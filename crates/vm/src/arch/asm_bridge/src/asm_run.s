...
map_pc_base:
    ...
    .long (pc_2c - map_pc_base)
    .long (pc_30 - map_pc_base)
    .long (pc_34 - map_pc_base)
    .long (pc_38 - map_pc_base)
    .long (pc_3c - map_pc_base)
    .long (pc_40 - map_pc_base)
    .long (pc_44 - map_pc_base)
    .long (pc_48 - map_pc_base)
    .long (pc_4c - map_pc_base)
    .long (pc_50 - map_pc_base)
map_pc_end:

...
// =========================================================================
// Memory layout source-of-truth constants. Static invariants below guarantee
// the derived constants are integer-valued.
// =========================================================================
...
const _: () = assert!(
    MEMORY_BLOCK_BYTES.is_power_of_two(),
    "MEMORY_BLOCK_BYTES must be a power of two so byte-pointer / block-index arithmetic uses a shift"
);
const _: () = assert!(

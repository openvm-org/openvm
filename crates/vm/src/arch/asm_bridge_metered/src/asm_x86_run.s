...
asm_execute:
    ...
    call metered_extern_handler ; metered_extern_handler(vm_exec_state_ptr, pre_compute_insns_ptr, cur_pc, cur_instret)
...
asm_run_end:
    ...
    mov rdx, r13        ; rdx = cur_pc 
    mov rcx, r14        ; rcx = cur_instret
    call metered_set_instret_and_pc ; metered_set_instret_and_pc(vm_exec_state_ptr, pre_compute_insns_ptr, cur_pc, cur_instret)

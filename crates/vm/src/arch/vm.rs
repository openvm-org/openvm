...
use super::rvr::{
    ...
    compile_metered_cost, compile_metered_segment_boundary, load_compiled_from_path,
    ...
    RvrDeltaRecords, RvrInitialImage, RvrInlineChipRecords, RvrMeteredCostInstance,

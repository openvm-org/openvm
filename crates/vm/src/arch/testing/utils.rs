...
// TODO[arayi]: delete this once it's migrated to stark-backend-gpu
#[cfg(feature = "cuda")]
mod cuda_utils {
    use core::fmt::Debug;
    use std::sync::Arc;
    ...
    use stark_backend_gpu::{
        base::DeviceMatrix, data_transporter::transport_device_matrix_to_host,
    };

...
use super::{
    ...
    InstructionExecutor, PhantomSubExecutor, Streams, SystemConfig, SystemTraceHeights,
};
#[cfg(feature = "bench-metrics")]
...
impl<F: PrimeField32, E, P> VmChipComplex<F, E, P> {
    ...
    pub(crate) fn generate_proof_input_with_ctx<SC>(
        mut self,

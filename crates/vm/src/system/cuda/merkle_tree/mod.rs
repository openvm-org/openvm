...
mod tests {
    ...
    fn test_cuda_merkle_tree_cpu_gpu_root_equivalence() {
        ...
        let mem_config = {
            ...
            let max_cells = 1 << 16;
            // RV64_REGISTER_AS is u16-celled; num_cells is in cells.
            ...
            // pointer_max_bits = log2(max_cells) + log2(BUS_PTR_SCALE) so the
            // max bus pointer `BUS_PTR_SCALE * (num_cells - 1)` fits.
            MemoryConfig::new(
                2,
                addr_spaces,

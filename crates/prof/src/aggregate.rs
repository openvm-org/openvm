...
pub const COMPILE_PURE_TIME_LABEL: &str = "compile_pure_ms";
pub const COMPILE_METERED_TIME_LABEL: &str = "compile_metered_ms";
pub const COMPILE_METERED_SEGMENT_TIME_LABEL: &str = "compile_metered_segment_ms";
pub const COMPILE_METERED_COST_TIME_LABEL: &str = "compile_metered_cost_ms";

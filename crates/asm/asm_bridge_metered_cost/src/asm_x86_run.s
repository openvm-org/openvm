...
asm_execute:
    ...
    call metered_cost_extern_handler ; metered_cost_extern_handler(vm_exec_state_ptr, pre_compute_insns_ptr, cur_pc, cur_instret)
    add r14, 1          ; cur_instret += 1
    cmp rax, 1          ; if return value of metered_cost_extern_handler is 1 
    je asm_run_end      ; jump to asm_run_end 
    mov r13, rax        ; cur_pc = return value of metered_cost_extern_handler
...
asm_run_end:
    ...
    mov rdx, r13        ; rdx = cur_pc 
    mov rcx, r14        ; rcx = cur_instret
    call metered_cost_set_instret_and_pc ; metered_cost_set_instret_and_pc(vm_exec_state_ptr, pre_compute_insns_ptr, cur_pc, cur_instret)
...
asm_execute:
    ...
    mov rdx, r13       
    mov rcx, r14        
    call metered_cost_extern_handler
    add r14, 1          
    cmp rax, 1          
    je asm_run_end      
    mov r13, rax        
...
asm_run_end:
    ...
    mov rdx, r13        
    mov rcx, r14        
    call metered_cost_set_instret_and_pc 
    xor rax, rax        
    pop r14             
    pop r13
    pop r12

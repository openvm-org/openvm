...
v___x_2_ = lean_unsigned_to_nat(28u);
return v___x_2_;
}
}
...
v_tail_4_ = lean_ctor_get(v_x_3_, 1);
if (lean_obj_tag(v_tail_4_) == 1)
{
lean_object* v_tail_5_; 
v_tail_5_ = lean_ctor_get(v_tail_4_, 1);
if (lean_obj_tag(v_tail_5_) == 1)
{
lean_object* v_tail_6_; 
v_tail_6_ = lean_ctor_get(v_tail_5_, 1);
if (lean_obj_tag(v_tail_6_) == 1)
{
lean_object* v_tail_7_; 
v_tail_7_ = lean_ctor_get(v_tail_6_, 1);
if (lean_obj_tag(v_tail_7_) == 0)
{
lean_object* v_head_8_; lean_object* v_head_9_; lean_object* v_head_10_; lean_object* v_head_11_; lean_object* v___x_12_; lean_object* v___x_13_; 
v_head_8_ = lean_ctor_get(v_x_3_, 0);
v_head_9_ = lean_ctor_get(v_tail_4_, 0);
v_head_10_ = lean_ctor_get(v_tail_5_, 0);
v_head_11_ = lean_ctor_get(v_tail_6_, 0);
lean_inc(v_head_11_);
lean_inc(v_head_10_);
lean_inc(v_head_9_);
lean_inc(v_head_8_);
v___x_12_ = lean_alloc_ctor(0, 4, 0);
lean_ctor_set(v___x_12_, 0, v_head_8_);
lean_ctor_set(v___x_12_, 1, v_head_9_);
lean_ctor_set(v___x_12_, 2, v_head_10_);
lean_ctor_set(v___x_12_, 3, v_head_11_);
...
v___x_28_ = lean_array_mk(v_values_27_);
return v___x_28_;
}
}
...
v___x_33_ = lean_array_mk(v_values_31_);
return v___x_33_;
}
}
...
v___x_42_ = lean_nat_add(v_offset_39_, v_i_41_);
v___x_43_ = lean_array_fget_borrowed(v_values_40_, v___x_42_);
lean_dec(v___x_42_);
lean_inc(v___x_43_);
return v___x_43_;
}
...
v___x_70_ = lean_array_fget_borrowed(v_values_68_, v_i_69_);
lean_inc(v___x_70_);
return v___x_70_;
}
}
...
v___x_77_ = lean_nat_add(v___x_74_, v_i_76_);
v___x_78_ = lean_array_fget_borrowed(v_values_75_, v___x_77_);
lean_dec(v___x_77_);
lean_inc(v___x_78_);
return v___x_78_;
}
...
v___x_88_ = l_Array_ofFn___redArg(v___x_85_, v___f_86_);
...
v___x_108_ = lean_array_fget_borrowed(v_values_104_, v___x_106_);
v___x_109_ = lean_unsigned_to_nat(9u);
v___x_110_ = lean_array_fget_borrowed(v_values_104_, v___x_109_);
v___x_111_ = lean_unsigned_to_nat(10u);
v___x_112_ = lean_array_fget_borrowed(v_values_104_, v___x_111_);
v___x_113_ = lean_unsigned_to_nat(11u);
v___x_114_ = lean_array_fget_borrowed(v_values_104_, v___x_113_);
lean_inc(v___x_114_);
lean_inc(v___x_112_);
lean_inc(v___x_110_);
lean_inc(v___x_108_);
v___x_115_ = lean_alloc_ctor(0, 4, 0);
lean_ctor_set(v___x_115_, 0, v___x_108_);
lean_ctor_set(v___x_115_, 1, v___x_110_);
...
v___x_126_ = l_List_lengthTR___redArg(v_values_125_);
v___x_127_ = lean_unsigned_to_nat(28u);
...
v___x_139_ = lean_nat_dec_eq(v_n_136_, v___x_138_);
if (v___x_139_ == 0)
{
lean_object* v___x_140_; 
lean_dec_ref(v_values_137_);
...
lean_dec(v_inst_155_);
lean_dec_ref(v_inst_154_);
v_head_159_ = lean_ctor_get(v_x_156_, 0);
lean_inc(v_head_159_);
lean_dec_ref_known(v_x_156_, 2);
v___x_160_ = lean_alloc_ctor(1, 1, 0);
lean_ctor_set(v___x_160_, 0, v_head_159_);
return v___x_160_;
}
else
{
lean_object* v_head_161_; lean_object* v_head_162_; lean_object* v_programCommit_163_; lean_object* v_connector_164_; lean_object* v_memory_165_; lean_object* v_programCommit_166_; lean_object* v_connector_167_; lean_object* v_memory_168_; uint8_t v___x_169_; 
lean_inc_ref(v_tail_158_);
v_head_161_ = lean_ctor_get(v_x_156_, 0);
lean_inc(v_head_161_);
lean_dec_ref_known(v_x_156_, 2);
v_head_162_ = lean_ctor_get(v_tail_158_, 0);
v_programCommit_163_ = lean_ctor_get(v_head_161_, 0);
lean_inc_ref(v_programCommit_163_);
v_connector_164_ = lean_ctor_get(v_head_161_, 1);
lean_inc_ref(v_connector_164_);
v_memory_165_ = lean_ctor_get(v_head_161_, 2);
lean_inc_ref(v_memory_165_);
lean_dec(v_head_161_);
v_programCommit_166_ = lean_ctor_get(v_head_162_, 0);
v_connector_167_ = lean_ctor_get(v_head_162_, 1);
v_memory_168_ = lean_ctor_get(v_head_162_, 2);
lean_inc_ref(v_inst_154_);
v___x_169_ = l_Array_instDecidableEqImpl___redArg(v_inst_154_, v_programCommit_163_, v_programCommit_166_);
if (v___x_169_ == 0)
{
lean_object* v___x_170_; 
lean_dec_ref(v_memory_165_);
lean_dec_ref(v_connector_164_);
lean_dec_ref(v_programCommit_163_);
lean_dec_ref_known(v_tail_158_, 2);
lean_dec(v_inst_155_);
lean_dec_ref(v_inst_154_);
...
{
lean_object* v_initialPc_171_; lean_object* v_finalPc_172_; lean_object* v_isTerminate_173_; lean_object* v_initialPc_174_; lean_object* v___x_175_; uint8_t v___x_176_; 
v_initialPc_171_ = lean_ctor_get(v_connector_164_, 0);
lean_inc(v_initialPc_171_);
v_finalPc_172_ = lean_ctor_get(v_connector_164_, 1);
lean_inc(v_finalPc_172_);
v_isTerminate_173_ = lean_ctor_get(v_connector_164_, 3);
lean_inc(v_isTerminate_173_);
lean_dec_ref(v_connector_164_);
v_initialPc_174_ = lean_ctor_get(v_connector_167_, 0);
lean_inc_ref(v_inst_154_);
lean_inc(v_initialPc_174_);
v___x_175_ = lean_apply_2(v_inst_154_, v_finalPc_172_, v_initialPc_174_);
v___x_176_ = lean_unbox(v___x_175_);
if (v___x_176_ == 0)
{
lean_object* v___x_177_; 
lean_dec(v_isTerminate_173_);
lean_dec(v_initialPc_171_);
lean_dec_ref(v_memory_165_);
lean_dec_ref(v_programCommit_163_);
lean_dec_ref_known(v_tail_158_, 2);
lean_dec(v_inst_155_);
...
{
lean_object* v_initialRoot_178_; lean_object* v_finalRoot_179_; lean_object* v_initialRoot_180_; uint8_t v___x_181_; 
v_initialRoot_178_ = lean_ctor_get(v_memory_165_, 0);
lean_inc_ref(v_initialRoot_178_);
v_finalRoot_179_ = lean_ctor_get(v_memory_165_, 1);
lean_inc_ref(v_finalRoot_179_);
lean_dec_ref(v_memory_165_);
v_initialRoot_180_ = lean_ctor_get(v_memory_168_, 0);
lean_inc_ref(v_inst_154_);
v___x_181_ = l_Array_instDecidableEqImpl___redArg(v_inst_154_, v_finalRoot_179_, v_initialRoot_180_);
lean_dec_ref(v_finalRoot_179_);
if (v___x_181_ == 0)
{
...
v___x_183_ = lean_apply_2(v_inst_154_, v_isTerminate_173_, v_inst_155_);
...
{
lean_object* v_val_187_; lean_object* v___x_189_; uint8_t v_isShared_190_; uint8_t v_isSharedCheck_224_; 
v_val_187_ = lean_ctor_get(v___x_186_, 0);
v_isSharedCheck_224_ = !lean_is_exclusive(v___x_186_);
if (v_isSharedCheck_224_ == 0)
{
v___x_189_ = v___x_186_;
v_isShared_190_ = v_isSharedCheck_224_;
goto v_resetjp_188_;
}
else
{
...
v_resetjp_188_:
{
lean_object* v_connector_191_; lean_object* v_memory_192_; lean_object* v___x_194_; uint8_t v_isShared_195_; uint8_t v_isSharedCheck_222_; 
v_connector_191_ = lean_ctor_get(v_val_187_, 1);
v_memory_192_ = lean_ctor_get(v_val_187_, 2);
v_isSharedCheck_222_ = !lean_is_exclusive(v_val_187_);
if (v_isSharedCheck_222_ == 0)
{
lean_object* v_unused_223_; 
v_unused_223_ = lean_ctor_get(v_val_187_, 0);
lean_dec(v_unused_223_);
v___x_194_ = v_val_187_;
v_isShared_195_ = v_isSharedCheck_222_;
goto v_resetjp_193_;
}
else
{
lean_inc(v_memory_192_);
lean_inc(v_connector_191_);
lean_dec(v_val_187_);
...
v_resetjp_193_:
{
lean_object* v_finalPc_196_; lean_object* v_exitCode_197_; lean_object* v_isTerminate_198_; lean_object* v___x_200_; uint8_t v_isShared_201_; uint8_t v_isSharedCheck_220_; 
v_finalPc_196_ = lean_ctor_get(v_connector_191_, 1);
v_exitCode_197_ = lean_ctor_get(v_connector_191_, 2);
v_isTerminate_198_ = lean_ctor_get(v_connector_191_, 3);
v_isSharedCheck_220_ = !lean_is_exclusive(v_connector_191_);
if (v_isSharedCheck_220_ == 0)
{
lean_object* v_unused_221_; 
v_unused_221_ = lean_ctor_get(v_connector_191_, 0);
lean_dec(v_unused_221_);
v___x_200_ = v_connector_191_;
v_isShared_201_ = v_isSharedCheck_220_;
goto v_resetjp_199_;
}
else
{
lean_inc(v_isTerminate_198_);
lean_inc(v_exitCode_197_);
lean_inc(v_finalPc_196_);
lean_dec(v_connector_191_);
...
v_resetjp_199_:
{
lean_object* v_finalRoot_202_; lean_object* v___x_204_; uint8_t v_isShared_205_; uint8_t v_isSharedCheck_218_; 
v_finalRoot_202_ = lean_ctor_get(v_memory_192_, 1);
v_isSharedCheck_218_ = !lean_is_exclusive(v_memory_192_);
if (v_isSharedCheck_218_ == 0)
{
lean_object* v_unused_219_; 
v_unused_219_ = lean_ctor_get(v_memory_192_, 0);
lean_dec(v_unused_219_);
v___x_204_ = v_memory_192_;
v_isShared_205_ = v_isSharedCheck_218_;
goto v_resetjp_203_;
}
else
{
lean_inc(v_finalRoot_202_);
lean_dec(v_memory_192_);
...
{
lean_ctor_set(v___x_200_, 0, v_initialPc_171_);
...
lean_ctor_set(v_reuseFailAlloc_217_, 0, v_initialPc_171_);
lean_ctor_set(v_reuseFailAlloc_217_, 1, v_finalPc_196_);
lean_ctor_set(v_reuseFailAlloc_217_, 2, v_exitCode_197_);
lean_ctor_set(v_reuseFailAlloc_217_, 3, v_isTerminate_198_);
v___x_207_ = v_reuseFailAlloc_217_;
goto v_reusejp_206_;
}
v_reusejp_206_:
{
...
{
lean_ctor_set(v___x_204_, 0, v_initialRoot_178_);
...
lean_ctor_set(v_reuseFailAlloc_216_, 0, v_initialRoot_178_);
lean_ctor_set(v_reuseFailAlloc_216_, 1, v_finalRoot_202_);
...
{
lean_ctor_set(v___x_194_, 2, v___x_209_);
lean_ctor_set(v___x_194_, 1, v___x_207_);
lean_ctor_set(v___x_194_, 0, v_programCommit_163_);
v___x_211_ = v___x_194_;
goto v_reusejp_210_;
}
else
{
...
lean_ctor_set(v_reuseFailAlloc_215_, 0, v_programCommit_163_);
lean_ctor_set(v_reuseFailAlloc_215_, 1, v___x_207_);
lean_ctor_set(v_reuseFailAlloc_215_, 2, v___x_209_);
...
{
lean_ctor_set(v___x_189_, 0, v___x_211_);
...
v_tail_236_ = lean_ctor_get(v_x_230_, 1);
if (lean_obj_tag(v_tail_236_) == 0)
{
lean_object* v_head_237_; lean_object* v___x_238_; 
lean_dec(v_h__3_233_);
v_head_237_ = lean_ctor_get(v_x_230_, 0);
lean_inc(v_head_237_);
lean_dec_ref_known(v_x_230_, 2);
v___x_238_ = lean_apply_1(v_h__2_232_, v_head_237_);
return v___x_238_;
}
else
{
lean_object* v_head_239_; lean_object* v_head_240_; lean_object* v_tail_241_; lean_object* v___x_242_; 
lean_inc_ref(v_tail_236_);
lean_dec(v_h__2_232_);
v_head_239_ = lean_ctor_get(v_x_230_, 0);
lean_inc(v_head_239_);
lean_dec_ref_known(v_x_230_, 2);
v_head_240_ = lean_ctor_get(v_tail_236_, 0);
lean_inc(v_head_240_);
v_tail_241_ = lean_ctor_get(v_tail_236_, 1);
lean_inc(v_tail_241_);
lean_dec_ref_known(v_tail_236_, 2);
v___x_242_ = lean_apply_3(v_h__3_233_, v_head_239_, v_head_240_, v_tail_241_);
return v___x_242_;
}
}
}
...
v_tail_251_ = lean_ctor_get(v_x_245_, 1);
if (lean_obj_tag(v_tail_251_) == 0)
{
lean_object* v_head_252_; lean_object* v___x_253_; 
lean_dec(v_h__3_248_);
v_head_252_ = lean_ctor_get(v_x_245_, 0);
lean_inc(v_head_252_);
lean_dec_ref_known(v_x_245_, 2);
v___x_253_ = lean_apply_1(v_h__2_247_, v_head_252_);
return v___x_253_;
}
else
{
lean_object* v_head_254_; lean_object* v_head_255_; lean_object* v_tail_256_; lean_object* v___x_257_; 
lean_inc_ref(v_tail_251_);
lean_dec(v_h__2_247_);
v_head_254_ = lean_ctor_get(v_x_245_, 0);
lean_inc(v_head_254_);
lean_dec_ref_known(v_x_245_, 2);
v_head_255_ = lean_ctor_get(v_tail_251_, 0);
lean_inc(v_head_255_);
v_tail_256_ = lean_ctor_get(v_tail_251_, 1);
lean_inc(v_tail_256_);
lean_dec_ref_known(v_tail_251_, 2);
v___x_257_ = lean_apply_3(v_h__3_248_, v_head_254_, v_head_255_, v_tail_256_);
return v___x_257_;
}
}
}

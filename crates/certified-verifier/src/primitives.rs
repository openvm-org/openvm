...
#[inline]
fn narrow_usize(value: usize) -> Result<u32> {
...
#[inline]
pub(crate) fn write_isize_as_i32<W: Write>(writer: &mut W, value: isize) -> Result<()> {
...
#[inline]
pub(crate) fn write_length_prefix<W: Write>(writer: &mut W, len: usize) -> Result<()> {
    write_usize_as_u32(writer, len)
}

/// Write a `u32` list of `u32` values.
pub(crate) fn write_u32_list<W: Write>(writer: &mut W, items: &[u32]) -> Result<()> {
...
/// `Some(_)`.
pub(crate) fn write_option<T, W: Write>(
    writer: &mut W,
    value: Option<&T>,
...
pub(crate) fn write_option_usize<W: Write>(writer: &mut W, value: Option<usize>) -> Result<()> {
...
#[inline]
pub(crate) fn write_prime_field32<F: PrimeField32, W: Write>(
    writer: &mut W,
    value: &F,
) -> Result<()> {

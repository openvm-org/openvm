...
//! upstream Lean `Wire.Raw` decoder.
...
use super::primitives::{
    write_length_prefix, write_prime_field32, write_u32, write_usize_as_u32, write_usize_as_u64,
};
...
fn write_entry<W: Write>(writer: &mut W, entry: &Entry) -> Result<()> {
    match entry {
        ...
        Entry::Challenge => writer.write_all(&[0x03u8]),
    }
}
...
fn write_symbolic_expression_node<F: PrimeField32, W: Write>(
    ...
    match node {
        ...
        SymbolicExpressionNode::Add {
            ...
            write_usize_as_u64(writer, *degree_multiple)
        }

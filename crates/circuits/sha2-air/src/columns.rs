...
pub struct Sha2FlagsCols<T, const ROW_VAR_CNT: usize> {
    ...
    pub is_digest_row: T,
    // This flag will always be true. This flag exists because this air was made to support
    // multi-block hashes. We chose to leave this flag here since we may support multi-block
...
// {
//     // This refers to the padding rows that are added to the air to make the trace length a power
// of     // 2. Not to be confused with the padding added to messages as part of the SHA hash
//     // function.

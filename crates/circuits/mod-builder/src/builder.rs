...
impl<F: PrimeField64> TraceSubRowGenerator<F> for FieldExpr {
    ...
    fn generate_subrow<'a>(
        ...
        for i in 0..expr.constraints.len() {
            ...
            // If this fails, the q_limbs estimate is wrong.
            assert_eq!(q_limbs.len(), expr.q_limbs[i]);
            ...
            // If this fails, the carry limbs estimate is wrong.
            assert_eq!(carries.len(), expr.carry_limbs[i]);

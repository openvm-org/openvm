...
pub use extension::{
    air_index_codegen_fingerprint, air_index_to_c, opcode_air_idx, AirIndex, ExtensionError,
    ExtensionRegistry, RvrExtension, RvrExtensionCtx, TraceChipIndex, VmRvrExtension,
};

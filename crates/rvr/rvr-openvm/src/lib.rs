...
pub use emit::{
    ...
    ArenaNativeGeometry, ArenaNativeLayout, Branch2ArenaFieldOffsets, CProject, EmitContext,
    G2DsoManifestConfigV2, G2EmissionMode, InlineRecordShape, InvalidRvrExecutionKind,

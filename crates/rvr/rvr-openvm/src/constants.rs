...
use rvr_openvm_ext_ffi_common::{
    PREFLIGHT_ADDSUB_RECORD_SIZE, PREFLIGHT_BRANCH2_RECORD_SIZE, PREFLIGHT_CHIP_RECORD_BUF_ALIGN,
    PREFLIGHT_CHIP_RECORD_BUF_SIZE, PREFLIGHT_DELTA_MEMORY_LOG_ENTRY_ALIGN,
    PREFLIGHT_DELTA_MEMORY_LOG_ENTRY_SIZE, PREFLIGHT_DELTA_RECORD_SIZE,
    PREFLIGHT_DEVICE_PROGRAM_ENTRY_ALIGN, PREFLIGHT_DEVICE_PROGRAM_ENTRY_SIZE,
    PREFLIGHT_INITIAL_TIMESTAMP, PREFLIGHT_MEMORY_KIND_READ, PREFLIGHT_MEMORY_KIND_TOUCH,
    PREFLIGHT_MEMORY_KIND_WRITE, PREFLIGHT_MEMORY_LOG_ENTRY_ALIGN, PREFLIGHT_MEMORY_LOG_ENTRY_SIZE,
    PREFLIGHT_PROGRAM_LOG_ENTRY_ALIGN, PREFLIGHT_PROGRAM_LOG_ENTRY_SIZE,
    PREFLIGHT_PROGRAM_RUN_ENTRY_ALIGN, PREFLIGHT_PROGRAM_RUN_ENTRY_SIZE, PREFLIGHT_RW1_RECORD_SIZE,

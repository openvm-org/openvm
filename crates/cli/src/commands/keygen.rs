...
fn assert_default_root_shape(
    ...
    assert_eq!(
        actual_system_config.num_public_value_cells, default_system_config.num_public_value_cells,
        "cargo openvm keygen only supports the default num_public_value_cells"
    );

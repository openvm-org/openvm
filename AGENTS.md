...
- Rust 1.94.0 (stable), specified in `rust-toolchain.toml`
- Nightly is only needed for:
  - `rustfmt` (unstable formatting options)
  - guest program compilation / some integration tests (requires `rust-src`, pinned nightly: `nightly-2026-04-08`)
...
rustup component add rust-src --toolchain nightly-2026-04-08

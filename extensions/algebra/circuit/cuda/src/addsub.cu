...
template <size_t BLOCKS, size_t BLOCK_SIZE, size_t NUM_LIMBS>
__global__ void modular_addsub_quotient_tracegen_kernel(
    Fp *trace,
    size_t height,
    const uint8_t *records,
    size_t num_records,
...
template <size_t BLOCKS, size_t BLOCK_SIZE, size_t NUM_LIMBS>
__global__ void modular_addsub_carry_tracegen_kernel(
    Fp *trace,
    size_t height,
    const uint8_t *records,
    size_t num_records,
...
extern "C" int launch_modular_addsub_tracegen(
    ...
    if (prime_limb_count <= 32) {
        ...
        modular_addsub_quotient_tracegen_kernel<BLOCKS, BLOCK_SIZE, NUM_LIMBS>
        ...
        modular_addsub_carry_tracegen_kernel<BLOCKS, BLOCK_SIZE, NUM_LIMBS>
            <<<constraint_grid, constraint_block>>>(
                d_trace,
                trace_height,
                d_records,

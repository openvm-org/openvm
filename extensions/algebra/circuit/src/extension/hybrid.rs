    ...
    fn extend_prover(
        ...
        for (i, modulus) in extension.supported_moduli.iter().enumerate() {
            ...
            if bytes <= NUM_LIMBS_32 {
                ...
                let addsub = get_modular_addsub_chip::<F, MODULAR_BLOCKS_32, MEMORY_BLOCK_BYTES>(
                    config.clone(),
                    mem_helper.clone(),
                    range_checker.clone(),
                    bitwise_lu.clone(),
                ...
                inventory.next_air::<ModularAir<MODULAR_BLOCKS_32, MEMORY_BLOCK_BYTES>>()?;
                let muldiv = get_modular_muldiv_chip::<F, MODULAR_BLOCKS_32, MEMORY_BLOCK_BYTES>(
                    config,
                    mem_helper.clone(),
                    range_checker.clone(),
                    bitwise_lu.clone(),
                ...
                let addsub = get_modular_addsub_chip::<F, MODULAR_BLOCKS_48, MEMORY_BLOCK_BYTES>(
                    config.clone(),
                    mem_helper.clone(),
                    range_checker.clone(),
                    bitwise_lu.clone(),
                ...
                inventory.next_air::<ModularAir<MODULAR_BLOCKS_48, MEMORY_BLOCK_BYTES>>()?;
                let muldiv = get_modular_muldiv_chip::<F, MODULAR_BLOCKS_48, MEMORY_BLOCK_BYTES>(
                    config,
                    mem_helper.clone(),
                    range_checker.clone(),
                    bitwise_lu.clone(),
    ...
    fn extend_prover(
        ...
        for (_, modulus) in extension.supported_moduli.iter() {
            ...
            if bytes <= NUM_LIMBS_32 {
                ...
                let addsub = get_fp2_addsub_chip::<F, FP2_BLOCKS_32, MEMORY_BLOCK_BYTES>(
                    config.clone(),
                    mem_helper.clone(),
                    range_checker.clone(),
                    bitwise_lu.clone(),
                ...
                inventory.next_air::<Fp2Air<FP2_BLOCKS_32, MEMORY_BLOCK_BYTES>>()?;
                let muldiv = get_fp2_muldiv_chip::<F, FP2_BLOCKS_32, MEMORY_BLOCK_BYTES>(
                    config,
                    mem_helper.clone(),
                    range_checker.clone(),
                    bitwise_lu.clone(),
                ...
                let addsub = get_fp2_addsub_chip::<F, FP2_BLOCKS_48, MEMORY_BLOCK_BYTES>(
                    config.clone(),
                    mem_helper.clone(),
                    range_checker.clone(),
                    bitwise_lu.clone(),
                ...
                inventory.next_air::<Fp2Air<FP2_BLOCKS_48, MEMORY_BLOCK_BYTES>>()?;
                let muldiv = get_fp2_muldiv_chip::<F, FP2_BLOCKS_48, MEMORY_BLOCK_BYTES>(
                    config,
                    mem_helper.clone(),
                    range_checker.clone(),
                    bitwise_lu.clone(),

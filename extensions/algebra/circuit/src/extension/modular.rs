    ...
    fn extend_execution(
        ...
        for (i, modulus) in self.supported_moduli.iter().enumerate() {
            ...
            if bytes <= NUM_LIMBS_32 {
                ...
                let addsub = get_modular_addsub_step::<MODULAR_BLOCKS_32, MEMORY_BLOCK_BYTES>(
                    config.clone(),
                ...
                let addsub = get_modular_addsub_step::<MODULAR_BLOCKS_48, MEMORY_BLOCK_BYTES>(
                    config.clone(),
                    dummy_range_checker_bus,
                    pointer_max_bits,
                    start_offset,
                ...
                let muldiv = get_modular_muldiv_step::<MODULAR_BLOCKS_48, MEMORY_BLOCK_BYTES>(
                    config,
                    dummy_range_checker_bus,
                    pointer_max_bits,
                    start_offset,
    ...
    fn extend_circuit(&self, inventory: &mut AirInventory<SC>) -> Result<(), AirInventoryError> {
        ...
        for (i, modulus) in self.supported_moduli.iter().enumerate() {
            ...
            if bytes <= NUM_LIMBS_32 {
                ...
                let addsub = get_modular_addsub_air::<MODULAR_BLOCKS_32, MEMORY_BLOCK_BYTES>(
                    exec_bridge,
                    memory_bridge,
                    config.clone(),
                    range_checker_bus,
                ...
                let muldiv = get_modular_muldiv_air::<MODULAR_BLOCKS_32, MEMORY_BLOCK_BYTES>(
                    exec_bridge,
                    memory_bridge,
                    config,
                    range_checker_bus,
                ...
                let addsub = get_modular_addsub_air::<MODULAR_BLOCKS_48, MEMORY_BLOCK_BYTES>(
                    exec_bridge,
                    memory_bridge,
                    config.clone(),
                    range_checker_bus,
                ...
                let muldiv = get_modular_muldiv_air::<MODULAR_BLOCKS_48, MEMORY_BLOCK_BYTES>(
                    exec_bridge,
                    memory_bridge,
                    config,
                    range_checker_bus,
    ...
    fn extend_prover(
        ...
        for (i, modulus) in extension.supported_moduli.iter().enumerate() {
            ...
            if bytes <= NUM_LIMBS_32 {
                ...
                inventory.next_air::<ModularAir<MODULAR_BLOCKS_32, MEMORY_BLOCK_BYTES>>()?;
                let addsub =
                    get_modular_addsub_chip::<Val<SC>, MODULAR_BLOCKS_32, MEMORY_BLOCK_BYTES>(
                        config.clone(),
                        mem_helper.clone(),
                        range_checker.clone(),
                        bitwise_lu.clone(),
                ...
                inventory.next_air::<ModularAir<MODULAR_BLOCKS_32, MEMORY_BLOCK_BYTES>>()?;
                let muldiv =
                    get_modular_muldiv_chip::<Val<SC>, MODULAR_BLOCKS_32, MEMORY_BLOCK_BYTES>(
                        config,
                        mem_helper.clone(),
                        range_checker.clone(),
                        bitwise_lu.clone(),
                ...
                inventory.next_air::<ModularAir<MODULAR_BLOCKS_48, MEMORY_BLOCK_BYTES>>()?;
                let addsub =
                    get_modular_addsub_chip::<Val<SC>, MODULAR_BLOCKS_48, MEMORY_BLOCK_BYTES>(
                        config.clone(),
                        mem_helper.clone(),
                        range_checker.clone(),
                        bitwise_lu.clone(),
                ...
                inventory.next_air::<ModularAir<MODULAR_BLOCKS_48, MEMORY_BLOCK_BYTES>>()?;
                let muldiv =
                    get_modular_muldiv_chip::<Val<SC>, MODULAR_BLOCKS_48, MEMORY_BLOCK_BYTES>(
                        config,
                        mem_helper.clone(),
                        range_checker.clone(),
                        bitwise_lu.clone(),

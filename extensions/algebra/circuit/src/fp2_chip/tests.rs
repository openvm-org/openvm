...
#[test_case(TestConfig::<{FP2_BLOCKS_32}, {MEMORY_BLOCK_BYTES}, {NUM_LIMBS_32}>::new(
...
#[test_case(TestConfig::<{FP2_BLOCKS_48}, {MEMORY_BLOCK_BYTES}, {NUM_LIMBS_48}>::new(
...
mod cuda_tests {
    ...
    true,
    50),
    create_addsub_cuda_test_harness::<FP2_BLOCKS_32, MEMORY_BLOCK_BYTES>
)]
    #[test_case(TestConfig::<FP2_BLOCKS_32, MEMORY_BLOCK_BYTES, NUM_LIMBS_32>::new(
    secp256k1_coord_prime(),
    true,
    ...
    true,
    50),
    create_addsub_cuda_test_harness::<FP2_BLOCKS_48, MEMORY_BLOCK_BYTES>
)]
    #[test_case(TestConfig::<FP2_BLOCKS_32, MEMORY_BLOCK_BYTES, NUM_LIMBS_32>::new(
    BigUint::from_str("357686312646216567629137").unwrap(),
    false,
    50),
    create_muldiv_cuda_test_harness::<FP2_BLOCKS_32, MEMORY_BLOCK_BYTES>
)]
    #[test_case(TestConfig::<FP2_BLOCKS_32, MEMORY_BLOCK_BYTES, NUM_LIMBS_32>::new(
    secp256k1_coord_prime(),
    false,
    ...
    false,
    50),
    create_muldiv_cuda_test_harness::<FP2_BLOCKS_48, MEMORY_BLOCK_BYTES>
)]

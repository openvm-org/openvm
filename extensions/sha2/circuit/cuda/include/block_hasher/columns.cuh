...
#define SHA2_COL_ARRAY_LEN(V, STRUCT, FIELD) (sizeof((reinterpret_cast<STRUCT<V, uint8_t> *>(0)->FIELD)))
#define SHA2_WRITE_VALUE(V, ROW, STRUCT, FIELD, VALUE) (ROW).write(SHA2_COL_INDEX(V, STRUCT, FIELD), VALUE)
#define SHA2_WRITE_ARRAY(V, ROW, STRUCT, FIELD, VALUES)                                             \
    (ROW).write_array(SHA2_COL_INDEX(V, STRUCT, FIELD), SHA2_COL_ARRAY_LEN(V, STRUCT, FIELD), VALUES)
#define SHA2_WRITE_BITS(V, ROW, STRUCT, FIELD, VALUE) (ROW).write_bits(SHA2_COL_INDEX(V, STRUCT, FIELD), VALUE)
...
#define SHA2_FILL_ZERO_ROUND(V, row, FIELD)                                                         \
    SHA2_FILL_ZERO(V, row, Sha2BlockHasherRoundCols, FIELD)

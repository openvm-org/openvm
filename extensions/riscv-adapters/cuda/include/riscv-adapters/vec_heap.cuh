...
constexpr size_t REG_PTR_U16S = RV64_WORD_NUM_LIMBS / 2;
...
struct Rv64VecHeapAdapterCols {
    ...
    T rs_val[NUM_READS][REG_PTR_U16S];
    /// Low 32 bits of rd register, packed as 2 u16 cells.
    T rd_val[REG_PTR_U16S];

    ...
    >
{
    ...
    fn eval(
        ...
        // Pointer high-u16 range checks: range-check `val[1] * shift < 2^16` to enforce
        // `val[1] < 2^(addr_bits - 16)`. Memory-read u16 cells are already < 2^16.
    ...
    >
{
    ...
    fn fill_trace_row(&self, mem_helper: &MemoryAuxColsFactory<F>, mut adapter_row: &mut [F]) {
        ...
        // Pointer high-u16 range checks: `(reg >> 16) << shift_bits < 2^16` for each pointer.
        let u16_bits = RV64_CELL_BITS * 2;

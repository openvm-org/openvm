...
use openvm_circuit::{
    arch::{
        ...
        MinimalInstruction, VmAdapterAir, BLOCK_FE_WIDTH, MEMORY_BLOCK_BYTES, U16_CELL_SIZE,
    },
    system::memory::{
...
use openvm_riscv_circuit::adapters::{
    ...
    reg_byte_ptr_to_cell_ptr_limbs, RV64_PTR_U16_LIMBS, RV64_REGISTER_NUM_LIMBS,
};

...
use openvm_riscv_circuit::adapters::{
    ...
    eval_byte_ptr_limbs_to_u16_cell_ptr_limbs, expand_to_rv64_block, ptr_to_u16_limbs,
    reg_byte_ptr_to_cell_ptr_limbs, tracing_read_reg_ptr, tracing_read_u16, RV64_PTR_U16_LIMBS,
};

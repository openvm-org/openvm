...
extern bool rvr_ext_pairing_hint_final_exp_bn254(RvState* state, uint64_t rs1_val,
                                                 uint64_t rs2_val);

extern bool rvr_ext_pairing_hint_final_exp_bls12_381(RvState* state, uint64_t rs1_val,
                                                     uint64_t rs2_val);

...
fn test_mul_023_by_023() {
    ...
    let mut chip = EcLineMul023By023Chip::<F, 12, 30, BLOCK_SIZE>::new(
    ...
    let instruction = rv32_write_heap_default_with_increment(
        ...
        input_line1_limbs,
        512,
        chip.0.step.offset + PairingOpcode::MUL_023_BY_023 as usize,
    );
...
fn test_mul_by_02345() {
    ...
    let bitwise_bus = BitwiseOperationLookupBus::new(BITWISE_OP_LOOKUP_BUS);
    let bitwise_chip = SharedBitwiseOperationLookupChip::<RV32_CELL_BITS>::new(bitwise_bus);
    let mut chip = EcLineMulBy02345Chip::<F, 36, 30, 36, BLOCK_SIZE>::new(
        tester.execution_bridge(),
        tester.memory_bridge(),
        tester.memory_helper(),
        tester.address_bits(),
    ...
    let instruction = rv32_write_heap_default_with_increment(
        ...
        input_x_limbs,
        1024,
        chip.0.step.offset + PairingOpcode::MUL_BY_02345 as usize,
    );

...
// ----------------------------------------------------------------------------
// Byte-limb arithmetic-right shift (SRA). Keeps byte limbs and the byte adapter; the sign bit of
// the top limb fills the vacated high bits. Byte-pair bitwise lookups range check the limbs, in

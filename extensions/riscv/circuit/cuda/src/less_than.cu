...
using Rv64LessThanCoreRecord = LessThanCoreRecord<BLOCK_FE_WIDTH, RV64_U16_LIMB_BITS>;
using Rv64LessThanCore = LessThanCore<BLOCK_FE_WIDTH, RV64_U16_LIMB_BITS>;
template <typename T>
using Rv64LessThanCoreCols =
    LessThanCoreCols<T, BLOCK_FE_WIDTH, RV64_U16_LIMB_BITS>;

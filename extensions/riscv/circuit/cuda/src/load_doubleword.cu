...
__global__ void rv64_load_doubleword_replay_tracegen(
    Fp *trace,
    size_t height,
...
extern "C" int _rv64_load_doubleword_replay_tracegen(
    Fp *d_trace,
    size_t height,
    size_t width,
    ...
    auto [grid, block] = kernel_launch_params(height, 512);
    rv64_load_doubleword_replay_tracegen<<<grid, block, 0, stream>>>(
        d_trace,
        height,
        d_instructions,
        pc_base,

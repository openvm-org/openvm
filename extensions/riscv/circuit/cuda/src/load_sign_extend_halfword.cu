...
DEFINE_RVR_G2_TRACEGEN_LAUNCHER_WITH_WIDTH(
    _rv64_load_sign_extend_halfword_tracegen_g2, Rv64LoadSignExtendHalfwordCols,
    rv64_load_sign_extend_halfword_tracegen, Rv64LoadSignExtendRecord, 512,
    pointer_max_bits, range_checker, range_checker_num_bins, bitwise_lookup,
    timestamp_max_bits
)

...
DEFINE_RVR_G2_TRACEGEN_LAUNCHER(
    _rv64_load_sign_extend_byte_tracegen_g2, Rv64LoadSignExtendByteCols,
    rv64_load_sign_extend_byte_tracegen_compact, RvrAlu3Compact, 512, operand_table,
    pc_base, pointer_max_bits, range_checker, range_checker_num_bins, bitwise_lookup,
    timestamp_max_bits
)

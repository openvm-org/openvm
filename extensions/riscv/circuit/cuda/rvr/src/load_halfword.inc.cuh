...
__global__ void rv64_load_halfword_replay_tracegen(
    Fp *trace,
    size_t height,
...
extern "C" int _rv64_load_halfword_replay_tracegen(
    Fp *d_trace,
    size_t height,
    size_t width,
    ...
    rv64_load_halfword_replay_tracegen<<<grid, block, 0, stream>>>(
        d_trace,
        height,
        d_instructions,
        pc_base,

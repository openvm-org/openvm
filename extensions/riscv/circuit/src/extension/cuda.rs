...
use crate::{
    ...
    Rv64MultiplicationChipGpu, Rv64ShiftLeftAir, Rv64ShiftLeftChipGpu, Rv64ShiftRightAir,
    Rv64ShiftRightChipGpu, Rv64ShiftWLeftAir, Rv64ShiftWLeftChipGpu, Rv64ShiftWRightAir,
...
impl VmProverExtension<GpuBabyBearPoseidon2Engine, DenseRecordArena, Rv64I> for Rv64ImGpuProverExt {
    fn extend_prover(
        ...
        let shift_left = Rv64ShiftLeftChipGpu::new(
            range_checker.clone(),
            bitwise_lu.clone(),
            timestamp_max_bits,
        );
        ...
        let shift_right = Rv64ShiftRightChipGpu::new(
            range_checker.clone(),
            bitwise_lu.clone(),
            timestamp_max_bits,
        );
        ...
        let shift_w_left = Rv64ShiftWLeftChipGpu::new(
            range_checker.clone(),
            bitwise_lu.clone(),
            timestamp_max_bits,
        );
        ...
        let shift_w_right = Rv64ShiftWRightChipGpu::new(
            range_checker.clone(),
            bitwise_lu.clone(),
            timestamp_max_bits,
        );

...
pub type Rv64ShiftLogicalAir =
    VmAirWrapper<Rv64BaseAluU16AdapterAir, ShiftLogicalCoreAir<BLOCK_FE_WIDTH, U16_BITS>>;
pub type Rv64ShiftLogicalExecutor =
    ShiftLogicalExecutor<Rv64BaseAluU16AdapterExecutor, BLOCK_FE_WIDTH, U16_BITS>;
pub type Rv64ShiftLogicalChip<F> =
    VmChipWrapper<F, ShiftLogicalFiller<Rv64BaseAluU16AdapterFiller, BLOCK_FE_WIDTH, U16_BITS>>;

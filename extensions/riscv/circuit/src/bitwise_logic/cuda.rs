...
use crate::{
    adapters::{
        Rv64BaseAluRegAdapterCols, Rv64BaseAluRegAdapterRecord, RV64_BYTE_BITS,
...
impl Chip<DenseRecordArena, GpuBackend> for Rv64BitwiseLogicChipGpu {
    fn generate_proving_ctx(&self, arena: DenseRecordArena) -> AirProvingContext<GpuBackend> {
        ...
        let delta_records = self.rvr_decode.device_delta_records(
            crate::rvr_gpu_decode::DeltaAirKind::Bitwise,
        ...
        if rvr_wire || delta_records.is_some() {
            ...
            unsafe {
                crate::cuda_abi::bitwise_logic_cuda::tracegen_compact(
                    d_trace.buffer(),
                    trace_height,
                    &d_records,
                    &d_table,

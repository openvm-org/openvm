...
use crate::{
    adapters::{BaseAluRegAdapterCols, BYTE_BITS, REGISTER_NUM_LIMBS},
    cuda_abi::bitwise_logic_cuda,
};

#[derive(new)]
pub struct BitwiseLogicChipGpu {
    pub range_checker: Arc<VariableRangeCheckerChipGPU>,
    pub bitwise_lookup: Arc<BitwiseOperationLookupChipGPU<BYTE_BITS>>,
    pub timestamp_max_bits: usize,
}

impl BitwiseLogicChipGpu {
    pub fn generate_proving_ctx_from_postflight(
        ...
        let trace_width = BitwiseLogicCoreCols::<F, REGISTER_NUM_LIMBS, BYTE_BITS>::width()

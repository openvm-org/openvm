...
#[cfg(feature = "rvr")]
impl Rv64LoadSignExtendWordChipGpu {
    pub fn generate_proving_ctx_from_rvr(
        ...
        let step_range = replay_plan.opcode_range(Rv64LoadStoreOpcode::LOADW.global_opcode());
        ...
        unsafe {
            load_sign_extend_word_cuda::replay_tracegen(
                ...
                Rv64LoadStoreOpcode::LOADW.global_opcode().as_usize() as u32,
                RV64_REGISTER_AS,
                RV64_MEMORY_AS,

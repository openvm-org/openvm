...
#[derive(new)]
pub struct LoadSignExtendWordChipGpu {
...
impl LoadSignExtendWordChipGpu {
    pub fn generate_proving_ctx_from_postflight(
        ...
        let step_range = replay_plan.opcode_range(LoadStoreOpcode::LOADW.global_opcode());
        ...
        unsafe {
            load_sign_extend_word_cuda::replay_tracegen(
                d_trace.buffer(),
                trace_height,
                ...
                LoadStoreOpcode::LOADW.global_opcode().as_usize() as u32,
                REGISTER_AS,
                MEMORY_AS,

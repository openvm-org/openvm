...
pub const LOAD_SIGN_EXTEND_HALFWORD_OVERLAP_CELLS: usize = LOAD_WIDTH_HALFWORD / 2 + 1;

pub type LoadSignExtendHalfwordCoreAir =
    LoadSignExtendCoreAir<LOAD_WIDTH_HALFWORD, LOAD_SIGN_EXTEND_HALFWORD_OVERLAP_CELLS>;

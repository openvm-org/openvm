...
use super::LOAD_SIGN_EXTEND_HALFWORD_SELECTOR_WIDTH;
use crate::{
...
impl Chip<DenseRecordArena, GpuBackend> for Rv64LoadSignExtendHalfwordChipGpu {
    fn generate_proving_ctx(&self, arena: DenseRecordArena) -> AirProvingContext<GpuBackend> {
        ...
        let delta_records = self.rvr_decode.device_delta_records(
            crate::rvr_gpu_decode::DeltaAirKind::LoadSignExtendHalfword,
        ...
        if rvr_wire || delta_records.is_some() {
            ...
            unsafe {
                load_sign_extend_halfword_cuda::tracegen_compact(
                    trace.buffer(),
                    compact_height,
                    &compact_records,
                    &table,

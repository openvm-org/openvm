...
use super::LOAD_SIGN_EXTEND_HALFWORD_OVERLAP_CELLS;
use crate::{
...
#[derive(new)]
pub struct LoadSignExtendHalfwordChipGpu {
...
impl LoadSignExtendHalfwordChipGpu {
    pub fn generate_proving_ctx_from_postflight(
        ...
        let step_range = replay_plan.opcode_range(LoadStoreOpcode::LOADH.global_opcode());
        ...
        unsafe {
            load_sign_extend_halfword_cuda::replay_tracegen(
                d_trace.buffer(),
                trace_height,
                ...
                LoadStoreOpcode::LOADH.global_opcode().as_usize() as u32,
                REGISTER_AS,
                MEMORY_AS,

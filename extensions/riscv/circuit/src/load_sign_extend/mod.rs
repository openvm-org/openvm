...
pub type Rv64LoadSignExtendAir = VmAirWrapper<
    ...
    LoadSignExtendCoreAir<RV64_REGISTER_NUM_LIMBS, RV64_BYTE_BITS>,
>;
pub type Rv64LoadSignExtendExecutor =
    LoadSignExtendExecutor<Rv64LoadStoreAdapterExecutor, RV64_REGISTER_NUM_LIMBS, RV64_BYTE_BITS>;

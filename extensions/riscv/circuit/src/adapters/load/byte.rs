...
use crate::adapters::{
    byte_ptr_limbs_to_cell_ptr_limbs_value, cell_ptr_hi_bits, checked_byte_ptr_to_u16_ptr_value,
    checked_register_u16_pointer, expand_to_rv64_block, ptr_to_field_u16_limbs, ptr_to_u16_limbs,

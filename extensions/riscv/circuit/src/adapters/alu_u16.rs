...
use crate::adapters::{imm_to_u64, RV64_U16_LIMB_BITS, RV64_U16_LIMB_MASK};
...
impl<AB: InteractionBuilder> VmAdapterAir<AB> for Rv64BaseAluU16AdapterAir {
    ...
    fn eval(
        ...
        let rs2_sign_u16 = local.rs2_imm_sign * AB::Expr::from_u32(RV64_U16_LIMB_MASK);
        ...
        self.range_bus
            .range_check(rs2_low_u16, RV64_U16_LIMB_BITS)
...
impl<F: PrimeField32> AdapterTraceExecutor<F> for Rv64BaseAluU16AdapterExecutor {
    ...
    fn read(
        ...
        let rs2 = if e.as_canonical_u32() == RV64_REGISTER_AS {
            ...
            let sign_u16 = (imm64 >> RV64_U16_LIMB_BITS) as u16;
...
impl<F: PrimeField32> AdapterTraceFiller<F> for Rv64BaseAluU16AdapterFiller {
    ...
    fn fill_trace_row(&self, mem_helper: &MemoryAuxColsFactory<F>, mut adapter_row: &mut [F]) {
        ...
        if record.rs2_as as u32 == RV64_IMM_AS {
            let imm_low_u16 = record.rs2 & RV64_U16_LIMB_MASK;
            self.range_checker_chip
                .add_count(imm_low_u16, RV64_U16_LIMB_BITS);
        }

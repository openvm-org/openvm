...
use crate::adapters::{
    ...
    checked_register_pointer, ptr_to_field_u16_limbs, u32_to_ptr_limbs, RV64_PTR_BITS, U16_BITS,
};
...
fn fill_row<F: PrimeField32>(
    ...
    cols.mem_ptr_inc_carry =
        F::from_u32((byte_limbs[0] + RV64_REGISTER_NUM_LIMBS as u32) >> U16_BITS);

...
use crate::{
    adapters::{
        ...
        Rv64StoreMultiByteAdapterFiller, BYTE_SHIFT_SELECTOR_WIDTH, STORE_WIDTH_WORD,
    },
    store::{
...
pub type StoreWordCoreAir =
    StoreCoreAir<STORE_WIDTH_WORD, BYTE_SHIFT_SELECTOR_WIDTH, STORE_WORD_VALUE_CELLS>;

...
fn create_store_halfword_harness(tester: &mut VmChipTestBuilder<F>) -> StoreHalfwordHarness {
...
fn negative_split_opcode_role_test() {
    ...
    let modify_trace = |trace: &mut DenseMatrix<F>| {
        ...
        let core: &mut StoreCoreCols<F, STORE_HALFWORD_SELECTOR_WIDTH> = core_row.borrow_mut();

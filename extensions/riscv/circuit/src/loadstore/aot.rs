...
use crate::{
    ...
    common::{address_space_start_to_gpr, *},
    LoadStoreExecutor,
};
    ...
    F: PrimeField32,
{
    ...
    fn generate_x86_metered_asm(
        ...
        let is_load = matches!(
            local_opcode,
            Rv64LoadStoreOpcode::LOADW | Rv64LoadStoreOpcode::LOADBU | Rv64LoadStoreOpcode::LOADHU
        );
...
fn is_aot_supported_impl<F: PrimeField32>(
    ...
    match local_opcode {
        Rv64LoadStoreOpcode::STOREW | Rv64LoadStoreOpcode::STOREH | Rv64LoadStoreOpcode::STOREB => {
            !is_native_store
        }
        _ => true,
    }
...
fn generate_x86_asm_impl<F: PrimeField32>(
    ...
    let local_opcode =
        Rv64LoadStoreOpcode::from_usize(opcode.local_opcode_idx(Rv64LoadStoreOpcode::CLASS_OFFSET));

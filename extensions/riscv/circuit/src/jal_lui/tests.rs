...
use crate::{
    adapters::{
        ...
        Rv64RdWriteAdapterFiller, RV64_BYTE_BITS, RV64_REGISTER_NUM_LIMBS, RV64_WORD_NUM_LIMBS,
        RV_IS_TYPE_IMM_BITS,
    },
...
const LIMB_MAX: u32 = (1 << RV64_BYTE_BITS) - 1;
...
#[cfg(feature = "cuda")]
#[test_case(Rv64JalLuiOpcode::JAL, 100)]
#[test_case(Rv64JalLuiOpcode::LUI, 100)]

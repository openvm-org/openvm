...
use crate::adapters::{
    Rv64CondRdWriteAdapterExecutor, Rv64CondRdWriteAdapterFiller, RV64_LOW32_U16_LIMBS,
    RV64_U16_LIMB_BASE, RV64_U16_LIMB_BITS, RV64_U16_LIMB_MASK, RV64_U16_SIGN_BIT,
    RV_IS_TYPE_IMM_BITS, RV_J_TYPE_IMM_BITS,
};

const LUI_IMM_LOW_BITS: usize = RV64_U16_LIMB_BITS - RV_IS_TYPE_IMM_BITS;
const PC_HIGH_U16_SHIFT: usize = 2 * RV64_U16_LIMB_BITS - PC_BITS;
    ...
    I::ProcessedInstruction: From<ImmInstruction<AB::Expr>>,
{
    fn eval(
        ...
        self.range_bus
            .range_check(rd[0], RV64_U16_LIMB_BITS)
            .eval(builder, is_valid.clone());
        self.range_bus
            .range_check(rd[1], RV64_U16_LIMB_BITS)
            .eval(builder, is_valid.clone());
        ...
        // PC_BITS - RV64_U16_LIMB_BITS bits above the low u16 cell.
        self.range_bus
            .range_check(
                rd[1] * AB::F::from_u32(1 << PC_HIGH_U16_SHIFT),
                RV64_U16_LIMB_BITS,
            )
            .eval(builder, is_jal);
    ...
    A: 'static + AdapterTraceFiller<F>,
{
    fn fill_trace_row(&self, mem_helper: &MemoryAuxColsFactory<F>, row_slice: &mut [F]) {
        ...
        self.range_checker_chip
            .add_count(rd_lo as u32, RV64_U16_LIMB_BITS);
        self.range_checker_chip
            .add_count(rd_hi as u32, RV64_U16_LIMB_BITS);
        let is_sign_extend = (rd_hi >> RV64_U16_SIGN_BIT) & 1;
        let sign_check = 2u32 * (rd_hi as u32) - (is_sign_extend as u32) * RV64_U16_LIMB_BASE;
        self.range_checker_chip
            .add_count(sign_check, RV64_U16_LIMB_BITS);
        ...
        if record.is_jal {
            self.range_checker_chip
                .add_count((rd_hi as u32) << PC_HIGH_U16_SHIFT, RV64_U16_LIMB_BITS);
        }
...
pub(super) fn run_jal_lui(is_jal: bool, pc: u32, imm: i32) -> (u32, [u16; BLOCK_FE_WIDTH]) {
    if is_jal {
        ...
        let lo = (rd_low & RV64_U16_LIMB_MASK) as u16;
        let hi = (rd_low >> RV64_U16_LIMB_BITS) as u16;

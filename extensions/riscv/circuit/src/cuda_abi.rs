...
pub mod add_cuda {
    ...
    pub unsafe fn tracegen(
        ...
        let width = d_trace.len() / height;
        CudaError::from_result(_add_tracegen(
            d_trace.as_mut_ptr(),
            height,
            width,
            d_records.view(),
...
pub mod and_cuda {
    ...
    pub unsafe fn tracegen(
        ...
        let width = d_trace.len() / height;
        CudaError::from_result(_and_tracegen(
            d_trace.as_mut_ptr(),
            height,
            width,
            d_records.view(),
...
pub mod or_cuda {
    ...
    pub unsafe fn tracegen(
        ...
        let width = d_trace.len() / height;
        CudaError::from_result(_or_tracegen(
            d_trace.as_mut_ptr(),
            height,
            width,
            d_records.view(),
...
pub mod xor_cuda {
    ...
    pub unsafe fn tracegen(
        ...
        let width = d_trace.len() / height;
        CudaError::from_result(_xor_tracegen(
            d_trace.as_mut_ptr(),
            height,
            width,
            d_records.view(),
...
pub mod add_sub_w_cuda {
    ...
    pub unsafe fn tracegen(
        ...
        let width = d_trace.len() / height;
        CudaError::from_result(_add_sub_w_tracegen(
            d_trace.as_mut_ptr(),
            height,
            width,
            d_records.view(),

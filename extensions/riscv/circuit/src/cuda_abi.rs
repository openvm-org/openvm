...
pub mod rvr_delta_cuda {
    ...
    pub unsafe fn predecode(
        ...
        program_count: usize,
        d_touched: &DeviceBuffer<openvm_circuit::arch::rvr::TouchedBlock>,
        touched_count: usize,
...
pub mod loadstore_cuda {
    ...
    extern "C" {
        ...
        pub fn _rv64_load_store_tracegen_compact(
            d_trace: *mut F,
            height: usize,
            width: usize,
            d_records: DeviceBufferView,
    ...
    pub unsafe fn tracegen_compact(
        ...
        CudaError::from_result(_rv64_load_store_tracegen_compact(
            d_trace.as_mut_ptr(),
            height,
            width,
            d_records.view(),
...
pub mod load_sign_extend_cuda {
    ...
    extern "C" {
        ...
        pub fn _rv64_load_sign_extend_tracegen_compact(
            d_trace: *mut F,
            height: usize,
            width: usize,
            d_records: DeviceBufferView,
    ...
    pub unsafe fn tracegen_compact(
        ...
        CudaError::from_result(_rv64_load_sign_extend_tracegen_compact(
            d_trace.as_mut_ptr(),
            height,
            width,
            d_records.view(),

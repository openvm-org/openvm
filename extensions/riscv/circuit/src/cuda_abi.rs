...
pub mod shift_cuda {
    ...
    pub unsafe fn tracegen_left(
        ...
        CudaError::from_result(_rv64_shift_left_tracegen(
            d_trace.as_mut_ptr(),
            height,
            d_trace.len() / height,
            d_records.view(),
    ...
    pub unsafe fn tracegen_right(
        ...
        CudaError::from_result(_rv64_shift_right_tracegen(
            d_trace.as_mut_ptr(),
            height,
            d_trace.len() / height,
            d_records.view(),
...
pub mod shift_w_cuda {
    ...
    extern "C" {
        fn _rv64_shift_w_left_tracegen(
            d_trace: *mut F,
            height: usize,
            width: usize,
            d_records: DeviceBufferView,
        ...
        fn _rv64_shift_w_right_tracegen(
            d_trace: *mut F,
            height: usize,
            width: usize,
            d_records: DeviceBufferView,
    ...
    pub unsafe fn tracegen_left(
        ...
        CudaError::from_result(_rv64_shift_w_left_tracegen(
            d_trace.as_mut_ptr(),
            height,
            d_trace.len() / height,
            d_records.view(),
    ...
    pub unsafe fn tracegen_right(
        ...
        CudaError::from_result(_rv64_shift_w_right_tracegen(
            d_trace.as_mut_ptr(),
            height,
            d_trace.len() / height,
            d_records.view(),

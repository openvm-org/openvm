...
pub mod loadstore_byte_cuda {
    use super::*;

    extern "C" {
        fn _rv64_load_store_byte_tracegen(
            d_trace: *mut F,
            height: usize,
            width: usize,
            d_records: DeviceBufferView,
    ...
    pub unsafe fn tracegen(
        ...
        CudaError::from_result(_rv64_load_store_byte_tracegen(
            d_trace.as_mut_ptr(),
            height,
            d_trace.len() / height,
            d_records.view(),
...
pub mod loadstore_halfword_cuda {
    use super::*;

    extern "C" {
        fn _rv64_load_store_halfword_tracegen(
            d_trace: *mut F,
            height: usize,
            width: usize,
            d_records: DeviceBufferView,
    ...
    pub unsafe fn tracegen(
        ...
        CudaError::from_result(_rv64_load_store_halfword_tracegen(
            d_trace.as_mut_ptr(),
            height,
            d_trace.len() / height,
            d_records.view(),
...
pub mod loadstore_word_cuda {
    use super::*;

    extern "C" {
        fn _rv64_load_store_word_tracegen(
            d_trace: *mut F,
            height: usize,
            width: usize,
            d_records: DeviceBufferView,
    ...
    pub unsafe fn tracegen(
        ...
        CudaError::from_result(_rv64_load_store_word_tracegen(
            d_trace.as_mut_ptr(),
            height,
            d_trace.len() / height,
            d_records.view(),
...
pub mod loadstore_doubleword_cuda {
    use super::*;

    extern "C" {
        fn _rv64_load_store_doubleword_tracegen(
            d_trace: *mut F,
            height: usize,
            width: usize,
            d_records: DeviceBufferView,
    ...
    pub unsafe fn tracegen(
        ...
        CudaError::from_result(_rv64_load_store_doubleword_tracegen(
            d_trace.as_mut_ptr(),
            height,
            d_trace.len() / height,
            d_records.view(),

...
pub mod addi_w_cuda {
    ...
    pub unsafe fn tracegen_compact(
        ...
        CudaError::from_result(_addi_w_tracegen_compact(
            d_trace.as_mut_ptr(),
            height,
            d_trace.len() / height,
            d_records.view(),
...
pub mod shift_logical_imm_cuda {
    ...
    extern "C" {
        ...
        fn _shift_logical_imm_tracegen_compact(
            d_trace: *mut F,
            height: usize,
            width: usize,
            d_records: DeviceBufferView,
    ...
    pub unsafe fn tracegen_compact(
        ...
        CudaError::from_result(_shift_logical_imm_tracegen_compact(
            d_trace.as_mut_ptr(),
            height,
            d_trace.len() / height,
            d_records.view(),
...
pub mod shift_w_logical_imm_cuda {
    ...
    extern "C" {
        ...
        fn _shift_w_logical_imm_tracegen_compact(
            d_trace: *mut F,
            height: usize,
            width: usize,
            d_records: DeviceBufferView,
    ...
    pub unsafe fn tracegen_compact(
        ...
        CudaError::from_result(_shift_w_logical_imm_tracegen_compact(
            d_trace.as_mut_ptr(),
            height,
            d_trace.len() / height,
            d_records.view(),
...
pub mod shift_right_arithmetic_imm_cuda {
    ...
    extern "C" {
        ...
        fn _shift_right_arithmetic_imm_tracegen_compact(
            d_trace: *mut F,
            height: usize,
            width: usize,
            d_records: DeviceBufferView,
    ...
    pub unsafe fn tracegen_compact(
        ...
        CudaError::from_result(_shift_right_arithmetic_imm_tracegen_compact(
            d_trace.as_mut_ptr(),
            height,
            d_trace.len() / height,
            d_records.view(),
...
pub mod shift_w_right_arithmetic_imm_cuda {
    ...
    extern "C" {
        ...
        fn _shift_w_right_arithmetic_imm_tracegen_compact(
            d_trace: *mut F,
            height: usize,
            width: usize,
            d_records: DeviceBufferView,
    ...
    pub unsafe fn tracegen_compact(
        ...
        CudaError::from_result(_shift_w_right_arithmetic_imm_tracegen_compact(
            d_trace.as_mut_ptr(),
            height,
            d_trace.len() / height,
            d_records.view(),
...
pub mod less_than_imm_cuda {
    ...
    extern "C" {
        ...
        fn _less_than_imm_tracegen_compact(
            d_trace: *mut F,
            height: usize,
            width: usize,
            d_records: DeviceBufferView,
    ...
    pub unsafe fn tracegen_compact(
        ...
        CudaError::from_result(_less_than_imm_tracegen_compact(
            d_trace.as_mut_ptr(),
            height,
            d_trace.len() / height,
            d_records.view(),
...
pub mod bitwise_logic_imm_cuda {
    ...
    extern "C" {
        ...
        fn _bitwise_logic_imm_tracegen_compact(
            d_trace: *mut F,
            height: usize,
            width: usize,
            d_records: DeviceBufferView,
    ...
    pub unsafe fn tracegen_compact(
        ...
        CudaError::from_result(_bitwise_logic_imm_tracegen_compact(
            d_trace.as_mut_ptr(),
            height,
            d_trace.len() / height,
            d_records.view(),

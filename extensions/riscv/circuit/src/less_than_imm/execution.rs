    ...
    F: PrimeField32,
{
        ...
        Ctx: ExecutionCtxTrait,
    {
        ...
        Ok(match opcode {
            LessThanImmOpcode::SLTI => execute_e1_handler::<F, Ctx, true, SltOp>,
            LessThanImmOpcode::SLTIU => execute_e1_handler::<F, Ctx, true, SltuOp>,
        })
    }
    ...
    F: PrimeField32,
{
        ...
        Ctx: MeteredExecutionCtxTrait,
    {
        ...
        Ok(match opcode {
            LessThanImmOpcode::SLTI => execute_e2_handler::<F, Ctx, true, SltOp>,
            LessThanImmOpcode::SLTIU => execute_e2_handler::<F, Ctx, true, SltuOp>,
        })
    }

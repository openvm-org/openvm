...
#[repr(C)]
struct ShiftLeftPreCompute {
    c: u64,
    a: u8,
    b: u8,
}

impl<A, const LIMB_BITS: usize> ShiftLeftExecutor<A, { RV64_REGISTER_NUM_LIMBS }, LIMB_BITS> {
    #[inline(always)]
    fn pre_compute_impl<F: PrimeField32>(
        &self,
        pc: u32,
        inst: &Instruction<F>,
        data: &mut ShiftLeftPreCompute,
...
impl<F, A, const LIMB_BITS: usize> InterpreterExecutor<F>
    for ShiftLeftExecutor<A, { RV64_REGISTER_NUM_LIMBS }, LIMB_BITS>
where
    F: PrimeField32,
{
    fn pre_compute_size(&self) -> usize {
        size_of::<ShiftLeftPreCompute>()
    }
    ...
    fn pre_compute<Ctx: ExecutionCtxTrait>(
        ...
        let data: &mut ShiftLeftPreCompute = data.borrow_mut();
    ...
    F: PrimeField32,
{
    fn metered_pre_compute_size(&self) -> usize {
        size_of::<E2PreCompute<ShiftLeftPreCompute>>()
    }
    ...
    fn metered_pre_compute<Ctx: MeteredExecutionCtxTrait>(
        ...
        let data: &mut E2PreCompute<ShiftLeftPreCompute> = data.borrow_mut();
...
unsafe fn execute_e12_impl<F: PrimeField32, CTX: ExecutionCtxTrait, const IS_IMM: bool>(
    pre_compute: &ShiftLeftPreCompute,
    ...
    // Execute the shift-left operation.
...
unsafe fn execute_e1_impl<F: PrimeField32, CTX: ExecutionCtxTrait, const IS_IMM: bool>(
    ...
    let pre_compute: &ShiftLeftPreCompute =
        std::slice::from_raw_parts(pre_compute, size_of::<ShiftLeftPreCompute>()).borrow();
...
unsafe fn execute_e2_impl<F: PrimeField32, CTX: MeteredExecutionCtxTrait, const IS_IMM: bool>(
    ...
    let pre_compute: &E2PreCompute<ShiftLeftPreCompute> =
        std::slice::from_raw_parts(pre_compute, size_of::<E2PreCompute<ShiftLeftPreCompute>>())
            .borrow();
    exec_state
        .ctx

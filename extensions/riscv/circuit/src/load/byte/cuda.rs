...
impl Rv64LoadByteChipGpu {
    pub fn generate_proving_ctx_from_postflight(
        ...
        let step_range = replay_plan.opcode_range(Rv64LoadStoreOpcode::LOADBU.global_opcode());
        ...
        unsafe {
            load_byte_cuda::replay_tracegen(
                ...
                Rv64LoadStoreOpcode::LOADBU.global_opcode().as_usize() as u32,
                RV64_REGISTER_AS,
                RV64_MEMORY_AS,

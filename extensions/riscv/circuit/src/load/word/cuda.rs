...
impl LoadWordChipGpu {
    pub fn generate_proving_ctx_from_postflight(
        ...
        let step_range = replay_plan.opcode_range(LoadStoreOpcode::LOADWU.global_opcode());
        ...
        unsafe {
            load_word_cuda::replay_tracegen(
                ...
                LoadStoreOpcode::LOADWU.global_opcode().as_usize() as u32,
                REGISTER_AS,
                MEMORY_AS,

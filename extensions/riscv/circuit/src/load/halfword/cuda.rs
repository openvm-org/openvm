...
#[derive(new)]
pub struct LoadHalfwordChipGpu {
...
impl LoadHalfwordChipGpu {
    pub fn generate_proving_ctx_from_postflight(
        ...
        let step_range = replay_plan.opcode_range(LoadStoreOpcode::LOADHU.global_opcode());
        ...
        unsafe {
            load_halfword_cuda::replay_tracegen(
                ...
                LoadStoreOpcode::LOADHU.global_opcode().as_usize() as u32,
                REGISTER_AS,
                MEMORY_AS,

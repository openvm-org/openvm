...
use crate::{
    adapters::{Rv64BranchAdapterCols, Rv64BranchAdapterRecord, RV64_U16_LIMB_BITS},
...
impl Chip<DenseRecordArena, GpuBackend> for Rv64BranchLessThanChipGpu {
    fn generate_proving_ctx(&self, arena: DenseRecordArena) -> AirProvingContext<GpuBackend> {
        const RECORD_SIZE: usize = size_of::<(
            ...
            BranchLessThanCoreRecord<BLOCK_FE_WIDTH, RV64_U16_LIMB_BITS>,
        )>();
        ...
        let trace_width = BranchLessThanCoreCols::<F, BLOCK_FE_WIDTH, RV64_U16_LIMB_BITS>::width()

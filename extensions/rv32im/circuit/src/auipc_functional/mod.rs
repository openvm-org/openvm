...
impl<AB: InteractionBuilder> Air<AB> for Rv32AuipcFunctionalAir {
    fn eval(&self, builder: &mut AB) {
        ...
        builder.when(cell(0)).assert_eq(
            (((cell(2)
                - cell(5)
                - (constant_expr(256) * cell(3))
                - (constant_expr(256) * constant(256) * cell(4)))
                * (constant(256) * constant(256) * constant(256)).inverse())
                + cell(18)
                + ((cell(4)
                + cell(17)
                + ((cell(3) + cell(16) - cell(6)) * constant(256).inverse())
                - cell(7))
        ...
        "line 434, column 5: x * x ";
        builder.when(cell(0)).assert_eq(
            (cell(4) + cell(17) + ((cell(3) + cell(16) - cell(6)) * constant(256).inverse())
                - cell(7))
                * constant(256).inverse()
                * (cell(4) + cell(17) + ((cell(3) + cell(16) - cell(6)) * constant(256).inverse())
                - cell(7))
        ...
        builder.push_interaction(
            self.custom_bus_range_check,
            [
                cell(1) - cell(10) - UF_1_0 - (constant_expr(65536) * cell(11)),
        ...
        builder.push_interaction(
            ...
            [cell(7), cell(8), AB::Expr::from(U8F_0_0), constant_expr(0)],
            constant_expr(1) * cell(0),
            1,
        );
        "line 116, column 5: bitwise << x, y, 0U8F, 0;";
        builder.push_interaction(
            self.custom_bus_bitwise,
            [cell(5), cell(6), AB::Expr::from(U8F_0_0), constant_expr(0)],
            constant_expr(1) * cell(0),
            1,
        );
        ...
        builder.push_interaction(
            ...
            [
                ...
                AB::Expr::from(UF_0_0),
                cell(16)
                    + (constant_expr(256) * cell(17))
                    + (constant_expr(256) * constant(256) * cell(18)),
                AB::Expr::from(UF_1_0),
                AB::Expr::from(UF_0_0),
                AB::Expr::from(UF_0_0),
                AB::Expr::from(UF_0_0),
        ...
        builder.push_interaction(
            self.custom_bus_bitwise,
            [cell(3), cell(16), AB::Expr::from(U8F_0_0), constant_expr(0)],
            constant_expr(1) * cell(0),
            1,
        );
        "line 116, column 5: bitwise << x, y, 0U8F, 0;";
        ...
        builder.push_interaction(
            self.custom_bus_bitwise,
            [cell(4), cell(17), AB::Expr::from(U8F_0_0), constant_expr(0)],
            constant_expr(1) * cell(0),
            1,
        );
    }

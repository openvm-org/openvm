    ...
    A: 'static + AdapterTraceFiller<F>,
{
    fn fill_trace_row(&self, mem_helper: &MemoryAuxColsFactory<F>, row_slice: &mut [F]) {
        ...
        // AdapterFiller::WIDTH + LessThanCoreCols::width() elements. A::WIDTH is the
        ...
        // LessThanCoreRecord serialized representation at this point, as written
        // by the executor during trace generation. get_record_from_slice
        // correctly interprets the bytes as LessThanCoreRecord with proper alignment.

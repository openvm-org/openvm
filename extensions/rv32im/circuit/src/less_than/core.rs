...
use openvm_rv32im_transpiler::{BaseAluOpcode, LessThanOpcode};
    ...
    F: PrimeField32,
{
    ...
    fn pre_compute(&self, inst: &Instruction<F>, data: &mut [u8]) {
        ...
        *pre_compute = LessThanPreCompute {
            ...
            e_is_imm: e_u32 == RV32_IMM_AS,
            is_u32: local_opcode == LessThanOpcode::SLTU,
        };
    }
}
...
unsafe fn execute_e1_impl<F: PrimeField32, CTX: E1E2ExecutionCtx>(
    ...
    vm_state.vm_write(RV32_REGISTER_AS, pre_compute.a, &rd);

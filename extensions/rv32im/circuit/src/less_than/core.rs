...
pub struct LessThanStep<AdapterAir, AdapterStep, const NUM_LIMBS: usize, const LIMB_BITS: usize> {
    air: VmAirWrapper<AdapterAir, LessThanCoreAir<NUM_LIMBS, LIMB_BITS>>,
    adapter: AdapterStep,
...
impl<AdapterAir, AdapterStep, const NUM_LIMBS: usize, const LIMB_BITS: usize> ChipUsageGetter
    for LessThanStep<AdapterAir, AdapterStep, NUM_LIMBS, LIMB_BITS>
{

...
pub struct DivRemStep<AdapterAir, AdapterStep, const NUM_LIMBS: usize, const LIMB_BITS: usize> {
    air: VmAirWrapper<AdapterAir, DivRemCoreAir<NUM_LIMBS, LIMB_BITS>>,
    adapter: AdapterStep,
    pub offset: usize,
...
impl<AdapterAir, AdapterStep, const NUM_LIMBS: usize, const LIMB_BITS: usize> ChipUsageGetter
    for DivRemStep<AdapterAir, AdapterStep, NUM_LIMBS, LIMB_BITS>
{
...
impl<AdapterAir, AdapterStep, const NUM_LIMBS: usize, const LIMB_BITS: usize>
    DivRemStep<AdapterAir, AdapterStep, NUM_LIMBS, LIMB_BITS>
{
    pub fn new(
        air: VmAirWrapper<AdapterAir, DivRemCoreAir<NUM_LIMBS, LIMB_BITS>>,
        adapter: AdapterStep,

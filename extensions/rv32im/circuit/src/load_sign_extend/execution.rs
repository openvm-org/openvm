...
>(
    ...
    execute_e12_impl::<F, CTX, IS_LOADB, ENABLED>(pre_compute, pc, instret, exec_state);
}
...
>(
    ...
    execute_e12_impl::<F, CTX, IS_LOADB, ENABLED>(&pre_compute.data, pc, instret, exec_state);
}

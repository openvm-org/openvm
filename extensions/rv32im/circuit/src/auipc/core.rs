    ...
    A: 'static + AdapterTraceFiller<F>,
{
    fn fill_trace_row(&self, mem_helper: &MemoryAuxColsFactory<F>, row_slice: &mut [F]) {
        ...
        // AdapterFiller::WIDTH + Rv32AuipcCoreCols::width() elements. A::WIDTH is the
        ...
        // Rv32AuipcCoreRecord serialized representation at this point, as written
        // by the executor during trace generation. get_record_from_slice
        // correctly interprets the bytes as Rv32AuipcCoreRecord with proper alignment.

...
impl<AB: InteractionBuilder> Air<AB> for Rv32AuipcDazlAir {
    fn eval(&self, builder: &mut AB) {
        ...
        let name_pc_middle = [cell(6), cell(7)];
        ...
        let inline_0_name_start_t = cell(8);
        ...
        let name_imm_bytes = [cell(9), cell(10), cell(11)];
        ...
        let inline_2_name_prev_t = cell(12);
        ...
        let inline_2_name_prev_data = [cell(13), cell(14), cell(15), cell(16)];
        let anonymous_27_line_0_column_0 = constant_expr(576);
        let name_rd_ptr = cell(17);
        ...
        let inline_2_1_name_upper = cell(18);
        let temp: AB::F;
        temp = {
            let result: AB::F;
    ...
    RecordArena<'buf, MultiRowLayout<EmptyMultiRowMetadata>, &'buf mut Rv32AuipcDazlRecord>,
{
    ...
    fn execute(
        ...
        "line 19, column 15: operands[2]";
        anonymous_25_line_0_column_0 = name_operands[2];
        "line 19, column 9: imm = operands[2]";

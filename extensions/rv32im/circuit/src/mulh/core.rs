    ...
    A: 'static + AdapterTraceFiller<F>,
{
    fn fill_trace_row(&self, mem_helper: &MemoryAuxColsFactory<F>, row_slice: &mut [F]) {
        ...
        // AdapterFiller::WIDTH + MulHCoreCols::width() elements. A::WIDTH is the
        ...
        // MulHCoreRecord serialized representation at this point, as written
        // by the executor during trace generation. get_record_from_slice
        // correctly interprets the bytes as MulHCoreRecord with proper alignment.

...
impl<F: PrimeField32> VmExtension<F> for Rv32I {
    ...
    fn build(
        ...
        let load_sign_extend_chip = Rv32LoadSignExtendChip::new(
            ...
            LoadSignExtendCoreChip::new(range_checker.clone(), Rv32LoadStoreOpcode::CLASS_OFFSET),
            offline_memory.clone(),
        );
        inventory.add_executor(
        ...
        let jal_lui_chip = Rv32JalLuiChip::new(
            ...
            Rv32JalLuiCoreChip::new(bitwise_lu_chip.clone(), Rv32JalLuiOpcode::CLASS_OFFSET),
            offline_memory.clone(),
        );
        inventory.add_executor(
            jal_lui_chip,
        ...
        let auipc_chip = Rv32AuipcChip::new(
            ...
            Rv32AuipcCoreChip::new(bitwise_lu_chip.clone(), Rv32AuipcOpcode::CLASS_OFFSET),
            offline_memory.clone(),
        );
        inventory.add_executor(
            auipc_chip,
...
impl<F: PrimeField32> VmExtension<F> for Rv32Io {
    ...
    fn build(
        ...
        let mut hintstore_chip = Rv32HintStoreChip::new(
            ...
            Rv32HintStoreCoreChip::new(bitwise_lu_chip.clone(), Rv32HintStoreOpcode::CLASS_OFFSET),
            offline_memory.clone(),
        );

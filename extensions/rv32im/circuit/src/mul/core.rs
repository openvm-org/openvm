...
unsafe fn execute_e1_impl<F: PrimeField32, CTX: E1E2ExecutionCtx>(
    ...
    let rs1: [u8; RV32_REGISTER_NUM_LIMBS] = vm_state.vm_read(RV32_REGISTER_AS, pre_compute.b);
    let rs2: [u8; RV32_REGISTER_NUM_LIMBS] = vm_state.vm_read(RV32_REGISTER_AS, pre_compute.c);
    let rs1 = u32::from_le_bytes(rs1);
    let rs2 = u32::from_le_bytes(rs2);
    let rd = rs1.wrapping_mul(rs2);
    vm_state.vm_write(RV32_REGISTER_AS, pre_compute.a, &rd.to_le_bytes());

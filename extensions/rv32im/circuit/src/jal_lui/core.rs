...
pub struct Rv32JalLuiStep<AdapterAir, AdapterStep> {
    air: VmAirWrapper<AdapterAir, Rv32JalLuiCoreAir>,
    adapter: AdapterStep,
    pub bitwise_lookup_chip: SharedBitwiseOperationLookupChip<RV32_CELL_BITS>,
}

impl<AdapterAir, AdapterStep> ChipUsageGetter for Rv32JalLuiStep<AdapterAir, AdapterStep> {
...
impl<F, AdapterAir, AdapterStep> TraceStep<F> for Rv32JalLuiStep<AdapterAir, AdapterStep>
where
    F: PrimeField32,
    AdapterStep: 'static
        + for<'a> AdapterTraceStep<F, ReadData = (), WriteData = [u8; RV32_REGISTER_NUM_LIMBS]>,
{
    ...
    type RecordMut<'a> = (AdapterStep::RecordMut<'a>, &'a mut Rv32JalLuiStepRecord);
...
impl<F, AdapterAir, AdapterStep> TraceFiller<F> for Rv32JalLuiStep<AdapterAir, AdapterStep>
where
    F: PrimeField32,
...
impl<F, AdapterAir, AdapterStep> StepExecutorE1<F> for Rv32JalLuiStep<AdapterAir, AdapterStep>
where
    F: PrimeField32,
    AdapterStep: 'static

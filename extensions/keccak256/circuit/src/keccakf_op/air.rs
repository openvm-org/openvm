...
use openvm_riscv_circuit::adapters::{
    compose_rv64_u16_limbs, expand_to_rv64_block, rv64_ptr_max_bits_shift, RV64_PTR_U16_LIMBS,
    RV64_U16_LIMB_BITS,
};
...
impl<AB: InteractionBuilder> Air<AB> for KeccakfOpAir {
    fn eval(&self, builder: &mut AB) {
        ...
        let ptr_shift = AB::F::from_usize(1 << rv64_ptr_max_bits_shift(self.ptr_max_bits));
        self.range_bus
            .range_check(
                local.buffer_ptr_limbs[RV64_PTR_U16_LIMBS - 1] * ptr_shift,
                RV64_U16_LIMB_BITS,
            )
            .eval(builder, is_valid);
        ...
        // Constrain the pre- and post-state against the KeccakF periphery.

...
use openvm_riscv_circuit::adapters::{
    rv64_bytes_to_u32, rv64_ptr_max_bits_shift, timed_write, tracing_read, u32_to_le_u16_cells,
    u32_to_le_u16_limbs, RV64_PTR_U16_LIMBS, RV64_U16_LIMB_BITS,
};
    ...
    fn fill_trace(
        ...
        trace
            ...
            .for_each(|(row, record)| {
                ...
                let mem_ptr_msl_lshift = rv64_ptr_max_bits_shift(self.pointer_max_bits) as u32;
                let buffer_ptr_high_u16 =
                    u32_to_le_u16_cells(record.buffer_ptr)[RV64_PTR_U16_LIMBS - 1] as u32;
                self.range_checker_chip.add_count(
                    buffer_ptr_high_u16 << mem_ptr_msl_lshift,
                    RV64_U16_LIMB_BITS,
                );
            });

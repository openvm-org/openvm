    ...
    for item in items.into_iter() {
        ...
        let result = TokenStream::from(quote::quote_spanned! { span.into() =>
            ...
            impl #struct_name {
                ...
                #[cfg(target_os = "zkvm")]
                fn set_up_once() {
                    static is_setup: ::openvm_ecc_guest::weierstrass::once_cell::race::OnceBool = ::openvm_ecc_guest::weierstrass::once_cell::race::OnceBool::new();
                    ...
                    is_setup.get_or_init(|| {
                        ...
                        let modulus_bytes = <<Self as openvm_ecc_guest::weierstrass::weierstrass::WeierstrassPoint>::Coordinate as openvm_algebra_guest::IntMod>::MODULUS;
                        let mut one = [0u8; <<Self as openvm_ecc_guest::weierstrass::weierstrass::WeierstrassPoint>::Coordinate as openvm_algebra_guest::IntMod>::NUM_LIMBS];
                        one[0] = 1;
                        let curve_a_bytes = openvm_algebra_guest::IntMod::as_le_bytes(&<#struct_name as openvm_ecc_guest::weierstrass::weierstrass::WeierstrassPoint>::CURVE_A);
                        // p1 should be (p, a)
            ...
            impl ::openvm_ecc_guest::weierstrass::weierstrass::WeierstrassPoint for #struct_name {
            ...
            mod #group_ops_mod_name {
                use ::openvm_ecc_guest::weierstrass::{weierstrass::{WeierstrassPoint}, FromCompressed, impl_sw_group_ops, algebra::IntMod};
                use super::*;
                ...
                impl FromCompressed<#intmod_type> for #struct_name {
                    fn decompress(x: #intmod_type, rec_id: &u8) -> Option<Self> {
                        ...
                        let y_squared = &x * &x * &x + &<#struct_name as ::openvm_ecc_guest::weierstrass::weierstrass::WeierstrassPoint>::CURVE_A * &x + &<#struct_name as ::openvm_ecc_guest::weierstrass::weierstrass::WeierstrassPoint>::CURVE_B;
                        ...
                        match y {
                            ...
                            Some(y) => {
                                ...
                                Some(<#struct_name as ::openvm_ecc_guest::weierstrass::weierstrass::WeierstrassPoint>::from_xy_unchecked(x, correct_y))
                            }
                        }
                    }
                }
    ...
    for (ec_idx, struct_id) in items.into_iter().enumerate() {
        ...
        externs.push(quote::quote_spanned! { span.into() =>
            ...
            extern "C" fn #setup_extern_func(uninit: *mut core::ffi::c_void, p1: *const u8, p2: *const u8) {
                ...
                {
                    openvm::platform::custom_insn_r!(
                        opcode = ::openvm_ecc_guest::weierstrass::OPCODE,
                        funct3 = ::openvm_ecc_guest::weierstrass::SW_FUNCT3 as usize,
                        funct7 = ::openvm_ecc_guest::weierstrass::SwBaseFunct7::SwSetup as usize
                            + #ec_idx

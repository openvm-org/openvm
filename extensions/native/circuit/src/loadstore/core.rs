    ...
    A: 'static + AdapterTraceFiller<F>,
{
    fn fill_trace_row(&self, mem_helper: &MemoryAuxColsFactory<F>, row_slice: &mut [F]) {
        ...
        // AdapterFiller::WIDTH + NativeLoadStoreCoreCols::width() elements. A::WIDTH is the
        ...
        // NativeLoadStoreCoreRecord serialized representation at this point, as written
        // by the executor during trace generation. get_record_from_slice
        // correctly interprets the bytes as NativeLoadStoreCoreRecord with proper alignment.

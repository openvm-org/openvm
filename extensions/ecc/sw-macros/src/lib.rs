    ...
    for item in items.into_iter() {
        ...
        let result = TokenStream::from(quote::quote_spanned! { span.into() =>
            ...
            impl #struct_name {
                ...
                /// The curve guest libraries discharge the preconditions in their `mul_scalar`
                /// wrappers.
                ///
                /// # Safety
                ///
                ...
                /// must also lie in the prime-order subgroup. Violations make the trace
                /// unprovable. Only set `CHECK_SETUP` to `false` if you are sure that setup has
                /// been called already.

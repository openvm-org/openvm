    ...
    for item in items.into_iter() {
        ...
        let result = TokenStream::from(quote::quote_spanned! { span.into() =>
            ...
            impl #struct_name {
                ...
                /// # Safety
                ///
                /// `scalar` must be less than the order of the subgroup generated by `self`. The
                /// ladder's addition uses the incomplete affine formula, and for a scalar at or
                /// above the order an intermediate doubling can share an x-coordinate with `self`,

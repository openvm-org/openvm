...
use openvm_algebra_circuit::{ModularConfig, ModularConfigExecutor, ModularCpuBuilder};
use openvm_circuit::{
    arch::{
...
cfg_if::cfg_if! {
    if #[cfg(feature = "cuda")] {
        ...
        pub use {
            ...
            WeierstrassHybridBuilder as WeierstrassBuilder,
        };
    } else {
        pub use self::{
            EccCpuProverExt as EccProverExt,
            WeierstrassCpuBuilder as WeierstrassBuilder,
        };
    }
}
...
impl WeierstrassConfig {
    pub fn new(curves: Vec<CurveConfig>) -> Self {
        let primes: Vec<_> = curves
            ...
            .collect();
        Self {
            modular: ModularConfig::new(primes),
            weierstrass: WeierstrassExtension::new(curves),
        }
    }
}

impl InitFileGenerator for WeierstrassConfig {
...
#[derive(Clone)]
pub struct WeierstrassCpuBuilder;

impl<SC, E> VmBuilder<E> for WeierstrassCpuBuilder
where

    ...
    fn extend_prover(
        ...
        for curve in extension.supported_curves.iter() {
            ...
            if bytes <= NUM_LIMBS_32 {
                ...
                let addne = get_ec_addne_chip::<F, ECC_BLOCKS_32, MEMORY_BLOCK_BYTES>(
                    config.clone(),
                    mem_helper.clone(),
                    range_checker.clone(),
                    bitwise_lu.clone(),
                ...
                let double = get_ec_double_chip::<F, ECC_BLOCKS_32, MEMORY_BLOCK_BYTES>(
                    config,
                    mem_helper.clone(),
                    range_checker.clone(),
                    bitwise_lu.clone(),
                ...
                let addne = get_ec_addne_chip::<F, ECC_BLOCKS_48, MEMORY_BLOCK_BYTES>(
                    config.clone(),
                    mem_helper.clone(),
                    range_checker.clone(),
                    bitwise_lu.clone(),
                ...
                let double = get_ec_double_chip::<F, ECC_BLOCKS_48, MEMORY_BLOCK_BYTES>(
                    config,
                    mem_helper.clone(),
                    range_checker.clone(),
                    bitwise_lu.clone(),

use halo2curves_axiom::{bn256::Fq, ff::PrimeField};
...
#[inline(always)]
pub fn ec_add_ne_bn254<const BLOCKS: usize, const BLOCK_SIZE: usize>(
...
#[inline(always)]
pub fn ec_double_bn254<const BLOCKS: usize, const BLOCK_SIZE: usize>(

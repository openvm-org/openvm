...
using LessThan256CoreRecord =
    LessThanCoreRecord<INT256_NUM_U16_LIMBS, RV64_U16_LIMB_BITS>;
using LessThan256Core = LessThanCore<INT256_NUM_U16_LIMBS, RV64_U16_LIMB_BITS>;
template <typename T>
using LessThan256CoreCols =
    LessThanCoreCols<T, INT256_NUM_U16_LIMBS, RV64_U16_LIMB_BITS>;
...
using BranchLessThan256Core = BranchLessThanCore<INT256_NUM_U16_LIMBS, RV64_U16_LIMB_BITS>;
template <typename T>
using BranchLessThan256CoreCols =
    BranchLessThanCoreCols<T, INT256_NUM_U16_LIMBS, RV64_U16_LIMB_BITS>;

...
impl<F: PrimeField32> VmExecutionExtension<F> for Int256 {
    ...
    fn extend_execution(
        ...
        let lt = Rv64LessThan256Executor::new(
            AluU16AdapterExecutor::new(Rv64VecHeapU16AdapterExecutor::new(pointer_max_bits)),
        ...
        let beq = Rv64BranchEqual256Executor::new(
            BranchAdapterExecutor::new(Rv64VecHeapBranchU16AdapterExecutor::new(pointer_max_bits)),
    ...
    fn extend_prover(
        ...
        let beq = Rv64BranchEqual256Chip::new(
            BranchEqualFiller::new(
                Rv64VecHeapBranchU16AdapterFiller::new(pointer_max_bits, range_checker.clone()),
                Rv64BranchEqual256Opcode::CLASS_OFFSET,
                DEFAULT_PC_STEP,
            ),
            mem_helper.clone(),

...
impl<F: PrimeField32> VmExecutionExtension<F> for Int256 {
    ...
    fn extend_execution(
        ...
        let beq = Rv64BranchEqual256Executor::new(
            BranchAdapterExecutor::new(Rv64VecHeapBranchAdapterExecutor::new(pointer_max_bits)),
    ...
    fn extend_prover(
        ...
        let beq = Rv64BranchEqual256Chip::new(
            BranchEqualFiller::new(
                Rv64VecHeapBranchAdapterFiller::new(pointer_max_bits, range_checker.clone()),
                range_checker.clone(),
                Rv64BranchEqual256Opcode::CLASS_OFFSET,
                DEFAULT_PC_STEP,
            ),

...
pub type Rv64BaseAlu256Air =
    VmAirWrapper<AluAdapterAir, BaseAluCoreAir<INT256_NUM_U8_LIMBS, RV64_CELL_BITS>>;
#[derive(Clone, PreflightExecutor)]
pub struct Rv64BaseAlu256Executor(
    BaseAluExecutor<AluAdapterExecutor, INT256_NUM_U8_LIMBS, RV64_CELL_BITS>,
);
...
pub type Rv64LessThan256Air =
    VmAirWrapper<AluU16AdapterAir, LessThanCoreAir<INT256_NUM_U16_LIMBS, RV64_U16_LIMB_BITS>>;
#[derive(Clone, PreflightExecutor)]
pub struct Rv64LessThan256Executor(
    LessThanExecutor<AluU16AdapterExecutor, INT256_NUM_U16_LIMBS, RV64_U16_LIMB_BITS>,
);
...
pub type Rv64Multiplication256Air =
    VmAirWrapper<AluAdapterAir, MultiplicationCoreAir<INT256_NUM_U8_LIMBS, RV64_CELL_BITS>>;
#[derive(Clone, PreflightExecutor)]
pub struct Rv64Multiplication256Executor(
    MultiplicationExecutor<AluAdapterExecutor, INT256_NUM_U8_LIMBS, RV64_CELL_BITS>,
);
...
pub type Rv64Shift256Air =
    VmAirWrapper<AluAdapterAir, ShiftCoreAir<INT256_NUM_U8_LIMBS, RV64_CELL_BITS>>;
#[derive(Clone, PreflightExecutor)]
pub struct Rv64Shift256Executor(
    ShiftExecutor<AluAdapterExecutor, INT256_NUM_U8_LIMBS, RV64_CELL_BITS>,
);
...
pub type Rv64BranchLessThan256Air =
    VmAirWrapper<BranchAdapterAir, BranchLessThanCoreAir<INT256_NUM_U16_LIMBS, RV64_U16_LIMB_BITS>>;
#[derive(Clone, PreflightExecutor)]
pub struct Rv64BranchLessThan256Executor(
    BranchLessThanExecutor<BranchAdapterExecutor, INT256_NUM_U16_LIMBS, RV64_U16_LIMB_BITS>,
);

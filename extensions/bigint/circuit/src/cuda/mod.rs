...
use openvm_riscv_adapters::{
    ...
    Rv64VecHeapBranchU16AdapterRecord,
};
use openvm_riscv_circuit::{
    adapters::{RV64_CELL_BITS, RV64_U16_LIMB_BITS},
...
pub type BaseAlu256CoreRecord = BaseAluCoreRecord<INT256_NUM_U8_LIMBS>;
...
impl Chip<DenseRecordArena, GpuBackend> for BaseAlu256ChipGpu {
    fn generate_proving_ctx(&self, arena: DenseRecordArena) -> AirProvingContext<GpuBackend> {
        ...
        let trace_width = BaseAluCoreCols::<F, INT256_NUM_U8_LIMBS, RV64_CELL_BITS>::width()
...
pub type LessThan256AdapterRecord = openvm_riscv_adapters::Rv64VecHeapU16AdapterRecord<
    ...
    INT256_NUM_MEMORY_BLOCKS,
>;
pub type LessThan256CoreRecord = LessThanCoreRecord<INT256_NUM_U16_LIMBS, RV64_U16_LIMB_BITS>;
...
impl Chip<DenseRecordArena, GpuBackend> for LessThan256ChipGpu {
    fn generate_proving_ctx(&self, arena: DenseRecordArena) -> AirProvingContext<GpuBackend> {
        ...
        let trace_width = LessThanCoreCols::<F, INT256_NUM_U16_LIMBS, RV64_U16_LIMB_BITS>::width()
...
pub type BranchLessThan256AdapterRecord =
    Rv64VecHeapBranchU16AdapterRecord<NUM_READS, INT256_NUM_MEMORY_BLOCKS>;
pub type BranchLessThan256CoreRecord =
    BranchLessThanCoreRecord<INT256_NUM_U16_LIMBS, RV64_U16_LIMB_BITS>;
...
impl Chip<DenseRecordArena, GpuBackend> for BranchLessThan256ChipGpu {
    fn generate_proving_ctx(&self, arena: DenseRecordArena) -> AirProvingContext<GpuBackend> {
        ...
        let trace_width =
            BranchLessThanCoreCols::<F, INT256_NUM_U16_LIMBS, RV64_U16_LIMB_BITS>::width()
                + Rv64VecHeapBranchU16AdapterCols::<F, NUM_READS, INT256_NUM_MEMORY_BLOCKS>::width(
                );
        let trace_height = next_power_of_two_or_zero(records.len() / RECORD_SIZE);
        let device_ctx = &self.range_checker.device_ctx;
...
pub type Shift256AdapterRecord =
    Rv64VecHeapAdapterRecord<NUM_READS, INT256_NUM_MEMORY_BLOCKS, INT256_NUM_MEMORY_BLOCKS>;
pub type Shift256CoreRecord = ShiftCoreRecord<INT256_NUM_U8_LIMBS, RV64_CELL_BITS>;
...
impl Chip<DenseRecordArena, GpuBackend> for Shift256ChipGpu {
    fn generate_proving_ctx(&self, arena: DenseRecordArena) -> AirProvingContext<GpuBackend> {
        ...
        let trace_width = ShiftCoreCols::<F, INT256_NUM_U8_LIMBS, RV64_CELL_BITS>::width()
            + Rv64VecHeapAdapterCols::<
                F,
                NUM_READS,
                INT256_NUM_MEMORY_BLOCKS,
...
pub type Multiplication256CoreRecord =
    MultiplicationCoreRecord<INT256_NUM_U8_LIMBS, RV64_CELL_BITS>;
...
impl Chip<DenseRecordArena, GpuBackend> for Multiplication256ChipGpu {
    fn generate_proving_ctx(&self, arena: DenseRecordArena) -> AirProvingContext<GpuBackend> {
        ...
        let trace_width = MultiplicationCoreCols::<F, INT256_NUM_U8_LIMBS, RV64_CELL_BITS>::width()
            + Rv64VecHeapAdapterCols::<
                F,
                NUM_READS,
                INT256_NUM_MEMORY_BLOCKS,

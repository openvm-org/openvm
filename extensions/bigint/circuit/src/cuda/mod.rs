...
pub type BaseAlu256AdapterRecord =
    Rv32VecHeapAdapterRecord<2, BLOCKS_PER_OP, BLOCKS_PER_OP, CONST_BLOCK_SIZE, CONST_BLOCK_SIZE>;
...
impl Chip<DenseRecordArena, GpuBackend> for BaseAlu256ChipGpu {
    fn generate_proving_ctx(&self, arena: DenseRecordArena) -> AirProvingContext<GpuBackend> {
        ...
        let trace_width = BaseAluCoreCols::<F, INT256_NUM_LIMBS, RV32_CELL_BITS>::width()
            + Rv32VecHeapAdapterCols::<F, 2, BLOCKS_PER_OP, BLOCKS_PER_OP, CONST_BLOCK_SIZE, CONST_BLOCK_SIZE>::width();
...
/// Branch Equal
//////////////////////////////////////////////////////////////////////////////////////
pub type BranchEqual256AdapterRecord = Rv32VecHeapBranchAdapterRecord<2, BLOCKS_PER_OP, CONST_BLOCK_SIZE>;
...
impl Chip<DenseRecordArena, GpuBackend> for BranchEqual256ChipGpu {
    fn generate_proving_ctx(&self, arena: DenseRecordArena) -> AirProvingContext<GpuBackend> {
        ...
        let trace_width = BranchEqualCoreCols::<F, INT256_NUM_LIMBS>::width()
            + Rv32VecHeapBranchAdapterCols::<F, 2, BLOCKS_PER_OP, CONST_BLOCK_SIZE>::width();
        let trace_height = next_power_of_two_or_zero(records.len() / RECORD_SIZE);
...
/// Branch Less Than
//////////////////////////////////////////////////////////////////////////////////////
pub type BranchLessThan256AdapterRecord = Rv32VecHeapBranchAdapterRecord<2, BLOCKS_PER_OP, CONST_BLOCK_SIZE>;

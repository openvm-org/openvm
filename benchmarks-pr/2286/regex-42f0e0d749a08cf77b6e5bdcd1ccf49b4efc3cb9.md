...
|:---|---:|---:|
| Total | <span style='color: red'>(+0 [+2.0%])</span> 2.43 | <span style='color: green'>(-0 [-0.3%])</span> 0.78 |
| regex_program | <span style='color: red'>(+0 [+2.0%])</span> 2.40 | <span style='color: green'>(-0 [-0.4%])</span> 0.74 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+12 [+2.0%])</span> 598.75 | <span style='color: red'>(+46 [+2.0%])</span> 2,395 | <span style='color: green'>(-3 [-0.4%])</span> 740 |  523 |
...
| `execute_metered_insn_mi/s` | <span style='color: green'>(-3 [-2.4%])</span> 108.52 | -          | <span style='color: green'>(-3 [-2.4%])</span> 108.52 | <span style='color: green'>(-3 [-2.4%])</span> 108.52 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` | <span style='color: green'>(-0 [-0.5%])</span> 52.25 | <span style='color: green'>(-1 [-0.5%])</span> 209 | <span style='color: green'>(-1 [-1.6%])</span> 63 |  44 |
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+0 [+0.7%])</span> 32.31 | -          | <span style='color: red'>(+0 [+1.4%])</span> 33.63 | <span style='color: green'>(-0 [-0.2%])</span> 29.13 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+2 [+1.0%])</span> 180.75 | <span style='color: red'>(+7 [+1.0%])</span> 723 | <span style='color: red'>(+2 [+0.9%])</span> 214 | <span style='color: red'>(+3 [+1.9%])</span> 158 |
| `memory_finalize_time_ms` |  1 |  4 |  4 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+10 [+3.5%])</span> 298 | <span style='color: red'>(+40 [+3.5%])</span> 1,192 | <span style='color: green'>(-5 [-1.5%])</span> 335 |  260 |
...
| `generate_perm_trace_time_ms` | <span style='color: red'>(+4 [+10.1%])</span> 38.25 | <span style='color: red'>(+14 [+10.1%])</span> 153 | <span style='color: green'>(-6 [-10.9%])</span> 49 |  19 |
| `perm_trace_commit_time_ms` | <span style='color: green'>(-0 [-0.4%])</span> 64.25 | <span style='color: green'>(-1 [-0.4%])</span> 257.02 | <span style='color: green'>(-1 [-0.8%])</span> 69.34 | <span style='color: green'>(-1 [-1.7%])</span> 55.10 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+0 [+0.6%])</span> 59.10 | <span style='color: red'>(+1 [+0.6%])</span> 236.39 | <span style='color: red'>(+1 [+1.3%])</span> 70.42 | <span style='color: green'>(-1 [-1.0%])</span> 52.20 |
| `quotient_poly_commit_time_ms` | <span style='color: green'>(-0 [-0.2%])</span> 15.25 | <span style='color: green'>(-0 [-0.2%])</span> 61.01 | <span style='color: green'>(-0 [-1.5%])</span> 17.69 | <span style='color: green'>(-0 [-0.6%])</span> 12.76 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+7 [+11.3%])</span> 66.25 | <span style='color: red'>(+27 [+11.3%])</span> 265 | <span style='color: red'>(+1 [+1.3%])</span> 79 | <span style='color: red'>(+6 [+13.0%])</span> 52 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 564 | 1 | 38 | 4,137,502 | 108.52 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 214 | 740 | 23,446,148 | 150,778,428 | 214 | 335 | 0 | 61.46 | 17.69 | 5 | 69.34 | 79 | 118 | 79 | 4 | 57 | 10,899,170 | 48 | 45 | 1,103,000 | 29.13 | 21 | 79 | 1 | 79 | 
| regex_program | 1 | 158 | 523 | 11,598,276 | 128,513,066 | 158 | 260 | 1 | 52.20 | 15.02 | 4 | 66.91 | 55 | 87 | 55 | 0 | 49 | 2,196,106 | 19 | 63 | 1,104,000 | 33.50 | 17 | 67 | 0 | 55 | 
| regex_program | 2 | 166 | 568 | 11,579,064 | 128,513,066 | 166 | 303 | 1 | 52.32 | 15.54 | 4 | 65.68 | 79 | 104 | 79 | 0 | 51 | 2,177,334 | 37 | 57 | 1,104,000 | 33 | 17 | 68 | 0 | 79 | 
| regex_program | 3 | 185 | 564 | 11,853,872 | 103,456,394 | 185 | 294 | 0 | 70.42 | 12.76 | 5 | 55.10 | 52 | 107 | 52 | 0 | 50 | 2,422,606 | 49 | 44 | 826,502 | 33.63 | 18 | 84 | 1 | 52 | 

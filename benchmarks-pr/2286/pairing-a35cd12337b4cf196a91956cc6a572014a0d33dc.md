...
|:---|---:|---:|
| Total | <span style='color: red'>(+0 [+3.6%])</span> 1.53 | <span style='color: red'>(+0 [+3.1%])</span> 0.91 |
| pairing | <span style='color: red'>(+0 [+3.7%])</span> 1.47 | <span style='color: red'>(+0 [+3.1%])</span> 0.84 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+26 [+3.7%])</span> 732.50 | <span style='color: red'>(+52 [+3.7%])</span> 1,465 | <span style='color: red'>(+25 [+3.1%])</span> 836 | <span style='color: red'>(+27 [+4.5%])</span> 629 |
...
| `execute_metered_time_ms` | <span style='color: red'>(+2 [+3.0%])</span> 69 | -          | -          | -          |
| `execute_metered_insn_mi/s` | <span style='color: green'>(-1 [-2.7%])</span> 25.02 | -          | <span style='color: green'>(-1 [-2.7%])</span> 25.02 | <span style='color: green'>(-1 [-2.7%])</span> 25.02 |
...
| `execute_preflight_time_ms` | <span style='color: red'>(+1 [+1.2%])</span> 83.50 | <span style='color: red'>(+2 [+1.2%])</span> 167 | <span style='color: red'>(+1 [+0.9%])</span> 108 | <span style='color: red'>(+1 [+1.7%])</span> 59 |
| `execute_preflight_insn_mi/s` | <span style='color: green'>(-0 [-0.7%])</span> 14.80 | -          | <span style='color: green'>(-0 [-0.1%])</span> 18.67 | <span style='color: green'>(-0 [-1.6%])</span> 10.93 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+0 [+0.3%])</span> 187.50 | <span style='color: red'>(+1 [+0.3%])</span> 375 | <span style='color: red'>(+1 [+0.5%])</span> 195 |  180 |
...
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+24 [+7.1%])</span> 369 | <span style='color: red'>(+49 [+7.1%])</span> 738 | <span style='color: red'>(+23 [+6.0%])</span> 404 | <span style='color: red'>(+26 [+8.4%])</span> 334 |
...
| `generate_perm_trace_time_ms` | <span style='color: green'>(-6 [-14.9%])</span> 37 | <span style='color: green'>(-13 [-14.9%])</span> 74 | <span style='color: green'>(-9 [-19.1%])</span> 38 | <span style='color: green'>(-4 [-10.0%])</span> 36 |
| `perm_trace_commit_time_ms` | <span style='color: red'>(+1 [+0.8%])</span> 77.21 | <span style='color: red'>(+1 [+0.8%])</span> 154.41 | <span style='color: red'>(+2 [+1.8%])</span> 89.84 | <span style='color: green'>(-0 [-0.6%])</span> 64.57 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+1 [+1.2%])</span> 78.83 | <span style='color: red'>(+2 [+1.2%])</span> 157.67 | <span style='color: red'>(+1 [+1.5%])</span> 87.43 | <span style='color: red'>(+1 [+0.8%])</span> 70.23 |
| `quotient_poly_commit_time_ms` | <span style='color: green'>(-1 [-4.2%])</span> 15.82 | <span style='color: green'>(-1 [-4.2%])</span> 31.63 | <span style='color: green'>(-1 [-7.2%])</span> 17.44 | <span style='color: green'>(-0 [-0.3%])</span> 14.19 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+30 [+48.8%])</span> 90 | <span style='color: red'>(+59 [+48.8%])</span> 180 | <span style='color: red'>(+26 [+38.2%])</span> 94 | <span style='color: red'>(+33 [+62.3%])</span> 86 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 629 | 1 | 69 | 1,745,742 | 25.02 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 180 | 836 | 32,480,114 | 172,558,444 | 180 | 404 | 0 | 87.43 | 17.44 | 6 | 89.84 | 94 | 129 | 93 | 0 | 75 | 15,909,408 | 36 | 108 | 1,149,000 | 10.93 | 26 | 105 | 1 | 93 | 
| pairing | 1 | 195 | 629 | 22,464,232 | 119,958,502 | 195 | 334 | 1 | 70.23 | 14.19 | 6 | 64.57 | 86 | 106 | 86 | 0 | 55 | 9,498,894 | 38 | 59 | 596,742 | 18.67 | 20 | 85 | 1 | 86 | 

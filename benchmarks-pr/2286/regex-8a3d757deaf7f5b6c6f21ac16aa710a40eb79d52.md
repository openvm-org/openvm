...
|:---|---:|---:|
| Total | <span style='color: red'>(+0 [+0.6%])</span> 2.40 | <span style='color: green'>(-0 [-2.9%])</span> 0.76 |
| regex_program | <span style='color: red'>(+0 [+0.7%])</span> 2.37 | <span style='color: green'>(-0 [-3.0%])</span> 0.72 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+4 [+0.7%])</span> 591.25 | <span style='color: red'>(+16 [+0.7%])</span> 2,365 | <span style='color: green'>(-22 [-3.0%])</span> 721 | <span style='color: red'>(+3 [+0.6%])</span> 526 |
...
| `execute_metered_insn_mi/s` | <span style='color: red'>(+1 [+0.8%])</span> 112 | -          | <span style='color: red'>(+1 [+0.8%])</span> 112 | <span style='color: red'>(+1 [+0.8%])</span> 112 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` | <span style='color: red'>(+2 [+2.9%])</span> 54 | <span style='color: red'>(+6 [+2.9%])</span> 216 | <span style='color: red'>(+2 [+3.1%])</span> 66 | <span style='color: green'>(-1 [-2.3%])</span> 43 |
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+0 [+1.5%])</span> 32.59 | -          | <span style='color: red'>(+1 [+2.0%])</span> 33.84 | <span style='color: red'>(+1 [+1.7%])</span> 29.69 |
| `trace_gen_time_ms   ` | <span style='color: green'>(-0 [-0.3%])</span> 178.50 | <span style='color: green'>(-2 [-0.3%])</span> 714 | <span style='color: red'>(+3 [+1.4%])</span> 215 | <span style='color: green'>(-1 [-0.6%])</span> 154 |
| `memory_finalize_time_ms` |  1 |  4 |  4 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+3 [+1.0%])</span> 290.75 | <span style='color: red'>(+11 [+1.0%])</span> 1,163 | <span style='color: green'>(-23 [-6.8%])</span> 317 | <span style='color: red'>(+3 [+1.2%])</span> 263 |
| `main_trace_commit_time_ms` | <span style='color: green'>(-0 [-1.0%])</span> 51.75 | <span style='color: green'>(-2 [-1.0%])</span> 207 |  57 | <span style='color: green'>(-1 [-2.0%])</span> 49 |
| `generate_perm_trace_time_ms` | <span style='color: red'>(+4 [+10.8%])</span> 38.50 | <span style='color: red'>(+15 [+10.8%])</span> 154 | <span style='color: green'>(-5 [-9.1%])</span> 50 |  19 |
| `perm_trace_commit_time_ms` | <span style='color: red'>(+0 [+0.8%])</span> 65.03 | <span style='color: red'>(+2 [+0.8%])</span> 260.13 | <span style='color: red'>(+1 [+1.2%])</span> 70.76 | <span style='color: green'>(-1 [-1.0%])</span> 55.53 |
| `quotient_poly_compute_time_ms` | <span style='color: green'>(-0 [-0.5%])</span> 58.43 | <span style='color: green'>(-1 [-0.5%])</span> 233.71 | <span style='color: green'>(-0 [-0.6%])</span> 69.09 | <span style='color: red'>(+0 [+0.2%])</span> 52.82 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+0 [+0.1%])</span> 15.31 | <span style='color: red'>(+0 [+0.1%])</span> 61.24 | <span style='color: green'>(-1 [-5.8%])</span> 16.91 | <span style='color: red'>(+0 [+2.0%])</span> 13.08 |
| `pcs_opening_time_ms ` | <span style='color: green'>(-1 [-2.1%])</span> 58.25 | <span style='color: green'>(-5 [-2.1%])</span> 233 | <span style='color: green'>(-16 [-20.5%])</span> 62 | <span style='color: red'>(+9 [+19.6%])</span> 55 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 576 | 1 | 36 | 4,137,502 | 112 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 215 | 721 | 23,446,148 | 150,778,428 | 215 | 317 | 0 | 58.59 | 16.91 | 5 | 70.76 | 61 | 121 | 61 | 4 | 57 | 10,899,170 | 49 | 43 | 1,103,000 | 29.69 | 21 | 76 | 1 | 61 | 
| regex_program | 1 | 154 | 526 | 11,598,276 | 128,513,066 | 154 | 263 | 1 | 52.82 | 15.83 | 4 | 67.100 | 55 | 88 | 54 | 0 | 50 | 2,196,106 | 19 | 66 | 1,104,000 | 33.26 | 17 | 69 | 0 | 54 | 
| regex_program | 2 | 159 | 542 | 11,579,064 | 128,513,066 | 159 | 279 | 1 | 53.21 | 15.42 | 4 | 65.85 | 55 | 103 | 55 | 0 | 51 | 2,177,334 | 36 | 62 | 1,104,000 | 33.56 | 16 | 69 | 0 | 55 | 
| regex_program | 3 | 186 | 576 | 11,853,872 | 103,456,394 | 186 | 304 | 1 | 69.09 | 13.08 | 5 | 55.53 | 62 | 109 | 62 | 0 | 49 | 2,422,606 | 50 | 45 | 826,502 | 33.84 | 18 | 83 | 1 | 62 | 

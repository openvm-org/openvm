...
|:---|---:|---:|
| Total |  1.19 |  0.68 |
| fibonacci_program |  1.18 |  0.67 |


| fibonacci_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  588 |  1,176 |  666 |  510 |
...
| `execute_metered_insn_mi/s` |  139.05 | -          |  139.05 |  139.05 |
| `execute_preflight_insns` |  750,105 |  1,500,210 |  873,000 |  627,210 |
| `execute_preflight_time_ms` |  29.50 |  59 |  33 |  26 |
| `execute_preflight_insn_mi/s` |  35.72 | -          |  37.20 |  34.25 |
| `trace_gen_time_ms   ` |  206.50 |  413 |  210 |  203 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  257 |  514 |  282 |  232 |
| `main_trace_commit_time_ms` |  32.50 |  65 |  35 |  30 |
| `generate_perm_trace_time_ms` |  20.50 |  41 |  28 |  13 |
| `perm_trace_commit_time_ms` |  44.70 |  89.40 |  46.69 |  42.71 |
| `quotient_poly_compute_time_ms` |  29.58 |  59.15 |  32.09 |  27.06 |
| `quotient_poly_commit_time_ms` |  13.73 |  27.46 |  14.06 |  13.39 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 510 | 66 | 1 | 10 | 1,500,210 | 139.05 | 169 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 210 | 666 | 9,684,992 | 84,395,212 | 210 | 282 | 0 | 32.09 | 14.06 | 4 | 46.69 | 124 | 75 | 124 | 0 | 35 | 1,040,430 | 28 | 26 | 873,000 | 34.25 | 13 | 46 | 1 | 124 | 
| fibonacci_program | 1 | 203 | 510 | 9,714,030 | 74,305,770 | 203 | 232 | 1 | 27.06 | 13.39 | 4 | 42.71 | 103 | 56 | 103 | 0 | 30 | 1,067,532 | 13 | 33 | 627,210 | 37.20 | 10 | 40 | 1 | 103 | 

...
| `total_proof_time_ms ` |  878 |  1,756 |  994 |  762 |
...
| `execute_preflight_time_ms` |  99.50 |  199 |  127 |  72 |
| `execute_preflight_insn_mi/s` |  13.81 | -          |  18.40 |  9.22 |
| `trace_gen_time_ms   ` |  193 |  386 |  208 |  178 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  491.50 |  983 |  542 |  441 |
| `main_trace_commit_time_ms` |  69 |  138 |  76 |  62 |
| `generate_perm_trace_time_ms` |  51 |  102 |  59 |  43 |
| `perm_trace_commit_time_ms` |  82.54 |  165.07 |  91.59 |  73.49 |
| `quotient_poly_compute_time_ms` |  94.74 |  189.48 |  100.21 |  89.27 |
| `quotient_poly_commit_time_ms` |  18.65 |  37.29 |  19.44 |  17.85 |
| `pcs_opening_time_ms ` |  171 |  342 |  191 |  151 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 762 | 40 | 1 | 91 | 1,882,939 | 20.61 | 145 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 178 | 994 | 31,041,944 | 160,949,612 | 178 | 542 | 0 | 100.21 | 19.44 | 6 | 91.59 | 191 | 153 | 191 | 0 | 76 | 15,014,446 | 59 | 127 | 1,143,000 | 9.22 | 24 | 120 | 3 | 191 | 
| pairing | 1 | 208 | 762 | 24,485,078 | 124,079,782 | 208 | 441 | 1 | 89.27 | 17.85 | 6 | 73.49 | 151 | 119 | 150 | 0 | 62 | 10,833,316 | 43 | 72 | 739,939 | 18.40 | 20 | 107 | 2 | 150 | 

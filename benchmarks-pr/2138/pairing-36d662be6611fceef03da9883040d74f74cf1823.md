...
| `total_proof_time_ms ` |  884.50 |  1,769 |  996 |  773 |
...
| `execute_preflight_time_ms` |  100.50 |  201 |  128 |  73 |
| `execute_preflight_insn_mi/s` |  13.93 | -          |  18.71 |  9.14 |
| `trace_gen_time_ms   ` |  193 |  386 |  209 |  177 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  497 |  994 |  544 |  450 |
| `main_trace_commit_time_ms` |  70 |  140 |  77 |  63 |
| `generate_perm_trace_time_ms` |  46.50 |  93 |  47 |  46 |
| `perm_trace_commit_time_ms` |  82.90 |  165.81 |  92.49 |  73.32 |
| `quotient_poly_compute_time_ms` |  95.37 |  190.74 |  101.29 |  89.45 |
| `quotient_poly_commit_time_ms` |  18.44 |  36.89 |  19.96 |  16.93 |
| `pcs_opening_time_ms ` |  178.50 |  357 |  200 |  157 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 773 | 69 | 1 | 92 | 1,882,939 | 20.29 | 176 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 177 | 996 | 31,041,944 | 160,949,612 | 177 | 544 | 0 | 101.29 | 19.96 | 6 | 92.49 | 200 | 143 | 200 | 0 | 77 | 15,014,446 | 47 | 128 | 1,143,000 | 9.14 | 23 | 121 | 3 | 200 | 
| pairing | 1 | 209 | 773 | 24,485,078 | 124,079,782 | 209 | 450 | 1 | 89.45 | 16.93 | 6 | 73.32 | 157 | 122 | 156 | 0 | 63 | 10,833,316 | 46 | 73 | 739,939 | 18.71 | 19 | 106 | 2 | 156 | 

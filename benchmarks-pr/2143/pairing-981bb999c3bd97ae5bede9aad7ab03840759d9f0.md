...
|:---|---:|---:|
| Total | <span style='color: green'>(-0 [-1.0%])</span> 1.85 | <span style='color: green'>(-0 [-1.5%])</span> 1.09 |
| pairing | <span style='color: green'>(-0 [-1.1%])</span> 1.76 | <span style='color: green'>(-0 [-1.8%])</span> 1 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: green'>(-10 [-1.1%])</span> 879.50 | <span style='color: green'>(-20 [-1.1%])</span> 1,759 | <span style='color: green'>(-18 [-1.8%])</span> 1,000 | <span style='color: green'>(-2 [-0.3%])</span> 759 |
...
| `execute_metered_insn_mi/s` | <span style='color: green'>(-0 [-1.1%])</span> 20.42 | -          | <span style='color: green'>(-0 [-1.1%])</span> 20.42 | <span style='color: green'>(-0 [-1.1%])</span> 20.42 |
| `execute_preflight_insns` |  941,469.50 |  1,882,939 |  1,143,000 |  739,939 |
| `execute_preflight_time_ms` | <span style='color: green'>(-2 [-2.0%])</span> 99.50 | <span style='color: green'>(-4 [-2.0%])</span> 199 | <span style='color: green'>(-1 [-0.8%])</span> 126 | <span style='color: green'>(-3 [-3.9%])</span> 73 |
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+0 [+0.7%])</span> 13.99 | -          | <span style='color: red'>(+0 [+0.7%])</span> 18.71 | <span style='color: red'>(+0 [+0.7%])</span> 9.28 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+6 [+3.4%])</span> 195 | <span style='color: red'>(+13 [+3.4%])</span> 390 | <span style='color: red'>(+5 [+2.5%])</span> 209 | <span style='color: red'>(+8 [+4.6%])</span> 181 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: green'>(-14 [-2.7%])</span> 491 | <span style='color: green'>(-27 [-2.7%])</span> 982 | <span style='color: green'>(-24 [-4.2%])</span> 546 | <span style='color: green'>(-3 [-0.7%])</span> 436 |
| `main_trace_commit_time_ms` | <span style='color: red'>(+0 [+0.7%])</span> 69.50 | <span style='color: red'>(+1 [+0.7%])</span> 139 |  77 | <span style='color: red'>(+1 [+1.6%])</span> 62 |
| `generate_perm_trace_time_ms` | <span style='color: green'>(-11 [-17.3%])</span> 52.50 | <span style='color: green'>(-22 [-17.3%])</span> 105 | <span style='color: green'>(-21 [-25.0%])</span> 63 | <span style='color: green'>(-1 [-2.3%])</span> 42 |
| `perm_trace_commit_time_ms` | <span style='color: red'>(+0 [+0.4%])</span> 83.03 | <span style='color: red'>(+1 [+0.4%])</span> 166.06 | <span style='color: red'>(+0 [+0.5%])</span> 92.31 | <span style='color: red'>(+0 [+0.2%])</span> 73.75 |
| `quotient_poly_compute_time_ms` | <span style='color: green'>(-3 [-3.1%])</span> 94.82 | <span style='color: green'>(-6 [-3.1%])</span> 189.64 | <span style='color: green'>(-3 [-3.0%])</span> 100.91 | <span style='color: green'>(-3 [-3.3%])</span> 88.73 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+0 [+0.1%])</span> 18.52 | <span style='color: red'>(+0 [+0.1%])</span> 37.04 | <span style='color: green'>(-0 [-1.3%])</span> 19.74 | <span style='color: red'>(+0 [+1.7%])</span> 17.31 |
| `pcs_opening_time_ms ` | <span style='color: green'>(-0 [-0.3%])</span> 168 | <span style='color: green'>(-1 [-0.3%])</span> 336 | <span style='color: green'>(-1 [-0.5%])</span> 188 |  148 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 759 | 41 | 1 | 92 | 1,882,939 | 20.42 | 146 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 181 | 1,000 | 31,041,944 | 160,949,612 | 181 | 546 | 0 | 100.91 | 19.74 | 7 | 92.31 | 188 | 158 | 188 | 1 | 77 | 15,014,446 | 63 | 126 | 1,143,000 | 9.28 | 24 | 121 | 3 | 188 | 
| pairing | 1 | 209 | 759 | 24,485,078 | 124,079,782 | 209 | 436 | 1 | 88.73 | 17.31 | 6 | 73.75 | 148 | 118 | 148 | 0 | 62 | 10,833,316 | 42 | 73 | 739,939 | 18.71 | 19 | 106 | 2 | 148 | 

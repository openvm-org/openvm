...
|:---|---:|---:|
| Total | <span style='color: red'>(+0 [+0.4%])</span> 1.52 | <span style='color: red'>(+0 [+0.2%])</span> 0.92 |
| pairing | <span style='color: red'>(+0 [+0.4%])</span> 1.43 | <span style='color: red'>(+0 [+0.2%])</span> 0.83 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+3 [+0.4%])</span> 717 | <span style='color: red'>(+6 [+0.4%])</span> 1,434 | <span style='color: red'>(+2 [+0.2%])</span> 827 | <span style='color: red'>(+4 [+0.7%])</span> 607 |
...
| `execute_metered_insn_mi/s` | <span style='color: red'>(+0 [+0.1%])</span> 19.50 | -          | <span style='color: red'>(+0 [+0.1%])</span> 19.50 | <span style='color: red'>(+0 [+0.1%])</span> 19.50 |
| `execute_preflight_insns` |  872,871 |  1,745,742 |  1,157,000 |  588,742 |
| `execute_preflight_time_ms` | <span style='color: red'>(+0 [+0.5%])</span> 95.50 | <span style='color: red'>(+1 [+0.5%])</span> 191 | <span style='color: red'>(+1 [+0.8%])</span> 131 |  60 |
| `execute_preflight_insn_mi/s` | <span style='color: green'>(-0 [-1.1%])</span> 13.40 | -          | <span style='color: green'>(-0 [-1.2%])</span> 17.77 | <span style='color: green'>(-0 [-0.9%])</span> 9.02 |
| `trace_gen_time_ms   ` | <span style='color: green'>(-4 [-2.2%])</span> 176.50 | <span style='color: green'>(-8 [-2.2%])</span> 353 | <span style='color: green'>(-3 [-1.5%])</span> 194 | <span style='color: green'>(-5 [-3.0%])</span> 159 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+7 [+2.0%])</span> 352 | <span style='color: red'>(+14 [+2.0%])</span> 704 | <span style='color: red'>(+7 [+1.8%])</span> 393 | <span style='color: red'>(+7 [+2.3%])</span> 311 |
| `main_trace_commit_time_ms` | <span style='color: green'>(-2 [-3.0%])</span> 64.50 | <span style='color: green'>(-4 [-3.0%])</span> 129 | <span style='color: green'>(-3 [-3.9%])</span> 74 | <span style='color: green'>(-1 [-1.8%])</span> 55 |
| `generate_perm_trace_time_ms` | <span style='color: green'>(-0 [-1.4%])</span> 35 | <span style='color: green'>(-1 [-1.4%])</span> 70 |  36 | <span style='color: green'>(-1 [-2.9%])</span> 34 |
| `perm_trace_commit_time_ms` | <span style='color: green'>(-1 [-1.9%])</span> 76.70 | <span style='color: green'>(-3 [-1.9%])</span> 153.39 | <span style='color: green'>(-1 [-1.0%])</span> 88.88 | <span style='color: green'>(-2 [-3.1%])</span> 64.51 |
| `quotient_poly_compute_time_ms` | <span style='color: green'>(-1 [-1.5%])</span> 78.61 | <span style='color: green'>(-2 [-1.5%])</span> 157.23 | <span style='color: green'>(-1 [-1.0%])</span> 86.78 | <span style='color: green'>(-1 [-2.0%])</span> 70.45 |
| `quotient_poly_commit_time_ms` | <span style='color: green'>(-1 [-3.0%])</span> 16.53 | <span style='color: green'>(-1 [-3.0%])</span> 33.07 | <span style='color: green'>(-0 [-1.9%])</span> 18.62 | <span style='color: green'>(-1 [-4.3%])</span> 14.45 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+13 [+20.6%])</span> 76 | <span style='color: red'>(+26 [+20.6%])</span> 152 | <span style='color: red'>(+13 [+18.1%])</span> 85 | <span style='color: red'>(+13 [+24.1%])</span> 67 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 607 | 66 | 1 | 89 | 1,745,742 | 19.50 | 170 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 159 | 827 | 32,689,110 | 172,558,444 | 159 | 393 | 0 | 86.78 | 18.62 | 6 | 88.88 | 85 | 126 | 85 | 1 | 74 | 16,059,916 | 34 | 131 | 1,157,000 | 9.02 | 26 | 106 | 1 | 85 | 
| pairing | 1 | 194 | 607 | 22,314,288 | 119,958,502 | 194 | 311 | 1 | 70.45 | 14.45 | 6 | 64.51 | 67 | 103 | 67 | 0 | 55 | 9,408,294 | 36 | 60 | 588,742 | 17.77 | 20 | 85 | 1 | 67 | 

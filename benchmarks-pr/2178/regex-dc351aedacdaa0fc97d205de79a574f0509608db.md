...
|:---|---:|---:|
| Total | <span style='color: red'>(+0 [+2.7%])</span> 2.39 | <span style='color: red'>(+0 [+3.5%])</span> 0.75 |
| regex_program | <span style='color: red'>(+0 [+2.7%])</span> 2.36 | <span style='color: red'>(+0 [+3.5%])</span> 0.71 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+16 [+2.7%])</span> 589 | <span style='color: red'>(+62 [+2.7%])</span> 2,356 | <span style='color: red'>(+24 [+3.5%])</span> 714 | <span style='color: red'>(+4 [+0.8%])</span> 528 |
...
| `execute_metered_insn_mi/s` | <span style='color: green'>(-2 [-1.9%])</span> 119.59 | -          | <span style='color: green'>(-2 [-1.9%])</span> 119.59 | <span style='color: green'>(-2 [-1.9%])</span> 119.59 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` | <span style='color: red'>(+0 [+0.5%])</span> 54.75 | <span style='color: red'>(+1 [+0.5%])</span> 219 |  66 | <span style='color: green'>(-1 [-2.2%])</span> 45 |
| `execute_preflight_insn_mi/s` | <span style='color: green'>(-0 [-1.1%])</span> 29.93 | -          | <span style='color: green'>(-0 [-0.9%])</span> 31.24 | <span style='color: green'>(-1 [-2.1%])</span> 26.85 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+2 [+0.8%])</span> 179.25 | <span style='color: red'>(+6 [+0.8%])</span> 717 | <span style='color: green'>(-2 [-0.9%])</span> 209 | <span style='color: red'>(+5 [+3.3%])</span> 158 |
| `memory_finalize_time_ms` |  1 |  4 |  4 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+14 [+5.0%])</span> 287.25 | <span style='color: red'>(+55 [+5.0%])</span> 1,149 | <span style='color: red'>(+25 [+8.7%])</span> 312 |  262 |
| `main_trace_commit_time_ms` |  52 |  208 |  57 | <span style='color: green'>(-1 [-2.0%])</span> 49 |
| `generate_perm_trace_time_ms` | <span style='color: red'>(+4 [+16.7%])</span> 29.75 | <span style='color: red'>(+17 [+16.7%])</span> 119 | <span style='color: red'>(+16 [+48.5%])</span> 49 | <span style='color: green'>(-2 [-9.1%])</span> 20 |
| `perm_trace_commit_time_ms` | <span style='color: red'>(+0 [+0.6%])</span> 65.54 | <span style='color: red'>(+1 [+0.6%])</span> 262.15 | <span style='color: red'>(+1 [+1.5%])</span> 72.99 | <span style='color: red'>(+0 [+0.2%])</span> 55.89 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+1 [+1.4%])</span> 59.34 | <span style='color: red'>(+3 [+1.4%])</span> 237.35 | <span style='color: green'>(-0 [-0.4%])</span> 70 | <span style='color: red'>(+2 [+3.2%])</span> 53.63 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+0 [+0.7%])</span> 15.18 | <span style='color: red'>(+0 [+0.7%])</span> 60.72 | <span style='color: red'>(+0 [+0.3%])</span> 17.13 | <span style='color: red'>(+0 [+0.8%])</span> 13.35 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+8 [+15.7%])</span> 62.50 | <span style='color: red'>(+34 [+15.7%])</span> 250 | <span style='color: red'>(+20 [+36.4%])</span> 75 | <span style='color: red'>(+2 [+3.9%])</span> 53 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 576 | 67 | 1 | 34 | 4,137,502 | 119.59 | 193 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 209 | 714 | 23,446,148 | 150,778,428 | 208 | 312 | 0 | 59.80 | 17.13 | 5 | 72.99 | 75 | 101 | 75 | 4 | 57 | 10,899,170 | 27 | 48 | 1,103,000 | 26.85 | 22 | 77 | 1 | 75 | 
| regex_program | 1 | 158 | 538 | 11,598,276 | 128,513,066 | 158 | 272 | 1 | 53.91 | 14.76 | 4 | 65.87 | 62 | 89 | 61 | 0 | 51 | 2,196,106 | 23 | 66 | 1,104,000 | 31.03 | 16 | 69 | 0 | 61 | 
| regex_program | 2 | 164 | 528 | 11,579,064 | 128,513,066 | 164 | 262 | 1 | 53.63 | 15.48 | 4 | 67.39 | 53 | 87 | 52 | 0 | 51 | 2,177,334 | 20 | 60 | 1,104,000 | 30.60 | 16 | 69 | 0 | 52 | 
| regex_program | 3 | 186 | 576 | 11,853,872 | 103,456,394 | 186 | 303 | 0 | 70 | 13.35 | 5 | 55.89 | 60 | 108 | 60 | 0 | 49 | 2,422,606 | 49 | 45 | 826,502 | 31.24 | 19 | 84 | 1 | 60 | 

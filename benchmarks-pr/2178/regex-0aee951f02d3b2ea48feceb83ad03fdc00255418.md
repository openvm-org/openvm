...
|:---|---:|---:|
| Total | <span style='color: green'>(-0 [-1.2%])</span> 2.38 | <span style='color: green'>(-0 [-1.3%])</span> 0.74 |
| regex_program | <span style='color: green'>(-0 [-1.2%])</span> 2.34 | <span style='color: green'>(-0 [-1.4%])</span> 0.71 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: green'>(-7 [-1.2%])</span> 585.75 | <span style='color: green'>(-28 [-1.2%])</span> 2,343 | <span style='color: green'>(-10 [-1.4%])</span> 706 | <span style='color: green'>(-2 [-0.4%])</span> 532 |
...
| `execute_metered_insn_mi/s` | <span style='color: red'>(+1 [+0.5%])</span> 123.64 | -          | <span style='color: red'>(+1 [+0.5%])</span> 123.64 | <span style='color: red'>(+1 [+0.5%])</span> 123.64 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` | <span style='color: green'>(-2 [-3.6%])</span> 53.50 | <span style='color: green'>(-8 [-3.6%])</span> 214 | <span style='color: green'>(-3 [-4.4%])</span> 65 | <span style='color: green'>(-1 [-2.2%])</span> 45 |
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+1 [+2.2%])</span> 30.86 | -          | <span style='color: red'>(+1 [+1.8%])</span> 32.11 | <span style='color: red'>(+1 [+2.9%])</span> 27.83 |
| `trace_gen_time_ms   ` | <span style='color: green'>(-1 [-0.4%])</span> 176.50 | <span style='color: green'>(-3 [-0.4%])</span> 706 |  210 |  154 |
...
| `stark_prove_excluding_trace_time_ms` | <span style='color: green'>(-4 [-1.5%])</span> 288 | <span style='color: green'>(-17 [-1.5%])</span> 1,152 | <span style='color: green'>(-6 [-1.9%])</span> 305 |  271 |
...
| `generate_perm_trace_time_ms` |  32 |  128 |  49 |  23 |
| `perm_trace_commit_time_ms` | <span style='color: green'>(-0 [-0.5%])</span> 64.42 | <span style='color: green'>(-1 [-0.5%])</span> 257.67 | <span style='color: green'>(-1 [-1.9%])</span> 71.04 | <span style='color: red'>(+1 [+2.2%])</span> 55.34 |
| `quotient_poly_compute_time_ms` | <span style='color: green'>(-2 [-3.4%])</span> 57.41 | <span style='color: green'>(-8 [-3.4%])</span> 229.66 | <span style='color: green'>(-3 [-4.1%])</span> 68.54 | <span style='color: green'>(-2 [-3.4%])</span> 51.13 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+0 [+0.6%])</span> 15.36 | <span style='color: red'>(+0 [+0.6%])</span> 61.42 | <span style='color: green'>(-0 [-0.8%])</span> 17.12 | <span style='color: red'>(+0 [+3.0%])</span> 13.21 |
| `pcs_opening_time_ms ` | <span style='color: green'>(-1 [-1.1%])</span> 64.50 | <span style='color: green'>(-3 [-1.1%])</span> 258 | <span style='color: green'>(-1 [-1.4%])</span> 73 | <span style='color: green'>(-3 [-5.0%])</span> 57 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 545 | 41 | 1 | 33 | 4,137,502 | 123.64 | 166 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 210 | 706 | 23,446,148 | 150,778,428 | 210 | 305 | 0 | 58.25 | 17.12 | 5 | 71.04 | 73 | 99 | 73 | 3 | 56 | 10,899,170 | 27 | 46 | 1,103,000 | 27.83 | 21 | 76 | 1 | 73 | 
| regex_program | 1 | 154 | 532 | 11,598,276 | 128,513,066 | 154 | 271 | 1 | 51.74 | 15.55 | 5 | 65.94 | 62 | 90 | 62 | 0 | 50 | 2,196,106 | 23 | 65 | 1,104,000 | 31.66 | 16 | 67 | 0 | 62 | 
| regex_program | 2 | 161 | 560 | 11,579,064 | 128,513,066 | 161 | 299 | 1 | 51.13 | 15.54 | 4 | 65.35 | 66 | 115 | 66 | 0 | 49 | 2,177,334 | 49 | 58 | 1,104,000 | 32.11 | 17 | 67 | 0 | 66 | 
| regex_program | 3 | 181 | 545 | 11,853,872 | 103,456,394 | 181 | 277 | 0 | 68.54 | 13.21 | 5 | 55.34 | 57 | 87 | 57 | 0 | 49 | 2,422,606 | 29 | 45 | 826,502 | 31.83 | 18 | 82 | 1 | 57 | 

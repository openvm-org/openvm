...
|:---|---:|---:|
| Total |  7.74 |  4.98 |
| regex_program |  7.71 |  4.95 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  3,854.50 |  7,709 |  4,954 |  2,755 |
...
| `execute_preflight_insn_mi/s` |  28.37 | -          |  30.82 |  25.93 |
| `trace_gen_time_ms   ` |  404.50 |  809 |  515 |  294 |
| `memory_finalize_time_ms` |  7.50 |  15 |  13 |  2 |
| `stark_prove_excluding_trace_time_ms` |  3,127.50 |  6,255 |  4,094 |  2,161 |
| `main_trace_commit_time_ms` |  628.50 |  1,257 |  844 |  413 |
| `generate_perm_trace_time_ms` |  238 |  476 |  328 |  148 |
| `perm_trace_commit_time_ms` |  651.50 |  1,303 |  853 |  450 |
| `quotient_poly_compute_time_ms` |  331 |  662 |  446 |  216 |
| `quotient_poly_commit_time_ms` |  302 |  604 |  400 |  204 |
| `pcs_opening_time_ms ` |  969.50 |  1,939 |  1,218 |  721 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2,755 | 6 | 1 | 31 | 4,108,597 | 130.28 | 45 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 515 | 4,954 | 211,758,557 | 373,183,036 | 515 | 4,094 | 0 | 446 | 400 | 853 | 1,218 | 7 | 13 | 844 | 91,281,687 | 328 | 102 | 2,211,000 | 25.93 | 
| regex_program | 1 | 294 | 2,755 | 174,326,267 | 196,838,026 | 294 | 2,161 | 56 | 216 | 204 | 450 | 721 | 6 | 2 | 413 | 73,453,305 | 148 | 84 | 1,897,597 | 30.82 | 

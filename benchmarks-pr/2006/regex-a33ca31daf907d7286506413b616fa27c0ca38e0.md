...
|:---|---:|---:|
| Total |  7.78 |  4.94 |
| regex_program |  7.75 |  4.91 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  3,877 |  7,754 |  4,911 |  2,843 |
...
| `execute_preflight_insn_mi/s` |  28.89 | -          |  31.28 |  26.50 |
| `trace_gen_time_ms   ` |  404 |  808 |  513 |  295 |
| `memory_finalize_time_ms` |  8 |  16 |  14 |  2 |
| `stark_prove_excluding_trace_time_ms` |  3,151.50 |  6,303 |  4,055 |  2,248 |
| `main_trace_commit_time_ms` |  637.50 |  1,275 |  838 |  437 |
| `generate_perm_trace_time_ms` |  238.50 |  477 |  302 |  175 |
| `perm_trace_commit_time_ms` |  665.50 |  1,331 |  851 |  480 |
| `quotient_poly_compute_time_ms` |  323.50 |  647 |  441 |  206 |
| `quotient_poly_commit_time_ms` |  310 |  620 |  411 |  209 |
| `pcs_opening_time_ms ` |  968 |  1,936 |  1,205 |  731 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2,843 | 6 | 1 | 31 | 4,108,597 | 129.21 | 45 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 513 | 4,911 | 211,758,557 | 373,183,036 | 513 | 4,055 | 0 | 441 | 411 | 851 | 1,205 | 7 | 14 | 838 | 91,281,687 | 302 | 100 | 2,211,000 | 26.50 | 
| regex_program | 1 | 295 | 2,843 | 174,326,267 | 196,838,026 | 295 | 2,248 | 56 | 206 | 209 | 480 | 731 | 7 | 2 | 437 | 73,453,305 | 175 | 84 | 1,897,597 | 31.28 | 

...
| `total_proof_time_ms ` |  3,811.50 |  7,623 |  4,876 |  2,747 |
...
| `execute_preflight_insn_mi/s` |  28.65 | -          |  31.02 |  26.29 |
| `trace_gen_time_ms   ` |  383.50 |  767 |  491 |  276 |
| `memory_finalize_time_ms` |  7.50 |  15 |  13 |  2 |
| `stark_prove_excluding_trace_time_ms` |  3,103.50 |  6,207 |  4,037 |  2,170 |
| `main_trace_commit_time_ms` |  616 |  1,232 |  839 |  393 |
| `generate_perm_trace_time_ms` |  238 |  476 |  321 |  155 |
| `perm_trace_commit_time_ms` |  655.50 |  1,311 |  850 |  461 |
| `quotient_poly_compute_time_ms` |  323.50 |  647 |  432 |  215 |
| `quotient_poly_commit_time_ms` |  310.50 |  621 |  402 |  219 |
| `pcs_opening_time_ms ` |  952.50 |  1,905 |  1,188 |  717 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2,747 | 6 | 1 | 31 | 4,108,597 | 129.18 | 46 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 491 | 4,876 | 211,758,557 | 373,183,036 | 491 | 4,037 | 0 | 432 | 402 | 850 | 1,188 | 7 | 13 | 839 | 91,281,687 | 321 | 102 | 2,211,000 | 26.29 | 
| regex_program | 1 | 276 | 2,747 | 174,326,267 | 196,838,026 | 276 | 2,170 | 51 | 215 | 219 | 461 | 717 | 6 | 2 | 393 | 73,453,305 | 155 | 85 | 1,897,597 | 31.02 | 

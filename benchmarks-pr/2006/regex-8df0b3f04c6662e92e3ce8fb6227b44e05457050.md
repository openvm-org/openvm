...
| `total_proof_time_ms ` |  3,819.50 |  7,639 |  4,924 |  2,715 |
...
| `execute_preflight_insn_mi/s` |  28.74 | -          |  31.10 |  26.37 |
| `trace_gen_time_ms   ` |  387.50 |  775 |  496 |  279 |
| `memory_finalize_time_ms` |  7.50 |  15 |  13 |  2 |
| `stark_prove_excluding_trace_time_ms` |  3,112 |  6,224 |  4,086 |  2,138 |
| `main_trace_commit_time_ms` |  616.50 |  1,233 |  842 |  391 |
| `generate_perm_trace_time_ms` |  234 |  468 |  317 |  151 |
| `perm_trace_commit_time_ms` |  650.50 |  1,301 |  850 |  451 |
| `quotient_poly_compute_time_ms` |  319 |  638 |  441 |  197 |
| `quotient_poly_commit_time_ms` |  302.50 |  605 |  400 |  205 |
| `pcs_opening_time_ms ` |  981.50 |  1,963 |  1,231 |  732 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2,715 | 6 | 1 | 31 | 4,108,597 | 130.68 | 44 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 496 | 4,924 | 211,758,557 | 373,183,036 | 496 | 4,086 | 0 | 441 | 400 | 850 | 1,231 | 9 | 13 | 842 | 91,281,687 | 317 | 101 | 2,211,000 | 26.37 | 
| regex_program | 1 | 279 | 2,715 | 174,326,267 | 196,838,026 | 279 | 2,138 | 51 | 197 | 205 | 451 | 732 | 6 | 2 | 391 | 73,453,305 | 151 | 83 | 1,897,597 | 31.10 | 

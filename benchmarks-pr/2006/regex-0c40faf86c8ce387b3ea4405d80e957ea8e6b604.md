...
| `total_proof_time_ms ` |  3,798 |  7,596 |  4,874 |  2,722 |
...
| `execute_preflight_insn_mi/s` |  28.62 | -          |  31.07 |  26.16 |
| `trace_gen_time_ms   ` |  382.50 |  765 |  495 |  270 |
| `memory_finalize_time_ms` |  8 |  16 |  14 |  2 |
| `stark_prove_excluding_trace_time_ms` |  3,087 |  6,174 |  4,027 |  2,147 |
| `main_trace_commit_time_ms` |  626 |  1,252 |  840 |  412 |
| `generate_perm_trace_time_ms` |  229.50 |  459 |  312 |  147 |
| `perm_trace_commit_time_ms` |  648 |  1,296 |  847 |  449 |
| `quotient_poly_compute_time_ms` |  318.50 |  637 |  434 |  203 |
| `quotient_poly_commit_time_ms` |  301.50 |  603 |  393 |  210 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2,722 | 6 | 1 | 31 | 4,108,597 | 131.96 | 44 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 495 | 4,874 | 211,758,557 | 373,183,036 | 495 | 4,027 | 0 | 434 | 393 | 847 | 1,196 | 7 | 14 | 840 | 91,281,687 | 312 | 103 | 2,211,000 | 26.16 | 
| regex_program | 1 | 270 | 2,722 | 174,326,267 | 196,838,026 | 270 | 2,147 | 50 | 203 | 210 | 449 | 715 | 6 | 2 | 412 | 73,453,305 | 147 | 83 | 1,897,597 | 31.07 | 

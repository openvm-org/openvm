...
|:---|---:|---:|
| Total |  7.44 |  4.28 |
| regex_program |  6.88 |  3.73 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  3,441 |  6,882 |  3,729 |  3,153 |
...
| `execute_e3_insn_mi/s` |  7.27 | -          |  7.34 |  7.20 |
| `trace_gen_time_ms   ` |  509.50 |  1,019 |  586 |  433 |
| `memory_finalize_time_ms` |  228.50 |  457 |  287 |  170 |
| `boundary_finalize_time_ms` |  3 |  6 |  5 |  1 |
| `merkle_finalize_time_ms` |  212.50 |  425 |  263 |  162 |
| `stark_prove_excluding_trace_time_ms` |  2,645.50 |  5,291 |  2,832 |  2,459 |
| `main_trace_commit_time_ms` |  504.50 |  1,009 |  564 |  445 |
| `generate_perm_trace_time_ms` |  217 |  434 |  227 |  207 |
| `perm_trace_commit_time_ms` |  575 |  1,150 |  600 |  550 |
| `quotient_poly_compute_time_ms` |  263 |  526 |  282 |  244 |
| `quotient_poly_commit_time_ms` |  259 |  518 |  312 |  206 |
| `pcs_opening_time_ms ` |  819.50 |  1,639 |  842 |  797 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2 | 583 | 4,165,433 | 1 | 555 | 7.50 | 20 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 586 | 3,729 | 2,243,700 | 275,648,700 | 2,832 | 282 | 312 | 600 | 842 | 263 | 287 | 564 | 93,502,324 | 2,243,700 | 227 | 311 | 7.20 | 5 | 
| regex_program | 1 | 433 | 3,153 | 1,921,732 | 242,975,388 | 2,459 | 244 | 206 | 550 | 797 | 162 | 170 | 445 | 73,017,132 | 1,921,733 | 207 | 261 | 7.34 | 1 | 

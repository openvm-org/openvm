...
|:---|---:|---:|
| Total |  7.34 |  4.22 |
| regex_program |  6.79 |  3.67 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  3,392.50 |  6,785 |  3,665 |  3,120 |
...
| `execute_e3_time_ms  ` |  286.50 |  573 |  311 |  262 |
| `execute_e3_insn_mi/s` |  7.26 | -          |  7.32 |  7.20 |
| `trace_gen_time_ms   ` |  504.50 |  1,009 |  575 |  434 |
| `memory_finalize_time_ms` |  228.50 |  457 |  287 |  170 |
| `boundary_finalize_time_ms` |  3 |  6 |  6 |  0 |
| `merkle_finalize_time_ms` |  212.50 |  425 |  262 |  163 |
| `stark_prove_excluding_trace_time_ms` |  2,601.50 |  5,203 |  2,779 |  2,424 |
| `main_trace_commit_time_ms` |  504.50 |  1,009 |  563 |  446 |
| `generate_perm_trace_time_ms` |  212 |  424 |  225 |  199 |
| `perm_trace_commit_time_ms` |  552.50 |  1,105 |  588 |  517 |
| `quotient_poly_compute_time_ms` |  275.50 |  551 |  285 |  266 |
| `quotient_poly_commit_time_ms` |  241 |  482 |  275 |  207 |
| `pcs_opening_time_ms ` |  806 |  1,612 |  838 |  774 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2 | 582 | 4,165,433 | 1 | 555 | 7.50 | 20 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 575 | 3,665 | 2,243,700 | 275,648,700 | 2,779 | 285 | 275 | 588 | 838 | 262 | 287 | 563 | 93,502,324 | 2,243,700 | 225 | 311 | 7.20 | 6 | 
| regex_program | 1 | 434 | 3,120 | 1,921,732 | 242,975,388 | 2,424 | 266 | 207 | 517 | 774 | 163 | 170 | 446 | 73,017,132 | 1,921,733 | 199 | 262 | 7.32 | 0 | 

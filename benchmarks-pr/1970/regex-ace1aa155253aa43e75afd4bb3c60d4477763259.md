...
|:---|---:|---:|
| Total |  7.65 | <span style='color: green'>(-0 [-0.5%])</span> 4.91 |
| regex_program |  7.62 | <span style='color: green'>(-0 [-0.5%])</span> 4.88 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  3,808 |  7,616 | <span style='color: green'>(-26 [-0.5%])</span> 4,880 | <span style='color: red'>(+23 [+0.8%])</span> 2,736 |
...
| `execute_metered_insn_mi/s` | <span style='color: red'>(+0 [+0.2%])</span> 127.89 | -          | <span style='color: red'>(+0 [+0.2%])</span> 127.89 | <span style='color: red'>(+0 [+0.2%])</span> 127.89 |
| `execute_preflight_insns` |  2,054,298.50 |  4,108,597 |  2,211,000 |  1,897,597 |
| `execute_preflight_time_ms` | <span style='color: green'>(-1 [-1.0%])</span> 95.50 | <span style='color: green'>(-2 [-1.0%])</span> 191 | <span style='color: green'>(-3 [-2.9%])</span> 102 | <span style='color: red'>(+1 [+1.1%])</span> 89 |
| `execute_preflight_insn_mi/s` |  27.64 | -          | <span style='color: green'>(-0 [-1.6%])</span> 29.68 | <span style='color: red'>(+1 [+2.0%])</span> 25.60 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+26 [+6.9%])</span> 409 | <span style='color: red'>(+53 [+6.9%])</span> 818 | <span style='color: red'>(+30 [+6.1%])</span> 525 | <span style='color: red'>(+23 [+8.5%])</span> 293 |
...
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+13 [+0.4%])</span> 3,113.50 | <span style='color: red'>(+26 [+0.4%])</span> 6,227 | <span style='color: red'>(+21 [+0.5%])</span> 4,082 | <span style='color: red'>(+5 [+0.2%])</span> 2,145 |
| `main_trace_commit_time_ms` | <span style='color: red'>(+12 [+2.0%])</span> 628.50 | <span style='color: red'>(+25 [+2.0%])</span> 1,257 | <span style='color: red'>(+1 [+0.1%])</span> 845 | <span style='color: red'>(+24 [+6.2%])</span> 412 |
| `generate_perm_trace_time_ms` | <span style='color: red'>(+9 [+3.9%])</span> 242.50 | <span style='color: red'>(+18 [+3.9%])</span> 485 | <span style='color: red'>(+22 [+7.2%])</span> 328 | <span style='color: green'>(-4 [-2.5%])</span> 157 |
| `perm_trace_commit_time_ms` | <span style='color: red'>(+4 [+0.5%])</span> 651 | <span style='color: red'>(+7 [+0.5%])</span> 1,302 | <span style='color: red'>(+7 [+0.8%])</span> 855 |  447 |
| `quotient_poly_compute_time_ms` | <span style='color: green'>(-15 [-4.5%])</span> 317 | <span style='color: green'>(-30 [-4.5%])</span> 634 | <span style='color: green'>(-24 [-5.3%])</span> 431 | <span style='color: green'>(-6 [-2.9%])</span> 203 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+0 [+0.2%])</span> 302 | <span style='color: red'>(+1 [+0.2%])</span> 604 | <span style='color: red'>(+1 [+0.3%])</span> 398 |  206 |
| `pcs_opening_time_ms ` |  961.50 |  1,923 | <span style='color: red'>(+9 [+0.7%])</span> 1,212 | <span style='color: green'>(-8 [-1.1%])</span> 711 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 165 | 2,736 | 8 | 1 | 32 | 4,108,597 | 127.89 | 46 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 525 | 4,880 | 211,758,557 | 373,183,036 | 525 | 4,082 | 0 | 431 | 398 | 855 | 1,212 | 10 | 13 | 845 | 91,281,687 | 328 | 102 | 2,211,000 | 25.60 | 
| regex_program | 1 | 293 | 2,736 | 174,326,267 | 196,838,026 | 293 | 2,145 | 55 | 203 | 206 | 447 | 711 | 8 | 2 | 412 | 73,453,305 | 157 | 89 | 1,897,597 | 29.68 | 

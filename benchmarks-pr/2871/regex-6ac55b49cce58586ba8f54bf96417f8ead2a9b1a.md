...
| `total_proof_time_ms ` |  752.50 |  1,505 |  815 |  690 |
| `execute_metered_time_ms` |  33 | -          | -          | -          |
| `execute_metered_insns` |  4,137,067 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  124 | -          |  124 |  124 |
| `execute_preflight_insns` |  2,068,533.50 |  4,137,067 |  2,208,000 |  1,929,067 |
| `execute_preflight_time_ms` |  73.50 |  147 |  80 |  67 |
| `execute_preflight_insn_mi/s` |  39.63 | -          |  41.45 |  37.82 |
| `trace_gen_time_ms   ` |  150.50 |  301 |  154 |  147 |
| `memory_finalize_time_ms` |  1 |  2 |  2 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  427.50 |  855 |  428 |  427 |
| `prover.main_trace_commit_time_ms` |  94 |  188 |  100 |  88 |
| `prover.rap_constraints_time_ms` |  236.50 |  473 |  246 |  227 |
| `prover.openings_time_ms` |  96 |  192 |  100 |  92 |
| `prover.rap_constraints.logup_gkr_time_ms` |  137.50 |  275 |  141 |  134 |
| `prover.rap_constraints.round0_time_ms` |  70.50 |  141 |  85 |  56 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  429 |  429 |  429 |  429 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/6ac55b49cce58586ba8f54bf96417f8ead2a9b1a/regex-6ac55b49cce58586ba8f54bf96417f8ead2a9b1a.memory.svg)
...
| app_proof |  |  |  |  |  | 690 |  |  | 33 | 4,137,067 | 124 | 0 | 1,553 |  | 
| internal_for_leaf |  |  |  | 272 |  |  |  |  |  |  |  |  |  | 272 | 
| internal_recursive.0 |  |  |  | 176 |  |  |  |  |  |  |  |  |  | 177 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 27,256,635 | 256 | 82 | 0 | 0 | 96 | 32 | 31 | 45 | 19 | 0 | 76 | 65 | 11 | 2 | 8 | 82 | 96 | 0 | 3 | 18 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,767 | 166 | 46 | 0 | 0 | 67 | 25 | 24 | 27 | 13 | 0 | 52 | 44 | 8 | 1 | 6 | 46 | 67 | 0 | 3 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 140 | 32 | 0 | 0 | 61 | 22 | 22 | 24 | 14 | 0 | 45 | 38 | 7 | 1 | 5 | 32 | 61 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 79,959,796 | 380 | 127 | 0 | 0 | 136 | 55 | 54 | 37 | 42 | 0 | 116 | 101 | 15 | 6 | 8 | 127 | 135 | 0 | 7 | 41 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 123,384,338 | 428 | 100 | 0 | 0 | 227 | 56 | 56 | 29 | 141 | 0 | 100 | 81 | 19 | 10 | 9 | 100 | 227 | 0 | 3 | 139 | 0 | 0 | 
| app_proof | prover | 1 | 106,568,591 | 427 | 88 | 0 | 0 | 246 | 85 | 85 | 25 | 134 | 0 | 92 | 74 | 18 | 8 | 9 | 88 | 246 | 0 | 3 | 133 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 147 | 815 | 147 | 159 | 2,052,973,566 | 668,936,290 | 2,721,909,856 | 2,097,152 | 2 | 7 | 80 | 2,208,000 | 37.82 | 
| app_proof | 1 | 154 | 690 | 154 | 41 | 1,584,899,101 | 646,500,736 | 2,231,399,837 | 2,097,152 | 0 | 2 | 67 | 1,929,067 | 41.45 | 

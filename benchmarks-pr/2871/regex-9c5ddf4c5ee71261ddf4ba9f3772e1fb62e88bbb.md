...
| `total_proof_time_ms ` |  760 |  1,520 |  820 |  700 |
| `execute_metered_time_ms` |  33 | -          | -          | -          |
| `execute_metered_insns` |  4,137,067 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  123.45 | -          |  123.45 |  123.45 |
| `execute_preflight_insns` |  2,068,533.50 |  4,137,067 |  2,208,000 |  1,929,067 |
| `execute_preflight_time_ms` |  74 |  148 |  81 |  67 |
| `execute_preflight_insn_mi/s` |  40.40 | -          |  42.18 |  38.62 |
| `trace_gen_time_ms   ` |  151 |  302 |  155 |  147 |
| `memory_finalize_time_ms` |  1.50 |  3 |  3 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  432.50 |  865 |  435 |  430 |
| `prover.main_trace_commit_time_ms` |  95 |  190 |  100 |  90 |
| `prover.rap_constraints_time_ms` |  239.50 |  479 |  251 |  228 |
| `prover.openings_time_ms` |  96.50 |  193 |  100 |  93 |
...
| `prover.openings.whir_time_ms` |  78 |  156 |  81 |  75 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  431 |  431 |  431 |  431 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/9c5ddf4c5ee71261ddf4ba9f3772e1fb62e88bbb/regex-9c5ddf4c5ee71261ddf4ba9f3772e1fb62e88bbb.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 75 | 9 |  |  | 0 |  | 351 | 9 |  |  |  |  |  |  | 
| app_proof |  |  |  |  |  | 700 |  |  | 33 | 4,137,067 | 123.45 | 0 | 1,568 |  | 
| internal_for_leaf |  |  |  | 279 |  |  |  |  |  |  |  |  |  | 279 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 27,256,635 | 263 | 82 | 0 | 0 | 98 | 33 | 32 | 45 | 19 | 0 | 82 | 70 | 11 | 2 | 8 | 82 | 98 | 0 | 3 | 18 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,767 | 169 | 46 | 0 | 0 | 67 | 25 | 24 | 28 | 13 | 0 | 54 | 45 | 8 | 1 | 6 | 47 | 67 | 0 | 3 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 138 | 31 | 0 | 0 | 62 | 23 | 23 | 24 | 13 | 0 | 44 | 36 | 7 | 1 | 5 | 32 | 61 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 79,959,796 | 381 | 128 | 0 | 0 | 136 | 56 | 55 | 38 | 42 | 0 | 116 | 100 | 15 | 6 | 8 | 128 | 136 | 0 | 7 | 41 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 123,384,338 | 430 | 100 | 0 | 0 | 228 | 56 | 55 | 29 | 142 | 0 | 100 | 81 | 19 | 10 | 9 | 100 | 228 | 0 | 3 | 139 | 0 | 0 | 
| app_proof | prover | 1 | 106,568,591 | 435 | 90 | 0 | 0 | 251 | 86 | 86 | 26 | 138 | 0 | 93 | 75 | 18 | 8 | 9 | 90 | 251 | 0 | 3 | 137 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 147 | 820 | 147 | 160 | 2,052,973,566 | 668,936,290 | 2,721,909,856 | 2,097,152 | 3 | 8 | 81 | 2,208,000 | 38.62 | 
| app_proof | 1 | 155 | 700 | 155 | 41 | 1,584,899,101 | 646,500,736 | 2,231,399,837 | 2,097,152 | 0 | 2 | 67 | 1,929,067 | 42.18 | 

...
|:---|---:|---:|---:|
| Total |  18.82 |  5.30 |  5.30 |
| app_proof |  15.77 |  3.02 |  3.02 |
| leaf |  2.20 |  1.43 |  1.43 |
...
| `total_proof_time_ms ` |  2,622.17 |  15,733 |  2,986 |  2,531 |
| `execute_metered_time_ms` |  37 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  33.18 | -          |  33.18 |  33.18 |
| `execute_preflight_insns` |  205,869.67 |  1,235,218 |  207,000 |  200,218 |
| `execute_preflight_time_ms` |  180 |  1,080 |  265 |  15 |
| `execute_preflight_insn_mi/s` |  19.23 | -          |  19.39 |  18.97 |
| `trace_gen_time_ms   ` |  387.67 |  2,326 |  543 |  351 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,990.50 |  11,943 |  2,256 |  1,930 |
| `prover.main_trace_commit_time_ms` |  689.83 |  4,139 |  848 |  657 |
| `prover.rap_constraints_time_ms` |  1,114.50 |  6,687 |  1,224 |  1,088 |
| `prover.openings_time_ms` |  185.17 |  1,111 |  190 |  182 |
| `prover.rap_constraints.logup_gkr_time_ms` |  275.33 |  1,652 |  383 |  253 |
| `prover.rap_constraints.round0_time_ms` |  524 |  3,144 |  528 |  520 |
| `prover.rap_constraints.mle_rounds_time_ms` |  314.17 |  1,885 |  320 |  312 |
| `prover.openings.stacked_reduction_time_ms` |  140.67 |  844 |  142 |  139 |
| `prover.openings.stacked_reduction.round0_time_ms` |  85 |  510 |  86 |  84 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  55 |  330 |  57 |  54 |
| `prover.openings.whir_time_ms` |  43.83 |  263 |  49 |  40 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,099.50 |  2,199 |  1,427 |  772 |
| `execute_preflight_time_ms` |  4.50 |  9 |  5 |  4 |
| `trace_gen_time_ms   ` |  136.50 |  273 |  184 |  89 |
| `generate_blob_total_time_ms` |  25.50 |  51 |  34 |  17 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  962.50 |  1,925 |  1,242 |  683 |
| `prover.main_trace_commit_time_ms` |  546.50 |  1,093 |  719 |  374 |
| `prover.rap_constraints_time_ms` |  309 |  618 |  396 |  222 |
| `prover.openings_time_ms` |  106.50 |  213 |  127 |  86 |
| `prover.rap_constraints.logup_gkr_time_ms` |  65.50 |  131 |  81 |  50 |
| `prover.rap_constraints.round0_time_ms` |  148 |  296 |  193 |  103 |
...
| `prover.openings.whir_time_ms` |  37.50 |  75 |  41 |  34 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/a10b0a98cfcc10fe6df48aabf04c12d178b81436/keccak-a10b0a98cfcc10fe6df48aabf04c12d178b81436.memory.svg)
...
| app_proof |  |  |  |  |  | 2,538 |  |  | 37 | 1,235,218 | 33.18 | 0 | 15,776 |  | 
| internal_for_leaf |  |  |  | 521 |  |  |  |  |  |  |  |  |  | 521 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 37 | 521 | 37 | 13 | 4 | 2 | 2 | 2 | 
| internal_recursive.0 | 1 | 12 | 182 | 12 | 2 | 1 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 8 | 145 | 8 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 184 | 1,427 | 184 | 65 | 34 | 5 | 7 | 7 | 
| leaf | 1 | 89 | 772 | 89 | 32 | 17 | 4 | 7 | 7 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 109,497,984 | 483 | 246 | 0 | 14 | 174 | 46 | 45 | 93 | 34 | 0 | 62 | 24 | 38 | 7 | 30 | 246 | 174 | 0 | 2 | 32 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 25,962,119 | 170 | 51 | 0 | 3 | 74 | 23 | 23 | 29 | 21 | 0 | 43 | 19 | 23 | 1 | 21 | 52 | 74 | 0 | 2 | 21 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 17,507,975 | 136 | 33 | 0 | 3 | 64 | 22 | 21 | 24 | 17 | 0 | 37 | 15 | 22 | 1 | 21 | 34 | 64 | 0 | 2 | 16 | 0 | 0 | 
| leaf | 0 | prover | 583,523,386 | 1,242 | 718 | 0 | 47 | 396 | 193 | 192 | 121 | 81 | 0 | 127 | 41 | 86 | 40 | 45 | 719 | 396 | 0 | 6 | 80 | 0 | 0 | 
| leaf | 1 | prover | 300,618,208 | 683 | 373 | 0 | 24 | 222 | 103 | 102 | 67 | 50 | 0 | 86 | 34 | 51 | 19 | 31 | 374 | 222 | 0 | 5 | 49 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,205,061,845 | 2,256 | 848 | 0 | 243 | 1,224 | 520 | 519 | 320 | 383 | 128 | 183 | 40 | 142 | 86 | 55 | 848 | 1,224 | 0 | 3 | 254 | 0 | 0 | 
| app_proof | prover | 1 | 1,205,053,652 | 1,940 | 657 | 0 | 51 | 1,092 | 525 | 525 | 312 | 254 | 0 | 190 | 48 | 141 | 86 | 55 | 657 | 1,092 | 0 | 3 | 253 | 0 | 0 | 
| app_proof | prover | 2 | 1,205,053,652 | 1,930 | 657 | 0 | 51 | 1,088 | 521 | 521 | 312 | 254 | 0 | 184 | 42 | 141 | 85 | 55 | 658 | 1,088 | 0 | 4 | 253 | 0 | 0 | 
| app_proof | prover | 3 | 1,205,053,652 | 1,936 | 658 | 0 | 51 | 1,095 | 528 | 528 | 313 | 253 | 0 | 182 | 43 | 139 | 84 | 54 | 658 | 1,095 | 0 | 4 | 252 | 0 | 0 | 
| app_proof | prover | 4 | 1,205,053,652 | 1,943 | 659 | 0 | 51 | 1,094 | 526 | 525 | 313 | 254 | 0 | 188 | 49 | 139 | 84 | 54 | 659 | 1,094 | 0 | 3 | 252 | 0 | 0 | 
| app_proof | prover | 5 | 1,205,062,652 | 1,938 | 659 | 0 | 52 | 1,094 | 524 | 524 | 315 | 254 | 0 | 184 | 41 | 142 | 85 | 57 | 659 | 1,094 | 0 | 3 | 253 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 543 | 2,986 | 543 | 170 | 0 | 192 | 15 | 207,000 | 19.03 | 
| app_proof | 1 | 351 | 2,599 | 351 | 41 | 0 | 1 | 265 | 207,000 | 18.97 | 
| app_proof | 2 | 351 | 2,531 | 351 | 41 | 0 | 1 | 208 | 207,000 | 19.29 | 
| app_proof | 3 | 351 | 2,536 | 351 | 41 | 0 | 1 | 207 | 207,000 | 19.37 | 
| app_proof | 4 | 352 | 2,543 | 352 | 41 | 0 | 2 | 206 | 207,000 | 19.35 | 
| app_proof | 5 | 378 | 2,538 | 378 | 41 | 0 | 29 | 179 | 200,218 | 19.39 | 

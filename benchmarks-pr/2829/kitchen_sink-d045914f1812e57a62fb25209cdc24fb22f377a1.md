...
| `total_proof_time_ms ` |  1,934.50 |  3,869 |  2,244 |  1,625 |
...
| `execute_preflight_insn_mi/s` |  35.13 | -          |  36.08 |  34.19 |
| `trace_gen_time_ms   ` |  142.50 |  285 |  186 |  99 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,583.50 |  3,167 |  1,817 |  1,350 |
| `prover.main_trace_commit_time_ms` |  515 |  1,030 |  597 |  433 |
| `prover.rap_constraints_time_ms` |  937.50 |  1,875 |  1,083 |  792 |
| `prover.openings_time_ms` |  129.50 |  259 |  135 |  124 |
| `prover.rap_constraints.logup_gkr_time_ms` |  167.50 |  335 |  198 |  137 |
| `prover.rap_constraints.round0_time_ms` |  565.50 |  1,131 |  670 |  461 |
| `prover.rap_constraints.mle_rounds_time_ms` |  204 |  408 |  215 |  193 |
| `prover.openings.stacked_reduction_time_ms` |  96 |  192 |  105 |  87 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/d045914f1812e57a62fb25209cdc24fb22f377a1/kitchen_sink-d045914f1812e57a62fb25209cdc24fb22f377a1.memory.svg)
...
| app_proof |  |  |  |  |  | 1,625 |  |  | 34 | 2,579,903 | 73.78 | 0 | 3,909 |  | 
...
| leaf | 0 | 122 | 955 | 121 | 23 | 9 | 21 | 5 | 5 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,577,979 | 258 | 117 | 0 | 0 | 107 | 36 | 35 | 51 | 20 | 0 | 33 | 19 | 13 | 3 | 9 | 117 | 107 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,767 | 142 | 45 | 0 | 0 | 68 | 26 | 25 | 28 | 13 | 0 | 27 | 18 | 8 | 1 | 6 | 46 | 68 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 119 | 32 | 0 | 0 | 62 | 24 | 23 | 24 | 14 | 0 | 24 | 16 | 7 | 1 | 5 | 32 | 62 | 0 | 2 | 13 | 0 | 0 | 
| leaf | 0 | prover | 265,003,892 | 833 | 404 | 0 | 1 | 353 | 136 | 135 | 78 | 138 | 0 | 75 | 34 | 40 | 22 | 18 | 404 | 353 | 0 | 6 | 137 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 567,917,156 | 1,817 | 596 | 0 | 184 | 1,083 | 670 | 669 | 215 | 198 | 55 | 135 | 30 | 105 | 51 | 53 | 597 | 1,083 | 0 | 3 | 140 | 0 | 0 | 
| app_proof | prover | 1 | 537,266,124 | 1,350 | 433 | 0 | 2 | 792 | 461 | 461 | 193 | 137 | 0 | 124 | 37 | 87 | 49 | 37 | 433 | 792 | 0 | 3 | 136 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 186 | 2,244 | 186 | 177 | 0 | 3 | 63 | 1,540,000 | 34.19 | 
| app_proof | 1 | 99 | 1,625 | 99 | 41 | 0 | 2 | 134 | 1,039,903 | 36.08 | 

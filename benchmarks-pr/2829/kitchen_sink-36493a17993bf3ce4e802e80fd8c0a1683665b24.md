...
|:---|---:|---:|---:|
| Total |  5.52 |  3.86 |  3.86 |
| app_proof |  3.98 |  2.31 |  2.31 |
| leaf |  0.98 |  0.98 |  0.98 |
...
| `total_proof_time_ms ` |  1,970 |  3,940 |  2,278 |  1,662 |
| `execute_metered_time_ms` |  35 | -          | -          | -          |
| `execute_metered_insns` |  2,579,903 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  72.64 | -          |  72.64 |  72.64 |
| `execute_preflight_insns` |  1,289,951.50 |  2,579,903 |  1,540,000 |  1,039,903 |
| `execute_preflight_time_ms` |  97 |  194 |  132 |  62 |
| `execute_preflight_insn_mi/s` |  35.59 | -          |  36.70 |  34.48 |
| `trace_gen_time_ms   ` |  149.50 |  299 |  193 |  106 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,612 |  3,224 |  1,843 |  1,381 |
| `prover.main_trace_commit_time_ms` |  521 |  1,042 |  602 |  440 |
| `prover.rap_constraints_time_ms` |  956.50 |  1,913 |  1,102 |  811 |
| `prover.openings_time_ms` |  134 |  268 |  139 |  129 |
| `prover.rap_constraints.logup_gkr_time_ms` |  170.50 |  341 |  201 |  140 |
| `prover.rap_constraints.round0_time_ms` |  577 |  1,154 |  683 |  471 |
| `prover.rap_constraints.mle_rounds_time_ms` |  208 |  416 |  217 |  199 |
| `prover.openings.stacked_reduction_time_ms` |  98 |  196 |  107 |  89 |
| `prover.openings.stacked_reduction.round0_time_ms` |  51 |  102 |  52 |  50 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  46 |  92 |  54 |  38 |
...
| `prover.rap_constraints.round0_time_ms` |  141 |  141 |  141 |  141 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/36493a17993bf3ce4e802e80fd8c0a1683665b24/kitchen_sink-36493a17993bf3ce4e802e80fd8c0a1683665b24.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 83 | 9 |  |  | 0 |  | 409 | 9 |  |  |  |  |  |  | 
| app_proof |  |  |  |  |  | 1,662 |  |  | 35 | 2,579,903 | 72.64 | 0 | 3,980 |  | 
| internal_for_leaf |  |  |  | 287 |  |  |  |  |  |  |  |  |  | 287 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,577,979 | 266 | 120 | 0 | 0 | 110 | 36 | 35 | 53 | 20 | 0 | 35 | 21 | 13 | 3 | 9 | 120 | 110 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,767 | 144 | 46 | 0 | 0 | 67 | 25 | 24 | 28 | 13 | 0 | 29 | 21 | 8 | 1 | 6 | 47 | 67 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 119 | 32 | 0 | 0 | 63 | 24 | 24 | 24 | 13 | 0 | 23 | 16 | 7 | 1 | 5 | 33 | 63 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 265,003,892 | 854 | 411 | 0 | 1 | 361 | 141 | 140 | 79 | 140 | 0 | 81 | 40 | 41 | 22 | 18 | 411 | 361 | 0 | 7 | 139 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 567,917,156 | 1,843 | 601 | 0 | 182 | 1,102 | 683 | 682 | 217 | 201 | 54 | 139 | 32 | 107 | 52 | 54 | 602 | 1,102 | 0 | 3 | 144 | 0 | 0 | 
| app_proof | prover | 1 | 537,266,124 | 1,381 | 440 | 0 | 1 | 811 | 471 | 471 | 199 | 140 | 0 | 129 | 40 | 89 | 50 | 38 | 440 | 811 | 0 | 4 | 139 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 193 | 2,278 | 193 | 178 | 0 | 4 | 62 | 1,540,000 | 34.48 | 
| app_proof | 1 | 106 | 1,662 | 106 | 41 | 0 | 2 | 132 | 1,039,903 | 36.70 | 

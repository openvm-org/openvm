...
| `total_proof_time_ms ` |  2,039.50 |  4,079 |  2,740 |  1,339 |
...
| `execute_preflight_time_ms` |  240.50 |  481 |  321 |  160 |
| `execute_preflight_insn_mi/s` |  23.22 | -          |  25.05 |  22.22 |
| `postflight_time_ms  ` |  85.50 |  171 |  122 |  49 |
| `postflight_memory_chronology_time_ms` |  12 |  24 |  20 |  4 |
| `postflight_program_index_time_ms` |  1.50 |  3 |  2 |  1 |
| `trace_gen_time_ms   ` |  40 |  80 |  56 |  24 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,636.50 |  3,273 |  2,194 |  1,079 |
| `prover.main_trace_commit_time_ms` |  391.50 |  783 |  566 |  217 |
| `prover.rap_constraints_time_ms` |  978 |  1,956 |  1,286 |  670 |
| `prover.openings_time_ms` |  266 |  532 |  341 |  191 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/4ba087cd860326e246322001b3a34506f3fda759/sha2_bench-4ba087cd860326e246322001b3a34506f3fda759.memory.svg)
...
| leaf | 0 | prover | 237,929,272 | 403 | 144 | 0 | 0 | 142 | 71 | 70 | 44 | 25 | 0 | 116 | 94 | 21 | 10 | 11 | 145 | 144 | 142 | 0 | 3 | 25 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover |  | 0 | 1,289,518,990 | 2,194 | 566 | 0 | 0 | 1,286 | 699 | 698 | 233 | 353 | 1 | 341 | 248 | 93 | 57 | 36 | 566 | 566 | 1,286 | 0 | 1 | 351 | 0 | 0 | 
| app_proof | prover |  | 1 | 692,746,700 | 1,079 | 217 | 0 | 0 | 670 | 350 | 349 | 125 | 194 | 0 | 191 | 139 | 52 | 31 | 21 | 217 | 217 | 670 | 0 | 1 | 193 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof |  | 1,339 | 56 | 11,167,961 | 198.54 | 0 | 4,146 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof |  | 0 | 4 | 2 | 56 | 2,740 | 3 | 4 | 0 | 122 | 2 | 20 | 0 | 12,605,497,128 | 2,871,495,552 | 15,476,992,680 | 2,097,152 | 2 | 0 | 0 | 3 | 52 | 321 | 7,136,000 | 22.22 | 0 | 0 | 
| app_proof |  | 1 | 3 | 2 | 24 | 1,339 | 3 | 3 | 0 | 49 | 1 | 4 | 0 | 7,154,612,856 | 1,641,450,113 | 8,796,062,969 | 2,097,152 | 2 | 0 | 0 | 2 | 21 | 160 | 4,031,961 | 25.05 | 0 | 0 | 

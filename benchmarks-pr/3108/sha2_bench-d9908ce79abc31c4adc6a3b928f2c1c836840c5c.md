...
|:---|---:|---:|---:|
| Total |  5.13 |  3.90 |  3.90 |
| app_proof |  4.18 |  2.95 |  2.95 |
| leaf |  0.52 |  0.52 |  0.52 |
...
| `total_proof_time_ms ` |  2,060 |  4,120 |  2,725 |  1,395 |
| `compile_metered_time_ms` |  0 |  0 |  0 |  0 |
| `execute_metered_time_ms` |  60 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  184.06 | -          |  184.06 |  184.06 |
| `set_initial_memory_time_ms` |  4 |  8 |  5 |  3 |
| `execute_preflight_insns` |  5,583,980.50 |  11,167,961 |  7,136,000 |  4,031,961 |
| `execute_preflight_time_ms` |  254.50 |  509 |  343 |  166 |
| `execute_preflight_insn_mi/s` |  21.94 | -          |  24.16 |  20.75 |
| `postflight_time_ms  ` |  134.50 |  269 |  191 |  78 |
...
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,575 |  3,150 |  2,062 |  1,088 |
| `prover.main_trace_commit_time_ms` |  389.50 |  779 |  564 |  215 |
| `prover.rap_constraints_time_ms` |  914.50 |  1,829 |  1,155 |  674 |
| `prover.openings_time_ms` |  270 |  540 |  342 |  198 |
| `prover.rap_constraints.logup_gkr_time_ms` |  218.50 |  437 |  242 |  195 |
| `prover.rap_constraints.round0_time_ms` |  514 |  1,028 |  677 |  351 |
...
| `prover.openings.whir_time_ms` |  197.50 |  395 |  249 |  146 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/d9908ce79abc31c4adc6a3b928f2c1c836840c5c/sha2_bench-d9908ce79abc31c4adc6a3b928f2c1c836840c5c.memory.svg)
...
| leaf | 0 | 115 | 522 | 115 | 33 | 12 | 2 | 9 | 9 | 
...
| leaf | 0 | prover | 237,929,272 | 406 | 145 | 0 | 0 | 142 | 72 | 70 | 44 | 26 | 0 | 117 | 95 | 22 | 10 | 11 | 146 | 145 | 142 | 0 | 3 | 25 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover |  | 0 | 1,281,523,083 | 2,062 | 564 | 0 | 0 | 1,155 | 677 | 676 | 235 | 242 | 1 | 342 | 249 | 93 | 57 | 36 | 564 | 564 | 1,155 | 0 | 1 | 241 | 0 | 0 | 
| app_proof | prover |  | 1 | 687,699,844 | 1,088 | 215 | 0 | 0 | 674 | 351 | 350 | 127 | 195 | 0 | 198 | 146 | 51 | 30 | 21 | 215 | 215 | 674 | 0 | 1 | 194 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof |  | 1,395 | 60 | 11,167,961 | 184.06 | 0 | 4,186 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof |  | 0 | 5 | 2 | 74 | 2,725 | 5 | 5 | 0 | 191 | 2 | 20 | 0 | 12,537,603,360 | 2,843,438,436 | 15,381,041,796 | 2,097,152 | 2 | 0 | 2 | 5 | 68 | 343 | 7,136,000 | 20.75 | 0 | 0 | 
| app_proof |  | 1 | 3 | 2 | 33 | 1,395 | 3 | 3 | 0 | 78 | 1 | 4 | 0 | 7,116,253,404 | 1,550,303,741 | 8,666,557,145 | 2,097,152 | 2 | 0 | 0 | 2 | 29 | 166 | 4,031,961 | 24.16 | 0 | 0 | 

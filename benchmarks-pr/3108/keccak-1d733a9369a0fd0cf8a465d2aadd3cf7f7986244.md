...
|:---|---:|---:|---:|
| Total |  9.45 |  3.36 |  3.36 |
| app_proof |  7.31 |  1.71 |  1.71 |
| leaf |  1.57 |  1.08 |  1.08 |
...
| `total_proof_time_ms ` |  1,197.67 |  7,186 |  1,256 |  1,170 |
...
| `execute_preflight_time_ms` |  69.17 |  415 |  81 |  65 |
| `execute_preflight_insn_mi/s` |  34.61 | -          |  35.84 |  29.72 |
| `postflight_time_ms  ` |  34.33 |  206 |  46 |  30 |
| `postflight_memory_chronology_time_ms` |  3 |  18 |  6 |  2 |
| `postflight_program_index_time_ms` |  0 |  0 |  0 |  0 |
| `trace_gen_time_ms   ` |  13.50 |  81 |  21 |  12 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,064.83 |  6,389 |  1,086 |  1,049 |
| `prover.main_trace_commit_time_ms` |  334.83 |  2,009 |  357 |  325 |
| `prover.rap_constraints_time_ms` |  505.83 |  3,035 |  508 |  503 |
| `prover.openings_time_ms` |  223.33 |  1,340 |  227 |  220 |
| `prover.rap_constraints.logup_gkr_time_ms` |  102.17 |  613 |  103 |  101 |
| `prover.rap_constraints.round0_time_ms` |  280.33 |  1,682 |  282 |  279 |
...
| `prover.openings.whir_time_ms` |  163 |  978 |  166 |  160 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  786 |  1,572 |  1,077 |  495 |
| `execute_preflight_time_ms` |  4.50 |  9 |  5 |  4 |
| `trace_gen_time_ms   ` |  133 |  266 |  177 |  89 |
| `generate_blob_total_time_ms` |  15.50 |  31 |  21 |  10 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  653 |  1,306 |  900 |  406 |
| `prover.main_trace_commit_time_ms` |  262 |  524 |  378 |  146 |
| `prover.rap_constraints_time_ms` |  187 |  374 |  232 |  142 |
| `prover.openings_time_ms` |  204 |  408 |  290 |  118 |
...
| `prover.openings.whir_time_ms` |  174.50 |  349 |  253 |  96 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/1d733a9369a0fd0cf8a465d2aadd3cf7f7986244/keccak-1d733a9369a0fd0cf8a465d2aadd3cf7f7986244.memory.svg)
...
| leaf | 0 | 177 | 1,077 | 176 | 56 | 21 | 4 | 10 | 10 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 81,415,160 | 287 | 92 | 0 | 0 | 114 | 39 | 38 | 56 | 17 | 0 | 80 | 65 | 15 | 5 | 10 | 93 | 92 | 114 | 0 | 1 | 16 | 0 | 0 | 
...
| leaf | 0 | prover | 476,578,798 | 900 | 377 | 0 | 60 | 232 | 120 | 119 | 70 | 40 | 0 | 290 | 253 | 37 | 19 | 17 | 378 | 377 | 232 | 0 | 3 | 39 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover |  | 0 | 828,569,228 | 1,086 | 357 | 0 | 0 | 506 | 280 | 280 | 122 | 102 | 0 | 222 | 162 | 60 | 35 | 24 | 357 | 357 | 506 | 0 | 1 | 101 | 0 | 0 | 
| app_proof | prover |  | 1 | 828,569,228 | 1,069 | 337 | 0 | 0 | 508 | 281 | 281 | 122 | 103 | 0 | 223 | 163 | 60 | 35 | 24 | 337 | 337 | 508 | 0 | 1 | 102 | 0 | 0 | 
| app_proof | prover |  | 2 | 828,569,228 | 1,060 | 329 | 0 | 0 | 505 | 279 | 279 | 122 | 102 | 0 | 225 | 165 | 60 | 35 | 24 | 330 | 329 | 505 | 0 | 1 | 101 | 0 | 0 | 
| app_proof | prover |  | 3 | 828,569,228 | 1,066 | 329 | 0 | 0 | 508 | 282 | 281 | 122 | 103 | 0 | 227 | 166 | 60 | 36 | 24 | 330 | 329 | 508 | 0 | 1 | 103 | 0 | 0 | 
| app_proof | prover |  | 4 | 828,569,228 | 1,059 | 329 | 0 | 0 | 505 | 280 | 279 | 122 | 102 | 0 | 223 | 162 | 60 | 35 | 24 | 330 | 329 | 505 | 0 | 1 | 101 | 0 | 0 | 
| app_proof | prover |  | 5 | 818,607,756 | 1,049 | 325 | 0 | 0 | 503 | 280 | 279 | 122 | 101 | 0 | 220 | 160 | 60 | 35 | 24 | 325 | 325 | 503 | 0 | 1 | 100 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof |  | 1,170 | 124 | 14,365,133 | 115.10 | 0 | 7,321 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof |  | 0 | 4 | 2 | 21 | 1,256 | 5 | 4 | 0 | 46 | 0 | 6 | 0 | 9,327,052,656 | 615,778,080 | 9,942,830,736 | 2,097,152 | 2 | 0 | 2 | 5 | 15 | 81 | 2,413,000 | 29.72 | 0 | 0 | 
| app_proof |  | 1 | 2 | 2 | 12 | 1,195 | 3 | 2 | 0 | 32 | 0 | 2 | 0 | 9,327,359,880 | 616,392,456 | 9,943,752,336 | 2,097,152 | 2 | 0 | 0 | 2 | 9 | 67 | 2,413,000 | 35.77 | 0 | 0 | 
| app_proof |  | 2 | 2 | 2 | 12 | 1,188 | 3 | 2 | 0 | 34 | 0 | 4 | 0 | 9,326,596,344 | 617,155,992 | 9,943,752,336 | 2,097,152 | 2 | 0 | 0 | 2 | 9 | 68 | 2,413,000 | 35.46 | 0 | 0 | 
| app_proof |  | 3 | 2 | 2 | 12 | 1,192 | 2 | 2 | 0 | 32 | 0 | 2 | 0 | 9,327,359,244 | 616,393,092 | 9,943,752,336 | 2,097,152 | 2 | 0 | 0 | 2 | 9 | 67 | 2,413,000 | 35.84 | 0 | 0 | 
| app_proof |  | 4 | 2 | 2 | 12 | 1,185 | 2 | 2 | 0 | 32 | 0 | 2 | 0 | 9,326,596,176 | 617,156,160 | 9,943,752,336 | 2,097,152 | 2 | 0 | 0 | 2 | 9 | 67 | 2,413,000 | 35.66 | 0 | 0 | 
| app_proof |  | 5 | 2 | 2 | 12 | 1,170 | 3 | 2 | 0 | 30 | 0 | 2 | 0 | 8,893,973,964 | 930,240,708 | 9,824,214,672 | 2,097,152 | 2 | 0 | 0 | 2 | 8 | 65 | 2,300,133 | 35.16 | 0 | 0 | 

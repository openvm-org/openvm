...
|:---|---:|---:|---:|
| Total |  9.42 |  3.35 |  3.35 |
| app_proof |  7.28 |  1.71 |  1.71 |
| leaf |  1.58 |  1.09 |  1.09 |
...
| `total_proof_time_ms ` |  1,192 |  7,152 |  1,248 |  1,167 |
...
| `execute_preflight_time_ms` |  69 |  414 |  80 |  64 |
| `execute_preflight_insn_mi/s` |  34.70 | -          |  35.69 |  29.95 |
| `postflight_time_ms  ` |  31.33 |  188 |  43 |  27 |
| `postflight_memory_chronology_time_ms` |  3 |  18 |  6 |  2 |
| `postflight_program_index_time_ms` |  0 |  0 |  0 |  0 |
| `trace_gen_time_ms   ` |  13.67 |  82 |  22 |  12 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,061.50 |  6,369 |  1,081 |  1,049 |
| `prover.main_trace_commit_time_ms` |  333.50 |  2,001 |  355 |  324 |
| `prover.rap_constraints_time_ms` |  504.17 |  3,025 |  506 |  502 |
| `prover.openings_time_ms` |  222.50 |  1,335 |  226 |  221 |
| `prover.rap_constraints.logup_gkr_time_ms` |  102.17 |  613 |  103 |  101 |
...
| `prover.openings.stacked_reduction.round0_time_ms` |  35 |  210 |  35 |  35 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  24 |  144 |  24 |  24 |
| `prover.openings.whir_time_ms` |  162.83 |  977 |  167 |  161 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  792 |  1,584 |  1,089 |  495 |
| `execute_preflight_time_ms` |  4 |  8 |  4 |  4 |
| `trace_gen_time_ms   ` |  137.50 |  275 |  184 |  91 |
| `generate_blob_total_time_ms` |  15.50 |  31 |  21 |  10 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  653.50 |  1,307 |  904 |  403 |
| `prover.main_trace_commit_time_ms` |  261.50 |  523 |  378 |  145 |
| `prover.rap_constraints_time_ms` |  186 |  372 |  231 |  141 |
| `prover.openings_time_ms` |  205.50 |  411 |  295 |  116 |
...
| `prover.openings.whir_time_ms` |  176 |  352 |  258 |  94 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/4d105031aced92e76436b9128a7f264213e4b00b/keccak-4d105031aced92e76436b9128a7f264213e4b00b.memory.svg)
...
| leaf | 0 | 184 | 1,089 | 183 | 57 | 21 | 4 | 10 | 10 | 
| leaf | 1 | 91 | 495 | 90 | 28 | 10 | 4 | 10 | 10 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 81,415,160 | 283 | 92 | 0 | 0 | 114 | 39 | 38 | 56 | 17 | 0 | 76 | 61 | 15 | 4 | 10 | 93 | 92 | 114 | 0 | 1 | 16 | 0 | 0 | 
...
| leaf | 0 | prover | 476,578,798 | 904 | 377 | 0 | 62 | 231 | 120 | 119 | 70 | 40 | 0 | 295 | 258 | 36 | 19 | 16 | 378 | 377 | 231 | 0 | 3 | 39 | 0 | 0 | 
| leaf | 1 | prover | 240,255,800 | 403 | 144 | 0 | 0 | 141 | 70 | 69 | 44 | 26 | 0 | 116 | 94 | 21 | 10 | 11 | 145 | 144 | 141 | 0 | 3 | 25 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover |  | 0 |
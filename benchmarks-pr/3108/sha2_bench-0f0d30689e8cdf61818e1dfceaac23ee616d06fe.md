...
|:---|---:|---:|---:|
| Total |  5.06 |  3.86 |  3.86 |
| app_proof |  4.11 |  2.90 |  2.90 |
| leaf |  0.53 |  0.53 |  0.53 |
...
| `total_proof_time_ms ` |  2,023.50 |  4,047 |  2,675 |  1,372 |
| `compile_metered_time_ms` |  0 |  0 |  0 |  0 |
| `execute_metered_time_ms` |  61 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  182.86 | -          |  182.86 |  182.86 |
| `set_initial_memory_time_ms` |  4 |  8 |  5 |  3 |
| `execute_preflight_insns` |  5,583,980.50 |  11,167,961 |  7,136,000 |  4,031,961 |
| `execute_preflight_time_ms` |  258 |  516 |  349 |  167 |
| `execute_preflight_insn_mi/s` |  21.64 | -          |  24.09 |  20.39 |
| `postflight_time_ms  ` |  106.50 |  213 |  149 |  64 |
| `postflight_memory_chronology_time_ms` |  12 |  24 |  20 |  4 |
| `postflight_program_index_time_ms` |  1.50 |  3 |  2 |  1 |
| `trace_gen_time_ms   ` |  54 |  108 |  75 |  33 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,562.50 |  3,125 |  2,046 |  1,079 |
| `prover.main_trace_commit_time_ms` |  386.50 |  773 |  561 |  212 |
| `prover.rap_constraints_time_ms` |  904.50 |  1,809 |  1,141 |  668 |
| `prover.openings_time_ms` |  269.50 |  539 |  342 |  197 |
| `prover.rap_constraints.logup_gkr_time_ms` |  215.50 |  431 |  239 |  192 |
...
| `prover.openings.whir_time_ms` |  198 |  396 |  250 |  146 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/0f0d30689e8cdf61818e1dfceaac23ee616d06fe/sha2_bench-0f0d30689e8cdf61818e1dfceaac23ee616d06fe.memory.svg)
...
| internal_recursive.0 | 1 | prover | 15,378,769 | 108 | 20 | 0 | 0 | 56 | 21 | 20 | 23 | 10 | 0 | 31 | 23 | 7 | 1 | 6 | 20 | 20 | 56 | 0 | 1 | 10 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 97 | 15 | 0 | 0 | 54 | 21 | 19 | 21 | 11 | 0 | 27 | 20 | 7 | 1 | 5 | 15 | 15 | 54 | 0 | 1 | 10 | 0 | 0 | 
| leaf | 0 | prover | 237,929,272 | 406 | 144 | 0 | 0 | 144 | 72 | 71 | 45 | 26 | 0 | 116 | 94 | 21 | 10 | 11 | 145 | 144 | 144 | 0 | 3 | 25 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover |  | 0 | 1,281,523,083 | 2,046 | 561 | 0 | 0 | 1,141 | 670 | 670 | 230 | 239 | 1 | 342 | 250 | 92 | 56 | 35 | 561 | 561 | 1,141 | 0 | 1 | 237 | 0 | 0 | 
| app_proof | prover |  | 1 | 687,699,844 | 1,079 | 212 | 0 | 0 | 668 | 348 | 348 | 126 | 192 | 0 | 197 | 146 | 51 | 30 | 20 | 212 | 212 | 668 | 0 | 1 | 191 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof |  | 1,372 | 61 | 11,167,961 | 182.86 | 0 | 4,112 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof |  | 0 | 5 | 2 | 75 | 2,675 | 6 | 5 | 0 | 149 | 2 | 20 | 0 | 12,537,603,360 | 2,843,438,436 | 15,381,041,796 | 2,097,152 | 2 | 0 | 2 | 5 | 69 | 349 | 7,136,000 | 20.39 | 0 | 0 | 
| app_proof |  | 1 | 3 | 2 | 33 | 1,372 | 3 | 3 | 0 | 64 | 1 | 4 | 0 | 7,116,253,404 | 1,550,303,741 | 8,666,557,145 | 2,097,152 | 2 | 0 | 0 | 2 | 29 | 167 | 4,031,961 | 24.09 | 0 | 0 | 

...
| `total_proof_time_ms ` |  2,016.50 |  4,033 |  2,663 |  1,370 |
| `compile_metered_time_ms` |  0 |  0 |  0 |  0 |
| `execute_metered_time_ms` |  59 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  187.33 | -          |  187.33 |  187.33 |
| `set_initial_memory_time_ms` |  3.50 |  7 |  4 |  3 |
| `execute_preflight_insns` |  5,583,980.50 |  11,167,961 |  7,136,000 |  4,031,961 |
| `execute_preflight_time_ms` |  244.50 |  489 |  325 |  164 |
| `execute_preflight_insn_mi/s` |  22.84 | -          |  24.54 |  21.92 |
| `postflight_time_ms  ` |  115.50 |  231 |  167 |  64 |
| `postflight_memory_chronology_time_ms` |  12 |  24 |  20 |  4 |
| `postflight_program_index_time_ms` |  1.50 |  3 |  2 |  1 |
| `trace_gen_time_ms   ` |  53 |  106 |  74 |  32 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,570 |  3,140 |  2,054 |  1,086 |
| `prover.main_trace_commit_time_ms` |  389 |  778 |  564 |  214 |
| `prover.rap_constraints_time_ms` |  910 |  1,820 |  1,147 |  673 |
| `prover.openings_time_ms` |  270 |  540 |  342 |  198 |
| `prover.rap_constraints.logup_gkr_time_ms` |  217 |  434 |  240 |  194 |
| `prover.rap_constraints.round0_time_ms` |  511.50 |  1,023 |  673 |  350 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/cbd1fd2ca2451d6869a91a23bd2947888a99ee60/sha2_bench-cbd1fd2ca2451d6869a91a23bd2947888a99ee60.memory.svg)
...
| leaf | 0 | 109 | 512 | 108 | 31 | 12 | 2 | 9 | 9 | 
...
| leaf | 0 | prover | 237,929,272 | 402 | 145 | 0 | 0 | 142 | 71 | 70 | 44 | 25 | 0 | 114 | 92 | 21 | 10 | 11 | 145 | 145 | 142 | 0 | 3 | 25 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover |  | 0 | 1,281,523,083 | 2,054 | 564 | 0 | 0 | 1,147 | 673 | 672 | 233 | 240 | 1 | 342 | 248 | 93 | 57 | 36 | 564 | 564 | 1,147 | 0 | 1 | 239 | 0 | 0 | 
| app_proof | prover |  | 1 | 687,699,844 | 1,086 | 214 | 0 | 0 | 673 | 350 | 349 | 128 | 194 | 0 | 198 | 146 | 52 | 30 | 21 | 214 | 214 | 673 | 0 | 1 | 194 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof |  | 1,370 | 59 | 11,167,961 | 187.33 | 0 | 4,098 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof |  | 0 | 4 | 2 | 74 | 2,663 | 5 | 4 | 0 | 167 | 2 | 20 | 0 | 12,537,603,360 | 2,843,438,436 | 15,381,041,796 | 2,097,152 | 2 | 0 | 2 | 5 | 68 | 325 | 7,136,000 | 21.92 | 0 | 0 | 
| app_proof |  | 1 | 3 | 2 | 32 | 1,370 | 3 | 3 | 0 | 64 | 1 | 4 | 0 | 7,116,253,404 | 1,550,303,741 | 8,666,557,145 | 2,097,152 | 2 | 0 | 0 | 2 | 29 | 164 | 4,031,961 | 24.54 | 0 | 0 | 

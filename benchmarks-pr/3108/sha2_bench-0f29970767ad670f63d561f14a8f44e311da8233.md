...
|:---|---:|---:|---:|
| Total |  5.09 |  3.88 |  3.88 |
| app_proof |  4.14 |  2.93 |  2.93 |
| leaf |  0.52 |  0.52 |  0.52 |
...
| `total_proof_time_ms ` |  2,043.50 |  4,087 |  2,708 |  1,379 |
...
| `execute_preflight_time_ms` |  255.50 |  511 |  346 |  165 |
| `execute_preflight_insn_mi/s` |  21.86 | -          |  24.42 |  20.59 |
| `postflight_time_ms  ` |  119 |  238 |  171 |  67 |
...
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,571.50 |  3,143 |  2,058 |  1,085 |
| `prover.main_trace_commit_time_ms` |  389.50 |  779 |  565 |  214 |
| `prover.rap_constraints_time_ms` |  911.50 |  1,823 |  1,151 |  672 |
| `prover.openings_time_ms` |  270 |  540 |  342 |  198 |
| `prover.rap_constraints.logup_gkr_time_ms` |  217 |  434 |  241 |  193 |
| `prover.rap_constraints.round0_time_ms` |  513.50 |  1,027 |  676 |  351 |
...
| `prover.openings.whir_time_ms` |  197 |  394 |  248 |  146 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/0f29970767ad670f63d561f14a8f44e311da8233/sha2_bench-0f29970767ad670f63d561f14a8f44e311da8233.memory.svg)
...
| leaf | 0 | prover | 237,929,272 | 404 | 144 | 0 | 0 | 143 | 72 | 71 | 44 | 26 | 0 | 115 | 93 | 21 | 10 | 11 | 145 | 144 | 143 | 0 | 3 | 25 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover |  | 0 | 1,281,523,083 | 2,058 | 564 | 0 | 0 | 1,151 | 676 | 675 | 234 | 241 | 1 | 342 | 248 | 93 | 57 | 36 | 565 | 564 | 1,151 | 0 | 1 | 239 | 0 | 0 | 
| app_proof | prover |  | 1 | 687,699,844 | 1,085 | 214 | 0 | 0 | 672 | 351 | 351 | 127 | 193 | 0 | 198 | 146 | 52 | 30 | 21 | 214 | 214 | 672 | 0 | 1 | 192 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof |  | 1,379 | 56 | 11,167,961 | 196.46 | 0 | 4,152 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof |  | 0 | 4 | 2 | 75 | 2,708 | 6 | 4 | 0 | 171 | 2 | 20 | 0 | 12,537,603,360 | 2,843,438,436 | 15,381,041,796 | 2,097,152 | 2 | 0 | 2 | 5 | 69 | 346 | 7,136,000 | 20.59 | 0 | 0 | 
| app_proof |  | 1 | 3 | 2 | 32 | 1,379 | 3 | 3 | 0 | 67 | 1 | 4 | 0 | 7,116,253,404 | 1,550,303,741 | 8,666,557,145 | 2,097,152 | 2 | 0 | 0 | 2 | 29 | 165 | 4,031,961 | 24.42 | 0 | 0 | 

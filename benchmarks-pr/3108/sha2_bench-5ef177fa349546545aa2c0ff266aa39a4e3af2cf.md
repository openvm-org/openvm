...
|:---|---:|---:|---:|
| Total |  5.01 |  3.81 |  3.81 |
| app_proof |  4.07 |  2.87 |  2.87 |
| leaf |  0.51 |  0.51 |  0.51 |
...
| `total_proof_time_ms ` |  2,007 |  4,014 |  2,651 |  1,363 |
| `compile_metered_time_ms` |  0 |  0 |  0 |  0 |
| `execute_metered_time_ms` |  59 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  187.31 | -          |  187.31 |  187.31 |
| `set_initial_memory_time_ms` |  3.50 |  7 |  4 |  3 |
| `execute_preflight_insns` |  5,583,980.50 |  11,167,961 |  7,136,000 |  4,031,961 |
| `execute_preflight_time_ms` |  242 |  484 |  322 |  162 |
| `execute_preflight_insn_mi/s` |  23.07 | -          |  24.77 |  22.12 |
| `postflight_time_ms  ` |  122.50 |  245 |  176 |  69 |
...
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,554.50 |  3,109 |  2,036 |  1,073 |
| `prover.main_trace_commit_time_ms` |  385.50 |  771 |  559 |  212 |
| `prover.rap_constraints_time_ms` |  899.50 |  1,799 |  1,136 |  663 |
| `prover.openings_time_ms` |  268 |  536 |  340 |  196 |
| `prover.rap_constraints.logup_gkr_time_ms` |  214 |  428 |  238 |  190 |
| `prover.rap_constraints.round0_time_ms` |  507.50 |  1,015 |  667 |  348 |
| `prover.rap_constraints.mle_rounds_time_ms` |  177 |  354 |  230 |  124 |
...
| `prover.openings.whir_time_ms` |  196.50 |  393 |  248 |  145 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  512 |  512 |  512 |  512 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/5ef177fa349546545aa2c0ff266aa39a4e3af2cf/sha2_bench-5ef177fa349546545aa2c0ff266aa39a4e3af2cf.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 177 | 46 | 0 | 0 | 79 | 29 | 28 | 36 | 13 | 0 | 51 | 41 | 10 | 2 | 7 | 46 | 46 | 79 | 0 | 1 | 12 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 109 | 20 | 0 | 0 | 59 | 21 | 20 | 23 | 14 | 0 | 29 | 21 | 7 | 1 | 6 | 20 | 20 | 59 | 0 | 1 | 10 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 98 | 14 | 0 | 0 | 53 | 20 | 19 | 21 | 11 | 0 | 29 | 21 | 7 | 1 | 5 | 15 | 14 | 53 | 0 | 1 | 10 | 0 | 0 | 
| leaf | 0 | prover | 237,929,272 | 402 | 144 | 0 | 0 | 141 | 71 | 70 | 44 | 25 | 0 | 115 | 93 | 21 | 10 | 11 | 144 | 144 | 141 | 0 | 3 | 25 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover |  | 0 | 1,281,523,083 | 2,036 | 559 | 0 | 0 | 1,136 | 667 | 666 | 230 | 238 | 0 | 340 | 248 | 92 | 56 | 35 | 559 | 559 | 1,136 | 0 | 1 | 236 | 0 | 0 | 
| app_proof | prover |  | 1 | 687,699,844 | 1,073 | 212 | 0 | 0 | 663 | 348 | 347 | 124 | 190 | 0 | 196 | 145 | 50 | 29 | 20 | 212 | 212 | 663 | 0 | 1 | 189 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof |  | 1,363 | 59 | 11,167,961 | 187.31 | 0 | 4,078 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof |  | 0 | 4 | 2 | 75 | 2,651 | 6 | 4 | 0 | 176 | 2 | 20 | 0 | 12,537,603,360 | 2,843,438,436 | 15,381,041,796 | 2,097,152 | 2 | 0 | 2 | 5 | 68 | 322 | 7,136,000 | 22.12 | 0 | 0 | 
| app_proof |  | 1 | 3 | 2 | 32 | 1,363 | 3 | 3 | 0 | 69 | 1 | 4 | 0 | 7,116,253,404 | 1,550,303,741 | 8,666,557,145 | 2,097,152 | 2 | 0 | 0 | 2 | 29 | 162 | 4,031,961 | 24.77 | 0 | 0 | 

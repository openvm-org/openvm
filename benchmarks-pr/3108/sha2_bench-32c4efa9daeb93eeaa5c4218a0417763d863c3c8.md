...
|:---|---:|---:|---:|
| Total |  5.05 |  3.88 |  3.88 |
| app_proof |  4.11 |  2.94 |  2.94 |
| leaf |  0.51 |  0.51 |  0.51 |
...
| `total_proof_time_ms ` |  2,028.50 |  4,057 |  2,727 |  1,330 |
| `compile_metered_time_ms` |  5 |  5 |  5 |  5 |
| `execute_metered_time_ms` |  55 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  200.05 | -          |  200.05 |  200.05 |
| `set_initial_memory_time_ms` |  3.50 |  7 |  4 |  3 |
| `execute_preflight_insns` |  5,583,980.50 |  11,167,961 |  7,136,000 |  4,031,961 |
| `execute_preflight_time_ms` |  237.50 |  475 |  318 |  157 |
| `execute_preflight_insn_mi/s` |  23.51 | -          |  25.56 |  22.40 |
| `postflight_time_ms  ` |  81 |  162 |  114 |  48 |
| `postflight_memory_chronology_time_ms` |  12 |  24 |  20 |  4 |
| `postflight_program_index_time_ms` |  1.50 |  3 |  2 |  1 |
| `trace_gen_time_ms   ` |  40 |  80 |  56 |  24 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,631 |  3,262 |  2,186 |  1,076 |
| `prover.main_trace_commit_time_ms` |  389.50 |  779 |  563 |  216 |
| `prover.rap_constraints_time_ms` |  974.50 |  1,949 |  1,281 |  668 |
| `prover.openings_time_ms` |  266.50 |  533 |  342 |  191 |
| `prover.rap_constraints.logup_gkr_time_ms` |  272.50 |  545 |  351 |  194 |
| `prover.rap_constraints.round0_time_ms` |  523 |  1,046 |  696 |  350 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/32c4efa9daeb93eeaa5c4218a0417763d863c3c8/sha2_bench-32c4efa9daeb93eeaa5c4218a0417763d863c3c8.memory.svg)
...
| app_proof | Sha2BlockHasherVmAir<Sha256Config> |  | 0 | 23 | 
...
| leaf | 0 | 106 | 513 | 106 | 31 | 12 | 2 | 9 | 9 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 177 | 46 | 0 | 0 | 79 | 28 | 27 | 36 | 14 | 0 | 50 | 40 | 10 | 2 | 7 | 46 | 46 | 79 | 0 | 1 | 12 | 0 | 0 | 
...
| leaf | 0 | prover | 237,929,272 | 407 | 144 | 0 | 0 | 142 | 71 | 70 | 44 | 26 | 0 | 120 | 98 | 21 | 10 | 11 | 145 | 144 | 142 | 0 | 3 | 25 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover |  | 0 | 1,289,518,990 | 2,186 | 563 | 0 | 0 | 1,281 | 696 | 696 | 232 | 351 | 0 | 342 | 247 | 94 | 58 | 36 | 563 | 563 | 1,281 | 0 | 1 | 350 | 0 | 0 | 
| app_proof | prover |  | 1 | 692,746,700 | 1,076 | 216 | 0 | 0 | 668 | 350 | 349 | 124 | 194 | 0 | 191 | 139 | 52 | 30 | 21 | 216 | 216 | 668 | 0 | 1 | 193 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof |  | 1,330 | 55 | 11,167,961 | 200.05 | 0 | 4,122 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof |  | 0 | 4 | 2 | 56 | 2,727 | 3 | 4 | 0 | 114 | 2 | 20 | 0 | 12,605,497,128 | 2,871,495,552 | 15,476,992,680 | 2,097,152 | 2 | 0 | 0 | 3 | 52 | 318 | 7,136,000 | 22.40 | 0 | 0 | 
| app_proof |  | 1 | 3 | 2 | 24 | 1,330 | 2 | 3 | 0 | 48 | 1 | 4 | 0 | 7,154,612,856 | 1,641,450,113 | 8,796,062,969 | 2,097,152 | 2 | 0 | 0 | 2 | 21 | 157 | 4,031,961 | 25.56 | 0 | 0 | 

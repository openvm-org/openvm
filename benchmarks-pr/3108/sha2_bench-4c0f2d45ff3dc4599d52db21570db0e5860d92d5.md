...
|:---|---:|---:|---:|
| Total |  5.08 |  3.87 |  3.87 |
| app_proof |  4.14 |  2.92 |  2.92 |
| leaf |  0.52 |  0.52 |  0.52 |
...
| `total_proof_time_ms ` |  2,039 |  4,078 |  2,701 |  1,377 |
| `compile_metered_time_ms` |  0 |  0 |  0 |  0 |
| `execute_metered_time_ms` |  60 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  185.04 | -          |  185.04 |  185.04 |
...
| `execute_preflight_insn_mi/s` |  22.47 | -          |  24.78 |  21.30 |
| `postflight_time_ms  ` |  128 |  256 |  188 |  68 |
| `postflight_memory_chronology_time_ms` |  12 |  24 |  20 |  4 |
| `postflight_program_index_time_ms` |  1.50 |  3 |  2 |  1 |
| `trace_gen_time_ms   ` |  53 |  106 |  74 |  32 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,572 |  3,144 |  2,056 |  1,088 |
| `prover.main_trace_commit_time_ms` |  388.50 |  777 |  562 |  215 |
| `prover.rap_constraints_time_ms` |  911.50 |  1,823 |  1,149 |  674 |
| `prover.openings_time_ms` |  271 |  542 |  344 |  198 |
| `prover.rap_constraints.logup_gkr_time_ms` |  218.50 |  437 |  242 |  195 |
| `prover.rap_constraints.round0_time_ms` |  513 |  1,026 |  675 |  351 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/4c0f2d45ff3dc4599d52db21570db0e5860d92d5/sha2_bench-4c0f2d45ff3dc4599d52db21570db0e5860d92d5.memory.svg)
...
| leaf | 0 | 109 | 515 | 109 | 30 | 12 | 2 | 9 | 9 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 174 | 46 | 0 | 0 | 78 | 27 | 26 | 37 | 13 | 0 | 49 | 38 | 10 | 2 | 7 | 46 | 46 | 78 | 0 | 1 | 12 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 111 | 20 | 0 | 0 | 56 | 22 | 21 | 23 | 11 | 0 | 33 | 25 | 7 | 1 | 6 | 20 | 20 | 56 | 0 | 1 | 10 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 103 | 15 | 0 | 0 | 53 | 20 | 19 | 21 | 10 | 0 | 35 | 27 | 7 | 1 | 5 | 15 | 15 | 53 | 0 | 1 | 10 | 0 | 0 | 
| leaf | 0 | prover | 237,929,272 | 406 | 145 | 0 | 0 | 142 | 72 | 70 | 44 | 26 | 0 | 117 | 96 | 21 | 10 | 11 | 145 | 145 | 142 | 0 | 3 | 25 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover |  | 0 | 1,281,523,083 | 2,056 | 562 | 0 | 0 | 1,149 | 675 | 674 | 232 | 242 | 1 | 344 | 250 | 93 | 57 | 36 | 562 | 562 | 1,149 | 0 | 1 | 240 | 0 | 0 | 
| app_proof | prover |  | 1 | 687,699,844 | 1,088 | 214 | 0 | 0 | 674 | 351 | 351 | 127 | 195 | 0 | 198 | 146 | 51 | 30 | 21 | 215 | 214 | 674 | 0 | 1 | 194 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof |  | 1,377 | 60 | 11,167,961 | 185.04 | 0 | 4,144 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof |  | 0 | 5 | 2 | 74 | 2,701 | 5 | 5 | 0 | 188 | 2 | 20 | 0 | 12,537,603,360 | 2,843,438,436 | 15,381,041,796 | 2,097,152 | 2 | 0 | 2 | 5 | 68 | 335 | 7,136,000 | 21.30 | 0 | 0 | 
| app_proof |  | 1 | 3 | 2 | 32 | 1,377 | 3 | 3 | 0 | 68 | 1 | 4 | 0 | 7,116,253,404 | 1,550,303,741 | 8,666,557,145 | 2,097,152 | 2 | 0 | 0 | 2 | 29 | 162 | 4,031,961 | 24.78 | 0 | 0 | 

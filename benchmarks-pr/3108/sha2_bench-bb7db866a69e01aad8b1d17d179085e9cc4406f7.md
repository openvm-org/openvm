...
| `total_proof_time_ms ` |  2,017.50 |  4,035 |  2,665 |  1,370 |
| `compile_metered_time_ms` |  0 |  0 |  0 |  0 |
| `execute_metered_time_ms` |  61 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  182.01 | -          |  182.01 |  182.01 |
| `set_initial_memory_time_ms` |  3.50 |  7 |  4 |  3 |
| `execute_preflight_insns` |  5,583,980.50 |  11,167,961 |  7,136,000 |  4,031,961 |
| `execute_preflight_time_ms` |  244 |  488 |  326 |  162 |
| `execute_preflight_insn_mi/s` |  22.89 | -          |  24.83 |  21.82 |
| `postflight_time_ms  ` |  114.50 |  229 |  167 |  62 |
| `postflight_memory_chronology_time_ms` |  12 |  24 |  20 |  4 |
| `postflight_program_index_time_ms` |  1.50 |  3 |  2 |  1 |
| `trace_gen_time_ms   ` |  53 |  106 |  74 |  32 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,568.50 |  3,137 |  2,050 |  1,087 |
| `prover.main_trace_commit_time_ms` |  385.50 |  771 |  557 |  214 |
| `prover.rap_constraints_time_ms` |  912.50 |  1,825 |  1,151 |  674 |
| `prover.openings_time_ms` |  269.50 |  539 |  341 |  198 |
| `prover.rap_constraints.logup_gkr_time_ms` |  218 |  436 |  241 |  195 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/bb7db866a69e01aad8b1d17d179085e9cc4406f7/sha2_bench-bb7db866a69e01aad8b1d17d179085e9cc4406f7.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 171 | 46 | 0 | 0 | 79 | 28 | 27 | 36 | 13 | 0 | 45 | 35 | 10 | 2 | 7 | 46 | 46 | 79 | 0 | 1 | 12 | 0 | 0 | 
...
| leaf | 0 | prover | 237,929,272 | 407 | 145 | 0 | 0 | 142 | 72 | 70 | 44 | 26 | 0 | 119 | 97 | 21 | 10 | 11 | 145 | 145 | 142 | 0 | 3 | 25 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover |  | 0 | 1,281,523,083 | 2,050 | 557 | 0 | 0 | 1,151 | 676 | 675 | 233 | 241 | 0 | 341 | 248 | 93 | 57 | 35 | 557 | 557 | 1,151 | 0 | 1 | 239 | 0 | 0 | 
| app_proof | prover |  | 1 | 687,699,844 | 1,087 | 214 | 0 | 0 | 674 | 350 | 350 | 127 | 195 | 0 | 198 | 146 | 52 | 31 | 21 | 214 | 214 | 674 | 0 | 1 | 194 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof |  | 1,370 | 61 | 11,167,961 | 182.01 | 0 | 4,101 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof |  | 0 | 4 | 2 | 74 | 2,665 | 5 | 4 | 0 | 167 | 2 | 20 | 0 | 12,537,603,360 | 2,843,438,436 | 15,381,041,796 | 2,097,152 | 2 | 0 | 2 | 5 | 68 | 326 | 7,136,000 | 21.82 | 0 | 0 | 
| app_proof |  | 1 | 3 | 2 | 32 | 1,370 | 2 | 3 | 0 | 62 | 1 | 4 | 0 | 7,116,253,404 | 1,550,303,741 | 8,666,557,145 | 2,097,152 | 2 | 0 | 0 | 2 | 29 | 162 | 4,031,961 | 24.83 | 0 | 0 | 

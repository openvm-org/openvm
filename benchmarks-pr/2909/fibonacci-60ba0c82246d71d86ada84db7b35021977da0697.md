...
| `total_proof_time_ms ` |  753.25 |  3,013 |  906 |  541 |
| `execute_metered_time_ms` |  67 | -          | -          | -          |
| `execute_metered_insns` |  12,000,265 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  178.57 | -          |  178.57 |  178.57 |
| `execute_preflight_insns` |  3,000,066.25 |  12,000,265 |  3,495,000 |  1,515,265 |
| `execute_preflight_time_ms` |  82.25 |  329 |  101 |  42 |
| `execute_preflight_insn_mi/s` |  49.29 | -          |  50.43 |  46.38 |
| `trace_gen_time_ms   ` |  137.25 |  549 |  170 |  120 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  463 |  1,852 |  527 |  286 |
| `prover.main_trace_commit_time_ms` |  96.75 |  387 |  110 |  58 |
| `prover.rap_constraints_time_ms` |  266.25 |  1,065 |  303 |  163 |
| `prover.openings_time_ms` |  99.25 |  397 |  113 |  64 |
| `prover.rap_constraints.logup_gkr_time_ms` |  191.75 |  767 |  218 |  114 |
| `prover.rap_constraints.round0_time_ms` |  49.50 |  198 |  57 |  32 |
| `prover.rap_constraints.mle_rounds_time_ms` |  23.50 |  94 |  26 |  16 |
...
| `prover.openings.whir_time_ms` |  80.50 |  322 |  92 |  52 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/60ba0c82246d71d86ada84db7b35021977da0697/fibonacci-60ba0c82246d71d86ada84db7b35021977da0697.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 78 | 9 |  |  | 0 |  | 360 | 9 |  |  |  |  |  |  | 
| app_proof |  |  |  |  |  | 541 |  |  | 67 | 12,000,265 | 178.57 | 0 | 3,087 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 322 | 115 | 0 | 0 | 105 | 34 | 33 | 50 | 20 | 0 | 101 | 87 | 13 | 3 | 9 | 116 | 105 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 172 | 45 | 0 | 0 | 67 | 24 | 23 | 27 | 15 | 0 | 58 | 50 | 8 | 1 | 6 | 46 | 67 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 134 | 31 | 0 | 0 | 60 | 22 | 22 | 24 | 13 | 0 | 42 | 34 | 7 | 1 | 5 | 32 | 60 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 147,934,254 | 599 | 229 | 0 | 0 | 180 | 82 | 81 | 53 | 44 | 0 | 189 | 164 | 24 | 12 | 11 | 230 | 180 | 0 | 7 | 43 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 136,618,054 | 527 | 110 | 0 | 0 | 303 | 57 | 57 | 26 | 218 | 0 | 113 | 92 | 21 | 11 | 9 | 110 | 303 | 0 | 3 | 217 | 0 | 0 | 
| app_proof | prover | 1 | 136,570,716 | 519 | 109 | 0 | 0 | 299 | 54 | 54 | 26 | 217 | 0 | 111 | 90 | 20 | 11 | 8 | 109 | 299 | 0 | 3 | 217 | 0 | 0 | 
| app_proof | prover | 2 | 136,570,716 | 520 | 110 | 0 | 0 | 300 | 55 | 54 | 26 | 218 | 0 | 109 | 88 | 21 | 12 | 9 | 110 | 300 | 0 | 3 | 218 | 0 | 0 | 
| app_proof | prover | 3 | 70,295,004 | 286 | 58 | 0 | 0 | 163 | 32 | 31 | 16 | 114 | 0 | 64 | 52 | 11 | 6 | 5 | 58 | 163 | 0 | 3 | 113 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 134 | 906 | 134 | 155 | 2,770,197,065 | 323,292,691 | 3,093,489,756 | 2,097,152 | 0 | 3 | 89 | 3,495,000 | 46.38 | 
| app_proof | 1 | 120 | 782 | 120 | 41 | 2,768,862,357 | 322,353,414 | 3,091,215,771 | 2,097,152 | 0 | 1 | 101 | 3,495,000 | 50.43 | 
| app_proof | 2 | 125 | 784 | 125 | 41 | 2,768,862,357 | 322,353,414 | 3,091,215,771 | 2,097,152 | 0 | 1 | 97 | 3,495,000 | 50.02 | 
| app_proof | 3 | 170 | 541 | 170 | 41 | 1,230,956,171 | 342,871,578 | 1,573,827,749 | 2,097,152 | 0 | 1 | 42 | 1,515,265 | 50.35 | 

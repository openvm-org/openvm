...
| `total_proof_time_ms ` |  750.25 |  3,001 |  907 |  539 |
| `execute_metered_time_ms` |  67 | -          | -          | -          |
| `execute_metered_insns` |  12,000,265 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  178.81 | -          |  178.81 |  178.81 |
| `execute_preflight_insns` |  3,000,066.25 |  12,000,265 |  3,495,000 |  1,515,265 |
| `execute_preflight_time_ms` |  83.50 |  334 |  103 |  43 |
| `execute_preflight_insn_mi/s` |  49.24 | -          |  50.66 |  45.08 |
| `trace_gen_time_ms   ` |  133.75 |  535 |  168 |  115 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  462 |  1,848 |  528 |  287 |
| `prover.main_trace_commit_time_ms` |  96.25 |  385 |  109 |  58 |
| `prover.rap_constraints_time_ms` |  265.50 |  1,062 |  304 |  163 |
| `prover.openings_time_ms` |  99.25 |  397 |  114 |  65 |
| `prover.rap_constraints.logup_gkr_time_ms` |  191.50 |  766 |  219 |  114 |
| `prover.rap_constraints.round0_time_ms` |  49.25 |  197 |  58 |  31 |
...
| `prover.openings.whir_time_ms` |  80.50 |  322 |  93 |  53 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/d273a0629899a36832229b4b968a0998fb531590/fibonacci-d273a0629899a36832229b4b968a0998fb531590.memory.svg)
...
| app_proof |  |  |  |  |  | 539 |  |  | 67 | 12,000,265 | 178.81 | 0 | 3,075 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 322 | 115 | 0 | 0 | 106 | 34 | 34 | 50 | 20 | 0 | 100 | 86 | 13 | 3 | 9 | 115 | 106 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 169 | 46 | 0 | 0 | 68 | 24 | 24 | 28 | 15 | 0 | 54 | 46 | 8 | 1 | 6 | 47 | 68 | 0 | 2 | 12 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 136 | 32 | 0 | 0 | 61 | 22 | 22 | 24 | 14 | 0 | 41 | 34 | 7 | 1 | 5 | 32 | 61 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 147,934,254 | 595 | 227 | 0 | 0 | 178 | 81 | 80 | 52 | 44 | 0 | 188 | 164 | 24 | 12 | 11 | 228 | 178 | 0 | 7 | 43 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 136,618,054 | 528 | 109 | 0 | 0 | 304 | 58 | 58 | 26 | 219 | 0 | 114 | 93 | 21 | 11 | 9 | 109 | 304 | 0 | 3 | 217 | 0 | 0 | 
| app_proof | prover | 1 | 136,570,716 | 517 | 109 | 0 | 0 | 297 | 54 | 54 | 26 | 216 | 0 | 110 | 89 | 21 | 11 | 9 | 109 | 297 | 0 | 3 | 215 | 0 | 0 | 
| app_proof | prover | 2 | 136,570,716 | 516 | 109 | 0 | 0 | 298 | 54 | 54 | 26 | 217 | 0 | 108 | 87 | 21 | 11 | 9 | 109 | 298 | 0 | 3 | 216 | 0 | 0 | 
| app_proof | prover | 3 | 70,295,004 | 287 | 58 | 0 | 0 | 163 | 31 | 31 | 17 | 114 | 0 | 65 | 53 | 12 | 6 | 6 | 58 | 163 | 0 | 3 | 113 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 129 | 907 | 129 | 157 | 2,770,197,065 | 323,292,691 | 3,093,489,756 | 2,097,152 | 0 | 3 | 91 | 3,495,000 | 45.08 | 
| app_proof | 1 | 115 | 777 | 115 | 41 | 2,768,862,357 | 322,353,414 | 3,091,215,771 | 2,097,152 | 0 | 1 | 103 | 3,495,000 | 50.64 | 
| app_proof | 2 | 123 | 778 | 123 | 40 | 2,768,862,357 | 322,353,414 | 3,091,215,771 | 2,097,152 | 0 | 1 | 97 | 3,495,000 | 50.59 | 
| app_proof | 3 | 168 | 539 | 168 | 41 | 1,230,956,171 | 342,871,578 | 1,573,827,749 | 2,097,152 | 0 | 1 | 43 | 1,515,265 | 50.66 | 

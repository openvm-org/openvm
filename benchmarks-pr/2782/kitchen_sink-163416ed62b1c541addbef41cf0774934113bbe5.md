...
| `total_proof_time_ms ` |  943.50 |  1,887 |  1,212 |  675 |
| `execute_metered_time_ms` |  34 | -          | -          | -          |
| `execute_metered_insns` |  2,579,903 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  74.28 | -          |  74.28 |  74.28 |
| `execute_preflight_insns` |  1,289,951.50 |  2,579,903 |  1,540,000 |  1,039,903 |
| `execute_preflight_time_ms` |  98 |  196 |  133 |  63 |
| `execute_preflight_insn_mi/s` |  35.62 | -          |  36.71 |  34.53 |
| `trace_gen_time_ms   ` |  26 |  52 |  36 |  16 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  709 |  1,418 |  934 |  484 |
| `prover.main_trace_commit_time_ms` |  214 |  428 |  290 |  138 |
| `prover.rap_constraints_time_ms` |  449 |  898 |  592 |  306 |
| `prover.openings_time_ms` |  45 |  90 |  51 |  39 |
| `prover.rap_constraints.logup_gkr_time_ms` |  82.50 |  165 |  110 |  55 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/163416ed62b1c541addbef41cf0774934113bbe5/kitchen_sink-163416ed62b1c541addbef41cf0774934113bbe5.memory.svg)
...
| app_proof |  |  |  |  |  | 675 |  |  | 34 | 2,579,903 | 74.28 | 0 | 1,927 |  | 
...
| leaf | 0 | 114 | 411 | 113 | 25 | 11 | 21 | 4 | 4 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,577,915 | 120 | 38 | 0 | 0 | 64 | 22 | 21 | 29 | 12 | 0 | 17 | 9 | 7 | 1 | 6 | 38 | 64 | 0 | 1 | 11 | 0 | 0 | 
...
| leaf | 0 | prover | 265,006,708 | 297 | 128 | 0 | 1 | 140 | 49 | 48 | 37 | 54 | 0 | 27 | 11 | 15 | 7 | 8 | 129 | 140 | 0 | 2 | 53 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 567,917,156 | 934 | 289 | 0 | 160 | 592 | 352 | 351 | 128 | 110 | 54 | 51 | 12 | 38 | 15 | 22 | 290 | 592 | 0 | 1 | 55 | 0 | 0 | 
| app_proof | prover | 1 | 537,266,124 | 484 | 137 | 0 | 2 | 306 | 174 | 174 | 75 | 55 | 0 | 39 | 12 | 27 | 14 | 13 | 138 | 306 | 0 | 1 | 54 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 36 | 1,212 | 36 | 178 | 0 | 3 | 63 | 1,540,000 | 34.53 | 
| app_proof | 1 | 16 | 675 | 16 | 40 | 0 | 1 | 133 | 1,039,903 | 36.71 | 

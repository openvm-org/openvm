...
| `total_proof_time_ms ` |  587 |  2,348 |  719 |  539 |
...
| `execute_preflight_insn_mi/s` |  30.83 | -          |  32.07 |  27.88 |
| `trace_gen_time_ms   ` |  178.50 |  714 |  210 |  157 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  287.50 |  1,150 |  318 |  269 |
| `main_trace_commit_time_ms` |  51.75 |  207 |  57 |  49 |
| `generate_perm_trace_time_ms` |  34.75 |  139 |  54 |  20 |
| `perm_trace_commit_time_ms` |  64.68 |  258.71 |  70.66 |  55.62 |
| `quotient_poly_compute_time_ms` |  58.77 |  235.08 |  69.94 |  52.55 |
| `quotient_poly_commit_time_ms` |  15.33 |  61.31 |  17.45 |  12.51 |
| `pcs_opening_time_ms ` |  59 |  236 |  63 |  56 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 539 | 1 | 36 | 4,137,502 | 113.08 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 210 | 719 | 23,446,148 | 150,778,428 | 210 | 318 | 0 | 59.47 | 17.45 | 5 | 70.66 | 56 | 126 | 56 | 4 | 57 | 10,899,170 | 54 | 46 | 1,103,000 | 27.88 | 22 | 77 | 1 | 56 | 
| regex_program | 1 | 157 | 551 | 11,598,276 | 128,513,066 | 157 | 287 | 1 | 52.55 | 15.78 | 4 | 65.95 | 63 | 104 | 62 | 0 | 51 | 2,196,106 | 37 | 65 | 1,104,000 | 31.81 | 17 | 68 | 0 | 62 | 
| regex_program | 2 | 163 | 539 | 11,579,064 | 128,513,066 | 163 | 276 | 1 | 53.12 | 15.57 | 4 | 66.49 | 61 | 95 | 61 | 0 | 49 | 2,177,334 | 28 | 58 | 1,104,000 | 31.54 | 16 | 69 | 0 | 61 | 
| regex_program | 3 | 184 | 539 | 11,853,872 | 103,456,394 | 184 | 269 | 0 | 69.94 | 12.51 | 5 | 55.62 | 56 | 78 | 56 | 0 | 50 | 2,422,606 | 20 | 45 | 826,502 | 32.07 | 18 | 83 | 1 | 56 | 
...
Commit: https://github.com/openvm-org/openvm/commit/25a73300f83724ff95354f4223bfa200eceeeb92
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19379914491)

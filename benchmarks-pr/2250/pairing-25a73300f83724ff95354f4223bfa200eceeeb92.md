...
| `total_proof_time_ms ` |  733 |  1,466 |  853 |  613 |
...
| `execute_preflight_time_ms` |  102.50 |  205 |  137 |  68 |
| `execute_preflight_insn_mi/s` |  13.41 | -          |  18.10 |  8.71 |
| `trace_gen_time_ms   ` |  168.50 |  337 |  185 |  152 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  368 |  736 |  418 |  318 |
| `main_trace_commit_time_ms` |  65 |  130 |  75 |  55 |
| `generate_perm_trace_time_ms` |  35.50 |  71 |  39 |  32 |
| `perm_trace_commit_time_ms` |  77.19 |  154.38 |  89.19 |  65.19 |
| `quotient_poly_compute_time_ms` |  78.72 |  157.44 |  87.60 |  69.84 |
| `quotient_poly_commit_time_ms` |  16.09 |  32.18 |  18.26 |  13.92 |
| `pcs_opening_time_ms ` |  90.50 |  181 |  104 |  77 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 613 | 1 | 97 | 1,745,742 | 17.81 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 152 | 853 | 32,689,110 | 172,558,444 | 152 | 418 | 0 | 87.60 | 18.26 | 6 | 89.19 | 104 | 132 | 103 | 1 | 75 | 16,059,916 | 39 | 137 | 1,157,000 | 8.71 | 26 | 106 | 1 | 103 | 
| pairing | 1 | 185 | 613 | 22,314,288 | 119,958,502 | 185 | 318 | 1 | 69.84 | 13.92 | 6 | 65.19 | 77 | 101 | 77 | 0 | 55 | 9,408,294 | 32 | 68 | 588,742 | 18.10 | 20 | 84 | 1 | 77 | 

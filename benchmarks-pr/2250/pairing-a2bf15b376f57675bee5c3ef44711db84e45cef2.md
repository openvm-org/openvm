...
| `total_proof_time_ms ` |  730 |  1,460 |  847 |  613 |
...
| `execute_metered_insn_mi/s` |  17.83 | -          |  17.83 |  17.83 |
| `execute_preflight_insns` |  872,871 |  1,745,742 |  1,157,000 |  588,742 |
| `execute_preflight_time_ms` |  97 |  194 |  134 |  60 |
| `execute_preflight_insn_mi/s` |  13.52 | -          |  18.18 |  8.86 |
| `trace_gen_time_ms   ` |  175 |  350 |  194 |  156 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  365 |  730 |  412 |  318 |
| `main_trace_commit_time_ms` |  64 |  128 |  74 |  54 |
| `generate_perm_trace_time_ms` |  35.50 |  71 |  39 |  32 |
| `perm_trace_commit_time_ms` |  76.63 |  153.25 |  88.38 |  64.87 |
| `quotient_poly_compute_time_ms` |  79.05 |  158.09 |  87.25 |  70.84 |
| `quotient_poly_commit_time_ms` |  15.86 |  31.71 |  17.15 |  14.56 |
| `pcs_opening_time_ms ` |  89 |  178 |  102 |  76 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 613 | 1 | 97 | 1,745,742 | 17.83 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 156 | 847 | 32,689,110 | 172,558,444 | 156 | 412 | 0 | 87.25 | 17.15 | 6 | 88.38 | 102 | 130 | 102 | 1 | 74 | 16,059,916 | 39 | 134 | 1,157,000 | 8.86 | 26 | 105 | 1 | 102 | 
| pairing | 1 | 194 | 613 | 22,314,288 | 119,958,502 | 194 | 318 | 1 | 70.84 | 14.56 | 5 | 64.87 | 76 | 100 | 76 | 0 | 54 | 9,408,294 | 32 | 60 | 588,742 | 18.18 | 20 | 86 | 1 | 76 | 
...
Commit: https://github.com/openvm-org/openvm/commit/a2bf15b376f57675bee5c3ef44711db84e45cef2
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19380321945)

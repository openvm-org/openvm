...
|:---|---:|---:|
| Total |  7.63 |  4.93 |
| regex_program |  7.60 |  4.90 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  3,799.50 |  7,599 |  4,902 |  2,697 |
...
| `execute_preflight_insn_mi/s` |  28.67 | -          |  31.21 |  26.13 |
| `trace_gen_time_ms   ` |  390 |  780 |  504 |  276 |
| `memory_finalize_time_ms` |  7.50 |  15 |  13 |  2 |
| `stark_prove_excluding_trace_time_ms` |  3,082.50 |  6,165 |  4,054 |  2,111 |
| `main_trace_commit_time_ms` |  620 |  1,240 |  844 |  396 |
| `generate_perm_trace_time_ms` |  225 |  450 |  306 |  144 |
| `perm_trace_commit_time_ms` |  649.50 |  1,299 |  849 |  450 |
| `quotient_poly_compute_time_ms` |  320.50 |  641 |  440 |  201 |
| `quotient_poly_commit_time_ms` |  298 |  596 |  401 |  195 |
| `pcs_opening_time_ms ` |  959.50 |  1,919 |  1,204 |  715 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 1 | 2,697 | 7 | 1 | 32 | 4,108,597 | 127.17 | 45 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 504 | 4,902 | 211,758,557 | 373,183,036 | 504 | 4,054 | 0 | 440 | 401 | 849 | 1,204 | 7 | 13 | 844 | 91,281,687 | 306 | 100 | 2,211,000 | 26.13 | 
| regex_program | 1 | 276 | 2,697 | 174,326,267 | 196,838,026 | 276 | 2,111 | 52 | 201 | 195 | 450 | 715 | 6 | 2 | 396 | 73,453,305 | 144 | 86 | 1,897,597 | 31.21 | 

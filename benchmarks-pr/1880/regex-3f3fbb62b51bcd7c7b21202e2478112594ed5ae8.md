...
| `execute_metered_insn_mi/s` |  67.40 | -          |  67.40 |  67.40 |
| `execute_e3_time_ms  ` |  123.50 |  247 |  139 |  108 |
| `execute_e3_insn_mi/s` |  16.87 | -          |  17.71 |  16.02 |
| `memory_finalize_time_ms` |  6.50 |  13 |  11 |  2 |
| `boundary_finalize_time_ms` |  2 |  4 |  4 |  0 |
| `merkle_finalize_time_ms` |  154 |  308 |  241 |  67 |
| `stark_prove_excluding_trace_time_ms` |  2,629.50 |  5,259 |  2,884 |  2,375 |
| `main_trace_commit_time_ms` |  521 |  1,042 |  575 |  467 |
| `generate_perm_trace_time_ms` |  204.50 |  409 |  232 |  177 |
| `perm_trace_commit_time_ms` |  558 |  1,116 |  599 |  517 |
| `quotient_poly_compute_time_ms` |  267 |  534 |  287 |  247 |
| `quotient_poly_commit_time_ms` |  239.50 |  479 |  275 |  204 |
| `pcs_opening_time_ms ` |  830 |  1,660 |  906 |  754 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 3,983 | 23 | 4,165,433 | 1 | 61 | 67.40 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 516 | 275,648,700 | 2,884 | 287 | 275 | 599 | 906 | 241 | 24 | 11 | 575 | 2,243,700 | 232 | 139 | 16.02 | 4 | 
| regex_program | 1 | 291 | 242,975,370 | 2,375 | 247 | 204 | 517 | 754 | 67 | 24 | 2 | 467 | 1,921,733 | 177 | 108 | 17.71 | 0 | 

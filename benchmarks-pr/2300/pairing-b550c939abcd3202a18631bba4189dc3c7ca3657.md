...
|:---|---:|---:|
| Total | <span style='color: red'>(+0 [+1.0%])</span> 1.53 | <span style='color: red'>(+0 [+3.7%])</span> 0.95 |
| pairing | <span style='color: red'>(+0 [+1.1%])</span> 1.46 | <span style='color: red'>(+0 [+4.1%])</span> 0.88 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+8 [+1.1%])</span> 730 | <span style='color: red'>(+16 [+1.1%])</span> 1,460 | <span style='color: red'>(+35 [+4.1%])</span> 879 | <span style='color: green'>(-19 [-3.2%])</span> 581 |
...
| `execute_metered_insn_mi/s` | <span style='color: red'>(+0 [+0.3%])</span> 25.30 | -          | <span style='color: red'>(+0 [+0.3%])</span> 25.30 | <span style='color: red'>(+0 [+0.3%])</span> 25.30 |
...
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+0 [+0.6%])</span> 14.74 | -          | <span style='color: red'>(+0 [+1.1%])</span> 18.61 | <span style='color: green'>(-0 [-0.1%])</span> 10.88 |
| `trace_gen_time_ms   ` | <span style='color: green'>(-0 [-0.3%])</span> 185.50 | <span style='color: green'>(-1 [-0.3%])</span> 371 | <span style='color: green'>(-2 [-1.0%])</span> 190 | <span style='color: red'>(+1 [+0.6%])</span> 181 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+8 [+2.3%])</span> 354.50 | <span style='color: red'>(+16 [+2.3%])</span> 709 | <span style='color: red'>(+33 [+8.5%])</span> 419 | <span style='color: green'>(-17 [-5.5%])</span> 290 |
| `main_trace_commit_time_ms` |  64 |  128 | <span style='color: green'>(-1 [-1.3%])</span> 74 | <span style='color: red'>(+1 [+1.9%])</span> 54 |
| `generate_perm_trace_time_ms` | <span style='color: red'>(+13 [+40.0%])</span> 45.50 | <span style='color: red'>(+26 [+40.0%])</span> 91 | <span style='color: red'>(+24 [+66.7%])</span> 60 | <span style='color: red'>(+2 [+6.9%])</span> 31 |
| `perm_trace_commit_time_ms` | <span style='color: green'>(-3 [-3.8%])</span> 74.14 | <span style='color: green'>(-6 [-3.8%])</span> 148.28 | <span style='color: green'>(-5 [-5.8%])</span> 84.13 | <span style='color: green'>(-1 [-0.9%])</span> 64.15 |
| `quotient_poly_compute_time_ms` | <span style='color: green'>(-6 [-7.5%])</span> 76.56 | <span style='color: green'>(-12 [-7.5%])</span> 153.13 | <span style='color: green'>(-7 [-7.8%])</span> 84.69 | <span style='color: green'>(-5 [-7.2%])</span> 68.44 |
| `quotient_poly_commit_time_ms` | <span style='color: green'>(-2 [-11.8%])</span> 15.56 | <span style='color: green'>(-4 [-11.8%])</span> 31.12 | <span style='color: green'>(-2 [-11.5%])</span> 17.54 | <span style='color: green'>(-2 [-12.2%])</span> 13.58 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+6 [+9.6%])</span> 74 | <span style='color: red'>(+13 [+9.6%])</span> 148 | <span style='color: red'>(+26 [+37.7%])</span> 95 | <span style='color: green'>(-13 [-19.7%])</span> 53 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 581 | 1 | 68 | 1,745,742 | 25.30 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 181 | 879 | 32,480,114 | 172,558,444 | 181 | 419 | 0 | 84.69 | 17.54 | 6 | 84.13 | 95 | 146 | 95 | 1 | 74 | 15,909,408 | 60 | 109 | 1,149,000 | 10.88 | 26 | 103 | 1 | 95 | 
| pairing | 1 | 190 | 581 | 22,464,232 | 119,958,502 | 190 | 290 | 1 | 68.44 | 13.58 | 6 | 64.15 | 53 | 98 | 53 | 0 | 54 | 9,498,894 | 31 | 59 | 596,742 | 18.61 | 20 | 82 | 1 | 53 | 

...
|:---|---:|---:|
| Total |  2.37 | <span style='color: red'>(+0 [+2.3%])</span> 0.77 |
| regex_program | <span style='color: green'>(-0 [-0.2%])</span> 2.33 | <span style='color: red'>(+0 [+2.1%])</span> 0.73 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: green'>(-1 [-0.2%])</span> 583.25 | <span style='color: green'>(-4 [-0.2%])</span> 2,333 | <span style='color: red'>(+15 [+2.1%])</span> 730 | <span style='color: green'>(-21 [-3.9%])</span> 519 |
...
| `execute_metered_insn_mi/s` | <span style='color: green'>(-5 [-4.3%])</span> 108.23 | -          | <span style='color: green'>(-5 [-4.3%])</span> 108.23 | <span style='color: green'>(-5 [-4.3%])</span> 108.23 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` | <span style='color: red'>(+1 [+2.4%])</span> 53.50 | <span style='color: red'>(+5 [+2.4%])</span> 214 | <span style='color: red'>(+3 [+4.8%])</span> 66 | <span style='color: red'>(+1 [+2.3%])</span> 45 |
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+0 [+0.1%])</span> 32.21 | -          | <span style='color: red'>(+0 [+0.6%])</span> 33.49 |  29.10 |
| `trace_gen_time_ms   ` | <span style='color: green'>(-1 [-0.7%])</span> 178 | <span style='color: green'>(-5 [-0.7%])</span> 712 |  210 | <span style='color: green'>(-3 [-1.9%])</span> 155 |
| `memory_finalize_time_ms` |  1 |  4 |  4 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: green'>(-1 [-0.4%])</span> 278.25 | <span style='color: green'>(-4 [-0.4%])</span> 1,113 | <span style='color: red'>(+14 [+4.8%])</span> 305 | <span style='color: green'>(-13 [-4.8%])</span> 256 |
| `main_trace_commit_time_ms` | <span style='color: red'>(+0 [+0.5%])</span> 52 | <span style='color: red'>(+1 [+0.5%])</span> 208 | <span style='color: red'>(+1 [+1.8%])</span> 57 | <span style='color: red'>(+1 [+2.0%])</span> 50 |
| `generate_perm_trace_time_ms` | <span style='color: green'>(-1 [-4.8%])</span> 25 | <span style='color: green'>(-5 [-4.8%])</span> 100 | <span style='color: green'>(-7 [-19.4%])</span> 29 | <span style='color: red'>(+2 [+10.5%])</span> 21 |
| `perm_trace_commit_time_ms` | <span style='color: red'>(+0 [+0.2%])</span> 64.65 | <span style='color: red'>(+1 [+0.2%])</span> 258.60 | <span style='color: red'>(+0 [+0.4%])</span> 72.02 | <span style='color: green'>(-1 [-1.0%])</span> 54.59 |
| `quotient_poly_compute_time_ms` | <span style='color: green'>(-1 [-1.8%])</span> 58.26 | <span style='color: green'>(-4 [-1.8%])</span> 233.04 | <span style='color: red'>(+0 [+0.5%])</span> 70.46 | <span style='color: green'>(-2 [-3.5%])</span> 51.23 |
| `quotient_poly_commit_time_ms` | <span style='color: green'>(-1 [-7.3%])</span> 14.58 | <span style='color: green'>(-5 [-7.3%])</span> 58.33 | <span style='color: green'>(-1 [-6.0%])</span> 16.49 | <span style='color: green'>(-0 [-3.6%])</span> 12.62 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+2 [+3.4%])</span> 60.50 | <span style='color: red'>(+8 [+3.4%])</span> 242 | <span style='color: red'>(+10 [+16.1%])</span> 72 | <span style='color: green'>(-6 [-11.1%])</span> 48 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 553 | 1 | 38 | 4,137,502 | 108.23 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 210 | 730 | 23,446,148 | 150,778,428 | 210 | 305 | 0 | 58.15 | 16.49 | 5 | 72.02 | 72 | 99 | 72 | 4 | 57 | 10,899,170 | 26 | 45 | 1,103,000 | 29.10 | 21 | 75 | 1 | 72 | 
| regex_program | 1 | 155 | 531 | 11,598,276 | 128,513,066 | 155 | 269 | 1 | 51.23 | 14.69 | 4 | 65.69 | 62 | 90 | 62 | 0 | 50 | 2,196,106 | 24 | 66 | 1,104,000 | 33.49 | 16 | 66 | 0 | 61 | 
| regex_program | 2 | 163 | 519 | 11,579,064 | 128,513,066 | 163 | 256 | 1 | 53.21 | 14.53 | 4 | 66.30 | 48 | 88 | 48 | 0 | 51 | 2,177,334 | 21 | 58 | 1,104,000 | 33.33 | 16 | 68 | 0 | 48 | 
| regex_program | 3 | 184 | 553 | 11,853,872 | 103,456,394 | 184 | 283 | 0 | 70.46 | 12.62 | 5 | 54.59 | 60 | 87 | 60 | 0 | 50 | 2,422,606 | 29 | 45 | 826,502 | 32.91 | 18 | 84 | 1 | 60 | 

...
| `total_proof_time_ms ` |  526.50 |  1,053 |  592 |  461 |
...
| `execute_metered_insn_mi/s` |  133.89 | -          |  133.89 |  133.89 |
| `execute_preflight_insns` |  750,104.50 |  1,500,209 |  873,000 |  627,209 |
| `execute_preflight_time_ms` |  30 |  60 |  34 |  26 |
| `execute_preflight_insn_mi/s` |  35.70 | -          |  37.13 |  34.28 |
| `trace_gen_time_ms   ` |  194 |  388 |  197 |  191 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  196 |  392 |  198 |  194 |
| `main_trace_commit_time_ms` |  30.50 |  61 |  33 |  28 |
| `generate_perm_trace_time_ms` |  30 |  60 |  31 |  29 |
| `perm_trace_commit_time_ms` |  42.25 |  84.51 |  45.06 |  39.45 |
| `quotient_poly_compute_time_ms` |  31.26 |  62.51 |  33.78 |  28.73 |
| `quotient_poly_commit_time_ms` |  12.47 |  24.95 |  13.30 |  11.65 |
| `pcs_opening_time_ms ` |  47.50 |  95 |  53 |  42 |
...
| --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 461 | 1 | 11 | 1,500,209 | 133.89 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 197 | 592 | 9,677,708 | 84,395,212 | 197 | 198 | 0 | 33.78 | 13.30 | 4 | 45.06 | 42 | 74 | 41 | 0 | 33 | 1,035,986 | 29 | 26 | 873,000 | 34.28 | 14 | 47 | 0 | 41 | 
| fibonacci_program | 1 | 191 | 461 | 9,708,170 | 74,305,770 | 191 | 194 | 1 | 28.73 | 11.65 | 4 | 39.45 | 53 | 71 | 53 | 0 | 28 | 1,064,416 | 31 | 34 | 627,209 | 37.13 | 11 | 40 | 0 | 53 | 

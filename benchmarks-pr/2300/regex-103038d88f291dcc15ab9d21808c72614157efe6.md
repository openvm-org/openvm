...
| `total_proof_time_ms ` |  597.25 |  2,389 |  751 |  532 |
...
| `execute_metered_insn_mi/s` |  108.74 | -          |  108.74 |  108.74 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  51.75 |  207 |  63 |  44 |
| `execute_preflight_insn_mi/s` |  32.47 | -          |  33.55 |  29.49 |
| `trace_gen_time_ms   ` |  186.25 |  745 |  221 |  163 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  285.25 |  1,141 |  315 |  263 |
| `main_trace_commit_time_ms` |  52.50 |  210 |  57 |  50 |
| `generate_perm_trace_time_ms` |  27.75 |  111 |  38 |  22 |
| `perm_trace_commit_time_ms` |  66.02 |  264.10 |  73.05 |  55.54 |
| `quotient_poly_compute_time_ms` |  61.05 |  244.21 |  72.89 |  54.32 |
| `quotient_poly_commit_time_ms` |  15.81 |  63.25 |  18.70 |  13.16 |
| `pcs_opening_time_ms ` |  59.25 |  237 |  75 |  49 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 221 | 751 | 23,446,148 | 150,778,428 | 221 | 315 | 0 | 61.83 | 18.70 | 5 | 73.05 | 75 | 101 | 75 | 4 | 57 | 10,899,170 | 27 | 44 | 1,103,000 | 29.49 | 22 | 81 | 1 | 75 | 
| regex_program | 1 | 163 | 547 | 11,598,276 | 128,513,066 | 163 | 279 | 1 | 54.32 | 16.37 | 4 | 67.62 | 64 | 92 | 63 | 0 | 51 | 2,196,106 | 24 | 63 | 1,104,000 | 33.36 | 17 | 71 | 0 | 63 | 
| regex_program | 2 | 171 | 532 | 11,579,064 | 128,513,066 | 171 | 263 | 1 | 55.17 | 15.02 | 4 | 67.89 | 49 | 91 | 48 | 0 | 52 | 2,177,334 | 22 | 56 | 1,104,000 | 33.49 | 16 | 70 | 0 | 48 | 
| regex_program | 3 | 190 | 559 | 11,853,872 | 103,456,394 | 190 | 284 | 0 | 72.89 | 13.16 | 5 | 55.54 | 49 | 96 | 49 | 0 | 50 | 2,422,606 | 38 | 44 | 826,502 | 33.55 | 18 | 87 | 1 | 49 | 
...
Commit: https://github.com/openvm-org/openvm/commit/103038d88f291dcc15ab9d21808c72614157efe6
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19977184096)

...
|:---|---:|---:|---:|
| Total |  5.19 |  3.54 |  3.54 |
| app_proof |  4.25 |  2.61 |  2.61 |
| leaf |  0.52 |  0.52 |  0.52 |
...
| `total_proof_time_ms ` |  2,095 |  4,190 |  2,549 |  1,641 |
| `compile_metered_time_ms` |  6 |  6 |  6 |  6 |
| `execute_metered_time_ms` |  57 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  195.31 | -          |  195.31 |  195.31 |
| `execute_preflight_insns` |  5,583,980.50 |  11,167,961 |  7,136,000 |  4,031,961 |
| `execute_preflight_time_ms` |  355.50 |  711 |  495 |  216 |
| `execute_preflight_insn_mi/s` |  35.10 | -          |  35.45 |  34.76 |
| `trace_gen_time_ms   ` |  75.50 |  151 |  107 |  44 |
| `set_initial_memory_time_ms` |  0 |  0 |  0 |  0 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,662 |  3,324 |  2,224 |  1,100 |
| `prover.main_trace_commit_time_ms` |  403 |  806 |  583 |  223 |
| `prover.rap_constraints_time_ms` |  983.50 |  1,967 |  1,290 |  677 |
| `prover.openings_time_ms` |  274.50 |  549 |  350 |  199 |
| `prover.rap_constraints.logup_gkr_time_ms` |  273 |  546 |  352 |  194 |
| `prover.rap_constraints.round0_time_ms` |  528.50 |  1,057 |  702 |  355 |
| `prover.rap_constraints.mle_rounds_time_ms` |  180.50 |  361 |  234 |  127 |
| `prover.openings.stacked_reduction_time_ms` |  74 |  148 |  94 |  54 |
...
| `prover.openings.whir_time_ms` |  200 |  400 |  255 |  145 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  517 |  517 |  517 |  517 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/448f3dfc23beabe8c2c405f233f21ba468d9bd01/sha2_bench-448f3dfc23beabe8c2c405f233f21ba468d9bd01.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 59 |  |  |  | 289 |  |  |  |  |  |  | 
| app_proof |  |  |  | 1,641 |  | 57 | 11,167,961 | 195.31 | 0 | 4,257 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 174 | 46 | 0 | 0 | 79 | 29 | 28 | 36 | 13 | 0 | 47 | 37 | 10 | 2 | 7 | 46 | 46 | 79 | 0 | 1 | 12 | 0 | 0 | 
...
| leaf | 0 | prover | 237,929,144 | 403 | 144 | 0 | 0 | 140 | 70 | 69 | 44 | 25 | 0 | 117 | 95 | 21 | 10 | 11 | 145 | 144 | 140 | 0 | 3 | 25 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,324,516,602 | 2,224 | 583 | 0 | 0 | 1,290 | 702 | 702 | 234 | 352 | 1 | 350 | 255 | 94 | 58 | 36 | 583 | 583 | 1,290 | 0 | 1 | 351 | 0 | 0 | 
| app_proof | prover | 1 | 716,475,896 | 1,100 | 222 | 0 | 0 | 677 | 355 | 354 | 127 | 194 | 0 | 199 | 145 | 54 | 32 | 21 | 223 | 222 | 677 | 0 | 1 | 192 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 0 | 2 | 107 | 2,549 | 107 | 0 | 12,918,735,564 | 2,978,228,460 | 15,896,964,024 | 2,097,152 | 0 | 4 | 216 | 7,136,000 | 34.76 | 
| app_proof | 1 | 0 | 1 | 44 | 1,641 | 44 | 0 | 7,331,586,696 | 1,706,847,983 | 9,038,434,679 | 2,097,152 | 0 | 2 | 495 | 4,031,961 | 35.45 | 

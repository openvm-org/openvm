...
| `total_proof_time_ms ` |  2,136 |  4,272 |  2,588 |  1,684 |
| `compile_metered_time_ms` |  6 |  6 |  6 |  6 |
| `execute_metered_time_ms` |  57 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  194.77 | -          |  194.77 |  194.77 |
| `execute_preflight_insns` |  5,583,980.50 |  11,167,961 |  7,136,000 |  4,031,961 |
| `execute_preflight_time_ms` |  371.50 |  743 |  525 |  218 |
| `execute_preflight_insn_mi/s` |  35.09 | -          |  35.47 |  34.72 |
| `trace_gen_time_ms   ` |  81 |  162 |  114 |  48 |
| `set_initial_memory_time_ms` |  0 |  0 |  0 |  0 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,682 |  3,364 |  2,254 |  1,110 |
| `prover.main_trace_commit_time_ms` |  409.50 |  819 |  594 |  225 |
| `prover.rap_constraints_time_ms` |  994 |  1,988 |  1,304 |  684 |
| `prover.openings_time_ms` |  277.50 |  555 |  355 |  200 |
| `prover.rap_constraints.logup_gkr_time_ms` |  276.50 |  553 |  356 |  197 |
| `prover.rap_constraints.round0_time_ms` |  534 |  1,068 |  709 |  359 |
| `prover.rap_constraints.mle_rounds_time_ms` |  182.50 |  365 |  238 |  127 |
| `prover.openings.stacked_reduction_time_ms` |  75.50 |  151 |  97 |  54 |
| `prover.openings.stacked_reduction.round0_time_ms` |  46 |  92 |  60 |  32 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  29 |  58 |  37 |  21 |
| `prover.openings.whir_time_ms` |  201 |  402 |  257 |  145 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/a630dfe19a4ad7dfa168d62bbb789e3d59b59ad9/sha2_bench-a630dfe19a4ad7dfa168d62bbb789e3d59b59ad9.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 60 |  |  |  | 297 |  |  |  |  |  |  | 
| app_proof |  |  |  | 1,684 |  | 57 | 11,167,961 | 194.77 | 0 | 4,339 |  | 
...
| app_proof | VmAirWrapper<Rv64BaseAluAdapterAir, BitwiseLogicCoreAir<8, 8> | 0 | 4 | 5 | 
| app_proof | VmAirWrapper<Rv64BaseAluImmU16AdapterAir, AddICoreAir<4, 16> | 0 |  | 13 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 178 | 46 | 0 | 0 | 80 | 29 | 28 | 37 | 13 | 0 | 50 | 39 | 10 | 2 | 7 | 46 | 46 | 80 | 0 | 1 | 13 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 109 | 20 | 0 | 0 | 56 | 20 | 20 | 23 | 11 | 0 | 32 | 24 | 7 | 1 | 6 | 20 | 20 | 56 | 0 | 1 | 10 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 99 | 15 | 0 | 0 | 55 | 20 | 19 | 21 | 12 | 0 | 28 | 20 | 7 | 1 | 5 | 15 | 15 | 55 | 0 | 1 | 10 | 0 | 0 | 
| leaf | 0 | prover | 237,929,144 | 404 | 145 | 0 | 0 | 141 | 71 | 69 | 44 | 26 | 0 | 116 | 94 | 22 | 10 | 11 | 145 | 145 | 141 | 0 | 3 | 25 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,324,516,602 | 2,254 | 594 | 0 | 0 | 1,304 | 709 | 708 | 238 | 356 | 1 | 355 | 257 | 97 | 60 | 37 | 594 | 594 | 1,304 | 0 | 1 | 354 | 0 | 0 | 
| app_proof | prover | 1 | 716,475,896 | 1,110 | 225 | 0 | 0 | 684 | 359 | 358 | 127 | 197 | 0 | 200 | 145 | 54 | 32 | 21 | 225 | 225 | 684 | 0 | 1 | 195 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 0 | 2 | 114 | 2,588 | 114 | 0 | 12,918,735,564 | 2,978,228,460 | 15,896,964,024 | 2,097,152 | 0 | 4 | 218 | 7,136,000 | 34.72 | 
| app_proof | 1 | 0 | 1 | 48 | 1,684 | 48 | 0 | 7,331,586,696 | 1,706,847,983 | 9,038,434,679 | 2,097,152 | 0 | 2 | 525 | 4,031,961 | 35.47 | 

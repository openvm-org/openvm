...
| `total_proof_time_ms ` |  757.50 |  1,515 |  817 |  698 |
| `execute_metered_time_ms` |  33 | -          | -          | -          |
| `execute_metered_insns` |  4,137,067 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  124.60 | -          |  124.60 |  124.60 |
| `execute_preflight_insns` |  2,068,533.50 |  4,137,067 |  2,208,000 |  1,929,067 |
| `execute_preflight_time_ms` |  73.50 |  147 |  81 |  66 |
| `execute_preflight_insn_mi/s` |  40.37 | -          |  42.28 |  38.46 |
| `trace_gen_time_ms   ` |  151.50 |  303 |  156 |  147 |
| `memory_finalize_time_ms` |  1 |  2 |  2 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  430 |  860 |  432 |  428 |
| `prover.main_trace_commit_time_ms` |  94.50 |  189 |  100 |  89 |
| `prover.rap_constraints_time_ms` |  238 |  476 |  251 |  225 |
| `prover.openings_time_ms` |  97 |  194 |  102 |  92 |
| `prover.rap_constraints.logup_gkr_time_ms` |  139 |  278 |  141 |  137 |
| `prover.rap_constraints.round0_time_ms` |  71 |  142 |  87 |  55 |
| `prover.rap_constraints.mle_rounds_time_ms` |  27 |  54 |  28 |  26 |
| `prover.openings.stacked_reduction_time_ms` |  19 |  38 |  20 |  18 |
| `prover.openings.stacked_reduction.round0_time_ms` |  9 |  18 |  10 |  8 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  9 |  18 |  9 |  9 |
| `prover.openings.whir_time_ms` |  77.50 |  155 |  82 |  73 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  430 |  430 |  430 |  430 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/9b49e342f8f812cc7adeccaccdb44bd196f504ff/regex-9b49e342f8f812cc7adeccaccdb44bd196f504ff.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 70 | 9 |  |  | 0 |  | 338 | 9 |  |  |  |  |  |  | 
| app_proof |  |  |  |  |  | 698 |  |  | 33 | 4,137,067 | 124.60 | 0 | 1,562 |  | 
...
| internal_recursive.1 | 1 | 8 | 150 | 8 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 49 | 430 | 48 | 13 | 2 | 5 | 1 | 1 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 27,256,635 | 258 | 83 | 0 | 0 | 97 | 32 | 31 | 45 | 19 | 0 | 77 | 65 | 11 | 2 | 8 | 83 | 97 | 0 | 3 | 18 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,767 | 167 | 46 | 0 | 0 | 67 | 25 | 24 | 28 | 14 | 0 | 53 | 44 | 8 | 1 | 6 | 46 | 67 | 0 | 3 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 141 | 32 | 0 | 0 | 60 | 22 | 22 | 24 | 13 | 0 | 48 | 41 | 7 | 1 | 5 | 32 | 60 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 79,959,796 | 381 | 128 | 0 | 0 | 136 | 55 | 54 | 37 | 42 | 0 | 115 | 100 | 15 | 6 | 8 | 128 | 136 | 0 | 7 | 41 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 123,384,338 | 428 | 100 | 0 | 0 | 225 | 55 | 54 | 28 | 141 | 0 | 102 | 82 | 20 | 10 | 9 | 100 | 225 | 0 | 3 | 138 | 0 | 0 | 
| app_proof | prover | 1 | 106,568,591 | 432 | 89 | 0 | 0 | 251 | 87 | 87 | 26 | 137 | 0 | 92 | 73 | 18 | 8 | 9 | 89 | 251 | 0 | 3 | 136 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 147 | 817 | 147 | 159 | 2,052,973,566 | 668,936,290 | 2,721,909,856 | 2,097,152 | 2 | 7 | 81 | 2,208,000 | 38.46 | 
| app_proof | 1 | 156 | 698 | 156 | 41 | 1,584,899,101 | 646,500,736 | 2,231,399,837 | 2,097,152 | 0 | 2 | 66 | 1,929,067 | 42.28 | 

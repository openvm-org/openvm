...
| `total_proof_time_ms ` |  757 |  1,514 |  821 |  693 |
| `execute_metered_time_ms` |  33 | -          | -          | -          |
| `execute_metered_insns` |  4,137,067 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  123.65 | -          |  123.65 |  123.65 |
| `execute_preflight_insns` |  2,068,533.50 |  4,137,067 |  2,208,000 |  1,929,067 |
| `execute_preflight_time_ms` |  76.50 |  153 |  82 |  71 |
| `execute_preflight_insn_mi/s` |  37.47 | -          |  38.18 |  36.77 |
| `trace_gen_time_ms   ` |  148 |  296 |  150 |  146 |
| `memory_finalize_time_ms` |  1.50 |  3 |  3 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  430.50 |  861 |  431 |  430 |
| `prover.main_trace_commit_time_ms` |  95 |  190 |  101 |  89 |
| `prover.rap_constraints_time_ms` |  238 |  476 |  248 |  228 |
| `prover.openings_time_ms` |  96.50 |  193 |  101 |  92 |
| `prover.rap_constraints.logup_gkr_time_ms` |  139 |  278 |  142 |  136 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/37631779ea1a355651112b562dda5bb6b4683bea/regex-37631779ea1a355651112b562dda5bb6b4683bea.memory.svg)
...
| app_proof |  |  |  |  |  | 693 |  |  | 33 | 4,137,067 | 123.65 | 0 | 1,562 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 27,256,635 | 259 | 82 | 0 | 0 | 98 | 32 | 31 | 45 | 19 | 0 | 78 | 67 | 11 | 2 | 8 | 82 | 98 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,767 | 169 | 47 | 0 | 0 | 68 | 26 | 25 | 28 | 14 | 0 | 53 | 44 | 8 | 1 | 6 | 47 | 68 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 140 | 31 | 0 | 0 | 62 | 23 | 23 | 24 | 14 | 0 | 45 | 37 | 7 | 1 | 5 | 32 | 62 | 0 | 3 | 13 | 0 | 0 | 
| leaf | 0 | prover | 79,959,796 | 381 | 128 | 0 | 0 | 136 | 54 | 53 | 37 | 44 | 0 | 115 | 100 | 15 | 6 | 8 | 128 | 136 | 0 | 6 | 41 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 123,384,338 | 431 | 100 | 0 | 0 | 228 | 56 | 56 | 29 | 142 | 0 | 101 | 81 | 19 | 10 | 9 | 101 | 228 | 0 | 3 | 139 | 0 | 0 | 
| app_proof | prover | 1 | 106,568,591 | 430 | 89 | 0 | 0 | 248 | 85 | 85 | 26 | 136 | 0 | 92 | 73 | 18 | 8 | 9 | 89 | 248 | 0 | 3 | 135 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 146 | 821 | 146 | 161 | 2,052,973,566 | 668,936,290 | 2,721,909,856 | 2,097,152 | 3 | 7 | 82 | 2,208,000 | 36.77 | 
| app_proof | 1 | 150 | 693 | 150 | 41 | 1,584,899,101 | 646,500,736 | 2,231,399,837 | 2,097,152 | 0 | 2 | 71 | 1,929,067 | 38.18 | 

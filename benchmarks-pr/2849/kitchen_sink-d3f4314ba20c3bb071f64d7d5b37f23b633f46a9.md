...
|:---|---:|---:|---:|
| Total |  5.47 |  3.83 |  3.83 |
| app_proof |  3.94 |  2.30 |  2.30 |
| leaf |  0.97 |  0.97 |  0.97 |
...
| `total_proof_time_ms ` |  1,953 |  3,906 |  2,265 |  1,641 |
| `execute_metered_time_ms` |  34 | -          | -          | -          |
| `execute_metered_insns` |  2,579,903 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  73.99 | -          |  73.99 |  73.99 |
| `execute_preflight_insns` |  1,289,951.50 |  2,579,903 |  1,540,000 |  1,039,903 |
| `execute_preflight_time_ms` |  99 |  198 |  133 |  65 |
| `execute_preflight_insn_mi/s` |  33.53 | -          |  34.45 |  32.61 |
| `trace_gen_time_ms   ` |  146 |  292 |  188 |  104 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,597.50 |  3,195 |  1,833 |  1,362 |
| `prover.main_trace_commit_time_ms` |  518 |  1,036 |  602 |  434 |
| `prover.rap_constraints_time_ms` |  947.50 |  1,895 |  1,093 |  802 |
| `prover.openings_time_ms` |  131 |  262 |  136 |  126 |
| `prover.rap_constraints.logup_gkr_time_ms` |  169 |  338 |  200 |  138 |
| `prover.rap_constraints.round0_time_ms` |  570.50 |  1,141 |  674 |  467 |
| `prover.rap_constraints.mle_rounds_time_ms` |  206.50 |  413 |  218 |  195 |
| `prover.openings.stacked_reduction_time_ms` |  97 |  194 |  106 |  88 |
| `prover.openings.stacked_reduction.round0_time_ms` |  51 |  102 |  52 |  50 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  45.50 |  91 |  54 |  37 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/d3f4314ba20c3bb071f64d7d5b37f23b633f46a9/kitchen_sink-d3f4314ba20c3bb071f64d7d5b37f23b633f46a9.memory.svg)
...
| app_proof |  |  |  |  |  | 1,641 |  |  | 34 | 2,579,903 | 73.99 | 0 | 3,946 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,577,979 | 264 | 118 | 0 | 0 | 109 | 36 | 35 | 52 | 20 | 0 | 36 | 22 | 13 | 3 | 9 | 119 | 109 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,767 | 141 | 46 | 0 | 0 | 67 | 24 | 24 | 28 | 14 | 0 | 27 | 18 | 8 | 1 | 6 | 46 | 67 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 120 | 31 | 0 | 0 | 64 | 25 | 24 | 24 | 14 | 0 | 24 | 16 | 7 | 1 | 5 | 32 | 64 | 0 | 2 | 13 | 0 | 0 | 
| leaf | 0 | prover | 265,003,892 | 847 | 407 | 0 | 1 | 356 | 139 | 138 | 77 | 140 | 0 | 82 | 42 | 40 | 22 | 18 | 407 | 356 | 0 | 6 | 139 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 567,917,156 | 1,833 | 602 | 0 | 187 | 1,093 | 674 | 673 | 218 | 200 | 56 | 136 | 30 | 106 | 52 | 54 | 602 | 1,093 | 0 | 3 | 142 | 0 | 0 | 
| app_proof | prover | 1 | 537,266,124 | 1,362 | 434 | 0 | 1 | 802 | 467 | 467 | 195 | 138 | 0 | 126 | 37 | 88 | 50 | 37 | 434 | 802 | 0 | 3 | 137 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 188 | 2,265 | 188 | 177 | 0 | 3 | 65 | 1,540,000 | 32.61 | 
| app_proof | 1 | 104 | 1,641 | 104 | 41 | 0 | 2 | 133 | 1,039,903 | 34.45 | 

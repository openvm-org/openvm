...
|:---|---:|---:|---:|
| Total |  2.35 |  0.74 | 0.74 |
| regex_program |  2.35 |  0.74 |  0.74 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  578.25 |  2,313 |  700 |  516 |
| `execute_metered_time_ms` |  36 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  113.22 | -          |  113.22 |  113.22 |
| `execute_preflight_insns` |  1,034,410 |  4,137,640 |  1,104,000 |  826,640 |
| `execute_preflight_time_ms` |  44.25 |  177 |  56 |  33 |
| `execute_preflight_insn_mi/s` |  33.06 | -          |  33.61 |  31.98 |
| `trace_gen_time_ms   ` |  179 |  716 |  198 |  169 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  280.50 |  1,122 |  305 |  254 |
| `main_trace_commit_time_ms` |  51.75 |  207 |  57 |  49 |
| `generate_perm_trace_time_ms` |  23.75 |  95 |  32 |  18 |
| `perm_trace_commit_time_ms` |  64.50 |  257.98 |  71.33 |  55.80 |
| `quotient_poly_compute_time_ms` |  58.70 |  234.79 |  70.64 |  52.02 |
| `quotient_poly_commit_time_ms` |  15.29 |  61.16 |  17.49 |  13.74 |
| `pcs_opening_time_ms ` |  63.50 |  254 |  74 |  50 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 566 | 1 | 36 | 4,137,640 | 113.22 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 169 | 700 | 150,778,428 | 169 | 305 | 0 | 59.31 | 17.49 | 5 | 71.33 | 74 | 95 | 74 | 4 | 57 | 23 | 56 | 1,103,000 | 31.98 | 22 | 77 | 1 | 74 | 
| regex_program | 1 | 175 | 516 | 128,513,066 | 175 | 254 | 1 | 52.02 | 14.79 | 4 | 64.51 | 50 | 87 | 49 | 0 | 49 | 22 | 44 | 1,104,000 | 33.61 | 16 | 67 | 0 | 49 | 
| regex_program | 2 | 174 | 531 | 128,513,066 | 174 | 271 | 1 | 52.83 | 15.14 | 4 | 66.34 | 66 | 85 | 66 | 0 | 50 | 18 | 44 | 1,104,000 | 33.20 | 16 | 68 | 0 | 66 | 
| regex_program | 3 | 198 | 566 | 103,475,717 | 198 | 292 | 0 | 70.64 | 13.74 | 5 | 55.80 | 64 | 91 | 64 | 0 | 51 | 32 | 33 | 826,640 | 33.45 | 21 | 85 | 1 | 64 | 

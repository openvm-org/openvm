...
| `total_proof_time_ms ` |  511 |  1,022 |  578 |  444 |
| `execute_metered_time_ms` |  9 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  163.41 | -          |  163.41 |  163.41 |
| `execute_preflight_insns` |  750,132.50 |  1,500,265 |  873,000 |  627,265 |
| `execute_preflight_time_ms` |  26.50 |  53 |  31 |  22 |
| `execute_preflight_insn_mi/s` |  38.78 | -          |  39.91 |  37.64 |
| `trace_gen_time_ms   ` |  192 |  384 |  194 |  190 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  187 |  374 |  188 |  186 |
| `main_trace_commit_time_ms` |  30.50 |  61 |  33 |  28 |
| `generate_perm_trace_time_ms` |  22 |  44 |  29 |  15 |
| `perm_trace_commit_time_ms` |  41.71 |  83.42 |  44.69 |  38.74 |
| `quotient_poly_compute_time_ms` |  31.61 |  63.22 |  34.50 |  28.72 |
| `quotient_poly_commit_time_ms` |  11.88 |  23.76 |  12.45 |  11.32 |
| `pcs_opening_time_ms ` |  47.50 |  95 |  48 |  47 |
...
| --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 444 | 1 | 9 | 1,500,265 | 163.41 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 190 | 578 | 84,399,632 | 190 | 188 | 0 | 34.50 | 12.45 | 4 | 44.69 | 47 | 60 | 47 | 0 | 33 | 15 | 31 | 873,000 | 39.91 | 14 | 47 | 0 | 47 | 
| fibonacci_program | 1 | 194 | 444 | 74,305,770 | 194 | 186 | 1 | 28.72 | 11.32 | 4 | 38.74 | 48 | 68 | 48 | 0 | 28 | 29 | 22 | 627,265 | 37.64 | 11 | 40 | 0 | 48 | 

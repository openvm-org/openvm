...
| `total_proof_time_ms ` |  736 |  1,472 |  866 |  606 |
...
| `execute_preflight_time_ms` |  87.50 |  175 |  127 |  48 |
| `execute_preflight_insn_mi/s` |  14.24 | -          |  17.61 |  10.87 |
| `trace_gen_time_ms   ` |  182.50 |  365 |  205 |  160 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  360 |  720 |  409 |  311 |
| `main_trace_commit_time_ms` |  64.50 |  129 |  76 |  53 |
| `generate_perm_trace_time_ms` |  40 |  80 |  45 |  35 |
| `perm_trace_commit_time_ms` |  76.100 |  153.100 |  89.28 |  64.72 |
| `quotient_poly_compute_time_ms` |  83.34 |  166.68 |  91.84 |  74.84 |
| `quotient_poly_commit_time_ms` |  17.33 |  34.65 |  19.02 |  15.64 |
| `pcs_opening_time_ms ` |  73 |  146 |  83 |  63 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 606 | 1 | 68 | 1,745,757 | 25.39 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 160 | 866 | 172,558,444 | 160 | 409 | 0 | 91.84 | 19.02 | 6 | 89.28 | 83 | 137 | 83 | 1 | 76 | 45 | 127 | 1,151,000 | 10.87 | 27 | 111 | 1 | 83 | 
| pairing | 1 | 205 | 606 | 119,958,502 | 205 | 311 | 1 | 74.84 | 15.64 | 6 | 64.72 | 63 | 102 | 62 | 0 | 53 | 35 | 48 | 594,757 | 17.61 | 21 | 91 | 1 | 62 | 

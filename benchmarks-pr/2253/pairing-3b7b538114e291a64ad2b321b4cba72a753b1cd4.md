...
| `total_proof_time_ms ` |  728.50 |  1,457 |  813 |  644 |
...
| `execute_preflight_time_ms` |  92.50 |  185 |  125 |  60 |
| `execute_preflight_insn_mi/s` |  13.93 | -          |  18.39 |  9.47 |
| `trace_gen_time_ms   ` |  177 |  354 |  192 |  162 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  365.50 |  731 |  382 |  349 |
| `main_trace_commit_time_ms` |  63.50 |  127 |  73 |  54 |
| `generate_perm_trace_time_ms` |  58 |  116 |  71 |  45 |
| `perm_trace_commit_time_ms` |  76.09 |  152.17 |  88.87 |  63.30 |
| `quotient_poly_compute_time_ms` |  78.60 |  157.21 |  86.48 |  70.73 |
| `quotient_poly_commit_time_ms` |  16 |  32.01 |  17.78 |  14.23 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 644 | 1 | 88 | 1,745,742 | 19.75 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 162 | 813 | 32,689,110 | 172,558,444 | 162 | 382 | 0 | 86.48 | 17.78 | 6 | 88.87 | 66 | 137 | 66 | 1 | 73 | 16,059,916 | 45 | 125 | 1,157,000 | 9.47 | 26 | 105 | 1 | 66 | 
| pairing | 1 | 192 | 644 | 22,314,288 | 119,958,502 | 192 | 349 | 1 | 70.73 | 14.23 | 6 | 63.30 | 71 | 137 | 71 | 0 | 54 | 9,408,294 | 71 | 60 | 588,742 | 18.39 | 20 | 85 | 1 | 71 | 

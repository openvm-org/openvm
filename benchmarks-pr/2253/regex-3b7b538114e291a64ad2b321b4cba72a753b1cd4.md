...
| `total_proof_time_ms ` |  592.25 |  2,369 |  739 |  532 |
...
| `execute_preflight_insn_mi/s` |  31.81 | -          |  32.89 |  28.82 |
| `trace_gen_time_ms   ` |  178.25 |  713 |  212 |  154 |
| `memory_finalize_time_ms` |  0.75 |  3 |  3 |  0 |
| `stark_prove_excluding_trace_time_ms` |  293.75 |  1,175 |  338 |  262 |
| `main_trace_commit_time_ms` |  52 |  208 |  57 |  50 |
| `generate_perm_trace_time_ms` |  34.75 |  139 |  55 |  19 |
| `perm_trace_commit_time_ms` |  64.10 |  256.38 |  70.08 |  55.57 |
| `quotient_poly_compute_time_ms` |  57.51 |  230.04 |  68.62 |  51.52 |
| `quotient_poly_commit_time_ms` |  15.12 |  60.48 |  17.03 |  12.82 |
| `pcs_opening_time_ms ` |  67.50 |  270 |  78 |  51 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 532 | 1 | 40 | 4,137,502 | 102.93 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 212 | 739 | 23,446,148 | 150,778,428 | 212 | 338 | 0 | 58.29 | 17.03 | 5 | 70.08 | 78 | 125 | 78 | 3 | 57 | 10,899,170 | 55 | 44 | 1,103,000 | 28.82 | 21 | 76 | 1 | 78 | 
| regex_program | 1 | 154 | 546 | 11,598,276 | 128,513,066 | 154 | 286 | 1 | 51.61 | 15.63 | 4 | 65.57 | 63 | 104 | 63 | 0 | 51 | 2,196,106 | 38 | 64 | 1,104,000 | 32.89 | 17 | 67 | 0 | 63 | 
| regex_program | 2 | 163 | 552 | 11,579,064 | 128,513,066 | 163 | 289 | 1 | 51.52 | 15.01 | 5 | 65.16 | 78 | 93 | 78 | 0 | 50 | 2,177,334 | 27 | 57 | 1,104,000 | 32.85 | 17 | 67 | 0 | 78 | 
| regex_program | 3 | 184 | 532 | 11,853,872 | 103,456,394 | 183 | 262 | 0 | 68.62 | 12.82 | 5 | 55.57 | 51 | 77 | 51 | 0 | 50 | 2,422,606 | 19 | 45 | 826,502 | 32.67 | 18 | 82 | 1 | 51 | 

...
| `total_proof_time_ms ` |  495 |  990 |  560 |  430 |
...
| `execute_metered_insn_mi/s` |  146.11 | -          |  146.11 |  146.11 |
| `execute_preflight_insns` |  750,104.50 |  1,500,209 |  873,000 |  627,209 |
| `execute_preflight_time_ms` |  28.50 |  57 |  32 |  25 |
| `execute_preflight_insn_mi/s` |  38.43 | -          |  40.50 |  36.36 |
| `trace_gen_time_ms   ` |  190 |  380 |  196 |  184 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  181.50 |  363 |  191 |  172 |
| `main_trace_commit_time_ms` |  30.50 |  61 |  33 |  28 |
| `generate_perm_trace_time_ms` |  24.50 |  49 |  28 |  21 |
| `perm_trace_commit_time_ms` |  40.92 |  81.84 |  43.24 |  38.60 |
| `quotient_poly_compute_time_ms` |  30.04 |  60.07 |  31.66 |  28.41 |
| `quotient_poly_commit_time_ms` |  11.53 |  23.05 |  12 |  11.05 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 430 | 41 | 1 | 10 | 1,500,209 | 146.11 | 142 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 196 | 560 | 9,677,708 | 84,395,212 | 196 | 191 | 0 | 31.66 | 12 | 5 | 43.24 | 41 | 72 | 41 | 0 | 33 | 1,035,986 | 28 | 25 | 873,000 | 36.36 | 14 | 44 | 0 | 41 | 
| fibonacci_program | 1 | 184 | 430 | 9,708,170 | 74,305,770 | 184 | 172 | 1 | 28.41 | 11.05 | 4 | 38.60 | 44 | 60 | 43 | 0 | 28 | 1,064,416 | 21 | 32 | 627,209 | 40.50 | 11 | 39 | 0 | 43 | 

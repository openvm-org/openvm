...
|:---|---:|---:|
| Total |  2.40 |  0.74 |
| regex_program |  2.36 |  0.70 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  591 |  2,364 |  698 |  524 |
...
| `execute_metered_insn_mi/s` |  108.88 | -          |  108.88 |  108.88 |
| `execute_preflight_insns` |  1,034,343 |  4,137,372 |  1,104,000 |  826,372 |
| `execute_preflight_time_ms` |  54.75 |  219 |  68 |  46 |
| `execute_preflight_insn_mi/s` |  32.14 | -          |  33.70 |  28.61 |
| `trace_gen_time_ms   ` |  175.25 |  701 |  210 |  150 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  292.25 |  1,169 |  319 |  264 |
| `main_trace_commit_time_ms` |  51.25 |  205 |  55 |  50 |
| `generate_perm_trace_time_ms` |  32 |  128 |  53 |  20 |
| `perm_trace_commit_time_ms` |  63.86 |  255.43 |  70.30 |  55.33 |
| `quotient_poly_compute_time_ms` |  57.47 |  229.88 |  68.24 |  51.05 |
| `quotient_poly_commit_time_ms` |  14.91 |  59.63 |  17.18 |  12.47 |
| `pcs_opening_time_ms ` |  69.75 |  279 |  107 |  48 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 587 | 41 | 1 | 37 | 4,137,372 | 108.88 | 170 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 210 | 698 | 23,468,048 | 150,778,428 | 210 | 292 | 0 | 59.40 | 17.18 | 5 | 70.30 | 68 | 91 | 67 | 4 | 55 | 10,916,118 | 20 | 46 | 1,103,000 | 28.61 | 21 | 77 | 1 | 67 | 
| regex_program | 1 | 150 | 524 | 11,615,600 | 128,513,066 | 150 | 264 | 1 | 51.05 | 14.43 | 5 | 64.31 | 48 | 99 | 47 | 0 | 50 | 2,207,750 | 34 | 68 | 1,104,000 | 33.07 | 16 | 66 | 0 | 47 | 
| regex_program | 2 | 161 | 555 | 11,604,416 | 128,513,066 | 161 | 294 | 1 | 51.19 | 15.55 | 5 | 65.49 | 56 | 119 | 56 | 0 | 50 | 2,196,886 | 53 | 59 | 1,104,000 | 33.70 | 17 | 67 | 0 | 56 | 
| regex_program | 3 | 180 | 587 | 11,876,674 | 103,522,954 | 180 | 319 | 0 | 68.24 | 12.47 | 5 | 55.33 | 107 | 80 | 107 | 0 | 50 | 2,438,640 | 21 | 46 | 826,372 | 33.19 | 18 | 81 | 1 | 107 | 

...
|:---|---:|---:|
| Total |  2.43 |  0.73 |
| regex_program |  2.40 |  0.70 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  599.25 |  2,397 |  697 |  530 |
...
| `execute_metered_insn_mi/s` |  119.90 | -          |  119.90 |  119.90 |
| `execute_preflight_insns` |  1,034,343 |  4,137,372 |  1,104,000 |  826,372 |
| `execute_preflight_time_ms` |  54.25 |  217 |  65 |  46 |
| `execute_preflight_insn_mi/s` |  30.52 | -          |  31.48 |  27.92 |
| `trace_gen_time_ms   ` |  179 |  716 |  212 |  157 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  298.50 |  1,194 |  343 |  266 |
| `main_trace_commit_time_ms` |  52 |  208 |  57 |  50 |
| `generate_perm_trace_time_ms` |  44 |  176 |  83 |  24 |
| `perm_trace_commit_time_ms` |  63.80 |  255.21 |  72.11 |  54.29 |
| `quotient_poly_compute_time_ms` |  58.64 |  234.57 |  71.93 |  51.83 |
| `quotient_poly_commit_time_ms` |  14.77 |  59.09 |  16.99 |  12.85 |
| `pcs_opening_time_ms ` |  62 |  248 |  77 |  48 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 564 | 41 | 1 | 34 | 4,137,372 | 119.90 | 166 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 212 | 697 | 23,468,048 | 150,778,428 | 212 | 292 | 0 | 58.43 | 16.99 | 5 | 72.11 | 60 | 97 | 60 | 4 | 57 | 10,916,118 | 24 | 47 | 1,103,000 | 27.92 | 21 | 76 | 1 | 60 | 
| regex_program | 1 | 157 | 530 | 11,615,600 | 128,513,066 | 157 | 266 | 1 | 51.83 | 14.78 | 5 | 64.72 | 48 | 99 | 48 | 0 | 51 | 2,207,750 | 34 | 65 | 1,104,000 | 31.34 | 16 | 67 | 0 | 48 | 
| regex_program | 2 | 163 | 606 | 11,604,416 | 128,513,066 | 163 | 343 | 1 | 52.39 | 14.48 | 5 | 64.09 | 77 | 147 | 77 | 0 | 50 | 2,196,886 | 83 | 59 | 1,104,000 | 31.48 | 16 | 67 | 0 | 77 | 
| regex_program | 3 | 184 | 564 | 11,876,674 | 103,522,954 | 184 | 293 | 0 | 71.93 | 12.85 | 5 | 54.29 | 63 | 92 | 63 | 0 | 50 | 2,438,640 | 35 | 46 | 826,372 | 31.36 | 18 | 85 | 1 | 63 | 

...
|:---|---:|---:|
| Total |  2.41 |  0.74 |
| regex_program |  2.37 |  0.70 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  593.50 |  2,374 |  700 |  536 |
...
| `execute_preflight_insn_mi/s` |  30.85 | -          |  31.93 |  28.02 |
| `trace_gen_time_ms   ` |  180.50 |  722 |  215 |  157 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  290.50 |  1,162 |  325 |  271 |
| `main_trace_commit_time_ms` |  51.75 |  207 |  56 |  49 |
| `generate_perm_trace_time_ms` |  40.25 |  161 |  83 |  21 |
| `perm_trace_commit_time_ms` |  64.86 |  259.43 |  72.39 |  54.74 |
| `quotient_poly_compute_time_ms` |  59.34 |  237.38 |  72.30 |  52.84 |
| `quotient_poly_commit_time_ms` |  15.23 |  60.91 |  16.71 |  12.87 |
| `pcs_opening_time_ms ` |  55.75 |  223 |  60 |  49 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 548 | 65 | 1 | 36 | 4,137,372 | 113.92 | 192 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 215 | 700 | 23,468,048 | 150,778,428 | 215 | 290 | 0 | 58.63 | 16.71 | 6 | 72.39 | 60 | 96 | 60 | 4 | 56 | 10,916,118 | 23 | 46 | 1,103,000 | 28.02 | 21 | 76 | 1 | 60 | 
| regex_program | 1 | 157 | 536 | 11,615,600 | 128,513,066 | 157 | 271 | 1 | 52.84 | 15.95 | 5 | 66.32 | 49 | 100 | 49 | 0 | 51 | 2,207,750 | 34 | 66 | 1,104,000 | 31.93 | 17 | 69 | 0 | 49 | 
| regex_program | 2 | 165 | 590 | 11,604,416 | 128,513,066 | 165 | 325 | 1 | 53.61 | 15.38 | 5 | 65.98 | 54 | 149 | 54 | 0 | 51 | 2,196,886 | 83 | 59 | 1,104,000 | 31.92 | 16 | 69 | 0 | 54 | 
| regex_program | 3 | 185 | 548 | 11,876,674 | 103,522,954 | 185 | 276 | 0 | 72.30 | 12.87 | 5 | 54.74 | 60 | 79 | 60 | 0 | 49 | 2,438,640 | 21 | 45 | 826,372 | 31.55 | 18 | 86 | 1 | 60 | 

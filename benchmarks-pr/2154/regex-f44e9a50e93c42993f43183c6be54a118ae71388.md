...
| `total_proof_time_ms ` |  593.50 |  2,374 |  718 |  535 |
...
| `execute_metered_insn_mi/s` |  121.24 | -          |  121.24 |  121.24 |
| `execute_preflight_insns` |  1,034,343 |  4,137,372 |  1,104,000 |  826,372 |
| `execute_preflight_time_ms` |  56.25 |  225 |  69 |  47 |
| `execute_preflight_insn_mi/s` |  31.58 | -          |  33.66 |  27.84 |
| `trace_gen_time_ms   ` |  177.25 |  709 |  212 |  154 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  290 |  1,160 |  305 |  270 |
| `main_trace_commit_time_ms` |  52 |  208 |  57 |  49 |
| `generate_perm_trace_time_ms` |  34.75 |  139 |  60 |  22 |
| `perm_trace_commit_time_ms` |  64.73 |  258.91 |  72.09 |  54.60 |
| `quotient_poly_compute_time_ms` |  59.86 |  239.44 |  71.100 |  52.38 |
| `quotient_poly_commit_time_ms` |  15.48 |  61.94 |  17.65 |  12.76 |
| `pcs_opening_time_ms ` |  59.75 |  239 |  69 |  49 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 555 | 41 | 1 | 34 | 4,137,372 | 121.24 | 174 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 212 | 718 | 23,468,048 | 150,778,428 | 212 | 305 | 0 | 62.34 | 17.65 | 6 | 72.09 | 69 | 96 | 69 | 4 | 57 | 10,916,118 | 23 | 47 | 1,103,000 | 27.84 | 22 | 80 | 1 | 69 | 
| regex_program | 1 | 154 | 535 | 11,615,600 | 128,513,066 | 154 | 270 | 1 | 52.38 | 15.81 | 5 | 66.38 | 49 | 101 | 49 | 0 | 51 | 2,207,750 | 34 | 69 | 1,104,000 | 32.07 | 17 | 68 | 0 | 49 | 
| regex_program | 2 | 162 | 566 | 11,604,416 | 128,513,066 | 161 | 302 | 1 | 52.71 | 15.72 | 5 | 65.83 | 54 | 127 | 54 | 0 | 51 | 2,196,886 | 60 | 60 | 1,104,000 | 33.66 | 17 | 69 | 0 | 54 | 
| regex_program | 3 | 181 | 555 | 11,876,674 | 103,522,954 | 181 | 283 | 1 | 71.100 | 12.76 | 7 | 54.60 | 67 | 80 | 66 | 0 | 49 | 2,438,640 | 22 | 49 | 826,372 | 32.74 | 19 | 86 | 1 | 66 | 

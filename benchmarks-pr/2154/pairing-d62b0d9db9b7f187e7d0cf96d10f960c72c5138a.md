...
| `total_proof_time_ms ` |  730 |  1,460 |  835 |  625 |
...
| `execute_preflight_insn_mi/s` |  13.36 | -          |  17.63 |  9.08 |
| `trace_gen_time_ms   ` |  179 |  358 |  195 |  163 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  361.50 |  723 |  394 |  329 |
| `main_trace_commit_time_ms` |  62 |  124 |  70 |  54 |
| `generate_perm_trace_time_ms` |  49 |  98 |  51 |  47 |
| `perm_trace_commit_time_ms` |  76.74 |  153.48 |  89.33 |  64.15 |
| `quotient_poly_compute_time_ms` |  79.21 |  158.41 |  87.29 |  71.12 |
| `quotient_poly_commit_time_ms` |  16.45 |  32.91 |  18.61 |  14.30 |
| `pcs_opening_time_ms ` |  73.50 |  147 |  76 |  71 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 625 | 40 | 1 | 89 | 1,745,742 | 19.47 | 145 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 163 | 835 | 32,689,110 | 172,558,444 | 163 | 394 | 0 | 87.29 | 18.61 | 6 | 89.33 | 76 | 140 | 76 | 1 | 70 | 16,059,916 | 47 | 130 | 1,157,000 | 9.08 | 26 | 106 | 1 | 75 | 
| pairing | 1 | 195 | 625 | 22,314,288 | 119,958,502 | 195 | 329 | 1 | 71.12 | 14.30 | 6 | 64.15 | 71 | 118 | 71 | 0 | 54 | 9,408,294 | 51 | 59 | 588,742 | 17.63 | 20 | 86 | 1 | 71 | 

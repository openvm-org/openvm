...
| `total_proof_time_ms ` |  733.50 |  1,467 |  841 |  626 |
...
| `execute_preflight_insn_mi/s` |  13.83 | -          |  18.49 |  9.18 |
| `trace_gen_time_ms   ` |  179 |  358 |  194 |  164 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  365 |  730 |  400 |  330 |
| `main_trace_commit_time_ms` |  63.50 |  127 |  74 |  53 |
| `generate_perm_trace_time_ms` |  46.50 |  93 |  48 |  45 |
| `perm_trace_commit_time_ms` |  77.26 |  154.51 |  89.64 |  64.88 |
| `quotient_poly_compute_time_ms` |  79.39 |  158.78 |  88.18 |  70.60 |
| `quotient_poly_commit_time_ms` |  16.70 |  33.41 |  18.56 |  14.85 |
| `pcs_opening_time_ms ` |  76.50 |  153 |  77 |  76 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 626 | 40 | 1 | 89 | 1,745,742 | 19.43 | 150 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 164 | 841 | 32,689,110 | 172,558,444 | 164 | 400 | 0 | 88.18 | 18.56 | 7 | 89.64 | 76 | 141 | 76 | 1 | 74 | 16,059,916 | 48 | 129 | 1,157,000 | 9.18 | 27 | 107 | 1 | 76 | 
| pairing | 1 | 194 | 626 | 22,314,288 | 119,958,502 | 194 | 330 | 1 | 70.60 | 14.85 | 6 | 64.88 | 77 | 113 | 77 | 0 | 53 | 9,408,294 | 45 | 61 | 588,742 | 18.49 | 21 | 86 | 1 | 77 | 

...
| `total_proof_time_ms ` |  732 |  1,464 |  839 |  625 |
...
| `execute_preflight_insn_mi/s` |  13.98 | -          |  18.69 |  9.27 |
| `trace_gen_time_ms   ` |  179 |  358 |  194 |  164 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  366.50 |  733 |  401 |  332 |
| `main_trace_commit_time_ms` |  64.50 |  129 |  75 |  54 |
| `generate_perm_trace_time_ms` |  50 |  100 |  51 |  49 |
| `perm_trace_commit_time_ms` |  77.30 |  154.61 |  89.49 |  65.12 |
| `quotient_poly_compute_time_ms` |  79.50 |  159.01 |  87.88 |  71.13 |
| `quotient_poly_commit_time_ms` |  16.20 |  32.40 |  17.67 |  14.73 |
| `pcs_opening_time_ms ` |  74 |  148 |  77 |  71 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 625 | 65 | 1 | 90 | 1,745,742 | 19.19 | 169 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 164 | 839 | 32,689,110 | 172,558,444 | 164 | 401 | 0 | 87.88 | 17.67 | 7 | 89.49 | 77 | 142 | 77 | 1 | 75 | 16,059,916 | 49 | 128 | 1,157,000 | 9.27 | 26 | 106 | 1 | 77 | 
| pairing | 1 | 194 | 625 | 22,314,288 | 119,958,502 | 194 | 332 | 1 | 71.13 | 14.73 | 6 | 65.12 | 71 | 119 | 71 | 0 | 54 | 9,408,294 | 51 | 58 | 588,742 | 18.69 | 20 | 86 | 1 | 71 | 

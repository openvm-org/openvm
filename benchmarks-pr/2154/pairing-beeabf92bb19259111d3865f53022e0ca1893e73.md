...
| `total_proof_time_ms ` |  711.50 |  1,423 |  827 |  596 |
...
| `execute_preflight_insn_mi/s` |  13.12 | -          |  17.32 |  8.93 |
| `trace_gen_time_ms   ` |  176.50 |  353 |  192 |  161 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  341.50 |  683 |  384 |  299 |
| `main_trace_commit_time_ms` |  61.50 |  123 |  70 |  53 |
| `generate_perm_trace_time_ms` |  38.50 |  77 |  41 |  36 |
| `perm_trace_commit_time_ms` |  76.85 |  153.71 |  89.53 |  64.18 |
| `quotient_poly_compute_time_ms` |  79.18 |  158.35 |  87.92 |  70.44 |
| `quotient_poly_commit_time_ms` |  16.51 |  33.03 |  18.75 |  14.28 |
| `pcs_opening_time_ms ` |  63.50 |  127 |  70 |  57 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 596 | 40 | 1 | 89 | 1,745,742 | 19.40 | 145 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 161 | 827 | 32,689,110 | 172,558,444 | 161 | 384 | 0 | 87.92 | 18.75 | 7 | 89.53 | 70 | 134 | 70 | 1 | 70 | 16,059,916 | 41 | 133 | 1,157,000 | 8.93 | 26 | 107 | 1 | 70 | 
| pairing | 1 | 192 | 596 | 22,314,288 | 119,958,502 | 192 | 299 | 1 | 70.44 | 14.28 | 6 | 64.18 | 57 | 103 | 57 | 0 | 53 | 9,408,294 | 36 | 63 | 588,742 | 17.32 | 20 | 85 | 1 | 57 | 

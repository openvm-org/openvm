...
| `total_proof_time_ms ` |  585.50 |  2,342 |  701 |  518 |
...
| `execute_metered_insn_mi/s` |  119.98 | -          |  119.98 |  119.98 |
| `execute_preflight_insns` |  1,034,343 |  4,137,372 |  1,104,000 |  826,372 |
| `execute_preflight_time_ms` |  55 |  220 |  68 |  46 |
| `execute_preflight_insn_mi/s` |  30.55 | -          |  31.71 |  27.76 |
| `trace_gen_time_ms   ` |  175.75 |  703 |  210 |  152 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  286.25 |  1,145 |  317 |  256 |
| `main_trace_commit_time_ms` |  50.75 |  203 |  56 |  48 |
| `generate_perm_trace_time_ms` |  40 |  160 |  80 |  21 |
| `perm_trace_commit_time_ms` |  63.89 |  255.55 |  73.10 |  54.78 |
| `quotient_poly_compute_time_ms` |  57.26 |  229.04 |  71.13 |  45.53 |
| `quotient_poly_commit_time_ms` |  14.90 |  59.59 |  17.92 |  12.44 |
| `pcs_opening_time_ms ` |  56.25 |  225 |  63 |  48 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 544 | 41 | 1 | 34 | 4,137,372 | 119.98 | 167 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 210 | 701 | 23,468,048 | 150,778,428 | 210 | 296 | 0 | 59.87 | 17.92 | 5 | 73.10 | 60 | 100 | 60 | 4 | 56 | 10,916,118 | 26 | 47 | 1,103,000 | 27.76 | 22 | 78 | 1 | 60 | 
| regex_program | 1 | 152 | 518 | 11,615,600 | 128,513,066 | 152 | 256 | 1 | 45.53 | 14.84 | 5 | 63.63 | 48 | 97 | 48 | 0 | 49 | 2,207,750 | 33 | 68 | 1,104,000 | 31.38 | 16 | 60 | 0 | 48 | 
| regex_program | 2 | 161 | 579 | 11,604,416 | 128,513,066 | 161 | 317 | 1 | 52.52 | 14.39 | 5 | 64.04 | 54 | 144 | 54 | 0 | 50 | 2,196,886 | 80 | 59 | 1,104,000 | 31.71 | 16 | 67 | 0 | 54 | 
| regex_program | 3 | 180 | 544 | 11,876,674 | 103,522,954 | 180 | 276 | 0 | 71.13 | 12.44 | 5 | 54.78 | 63 | 79 | 63 | 0 | 48 | 2,438,640 | 21 | 46 | 826,372 | 31.34 | 18 | 84 | 1 | 63 | 

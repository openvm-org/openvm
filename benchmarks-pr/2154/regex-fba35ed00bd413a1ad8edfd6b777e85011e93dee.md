...
| `total_proof_time_ms ` |  597.75 |  2,391 |  705 |  537 |
...
| `execute_metered_insn_mi/s` |  118.79 | -          |  118.79 |  118.79 |
| `execute_preflight_insns` |  1,034,343 |  4,137,372 |  1,104,000 |  826,372 |
| `execute_preflight_time_ms` |  54.50 |  218 |  66 |  46 |
| `execute_preflight_insn_mi/s` |  30.40 | -          |  31.48 |  27.41 |
| `trace_gen_time_ms   ` |  181.75 |  727 |  216 |  158 |
| `memory_finalize_time_ms` |  0.75 |  3 |  3 |  0 |
| `stark_prove_excluding_trace_time_ms` |  293.25 |  1,173 |  332 |  270 |
| `main_trace_commit_time_ms` |  52 |  208 |  57 |  50 |
| `generate_perm_trace_time_ms` |  40.50 |  162 |  83 |  21 |
| `perm_trace_commit_time_ms` |  64.93 |  259.74 |  73.32 |  55.37 |
| `quotient_poly_compute_time_ms` |  59.80 |  239.19 |  71.55 |  53.67 |
| `quotient_poly_commit_time_ms` |  14.95 |  59.81 |  16.91 |  12.70 |
| `pcs_opening_time_ms ` |  57.75 |  231 |  63 |  48 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 550 | 41 | 1 | 34 | 4,137,372 | 118.79 | 166 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 216 | 705 | 23,468,048 | 150,778,428 | 216 | 295 | 0 | 59.57 | 16.91 | 5 | 73.32 | 60 | 100 | 60 | 3 | 57 | 10,916,118 | 25 | 47 | 1,103,000 | 27.41 | 22 | 77 | 1 | 60 | 
| regex_program | 1 | 158 | 537 | 11,615,600 | 128,513,066 | 158 | 270 | 1 | 54.41 | 15.57 | 5 | 66.59 | 48 | 100 | 48 | 0 | 50 | 2,207,750 | 33 | 66 | 1,104,000 | 31.48 | 16 | 70 | 0 | 48 | 
| regex_program | 2 | 166 | 599 | 11,604,416 | 128,513,066 | 166 | 332 | 1 | 53.67 | 14.63 | 5 | 64.46 | 63 | 148 | 63 | 0 | 51 | 2,196,886 | 83 | 59 | 1,104,000 | 31.30 | 16 | 68 | 0 | 63 | 
| regex_program | 3 | 187 | 550 | 11,876,674 | 103,522,954 | 186 | 276 | 0 | 71.55 | 12.70 | 5 | 55.37 | 60 | 80 | 60 | 0 | 50 | 2,438,640 | 21 | 46 | 826,372 | 31.39 | 18 | 85 | 1 | 60 | 

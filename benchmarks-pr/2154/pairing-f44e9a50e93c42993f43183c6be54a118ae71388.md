...
| `total_proof_time_ms ` |  724.50 |  1,449 |  822 |  627 |
...
| `execute_preflight_insn_mi/s` |  13.86 | -          |  18.41 |  9.31 |
| `trace_gen_time_ms   ` |  181 |  362 |  195 |  167 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  355.50 |  711 |  381 |  330 |
| `main_trace_commit_time_ms` |  61.50 |  123 |  70 |  53 |
| `generate_perm_trace_time_ms` |  49 |  98 |  51 |  47 |
| `perm_trace_commit_time_ms` |  74.53 |  149.06 |  84.10 |  64.96 |
| `quotient_poly_compute_time_ms` |  78.28 |  156.55 |  85.73 |  70.82 |
| `quotient_poly_commit_time_ms` |  16.78 |  33.56 |  19.35 |  14.21 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 627 | 40 | 1 | 89 | 1,745,742 | 19.41 | 146 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 167 | 822 | 32,689,110 | 172,558,444 | 167 | 381 | 0 | 85.73 | 19.35 | 7 | 84.10 | 69 | 134 | 69 | 1 | 70 | 16,059,916 | 47 | 128 | 1,157,000 | 9.31 | 27 | 105 | 1 | 69 | 
| pairing | 1 | 195 | 627 | 22,314,288 | 119,958,502 | 195 | 330 | 1 | 70.82 | 14.21 | 6 | 64.96 | 71 | 119 | 71 | 0 | 53 | 9,408,294 | 51 | 60 | 588,742 | 18.41 | 20 | 85 | 1 | 71 | 

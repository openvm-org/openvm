...
|:---|---:|---:|
| Total |  2.41 |  0.73 |
| regex_program |  2.38 |  0.70 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  594.50 |  2,378 |  696 |  529 |
...
| `execute_metered_insn_mi/s` |  120.29 | -          |  120.29 |  120.29 |
| `execute_preflight_insns` |  1,034,343 |  4,137,372 |  1,104,000 |  826,372 |
| `execute_preflight_time_ms` |  52.75 |  211 |  65 |  44 |
| `execute_preflight_insn_mi/s` |  32.13 | -          |  33.42 |  29.27 |
| `trace_gen_time_ms   ` |  179 |  716 |  213 |  156 |
| `memory_finalize_time_ms` |  0.75 |  3 |  3 |  0 |
| `stark_prove_excluding_trace_time_ms` |  294.75 |  1,179 |  344 |  267 |
| `main_trace_commit_time_ms` |  51.50 |  206 |  56 |  49 |
| `generate_perm_trace_time_ms` |  43 |  172 |  82 |  25 |
| `perm_trace_commit_time_ms` |  64.40 |  257.60 |  72.09 |  54.77 |
| `quotient_poly_compute_time_ms` |  58.42 |  233.69 |  70.85 |  51.42 |
| `quotient_poly_commit_time_ms` |  15.07 |  60.30 |  16.96 |  12.62 |
| `pcs_opening_time_ms ` |  58.75 |  235 |  77 |  48 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 546 | 41 | 1 | 34 | 4,137,372 | 120.29 | 168 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 213 | 696 | 23,468,048 | 150,778,428 | 213 | 291 | 0 | 58.25 | 16.96 | 5 | 72.09 | 60 | 98 | 60 | 3 | 56 | 10,916,118 | 25 | 44 | 1,103,000 | 29.27 | 21 | 75 | 1 | 60 | 
| regex_program | 1 | 156 | 529 | 11,615,600 | 128,513,066 | 156 | 267 | 1 | 51.42 | 15.48 | 5 | 65.71 | 48 | 99 | 48 | 0 | 51 | 2,207,750 | 33 | 65 | 1,104,000 | 32.91 | 17 | 67 | 0 | 48 | 
| regex_program | 2 | 164 | 607 | 11,604,416 | 128,513,066 | 164 | 344 | 1 | 53.17 | 15.24 | 5 | 65.03 | 77 | 147 | 77 | 0 | 49 | 2,196,886 | 82 | 57 | 1,104,000 | 33.42 | 17 | 68 | 0 | 77 | 
| regex_program | 3 | 183 | 546 | 11,876,674 | 103,522,954 | 183 | 277 | 0 | 70.85 | 12.62 | 5 | 54.77 | 50 | 90 | 50 | 0 | 50 | 2,438,640 | 32 | 45 | 826,372 | 32.93 | 18 | 84 | 1 | 50 | 

...
| `total_proof_time_ms ` |  729 |  1,458 |  852 |  606 |
...
| `execute_preflight_insn_mi/s` |  13.47 | -          |  17.81 |  9.12 |
| `trace_gen_time_ms   ` |  183 |  366 |  200 |  166 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  356.50 |  713 |  408 |  305 |
| `main_trace_commit_time_ms` |  64 |  128 |  72 |  56 |
| `generate_perm_trace_time_ms` |  40.50 |  81 |  48 |  33 |
| `perm_trace_commit_time_ms` |  78.69 |  157.38 |  90.63 |  66.75 |
| `quotient_poly_compute_time_ms` |  81.36 |  162.72 |  90.05 |  72.67 |
| `quotient_poly_commit_time_ms` |  16.43 |  32.86 |  17.93 |  14.93 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 606 | 40 | 1 | 90 | 1,745,742 | 19.31 | 145 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 166 | 852 | 32,689,110 | 172,558,444 | 166 | 408 | 0 | 90.05 | 17.93 | 7 | 90.63 | 84 | 142 | 84 | 1 | 72 | 16,059,916 | 48 | 130 | 1,157,000 | 9.12 | 27 | 108 | 1 | 84 | 
| pairing | 1 | 200 | 606 | 22,314,288 | 119,958,502 | 200 | 305 | 1 | 72.67 | 14.93 | 6 | 66.75 | 57 | 103 | 57 | 0 | 56 | 9,408,294 | 33 | 59 | 588,742 | 17.81 | 21 | 88 | 1 | 57 | 

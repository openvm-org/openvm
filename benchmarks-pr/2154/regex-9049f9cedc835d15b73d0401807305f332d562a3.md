...
| `total_proof_time_ms ` |  598.25 |  2,393 |  700 |  534 |
...
| `execute_preflight_insn_mi/s` |  30.32 | -          |  31.54 |  27.19 |
| `trace_gen_time_ms   ` |  179.25 |  717 |  213 |  156 |
| `memory_finalize_time_ms` |  0.75 |  3 |  3 |  0 |
| `stark_prove_excluding_trace_time_ms` |  295.25 |  1,181 |  334 |  269 |
| `main_trace_commit_time_ms` |  52 |  208 |  57 |  50 |
| `generate_perm_trace_time_ms` |  40.75 |  163 |  83 |  22 |
| `perm_trace_commit_time_ms` |  65.09 |  260.37 |  71.100 |  56.25 |
| `quotient_poly_compute_time_ms` |  58.33 |  233.31 |  69.63 |  51.99 |
| `quotient_poly_commit_time_ms` |  15.32 |  61.29 |  17.05 |  12.78 |
| `pcs_opening_time_ms ` |  60.50 |  242 |  70 |  48 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 559 | 40 | 1 | 35 | 4,137,372 | 117.13 | 167 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 213 | 700 | 23,468,048 | 150,778,428 | 213 | 292 | 0 | 59.01 | 17.05 | 5 | 71.100 | 60 | 97 | 60 | 3 | 57 | 10,916,118 | 24 | 47 | 1,103,000 | 27.19 | 21 | 76 | 1 | 60 | 
| regex_program | 1 | 156 | 534 | 11,615,600 | 128,513,066 | 156 | 269 | 1 | 51.99 | 15.51 | 5 | 65.84 | 48 | 100 | 48 | 0 | 51 | 2,207,750 | 34 | 68 | 1,104,000 | 31.30 | 17 | 68 | 0 | 48 | 
| regex_program | 2 | 164 | 600 | 11,604,416 | 128,513,066 | 164 | 334 | 1 | 52.68 | 15.96 | 5 | 66.28 | 64 | 150 | 64 | 0 | 50 | 2,196,886 | 83 | 60 | 1,104,000 | 31.54 | 17 | 69 | 0 | 64 | 
| regex_program | 3 | 184 | 559 | 11,876,674 | 103,522,954 | 184 | 286 | 0 | 69.63 | 12.78 | 5 | 56.25 | 70 | 81 | 70 | 0 | 50 | 2,438,640 | 22 | 47 | 826,372 | 31.24 | 18 | 83 | 1 | 70 | 

...
|:---|---:|---:|
| Total |  2.38 |  0.73 |
| regex_program |  2.35 |  0.69 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  587.75 |  2,351 |  694 |  527 |
...
| `execute_metered_insn_mi/s` |  122.05 | -          |  122.05 |  122.05 |
| `execute_preflight_insns` |  1,034,343 |  4,137,372 |  1,104,000 |  826,372 |
| `execute_preflight_time_ms` |  54 |  216 |  64 |  45 |
| `execute_preflight_insn_mi/s` |  31.53 | -          |  33.09 |  29.12 |
| `trace_gen_time_ms   ` |  178 |  712 |  212 |  156 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  288.25 |  1,153 |  320 |  266 |
| `main_trace_commit_time_ms` |  51.75 |  207 |  57 |  49 |
| `generate_perm_trace_time_ms` |  42 |  168 |  79 |  23 |
| `perm_trace_commit_time_ms` |  64.57 |  258.29 |  72.32 |  55.89 |
| `quotient_poly_compute_time_ms` |  58.36 |  233.44 |  68.98 |  52.48 |
| `quotient_poly_commit_time_ms` |  14.70 |  58.80 |  17.06 |  12.47 |
| `pcs_opening_time_ms ` |  53.25 |  213 |  60 |  48 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 547 | 40 | 1 | 33 | 4,137,372 | 122.05 | 169 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 212 | 694 | 23,468,048 | 150,778,428 | 212 | 291 | 0 | 59.05 | 17.06 | 6 | 72.32 | 60 | 96 | 60 | 4 | 57 | 10,916,118 | 23 | 45 | 1,103,000 | 29.12 | 21 | 76 | 1 | 60 | 
| regex_program | 1 | 156 | 527 | 11,615,600 | 128,513,066 | 156 | 266 | 1 | 52.48 | 14.44 | 5 | 64.92 | 48 | 99 | 48 | 0 | 50 | 2,207,750 | 34 | 64 | 1,104,000 | 33.09 | 16 | 67 | 0 | 48 | 
| regex_program | 2 | 161 | 583 | 11,604,416 | 128,513,066 | 161 | 320 | 1 | 52.94 | 14.83 | 5 | 65.16 | 54 | 145 | 54 | 0 | 51 | 2,196,886 | 79 | 61 | 1,104,000 | 32.79 | 16 | 68 | 0 | 54 | 
| regex_program | 3 | 183 | 547 | 11,876,674 | 103,522,954 | 183 | 276 | 0 | 68.98 | 12.47 | 6 | 55.89 | 51 | 92 | 51 | 0 | 49 | 2,438,640 | 32 | 46 | 826,372 | 31.11 | 18 | 82 | 1 | 51 | 

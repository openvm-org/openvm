...
|:---|---:|---:|
| Total |  1.06 |  0.59 |
| fibonacci_program |  1.05 |  0.58 |


| fibonacci_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  527.50 |  1,055 |  580 |  475 |
...
| `execute_metered_insn_mi/s` |  148.46 | -          |  148.46 |  148.46 |
| `execute_preflight_insns` |  750,104.50 |  1,500,209 |  873,000 |  627,209 |
| `execute_preflight_time_ms` |  31 |  62 |  35 |  27 |
| `execute_preflight_insn_mi/s` |  35.27 | -          |  37.05 |  33.49 |
| `trace_gen_time_ms   ` |  188 |  376 |  194 |  182 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  214 |  428 |  216 |  212 |
| `main_trace_commit_time_ms` |  30 |  60 |  32 |  28 |
| `generate_perm_trace_time_ms` |  14.50 |  29 |  16 |  13 |
| `perm_trace_commit_time_ms` |  41.36 |  82.72 |  43.76 |  38.96 |
| `quotient_poly_compute_time_ms` |  29.86 |  59.72 |  32.09 |  27.63 |
| `quotient_poly_commit_time_ms` |  12.30 |  24.60 |  12.73 |  11.87 |
| `pcs_opening_time_ms ` |  84 |  168 |  95 |  73 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 475 | 41 | 1 | 10 | 1,500,209 | 148.46 | 144 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 194 | 580 | 9,677,708 | 84,395,212 | 194 | 212 | 0 | 32.09 | 12.73 | 5 | 43.76 | 73 | 60 | 73 | 0 | 32 | 1,035,986 | 16 | 27 | 873,000 | 33.49 | 14 | 45 | 0 | 73 | 
| fibonacci_program | 1 | 182 | 475 | 9,708,170 | 74,305,770 | 182 | 216 | 1 | 27.63 | 11.87 | 4 | 38.96 | 95 | 52 | 95 | 0 | 28 | 1,064,416 | 13 | 35 | 627,209 | 37.05 | 11 | 39 | 0 | 95 | 

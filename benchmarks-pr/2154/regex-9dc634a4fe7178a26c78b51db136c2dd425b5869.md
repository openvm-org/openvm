...
|:---|---:|---:|
| Total |  2.42 |  0.74 |
| regex_program |  2.39 |  0.70 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  597.25 |  2,389 |  702 |  537 |
...
| `execute_metered_insn_mi/s` |  119.55 | -          |  119.55 |  119.55 |
| `execute_preflight_insns` |  1,034,343 |  4,137,372 |  1,104,000 |  826,372 |
| `execute_preflight_time_ms` |  54.75 |  219 |  68 |  46 |
| `execute_preflight_insn_mi/s` |  31.07 | -          |  32.50 |  27.92 |
| `trace_gen_time_ms   ` |  182.25 |  729 |  217 |  158 |
| `memory_finalize_time_ms` |  0.75 |  3 |  3 |  0 |
| `stark_prove_excluding_trace_time_ms` |  291.75 |  1,167 |  309 |  271 |
| `main_trace_commit_time_ms` |  52.25 |  209 |  58 |  50 |
| `generate_perm_trace_time_ms` |  35.25 |  141 |  60 |  22 |
| `perm_trace_commit_time_ms` |  65.19 |  260.74 |  71.65 |  56.85 |
| `quotient_poly_compute_time_ms` |  58.72 |  234.89 |  70.44 |  53.29 |
| `quotient_poly_commit_time_ms` |  15.14 |  60.56 |  18.17 |  12.71 |
| `pcs_opening_time_ms ` |  61.75 |  247 |  90 |  48 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 583 | 65 | 1 | 34 | 4,137,372 | 119.55 | 195 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 217 | 702 | 23,468,048 | 150,778,428 | 217 | 288 | 0 | 57.23 | 18.17 | 5 | 71.65 | 56 | 97 | 56 | 3 | 58 | 10,916,118 | 25 | 46 | 1,103,000 | 27.92 | 22 | 76 | 1 | 56 | 
| regex_program | 1 | 158 | 537 | 11,615,600 | 128,513,066 | 158 | 271 | 1 | 53.93 | 15.05 | 5 | 67.13 | 48 | 101 | 48 | 0 | 50 | 2,207,750 | 34 | 68 | 1,104,000 | 31.93 | 16 | 69 | 0 | 48 | 
| regex_program | 2 | 168 | 567 | 11,604,416 | 128,513,066 | 168 | 299 | 1 | 53.29 | 14.63 | 5 | 65.12 | 53 | 126 | 53 | 0 | 50 | 2,196,886 | 60 | 59 | 1,104,000 | 32.50 | 16 | 68 | 0 | 53 | 
| regex_program | 3 | 186 | 583 | 11,876,674 | 103,522,954 | 186 | 309 | 0 | 70.44 | 12.71 | 5 | 56.85 | 90 | 82 | 90 | 0 | 51 | 2,438,640 | 22 | 46 | 826,372 | 31.94 | 19 | 84 | 1 | 90 | 

...
|:---|---:|---:|
| Total |  7.65 |  4.91 |
| regex_program |  7.62 |  4.88 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  3,808 |  7,616 |  4,880 |  2,736 |
...
| `execute_preflight_insn_mi/s` |  28.76 | -          |  31.20 |  26.33 |
| `trace_gen_time_ms   ` |  391.50 |  783 |  501 |  282 |
| `memory_finalize_time_ms` |  8 |  16 |  13 |  3 |
| `stark_prove_excluding_trace_time_ms` |  3,097.50 |  6,195 |  4,041 |  2,154 |
| `main_trace_commit_time_ms` |  631.50 |  1,263 |  849 |  414 |
| `generate_perm_trace_time_ms` |  223.50 |  447 |  301 |  146 |
| `perm_trace_commit_time_ms` |  651 |  1,302 |  852 |  450 |
| `quotient_poly_compute_time_ms` |  317.50 |  635 |  431 |  204 |
| `quotient_poly_commit_time_ms` |  302.50 |  605 |  398 |  207 |
| `pcs_opening_time_ms ` |  964 |  1,928 |  1,205 |  723 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2,736 | 6 | 1 | 31 | 4,108,597 | 130.95 | 45 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 501 | 4,880 | 211,758,557 | 373,183,036 | 501 | 4,041 | 0 | 431 | 398 | 852 | 1,205 | 8 | 13 | 849 | 91,281,687 | 301 | 100 | 2,211,000 | 26.33 | 
| regex_program | 1 | 282 | 2,736 | 174,326,267 | 196,838,026 | 282 | 2,154 | 53 | 204 | 207 | 450 | 723 | 8 | 3 | 414 | 73,453,305 | 146 | 85 | 1,897,597 | 31.20 | 

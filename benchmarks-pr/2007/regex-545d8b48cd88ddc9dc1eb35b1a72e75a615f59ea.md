...
|:---|---:|---:|
| Total |  7.60 |  4.87 |
| regex_program |  7.57 |  4.84 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  3,783 |  7,566 |  4,843 |  2,723 |
...
| `execute_preflight_insn_mi/s` |  28.54 | -          |  30.89 |  26.19 |
| `trace_gen_time_ms   ` |  386 |  772 |  493 |  279 |
| `memory_finalize_time_ms` |  8.50 |  17 |  14 |  3 |
| `stark_prove_excluding_trace_time_ms` |  3,074.50 |  6,149 |  4,006 |  2,143 |
| `main_trace_commit_time_ms` |  624.50 |  1,249 |  838 |  411 |
| `generate_perm_trace_time_ms` |  225 |  450 |  302 |  148 |
| `perm_trace_commit_time_ms` |  647 |  1,294 |  847 |  447 |
| `quotient_poly_compute_time_ms` |  314 |  628 |  426 |  202 |
| `quotient_poly_commit_time_ms` |  300.50 |  601 |  397 |  204 |
| `pcs_opening_time_ms ` |  955 |  1,910 |  1,191 |  719 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2,723 | 6 | 1 | 31 | 4,108,597 | 129.73 | 45 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 493 | 4,843 | 211,758,557 | 373,183,036 | 493 | 4,006 | 0 | 426 | 397 | 847 | 1,191 | 8 | 14 | 838 | 91,281,687 | 302 | 104 | 2,211,000 | 26.19 | 
| regex_program | 1 | 279 | 2,723 | 174,326,267 | 196,838,026 | 279 | 2,143 | 52 | 202 | 204 | 447 | 719 | 6 | 3 | 411 | 73,453,305 | 148 | 86 | 1,897,597 | 30.89 | 

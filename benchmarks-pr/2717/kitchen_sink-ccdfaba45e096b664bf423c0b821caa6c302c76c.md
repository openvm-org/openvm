...
| `total_proof_time_ms ` |  1,054.50 |  2,109 |  1,318 |  791 |
...
| `execute_preflight_time_ms` |  105.50 |  211 |  144 |  67 |
| `execute_preflight_insn_mi/s` |  33.100 | -          |  35.06 |  32.93 |
| `trace_gen_time_ms   ` |  25.50 |  51 |  34 |  17 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  808.50 |  1,617 |  1,028 |  589 |
| `prover.main_trace_commit_time_ms` |  227.50 |  455 |  306 |  149 |
| `prover.rap_constraints_time_ms` |  516.50 |  1,033 |  644 |  389 |
| `prover.openings_time_ms` |  63 |  126 |  77 |  49 |
| `prover.rap_constraints.logup_gkr_time_ms` |  150.50 |  301 |  165 |  136 |
| `prover.rap_constraints.round0_time_ms` |  262.50 |  525 |  348 |  177 |
...
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  35 |  70 |  48 |  22 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/ccdfaba45e096b664bf423c0b821caa6c302c76c/kitchen_sink-ccdfaba45e096b664bf423c0b821caa6c302c76c.memory.svg)
...
| app_proof |  |  |  |  |  | 791 |  |  | 34 | 2,579,903 | 74.49 | 0 | 2,149 |  | 
...
| leaf | 0 | 117 | 442 | 117 | 28 | 11 | 20 | 5 | 5 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 53,472,003 | 139 | 40 | 0 | 4 | 65 | 20 | 20 | 29 | 15 | 0 | 32 | 8 | 23 | 1 | 21 | 41 | 65 | 0 | 1 | 15 | 0 | 0 | 
...
| leaf | 0 | prover | 428,317,568 | 324 | 131 | 0 | 10 | 146 | 48 | 47 | 37 | 60 | 0 | 45 | 12 | 32 | 7 | 25 | 132 | 146 | 0 | 2 | 59 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 787,664,364 | 1,028 | 305 | 0 | 174 | 644 | 348 | 347 | 129 | 165 | 65 | 77 | 12 | 64 | 16 | 48 | 306 | 644 | 0 | 1 | 99 | 0 | 0 | 
| app_proof | prover | 1 | 700,866,292 | 589 | 149 | 0 | 23 | 389 | 177 | 177 | 75 | 136 | 74 | 49 | 12 | 37 | 14 | 22 | 149 | 389 | 0 | 1 | 61 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 34 | 1,318 | 34 | 188 | 0 | 3 | 67 | 1,540,000 | 32.93 | 
| app_proof | 1 | 17 | 791 | 17 | 40 | 0 | 1 | 144 | 1,039,903 | 35.06 | 

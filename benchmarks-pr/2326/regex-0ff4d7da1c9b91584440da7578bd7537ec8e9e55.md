...
|:---|---:|---:|---:|
| Total |  2.43 |  0.80 | 0.80 |
| regex_program |  2.43 |  0.80 |  0.80 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  597.50 |  2,390 |  760 |  535 |
...
| `execute_metered_insn_mi/s` |  111.47 | -          |  111.47 |  111.47 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  53.25 |  213 |  65 |  45 |
| `execute_preflight_insn_mi/s` |  31.17 | -          |  32.17 |  28.52 |
| `trace_gen_time_ms   ` |  178.75 |  715 |  212 |  156 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  291.75 |  1,167 |  333 |  264 |
| `main_trace_commit_time_ms` |  51.25 |  205 |  57 |  49 |
| `generate_perm_trace_time_ms` |  24.75 |  99 |  29 |  20 |
| `perm_trace_commit_time_ms` |  64.55 |  258.18 |  71.50 |  54.23 |
| `quotient_poly_compute_time_ms` |  60.51 |  242.02 |  71.55 |  53.78 |
| `quotient_poly_commit_time_ms` |  15.59 |  62.36 |  17.93 |  13.47 |
| `pcs_opening_time_ms ` |  71.75 |  287 |  92 |  51 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 535 | 1 | 37 | 4,137,502 | 111.47 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 212 | 760 | 23,446,148 | 150,778,428 | 212 | 333 | 0 | 62.30 | 17.93 | 5 | 71.50 | 92 | 102 | 92 | 4 | 57 | 10,899,170 | 29 | 45 | 1,103,000 | 28.52 | 21 | 80 | 1 | 92 | 
| regex_program | 1 | 156 | 543 | 11,598,276 | 128,513,066 | 156 | 281 | 1 | 53.78 | 15.78 | 4 | 65.68 | 72 | 88 | 72 | 0 | 49 | 2,196,106 | 21 | 65 | 1,104,000 | 32.17 | 17 | 70 | 0 | 72 | 
| regex_program | 2 | 163 | 552 | 11,579,064 | 128,513,066 | 163 | 289 | 1 | 54.40 | 15.17 | 4 | 66.77 | 72 | 96 | 72 | 0 | 50 | 2,177,334 | 29 | 58 | 1,104,000 | 32.09 | 16 | 70 | 0 | 72 | 
| regex_program | 3 | 184 | 535 | 11,853,872 | 103,456,394 | 184 | 264 | 0 | 71.55 | 13.47 | 5 | 54.23 | 51 | 77 | 50 | 0 | 49 | 2,422,606 | 20 | 45 | 826,502 | 31.91 | 18 | 86 | 1 | 50 | 

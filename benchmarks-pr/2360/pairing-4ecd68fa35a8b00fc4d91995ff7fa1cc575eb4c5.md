...
| `total_proof_time_ms ` |  712 |  1,424 |  822 |  602 |
| `execute_metered_time_ms` |  67 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  25.97 | -          |  25.97 |  25.97 |
| `execute_preflight_insns` |  872,878.50 |  1,745,757 |  1,151,000 |  594,757 |
| `execute_preflight_time_ms` |  83.50 |  167 |  120 |  47 |
| `execute_preflight_insn_mi/s` |  14.81 | -          |  18.43 |  11.18 |
| `trace_gen_time_ms   ` |  177.50 |  355 |  198 |  157 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  346 |  692 |  377 |  315 |
| `main_trace_commit_time_ms` |  63 |  126 |  72 |  54 |
| `generate_perm_trace_time_ms` |  39.50 |  79 |  44 |  35 |
| `perm_trace_commit_time_ms` |  74.56 |  149.11 |  86.77 |  62.35 |
| `quotient_poly_compute_time_ms` |  81.51 |  163.02 |  89.94 |  73.08 |
| `quotient_poly_commit_time_ms` |  17.32 |  34.64 |  19.18 |  15.47 |
| `pcs_opening_time_ms ` |  65 |  130 |  69 |  61 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 602 | 1 | 67 | 1,745,757 | 25.97 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 157 | 822 | 172,558,444 | 157 | 377 | 0 | 89.94 | 19.18 | 6 | 86.77 | 69 | 125 | 68 | 1 | 72 | 35 | 120 | 1,151,000 | 11.18 | 26 | 109 | 1 | 68 | 
| pairing | 1 | 198 | 602 | 119,958,502 | 198 | 315 | 1 | 73.08 | 15.47 | 6 | 62.35 | 61 | 110 | 61 | 0 | 54 | 44 | 47 | 594,757 | 18.43 | 21 | 89 | 1 | 61 | 

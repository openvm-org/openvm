...
| `total_proof_time_ms ` |  510 |  1,020 |  572 |  448 |
| `execute_metered_time_ms` |  9 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  158.72 | -          |  158.72 |  158.72 |
| `execute_preflight_insns` |  750,132.50 |  1,500,265 |  873,000 |  627,265 |
| `execute_preflight_time_ms` |  26.50 |  53 |  32 |  21 |
| `execute_preflight_insn_mi/s` |  39.35 | -          |  39.46 |  39.24 |
| `trace_gen_time_ms   ` |  193 |  386 |  198 |  188 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  185.50 |  371 |  187 |  184 |
| `main_trace_commit_time_ms` |  30.50 |  61 |  33 |  28 |
| `generate_perm_trace_time_ms` |  20.50 |  41 |  28 |  13 |
| `perm_trace_commit_time_ms` |  41.21 |  82.42 |  44.72 |  37.71 |
| `quotient_poly_compute_time_ms` |  32.37 |  64.73 |  33.89 |  30.85 |
| `quotient_poly_commit_time_ms` |  12.87 |  25.74 |  13.51 |  12.22 |
| `pcs_opening_time_ms ` |  45.50 |  91 |  48 |  43 |
...
| --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 448 | 1 | 9 | 1,500,265 | 158.72 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 188 | 572 | 84,399,632 | 188 | 184 | 0 | 33.89 | 13.51 | 4 | 44.72 | 43 | 59 | 43 | 0 | 33 | 13 | 32 | 873,000 | 39.24 | 14 | 47 | 0 | 43 | 
| fibonacci_program | 1 | 198 | 448 | 74,305,770 | 198 | 187 | 1 | 30.85 | 12.22 | 4 | 37.71 | 48 | 66 | 48 | 0 | 28 | 28 | 21 | 627,265 | 39.46 | 11 | 43 | 0 | 48 | 

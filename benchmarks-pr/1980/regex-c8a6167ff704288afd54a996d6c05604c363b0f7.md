...
| `total_proof_time_ms ` |  3,813 |  7,626 |  4,903 |  2,723 |
...
| `execute_metered_insn_mi/s` |  123.85 | -          |  123.85 |  123.85 |
| `execute_preflight_insns` |  2,054,298.50 |  4,108,597 |  2,211,000 |  1,897,597 |
| `execute_preflight_time_ms` |  93 |  186 |  100 |  86 |
| `execute_preflight_insn_mi/s` |  28.80 | -          |  31.37 |  26.23 |
| `trace_gen_time_ms   ` |  396 |  792 |  511 |  281 |
| `memory_finalize_time_ms` |  7.50 |  15 |  13 |  2 |
| `stark_prove_excluding_trace_time_ms` |  3,087 |  6,174 |  4,041 |  2,133 |
| `main_trace_commit_time_ms` |  614.50 |  1,229 |  838 |  391 |
| `generate_perm_trace_time_ms` |  235.50 |  471 |  307 |  164 |
| `perm_trace_commit_time_ms` |  652 |  1,304 |  853 |  451 |
| `quotient_poly_compute_time_ms` |  318 |  636 |  430 |  206 |
| `quotient_poly_commit_time_ms` |  302.50 |  605 |  400 |  205 |
| `pcs_opening_time_ms ` |  957 |  1,914 |  1,207 |  707 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 1 | 2,723 | 6 | 1 | 33 | 4,108,597 | 123.85 | 45 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 511 | 4,903 | 211,758,557 | 373,183,036 | 511 | 4,041 | 0 | 430 | 400 | 853 | 1,207 | 7 | 13 | 838 | 91,281,687 | 307 | 100 | 2,211,000 | 26.23 | 
| regex_program | 1 | 281 | 2,723 | 174,326,267 | 196,838,026 | 281 | 2,133 | 53 | 206 | 205 | 451 | 707 | 6 | 2 | 391 | 73,453,305 | 164 | 86 | 1,897,597 | 31.37 | 

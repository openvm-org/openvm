...
|:---|---:|---:|
| Total |  7.85 |  5.05 |
| regex_program |  7.82 |  5.02 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  3,908 |  7,816 |  5,016 |  2,800 |
...
| `execute_metered_insn_mi/s` |  124.54 | -          |  124.54 |  124.54 |
| `execute_preflight_insns` |  2,054,298.50 |  4,108,597 |  2,211,000 |  1,897,597 |
| `execute_preflight_time_ms` |  95 |  190 |  103 |  87 |
| `execute_preflight_insn_mi/s` |  28.72 | -          |  31.18 |  26.27 |
| `trace_gen_time_ms   ` |  411 |  822 |  529 |  293 |
| `memory_finalize_time_ms` |  8 |  16 |  14 |  2 |
| `stark_prove_excluding_trace_time_ms` |  3,171 |  6,342 |  4,138 |  2,204 |
| `main_trace_commit_time_ms` |  637.50 |  1,275 |  841 |  434 |
| `generate_perm_trace_time_ms` |  231.50 |  463 |  313 |  150 |
| `perm_trace_commit_time_ms` |  665 |  1,330 |  853 |  477 |
| `quotient_poly_compute_time_ms` |  322.50 |  645 |  438 |  207 |
| `quotient_poly_commit_time_ms` |  307 |  614 |  408 |  206 |
| `pcs_opening_time_ms ` |  1,000.50 |  2,001 |  1,280 |  721 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 1 | 2,801 | 7 | 1 | 32 | 4,108,597 | 124.54 | 46 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 529 | 5,016 | 211,758,557 | 373,183,036 | 529 | 4,138 | 0 | 438 | 408 | 853 | 1,280 | 8 | 14 | 841 | 91,281,687 | 313 | 103 | 2,211,000 | 26.27 | 
| regex_program | 1 | 293 | 2,800 | 174,326,267 | 196,838,026 | 293 | 2,204 | 56 | 207 | 206 | 477 | 721 | 7 | 2 | 434 | 73,453,305 | 150 | 87 | 1,897,597 | 31.18 | 

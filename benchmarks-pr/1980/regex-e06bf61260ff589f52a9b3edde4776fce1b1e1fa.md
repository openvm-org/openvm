...
| `total_proof_time_ms ` |  3,817.50 |  7,635 |  4,882 |  2,753 |
...
| `execute_metered_insn_mi/s` |  125.34 | -          |  125.34 |  125.34 |
| `execute_preflight_insns` |  2,054,298.50 |  4,108,597 |  2,211,000 |  1,897,597 |
| `execute_preflight_time_ms` |  95 |  190 |  99 |  91 |
| `execute_preflight_insn_mi/s` |  28.71 | -          |  31.12 |  26.29 |
| `trace_gen_time_ms   ` |  397.50 |  795 |  512 |  283 |
| `memory_finalize_time_ms` |  7.50 |  15 |  13 |  2 |
| `stark_prove_excluding_trace_time_ms` |  3,093 |  6,186 |  4,027 |  2,159 |
| `main_trace_commit_time_ms` |  627.50 |  1,255 |  844 |  411 |
| `generate_perm_trace_time_ms` |  230.50 |  461 |  304 |  157 |
| `perm_trace_commit_time_ms` |  647.50 |  1,295 |  848 |  447 |
| `quotient_poly_compute_time_ms` |  328 |  656 |  436 |  220 |
| `quotient_poly_commit_time_ms` |  298.50 |  597 |  394 |  203 |
| `pcs_opening_time_ms ` |  953 |  1,906 |  1,194 |  712 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 1 | 2,753 | 6 | 1 | 32 | 4,108,597 | 125.34 | 45 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 512 | 4,882 | 211,758,557 | 373,183,036 | 512 | 4,027 | 0 | 436 | 394 | 848 | 1,194 | 8 | 13 | 844 | 91,281,687 | 304 | 99 | 2,211,000 | 26.29 | 
| regex_program | 1 | 283 | 2,753 | 174,326,267 | 196,838,026 | 283 | 2,159 | 53 | 220 | 203 | 447 | 712 | 6 | 2 | 411 | 73,453,305 | 157 | 91 | 1,897,597 | 31.12 | 

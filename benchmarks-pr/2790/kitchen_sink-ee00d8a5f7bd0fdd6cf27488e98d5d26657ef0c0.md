...
| `total_proof_time_ms ` |  950 |  1,900 |  1,222 |  678 |
| `execute_metered_time_ms` |  35 | -          | -          | -          |
| `execute_metered_insns` |  2,579,903 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  73.35 | -          |  73.35 |  73.35 |
| `execute_preflight_insns` |  1,289,951.50 |  2,579,903 |  1,540,000 |  1,039,903 |
| `execute_preflight_time_ms` |  98.50 |  197 |  135 |  62 |
| `execute_preflight_insn_mi/s` |  35.17 | -          |  35.71 |  34.63 |
| `trace_gen_time_ms   ` |  26 |  52 |  36 |  16 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  715.50 |  1,431 |  946 |  485 |
| `prover.main_trace_commit_time_ms` |  216 |  432 |  294 |  138 |
| `prover.rap_constraints_time_ms` |  450.50 |  901 |  596 |  305 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/ee00d8a5f7bd0fdd6cf27488e98d5d26657ef0c0/kitchen_sink-ee00d8a5f7bd0fdd6cf27488e98d5d26657ef0c0.memory.svg)
...
| app_proof |  |  |  |  |  | 678 |  |  | 35 | 2,579,903 | 73.35 | 0 | 1,940 |  | 
...
| leaf | 0 | 115 | 417 | 115 | 24 | 9 | 21 | 5 | 5 | 
...
| leaf | 0 | prover | 265,006,708 | 301 | 130 | 0 | 1 | 142 | 50 | 49 | 37 | 54 | 0 | 29 | 13 | 15 | 7 | 8 | 130 | 142 | 0 | 2 | 53 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 567,917,156 | 946 | 293 | 0 | 162 | 596 | 353 | 352 | 130 | 112 | 55 | 55 | 13 | 41 | 16 | 25 | 294 | 596 | 0 | 1 | 55 | 0 | 0 | 
| app_proof | prover | 1 | 537,266,124 | 485 | 138 | 0 | 2 | 305 | 174 | 173 | 75 | 55 | 0 | 41 | 13 | 27 | 14 | 13 | 138 | 305 | 0 | 1 | 54 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 36 | 1,222 | 36 | 176 | 0 | 3 | 62 | 1,540,000 | 34.63 | 
| app_proof | 1 | 16 | 678 | 16 | 40 | 0 | 1 | 135 | 1,039,903 | 35.71 | 

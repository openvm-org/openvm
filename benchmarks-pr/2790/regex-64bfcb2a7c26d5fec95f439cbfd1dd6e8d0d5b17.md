...
| `total_proof_time_ms ` |  749.50 |  1,499 |  811 |  688 |
| `compile_metered_time_ms` |  8 |  8 |  8 |  8 |
| `execute_metered_time_ms` |  32 | -          | -          | -          |
| `execute_metered_insns` |  4,137,067 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  125.49 | -          |  125.49 |  125.49 |
| `execute_preflight_insns` |  2,068,533.50 |  4,137,067 |  2,208,000 |  1,929,067 |
| `execute_preflight_time_ms` |  75 |  150 |  81 |  69 |
| `execute_preflight_insn_mi/s` |  39.39 | -          |  40.57 |  38.20 |
| `trace_gen_time_ms   ` |  147.50 |  295 |  151 |  144 |
| `memory_finalize_time_ms` |  1.50 |  3 |  3 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  426 |  852 |  426 |  426 |
| `prover.main_trace_commit_time_ms` |  94 |  188 |  99 |  89 |
| `prover.rap_constraints_time_ms` |  235.50 |  471 |  246 |  225 |
| `prover.openings_time_ms` |  95.50 |  191 |  101 |  90 |
| `prover.rap_constraints.logup_gkr_time_ms` |  137.50 |  275 |  141 |  134 |
| `prover.rap_constraints.round0_time_ms` |  70 |  140 |  85 |  55 |
...
| `prover.openings.whir_time_ms` |  76.50 |  153 |  81 |  72 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  425 |  425 |  425 |  425 |
| `execute_preflight_time_ms` |  5 |  5 |  5 |  5 |
| `trace_gen_time_ms   ` |  48 |  48 |  48 |  48 |
| `generate_blob_total_time_ms` |  2 |  2 |  2 |  2 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  376 |  376 |  376 |  376 |
| `prover.main_trace_commit_time_ms` |  126 |  126 |  126 |  126 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/64bfcb2a7c26d5fec95f439cbfd1dd6e8d0d5b17/regex-64bfcb2a7c26d5fec95f439cbfd1dd6e8d0d5b17.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 68 | 9 |  |  | 0 |  | 352 | 9 |  |  |  |  |  |  | 
| app_proof |  |  |  |  |  | 688 |  |  | 32 | 4,137,067 | 125.49 | 0 | 1,545 |  | 
| internal_for_leaf |  |  |  | 271 |  |  |  |  |  |  |  |  |  | 271 | 
| internal_recursive.0 |  |  |  | 178 |  |  |  |  |  |  |  |  |  | 178 | 
| internal_recursive.1 |  |  |  | 143 |  |  |  |  |  |  |  |  |  | 144 | 
| leaf |  |  | 425 |  |  |  |  |  |  |  |  |  |  | 425 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 15 | 271 | 15 | 4 | 0 | 2 | 1 | 1 | 
| internal_recursive.0 | 1 | 10 | 178 | 10 | 1 | 0 | 2 | 0 | 0 | 
| internal_recursive.1 | 1 | 9 | 143 | 8 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 48 | 425 | 48 | 13 | 2 | 5 | 1 | 1 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 27,256,635 | 255 | 81 | 0 | 0 | 97 | 32 | 31 | 45 | 19 | 0 | 75 | 64 | 11 | 2 | 8 | 81 | 97 | 0 | 3 | 18 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,767 | 167 | 46 | 0 | 0 | 67 | 25 | 24 | 28 | 13 | 0 | 53 | 45 | 8 | 1 | 6 | 47 | 67 | 0 | 2 | 12 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 134 | 31 | 0 | 0 | 61 | 23 | 22 | 24 | 13 | 0 | 41 | 33 | 7 | 1 | 5 | 32 | 61 | 0 | 2 | 13 | 0 | 0 | 
| leaf | 0 | prover | 79,959,796 | 376 | 126 | 0 | 0 | 134 | 54 | 53 | 37 | 42 | 0 | 115 | 100 | 15 | 6 | 8 | 126 | 134 | 0 | 6 | 41 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 123,384,338 | 426 | 99 | 0 | 0 | 225 | 55 | 55 | 28 | 141 | 0 | 101 | 81 | 19 | 10 | 9 | 99 | 225 | 0 | 3 | 138 | 0 | 0 | 
| app_proof | prover | 1 | 106,568,591 | 426 | 88 | 0 | 0 | 246 | 85 | 84 | 26 | 134 | 0 | 90 | 72 | 18 | 8 | 9 | 89 | 246 | 0 | 3 | 133 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 144 | 811 | 144 | 159 | 2,052,973,566 | 668,936,290 | 2,721,909,856 | 2,097,152 | 3 | 7 | 81 | 2,208,000 | 38.20 | 
| app_proof | 1 | 151 | 688 | 151 | 41 | 1,584,899,101 | 646,500,736 | 2,231,399,837 | 2,097,152 | 0 | 2 | 69 | 1,929,067 | 40.57 | 

...
| `total_proof_time_ms ` |  1,910.50 |  3,821 |  2,222 |  1,599 |
| `compile_metered_time_ms` |  3 |  3 |  3 |  3 |
| `execute_metered_time_ms` |  34 | -          | -          | -          |
| `execute_metered_insns` |  2,579,903 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  74.11 | -          |  74.11 |  74.11 |
| `execute_preflight_insns` |  1,289,951.50 |  2,579,903 |  1,540,000 |  1,039,903 |
| `execute_preflight_time_ms` |  98 |  196 |  133 |  63 |
| `execute_preflight_insn_mi/s` |  35.20 | -          |  36.31 |  34.08 |
| `trace_gen_time_ms   ` |  139 |  278 |  184 |  94 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,563 |  3,126 |  1,797 |  1,329 |
| `prover.main_trace_commit_time_ms` |  509 |  1,018 |  591 |  427 |
| `prover.rap_constraints_time_ms` |  924.50 |  1,849 |  1,070 |  779 |
| `prover.openings_time_ms` |  128.50 |  257 |  134 |  123 |
| `prover.rap_constraints.logup_gkr_time_ms` |  165.50 |  331 |  195 |  136 |
| `prover.rap_constraints.round0_time_ms` |  559 |  1,118 |  664 |  454 |
| `prover.rap_constraints.mle_rounds_time_ms` |  199 |  398 |  210 |  188 |
| `prover.openings.stacked_reduction_time_ms` |  94.50 |  189 |  104 |  85 |
| `prover.openings.stacked_reduction.round0_time_ms` |  50 |  100 |  51 |  49 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  44.50 |  89 |  53 |  36 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/2d21d6303559c989dc3f71617a725476f1ef328d/kitchen_sink-2d21d6303559c989dc3f71617a725476f1ef328d.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 70 | 9 |  |  | 0 |  | 374 | 9 |  |  |  |  |  |  | 
| app_proof |  |  |  |  |  | 1,599 |  |  | 34 | 2,579,903 | 74.11 | 0 | 3,861 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,577,979 | 256 | 116 | 0 | 0 | 106 | 35 | 34 | 51 | 20 | 0 | 32 | 19 | 13 | 3 | 9 | 116 | 106 | 0 | 2 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,767 | 142 | 46 | 0 | 0 | 66 | 24 | 24 | 28 | 13 | 0 | 29 | 21 | 8 | 1 | 6 | 46 | 66 | 0 | 2 | 12 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 122 | 31 | 0 | 0 | 62 | 24 | 23 | 24 | 13 | 0 | 27 | 20 | 7 | 1 | 5 | 32 | 62 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 265,003,892 | 822 | 398 | 0 | 1 | 347 | 134 | 133 | 76 | 136 | 0 | 75 | 35 | 39 | 21 | 18 | 399 | 347 | 0 | 6 | 134 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 567,917,156 | 1,797 | 591 | 0 | 184 | 1,070 | 664 | 663 | 210 | 195 | 55 | 134 | 30 | 104 | 51 | 53 | 591 | 1,070 | 0 | 3 | 138 | 0 | 0 | 
| app_proof | prover | 1 | 537,266,124 | 1,329 | 426 | 0 | 2 | 779 | 454 | 454 | 188 | 136 | 0 | 123 | 37 | 85 | 49 | 36 | 427 | 779 | 0 | 3 | 135 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 184 | 2,222 | 184 | 177 | 0 | 3 | 63 | 1,540,000 | 34.08 | 
| app_proof | 1 | 94 | 1,599 | 94 | 41 | 0 | 2 | 133 | 1,039,903 | 36.31 | 

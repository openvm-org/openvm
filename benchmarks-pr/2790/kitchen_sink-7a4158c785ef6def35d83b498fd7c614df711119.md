...
| `total_proof_time_ms ` |  1,938.50 |  3,877 |  2,259 |  1,618 |
...
| `execute_preflight_insn_mi/s` |  35.100 | -          |  37.14 |  34.86 |
| `trace_gen_time_ms   ` |  140.50 |  281 |  186 |  95 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,587.50 |  3,175 |  1,831 |  1,344 |
| `prover.main_trace_commit_time_ms` |  514.50 |  1,029 |  600 |  429 |
| `prover.rap_constraints_time_ms` |  942.50 |  1,885 |  1,092 |  793 |
| `prover.openings_time_ms` |  129.50 |  259 |  138 |  121 |
| `prover.rap_constraints.logup_gkr_time_ms` |  169.50 |  339 |  202 |  137 |
| `prover.rap_constraints.round0_time_ms` |  568.50 |  1,137 |  675 |  462 |
| `prover.rap_constraints.mle_rounds_time_ms` |  203 |  406 |  214 |  192 |
| `prover.openings.stacked_reduction_time_ms` |  94 |  188 |  103 |  85 |
| `prover.openings.stacked_reduction.round0_time_ms` |  49.50 |  99 |  51 |  48 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  43.50 |  87 |  51 |  36 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/7a4158c785ef6def35d83b498fd7c614df711119/kitchen_sink-7a4158c785ef6def35d83b498fd7c614df711119.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 72 | 9 |  |  | 0 |  | 378 | 9 |  |  |  |  |  |  | 
| app_proof |  |  |  |  |  | 1,618 |  |  | 34 | 2,579,903 | 74.19 | 0 | 3,916 |  | 
...
| leaf | 0 | 121 | 953 | 121 | 23 | 9 | 21 | 5 | 5 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,577,979 | 261 | 117 | 0 | 0 | 108 | 35 | 34 | 51 | 21 | 0 | 34 | 20 | 13 | 3 | 9 | 118 | 108 | 0 | 2 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,767 | 138 | 46 | 0 | 0 | 67 | 25 | 24 | 28 | 13 | 0 | 24 | 16 | 8 | 1 | 6 | 46 | 67 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 120 | 31 | 0 | 0 | 63 | 25 | 24 | 24 | 14 | 0 | 24 | 17 | 7 | 1 | 5 | 31 | 63 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 265,003,892 | 831 | 401 | 0 | 1 | 352 | 137 | 136 | 78 | 137 | 0 | 76 | 35 | 40 | 21 | 18 | 402 | 352 | 0 | 6 | 136 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 567,917,156 | 1,831 | 599 | 0 | 189 | 1,092 | 675 | 674 | 214 | 202 | 58 | 138 | 35 | 103 | 51 | 51 | 600 | 1,092 | 0 | 3 | 142 | 0 | 0 | 
| app_proof | prover | 1 | 537,266,124 | 1,344 | 429 | 0 | 2 | 793 | 462 | 462 | 192 | 137 | 0 | 121 | 36 | 85 | 48 | 36 | 429 | 793 | 0 | 4 | 136 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 186 | 2,259 | 186 | 177 | 0 | 4 | 63 | 1,540,000 | 34.86 | 
| app_proof | 1 | 95 | 1,618 | 95 | 41 | 0 | 2 | 136 | 1,039,903 | 37.14 | 

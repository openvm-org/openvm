...
|:---|---:|---:|---:|
| Total |  2.64 |  1.97 |  1.97 |
| app_proof |  1.92 |  1.25 |  1.25 |
| leaf |  0.41 |  0.41 |  0.41 |
...
| `total_proof_time_ms ` |  943.50 |  1,887 |  1,215 |  672 |
| `execute_metered_time_ms` |  35 | -          | -          | -          |
| `execute_metered_insns` |  2,579,903 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  73.48 | -          |  73.48 |  73.48 |
| `execute_preflight_insns` |  1,289,951.50 |  2,579,903 |  1,540,000 |  1,039,903 |
| `execute_preflight_time_ms` |  98 |  196 |  133 |  63 |
| `execute_preflight_insn_mi/s` |  35.48 | -          |  36.40 |  34.55 |
| `trace_gen_time_ms   ` |  26 |  52 |  36 |  16 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  710.50 |  1,421 |  939 |  482 |
| `prover.main_trace_commit_time_ms` |  213.50 |  427 |  290 |  137 |
| `prover.rap_constraints_time_ms` |  448.50 |  897 |  593 |  304 |
| `prover.openings_time_ms` |  47.50 |  95 |  55 |  40 |
| `prover.rap_constraints.logup_gkr_time_ms` |  82 |  164 |  111 |  53 |
| `prover.rap_constraints.round0_time_ms` |  263.50 |  527 |  352 |  175 |
| `prover.rap_constraints.mle_rounds_time_ms` |  101.50 |  203 |  129 |  74 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/60f2fbbe13806244c24e3b4395bef5bb036698ad/kitchen_sink-60f2fbbe13806244c24e3b4395bef5bb036698ad.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 70 | 3 |  |  | 0 |  | 330 | 3 |  |  |  |  |  |  | 
| app_proof |  |  |  |  |  | 672 |  |  | 35 | 2,579,903 | 73.48 | 0 | 1,927 |  | 
...
| leaf | 0 | 114 | 412 | 114 | 23 | 9 | 21 | 4 | 4 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,577,915 | 119 | 38 | 0 | 0 | 63 | 21 | 20 | 29 | 12 | 0 | 17 | 10 | 7 | 1 | 5 | 38 | 63 | 0 | 1 | 11 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,703 | 80 | 16 | 0 | 0 | 47 | 17 | 17 | 20 | 9 | 0 | 15 | 9 | 5 | 1 | 4 | 16 | 47 | 0 | 1 | 9 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 73 | 11 | 0 | 0 | 48 | 19 | 18 | 18 | 10 | 0 | 13 | 7 | 5 | 0 | 4 | 11 | 48 | 0 | 1 | 9 | 0 | 0 | 
| leaf | 0 | prover | 265,006,708 | 297 | 129 | 0 | 1 | 140 | 48 | 48 | 37 | 54 | 0 | 27 | 11 | 15 | 7 | 8 | 129 | 140 | 0 | 2 | 53 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 567,917,156 | 939 | 290 | 0 | 160 | 593 | 352 | 351 | 129 | 111 | 54 | 55 | 13 | 41 | 15 | 25 | 290 | 593 | 0 | 1 | 55 | 0 | 0 | 
| app_proof | prover | 1 | 537,266,124 | 482 | 136 | 0 | 1 | 304 | 175 | 175 | 74 | 53 | 0 | 40 | 12 | 27 | 14 | 13 | 137 | 304 | 0 | 1 | 52 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 36 | 1,215 | 36 | 175 | 0 | 3 | 63 | 1,540,000 | 34.55 | 
| app_proof | 1 | 16 | 672 | 16 | 40 | 0 | 1 | 133 | 1,039,903 | 36.40 | 

...
|:---|---:|---:|---:|
| Total |  18.83 |  5.33 |  5.33 |
| app_proof |  15.76 |  3.03 |  3.03 |
| leaf |  2.21 |  1.44 |  1.44 |
...
| `total_proof_time_ms ` |  2,620.17 |  15,721 |  2,991 |  2,528 |
| `execute_metered_time_ms` |  36 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  33.51 | -          |  33.51 |  33.51 |
| `execute_preflight_insns` |  205,869.67 |  1,235,218 |  207,000 |  200,218 |
| `execute_preflight_time_ms` |  177.33 |  1,064 |  264 |  15 |
| `execute_preflight_insn_mi/s` |  19.21 | -          |  19.34 |  18.97 |
| `trace_gen_time_ms   ` |  389.67 |  2,338 |  543 |  351 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,990 |  11,940 |  2,262 |  1,929 |
| `prover.main_trace_commit_time_ms` |  693.17 |  4,159 |  855 |  660 |
| `prover.rap_constraints_time_ms` |  1,112.67 |  6,676 |  1,224 |  1,085 |
| `prover.openings_time_ms` |  183.17 |  1,099 |  190 |  178 |
| `prover.rap_constraints.logup_gkr_time_ms` |  275.67 |  1,654 |  384 |  253 |
| `prover.rap_constraints.round0_time_ms` |  520.67 |  3,124 |  524 |  516 |
| `prover.rap_constraints.mle_rounds_time_ms` |  315.67 |  1,894 |  318 |  314 |
| `prover.openings.stacked_reduction_time_ms` |  141 |  846 |  142 |  139 |
| `prover.openings.stacked_reduction.round0_time_ms` |  85.83 |  515 |  87 |  85 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  54.83 |  329 |  56 |  54 |
| `prover.openings.whir_time_ms` |  42 |  252 |  48 |  38 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,104.50 |  2,209 |  1,437 |  772 |
| `execute_preflight_time_ms` |  4.50 |  9 |  5 |  4 |
| `trace_gen_time_ms   ` |  136.50 |  273 |  183 |  90 |
| `generate_blob_total_time_ms` |  25.50 |  51 |  34 |  17 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  967 |  1,934 |  1,253 |  681 |
| `prover.main_trace_commit_time_ms` |  546 |  1,092 |  718 |  374 |
| `prover.rap_constraints_time_ms` |  313 |  626 |  403 |  223 |
| `prover.openings_time_ms` |  106.50 |  213 |  130 |  83 |
| `prover.rap_constraints.logup_gkr_time_ms` |  66.50 |  133 |  82 |  51 |
| `prover.rap_constraints.round0_time_ms` |  150.50 |  301 |  197 |  104 |
| `prover.rap_constraints.mle_rounds_time_ms` |  95 |  190 |  123 |  67 |
| `prover.openings.stacked_reduction_time_ms` |  69 |  138 |  87 |  51 |
...
| `prover.openings.whir_time_ms` |  37.50 |  75 |  43 |  32 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/b6a92877ca4b1b033cc43fe76cd1bc97cedfa60f/keccak-b6a92877ca4b1b033cc43fe76cd1bc97cedfa60f.memory.svg)
...
| app_proof |  |  |  |  |  | 2,539 |  |  | 36 | 1,235,218 | 33.51 | 0 | 15,766 |  | 
...
| internal_recursive.0 | 1 | 12 | 190 | 12 | 2 | 1 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 9 |
...
| `execute_preflight_insn_mi/s` |  8.57 | -          |  11.25 |  5.89 |
| `trace_gen_time_ms   ` |  158.50 |  317 |  188 |  129 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  846.50 |  1,693 |  1,025 |  668 |
| `prover.main_trace_commit_time_ms` |  220.50 |  441 |  291 |  150 |
| `prover.rap_constraints_time_ms` |  564 |  1,128 |  660 |  468 |
| `prover.openings_time_ms` |  61.50 |  123 |  73 |  50 |
| `prover.rap_constraints.logup_gkr_time_ms` |  141 |  282 |  154 |  128 |
| `prover.rap_constraints.round0_time_ms` |  289 |  578 |  366 |  212 |
| `prover.rap_constraints.mle_rounds_time_ms` |  132.50 |  265 |  138 |  127 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/cee086ac9270babd2cb1bd731e4e385806123a97/kitchen_sink-cee086ac9270babd2cb1bd731e4e385806123a97.memory.svg)
...
| app_proof |  |  |  |  |  | 961 |  |  | 7 | 154,763 | 19.47 | 0 | 2,396 |  | 
...
| internal_recursive.0 | 1 | 9 | 111 | 9 | 1 | 0 | 2 | 0 | 1 | 
| internal_recursive.1 | 1 | 8 | 105 | 8 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 109 | 418 | 108 | 25 | 11 | 18 | 5 | 5 | 
...
| internal_recursive.1 | 1 | prover | 17,507,975 | 96 | 14 | 0 | 4 | 49 | 17 | 16 | 18 | 13 | 0 | 31 | 10 | 21 | 0 | 20 | 15 | 49 | 0 | 1 | 12 | 0 | 0 | 
| leaf | 0 | prover | 407,935,872 | 309 | 124 | 0 | 9 | 141 | 45 | 44 | 36 | 59 | 0 | 42 | 12 | 30 | 6 | 23 | 125 | 141 | 0 | 2 | 59 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 816,542,084 | 1,025 | 291 | 0 | 162 | 660 | 366 | 364 | 138 | 154 | 62 | 73 | 13 | 60 | 16 | 44 | 291 | 660 | 0 | 1 | 91 | 0 | 0 | 
| app_proof | prover | 1 | 800,298,548 | 668 | 150 | 0 | 20 | 468 | 212 | 211 | 127 | 128 | 74 | 50 | 13 | 36 | 14 | 22 | 150 | 468 | 0 | 1 | 53 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 188 | 1,422 | 188 | 187 | 0 | 50 | 20 | 121,000 | 11.25 | 
| app_proof | 1 | 129 | 961 | 129 | 41 | 0 | 3 | 122 | 33,763 | 5.89 | 

...
|:---|---:|---:|---:|
| Total |  3.22 |  2.24 |  2.24 |
| app_proof |  2.42 |  1.44 |  1.44 |
| leaf |  0.43 |  0.43 |  0.43 |
...
| `total_proof_time_ms ` |  1,204 |  2,408 |  1,435 |  973 |
| `execute_metered_time_ms` |  7 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  19.97 | -          |  19.97 |  19.97 |
| `execute_preflight_insns` |  77,381.50 |  154,763 |  121,000 |  33,763 |
| `execute_preflight_time_ms` |  76.50 |  153 |  133 |  20 |
| `execute_preflight_insn_mi/s` |  8.64 | -          |  11.59 |  5.68 |
| `trace_gen_time_ms   ` |  158 |  316 |  188 |  128 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  854.50 |  1,709 |  1,040 |  669 |
| `prover.main_trace_commit_time_ms` |  223 |  446 |  296 |  150 |
| `prover.rap_constraints_time_ms` |  568 |  1,136 |  669 |  467 |
| `prover.openings_time_ms` |  62.50 |  125 |  74 |  51 |
| `prover.rap_constraints.logup_gkr_time_ms` |  143.50 |  287 |  158 |  129 |
| `prover.rap_constraints.round0_time_ms` |  288 |  576 |  366 |  210 |
| `prover.rap_constraints.mle_rounds_time_ms` |  135 |  270 |  143 |  127 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/b6a92877ca4b1b033cc43fe76cd1bc97cedfa60f/kitchen_sink-b6a92877ca4b1b033cc43fe76cd1bc97cedfa60f.memory.svg)
...
| app_proof |  |  |  |  |  | 973 |  |  | 7 | 154,763 | 19.97 | 0 | 2,421 |  | 
...
| internal_recursive.0 | 1 | 10 | 113 | 9 | 1 | 0 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 9 | 104 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 112 | 426 | 112 | 27 | 11 | 18 | 5 | 5 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 53,472,003 | 139 | 40 | 0 | 4 | 64 | 19 | 19 | 29 | 15 | 0 | 32 | 9 | 23 | 1 | 21 | 41 | 64 | 0 | 1 | 15 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 23,651,975 | 103 | 19 | 0 | 4 | 51 | 17 | 16 | 20 | 13 | 0 | 32 | 10 | 21 | 1 | 20 | 19 | 51 | 0 | 1 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 17,507,975 | 95 | 14 | 0 | 4 | 49 | 17 | 16 | 18 | 13 | 0 | 29 | 8 | 21 | 0 | 20 | 15 | 49 | 0 | 1 | 13 | 0 | 0 | 
| leaf | 0 | prover | 407,935,872 | 313 | 125 | 0 | 9 | 143 | 45 | 44 | 36 | 60 | 0 | 44 | 13 | 31 | 7 | 24 | 125 | 143 | 0 | 2 | 59 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 816,542,084 | 1,040 | 296 | 0 | 166 | 669 | 366 | 365 | 143 | 158 | 64 | 74 | 13 | 61 | 16 | 44 | 296 | 669 | 0 | 1 | 92 | 0 | 0 | 
| app_proof | prover | 1 | 800,298,548 | 669 | 150 | 0 | 20 | 467 | 210 | 209 | 127 | 129 | 75 | 51 | 13 | 37 | 14 | 22 | 150 | 467 | 0 | 1 | 53 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 188 | 1,435 | 188 | 184 | 0 | 50 | 20 | 121,000 | 11.59 | 
| app_proof | 1 | 128 | 973 | 128 | 41 | 0 | 3 | 133 | 33,763 | 5.68 | 

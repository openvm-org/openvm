...
| `total_proof_time_ms ` |  1,199 |  2,398 |  1,429 |  969 |
| `execute_metered_time_ms` |  7 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  19.86 | -          |  19.86 |  19.86 |
| `execute_preflight_insns` |  77,381.50 |  154,763 |  121,000 |  33,763 |
| `execute_preflight_time_ms` |  74 |  148 |  128 |  20 |
| `execute_preflight_insn_mi/s` |  8.73 | -          |  11.62 |  5.85 |
| `trace_gen_time_ms   ` |  159 |  318 |  189 |  129 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  850.50 |  1,701 |  1,031 |  670 |
| `prover.main_trace_commit_time_ms` |  224.50 |  449 |  298 |  151 |
| `prover.rap_constraints_time_ms` |  563 |  1,126 |  659 |  467 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/5b578258738a355fae7e51bae01be4bdc4f34016/kitchen_sink-5b578258738a355fae7e51bae01be4bdc4f34016.memory.svg)
...
| app_proof |  |  |  |  |  | 969 |  |  | 7 | 154,763 | 19.86 | 0 | 2,411 |  | 
...
| internal_recursive.1 | 1 | prover | 17,507,975 | 94 | 15 | 0 | 4 | 48 | 16 | 16 | 18 | 13 | 0 | 30 | 9 | 21 | 0 | 20 | 15 | 48 | 0 | 1 | 12 | 0 | 0 | 
| leaf | 0 | prover | 407,935,872 | 309 | 124 | 0 | 9 | 139 | 44 | 44 | 35 | 58 | 0 | 45 | 14 | 31 | 7 | 24 | 124 | 139 | 0 | 2 | 58 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 816,542,084 | 1,031 | 298 | 0 | 167 | 659 | 362 | 361 | 141 | 155 | 63 | 73 | 12 | 60 | 15 | 44 | 298 | 659 | 0 | 1 | 90 | 0 | 0 | 
| app_proof | prover | 1 | 800,298,548 | 670 | 151 | 0 | 20 | 467 | 209 | 208 | 128 | 129 | 75 | 50 | 13 | 37 | 15 | 22 | 151 | 467 | 0 | 1 | 53 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 189 | 1,429 | 189 | 188 | 0 | 50 | 20 | 121,000 | 11.62 | 
| app_proof | 1 | 129 | 969 | 129 | 40 | 0 | 3 | 128 | 33,763 | 5.85 | 

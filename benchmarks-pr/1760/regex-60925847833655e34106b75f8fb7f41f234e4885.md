...
| `execute_metered_time_ms` |  547 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  7.60 | -          | -          | -          |
| `execute_e3_time_ms  ` |  296.50 |  593 |  322 |  271 |
| `execute_e3_insn_mi/s` |  7.01 | -          |  7.08 |  6.95 |
| `trace_gen_time_ms   ` |  506.50 |  1,013 |  588 |  425 |
| `stark_prove_excluding_trace_time_ms` |  2,620.50 |  5,241 |  2,796 |  2,445 |
| `main_trace_commit_time_ms` |  515 |  1,030 |  570 |  460 |
| `generate_perm_trace_time_ms` |  215 |  430 |  221 |  209 |
| `perm_trace_commit_time_ms` |  560 |  1,120 |  591 |  529 |
| `quotient_poly_compute_time_ms` |  263 |  526 |  285 |  241 |
| `quotient_poly_commit_time_ms` |  244 |  488 |  281 |  207 |
| `pcs_opening_time_ms ` |  815 |  1,630 |  842 |  788 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2 | 592 | 4,165,433 | 1 | 547 | 7.60 | 19 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 588 | 2,243,700 | 275,648,700 | 2,796 | 285 | 281 | 591 | 842 | 570 | 93,502,324 | 2,243,700 | 221 | 322 | 6.95 | 
| regex_program | 1 | 425 | 1,921,732 | 242,975,388 | 2,445 | 241 | 207 | 529 | 788 | 460 | 73,017,132 | 1,921,733 | 209 | 271 | 7.08 | 

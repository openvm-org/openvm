...
| `execute_e3_insn_mi/s` |  7.02 |  14.04 |  7.08 |  6.96 |
| `trace_gen_time_ms   ` |  503 |  1,006 |  580 |  426 |
| `stark_prove_excluding_trace_time_ms` |  2,581 |  5,162 |  2,780 |  2,382 |
| `main_trace_commit_time_ms` |  503.50 |  1,007 |  564 |  443 |
| `generate_perm_trace_time_ms` |  218.50 |  437 |  225 |  212 |
| `perm_trace_commit_time_ms` |  552 |  1,104 |  586 |  518 |
| `quotient_poly_compute_time_ms` |  261.50 |  523 |  286 |  237 |
| `quotient_poly_commit_time_ms` |  241.50 |  483 |  275 |  208 |
| `pcs_opening_time_ms ` |  797.50 |  1,595 |  841 |  754 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2 | 589 | 4,165,433 | 1 | 546 | 7.62 | 20 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 580 | 2,243,700 | 275,648,700 | 2,780 | 286 | 275 | 586 | 841 | 564 | 93,502,324 | 2,243,700 | 225 | 322 | 6.96 | 
| regex_program | 1 | 426 | 1,921,732 | 242,975,388 | 2,382 | 237 | 208 | 518 | 754 | 443 | 73,017,132 | 1,921,733 | 212 | 271 | 7.08 | 

...
| `total_proof_time_ms ` |  769 |  1,538 |  858 |  680 |
...
| `execute_preflight_time_ms` |  97.50 |  195 |  136 |  59 |
| `execute_preflight_insn_mi/s` |  13.37 | -          |  18.01 |  8.74 |
| `trace_gen_time_ms   ` |  176 |  352 |  196 |  156 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  402.50 |  805 |  422 |  383 |
| `main_trace_commit_time_ms` |  65.50 |  131 |  76 |  55 |
| `generate_perm_trace_time_ms` |  56 |  112 |  71 |  41 |
| `perm_trace_commit_time_ms` |  77.77 |  155.54 |  89.96 |  65.58 |
| `quotient_poly_compute_time_ms` |  79.42 |  158.84 |  87.27 |  71.57 |
| `quotient_poly_commit_time_ms` |  16.83 |  33.66 |  18.84 |  14.82 |
| `pcs_opening_time_ms ` |  102 |  204 |  104 |  100 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 680 | 1 | 102 | 1,745,742 | 16.99 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 156 | 858 | 32,689,110 | 172,558,444 | 156 | 422 | 0 | 87.27 | 18.84 | 6 | 89.96 | 104 | 133 | 104 | 1 | 76 | 16,059,916 | 41 | 136 | 1,157,000 | 8.74 | 26 | 106 | 1 | 104 | 
| pairing | 1 | 196 | 680 | 22,314,288 | 119,958,502 | 196 | 383 | 1 | 71.57 | 14.82 | 5 | 65.58 | 100 | 140 | 100 | 0 | 55 | 9,408,294 | 71 | 59 | 588,742 | 18.01 | 20 | 86 | 1 | 100 | 

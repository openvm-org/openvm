...
| `total_proof_time_ms ` |  726.50 |  1,453 |  817 |  636 |
...
| `execute_preflight_time_ms` |  98.50 |  197 |  137 |  60 |
| `execute_preflight_insn_mi/s` |  13.30 | -          |  17.93 |  8.68 |
| `trace_gen_time_ms   ` |  175.50 |  351 |  195 |  156 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  359 |  718 |  379 |  339 |
| `main_trace_commit_time_ms` |  65 |  130 |  75 |  55 |
| `generate_perm_trace_time_ms` |  55.50 |  111 |  72 |  39 |
| `perm_trace_commit_time_ms` |  75.51 |  151.02 |  85.83 |  65.19 |
| `quotient_poly_compute_time_ms` |  77.68 |  155.37 |  85.18 |  70.19 |
| `quotient_poly_commit_time_ms` |  15.67 |  31.34 |  17.37 |  13.98 |
| `pcs_opening_time_ms ` |  64.50 |  129 |  71 |  58 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 636 | 1 | 100 | 1,745,742 | 17.38 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 156 | 817 | 32,689,110 | 172,558,444 | 156 | 379 | 0 | 85.18 | 17.37 | 6 | 85.83 | 71 | 128 | 71 | 1 | 75 | 16,059,916 | 39 | 137 | 1,157,000 | 8.68 | 26 | 103 | 1 | 71 | 
| pairing | 1 | 195 | 636 | 22,314,288 | 119,958,502 | 195 | 339 | 1 | 70.19 | 13.98 | 5 | 65.19 | 58 | 140 | 58 | 0 | 55 | 9,408,294 | 72 | 60 | 588,742 | 17.93 | 20 | 84 | 1 | 58 | 

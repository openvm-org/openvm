...
| `total_proof_time_ms ` |  583 |  2,332 |  697 |  541 |
...
| `execute_metered_insn_mi/s` |  116.11 | -          |  116.11 |  116.11 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  59.25 |  237 |  72 |  48 |
| `execute_preflight_insn_mi/s` |  30.43 | -          |  31.67 |  27.68 |
| `trace_gen_time_ms   ` |  174.25 |  697 |  211 |  150 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  280.75 |  1,123 |  288 |  272 |
| `main_trace_commit_time_ms` |  52.25 |  209 |  57 |  50 |
| `generate_perm_trace_time_ms` |  28.25 |  113 |  38 |  19 |
| `perm_trace_commit_time_ms` |  64.33 |  257.32 |  69.29 |  56.35 |
| `quotient_poly_compute_time_ms` |  57.30 |  229.20 |  69.89 |  53.01 |
| `quotient_poly_commit_time_ms` |  14.86 |  59.46 |  16.43 |  13.15 |
| `pcs_opening_time_ms ` |  60.25 |  241 |  62 |  57 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 543 | 1 | 35 | 4,137,502 | 116.11 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 211 | 697 | 23,446,148 | 150,778,428 | 211 | 288 | 0 | 53.06 | 16.43 | 5 | 69.29 | 61 | 99 | 61 | 4 | 57 | 10,899,170 | 29 | 48 | 1,103,000 | 27.68 | 22 | 70 | 1 | 61 | 
| regex_program | 1 | 150 | 551 | 11,598,276 | 128,513,066 | 150 | 288 | 1 | 53.01 | 15.27 | 4 | 66.09 | 62 | 105 | 62 | 0 | 51 | 2,196,106 | 38 | 72 | 1,104,000 | 31.67 | 16 | 68 | 0 | 62 | 
| regex_program | 2 | 159 | 541 | 11,579,064 | 128,513,066 | 159 | 275 | 1 | 53.23 | 14.61 | 4 | 65.58 | 61 | 93 | 61 | 0 | 51 | 2,177,334 | 27 | 65 | 1,104,000 | 31.39 | 16 | 68 | 0 | 61 | 
| regex_program | 3 | 177 | 543 | 11,853,872 | 103,456,394 | 177 | 272 | 0 | 69.89 | 13.15 | 5 | 56.35 | 57 | 79 | 57 | 0 | 50 | 2,422,606 | 19 | 52 | 826,502 | 30.98 | 18 | 84 | 1 | 56 | 

...
| `total_proof_time_ms ` |  745 |  1,490 |  818 |  672 |
...
| `execute_metered_insn_mi/s` |  17.63 | -          |  17.63 |  17.63 |
| `execute_preflight_insns` |  872,871 |  1,745,742 |  1,157,000 |  588,742 |
| `execute_preflight_time_ms` |  98 |  196 |  136 |  60 |
| `execute_preflight_insn_mi/s` |  13.31 | -          |  17.90 |  8.71 |
| `trace_gen_time_ms   ` |  173 |  346 |  192 |  154 |
...
| `generate_perm_trace_time_ms` |  56 |  112 |  71 |  41 |
| `perm_trace_commit_time_ms` |  76.78 |  153.57 |  88.91 |  64.66 |
| `quotient_poly_compute_time_ms` |  78.46 |  156.91 |  86.80 |  70.12 |
| `quotient_poly_commit_time_ms` |  16.68 |  33.36 |  18.88 |  14.48 |
| `pcs_opening_time_ms ` |  83 |  166 |  98 |  68 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 672 | 1 | 98 | 1,745,742 | 17.63 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 154 | 818 | 32,689,110 | 172,558,444 | 154 | 383 | 0 | 86.80 | 18.88 | 7 | 88.91 | 68 | 132 | 68 | 1 | 75 | 16,059,916 | 41 | 136 | 1,157,000 | 8.71 | 26 | 106 | 1 | 68 | 
| pairing | 1 | 192 | 672 | 22,314,288 | 119,958,502 | 192 | 378 | 1 | 70.12 | 14.48 | 6 | 64.66 | 98 | 139 | 98 | 0 | 54 | 9,408,294 | 71 | 60 | 588,742 | 17.90 | 20 | 85 | 1 | 98 | 

...
| `total_proof_time_ms ` |  594.25 |  2,377 |  750 |  540 |
...
| `execute_metered_insn_mi/s` |  116.05 | -          |  116.05 |  116.05 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  59.50 |  238 |  74 |  47 |
| `execute_preflight_insn_mi/s` |  30.66 | -          |  31.82 |  27.45 |
| `trace_gen_time_ms   ` |  174 |  696 |  211 |  149 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  292 |  1,168 |  343 |  267 |
| `main_trace_commit_time_ms` |  51.75 |  207 |  57 |  49 |
| `generate_perm_trace_time_ms` |  34 |  136 |  54 |  20 |
| `perm_trace_commit_time_ms` |  64.58 |  258.33 |  71.18 |  55.03 |
| `quotient_poly_compute_time_ms` |  58.90 |  235.60 |  71.97 |  52.04 |
| `quotient_poly_commit_time_ms` |  15.34 |  61.38 |  16.80 |  13.02 |
| `pcs_opening_time_ms ` |  64.25 |  257 |  82 |  53 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 540 | 1 | 35 | 4,137,502 | 116.05 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 211 | 750 | 23,446,148 | 150,778,428 | 211 | 343 | 0 | 58.89 | 16.80 | 5 | 71.18 | 82 | 126 | 82 | 4 | 57 | 10,899,170 | 54 | 47 | 1,103,000 | 27.45 | 21 | 76 | 1 | 82 | 
| regex_program | 1 | 149 | 546 | 11,598,276 | 128,513,066 | 149 | 282 | 1 | 52.04 | 15.79 | 5 | 66.03 | 60 | 101 | 60 | 0 | 51 | 2,196,106 | 35 | 74 | 1,104,000 | 31.79 | 17 | 68 | 0 | 60 | 
| regex_program | 2 | 157 | 541 | 11,579,064 | 128,513,066 | 157 | 276 | 1 | 52.70 | 15.77 | 4 | 66.09 | 62 | 94 | 62 | 0 | 50 | 2,177,334 | 27 | 66 | 1,104,000 | 31.57 | 17 | 69 | 0 | 62 | 
| regex_program | 3 | 179 | 540 | 11,853,872 | 103,456,394 | 179 | 267 | 0 | 71.97 | 13.02 | 5 | 55.03 | 53 | 78 | 53 | 0 | 49 | 2,422,606 | 20 | 51 | 826,502 | 31.82 | 18 | 86 | 1 | 53 | 
...
Commit: https://github.com/openvm-org/openvm/commit/5a12ee30c59d046a4ec1193df6318c96a60c562e
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19349642109)

...
|:---|---:|---:|
| Total |  7.38 |  4.70 |
| regex_program |  7.34 |  4.67 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  3,672 |  7,344 |  4,668 |  2,676 |
...
| `execute_metered_insn_mi/s` |  123.89 | -          |  123.89 |  123.89 |
| `execute_preflight_time_ms` |  96.50 |  193 |  104 |  89 |
| `execute_preflight_insn_mi/s` |  27.62 | -          |  29.87 |  25.37 |
| `trace_gen_time_ms   ` |  392.50 |  785 |  505 |  280 |
| `memory_finalize_time_ms` |  7.50 |  15 |  13 |  2 |
| `stark_prove_excluding_trace_time_ms` |  2,947 |  5,894 |  3,812 |  2,082 |
| `main_trace_commit_time_ms` |  565.50 |  1,131 |  761 |  370 |
| `generate_perm_trace_time_ms` |  234 |  468 |  303 |  165 |
| `perm_trace_commit_time_ms` |  601 |  1,202 |  755 |  447 |
| `quotient_poly_compute_time_ms` |  312 |  624 |  424 |  200 |
| `quotient_poly_commit_time_ms` |  282.50 |  565 |  373 |  192 |
| `pcs_opening_time_ms ` |  943 |  1,886 |  1,188 |  698 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2,676 | 6 | 4,108,597 | 1 | 33 | 123.89 | 45 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 505 | 4,668 | 211,758,557 | 373,183,036 | 505 | 3,812 | 0 | 424 | 373 | 755 | 1,188 | 7 | 13 | 761 | 91,281,687 | 2,211,000 | 303 | 104 | 25.37 | 
| regex_program | 1 | 280 | 2,676 | 174,326,267 | 196,838,026 | 280 | 2,082 | 53 | 200 | 192 | 447 | 698 | 6 | 2 | 370 | 73,453,305 | 1,897,597 | 165 | 89 | 29.87 | 

...
|:---|---:|---:|
| Total | <span style='color: green'>(-0 [-2.6%])</span> 2.37 | <span style='color: green'>(-0 [-6.9%])</span> 0.74 |
| regex_program | <span style='color: green'>(-0 [-2.6%])</span> 2.33 | <span style='color: green'>(-0 [-7.1%])</span> 0.70 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: green'>(-16 [-2.6%])</span> 582.50 | <span style='color: green'>(-62 [-2.6%])</span> 2,330 | <span style='color: green'>(-54 [-7.1%])</span> 702 | <span style='color: green'>(-4 [-0.7%])</span> 539 |
...
| `execute_metered_insn_mi/s` | <span style='color: red'>(+1 [+1.4%])</span> 110.05 | -          | <span style='color: red'>(+1 [+1.4%])</span> 110.05 | <span style='color: red'>(+1 [+1.4%])</span> 110.05 |
...
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+1 [+1.6%])</span> 32.52 | -          | <span style='color: red'>(+1 [+1.5%])</span> 33.68 | <span style='color: red'>(+0 [+1.4%])</span> 29.18 |
| `trace_gen_time_ms   ` | <span style='color: green'>(-0 [-0.3%])</span> 181.75 | <span style='color: green'>(-2 [-0.3%])</span> 727 |  217 |  157 |
| `memory_finalize_time_ms` |  1 |  4 |  4 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: green'>(-13 [-4.5%])</span> 281.25 | <span style='color: green'>(-53 [-4.5%])</span> 1,125 | <span style='color: green'>(-52 [-14.9%])</span> 296 | <span style='color: green'>(-2 [-0.7%])</span> 271 |
| `main_trace_commit_time_ms` | <span style='color: red'>(+0 [+0.5%])</span> 52.50 | <span style='color: red'>(+1 [+0.5%])</span> 210 | <span style='color: green'>(-1 [-1.7%])</span> 57 |  50 |
| `generate_perm_trace_time_ms` | <span style='color: green'>(-8 [-21.9%])</span> 26.75 | <span style='color: green'>(-30 [-21.9%])</span> 107 | <span style='color: green'>(-17 [-30.9%])</span> 38 |  19 |
| `perm_trace_commit_time_ms` | <span style='color: green'>(-1 [-0.8%])</span> 65.05 | <span style='color: green'>(-2 [-0.8%])</span> 260.18 | <span style='color: red'>(+1 [+1.2%])</span> 73.06 | <span style='color: green'>(-0 [-0.3%])</span> 56.61 |
| `quotient_poly_compute_time_ms` | <span style='color: green'>(-0 [-0.2%])</span> 59.09 | <span style='color: green'>(-0 [-0.2%])</span> 236.36 | <span style='color: green'>(-1 [-0.8%])</span> 69.64 | <span style='color: green'>(-1 [-1.3%])</span> 52.73 |
| `quotient_poly_commit_time_ms` | <span style='color: green'>(-0 [-0.9%])</span> 14.95 | <span style='color: green'>(-1 [-0.9%])</span> 59.81 | <span style='color: red'>(+1 [+8.1%])</span> 18.10 | <span style='color: green'>(-0 [-0.8%])</span> 12.69 |
| `pcs_opening_time_ms ` | <span style='color: green'>(-5 [-8.0%])</span> 60.25 | <span style='color: green'>(-21 [-8.0%])</span> 241 | <span style='color: green'>(-23 [-27.1%])</span> 62 | <span style='color: red'>(+1 [+1.8%])</span> 57 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 543 | 1 | 37 | 4,137,502 | 110.05 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 217 | 702 | 23,446,148 | 150,778,428 | 217 | 296 | 0 | 61.05 | 18.10 | 5 | 73.06 | 61 | 96 | 61 | 4 | 57 | 10,899,170 | 23 | 44 | 1,103,000 | 29.18 | 21 | 79 | 1 | 61 | 
| regex_program | 1 | 157 | 546 | 11,598,276 | 128,513,066 | 157 | 284 | 1 | 52.94 | 14.46 | 4 | 65.10 | 62 | 103 | 61 | 0 | 50 | 2,196,106 | 38 | 64 | 1,104,000 | 33.56 | 16 | 67 | 0 | 61 | 
| regex_program | 2 | 166 | 539 | 11,579,064 | 128,513,066 | 166 | 274 | 1 | 52.73 | 14.57 | 4 | 65.41 | 61 | 93 | 60 | 0 | 52 | 2,177,334 | 27 | 57 | 1,104,000 | 33.67 | 16 | 67 | 0 | 60 | 
| regex_program | 3 | 187 | 543 | 11,853,872 | 103,456,394 | 187 | 271 | 0 | 69.64 | 12.69 | 5 | 56.61 | 57 | 78 | 57 | 0 | 51 | 2,422,606 | 19 | 44 | 826,502 | 33.68 | 18 | 83 | 1 | 57 | 

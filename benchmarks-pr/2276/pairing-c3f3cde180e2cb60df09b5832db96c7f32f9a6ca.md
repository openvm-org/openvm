...
|:---|---:|---:|
| Total | <span style='color: red'>(+0 [+2.0%])</span> 1.52 | <span style='color: red'>(+0 [+1.6%])</span> 0.91 |
| pairing | <span style='color: red'>(+0 [+2.0%])</span> 1.45 | <span style='color: red'>(+0 [+1.6%])</span> 0.84 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+14 [+2.0%])</span> 724 | <span style='color: red'>(+28 [+2.0%])</span> 1,448 | <span style='color: red'>(+13 [+1.6%])</span> 843 | <span style='color: red'>(+15 [+2.5%])</span> 605 |
| `main_cells_used     ` |  12,734,105 |  25,468,210 |  16,059,916 |  9,408,294 |
| `total_cells_used    ` |  27,501,699 |  55,003,398 |  32,689,110 |  22,314,288 |
| `execute_metered_time_ms` | <span style='color: red'>(+1 [+1.5%])</span> 68 | -          | -          | -          |
| `execute_metered_insn_mi/s` | <span style='color: green'>(-0 [-0.5%])</span> 25.65 | -          | <span style='color: green'>(-0 [-0.5%])</span> 25.65 | <span style='color: green'>(-0 [-0.5%])</span> 25.65 |
| `execute_preflight_insns` |  872,871 |  1,745,742 |  1,157,000 |  588,742 |
| `execute_preflight_time_ms` | <span style='color: red'>(+4 [+4.2%])</span> 86.50 | <span style='color: red'>(+7 [+4.2%])</span> 173 | <span style='color: red'>(+5 [+4.6%])</span> 113 | <span style='color: red'>(+2 [+3.4%])</span> 60 |
| `execute_preflight_insn_mi/s` | <span style='color: green'>(-0 [-2.3%])</span> 14.43 | -          | <span style='color: green'>(-0 [-1.7%])</span> 18.24 | <span style='color: green'>(-0 [-3.4%])</span> 10.61 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+1 [+0.5%])</span> 191 | <span style='color: red'>(+2 [+0.5%])</span> 382 | <span style='color: red'>(+3 [+1.5%])</span> 199 | <span style='color: green'>(-1 [-0.5%])</span> 183 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+10 [+3.1%])</span> 353.50 | <span style='color: red'>(+21 [+3.1%])</span> 707 | <span style='color: red'>(+10 [+2.5%])</span> 403 | <span style='color: red'>(+11 [+3.8%])</span> 304 |
| `main_trace_commit_time_ms` | <span style='color: red'>(+2 [+3.9%])</span> 66 | <span style='color: red'>(+5 [+3.9%])</span> 132 | <span style='color: red'>(+3 [+4.1%])</span> 77 | <span style='color: red'>(+2 [+3.8%])</span> 55 |
| `generate_perm_trace_time_ms` | <span style='color: red'>(+2 [+4.1%])</span> 38 | <span style='color: red'>(+3 [+4.1%])</span> 76 | <span style='color: red'>(+1 [+2.4%])</span> 42 | <span style='color: red'>(+2 [+6.2%])</span> 34 |
| `perm_trace_commit_time_ms` | <span style='color: red'>(+1 [+1.1%])</span> 77.97 | <span style='color: red'>(+2 [+1.1%])</span> 155.93 | <span style='color: red'>(+1 [+0.9%])</span> 89.96 | <span style='color: red'>(+1 [+1.4%])</span> 65.97 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+2 [+2.4%])</span> 80.83 | <span style='color: red'>(+4 [+2.4%])</span> 161.65 | <span style='color: red'>(+1 [+1.7%])</span> 88.64 | <span style='color: red'>(+2 [+3.3%])</span> 73.01 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+1 [+8.5%])</span> 17.16 | <span style='color: red'>(+3 [+8.5%])</span> 34.33 | <span style='color: red'>(+2 [+11.5%])</span> 19.16 | <span style='color: red'>(+1 [+4.9%])</span> 15.17 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+2 [+3.8%])</span> 68 | <span style='color: red'>(+5 [+3.8%])</span> 136 | <span style='color: red'>(+2 [+2.5%])</span> 81 | <span style='color: red'>(+3 [+5.8%])</span> 55 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 605 | 1 | 68 | 1,745,742 | 25.65 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 183 | 843 | 32,689,110 | 172,558,444 | 183 | 403 | 0 | 88.64 | 19.16 | 6 | 89.96 | 81 | 135 | 81 | 1 | 77 | 16,059,916 | 42 | 113 | 1,157,000 | 10.61 | 26 | 108 | 1 | 81 | 
| pairing | 1 | 199 | 605 | 22,314,288 | 119,958,502 | 199 | 304 | 1 | 73.01 | 15.17 | 6 | 65.97 | 55 | 104 | 55 | 0 | 55 | 9,408,294 | 34 | 60 | 588,742 | 18.24 | 21 | 88 | 1 | 55 | 

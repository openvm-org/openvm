...
| `total_proof_time_ms ` |  735 |  1,470 |  856 |  614 |
...
| `execute_metered_insn_mi/s` |  27.71 | -          |  27.71 |  27.71 |
| `execute_preflight_insns` |  872,878.50 |  1,745,757 |  1,151,000 |  594,757 |
| `execute_preflight_time_ms` |  83.50 |  167 |  119 |  48 |
| `execute_preflight_insn_mi/s` |  14.74 | -          |  18.01 |  11.46 |
| `trace_gen_time_ms   ` |  189.50 |  379 |  208 |  171 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  356.50 |  713 |  397 |  316 |
| `main_trace_commit_time_ms` |  65.50 |  131 |  76 |  55 |
| `generate_perm_trace_time_ms` |  43 |  86 |  47 |  39 |
| `perm_trace_commit_time_ms` |  78.68 |  157.36 |  90.82 |  66.54 |
| `quotient_poly_compute_time_ms` |  83.72 |  167.45 |  92.10 |  75.35 |
| `quotient_poly_commit_time_ms` |  17.44 |  34.87 |  19.63 |  15.24 |
| `pcs_opening_time_ms ` |  63.50 |  127 |  67 |  60 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 614 | 1 | 63 | 1,745,757 | 27.71 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 171 | 856 | 32,579,050 | 172,558,444 | 171 | 397 | 0 | 92.10 | 19.63 | 6 | 90.82 | 67 | 141 | 66 | 1 | 76 | 15,992,408 | 47 | 119 | 1,151,000 | 11.46 | 27 | 112 | 1 | 66 | 
| pairing | 1 | 208 | 614 | 22,427,652 | 119,958,502 | 208 | 316 | 1 | 75.35 | 15.24 | 6 | 66.54 | 60 | 108 | 60 | 0 | 55 | 9,471,642 | 39 | 48 | 594,757 | 18.01 | 21 | 91 | 1 | 60 | 

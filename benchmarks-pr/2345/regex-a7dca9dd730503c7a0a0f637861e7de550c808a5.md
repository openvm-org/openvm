...
|:---|---:|---:|---:|
| Total |  2.43 |  0.74 | 0.74 |
| regex_program |  2.43 |  0.74 |  0.74 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  598.50 |  2,394 |  705 |  552 |
...
| `execute_preflight_time_ms` |  46.50 |  186 |  58 |  35 |
| `execute_preflight_insn_mi/s` |  31.33 | -          |  31.75 |  30.31 |
| `trace_gen_time_ms   ` |  177.25 |  709 |  192 |  169 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  300.50 |  1,202 |  307 |  290 |
| `main_trace_commit_time_ms` |  51.50 |  206 |  57 |  49 |
| `generate_perm_trace_time_ms` |  41 |  164 |  47 |  35 |
| `perm_trace_commit_time_ms` |  63.70 |  254.78 |  70.69 |  54.10 |
| `quotient_poly_compute_time_ms` |  60.22 |  240.87 |  72.18 |  53.61 |
| `quotient_poly_commit_time_ms` |  15.54 |  62.17 |  18.39 |  13.65 |
| `pcs_opening_time_ms ` |  64.50 |  258 |  76 |  56 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 568 | 1 | 36 | 4,137,631 | 113.01 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 169 | 705 | 23,439,210 | 150,778,428 | 169 | 306 | 0 | 60.20 | 18.39 | 6 | 70.69 | 56 | 112 | 55 | 4 | 57 | 10,893,008 | 40 | 58 | 1,103,000 | 30.31 | 22 | 79 | 1 | 55 | 
| regex_program | 1 | 174 | 569 | 11,594,026 | 128,513,066 | 174 | 307 | 1 | 54.89 | 15.07 | 4 | 65.13 | 76 | 108 | 76 | 0 | 51 | 2,191,736 | 42 | 46 | 1,104,000 | 31.75 | 17 | 70 | 0 | 76 | 
| regex_program | 2 | 174 | 552 | 11,584,746 | 128,513,066 | 174 | 290 | 1 | 53.61 | 15.05 | 4 | 64.86 | 69 | 101 | 69 | 0 | 49 | 2,182,520 | 35 | 47 | 1,104,000 | 31.73 | 17 | 69 | 0 | 69 | 
| regex_program | 3 | 192 | 568 | 11,863,726 | 103,456,394 | 192 | 299 | 0 | 72.18 | 13.65 | 5 | 54.10 | 57 | 104 | 57 | 0 | 49 | 2,431,236 | 47 | 35 | 826,631 | 31.52 | 19 | 87 | 1 | 57 | 

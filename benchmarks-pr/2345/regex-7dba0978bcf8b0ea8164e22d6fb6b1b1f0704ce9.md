...
|:---|---:|---:|---:|
| Total |  2.40 |  0.74 | 0.74 |
| regex_program |  2.40 |  0.74 |  0.74 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  592.25 |  2,369 |  708 |  538 |
| `main_cells_used     ` |  4,424,625 |  17,698,500 |  10,893,008 |  2,182,520 |
| `total_cells_used    ` |  14,620,427 |  58,481,708 |  23,439,210 |  11,584,746 |
| `execute_metered_time_ms` |  35 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  115.16 | -          |  115.16 |  115.16 |
| `execute_preflight_insns` |  1,034,407.75 |  4,137,631 |  1,104,000 |  826,631 |
| `execute_preflight_time_ms` |  46.25 |  185 |  57 |  36 |
| `execute_preflight_insn_mi/s` |  30.82 | -          |  31.68 |  29.62 |
| `trace_gen_time_ms   ` |  178.75 |  715 |  193 |  171 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  293.25 |  1,173 |  310 |  275 |
| `main_trace_commit_time_ms` |  51.25 |  205 |  55 |  49 |
| `generate_perm_trace_time_ms` |  37 |  148 |  41 |  34 |
| `perm_trace_commit_time_ms` |  63.85 |  255.42 |  69.76 |  54.80 |
| `quotient_poly_compute_time_ms` |  60.18 |  240.71 |  70.59 |  53.71 |
| `quotient_poly_commit_time_ms` |  15.64 |  62.56 |  18.19 |  13.27 |
| `pcs_opening_time_ms ` |  61.75 |  247 |  74 |  47 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 561 | 1 | 35 | 4,137,631 | 115.16 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 171 | 708 | 23,439,210 | 150,778,428 | 171 | 310 | 0 | 62.06 | 18.19 | 5 | 69.76 | 68 | 104 | 68 | 4 | 55 | 10,893,008 | 34 | 57 | 1,103,000 | 30.45 | 22 | 80 | 1 | 68 | 
| regex_program | 1 | 175 | 538 | 11,594,026 | 128,513,066 | 175 | 275 | 1 | 53.71 | 15.11 | 4 | 64.73 | 47 | 106 | 47 | 0 | 51 | 2,191,736 | 41 | 46 | 1,104,000 | 31.68 | 16 | 69 | 0 | 47 | 
| regex_program | 2 | 176 | 562 | 11,584,746 | 128,513,066 | 176 | 298 | 1 | 54.35 | 15.99 | 4 | 66.14 | 74 | 101 | 74 | 0 | 50 | 2,182,520 | 34 | 46 | 1,104,000 | 31.54 | 17 | 70 | 0 | 74 | 
| regex_program | 3 | 193 | 561 | 11,863,726 | 103,456,394 | 193 | 290 | 0 | 70.59 | 13.27 | 5 | 54.80 | 58 | 97 | 58 | 0 | 49 | 2,431,236 | 39 | 36 | 826,631 | 29.62 | 18 | 85 | 1 | 58 | 
...
Commit: https://github.com/openvm-org/openvm/commit/7dba0978bcf8b0ea8164e22d6fb6b1b1f0704ce9
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/20868290104)

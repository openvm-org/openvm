...
|:---|---:|---:|---:|
| Total |  1.08 |  0.62 | 0.62 |
| fibonacci_program |  1.08 |  0.62 |  0.62 |


| fibonacci_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  535 |  1,070 |  614 |  456 |
| `main_cells_used     ` |  1,052,383 |  2,104,766 |  1,065,658 |  1,039,108 |
| `total_cells_used    ` |  9,695,681 |  19,391,362 |  9,709,748 |  9,681,614 |
| `execute_metered_time_ms` |  9 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  160.42 | -          |  160.42 |  160.42 |
| `execute_preflight_insns` |  750,132.50 |  1,500,265 |  873,000 |  627,265 |
| `execute_preflight_time_ms` |  33.50 |  67 |  39 |  28 |
| `execute_preflight_insn_mi/s` |  29.03 | -          |  29.21 |  28.85 |
| `trace_gen_time_ms   ` |  187.50 |  375 |  192 |  183 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  209 |  418 |  224 |  194 |
| `main_trace_commit_time_ms` |  31 |  62 |  34 |  28 |
| `generate_perm_trace_time_ms` |  21.50 |  43 |  28 |  15 |
| `perm_trace_commit_time_ms` |  42.02 |  84.03 |  45.88 |  38.16 |
| `quotient_poly_compute_time_ms` |  31.70 |  63.41 |  35.17 |  28.24 |
| `quotient_poly_commit_time_ms` |  13.05 |  26.11 |  13.44 |  12.67 |
...
| --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 456 | 1 | 9 | 1,500,265 | 160.42 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 183 | 614 | 9,681,614 | 84,399,632 | 183 | 224 | 0 | 35.17 | 13.44 | 5 | 45.88 | 78 | 62 | 78 | 0 | 34 | 1,039,108 | 15 | 39 | 873,000 | 29.21 | 14 | 49 | 1 | 78 | 
| fibonacci_program | 1 | 192 | 456 | 9,709,748 | 74,305,770 | 192 | 194 | 1 | 28.24 | 12.67 | 4 | 38.16 | 57 | 67 | 56 | 0 | 28 | 1,065,658 | 28 | 28 | 627,265 | 28.85 | 11 | 41 | 0 | 56 | 

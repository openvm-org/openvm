...
| `total_proof_time_ms ` |  723.50 |  1,447 |  843 |  604 |
...
| `execute_metered_insn_mi/s` |  27.64 | -          |  27.64 |  27.64 |
| `execute_preflight_insns` |  872,878.50 |  1,745,757 |  1,151,000 |  594,757 |
| `execute_preflight_time_ms` |  82.50 |  165 |  118 |  47 |
| `execute_preflight_insn_mi/s` |  14.80 | -          |  18.11 |  11.48 |
| `trace_gen_time_ms   ` |  185.50 |  371 |  203 |  168 |
...
| `generate_perm_trace_time_ms` |  43.50 |  87 |  46 |  41 |
| `perm_trace_commit_time_ms` |  74.66 |  149.31 |  85.42 |  63.89 |
| `quotient_poly_compute_time_ms` |  82.64 |  165.27 |  89.89 |  75.38 |
| `quotient_poly_commit_time_ms` |  17.64 |  35.28 |  19.96 |  15.32 |
| `pcs_opening_time_ms ` |  61.50 |  123 |  66 |  57 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 604 | 1 | 63 | 1,745,757 | 27.64 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 168 | 843 | 32,579,050 | 172,558,444 | 168 | 388 | 0 | 89.89 | 19.96 | 6 | 85.42 | 66 | 135 | 65 | 1 | 76 | 15,992,408 | 46 | 118 | 1,151,000 | 11.48 | 27 | 110 | 1 | 65 | 
| pairing | 1 | 203 | 604 | 22,427,652 | 119,958,502 | 203 | 311 | 1 | 75.38 | 15.32 | 5 | 63.89 | 57 | 107 | 57 | 0 | 54 | 9,471,642 | 41 | 47 | 594,757 | 18.11 | 21 | 91 | 1 | 57 | 

...
| `execute_e3_time_ms  ` |  123.50 |  247 |  140 |  107 |
| `execute_e3_insn_mi/s` |  16.93 | -          |  17.95 |  15.92 |
| `memory_finalize_time_ms` |  6.50 |  13 |  11 |  2 |
| `boundary_finalize_time_ms` |  2 |  4 |  4 |  0 |
| `merkle_finalize_time_ms` |  154 |  308 |  240 |  68 |
| `stark_prove_excluding_trace_time_ms` |  3,048 |  6,096 |  3,823 |  2,273 |
| `main_trace_commit_time_ms` |  588.50 |  1,177 |  757 |  420 |
| `generate_perm_trace_time_ms` |  254.50 |  509 |  304 |  205 |
| `perm_trace_commit_time_ms` |  609 |  1,218 |  756 |  462 |
| `quotient_poly_compute_time_ms` |  337 |  674 |  435 |  239 |
| `quotient_poly_commit_time_ms` |  290 |  580 |  392 |  188 |
| `pcs_opening_time_ms ` |  960.50 |  1,921 |  1,173 |  748 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 3,914 | 24 | 4,165,433 | 1 | 36 | 113.81 | 63 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 536 | 373,166,268 | 3,823 | 435 | 392 | 756 | 1,173 | 240 | 25 | 11 | 757 | 2,244,000 | 304 | 140 | 15.92 | 4 | 
| regex_program | 1 | 310 | 242,975,370 | 2,273 | 239 | 188 | 462 | 748 | 68 | 24 | 2 | 420 | 1,921,433 | 205 | 107 | 17.95 | 0 | 

...
| `execute_e3_time_ms  ` |  122.50 |  245 |  139 |  106 |
| `execute_e3_insn_mi/s` |  17.08 | -          |  18.04 |  16.13 |
| `memory_finalize_time_ms` |  7.50 |  15 |  11 |  4 |
| `boundary_finalize_time_ms` |  2 |  4 |  4 |  0 |
| `merkle_finalize_time_ms` |  152.50 |  305 |  235 |  70 |
| `stark_prove_excluding_trace_time_ms` |  3,022.50 |  6,045 |  3,790 |  2,255 |
| `main_trace_commit_time_ms` |  580 |  1,160 |  762 |  398 |
| `generate_perm_trace_time_ms` |  249 |  498 |  299 |  199 |
| `perm_trace_commit_time_ms` |  609 |  1,218 |  755 |  463 |
| `quotient_poly_compute_time_ms` |  333 |  666 |  424 |  242 |
| `quotient_poly_commit_time_ms` |  280.50 |  561 |  373 |  188 |
| `pcs_opening_time_ms ` |  963.50 |  1,927 |  1,171 |  756 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 3,890 | 24 | 4,165,433 | 1 | 36 | 113.78 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 533 | 373,166,268 | 3,790 | 424 | 373 | 755 | 1,171 | 235 | 25 | 11 | 762 | 2,244,000 | 299 | 139 | 16.13 | 4 | 
| regex_program | 1 | 313 | 242,975,370 | 2,255 | 242 | 188 | 463 | 756 | 70 | 24 | 4 | 398 | 1,921,433 | 199 | 106 | 18.04 | 0 | 

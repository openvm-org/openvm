...
| `execute_metered_insn_mi/s` |  113.59 | -          |  113.59 |  113.59 |
| `execute_e3_time_ms  ` |  123 |  246 |  139 |  107 |
| `execute_e3_insn_mi/s` |  16.94 | -          |  17.84 |  16.05 |
| `memory_finalize_time_ms` |  6.50 |  13 |  11 |  2 |
| `boundary_finalize_time_ms` |  2 |  4 |  4 |  0 |
| `merkle_finalize_time_ms` |  156.50 |  313 |  243 |  70 |
| `stark_prove_excluding_trace_time_ms` |  3,052 |  6,104 |  3,830 |  2,274 |
| `main_trace_commit_time_ms` |  581.50 |  1,163 |  762 |  401 |
| `generate_perm_trace_time_ms` |  255 |  510 |  309 |  201 |
| `perm_trace_commit_time_ms` |  610.50 |  1,221 |  758 |  463 |
| `quotient_poly_compute_time_ms` |  336 |  672 |  428 |  244 |
| `quotient_poly_commit_time_ms` |  282.50 |  565 |  369 |  196 |
| `pcs_opening_time_ms ` |  979 |  1,958 |  1,199 |  759 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 3,912 | 24 | 4,165,433 | 1 | 36 | 113.59 | 62 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 526 | 373,166,268 | 3,830 | 428 | 369 | 758 | 1,199 | 243 | 25 | 11 | 762 | 2,244,000 | 309 | 139 | 16.05 | 4 | 
| regex_program | 1 | 302 | 242,975,370 | 2,274 | 244 | 196 | 463 | 759 | 70 | 24 | 2 | 401 | 1,921,433 | 201 | 107 | 17.84 | 0 | 

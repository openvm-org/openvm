...
|:---|---:|---:|---:|
| Total |  12.49 |  3.60 |  3.60 |
| app_proof |  10.25 |  1.85 |  1.85 |
| leaf |  1.48 |  0.98 |  0.98 |
...
| `total_proof_time_ms ` |  1,684.83 |  10,109 |  1,715 |  1,642 |
...
| `execute_preflight_time_ms` |  122.67 |  736 |  153 |  85 |
| `execute_preflight_insn_mi/s` |  41.08 | -          |  42.06 |  39.37 |
| `trace_gen_time_ms   ` |  166.83 |  1,001 |  199 |  145 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,258.67 |  7,552 |  1,285 |  1,224 |
| `prover.main_trace_commit_time_ms` |  289.17 |  1,735 |  290 |  289 |
| `prover.rap_constraints_time_ms` |  881.17 |  5,287 |  904 |  847 |
| `prover.openings_time_ms` |  87.17 |  523 |  91 |  83 |
| `prover.rap_constraints.logup_gkr_time_ms` |  293.83 |  1,763 |  312 |  246 |
| `prover.rap_constraints.round0_time_ms` |  447.33 |  2,684 |  462 |  393 |
| `prover.rap_constraints.mle_rounds_time_ms` |  138.83 |  833 |  141 |  135 |
| `prover.openings.stacked_reduction_time_ms` |  54.67 |  328 |  56 |  52 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  737.50 |  1,475 |  976 |  499 |
| `execute_preflight_time_ms` |  2 |  4 |  2 |  2 |
| `trace_gen_time_ms   ` |  76.50 |  153 |  103 |  50 |
| `generate_blob_total_time_ms` |  9.50 |  19 |  13 |  6 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  660.50 |  1,321 |  872 |  449 |
| `prover.main_trace_commit_time_ms` |  364.50 |  729 |  506 |  223 |
| `prover.rap_constraints_time_ms` |  227 |  454 |  288 |  166 |
| `prover.openings_time_ms` |  67.50 |  135 |  77 |  58 |
| `prover.rap_constraints.logup_gkr_time_ms` |  59.50 |  119 |  74 |  45 |
| `prover.rap_constraints.round0_time_ms` |  103 |  206 |  134 |  72 |
...
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  439 |  439 |  439 |  439 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/4cdf911143b4fe2c2f8ed0a6a409ab2799ad5a09/sha2_bench-4cdf911143b4fe2c2f8ed0a6a409ab2799ad5a09.memory.svg)
...
| app_proof |  |  |  |  |  | 1,687 |  |  | 139 | 14,793,960 | 105.88 | 0 | 10,258 |  | 
| internal_for_leaf |  |  |  | 472 |  |  |  |  |  |  |  |  |  | 472 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 32 | 472 | 32 | 11 | 2 | 2 | 1 | 1 | 
| internal_recursive.0 | 1 | 12 | 166 | 12 | 2 | 1 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 9 | 131 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 103 | 976 | 103 | 36 | 13 | 2 | 3 | 3 | 
| leaf | 1 | 50 | 499 | 49 | 18 | 6 | 2 | 3 | 3 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 75,647,988 | 439 | 229 | 0 | 1 | 165 | 46 | 46 | 87 | 30 | 0 | 44 | 22 | 22 | 7 | 15 | 229 | 165 | 0 | 3 | 29 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,943 | 153 | 50 | 0 | 0 | 73 | 26 | 25 | 29 | 17 | 0 | 29 | 20 | 8 | 2 | 6 | 50 | 73 | 0 | 2 | 17 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 122 | 31 | 0 | 0 | 63 | 24 | 23 | 25 | 13 | 0 | 26 | 19 | 7 | 1 | 5 | 32 | 63 | 0 | 2 | 13 | 0 | 0 | 
| leaf | 0 | prover | 266,554,214 | 872 | 505 | 0 | 92 | 288 | 134 | 133 | 79 | 74 | 0 | 77 | 36 | 41 | 22 | 18 | 506 | 288 | 0 | 7 | 73 | 0 | 0 | 
| leaf | 1 | prover | 135,243,508 | 449 | 223 | 0 | 1 | 166 | 72 | 71 | 48 | 45 | 0 | 58 | 35 | 23 | 11 | 11 | 223 | 166 | 0 | 6 | 45 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 353,899,717 | 1,224 | 289 | 0 | 1 | 847 | 393 | 393 | 141 | 312 | 76 | 87 | 31 | 56 | 33 | 23 | 289 | 847 | 0 | 3 | 234 | 0 | 0 | 
| app_proof | prover | 1 | 353,899,532 | 1,275 | 289 | 0 | 1 | 898 | 457 | 456 | 139 | 301 | 74 | 87 | 31 | 56 | 32 | 23 | 289 | 898 | 0 | 4 | 225 | 0 | 0 | 
| app_proof | prover | 2 | 353,899,532 | 1,285 | 290 | 0 | 1 | 904 | 459 | 459 | 141 | 302 | 74 | 90 | 34 | 55 | 33 | 22 | 290 | 904 | 0 | 4 | 227 | 0 | 0 | 
| app_proof | prover | 3 | 353,899,532 | 1,225 | 289 | 0 | 1 | 850 | 462 | 462 | 141 | 246 | 0 | 85 | 29 | 55 | 33 | 22 | 289 | 850 | 0 | 4 | 245 | 0 | 0 | 
| app_proof | prover | 4 | 353,899,532 | 1,275 | 289 | 0 | 1 | 901 | 461 | 461 | 136 | 303 | 75 | 83 | 29 | 54 | 32 | 21 | 289 | 901 | 0 | 4 | 228 | 0 | 0 | 
| app_proof | prover | 5 | 353,980,012 | 1,268 | 289 | 0 | 1 | 887 | 452 | 452 | 135 | 299 | 75 | 91 | 38 | 52 | 31 | 20 | 289 | 887 | 0 | 3 | 223 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 170 | 1,642 | 170 | 162 | 0 | 4 | 85 | 2,623,000 | 39.37 | 
| app_proof | 1 | 145 | 1,710 | 145 | 136 | 0 | 2 | 153 | 2,625,000 | 42.06 | 
| app_proof | 2 | 161 | 1,715 | 161 | 130 | 0 | 2 | 137 | 2,625,000 | 40.34 | 
| app_proof | 3 | 163 | 1,653 | 163 | 128 | 0 | 2 | 135 | 2,625,000 | 41.43 | 
| app_proof | 4 | 163 | 1,702 | 163 | 128 | 0 | 2 | 136 | 2,625,000 | 41.98 | 
| app_proof | 5 | 199 | 1,687 | 199 | 128 | 0 | 2 | 90 | 1,670,960 | 41.29 | 

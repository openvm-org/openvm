...
| `total_proof_time_ms ` |  1,953.50 |  3,907 |  2,267 |  1,640 |
| `execute_metered_time_ms` |  34 | -          | -          | -          |
| `execute_metered_insns` |  2,579,903 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  73.87 | -          |  73.87 |  73.87 |
| `execute_preflight_insns` |  1,289,951.50 |  2,579,903 |  1,540,000 |  1,039,903 |
| `execute_preflight_time_ms` |  99.50 |  199 |  137 |  62 |
| `execute_preflight_insn_mi/s` |  36.06 | -          |  37.20 |  34.93 |
| `trace_gen_time_ms   ` |  144.50 |  289 |  191 |  98 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,599.50 |  3,199 |  1,836 |  1,363 |
| `prover.main_trace_commit_time_ms` |  518 |  1,036 |  601 |  435 |
| `prover.rap_constraints_time_ms` |  949.50 |  1,899 |  1,095 |  804 |
| `prover.openings_time_ms` |  130.50 |  261 |  139 |  122 |
| `prover.rap_constraints.logup_gkr_time_ms` |  169.50 |  339 |  200 |  139 |
| `prover.rap_constraints.round0_time_ms` |  573.50 |  1,147 |  678 |  469 |
| `prover.rap_constraints.mle_rounds_time_ms` |  206 |  412 |  217 |  195 |
| `prover.openings.stacked_reduction_time_ms` |  95 |  190 |  104 |  86 |
...
| `prover.openings.whir_time_ms` |  35 |  70 |  36 |  34 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/907da84aed491fff7dc2cfbba3d5de00b5d3f79d/kitchen_sink-907da84aed491fff7dc2cfbba3d5de00b5d3f79d.memory.svg)
...
| app_proof |  |  |  |  |  | 1,640 |  |  | 34 | 2,579,903 | 73.87 | 0 | 3,947 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 20 | 281 | 20 | 6 | 1 | 2 | 2 | 2 | 
| internal_recursive.0 | 1 | 11 | 150 | 10 | 1 | 0 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 9 | 131 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 121 | 972 | 121 | 23 | 9 | 21 | 5 | 5 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,577,979 | 261 | 118 | 0 | 0 | 108 | 35 | 34 | 52 | 21 | 0 | 33 | 20 | 13 | 3 | 9 | 118 | 108 | 0 | 2 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,767 | 139 | 45 | 0 | 0 | 65 | 23 | 22 | 28 | 13 | 0 | 28 | 19 | 8 | 1 | 6 | 46 | 65 | 0 | 3 | 12 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 121 | 31 | 0 | 0 | 64 | 25 | 24 | 24 | 13 | 0 | 25 | 18 | 7 | 1 | 5 | 32 | 64 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 265,003,892 | 850 | 409 | 0 | 1 | 357 | 139 | 138 | 78 | 139 | 0 | 83 | 43 | 40 | 22 | 18 | 409 | 357 | 0 | 6 | 138 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 567,917,156 | 1,836 | 601 | 0 | 187 | 1,095 | 678 | 677 | 217 | 200 | 56 | 139 | 34 | 104 | 52 | 52 | 601 | 1,095 | 0 | 3 | 142 | 0 | 0 | 
| app_proof | prover | 1 | 537,266,124 | 1,363 | 435 | 0 | 2 | 804 | 469 | 469 | 195 | 139 | 0 | 122 | 36 | 86 | 49 | 36 | 435 | 804 | 0 | 3 | 138 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 191 | 2,267 | 191 | 176 | 0 | 4 | 62 | 1,540,000 | 34.93 | 
| app_proof | 1 | 98 | 1,640 | 98 | 41 | 0 | 2 | 137 | 1,039,903 | 37.20 | 

...
|:---|---:|---:|---:|
| Total |  5.46 |  3.82 |  3.82 |
| app_proof |  3.93 |  2.29 |  2.29 |
| leaf |  0.96 |  0.96 |  0.96 |
...
| `total_proof_time_ms ` |  1,946 |  3,892 |  2,258 |  1,634 |
...
| `execute_preflight_insn_mi/s` |  35.97 | -          |  36.57 |  35.37 |
| `trace_gen_time_ms   ` |  142.50 |  285 |  189 |  96 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,592 |  3,184 |  1,826 |  1,358 |
| `prover.main_trace_commit_time_ms` |  515.50 |  1,031 |  598 |  433 |
| `prover.rap_constraints_time_ms` |  946 |  1,892 |  1,091 |  801 |
| `prover.openings_time_ms` |  129 |  258 |  136 |  122 |
| `prover.rap_constraints.logup_gkr_time_ms` |  168.50 |  337 |  200 |  137 |
| `prover.rap_constraints.round0_time_ms` |  572.50 |  1,145 |  675 |  470 |
| `prover.rap_constraints.mle_rounds_time_ms` |  204.50 |  409 |  215 |  194 |
| `prover.openings.stacked_reduction_time_ms` |  93.50 |  187 |  101 |  86 |
...
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  839 |  839 |  839 |  839 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/4cdf911143b4fe2c2f8ed0a6a409ab2799ad5a09/kitchen_sink-4cdf911143b4fe2c2f8ed0a6a409ab2799ad5a09.memory.svg)
...
| app_proof |  |  |  |  |  | 1,635 |  |  | 34 | 2,579,903 | 74.07 | 0 | 3,933 |  | 
...
| leaf | 0 | 121 | 960 | 120 | 23 | 9 | 21 | 5 | 5 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,577,979 | 262 | 118 | 0 | 0 | 109 | 35 | 35 | 52 | 21 | 0 | 33 | 19 | 13 | 3 | 9 | 119 | 109 | 0 | 2 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,767 | 145 | 46 | 0 | 0 | 68 | 25 | 24 | 28 | 14 | 0 | 30 | 21 | 8 | 1 | 6 | 46 | 68 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 123 | 31 | 0 | 0 | 64 | 25 | 24 | 24 | 14 | 0 | 27 | 19 | 7 | 1 | 5 | 31 | 64 | 0 | 2 | 13 | 0 | 0 | 
| leaf | 0 | prover | 265,003,892 | 839 | 405 | 0 | 1 | 353 | 137 | 136 | 77 | 138 | 0 | 79 | 39 | 40 | 21 | 18 | 405 | 353 | 0 | 7 | 138 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 567,917,156 | 1,826 | 598 | 0 | 185 | 1,091 | 675 | 674 | 215 | 200 | 55 | 136 | 35 | 101 | 49 | 51 | 598 | 1,091 | 0 | 3 | 142 | 0 | 0 | 
| app_proof | prover | 1 | 537,266,124 | 1,358 | 433 | 0 | 2 | 801 | 470 | 469 | 194 | 137 | 0 | 122 | 36 | 86 | 48 | 37 | 433 | 801 | 0 | 4 | 136 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 189 | 2,258 | 189 | 178 | 0 | 4 | 64 | 1,540,000 | 35.37 | 
| app_proof | 1 | 96 | 1,634 | 96 | 41 | 0 | 2 | 139 | 1,039,903 | 36.57 | 

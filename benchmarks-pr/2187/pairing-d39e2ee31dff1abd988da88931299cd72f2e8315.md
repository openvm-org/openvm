...
| `total_proof_time_ms ` |  717 |  1,434 |  825 |  609 |
...
| `execute_preflight_insn_mi/s` |  13.55 | -          |  18.08 |  9.02 |
| `trace_gen_time_ms   ` |  181 |  362 |  200 |  162 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  348 |  696 |  387 |  309 |
| `main_trace_commit_time_ms` |  65 |  130 |  76 |  54 |
| `generate_perm_trace_time_ms` |  38.50 |  77 |  41 |  36 |
| `perm_trace_commit_time_ms` |  79.07 |  158.15 |  91.69 |  66.45 |
| `quotient_poly_compute_time_ms` |  81.23 |  162.46 |  90.38 |  72.07 |
| `quotient_poly_commit_time_ms` |  16.99 |  33.97 |  19.15 |  14.82 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 609 | 40 | 1 | 89 | 1,745,742 | 19.44 | 144 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 162 | 825 | 32,689,110 | 172,558,444 | 162 | 387 | 0 | 90.38 | 19.15 | 6 | 91.69 | 68 | 131 | 68 | 1 | 76 | 16,059,916 | 36 | 131 | 1,157,000 | 9.02 | 27 | 110 | 1 | 68 | 
| pairing | 1 | 200 | 609 | 22,314,288 | 119,958,502 | 200 | 309 | 1 | 72.07 | 14.82 | 5 | 66.45 | 55 | 111 | 55 | 0 | 54 | 9,408,294 | 41 | 59 | 588,742 | 18.08 | 20 | 87 | 1 | 55 | 

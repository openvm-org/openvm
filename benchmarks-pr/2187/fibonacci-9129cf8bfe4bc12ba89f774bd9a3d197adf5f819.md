...
|:---|---:|---:|
| Total |  1.01 |  0.56 |
| fibonacci_program |  0.100 |  0.55 |


| fibonacci_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  499 |  998 |  553 |  445 |
...
| `execute_metered_insn_mi/s` |  145.86 | -          |  145.86 |  145.86 |
| `execute_preflight_insns` |  750,104.50 |  1,500,209 |  873,000 |  627,209 |
| `execute_preflight_time_ms` |  30.50 |  61 |  35 |  26 |
| `execute_preflight_insn_mi/s` |  35.06 | -          |  36.24 |  33.87 |
| `trace_gen_time_ms   ` |  190 |  380 |  194 |  186 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  185.50 |  371 |  188 |  183 |
| `main_trace_commit_time_ms` |  30.50 |  61 |  33 |  28 |
| `generate_perm_trace_time_ms` |  33 |  66 |  38 |  28 |
| `perm_trace_commit_time_ms` |  41.15 |  82.31 |  43.73 |  38.58 |
| `quotient_poly_compute_time_ms` |  28.100 |  57.100 |  29.33 |  28.67 |
| `quotient_poly_commit_time_ms` |  11.07 |  22.14 |  11.13 |  11 |
| `pcs_opening_time_ms ` |  38 |  76 |  40 |  36 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 445 | 41 | 1 | 10 | 1,500,209 | 145.86 | 143 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 194 | 553 | 9,677,708 | 84,395,212 | 194 | 188 | 0 | 29.33 | 11 | 4 | 43.73 | 40 | 72 | 40 | 0 | 33 | 1,035,986 | 28 | 26 | 873,000 | 33.87 | 13 | 40 | 0 | 40 | 
| fibonacci_program | 1 | 186 | 445 | 9,708,170 | 74,305,770 | 186 | 183 | 1 | 28.67 | 11.13 | 4 | 38.58 | 36 | 77 | 36 | 0 | 28 | 1,064,416 | 38 | 35 | 627,209 | 36.24 | 11 | 40 | 0 | 36 | 

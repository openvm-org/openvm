...
| `total_proof_time_ms ` |  720.50 |  1,441 |  834 |  607 |
...
| `execute_preflight_insn_mi/s` |  12.66 | -          |  16.60 |  8.71 |
| `trace_gen_time_ms   ` |  173.50 |  347 |  191 |  156 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  354 |  708 |  397 |  311 |
| `main_trace_commit_time_ms` |  65 |  130 |  75 |  55 |
| `generate_perm_trace_time_ms` |  39 |  78 |  41 |  37 |
| `perm_trace_commit_time_ms` |  77.74 |  155.47 |  89.63 |  65.85 |
| `quotient_poly_compute_time_ms` |  79.40 |  158.80 |  87.45 |  71.35 |
| `quotient_poly_commit_time_ms` |  16.08 |  32.16 |  17.36 |  14.81 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 607 | 65 | 1 | 90 | 1,745,742 | 19.27 | 169 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 156 | 834 | 32,689,110 | 172,558,444 | 156 | 397 | 0 | 87.45 | 17.36 | 6 | 89.63 | 86 | 129 | 85 | 1 | 75 | 16,059,916 | 37 | 136 | 1,157,000 | 8.71 | 26 | 105 | 1 | 85 | 
| pairing | 1 | 191 | 607 | 22,314,288 | 119,958,502 | 191 | 311 | 1 | 71.35 | 14.81 | 6 | 65.85 | 58 | 110 | 58 | 0 | 55 | 9,408,294 | 41 | 64 | 588,742 | 16.60 | 20 | 86 | 1 | 58 | 

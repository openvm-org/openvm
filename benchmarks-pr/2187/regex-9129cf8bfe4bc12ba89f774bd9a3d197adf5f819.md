...
| `total_proof_time_ms ` |  583.25 |  2,333 |  695 |  543 |
...
| `execute_metered_insn_mi/s` |  124.69 | -          |  124.69 |  124.69 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  54.75 |  219 |  67 |  46 |
| `execute_preflight_insn_mi/s` |  30.46 | -          |  31.53 |  27.32 |
| `trace_gen_time_ms   ` |  181 |  724 |  215 |  157 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  279.75 |  1,119 |  288 |  273 |
| `main_trace_commit_time_ms` |  52.50 |  210 |  58 |  50 |
| `generate_perm_trace_time_ms` |  26.25 |  105 |  35 |  20 |
| `perm_trace_commit_time_ms` |  64.60 |  258.42 |  71.57 |  55.37 |
| `quotient_poly_compute_time_ms` |  58.85 |  235.41 |  72.50 |  52.87 |
| `quotient_poly_commit_time_ms` |  15.24 |  60.96 |  17.34 |  13.03 |
| `pcs_opening_time_ms ` |  59 |  236 |  62 |  57 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 547 | 67 | 1 | 33 | 4,137,502 | 124.69 | 193 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 215 | 695 | 23,446,148 | 150,778,428 | 215 | 288 | 0 | 57.04 | 17.34 | 5 | 71.57 | 58 | 96 | 57 | 4 | 58 | 10,899,170 | 23 | 47 | 1,103,000 | 27.32 | 21 | 75 | 1 | 57 | 
| regex_program | 1 | 157 | 548 | 11,598,276 | 128,513,066 | 157 | 282 | 1 | 53 | 15.29 | 4 | 65.72 | 59 | 102 | 59 | 0 | 51 | 2,196,106 | 35 | 67 | 1,104,000 | 31.53 | 17 | 68 | 0 | 59 | 
| regex_program | 2 | 165 | 543 | 11,579,064 | 128,513,066 | 165 | 276 | 1 | 52.87 | 15.30 | 5 | 65.76 | 62 | 93 | 62 | 0 | 51 | 2,177,334 | 27 | 59 | 1,104,000 | 31.47 | 17 | 68 | 0 | 62 | 
| regex_program | 3 | 187 | 547 | 11,853,872 | 103,456,394 | 187 | 273 | 0 | 72.50 | 13.03 | 5 | 55.37 | 57 | 78 | 57 | 0 | 50 | 2,422,606 | 20 | 46 | 826,502 | 31.53 | 18 | 86 | 1 | 57 | 

...
| leaf |  22.43 |  22.43 |
| internal.0 |  5.93 |  5.93 |
| root |  38.59 |  38.59 |
| halo2_outer |  88.75 |  88.75 |
...
| `total_proof_time_ms ` |  14,697 |  14,697 |  14,697 |  14,697 |
...
| `stark_prove_excluding_trace_time_ms` |  14,136 |  14,136 |  14,136 |  14,136 |
...
| `pcs_opening_time_ms ` |  1,213 |  1,213 |  1,213 |  1,213 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  22,431 |  22,431 |  22,431 |  22,431 |
| `main_cells_used     ` |  769,361,594 |  769,361,594 |  769,361,594 |  769,361,594 |
| `total_cells_used    ` |  2,050,262,676 |  2,050,262,676 |  2,050,262,676 |  2,050,262,676 |
| `insns               ` |  7,903,854 |  7,903,854 |  7,903,854 |  7,903,854 |
| `execute_preflight_time_ms` |  1,343 |  1,343 |  1,343 |  1,343 |
| `execute_preflight_insn_mi/s` |  6.83 | -          |  6.83 |  6.83 |
| `trace_gen_time_ms   ` |  1,607 |  1,607 |  1,607 |  1,607 |
| `memory_finalize_time_ms` |  20 |  20 |  20 |  20 |
| `stark_prove_excluding_trace_time_ms` |  18,373 |  18,373 |  18,373 |  18,373 |
| `main_trace_commit_time_ms` |  3,754 |  3,754 |  3,754 |  3,754 |
| `generate_perm_trace_time_ms` |  1,759 |  1,759 |  1,759 |  1,759 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  5,927 |  5,927 |  5,927 |  5,927 |
| `main_cells_used     ` |  79,528,515 |  79,528,515 |  79,528,515 |  79,528,515 |
| `total_cells_used    ` |  143,467,305 |  143,467,305 |  143,467,305 |  143,467,305 |
| `insns               ` |  1,197,872 |  1,197,872 |  1,197,872 |  1,197,872 |
| `execute_preflight_time_ms` |  482 |  482 |  482 |  482 |
| `execute_preflight_insn_mi/s` |  3.67 | -          |  3.67 |  3.67 |
| `trace_gen_time_ms   ` |  181 |  181 |  181 |  181 |
| `memory_finalize_time_ms` |  11 |  11 |  11 |  11 |
| `stark_prove_excluding_trace_time_ms` |  4,263 |  4,263 |  4,263 |  4,263 |
| `main_trace_commit_time_ms` |  914 |  914 |  914 |  914 |
| `generate_perm_trace_time_ms` |  193 |  193 |  193 |  193 |
| `perm_trace_commit_time_ms` |  660 |  660 |  660 |  660 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  38,588 |  38,588 |  38,588 |  38,588 |
...
| `stark_prove_excluding_trace_time_ms` |  38,310 |  38,310 |  38,310 |  38,310 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  88,748 |  88,748 |  88,748 |  88,748 |
| `main_cells_used     ` |  65,627,358 |  65,627,358 |  65,627,358 |  65,627,358 |

| halo2_wrapper |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  44,509 |  44,509 |  44,509 |  44,509 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
|  | 115 | 64,201,132 | 115 | 0 | 88,761 | 44,509 | 9 | 41,518,302 | 772,581 | 297 | 5.42 | 14,750 | 39,598 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| halo2_outer | 88,748 |  |  |  |  |  | 65,627,358 |  |  |  |  |  | 
| halo2_wrapper | 44,509 |  |  |  |  |  |  |  |  |  |  |  | 
| internal.0 |  |  | 5,929 |  | 3 |  |  |  | 2 |  |  |  | 
| kitchen_sink |  |  |  | 14,697 |  | 5 |  | 153,644 | 1 | 10 | 14.59 | 37 | 
| leaf |  | 22,438 |  |  | 1 |  |  |  | 1 |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal.0 | 0 | 181 | 5,927 | 143,467,305 | 224,975,330 | 181 | 4,263 | 0 | 596 | 677 | 660 | 1,218 | 11 | 914 | 79,528,515 | 1,197,872 | 193 |  | 482 | 3.67 | 
| leaf | 0 | 1,607 | 22,431 | 2,050,262,676 | 2,500,267,498 | 1,607 | 18,373 | 0 | 2,125 | 1,318 | 4,824 | 4,587 | 20 | 3,754 | 769,361,594 | 7,903,854 | 1,759 |  | 1,343 | 6.83 | 
| root | 0 | 116 | 38,588 | 64,201,132 | 80,435,354 | 116 | 38,310 | 0 | 736 | 13,677 | 7,578 | 3,898 | 9 | 12,318 | 41,518,302 | 772,581 | 93 | 3 | 162 | 5.31 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| kitchen_sink | 0 | 209 | 14,697 | 1,226,975,002 | 1,481,193,346 | 209 | 14,136 | 3 | 6,277 | 283 | 1,367 | 1,213 | 5 | 2 | 4,494 | 904,738,232 | 153,644 | 453 | 102 | 7.36 | 

...
|:---|---:|---:|---:|
| Total | <span style='color: red'>(+0 [+1.7%])</span> 1.52 | <span style='color: red'>(+0 [+2.1%])</span> 0.92 | 0.92 |
| pairing | <span style='color: red'>(+0 [+1.7%])</span> 1.52 | <span style='color: red'>(+0 [+2.1%])</span> 0.92 |  0.92 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+13 [+1.8%])</span> 730.50 | <span style='color: red'>(+26 [+1.8%])</span> 1,461 | <span style='color: red'>(+19 [+2.3%])</span> 855 | <span style='color: red'>(+7 [+1.2%])</span> 606 |
...
| `execute_metered_insn_mi/s` |  27.47 | -          |  27.47 |  27.47 |
| `execute_preflight_insns` |  872,871 |  1,745,742 |  1,149,000 |  596,742 |
| `execute_preflight_time_ms` | <span style='color: green'>(-2 [-1.8%])</span> 82.50 | <span style='color: green'>(-3 [-1.8%])</span> 165 | <span style='color: green'>(-1 [-0.9%])</span> 105 | <span style='color: green'>(-2 [-3.2%])</span> 60 |
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+0 [+0.6%])</span> 14.82 | -          | <span style='color: red'>(+0 [+0.3%])</span> 18.35 | <span style='color: red'>(+0 [+1.1%])</span> 11.29 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+9 [+5.0%])</span> 190 | <span style='color: red'>(+18 [+5.0%])</span> 380 | <span style='color: red'>(+9 [+4.8%])</span> 196 | <span style='color: red'>(+9 [+5.1%])</span> 184 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+6 [+1.6%])</span> 352 | <span style='color: red'>(+11 [+1.6%])</span> 704 | <span style='color: red'>(+12 [+3.1%])</span> 396 | <span style='color: green'>(-1 [-0.3%])</span> 308 |
...
| `generate_perm_trace_time_ms` | <span style='color: red'>(+1 [+2.9%])</span> 35 | <span style='color: red'>(+2 [+2.9%])</span> 70 | <span style='color: red'>(+1 [+2.6%])</span> 40 | <span style='color: red'>(+1 [+3.4%])</span> 30 |
| `perm_trace_commit_time_ms` | <span style='color: red'>(+2 [+2.4%])</span> 78.32 | <span style='color: red'>(+4 [+2.4%])</span> 156.64 | <span style='color: red'>(+2 [+2.6%])</span> 90.14 | <span style='color: red'>(+1 [+2.1%])</span> 66.50 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+3 [+3.5%])</span> 84.99 | <span style='color: red'>(+6 [+3.5%])</span> 169.99 | <span style='color: red'>(+5 [+5.5%])</span> 95 | <span style='color: red'>(+1 [+1.0%])</span> 74.99 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+1 [+4.3%])</span> 17.77 | <span style='color: red'>(+1 [+4.3%])</span> 35.55 | <span style='color: red'>(+1 [+3.5%])</span> 19.53 | <span style='color: red'>(+1 [+5.3%])</span> 16.02 |
| `pcs_opening_time_ms ` | <span style='color: green'>(-2 [-2.9%])</span> 66 | <span style='color: green'>(-4 [-2.9%])</span> 132 | <span style='color: red'>(+2 [+2.9%])</span> 71 | <span style='color: green'>(-6 [-9.0%])</span> 61 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 606 | 1 | 63 | 1,745,742 | 27.47 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 184 | 855 | 32,480,114 | 172,558,444 | 184 | 396 | 0 | 95 | 19.53 | 6 | 90.14 | 71 | 133 | 71 | 1 | 76 | 15,909,408 | 40 | 105 | 1,149,000 | 11.29 | 27 | 115 | 1 | 71 | 
| pairing | 1 | 196 | 606 | 22,464,232 | 119,958,502 | 196 | 308 | 1 | 74.99 | 16.02 | 5 | 66.50 | 61 | 100 | 60 | 0 | 54 | 9,498,894 | 30 | 60 | 596,742 | 18.35 | 21 | 91 | 1 | 60 | 
...
Commit: https://github.com/openvm-org/openvm/commit/45eb8fdd99dbe65f457cb8cd108a4bf14787c101
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/20596330623)

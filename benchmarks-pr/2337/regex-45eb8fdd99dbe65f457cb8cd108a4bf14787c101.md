...
|:---|---:|---:|---:|
| Total | <span style='color: green'>(-0 [-2.3%])</span> 2.36 | <span style='color: green'>(-0 [-0.7%])</span> 0.75 | 0.75 |
| regex_program | <span style='color: green'>(-0 [-2.3%])</span> 2.36 | <span style='color: green'>(-0 [-0.7%])</span> 0.75 |  0.75 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: green'>(-14 [-2.3%])</span> 581.75 | <span style='color: green'>(-56 [-2.3%])</span> 2,327 | <span style='color: green'>(-5 [-0.7%])</span> 710 | <span style='color: green'>(-18 [-3.3%])</span> 521 |
...
| `execute_metered_insn_mi/s` | <span style='color: green'>(-1 [-0.9%])</span> 109.62 | -          | <span style='color: green'>(-1 [-0.9%])</span> 109.62 | <span style='color: green'>(-1 [-0.9%])</span> 109.62 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` | <span style='color: green'>(-1 [-1.4%])</span> 52.25 | <span style='color: green'>(-3 [-1.4%])</span> 209 |  64 |  44 |
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+0 [+0.7%])</span> 32.31 | -          | <span style='color: red'>(+0 [+0.2%])</span> 33.51 | <span style='color: red'>(+0 [+1.5%])</span> 29.29 |
| `trace_gen_time_ms   ` | <span style='color: green'>(-2 [-1.4%])</span> 170.50 | <span style='color: green'>(-10 [-1.4%])</span> 682 | <span style='color: green'>(-2 [-1.1%])</span> 184 | <span style='color: green'>(-1 [-0.6%])</span> 157 |
| `memory_finalize_time_ms` |  1 |  4 |  4 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: green'>(-12 [-3.9%])</span> 284.75 | <span style='color: green'>(-46 [-3.9%])</span> 1,139 | <span style='color: green'>(-1 [-0.3%])</span> 315 | <span style='color: green'>(-14 [-5.1%])</span> 262 |
| `main_trace_commit_time_ms` | <span style='color: green'>(-0 [-1.0%])</span> 52 | <span style='color: green'>(-2 [-1.0%])</span> 208 | <span style='color: green'>(-1 [-1.7%])</span> 57 |  50 |
| `generate_perm_trace_time_ms` | <span style='color: green'>(-7 [-20.7%])</span> 26.75 | <span style='color: green'>(-28 [-20.7%])</span> 107 | <span style='color: green'>(-20 [-39.2%])</span> 31 |  24 |
| `perm_trace_commit_time_ms` | <span style='color: red'>(+0 [+0.6%])</span> 64.80 | <span style='color: red'>(+1 [+0.6%])</span> 259.21 |  71.89 | <span style='color: red'>(+0 [+0.2%])</span> 55.36 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+0 [+0.5%])</span> 59.94 | <span style='color: red'>(+1 [+0.5%])</span> 239.78 | <span style='color: green'>(-0 [-0.3%])</span> 70.28 | <span style='color: red'>(+0 [+0.6%])</span> 53.67 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+0 [+1.5%])</span> 15.93 | <span style='color: red'>(+1 [+1.5%])</span> 63.70 | <span style='color: red'>(+1 [+3.7%])</span> 18.72 | <span style='color: red'>(+1 [+5.5%])</span> 14.05 |
| `pcs_opening_time_ms ` | <span style='color: green'>(-5 [-7.1%])</span> 62.25 | <span style='color: green'>(-19 [-7.1%])</span> 249 | <span style='color: green'>(-1 [-1.3%])</span> 75 | <span style='color: green'>(-12 [-19.7%])</span> 49 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 559 | 1 | 37 | 4,137,502 | 109.62 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 181 | 710 | 23,446,148 | 150,778,428 | 181 | 315 | 0 | 60.85 | 18.72 | 6 | 71.89 | 75 | 101 | 75 | 4 | 57 | 10,899,170 | 28 | 44 | 1,103,000 | 29.29 | 22 | 80 | 1 | 75 | 
| regex_program | 1 | 157 | 537 | 11,598,276 | 128,513,066 | 156 | 274 | 1 | 53.67 | 15.12 | 5 | 65.31 | 63 | 90 | 63 | 0 | 51 | 2,196,106 | 24 | 64 | 1,104,000 | 33.51 | 17 | 69 | 0 | 63 | 
| regex_program | 2 | 160 | 521 | 11,579,064 | 128,513,066 | 160 | 262 | 1 | 54.98 | 15.81 | 4 | 66.66 | 49 | 91 | 48 | 0 | 50 | 2,177,334 | 24 | 57 | 1,104,000 | 33.38 | 17 | 71 | 0 | 48 | 
| regex_program | 3 | 184 | 559 | 11,853,872 | 103,456,394 | 184 | 288 | 0 | 70.28 | 14.05 | 5 | 55.36 | 62 | 89 | 62 | 0 | 50 | 2,422,606 | 31 | 44 | 826,502 | 33.06 | 19 | 85 | 1 | 62 | 

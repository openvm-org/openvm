...
| `total_proof_time_ms ` |  766.50 |  3,066 |  921 |  555 |
| `execute_metered_time_ms` |  67 | -          | -          | -          |
| `execute_metered_insns` |  12,000,265 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  178.79 | -          |  178.79 |  178.79 |
| `execute_preflight_insns` |  3,000,066.25 |  12,000,265 |  3,495,000 |  1,515,265 |
| `execute_preflight_time_ms` |  85.25 |  341 |  105 |  44 |
| `execute_preflight_insn_mi/s` |  47.34 | -          |  48.40 |  44.39 |
| `record_arena.alloc_time_ms` |  21 |  84 |  32 |  12 |
| `trace_gen_time_ms   ` |  138.75 |  555 |  173 |  120 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  472.25 |  1,889 |  538 |  296 |
| `prover.main_trace_commit_time_ms` |  99 |  396 |  113 |  59 |
| `prover.rap_constraints_time_ms` |  272.75 |  1,091 |  311 |  170 |
| `prover.openings_time_ms` |  99.25 |  397 |  113 |  66 |
| `prover.rap_constraints.logup_gkr_time_ms` |  196.25 |  785 |  224 |  119 |
| `prover.rap_constraints.round0_time_ms` |  51 |  204 |  60 |  33 |
...
| `prover.openings.whir_time_ms` |  80.25 |  321 |  92 |  53 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/8289aee81b966042c09aadc3480517253949bdf5/fibonacci-8289aee81b966042c09aadc3480517253949bdf5.memory.svg)
...
| app_proof |  |  |  |  |  | 555 |  |  | 67 | 12,000,265 | 178.79 | 0 | 3,141 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 329 | 118 | 0 | 0 | 106 | 35 | 34 | 50 | 20 | 0 | 104 | 90 | 13 | 3 | 9 | 118 | 106 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 166 | 46 | 0 | 0 | 67 | 24 | 24 | 28 | 13 | 0 | 52 | 43 | 8 | 1 | 6 | 46 | 66 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 140 | 32 | 0 | 0 | 63 | 23 | 22 | 24 | 15 | 0 | 43 | 36 | 7 | 1 | 5 | 32 | 63 | 0 | 2 | 13 | 0 | 0 | 
| leaf | 0 | prover | 147,934,254 | 611 | 233 | 0 | 0 | 183 | 84 | 83 | 53 | 45 | 0 | 194 | 169 | 24 | 12 | 12 | 233 | 183 | 0 | 8 | 44 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 136,618,054 | 538 | 112 | 0 | 0 | 311 | 60 | 59 | 27 | 224 | 0 | 113 | 92 | 21 | 11 | 9 | 112 | 311 | 0 | 3 | 222 | 0 | 0 | 
| app_proof | prover | 1 | 136,570,716 | 527 | 112 | 0 | 0 | 303 | 55 | 55 | 27 | 220 | 0 | 110 | 89 | 21 | 12 | 8 | 113 | 303 | 0 | 3 | 219 | 0 | 0 | 
| app_proof | prover | 2 | 136,570,716 | 528 | 112 | 0 | 0 | 307 | 56 | 56 | 27 | 222 | 0 | 108 | 87 | 21 | 12 | 9 | 112 | 307 | 0 | 3 | 222 | 0 | 0 | 
| app_proof | prover | 3 | 70,295,004 | 296 | 59 | 0 | 0 | 170 | 33 | 32 | 17 | 119 | 0 | 66 | 53 | 12 | 6 | 6 | 59 | 170 | 0 | 3 | 118 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 154 | 135 | 921 | 135 | 154 | 13 | 2,770,197,065 | 323,292,691 | 3,093,489,756 | 2,097,152 | 0 | 3 | 92 | 3,495,000 | 44.39 | 
| app_proof | 1 | 41 | 120 | 794 | 120 | 41 | 32 | 2,768,862,357 | 322,353,414 | 3,091,215,771 | 2,097,152 | 0 | 1 | 105 | 3,495,000 | 48.31 | 
| app_proof | 2 | 41 | 127 | 796 | 127 | 41 | 27 | 2,768,862,357 | 322,353,414 | 3,091,215,771 | 2,097,152 | 0 | 1 | 100 | 3,495,000 | 48.40 | 
| app_proof | 3 | 41 | 173 | 555 | 173 | 41 | 12 | 1,230,956,171 | 342,871,578 | 1,573,827,749 | 2,097,152 | 0 | 2 | 44 | 1,515,265 | 48.24 | 

...
| `total_proof_time_ms ` |  2,625.33 |  15,752 |  2,985 |  2,535 |
...
| `execute_preflight_time_ms` |  189.33 |  1,136 |  275 |  17 |
| `execute_preflight_insn_mi/s` |  17.14 | -          |  17.38 |  16.88 |
| `trace_gen_time_ms   ` |  385.33 |  2,312 |  539 |  350 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,987.17 |  11,923 |  2,257 |  1,926 |
| `prover.main_trace_commit_time_ms` |  692.17 |  4,153 |  852 |  659 |
| `prover.rap_constraints_time_ms` |  1,111.33 |  6,668 |  1,222 |  1,086 |
| `prover.openings_time_ms` |  182.33 |  1,094 |  186 |  178 |
| `prover.rap_constraints.logup_gkr_time_ms` |  276 |  1,656 |  386 |  253 |
| `prover.rap_constraints.round0_time_ms` |  519 |  3,114 |  521 |  517 |
| `prover.rap_constraints.mle_rounds_time_ms` |  315.33 |  1,892 |  318 |  312 |
| `prover.openings.stacked_reduction_time_ms` |  139.50 |  837 |  143 |  137 |
| `prover.openings.stacked_reduction.round0_time_ms` |  84.33 |  506 |  87 |  80 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,105 |  2,210 |  1,438 |  772 |
| `execute_preflight_time_ms` |  4.50 |  9 |  5 |  4 |
| `trace_gen_time_ms   ` |  141 |  282 |  191 |  91 |
| `generate_blob_total_time_ms` |  25.50 |  51 |  34 |  17 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  964 |  1,928 |  1,247 |  681 |
| `prover.main_trace_commit_time_ms` |  547 |  1,094 |  720 |  374 |
| `prover.rap_constraints_time_ms` |  311.50 |  623 |  401 |  222 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/61ee02051eb604c485ac49e948a254e80d67ce0b/keccak-61ee02051eb604c485ac49e948a254e80d67ce0b.memory.svg)
...
| app_proof |  |  |  |  |  | 2,539 |  |  | 36 | 1,235,218 | 33.49 | 0 | 15,796 |  | 
...
| internal_recursive.0 | 1 | 12 | 193 | 12 | 2 | 1 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 9 | 150 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 191 | 1,438 | 190 | 65 | 34 | 5 | 7 | 7 | 
| leaf | 1 | 91 | 772 | 91 | 33 | 17 | 4 | 7 | 7 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 109,497,984 | 480 | 248 | 0 | 14 | 173 | 45 | 45 | 94 | 33 | 0 | 58 | 20 | 38 | 7 | 30 | 248 | 173 | 0 | 3 | 32 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 25,962,119 | 180 | 51 | 0 | 3 | 76 | 23 | 23 | 29 | 23 | 0 | 52 | 28 | 24 | 1 | 22 | 51 | 76 | 0 | 2 | 21 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 17,507,975 | 141 | 34 | 0 | 3 | 64 | 21 | 21 | 24 | 18 | 0 | 41 | 19 | 22 | 1 | 21 | 34 | 64 | 0 | 2 | 17 | 0 | 0 | 
| leaf | 0 | prover | 583,523,386 | 1,247 | 720 | 0 | 47 | 401 | 195 | 194 | 124 | 82 | 0 | 124 | 38 | 86 | 40 | 45 | 720 | 401 | 0 | 6 | 81 | 0 | 0 | 
| leaf | 1 | prover | 300,618,208 | 681 | 374 | 0 | 24 | 222 | 104 | 103 | 67 | 50 | 0 | 83 | 31 | 52 | 20 | 32 | 374 | 222 | 0 | 5 | 49 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,205,061,845 | 2,257 | 852 | 0 | 245 | 1,222 | 517 | 516 | 318 | 386 | 130 | 182 | 40 | 141 | 85 | 56 | 852 | 1,222 | 0 | 3 | 254 | 0 | 0 | 
| app_proof | prover | 1 | 1,205,053,652 | 1,935 | 659 | 0 | 51 | 1,088 | 521 | 521 | 312 | 253 | 0 | 186 | 47 | 139 | 85 | 54 | 659 | 1,088 | 0 | 3 | 252 | 0 | 0 | 
| app_proof | prover | 2 | 1,205,053,652 | 1,926 | 660 | 0 | 51 | 1,086 | 517 | 517 | 314 | 254 | 0 | 178 | 41 | 137 | 80 | 56 | 660 | 1,086 | 0 | 4 | 253 | 0 | 0 | 
| app_proof | prover | 3 | 1,205,053,652 | 1,933 | 660 | 0 | 51 | 1,089 | 520 | 519 | 315 | 254 | 0 | 183 | 43 | 139 | 85 | 54 | 660 | 1,089 | 0 | 4 | 253 | 0 | 0 | 
| app_proof | prover | 4 | 1,205,053,652 | 1,933 | 660 | 0 | 51 | 1,093 | 521 | 521 | 317 | 254 | 0 | 179 | 40 | 138 | 84 | 53 | 660 | 1,093 | 0 | 3 | 252 | 0 | 0 | 
| app_proof | prover | 5 | 1,205,062,652 | 1,939 | 662 | 0 | 52 | 1,090 | 518 | 517 | 316 | 255 | 0 | 186 | 42 | 143 | 87 | 56 | 662 | 1,090 | 0 | 3 | 254 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 539 | 2,985 | 539 | 170 | 0 | 188 | 17 | 207,000 | 16.88 | 
| app_proof | 1 | 350 | 2,602 | 350 | 40 | 0 | 1 | 275 | 207,000 | 17.13 | 
| app_proof | 2 | 351 | 2,535 | 351 | 40 | 0 | 1 | 217 | 207,000 | 17.14 | 
| app_proof | 3 | 351 | 2,545 | 351 | 40 | 0 | 1 | 218 | 207,000 | 17.14 | 
| app_proof | 4 | 351 | 2,546 | 351 | 40 | 0 | 1 | 220 | 207,000 | 17.16 | 
| app_proof | 5 | 370 | 2,539 | 370 | 40 | 0 | 20 | 189 | 200,218 | 17.38 | 

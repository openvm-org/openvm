...
|:---|---:|---:|
| Total | <span style='color: green'>(-0 [-0.5%])</span> 10.96 | <span style='color: green'>(-0 [-0.5%])</span> 10.96 |
| ecrecover_program | <span style='color: green'>(-0 [-4.6%])</span> 1.12 | <span style='color: green'>(-0 [-4.6%])</span> 1.12 |
| leaf |  9.84 |  9.84 |
...
| `total_proof_time_ms ` | <span style='color: green'>(-54 [-4.6%])</span> 1,115 | <span style='color: green'>(-54 [-4.6%])</span> 1,115 | <span style='color: green'>(-54 [-4.6%])</span> 1,115 | <span style='color: green'>(-54 [-4.6%])</span> 1,115 |
...
| `execute_metered_insn_mi/s` | <span style='color: red'>(+0 [+0.4%])</span> 20.28 | -          | <span style='color: red'>(+0 [+0.4%])</span> 20.28 | <span style='color: red'>(+0 [+0.4%])</span> 20.28 |
...
| `stark_prove_excluding_trace_time_ms` | <span style='color: green'>(-54 [-5.4%])</span> 942 | <span style='color: green'>(-54 [-5.4%])</span> 942 | <span style='color: green'>(-54 [-5.4%])</span> 942 | <span style='color: green'>(-54 [-5.4%])</span> 942 |
| `main_trace_commit_time_ms` | <span style='color: green'>(-4 [-2.9%])</span> 132 | <span style='color: green'>(-4 [-2.9%])</span> 132 | <span style='color: green'>(-4 [-2.9%])</span> 132 | <span style='color: green'>(-4 [-2.9%])</span> 132 |
...
| `perm_trace_commit_time_ms` | <span style='color: red'>(+14 [+10.9%])</span> 143 | <span style='color: red'>(+14 [+10.9%])</span> 143 | <span style='color: red'>(+14 [+10.9%])</span> 143 | <span style='color: red'>(+14 [+10.9%])</span> 143 |
...
| `quotient_poly_commit_time_ms` | <span style='color: green'>(-6 [-4.6%])</span> 125 | <span style='color: green'>(-6 [-4.6%])</span> 125 | <span style='color: green'>(-6 [-4.6%])</span> 125 | <span style='color: green'>(-6 [-4.6%])</span> 125 |
| `pcs_opening_time_ms ` | <span style='color: green'>(-56 [-11.9%])</span> 414 | <span style='color: green'>(-56 [-11.9%])</span> 414 | <span style='color: green'>(-56 [-11.9%])</span> 414 | <span style='color: green'>(-56 [-11.9%])</span> 414 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  9,840 |  9,840 |  9,840 |  9,840 |
| `main_cells_used     ` |  246,667,372 |  246,667,372 |  246,667,372 |  246,667,372 |
| `total_cells_used    ` |  645,427,514 |  645,427,514 |  645,427,514 |  645,427,514 |
| `insns               ` |  2,934,901 |  2,934,901 |  2,934,901 |  2,934,901 |
| `execute_e3_time_ms  ` |  981 |  981 |  981 |  981 |
| `execute_e3_insn_mi/s` |  2.99 | -          |  2.99 |  2.99 |
| `trace_gen_time_ms   ` |  623 |  623 |  623 |  623 |
| `memory_finalize_time_ms` |  16 |  16 |  16 |  16 |
| `boundary_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  8,236 |  8,236 |  8,236 |  8,236 |
| `main_trace_commit_time_ms` |  1,516 |  1,516 |  1,516 |  1,516 |
| `generate_perm_trace_time_ms` |  791 |  791 |  791 |  791 |
| `perm_trace_commit_time_ms` |  2,090 |  2,090 |  2,090 |  2,090 |
| `quotient_poly_compute_time_ms` |  957 |  957 |  957 |  957 |
| `quotient_poly_commit_time_ms` |  644 |  644 |  644 |  644 |
| `pcs_opening_time_ms ` |  2,235 |  2,235 |  2,235 |  2,235 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program |  | 1,368 |  | 6 | 137,284 | 1 | 6 | 20.28 | 38 | 
| leaf | 10,993 |  | 1 |  |  | 1 |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 623 | 9,840 | 645,427,514 | 992,054,762 | 619 | 8,236 | 2 | 957 | 644 | 2,090 | 2,235 | 16 | 1,516 | 246,667,372 | 2,934,901 | 791 | 981 | 2.99 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 93 | 1,115 | 25,968,337 | 32,925,330 | 92 | 942 | 2 | 79 | 125 | 143 | 414 | 54 | 7 | 2 | 132 | 8,596,011 | 137,284 | 29 | 80 | 1.70 | 0 | 

...
| `total_proof_time_ms ` |  1,494.50 |  2,989 |  1,725 |  1,264 |
...
| `execute_preflight_insn_mi/s` |  29.92 | -          |  31.59 |  28.25 |
| `trace_gen_time_ms   ` |  314.50 |  629 |  335 |  294 |
| `memory_finalize_time_ms` |  2 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  995 |  1,990 |  1,221 |  769 |
| `main_trace_commit_time_ms` |  143 |  286 |  185 |  101 |
| `generate_perm_trace_time_ms` |  60.50 |  121 |  66 |  55 |
| `perm_trace_commit_time_ms` |  171.63 |  343.27 |  226.56 |  116.71 |
| `quotient_poly_compute_time_ms` |  166.67 |  333.34 |  183.17 |  150.16 |
| `quotient_poly_commit_time_ms` |  37.18 |  74.37 |  49.06 |  25.31 |
| `pcs_opening_time_ms ` |  409.50 |  819 |  540 |  279 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 1,264 | 41 | 1 | 37 | 4,108,483 | 110.68 | 167 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 294 | 1,725 | 23,397,108 | 373,183,036 | 294 | 1,221 | 0 | 150.16 | 49.06 | 6 | 226.56 | 540 | 294 | 540 | 4 | 185 | 10,866,434 | 66 | 85 | 2,211,000 | 28.25 | 46 | 201 | 2 | 540 | 
| regex_program | 1 | 335 | 1,264 | 11,981,356 | 196,739,722 | 335 | 769 | 2 | 183.17 | 25.31 | 5 | 116.71 | 279 | 175 | 278 | 0 | 101 | 2,537,170 | 55 | 112 | 1,897,483 | 31.59 | 26 | 213 | 2 | 278 | 

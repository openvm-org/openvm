...
| `total_proof_time_ms ` |  1,488.50 |  2,977 |  1,706 |  1,271 |
...
| `execute_preflight_time_ms` |  98 |  196 |  113 |  83 |
| `execute_preflight_insn_mi/s` |  30.87 | -          |  32.74 |  28.99 |
| `trace_gen_time_ms   ` |  309.50 |  619 |  328 |  291 |
| `memory_finalize_time_ms` |  2 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  993.50 |  1,987 |  1,206 |  781 |
| `main_trace_commit_time_ms` |  140.50 |  281 |  182 |  99 |
| `generate_perm_trace_time_ms` |  58.50 |  117 |  64 |  53 |
| `perm_trace_commit_time_ms` |  171.26 |  342.51 |  222.73 |  119.79 |
| `quotient_poly_compute_time_ms` |  160.75 |  321.50 |  176.13 |  145.38 |
| `quotient_poly_commit_time_ms` |  35.84 |  71.68 |  47.29 |  24.38 |
| `pcs_opening_time_ms ` |  418.50 |  837 |  539 |  298 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 1,271 | 41 | 1 | 35 | 4,108,483 | 115.83 | 169 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 291 | 1,706 | 23,397,108 | 373,183,036 | 290 | 1,206 | 0 | 145.38 | 47.29 | 6 | 222.73 | 539 | 288 | 539 | 4 | 182 | 10,866,434 | 64 | 83 | 2,211,000 | 28.99 | 46 | 194 | 2 | 539 | 
| regex_program | 1 | 328 | 1,271 | 11,981,356 | 196,739,722 | 328 | 781 | 2 | 176.13 | 24.38 | 6 | 119.79 | 298 | 177 | 298 | 0 | 99 | 2,537,170 | 53 | 113 | 1,897,483 | 32.74 | 26 | 205 | 2 | 298 | 

...
| `total_proof_time_ms ` |  1,469 |  2,938 |  1,713 |  1,225 |
...
| `execute_metered_insn_mi/s` |  114.40 | -          |  114.40 |  114.40 |
| `execute_preflight_insns` |  2,054,241.50 |  4,108,483 |  2,211,000 |  1,897,483 |
| `execute_preflight_time_ms` |  95.50 |  191 |  109 |  82 |
| `execute_preflight_insn_mi/s` |  30.100 | -          |  32.69 |  29.31 |
| `trace_gen_time_ms   ` |  313.50 |  627 |  335 |  292 |
| `memory_finalize_time_ms` |  2 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  973 |  1,946 |  1,213 |  733 |
| `main_trace_commit_time_ms` |  141.50 |  283 |  185 |  98 |
| `generate_perm_trace_time_ms` |  55 |  110 |  63 |  47 |
| `perm_trace_commit_time_ms` |  172.11 |  344.22 |  224.64 |  119.58 |
| `quotient_poly_compute_time_ms` |  158.35 |  316.69 |  169.30 |  147.39 |
| `quotient_poly_commit_time_ms` |  35.96 |  71.92 |  48.16 |  23.76 |
| `pcs_opening_time_ms ` |  403 |  806 |  540 |  266 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 1,225 | 41 | 1 | 35 | 4,108,483 | 114.40 | 167 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 292 | 1,713 | 23,397,108 | 373,183,036 | 292 | 1,213 | 0 | 147.39 | 48.16 | 5 | 224.64 | 540 | 289 | 539 | 4 | 185 | 10,866,434 | 63 | 82 | 2,211,000 | 29.31 | 46 | 197 | 2 | 539 | 
| regex_program | 1 | 335 | 1,225 | 11,981,356 | 196,739,722 | 335 | 733 | 2 | 169.30 | 23.76 | 5 | 119.58 | 266 | 170 | 266 | 0 | 98 | 2,537,170 | 47 | 109 | 1,897,483 | 32.69 | 26 | 198 | 2 | 266 | 

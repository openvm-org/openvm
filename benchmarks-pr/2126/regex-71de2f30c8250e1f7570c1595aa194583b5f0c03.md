...
| `total_proof_time_ms ` |  1,474 |  2,948 |  1,713 |  1,235 |
...
| `execute_metered_insn_mi/s` |  106.45 | -          |  106.45 |  106.45 |
| `execute_preflight_insns` |  2,054,241.50 |  4,108,483 |  2,211,000 |  1,897,483 |
| `execute_preflight_time_ms` |  97.50 |  195 |  110 |  85 |
| `execute_preflight_insn_mi/s` |  30.12 | -          |  31.100 |  28.24 |
| `trace_gen_time_ms   ` |  311.50 |  623 |  332 |  291 |
| `memory_finalize_time_ms` |  2 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  978.50 |  1,957 |  1,212 |  745 |
| `main_trace_commit_time_ms` |  142 |  284 |  184 |  100 |
| `generate_perm_trace_time_ms` |  58 |  116 |  66 |  50 |
| `perm_trace_commit_time_ms` |  172.60 |  345.20 |  224.69 |  120.51 |
| `quotient_poly_compute_time_ms` |  160.37 |  320.74 |  174.27 |  146.47 |
| `quotient_poly_commit_time_ms` |  35.94 |  71.88 |  47.51 |  24.37 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 1,235 | 65 | 1 | 38 | 4,108,483 | 106.45 | 191 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 291 | 1,713 | 23,397,108 | 373,183,036 | 291 | 1,212 | 0 | 146.47 | 47.51 | 6 | 224.69 | 539 | 291 | 539 | 4 | 184 | 10,866,434 | 66 | 85 | 2,211,000 | 28.24 | 46 | 196 | 2 | 539 | 
| regex_program | 1 | 332 | 1,235 | 11,981,356 | 196,739,722 | 332 | 745 | 2 | 174.27 | 24.37 | 5 | 120.51 | 266 | 174 | 266 | 0 | 100 | 2,537,170 | 50 | 110 | 1,897,483 | 31.100 | 26 | 203 | 2 | 266 | 

...
| `total_proof_time_ms ` |  1,477 |  2,954 |  1,716 |  1,238 |
...
| `execute_preflight_insn_mi/s` |  29.82 | -          |  30.97 |  28.68 |
| `trace_gen_time_ms   ` |  312.50 |  625 |  332 |  293 |
| `memory_finalize_time_ms` |  2 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  979 |  1,958 |  1,212 |  746 |
| `main_trace_commit_time_ms` |  142 |  284 |  184 |  100 |
| `generate_perm_trace_time_ms` |  55.50 |  111 |  65 |  46 |
| `perm_trace_commit_time_ms` |  173.04 |  346.08 |  224.78 |  121.30 |
| `quotient_poly_compute_time_ms` |  162.25 |  324.50 |  176.46 |  148.04 |
| `quotient_poly_commit_time_ms` |  36.37 |  72.75 |  47.91 |  24.84 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 1,238 | 40 | 1 | 36 | 4,108,483 | 113.66 | 166 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 293 | 1,716 | 23,397,108 | 373,183,036 | 293 | 1,212 | 0 | 148.04 | 47.91 | 6 | 224.78 | 538 | 290 | 538 | 4 | 184 | 10,866,434 | 65 | 83 | 2,211,000 | 28.68 | 46 | 198 | 2 | 538 | 
| regex_program | 1 | 332 | 1,238 | 11,981,356 | 196,739,722 | 332 | 746 | 2 | 176.46 | 24.84 | 5 | 121.30 | 267 | 171 | 266 | 0 | 100 | 2,537,170 | 46 | 112 | 1,897,483 | 30.97 | 26 | 206 | 2 | 266 | 

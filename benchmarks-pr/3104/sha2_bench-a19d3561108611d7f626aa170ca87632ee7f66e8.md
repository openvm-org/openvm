...
|:---|---:|---:|---:|
| Total |  5.08 |  3.86 |  3.86 |
| app_proof |  4.14 |  2.91 |  2.91 |
| leaf |  0.52 |  0.52 |  0.52 |
...
| `total_proof_time_ms ` |  2,042 |  4,084 |  2,697 |  1,387 |
...
| `execute_preflight_time_ms` |  246.50 |  493 |  331 |  162 |
| `execute_preflight_insn_mi/s` |  22.65 | -          |  24.86 |  21.49 |
| `postflight_time_ms  ` |  133.50 |  267 |  184 |  83 |
| `postflight_memory_chronology_time_ms` |  12.50 |  25 |  20 |  5 |
| `postflight_program_index_time_ms` |  1 |  2 |  1 |  1 |
| `trace_gen_time_ms   ` |  53 |  106 |  74 |  32 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,570 |  3,140 |  2,059 |  1,081 |
| `prover.main_trace_commit_time_ms` |  389 |  778 |  563 |  215 |
| `prover.rap_constraints_time_ms` |  914 |  1,828 |  1,153 |  675 |
| `prover.openings_time_ms` |  265.50 |  531 |  341 |  190 |
| `prover.rap_constraints.logup_gkr_time_ms` |  219 |  438 |  242 |  196 |
| `prover.rap_constraints.round0_time_ms` |  513.50 |  1,027 |  677 |  350 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/a19d3561108611d7f626aa170ca87632ee7f66e8/sha2_bench-a19d3561108611d7f626aa170ca87632ee7f66e8.memory.svg)
...
| leaf | 0 | prover | 237,929,272 | 406 | 145 | 0 | 0 | 143 | 72 | 71 | 44 | 26 | 0 | 116 | 94 | 22 | 10 | 11 | 146 | 145 | 143 | 0 | 3 | 25 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover |  | 0 | 1,280,474,507 | 2,059 | 563 | 0 | 0 | 1,153 | 677 | 676 | 234 | 242 | 1 | 341 | 248 | 93 | 57 | 36 | 563 | 563 | 1,153 | 0 | 1 | 240 | 0 | 0 | 
| app_proof | prover |  | 1 | 687,175,556 | 1,081 | 215 | 0 | 0 | 675 | 350 | 350 | 128 | 196 | 0 | 190 | 138 | 51 | 30 | 21 | 215 | 215 | 675 | 0 | 1 | 194 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof |  | 1,387 | 55 | 11,167,961 | 202.59 | 0 | 4,148 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof |  | 0 | 4 | 2 | 74 | 2,697 | 5 | 4 | 0 | 184 | 1 | 20 | 0 | 12,528,770,136 | 2,839,688,748 | 15,368,458,884 | 2,097,152 | 2 | 0 | 2 | 5 | 68 | 331 | 7,136,000 | 21.49 | 0 | 0 | 
| app_proof |  | 1 | 3 | 2 | 32 | 1,387 | 3 | 3 | 0 | 83 | 1 | 5 | 0 | 7,111,262,244 | 1,553,197,749 | 8,664,459,993 | 2,097,152 | 2 | 0 | 0 | 2 | 29 | 162 | 4,031,961 | 24.86 | 0 | 0 | 

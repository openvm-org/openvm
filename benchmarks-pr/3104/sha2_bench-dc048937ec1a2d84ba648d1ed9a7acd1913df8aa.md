...
|:---|---:|---:|---:|
| Total |  5.03 |  3.83 |  3.83 |
| app_proof |  4.09 |  2.89 |  2.89 |
| leaf |  0.52 |  0.52 |  0.52 |
...
| `total_proof_time_ms ` |  2,016 |  4,032 |  2,676 |  1,356 |
| `compile_metered_time_ms` |  5 |  5 |  5 |  5 |
| `execute_metered_time_ms` |  54 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  204.04 | -          |  204.04 |  204.04 |
| `set_initial_memory_time_ms` |  3.50 |  7 |  4 |  3 |
| `execute_preflight_insns` |  5,583,980.50 |  11,167,961 |  7,136,000 |  4,031,961 |
| `execute_preflight_time_ms` |  245.50 |  491 |  331 |  160 |
| `execute_preflight_insn_mi/s` |  22.75 | -          |  25.13 |  21.54 |
| `postflight_time_ms  ` |  122.50 |  245 |  181 |  64 |
| `postflight_memory_chronology_time_ms` |  12 |  24 |  20 |  4 |
| `postflight_program_index_time_ms` |  1.50 |  3 |  2 |  1 |
| `trace_gen_time_ms   ` |  41 |  82 |  57 |  25 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,569 |  3,138 |  2,057 |  1,081 |
| `prover.main_trace_commit_time_ms` |  390 |  780 |  567 |  213 |
| `prover.rap_constraints_time_ms` |  909 |  1,818 |  1,147 |  671 |
| `prover.openings_time_ms` |  269 |  538 |  342 |  196 |
| `prover.rap_constraints.logup_gkr_time_ms` |  217.50 |  435 |  241 |  194 |
| `prover.rap_constraints.round0_time_ms` |  512 |  1,024 |  674 |  350 |
...
| `prover.openings.whir_time_ms` |  196.50 |  393 |  249 |  144 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/dc048937ec1a2d84ba648d1ed9a7acd1913df8aa/sha2_bench-dc048937ec1a2d84ba648d1ed9a7acd1913df8aa.memory.svg)
...
| leaf | 0 | 110 | 516 | 110 | 31 | 12 | 2 | 10 | 10 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover |  | 0 | 1,280,474,509 | 2,057 | 567 | 0 | 0 | 1,147 | 674 | 674 | 230 | 241 | 1 | 342 | 249 | 93 | 57 | 36 | 567 | 567 | 1,147 | 0 | 1 | 239 | 0 | 0 | 
| app_proof | prover |  | 1 | 687,175,556 | 1,081 | 213 | 0 | 0 | 671 | 350 | 349 | 126 | 194 | 0 | 196 | 144 | 51 | 30 | 21 | 213 | 213 | 671 | 0 | 1 | 193 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof |  | 1,356 | 54 | 11,167,961 | 204.04 | 0 | 4,095 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof |  | 0 | 4 | 2 | 57 | 2,676 | 3 | 4 | 0 | 181 | 2 | 20 | 0 | 12,528,770,160 | 2,839,688,748 | 15,368,458,908 | 2,097,152 | 2 | 0 | 0 | 3 | 53 | 331 | 7,136,000 | 21.54 | 0 | 0 | 
| app_proof |  | 1 | 3 | 2 | 25 | 1,356 | 3 | 3 | 0 | 64 | 1 | 4 | 0 | 7,111,262,244 | 1,553,197,749 | 8,664,459,993 | 2,097,152 | 2 | 0 | 0 | 2 | 21 | 160 | 4,031,961 | 25.13 | 0 | 0 | 

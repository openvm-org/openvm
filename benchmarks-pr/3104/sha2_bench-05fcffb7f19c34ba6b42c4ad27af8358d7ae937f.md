...
|:---|---:|---:|---:|
| Total |  5.10 |  3.90 |  3.90 |
| app_proof |  4.15 |  2.96 |  2.96 |
| leaf |  0.52 |  0.52 |  0.52 |
...
| `total_proof_time_ms ` |  2,049.50 |  4,099 |  2,744 |  1,355 |
| `compile_metered_time_ms` |  5 |  5 |  5 |  5 |
| `execute_metered_time_ms` |  55 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  202.35 | -          |  202.35 |  202.35 |
| `set_initial_memory_time_ms` |  3.50 |  7 |  4 |  3 |
| `execute_preflight_insns` |  5,583,980.50 |  11,167,961 |  7,136,000 |  4,031,961 |
| `execute_preflight_time_ms` |  244.50 |  489 |  327 |  162 |
| `execute_preflight_insn_mi/s` |  22.84 | -          |  24.81 |  21.76 |
| `postflight_time_ms  ` |  85.50 |  171 |  116 |  55 |
| `postflight_memory_chronology_time_ms` |  12 |  24 |  20 |  4 |
| `postflight_program_index_time_ms` |  1.50 |  3 |  2 |  1 |
| `trace_gen_time_ms   ` |  40 |  80 |  56 |  24 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,642.50 |  3,285 |  2,198 |  1,087 |
| `prover.main_trace_commit_time_ms` |  391.50 |  783 |  566 |  217 |
| `prover.rap_constraints_time_ms` |  982 |  1,964 |  1,289 |  675 |
| `prover.openings_time_ms` |  268 |  536 |  342 |  194 |
...
| `prover.openings.whir_time_ms` |  195 |  390 |  248 |  142 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/05fcffb7f19c34ba6b42c4ad27af8358d7ae937f/sha2_bench-05fcffb7f19c34ba6b42c4ad27af8358d7ae937f.memory.svg)
...
| prover.batch_constraints.before_round0 | 13.95 | app_proof.prover..0 |
| frac_sumcheck.gkr_rounds | 13.95 | app_proof.prover..0 |
| prover.gkr_input_evals | 13.13 | app_proof.prover..0 |
| frac_sumcheck.segment_tree | 13.13 | app_proof.prover..0 |
...
| app_proof | 15 | HintStoreAir | prover |  | 0 | 2 | 25 | 50 | 
...
| app_proof | 15 | HintStoreAir |  | 0 | 2 |  | 250 |  | 200 |  | 50 |  | 1,305 |  | 36 |  | 
...
| leaf | 0 | 107 | 515 | 107 | 31 | 12 | 2 | 9 | 9 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 179 | 46 | 0 | 0 | 78 | 27 | 27 | 37 | 13 | 0 | 54 | 43 | 10 | 2 | 7 | 46 | 46 | 78 | 0 | 1 | 12 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover |  | 0 | 1,282,965,388 | 2,198 | 566 | 0 | 0 | 1,289 | 700 | 700 | 233 | 355 | 1 | 342 | 248 | 93 | 57 | 36 | 566 | 566 | 1,289 | 0 | 1 | 353 | 0 | 0 | 
| app_proof | prover |  | 1 | 688,421,252 | 1,087 | 217 | 0 | 0 | 675 | 351 | 350 | 128 | 195 | 0 | 194 | 142 | 51 | 30 | 21 | 217 | 217 | 675 | 0 | 1 | 194 | 0 | 0 | 

| group | phase | program | segment | trace_height_constraint | weighted_sum | threshold |
| --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover |  | 0 | 0 | 268,723,686 | 2,013,265,921 | 
| app_proof | prover |  | 1 | 0 | 163,932,162 | 2,013,265,921 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof |  | 1,355 | 55 | 11,167,961 | 202.35 | 0 | 4,163 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof |  | 0 | 4 | 2 | 56 | 2,744 | 3 | 4 | 0 | 116 | 2 | 20 | 0 | 12,552,642,552 | 2,845,706,904 | 15,398,349,456 | 2,097,152 | 2 | 0 | 0 | 3 | 52 | 327 | 7,136,000 | 21.76 | 0 | 0 | 
| app_proof |  | 1 | 3 | 2 | 24 | 1,355 | 3 | 3 | 0 | 55 | 1 | 4 | 0 | 7,124,752,848 | 1,575,610,889 | 8,700,363,737 | 2,097,152 | 2 | 0 | 0 | 2 | 21 | 162 | 4,031,961 | 24.81 | 0 | 0 | 

...
| `total_proof_time_ms ` |  2,026.50 |  4,053 |  2,691 |  1,362 |
| `compile_metered_time_ms` |  4 |  4 |  4 |  4 |
| `execute_metered_time_ms` |  55 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  202.90 | -          |  202.90 |  202.90 |
...
| `execute_preflight_insn_mi/s` |  22.16 | -          |  24.55 |  20.95 |
| `postflight_time_ms  ` |  124.50 |  249 |  180 |  69 |
| `postflight_memory_chronology_time_ms` |  12 |  24 |  20 |  4 |
| `postflight_program_index_time_ms` |  1.50 |  3 |  2 |  1 |
| `trace_gen_time_ms   ` |  41 |  82 |  57 |  25 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,570 |  3,140 |  2,064 |  1,076 |
| `prover.main_trace_commit_time_ms` |  392.50 |  785 |  571 |  214 |
| `prover.rap_constraints_time_ms` |  909 |  1,818 |  1,149 |  669 |
| `prover.openings_time_ms` |  267.50 |  535 |  343 |  192 |
| `prover.rap_constraints.logup_gkr_time_ms` |  217 |  434 |  241 |  193 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/19b412a9e0d11b1522128705a0dd978c10af6afe/sha2_bench-19b412a9e0d11b1522128705a0dd978c10af6afe.memory.svg)

| Module | Max (GB) | Max At |
| --- | ---: | --- |
| prover.stacked_commit | 14.45 | app_proof.prover..0 |
| frac_sumcheck.gkr_rounds | 13.37 | app_proof.prover..0 |
| prover.batch_constraints.before_round0 | 13.37 | app_proof.prover..0 |
| frac_sumcheck.segment_tree | 13.06 | app_proof.prover..0 |
| prover.gkr_input_evals | 13.06 | app_proof.prover..0 |
...
| app_proof | 12 | Sha2MainAir<Sha256Config> | prover |  | 0 | 131,072 | 134 | 17,563,648 | 
...
| app_proof | 12 | Sha2MainAir<Sha256Config> | prover |  | 1 | 65,536 | 134 | 8,781,824 | 
...
| app_proof | 12 | Sha2MainAir<Sha256Config> |  | 0 | 104,688 | 26,384 | 70,140,960 | 17,677,280 | 56,112,768 | 14,141,824 | 14,028,192 | 3,535,456 | 322,569,900 | 81,295,700 | 8,898,480 | 2,242,640 | 
...
| app_proof | 12 | Sha2MainAir<Sha256Config> |  | 1 | 59,153 | 6,383 | 39,632,510 | 4,276,610 | 31,706,008 | 3,421,288 | 7,926,502 | 855,322 | 182,265,182 | 19,667,618 | 5,028,005 | 542,555 | 
...
| leaf | 0 | 112 | 524 | 112 | 32 | 12 | 2 | 10 | 10 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 175 | 46 | 0 | 0 | 80 | 29 | 28 | 37 | 14 | 0 | 48 | 37 | 10 | 2 | 7 | 47 | 46 | 80 | 0 | 1 | 12 | 0 | 0 | 
...
| leaf | 0 | prover | 237,929,272 | 411 | 145 | 0 | 0 | 143 | 72 | 71 | 44 | 26 | 0 | 122 | 100 | 22 | 10 | 11 | 146 | 145 | 143 | 0 | 3 | 25 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover |  | 0 | 1,280,867,725 | 2,064 | 571 | 0 | 0 | 1,149 | 674 | 673 | 233 | 241 | 1 | 343 | 249 | 93 | 57 | 36 | 571 | 571 | 1,149 | 0 | 1 | 239 | 0 | 0 | 
| app_proof | prover |  | 1 | 687,372,164 | 1,076 | 214 | 0 | 0 | 669 | 350 | 349 | 125 | 193 | 0 | 192 | 140 | 52 | 31 | 21 | 214 | 214 | 669 | 0 | 1 | 192 | 0 | 0 | 

| group | phase | program | segment | trace_height_constraint | weighted_sum | threshold |
| --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover |  | 0 | 0 | 266,625,510 | 2,013,265,921 | 
| app_proof | prover |  | 1 | 0 | 162,882,562 | 2,013,265,921 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof |  | 1,362 | 55 | 11,167,961 | 202.90 | 0 | 4,117 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof |  | 0 | 4 | 2 | 57 | 2,691 | 3 | 4 | 0 | 180 | 2 | 20 | 0 | 12,532,538,928 | 2,840,638,572 | 15,373,177,500 | 2,097,152 | 2 | 0 | 0 | 3 | 53 | 340 | 7,136,000 | 20.95 | 0 | 0 | 
| app_proof |  | 1 | 3 | 2 | 25 | 1,362 | 3 | 3 | 0 | 69 | 1 | 4 | 0 | 7,113,391,752 | 1,544,727,633 | 8,658,119,385 | 2,097,152 | 2 | 0 | 0 | 2 | 21 | 164 | 4,031,961 | 24.55 | 0 | 0 | 

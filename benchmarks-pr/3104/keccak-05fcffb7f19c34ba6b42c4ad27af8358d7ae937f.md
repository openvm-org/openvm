...
|:---|---:|---:|---:|
| Total |  9.50 |  3.36 |  3.36 |
| app_proof |  7.34 |  1.70 |  1.70 |
| leaf |  1.59 |  1.09 |  1.09 |
...
| `total_proof_time_ms ` |  1,203.33 |  7,220 |  1,257 |  1,177 |
| `compile_metered_time_ms` |  4 |  4 |  4 |  4 |
| `execute_metered_time_ms` |  125 | -          | -          | -          |
| `execute_metered_insns` |  14,365,133 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  114.14 | -          |  114.14 |  114.14 |
| `set_initial_memory_time_ms` |  2.50 |  15 |  4 |  2 |
| `execute_preflight_insns` |  2,394,188.83 |  14,365,133 |  2,413,000 |  2,300,133 |
| `execute_preflight_time_ms` |  67.17 |  403 |  83 |  61 |
| `execute_preflight_insn_mi/s` |  35.65 | -          |  37.44 |  28.76 |
| `postflight_time_ms  ` |  30.50 |  183 |  39 |  27 |
| `postflight_memory_chronology_time_ms` |  3 |  18 |  6 |  2 |
| `postflight_program_index_time_ms` |  0 |  0 |  0 |  0 |
| `trace_gen_time_ms   ` |  13 |  78 |  18 |  12 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,073.83 |  6,443 |  1,094 |  1,060 |
| `prover.main_trace_commit_time_ms` |  340.17 |  2,041 |  359 |  333 |
| `prover.rap_constraints_time_ms` |  507.50 |  3,045 |  509 |  504 |
| `prover.openings_time_ms` |  225.17 |  1,351 |  227 |  221 |
| `prover.rap_constraints.logup_gkr_time_ms` |  103 |  618 |  104 |  101 |
| `prover.rap_constraints.round0_time_ms` |  281.33 |  1,688 |  282 |  280 |
| `prover.rap_constraints.mle_rounds_time_ms` |  121.83 |  731 |  122 |  121 |
| `prover.openings.stacked_reduction_time_ms` |  59.83 |  359 |  61 |  58 |
| `prover.openings.stacked_reduction.round0_time_ms` |  35.17 |  211 |  36 |  34 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  24 |  144 |  24 |  24 |
| `prover.openings.whir_time_ms` |  164.83 |  989 |  166 |  162 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  793 |  1,586 |  1,092 |  494 |
| `execute_preflight_time_ms` |  4 |  8 |  4 |  4 |
| `trace_gen_time_ms   ` |  135.50 |  271 |  181 |  90 |
| `generate_blob_total_time_ms` |  15.50 |  31 |  21 |  10 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  657 |  1,314 |  911 |  403 |
| `prover.main_trace_commit_time_ms` |  264 |  528 |  383 |  145 |
| `prover.rap_constraints_time_ms` |  186.50 |  373 |  231 |  142 |
| `prover.openings_time_ms` |  205.50 |  411 |  296 |  115 |
...
| `prover.openings.whir_time_ms` |  176 |  352 |  259 |  93 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/05fcffb7f19c34ba6b42c4ad27af8358d7ae937f/keccak-05fcffb7f19c34ba6b42c4ad27af8358d7ae937f.memory.svg)
...
| frac_sumcheck.gkr_rounds | 6.18 | app_proof.prover..4 |
| prover.batch_constraints.before_round0 | 6.18 | app_proof.prover..4 |
| prover.gkr_input_evals | 6.14 | app_proof.prover..4 |
| frac_sumcheck.segment_tree | 6.14 | app_proof.prover..4 |
...
| internal_recursive.0 | 1 | 13 | 134 | 13 | 2 | 0 | 2 | 2 | 2 | 
| internal_recursive.1 | 1 | 10 | 111 | 10 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 181 | 1,092 | 180 | 56 | 21 | 4 | 11 | 11 | 
| leaf | 1 | 90 | 494 | 90 | 28 | 10 | 4 | 11 | 11 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 81,415,160 | 285 | 92 | 0 | 0 | 113 | 39 | 38 | 56 | 17 | 0 | 78 | 63 | 15 | 5 | 10 | 93 | 92 | 113 | 0 | 1 | 16 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,945 | 120 | 21 | 0 | 0 | 59 | 21 | 20 | 24 | 12 | 0 | 39 | 31 | 8 | 1 | 6 | 21 | 21 | 59 | 0 | 1 | 12 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 100 | 15 | 0 | 0 | 53 | 20 | 19 | 21 | 11 | 0 | 31 | 24 | 7 | 1 | 5 | 15 | 15 | 53 | 0 | 1 | 10 | 0 | 0 | 
| leaf | 0 | prover | 476,578,798 |
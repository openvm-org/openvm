...
|:---|---:|---:|---:|
| Total |  5.18 |  3.91 |  3.91 |
| app_proof |  4.24 |  2.97 |  2.97 |
| leaf |  0.51 |  0.51 |  0.51 |
...
| `total_proof_time_ms ` |  2,092 |  4,184 |  2,761 |  1,423 |
| `compile_metered_time_ms` |  3 |  3 |  3 |  3 |
| `execute_metered_time_ms` |  57 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  193.09 | -          |  193.09 |  193.09 |
| `set_initial_memory_time_ms` |  19 |  38 |  37 |  1 |
| `execute_preflight_insns` |  5,583,980.50 |  11,167,961 |  7,136,000 |  4,031,961 |
| `execute_preflight_time_ms` |  234 |  468 |  314 |  154 |
| `execute_preflight_insn_mi/s` |  23.86 | -          |  26.12 |  22.71 |
| `postflight_time_ms  ` |  131 |  262 |  137 |  125 |
| `postflight_memory_chronology_time_ms` |  12.50 |  25 |  21 |  4 |
| `postflight_program_index_time_ms` |  1 |  2 |  1 |  1 |
| `trace_gen_time_ms   ` |  36 |  72 |  48 |  24 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,644 |  3,288 |  2,201 |  1,087 |
| `prover.main_trace_commit_time_ms` |  391.50 |  783 |  565 |  218 |
| `prover.rap_constraints_time_ms` |  984.50 |  1,969 |  1,292 |  677 |
| `prover.openings_time_ms` |  267.50 |  535 |  344 |  191 |
| `prover.rap_constraints.logup_gkr_time_ms` |  276.50 |  553 |  357 |  196 |
| `prover.rap_constraints.round0_time_ms` |  525.50 |  1,051 |  699 |  352 |
...
| `prover.openings.whir_time_ms` |  193.50 |  387 |  249 |  138 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  513 |  513 |  513 |  513 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/4df0fa8af3cc5ef6e546e4b1fa18158c0a91bd7f/sha2_bench-4df0fa8af3cc5ef6e546e4b1fa18158c0a91bd7f.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 172 | 46 | 0 | 0 | 78 | 27 | 27 | 37 | 13 | 0 | 47 | 36 | 10 | 2 | 7 | 46 | 46 | 78 | 0 | 1 | 12 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 114 | 20 | 0 | 0 | 56 | 22 | 21 | 23 | 11 | 0 | 37 | 29 | 7 | 1 | 6 | 20 | 20 | 56 | 0 | 1 | 10 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 94 | 15 | 0 | 0 | 52 | 20 | 19 | 21 | 10 | 0 | 26 | 19 | 7 | 1 | 5 | 15 | 15 | 52 | 0 | 1 | 10 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover |  | 0 | 1,291,616,142 | 2,201 | 565 | 0 | 0 | 1,292 | 699 | 698 | 235 | 357 | 1 | 344 | 249 | 95 | 58 | 36 | 565 | 565 | 1,292 | 0 | 1 | 355 | 0 | 0 | 
| app_proof | prover |  | 1 | 693,795,340 | 1,087 | 218 | 0 | 0 | 677 | 352 | 352 | 128 | 196 | 0 | 191 | 138 | 52 | 31 | 21 | 218 | 218 | 677 | 0 | 1 | 195 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof |  | 1,423 | 57 | 11,167,961 | 193.09 | 0 | 4,249 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof |  | 0 | 37 | 2 | 48 | 2,761 | 3 | 37 | 0 | 125 | 1 | 21 | 0 | 12,618,085,836 | 2,884,072,668 | 15,502,158,504 | 2,097,152 | 2 | 0 | 0 | 3 | 45 | 314 | 7,136,000 | 22.71 | 0 | 0 | 
| app_proof |  | 1 | 1 | 2 | 24 | 1,423 | 2 | 1 | 0 | 137 | 1 | 4 | 0 | 7,161,723,144 | 1,638,534,385 | 8,800,257,529 | 2,097,152 | 2 | 0 | 0 | 2 | 21 | 154 | 4,031,961 | 26.12 | 0 | 0 | 

...
|:---|---:|---:|---:|
| Total |  5.04 |  3.83 |  3.83 |
| app_proof |  4.09 |  2.88 |  2.88 |
| leaf |  0.52 |  0.52 |  0.52 |
...
| `total_proof_time_ms ` |  2,018 |  4,036 |  2,660 |  1,376 |
| `compile_metered_time_ms` |  5 |  5 |  5 |  5 |
| `execute_metered_time_ms` |  55 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  199.98 | -          |  199.98 |  199.98 |
| `set_initial_memory_time_ms` |  4 |  8 |  5 |  3 |
| `execute_preflight_insns` |  5,583,980.50 |  11,167,961 |  7,136,000 |  4,031,961 |
| `execute_preflight_time_ms` |  247.50 |  495 |  333 |  162 |
| `execute_preflight_insn_mi/s` |  22.56 | -          |  24.87 |  21.38 |
| `postflight_time_ms  ` |  127.50 |  255 |  170 |  85 |
...
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,568.50 |  3,137 |  2,057 |  1,080 |
| `prover.main_trace_commit_time_ms` |  391.50 |  783 |  570 |  213 |
| `prover.rap_constraints_time_ms` |  907 |  1,814 |  1,145 |  669 |
| `prover.openings_time_ms` |  268.50 |  537 |  341 |  196 |
| `prover.rap_constraints.logup_gkr_time_ms` |  216.50 |  433 |  240 |  193 |
| `prover.rap_constraints.round0_time_ms` |  511 |  1,022 |  672 |  350 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/6106bd03ae0157fa0d68995b88e2fe5b69c3217d/sha2_bench-6106bd03ae0157fa0d68995b88e2fe5b69c3217d.memory.svg)
...
| leaf | 0 | 112 | 519 | 112 | 34 | 12 | 2 | 9 | 9 | 
...
| leaf | 0 | prover | 237,929,272 | 407 | 145 | 0 | 0 | 143 | 72 | 71 | 44 | 26 | 0 | 117 | 96 | 21 | 10 | 11 | 145 | 145 | 143 | 0 | 3 | 25 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover |  | 0 | 1,280,474,509 | 2,057 | 569 | 0 | 0 | 1,145 | 672 | 672 | 232 | 240 | 1 | 341 | 249 | 92 | 56 | 35 | 570 | 569 | 1,145 | 0 | 1 | 237 | 0 | 0 | 
| app_proof | prover |  | 1 | 687,175,556 | 1,080 | 213 | 0 | 0 | 669 | 350 | 349 | 126 | 193 | 0 | 196 | 144 | 51 | 30 | 21 | 213 | 213 | 669 | 0 | 1 | 191 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof |  | 1,376 | 55 | 11,167,961 | 199.98 | 0 | 4,102 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof |  | 0 | 5 | 2 | 56 | 2,660 | 3 | 5 | 0 | 170 | 2 | 20 | 0 | 12,528,770,160 | 2,839,688,748 | 15,368,458,908 | 2,097,152 | 2 | 0 | 0 | 3 | 52 | 333 | 7,136,000 | 21.38 | 0 | 0 | 
| app_proof |  | 1 | 3 | 2 | 24 | 1,376 | 3 | 3 | 0 | 85 | 1 | 5 | 0 | 7,111,262,244 | 1,553,197,749 | 8,664,459,993 | 2,097,152 | 2 | 0 | 0 | 2 | 21 | 162 | 4,031,961 | 24.87 | 0 | 0 | 

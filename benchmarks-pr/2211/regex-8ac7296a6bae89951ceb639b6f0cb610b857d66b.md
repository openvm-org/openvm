...
| `total_proof_time_ms ` |  582.25 |  2,329 |  703 |  537 |
...
| `execute_preflight_time_ms` |  54.25 |  217 |  69 |  45 |
| `execute_preflight_insn_mi/s` |  30.42 | -          |  32.31 |  28.10 |
| `trace_gen_time_ms   ` |  178.75 |  715 |  213 |  153 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  281.75 |  1,127 |  300 |  270 |
| `main_trace_commit_time_ms` |  51.50 |  206 |  56 |  49 |
| `generate_perm_trace_time_ms` |  31 |  124 |  40 |  19 |
| `perm_trace_commit_time_ms` |  64.11 |  256.43 |  70.82 |  55.89 |
| `quotient_poly_compute_time_ms` |  58.43 |  233.71 |  69.54 |  52.48 |
| `quotient_poly_commit_time_ms` |  14.73 |  58.91 |  16.91 |  13.01 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 541 | 41 | 1 | 40 | 4,137,502 | 102.83 | 168 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 213 | 703 | 23,446,148 | 150,778,428 | 213 | 300 | 0 | 58.86 | 16.91 | 5 | 70.82 | 54 | 112 | 54 | 4 | 56 | 10,899,170 | 40 | 45 | 1,103,000 | 28.10 | 21 | 76 | 1 | 54 | 
| regex_program | 1 | 153 | 548 | 11,598,276 | 128,513,066 | 153 | 284 | 1 | 52.83 | 14.54 | 4 | 64.42 | 62 | 103 | 62 | 0 | 49 | 2,196,106 | 38 | 69 | 1,104,000 | 29.36 | 16 | 67 | 0 | 62 | 
| regex_program | 2 | 164 | 537 | 11,579,064 | 128,513,066 | 164 | 273 | 1 | 52.48 | 14.45 | 4 | 65.30 | 61 | 93 | 60 | 0 | 51 | 2,177,334 | 27 | 58 | 1,104,000 | 31.93 | 16 | 67 | 0 | 60 | 
| regex_program | 3 | 185 | 541 | 11,853,872 | 103,456,394 | 184 | 270 | 0 | 69.54 | 13.01 | 5 | 55.89 | 57 | 78 | 57 | 0 | 50 | 2,422,606 | 19 | 45 | 826,502 | 32.31 | 18 | 83 | 1 | 57 | 

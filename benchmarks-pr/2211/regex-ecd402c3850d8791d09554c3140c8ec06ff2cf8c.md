...
|:---|---:|---:|
| Total |  2.43 |  0.77 |
| regex_program |  2.39 |  0.74 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  598.25 |  2,393 |  738 |  547 |
...
| `execute_preflight_time_ms` |  56 |  224 |  66 |  47 |
| `execute_preflight_insn_mi/s` |  28.93 | -          |  30.68 |  24.66 |
| `trace_gen_time_ms   ` |  181.50 |  726 |  213 |  160 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  293.75 |  1,175 |  331 |  273 |
| `main_trace_commit_time_ms` |  53 |  212 |  58 |  50 |
| `generate_perm_trace_time_ms` |  30 |  120 |  38 |  20 |
| `perm_trace_commit_time_ms` |  65.02 |  260.06 |  71.24 |  55.90 |
| `quotient_poly_compute_time_ms` |  59.46 |  237.84 |  72.44 |  53.97 |
| `quotient_poly_commit_time_ms` |  15.48 |  61.92 |  18.07 |  13.16 |
| `pcs_opening_time_ms ` |  67.75 |  271 |  89 |  57 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 549 | 66 | 1 | 36 | 4,137,502 | 114.06 | 191 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 213 | 738 | 23,446,148 | 150,778,428 | 213 | 331 | 0 | 56.92 | 18.07 | 5 | 71.24 | 89 | 107 | 89 | 4 | 58 | 10,899,170 | 35 | 51 | 1,103,000 | 24.66 | 22 | 75 | 1 | 89 | 
| regex_program | 1 | 160 | 559 | 11,598,276 | 128,513,066 | 160 | 292 | 1 | 54.52 | 15.42 | 4 | 67.28 | 63 | 106 | 62 | 0 | 52 | 2,196,106 | 38 | 66 | 1,104,000 | 30.68 | 16 | 70 | 0 | 62 | 
| regex_program | 2 | 166 | 547 | 11,579,064 | 128,513,066 | 166 | 279 | 1 | 53.97 | 15.27 | 4 | 65.64 | 62 | 94 | 62 | 0 | 52 | 2,177,334 | 27 | 60 | 1,104,000 | 30.38 | 17 | 69 | 0 | 62 | 
| regex_program | 3 | 187 | 549 | 11,853,872 | 103,456,394 | 187 | 273 | 0 | 72.44 | 13.16 | 5 | 55.90 | 57 | 79 | 56 | 0 | 50 | 2,422,606 | 20 | 47 | 826,502 | 30.01 | 18 | 86 | 1 | 56 | 

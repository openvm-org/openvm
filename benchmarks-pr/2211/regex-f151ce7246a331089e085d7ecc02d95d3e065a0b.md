...
| `total_proof_time_ms ` |  577.50 |  2,310 |  700 |  535 |
...
| `execute_metered_insn_mi/s` |  115.77 | -          |  115.77 |  115.77 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  53.75 |  215 |  66 |  44 |
| `execute_preflight_insn_mi/s` |  31.50 | -          |  32.61 |  28.60 |
| `trace_gen_time_ms   ` |  177.25 |  709 |  212 |  154 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  278.75 |  1,115 |  299 |  269 |
| `main_trace_commit_time_ms` |  51.25 |  205 |  56 |  49 |
| `generate_perm_trace_time_ms` |  30.25 |  121 |  41 |  18 |
| `perm_trace_commit_time_ms` |  64.30 |  257.20 |  70.94 |  55.60 |
| `quotient_poly_compute_time_ms` |  57.89 |  231.57 |  69.03 |  51.53 |
| `quotient_poly_commit_time_ms` |  14.67 |  58.68 |  16.74 |  12.40 |
| `pcs_opening_time_ms ` |  56.75 |  227 |  62 |  53 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 539 | 66 | 1 | 35 | 4,137,502 | 115.77 | 195 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 212 | 700 | 23,446,148 | 150,778,428 | 212 | 299 | 0 | 58.40 | 16.74 | 5 | 70.94 | 54 | 112 | 54 | 4 | 56 | 10,899,170 | 41 | 44 | 1,103,000 | 28.60 | 21 | 75 | 1 | 54 | 
| regex_program | 1 | 154 | 535 | 11,598,276 | 128,513,066 | 154 | 273 | 1 | 52.60 | 14.69 | 4 | 65.41 | 53 | 101 | 53 | 0 | 49 | 2,196,106 | 35 | 66 | 1,104,000 | 32.61 | 16 | 67 | 0 | 53 | 
| regex_program | 2 | 162 | 536 | 11,579,064 | 128,513,066 | 162 | 274 | 1 | 51.53 | 14.85 | 5 | 65.26 | 62 | 93 | 62 | 0 | 50 | 2,177,334 | 27 | 58 | 1,104,000 | 32.37 | 16 | 67 | 0 | 62 | 
| regex_program | 3 | 181 | 539 | 11,853,872 | 103,456,394 | 181 | 269 | 0 | 69.03 | 12.40 | 5 | 55.60 | 58 | 77 | 58 | 0 | 50 | 2,422,606 | 18 | 47 | 826,502 | 32.41 | 19 | 82 | 1 | 58 | 
...
Commit: https://github.com/openvm-org/openvm/commit/f151ce7246a331089e085d7ecc02d95d3e065a0b
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19246973431)

...
| `total_proof_time_ms ` |  766 |  1,532 |  855 |  677 |
...
| `execute_preflight_insn_mi/s` |  13.60 | -          |  18.12 |  9.09 |
| `trace_gen_time_ms   ` |  180.50 |  361 |  197 |  164 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  396.50 |  793 |  416 |  377 |
| `main_trace_commit_time_ms` |  64.50 |  129 |  75 |  54 |
| `generate_perm_trace_time_ms` |  55 |  110 |  71 |  39 |
| `perm_trace_commit_time_ms` |  76.81 |  153.62 |  89.02 |  64.60 |
| `quotient_poly_compute_time_ms` |  79.46 |  158.92 |  87.94 |  70.98 |
| `quotient_poly_commit_time_ms` |  16.23 |  32.46 |  17.88 |  14.58 |
| `pcs_opening_time_ms ` |  100.50 |  201 |  103 |  98 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 677 | 66 | 1 | 91 | 1,745,742 | 19.17 | 171 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 164 | 855 | 32,689,110 | 172,558,444 | 164 | 416 | 0 | 87.94 | 17.88 | 6 | 89.02 | 103 | 130 | 103 | 1 | 75 | 16,059,916 | 39 | 130 | 1,157,000 | 9.09 | 26 | 106 | 1 | 103 | 
| pairing | 1 | 197 | 677 | 22,314,288 | 119,958,502 | 197 | 377 | 1 | 70.98 | 14.58 | 6 | 64.60 | 98 | 139 | 98 | 0 | 54 | 9,408,294 | 71 | 60 | 588,742 | 18.12 | 20 | 86 | 1 | 98 | 

...
| `total_proof_time_ms ` |  586 |  2,344 |  710 |  543 |
...
| `execute_metered_insn_mi/s` |  115.97 | -          |  115.97 |  115.97 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  53.50 |  214 |  67 |  44 |
| `execute_preflight_insn_mi/s` |  31.09 | -          |  32.87 |  28.36 |
| `trace_gen_time_ms   ` |  180.75 |  723 |  215 |  156 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  284.50 |  1,138 |  306 |  271 |
| `main_trace_commit_time_ms` |  51.75 |  207 |  56 |  50 |
| `generate_perm_trace_time_ms` |  28.25 |  113 |  35 |  20 |
| `perm_trace_commit_time_ms` |  65.19 |  260.78 |  70.66 |  56.53 |
| `quotient_poly_compute_time_ms` |  59.24 |  236.97 |  69.61 |  52.95 |
| `quotient_poly_commit_time_ms` |  15.76 |  63.05 |  17.98 |  13.39 |
| `pcs_opening_time_ms ` |  61 |  244 |  67 |  56 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 543 | 66 | 1 | 35 | 4,137,502 | 115.97 | 195 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 215 | 710 | 23,446,148 | 150,778,428 | 215 | 306 | 0 | 60.93 | 17.98 | 5 | 70.66 | 67 | 102 | 67 | 4 | 56 | 10,899,170 | 30 | 45 | 1,103,000 | 28.36 | 21 | 79 | 1 | 67 | 
| regex_program | 1 | 156 | 548 | 11,598,276 | 128,513,066 | 156 | 283 | 1 | 52.95 | 15.89 | 4 | 66.45 | 59 | 102 | 59 | 0 | 51 | 2,196,106 | 35 | 67 | 1,104,000 | 31.26 | 17 | 69 | 0 | 59 | 
| regex_program | 2 | 165 | 543 | 11,579,064 | 128,513,066 | 165 | 278 | 1 | 53.48 | 15.79 | 4 | 67.15 | 62 | 96 | 62 | 0 | 50 | 2,177,334 | 28 | 58 | 1,104,000 | 31.88 | 16 | 69 | 0 | 62 | 
| regex_program | 3 | 187 | 543 | 11,853,872 | 103,456,394 | 187 | 271 | 0 | 69.61 | 13.39 | 5 | 56.53 | 56 | 79 | 56 | 0 | 50 | 2,422,606 | 20 | 44 | 826,502 | 32.87 | 18 | 84 | 1 | 56 | 
...
Commit: https://github.com/openvm-org/openvm/commit/dd8ea5402376d739038d111e495e723b325933e8
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19235653527)

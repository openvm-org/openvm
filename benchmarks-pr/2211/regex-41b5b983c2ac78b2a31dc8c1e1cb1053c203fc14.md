...
| `total_proof_time_ms ` |  586 |  2,344 |  736 |  531 |
...
| `execute_metered_insn_mi/s` |  110.34 | -          |  110.34 |  110.34 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  53.50 |  214 |  66 |  45 |
| `execute_preflight_insn_mi/s` |  31.43 | -          |  32.66 |  28.76 |
| `trace_gen_time_ms   ` |  176.25 |  705 |  210 |  153 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  288.25 |  1,153 |  335 |  265 |
| `main_trace_commit_time_ms` |  51.50 |  206 |  57 |  49 |
| `generate_perm_trace_time_ms` |  34.75 |  139 |  55 |  19 |
| `perm_trace_commit_time_ms` |  62.90 |  251.61 |  68.23 |  54.15 |
| `quotient_poly_compute_time_ms` |  55.66 |  222.65 |  69.97 |  47.87 |
| `quotient_poly_commit_time_ms` |  14.73 |  58.91 |  16.67 |  12.48 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 534 | 40 | 1 | 37 | 4,137,502 | 110.34 | 167 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 210 | 736 | 23,446,148 | 150,778,428 | 210 | 335 | 0 | 53.51 | 16.67 | 5 | 68.23 | 82 | 124 | 82 | 4 | 57 | 10,899,170 | 55 | 45 | 1,103,000 | 28.76 | 21 | 70 | 1 | 82 | 
| regex_program | 1 | 153 | 543 | 11,598,276 | 128,513,066 | 153 | 282 | 1 | 51.30 | 14.39 | 4 | 64.20 | 62 | 103 | 62 | 0 | 50 | 2,196,106 | 38 | 66 | 1,104,000 | 31.76 | 16 | 66 | 0 | 62 | 
| regex_program | 2 | 160 | 531 | 11,579,064 | 128,513,066 | 160 | 271 | 1 | 47.87 | 15.38 | 4 | 65.02 | 63 | 93 | 62 | 0 | 50 | 2,177,334 | 27 | 58 | 1,104,000 | 32.66 | 16 | 63 | 0 | 62 | 
| regex_program | 3 | 182 | 534 | 11,853,872 | 103,456,394 | 182 | 265 | 0 | 69.97 | 12.48 | 5 | 54.15 | 56 | 76 | 55 | 0 | 49 | 2,422,606 | 19 | 45 | 826,502 | 32.54 | 18 | 83 | 1 | 55 | 

...
| `total_proof_time_ms ` |  735 |  1,470 |  816 |  654 |
...
| `execute_preflight_insn_mi/s` |  13.89 | -          |  18.46 |  9.32 |
| `trace_gen_time_ms   ` |  180 |  360 |  196 |  164 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  369.50 |  739 |  381 |  358 |
| `main_trace_commit_time_ms` |  64.50 |  129 |  74 |  55 |
| `generate_perm_trace_time_ms` |  55.50 |  111 |  71 |  40 |
| `perm_trace_commit_time_ms` |  76.64 |  153.29 |  89.43 |  63.85 |
| `quotient_poly_compute_time_ms` |  79.58 |  159.16 |  87.61 |  71.55 |
| `quotient_poly_commit_time_ms` |  15.77 |  31.54 |  17.40 |  14.14 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 654 | 40 | 1 | 90 | 1,745,742 | 19.31 | 145 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 164 | 816 | 32,689,110 | 172,558,444 | 163 | 381 | 0 | 87.61 | 17.40 | 6 | 89.43 | 67 | 132 | 67 | 1 | 74 | 16,059,916 | 40 | 127 | 1,157,000 | 9.32 | 26 | 105 | 1 | 67 | 
| pairing | 1 | 196 | 654 | 22,314,288 | 119,958,502 | 196 | 358 | 1 | 71.55 | 14.14 | 5 | 63.85 | 77 | 138 | 77 | 0 | 55 | 9,408,294 | 71 | 58 | 588,742 | 18.46 | 21 | 86 | 1 | 77 | 

...
| `total_proof_time_ms ` |  592.75 |  2,371 |  745 |  537 |
...
| `execute_preflight_time_ms` |  55.25 |  221 |  70 |  45 |
| `execute_preflight_insn_mi/s` |  30.47 | -          |  31.45 |  28.66 |
| `trace_gen_time_ms   ` |  178.25 |  713 |  214 |  151 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  292 |  1,168 |  343 |  264 |
| `main_trace_commit_time_ms` |  52 |  208 |  57 |  50 |
| `generate_perm_trace_time_ms` |  34.75 |  139 |  55 |  19 |
| `perm_trace_commit_time_ms` |  64.09 |  256.35 |  70.20 |  55.89 |
| `quotient_poly_compute_time_ms` |  59.12 |  236.49 |  69.53 |  52.50 |
| `quotient_poly_commit_time_ms` |  15.01 |  60.05 |  18.05 |  12.47 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 537 | 66 | 1 | 37 | 4,137,502 | 111.09 | 194 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 214 | 745 | 23,446,148 | 150,778,428 | 214 | 343 | 0 | 61.50 | 18.05 | 5 | 70.20 | 78 | 127 | 78 | 4 | 57 | 10,899,170 | 55 | 45 | 1,103,000 | 28.66 | 21 | 80 | 1 | 78 | 
| regex_program | 1 | 151 | 549 | 11,598,276 | 128,513,066 | 151 | 286 | 1 | 52.96 | 14.75 | 5 | 65.09 | 63 | 104 | 63 | 0 | 50 | 2,196,106 | 38 | 70 | 1,104,000 | 30.62 | 16 | 68 | 0 | 63 | 
| regex_program | 2 | 164 | 540 | 11,579,064 | 128,513,066 | 164 | 275 | 1 | 52.50 | 14.78 | 4 | 65.18 | 62 | 93 | 62 | 0 | 51 | 2,177,334 | 27 | 59 | 1,104,000 | 31.45 | 16 | 67 | 0 | 62 | 
| regex_program | 3 | 184 | 537 | 11,853,872 | 103,456,394 | 184 | 264 | 0 | 69.53 | 12.47 | 5 | 55.89 | 52 | 77 | 52 | 0 | 50 | 2,422,606 | 19 | 47 | 826,502 | 31.15 | 19 | 83 | 1 | 52 | 

...
| `total_proof_time_ms ` |  595 |  2,380 |  747 |  535 |
...
| `execute_preflight_insn_mi/s` |  30.70 | -          |  32.17 |  27.33 |
| `trace_gen_time_ms   ` |  177.50 |  710 |  210 |  155 |
| `memory_finalize_time_ms` |  1.25 |  5 |  5 |  0 |
| `stark_prove_excluding_trace_time_ms` |  296.50 |  1,186 |  345 |  267 |
| `main_trace_commit_time_ms` |  50.75 |  203 |  56 |  49 |
| `generate_perm_trace_time_ms` |  35.50 |  142 |  55 |  20 |
| `perm_trace_commit_time_ms` |  63.18 |  252.73 |  68.53 |  54.34 |
| `quotient_poly_compute_time_ms` |  56.74 |  226.97 |  71.14 |  51.36 |
| `quotient_poly_commit_time_ms` |  14.55 |  58.20 |  15.95 |  12.85 |
| `pcs_opening_time_ms ` |  72.50 |  290 |  94 |  55 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 536 | 66 | 1 | 36 | 4,137,502 | 113.69 | 193 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 210 | 747 | 23,446,148 | 150,778,428 | 210 | 345 | 0 | 52.34 | 15.95 | 5 | 68.53 | 94 | 125 | 94 | 5 | 56 | 10,899,170 | 55 | 47 | 1,103,000 | 27.33 | 21 | 69 | 1 | 94 | 
| regex_program | 1 | 155 | 562 | 11,598,276 | 128,513,066 | 155 | 300 | 1 | 51.36 | 14.05 | 5 | 63.76 | 80 | 103 | 80 | 0 | 49 | 2,196,106 | 39 | 66 | 1,104,000 | 31.23 | 16 | 65 | 0 | 80 | 
| regex_program | 2 | 162 | 535 | 11,579,064 | 128,513,066 | 162 | 274 | 1 | 52.12 | 15.36 | 4 | 66.10 | 61 | 94 | 61 | 0 | 49 | 2,177,334 | 28 | 58 | 1,104,000 | 32.08 | 16 | 68 | 0 | 61 | 
| regex_program | 3 | 183 | 536 | 11,853,872 | 103,456,394 | 183 | 267 | 0 | 71.14 | 12.85 | 5 | 54.34 | 55 | 77 | 54 | 0 | 49 | 2,422,606 | 20 | 45 | 826,502 | 32.17 | 18 | 85 | 1 | 54 | 
...
Commit: https://github.com/openvm-org/openvm/commit/2c65333ae6032e20c161801cd2cd70d9a544e0bf
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19274725306)

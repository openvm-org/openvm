...
|:---|---:|---:|
| Total |  2.34 |  0.74 |
| regex_program |  2.31 |  0.70 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  577 |  2,308 |  701 |  528 |
...
| `execute_metered_insn_mi/s` |  109.45 | -          |  109.45 |  109.45 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  53 |  212 |  64 |  45 |
| `execute_preflight_insn_mi/s` |  31.37 | -          |  32.38 |  28.65 |
| `trace_gen_time_ms   ` |  176.25 |  705 |  210 |  154 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  280 |  1,120 |  301 |  261 |
| `main_trace_commit_time_ms` |  51.50 |  206 |  57 |  49 |
| `generate_perm_trace_time_ms` |  30.75 |  123 |  40 |  18 |
| `perm_trace_commit_time_ms` |  63.79 |  255.14 |  69.04 |  55.41 |
| `quotient_poly_compute_time_ms` |  57.46 |  229.84 |  68.43 |  50.95 |
| `quotient_poly_commit_time_ms` |  15.23 |  60.91 |  17.83 |  12.60 |
| `pcs_opening_time_ms ` |  58 |  232 |  63 |  51 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 528 | 66 | 1 | 37 | 4,137,502 | 109.45 | 193 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 210 | 701 | 23,446,148 | 150,778,428 | 210 | 301 | 0 | 59.12 | 17.83 | 5 | 69.04 | 55 | 110 | 55 | 4 | 57 | 10,899,170 | 40 | 45 | 1,103,000 | 28.65 | 21 | 77 | 1 | 55 | 
| regex_program | 1 | 154 | 546 | 11,598,276 | 128,513,066 | 154 | 286 | 1 | 51.35 | 15.62 | 4 | 65.49 | 63 | 104 | 63 | 0 | 50 | 2,196,106 | 38 | 64 | 1,104,000 | 32.38 | 16 | 67 | 0 | 63 | 
| regex_program | 2 | 161 | 533 | 11,579,064 | 128,513,066 | 161 | 272 | 1 | 50.95 | 14.85 | 4 | 65.21 | 63 | 93 | 63 | 0 | 49 | 2,177,334 | 27 | 58 | 1,104,000 | 32.10 | 16 | 66 | 0 | 63 | 
| regex_program | 3 | 180 | 528 | 11,853,872 | 103,456,394 | 180 | 261 | 0 | 68.43 | 12.60 | 5 | 55.41 | 51 | 76 | 51 | 0 | 50 | 2,422,606 | 18 | 45 | 826,502 | 32.36 | 18 | 82 | 1 | 51 | 
...
Commit: https://github.com/openvm-org/openvm/commit/210a4e7b99174bbaa0caef5add3b741fe71a3423
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19276549525)

...
| `total_proof_time_ms ` |  490 |  980 |  553 |  427 |
...
| `execute_metered_insn_mi/s` |  117.30 | -          |  117.30 |  117.30 |
| `execute_preflight_insns` |  750,104.50 |  1,500,209 |  873,000 |  627,209 |
| `execute_preflight_time_ms` |  28.50 |  57 |  32 |  25 |
| `execute_preflight_insn_mi/s` |  37.71 | -          |  39.83 |  35.59 |
| `trace_gen_time_ms   ` |  193 |  386 |  198 |  188 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  175 |  350 |  185 |  165 |
| `main_trace_commit_time_ms` |  30 |  60 |  32 |  28 |
| `generate_perm_trace_time_ms` |  15 |  30 |  17 |  13 |
| `perm_trace_commit_time_ms` |  41.96 |  83.91 |  43.77 |  40.14 |
| `quotient_poly_compute_time_ms` |  31.21 |  62.42 |  33.99 |  28.43 |
| `quotient_poly_commit_time_ms` |  12.21 |  24.42 |  12.43 |  11.99 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 427 | 40 | 1 | 12 | 1,500,209 | 117.30 | 137 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 198 | 553 | 9,677,708 | 84,395,212 | 198 | 185 | 0 | 33.99 | 12.43 | 4 | 43.77 | 44 | 61 | 43 | 0 | 32 | 1,035,986 | 17 | 25 | 873,000 | 35.59 | 14 | 46 | 0 | 43 | 
| fibonacci_program | 1 | 188 | 427 | 9,708,170 | 74,305,770 | 188 | 165 | 1 | 28.43 | 11.99 | 4 | 40.14 | 41 | 53 | 41 | 0 | 28 | 1,064,416 | 13 | 32 | 627,209 | 39.83 | 11 | 40 | 0 | 41 | 
...
Commit: https://github.com/openvm-org/openvm/commit/8ac7296a6bae89951ceb639b6f0cb610b857d66b
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19245635445)

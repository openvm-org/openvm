...
| `total_proof_time_ms ` |  723.50 |  1,447 |  825 |  622 |
...
| `execute_preflight_insn_mi/s` |  13.76 | -          |  18.30 |  9.22 |
| `trace_gen_time_ms   ` |  183.50 |  367 |  200 |  167 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  353 |  706 |  384 |  322 |
| `main_trace_commit_time_ms` |  65 |  130 |  75 |  55 |
| `generate_perm_trace_time_ms` |  36.50 |  73 |  40 |  33 |
| `perm_trace_commit_time_ms` |  77.92 |  155.84 |  89.78 |  66.05 |
| `quotient_poly_compute_time_ms` |  80.29 |  160.57 |  88.84 |  71.73 |
| `quotient_poly_commit_time_ms` |  16.24 |  32.49 |  17.81 |  14.68 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 622 | 66 | 1 | 90 | 1,745,742 | 19.30 | 171 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 167 | 825 | 32,689,110 | 172,558,444 | 167 | 384 | 0 | 88.84 | 17.81 | 6 | 89.78 | 68 | 132 | 68 | 1 | 75 | 16,059,916 | 40 | 128 | 1,157,000 | 9.22 | 26 | 107 | 1 | 68 | 
| pairing | 1 | 200 | 622 | 22,314,288 | 119,958,502 | 200 | 322 | 1 | 71.73 | 14.68 | 5 | 66.05 | 76 | 102 | 76 | 0 | 55 | 9,408,294 | 33 | 59 | 588,742 | 18.30 | 20 | 87 | 1 | 76 | 

...
| `total_proof_time_ms ` |  588.75 |  2,355 |  712 |  540 |
...
| `execute_preflight_insn_mi/s` |  31.40 | -          |  32.38 |  28.67 |
| `trace_gen_time_ms   ` |  183 |  732 |  217 |  161 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  285.50 |  1,142 |  306 |  266 |
| `main_trace_commit_time_ms` |  52.50 |  210 |  57 |  51 |
| `generate_perm_trace_time_ms` |  30.75 |  123 |  40 |  18 |
| `perm_trace_commit_time_ms` |  65.47 |  261.87 |  71.27 |  56.72 |
| `quotient_poly_compute_time_ms` |  59.61 |  238.42 |  70.01 |  53.07 |
| `quotient_poly_commit_time_ms` |  15.22 |  60.88 |  17.26 |  12.87 |
| `pcs_opening_time_ms ` |  58.50 |  234 |  64 |  52 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 540 | 67 | 1 | 35 | 4,137,502 | 116.92 | 193 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 217 | 712 | 23,446,148 | 150,778,428 | 217 | 306 | 0 | 60.69 | 17.26 | 5 | 71.27 | 56 | 112 | 56 | 4 | 57 | 10,899,170 | 40 | 45 | 1,103,000 | 28.67 | 21 | 78 | 1 | 56 | 
| regex_program | 1 | 161 | 558 | 11,598,276 | 128,513,066 | 161 | 291 | 1 | 53.07 | 15.90 | 4 | 66.60 | 64 | 105 | 64 | 0 | 51 | 2,196,106 | 38 | 64 | 1,104,000 | 32.36 | 17 | 69 | 0 | 64 | 
| regex_program | 2 | 167 | 545 | 11,579,064 | 128,513,066 | 167 | 279 | 1 | 54.65 | 14.86 | 4 | 67.29 | 62 | 95 | 61 | 0 | 51 | 2,177,334 | 27 | 58 | 1,104,000 | 32.38 | 16 | 70 | 0 | 61 | 
| regex_program | 3 | 187 | 540 | 11,853,872 | 103,456,394 | 187 | 266 | 0 | 70.01 | 12.87 | 5 | 56.72 | 52 | 78 | 52 | 0 | 51 | 2,422,606 | 18 | 45 | 826,502 | 32.19 | 18 | 83 | 1 | 52 | 
...
Commit: https://github.com/openvm-org/openvm/commit/0461ae69d1e40661a125c1ec501d5d06894ee977
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19278776782)

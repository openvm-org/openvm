...
| `total_proof_time_ms ` |  493.50 |  987 |  561 |  426 |
...
| `execute_metered_insn_mi/s` |  118.94 | -          |  118.94 |  118.94 |
| `execute_preflight_insns` |  750,104.50 |  1,500,209 |  873,000 |  627,209 |
| `execute_preflight_time_ms` |  28.50 |  57 |  33 |  24 |
| `execute_preflight_insn_mi/s` |  38.06 | -          |  40.10 |  36.03 |
| `trace_gen_time_ms   ` |  194.50 |  389 |  201 |  188 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  177.50 |  355 |  192 |  163 |
| `main_trace_commit_time_ms` |  30.50 |  61 |  33 |  28 |
| `generate_perm_trace_time_ms` |  14.50 |  29 |  18 |  11 |
| `perm_trace_commit_time_ms` |  42.43 |  84.86 |  45.80 |  39.05 |
| `quotient_poly_compute_time_ms` |  32.70 |  65.41 |  34.57 |  30.84 |
| `quotient_poly_commit_time_ms` |  12.25 |  24.50 |  12.89 |  11.60 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 426 | 40 | 1 | 12 | 1,500,209 | 118.94 | 139 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 201 | 561 | 9,677,708 | 84,395,212 | 201 | 192 | 0 | 34.57 | 12.89 | 4 | 45.80 | 45 | 64 | 45 | 0 | 33 | 1,035,986 | 18 | 24 | 873,000 | 36.03 | 14 | 47 | 0 | 45 | 
| fibonacci_program | 1 | 188 | 426 | 9,708,170 | 74,305,770 | 188 | 163 | 1 | 30.84 | 11.60 | 4 | 39.05 | 40 | 51 | 40 | 0 | 28 | 1,064,416 | 11 | 33 | 627,209 | 40.10 | 11 | 42 | 0 | 40 | 
...
Commit: https://github.com/openvm-org/openvm/commit/7bd4be1a6b0d8ab719c29890ed7d4e27d2d4e221
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19245162138)

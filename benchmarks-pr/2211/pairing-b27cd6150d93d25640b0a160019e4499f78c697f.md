...
| `total_proof_time_ms ` |  735 |  1,470 |  851 |  619 |
...
| `execute_preflight_insn_mi/s` |  13.91 | -          |  18.59 |  9.23 |
| `trace_gen_time_ms   ` |  179.50 |  359 |  196 |  163 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  369 |  738 |  415 |  323 |
| `main_trace_commit_time_ms` |  64 |  128 |  75 |  53 |
| `generate_perm_trace_time_ms` |  43 |  86 |  47 |  39 |
| `perm_trace_commit_time_ms` |  77.18 |  154.35 |  88.73 |  65.62 |
| `quotient_poly_compute_time_ms` |  79.56 |  159.12 |  87.55 |  71.57 |
| `quotient_poly_commit_time_ms` |  16.01 |  32.01 |  17.15 |  14.86 |
| `pcs_opening_time_ms ` |  84.50 |  169 |  103 |  66 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 619 | 66 | 1 | 91 | 1,745,742 | 19.07 | 170 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 163 | 851 | 32,689,110 | 172,558,444 | 163 | 415 | 0 | 87.55 | 17.15 | 6 | 88.73 | 103 | 130 | 103 | 1 | 75 | 16,059,916 | 39 | 128 | 1,157,000 | 9.23 | 26 | 105 | 1 | 103 | 
| pairing | 1 | 196 | 619 | 22,314,288 | 119,958,502 | 196 | 323 | 1 | 71.57 | 14.86 | 6 | 65.62 | 66 | 116 | 66 | 0 | 53 | 9,408,294 | 47 | 58 | 588,742 | 18.59 | 20 | 87 | 1 | 66 | 

...
|:---|---:|---:|
| Total |  0.98 |  0.56 |
| fibonacci_program |  0.97 |  0.54 |


| fibonacci_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  482.50 |  965 |  544 |  421 |
...
| `execute_metered_insn_mi/s` |  117.57 | -          |  117.57 |  117.57 |
| `execute_preflight_insns` |  750,104.50 |  1,500,209 |  873,000 |  627,209 |
| `execute_preflight_time_ms` |  29 |  58 |  33 |  25 |
| `execute_preflight_insn_mi/s` |  37.66 | -          |  40.07 |  35.26 |
| `trace_gen_time_ms   ` |  188 |  376 |  193 |  183 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  172.50 |  345 |  182 |  163 |
| `main_trace_commit_time_ms` |  30.50 |  61 |  33 |  28 |
| `generate_perm_trace_time_ms` |  15 |  30 |  17 |  13 |
| `perm_trace_commit_time_ms` |  41.73 |  83.47 |  43.87 |  39.60 |
| `quotient_poly_compute_time_ms` |  28.76 |  57.52 |  29.64 |  27.88 |
| `quotient_poly_commit_time_ms` |  11.45 |  22.90 |  11.45 |  11.45 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 421 | 40 | 1 | 12 | 1,500,209 | 117.57 | 138 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 193 | 544 | 9,677,708 | 84,395,212 | 193 | 182 | 0 | 29.64 | 11.45 | 4 | 43.87 | 44 | 62 | 44 | 0 | 33 | 1,035,986 | 17 | 25 | 873,000 | 35.26 | 14 | 41 | 0 | 44 | 
| fibonacci_program | 1 | 183 | 421 | 9,708,170 | 74,305,770 | 183 | 163 | 1 | 27.88 | 11.45 | 4 | 39.60 | 42 | 53 | 41 | 0 | 28 | 1,064,416 | 13 | 33 | 627,209 | 40.07 | 11 | 39 | 0 | 41 | 
...
Commit: https://github.com/openvm-org/openvm/commit/41b5b983c2ac78b2a31dc8c1e1cb1053c203fc14
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19246166636)

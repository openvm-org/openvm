...
| `total_proof_time_ms ` |  713 |  1,426 |  814 |  612 |
...
| `execute_preflight_insn_mi/s` |  13.79 | -          |  18.39 |  9.18 |
| `trace_gen_time_ms   ` |  176 |  352 |  193 |  159 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  349.50 |  699 |  381 |  318 |
| `main_trace_commit_time_ms` |  65 |  130 |  75 |  55 |
| `generate_perm_trace_time_ms` |  36.50 |  73 |  40 |  33 |
| `perm_trace_commit_time_ms` |  77.12 |  154.24 |  89.05 |  65.19 |
| `quotient_poly_compute_time_ms` |  78.17 |  156.34 |  86.87 |  69.47 |
| `quotient_poly_commit_time_ms` |  15.87 |  31.73 |  17.74 |  13.99 |
| `pcs_opening_time_ms ` |  72.50 |  145 |  77 |  68 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 612 | 66 | 1 | 91 | 1,745,742 | 19.05 | 172 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 159 | 814 | 32,689,110 | 172,558,444 | 159 | 381 | 0 | 86.87 | 17.74 | 6 | 89.05 | 68 | 132 | 68 | 1 | 75 | 16,059,916 | 40 | 129 | 1,157,000 | 9.18 | 26 | 105 | 1 | 68 | 
| pairing | 1 | 193 | 612 | 22,314,288 | 119,958,502 | 193 | 318 | 1 | 69.47 | 13.99 | 6 | 65.19 | 77 | 101 | 77 | 0 | 55 | 9,408,294 | 33 | 60 | 588,742 | 18.39 | 20 | 84 | 1 | 77 | 

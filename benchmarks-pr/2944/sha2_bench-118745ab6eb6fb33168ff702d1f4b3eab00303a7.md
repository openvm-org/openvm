...
|:---|---:|---:|---:|
| Total |  9.80 |  6.83 |  6.83 |
| app_proof |  8.14 |  5.17 |  5.17 |
| leaf |  0.99 |  0.99 |  0.99 |
...
| `total_proof_time_ms ` |  4,026 |  8,052 |  5,082 |  2,970 |
...
| `execute_preflight_time_ms` |  237 |  474 |  271 |  203 |
| `execute_preflight_insn_mi/s` |  38.18 | -          |  40.43 |  35.94 |
| `trace_gen_time_ms   ` |  121 |  242 |  170 |  72 |
| `set_initial_memory_time_ms` |  88.50 |  177 |  136 |  41 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  3,577 |  7,154 |  4,570 |  2,584 |
| `prover.main_trace_commit_time_ms` |  951 |  1,902 |  1,318 |  584 |
| `prover.rap_constraints_time_ms` |  1,923.50 |  3,847 |  2,372 |  1,475 |
| `prover.openings_time_ms` |  701.50 |  1,403 |  879 |  524 |
| `prover.rap_constraints.logup_gkr_time_ms` |  543 |  1,086 |  584 |  502 |
| `prover.rap_constraints.round0_time_ms` |  1,007.50 |  2,015 |  1,309 |  706 |
| `prover.rap_constraints.mle_rounds_time_ms` |  371.50 |  743 |  478 |  265 |
| `prover.openings.stacked_reduction_time_ms` |  161 |  322 |  206 |  116 |
| `prover.openings.stacked_reduction.round0_time_ms` |  99.50 |  199 |  128 |  71 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/118745ab6eb6fb33168ff702d1f4b3eab00303a7/sha2_bench-118745ab6eb6fb33168ff702d1f4b3eab00303a7.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 72 |  |  |  | 350 |  |  |  |  |  |  | 
| app_proof |  |  |  | 2,970 |  | 89 | 11,167,961 | 124.92 | 0 | 8,148 |  | 
...
| app_proof | 32 | Poseidon2PeripheryAir<BabyBearParameters>, 1> | 0 | 757 | 267 | 567,750 | 200,250 | 908,400 | 320,400 | 227,100 | 80,100 | 27,442 | 9,678 | 757 | 267 | 
...
| app_proof | 32 | Poseidon2PeripheryAir<BabyBearParameters>, 1> | 1 | 1,342 | 706 | 1,006,500 | 529,500 | 1,610,400 | 847,200 | 402,600 | 211,800 | 48,648 | 25,592 | 1,342 | 706 | 
...
| leaf | 0 | 106 | 988 | 105 | 34 | 17 | 2 | 7 | 7 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 323 | 116 | 0 | 0 | 106 | 33 | 33 | 51 | 21 | 0 | 99 | 86 | 13 | 3 | 9 | 116 | 116 | 106 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 168 | 46 | 0 | 0 | 67 | 24 | 23 | 27 | 14 | 0 | 54 | 45 | 8 | 1 | 6 | 47 | 46 | 67 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 133 | 31 | 0 | 0 | 60 | 22 | 22 | 24 | 13 | 0 | 40 | 33 | 7 | 1 | 5 | 32 | 31 | 60 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 237,929,016 | 881 | 369 | 0 | 0 | 223 | 105 | 105 | 66 | 50 | 0 | 288 | 251 | 36 | 19 | 16 | 369 | 369 | 223 | 0 | 9 | 49 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,286,242,554 | 4,570 | 1,318 | 0 | 0 | 2,372 | 1,309 | 1,308 | 478 | 584 | 0 | 879 | 672 | 206 | 128 | 78 | 1,318 | 1,318 | 2,372 | 0 | 4 | 583 | 0 | 0 | 
| app_proof | prover | 1 | 750,289,144 | 2,584 | 584 | 0 | 0 | 1,475 | 706 | 706 | 265 | 502 | 0 | 524 | 407 | 116 | 71 | 45 | 584 | 584 | 1,475 | 0 | 4 | 501 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 136 | 1 | 170 | 5,082 | 170 | 136 | 13,304,563,452 | 2,133,111,996 | 15,437,675,448 | 2,097,152 | 0 | 4 | 203 | 7,124,000 | 35.94 | 
| app_proof | 1 | 41 | 1 | 72 | 2,970 | 72 | 41 | 7,584,439,332 | 1,503,674,269 | 9,088,113,601 | 2,097,152 | 0 | 2 | 271 | 4,043,961 | 40.43 | 

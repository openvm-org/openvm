...
|:---|---:|---:|
| Total | <span style='color: green'>(-0 [-0.1%])</span> 13.91 |  7.79 |
| regex_program | <span style='color: green'>(-0 [-0.1%])</span> 13.91 |  7.79 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: green'>(-8 [-0.1%])</span> 6,954.50 | <span style='color: green'>(-16 [-0.1%])</span> 13,909 |  7,793 | <span style='color: green'>(-23 [-0.4%])</span> 6,116 |
| `main_cells_used     ` |  83,694,725 |  167,389,450 |  93,699,990 |  73,689,460 |
| `total_cycles        ` |  2,070,082 |  4,140,164 |  2,225,434 |  1,914,730 |
| `execute_time_ms     ` |  389 |  778 | <span style='color: green'>(-1 [-0.2%])</span> 471 | <span style='color: red'>(+1 [+0.3%])</span> 307 |
| `trace_gen_time_ms   ` | <span style='color: green'>(-6 [-0.4%])</span> 1,260 | <span style='color: green'>(-11 [-0.4%])</span> 2,520 | <span style='color: red'>(+5 [+0.4%])</span> 1,284 | <span style='color: green'>(-16 [-1.3%])</span> 1,236 |
| `stark_prove_excluding_trace_time_ms` |  5,305.50 |  10,611 |  6,038 | <span style='color: green'>(-8 [-0.2%])</span> 4,573 |
| `main_trace_commit_time_ms` | <span style='color: green'>(-8 [-0.7%])</span> 1,144 | <span style='color: green'>(-16 [-0.7%])</span> 2,288 | <span style='color: green'>(-9 [-0.7%])</span> 1,320 | <span style='color: green'>(-7 [-0.7%])</span> 968 |
| `generate_perm_trace_time_ms` | <span style='color: red'>(+10 [+5.8%])</span> 182 | <span style='color: red'>(+20 [+5.8%])</span> 364 | <span style='color: red'>(+3 [+1.6%])</span> 195 | <span style='color: red'>(+17 [+11.2%])</span> 169 |
| `perm_trace_commit_time_ms` |  1,036 |  2,072 |  1,182 | <span style='color: green'>(-2 [-0.2%])</span> 890 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+7 [+0.9%])</span> 751.50 | <span style='color: red'>(+14 [+0.9%])</span> 1,503 | <span style='color: red'>(+6 [+0.7%])</span> 882 | <span style='color: red'>(+8 [+1.3%])</span> 621 |
| `quotient_poly_commit_time_ms` | <span style='color: green'>(-10 [-1.0%])</span> 911 | <span style='color: green'>(-19 [-1.0%])</span> 1,822 |  1,061 | <span style='color: green'>(-19 [-2.4%])</span> 761 |
| `pcs_opening_time_ms ` | <span style='color: green'>(-2 [-0.1%])</span> 1,272.50 | <span style='color: green'>(-3 [-0.1%])</span> 2,545 |  1,389 | <span style='color: green'>(-4 [-0.3%])</span> 1,156 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,284 | 7,793 | 2,225,434 | 210,931,487 | 6,038 | 882 | 1,061 | 1,182 | 1,389 | 1,320 | 93,699,990 | 195 | 471 | 
| regex_program | 1 | 1,236 | 6,116 | 1,914,730 | 150,470,512 | 4,573 | 621 | 761 | 890 | 1,156 | 968 | 73,689,460 | 169 | 307 | 

...
| `total_proof_time_ms ` |  493 |  986 |  557 |  429 |
...
| `execute_metered_insn_mi/s` |  116.86 | -          |  116.86 |  116.86 |
| `execute_preflight_insns` |  750,104.50 |  1,500,209 |  873,000 |  627,209 |
| `execute_preflight_time_ms` |  29.50 |  59 |  34 |  25 |
| `execute_preflight_insn_mi/s` |  37.52 | -          |  39.31 |  35.73 |
| `trace_gen_time_ms   ` |  193.50 |  387 |  200 |  187 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  176.50 |  353 |  187 |  166 |
| `main_trace_commit_time_ms` |  30.50 |  61 |  33 |  28 |
| `generate_perm_trace_time_ms` |  15 |  30 |  18 |  12 |
| `perm_trace_commit_time_ms` |  42.03 |  84.06 |  45.27 |  38.78 |
| `quotient_poly_compute_time_ms` |  31.02 |  62.04 |  31.51 |  30.53 |
| `quotient_poly_commit_time_ms` |  12.08 |  24.16 |  12.25 |  11.90 |
| `pcs_opening_time_ms ` |  43.50 |  87 |  45 |  42 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 429 | 65 | 1 | 12 | 1,500,209 | 116.86 | 163 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 200 | 557 | 9,677,708 | 84,395,212 | 200 | 187 | 0 | 31.51 | 11.90 | 4 | 45.27 | 45 | 64 | 45 | 0 | 33 | 1,035,986 | 18 | 25 | 873,000 | 35.73 | 14 | 43 | 0 | 45 | 
| fibonacci_program | 1 | 187 | 429 | 9,708,170 | 74,305,770 | 187 | 166 | 1 | 30.53 | 12.25 | 4 | 38.78 | 42 | 52 | 42 | 0 | 28 | 1,064,416 | 12 | 34 | 627,209 | 39.31 | 11 | 43 | 0 | 42 | 
...
Commit: https://github.com/openvm-org/openvm/commit/2bb88578ba9304165bf8d1cb7da3a900f7ecb49c
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19316345143)

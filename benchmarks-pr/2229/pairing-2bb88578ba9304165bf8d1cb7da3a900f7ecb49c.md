...
| `total_proof_time_ms ` |  732 |  1,464 |  818 |  646 |
...
| `execute_metered_insn_mi/s` |  19.14 | -          |  19.14 |  19.14 |
| `execute_preflight_insns` |  872,871 |  1,745,742 |  1,157,000 |  588,742 |
| `execute_preflight_time_ms` |  96 |  192 |  130 |  62 |
| `execute_preflight_insn_mi/s` |  13.70 | -          |  18.28 |  9.12 |
| `trace_gen_time_ms   ` |  177.50 |  355 |  193 |  162 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  364.50 |  729 |  380 |  349 |
| `main_trace_commit_time_ms` |  64 |  128 |  75 |  53 |
| `generate_perm_trace_time_ms` |  55 |  110 |  71 |  39 |
| `perm_trace_commit_time_ms` |  76.60 |  153.21 |  88.55 |  64.65 |
| `quotient_poly_compute_time_ms` |  78.84 |  157.69 |  86.86 |  70.83 |
| `quotient_poly_commit_time_ms` |  16.50 |  32.99 |  18.54 |  14.46 |
| `pcs_opening_time_ms ` |  69.50 |  139 |  71 |  68 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 646 | 40 | 1 | 91 | 1,745,742 | 19.14 | 146 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 162 | 818 | 32,689,110 | 172,558,444 | 162 | 380 | 0 | 86.86 | 18.54 | 6 | 88.55 | 68 | 131 | 67 | 0 | 75 | 16,059,916 | 39 | 130 | 1,157,000 | 9.12 | 26 | 106 | 1 | 67 | 
| pairing | 1 | 193 | 646 | 22,314,288 | 119,958,502 | 193 | 349 | 1 | 70.83 | 14.46 | 5 | 64.65 | 71 | 139 | 70 | 0 | 53 | 9,408,294 | 71 | 62 | 588,742 | 18.28 | 20 | 85 | 1 | 70 | 

...
| `total_proof_time_ms ` |  495 |  990 |  555 |  435 |
...
| `execute_metered_insn_mi/s` |  117.19 | -          |  117.19 |  117.19 |
| `execute_preflight_insns` |  750,104.50 |  1,500,209 |  873,000 |  627,209 |
| `execute_preflight_time_ms` |  28 |  56 |  32 |  24 |
| `execute_preflight_insn_mi/s` |  38 | -          |  40.05 |  35.96 |
| `trace_gen_time_ms   ` |  197 |  394 |  201 |  193 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  176.50 |  353 |  185 |  168 |
| `main_trace_commit_time_ms` |  31 |  62 |  33 |  29 |
| `generate_perm_trace_time_ms` |  15 |  30 |  17 |  13 |
| `perm_trace_commit_time_ms` |  42.49 |  84.98 |  44.72 |  40.26 |
| `quotient_poly_compute_time_ms` |  31.04 |  62.08 |  31.54 |  30.55 |
| `quotient_poly_commit_time_ms` |  12.60 |  25.21 |  12.73 |  12.48 |
| `pcs_opening_time_ms ` |  42.50 |  85 |  45 |  40 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 435 | 65 | 1 | 12 | 1,500,209 | 117.19 | 163 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 201 | 555 | 9,677,708 | 84,395,212 | 201 | 185 | 0 | 30.55 | 12.73 | 4 | 44.72 | 45 | 62 | 45 | 0 | 33 | 1,035,986 | 17 | 24 | 873,000 | 35.96 | 14 | 43 | 0 | 45 | 
| fibonacci_program | 1 | 193 | 435 | 9,708,170 | 74,305,770 | 193 | 168 | 1 | 31.54 | 12.48 | 4 | 40.26 | 40 | 54 | 40 | 0 | 29 | 1,064,416 | 13 | 32 | 627,209 | 40.05 | 11 | 44 | 0 | 40 | 

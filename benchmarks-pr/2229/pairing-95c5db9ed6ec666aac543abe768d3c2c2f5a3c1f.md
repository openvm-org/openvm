...
| `total_proof_time_ms ` |  726 |  1,452 |  808 |  644 |
...
| `execute_preflight_insn_mi/s` |  13.68 | -          |  18.26 |  9.09 |
| `trace_gen_time_ms   ` |  174.50 |  349 |  191 |  158 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  360.50 |  721 |  373 |  348 |
| `main_trace_commit_time_ms` |  64 |  128 |  75 |  53 |
| `generate_perm_trace_time_ms` |  55.50 |  111 |  71 |  40 |
| `perm_trace_commit_time_ms` |  74.87 |  149.74 |  85.78 |  63.97 |
| `quotient_poly_compute_time_ms` |  77.46 |  154.92 |  84.61 |  70.31 |
| `quotient_poly_commit_time_ms` |  15.42 |  30.85 |  16.91 |  13.94 |
| `pcs_opening_time_ms ` |  68 |  136 |  70 |  66 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 644 | 41 | 1 | 91 | 1,745,742 | 19.05 | 146 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 158 | 808 | 32,689,110 | 172,558,444 | 158 | 373 | 0 | 84.61 | 16.91 | 6 | 85.78 | 66 | 128 | 66 | 1 | 75 | 16,059,916 | 40 | 131 | 1,157,000 | 9.09 | 26 | 102 | 1 | 66 | 
| pairing | 1 | 191 | 644 | 22,314,288 | 119,958,502 | 191 | 348 | 1 | 70.31 | 13.94 | 6 | 63.97 | 70 | 138 | 70 | 0 | 53 | 9,408,294 | 71 | 63 | 588,742 | 18.26 | 20 | 84 | 1 | 70 | 

...
|:---|---:|---:|
| Total |  2.35 |  0.73 |
| regex_program |  2.31 |  0.69 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  577.25 |  2,309 |  689 |  538 |
...
| `execute_metered_insn_mi/s` |  112.43 | -          |  112.43 |  112.43 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  53.75 |  215 |  66 |  45 |
| `execute_preflight_insn_mi/s` |  31.07 | -          |  32.33 |  28.41 |
| `trace_gen_time_ms   ` |  178.50 |  714 |  211 |  156 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  277.25 |  1,109 |  288 |  268 |
| `main_trace_commit_time_ms` |  52 |  208 |  56 |  50 |
| `generate_perm_trace_time_ms` |  22 |  88 |  27 |  18 |
| `perm_trace_commit_time_ms` |  64.92 |  259.68 |  72.64 |  55.73 |
| `quotient_poly_compute_time_ms` |  58.20 |  232.81 |  68.63 |  52.71 |
| `quotient_poly_commit_time_ms` |  14.88 |  59.54 |  16.73 |  12.58 |
| `pcs_opening_time_ms ` |  61.75 |  247 |  71 |  57 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 539 | 40 | 1 | 36 | 4,137,502 | 112.43 | 167 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 211 | 689 | 23,446,148 | 150,778,428 | 211 | 288 | 0 | 58.44 | 16.73 | 5 | 72.64 | 58 | 97 | 58 | 4 | 56 | 10,899,170 | 23 | 45 | 1,103,000 | 28.41 | 21 | 75 | 1 | 58 | 
| regex_program | 1 | 156 | 543 | 11,598,276 | 128,513,066 | 156 | 279 | 1 | 53.03 | 15.42 | 5 | 66.59 | 71 | 87 | 71 | 0 | 51 | 2,196,106 | 20 | 66 | 1,104,000 | 32.07 | 16 | 69 | 0 | 71 | 
| regex_program | 2 | 164 | 538 | 11,579,064 | 128,513,066 | 164 | 274 | 1 | 52.71 | 14.80 | 4 | 64.73 | 61 | 92 | 61 | 0 | 51 | 2,177,334 | 27 | 58 | 1,104,000 | 32.33 | 16 | 68 | 0 | 61 | 
| regex_program | 3 | 183 | 539 | 11,853,872 | 103,456,394 | 183 | 268 | 0 | 68.63 | 12.58 | 5 | 55.73 | 57 | 77 | 57 | 0 | 50 | 2,422,606 | 18 | 46 | 826,502 | 31.47 | 19 | 82 | 1 | 57 | 
...
Commit: https://github.com/openvm-org/openvm/commit/95c5db9ed6ec666aac543abe768d3c2c2f5a3c1f
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19316579658)

...
| `total_proof_time_ms ` |  1,188.50 |  2,377 |  1,420 |  957 |
| `execute_metered_time_ms` |  7 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  19.75 | -          |  19.75 |  19.75 |
| `execute_preflight_insns` |  77,381.50 |  154,763 |  121,000 |  33,763 |
| `execute_preflight_time_ms` |  70.50 |  141 |  120 |  21 |
| `execute_preflight_insn_mi/s` |  7.82 | -          |  9.60 |  6.04 |
| `trace_gen_time_ms   ` |  157.50 |  315 |  187 |  128 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  845.50 |  1,691 |  1,024 |  667 |
| `prover.main_trace_commit_time_ms` |  222 |  444 |  293 |  151 |
| `prover.rap_constraints_time_ms` |  561.50 |  1,123 |  657 |  466 |
| `prover.openings_time_ms` |  61.50 |  123 |  73 |  50 |
| `prover.rap_constraints.logup_gkr_time_ms` |  141 |  282 |  154 |  128 |
| `prover.rap_constraints.round0_time_ms` |  287 |  574 |  363 |  211 |
| `prover.rap_constraints.mle_rounds_time_ms` |  132.50 |  265 |  139 |  126 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/793793ecc2ca14db2bc5acaac470a1d7452e93b7/kitchen_sink-793793ecc2ca14db2bc5acaac470a1d7452e93b7.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 67 | 3 |  |  | 0 |  | 322 | 3 |  |  |  |  |  |  | 
| app_proof |  |  |  |  |  | 957 |  |  | 7 | 154,763 | 19.75 | 0 | 2,390 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 53,472,003 | 138 | 40 | 0 | 4 | 64 | 19 | 19 | 29 | 15 | 0 | 32 | 9 | 23 | 1 | 21 | 41 | 64 | 0 | 1 | 15 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 23,651,975 | 101 | 19 | 0 | 4 | 50 | 16 | 16 | 20 | 13 | 0 | 30 | 9 | 21 | 1 | 20 | 19 | 50 | 0 | 1 | 12 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 17,507,975 | 94 | 14 | 0 | 4 | 48 | 16 | 16 | 18 | 13 | 0 | 31 | 9 | 21 | 0 | 20 | 14 | 48 | 0 | 1 | 12 | 0 | 0 | 
| leaf | 0 | prover | 407,935,872 | 309 | 125 | 0 | 9 | 141 | 45 | 44 | 35 | 59 | 0 | 43 | 11 | 31 | 7 | 24 | 125 | 141 | 0 | 2 | 59 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 816,542,084 | 1,024 | 292 | 0 | 163 | 657 | 363 | 362 | 139 | 154 | 62 | 73 | 12 | 60 | 15 | 44 | 293 | 657 | 0 | 1 | 91 | 0 | 0 | 
| app_proof | prover | 1 | 800,298,548 | 667 | 150 | 0 | 20 | 466 | 211 | 210 | 126 | 128 | 74 | 50 | 13 | 37 | 14 | 22 | 151 | 466 | 0 | 1 | 53 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 187 | 1,420 | 187 | 186 | 0 | 49 | 21 | 121,000 | 9.60 | 
| app_proof | 1 | 128 | 957 | 128 | 40 | 0 | 3 | 120 | 33,763 | 6.04 | 

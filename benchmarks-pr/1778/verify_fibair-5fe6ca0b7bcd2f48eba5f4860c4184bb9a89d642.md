...
| `execute_metered_time_ms` |  160 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  2.02 | -          | -          | -          |
| `execute_e3_time_ms  ` |  184 |  184 |  184 |  184 |
| `execute_e3_insn_mi/s` |  1.74 | -          |  1.74 |  1.74 |
| `trace_gen_time_ms   ` |  2,704 |  2,704 |  2,704 |  2,704 |
| `memory_finalize_time_ms` |  2,643 |  2,643 |  2,643 |  2,643 |
| `boundary_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  822 |  822 |  822 |  822 |
| `main_trace_commit_time_ms` |  150 |  150 |  150 |  150 |
| `generate_perm_trace_time_ms` |  55 |  55 |  55 |  55 |
| `perm_trace_commit_time_ms` |  145 |  145 |  145 |  145 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| verify_fibair | 2,704 | 3,870 | 322,699 | 62,474,410 | 822 | 83 | 96 | 145 | 289 | 2,643 | 150 | 17,340,154 | 322,700 | 55 | 1 | 160 | 2.02 | 184 | 1.74 | 0 | 

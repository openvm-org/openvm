...
|:---|---:|---:|
| Total |  40.43 |  40.43 |
| ecrecover_program |  40.35 |  40.35 |


| ecrecover_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  40,347 |  40,347 |  40,347 |  40,347 |
| `main_cells_used     ` |  8,151,353 |  8,151,353 |  8,151,353 |  8,151,353 |
| `total_cycles        ` |  137,260 |  137,260 |  137,260 |  137,260 |
| `execute_metered_time_ms` |  81 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  1.67 | -          | -          | -          |
| `execute_e3_time_ms  ` |  85 |  85 |  85 |  85 |
| `execute_e3_insn_mi/s` |  1.60 | -          |  1.60 |  1.60 |
| `trace_gen_time_ms   ` |  39,299 |  39,299 |  39,299 |  39,299 |
| `memory_finalize_time_ms` |  39,009 |  39,009 |  39,009 |  39,009 |
| `boundary_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `merkle_finalize_time_ms` |  38,762 |  38,762 |  38,762 |  38,762 |
| `stark_prove_excluding_trace_time_ms` |  963 |  963 |  963 |  963 |
| `main_trace_commit_time_ms` |  129 |  129 |  129 |  129 |
| `generate_perm_trace_time_ms` |  34 |  34 |  34 |  34 |
| `perm_trace_commit_time_ms` |  169 |  169 |  169 |  169 |
| `quotient_poly_compute_time_ms` |  76 |  76 |  76 |  76 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 1 | 912 | 137,261 | 1 | 81 | 1.67 | 9 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 39,299 | 40,347 | 137,260 | 32,925,330 | 963 | 76 | 125 | 169 | 413 | 38,762 | 39,009 | 129 | 8,151,353 | 137,261 | 34 | 85 | 1.60 | 0 | 

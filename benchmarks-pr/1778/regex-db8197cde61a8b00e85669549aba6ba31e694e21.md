...
|:---|---:|---:|
| Total |  86.47 |  44.95 |
| regex_program |  86.20 |  44.69 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  43,100.50 |  86,201 |  44,686 |  41,515 |
...
| `execute_metered_insn_mi/s` |  15.65 | -          | -          | -          |
| `execute_e3_time_ms  ` |  188 |  376 |  204 |  172 |
| `execute_e3_insn_mi/s` |  11.05 | -          |  11.14 |  10.96 |
| `trace_gen_time_ms   ` |  40,461.50 |  80,923 |  41,861 |  39,062 |
| `memory_finalize_time_ms` |  39,883 |  79,766 |  41,364 |  38,402 |
| `boundary_finalize_time_ms` |  3 |  6 |  6 |  0 |
| `merkle_finalize_time_ms` |  39,642 |  79,284 |  41,107 |  38,177 |
| `stark_prove_excluding_trace_time_ms` |  2,451 |  4,902 |  2,621 |  2,281 |
| `main_trace_commit_time_ms` |  456.50 |  913 |  509 |  404 |
| `generate_perm_trace_time_ms` |  201.50 |  403 |  207 |  196 |
| `perm_trace_commit_time_ms` |  499 |  998 |  525 |  473 |
| `quotient_poly_compute_time_ms` |  264 |  528 |  282 |  246 |
| `quotient_poly_commit_time_ms` |  229.50 |  459 |  262 |  197 |
| `pcs_opening_time_ms ` |  792 |  1,584 |  829 |  755 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2 | 543 | 4,165,433 | 1 | 266 | 15.65 | 19 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 41,861 | 44,686 | 2,243,700 | 275,648,700 | 2,621 | 282 | 262 | 525 | 829 | 41,107 | 41,364 | 509 | 93,502,324 | 2,243,700 | 207 | 204 | 10.96 | 6 | 
| regex_program | 1 | 39,062 | 41,515 | 1,921,732 | 242,975,388 | 2,281 | 246 | 197 | 473 | 755 | 38,177 | 38,402 | 404 | 73,017,132 | 1,921,733 | 196 | 172 | 11.14 | 0 | 

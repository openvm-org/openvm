...
|:---|---:|---:|
| Total |  83.63 |  43.15 |
| regex_program |  83.36 |  42.89 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  41,680.50 |  83,361 |  42,886 |  40,475 |
...
| `execute_metered_insn_mi/s` |  15.51 | -          | -          | -          |
| `execute_e3_time_ms  ` |  187 |  374 |  202 |  172 |
| `execute_e3_insn_mi/s` |  11.10 | -          |  11.13 |  11.07 |
| `trace_gen_time_ms   ` |  38,907.50 |  77,815 |  39,896 |  37,919 |
| `memory_finalize_time_ms` |  38,310 |  76,620 |  39,383 |  37,237 |
| `boundary_finalize_time_ms` |  3 |  6 |  6 |  0 |
| `merkle_finalize_time_ms` |  38,049.50 |  76,099 |  39,126 |  36,973 |
| `stark_prove_excluding_trace_time_ms` |  2,586 |  5,172 |  2,788 |  2,384 |
| `main_trace_commit_time_ms` |  504.50 |  1,009 |  561 |  448 |
| `generate_perm_trace_time_ms` |  202 |  404 |  209 |  195 |
| `perm_trace_commit_time_ms` |  575.50 |  1,151 |  624 |  527 |
| `quotient_poly_compute_time_ms` |  266 |  532 |  287 |  245 |
| `quotient_poly_commit_time_ms` |  241 |  482 |  278 |  204 |
| `pcs_opening_time_ms ` |  790 |  1,580 |  824 |  756 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2 | 547 | 4,165,433 | 1 | 268 | 15.51 | 20 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 39,896 | 42,886 | 2,243,700 | 275,648,700 | 2,788 | 287 | 278 | 624 | 824 | 39,126 | 39,383 | 561 | 93,502,324 | 2,243,700 | 209 | 202 | 11.07 | 6 | 
| regex_program | 1 | 37,919 | 40,475 | 1,921,732 | 242,975,388 | 2,384 | 245 | 204 | 527 | 756 | 36,973 | 37,237 | 448 | 73,017,132 | 1,921,733 | 195 | 172 | 11.13 | 0 | 

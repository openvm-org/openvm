...
|:---|---:|---:|
| Total |  83.11 |  42.88 |
| regex_program |  82.84 |  42.61 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  41,420 |  82,840 |  42,614 |  40,226 |
...
| `execute_e3_insn_mi/s` |  11.10 | -          |  11.17 |  11.03 |
| `trace_gen_time_ms   ` |  38,645 |  77,290 |  39,654 |  37,636 |
| `memory_finalize_time_ms` |  38,092 |  76,184 |  39,164 |  37,020 |
| `boundary_finalize_time_ms` |  2.50 |  5 |  5 |  0 |
| `merkle_finalize_time_ms` |  37,846 |  75,692 |  38,916 |  36,776 |
| `stark_prove_excluding_trace_time_ms` |  2,587.50 |  5,175 |  2,757 |  2,418 |
| `main_trace_commit_time_ms` |  505 |  1,010 |  560 |  450 |
| `generate_perm_trace_time_ms` |  206 |  412 |  209 |  203 |
| `perm_trace_commit_time_ms` |  559 |  1,118 |  585 |  533 |
| `quotient_poly_compute_time_ms` |  271.50 |  543 |  293 |  250 |
| `quotient_poly_commit_time_ms` |  242.50 |  485 |  277 |  208 |
| `pcs_opening_time_ms ` |  794.50 |  1,589 |  828 |  761 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 39,654 | 42,614 | 2,243,700 | 275,648,700 | 2,757 | 293 | 277 | 585 | 828 | 38,916 | 39,164 | 560 | 93,502,324 | 2,243,700 | 209 | 203 | 11.03 | 5 | 
| regex_program | 1 | 37,636 | 40,226 | 1,921,732 | 242,975,388 | 2,418 | 250 | 208 | 533 | 761 | 36,776 | 37,020 | 450 | 73,017,132 | 1,921,733 | 203 | 172 | 11.17 | 0 | 

...
|:---|---:|---:|
| Total |  892.25 |  447.78 |
| regex_program |  891.98 |  447.52 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  445,989 |  891,978 |  447,516 |  444,462 |
...
| `execute_metered_insn_mi/s` |  15.54 | -          | -          | -          |
| `execute_e3_time_ms  ` |  187.50 |  375 |  203 |  172 |
| `execute_e3_insn_mi/s` |  11.08 | -          |  11.16 |  10.100 |
| `trace_gen_time_ms   ` |  443,396 |  886,792 |  444,749 |  442,043 |
| `memory_finalize_time_ms` |  442,786 |  885,572 |  444,218 |  441,354 |
| `boundary_finalize_time_ms` |  3.50 |  7 |  7 |  0 |
| `merkle_finalize_time_ms` |  441,291.50 |  882,583 |  442,723 |  439,860 |
| `stark_prove_excluding_trace_time_ms` |  2,405.50 |  4,811 |  2,564 |  2,247 |
| `main_trace_commit_time_ms` |  445 |  890 |  491 |  399 |
| `generate_perm_trace_time_ms` |  208 |  416 |  215 |  201 |
| `perm_trace_commit_time_ms` |  483.50 |  967 |  508 |  459 |
| `quotient_poly_compute_time_ms` |  257.50 |  515 |  280 |  235 |
| `quotient_poly_commit_time_ms` |  221.50 |  443 |  251 |  192 |
| `pcs_opening_time_ms ` |  781 |  1,562 |  813 |  749 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2 | 542 | 4,165,433 | 1 | 268 | 15.54 | 19 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 444,749 | 447,516 | 2,243,700 | 275,648,700 | 2,564 | 280 | 251 | 508 | 813 | 442,723 | 444,218 | 491 | 93,502,324 | 2,243,700 | 215 | 203 | 10.100 | 7 | 
| regex_program | 1 | 442,043 | 444,462 | 1,921,732 | 242,975,388 | 2,247 | 235 | 192 | 459 | 749 | 439,860 | 441,354 | 399 | 73,017,132 | 1,921,733 | 201 | 172 | 11.16 | 0 | 

...
|:---|---:|---:|
| Total |  83.04 |  42.72 |
| regex_program |  82.77 |  42.45 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  41,387 |  82,774 |  42,452 |  40,322 |
...
| `execute_metered_insn_mi/s` |  15.47 | -          | -          | -          |
| `execute_e3_time_ms  ` |  186 |  372 |  202 |  170 |
| `execute_e3_insn_mi/s` |  11.15 | -          |  11.24 |  11.06 |
| `trace_gen_time_ms   ` |  38,623.50 |  77,247 |  39,485 |  37,762 |
| `memory_finalize_time_ms` |  38,048.50 |  76,097 |  38,993 |  37,104 |
| `boundary_finalize_time_ms` |  3 |  6 |  6 |  0 |
| `merkle_finalize_time_ms` |  37,825 |  75,650 |  38,739 |  36,911 |
| `stark_prove_excluding_trace_time_ms` |  2,577.50 |  5,155 |  2,765 |  2,390 |
| `main_trace_commit_time_ms` |  510.50 |  1,021 |  569 |  452 |
| `generate_perm_trace_time_ms` |  202 |  404 |  207 |  197 |
| `perm_trace_commit_time_ms` |  556.50 |  1,113 |  584 |  529 |
| `quotient_poly_compute_time_ms` |  258.50 |  517 |  284 |  233 |
| `quotient_poly_commit_time_ms` |  244 |  488 |  278 |  210 |
| `pcs_opening_time_ms ` |  798.50 |  1,597 |  837 |  760 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2 | 548 | 4,165,433 | 1 | 269 | 15.47 | 20 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 39,485 | 42,452 | 2,243,700 | 275,648,700 | 2,765 | 284 | 278 | 584 | 837 | 38,739 | 38,993 | 569 | 93,502,324 | 2,243,700 | 207 | 202 | 11.06 | 6 | 
| regex_program | 1 | 37,762 | 40,322 | 1,921,732 | 242,975,388 | 2,390 | 233 | 210 | 529 | 760 | 36,911 | 37,104 | 452 | 73,017,132 | 1,921,733 | 197 | 170 | 11.24 | 0 | 

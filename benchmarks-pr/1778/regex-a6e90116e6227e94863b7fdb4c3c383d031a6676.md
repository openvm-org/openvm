...
|:---|---:|---:|
| Total |  86.28 |  44.57 |
| regex_program |  86.02 |  44.30 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  43,009.50 |  86,019 |  44,301 |  41,718 |
...
| `execute_metered_insn_mi/s` |  15.71 | -          | -          | -          |
| `execute_e3_time_ms  ` |  186 |  372 |  202 |  170 |
| `execute_e3_insn_mi/s` |  11.18 | -          |  11.27 |  11.10 |
| `trace_gen_time_ms   ` |  40,344 |  80,688 |  41,463 |  39,225 |
| `memory_finalize_time_ms` |  39,777 |  79,554 |  40,960 |  38,594 |
| `boundary_finalize_time_ms` |  3 |  6 |  6 |  0 |
| `merkle_finalize_time_ms` |  39,531 |  79,062 |  40,704 |  38,358 |
| `stark_prove_excluding_trace_time_ms` |  2,479.50 |  4,959 |  2,636 |  2,323 |
| `main_trace_commit_time_ms` |  456.50 |  913 |  510 |  403 |
| `generate_perm_trace_time_ms` |  210 |  420 |  220 |  200 |
| `perm_trace_commit_time_ms` |  498.50 |  997 |  523 |  474 |
| `quotient_poly_compute_time_ms` |  261 |  522 |  284 |  238 |
| `quotient_poly_commit_time_ms` |  225.50 |  451 |  260 |  191 |
| `pcs_opening_time_ms ` |  819 |  1,638 |  834 |  804 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2 | 539 | 4,165,433 | 1 | 265 | 15.71 | 19 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 41,463 | 44,301 | 2,243,700 | 275,648,700 | 2,636 | 284 | 260 | 523 | 834 | 40,704 | 40,960 | 510 | 93,502,324 | 2,243,700 | 220 | 202 | 11.10 | 6 | 
| regex_program | 1 | 39,225 | 41,718 | 1,921,732 | 242,975,388 | 2,323 | 238 | 191 | 474 | 804 | 38,358 | 38,594 | 403 | 73,017,132 | 1,921,733 | 200 | 170 | 11.27 | 0 | 

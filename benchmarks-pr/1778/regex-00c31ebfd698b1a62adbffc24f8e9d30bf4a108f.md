...
|:---|---:|---:|
| Total |  87.35 |  44.60 |
| regex_program |  87.08 |  44.33 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  43,541 |  87,082 |  44,327 |  42,755 |
...
| `execute_metered_insn_mi/s` |  15.45 | -          | -          | -          |
| `execute_e3_time_ms  ` |  189.50 |  379 |  205 |  174 |
| `execute_e3_insn_mi/s` |  10.97 | -          |  11.02 |  10.93 |
| `trace_gen_time_ms   ` |  40,744 |  81,488 |  41,365 |  40,123 |
| `memory_finalize_time_ms` |  40,160.50 |  80,321 |  40,860 |  39,461 |
| `boundary_finalize_time_ms` |  2.50 |  5 |  5 |  0 |
| `merkle_finalize_time_ms` |  39,908.50 |  79,817 |  40,639 |  39,178 |
| `stark_prove_excluding_trace_time_ms` |  2,607.50 |  5,215 |  2,757 |  2,458 |
| `main_trace_commit_time_ms` |  507 |  1,014 |  563 |  451 |
| `generate_perm_trace_time_ms` |  206.50 |  413 |  210 |  203 |
| `perm_trace_commit_time_ms` |  557 |  1,114 |  586 |  528 |
| `quotient_poly_compute_time_ms` |  260.50 |  521 |  280 |  241 |
| `quotient_poly_commit_time_ms` |  245.50 |  491 |  284 |  207 |
| `pcs_opening_time_ms ` |  824 |  1,648 |  836 |  812 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2 | 548 | 4,165,433 | 1 | 269 | 15.45 | 20 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 41,365 | 44,327 | 2,243,700 | 275,648,700 | 2,757 | 280 | 284 | 586 | 836 | 40,639 | 40,860 | 563 | 93,502,324 | 2,243,700 | 203 | 205 | 10.93 | 5 | 
| regex_program | 1 | 40,123 | 42,755 | 1,921,732 | 242,975,388 | 2,458 | 241 | 207 | 528 | 812 | 39,178 | 39,461 | 451 | 73,017,132 | 1,921,733 | 210 | 174 | 11.02 | 0 | 

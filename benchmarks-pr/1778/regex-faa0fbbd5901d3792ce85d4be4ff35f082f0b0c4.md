...
|:---|---:|---:|
| Total |  86.25 |  44.32 |
| regex_program |  85.98 |  44.06 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  42,991 |  85,982 |  44,056 |  41,926 |
| `main_cells_used     ` |  83,259,728 |  166,519,456 |  93,502,324 |  73,017,132 |
| `total_cycles        ` |  2,082,716 |  4,165,432 |  2,243,700 |  1,921,732 |
| `execute_metered_time_ms` |  268 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  15.53 | -          | -          | -          |
| `execute_e3_time_ms  ` |  188 |  376 |  203 |  173 |
| `execute_e3_insn_mi/s` |  11.07 | -          |  11.11 |  11.03 |
| `trace_gen_time_ms   ` |  40,209 |  80,418 |  41,090 |  39,328 |
| `memory_finalize_time_ms` |  39,617 |  79,234 |  40,566 |  38,668 |
| `boundary_finalize_time_ms` |  2.50 |  5 |  5 |  0 |
| `merkle_finalize_time_ms` |  39,369 |  78,738 |  40,312 |  38,426 |
| `stark_prove_excluding_trace_time_ms` |  2,594 |  5,188 |  2,763 |  2,425 |
| `main_trace_commit_time_ms` |  507 |  1,014 |  562 |  452 |
| `generate_perm_trace_time_ms` |  204.50 |  409 |  210 |  199 |
| `perm_trace_commit_time_ms` |  558 |  1,116 |  587 |  529 |
| `quotient_poly_compute_time_ms` |  278 |  556 |  298 |  258 |
| `quotient_poly_commit_time_ms` |  242 |  484 |  272 |  212 |
| `pcs_opening_time_ms ` |  794 |  1,588 |  830 |  758 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2 | 547 | 4,165,433 | 1 | 268 | 15.53 | 20 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 41,090 | 44,056 | 2,243,700 | 275,648,700 | 2,763 | 298 | 272 | 587 | 830 | 40,312 | 40,566 | 562 | 93,502,324 | 2,243,700 | 210 | 203 | 11.03 | 5 | 
| regex_program | 1 | 39,328 | 41,926 | 1,921,732 | 242,975,388 | 2,425 | 258 | 212 | 529 | 758 | 38,426 | 38,668 | 452 | 73,017,132 | 1,921,733 | 199 | 173 | 11.11 | 0 | 

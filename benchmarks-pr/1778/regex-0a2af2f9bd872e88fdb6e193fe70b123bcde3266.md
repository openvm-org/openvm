...
|:---|---:|---:|
| Total |  82.59 |  42.50 |
| regex_program |  82.32 |  42.23 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  41,162 |  82,324 |  42,235 |  40,089 |
| `main_cells_used     ` |  83,259,728 |  166,519,456 |  93,502,324 |  73,017,132 |
| `total_cycles        ` |  2,082,716 |  4,165,432 |  2,243,700 |  1,921,732 |
| `execute_metered_time_ms` |  265 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  15.67 | -          | -          | -          |
| `execute_e3_time_ms  ` |  187.50 |  375 |  203 |  172 |
| `execute_e3_insn_mi/s` |  11.08 | -          |  11.16 |  11.01 |
| `trace_gen_time_ms   ` |  38,524 |  77,048 |  39,413 |  37,635 |
| `memory_finalize_time_ms` |  37,969.50 |  75,939 |  38,927 |  37,012 |
| `boundary_finalize_time_ms` |  2.50 |  5 |  5 |  0 |
| `merkle_finalize_time_ms` |  37,741 |  75,482 |  38,712 |  36,770 |
| `stark_prove_excluding_trace_time_ms` |  2,450.50 |  4,901 |  2,619 |  2,282 |
| `main_trace_commit_time_ms` |  457 |  914 |  510 |  404 |
| `generate_perm_trace_time_ms` |  205.50 |  411 |  208 |  203 |
| `perm_trace_commit_time_ms` |  499.50 |  999 |  527 |  472 |
| `quotient_poly_compute_time_ms` |  263 |  526 |  284 |  242 |
| `quotient_poly_commit_time_ms` |  226 |  452 |  258 |  194 |
| `pcs_opening_time_ms ` |  790 |  1,580 |  827 |  753 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2 | 539 | 4,165,433 | 1 | 265 | 15.67 | 19 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 39,413 | 42,235 | 2,243,700 | 275,648,700 | 2,619 | 284 | 258 | 527 | 827 | 38,712 | 38,927 | 510 | 93,502,324 | 2,243,700 | 208 | 203 | 11.01 | 5 | 
| regex_program | 1 | 37,635 | 40,089 | 1,921,732 | 242,975,388 | 2,282 | 242 | 194 | 472 | 753 | 36,770 | 37,012 | 404 | 73,017,132 | 1,921,733 | 203 | 172 | 11.16 | 0 | 

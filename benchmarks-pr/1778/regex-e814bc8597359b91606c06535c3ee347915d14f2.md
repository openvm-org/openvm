...
|:---|---:|---:|
| Total |  891.83 |  447.57 |
| regex_program |  891.56 |  447.30 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  445,781 |  891,562 |  447,299 |  444,263 |
...
| `execute_e3_time_ms  ` |  188 |  376 |  204 |  172 |
| `execute_e3_insn_mi/s` |  11.07 | -          |  11.15 |  10.99 |
| `trace_gen_time_ms   ` |  443,172.50 |  886,345 |  444,508 |  441,837 |
| `memory_finalize_time_ms` |  442,545 |  885,090 |  443,953 |  441,137 |
| `boundary_finalize_time_ms` |  3.50 |  7 |  7 |  0 |
| `merkle_finalize_time_ms` |  441,066.50 |  882,133 |  442,458 |  439,675 |
| `stark_prove_excluding_trace_time_ms` |  2,420.50 |  4,841 |  2,587 |  2,254 |
| `main_trace_commit_time_ms` |  447 |  894 |  497 |  397 |
| `generate_perm_trace_time_ms` |  206 |  412 |  213 |  199 |
| `perm_trace_commit_time_ms` |  486.50 |  973 |  511 |  462 |
| `quotient_poly_compute_time_ms` |  264 |  528 |  285 |  243 |
| `quotient_poly_commit_time_ms` |  222.50 |  445 |  255 |  190 |
| `pcs_opening_time_ms ` |  787.50 |  1,575 |  822 |  753 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2 | 544 | 4,165,433 | 1 | 268 | 15.54 | 19 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 444,508 | 447,299 | 2,243,700 | 275,648,700 | 2,587 | 285 | 255 | 511 | 822 | 442,458 | 443,953 | 497 | 93,502,324 | 2,243,700 | 213 | 204 | 10.99 | 7 | 
| regex_program | 1 | 441,837 | 444,263 | 1,921,732 | 242,975,388 | 2,254 | 243 | 190 | 462 | 753 | 439,675 | 441,137 | 397 | 73,017,132 | 1,921,733 | 199 | 172 | 11.15 | 0 | 

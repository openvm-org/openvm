...
|:---|---:|---:|
| Total |  88.14 |  45.97 |
| regex_program |  87.88 |  45.70 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  43,937.50 |  87,875 |  45,705 |  42,170 |
...
| `execute_metered_insn_mi/s` |  15.52 | -          | -          | -          |
| `execute_e3_time_ms  ` |  189 |  378 |  205 |  173 |
| `execute_e3_insn_mi/s` |  11 | -          |  11.08 |  10.93 |
| `trace_gen_time_ms   ` |  41,333.50 |  82,667 |  42,924 |  39,743 |
| `memory_finalize_time_ms` |  40,780.50 |  81,561 |  42,445 |  39,116 |
| `boundary_finalize_time_ms` |  3.50 |  7 |  7 |  0 |
| `merkle_finalize_time_ms` |  39,503 |  79,006 |  41,159 |  37,847 |
| `stark_prove_excluding_trace_time_ms` |  2,415 |  4,830 |  2,576 |  2,254 |
| `main_trace_commit_time_ms` |  447.50 |  895 |  492 |  403 |
| `generate_perm_trace_time_ms` |  211 |  422 |  212 |  210 |
| `perm_trace_commit_time_ms` |  484.50 |  969 |  507 |  462 |
| `quotient_poly_compute_time_ms` |  259 |  518 |  282 |  236 |
| `quotient_poly_commit_time_ms` |  226 |  452 |  265 |  187 |
| `pcs_opening_time_ms ` |  778.50 |  1,557 |  813 |  744 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2 | 539 | 4,165,433 | 1 | 268 | 15.52 | 19 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 42,924 | 45,705 | 2,243,700 | 275,648,700 | 2,576 | 282 | 265 | 507 | 813 | 41,159 | 42,445 | 492 | 93,502,324 | 2,243,700 | 210 | 205 | 10.93 | 7 | 
| regex_program | 1 | 39,743 | 42,170 | 1,921,732 | 242,975,388 | 2,254 | 236 | 187 | 462 | 744 | 37,847 | 39,116 | 403 | 73,017,132 | 1,921,733 | 212 | 173 | 11.08 | 0 | 

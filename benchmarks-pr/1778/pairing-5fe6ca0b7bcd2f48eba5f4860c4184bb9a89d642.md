...
|:---|---:|---:|
| Total |  453.56 |  453.56 |
| pairing |  453.25 |  453.25 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  453,246 |  453,246 |  453,246 |  453,246 |
| `main_cells_used     ` |  97,508,739 |  97,508,739 |  97,508,739 |  97,508,739 |
| `total_cycles        ` |  1,862,964 |  1,862,964 |  1,862,964 |  1,862,964 |
| `execute_metered_time_ms` |  313 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  5.93 | -          | -          | -          |
| `execute_e3_time_ms  ` |  418 |  418 |  418 |  418 |
| `execute_e3_insn_mi/s` |  4.45 | -          |  4.45 |  4.45 |
| `trace_gen_time_ms   ` |  450,027 |  450,027 |  450,027 |  450,027 |
| `memory_finalize_time_ms` |  449,517 |  449,517 |  449,517 |  449,517 |
| `boundary_finalize_time_ms` |  5 |  5 |  5 |  5 |
| `merkle_finalize_time_ms` |  446,872 |  446,872 |  446,872 |  446,872 |
| `stark_prove_excluding_trace_time_ms` |  2,801 |  2,801 |  2,801 |  2,801 |
...
| `quotient_poly_commit_time_ms` |  270 |  270 |  270 |  270 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 1 | 1,089 | 1,862,965 | 1 | 313 | 5.93 | 10 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 450,027 | 453,246 | 1,862,964 | 304,931,516 | 2,801 | 328 | 270 | 552 | 860 | 446,872 | 449,517 | 555 | 97,508,739 | 1,862,965 | 227 | 418 | 4.45 | 5 | 

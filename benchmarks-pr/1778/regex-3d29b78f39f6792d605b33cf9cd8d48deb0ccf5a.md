...
|:---|---:|---:|
| Total |  86.56 |  44.70 |
| regex_program |  86.29 |  44.43 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  43,146 |  86,292 |  44,434 |  41,858 |
...
| `execute_metered_insn_mi/s` |  15.66 | -          | -          | -          |
| `execute_e3_time_ms  ` |  186 |  372 |  202 |  170 |
| `execute_e3_insn_mi/s` |  11.17 | -          |  11.25 |  11.08 |
| `trace_gen_time_ms   ` |  40,511.50 |  81,023 |  41,611 |  39,412 |
| `memory_finalize_time_ms` |  39,938 |  79,876 |  41,105 |  38,771 |
| `boundary_finalize_time_ms` |  2.50 |  5 |  5 |  0 |
| `merkle_finalize_time_ms` |  39,719.50 |  79,439 |  40,873 |  38,566 |
| `stark_prove_excluding_trace_time_ms` |  2,448.50 |  4,897 |  2,621 |  2,276 |
| `main_trace_commit_time_ms` |  459 |  918 |  515 |  403 |
| `generate_perm_trace_time_ms` |  200 |  400 |  205 |  195 |
| `perm_trace_commit_time_ms` |  497 |  994 |  524 |  470 |
| `quotient_poly_compute_time_ms` |  263.50 |  527 |  286 |  241 |
| `quotient_poly_commit_time_ms` |  227.50 |  455 |  260 |  195 |
| `pcs_opening_time_ms ` |  793 |  1,586 |  826 |  760 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2 | 543 | 4,165,433 | 1 | 265 | 15.66 | 20 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 41,611 | 44,434 | 2,243,700 | 275,648,700 | 2,621 | 286 | 260 | 524 | 826 | 40,873 | 41,105 | 515 | 93,502,324 | 2,243,700 | 205 | 202 | 11.08 | 5 | 
| regex_program | 1 | 39,412 | 41,858 | 1,921,732 | 242,975,388 | 2,276 | 241 | 195 | 470 | 760 | 38,566 | 38,771 | 403 | 73,017,132 | 1,921,733 | 195 | 170 | 11.25 | 0 | 

...
|:---|---:|---:|
| Total |  82.88 |  42.75 |
| regex_program |  82.61 |  42.49 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  41,306 |  82,612 |  42,486 |  40,126 |
| `main_cells_used     ` |  83,259,728 |  166,519,456 |  93,502,324 |  73,017,132 |
| `total_cycles        ` |  2,082,716 |  4,165,432 |  2,243,700 |  1,921,732 |
| `execute_metered_time_ms` |  266 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  15.64 | -          | -          | -          |
| `execute_e3_time_ms  ` |  185.50 |  371 |  201 |  170 |
| `execute_e3_insn_mi/s` |  11.20 | -          |  11.26 |  11.13 |
| `trace_gen_time_ms   ` |  38,667 |  77,334 |  39,641 |  37,693 |
| `memory_finalize_time_ms` |  38,112.50 |  76,225 |  39,166 |  37,059 |
| `boundary_finalize_time_ms` |  2.50 |  5 |  5 |  0 |
| `merkle_finalize_time_ms` |  37,890 |  75,780 |  38,918 |  36,862 |
| `stark_prove_excluding_trace_time_ms` |  2,453.50 |  4,907 |  2,644 |  2,263 |
| `main_trace_commit_time_ms` |  460 |  920 |  515 |  405 |
| `generate_perm_trace_time_ms` |  203 |  406 |  219 |  187 |
| `perm_trace_commit_time_ms` |  507.50 |  1,015 |  542 |  473 |
| `quotient_poly_compute_time_ms` |  263.50 |  527 |  286 |  241 |
| `quotient_poly_commit_time_ms` |  222.50 |  445 |  255 |  190 |
| `pcs_opening_time_ms ` |  790 |  1,580 |  823 |  757 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2 | 541 | 4,165,433 | 1 | 266 | 15.64 | 19 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 39,641 | 42,486 | 2,243,700 | 275,648,700 | 2,644 | 286 | 255 | 542 | 823 | 38,918 | 39,166 | 515 | 93,502,324 | 2,243,700 | 219 | 201 | 11.13 | 5 | 
| regex_program | 1 | 37,693 | 40,126 | 1,921,732 | 242,975,388 | 2,263 | 241 | 190 | 473 | 757 | 36,862 | 37,059 | 405 | 73,017,132 | 1,921,733 | 187 | 170 | 11.26 | 0 | 

...
|:---|---:|---:|
| Total |  83.28 |  42.88 |
| regex_program |  83.02 |  42.61 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  41,507.50 |  83,015 |  42,611 |  40,404 |
...
| `execute_e3_time_ms  ` |  189.50 |  379 |  206 |  173 |
| `execute_e3_insn_mi/s` |  10.95 | -          |  11.04 |  10.86 |
| `trace_gen_time_ms   ` |  38,729 |  77,458 |  39,643 |  37,815 |
| `memory_finalize_time_ms` |  38,148.50 |  76,297 |  39,138 |  37,159 |
| `boundary_finalize_time_ms` |  3 |  6 |  6 |  0 |
| `merkle_finalize_time_ms` |  37,914.50 |  75,829 |  38,915 |  36,914 |
| `stark_prove_excluding_trace_time_ms` |  2,589 |  5,178 |  2,762 |  2,416 |
| `main_trace_commit_time_ms` |  505 |  1,010 |  561 |  449 |
| `generate_perm_trace_time_ms` |  210.50 |  421 |  214 |  207 |
| `perm_trace_commit_time_ms` |  564 |  1,128 |  601 |  527 |
| `quotient_poly_compute_time_ms` |  262.50 |  525 |  283 |  242 |
| `quotient_poly_commit_time_ms` |  245 |  490 |  282 |  208 |
| `pcs_opening_time_ms ` |  793.50 |  1,587 |  823 |  764 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2 | 549 | 4,165,433 | 1 | 268 | 15.53 | 20 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 39,643 | 42,611 | 2,243,700 | 275,648,700 | 2,762 | 283 | 282 | 601 | 823 | 38,915 | 39,138 | 561 | 93,502,324 | 2,243,700 | 207 | 206 | 10.86 | 6 | 
| regex_program | 1 | 37,815 | 40,404 | 1,921,732 | 242,975,388 | 2,416 | 242 | 208 | 527 | 764 | 36,914 | 37,159 | 449 | 73,017,132 | 1,921,733 | 214 | 173 | 11.04 | 0 | 

...
|:---|---:|---:|
| Total |  459.07 |  459.07 |
| fibonacci_program |  458.100 |  458.100 |


| fibonacci_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  458,997 |  458,997 |  458,997 |  458,997 |
| `main_cells_used     ` |  50,589,503 |  50,589,503 |  50,589,503 |  50,589,503 |
| `total_cycles        ` |  1,500,277 |  1,500,277 |  1,500,277 |  1,500,277 |
| `execute_metered_time_ms` |  76 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  19.70 | -          | -          | -          |
| `execute_e3_time_ms  ` |  115 |  115 |  115 |  115 |
| `execute_e3_insn_mi/s` |  12.99 | -          |  12.99 |  12.99 |
| `trace_gen_time_ms   ` |  457,141 |  457,141 |  457,141 |  457,141 |
| `memory_finalize_time_ms` |  456,690 |  456,690 |  456,690 |  456,690 |
| `boundary_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `merkle_finalize_time_ms` |  455,215 |  455,215 |  455,215 |  455,215 |
| `stark_prove_excluding_trace_time_ms` |  1,741 |  1,741 |  1,741 |  1,741 |
| `main_trace_commit_time_ms` |  308 |  308 |  308 |  308 |
| `generate_perm_trace_time_ms` |  132 |  132 |  132 |  132 |
| `perm_trace_commit_time_ms` |  334 |  334 |  334 |  334 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 1 | 240 | 1,500,278 | 1 | 76 | 19.70 | 5 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 457,141 | 458,997 | 1,500,277 | 160,837,996 | 1,741 | 173 | 179 | 334 | 605 | 455,215 | 456,690 | 308 | 50,589,503 | 1,500,278 | 132 | 115 | 12.99 | 0 | 

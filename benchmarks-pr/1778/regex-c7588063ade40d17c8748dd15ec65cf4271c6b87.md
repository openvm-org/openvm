...
|:---|---:|---:|
| Total |  86.90 |  44.86 |
| regex_program |  86.63 |  44.59 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  43,316.50 |  86,633 |  44,589 |  42,044 |
...
| `execute_e3_time_ms  ` |  190.50 |  381 |  206 |  175 |
| `execute_e3_insn_mi/s` |  10.91 | -          |  10.96 |  10.86 |
| `trace_gen_time_ms   ` |  40,550.50 |  81,101 |  41,645 |  39,456 |
| `memory_finalize_time_ms` |  39,980 |  79,960 |  41,155 |  38,805 |
| `boundary_finalize_time_ms` |  2.50 |  5 |  5 |  0 |
| `merkle_finalize_time_ms` |  39,717 |  79,434 |  40,832 |  38,602 |
| `stark_prove_excluding_trace_time_ms` |  2,575.50 |  5,151 |  2,738 |  2,413 |
| `main_trace_commit_time_ms` |  508 |  1,016 |  564 |  452 |
| `generate_perm_trace_time_ms` |  200.50 |  401 |  201 |  200 |
| `perm_trace_commit_time_ms` |  557 |  1,114 |  587 |  527 |
| `quotient_poly_compute_time_ms` |  268.50 |  537 |  280 |  257 |
| `quotient_poly_commit_time_ms` |  239.50 |  479 |  275 |  204 |
| `pcs_opening_time_ms ` |  791 |  1,582 |  824 |  758 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2 | 547 | 4,165,433 | 1 | 267 | 15.54 | 20 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 41,645 | 44,589 | 2,243,700 | 275,648,700 | 2,738 | 280 | 275 | 587 | 824 | 40,832 | 41,155 | 564 | 93,502,324 | 2,243,700 | 201 | 206 | 10.86 | 5 | 
| regex_program | 1 | 39,456 | 42,044 | 1,921,732 | 242,975,388 | 2,413 | 257 | 204 | 527 | 758 | 38,602 | 38,805 | 452 | 73,017,132 | 1,921,733 | 200 | 175 | 10.96 | 0 | 

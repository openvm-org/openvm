...
|:---|---:|---:|
| Total |  83.96 |  43.05 |
| regex_program |  83.70 |  42.79 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  41,848 |  83,696 |  42,790 |  40,906 |
| `main_cells_used     ` |  83,259,728 |  166,519,456 |  93,502,324 |  73,017,132 |
| `total_cycles        ` |  2,082,716 |  4,165,432 |  2,243,700 |  1,921,732 |
| `execute_metered_time_ms` |  263 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  15.80 | -          | -          | -          |
| `execute_e3_time_ms  ` |  185.50 |  371 |  201 |  170 |
| `execute_e3_insn_mi/s` |  11.22 | -          |  11.30 |  11.15 |
| `trace_gen_time_ms   ` |  39,197 |  78,394 |  39,986 |  38,408 |
| `memory_finalize_time_ms` |  38,609.50 |  77,219 |  39,478 |  37,741 |
| `boundary_finalize_time_ms` |  2.50 |  5 |  5 |  0 |
| `merkle_finalize_time_ms` |  38,320.50 |  76,641 |  39,184 |  37,457 |
| `stark_prove_excluding_trace_time_ms` |  2,465.50 |  4,931 |  2,603 |  2,328 |
| `main_trace_commit_time_ms` |  455 |  910 |  509 |  401 |
| `generate_perm_trace_time_ms` |  212.50 |  425 |  214 |  211 |
| `perm_trace_commit_time_ms` |  496.50 |  993 |  521 |  472 |
| `quotient_poly_compute_time_ms` |  267.50 |  535 |  282 |  253 |
| `quotient_poly_commit_time_ms` |  221.50 |  443 |  253 |  190 |
| `pcs_opening_time_ms ` |  804 |  1,608 |  817 |  791 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2 | 539 | 4,165,433 | 1 | 263 | 15.80 | 19 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 39,986 | 42,790 | 2,243,700 | 275,648,700 | 2,603 | 282 | 253 | 521 | 817 | 39,184 | 39,478 | 509 | 93,502,324 | 2,243,700 | 214 | 201 | 11.15 | 5 | 
| regex_program | 1 | 38,408 | 40,906 | 1,921,732 | 242,975,388 | 2,328 | 253 | 190 | 472 | 791 | 37,457 | 37,741 | 401 | 73,017,132 | 1,921,733 | 211 | 170 | 11.30 | 0 | 

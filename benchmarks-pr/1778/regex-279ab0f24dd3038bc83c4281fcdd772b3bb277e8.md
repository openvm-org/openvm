...
|:---|---:|---:|
| Total |  82.58 |  42.40 |
| regex_program |  82.32 |  42.14 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  41,158 |  82,316 |  42,137 |  40,179 |
...
| `execute_e3_time_ms  ` |  187 |  374 |  203 |  171 |
| `execute_e3_insn_mi/s` |  11.10 | -          |  11.18 |  11.01 |
| `trace_gen_time_ms   ` |  38,497.50 |  76,995 |  39,314 |  37,681 |
| `memory_finalize_time_ms` |  37,908 |  75,816 |  38,802 |  37,014 |
| `boundary_finalize_time_ms` |  2.50 |  5 |  5 |  0 |
| `merkle_finalize_time_ms` |  37,693 |  75,386 |  38,591 |  36,795 |
| `stark_prove_excluding_trace_time_ms` |  2,473.50 |  4,947 |  2,620 |  2,327 |
| `main_trace_commit_time_ms` |  460.50 |  921 |  510 |  411 |
| `generate_perm_trace_time_ms` |  205.50 |  411 |  208 |  203 |
| `perm_trace_commit_time_ms` |  516 |  1,032 |  525 |  507 |
| `quotient_poly_compute_time_ms` |  262 |  524 |  286 |  238 |
| `quotient_poly_commit_time_ms` |  233 |  466 |  260 |  206 |
| `pcs_opening_time_ms ` |  788.50 |  1,577 |  824 |  753 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2 | 538 | 4,165,433 | 1 | 265 | 15.70 | 19 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 39,314 | 42,137 | 2,243,700 | 275,648,700 | 2,620 | 286 | 260 | 525 | 824 | 38,591 | 38,802 | 510 | 93,502,324 | 2,243,700 | 208 | 203 | 11.01 | 5 | 
| regex_program | 1 | 37,681 | 40,179 | 1,921,732 | 242,975,388 | 2,327 | 238 | 206 | 507 | 753 | 36,795 | 37,014 | 411 | 73,017,132 | 1,921,733 | 203 | 171 | 11.18 | 0 | 

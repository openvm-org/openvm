...
|:---|---:|---:|
| Total |  899.26 |  451.93 |
| regex_program |  898.98 |  451.64 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  449,489 |  898,978 |  451,641 |  447,337 |
| `main_cells_used     ` |  83,259,728 |  166,519,456 |  93,502,324 |  73,017,132 |
| `total_cycles        ` |  2,082,716 |  4,165,432 |  2,243,700 |  1,921,732 |
| `execute_metered_time_ms` |  285 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  14.58 | -          | -          | -          |
| `execute_e3_time_ms  ` |  227.50 |  455 |  247 |  208 |
| `execute_e3_insn_mi/s` |  9.14 | -          |  9.22 |  9.06 |
| `trace_gen_time_ms   ` |  446,705.50 |  893,411 |  448,664 |  444,747 |
| `memory_finalize_time_ms` |  446,070 |  892,140 |  448,128 |  444,012 |
| `boundary_finalize_time_ms` |  3.50 |  7 |  7 |  0 |
| `merkle_finalize_time_ms` |  443,411.50 |  886,823 |  445,452 |  441,371 |
| `stark_prove_excluding_trace_time_ms` |  2,556 |  5,112 |  2,730 |  2,382 |
| `main_trace_commit_time_ms` |  495 |  990 |  545 |  445 |
| `generate_perm_trace_time_ms` |  201.50 |  403 |  206 |  197 |
| `perm_trace_commit_time_ms` |  549.50 |  1,099 |  581 |  518 |
| `quotient_poly_compute_time_ms` |  258 |  516 |  280 |  236 |
| `quotient_poly_commit_time_ms` |  243 |  486 |  275 |  211 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2 | 545 | 4,165,433 | 1 | 285 | 14.58 | 20 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 448,664 | 451,641 | 2,243,700 | 275,648,700 | 2,730 | 280 | 275 | 581 | 834 | 445,452 | 448,128 | 545 | 93,502,324 | 2,243,700 | 206 | 247 | 9.06 | 7 | 
| regex_program | 1 | 444,747 | 447,337 | 1,921,732 | 242,975,388 | 2,382 | 236 | 211 | 518 | 762 | 441,371 | 444,012 | 445 | 73,017,132 | 1,921,733 | 197 | 208 | 9.22 | 0 | 

...
| `execute_metered_insn_mi/s` |  58.98 | -          |  58.98 |  58.98 |
| `execute_preflight_insns` |  1,289,951.50 |  2,579,903 |  1,540,000 |  1,039,903 |
| `execute_preflight_time_ms` |  101 |  202 |  139 |  63 |
| `execute_preflight_insn_mi/s` |  35.80 | -          |  36.67 |  34.94 |
| `trace_gen_time_ms   ` |  136 |  272 |  182 |  90 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,563.50 |  3,127 |  1,800 |  1,327 |
| `prover.main_trace_commit_time_ms` |  511 |  1,022 |  595 |  427 |
| `prover.rap_constraints_time_ms` |  925 |  1,850 |  1,071 |  779 |
| `prover.openings_time_ms` |  126.50 |  253 |  133 |  120 |
| `prover.rap_constraints.logup_gkr_time_ms` |  166.50 |  333 |  197 |  136 |
| `prover.rap_constraints.round0_time_ms` |  559.50 |  1,119 |  664 |  455 |
| `prover.rap_constraints.mle_rounds_time_ms` |  198 |  396 |  209 |  187 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/f870ed85f8dee0be95662c746945a0af57f7a585/kitchen_sink-f870ed85f8dee0be95662c746945a0af57f7a585.memory.svg)
...
| app_proof |  |  |  |  |  | 1,598 |  |  | 43 | 2,579,903 | 58.98 | 0 | 3,871 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,577,979 | 256 | 116 | 0 | 0 | 107 | 36 | 35 | 51 | 20 | 0 | 32 | 19 | 13 | 3 | 9 | 116 | 107 | 0 | 2 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,767 | 142 | 45 | 0 | 0 | 67 | 24 | 24 | 28 | 13 | 0 | 29 | 21 | 8 | 1 | 6 | 45 | 67 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 122 | 31 | 0 | 0 | 62 | 23 | 23 | 24 | 13 | 0 | 28 | 21 | 7 | 1 | 5 | 32 | 62 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 265,003,892 | 822 | 398 | 0 | 1 | 346 | 132 | 131 | 77 | 136 | 0 | 78 | 37 | 40 | 21 | 18 | 398 | 346 | 0 | 6 | 135 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 567,917,156 | 1,800 | 594 | 0 | 187 | 1,071 | 664 | 663 | 209 | 197 | 55 | 133 | 33 | 100 | 50 | 49 | 595 | 1,071 | 0 | 3 | 140 | 0 | 0 | 
| app_proof | prover | 1 | 537,266,124 | 1,327 | 426 | 0 | 1 | 779 | 455 | 455 | 187 | 136 | 0 | 120 | 35 | 85 | 48 | 36 | 427 | 779 | 0 | 3 | 135 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 182 | 2,225 | 182 | 178 | 9,069,025,194 | 1,018,123,350 | 10,087,148,544 | 2,097,152 | 2,097,152 | 0 | 3 | 63 | 1,540,000 | 34.94 | 
| app_proof | 1 | 90 | 1,598 | 90 | 41 | 6,675,792,954 | 2,876,399,838 | 9,552,192,792 | 2,097,152 | 2,097,152 | 0 | 2 | 139 | 1,039,903 | 36.67 | 

...
|:---|---:|---:|---:|
| Total |  5.36 |  3.76 |  3.76 |
| app_proof |  3.86 |  2.26 |  2.26 |
| leaf |  0.94 |  0.94 |  0.94 |
...
| `total_proof_time_ms ` |  1,911.50 |  3,823 |  2,225 |  1,598 |
| `execute_metered_time_ms` |  36 | -          | -          | -          |
| `execute_metered_insns` |  2,579,903 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  70.14 | -          |  70.14 |  70.14 |
| `execute_preflight_insns` |  1,289,951.50 |  2,579,903 |  1,540,000 |  1,039,903 |
| `execute_preflight_time_ms` |  97.50 |  195 |  132 |  63 |
| `execute_preflight_insn_mi/s` |  35.87 | -          |  36.89 |  34.85 |
| `trace_gen_time_ms   ` |  141.50 |  283 |  185 |  98 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,563 |  3,126 |  1,800 |  1,326 |
| `prover.main_trace_commit_time_ms` |  510.50 |  1,021 |  595 |  426 |
| `prover.rap_constraints_time_ms` |  924.50 |  1,849 |  1,070 |  779 |
| `prover.openings_time_ms` |  127 |  254 |  134 |  120 |
| `prover.rap_constraints.logup_gkr_time_ms` |  166 |  332 |  197 |  135 |
| `prover.rap_constraints.round0_time_ms` |  557.50 |  1,115 |  662 |  453 |
| `prover.rap_constraints.mle_rounds_time_ms` |  199 |  398 |  209 |  189 |
...
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  820 |  820 |  820 |  820 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/8e452fc5a1c5261f3ef68d9ef5b3430e7520dc8b/kitchen_sink-8e452fc5a1c5261f3ef68d9ef5b3430e7520dc8b.memory.svg)
...
| app_proof |  |  |  |  |  | 1,598 |  |  | 36 | 2,579,903 | 70.14 | 0 | 3,865 |  | 
...
| app_proof | 72 | PhantomAir | PHANTOM | 1 | 1 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,577,979 | 259 | 115 | 0 | 0 | 107 | 36 | 35 | 51 | 20 | 0 | 35 | 21 | 13 | 3 | 9 | 116 | 107 | 0 | 2 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,767 | 141 | 46 | 0 | 0 | 67 | 24 | 24 | 28 | 14 | 0 | 27 | 18 | 8 | 1 | 6 | 46 | 67 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 115 | 31 | 0 | 0 | 61 | 23 | 23 | 24 | 13 | 0 | 22 | 14 | 7 | 1 | 5 | 32 | 61 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 265,003,892 | 820 | 397 | 0 | 1 | 346 | 135 | 134 | 75 | 135 | 0 | 76 | 36 | 39 | 21 | 18 | 397 | 346 | 0 | 6 | 134 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 567,917,156 | 1,800 | 594 | 0 | 188 | 1,070 | 662 | 661 | 209 | 197 | 56 | 134 | 33 | 100 | 50 | 50 | 595 | 1,070 | 0 | 3 | 139 | 0 | 0 | 
| app_proof | prover | 1 | 537,266,124 | 1,326 | 426 | 0 | 1 | 779 | 453 | 453 | 189 | 135 | 0 | 120 | 34 | 85 | 48 | 36 | 426 | 779 | 0 | 3 | 134 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 185 | 2,225 | 185 | 176 | 9,069,025,194 | 1,018,123,350 | 10,087,148,544 | 2,097,152 | 2,097,152 | 0 | 4 | 63 | 1,540,000 | 34.85 | 
| app_proof | 1 | 98 | 1,598 | 98 | 41 | 6,675,792,954 | 2,876,399,838 | 9,552,192,792 | 2,097,152 | 2,097,152 | 0 | 2 | 132 | 1,039,903 | 36.89 | 

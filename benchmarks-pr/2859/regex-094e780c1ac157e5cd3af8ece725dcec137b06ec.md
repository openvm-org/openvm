...
| `total_proof_time_ms ` |  702 |  1,404 |  761 |  643 |
| `execute_metered_time_ms` |  33 | -          | -          | -          |
| `execute_metered_insns` |  4,137,067 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  124.15 | -          |  124.15 |  124.15 |
| `execute_preflight_insns` |  2,068,533.50 |  4,137,067 |  2,208,000 |  1,929,067 |
| `execute_preflight_time_ms` |  73.50 |  147 |  80 |  67 |
| `execute_preflight_insn_mi/s` |  40.21 | -          |  41.71 |  38.71 |
| `trace_gen_time_ms   ` |  152 |  304 |  156 |  148 |
| `memory_finalize_time_ms` |  1 |  2 |  2 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  373 |  746 |  378 |  368 |
| `prover.main_trace_commit_time_ms` |  94.50 |  189 |  100 |  89 |
| `prover.rap_constraints_time_ms` |  237 |  474 |  249 |  225 |
| `prover.openings_time_ms` |  39.50 |  79 |  41 |  38 |
| `prover.rap_constraints.logup_gkr_time_ms` |  138.50 |  277 |  140 |  137 |
...
| `prover.openings.whir_time_ms` |  20 |  40 |  21 |  19 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  357 |  357 |  357 |  357 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/094e780c1ac157e5cd3af8ece725dcec137b06ec/regex-094e780c1ac157e5cd3af8ece725dcec137b06ec.memory.svg)
...
| app_proof |  |  |  |  |  | 643 |  |  | 33 | 4,137,067 | 124.15 | 0 | 1,451 |  | 
| internal_for_leaf |  |  |  | 226 |  |  |  |  |  |  |  |  |  | 226 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 15 | 226 | 14 | 4 | 0 | 2 | 0 | 0 | 
| internal_recursive.0 | 1 | 10 | 152 | 9 | 1 | 0 | 2 | 0 | 0 | 
| internal_recursive.1 | 1 | 9 | 131 | 9 | 1 | 0 | 1 | 0 | 0 | 
| leaf | 0 | 48 | 357 | 48 | 13 | 2 | 5 | 1 | 1 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 27,256,635 | 211 | 82 | 0 | 0 | 99 | 33 | 32 | 45 | 20 | 0 | 28 | 17 | 11 | 2 | 8 | 82 | 99 | 0 | 2 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,767 | 142 | 46 | 0 | 0 | 68 | 26 | 25 | 28 | 13 | 0 | 26 | 18 | 8 | 1 | 6 | 46 | 68 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 122 | 31 | 0 | 0 | 61 | 23 | 23 | 24 | 13 | 0 | 28 | 21 | 7 | 1 | 5 | 32 | 61 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 79,959,796 | 309 | 128 | 0 | 0 | 135 | 54 | 53 | 38 | 42 | 0 | 44 | 29 | 15 | 6 | 8 | 128 | 135 | 0 | 5 | 41 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 123,384,338 | 368 | 100 | 0 | 0 | 225 | 56 | 55 | 29 | 140 | 0 | 41 | 21 | 19 | 10 | 9 | 100 | 225 | 0 | 3 | 137 | 0 | 0 | 
| app_proof | prover | 1 | 106,568,591 | 378 | 89 | 0 | 8 | 249 | 86 | 85 | 26 | 137 | 0 | 38 | 19 | 18 | 8 | 9 | 89 | 249 | 0 | 3 | 135 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 148 | 761 | 148 | 163 | 3,211,990,398 | 1,086,818,162 | 4,298,808,560 | 1,048,576 | 2,097,152 | 2 | 7 | 80 | 2,208,000 | 38.71 | 
| app_proof | 1 | 156 | 643 | 156 | 41 | 2,230,931,741 | 889,503,992 | 3,120,435,733 | 1,048,576 | 2,097,152 | 0 | 2 | 67 | 1,929,067 | 41.71 | 

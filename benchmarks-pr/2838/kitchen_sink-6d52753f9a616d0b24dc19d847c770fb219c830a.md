...
| `total_proof_time_ms ` |  1,932.50 |  3,865 |  2,245 |  1,620 |
...
| `execute_preflight_insn_mi/s` |  35.24 | -          |  35.87 |  34.62 |
| `trace_gen_time_ms   ` |  141 |  282 |  187 |  95 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,581.50 |  3,163 |  1,817 |  1,346 |
| `prover.main_trace_commit_time_ms` |  514.50 |  1,029 |  600 |  429 |
| `prover.rap_constraints_time_ms` |  937.50 |  1,875 |  1,083 |  792 |
| `prover.openings_time_ms` |  129 |  258 |  134 |  124 |
| `prover.rap_constraints.logup_gkr_time_ms` |  168.50 |  337 |  199 |  138 |
| `prover.rap_constraints.round0_time_ms` |  565 |  1,130 |  669 |  461 |
| `prover.rap_constraints.mle_rounds_time_ms` |  202.50 |  405 |  214 |  191 |
| `prover.openings.stacked_reduction_time_ms` |  94 |  188 |  103 |  85 |
| `prover.openings.stacked_reduction.round0_time_ms` |  49 |  98 |  50 |  48 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  45 |  90 |  53 |  37 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/6d52753f9a616d0b24dc19d847c770fb219c830a/kitchen_sink-6d52753f9a616d0b24dc19d847c770fb219c830a.memory.svg)
...
| app_proof |  |  |  |  |  | 1,620 |  |  | 34 | 2,579,903 | 74.26 | 0 | 3,904 |  | 
...
| internal_recursive.0 | 1 | 11 | 156 | 10 | 1 | 0 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 9 | 131 | 8 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 120 | 951 | 120 | 23 | 9 | 21 | 5 | 5 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,577,979 | 258 | 117 | 0 | 0 | 107 | 35 | 34 | 51 | 20 | 0 | 33 | 19 | 13 | 3 | 9 | 117 | 107 | 0 | 2 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,767 | 145 | 46 | 0 | 0 | 67 | 25 | 24 | 28 | 13 | 0 | 30 | 21 | 8 | 1 | 6 | 47 | 67 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 122 | 31 | 0 | 0 | 64 | 25 | 24 | 24 | 14 | 0 | 25 | 18 | 7 | 1 | 5 | 31 | 64 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 265,003,892 | 831 | 402 | 0 | 1 | 351 | 135 | 134 | 77 | 138 | 0 | 76 | 36 | 40 | 21 | 18 | 403 | 351 | 0 | 6 | 137 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 567,917,156 | 1,817 | 599 | 0 | 189 | 1,083 | 669 | 668 | 214 | 199 | 57 | 134 | 30 | 103 | 50 | 53 | 600 | 1,083 | 0 | 3 | 140 | 0 | 0 | 
| app_proof | prover | 1 | 537,266,124 | 1,346 | 429 | 0 | 1 | 792 | 461 | 461 | 191 | 138 | 0 | 124 | 38 | 85 | 48 | 37 | 429 | 792 | 0 | 4 | 137 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 187 | 2,245 | 187 | 177 | 0 | 3 | 63 | 1,540,000 | 34.62 | 
| app_proof | 1 | 95 | 1,620 | 94 | 41 | 0 | 2 | 137 | 1,039,903 | 35.87 | 

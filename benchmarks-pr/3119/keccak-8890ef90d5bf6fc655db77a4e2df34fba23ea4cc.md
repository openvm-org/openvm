...
|:---|---:|---:|---:|
| Total |  9.73 |  3.51 |  3.51 |
| app_proof |  7.62 |  1.91 |  1.91 |
| leaf |  1.54 |  1.04 |  1.04 |
...
| `total_proof_time_ms ` |  1,248.17 |  7,489 |  1,360 |  1,213 |
...
| `execute_preflight_time_ms` |  88.33 |  530 |  112 |  81 |
| `execute_preflight_insn_mi/s` |  27.10 | -          |  28.71 |  21.47 |
| `postflight_time_ms  ` |  31.17 |  187 |  33 |  30 |
| `postflight_memory_chronology_time_ms` |  2 |  12 |  2 |  2 |
| `postflight_program_index_time_ms` |  0 |  0 |  0 |  0 |
| `trace_gen_time_ms   ` |  13 |  78 |  18 |  12 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,098.67 |  6,592 |  1,183 |  1,069 |
| `prover.main_trace_commit_time_ms` |  344.50 |  2,067 |  359 |  338 |
| `prover.rap_constraints_time_ms` |  512 |  3,072 |  514 |  508 |
| `prover.openings_time_ms` |  241.33 |  1,448 |  308 |  222 |
| `prover.rap_constraints.logup_gkr_time_ms` |  104.50 |  627 |  106 |  102 |
| `prover.rap_constraints.round0_time_ms` |  282.33 |  1,694 |  284 |  281 |
...
| `prover.openings.whir_time_ms` |  180.17 |  1,081 |  247 |  162 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  772.50 |  1,545 |  1,036 |  509 |
| `execute_preflight_time_ms` |  4.50 |  9 |  5 |  4 |
| `trace_gen_time_ms   ` |  148.50 |  297 |  198 |  99 |
...
| `prover.rap_constraints_time_ms` |  188.50 |  377 |  235 |  142 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/8890ef90d5bf6fc655db77a4e2df34fba23ea4cc/keccak-8890ef90d5bf6fc655db77a4e2df34fba23ea4cc.memory.svg)
...
| leaf | 0 | 198 | 1,036 | 198 | 62 | 22 | 4 | 11 | 11 | 
| leaf | 1 | 99 | 509 | 99 | 32 | 11 | 5 | 11 | 11 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 81,415,160 | 286 | 93 | 0 | 0 | 114 | 39 | 38 | 56 | 17 | 0 | 78 | 62 | 15 | 5 | 10 | 93 | 93 | 114 | 0 | 1 | 17 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,945 | 115 | 21 | 0 | 0 | 59 | 21 | 21 | 24 | 13 | 0 | 33 | 25 | 8 | 1 | 6 | 21 | 21 | 59 | 0 | 1 | 12 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 99 | 15 | 0 | 0 | 54 | 20 | 20 | 21 | 11 | 0 | 29 | 22 | 7 | 1 | 5 | 15 | 15 | 54 | 0 | 1 | 10 | 0 | 0 | 
| leaf | 0 | prover | 476,578,798 | 837 | 388 | 0 | 0 | 235 | 122 | 121 | 71 | 41 | 0 | 213 | 175 | 37 | 20 | 17 | 388 | 388 | 235 | 0 | 3 | 40 | 0 | 0 | 
| leaf | 1 | prover | 240,255,800 | 409 | 146 | 0 | 0 | 142 | 71 | 69 | 44 | 26 | 0 | 119 | 97 | 22 | 10 | 11 | 147 | 146 | 142 | 0 | 3 | 25 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover |  | 0 | 830,158,476 | 1,183 | 359 | 0 | 55 | 514 | 283 | 282 | 124 | 106 | 0 | 308 | 247 | 61 | 36 | 24 | 359 | 359 | 514 | 0 | 1 | 104 | 0 | 0 | 
| app_proof | prover |  | 1 | 830,158,476 | 1,083 | 338 | 0 | 0 | 510 | 281 | 280 | 124 | 104 | 0 | 234 | 172 | 61 | 36 | 24 | 338 | 338 | 510 | 0 | 1 | 103 | 0 | 0 | 
| app_proof | prover |  | 2 | 830,158,476 | 1,079 | 339 | 0 | 0 | 513 | 283 | 282 | 124 | 105 | 0 | 226 | 164 | 61 | 36 | 24 | 340 | 339 | 513 | 0 | 1 | 104 | 0 | 0 | 
| app_proof | prover |  | 3 | 830,158,476 | 1,088 | 345 | 0 | 0 | 513 | 282 | 282 | 124 | 105 | 0 | 229 | 168 | 61 | 36 | 24 | 346 | 345 | 512 | 0 | 1 | 104 | 0 | 0 | 
| app_proof | prover |  | 4 | 830,158,476 | 1,090 | 346 | 0 | 0 | 514 | 284 | 283 | 124 | 105 | 0 | 229 | 168 | 61 | 36 | 24 | 346 | 346 | 514 | 0 | 1 | 104 | 0 | 0 | 
| app_proof | prover |  | 5 | 819,934,860 | 1,069 | 338 | 0 | 0 | 508 | 281 | 280 | 123 | 102 | 0 | 222 | 162 | 60 | 35 | 24 | 338 | 338 | 508 | 0 | 1 | 101 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof |  | 1,213 | 128 | 14,365,133 | 111.82 | 0 | 7,626 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof |  | 0 | 1 | 2 | 18 | 1,360 | 3 | 1 | 0 | 31 | 0 | 2 | 0 | 9,337,486,584 | 624,415,128 | 9,961,901,712 | 2,097,152 | 2 | 0 | 0 | 3 | 14 | 112 | 2,413,000 | 21.47 | 0 | 0 | 
| app_proof |  | 1 | 0 | 2 | 12 | 1,226 | 2 | 0 | 0 | 30 | 0 | 2 | 0 | 9,337,793,604 | 625,029,708 | 9,962,823,312 | 2,097,152 | 2 | 0 | 0 | 2 | 9 | 85 | 2,413,000 | 28.34 | 0 | 0 | 
| app_proof |  | 2 | 0 | 2 | 12 | 1,222 | 3 | 0 | 0 | 30 | 0 | 2 | 0 | 9,337,030,356 | 625,792,956 | 9,962,823,312 | 2,097,152 | 2 | 0 | 0 | 2 | 9 | 84 | 2,413,000 | 28.56 | 0 | 0 | 
| app_proof |  | 3 | 0 | 2 | 12 | 1,233 | 2 | 0 | 0 | 31 | 0 | 2 | 0 | 9,337,792,860 | 625,030,452 | 9,962,823,312 | 2,097,152 | 2 | 0 | 0 | 2 | 9 | 84 | 2,413,000 | 28.59 | 0 | 0 | 
| app_proof |  | 4 | 0 | 2 | 12 | 1,235 | 2 | 0 | 0 | 32 | 0 | 2 | 0 | 9,337,030,236 | 625,793,076 | 9,962,823,312 | 2,097,152 | 2 | 0 | 0 | 2 | 9 | 84 | 2,413,000 | 28.71 | 0 | 0 | 
| app_proof |  | 5 | 0 | 2 | 12 | 1,213 | 3 | 0 | 0 | 33 | 0 | 2 | 0 | 8,903,917,596 | 936,222,324 | 9,840,139,920 | 2,097,152 | 2 | 0 | 0 | 2 | 8 | 81 | 2,300,133 | 28.20 | 0 | 0 | 

...
| `total_proof_time_ms ` |  4,057.50 |  8,115 |  5,125 |  2,990 |
...
| `execute_preflight_time_ms` |  239.50 |  479 |  270 |  209 |
| `execute_preflight_insn_mi/s` |  39.44 | -          |  41.47 |  37.41 |
| `trace_gen_time_ms   ` |  121.50 |  243 |  171 |  72 |
| `set_initial_memory_time_ms` |  88.50 |  177 |  136 |  41 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  3,606 |  7,212 |  4,607 |  2,605 |
| `prover.main_trace_commit_time_ms` |  957 |  1,914 |  1,326 |  588 |
| `prover.rap_constraints_time_ms` |  1,942.50 |  3,885 |  2,394 |  1,491 |
| `prover.openings_time_ms` |  705.50 |  1,411 |  886 |  525 |
| `prover.rap_constraints.logup_gkr_time_ms` |  550 |  1,100 |  591 |  509 |
| `prover.rap_constraints.round0_time_ms` |  1,012.50 |  2,025 |  1,313 |  712 |
| `prover.rap_constraints.mle_rounds_time_ms` |  379 |  758 |  489 |  269 |
| `prover.openings.stacked_reduction_time_ms` |  163 |  326 |  209 |  117 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/b3af48a198d26400ff5fbb69bc64f1e1451b8746/sha2_bench-b3af48a198d26400ff5fbb69bc64f1e1451b8746.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 69 |  |  |  | 341 |  |  |  |  |  |  | 
| app_proof |  |  |  | 2,990 |  | 98 | 11,167,961 | 113.45 | 0 | 8,220 |  | 
...
| leaf | 0 | 106 | 996 | 106 | 34 | 17 | 2 | 7 | 7 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 325 | 117 | 0 | 0 | 107 | 34 | 34 | 51 | 20 | 0 | 100 | 86 | 13 | 3 | 9 | 117 | 117 | 107 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 166 | 47 | 0 | 0 | 67 | 25 | 24 | 28 | 14 | 0 | 50 | 42 | 8 | 1 | 6 | 47 | 47 | 67 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 136 | 31 | 0 | 0 | 59 | 21 | 21 | 24 | 13 | 0 | 44 | 37 | 7 | 1 | 5 | 31 | 31 | 59 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 237,929,016 | 889 | 372 | 0 | 0 | 227 | 109 | 108 | 67 | 50 | 0 | 289 | 252 | 36 | 19 | 17 | 372 | 372 | 227 | 0 | 9 | 49 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,286,242,554 | 4,607 | 1,326 | 0 | 0 | 2,394 | 1,313 | 1,313 | 489 | 591 | 0 | 886 | 676 | 209 | 130 | 78 | 1,326 | 1,326 | 2,394 | 0 | 5 | 590 | 0 | 0 | 
| app_proof | prover | 1 | 750,289,144 | 2,605 | 588 | 0 | 0 | 1,491 | 712 | 711 | 269 | 509 | 0 | 525 | 407 | 117 | 71 | 46 | 588 | 588 | 1,491 | 0 | 5 | 508 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 136 | 1 | 171 | 5,125 | 171 | 136 | 13,311,936,132 | 2,137,449,780 | 15,449,385,912 | 2,097,152 | 0 | 4 | 209 | 7,124,000 | 37.41 | 
| app_proof | 1 | 41 | 1 | 72 | 2,990 | 72 | 41 | 7,588,526,580 | 1,502,398,413 | 9,090,924,993 | 2,097,152 | 0 | 2 | 270 | 4,043,961 | 41.47 | 

...
| `total_proof_time_ms ` |  4,130 |  8,260 |  5,216 |  3,044 |
...
| `execute_preflight_insn_mi/s` |  36.95 | -          |  39.13 |  34.77 |
| `trace_gen_time_ms   ` |  124.50 |  249 |  174 |  75 |
| `set_initial_memory_time_ms` |  89 |  178 |  137 |  41 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  3,665.50 |  7,331 |  4,681 |  2,650 |
| `prover.main_trace_commit_time_ms` |  964 |  1,928 |  1,334 |  594 |
| `prover.rap_constraints_time_ms` |  1,992 |  3,984 |  2,449 |  1,535 |
| `prover.openings_time_ms` |  708.50 |  1,417 |  897 |  520 |
| `prover.rap_constraints.logup_gkr_time_ms` |  563 |  1,126 |  602 |  524 |
| `prover.rap_constraints.round0_time_ms` |  1,045 |  2,090 |  1,353 |  737 |
...
| `prover.openings.whir_time_ms` |  540.50 |  1,081 |  681 |  400 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/5c137cf67ea88a866e785afd0698ad8300f81428/sha2_bench-5c137cf67ea88a866e785afd0698ad8300f81428.memory.svg)
...
| app_proof |  |  |  |  |  | 3,044 |  |  | 99 | 11,167,961 | 112.50 | 0 | 8,365 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 327 | 117 | 0 | 0 | 108 | 35 | 34 | 52 | 20 | 0 | 101 | 87 | 13 | 3 | 9 | 118 | 108 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 174 | 47 | 0 | 0 | 69 | 26 | 25 | 28 | 14 | 0 | 57 | 48 | 8 | 1 | 6 | 47 | 69 | 0 | 3 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 137 | 32 | 0 | 0 | 62 | 23 | 23 | 25 | 13 | 0 | 41 | 34 | 7 | 1 | 5 | 32 | 62 | 0 | 2 | 13 | 0 | 0 | 
| leaf | 0 | prover | 237,896,248 | 901 | 375 | 0 | 0 | 229 | 110 | 110 | 68 | 50 | 0 | 295 | 257 | 37 | 20 | 17 | 376 | 229 | 0 | 12 | 49 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,288,077,561 | 4,681 | 1,334 | 0 | 0 | 2,449 | 1,353 | 1,352 | 493 | 602 | 0 | 897 | 681 | 215 | 135 | 80 | 1,334 | 2,449 | 0 | 8 | 600 | 0 | 0 | 
| app_proof | prover | 1 | 751,206,644 | 2,650 | 594 | 0 | 0 | 1,535 | 737 | 737 | 273 | 524 | 0 | 520 | 400 | 119 | 72 | 47 | 594 | 1,535 | 0 | 6 | 522 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 1 | 174 | 5,216 | 174 | 137 | 13,329,494,472 | 2,141,911,524 | 15,471,405,996 | 2,097,152 | 0 | 3 | 223 | 7,124,000 | 34.77 | 
| app_proof | 1 | 1 | 75 | 3,044 | 75 | 41 | 7,598,498,184 | 1,557,865,504 | 9,156,363,688 | 2,097,152 | 0 | 2 | 276 | 4,043,961 | 39.13 | 

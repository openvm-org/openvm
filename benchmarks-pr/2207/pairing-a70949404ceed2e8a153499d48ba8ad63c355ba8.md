...
|:---|---:|---:|
| Total | <span style='color: green'>(-0 [-0.5%])</span> 1.51 | <span style='color: red'>(+0 [+0.3%])</span> 0.91 |
| pairing | <span style='color: green'>(-0 [-0.6%])</span> 1.42 | <span style='color: red'>(+0 [+0.4%])</span> 0.82 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: green'>(-4 [-0.6%])</span> 711.50 | <span style='color: green'>(-8 [-0.6%])</span> 1,423 | <span style='color: red'>(+3 [+0.4%])</span> 821 | <span style='color: green'>(-11 [-1.8%])</span> 602 |
...
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+1 [+4.6%])</span> 13.58 | -          | <span style='color: red'>(+1 [+6.5%])</span> 18 | <span style='color: red'>(+0 [+0.9%])</span> 9.16 |
| `trace_gen_time_ms   ` | <span style='color: green'>(-2 [-0.8%])</span> 177 | <span style='color: green'>(-3 [-0.8%])</span> 354 |  195 | <span style='color: green'>(-3 [-1.9%])</span> 159 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: green'>(-2 [-0.4%])</span> 347 | <span style='color: green'>(-3 [-0.4%])</span> 694 | <span style='color: red'>(+7 [+1.8%])</span> 389 | <span style='color: green'>(-10 [-3.2%])</span> 305 |
| `main_trace_commit_time_ms` | <span style='color: green'>(-1 [-1.5%])</span> 64.50 | <span style='color: green'>(-2 [-1.5%])</span> 129 | <span style='color: red'>(+1 [+1.3%])</span> 76 | <span style='color: green'>(-3 [-5.4%])</span> 53 |
| `generate_perm_trace_time_ms` | <span style='color: red'>(+6 [+16.7%])</span> 42 | <span style='color: red'>(+12 [+16.7%])</span> 84 | <span style='color: red'>(+2 [+5.0%])</span> 42 | <span style='color: red'>(+10 [+31.2%])</span> 42 |
| `perm_trace_commit_time_ms` | <span style='color: green'>(-1 [-1.7%])</span> 76.77 | <span style='color: green'>(-3 [-1.7%])</span> 153.54 | <span style='color: green'>(-2 [-2.1%])</span> 88.26 | <span style='color: green'>(-1 [-1.1%])</span> 65.28 |
| `quotient_poly_compute_time_ms` | <span style='color: green'>(-2 [-1.9%])</span> 78.73 | <span style='color: green'>(-3 [-1.9%])</span> 157.46 | <span style='color: green'>(-2 [-1.7%])</span> 87.42 | <span style='color: green'>(-1 [-2.1%])</span> 70.04 |
| `quotient_poly_commit_time_ms` |  16.51 |  33.02 | <span style='color: red'>(+1 [+5.7%])</span> 19.03 | <span style='color: green'>(-1 [-6.8%])</span> 13.99 |
| `pcs_opening_time_ms ` | <span style='color: green'>(-3 [-4.5%])</span> 64 | <span style='color: green'>(-6 [-4.5%])</span> 128 | <span style='color: red'>(+1 [+1.4%])</span> 71 | <span style='color: green'>(-7 [-10.9%])</span> 57 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 602 | 1 | 90 | 1,745,742 | 19.31 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 159 | 821 | 32,689,110 | 172,558,444 | 159 | 389 | 0 | 87.42 | 19.03 | 6 | 88.26 | 71 | 134 | 71 | 1 | 76 | 16,059,916 | 42 | 130 | 1,157,000 | 9.16 | 26 | 107 | 1 | 71 | 
| pairing | 1 | 195 | 602 | 22,314,288 | 119,958,502 | 195 | 305 | 1 | 70.04 | 13.99 | 6 | 65.28 | 57 | 110 | 57 | 0 | 53 | 9,408,294 | 42 | 60 | 588,742 | 18 | 20 | 84 | 1 | 57 | 

...
|:---|---:|---:|
| Total | <span style='color: red'>(+0 [+0.5%])</span> 1.53 | <span style='color: red'>(+0 [+0.3%])</span> 0.91 |
| pairing | <span style='color: red'>(+0 [+0.5%])</span> 1.44 | <span style='color: red'>(+0 [+0.4%])</span> 0.82 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+4 [+0.5%])</span> 719 | <span style='color: red'>(+7 [+0.5%])</span> 1,438 | <span style='color: red'>(+3 [+0.4%])</span> 821 | <span style='color: red'>(+4 [+0.7%])</span> 617 |
...
| `execute_metered_insn_mi/s` | <span style='color: green'>(-0 [-0.4%])</span> 19.25 | -          | <span style='color: green'>(-0 [-0.4%])</span> 19.25 | <span style='color: green'>(-0 [-0.4%])</span> 19.25 |
| `execute_preflight_insns` |  872,871 |  1,745,742 |  1,157,000 |  588,742 |
| `execute_preflight_time_ms` | <span style='color: green'>(-2 [-1.6%])</span> 95 | <span style='color: green'>(-3 [-1.6%])</span> 190 | <span style='color: green'>(-1 [-0.8%])</span> 130 | <span style='color: green'>(-2 [-3.2%])</span> 60 |
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+1 [+4.4%])</span> 13.55 | -          | <span style='color: red'>(+1 [+6.1%])</span> 17.92 | <span style='color: red'>(+0 [+1.3%])</span> 9.19 |
| `trace_gen_time_ms   ` | <span style='color: green'>(-2 [-0.8%])</span> 177 | <span style='color: green'>(-3 [-0.8%])</span> 354 | <span style='color: green'>(-1 [-0.5%])</span> 194 | <span style='color: green'>(-2 [-1.2%])</span> 160 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+6 [+1.6%])</span> 354 | <span style='color: red'>(+11 [+1.6%])</span> 708 | <span style='color: red'>(+5 [+1.3%])</span> 387 | <span style='color: red'>(+6 [+1.9%])</span> 321 |
| `main_trace_commit_time_ms` | <span style='color: green'>(-2 [-2.3%])</span> 64 | <span style='color: green'>(-3 [-2.3%])</span> 128 |  75 | <span style='color: green'>(-3 [-5.4%])</span> 53 |
| `generate_perm_trace_time_ms` | <span style='color: red'>(+9 [+25.0%])</span> 45 | <span style='color: red'>(+18 [+25.0%])</span> 90 | <span style='color: red'>(+8 [+20.0%])</span> 48 | <span style='color: red'>(+10 [+31.2%])</span> 42 |
| `perm_trace_commit_time_ms` | <span style='color: green'>(-2 [-2.1%])</span> 76.41 | <span style='color: green'>(-3 [-2.1%])</span> 152.82 | <span style='color: green'>(-2 [-2.6%])</span> 87.82 | <span style='color: green'>(-1 [-1.5%])</span> 64.99 |
| `quotient_poly_compute_time_ms` | <span style='color: green'>(-2 [-2.0%])</span> 78.62 | <span style='color: green'>(-3 [-2.0%])</span> 157.24 | <span style='color: green'>(-2 [-2.6%])</span> 86.63 | <span style='color: green'>(-1 [-1.3%])</span> 70.60 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+0 [+2.0%])</span> 16.84 | <span style='color: red'>(+1 [+2.0%])</span> 33.68 | <span style='color: red'>(+1 [+5.4%])</span> 18.97 | <span style='color: green'>(-0 [-2.0%])</span> 14.71 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+2 [+2.2%])</span> 68.50 | <span style='color: red'>(+3 [+2.2%])</span> 137 | <span style='color: red'>(+1 [+1.4%])</span> 71 | <span style='color: red'>(+2 [+3.1%])</span> 66 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 617 | 1 | 90 | 1,745,742 | 19.25 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 160 | 821 | 32,689,110 | 172,558,444 | 159 | 387 | 0 | 86.63 | 18.97 | 6 | 87.82 | 71 | 133 | 71 | 1 | 75 | 16,059,916 | 42 | 130 | 1,157,000 | 9.19 | 26 | 106 | 1 | 71 | 
| pairing | 1 | 194 | 617 | 22,314,288 | 119,958,502 | 194 | 321 | 1 | 70.60 | 14.71 | 6 | 64.99 | 66 | 115 | 66 | 0 | 53 | 9,408,294 | 48 | 60 | 588,742 | 17.92 | 20 | 85 | 1 | 66 | 

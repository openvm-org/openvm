...
|:---|---:|---:|
| Total | <span style='color: red'>(+0 [+0.6%])</span> 2.37 | <span style='color: green'>(-0 [-2.3%])</span> 0.73 |
| regex_program | <span style='color: red'>(+0 [+0.6%])</span> 2.34 | <span style='color: green'>(-0 [-2.5%])</span> 0.70 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+3 [+0.6%])</span> 585 | <span style='color: red'>(+13 [+0.6%])</span> 2,340 | <span style='color: green'>(-18 [-2.5%])</span> 700 | <span style='color: red'>(+2 [+0.4%])</span> 524 |
...
| `execute_metered_insn_mi/s` | <span style='color: green'>(-4 [-3.0%])</span> 118.45 | -          | <span style='color: green'>(-4 [-3.0%])</span> 118.45 | <span style='color: green'>(-4 [-3.0%])</span> 118.45 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` | <span style='color: red'>(+4 [+6.5%])</span> 57.75 | <span style='color: red'>(+14 [+6.5%])</span> 231 | <span style='color: red'>(+1 [+1.4%])</span> 70 | <span style='color: red'>(+3 [+6.8%])</span> 47 |
| `execute_preflight_insn_mi/s` | <span style='color: green'>(-2 [-6.8%])</span> 29.80 | -          | <span style='color: green'>(-2 [-7.4%])</span> 30.87 | <span style='color: green'>(-1 [-4.6%])</span> 27.13 |
| `trace_gen_time_ms   ` | <span style='color: green'>(-4 [-2.1%])</span> 176.25 | <span style='color: green'>(-15 [-2.1%])</span> 705 | <span style='color: green'>(-2 [-0.9%])</span> 213 | <span style='color: green'>(-1 [-0.6%])</span> 153 |
| `memory_finalize_time_ms` |  1 |  4 |  4 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+4 [+1.3%])</span> 282 | <span style='color: red'>(+14 [+1.3%])</span> 1,128 | <span style='color: green'>(-4 [-1.3%])</span> 303 | <span style='color: red'>(+2 [+0.8%])</span> 259 |
...
| `generate_perm_trace_time_ms` | <span style='color: green'>(-1 [-5.1%])</span> 23.25 | <span style='color: green'>(-5 [-5.1%])</span> 93 | <span style='color: green'>(-3 [-10.3%])</span> 26 | <span style='color: red'>(+3 [+16.7%])</span> 21 |
| `perm_trace_commit_time_ms` |  64.95 |  259.80 | <span style='color: green'>(-1 [-1.7%])</span> 70.26 | <span style='color: red'>(+1 [+1.1%])</span> 56.04 |
| `quotient_poly_compute_time_ms` | <span style='color: green'>(-0 [-0.5%])</span> 59.03 | <span style='color: green'>(-1 [-0.5%])</span> 236.13 | <span style='color: green'>(-1 [-1.2%])</span> 69.32 | <span style='color: green'>(-1 [-1.9%])</span> 52.43 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+0 [+1.3%])</span> 15.21 | <span style='color: red'>(+1 [+1.3%])</span> 60.84 | <span style='color: red'>(+1 [+6.3%])</span> 17.69 | <span style='color: green'>(-1 [-5.9%])</span> 12.38 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+5 [+8.3%])</span> 65 | <span style='color: red'>(+20 [+8.3%])</span> 260 | <span style='color: red'>(+14 [+19.2%])</span> 87 | <span style='color: red'>(+1 [+1.9%])</span> 53 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 576 | 40 | 1 | 34 | 4,137,502 | 118.45 | 171 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 213 | 700 | 23,446,148 | 150,778,428 | 213 | 292 | 0 | 61.59 | 17.69 | 5 | 70.26 | 57 | 97 | 57 | 4 | 57 | 10,899,170 | 26 | 47 | 1,103,000 | 27.13 | 21 | 79 | 1 | 57 | 
| regex_program | 1 | 153 | 540 | 11,598,276 | 128,513,066 | 153 | 274 | 1 | 52.43 | 15.69 | 4 | 67.20 | 63 | 92 | 63 | 0 | 50 | 2,196,106 | 24 | 70 | 1,104,000 | 30.71 | 17 | 68 | 0 | 63 | 
| regex_program | 2 | 158 | 524 | 11,579,064 | 128,513,066 | 158 | 259 | 1 | 52.79 | 15.07 | 4 | 66.31 | 53 | 87 | 53 | 0 | 50 | 2,177,334 | 21 | 64 | 1,104,000 | 30.87 | 17 | 68 | 0 | 53 | 
| regex_program | 3 | 181 | 576 | 11,853,872 | 103,456,394 | 181 | 303 | 0 | 69.32 | 12.38 | 5 | 56.04 | 87 | 81 | 87 | 0 | 51 | 2,422,606 | 22 | 50 | 826,502 | 30.49 | 18 | 82 | 1 | 87 | 

...
|:---|---:|---:|---:|
| Total |  11.37 |  4.65 |  4.65 |
| app_proof |  9.31 |  2.59 |  2.59 |
| leaf |  1.40 |  1.40 |  1.40 |
...
| `total_proof_time_ms ` |  2,303 |  9,212 |  2,495 |  2,213 |
...
| `execute_preflight_time_ms` |  168.25 |  673 |  213 |  102 |
| `execute_preflight_insn_mi/s` |  34.52 | -          |  35.41 |  32.17 |
| `trace_gen_time_ms   ` |  58 |  232 |  64 |  54 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  2,011 |  8,044 |  2,192 |  1,942 |
| `prover.main_trace_commit_time_ms` |  543.25 |  2,173 |  635 |  512 |
| `prover.rap_constraints_time_ms` |  1,333.50 |  5,334 |  1,426 |  1,296 |
| `prover.openings_time_ms` |  133.25 |  533 |  138 |  130 |
| `prover.rap_constraints.logup_gkr_time_ms` |  362 |  1,448 |  457 |  330 |
| `prover.rap_constraints.round0_time_ms` |  659 |  2,636 |  666 |  655 |
| `prover.rap_constraints.mle_rounds_time_ms` |  311.50 |  1,246 |  313 |  310 |
| `prover.openings.stacked_reduction_time_ms` |  95.50 |  382 |  98 |  93 |
| `prover.openings.stacked_reduction.round0_time_ms` |  58 |  232 |  60 |  56 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  37 |  148 |  38 |  36 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/03e874ed516696502064dc2017d04a5f91fea9c1/sha2_bench-03e874ed516696502064dc2017d04a5f91fea9c1.memory.svg)
...
| app_proof |  |  |  |  |  | 2,213 |  |  | 96 | 11,167,961 | 115.44 | 0 | 9,315 |  | 
| internal_for_leaf |  |  |  | 374 |  |  |  |  |  |  |  |  |  | 374 | 
| internal_recursive.0 |  |  |  | 158 |  |  |  |  |  |  |  |  |  | 159 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 61,220,603 | 349 | 181 | 0 | 0 | 130 | 38 | 37 | 65 | 26 | 0 | 37 | 19 | 18 | 5 | 12 | 181 | 130 | 0 | 2 | 26 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,879 | 146 | 47 | 0 | 0 | 72 | 25 | 24 | 29 | 17 | 0 | 26 | 17 | 8 | 1 | 6 | 48 | 72 | 0 | 2 | 16 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 118 | 31 | 0 | 0 | 62 | 24 | 23 | 24 | 13 | 0 | 24 | 17 | 7 | 1 | 5 | 31 | 62 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 425,198,438 | 1,246 | 794 | 0 | 158 | 344 | 167 | 166 | 102 | 74 | 0 | 106 | 43 | 63 | 36 | 26 | 795 | 344 | 0 | 6 | 73 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 654,475,553 | 2,192 | 635 | 0 | 126 | 1,426 | 655 | 654 | 313 | 457 | 140 | 130 | 36 | 93 | 57 | 36 | 635 | 1,426 | 0 | 3 | 315 | 0 | 0 | 
| app_proof | prover | 1 | 654,475,276 | 1,951 | 511 | 0 | 2 | 1,304 | 660 | 660 | 312 | 331 | 0 | 134 | 36 | 98 | 59 | 38 | 512 | 1,304 | 0 | 3 | 329 | 0 | 0 | 
| app_proof | prover | 2 | 654,475,276 | 1,959 | 512 | 0 | 2 | 1,308 | 666 | 665 | 311 | 330 | 0 | 138 | 39 | 98 | 60 | 38 | 512 | 1,308 | 0 | 3 | 329 | 0 | 0 | 
| app_proof | prover | 3 | 654,475,524 | 1,942 | 513 | 0 | 2 | 1,296 | 655 | 654 | 310 | 330 | 0 | 131 | 37 | 93 | 56 | 36 | 514 | 1,296 | 0 | 4 | 329 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 64 | 2,495 | 64 | 135 | 0 | 3 | 102 | 2,851,000 | 32.17 | 
| app_proof | 1 | 57 | 2,263 | 57 | 41 | 0 | 1 | 213 | 2,851,000 | 35.38 | 
| app_proof | 2 | 57 | 2,241 | 57 | 41 | 0 | 1 | 183 | 2,851,000 | 35.12 | 
| app_proof | 3 | 54 | 2,213 | 54 | 41 | 0 | 1 | 175 | 2,614,961 | 35.41 | 

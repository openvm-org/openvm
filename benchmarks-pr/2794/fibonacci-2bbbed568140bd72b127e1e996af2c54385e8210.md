...
|:---|---:|---:|---:|
| Total |  2.61 |  1.54 |  1.54 |
| app_proof |  1.63 |  0.56 |  0.56 |
| leaf |  0.46 |  0.46 |  0.46 |
...
| `total_proof_time_ms ` |  402.75 |  1,611 |  540 |  223 |
| `execute_metered_time_ms` |  21 | -          | -          | -          |
| `execute_metered_insns` |  4,000,051 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  186.58 | -          |  186.58 |  186.58 |
| `execute_preflight_insns` |  1,000,012.75 |  4,000,051 |  1,310,000 |  70,051 |
| `execute_preflight_time_ms` |  44.25 |  177 |  62 |  7 |
| `execute_preflight_insn_mi/s` |  33.66 | -          |  36.03 |  31.32 |
| `trace_gen_time_ms   ` |  69.50 |  278 |  100 |  55 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  219.75 |  879 |  272 |  74 |
| `prover.main_trace_commit_time_ms` |  43.25 |  173 |  53 |  16 |
| `prover.rap_constraints_time_ms` |  145.50 |  582 |  185 |  36 |
| `prover.openings_time_ms` |  30 |  120 |  33 |  21 |
| `prover.rap_constraints.logup_gkr_time_ms` |  99.25 |  397 |  127 |  18 |
| `prover.rap_constraints.round0_time_ms` |  30.50 |  122 |  41 |  10 |
...
| `prover.openings.whir_time_ms` |  20 |  80 |  21 |  17 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/2bbbed568140bd72b127e1e996af2c54385e8210/fibonacci-2bbbed568140bd72b127e1e996af2c54385e8210.memory.svg)
...
| app_proof |  |  |  |  |  | 223 |  |  | 21 | 4,000,051 | 186.58 | 0 | 1,641 |  | 
...
| app_proof | VmAirWrapper<Rv64BaseAluAdapterAir, BaseAluCoreAir<8, 8> | 2 | 8 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 21 | 235 | 21 | 6 | 1 | 2 | 1 | 1 | 
| internal_recursive.0 | 1 | 13 | 157 | 12 | 1 | 0 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 11 | 131 | 11 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 75 | 456 | 75 | 30 | 3 | 1 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 27,289,339 | 213 | 81 | 0 | 0 | 98 | 32 | 31 | 45 | 20 | 0 | 31 | 20 | 11 | 2 | 8 | 82 | 98 | 0 | 2 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,703 | 144 | 46 | 0 | 0 | 68 | 25 | 24 | 28 | 14 | 0 | 28 | 19 | 8 | 1 | 6 | 47 | 68 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 119 | 31 | 0 | 0 | 63 | 24 | 23 | 25 | 13 | 0 | 23 | 16 | 7 | 1 | 5 | 31 | 63 | 0 | 2 | 13 | 0 | 0 | 
| leaf | 0 | prover | 103,146,406 | 380 | 171 | 0 | 1 | 162 | 71 | 70 | 46 | 44 | 0 | 46 | 27 | 18 | 8 | 9 | 171 | 162 | 0 | 5 | 43 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 65,794,666 | 272 | 53 | 0 | 0 | 185 | 41 | 40 | 18 | 126 | 0 | 33 | 21 | 11 | 5 | 5 | 53 | 185 | 0 | 3 | 125 | 0 | 0 | 
| app_proof | prover | 1 | 65,748,660 | 266 | 52 | 0 | 0 | 180 | 35 | 34 | 18 | 127 | 0 | 33 | 21 | 11 | 6 | 5 | 52 | 180 | 0 | 3 | 126 | 0 | 0 | 
| app_proof | prover | 2 | 65,748,660 | 267 | 51 | 0 | 0 | 181 | 36 | 35 | 18 | 126 | 0 | 33 | 21 | 11 | 6 | 5 | 52 | 181 | 0 | 3 | 125 | 0 | 0 | 
| app_proof | prover | 3 | 9,268,712 | 74 | 15 | 0 | 0 | 36 | 10 | 9 | 8 | 18 | 0 | 21 | 17 | 3 | 1 | 2 | 16 | 36 | 0 | 3 | 17 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 55 | 540 | 55 | 150 | 0 | 3 | 62 | 1,310,000 | 31.93 | 
| app_proof | 1 | 56 | 422 | 56 | 41 | 0 | 1 | 58 | 1,310,000 | 31.32 | 
| app_proof | 2 | 67 | 426 | 67 | 40 | 0 | 1 | 50 | 1,310,000 | 36.03 | 
| app_proof | 3 | 100 | 223 | 100 | 41 | 0 | 1 | 7 | 70,051 | 35.36 | 

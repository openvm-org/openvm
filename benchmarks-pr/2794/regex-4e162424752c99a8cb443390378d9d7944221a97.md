...
| `total_proof_time_ms ` |  806.50 |  1,613 |  927 |  686 |
| `execute_metered_time_ms` |  33 | -          | -          | -          |
| `execute_metered_insns` |  4,090,656 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  120.72 | -          |  120.72 |  120.72 |
| `execute_preflight_insns` |  2,045,328 |  4,090,656 |  2,327,000 |  1,763,656 |
| `execute_preflight_time_ms` |  88.50 |  177 |  98 |  79 |
| `execute_preflight_insn_mi/s` |  30.99 | -          |  32.15 |  29.83 |
| `trace_gen_time_ms   ` |  34.50 |  69 |  40 |  29 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  593.50 |  1,187 |  663 |  524 |
| `prover.main_trace_commit_time_ms` |  121 |  242 |  137 |  105 |
| `prover.rap_constraints_time_ms` |  425.50 |  851 |  475 |  376 |
| `prover.openings_time_ms` |  46 |  92 |  49 |  43 |
| `prover.rap_constraints.logup_gkr_time_ms` |  284.50 |  569 |  337 |  232 |
| `prover.rap_constraints.round0_time_ms` |  98.50 |  197 |  106 |  91 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/4e162424752c99a8cb443390378d9d7944221a97/regex-4e162424752c99a8cb443390378d9d7944221a97.memory.svg)
...
| app_proof |  |  |  |  |  | 686 |  |  | 33 | 4,090,656 | 120.72 | 0 | 1,660 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 27,289,339 | 208 | 81 | 0 | 0 | 98 | 33 | 32 | 45 | 19 | 0 | 27 | 16 | 11 | 2 | 8 | 81 | 98 | 0 | 2 | 18 | 0 | 0 | 
...
| leaf | 0 | prover | 79,659,764 | 304 | 127 | 0 | 0 | 133 | 53 | 53 | 37 | 42 | 0 | 42 | 27 | 15 | 6 | 8 | 127 | 133 | 0 | 5 | 40 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 169,896,914 | 663 | 137 | 0 | 0 | 475 | 91 | 90 | 46 | 337 | 89 | 49 | 23 | 26 | 14 | 11 | 137 | 475 | 0 | 3 | 247 | 0 | 0 | 
| app_proof | prover | 1 | 129,384,977 | 524 | 104 | 0 | 9 | 376 | 106 | 106 | 36 | 232 | 0 | 43 | 21 | 21 | 10 | 11 | 105 | 376 | 0 | 3 | 231 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 29 | 927 | 29 | 136 | 1 | 5 | 98 | 2,327,000 | 29.83 | 
| app_proof | 1 | 40 | 686 | 40 | 41 | 0 | 2 | 79 | 1,763,656 | 32.15 | 

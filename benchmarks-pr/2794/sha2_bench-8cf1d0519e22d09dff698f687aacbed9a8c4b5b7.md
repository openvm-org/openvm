...
|:---|---:|---:|---:|
| Total |  11.56 |  4.71 |  4.71 |
| app_proof |  9.46 |  2.61 |  2.61 |
| leaf |  1.43 |  1.43 |  1.43 |
...
| `total_proof_time_ms ` |  2,340 |  9,360 |  2,510 |  2,259 |
...
| `execute_preflight_time_ms` |  176.25 |  705 |  218 |  113 |
| `execute_preflight_insn_mi/s` |  30.57 | -          |  31.30 |  28.69 |
| `trace_gen_time_ms   ` |  57.75 |  231 |  63 |  54 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  2,040.25 |  8,161 |  2,197 |  1,980 |
| `prover.main_trace_commit_time_ms` |  553.75 |  2,215 |  644 |  523 |
| `prover.rap_constraints_time_ms` |  1,344 |  5,376 |  1,413 |  1,314 |
| `prover.openings_time_ms` |  141.75 |  567 |  145 |  140 |
| `prover.rap_constraints.logup_gkr_time_ms` |  346.25 |  1,385 |  422 |  320 |
| `prover.rap_constraints.round0_time_ms` |  674.50 |  2,698 |  681 |  667 |
| `prover.rap_constraints.mle_rounds_time_ms` |  322 |  1,288 |  323 |  321 |
| `prover.openings.stacked_reduction_time_ms` |  102.75 |  411 |  103 |  102 |
| `prover.openings.stacked_reduction.round0_time_ms` |  62.25 |  249 |  63 |  62 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  39.75 |  159 |  40 |  39 |
| `prover.openings.whir_time_ms` |  38.50 |  154 |  41 |  36 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,430 |  1,430 |  1,430 |  1,430 |
| `execute_preflight_time_ms` |  3 |  3 |  3 |  3 |
| `trace_gen_time_ms   ` |  153 |  153 |  153 |  153 |
| `generate_blob_total_time_ms` |  25 |  25 |  25 |  25 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,277 |  1,277 |  1,277 |  1,277 |
...
| `prover.rap_constraints.logup_gkr_time_ms` |  77 |  77 |  77 |  77 |
| `prover.rap_constraints.round0_time_ms` |  171 |  171 |  171 |  171 |
| `prover.rap_constraints.mle_rounds_time_ms` |  108 |  108 |  108 |  108 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/8cf1d0519e22d09dff698f687aacbed9a8c4b5b7/sha2_bench-8cf1d0519e22d09dff698f687aacbed9a8c4b5b7.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 76 | 9 |  |  | 0 |  | 372 | 9 |  |  |  |  |  |  | 
| app_proof |  |  |  |  |  | 2,259 |  |  | 97 | 11,167,961 | 114.63 | 0 | 9,464 |  | 
...
| leaf | 0 | 153 | 1,430 | 152 | 55 | 25 | 3 | 6 | 6 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 61,220,603 | 357 | 185 | 0 | 0 | 130 | 38 | 37 | 65 | 27 | 0 | 41 | 22 | 18 | 5 | 12 | 185 | 130 | 0 | 3 | 26 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,879 | 149 | 49 | 0 | 0 | 72 | 25 | 24 | 29 | 17 | 0 | 26 | 17 | 8 | 1 | 6 | 50 | 72 | 0 | 2 | 16 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 121 | 31 | 0 | 0 | 62 | 24 | 23 | 24 | 13 | 0 | 26 | 19 | 7 | 1 | 5 | 32 | 62 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 425,198,438 | 1,277 | 810 | 0 | 158 | 357 | 171 | 170 | 108 | 77 | 0 | 109 | 44 | 65 | 37 | 27 | 810 | 357 | 0 | 7 | 76 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 654,475,553 | 2,197 | 643 | 0 | 123 | 1,413 | 667 | 667 | 322 | 422 | 118 | 140 | 36 | 103 | 62 | 40 | 644 | 1,413 | 0 | 4 | 303 | 0 | 0 | 
| app_proof | prover | 1 | 654,475,276 | 1,992 | 522 | 0 | 2 | 1,326 | 681 | 680 | 322 | 322 | 0 | 142 | 39 | 103 | 62 | 40 | 523 | 1,326 | 0 | 3 | 320 | 0 | 0 | 
| app_proof | prover | 2 | 654,475,276 | 1,992 | 523 | 0 | 2 | 1,323 | 679 | 679 | 323 | 320 | 0 | 145 | 41 | 103 | 63 | 39 | 523 | 1,323 | 0 | 3 | 319 | 0 | 0 | 
| app_proof | prover | 3 | 654,475,524 | 1,980 | 525 | 0 | 2 | 1,314 | 671 | 671 | 321 | 321 | 0 | 140 | 38 | 102 | 62 | 40 | 525 | 1,314 | 0 | 3 | 320 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 63 | 2,510 | 63 | 135 | 0 | 3 | 113 | 2,851,000 | 28.69 | 
| app_proof | 1 | 57 | 2,309 | 57 | 41 | 0 | 1 | 218 | 2,851,000 | 31.19 | 
| app_proof | 2 | 57 | 2,282 | 57 | 41 | 0 | 1 | 191 | 2,851,000 | 31.08 | 
| app_proof | 3 | 54 | 2,259 | 54 | 41 | 0 | 1 | 183 | 2,614,961 | 31.30 | 

...
|:---|---:|---:|---:|
| Total |  2.38 |  1.78 |  1.78 |
| app_proof |  1.51 |  0.92 |  0.92 |
| leaf |  0.36 |  0.36 |  0.36 |
...
| `total_proof_time_ms ` |  740 |  1,480 |  881 |  599 |
| `execute_metered_time_ms` |  35 | -          | -          | -          |
| `execute_metered_insns` |  4,090,656 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  115.60 | -          |  115.60 |  115.60 |
| `execute_preflight_insns` |  2,045,328 |  4,090,656 |  2,327,000 |  1,763,656 |
| `execute_preflight_time_ms` |  94.50 |  189 |  103 |  86 |
| `execute_preflight_insn_mi/s` |  28.37 | -          |  28.57 |  28.17 |
| `trace_gen_time_ms   ` |  29.50 |  59 |  34 |  25 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  526.50 |  1,053 |  617 |  436 |
| `prover.main_trace_commit_time_ms` |  121.50 |  243 |  137 |  106 |
| `prover.rap_constraints_time_ms` |  358 |  716 |  428 |  288 |
| `prover.openings_time_ms` |  46 |  92 |  50 |  42 |
| `prover.rap_constraints.logup_gkr_time_ms` |  222.50 |  445 |  296 |  149 |
| `prover.rap_constraints.round0_time_ms` |  95 |  190 |  103 |  87 |
| `prover.rap_constraints.mle_rounds_time_ms` |  40 |  80 |  44 |  36 |
| `prover.openings.stacked_reduction_time_ms` |  23.50 |  47 |  26 |  21 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/8cf1d0519e22d09dff698f687aacbed9a8c4b5b7/regex-8cf1d0519e22d09dff698f687aacbed9a8c4b5b7.memory.svg)
...
| app_proof |  |  |  |  |  | 599 |  |  | 35 | 4,090,656 | 115.60 | 0 | 1,528 |  | 
...
| internal_recursive.1 | 1 | 10 | 131 | 9 | 1 | 0 | 1 | 0 | 0 | 
| leaf | 0 | 52 | 359 | 51 | 14 | 3 | 4 | 1 | 1 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 27,289,339 | 210 | 82 | 0 | 0 | 99 | 32 | 31 | 45 | 21 | 0 | 28 | 17 | 11 | 2 | 8 | 82 | 99 | 0 | 2 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,703 | 141 | 45 | 0 | 0 | 67 | 25 | 24 | 28 | 13 | 0 | 27 | 19 | 8 | 1 | 6 | 46 | 67 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 120 | 31 | 0 | 0 | 63 | 24 | 24 | 24 | 13 | 0 | 26 | 18 | 7 | 1 | 5 | 31 | 63 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 79,659,764 | 307 | 127 | 0 | 0 | 136 | 55 | 54 | 37 | 43 | 0 | 42 | 26 | 15 | 6 | 8 | 128 | 136 | 0 | 5 | 41 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 169,896,914 | 617 | 137 | 0 | 0 | 428 | 87 | 86 | 44 | 296 | 70 | 50 | 24 | 26 | 14 | 11 | 137 | 428 | 0 | 3 | 224 | 0 | 0 | 
| app_proof | prover | 1 | 129,384,977 | 436 | 105 | 0 | 9 | 288 | 103 | 102 | 36 | 149 | 0 | 42 | 20 | 21 | 10 | 11 | 106 | 288 | 0 | 3 | 147 | 0 | 0 | 

| group | phase | segment | trace_height_constraint | weighted_sum | threshold |
| --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 0 | 76,824,781 | 2,013,265,921 | 
| app_proof | prover | 1 | 0 | 55,376,443 | 2,013,265,921 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 25 | 881 | 25 | 135 | 1 | 4 | 103 | 2,327,000 | 28.17 | 
| app_proof | 1 | 34 | 599 | 34 | 40 | 0 | 2 | 86 | 1,763,656 | 28.57 | 

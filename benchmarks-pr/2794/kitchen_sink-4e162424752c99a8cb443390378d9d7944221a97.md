...
| `total_proof_time_ms ` |  913 |  1,826 |  1,143 |  683 |
| `execute_metered_time_ms` |  24 | -          | -          | -          |
| `execute_metered_insns` |  1,979,971 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  81.64 | -          |  81.64 |  81.64 |
| `execute_preflight_insns` |  989,985.50 |  1,979,971 |  1,168,000 |  811,971 |
| `execute_preflight_time_ms` |  92.50 |  185 |  126 |  59 |
| `execute_preflight_insn_mi/s` |  30.16 | -          |  30.32 |  29.99 |
| `trace_gen_time_ms   ` |  24.50 |  49 |  33 |  16 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  707 |  1,414 |  916 |  498 |
| `prover.main_trace_commit_time_ms` |  204.50 |  409 |  271 |  138 |
| `prover.rap_constraints_time_ms` |  456.50 |  913 |  594 |  319 |
| `prover.openings_time_ms` |  45.50 |  91 |  50 |  41 |
| `prover.rap_constraints.logup_gkr_time_ms` |  92 |  184 |  126 |  58 |
| `prover.rap_constraints.round0_time_ms` |  266.50 |  533 |  350 |  183 |
| `prover.rap_constraints.mle_rounds_time_ms` |  97.50 |  195 |  118 |  77 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/4e162424752c99a8cb443390378d9d7944221a97/kitchen_sink-4e162424752c99a8cb443390378d9d7944221a97.memory.svg)
...
| app_proof |  |  |  |  |  | 683 |  |  | 24 | 1,979,971 | 81.64 | 0 | 1,855 |  | 
...
| leaf | 0 | 110 | 407 | 110 | 24 | 10 | 19 | 4 | 4 | 
...
| internal_recursive.1 | 1 | prover | 9,750,799 | 73 | 11 | 0 | 0 | 48 | 18 | 18 | 18 | 10 | 0 | 14 | 8 | 5 | 0 | 4 | 11 | 48 | 0 | 1 | 9 | 0 | 0 | 
| leaf | 0 | prover | 263,565,172 | 297 | 128 | 0 | 1 | 140 | 48 | 48 | 37 | 53 | 0 | 28 | 12 | 15 | 7 | 8 | 128 | 140 | 0 | 2 | 53 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 560,358,052 | 916 | 270 | 0 | 141 | 594 | 350 | 349 | 118 | 126 | 66 | 50 | 12 | 38 | 15 | 22 | 271 | 594 | 0 | 1 | 58 | 0 | 0 | 
| app_proof | prover | 1 | 537,646,220 | 498 | 137 | 0 | 2 | 319 | 183 | 182 | 77 | 58 | 0 | 41 | 13 | 27 | 14 | 13 | 138 | 319 | 0 | 1 | 57 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 33 | 1,143 | 33 | 134 | 0 | 3 | 59 | 1,168,000 | 29.99 | 
| app_proof | 1 | 16 | 683 | 16 | 40 | 0 | 1 | 126 | 811,971 | 30.32 | 

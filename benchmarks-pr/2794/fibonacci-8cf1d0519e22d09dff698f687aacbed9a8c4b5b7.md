...
|:---|---:|---:|---:|
| Total |  2.56 |  1.49 |  1.49 |
| app_proof |  1.61 |  0.55 |  0.55 |
| leaf |  0.44 |  0.44 |  0.44 |
...
| `total_proof_time_ms ` |  398.25 |  1,593 |  526 |  223 |
| `execute_metered_time_ms` |  19 | -          | -          | -          |
| `execute_metered_insns` |  4,000,051 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  200.94 | -          |  200.94 |  200.94 |
| `execute_preflight_insns` |  1,000,012.75 |  4,000,051 |  1,310,000 |  70,051 |
| `execute_preflight_time_ms` |  40.25 |  161 |  55 |  4 |
| `execute_preflight_insn_mi/s` |  34.69 | -          |  34.83 |  34.52 |
| `trace_gen_time_ms   ` |  72.75 |  291 |  103 |  62 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  219 |  876 |  271 |  73 |
| `prover.main_trace_commit_time_ms` |  43 |  172 |  53 |  15 |
| `prover.rap_constraints_time_ms` |  143.50 |  574 |  185 |  34 |
| `prover.openings_time_ms` |  31.50 |  126 |  38 |  23 |
| `prover.rap_constraints.logup_gkr_time_ms` |  97.50 |  390 |  126 |  16 |
| `prover.rap_constraints.round0_time_ms` |  29.50 |  118 |  40 |  9 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/8cf1d0519e22d09dff698f687aacbed9a8c4b5b7/fibonacci-8cf1d0519e22d09dff698f687aacbed9a8c4b5b7.memory.svg)
...
| app_proof |  |  |  |  |  | 223 |  |  | 19 | 4,000,051 | 200.94 | 0 | 1,619 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 27,289,339 | 209 | 81 | 0 | 0 | 99 | 33 | 32 | 46 | 19 | 0 | 27 | 16 | 11 | 2 | 8 | 82 | 99 | 0 | 2 | 18 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,703 | 140 | 46 | 0 | 0 | 67 | 25 | 24 | 28 | 13 | 0 | 26 | 17 | 8 | 1 | 6 | 47 | 67 | 0 | 2 | 12 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 120 | 32 | 0 | 0 | 60 | 22 | 22 | 24 | 13 | 0 | 27 | 20 | 7 | 1 | 5 | 32 | 60 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 103,146,406 | 381 | 172 | 0 | 0 | 161 | 71 | 70 | 46 | 43 | 0 | 46 | 28 | 18 | 8 | 9 | 173 | 161 | 0 | 6 | 43 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 65,794,666 | 271 | 52 | 0 | 0 | 185 | 40 | 40 | 18 | 126 | 0 | 33 | 20 | 12 | 6 | 6 | 52 | 185 | 0 | 3 | 125 | 0 | 0 | 
| app_proof | prover | 1 | 65,748,660 | 263 | 52 | 0 | 0 | 177 | 34 | 34 | 18 | 124 | 0 | 32 | 20 | 11 | 6 | 5 | 53 | 177 | 0 | 3 | 124 | 0 | 0 | 
| app_proof | prover | 2 | 65,748,660 | 269 | 52 | 0 | 0 | 178 | 35 | 35 | 18 | 124 | 0 | 38 | 26 | 11 | 6 | 5 | 52 | 178 | 0 | 3 | 124 | 0 | 0 | 
| app_proof | prover | 3 | 9,268,712 | 73 | 15 | 0 | 0 | 34 | 9 | 9 | 7 | 16 | 0 | 23 | 20 | 3 | 0 | 2 | 15 | 34 | 0 | 2 | 16 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 62 | 526 | 62 | 136 | 0 | 3 | 55 | 1,310,000 | 34.77 | 
| app_proof | 1 | 63 | 419 | 63 | 40 | 0 | 1 | 51 | 1,310,000 | 34.83 | 
| app_proof | 2 | 63 | 425 | 63 | 41 | 0 | 1 | 51 | 1,310,000 | 34.65 | 
| app_proof | 3 | 103 | 223 | 103 | 40 | 0 | 1 | 4 | 70,051 | 34.52 | 

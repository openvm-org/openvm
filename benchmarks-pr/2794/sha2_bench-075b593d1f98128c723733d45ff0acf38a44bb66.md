...
|:---|---:|---:|---:|
| Total |  11.39 |  4.64 |  4.64 |
| app_proof |  9.32 |  2.57 |  2.57 |
| leaf |  1.40 |  1.40 |  1.40 |
...
| `total_proof_time_ms ` |  2,307.25 |  9,229 |  2,478 |  2,230 |
| `execute_metered_time_ms` |  96 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  115.59 | -          |  115.59 |  115.59 |
| `execute_preflight_insns` |  2,791,990.25 |  11,167,961 |  2,851,000 |  2,614,961 |
| `execute_preflight_time_ms` |  169.75 |  679 |  215 |  104 |
| `execute_preflight_insn_mi/s` |  33.55 | -          |  34.81 |  31.32 |
| `trace_gen_time_ms   ` |  58 |  232 |  64 |  54 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  2,013.25 |  8,053 |  2,172 |  1,956 |
| `prover.main_trace_commit_time_ms` |  547.50 |  2,190 |  638 |  517 |
| `prover.rap_constraints_time_ms` |  1,325.75 |  5,303 |  1,396 |  1,299 |
| `prover.openings_time_ms` |  139.25 |  557 |  142 |  137 |
| `prover.rap_constraints.logup_gkr_time_ms` |  342.75 |  1,371 |  420 |  317 |
| `prover.rap_constraints.round0_time_ms` |  665.75 |  2,663 |  670 |  657 |
| `prover.rap_constraints.mle_rounds_time_ms` |  316.50 |  1,266 |  318 |  315 |
...
| `prover.openings.whir_time_ms` |  37.75 |  151 |  40 |  35 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/075b593d1f98128c723733d45ff0acf38a44bb66/sha2_bench-075b593d1f98128c723733d45ff0acf38a44bb66.memory.svg)
...
| app_proof |  |  |  |  |  | 2,230 |  |  | 96 | 11,167,961 | 115.59 | 0 | 9,332 |  | 
...
| leaf | 0 | 149 | 1,403 | 149 | 54 | 25 | 3 | 6 | 6 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 61,220,603 | 351 | 183 | 0 | 0 | 131 | 38 | 38 | 65 | 27 | 0 | 35 | 16 | 18 | 5 | 13 | 184 | 131 | 0 | 2 | 26 | 0 | 0 | 
...
| leaf | 0 | prover | 425,198,438 | 1,254 | 798 | 0 | 154 | 350 | 170 | 169 | 103 | 76 | 0 | 104 | 39 | 64 | 36 | 27 | 798 | 350 | 0 | 7 | 74 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 654,475,553 | 2,172 | 637 | 0 | 125 | 1,396 | 657 | 656 | 318 | 420 | 119 | 137 | 35 | 102 | 62 | 40 | 638 | 1,396 | 0 | 3 | 300 | 0 | 0 | 
| app_proof | prover | 1 | 654,475,276 | 1,959 | 516 | 0 | 2 | 1,302 | 670 | 670 | 315 | 317 | 0 | 139 | 38 | 100 | 61 | 39 | 517 | 1,302 | 0 | 4 | 315 | 0 | 0 | 
| app_proof | prover | 2 | 654,475,276 | 1,966 | 517 | 0 | 2 | 1,306 | 670 | 670 | 318 | 317 | 0 | 142 | 40 | 101 | 62 | 39 | 518 | 1,306 | 0 | 4 | 316 | 0 | 0 | 
| app_proof | prover | 3 | 654,475,524 | 1,956 | 517 | 0 | 2 | 1,299 | 666 | 666 | 315 | 317 | 0 | 139 | 38 | 100 | 60 | 39 | 517 | 1,299 | 0 | 4 | 316 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 64 | 2,478 | 64 | 136 | 0 | 4 | 104 | 2,851,000 | 31.32 | 
| app_proof | 1 | 57 | 2,274 | 57 | 41 | 0 | 1 | 215 | 2,851,000 | 33.88 | 
| app_proof | 2 | 57 | 2,247 | 57 | 41 | 0 | 1 | 181 | 2,851,000 | 34.81 | 
| app_proof | 3 | 54 | 2,230 | 54 | 41 | 0 | 1 | 179 | 2,614,961 | 34.18 | 

...
| `total_proof_time_ms ` |  2,334.17 |  14,005 |  2,572 |  2,245 |
...
| `execute_preflight_time_ms` |  242 |  1,452 |  322 |  93 |
| `execute_preflight_insn_mi/s` |  32.14 | -          |  32.99 |  29.55 |
| `trace_gen_time_ms   ` |  36.33 |  218 |  49 |  33 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,998.17 |  11,989 |  2,293 |  1,933 |
| `prover.main_trace_commit_time_ms` |  706.33 |  4,238 |  868 |  673 |
| `prover.rap_constraints_time_ms` |  1,103.83 |  6,623 |  1,240 |  1,070 |
| `prover.openings_time_ms` |  187.17 |  1,123 |  190 |  184 |
| `prover.rap_constraints.logup_gkr_time_ms` |  255.50 |  1,533 |  315 |  243 |
| `prover.rap_constraints.round0_time_ms` |  532.17 |  3,193 |  610 |  514 |
| `prover.rap_constraints.mle_rounds_time_ms` |  314.83 |  1,889 |  334 |  310 |
| `prover.openings.stacked_reduction_time_ms` |  140.33 |  842 |  141 |  139 |
| `prover.openings.stacked_reduction.round0_time_ms` |  84.17 |  505 |  85 |  83 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  55.50 |  333 |  57 |  54 |
| `prover.openings.whir_time_ms` |  46.50 |  279 |  49 |  43 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,198 |  2,396 |  1,617 |  779 |
| `execute_preflight_time_ms` |  5.50 |  11 |  6 |  5 |
| `trace_gen_time_ms   ` |  135 |  270 |  179 |  91 |
| `generate_blob_total_time_ms` |  24.50 |  49 |  33 |  16 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,062.50 |  2,125 |  1,437 |  688 |
| `prover.main_trace_commit_time_ms` |  641.50 |  1,283 |  904 |  379 |
| `prover.rap_constraints_time_ms` |  323 |  646 |  416 |  230 |
| `prover.openings_time_ms` |  97.50 |  195 |  117 |  78 |
...
| `prover.openings.whir_time_ms` |  42.50 |  85 |  45 |  40 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/075b593d1f98128c723733d45ff0acf38a44bb66/keccak-075b593d1f98128c723733d45ff0acf38a44bb66.memory.svg)
...
| app_proof |  |  |  |  |  | 2,245 |  |  | 141 | 14,365,133 | 101.79 | 0 | 14,153 |  | 
...
| leaf | 0 | 179 | 1,617 | 179 | 63 | 33 | 6 | 7 | 7 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 81,415,028 | 464 | 246 | 0 | 1 | 173 | 49 | 49 | 92 | 30 | 0 | 43 | 20 | 23 | 7 | 16 | 247 | 173 | 0 | 3 | 29 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,879 | 152 | 49 | 0 | 0 | 73 | 25 | 25 | 29 | 17 | 0 | 29 | 20 | 8 | 1 | 6 | 50 | 73 | 0 | 2 | 16 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 119 | 31 | 0 | 0 | 63 | 24 | 23 | 24 | 14 | 0 | 24 | 17 | 7 | 1 | 5 | 31 | 63 | 0 | 2 | 13 | 0 | 0 | 
| leaf | 0 | prover | 476,578,662 | 1,437 | 903 | 0 | 178 | 416 | 208 | 207 | 121 | 86 | 0 | 117 | 45 | 71 | 41 | 30 | 904 | 416 | 0 | 7 | 85 | 0 | 0 | 
| leaf | 1 | prover | 240,255,732 | 688 | 378 | 0 | 1 | 230 | 110 | 109 | 68 | 51 | 0 | 78 | 40 | 37 | 20 | 17 | 379 | 230 | 0 | 7 | 51 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 850,917,004 | 2,293 | 868 | 0 | 198 | 1,240 | 610 | 609 | 314 | 315 | 80 | 184 | 45 | 139 | 84 | 54 | 868 | 1,240 | 0 | 3 | 234 | 0 | 0 | 
| app_proof | prover | 1 | 850,917,004 | 1,958 | 673 | 0 | 3 | 1,096 | 517 | 517 | 334 | 243 | 0 | 188 | 49 | 139 | 83 | 55 | 673 | 1,096 | 0 | 4 | 242 | 0 | 0 | 
| app_proof | prover | 2 | 850,917,004 | 1,935 | 674 | 0 | 2 | 1,071 | 516 | 516 | 310 | 244 | 0 | 190 | 48 | 141 | 85 | 55 | 674 | 1,071 | 0 | 4 | 243 | 0 | 0 | 
| app_proof | prover | 3 | 850,917,004 | 1,935 | 674 | 0 | 2 | 1,070 | 514 | 514 | 310 | 244 | 0 | 189 | 48 | 141 | 84 | 56 | 675 | 1,070 | 0 | 4 | 243 | 0 | 0 | 
| app_proof | prover | 4 | 850,917,004 | 1,933 | 674 | 0 | 2 | 1,074 | 519 | 518 | 310 | 244 | 0 | 184 | 43 | 141 | 84 | 57 | 674 | 1,074 | 0 | 4 | 244 | 0 | 0 | 
| app_proof | prover | 5 | 850,917,004 | 1,935 | 674 | 0 | 2 | 1,072 | 517 | 516 | 311 | 243 | 0 | 188 | 46 | 141 | 85 | 56 | 674 | 1,072 | 0 | 4 | 242 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 49 | 2,572 | 49 | 135 | 0 | 3 | 93 | 2,413,000 | 29.55 | 
| app_proof | 1 | 34 | 2,355 | 34 | 41 | 0 | 1 | 322 | 2,413,000 | 32.99 | 
| app_proof | 2 | 34 | 2,281 | 34 | 41 | 0 | 1 | 270 | 2,413,000 | 31.85 | 
| app_proof | 3 | 34 | 2,278 | 34 | 41 | 0 | 1 | 267 | 2,413,000 | 32.89 | 
| app_proof | 4 | 34 | 2,274 | 34 | 41 | 0 | 1 | 265 | 2,413,000 | 32.77 | 
| app_proof | 5 | 33 | 2,245 | 33 | 41 | 0 | 1 | 235 | 2,300,133 | 32.80 | 

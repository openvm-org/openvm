...
| `total_proof_time_ms ` |  910 |  1,820 |  1,139 |  681 |
| `execute_metered_time_ms` |  24 | -          | -          | -          |
| `execute_metered_insns` |  1,979,971 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  81.82 | -          |  81.82 |  81.82 |
| `execute_preflight_insns` |  989,985.50 |  1,979,971 |  1,168,000 |  811,971 |
| `execute_preflight_time_ms` |  97 |  194 |  132 |  62 |
| `execute_preflight_insn_mi/s` |  29.70 | -          |  30.01 |  29.38 |
| `trace_gen_time_ms   ` |  24.50 |  49 |  33 |  16 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  699.50 |  1,399 |  908 |  491 |
| `prover.main_trace_commit_time_ms` |  202 |  404 |  267 |  137 |
| `prover.rap_constraints_time_ms` |  451.50 |  903 |  590 |  313 |
| `prover.openings_time_ms` |  45 |  90 |  50 |  40 |
| `prover.rap_constraints.logup_gkr_time_ms` |  90.50 |  181 |  125 |  56 |
| `prover.rap_constraints.round0_time_ms` |  264 |  528 |  348 |  180 |
| `prover.rap_constraints.mle_rounds_time_ms` |  96.50 |  193 |  116 |  77 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/2bbbed568140bd72b127e1e996af2c54385e8210/kitchen_sink-2bbbed568140bd72b127e1e996af2c54385e8210.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 70 | 3 |  |  | 0 |  | 346 | 3 |  |  |  |  |  |  | 
| app_proof |  |  |  |  |  | 681 |  |  | 24 | 1,979,971 | 81.82 | 0 | 1,849 |  | 
...
| leaf | 0 | 109 | 407 | 109 | 25 | 11 | 19 | 5 | 5 | 
...
| internal_recursive.0 | 1 | prover | 15,378,703 | 80 | 16 | 0 | 0 | 48 | 18 | 17 | 20 | 10 | 0 | 15 | 9 | 5 | 1 | 4 | 16 | 48 | 0 | 1 | 9 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 74 | 11 | 0 | 0 | 47 | 18 | 17 | 18 | 9 | 0 | 15 | 9 | 5 | 0 | 4 | 11 | 47 | 0 | 1 | 9 | 0 | 0 | 
| leaf | 0 | prover | 263,565,172 | 297 | 128 | 0 | 1 | 140 | 48 | 48 | 37 | 54 | 0 | 27 | 11 | 15 | 7 | 8 | 128 | 140 | 0 | 2 | 53 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 560,358,052 | 908 | 266 | 0 | 138 | 590 | 348 | 347 | 116 | 125 | 65 | 50 | 12 | 37 | 15 | 21 | 267 | 590 | 0 | 1 | 58 | 0 | 0 | 
| app_proof | prover | 1 | 537,646,220 | 491 | 136 | 0 | 2 | 313 | 180 | 179 | 77 | 56 | 0 | 40 | 13 | 27 | 14 | 13 | 137 | 313 | 0 | 1 | 55 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 33 | 1,139 | 33 | 135 | 0 | 3 | 62 | 1,168,000 | 29.38 | 
| app_proof | 1 | 16 | 681 | 16 | 40 | 0 | 1 | 132 | 811,971 | 30.01 | 

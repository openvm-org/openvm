...
| `total_proof_time_ms ` |  808.50 |  1,617 |  923 |  694 |
| `execute_metered_time_ms` |  33 | -          | -          | -          |
| `execute_metered_insns` |  4,090,656 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  122.08 | -          |  122.08 |  122.08 |
| `execute_preflight_insns` |  2,045,328 |  4,090,656 |  2,327,000 |  1,763,656 |
| `execute_preflight_time_ms` |  85.50 |  171 |  95 |  76 |
| `execute_preflight_insn_mi/s` |  32.72 | -          |  34.43 |  31 |
| `trace_gen_time_ms   ` |  37 |  74 |  43 |  31 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  595.50 |  1,191 |  658 |  533 |
| `prover.main_trace_commit_time_ms` |  121.50 |  243 |  138 |  105 |
| `prover.rap_constraints_time_ms` |  423.50 |  847 |  469 |  378 |
| `prover.openings_time_ms` |  49.50 |  99 |  50 |  49 |
| `prover.rap_constraints.logup_gkr_time_ms` |  284 |  568 |  335 |  233 |
| `prover.rap_constraints.round0_time_ms` |  97.50 |  195 |  108 |  87 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/03e874ed516696502064dc2017d04a5f91fea9c1/regex-03e874ed516696502064dc2017d04a5f91fea9c1.memory.svg)
...
| app_proof |  |  |  |  |  | 694 |  |  | 33 | 4,090,656 | 122.08 | 0 | 1,664 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 27,289,339 | 211 | 81 | 0 | 0 | 98 | 32 | 31 | 45 | 19 | 0 | 31 | 19 | 11 | 2 | 8 | 81 | 98 | 0 | 2 | 18 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,703 | 142 | 46 | 0 | 0 | 67 | 25 | 24 | 28 | 14 | 0 | 27 | 19 | 8 | 1 | 6 | 47 | 67 | 0 | 2 | 12 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 122 | 31 | 0 | 0 | 61 | 23 | 22 | 24 | 13 | 0 | 29 | 21 | 7 | 1 | 5 | 32 | 61 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 79,659,764 | 305 | 128 | 0 | 0 | 133 | 53 | 52 | 37 | 42 | 0 | 43 | 28 | 15 | 6 | 8 | 128 | 133 | 0 | 5 | 41 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 169,896,914 | 658 | 138 | 0 | 0 | 469 | 87 | 86 | 46 | 335 | 89 | 50 | 23 | 27 | 15 | 12 | 138 | 469 | 0 | 3 | 244 | 0 | 0 | 
| app_proof | prover | 1 | 129,384,977 | 533 | 105 | 0 | 9 | 378 | 108 | 108 | 36 | 233 | 0 | 49 | 27 | 21 | 10 | 11 | 105 | 378 | 0 | 3 | 231 | 0 | 0 | 

| group | phase | segment | trace_height_constraint | weighted_sum | threshold |
| --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 0 | 94,331,085 | 2,013,265,921 | 
| app_proof | prover | 1 | 0 | 72,825,407 | 2,013,265,921 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 31 | 923 | 31 | 137 | 1 | 4 | 95 | 2,327,000 | 31 | 
| app_proof | 1 | 43 | 694 | 43 | 40 | 0 | 2 | 76 | 1,763,656 | 34.43 | 

...
| `total_proof_time_ms ` |  904.50 |  1,809 |  1,135 |  674 |
| `execute_metered_time_ms` |  24 | -          | -          | -          |
| `execute_metered_insns` |  1,979,971 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  81.70 | -          |  81.70 |  81.70 |
| `execute_preflight_insns` |  989,985.50 |  1,979,971 |  1,168,000 |  811,971 |
| `execute_preflight_time_ms` |  91 |  182 |  125 |  57 |
| `execute_preflight_insn_mi/s` |  31.57 | -          |  32.13 |  31.02 |
| `trace_gen_time_ms   ` |  24.50 |  49 |  33 |  16 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  699.50 |  1,399 |  907 |  492 |
| `prover.main_trace_commit_time_ms` |  202.50 |  405 |  268 |  137 |
| `prover.rap_constraints_time_ms` |  451 |  902 |  588 |  314 |
| `prover.openings_time_ms` |  45 |  90 |  50 |  40 |
| `prover.rap_constraints.logup_gkr_time_ms` |  90.50 |  181 |  124 |  57 |
| `prover.rap_constraints.round0_time_ms` |  265.50 |  531 |  350 |  181 |
| `prover.rap_constraints.mle_rounds_time_ms` |  94.50 |  189 |  114 |  75 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/03e874ed516696502064dc2017d04a5f91fea9c1/kitchen_sink-03e874ed516696502064dc2017d04a5f91fea9c1.memory.svg)
...
| app_proof |  |  |  |  |  | 674 |  |  | 24 | 1,979,971 | 81.70 | 0 | 1,838 |  | 
...
| leaf | 0 | 108 | 406 | 108 | 24 | 11 | 18 | 4 | 4 | 
...
| internal_recursive.0 | 1 | prover | 15,378,703 | 80 | 16 | 0 | 0 | 48 | 18 | 17 | 20 | 10 | 0 | 15 | 9 | 5 | 1 | 4 | 17 | 48 | 0 | 1 | 9 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 73 | 11 | 0 | 0 | 47 | 18 | 18 | 18 | 10 | 0 | 13 | 8 | 5 | 0 | 4 | 11 | 47 | 0 | 1 | 9 | 0 | 0 | 
| leaf | 0 | prover | 263,565,172 | 297 | 128 | 0 | 1 | 140 | 49 | 48 | 37 | 53 | 0 | 27 | 11 | 15 | 7 | 8 | 129 | 140 | 0 | 2 | 53 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 560,358,052 | 907 | 268 | 0 | 138 | 588 | 350 | 348 | 114 | 124 | 64 | 50 | 12 | 37 | 15 | 21 | 268 | 588 | 0 | 1 | 58 | 0 | 0 | 
| app_proof | prover | 1 | 537,646,220 | 492 | 137 | 0 | 1 | 314 | 181 | 180 | 75 | 57 | 0 | 40 | 13 | 27 | 14 | 13 | 137 | 314 | 0 | 1 | 56 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 33 | 1,135 | 33 | 136 | 0 | 3 | 57 | 1,168,000 | 31.02 | 
| app_proof | 1 | 16 | 674 | 16 | 40 | 0 | 1 | 125 | 811,971 | 32.13 | 

...
| `total_proof_time_ms ` |  2,340.75 |  9,363 |  2,509 |  2,272 |
...
| `execute_preflight_time_ms` |  175 |  700 |  217 |  107 |
| `execute_preflight_insn_mi/s` |  32.63 | -          |  33.35 |  30.52 |
| `trace_gen_time_ms   ` |  58 |  232 |  64 |  54 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  2,041.50 |  8,166 |  2,201 |  1,986 |
| `prover.main_trace_commit_time_ms` |  554.50 |  2,218 |  649 |  523 |
| `prover.rap_constraints_time_ms` |  1,343.50 |  5,374 |  1,414 |  1,315 |
| `prover.openings_time_ms` |  142.25 |  569 |  146 |  137 |
| `prover.rap_constraints.logup_gkr_time_ms` |  347.50 |  1,390 |  427 |  320 |
| `prover.rap_constraints.round0_time_ms` |  674.50 |  2,698 |  679 |  667 |
| `prover.rap_constraints.mle_rounds_time_ms` |  321 |  1,284 |  325 |  318 |
| `prover.openings.stacked_reduction_time_ms` |  103 |  412 |  105 |  102 |
| `prover.openings.stacked_reduction.round0_time_ms` |  62 |  248 |  63 |  61 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  40 |  160 |  41 |  39 |
| `prover.openings.whir_time_ms` |  38.75 |  155 |  41 |  35 |
...
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,288 |  1,288 |  1,288 |  1,288 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/d30973fd5a2fa9b6a654e52b15321c3d868021f9/sha2_bench-d30973fd5a2fa9b6a654e52b15321c3d868021f9.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 83 | 9 |  |  | 0 |  | 385 | 9 |  |  |  |  |  |  | 
| app_proof |  |  |  |  |  | 2,272 |  |  | 97 | 11,167,961 | 114.18 | 0 | 9,467 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 27 | 388 | 27 | 8 | 2 | 2 | 3 | 3 | 
| internal_recursive.0 | 1 | 13 | 166 | 13 | 2 | 0 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 10 | 133 | 10 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 160 | 1,449 | 160 | 55 | 26 | 3 | 7 | 7 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 61,220,603 | 361 | 187 | 0 | 1 | 133 | 38 | 38 | 66 | 27 | 0 | 40 | 21 | 18 | 5 | 12 | 187 | 133 | 0 | 3 | 26 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,879 | 153 | 49 | 0 | 0 | 74 | 26 | 25 | 30 | 18 | 0 | 27 | 18 | 8 | 2 | 6 | 50 | 74 | 0 | 2 | 17 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 123 | 31 | 0 | 0 | 64 | 24 | 23 | 25 | 14 | 0 | 26 | 19 | 7 | 1 | 5 | 32 | 64 | 0 | 2 | 13 | 0 | 0 | 
| leaf | 0 | prover | 425,198,438 | 1,288 | 813 | 0 | 161 | 361 | 177 | 176 | 107 | 76 | 0 | 112 | 47 | 65 | 36 | 28 | 813 | 361 | 0 | 7 | 75 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 654,475,553 | 2,201 | 648 | 0 | 125 | 1,414 | 667 | 666 | 320 | 427 | 121 | 137 | 35 | 102 | 61 | 40 | 649 | 1,414 | 0 | 3 | 305 | 0 | 0 | 
| app_proof | prover | 1 | 654,475,276 | 1,987 | 523 | 0 | 2 | 1,320 | 676 | 676 | 321 | 322 | 0 | 143 | 39 | 103 | 62 | 40 | 523 | 1,320 | 0 | 4 | 320 | 0 | 0 | 
| app_proof | prover | 2 | 654,475,276 | 1,992 | 522 | 0 | 2 | 1,325 | 679 | 678 | 325 | 320 | 0 | 143 | 41 | 102 | 62 | 39 | 523 | 1,325 | 0 | 4 | 319 | 0 | 0 | 
| app_proof | prover | 3 | 654,475,524 | 1,986 | 523 | 0 | 2 | 1,315 | 676 | 675 | 318 | 321 | 0 | 146 | 40 | 105 | 63 | 41 | 523 | 1,315 | 0 | 3 | 320 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 64 | 2,509 | 64 | 136 | 0 | 3 | 107 | 2,851,000 | 30.52 | 
| app_proof | 1 | 57 | 2,304 | 57 | 41 | 0 | 1 | 217 | 2,851,000 | 33.35 | 
| app_proof | 2 | 57 | 2,278 | 57 | 41 | 0 | 1 | 186 | 2,851,000 | 33.34 | 
| app_proof | 3 | 54 | 2,272 | 54 | 41 | 0 | 1 | 190 | 2,614,961 | 33.29 | 

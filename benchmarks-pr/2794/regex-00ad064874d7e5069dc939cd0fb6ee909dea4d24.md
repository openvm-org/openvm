...
|:---|---:|---:|---:|
| Total |  2.53 |  1.83 |  1.83 |
| app_proof |  1.67 |  0.97 |  0.97 |
| leaf |  0.36 |  0.36 |  0.36 |
...
| `total_proof_time_ms ` |  817 |  1,634 |  932 |  702 |
| `execute_metered_time_ms` |  33 | -          | -          | -          |
| `execute_metered_insns` |  4,090,656 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  121.03 | -          |  121.03 |  121.03 |
| `execute_preflight_insns` |  2,045,328 |  4,090,656 |  2,327,000 |  1,763,656 |
| `execute_preflight_time_ms` |  86.50 |  173 |  96 |  77 |
| `execute_preflight_insn_mi/s` |  32.94 | -          |  34.40 |  31.47 |
| `trace_gen_time_ms   ` |  38.50 |  77 |  45 |  32 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  603 |  1,206 |  667 |  539 |
| `prover.main_trace_commit_time_ms` |  123 |  246 |  140 |  106 |
| `prover.rap_constraints_time_ms` |  429 |  858 |  477 |  381 |
| `prover.openings_time_ms` |  50 |  100 |  50 |  50 |
| `prover.rap_constraints.logup_gkr_time_ms` |  285.50 |  571 |  338 |  233 |
| `prover.rap_constraints.round0_time_ms` |  101 |  202 |  111 |  91 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/00ad064874d7e5069dc939cd0fb6ee909dea4d24/regex-00ad064874d7e5069dc939cd0fb6ee909dea4d24.memory.svg)
...
| app_proof |  |  |  |  |  | 702 |  |  | 33 | 4,090,656 | 121.03 | 0 | 1,681 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 27,289,339 | 214 | 83 | 0 | 0 | 98 | 32 | 31 | 46 | 19 | 0 | 32 | 20 | 11 | 2 | 8 | 83 | 98 | 0 | 2 | 18 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,703 | 141 | 46 | 0 | 0 | 67 | 24 | 24 | 28 | 13 | 0 | 27 | 19 | 8 | 1 | 6 | 46 | 67 | 0 | 2 | 12 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 117 | 32 | 0 | 0 | 61 | 23 | 23 | 24 | 13 | 0 | 23 | 15 | 7 | 1 | 5 | 32 | 61 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 79,659,764 | 310 | 129 | 0 | 0 | 136 | 55 | 54 | 38 | 42 | 0 | 44 | 29 | 15 | 6 | 8 | 129 | 136 | 0 | 5 | 42 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 169,896,914 | 667 | 139 | 0 | 0 | 477 | 91 | 91 | 46 | 338 | 90 | 50 | 23 | 26 | 14 | 12 | 140 | 476 | 0 | 3 | 247 | 0 | 0 | 
| app_proof | prover | 1 | 129,384,977 | 539 | 106 | 0 | 9 | 381 | 111 | 110 | 36 | 233 | 0 | 50 | 27 | 22 | 10 | 11 | 106 | 381 | 0 | 3 | 232 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 32 | 932 | 32 | 135 | 1 | 4 | 96 | 2,327,000 | 31.47 | 
| app_proof | 1 | 45 | 702 | 45 | 40 | 0 | 2 | 77 | 1,763,656 | 34.40 | 

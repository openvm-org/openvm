...
|:---|---:|---:|---:|
| Total |  17.34 |  5.12 |  5.12 |
| app_proof |  14.15 |  2.71 |  2.71 |
| leaf |  2.39 |  1.62 |  1.62 |
...
| `total_proof_time_ms ` |  2,335.33 |  14,012 |  2,568 |  2,243 |
| `execute_metered_time_ms` |  141 | -          | -          | -          |
| `execute_metered_insns` |  14,365,133 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  101.32 | -          |  101.32 |  101.32 |
| `execute_preflight_insns` |  2,394,188.83 |  14,365,133 |  2,413,000 |  2,300,133 |
| `execute_preflight_time_ms` |  254.83 |  1,529 |  346 |  102 |
| `execute_preflight_insn_mi/s` |  28.37 | -          |  29.05 |  26.71 |
| `trace_gen_time_ms   ` |  34.83 |  209 |  40 |  33 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,987.83 |  11,927 |  2,289 |  1,917 |
| `prover.main_trace_commit_time_ms` |  703.17 |  4,219 |  866 |  670 |
| `prover.rap_constraints_time_ms` |  1,099.67 |  6,598 |  1,239 |  1,066 |
| `prover.openings_time_ms` |  184 |  1,104 |  192 |  180 |
| `prover.rap_constraints.logup_gkr_time_ms` |  255.17 |  1,531 |  316 |  241 |
| `prover.rap_constraints.round0_time_ms` |  531.67 |  3,190 |  609 |  516 |
| `prover.rap_constraints.mle_rounds_time_ms` |  312 |  1,872 |  329 |  305 |
| `prover.openings.stacked_reduction_time_ms` |  138.83 |  833 |  142 |  138 |
| `prover.openings.stacked_reduction.round0_time_ms` |  83.50 |  501 |  86 |  83 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  54.50 |  327 |  55 |  54 |
| `prover.openings.whir_time_ms` |  44.67 |  268 |  50 |  41 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,196.50 |  2,393 |  1,618 |  775 |
| `execute_preflight_time_ms` |  5.50 |  11 |  6 |  5 |
| `trace_gen_time_ms   ` |  136.50 |  273 |  182 |  91 |
| `generate_blob_total_time_ms` |  24.50 |  49 |  33 |  16 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,059.50 |  2,119 |  1,435 |  684 |
| `prover.main_trace_commit_time_ms` |  641 |  1,282 |  903 |  379 |
| `prover.rap_constraints_time_ms` |  321.50 |  643 |  412 |  231 |
| `prover.openings_time_ms` |  96.50 |  193 |  119 |  74 |
...
| `prover.openings.whir_time_ms` |  40 |  80 |  44 |  36 |

| internal_for_leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  504 |  504 |  504 |  504 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/8cf1d0519e22d09dff698f687aacbed9a8c4b5b7/keccak-8cf1d0519e22d09dff698f687aacbed9a8c4b5b7.memory.svg)
...
| app_proof |  |  |  |  |  | 2,243 |  |  | 141 | 14,365,133 | 101.32 | 0 | 14,162 |  | 
| internal_for_leaf |  |  |  | 504 |  |  |  |  |  |  |  |  |  | 504 | 
| internal_recursive.0 |  |  |  | 160 |  |  |  |  |  |  |  |  |  | 161 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 39 | 504 | 39 | 13 | 4 | 2 | 2 | 2 | 
| internal_recursive.0 | 1 | 14 | 160 | 14 | 2 | 1 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 9 | 128 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 182 | 1,618 | 182 | 65 | 33 | 6 | 7 | 7 | 
| leaf | 1 | 91 | 775 | 90 | 32 | 16 | 5 | 7 | 7 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 81,415,028 | 464 | 245 | 0 | 1 | 174 | 50 | 49 | 92 | 31 | 0 | 44 | 20 | 24 | 8 | 16 | 245 | 174 | 0 | 3 | 30 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,879 |
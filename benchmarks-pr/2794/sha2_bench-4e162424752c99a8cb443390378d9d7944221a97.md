...
|:---|---:|---:|---:|
| Total |  11.58 |  4.73 |  4.73 |
| app_proof |  9.49 |  2.63 |  2.63 |
| leaf |  1.42 |  1.42 |  1.42 |
...
| `total_proof_time_ms ` |  2,347.75 |  9,391 |  2,537 |  2,264 |
| `execute_metered_time_ms` |  97 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  114.03 | -          |  114.03 |  114.03 |
| `execute_preflight_insns` |  2,791,990.25 |  11,167,961 |  2,851,000 |  2,614,961 |
| `execute_preflight_time_ms` |  169 |  676 |  211 |  106 |
| `execute_preflight_insn_mi/s` |  32.75 | -          |  33.50 |  30.68 |
| `trace_gen_time_ms   ` |  58 |  232 |  64 |  54 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  2,054.50 |  8,218 |  2,229 |  1,992 |
| `prover.main_trace_commit_time_ms` |  550 |  2,200 |  641 |  518 |
| `prover.rap_constraints_time_ms` |  1,361.75 |  5,447 |  1,446 |  1,329 |
| `prover.openings_time_ms` |  141.75 |  567 |  145 |  140 |
| `prover.rap_constraints.logup_gkr_time_ms` |  366.75 |  1,467 |  460 |  335 |
| `prover.rap_constraints.round0_time_ms` |  675 |  2,700 |  679 |  668 |
| `prover.rap_constraints.mle_rounds_time_ms` |  319 |  1,276 |  321 |  317 |
| `prover.openings.stacked_reduction_time_ms` |  102 |  408 |  103 |  101 |
| `prover.openings.stacked_reduction.round0_time_ms` |  62 |  248 |  63 |  61 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  39.75 |  159 |  41 |  39 |
| `prover.openings.whir_time_ms` |  39 |  156 |  43 |  37 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/4e162424752c99a8cb443390378d9d7944221a97/sha2_bench-4e162424752c99a8cb443390378d9d7944221a97.memory.svg)
...
| app_proof |  |  |  |  |  | 2,264 |  |  | 97 | 11,167,961 | 114.03 | 0 | 9,495 |  | 
...
| leaf | 0 | 151 | 1,424 | 151 | 53 | 25 | 3 | 6 | 6 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 61,220,603 | 355 | 186 | 0 | 0 | 129 | 37 | 37 | 64 | 27 | 0 | 39 | 20 | 18 | 5 | 13 | 186 | 129 | 0 | 2 | 26 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,879 | 148 | 49 | 0 | 0 | 73 | 25 | 25 | 29 | 17 | 0 | 25 | 17 | 8 | 1 | 6 | 49 | 73 | 0 | 2 | 16 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 120 | 31 | 0 | 0 | 62 | 24 | 23 | 24 | 13 | 0 | 25 | 18 | 7 | 1 | 5 | 31 | 62 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 425,198,438 | 1,272 | 803 | 0 | 152 | 354 | 171 | 170 | 107 | 75 | 0 | 114 | 49 | 64 | 36 | 27 | 803 | 354 | 0 | 7 | 75 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 654,475,553 | 2,229 | 641 | 0 | 125 | 1,446 | 668 | 667 | 317 | 460 | 138 | 141 | 37 | 103 | 63 | 40 | 641 | 1,446 | 0 | 4 | 320 | 0 | 0 | 
| app_proof | prover | 1 | 654,475,276 | 1,996 | 518 | 0 | 2 | 1,336 | 679 | 679 | 321 | 335 | 0 | 141 | 39 | 101 | 61 | 39 | 518 | 1,336 | 0 | 3 | 334 | 0 | 0 | 
| app_proof | prover | 2 | 654,475,276 | 2,001 | 520 | 0 | 2 | 1,336 | 679 | 678 | 320 | 336 | 0 | 145 | 43 | 101 | 62 | 39 | 520 | 1,336 | 0 | 3 | 334 | 0 | 0 | 
| app_proof | prover | 3 | 654,475,524 | 1,992 | 521 | 0 | 2 | 1,329 | 674 | 674 | 318 | 336 | 0 | 140 | 37 | 103 | 62 | 41 | 521 | 1,329 | 0 | 4 | 334 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 64 | 2,537 | 64 | 137 | 0 | 3 | 106 | 2,851,000 | 30.68 | 
| app_proof | 1 | 57 | 2,306 | 57 | 41 | 0 | 1 | 211 | 2,851,000 | 33.35 | 
| app_proof | 2 | 57 | 2,284 | 57 | 41 | 0 | 1 | 183 | 2,851,000 | 33.50 | 
| app_proof | 3 | 54 | 2,264 | 54 | 41 | 0 | 1 | 176 | 2,614,961 | 33.48 | 

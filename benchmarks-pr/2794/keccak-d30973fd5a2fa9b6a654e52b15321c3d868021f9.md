...
|:---|---:|---:|---:|
| Total |  17.38 |  5.13 |  5.13 |
| app_proof |  14.18 |  2.71 |  2.71 |
| leaf |  2.39 |  1.62 |  1.62 |
...
| `total_proof_time_ms ` |  2,340 |  14,040 |  2,567 |  2,254 |
| `execute_metered_time_ms` |  142 | -          | -          | -          |
| `execute_metered_insns` |  14,365,133 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  100.53 | -          |  100.53 |  100.53 |
| `execute_preflight_insns` |  2,394,188.83 |  14,365,133 |  2,413,000 |  2,300,133 |
| `execute_preflight_time_ms` |  239.67 |  1,438 |  321 |  94 |
| `execute_preflight_insn_mi/s` |  31.25 | -          |  32.14 |  28.99 |
| `trace_gen_time_ms   ` |  36.17 |  217 |  48 |  33 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  2,006.33 |  12,038 |  2,288 |  1,944 |
| `prover.main_trace_commit_time_ms` |  706.33 |  4,238 |  866 |  673 |
| `prover.rap_constraints_time_ms` |  1,112.17 |  6,673 |  1,237 |  1,082 |
| `prover.openings_time_ms` |  187 |  1,122 |  191 |  183 |
| `prover.rap_constraints.logup_gkr_time_ms` |  258.17 |  1,549 |  315 |  244 |
| `prover.rap_constraints.round0_time_ms` |  536.33 |  3,218 |  605 |  518 |
| `prover.rap_constraints.mle_rounds_time_ms` |  316.17 |  1,897 |  335 |  311 |
| `prover.openings.stacked_reduction_time_ms` |  139.67 |  838 |  141 |  137 |
| `prover.openings.stacked_reduction.round0_time_ms` |  84.17 |  505 |  86 |  80 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  55 |  330 |  56 |  54 |
| `prover.openings.whir_time_ms` |  46.83 |  281 |  50 |  42 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,197 |  2,394 |  1,620 |  774 |
| `execute_preflight_time_ms` |  5.50 |  11 |  6 |  5 |
| `trace_gen_time_ms   ` |  134 |  268 |  178 |  90 |
| `generate_blob_total_time_ms` |  24.50 |  49 |  33 |  16 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,062.50 |  2,125 |  1,441 |  684 |
| `prover.main_trace_commit_time_ms` |  642 |  1,284 |  904 |  380 |
| `prover.rap_constraints_time_ms` |  324.50 |  649 |  418 |  231 |
| `prover.openings_time_ms` |  95 |  190 |  118 |  72 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/d30973fd5a2fa9b6a654e52b15321c3d868021f9/keccak-d30973fd5a2fa9b6a654e52b15321c3d868021f9.memory.svg)
...
| app_proof |  |  |  |  |  | 2,254 |  |  | 142 | 14,365,133 | 100.53 | 0 | 14,190 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 39 | 507 | 39 | 13 | 4 | 2 | 2 | 2 | 
| internal_recursive.0 | 1 | 13 | 164 | 13 | 2 | 1 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 9 | 131 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 178 | 1,620 | 178 | 64 | 33 | 6 | 7 | 7 | 
| leaf | 1 | 90 | 774 | 89 | 32 | 16 | 5 | 7 | 7 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 81,415,028 | 467 | 247 | 0 | 1 | 173 | 49 | 49 | 92 | 30 | 0 | 45 | 21 | 23 | 7 | 15 | 248 | 173 | 0 | 3 | 30 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,879 | 151 | 50 | 0 | 0 | 73 | 25 | 25 | 29 | 18 | 0 | 26 | 18 | 8 | 1 | 6 | 50 | 73 | 0 | 2 | 17 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 121 | 31 | 0 | 0 | 63 | 24 | 24 | 24 | 13 | 0 | 25 | 18 | 7 | 1 | 5 | 32 | 63 | 0 | 2 | 13 | 0 | 0 | 
| leaf | 0 | prover | 476,578,662 | 1
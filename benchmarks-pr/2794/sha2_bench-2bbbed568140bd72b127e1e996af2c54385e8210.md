...
|:---|---:|---:|---:|
| Total |  11.56 |  4.73 |  4.73 |
| app_proof |  9.46 |  2.63 |  2.63 |
| leaf |  1.42 |  1.42 |  1.42 |
...
| `total_proof_time_ms ` |  2,341.25 |  9,365 |  2,532 |  2,254 |
...
| `execute_preflight_time_ms` |  171.25 |  685 |  215 |  106 |
| `execute_preflight_insn_mi/s` |  32.36 | -          |  33.37 |  30.58 |
| `trace_gen_time_ms   ` |  57.75 |  231 |  63 |  54 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  2,046.25 |  8,185 |  2,225 |  1,980 |
| `prover.main_trace_commit_time_ms` |  551 |  2,204 |  642 |  520 |
| `prover.rap_constraints_time_ms` |  1,354 |  5,416 |  1,443 |  1,319 |
| `prover.openings_time_ms` |  140.25 |  561 |  145 |  138 |
| `prover.rap_constraints.logup_gkr_time_ms` |  365.75 |  1,463 |  459 |  334 |
| `prover.rap_constraints.round0_time_ms` |  667.75 |  2,671 |  672 |  663 |
| `prover.rap_constraints.mle_rounds_time_ms` |  319.25 |  1,277 |  321 |  317 |
| `prover.openings.stacked_reduction_time_ms` |  101.50 |  406 |  102 |  101 |
...
| `prover.openings.whir_time_ms` |  38.50 |  154 |  43 |  36 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/2bbbed568140bd72b127e1e996af2c54385e8210/sha2_bench-2bbbed568140bd72b127e1e996af2c54385e8210.memory.svg)

| Module | Max (GB) | Max At |
| --- | ---: | --- |
| prover.batch_constraints.before_round0 | 11.83 | app_proof.prover.3 |
| frac_sumcheck.gkr_rounds | 11.83 | app_proof.prover.3 |
| frac_sumcheck.segment_tree | 11.74 | app_proof.prover.0 |
| prover.gkr_input_evals | 11.74 | app_proof.prover.0 |
...
| app_proof |  |  |  |  |  | 2,254 |  |  | 98 | 11,167,961 | 113.88 | 0 | 9,470 |  | 
...
| internal_recursive.0 | 1 | 12 | 164 | 11 | 2 | 0 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 9 | 129 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 148 | 1,424 | 148 | 53 | 25 | 3 | 6 | 6 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 61,220,603 | 355 | 184 | 0 | 0 | 129 | 37 | 37 | 64 | 26 | 0 | 40 | 21 | 18 | 5 | 12 | 185 | 129 | 0 | 2 | 26 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,879 | 152 | 49 | 0 | 0 | 73 | 25 | 25 | 29 | 17 | 0 | 28 | 20 | 8 | 2 | 6 | 50 | 73 | 0 | 2 | 17 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 119 | 31 | 0 | 0 | 63 | 24 | 23 | 24 | 13 | 0 | 24 | 16 | 7 | 1 | 5 | 32 | 63 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 425,198,438 | 1,275 | 807 | 0 | 159 | 355 | 174 | 173 | 104 | 75 | 0 | 112 | 47 | 65 | 36 | 28 | 807 | 355 | 0 | 6 | 75 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 654,475,553 | 2,225 | 642 | 0 | 125 | 1,443 | 663 | 663 | 320 | 459 | 138 | 138 | 36 | 101 | 61 | 39 | 642 | 1,443 | 0 | 3 | 318 | 0 | 0 | 
| app_proof | prover | 1 | 654,475,276 | 1,985 | 520 | 0 | 2 | 1,325 | 672 | 671 | 317 | 335 | 0 | 139 | 38 | 101 | 61 | 39 | 521 | 1,325 | 0 | 3 | 334 | 0 | 0 | 
| app_proof | prover | 2 | 654,475,276 | 1,995 | 520 | 0 | 2 | 1,329 | 672 | 672 | 321 | 334 | 0 | 145 | 43 | 102 | 62 | 39 | 520 | 1,329 | 0 | 3 | 333 | 0 | 0 | 
| app_proof | prover | 3 | 654,475,524 | 1,980 | 521 | 0 | 2 | 1,319 | 664 | 664 | 319 | 335 | 0 | 139 | 37 | 102 | 61 | 40 | 521 | 1,319 | 0 | 3 | 333 | 0 | 0 | 

| group | phase | segment | trace_height_constraint | weighted_sum | threshold |
| --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 0 | 130,507,179 | 2,013,265,921 | 
| app_proof | prover | 1 | 0 | 130,507,018 | 2,013,265,921 | 
| app_proof | prover | 2 | 0 | 130,507,018 | 2,013,265,921 | 
| app_proof | prover | 3 | 0 | 130,507,134 | 2,013,265,921 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 63 | 2,532 | 63 | 136 | 0 | 3 | 106 | 2,851,000 | 30.58 | 
| app_proof | 1 | 57 | 2,299 | 57 | 41 | 0 | 1 | 215 | 2,851,000 | 32.20 | 
| app_proof | 2 | 57 | 2,280 | 57 | 41 | 0 | 1 | 186 | 2,851,000 | 33.29 | 
| app_proof | 3 | 54 | 2,254 | 54 | 41 | 0 | 1 | 178 | 2,614,961 | 33.37 | 

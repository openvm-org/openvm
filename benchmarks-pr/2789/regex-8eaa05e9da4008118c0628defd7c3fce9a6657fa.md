...
|:---|---:|---:|---:|
| Total |  2.28 |  1.65 |  1.65 |
| app_proof |  1.42 |  0.79 |  0.79 |
| leaf |  0.35 |  0.35 |  0.35 |
...
| `total_proof_time_ms ` |  696 |  1,392 |  758 |  634 |
| `execute_metered_time_ms` |  32 | -          | -          | -          |
| `execute_metered_insns` |  4,137,067 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  128.75 | -          |  128.75 |  128.75 |
| `execute_preflight_insns` |  2,068,533.50 |  4,137,067 |  2,208,000 |  1,929,067 |
| `execute_preflight_time_ms` |  72.50 |  145 |  78 |  67 |
| `execute_preflight_insn_mi/s` |  39.57 | -          |  40.86 |  38.29 |
| `trace_gen_time_ms   ` |  149.50 |  299 |  152 |  147 |
| `memory_finalize_time_ms` |  1 |  2 |  2 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  371.50 |  743 |  373 |  370 |
| `prover.main_trace_commit_time_ms` |  93 |  186 |  99 |  87 |
| `prover.rap_constraints_time_ms` |  239 |  478 |  249 |  229 |
| `prover.openings_time_ms` |  39 |  78 |  41 |  37 |
| `prover.rap_constraints.logup_gkr_time_ms` |  136.50 |  273 |  140 |  133 |
| `prover.rap_constraints.round0_time_ms` |  70.50 |  141 |  86 |  55 |
...
| `prover.openings.whir_time_ms` |  19.50 |  39 |  21 |  18 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/8eaa05e9da4008118c0628defd7c3fce9a6657fa/regex-8eaa05e9da4008118c0628defd7c3fce9a6657fa.memory.svg)
...
| app_proof |  |  |  |  |  | 634 |  |  | 32 | 4,137,067 | 128.75 | 0 | 1,439 |  | 
| internal_for_leaf |  |  |  | 227 |  |  |  |  |  |  |  |  |  | 227 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 27,256,571 | 211 | 81 | 0 | 0 | 96 | 31 | 31 | 45 | 19 | 0 | 33 | 22 | 11 | 2 | 8 | 81 | 96 | 0 | 2 | 18 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,703 | 141 | 45 | 0 | 0 | 66 | 25 | 24 | 27 | 13 | 0 | 28 | 20 | 8 | 1 | 6 | 45 | 66 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 118 | 31 | 0 | 0 | 63 | 24 | 23 | 24 | 13 | 0 | 24 | 16 | 7 | 1 | 5 | 31 | 63 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 79,962,804 | 302 | 126 | 0 | 0 | 134 | 54 | 53 | 37 | 42 | 0 | 41 | 26 | 15 | 6 | 8 | 126 | 134 | 0 | 5 | 41 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 123,384,338 | 370 | 99 | 0 | 0 | 229 | 55 | 54 | 34 | 140 | 0 | 41 | 21 | 19 | 10 | 9 | 99 | 229 | 0 | 3 | 138 | 0 | 0 | 
| app_proof | prover | 1 | 106,568,591 | 373 | 86 | 0 | 8 | 249 | 86 | 85 | 29 | 133 | 0 | 37 | 18 | 19 | 8 | 10 | 87 | 249 | 0 | 3 | 132 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 147 | 758 | 147 | 161 | 2 | 6 | 78 | 2,208,000 | 38.29 | 
| app_proof | 1 | 152 | 634 | 152 | 40 | 0 | 2 | 67 | 1,929,067 | 40.86 | 

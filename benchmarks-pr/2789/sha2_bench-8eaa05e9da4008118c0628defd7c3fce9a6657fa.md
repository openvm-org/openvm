...
|:---|---:|---:|---:|
| Total |  12.39 |  3.55 |  3.55 |
| app_proof |  10.20 |  1.84 |  1.84 |
| leaf |  1.44 |  0.96 |  0.96 |
...
| `total_proof_time_ms ` |  1,677 |  10,062 |  1,707 |  1,625 |
| `execute_metered_time_ms` |  137 | -          | -          | -          |
| `execute_metered_insns` |  14,793,960 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  107.22 | -          |  107.22 |  107.22 |
| `execute_preflight_insns` |  2,465,660 |  14,793,960 |  2,625,000 |  1,670,960 |
| `execute_preflight_time_ms` |  120.67 |  724 |  152 |  85 |
| `execute_preflight_insn_mi/s` |  41.23 | -          |  42.10 |  38.10 |
| `trace_gen_time_ms   ` |  160.50 |  963 |  194 |  137 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,256.50 |  7,539 |  1,282 |  1,217 |
| `prover.main_trace_commit_time_ms` |  281.67 |  1,690 |  283 |  281 |
| `prover.rap_constraints_time_ms` |  890.50 |  5,343 |  915 |  849 |
| `prover.openings_time_ms` |  83.67 |  502 |  90 |  78 |
| `prover.rap_constraints.logup_gkr_time_ms` |  288.33 |  1,730 |  305 |  237 |
| `prover.rap_constraints.round0_time_ms` |  437.17 |  2,623 |  453 |  380 |
| `prover.rap_constraints.mle_rounds_time_ms` |  164 |  984 |  166 |  162 |
| `prover.openings.stacked_reduction_time_ms` |  52.83 |  317 |  54 |  51 |
...
| `prover.openings.whir_time_ms` |  30.17 |  181 |  36 |  26 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  718.50 |  1,437 |  957 |  480 |
| `execute_preflight_time_ms` |  2 |  4 |  2 |  2 |
| `trace_gen_time_ms   ` |  74.50 |  149 |  100 |  49 |
| `generate_blob_total_time_ms` |  9.50 |  19 |  13 |  6 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  643.50 |  1,287 |  857 |  430 |
| `prover.main_trace_commit_time_ms` |  357.50 |  715 |  498 |  217 |
| `prover.rap_constraints_time_ms` |  220.50 |  441 |  278 |  163 |
| `prover.openings_time_ms` |  64 |  128 |  79 |  49 |
| `prover.rap_constraints.logup_gkr_time_ms` |  58 |  116 |  72 |  44 |
| `prover.rap_constraints.round0_time_ms` |  99 |  198 |  128 |  70 |
...
| `prover.openings.whir_time_ms` |  33 |  66 |  39 |  27 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/8eaa05e9da4008118c0628defd7c3fce9a6657fa/sha2_bench-8eaa05e9da4008118c0628defd7c3fce9a6657fa.memory.svg)
...
| app_proof |  |  |  |  |  | 1,680 |  |  | 137 | 14,793,960 | 107.22 | 0 | 10,207 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 30 | 458 | 30 | 11 | 2 | 2 | 1 | 1 | 
| internal_recursive.0 | 1 | 12 | 160 | 12 | 2 | 1 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 9 | 133 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 100 | 957 | 100 | 36 | 13 | 2 | 3 | 3 | 
| leaf | 1 | 49 | 480 | 49 | 18 | 6 | 2 | 3 | 3 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 75,647,860 | 427 | 222 | 0 | 1 | 160 | 44 | 44 | 85 | 29 | 0 | 44 | 22 | 22 | 7 | 15 | 222 | 160 | 0 | 2 | 28 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,879 | 147 | 47 | 0 | 0 | 72 | 25 | 25 | 29 | 17 | 0 | 27 | 18 | 8 | 1 | 6 | 47 | 72 | 0 | 2 | 16 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 123 | 31 | 0 | 0 | 60 | 22 | 21 | 24 | 13 | 0 | 31 | 24 | 7 | 1 | 5 | 31 | 60 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 266,560,230 | 857 | 498 | 0 | 97 | 278 | 128 | 127 | 77 | 72 | 0 | 79 | 39 | 40 | 21 | 18 | 498 | 278 | 0 | 6 | 71 | 0 | 0 | 
| leaf | 1 | prover | 135,246,516 | 430 | 217 | 0 | 1 | 163 | 70 | 70 | 47 | 44 | 0 | 49 | 27 | 22 | 11 | 11 | 217 | 163 | 0 | 5 | 44 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 353,899,717 | 1,217 | 281 | 0 | 1 | 849 | 380 | 380 | 163 | 305 | 77 | 86 | 32 | 54 | 31 | 23 | 281 | 849 | 0 | 4 | 227 | 0 | 0 | 
| app_proof | prover | 1 | 353,899,532 | 1,278 | 282 | 0 | 1 | 912 | 449 | 449 | 166 | 296 | 75 | 83 | 29 | 53 | 32 | 21 | 282 | 912 | 0 | 3 | 219 | 0 | 0 | 
| app_proof | prover | 2 | 353,899,532 | 1,282 | 282 | 0 | 1 | 910 | 447 | 447 | 166 | 296 | 76 | 90 | 36 | 53 | 31 | 21 | 282 | 910 | 0 | 3 | 219 | 0 | 0 | 
| app_proof | prover | 3 | 353,899,532 | 1,218 | 280 | 0 | 1 | 854 | 453 | 453 | 163 | 237 | 0 | 82 | 29 | 53 | 31 | 22 | 281 | 854 | 0 | 4 | 236 | 0 | 0 | 
| app_proof | prover | 4 | 353,899,532 | 1,280 | 281 | 0 | 1 | 915 | 451 | 450 | 164 | 299 | 76 | 83 | 29 | 53 | 31 | 22 | 281 | 915 | 0 | 3 | 222 | 0 | 0 | 
| app_proof | prover | 5 | 353,980,012 | 1,264 | 283 | 0 | 1 | 903 | 443 | 442 | 162 | 297 | 76 | 78 | 26 | 51 | 30 | 20 | 283 | 903 | 0 | 3 | 220 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 158 | 1,625 | 158 | 163 | 0 | 3 | 85 | 2,623,000 | 38.10 | 
| app_proof | 1 | 137 | 1,707 | 137 | 138 | 0 | 2 | 152 | 2,625,000 | 41.39 | 
| app_proof | 2 | 158 | 1,706 | 158 | 131 | 0 | 2 | 133 | 2,625,000 | 41.98 | 
| app_proof | 3 | 159 | 1,642 | 159 | 131 | 0 | 2 | 132 | 2,625,000 | 42.10 | 
| app_proof | 4 | 157 | 1,702 | 157 | 131 | 0 | 2 | 133 | 2,625,000 | 41.92 | 
| app_proof | 5 | 194 | 1,680 | 194 | 132 | 0 | 2 | 89 | 1,670,960 | 41.92 | 

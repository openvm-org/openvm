...
|:---|---:|---:|---:|
| Total |  1.57 |  0.97 | 0.97 |
| pairing |  1.57 |  0.97 |  0.97 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  750.50 |  1,501 |  902 |  599 |
...
| `execute_preflight_time_ms` |  85.50 |  171 |  124 |  47 |
| `execute_preflight_insn_mi/s` |  14.61 | -          |  18.19 |  11.03 |
| `trace_gen_time_ms   ` |  185.50 |  371 |  206 |  165 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  374 |  748 |  445 |  303 |
| `main_trace_commit_time_ms` |  65.50 |  131 |  76 |  55 |
| `generate_perm_trace_time_ms` |  60.50 |  121 |  88 |  33 |
| `perm_trace_commit_time_ms` |  77.82 |  155.64 |  90.57 |  65.07 |
| `quotient_poly_compute_time_ms` |  84.86 |  169.73 |  93.71 |  76.02 |
| `quotient_poly_commit_time_ms` |  17.88 |  35.77 |  20.28 |  15.49 |
| `pcs_opening_time_ms ` |  62.50 |  125 |  71 |  54 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 599 | 1 | 67 | 1,745,757 | 25.92 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 165 | 902 | 172,558,444 | 165 | 445 | 0 | 93.71 | 20.28 | 6 | 90.57 | 71 | 181 | 71 | 1 | 76 | 88 | 124 | 1,151,000 | 11.03 | 27 | 114 | 1 | 71 | 
| pairing | 1 | 206 | 599 | 119,958,502 | 206 | 303 | 1 | 76.02 | 15.49 | 6 | 65.07 | 54 | 101 | 54 | 0 | 55 | 33 | 47 | 594,757 | 18.19 | 21 | 92 | 1 | 54 | 

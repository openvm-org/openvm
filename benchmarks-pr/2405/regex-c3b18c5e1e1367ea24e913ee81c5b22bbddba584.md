...
|:---|---:|---:|---:|
| Total |  2.43 |  0.76 | 0.76 |
| regex_program |  2.43 |  0.76 |  0.76 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  598.50 |  2,394 |  720 |  531 |
...
| `execute_preflight_insn_mi/s` |  31.40 | -          |  31.99 |  30.84 |
| `trace_gen_time_ms   ` |  182.50 |  730 |  202 |  173 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  296.25 |  1,185 |  330 |  265 |
| `main_trace_commit_time_ms` |  51.50 |  206 |  57 |  48 |
| `generate_perm_trace_time_ms` |  32.25 |  129 |  46 |  21 |
| `perm_trace_commit_time_ms` |  65.29 |  261.16 |  72.35 |  53.97 |
| `quotient_poly_compute_time_ms` |  60.09 |  240.36 |  69.27 |  54.53 |
| `quotient_poly_commit_time_ms` |  15.84 |  63.35 |  17.91 |  13.76 |
| `pcs_opening_time_ms ` |  68.25 |  273 |  93 |  51 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 608 | 1 | 36 | 4,137,600 | 111.77 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 173 | 720 | 150,778,428 | 173 | 319 | 0 | 61.04 | 17.91 | 5 | 72.35 | 69 | 113 | 69 | 4 | 57 | 40 | 56 | 1,103,000 | 30.84 | 22 | 79 | 1 | 69 | 
| regex_program | 1 | 178 | 531 | 128,513,066 | 178 | 265 | 1 | 55.53 | 16.08 | 4 | 68.07 | 51 | 91 | 51 | 0 | 50 | 22 | 46 | 1,104,000 | 31.40 | 17 | 72 | 0 | 51 | 
| regex_program | 2 | 177 | 535 | 128,513,066 | 177 | 271 | 1 | 54.53 | 15.60 | 4 | 66.77 | 60 | 88 | 59 | 0 | 51 | 21 | 45 | 1,104,000 | 31.99 | 17 | 70 | 0 | 59 | 
| regex_program | 3 | 202 | 608 | 103,473,675 | 202 | 330 | 0 | 69.27 | 13.76 | 5 | 53.97 | 93 | 103 | 93 | 0 | 48 | 46 | 35 | 826,600 | 31.36 | 19 | 84 | 1 | 93 | 

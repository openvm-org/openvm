...
| `total_proof_time_ms ` |  585.25 |  2,341 |  697 |  522 |
| `execute_metered_time_ms` |  35 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  115.67 | -          |  115.67 |  115.67 |
| `execute_preflight_insns` |  1,034,400 |  4,137,600 |  1,104,000 |  826,600 |
| `execute_preflight_time_ms` |  45.25 |  181 |  56 |  34 |
| `execute_preflight_insn_mi/s` |  31.69 | -          |  32.13 |  30.92 |
| `trace_gen_time_ms   ` |  182.50 |  730 |  202 |  173 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  283.25 |  1,133 |  314 |  257 |
| `main_trace_commit_time_ms` |  52 |  208 |  58 |  50 |
| `generate_perm_trace_time_ms` |  28.50 |  114 |  46 |  18 |
| `perm_trace_commit_time_ms` |  64.62 |  258.50 |  71.12 |  54.18 |
| `quotient_poly_compute_time_ms` |  59.48 |  237.91 |  66.16 |  53.41 |
| `quotient_poly_commit_time_ms` |  15.92 |  63.67 |  18.35 |  13.92 |
| `pcs_opening_time_ms ` |  59.25 |  237 |  78 |  50 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 592 | 1 | 35 | 4,137,600 | 115.67 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 173 | 697 | 150,778,428 | 173 | 297 | 0 | 63.22 | 18.35 | 5 | 71.12 | 57 | 98 | 57 | 4 | 58 | 26 | 56 | 1,103,000 | 30.92 | 22 | 82 | 1 | 57 | 
| regex_program | 1 | 177 | 530 | 128,513,066 | 177 | 265 | 1 | 53.41 | 16.19 | 4 | 66.59 | 52 | 91 | 52 | 0 | 50 | 24 | 46 | 1,104,000 | 31.84 | 17 | 70 | 0 | 52 | 
| regex_program | 2 | 178 | 522 | 128,513,066 | 178 | 257 | 1 | 55.11 | 15.21 | 4 | 66.61 | 50 | 85 | 50 | 0 | 50 | 18 | 45 | 1,104,000 | 32.13 | 17 | 70 | 0 | 50 | 
| regex_program | 3 | 202 | 592 | 103,473,675 | 202 | 314 | 0 | 66.16 | 13.92 | 5 | 54.18 | 78 | 103 | 78 | 0 | 50 | 46 | 34 | 826,600 | 31.87 | 19 | 81 | 1 | 78 | 

...
|:---|---:|---:|---:|
| Total |  1.59 |  0.97 | 0.97 |
| pairing |  1.59 |  0.97 |  0.97 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  760 |  1,520 |  898 |  622 |
| `execute_metered_time_ms` |  67 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  25.74 | -          |  25.74 |  25.74 |
| `execute_preflight_insns` |  872,878.50 |  1,745,757 |  1,151,000 |  594,757 |
| `execute_preflight_time_ms` |  85.50 |  171 |  123 |  48 |
| `execute_preflight_insn_mi/s` |  14.50 | -          |  17.97 |  11.03 |
| `trace_gen_time_ms   ` |  181.50 |  363 |  202 |  161 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  387 |  774 |  443 |  331 |
| `main_trace_commit_time_ms` |  65 |  130 |  75 |  55 |
| `generate_perm_trace_time_ms` |  65.50 |  131 |  99 |  32 |
| `perm_trace_commit_time_ms` |  77.21 |  154.42 |  89.10 |  65.32 |
| `quotient_poly_compute_time_ms` |  82.89 |  165.78 |  91.03 |  74.75 |
| `quotient_poly_commit_time_ms` |  17.24 |  34.48 |  19.24 |  15.24 |
| `pcs_opening_time_ms ` |  74.50 |  149 |  84 |  65 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 622 | 1 | 67 | 1,745,757 | 25.74 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 161 | 898 | 172,558,444 | 161 | 443 | 0 | 91.03 | 19.24 | 6 | 89.10 | 65 | 191 | 64 | 1 | 75 | 99 | 123 | 1,151,000 | 11.03 | 26 | 111 | 1 | 64 | 
| pairing | 1 | 202 | 622 | 119,958,502 | 202 | 331 | 1 | 74.75 | 15.24 | 6 | 65.32 | 84 | 100 | 84 | 0 | 55 | 32 | 48 | 594,757 | 17.97 | 21 | 90 | 1 | 84 | 

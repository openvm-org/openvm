...
| `total_proof_time_ms ` |  539 |  1,078 |  623 |  455 |
| `execute_metered_time_ms` |  9 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  164.83 | -          |  164.83 |  164.83 |
| `execute_preflight_insns` |  750,132.50 |  1,500,265 |  873,000 |  627,265 |
| `execute_preflight_time_ms` |  27 |  54 |  32 |  22 |
| `execute_preflight_insn_mi/s` |  38.28 | -          |  38.30 |  38.26 |
| `trace_gen_time_ms   ` |  199.50 |  399 |  202 |  197 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  207 |  414 |  225 |  189 |
| `main_trace_commit_time_ms` |  31 |  62 |  33 |  29 |
| `generate_perm_trace_time_ms` |  21.50 |  43 |  28 |  15 |
| `perm_trace_commit_time_ms` |  42.29 |  84.59 |  45.43 |  39.16 |
| `quotient_poly_compute_time_ms` |  32.69 |  65.38 |  36.98 |  28.40 |
| `quotient_poly_commit_time_ms` |  12.98 |  25.96 |  13.29 |  12.67 |
| `pcs_opening_time_ms ` |  64 |  128 |  78 |  50 |
...
| --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 455 | 1 | 9 | 1,500,265 | 164.83 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 197 | 623 | 84,399,632 | 197 | 225 | 0 | 36.98 | 13.29 | 4 | 45.43 | 78 | 61 | 78 | 0 | 33 | 15 | 32 | 873,000 | 38.26 | 14 | 50 | 0 | 78 | 
| fibonacci_program | 1 | 202 | 455 | 74,305,770 | 202 | 189 | 1 | 28.40 | 12.67 | 4 | 39.16 | 50 | 68 | 50 | 0 | 29 | 28 | 22 | 627,265 | 38.30 | 11 | 41 | 0 | 50 | 

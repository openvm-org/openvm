...
|:---|---:|---:|---:|
| Total |  1.09 |  0.63 | 0.62 |
| fibonacci_program |  1.09 |  0.63 |  0.63 |


| fibonacci_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  539.50 |  1,079 |  616 |  463 |
| `execute_metered_time_ms` |  9 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  164.92 | -          |  164.92 |  164.92 |
| `execute_preflight_insns` |  750,132.50 |  1,500,265 |  873,000 |  627,265 |
| `execute_preflight_time_ms` |  27 |  54 |  32 |  22 |
| `execute_preflight_insn_mi/s` |  37.87 | -          |  38.44 |  37.30 |
| `trace_gen_time_ms   ` |  195 |  390 |  198 |  192 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  212 |  424 |  223 |  201 |
| `main_trace_commit_time_ms` |  31 |  62 |  34 |  28 |
| `generate_perm_trace_time_ms` |  21.50 |  43 |  28 |  15 |
| `perm_trace_commit_time_ms` |  41.81 |  83.61 |  45.41 |  38.20 |
| `quotient_poly_compute_time_ms` |  31.62 |  63.24 |  34.79 |  28.45 |
| `quotient_poly_commit_time_ms` |  13.23 |  26.45 |  13.60 |  12.85 |
| `pcs_opening_time_ms ` |  70.50 |  141 |  78 |  63 |
...
| --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 463 | 1 | 9 | 1,500,265 | 164.92 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 192 | 616 | 84,399,632 | 192 | 223 | 0 | 34.79 | 13.60 | 4 | 45.41 | 78 | 60 | 78 | 0 | 34 | 15 | 32 | 873,000 | 38.44 | 15 | 48 | 0 | 78 | 
| fibonacci_program | 1 | 198 | 463 | 74,305,770 | 198 | 201 | 1 | 28.45 | 12.85 | 4 | 38.20 | 63 | 66 | 63 | 0 | 28 | 28 | 22 | 627,265 | 37.30 | 11 | 41 | 0 | 63 | 

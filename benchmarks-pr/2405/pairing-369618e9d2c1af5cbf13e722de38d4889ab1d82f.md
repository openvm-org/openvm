...
|:---|---:|---:|---:|
| Total |  1.58 |  0.96 | 0.96 |
| pairing |  1.58 |  0.96 |  0.96 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  755 |  1,510 |  894 |  616 |
...
| `execute_preflight_insn_mi/s` |  14.50 | -          |  17.92 |  11.07 |
| `trace_gen_time_ms   ` |  182.50 |  365 |  203 |  162 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  383 |  766 |  442 |  324 |
| `main_trace_commit_time_ms` |  64 |  128 |  74 |  54 |
| `generate_perm_trace_time_ms` |  74.50 |  149 |  98 |  51 |
| `perm_trace_commit_time_ms` |  76 |  152.01 |  88.29 |  63.72 |
| `quotient_poly_compute_time_ms` |  83.39 |  166.78 |  92.79 |  73.98 |
| `quotient_poly_commit_time_ms` |  16.91 |  33.83 |  19.37 |  14.46 |
| `pcs_opening_time_ms ` |  63.50 |  127 |  65 |  62 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 616 | 1 | 69 | 1,745,757 | 24.97 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 162 | 894 | 172,558,444 | 162 | 442 | 0 | 92.79 | 19.37 | 6 | 88.29 | 65 | 189 | 65 | 1 | 74 | 98 | 122 | 1,151,000 | 11.07 | 27 | 113 | 1 | 65 | 
| pairing | 1 | 203 | 616 | 119,958,502 | 203 | 324 | 1 | 73.98 | 14.46 | 6 | 63.72 | 62 | 118 | 62 | 0 | 54 | 51 | 47 | 594,757 | 17.92 | 21 | 89 | 1 | 62 | 

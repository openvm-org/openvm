...
| `total_proof_time_ms ` |  587.75 |  2,351 |  691 |  521 |
| `execute_metered_time_ms` |  37 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  110.32 | -          |  110.32 |  110.32 |
| `execute_preflight_insns` |  1,034,400 |  4,137,600 |  1,104,000 |  826,600 |
| `execute_preflight_time_ms` |  46.50 |  186 |  58 |  35 |
| `execute_preflight_insn_mi/s` |  31.47 | -          |  31.76 |  30.71 |
| `trace_gen_time_ms   ` |  181 |  724 |  201 |  171 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  286 |  1,144 |  330 |  256 |
| `main_trace_commit_time_ms` |  52.25 |  209 |  59 |  50 |
| `generate_perm_trace_time_ms` |  29.75 |  119 |  46 |  18 |
| `perm_trace_commit_time_ms` |  64.16 |  256.63 |  69.35 |  54.07 |
| `quotient_poly_compute_time_ms` |  58.17 |  232.70 |  66.04 |  54.72 |
| `quotient_poly_commit_time_ms` |  15.86 |  63.43 |  17.90 |  14.19 |
| `pcs_opening_time_ms ` |  62.75 |  251 |  94 |  50 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 608 | 1 | 37 | 4,137,600 | 110.32 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 171 | 691 | 150,778,428 | 171 | 291 | 0 | 56.73 | 17.90 | 5 | 69.35 | 55 | 100 | 55 | 4 | 59 | 30 | 58 | 1,103,000 | 30.71 | 22 | 75 | 1 | 55 | 
| regex_program | 1 | 176 | 531 | 128,513,066 | 176 | 267 | 1 | 55.20 | 16.13 | 4 | 66.69 | 52 | 92 | 52 | 0 | 50 | 25 | 47 | 1,104,000 | 31.64 | 17 | 71 | 0 | 52 | 
| regex_program | 2 | 176 | 521 | 128,513,066 | 176 | 256 | 1 | 54.72 | 15.21 | 4 | 66.53 | 50 | 85 | 50 | 0 | 50 | 18 | 46 | 1,104,000 | 31.76 | 16 | 70 | 0 | 50 | 
| regex_program | 3 | 201 | 608 | 103,473,675 | 201 | 330 | 0 | 66.04 | 14.19 | 5 | 54.07 | 94 | 103 | 94 | 0 | 50 | 46 | 35 | 826,600 | 31.76 | 19 | 81 | 1 | 94 | 

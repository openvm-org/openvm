...
| `total_proof_time_ms ` |  746.50 |  1,493 |  845 |  648 |
| `execute_metered_time_ms` |  67 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  25.94 | -          |  25.94 |  25.94 |
| `execute_preflight_insns` |  872,878.50 |  1,745,757 |  1,151,000 |  594,757 |
| `execute_preflight_time_ms` |  85.50 |  171 |  123 |  48 |
| `execute_preflight_insn_mi/s` |  14.53 | -          |  17.97 |  11.10 |
| `trace_gen_time_ms   ` |  184 |  368 |  205 |  163 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  370.50 |  741 |  388 |  353 |
| `main_trace_commit_time_ms` |  65.50 |  131 |  75 |  56 |
| `generate_perm_trace_time_ms` |  44 |  88 |  51 |  37 |
| `perm_trace_commit_time_ms` |  77.58 |  155.16 |  89.29 |  65.87 |
| `quotient_poly_compute_time_ms` |  84.45 |  168.91 |  93.55 |  75.36 |
| `quotient_poly_commit_time_ms` |  17.20 |  34.41 |  18.87 |  15.53 |
| `pcs_opening_time_ms ` |  77 |  154 |  84 |  70 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 648 | 1 | 67 | 1,745,757 | 25.94 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 163 | 845 | 172,558,444 | 163 | 388 | 0 | 93.55 | 18.87 | 7 | 89.29 | 70 | 129 | 69 | 1 | 75 | 37 | 123 | 1,151,000 | 11.10 | 27 | 113 | 1 | 69 | 
| pairing | 1 | 205 | 648 | 119,958,502 | 205 | 353 | 1 | 75.36 | 15.53 | 6 | 65.87 | 84 | 120 | 84 | 0 | 56 | 51 | 48 | 594,757 | 17.97 | 21 | 91 | 1 | 84 | 

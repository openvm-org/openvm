...
| `total_proof_time_ms ` |  529.50 |  1,059 |  598 |  461 |
| `execute_metered_time_ms` |  9 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  162.75 | -          |  162.75 |  162.75 |
| `execute_preflight_insns` |  750,132.50 |  1,500,265 |  873,000 |  627,265 |
| `execute_preflight_time_ms` |  26.50 |  53 |  32 |  21 |
| `execute_preflight_insn_mi/s` |  38.67 | -          |  38.98 |  38.35 |
| `trace_gen_time_ms   ` |  194.50 |  389 |  198 |  191 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  201.50 |  403 |  203 |  200 |
| `main_trace_commit_time_ms` |  30.50 |  61 |  33 |  28 |
| `generate_perm_trace_time_ms` |  21 |  42 |  27 |  15 |
| `perm_trace_commit_time_ms` |  41.18 |  82.36 |  44.69 |  37.67 |
| `quotient_poly_compute_time_ms` |  31.50 |  62.100 |  33.97 |  29.03 |
| `quotient_poly_commit_time_ms` |  12.64 |  25.27 |  12.68 |  12.60 |
| `pcs_opening_time_ms ` |  63 |  126 |  63 |  63 |
...
| --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 461 | 1 | 9 | 1,500,265 | 162.75 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 191 | 598 | 84,399,632 | 191 | 203 | 0 | 33.97 | 12.60 | 4 | 44.69 | 63 | 60 | 62 | 0 | 33 | 15 | 32 | 873,000 | 38.35 | 14 | 47 | 0 | 62 | 
| fibonacci_program | 1 | 198 | 461 | 74,305,770 | 198 | 200 | 1 | 29.03 | 12.68 | 4 | 37.67 | 63 | 65 | 63 | 0 | 28 | 27 | 21 | 627,265 | 38.98 | 11 | 42 | 0 | 63 | 

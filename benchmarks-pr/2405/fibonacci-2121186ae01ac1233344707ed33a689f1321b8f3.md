...
|:---|---:|---:|---:|
| Total |  1.10 |  0.62 | 0.62 |
| fibonacci_program |  1.10 |  0.62 |  0.62 |


| fibonacci_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  545 |  1,090 |  614 |  476 |
| `execute_metered_time_ms` |  9 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  153.78 | -          |  153.78 |  153.78 |
| `execute_preflight_insns` |  750,132.50 |  1,500,265 |  873,000 |  627,265 |
| `execute_preflight_time_ms` |  26.50 |  53 |  32 |  21 |
| `execute_preflight_insn_mi/s` |  38.56 | -          |  38.58 |  38.53 |
| `trace_gen_time_ms   ` |  195 |  390 |  199 |  191 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  216.50 |  433 |  222 |  211 |
| `main_trace_commit_time_ms` |  30.50 |  61 |  33 |  28 |
| `generate_perm_trace_time_ms` |  21 |  42 |  28 |  14 |
| `perm_trace_commit_time_ms` |  41.81 |  83.61 |  45.39 |  38.22 |
| `quotient_poly_compute_time_ms` |  32.49 |  64.97 |  34.10 |  30.87 |
| `quotient_poly_commit_time_ms` |  12.86 |  25.71 |  13.59 |  12.12 |
| `pcs_opening_time_ms ` |  75 |  150 |  79 |  71 |
...
| --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 476 | 1 | 9 | 1,500,265 | 153.78 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 191 | 614 | 84,399,632 | 191 | 222 | 0 | 34.10 | 13.59 | 4 | 45.39 | 79 | 60 | 79 | 0 | 33 | 14 | 32 | 873,000 | 38.53 | 15 | 48 | 0 | 79 | 
| fibonacci_program | 1 | 199 | 476 | 74,305,770 | 199 | 211 | 1 | 30.87 | 12.12 | 4 | 38.22 | 71 | 67 | 71 | 0 | 28 | 28 | 21 | 627,265 | 38.58 | 11 | 43 | 0 | 71 | 

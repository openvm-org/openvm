...
|:---|---:|---:|---:|
| Total |  2.37 |  0.72 | 0.72 |
| regex_program |  2.37 |  0.72 |  0.72 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  582.25 |  2,329 |  683 |  520 |
| `execute_metered_time_ms` |  36 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  113.67 | -          |  113.67 |  113.67 |
| `execute_preflight_insns` |  1,034,400 |  4,137,600 |  1,104,000 |  826,600 |
| `execute_preflight_time_ms` |  46 |  184 |  57 |  35 |
| `execute_preflight_insn_mi/s` |  30.94 | -          |  31.36 |  30.23 |
| `trace_gen_time_ms   ` |  178.25 |  713 |  197 |  169 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  284.25 |  1,137 |  324 |  259 |
| `main_trace_commit_time_ms` |  50.25 |  201 |  55 |  48 |
| `generate_perm_trace_time_ms` |  28.50 |  114 |  46 |  21 |
| `perm_trace_commit_time_ms` |  62.86 |  251.46 |  69.38 |  51.82 |
| `quotient_poly_compute_time_ms` |  58.49 |  233.98 |  66.79 |  52.07 |
| `quotient_poly_commit_time_ms` |  15.60 |  62.40 |  18.07 |  13.25 |
| `pcs_opening_time_ms ` |  65.50 |  262 |  93 |  51 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 598 | 1 | 36 | 4,137,600 | 113.67 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 169 | 683 | 150,778,428 | 169 | 287 | 0 | 62.16 | 18.07 | 5 | 69.38 | 57 | 93 | 57 | 4 | 55 | 23 | 57 | 1,103,000 | 30.23 | 22 | 80 | 1 | 57 | 
| regex_program | 1 | 173 | 520 | 128,513,066 | 173 | 259 | 1 | 52.07 | 15.58 | 4 | 64.95 | 51 | 90 | 51 | 0 | 49 | 24 | 46 | 1,104,000 | 31.27 | 17 | 68 | 0 | 51 | 
| regex_program | 2 | 174 | 528 | 128,513,066 | 174 | 267 | 1 | 52.96 | 15.51 | 4 | 65.30 | 61 | 87 | 60 | 0 | 49 | 21 | 46 | 1,104,000 | 31.36 | 17 | 69 | 0 | 60 | 
| regex_program | 3 | 197 | 598 | 103,473,675 | 197 | 324 | 0 | 66.79 | 13.25 | 5 | 51.82 | 93 | 101 | 93 | 0 | 48 | 46 | 35 | 826,600 | 30.91 | 18 | 81 | 1 | 93 | 

...
| `total_proof_time_ms ` |  522 |  1,044 |  586 |  458 |
| `execute_metered_time_ms` |  9 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  165.100 | -          |  165.100 |  165.100 |
| `execute_preflight_insns` |  750,132.50 |  1,500,265 |  873,000 |  627,265 |
| `execute_preflight_time_ms` |  31 |  62 |  37 |  25 |
| `execute_preflight_insn_mi/s` |  31.09 | -          |  31.36 |  30.82 |
| `trace_gen_time_ms   ` |  192.50 |  385 |  197 |  188 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  192.50 |  385 |  194 |  191 |
| `main_trace_commit_time_ms` |  30.50 |  61 |  33 |  28 |
| `generate_perm_trace_time_ms` |  21 |  42 |  28 |  14 |
| `perm_trace_commit_time_ms` |  41.67 |  83.34 |  45.18 |  38.17 |
| `quotient_poly_compute_time_ms` |  31.81 |  63.62 |  35.27 |  28.35 |
| `quotient_poly_commit_time_ms` |  12.99 |  25.98 |  13.31 |  12.67 |
| `pcs_opening_time_ms ` |  52 |  104 |  56 |  48 |
...
| --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 458 | 1 | 9 | 1,500,265 | 165.100 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 188 | 586 | 84,399,632 | 187 | 191 | 0 | 35.27 | 13.31 | 4 | 45.18 | 48 | 60 | 48 | 0 | 33 | 14 | 37 | 873,000 | 30.82 | 15 | 49 | 0 | 48 | 
| fibonacci_program | 1 | 197 | 458 | 74,305,770 | 197 | 194 | 1 | 28.35 | 12.67 | 4 | 38.17 | 56 | 67 | 56 | 0 | 28 | 28 | 25 | 627,265 | 31.36 | 11 | 41 | 0 | 56 | 

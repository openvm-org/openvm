...
|:---|---:|---:|---:|
| Total |  1.56 |  0.96 | 0.96 |
| pairing |  1.56 |  0.96 |  0.96 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  749 |  1,498 |  888 |  610 |
...
| `execute_preflight_time_ms` |  84.50 |  169 |  121 |  48 |
| `execute_preflight_insn_mi/s` |  14.57 | -          |  18.02 |  11.12 |
| `trace_gen_time_ms   ` |  180.50 |  361 |  200 |  161 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  378 |  756 |  435 |  321 |
| `main_trace_commit_time_ms` |  64.50 |  129 |  74 |  55 |
| `generate_perm_trace_time_ms` |  69.50 |  139 |  88 |  51 |
| `perm_trace_commit_time_ms` |  76.66 |  153.32 |  88.55 |  64.76 |
| `quotient_poly_compute_time_ms` |  82.89 |  165.78 |  91.95 |  73.83 |
| `quotient_poly_commit_time_ms` |  17.67 |  35.35 |  19.81 |  15.54 |
| `pcs_opening_time_ms ` |  62.50 |  125 |  69 |  56 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 610 | 1 | 67 | 1,745,757 | 25.83 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 161 | 888 | 172,558,444 | 161 | 435 | 0 | 91.95 | 19.81 | 6 | 88.55 | 69 | 179 | 69 | 1 | 74 | 88 | 121 | 1,151,000 | 11.12 | 27 | 112 | 1 | 69 | 
| pairing | 1 | 200 | 610 | 119,958,502 | 200 | 321 | 1 | 73.83 | 15.54 | 5 | 64.76 | 56 | 118 | 56 | 0 | 55 | 51 | 48 | 594,757 | 18.02 | 21 | 89 | 1 | 56 | 

...
| `total_proof_time_ms ` |  3,802 |  7,604 |  4,872 |  2,732 |
...
| `execute_metered_insn_mi/s` |  127.65 | -          |  127.65 |  127.65 |
| `execute_preflight_insns` |  2,054,298.50 |  4,108,597 |  2,211,000 |  1,897,597 |
| `execute_preflight_time_ms` |  93 |  186 |  100 |  86 |
| `execute_preflight_insn_mi/s` |  28.61 | -          |  30.95 |  26.26 |
| `trace_gen_time_ms   ` |  391.50 |  783 |  504 |  279 |
| `memory_finalize_time_ms` |  7.50 |  15 |  13 |  2 |
| `stark_prove_excluding_trace_time_ms` |  3,083 |  6,166 |  4,023 |  2,143 |
| `main_trace_commit_time_ms` |  615.50 |  1,231 |  835 |  396 |
| `generate_perm_trace_time_ms` |  229.50 |  459 |  306 |  153 |
| `perm_trace_commit_time_ms` |  648 |  1,296 |  848 |  448 |
| `quotient_poly_compute_time_ms` |  316.50 |  633 |  427 |  206 |
| `quotient_poly_commit_time_ms` |  297 |  594 |  389 |  205 |
| `pcs_opening_time_ms ` |  969 |  1,938 |  1,213 |  725 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 1 | 2,732 | 6 | 1 | 32 | 4,108,597 | 127.65 | 45 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 504 | 4,872 | 211,758,557 | 373,183,036 | 504 | 4,023 | 0 | 427 | 389 | 848 | 1,213 | 7 | 13 | 835 | 91,281,687 | 306 | 100 | 2,211,000 | 26.26 | 
| regex_program | 1 | 279 | 2,732 | 174,326,267 | 196,838,026 | 279 | 2,143 | 52 | 206 | 205 | 448 | 725 | 6 | 2 | 396 | 73,453,305 | 153 | 86 | 1,897,597 | 30.95 | 

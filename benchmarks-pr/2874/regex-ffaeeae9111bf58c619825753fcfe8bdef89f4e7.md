...
|:---|---:|---:|---:|
| Total |  2.57 |  1.88 |  1.88 |
| app_proof |  1.54 |  0.85 |  0.85 |
| leaf |  0.43 |  0.43 |  0.43 |
...
| `total_proof_time_ms ` |  752 |  1,504 |  814 |  690 |
| `execute_metered_time_ms` |  33 | -          | -          | -          |
| `execute_metered_insns` |  4,137,067 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  125.04 | -          |  125.04 |  125.04 |
| `execute_preflight_insns` |  2,068,533.50 |  4,137,067 |  2,208,000 |  1,929,067 |
| `execute_preflight_time_ms` |  75.50 |  151 |  80 |  71 |
| `execute_preflight_insn_mi/s` |  39.04 | -          |  39.04 |  39.03 |
| `trace_gen_time_ms   ` |  148.50 |  297 |  150 |  147 |
| `memory_finalize_time_ms` |  1.50 |  3 |  3 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  426.50 |  853 |  428 |  425 |
| `prover.main_trace_commit_time_ms` |  94 |  188 |  100 |  88 |
| `prover.rap_constraints_time_ms` |  236 |  472 |  247 |  225 |
| `prover.openings_time_ms` |  95 |  190 |  99 |  91 |
| `prover.rap_constraints.logup_gkr_time_ms` |  138.50 |  277 |  141 |  136 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/ffaeeae9111bf58c619825753fcfe8bdef89f4e7/regex-ffaeeae9111bf58c619825753fcfe8bdef89f4e7.memory.svg)
...
| app_proof |  |  |  |  |  | 690 |  |  | 33 | 4,137,067 | 125.04 | 0 | 1,551 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 27,256,635 | 258 | 82 | 0 | 0 | 96 | 31 | 31 | 45 | 19 | 0 | 79 | 68 | 11 | 2 | 8 | 82 | 96 | 0 | 3 | 18 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,767 | 169 | 47 | 0 | 0 | 68 | 26 | 25 | 27 | 14 | 0 | 53 | 44 | 8 | 1 | 6 | 47 | 68 | 0 | 3 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 136 | 31 | 0 | 0 | 61 | 23 | 22 | 24 | 13 | 0 | 43 | 36 | 7 | 1 | 5 | 32 | 61 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 79,959,796 | 380 | 127 | 0 | 0 | 136 | 55 | 54 | 37 | 43 | 0 | 116 | 101 | 15 | 6 | 8 | 127 | 136 | 0 | 6 | 41 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 123,384,338 | 425 | 99 | 0 | 0 | 225 | 54 | 54 | 29 | 141 | 0 | 99 | 80 | 19 | 10 | 8 | 100 | 225 | 0 | 3 | 138 | 0 | 0 | 
| app_proof | prover | 1 | 106,568,591 | 428 | 88 | 0 | 0 | 247 | 85 | 85 | 25 | 136 | 0 | 91 | 73 | 18 | 8 | 9 | 88 | 247 | 0 | 3 | 134 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 147 | 814 | 147 | 161 | 2,052,973,566 | 668,936,290 | 2,721,909,856 | 2,097,152 | 3 | 7 | 80 | 2,208,000 | 39.04 | 
| app_proof | 1 | 150 | 690 | 150 | 41 | 1,584,899,101 | 646,500,736 | 2,231,399,837 | 2,097,152 | 0 | 2 | 71 | 1,929,067 | 39.03 | 

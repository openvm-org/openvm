...
|:---|---:|---:|---:|
| Total |  5.52 |  3.87 |  3.87 |
| app_proof |  3.96 |  2.32 |  2.32 |
| leaf |  0.98 |  0.98 |  0.98 |
...
| `total_proof_time_ms ` |  1,964 |  3,928 |  2,281 |  1,647 |
| `execute_metered_time_ms` |  35 | -          | -          | -          |
| `execute_metered_insns` |  2,579,903 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  73.47 | -          |  73.47 |  73.47 |
| `execute_preflight_insns` |  1,289,951.50 |  2,579,903 |  1,540,000 |  1,039,903 |
| `execute_preflight_time_ms` |  100.50 |  201 |  137 |  64 |
| `execute_preflight_insn_mi/s` |  35.37 | -          |  36.38 |  34.36 |
| `trace_gen_time_ms   ` |  144.50 |  289 |  191 |  98 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,607.50 |  3,215 |  1,846 |  1,369 |
| `prover.main_trace_commit_time_ms` |  521 |  1,042 |  605 |  437 |
| `prover.rap_constraints_time_ms` |  954.50 |  1,909 |  1,102 |  807 |
| `prover.openings_time_ms` |  131.50 |  263 |  139 |  124 |
| `prover.rap_constraints.logup_gkr_time_ms` |  170 |  340 |  201 |  139 |
| `prover.rap_constraints.round0_time_ms` |  576 |  1,152 |  682 |  470 |
| `prover.rap_constraints.mle_rounds_time_ms` |  206.50 |  413 |  217 |  196 |
| `prover.openings.stacked_reduction_time_ms` |  95.50 |  191 |  103 |  88 |
| `prover.openings.stacked_reduction.round0_time_ms` |  50.50 |  101 |  51 |  50 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  44 |  88 |  51 |  37 |
| `prover.openings.whir_time_ms` |  35 |  70 |  35 |  35 |
...
| `prover.rap_constraints_time_ms` |  361 |  361 |  361 |  361 |
| `prover.openings_time_ms` |  81 |  81 |  81 |  81 |
| `prover.rap_constraints.logup_gkr_time_ms` |  141 |  141 |  141 |  141 |
| `prover.rap_constraints.round0_time_ms` |  139 |  139 |  139 |  139 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/f0801fc819ed0ea388234dccaa2757099b25ef2f/kitchen_sink-f0801fc819ed0ea388234dccaa2757099b25ef2f.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 73 | 9 |  |  | 0 |  | 382 | 9 |  |  |  |  |  |  | 
| app_proof |  |  |  |  |  | 1,647 |  |  | 35 | 2,579,903 | 73.47 | 0 | 3,968 |  | 
| internal_for_leaf |  |  |  | 288 |  |  |  |  |  |  |  |  |  | 288 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 22 | 288 | 21 | 6 | 1 | 2 | 2 | 2 | 
| internal_recursive.0 | 1 | 11 | 157 | 11 | 1 | 0 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 9 | 136 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 123 | 975 | 122 | 23 | 9 | 21 | 5 | 5 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,577,979 | 266 | 119 | 0 | 0 | 110 | 37 | 36 | 52 | 20 | 0 | 35 | 21 | 13 | 3 | 9 | 119 | 110 | 0 | 2 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,767 | 145 | 47 | 0 | 0 | 68 | 25 | 25 | 29 | 13 | 0 | 28 | 20 | 8 | 1 | 6 | 48 | 68 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 126 | 31 | 0 | 0 | 65 | 26 | 25 | 25 | 14 | 0 | 28 | 21 | 7 | 1 | 5 | 32 | 65 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 265,003,892 | 852 | 409 | 0 | 1 | 361 | 139 | 138 | 80 | 141 | 0 | 81 | 39 | 41 | 22 | 19 | 409 | 361 | 0 | 7 | 138 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 567,917,156 | 1,846 | 604 | 0 | 189 | 1,102 | 682 | 681 | 217 | 201 | 58 | 139 | 35 | 103 | 51 | 51 | 605 | 1,102 | 0 | 3 | 141 | 0 | 0 | 
| app_proof | prover | 1 | 537,266,124 | 1,369 | 437 | 0 | 1 | 807 | 470 | 470 | 196 | 139 | 0 | 124 | 35 | 88 | 50 | 37 | 437 | 807 | 0 | 3 | 138 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 191 | 2,281 | 191 | 179 | 0 | 4 | 64 | 1,540,000 | 34.36 | 
| app_proof | 1 | 98 | 1,647 | 98 | 41 | 0 | 2 | 137 | 1,039,903 | 36.38 | 

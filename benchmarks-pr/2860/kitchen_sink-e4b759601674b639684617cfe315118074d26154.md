...
| `total_proof_time_ms ` |  1,933 |  3,866 |  2,251 |  1,615 |
| `execute_metered_time_ms` |  34 | -          | -          | -          |
| `execute_metered_insns` |  2,579,903 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  74.27 | -          |  74.27 |  74.27 |
| `execute_preflight_insns` |  1,289,951.50 |  2,579,903 |  1,540,000 |  1,039,903 |
| `execute_preflight_time_ms` |  100 |  200 |  137 |  63 |
| `execute_preflight_insn_mi/s` |  35.24 | -          |  36.09 |  34.39 |
| `trace_gen_time_ms   ` |  140.50 |  281 |  187 |  94 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,581.50 |  3,163 |  1,821 |  1,342 |
| `prover.main_trace_commit_time_ms` |  515 |  1,030 |  601 |  429 |
| `prover.rap_constraints_time_ms` |  937 |  1,874 |  1,084 |  790 |
| `prover.openings_time_ms` |  128.50 |  257 |  135 |  122 |
| `prover.rap_constraints.logup_gkr_time_ms` |  169 |  338 |  201 |  137 |
| `prover.rap_constraints.round0_time_ms` |  565.50 |  1,131 |  670 |  461 |
| `prover.rap_constraints.mle_rounds_time_ms` |  202.50 |  405 |  213 |  192 |
| `prover.openings.stacked_reduction_time_ms` |  93 |  186 |  100 |  86 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/e4b759601674b639684617cfe315118074d26154/kitchen_sink-e4b759601674b639684617cfe315118074d26154.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 83 | 9 |  |  | 0 |  | 407 | 9 |  |  |  |  |  |  | 
| app_proof |  |  |  |  |  | 1,615 |  |  | 34 | 2,579,903 | 74.27 | 0 | 3,906 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,577,979 | 264 | 116 | 0 | 0 | 108 | 36 | 35 | 51 | 20 | 0 | 39 | 25 | 13 | 3 | 9 | 117 | 108 | 0 | 2 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,767 | 143 | 46 | 0 | 0 | 67 | 25 | 24 | 28 | 13 | 0 | 28 | 20 | 8 | 1 | 6 | 47 | 67 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 121 | 31 | 0 | 0 | 64 | 25 | 24 | 24 | 14 | 0 | 25 | 18 | 7 | 1 | 5 | 31 | 64 | 0 | 3 | 12 | 0 | 0 | 
| leaf | 0 | prover | 265,003,892 | 833 | 401 | 0 | 1 | 354 | 135 | 134 | 79 | 139 | 0 | 76 | 35 | 40 | 21 | 18 | 402 | 354 | 0 | 6 | 137 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 567,917,156 | 1,821 | 600 | 0 | 190 | 1,084 | 670 | 669 | 213 | 201 | 58 | 135 | 35 | 100 | 49 | 50 | 601 | 1,084 | 0 | 3 | 141 | 0 | 0 | 
| app_proof | prover | 1 | 537,266,124 | 1,342 | 429 | 0 | 1 | 790 | 461 | 460 | 192 | 137 | 0 | 122 | 36 | 86 | 48 | 37 | 429 | 790 | 0 | 4 | 136 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 187 | 2,251 | 186 | 178 | 0 | 4 | 63 | 1,540,000 | 34.39 | 
| app_proof | 1 | 94 | 1,615 | 94 | 41 | 0 | 2 | 137 | 1,039,903 | 36.09 | 

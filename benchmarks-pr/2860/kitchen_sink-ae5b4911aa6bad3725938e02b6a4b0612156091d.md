...
| `total_proof_time_ms ` |  1,912.50 |  3,825 |  2,229 |  1,596 |
...
| `execute_preflight_insn_mi/s` |  35.39 | -          |  36.28 |  34.49 |
| `trace_gen_time_ms   ` |  139.50 |  279 |  183 |  96 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,564 |  3,128 |  1,802 |  1,326 |
| `prover.main_trace_commit_time_ms` |  508.50 |  1,017 |  593 |  424 |
| `prover.rap_constraints_time_ms` |  928 |  1,856 |  1,075 |  781 |
| `prover.openings_time_ms` |  127 |  254 |  134 |  120 |
| `prover.rap_constraints.logup_gkr_time_ms` |  167 |  334 |  198 |  136 |
| `prover.rap_constraints.round0_time_ms` |  560 |  1,120 |  665 |  455 |
| `prover.rap_constraints.mle_rounds_time_ms` |  199.50 |  399 |  211 |  188 |
| `prover.openings.stacked_reduction_time_ms` |  92 |  184 |  100 |  84 |
| `prover.openings.stacked_reduction.round0_time_ms` |  49 |  98 |  50 |  48 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  42.50 |  85 |  50 |  35 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/ae5b4911aa6bad3725938e02b6a4b0612156091d/kitchen_sink-ae5b4911aa6bad3725938e02b6a4b0612156091d.memory.svg)
...
| app_proof |  |  |  |  |  | 1,596 |  |  | 34 | 2,579,903 | 73.76 | 0 | 3,865 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 20 | 275 | 20 | 6 | 1 | 2 | 2 | 2 | 
| internal_recursive.0 | 1 | 10 | 159 | 10 | 1 | 0 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 9 | 130 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 122 | 944 | 122 | 23 | 9 | 21 | 5 | 5 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,577,979 | 254 | 115 | 0 | 0 | 107 | 35 | 34 | 51 | 20 | 0 | 31 | 17 | 13 | 3 | 9 | 116 | 107 | 0 | 2 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,767 | 149 | 44 | 0 | 0 | 67 | 24 | 24 | 28 | 13 | 0 | 36 | 28 | 8 | 1 | 6 | 45 | 67 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 121 | 31 | 0 | 0 | 62 | 24 | 23 | 24 | 14 | 0 | 26 | 19 | 7 | 1 | 5 | 32 | 62 | 0 | 2 | 13 | 0 | 0 | 
| leaf | 0 | prover | 265,003,892 | 822 | 398 | 0 | 1 | 349 | 133 | 132 | 78 | 137 | 0 | 74 | 33 | 40 | 21 | 18 | 398 | 349 | 0 | 6 | 136 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 567,917,156 | 1,802 | 592 | 0 | 186 | 1,075 | 665 | 664 | 211 | 198 | 55 | 134 | 33 | 100 | 50 | 50 | 593 | 1,075 | 0 | 3 | 141 | 0 | 0 | 
| app_proof | prover | 1 | 537,266,124 | 1,326 | 424 | 0 | 1 | 781 | 455 | 455 | 188 | 136 | 0 | 120 | 35 | 84 | 48 | 35 | 424 | 781 | 0 | 4 | 135 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 183 | 2,229 | 183 | 178 | 0 | 4 | 63 | 1,540,000 | 34.49 | 
| app_proof | 1 | 96 | 1,596 | 96 | 41 | 0 | 2 | 131 | 1,039,903 | 36.28 | 

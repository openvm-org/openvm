...
|:---|---:|---:|
| Total | <span style='color: green'>(-0 [-3.1%])</span> 1.50 | <span style='color: green'>(-0 [-1.7%])</span> 0.91 |
| pairing | <span style='color: green'>(-0 [-3.4%])</span> 1.41 | <span style='color: green'>(-0 [-2.0%])</span> 0.82 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: green'>(-24 [-3.4%])</span> 706 | <span style='color: green'>(-49 [-3.4%])</span> 1,412 | <span style='color: green'>(-17 [-2.0%])</span> 819 | <span style='color: green'>(-32 [-5.1%])</span> 593 |
...
| `execute_metered_insn_mi/s` | <span style='color: green'>(-0 [-1.2%])</span> 19.30 | -          | <span style='color: green'>(-0 [-1.2%])</span> 19.30 | <span style='color: green'>(-0 [-1.2%])</span> 19.30 |
...
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+0 [+0.9%])</span> 13.75 | -          | <span style='color: red'>(+0 [+1.2%])</span> 18.34 | <span style='color: red'>(+0 [+0.4%])</span> 9.16 |
| `trace_gen_time_ms   ` | <span style='color: green'>(-2 [-1.4%])</span> 175 | <span style='color: green'>(-5 [-1.4%])</span> 350 | <span style='color: green'>(-4 [-2.1%])</span> 190 | <span style='color: green'>(-1 [-0.6%])</span> 160 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: green'>(-23 [-6.3%])</span> 340 | <span style='color: green'>(-46 [-6.3%])</span> 680 | <span style='color: green'>(-17 [-4.3%])</span> 380 | <span style='color: green'>(-29 [-8.8%])</span> 300 |
...
| `perm_trace_commit_time_ms` | <span style='color: green'>(-1 [-0.9%])</span> 75.78 | <span style='color: green'>(-1 [-0.9%])</span> 151.56 | <span style='color: green'>(-1 [-0.6%])</span> 88.23 | <span style='color: green'>(-1 [-1.3%])</span> 63.33 |
| `quotient_poly_compute_time_ms` | <span style='color: green'>(-0 [-0.4%])</span> 78.67 | <span style='color: green'>(-1 [-0.4%])</span> 157.34 | <span style='color: green'>(-1 [-1.6%])</span> 85.87 | <span style='color: red'>(+1 [+1.0%])</span> 71.47 |
| `quotient_poly_commit_time_ms` | <span style='color: green'>(-1 [-5.1%])</span> 15.70 | <span style='color: green'>(-2 [-5.1%])</span> 31.40 | <span style='color: green'>(-2 [-9.8%])</span> 16.86 | <span style='color: red'>(+0 [+0.9%])</span> 14.54 |
| `pcs_opening_time_ms ` | <span style='color: green'>(-13 [-17.1%])</span> 63 | <span style='color: green'>(-26 [-17.1%])</span> 126 | <span style='color: green'>(-7 [-9.2%])</span> 69 | <span style='color: green'>(-19 [-25.0%])</span> 57 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 593 | 41 | 1 | 90 | 1,745,742 | 19.30 | 147 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 160 | 819 | 32,689,110 | 172,558,444 | 160 | 380 | 0 | 85.87 | 16.86 | 6 | 88.23 | 69 | 134 | 68 | 1 | 73 | 16,059,916 | 42 | 130 | 1,157,000 | 9.16 | 26 | 103 | 1 | 68 | 
| pairing | 1 | 190 | 593 | 22,314,288 | 119,958,502 | 190 | 300 | 1 | 71.47 | 14.54 | 6 | 63.33 | 57 | 102 | 57 | 0 | 53 | 9,408,294 | 36 | 62 | 588,742 | 18.34 | 20 | 86 | 1 | 57 | 

...
|:---|---:|---:|
| Total | <span style='color: green'>(-0 [-3.7%])</span> 1.49 | <span style='color: green'>(-0 [-3.1%])</span> 0.90 |
| pairing | <span style='color: green'>(-0 [-3.9%])</span> 1.40 | <span style='color: green'>(-0 [-3.5%])</span> 0.81 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: green'>(-28 [-3.9%])</span> 702 | <span style='color: green'>(-57 [-3.9%])</span> 1,404 | <span style='color: green'>(-29 [-3.5%])</span> 807 | <span style='color: green'>(-28 [-4.5%])</span> 597 |
...
| `execute_metered_insn_mi/s` | <span style='color: green'>(-0 [-0.6%])</span> 19.42 | -          | <span style='color: green'>(-0 [-0.6%])</span> 19.42 | <span style='color: green'>(-0 [-0.6%])</span> 19.42 |
| `execute_preflight_insns` |  872,871 |  1,745,742 |  1,157,000 |  588,742 |
| `execute_preflight_time_ms` | <span style='color: red'>(+2 [+1.6%])</span> 96.50 | <span style='color: red'>(+3 [+1.6%])</span> 193 | <span style='color: red'>(+1 [+0.8%])</span> 131 | <span style='color: red'>(+2 [+3.3%])</span> 62 |
| `execute_preflight_insn_mi/s` | <span style='color: green'>(-0 [-0.9%])</span> 13.50 | -          | <span style='color: green'>(-0 [-1.1%])</span> 17.93 | <span style='color: green'>(-0 [-0.6%])</span> 9.06 |
| `trace_gen_time_ms   ` | <span style='color: green'>(-6 [-3.1%])</span> 172 | <span style='color: green'>(-11 [-3.1%])</span> 344 | <span style='color: green'>(-5 [-2.6%])</span> 189 | <span style='color: green'>(-6 [-3.7%])</span> 155 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: green'>(-24 [-6.6%])</span> 339 | <span style='color: green'>(-48 [-6.6%])</span> 678 | <span style='color: green'>(-23 [-5.8%])</span> 374 | <span style='color: green'>(-25 [-7.6%])</span> 304 |
| `main_trace_commit_time_ms` | <span style='color: green'>(-1 [-1.6%])</span> 63 | <span style='color: green'>(-2 [-1.6%])</span> 126 | <span style='color: green'>(-1 [-1.4%])</span> 73 | <span style='color: green'>(-1 [-1.9%])</span> 53 |
| `generate_perm_trace_time_ms` | <span style='color: green'>(-11 [-23.9%])</span> 35 | <span style='color: green'>(-22 [-23.9%])</span> 70 | <span style='color: green'>(-10 [-21.3%])</span> 37 | <span style='color: green'>(-12 [-26.7%])</span> 33 |
| `perm_trace_commit_time_ms` | <span style='color: green'>(-2 [-2.2%])</span> 74.79 | <span style='color: green'>(-3 [-2.2%])</span> 149.58 | <span style='color: green'>(-2 [-2.5%])</span> 86.55 | <span style='color: green'>(-1 [-1.8%])</span> 63.03 |
| `quotient_poly_compute_time_ms` | <span style='color: green'>(-1 [-1.4%])</span> 77.90 | <span style='color: green'>(-2 [-1.4%])</span> 155.81 | <span style='color: green'>(-1 [-1.7%])</span> 85.81 | <span style='color: green'>(-1 [-1.1%])</span> 69.100 |
| `quotient_poly_commit_time_ms` | <span style='color: green'>(-1 [-4.0%])</span> 15.88 | <span style='color: green'>(-1 [-4.0%])</span> 31.77 | <span style='color: green'>(-1 [-3.3%])</span> 18.07 | <span style='color: green'>(-1 [-4.9%])</span> 13.70 |
| `pcs_opening_time_ms ` | <span style='color: green'>(-8 [-11.2%])</span> 67.50 | <span style='color: green'>(-17 [-11.2%])</span> 135 | <span style='color: green'>(-4 [-5.3%])</span> 72 | <span style='color: green'>(-13 [-17.1%])</span> 63 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 597 | 40 | 1 | 89 | 1,745,742 | 19.42 | 148 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 155 | 807 | 32,689,110 | 172,558,444 | 155 | 374 | 0 | 85.81 | 18.07 | 6 | 86.55 | 72 | 122 | 72 | 1 | 73 | 16,059,916 | 33 | 131 | 1,157,000 | 9.06 | 26 | 104 | 1 | 72 | 
| pairing | 1 | 189 | 597 | 22,314,288 | 119,958,502 | 189 | 304 | 1 | 69.100 | 13.70 | 6 | 63.03 | 63 | 103 | 63 | 0 | 53 | 9,408,294 | 37 | 62 | 588,742 | 17.93 | 20 | 84 | 1 | 63 | 

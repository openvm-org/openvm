...
|:---|---:|---:|---:|
| Total | <span style='color: red'>(+0 [+11.3%])</span> 2.86 | <span style='color: red'>(+0 [+12.5%])</span> 1.50 | 1.50 |
| pairing | <span style='color: red'>(+0 [+11.3%])</span> 2.86 | <span style='color: red'>(+0 [+12.5%])</span> 1.50 |  1.50 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+144 [+11.5%])</span> 1,397 | <span style='color: red'>(+289 [+11.5%])</span> 2,794 | <span style='color: red'>(+167 [+13.1%])</span> 1,439 | <span style='color: red'>(+122 [+9.9%])</span> 1,355 |
...
| `execute_metered_insn_mi/s` | <span style='color: red'>(+0 [+0.4%])</span> 28.09 | -          | <span style='color: red'>(+0 [+0.4%])</span> 28.09 | <span style='color: red'>(+0 [+0.4%])</span> 28.09 |
| `execute_preflight_insns` |  886,012.50 |  1,772,025 |  1,158,000 |  614,025 |
| `execute_preflight_time_ms` |  83 |  166 | <span style='color: green'>(-1 [-0.8%])</span> 117 | <span style='color: red'>(+1 [+2.1%])</span> 49 |
| `execute_preflight_insn_mi/s` | <span style='color: green'>(-0 [-1.2%])</span> 14.93 | -          | <span style='color: green'>(-0 [-2.2%])</span> 18.24 | <span style='color: red'>(+0 [+0.2%])</span> 11.62 |
| `trace_gen_time_ms   ` | <span style='color: green'>(-1 [-0.5%])</span> 185 | <span style='color: green'>(-2 [-0.5%])</span> 370 | <span style='color: green'>(-1 [-0.5%])</span> 203 | <span style='color: green'>(-1 [-0.6%])</span> 167 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+146 [+16.6%])</span> 1,028 | <span style='color: red'>(+293 [+16.6%])</span> 2,056 | <span style='color: red'>(+123 [+13.1%])</span> 1,062 | <span style='color: red'>(+170 [+20.6%])</span> 994 |
| `main_trace_commit_time_ms` | <span style='color: red'>(+0 [+0.8%])</span> 64.50 | <span style='color: red'>(+1 [+0.8%])</span> 129 | <span style='color: red'>(+4 [+5.6%])</span> 76 | <span style='color: green'>(-3 [-5.4%])</span> 53 |
| `generate_perm_trace_time_ms` | <span style='color: red'>(+4 [+14.5%])</span> 35.50 | <span style='color: red'>(+9 [+14.5%])</span> 71 | <span style='color: red'>(+11 [+32.4%])</span> 45 | <span style='color: green'>(-2 [-7.1%])</span> 26 |
| `perm_trace_commit_time_ms` | <span style='color: red'>(+0 [+0.5%])</span> 76.95 | <span style='color: red'>(+1 [+0.5%])</span> 153.89 | <span style='color: green'>(-1 [-1.3%])</span> 88.97 | <span style='color: red'>(+2 [+3.0%])</span> 64.92 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+2 [+2.9%])</span> 81.88 | <span style='color: red'>(+5 [+2.9%])</span> 163.75 | <span style='color: red'>(+2 [+1.9%])</span> 91.26 | <span style='color: red'>(+3 [+4.1%])</span> 72.49 |
| `quotient_poly_commit_time_ms` | <span style='color: green'>(-0 [-2.7%])</span> 16.91 | <span style='color: green'>(-1 [-2.7%])</span> 33.82 | <span style='color: green'>(-1 [-5.4%])</span> 18.57 | <span style='color: red'>(+0 [+0.7%])</span> 15.25 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+138 [+22.8%])</span> 747 | <span style='color: red'>(+277 [+22.8%])</span> 1,494 | <span style='color: red'>(+122 [+17.4%])</span> 825 | <span style='color: red'>(+155 [+30.2%])</span> 669 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 1,355 | 1 | 63 | 1,772,025 | 28.09 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 167 | 1,439 | 32,402,324 | 172,560,220 | 167 | 994 | 0 | 91.26 | 18.57 | 8 | 88.97 | 669 | 137 | 669 | 1 | 76 | 15,874,642 | 45 | 117 | 1,158,000 | 11.62 | 26 | 110 | 1 | 669 | 
| pairing | 1 | 203 | 1,355 | 22,659,576 | 122,481,638 | 203 | 1,062 | 1 | 72.49 | 15.25 | 9 | 64.92 | 825 | 94 | 825 | 0 | 53 | 9,633,870 | 26 | 49 | 614,025 | 18.24 | 21 | 88 | 1 | 825 | 

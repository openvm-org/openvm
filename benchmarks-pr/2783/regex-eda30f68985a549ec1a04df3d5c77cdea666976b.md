...
|:---|---:|---:|---:|
| Total | <span style='color: red'>(+0 [+8.8%])</span> 5.62 | <span style='color: green'>(-0 [-0.5%])</span> 1.56 | 1.56 |
| regex_program | <span style='color: red'>(+0 [+8.8%])</span> 5.62 | <span style='color: green'>(-0 [-0.5%])</span> 1.56 |  1.56 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+113 [+8.8%])</span> 1,395.25 | <span style='color: red'>(+453 [+8.8%])</span> 5,581 | <span style='color: green'>(-8 [-0.5%])</span> 1,521 | <span style='color: red'>(+82 [+7.0%])</span> 1,247 |
...
| `execute_metered_insn_mi/s` | <span style='color: red'>(+1 [+0.9%])</span> 113.32 | -          | <span style='color: red'>(+1 [+0.9%])</span> 113.32 | <span style='color: red'>(+1 [+0.9%])</span> 113.32 |
| `execute_preflight_insns` |  1,034,284.75 |  4,137,139 |  1,104,000 |  826,139 |
| `execute_preflight_time_ms` | <span style='color: green'>(-1 [-2.7%])</span> 44.75 | <span style='color: green'>(-5 [-2.7%])</span> 179 | <span style='color: green'>(-1 [-1.8%])</span> 55 | <span style='color: green'>(-2 [-5.6%])</span> 34 |
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+1 [+4.7%])</span> 32.25 | -          | <span style='color: red'>(+1 [+1.8%])</span> 32.80 | <span style='color: red'>(+1 [+3.5%])</span> 31.19 |
| `trace_gen_time_ms   ` | <span style='color: green'>(-0 [-0.3%])</span> 181.25 | <span style='color: green'>(-2 [-0.3%])</span> 725 | <span style='color: red'>(+2 [+1.0%])</span> 197 | <span style='color: green'>(-1 [-0.6%])</span> 175 |
| `memory_finalize_time_ms` |  1 |  4 |  4 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+115 [+11.7%])</span> 1,097 | <span style='color: red'>(+460 [+11.7%])</span> 4,388 | <span style='color: red'>(+124 [+10.9%])</span> 1,258 | <span style='color: red'>(+57 [+6.4%])</span> 949 |
| `main_trace_commit_time_ms` | <span style='color: green'>(-0 [-0.9%])</span> 52.25 | <span style='color: green'>(-2 [-0.9%])</span> 209 | <span style='color: green'>(-2 [-3.4%])</span> 56 |  51 |
| `generate_perm_trace_time_ms` | <span style='color: red'>(+0 [+1.0%])</span> 25.50 | <span style='color: red'>(+1 [+1.0%])</span> 102 |  37 | <span style='color: red'>(+1 [+5.9%])</span> 18 |
| `perm_trace_commit_time_ms` | <span style='color: green'>(-1 [-1.7%])</span> 64.85 | <span style='color: green'>(-5 [-1.7%])</span> 259.39 | <span style='color: green'>(-2 [-2.1%])</span> 71.64 | <span style='color: green'>(-0 [-0.8%])</span> 55.98 |
| `quotient_poly_compute_time_ms` | <span style='color: green'>(-2 [-4.2%])</span> 57.33 | <span style='color: green'>(-10 [-4.2%])</span> 229.31 | <span style='color: red'>(+1 [+2.1%])</span> 70.97 | <span style='color: green'>(-7 [-12.4%])</span> 47.77 |
| `quotient_poly_commit_time_ms` | <span style='color: green'>(-0 [-0.7%])</span> 15.76 | <span style='color: green'>(-0 [-0.7%])</span> 63.04 | <span style='color: green'>(-1 [-4.7%])</span> 17.88 | <span style='color: green'>(-0 [-3.3%])</span> 13.33 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+119 [+15.7%])</span> 878 | <span style='color: red'>(+476 [+15.7%])</span> 3,512 | <span style='color: red'>(+154 [+17.2%])</span> 1,049 | <span style='color: red'>(+43 [+6.4%])</span> 718 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 1,247 | 1 | 36 | 4,137,139 | 113.32 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 175 | 1,343 | 23,441,564 | 150,778,428 | 175 | 949 | 0 | 56.73 | 17.88 | 7 | 71.64 | 718 | 98 | 718 | 4 | 56 | 10,895,130 | 26 | 55 | 1,103,000 | 31.19 | 22 | 75 | 0 | 717 | 
| regex_program | 1 | 177 | 1,521 | 11,592,182 | 128,513,066 | 177 | 1,258 | 1 | 53.85 | 15.60 | 7 | 67.88 | 1,049 | 87 | 1,049 | 0 | 51 | 2,190,100 | 18 | 45 | 1,104,000 | 32.80 | 17 | 70 | 0 | 1,049 | 
| regex_program | 2 | 176 | 1,470 | 11,583,038 | 128,513,066 | 176 | 1,207 | 1 | 47.77 | 16.23 | 6 | 63.89 | 989 | 101 | 989 | 0 | 51 | 2,181,164 | 37 | 45 | 1,104,000 | 32.52 | 17 | 64 | 0 | 989 | 
| regex_program | 3 | 197 | 1,247 | 11,854,458 | 103,456,394 | 197 | 974 | 0 | 70.97 | 13.33 | 7 | 55.98 | 756 | 81 | 756 | 0 | 51 | 2,423,136 | 21 | 34 | 826,139 | 32.50 | 19 | 85 | 0 | 756 | 

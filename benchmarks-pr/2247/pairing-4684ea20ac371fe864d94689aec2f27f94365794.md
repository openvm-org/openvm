...
| `total_proof_time_ms ` |  716 |  1,432 |  816 |  616 |
...
| `execute_preflight_insn_mi/s` |  13.32 | -          |  17.99 |  8.66 |
| `trace_gen_time_ms   ` |  174.50 |  349 |  196 |  153 |
| `memory_finalize_time_ms` |  1 |  2 |  1 |  1 |
| `stark_prove_excluding_trace_time_ms` |  349 |  698 |  379 |  319 |
| `main_trace_commit_time_ms` |  64 |  128 |  74 |  54 |
| `generate_perm_trace_time_ms` |  36.50 |  73 |  40 |  33 |
| `perm_trace_commit_time_ms` |  76.50 |  153 |  88.82 |  64.18 |
| `quotient_poly_compute_time_ms` |  79.44 |  158.88 |  87.80 |  71.08 |
| `quotient_poly_commit_time_ms` |  15.95 |  31.89 |  17.37 |  14.52 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 616 | 1 | 99 | 1,745,742 | 17.50 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 153 | 816 | 32,689,110 | 172,558,444 | 153 | 379 | 0 | 87.80 | 17.37 | 6 | 88.82 | 67 | 131 | 67 | 1 | 74 | 16,059,916 | 40 | 137 | 1,157,000 | 8.66 | 26 | 105 | 1 | 67 | 
| pairing | 1 | 196 | 616 | 22,314,288 | 119,958,502 | 196 | 319 | 1 | 71.08 | 14.52 | 5 | 64.18 | 77 | 100 | 77 | 1 | 54 | 9,408,294 | 33 | 60 | 588,742 | 17.99 | 21 | 86 | 1 | 77 | 

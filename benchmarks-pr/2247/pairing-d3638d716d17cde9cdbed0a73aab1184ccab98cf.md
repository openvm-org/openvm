...
| `total_proof_time_ms ` |  706.50 |  1,413 |  803 |  610 |
...
| `execute_metered_insn_mi/s` |  17.37 | -          |  17.37 |  17.37 |
| `execute_preflight_insns` |  872,871 |  1,745,742 |  1,157,000 |  588,742 |
| `execute_preflight_time_ms` |  98 |  196 |  136 |  60 |
| `execute_preflight_insn_mi/s` |  13.12 | -          |  17.57 |  8.66 |
| `trace_gen_time_ms   ` |  171 |  342 |  192 |  150 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  343.50 |  687 |  372 |  315 |
| `main_trace_commit_time_ms` |  63 |  126 |  74 |  52 |
| `generate_perm_trace_time_ms` |  36 |  72 |  40 |  32 |
| `perm_trace_commit_time_ms` |  74.87 |  149.74 |  85.21 |  64.52 |
| `quotient_poly_compute_time_ms` |  77.29 |  154.58 |  84.36 |  70.22 |
| `quotient_poly_commit_time_ms` |  15.79 |  31.59 |  17.03 |  14.55 |
| `pcs_opening_time_ms ` |  71 |  142 |  76 |  66 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 610 | 1 | 100 | 1,745,742 | 17.37 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 150 | 803 | 32,689,110 | 172,558,444 | 150 | 372 | 0 | 84.36 | 17.03 | 6 | 85.21 | 66 | 127 | 66 | 1 | 74 | 16,059,916 | 40 | 136 | 1,157,000 | 8.66 | 26 | 102 | 1 | 66 | 
| pairing | 1 | 192 | 610 | 22,314,288 | 119,958,502 | 192 | 315 | 1 | 70.22 | 14.55 | 6 | 64.52 | 76 | 100 | 76 | 0 | 52 | 9,408,294 | 32 | 60 | 588,742 | 17.57 | 20 | 85 | 1 | 76 | 

...
|:---|---:|---:|
| Total |  2.37 |  0.75 |
| regex_program |  2.34 |  0.71 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  584.50 |  2,338 |  714 |  540 |
...
| `execute_metered_insn_mi/s` |  116.46 | -          |  116.46 |  116.46 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  54.25 |  217 |  67 |  45 |
| `execute_preflight_insn_mi/s` |  30.91 | -          |  32.04 |  28.15 |
| `trace_gen_time_ms   ` |  181.25 |  725 |  215 |  158 |
| `memory_finalize_time_ms` |  0.75 |  3 |  3 |  0 |
| `stark_prove_excluding_trace_time_ms` |  282 |  1,128 |  309 |  268 |
| `main_trace_commit_time_ms` |  52 |  208 |  56 |  49 |
| `generate_perm_trace_time_ms` |  28.50 |  114 |  35 |  18 |
| `perm_trace_commit_time_ms` |  64.71 |  258.84 |  70.68 |  55.81 |
| `quotient_poly_compute_time_ms` |  59.82 |  239.26 |  69.94 |  53.45 |
| `quotient_poly_commit_time_ms` |  15.32 |  61.26 |  17.67 |  12.58 |
| `pcs_opening_time_ms ` |  57.75 |  231 |  64 |  49 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 541 | 1 | 35 | 4,137,502 | 116.46 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 215 | 714 | 23,446,148 | 150,778,428 | 215 | 309 | 0 | 62.34 | 17.67 | 5 | 70.68 | 64 | 106 | 64 | 3 | 56 | 10,899,170 | 34 | 46 | 1,103,000 | 28.15 | 21 | 80 | 1 | 64 | 
| regex_program | 1 | 158 | 540 | 11,598,276 | 128,513,066 | 158 | 274 | 1 | 53.53 | 15.83 | 4 | 66.91 | 49 | 102 | 49 | 0 | 51 | 2,196,106 | 35 | 67 | 1,104,000 | 31.75 | 16 | 69 | 0 | 49 | 
| regex_program | 2 | 165 | 543 | 11,579,064 | 128,513,066 | 165 | 277 | 1 | 53.45 | 15.18 | 4 | 65.43 | 62 | 93 | 62 | 0 | 52 | 2,177,334 | 27 | 59 | 1,104,000 | 31.71 | 16 | 69 | 0 | 62 | 
| regex_program | 3 | 187 | 541 | 11,853,872 | 103,456,394 | 186 | 268 | 0 | 69.94 | 12.58 | 5 | 55.81 | 56 | 77 | 56 | 0 | 49 | 2,422,606 | 18 | 45 | 826,502 | 32.04 | 18 | 83 | 1 | 56 | 
...
Commit: https://github.com/openvm-org/openvm/commit/d3638d716d17cde9cdbed0a73aab1184ccab98cf
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19375084881)

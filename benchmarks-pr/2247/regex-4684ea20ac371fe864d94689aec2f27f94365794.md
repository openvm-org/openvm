...
| `total_proof_time_ms ` |  584 |  2,336 |  720 |  535 |
...
| `execute_preflight_time_ms` |  55 |  220 |  68 |  45 |
| `execute_preflight_insn_mi/s` |  31.03 | -          |  32.07 |  28.31 |
| `trace_gen_time_ms   ` |  175.25 |  701 |  211 |  151 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  286 |  1,144 |  319 |  266 |
| `main_trace_commit_time_ms` |  50.75 |  203 |  55 |  49 |
| `generate_perm_trace_time_ms` |  28.75 |  115 |  37 |  19 |
| `perm_trace_commit_time_ms` |  64.08 |  256.34 |  70.52 |  54.20 |
| `quotient_poly_compute_time_ms` |  58.53 |  234.13 |  70.20 |  52.06 |
| `quotient_poly_commit_time_ms` |  15.21 |  60.85 |  17.69 |  12.62 |
| `pcs_opening_time_ms ` |  65.25 |  261 |  81 |  56 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 535 | 1 | 36 | 4,137,502 | 111.82 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 211 | 720 | 23,446,148 | 150,778,428 | 211 | 319 | 0 | 59.61 | 17.69 | 5 | 70.52 | 81 | 103 | 81 | 4 | 55 | 10,899,170 | 31 | 45 | 1,103,000 | 28.31 | 21 | 78 | 1 | 81 | 
| regex_program | 1 | 151 | 545 | 11,598,276 | 128,513,066 | 151 | 284 | 1 | 52.26 | 14.87 | 5 | 65.35 | 62 | 103 | 62 | 0 | 50 | 2,196,106 | 37 | 68 | 1,104,000 | 32.07 | 16 | 67 | 0 | 62 | 
| regex_program | 2 | 159 | 536 | 11,579,064 | 128,513,066 | 159 | 275 | 1 | 52.06 | 15.67 | 4 | 66.27 | 62 | 94 | 62 | 0 | 49 | 2,177,334 | 28 | 60 | 1,104,000 | 31.99 | 16 | 68 | 0 | 62 | 
| regex_program | 3 | 180 | 535 | 11,853,872 | 103,456,394 | 180 | 266 | 0 | 70.20 | 12.62 | 5 | 54.20 | 56 | 77 | 55 | 0 | 49 | 2,422,606 | 19 | 47 | 826,502 | 31.76 | 18 | 83 | 1 | 55 | 

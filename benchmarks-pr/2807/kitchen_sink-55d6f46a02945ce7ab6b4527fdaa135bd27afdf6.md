...
| `total_proof_time_ms ` |  946.50 |  1,893 |  1,218 |  675 |
| `execute_metered_time_ms` |  34 | -          | -          | -          |
| `execute_metered_insns` |  2,579,903 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  74.09 | -          |  74.09 |  74.09 |
| `execute_preflight_insns` |  1,289,951.50 |  2,579,903 |  1,540,000 |  1,039,903 |
| `execute_preflight_time_ms` |  99 |  198 |  136 |  62 |
| `execute_preflight_insn_mi/s` |  35.54 | -          |  36.51 |  34.57 |
| `trace_gen_time_ms   ` |  26 |  52 |  36 |  16 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  710.50 |  1,421 |  940 |  481 |
| `prover.main_trace_commit_time_ms` |  213 |  426 |  290 |  136 |
| `prover.rap_constraints_time_ms` |  449 |  898 |  594 |  304 |
| `prover.openings_time_ms` |  47 |  94 |  54 |  40 |
| `prover.rap_constraints.logup_gkr_time_ms` |  82.50 |  165 |  111 |  54 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/55d6f46a02945ce7ab6b4527fdaa135bd27afdf6/kitchen_sink-55d6f46a02945ce7ab6b4527fdaa135bd27afdf6.memory.svg)
...
| app_proof |  |  |  |  |  | 675 |  |  | 34 | 2,579,903 | 74.09 | 0 | 1,933 |  | 
...
| leaf | 0 | 112 | 409 | 112 | 24 | 9 | 21 | 5 | 5 | 
...
| leaf | 0 | prover | 265,006,708 | 297 | 128 | 0 | 1 | 140 | 49 | 48 | 37 | 54 | 0 | 27 | 11 | 15 | 7 | 8 | 128 | 140 | 0 | 2 | 53 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 567,917,156 | 940 | 290 | 0 | 160 | 594 | 354 | 352 | 129 | 111 | 54 | 54 | 13 | 41 | 15 | 25 | 290 | 594 | 0 | 1 | 55 | 0 | 0 | 
| app_proof | prover | 1 | 537,266,124 | 481 | 136 | 0 | 1 | 304 | 174 | 173 | 75 | 54 | 0 | 40 | 12 | 27 | 14 | 13 | 136 | 304 | 0 | 1 | 53 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 36 | 1,218 | 36 | 178 | 0 | 3 | 62 | 1,540,000 | 34.57 | 
| app_proof | 1 | 16 | 675 | 16 | 40 | 0 | 1 | 136 | 1,039,903 | 36.51 | 

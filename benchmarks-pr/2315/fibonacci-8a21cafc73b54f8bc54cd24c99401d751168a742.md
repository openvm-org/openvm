...
|:---|---:|---:|---:|
| Total | <span style='color: green'>(-0 [-0.4%])</span> 1.04 | <span style='color: red'>(+0 [+1.8%])</span> 0.61 | 0.61 |
| fibonacci_program | <span style='color: green'>(-0 [-0.4%])</span> 1.04 | <span style='color: red'>(+0 [+1.8%])</span> 0.61 |  0.61 |


| fibonacci_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: green'>(-2 [-0.4%])</span> 515.50 | <span style='color: green'>(-4 [-0.4%])</span> 1,031 | <span style='color: red'>(+11 [+1.9%])</span> 599 | <span style='color: green'>(-15 [-3.4%])</span> 432 |
...
| `execute_metered_insn_mi/s` | <span style='color: green'>(-2 [-1.5%])</span> 110.94 | -          | <span style='color: green'>(-2 [-1.5%])</span> 110.94 | <span style='color: green'>(-2 [-1.5%])</span> 110.94 |
...
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+0 [+1.3%])</span> 36.94 | -          | <span style='color: red'>(+1 [+2.6%])</span> 39.02 |  34.87 |
...
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+3 [+1.6%])</span> 189.50 | <span style='color: red'>(+6 [+1.6%])</span> 379 | <span style='color: red'>(+15 [+7.8%])</span> 207 | <span style='color: green'>(-9 [-5.0%])</span> 172 |
| `main_trace_commit_time_ms` |  30.50 |  61 |  33 |  28 |
| `generate_perm_trace_time_ms` | <span style='color: red'>(+3 [+11.8%])</span> 28.50 | <span style='color: red'>(+6 [+11.8%])</span> 57 | <span style='color: red'>(+7 [+24.1%])</span> 36 | <span style='color: green'>(-1 [-4.5%])</span> 21 |
| `perm_trace_commit_time_ms` | <span style='color: green'>(-0 [-1.0%])</span> 41.15 | <span style='color: green'>(-1 [-1.0%])</span> 82.30 | <span style='color: green'>(-0 [-0.5%])</span> 44.04 | <span style='color: green'>(-1 [-1.5%])</span> 38.26 |
| `quotient_poly_compute_time_ms` | <span style='color: green'>(-1 [-3.0%])</span> 30.15 | <span style='color: green'>(-2 [-3.0%])</span> 60.30 | <span style='color: red'>(+1 [+1.8%])</span> 32.48 | <span style='color: green'>(-2 [-8.0%])</span> 27.83 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+0 [+1.3%])</span> 12.15 | <span style='color: red'>(+0 [+1.3%])</span> 24.29 | <span style='color: green'>(-1 [-4.2%])</span> 12.25 | <span style='color: red'>(+1 [+7.5%])</span> 12.04 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+2 [+4.7%])</span> 45 | <span style='color: red'>(+4 [+4.7%])</span> 90 | <span style='color: red'>(+3 [+6.8%])</span> 47 | <span style='color: red'>(+1 [+2.4%])</span> 43 |
...
| --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 432 | 1 | 13 | 1,500,209 | 110.94 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 197 | 599 | 9,677,708 | 84,395,212 | 197 | 207 | 0 | 32.48 | 12.04 | 4 | 44.04 | 47 | 81 | 47 | 0 | 33 | 1,035,986 | 36 | 25 | 873,000 | 34.87 | 14 | 45 | 0 | 47 | 
| fibonacci_program | 1 | 186 | 432 | 9,708,170 | 74,305,770 | 186 | 172 | 1 | 27.83 | 12.25 | 4 | 38.26 | 43 | 59 | 43 | 0 | 28 | 1,064,416 | 21 | 32 | 627,209 | 39.02 | 11 | 40 | 0 | 43 | 

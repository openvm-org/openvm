...
|:---|---:|---:|---:|
| Total | <span style='color: red'>(+0 [+0.7%])</span> 1.53 | <span style='color: red'>(+0 [+1.3%])</span> 0.93 | 0.93 |
| pairing | <span style='color: red'>(+0 [+0.7%])</span> 1.53 | <span style='color: red'>(+0 [+1.2%])</span> 0.93 |  0.93 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+5 [+0.7%])</span> 732.50 | <span style='color: red'>(+10 [+0.7%])</span> 1,465 | <span style='color: red'>(+11 [+1.3%])</span> 863 | <span style='color: green'>(-1 [-0.2%])</span> 602 |
...
| `execute_metered_insn_mi/s` | <span style='color: green'>(-0 [-0.3%])</span> 27.25 | -          | <span style='color: green'>(-0 [-0.3%])</span> 27.25 | <span style='color: green'>(-0 [-0.3%])</span> 27.25 |
| `execute_preflight_insns` |  872,871 |  1,745,742 |  1,149,000 |  596,742 |
| `execute_preflight_time_ms` |  82.50 |  165 |  104 |  61 |
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+0 [+0.6%])</span> 14.97 | -          | <span style='color: red'>(+0 [+1.1%])</span> 18.56 |  11.38 |
| `trace_gen_time_ms   ` | <span style='color: green'>(-2 [-1.3%])</span> 188.50 | <span style='color: green'>(-5 [-1.3%])</span> 377 | <span style='color: green'>(-4 [-2.1%])</span> 191 | <span style='color: green'>(-1 [-0.5%])</span> 186 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+8 [+2.2%])</span> 356 | <span style='color: red'>(+15 [+2.2%])</span> 712 | <span style='color: red'>(+12 [+3.1%])</span> 404 | <span style='color: red'>(+3 [+1.0%])</span> 308 |
| `main_trace_commit_time_ms` |  63.50 |  127 | <span style='color: green'>(-1 [-1.3%])</span> 74 | <span style='color: red'>(+1 [+1.9%])</span> 53 |
| `generate_perm_trace_time_ms` | <span style='color: red'>(+6 [+16.5%])</span> 46 | <span style='color: red'>(+13 [+16.5%])</span> 92 | <span style='color: red'>(+12 [+29.3%])</span> 53 | <span style='color: red'>(+1 [+2.6%])</span> 39 |
| `perm_trace_commit_time_ms` | <span style='color: green'>(-1 [-1.9%])</span> 76.24 | <span style='color: green'>(-3 [-1.9%])</span> 152.48 | <span style='color: green'>(-2 [-1.9%])</span> 88.76 | <span style='color: green'>(-1 [-1.9%])</span> 63.72 |
| `quotient_poly_compute_time_ms` | <span style='color: green'>(-3 [-3.1%])</span> 81.34 | <span style='color: green'>(-5 [-3.1%])</span> 162.68 | <span style='color: green'>(-5 [-5.1%])</span> 88.38 | <span style='color: green'>(-1 [-0.7%])</span> 74.30 |
| `quotient_poly_commit_time_ms` | <span style='color: green'>(-2 [-12.3%])</span> 15.54 | <span style='color: green'>(-4 [-12.3%])</span> 31.09 | <span style='color: green'>(-4 [-17.7%])</span> 16.46 | <span style='color: green'>(-1 [-5.4%])</span> 14.63 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+8 [+13.2%])</span> 68.50 | <span style='color: red'>(+16 [+13.2%])</span> 137 | <span style='color: red'>(+11 [+16.4%])</span> 78 | <span style='color: red'>(+5 [+9.3%])</span> 59 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 602 | 1 | 64 | 1,745,742 | 27.25 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 186 | 863 | 32,480,114 | 172,558,444 | 186 | 404 | 0 | 88.38 | 16.46 | 6 | 88.76 | 78 | 145 | 78 | 1 | 74 | 15,909,408 | 53 | 104 | 1,149,000 | 11.38 | 26 | 105 | 1 | 78 | 
| pairing | 1 | 191 | 602 | 22,464,232 | 119,958,502 | 191 | 308 | 1 | 74.30 | 14.63 | 6 | 63.72 | 59 | 106 | 58 | 0 | 53 | 9,498,894 | 39 | 61 | 596,742 | 18.56 | 21 | 89 | 1 | 58 | 

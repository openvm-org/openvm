...
|:---|---:|---:|
| Total |  14.20 |  8.04 |
| regex_program |  14.20 |  8.04 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,101.50 |  14,203 |  8,045 | <span style='color: red'>(+9 [+0.1%])</span> 6,158 |
...
| `trace_gen_time_ms   ` | <span style='color: red'>(+4 [+0.3%])</span> 1,157 | <span style='color: red'>(+8 [+0.3%])</span> 2,314 | <span style='color: red'>(+18 [+1.3%])</span> 1,379 | <span style='color: green'>(-10 [-1.1%])</span> 935 |
| `stark_prove_excluding_trace_time_ms` |  5,510.50 |  11,021 | <span style='color: green'>(-18 [-0.3%])</span> 6,199 | <span style='color: red'>(+22 [+0.5%])</span> 4,822 |
| `main_trace_commit_time_ms` | <span style='color: red'>(+23 [+2.1%])</span> 1,105 | <span style='color: red'>(+46 [+2.1%])</span> 2,210 | <span style='color: green'>(-5 [-0.4%])</span> 1,328 | <span style='color: red'>(+51 [+6.1%])</span> 882 |
| `generate_perm_trace_time_ms` | <span style='color: red'>(+8 [+4.5%])</span> 185 | <span style='color: red'>(+16 [+4.5%])</span> 370 | <span style='color: green'>(-2 [-1.1%])</span> 186 | <span style='color: red'>(+18 [+10.8%])</span> 184 |
| `perm_trace_commit_time_ms` | <span style='color: red'>(+10 [+0.8%])</span> 1,177.50 | <span style='color: red'>(+19 [+0.8%])</span> 2,355 | <span style='color: red'>(+22 [+1.8%])</span> 1,248 | <span style='color: green'>(-3 [-0.3%])</span> 1,107 |
| `quotient_poly_compute_time_ms` | <span style='color: green'>(-6 [-0.9%])</span> 726.50 | <span style='color: green'>(-13 [-0.9%])</span> 1,453 | <span style='color: green'>(-14 [-1.6%])</span> 846 | <span style='color: red'>(+1 [+0.2%])</span> 607 |
| `quotient_poly_commit_time_ms` | <span style='color: green'>(-29 [-2.9%])</span> 974 | <span style='color: green'>(-58 [-2.9%])</span> 1,948 | <span style='color: green'>(-19 [-1.6%])</span> 1,141 | <span style='color: green'>(-39 [-4.6%])</span> 807 |
| `pcs_opening_time_ms ` |  1,331.50 |  2,663 |  1,441 |  1,222 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,379 | 8,045 |  | 209,921,543 | 6,199 | 846 | 1,141 | 1,248 | 1,441 | 1,328 | 92,686,348 | 186 | 467 | 
| regex_program | 1 | 935 | 6,158 | 1,914,103 | 149,454,692 | 4,822 | 607 | 807 | 1,107 | 1,222 | 882 | 72,769,025 | 184 | 401 | 

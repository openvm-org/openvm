...
| `total_proof_time_ms ` |  951.50 |  1,903 |  1,225 |  678 |
| `execute_metered_time_ms` |  34 | -          | -          | -          |
| `execute_metered_insns` |  2,579,903 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  74.17 | -          |  74.17 |  74.17 |
| `execute_preflight_insns` |  1,289,951.50 |  2,579,903 |  1,540,000 |  1,039,903 |
| `execute_preflight_time_ms` |  98.50 |  197 |  134 |  63 |
| `execute_preflight_insn_mi/s` |  35.58 | -          |  36.68 |  34.48 |
| `trace_gen_time_ms   ` |  26.50 |  53 |  37 |  16 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  717 |  1,434 |  947 |  487 |
| `prover.main_trace_commit_time_ms` |  216 |  432 |  294 |  138 |
| `prover.rap_constraints_time_ms` |  451.50 |  903 |  596 |  307 |
| `prover.openings_time_ms` |  48 |  96 |  55 |  41 |
| `prover.rap_constraints.logup_gkr_time_ms` |  83 |  166 |  112 |  54 |
| `prover.rap_constraints.round0_time_ms` |  264.50 |  529 |  353 |  176 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/0ec03165baf1d206a5ba5e7e4d2a52799bd0c3cb/kitchen_sink-0ec03165baf1d206a5ba5e7e4d2a52799bd0c3cb.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 69 | 3 |  |  | 0 |  | 328 | 3 |  |  |  |  |  |  | 
| app_proof |  |  |  |  |  | 678 |  |  | 34 | 2,579,903 | 74.17 | 0 | 1,943 |  | 
...
| leaf | 0 | 113 | 413 | 112 | 24 | 9 | 21 | 4 | 4 | 
...
| leaf | 0 | prover | 265,006,708 | 300 | 129 | 0 | 1 | 141 | 49 | 48 | 37 | 54 | 0 | 28 | 12 | 15 | 7 | 8 | 130 | 141 | 0 | 2 | 54 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 567,917,156 | 947 | 294 | 0 | 163 | 596 | 353 | 352 | 130 | 112 | 55 | 55 | 13 | 42 | 16 | 25 | 294 | 596 | 0 | 1 | 55 | 0 | 0 | 
| app_proof | prover | 1 | 537,266,124 | 487 | 138 | 0 | 2 | 307 | 176 | 176 | 76 | 54 | 0 | 41 | 13 | 28 | 14 | 13 | 138 | 307 | 0 | 1 | 53 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 37 | 1,225 | 37 | 177 | 0 | 3 | 63 | 1,540,000 | 34.48 | 
| app_proof | 1 | 16 | 678 | 16 | 40 | 0 | 1 | 134 | 1,039,903 | 36.68 | 

...
|:---|---:|---:|
| Total |  222.84 |  222.84 |
| kitchen_sink |  15.36 |  15.36 |
| leaf |  23.66 |  23.66 |
| internal.0 |  6.24 |  6.24 |
| root |  38.61 |  38.61 |
| halo2_outer |  94.29 |  94.29 |
...
| `total_proof_time_ms ` |  15,355 |  15,355 |  15,355 |  15,355 |
...
| `stark_prove_excluding_trace_time_ms` |  14,792 |  14,792 |  14,792 |  14,792 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  23,657 |  23,657 |  23,657 |  23,657 |
| `main_cells_used     ` |  769,362,602 |  769,362,602 |  769,362,602 |  769,362,602 |
| `total_cells_used    ` |  2,050,266,036 |  2,050,266,036 |  2,050,266,036 |  2,050,266,036 |
| `execute_preflight_insns` |  7,903,938 |  7,903,938 |  7,903,938 |  7,903,938 |
| `execute_preflight_time_ms` |  1,308 |  1,308 |  1,308 |  1,308 |
| `execute_preflight_insn_mi/s` |  6.98 | -          |  6.98 |  6.98 |
| `trace_gen_time_ms   ` |  1,598 |  1,598 |  1,598 |  1,598 |
| `memory_finalize_time_ms` |  18 |  18 |  18 |  18 |
| `stark_prove_excluding_trace_time_ms` |  19,685 |  19,685 |  19,685 |  19,685 |
| `main_trace_commit_time_ms` |  4,222 |  4,222 |  4,222 |  4,222 |
| `generate_perm_trace_time_ms` |  1,726 |  1,726 |  1,726 |  1,726 |
| `perm_trace_commit_time_ms` |  5,505 |  5,505 |  5,505 |  5,505 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  6,244 |  6,244 |  6,244 |  6,244 |
| `main_cells_used     ` |  79,527,843 |  79,527,843 |  79,527,843 |  79,527,843 |
| `total_cells_used    ` |  143,465,737 |  143,465,737 |  143,465,737 |  143,465,737 |
| `execute_preflight_insns` |  1,197,816 |  1,197,816 |  1,197,816 |  1,197,816 |
| `execute_preflight_time_ms` |  486 |  486 |  486 |  486 |
| `execute_preflight_insn_mi/s` |  3.63 | -          |  3.63 |  3.63 |
| `trace_gen_time_ms   ` |  189 |  189 |  189 |  189 |
| `memory_finalize_time_ms` |  9 |  9 |  9 |  9 |
| `stark_prove_excluding_trace_time_ms` |  4,572 |  4,572 |  4,572 |  4,572 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  38,609 |  38,609 |  38,609 |  38,609 |
| `main_cells_used     ` |  41,517,942 |  41,517,942 |  41,517,942 |  41,517,942 |
| `total_cells_used    ` |  64,200,412 |  64,200,412 |  64,200,412 |  64,200,412 |
| `execute_preflight_insns` |  772,551 |  772,551 |  772,551 |  772,551 |
...
| `quotient_poly_commit_time_ms` |  13,618 |  13,618 |  13,618 |  13,618 |
| `pcs_opening_time_ms ` |  3,991 |  3,991 |  3,991 |  3,991 |

| halo2_outer |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  94,292 |  94,292 |  94,292 |  94,292 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
|  | 0 | 119 | 64,200,412 | 119 | 0 | 94,307 | 44,669 | 12 | 41,517,942 | 305 | 772,551 | 5.37 | 15,405 | 39,605 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| halo2_outer |  | 94,292 |  |  |  |  |  | 65,627,358 |  |  |  |  |  | 
| halo2_wrapper |  | 44,669 |  |  |  |  |  |  |  |  |  |  |  | 
| internal.0 |  |  |  | 6,245 |  | 3 |  |  | 2 |  |  |  |  | 
| kitchen_sink | 0 |  |  |  | 15,355 |  | 6 |  | 1 | 10 | 153,644 | 14.56 | 37 | 
| leaf |  |  | 23,664 |  |  | 1 |  |  | 1 |  |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal.0 | 0 | 0 | 189 | 6,244 | 143,465,737 | 224,975,330 | 189 | 4,572 | 0 | 616 | 735 | 747 | 1,244 | 9 | 1,028 | 79,527,843 | 196 |  | 486 | 1,197,816 | 3.63 | 
| leaf | 0 | 0 | 1,598 | 23,657 | 2,050,266,036 | 2,500,267,498 | 1,598 | 19,685 | 0 | 2,130 | 1,450 | 5,505 | 4,646 | 18 | 4,222 | 769,362,602 | 1,726 |  | 1,308 | 7,903,938 | 6.98 | 
| root | 0 | 0 | 119 | 38,609 | 64,200,412 | 80,435,354 | 119 | 38,329 | 0 | 728 | 13,618 | 7,578 | 3,991 | 8 | 12,312 | 41,517,942 | 88 | 3 | 161 | 772,551 | 5.28 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| kitchen_sink | 0 | 212 | 15,355 | 1,226,975,002 | 1,481,193,346 | 211 | 14,792 | 3 | 6,263 | 307 | 1,526 | 1,226 | 6 | 3 | 4,963 | 904,738,232 | 463 | 102 | 153,644 | 7.32 | 

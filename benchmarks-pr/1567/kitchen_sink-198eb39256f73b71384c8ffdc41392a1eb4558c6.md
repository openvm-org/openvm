...
| leaf |  23.45 |  23.45 |
| internal.0 |  5.31 |  5.31 |
| root |  38.60 |  38.60 |
| halo2_outer |  89.07 |  89.07 |
...
| `execute_metered_insn_mi/s` |  14.28 | -          |  14.28 |  14.28 |
...
| `main_trace_commit_time_ms` |  4,909 |  4,909 |  4,909 |  4,909 |
| `generate_perm_trace_time_ms` |  508 |  508 |  508 |  508 |
| `perm_trace_commit_time_ms` |  1,509 |  1,509 |  1,509 |  1,509 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  23,452 |  23,452 |  23,452 |  23,452 |
| `main_cells_used     ` |  748,994,226 |  748,994,226 |  748,994,226 |  748,994,226 |
| `total_cells_used    ` |  2,003,006,024 |  2,003,006,024 |  2,003,006,024 |  2,003,006,024 |
| `insns               ` |  7,952,492 |  7,952,492 |  7,952,492 |  7,952,492 |
| `execute_e3_time_ms  ` |  2,423 |  2,423 |  2,423 |  2,423 |
| `execute_e3_insn_mi/s` |  3.28 | -          |  3.28 |  3.28 |
| `trace_gen_time_ms   ` |  1,555 |  1,555 |  1,555 |  1,555 |
| `memory_finalize_time_ms` |  16 |  16 |  16 |  16 |
| `boundary_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  19,474 |  19,474 |  19,474 |  19,474 |
| `main_trace_commit_time_ms` |  4,191 |  4,191 |  4,191 |  4,191 |
| `generate_perm_trace_time_ms` |  1,635 |  1,635 |  1,635 |  1,635 |
...
| `pcs_opening_time_ms ` |  4,674 |  4,674 |  4,674 |  4,674 |

| internal.0 |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  5,306 |  5,306 |  5,306 |  5,306 |
| `main_cells_used     ` |  75,193,323 |  75,193,323 |  75,193,323 |  75,193,323 |
| `total_cells_used    ` |  134,681,025 |  134,681,025 |  134,681,025 |  134,681,025 |
| `insns               ` |  1,197,761 |  1,197,761 |  1,197,761 |  1,197,761 |
| `execute_e3_time_ms  ` |  490 |  490 |  490 |  490 |
| `execute_e3_insn_mi/s` |  2.44 | -          |  2.44 |  2.44 |
| `trace_gen_time_ms   ` |  187 |  187 |  187 |  187 |
| `memory_finalize_time_ms` |  8 |  8 |  8 |  8 |
| `boundary_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  4,629 |  4,629 |  4,629 |  4,629 |
...
| `pcs_opening_time_ms ` |  1,255 |  1,255 |  1,255 |  1,255 |

| root |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  38,598 |  38,598 |  38,598 |  38,598 |
| `main_cells_used     ` |  40,016,626 |  40,016,626 |  40,016,626 |  40,016,626 |
| `total_cells_used    ` |  61,675,688 |  61,675,688 |  61,675,688 |  61,675,688 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  89,074 |  89,074 |  89,074 |  89,074 |
| `main_cells_used     ` |  65,627,358 |  65,627,358 |  65,627,358 |  65,627,358 |

| halo2_wrapper |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  44,588 |  44,588 |  44,588 |  44,588 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
|  | 112 | 61,675,688 | 89,087 | 44,588 | 7 | 40,016,626 | 772,547 | 208 | 3.70 | 0 | 16,587 | 39,684 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| halo2_outer | 89,074 |  |  |  |  |  | 65,627,358 |  |  |  |  |  | 
| halo2_wrapper | 44,588 |  |  |  |  |  |  |  |  |  |  |  | 
| internal.0 |  |  | 6,518 |  | 3 |  |  |  | 2 |  |  |  | 
| kitchen_sink |  |  |  | 16,508 |  | 24 |  | 154,596 | 1 | 10 | 14.28 | 55 | 
| leaf |  | 24,660 |  |  | 1 |  |  |  | 1 |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal.0 | 0 | 187 | 5,306 | 134,681,025 | 224,975,330 | 4,629 | 610 | 744 | 787 | 1,255 | 8 | 1,013 | 75,193,323 | 1,197,761 | 214 |  | 490 | 2.44 | 0 | 
| leaf | 0 | 1,555 | 23,452 | 2,003,006,024 | 2,500,267,498 | 19,474 | 2,118 | 1,433 | 5,418 | 4,674 | 16 | 4,191 | 748,994,226 | 7,952,492 | 1,635 |  | 2,423 | 3.28 | 0 | 
| root | 0 | 111 | 38,598 | 61,675,688 | 80,435,354 | 38,277 | 710 | 13,672 | 7,584 | 3,893 | 6 | 12,313 | 40,016,626 | 772,547 | 90 | 3 | 210 | 3.66 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| kitchen_sink | 0 | 220 | 15,046 | 1,217,690,534 | 1,481,195,122 | 14,790 | 6,272 | 311 | 1,509 | 1,235 | 79 | 24 | 2 | 4,909 | 899,579,940 | 154,596 | 508 | 36 | 4.22 | 0 | 

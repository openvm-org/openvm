...
| `total_proof_time_ms ` |  14,664 |  14,664 |  14,664 |  14,664 |
...
| `stark_prove_excluding_trace_time_ms` |  14,102 |  14,102 |  14,102 |  14,102 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  22,297 |  22,297 |  22,297 |  22,297 |
| `main_cells_used     ` |  769,362,674 |  769,362,674 |  769,362,674 |  769,362,674 |
| `total_cells_used    ` |  2,050,266,276 |  2,050,266,276 |  2,050,266,276 |  2,050,266,276 |
| `insns               ` |  7,903,944 |  7,903,944 |  7,903,944 |  7,903,944 |
| `execute_preflight_time_ms` |  1,318 |  1,318 |  1,318 |  1,318 |
| `execute_preflight_insn_mi/s` |  6.95 | -          |  6.95 |  6.95 |
| `trace_gen_time_ms   ` |  1,590 |  1,590 |  1,590 |  1,590 |
| `memory_finalize_time_ms` |  20 |  20 |  20 |  20 |
| `stark_prove_excluding_trace_time_ms` |  18,293 |  18,293 |  18,293 |  18,293 |
| `main_trace_commit_time_ms` |  3,752 |  3,752 |  3,752 |  3,752 |
| `generate_perm_trace_time_ms` |  1,688 |  1,688 |  1,688 |  1,688 |
| `perm_trace_commit_time_ms` |  4,810 |  4,810 |  4,810 |  4,810 |
| `quotient_poly_compute_time_ms` |  2,177 |  2,177 |  2,177 |  2,177 |
...
| `main_cells_used     ` |  79,528,599 |  79,528,599 |  79,528,599 |  79,528,599 |
| `total_cells_used    ` |  143,467,501 |  143,467,501 |  143,467,501 |  143,467,501 |
| `insns               ` |  1,197,879 |  1,197,879 |  1,197,879 |  1,197,879 |
...
| `main_cells_used     ` |  41,517,258 |  41,517,258 |  41,517,258 |  41,517,258 |
| `total_cells_used    ` |  64,199,044 |  64,199,044 |  64,199,044 |  64,199,044 |
...
| `stark_prove_excluding_trace_time_ms` |  38,367 |  38,367 |  38,367 |  38,367 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  88,568 |  88,568 |  88,568 |  88,568 |
| `main_cells_used     ` |  65,627,358 |  65,627,358 |  65,627,358 |  65,627,358 |

| halo2_wrapper |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  44,120 |  44,120 |  44,120 |  44,120 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
|  | 0 | 118 | 64,199,044 | 118 | 0 | 88,581 | 44,120 | 8 | 41,517,258 | 772,494 | 302 | 5.38 | 14,714 | 39,673 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| halo2_outer |  | 88,568 |  |  |  |  |  | 65,627,358 |  |  |  |  |  | 
| halo2_wrapper |  | 44,120 |  |  |  |  |  |  |  |  |  |  |  | 
| internal.0 |  |  |  | 6,026 |  | 3 |  |  |  | 2 |  |  |  | 
| kitchen_sink | 0 |  |  |  | 14,664 |  | 6 |  | 153,644 | 1 | 10 | 14.60 | 37 | 
| leaf |  |  | 22,304 |  |  | 1 |  |  |  | 1 |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal.0 | 0 | 0 | 189 | 6,024 | 143,467,501 | 224,975,330 | 189 | 4,299 | 0 | 618 | 684 | 652 | 1,229 | 9 | 915 | 79,528,599 | 1,197,879 | 196 |  | 484 | 3.62 | 
| leaf | 0 | 0 | 1,590 | 22,297 | 2,050,266,276 | 2,500,267,498 | 1,590 | 18,293 | 0 | 2,177 | 1,304 | 4,810 | 4,556 | 20 | 3,752 | 769,362,674 | 7,903,944 | 1,688 |  | 1,318 | 6.95 | 
| root | 0 | 0 | 117 | 38,645 | 64,199,044 | 80,435,354 | 117 | 38,367 | 0 | 695 | 13,755 | 7,584 | 3,902 | 8 | 12,319 | 41,517,258 | 772,494 | 91 | 3 | 161 | 5.27 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| kitchen_sink | 0 | 210 | 14,664 | 1,226,975,002 | 1,481,193,346 | 209 | 14,102 | 3 | 6,253 | 285 | 1,360 | 1,208 | 6 | 3 | 4,487 | 904,738,232 | 153,644 | 463 | 104 | 7.36 | 

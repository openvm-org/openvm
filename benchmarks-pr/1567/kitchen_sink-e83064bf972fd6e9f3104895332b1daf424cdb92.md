...
| `total_proof_time_ms ` |  15,518 |  15,518 |  15,518 |  15,518 |
...
| `execute_metered_insn_mi/s` |  14.65 | -          |  14.65 |  14.65 |
...
| `stark_prove_excluding_trace_time_ms` |  14,959 |  14,959 |  14,959 |  14,959 |
| `main_trace_commit_time_ms` |  5,088 |  5,088 |  5,088 |  5,088 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  23,661 |  23,661 |  23,661 |  23,661 |
| `main_cells_used     ` |  769,363,574 |  769,363,574 |  769,363,574 |  769,363,574 |
| `total_cells_used    ` |  2,050,269,276 |  2,050,269,276 |  2,050,269,276 |  2,050,269,276 |
| `execute_preflight_insns` |  7,904,019 |  7,904,019 |  7,904,019 |  7,904,019 |
| `execute_preflight_time_ms` |  1,312 |  1,312 |  1,312 |  1,312 |
| `execute_preflight_insn_mi/s` |  6.93 | -          |  6.93 |  6.93 |
| `trace_gen_time_ms   ` |  1,619 |  1,619 |  1,619 |  1,619 |
| `memory_finalize_time_ms` |  19 |  19 |  19 |  19 |
| `stark_prove_excluding_trace_time_ms` |  19,676 |  19,676 |  19,676 |  19,676 |
| `main_trace_commit_time_ms` |  4,232 |  4,232 |  4,232 |  4,232 |
| `generate_perm_trace_time_ms` |  1,658 |  1,658 |  1,658 |  1,658 |
| `perm_trace_commit_time_ms` |  5,495 |  5,495 |  5,495 |  5,495 |
| `quotient_poly_compute_time_ms` |  2,176 |  2,176 |  2,176 |  2,176 |
| `quotient_poly_commit_time_ms` |  1,451 |  1,451 |  1,451 |  1,451 |
| `pcs_opening_time_ms ` |  4,659 |  4,659 |  4,659 |  4,659 |

| internal.0 |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  6,283 |  6,283 |  6,283 |  6,283 |
| `main_cells_used     ` |  79,528,047 |  79,528,047 |  79,528,047 |  79,528,047 |
| `total_cells_used    ` |  143,466,213 |  143,466,213 |  143,466,213 |  143,466,213 |
| `execute_preflight_insns` |  1,197,833 |  1,197,833 |  1,197,833 |  1,197,833 |
| `execute_preflight_time_ms` |  497 |  497 |  497 |  497 |
| `execute_preflight_insn_mi/s` |  3.53 | -          |  3.53 |  3.53 |
| `trace_gen_time_ms   ` |  195 |  195 |  195 |  195 |
| `memory_finalize_time_ms` |  9 |  9 |  9 |  9 |
| `stark_prove_excluding_trace_time_ms` |  4,588 |  4,588 |  4,588 |  4,588 |
| `main_trace_commit_time_ms` |  1,036 |  1,036 |  1,036 |  1,036 |
...
| `main_cells_used     ` |  41,517,582 |  41,517,582 |  41,517,582 |  41,517,582 |
| `total_cells_used    ` |  64,199,692 |  64,199,692 |  64,199,692 |  64,199,692 |
...
| `quotient_poly_compute_time_ms` |  750 |  750 |  750 |  750 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  91,805 |  91,805 |  91,805 |  91,805 |
| `main_cells_used     ` |  65,627,358 |  65,627,358 |  65,627,358 |  65,627,358 |

| halo2_wrapper |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  44,058 |  44,058 |  44,058 |  44,058 |
...
| `stark_prove_excluding_trace_time_ms` |  38,459 |  38,459 |  38,459 |  38,459 |
...
| `quotient_poly_commit_time_ms` |  13,672 |  13,672 |  13,672 |  13,672 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
|  | 0 | 119 | 64,199,692 | 119 | 0 | 91,818 | 44,058 | 22 | 8 | 41,517,582 | 172,079 | 304 | 772,521 | 5.17 | 15,568 | 39,597 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| halo2_keygen | 0 | 0 | 112 | 38,735 | 64,211,414 | 80,435,354 | 112 | 38,459 | 0 |  |  | 729 | 13,672 |  | 7,607 | 3,925 |  |  | 7 | 12,320 | 41,528,284 | 5,447,564 | 19,654 | 90 |  | 164 | 772,298 | 5.17 |  |  |  |  | 
| halo2_outer |  |  |  | 91,805 |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  | 65,627,358 |  |  |  |  |  |  |  |  |  |  |  | 
| halo2_wrapper |  |  |  | 44,058 |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  | 
| internal.0 |  |  |  |  |  |  |  |  |  |  | 6,285 |  |  |  |  |  | 3 |  |  |  |  |  |  |  | 2 |  |  |  |  |  |  |  | 
| kitchen_sink | 0 |  |  |  |  |  |  |  |  |  |  |  |  | 15,518 |  |  |  | 6 |  |  |  |  |  |  | 1 |  |  |  | 10 | 153,644 | 14.65 | 37 | 
| leaf |  |  |  |  |  |  |  |  |  | 23,668 |  |  |  |  |  |  | 1 |  |  |  |  |  |  |  | 1 |  |  |  |  |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal.0 | 0 | 0 | 195 | 6,283 | 143,466,213 | 224,975,330 | 195 | 4,588 | 0 | 617 | 734 | 750 | 1,251 | 9 | 1,036 | 79,528,047 | 195 |  | 497 | 1,197,833 | 3.53 | 
| leaf | 0 | 0 | 1,619 | 23,661 | 2,050,269,276 | 2,500,267,498 | 1,619 | 19,676 | 0 | 2,176 | 1,451 | 5,495 | 4,659 | 19 | 4,232 | 769,363,574 | 1,658 |  | 1,312 | 7,904,019 | 6.93 | 
| root | 0 | 0 | 119 | 38,579 | 64,199,692 | 80,435,354 | 119 | 38,295 | 0 | 750 | 13,663 | 7,586 | 3,892 | 9 | 12,312 | 41,517,582 | 86 | 3 | 165 | 772,521 | 5.17 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| kitchen_sink | 0 | 207 | 15,518 | 1,226,975,002 | 1,481,193,346 | 207 | 14,959 | 3 | 6,277 | 310 | 1,531 | 1,253 | 6 | 3 | 5,088 | 904,738,232 | 450 | 104 | 153,644 | 7.38 | 

...
| leaf |  21.49 |  21.49 |
| internal.0 |  4.84 |  4.84 |
| root |  38.58 |  38.58 |
| halo2_outer |  92.03 |  92.03 |
...
| `total_proof_time_ms ` |  14,356 |  14,356 |  14,356 |  14,356 |
...
| `stark_prove_excluding_trace_time_ms` |  14,111 |  14,111 |  14,111 |  14,111 |
| `main_trace_commit_time_ms` |  4,501 |  4,501 |  4,501 |  4,501 |
| `generate_perm_trace_time_ms` |  455 |  455 |  455 |  455 |
| `perm_trace_commit_time_ms` |  1,361 |  1,361 |  1,361 |  1,361 |
| `quotient_poly_compute_time_ms` |  6,260 |  6,260 |  6,260 |  6,260 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  21,487 |  21,487 |  21,487 |  21,487 |
| `main_cells_used     ` |  748,994,526 |  748,994,526 |  748,994,526 |  748,994,526 |
| `total_cells_used    ` |  2,003,007,024 |  2,003,007,024 |  2,003,007,024 |  2,003,007,024 |
| `insns               ` |  7,952,517 |  7,952,517 |  7,952,517 |  7,952,517 |
| `execute_e3_time_ms  ` |  1,560 |  1,560 |  1,560 |  1,560 |
| `execute_e3_insn_mi/s` |  5.10 | -          |  5.10 |  5.10 |
| `trace_gen_time_ms   ` |  1,656 |  1,656 |  1,656 |  1,656 |
| `memory_finalize_time_ms` |  18 |  18 |  18 |  18 |
| `boundary_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  18,271 |  18,271 |  18,271 |  18,271 |
| `main_trace_commit_time_ms` |  3,761 |  3,761 |  3,761 |  3,761 |
| `generate_perm_trace_time_ms` |  1,648 |  1,648 |  1,648 |  1,648 |
...
| `main_cells_used     ` |  75,193,287 |  75,193,287 |  75,193,287 |  75,193,287 |
| `total_cells_used    ` |  134,680,941 |  134,680,941 |  134,680,941 |  134,680,941 |
| `insns               ` |  1,197,758 |  1,197,758 |  1,197,758 |  1,197,758 |
| `execute_e3_time_ms  ` |  372 |  372 |  372 |  372 |
| `execute_e3_insn_mi/s` |  3.21 | -          |  3.21 |  3.21 |
| `trace_gen_time_ms   ` |  187 |  187 |  187 |  187 |
| `memory_finalize_time_ms` |  8 |  8 |  8 |  8 |
| `boundary_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  4,277 |  4,277 |  4,277 |  4,277 |
...
| `main_cells_used     ` |  40,016,734 |  40,016,734 |  40,016,734 |  40,016,734 |
| `total_cells_used    ` |  61,675,904 |  61,675,904 |  61,675,904 |  61,675,904 |
| `insns               ` |  772,556 |  772,556 |  772,556 |  772,556 |
...
| `boundary_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  38,291 |  38,291 |  38,291 |  38,291 |
...
| `quotient_poly_commit_time_ms` |  13,650 |  13,650 |  13,650 |  13,650 |
| `pcs_opening_time_ms ` |  3,927 |  3,927 |  3,927 |  3,927 |

| halo2_outer |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  92,034 |  92,034 |  92,034 |  92,034 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
|  | 117 | 61,675,904 | 116 | 2 | 92,048 | 44,237 | 7 | 40,016,734 | 772,556 | 168 | 4.58 | 0 | 14,741 | 39,622 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| halo2_outer | 92,034 |  |  |  |  |  | 65,627,358 |  |  |  |  |  | 
| halo2_wrapper | 44,237 |  |  |  |  |  |  |  |  |  |  |  | 
| internal.0 |  |  | 6,019 |  | 3 |  |  |  | 2 |  |  |  | 
| kitchen_sink |  |  |  | 14,686 |  | 8 |  | 154,596 | 1 | 10 | 14.72 | 39 | 
| leaf |  | 22,753 |  |  | 1 |  |  |  | 1 |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal.0 | 0 | 187 | 4,836 | 134,680,941 | 224,975,330 | 185 | 4,277 | 2 | 618 | 672 | 664 | 1,222 | 8 | 902 | 75,193,287 | 1,197,758 | 193 |  | 372 | 3.21 | 0 | 
| leaf | 0 | 1,656 | 21,487 | 2,003,007,024 | 2,500,267,498 | 1,645 | 18,271 | 2 | 2,137 | 1,309 | 4,804 | 4,602 | 18 | 3,761 | 748,994,526 | 7,952,517 | 1,648 |  | 1,560 | 5.10 | 0 | 
| root | 0 | 117 | 38,579 | 61,675,904 | 80,435,354 | 116 | 38,291 | 2 | 702 | 13,650 | 7,574 | 3,927 | 7 | 12,306 | 40,016,734 | 772,556 | 88 | 3 | 171 | 4.51 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| kitchen_sink | 0 | 212 | 14,356 | 1,217,691,116 | 1,481,195,122 | 210 | 14,111 | 2 | 6,260 | 284 | 1,361 | 1,204 | 64 | 8 | 2 | 4,501 | 899,580,290 | 154,596 | 455 | 33 | 4.59 | 0 | 

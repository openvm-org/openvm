...
| `stark_prove_excluding_trace_time_ms` |  14,247 |  14,247 |  14,247 |  14,247 |
| `main_trace_commit_time_ms` |  4,477 |  4,477 |  4,477 |  4,477 |
| `generate_perm_trace_time_ms` |  566 |  566 |  566 |  566 |
...
| `generate_perm_trace_time_ms` |  1,683 |  1,683 |  1,683 |  1,683 |
| `perm_trace_commit_time_ms` |  4,799 |  4,799 |  4,799 |  4,799 |
| `quotient_poly_compute_time_ms` |  2,129 |  2,129 |  2,129 |  2,129 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `main_cells_used     ` |  75,194,715 |  75,194,715 |  75,194,715 |  75,194,715 |
| `total_cells_used    ` |  134,684,273 |  134,684,273 |  134,684,273 |  134,684,273 |
| `insns               ` |  1,197,877 |  1,197,877 |  1,197,877 |  1,197,877 |
| `execute_e3_time_ms  ` |  484 |  484 |  484 |  484 |
| `execute_e3_insn_mi/s` |  2.47 | -          |  2.47 |  2.47 |
| `memory_finalize_time_ms` |  8 |  8 |  8 |  8 |
| `boundary_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  4,275 |  4,275 |  4,275 |  4,275 |
...
| `pcs_opening_time_ms ` |  3,993 |  3,993 |  3,993 |  3,993 |

| halo2_outer |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  95,327 |  95,327 |  95,327 |  95,327 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
|  | 114 | 61,676,720 | 95,341 | 44,140 | 7 | 40,017,142 | 772,590 | 211 | 3.66 | 0 | 16,087 | 39,781 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| halo2_outer | 95,327 |  |  |  |  |  | 65,627,358 |  |  |  |  |  | 
| halo2_wrapper | 44,140 |  |  |  |  |  |  |  |  |  |  |  | 
| internal.0 |  |  | 6,165 |  | 3 |  |  |  | 2 |  |  |  | 
| kitchen_sink |  |  |  | 16,009 |  | 23 |  | 154,596 | 1 | 10 | 14.17 | 53 | 
| leaf |  | 23,625 |  |  | 1 |  |  |  | 1 |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal.0 | 0 | 182 | 134,684,273 | 224,975,330 | 4,275 | 603 | 673 | 652 | 1,232 | 8 | 914 | 75,194,715 | 1,197,877 | 196 |  | 484 | 2.47 | 0 | 
| leaf | 0 | 1,673 | 2,003,005,464 | 2,500,267,498 | 18,344 | 2,129 | 1,317 | 4,799 | 4,650 | 15 | 3,761 | 748,994,058 | 7,952,478 | 1,683 |  | 2,397 | 3.32 | 0 | 
| root | 0 | 114 | 61,676,720 | 80,435,354 | 38,380 | 722 | 13,631 | 7,585 | 3,993 | 7 | 12,312 | 40,017,142 | 772,590 | 88 | 3 | 212 | 3.63 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| kitchen_sink | 0 | 220 | 1,217,690,534 | 1,481,195,122 | 14,247 | 6,261 | 283 | 1,360 | 1,254 | 78 | 23 | 3 | 4,477 | 899,579,940 | 154,596 | 566 | 36 | 4.18 | 0 | 

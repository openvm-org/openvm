...
| `total_proof_time_ms ` |  15,496 |  15,496 |  15,496 |  15,496 |
...
| `execute_metered_insn_mi/s` |  14.62 | -          |  14.62 |  14.62 |
...
| `stark_prove_excluding_trace_time_ms` |  14,939 |  14,939 |  14,939 |  14,939 |
| `main_trace_commit_time_ms` |  5,093 |  5,093 |  5,093 |  5,093 |
| `generate_perm_trace_time_ms` |  461 |  461 |  461 |  461 |
| `perm_trace_commit_time_ms` |  1,534 |  1,534 |  1,534 |  1,534 |
| `quotient_poly_compute_time_ms` |  6,266 |  6,266 |  6,266 |  6,266 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  23,593 |  23,593 |  23,593 |  23,593 |
| `main_cells_used     ` |  769,362,866 |  769,362,866 |  769,362,866 |  769,362,866 |
| `total_cells_used    ` |  2,050,266,916 |  2,050,266,916 |  2,050,266,916 |  2,050,266,916 |
| `execute_preflight_insns` |  7,903,960 |  7,903,960 |  7,903,960 |  7,903,960 |
...
| `stark_prove_excluding_trace_time_ms` |  19,604 |  19,604 |  19,604 |  19,604 |
| `main_trace_commit_time_ms` |  4,236 |  4,236 |  4,236 |  4,236 |
| `generate_perm_trace_time_ms` |  1,699 |  1,699 |  1,699 |  1,699 |
| `perm_trace_commit_time_ms` |  5,478 |  5,478 |  5,478 |  5,478 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  6,317 |  6,317 |  6,317 |  6,317 |
| `main_cells_used     ` |  79,526,907 |  79,526,907 |  79,526,907 |  79,526,907 |
| `total_cells_used    ` |  143,463,553 |  143,463,553 |  143,463,553 |  143,463,553 |
| `execute_preflight_insns` |  1,197,738 |  1,197,738 |  1,197,738 |  1,197,738 |
| `execute_preflight_time_ms` |  483 |  483 |  483 |  483 |
| `execute_preflight_insn_mi/s` |  3.64 | -          |  3.64 |  3.64 |
| `trace_gen_time_ms   ` |  189 |  189 |  189 |  189 |
| `memory_finalize_time_ms` |  9 |  9 |  9 |  9 |
| `stark_prove_excluding_trace_time_ms` |  4,639 |  4,639 |  4,639 |  4,639 |
| `main_trace_commit_time_ms` |  1,041 |  1,041 |  1,041 |  1,041 |
...
| `pcs_opening_time_ms ` |  1,253 |  1,253 |  1,253 |  1,253 |

| root |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  38,626 |  38,626 |  38,626 |  38,626 |
| `main_cells_used     ` |  41,518,350 |  41,518,350 |  41,518,350 |  41,518,350 |
| `total_cells_used    ` |  64,201,228 |  64,201,228 |  64,201,228 |  64,201,228 |
...
| `stark_prove_excluding_trace_time_ms` |  38,345 |  38,345 |  38,345 |  38,345 |
...
| `quotient_poly_commit_time_ms` |  13,684 |  13,684 |  13,684 |  13,684 |
| `pcs_opening_time_ms ` |  3,878 |  3,878 |  3,878 |  3,878 |

| halo2_outer |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  90,971 |  90,971 |  90,971 |  90,971 |
...
| `quotient_poly_commit_time_ms` |  13,648 |  13,648 |  13,648 |  13,648 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
|  | 0 | 120 | 64,201,228 | 120 | 0 | 90,985 | 44,065 | 23 | 8 | 41,518,350 | 173,840 | 296 | 772,585 | 5.44 | 15,546 | 39,631 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| halo2_keygen | 0 | 0 | 115 | 38,561 | 64,212,446 | 80,435,354 | 115 | 38,289 | 0 |  |  | 711 | 13,648 |  | 7,584 | 3,929 |  |  | 8 | 12,319 | 41,528,800 | 5,447,564 | 19,731 | 91 |  | 157 | 772,341 | 5.41 |  |  |  |  | 
| halo2_outer |  |  |  | 90,971 |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  | 65,627,358 |  |  |  |  |  |  |  |  |  |  |  | 
| halo2_wrapper |  |  |  | 44,065 |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  | 
| internal.0 |  |  |  |  |  |  |  |  |  |  | 6,319 |  |  |  |  |  | 3 |  |  |  |  |  |  |  | 2 |  |  |  |  |  |  |  | 
| kitchen_sink | 0 |  |  |  |  |  |  |  |  |  |  |  |  | 15,496 |  |  |  | 6 |  |  |  |  |  |  | 1 |  |  |  | 10 | 153,644 | 14.62 | 36 | 
| leaf |  |  |  |  |  |  |  |  |  | 23,600 |  |  |  |  |  |  | 1 |  |  |  |  |  |  |  | 1 |  |  |  |  |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal.0 | 0 | 0 | 189 | 6,317 | 143,463,553 | 224,975,330 | 189 | 4,639 | 0 | 627 | 736 | 782 | 1,253 | 9 | 1,041 | 79,526,907 | 197 |  | 483 | 1,197,738 | 3.64 | 
| leaf | 0 | 0 | 1,640 | 23,593 | 2,050,266,916 | 2,500,267,498 | 1,640 | 19,604 | 0 | 2,121 | 1,456 | 5,478 | 4,609 | 16 | 4,236 | 769,362,866 | 1,699 |  | 1,303 | 7,903,960 | 6.95 | 
| root | 0 | 0 | 120 | 38,626 | 64,201,228 | 80,435,354 | 120 | 38,345 | 0 | 688 | 13,684 | 7,684 | 3,878 | 8 | 12,297 | 41,518,350 | 104 | 3 | 161 | 772,585 | 5.25 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| kitchen_sink | 0 | 207 | 15,496 | 1,226,975,002 | 1,481,193,346 | 207 | 14,939 | 3 | 6,266 | 309 | 1,534 | 1,230 | 6 | 3 | 5,093 | 904,738,232 | 461 | 102 | 153,644 | 7.37 | 

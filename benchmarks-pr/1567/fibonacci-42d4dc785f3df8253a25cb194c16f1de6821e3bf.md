...
| `total_proof_time_ms ` |  2,304 |  2,304 |  2,304 |  2,304 |
| `main_cells_used     ` |  50,589,503 |  50,589,503 |  50,589,503 |  50,589,503 |
| `total_cycles        ` |  1,500,277 |  1,500,277 |  1,500,277 |  1,500,277 |
| `execute_metered_time_ms` |  119 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  12.53 | -          | -          | -          |
| `execute_e3_time_ms  ` |  178 |  178 |  178 |  178 |
| `execute_e3_insn_mi/s` |  8.40 | -          |  8.40 |  8.40 |
...
| `perm_trace_commit_time_ms` |  383 |  383 |  383 |  383 |
| `quotient_poly_compute_time_ms` |  168 |  168 |  168 |  168 |
...
| `main_cells_used     ` |  69,834,170 |  69,834,170 |  69,834,170 |  69,834,170 |
| `total_cycles        ` |  1,248,044 |  1,248,044 |  1,248,044 |  1,248,044 |
| `execute_metered_time_ms` |  548 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  2.27 | -          | -          | -          |
| `execute_e3_time_ms  ` |  573 |  573 |  573 |  573 |
| `execute_e3_insn_mi/s` |  2.18 | -          |  2.18 |  2.18 |
| `trace_gen_time_ms   ` |  198 |  198 |  198 |  198 |
| `memory_finalize_time_ms` |  22 |  22 |  22 |  22 |
| `boundary_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  2,493 |  2,493 |  2,493 |  2,493 |
...
| `quotient_poly_compute_time_ms` |  280 |  280 |  280 |  280 |
| `quotient_poly_commit_time_ms` |  239 |  239 |  239 |  239 |
| `pcs_opening_time_ms ` |  731 |  731 |  731 |  731 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 1 |  | 282 | 1,500,278 | 1 | 119 | 12.53 | 5 | 
| leaf |  | 1 |  |  | 1 |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 198 | 3,812 | 1,248,044 | 253,173,226 | 2,493 | 280 | 239 | 573 | 731 | 22 | 460 | 69,834,170 | 1,248,045 | 203 | 548 | 2.27 | 573 | 2.18 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 229 | 2,304 | 1,500,277 | 160,837,996 | 1,897 | 168 | 206 | 383 | 626 | 25 | 32 | 361 | 50,589,503 | 1,500,278 | 143 | 178 | 8.40 | 0 | 

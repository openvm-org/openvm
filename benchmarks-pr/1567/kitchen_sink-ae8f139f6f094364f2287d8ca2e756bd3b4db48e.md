...
|:---|---:|---:|
| Total |  216.36 |  216.36 |
| kitchen_sink |  15.53 |  15.53 |
| leaf |  23.49 |  23.49 |
| internal.0 |  6.24 |  6.24 |
| root |  38.53 |  38.53 |
| halo2_outer |  88.33 |  88.33 |
...
| `total_proof_time_ms ` |  15,525 |  15,525 |  15,525 |  15,525 |
...
| `execute_preflight_insn_mi/s` |  7.41 | -          |  7.41 |  7.41 |
| `trace_gen_time_ms   ` |  208 |  208 |  208 |  208 |
| `memory_finalize_time_ms` |  2 |  2 |  2 |  2 |
| `stark_prove_excluding_trace_time_ms` |  14,966 |  14,966 |  14,966 |  14,966 |
| `main_trace_commit_time_ms` |  5,089 |  5,089 |  5,089 |  5,089 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  23,486 |  23,486 |  23,486 |  23,486 |
| `main_cells_used     ` |  769,362,206 |  769,362,206 |  769,362,206 |  769,362,206 |
| `total_cells_used    ` |  2,050,264,716 |  2,050,264,716 |  2,050,264,716 |  2,050,264,716 |
| `execute_preflight_insns` |  7,903,905 |  7,903,905 |  7,903,905 |  7,903,905 |
| `execute_preflight_time_ms` |  1,304 |  1,304 |  1,304 |  1,304 |
| `execute_preflight_insn_mi/s` |  6.99 | -          |  6.99 |  6.99 |
| `trace_gen_time_ms   ` |  1,590 |  1,590 |  1,590 |  1,590 |
| `memory_finalize_time_ms` |  20 |  20 |  20 |  20 |
| `stark_prove_excluding_trace_time_ms` |  19,533 |  19,533 |  19,533 |  19,533 |
...
| `main_cells_used     ` |  79,527,483 |  79,527,483 |  79,527,483 |  79,527,483 |
| `total_cells_used    ` |  143,464,897 |  143,464,897 |  143,464,897 |  143,464,897 |
| `execute_preflight_insns` |  1,197,786 |  1,197,786 |  1,197,786 |  1,197,786 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  38,535 |  38,535 |  38,535 |  38,535 |
...
| `quotient_poly_commit_time_ms` |  13,627 |  13,627 |  13,627 |  13,627 |
| `pcs_opening_time_ms ` |  3,872 |  3,872 |  3,872 |  3,872 |

| halo2_outer |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  88,327 |  88,327 |  88,327 |  88,327 |
| `main_cells_used     ` |  65,627,358 |  65,627,358 |  65,627,358 |  65,627,358 |

| halo2_wrapper |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  44,238 |  44,238 |  44,238 |  44,238 |
...
| `quotient_poly_commit_time_ms` |  13,750 |  13,750 |  13,750 |  13,750 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
|  | 0 | 114 | 64,200,868 | 114 | 0 | 88,341 | 44,238 | 20 | 8 | 41,518,170 | 172,461 | 303 | 772,570 | 5.28 | 15,575 | 39,530 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| halo2_keygen | 0 | 0 | 112 | 38,602 | 64,211,534 | 80,435,354 | 112 | 38,329 | 0 |  |  | 685 | 13,750 |  | 7,592 | 3,895 |  |  | 8 | 12,313 | 41,528,344 | 5,447,564 | 18,997 | 86 |  | 161 | 772,303 | 5.26 |  |  |  |  | 
| halo2_outer |  |  |  | 88,327 |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  | 65,627,358 |  |  |  |  |  |  |  |  |  |  |  | 
| halo2_wrapper |  |  |  | 44,238 |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  | 
| internal.0 |  |  |  |  |  |  |  |  |  |  | 6,241 |  |  |  |  |  | 3 |  |  |  |  |  |  |  | 2 |  |  |  |  |  |  |  | 
| kitchen_sink | 0 |  |  |  |  |  |  |  |  |  |  |  |  | 15,525 |  |  |  | 6 |  |  |  |  |  |  | 1 |  |  |  | 10 | 153,644 | 14.62 | 37 | 
| leaf |  |  |  |  |  |  |  |  |  | 23,493 |  |  |  |  |  |  | 1 |  |  |  |  |  |  |  | 1 |  |  |  |  |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal.0 | 0 | 0 | 186 | 6,239 | 143,464,897 | 224,975,330 | 186 | 4,545 | 0 | 595 | 743 | 748 | 1,239 | 10 | 1,025 | 79,527,483 | 189 |  | 492 | 1,197,786 | 3.58 | 
| leaf | 0 | 0 | 1,590 | 23,486 | 2,050,264,716 | 2,500,267,498 | 1,590 | 19,533 | 0 | 2,113 | 1,453 | 5,488 | 4,645 | 20 | 4,211 | 769,362,206 | 1,616 |  | 1,304 | 7,903,905 | 6.99 | 
| root | 0 | 0 | 113 | 38,535 | 64,200,868 | 80,435,354 | 113 | 38,261 | 0 | 748 | 13,627 | 7,585 | 3,872 | 8 | 12,309 | 41,518,170 | 91 | 3 | 161 | 772,570 | 5.25 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| kitchen_sink | 0 | 208 | 15,525 | 1,226,975,002 | 1,481,193,346 | 208 | 14,966 | 3 | 6,265 | 309 | 1,526 | 1,237 | 6 | 2 | 5,089 | 904,738,232 | 496 | 103 | 153,644 | 7.41 | 

...
| `total_proof_time_ms ` |  3,403.50 |  6,807 |  3,718 |  3,089 |
| `main_cells_used     ` |  83,259,728 |  166,519,456 |  93,502,324 |  73,017,132 |
| `total_cycles        ` |  2,082,716 |  4,165,432 |  2,243,700 |  1,921,732 |
| `execute_metered_time_ms` |  557 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  7.47 | -          | -          | -          |
| `execute_e3_time_ms  ` |  286 |  572 |  311 |  261 |
| `execute_e3_insn_mi/s` |  7.28 | -          |  7.36 |  7.19 |
| `trace_gen_time_ms   ` |  502.50 |  1,005 |  580 |  425 |
| `memory_finalize_time_ms` |  228 |  456 |  286 |  170 |
| `boundary_finalize_time_ms` |  3 |  6 |  6 |  0 |
| `merkle_finalize_time_ms` |  211.50 |  423 |  261 |  162 |
| `stark_prove_excluding_trace_time_ms` |  2,615 |  5,230 |  2,827 |  2,403 |
| `main_trace_commit_time_ms` |  506.50 |  1,013 |  569 |  444 |
| `generate_perm_trace_time_ms` |  224.50 |  449 |  234 |  215 |
| `perm_trace_commit_time_ms` |  572.50 |  1,145 |  628 |  517 |
| `quotient_poly_compute_time_ms` |  268 |  536 |  287 |  249 |
| `quotient_poly_commit_time_ms` |  240 |  480 |  274 |  206 |
| `pcs_opening_time_ms ` |  794.50 |  1,589 |  829 |  760 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  6,012 |  12,024 |  7,725 |  4,299 |
| `main_cells_used     ` |  114,459,247.50 |  228,918,495 |  146,194,829 |  82,723,666 |
| `total_cycles        ` |  1,674,526.50 |  3,349,053 |  1,867,649 |  1,481,404 |
| `execute_metered_time_ms` |  1,126.50 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  1.79 | -          | -          | -          |
| `execute_e3_time_ms  ` |  769 |  1,538 |  902 |  636 |
| `execute_e3_insn_mi/s` |  2.20 | -          |  2.33 |  2.07 |
| `trace_gen_time_ms   ` |  336.50 |  673 |  421 |  252 |
| `memory_finalize_time_ms` |  47.50 |  95 |  72 |  23 |
| `boundary_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  3,780 |  7,560 |  4,752 |  2,808 |
| `main_trace_commit_time_ms` |  724 |  1,448 |  865 |  583 |
| `generate_perm_trace_time_ms` |  315.50 |  631 |  416 |  215 |
| `perm_trace_commit_time_ms` |  958.50 |  1,917 |  1,251 |  666 |
| `quotient_poly_compute_time_ms` |  413.50 |  827 |  519 |  308 |
| `quotient_poly_commit_time_ms` |  329.50 |  659 |  408 |  251 |
| `pcs_opening_time_ms ` |  1,035 |  2,070 |  1,289 |  781 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf |  | 1 |  |  | 1 |  |  |  | 
| regex_program | 2 |  | 582 | 4,165,433 | 1 | 557 | 7.47 | 19 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 252 | 4,299 | 1,481,404 | 319,626,730 | 2,808 | 308 | 251 | 666 | 781 | 23 | 583 | 82,723,666 | 1,481,405 | 215 | 603 | 2.45 | 636 | 2.33 | 0 | 
| leaf | 1 | 421 | 7,725 | 1,867,649 | 538,660,330 | 4,752 | 519 | 408 | 1,251 | 1,289 | 72 | 865 | 146,194,829 | 1,867,650 | 416 | 1,650 | 1.13 | 902 | 2.07 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 580 | 3,718 | 2,243,700 | 275,648,700 | 2,827 | 287 | 274 | 628 | 829 | 261 | 286 | 569 | 93,502,324 | 2,243,700 | 234 | 311 | 7.19 | 6 | 
| regex_program | 1 | 425 | 3,089 | 1,921,732 | 242,975,388 | 2,403 | 249 | 206 | 517 | 760 | 162 | 170 | 444 | 73,017,132 | 1,921,733 | 215 | 261 | 7.36 | 0 | 

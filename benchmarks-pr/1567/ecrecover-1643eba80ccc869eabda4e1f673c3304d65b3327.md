...
| `total_proof_time_ms ` |  1,118 |  1,118 |  1,118 |  1,118 |
...
| `execute_metered_insn_mi/s` |  19.69 | -          |  19.69 |  19.69 |
| `execute_e3_time_ms  ` |  82 |  82 |  82 |  82 |
| `execute_e3_insn_mi/s` |  1.67 | -          |  1.67 |  1.67 |
| `trace_gen_time_ms   ` | <span style='color: green'>(-14 [-12.5%])</span> 98 | <span style='color: green'>(-14 [-12.5%])</span> 98 | <span style='color: green'>(-14 [-12.5%])</span> 98 | <span style='color: green'>(-14 [-12.5%])</span> 98 |
...
| `perm_trace_commit_time_ms` |  125 |  125 |  125 |  125 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  9,794 |  9,794 |  9,794 |  9,794 |
| `main_cells_used     ` | <span style='color: red'>(+1573284 [+0.6%])</span> 246,667,636 | <span style='color: red'>(+1573284 [+0.6%])</span> 246,667,636 | <span style='color: red'>(+1573284 [+0.6%])</span> 246,667,636 | <span style='color: red'>(+1573284 [+0.6%])</span> 246,667,636 |
| `total_cells_used    ` |  645,428,394 |  645,428,394 |  645,428,394 |  645,428,394 |
| `insns               ` |  2,934,923 |  2,934,923 |  2,934,923 |  2,934,923 |
...
| `boundary_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+58 [+0.7%])</span> 8,212 | <span style='color: red'>(+58 [+0.7%])</span> 8,212 | <span style='color: red'>(+58 [+0.7%])</span> 8,212 | <span style='color: red'>(+58 [+0.7%])</span> 8,212 |
| `main_trace_commit_time_ms` | <span style='color: red'>(+11 [+0.7%])</span> 1,521 | <span style='color: red'>(+11 [+0.7%])</span> 1,521 | <span style='color: red'>(+11 [+0.7%])</span> 1,521 | <span style='color: red'>(+11 [+0.7%])</span> 1,521 |
| `generate_perm_trace_time_ms` | <span style='color: red'>(+11 [+1.4%])</span> 794 | <span style='color: red'>(+11 [+1.4%])</span> 794 | <span style='color: red'>(+11 [+1.4%])</span> 794 | <span style='color: red'>(+11 [+1.4%])</span> 794 |
...
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+18 [+1.9%])</span> 944 | <span style='color: red'>(+18 [+1.9%])</span> 944 | <span style='color: red'>(+18 [+1.9%])</span> 944 | <span style='color: red'>(+18 [+1.9%])</span> 944 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+8 [+1.3%])</span> 645 | <span style='color: red'>(+8 [+1.3%])</span> 645 | <span style='color: red'>(+8 [+1.3%])</span> 645 | <span style='color: red'>(+8 [+1.3%])</span> 645 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+30 [+1.4%])</span> 2,213 | <span style='color: red'>(+30 [+1.4%])</span> 2,213 | <span style='color: red'>(+30 [+1.4%])</span> 2,213 | <span style='color: red'>(+30 [+1.4%])</span> 2,213 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program |  | 1,612 |  | 10 | 137,284 | 1 | 6 | 19.69 | 43 | 
| leaf | 10,879 |  | 1 |  |  | 1 |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 591 | 9,794 | 645,428,394 | 992,054,762 | 8,212 | 944 | 645 | 2,091 | 2,213 | 12 | 1,521 | 246,667,636 | 2,934,923 | 794 | 991 | 2.96 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 98 | 1,118 | 25,968,337 | 32,925,330 | 938 | 78 | 129 | 125 | 426 | 59 | 11 | 3 | 135 | 8,596,011 | 137,284 | 30 | 82 | 1.67 | 0 | 

...
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+79 [+8.7%])</span> 989 | <span style='color: red'>(+79 [+8.7%])</span> 989 | <span style='color: red'>(+79 [+8.7%])</span> 989 | <span style='color: red'>(+79 [+8.7%])</span> 989 |
...
| `generate_perm_trace_time_ms` | <span style='color: green'>(-7 [-18.9%])</span> 30 | <span style='color: green'>(-7 [-18.9%])</span> 30 | <span style='color: green'>(-7 [-18.9%])</span> 30 | <span style='color: green'>(-7 [-18.9%])</span> 30 |
| `perm_trace_commit_time_ms` | <span style='color: red'>(+16 [+13.4%])</span> 135 | <span style='color: red'>(+16 [+13.4%])</span> 135 | <span style='color: red'>(+16 [+13.4%])</span> 135 | <span style='color: red'>(+16 [+13.4%])</span> 135 |
...
| `pcs_opening_time_ms ` | <span style='color: red'>(+46 [+11.4%])</span> 451 | <span style='color: red'>(+46 [+11.4%])</span> 451 | <span style='color: red'>(+46 [+11.4%])</span> 451 | <span style='color: red'>(+46 [+11.4%])</span> 451 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  10,848 |  10,848 |  10,848 |  10,848 |
| `main_cells_used     ` | <span style='color: red'>(+3647772 [+1.5%])</span> 247,226,574 | <span style='color: red'>(+3647772 [+1.5%])</span> 247,226,574 | <span style='color: red'>(+3647772 [+1.5%])</span> 247,226,574 | <span style='color: red'>(+3647772 [+1.5%])</span> 247,226,574 |
| `total_cells_used    ` |  646,606,572 |  646,606,572 |  646,606,572 |  646,606,572 |
| `execute_preflight_insns` |  2,934,903 |  2,934,903 |  2,934,903 |  2,934,903 |
| `execute_preflight_time_ms` |  569 |  569 |  569 |  569 |
| `execute_preflight_insn_mi/s` |  5.39 | -          |  5.39 |  5.39 |
| `trace_gen_time_ms   ` | <span style='color: green'>(-1739 [-73.7%])</span> 621 | <span style='color: green'>(-1739 [-73.7%])</span> 621 | <span style='color: green'>(-1739 [-73.7%])</span> 621 | <span style='color: green'>(-1739 [-73.7%])</span> 621 |
| `memory_finalize_time_ms` |  15 |  15 |  15 |  15 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+417 [+5.1%])</span> 8,588 | <span style='color: red'>(+417 [+5.1%])</span> 8,588 | <span style='color: red'>(+417 [+5.1%])</span> 8,588 | <span style='color: red'>(+417 [+5.1%])</span> 8,588 |
| `main_trace_commit_time_ms` | <span style='color: red'>(+145 [+9.6%])</span> 1,656 | <span style='color: red'>(+145 [+9.6%])</span> 1,656 | <span style='color: red'>(+145 [+9.6%])</span> 1,656 | <span style='color: red'>(+145 [+9.6%])</span> 1,656 |
| `generate_perm_trace_time_ms` | <span style='color: red'>(+1 [+0.1%])</span> 790 | <span style='color: red'>(+1 [+0.1%])</span> 790 | <span style='color: red'>(+1 [+0.1%])</span> 790 | <span style='color: red'>(+1 [+0.1%])</span> 790 |
| `perm_trace_commit_time_ms` | <span style='color: red'>(+203 [+9.6%])</span> 2,316 | <span style='color: red'>(+203 [+9.6%])</span> 2,316 | <span style='color: red'>(+203 [+9.6%])</span> 2,316 | <span style='color: red'>(+203 [+9.6%])</span> 2,316 |
| `quotient_poly_compute_time_ms` | <span style='color: green'>(-10 [-1.1%])</span> 899 | <span style='color: green'>(-10 [-1.1%])</span> 899 | <span style='color: green'>(-10 [-1.1%])</span> 899 | <span style='color: green'>(-10 [-1.1%])</span> 899 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+53 [+8.3%])</span> 692 | <span style='color: red'>(+53 [+8.3%])</span> 692 | <span style='color: red'>(+53 [+8.3%])</span> 692 | <span style='color: red'>(+53 [+8.3%])</span> 692 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+25 [+1.1%])</span> 2,231 | <span style='color: red'>(+25 [+1.1%])</span> 2,231 | <span style='color: red'>(+25 [+1.1%])</span> 2,231 | <span style='color: red'>(+25 [+1.1%])</span> 2,231 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program |  | 1,416 |  | 6 | 1 | 6 | 140,487 | 20.40 | 38 | 
| leaf | 10,850 |  | 1 |  | 1 |  |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 621 | 10,848 | 646,606,572 | 992,054,762 | 621 | 8,588 | 0 | 899 | 692 | 2,316 | 2,231 | 15 | 1,656 | 247,226,574 | 790 | 569 | 2,934,903 | 5.39 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 94 | 1,416 | 26,518,220 | 32,927,986 | 94 | 989 | 0 | 82 | 131 | 135 | 451 | 7 | 2 | 144 | 8,866,654 | 30 | 83 | 140,487 | 1.82 | 

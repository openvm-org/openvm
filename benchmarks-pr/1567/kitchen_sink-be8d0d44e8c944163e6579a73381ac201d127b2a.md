...
| `total_proof_time_ms ` |  14,446 |  14,446 |  14,446 |  14,446 |
...
| `quotient_poly_compute_time_ms` |  6,258 |  6,258 |  6,258 |  6,258 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  21,294 |  21,294 |  21,294 |  21,294 |
| `main_cells_used     ` |  769,363,850 |  769,363,850 |  769,363,850 |  769,363,850 |
| `total_cells_used    ` |  2,050,270,196 |  2,050,270,196 |  2,050,270,196 |  2,050,270,196 |
| `insns               ` |  7,904,042 |  7,904,042 |  7,904,042 |  7,904,042 |
| `execute_preflight_time_ms` |  1,340 |  1,340 |  1,340 |  1,340 |
| `execute_preflight_insn_mi/s` |  6.85 | -          |  6.85 |  6.85 |
| `trace_gen_time_ms   ` |  1,633 |  1,633 |  1,633 |  1,633 |
| `memory_finalize_time_ms` |  19 |  19 |  19 |  19 |
| `stark_prove_excluding_trace_time_ms` |  18,321 |  18,321 |  18,321 |  18,321 |
...
| `quotient_poly_compute_time_ms` |  2,154 |  2,154 |  2,154 |  2,154 |
| `quotient_poly_commit_time_ms` |  1,319 |  1,319 |  1,319 |  1,319 |
| `pcs_opening_time_ms ` |  4,610 |  4,610 |  4,610 |  4,610 |

| internal.0 |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  5,044 |  5,044 |  5,044 |  5,044 |
| `main_cells_used     ` |  79,527,111 |  79,527,111 |  79,527,111 |  79,527,111 |
| `total_cells_used    ` |  143,464,029 |  143,464,029 |  143,464,029 |  143,464,029 |
| `insns               ` |  1,197,755 |  1,197,755 |  1,197,755 |  1,197,755 |
| `execute_preflight_time_ms` |  498 |  498 |  498 |  498 |
...
| `stark_prove_excluding_trace_time_ms` |  38,347 |  38,347 |  38,347 |  38,347 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  95,502 |  95,502 |  95,502 |  95,502 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
|  | 112 | 64,200,124 | 112 | 0 | 95,515 | 44,635 | 8 | 41,517,798 | 772,539 | 298 | 5.38 | 14,745 | 39,664 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| halo2_outer | 95,502 |  |  |  |  |  | 65,627,358 |  |  |  |  |  | 
| halo2_wrapper | 44,635 |  |  |  |  |  |  |  |  |  |  |  | 
| internal.0 |  |  | 6,069 |  | 3 |  |  |  | 2 |  |  |  | 
| kitchen_sink |  |  |  | 14,693 |  | 6 |  | 153,644 | 1 | 10 | 14.63 | 36 | 
| leaf |  | 22,377 |  |  | 1 |  |  |  | 1 |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal.0 | 0 | 196 | 5,044 | 143,464,029 | 224,975,330 | 196 | 4,350 | 0 | 608 | 729 | 656 | 1,237 | 9 | 919 | 79,527,111 | 1,197,755 | 195 |  | 498 | 3.48 | 
| leaf | 0 | 1,633 | 21,294 | 2,050,270,196 | 2,500,267,498 | 1,633 | 18,321 | 0 | 2,154 | 1,319 | 4,811 | 4,610 | 19 | 3,758 | 769,363,850 | 7,904,042 | 1,659 |  | 1,340 | 6.85 | 
| root | 0 | 112 | 38,625 | 64,200,124 | 80,435,354 | 112 | 38,347 | 0 | 706 | 13,699 | 7,589 | 3,911 | 7 | 12,314 | 41,517,798 | 772,539 | 93 | 3 | 166 | 5.11 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| kitchen_sink | 0 | 209 | 14,446 | 1,226,975,002 | 1,481,193,346 | 209 | 14,134 | 3 | 6,258 | 285 | 1,363 | 1,218 | 6 | 3 | 4,501 | 904,738,232 | 153,644 | 463 | 103 | 7.33 | 

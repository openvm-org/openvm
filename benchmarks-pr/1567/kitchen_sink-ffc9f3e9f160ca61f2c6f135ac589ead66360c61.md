...
|:---|---:|---:|
| Total |  217.22 |  217.22 |
| kitchen_sink |  15.02 |  15.02 |
| leaf |  23.51 |  23.51 |
| internal.0 |  5.23 |  5.23 |
| root |  38.59 |  38.59 |
| halo2_outer |  90.27 |  90.27 |
...
| `total_proof_time_ms ` |  15,019 |  15,019 |  15,019 |  15,019 |
...
| `execute_metered_insn_mi/s` |  14.70 | -          |  14.70 |  14.70 |
...
| `stark_prove_excluding_trace_time_ms` |  14,772 |  14,772 |  14,772 |  14,772 |
| `main_trace_commit_time_ms` |  4,918 |  4,918 |  4,918 |  4,918 |
| `generate_perm_trace_time_ms` |  461 |  461 |  461 |  461 |
| `perm_trace_commit_time_ms` |  1,532 |  1,532 |  1,532 |  1,532 |
| `quotient_poly_compute_time_ms` |  6,263 |  6,263 |  6,263 |  6,263 |
...
| `main_cells_used     ` |  748,994,622 |  748,994,622 |  748,994,622 |  748,994,622 |
| `total_cells_used    ` |  2,003,007,344 |  2,003,007,344 |  2,003,007,344 |  2,003,007,344 |
| `insns               ` |  7,952,525 |  7,952,525 |  7,952,525 |  7,952,525 |
| `execute_e3_time_ms  ` |  2,452 |  2,452 |  2,452 |  2,452 |
| `execute_e3_insn_mi/s` |  3.24 | -          |  3.24 |  3.24 |
| `trace_gen_time_ms   ` |  1,646 |  1,646 |  1,646 |  1,646 |
| `memory_finalize_time_ms` |  18 |  18 |  18 |  18 |
| `boundary_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  19,410 |  19,410 |  19,410 |  19,410 |
| `main_trace_commit_time_ms` |  4,162 |  4,162 |  4,162 |  4,162 |
| `generate_perm_trace_time_ms` |  1,636 |  1,636 |  1,636 |  1,636 |
| `perm_trace_commit_time_ms` |  5,410 |  5,410 |  5,410 |  5,410 |
| `quotient_poly_compute_time_ms` |  2,125 |  2,125 |  2,125 |  2,125 |
| `quotient_poly_commit_time_ms` |  1,437 |  1,437 |  1,437 |  1,437 |
| `pcs_opening_time_ms ` |  4,634 |  4,634 |  4,634 |  4,634 |

| internal.0 |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  5,231 |  5,231 |  5,231 |  5,231 |
| `main_cells_used     ` |  75,193,971 |  75,193,971 |  75,193,971 |  75,193,971 |
| `total_cells_used    ` |  134,682,537 |  134,682,537 |  134,682,537 |  134,682,537 |
| `insns               ` |  1,197,815 |  1,197,815 |  1,197,815 |  1,197,815 |
| `execute_e3_time_ms  ` |  503 |  503 |  503 |  503 |
| `execute_e3_insn_mi/s` |  2.38 | -          |  2.38 |  2.38 |
| `trace_gen_time_ms   ` |  180 |  180 |  180 |  180 |
| `memory_finalize_time_ms` |  8 |  8 |  8 |  8 |
| `boundary_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  4,548 |  4,548 |  4,548 |  4,548 |
| `main_trace_commit_time_ms` |  1,014 |  1,014 |  1,014 |  1,014 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  38,592 |  38,592 |  38,592 |  38,592 |
| `main_cells_used     ` |  40,016,146 |  40,016,146 |  40,016,146 |  40,016,146 |
| `total_cells_used    ` |  61,674,728 |  61,674,728 |  61,674,728 |  61,674,728 |
| `insns               ` |  772,507 |  772,507 |  772,507 |  772,507 |
| `execute_e3_time_ms  ` |  216 |  216 |  216 |  216 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  90,268 |  90,268 |  90,268 |  90,268 |
| `main_cells_used     ` |  65,627,358 |  65,627,358 |  65,627,358 |  65,627,358 |

| halo2_wrapper |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  44,589 |  44,589 |  44,589 |  44,589 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
|  | 114 | 61,674,728 | 114 | 2 | 90,281 | 44,589 | 7 | 40,016,146 | 772,507 | 211 | 3.65 | 0 | 15,402 | 39,670 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| halo2_outer | 90,268 |  |  |  |  |  | 65,627,358 |  |  |  |  |  | 
| halo2_wrapper | 44,589 |  |  |  |  |  |  |  |  |  |  |  | 
| internal.0 |  |  | 6,425 |  | 3 |  |  |  | 2 |  |  |  | 
| kitchen_sink |  |  |  | 15,350 |  | 6 |  | 154,596 | 1 | 10 | 14.70 | 35 | 
| leaf |  | 24,752 |  |  | 1 |  |  |  | 1 |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal.0 | 0 | 180 | 5,231 | 134,682,537 | 224,975,330 | 179 | 4,548 | 2 | 622 | 728 | 741 | 1,242 | 8 | 1,014 | 75,193,971 | 1,197,815 | 195 |  | 503 | 2.38 | 0 | 
| leaf | 0 | 1,646 | 23,508 | 2,003,007,344 | 2,500,267,498 | 1,635 | 19,410 | 2 | 2,125 | 1,437 | 5,410 | 4,634 | 18 | 4,162 | 748,994,622 | 7,952,525 | 1,636 |  | 2,452 | 3.24 | 0 | 
| root | 0 | 115 | 38,592 | 61,674,728 | 80,435,354 | 114 | 38,261 | 2 | 720 | 13,651 | 7,575 | 3,897 | 7 | 12,313 | 40,016,146 | 772,507 | 89 | 3 | 216 | 3.56 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| kitchen_sink | 0 | 211 | 15,019 | 1,217,691,116 | 1,481,195,122 | 209 | 14,772 | 2 | 6,263 | 305 | 1,532 | 1,235 | 61 | 6 | 2 | 4,918 | 899,580,290 | 154,596 | 461 | 36 | 4.26 | 0 | 

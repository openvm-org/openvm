...
| `total_proof_time_ms ` |  1,117 |  1,117 |  1,117 |  1,117 |
...
| `execute_e3_insn_mi/s` |  1.71 | -          |  1.71 |  1.71 |
...
| `merkle_finalize_time_ms` |  60 |  60 |  60 |  60 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+22 [+2.4%])</span> 940 | <span style='color: red'>(+22 [+2.4%])</span> 940 | <span style='color: red'>(+22 [+2.4%])</span> 940 | <span style='color: red'>(+22 [+2.4%])</span> 940 |
...
| `perm_trace_commit_time_ms` | <span style='color: red'>(+1 [+0.8%])</span> 126 | <span style='color: red'>(+1 [+0.8%])</span> 126 | <span style='color: red'>(+1 [+0.8%])</span> 126 | <span style='color: red'>(+1 [+0.8%])</span> 126 |
...
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+4 [+3.2%])</span> 128 | <span style='color: red'>(+4 [+3.2%])</span> 128 | <span style='color: red'>(+4 [+3.2%])</span> 128 | <span style='color: red'>(+4 [+3.2%])</span> 128 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+7 [+1.7%])</span> 422 | <span style='color: red'>(+7 [+1.7%])</span> 422 | <span style='color: red'>(+7 [+1.7%])</span> 422 | <span style='color: red'>(+7 [+1.7%])</span> 422 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  9,762 |  9,762 |  9,762 |  9,762 |
| `main_cells_used     ` | <span style='color: red'>(+1572792 [+0.6%])</span> 246,667,144 | <span style='color: red'>(+1572792 [+0.6%])</span> 246,667,144 | <span style='color: red'>(+1572792 [+0.6%])</span> 246,667,144 | <span style='color: red'>(+1572792 [+0.6%])</span> 246,667,144 |
| `total_cells_used    ` |  645,426,754 |  645,426,754 |  645,426,754 |  645,426,754 |
| `insns               ` |  2,934,882 |  2,934,882 |  2,934,882 |  2,934,882 |
| `execute_e3_time_ms  ` |  976 |  976 |  976 |  976 |
| `execute_e3_insn_mi/s` |  3.01 | -          |  3.01 |  3.01 |
| `trace_gen_time_ms   ` | <span style='color: green'>(-1750 [-74.5%])</span> 600 | <span style='color: green'>(-1750 [-74.5%])</span> 600 | <span style='color: green'>(-1750 [-74.5%])</span> 600 | <span style='color: green'>(-1750 [-74.5%])</span> 600 |
| `memory_finalize_time_ms` |  13 |  13 |  13 |  13 |
| `boundary_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+32 [+0.4%])</span> 8,186 | <span style='color: red'>(+32 [+0.4%])</span> 8,186 | <span style='color: red'>(+32 [+0.4%])</span> 8,186 | <span style='color: red'>(+32 [+0.4%])</span> 8,186 |
...
| `generate_perm_trace_time_ms` | <span style='color: red'>(+1 [+0.1%])</span> 784 | <span style='color: red'>(+1 [+0.1%])</span> 784 | <span style='color: red'>(+1 [+0.1%])</span> 784 | <span style='color: red'>(+1 [+0.1%])</span> 784 |
| `perm_trace_commit_time_ms` | <span style='color: green'>(-17 [-0.8%])</span> 2,089 | <span style='color: green'>(-17 [-0.8%])</span> 2,089 | <span style='color: green'>(-17 [-0.8%])</span> 2,089 | <span style='color: green'>(-17 [-0.8%])</span> 2,089 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+3 [+0.3%])</span> 929 | <span style='color: red'>(+3 [+0.3%])</span> 929 | <span style='color: red'>(+3 [+0.3%])</span> 929 | <span style='color: red'>(+3 [+0.3%])</span> 929 |
...
| `pcs_opening_time_ms ` | <span style='color: red'>(+32 [+1.5%])</span> 2,215 | <span style='color: red'>(+32 [+1.5%])</span> 2,215 | <span style='color: red'>(+32 [+1.5%])</span> 2,215 | <span style='color: red'>(+32 [+1.5%])</span> 2,215 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program |  | 1,604 |  | 10 | 137,284 | 1 | 7 | 18.65 | 42 | 
| leaf | 10,834 |  | 1 |  |  | 1 |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 600 | 9,762 | 645,426,754 | 992,054,762 | 8,186 | 929 | 649 | 2,089 | 2,215 | 13 | 1,512 | 246,667,144 | 2,934,882 | 784 | 976 | 3.01 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 97 | 1,117 | 25,968,337 | 32,925,330 | 940 | 81 | 128 | 126 | 422 | 60 | 10 | 1 | 137 | 8,596,011 | 137,284 | 29 | 80 | 1.71 | 0 | 

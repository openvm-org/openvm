...
|:---|---:|---:|
| Total |  219.70 |  219.70 |
| kitchen_sink |  15.46 |  15.46 |
| leaf |  23.50 |  23.50 |
| internal.0 |  6.22 |  6.22 |
| root |  38.66 |  38.66 |
...
| `total_proof_time_ms ` |  15,464 |  15,464 |  15,464 |  15,464 |
...
| `stark_prove_excluding_trace_time_ms` |  14,907 |  14,907 |  14,907 |  14,907 |
| `main_trace_commit_time_ms` |  5,079 |  5,079 |  5,079 |  5,079 |
| `generate_perm_trace_time_ms` |  463 |  463 |  463 |  463 |
| `perm_trace_commit_time_ms` |  1,523 |  1,523 |  1,523 |  1,523 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  23,501 |  23,501 |  23,501 |  23,501 |
| `main_cells_used     ` |  769,363,322 |  769,363,322 |  769,363,322 |  769,363,322 |
| `total_cells_used    ` |  2,050,268,436 |  2,050,268,436 |  2,050,268,436 |  2,050,268,436 |
| `execute_preflight_insns` |  7,903,998 |  7,903,998 |  7,903,998 |  7,903,998 |
| `execute_preflight_time_ms` |  1,300 |  1,300 |  1,300 |  1,300 |
| `execute_preflight_insn_mi/s` |  6.100 | -          |  6.100 |  6.100 |
| `trace_gen_time_ms   ` |  1,625 |  1,625 |  1,625 |  1,625 |
| `memory_finalize_time_ms` |  19 |  19 |  19 |  19 |
| `stark_prove_excluding_trace_time_ms` |  19,532 |  19,532 |  19,532 |  19,532 |
| `main_trace_commit_time_ms` |  4,211 |  4,211 |  4,211 |  4,211 |
| `generate_perm_trace_time_ms` |  1,614 |  1,614 |  1,614 |  1,614 |
| `perm_trace_commit_time_ms` |  5,491 |  5,491 |  5,491 |  5,491 |
| `quotient_poly_compute_time_ms` |  2,117 |  2,117 |  2,117 |  2,117 |
| `quotient_poly_commit_time_ms` |  1,464 |  1,464 |  1,464 |  1,464 |
| `pcs_opening_time_ms ` |  4,629 |  4,629 |  4,629 |  4,629 |

| internal.0 |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  6,219 |  6,219 |  6,219 |  6,219 |
| `main_cells_used     ` |  79,527,555 |  79,527,555 |  79,527,555 |  79,527,555 |
| `total_cells_used    ` |  143,465,065 |  143,465,065 |  143,465,065 |  143,465,065 |
| `execute_preflight_insns` |  1,197,792 |  1,197,792 |  1,197,792 |  1,197,792 |
...
| `stark_prove_excluding_trace_time_ms` |  4,539 |  4,539 |  4,539 |  4,539 |
| `main_trace_commit_time_ms` |  1,025 |  1,025 |  1,025 |  1,025 |
...
| `main_cells_used     ` |  41,518,170 |  41,518,170 |  41,518,170 |  41,518,170 |
| `total_cells_used    ` |  64,200,868 |  64,200,868 |  64,200,868 |  64,200,868 |
...
| `stark_prove_excluding_trace_time_ms` |  38,391 |  38,391 |  38,391 |  38,391 |
...
| `quotient_poly_commit_time_ms` |  13,776 |  13,776 |  13,776 |  13,776 |
| `pcs_opening_time_ms ` |  3,880 |  3,880 |  3,880 |  3,880 |

| halo2_outer |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  91,564 |  91,564 |  91,564 |  91,564 |
| `main_cells_used     ` |  65,627,358 |  65,627,358 |  65,627,358 |  65,627,358 |

| halo2_wrapper |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  44,278 |  44,278 |  44,278 |  44,278 |

| halo2_keygen |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  38,579 |  38,579 |  38,579 |  38,579 |
| `main_cells_used     ` |  41,529,040 |  41,529,040 |  41,529,040 |  41,529,040 |
| `total_cells_used    ` |  64,212,926 |  64,212,926 |  64,212,926 |  64,212,926 |
| `execute_preflight_insns` |  772,361 |  772,361 |  772,361 |  772,361 |
...
| `perm_trace_commit_time_ms` |  7,607 |  7,607 |  7,607 |  7,607 |
| `quotient_poly_compute_time_ms` |  689 |  689 |  689 |  689 |
| `quotient_poly_commit_time_ms` |  13,686 |  13,686 |  13,686 |  13,686 |
| `pcs_opening_time_ms ` |  3,904 |  3,904 |  3,904 |  3,904 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
|  | 0 | 111 | 64,200,868 | 111 | 0 | 91,578 | 44,278 | 21 | 9 | 41,518,170 | 175,301 | 299 | 772,570 | 5.29 | 15,513 | 39,682 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| halo2_keygen | 0 | 0 | 112 | 38,579 | 64,212,926 | 80,435,354 | 112 | 38,308 | 0 |  |  | 689 | 13,686 |  | 7,607 | 3,904 |  |  | 7 | 12,317 | 41,529,040 | 5,447,564 | 20,073 | 91 |  | 159 | 772,361 | 5.35 |  |  |  |  | 
| halo2_outer |  |  |  | 91,564 |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  | 65,627,358 |  |  |  |  |  |  |  |  |  |  |  | 
| halo2_wrapper |  |  |  | 44,278 |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  | 
| internal.0 |  |  |  |  |  |  |  |  |  |  | 6,221 |  |  |  |  |  | 3 |  |  |  |  |  |  |  | 2 |  |  |  |  |  |  |  | 
| kitchen_sink | 0 |  |  |  |  |  |  |  |  |  |  |  |  | 15,464 |  |  |  | 6 |  |  |  |  |  |  | 1 |  |  |  | 10 | 153,644 | 14.57 | 36 | 
| leaf |  |  |  |  |  |  |  |  |  | 23,508 |  |  |  |  |  |  | 1 |  |  |  |  |  |  |  | 1 |  |  |  |  |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal.0 | 0 | 0 | 190 | 6,219 | 143,465,065 | 224,975,330 | 190 | 4,539 | 0 | 603 | 745 | 751 | 1,220 | 9 | 1,025 | 79,527,555 | 190 |  | 481 | 1,197,792 | 3.68 | 
| leaf | 0 | 0 | 1,625 | 23,501 | 2,050,268,436 | 2,500,267,498 | 1,625 | 19,532 | 0 | 2,117 | 1,464 | 5,491 | 4,629 | 19 | 4,211 | 769,363,322 | 1,614 |  | 1,300 | 7,903,998 | 6.100 | 
| root | 0 | 0 | 111 | 38,662 | 64,200,868 | 80,435,354 | 111 | 38,391 | 0 | 706 | 13,776 | 7,577 | 3,880 | 8 | 12,305 | 41,518,170 | 90 | 3 | 160 | 772,570 | 5.31 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| kitchen_sink | 0 | 206 | 15,464 | 1,226,975,002 | 1,481,193,346 | 206 | 14,907 | 3 | 6,270 | 308 | 1,523 | 1,216 | 6 | 3 | 5,079 | 904,738,232 | 463 | 104 | 153,644 | 7.37 | 

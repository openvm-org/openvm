...
| `total_proof_time_ms ` |  3,584 |  3,584 |  3,584 |  3,584 |
...
| `execute_e3_insn_mi/s` |  7.31 | -          |  7.31 |  7.31 |
...
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+100 [+3.5%])</span> 2,963 | <span style='color: red'>(+100 [+3.5%])</span> 2,963 | <span style='color: red'>(+100 [+3.5%])</span> 2,963 | <span style='color: red'>(+100 [+3.5%])</span> 2,963 |
| `main_trace_commit_time_ms` | <span style='color: red'>(+22 [+3.8%])</span> 600 | <span style='color: red'>(+22 [+3.8%])</span> 600 | <span style='color: red'>(+22 [+3.8%])</span> 600 | <span style='color: red'>(+22 [+3.8%])</span> 600 |
| `generate_perm_trace_time_ms` | <span style='color: red'>(+2 [+0.9%])</span> 233 | <span style='color: red'>(+2 [+0.9%])</span> 233 | <span style='color: red'>(+2 [+0.9%])</span> 233 | <span style='color: red'>(+2 [+0.9%])</span> 233 |
...
| `pcs_opening_time_ms ` | <span style='color: red'>(+31 [+3.5%])</span> 914 | <span style='color: red'>(+31 [+3.5%])</span> 914 | <span style='color: red'>(+31 [+3.5%])</span> 914 | <span style='color: red'>(+31 [+3.5%])</span> 914 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  4,285 |  4,285 |  4,285 |  4,285 |
| `main_cells_used     ` | <span style='color: green'>(-57514523 [-28.0%])</span> 148,010,811 | <span style='color: green'>(-57514523 [-28.0%])</span> 148,010,811 | <span style='color: green'>(-57514523 [-28.0%])</span> 148,010,811 | <span style='color: green'>(-57514523 [-28.0%])</span> 148,010,811 |
| `total_cells_used    ` |  370,450,685 |  370,450,685 |  370,450,685 |  370,450,685 |
| `insns               ` |  2,010,372 |  2,010,372 |  2,010,372 |  2,010,372 |
...
| `stark_prove_excluding_trace_time_ms` | <span style='color: green'>(-2310 [-40.2%])</span> 3,439 | <span style='color: green'>(-2310 [-40.2%])</span> 3,439 | <span style='color: green'>(-2310 [-40.2%])</span> 3,439 | <span style='color: green'>(-2310 [-40.2%])</span> 3,439 |
| `main_trace_commit_time_ms` | <span style='color: green'>(-463 [-41.9%])</span> 643 | <span style='color: green'>(-463 [-41.9%])</span> 643 | <span style='color: green'>(-463 [-41.9%])</span> 643 | <span style='color: green'>(-463 [-41.9%])</span> 643 |
...
| `quotient_poly_compute_time_ms` | <span style='color: green'>(-298 [-42.3%])</span> 406 | <span style='color: green'>(-298 [-42.3%])</span> 406 | <span style='color: green'>(-298 [-42.3%])</span> 406 | <span style='color: green'>(-298 [-42.3%])</span> 406 |
...
| `pcs_opening_time_ms ` | <span style='color: green'>(-512 [-34.3%])</span> 981 | <span style='color: green'>(-512 [-34.3%])</span> 981 | <span style='color: green'>(-512 [-34.3%])</span> 981 | <span style='color: green'>(-512 [-34.3%])</span> 981 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 5,417 |  | 1 |  |  | 1 |  |  |  | 
| pairing |  | 3,837 |  | 6 | 1,862,965 | 1 | 114 | 16.27 | 39 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 349 | 4,285 | 370,450,685 | 418,598,378 | 349 | 3,439 | 2 | 406 | 299 | 788 | 981 | 10 | 643 | 148,010,811 | 2,010,372 | 318 | 497 | 4.04 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 367 | 3,584 | 218,306,645 | 304,931,516 | 367 | 2,963 | 2 | 353 | 278 | 577 | 914 | 104 | 7 | 4 | 600 | 98,127,219 | 1,862,965 | 233 | 254 | 7.31 | 2 | 

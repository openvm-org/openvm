...
| `total_proof_time_ms ` |  1,394 |  1,394 |  1,394 |  1,394 |
...
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+52 [+5.7%])</span> 970 | <span style='color: red'>(+52 [+5.7%])</span> 970 | <span style='color: red'>(+52 [+5.7%])</span> 970 | <span style='color: red'>(+52 [+5.7%])</span> 970 |
...
| `perm_trace_commit_time_ms` | <span style='color: red'>(+15 [+12.0%])</span> 140 | <span style='color: red'>(+15 [+12.0%])</span> 140 | <span style='color: red'>(+15 [+12.0%])</span> 140 | <span style='color: red'>(+15 [+12.0%])</span> 140 |
...
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+13 [+10.5%])</span> 137 | <span style='color: red'>(+13 [+10.5%])</span> 137 | <span style='color: red'>(+13 [+10.5%])</span> 137 | <span style='color: red'>(+13 [+10.5%])</span> 137 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  10,847 |  10,847 |  10,847 |  10,847 |
| `main_cells_used     ` | <span style='color: red'>(+2132810 [+0.9%])</span> 247,227,162 | <span style='color: red'>(+2132810 [+0.9%])</span> 247,227,162 | <span style='color: red'>(+2132810 [+0.9%])</span> 247,227,162 | <span style='color: red'>(+2132810 [+0.9%])</span> 247,227,162 |
| `total_cells_used    ` |  646,608,532 |  646,608,532 |  646,608,532 |  646,608,532 |
| `execute_preflight_insns` |  2,934,952 |  2,934,952 |  2,934,952 |  2,934,952 |
| `execute_preflight_time_ms` |  574 |  574 |  574 |  574 |
| `execute_preflight_insn_mi/s` |  5.35 | -          |  5.35 |  5.35 |
| `trace_gen_time_ms   ` | <span style='color: green'>(-1778 [-75.7%])</span> 572 | <span style='color: green'>(-1778 [-75.7%])</span> 572 | <span style='color: green'>(-1778 [-75.7%])</span> 572 | <span style='color: green'>(-1778 [-75.7%])</span> 572 |
| `memory_finalize_time_ms` |  15 |  15 |  15 |  15 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+463 [+5.7%])</span> 8,617 | <span style='color: red'>(+463 [+5.7%])</span> 8,617 | <span style='color: red'>(+463 [+5.7%])</span> 8,617 | <span style='color: red'>(+463 [+5.7%])</span> 8,617 |
| `main_trace_commit_time_ms` | <span style='color: red'>(+143 [+9.5%])</span> 1,653 | <span style='color: red'>(+143 [+9.5%])</span> 1,653 | <span style='color: red'>(+143 [+9.5%])</span> 1,653 | <span style='color: red'>(+143 [+9.5%])</span> 1,653 |
| `generate_perm_trace_time_ms` | <span style='color: red'>(+4 [+0.5%])</span> 787 | <span style='color: red'>(+4 [+0.5%])</span> 787 | <span style='color: red'>(+4 [+0.5%])</span> 787 | <span style='color: red'>(+4 [+0.5%])</span> 787 |
| `perm_trace_commit_time_ms` | <span style='color: red'>(+206 [+9.8%])</span> 2,312 | <span style='color: red'>(+206 [+9.8%])</span> 2,312 | <span style='color: red'>(+206 [+9.8%])</span> 2,312 | <span style='color: red'>(+206 [+9.8%])</span> 2,312 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+4 [+0.4%])</span> 930 | <span style='color: red'>(+4 [+0.4%])</span> 930 | <span style='color: red'>(+4 [+0.4%])</span> 930 | <span style='color: red'>(+4 [+0.4%])</span> 930 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+60 [+9.4%])</span> 697 | <span style='color: red'>(+60 [+9.4%])</span> 697 | <span style='color: red'>(+60 [+9.4%])</span> 697 | <span style='color: red'>(+60 [+9.4%])</span> 697 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+49 [+2.2%])</span> 2,232 | <span style='color: red'>(+49 [+2.2%])</span> 2,232 | <span style='color: red'>(+49 [+2.2%])</span> 2,232 | <span style='color: red'>(+49 [+2.2%])</span> 2,232 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 |  | 1,394 |  | 7 | 1 | 6 | 140,487 | 20.55 | 39 | 
| leaf |  | 10,850 |  | 1 |  | 1 |  |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 0 | 572 | 10,847 | 646,608,532 | 992,054,762 | 572 | 8,617 | 0 | 930 | 697 | 2,312 | 2,232 | 15 | 1,653 | 247,227,162 | 787 | 574 | 2,934,952 | 5.35 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 94 | 1,394 | 26,518,220 | 32,927,986 | 94 | 970 | 0 | 79 | 137 | 140 | 425 | 7 | 2 | 143 | 8,866,654 | 29 | 81 | 140,487 | 1.83 | 

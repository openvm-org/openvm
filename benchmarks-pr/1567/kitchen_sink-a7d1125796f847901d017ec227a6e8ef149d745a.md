...
|:---|---:|---:|
| Total |  219.01 |  219.01 |
| kitchen_sink |  14.83 |  14.83 |
| leaf |  24.45 |  24.45 |
| internal_wrapper.1 |  5.55 |  5.55 |
| root |  38.79 |  38.79 |
| halo2_outer |  90.84 |  90.84 |
...
| `total_proof_time_ms ` |  14,827 |  14,827 |  14,827 |  14,827 |
...
| `execute_metered_insn_mi/s` |  6.02 | -          |  6.02 |  6.02 |
| `execute_e3_time_ms  ` |  40 |  40 |  40 |  40 |
| `execute_e3_insn_mi/s` |  3.77 | -          |  3.77 |  3.77 |
| `trace_gen_time_ms   ` |  512 |  512 |  512 |  512 |
| `memory_finalize_time_ms` |  81 |  81 |  81 |  81 |
| `boundary_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `merkle_finalize_time_ms` |  74 |  74 |  74 |  74 |
| `stark_prove_excluding_trace_time_ms` |  14,275 |  14,275 |  14,275 |  14,275 |
| `main_trace_commit_time_ms` |  4,630 |  4,630 |  4,630 |  4,630 |
...
| `main_cells_used     ` |  755,626,629 |  755,626,629 |  755,626,629 |  755,626,629 |
| `total_cycles        ` |  7,991,176 |  7,991,176 |  7,991,176 |  7,991,176 |
| `execute_metered_time_ms` |  2,087 |  2,087 |  2,087 |  2,087 |
| `execute_metered_insn_mi/s` |  3.83 | -          |  3.83 |  3.83 |
| `execute_e3_time_ms  ` |  2,595 |  2,595 |  2,595 |  2,595 |
| `execute_e3_insn_mi/s` |  3.08 | -          |  3.08 |  3.08 |
| `trace_gen_time_ms   ` |  1,630 |  1,630 |  1,630 |  1,630 |
| `memory_finalize_time_ms` |  25 |  25 |  25 |  25 |
| `boundary_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  18,143 |  18,143 |  18,143 |  18,143 |
| `main_trace_commit_time_ms` |  3,754 |  3,754 |  3,754 |  3,754 |
| `generate_perm_trace_time_ms` |  1,566 |  1,566 |  1,566 |  1,566 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  38,793 |  38,793 |  38,793 |  38,793 |
| `main_cells_used     ` |  40,006,888 |  40,006,888 |  40,006,888 |  40,006,888 |
| `total_cycles        ` |  772,505 |  772,505 |  772,505 |  772,505 |
| `execute_e3_time_ms  ` |  230 |  230 |  230 |  230 |
| `execute_e3_insn_mi/s` |  3.36 | -          |  3.36 |  3.36 |
| `trace_gen_time_ms   ` |  122 |  122 |  122 |  122 |
| `memory_finalize_time_ms` |  8 |  8 |  8 |  8 |
| `boundary_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  38,441 |  38,441 |  38,441 |  38,441 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  90,837 |  90,837 |  90,837 |  90,837 |
| `main_cells_used     ` |  65,626,678 |  65,626,678 |  65,626,678 |  65,626,678 |

| halo2_wrapper |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  44,404 |  44,404 |  44,404 |  44,404 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
|  | 5,588 | 90,852 | 44,404 | 7 | 1,198,248 | 202 | 3.82 | 229 | 3.36 | 0 | 22,760 | 38,810 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| halo2_outer |  | 90,837 |  |  |  |  |  |  |  |  |  |  |  |  |  | 65,626,678 |  |  |  |  |  |  |  |  |  | 
| halo2_wrapper |  | 44,404 |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  | 
| internal_wrapper.1 | 200 | 5,549 | 1,197,775 | 224,975,330 | 4,376 |  | 619 | 686 | 734 | 1,230 |  |  |  | 9 | 907 | 73,433,109 | 1,197,776 | 195 | 2 |  | 459 | 2.60 | 514 | 2.33 | 0 | 
| kitchen_sink |  |  |  |  |  |  |  |  |  |  | 1 |  | 22 |  |  |  | 154,596 |  | 1 | 22,187 | 142 | 6.02 |  |  |  | 
| leaf |  |  |  |  |  | 24,873 |  |  |  |  |  | 1 |  |  |  |  |  |  | 1 |  |  |  |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,630 | 24,455 | 7,991,176 | 2,500,267,498 | 18,143 | 2,103 | 1,310 | 4,825 | 4,582 | 25 | 3,754 | 755,626,629 | 7,991,177 | 1,566 |  | 2,087 | 3.83 | 2,595 | 3.08 | 0 | 
| root | 0 | 122 | 38,793 | 772,505 | 80,435,354 | 38,441 | 702 | 13,755 | 7,615 | 3,934 | 8 | 12,314 | 40,006,888 | 772,506 | 111 | 3 |  |  | 230 | 3.36 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| kitchen_sink | 0 | 512 | 14,827 | 154,595 | 1,481,195,140 | 14,275 | 6,257 | 288 | 18,167 | 1,379 | 1,211 | 74 | 22 | 81 | 4,630 | 903,326,712 | 154,596 | 463 | 40 | 3.77 | 0 | 

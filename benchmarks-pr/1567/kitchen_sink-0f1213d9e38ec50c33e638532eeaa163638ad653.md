...
| leaf |  23.41 |  23.41 |
| internal.0 |  5.20 |  5.20 |
| root |  38.61 |  38.61 |
| halo2_outer |  92.58 |  92.58 |
...
| `total_proof_time_ms ` |  14,968 |  14,968 |  14,968 |  14,968 |
...
| `execute_metered_insn_mi/s` |  14.38 | -          |  14.38 |  14.38 |
...
| `stark_prove_excluding_trace_time_ms` |  14,713 |  14,713 |  14,713 |  14,713 |
| `main_trace_commit_time_ms` |  4,903 |  4,903 |  4,903 |  4,903 |
| `generate_perm_trace_time_ms` |  457 |  457 |  457 |  457 |
| `perm_trace_commit_time_ms` |  1,505 |  1,505 |  1,505 |  1,505 |
...
| `main_cells_used     ` |  748,995,378 |  748,995,378 |  748,995,378 |  748,995,378 |
| `total_cells_used    ` |  2,003,009,864 |  2,003,009,864 |  2,003,009,864 |  2,003,009,864 |
| `insns               ` |  7,952,588 |  7,952,588 |  7,952,588 |  7,952,588 |
| `execute_e3_time_ms  ` |  2,413 |  2,413 |  2,413 |  2,413 |
| `execute_e3_insn_mi/s` |  3.29 | -          |  3.29 |  3.29 |
| `trace_gen_time_ms   ` |  1,567 |  1,567 |  1,567 |  1,567 |
| `memory_finalize_time_ms` |  16 |  16 |  16 |  16 |
| `boundary_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  19,433 |  19,433 |  19,433 |  19,433 |
| `main_trace_commit_time_ms` |  4,177 |  4,177 |  4,177 |  4,177 |
| `generate_perm_trace_time_ms` |  1,627 |  1,627 |  1,627 |  1,627 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  5,202 |  5,202 |  5,202 |  5,202 |
| `main_cells_used     ` |  75,193,731 |  75,193,731 |  75,193,731 |  75,193,731 |
| `total_cells_used    ` |  134,681,977 |  134,681,977 |  134,681,977 |  134,681,977 |
| `insns               ` |  1,197,795 |  1,197,795 |  1,197,795 |  1,197,795 |
| `execute_e3_time_ms  ` |  481 |  481 |  481 |  481 |
| `execute_e3_insn_mi/s` |  2.49 | -          |  2.49 |  2.49 |
| `trace_gen_time_ms   ` |  185 |  185 |  185 |  185 |
| `memory_finalize_time_ms` |  8 |  8 |  8 |  8 |
| `boundary_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  4,536 |  4,536 |  4,536 |  4,536 |
| `main_trace_commit_time_ms` |  1,020 |  1,020 |  1,020 |  1,020 |
...
| `main_cells_used     ` |  40,016,950 |  40,016,950 |  40,016,950 |  40,016,950 |
| `total_cells_used    ` |  61,676,336 |  61,676,336 |  61,676,336 |  61,676,336 |
| `insns               ` |  772,574 |  772,574 |  772,574 |  772,574 |
| `execute_e3_time_ms  ` |  209 |  209 |  209 |  209 |
| `execute_e3_insn_mi/s` |  3.68 | -          |  3.68 |  3.68 |
| `trace_gen_time_ms   ` |  111 |  111 |  111 |  111 |
| `memory_finalize_time_ms` |  7 |  7 |  7 |  7 |
| `boundary_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  38,292 |  38,292 |  38,292 |  38,292 |
| `main_trace_commit_time_ms` |  12,309 |  12,309 |  12,309 |  12,309 |
| `generate_perm_trace_time_ms` |  91 |  91 |  91 |  91 |
| `perm_trace_commit_time_ms` |  7,579 |  7,579 |  7,579 |  7,579 |
| `quotient_poly_compute_time_ms` |  732 |  732 |  732 |  732 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  92,576 |  92,576 |  92,576 |  92,576 |
| `main_cells_used     ` |  65,627,358 |  65,627,358 |  65,627,358 |  65,627,358 |

| halo2_wrapper |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  44,554 |  44,554 |  44,554 |  44,554 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
|  | 111 | 61,676,336 | 92,590 | 44,554 | 7 | 40,016,950 | 772,574 | 210 | 3.67 | 0 | 16,522 | 39,687 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| halo2_outer | 92,576 |  |  |  |  |  | 65,627,358 |  |  |  |  |  | 
| halo2_wrapper | 44,554 |  |  |  |  |  |  |  |  |  |  |  | 
| internal.0 |  |  | 6,411 |  | 3 |  |  |  | 2 |  |  |  | 
| kitchen_sink |  |  |  | 16,443 |  | 24 |  | 154,596 | 1 | 10 | 14.38 | 54 | 
| leaf |  | 24,642 |  |  | 1 |  |  |  | 1 |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal.0 | 0 | 185 | 5,202 | 134,681,977 | 224,975,330 | 4,536 | 613 | 726 | 736 | 1,230 | 8 | 1,020 | 75,193,731 | 1,197,795 | 202 |  | 481 | 2.49 | 0 | 
| leaf | 0 | 1,567 | 23,413 | 2,003,009,864 | 2,500,267,498 | 19,433 | 2,128 | 1,428 | 5,418 | 4,650 | 16 | 4,177 | 748,995,378 | 7,952,588 | 1,627 |  | 2,413 | 3.29 | 0 | 
| root | 0 | 111 | 38,612 | 61,676,336 | 80,435,354 | 38,292 | 732 | 13,632 | 7,579 | 3,908 | 7 | 12,309 | 40,016,950 | 772,574 | 91 | 3 | 209 | 3.68 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| kitchen_sink | 0 | 219 | 14,968 | 1,217,690,534 | 1,481,195,122 | 14,713 | 6,275 | 305 | 1,505 | 1,222 | 79 | 23 | 2 | 4,903 | 899,579,940 | 154,596 | 457 | 36 | 4.22 | 0 | 

...
|:---|---:|---:|
| Total |  216.45 |  216.45 |
| kitchen_sink |  15.61 |  15.61 |
| leaf |  23.68 |  23.68 |
| internal.0 |  6.24 |  6.24 |
| root |  38.69 |  38.69 |
| halo2_outer |  88.11 |  88.11 |
...
| `total_proof_time_ms ` |  15,608 |  15,608 |  15,608 |  15,608 |
...
| `stark_prove_excluding_trace_time_ms` |  15,031 |  15,031 |  15,031 |  15,031 |
| `main_trace_commit_time_ms` |  5,098 |  5,098 |  5,098 |  5,098 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  23,679 |  23,679 |  23,679 |  23,679 |
| `main_cells_used     ` |  769,362,746 |  769,362,746 |  769,362,746 |  769,362,746 |
| `total_cells_used    ` |  2,050,266,516 |  2,050,266,516 |  2,050,266,516 |  2,050,266,516 |
| `execute_preflight_insns` |  7,903,950 |  7,903,950 |  7,903,950 |  7,903,950 |
| `execute_preflight_time_ms` |  1,314 |  1,314 |  1,314 |  1,314 |
| `execute_preflight_insn_mi/s` |  6.92 | -          |  6.92 |  6.92 |
| `trace_gen_time_ms   ` |  1,666 |  1,666 |  1,666 |  1,666 |
| `memory_finalize_time_ms` |  19 |  19 |  19 |  19 |
| `stark_prove_excluding_trace_time_ms` |  19,669 |  19,669 |  19,669 |  19,669 |
| `main_trace_commit_time_ms` |  4,226 |  4,226 |  4,226 |  4,226 |
| `generate_perm_trace_time_ms` |  1,707 |  1,707 |  1,707 |  1,707 |
| `perm_trace_commit_time_ms` |  5,506 |  5,506 |  5,506 |  5,506 |
| `quotient_poly_compute_time_ms` |  2,111 |  2,111 |  2,111 |  2,111 |
| `quotient_poly_commit_time_ms` |  1,451 |  1,451 |  1,451 |  1,451 |
| `pcs_opening_time_ms ` |  4,662 |  4,662 |  4,662 |  4,662 |

| internal.0 |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  6,237 |  6,237 |  6,237 |  6,237 |
| `main_cells_used     ` |  79,528,359 |  79,528,359 |  79,528,359 |  79,528,359 |
| `total_cells_used    ` |  143,466,941 |  143,466,941 |  143,466,941 |  143,466,941 |
| `execute_preflight_insns` |  1,197,859 |  1,197,859 |  1,197,859 |  1,197,859 |
...
| `main_cells_used     ` |  41,517,498 |  41,517,498 |  41,517,498 |  41,517,498 |
| `total_cells_used    ` |  64,199,524 |  64,199,524 |  64,199,524 |  64,199,524 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  88,112 |  88,112 |  88,112 |  88,112 |
| `main_cells_used     ` |  65,627,358 |  65,627,358 |  65,627,358 |  65,627,358 |

| halo2_wrapper |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  44,112 |  44,112 |  44,112 |  44,112 |

| halo2_keygen |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  38,575 |  38,575 |  38,575 |  38,575 |
...
| `stark_prove_excluding_trace_time_ms` |  38,302 |  38,302 |  38,302 |  38,302 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
|  | 117 | 64,199,524 | 117 | 0 | 88,126 | 44,112 | 25 | 8 | 41,517,498 | 173,181 | 327 | 772,514 | 5.22 | 15,658 | 39,680 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| halo2_keygen | 111 | 38,575 | 64,211,894 | 80,435,354 | 111 | 38,302 | 0 |  |  | 718 | 13,650 |  | 7,582 | 3,946 |  |  | 7 | 12,311 | 41,528,524 | 5,447,564 | 19,110 | 88 |  | 162 | 772,318 | 5.20 |  |  |  |  | 
| halo2_outer |  | 88,112 |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  | 65,627,358 |  |  |  |  |  |  |  |  |  |  |  | 
| halo2_wrapper |  | 44,112 |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  | 
| internal.0 |  |  |  |  |  |  |  |  | 6,238 |  |  |  |  |  | 3 |  |  |  |  |  |  |  | 2 |  |  |  |  |  |  |  | 
| kitchen_sink |  |  |  |  |  |  |  |  |  |  |  | 15,608 |  |  |  | 6 |  |  |  |  |  |  | 1 |  |  |  | 10 | 153,644 | 14.58 | 37 | 
| leaf |  |  |  |  |  |  |  | 23,686 |  |  |  |  |  |  | 1 |  |  |  |  |  |  |  | 1 |  |  |  |  |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal.0 | 0 | 181 | 6,237 | 143,466,941 | 224,975,330 | 181 | 4,573 | 0 | 608 | 743 | 752 | 1,245 | 9 | 1,021 | 79,528,359 | 194 |  | 496 | 1,197,859 | 3.52 | 
| leaf | 0 | 1,666 | 23,679 | 2,050,266,516 | 2,500,267,498 | 1,666 | 19,669 | 0 | 2,111 | 1,451 | 5,506 | 4,662 | 19 | 4,226 | 769,362,746 | 1,707 |  | 1,314 | 7,903,950 | 6.92 | 
| root | 0 | 117 | 38,690 | 64,199,524 | 80,435,354 | 117 | 38,407 | 0 | 720 | 13,763 | 7,584 | 3,910 | 9 | 12,324 | 41,517,498 | 88 | 3 | 166 | 772,514 | 5.13 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| kitchen_sink | 0 | 210 | 15,608 | 1,226,975,002 | 1,481,193,346 | 210 | 15,031 | 3 | 6,270 | 312 | 1,524 | 1,241 | 6 | 2 | 5,098 | 904,738,232 | 538 | 117 | 153,644 | 7.38 | 

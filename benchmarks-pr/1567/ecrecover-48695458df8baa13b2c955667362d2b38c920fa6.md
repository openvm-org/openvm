...
| `total_proof_time_ms ` |  1,150 |  1,150 |  1,150 |  1,150 |
...
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+56 [+6.1%])</span> 974 | <span style='color: red'>(+56 [+6.1%])</span> 974 | <span style='color: red'>(+56 [+6.1%])</span> 974 | <span style='color: red'>(+56 [+6.1%])</span> 974 |
| `main_trace_commit_time_ms` | <span style='color: red'>(+20 [+15.3%])</span> 151 | <span style='color: red'>(+20 [+15.3%])</span> 151 | <span style='color: red'>(+20 [+15.3%])</span> 151 | <span style='color: red'>(+20 [+15.3%])</span> 151 |
...
| `pcs_opening_time_ms ` | <span style='color: red'>(+12 [+2.9%])</span> 427 | <span style='color: red'>(+12 [+2.9%])</span> 427 | <span style='color: red'>(+12 [+2.9%])</span> 427 | <span style='color: red'>(+12 [+2.9%])</span> 427 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  9,780 |  9,780 |  9,780 |  9,780 |
| `main_cells_used     ` | <span style='color: red'>(+2132258 [+0.9%])</span> 247,226,610 | <span style='color: red'>(+2132258 [+0.9%])</span> 247,226,610 | <span style='color: red'>(+2132258 [+0.9%])</span> 247,226,610 | <span style='color: red'>(+2132258 [+0.9%])</span> 247,226,610 |
| `total_cells_used    ` |  646,606,692 |  646,606,692 |  646,606,692 |  646,606,692 |
| `insns               ` |  2,934,906 |  2,934,906 |  2,934,906 |  2,934,906 |
| `execute_preflight_time_ms` |  569 |  569 |  569 |  569 |
| `execute_preflight_insn_mi/s` |  5.42 | -          |  5.42 |  5.42 |
| `trace_gen_time_ms   ` | <span style='color: green'>(-1766 [-75.1%])</span> 584 | <span style='color: green'>(-1766 [-75.1%])</span> 584 | <span style='color: green'>(-1766 [-75.1%])</span> 584 | <span style='color: green'>(-1766 [-75.1%])</span> 584 |
| `memory_finalize_time_ms` |  16 |  16 |  16 |  16 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+473 [+5.8%])</span> 8,627 | <span style='color: red'>(+473 [+5.8%])</span> 8,627 | <span style='color: red'>(+473 [+5.8%])</span> 8,627 | <span style='color: red'>(+473 [+5.8%])</span> 8,627 |
| `main_trace_commit_time_ms` | <span style='color: red'>(+153 [+10.1%])</span> 1,663 | <span style='color: red'>(+153 [+10.1%])</span> 1,663 | <span style='color: red'>(+153 [+10.1%])</span> 1,663 | <span style='color: red'>(+153 [+10.1%])</span> 1,663 |
...
| `perm_trace_commit_time_ms` | <span style='color: red'>(+208 [+9.9%])</span> 2,314 | <span style='color: red'>(+208 [+9.9%])</span> 2,314 | <span style='color: red'>(+208 [+9.9%])</span> 2,314 | <span style='color: red'>(+208 [+9.9%])</span> 2,314 |
...
| `pcs_opening_time_ms ` | <span style='color: red'>(+59 [+2.7%])</span> 2,242 | <span style='color: red'>(+59 [+2.7%])</span> 2,242 | <span style='color: red'>(+59 [+2.7%])</span> 2,242 | <span style='color: red'>(+59 [+2.7%])</span> 2,242 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program |  | 1,397 |  | 6 | 140,487 | 1 | 6 | 20.52 | 38 | 
| leaf | 10,870 |  | 1 |  |  | 1 |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 584 | 9,780 | 646,606,692 | 992,054,762 | 584 | 8,627 | 0 | 914 | 698 | 2,314 | 2,242 | 16 | 1,663 | 247,226,610 | 2,934,906 | 792 | 569 | 5.42 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 96 | 1,150 | 26,518,202 | 32,927,986 | 96 | 974 | 0 | 78 | 133 | 137 | 427 | 7 | 1 | 151 | 8,866,644 | 140,487 | 31 | 80 | 1.85 | 

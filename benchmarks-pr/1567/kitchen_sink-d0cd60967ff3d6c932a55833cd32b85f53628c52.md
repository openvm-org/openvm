...
| `total_proof_time_ms ` |  14,373 |  14,373 |  14,373 |  14,373 |
...
| `execute_metered_insn_mi/s` |  14.75 | -          |  14.75 |  14.75 |
...
| `stark_prove_excluding_trace_time_ms` |  14,128 |  14,128 |  14,128 |  14,128 |
| `main_trace_commit_time_ms` |  4,492 |  4,492 |  4,492 |  4,492 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  21,419 |  21,419 |  21,419 |  21,419 |
| `main_cells_used     ` |  748,993,338 |  748,993,338 |  748,993,338 |  748,993,338 |
| `total_cells_used    ` |  2,003,003,064 |  2,003,003,064 |  2,003,003,064 |  2,003,003,064 |
| `insns               ` |  7,952,418 |  7,952,418 |  7,952,418 |  7,952,418 |
| `execute_e3_time_ms  ` |  1,627 |  1,627 |  1,627 |  1,627 |
| `execute_e3_insn_mi/s` |  4.89 | -          |  4.89 |  4.89 |
| `trace_gen_time_ms   ` |  1,638 |  1,638 |  1,638 |  1,638 |
| `memory_finalize_time_ms` |  18 |  18 |  18 |  18 |
| `boundary_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  18,154 |  18,154 |  18,154 |  18,154 |
| `main_trace_commit_time_ms` |  3,752 |  3,752 |  3,752 |  3,752 |
| `generate_perm_trace_time_ms` |  1,629 |  1,629 |  1,629 |  1,629 |
| `perm_trace_commit_time_ms` |  4,796 |  4,796 |  4,796 |  4,796 |
| `quotient_poly_compute_time_ms` |  2,126 |  2,126 |  2,126 |  2,126 |
| `quotient_poly_commit_time_ms` |  1,297 |  1,297 |  1,297 |  1,297 |
| `pcs_opening_time_ms ` |  4,549 |  4,549 |  4,549 |  4,549 |

| internal.0 |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  4,839 |  4,839 |  4,839 |  4,839 |
| `main_cells_used     ` |  75,193,587 |  75,193,587 |  75,193,587 |  75,193,587 |
| `total_cells_used    ` |  134,681,641 |  134,681,641 |  134,681,641 |  134,681,641 |
| `insns               ` |  1,197,783 |  1,197,783 |  1,197,783 |  1,197,783 |
| `execute_e3_time_ms  ` |  394 |  394 |  394 |  394 |
| `execute_e3_insn_mi/s` |  3.03 | -          |  3.03 |  3.03 |
| `trace_gen_time_ms   ` |  186 |  186 |  186 |  186 |
| `memory_finalize_time_ms` |  9 |  9 |  9 |  9 |
| `boundary_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  4,259 |  4,259 |  4,259 |  4,259 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  38,428 |  38,428 |  38,428 |  38,428 |
| `main_cells_used     ` |  40,016,746 |  40,016,746 |  40,016,746 |  40,016,746 |
| `total_cells_used    ` |  61,675,928 |  61,675,928 |  61,675,928 |  61,675,928 |
| `insns               ` |  772,557 |  772,557 |  772,557 |  772,557 |
...
| `boundary_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  38,130 |  38,130 |  38,130 |  38,130 |
...
| `quotient_poly_commit_time_ms` |  13,559 |  13,559 |  13,559 |  13,559 |
| `pcs_opening_time_ms ` |  3,889 |  3,889 |  3,889 |  3,889 |

| halo2_outer |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  89,504 |  89,504 |  89,504 |  89,504 |
| `main_cells_used     ` |  65,627,358 |  65,627,358 |  65,627,358 |  65,627,358 |

| halo2_wrapper |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  44,577 |  44,577 |  44,577 |  44,577 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
|  | 117 | 61,675,928 | 116 | 2 | 89,518 | 44,577 | 7 | 40,016,746 | 772,557 | 178 | 4.33 | 0 | 14,762 | 39,476 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| halo2_outer | 89,504 |  |  |  |  |  | 65,627,358 |  |  |  |  |  | 
| halo2_wrapper | 44,577 |  |  |  |  |  |  |  |  |  |  |  | 
| internal.0 |  |  | 6,019 |  | 3 |  |  |  | 2 |  |  |  | 
| kitchen_sink |  |  |  | 14,710 |  | 6 |  | 154,596 | 1 | 10 | 14.75 | 36 | 
| leaf |  | 22,681 |  |  | 1 |  |  |  | 1 |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal.0 | 0 | 186 | 4,839 | 134,681,641 | 224,975,330 | 185 | 4,259 | 2 | 616 | 668 | 652 | 1,215 | 9 | 911 | 75,193,587 | 1,197,783 | 193 |  | 394 | 3.03 | 0 | 
| leaf | 0 | 1,638 | 21,419 | 2,003,003,064 | 2,500,267,498 | 1,627 | 18,154 | 2 | 2,126 | 1,297 | 4,796 | 4,549 | 18 | 3,752 | 748,993,338 | 7,952,418 | 1,629 |  | 1,627 | 4.89 | 0 | 
| root | 0 | 117 | 38,428 | 61,675,928 | 80,435,354 | 116 | 38,130 | 2 | 696 | 13,559 | 7,573 | 3,889 | 7 | 12,302 | 40,016,746 | 772,557 | 87 | 3 | 181 | 4.26 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| kitchen_sink | 0 | 209 | 14,373 | 1,217,691,116 | 1,481,195,122 | 208 | 14,128 | 2 | 6,274 | 285 | 1,362 | 1,204 | 61 | 6 | 2 | 4,492 | 899,580,290 | 154,596 | 467 | 36 | 4.23 | 0 | 

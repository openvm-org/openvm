...
|:---|---:|---:|
| Total |  224.79 |  224.79 |
| kitchen_sink |  15.34 |  15.34 |
| leaf |  23.58 |  23.58 |
| internal.0 |  6.30 |  6.30 |
| root |  38.64 |  38.64 |
| halo2_outer |  96.16 |  96.16 |
...
| `total_proof_time_ms ` |  15,341 |  15,341 |  15,341 |  15,341 |
...
| `stark_prove_excluding_trace_time_ms` |  14,782 |  14,782 |  14,782 |  14,782 |
| `main_trace_commit_time_ms` |  4,951 |  4,951 |  4,951 |  4,951 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  23,582 |  23,582 |  23,582 |  23,582 |
| `main_cells_used     ` |  769,363,190 |  769,363,190 |  769,363,190 |  769,363,190 |
| `total_cells_used    ` |  2,050,267,996 |  2,050,267,996 |  2,050,267,996 |  2,050,267,996 |
| `execute_preflight_insns` |  7,903,987 |  7,903,987 |  7,903,987 |  7,903,987 |
| `execute_preflight_time_ms` |  1,304 |  1,304 |  1,304 |  1,304 |
| `execute_preflight_insn_mi/s` |  6.98 | -          |  6.98 |  6.98 |
| `trace_gen_time_ms   ` |  1,606 |  1,606 |  1,606 |  1,606 |
| `memory_finalize_time_ms` |  18 |  18 |  18 |  18 |
| `stark_prove_excluding_trace_time_ms` |  19,613 |  19,613 |  19,613 |  19,613 |
| `main_trace_commit_time_ms` |  4,231 |  4,231 |  4,231 |  4,231 |
| `generate_perm_trace_time_ms` |  1,691 |  1,691 |  1,691 |  1,691 |
| `perm_trace_commit_time_ms` |  5,481 |  5,481 |  5,481 |  5,481 |
| `quotient_poly_compute_time_ms` |  2,114 |  2,114 |  2,114 |  2,114 |
| `quotient_poly_commit_time_ms` |  1,443 |  1,443 |  1,443 |  1,443 |
| `pcs_opening_time_ms ` |  4,646 |  4,646 |  4,646 |  4,646 |

| internal.0 |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  6,299 |  6,299 |  6,299 |  6,299 |
| `main_cells_used     ` |  79,526,967 |  79,526,967 |  79,526,967 |  79,526,967 |
| `total_cells_used    ` |  143,463,693 |  143,463,693 |  143,463,693 |  143,463,693 |
| `execute_preflight_insns` |  1,197,743 |  1,197,743 |  1,197,743 |  1,197,743 |
...
| `stark_prove_excluding_trace_time_ms` |  4,622 |  4,622 |  4,622 |  4,622 |
| `main_trace_commit_time_ms` |  1,035 |  1,035 |  1,035 |  1,035 |
| `generate_perm_trace_time_ms` |  200 |  200 |  200 |  200 |
| `perm_trace_commit_time_ms` |  745 |  745 |  745 |  745 |
...
| `main_cells_used     ` |  41,517,882 |  41,517,882 |  41,517,882 |  41,517,882 |
| `total_cells_used    ` |  64,200,292 |  64,200,292 |  64,200,292 |  64,200,292 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  96,163 |  96,163 |  96,163 |  96,163 |
| `main_cells_used     ` |  65,627,358 |  65,627,358 |  65,627,358 |  65,627,358 |

| halo2_wrapper |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  44,755 |  44,755 |  44,755 |  44,755 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
|  | 0 | 114 | 64,200,292 | 114 | 0 | 96,176 | 44,755 | 8 | 41,517,882 | 303 | 772,546 | 5.25 | 15,391 | 39,657 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| halo2_outer |  | 96,163 |  |  |  |  |  | 65,627,358 |  |  |  |  |  | 
| halo2_wrapper |  | 44,755 |  |  |  |  |  |  |  |  |  |  |  | 
| internal.0 |  |  |  | 6,300 |  | 3 |  |  | 2 |  |  |  |  | 
| kitchen_sink | 0 |  |  |  | 15,341 |  | 6 |  | 1 | 10 | 153,644 | 14.56 | 37 | 
| leaf |  |  | 23,589 |  |  | 1 |  |  | 1 |  |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal.0 | 0 | 0 | 181 | 6,299 | 143,463,693 | 224,975,330 | 181 | 4,622 | 0 | 658 | 747 | 745 | 1,229 | 12 | 1,035 | 79,526,967 | 200 |  | 486 | 1,197,743 | 3.66 | 
| leaf | 0 | 0 | 1,606 | 23,582 | 2,050,267,996 | 2,500,267,498 | 1,606 | 19,613 | 0 | 2,114 | 1,443 | 5,481 | 4,646 | 18 | 4,231 | 769,363,190 | 1,691 |  | 1,304 | 7,903,987 | 6.98 | 
| root | 0 | 0 | 113 | 38,638 | 64,200,292 | 80,435,354 | 113 | 38,364 | 0 | 686 | 13,739 | 7,578 | 3,935 | 7 | 12,308 | 41,517,882 | 88 | 3 | 161 | 772,546 | 5.26 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| kitchen_sink | 0 | 211 | 15,341 | 1,226,975,002 | 1,481,193,346 | 211 | 14,782 | 3 | 6,267 | 310 | 1,526 | 1,219 | 6 | 2 | 4,951 | 904,738,232 | 462 | 102 | 153,644 | 7.34 | 

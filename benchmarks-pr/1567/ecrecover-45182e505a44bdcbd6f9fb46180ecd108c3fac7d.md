...
| `execute_metered_insn_mi/s` |  20.58 | -          |  20.58 |  20.58 |
| `execute_preflight_time_ms` |  81 |  81 |  81 |  81 |
| `execute_preflight_insn_mi/s` |  1.88 | -          |  1.88 |  1.88 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  10,908 |  10,908 |  10,908 |  10,908 |
| `main_cells_used     ` | <span style='color: red'>(+2131910 [+0.9%])</span> 247,226,262 | <span style='color: red'>(+2131910 [+0.9%])</span> 247,226,262 | <span style='color: red'>(+2131910 [+0.9%])</span> 247,226,262 | <span style='color: red'>(+2131910 [+0.9%])</span> 247,226,262 |
| `total_cells_used    ` |  646,605,532 |  646,605,532 |  646,605,532 |  646,605,532 |
| `insns               ` |  2,934,877 |  2,934,877 |  2,934,877 |  2,934,877 |
| `execute_preflight_time_ms` |  563 |  563 |  563 |  563 |
| `execute_preflight_insn_mi/s` |  5.46 | -          |  5.46 |  5.46 |
| `trace_gen_time_ms   ` | <span style='color: green'>(-1755 [-74.7%])</span> 595 | <span style='color: green'>(-1755 [-74.7%])</span> 595 | <span style='color: green'>(-1755 [-74.7%])</span> 595 | <span style='color: green'>(-1755 [-74.7%])</span> 595 |
| `memory_finalize_time_ms` |  16 |  16 |  16 |  16 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+518 [+6.4%])</span> 8,672 | <span style='color: red'>(+518 [+6.4%])</span> 8,672 | <span style='color: red'>(+518 [+6.4%])</span> 8,672 | <span style='color: red'>(+518 [+6.4%])</span> 8,672 |
| `main_trace_commit_time_ms` | <span style='color: red'>(+169 [+11.2%])</span> 1,679 | <span style='color: red'>(+169 [+11.2%])</span> 1,679 | <span style='color: red'>(+169 [+11.2%])</span> 1,679 | <span style='color: red'>(+169 [+11.2%])</span> 1,679 |
| `generate_perm_trace_time_ms` | <span style='color: green'>(-3 [-0.4%])</span> 780 | <span style='color: green'>(-3 [-0.4%])</span> 780 | <span style='color: green'>(-3 [-0.4%])</span> 780 | <span style='color: green'>(-3 [-0.4%])</span> 780 |
| `perm_trace_commit_time_ms` | <span style='color: red'>(+244 [+11.6%])</span> 2,350 | <span style='color: red'>(+244 [+11.6%])</span> 2,350 | <span style='color: red'>(+244 [+11.6%])</span> 2,350 | <span style='color: red'>(+244 [+11.6%])</span> 2,350 |
| `quotient_poly_compute_time_ms` | <span style='color: green'>(-16 [-1.7%])</span> 910 | <span style='color: green'>(-16 [-1.7%])</span> 910 | <span style='color: green'>(-16 [-1.7%])</span> 910 | <span style='color: green'>(-16 [-1.7%])</span> 910 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+68 [+10.7%])</span> 705 | <span style='color: red'>(+68 [+10.7%])</span> 705 | <span style='color: red'>(+68 [+10.7%])</span> 705 | <span style='color: red'>(+68 [+10.7%])</span> 705 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+55 [+2.5%])</span> 2,238 | <span style='color: red'>(+55 [+2.5%])</span> 2,238 | <span style='color: red'>(+55 [+2.5%])</span> 2,238 | <span style='color: red'>(+55 [+2.5%])</span> 2,238 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 |  | 1,384 |  | 6 | 140,487 | 1 | 6 | 20.58 | 38 | 
| leaf |  | 10,911 |  | 1 |  |  | 1 |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 0 | 595 | 10,908 | 646,605,532 | 992,054,762 | 595 | 8,672 | 0 | 910 | 705 | 2,350 | 2,238 | 16 | 1,679 | 247,226,262 | 2,934,877 | 780 | 563 | 5.46 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 94 | 1,384 | 26,518,220 | 32,927,986 | 94 | 963 | 0 | 79 | 136 | 139 | 420 | 7 | 5 | 143 | 8,866,654 | 140,487 | 30 | 81 | 1.88 | 

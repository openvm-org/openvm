...
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+244 [+8.5%])</span> 3,107 | <span style='color: red'>(+244 [+8.5%])</span> 3,107 | <span style='color: red'>(+244 [+8.5%])</span> 3,107 | <span style='color: red'>(+244 [+8.5%])</span> 3,107 |
| `main_trace_commit_time_ms` | <span style='color: red'>(+75 [+13.0%])</span> 653 | <span style='color: red'>(+75 [+13.0%])</span> 653 | <span style='color: red'>(+75 [+13.0%])</span> 653 | <span style='color: red'>(+75 [+13.0%])</span> 653 |
| `generate_perm_trace_time_ms` | <span style='color: red'>(+21 [+9.1%])</span> 252 | <span style='color: red'>(+21 [+9.1%])</span> 252 | <span style='color: red'>(+21 [+9.1%])</span> 252 | <span style='color: red'>(+21 [+9.1%])</span> 252 |
| `perm_trace_commit_time_ms` | <span style='color: red'>(+79 [+14.4%])</span> 627 | <span style='color: red'>(+79 [+14.4%])</span> 627 | <span style='color: red'>(+79 [+14.4%])</span> 627 | <span style='color: red'>(+79 [+14.4%])</span> 627 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  5,556 |  5,556 |  5,556 |  5,556 |
| `main_cells_used     ` | <span style='color: green'>(-57514763 [-28.0%])</span> 148,010,571 | <span style='color: green'>(-57514763 [-28.0%])</span> 148,010,571 | <span style='color: green'>(-57514763 [-28.0%])</span> 148,010,571 | <span style='color: green'>(-57514763 [-28.0%])</span> 148,010,571 |
| `total_cells_used    ` |  370,449,885 |  370,449,885 |  370,449,885 |  370,449,885 |
| `insns               ` |  2,010,352 |  2,010,352 |  2,010,352 |  2,010,352 |
| `execute_preflight_time_ms` |  521 |  521 |  521 |  521 |
| `execute_preflight_insn_mi/s` |  4.45 | -          |  4.45 |  4.45 |
...
| `stark_prove_excluding_trace_time_ms` | <span style='color: green'>(-2147 [-37.3%])</span> 3,602 | <span style='color: green'>(-2147 [-37.3%])</span> 3,602 | <span style='color: green'>(-2147 [-37.3%])</span> 3,602 | <span style='color: green'>(-2147 [-37.3%])</span> 3,602 |
...
| `perm_trace_commit_time_ms` | <span style='color: green'>(-549 [-38.5%])</span> 876 | <span style='color: green'>(-549 [-38.5%])</span> 876 | <span style='color: green'>(-549 [-38.5%])</span> 876 | <span style='color: green'>(-549 [-38.5%])</span> 876 |
...
| `quotient_poly_commit_time_ms` | <span style='color: green'>(-134 [-29.2%])</span> 325 | <span style='color: green'>(-134 [-29.2%])</span> 325 | <span style='color: green'>(-134 [-29.2%])</span> 325 | <span style='color: green'>(-134 [-29.2%])</span> 325 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 5,558 |  | 1 |  |  | 1 |  |  |  | 
| pairing |  | 3,937 |  | 6 | 1,882,939 | 1 | 114 | 16.39 | 40 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 344 | 5,556 | 370,449,885 | 418,598,378 | 344 | 3,602 | 0 | 427 | 325 | 876 | 949 | 12 | 709 | 148,010,571 | 2,010,352 | 310 | 521 | 4.45 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 372 | 3,937 | 219,937,463 | 304,931,516 | 372 | 3,107 | 0 | 352 | 296 | 627 | 916 | 7 | 4 | 653 | 98,834,293 | 1,882,939 | 252 | 212 | 9.22 | 

...
|:---|---:|---:|
| Total |  219.92 |  219.92 |
| kitchen_sink |  15.54 |  15.54 |
| leaf |  23.58 |  23.58 |
| internal.0 |  6.30 |  6.30 |
| root |  38.54 |  38.54 |
| halo2_outer |  91.72 |  91.72 |
...
| `total_proof_time_ms ` |  15,542 |  15,542 |  15,542 |  15,542 |
...
| `stark_prove_excluding_trace_time_ms` |  14,980 |  14,980 |  14,980 |  14,980 |
| `main_trace_commit_time_ms` |  5,091 |  5,091 |  5,091 |  5,091 |
| `generate_perm_trace_time_ms` |  468 |  468 |  468 |  468 |
| `perm_trace_commit_time_ms` |  1,564 |  1,564 |  1,564 |  1,564 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  23,584 |  23,584 |  23,584 |  23,584 |
| `main_cells_used     ` |  769,362,554 |  769,362,554 |  769,362,554 |  769,362,554 |
| `total_cells_used    ` |  2,050,265,876 |  2,050,265,876 |  2,050,265,876 |  2,050,265,876 |
| `execute_preflight_insns` |  7,903,934 |  7,903,934 |  7,903,934 |  7,903,934 |
| `execute_preflight_time_ms` |  1,308 |  1,308 |  1,308 |  1,308 |
| `execute_preflight_insn_mi/s` |  6.93 | -          |  6.93 |  6.93 |
| `trace_gen_time_ms   ` |  1,690 |  1,690 |  1,690 |  1,690 |
| `memory_finalize_time_ms` |  18 |  18 |  18 |  18 |
| `stark_prove_excluding_trace_time_ms` |  19,544 |  19,544 |  19,544 |  19,544 |
| `main_trace_commit_time_ms` |  4,225 |  4,225 |  4,225 |  4,225 |
| `generate_perm_trace_time_ms` |  1,614 |  1,614 |  1,614 |  1,614 |
| `perm_trace_commit_time_ms` |  5,518 |  5,518 |  5,518 |  5,518 |
| `quotient_poly_compute_time_ms` |  2,132 |  2,132 |  2,132 |  2,132 |
| `quotient_poly_commit_time_ms` |  1,450 |  1,450 |  1,450 |  1,450 |
| `pcs_opening_time_ms ` |  4,596 |  4,596 |  4,596 |  4,596 |

| internal.0 |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  6,296 |  6,296 |  6,296 |  6,296 |
| `main_cells_used     ` |  79,527,015 |  79,527,015 |  79,527,015 |  79,527,015 |
| `total_cells_used    ` |  143,463,805 |  143,463,805 |  143,463,805 |  143,463,805 |
| `execute_preflight_insns` |  1,197,747 |  1,197,747 |  1,197,747 |  1,197,747 |
| `execute_preflight_time_ms` |  501 |  501 |  501 |  501 |
| `execute_preflight_insn_mi/s` |  3.46 | -          |  3.46 |  3.46 |
| `trace_gen_time_ms   ` |  192 |  192 |  192 |  192 |
| `memory_finalize_time_ms` |  9 |  9 |  9 |  9 |
| `stark_prove_excluding_trace_time_ms` |  4,593 |  4,593 |  4,593 |  4,593 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  38,544 |  38,544 |  38,544 |  38,544 |
| `main_cells_used     ` |  41,517,834 |  41,517,834 |  41,517,834 |  41,517,834 |
| `total_cells_used    ` |  64,200,196 |  64,200,196 |  64,200,196 |  64,200,196 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  91,724 |  91,724 |  91,724 |  91,724 |
...
| `memory_finalize_time_ms` |  8 |  8 |  8 |  8 |
| `stark_prove_excluding_trace_time_ms` |  38,369 |  38,369 |  38,369 |  38,369 |
| `main_trace_commit_time_ms` |  12,314 |  12,314 |  12,314 |  12,314 |
| `generate_perm_trace_time_ms` |  88 |  88 |  88 |  88 |
| `perm_trace_commit_time_ms` |  7,594 |  7,594 |  7,594 |  7,594 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
|  | 115 | 64,200,196 | 115 | 0 | 91,738 | 44,223 | 21 | 7 | 41,517,834 | 174,027 | 302 | 772,542 | 5.23 | 15,591 | 39,538 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| halo2_keygen | 116 | 38,649 | 64,212,398 | 80,435,354 | 116 | 38,369 | 0 |  |  | 706 | 13,726 |  | 7,594 | 3,894 |  |  | 8 | 12,314 | 41,528,776 | 5,447,564 | 19,146 | 88 |  | 164 | 772,339 | 5.19 |  |  |  |  | 
| halo2_outer |  | 91,724 |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  | 65,627,358 |  |  |  |  |  |  |  |  |  |  |  | 
| halo2_wrapper |  | 44,223 |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  | 
| internal.0 |  |  |  |  |  |  |  |  | 6,297 |  |  |  |  |  | 3 |  |  |  |  |  |  |  | 2 |  |  |  |  |  |  |  | 
| kitchen_sink |  |  |  |  |  |  |  |  |  |  |  | 15,542 |  |  |  | 6 |  |  |  |  |  |  | 1 |  |  |  | 10 | 153,644 | 14.63 | 37 | 
| leaf |  |  |  |  |  |  |  | 23,591 |  |  |  |  |  |  | 1 |  |  |  |  |  |  |  | 1 |  |  |  |  |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal.0 | 0 | 192 | 6,296 | 143,463,805 | 224,975,330 | 192 | 4,593 | 1 | 629 | 733 | 751 | 1,243 | 9 | 1,038 | 79,527,015 | 193 |  | 501 | 1,197,747 | 3.46 | 
| leaf | 0 | 1,690 | 23,584 | 2,050,265,876 | 2,500,267,498 | 1,690 | 19,544 | 0 | 2,132 | 1,450 | 5,518 | 4,596 | 18 | 4,225 | 769,362,554 | 1,614 |  | 1,308 | 7,903,934 | 6.93 | 
| root | 0 | 115 | 38,544 | 64,200,196 | 80,435,354 | 115 | 38,264 | 0 | 702 | 13,662 | 7,582 | 3,894 | 8 | 12,318 | 41,517,834 | 89 | 3 | 165 | 772,542 | 5.12 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| kitchen_sink | 0 | 208 | 15,542 | 1,226,975,002 | 1,481,193,346 | 208 | 14,980 | 3 | 6,277 | 310 | 1,564 | 1,222 | 6 | 3 | 5,091 | 904,738,232 | 468 | 105 | 153,644 | 7.38 | 

...
|:---|---:|---:|
| Total |  216.95 |  216.95 |
| kitchen_sink |  14.97 |  14.97 |
| leaf |  23.48 |  23.48 |
| internal.0 |  5.21 |  5.21 |
| root |  38.61 |  38.61 |
| halo2_outer |  90.13 |  90.13 |
...
| `execute_metered_insn_mi/s` |  14.33 | -          |  14.33 |  14.33 |
...
| `stark_prove_excluding_trace_time_ms` |  14,720 |  14,720 |  14,720 |  14,720 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  23,478 |  23,478 |  23,478 |  23,478 |
| `main_cells_used     ` |  748,993,998 |  748,993,998 |  748,993,998 |  748,993,998 |
| `total_cells_used    ` |  2,003,005,264 |  2,003,005,264 |  2,003,005,264 |  2,003,005,264 |
| `insns               ` |  7,952,473 |  7,952,473 |  7,952,473 |  7,952,473 |
| `execute_e3_time_ms  ` |  2,415 |  2,415 |  2,415 |  2,415 |
| `execute_e3_insn_mi/s` |  3.29 | -          |  3.29 |  3.29 |
| `trace_gen_time_ms   ` |  1,637 |  1,637 |  1,637 |  1,637 |
| `memory_finalize_time_ms` |  16 |  16 |  16 |  16 |
| `boundary_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  19,426 |  19,426 |  19,426 |  19,426 |
| `main_trace_commit_time_ms` |  4,170 |  4,170 |  4,170 |  4,170 |
| `generate_perm_trace_time_ms` |  1,649 |  1,649 |  1,649 |  1,649 |
| `perm_trace_commit_time_ms` |  5,400 |  5,400 |  5,400 |  5,400 |
| `quotient_poly_compute_time_ms` |  2,132 |  2,132 |  2,132 |  2,132 |
| `quotient_poly_commit_time_ms` |  1,432 |  1,432 |  1,432 |  1,432 |
| `pcs_opening_time_ms ` |  4,638 |  4,638 |  4,638 |  4,638 |

| internal.0 |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  5,211 |  5,211 |  5,211 |  5,211 |
...
| `boundary_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  4,544 |  4,544 |  4,544 |  4,544 |
...
| `main_cells_used     ` |  40,016,866 |  40,016,866 |  40,016,866 |  40,016,866 |
| `total_cells_used    ` |  61,676,168 |  61,676,168 |  61,676,168 |  61,676,168 |
| `insns               ` |  772,567 |  772,567 |  772,567 |  772,567 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  90,126 |  90,126 |  90,126 |  90,126 |
| `main_cells_used     ` |  65,627,358 |  65,627,358 |  65,627,358 |  65,627,358 |

| halo2_wrapper |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  44,536 |  44,536 |  44,536 |  44,536 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
|  | 111 | 61,676,168 | 90,140 | 44,536 | 7 | 40,016,866 | 772,567 | 208 | 3.70 | 0 | 16,498 | 39,677 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| halo2_outer | 90,126 |  |  |  |  |  | 65,627,358 |  |  |  |  |  | 
| halo2_wrapper | 44,536 |  |  |  |  |  |  |  |  |  |  |  | 
| internal.0 |  |  | 6,401 |  | 3 |  |  |  | 2 |  |  |  | 
| kitchen_sink |  |  |  | 16,420 |  | 23 |  | 154,596 | 1 | 10 | 14.33 | 54 | 
| leaf |  | 24,680 |  |  | 1 |  |  |  | 1 |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal.0 | 0 | 185 | 5,211 | 134,681,137 | 224,975,330 | 4,544 | 622 | 720 | 736 | 1,229 | 8 | 1,037 | 75,193,371 | 1,197,765 | 195 |  | 482 | 2.48 | 0 | 
| leaf | 0 | 1,637 | 23,478 | 2,003,005,264 | 2,500,267,498 | 19,426 | 2,132 | 1,432 | 5,400 | 4,638 | 16 | 4,170 | 748,993,998 | 7,952,473 | 1,649 |  | 2,415 | 3.29 | 0 | 
| root | 0 | 110 | 38,614 | 61,676,168 | 80,435,354 | 38,294 | 726 | 13,651 | 7,579 | 3,907 | 7 | 12,333 | 40,016,866 | 772,567 | 87 | 3 | 210 | 3.67 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| kitchen_sink | 0 | 219 | 14,975 | 1,217,690,534 | 1,481,195,122 | 14,720 | 6,270 | 302 | 1,506 | 1,225 | 80 | 24 | 2 | 4,905 | 899,579,940 | 154,596 | 464 | 36 | 4.20 | 0 | 

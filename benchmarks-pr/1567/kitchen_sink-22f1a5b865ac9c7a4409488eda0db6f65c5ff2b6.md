...
|:---|---:|---:|
| Total |  213.53 |  213.53 |
| kitchen_sink |  14.43 |  14.43 |
| leaf |  21.41 |  21.41 |
| internal.0 |  4.85 |  4.85 |
| root |  38.63 |  38.63 |
| halo2_outer |  89.63 |  89.63 |
...
| `total_proof_time_ms ` |  14,433 |  14,433 |  14,433 |  14,433 |
...
| `execute_e3_insn_mi/s` |  4.60 | -          |  4.60 |  4.60 |
| `trace_gen_time_ms   ` |  212 |  212 |  212 |  212 |
| `memory_finalize_time_ms` |  3 |  3 |  3 |  3 |
| `boundary_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `merkle_finalize_time_ms` |  62 |  62 |  62 |  62 |
| `stark_prove_excluding_trace_time_ms` |  14,188 |  14,188 |  14,188 |  14,188 |
| `main_trace_commit_time_ms` |  4,497 |  4,497 |  4,497 |  4,497 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  21,405 |  21,405 |  21,405 |  21,405 |
| `main_cells_used     ` |  772,081,928 |  772,081,928 |  772,081,928 |  772,081,928 |
| `total_cells_used    ` |  2,057,384,386 |  2,057,384,386 |  2,057,384,386 |  2,057,384,386 |
| `insns               ` |  7,952,515 |  7,952,515 |  7,952,515 |  7,952,515 |
| `execute_e3_time_ms  ` |  1,573 |  1,573 |  1,573 |  1,573 |
| `execute_e3_insn_mi/s` |  5.05 | -          |  5.05 |  5.05 |
| `trace_gen_time_ms   ` |  1,600 |  1,600 |  1,600 |  1,600 |
| `memory_finalize_time_ms` |  17 |  17 |  17 |  17 |
| `boundary_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  18,232 |  18,232 |  18,232 |  18,232 |
| `main_trace_commit_time_ms` |  3,749 |  3,749 |  3,749 |  3,749 |
| `generate_perm_trace_time_ms` |  1,609 |  1,609 |  1,609 |  1,609 |
| `perm_trace_commit_time_ms` |  4,803 |  4,803 |  4,803 |  4,803 |
| `quotient_poly_compute_time_ms` |  2,142 |  2,142 |  2,142 |  2,142 |
| `quotient_poly_commit_time_ms` |  1,305 |  1,305 |  1,305 |  1,305 |
| `pcs_opening_time_ms ` |  4,620 |  4,620 |  4,620 |  4,620 |

| internal.0 |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  4,852 |  4,852 |  4,852 |  4,852 |
...
| `execute_e3_time_ms  ` |  374 |  374 |  374 |  374 |
| `execute_e3_insn_mi/s` |  3.20 | -          |  3.20 |  3.20 |
| `trace_gen_time_ms   ` |  192 |  192 |  192 |  192 |
| `memory_finalize_time_ms` |  8 |  8 |  8 |  8 |
| `boundary_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  4,286 |  4,286 |  4,286 |  4,286 |
...
| `main_cells_used     ` |  41,517,966 |  41,517,966 |  41,517,966 |  41,517,966 |
| `total_cells_used    ` |  64,200,460 |  64,200,460 |  64,200,460 |  64,200,460 |
| `insns               ` |  772,553 |  772,553 |  772,553 |  772,553 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  89,631 |  89,631 |  89,631 |  89,631 |
| `main_cells_used     ` |  65,627,358 |  65,627,358 |  65,627,358 |  65,627,358 |

| halo2_wrapper |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  44,569 |  44,569 |  44,569 |  44,569 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
|  | 111 | 64,200,460 | 111 | 2 | 89,644 | 44,569 | 7 | 41,517,966 | 772,553 | 171 | 4.50 | 0 | 14,818 | 39,692 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| halo2_outer | 89,631 |  |  |  |  |  | 65,627,358 |  |  |  |  |  | 
| halo2_wrapper | 44,569 |  |  |  |  |  |  |  |  |  |  |  | 
| internal.0 |  |  | 6,036 |  | 3 |  |  |  | 2 |  |  |  | 
| kitchen_sink |  |  |  | 14,766 |  | 5 |  | 154,596 | 1 | 10 | 14.66 | 36 | 
| leaf |  | 22,691 |  |  | 1 |  |  |  | 1 |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal.0 | 0 | 192 | 4,852 | 143,463,777 | 224,975,330 | 192 | 4,286 | 2 | 612 | 677 | 653 | 1,232 | 8 | 913 | 79,527,003 | 1,197,746 | 194 |  | 374 | 3.20 | 0 | 
| leaf | 0 | 1,600 | 21,405 | 2,057,384,386 | 2,500,267,498 | 1,600 | 18,232 | 2 | 2,142 | 1,305 | 4,803 | 4,620 | 17 | 3,749 | 772,081,928 | 7,952,515 | 1,609 |  | 1,573 | 5.05 | 0 | 
| root | 0 | 111 | 38,627 | 64,200,460 | 80,435,354 | 111 | 38,345 | 2 | 699 | 13,705 | 7,580 | 3,917 | 7 | 12,310 | 41,517,966 | 772,553 | 91 | 3 | 171 | 4.50 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| kitchen_sink | 0 | 212 | 14,433 | 1,227,056,610 | 1,481,195,122 | 212 | 14,188 | 2 | 6,306 | 284 | 1,364 | 1,216 | 62 | 6 | 3 | 4,497 | 904,774,168 | 154,596 | 474 | 33 | 4.60 | 0 | 

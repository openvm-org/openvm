...
|:---|---:|---:|---:|
| Total |  4.82 |  3.42 |  3.42 |
| app_proof |  3.80 |  2.40 |  2.40 |
| leaf |  0.43 |  0.43 |  0.43 |
...
| `total_proof_time_ms ` |  1,883.50 |  3,767 |  2,370 |  1,397 |
...
| `execute_preflight_insn_mi/s` |  33.17 | -          |  34.29 |  32.05 |
| `trace_gen_time_ms   ` |  492.50 |  985 |  498 |  487 |
| `memory_finalize_time_ms` |  1 |  2 |  2 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  561 |  1,122 |  628 |  494 |
| `prover.main_trace_commit_time_ms` |  115.50 |  231 |  129 |  102 |
| `prover.rap_constraints_time_ms` |  331.50 |  663 |  372 |  291 |
| `prover.openings_time_ms` |  112.50 |  225 |  125 |  100 |
| `prover.rap_constraints.logup_gkr_time_ms` |  199.50 |  399 |  244 |  155 |
| `prover.rap_constraints.round0_time_ms` |  96.50 |  193 |  104 |  89 |
...
| `prover.openings.whir_time_ms` |  90 |  180 |  100 |  80 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/2b6ac52899e0de6e232799e40f1f1ed20fa7467e/regex-2b6ac52899e0de6e232799e40f1f1ed20fa7467e.memory.svg)
...
| app_proof |  |  |  |  |  | 1,397 |  |  | 34 | 4,090,656 | 117.30 | 0 | 3,816 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 27,289,403 | 256 | 81 | 0 | 0 | 97 | 31 | 31 | 45 | 20 | 0 | 77 | 65 | 11 | 2 | 8 | 82 | 97 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,767 | 168 | 47 | 0 | 0 | 66 | 24 | 24 | 28 | 13 | 0 | 54 | 45 | 8 | 1 | 6 | 47 | 66 | 0 | 2 | 12 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 134 | 31 | 0 | 0 | 62 | 24 | 23 | 24 | 13 | 0 | 39 | 32 | 7 | 1 | 5 | 32 | 62 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 79,959,860 | 377 | 127 | 0 | 0 | 134 | 55 | 54 | 37 | 41 | 0 | 115 | 100 | 15 | 6 | 8 | 127 | 134 | 0 | 6 | 40 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 163,039,698 | 628 | 129 | 0 | 0 | 372 | 89 | 89 | 37 | 244 | 0 | 125 | 100 | 25 | 14 | 11 | 129 | 372 | 0 | 3 | 243 | 0 | 0 | 
| app_proof | prover | 1 | 124,372,364 | 494 | 102 | 0 | 0 | 291 | 104 | 104 | 31 | 155 | 0 | 100 | 80 | 20 | 9 | 10 | 102 | 291 | 0 | 3 | 155 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 2 | 487 | 2,370 | 487 | 1,158 | 2,919,537,094 | 1,047,419,530 | 3,966,956,624 | 2,097,152 | 2 | 6 | 96 | 2,327,000 | 32.05 | 
| app_proof | 1 | 1 | 498 | 1,397 | 498 | 325 | 2,095,905,356 | 675,000,158 | 2,770,905,514 | 2,097,152 | 0 | 2 | 78 | 1,763,656 | 34.29 | 

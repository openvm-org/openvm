...
| `total_proof_time_ms ` |  5,680 |  5,680 |  5,680 |  5,680 |
| `compile_metered_time_ms` |  3 |  3 |  3 |  3 |
| `execute_metered_time_ms` |  25 | -          | -          | -          |
| `execute_metered_insns` |  1,979,971 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  77.06 | -          |  77.06 |  77.06 |
| `execute_preflight_insns` |  1,979,971 |  1,979,971 |  1,979,971 |  1,979,971 |
| `execute_preflight_time_ms` |  81 |  81 |  81 |  81 |
| `execute_preflight_insn_mi/s` |  29.09 | -          |  29.09 |  29.09 |
| `trace_gen_time_ms   ` |  562 |  562 |  562 |  562 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  3,859 |  3,859 |  3,859 |  3,859 |
| `prover.main_trace_commit_time_ms` |  1,144 |  1,144 |  1,144 |  1,144 |
| `prover.rap_constraints_time_ms` |  1,724 |  1,724 |  1,724 |  1,724 |
| `prover.openings_time_ms` |  989 |  989 |  989 |  989 |
| `prover.rap_constraints.logup_gkr_time_ms` |  298 |  298 |  298 |  298 |
| `prover.rap_constraints.round0_time_ms` |  1,038 |  1,038 |  1,038 |  1,038 |
| `prover.rap_constraints.mle_rounds_time_ms` |  388 |  388 |  388 |  388 |
| `prover.openings.stacked_reduction_time_ms` |  191 |  191 |  191 |  191 |
| `prover.openings.stacked_reduction.round0_time_ms` |  110 |  110 |  110 |  110 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  80 |  80 |  80 |  80 |
| `prover.openings.whir_time_ms` |  798 |  798 |  798 |  798 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  867 |  867 |  867 |  867 |
| `execute_preflight_time_ms` |  19 |  19 |  19 |  19 |
| `trace_gen_time_ms   ` |  100 |  100 |  100 |  100 |
| `generate_blob_total_time_ms` |  9 |  9 |  9 |  9 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  767 |  767 |  767 |  767 |
| `prover.main_trace_commit_time_ms` |  255 |  255 |  255 |  255 |
| `prover.rap_constraints_time_ms` |  297 |  297 |  297 |  297 |
| `prover.openings_time_ms` |  214 |  214 |  214 |  214 |
...
| `prover.openings.whir_time_ms` |  186 |  186 |  186 |  186 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/2b6ac52899e0de6e232799e40f1f1ed20fa7467e/kitchen_sink-2b6ac52899e0de6e232799e40f1f1ed20fa7467e.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 70 | 9 |  |  | 0 |  | 366 | 9 |  |  |  |  |  |  | 
| app_proof |  |  |  |  |  | 5,680 |  |  | 25 | 1,979,971 | 77.06 | 0 | 5,710 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 19 | 345 | 18 | 5 | 1 | 2 | 1 | 1 | 
| internal_recursive.0 | 1 | 10 | 185 | 10 | 1 | 0 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 9 | 149 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 100 | 867 | 100 | 18 | 9 | 19 | 13 | 13 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,577,979 | 326 | 118 | 0 | 0 | 108 | 36 | 35 | 51 | 20 | 0 | 98 | 84 | 13 | 3 | 9 | 119 | 108 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,767 | 174 | 48 | 0 | 0 | 68 | 25 | 24 | 28 | 14 | 0 | 57 | 48 | 8 | 1 | 6 | 48 | 68 | 0 | 3 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 139 | 33 | 0 | 0 | 63 | 24 | 23 | 24 | 14 | 0 | 41 | 34 | 7 | 1 | 5 | 33 | 63 | 0 | 2 | 13 | 0 | 0 | 
| leaf | 0 | prover | 167,484,091 | 767 | 255 | 0 | 0 | 297 | 105 | 104 | 59 | 131 | 0 | 214 | 186 | 27 | 14 | 13 | 255 | 297 | 0 | 8 | 131 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,095,593,232 | 3,859 | 1,144 | 0 | 100 | 1,724 | 1,038 | 1,037 | 388 | 298 | 1 | 989 | 798 | 191 | 110 | 80 | 1,144 | 1,724 | 0 | 5 | 296 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 2 | 562 | 5,680 | 562 | 1,177 | 10,406,304,744 | 2,785,050,840 | 13,191,355,584 | 2,097,152 | 0 | 4 | 81 | 1,979,971 | 29.09 | 

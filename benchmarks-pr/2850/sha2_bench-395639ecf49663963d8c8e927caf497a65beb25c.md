...
|:---|---:|---:|---:|
| Total |  16.97 |  7.06 |  7.06 |
| app_proof |  14.21 |  4.30 |  4.30 |
| leaf |  1.93 |  1.93 |  1.93 |
...
| `total_proof_time_ms ` |  3,528.75 |  14,115 |  4,203 |  3,300 |
| `compile_metered_time_ms` |  3 |  3 |  3 |  3 |
| `execute_metered_time_ms` |  100 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  111.48 | -          |  111.48 |  111.48 |
| `execute_preflight_insns` |  2,791,990.25 |  11,167,961 |  2,851,000 |  2,614,961 |
| `execute_preflight_time_ms` |  167.25 |  669 |  213 |  101 |
| `execute_preflight_insn_mi/s` |  34.43 | -          |  35.34 |  31.98 |
| `trace_gen_time_ms   ` |  472 |  1,888 |  523 |  431 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  2,320 |  9,280 |  2,420 |  2,283 |
| `prover.main_trace_commit_time_ms` |  620 |  2,480 |  633 |  614 |
| `prover.rap_constraints_time_ms` |  1,227.25 |  4,909 |  1,233 |  1,224 |
| `prover.openings_time_ms` |  471.75 |  1,887 |  560 |  439 |
| `prover.rap_constraints.logup_gkr_time_ms` |  311.25 |  1,245 |  312 |  311 |
| `prover.rap_constraints.round0_time_ms` |  669 |  2,676 |  673 |  662 |
| `prover.rap_constraints.mle_rounds_time_ms` |  245.75 |  983 |  248 |  243 |
| `prover.openings.stacked_reduction_time_ms` |  96.75 |  387 |  100 |  91 |
| `prover.openings.stacked_reduction.round0_time_ms` |  58.50 |  234 |  60 |  55 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  37.75 |  151 |  39 |  36 |
| `prover.openings.whir_time_ms` |  374.50 |  1,498 |  460 |  345 |
...
| `prover.main_trace_commit_time_ms` |  803 |  803 |  803 |  803 |
| `prover.rap_constraints_time_ms` |  350 |  350 |  350 |  350 |
| `prover.openings_time_ms` |  633 |  633 |  633 |  633 |
...
| `prover.openings.whir_time_ms` |  569 |  569 |  569 |  569 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/395639ecf49663963d8c8e927caf497a65beb25c/sha2_bench-395639ecf49663963d8c8e927caf497a65beb25c.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 76 | 9 |  |  | 0 |  | 368 | 9 |  |  |  |  |  |  | 
| app_proof |  |  |  |  |  | 3,300 |  |  | 100 | 11,167,961 | 111.48 | 0 | 14,222 |  | 
...
| app_proof | VmAirWrapper<Rv64BaseAluWAdapterAir, ShiftCoreAir<4, 8> | 3 | 1 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 25 | 485 | 25 | 7 | 2 | 2 | 4 | 4 | 
| internal_recursive.0 | 1 | 13 | 195 | 12 | 2 | 0 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 9 | 146 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 144 | 1,933 | 144 | 51 | 22 | 3 | 6 | 6 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 61,220,667 | 459 | 183 | 0 | 0 | 130 | 38 | 37 | 64 | 27 | 0 | 144 | 125 | 18 | 5 | 12 | 184 | 130 | 0 | 4 | 26 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,943 | 182 | 50 | 0 | 0 | 72 | 24 | 23 | 29 | 18 | 0 | 59 | 50 | 8 | 1 | 6 | 50 | 72 | 0 | 3 | 17 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 137 | 31 | 0 | 0 | 62 | 23 | 23 | 25 | 13 | 0 | 42 | 35 | 7 | 1 | 5 | 31 | 62 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 425,192,422 | 1,788 | 803 | 0 | 93 | 350 | 171 | 170 | 103 | 75 | 0 | 633 | 569 | 64 | 36 | 27 | 803 | 350 | 0 | 9 | 74 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 642,417,917 | 2,420 | 633 | 0 | 71 | 1,226 | 671 | 671 | 243 | 311 | 0 | 560 | 460 | 100 | 60 | 39 | 633 | 1,226 | 0 | 4 | 309 | 0 | 0 | 
| app_proof | prover | 1 | 642,417,676 | 2,286 | 614 | 0 | 0 | 1,226 | 670 | 670 | 244 | 311 | 0 | 445 | 345 | 99 | 60 | 38 | 614 | 1,226 | 0 | 4 | 310 | 0 | 0 | 
| app_proof | prover | 2 | 642,417,676 | 2,291 | 618 | 0 | 0 | 1,233 | 673 | 672 | 248 | 311 | 0 | 439 | 347 | 91 | 55 | 36 | 618 | 1,233 | 0 | 5 | 310 | 0 | 0 | 
| app_proof | prover | 3 | 642,494,708 | 2,283 | 615 | 0 | 0 | 1,224 | 662 | 662 | 248 | 312 | 0 | 443 | 346 | 97 | 59 | 38 | 615 | 1,224 | 0 | 5 | 311 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 2 | 523 | 4,203 | 523 | 1,157 | 5,549,760,024 | 2,173,742,532 | 7,723,502,556 | 2,097,152 | 0 | 4 | 101 | 2,851,000 | 31.98 | 
| app_proof | 1 | 1 | 431 | 3,302 | 431 | 370 | 5,549,645,136 | 2,173,584,192 | 7,723,229,328 | 2,097,152 | 0 | 2 | 213 | 2,851,000 | 35.34 | 
| app_proof | 2 | 1 | 464 | 3,310 | 464 | 372 | 5,549,647,092 | 2,173,582,236 | 7,723,229,328 | 2,097,152 | 0 | 2 | 181 | 2,851,000 | 35.25 | 
| app_proof | 3 | 1 | 470 | 3,300 | 470 | 371 | 5,096,069,448 | 2,627,162,664 | 7,723,232,112 | 2,097,152 | 0 | 2 | 174 | 2,614,961 | 35.16 | 

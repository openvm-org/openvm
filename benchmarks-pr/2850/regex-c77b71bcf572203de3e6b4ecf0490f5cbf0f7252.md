...
|:---|---:|---:|---:|
| Total |  4.55 |  3.21 |  3.21 |
| app_proof |  3.67 |  2.33 |  2.33 |
| leaf |  0.36 |  0.36 |  0.36 |
...
| `total_proof_time_ms ` |  1,820.50 |  3,641 |  2,298 |  1,343 |
| `compile_metered_time_ms` |  8 |  8 |  8 |  8 |
| `execute_metered_time_ms` |  34 | -          | -          | -          |
| `execute_metered_insns` |  4,090,656 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  118.50 | -          |  118.50 |  118.50 |
| `execute_preflight_insns` |  2,045,328 |  4,090,656 |  2,327,000 |  1,763,656 |
| `execute_preflight_time_ms` |  89.50 |  179 |  99 |  80 |
| `execute_preflight_insn_mi/s` |  31.40 | -          |  32.76 |  30.04 |
| `trace_gen_time_ms   ` |  496 |  992 |  502 |  490 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  491.50 |  983 |  549 |  434 |
| `prover.main_trace_commit_time_ms` |  116 |  232 |  130 |  102 |
| `prover.rap_constraints_time_ms` |  331 |  662 |  371 |  291 |
| `prover.openings_time_ms` |  43.50 |  87 |  47 |  40 |
| `prover.rap_constraints.logup_gkr_time_ms` |  200 |  400 |  245 |  155 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/c77b71bcf572203de3e6b4ecf0490f5cbf0f7252/regex-c77b71bcf572203de3e6b4ecf0490f5cbf0f7252.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 72 | 9 |  |  | 0 |  | 367 | 9 |  |  |  |  |  |  | 
| app_proof |  |  |  |  |  | 1,343 |  |  | 34 | 4,090,656 | 118.50 | 0 | 3,689 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 27,289,403 | 208 | 81 | 0 | 0 | 98 | 32 | 31 | 45 | 19 | 0 | 29 | 18 | 11 | 2 | 8 | 81 | 98 | 0 | 2 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,767 | 142 | 45 | 0 | 0 | 66 | 24 | 24 | 27 | 13 | 0 | 29 | 21 | 8 | 1 | 6 | 46 | 66 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 125 | 32 | 0 | 0 | 62 | 23 | 22 | 24 | 14 | 0 | 30 | 23 | 7 | 1 | 5 | 32 | 62 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 79,959,860 | 311 | 127 | 0 | 0 | 136 | 55 | 54 | 37 | 42 | 0 | 47 | 32 | 15 | 6 | 8 | 127 | 136 | 0 | 5 | 41 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 163,039,698 | 549 | 130 | 0 | 0 | 371 | 88 | 88 | 37 | 245 | 0 | 47 | 21 | 25 | 13 | 11 | 130 | 371 | 0 | 3 | 244 | 0 | 0 | 
| app_proof | prover | 1 | 124,372,364 | 434 | 101 | 0 | 8 | 291 | 104 | 104 | 31 | 155 | 0 | 40 | 20 | 20 | 9 | 10 | 102 | 291 | 0 | 3 | 155 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 2 | 490 | 2,298 | 490 | 1,159 | 1 | 6 | 99 | 2,327,000 | 30.04 | 
| app_proof | 1 | 1 | 502 | 1,343 | 502 | 325 | 0 | 2 | 80 | 1,763,656 | 32.76 | 

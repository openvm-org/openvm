...
| `total_proof_time_ms ` |  1,903.50 |  3,807 |  2,383 |  1,424 |
| `compile_metered_time_ms` |  8 |  8 |  8 |  8 |
| `execute_metered_time_ms` |  34 | -          | -          | -          |
| `execute_metered_insns` |  4,090,656 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  117.47 | -          |  117.47 |  117.47 |
| `execute_preflight_insns` |  2,045,328 |  4,090,656 |  2,327,000 |  1,763,656 |
| `execute_preflight_time_ms` |  87.50 |  175 |  97 |  78 |
| `execute_preflight_insn_mi/s` |  32.42 | -          |  33.36 |  31.47 |
| `trace_gen_time_ms   ` |  510 |  1,020 |  515 |  505 |
| `memory_finalize_time_ms` |  1 |  2 |  2 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  571 |  1,142 |  639 |  503 |
| `prover.main_trace_commit_time_ms` |  117.50 |  235 |  132 |  103 |
| `prover.rap_constraints_time_ms` |  338 |  676 |  379 |  297 |
| `prover.openings_time_ms` |  114.50 |  229 |  127 |  102 |
| `prover.rap_constraints.logup_gkr_time_ms` |  203.50 |  407 |  249 |  158 |
| `prover.rap_constraints.round0_time_ms` |  99.50 |  199 |  108 |  91 |
...
| `prover.openings.whir_time_ms` |  91.50 |  183 |  102 |  81 |
...
| app_proof |  |  |  |  |  | 1,424 |  |  | 34 | 4,090,656 | 117.47 | 0 | 3,857 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 27,289,403 | 262 | 83 | 0 | 0 | 99 | 32 | 32 | 46 | 20 | 0 | 79 | 67 | 11 | 2 | 8 | 83 | 99 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,767 | 170 | 47 | 0 | 0 | 67 | 24 | 24 | 28 | 14 | 0 | 55 | 47 | 8 | 1 | 6 | 47 | 67 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 139 | 32 | 0 | 0 | 63 | 24 | 23 | 24 | 13 | 0 | 42 | 35 | 7 | 1 | 5 | 33 | 63 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 79,959,860 | 385 | 130 | 0 | 0 | 136 | 55 | 54 | 37 | 42 | 0 | 118 | 102 | 15 | 6 | 8 | 130 | 136 | 0 | 7 | 41 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 163,039,698 | 639 | 132 | 0 | 0 | 379 | 91 | 91 | 38 | 249 | 0 | 127 | 102 | 25 | 13 | 11 | 132 | 379 | 0 | 3 | 247 | 0 | 0 | 
| app_proof | prover | 1 | 124,372,364 | 503 | 103 | 0 | 0 | 297 | 108 | 107 | 31 | 158 | 0 | 102 | 81 | 20 | 9 | 10 | 103 | 297 | 0 | 3 | 157 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 2 | 505 | 2,383 | 505 | 1,140 | 2,919,537,094 | 1,047,419,530 | 3,966,956,624 | 2,097,152 | 2 | 7 | 97 | 2,327,000 | 31.47 | 
| app_proof | 1 | 1 | 515 | 1,424 | 515 | 326 | 2,095,905,356 | 675,000,158 | 2,770,905,514 | 2,097,152 | 0 | 2 | 78 | 1,763,656 | 33.36 | 

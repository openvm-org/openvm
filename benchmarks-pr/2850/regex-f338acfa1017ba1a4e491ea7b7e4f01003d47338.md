...
|:---|---:|---:|---:|
| Total |  4.88 |  3.46 |  3.46 |
| app_proof |  3.84 |  2.42 |  2.42 |
| leaf |  0.44 |  0.44 |  0.44 |
...
| `total_proof_time_ms ` |  1,901.50 |  3,803 |  2,380 |  1,423 |
...
| `execute_preflight_insn_mi/s` |  32.62 | -          |  34.42 |  30.83 |
| `trace_gen_time_ms   ` |  509.50 |  1,019 |  516 |  503 |
| `memory_finalize_time_ms` |  1 |  2 |  2 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  569 |  1,138 |  635 |  503 |
| `prover.main_trace_commit_time_ms` |  117 |  234 |  131 |  103 |
| `prover.rap_constraints_time_ms` |  337 |  674 |  377 |  297 |
| `prover.openings_time_ms` |  114.50 |  229 |  127 |  102 |
| `prover.rap_constraints.logup_gkr_time_ms` |  202 |  404 |  247 |  157 |
| `prover.rap_constraints.round0_time_ms` |  100 |  200 |  109 |  91 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/f338acfa1017ba1a4e491ea7b7e4f01003d47338/regex-f338acfa1017ba1a4e491ea7b7e4f01003d47338.memory.svg)
...
| app_proof |  |  |  |  |  | 1,423 |  |  | 35 | 4,090,656 | 116.55 | 0 | 3,852 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 27,289,403 | 258 | 82 | 0 | 0 | 98 | 32 | 31 | 46 | 20 | 0 | 76 | 65 | 11 | 2 | 8 | 83 | 98 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,767 | 167 | 47 | 0 | 0 | 67 | 25 | 24 | 28 | 14 | 0 | 52 | 43 | 8 | 1 | 6 | 47 | 67 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 141 | 32 | 0 | 0 | 63 | 24 | 23 | 24 | 14 | 0 | 44 | 37 | 7 | 1 | 5 | 33 | 63 | 0 | 3 | 13 | 0 | 0 | 
| leaf | 0 | prover | 79,959,860 | 392 | 129 | 0 | 0 | 137 | 56 | 55 | 37 | 43 | 0 | 124 | 109 | 15 | 6 | 8 | 129 | 137 | 0 | 7 | 42 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 163,039,698 | 635 | 130 | 0 | 0 | 377 | 91 | 90 | 37 | 247 | 0 | 127 | 101 | 25 | 13 | 11 | 131 | 377 | 0 | 3 | 246 | 0 | 0 | 
| app_proof | prover | 1 | 124,372,364 | 503 | 103 | 0 | 0 | 297 | 109 | 108 | 31 | 157 | 0 | 102 | 81 | 20 | 9 | 10 | 103 | 297 | 0 | 3 | 156 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 2 | 503 | 2,380 | 503 | 1,143 | 2,919,537,094 | 1,047,419,530 | 3,966,956,624 | 2,097,152 | 2 | 7 | 97 | 2,327,000 | 30.83 | 
| app_proof | 1 | 1 | 516 | 1,423 | 516 | 325 | 2,095,905,356 | 675,000,158 | 2,770,905,514 | 2,097,152 | 0 | 2 | 76 | 1,763,656 | 34.42 | 

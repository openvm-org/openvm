...
|:---|---:|---:|---:|
| Total |  7.54 |  5.88 |  5.88 |
| app_proof |  6.03 |  4.37 |  4.37 |
| leaf |  0.94 |  0.94 |  0.94 |
...
| `total_proof_time_ms ` |  3,002.50 |  6,005 |  4,345 |  1,660 |
| `compile_metered_time_ms` |  2 |  2 |  2 |  2 |
| `execute_metered_time_ms` |  24 | -          | -          | -          |
| `execute_metered_insns` |  1,979,971 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  80.56 | -          |  80.56 |  80.56 |
| `execute_preflight_insns` |  989,985.50 |  1,979,971 |  1,445,000 |  534,971 |
| `execute_preflight_time_ms` |  74.50 |  149 |  82 |  67 |
| `execute_preflight_insn_mi/s` |  29.69 | -          |  30.68 |  28.70 |
| `trace_gen_time_ms   ` |  522 |  1,044 |  549 |  495 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,656.50 |  3,313 |  2,558 |  755 |
| `prover.main_trace_commit_time_ms` |  559.50 |  1,119 |  893 |  226 |
| `prover.rap_constraints_time_ms` |  959 |  1,918 |  1,465 |  453 |
| `prover.openings_time_ms` |  137 |  274 |  198 |  76 |
| `prover.rap_constraints.logup_gkr_time_ms` |  150.50 |  301 |  215 |  86 |
| `prover.rap_constraints.round0_time_ms` |  588.50 |  1,177 |  916 |  261 |
| `prover.rap_constraints.mle_rounds_time_ms` |  218 |  436 |  332 |  104 |
| `prover.openings.stacked_reduction_time_ms` |  100 |  200 |  155 |  45 |
| `prover.openings.stacked_reduction.round0_time_ms` |  56 |  112 |  87 |  25 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  44 |  88 |  68 |  20 |
| `prover.openings.whir_time_ms` |  36.50 |  73 |  43 |  30 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  943 |  943 |  943 |  943 |
...
| `prover.rap_constraints.round0_time_ms` |  135 |  135 |  135 |  135 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/34325145d0d54120ef22aa1663e3c60ceef44cbb/kitchen_sink-34325145d0d54120ef22aa1663e3c60ceef44cbb.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 72 | 9 |  |  | 0 |  | 371 | 9 |  |  |  |  |  |  | 
| app_proof |  |  |  |  |  | 1,660 |  |  | 24 | 1,979,971 | 80.56 | 0 | 6,034 |  | 
| internal_for_leaf |  |  |  | 284 |  |  |  |  |  |  |  |  |  | 284 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,577,979 | 263 | 118 | 0 | 0 | 108 | 36 | 35 | 51 | 20 | 0 | 36 | 22 | 13 | 3 | 9 | 118 | 108 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,767 | 142 | 46 | 0 | 0 | 67 | 25 | 24 | 27 | 13 | 0 | 27 | 19 | 8 | 1 | 6 | 47 | 67 | 0 | 2 | 12 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 125 | 32 | 0 | 0 | 63 | 24 | 23 | 24 | 14 | 0 | 29 | 22 | 7 | 1 | 5 | 32 | 63 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 263,562,356 | 827 | 398 | 0 | 1 | 349 | 135 | 134 | 77 | 137 | 0 | 78 | 38 | 40 | 21 | 18 | 399 | 349 | 0 | 6 | 135 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 904,454,160 | 2,558 | 892 | 0 | 247 | 1,465 | 916 | 915 | 332 | 215 | 62 | 198 | 43 | 155 | 87 | 68 | 893 | 1,465 | 0 | 3 | 152 | 0 | 0 | 
| app_proof | prover | 1 | 280,712,044 | 755 | 225 | 0 | 1 | 453 | 261 | 261 | 104 | 86 | 0 | 76 | 30 | 45 | 25 | 20 | 226 | 453 | 0 | 3 | 85 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 2 | 549 | 4,345 | 549 | 1,170 | 0 | 4 | 67 | 1,445,000 | 28.70 | 
| app_proof | 1 | 1 | 495 | 1,660 | 495 | 325 | 0 | 2 | 82 | 534,971 | 30.68 | 

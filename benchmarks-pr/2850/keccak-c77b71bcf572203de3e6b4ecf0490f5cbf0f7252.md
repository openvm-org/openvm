...
|:---|---:|---:|---:|
| Total |  21.74 |  6.44 |  6.44 |
| app_proof |  18.58 |  4.04 |  4.04 |
| leaf |  2.36 |  1.60 |  1.60 |
...
| `total_proof_time_ms ` |  3,072.33 |  18,434 |  3,899 |  2,839 |
| `compile_metered_time_ms` |  3 |  3 |  3 |  3 |
| `execute_metered_time_ms` |  144 | -          | -          | -          |
| `execute_metered_insns` |  14,365,133 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  99.71 | -          |  99.71 |  99.71 |
| `execute_preflight_insns` |  2,394,188.83 |  14,365,133 |  2,413,000 |  2,300,133 |
| `execute_preflight_time_ms` |  245.33 |  1,472 |  342 |  92 |
| `execute_preflight_insn_mi/s` |  31.63 | -          |  32.36 |  29.03 |
| `trace_gen_time_ms   ` |  343.83 |  2,063 |  493 |  247 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  2,018.67 |  12,112 |  2,160 |  1,921 |
| `prover.main_trace_commit_time_ms` |  683.67 |  4,102 |  797 |  659 |
| `prover.rap_constraints_time_ms` |  1,159.50 |  6,957 |  1,188 |  1,079 |
| `prover.openings_time_ms` |  174.17 |  1,045 |  177 |  170 |
| `prover.rap_constraints.logup_gkr_time_ms` |  321.83 |  1,931 |  329 |  318 |
| `prover.rap_constraints.round0_time_ms` |  579.67 |  3,478 |  600 |  507 |
| `prover.rap_constraints.mle_rounds_time_ms` |  256.83 |  1,541 |  258 |  253 |
| `prover.openings.stacked_reduction_time_ms` |  131.33 |  788 |  135 |  126 |
| `prover.openings.stacked_reduction.round0_time_ms` |  79.17 |  475 |  82 |  75 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  51.33 |  308 |  52 |  50 |
| `prover.openings.whir_time_ms` |  42.67 |  256 |  45 |  40 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,181 |  2,362 |  1,600 |  762 |
| `execute_preflight_time_ms` |  5 |  10 |  5 |  5 |
| `trace_gen_time_ms   ` |  132.50 |  265 |  177 |  88 |
| `generate_blob_total_time_ms` |  21 |  42 |  28 |  14 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,047.50 |  2,095 |  1,422 |  673 |
| `prover.main_trace_commit_time_ms` |  634 |  1,268 |  896 |  372 |
| `prover.rap_constraints_time_ms` |  318.50 |  637 |  412 |  225 |
| `prover.openings_time_ms` |  94 |  188 |  113 |  75 |
| `prover.rap_constraints.logup_gkr_time_ms` |  68 |  136 |  85 |  51 |
| `prover.rap_constraints.round0_time_ms` |  154 |  308 |  202 |  106 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/c77b71bcf572203de3e6b4ecf0490f5cbf0f7252/keccak-c77b71bcf572203de3e6b4ecf0490f5cbf0f7252.memory.svg)
...
| app_proof |  |  |  |  |  | 2,839 |  |  | 144 | 14,365,133 | 99.71 | 0 | 18,586 |  | 
...
| app_proof | VmAirWrapper<Rv64BaseAluAdapterAir, BaseAluCoreAir<8, 8> | 5 | 6 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 39 | 502 | 39 | 13 | 4 | 2 | 2 | 2 | 
| internal_recursive.0 | 1 | 14 | 164 | 13 | 2 | 1 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 9 | 133 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 177 | 1,600 | 177 | 60 | 28 | 5 | 7 | 7 | 
| leaf | 1 | 88 | 762 | 88 | 30 | 14 | 5 | 7 | 7 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 81,415,156 | 462 | 243 | 0 | 1 | 173 | 49 | 48 | 92 | 31 | 0 | 45 | 22 | 23 | 7 | 15 | 243 | 173 | 0 | 3 | 29 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,943 |
...
|:---|---:|---:|---:|
| Total |  14.80 |  6.13 |  6.13 |
| app_proof |  12.70 |  4.03 |  4.03 |
| leaf |  1.43 |  1.43 |  1.43 |
...
| `total_proof_time_ms ` |  3,150.25 |  12,601 |  3,926 |  2,849 |
...
| `execute_preflight_time_ms` |  171.75 |  687 |  216 |  106 |
| `execute_preflight_insn_mi/s` |  33.09 | -          |  34.24 |  30.49 |
| `trace_gen_time_ms   ` |  458 |  1,832 |  528 |  413 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,983 |  7,932 |  2,124 |  1,897 |
| `prover.main_trace_commit_time_ms` |  548 |  2,192 |  639 |  517 |
| `prover.rap_constraints_time_ms` |  1,295.75 |  5,183 |  1,354 |  1,241 |
| `prover.openings_time_ms` |  138.25 |  553 |  141 |  136 |
| `prover.rap_constraints.logup_gkr_time_ms` |  376.50 |  1,506 |  435 |  322 |
| `prover.rap_constraints.round0_time_ms` |  666.50 |  2,666 |  671 |  663 |
| `prover.rap_constraints.mle_rounds_time_ms` |  252 |  1,008 |  255 |  250 |
| `prover.openings.stacked_reduction_time_ms` |  99.25 |  397 |  102 |  97 |
| `prover.openings.stacked_reduction.round0_time_ms` |  60 |  240 |  63 |  58 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  38.50 |  154 |  39 |  38 |
| `prover.openings.whir_time_ms` |  38.25 |  153 |  39 |  38 |
...
| `prover.main_trace_commit_time_ms` |  814 |  814 |  814 |  814 |
| `prover.rap_constraints_time_ms` |  357 |  357 |  357 |  357 |
| `prover.openings_time_ms` |  109 |  109 |  109 |  109 |
| `prover.rap_constraints.logup_gkr_time_ms` |  76 |  76 |  76 |  76 |
| `prover.rap_constraints.round0_time_ms` |  174 |  174 |  174 |  174 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/c77b71bcf572203de3e6b4ecf0490f5cbf0f7252/sha2_bench-c77b71bcf572203de3e6b4ecf0490f5cbf0f7252.memory.svg)

| Module | Max (GB) | Max At |
| --- | ---: | --- |
| frac_sumcheck.gkr_rounds | 11.35 | app_proof.prover.3 |
| prover.batch_constraints.before_round0 | 11.35 | app_proof.prover.3 |
| frac_sumcheck.segment_tree | 11.25 | app_proof.prover.3 |
| prover.gkr_input_evals | 11.25 | app_proof.prover.3 |
| prover.rap_constraints | 10.42 | app_proof.prover.3 |
| prover.batch_constraints.round0 | 10.42 | app_proof.prover.3 |
| prover.batch_constraints.fold_ple_evals | 10.42 | app_proof.prover.3 |
| prover.merkle_tree | 9.80 | app_proof.prover.3 |
| prover.openings | 9.80 | app_proof.prover.3 |
| prover.prove_whir_opening | 9.80 | app_proof.prover.3 |
...
| generate mem proving ctxs | 6.34 | app_proof.3 |
...
| --- | --- | --- | --- | --- | --- | --- |
| 136 | 9 | 0 | 267,271 | 229,956 | 9 | 475 | 

| air_id | air_name | interactions | constraints | constraint_deg |
| --- | --- | --- | --- | --- |
| 0 | ProgramAir | 1 |  | 1 | 
| 1 | VmConnectorAir | 5 | 9 | 3 | 
| 10 | Sha2MainAir<Sha512Config> | 181 | 74 | 3 | 
| 11 | Sha2BlockHasherVmAir<Sha512Config> | 53 | 1,481 | 3 | 
| 12 | Sha2MainAir<Sha256Config> | 101 | 42 | 3 | 
| 13 | Sha2BlockHasherVmAir<Sha256Config> | 29 | 754 | 3 | 
| 14 | Rv64HintStoreAir | 18 | 18 | 3 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 79 | 9 |  |  | 0 |  | 362 | 9 |  |  |  |  |  |  | 
| app_proof |  |  |  |  |  | 2,849 |  |  | 100 | 11,167,961 | 110.76 | 0 | 12,709 |  | 
...
| app_proof | 12 | Sha2MainAir<Sha256Config> | prover | 0 | 65,536 | 169 | 11,075,584 | 
...
| app_proof | 20 | VmAirWrapper<Rv64LoadStoreAdapterAir, LoadSignExtendCoreAir<8, 8> | prover | 0 | 65,536 | 47 | 3,080,192 | 
| app_proof | 21 | VmAirWrapper<Rv64LoadStoreAdapterAir, LoadStoreCoreAir<8> | prover | 0 | 1,048,576 | 55 | 57,671,680 | 
...
| app_proof | 21 | VmAirWrapper<Rv64LoadStoreAdapterAir, LoadStoreCoreAir<8> | prover | 1 | 1,048,576 | 55 | 57,671,680 | 
...
| app_proof | 12 | Sha2MainAir<Sha256Config> | prover | 2 | 65,536 | 169 | 11,075,584 | 
...
| app_proof | 2 | PersistentBoundaryAir<8> | prover | 2 | 1,024 | 22 | 22,528 | 
| app_proof | 20 | VmAirWrapper<Rv64LoadStoreAdapterAir, LoadSignExtendCoreAir<8, 8> | prover | 2 | 65,536 | 47 | 3,080,192 | 
| app_proof | 21 | VmAirWrapper<Rv64LoadStoreAdapterAir, LoadStoreCoreAir<8> | prover | 2 | 1,048,576 | 55 | 57,671,680 | 
...
| app_proof | 12 | Sha2MainAir<Sha256Config> | prover | 3 | 65,536 | 169 | 11,075,584 | 
...
| app_proof | 2 | PersistentBoundaryAir<8> | prover | 3 | 1,024 | 22 | 22,528 | 
| app_proof | 20 | VmAirWrapper<Rv64LoadStoreAdapterAir, LoadSignExtendCoreAir<8, 8> | prover | 3 | 65,536 | 47 | 3,080,192 | 
| app_proof | 21 | VmAirWrapper<Rv64LoadStoreAdapterAir, LoadStoreCoreAir<8> | prover | 3 | 1,048,576 | 55 | 57,671,680 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 24 | 386 | 24 | 7 | 2 | 2 | 3 | 3 | 
| internal_recursive.0 | 1 | 12 | 164 | 12 | 2 | 0 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 9 | 127 | 8 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 144 | 1,425 | 144 | 50 | 22 | 2 | 6 | 6 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 61,220,667 | 361 | 185 | 0 | 0 | 135 | 39 | 39 | 66 | 29 | 0 | 39 | 20 | 18 | 5 | 13 | 186 | 135 | 0 | 3 | 26 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,943 | 152 | 48 | 0 | 0 | 75 | 27 | 26 | 29 | 18 | 0 | 28 | 19 | 8 | 2 | 6 | 48 | 75 | 0 | 2 | 17 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 118 | 32 | 0 | 0 | 61 | 23 | 22 | 24 | 13 | 0 | 24 | 17 | 7 | 1 | 5 | 32 | 61 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 425,192,422 | 1,280 | 813 | 0 | 161 | 357 | 174 | 173 | 106 | 76 | 0 | 109 | 43 | 65 | 36 | 29 | 814 | 357 | 0 | 7 | 74 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 642,417,917 | 2,124 | 639 | 0 | 130 | 1,344 | 665 | 665 | 252 | 427 | 118 | 139 | 39 | 99 | 59 | 39 | 639 | 1,344 | 0 | 3 | 307 | 0 | 0 | 
| app_proof | prover | 1 | 642,417,676 | 2,013 | 517 | 0 | 2 | 1,354 | 663 | 663 | 255 | 435 | 135 | 141 | 38 | 102 | 63 | 39 | 517 | 1,354 | 0 | 4 | 298 | 0 | 0 | 
| app_proof | prover | 2 | 642,417,676 | 1,897 | 517 | 0 | 2 | 1,244 | 671 | 671 | 250 | 322 | 0 | 136 | 38 | 97 | 58 | 38 | 517 | 1,244 | 0 | 4 | 321 | 0 | 0 | 
| app_proof | prover | 3 | 642,494,708 | 1,898 | 519 | 0 | 2 | 1,241 | 667 | 667 | 251 | 322 | 0 | 137 | 38 | 99 | 60 | 38 | 519 | 1,241 | 0 | 3 | 321 | 0 | 0 | 

| group | phase | segment | trace_height_constraint | weighted_sum | threshold |
| --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 0 | 118,909,331 | 2,013,265,921 | 
| app_proof | prover | 1 | 0 | 118,909,194 | 2,013,265,921 | 
| app_proof | prover | 2 | 0 | 118,909,194 | 2,013,265,921 | 
| app_proof | prover | 3 | 0 | 118,909,566 | 2,013,265,921 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 2 | 528 | 3,926 | 528 | 1,168 | 0 | 4 | 106 | 2,851,000 | 30.49 | 
| app_proof | 1 | 1 | 413 | 2,970 | 413 | 326 | 0 | 2 | 216 | 2,851,000 | 34.24 | 
| app_proof | 2 | 1 | 445 | 2,856 | 445 | 326 | 0 | 2 | 187 | 2,851,000 | 33.44 | 
| app_proof | 3 | 1 | 446 | 2,849 | 446 | 325 | 0 | 2 | 178 | 2,614,961 | 34.20 | 

...
| `total_proof_time_ms ` |  5,609 |  5,609 |  5,609 |  5,609 |
| `compile_metered_time_ms` |  3 |  3 |  3 |  3 |
| `execute_metered_time_ms` |  22 | -          | -          | -          |
| `execute_metered_insns` |  1,979,971 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  88.29 | -          |  88.29 |  88.29 |
| `execute_preflight_insns` |  1,979,971 |  1,979,971 |  1,979,971 |  1,979,971 |
| `execute_preflight_time_ms` |  82 |  82 |  82 |  82 |
| `execute_preflight_insn_mi/s` |  33.64 | -          |  33.64 |  33.64 |
| `trace_gen_time_ms   ` |  549 |  549 |  549 |  549 |
| `set_initial_memory_time_ms` |  1,167 |  1,167 |  1,167 |  1,167 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  3,810 |  3,810 |  3,810 |  3,810 |
| `prover.main_trace_commit_time_ms` |  1,126 |  1,126 |  1,126 |  1,126 |
| `prover.rap_constraints_time_ms` |  1,705 |  1,705 |  1,705 |  1,705 |
| `prover.openings_time_ms` |  978 |  978 |  978 |  978 |
| `prover.rap_constraints.logup_gkr_time_ms` |  286 |  286 |  286 |  286 |
| `prover.rap_constraints.round0_time_ms` |  1,033 |  1,033 |  1,033 |  1,033 |
| `prover.rap_constraints.mle_rounds_time_ms` |  385 |  385 |  385 |  385 |
...
| `prover.openings.whir_time_ms` |  791 |  791 |  791 |  791 |
...
| `prover.rap_constraints_time_ms` |  296 |  296 |  296 |  296 |
| `prover.openings_time_ms` |  212 |  212 |  212 |  212 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/ff751957a4cfeefa242fb1cf49f325dace218a42/kitchen_sink-ff751957a4cfeefa242fb1cf49f325dace218a42.memory.svg)

| Module | Max (GB) | Max At |
| --- | ---: | --- |
| prover.stacked_commit | 12.39 | app_proof.prover.0 |
| prover.rap_constraints | 9.18 | app_proof.prover.0 |
| prover.openings | 8.39 | app_proof.prover.0 |
| prover.merkle_tree | 8.39 | app_proof.prover.0 |
| prover.prove_whir_opening | 8.39 | app_proof.prover.0 |
| prover.rs_code_matrix | 8.38 | app_proof.prover.0 |
| prover.batch_constraints.before_round0 | 7.38 | app_proof.prover.0 |
| frac_sumcheck.gkr_rounds | 7.38 | app_proof.prover.0 |
| prover.gkr_input_evals | 7.29 | app_proof.prover.0 |
| frac_sumcheck.segment_tree | 7.29 | app_proof.prover.0 |
| prover.batch_constraints.fold_ple_evals | 7.13 | app_proof.prover.0 |
| prover.batch_constraints.round0 | 7.13 | app_proof.prover.0 |
| generate mem proving ctxs | 6.16 | app_proof.0 |
| set initial memory | 6.16 | app_proof.0 |
| prover.before_gkr_input_evals | 4.26 | app_proof.prover.0 |
...
| 43 | VmAirWrapper<Rv64VecHeapU16AdapterAir<2, 4, 4>, 2, 4, 4, 4, 16, 16>, ShiftRightArithmeticCoreAir<16, 16> |  | 112 | 370 | 3 | 
| 44 | VmAirWrapper<Rv64VecHeapU16AdapterAir<2, 4, 4>, 2, 4, 4, 4, 16, 16>, ShiftLogicalCoreAir<16, 16> |  | 111 | 675 | 3 | 
| 45 | VmAirWrapper<Rv64VecHeapAdapterAir<2, 4, 4>, 2, 4, 4, 8, 32, 32>, MultiplicationCoreAir<32, 8> |  | 142 | 31 | 3 | 
| 46 | VmAirWrapper<Rv64VecHeapBranchU16AdapterAir<2, 4>, 2, 4, 4, 16>, BranchLessThanCoreAir<16, 16> |  | 56 | 79 | 3 | 
| 47 | VmAirWrapper<Rv64VecHeapBranchU16AdapterAir<2, 4>, 2, 4, 4, 16>, BranchEqualCoreAir<16> |  | 53 | 41 | 3 | 
| 48 | VmAirWrapper<Rv64VecHeapU16AdapterAir<2, 4, 4>, 2, 4, 4, 4, 16, 16>, LessThanCoreAir<16, 16> |  | 81 | 86 | 3 | 
| 49 | VmAirWrapper<Rv64VecHeapAdapterAir<2, 4, 4>, 2, 4, 4, 8, 32, 32>, BitwiseLogicCoreAir<32, 8> |  | 110 | 34 | 3 | 
| 5 | VmAirWrapper<Rv64VecHeapAdapterAir<2, 12, 12>, FieldExpressionCoreAir> |  | 777 | 420 | 3 | 
| 50 | VmAirWrapper<Rv64VecHeapU16AdapterAir<2, 4, 4>, 2, 4, 4, 4, 16, 16>, AddSubCoreAir<16, 16> |  | 94 | 65 | 3 | 
...
| 57 | Sha2MainAir<Sha512Config> | 1 | 181 | 74 | 3 | 
| 58 | Sha2BlockHasherVmAir<Sha512Config> | 1 | 53 | 1,481 | 3 | 
| 59 | Sha2MainAir<Sha256Config> | 1 | 101 | 42 | 3 | 
...
| 61 | KeccakfOpAir |  | 135 | 53 | 3 | 
| 62 | KeccakfPermAir | 1 | 2 | 3,183 | 3 | 
| 63 | XorinVmAir |  | 408 | 143 | 3 | 
| 64 | Rv64HintStoreAir | 1 | 18 | 18 | 3 | 
...
| 70 | VmAirWrapper<Rv64LoadStoreAdapterAir, LoadSignExtendCoreAir<8, 8> |  | 22 | 24 | 3 | 
| 71 | VmAirWrapper<Rv64LoadStoreAdapterAir, LoadStoreCoreAir<8> |  | 25 | 33 | 3 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 72 |  |  |  | 370 |  |  |  |  |  |  | 
| app_proof |  |  |  | 5,609 |  | 22 | 1,979,971 | 88.29 | 0 | 5,637 |  | 
...
| app_proof | VmAirWrapper<Rv64LoadStoreAdapterAir, LoadSignExtendCoreAir<8, 8> | 17 | VmAirWrapper<Rv64LoadStoreAdapterAir, LoadSignExtendCoreAir<8, 8> | 0 | 1,460,460 | 
| app_proof | VmAirWrapper<Rv64LoadStoreAdapterAir, LoadStoreCoreAir<8> | 16 | VmAirWrapper<Rv64LoadStoreAdapterAir, LoadStoreCoreAir<8> | 0 | 36,909,720 | 
...
| app_proof | 44 | VmAirWrapper<Rv64VecHeapU16AdapterAir<2, 4, 4>, 2, 4, 4, 4, 16, 16>, ShiftLogicalCoreAir<16, 16> | prover | 0 | 512 | 205 | 104,960 | 
| app_proof | 45 | VmAirWrapper<Rv64VecHeapAdapterAir<2, 4, 4>, 2, 4, 4, 8, 32, 32>, MultiplicationCoreAir<32, 8> | prover | 0 | 256 | 184 | 47,104 | 
| app_proof | 47 | VmAirWrapper<Rv64VecHeapBranchU16AdapterAir<2, 4>, 2, 4, 4, 16>, BranchEqualCoreAir<16> | prover | 0 | 256 | 100 | 25,600 | 
| app_proof | 48 | VmAirWrapper<Rv64VecHeapU16AdapterAir<2, 4, 4>, 2, 4, 4, 4, 16, 16>, LessThanCoreAir<16, 16> | prover | 0 | 512 | 141 | 72,192 | 
| app_proof | 49 | VmAirWrapper<Rv64VecHeapAdapterAir<2, 4, 4>, 2, 4, 4, 8, 32, 32>, BitwiseLogicCoreAir<32, 8> | prover | 0 | 512 | 186 | 95,232 | 
| app_proof | 5 | VmAirWrapper<Rv64VecHeapAdapterAir<2, 12, 12>, FieldExpressionCoreAir> | prover | 0 | 1 | 988 | 988 | 
| app_proof | 50 | VmAirWrapper<Rv64VecHeapU16AdapterAir<2, 4, 4>, 2, 4, 4, 4, 16, 16>, AddSubCoreAir<16, 16> | prover | 0 | 512 | 137 | 70,144 | 
...
| app_proof | 59 | Sha2MainAir<Sha256Config> | prover | 0 | 32,768 | 169 | 5,537,792 | 
...
| app_proof | 61 | KeccakfOpAir | prover | 0 | 16,384 | 310 | 5,079,040 | 
| app_proof | 62 | KeccakfPermAir | prover | 0 | 262,144 | 2,634 | 690,487,296 | 
| app_proof | 63 | XorinVmAir | prover | 0 | 16,384 | 720 | 11,796,480 | 
...
| app_proof | 70 | VmAirWrapper<Rv64LoadStoreAdapterAir, LoadSignExtendCoreAir<8, 8> | prover | 0 | 32,768 | 47 | 1,540,096 | 
| app_proof | 71 | VmAirWrapper<Rv64LoadStoreAdapterAir, LoadStoreCoreAir<8> | prover | 0 | 1,048,576 | 55 | 57,671,680 | 
...
| app_proof | 2 | PersistentBoundaryAir<8> | 0 | 4,118 | 4,074 | 226,490 | 224,070 | 362,384 | 358,512 | 90,596 | 89,628 | 895,665 | 886,095 | 24,708 | 24,444 | 
...
| app_proof | 3 | MemoryMerkleAir<8> | 0 | 4,356 | 3,836 | 696,960 | 613,760 | 557,568 | 491,008 | 139,392 | 122,752 | 631,620 | 556,220 | 17,424 | 15,344 | 
...
| app_proof | 44 | VmAirWrapper<Rv64VecHeapU16AdapterAir<2, 4, 4>, 2, 4, 4, 4, 16, 16>, ShiftLogicalCoreAir<16, 16> | 0 | 400 | 112 | 205,000 | 57,400 | 328,000 | 91,840 | 82,000 | 22,960 | 1,609,500 | 450,660 | 44,400 | 12,432 | 
| app_proof | 45 | VmAirWrapper<Rv64VecHeapAdapterAir<2, 4, 4>, 2, 4, 4, 8, 32, 32>, MultiplicationCoreAir<32, 8> | 0 | 200 | 56 | 92,000 | 25,760 | 147,200 | 41,216 | 36,800 | 10,304 | 1,029,500 | 288,260 | 28,400 | 7,952 | 
| app_proof | 47 | VmAirWrapper<Rv64VecHeapBranchU16AdapterAir<2, 4>, 2, 4, 4, 16>, BranchEqualCoreAir<16> | 0 | 200 | 56 | 50,000 | 14,000 | 80,000 | 22,400 | 20,000 | 5,600 | 384,250 | 107,590 | 10,600 | 2,968 | 
| app_proof | 48 | VmAirWrapper<Rv64VecHeapU16AdapterAir<2, 4, 4>, 2, 4, 4, 4, 16, 16>
...
|:---|---:|---:|---:|
| Total |  16.91 |  7.04 |  7.04 |
| app_proof |  14.15 |  4.29 |  4.29 |
| leaf |  1.93 |  1.93 |  1.93 |
...
| `total_proof_time_ms ` |  3,512 |  14,048 |  4,186 |  3,280 |
...
| `execute_preflight_time_ms` |  164.25 |  657 |  206 |  99 |
| `execute_preflight_insn_mi/s` |  34.94 | -          |  36.07 |  32.61 |
| `trace_gen_time_ms   ` |  465.25 |  1,861 |  510 |  429 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  2,310.75 |  9,243 |  2,409 |  2,270 |
| `prover.main_trace_commit_time_ms` |  617.25 |  2,469 |  630 |  611 |
| `prover.rap_constraints_time_ms` |  1,221.75 |  4,887 |  1,228 |  1,214 |
| `prover.openings_time_ms` |  470.25 |  1,881 |  556 |  441 |
| `prover.rap_constraints.logup_gkr_time_ms` |  309.50 |  1,238 |  310 |  308 |
| `prover.rap_constraints.round0_time_ms` |  667.75 |  2,671 |  671 |  664 |
| `prover.rap_constraints.mle_rounds_time_ms` |  243.75 |  975 |  248 |  239 |
| `prover.openings.stacked_reduction_time_ms` |  96.50 |  386 |  97 |  96 |
| `prover.openings.stacked_reduction.round0_time_ms` |  58 |  232 |  58 |  58 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  38.25 |  153 |  39 |  38 |
| `prover.openings.whir_time_ms` |  373.25 |  1,493 |  459 |  344 |
...
| `prover.openings_time_ms` |  632 |  632 |  632 |  632 |
...
| `prover.openings.whir_time_ms` |  567 |  567 |  567 |  567 |
...
| `prover.openings_time_ms` |  146 |  146 |  146 |  146 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/2b6ac52899e0de6e232799e40f1f1ed20fa7467e/sha2_bench-2b6ac52899e0de6e232799e40f1f1ed20fa7467e.memory.svg)
...
| app_proof |  |  |  |  |  | 3,280 |  |  | 104 | 11,167,961 | 107.25 | 0 | 14,159 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 26 | 485 | 25 | 7 | 2 | 2 | 3 | 3 | 
| internal_recursive.0 | 1 | 12 | 196 | 12 | 1 | 0 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 9 | 145 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 149 | 1,928 | 149 | 51 | 22 | 3 | 6 | 6 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 61,220,667 | 459 | 182 | 0 | 0 | 129 | 37 | 37 | 64 | 27 | 0 | 146 | 127 | 18 | 5 | 12 | 183 | 129 | 0 | 4 | 26 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,943 | 183 | 50 | 0 | 0 | 72 | 25 | 24 | 29 | 17 | 0 | 59 | 50 | 8 | 2 | 6 | 50 | 72 | 0 | 3 | 17 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 135 | 31 | 0 | 0 | 61 | 23 | 22 | 24 | 13 | 0 | 42 | 34 | 7 | 1 | 5 | 32 | 61 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 425,192,422 | 1,778 | 798 | 0 | 91 | 346 | 167 | 166 | 104 | 74 | 0 | 632 | 567 | 64 | 36 | 27 | 799 | 346 | 0 | 9 | 73 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 642,417,917 | 2,409 | 630 | 0 | 71 | 1,222 | 667 | 667 | 244 | 310 | 0 | 556 | 459 | 96 | 58 | 38 | 630 | 1,222 | 0 | 4 | 308 | 0 | 0 | 
| app_proof | prover | 1 | 642,417,676 | 2,278 | 611 | 0 | 0 | 1,223 | 669 | 668 | 244 | 310 | 0 | 442 | 345 | 97 | 58 | 38 | 611 | 1,223 | 0 | 4 | 308 | 0 | 0 | 
| app_proof | prover | 2 | 642,417,676 | 2,286 | 615 | 0 | 0 | 1,228 | 671 | 670 | 248 | 308 | 0 | 442 | 344 | 97 | 58 | 39 | 615 | 1,228 | 0 | 4 | 307 | 0 | 0 | 
| app_proof | prover | 3 | 642,494,708 | 2,270 | 613 | 0 | 0 | 1,214 | 664 | 664 | 239 | 310 | 0 | 441 | 345 | 96 | 58 | 38 | 613 | 1,214 | 0 | 4 | 308 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 2 | 510 | 4,186 | 510 | 1,167 | 5,549,760,024 | 2,173,742,532 | 7,723,502,556 | 2,097,152 | 0 | 4 | 99 | 2,851,000 | 32.61 | 
| app_proof | 1 | 1 | 429 | 3,285 | 429 | 371 | 5,549,645,136 | 2,173,584,192 | 7,723,229,328 | 2,097,152 | 0 | 2 | 206 | 2,851,000 | 35.47 | 
| app_proof | 2 | 1 | 456 | 3,297 | 456 | 372 | 5,549,647,092 | 2,173,582,236 | 7,723,229,328 | 2,097,152 | 0 | 2 | 181 | 2,851,000 | 35.62 | 
| app_proof | 3 | 1 | 466 | 3,280 | 466 | 371 | 5,096,069,448 | 2,627,162,664 | 7,723,232,112 | 2,097,152 | 0 | 2 | 171 | 2,614,961 | 36.07 | 

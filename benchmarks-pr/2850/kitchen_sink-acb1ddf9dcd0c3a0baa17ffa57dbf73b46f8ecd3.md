...
|:---|---:|---:|---:|
| Total |  7.61 |  5.94 |  5.94 |
| app_proof |  6.09 |  4.42 |  4.42 |
| leaf |  0.95 |  0.95 |  0.95 |
...
| `total_proof_time_ms ` |  3,031.50 |  6,063 |  4,392 |  1,671 |
| `compile_metered_time_ms` |  3 |  3 |  3 |  3 |
| `execute_metered_time_ms` |  24 | -          | -          | -          |
| `execute_metered_insns` |  1,979,971 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  80.96 | -          |  80.96 |  80.96 |
| `execute_preflight_insns` |  989,985.50 |  1,979,971 |  1,445,000 |  534,971 |
| `execute_preflight_time_ms` |  75.50 |  151 |  86 |  65 |
| `execute_preflight_insn_mi/s` |  30.08 | -          |  30.71 |  29.46 |
| `trace_gen_time_ms   ` |  528 |  1,056 |  559 |  497 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,671 |  3,342 |  2,581 |  761 |
| `prover.main_trace_commit_time_ms` |  566.50 |  1,133 |  907 |  226 |
| `prover.rap_constraints_time_ms` |  963.50 |  1,927 |  1,471 |  456 |
| `prover.openings_time_ms` |  139.50 |  279 |  202 |  77 |
| `prover.rap_constraints.logup_gkr_time_ms` |  152.50 |  305 |  216 |  89 |
| `prover.rap_constraints.round0_time_ms` |  592 |  1,184 |  922 |  262 |
| `prover.rap_constraints.mle_rounds_time_ms` |  218 |  436 |  332 |  104 |
| `prover.openings.stacked_reduction_time_ms` |  101.50 |  203 |  158 |  45 |
| `prover.openings.stacked_reduction.round0_time_ms` |  55.50 |  111 |  87 |  24 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  45.50 |  91 |  70 |  21 |
| `prover.openings.whir_time_ms` |  37.50 |  75 |  44 |  31 |
...
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  837 |  837 |  837 |  837 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/acb1ddf9dcd0c3a0baa17ffa57dbf73b46f8ecd3/kitchen_sink-acb1ddf9dcd0c3a0baa17ffa57dbf73b46f8ecd3.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 71 | 9 |  |  | 0 |  | 372 | 9 |  |  |  |  |  |  | 
| app_proof |  |  |  |  |  | 1,671 |  |  | 24 | 1,979,971 | 80.96 | 0 | 6,093 |  | 
| internal_for_leaf |  |  |  | 283 |  |  |  |  |  |  |  |  |  | 283 | 
| internal_recursive.0 |  |  |  | 156 |  |  |  |  |  |  |  |  |  | 156 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 20 | 283 | 20 | 6 | 1 | 2 | 2 | 2 | 
| internal_recursive.0 | 1 | 10 | 156 | 10 | 1 | 0 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 9 | 131 | 8 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 115 | 953 | 115 | 24 | 10 | 18 | 2 | 2 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,577,979 | 262 | 118 | 0 | 0 | 108 | 36 | 35 | 51 | 20 | 0 | 35 | 21 | 13 | 3 | 9 | 118 | 108 | 0 | 2 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,767 | 145 | 46 | 0 | 0 | 68 | 25 | 24 | 28 | 14 | 0 | 30 | 22 | 8 | 1 | 6 | 47 | 68 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 122 | 32 | 0 | 0 | 62 | 24 | 23 | 24 | 13 | 0 | 26 | 19 | 7 | 1 | 5 | 32 | 62 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 263,562,356 | 837 | 404 | 0 | 1 | 352 | 136 | 135 | 79 | 137 | 0 | 80 | 39 | 40 | 21 | 18 | 404 | 352 | 0 | 7 | 136 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 904,454,160 | 2,581 | 907 | 0 | 252 | 1,471 | 922 | 921 | 332 | 216 | 62 | 202 | 44 | 158 | 87 | 70 | 907 | 1,471 | 0 | 4 | 153 | 0 | 0 | 
| app_proof | prover | 1 | 280,712,044 | 761 | 226 | 0 | 1 | 456 | 262 | 261 | 104 | 89 | 0 | 77 | 31 | 45 | 24 | 21 | 226 | 456 | 0 | 3 | 88 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 2 | 559 | 4,392 | 559 | 1,185 | 0 | 4 | 65 | 1,445,000 | 29.46 | 
| app_proof | 1 | 1 | 497 | 1,671 | 497 | 325 | 0 | 2 | 86 | 534,971 | 30.71 | 

...
|:---|---:|---:|---:|
| Total |  7.57 |  5.89 |  5.89 |
| app_proof |  6.05 |  4.38 |  4.38 |
| leaf |  0.95 |  0.95 |  0.95 |
...
| `total_proof_time_ms ` |  3,013 |  6,026 |  4,352 |  1,674 |
| `compile_metered_time_ms` |  2 |  2 |  2 |  2 |
| `execute_metered_time_ms` |  24 | -          | -          | -          |
| `execute_metered_insns` |  1,979,971 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  81.53 | -          |  81.53 |  81.53 |
| `execute_preflight_insns` |  989,985.50 |  1,979,971 |  1,445,000 |  534,971 |
| `execute_preflight_time_ms` |  74 |  148 |  82 |  66 |
| `execute_preflight_insn_mi/s` |  29.53 | -          |  30.26 |  28.80 |
| `trace_gen_time_ms   ` |  524.50 |  1,049 |  547 |  502 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,668 |  3,336 |  2,572 |  764 |
| `prover.main_trace_commit_time_ms` |  560.50 |  1,121 |  895 |  226 |
| `prover.rap_constraints_time_ms` |  968 |  1,936 |  1,477 |  459 |
| `prover.openings_time_ms` |  138 |  276 |  198 |  78 |
| `prover.rap_constraints.logup_gkr_time_ms` |  151 |  302 |  215 |  87 |
| `prover.rap_constraints.round0_time_ms` |  596.50 |  1,193 |  927 |  266 |
| `prover.rap_constraints.mle_rounds_time_ms` |  220 |  440 |  335 |  105 |
| `prover.openings.stacked_reduction_time_ms` |  101 |  202 |  156 |  46 |
...
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  833 |  833 |  833 |  833 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/2ce0fa4690e620ba7617bb2338c1271104821a06/kitchen_sink-2ce0fa4690e620ba7617bb2338c1271104821a06.memory.svg)
...
| app_proof |  |  |  |  |  | 1,674 |  |  | 24 | 1,979,971 | 81.53 | 0 | 6,055 |  | 
...
| leaf | 0 | 116 | 950 | 116 | 24 | 10 | 18 | 2 | 2 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,577,979 | 258 | 118 | 0 | 0 | 107 | 35 | 34 | 51 | 20 | 0 | 32 | 18 | 13 | 3 | 9 | 118 | 107 | 0 | 2 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,767 | 144 | 47 | 0 | 0 | 69 | 26 | 25 | 28 | 14 | 0 | 27 | 19 | 8 | 1 | 6 | 47 | 69 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 122 | 31 | 0 | 0 | 62 | 24 | 24 | 24 | 13 | 0 | 28 | 20 | 7 | 1 | 5 | 31 | 62 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 263,562,356 | 833 | 402 | 0 | 1 | 353 | 137 | 137 | 77 | 138 | 0 | 77 | 37 | 40 | 21 | 18 | 402 | 353 | 0 | 6 | 138 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 904,454,160 | 2,572 | 895 | 0 | 245 | 1,477 | 927 | 925 | 335 | 215 | 60 | 198 | 42 | 156 | 87 | 69 | 895 | 1,477 | 0 | 3 | 153 | 0 | 0 | 
| app_proof | prover | 1 | 280,712,044 | 764 | 226 | 0 | 1 | 459 | 266 | 265 | 105 | 87 | 0 | 78 | 31 | 46 | 25 | 20 | 226 | 459 | 0 | 3 | 86 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 2 | 547 | 4,352 | 547 | 1,166 | 0 | 4 | 66 | 1,445,000 | 28.80 | 
| app_proof | 1 | 1 | 502 | 1,674 | 502 | 325 | 0 | 2 | 82 | 534,971 | 30.26 | 

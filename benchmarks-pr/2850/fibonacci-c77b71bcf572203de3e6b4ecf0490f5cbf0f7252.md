...
|:---|---:|---:|---:|
| Total |  6.19 |  2.94 |  2.94 |
| app_proof |  5.25 |  1.100 |  1.100 |
| leaf |  0.43 |  0.43 |  0.43 |
...
| `total_proof_time_ms ` |  1,308.75 |  5,235 |  1,979 |  957 |
| `compile_metered_time_ms` |  3 |  3 |  3 |  3 |
| `execute_metered_time_ms` |  20 | -          | -          | -          |
| `execute_metered_insns` |  4,000,051 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  196.15 | -          |  196.15 |  196.15 |
| `execute_preflight_insns` |  1,000,012.75 |  4,000,051 |  1,310,000 |  70,051 |
| `execute_preflight_time_ms` |  38 |  152 |  52 |  4 |
| `execute_preflight_insn_mi/s` |  37.08 | -          |  37.19 |  36.78 |
| `trace_gen_time_ms   ` |  527 |  2,108 |  556 |  516 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  210.25 |  841 |  259 |  70 |
| `prover.main_trace_commit_time_ms` |  41.25 |  165 |  50 |  15 |
| `prover.rap_constraints_time_ms` |  139.75 |  559 |  178 |  34 |
| `prover.openings_time_ms` |  28.50 |  114 |  32 |  20 |
| `prover.rap_constraints.logup_gkr_time_ms` |  96.75 |  387 |  124 |  17 |
| `prover.rap_constraints.round0_time_ms` |  28.50 |  114 |  38 |  9 |
...
| `prover.openings.whir_time_ms` |  19 |  76 |  21 |  16 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/c77b71bcf572203de3e6b4ecf0490f5cbf0f7252/fibonacci-c77b71bcf572203de3e6b4ecf0490f5cbf0f7252.memory.svg)

| Module | Max (GB) | Max At |
| --- | ---: | --- |
| generate mem proving ctxs | 6.33 | app_proof.0 |
| set initial memory | 6.33 | app_proof.1 |
...
| app_proof |  |  |  |  |  | 957 |  |  | 20 | 4,000,051 | 196.15 | 0 | 5,262 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 27,289,403 | 208 | 80 | 0 | 0 | 96 | 31 | 30 | 45 | 19 | 0 | 30 | 19 | 11 | 2 | 8 | 81 | 96 | 0 | 2 | 18 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,767 | 141 | 45 | 0 | 0 | 67 | 25 | 24 | 27 | 13 | 0 | 28 | 19 | 8 | 1 | 6 | 45 | 67 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 119 | 31 | 0 | 0 | 61 | 23 | 23 | 24 | 13 | 0 | 25 | 18 | 7 | 1 | 5 | 31 | 61 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 102,779,942 | 376 | 168 | 0 | 0 | 159 | 70 | 69 | 45 | 42 | 0 | 47 | 29 | 18 | 8 | 9 | 169 | 159 | 0 | 5 | 41 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 62,648,868 | 259 | 49 | 0 | 0 | 178 | 38 | 38 | 16 | 123 | 0 | 31 | 19 | 11 | 5 | 5 | 50 | 178 | 0 | 3 | 122 | 0 | 0 | 
| app_proof | prover | 1 | 62,604,988 | 255 | 50 | 0 | 0 | 173 | 33 | 33 | 15 | 124 | 0 | 31 | 20 | 10 | 5 | 5 | 50 | 173 | 0 | 3 | 123 | 0 | 0 | 
| app_proof | prover | 2 | 62,604,988 | 257 | 49 | 0 | 0 | 174 | 34 | 34 | 15 | 123 | 0 | 32 | 21 | 10 | 5 | 5 | 50 | 174 | 0 | 3 | 121 | 0 | 0 | 
| app_proof | prover | 3 | 9,072,114 | 70 | 15 | 0 | 0 | 34 | 9 | 9 | 7 | 17 | 0 | 20 | 16 | 3 | 0 | 2 | 15 | 34 | 0 | 2 | 16 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 2 | 516 | 1,979 | 516 | 1,150 | 0 | 4 | 52 | 1,310,000 | 37.18 | 
| app_proof | 1 | 1 | 518 | 1,149 | 518 | 326 | 0 | 2 | 48 | 1,310,000 | 37.17 | 
| app_proof | 2 | 1 | 518 | 1,150 | 518 | 325 | 0 | 2 | 48 | 1,310,000 | 37.19 | 
| app_proof | 3 | 1 | 556 | 957 | 556 | 325 | 0 | 2 | 4 | 70,051 | 36.78 | 

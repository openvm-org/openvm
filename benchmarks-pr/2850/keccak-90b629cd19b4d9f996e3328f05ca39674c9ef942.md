...
|:---|---:|---:|---:|
| Total |  21.89 |  6.47 |  6.47 |
| app_proof |  18.73 |  4.07 |  4.07 |
| leaf |  2.36 |  1.60 |  1.60 |
...
| `total_proof_time_ms ` |  3,097.50 |  18,585 |  3,928 |  2,862 |
...
| `execute_preflight_time_ms` |  244.83 |  1,469 |  330 |  94 |
| `execute_preflight_insn_mi/s` |  31.01 | -          |  31.63 |  28.54 |
| `trace_gen_time_ms   ` |  348.50 |  2,091 |  501 |  261 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  2,036.67 |  12,220 |  2,162 |  1,943 |
| `prover.main_trace_commit_time_ms` |  692.50 |  4,155 |  795 |  665 |
| `prover.rap_constraints_time_ms` |  1,166.67 |  7,000 |  1,188 |  1,091 |
| `prover.openings_time_ms` |  176.50 |  1,059 |  180 |  173 |
| `prover.rap_constraints.logup_gkr_time_ms` |  323.67 |  1,942 |  331 |  321 |
| `prover.rap_constraints.round0_time_ms` |  583.50 |  3,501 |  601 |  511 |
| `prover.rap_constraints.mle_rounds_time_ms` |  258.17 |  1,549 |  260 |  257 |
| `prover.openings.stacked_reduction_time_ms` |  132.67 |  796 |  134 |  128 |
| `prover.openings.stacked_reduction.round0_time_ms` |  80.17 |  481 |  82 |  76 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,180.50 |  2,361 |  1,598 |  763 |
| `execute_preflight_time_ms` |  5.50 |  11 |  6 |  5 |
| `trace_gen_time_ms   ` |  131.50 |  263 |  175 |  88 |
| `generate_blob_total_time_ms` |  21 |  42 |  28 |  14 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,048.50 |  2,097 |  1,422 |  675 |
| `prover.main_trace_commit_time_ms` |  636.50 |  1,273 |  900 |  373 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/90b629cd19b4d9f996e3328f05ca39674c9ef942/keccak-90b629cd19b4d9f996e3328f05ca39674c9ef942.memory.svg)
...
| app_proof |  |  |  |  |  | 2,862 |  |  | 145 | 14,365,133 | 98.79 | 0 | 18,739 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 38 | 497 | 37 | 13 | 4 | 2 | 2 | 2 | 
| internal_recursive.0 | 1 | 14 | 165 | 14 | 2 | 1 | 2 | 2 | 2 | 
| internal_recursive.1 | 1 | 9 | 134 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 175 | 1,598 | 175 | 60 | 28 | 6 | 7 | 7 | 
| leaf | 1 | 88 | 763 | 87 | 30 | 14 | 5 | 7 | 7 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 81,415,156 | 459 | 243 | 0 | 1 | 171 | 48 | 48 | 92 | 30 | 0 | 43 | 20 | 23 | 7 | 15 | 243 | 171 | 0 | 3 | 29 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,943 | 150 | 49 | 0 | 0 | 72 | 25 | 25 | 29 | 17 | 0 | 28 | 19 | 8 | 2 | 6 | 49 | 72 | 0 | 2 | 17 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 124 | 31 | 0 | 0 | 62 | 23 | 23 | 24 | 13 | 0 | 30 | 23 | 7 | 1 | 5 | 31 | 62 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 476
...
| `total_proof_time_ms ` |  5,596 |  5,596 |  5,596 |  5,596 |
| `compile_metered_time_ms` |  3 |  3 |  3 |  3 |
| `execute_metered_time_ms` |  25 | -          | -          | -          |
| `execute_metered_insns` |  1,979,971 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  77.08 | -          |  77.08 |  77.08 |
| `execute_preflight_insns` |  1,979,971 |  1,979,971 |  1,979,971 |  1,979,971 |
| `execute_preflight_time_ms` |  86 |  86 |  86 |  86 |
| `execute_preflight_insn_mi/s` |  30.15 | -          |  30.15 |  30.15 |
| `trace_gen_time_ms   ` |  544 |  544 |  544 |  544 |
| `set_initial_memory_time_ms` |  1,147 |  1,147 |  1,147 |  1,147 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  3,817 |  3,817 |  3,817 |  3,817 |
| `prover.main_trace_commit_time_ms` |  1,137 |  1,137 |  1,137 |  1,137 |
| `prover.rap_constraints_time_ms` |  1,690 |  1,690 |  1,690 |  1,690 |
| `prover.openings_time_ms` |  989 |  989 |  989 |  989 |
| `prover.rap_constraints.logup_gkr_time_ms` |  283 |  283 |  283 |  283 |
| `prover.rap_constraints.round0_time_ms` |  1,023 |  1,023 |  1,023 |  1,023 |
| `prover.rap_constraints.mle_rounds_time_ms` |  382 |  382 |  382 |  382 |
...
| `prover.openings.whir_time_ms` |  802 |  802 |  802 |  802 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  865 |  865 |  865 |  865 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/72ab75b770fd85360d3a0f82c274dbd88ccc1ee0/kitchen_sink-72ab75b770fd85360d3a0f82c274dbd88ccc1ee0.memory.svg)
...
| prover.gkr_input_evals | 7.28 | app_proof.prover.0 |
| frac_sumcheck.segment_tree | 7.28 | app_proof.prover.0 |
...
| 66 | VmAirWrapper<Rv64JalrAdapterAir, Rv64JalrCoreAir> |  | 15 | 9 | 3 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 70 |  |  |  | 363 |  |  |  |  |  |  | 
| app_proof |  |  |  | 5,596 |  | 25 | 1,979,971 | 77.08 | 0 | 5,626 |  | 
...
| app_proof | VmAirWrapper<Rv64LoadStoreAdapterAir, LoadStoreCoreAir<8> | 16 | VmAirWrapper<Rv64LoadStoreAdapterAir, LoadStoreCoreAir<8> | 0 | 51,673,608 | 
...
| app_proof | 82 | Poseidon2PeripheryAir<BabyBearParameters>, 1> | 0 | 11,248 | 5,136 | 8,436,000 | 3,852,000 | 13,497,600 | 6,163,200 | 3,374,400 | 1,540,800 | 407,740 | 186,180 | 11,248 | 5,136 | 
...
| leaf | 0 | 101 | 865 | 101 | 18 | 9 | 19 | 13 | 13 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,577,981 | 323 | 118 | 0 | 0 | 107 | 35 | 34 | 51 | 20 | 0 | 97 | 83 | 13 | 3 | 9 | 118 | 118 | 107 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 168 | 47 | 0 | 0 | 67 | 24 | 24 | 28 | 14 | 0 | 53 | 45 | 8 | 1 | 6 | 47 | 47 | 67 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 139 | 33 | 0 | 0 | 62 | 24 | 23 | 24 | 13 | 0 | 42 | 35 | 7 | 1 | 5 | 33 | 33 | 62 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 167,484,093 | 764 | 255 | 0 | 0 | 297 | 106 | 105 | 58 | 131 | 0 | 210 | 182 | 27 | 14 | 13 | 256 | 255 | 297 | 0 | 8 | 131 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,092,195,600 | 3,817 | 1,136 | 0 | 99 | 1,690 | 1,023 | 1,022 | 382 | 283 | 1 | 989 | 802 | 186 | 106 | 80 | 1,137 | 1,136 | 1,690 | 0 | 5 | 281 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 1,147 | 2 | 544 | 5,596 | 544 | 1,147 | 10,298,796,804 | 2,851,787,196 | 13,150,584,000 | 2,097,152 | 0 | 4 | 86 | 1,979,971 | 30.15 | 

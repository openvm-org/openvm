...
|:---|---:|---:|---:|
| Total |  4.58 |  3.23 |  3.23 |
| app_proof |  3.70 |  2.35 |  2.35 |
| leaf |  0.36 |  0.36 |  0.36 |
...
| `total_proof_time_ms ` |  1,834 |  3,668 |  2,321 |  1,347 |
| `compile_metered_time_ms` |  8 |  8 |  8 |  8 |
| `execute_metered_time_ms` |  33 | -          | -          | -          |
| `execute_metered_insns` |  4,090,656 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  120.30 | -          |  120.30 |  120.30 |
| `execute_preflight_insns` |  2,045,328 |  4,090,656 |  2,327,000 |  1,763,656 |
| `execute_preflight_time_ms` |  89.50 |  179 |  100 |  79 |
| `execute_preflight_insn_mi/s` |  31.26 | -          |  32.56 |  29.97 |
| `trace_gen_time_ms   ` |  498.50 |  997 |  507 |  490 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  494 |  988 |  554 |  434 |
| `prover.main_trace_commit_time_ms` |  116 |  232 |  130 |  102 |
| `prover.rap_constraints_time_ms` |  333 |  666 |  375 |  291 |
| `prover.openings_time_ms` |  43.50 |  87 |  47 |  40 |
| `prover.rap_constraints.logup_gkr_time_ms` |  201 |  402 |  247 |  155 |
| `prover.rap_constraints.round0_time_ms` |  97 |  194 |  105 |  89 |
| `prover.rap_constraints.mle_rounds_time_ms` |  34.50 |  69 |  38 |  31 |
| `prover.openings.stacked_reduction_time_ms` |  22.50 |  45 |  25 |  20 |
| `prover.openings.stacked_reduction.round0_time_ms` |  12 |  24 |  14 |  10 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/acb1ddf9dcd0c3a0baa17ffa57dbf73b46f8ecd3/regex-acb1ddf9dcd0c3a0baa17ffa57dbf73b46f8ecd3.memory.svg)

| Module | Max (GB) | Max At |
| --- | ---: | --- |
| generate mem proving ctxs | 6.36 | app_proof.0 |
| set initial memory | 6.35 | app_proof.1 |
| frac_sumcheck.gkr_rounds | 4.91 | app_proof.prover.0 |
| prover.batch_constraints.before_round0 | 4.91 | app_proof.prover.0 |
| prover.gkr_input_evals | 4.78 | app_proof.prover.0 |
| frac_sumcheck.segment_tree | 4.78 | app_proof.prover.0 |
| prover.rap_constraints | 2.85 | app_proof.prover.0 |
| prover.batch_constraints.fold_ple_evals | 2.85 | app_proof.prover.0 |
| prover.batch_constraints.round0 | 2.85 | app_proof.prover.0 |
| prover.openings | 2.59 | app_proof.prover.0 |
| prover.merkle_tree | 2.59 | app_proof.prover.0 |
| prover.prove_whir_opening | 2.59 | app_proof.prover.0 |
| prover.before_gkr_input_evals | 2.19 | app_proof.prover.0 |
| prover.stacked_commit | 2.19 | app_proof.prover.0 |
| prover.rs_code_matrix | 2.18 | app_proof.prover.0 |
...
| app_proof |  |  |  |  |  | 1,347 |  |  | 33 | 4,090,656 | 120.30 | 0 | 3,717 |  | 
| internal_for_leaf |  |  |  | 234 |  |  |  |  |  |  |  |  |  | 234 | 
...
| app_proof | 19 | VmAirWrapper<Rv64LoadStoreAdapterAir, LoadSignExtendCoreAir<8, 8> | prover | 0 | 65,536 | 47 | 3,080,192 | 
...
| app_proof | 10 | KeccakfOpAir | prover | 1 | 1 | 310 | 310 | 
| app_proof | 11 | KeccakfPermAir | prover | 1 | 32 | 2,634 | 84,288 | 
| app_proof | 12 | XorinVmAir | prover | 1 | 1 | 720 | 720 | 
...
| app_proof | 19 | VmAirWrapper<Rv64LoadStoreAdapterAir, LoadSignExtendCoreAir<8, 8> | prover | 1 | 65,536 | 47 | 3,080,192 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 15 | 234 | 15 | 4 | 0 | 2 | 1 | 1 | 
| internal_recursive.0 | 1 | 10 | 149 | 10 | 1 | 0 | 2 | 0 | 0 | 
| internal_recursive.1 | 1 | 9 | 132 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 49 | 359 | 49 | 13 | 3 | 5 | 1 | 1 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 27,289,403 | 218 | 82 | 0 | 0 | 99 | 33 | 32 | 46 | 19 | 0 | 37 | 25 | 11 | 2 | 8 | 82 | 99 | 0 | 2 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,767 | 138 | 45 | 0 | 0 | 67 | 25 | 25 | 27 | 14 | 0 | 24 | 16 | 8 | 1 | 6 | 46 | 67 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 122 | 31 | 0 | 0 | 62 | 24 | 23 | 24 | 13 | 0 | 28 | 21 | 7 | 1 | 5 | 31 | 62 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 79,959,860 | 309 | 128 | 0 | 0 | 136 | 55 | 54 | 37 | 43 | 0 | 43 | 28 | 15 | 6 | 8 | 128 | 136 | 0 | 5 | 42 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 163,039,698 | 554 | 130 | 0 | 0 | 375 | 89 | 88 | 38 | 247 | 0 | 47 | 22 | 25 | 14 | 11 | 130 | 375 | 0 | 3 | 246 | 0 | 0 | 
| app_proof | prover | 1 | 124,372,364 | 434 | 102 | 0 | 8 | 291 | 105 | 104 | 31 | 155 | 0 | 40 | 19 | 20 | 10 | 10 | 102 | 291 | 0 | 3 | 154 | 0 | 0 | 

| group | phase | segment | trace_height_constraint | weighted_sum | threshold |
| --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 0 | 82,510,029 | 2,013,265,921 | 
| app_proof | prover | 1 | 0 | 62,096,006 | 2,013,265,921 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 2 | 490 | 2,321 | 490 | 1,176 | 1 | 7 | 100 | 2,327,000 | 29.97 | 
| app_proof | 1 | 1 | 507 | 1,347 | 507 | 325 | 0 | 2 | 79 | 1,763,656 | 32.56 | 

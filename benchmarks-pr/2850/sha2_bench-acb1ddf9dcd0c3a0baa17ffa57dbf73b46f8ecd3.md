...
|:---|---:|---:|---:|
| Total |  14.72 |  6.08 |  6.08 |
| app_proof |  12.63 |  3.99 |  3.99 |
| leaf |  1.42 |  1.42 |  1.42 |
...
| `total_proof_time_ms ` |  3,132.75 |  12,531 |  3,897 |  2,832 |
| `compile_metered_time_ms` |  4 |  4 |  4 |  4 |
| `execute_metered_time_ms` |  98 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  113.25 | -          |  113.25 |  113.25 |
| `execute_preflight_insns` |  2,791,990.25 |  11,167,961 |  2,851,000 |  2,614,961 |
| `execute_preflight_time_ms` |  167 |  668 |  209 |  104 |
| `execute_preflight_insn_mi/s` |  33.37 | -          |  34.24 |  30.99 |
| `trace_gen_time_ms   ` |  451.25 |  1,805 |  516 |  409 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,979.75 |  7,919 |  2,119 |  1,888 |
| `prover.main_trace_commit_time_ms` |  547.50 |  2,190 |  634 |  517 |
| `prover.rap_constraints_time_ms` |  1,293 |  5,172 |  1,349 |  1,228 |
| `prover.openings_time_ms` |  137.75 |  551 |  140 |  136 |
| `prover.rap_constraints.logup_gkr_time_ms` |  374.75 |  1,499 |  433 |  320 |
| `prover.rap_constraints.round0_time_ms` |  669.50 |  2,678 |  682 |  663 |
| `prover.rap_constraints.mle_rounds_time_ms` |  248 |  992 |  252 |  240 |
| `prover.openings.stacked_reduction_time_ms` |  99.50 |  398 |  101 |  98 |
| `prover.openings.stacked_reduction.round0_time_ms` |  60.25 |  241 |  62 |  59 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  38.75 |  155 |  39 |  38 |
| `prover.openings.whir_time_ms` |  37.75 |  151 |  39 |  37 |
...
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,274 |  1,274 |  1,274 |  1,274 |
| `prover.main_trace_commit_time_ms` |  810 |  810 |  810 |  810 |
...
| `prover.rap_constraints.round0_time_ms` |  170 |  170 |  170 |  170 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/acb1ddf9dcd0c3a0baa17ffa57dbf73b46f8ecd3/sha2_bench-acb1ddf9dcd0c3a0baa17ffa57dbf73b46f8ecd3.memory.svg)
...
| app_proof |  |  |  |  |  | 2,832 |  |  | 98 | 11,167,961 | 113.25 | 0 | 12,636 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 24 | 380 | 24 | 7 | 2 | 2 | 3 | 3 | 
| internal_recursive.0 | 1 | 12 | 163 | 12 | 1 | 0 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 9 | 127 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 145 | 1,420 | 145 | 50 | 22 | 3 | 6 | 6 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 61,220,667 | 355 | 184 | 0 | 0 | 132 | 38 | 38 | 65 | 28 | 0 | 37 | 19 | 18 | 5 | 13 | 184 | 132 | 0 | 3 | 26 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,943 | 150 | 48 | 0 | 0 | 74 | 27 | 26 | 29 | 18 | 0 | 27 | 18 | 8 | 1 | 6 | 48 | 74 | 0 | 2 | 17 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 117 | 32 | 0 | 0 | 60 | 22 | 22 | 24 | 13 | 0 | 24 | 17 | 7 | 1 | 5 | 32 | 60 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 425,192,422 | 1,274 | 810 | 0 | 161 | 351 | 170 | 169 | 105 | 75 | 0 | 112 | 47 | 64 | 35 | 28 | 810 | 351 | 0 | 7 | 74 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 642,417,917 | 2,119 | 634 | 0 | 128 | 1,343 | 667 | 666 | 251 | 425 | 117 | 140 | 39 | 101 | 61 | 39 | 634 | 1,343 | 0 | 4 | 307 | 0 | 0 | 
| app_proof | prover | 1 | 642,417,676 | 2,003 | 516 | 0 | 2 | 1,349 | 663 | 663 | 252 | 433 | 135 | 136 | 37 | 98 | 59 | 38 | 517 | 1,349 | 0 | 3 | 297 | 0 | 0 | 
| app_proof | prover | 2 | 642,417,676 | 1,909 | 519 | 0 | 2 | 1,252 | 682 | 681 | 249 | 321 | 0 | 136 | 38 | 98 | 59 | 39 | 519 | 1,252 | 0 | 3 | 320 | 0 | 0 | 
| app_proof | prover | 3 | 642,494,708 | 1,888 | 520 | 0 | 2 | 1,228 | 666 | 666 | 240 | 320 | 0 | 139 | 37 | 101 | 62 | 39 | 520 | 1,228 | 0 | 4 | 319 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 2 | 516 | 3,897 | 516 | 1,156 | 0 | 4 | 104 | 2,851,000 | 30.99 | 
| app_proof | 1 | 1 | 409 | 2,948 | 409 | 326 | 0 | 2 | 209 | 2,851,000 | 34.04 | 
| app_proof | 2 | 1 | 436 | 2,854 | 436 | 326 | 0 | 2 | 182 | 2,851,000 | 34.24 | 
| app_proof | 3 | 1 | 444 | 2,832 | 444 | 325 | 0 | 2 | 173 | 2,614,961 | 34.19 | 

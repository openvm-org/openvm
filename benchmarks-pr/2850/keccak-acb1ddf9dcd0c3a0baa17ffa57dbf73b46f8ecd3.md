...
|:---|---:|---:|---:|
| Total |  21.88 |  6.46 |  6.46 |
| app_proof |  18.72 |  4.07 |  4.07 |
| leaf |  2.36 |  1.60 |  1.60 |
...
| `total_proof_time_ms ` |  3,095.50 |  18,573 |  3,924 |  2,859 |
...
| `execute_preflight_time_ms` |  247.17 |  1,483 |  327 |  92 |
| `execute_preflight_insn_mi/s` |  31.02 | -          |  32.34 |  27.94 |
| `trace_gen_time_ms   ` |  348 |  2,088 |  503 |  267 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  2,034.67 |  12,208 |  2,168 |  1,938 |
| `prover.main_trace_commit_time_ms` |  690 |  4,140 |  797 |  665 |
| `prover.rap_constraints_time_ms` |  1,166.67 |  7,000 |  1,193 |  1,090 |
| `prover.openings_time_ms` |  177.17 |  1,063 |  181 |  174 |
| `prover.rap_constraints.logup_gkr_time_ms` |  323.33 |  1,940 |  329 |  321 |
| `prover.rap_constraints.round0_time_ms` |  583 |  3,498 |  602 |  512 |
| `prover.rap_constraints.mle_rounds_time_ms` |  258.83 |  1,553 |  261 |  256 |
| `prover.openings.stacked_reduction_time_ms` |  133.67 |  802 |  135 |  132 |
...
| `prover.openings.whir_time_ms` |  43 |  258 |  45 |  40 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,182 |  2,364 |  1,600 |  764 |
| `execute_preflight_time_ms` |  5 |  10 |  5 |  5 |
| `trace_gen_time_ms   ` |  130.50 |  261 |  173 |  88 |
| `generate_blob_total_time_ms` |  21 |  42 |  28 |  14 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,051 |  2,102 |  1,426 |  676 |
| `prover.main_trace_commit_time_ms` |  637.50 |  1,275 |  901 |  374 |
| `prover.rap_constraints_time_ms` |  319 |  638 |  409 |  229 |
| `prover.openings_time_ms` |  93 |  186 |  115 |  71 |
...
| `prover.openings.whir_time_ms` |  39 |  78 |  44 |  34 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/acb1ddf9dcd0c3a0baa17ffa57dbf73b46f8ecd3/keccak-acb1ddf9dcd0c3a0baa17ffa57dbf73b46f8ecd3.memory.svg)

| Module | Max (GB) | Max At |
| --- | ---: | --- |
| prover.rap_constraints | 13.50 | app_proof.prover.0 |
| prover.openings | 12.90 | app_proof.prover.0 |
| prover.prove_whir_opening | 12.90 | app_proof.prover.0 |
| prover.merkle_tree | 12.90 | app_proof.prover.0 |
| frac_sumcheck.gkr_rounds | 12.49 | app_proof.prover.0 |
| prover.batch_constraints.before_round0 | 12.49 | app_proof.prover.0 |
| prover.batch_constraints.round0 | 12.40 | app_proof.prover.0 |
| prover.batch_constraints.fold_ple_evals | 12.40 | app_proof.prover.0 |
| frac_sumcheck.segment_tree | 12.36 | app_proof.prover.0 |
| prover.gkr_input_evals | 12.36 | app_proof.prover.0 |
| prover.before_gkr_input_evals | 9.79 | app_proof.prover.0 |
| prover.stacked_commit | 9.79 | app_proof.prover.0 |
| prover.rs_code_matrix | 9.77 | app_proof.prover.0 |
| generate mem proving ctxs | 6.34 | app_proof.0 |
| set initial memory | 6.34 | app_proof.1 |
| tracegen.exp_bits_len | 2.29 | leaf.0 |
| tracegen.pow_checker | 2.29 | leaf.0 |
| tracegen.whir_final_poly_query_eval | 2.29 | leaf.0 |
| tracegen.whir_folding | 2.03 | leaf.0 |
| tracegen.whir_non_initial_opened_values | 2.03 | leaf.0 |
...
| app_proof |  |  |  |  |  | 2,859 |  |  | 143 | 14,365,133 | 100.26 | 0 | 18,724 |  | 
...
| app_proof | VmAirWrapper<Rv64LoadStoreAdapterAir, LoadStoreCoreAir<8> | 3 | 6 | 
...
| app_proof | VmAirWrapper<Rv64LoadStoreAdapterAir, LoadStoreCoreAir<8> | 4 | 6 | 
...
| agg_keygen | 19 | ProofShapeAir<4, 8> | 78 | 88 | 4 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 38 | 498 | 38 | 13 | 4 | 2 | 2 | 2 | 
| internal_recursive.0 | 1 | 13 | 167 | 13 | 2 | 1 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 9 | 131 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 173 | 1,600 | 173 | 59 | 28 | 5 | 7 | 7 | 
| leaf | 1 | 88 | 764 | 88 | 30 | 14 | 5 | 7 | 7 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 81,415,156 | 459 | 243 | 0 | 1 | 172 | 48 | 48 | 92 | 30 | 0 | 44 | 20 | 23 | 7 | 16 | 243 | 171 | 0 | 3 | 29 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,943 | 153 | 49 | 0 | 0 | 72 | 25 | 24 | 29 | 17 | 0 | 30 | 21 | 8 | 2 | 6 | 49 | 72 | 0 | 2 | 16 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 122 | 31 | 0 | 0 | 62 | 23 | 22 | 25 | 14 | 0 | 27 | 20 | 7 | 1 | 5 | 31 | 62 | 0 | 2 | 13 | 0 | 0 | 
| leaf | 0 | prover | 476,982,246 | 1,426 | 901 | 0 | 180 | 409 | 204 | 203 | 118 | 86 | 0 | 115 | 44 | 71 | 40 | 30 | 901 | 409 | 0 | 7 | 86 | 0 | 0 | 
| leaf | 1 | prover | 240,457,524 | 676 | 374 | 0 | 1 | 229 | 110 | 109 | 67 | 51 | 0 | 71 | 34 | 37 | 19 | 17 | 374 | 229 | 0 | 6 | 50 | 0 | 0 | 
...
| leaf | 0 | prover | 0 | 28,224,965 | 2,013,265,921 | 
| leaf | 1 | prover | 0 | 15,816,579 | 2,013,265,921 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 842,823,436 | 2,168 | 797 | 0 | 139 | 1,193 | 602 | 602 | 261 | 329 | 86 | 177 | 44 | 132 | 80 | 51 | 797 | 1,193 | 0 | 3 | 242 | 0 | 0 | 
| app_proof | prover | 1 | 842,823,436 | 2,024 | 665 | 0 | 3 | 1,184 | 598 | 598 | 259 | 325 | 93 | 174 | 40 | 133 | 80 | 52 | 665 | 1,184 | 0 | 4 | 231 | 0 | 0 | 
| app_proof | prover | 2 | 842,823,436 | 2,022 | 669 | 0 | 3 | 1,176 | 594 | 594 | 258 | 322 | 91 | 177 | 42 | 135 | 82 | 53 | 669 | 1,175 | 0 | 4 | 230 | 0 | 0 | 
| app_proof | prover | 3 | 842,823,436 | 2,022 | 670 | 0 | 3 | 1,175 | 594 | 593 | 259 | 321 | 90 | 176 | 44 | 132 | 80 | 51 | 670 | 1,175 | 0 | 4 | 230 | 0 | 0 | 
| app_proof | prover | 4 | 842,823,436 | 2,034 | 670 | 0 | 3 | 1,182 | 598 | 598 | 260 | 322 | 91 | 181 | 45 | 135 | 82 | 52 | 670 | 1,182 | 0 | 4 | 231 | 0 | 0 | 
| app_proof | prover | 5 | 842,823,436 | 1,938 | 669 | 0 | 3 | 1,090 | 512 | 511 | 256 | 321 | 90 | 178 | 43 | 135 | 82 | 52 | 669 | 1,090 | 0 | 4 | 230 | 0 | 0 | 

| group | phase | segment | trace_height_constraint | weighted_sum | threshold |
| --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 0 | 82,286,602 | 2,013,265,921 | 
| app_proof | prover | 1 | 0 | 82,286,602 | 2,013,265,921 | 
| app_proof | prover | 2 | 0 | 82,286,602 | 2,013,265,921 | 
| app_proof | prover | 3 | 0 | 82,286,602 | 2,013,265,921 | 
| app_proof | prover | 4 | 0 | 82,286,602 | 2,013,265,921 | 
| app_proof | prover | 5 | 0 | 82,286,602 | 2,013,265,921 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 2 | 503 | 3,924 | 503 | 1,159 | 0 | 4 | 92 | 2,413,000 | 29.11 | 
| app_proof | 1 | 1 | 267 | 2,945 | 267 | 325 | 0 | 2 | 327 | 2,413,000 | 32.22 | 
| app_proof | 2 | 1 | 326 | 2,945 | 326 | 326 | 0 | 2 | 270 | 2,413,000 | 32.34 | 
| app_proof | 3 | 1 | 323 | 2,944 | 323 | 325 | 0 | 2 | 272 | 2,413,000 | 32.32 | 
| app_proof | 4 | 1 | 311 | 2,956 | 311 | 326 | 0 | 2 | 285 | 2,413,000 | 27.94 | 
| app_proof | 5 | 1 | 358 | 2,859 | 358 | 325 | 0 | 2 | 237 | 2,300,133 | 32.19 | 

...
|:---|---:|---:|---:|
| Total |  4.88 |  3.47 |  3.47 |
| app_proof |  3.84 |  2.43 |  2.43 |
| leaf |  0.43 |  0.43 |  0.43 |
...
| `total_proof_time_ms ` |  1,903 |  3,806 |  2,397 |  1,409 |
...
| `execute_preflight_insn_mi/s` |  32.36 | -          |  33.32 |  31.39 |
| `trace_gen_time_ms   ` |  500.50 |  1,001 |  506 |  495 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  566.50 |  1,133 |  635 |  498 |
| `prover.main_trace_commit_time_ms` |  116 |  232 |  130 |  102 |
| `prover.rap_constraints_time_ms` |  333.50 |  667 |  373 |  294 |
| `prover.openings_time_ms` |  115 |  230 |  130 |  100 |
| `prover.rap_constraints.logup_gkr_time_ms` |  202 |  404 |  247 |  157 |
| `prover.rap_constraints.round0_time_ms` |  96.50 |  193 |  106 |  87 |
...
| `prover.openings.whir_time_ms` |  92.50 |  185 |  105 |  80 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/e5f8e9c036de5d533631242be98751119cd0f8c1/regex-e5f8e9c036de5d533631242be98751119cd0f8c1.memory.svg)
...
| app_proof |  |  |  |  |  | 1,409 |  |  | 34 | 4,090,656 | 117.13 | 0 | 3,856 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 27,289,403 | 262 | 82 | 0 | 0 | 97 | 31 | 31 | 45 | 19 | 0 | 80 | 69 | 11 | 2 | 8 | 83 | 97 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,767 | 170 | 47 | 0 | 0 | 67 | 25 | 24 | 28 | 13 | 0 | 55 | 47 | 8 | 1 | 6 | 47 | 67 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 141 | 31 | 0 | 0 | 63 | 25 | 24 | 24 | 13 | 0 | 45 | 38 | 7 | 1 | 5 | 32 | 63 | 0 | 3 | 12 | 0 | 0 | 
| leaf | 0 | prover | 79,959,860 | 381 | 128 | 0 | 0 | 136 | 56 | 55 | 37 | 42 | 0 | 115 | 100 | 15 | 6 | 8 | 128 | 136 | 0 | 7 | 42 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 163,039,698 | 635 | 130 | 0 | 0 | 373 | 87 | 87 | 38 | 247 | 0 | 130 | 105 | 25 | 13 | 11 | 130 | 373 | 0 | 4 | 246 | 0 | 0 | 
| app_proof | prover | 1 | 124,372,364 | 498 | 102 | 0 | 0 | 294 | 106 | 106 | 31 | 157 | 0 | 100 | 80 | 20 | 9 | 10 | 102 | 294 | 0 | 3 | 156 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 2 | 495 | 2,397 | 494 | 1,169 | 2,919,537,094 | 1,047,419,530 | 3,966,956,624 | 2,097,152 | 1 | 7 | 97 | 2,327,000 | 31.39 | 
| app_proof | 1 | 1 | 506 | 1,409 | 506 | 325 | 2,095,905,356 | 675,000,158 | 2,770,905,514 | 2,097,152 | 0 | 2 | 78 | 1,763,656 | 33.32 | 

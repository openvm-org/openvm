...
|:---|---:|---:|---:|
| Total |  6.66 |  3.23 |  3.23 |
| app_proof |  5.51 |  2.07 |  2.07 |
| leaf |  0.54 |  0.54 |  0.54 |
...
| `total_proof_time_ms ` |  1,371.25 |  5,485 |  2,049 |  994 |
| `compile_metered_time_ms` |  3 |  3 |  3 |  3 |
| `execute_metered_time_ms` |  21 | -          | -          | -          |
| `execute_metered_insns` |  4,000,051 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  185.80 | -          |  185.80 |  185.80 |
| `execute_preflight_insns` |  1,000,012.75 |  4,000,051 |  1,310,000 |  70,051 |
| `execute_preflight_time_ms` |  37 |  148 |  51 |  4 |
| `execute_preflight_insn_mi/s` |  39.46 | -          |  39.62 |  39.18 |
| `trace_gen_time_ms   ` |  555.25 |  2,221 |  586 |  540 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  244.25 |  977 |  302 |  77 |
| `prover.main_trace_commit_time_ms` |  43 |  172 |  52 |  16 |
| `prover.rap_constraints_time_ms` |  145.50 |  582 |  185 |  34 |
| `prover.openings_time_ms` |  54.50 |  218 |  66 |  25 |
| `prover.rap_constraints.logup_gkr_time_ms` |  99.75 |  399 |  128 |  17 |
| `prover.rap_constraints.round0_time_ms` |  30.75 |  123 |  42 |  9 |
...
| `prover.openings.whir_time_ms` |  45 |  180 |  55 |  22 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/f338acfa1017ba1a4e491ea7b7e4f01003d47338/fibonacci-f338acfa1017ba1a4e491ea7b7e4f01003d47338.memory.svg)
...
| app_proof |  |  |  |  |  | 994 |  |  | 21 | 4,000,051 | 185.80 | 0 | 5,512 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 27,289,403 | 265 | 84 | 0 | 0 | 100 | 33 | 33 | 46 | 20 | 0 | 80 | 68 | 11 | 2 | 8 | 84 | 100 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,767 | 169 | 47 | 0 | 0 | 68 | 25 | 24 | 28 | 14 | 0 | 53 | 44 | 8 | 1 | 6 | 48 | 68 | 0 | 3 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 142 | 33 | 0 | 0 | 63 | 24 | 23 | 24 | 14 | 0 | 45 | 38 | 7 | 1 | 5 | 33 | 63 | 0 | 3 | 13 | 0 | 0 | 
| leaf | 0 | prover | 102,779,942 | 485 | 174 | 0 | 0 | 167 | 75 | 74 | 48 | 43 | 0 | 143 | 124 | 18 | 8 | 9 | 174 | 167 | 0 | 7 | 42 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 62,648,868 | 302 | 52 | 0 | 0 | 185 | 42 | 42 | 16 | 126 | 0 | 63 | 51 | 12 | 6 | 6 | 52 | 185 | 0 | 3 | 125 | 0 | 0 | 
| app_proof | prover | 1 | 62,604,988 | 297 | 52 | 0 | 0 | 181 | 36 | 36 | 16 | 128 | 0 | 64 | 52 | 11 | 6 | 5 | 52 | 181 | 0 | 3 | 126 | 0 | 0 | 
| app_proof | prover | 2 | 62,604,988 | 301 | 52 | 0 | 0 | 182 | 36 | 36 | 16 | 128 | 0 | 66 | 55 | 11 | 6 | 5 | 52 | 182 | 0 | 3 | 126 | 0 | 0 | 
| app_proof | prover | 3 | 9,072,114 | 77 | 16 | 0 | 0 | 34 | 9 | 9 | 7 | 17 | 0 | 25 | 22 | 3 | 0 | 2 | 16 | 34 | 0 | 3 | 17 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 2 | 540 | 2,049 | 540 | 1,154 | 1,626,562,846 | 2,063,722 | 1,628,626,568 | 2,097,152 | 0 | 4 | 51 | 1,310,000 | 39.62 | 
| app_proof | 1 | 1 | 547 | 1,219 | 547 | 326 | 1,625,183,252 | 1,196,999 | 1,626,380,251 | 2,097,152 | 0 | 2 | 47 | 1,310,000 | 39.44 | 
| app_proof | 2 | 1 | 548 | 1,223 | 548 | 326 | 1,625,183,252 | 1,196,999 | 1,626,380,251 | 2,097,152 | 0 | 2 | 46 | 1,310,000 | 39.59 | 
| app_proof | 3 | 1 | 586 | 994 | 586 | 325 | 160,301,989 | 14,415,170 | 174,717,159 | 2,097,152 | 0 | 2 | 4 | 70,051 | 39.18 | 

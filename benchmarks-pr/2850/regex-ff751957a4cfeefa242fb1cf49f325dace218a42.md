...
| `total_proof_time_ms ` |  2,607 |  2,607 |  2,607 |  2,607 |
| `compile_metered_time_ms` |  7 |  7 |  7 |  7 |
| `execute_metered_time_ms` |  30 | -          | -          | -          |
| `execute_metered_insns` |  4,090,656 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  136.10 | -          |  136.10 |  136.10 |
| `execute_preflight_insns` |  4,090,656 |  4,090,656 |  4,090,656 |  4,090,656 |
| `execute_preflight_time_ms` |  138 |  138 |  138 |  138 |
| `execute_preflight_insn_mi/s` |  34.77 | -          |  34.77 |  34.77 |
| `trace_gen_time_ms   ` |  457 |  457 |  457 |  457 |
| `set_initial_memory_time_ms` |  1,152 |  1,152 |  1,152 |  1,152 |
| `memory_finalize_time_ms` |  2 |  2 |  2 |  2 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  858 |  858 |  858 |  858 |
| `prover.main_trace_commit_time_ms` |  196 |  196 |  196 |  196 |
| `prover.rap_constraints_time_ms` |  482 |  482 |  482 |  482 |
| `prover.openings_time_ms` |  180 |  180 |  180 |  180 |
| `prover.rap_constraints.logup_gkr_time_ms` |  279 |  279 |  279 |  279 |
| `prover.rap_constraints.round0_time_ms` |  151 |  151 |  151 |  151 |
...
| `prover.openings.whir_time_ms` |  143 |  143 |  143 |  143 |
...
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  313 |  313 |  313 |  313 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/ff751957a4cfeefa242fb1cf49f325dace218a42/regex-ff751957a4cfeefa242fb1cf49f325dace218a42.memory.svg)

| Module | Max (GB) | Max At |
| --- | ---: | --- |
| generate mem proving ctxs | 6.15 | app_proof.0 |
| set initial memory | 6.12 | app_proof.0 |
| frac_sumcheck.gkr_rounds | 4.58 | app_proof.prover.0 |
| prover.batch_constraints.before_round0 | 4.58 | app_proof.prover.0 |
| frac_sumcheck.segment_tree | 4.46 | app_proof.prover.0 |
| prover.gkr_input_evals | 4.46 | app_proof.prover.0 |
| prover.stacked_commit | 2.84 | app_proof.prover.0 |
| prover.rap_constraints | 2.35 | app_proof.prover.0 |
| prover.batch_constraints.fold_ple_evals | 2.35 | app_proof.prover.0 |
| prover.batch_constraints.round0 | 2.35 | app_proof.prover.0 |
| prover.prove_whir_opening | 2.00 | app_proof.prover.0 |
| prover.merkle_tree | 2.00 | app_proof.prover.0 |
| prover.openings | 2.00 | app_proof.prover.0 |
| prover.rs_code_matrix | 2.00 | app_proof.prover.0 |
| prover.before_gkr_input_evals | 1.05 | app_proof.prover.0 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 79 |  |  |  | 357 |  |  |  |  |  |  | 
| app_proof |  |  |  | 2,607 |  | 30 | 4,090,656 | 136.10 | 0 | 2,650 |  | 
...
| app_proof | VmAirWrapper<Rv64LoadStoreAdapterAir, LoadSignExtendCoreAir<8, 8> | 17 | VmAirWrapper<Rv64LoadStoreAdapterAir, LoadSignExtendCoreAir<8, 8> | 0 | 5,130,780 | 
| app_proof | VmAirWrapper<Rv64LoadStoreAdapterAir, LoadStoreCoreAir<8> | 16 | VmAirWrapper<Rv64LoadStoreAdapterAir, LoadStoreCoreAir<8> | 0 | 109,907,940 | 
...
| app_proof | VmAirWrapper<Rv64LoadStoreAdapterAir, LoadStoreCoreAir<8> | 0 | 8 | 8 | 
...
| app_proof | 10 | KeccakfOpAir | prover | 0 | 1 | 310 | 310 | 
| app_proof | 11 | KeccakfPermAir | prover | 0 | 32 | 2,634 | 84,288 | 
| app_proof | 12 | XorinVmAir | prover | 0 | 1 | 720 | 720 | 
| app_proof | 13 | Rv64HintStoreAir | prover | 0 | 8,192 | 29 | 237,568 | 
...
| app_proof | 19 | VmAirWrapper<Rv64LoadStoreAdapterAir, LoadSignExtendCoreAir<8, 8> | prover | 0 | 131,072 | 47 | 6,160,384 | 
| app_proof | 2 | PersistentBoundaryAir<8> | prover | 0 | 65,536 | 22 | 1,441,792 | 
| app_proof | 20 | VmAirWrapper<Rv64LoadStoreAdapterAir, LoadStoreCoreAir<8>
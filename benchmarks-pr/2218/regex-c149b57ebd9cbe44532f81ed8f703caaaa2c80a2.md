...
| `total_proof_time_ms ` |  589.50 |  2,358 |  739 |  537 |
...
| `execute_metered_insn_mi/s` |  109.42 | -          |  109.42 |  109.42 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  53.25 |  213 |  65 |  45 |
| `execute_preflight_insn_mi/s` |  31.54 | -          |  32.58 |  28.71 |
| `trace_gen_time_ms   ` |  177.25 |  709 |  212 |  153 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  291.25 |  1,165 |  338 |  268 |
| `main_trace_commit_time_ms` |  51.25 |  205 |  56 |  49 |
| `generate_perm_trace_time_ms` |  35 |  140 |  55 |  20 |
| `perm_trace_commit_time_ms` |  64.02 |  256.08 |  70.03 |  55.54 |
| `quotient_poly_compute_time_ms` |  58.96 |  235.86 |  69.58 |  53.11 |
| `quotient_poly_commit_time_ms` |  14.89 |  59.58 |  17.23 |  12.67 |
| `pcs_opening_time_ms ` |  64.25 |  257 |  77 |  56 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 538 | 66 | 1 | 37 | 4,137,502 | 109.42 | 192 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 212 | 739 | 23,446,148 | 150,778,428 | 212 | 338 | 0 | 59.94 | 17.23 | 5 | 70.03 | 77 | 125 | 76 | 4 | 56 | 10,899,170 | 55 | 45 | 1,103,000 | 28.71 | 21 | 77 | 1 | 76 | 
| regex_program | 1 | 153 | 544 | 11,598,276 | 128,513,066 | 153 | 284 | 1 | 53.11 | 14.55 | 4 | 64.48 | 62 | 103 | 62 | 0 | 49 | 2,196,106 | 38 | 65 | 1,104,000 | 32.36 | 16 | 68 | 0 | 62 | 
| regex_program | 2 | 162 | 537 | 11,579,064 | 128,513,066 | 162 | 275 | 1 | 53.23 | 15.12 | 4 | 66.03 | 62 | 94 | 61 | 0 | 50 | 2,177,334 | 27 | 58 | 1,104,000 | 32.51 | 16 | 68 | 0 | 61 | 
| regex_program | 3 | 182 | 538 | 11,853,872 | 103,456,394 | 182 | 268 | 0 | 69.58 | 12.67 | 5 | 55.54 | 56 | 78 | 56 | 0 | 50 | 2,422,606 | 20 | 45 | 826,502 | 32.58 | 18 | 83 | 1 | 56 | 
...
Commit: https://github.com/openvm-org/openvm/commit/c149b57ebd9cbe44532f81ed8f703caaaa2c80a2
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19279197944)

...
| `total_proof_time_ms ` |  721 |  1,442 |  823 |  619 |
...
| `execute_preflight_insn_mi/s` |  13.86 | -          |  18.49 |  9.23 |
| `trace_gen_time_ms   ` |  180 |  360 |  197 |  163 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  353.50 |  707 |  386 |  321 |
| `main_trace_commit_time_ms` |  64.50 |  129 |  75 |  54 |
| `generate_perm_trace_time_ms` |  43.50 |  87 |  47 |  40 |
| `perm_trace_commit_time_ms` |  77.73 |  155.45 |  90.21 |  65.24 |
| `quotient_poly_compute_time_ms` |  79.07 |  158.15 |  88.12 |  70.03 |
| `quotient_poly_commit_time_ms` |  16.82 |  33.64 |  19.18 |  14.45 |
| `pcs_opening_time_ms ` |  66.50 |  133 |  68 |  65 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 619 | 41 | 1 | 90 | 1,745,742 | 19.19 | 145 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 163 | 823 | 32,689,110 | 172,558,444 | 163 | 386 | 0 | 88.12 | 19.18 | 6 | 90.21 | 68 | 133 | 68 | 1 | 75 | 16,059,916 | 40 | 129 | 1,157,000 | 9.23 | 27 | 108 | 1 | 68 | 
| pairing | 1 | 197 | 619 | 22,314,288 | 119,958,502 | 197 | 321 | 1 | 70.03 | 14.45 | 6 | 65.24 | 65 | 116 | 65 | 0 | 54 | 9,408,294 | 47 | 59 | 588,742 | 18.49 | 20 | 85 | 1 | 65 | 

...
| `total_proof_time_ms ` |  721.50 |  1,443 |  824 |  619 |
...
| `execute_preflight_time_ms` |  93 |  186 |  127 |  59 |
| `execute_preflight_insn_mi/s` |  13.91 | -          |  18.52 |  9.29 |
| `trace_gen_time_ms   ` |  181 |  362 |  196 |  166 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  354 |  708 |  386 |  322 |
| `main_trace_commit_time_ms` |  65 |  130 |  75 |  55 |
| `generate_perm_trace_time_ms` |  45 |  90 |  47 |  43 |
| `perm_trace_commit_time_ms` |  77.53 |  155.07 |  90.03 |  65.04 |
| `quotient_poly_compute_time_ms` |  78.88 |  157.77 |  87.88 |  69.89 |
| `quotient_poly_commit_time_ms` |  15.97 |  31.94 |  18.14 |  13.80 |
| `pcs_opening_time_ms ` |  67 |  134 |  68 |  66 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 619 | 40 | 1 | 90 | 1,745,742 | 19.25 | 144 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 166 | 824 | 32,689,110 | 172,558,444 | 166 | 386 | 0 | 87.88 | 18.14 | 6 | 90.03 | 68 | 136 | 68 | 1 | 75 | 16,059,916 | 43 | 127 | 1,157,000 | 9.29 | 27 | 106 | 1 | 68 | 
| pairing | 1 | 196 | 619 | 22,314,288 | 119,958,502 | 196 | 322 | 1 | 69.89 | 13.80 | 6 | 65.04 | 66 | 115 | 66 | 0 | 55 | 9,408,294 | 47 | 59 | 588,742 | 18.52 | 21 | 84 | 1 | 66 | 

...
| `total_proof_time_ms ` |  725 |  1,450 |  845 |  605 |
...
| `execute_preflight_insn_mi/s` |  13.69 | -          |  18.15 |  9.23 |
| `trace_gen_time_ms   ` |  180 |  360 |  195 |  165 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  358 |  716 |  407 |  309 |
| `main_trace_commit_time_ms` |  62 |  124 |  70 |  54 |
| `generate_perm_trace_time_ms` |  42 |  84 |  47 |  37 |
| `perm_trace_commit_time_ms` |  76.73 |  153.45 |  88.54 |  64.92 |
| `quotient_poly_compute_time_ms` |  78.76 |  157.52 |  87.55 |  69.98 |
| `quotient_poly_commit_time_ms` |  15.86 |  31.72 |  17.62 |  14.10 |
| `pcs_opening_time_ms ` |  77.50 |  155 |  101 |  54 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 605 | 40 | 1 | 91 | 1,745,742 | 19.16 | 143 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 165 | 845 | 32,689,110 | 172,558,444 | 165 | 407 | 0 | 87.55 | 17.62 | 6 | 88.54 | 101 | 128 | 101 | 1 | 70 | 16,059,916 | 37 | 129 | 1,157,000 | 9.23 | 26 | 106 | 1 | 101 | 
| pairing | 1 | 195 | 605 | 22,314,288 | 119,958,502 | 195 | 309 | 1 | 69.98 | 14.10 | 6 | 64.92 | 54 | 115 | 54 | 0 | 54 | 9,408,294 | 47 | 59 | 588,742 | 18.15 | 21 | 84 | 1 | 54 | 

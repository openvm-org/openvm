...
| `total_proof_time_ms ` |  593.75 |  2,375 |  751 |  527 |
...
| `execute_preflight_time_ms` |  54.75 |  219 |  69 |  45 |
| `execute_preflight_insn_mi/s` |  30.53 | -          |  32.04 |  28.48 |
| `trace_gen_time_ms   ` |  180.25 |  721 |  216 |  154 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  291 |  1,164 |  345 |  261 |
| `main_trace_commit_time_ms` |  52.25 |  209 |  58 |  50 |
| `generate_perm_trace_time_ms` |  34.75 |  139 |  55 |  19 |
| `perm_trace_commit_time_ms` |  64.38 |  257.53 |  71.68 |  55.04 |
| `quotient_poly_compute_time_ms` |  59.94 |  239.75 |  72.44 |  53.37 |
| `quotient_poly_commit_time_ms` |  15.11 |  60.44 |  18.15 |  12.89 |
| `pcs_opening_time_ms ` |  61.25 |  245 |  79 |  47 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 545 | 66 | 1 | 36 | 4,137,502 | 114.04 | 191 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 216 | 751 | 23,446,148 | 150,778,428 | 216 | 345 | 0 | 60.04 | 18.15 | 5 | 71.68 | 79 | 128 | 78 | 4 | 58 | 10,899,170 | 55 | 45 | 1,103,000 | 28.48 | 21 | 78 | 1 | 78 | 
| regex_program | 1 | 154 | 552 | 11,598,276 | 128,513,066 | 154 | 287 | 1 | 53.89 | 14.49 | 4 | 65.65 | 62 | 104 | 62 | 0 | 50 | 2,196,106 | 38 | 69 | 1,104,000 | 31.33 | 16 | 68 | 0 | 62 | 
| regex_program | 2 | 166 | 527 | 11,579,064 | 128,513,066 | 166 | 261 | 1 | 53.37 | 14.91 | 4 | 65.16 | 47 | 93 | 47 | 0 | 51 | 2,177,334 | 27 | 58 | 1,104,000 | 32.04 | 16 | 68 | 0 | 47 | 
| regex_program | 3 | 185 | 545 | 11,853,872 | 103,456,394 | 185 | 271 | 0 | 72.44 | 12.89 | 5 | 55.04 | 57 | 77 | 56 | 0 | 50 | 2,422,606 | 19 | 47 | 826,502 | 30.28 | 18 | 86 | 1 | 56 | 
...
Commit: https://github.com/openvm-org/openvm/commit/05153d3d9353342057f2875c8ead24586898b599
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19281432536)

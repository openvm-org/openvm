...
| `total_proof_time_ms ` |  589.50 |  2,358 |  723 |  528 |
...
| `execute_metered_insn_mi/s` |  110.41 | -          |  110.41 |  110.41 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  53.25 |  213 |  64 |  45 |
| `execute_preflight_insn_mi/s` |  31.17 | -          |  32.45 |  28.32 |
| `trace_gen_time_ms   ` |  177.25 |  709 |  210 |  155 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  292.25 |  1,169 |  326 |  265 |
| `main_trace_commit_time_ms` |  52 |  208 |  57 |  49 |
| `generate_perm_trace_time_ms` |  35 |  140 |  62 |  18 |
| `perm_trace_commit_time_ms` |  63.80 |  255.20 |  71.20 |  55.17 |
| `quotient_poly_compute_time_ms` |  58.01 |  232.05 |  69.03 |  52.65 |
| `quotient_poly_commit_time_ms` |  14.45 |  57.79 |  16.52 |  12.23 |
| `pcs_opening_time_ms ` |  65.50 |  262 |  87 |  54 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 534 | 67 | 1 | 37 | 4,137,502 | 110.41 | 194 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 210 | 723 | 23,446,148 | 150,778,428 | 210 | 326 | 0 | 57.27 | 16.52 | 5 | 71.20 | 87 | 106 | 87 | 4 | 57 | 10,899,170 | 34 | 45 | 1,103,000 | 28.32 | 21 | 74 | 1 | 87 | 
| regex_program | 1 | 155 | 573 | 11,598,276 | 128,513,066 | 155 | 312 | 1 | 52.65 | 14.42 | 5 | 64.14 | 65 | 127 | 65 | 0 | 51 | 2,196,106 | 62 | 64 | 1,104,000 | 32.26 | 16 | 67 | 0 | 65 | 
| regex_program | 2 | 161 | 528 | 11,579,064 | 128,513,066 | 161 | 266 | 1 | 53.10 | 14.62 | 5 | 64.68 | 54 | 91 | 54 | 0 | 51 | 2,177,334 | 26 | 59 | 1,104,000 | 31.64 | 16 | 68 | 0 | 54 | 
| regex_program | 3 | 183 | 534 | 11,853,872 | 103,456,394 | 183 | 265 | 0 | 69.03 | 12.23 | 5 | 55.17 | 56 | 76 | 56 | 0 | 49 | 2,422,606 | 18 | 45 | 826,502 | 32.45 | 18 | 82 | 1 | 56 | 
...
Commit: https://github.com/openvm-org/openvm/commit/d3d31591449342edd117a5f5aacb52e110dd6200
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19317072948)

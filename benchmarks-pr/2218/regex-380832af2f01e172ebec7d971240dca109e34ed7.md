...
| `total_proof_time_ms ` |  601.25 |  2,405 |  754 |  545 |
...
| `execute_preflight_time_ms` |  58.75 |  235 |  74 |  46 |
| `execute_preflight_insn_mi/s` |  31.12 | -          |  32.64 |  27.52 |
| `trace_gen_time_ms   ` |  177.50 |  710 |  215 |  152 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  295.50 |  1,182 |  342 |  270 |
| `main_trace_commit_time_ms` |  52.50 |  210 |  57 |  51 |
| `generate_perm_trace_time_ms` |  35.25 |  141 |  56 |  19 |
| `perm_trace_commit_time_ms` |  64.44 |  257.76 |  68.98 |  56.47 |
| `quotient_poly_compute_time_ms` |  57.95 |  231.80 |  71.78 |  53.13 |
| `quotient_poly_commit_time_ms` |  15.30 |  61.20 |  17.38 |  13.03 |
| `pcs_opening_time_ms ` |  66.50 |  266 |  86 |  53 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 545 | 67 | 1 | 36 | 4,137,502 | 112.79 | 202 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 215 | 754 | 23,446,148 | 150,778,428 | 215 | 342 | 0 | 53.38 | 17.38 | 6 | 68.98 | 86 | 126 | 86 | 4 | 57 | 10,899,170 | 56 | 46 | 1,103,000 | 27.52 | 22 | 71 | 1 | 86 | 
| regex_program | 1 | 152 | 560 | 11,598,276 | 128,513,066 | 152 | 292 | 1 | 53.13 | 16.17 | 5 | 66.43 | 65 | 106 | 64 | 0 | 51 | 2,196,106 | 38 | 74 | 1,104,000 | 32.64 | 17 | 69 | 0 | 64 | 
| regex_program | 2 | 161 | 546 | 11,579,064 | 128,513,066 | 161 | 278 | 1 | 53.51 | 14.63 | 4 | 65.89 | 62 | 95 | 62 | 0 | 51 | 2,177,334 | 28 | 65 | 1,104,000 | 32 | 16 | 68 | 0 | 62 | 
| regex_program | 3 | 182 | 545 | 11,853,872 | 103,456,394 | 182 | 270 | 0 | 71.78 | 13.03 | 6 | 56.47 | 53 | 79 | 53 | 0 | 51 | 2,422,606 | 19 | 50 | 826,502 | 32.34 | 19 | 86 | 1 | 53 | 

...
|:---|---:|---:|
| Total |  2.37 |  0.77 |
| regex_program |  2.34 |  0.73 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  584.50 |  2,338 |  730 |  527 |
...
| `execute_preflight_insn_mi/s` |  31.14 | -          |  32.46 |  28.09 |
| `trace_gen_time_ms   ` |  178.50 |  714 |  213 |  156 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  283 |  1,132 |  324 |  262 |
| `main_trace_commit_time_ms` |  52 |  208 |  56 |  50 |
| `generate_perm_trace_time_ms` |  25.25 |  101 |  34 |  18 |
| `perm_trace_commit_time_ms` |  64.97 |  259.89 |  70.38 |  56.08 |
| `quotient_poly_compute_time_ms` |  59.06 |  236.22 |  68.84 |  52.83 |
| `quotient_poly_commit_time_ms` |  15.15 |  60.59 |  18.13 |  12.55 |
| `pcs_opening_time_ms ` |  63 |  252 |  82 |  50 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 541 | 66 | 1 | 36 | 4,137,502 | 112.94 | 196 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 213 | 730 | 23,446,148 | 150,778,428 | 213 | 324 | 0 | 60.49 | 18.13 | 6 | 70.38 | 82 | 105 | 81 | 4 | 56 | 10,899,170 | 34 | 46 | 1,103,000 | 28.09 | 21 | 79 | 1 | 81 | 
| regex_program | 1 | 156 | 527 | 11,598,276 | 128,513,066 | 156 | 262 | 1 | 54.07 | 15.36 | 5 | 68.26 | 50 | 91 | 50 | 0 | 50 | 2,196,106 | 22 | 67 | 1,104,000 | 32.31 | 16 | 70 | 0 | 50 | 
| regex_program | 2 | 162 | 540 | 11,579,064 | 128,513,066 | 162 | 276 | 1 | 52.83 | 14.54 | 5 | 65.17 | 63 | 93 | 62 | 0 | 51 | 2,177,334 | 27 | 60 | 1,104,000 | 32.46 | 16 | 68 | 0 | 62 | 
| regex_program | 3 | 183 | 541 | 11,853,872 | 103,456,394 | 183 | 270 | 0 | 68.84 | 12.55 | 5 | 56.08 | 57 | 78 | 57 | 0 | 51 | 2,422,606 | 18 | 47 | 826,502 | 31.70 | 18 | 82 | 1 | 57 | 
...
Commit: https://github.com/openvm-org/openvm/commit/bb2aba53ab474cd1e1817093a0c5f50ade4b7db3
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19339333015)

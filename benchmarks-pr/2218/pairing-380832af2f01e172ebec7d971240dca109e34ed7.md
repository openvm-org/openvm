...
| `total_proof_time_ms ` |  720.50 |  1,441 |  824 |  617 |
...
| `execute_preflight_insn_mi/s` |  13.69 | -          |  18.20 |  9.19 |
| `trace_gen_time_ms   ` |  177 |  354 |  194 |  160 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  357 |  714 |  391 |  323 |
| `main_trace_commit_time_ms` |  64.50 |  129 |  74 |  55 |
| `generate_perm_trace_time_ms` |  49.50 |  99 |  52 |  47 |
| `perm_trace_commit_time_ms` |  76.51 |  153.02 |  89.32 |  63.70 |
| `quotient_poly_compute_time_ms` |  79.80 |  159.60 |  87.69 |  71.91 |
| `quotient_poly_commit_time_ms` |  16.67 |  33.34 |  18.88 |  14.46 |
| `pcs_opening_time_ms ` |  65 |  130 |  66 |  64 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 617 | 41 | 1 | 90 | 1,745,742 | 19.24 | 145 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 160 | 824 | 32,689,110 | 172,558,444 | 160 | 391 | 0 | 87.69 | 18.88 | 6 | 89.32 | 64 | 144 | 63 | 1 | 74 | 16,059,916 | 52 | 129 | 1,157,000 | 9.19 | 26 | 107 | 1 | 63 | 
| pairing | 1 | 194 | 617 | 22,314,288 | 119,958,502 | 194 | 323 | 1 | 71.91 | 14.46 | 6 | 63.70 | 66 | 114 | 66 | 0 | 55 | 9,408,294 | 47 | 58 | 588,742 | 18.20 | 20 | 86 | 1 | 66 | 

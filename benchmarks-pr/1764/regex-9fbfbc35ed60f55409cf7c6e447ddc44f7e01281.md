...
|:---|---:|---:|
| Total |  7.30 |  4.24 |
| regex_program |  6.74 |  3.69 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  3,369 |  6,738 |  3,687 |  3,051 |
...
| `execute_e3_time_ms  ` |  285.50 |  571 |  311 |  260 |
| `execute_e3_insn_mi/s` |  7.29 | -          |  7.37 |  7.21 |
| `trace_gen_time_ms   ` |  517.50 |  1,035 |  597 |  438 |
| `memory_finalize_time_ms` |  230 |  460 |  291 |  169 |
| `boundary_finalize_time_ms` |  2.50 |  5 |  5 |  0 |
| `merkle_finalize_time_ms` |  214 |  428 |  266 |  162 |
| `stark_prove_excluding_trace_time_ms` |  2,566 |  5,132 |  2,779 |  2,353 |
| `main_trace_commit_time_ms` |  504 |  1,008 |  563 |  445 |
| `generate_perm_trace_time_ms` |  205.50 |  411 |  233 |  178 |
| `perm_trace_commit_time_ms` |  552 |  1,104 |  585 |  519 |
| `quotient_poly_compute_time_ms` |  264 |  528 |  287 |  241 |
| `quotient_poly_commit_time_ms` |  240.50 |  481 |  276 |  205 |
| `pcs_opening_time_ms ` |  793 |  1,586 |  830 |  756 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2 | 580 | 4,165,433 | 1 | 557 | 7.47 | 19 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 597 | 3,687 | 2,243,700 | 275,648,700 | 2,779 | 287 | 276 | 585 | 830 | 266 | 291 | 563 | 93,502,324 | 2,243,700 | 233 | 311 | 7.21 | 5 | 
| regex_program | 1 | 438 | 3,051 | 1,921,732 | 242,975,388 | 2,353 | 241 | 205 | 519 | 756 | 162 | 169 | 445 | 73,017,132 | 1,921,733 | 178 | 260 | 7.37 | 0 | 

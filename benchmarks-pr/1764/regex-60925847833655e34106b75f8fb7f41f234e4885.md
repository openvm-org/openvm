...
| `execute_metered_insn_mi/s` |  7.63 | -          | -          | -          |
| `execute_e3_time_ms  ` |  295.50 |  591 |  321 |  270 |
| `execute_e3_insn_mi/s` |  7.04 | -          |  7.09 |  6.98 |
| `trace_gen_time_ms   ` |  507.50 |  1,015 |  582 |  433 |
| `stark_prove_excluding_trace_time_ms` |  2,602 |  5,204 |  2,801 |  2,403 |
| `main_trace_commit_time_ms` |  521 |  1,042 |  577 |  465 |
| `generate_perm_trace_time_ms` |  210.50 |  421 |  228 |  193 |
| `perm_trace_commit_time_ms` |  555.50 |  1,111 |  588 |  523 |
| `quotient_poly_compute_time_ms` |  263.50 |  527 |  284 |  243 |
| `quotient_poly_commit_time_ms` |  245.50 |  491 |  279 |  212 |
| `pcs_opening_time_ms ` |  798.50 |  1,597 |  840 |  757 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2 | 586 | 4,165,433 | 1 | 545 | 7.63 | 19 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 582 | 2,243,700 | 275,648,700 | 2,801 | 284 | 279 | 588 | 840 | 577 | 93,502,324 | 2,243,700 | 228 | 321 | 6.98 | 
| regex_program | 1 | 433 | 1,921,732 | 242,975,388 | 2,403 | 243 | 212 | 523 | 757 | 465 | 73,017,132 | 1,921,733 | 193 | 270 | 7.09 | 

...
|:---|---:|---:|
| Total |  7.19 |  4.18 |
| regex_program |  6.64 |  3.63 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  3,318.50 |  6,637 |  3,630 |  3,007 |
| `main_cells_used     ` |  83,259,728 |  166,519,456 |  93,502,324 |  73,017,132 |
| `total_cycles        ` |  2,082,716 |  4,165,432 |  2,243,700 |  1,921,732 |
| `execute_metered_time_ms` |  554 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  7.52 | -          | -          | -          |
| `execute_e3_time_ms  ` |  305 |  610 |  331 |  279 |
| `execute_e3_insn_mi/s` |  6.83 | -          |  6.88 |  6.77 |
| `trace_gen_time_ms   ` |  501 |  1,002 |  575 |  427 |
| `memory_finalize_time_ms` |  230 |  460 |  289 |  171 |
| `boundary_finalize_time_ms` |  2.50 |  5 |  5 |  0 |
| `merkle_finalize_time_ms` |  214.50 |  429 |  266 |  163 |
| `stark_prove_excluding_trace_time_ms` |  2,512.50 |  5,025 |  2,724 |  2,301 |
| `main_trace_commit_time_ms` |  455.50 |  911 |  512 |  399 |
| `generate_perm_trace_time_ms` |  231.50 |  463 |  256 |  207 |
| `perm_trace_commit_time_ms` |  507 |  1,014 |  548 |  466 |
| `quotient_poly_compute_time_ms` |  283 |  566 |  292 |  274 |
| `quotient_poly_commit_time_ms` |  224 |  448 |  258 |  190 |
| `pcs_opening_time_ms ` |  804.50 |  1,609 |  854 |  755 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2 | 580 | 4,165,433 | 1 | 554 | 7.52 | 19 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 575 | 3,630 | 2,243,700 | 275,648,700 | 2,724 | 292 | 258 | 548 | 854 | 266 | 289 | 512 | 93,502,324 | 2,243,700 | 256 | 331 | 6.77 | 5 | 
| regex_program | 1 | 427 | 3,007 | 1,921,732 | 242,975,388 | 2,301 | 274 | 190 | 466 | 755 | 163 | 171 | 399 | 73,017,132 | 1,921,733 | 207 | 279 | 6.88 | 0 | 

...
| `execute_metered_insn_mi/s` |  7.62 | -          | -          | -          |
| `execute_e3_time_ms  ` |  296 |  592 |  322 |  270 |
| `execute_e3_insn_mi/s` |  7.03 | -          |  7.10 |  6.96 |
| `trace_gen_time_ms   ` |  492.50 |  985 |  568 |  417 |
| `stark_prove_excluding_trace_time_ms` |  2,586 |  5,172 |  2,799 |  2,373 |
| `main_trace_commit_time_ms` |  503.50 |  1,007 |  561 |  446 |
| `generate_perm_trace_time_ms` |  214 |  428 |  229 |  199 |
| `perm_trace_commit_time_ms` |  554 |  1,108 |  589 |  519 |
| `quotient_poly_compute_time_ms` |  268.50 |  537 |  300 |  237 |
| `quotient_poly_commit_time_ms` |  244.50 |  489 |  283 |  206 |
| `pcs_opening_time_ms ` |  794 |  1,588 |  832 |  756 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2 | 583 | 4,165,433 | 1 | 546 | 7.62 | 19 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 568 | 2,243,700 | 275,648,700 | 2,799 | 300 | 283 | 589 | 832 | 561 | 93,502,324 | 2,243,700 | 229 | 322 | 6.96 | 
| regex_program | 1 | 417 | 1,921,732 | 242,975,388 | 2,373 | 237 | 206 | 519 | 756 | 446 | 73,017,132 | 1,921,733 | 199 | 270 | 7.10 | 

...
|:---|---:|---:|
| Total |  7.36 |  4.27 |
| regex_program |  6.82 |  3.72 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  3,409.50 |  6,819 |  3,720 |  3,099 |
...
| `execute_e3_insn_mi/s` |  7.03 | -          |  7.09 |  6.96 |
| `trace_gen_time_ms   ` |  496.50 |  993 |  563 |  430 |
| `stark_prove_excluding_trace_time_ms` |  2,617 |  5,234 |  2,835 |  2,399 |
| `main_trace_commit_time_ms` |  507.50 |  1,015 |  571 |  444 |
| `generate_perm_trace_time_ms` |  217.50 |  435 |  226 |  209 |
| `perm_trace_commit_time_ms` |  555 |  1,110 |  590 |  520 |
| `quotient_poly_compute_time_ms` |  261 |  522 |  281 |  241 |
| `quotient_poly_commit_time_ms` |  246 |  492 |  281 |  211 |
| `pcs_opening_time_ms ` |  822.50 |  1,645 |  881 |  764 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2 | 582 | 4,165,433 | 1 | 545 | 7.64 | 20 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 563 | 3,720 | 2,243,700 | 275,648,700 | 2,835 | 281 | 281 | 590 | 881 | 571 | 93,502,324 | 2,243,700 | 226 | 322 | 6.96 | 
| regex_program | 1 | 430 | 3,099 | 1,921,732 | 242,975,388 | 2,399 | 241 | 211 | 520 | 764 | 444 | 73,017,132 | 1,921,733 | 209 | 270 | 7.09 | 

...
|:---|---:|---:|
| Total |  7.38 |  4.27 |
| regex_program |  6.81 |  3.70 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  3,405 |  6,810 |  3,703 |  3,107 |
...
| `execute_metered_insn_mi/s` |  7.36 | -          | -          | -          |
| `execute_e3_time_ms  ` |  286 |  572 |  311 |  261 |
| `execute_e3_insn_mi/s` |  7.27 | -          |  7.34 |  7.20 |
| `trace_gen_time_ms   ` |  508.50 |  1,017 |  587 |  430 |
| `memory_finalize_time_ms` |  228 |  456 |  285 |  171 |
| `boundary_finalize_time_ms` |  3 |  6 |  5 |  1 |
| `merkle_finalize_time_ms` |  210.50 |  421 |  259 |  162 |
| `stark_prove_excluding_trace_time_ms` |  2,610.50 |  5,221 |  2,805 |  2,416 |
| `main_trace_commit_time_ms` |  506 |  1,012 |  568 |  444 |
| `generate_perm_trace_time_ms` |  211.50 |  423 |  228 |  195 |
| `perm_trace_commit_time_ms` |  553 |  1,106 |  587 |  519 |
| `quotient_poly_compute_time_ms` |  264.50 |  529 |  292 |  237 |
| `quotient_poly_commit_time_ms` |  243.50 |  487 |  278 |  209 |
| `pcs_opening_time_ms ` |  824 |  1,648 |  847 |  801 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2 | 585 | 4,165,433 | 1 | 565 | 7.36 | 20 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 587 | 3,703 | 2,243,700 | 275,648,700 | 2,805 | 292 | 278 | 587 | 847 | 259 | 285 | 568 | 93,502,324 | 2,243,700 | 228 | 311 | 7.20 | 5 | 
| regex_program | 1 | 430 | 3,107 | 1,921,732 | 242,975,388 | 2,416 | 237 | 209 | 519 | 801 | 162 | 171 | 444 | 73,017,132 | 1,921,733 | 195 | 261 | 7.34 | 1 | 

...
|:---|---:|---:|
| Total |  7.31 |  4.21 |
| regex_program |  6.76 |  3.67 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  3,381 |  6,762 |  3,670 |  3,092 |
| `main_cells_used     ` |  83,259,728 |  166,519,456 |  93,502,324 |  73,017,132 |
| `total_cycles        ` |  2,082,716 |  4,165,432 |  2,243,700 |  1,921,732 |
| `execute_metered_time_ms` |  545 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  7.64 | -          | -          | -          |
| `execute_e3_time_ms  ` |  297.50 |  595 |  321 |  274 |
| `execute_e3_insn_mi/s` |  6.99 | -          |  6.100 |  6.97 |
| `trace_gen_time_ms   ` |  503.50 |  1,007 |  574 |  433 |
| `stark_prove_excluding_trace_time_ms` |  2,580 |  5,160 |  2,775 |  2,385 |
| `main_trace_commit_time_ms` |  505.50 |  1,011 |  565 |  446 |
| `generate_perm_trace_time_ms` |  218.50 |  437 |  236 |  201 |
| `perm_trace_commit_time_ms` |  552.50 |  1,105 |  585 |  520 |
| `quotient_poly_compute_time_ms` |  262.50 |  525 |  288 |  237 |
| `quotient_poly_commit_time_ms` |  246.50 |  493 |  275 |  218 |
| `pcs_opening_time_ms ` |  787 |  1,574 |  820 |  754 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2 | 586 | 4,165,433 | 1 | 545 | 7.64 | 20 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 574 | 3,670 | 2,243,700 | 275,648,700 | 2,775 | 288 | 275 | 585 | 820 | 565 | 93,502,324 | 2,243,700 | 236 | 321 | 6.97 | 
| regex_program | 1 | 433 | 3,092 | 1,921,732 | 242,975,388 | 2,385 | 237 | 218 | 520 | 754 | 446 | 73,017,132 | 1,921,733 | 201 | 274 | 6.100 | 

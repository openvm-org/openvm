...
|:---|---:|---:|
| Total |  7.66 |  4.96 |
| regex_program |  7.63 |  4.93 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  3,812.50 |  7,625 |  4,931 |  2,694 |
...
| `execute_metered_insn_mi/s` |  120.41 | -          |  120.41 |  120.41 |
| `execute_preflight_insns` |  2,054,298.50 |  4,108,597 |  2,211,000 |  1,897,597 |
| `execute_preflight_time_ms` |  93 |  186 |  102 |  84 |
| `execute_preflight_insn_mi/s` |  28.59 | -          |  30.96 |  26.23 |
| `trace_gen_time_ms   ` |  386.50 |  773 |  495 |  278 |
| `memory_finalize_time_ms` |  7.50 |  15 |  13 |  2 |
| `stark_prove_excluding_trace_time_ms` |  3,104.50 |  6,209 |  4,092 |  2,117 |
| `main_trace_commit_time_ms` |  623 |  1,246 |  838 |  408 |
| `generate_perm_trace_time_ms` |  239 |  478 |  335 |  143 |
| `perm_trace_commit_time_ms` |  674 |  1,348 |  894 |  454 |
| `quotient_poly_compute_time_ms` |  322 |  644 |  442 |  202 |
| `quotient_poly_commit_time_ms` |  293 |  586 |  393 |  193 |
| `pcs_opening_time_ms ` |  945.50 |  1,891 |  1,185 |  706 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2,694 | 6 | 1 | 34 | 4,108,597 | 120.41 | 45 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 495 | 4,931 | 211,758,557 | 373,183,036 | 495 | 4,092 | 0 | 442 | 393 | 894 | 1,185 | 7 | 13 | 838 | 91,281,687 | 335 | 102 | 2,211,000 | 26.23 | 
| regex_program | 1 | 278 | 2,694 | 174,326,267 | 196,838,026 | 278 | 2,117 | 52 | 202 | 193 | 454 | 706 | 6 | 2 | 408 | 73,453,305 | 143 | 84 | 1,897,597 | 30.96 | 

...
|:---|---:|---:|
| Total |  7.63 |  4.92 |
| regex_program |  7.60 |  4.89 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  3,801 |  7,602 |  4,892 |  2,710 |
...
| `execute_metered_insn_mi/s` |  130.13 | -          |  130.13 |  130.13 |
| `execute_preflight_insns` |  2,054,298.50 |  4,108,597 |  2,211,000 |  1,897,597 |
| `execute_preflight_time_ms` |  93.50 |  187 |  103 |  84 |
| `execute_preflight_insn_mi/s` |  28.64 | -          |  31.07 |  26.22 |
| `trace_gen_time_ms   ` |  399.50 |  799 |  509 |  290 |
| `memory_finalize_time_ms` |  8 |  16 |  14 |  2 |
| `stark_prove_excluding_trace_time_ms` |  3,077.50 |  6,155 |  4,034 |  2,121 |
| `main_trace_commit_time_ms` |  610.50 |  1,221 |  834 |  387 |
| `generate_perm_trace_time_ms` |  225 |  450 |  298 |  152 |
| `perm_trace_commit_time_ms` |  649.50 |  1,299 |  852 |  447 |
| `quotient_poly_compute_time_ms` |  320.50 |  641 |  436 |  205 |
| `quotient_poly_commit_time_ms` |  297 |  594 |  392 |  202 |
| `pcs_opening_time_ms ` |  968 |  1,936 |  1,217 |  719 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2,710 | 6 | 1 | 31 | 4,108,597 | 130.13 | 45 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 509 | 4,892 | 211,758,557 | 373,183,036 | 509 | 4,034 | 0 | 436 | 392 | 852 | 1,217 | 8 | 14 | 834 | 91,281,687 | 298 | 103 | 2,211,000 | 26.22 | 
| regex_program | 1 | 290 | 2,710 | 174,326,267 | 196,838,026 | 290 | 2,121 | 54 | 205 | 202 | 447 | 719 | 6 | 2 | 387 | 73,453,305 | 152 | 84 | 1,897,597 | 31.07 | 

...
| `total_proof_time_ms ` |  3,819 |  7,638 |  4,899 |  2,739 |
...
| `execute_preflight_insn_mi/s` |  28.74 | -          |  31.46 |  26.02 |
| `trace_gen_time_ms   ` |  389.50 |  779 |  498 |  281 |
| `memory_finalize_time_ms` |  7.50 |  15 |  13 |  2 |
| `stark_prove_excluding_trace_time_ms` |  3,110.50 |  6,221 |  4,058 |  2,163 |
| `main_trace_commit_time_ms` |  630.50 |  1,261 |  845 |  416 |
| `generate_perm_trace_time_ms` |  234.50 |  469 |  308 |  161 |
| `perm_trace_commit_time_ms` |  661.50 |  1,323 |  874 |  449 |
| `quotient_poly_compute_time_ms` |  316 |  632 |  424 |  208 |
| `quotient_poly_commit_time_ms` |  304 |  608 |  401 |  207 |
| `pcs_opening_time_ms ` |  956 |  1,912 |  1,201 |  711 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2,739 | 7 | 1 | 31 | 4,108,597 | 132.13 | 45 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 498 | 4,899 | 211,758,557 | 373,183,036 | 498 | 4,058 | 0 | 424 | 401 | 874 | 1,201 | 8 | 13 | 845 | 91,281,687 | 308 | 101 | 2,211,000 | 26.02 | 
| regex_program | 1 | 281 | 2,739 | 174,326,267 | 196,838,026 | 281 | 2,163 | 52 | 208 | 207 | 449 | 711 | 6 | 2 | 416 | 73,453,305 | 161 | 83 | 1,897,597 | 31.46 | 

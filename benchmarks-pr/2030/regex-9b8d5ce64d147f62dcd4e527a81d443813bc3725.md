...
| `total_proof_time_ms ` |  3,814.50 |  7,629 |  4,889 |  2,740 |
...
| `execute_preflight_insn_mi/s` |  28.52 | -          |  30.82 |  26.22 |
| `trace_gen_time_ms   ` |  376 |  752 |  482 |  270 |
| `memory_finalize_time_ms` |  7.50 |  15 |  13 |  2 |
| `stark_prove_excluding_trace_time_ms` |  3,114.50 |  6,229 |  4,065 |  2,164 |
| `main_trace_commit_time_ms` |  640 |  1,280 |  851 |  429 |
| `generate_perm_trace_time_ms` |  235.50 |  471 |  313 |  158 |
| `perm_trace_commit_time_ms` |  653.50 |  1,307 |  857 |  450 |
| `quotient_poly_compute_time_ms` |  320.50 |  641 |  443 |  198 |
| `quotient_poly_commit_time_ms` |  297 |  594 |  398 |  196 |
| `pcs_opening_time_ms ` |  958 |  1,916 |  1,194 |  722 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2,740 | 7 | 1 | 32 | 4,108,597 | 127.47 | 45 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 482 | 4,889 | 211,758,557 | 373,183,036 | 482 | 4,065 | 0 | 443 | 398 | 857 | 1,194 | 7 | 13 | 851 | 91,281,687 | 313 | 100 | 2,211,000 | 26.22 | 
| regex_program | 1 | 270 | 2,740 | 174,326,267 | 196,838,026 | 269 | 2,164 | 50 | 198 | 196 | 450 | 722 | 8 | 2 | 429 | 73,453,305 | 158 | 85 | 1,897,597 | 30.82 | 

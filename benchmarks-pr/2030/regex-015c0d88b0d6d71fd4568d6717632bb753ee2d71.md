...
|:---|---:|---:|
| Total |  7.67 |  4.94 |
| regex_program |  7.63 |  4.91 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  3,816.50 |  7,633 |  4,905 |  2,728 |
...
| `execute_preflight_time_ms` |  91.50 |  183 |  100 |  83 |
| `execute_preflight_insn_mi/s` |  28.71 | -          |  31.23 |  26.19 |
| `trace_gen_time_ms   ` |  375.50 |  751 |  481 |  270 |
| `memory_finalize_time_ms` |  7.50 |  15 |  13 |  2 |
| `stark_prove_excluding_trace_time_ms` |  3,117.50 |  6,235 |  4,079 |  2,156 |
| `main_trace_commit_time_ms` |  623.50 |  1,247 |  850 |  397 |
| `generate_perm_trace_time_ms` |  233.50 |  467 |  313 |  154 |
| `perm_trace_commit_time_ms` |  654.50 |  1,309 |  852 |  457 |
| `quotient_poly_compute_time_ms` |  320.50 |  641 |  435 |  206 |
| `quotient_poly_commit_time_ms` |  303 |  606 |  397 |  209 |
| `pcs_opening_time_ms ` |  976 |  1,952 |  1,229 |  723 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2,728 | 7 | 1 | 32 | 4,108,597 | 127.19 | 45 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 481 | 4,905 | 211,758,557 | 373,183,036 | 481 | 4,079 | 0 | 435 | 397 | 852 | 1,229 | 8 | 13 | 850 | 91,281,687 | 313 | 100 | 2,211,000 | 26.19 | 
| regex_program | 1 | 270 | 2,728 | 174,326,267 | 196,838,026 | 270 | 2,156 | 49 | 206 | 209 | 457 | 723 | 7 | 2 | 397 | 73,453,305 | 154 | 83 | 1,897,597 | 31.23 | 

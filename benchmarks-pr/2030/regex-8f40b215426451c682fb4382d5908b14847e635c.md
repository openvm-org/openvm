...
|:---|---:|---:|
| Total |  7.65 |  4.89 |
| regex_program |  7.62 |  4.86 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  3,808 |  7,616 |  4,863 |  2,753 |
...
| `execute_metered_insn_mi/s` |  129.06 | -          |  129.06 |  129.06 |
| `execute_preflight_insns` |  2,054,298.50 |  4,108,597 |  2,211,000 |  1,897,597 |
| `execute_preflight_time_ms` |  95 |  190 |  103 |  87 |
| `execute_preflight_insn_mi/s` |  28.39 | -          |  30.74 |  26.04 |
| `trace_gen_time_ms   ` |  390.50 |  781 |  498 |  283 |
| `memory_finalize_time_ms` |  8 |  16 |  14 |  2 |
| `stark_prove_excluding_trace_time_ms` |  3,095.50 |  6,191 |  4,021 |  2,170 |
| `main_trace_commit_time_ms` |  634 |  1,268 |  838 |  430 |
| `generate_perm_trace_time_ms` |  221 |  442 |  292 |  150 |
| `perm_trace_commit_time_ms` |  651.50 |  1,303 |  853 |  450 |
| `quotient_poly_compute_time_ms` |  317 |  634 |  432 |  202 |
| `quotient_poly_commit_time_ms` |  303.50 |  607 |  400 |  207 |
| `pcs_opening_time_ms ` |  957.50 |  1,915 |  1,196 |  719 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2,753 | 6 | 1 | 31 | 4,108,597 | 129.06 | 45 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 498 | 4,863 | 211,758,557 | 373,183,036 | 498 | 4,021 | 0 | 432 | 400 | 853 | 1,196 | 8 | 14 | 838 | 91,281,687 | 292 | 103 | 2,211,000 | 26.04 | 
| regex_program | 1 | 283 | 2,753 | 174,326,267 | 196,838,026 | 283 | 2,170 | 53 | 202 | 207 | 450 | 719 | 8 | 2 | 430 | 73,453,305 | 150 | 87 | 1,897,597 | 30.74 | 

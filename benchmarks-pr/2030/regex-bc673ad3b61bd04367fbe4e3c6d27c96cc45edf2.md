...
| `total_proof_time_ms ` |  3,801 |  7,602 |  4,879 |  2,723 |
...
| `execute_metered_insn_mi/s` |  131.95 | -          |  131.95 |  131.95 |
| `execute_preflight_insns` |  2,054,298.50 |  4,108,597 |  2,211,000 |  1,897,597 |
| `execute_preflight_time_ms` |  93.50 |  187 |  102 |  85 |
| `execute_preflight_insn_mi/s` |  28.55 | -          |  31.03 |  26.06 |
| `trace_gen_time_ms   ` |  385.50 |  771 |  494 |  277 |
| `memory_finalize_time_ms` |  8 |  16 |  13 |  3 |
| `stark_prove_excluding_trace_time_ms` |  3,093.50 |  6,187 |  4,042 |  2,145 |
| `main_trace_commit_time_ms` |  629 |  1,258 |  840 |  418 |
| `generate_perm_trace_time_ms` |  228.50 |  457 |  309 |  148 |
| `perm_trace_commit_time_ms` |  650 |  1,300 |  850 |  450 |
| `quotient_poly_compute_time_ms` |  316 |  632 |  434 |  198 |
| `quotient_poly_commit_time_ms` |  304 |  608 |  405 |  203 |
| `pcs_opening_time_ms ` |  959 |  1,918 |  1,200 |  718 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2,724 | 6 | 1 | 31 | 4,108,597 | 131.95 | 45 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 494 | 4,879 | 211,758,557 | 373,183,036 | 494 | 4,042 | 0 | 434 | 405 | 850 | 1,200 | 7 | 13 | 840 | 91,281,687 | 309 | 102 | 2,211,000 | 26.06 | 
| regex_program | 1 | 277 | 2,723 | 174,326,267 | 196,838,026 | 277 | 2,145 | 51 | 198 | 203 | 450 | 718 | 7 | 3 | 418 | 73,453,305 | 148 | 85 | 1,897,597 | 31.03 | 

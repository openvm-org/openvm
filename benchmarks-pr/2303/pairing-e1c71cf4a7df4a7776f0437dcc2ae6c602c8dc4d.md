...
| `total_proof_time_ms ` |  747 |  1,494 |  873 |  621 |
...
| `execute_metered_insn_mi/s` |  27.35 | -          |  27.35 |  27.35 |
| `execute_preflight_insns` |  872,871 |  1,745,742 |  1,149,000 |  596,742 |
| `execute_preflight_time_ms` |  83 |  166 |  105 |  61 |
| `execute_preflight_insn_mi/s` |  14.76 | -          |  18.28 |  11.24 |
| `trace_gen_time_ms   ` |  193 |  386 |  196 |  190 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  366 |  732 |  409 |  323 |
| `main_trace_commit_time_ms` |  65.50 |  131 |  76 |  55 |
| `generate_perm_trace_time_ms` |  41.50 |  83 |  54 |  29 |
| `perm_trace_commit_time_ms` |  77.72 |  155.43 |  90.58 |  64.86 |
| `quotient_poly_compute_time_ms` |  82.40 |  164.80 |  89.04 |  75.76 |
| `quotient_poly_commit_time_ms` |  16.04 |  32.07 |  16.71 |  15.36 |
| `pcs_opening_time_ms ` |  78 |  156 |  79 |  77 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 621 | 1 | 63 | 1,745,742 | 27.35 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 190 | 873 | 32,480,114 | 172,558,444 | 190 | 409 | 0 | 89.04 | 16.71 | 6 | 90.58 | 79 | 147 | 78 | 1 | 76 | 15,909,408 | 54 | 105 | 1,149,000 | 11.24 | 27 | 106 | 1 | 78 | 
| pairing | 1 | 196 | 621 | 22,464,232 | 119,958,502 | 196 | 323 | 1 | 75.76 | 15.36 | 6 | 64.86 | 77 | 97 | 77 | 0 | 55 | 9,498,894 | 29 | 61 | 596,742 | 18.28 | 21 | 91 | 1 | 77 | 

...
|:---|---:|---:|---:|
| Total |  2.35 |  0.75 | 0.75 |
| regex_program |  2.35 |  0.75 |  0.75 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  578.25 |  2,313 |  713 |  530 |
...
| `execute_metered_insn_mi/s` |  108.81 | -          |  108.81 |  108.81 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  53.25 |  213 |  65 |  45 |
| `execute_preflight_insn_mi/s` |  31.22 | -          |  32.28 |  28.69 |
| `trace_gen_time_ms   ` |  175 |  700 |  209 |  152 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  275.75 |  1,103 |  288 |  271 |
| `main_trace_commit_time_ms` |  50.75 |  203 |  55 |  49 |
| `generate_perm_trace_time_ms` |  24 |  96 |  27 |  21 |
| `perm_trace_commit_time_ms` |  63.98 |  255.91 |  70.78 |  55.25 |
| `quotient_poly_compute_time_ms` |  56.33 |  225.34 |  68.35 |  47.63 |
| `quotient_poly_commit_time_ms` |  15.34 |  61.35 |  17.45 |  13.58 |
| `pcs_opening_time_ms ` |  62 |  248 |  72 |  56 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 538 | 1 | 37 | 4,137,502 | 108.81 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 209 | 713 | 23,446,148 | 150,778,428 | 209 | 288 | 0 | 58.25 | 17.45 | 5 | 70.78 | 56 | 99 | 56 | 4 | 55 | 10,899,170 | 27 | 45 | 1,103,000 | 28.69 | 22 | 76 | 1 | 56 | 
| regex_program | 1 | 152 | 532 | 11,598,276 | 128,513,066 | 152 | 272 | 1 | 47.63 | 14.99 | 4 | 65.22 | 72 | 87 | 72 | 0 | 49 | 2,196,106 | 21 | 65 | 1,104,000 | 32.16 | 16 | 63 | 0 | 72 | 
| regex_program | 2 | 160 | 530 | 11,579,064 | 128,513,066 | 160 | 271 | 1 | 51.11 | 15.33 | 4 | 64.66 | 61 | 92 | 61 | 0 | 49 | 2,177,334 | 27 | 58 | 1,104,000 | 31.76 | 17 | 67 | 0 | 61 | 
| regex_program | 3 | 179 | 538 | 11,853,872 | 103,456,394 | 179 | 272 | 0 | 68.35 | 13.58 | 5 | 55.25 | 59 | 79 | 58 | 0 | 50 | 2,422,606 | 21 | 45 | 826,502 | 32.28 | 19 | 83 | 1 | 58 | 
...
Commit: https://github.com/openvm-org/openvm/commit/e1c71cf4a7df4a7776f0437dcc2ae6c602c8dc4d
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/20325925514)

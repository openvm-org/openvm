...
| `total_proof_time_ms ` |  732 |  1,464 |  867 |  597 |
...
| `execute_metered_insn_mi/s` |  27.43 | -          |  27.43 |  27.43 |
| `execute_preflight_insns` |  872,871 |  1,745,742 |  1,149,000 |  596,742 |
| `execute_preflight_time_ms` |  83 |  166 |  105 |  61 |
| `execute_preflight_insn_mi/s` |  14.46 | -          |  17.65 |  11.27 |
| `trace_gen_time_ms   ` |  188.50 |  377 |  191 |  186 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  355 |  710 |  407 |  303 |
| `main_trace_commit_time_ms` |  62 |  124 |  70 |  54 |
| `generate_perm_trace_time_ms` |  45 |  90 |  53 |  37 |
| `perm_trace_commit_time_ms` |  76.32 |  152.65 |  88.17 |  64.47 |
| `quotient_poly_compute_time_ms` |  83.05 |  166.11 |  92.99 |  73.11 |
| `quotient_poly_commit_time_ms` |  17.50 |  34.100 |  19.98 |  15.02 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 597 | 1 | 63 | 1,745,742 | 27.43 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 186 | 867 | 32,480,114 | 172,558,444 | 186 | 407 | 0 | 92.99 | 19.98 | 6 | 88.17 | 78 | 143 | 78 | 1 | 70 | 15,909,408 | 53 | 105 | 1,149,000 | 11.27 | 27 | 113 | 1 | 78 | 
| pairing | 1 | 191 | 597 | 22,464,232 | 119,958,502 | 191 | 303 | 1 | 73.11 | 15.02 | 6 | 64.47 | 54 | 105 | 54 | 0 | 54 | 9,498,894 | 37 | 61 | 596,742 | 17.65 | 21 | 88 | 1 | 54 | 

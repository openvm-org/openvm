...
| `total_proof_time_ms ` |  739 |  1,478 |  871 |  607 |
...
| `execute_preflight_time_ms` |  82 |  164 |  104 |  60 |
| `execute_preflight_insn_mi/s` |  14.82 | -          |  18.32 |  11.33 |
| `trace_gen_time_ms   ` |  189.50 |  379 |  193 |  186 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  362.50 |  725 |  413 |  312 |
| `main_trace_commit_time_ms` |  65 |  130 |  75 |  55 |
| `generate_perm_trace_time_ms` |  46 |  92 |  53 |  39 |
| `perm_trace_commit_time_ms` |  77.03 |  154.07 |  89.23 |  64.83 |
| `quotient_poly_compute_time_ms` |  82.92 |  165.83 |  92.19 |  73.65 |
| `quotient_poly_commit_time_ms` |  17.44 |  34.87 |  19.84 |  15.03 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 607 | 1 | 63 | 1,745,742 | 27.41 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 186 | 871 | 32,480,114 | 172,558,444 | 186 | 413 | 0 | 92.19 | 19.84 | 6 | 89.23 | 79 | 145 | 79 | 1 | 75 | 15,909,408 | 53 | 104 | 1,149,000 | 11.33 | 27 | 112 | 1 | 79 | 
| pairing | 1 | 193 | 607 | 22,464,232 | 119,958,502 | 193 | 312 | 1 | 73.65 | 15.03 | 6 | 64.83 | 60 | 107 | 60 | 0 | 55 | 9,498,894 | 39 | 60 | 596,742 | 18.32 | 21 | 89 | 1 | 60 | 

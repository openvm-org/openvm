...
|:---|---:|---:|---:|
| Total |  2.43 |  0.77 | 0.77 |
| regex_program |  2.43 |  0.77 |  0.77 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  599 |  2,396 |  736 |  551 |
...
| `execute_preflight_insn_mi/s` |  30.78 | -          |  31.89 |  27.93 |
| `trace_gen_time_ms   ` |  178.25 |  713 |  209 |  156 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  292.75 |  1,171 |  310 |  280 |
| `main_trace_commit_time_ms` |  51.75 |  207 |  56 |  49 |
| `generate_perm_trace_time_ms` |  24.25 |  97 |  28 |  21 |
| `perm_trace_commit_time_ms` |  64.72 |  258.87 |  71.58 |  55.62 |
| `quotient_poly_compute_time_ms` |  60.12 |  240.46 |  71.27 |  53.94 |
| `quotient_poly_commit_time_ms` |  15.77 |  63.07 |  18.69 |  13.71 |
| `pcs_opening_time_ms ` |  72.75 |  291 |  82 |  63 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 551 | 1 | 36 | 4,137,502 | 112.62 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 209 | 736 | 23,446,148 | 150,778,428 | 209 | 310 | 0 | 60.54 | 18.69 | 5 | 71.58 | 73 | 99 | 73 | 4 | 56 | 10,899,170 | 27 | 47 | 1,103,000 | 27.93 | 22 | 80 | 1 | 73 | 
| regex_program | 1 | 156 | 557 | 11,598,276 | 128,513,066 | 156 | 293 | 1 | 54.71 | 15.54 | 4 | 66.71 | 82 | 88 | 82 | 0 | 51 | 2,196,106 | 21 | 66 | 1,104,000 | 31.89 | 17 | 70 | 0 | 82 | 
| regex_program | 2 | 164 | 552 | 11,579,064 | 128,513,066 | 164 | 288 | 1 | 53.94 | 15.12 | 5 | 64.96 | 73 | 94 | 72 | 0 | 51 | 2,177,334 | 28 | 58 | 1,104,000 | 31.79 | 16 | 69 | 0 | 72 | 
| regex_program | 3 | 184 | 551 | 11,853,872 | 103,456,394 | 184 | 280 | 0 | 71.27 | 13.71 | 5 | 55.62 | 63 | 80 | 63 | 0 | 49 | 2,422,606 | 21 | 45 | 826,502 | 31.49 | 19 | 86 | 1 | 63 | 
...
Commit: https://github.com/openvm-org/openvm/commit/91e4b5b3ec8e2fd998a8e3f5a20cb553cae0be08
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/20350927268)

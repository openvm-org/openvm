...
| `total_proof_time_ms ` |  596.75 |  2,387 |  754 |  537 |
...
| `execute_preflight_insn_mi/s` |  31.40 | -          |  32.46 |  28.48 |
| `trace_gen_time_ms   ` |  177 |  708 |  211 |  152 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  292.25 |  1,169 |  328 |  276 |
| `main_trace_commit_time_ms` |  51.25 |  205 |  57 |  49 |
| `generate_perm_trace_time_ms` |  24 |  96 |  28 |  20 |
| `perm_trace_commit_time_ms` |  64.28 |  257.14 |  71.25 |  55.58 |
| `quotient_poly_compute_time_ms` |  58.47 |  233.88 |  69.26 |  52.30 |
| `quotient_poly_commit_time_ms` |  15.59 |  62.37 |  17.55 |  14.02 |
| `pcs_opening_time_ms ` |  75 |  300 |  92 |  63 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 548 | 1 | 36 | 4,137,502 | 113.28 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 211 | 754 | 23,446,148 | 150,778,428 | 211 | 328 | 0 | 59.54 | 17.55 | 5 | 71.25 | 92 | 100 | 92 | 4 | 57 | 10,899,170 | 27 | 46 | 1,103,000 | 28.48 | 21 | 77 | 1 | 92 | 
| regex_program | 1 | 152 | 537 | 11,598,276 | 128,513,066 | 152 | 276 | 1 | 52.78 | 14.84 | 4 | 65.23 | 72 | 86 | 72 | 0 | 49 | 2,196,106 | 20 | 67 | 1,104,000 | 32.36 | 16 | 68 | 0 | 72 | 
| regex_program | 2 | 163 | 548 | 11,579,064 | 128,513,066 | 163 | 286 | 1 | 52.30 | 15.98 | 4 | 65.08 | 73 | 93 | 73 | 0 | 49 | 2,177,334 | 28 | 58 | 1,104,000 | 32.46 | 17 | 68 | 0 | 73 | 
| regex_program | 3 | 182 | 548 | 11,853,872 | 103,456,394 | 182 | 279 | 0 | 69.26 | 14.02 | 5 | 55.58 | 63 | 80 | 63 | 0 | 50 | 2,422,606 | 21 | 45 | 826,502 | 32.28 | 19 | 84 | 1 | 63 | 
...
Commit: https://github.com/openvm-org/openvm/commit/2326c54fcff1db592c5b063f65797004ed9048ac
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/20350775230)

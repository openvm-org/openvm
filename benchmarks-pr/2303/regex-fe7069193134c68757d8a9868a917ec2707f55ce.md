...
| `total_proof_time_ms ` |  591.50 |  2,366 |  729 |  543 |
...
| `execute_preflight_insn_mi/s` |  31.44 | -          |  32.52 |  28.35 |
| `trace_gen_time_ms   ` |  177.50 |  710 |  211 |  155 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  285.75 |  1,143 |  301 |  274 |
| `main_trace_commit_time_ms` |  51.75 |  207 |  57 |  50 |
| `generate_perm_trace_time_ms` |  23.50 |  94 |  28 |  20 |
| `perm_trace_commit_time_ms` |  64.34 |  257.35 |  70.72 |  55.61 |
| `quotient_poly_compute_time_ms` |  59.64 |  238.56 |  69.15 |  52.98 |
| `quotient_poly_commit_time_ms` |  15.91 |  63.62 |  18.31 |  13.82 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 543 | 1 | 37 | 4,137,502 | 110.07 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 211 | 729 | 23,446,148 | 150,778,428 | 211 | 301 | 0 | 62.27 | 18.31 | 5 | 70.72 | 67 | 95 | 66 | 4 | 57 | 10,899,170 | 24 | 47 | 1,103,000 | 28.35 | 21 | 81 | 1 | 66 | 
| regex_program | 1 | 155 | 544 | 11,598,276 | 128,513,066 | 155 | 281 | 1 | 54.16 | 15.49 | 4 | 66.37 | 72 | 87 | 72 | 0 | 50 | 2,196,106 | 20 | 66 | 1,104,000 | 32.52 | 17 | 70 | 0 | 72 | 
| regex_program | 2 | 162 | 550 | 11,579,064 | 128,513,066 | 162 | 287 | 1 | 52.98 | 15.100 | 4 | 64.65 | 73 | 93 | 73 | 0 | 50 | 2,177,334 | 28 | 59 | 1,104,000 | 32.48 | 17 | 69 | 0 | 73 | 
| regex_program | 3 | 182 | 543 | 11,853,872 | 103,456,394 | 182 | 274 | 0 | 69.15 | 13.82 | 5 | 55.61 | 58 | 81 | 57 | 0 | 50 | 2,422,606 | 22 | 45 | 826,502 | 32.41 | 19 | 84 | 1 | 57 | 
...
Commit: https://github.com/openvm-org/openvm/commit/fe7069193134c68757d8a9868a917ec2707f55ce
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/20325491680)

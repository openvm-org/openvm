...
| `total_proof_time_ms ` |  738.50 |  1,477 |  861 |  616 |
...
| `execute_metered_insn_mi/s` |  27.17 | -          |  27.17 |  27.17 |
| `execute_preflight_insns` |  872,871 |  1,745,742 |  1,149,000 |  596,742 |
| `execute_preflight_time_ms` |  84 |  168 |  107 |  61 |
| `execute_preflight_insn_mi/s` |  14.74 | -          |  18.35 |  11.12 |
| `trace_gen_time_ms   ` |  193.50 |  387 |  198 |  189 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  355.50 |  711 |  396 |  315 |
| `main_trace_commit_time_ms` |  65.50 |  131 |  76 |  55 |
| `generate_perm_trace_time_ms` |  41 |  82 |  44 |  38 |
| `perm_trace_commit_time_ms` |  77.44 |  154.88 |  89.100 |  64.88 |
| `quotient_poly_compute_time_ms` |  81.64 |  163.28 |  89.42 |  73.86 |
| `quotient_poly_commit_time_ms` |  16.37 |  32.74 |  16.80 |  15.94 |
| `pcs_opening_time_ms ` |  68.50 |  137 |  75 |  62 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 616 | 1 | 64 | 1,745,742 | 27.17 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 189 | 861 | 32,480,114 | 172,558,444 | 189 | 396 | 0 | 89.42 | 16.80 | 6 | 89.100 | 75 | 137 | 75 | 1 | 76 | 15,909,408 | 44 | 107 | 1,149,000 | 11.12 | 26 | 107 | 1 | 75 | 
| pairing | 1 | 198 | 616 | 22,464,232 | 119,958,502 | 198 | 315 | 1 | 73.86 | 15.94 | 6 | 64.88 | 62 | 106 | 61 | 0 | 55 | 9,498,894 | 38 | 61 | 596,742 | 18.35 | 21 | 90 | 1 | 61 | 

...
|:---|---:|---:|---:|
| Total |  2.47 |  0.80 | 0.80 |
| regex_program |  2.47 |  0.80 |  0.80 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  608.75 |  2,435 |  759 |  553 |
...
| `execute_preflight_time_ms` |  61.75 |  247 |  73 |  49 |
| `execute_preflight_insn_mi/s` |  29.36 | -          |  32.26 |  20.94 |
| `trace_gen_time_ms   ` |  176.25 |  705 |  203 |  155 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  294.75 |  1,179 |  317 |  282 |
| `main_trace_commit_time_ms` |  52.50 |  210 |  58 |  50 |
| `generate_perm_trace_time_ms` |  27.75 |  111 |  40 |  21 |
| `perm_trace_commit_time_ms` |  65.53 |  262.10 |  71.62 |  56.07 |
| `quotient_poly_compute_time_ms` |  61.56 |  246.23 |  70.96 |  55.15 |
| `quotient_poly_commit_time_ms` |  15.89 |  63.55 |  18.98 |  13.54 |
| `pcs_opening_time_ms ` |  67.50 |  270 |  75 |  61 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 559 | 1 | 38 | 4,137,502 | 107.84 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 203 | 759 | 23,446,148 | 150,778,428 | 203 | 317 | 0 | 64.45 | 18.98 | 6 | 71.62 | 61 | 113 | 60 | 4 | 58 | 10,899,170 | 40 | 61 | 1,103,000 | 20.94 | 22 | 84 | 1 | 60 | 
| regex_program | 1 | 155 | 553 | 11,598,276 | 128,513,066 | 155 | 284 | 1 | 55.15 | 15.56 | 5 | 67.16 | 71 | 89 | 70 | 0 | 51 | 2,196,106 | 21 | 73 | 1,104,000 | 32.26 | 17 | 71 | 0 | 70 | 
| regex_program | 2 | 162 | 564 | 11,579,064 | 128,513,066 | 162 | 296 | 1 | 55.67 | 15.46 | 5 | 67.25 | 75 | 97 | 75 | 0 | 50 | 2,177,334 | 29 | 64 | 1,104,000 | 32.18 | 17 | 71 | 0 | 75 | 
| regex_program | 3 | 185 | 559 | 11,853,872 | 103,456,394 | 185 | 282 | 1 | 70.96 | 13.54 | 5 | 56.07 | 63 | 81 | 63 | 0 | 51 | 2,422,606 | 21 | 49 | 826,502 | 32.07 | 19 | 85 | 1 | 63 | 

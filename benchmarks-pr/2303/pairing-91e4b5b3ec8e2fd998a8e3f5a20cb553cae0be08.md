...
| `total_proof_time_ms ` |  724.50 |  1,449 |  846 |  603 |
...
| `execute_preflight_time_ms` |  83 |  166 |  105 |  61 |
| `execute_preflight_insn_mi/s` |  14.73 | -          |  18.19 |  11.26 |
| `trace_gen_time_ms   ` |  188 |  376 |  192 |  184 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  346.50 |  693 |  385 |  308 |
| `main_trace_commit_time_ms` |  63.50 |  127 |  75 |  52 |
| `generate_perm_trace_time_ms` |  39 |  78 |  40 |  38 |
| `perm_trace_commit_time_ms` |  76.21 |  152.42 |  89.07 |  63.35 |
| `quotient_poly_compute_time_ms` |  82.49 |  164.97 |  90.66 |  74.31 |
| `quotient_poly_commit_time_ms` |  17.40 |  34.79 |  19.22 |  15.58 |
| `pcs_opening_time_ms ` |  63 |  126 |  67 |  59 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 603 | 1 | 63 | 1,745,742 | 27.60 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 184 | 846 | 32,480,114 | 172,558,444 | 184 | 385 | 0 | 90.66 | 19.22 | 6 | 89.07 | 67 | 132 | 67 | 1 | 75 | 15,909,408 | 40 | 105 | 1,149,000 | 11.26 | 27 | 110 | 1 | 67 | 
| pairing | 1 | 192 | 603 | 22,464,232 | 119,958,502 | 192 | 308 | 1 | 74.31 | 15.58 | 6 | 63.35 | 59 | 104 | 59 | 0 | 52 | 9,498,894 | 38 | 61 | 596,742 | 18.19 | 21 | 90 | 1 | 59 | 

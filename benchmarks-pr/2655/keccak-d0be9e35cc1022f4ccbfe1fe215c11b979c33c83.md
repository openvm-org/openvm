...
|:---|---:|---:|---:|
| Total |  18.57 |  5.24 |  5.24 |
| app_proof |  15.56 |  2.98 |  2.98 |
| leaf |  2.17 |  1.41 |  1.41 |
...
| `total_proof_time_ms ` |  2,587.17 |  15,523 |  2,945 |  2,499 |
| `execute_metered_time_ms` |  38 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  32.46 | -          |  32.46 |  32.46 |
| `execute_preflight_insns` |  205,869.67 |  1,235,218 |  207,000 |  200,218 |
| `execute_preflight_time_ms` |  183.67 |  1,102 |  269 |  17 |
| `execute_preflight_insn_mi/s` |  16.83 | -          |  16.89 |  16.70 |
| `trace_gen_time_ms   ` |  384.50 |  2,307 |  535 |  350 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,955.17 |  11,731 |  2,221 |  1,897 |
| `prover.main_trace_commit_time_ms` |  680.67 |  4,084 |  836 |  649 |
| `prover.rap_constraints_time_ms` |  1,094.83 |  6,569 |  1,205 |  1,069 |
| `prover.openings_time_ms` |  178.83 |  1,073 |  182 |  175 |
| `prover.rap_constraints.logup_gkr_time_ms` |  274.33 |  1,646 |  381 |  252 |
| `prover.rap_constraints.round0_time_ms` |  512.33 |  3,074 |  515 |  509 |
| `prover.rap_constraints.mle_rounds_time_ms` |  307 |  1,842 |  312 |  305 |
| `prover.openings.stacked_reduction_time_ms` |  137 |  822 |  139 |  136 |
| `prover.openings.stacked_reduction.round0_time_ms` |  83.17 |  499 |  84 |  82 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  53 |  318 |  55 |  52 |
| `prover.openings.whir_time_ms` |  41.17 |  247 |  43 |  38 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,083.50 |  2,167 |  1,407 |  760 |
| `execute_preflight_time_ms` |  4.50 |  9 |  5 |  4 |
| `trace_gen_time_ms   ` |  137 |  274 |  185 |  89 |
| `generate_blob_total_time_ms` |  25.50 |  51 |  34 |  17 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  945.50 |  1,891 |  1,221 |  670 |
| `prover.main_trace_commit_time_ms` |  538 |  1,076 |  707 |  369 |
| `prover.rap_constraints_time_ms` |  302.50 |  605 |  387 |  218 |
| `prover.openings_time_ms` |  104.50 |  209 |  127 |  82 |
| `prover.rap_constraints.logup_gkr_time_ms` |  66 |  132 |  82 |  50 |
| `prover.rap_constraints.round0_time_ms` |  145 |  290 |  189 |  101 |
| `prover.rap_constraints.mle_rounds_time_ms` |  90.50 |  181 |  115 |  66 |
...
| `prover.openings.whir_time_ms` |  37 |  74 |  43 |  31 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/d0be9e35cc1022f4ccbfe1fe215c11b979c33c83/keccak-d0be9e35cc1022f4ccbfe1fe215c11b979c33c83.memory.svg)
...
| app_proof |  |  |  |  |  | 2,504 |  |  | 38 | 1,235,218 | 32.46 | 0 | 15,567 |  | 
| internal_for_leaf |  |  |  | 514 |  |  |  |  |  |  |  |  |  | 515 | 
...
| internal_recursive.0 | 1 | 13 | 182 | 13 | 2 | 1 | 2 | 1 | 2 | 
| internal_recursive.1 | 1 | 9 | 149 | 8 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 |
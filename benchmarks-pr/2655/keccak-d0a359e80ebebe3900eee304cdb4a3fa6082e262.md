...
|:---|---:|---:|---:|
| Total |  18.62 |  5.25 |  5.25 |
| app_proof |  15.60 |  2.100 |  2.100 |
| leaf |  2.18 |  1.42 |  1.42 |
| internal_for_leaf |  0.51 |  0.51 |  0.51 |
...
| `total_proof_time_ms ` |  2,594.17 |  15,565 |  2,960 |  2,502 |
| `execute_metered_time_ms` |  36 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  33.59 | -          |  33.59 |  33.59 |
| `execute_preflight_insns` |  205,869.67 |  1,235,218 |  207,000 |  200,218 |
| `execute_preflight_time_ms` |  180.50 |  1,083 |  264 |  15 |
| `execute_preflight_insn_mi/s` |  19.58 | -          |  19.70 |  19.41 |
| `trace_gen_time_ms   ` |  386.17 |  2,317 |  539 |  350 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,963.83 |  11,783 |  2,235 |  1,902 |
| `prover.main_trace_commit_time_ms` |  685.33 |  4,112 |  846 |  652 |
| `prover.rap_constraints_time_ms` |  1,098 |  6,588 |  1,206 |  1,074 |
| `prover.openings_time_ms` |  179.50 |  1,077 |  182 |  173 |
| `prover.rap_constraints.logup_gkr_time_ms` |  274.83 |  1,649 |  383 |  253 |
| `prover.rap_constraints.round0_time_ms` |  512.67 |  3,076 |  514 |  511 |
| `prover.rap_constraints.mle_rounds_time_ms` |  309.67 |  1,858 |  311 |  309 |
| `prover.openings.stacked_reduction_time_ms` |  137.33 |  824 |  141 |  134 |
| `prover.openings.stacked_reduction.round0_time_ms` |  83.33 |  500 |  84 |  81 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  53.83 |  323 |  57 |  52 |
| `prover.openings.whir_time_ms` |  41.67 |  250 |  43 |  39 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,089 |  2,178 |  1,416 |  762 |
| `execute_preflight_time_ms` |  4.50 |  9 |  5 |  4 |
| `trace_gen_time_ms   ` |  140 |  280 |  190 |  90 |
| `generate_blob_total_time_ms` |  25.50 |  51 |  34 |  17 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  949 |  1,898 |  1,226 |  672 |
| `prover.main_trace_commit_time_ms` |  541 |  1,082 |  712 |  370 |
| `prover.rap_constraints_time_ms` |  303 |  606 |  390 |  216 |
| `prover.openings_time_ms` |  104 |  208 |  123 |  85 |
| `prover.rap_constraints.logup_gkr_time_ms` |  65.50 |  131 |  81 |  50 |
| `prover.rap_constraints.round0_time_ms` |  145 |  290 |  190 |  100 |
| `prover.rap_constraints.mle_rounds_time_ms` |  91.50 |  183 |  118 |  65 |
| `prover.openings.stacked_reduction_time_ms` |  67.50 |  135 |  84 |  51 |
...
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  473 |  473 |  473 |  473 |
| `prover.main_trace_commit_time_ms` |  244 |  244 |  244 |  244 |
| `prover.rap_constraints_time_ms` |  169 |  169 |  169 |  169 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/d0a359e80ebebe3900eee304cdb4a3fa6082e262/keccak-d0a359e80ebebe3900eee304cdb4a3fa6082e262.memory.svg)
...
| app_proof |  |  |  |  |  | 2,510 |  |  | 36 | 1,235,218 | 33.59 | 0 | 15,610 |  | 
| internal_for_leaf |  |  |  | 511 |  |  |  |  |  |  |  |  |  | 511 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 38 |
...
| `total_proof_time_ms ` |  715.50 |  1,431 |  835 |  596 |
| `execute_metered_time_ms` |  68 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  25.63 | -          |  25.63 |  25.63 |
| `execute_preflight_insns` |  872,878.50 |  1,745,757 |  1,151,000 |  594,757 |
| `execute_preflight_time_ms` |  86.50 |  173 |  126 |  47 |
| `execute_preflight_insn_mi/s` |  14.48 | -          |  17.93 |  11.02 |
| `trace_gen_time_ms   ` |  181 |  362 |  204 |  158 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  342.50 |  685 |  383 |  302 |
| `main_trace_commit_time_ms` |  62.50 |  125 |  71 |  54 |
| `generate_perm_trace_time_ms` |  39 |  78 |  43 |  35 |
| `perm_trace_commit_time_ms` |  76.95 |  153.89 |  89.31 |  64.58 |
| `quotient_poly_compute_time_ms` |  82.18 |  164.37 |  91.38 |  72.99 |
| `quotient_poly_commit_time_ms` |  17.27 |  34.54 |  19.53 |  15.01 |
| `pcs_opening_time_ms ` |  60 |  120 |  64 |  56 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 596 | 1 | 68 | 1,745,757 | 25.63 | 0 | 
...
| pairing | VmAirWrapper<Rv32VecHeapAdapterAir<1, 3, 3, 32, 32>, FieldExpressionCoreAir> | 2 | 1,165 | 1,279 | 
| pairing | VmAirWrapper<Rv32VecHeapAdapterAir<2, 1, 1, 32, 32>, FieldExpressionCoreAir> | 2 | 158 | 190 | 
| pairing | VmAirWrapper<Rv32VecHeapAdapterAir<2, 2, 2, 32, 32>, FieldExpressionCoreAir> | 2 | 299 | 329 | 
| pairing | VmAirWrapper<Rv32VecHeapAdapterAir<2, 3, 3, 32, 32>, FieldExpressionCoreAir> | 2 | 1,471 | 1,597 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 158 | 835 | 172,558,444 | 158 | 383 | 0 | 91.38 | 19.53 | 6 | 89.31 | 64 | 135 | 64 | 1 | 71 | 43 | 126 | 1,151,000 | 11.02 | 27 | 111 | 1 | 64 | 
| pairing | 1 | 204 | 596 | 119,958,502 | 204 | 302 | 1 | 72.99 | 15.01 | 6 | 64.58 | 56 | 103 | 56 | 0 | 54 | 35 | 47 | 594,757 | 17.93 | 20 | 88 | 1 | 55 | 

...
|:---|---:|---:|---:|
| Total |  2.40 |  0.77 | 0.77 |
| regex_program |  2.40 |  0.77 |  0.77 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  592 |  2,368 |  737 |  525 |
| `execute_metered_time_ms` |  36 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  112.52 | -          |  112.52 |  112.52 |
| `execute_preflight_insns` |  1,034,410 |  4,137,640 |  1,104,000 |  826,640 |
| `execute_preflight_time_ms` |  44 |  176 |  55 |  33 |
| `execute_preflight_insn_mi/s` |  32.99 | -          |  33.52 |  32.05 |
| `trace_gen_time_ms   ` |  182.50 |  730 |  202 |  173 |
| `memory_finalize_time_ms` |  0.75 |  3 |  3 |  0 |
| `stark_prove_excluding_trace_time_ms` |  292 |  1,168 |  339 |  262 |
| `main_trace_commit_time_ms` |  52.50 |  210 |  58 |  50 |
| `generate_perm_trace_time_ms` |  23.75 |  95 |  32 |  18 |
| `perm_trace_commit_time_ms` |  65.21 |  260.84 |  71.46 |  56.82 |
| `quotient_poly_compute_time_ms` |  60.81 |  243.24 |  71.71 |  54.28 |
| `quotient_poly_commit_time_ms` |  15.71 |  62.86 |  18.28 |  13.19 |
| `pcs_opening_time_ms ` |  70.50 |  282 |  102 |  51 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 570 | 1 | 36 | 4,137,640 | 112.52 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 173 | 737 | 150,778,428 | 173 | 339 | 0 | 62.94 | 18.28 | 5 | 71.46 | 102 | 96 | 101 | 3 | 58 | 23 | 55 | 1,103,000 | 32.05 | 21 | 81 | 1 | 101 | 
| regex_program | 1 | 177 | 525 | 128,513,066 | 177 | 262 | 1 | 54.31 | 15.94 | 5 | 66.40 | 51 | 89 | 50 | 0 | 51 | 22 | 44 | 1,104,000 | 33.16 | 17 | 70 | 0 | 50 | 
| regex_program | 2 | 178 | 536 | 128,513,066 | 178 | 273 | 1 | 54.28 | 15.43 | 4 | 66.17 | 66 | 85 | 66 | 0 | 51 | 18 | 44 | 1,104,000 | 33.52 | 17 | 70 | 0 | 66 | 
| regex_program | 3 | 202 | 570 | 103,475,717 | 202 | 294 | 0 | 71.71 | 13.19 | 6 | 56.82 | 63 | 93 | 63 | 0 | 50 | 32 | 33 | 826,640 | 33.22 | 20 | 85 | 1 | 63 | 

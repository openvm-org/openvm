...
| `total_proof_time_ms ` |  733.50 |  1,467 |  874 |  593 |
...
| `execute_preflight_time_ms` |  86.50 |  173 |  125 |  48 |
| `execute_preflight_insn_mi/s` |  14.34 | -          |  17.56 |  11.12 |
| `trace_gen_time_ms   ` |  179.50 |  359 |  201 |  158 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  362 |  724 |  421 |  303 |
| `main_trace_commit_time_ms` |  65 |  130 |  75 |  55 |
| `generate_perm_trace_time_ms` |  35.50 |  71 |  36 |  35 |
| `perm_trace_commit_time_ms` |  76.91 |  153.83 |  89.10 |  64.72 |
| `quotient_poly_compute_time_ms` |  82.91 |  165.82 |  92.22 |  73.60 |
| `quotient_poly_commit_time_ms` |  17.61 |  35.22 |  19.84 |  15.38 |
| `pcs_opening_time_ms ` |  79 |  158 |  104 |  54 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 593 | 1 | 68 | 1,745,757 | 25.39 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 158 | 874 | 172,558,444 | 157 | 421 | 0 | 92.22 | 19.84 | 6 | 89.10 | 104 | 128 | 104 | 1 | 75 | 36 | 125 | 1,151,000 | 11.12 | 27 | 112 | 1 | 104 | 
| pairing | 1 | 201 | 593 | 119,958,502 | 201 | 303 | 1 | 73.60 | 15.38 | 5 | 64.72 | 54 | 103 | 54 | 0 | 55 | 35 | 48 | 594,757 | 17.56 | 21 | 89 | 1 | 54 | 

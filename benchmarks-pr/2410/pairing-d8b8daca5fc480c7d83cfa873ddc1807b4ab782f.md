...
|:---|---:|---:|---:|
| Total |  1.51 |  0.91 | 0.91 |
| pairing |  1.51 |  0.91 |  0.91 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  722.50 |  1,445 |  845 |  600 |
...
| `execute_preflight_time_ms` |  88 |  176 |  127 |  49 |
| `execute_preflight_insn_mi/s` |  14.32 | -          |  17.69 |  10.96 |
| `trace_gen_time_ms   ` |  181 |  362 |  205 |  157 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  347.50 |  695 |  390 |  305 |
| `main_trace_commit_time_ms` |  63.50 |  127 |  72 |  55 |
| `generate_perm_trace_time_ms` |  39.50 |  79 |  44 |  35 |
| `perm_trace_commit_time_ms` |  77.13 |  154.26 |  89.18 |  65.08 |
| `quotient_poly_compute_time_ms` |  84.31 |  168.63 |  95.10 |  73.52 |
| `quotient_poly_commit_time_ms` |  17.62 |  35.23 |  19.97 |  15.26 |
| `pcs_opening_time_ms ` |  60 |  120 |  65 |  55 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 600 | 1 | 67 | 1,745,757 | 25.69 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 157 | 845 | 172,558,444 | 156 | 390 | 0 | 95.10 | 19.97 | 6 | 89.18 | 65 | 136 | 65 | 1 | 72 | 44 | 127 | 1,151,000 | 10.96 | 27 | 115 | 1 | 65 | 
| pairing | 1 | 205 | 600 | 119,958,502 | 205 | 305 | 1 | 73.52 | 15.26 | 6 | 65.08 | 55 | 103 | 55 | 0 | 55 | 35 | 49 | 594,757 | 17.69 | 21 | 89 | 1 | 55 | 

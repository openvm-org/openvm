...
| `total_proof_time_ms ` |  730 |  1,460 |  863 |  597 |
| `execute_metered_time_ms` |  67 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  25.72 | -          |  25.72 |  25.72 |
| `execute_preflight_insns` |  872,878.50 |  1,745,757 |  1,151,000 |  594,757 |
| `execute_preflight_time_ms` |  87.50 |  175 |  127 |  48 |
| `execute_preflight_insn_mi/s` |  14.32 | -          |  17.57 |  11.08 |
| `trace_gen_time_ms   ` |  180 |  360 |  203 |  157 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  357.50 |  715 |  411 |  304 |
| `main_trace_commit_time_ms` |  64.50 |  129 |  74 |  55 |
| `generate_perm_trace_time_ms` |  35 |  70 |  35 |  35 |
| `perm_trace_commit_time_ms` |  76.86 |  153.72 |  88.72 |  64.99 |
| `quotient_poly_compute_time_ms` |  83.08 |  166.17 |  92.46 |  73.71 |
| `quotient_poly_commit_time_ms` |  16.100 |  33.99 |  18.57 |  15.43 |
| `pcs_opening_time_ms ` |  75.50 |  151 |  97 |  54 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 597 | 1 | 67 | 1,745,757 | 25.72 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 157 | 863 | 172,558,444 | 157 | 411 | 0 | 92.46 | 18.57 | 6 | 88.72 | 97 | 126 | 96 | 1 | 74 | 35 | 127 | 1,151,000 | 11.08 | 27 | 111 | 1 | 96 | 
| pairing | 1 | 203 | 597 | 119,958,502 | 203 | 304 | 1 | 73.71 | 15.43 | 6 | 64.99 | 54 | 103 | 54 | 0 | 55 | 35 | 48 | 594,757 | 17.57 | 21 | 89 | 1 | 54 | 

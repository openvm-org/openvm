...
| `total_proof_time_ms ` |  538.50 |  1,077 |  619 |  458 |
| `execute_metered_time_ms` |  9 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  163.30 | -          |  163.30 |  163.30 |
| `execute_preflight_insns` |  750,132.50 |  1,500,265 |  873,000 |  627,265 |
| `execute_preflight_time_ms` |  27 |  54 |  32 |  22 |
| `execute_preflight_insn_mi/s` |  38.55 | -          |  38.93 |  38.17 |
| `trace_gen_time_ms   ` |  193.50 |  387 |  197 |  190 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  212.50 |  425 |  228 |  197 |
| `main_trace_commit_time_ms` |  30.50 |  61 |  33 |  28 |
| `generate_perm_trace_time_ms` |  21 |  42 |  28 |  14 |
| `perm_trace_commit_time_ms` |  41.31 |  82.62 |  44.94 |  37.68 |
| `quotient_poly_compute_time_ms` |  32.56 |  65.13 |  34.52 |  30.60 |
| `quotient_poly_commit_time_ms` |  12.84 |  25.68 |  13.43 |  12.25 |
| `pcs_opening_time_ms ` |  72 |  144 |  85 |  59 |
...
| --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 458 | 1 | 9 | 1,500,265 | 163.30 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 190 | 619 | 84,399,632 | 190 | 228 | 0 | 34.52 | 13.43 | 4 | 44.94 | 85 | 59 | 85 | 0 | 33 | 14 | 32 | 873,000 | 38.93 | 15 | 48 | 0 | 85 | 
| fibonacci_program | 1 | 197 | 458 | 74,305,770 | 197 | 197 | 1 | 30.60 | 12.25 | 4 | 37.68 | 59 | 66 | 58 | 0 | 28 | 28 | 22 | 627,265 | 38.17 | 11 | 43 | 0 | 58 | 

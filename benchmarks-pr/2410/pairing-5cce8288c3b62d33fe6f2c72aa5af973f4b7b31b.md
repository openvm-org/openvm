...
|:---|---:|---:|---:|
| Total |  1.56 |  0.91 | 0.91 |
| pairing |  1.56 |  0.91 |  0.91 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  746 |  1,492 |  847 |  645 |
...
| `execute_preflight_time_ms` |  87 |  174 |  126 |  48 |
| `execute_preflight_insn_mi/s` |  14.21 | -          |  17.37 |  11.06 |
| `trace_gen_time_ms   ` |  179 |  358 |  201 |  157 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  374 |  748 |  394 |  354 |
| `main_trace_commit_time_ms` |  63.50 |  127 |  74 |  53 |
| `generate_perm_trace_time_ms` |  58 |  116 |  74 |  42 |
| `perm_trace_commit_time_ms` |  76.38 |  152.77 |  88.86 |  63.91 |
| `quotient_poly_compute_time_ms` |  82.15 |  164.30 |  91.97 |  72.33 |
| `quotient_poly_commit_time_ms` |  17.33 |  34.65 |  20.03 |  14.63 |
| `pcs_opening_time_ms ` |  72 |  144 |  72 |  72 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 645 | 1 | 67 | 1,745,757 | 25.86 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 157 | 847 | 172,558,444 | 157 | 394 | 0 | 91.97 | 20.03 | 6 | 88.86 | 72 | 133 | 72 | 1 | 74 | 42 | 126 | 1,151,000 | 11.06 | 27 | 112 | 1 | 72 | 
| pairing | 1 | 201 | 645 | 119,958,502 | 201 | 354 | 1 | 72.33 | 14.63 | 6 | 63.91 | 72 | 141 | 71 | 0 | 53 | 74 | 48 | 594,757 | 17.37 | 21 | 87 | 1 | 71 | 

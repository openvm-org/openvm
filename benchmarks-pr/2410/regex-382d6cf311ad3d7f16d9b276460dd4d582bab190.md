...
|:---|---:|---:|---:|
| Total |  2.41 |  0.74 | 0.74 |
| regex_program |  2.41 |  0.74 |  0.74 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  593.75 |  2,375 |  700 |  541 |
| `execute_metered_time_ms` |  36 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  114.35 | -          |  114.35 |  114.35 |
| `execute_preflight_insns` |  1,034,431.75 |  4,137,727 |  1,104,000 |  826,727 |
| `execute_preflight_time_ms` |  44.25 |  177 |  55 |  33 |
| `execute_preflight_insn_mi/s` |  32.95 | -          |  33.74 |  31.90 |
| `trace_gen_time_ms   ` |  180.50 |  722 |  200 |  172 |
| `memory_finalize_time_ms` |  0.75 |  3 |  3 |  0 |
| `stark_prove_excluding_trace_time_ms` |  296 |  1,184 |  320 |  279 |
| `main_trace_commit_time_ms` |  51.50 |  206 |  56 |  49 |
| `generate_perm_trace_time_ms` |  42 |  168 |  85 |  22 |
| `perm_trace_commit_time_ms` |  64.36 |  257.44 |  69.92 |  54.98 |
| `quotient_poly_compute_time_ms` |  60.75 |  242.100 |  73.89 |  52.96 |
| `quotient_poly_commit_time_ms` |  16.09 |  64.35 |  18.13 |  13.57 |
| `pcs_opening_time_ms ` |  57.75 |  231 |  68 |  49 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 553 | 1 | 36 | 4,137,727 | 114.35 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 172 | 700 | 150,778,428 | 172 | 305 | 0 | 62.40 | 18.13 | 5 | 69.92 | 59 | 107 | 59 | 3 | 56 | 36 | 55 | 1,103,000 | 32.47 | 21 | 81 | 1 | 59 | 
| regex_program | 1 | 175 | 581 | 128,513,066 | 175 | 320 | 1 | 52.96 | 16.33 | 4 | 65.42 | 49 | 151 | 49 | 0 | 49 | 85 | 44 | 1,104,000 | 33.74 | 17 | 69 | 0 | 49 | 
| regex_program | 2 | 175 | 541 | 128,513,066 | 175 | 280 | 1 | 53.76 | 16.31 | 4 | 67.11 | 68 | 90 | 68 | 0 | 50 | 22 | 45 | 1,104,000 | 31.90 | 17 | 70 | 0 | 68 | 
| regex_program | 3 | 200 | 553 | 103,475,717 | 200 | 279 | 0 | 73.89 | 13.57 | 5 | 54.98 | 55 | 83 | 54 | 0 | 51 | 25 | 33 | 826,727 | 33.69 | 20 | 88 | 1 | 54 | 

...
| `total_proof_time_ms ` |  534.50 |  1,069 |  612 |  457 |
| `execute_metered_time_ms` |  9 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  159.67 | -          |  159.67 |  159.67 |
| `execute_preflight_insns` |  750,132.50 |  1,500,265 |  873,000 |  627,265 |
| `execute_preflight_time_ms` |  27 |  54 |  32 |  22 |
| `execute_preflight_insn_mi/s` |  38.63 | -          |  39.27 |  37.99 |
| `trace_gen_time_ms   ` |  191.50 |  383 |  195 |  188 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  209 |  418 |  220 |  198 |
| `main_trace_commit_time_ms` |  30.50 |  61 |  33 |  28 |
| `generate_perm_trace_time_ms` |  21.50 |  43 |  29 |  14 |
| `perm_trace_commit_time_ms` |  41.43 |  82.87 |  44.82 |  38.04 |
| `quotient_poly_compute_time_ms` |  30.77 |  61.54 |  33.71 |  27.83 |
| `quotient_poly_commit_time_ms` |  12.76 |  25.51 |  13.07 |  12.44 |
| `pcs_opening_time_ms ` |  69.50 |  139 |  79 |  60 |
...
| --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 457 | 1 | 9 | 1,500,265 | 159.67 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 188 | 612 | 84,399,632 | 188 | 220 | 0 | 33.71 | 13.07 | 5 | 44.82 | 79 | 59 | 78 | 0 | 33 | 14 | 32 | 873,000 | 39.27 | 15 | 47 | 0 | 78 | 
| fibonacci_program | 1 | 195 | 457 | 74,305,770 | 195 | 198 | 1 | 27.83 | 12.44 | 4 | 38.04 | 60 | 68 | 59 | 0 | 28 | 29 | 22 | 627,265 | 37.99 | 11 | 40 | 0 | 59 | 

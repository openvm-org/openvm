...
| `total_proof_time_ms ` |  523 |  1,046 |  605 |  441 |
| `execute_metered_time_ms` |  9 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  161.08 | -          |  161.08 |  161.08 |
| `execute_preflight_insns` |  750,132.50 |  1,500,265 |  873,000 |  627,265 |
| `execute_preflight_time_ms` |  27 |  54 |  32 |  22 |
| `execute_preflight_insn_mi/s` |  38.60 | -          |  39.16 |  38.04 |
| `trace_gen_time_ms   ` |  195.50 |  391 |  199 |  192 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  195.50 |  391 |  213 |  178 |
| `main_trace_commit_time_ms` |  30.50 |  61 |  33 |  28 |
| `generate_perm_trace_time_ms` |  22 |  44 |  28 |  16 |
| `perm_trace_commit_time_ms` |  41.40 |  82.80 |  44.99 |  37.80 |
| `quotient_poly_compute_time_ms` |  33.52 |  67.05 |  36.50 |  30.54 |
| `quotient_poly_commit_time_ms` |  13.03 |  26.07 |  13.28 |  12.79 |
| `pcs_opening_time_ms ` |  53 |  106 |  67 |  39 |
...
| --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 441 | 1 | 9 | 1,500,265 | 161.08 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 192 | 605 | 84,399,632 | 192 | 213 | 0 | 36.50 | 13.28 | 4 | 44.99 | 67 | 61 | 67 | 0 | 33 | 16 | 32 | 873,000 | 39.16 | 15 | 50 | 0 | 67 | 
| fibonacci_program | 1 | 199 | 441 | 74,305,770 | 199 | 178 | 1 | 30.54 | 12.79 | 4 | 37.80 | 39 | 66 | 38 | 0 | 28 | 28 | 22 | 627,265 | 38.04 | 11 | 43 | 0 | 38 | 

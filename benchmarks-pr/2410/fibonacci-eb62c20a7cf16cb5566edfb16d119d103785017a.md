...
|:---|---:|---:|---:|
| Total |  1.11 |  0.62 | 0.62 |
| fibonacci_program |  1.11 |  0.62 |  0.62 |


| fibonacci_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  549.50 |  1,099 |  613 |  486 |
| `execute_metered_time_ms` |  9 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  163.07 | -          |  163.07 |  163.07 |
| `execute_preflight_insns` |  750,132.50 |  1,500,265 |  873,000 |  627,265 |
| `execute_preflight_time_ms` |  26.50 |  53 |  31 |  22 |
| `execute_preflight_insn_mi/s` |  39.21 | -          |  39.100 |  38.42 |
| `trace_gen_time_ms   ` |  194.50 |  389 |  197 |  192 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  222.50 |  445 |  226 |  219 |
| `main_trace_commit_time_ms` |  30.50 |  61 |  33 |  28 |
| `generate_perm_trace_time_ms` |  21.50 |  43 |  29 |  14 |
| `perm_trace_commit_time_ms` |  41.94 |  83.88 |  45.16 |  38.72 |
| `quotient_poly_compute_time_ms` |  31.05 |  62.10 |  34.21 |  27.89 |
| `quotient_poly_commit_time_ms` |  12.09 |  24.17 |  12.31 |  11.86 |
| `pcs_opening_time_ms ` |  83 |  166 |  88 |  78 |
...
| --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 486 | 1 | 9 | 1,500,265 | 163.07 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 192 | 613 | 84,399,632 | 192 | 219 | 0 | 34.21 | 12.31 | 4 | 45.16 | 78 | 60 | 78 | 0 | 33 | 14 | 31 | 873,000 | 39.100 | 14 | 47 | 0 | 78 | 
| fibonacci_program | 1 | 197 | 486 | 74,305,770 | 197 | 226 | 1 | 27.89 | 11.86 | 4 | 38.72 | 88 | 68 | 88 | 0 | 28 | 29 | 22 | 627,265 | 38.42 | 11 | 40 | 0 | 88 | 

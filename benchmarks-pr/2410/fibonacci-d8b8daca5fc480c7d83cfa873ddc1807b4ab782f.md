...
| `total_proof_time_ms ` |  523.50 |  1,047 |  603 |  444 |
| `execute_metered_time_ms` |  9 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  154.70 | -          |  154.70 |  154.70 |
| `execute_preflight_insns` |  750,132.50 |  1,500,265 |  873,000 |  627,265 |
| `execute_preflight_time_ms` |  28 |  56 |  33 |  23 |
| `execute_preflight_insn_mi/s` |  36.76 | -          |  37.30 |  36.21 |
| `trace_gen_time_ms   ` |  195 |  390 |  198 |  192 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  195.50 |  391 |  209 |  182 |
| `main_trace_commit_time_ms` |  30.50 |  61 |  33 |  28 |
| `generate_perm_trace_time_ms` |  21.50 |  43 |  28 |  15 |
| `perm_trace_commit_time_ms` |  41.85 |  83.71 |  45.03 |  38.68 |
| `quotient_poly_compute_time_ms` |  31.65 |  63.31 |  35.39 |  27.92 |
| `quotient_poly_commit_time_ms` |  12.37 |  24.73 |  12.58 |  12.16 |
| `pcs_opening_time_ms ` |  55 |  110 |  66 |  44 |
...
| --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 444 | 1 | 9 | 1,500,265 | 154.70 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 192 | 603 | 84,399,632 | 192 | 209 | 0 | 35.39 | 12.58 | 4 | 45.03 | 66 | 60 | 66 | 0 | 33 | 15 | 33 | 873,000 | 37.30 | 14 | 48 | 0 | 66 | 
| fibonacci_program | 1 | 198 | 444 | 74,305,770 | 198 | 182 | 1 | 27.92 | 12.16 | 4 | 38.68 | 44 | 67 | 44 | 0 | 28 | 28 | 23 | 627,265 | 36.21 | 11 | 40 | 0 | 44 | 

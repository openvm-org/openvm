...
|:---|---:|---:|---:|
| Total |  9.94 |  4.34 |  4.34 |
| app_proof |  8.40 |  2.80 |  2.80 |
| leaf |  0.92 |  0.92 |  0.92 |
...
| `total_proof_time_ms ` |  2,075 |  8,300 |  2,703 |  649 |
| `execute_metered_time_ms` |  95 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  116.70 | -          |  116.70 |  116.70 |
| `execute_preflight_insns` |  2,791,990.25 |  11,167,961 |  3,562,000 |  481,961 |
| `execute_preflight_time_ms` |  167.25 |  669 |  271 |  31 |
| `execute_preflight_insn_mi/s` |  34.32 | -          |  35.54 |  32.36 |
| `trace_gen_time_ms   ` |  116.25 |  465 |  185 |  66 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,718.25 |  6,873 |  2,263 |  391 |
| `prover.main_trace_commit_time_ms` |  464.75 |  1,859 |  691 |  89 |
| `prover.rap_constraints_time_ms` |  1,127.75 |  4,511 |  1,422 |  254 |
| `prover.openings_time_ms` |  125 |  500 |  152 |  47 |
| `prover.rap_constraints.logup_gkr_time_ms` |  340.25 |  1,361 |  430 |  80 |
| `prover.rap_constraints.round0_time_ms` |  529.50 |  2,118 |  666 |  122 |
| `prover.rap_constraints.mle_rounds_time_ms` |  257.25 |  1,029 |  327 |  51 |
| `prover.openings.stacked_reduction_time_ms` |  91.50 |  366 |  115 |  25 |
| `prover.openings.stacked_reduction.round0_time_ms` |  50.25 |  201 |  65 |  9 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  40.75 |  163 |  51 |  16 |
| `prover.openings.whir_time_ms` |  33 |  132 |  37 |  22 |
...
| `prover.openings.stacked_reduction_time_ms` |  55 |  55 |  55 |  55 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/e592b7583bbd8494cfd51a6cc37b94b6c954bef6/sha2_bench-e592b7583bbd8494cfd51a6cc37b94b6c954bef6.memory.svg)
...
| app_proof |  |  |  |  |  | 649 |  |  | 95 | 11,167,961 | 116.70 | 0 | 8,402 |  | 
| internal_for_leaf |  |  |  | 298 |  |  |  |  |  |  |  |  |  | 298 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,577,915 | 278 | 119 | 0 | 7 | 111 | 34 | 33 | 51 | 25 | 0 | 47 | 18 | 28 | 3 | 25 | 119 | 111 | 0 | 2 | 25 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,703 | 161 | 48 | 0 | 4 | 71 | 23 | 23 | 28 | 19 | 0 | 41 | 17 | 23 | 1 | 21 | 48 | 71 | 0 | 2 | 18 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 141 | 34 | 0 | 4 | 65 | 22 | 21 | 24 | 18 | 0 | 42 | 19 | 22 | 1 | 21 | 34 | 64 | 0 | 2 | 17 | 0 | 0 | 
| leaf | 0 | prover | 267,458,790 | 789 | 410 | 0 | 26 | 286 | 129 | 128 | 80 | 76 | 0 | 91 | 36 | 55 | 22 | 33 | 410 | 286 | 0 | 5 | 75 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 686,312,761 | 2,263 | 691 | 0 | 198 | 1,419 | 665 | 664 | 326 | 428 | 108 | 152 | 37 | 115 | 63 | 51 | 691 | 1,419 | 0 | 3 | 319 | 0 | 0 | 
| app_proof | prover | 1 | 686,312,460 | 2,113 | 539 | 0 | 41 | 1,422 | 665 | 664 | 327 | 430 | 125 | 151 | 37 | 113 | 64 | 48 | 539 | 1,422 | 0 | 3 | 304 | 0 | 0 | 
| app_proof | prover | 2 | 686,312,460 | 2,106 | 540 | 0 | 42 | 1,416 | 666 | 665 | 325 | 423 | 119 | 150 | 36 | 113 | 65 | 48 | 540 | 1,415 | 0 | 3 | 303 | 0 | 0 | 
| app_proof | prover | 3 | 106,273,044 | 391 | 89 | 0 | 7 | 254 | 122 | 122 | 51 | 80 | 0 | 47 | 22 | 25 | 9 | 16 | 89 | 254 | 0 | 3 | 79 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 147 | 2,703 | 147 | 162 | 0 | 3 | 128 | 3,562,000 | 32.36 | 
| app_proof | 1 | 66 | 2,493 | 66 | 41 | 0 | 1 | 271 | 3,562,000 | 35.54 | 
| app_proof | 2 | 67 | 2,455 | 67 | 41 | 0 | 1 | 239 | 3,562,000 | 35.51 | 
| app_proof | 3 | 185 | 649 | 185 | 41 | 0 | 1 | 31 | 481,961 | 33.88 | 

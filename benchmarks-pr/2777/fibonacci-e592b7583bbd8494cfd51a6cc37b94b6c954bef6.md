...
| `total_proof_time_ms ` |  472.25 |  1,889 |  613 |  332 |
...
| `execute_preflight_time_ms` |  35.50 |  142 |  51 |  4 |
| `execute_preflight_insn_mi/s` |  40.59 | -          |  41.94 |  37.29 |
| `trace_gen_time_ms   ` |  181.50 |  726 |  208 |  166 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  182 |  728 |  226 |  78 |
| `prover.main_trace_commit_time_ms` |  44.25 |  177 |  54 |  16 |
| `prover.rap_constraints_time_ms` |  102 |  408 |  130 |  34 |
| `prover.openings_time_ms` |  35 |  140 |  41 |  27 |
| `prover.rap_constraints.logup_gkr_time_ms` |  64.75 |  259 |  82 |  17 |
| `prover.rap_constraints.round0_time_ms` |  22.75 |  91 |  31 |  9 |
...
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  9.50 |  38 |  13 |  7 |
| `prover.openings.whir_time_ms` |  20.75 |  83 |  22 |  19 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/e592b7583bbd8494cfd51a6cc37b94b6c954bef6/fibonacci-e592b7583bbd8494cfd51a6cc37b94b6c954bef6.memory.svg)

| Module | Max (GB) | Max At |
| --- | ---: | --- |
| generate mem proving ctxs | 4.83 | app_proof.0 |
| set initial memory | 4.83 | app_proof.1 |
| prover.rap_constraints | 2.79 | leaf.0.prover |
...
| frac_sumcheck.segment_tree | 2.62 | leaf.0.prover |
| prover.gkr_input_evals | 2.62 | leaf.0.prover |
...
| 23 | VmAirWrapper<Rv64BaseAluAdapterAir, AddSubCoreAir<8, 8> | 24 | 31 | 3 | 
| 24 | BitwiseOperationLookupAir<8> | 2 | 19 | 2 | 
| 25 | PhantomAir | 3 |  | 1 | 
| 26 | Poseidon2PeripheryAir<BabyBearParameters>, 1> | 1 | 282 | 3 | 
| 27 | VariableRangeCheckerAir | 1 | 10 | 3 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 71 | 9 |  |  | 0 |  | 355 | 9 |  |  |  |  |  |  | 
| app_proof |  |  |  |  |  | 332 |  |  | 20 | 4,000,051 | 199.52 | 0 | 1,915 |  | 
...
| app_proof | 22 | VmAirWrapper<Rv64BaseAluAdapterAir, XorOrAndCoreAir<8, 8> | prover | 0 | 2 | 50 | 100 | 
| app_proof | 23 | VmAirWrapper<Rv64BaseAluAdapterAir, AddSubCoreAir<8, 8> | prover | 0 | 1,048,576 | 49 | 51,380,224 | 
...
| app_proof | 23 | VmAirWrapper<Rv64BaseAluAdapterAir, AddSubCoreAir<8, 8> | prover | 1 | 1,048,576 | 49 | 51,380,224 | 
...
| app_proof | 23 | VmAirWrapper<Rv64BaseAluAdapterAir, AddSubCoreAir<8, 8> | prover | 2 | 1,048,576 | 49 | 51,380,224 | 
...
| app_proof | 23 | VmAirWrapper<Rv64BaseAluAdapterAir, AddSubCoreAir<8, 8> | prover | 3 | 65,536 | 49 | 3,211,264 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 27,289,339 | 237 | 84 | 0 | 5 | 104 | 32 | 31 | 46 | 25 | 0 | 47 | 20 | 26 | 2 | 23 | 85 | 104 | 0 | 2 | 25 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,703 | 166 | 49 | 0 | 4 | 72 | 24 | 24 | 28 | 19 | 0 | 43 | 19 | 24 | 1 | 22 | 49 | 72 | 0 | 2 | 18 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 144 | 34 | 0 | 4 | 68 | 23 | 23 | 24 | 19 | 0 | 41 | 18 | 23 | 1 | 21 | 34 | 68 | 0 | 2 | 18 | 0 | 0 | 
| leaf | 0 | prover | 102,941,734 | 405 | 171 | 0 | 11 | 168 | 71 | 70 | 47 | 49 | 0 | 64 | 29 | 35 | 8 | 26 | 172 | 168 | 0 | 5 | 48 | 0 | 0 | 
...
| leaf | 0 | prover | 0 | 9,097,221 | 2,013,265,921 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 66,843,374 | 226 | 54 | 0 | 2 | 130 | 31 | 30 | 16 | 82 | 0 | 41 | 22 | 19 | 6 | 13 | 54 | 130 | 0 | 3 | 81 | 0 | 0 | 
| app_proof | prover | 1 | 66,799,436 | 209 | 52 | 0 | 1 | 120 | 26 | 25 | 16 | 78 | 0 | 35 | 20 | 15 | 6 | 9 | 53 | 120 | 0 | 3 | 77 | 0 | 0 | 
| app_proof | prover | 2 | 66,799,436 | 215 | 54 | 0 | 1 | 124 | 25 | 25 | 16 | 82 | 0 | 37 | 22 | 15 | 6 | 9 | 54 | 124 | 0 | 3 | 81 | 0 | 0 | 
| app_proof | prover | 3 | 9,334,556 | 78 | 16 | 0 | 1 | 34 | 9 | 8 | 7 | 17 | 0 | 27 | 19 | 8 | 1 | 7 | 16 | 34 | 0 | 2 | 16 | 0 | 0 | 

| group | phase | segment | trace_height_constraint | weighted_sum | threshold |
| --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 0 | 29,497,123 | 2,013,265,921 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 182 | 613 | 182 | 164 | 0 | 3 | 39 | 1,310,000 | 37.29 | 
| app_proof | 1 | 166 | 469 | 166 | 41 | 0 | 1 | 51 | 1,310,000 | 41.64 | 
| app_proof | 2 | 170 | 475 | 170 | 41 | 0 | 1 | 48 | 1,310,000 | 41.94 | 
| app_proof | 3 | 208 | 332 | 208 | 41 | 0 | 2 | 4 | 70,051 | 41.47 | 

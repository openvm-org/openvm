...
|:---|---:|---:|---:|
| Total |  17.50 |  5.21 |  5.21 |
| app_proof |  14.30 |  2.79 |  2.79 |
| leaf |  2.40 |  1.62 |  1.62 |
...
| `total_proof_time_ms ` |  2,360.33 |  14,162 |  2,650 |  2,243 |
| `execute_metered_time_ms` |  139 | -          | -          | -          |
| `execute_metered_insns` |  14,365,133 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  102.79 | -          |  102.79 |  102.79 |
| `execute_preflight_insns` |  2,394,188.83 |  14,365,133 |  2,413,000 |  2,300,133 |
| `execute_preflight_time_ms` |  241 |  1,446 |  322 |  88 |
| `execute_preflight_insn_mi/s` |  35.78 | -          |  36.65 |  32.76 |
| `trace_gen_time_ms   ` |  54.33 |  326 |  157 |  33 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  2,002.67 |  12,016 |  2,241 |  1,933 |
| `prover.main_trace_commit_time_ms` |  719.17 |  4,315 |  889 |  684 |
| `prover.rap_constraints_time_ms` |  1,097.33 |  6,584 |  1,163 |  1,061 |
| `prover.openings_time_ms` |  185.33 |  1,112 |  188 |  183 |
| `prover.rap_constraints.logup_gkr_time_ms` |  247 |  1,482 |  302 |  235 |
| `prover.rap_constraints.round0_time_ms` |  531 |  3,186 |  603 |  512 |
| `prover.rap_constraints.mle_rounds_time_ms` |  318.17 |  1,909 |  333 |  310 |
| `prover.openings.stacked_reduction_time_ms` |  140.67 |  844 |  142 |  137 |
...
| `prover.openings.whir_time_ms` |  44 |  264 |  46 |  42 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,199 |  2,398 |  1,621 |  777 |
| `execute_preflight_time_ms` |  5.50 |  11 |  6 |  5 |
| `trace_gen_time_ms   ` |  139.50 |  279 |  186 |  93 |
| `generate_blob_total_time_ms` |  24.50 |  49 |  33 |  16 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,058.50 |  2,117 |  1,434 |  683 |
| `prover.main_trace_commit_time_ms` |  639 |  1,278 |  900 |  378 |
| `prover.rap_constraints_time_ms` |  322 |  644 |  413 |  231 |
| `prover.openings_time_ms` |  95.50 |  191 |  119 |  72 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/dc8f178291c11e091c2b67ec04fbe0c89eb4c4de/keccak-dc8f178291c11e091c2b67ec04fbe0c89eb4c4de.memory.svg)

| Module | Max (GB) | Max At |
| --- | ---: | --- |
| prover.rap_constraints | 14.60 | app_proof.prover.4 |
| prover.openings | 13.21 | app_proof.prover.4 |
| prover.prove_whir_opening | 13.21 | app_proof.prover.4 |
| prover.merkle_tree | 13.21 | app_proof.prover.4 |
| prover.batch_constraints.round0 | 12.68 | app_proof.prover.4 |
| prover.batch_constraints.fold_ple_evals | 12.68 | app_proof.prover.4 |
| frac_sumcheck.gkr_rounds | 12.44 | app_proof.prover.4 |
| prover.batch_constraints.before_round0 | 12.44 | app_proof.prover.4 |
| prover.gkr_input_evals | 12.32 | app_proof.prover.4 |
| frac_sumcheck.segment_tree | 12.32 | app_proof.prover.4 |
| prover.before_gkr_input_evals | 10.06 | app_proof.prover.4 |
| prover.stacked_commit | 10.06 | app_proof.prover.4 |
| prover.rs_code_matrix | 10.05 | app_proof.prover.4 |
...
| 26 | VmAirWrapper<Rv64BaseAluAdapterAir, AddSubCoreAir<8, 8> | 24 | 31 | 3 | 
...
| app_proof |  |  |  |  |  | 2,243 |  |  | 139 | 14,365,133 | 102.79 | 0 | 14,308 |  | 
| internal_for_leaf |  |  |  | 508 |  |  |  |  |  |  |  |  |  | 508 | 
...
| app_proof | 25 | VmAirWrapper<Rv64BaseAluAdapterAir, XorOrAndCoreAir<8, 8> | prover | 0 | 262,144 | 50 | 13,107,200 | 
| app_proof | 26 | VmAirWrapper<Rv64BaseAluAdapterAir, AddSubCoreAir<8, 8> | prover | 0 | 1,048,576 | 49 | 51,380,224 | 
...
| app_proof | 25 | VmAirWrapper<Rv64BaseAluAdapterAir, XorOrAndCoreAir<8, 8> | prover | 1 | 262,144 | 50 | 13,107,200 | 
| app_proof | 26 | VmAirWrapper<Rv64BaseAluAdapterAir, AddSubCoreAir<8, 8> | prover | 1 | 1,048,576 | 49 | 51,380,224 | 
| app_proof | 27 | BitwiseOperationLookupAir<8> | prover | 1 | 65,536 | 18 | 1,179,648 | 
| app_proof | 29 | Poseidon2PeripheryAir<BabyBearParameters>, 1> | prover | 1 | 512 | 300 | 153,600 | 
...
| app_proof | 25 | VmAirWrapper<Rv64BaseAluAdapterAir, XorOrAndCoreAir<8, 8> | prover | 2 | 262,144 | 50 | 13,107,200 | 
| app_proof | 26 | VmAirWrapper<Rv64BaseAluAdapterAir, AddSubCoreAir<8, 8> | prover | 2 | 1,048,576 | 49 | 51,380,224 | 
| app_proof | 27 | BitwiseOperationLookupAir<8> | prover | 2 | 65,536 | 18 | 1,179,648 | 
| app_proof | 29 | Poseidon2PeripheryAir<BabyBearParameters>, 1> | prover | 2 | 512 | 300 | 153,600 | 
...
| app_proof | 25 | VmAirWrapper<Rv64BaseAluAdapterAir, XorOrAndCoreAir<8, 8> | prover | 3 | 262,144 | 50 | 13,107,200 | 
| app_proof | 26 | VmAirWrapper<Rv64BaseAluAdapterAir, AddSubCoreAir<8, 8> | prover | 3 | 1,048,576 | 49 | 51,380,224 | 
...
| app_proof | 25 | VmAirWrapper<Rv64BaseAluAdapterAir, XorOrAndCoreAir<8, 8>
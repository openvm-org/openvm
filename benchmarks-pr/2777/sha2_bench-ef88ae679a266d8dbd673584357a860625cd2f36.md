...
|:---|---:|---:|---:|
| Total |  9.92 |  4.34 |  4.34 |
| app_proof |  8.37 |  2.79 |  2.79 |
| leaf |  0.92 |  0.92 |  0.92 |
...
| `total_proof_time_ms ` |  2,069.75 |  8,279 |  2,696 |  644 |
| `execute_metered_time_ms` |  93 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  119.45 | -          |  119.45 |  119.45 |
| `execute_preflight_insns` |  2,791,990.25 |  11,167,961 |  3,562,000 |  481,961 |
| `execute_preflight_time_ms` |  165 |  660 |  269 |  31 |
| `execute_preflight_insn_mi/s` |  34.33 | -          |  35.46 |  32.30 |
| `trace_gen_time_ms   ` |  116.75 |  467 |  186 |  66 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,715.75 |  6,863 |  2,258 |  385 |
| `prover.main_trace_commit_time_ms` |  463.75 |  1,855 |  689 |  89 |
| `prover.rap_constraints_time_ms` |  1,126.75 |  4,507 |  1,424 |  249 |
| `prover.openings_time_ms` |  124 |  496 |  153 |  46 |
| `prover.rap_constraints.logup_gkr_time_ms` |  339.25 |  1,357 |  430 |  79 |
| `prover.rap_constraints.round0_time_ms` |  529 |  2,116 |  666 |  120 |
| `prover.rap_constraints.mle_rounds_time_ms` |  257.25 |  1,029 |  328 |  48 |
| `prover.openings.stacked_reduction_time_ms` |  91.50 |  366 |  115 |  24 |
| `prover.openings.stacked_reduction.round0_time_ms` |  50.75 |  203 |  66 |  8 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  40.75 |  163 |  51 |  16 |
| `prover.openings.whir_time_ms` |  32 |  128 |  39 |  21 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/ef88ae679a266d8dbd673584357a860625cd2f36/sha2_bench-ef88ae679a266d8dbd673584357a860625cd2f36.memory.svg)
...
| app_proof |  |  |  |  |  | 644 |  |  | 93 | 11,167,961 | 119.45 | 0 | 8,380 |  | 
...
| leaf | 0 | 129 | 915 | 128 | 48 | 22 | 2 | 1 | 1 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,577,915 | 280 | 119 | 0 | 7 | 112 | 34 | 33 | 51 | 26 | 0 | 48 | 19 | 28 | 3 | 25 | 119 | 112 | 0 | 2 | 25 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,703 | 167 | 48 | 0 | 4 | 71 | 24 | 23 | 28 | 19 | 0 | 46 | 22 | 23 | 1 | 21 | 49 | 71 | 0 | 2 | 18 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 145 | 33 | 0 | 4 | 66 | 23 | 22 | 24 | 18 | 0 | 44 | 21 | 22 | 1 | 21 | 34 | 66 | 0 | 2 | 17 | 0 | 0 | 
| leaf | 0 | prover | 267,458,790 | 786 | 410 | 0 | 26 | 285 | 128 | 127 | 79 | 76 | 0 | 90 | 34 | 55 | 22 | 33 | 410 | 285 | 0 | 6 | 74 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 686,312,761 | 2,258 | 688 | 0 | 194 | 1,420 | 666 | 666 | 326 | 426 | 106 | 148 | 33 | 115 | 64 | 51 | 689 | 1,420 | 0 | 3 | 319 | 0 | 0 | 
| app_proof | prover | 1 | 686,312,460 | 2,117 | 538 | 0 | 42 | 1,424 | 666 | 665 | 328 | 430 | 125 | 153 | 39 | 114 | 66 | 48 | 539 | 1,424 | 0 | 3 | 304 | 0 | 0 | 
| app_proof | prover | 2 | 686,312,460 | 2,103 | 538 | 0 | 41 | 1,414 | 664 | 664 | 327 | 422 | 118 | 149 | 35 | 113 | 65 | 48 | 538 | 1,414 | 0 | 3 | 303 | 0 | 0 | 
| app_proof | prover | 3 | 106,273,044 | 385 | 89 | 0 | 7 | 249 | 120 | 120 | 48 | 79 | 0 | 46 | 21 | 24 | 8 | 16 | 89 | 249 | 0 | 3 | 78 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 148 | 2,696 | 148 | 161 | 0 | 3 | 127 | 3,562,000 | 32.30 | 
| app_proof | 1 | 66 | 2,494 | 66 | 41 | 0 | 1 | 269 | 3,562,000 | 35.46 | 
| app_proof | 2 | 67 | 2,445 | 67 | 41 | 0 | 1 | 233 | 3,562,000 | 35.45 | 
| app_proof | 3 | 186 | 644 | 186 | 41 | 0 | 2 | 31 | 481,961 | 34.10 | 

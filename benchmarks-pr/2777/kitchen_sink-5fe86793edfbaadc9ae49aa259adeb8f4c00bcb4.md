...
| `total_proof_time_ms ` |  944 |  1,888 |  1,197 |  691 |
| `execute_metered_time_ms` |  23 | -          | -          | -          |
| `execute_metered_insns` |  1,979,971 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  83.70 | -          |  83.70 |  83.70 |
| `execute_preflight_insns` |  989,985.50 |  1,979,971 |  1,168,000 |  811,971 |
| `execute_preflight_time_ms` |  91.50 |  183 |  130 |  53 |
| `execute_preflight_insn_mi/s` |  34.60 | -          |  35.40 |  33.79 |
| `trace_gen_time_ms   ` |  30 |  60 |  44 |  16 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  712 |  1,424 |  921 |  503 |
| `prover.main_trace_commit_time_ms` |  212 |  424 |  290 |  134 |
| `prover.rap_constraints_time_ms` |  453.50 |  907 |  579 |  328 |
| `prover.openings_time_ms` |  46 |  92 |  52 |  40 |
| `prover.rap_constraints.logup_gkr_time_ms` |  73 |  146 |  107 |  39 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/5fe86793edfbaadc9ae49aa259adeb8f4c00bcb4/kitchen_sink-5fe86793edfbaadc9ae49aa259adeb8f4c00bcb4.memory.svg)
...
| app_proof |  |  |  |  |  | 691 |  |  | 23 | 1,979,971 | 83.70 | 0 | 1,916 |  | 
| internal_for_leaf |  |  |  | 137 |  |  |  |  |  |  |  |  |  | 138 | 
...
| internal_recursive.1 | 1 | 8 | 83 | 8 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 112 | 406 | 112 | 24 | 11 | 20 | 5 | 5 | 
...
| leaf | 0 | prover | 263,565,172 | 294 | 126 | 0 | 1 | 138 | 48 | 47 | 37 | 52 | 0 | 28 | 13 | 15 | 7 | 8 | 126 | 138 | 0 | 2 | 51 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 570,054,164 | 921 | 289 | 0 | 160 | 579 | 341 | 340 | 129 | 107 | 51 | 52 | 14 | 38 | 15 | 22 | 290 | 579 | 0 | 1 | 55 | 0 | 0 | 
| app_proof | prover | 1 | 530,609,548 | 503 | 134 | 0 | 1 | 328 | 213 | 212 | 75 | 39 | 0 | 40 | 13 | 27 | 13 | 13 | 134 | 328 | 0 | 1 | 39 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 44 | 1,197 | 44 | 177 | 0 | 3 | 53 | 1,168,000 | 33.79 | 
| app_proof | 1 | 16 | 691 | 16 | 40 | 0 | 1 | 130 | 811,971 | 35.40 | 

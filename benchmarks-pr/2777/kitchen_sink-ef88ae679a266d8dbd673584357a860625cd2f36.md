...
| `total_proof_time_ms ` |  1,006.50 |  2,013 |  1,292 |  721 |
| `execute_metered_time_ms` |  23 | -          | -          | -          |
| `execute_metered_insns` |  1,979,971 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  83.11 | -          |  83.11 |  83.11 |
| `execute_preflight_insns` |  989,985.50 |  1,979,971 |  1,168,000 |  811,971 |
| `execute_preflight_time_ms` |  93 |  186 |  129 |  57 |
| `execute_preflight_insn_mi/s` |  31.11 | -          |  31.77 |  30.44 |
| `trace_gen_time_ms   ` |  28.50 |  57 |  41 |  16 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  776 |  1,552 |  1,018 |  534 |
| `prover.main_trace_commit_time_ms` |  226 |  452 |  306 |  146 |
| `prover.rap_constraints_time_ms` |  484.50 |  969 |  633 |  336 |
| `prover.openings_time_ms` |  65 |  130 |  78 |  52 |
| `prover.rap_constraints.logup_gkr_time_ms` |  96.50 |  193 |  145 |  48 |
| `prover.rap_constraints.round0_time_ms` |  277 |  554 |  343 |  211 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/ef88ae679a266d8dbd673584357a860625cd2f36/kitchen_sink-ef88ae679a266d8dbd673584357a860625cd2f36.memory.svg)
...
| app_proof |  |  |  |  |  | 721 |  |  | 23 | 1,979,971 | 83.11 | 0 | 2,042 |  | 
...
| leaf | 0 | 109 | 430 | 109 | 24 | 11 | 20 | 5 | 5 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,577,915 | 142 | 40 | 0 | 4 | 67 | 21 | 21 | 29 | 16 | 0 | 33 | 9 | 23 | 1 | 22 | 41 | 67 | 0 | 1 | 15 | 0 | 0 | 
...
| leaf | 0 | prover | 263,565,172 | 320 | 130 | 0 | 10 | 145 | 49 | 48 | 37 | 58 | 0 | 44 | 12 | 32 | 7 | 24 | 130 | 145 | 0 | 2 | 58 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 570,054,164 | 1,018 | 305 | 0 | 174 | 633 | 343 | 342 | 144 | 145 | 47 | 78 | 14 | 64 | 15 | 48 | 306 | 633 | 0 | 1 | 97 | 0 | 0 | 
| app_proof | prover | 1 | 530,609,548 | 534 | 145 | 0 | 23 | 336 | 211 | 211 | 76 | 48 | 0 | 52 | 13 | 39 | 14 | 25 | 146 | 336 | 0 | 1 | 48 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 41 | 1,292 | 41 | 175 | 0 | 3 | 57 | 1,168,000 | 30.44 | 
| app_proof | 1 | 16 | 721 | 16 | 40 | 0 | 1 | 129 | 811,971 | 31.77 | 

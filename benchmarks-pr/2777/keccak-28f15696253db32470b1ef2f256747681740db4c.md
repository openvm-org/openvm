...
|:---|---:|---:|---:|
| Total |  16.94 |  4.97 |  4.97 |
| app_proof |  13.96 |  2.75 |  2.75 |
| leaf |  2.19 |  1.43 |  1.43 |
...
| `total_proof_time_ms ` |  2,302.67 |  13,816 |  2,613 |  2,207 |
| `execute_metered_time_ms` |  140 | -          | -          | -          |
| `execute_metered_insns` |  14,365,133 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  102.03 | -          |  102.03 |  102.03 |
| `execute_preflight_insns` |  2,394,188.83 |  14,365,133 |  2,413,000 |  2,300,133 |
| `execute_preflight_time_ms` |  234 |  1,404 |  316 |  87 |
| `execute_preflight_insn_mi/s` |  35.100 | -          |  36.94 |  32.93 |
| `trace_gen_time_ms   ` |  54 |  324 |  155 |  33 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,952.33 |  11,714 |  2,208 |  1,899 |
| `prover.main_trace_commit_time_ms` |  709.33 |  4,256 |  874 |  675 |
| `prover.rap_constraints_time_ms` |  1,060.83 |  6,365 |  1,150 |  1,042 |
| `prover.openings_time_ms` |  181.17 |  1,087 |  183 |  179 |
| `prover.rap_constraints.logup_gkr_time_ms` |  241.33 |  1,448 |  294 |  230 |
| `prover.rap_constraints.round0_time_ms` |  508.50 |  3,051 |  521 |  504 |
| `prover.rap_constraints.mle_rounds_time_ms` |  310.17 |  1,861 |  333 |  304 |
| `prover.openings.stacked_reduction_time_ms` |  136.83 |  821 |  139 |  136 |
| `prover.openings.stacked_reduction.round0_time_ms` |  82.33 |  494 |  84 |  80 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  54 |  324 |  55 |  53 |
| `prover.openings.whir_time_ms` |  43.67 |  262 |  45 |  42 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,096 |  2,192 |  1,429 |  763 |
| `execute_preflight_time_ms` |  5.50 |  11 |  6 |  5 |
| `trace_gen_time_ms   ` |  137 |  274 |  182 |  92 |
| `generate_blob_total_time_ms` |  24.50 |  49 |  33 |  16 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  958 |  1,916 |  1,246 |  670 |
| `prover.main_trace_commit_time_ms` |  545.50 |  1,091 |  719 |  372 |
| `prover.rap_constraints_time_ms` |  319.50 |  639 |  411 |  228 |
| `prover.openings_time_ms` |  92 |  184 |  115 |  69 |
...
| `prover.openings.whir_time_ms` |  38 |  76 |  44 |  32 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/28f15696253db32470b1ef2f256747681740db4c/keccak-28f15696253db32470b1ef2f256747681740db4c.memory.svg)
...
| app_proof |  |  |  |  |  | 2,207 |  |  | 140 | 14,365,133 | 102.03 | 0 | 13,964 |  | 
...
| internal_recursive.0 | 1 | 13 | 164 | 13 | 2 | 1 | 2 | 2 | 2 | 
| internal_recursive.1 | 1 | 9 | 130 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 182 | 1,429 | 182 | 64 | 33 | 6 | 7 | 7 | 
| leaf | 1 | 92 | 763 | 92 | 32 | 16 | 5 | 7 | 7 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 81,415,028 | 459 | 241 | 0 | 1 | 171 | 48 | 47 | 92 | 30 | 0 | 45 | 22 | 23 | 7 | 15 | 242 | 171 | 0 | 3 | 29 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,879 | 150 | 49 | 0 | 0 | 72 | 25 | 24 | 29 | 17 | 0 | 28 | 19 | 8 | 1 | 6 | 49 | 72 | 0 | 2 | 16 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 121 | 31 | 0 | 0 | 62 | 24 | 23 | 24 | 13 | 0 | 26 | 19 | 7 | 1 | 5 | 31 | 62 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 476,993,766 | 1,246 | 719 | 0 | 2 | 411 | 204 | 203 | 120 | 86 | 0 | 115 | 44 | 71 | 40 | 30 | 719 | 411 | 0 | 7 | 85 | 0 | 0 | 
| leaf | 1 | prover | 240,463,284 | 670 | 372 | 0 | 1 | 228 | 109 | 108 | 67 | 50 | 0 | 69 | 32 | 37 | 19 | 17 | 372 | 228 | 0 | 6 | 50 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 864,460,812 | 2,208 | 874 | 0 | 203 | 1,150 | 521 | 521 | 333 | 294 | 73 | 183 | 45 | 137 | 83 | 54 | 874 | 1,150 | 0 | 4 | 220 | 0 | 0 | 
| app_proof | prover | 1 | 864,537,612 | 1,902 | 676 | 0 | 3 | 1,043 | 506 | 505 | 306 | 231 | 0 | 181 | 44 | 136 | 82 | 54 | 676 | 1,043 | 0 | 3 | 229 | 0 | 0 | 
| app_proof | prover | 2 | 864,537,612 | 1,899 | 675 | 0 | 3 | 1,044 | 508 | 507 | 305 | 231 | 0 | 179 | 43 | 136 | 82 | 53 | 675 | 1,044 | 0 | 3 | 230 | 0 | 0 | 
| app_proof | prover | 3 | 864,537,612 | 1,899 | 676 | 0 | 3 | 1,042 | 504 | 503 | 306 | 231 | 0 | 181 | 44 | 136 | 80 | 55 | 676 | 1,042 | 0 | 4 | 229 | 0 | 0 | 
| app_proof | prover | 4 | 864,537,612 | 1,905 | 677 | 0 | 3 | 1,044 | 505 | 504 | 307 | 231 | 0 | 182 | 44 | 137 | 83 | 54 | 678 | 1,044 | 0 | 3 | 230 | 0 | 0 | 
| app_proof | prover | 5 | 864,460,812 | 1,901 | 677 | 0 | 3 | 1,042 | 507 | 506 | 304 | 230 | 0 | 181 | 42 | 139 | 84 | 54 | 677 | 1,042 | 0 | 3 | 229 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 155 | 2,613 | 155 | 162 | 0 | 3 | 87 | 2,413,000 | 32.93 | 
| app_proof | 1 | 34 | 2,293 | 34 | 41 | 0 | 1 | 316 | 2,413,000 | 36.62 | 
| app_proof | 2 | 34 | 2,232 | 34 | 41 | 0 | 1 | 257 | 2,413,000 | 36.47 | 
| app_proof | 3 | 34 | 2,232 | 34 | 41 | 0 | 1 | 257 | 2,413,000 | 36.94 | 
| app_proof | 4 | 34 | 2,239 | 34 | 41 | 0 | 1 | 257 | 2,413,000 | 36.73 | 
| app_proof | 5 | 33 | 2,207 | 33 | 41 | 0 | 1 | 230 | 2,300,133 | 36.29 | 

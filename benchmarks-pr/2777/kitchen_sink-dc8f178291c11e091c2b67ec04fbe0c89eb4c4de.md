...
|:---|---:|---:|---:|
| Total |  2.63 |  1.94 |  1.94 |
| app_proof |  1.91 |  1.22 |  1.22 |
| leaf |  0.41 |  0.41 |  0.41 |
...
| `total_proof_time_ms ` |  944.50 |  1,889 |  1,197 |  692 |
| `execute_metered_time_ms` |  23 | -          | -          | -          |
| `execute_metered_insns` |  1,979,971 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  83.85 | -          |  83.85 |  83.85 |
| `execute_preflight_insns` |  989,985.50 |  1,979,971 |  1,168,000 |  811,971 |
| `execute_preflight_time_ms` |  92.50 |  185 |  130 |  55 |
| `execute_preflight_insn_mi/s` |  34.31 | -          |  35.64 |  32.98 |
| `trace_gen_time_ms   ` |  28.50 |  57 |  42 |  15 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  712.50 |  1,425 |  921 |  504 |
| `prover.main_trace_commit_time_ms` |  211.50 |  423 |  288 |  135 |
| `prover.rap_constraints_time_ms` |  454 |  908 |  579 |  329 |
| `prover.openings_time_ms` |  46 |  92 |  52 |  40 |
| `prover.rap_constraints.logup_gkr_time_ms` |  72.50 |  145 |  106 |  39 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/dc8f178291c11e091c2b67ec04fbe0c89eb4c4de/kitchen_sink-dc8f178291c11e091c2b67ec04fbe0c89eb4c4de.memory.svg)

| Module | Max (GB) | Max At |
| --- | ---: | --- |
| prover.rap_constraints | 10.30 | app_proof.prover.0 |
| prover.merkle_tree | 9.00 | app_proof.prover.0 |
| prover.openings | 9.00 | app_proof.prover.0 |
| prover.prove_whir_opening | 9.00 | app_proof.prover.0 |
| frac_sumcheck.gkr_rounds | 8.83 | app_proof.prover.0 |
| frac_sumcheck.segment_tree | 8.83 | app_proof.prover.0 |
| prover.batch_constraints.before_round0 | 8.83 | app_proof.prover.0 |
| prover.gkr_input_evals | 8.83 | app_proof.prover.0 |
| prover.batch_constraints.fold_ple_evals | 8.67 | app_proof.prover.0 |
| prover.batch_constraints.round0 | 8.67 | app_proof.prover.0 |
| prover.before_gkr_input_evals | 7.22 | app_proof.prover.0 |
| prover.stacked_commit | 7.22 | app_proof.prover.0 |
| prover.rs_code_matrix | 7.21 | app_proof.prover.0 |
...
| 75 | VmAirWrapper<Rv64BaseAluAdapterAir, AddSubCoreAir<8, 8> | 24 | 31 | 3 | 
| 76 | BitwiseOperationLookupAir<8> | 2 | 19 | 2 | 
| 77 | PhantomAir | 3 |  | 1 | 
| 78 | Poseidon2PeripheryAir<BabyBearParameters>, 1> | 1 | 282 | 3 | 
| 79 | VariableRangeCheckerAir | 1 | 10 | 3 | 
...
| app_proof |  |  |  |  |  | 692 |  |  | 23 | 1,979,971 | 83.85 | 0 | 1,917 |  | 
...
| app_proof | VmAirWrapper<Rv64BaseAluAdapterAir, AddSubCoreAir<8, 8> | 0 | 1 | 
...
| app_proof | VmAirWrapper<Rv64BaseAluAdapterAir, AddSubCoreAir<8, 8> | 1 | 1 | 
...
| app_proof | 74 | VmAirWrapper<Rv64BaseAluAdapterAir, XorOrAndCoreAir<8, 8> | prover | 0 | 131,072 | 50 | 6,553,600 | 
| app_proof | 75 | VmAirWrapper<Rv64BaseAluAdapterAir, AddSubCoreAir<8, 8> | prover | 0 | 524,288 | 49 | 25,690,112 | 
...
| app_proof | 74 | VmAirWrapper<Rv64BaseAluAdapterAir, XorOrAndCoreAir<8, 8> | prover | 1 | 65,536 | 50 | 3,276,800 | 
| app_proof | 75 | VmAirWrapper<Rv64BaseAluAdapterAir, AddSubCoreAir<8, 8> | prover | 1 | 262,144 | 49 | 12,845,056 | 
| app_proof | 76 | BitwiseOperationLookupAir<8> | prover | 1 | 65,536 | 18 | 1,179,648 | 
| app_proof | 78 | Poseidon2PeripheryAir<BabyBearParameters>, 1> | prover | 1 | 4,096 | 300 | 1,228,800 | 
| app_proof | 79 | VariableRangeCheckerAir | prover | 1 | 262,144 | 4 | 1,048,576 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 18 | 136 | 17 | 6 | 1 | 2 | 1 | 1 | 
| internal_recursive.0 | 1 | 10 | 90 | 10 | 1 | 0 | 2 | 0 | 0 | 
| internal_recursive.1 | 1 | 9 | 84 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 111 | 408 | 111 | 25 | 11 | 20 | 5 | 5 | 
...
| internal_recursive.1 | 1 | prover | 9,750,799 | 74 | 11 | 0 | 0 | 48 | 19 | 18 | 18 | 10 | 0 | 14 | 9 | 5 | 0 | 4 | 11 | 48 | 0 | 1 | 9 | 0 | 0 | 
| leaf | 0 | prover | 263,565,172 | 297 | 128 | 0 | 1 | 140 | 49 | 48 | 37 | 53 | 0 | 28 | 12 | 15 | 7 | 8 | 128 | 140 | 0 | 2 | 52 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 570,054,164 | 921 | 288 | 0 | 157 | 579 | 343 | 342 | 129 | 106 | 50 | 52 | 14 | 38 | 16 | 22 | 288 | 579 | 0 | 1 | 54 | 0 | 0 | 
| app_proof | prover | 1 | 530,609,548 | 504 | 134 | 0 | 1 | 329 | 212 | 212 | 76 | 39 | 0 | 40 | 12 | 27 | 14 | 13 | 135 | 329 | 0 | 1 | 39 | 0 | 0 | 

| group | phase | segment | trace_height_constraint | weighted_sum | threshold |
| --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 0 | 48,361,186 | 2,013,265,921 | 
| app_proof | prover | 1 | 0 | 32,291,466 | 2,013,265,921 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 42 | 1,197 | 42 | 177 | 0 | 3 | 55 | 1,168,000 | 32.98 | 
| app_proof | 1 | 15 | 692 | 15 | 40 | 0 | 1 | 130 | 811,971 | 35.64 | 

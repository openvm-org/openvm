...
| `total_proof_time_ms ` |  2,068.75 |  8,275 |  2,701 |  632 |
...
| `execute_preflight_time_ms` |  158.75 |  635 |  261 |  30 |
| `execute_preflight_insn_mi/s` |  37.63 | -          |  39.25 |  35.57 |
| `trace_gen_time_ms   ` |  121 |  484 |  191 |  66 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,716.75 |  6,867 |  2,261 |  369 |
| `prover.main_trace_commit_time_ms` |  468.25 |  1,873 |  695 |  87 |
| `prover.rap_constraints_time_ms` |  1,126.25 |  4,505 |  1,424 |  240 |
| `prover.openings_time_ms` |  121.50 |  486 |  151 |  41 |
| `prover.rap_constraints.logup_gkr_time_ms` |  329.25 |  1,317 |  419 |  73 |
| `prover.rap_constraints.round0_time_ms` |  535 |  2,140 |  679 |  112 |
| `prover.rap_constraints.mle_rounds_time_ms` |  261.25 |  1,045 |  332 |  54 |
| `prover.openings.stacked_reduction_time_ms` |  86 |  344 |  109 |  18 |
| `prover.openings.stacked_reduction.round0_time_ms` |  51.75 |  207 |  67 |  9 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  33.50 |  134 |  42 |  8 |
| `prover.openings.whir_time_ms` |  34.50 |  138 |  41 |  22 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/e53664d30663bdf156e08a79eb6c350c5a501426/sha2_bench-e53664d30663bdf156e08a79eb6c350c5a501426.memory.svg)
...
| app_proof |  |  |  |  |  | 632 |  |  | 91 | 11,167,961 | 121.43 | 0 | 8,373 |  | 
...
| internal_recursive.0 | 1 | 11 | 149 | 11 | 1 | 0 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 10 | 136 | 10 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 129 | 908 | 129 | 48 | 21 | 2 | 1 | 1 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,577,915 | 260 | 118 | 0 | 0 | 107 | 35 | 35 | 52 | 20 | 0 | 33 | 19 | 13 | 3 | 9 | 118 | 107 | 0 | 2 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,703 | 137 | 45 | 0 | 0 | 63 | 22 | 21 | 27 | 13 | 0 | 28 | 20 | 8 | 1 | 6 | 45 | 63 | 0 | 2 | 12 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 125 | 31 | 0 | 0 | 64 | 23 | 22 | 24 | 16 | 0 | 28 | 21 | 7 | 1 | 5 | 32 | 64 | 0 | 3 | 12 | 0 | 0 | 
| leaf | 0 | prover | 267,458,790 | 779 | 413 | 0 | 1 | 289 | 133 | 132 | 80 | 74 | 0 | 76 | 34 | 41 | 22 | 18 | 413 | 289 | 0 | 6 | 73 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 686,312,761 | 2,261 | 694 | 0 | 152 | 1,420 | 679 | 678 | 327 | 413 | 112 | 146 | 37 | 108 | 65 | 42 | 695 | 1,420 | 0 | 4 | 300 | 0 | 0 | 
| app_proof | prover | 1 | 686,312,460 | 2,121 | 545 | 0 | 2 | 1,424 | 673 | 672 | 332 | 419 | 123 | 151 | 41 | 109 | 67 | 42 | 545 | 1,424 | 0 | 3 | 295 | 0 | 0 | 
| app_proof | prover | 2 | 686,312,460 | 2,116 | 546 | 0 | 2 | 1,421 | 676 | 676 | 332 | 412 | 117 | 148 | 38 | 109 | 66 | 42 | 546 | 1,421 | 0 | 3 | 294 | 0 | 0 | 
| app_proof | prover | 3 | 106,273,044 | 369 | 87 | 0 | 0 | 240 | 112 | 111 | 54 | 73 | 0 | 41 | 22 | 18 | 9 | 8 | 87 | 240 | 0 | 3 | 73 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 160 | 2,701 | 160 | 160 | 0 | 3 | 118 | 3,562,000 | 35.57 | 
| app_proof | 1 | 67 | 2,492 | 67 | 41 | 0 | 1 | 261 | 3,562,000 | 39.07 | 
| app_proof | 2 | 66 | 2,450 | 66 | 41 | 0 | 1 | 226 | 3,562,000 | 39.25 | 
| app_proof | 3 | 191 | 632 | 191 | 41 | 0 | 2 | 30 | 481,961 | 36.63 | 

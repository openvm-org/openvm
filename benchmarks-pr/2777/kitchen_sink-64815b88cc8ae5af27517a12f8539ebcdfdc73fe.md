...
|:---|---:|---:|---:|
| Total |  2.63 |  1.96 |  1.96 |
| app_proof |  1.90 |  1.23 |  1.23 |
| leaf |  0.41 |  0.41 |  0.41 |
...
| `total_proof_time_ms ` |  941 |  1,882 |  1,211 |  671 |
| `execute_metered_time_ms` |  23 | -          | -          | -          |
| `execute_metered_insns` |  1,979,971 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  83.41 | -          |  83.41 |  83.41 |
| `execute_preflight_insns` |  989,985.50 |  1,979,971 |  1,168,000 |  811,971 |
| `execute_preflight_time_ms` |  90 |  180 |  124 |  56 |
| `execute_preflight_insn_mi/s` |  33.99 | -          |  34.89 |  33.08 |
| `trace_gen_time_ms   ` |  29 |  58 |  42 |  16 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  711.50 |  1,423 |  934 |  489 |
| `prover.main_trace_commit_time_ms` |  215.50 |  431 |  295 |  136 |
| `prover.rap_constraints_time_ms` |  448 |  896 |  585 |  311 |
| `prover.openings_time_ms` |  46.50 |  93 |  52 |  41 |
| `prover.rap_constraints.logup_gkr_time_ms` |  81.50 |  163 |  110 |  53 |
| `prover.rap_constraints.round0_time_ms` |  261.50 |  523 |  343 |  180 |
| `prover.rap_constraints.mle_rounds_time_ms` |  104.50 |  209 |  132 |  77 |
| `prover.openings.stacked_reduction_time_ms` |  33 |  66 |  39 |  27 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/64815b88cc8ae5af27517a12f8539ebcdfdc73fe/kitchen_sink-64815b88cc8ae5af27517a12f8539ebcdfdc73fe.memory.svg)

| Module | Max (GB) | Max At |
| --- | ---: | --- |
| prover.rap_constraints | 10.35 | app_proof.prover.0 |
| prover.merkle_tree | 9.05 | app_proof.prover.0 |
| prover.openings | 9.05 | app_proof.prover.0 |
| prover.prove_whir_opening | 9.05 | app_proof.prover.0 |
| frac_sumcheck.gkr_rounds | 8.94 | app_proof.prover.0 |
| prover.gkr_input_evals | 8.94 | app_proof.prover.0 |
| frac_sumcheck.segment_tree | 8.94 | app_proof.prover.0 |
| prover.batch_constraints.before_round0 | 8.94 | app_proof.prover.0 |
| prover.batch_constraints.round0 | 8.71 | app_proof.prover.0 |
| prover.batch_constraints.fold_ple_evals | 8.71 | app_proof.prover.0 |
| prover.before_gkr_input_evals | 7.27 | app_proof.prover.0 |
| prover.stacked_commit | 7.27 | app_proof.prover.0 |
| prover.rs_code_matrix | 7.25 | app_proof.prover.0 |
...
| 73 | VmAirWrapper<Rv64BaseAluWAdapterAir, AddSubCoreAir<4, 8> | 21 | 20 | 3 | 
| 74 | VmAirWrapper<Rv64BaseAluAdapterAir, AndCoreAir<8, 8> | 24 | 13 | 3 | 
| 75 | VmAirWrapper<Rv64BaseAluAdapterAir, OrCoreAir<8, 8> | 24 | 13 | 3 | 
| 76 | VmAirWrapper<Rv64BaseAluAdapterAir, XorCoreAir<8, 8> | 24 | 13 | 3 | 
| 77 | VmAirWrapper<Rv64BaseAluAdapterAir, SubCoreAir<8, 8> | 24 | 21 | 3 | 
| 78 | VmAirWrapper<Rv64BaseAluAdapterAir, AddCoreAir<8, 8> | 24 | 21 | 3 | 
| 79 | BitwiseOperationLookupAir<8> | 2 | 19 | 2 | 
| 8 | VmAirWrapper<Rv64VecHeapAdapterAir<1, 8, 8, 8, 8>, FieldExpressionCoreAir> | 463 | 280 | 3 | 
| 80 | PhantomAir | 3 |  | 1 | 
| 81 | Poseidon2PeripheryAir<BabyBearParameters>, 1> | 1 | 282 | 3 | 
| 82 | VariableRangeCheckerAir | 1 | 10 | 3 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 81 | 3 |  |  | 0 |  | 350 | 3 |  |  |  |  |  |  | 
| app_proof |  |  |  |  |  | 671 |  |  | 23 | 1,979,971 | 83.41 | 0 | 1,910 |  | 
| internal_for_leaf |  |  |  | 136 |  |  |  |  |  |  |  |  |  | 136 | 
| internal_recursive.0 |  |  |  | 93 |  |  |  |  |  |  |  |  |  | 93 | 
...
| app_proof | VmAirWrapper<Rv64BaseAluAdapterAir, AddCoreAir<8, 8> | 0 | 1 | 
...
| app_proof | 73 | VmAirWrapper<Rv64BaseAluWAdapterAir, AddSubCoreAir<4, 8> | prover | 0 | 16,384 | 46 | 753,664 | 
| app_proof | 74 | VmAirWrapper<Rv64BaseAluAdapterAir, AndCoreAir<8, 8> | prover | 0 | 131,072 | 48 | 6,291,456 | 
| app_proof | 75 | VmAirWrapper<Rv64BaseAluAdapterAir, OrCoreAir<8, 8> | prover | 0 | 16,384 | 48 | 786,432 | 
| app_proof | 76 | VmAirWrapper<Rv64BaseAluAdapterAir, XorCoreAir<8, 8> | prover | 0 | 512 | 48 | 24,576 | 
| app_proof | 77 | VmAirWrapper<Rv64BaseAluAdapterAir, SubCoreAir<8, 8> | prover | 0 | 65,536 | 48 | 3,145,728 | 
| app_proof | 78 | VmAirWrapper<Rv64BaseAluAdapterAir, AddCoreAir<8, 8> | prover | 0 | 524,288 | 48 | 25,165,824 | 
| app_proof | 79 | BitwiseOperationLookupAir<8> | prover | 0 | 65,536 | 18 | 1,179,648 | 
| app_proof | 8 | VmAirWrapper<Rv64VecHeapAdapterAir<1, 8, 8, 8, 8>, FieldExpressionCoreAir> | prover | 0 | 4 | 583 | 2,332 | 
| app_proof | 81 | Poseidon2PeripheryAir<BabyBearParameters>, 1> | prover | 0 | 4,096 | 300 | 1,228,800 | 
| app_proof | 82 | VariableRangeCheckerAir | prover | 0 | 262,144 | 4 | 1,048,576 | 
...
| app_proof | 73 | VmAirWrapper<Rv64BaseAluWAdapterAir, AddSubCoreAir<4, 8> | prover | 1 | 16,384 | 46 | 753,664 | 
| app_proof | 74 | VmAirWrapper<Rv64BaseAluAdapterAir, AndCoreAir<8, 8> | prover | 1 | 65,536 | 48 | 3,145,728 | 
| app_proof | 75 | VmAirWrapper<Rv64BaseAluAdapterAir, OrCoreAir<8, 8> | prover | 1 | 8,192 | 48 | 393,216 | 
| app_proof | 76 | VmAirWrapper<Rv64BaseAluAdapterAir, XorCoreAir<8, 8> | prover | 1 | 128 | 48 | 6,144 | 
| app_proof | 77 | VmAirWrapper<Rv64BaseAluAdapterAir, SubCoreAir<8, 8> | prover | 1 | 65,536 | 48 | 3,145,728 | 
| app_proof | 78 | VmAirWrapper<Rv64BaseAluAdapterAir, AddCoreAir<8, 8> | prover | 1 | 262,144 | 48 | 12,582,912 | 
| app_proof | 79 | BitwiseOperationLookupAir<8> | prover | 1 | 65,536 | 18 | 1,179,648 | 
| app_proof | 81 | Poseidon2PeripheryAir<BabyBearParameters>, 1> | prover | 1 | 4,096 | 300 | 1,228,800 | 
| app_proof | 82 | VariableRangeCheckerAir | prover | 1 | 262,144 | 4 | 1,048,576 | 
...
| internal_recursive.0 | 1 | 10 | 93 | 10 | 1 | 0 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 8 | 84 | 8 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 111 | 409 | 110 | 25 | 11 | 20 | 4 | 4 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,577,915 | 118 | 38 | 0 | 0 | 63 | 21 | 20 | 29 | 12 | 0 | 16 | 8 | 7 | 1 | 5 | 38 | 63 | 0 | 1 | 11 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,703 | 82 | 16 | 0 | 0 | 47 | 17 | 17 | 20 | 9 | 0 | 17 | 11 | 5 | 1 | 4 | 16 | 47 | 0 | 1 | 9 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 75 | 11 | 0 | 0 | 49 | 20 | 19 | 18 | 10 | 0 | 13 | 8 | 5 | 0 | 4 | 11 | 49 | 0 | 1 | 9 | 0 | 0 | 
| leaf | 0 | prover | 263,565,172 | 298 | 129 | 0 | 1 | 141 | 48 | 48 | 37 | 54 | 0 | 27 | 12 | 15 | 7 | 8 | 129 | 141 | 0 | 2 | 53 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 573,224,468 | 934 | 295 | 0 | 161 | 585 | 343 | 341 | 132 | 110 | 53 | 52 | 13 | 39 | 16 | 22 | 295 | 585 | 0 | 1 | 55 | 0 | 0 | 
| app_proof | prover | 1 | 533,761,420 | 489 | 136 | 0 | 1 | 311 | 180 | 179 | 77 | 53 | 0 | 41 | 13 | 27 | 14 | 13 | 136 | 311 | 0 | 1 | 52 | 0 | 0 | 

| group | phase | segment | trace_height_constraint | weighted_sum | threshold |
| --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 0 | 50,339,554 | 2,013,265,921 | 
| app_proof | prover | 1 | 0 | 34,064,010 | 2,013,265,921 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 42 | 1,211 | 42 | 178 | 0 | 3 | 56 | 1,168,000 | 33.08 | 
| app_proof | 1 | 16 | 671 | 16 | 40 | 0 | 1 | 124 | 811,971 | 34.89 | 

...
|:---|---:|---:|---:|
| Total |  16.96 |  4.98 |  4.98 |
| app_proof |  13.97 |  2.75 |  2.75 |
| leaf |  2.19 |  1.43 |  1.43 |
...
| `total_proof_time_ms ` |  2,304.83 |  13,829 |  2,614 |  2,202 |
...
| `execute_preflight_time_ms` |  237.17 |  1,423 |  326 |  85 |
| `execute_preflight_insn_mi/s` |  36.42 | -          |  37.23 |  33.56 |
| `trace_gen_time_ms   ` |  54.17 |  325 |  156 |  33 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,951.50 |  11,709 |  2,210 |  1,893 |
| `prover.main_trace_commit_time_ms` |  709 |  4,254 |  879 |  674 |
| `prover.rap_constraints_time_ms` |  1,061 |  6,366 |  1,150 |  1,039 |
| `prover.openings_time_ms` |  180.83 |  1,085 |  183 |  179 |
| `prover.rap_constraints.logup_gkr_time_ms` |  242.33 |  1,454 |  297 |  230 |
| `prover.rap_constraints.round0_time_ms` |  507.83 |  3,047 |  518 |  503 |
| `prover.rap_constraints.mle_rounds_time_ms` |  309.83 |  1,859 |  333 |  304 |
...
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  53.83 |  323 |  54 |  53 |
| `prover.openings.whir_time_ms` |  43 |  258 |  45 |  41 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,096.50 |  2,193 |  1,429 |  764 |
| `execute_preflight_time_ms` |  5.50 |  11 |  6 |  5 |
| `trace_gen_time_ms   ` |  138 |  276 |  183 |  93 |
| `generate_blob_total_time_ms` |  24.50 |  49 |  33 |  16 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  958 |  1,916 |  1,245 |  671 |
| `prover.main_trace_commit_time_ms` |  545.50 |  1,091 |  719 |  372 |
| `prover.rap_constraints_time_ms` |  318 |  636 |  409 |  227 |
| `prover.openings_time_ms` |  94 |  188 |  117 |  71 |
| `prover.rap_constraints.logup_gkr_time_ms` |  68 |  136 |  86 |  50 |
| `prover.rap_constraints.round0_time_ms` |  155.50 |  311 |  202 |  109 |
...
| `prover.openings.whir_time_ms` |  40 |  80 |  46 |  34 |
...
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  460 |  460 |  460 |  460 |
| `prover.main_trace_commit_time_ms` |  240 |  240 |  240 |  240 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/64815b88cc8ae5af27517a12f8539ebcdfdc73fe/keccak-64815b88cc8ae5af27517a12f8539ebcdfdc73fe.memory.svg)

| Module | Max (GB) | Max At |
| --- | ---: | --- |
| prover.rap_constraints | 14.56 | app_proof.prover.4 |
| prover.merkle_tree | 13.19 | app_proof.prover.4 |
| prover.openings | 13.19 | app_proof.prover.4 |
| prover.prove_whir_opening | 13.19 | app_proof.prover.4 |
| prover.batch_constraints.round0 | 12.65 | app_proof.prover.4 |
| prover.batch_constraints.fold_ple_evals | 12.65 | app_proof.prover.4 |
| frac_sumcheck.gkr_rounds | 12.39 | app_proof.prover.4 |
| prover.batch_constraints.before_round0 | 12.39 | app_proof.prover.4 |
| frac_sumcheck.segment_tree | 12.28 | app_proof.prover.4 |
| prover.gkr_input_evals | 12.28 | app_proof.prover.4 |
| prover.before_gkr_input_evals | 10.04 | app_proof.prover.4 |
| prover.stacked_commit | 10.04 | app_proof.prover.4 |
| prover.rs_code_matrix | 10.02 | app_proof.prover.4 |
...
| 24 | VmAirWrapper<Rv64BaseAluWAdapterAir, AddSubCoreAir<4, 8> | 21 | 20 | 3 | 
| 25 | VmAirWrapper<Rv64BaseAluAdapterAir, AndCoreAir<8, 8> | 24 | 13 | 3 | 
| 26 | VmAirWrapper<Rv64BaseAluAdapterAir, OrCoreAir<8, 8> | 24 | 13 | 3 | 
| 27 | VmAirWrapper<Rv64BaseAluAdapterAir, XorCoreAir<8, 8> | 24 | 13 | 3 | 
| 28 | VmAirWrapper<Rv64BaseAluAdapterAir, SubCoreAir<8, 8> | 24 | 21 | 3 | 
| 29 | VmAirWrapper<Rv64BaseAluAdapterAir, AddCoreAir<8, 8> | 24 | 21 | 3 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 74 | 9 |  |  | 0 |  | 356 | 9 |  |  |  |  |  |  | 
| app_proof |  |  |  |  |  | 2,202 |  |  | 138 | 14,365,133 | 103.92 | 0 | 13,976 |  | 
| internal_for_leaf |  |  |  | 500 |  |  |  |  |  |  |  |  |  | 500 | 
...
| app_proof | VmAirWrapper<Rv64BaseAluAdapterAir, AddCoreAir<8, 8> | 0 | 3 | 
| app_proof | VmAirWrapper<Rv64BaseAluAdapterAir, AndCoreAir<8, 8> | 0 | 0 | 
| app_proof | VmAirWrapper<Rv64BaseAluAdapterAir, OrCoreAir<8, 8> | 0 | 0 | 
...
| app_proof | VmAirWrapper<Rv64BaseAluAdapterAir, XorCoreAir<8, 8> | 0 | 0 | 
...
| app_proof | VmAirWrapper<Rv64BaseAluAdapterAir, AddCoreAir<8, 8> | 1 | 3 | 
| app_proof | VmAirWrapper<Rv64BaseAluAdapterAir, AndCoreAir<8, 8> | 1 | 0 | 
| app_proof | VmAirWrapper<Rv64BaseAluAdapterAir, OrCoreAir<8, 8> | 1 | 0 | 
| app_proof | VmAirWrapper<Rv64BaseAluAdapterAir, ShiftCoreAir<8, 8> | 1 | 1 | 
| app_proof | VmAirWrapper<Rv64BaseAluAdapterAir, SubCoreAir<8, 8> | 1 | 0 | 
| app_proof | VmAirWrapper<Rv64BaseAluAdapterAir, XorCoreAir<8, 8> | 1 | 0 | 
...
| app_proof | VmAirWrapper<Rv64BaseAluAdapterAir, AddCoreAir<8, 8> | 2 | 3 | 
| app_proof | VmAirWrapper<Rv64BaseAluAdapterAir, AndCoreAir<8, 8> | 2 | 0 | 
| app_proof | VmAirWrapper<Rv64BaseAluAdapterAir, OrCoreAir<8, 8> | 2 | 0 | 
| app_proof | VmAirWrapper<Rv64BaseAluAdapterAir, ShiftCoreAir<8, 8> | 2 | 1 | 
| app_proof | VmAirWrapper<Rv64BaseAluAdapterAir, SubCoreAir<8, 8> | 2 | 0 | 
| app_proof | VmAirWrapper<Rv64BaseAluAdapterAir, XorCoreAir<8, 8> | 2 | 0 | 
...
| app_proof | VmAirWrapper<Rv64BaseAluAdapterAir, AddCoreAir<8, 8> | 3 | 3 | 
| app_proof | VmAirWrapper<Rv64BaseAluAdapterAir, AndCoreAir<8, 8> | 3 | 0 | 
| app_proof | VmAirWrapper<Rv64BaseAluAdapterAir, OrCoreAir<8, 8> | 3 | 0 | 
| app_proof | VmAirWrapper<Rv64BaseAluAdapterAir, ShiftCoreAir<8, 8> | 3 | 1 | 
| app_proof | VmAirWrapper<Rv64BaseAluAdapterAir, SubCoreAir<8, 8> | 3 | 0 | 
| app_proof | VmAirWrapper<Rv64BaseAluAdapterAir, XorCoreAir<8, 8> | 3 | 0 | 
...
| app_proof | VmAirWrapper<Rv64BaseAluAdapterAir, AddCoreAir<8, 8> | 4 | 3 | 
| app_proof | VmAirWrapper<Rv64BaseAluAdapterAir, AndCoreAir<8, 8> | 4 | 0 | 
| app_proof | VmAirWrapper<Rv64BaseAluAdapterAir, OrCoreAir<8, 8> | 4 | 0 | 
| app_proof | VmAirWrapper<Rv64BaseAluAdapterAir, ShiftCoreAir<8, 8> | 4 | 1 | 
| app_proof | VmAirWrapper<Rv64BaseAluAdapterAir, SubCoreAir<8, 8> | 4 | 0 | 
| app_proof | VmAirWrapper<Rv64BaseAluAdapterAir, XorCoreAir<8, 8> | 4 | 0 | 
| app_proof | VmAirWrapper<Rv64BaseAluWAdapterAir, AddSubCoreAir<4, 8> | 4 | 0 | 
...
| app_proof | VmAirWrapper<Rv64BaseAluAdapterAir, AddCoreAir<8, 8> | 5 | 3 | 
| app_proof | VmAirWrapper<Rv64BaseAluAdapterAir, AndCoreAir<8, 8> | 5 | 0 | 
| app_proof | VmAirWrapper<Rv64BaseAluAdapterAir, OrCoreAir<8, 8> | 5 | 0 | 
| app_proof | VmAirWrapper<Rv64BaseAluAdapterAir, ShiftCoreAir<8, 8> | 5 | 1 | 
| app_proof | VmAirWrapper<Rv64BaseAluAdapterAir, SubCoreAir<8, 8> | 5 | 0 | 
| app_proof | VmAirWrapper<Rv64BaseAluAdapterAir, XorCoreAir<8, 8> | 5 | 0 | 
| app_proof | VmAirWrapper<Rv64BaseAluWAdapterAir, AddSubCoreAir<4, 8> | 5 | 0 | 
...
| app_proof | 24 | VmAirWrapper<Rv64BaseAluWAdapterAir, AddSubCoreAir<4, 8> | prover | 0 | 32,768 | 46 | 1,507,328 | 
| app_proof | 25 | VmAirWrapper<Rv64BaseAluAdapterAir, AndCoreAir<8, 8> | prover | 0 | 131,072 | 48 | 6,291,456 | 
| app_proof | 26 | VmAirWrapper<Rv64BaseAluAdapterAir, OrCoreAir<8, 8> | prover | 0 | 32,768 | 48 | 1,572,864 | 
| app_proof | 27 | VmAirWrapper<Rv64BaseAluAdapterAir, XorCoreAir<8, 8> | prover | 0 | 32,768 | 48 | 1,572,864 | 
| app_proof | 28 | VmAirWrapper<Rv64BaseAluAdapterAir, SubCoreAir<8, 8> | prover | 0 | 32,768 | 48 | 1,572,864 | 
| app_proof | 29 | VmAirWrapper<Rv64BaseAluAdapterAir, AddCoreAir<8, 8> | prover | 0 | 1,048,576 | 48 | 50,331,648 | 
...
| app_proof | 24 | VmAirWrapper<Rv64BaseAluWAdapterAir, AddSubCoreAir<4, 8> | prover | 1 | 32,768 | 46 | 1,507,328 | 
| app_proof | 25 | VmAirWrapper<Rv64BaseAluAdapterAir, AndCoreAir<8, 8> | prover | 1 | 131,072 | 48 | 6,291,456 | 
| app_proof | 26 | VmAirWrapper<Rv64BaseAluAdapterAir, OrCoreAir<8, 8> | prover | 1 | 32,768 | 48 | 1,572,864 | 
| app_proof | 27 | VmAirWrapper<Rv64BaseAluAdapterAir, XorCoreAir<8, 8> | prover | 1 | 32,768 | 48 | 1,572,864 | 
| app_proof | 28 | VmAirWrapper<Rv64BaseAluAdapterAir, SubCoreAir<8, 8> | prover | 1 | 32,768 | 48 | 1,572,864 | 
| app_proof | 29 | VmAirWrapper<Rv64BaseAluAdapterAir, AddCoreAir<8, 8> | prover | 1 | 1,048,576 | 48 | 50,331,648 | 
...
| app_proof | 24 | VmAirWrapper<Rv64BaseAluWAdapterAir, AddSubCoreAir<4, 8> | prover | 2 | 32,768 | 46 | 1,507,328 | 
| app_proof | 25 | VmAirWrapper<Rv64BaseAluAdapterAir, AndCoreAir<8, 8> | prover | 2 | 131,072 | 48 | 6,291,456 | 
| app_proof | 26 | VmAirWrapper<Rv64BaseAluAdapterAir, OrCoreAir<8, 8> | prover | 2 | 32,768 | 48 | 1,572,864 | 
| app_proof | 27 | VmAirWrapper<Rv64BaseAluAdapterAir, XorCoreAir<8, 8> | prover | 2 | 32,768 | 48 | 1,572,864 | 
| app_proof | 28 | VmAirWrapper<Rv64BaseAluAdapterAir, SubCoreAir<8, 8> | prover | 2 | 32,768 | 48 | 1,572,864 | 
| app_proof | 29 | VmAirWrapper<Rv64BaseAluAdapterAir, AddCoreAir<8, 8> | prover | 2 | 1,048,576 | 48 | 50,331,648 | 
...
| app_proof | 32 | Poseidon2PeripheryAir<BabyBearParameters>, 1> | prover | 2 | 512 | 300 | 153,600 | 
...
| app_proof | 24 | VmAirWrapper<Rv64BaseAluWAdapterAir, AddSubCoreAir<4, 8> | prover | 3 | 32,768 | 46 | 1,507,328 | 
| app_proof | 25 | VmAirWrapper<Rv64BaseAluAdapterAir, AndCoreAir<8, 8> | prover | 3 | 131,072 | 48 | 6,291,456 | 
| app_proof | 26 | VmAirWrapper<Rv64BaseAluAdapterAir, OrCoreAir<8, 8> | prover | 3 | 32,768 | 48 | 1,572,864 | 
| app_proof | 27 | VmAirWrapper<Rv64BaseAluAdapterAir, XorCoreAir<8, 8> | prover | 3 | 32,768 | 48 | 1,572,864 | 
| app_proof | 28 | VmAirWrapper<Rv64BaseAluAdapterAir, SubCoreAir<8, 8> | prover | 3 | 32,768 | 48 | 1,572,864 | 
| app_proof | 29 | VmAirWrapper<Rv64BaseAluAdapterAir, AddCoreAir<8, 8> | prover | 3 | 1,048,576 | 48 | 50,331,648 | 
...
| app_proof | 32 | Poseidon2PeripheryAir<BabyBearParameters>, 1> | prover | 3 | 512 | 300 | 153,600 | 
...
| app_proof | 24 | VmAirWrapper<Rv64BaseAluWAdapterAir, AddSubCoreAir<4, 8> | prover | 4 | 32,768 | 46 | 1,507,328 | 
| app_proof | 25 | VmAirWrapper<Rv64BaseAluAdapterAir, AndCoreAir<8, 8> | prover | 4 | 131,072 | 48 | 6,291,456 | 
| app_proof | 26 | VmAirWrapper<Rv64BaseAluAdapterAir, OrCoreAir<8, 8> | prover | 4 | 32,768 | 48 | 1,572,864 | 
| app_proof | 27 | VmAirWrapper<Rv64BaseAluAdapterAir, XorCoreAir<8, 8> | prover | 4 | 32,768 | 48 | 1,572,864 | 
| app_proof | 28 | VmAirWrapper<Rv64BaseAluAdapterAir, SubCoreAir<8, 8> | prover | 4 | 32,768 | 48 | 1,572,864 | 
| app_proof | 29 | VmAirWrapper<Rv64BaseAluAdapterAir, AddCoreAir<8, 8> | prover | 4 | 1,048,576 | 48 | 50,331,648 | 
...
| app_proof | 32 | Poseidon2PeripheryAir<BabyBearParameters>, 1> | prover | 4 | 512 | 300 | 153,600 | 
...
| app_proof | 24 | VmAirWrapper<Rv64BaseAluWAdapterAir, AddSubCoreAir<4, 8> | prover | 5 | 32,768 | 46 | 1,507,328 | 
| app_proof | 25 | VmAirWrapper<Rv64BaseAluAdapterAir, AndCoreAir<8, 8> | prover | 5 | 131,072 | 48 | 6,291,456 | 
| app_proof | 26 | VmAirWrapper<Rv64BaseAluAdapterAir, OrCoreAir<8, 8> | prover | 5 | 32,768 | 48 | 1,572,864 | 
| app_proof | 27 | VmAirWrapper<Rv64BaseAluAdapterAir, XorCoreAir<8, 8> | prover | 5 | 32,768 | 48 | 1,572,864 | 
| app_proof | 28 | VmAirWrapper<Rv64BaseAluAdapterAir, SubCoreAir<8, 8> | prover | 5 | 32,768 | 48 | 1,572,864 | 
| app_proof | 29 | VmAirWrapper<Rv64BaseAluAdapterAir, AddCoreAir<8, 8> | prover | 5 | 1,048,576 | 48 | 50,331,648 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 40 |
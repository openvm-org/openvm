...
|:---|---:|---:|---:|
| Total |  9.69 |  4.20 |  4.20 |
| app_proof |  8.24 |  2.75 |  2.75 |
| leaf |  0.89 |  0.89 |  0.89 |
...
| `total_proof_time_ms ` |  2,036.25 |  8,145 |  2,656 |  623 |
...
| `execute_preflight_time_ms` |  165 |  660 |  276 |  31 |
| `execute_preflight_insn_mi/s` |  37.45 | -          |  38.87 |  35.16 |
| `trace_gen_time_ms   ` |  116.75 |  467 |  183 |  66 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,681.25 |  6,725 |  2,218 |  367 |
| `prover.main_trace_commit_time_ms` |  459 |  1,836 |  685 |  86 |
| `prover.rap_constraints_time_ms` |  1,104 |  4,416 |  1,395 |  239 |
| `prover.openings_time_ms` |  117.50 |  470 |  146 |  41 |
| `prover.rap_constraints.logup_gkr_time_ms` |  328.50 |  1,314 |  417 |  75 |
| `prover.rap_constraints.round0_time_ms` |  520.50 |  2,082 |  659 |  111 |
| `prover.rap_constraints.mle_rounds_time_ms` |  254 |  1,016 |  322 |  53 |
| `prover.openings.stacked_reduction_time_ms` |  83.25 |  333 |  106 |  18 |
| `prover.openings.stacked_reduction.round0_time_ms` |  50.50 |  202 |  66 |  9 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  32.50 |  130 |  41 |  8 |
| `prover.openings.whir_time_ms` |  33.75 |  135 |  40 |  23 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/5fe86793edfbaadc9ae49aa259adeb8f4c00bcb4/sha2_bench-5fe86793edfbaadc9ae49aa259adeb8f4c00bcb4.memory.svg)
...
| app_proof |  |  |  |  |  | 623 |  |  | 93 | 11,167,961 | 119.46 | 0 | 8,246 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 20 | 275 | 19 | 6 | 1 | 2 | 2 | 2 | 
| internal_recursive.0 | 1 | 11 | 151 | 10 | 1 | 0 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 10 | 130 | 10 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 130 | 891 | 129 | 48 | 21 | 2 | 1 | 1 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,577,915 | 255 | 115 | 0 | 0 | 105 | 34 | 33 | 50 | 20 | 0 | 33 | 20 | 13 | 3 | 9 | 116 | 105 | 0 | 2 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,703 | 140 | 45 | 0 | 0 | 66 | 24 | 23 | 27 | 14 | 0 | 27 | 19 | 8 | 1 | 6 | 46 | 66 | 0 | 2 | 12 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 119 | 31 | 0 | 0 | 60 | 22 | 21 | 24 | 13 | 0 | 26 | 19 | 7 | 1 | 5 | 31 | 60 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 267,458,790 | 760 | 403 | 0 | 1 | 279 | 127 | 126 | 78 | 72 | 0 | 77 | 37 | 40 | 21 | 18 | 404 | 279 | 0 | 6 | 71 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 686,312,761 | 2,218 | 684 | 0 | 156 | 1,393 | 659 | 658 | 321 | 411 | 116 | 140 | 34 | 105 | 64 | 41 | 685 | 1,392 | 0 | 3 | 294 | 0 | 0 | 
| app_proof | prover | 1 | 686,312,460 | 2,075 | 532 | 0 | 2 | 1,395 | 655 | 655 | 322 | 417 | 126 | 146 | 40 | 106 | 66 | 40 | 532 | 1,395 | 0 | 3 | 291 | 0 | 0 | 
| app_proof | prover | 2 | 686,312,460 | 2,065 | 533 | 0 | 2 | 1,389 | 657 | 657 | 320 | 411 | 121 | 143 | 38 | 104 | 63 | 41 | 533 | 1,389 | 0 | 4 | 288 | 0 | 0 | 
| app_proof | prover | 3 | 106,273,044 | 367 | 86 | 0 | 0 | 239 | 111 | 110 | 53 | 75 | 0 | 41 | 23 | 18 | 9 | 8 | 86 | 239 | 0 | 3 | 74 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 152 | 2,656 | 152 | 164 | 0 | 3 | 120 | 3,562,000 | 35.16 | 
| app_proof | 1 | 66 | 2,459 | 66 | 41 | 0 | 1 | 276 | 3,562,000 | 38.87 | 
| app_proof | 2 | 66 | 2,407 | 66 | 41 | 0 | 1 | 233 | 3,562,000 | 38.82 | 
| app_proof | 3 | 183 | 623 | 183 | 41 | 0 | 2 | 31 | 481,961 | 36.95 | 

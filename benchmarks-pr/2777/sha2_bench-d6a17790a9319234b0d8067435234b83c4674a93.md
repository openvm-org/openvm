...
|:---|---:|---:|---:|
| Total |  10.06 |  4.40 |  4.40 |
| app_proof |  8.50 |  2.84 |  2.84 |
| leaf |  0.93 |  0.93 |  0.93 |
...
| `total_proof_time_ms ` |  2,101.75 |  8,407 |  2,744 |  657 |
...
| `execute_preflight_time_ms` |  162.25 |  649 |  270 |  30 |
| `execute_preflight_insn_mi/s` |  37.09 | -          |  38.44 |  34.70 |
| `trace_gen_time_ms   ` |  121.25 |  485 |  191 |  67 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,745.25 |  6,981 |  2,298 |  394 |
| `prover.main_trace_commit_time_ms` |  469.75 |  1,879 |  700 |  90 |
| `prover.rap_constraints_time_ms` |  1,148 |  4,592 |  1,448 |  257 |
| `prover.openings_time_ms` |  126.50 |  506 |  155 |  46 |
| `prover.rap_constraints.logup_gkr_time_ms` |  343.50 |  1,374 |  435 |  80 |
| `prover.rap_constraints.round0_time_ms` |  540.25 |  2,161 |  680 |  124 |
| `prover.rap_constraints.mle_rounds_time_ms` |  263 |  1,052 |  334 |  51 |
| `prover.openings.stacked_reduction_time_ms` |  94.50 |  378 |  118 |  26 |
| `prover.openings.stacked_reduction.round0_time_ms` |  52 |  208 |  67 |  9 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  41.50 |  166 |  52 |  16 |
| `prover.openings.whir_time_ms` |  32 |  128 |  38 |  20 |
...
| `prover.main_trace_commit_time_ms` |  416 |  416 |  416 |  416 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/d6a17790a9319234b0d8067435234b83c4674a93/sha2_bench-d6a17790a9319234b0d8067435234b83c4674a93.memory.svg)
...
| app_proof |  |  |  |  |  | 657 |  |  | 94 | 11,167,961 | 118.08 | 0 | 8,508 |  | 
| internal_for_leaf |  |  |  | 305 |  |  |  |  |  |  |  |  |  | 305 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,577,915 | 284 | 121 | 0 | 7 | 112 | 34 | 33 | 51 | 26 | 0 | 50 | 21 | 28 | 3 | 25 | 121 | 112 | 0 | 2 | 25 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,703 | 164 | 49 | 0 | 4 | 72 | 24 | 23 | 28 | 19 | 0 | 42 | 19 | 23 | 1 | 21 | 49 | 72 | 0 | 2 | 18 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 141 | 34 | 0 | 4 | 66 | 23 | 22 | 24 | 18 | 0 | 40 | 17 | 22 | 1 | 21 | 34 | 66 | 0 | 2 | 17 | 0 | 0 | 
| leaf | 0 | prover | 267,458,790 | 802 | 415 | 0 | 26 | 295 | 134 | 133 | 81 | 79 | 0 | 90 | 33 | 56 | 22 | 33 | 416 | 295 | 0 | 6 | 78 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 686,312,761 | 2,298 | 700 | 0 | 198 | 1,445 | 680 | 680 | 333 | 431 | 107 | 152 | 34 | 118 | 65 | 52 | 700 | 1,445 | 0 | 3 | 322 | 0 | 0 | 
| app_proof | prover | 1 | 686,312,460 | 2,149 | 545 | 0 | 42 | 1,448 | 678 | 677 | 334 | 435 | 125 | 155 | 38 | 117 | 67 | 49 | 545 | 1,448 | 0 | 3 | 309 | 0 | 0 | 
| app_proof | prover | 2 | 686,312,460 | 2,140 | 543 | 0 | 42 | 1,442 | 679 | 678 | 334 | 428 | 119 | 153 | 36 | 117 | 67 | 49 | 544 | 1,442 | 0 | 3 | 307 | 0 | 0 | 
| app_proof | prover | 3 | 106,273,044 | 394 | 90 | 0 | 7 | 257 | 124 | 123 | 51 | 80 | 0 | 46 | 20 | 26 | 9 | 16 | 90 | 257 | 0 | 3 | 79 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 160 | 2,744 | 160 | 164 | 0 | 3 | 120 | 3,562,000 | 34.70 | 
| app_proof | 1 | 67 | 2,528 | 67 | 41 | 0 | 1 | 270 | 3,562,000 | 38.15 | 
| app_proof | 2 | 67 | 2,478 | 67 | 41 | 0 | 1 | 229 | 3,562,000 | 38.44 | 
| app_proof | 3 | 191 | 657 | 191 | 41 | 0 | 2 | 30 | 481,961 | 37.07 | 

...
|:---|---:|---:|---:|
| Total |  17.29 |  5.15 |  5.15 |
| app_proof |  14.13 |  2.76 |  2.76 |
| leaf |  2.36 |  1.60 |  1.60 |
...
| `total_proof_time_ms ` |  2,332.67 |  13,996 |  2,620 |  2,214 |
| `execute_metered_time_ms` |  139 | -          | -          | -          |
| `execute_metered_insns` |  14,365,133 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  103.04 | -          |  103.04 |  103.04 |
| `execute_preflight_insns` |  2,394,188.83 |  14,365,133 |  2,413,000 |  2,300,133 |
| `execute_preflight_time_ms` |  236.83 |  1,421 |  323 |  88 |
| `execute_preflight_insn_mi/s` |  35.07 | -          |  35.94 |  32.57 |
| `trace_gen_time_ms   ` |  53.83 |  323 |  154 |  33 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,979.67 |  11,878 |  2,215 |  1,911 |
| `prover.main_trace_commit_time_ms` |  711.50 |  4,269 |  876 |  676 |
| `prover.rap_constraints_time_ms` |  1,084.67 |  6,508 |  1,152 |  1,048 |
| `prover.openings_time_ms` |  182.67 |  1,096 |  186 |  178 |
| `prover.rap_constraints.logup_gkr_time_ms` |  244.17 |  1,465 |  298 |  231 |
| `prover.rap_constraints.round0_time_ms` |  526 |  3,156 |  600 |  506 |
| `prover.rap_constraints.mle_rounds_time_ms` |  313.33 |  1,880 |  332 |  305 |
| `prover.openings.stacked_reduction_time_ms` |  138.17 |  829 |  140 |  134 |
| `prover.openings.stacked_reduction.round0_time_ms` |  83.67 |  502 |  85 |  80 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  54.17 |  325 |  55 |  53 |
| `prover.openings.whir_time_ms` |  44 |  264 |  47 |  41 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,181 |  2,362 |  1,596 |  766 |
| `execute_preflight_time_ms` |  5.50 |  11 |  6 |  5 |
| `trace_gen_time_ms   ` |  136.50 |  273 |  181 |  92 |
| `generate_blob_total_time_ms` |  24.50 |  49 |  33 |  16 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,044 |  2,088 |  1,415 |  673 |
| `prover.main_trace_commit_time_ms` |  630.50 |  1,261 |  889 |  372 |
| `prover.rap_constraints_time_ms` |  318.50 |  637 |  409 |  228 |
...
| `prover.openings.stacked_reduction_time_ms` |  53 |  106 |  70 |  36 |
...
| `prover.openings.whir_time_ms` |  39.50 |  79 |  44 |  35 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/5fe86793edfbaadc9ae49aa259adeb8f4c00bcb4/keccak-5fe86793edfbaadc9ae49aa259adeb8f4c00bcb4.memory.svg)
...
| app_proof |  |  |  |  |  | 2,214 |  |  | 139 | 14,365,133 | 103.04 | 0 | 14,142 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 37 | 500 | 37 | 13 | 4 | 2 | 2 | 2 | 
| internal_recursive.0 | 1 | 14 | 165 | 13 | 2 | 1 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 10 | 129 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 181 | 1,596 | 181 | 64 | 33 | 6 | 7 | 7 | 
| leaf | 1 | 92 | 766 | 92 | 32 | 16 | 5 | 7 | 7 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 81,415,028 | 462 | 243 | 0 | 1 | 171 | 49 | 48 | 91 | 30 | 0 | 47 | 23 | 23 | 7 | 15 | 243 | 171 | 0 | 3 | 29 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,879 | 151 | 49 | 0 | 0 | 72 | 25 | 24 | 29 | 17 | 0 | 28 | 19 | 8 | 2 | 6 | 49 | 72 | 0 | 2 | 17 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 119 | 31 | 0 | 0 | 61 | 22 | 22 | 25 | 13 | 0 | 26 | 19 | 7 | 1 | 5 | 32 | 61 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 476,578,662 | 1,415 | 889 | 0 | 173 | 409 | 204 | 203 | 119 | 85 | 0 | 115 | 44 | 70 | 40 | 30 | 889 | 409 | 0 | 7 | 84 | 0 | 0 | 
| leaf | 1 | prover | 240,255,732 | 673 | 372 | 0 | 1 | 228 | 109 | 108 | 67 | 51 | 0 | 71 | 35 | 36 | 19 | 16 | 372 | 228 | 0 | 6 | 49 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 867,606,540 | 2,215 | 876 | 0 | 205 | 1,152 | 521 | 520 | 332 | 298 | 74 | 186 | 46 | 140 | 84 | 55 | 876 | 1,152 | 0 | 3 | 222 | 0 | 0 | 
| app_proof | prover | 1 | 867,683,340 | 2,002 | 679 | 0 | 2 | 1,138 | 600 | 599 | 306 | 231 | 0 | 184 | 47 | 137 | 84 | 53 | 679 | 1,138 | 0 | 3 | 230 | 0 | 0 | 
| app_proof | prover | 2 | 867,683,340 | 1,926 | 679 | 0 | 3 | 1,069 | 509 | 509 | 325 | 233 | 0 | 178 | 43 | 134 | 80 | 53 | 679 | 1,069 | 0 | 4 | 232 | 0 | 0 | 
| app_proof | prover | 3 | 867,683,340 | 1,913 | 676 | 0 | 3 | 1,052 | 511 | 510 | 306 | 234 | 0 | 184 | 45 | 139 | 85 | 54 | 676 | 1,052 | 0 | 4 | 232 | 0 | 0 | 
| app_proof | prover | 4 | 867,683,340 | 1,911 | 680 | 0 | 3 | 1,049 | 509 | 509 | 305 | 234 | 0 | 181 | 41 | 139 | 84 | 55 | 680 | 1,049 | 0 | 3 | 233 | 0 | 0 | 
| app_proof | prover | 5 | 867,606,540 | 1,911 | 679 | 0 | 3 | 1,048 | 506 | 506 | 306 | 235 | 0 | 183 | 42 | 140 | 85 | 55 | 679 | 1,048 | 0 | 3 | 234 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 154 | 2,620 | 154 | 161 | 0 | 4 | 88 | 2,413,000 | 32.57 | 
| app_proof | 1 | 34 | 2,401 | 34 | 41 | 0 | 1 | 323 | 2,413,000 | 35.61 | 
| app_proof | 2 | 34 | 2,263 | 34 | 41 | 0 | 1 | 260 | 2,413,000 | 35.94 | 
| app_proof | 3 | 34 | 2,252 | 34 | 41 | 0 | 1 | 262 | 2,413,000 | 34.68 | 
| app_proof | 4 | 34 | 2,246 | 34 | 41 | 0 | 1 | 260 | 2,413,000 | 35.83 | 
| app_proof | 5 | 33 | 2,214 | 33 | 41 | 0 | 1 | 228 | 2,300,133 | 35.78 | 

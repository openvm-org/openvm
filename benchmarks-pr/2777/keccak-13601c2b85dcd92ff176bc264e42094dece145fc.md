...
|:---|---:|---:|---:|
| Total |  16.90 |  5.02 |  5.02 |
| app_proof |  13.78 |  2.69 |  2.69 |
| leaf |  2.25 |  1.46 |  1.46 |
...
| `total_proof_time_ms ` |  2,274 |  13,644 |  2,557 |  2,178 |
| `execute_metered_time_ms` |  137 | -          | -          | -          |
| `execute_metered_insns` |  14,365,133 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  104.27 | -          |  104.27 |  104.27 |
| `execute_preflight_insns` |  2,394,188.83 |  14,365,133 |  2,413,000 |  2,300,133 |
| `execute_preflight_time_ms` |  239 |  1,434 |  319 |  91 |
| `execute_preflight_insn_mi/s` |  32.92 | -          |  33.84 |  30.27 |
| `trace_gen_time_ms   ` |  54 |  324 |  155 |  33 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,919.17 |  11,515 |  2,149 |  1,871 |
| `prover.main_trace_commit_time_ms` |  716 |  4,296 |  882 |  682 |
| `prover.rap_constraints_time_ms` |  1,016.17 |  6,097 |  1,078 |  1,001 |
| `prover.openings_time_ms` |  186.17 |  1,117 |  190 |  183 |
| `prover.rap_constraints.logup_gkr_time_ms` |  181.67 |  1,090 |  235 |  170 |
| `prover.rap_constraints.round0_time_ms` |  518.83 |  3,113 |  523 |  510 |
| `prover.rap_constraints.mle_rounds_time_ms` |  314.67 |  1,888 |  332 |  309 |
| `prover.openings.stacked_reduction_time_ms` |  144.33 |  866 |  146 |  140 |
| `prover.openings.stacked_reduction.round0_time_ms` |  83.83 |  503 |  85 |  79 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  60 |  360 |  60 |  60 |
| `prover.openings.whir_time_ms` |  41 |  246 |  44 |  38 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,125 |  2,250 |  1,458 |  792 |
| `execute_preflight_time_ms` |  5.50 |  11 |  6 |  5 |
| `trace_gen_time_ms   ` |  137.50 |  275 |  183 |  92 |
| `generate_blob_total_time_ms` |  24.50 |  49 |  33 |  16 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  986.50 |  1,973 |  1,274 |  699 |
| `prover.main_trace_commit_time_ms` |  553 |  1,106 |  727 |  379 |
| `prover.rap_constraints_time_ms` |  328 |  656 |  420 |  236 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/13601c2b85dcd92ff176bc264e42094dece145fc/keccak-13601c2b85dcd92ff176bc264e42094dece145fc.memory.svg)
...
| app_proof |  |  |  |  |  | 2,178 |  |  | 137 | 14,365,133 | 104.27 | 0 | 13,790 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 38 | 530 | 38 | 13 | 4 | 2 | 2 | 2 | 
| internal_recursive.0 | 1 | 14 | 189 | 14 | 2 | 1 | 2 | 2 | 2 | 
| internal_recursive.1 | 1 | 9 | 152 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 183 | 1,458 | 183 | 64 | 33 | 6 | 7 | 7 | 
| leaf | 1 | 92 | 792 | 92 | 32 | 16 | 5 | 7 | 7 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 81,415,028 | 492 | 247 | 0 | 14 | 178 | 49 | 48 | 93 | 36 | 0 | 65 | 26 | 38 | 7 | 30 | 247 | 178 | 0 | 2 | 35 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,879 | 174 | 51 | 0 | 4 | 77 | 24 | 23 | 29 | 24 | 0 | 45 | 20 | 24 | 1 | 22 | 51 | 77 | 0 | 2 | 23 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 143 | 34 | 0 | 4 | 66 | 23 | 23 | 24 | 17 | 0 | 42 | 19 | 22 | 1 | 21 | 34 | 66 | 0 | 2 | 17 | 0 | 0 | 
| leaf | 0 | prover | 476,578,662 | 1,274 | 727 | 0 | 48 | 420 | 207 | 206 | 123 | 89 | 0 | 126 | 39 | 86 | 40 | 45 | 727 | 420 | 0 | 6 | 88 | 0 | 0 | 
| leaf | 1 | prover | 240,255,732 | 699 | 378 | 0 | 24 | 236 | 110 | 110 | 68 | 57 | 0 | 84 | 31 | 52 | 20 | 32 | 379 | 236 | 0 | 6 | 56 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 857,743,372 | 2,149 | 882 | 0 | 258 | 1,078 | 510 | 509 | 332 | 235 | 65 | 188 | 41 | 146 | 85 | 60 | 882 | 1,078 | 0 | 3 | 169 | 0 | 0 | 
| app_proof | prover | 1 | 857,820,172 | 1,881 | 682 | 0 | 58 | 1,008 | 523 | 522 | 312 | 172 | 0 | 190 | 44 | 145 | 85 | 60 | 682 | 1,008 | 0 | 3 | 171 | 0 | 0 | 
| app_proof | prover | 2 | 857,820,172 | 1,871 | 683 | 0 | 58 | 1,004 | 521 | 521 | 311 | 171 | 0 | 183 | 43 | 140 | 79 | 60 | 683 | 1,004 | 0 | 3 | 170 | 0 | 0 | 
| app_proof | prover | 3 | 857,820,172 | 1,871 | 683 | 0 | 58 | 1,001 | 520 | 519 | 309 | 171 | 0 | 186 | 40 | 145 | 84 | 60 | 683 | 1,001 | 0 | 3 | 170 | 0 | 0 | 
| app_proof | prover | 4 | 857,820,172 | 1,872 | 683 | 0 | 58 | 1,004 | 520 | 520 | 312 | 171 | 0 | 184 | 38 | 145 | 85 | 60 | 683 | 1,004 | 0 | 3 | 169 | 0 | 0 | 
| app_proof | prover | 5 | 857,743,372 | 1,871 | 682 | 0 | 58 | 1,002 | 519 | 518 | 312 | 170 | 0 | 186 | 40 | 145 | 85 | 60 | 683 | 1,002 | 0 | 3 | 169 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 155 | 2,557 | 155 | 161 | 0 | 3 | 91 | 2,413,000 | 30.27 | 
| app_proof | 1 | 34 | 2,276 | 34 | 41 | 0 | 1 | 319 | 2,413,000 | 33.69 | 
| app_proof | 2 | 34 | 2,212 | 34 | 41 | 0 | 1 | 265 | 2,413,000 | 32.29 | 
| app_proof | 3 | 34 | 2,211 | 34 | 41 | 0 | 1 | 265 | 2,413,000 | 33.76 | 
| app_proof | 4 | 34 | 2,210 | 34 | 41 | 0 | 1 | 262 | 2,413,000 | 33.84 | 
| app_proof | 5 | 33 | 2,178 | 33 | 41 | 0 | 1 | 232 | 2,300,133 | 33.68 | 

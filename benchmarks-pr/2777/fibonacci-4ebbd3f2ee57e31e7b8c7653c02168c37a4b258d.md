...
|:---|---:|---:|---:|
| Total |  2.88 |  1.63 |  1.63 |
| app_proof |  1.86 |  0.61 |  0.61 |
| leaf |  0.45 |  0.45 |  0.45 |
...
| `total_proof_time_ms ` |  459.50 |  1,838 |  595 |  324 |
| `execute_metered_time_ms` |  19 | -          | -          | -          |
| `execute_metered_insns` |  4,000,051 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  201.68 | -          |  201.68 |  201.68 |
| `execute_preflight_insns` |  1,000,012.75 |  4,000,051 |  1,310,000 |  70,051 |
| `execute_preflight_time_ms` |  34.75 |  139 |  50 |  4 |
| `execute_preflight_insn_mi/s` |  40.52 | -          |  42.04 |  37.61 |
| `trace_gen_time_ms   ` |  176 |  704 |  202 |  162 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  176 |  704 |  217 |  76 |
| `prover.main_trace_commit_time_ms` |  43.25 |  173 |  53 |  16 |
| `prover.rap_constraints_time_ms` |  98.50 |  394 |  125 |  33 |
| `prover.openings_time_ms` |  33.25 |  133 |  39 |  26 |
| `prover.rap_constraints.logup_gkr_time_ms` |  63.75 |  255 |  80 |  17 |
| `prover.rap_constraints.round0_time_ms` |  20.75 |  83 |  29 |  8 |
| `prover.rap_constraints.mle_rounds_time_ms` |  13.25 |  53 |  16 |  7 |
| `prover.openings.stacked_reduction_time_ms` |  13.75 |  55 |  19 |  8 |
| `prover.openings.stacked_reduction.round0_time_ms` |  3.75 |  15 |  5 |  0 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  8.75 |  35 |  13 |  6 |
| `prover.openings.whir_time_ms` |  19.25 |  77 |  21 |  18 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  451 |  451 |  451 |  451 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/4ebbd3f2ee57e31e7b8c7653c02168c37a4b258d/fibonacci-4ebbd3f2ee57e31e7b8c7653c02168c37a4b258d.memory.svg)
...
| app_proof |  |  |  |  |  | 324 |  |  | 19 | 4,000,051 | 201.68 | 0 | 1,864 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 27,289,339 | 229 | 83 | 0 | 5 | 102 | 31 | 31 | 45 | 25 | 0 | 43 | 17 | 26 | 2 | 23 | 83 | 102 | 0 | 2 | 24 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,703 | 163 | 48 | 0 | 3 | 70 | 23 | 23 | 27 | 19 | 0 | 43 | 19 | 23 | 1 | 21 | 48 | 70 | 0 | 2 | 18 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 138 | 34 | 0 | 4 | 65 | 22 | 21 | 24 | 18 | 0 | 39 | 16 | 22 | 1 | 21 | 34 | 65 | 0 | 2 | 17 | 0 | 0 | 
| leaf | 0 | prover | 102,941,734 | 393 | 169 | 0 | 10 | 162 | 68 | 67 | 45 | 47 | 0 | 61 | 28 | 33 | 8 | 25 | 170 | 162 | 0 | 5 | 47 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 66,843,374 | 217 | 52 | 0 | 1 | 125 | 29 | 28 | 16 | 79 | 0 | 39 | 20 | 19 | 5 | 13 | 52 | 125 | 0 | 3 | 78 | 0 | 0 | 
| app_proof | prover | 1 | 66,799,436 | 204 | 53 | 0 | 1 | 118 | 23 | 23 | 15 | 79 | 0 | 32 | 18 | 14 | 5 | 8 | 53 | 118 | 0 | 3 | 79 | 0 | 0 | 
| app_proof | prover | 2 | 66,799,436 | 207 | 52 | 0 | 1 | 118 | 23 | 23 | 15 | 80 | 0 | 36 | 21 | 14 | 5 | 8 | 52 | 118 | 0 | 3 | 79 | 0 | 0 | 
| app_proof | prover | 3 | 9,334,556 | 76 | 16 | 0 | 1 | 33 | 8 | 8 | 7 | 17 | 0 | 26 | 18 | 8 | 0 | 6 | 16 | 33 | 0 | 2 | 16 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 175 | 595 | 175 | 162 | 0 | 3 | 39 | 1,310,000 | 37.61 | 
| app_proof | 1 | 162 | 458 | 162 | 40 | 0 | 1 | 50 | 1,310,000 | 41.95 | 
| app_proof | 2 | 165 | 461 | 165 | 40 | 0 | 1 | 46 | 1,310,000 | 42.04 | 
| app_proof | 3 | 202 | 324 | 202 | 40 | 0 | 1 | 4 | 70,051 | 40.47 | 

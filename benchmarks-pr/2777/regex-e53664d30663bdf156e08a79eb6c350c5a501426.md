...
| `total_proof_time_ms ` |  781.50 |  1,563 |  873 |  690 |
| `execute_metered_time_ms` |  31 | -          | -          | -          |
| `execute_metered_insns` |  4,090,656 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  129.58 | -          |  129.58 |  129.58 |
| `execute_preflight_insns` |  2,045,328 |  4,090,656 |  2,327,000 |  1,763,656 |
| `execute_preflight_time_ms` |  81.50 |  163 |  86 |  77 |
| `execute_preflight_insn_mi/s` |  34.39 | -          |  34.83 |  33.96 |
| `trace_gen_time_ms   ` |  144 |  288 |  145 |  143 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  452.50 |  905 |  478 |  427 |
| `prover.main_trace_commit_time_ms` |  125 |  250 |  143 |  107 |
| `prover.rap_constraints_time_ms` |  278 |  556 |  281 |  275 |
| `prover.openings_time_ms` |  48.50 |  97 |  52 |  45 |
| `prover.rap_constraints.logup_gkr_time_ms` |  147.50 |  295 |  157 |  138 |
| `prover.rap_constraints.round0_time_ms` |  89 |  178 |  100 |  78 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/e53664d30663bdf156e08a79eb6c350c5a501426/regex-e53664d30663bdf156e08a79eb6c350c5a501426.memory.svg)
...
| app_proof |  |  |  |  |  | 690 |  |  | 31 | 4,090,656 | 129.58 | 0 | 1,609 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 27,256,571 | 208 | 82 | 0 | 0 | 97 | 32 | 31 | 45 | 19 | 0 | 28 | 17 | 11 | 2 | 8 | 82 | 97 | 0 | 2 | 18 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,703 | 139 | 45 | 0 | 0 | 66 | 25 | 24 | 28 | 13 | 0 | 26 | 17 | 8 | 1 | 6 | 45 | 66 | 0 | 2 | 12 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 118 | 31 | 0 | 0 | 61 | 23 | 23 | 24 | 13 | 0 | 25 | 18 | 7 | 1 | 5 | 31 | 61 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 79,962,868 | 308 | 127 | 0 | 0 | 136 | 56 | 55 | 37 | 42 | 0 | 43 | 28 | 15 | 6 | 8 | 128 | 136 | 0 | 5 | 41 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 179,782,354 | 478 | 143 | 0 | 0 | 281 | 78 | 77 | 45 | 157 | 0 | 52 | 24 | 28 | 15 | 12 | 143 | 281 | 0 | 3 | 155 | 0 | 0 | 
| app_proof | prover | 1 | 135,061,081 | 427 | 107 | 0 | 9 | 275 | 100 | 99 | 36 | 138 | 0 | 45 | 22 | 22 | 11 | 11 | 107 | 275 | 0 | 3 | 137 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 145 | 873 | 145 | 163 | 1 | 6 | 86 | 2,327,000 | 33.96 | 
| app_proof | 1 | 143 | 690 | 143 | 41 | 0 | 2 | 77 | 1,763,656 | 34.83 | 

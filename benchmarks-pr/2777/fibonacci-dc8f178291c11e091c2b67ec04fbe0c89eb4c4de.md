...
|:---|---:|---:|---:|
| Total |  2.84 |  1.58 |  1.58 |
| app_proof |  1.88 |  0.62 |  0.62 |
| leaf |  0.45 |  0.45 |  0.45 |
...
| `total_proof_time_ms ` |  464.75 |  1,859 |  600 |  326 |
| `execute_metered_time_ms` |  19 | -          | -          | -          |
| `execute_metered_insns` |  4,000,051 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  201.13 | -          |  201.13 |  201.13 |
| `execute_preflight_insns` |  1,000,012.75 |  4,000,051 |  1,310,000 |  70,051 |
| `execute_preflight_time_ms` |  34 |  136 |  49 |  4 |
| `execute_preflight_insn_mi/s` |  42.75 | -          |  44.44 |  39.44 |
| `trace_gen_time_ms   ` |  183.75 |  735 |  209 |  168 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  175 |  700 |  215 |  72 |
| `prover.main_trace_commit_time_ms` |  43.50 |  174 |  53 |  15 |
| `prover.rap_constraints_time_ms` |  99.75 |  399 |  125 |  33 |
| `prover.openings_time_ms` |  30.25 |  121 |  35 |  22 |
| `prover.rap_constraints.logup_gkr_time_ms` |  63 |  252 |  79 |  16 |
| `prover.rap_constraints.round0_time_ms` |  22.25 |  89 |  29 |  9 |
| `prover.rap_constraints.mle_rounds_time_ms` |  13.50 |  54 |  16 |  7 |
| `prover.openings.stacked_reduction_time_ms` |  9.25 |  37 |  12 |  3 |
| `prover.openings.stacked_reduction.round0_time_ms` |  4.50 |  18 |  6 |  1 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  445 |  445 |  445 |  445 |
| `execute_preflight_time_ms` |  1 |  1 |  1 |  1 |
| `trace_gen_time_ms   ` |  58 |  58 |  58 |  58 |
| `generate_blob_total_time_ms` |  3 |  3 |  3 |  3 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  387 |  387 |  387 |  387 |
| `prover.main_trace_commit_time_ms` |  171 |  171 |  171 |  171 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/dc8f178291c11e091c2b67ec04fbe0c89eb4c4de/fibonacci-dc8f178291c11e091c2b67ec04fbe0c89eb4c4de.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 69 | 9 |  |  | 0 |  | 350 | 9 |  |  |  |  |  |  | 
| app_proof |  |  |  |  |  | 326 |  |  | 19 | 4,000,051 | 201.13 | 0 | 1,885 |  | 
| internal_for_leaf |  |  |  | 232 |  |  |  |  |  |  |  |  |  | 232 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 27,289,339 | 215 | 83 | 0 | 0 | 99 | 33 | 32 | 46 | 20 | 0 | 31 | 20 | 11 | 2 | 8 | 84 | 99 | 0 | 2 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,703 | 143 | 46 | 0 | 0 | 66 | 25 | 24 | 28 | 13 | 0 | 29 | 21 | 8 | 1 | 6 | 46 | 66 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 119 | 32 | 0 | 0 | 60 | 22 | 22 | 24 | 13 | 0 | 26 | 18 | 7 | 1 | 5 | 32 | 60 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 102,941,734 | 387 | 171 | 0 | 0 | 162 | 71 | 70 | 47 | 44 | 0 | 52 | 33 | 18 | 8 | 10 | 171 | 162 | 0 | 6 | 42 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 66,843,374 | 215 | 53 | 0 | 0 | 125 | 29 | 28 | 16 | 79 | 0 | 35 | 22 | 12 | 6 | 6 | 53 | 125 | 0 | 3 | 78 | 0 | 0 | 
| app_proof | prover | 1 | 66,799,436 | 207 | 53 | 0 | 0 | 122 | 26 | 26 | 16 | 79 | 0 | 31 | 20 | 11 | 6 | 5 | 53 | 122 | 0 | 3 | 79 | 0 | 0 | 
| app_proof | prover | 2 | 66,799,436 | 206 | 53 | 0 | 0 | 119 | 25 | 24 | 15 | 78 | 0 | 33 | 22 | 11 | 5 | 5 | 53 | 119 | 0 | 3 | 77 | 0 | 0 | 
| app_proof | prover | 3 | 9,334,556 | 72 | 15 | 0 | 0 | 33 | 9 | 8 | 7 | 16 | 0 | 22 | 19 | 3 | 1 | 2 | 15 | 33 | 0 | 2 | 16 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 185 | 600 | 185 | 161 | 0 | 3 | 38 | 1,310,000 | 39.44 | 
| app_proof | 1 | 168 | 466 | 168 | 41 | 0 | 1 | 49 | 1,310,000 | 44.27 | 
| app_proof | 2 | 173 | 467 | 173 | 41 | 0 | 1 | 45 | 1,310,000 | 44.44 | 
| app_proof | 3 | 209 | 326 | 209 | 41 | 0 | 1 | 4 | 70,051 | 42.84 | 

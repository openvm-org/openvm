...
|:---|---:|---:|---:|
| Total |  2.45 |  1.74 |  1.74 |
| app_proof |  1.59 |  0.88 |  0.88 |
| leaf |  0.36 |  0.36 |  0.36 |
...
| `total_proof_time_ms ` |  778 |  1,556 |  846 |  710 |
| `execute_metered_time_ms` |  31 | -          | -          | -          |
| `execute_metered_insns` |  4,090,656 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  128.68 | -          |  128.68 |  128.68 |
| `execute_preflight_insns` |  2,045,328 |  4,090,656 |  2,327,000 |  1,763,656 |
| `execute_preflight_time_ms` |  78.50 |  157 |  87 |  70 |
| `execute_preflight_insn_mi/s` |  36.27 | -          |  39.67 |  32.87 |
| `trace_gen_time_ms   ` |  153 |  306 |  157 |  149 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  441 |  882 |  442 |  440 |
| `prover.main_trace_commit_time_ms` |  121.50 |  243 |  128 |  115 |
| `prover.rap_constraints_time_ms` |  272 |  544 |  280 |  264 |
| `prover.openings_time_ms` |  47 |  94 |  49 |  45 |
| `prover.rap_constraints.logup_gkr_time_ms` |  143 |  286 |  145 |  141 |
| `prover.rap_constraints.round0_time_ms` |  88 |  176 |  101 |  75 |
| `prover.rap_constraints.mle_rounds_time_ms` |  40 |  80 |  43 |  37 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/5e2748cd4d4c6979f937f4153e784f635b0ce415/regex-5e2748cd4d4c6979f937f4153e784f635b0ce415.memory.svg)
...
| app_proof |  |  |  |  |  | 710 |  |  | 31 | 4,090,656 | 128.68 | 0 | 1,601 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 27,256,571 | 212 | 82 | 0 | 0 | 99 | 33 | 32 | 46 | 19 | 0 | 29 | 18 | 11 | 2 | 8 | 82 | 99 | 0 | 2 | 18 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,703 | 138 | 45 | 0 | 0 | 67 | 25 | 25 | 28 | 13 | 0 | 24 | 16 | 8 | 1 | 6 | 45 | 67 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 119 | 31 | 0 | 0 | 62 | 24 | 23 | 24 | 13 | 0 | 25 | 17 | 7 | 1 | 5 | 31 | 62 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 79,965,620 | 308 | 128 | 0 | 0 | 137 | 56 | 55 | 38 | 42 | 0 | 42 | 26 | 15 | 6 | 8 | 129 | 137 | 0 | 5 | 41 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 156,189,394 | 442 | 128 | 0 | 0 | 264 | 75 | 75 | 43 | 145 | 0 | 49 | 24 | 24 | 12 | 11 | 128 | 264 | 0 | 3 | 145 | 0 | 0 | 
| app_proof | prover | 1 | 136,765,017 | 440 | 114 | 0 | 9 | 280 | 101 | 100 | 37 | 141 | 0 | 45 | 22 | 23 | 11 | 11 | 115 | 279 | 0 | 3 | 139 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 149 | 846 | 149 | 167 | 1 | 6 | 87 | 2,327,000 | 32.87 | 
| app_proof | 1 | 157 | 710 | 157 | 41 | 0 | 2 | 70 | 1,763,656 | 39.67 | 

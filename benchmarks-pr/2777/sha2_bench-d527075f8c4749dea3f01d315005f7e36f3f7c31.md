...
|:---|---:|---:|---:|
| Total |  9.87 |  4.32 |  4.32 |
| app_proof |  8.33 |  2.78 |  2.78 |
| leaf |  0.92 |  0.92 |  0.92 |
...
| `total_proof_time_ms ` |  2,059.75 |  8,239 |  2,690 |  645 |
...
| `execute_preflight_time_ms` |  161 |  644 |  264 |  31 |
| `execute_preflight_insn_mi/s` |  37 | -          |  38.50 |  34.73 |
| `trace_gen_time_ms   ` |  117.75 |  471 |  185 |  66 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,708.75 |  6,835 |  2,253 |  387 |
| `prover.main_trace_commit_time_ms` |  461.75 |  1,847 |  685 |  88 |
| `prover.rap_constraints_time_ms` |  1,121.75 |  4,487 |  1,418 |  251 |
| `prover.openings_time_ms` |  124.25 |  497 |  152 |  47 |
| `prover.rap_constraints.logup_gkr_time_ms` |  339.25 |  1,357 |  428 |  79 |
| `prover.rap_constraints.round0_time_ms` |  526 |  2,104 |  666 |  121 |
| `prover.rap_constraints.mle_rounds_time_ms` |  255.75 |  1,023 |  326 |  51 |
| `prover.openings.stacked_reduction_time_ms` |  91.50 |  366 |  117 |  25 |
| `prover.openings.stacked_reduction.round0_time_ms` |  50.50 |  202 |  66 |  9 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  40.25 |  161 |  50 |  16 |
| `prover.openings.whir_time_ms` |  32.25 |  129 |  39 |  21 |
...
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  787 |  787 |  787 |  787 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/d527075f8c4749dea3f01d315005f7e36f3f7c31/sha2_bench-d527075f8c4749dea3f01d315005f7e36f3f7c31.memory.svg)
...
| app_proof |  |  |  |  |  | 645 |  |  | 93 | 11,167,961 | 119.83 | 0 | 8,340 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,577,915 | 276 | 118 | 0 | 7 | 111 | 34 | 33 | 50 | 25 | 0 | 46 | 16 | 29 | 3 | 25 | 118 | 111 | 0 | 2 | 25 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,703 | 160 | 47 | 0 | 4 | 71 | 23 | 23 | 28 | 19 | 0 | 41 | 17 | 23 | 1 | 21 | 48 | 71 | 0 | 2 | 18 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 141 | 33 | 0 | 4 | 66 | 23 | 22 | 24 | 18 | 0 | 41 | 18 | 22 | 1 | 21 | 34 | 66 | 0 | 2 | 18 | 0 | 0 | 
| leaf | 0 | prover | 267,458,790 | 787 | 407 | 0 | 26 | 287 | 130 | 129 | 79 | 77 | 0 | 91 | 35 | 55 | 22 | 33 | 407 | 287 | 0 | 5 | 77 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 686,312,761 | 2,253 | 684 | 0 | 193 | 1,418 | 666 | 665 | 323 | 428 | 108 | 149 | 32 | 117 | 66 | 50 | 685 | 1,418 | 0 | 3 | 318 | 0 | 0 | 
| app_proof | prover | 1 | 686,312,460 | 2,100 | 537 | 0 | 42 | 1,410 | 658 | 657 | 323 | 428 | 124 | 152 | 39 | 112 | 63 | 48 | 537 | 1,410 | 0 | 3 | 303 | 0 | 0 | 
| app_proof | prover | 2 | 686,312,460 | 2,095 | 536 | 0 | 42 | 1,408 | 659 | 658 | 326 | 422 | 119 | 149 | 37 | 112 | 64 | 47 | 537 | 1,408 | 0 | 3 | 302 | 0 | 0 | 
| app_proof | prover | 3 | 106,273,044 | 387 | 88 | 0 | 7 | 251 | 121 | 121 | 51 | 79 | 0 | 47 | 21 | 25 | 9 | 16 | 88 | 251 | 0 | 3 | 78 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 154 | 2,690 | 154 | 161 | 0 | 3 | 120 | 3,562,000 | 34.73 | 
| app_proof | 1 | 66 | 2,472 | 66 | 41 | 0 | 1 | 264 | 3,562,000 | 38.19 | 
| app_proof | 2 | 66 | 2,432 | 66 | 41 | 0 | 1 | 229 | 3,562,000 | 38.50 | 
| app_proof | 3 | 185 | 645 | 185 | 41 | 0 | 2 | 31 | 481,961 | 36.58 | 

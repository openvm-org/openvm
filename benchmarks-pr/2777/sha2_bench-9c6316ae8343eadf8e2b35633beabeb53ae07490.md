...
| `total_proof_time_ms ` |  2,077.50 |  8,310 |  2,704 |  638 |
| `execute_metered_time_ms` |  92 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  120.57 | -          |  120.57 |  120.57 |
| `execute_preflight_insns` |  2,791,990.25 |  11,167,961 |  3,562,000 |  481,961 |
| `execute_preflight_time_ms` |  163 |  652 |  268 |  30 |
| `execute_preflight_insn_mi/s` |  37.98 | -          |  39.43 |  35.46 |
| `trace_gen_time_ms   ` |  124.25 |  497 |  188 |  67 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,708.50 |  6,834 |  2,253 |  369 |
| `prover.main_trace_commit_time_ms` |  465.50 |  1,862 |  694 |  87 |
| `prover.rap_constraints_time_ms` |  1,121.50 |  4,486 |  1,417 |  240 |
| `prover.openings_time_ms` |  120 |  480 |  150 |  40 |
| `prover.rap_constraints.logup_gkr_time_ms` |  332 |  1,328 |  422 |  75 |
| `prover.rap_constraints.round0_time_ms` |  529 |  2,116 |  671 |  111 |
| `prover.rap_constraints.mle_rounds_time_ms` |  259.50 |  1,038 |  330 |  53 |
| `prover.openings.stacked_reduction_time_ms` |  84.75 |  339 |  108 |  18 |
| `prover.openings.stacked_reduction.round0_time_ms` |  51 |  204 |  66 |  9 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  33.50 |  134 |  42 |  9 |
| `prover.openings.whir_time_ms` |  34.75 |  139 |  43 |  21 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/9c6316ae8343eadf8e2b35633beabeb53ae07490/sha2_bench-9c6316ae8343eadf8e2b35633beabeb53ae07490.memory.svg)
...
| app_proof |  |  |  |  |  | 638 |  |  | 92 | 11,167,961 | 120.57 | 0 | 8,410 |  | 
| internal_for_leaf |  |  |  | 280 |  |  |  |  |  |  |  |  |  | 281 | 
...
| app_proof | VmAirWrapper<Rv64BranchAdapterAir, BranchEqualCoreAir<8> | 0 | 2 | 
...
| app_proof | VmAirWrapper<Rv64LoadStoreAdapterAir, LoadStoreCoreAir<8> | 0 | 9 | 
...
| app_proof | VmAirWrapper<Rv64BaseAluAdapterAir, AddSubCoreAir<8, 8> | 2 | 17 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 21 | 280 | 21 | 6 | 1 | 2 | 2 | 3 | 
| internal_recursive.0 | 1 | 11 | 155 | 11 | 2 | 0 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 9 | 132 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 147 | 921 | 147 | 58 | 22 | 3 | 1 | 1 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,577,915 | 258 | 117 | 0 | 0 | 106 | 33 | 33 | 52 | 20 | 0 | 34 | 20 | 13 | 3 | 9 | 118 | 106 | 0 | 2 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,703 | 143 | 46 | 0 | 0 | 67 | 24 | 23 | 28 | 14 | 0 | 29 | 21 | 8 | 1 | 6 | 46 | 67 | 0 | 3 | 12 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 122 | 31 | 0 | 0 | 61 | 22 | 20 | 25 | 12 | 0 | 29 | 22 | 7 | 1 | 5 | 31 | 61 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 267,458,790 | 774 | 410 | 0 | 1 | 284 | 129 | 128 | 80 | 74 | 0 | 78 | 37 | 41 | 22 | 18 | 410 | 284 | 0 | 6 | 73 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 686,312,761 | 2,253 | 694 | 0 | 158 | 1,413 | 668 | 667 | 328 | 416 | 116 | 144 | 36 | 108 | 66 | 42 | 694 | 1,413 | 0 | 3 | 299 | 0 | 0 | 
| app_proof | prover | 1 | 686,312,460 | 2,106 | 539 | 0 | 2 | 1,416 | 666 | 665 | 327 | 422 | 127 | 150 | 43 | 106 | 64 | 42 | 539 | 1,416 | 0 | 4 | 294 | 0 | 0 | 
| app_proof | prover | 2 | 686,312,460 | 2,106 | 542 | 0 | 2 | 1,417 | 671 | 671 | 330 | 415 | 121 | 146 | 39 | 107 | 65 | 41 | 542 | 1,417 | 0 | 4 | 293 | 0 | 0 | 
| app_proof | prover | 3 | 106,273,044 | 369 | 87 | 0 | 0 | 240 | 111 | 110 | 53 | 75 | 0 | 40 | 21 | 18 | 9 | 9 | 87 | 240 | 0 | 3 | 74 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 163 | 2,704 | 163 | 167 | 0 | 3 | 120 | 3,562,000 | 35.46 | 
| app_proof | 1 | 67 | 2,496 | 67 | 54 | 0 | 1 | 268 | 3,562,000 | 39.43 | 
| app_proof | 2 | 79 | 2,472 | 79 | 52 | 0 | 1 | 234 | 3,562,000 | 39.14 | 
| app_proof | 3 | 188 | 638 | 188 | 49 | 0 | 2 | 30 | 481,961 | 37.90 | 

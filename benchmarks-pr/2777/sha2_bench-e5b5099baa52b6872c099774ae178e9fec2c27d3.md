...
|:---|---:|---:|---:|
| Total |  9.62 |  4.25 |  4.25 |
| app_proof |  8.16 |  2.79 |  2.79 |
| leaf |  0.90 |  0.90 |  0.90 |
...
| `total_proof_time_ms ` |  2,017 |  8,068 |  2,697 |  617 |
...
| `execute_preflight_time_ms` |  157.75 |  631 |  260 |  29 |
| `execute_preflight_insn_mi/s` |  38.22 | -          |  39.61 |  35.83 |
| `trace_gen_time_ms   ` |  119.50 |  478 |  186 |  67 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,667.50 |  6,670 |  2,260 |  359 |
| `prover.main_trace_commit_time_ms` |  468 |  1,872 |  697 |  84 |
| `prover.rap_constraints_time_ms` |  1,079.25 |  4,317 |  1,416 |  236 |
| `prover.openings_time_ms` |  119.50 |  478 |  147 |  38 |
| `prover.rap_constraints.logup_gkr_time_ms` |  282.25 |  1,129 |  423 |  72 |
| `prover.rap_constraints.round0_time_ms` |  539.25 |  2,157 |  691 |  111 |
| `prover.rap_constraints.mle_rounds_time_ms` |  257 |  1,028 |  326 |  52 |
| `prover.openings.stacked_reduction_time_ms` |  85.25 |  341 |  108 |  17 |
| `prover.openings.stacked_reduction.round0_time_ms` |  51.25 |  205 |  66 |  8 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  33.50 |  134 |  43 |  8 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/e5b5099baa52b6872c099774ae178e9fec2c27d3/sha2_bench-e5b5099baa52b6872c099774ae178e9fec2c27d3.memory.svg)
...
| app_proof |  |  |  |  |  | 617 |  |  | 94 | 11,167,961 | 118.40 | 0 | 8,170 |  | 
...
| leaf | 0 | 132 | 900 | 131 | 48 | 21 | 3 | 1 | 1 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,577,915 | 257 | 117 | 0 | 0 | 105 | 34 | 33 | 51 | 19 | 0 | 33 | 20 | 13 | 3 | 9 | 117 | 105 | 0 | 2 | 19 | 0 | 0 | 
...
| leaf | 0 | prover | 267,458,790 | 768 | 407 | 0 | 1 | 283 | 129 | 128 | 79 | 73 | 0 | 77 | 36 | 40 | 22 | 18 | 408 | 283 | 0 | 7 | 72 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 697,322,857 | 2,260 | 696 | 0 | 154 | 1,416 | 668 | 667 | 325 | 423 | 120 | 146 | 37 | 108 | 65 | 43 | 697 | 1,416 | 0 | 4 | 301 | 0 | 0 | 
| app_proof | prover | 1 | 697,322,508 | 2,023 | 544 | 0 | 2 | 1,331 | 687 | 687 | 326 | 317 | 0 | 147 | 38 | 108 | 66 | 41 | 545 | 1,331 | 0 | 4 | 316 | 0 | 0 | 
| app_proof | prover | 2 | 697,322,508 | 2,028 | 546 | 0 | 2 | 1,334 | 691 | 690 | 325 | 317 | 0 | 147 | 38 | 108 | 66 | 42 | 546 | 1,334 | 0 | 4 | 316 | 0 | 0 | 
| app_proof | prover | 3 | 101,162,004 | 359 | 84 | 0 | 0 | 236 | 111 | 110 | 52 | 72 | 0 | 38 | 20 | 17 | 8 | 8 | 84 | 236 | 0 | 3 | 72 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 158 | 2,697 | 158 | 161 | 0 | 3 | 117 | 3,566,000 | 35.83 | 
| app_proof | 1 | 67 | 2,392 | 67 | 41 | 0 | 1 | 260 | 3,567,000 | 39.51 | 
| app_proof | 2 | 67 | 2,362 | 67 | 41 | 0 | 1 | 225 | 3,567,000 | 39.61 | 
| app_proof | 3 | 186 | 617 | 186 | 41 | 0 | 2 | 29 | 467,961 | 37.91 | 

...
|:---|---:|---:|---:|
| Total |  9.72 |  4.30 |  4.30 |
| app_proof |  8.25 |  2.83 |  2.83 |
| leaf |  0.91 |  0.91 |  0.91 |
...
| `total_proof_time_ms ` |  2,037.50 |  8,150 |  2,731 |  626 |
| `execute_metered_time_ms` |  97 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  114.59 | -          |  114.59 |  114.59 |
| `execute_preflight_insns` |  2,791,990.25 |  11,167,961 |  3,567,000 |  467,961 |
| `execute_preflight_time_ms` |  159.25 |  637 |  264 |  29 |
| `execute_preflight_insn_mi/s` |  38.75 | -          |  40.40 |  36.07 |
| `trace_gen_time_ms   ` |  120.75 |  483 |  189 |  67 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,685 |  6,740 |  2,290 |  365 |
| `prover.main_trace_commit_time_ms` |  474 |  1,896 |  708 |  85 |
| `prover.rap_constraints_time_ms` |  1,089 |  4,356 |  1,433 |  239 |
| `prover.openings_time_ms` |  120.75 |  483 |  148 |  40 |
| `prover.rap_constraints.logup_gkr_time_ms` |  285.50 |  1,142 |  428 |  73 |
| `prover.rap_constraints.round0_time_ms` |  541.75 |  2,167 |  690 |  113 |
| `prover.rap_constraints.mle_rounds_time_ms` |  260.75 |  1,043 |  331 |  53 |
| `prover.openings.stacked_reduction_time_ms` |  86.50 |  346 |  110 |  18 |
| `prover.openings.stacked_reduction.round0_time_ms` |  52 |  208 |  67 |  9 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  33.75 |  135 |  43 |  8 |
| `prover.openings.whir_time_ms` |  34 |  136 |  39 |  22 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/5e2748cd4d4c6979f937f4153e784f635b0ce415/sha2_bench-5e2748cd4d4c6979f937f4153e784f635b0ce415.memory.svg)
...
| app_proof |  |  |  |  |  | 626 |  |  | 97 | 11,167,961 | 114.59 | 0 | 8,254 |  | 
...
| leaf | 0 | 132 | 910 | 132 | 49 | 22 | 3 | 1 | 1 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,577,915 | 260 | 117 | 0 | 0 | 106 | 33 | 33 | 51 | 20 | 0 | 35 | 22 | 13 | 3 | 9 | 118 | 106 | 0 | 2 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,703 | 143 | 46 | 0 | 0 | 67 | 25 | 24 | 28 | 13 | 0 | 28 | 20 | 8 | 1 | 6 | 46 | 67 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 121 | 31 | 0 | 0 | 62 | 24 | 23 | 24 | 13 | 0 | 26 | 19 | 7 | 1 | 5 | 32 | 62 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 267,458,790 | 777 | 412 | 0 | 1 | 285 | 130 | 129 | 80 | 73 | 0 | 79 | 37 | 41 | 22 | 19 | 412 | 284 | 0 | 7 | 72 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 697,322,857 | 2,290 | 708 | 0 | 159 | 1,433 | 676 | 676 | 328 | 428 | 123 | 147 | 36 | 110 | 67 | 43 | 708 | 1,433 | 0 | 3 | 303 | 0 | 0 | 
| app_proof | prover | 1 | 697,322,508 | 2,042 | 551 | 0 | 2 | 1,342 | 688 | 688 | 331 | 321 | 0 | 148 | 39 | 109 | 66 | 42 | 551 | 1,342 | 0 | 4 | 320 | 0 | 0 | 
| app_proof | prover | 2 | 697,322,508 | 2,043 | 551 | 0 | 2 | 1,342 | 690 | 690 | 331 | 320 | 0 | 148 | 39 | 109 | 66 | 42 | 552 | 1,342 | 0 | 4 | 319 | 0 | 0 | 
| app_proof | prover | 3 | 101,162,004 | 365 | 85 | 0 | 0 | 239 | 113 | 112 | 53 | 73 | 0 | 40 | 22 | 18 | 9 | 8 | 85 | 239 | 0 | 3 | 72 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 160 | 2,731 | 160 | 162 | 0 | 3 | 117 | 3,566,000 | 36.07 | 
| app_proof | 1 | 67 | 2,414 | 67 | 41 | 0 | 1 | 264 | 3,567,000 | 40.40 | 
| app_proof | 2 | 67 | 2,379 | 67 | 41 | 0 | 1 | 227 | 3,567,000 | 39.86 | 
| app_proof | 3 | 189 | 626 | 189 | 41 | 0 | 2 | 29 | 467,961 | 38.64 | 

...
| `total_proof_time_ms ` |  2,331.17 |  13,987 |  2,621 |  2,235 |
...
| `execute_preflight_time_ms` |  236.17 |  1,417 |  318 |  89 |
| `execute_preflight_insn_mi/s` |  34.75 | -          |  35.98 |  32.17 |
| `trace_gen_time_ms   ` |  54 |  324 |  153 |  33 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,978.83 |  11,873 |  2,215 |  1,930 |
| `prover.main_trace_commit_time_ms` |  715.67 |  4,294 |  883 |  681 |
| `prover.rap_constraints_time_ms` |  1,074.17 |  6,445 |  1,143 |  1,059 |
| `prover.openings_time_ms` |  187.67 |  1,126 |  190 |  185 |
| `prover.rap_constraints.logup_gkr_time_ms` |  252.17 |  1,513 |  310 |  239 |
| `prover.rap_constraints.round0_time_ms` |  512.17 |  3,073 |  517 |  510 |
| `prover.rap_constraints.mle_rounds_time_ms` |  308.50 |  1,851 |  320 |  306 |
| `prover.openings.stacked_reduction_time_ms` |  147 |  882 |  149 |  146 |
| `prover.openings.stacked_reduction.round0_time_ms` |  84.50 |  507 |  86 |  84 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  62.17 |  373 |  63 |  62 |
| `prover.openings.whir_time_ms` |  40.33 |  242 |  44 |  38 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,113.50 |  2,227 |  1,441 |  786 |
| `execute_preflight_time_ms` |  5.50 |  11 |  6 |  5 |
| `trace_gen_time_ms   ` |  137.50 |  275 |  183 |  92 |
| `generate_blob_total_time_ms` |  24.50 |  49 |  33 |  16 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  975.50 |  1,951 |  1,258 |  693 |
| `prover.main_trace_commit_time_ms` |  549 |  1,098 |  722 |  376 |
| `prover.rap_constraints_time_ms` |  321 |  642 |  410 |  232 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/d6a17790a9319234b0d8067435234b83c4674a93/keccak-d6a17790a9319234b0d8067435234b83c4674a93.memory.svg)
...
| app_proof |  |  |  |  |  | 2,235 |  |  | 138 | 14,365,133 | 104.03 | 0 | 14,131 |  | 
...
| app_proof | VmAirWrapper<Rv64BaseAluAdapterAir, AddSubCoreAir<8, 8> | 3 | 5 | 
...
| leaf | 0 | 183 | 1,441 | 182 | 65 | 33 | 6 | 7 | 7 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 81,415,028 | 482 | 247 | 0 | 14 | 175 | 48 | 47 | 91 | 35 | 0 | 59 | 21 | 38 | 7 | 30 | 247 | 175 | 0 | 2 | 35 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,879 | 171 | 52 | 0 | 4 | 77 | 25 | 24 | 28 | 23 | 0 | 41 | 17 | 23 | 1 | 21 | 52 | 77 | 0 | 2 | 22 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 142 | 34 | 0 | 4 | 66 | 23 | 22 | 24 | 18 | 0 | 42 | 19 | 22 | 1 | 21 | 34 | 66 | 0 | 2 | 17 | 0 | 0 | 
| leaf | 0 | prover | 476,578,662 | 1,258 | 721 | 0 | 47 | 410 | 201 | 200 | 119 | 90 | 0 | 125 | 40 | 85 | 40 | 44 | 722 | 410 | 0 | 6 | 88 | 0 | 0 | 
| leaf | 1 | prover | 240,255,732 | 693 | 375 | 0 | 24 | 232 | 108 | 107 | 68 | 56 | 0 | 84 | 32 | 52 | 19 | 32 | 376 | 232 | 0 | 5 | 55 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 867,606,540 | 2,215 | 883 | 0 | 261 | 1,143 | 512 | 511 | 320 | 310 | 70 | 187 | 41 | 146 | 84 | 62 | 883 | 1,143 | 0 | 3 | 238 | 0 | 0 | 
| app_proof | prover | 1 | 867,683,340 | 1,933 | 681 | 0 | 59 | 1,061 | 511 | 511 | 306 | 242 | 0 | 190 | 44 | 146 | 84 | 62 | 681 | 1,061 | 0 | 3 | 241 | 0 | 0 | 
| app_proof | prover | 2 | 867,683,340 | 1,930 | 682 | 0 | 59 | 1,059 | 510 | 510 | 307 | 240 | 0 | 188 | 39 | 149 | 86 | 63 | 682 | 1,059 | 0 | 3 | 239 | 0 | 0 | 
| app_proof | prover | 3 | 867,683,340 | 1,932 | 681 | 0 | 59 | 1,060 | 511 | 511 | 306 | 242 | 0 | 189 | 42 | 147 | 84 | 62 | 682 | 1,060 | 0 | 3 | 241 | 0 | 0 | 
| app_proof | prover | 4 | 867,683,340 | 1,933 | 683 | 0 | 59 | 1,063 | 517 | 516 | 306 | 239 | 0 | 185 | 38 | 146 | 84 | 62 | 683 | 1,063 | 0 | 3 | 238 | 0 | 0 | 
| app_proof | prover | 5 | 867,606,540 | 1,930 | 683 | 0 | 59 | 1,059 | 512 | 511 | 306 | 240 | 0 | 187 | 38 | 148 | 85 | 62 | 683 | 1,059 | 0 | 3 | 239 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 153 | 2,621 | 153 | 163 | 0 | 3 | 89 | 2,413,000 | 32.17 | 
| app_proof | 1 | 34 | 2,327 | 34 | 41 | 0 | 1 | 318 | 2,413,000 | 34.90 | 
| app_proof | 2 | 34 | 2,266 | 34 | 41 | 0 | 1 | 261 | 2,413,000 | 35.35 | 
| app_proof | 3 | 36 | 2,270 | 36 | 41 | 0 | 1 | 260 | 2,413,000 | 35.98 | 
| app_proof | 4 | 34 | 2,268 | 34 | 41 | 0 | 1 | 260 | 2,413,000 | 35.53 | 
| app_proof | 5 | 33 | 2,235 | 33 | 41 | 0 | 1 | 229 | 2,300,133 | 34.56 | 

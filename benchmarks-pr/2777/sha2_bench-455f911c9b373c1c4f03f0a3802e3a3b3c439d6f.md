...
|:---|---:|---:|---:|
| Total |  9.67 |  4.19 |  4.19 |
| app_proof |  8.22 |  2.74 |  2.74 |
| leaf |  0.89 |  0.89 |  0.89 |
...
| `total_proof_time_ms ` |  2,033 |  8,132 |  2,650 |  621 |
...
| `execute_preflight_time_ms` |  162 |  648 |  269 |  30 |
| `execute_preflight_insn_mi/s` |  37.84 | -          |  39.30 |  35.20 |
| `trace_gen_time_ms   ` |  117.25 |  469 |  184 |  66 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,681 |  6,724 |  2,214 |  365 |
| `prover.main_trace_commit_time_ms` |  459.25 |  1,837 |  682 |  87 |
| `prover.rap_constraints_time_ms` |  1,103.50 |  4,414 |  1,398 |  239 |
| `prover.openings_time_ms` |  117.50 |  470 |  148 |  39 |
| `prover.rap_constraints.logup_gkr_time_ms` |  325.25 |  1,301 |  413 |  75 |
| `prover.rap_constraints.round0_time_ms` |  522.75 |  2,091 |  662 |  110 |
| `prover.rap_constraints.mle_rounds_time_ms` |  254.75 |  1,019 |  323 |  53 |
| `prover.openings.stacked_reduction_time_ms` |  83.50 |  334 |  107 |  17 |
...
| `prover.openings.whir_time_ms` |  33.50 |  134 |  40 |  21 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/455f911c9b373c1c4f03f0a3802e3a3b3c439d6f/sha2_bench-455f911c9b373c1c4f03f0a3802e3a3b3c439d6f.memory.svg)
...
| app_proof |  |  |  |  |  | 621 |  |  | 91 | 11,167,961 | 121.77 | 0 | 8,230 |  | 
...
| internal_recursive.0 | 1 | 10 | 148 | 10 | 1 | 0 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 9 | 129 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 129 | 892 | 128 | 48 | 21 | 2 | 1 | 1 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,577,915 | 257 | 115 | 0 | 0 | 105 | 34 | 33 | 51 | 19 | 0 | 35 | 22 | 13 | 3 | 9 | 115 | 105 | 0 | 2 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,703 | 137 | 44 | 0 | 0 | 65 | 24 | 23 | 27 | 13 | 0 | 25 | 17 | 8 | 1 | 6 | 45 | 65 | 0 | 2 | 12 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 120 | 31 | 0 | 0 | 61 | 23 | 22 | 24 | 13 | 0 | 26 | 19 | 7 | 1 | 5 | 31 | 61 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 267,458,790 | 763 | 405 | 0 | 1 | 280 | 129 | 128 | 78 | 72 | 0 | 77 | 36 | 40 | 22 | 18 | 406 | 280 | 0 | 6 | 71 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 686,312,761 | 2,214 | 682 | 0 | 152 | 1,391 | 661 | 660 | 322 | 407 | 112 | 140 | 35 | 105 | 63 | 41 | 682 | 1,390 | 0 | 3 | 294 | 0 | 0 | 
| app_proof | prover | 1 | 686,312,460 | 2,081 | 534 | 0 | 2 | 1,398 | 662 | 661 | 323 | 413 | 122 | 148 | 40 | 107 | 66 | 40 | 534 | 1,398 | 0 | 3 | 290 | 0 | 0 | 
| app_proof | prover | 2 | 686,312,460 | 2,064 | 534 | 0 | 2 | 1,386 | 658 | 658 | 321 | 406 | 117 | 143 | 38 | 105 | 64 | 41 | 534 | 1,386 | 0 | 3 | 288 | 0 | 0 | 
| app_proof | prover | 3 | 106,273,044 | 365 | 86 | 0 | 0 | 239 | 110 | 109 | 53 | 75 | 0 | 39 | 21 | 17 | 9 | 8 | 87 | 239 | 0 | 3 | 74 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 152 | 2,650 | 152 | 163 | 0 | 3 | 120 | 3,562,000 | 35.20 | 
| app_proof | 1 | 66 | 2,459 | 66 | 41 | 0 | 1 | 269 | 3,562,000 | 39.30 | 
| app_proof | 2 | 67 | 2,402 | 66 | 41 | 0 | 1 | 229 | 3,562,000 | 39.19 | 
| app_proof | 3 | 184 | 621 | 184 | 41 | 0 | 2 | 30 | 481,961 | 37.67 | 

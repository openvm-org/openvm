...
| `total_proof_time_ms ` |  802 |  1,604 |  889 |  715 |
| `execute_metered_time_ms` |  31 | -          | -          | -          |
| `execute_metered_insns` |  4,090,656 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  130.83 | -          |  130.83 |  130.83 |
| `execute_preflight_insns` |  2,045,328 |  4,090,656 |  2,327,000 |  1,763,656 |
| `execute_preflight_time_ms` |  90 |  180 |  100 |  80 |
| `execute_preflight_insn_mi/s` |  30.09 | -          |  32.16 |  28.02 |
| `trace_gen_time_ms   ` |  136 |  272 |  141 |  131 |
| `memory_finalize_time_ms` |  1 |  2 |  2 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  472.50 |  945 |  494 |  451 |
| `prover.main_trace_commit_time_ms` |  129 |  258 |  145 |  113 |
| `prover.rap_constraints_time_ms` |  286.50 |  573 |  289 |  284 |
| `prover.openings_time_ms` |  56 |  112 |  59 |  53 |
| `prover.rap_constraints.logup_gkr_time_ms` |  156.50 |  313 |  166 |  147 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/4ebbd3f2ee57e31e7b8c7653c02168c37a4b258d/regex-4ebbd3f2ee57e31e7b8c7653c02168c37a4b258d.memory.svg)
...
| app_proof |  |  |  |  |  | 715 |  |  | 31 | 4,090,656 | 130.83 | 0 | 1,649 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 27,256,571 | 232 | 84 | 0 | 5 | 101 | 30 | 30 | 44 | 25 | 0 | 46 | 19 | 26 | 2 | 23 | 84 | 101 | 0 | 2 | 24 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,703 | 163 | 48 | 0 | 3 | 72 | 24 | 23 | 27 | 20 | 0 | 42 | 18 | 23 | 1 | 21 | 48 | 72 | 0 | 2 | 18 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 149 | 34 | 0 | 4 | 65 | 22 | 22 | 24 | 18 | 0 | 49 | 26 | 22 | 1 | 21 | 34 | 65 | 0 | 2 | 17 | 0 | 0 | 
| leaf | 0 | prover | 79,962,868 | 331 | 130 | 0 | 8 | 140 | 54 | 53 | 37 | 48 | 0 | 60 | 29 | 30 | 6 | 23 | 130 | 140 | 0 | 5 | 46 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 179,782,354 | 494 | 145 | 0 | 10 | 289 | 79 | 78 | 44 | 166 | 0 | 59 | 22 | 36 | 14 | 21 | 145 | 289 | 0 | 3 | 164 | 0 | 0 | 
| app_proof | prover | 1 | 135,061,081 | 451 | 113 | 0 | 17 | 284 | 100 | 100 | 35 | 147 | 0 | 53 | 23 | 30 | 10 | 20 | 113 | 284 | 0 | 3 | 146 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 131 | 889 | 131 | 162 | 2 | 5 | 100 | 2,327,000 | 28.02 | 
| app_proof | 1 | 141 | 715 | 141 | 40 | 0 | 2 | 80 | 1,763,656 | 32.16 | 

...
| `total_proof_time_ms ` |  2,023 |  8,092 |  2,710 |  618 |
| `execute_metered_time_ms` |  92 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  120.09 | -          |  120.09 |  120.09 |
| `execute_preflight_insns` |  2,791,990.25 |  11,167,961 |  3,567,000 |  467,961 |
| `execute_preflight_time_ms` |  159.75 |  639 |  265 |  30 |
| `execute_preflight_insn_mi/s` |  37.78 | -          |  39.18 |  35.65 |
| `trace_gen_time_ms   ` |  119 |  476 |  186 |  67 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,671.50 |  6,686 |  2,271 |  360 |
| `prover.main_trace_commit_time_ms` |  469.50 |  1,878 |  703 |  84 |
| `prover.rap_constraints_time_ms` |  1,081.75 |  4,327 |  1,421 |  236 |
| `prover.openings_time_ms` |  119.25 |  477 |  146 |  39 |
| `prover.rap_constraints.logup_gkr_time_ms` |  282.50 |  1,130 |  423 |  72 |
| `prover.rap_constraints.round0_time_ms` |  543.50 |  2,174 |  697 |  111 |
| `prover.rap_constraints.mle_rounds_time_ms` |  254.75 |  1,019 |  325 |  52 |
| `prover.openings.stacked_reduction_time_ms` |  85 |  340 |  108 |  17 |
| `prover.openings.stacked_reduction.round0_time_ms` |  51 |  204 |  66 |  8 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  33.75 |  135 |  43 |  8 |
| `prover.openings.whir_time_ms` |  33.25 |  133 |  38 |  21 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/28f15696253db32470b1ef2f256747681740db4c/sha2_bench-28f15696253db32470b1ef2f256747681740db4c.memory.svg)
...
| app_proof |  |  |  |  |  | 618 |  |  | 92 | 11,167,961 | 120.09 | 0 | 8,192 |  | 
...
| leaf | 0 | 132 | 902 | 131 | 48 | 21 | 2 | 1 | 1 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,577,915 | 259 | 116 | 0 | 0 | 105 | 34 | 33 | 51 | 19 | 0 | 35 | 22 | 13 | 3 | 9 | 117 | 105 | 0 | 2 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,703 | 140 | 45 | 0 | 0 | 66 | 24 | 23 | 28 | 13 | 0 | 28 | 20 | 8 | 1 | 6 | 45 | 66 | 0 | 2 | 12 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 119 | 31 | 0 | 0 | 60 | 22 | 22 | 24 | 13 | 0 | 27 | 19 | 7 | 1 | 5 | 31 | 60 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 267,458,790 | 770 | 405 | 0 | 1 | 283 | 129 | 128 | 80 | 73 | 0 | 81 | 40 | 41 | 22 | 18 | 405 | 283 | 0 | 6 | 72 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 697,322,857 | 2,271 | 703 | 0 | 159 | 1,421 | 672 | 671 | 325 | 423 | 121 | 146 | 37 | 108 | 65 | 43 | 703 | 1,421 | 0 | 4 | 300 | 0 | 0 | 
| app_proof | prover | 1 | 697,322,508 | 2,028 | 546 | 0 | 2 | 1,335 | 697 | 697 | 320 | 317 | 0 | 146 | 38 | 107 | 65 | 42 | 546 | 1,335 | 0 | 4 | 316 | 0 | 0 | 
| app_proof | prover | 2 | 697,322,508 | 2,027 | 545 | 0 | 2 | 1,335 | 694 | 693 | 322 | 318 | 0 | 146 | 37 | 108 | 66 | 42 | 545 | 1,335 | 0 | 3 | 317 | 0 | 0 | 
| app_proof | prover | 3 | 101,162,004 | 360 | 84 | 0 | 0 | 236 | 111 | 110 | 52 | 72 | 0 | 39 | 21 | 17 | 8 | 8 | 84 | 236 | 0 | 3 | 71 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 156 | 2,710 | 156 | 163 | 0 | 3 | 118 | 3,566,000 | 35.65 | 
| app_proof | 1 | 67 | 2,402 | 67 | 41 | 0 | 1 | 265 | 3,567,000 | 38.69 | 
| app_proof | 2 | 67 | 2,362 | 67 | 41 | 0 | 1 | 226 | 3,567,000 | 39.18 | 
| app_proof | 3 | 186 | 618 | 186 | 41 | 0 | 2 | 30 | 467,961 | 37.60 | 

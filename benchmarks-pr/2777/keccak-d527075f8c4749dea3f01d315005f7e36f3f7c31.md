...
|:---|---:|---:|---:|
| Total |  17.22 |  5.07 |  5.07 |
| app_proof |  14.13 |  2.77 |  2.77 |
| leaf |  2.23 |  1.45 |  1.45 |
...
| `total_proof_time_ms ` |  2,332 |  13,992 |  2,630 |  2,232 |
...
| `execute_preflight_time_ms` |  233.67 |  1,402 |  313 |  88 |
| `execute_preflight_insn_mi/s` |  34.65 | -          |  35.72 |  32.24 |
| `trace_gen_time_ms   ` |  53.83 |  323 |  154 |  33 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,982.50 |  11,895 |  2,225 |  1,932 |
| `prover.main_trace_commit_time_ms` |  716.33 |  4,298 |  887 |  681 |
| `prover.rap_constraints_time_ms` |  1,077.83 |  6,467 |  1,148 |  1,059 |
| `prover.openings_time_ms` |  187 |  1,122 |  189 |  185 |
| `prover.rap_constraints.logup_gkr_time_ms` |  253 |  1,518 |  313 |  240 |
| `prover.rap_constraints.round0_time_ms` |  513.50 |  3,081 |  520 |  510 |
| `prover.rap_constraints.mle_rounds_time_ms` |  310.17 |  1,861 |  322 |  307 |
| `prover.openings.stacked_reduction_time_ms` |  146 |  876 |  149 |  142 |
| `prover.openings.stacked_reduction.round0_time_ms` |  83.50 |  501 |  86 |  79 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  61.83 |  371 |  63 |  61 |
| `prover.openings.whir_time_ms` |  40.50 |  243 |  43 |  38 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,115.50 |  2,231 |  1,446 |  785 |
| `execute_preflight_time_ms` |  5.50 |  11 |  6 |  5 |
| `trace_gen_time_ms   ` |  137.50 |  275 |  183 |  92 |
| `generate_blob_total_time_ms` |  24.50 |  49 |  33 |  16 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  978 |  1,956 |  1,263 |  693 |
| `prover.main_trace_commit_time_ms` |  550.50 |  1,101 |  725 |  376 |
| `prover.rap_constraints_time_ms` |  320.50 |  641 |  410 |  231 |
| `prover.openings_time_ms` |  106.50 |  213 |  128 |  85 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/d527075f8c4749dea3f01d315005f7e36f3f7c31/keccak-d527075f8c4749dea3f01d315005f7e36f3f7c31.memory.svg)
...
| app_proof |  |  |  |  |  | 2,232 |  |  | 138 | 14,365,133 | 103.86 | 0 | 14,137 |  | 
| internal_for_leaf |  |  |  | 521 |  |  |  |  |  |  |  |  |  | 522 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 39 | 521 | 38 | 13 | 4 | 2 | 2 | 2 | 
| internal_recursive.0 | 1 | 14 | 186 | 13 | 2 | 1 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 9 | 148 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 183 | 1,446 | 182 | 64 | 33 | 6 | 7 | 7 | 
| leaf | 1 | 92 | 785 | 92 | 32 | 16 | 5 | 7 | 7 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 81,415,028 | 482 | 245 | 0 | 14 | 176 | 48 | 47 | 91 | 37 | 0 | 60 | 21 | 38 | 7 | 31 | 245 | 176 | 0 | 2 | 35 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,879 | 172 | 51 | 0 | 4 | 78 | 25 | 25 | 28 | 23 | 0 | 42 | 18 | 24 | 1 | 22 | 52 | 78 | 0 | 2 | 22 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 |
...
|:---|---:|---:|---:|
| Total |  17.47 |  5.20 |  5.20 |
| app_proof |  14.27 |  2.78 |  2.78 |
| leaf |  2.39 |  1.62 |  1.62 |
...
| `total_proof_time_ms ` |  2,356.50 |  14,139 |  2,649 |  2,242 |
...
| `execute_preflight_time_ms` |  233.50 |  1,401 |  314 |  87 |
| `execute_preflight_insn_mi/s` |  35.95 | -          |  36.80 |  33.04 |
| `trace_gen_time_ms   ` |  54.67 |  328 |  158 |  34 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  2,006.17 |  12,037 |  2,239 |  1,936 |
| `prover.main_trace_commit_time_ms` |  719.17 |  4,315 |  889 |  684 |
| `prover.rap_constraints_time_ms` |  1,099.50 |  6,597 |  1,162 |  1,062 |
| `prover.openings_time_ms` |  186.83 |  1,121 |  189 |  185 |
| `prover.rap_constraints.logup_gkr_time_ms` |  249 |  1,494 |  302 |  237 |
| `prover.rap_constraints.round0_time_ms` |  531.50 |  3,189 |  601 |  512 |
| `prover.rap_constraints.mle_rounds_time_ms` |  318 |  1,908 |  334 |  309 |
| `prover.openings.stacked_reduction_time_ms` |  142 |  852 |  143 |  141 |
| `prover.openings.stacked_reduction.round0_time_ms` |  85.67 |  514 |  86 |  85 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  55.67 |  334 |  57 |  55 |
| `prover.openings.whir_time_ms` |  44.17 |  265 |  47 |  42 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,196 |  2,392 |  1,618 |  774 |
| `execute_preflight_time_ms` |  5.50 |  11 |  6 |  5 |
| `trace_gen_time_ms   ` |  136.50 |  273 |  181 |  92 |
| `generate_blob_total_time_ms` |  24.50 |  49 |  33 |  16 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,059 |  2,118 |  1,437 |  681 |
| `prover.main_trace_commit_time_ms` |  639 |  1,278 |  901 |  377 |
| `prover.rap_constraints_time_ms` |  322.50 |  645 |  417 |  228 |
| `prover.openings_time_ms` |  96.50 |  193 |  118 |  75 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/455f911c9b373c1c4f03f0a3802e3a3b3c439d6f/keccak-455f911c9b373c1c4f03f0a3802e3a3b3c439d6f.memory.svg)
...
| app_proof |  |  |  |  |  | 2,242 |  |  | 135 | 14,365,133 | 106.11 | 0 | 14,283 |  | 
...
| leaf | 0 | 181 | 1,618 | 180 | 64 | 33 | 6 | 7 | 7 | 
| leaf | 1 | 92 | 774 | 92 | 32 | 16 | 5 | 8 | 8 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 81,415,028 | 462 | 246 | 0 | 1 | 173 | 49 | 49 | 92 | 30 | 0 | 42 | 18 | 23 | 7 | 15 | 246 | 173 | 0 | 3 | 29 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,879 | 153 | 49 | 0 | 0 | 73 | 25 | 25 | 30 | 17 | 0 | 29 | 20 | 8 | 2 | 6 | 50 | 73 | 0 | 2 | 17 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 123 | 31 | 0 | 0 | 63 | 23 | 23 | 25 | 14 | 0 | 27 | 20 | 7 | 1 | 5 | 31 | 63 | 0 | 2 | 13 | 0 | 0 | 
| leaf | 0 | prover | 476,578,662 | 1,437 | 900 | 0 | 176 | 417 | 208 | 207 | 120 | 88 | 0 | 118 | 46 | 72 | 41 | 30 | 901 | 417 | 0 | 7 | 85 | 0 | 0 | 
| leaf | 1 | prover | 240,255,732 | 681 | 376 | 0 | 1 | 228 | 109 | 108 | 67 | 51 | 0 | 75 | 37 | 37 | 20 | 17 | 377 | 228 | 0 | 6 | 50 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 867,606,540 | 2,239 | 888 | 0 | 206 | 1,162 | 525 | 524 | 334 | 302 | 74 | 187 | 46 | 141 | 86 | 55 | 889 | 1,162 | 0 | 4 | 227 | 0 | 0 | 
| app_proof | prover | 1 | 867,683,340 | 2,021 | 684 | 0 | 3 | 1,148 | 601 | 601 | 309 | 237 | 0 | 189 | 47 | 142 | 85 | 56 | 684 | 1,148 | 0 | 4 | 236 | 0 | 0 | 
| app_proof | prover | 2 | 867,683,340 | 1,957 | 684 | 0 | 3 | 1,087 | 516 | 516 | 332 | 238 | 0 | 185 | 42 | 142 | 86 | 55 | 685 | 1,087 | 0 | 4 | 237 | 0 | 0 | 
| app_proof | prover | 3 | 867,683,340 | 1,943 | 684 | 0 | 3 | 1,071 | 519 | 518 | 311 | 240 | 0 | 187 | 44 | 142 | 86 | 56 | 684 | 1,071 | 0 | 4 | 239 | 0 | 0 | 
| app_proof | prover | 4 | 867,683,340 | 1,936 | 685 | 0 | 3 | 1,062 | 512 | 511 | 310 | 239 | 0 | 188 | 44 | 143 | 85 | 57 | 685 | 1,062 | 0 | 4 | 238 | 0 | 0 | 
| app_proof | prover | 5 | 867,606,540 | 1,941 | 688 | 0 | 3 | 1,067 | 516 | 516 | 312 | 238 | 0 | 185 | 42 | 142 | 86 | 55 | 688 | 1,067 | 0 | 3 | 237 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 158 | 2,649 | 158 | 163 | 0 | 3 | 87 | 2,413,000 | 33.04 | 
| app_proof | 1 | 34 | 2,411 | 34 | 41 | 0 | 1 | 314 | 2,413,000 | 35.98 | 
| app_proof | 2 | 34 | 2,290 | 34 | 41 | 0 | 1 | 257 | 2,413,000 | 36.71 | 
| app_proof | 3 | 34 | 2,276 | 34 | 41 | 0 | 1 | 258 | 2,413,000 | 36.80 | 
| app_proof | 4 | 34 | 2,271 | 34 | 41 | 0 | 1 | 259 | 2,413,000 | 36.59 | 
| app_proof | 5 | 34 | 2,242 | 34 | 41 | 0 | 1 | 226 | 2,300,133 | 36.58 | 

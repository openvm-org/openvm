...
|:---|---:|---:|---:|
| Total |  11.84 |  4.89 |  4.89 |
| app_proof |  9.68 |  2.73 |  2.73 |
| leaf |  1.42 |  1.42 |  1.42 |
...
| `total_proof_time_ms ` |  2,395.75 |  9,583 |  2,633 |  2,287 |
| `execute_metered_time_ms` |  93 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  119.18 | -          |  119.18 |  119.18 |
| `execute_preflight_insns` |  2,791,990.25 |  11,167,961 |  2,851,000 |  2,614,961 |
| `execute_preflight_time_ms` |  163.75 |  655 |  205 |  99 |
| `execute_preflight_insn_mi/s` |  36.14 | -          |  37.30 |  33.65 |
| `trace_gen_time_ms   ` |  102.75 |  411 |  170 |  61 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  2,057 |  8,228 |  2,202 |  1,981 |
| `prover.main_trace_commit_time_ms` |  559.25 |  2,237 |  665 |  523 |
| `prover.rap_constraints_time_ms` |  1,348.25 |  5,393 |  1,387 |  1,306 |
| `prover.openings_time_ms` |  148.50 |  594 |  150 |  147 |
| `prover.rap_constraints.logup_gkr_time_ms` |  358.25 |  1,433 |  402 |  314 |
| `prover.rap_constraints.round0_time_ms` |  669.25 |  2,677 |  685 |  661 |
| `prover.rap_constraints.mle_rounds_time_ms` |  319.75 |  1,279 |  322 |  318 |
...
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  47.25 |  189 |  48 |  47 |
| `prover.openings.whir_time_ms` |  38 |  152 |  39 |  36 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/13601c2b85dcd92ff176bc264e42094dece145fc/sha2_bench-13601c2b85dcd92ff176bc264e42094dece145fc.memory.svg)
...
| app_proof |  |  |  |  |  | 2,287 |  |  | 93 | 11,167,961 | 119.18 | 0 | 9,684 |  | 
...
| leaf | 0 | 147 | 1,423 | 147 | 54 | 25 | 3 | 6 | 6 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 61,220,603 | 375 | 187 | 0 | 10 | 135 | 37 | 36 | 65 | 32 | 0 | 52 | 18 | 33 | 5 | 27 | 188 | 135 | 0 | 2 | 32 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,879 | 175 | 50 | 0 | 4 | 80 | 26 | 25 | 29 | 24 | 0 | 43 | 19 | 24 | 2 | 22 | 51 | 80 | 0 | 3 | 22 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 140 | 33 | 0 | 4 | 65 | 23 | 22 | 24 | 17 | 0 | 40 | 18 | 22 | 1 | 20 | 34 | 65 | 0 | 2 | 17 | 0 | 0 | 
| leaf | 0 | prover | 424,379,238 | 1,275 | 804 | 0 | 195 | 354 | 171 | 170 | 104 | 78 | 0 | 116 | 36 | 79 | 36 | 43 | 804 | 354 | 0 | 6 | 77 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 662,392,121 | 2,202 | 665 | 0 | 185 | 1,387 | 661 | 661 | 322 | 402 | 93 | 149 | 38 | 110 | 61 | 48 | 665 | 1,387 | 0 | 3 | 308 | 0 | 0 | 
| app_proof | prover | 1 | 662,391,820 | 2,054 | 522 | 0 | 39 | 1,382 | 664 | 664 | 320 | 397 | 109 | 148 | 39 | 109 | 62 | 47 | 523 | 1,382 | 0 | 3 | 288 | 0 | 0 | 
| app_proof | prover | 2 | 662,391,820 | 1,991 | 524 | 0 | 39 | 1,318 | 685 | 684 | 319 | 314 | 0 | 147 | 36 | 111 | 63 | 47 | 525 | 1,318 | 0 | 3 | 313 | 0 | 0 | 
| app_proof | prover | 3 | 662,468,884 | 1,981 | 524 | 0 | 41 | 1,306 | 667 | 667 | 318 | 320 | 0 | 150 | 39 | 110 | 63 | 47 | 524 | 1,306 | 0 | 3 | 319 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 170 | 2,633 | 170 | 161 | 0 | 3 | 99 | 2,851,000 | 33.65 | 
| app_proof | 1 | 61 | 2,363 | 61 | 41 | 0 | 2 | 205 | 2,851,000 | 36.99 | 
| app_proof | 2 | 87 | 2,300 | 87 | 41 | 0 | 2 | 180 | 2,851,000 | 37.30 | 
| app_proof | 3 | 93 | 2,287 | 93 | 41 | 0 | 2 | 171 | 2,614,961 | 36.61 | 

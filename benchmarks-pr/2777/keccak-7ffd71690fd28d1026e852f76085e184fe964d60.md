...
|:---|---:|---:|---:|
| Total |  17.06 |  5.11 |  5.11 |
| app_proof |  13.93 |  2.74 |  2.74 |
| leaf |  2.34 |  1.58 |  1.58 |
...
| `total_proof_time_ms ` |  2,296.50 |  13,779 |  2,584 |  2,184 |
| `execute_metered_time_ms` |  155 | -          | -          | -          |
| `execute_metered_insns` |  14,365,133 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  92.09 | -          |  92.09 |  92.09 |
| `execute_preflight_insns` |  2,394,188.83 |  14,365,133 |  2,413,000 |  2,300,133 |
| `execute_preflight_time_ms` |  233.67 |  1,402 |  316 |  89 |
| `execute_preflight_insn_mi/s` |  34.90 | -          |  35.83 |  32.25 |
| `trace_gen_time_ms   ` |  52.83 |  317 |  148 |  33 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,947.83 |  11,687 |  2,184 |  1,881 |
| `prover.main_trace_commit_time_ms` |  704.50 |  4,227 |  870 |  670 |
| `prover.rap_constraints_time_ms` |  1,063.33 |  6,380 |  1,133 |  1,028 |
| `prover.openings_time_ms` |  178.67 |  1,072 |  180 |  177 |
| `prover.rap_constraints.logup_gkr_time_ms` |  238.83 |  1,433 |  295 |  226 |
| `prover.rap_constraints.round0_time_ms` |  516.67 |  3,100 |  585 |  499 |
| `prover.rap_constraints.mle_rounds_time_ms` |  306.50 |  1,839 |  326 |  298 |
| `prover.openings.stacked_reduction_time_ms` |  135.33 |  812 |  136 |  135 |
...
| `prover.openings.whir_time_ms` |  43 |  258 |  44 |  42 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,168.50 |  2,337 |  1,579 |  758 |
| `execute_preflight_time_ms` |  5.50 |  11 |  6 |  5 |
| `trace_gen_time_ms   ` |  137.50 |  275 |  183 |  92 |
| `generate_blob_total_time_ms` |  24.50 |  49 |  33 |  16 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,030 |  2,060 |  1,395 |  665 |
| `prover.main_trace_commit_time_ms` |  626 |  1,252 |  882 |  370 |
| `prover.rap_constraints_time_ms` |  309 |  618 |  398 |  220 |
...
| `prover.rap_constraints.mle_rounds_time_ms` |  90.50 |  181 |  116 |  65 |
| `prover.openings.stacked_reduction_time_ms` |  52.50 |  105 |  69 |  36 |
| `prover.openings.stacked_reduction.round0_time_ms` |  29 |  58 |  39 |  19 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  23 |  46 |  29 |  17 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/7ffd71690fd28d1026e852f76085e184fe964d60/keccak-7ffd71690fd28d1026e852f76085e184fe964d60.memory.svg)
...
| app_proof |  |  |  |  |  | 2,184 |  |  | 155 | 14,365,133 | 92.09 | 0 | 13,941 |  | 
...
| leaf | 0 | 183 | 1,579 | 183 | 64 | 33 | 6 | 7 | 7 | 
| leaf | 1 | 92 | 758 | 92 | 32 | 16 | 5 | 7 | 7 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 81,415,028 | 458 | 240 | 0 | 1 | 171 | 49 | 48 | 90 | 31 | 0 | 45 | 21 | 23 | 7 | 15 | 240 | 171 | 0 | 3 | 29 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,879 | 148 | 47 | 0 | 0 | 71 | 24 | 23 | 29 | 17 | 0 | 29 | 20 | 8 | 1 | 6 | 47 | 71 | 0 | 2 | 16 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 121 | 31 | 0 | 0 |
...
|:---|---:|---:|---:|
| Total |  2.77 |  1.54 |  1.54 |
| app_proof |  1.83 |  0.60 |  0.60 |
| leaf |  0.43 |  0.43 |  0.43 |
...
| `total_proof_time_ms ` |  452.75 |  1,811 |  583 |  318 |
| `execute_metered_time_ms` |  19 | -          | -          | -          |
| `execute_metered_insns` |  4,000,051 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  200.89 | -          |  200.89 |  200.89 |
| `execute_preflight_insns` |  1,000,012.75 |  4,000,051 |  1,310,000 |  70,051 |
| `execute_preflight_time_ms` |  33.50 |  134 |  48 |  4 |
| `execute_preflight_insn_mi/s` |  42.81 | -          |  44.30 |  39.57 |
| `trace_gen_time_ms   ` |  177.25 |  709 |  202 |  162 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  169.75 |  679 |  205 |  70 |
| `prover.main_trace_commit_time_ms` |  42.50 |  170 |  52 |  15 |
| `prover.rap_constraints_time_ms` |  97 |  388 |  119 |  33 |
| `prover.openings_time_ms` |  29.25 |  117 |  33 |  22 |
| `prover.rap_constraints.logup_gkr_time_ms` |  61.50 |  246 |  78 |  16 |
| `prover.rap_constraints.round0_time_ms` |  21.25 |  85 |  28 |  9 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/7ffd71690fd28d1026e852f76085e184fe964d60/fibonacci-7ffd71690fd28d1026e852f76085e184fe964d60.memory.svg)
...
| app_proof |  |  |  |  |  | 318 |  |  | 19 | 4,000,051 | 200.89 | 0 | 1,839 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 27,289,339 | 207 | 81 | 0 | 0 | 96 | 31 | 30 | 45 | 20 | 0 | 28 | 17 | 11 | 2 | 8 | 81 | 96 | 0 | 2 | 18 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,703 | 145 | 45 | 0 | 0 | 66 | 24 | 24 | 28 | 13 | 0 | 32 | 24 | 8 | 1 | 6 | 46 | 66 | 0 | 2 | 12 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 120 | 31 | 0 | 0 | 61 | 23 | 22 | 24 | 13 | 0 | 27 | 20 | 7 | 1 | 5 | 31 | 61 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 102,941,734 | 370 | 167 | 0 | 0 | 157 | 69 | 68 | 45 | 42 | 0 | 45 | 27 | 18 | 8 | 9 | 167 | 157 | 0 | 5 | 41 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 66,843,374 | 205 | 51 | 0 | 0 | 119 | 28 | 28 | 16 | 74 | 0 | 33 | 21 | 12 | 5 | 6 | 51 | 119 | 0 | 3 | 73 | 0 | 0 | 
| app_proof | prover | 1 | 66,799,436 | 201 | 52 | 0 | 0 | 118 | 24 | 24 | 15 | 78 | 0 | 30 | 19 | 11 | 5 | 5 | 52 | 118 | 0 | 3 | 77 | 0 | 0 | 
| app_proof | prover | 2 | 66,799,436 | 203 | 52 | 0 | 0 | 118 | 24 | 24 | 15 | 78 | 0 | 32 | 21 | 11 | 5 | 5 | 52 | 118 | 0 | 3 | 77 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 177 | 583 | 177 | 162 | 0 | 3 | 37 | 1,310,000 | 39.57 | 
| app_proof | 1 | 162 | 453 | 162 | 41 | 0 | 1 | 48 | 1,310,000 | 44.26 | 
| app_proof | 2 | 168 | 457 | 167 | 41 | 0 | 1 | 45 | 1,310,000 | 44.30 | 
| app_proof | 3 | 202 | 318 | 202 | 41 | 0 | 1 | 4 | 70,051 | 43.13 | 

...
|:---|---:|---:|---:|
| Total |  9.75 |  4.22 |  4.23 |
| app_proof |  8.30 |  2.77 |  2.77 |
| leaf |  0.90 |  0.90 |  0.90 |
...
| `total_proof_time_ms ` |  2,052.25 |  8,209 |  2,681 |  625 |
...
| `execute_preflight_time_ms` |  161.25 |  645 |  265 |  30 |
| `execute_preflight_insn_mi/s` |  37.45 | -          |  38.86 |  34.39 |
| `trace_gen_time_ms   ` |  118.75 |  475 |  187 |  67 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,699.75 |  6,799 |  2,241 |  366 |
| `prover.main_trace_commit_time_ms` |  462.50 |  1,850 |  689 |  84 |
| `prover.rap_constraints_time_ms` |  1,117 |  4,468 |  1,411 |  240 |
| `prover.openings_time_ms` |  119.25 |  477 |  148 |  41 |
| `prover.rap_constraints.logup_gkr_time_ms` |  329 |  1,316 |  419 |  73 |
| `prover.rap_constraints.round0_time_ms` |  529 |  2,116 |  671 |  112 |
| `prover.rap_constraints.mle_rounds_time_ms` |  257.75 |  1,031 |  328 |  54 |
| `prover.openings.stacked_reduction_time_ms` |  84.25 |  337 |  107 |  18 |
| `prover.openings.stacked_reduction.round0_time_ms` |  50.50 |  202 |  65 |  9 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  32.75 |  131 |  41 |  8 |
| `prover.openings.whir_time_ms` |  34.50 |  138 |  42 |  23 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/7ffd71690fd28d1026e852f76085e184fe964d60/sha2_bench-7ffd71690fd28d1026e852f76085e184fe964d60.memory.svg)
...
| app_proof |  |  |  |  |  | 625 |  |  | 92 | 11,167,961 | 121.10 | 0 | 8,308 |  | 
| internal_for_leaf |  |  |  | 280 |  |  |  |  |  |  |  |  |  | 280 | 
| internal_recursive.0 |  |  |  | 145 |  |  |  |  |  |  |  |  |  | 146 | 
| internal_recursive.1 |  |  |  | 124 |  |  |  |  |  |  |  |  |  | 125 | 
| leaf |  |  | 903 |  |  |  |  |  |  |  |  |  |  | 903 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 21 | 280 | 21 | 6 | 1 | 2 | 2 | 2 | 
| internal_recursive.0 | 1 | 10 | 145 | 10 | 1 | 0 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 9 | 124 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 130 | 903 | 130 | 48 | 21 | 2 | 1 | 1 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,577,915 | 259 | 117 | 0 | 0 | 107 | 35 | 34 | 52 | 20 | 0 | 33 | 19 | 13 | 3 | 9 | 118 | 107 | 0 | 2 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,703 | 135 | 44 | 0 | 0 | 63 | 22 | 21 | 27 | 13 | 0 | 27 | 18 | 8 | 1 | 6 | 45 | 63 | 0 | 3 | 12 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 115 | 31 | 0 | 0 | 58 | 21 | 20 | 24 | 13 | 0 | 25 | 17 | 7 | 1 | 5 | 31 | 58 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 267,458,790 | 772 | 409 | 0 | 1 | 285 | 131 | 130 | 79 | 74 | 0 | 76 | 35 | 41 | 22 | 18 | 409 | 285 | 0 | 6 | 73 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 686,312,761 | 2,241 | 689 | 0 | 154 | 1,408 | 671 | 671 | 323 | 413 | 114 | 143 | 35 | 107 | 65 | 41 | 689 | 1,408 | 0 | 3 | 298 | 0 | 0 | 
| app_proof | prover | 1 | 686,312,460 | 2,097 | 537 | 0 | 2 | 1,411 | 664 | 664 | 326 | 419 | 125 | 148 | 42 | 106 | 64 | 41 | 537 | 1,411 | 0 | 4 | 293 | 0 | 0 | 
| app_proof | prover | 2 | 686,312,460 | 2,095 | 539 | 0 | 2 | 1,409 | 669 | 669 | 328 | 411 | 119 | 145 | 38 | 106 | 64 | 41 | 540 | 1,409 | 0 | 4 | 290 | 0 | 0 | 
| app_proof | prover | 3 | 106,273,044 | 366 | 84 | 0 | 0 | 240 | 112 | 111 | 54 | 73 | 0 | 41 | 23 | 18 | 9 | 8 | 84 | 240 | 0 | 3 | 72 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 154 | 2,681 | 154 | 162 | 0 | 3 | 122 | 3,562,000 | 34.39 | 
| app_proof | 1 | 67 | 2,471 | 67 | 41 | 0 | 1 | 265 | 3,562,000 | 38.71 | 
| app_proof | 2 | 67 | 2,432 | 67 | 41 | 0 | 1 | 228 | 3,562,000 | 38.86 | 
| app_proof | 3 | 187 | 625 | 187 | 41 | 0 | 2 | 30 | 481,961 | 37.83 | 

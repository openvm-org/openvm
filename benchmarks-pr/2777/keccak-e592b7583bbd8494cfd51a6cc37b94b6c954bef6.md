...
|:---|---:|---:|---:|
| Total |  17.53 |  5.14 |  5.14 |
| app_proof |  14.39 |  2.80 |  2.80 |
| leaf |  2.27 |  1.47 |  1.47 |
...
| `total_proof_time_ms ` |  2,376 |  14,256 |  2,661 |  2,279 |
| `execute_metered_time_ms` |  139 | -          | -          | -          |
| `execute_metered_insns` |  14,365,133 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  103.26 | -          |  103.26 |  103.26 |
| `execute_preflight_insns` |  2,394,188.83 |  14,365,133 |  2,413,000 |  2,300,133 |
| `execute_preflight_time_ms` |  244.67 |  1,468 |  325 |  97 |
| `execute_preflight_insn_mi/s` |  30.71 | -          |  31.53 |  28.82 |
| `trace_gen_time_ms   ` |  53 |  318 |  149 |  33 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  2,016 |  12,096 |  2,251 |  1,966 |
| `prover.main_trace_commit_time_ms` |  726.33 |  4,358 |  895 |  691 |
| `prover.rap_constraints_time_ms` |  1,096.67 |  6,580 |  1,160 |  1,080 |
| `prover.openings_time_ms` |  192 |  1,152 |  195 |  189 |
| `prover.rap_constraints.logup_gkr_time_ms` |  257.17 |  1,543 |  314 |  245 |
| `prover.rap_constraints.round0_time_ms` |  522.17 |  3,133 |  527 |  518 |
| `prover.rap_constraints.mle_rounds_time_ms` |  316 |  1,896 |  327 |  313 |
| `prover.openings.stacked_reduction_time_ms` |  150.67 |  904 |  153 |  147 |
| `prover.openings.stacked_reduction.round0_time_ms` |  86.50 |  519 |  88 |  83 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  63.50 |  381 |  64 |  63 |
| `prover.openings.whir_time_ms` |  41 |  246 |  43 |  38 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,135 |  2,270 |  1,471 |  799 |
| `execute_preflight_time_ms` |  5.50 |  11 |  6 |  5 |
| `trace_gen_time_ms   ` |  138 |  276 |  184 |  92 |
| `generate_blob_total_time_ms` |  25 |  50 |  34 |  16 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  996.50 |  1,993 |  1,287 |  706 |
| `prover.main_trace_commit_time_ms` |  558.50 |  1,117 |  735 |  382 |
| `prover.rap_constraints_time_ms` |  330 |  660 |  421 |  239 |
| `prover.openings_time_ms` |  107.50 |  215 |  130 |  85 |
| `prover.rap_constraints.logup_gkr_time_ms` |  73.50 |  147 |  89 |  58 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/e592b7583bbd8494cfd51a6cc37b94b6c954bef6/keccak-e592b7583bbd8494cfd51a6cc37b94b6c954bef6.memory.svg)
...
| frac_sumcheck.segment_tree | 12.24 | app_proof.prover.4 |
| prover.gkr_input_evals | 12.24 | app_proof.prover.4 |
| prover.batch_constraints.fold_ple_evals | 11.81 | app_proof.prover.4 |
| prover.batch_constraints.round0 | 11.81 | app_proof.prover.4 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 76 | 9 |  |  | 0 |  | 355 | 9 |  |  |  |  |  |  | 
| app_proof |  |  |  |  |  | 2,279 |  |  | 139 | 14,365,133 | 103.26 | 0 | 14,402 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 38 | 525 | 37 | 14 | 4 | 2 | 2 | 2 | 
| internal_recursive.0 | 1 | 13 | 189 | 13 | 2 | 1 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 9 | 153 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 184 | 1,471 | 183 | 65 | 34 | 6 | 7 | 7 | 
| leaf | 1 | 92 | 799 | 92 | 33 | 16 | 5 | 7 | 7 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 81,415,028 | 487 | 249 | 0 | 14 | 177 | 47 | 46 | 93 | 36 | 0 | 59 | 19 | 39 | 8 | 31 | 250 | 177 | 0 | 2 | 35 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,879 | 175 | 51 | 0 | 4 | 78 | 25 | 25 | 29 | 23 | 0 | 44 | 20 | 24 | 1 | 22 | 52 | 78 | 0 | 2 | 23 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 144 | 34 | 0 | 4 | 65 | 22 | 21 | 24 | 18 | 0 | 43 | 20 | 22 | 1 | 21 | 34 | 65 | 0 | 2 | 18 | 0 | 0 | 
| leaf | 0 | prover | 476,578,662 | 1,287 | 734 | 0 | 47 | 421 | 210 | 210 | 120 | 89 | 0 | 130 | 42 | 88 | 41 | 46 | 735 | 421 | 0 | 6 | 88 | 0 | 0 | 
| leaf | 1 | prover | 240,255,732 | 706 | 381 | 0 | 24 | 239 | 111 | 110 | 69 | 58 | 0 | 85 | 32 | 52 | 19 | 32 | 382 | 239 | 0 | 5 | 56 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 867,606,540 | 2,251 | 895 | 0 | 262 | 1,160 | 518 | 517 | 327 | 314 | 72 | 195 | 43 | 152 | 87 | 64 | 895 | 1,160 | 0 | 3 | 241 | 0 | 0 | 
| app_proof | prover | 1 | 867,683,340 | 1,966 | 691 | 0 | 59 | 1,080 | 519 | 519 | 314 | 246 | 0 | 194 | 43 | 150 | 87 | 63 | 691 | 1,080 | 0 | 4 | 244 | 0 | 0 | 
| app_proof | prover | 2 | 867,683,340 | 1,967 | 691 | 0 | 59 | 1,085 | 525 | 524 | 313 | 245 | 0 | 189 | 42 | 147 | 83 | 63 | 692 | 1,085 | 0 | 3 | 244 | 0 | 0 | 
| app_proof | prover | 3 | 867,683,340 | 1,975 | 692 | 0 | 59 | 1,089 | 527 | 527 | 314 | 246 | 0 | 192 | 41 | 151 | 87 | 64 | 693 | 1,089 | 0 | 3 | 245 | 0 | 0 | 
| app_proof | prover | 4 | 867,683,340 | 1,970 | 694 | 0 | 59 | 1,083 | 521 | 520 | 314 | 247 | 0 | 192 | 39 | 153 | 88 | 64 | 694 | 1,083 | 0 | 3 | 246 | 0 | 0 | 
| app_proof | prover | 5 | 867,606,540 | 1,967 | 693 | 0 | 59 | 1,083 | 523 | 523 | 314 | 245 | 0 | 190 | 38 | 151 | 87 | 63 | 693 | 1,083 | 0 | 3 | 245 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 149 | 2,661 | 149 | 162 | 0 | 3 | 97 | 2,413,000 | 28.82 | 
| app_proof | 1 | 34 | 2,367 | 34 | 41 | 0 | 1 | 325 | 2,413,000 | 31.42 | 
| app_proof | 2 | 34 | 2,309 | 34 | 41 | 0 | 1 | 267 | 2,413,000 | 31.53 | 
| app_proof | 3 | 34 | 2,322 | 34 | 41 | 0 | 1 | 271 | 2,413,000 | 30.43 | 
| app_proof | 4 | 34 | 2,318 | 34 | 41 | 0 | 1 | 272 | 2,413,000 | 30.60 | 
| app_proof | 5 | 33 | 2,279 | 33 | 41 | 0 | 1 | 236 | 2,300,133 | 31.44 | 

...
|:---|---:|---:|---:|
| Total |  9.64 |  4.26 |  4.26 |
| app_proof |  8.18 |  2.81 |  2.81 |
| leaf |  0.90 |  0.90 |  0.90 |
...
| `total_proof_time_ms ` |  2,018 |  8,072 |  2,697 |  616 |
| `execute_metered_time_ms` |  113 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  98.48 | -          |  98.48 |  98.48 |
| `execute_preflight_insns` |  2,791,990.25 |  11,167,961 |  3,567,000 |  467,961 |
| `execute_preflight_time_ms` |  163.75 |  655 |  274 |  30 |
| `execute_preflight_insn_mi/s` |  37.51 | -          |  39.13 |  35.13 |
| `trace_gen_time_ms   ` |  118.75 |  475 |  187 |  67 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,663 |  6,652 |  2,259 |  357 |
| `prover.main_trace_commit_time_ms` |  469 |  1,876 |  702 |  84 |
| `prover.rap_constraints_time_ms` |  1,075 |  4,300 |  1,411 |  235 |
| `prover.openings_time_ms` |  118.25 |  473 |  146 |  37 |
| `prover.rap_constraints.logup_gkr_time_ms` |  283 |  1,132 |  424 |  73 |
| `prover.rap_constraints.round0_time_ms` |  536 |  2,144 |  689 |  109 |
| `prover.rap_constraints.mle_rounds_time_ms` |  254.75 |  1,019 |  323 |  52 |
| `prover.openings.stacked_reduction_time_ms` |  84.50 |  338 |  108 |  17 |
| `prover.openings.stacked_reduction.round0_time_ms` |  50.75 |  203 |  65 |  8 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  33.25 |  133 |  42 |  8 |
| `prover.openings.whir_time_ms` |  33.25 |  133 |  38 |  20 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/64815b88cc8ae5af27517a12f8539ebcdfdc73fe/sha2_bench-64815b88cc8ae5af27517a12f8539ebcdfdc73fe.memory.svg)

| Module | Max (GB) | Max At |
| --- | ---: | --- |
| prover.batch_constraints.before_round0 | 11.88 | app_proof.prover.0 |
| frac_sumcheck.gkr_rounds | 11.88 | app_proof.prover.0 |
| prover.gkr_input_evals | 11.81 | app_proof.prover.0 |
| frac_sumcheck.segment_tree | 11.81 | app_proof.prover.0 |
| prover.rap_constraints | 11.77 | app_proof.prover.0 |
| prover.batch_constraints.round0 | 11.03 | app_proof.prover.0 |
| prover.batch_constraints.fold_ple_evals | 11.03 | app_proof.prover.0 |
| prover.prove_whir_opening | 10.48 | app_proof.prover.0 |
| prover.merkle_tree | 10.48 | app_proof.prover.0 |
| prover.openings | 10.48 | app_proof.prover.0 |
| prover.before_gkr_input_evals | 8.16 | app_proof.prover.0 |
| prover.stacked_commit | 8.16 | app_proof.prover.0 |
| prover.rs_code_matrix | 8.15 | app_proof.prover.0 |
...
| 26 | VmAirWrapper<Rv64BaseAluAdapterAir, AndCoreAir<8, 8> | 24 | 13 | 3 | 
| 27 | VmAirWrapper<Rv64BaseAluAdapterAir, OrCoreAir<8, 8> | 24 | 13 | 3 | 
| 28 | VmAirWrapper<Rv64BaseAluAdapterAir, XorCoreAir<8, 8> | 24 | 13 | 3 | 
| 29 | VmAirWrapper<Rv64BaseAluAdapterAir, SubCoreAir<8, 8> | 24 | 21 | 3 | 
| 3 | MemoryMerkleAir<8> | 4 | 33 | 3 | 
| 30 | VmAirWrapper<Rv64BaseAluAdapterAir, AddCoreAir<8, 8> | 24 | 21 | 3 | 
| 31 | BitwiseOperationLookupAir<8> | 2 | 19 | 2 | 
| 32 | PhantomAir | 3 |  | 1 | 
| 33 | Poseidon2PeripheryAir<BabyBearParameters>, 1> | 1 | 282 | 3 | 
| 34 | VariableRangeCheckerAir | 1 | 10 | 3 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 81 | 9 |  |  | 0 |  | 369 | 9 |  |  |  |  |  |  | 
| app_proof |  |  |  |  |  | 616 |  |  | 113 | 11,167,961 | 98.48 | 0 | 8,191 |  | 
...
| app_proof | VmAirWrapper<Rv64BaseAluAdapterAir, AddCoreAir<8, 8> | 0 | 4 | 
| app_proof | VmAirWrapper<Rv64BaseAluAdapterAir, AndCoreAir<8, 8> | 0 | 1 | 
...
| app_proof | VmAirWrapper<Rv64BaseAluAdapterAir, SubCoreAir<8, 8> | 0 | 1 | 
...
| app_proof | VmAirWrapper<Rv64BaseAluAdapterAir, AddCoreAir<8, 8> | 1 | 4 | 
| app_proof | VmAirWrapper<Rv64BaseAluAdapterAir, AndCoreAir<8, 8> | 1 | 1 | 
| app_proof | VmAirWrapper<Rv64BaseAluAdapterAir, ShiftCoreAir<8, 8> | 1 | 1 | 
| app_proof | VmAirWrapper<Rv64BaseAluAdapterAir, SubCoreAir<8, 8> | 1 | 1 | 
...
| app_proof | VmAirWrapper<Rv64BaseAluAdapterAir, AddCoreAir<8, 8> | 2 | 4 | 
| app_proof | VmAirWrapper<Rv64BaseAluAdapterAir, AndCoreAir<8, 8> | 2 | 1 | 
| app_proof | VmAirWrapper<Rv64BaseAluAdapterAir, ShiftCoreAir<8, 8> | 2 | 2 | 
| app_proof | VmAirWrapper<Rv64BaseAluAdapterAir, SubCoreAir<8, 8> | 2 | 1 | 
...
| app_proof | VmAirWrapper<Rv64CondRdWriteAdapterAir, Rv64JalLuiCoreAir> | 3 | 4 | 
...
| app_proof | 26 | VmAirWrapper<Rv64BaseAluAdapterAir, AndCoreAir<8, 8> | prover | 0 | 262,144 | 48 | 12,582,912 | 
| app_proof | 27 | VmAirWrapper<Rv64BaseAluAdapterAir, OrCoreAir<8, 8> | prover | 0 | 1 | 48 | 48 | 
| app_proof | 29 | VmAirWrapper<Rv64BaseAluAdapterAir, SubCoreAir<8, 8> | prover | 0 | 262,144 | 48 | 12,582,912 | 
| app_proof | 3 | MemoryMerkleAir<8> | prover | 0 | 2,048 | 32 | 65,536 | 
| app_proof | 30 | VmAirWrapper<Rv64BaseAluAdapterAir, AddCoreAir<8, 8> | prover | 0 | 1,048,576 | 48 | 50,331,648 | 
...
| app_proof | 26 | VmAirWrapper<Rv64BaseAluAdapterAir, AndCoreAir<8, 8> | prover | 1 | 262,144 | 48 | 12,582,912 | 
| app_proof | 29 | VmAirWrapper<Rv64BaseAluAdapterAir, SubCoreAir<8, 8> | prover | 1 | 262,144 | 48 | 12,582,912 | 
| app_proof | 3 | MemoryMerkleAir<8> | prover | 1 | 2,048 | 32 | 65,536 | 
| app_proof | 30 | VmAirWrapper<Rv64BaseAluAdapterAir, AddCoreAir<8, 8> | prover | 1 | 1,048,576 | 48 | 50,331,648 | 
...
| app_proof | 26 | VmAirWrapper<Rv64BaseAluAdapterAir, AndCoreAir<8, 8> | prover | 2 | 262,144 | 48 | 12,582,912 | 
| app_proof | 29 | VmAirWrapper<Rv64BaseAluAdapterAir, SubCoreAir<8, 8> | prover | 2 | 262,144 | 48 | 12,582,912 | 
| app_proof | 3 | MemoryMerkleAir<8> | prover | 2 | 2,048 | 32 | 65,536 | 
| app_proof | 30 | VmAirWrapper<Rv64BaseAluAdapterAir, AddCoreAir<8, 8> | prover | 2 | 1,048,576 | 48 | 50,331,648 | 
| app_proof | 31 | BitwiseOperationLookupAir<8> | prover | 2 | 65,536 | 18 | 1,179,648 | 
| app_proof | 33 | Poseidon2PeripheryAir<BabyBearParameters>, 1> | prover | 2 | 256 | 300 | 76,800 | 
| app_proof | 34 | VariableRangeCheckerAir | prover | 2 | 262,144 | 4 | 1,048,576 | 
...
| app_proof | 26 | VmAirWrapper<Rv64BaseAluAdapterAir, AndCoreAir<8, 8> | prover | 3 | 65,536 | 48 | 3,145,728 | 
| app_proof | 27 | VmAirWrapper<Rv64BaseAluAdapterAir
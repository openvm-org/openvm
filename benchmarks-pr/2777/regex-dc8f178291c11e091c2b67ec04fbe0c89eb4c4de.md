...
|:---|---:|---:|---:|
| Total |  2.46 |  1.78 |  1.78 |
| app_proof |  1.60 |  0.91 |  0.91 |
| leaf |  0.36 |  0.36 |  0.36 |
...
| `total_proof_time_ms ` |  782.50 |  1,565 |  875 |  690 |
...
| `execute_preflight_time_ms` |  79 |  158 |  85 |  73 |
| `execute_preflight_insn_mi/s` |  36.08 | -          |  37.97 |  34.20 |
| `trace_gen_time_ms   ` |  149 |  298 |  150 |  148 |
| `memory_finalize_time_ms` |  1 |  2 |  2 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  452 |  904 |  479 |  425 |
| `prover.main_trace_commit_time_ms` |  124 |  248 |  144 |  104 |
| `prover.rap_constraints_time_ms` |  278.50 |  557 |  282 |  275 |
| `prover.openings_time_ms` |  48.50 |  97 |  52 |  45 |
| `prover.rap_constraints.logup_gkr_time_ms` |  147 |  294 |  157 |  137 |
| `prover.rap_constraints.round0_time_ms` |  90 |  180 |  101 |  79 |
| `prover.rap_constraints.mle_rounds_time_ms` |  40.50 |  81 |  45 |  36 |
| `prover.openings.stacked_reduction_time_ms` |  25 |  50 |  28 |  22 |
| `prover.openings.stacked_reduction.round0_time_ms` |  12.50 |  25 |  15 |  10 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  11.50 |  23 |  12 |  11 |
| `prover.openings.whir_time_ms` |  23.50 |  47 |  24 |  23 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/dc8f178291c11e091c2b67ec04fbe0c89eb4c4de/regex-dc8f178291c11e091c2b67ec04fbe0c89eb4c4de.memory.svg)

| Module | Max (GB) | Max At |
| --- | ---: | --- |
| generate mem proving ctxs | 4.88 | app_proof.0 |
| set initial memory | 4.85 | app_proof.1 |
| frac_sumcheck.gkr_rounds | 4.45 | app_proof.prover.0 |
| prover.batch_constraints.before_round0 | 4.45 | app_proof.prover.0 |
...
| prover.openings | 2.81 | app_proof.prover.0 |
| prover.prove_whir_opening | 2.81 | app_proof.prover.0 |
| prover.merkle_tree | 2.81 | app_proof.prover.0 |
...
| app_proof |  |  |  |  |  | 690 |  |  | 31 | 4,090,656 | 129.86 | 0 | 1,611 |  | 
...
| app_proof | 25 | VmAirWrapper<Rv64BaseAluAdapterAir, XorOrAndCoreAir<8, 8> | prover | 0 | 65,536 | 50 | 3,276,800 | 
...
| app_proof | 25 | VmAirWrapper<Rv64BaseAluAdapterAir, XorOrAndCoreAir<8, 8> | prover | 1 | 65,536 | 50 | 3,276,800 | 
| app_proof | 26 | VmAirWrapper<Rv64BaseAluAdapterAir, AddSubCoreAir<8, 8> | prover | 1 | 524,288 | 49 | 25,690,112 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 27,256,571 | 214 | 81 | 0 | 0 | 98 | 33 | 32 | 45 | 19 | 0 | 33 | 22 | 11 | 2 | 8 | 81 | 98 | 0 | 2 | 18 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,703 | 142 | 46 | 0 | 0 | 67 | 25 | 24 | 28 | 14 | 0 | 27 | 19 | 8 | 1 | 6 | 46 | 67 | 0 | 2 | 12 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 119 | 31 | 0 | 0 | 61 | 23 | 23 | 24 | 13 | 0 | 26 | 18 | 7 | 1 | 5 | 31 | 61 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 79,962,868 | 308 | 128 | 0 | 0 | 135 | 55 | 54 | 37 | 42 | 0 | 44 | 28 | 15 | 6 | 8 | 128 | 135 | 0 | 5 | 41 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 179,782,354 | 479 | 144 | 0 | 0 | 282 | 79 | 79 | 45 | 157 | 0 | 52 | 24 | 28 | 15 | 12 | 144 | 282 | 0 | 3 | 155 | 0 | 0 | 
| app_proof | prover | 1 | 135,061,081 | 425 | 104 | 0 | 9 | 275 | 101 | 100 | 36 | 137 | 0 | 45 | 23 | 22 | 10 | 11 | 104 | 275 | 0 | 3 | 137 | 0 | 0 | 

| group | phase | segment | trace_height_constraint | weighted_sum | threshold |
| --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 0 | 64,894,157 | 2,013,265,921 | 
| app_proof | prover | 1 | 0 | 48,407,193 | 2,013,265,921 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 148 | 875 | 148 | 162 | 2 | 5 | 85 | 2,327,000 | 34.20 | 
| app_proof | 1 | 150 | 690 | 150 | 41 | 0 | 2 | 73 | 1,763,656 | 37.97 | 

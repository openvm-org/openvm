...
|:---|---:|---:|---:|
| Total |  2.65 |  1.96 |  1.96 |
| app_proof |  1.92 |  1.23 |  1.23 |
| leaf |  0.42 |  0.42 |  0.42 |
...
| `total_proof_time_ms ` |  950.50 |  1,901 |  1,212 |  689 |
| `execute_metered_time_ms` |  23 | -          | -          | -          |
| `execute_metered_insns` |  1,979,971 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  83.50 | -          |  83.50 |  83.50 |
| `execute_preflight_insns` |  989,985.50 |  1,979,971 |  1,168,000 |  811,971 |
| `execute_preflight_time_ms` |  89.50 |  179 |  126 |  53 |
| `execute_preflight_insn_mi/s` |  34.60 | -          |  35.54 |  33.67 |
| `trace_gen_time_ms   ` |  29.50 |  59 |  44 |  15 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  720.50 |  1,441 |  936 |  505 |
| `prover.main_trace_commit_time_ms` |  214.50 |  429 |  293 |  136 |
| `prover.rap_constraints_time_ms` |  459 |  918 |  589 |  329 |
| `prover.openings_time_ms` |  46.50 |  93 |  53 |  40 |
| `prover.rap_constraints.logup_gkr_time_ms` |  74 |  148 |  109 |  39 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/e53664d30663bdf156e08a79eb6c350c5a501426/kitchen_sink-e53664d30663bdf156e08a79eb6c350c5a501426.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 75 | 3 |  |  | 0 |  | 343 | 3 |  |  |  |  |  |  | 
| app_proof |  |  |  |  |  | 689 |  |  | 23 | 1,979,971 | 83.50 | 0 | 1,929 |  | 
...
| leaf | 0 | 114 | 415 | 114 | 25 | 11 | 20 | 5 | 5 | 
...
| internal_recursive.0 | 1 | prover | 15,378,703 | 81 | 16 | 0 | 0 | 48 | 17 | 17 | 20 | 10 | 0 | 15 | 9 | 5 | 1 | 4 | 16 | 48 | 0 | 1 | 9 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 75 | 11 | 0 | 0 | 49 | 19 | 18 | 18 | 10 | 0 | 14 | 8 | 5 | 0 | 4 | 11 | 49 | 0 | 1 | 9 | 0 | 0 | 
| leaf | 0 | prover | 263,565,172 | 300 | 128 | 0 | 1 | 142 | 49 | 48 | 37 | 54 | 0 | 28 | 12 | 15 | 7 | 8 | 129 | 142 | 0 | 2 | 53 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 570,054,164 | 936 | 292 | 0 | 162 | 589 | 347 | 345 | 132 | 109 | 52 | 53 | 14 | 39 | 16 | 22 | 293 | 589 | 0 | 1 | 55 | 0 | 0 | 
| app_proof | prover | 1 | 530,609,548 | 505 | 135 | 0 | 1 | 329 | 213 | 212 | 76 | 39 | 0 | 40 | 12 | 27 | 14 | 13 | 136 | 329 | 0 | 1 | 38 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 44 | 1,212 | 44 | 177 | 0 | 3 | 53 | 1,168,000 | 33.67 | 
| app_proof | 1 | 15 | 689 | 15 | 40 | 0 | 1 | 126 | 811,971 | 35.54 | 

...
| `total_proof_time_ms ` |  940.50 |  1,881 |  1,204 |  677 |
| `execute_metered_time_ms` |  23 | -          | -          | -          |
| `execute_metered_insns` |  1,979,971 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  83.12 | -          |  83.12 |  83.12 |
| `execute_preflight_insns` |  989,985.50 |  1,979,971 |  1,168,000 |  811,971 |
| `execute_preflight_time_ms` |  93.50 |  187 |  132 |  55 |
| `execute_preflight_insn_mi/s` |  34.75 | -          |  34.81 |  34.69 |
| `trace_gen_time_ms   ` |  29.50 |  59 |  43 |  16 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  708 |  1,416 |  929 |  487 |
| `prover.main_trace_commit_time_ms` |  214 |  428 |  293 |  135 |
| `prover.rap_constraints_time_ms` |  446 |  892 |  583 |  309 |
| `prover.openings_time_ms` |  46.50 |  93 |  52 |  41 |
| `prover.rap_constraints.logup_gkr_time_ms` |  80 |  160 |  108 |  52 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/28f15696253db32470b1ef2f256747681740db4c/kitchen_sink-28f15696253db32470b1ef2f256747681740db4c.memory.svg)
...
| app_proof |  |  |  |  |  | 677 |  |  | 23 | 1,979,971 | 83.12 | 0 | 1,909 |  | 
...
| leaf | 0 | 111 | 409 | 110 | 25 | 11 | 20 | 5 | 5 | 
...
| leaf | 0 | prover | 263,565,172 | 298 | 128 | 0 | 1 | 140 | 48 | 48 | 37 | 54 | 0 | 29 | 13 | 15 | 7 | 8 | 129 | 140 | 0 | 2 | 53 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 573,224,468 | 929 | 292 | 0 | 160 | 583 | 344 | 343 | 130 | 108 | 51 | 52 | 13 | 39 | 16 | 22 | 293 | 583 | 0 | 1 | 55 | 0 | 0 | 
| app_proof | prover | 1 | 533,761,420 | 487 | 135 | 0 | 2 | 309 | 179 | 178 | 77 | 52 | 0 | 41 | 13 | 27 | 14 | 13 | 135 | 309 | 0 | 1 | 52 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 43 | 1,204 | 43 | 175 | 0 | 3 | 55 | 1,168,000 | 34.81 | 
| app_proof | 1 | 16 | 677 | 16 | 40 | 0 | 1 | 132 | 811,971 | 34.69 | 

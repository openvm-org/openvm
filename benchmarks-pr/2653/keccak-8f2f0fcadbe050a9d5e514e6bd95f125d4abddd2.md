...
|:---|---:|---:|---:|
| Total |  18.74 |  5.29 |  5.29 |
| app_proof |  15.70 |  3.02 |  3.02 |
| leaf |  2.19 |  1.42 |  1.42 |
...
| `total_proof_time_ms ` |  2,610.67 |  15,664 |  2,984 |  2,519 |
| `execute_metered_time_ms` |  37 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  33.29 | -          |  33.29 |  33.29 |
| `execute_preflight_insns` |  205,869.67 |  1,235,218 |  207,000 |  200,218 |
| `execute_preflight_time_ms` |  181.83 |  1,091 |  279 |  15 |
| `execute_preflight_insn_mi/s` |  19.86 | -          |  19.97 |  19.67 |
| `trace_gen_time_ms   ` |  386.83 |  2,321 |  541 |  349 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,978.33 |  11,870 |  2,256 |  1,920 |
| `prover.main_trace_commit_time_ms` |  688.67 |  4,132 |  853 |  655 |
| `prover.rap_constraints_time_ms` |  1,108.33 |  6,650 |  1,222 |  1,082 |
| `prover.openings_time_ms` |  180.33 |  1,082 |  184 |  176 |
| `prover.rap_constraints.logup_gkr_time_ms` |  275.67 |  1,654 |  387 |  253 |
| `prover.rap_constraints.round0_time_ms` |  519.83 |  3,119 |  523 |  517 |
| `prover.rap_constraints.mle_rounds_time_ms` |  311.50 |  1,869 |  316 |  310 |
| `prover.openings.stacked_reduction_time_ms` |  138 |  828 |  140 |  133 |
| `prover.openings.stacked_reduction.round0_time_ms` |  83.33 |  500 |  85 |  78 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  54.67 |  328 |  56 |  53 |
| `prover.openings.whir_time_ms` |  42 |  252 |  44 |  40 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,092.50 |  2,185 |  1,419 |  766 |
| `execute_preflight_time_ms` |  4.50 |  9 |  5 |  4 |
| `trace_gen_time_ms   ` |  137 |  274 |  184 |  90 |
| `generate_blob_total_time_ms` |  25.50 |  51 |  34 |  17 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  955.50 |  1,911 |  1,235 |  676 |
| `prover.main_trace_commit_time_ms` |  544 |  1,088 |  715 |  373 |
| `prover.rap_constraints_time_ms` |  306.50 |  613 |  394 |  219 |
| `prover.openings_time_ms` |  103.50 |  207 |  124 |  83 |
| `prover.rap_constraints.logup_gkr_time_ms` |  67 |  134 |  83 |  51 |
| `prover.rap_constraints.round0_time_ms` |  147 |  294 |  193 |  101 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/8f2f0fcadbe050a9d5e514e6bd95f125d4abddd2/keccak-8f2f0fcadbe050a9d5e514e6bd95f125d4abddd2.memory.svg)
...
| app_proof |  |  |  |  |  | 2,524 |  |  | 37 | 1,235,218 | 33.29 | 0 | 15,709 |  | 
| internal_for_leaf |  |  |  | 519 |  |  |  |  |  |  |  |  |  | 519 | 
...
| app_proof | VmAirWrapper<Rv32LoadStoreAdapterAir, LoadStoreCoreAir<4> | 1 | 346 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 39 | 519 | 39 | 13 | 4 | 2 | 2 | 2 | 
| internal_recursive.0 | 1 | 12 | 182 | 12 | 2 | 1 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 9 | 149 | 8 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 184 | 1,419 | 184 | 65 | 34 | 5 | 7 | 7 | 
| leaf | 1 | 90 | 766 | 89 | 32 | 17 | 4 | 7 | 7 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 109,497,984 | 479 | 245 | 0 | 14 | 172 | 45 | 45 | 93 | 33 | 0 | 60 | 22 | 38 | 7 | 30 | 245 | 172 | 0 | 2 | 32 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 25,962,119 | 170 | 51 | 0 | 3 | 74 | 23 | 23 | 29 | 22 | 0 | 43 | 19 | 24 | 1 | 22 | 51 | 74 | 0 | 2 | 21 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 17,507,975 | 140 | 33 | 0 | 3 | 63 | 22 | 21 | 24 | 16 | 0 | 42 | 19 | 22 | 1 | 21 | 34 | 63 | 0 | 2 | 16 | 0 | 0 | 
| leaf | 0 | prover | 583,523,386 | 1,235 | 715 | 0 | 47 | 394 | 193 | 192 | 117 | 83 | 0 | 124 | 39 | 85 | 40 | 44 | 715 | 394 | 0 | 6 | 81 | 0 | 0 | 
| leaf | 1 | prover | 300,618,208 | 676 | 372 | 0 | 24 | 219 | 101 | 100 | 66 | 51 | 0 | 83 | 32 | 51 | 19 | 31 | 373 | 219 | 0 | 5 | 50 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,205,061,845 | 2,256 | 852 | 0 | 248 | 1,222 | 517 | 517 | 316 | 387 | 133 | 181 | 40 | 140 | 84 | 56 | 853 | 1,222 | 0 | 3 | 253 | 0 | 0 | 
| app_proof | prover | 1 | 1,205,053,652 | 1,922 | 655 | 0 | 51 | 1,082 | 517 | 517 | 310 | 253 | 0 | 184 | 44 | 139 | 85 | 54 | 655 | 1,082 | 0 | 4 | 252 | 0 | 0 | 
| app_proof | prover | 2 | 1,205,053,652 | 1,920 | 656 | 0 | 51 | 1,087 | 523 | 522 | 310 | 253 | 0 | 176 | 43 | 133 | 78 | 55 | 656 | 1,087 | 0 | 3 | 252 | 0 | 0 | 
| app_proof | prover | 3 | 1,205,053,652 | 1,920 | 655 | 0 | 51 | 1,086 | 521 | 520 | 311 | 253 | 0 | 177 | 40 | 137 | 84 | 53 | 655 | 1,086 | 0 | 3 | 252 | 0 | 0 | 
| app_proof | prover | 4 | 1,205,053,652 | 1,925 | 656 | 0 | 51 | 1,087 | 521 | 520 | 311 | 254 | 0 | 182 | 43 | 139 | 85 | 54 | 656 | 1,087 | 0 | 3 | 252 | 0 | 0 | 
| app_proof | prover | 5 | 1,205,062,652 | 1,927 | 657 | 0 | 52 | 1,086 | 520 | 519 | 311 | 254 | 0 | 182 | 42 | 140 | 84 | 56 | 657 | 1,086 | 0 | 3 | 253 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 541 | 2,984 | 541 | 170 | 0 | 189 | 15 | 207,000 | 19.67 | 
| app_proof | 1 | 349 | 2,592 | 349 | 41 | 0 | 1 | 279 | 207,000 | 19.76 | 
| app_proof | 2 | 351 | 2,521 | 351 | 41 | 0 | 1 | 208 | 207,000 | 19.97 | 
| app_proof | 3 | 350 | 2,519 | 350 | 41 | 0 | 1 | 207 | 207,000 | 19.89 | 
| app_proof | 4 | 351 | 2,524 | 351 | 41 | 0 | 2 | 206 | 207,000 | 19.95 | 
| app_proof | 5 | 379 | 2,524 | 379 | 41 | 0 | 31 | 176 | 200,218 | 19.89 | 

...
|:---|---:|---:|---:|
| Total |  18.89 |  5.34 |  5.34 |
| app_proof |  15.82 |  3.04 |  3.04 |
| leaf |  2.22 |  1.44 |  1.44 |
...
| `total_proof_time_ms ` |  2,630.67 |  15,784 |  3,002 |  2,536 |
| `execute_metered_time_ms` |  36 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  33.57 | -          |  33.57 |  33.57 |
| `execute_preflight_insns` |  205,869.67 |  1,235,218 |  207,000 |  200,218 |
| `execute_preflight_time_ms` |  182.67 |  1,096 |  280 |  15 |
| `execute_preflight_insn_mi/s` |  19.62 | -          |  19.82 |  19.36 |
| `trace_gen_time_ms   ` |  388.50 |  2,331 |  546 |  351 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,996 |  11,976 |  2,271 |  1,935 |
| `prover.main_trace_commit_time_ms` |  694.17 |  4,165 |  856 |  661 |
| `prover.rap_constraints_time_ms` |  1,118 |  6,708 |  1,230 |  1,093 |
| `prover.openings_time_ms` |  183.17 |  1,099 |  189 |  178 |
| `prover.rap_constraints.logup_gkr_time_ms` |  276 |  1,656 |  387 |  253 |
| `prover.rap_constraints.round0_time_ms` |  524.33 |  3,146 |  527 |  522 |
| `prover.rap_constraints.mle_rounds_time_ms` |  316.33 |  1,898 |  320 |  315 |
| `prover.openings.stacked_reduction_time_ms` |  141 |  846 |  143 |  139 |
...
| `prover.openings.whir_time_ms` |  41.50 |  249 |  45 |  39 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,109.50 |  2,219 |  1,443 |  776 |
| `execute_preflight_time_ms` |  4.50 |  9 |  5 |  4 |
| `trace_gen_time_ms   ` |  140.50 |  281 |  190 |  91 |
| `generate_blob_total_time_ms` |  25.50 |  51 |  34 |  17 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  968 |  1,936 |  1,252 |  684 |
| `prover.main_trace_commit_time_ms` |  550 |  1,100 |  723 |  377 |
...
| `prover.rap_constraints.round0_time_ms` |  150 |  300 |  196 |  104 |
...
| `prover.openings.whir_time_ms` |  38 |  76 |  43 |  33 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/9fae58d796a4663e68c675efcd207f71258bed21/keccak-9fae58d796a4663e68c675efcd207f71258bed21.memory.svg)
...
| app_proof |  |  |  |  |  | 2,553 |  |  | 36 | 1,235,218 | 33.57 | 0 | 15,828 |  | 
...
| leaf | 0 | 190 | 1,443 | 190 | 65 | 34 | 5 | 7 | 7 | 
| leaf | 1 | 91 | 776 | 91 | 32 | 17 | 4 | 7 | 7 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 109,497,984 | 481 | 247 | 0 | 14 | 174 | 45 | 45 | 94 | 33 | 0 | 59 | 20 | 38 | 8 | 30 | 247 | 174 | 0 | 2 | 32 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 25,962,119 | 172 | 51 | 0 | 3 | 75 | 23 | 23 | 29 | 22 | 0 | 45 | 21 | 24 | 1 | 22 | 51 | 75 | 0 | 2 | 21 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 17,507,975 | 141 | 34 | 0 | 4 | 63 | 21 | 21 | 24 | 17 | 0 | 42 | 20 | 22 | 1 | 21 | 35 | 63 | 0 | 2 | 17 | 0 | 0 | 
| leaf | 0 | prover | 583,523,386 | 1,252 | 722 | 0 | 47 | 400 | 196 | 195 | 122 | 81 | 0 | 129 | 43 | 85 | 40 | 44 | 723 | 400 | 0 | 6 | 81 | 0 | 0 | 
| leaf | 1 | prover | 300,618,208 | 684 | 376 | 0 | 24 | 222 | 104 | 103 | 66 | 51 | 0 | 85 | 33 | 52 | 19 | 32 | 377 | 222 | 0 | 6 | 50 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,205,061,845 | 2,271 | 855 | 0 | 246 | 1,230 | 522 | 521 | 320 | 387 | 132 | 185 | 41 | 143 | 85 | 57 | 856 | 1,230 | 0 | 4 | 253 | 0 | 0 | 
| app_proof | prover | 1 | 1,205,053,652 | 1,938 | 661 | 0 | 51 | 1,093 | 524 | 524 | 315 | 253 | 0 | 183 | 42 | 140 | 85 | 54 | 661 | 1,093 | 0 | 3 | 252 | 0 | 0 | 
| app_proof | prover | 2 | 1,205,053,652 | 1,937 | 661 | 0 | 51 | 1,094 | 523 | 523 | 316 | 253 | 0 | 181 | 40 | 140 | 85 | 54 | 661 | 1,094 | 0 | 3 | 252 | 0 | 0 | 
| app_proof | prover | 3 | 1,205,053,652 | 1,935 | 662 | 0 | 51 | 1,094 | 524 | 523 | 315 | 254 | 0 | 178 | 39 | 139 | 84 | 54 | 662 | 1,094 | 0 | 3 | 252 | 0 | 0 | 
| app_proof | prover | 4 | 1,205,053,652 | 1,943 | 662 | 0 | 51 | 1,096 | 526 | 526 | 315 | 254 | 0 | 183 | 42 | 141 | 85 | 55 | 663 | 1,096 | 0 | 4 | 253 | 0 | 0 | 
| app_proof | prover | 5 | 1,205,062,652 | 1,952 | 662 | 0 | 52 | 1,101 | 527 | 527 | 317 | 255 | 0 | 189 | 45 | 143 | 87 | 56 | 662 | 1,100 | 0 | 3 | 254 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 546 | 3,002 | 546 | 169 | 0 | 193 | 15 | 207,000 | 19.36 | 
| app_proof | 1 | 351 | 2,611 | 351 | 41 | 0 | 1 | 280 | 207,000 | 19.82 | 
| app_proof | 2 | 351 | 2,537 | 351 | 41 | 0 | 1 | 207 | 207,000 | 19.63 | 
| app_proof | 3 | 351 | 2,536 | 351 | 41 | 0 | 1 | 208 | 207,000 | 19.74 | 
| app_proof | 4 | 351 | 2,545 | 351 | 41 | 0 | 2 | 209 | 207,000 | 19.50 | 
| app_proof | 5 | 381 | 2,553 | 381 | 41 | 0 | 31 | 177 | 200,218 | 19.65 | 

...
| `total_proof_time_ms ` |  549 |  3,843 |  671 |  525 |
| `execute_metered_time_ms` |  72 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  165.83 | -          |  165.83 |  165.83 |
| `execute_preflight_insns` |  1,714,323.57 |  12,000,265 |  1,747,000 |  1,518,265 |
| `execute_preflight_time_ms` |  57.29 |  401 |  64 |  49 |
| `execute_preflight_insn_mi/s` |  39.24 | -          |  40.17 |  38.16 |
| `trace_gen_time_ms   ` |  158.57 |  1,110 |  166 |  154 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  272.71 |  1,909 |  281 |  268 |
| `prover.main_trace_commit_time_ms` |  59.29 |  415 |  60 |  59 |
| `prover.rap_constraints_time_ms` |  174.86 |  1,224 |  180 |  173 |
| `prover.openings_time_ms` |  37.57 |  263 |  41 |  35 |
| `prover.rap_constraints.logup_gkr_time_ms` |  126.71 |  887 |  128 |  126 |
| `prover.rap_constraints.round0_time_ms` |  28.43 |  199 |  32 |  27 |
| `prover.rap_constraints.mle_rounds_time_ms` |  18.86 |  132 |  19 |  18 |
| `prover.openings.stacked_reduction_time_ms` |  16.86 |  118 |  20 |  16 |
...
| `prover.openings.whir_time_ms` |  20.14 |  141 |  22 |  19 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  474 |  948 |  549 |  399 |
| `execute_preflight_time_ms` |  1 |  2 |  1 |  1 |
| `trace_gen_time_ms   ` |  47.50 |  95 |  62 |  33 |
| `generate_blob_total_time_ms` |  3.50 |  7 |  4 |  3 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  426 |  852 |  486 |  366 |
| `prover.main_trace_commit_time_ms` |  198 |  396 |  236 |  160 |
| `prover.rap_constraints_time_ms` |  161.50 |  323 |  179 |  144 |
| `prover.openings_time_ms` |  65.50 |  131 |  71 |  60 |
| `prover.rap_constraints.logup_gkr_time_ms` |  41.50 |  83 |  48 |  35 |
| `prover.rap_constraints.round0_time_ms` |  70.50 |  141 |  77 |  64 |
...
| `prover.openings.whir_time_ms` |  29.50 |  59 |  32 |  27 |

| internal_for_leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  383 |  383 |  383 |  383 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/78166c6c31b7f8da316bfaae010b5f22ae9cdf94/fibonacci-78166c6c31b7f8da316bfaae010b5f22ae9cdf94.memory.svg)
...
| app_proof |  |  |  |  |  | 532 |  |  | 72 | 12,000,265 | 165.83 | 0 | 3,923 |  | 
| internal_for_leaf |  |  |  | 383 |  |  |  |  |  |  |  |  |  | 384 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 26 | 383 | 25 | 9 | 2 | 2 | 1 | 1 | 
| internal_recursive.0 | 1 | 11 | 179 | 10 | 1 | 0 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 8 | 148 | 8 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 62 | 549 | 61 | 23 | 4 | 1 | 1 | 1 | 
| leaf | 1 | 33 | 399 | 33 | 17 | 3 | 1 | 1 | 1 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 75,533,952 | 357 | 160 | 0 | 9 | 144 | 38 | 38 | 73 | 32 | 0 | 51 | 19 | 32 | 5 | 27 | 160 | 144 | 0 | 2 | 32 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 23,651,975 | 168 | 48 | 0 | 3 | 70 | 24 | 23 | 28 | 18 | 0 | 48 | 24 | 23 | 1 | 21 | 49 | 70 | 0 | 2 | 17 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 17,507,975 | 139 |
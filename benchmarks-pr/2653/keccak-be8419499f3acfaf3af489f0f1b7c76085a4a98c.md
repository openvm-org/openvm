...
|:---|---:|---:|---:|
| Total |  18.67 |  5.26 |  5.26 |
| app_proof |  15.61 |  2.99 |  2.99 |
| leaf |  2.21 |  1.42 |  1.42 |
...
| `total_proof_time_ms ` |  2,595.50 |  15,573 |  2,958 |  2,505 |
| `execute_metered_time_ms` |  36 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  33.44 | -          |  33.44 |  33.44 |
| `execute_preflight_insns` |  205,869.67 |  1,235,218 |  207,000 |  200,218 |
| `execute_preflight_time_ms` |  176.83 |  1,061 |  261 |  15 |
| `execute_preflight_insn_mi/s` |  19.44 | -          |  19.56 |  19.07 |
| `trace_gen_time_ms   ` |  386.83 |  2,321 |  539 |  350 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,967.83 |  11,807 |  2,233 |  1,906 |
| `prover.main_trace_commit_time_ms` |  684.83 |  4,109 |  839 |  652 |
| `prover.rap_constraints_time_ms` |  1,103.17 |  6,619 |  1,212 |  1,076 |
| `prover.openings_time_ms` |  179 |  1,074 |  183 |  175 |
| `prover.rap_constraints.logup_gkr_time_ms` |  274 |  1,644 |  379 |  252 |
| `prover.rap_constraints.round0_time_ms` |  516.33 |  3,098 |  519 |  514 |
| `prover.rap_constraints.mle_rounds_time_ms` |  311.83 |  1,871 |  317 |  307 |
| `prover.openings.stacked_reduction_time_ms` |  137.17 |  823 |  140 |  133 |
...
| `prover.openings.whir_time_ms` |  41.33 |  248 |  44 |  38 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,105 |  2,210 |  1,419 |  791 |
| `execute_preflight_time_ms` |  4.50 |  9 |  5 |  4 |
| `trace_gen_time_ms   ` |  146 |  292 |  185 |  107 |
| `generate_blob_total_time_ms` |  25.50 |  51 |  34 |  17 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  958.50 |  1,917 |  1,233 |  684 |
| `prover.main_trace_commit_time_ms` |  542 |  1,084 |  713 |  371 |
| `prover.rap_constraints_time_ms` |  305.50 |  611 |  393 |  218 |
| `prover.openings_time_ms` |  109.50 |  219 |  126 |  93 |
| `prover.rap_constraints.logup_gkr_time_ms` |  65 |  130 |  80 |  50 |
| `prover.rap_constraints.round0_time_ms` |  146 |  292 |  190 |  102 |
| `prover.rap_constraints.mle_rounds_time_ms` |  93.50 |  187 |  122 |  65 |
...
| `prover.openings.whir_time_ms` |  41.50 |  83 |  42 |  41 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/be8419499f3acfaf3af489f0f1b7c76085a4a98c/keccak-be8419499f3acfaf3af489f0f1b7c76085a4a98c.memory.svg)
...
| app_proof |  |  |  |  |  | 2,522 |  |  | 36 | 1,235,218 | 33.44 | 0 | 15,617 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 40 | 516 | 40 | 13 | 4 | 2 | 2 | 2 | 
| internal_recursive.0 | 1 | 13 | 180 | 13 | 2 | 1 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 8 | 152 | 8 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 185 | 1,419 | 185 | 64 | 34 | 5 | 7 | 7 | 
| leaf | 1 | 107 | 791 | 106 | 50 | 17 | 4 | 7 | 7 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 109,497,984 | 476 | 244 | 0 | 14 | 172 | 45 | 44 | 92 | 34 | 0 | 58 | 20 | 38 | 7 | 30 | 245 | 172 | 0 | 3 | 32 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 25,962,119 | 167 | 50 | 0 | 3 | 74 | 23 | 22 | 28 | 22 | 0 | 41 | 18 | 23 | 1 | 21 | 50 | 74 | 0 | 2 | 21 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 17,507,975 | 144 | 34 | 0 | 3 | 62 | 21 | 20 | 24 | 17 | 0 | 46 | 24 | 22 | 1 | 20 | 34 | 62 | 0 | 2 | 16 | 0 | 0 | 
| leaf | 0 | prover | 583,523,386 | 1,233 | 712 | 0 | 47 | 393 | 190 | 189 | 122 | 80 | 0 | 126 | 41 | 85 | 40 | 45 | 713 | 393 | 0 | 6 | 80 | 0 | 0 | 
| leaf | 1 | prover | 300,618,208 | 684 | 370 | 0 | 24 | 218 | 102 | 102 | 65 | 50 | 0 | 93 | 42 | 51 | 19 | 32 | 371 | 218 | 0 | 6 | 49 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,205,061,845 | 2,233 | 838 | 0 | 238 | 1,212 | 515 | 515 | 317 | 379 | 125 | 182 | 41 | 140 | 85 | 55 | 839 | 1,212 | 0 | 3 | 253 | 0 | 0 | 
| app_proof | prover | 1 | 1,205,053,652 | 1,906 | 652 | 0 | 51 | 1,077 | 514 | 514 | 310 | 252 | 0 | 175 | 38 | 136 | 83 | 53 | 652 | 1,077 | 0 | 3 | 251 | 0 | 0 | 
| app_proof | prover | 2 | 1,205,053,652 | 1,916 | 655 | 0 | 51 | 1,085 | 519 | 519 | 312 | 253 | 0 | 176 | 42 | 133 | 80 | 52 | 655 | 1,085 | 0 | 4 | 252 | 0 | 0 | 
| app_proof | prover | 3 | 1,205,053,652 | 1,909 | 654 | 0 | 51 | 1,076 | 515 | 515 | 307 | 253 | 0 | 178 | 40 | 138 | 84 | 53 | 654 | 1,076 | 0 | 3 | 252 | 0 | 0 | 
| app_proof | prover | 4 | 1,205,053,652 | 1,918 | 654 | 0 | 51 | 1,083 | 517 | 516 | 312 | 253 | 0 | 180 | 43 | 137 | 84 | 52 | 654 | 1,083 | 0 | 3 | 252 | 0 | 0 | 
| app_proof | prover | 5 | 1,205,062,652 | 1,925 | 655 | 0 | 52 | 1,086 | 518 | 518 | 313 | 254 | 0 | 183 | 44 | 139 | 84 | 54 | 655 | 1,086 | 0 | 3 | 252 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 539 | 2,958 | 539 | 169 | 0 | 188 | 15 | 207,000 | 19.07 | 
| app_proof | 1 | 350 | 2,560 | 350 | 41 | 0 | 1 | 261 | 207,000 | 19.50 | 
| app_proof | 2 | 351 | 2,511 | 351 | 41 | 0 | 2 | 202 | 207,000 | 19.48 | 
| app_proof | 3 | 352 | 2,505 | 352 | 41 | 0 | 3 | 201 | 207,000 | 19.50 | 
| app_proof | 4 | 351 | 2,517 | 351 | 41 | 0 | 2 | 205 | 207,000 | 19.52 | 
| app_proof | 5 | 378 | 2,522 | 378 | 41 | 0 | 29 | 177 | 200,218 | 19.56 | 

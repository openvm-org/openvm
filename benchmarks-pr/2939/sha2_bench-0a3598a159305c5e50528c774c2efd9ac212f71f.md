...
|:---|---:|---:|---:|
| Total |  9.79 |  6.83 |  6.83 |
| app_proof |  8.14 |  5.18 |  5.18 |
| leaf |  0.99 |  0.99 |  0.99 |
...
| `total_proof_time_ms ` |  4,020.50 |  8,041 |  5,081 |  2,960 |
...
| `execute_preflight_time_ms` |  237 |  474 |  267 |  207 |
| `execute_preflight_insn_mi/s` |  39.43 | -          |  41.41 |  37.45 |
| `trace_gen_time_ms   ` |  121.50 |  243 |  171 |  72 |
| `set_initial_memory_time_ms` |  88 |  176 |  135 |  41 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  3,571.50 |  7,143 |  4,565 |  2,578 |
| `prover.main_trace_commit_time_ms` |  951.50 |  1,903 |  1,319 |  584 |
| `prover.rap_constraints_time_ms` |  1,919 |  3,838 |  2,366 |  1,472 |
| `prover.openings_time_ms` |  700 |  1,400 |  879 |  521 |
| `prover.rap_constraints.logup_gkr_time_ms` |  541.50 |  1,083 |  583 |  500 |
| `prover.rap_constraints.round0_time_ms` |  1,004 |  2,008 |  1,302 |  706 |
| `prover.rap_constraints.mle_rounds_time_ms` |  372 |  744 |  480 |  264 |
| `prover.openings.stacked_reduction_time_ms` |  160.50 |  321 |  206 |  115 |
| `prover.openings.stacked_reduction.round0_time_ms` |  100 |  200 |  130 |  70 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  60.50 |  121 |  76 |  45 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/0a3598a159305c5e50528c774c2efd9ac212f71f/sha2_bench-0a3598a159305c5e50528c774c2efd9ac212f71f.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 67 |  |  |  | 339 |  |  |  |  |  |  | 
| app_proof |  |  |  | 2,960 |  | 98 | 11,167,961 | 112.85 | 0 | 8,145 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 20 | 341 | 20 | 5 | 1 | 2 | 2 | 2 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 321 | 117 | 0 | 0 | 106 | 34 | 33 | 51 | 20 | 0 | 97 | 84 | 13 | 3 | 9 | 117 | 117 | 106 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 163 | 45 | 0 | 0 | 64 | 23 | 22 | 27 | 13 | 0 | 53 | 44 | 8 | 1 | 6 | 45 | 45 | 64 | 0 | 3 | 12 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 138 | 31 | 0 | 0 | 61 | 23 | 22 | 24 | 13 | 0 | 44 | 37 | 7 | 1 | 5 | 32 | 31 | 61 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 237,929,016 | 881 | 370 | 0 | 0 | 224 | 106 | 105 | 66 | 52 | 0 | 286 | 249 | 36 | 19 | 16 | 371 | 370 | 224 | 0 | 9 | 49 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,286,242,554 | 4,565 | 1,319 | 0 | 0 | 2,366 | 1,302 | 1,302 | 480 | 583 | 0 | 879 | 672 | 206 | 130 | 76 | 1,319 | 1,319 | 2,366 | 0 | 4 | 582 | 0 | 0 | 
| app_proof | prover | 1 | 750,289,144 | 2,578 | 584 | 0 | 0 | 1,472 | 706 | 705 | 264 | 500 | 0 | 521 | 405 | 115 | 70 | 45 | 584 | 584 | 1,471 | 0 | 5 | 500 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 135 | 1 | 171 | 5,081 | 171 | 135 | 13,311,936,132 | 2,137,449,780 | 15,449,385,912 | 2,097,152 | 0 | 3 | 207 | 7,124,000 | 37.45 | 
| app_proof | 1 | 41 | 1 | 72 | 2,960 | 72 | 41 | 7,588,526,580 | 1,502,398,413 | 9,090,924,993 | 2,097,152 | 0 | 2 | 267 | 4,043,961 | 41.41 | 

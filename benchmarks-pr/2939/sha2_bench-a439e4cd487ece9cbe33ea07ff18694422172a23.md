...
|:---|---:|---:|---:|
| Total |  4.95 |  3.32 |  3.32 |
| app_proof |  3.99 |  2.36 |  2.36 |
| leaf |  0.52 |  0.52 |  0.52 |
...
| `total_proof_time_ms ` |  1,967 |  3,934 |  2,307 |  1,627 |
| `compile_metered_time_ms` |  6 |  6 |  6 |  6 |
| `execute_metered_time_ms` |  56 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  196.95 | -          |  196.95 |  196.95 |
| `execute_preflight_insns` |  5,583,980.50 |  11,167,961 |  7,124,000 |  4,043,961 |
| `execute_preflight_time_ms` |  361 |  722 |  506 |  216 |
| `execute_preflight_insn_mi/s` |  34.16 | -          |  34.22 |  34.10 |
| `trace_gen_time_ms   ` |  74 |  148 |  101 |  47 |
| `set_initial_memory_time_ms` |  0 |  0 |  0 |  0 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,530.50 |  3,061 |  1,989 |  1,072 |
| `prover.main_trace_commit_time_ms` |  384 |  768 |  550 |  218 |
| `prover.rap_constraints_time_ms` |  883.50 |  1,767 |  1,110 |  657 |
| `prover.openings_time_ms` |  262 |  524 |  328 |  196 |
| `prover.rap_constraints.logup_gkr_time_ms` |  203 |  406 |  222 |  184 |
| `prover.rap_constraints.round0_time_ms` |  503.50 |  1,007 |  660 |  347 |
| `prover.rap_constraints.mle_rounds_time_ms` |  176.50 |  353 |  227 |  126 |
| `prover.openings.stacked_reduction_time_ms` |  70.50 |  141 |  89 |  52 |
| `prover.openings.stacked_reduction.round0_time_ms` |  42.50 |  85 |  54 |  31 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/a439e4cd487ece9cbe33ea07ff18694422172a23/sha2_bench-a439e4cd487ece9cbe33ea07ff18694422172a23.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 56 |  |  |  | 291 |  |  |  |  |  |  | 
| app_proof |  |  |  | 1,627 |  | 56 | 11,167,961 | 196.95 | 0 | 3,999 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,233,945,850 | 1,989 | 550 | 0 | 0 | 1,110 | 660 | 660 | 227 | 222 | 0 | 328 | 239 | 89 | 54 | 34 | 550 | 550 | 1,110 | 0 | 1 | 221 | 0 | 0 | 
| app_proof | prover | 1 | 698,978,064 | 1,072 | 218 | 0 | 0 | 657 | 347 | 347 | 126 | 184 | 0 | 196 | 144 | 52 | 31 | 21 | 218 | 218 | 657 | 0 | 1 | 182 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 0 | 2 | 101 | 2,307 | 101 | 0 | 12,684,755,076 | 2,129,046,324 | 14,813,801,400 | 2,097,152 | 0 | 4 | 216 | 7,124,000 | 34.10 | 
| app_proof | 1 | 0 | 1 | 47 | 1,627 | 47 | 0 | 7,231,569,048 | 1,162,618,920 | 8,394,187,968 | 2,097,152 | 0 | 2 | 506 | 4,043,961 | 34.22 | 

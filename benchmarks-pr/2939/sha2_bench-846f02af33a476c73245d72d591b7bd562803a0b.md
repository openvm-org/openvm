...
| `total_proof_time_ms ` |  4,067 |  8,134 |  5,139 |  2,995 |
| `compile_metered_time_ms` |  4 |  4 |  4 |  4 |
| `execute_metered_time_ms` |  98 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  113.77 | -          |  113.77 |  113.77 |
| `execute_preflight_insns` |  5,583,980.50 |  11,167,961 |  7,124,000 |  4,043,961 |
| `execute_preflight_time_ms` |  237 |  474 |  266 |  208 |
| `execute_preflight_insn_mi/s` |  39.32 | -          |  41.27 |  37.37 |
| `trace_gen_time_ms   ` |  121.50 |  243 |  171 |  72 |
| `set_initial_memory_time_ms` |  88 |  176 |  135 |  41 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  3,618.50 |  7,237 |  4,623 |  2,614 |
| `prover.main_trace_commit_time_ms` |  958.50 |  1,917 |  1,328 |  589 |
| `prover.rap_constraints_time_ms` |  1,952.50 |  3,905 |  2,406 |  1,499 |
| `prover.openings_time_ms` |  706 |  1,412 |  887 |  525 |
| `prover.rap_constraints.logup_gkr_time_ms` |  548 |  1,096 |  591 |  505 |
| `prover.rap_constraints.round0_time_ms` |  1,026 |  2,052 |  1,328 |  724 |
| `prover.rap_constraints.mle_rounds_time_ms` |  377.50 |  755 |  486 |  269 |
...
| `prover.openings.whir_time_ms` |  541 |  1,082 |  675 |  407 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/846f02af33a476c73245d72d591b7bd562803a0b/sha2_bench-846f02af33a476c73245d72d591b7bd562803a0b.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 70 |  |  |  | 338 |  |  |  |  |  |  | 
| app_proof |  |  |  | 2,995 |  | 98 | 11,167,961 | 113.77 | 0 | 8,238 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 324 | 117 | 0 | 0 | 107 | 35 | 34 | 51 | 20 | 0 | 99 | 85 | 13 | 3 | 9 | 117 | 117 | 107 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 168 | 47 | 0 | 0 | 67 | 25 | 24 | 28 | 14 | 0 | 52 | 44 | 8 | 1 | 6 | 47 | 47 | 67 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 143 | 31 | 0 | 0 | 63 | 23 | 23 | 24 | 14 | 0 | 48 | 41 | 7 | 1 | 5 | 32 | 31 | 63 | 0 | 3 | 13 | 0 | 0 | 
| leaf | 0 | prover | 237,929,016 | 886 | 371 | 0 | 0 | 227 | 109 | 108 | 67 | 50 | 0 | 287 | 250 | 36 | 19 | 16 | 371 | 371 | 227 | 0 | 9 | 49 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,286,242,554 | 4,623 | 1,328 | 0 | 0 | 2,406 | 1,328 | 1,328 | 486 | 591 | 0 | 887 | 675 | 211 | 132 | 79 | 1,328 | 1,328 | 2,406 | 0 | 5 | 589 | 0 | 0 | 
| app_proof | prover | 1 | 750,289,144 | 2,614 | 588 | 0 | 0 | 1,499 | 724 | 723 | 269 | 505 | 0 | 525 | 407 | 117 | 71 | 46 | 589 | 588 | 1,499 | 0 | 5 | 504 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 135 | 1 | 171 | 5,139 | 171 | 135 | 13,311,936,132 | 2,137,449,780 | 15,449,385,912 | 2,097,152 | 0 | 3 | 208 | 7,124,000 | 37.37 | 
| app_proof | 1 | 41 | 1 | 72 | 2,995 | 72 | 41 | 7,588,526,580 | 1,502,398,413 | 9,090,924,993 | 2,097,152 | 0 | 2 | 266 | 4,043,961 | 41.27 | 

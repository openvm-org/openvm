...
| `total_proof_time_ms ` |  4,061.50 |  8,123 |  5,134 |  2,989 |
...
| `execute_preflight_time_ms` |  239.50 |  479 |  268 |  211 |
| `execute_preflight_insn_mi/s` |  38.84 | -          |  40.80 |  36.89 |
| `trace_gen_time_ms   ` |  121.50 |  243 |  171 |  72 |
| `set_initial_memory_time_ms` |  88 |  176 |  135 |  41 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  3,610.50 |  7,221 |  4,615 |  2,606 |
| `prover.main_trace_commit_time_ms` |  953.50 |  1,907 |  1,321 |  586 |
| `prover.rap_constraints_time_ms` |  1,950.50 |  3,901 |  2,408 |  1,493 |
| `prover.openings_time_ms` |  705 |  1,410 |  885 |  525 |
| `prover.rap_constraints.logup_gkr_time_ms` |  547.50 |  1,095 |  587 |  508 |
| `prover.rap_constraints.round0_time_ms` |  1,027 |  2,054 |  1,336 |  718 |
...
| `prover.openings.whir_time_ms` |  541 |  1,082 |  674 |  408 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/ba2322e54aa939b1dd68326fa36df973ca49f4c7/sha2_bench-ba2322e54aa939b1dd68326fa36df973ca49f4c7.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 69 |  |  |  | 338 |  |  |  |  |  |  | 
| app_proof |  |  |  | 2,989 |  | 98 | 11,167,961 | 113.53 | 0 | 8,227 |  | 
...
| internal_recursive.0 | 1 | 13 | 182 | 11 | 1 | 0 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 10 | 150 | 10 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 107 | 995 | 107 | 34 | 17 | 2 | 7 | 7 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 329 | 117 | 0 | 0 | 106 | 34 | 33 | 52 | 20 | 0 | 104 | 90 | 13 | 3 | 9 | 117 | 117 | 106 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 168 | 46 | 0 | 0 | 66 | 25 | 24 | 28 | 13 | 0 | 54 | 45 | 8 | 1 | 6 | 47 | 46 | 66 | 0 | 2 | 12 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 140 | 32 | 0 | 0 | 62 | 23 | 22 | 24 | 14 | 0 | 44 | 37 | 7 | 1 | 5 | 32 | 32 | 62 | 0 | 2 | 13 | 0 | 0 | 
| leaf | 0 | prover | 237,929,016 | 888 | 371 | 0 | 0 | 228 | 108 | 107 | 67 | 51 | 0 | 288 | 250 | 37 | 19 | 17 | 371 | 371 | 228 | 0 | 9 | 49 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,286,242,554 | 4,615 | 1,320 | 0 | 0 | 2,408 | 1,336 | 1,336 | 483 | 587 | 1 | 885 | 674 | 211 | 132 | 79 | 1,321 | 1,320 | 2,408 | 0 | 4 | 586 | 0 | 0 | 
| app_proof | prover | 1 | 750,289,144 | 2,606 | 586 | 0 | 0 | 1,493 | 718 | 718 | 267 | 508 | 0 | 525 | 408 | 116 | 70 | 45 | 586 | 586 | 1,493 | 0 | 5 | 507 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 135 | 1 | 171 | 5,134 | 171 | 135 | 13,311,936,132 | 2,137,449,780 | 15,449,385,912 | 2,097,152 | 0 | 3 | 211 | 7,124,000 | 36.89 | 
| app_proof | 1 | 41 | 1 | 72 | 2,989 | 72 | 41 | 7,588,526,580 | 1,502,398,413 | 9,090,924,993 | 2,097,152 | 0 | 2 | 268 | 4,043,961 | 40.80 | 

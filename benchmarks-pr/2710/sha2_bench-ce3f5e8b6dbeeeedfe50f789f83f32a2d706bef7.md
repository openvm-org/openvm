...
| `total_proof_time_ms ` |  1,493.50 |  8,961 |  1,703 |  1,426 |
...
| `execute_preflight_time_ms` |  125 |  750 |  158 |  87 |
| `execute_preflight_insn_mi/s` |  40.17 | -          |  40.75 |  38.35 |
| `trace_gen_time_ms   ` |  118.50 |  711 |  161 |  87 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,186.17 |  7,117 |  1,282 |  1,150 |
| `prover.main_trace_commit_time_ms` |  284.67 |  1,708 |  285 |  284 |
| `prover.rap_constraints_time_ms` |  809.67 |  4,858 |  904 |  775 |
| `prover.openings_time_ms` |  90.33 |  542 |  93 |  88 |
| `prover.rap_constraints.logup_gkr_time_ms` |  280.50 |  1,683 |  385 |  259 |
| `prover.rap_constraints.round0_time_ms` |  361.33 |  2,168 |  370 |  352 |
| `prover.rap_constraints.mle_rounds_time_ms` |  167.17 |  1,003 |  169 |  162 |
...
| `prover.openings.whir_time_ms` |  29.33 |  176 |  30 |  28 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  700.50 |  1,401 |  886 |  515 |
| `execute_preflight_time_ms` |  2 |  4 |  2 |  2 |
| `trace_gen_time_ms   ` |  76.50 |  153 |  103 |  50 |
| `generate_blob_total_time_ms` |  10.50 |  21 |  14 |  7 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  623.50 |  1,247 |  783 |  464 |
| `prover.main_trace_commit_time_ms` |  314 |  628 |  408 |  220 |
| `prover.rap_constraints_time_ms` |  227.50 |  455 |  287 |  168 |
| `prover.openings_time_ms` |  81.50 |  163 |  88 |  75 |
| `prover.rap_constraints.logup_gkr_time_ms` |  63.50 |  127 |  79 |  48 |
...
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  448 |  448 |  448 |  448 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/ce3f5e8b6dbeeeedfe50f789f83f32a2d706bef7/sha2_bench-ce3f5e8b6dbeeeedfe50f789f83f32a2d706bef7.memory.svg)
...
| app_proof |  |  |  |  |  | 1,426 |  |  | 138 | 14,793,960 | 106.50 | 0 | 9,108 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 31 | 480 | 31 | 11 | 2 | 2 | 1 | 1 | 
| internal_recursive.0 | 1 | 12 | 185 | 12 | 2 | 1 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 9 | 151 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 103 | 886 | 102 | 38 | 14 | 2 | 3 | 3 | 
| leaf | 1 | 50 | 515 | 50 | 19 | 7 | 2 | 3 | 3 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 100,404,864 | 448 | 226 | 0 | 13 | 165 | 45 | 44 | 86 | 33 | 0 | 56 | 18 | 37 | 7 | 30 | 226 | 165 | 0 | 2 | 32 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 25,962,119 | 173 | 51 | 0 | 3 | 75 | 24 | 24 | 28 | 22 | 0 | 45 | 21 | 23 | 1 | 21 | 51 | 75 | 0 | 2 | 21 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 17,507,975 | 141 | 33 | 0 | 3 | 62 | 21 | 21 | 24 | 16 | 0 | 44 | 22 | 22 | 1 | 20 | 34 | 62 | 0 | 2 | 16 | 0 | 0 | 
| leaf | 0 | prover | 341,718,010 | 783 | 407 | 0 | 26 | 287 | 128 | 127 | 79 | 79 | 0 | 88 | 32 | 55 | 22 | 33 | 408 | 287 | 0 | 6 | 77 | 0 | 0 | 
| leaf | 1 | prover | 179,641,792 | 464 | 220 | 0 | 13 | 168 | 71 | 70 | 47 | 48 | 0 | 75 | 37 | 37 | 11 | 26 | 220 | 168 | 0 | 5 | 48 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 630,037,121 | 1,282 | 284 | 0 | 21 | 904 | 352 | 351 | 167 | 385 | 137 | 93 | 30 | 62 | 32 | 30 | 284 | 904 | 0 | 3 | 246 | 0 | 0 | 
| app_proof | prover | 1 | 630,036,532 | 1,169 | 284 | 0 | 19 | 794 | 363 | 363 | 168 | 262 | 0 | 89 | 28 | 60 | 31 | 28 | 285 | 794 | 0 | 3 | 261 | 0 | 0 | 
| app_proof | prover | 2 | 630,036,532 | 1,168 | 285 | 0 | 19 | 791 | 363 | 363 | 169 | 259 | 0 | 90 | 30 | 60 | 32 | 28 | 285 | 791 | 0 | 3 | 257 | 0 | 0 | 
| app_proof | prover | 3 | 630,036,532 | 1,171 | 284 | 0 | 19 | 795 | 367 | 367 | 168 | 259 | 0 | 91 | 30 | 60 | 32 | 27 | 284 | 795 | 0 | 3 | 258 | 0 | 0 | 
| app_proof | prover | 4 | 630,036,532 | 1,177 | 285 | 0 | 19 | 799 | 370 | 369 | 169 | 259 | 0 | 91 | 30 | 60 | 32 | 28 | 285 | 799 | 0 | 3 | 258 | 0 | 0 | 
| app_proof | prover | 5 | 630,124,756 | 1,150 | 285 | 0 | 20 | 775 | 353 | 353 | 162 | 259 | 0 | 88 | 28 | 60 | 31 | 29 | 285 | 775 | 0 | 3 | 258 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 161 | 1,703 | 161 | 171 | 0 | 3 | 87 | 2,623,000 | 38.35 | 
| app_proof | 1 | 87 | 1,455 | 87 | 41 | 0 | 2 | 158 | 2,625,000 | 40.44 | 
| app_proof | 2 | 107 | 1,455 | 107 | 41 | 0 | 2 | 138 | 2,625,000 | 40.73 | 
| app_proof | 3 | 107 | 1,458 | 107 | 41 | 0 | 2 | 137 | 2,625,000 | 40.75 | 
| app_proof | 4 | 107 | 1,464 | 107 | 41 | 0 | 2 | 138 | 2,625,000 | 40.59 | 
| app_proof | 5 | 142 | 1,426 | 142 | 41 | 0 | 2 | 92 | 1,670,960 | 40.14 | 

...
| `total_proof_time_ms ` |  761 |  3,044 |  912 |  549 |
| `execute_metered_time_ms` |  68 | -          | -          | -          |
| `execute_metered_insns` |  12,000,265 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  175.15 | -          |  175.15 |  175.15 |
| `execute_preflight_insns` |  3,000,066.25 |  12,000,265 |  3,495,000 |  1,515,265 |
| `execute_preflight_time_ms` |  85.25 |  341 |  109 |  44 |
| `execute_preflight_insn_mi/s` |  48.81 | -          |  50.54 |  46.28 |
| `trace_gen_time_ms   ` |  137.25 |  549 |  171 |  117 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  468.50 |  1,874 |  532 |  293 |
| `prover.main_trace_commit_time_ms` |  98 |  392 |  111 |  59 |
| `prover.rap_constraints_time_ms` |  269 |  1,076 |  304 |  167 |
| `prover.openings_time_ms` |  100.25 |  401 |  116 |  66 |
| `prover.rap_constraints.logup_gkr_time_ms` |  193.75 |  775 |  221 |  116 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/4b5977f8da2d4403a8a4ffb480016457fc734569/fibonacci-4b5977f8da2d4403a8a4ffb480016457fc734569.memory.svg)
...
| app_proof |  |  |  |  |  | 549 |  |  | 68 | 12,000,265 | 175.15 | 0 | 3,121 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 19 | 339 | 18 | 5 | 1 | 2 | 1 | 1 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,747 | 320 | 116 | 0 | 0 | 105 | 34 | 33 | 50 | 20 | 0 | 98 | 84 | 13 | 3 | 9 | 117 | 105 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,767 | 166 | 46 | 0 | 0 | 67 | 24 | 24 | 28 | 13 | 0 | 52 | 43 | 8 | 1 | 6 | 47 | 66 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 135 | 32 | 0 | 0 | 60 | 22 | 22 | 24 | 13 | 0 | 42 | 35 | 7 | 1 | 5 | 32 | 60 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 147,934,246 | 605 | 231 | 0 | 0 | 181 | 83 | 82 | 53 | 44 | 0 | 191 | 167 | 24 | 12 | 11 | 231 | 181 | 0 | 8 | 43 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 136,618,054 | 532 | 111 | 0 | 0 | 304 | 57 | 56 | 27 | 219 | 0 | 116 | 95 | 21 | 11 | 9 | 111 | 304 | 0 | 3 | 218 | 0 | 0 | 
| app_proof | prover | 1 | 136,570,716 | 524 | 111 | 0 | 0 | 301 | 54 | 54 | 26 | 219 | 0 | 110 | 90 | 20 | 11 | 8 | 111 | 301 | 0 | 3 | 219 | 0 | 0 | 
| app_proof | prover | 2 | 136,570,716 | 525 | 111 | 0 | 0 | 304 | 56 | 55 | 26 | 221 | 0 | 109 | 88 | 21 | 12 | 9 | 111 | 304 | 0 | 3 | 221 | 0 | 0 | 
| app_proof | prover | 3 | 70,295,004 | 293 | 59 | 0 | 0 | 167 | 32 | 32 | 17 | 116 | 0 | 66 | 54 | 12 | 6 | 6 | 59 | 166 | 0 | 3 | 115 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 135 | 912 | 135 | 154 | 2,770,197,065 | 323,292,691 | 3,093,489,756 | 2,097,152 | 0 | 4 | 90 | 3,495,000 | 46.28 | 
| app_proof | 1 | 117 | 792 | 117 | 41 | 2,768,862,357 | 322,353,414 | 3,091,215,771 | 2,097,152 | 0 | 1 | 109 | 3,495,000 | 48.13 | 
| app_proof | 2 | 126 | 791 | 126 | 41 | 2,768,862,357 | 322,353,414 | 3,091,215,771 | 2,097,152 | 0 | 1 | 98 | 3,495,000 | 50.54 | 
| app_proof | 3 | 171 | 549 | 171 | 41 | 1,230,956,171 | 342,871,578 | 1,573,827,749 | 2,097,152 | 0 | 2 | 44 | 1,515,265 | 50.27 | 

...
| `total_proof_time_ms ` |  2,112.50 |  4,225 |  2,566 |  1,659 |
| `compile_metered_time_ms` |  6 |  6 |  6 |  6 |
| `execute_metered_time_ms` |  57 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  195.45 | -          |  195.45 |  195.45 |
| `execute_preflight_insns` |  5,583,980.50 |  11,167,961 |  7,136,000 |  4,031,961 |
| `execute_preflight_time_ms` |  362 |  724 |  506 |  218 |
| `execute_preflight_insn_mi/s` |  35.68 | -          |  36.68 |  34.67 |
| `trace_gen_time_ms   ` |  74 |  148 |  103 |  45 |
| `set_initial_memory_time_ms` |  0 |  0 |  0 |  0 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,674 |  3,348 |  2,243 |  1,105 |
| `prover.main_trace_commit_time_ms` |  406.50 |  813 |  589 |  224 |
| `prover.rap_constraints_time_ms` |  992.50 |  1,985 |  1,301 |  684 |
| `prover.openings_time_ms` |  274.50 |  549 |  353 |  196 |
| `prover.rap_constraints.logup_gkr_time_ms` |  275 |  550 |  355 |  195 |
| `prover.rap_constraints.round0_time_ms` |  531.50 |  1,063 |  706 |  357 |
| `prover.rap_constraints.mle_rounds_time_ms` |  185 |  370 |  239 |  131 |
...
| `prover.openings.whir_time_ms` |  199.50 |  399 |  256 |  143 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/68fed4d03751d7d3e8e08b0a5d1e4bc12fdcce9e/sha2_bench-68fed4d03751d7d3e8e08b0a5d1e4bc12fdcce9e.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 57 |  |  |  | 298 |  |  |  |  |  |  | 
| app_proof |  |  |  | 1,659 |  | 57 | 11,167,961 | 195.45 | 0 | 4,291 |  | 
...
| internal_recursive.0 | 1 | prover | 15,378,769 | 109 | 20 | 0 | 0 | 55 | 21 | 20 | 23 | 11 | 0 | 32 | 25 | 7 | 1 | 6 | 20 | 20 | 55 | 0 | 1 | 10 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 101 | 15 | 0 | 0 | 56 | 22 | 21 | 21 | 13 | 0 | 29 | 22 | 7 | 1 | 5 | 15 | 15 | 56 | 0 | 1 | 10 | 0 | 0 | 
| leaf | 0 | prover | 237,929,272 | 406 | 145 | 0 | 0 | 142 | 71 | 69 | 44 | 26 | 0 | 118 | 96 | 21 | 10 | 11 | 145 | 145 | 142 | 0 | 3 | 25 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,315,603,879 | 2,243 | 588 | 0 | 0 | 1,301 | 706 | 705 | 239 | 355 | 1 | 353 | 256 | 97 | 59 | 37 | 589 | 588 | 1,301 | 0 | 1 | 353 | 0 | 0 | 
| app_proof | prover | 1 | 709,400,372 | 1,105 | 224 | 0 | 0 | 684 | 357 | 356 | 131 | 195 | 0 | 196 | 143 | 53 | 31 | 21 | 224 | 224 | 684 | 0 | 1 | 194 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 0 | 2 | 103 | 2,566 | 103 | 0 | 12,820,745,040 | 2,969,266,308 | 15,790,011,348 | 2,097,152 | 0 | 4 | 218 | 7,136,000 | 34.67 | 
| app_proof | 1 | 0 | 1 | 45 | 1,659 | 45 | 0 | 7,276,211,748 | 1,627,054,965 | 8,903,266,713 | 2,097,152 | 0 | 2 | 506 | 4,031,961 | 36.68 | 

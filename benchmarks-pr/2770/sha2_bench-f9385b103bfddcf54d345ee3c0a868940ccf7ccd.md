...
|:---|---:|---:|---:|
| Total |  11.59 |  3.61 |  3.61 |
| app_proof |  9.34 |  1.87 |  1.87 |
| leaf |  1.42 |  0.90 |  0.90 |
...
| `total_proof_time_ms ` |  1,534 |  9,204 |  1,736 |  1,467 |
| `execute_metered_time_ms` |  138 | -          | -          | -          |
| `execute_metered_insns` |  14,793,960 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  106.63 | -          |  106.63 |  106.63 |
| `execute_preflight_insns` |  2,465,660 |  14,793,960 |  2,625,000 |  1,670,960 |
| `execute_preflight_time_ms` |  123.83 |  743 |  159 |  85 |
| `execute_preflight_insn_mi/s` |  40.40 | -          |  40.94 |  38.69 |
| `trace_gen_time_ms   ` |  125.50 |  753 |  168 |  89 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,221.50 |  7,329 |  1,318 |  1,183 |
| `prover.main_trace_commit_time_ms` |  289.67 |  1,738 |  292 |  289 |
| `prover.rap_constraints_time_ms` |  839.67 |  5,038 |  932 |  801 |
| `prover.openings_time_ms` |  91.17 |  547 |  96 |  89 |
| `prover.rap_constraints.logup_gkr_time_ms` |  283 |  1,698 |  389 |  260 |
| `prover.rap_constraints.round0_time_ms` |  385.33 |  2,312 |  394 |  370 |
| `prover.rap_constraints.mle_rounds_time_ms` |  170.67 |  1,024 |  173 |  167 |
| `prover.openings.stacked_reduction_time_ms` |  61.67 |  370 |  64 |  61 |
| `prover.openings.stacked_reduction.round0_time_ms` |  32 |  192 |  33 |  31 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  29.17 |  175 |  31 |  28 |
| `prover.openings.whir_time_ms` |  29 |  174 |  32 |  27 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  707.50 |  1,415 |  901 |  514 |
| `execute_preflight_time_ms` |  2 |  4 |  2 |  2 |
| `trace_gen_time_ms   ` |  75 |  150 |  102 |  48 |
| `generate_blob_total_time_ms` |  10.50 |  21 |  14 |  7 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  631.50 |  1,263 |  798 |  465 |
| `prover.main_trace_commit_time_ms` |  320.50 |  641 |  415 |  226 |
| `prover.rap_constraints_time_ms` |  232 |  464 |  292 |  172 |
| `prover.openings_time_ms` |  77.50 |  155 |  90 |  65 |
| `prover.rap_constraints.logup_gkr_time_ms` |  64 |  128 |  79 |  49 |
| `prover.rap_constraints.round0_time_ms` |  103.50 |  207 |  133 |  74 |
...
| `prover.openings.whir_time_ms` |  30.50 |  61 |  34 |  27 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/f9385b103bfddcf54d345ee3c0a868940ccf7ccd/sha2_bench-f9385b103bfddcf54d345ee3c0a868940ccf7ccd.memory.svg)
...
| app_proof |  |  |  |  |  | 1,467 |  |  | 138 | 14,793,960 | 106.63 | 0 | 9,351 |  | 
| internal_for_leaf |  |  |  | 490 |  |  |  |  |  |  |  |  |  | 490 | 
| internal_recursive.0 |  |  |  | 187 |  |  |  |  |  |  |  |  |  | 188 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 30 | 490 | 30 | 11 | 2 | 2 | 1 | 1 | 
| internal_recursive.0 | 1 | 12 | 187 | 12 | 2 | 1 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 9 | 155 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 102 | 901 | 102 | 38 | 14 | 2 | 3 | 3 | 
| leaf | 1 | 48 | 514 | 48 | 19 | 7 | 2 | 3 | 3 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 100,404,864 | 459 | 231 | 0 | 13 | 168 | 47 | 46 | 88 | 33 | 0 | 58 | 20 | 37 | 7 | 30 | 231 | 168 | 0 | 2 | 32 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 25,962,119 | 174 | 52 | 0 | 4 | 77 | 25 | 24 | 29 | 22 | 0 | 44 | 20 | 24 | 2 | 22 | 52 | 77 | 0 | 2 | 21 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 17,507,975 | 145 | 34 | 0 | 4 | 66 | 24 | 23 | 24 | 18 | 0 | 43 | 20 | 22 | 1 | 21 | 35 | 66 | 0 | 2 | 17 | 0 | 0 | 
| leaf | 0 | prover | 341,718,010 | 798 | 415 | 0 | 26 | 292 | 133 | 132 | 79 | 79 | 0 | 90 | 34 | 56 | 22 | 33 | 415 | 292 | 0 | 6 | 78 | 0 | 0 | 
| leaf | 1 | prover | 179,641,792 | 465 | 226 | 0 | 13 | 172 | 74 | 73 | 48 | 49 | 0 | 65 | 27 | 38 | 11 | 26 | 226 | 172 | 0 | 5 | 48 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 630,037,121 | 1,318 | 289 | 0 | 21 | 932 | 370 | 369 | 172 | 389 | 138 | 96 | 32 | 64 | 32 | 31 | 289 | 932 | 0 | 3 | 249 | 0 | 0 | 
| app_proof | prover | 1 | 630,036,532 | 1,205 | 288 | 0 | 19 | 826 | 389 | 388 | 172 | 265 | 0 | 90 | 28 | 61 | 32 | 29 | 289 | 826 | 0 | 3 | 264 | 0 | 0 | 
| app_proof | prover | 2 | 630,036,532 | 1,207 | 289 | 0 | 19 | 826 | 394 | 393 | 170 | 261 | 0 | 91 | 29 | 61 | 32 | 29 | 289 | 826 | 0 | 3 | 260 | 0 | 0 | 
| app_proof | prover | 3 | 630,036,532 | 1,208 | 289 | 0 | 19 | 829 | 394 | 394 | 173 | 261 | 0 | 89 | 28 | 61 | 33 | 28 | 289 | 829 | 0 | 3 | 260 | 0 | 0 | 
| app_proof | prover | 4 | 630,036,532 | 1,208 | 290 | 0 | 19 | 824 | 393 | 393 | 170 | 260 | 0 | 92 | 30 | 61 | 32 | 28 | 290 | 824 | 0 | 3 | 259 | 0 | 0 | 
| app_proof | prover | 5 | 630,124,756 | 1,183 | 292 | 0 | 20 | 801 | 372 | 371 | 167 | 262 | 0 | 89 | 27 | 62 | 31 | 30 | 292 | 801 | 0 | 3 | 260 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 168 | 1,736 | 168 | 163 | 0 | 3 | 85 | 2,623,000 | 38.69 | 
| app_proof | 1 | 89 | 1,496 | 89 | 41 | 0 | 2 | 159 | 2,625,000 | 40.38 | 
| app_proof | 2 | 115 | 1,500 | 115 | 41 | 0 | 2 | 136 | 2,625,000 | 40.76 | 
| app_proof | 3 | 115 | 1,502 | 115 | 41 | 0 | 2 | 136 | 2,625,000 | 40.88 | 
| app_proof | 4 | 116 | 1,503 | 116 | 41 | 0 | 2 | 136 | 2,625,000 | 40.94 | 
| app_proof | 5 | 150 | 1,467 | 150 | 41 | 0 | 2 | 91 | 1,670,960 | 40.76 | 

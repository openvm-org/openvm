...
|:---|---:|---:|---:|
| Total |  16.76 |  4.97 |  4.97 |
| app_proof |  13.67 |  2.67 |  2.67 |
| leaf |  2.23 |  1.44 |  1.44 |
...
| `total_proof_time_ms ` |  2,255.83 |  13,535 |  2,536 |  2,162 |
| `execute_metered_time_ms` |  139 | -          | -          | -          |
| `execute_metered_insns` |  14,365,133 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  102.82 | -          |  102.82 |  102.82 |
| `execute_preflight_insns` |  2,394,188.83 |  14,365,133 |  2,413,000 |  2,300,133 |
| `execute_preflight_time_ms` |  239.67 |  1,438 |  333 |  86 |
| `execute_preflight_insn_mi/s` |  35.45 | -          |  36.36 |  32.16 |
| `trace_gen_time_ms   ` |  54.17 |  325 |  156 |  33 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,900.17 |  11,401 |  2,131 |  1,851 |
| `prover.main_trace_commit_time_ms` |  708.17 |  4,249 |  873 |  675 |
| `prover.rap_constraints_time_ms` |  1,007.33 |  6,044 |  1,070 |  991 |
| `prover.openings_time_ms` |  183.67 |  1,102 |  187 |  177 |
| `prover.rap_constraints.logup_gkr_time_ms` |  179.67 |  1,078 |  231 |  169 |
| `prover.rap_constraints.round0_time_ms` |  518.83 |  3,113 |  523 |  512 |
| `prover.rap_constraints.mle_rounds_time_ms` |  307.67 |  1,846 |  326 |  304 |
| `prover.openings.stacked_reduction_time_ms` |  141.83 |  851 |  144 |  135 |
| `prover.openings.stacked_reduction.round0_time_ms` |  81.83 |  491 |  83 |  76 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  59.33 |  356 |  60 |  59 |
| `prover.openings.whir_time_ms` |  41.17 |  247 |  43 |  39 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,113 |  2,226 |  1,440 |  786 |
| `execute_preflight_time_ms` |  5.50 |  11 |  6 |  5 |
| `trace_gen_time_ms   ` |  137.50 |  275 |  183 |  92 |
| `generate_blob_total_time_ms` |  24.50 |  49 |  33 |  16 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  974.50 |  1,949 |  1,256 |  693 |
| `prover.main_trace_commit_time_ms` |  549 |  1,098 |  722 |  376 |
| `prover.rap_constraints_time_ms` |  320.50 |  641 |  408 |  233 |
| `prover.openings_time_ms` |  104.50 |  209 |  125 |  84 |
| `prover.rap_constraints.logup_gkr_time_ms` |  72 |  144 |  88 |  56 |
| `prover.rap_constraints.round0_time_ms` |  154 |  308 |  201 |  107 |
| `prover.rap_constraints.mle_rounds_time_ms` |  93 |  186 |  118 |  68 |
| `prover.openings.stacked_reduction_time_ms` |  68 |  136 |  84 |  52 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/9c8ce6e816ab3a26750ae1bee15b3f9ad59f41b7/keccak-9c8ce6e816ab3a26750ae1bee15b3f9ad59f41b7.memory.svg)
...
| app_proof |  |  |  |  |  | 2,162 |  |  | 139 | 14,365,133 | 102.82 | 0 | 13,682 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 38 | 522 | 37 | 13 | 4 | 2 | 2 | 2 | 
| internal_recursive.0 | 1 | 13 | 186 | 13 | 2 | 1 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 9 | 151 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 183 | 1,440 | 183 | 65 | 33 | 6 | 7 | 7 | 
| leaf | 1 | 92 | 786 | 92 | 32 | 16 | 5 | 7 | 7 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 81,415,028 |
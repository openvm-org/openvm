...
|:---|---:|---:|
| Total |  7.78 |  4.71 |
| regex_program |  7.72 |  4.65 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  3,858.50 |  7,717 |  4,650 |  3,067 |
...
| `execute_metered_insn_mi/s` |  69.63 | -          |  69.63 |  69.63 |
| `execute_e3_time_ms  ` |  164 |  328 |  177 |  151 |
| `execute_e3_insn_mi/s` |  12.64 | -          |  12.67 |  12.61 |
| `trace_gen_time_ms   ` |  722.50 |  1,445 |  761 |  684 |
| `memory_finalize_time_ms` |  169 |  338 |  265 |  73 |
| `boundary_finalize_time_ms` |  2.50 |  5 |  5 |  0 |
| `merkle_finalize_time_ms` |  154.50 |  309 |  240 |  69 |
| `stark_prove_excluding_trace_time_ms` |  2,972 |  5,944 |  3,712 |  2,232 |
| `main_trace_commit_time_ms` |  575.50 |  1,151 |  753 |  398 |
| `generate_perm_trace_time_ms` |  247 |  494 |  311 |  183 |
| `perm_trace_commit_time_ms` |  608.50 |  1,217 |  753 |  464 |
| `quotient_poly_compute_time_ms` |  302.50 |  605 |  368 |  237 |
| `quotient_poly_commit_time_ms` |  271 |  542 |  352 |  190 |
| `pcs_opening_time_ms ` |  958.50 |  1,917 |  1,169 |  748 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2 | 25 | 4,165,433 | 1 | 6,774 | 59 | 69.63 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 761 | 4,650 | 2,244,000 | 373,166,268 | 3,712 | 368 | 352 | 3,941 | 753 | 1,169 | 240 | 24 | 265 | 753 | 93,451,426 | 2,244,000 | 311 | 177 | 12.61 | 5 | 
| regex_program | 1 | 684 | 3,067 | 1,921,432 | 242,975,388 | 2,232 | 237 | 190 | 2,828 | 464 | 748 | 69 | 24 | 73 | 398 | 73,001,460 | 1,921,433 | 183 | 151 | 12.67 | 0 | 

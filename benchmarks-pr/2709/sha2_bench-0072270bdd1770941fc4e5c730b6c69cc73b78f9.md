...
|:---|---:|---:|---:|
| Total |  11.66 |  3.64 |  3.64 |
| app_proof |  9.39 |  1.89 |  1.89 |
| leaf |  1.44 |  0.92 |  0.92 |
...
| `total_proof_time_ms ` |  1,541.67 |  9,250 |  1,750 |  1,469 |
| `execute_metered_time_ms` |  138 | -          | -          | -          |
| `execute_metered_insns` |  14,793,960 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  106.60 | -          |  106.60 |  106.60 |
| `execute_preflight_insns` |  2,465,660 |  14,793,960 |  2,625,000 |  1,670,960 |
| `execute_preflight_time_ms` |  125.17 |  751 |  159 |  86 |
| `execute_preflight_insn_mi/s` |  40.17 | -          |  40.64 |  38.31 |
| `trace_gen_time_ms   ` |  127 |  762 |  170 |  95 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,225.83 |  7,355 |  1,322 |  1,184 |
| `prover.main_trace_commit_time_ms` |  292.67 |  1,756 |  294 |  291 |
| `prover.rap_constraints_time_ms` |  838.83 |  5,033 |  930 |  801 |
| `prover.openings_time_ms` |  93.50 |  561 |  100 |  89 |
| `prover.rap_constraints.logup_gkr_time_ms` |  283.67 |  1,702 |  388 |  262 |
| `prover.rap_constraints.round0_time_ms` |  380.50 |  2,283 |  390 |  368 |
| `prover.rap_constraints.mle_rounds_time_ms` |  173.50 |  1,041 |  176 |  170 |
| `prover.openings.stacked_reduction_time_ms` |  62.67 |  376 |  65 |  62 |
| `prover.openings.stacked_reduction.round0_time_ms` |  33 |  198 |  34 |  32 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  29.33 |  176 |  31 |  28 |
| `prover.openings.whir_time_ms` |  30.33 |  182 |  34 |  26 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  721 |  1,442 |  917 |  525 |
| `execute_preflight_time_ms` |  2 |  4 |  2 |  2 |
| `trace_gen_time_ms   ` |  78.50 |  157 |  107 |  50 |
| `generate_blob_total_time_ms` |  10.50 |  21 |  14 |  7 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  642.50 |  1,285 |  810 |  475 |
| `prover.main_trace_commit_time_ms` |  324 |  648 |  419 |  229 |
| `prover.rap_constraints_time_ms` |  233 |  466 |  293 |  173 |
| `prover.openings_time_ms` |  84.50 |  169 |  97 |  72 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/0072270bdd1770941fc4e5c730b6c69cc73b78f9/sha2_bench-0072270bdd1770941fc4e5c730b6c69cc73b78f9.memory.svg)
...
| app_proof |  |  |  |  |  | 1,469 |  |  | 138 | 14,793,960 | 106.60 | 0 | 9,397 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 31 | 492 | 31 | 11 | 2 | 2 | 1 | 1 | 
| internal_recursive.0 | 1 | 13 | 189 | 13 | 2 | 1 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 10 | 151 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 107 | 917 | 106 | 38 | 14 | 2 | 3 | 3 | 
| leaf | 1 | 50 | 525 | 50 | 19 | 7 | 2 | 3 | 3 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 100,404,864 | 460 | 232 | 0 | 13 | 169 | 46 | 46 | 89 | 33 | 0 | 58 | 21 | 37 | 7 | 30 | 232 | 169 | 0 | 3 | 32 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 25,962,119 | 176 | 51 | 0 | 3 | 78 | 25 | 24 | 29 | 22 | 0 | 46 | 22 | 24 | 2 | 21 | 51 | 78 | 0 | 2 | 22 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 17,507,975 | 141 | 34 | 0 | 3 | 66 | 23 | 23 | 24 | 17 | 0 | 39 | 17 | 22 | 1 | 20 | 35 | 66 | 0 | 2 | 16 | 0 | 0 | 
| leaf | 0 | prover | 341,718,010 | 810 | 419 | 0 | 26 | 293 | 131 | 131 | 81 | 79 | 0 | 97 | 40 | 56 | 22 | 33 | 419 | 293 | 0 | 6 | 77 | 0 | 0 | 
| leaf | 1 | prover | 179,641,792 | 475 | 228 | 0 | 13 | 173 | 74 | 74 | 49 | 49 | 0 | 72 | 33 | 38 | 11 | 26 | 229 | 173 | 0 | 5 | 48 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 630,037,121 | 1,322 | 291 | 0 | 21 | 930 | 368 | 367 | 173 | 388 | 138 | 100 | 34 | 65 | 34 | 31 | 291 | 930 | 0 | 4 | 248 | 0 | 0 | 
| app_proof | prover | 1 | 630,036,532 | 1,213 | 293 | 0 | 19 | 828 | 385 | 385 | 176 | 266 | 0 | 91 | 29 | 62 | 33 | 29 | 294 | 828 | 0 | 3 | 265 | 0 | 0 | 
| app_proof | prover | 2 | 630,036,532 | 1,212 | 292 | 0 | 19 | 827 | 390 | 389 | 174 | 262 | 0 | 92 | 30 | 62 | 33 | 28 | 292 | 827 | 0 | 3 | 260 | 0 | 0 | 
| app_proof | prover | 3 | 630,036,532 | 1,212 | 294 | 0 | 19 | 822 | 384 | 384 | 174 | 262 | 0 | 95 | 32 | 63 | 33 | 29 | 294 | 822 | 0 | 4 | 261 | 0 | 0 | 
| app_proof | prover | 4 | 630,036,532 | 1,212 | 292 | 0 | 19 | 825 | 388 | 388 | 174 | 262 | 0 | 94 | 31 | 62 | 33 | 29 | 292 | 825 | 0 | 3 | 261 | 0 | 0 | 
| app_proof | prover | 5 | 630,124,756 | 1,184 | 293 | 0 | 20 | 801 | 368 | 367 | 170 | 262 | 0 | 89 | 26 | 62 | 32 | 30 | 293 | 801 | 0 | 3 | 261 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 170 | 1,750 | 170 | 171 | 0 | 3 | 86 | 2,623,000 | 38.31 | 
| app_proof | 1 | 95 | 1,509 | 95 | 41 | 0 | 2 | 159 | 2,625,000 | 40.64 | 
| app_proof | 2 | 115 | 1,507 | 115 | 41 | 0 | 2 | 138 | 2,625,000 | 40.62 | 
| app_proof | 3 | 115 | 1,507 | 115 | 41 | 0 | 2 | 138 | 2,625,000 | 40.39 | 
| app_proof | 4 | 116 | 1,508 | 116 | 41 | 0 | 2 | 138 | 2,625,000 | 40.56 | 
| app_proof | 5 | 151 | 1,469 | 151 | 41 | 0 | 2 | 92 | 1,670,960 | 40.53 | 

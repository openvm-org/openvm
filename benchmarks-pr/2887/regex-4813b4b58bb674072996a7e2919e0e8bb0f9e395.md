...
| `total_proof_time_ms ` |  772.50 |  1,545 |  885 |  660 |
| `compile_metered_time_ms` |  8 |  8 |  8 |  8 |
| `execute_metered_time_ms` |  35 | -          | -          | -          |
| `execute_metered_insns` |  4,090,656 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  116.72 | -          |  116.72 |  116.72 |
| `execute_preflight_insns` |  2,045,328 |  4,090,656 |  2,327,000 |  1,763,656 |
| `execute_preflight_time_ms` |  87.50 |  175 |  97 |  78 |
| `execute_preflight_insn_mi/s` |  32.14 | -          |  33.26 |  31.03 |
| `trace_gen_time_ms   ` |  37.50 |  75 |  44 |  31 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  559 |  1,118 |  622 |  496 |
| `prover.main_trace_commit_time_ms` |  117 |  234 |  130 |  104 |
| `prover.rap_constraints_time_ms` |  328.50 |  657 |  367 |  290 |
| `prover.openings_time_ms` |  113 |  226 |  125 |  101 |
| `prover.rap_constraints.logup_gkr_time_ms` |  198 |  396 |  239 |  157 |
| `prover.rap_constraints.round0_time_ms` |  95 |  190 |  101 |  89 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/4813b4b58bb674072996a7e2919e0e8bb0f9e395/regex-4813b4b58bb674072996a7e2919e0e8bb0f9e395.memory.svg)
...
| app_proof |  |  |  |  |  | 660 |  |  | 35 | 4,090,656 | 116.72 | 0 | 1,594 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 27,289,403 | 265 | 82 | 0 | 0 | 99 | 33 | 32 | 46 | 19 | 0 | 82 | 71 | 11 | 2 | 8 | 82 | 99 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,767 | 166 | 46 | 0 | 0 | 67 | 25 | 24 | 28 | 13 | 0 | 51 | 43 | 8 | 1 | 6 | 47 | 67 | 0 | 3 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 136 | 32 | 0 | 0 | 60 | 22 | 22 | 24 | 13 | 0 | 43 | 35 | 7 | 1 | 5 | 32 | 60 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 79,656,756 | 380 | 128 | 0 | 0 | 136 | 56 | 55 | 37 | 42 | 0 | 114 | 99 | 15 | 6 | 8 | 129 | 136 | 0 | 7 | 41 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 161,843,666 | 622 | 129 | 0 | 0 | 367 | 89 | 88 | 38 | 239 | 0 | 125 | 100 | 25 | 13 | 11 | 130 | 367 | 0 | 3 | 238 | 0 | 0 | 
| app_proof | prover | 1 | 123,257,151 | 496 | 104 | 0 | 0 | 290 | 101 | 101 | 31 | 157 | 0 | 101 | 81 | 20 | 9 | 10 | 104 | 290 | 0 | 3 | 156 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 31 | 885 | 31 | 134 | 2,906,597,493 | 888,488,923 | 3,795,086,416 | 2,097,152 | 1 | 4 | 97 | 2,327,000 | 31.03 | 
| app_proof | 1 | 44 | 660 | 44 | 41 | 2,092,069,523 | 674,063,136 | 2,766,132,659 | 2,097,152 | 0 | 2 | 78 | 1,763,656 | 33.26 | 

...
|:---|---:|---:|---:|
| Total |  13.27 |  5.58 |  5.58 |
| app_proof |  10.51 |  2.82 |  2.82 |
| leaf |  1.95 |  1.95 |  1.95 |
...
| `total_proof_time_ms ` |  2,601 |  10,404 |  2,717 |  2,543 |
| `compile_metered_time_ms` |  3 |  3 |  3 |  3 |
| `execute_metered_time_ms` |  101 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  110.08 | -          |  110.08 |  110.08 |
| `execute_preflight_insns` |  2,791,990.25 |  11,167,961 |  2,851,000 |  2,614,961 |
| `execute_preflight_time_ms` |  164 |  656 |  210 |  99 |
| `execute_preflight_insn_mi/s` |  34.98 | -          |  35.85 |  32.49 |
| `trace_gen_time_ms   ` |  58.25 |  233 |  65 |  54 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  2,312.75 |  9,251 |  2,415 |  2,277 |
| `prover.main_trace_commit_time_ms` |  616.75 |  2,467 |  620 |  614 |
| `prover.rap_constraints_time_ms` |  1,222.50 |  4,890 |  1,228 |  1,215 |
| `prover.openings_time_ms` |  472.25 |  1,889 |  565 |  440 |
| `prover.rap_constraints.logup_gkr_time_ms` |  308.75 |  1,235 |  309 |  308 |
| `prover.rap_constraints.round0_time_ms` |  670.75 |  2,683 |  674 |  666 |
| `prover.rap_constraints.mle_rounds_time_ms` |  242.50 |  970 |  244 |  240 |
| `prover.openings.stacked_reduction_time_ms` |  96.25 |  385 |  99 |  93 |
...
| `prover.openings.whir_time_ms` |  375.25 |  1,501 |  465 |  342 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,946 |  1,946 |  1,946 |  1,946 |
...
| `prover.openings_time_ms` |  648 |  648 |  648 |  648 |
...
| `prover.openings.whir_time_ms` |  583 |  583 |  583 |  583 |
...
| `prover.openings_time_ms` |  142 |  142 |  142 |  142 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/0924674415f510c6719c5dc2c13658a1186563c8/sha2_bench-0924674415f510c6719c5dc2c13658a1186563c8.memory.svg)
...
| app_proof |  |  |  |  |  | 2,543 |  |  | 101 | 11,167,961 | 110.08 | 0 | 10,513 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 61,220,667 | 455 | 183 | 0 | 0 | 129 | 37 | 37 | 63 | 27 | 0 | 142 | 123 | 18 | 5 | 12 | 183 | 129 | 0 | 4 | 26 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,943 | 179 | 50 | 0 | 0 | 72 | 25 | 24 | 29 | 17 | 0 | 56 | 47 | 8 | 2 | 6 | 50 | 72 | 0 | 3 | 16 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 135 | 32 | 0 | 0 | 61 | 22 | 22 | 24 | 13 | 0 | 41 | 34 | 7 | 1 | 5 | 33 | 61 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 425,192,422 | 1,802 | 806 | 0 | 90 | 347 | 167 | 166 | 104 | 75 | 0 | 648 | 583 | 64 | 36 | 28 | 806 | 347 | 0 | 9 | 73 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 640,057,593 | 2,415 | 620 | 0 | 71 | 1,228 | 674 | 674 | 244 | 309 | 0 | 565 | 465 | 99 | 60 | 38 | 620 | 1,228 | 0 | 4 | 307 | 0 | 0 | 
| app_proof | prover | 1 | 640,057,356 | 2,277 | 614 | 0 | 0 | 1,222 | 670 | 670 | 243 | 308 | 0 | 440 | 342 | 97 | 59 | 38 | 614 | 1,222 | 0 | 5 | 307 | 0 | 0 | 
| app_proof | prover | 2 | 640,057,356 | 2,281 | 614 | 0 | 0 | 1,225 | 673 | 672 | 243 | 309 | 0 | 441 | 344 | 96 | 58 | 38 | 614 | 1,225 | 0 | 4 | 307 | 0 | 0 | 
| app_proof | prover | 3 | 640,057,588 | 2,278 | 618 | 0 | 0 | 1,215 | 666 | 666 | 240 | 309 | 0 | 443 | 350 | 93 | 56 | 37 | 619 | 1,215 | 0 | 6 | 307 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 65 | 2,717 | 65 | 136 | 5,529,436,044 | 2,165,730,336 | 7,695,166,380 | 2,097,152 | 0 | 3 | 99 | 2,851,000 | 32.49 | 
| app_proof | 1 | 57 | 2,586 | 57 | 41 | 5,529,347,520 | 2,165,557,968 | 7,694,905,488 | 2,097,152 | 0 | 1 | 210 | 2,851,000 | 35.78 | 
| app_proof | 2 | 57 | 2,558 | 57 | 41 | 5,529,349,296 | 2,165,556,192 | 7,694,905,488 | 2,097,152 | 0 | 1 | 178 | 2,851,000 | 35.80 | 
| app_proof | 3 | 54 | 2,543 | 54 | 41 | 5,077,435,956 | 2,617,472,316 | 7,694,908,272 | 2,097,152 | 0 | 1 | 169 | 2,614,961 | 35.85 | 

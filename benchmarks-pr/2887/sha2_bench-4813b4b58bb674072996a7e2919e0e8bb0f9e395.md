...
|:---|---:|---:|---:|
| Total |  13.32 |  5.59 |  5.59 |
| app_proof |  10.55 |  2.82 |  2.82 |
| leaf |  1.94 |  1.94 |  1.94 |
...
| `total_proof_time_ms ` |  2,611.75 |  10,447 |  2,717 |  2,561 |
...
| `execute_preflight_time_ms` |  160.50 |  642 |  204 |  97 |
| `execute_preflight_insn_mi/s` |  35.31 | -          |  36.30 |  32.81 |
| `trace_gen_time_ms   ` |  59 |  236 |  68 |  54 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  2,327 |  9,308 |  2,416 |  2,296 |
| `prover.main_trace_commit_time_ms` |  615.50 |  2,462 |  619 |  613 |
| `prover.rap_constraints_time_ms` |  1,236.50 |  4,946 |  1,240 |  1,233 |
| `prover.openings_time_ms` |  474.25 |  1,897 |  561 |  444 |
| `prover.rap_constraints.logup_gkr_time_ms` |  310.50 |  1,242 |  311 |  310 |
| `prover.rap_constraints.round0_time_ms` |  678.75 |  2,715 |  680 |  677 |
| `prover.rap_constraints.mle_rounds_time_ms` |  246.25 |  985 |  249 |  245 |
| `prover.openings.stacked_reduction_time_ms` |  98.75 |  395 |  100 |  98 |
...
| `prover.openings.whir_time_ms` |  374.75 |  1,499 |  462 |  345 |
...
| `prover.openings.whir_time_ms` |  568 |  568 |  568 |  568 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/4813b4b58bb674072996a7e2919e0e8bb0f9e395/sha2_bench-4813b4b58bb674072996a7e2919e0e8bb0f9e395.memory.svg)
...
| app_proof |  |  |  |  |  | 2,561 |  |  | 100 | 11,167,961 | 111.63 | 0 | 10,554 |  | 
| internal_for_leaf |  |  |  | 494 |  |  |  |  |  |  |  |  |  | 494 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 61,220,667 | 466 | 186 | 0 | 0 | 130 | 38 | 38 | 63 | 28 | 0 | 148 | 130 | 18 | 5 | 12 | 186 | 130 | 0 | 4 | 26 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,943 | 177 | 49 | 0 | 0 | 71 | 24 | 23 | 29 | 17 | 0 | 56 | 47 | 8 | 1 | 6 | 49 | 71 | 0 | 3 | 16 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 141 | 31 | 0 | 0 | 61 | 23 | 22 | 24 | 13 | 0 | 47 | 40 | 7 | 1 | 5 | 31 | 61 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 425,192,422 | 1,796 | 808 | 0 | 88 | 354 | 170 | 169 | 107 | 76 | 0 | 632 | 568 | 64 | 36 | 28 | 809 | 354 | 0 | 10 | 75 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 640,057,593 | 2,416 | 617 | 0 | 71 | 1,237 | 678 | 677 | 246 | 311 | 0 | 561 | 462 | 98 | 59 | 39 | 617 | 1,237 | 0 | 4 | 309 | 0 | 0 | 
| app_proof | prover | 1 | 640,057,356 | 2,296 | 613 | 0 | 0 | 1,236 | 680 | 680 | 245 | 310 | 0 | 446 | 345 | 100 | 61 | 39 | 613 | 1,236 | 0 | 5 | 309 | 0 | 0 | 
| app_proof | prover | 2 | 640,057,356 | 2,297 | 612 | 0 | 0 | 1,240 | 680 | 679 | 249 | 310 | 0 | 444 | 345 | 99 | 60 | 39 | 613 | 1,239 | 0 | 5 | 309 | 0 | 0 | 
| app_proof | prover | 3 | 640,057,588 | 2,299 | 619 | 0 | 0 | 1,233 | 677 | 676 | 245 | 311 | 0 | 446 | 347 | 98 | 59 | 39 | 619 | 1,233 | 0 | 5 | 309 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 68 | 2,717 | 68 | 135 | 5,529,436,044 | 2,165,730,336 | 7,695,166,380 | 2,097,152 | 0 | 3 | 97 | 2,851,000 | 32.81 | 
| app_proof | 1 | 57 | 2,598 | 57 | 41 | 5,529,347,520 | 2,165,557,968 | 7,694,905,488 | 2,097,152 | 0 | 1 | 204 | 2,851,000 | 35.90 | 
| app_proof | 2 | 57 | 2,571 | 57 | 41 | 5,529,349,296 | 2,165,556,192 | 7,694,905,488 | 2,097,152 | 0 | 1 | 175 | 2,851,000 | 36.30 | 
| app_proof | 3 | 54 | 2,561 | 54 | 41 | 5,077,435,956 | 2,617,472,316 | 7,694,908,272 | 2,097,152 | 0 | 1 | 166 | 2,614,961 | 36.24 | 

...
|:---|---:|---:|---:|
| Total |  10.15 |  7.08 |  7.08 |
| app_proof |  8.43 |  5.36 |  5.36 |
| leaf |  1.02 |  1.02 |  1.02 |
...
| `total_proof_time_ms ` |  4,168 |  8,336 |  5,265 |  3,071 |
...
| `execute_preflight_time_ms` |  254 |  508 |  287 |  221 |
| `execute_preflight_insn_mi/s` |  37.06 | -          |  38.90 |  35.21 |
| `trace_gen_time_ms   ` |  126.50 |  253 |  178 |  75 |
| `set_initial_memory_time_ms` |  88.50 |  177 |  136 |  41 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  3,697.50 |  7,395 |  4,728 |  2,667 |
| `prover.main_trace_commit_time_ms` |  976.50 |  1,953 |  1,353 |  600 |
| `prover.rap_constraints_time_ms` |  2,007 |  4,014 |  2,472 |  1,542 |
| `prover.openings_time_ms` |  713.50 |  1,427 |  902 |  525 |
| `prover.rap_constraints.logup_gkr_time_ms` |  564 |  1,128 |  604 |  524 |
| `prover.rap_constraints.round0_time_ms` |  1,052 |  2,104 |  1,366 |  738 |
| `prover.rap_constraints.mle_rounds_time_ms` |  389.50 |  779 |  500 |  279 |
| `prover.openings.stacked_reduction_time_ms` |  167.50 |  335 |  215 |  120 |
...
| `prover.openings.whir_time_ms` |  545.50 |  1,091 |  687 |  404 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/dce127c8d62c9ccc12de810c9b2e3dbc0574d124/sha2_bench-dce127c8d62c9ccc12de810c9b2e3dbc0574d124.memory.svg)
...
| 22 | VmAirWrapper<Rv64BaseAluWAdapterAir, ShiftRightArithmeticCoreAir<4, 8> |  | 29 | 49 | 3 | 
| 23 | VmAirWrapper<Rv64BaseAluWU16AdapterAir, ShiftLogicalCoreAir<2, 16> |  | 22 | 108 | 3 | 
| 24 | VmAirWrapper<Rv64BaseAluAdapterAir, ShiftRightArithmeticCoreAir<8, 8> |  | 38 | 104 | 3 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 71 |  |  |  | 342 |  |  |  |  |  |  | 
| app_proof |  |  |  | 3,071 |  | 98 | 11,167,961 | 113.23 | 0 | 8,441 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 333 | 119 | 0 | 0 | 110 | 34 | 34 | 53 | 21 | 0 | 103 | 89 | 13 | 3 | 9 | 120 | 119 | 110 | 0 | 4 | 20 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 173 | 48 | 0 | 0 | 69 | 26 | 25 | 28 | 14 | 0 | 54 | 46 | 8 | 1 | 6 | 48 | 48 | 69 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 142 | 32 | 0 | 0 | 67 | 27 | 26 | 25 | 14 | 0 | 42 | 35 | 7 | 1 | 5 | 33 | 32 | 67 | 0 | 2 | 13 | 0 | 0 | 
| leaf | 0 | prover | 237,929,016 | 914 | 381 | 0 | 0 | 234 | 112 | 111 | 69 | 52 | 0 | 298 | 260 | 38 | 20 | 17 | 381 | 381 | 234 | 0 | 10 | 51 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,286,242,554 | 4,728 | 1,353 | 0 | 0 | 2,472 | 1,366 | 1,366 | 500 | 604 | 1 | 902 | 687 | 215 | 135 | 79 | 1,353 | 1,353 | 2,472 | 0 | 5 | 602 | 0 | 0 | 
| app_proof | prover | 1 | 750,289,144 | 2,667 | 600 | 0 | 0 | 1,542 | 738 | 737 | 279 | 524 | 1 | 525 | 404 | 120 | 73 | 47 | 600 | 600 | 1,542 | 0 | 6 | 523 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 136 | 1 | 178 | 5,265 | 178 | 136 | 13,311,936,132 | 2,137,449,780 | 15,449,385,912 | 2,097,152 | 0 | 5 | 221 | 7,124,000 | 35.21 | 
| app_proof | 1 | 41 | 1 | 75 | 3,071 | 75 | 41 | 7,588,526,580 | 1,502,398,413 | 9,090,924,993 | 2,097,152 | 0 | 2 | 287 | 4,043,961 | 38.90 | 

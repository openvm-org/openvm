...
| `total_proof_time_ms ` |  4,131 |  8,262 |  5,217 |  3,045 |
...
| `execute_preflight_time_ms` |  272.50 |  545 |  303 |  242 |
| `execute_preflight_insn_mi/s` |  33.84 | -          |  35.71 |  31.97 |
| `trace_gen_time_ms   ` |  125 |  250 |  175 |  75 |
| `set_initial_memory_time_ms` |  89 |  178 |  137 |  41 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  3,643 |  7,286 |  4,661 |  2,625 |
| `prover.main_trace_commit_time_ms` |  957 |  1,914 |  1,324 |  590 |
| `prover.rap_constraints_time_ms` |  1,981 |  3,962 |  2,446 |  1,516 |
| `prover.openings_time_ms` |  703.50 |  1,407 |  889 |  518 |
| `prover.rap_constraints.logup_gkr_time_ms` |  552.50 |  1,105 |  590 |  515 |
| `prover.rap_constraints.round0_time_ms` |  1,046.50 |  2,093 |  1,363 |  730 |
| `prover.rap_constraints.mle_rounds_time_ms` |  381 |  762 |  492 |  270 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/7a71cdb160bf7034c022ac927555b4fa66d66edd/sha2_bench-7a71cdb160bf7034c022ac927555b4fa66d66edd.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 71 |  |  |  | 344 |  |  |  |  |  |  | 
| app_proof |  |  |  | 3,045 |  | 99 | 11,167,961 | 111.92 | 0 | 8,368 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 332 | 117 | 0 | 0 | 109 | 34 | 34 | 51 | 23 | 0 | 104 | 90 | 13 | 3 | 9 | 117 | 117 | 109 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 170 | 47 | 0 | 0 | 68 | 25 | 24 | 27 | 15 | 0 | 54 | 45 | 8 | 1 | 6 | 47 | 47 | 68 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 138 | 32 | 0 | 0 | 63 | 24 | 23 | 24 | 14 | 0 | 42 | 34 | 7 | 1 | 5 | 33 | 32 | 63 | 0 | 2 | 13 | 0 | 0 | 
| leaf | 0 | prover | 237,929,016 | 898 | 372 | 0 | 0 | 229 | 110 | 109 | 68 | 51 | 0 | 295 | 257 | 37 | 19 | 17 | 373 | 372 | 229 | 0 | 11 | 50 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,286,242,554 | 4,661 | 1,324 | 0 | 0 | 2,446 | 1,363 | 1,362 | 492 | 590 | 0 | 889 | 677 | 211 | 133 | 78 | 1,324 | 1,324 | 2,446 | 0 | 5 | 589 | 0 | 0 | 
| app_proof | prover | 1 | 750,289,144 | 2,625 | 589 | 0 | 0 | 1,516 | 730 | 729 | 270 | 515 | 0 | 518 | 401 | 117 | 70 | 46 | 590 | 589 | 1,516 | 0 | 6 | 514 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 137 | 1 | 175 | 5,217 | 175 | 137 | 13,311,936,132 | 2,137,449,780 | 15,449,385,912 | 2,097,152 | 0 | 3 | 242 | 7,124,000 | 31.97 | 
| app_proof | 1 | 41 | 1 | 75 | 3,045 | 75 | 41 | 7,588,526,580 | 1,502,398,413 | 9,090,924,993 | 2,097,152 | 0 | 2 | 303 | 4,043,961 | 35.71 | 

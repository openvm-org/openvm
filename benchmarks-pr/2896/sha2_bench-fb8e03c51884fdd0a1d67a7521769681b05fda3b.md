...
|:---|---:|---:|---:|
| Total |  10.18 |  7.09 |  7.09 |
| app_proof |  8.46 |  5.37 |  5.37 |
| leaf |  1.02 |  1.02 |  1.02 |
...
| `total_proof_time_ms ` |  4,182 |  8,364 |  5,273 |  3,091 |
| `compile_metered_time_ms` |  3 |  3 |  3 |  3 |
| `execute_metered_time_ms` |  100 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  111.37 | -          |  111.37 |  111.37 |
| `execute_preflight_insns` |  5,583,980.50 |  11,167,961 |  7,124,000 |  4,043,961 |
| `execute_preflight_time_ms` |  274.50 |  549 |  305 |  244 |
| `execute_preflight_insn_mi/s` |  33.24 | -          |  34.87 |  31.61 |
| `trace_gen_time_ms   ` |  125 |  250 |  175 |  75 |
| `set_initial_memory_time_ms` |  88.50 |  177 |  136 |  41 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  3,692 |  7,384 |  4,716 |  2,668 |
| `prover.main_trace_commit_time_ms` |  968.50 |  1,937 |  1,340 |  597 |
| `prover.rap_constraints_time_ms` |  2,011.50 |  4,023 |  2,477 |  1,546 |
| `prover.openings_time_ms` |  710.50 |  1,421 |  898 |  523 |
| `prover.rap_constraints.logup_gkr_time_ms` |  564 |  1,128 |  602 |  526 |
| `prover.rap_constraints.round0_time_ms` |  1,057.50 |  2,115 |  1,372 |  743 |
| `prover.rap_constraints.mle_rounds_time_ms` |  389.50 |  779 |  502 |  277 |
| `prover.openings.stacked_reduction_time_ms` |  168 |  336 |  217 |  119 |
| `prover.openings.stacked_reduction.round0_time_ms` |  104.50 |  209 |  137 |  72 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/fb8e03c51884fdd0a1d67a7521769681b05fda3b/sha2_bench-fb8e03c51884fdd0a1d67a7521769681b05fda3b.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 70 |  |  |  | 345 |  |  |  |  |  |  | 
| app_proof |  |  |  | 3,091 |  | 100 | 11,167,961 | 111.37 | 0 | 8,470 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 333 | 119 | 0 | 0 | 109 | 35 | 35 | 52 | 21 | 0 | 103 | 89 | 13 | 3 | 9 | 119 | 119 | 109 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 173 | 47 | 0 | 0 | 70 | 27 | 26 | 28 | 14 | 0 | 55 | 46 | 8 | 1 | 6 | 47 | 47 | 70 | 0 | 3 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 139 | 32 | 0 | 0 | 63 | 24 | 23 | 24 | 13 | 0 | 43 | 36 | 7 | 1 | 5 | 33 | 32 | 63 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 237,929,016 | 912 | 378 | 0 | 0 | 233 | 112 | 111 | 69 | 51 | 0 | 300 | 261 | 38 | 20 | 17 | 379 | 378 | 233 | 0 | 12 | 50 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,286,242,554 | 4,716 | 1,340 | 0 | 0 | 2,477 | 1,372 | 1,371 | 502 | 602 | 1 | 898 | 680 | 217 | 137 | 80 | 1,340 | 1,340 | 2,477 | 0 | 5 | 600 | 0 | 0 | 
| app_proof | prover | 1 | 750,289,144 | 2,668 | 597 | 0 | 0 | 1,546 | 743 | 742 | 277 | 526 | 0 | 523 | 403 | 119 | 72 | 47 | 597 | 597 | 1,546 | 0 | 7 | 524 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 136 | 1 | 175 | 5,273 | 175 | 136 | 13,311,936,132 | 2,137,449,780 | 15,449,385,912 | 2,097,152 | 0 | 3 | 244 | 7,124,000 | 31.61 | 
| app_proof | 1 | 41 | 1 | 75 | 3,091 | 75 | 41 | 7,588,526,580 | 1,502,398,413 | 9,090,924,993 | 2,097,152 | 0 | 2 | 305 | 4,043,961 | 34.87 | 

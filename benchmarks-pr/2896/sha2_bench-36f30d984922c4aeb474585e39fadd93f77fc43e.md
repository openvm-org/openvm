...
|:---|---:|---:|---:|
| Total |  9.98 |  6.97 |  6.97 |
| app_proof |  8.30 |  5.29 |  5.29 |
| leaf |  1.01 |  1.01 |  1.01 |
...
| `total_proof_time_ms ` |  4,098.50 |  8,197 |  5,186 |  3,011 |
...
| `execute_preflight_insn_mi/s` |  37.06 | -          |  39.07 |  35.04 |
| `trace_gen_time_ms   ` |  125.50 |  251 |  176 |  75 |
| `set_initial_memory_time_ms` |  88 |  176 |  135 |  41 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  3,635.50 |  7,271 |  4,652 |  2,619 |
| `prover.main_trace_commit_time_ms` |  959.50 |  1,919 |  1,328 |  591 |
| `prover.rap_constraints_time_ms` |  1,968 |  3,936 |  2,427 |  1,509 |
| `prover.openings_time_ms` |  707 |  1,414 |  896 |  518 |
| `prover.rap_constraints.logup_gkr_time_ms` |  553.50 |  1,107 |  594 |  513 |
| `prover.rap_constraints.round0_time_ms` |  1,032 |  2,064 |  1,343 |  721 |
| `prover.rap_constraints.mle_rounds_time_ms` |  381 |  762 |  489 |  273 |
| `prover.openings.stacked_reduction_time_ms` |  165.50 |  331 |  213 |  118 |
...
| `prover.openings.whir_time_ms` |  541 |  1,082 |  682 |  400 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/36f30d984922c4aeb474585e39fadd93f77fc43e/sha2_bench-36f30d984922c4aeb474585e39fadd93f77fc43e.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 79 |  |  |  | 359 |  |  |  |  |  |  | 
| app_proof |  |  |  | 3,011 |  | 99 | 11,167,961 | 112.20 | 0 | 8,302 |  | 
...
| leaf | 0 | 107 | 1,006 | 107 | 34 | 17 | 2 | 7 | 7 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 329 | 118 | 0 | 0 | 110 | 35 | 34 | 52 | 22 | 0 | 100 | 87 | 13 | 3 | 9 | 118 | 118 | 110 | 0 | 3 | 20 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 169 | 48 | 0 | 0 | 68 | 25 | 24 | 28 | 15 | 0 | 52 | 44 | 8 | 1 | 6 | 48 | 48 | 68 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 138 | 31 | 0 | 0 | 63 | 24 | 23 | 24 | 13 | 0 | 42 | 35 | 7 | 1 | 5 | 32 | 31 | 63 | 0 | 3 | 13 | 0 | 0 | 
| leaf | 0 | prover | 237,929,016 | 898 | 375 | 0 | 0 | 228 | 108 | 107 | 66 | 52 | 0 | 294 | 256 | 37 | 19 | 17 | 375 | 375 | 228 | 0 | 11 | 50 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,286,242,554 | 4,652 | 1,328 | 0 | 0 | 2,427 | 1,343 | 1,342 | 489 | 594 | 0 | 896 | 682 | 213 | 133 | 80 | 1,328 | 1,328 | 2,427 | 0 | 5 | 592 | 0 | 0 | 
| app_proof | prover | 1 | 750,289,144 | 2,619 | 591 | 0 | 0 | 1,509 | 721 | 721 | 273 | 513 | 0 | 518 | 400 | 118 | 71 | 46 | 591 | 591 | 1,509 | 0 | 6 | 512 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 135 | 2 | 176 | 5,186 | 176 | 135 | 13,311,936,132 | 2,137,449,780 | 15,449,385,912 | 2,097,152 | 0 | 4 | 221 | 7,124,000 | 35.04 | 
| app_proof | 1 | 41 | 1 | 75 | 3,011 | 75 | 41 | 7,588,526,580 | 1,502,398,413 | 9,090,924,993 | 2,097,152 | 0 | 2 | 274 | 4,043,961 | 39.07 | 

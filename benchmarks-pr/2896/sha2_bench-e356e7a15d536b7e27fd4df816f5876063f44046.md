...
|:---|---:|---:|---:|
| Total |  10.09 |  7.03 |  7.03 |
| app_proof |  8.38 |  5.33 |  5.33 |
| leaf |  1.01 |  1.01 |  1.01 |
...
| `total_proof_time_ms ` |  4,142 |  8,284 |  5,228 |  3,056 |
...
| `execute_preflight_time_ms` |  251.50 |  503 |  284 |  219 |
| `execute_preflight_insn_mi/s` |  37.34 | -          |  39.27 |  35.40 |
...
| `prover.main_trace_commit_time_ms` |  968 |  1,936 |  1,339 |  597 |
| `prover.rap_constraints_time_ms` |  1,992 |  3,984 |  2,451 |  1,533 |
| `prover.openings_time_ms` |  712 |  1,424 |  902 |  522 |
| `prover.rap_constraints.logup_gkr_time_ms` |  562 |  1,124 |  601 |  523 |
| `prover.rap_constraints.round0_time_ms` |  1,042 |  2,084 |  1,351 |  733 |
...
| `prover.openings.whir_time_ms` |  543.50 |  1,087 |  686 |  401 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/e356e7a15d536b7e27fd4df816f5876063f44046/sha2_bench-e356e7a15d536b7e27fd4df816f5876063f44046.memory.svg)
...
| 23 | VmAirWrapper<Rv64BaseAluWU16AdapterAir, ShiftLogicalU16CoreAir<2, 16> |  | 22 | 108 | 3 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 72 |  |  |  | 361 |  |  |  |  |  |  | 
| app_proof |  |  |  | 3,056 |  | 99 | 11,167,961 | 112.07 | 0 | 8,389 |  | 
...
| app_proof | VmAirWrapper<Rv64BaseAluWU16AdapterAir, ShiftLogicalU16CoreAir<2, 16> | 14 | VmAirWrapper<Rv64BaseAluWU16AdapterAir, ShiftLogicalU16CoreAir<2, 16> | 0 | 68 | 
...
| app_proof | VmAirWrapper<Rv64BaseAluWU16AdapterAir, ShiftLogicalU16CoreAir<2, 16> | 14 | VmAirWrapper<Rv64BaseAluWU16AdapterAir, ShiftLogicalU16CoreAir<2, 16> | 1 | 204 | 
...
| app_proof | VmAirWrapper<Rv64LoadStoreAdapterAir, LoadStoreCoreAir<8> | 0 | 18 | 32 | 
...
| app_proof | VmAirWrapper<Rv64BaseAluWU16AdapterAir, ShiftLogicalU16CoreAir<2, 16> | 1 |  | 0 | 
...
| app_proof | 23 | VmAirWrapper<Rv64BaseAluWU16AdapterAir, ShiftLogicalU16CoreAir<2, 16> | SRLW | 0 | 1 | 
...
| app_proof | 23 | VmAirWrapper<Rv64BaseAluWU16AdapterAir, ShiftLogicalU16CoreAir<2, 16> | SLLW | 1 | 1 | 
| app_proof | 23 | VmAirWrapper<Rv64BaseAluWU16AdapterAir, ShiftLogicalU16CoreAir<2, 16> | SRLW | 1 | 2 | 
...
| app_proof | 23 | VmAirWrapper<Rv64BaseAluWU16AdapterAir, ShiftLogicalU16CoreAir<2, 16> | prover | 0 | 1 | 59 | 59 | 
...
| app_proof | 23 | VmAirWrapper<Rv64BaseAluWU16AdapterAir, ShiftLogicalU16CoreAir<2, 16> | prover | 1 | 4 | 59 | 236 | 
...
| app_proof | 23 | VmAirWrapper<Rv64BaseAluWU16AdapterAir, ShiftLogicalU16CoreAir<2, 16> | 0 | 1 |  | 148 |  | 236 |  | 59 |  | 798 |  | 22 |  | 
...
| app_proof | 23 | VmAirWrapper<Rv64BaseAluWU16AdapterAir, ShiftLogicalU16CoreAir<2, 16> | 1 | 3 | 1 | 443 | 147 | 708 | 236 | 177 | 59 | 2,393 | 797 | 66 | 22 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 332 | 122 | 0 | 0 | 108 | 34 | 34 | 52 | 20 | 0 | 101 | 87 | 13 | 3 | 9 | 123 | 122 | 108 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 169 | 47 | 0 | 0 | 68 | 25 | 24 | 28 | 14 | 0 | 54 | 45 | 8 | 1 | 6 | 47 | 47 | 68 | 0 | 3 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 142 | 32 | 0 | 0 | 62 | 23 | 22 | 24 | 13 | 0 | 47 | 39 | 7 | 1 | 5 | 32 | 32 | 62 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 237,929,016 | 906 | 378 | 0 | 0 | 230 | 111 | 110 | 67 | 51 | 0 | 297 | 259 | 38 | 20 | 17 | 378 | 378 | 230 | 0 | 11 | 51 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,286,242,554 | 4,693 | 1,338 | 0 | 0 | 2,451 | 1,351 | 1,351 | 498 | 601 | 0 | 902 | 686 | 216 | 136 | 80 | 1,339 | 1,338 | 2,451 | 0 | 5 | 600 | 0 | 0 | 
| app_proof | prover | 1 | 750,289,144 | 2,654 | 597 | 0 | 0 | 1,533 | 733 | 732 | 276 | 523 | 0 | 522 | 401 | 120 | 73 | 47 | 597 | 597 | 1,533 | 0 | 6 | 522 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 136 | 2 | 178 | 5,228 | 178 | 136 | 13,311,936,132 | 2,137,449,780 | 15,449,385,912 | 2,097,152 | 0 | 4 | 219 | 7,124,000 | 35.40 | 
| app_proof | 1 | 41 | 1 | 75 | 3,056 | 75 | 41 | 7,588,526,580 | 1,502,398,413 | 9,090,924,993 | 2,097,152 | 0 | 2 | 284 | 4,043,961 | 39.27 | 

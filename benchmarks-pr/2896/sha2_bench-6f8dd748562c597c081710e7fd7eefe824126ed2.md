...
| `total_proof_time_ms ` |  4,077.50 |  8,155 |  5,152 |  3,003 |
...
| `execute_preflight_time_ms` |  258.50 |  517 |  294 |  223 |
| `execute_preflight_insn_mi/s` |  36.83 | -          |  38.74 |  34.93 |
| `trace_gen_time_ms   ` |  127.50 |  255 |  180 |  75 |
| `set_initial_memory_time_ms` |  89.50 |  179 |  138 |  41 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  3,600.50 |  7,201 |  4,609 |  2,592 |
| `prover.main_trace_commit_time_ms` |  957 |  1,914 |  1,329 |  585 |
| `prover.rap_constraints_time_ms` |  1,940.50 |  3,881 |  2,390 |  1,491 |
| `prover.openings_time_ms` |  701.50 |  1,403 |  889 |  514 |
| `prover.rap_constraints.logup_gkr_time_ms` |  547 |  1,094 |  589 |  505 |
| `prover.rap_constraints.round0_time_ms` |  1,017.50 |  2,035 |  1,317 |  718 |
| `prover.rap_constraints.mle_rounds_time_ms` |  375 |  750 |  483 |  267 |
| `prover.openings.stacked_reduction_time_ms` |  163.50 |  327 |  210 |  117 |
| `prover.openings.stacked_reduction.round0_time_ms` |  100.50 |  201 |  130 |  71 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  62.50 |  125 |  79 |  46 |
| `prover.openings.whir_time_ms` |  537.50 |  1,075 |  678 |  397 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/6f8dd748562c597c081710e7fd7eefe824126ed2/sha2_bench-6f8dd748562c597c081710e7fd7eefe824126ed2.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 70 |  |  |  | 346 |  |  |  |  |  |  | 
| app_proof |  |  |  | 3,003 |  | 98 | 11,167,961 | 113.31 | 0 | 8,260 |  | 
...
| leaf | 0 | 114 | 997 | 114 | 35 | 17 | 2 | 7 | 7 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 321 | 117 | 0 | 0 | 105 | 33 | 33 | 52 | 20 | 0 | 97 | 83 | 13 | 3 | 9 | 118 | 117 | 105 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 166 | 45 | 0 | 0 | 67 | 24 | 23 | 28 | 14 | 0 | 52 | 43 | 8 | 1 | 6 | 46 | 45 | 67 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 139 | 32 | 0 | 0 | 63 | 24 | 23 | 24 | 14 | 0 | 43 | 36 | 7 | 1 | 5 | 33 | 32 | 63 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 237,929,016 | 883 | 370 | 0 | 0 | 226 | 107 | 106 | 67 | 51 | 0 | 286 | 249 | 37 | 19 | 17 | 370 | 370 | 226 | 0 | 9 | 49 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,286,242,554 | 4,609 | 1,329 | 0 | 0 | 2,390 | 1,317 | 1,316 | 483 | 589 | 1 | 889 | 678 | 210 | 130 | 79 | 1,329 | 1,329 | 2,390 | 0 | 4 | 587 | 0 | 0 | 
| app_proof | prover | 1 | 750,289,144 | 2,592 | 585 | 0 | 0 | 1,491 | 718 | 717 | 267 | 505 | 0 | 514 | 397 | 117 | 71 | 46 | 585 | 585 | 1,491 | 0 | 5 | 503 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 138 | 1 | 180 | 5,152 | 180 | 138 | 13,311,936,132 | 2,137,449,780 | 15,449,385,912 | 2,097,152 | 0 | 4 | 223 | 7,124,000 | 34.93 | 
| app_proof | 1 | 41 | 1 | 75 | 3,003 | 75 | 41 | 7,588,526,580 | 1,502,398,413 | 9,090,924,993 | 2,097,152 | 0 | 2 | 294 | 4,043,961 | 38.74 | 

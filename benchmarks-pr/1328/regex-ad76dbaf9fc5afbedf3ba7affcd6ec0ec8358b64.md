...
|:---|---:|---:|
| Total | <span style='color: green'>(-0 [-0.9%])</span> 14.76 | <span style='color: green'>(-0 [-1.0%])</span> 8.25 |
| regex_program | <span style='color: green'>(-0 [-0.9%])</span> 14.76 | <span style='color: green'>(-0 [-1.0%])</span> 8.25 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: green'>(-68 [-0.9%])</span> 7,380 | <span style='color: green'>(-135 [-0.9%])</span> 14,760 | <span style='color: green'>(-86 [-1.0%])</span> 8,248 | <span style='color: green'>(-49 [-0.7%])</span> 6,512 |
| `main_cells_used     ` |  82,727,686.50 |  165,455,373 |  92,686,348 |  72,769,025 |
| `total_cycles        ` |  1,914,103 |  1,914,103 |  1,914,103 |  1,914,103 |
| `execute_time_ms     ` | <span style='color: red'>(+1 [+0.2%])</span> 450.50 | <span style='color: red'>(+2 [+0.2%])</span> 901 | <span style='color: red'>(+2 [+0.4%])</span> 485 |  416 |
| `trace_gen_time_ms   ` | <span style='color: green'>(-23 [-1.6%])</span> 1,427 | <span style='color: green'>(-46 [-1.6%])</span> 2,854 | <span style='color: green'>(-22 [-1.4%])</span> 1,589 | <span style='color: green'>(-24 [-1.9%])</span> 1,265 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: green'>(-46 [-0.8%])</span> 5,502.50 | <span style='color: green'>(-91 [-0.8%])</span> 11,005 | <span style='color: green'>(-66 [-1.1%])</span> 6,174 | <span style='color: green'>(-25 [-0.5%])</span> 4,831 |
| `main_trace_commit_time_ms` | <span style='color: green'>(-14 [-1.3%])</span> 1,102.50 | <span style='color: green'>(-28 [-1.3%])</span> 2,205 | <span style='color: green'>(-12 [-0.9%])</span> 1,329 | <span style='color: green'>(-16 [-1.8%])</span> 876 |
| `generate_perm_trace_time_ms` | <span style='color: green'>(-10 [-5.8%])</span> 169 | <span style='color: green'>(-21 [-5.8%])</span> 338 | <span style='color: green'>(-6 [-3.1%])</span> 188 | <span style='color: green'>(-15 [-9.1%])</span> 150 |
| `perm_trace_commit_time_ms` | <span style='color: green'>(-20 [-1.6%])</span> 1,171.50 | <span style='color: green'>(-39 [-1.6%])</span> 2,343 | <span style='color: green'>(-14 [-1.1%])</span> 1,238 | <span style='color: green'>(-25 [-2.2%])</span> 1,105 |
| `quotient_poly_compute_time_ms` |  739 |  1,478 | <span style='color: green'>(-7 [-0.8%])</span> 852 | <span style='color: red'>(+6 [+1.0%])</span> 626 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+2 [+0.2%])</span> 980.50 | <span style='color: red'>(+4 [+0.2%])</span> 1,961 | <span style='color: green'>(-12 [-1.0%])</span> 1,132 | <span style='color: red'>(+16 [+2.0%])</span> 829 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,589 | 8,248 |  | 209,921,543 | 6,174 | 852 | 1,132 | 1,238 | 1,427 | 1,329 | 92,686,348 | 188 | 485 | 
| regex_program | 1 | 1,265 | 6,512 | 1,914,103 | 149,454,692 | 4,831 | 626 | 829 | 1,105 | 1,223 | 876 | 72,769,025 | 150 | 416 | 

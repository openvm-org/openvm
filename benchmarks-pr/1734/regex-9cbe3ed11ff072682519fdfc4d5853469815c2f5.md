...
| `total_proof_time_ms ` |  3,779.50 |  7,559 |  4,080 |  3,479 |
| `main_cells_used     ` |  83,259,728 |  166,519,456 |  93,502,324 |  73,017,132 |
| `total_cycles        ` |  2,082,716 |  4,165,432 |  2,243,700 |  1,921,732 |
| `execute_metered_time_ms` |  511 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  8.14 | -          | -          | -          |
| `execute_e3_time_ms  ` |  230.50 |  461 |  250 |  211 |
| `execute_e3_insn_mi/s` |  9.03 | -          |  9.10 |  8.95 |
| `trace_gen_time_ms   ` |  902 |  1,804 |  999 |  805 |
| `memory_finalize_time_ms` |  634 |  1,268 |  699 |  569 |
| `boundary_finalize_time_ms` |  3 |  6 |  6 |  0 |
| `merkle_finalize_time_ms` |  621 |  1,242 |  677 |  565 |
| `stark_prove_excluding_trace_time_ms` |  2,647 |  5,294 |  2,831 |  2,463 |
| `main_trace_commit_time_ms` |  533 |  1,066 |  577 |  489 |
| `generate_perm_trace_time_ms` |  216.50 |  433 |  226 |  207 |
| `perm_trace_commit_time_ms` |  558 |  1,116 |  595 |  521 |
| `quotient_poly_compute_time_ms` |  269.50 |  539 |  295 |  244 |
| `quotient_poly_commit_time_ms` |  249 |  498 |  285 |  213 |
| `pcs_opening_time_ms ` |  813 |  1,626 |  847 |  779 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  5,992.50 |  11,985 |  7,672 |  4,313 |
| `main_cells_used     ` |  114,460,159.50 |  228,920,319 |  146,196,233 |  82,724,086 |
| `total_cycles        ` |  1,674,602.50 |  3,349,205 |  1,867,766 |  1,481,439 |
| `execute_metered_time_ms` |  1,112 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  1.82 | -          | -          | -          |
| `execute_e3_time_ms  ` |  671.50 |  1,343 |  778 |  565 |
| `execute_e3_insn_mi/s` |  2.51 | -          |  2.62 |  2.40 |
| `trace_gen_time_ms   ` |  373.50 |  747 |  451 |  296 |
| `memory_finalize_time_ms` |  96.50 |  193 |  119 |  74 |
| `boundary_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  3,835.50 |  7,671 |  4,815 |  2,856 |
| `main_trace_commit_time_ms` |  726.50 |  1,453 |  871 |  582 |
| `generate_perm_trace_time_ms` |  319 |  638 |  412 |  226 |
| `perm_trace_commit_time_ms` |  975.50 |  1,951 |  1,278 |  673 |
| `quotient_poly_compute_time_ms` |  417 |  834 |  514 |  320 |
| `quotient_poly_commit_time_ms` |  340 |  680 |  422 |  258 |
| `pcs_opening_time_ms ` |  1,051.50 |  2,103 |  1,311 |  792 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf |  | 1 |  |  | 1 |  |  |  | 
| regex_program | 2 |  | 549 | 4,165,433 | 1 | 511 | 8.14 | 21 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 296 | 4,313 | 1,481,439 | 319,626,730 | 2,856 | 320 | 258 | 673 | 792 | 74 | 582 | 82,724,086 | 1,481,440 | 226 | 596 | 2.48 | 565 | 2.62 | 0 | 
| leaf | 1 | 451 | 7,672 | 1,867,766 | 538,660,330 | 4,815 | 514 | 422 | 1,278 | 1,311 | 119 | 871 | 146,196,233 | 1,867,767 | 412 | 1,628 | 1.15 | 778 | 2.40 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 999 | 4,080 | 2,243,700 | 275,648,700 | 2,831 | 295 | 285 | 595 | 847 | 677 | 699 | 577 | 93,502,324 | 2,243,700 | 226 | 250 | 8.95 | 6 | 
| regex_program | 1 | 805 | 3,479 | 1,921,732 | 242,975,388 | 2,463 | 244 | 213 | 521 | 779 | 565 | 569 | 489 | 73,017,132 | 1,921,733 | 207 | 211 | 9.10 | 0 | 

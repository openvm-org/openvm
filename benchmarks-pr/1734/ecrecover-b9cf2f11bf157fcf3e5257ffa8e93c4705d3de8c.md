...
|:---|---:|---:|
| Total | <span style='color: red'>(+39 [+331.9%])</span> 50.75 | <span style='color: red'>(+39 [+331.9%])</span> 50.75 |
| ecrecover_program | <span style='color: red'>(+39 [+3400.7%])</span> 40.15 | <span style='color: red'>(+39 [+3400.7%])</span> 40.15 |
| leaf |  10.52 |  10.52 |
...
| `total_proof_time_ms ` | <span style='color: red'>(+39006 [+3400.7%])</span> 40,153 | <span style='color: red'>(+39006 [+3400.7%])</span> 40,153 | <span style='color: red'>(+39006 [+3400.7%])</span> 40,153 | <span style='color: red'>(+39006 [+3400.7%])</span> 40,153 |
...
| `execute_metered_insn_mi/s` | <span style='color: red'>(+0 [+1.6%])</span> 1.64 | -          | -          | -          |
...
| `execute_e3_insn_mi/s` | <span style='color: red'>(+0 [+8.7%])</span> 1.57 | -          | <span style='color: red'>(+0 [+8.7%])</span> 1.57 | <span style='color: red'>(+0 [+8.7%])</span> 1.57 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+39033 [+33941.7%])</span> 39,148 | <span style='color: red'>(+39033 [+33941.7%])</span> 39,148 | <span style='color: red'>(+39033 [+33941.7%])</span> 39,148 | <span style='color: red'>(+39033 [+33941.7%])</span> 39,148 |
| `memory_finalize_time_ms` | <span style='color: red'>(+38803 [+73213.2%])</span> 38,856 | <span style='color: red'>(+38803 [+73213.2%])</span> 38,856 | <span style='color: red'>(+38803 [+73213.2%])</span> 38,856 | <span style='color: red'>(+38803 [+73213.2%])</span> 38,856 |
...
| `merkle_finalize_time_ms` | <span style='color: red'>(+38576 [+87672.7%])</span> 38,620 | <span style='color: red'>(+38576 [+87672.7%])</span> 38,620 | <span style='color: red'>(+38576 [+87672.7%])</span> 38,620 | <span style='color: red'>(+38576 [+87672.7%])</span> 38,620 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: green'>(-19 [-2.0%])</span> 918 | <span style='color: green'>(-19 [-2.0%])</span> 918 | <span style='color: green'>(-19 [-2.0%])</span> 918 | <span style='color: green'>(-19 [-2.0%])</span> 918 |
| `main_trace_commit_time_ms` | <span style='color: green'>(-9 [-6.6%])</span> 127 | <span style='color: green'>(-9 [-6.6%])</span> 127 | <span style='color: green'>(-9 [-6.6%])</span> 127 | <span style='color: green'>(-9 [-6.6%])</span> 127 |
...
| `perm_trace_commit_time_ms` | <span style='color: green'>(-9 [-6.9%])</span> 121 | <span style='color: green'>(-9 [-6.9%])</span> 121 | <span style='color: green'>(-9 [-6.9%])</span> 121 | <span style='color: green'>(-9 [-6.9%])</span> 121 |
| `quotient_poly_compute_time_ms` |  79 |  79 |  79 |  79 |
| `quotient_poly_commit_time_ms` | <span style='color: green'>(-5 [-3.8%])</span> 127 | <span style='color: green'>(-5 [-3.8%])</span> 127 | <span style='color: green'>(-5 [-3.8%])</span> 127 | <span style='color: green'>(-5 [-3.8%])</span> 127 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+1 [+0.2%])</span> 418 | <span style='color: red'>(+1 [+0.2%])</span> 418 | <span style='color: red'>(+1 [+0.2%])</span> 418 | <span style='color: red'>(+1 [+0.2%])</span> 418 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  10,519 |  10,519 |  10,519 |  10,519 |
| `main_cells_used     ` |  241,888,658 |  241,888,658 |  241,888,658 |  241,888,658 |
| `total_cycles        ` |  2,934,908 |  2,934,908 |  2,934,908 |  2,934,908 |
| `execute_metered_time_ms` |  813 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  3.61 | -          | -          | -          |
| `execute_e3_time_ms  ` |  1,031 |  1,031 |  1,031 |  1,031 |
| `execute_e3_insn_mi/s` |  2.84 | -          |  2.84 |  2.84 |
| `trace_gen_time_ms   ` |  795 |  795 |  795 |  795 |
| `memory_finalize_time_ms` |  227 |  227 |  227 |  227 |
| `boundary_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  7,880 |  7,880 |  7,880 |  7,880 |
| `main_trace_commit_time_ms` |  1,430 |  1,430 |  1,430 |  1,430 |
| `generate_perm_trace_time_ms` |  675 |  675 |  675 |  675 |
| `perm_trace_commit_time_ms` |  2,060 |  2,060 |  2,060 |  2,060 |
| `quotient_poly_compute_time_ms` |  898 |  898 |  898 |  898 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 1 |  | 905 | 137,261 | 1 | 83 | 1.64 | 9 | 
| leaf |  | 1 |  |  | 1 |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 795 | 10,519 | 2,934,908 | 992,054,762 | 7,880 | 898 | 624 | 2,060 | 2,187 | 227 | 1,430 | 241,888,658 | 2,934,909 | 675 | 813 | 3.61 | 1,031 | 2.84 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 39,148 | 40,153 | 137,260 | 32,925,330 | 918 | 79 | 127 | 121 | 418 | 38,620 | 38,856 | 127 | 8,151,353 | 137,261 | 30 | 87 | 1.57 | 0 | 

...
| `total_proof_time_ms ` |  1,545 |  1,545 |  1,545 |  1,545 |
...
| `execute_e3_insn_mi/s` |  1.53 | -          |  1.53 |  1.53 |
| `trace_gen_time_ms   ` |  528 |  528 |  528 |  528 |
| `memory_finalize_time_ms` |  477 |  477 |  477 |  477 |
| `boundary_finalize_time_ms` |  1 |  1 |  1 |  1 |
| `merkle_finalize_time_ms` |  472 |  472 |  472 |  472 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  11,995 |  11,995 |  11,995 |  11,995 |
| `main_cells_used     ` |  241,887,890 |  241,887,890 |  241,887,890 |  241,887,890 |
| `total_cycles        ` |  2,934,844 |  2,934,844 |  2,934,844 |  2,934,844 |
| `execute_metered_time_ms` |  2,123 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  1.38 | -          | -          | -          |
| `execute_e3_time_ms  ` |  1,127 |  1,127 |  1,127 |  1,127 |
| `execute_e3_insn_mi/s` |  2.60 | -          |  2.60 |  2.60 |
| `trace_gen_time_ms   ` |  683 |  683 |  683 |  683 |
| `memory_finalize_time_ms` |  127 |  127 |  127 |  127 |
| `boundary_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  8,062 |  8,062 |  8,062 |  8,062 |
| `main_trace_commit_time_ms` |  1,498 |  1,498 |  1,498 |  1,498 |
| `generate_perm_trace_time_ms` |  792 |  792 |  792 |  792 |
| `perm_trace_commit_time_ms` |  2,068 |  2,068 |  2,068 |  2,068 |
| `quotient_poly_compute_time_ms` |  912 |  912 |  912 |  912 |
| `quotient_poly_commit_time_ms` |  619 |  619 |  619 |  619 |
| `pcs_opening_time_ms ` |  2,169 |  2,169 |  2,169 |  2,169 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 1 |  | 903 | 137,261 | 1 | 89 | 1.54 | 9 | 
| leaf |  | 1 |  |  | 1 |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 683 | 11,995 | 2,934,844 | 992,054,762 | 8,062 | 912 | 619 | 2,068 | 2,169 | 127 | 1,498 | 241,887,890 | 2,934,845 | 792 | 2,123 | 1.38 | 1,127 | 2.60 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 528 | 1,545 | 137,260 | 32,925,330 | 928 | 82 | 132 | 127 | 413 | 472 | 477 | 124 | 8,151,353 | 137,261 | 33 | 89 | 1.53 | 1 | 

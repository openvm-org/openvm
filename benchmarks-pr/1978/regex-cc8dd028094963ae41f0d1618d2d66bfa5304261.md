...
| `total_proof_time_ms ` |  3,839.50 |  7,679 |  4,963 |  2,716 |
...
| `execute_metered_insn_mi/s` |  124.41 | -          |  124.41 |  124.41 |
| `execute_preflight_insns` |  2,054,298.50 |  4,108,597 |  2,211,000 |  1,897,597 |
| `execute_preflight_time_ms` |  94 |  188 |  102 |  86 |
| `execute_preflight_insn_mi/s` |  28.57 | -          |  31.02 |  26.12 |
| `trace_gen_time_ms   ` |  394.50 |  789 |  511 |  278 |
| `memory_finalize_time_ms` |  8 |  16 |  14 |  2 |
| `stark_prove_excluding_trace_time_ms` |  3,119.50 |  6,239 |  4,107 |  2,132 |
| `main_trace_commit_time_ms` |  614 |  1,228 |  841 |  387 |
| `generate_perm_trace_time_ms` |  234 |  468 |  303 |  165 |
| `perm_trace_commit_time_ms` |  653 |  1,306 |  858 |  448 |
| `quotient_poly_compute_time_ms` |  324 |  648 |  436 |  212 |
| `quotient_poly_commit_time_ms` |  295 |  590 |  395 |  195 |
| `pcs_opening_time_ms ` |  991 |  1,982 |  1,268 |  714 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 1 | 2,716 | 7 | 1 | 33 | 4,108,597 | 124.41 | 46 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 511 | 4,963 | 211,758,557 | 373,183,036 | 511 | 4,107 | 0 | 436 | 395 | 858 | 1,268 | 9 | 14 | 841 | 91,281,687 | 303 | 102 | 2,211,000 | 26.12 | 
| regex_program | 1 | 278 | 2,716 | 174,326,267 | 196,838,026 | 278 | 2,132 | 52 | 212 | 195 | 448 | 714 | 6 | 2 | 387 | 73,453,305 | 165 | 86 | 1,897,597 | 31.02 | 

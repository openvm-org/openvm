...
|:---|---:|---:|
| Total |  7.68 |  4.96 |
| regex_program |  7.64 |  4.93 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  3,822.50 |  7,645 |  4,926 |  2,719 |
...
| `execute_metered_insn_mi/s` |  122.76 | -          |  122.76 |  122.76 |
| `execute_preflight_insns` |  2,054,298.50 |  4,108,597 |  2,211,000 |  1,897,597 |
| `execute_preflight_time_ms` |  93.50 |  187 |  101 |  86 |
| `execute_preflight_insn_mi/s` |  28.68 | -          |  31.11 |  26.24 |
| `trace_gen_time_ms   ` |  403 |  806 |  520 |  286 |
| `memory_finalize_time_ms` |  8 |  16 |  14 |  2 |
| `stark_prove_excluding_trace_time_ms` |  3,100 |  6,200 |  4,065 |  2,135 |
| `main_trace_commit_time_ms` |  614 |  1,228 |  836 |  392 |
| `generate_perm_trace_time_ms` |  235 |  470 |  320 |  150 |
| `perm_trace_commit_time_ms` |  660 |  1,320 |  851 |  469 |
| `quotient_poly_compute_time_ms` |  323 |  646 |  440 |  206 |
| `quotient_poly_commit_time_ms` |  299.50 |  599 |  403 |  196 |
| `pcs_opening_time_ms ` |  961.50 |  1,923 |  1,209 |  714 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 1 | 2,719 | 6 | 1 | 33 | 4,108,597 | 122.76 | 45 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 520 | 4,926 | 211,758,557 | 373,183,036 | 520 | 4,065 | 0 | 440 | 403 | 851 | 1,209 | 9 | 14 | 836 | 91,281,687 | 320 | 101 | 2,211,000 | 26.24 | 
| regex_program | 1 | 286 | 2,719 | 174,326,267 | 196,838,026 | 286 | 2,135 | 54 | 206 | 196 | 469 | 714 | 6 | 2 | 392 | 73,453,305 | 150 | 86 | 1,897,597 | 31.11 | 

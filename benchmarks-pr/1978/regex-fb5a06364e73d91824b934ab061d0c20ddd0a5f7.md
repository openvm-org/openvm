...
|:---|---:|---:|
| Total |  7.72 |  4.95 |
| regex_program |  7.69 |  4.92 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  3,843.50 |  7,687 |  4,915 |  2,772 |
...
| `execute_preflight_time_ms` |  94.50 |  189 |  102 |  87 |
| `execute_preflight_insn_mi/s` |  28.43 | -          |  30.97 |  25.89 |
| `trace_gen_time_ms   ` |  406.50 |  813 |  521 |  292 |
| `memory_finalize_time_ms` |  7.50 |  15 |  13 |  2 |
| `stark_prove_excluding_trace_time_ms` |  3,112 |  6,224 |  4,047 |  2,177 |
| `main_trace_commit_time_ms` |  626 |  1,252 |  841 |  411 |
| `generate_perm_trace_time_ms` |  231.50 |  463 |  300 |  163 |
| `perm_trace_commit_time_ms` |  650.50 |  1,301 |  850 |  451 |
| `quotient_poly_compute_time_ms` |  321 |  642 |  436 |  206 |
| `quotient_poly_commit_time_ms` |  305 |  610 |  399 |  211 |
| `pcs_opening_time_ms ` |  970.50 |  1,941 |  1,216 |  725 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 1 | 2,772 | 6 | 1 | 33 | 4,108,597 | 123.82 | 45 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 521 | 4,915 | 211,758,557 | 373,183,036 | 521 | 4,047 | 0 | 436 | 399 | 850 | 1,216 | 7 | 13 | 841 | 91,281,687 | 300 | 102 | 2,211,000 | 25.89 | 
| regex_program | 1 | 292 | 2,772 | 174,326,267 | 196,838,026 | 292 | 2,177 | 56 | 206 | 211 | 451 | 725 | 6 | 2 | 411 | 73,453,305 | 163 | 87 | 1,897,597 | 30.97 | 

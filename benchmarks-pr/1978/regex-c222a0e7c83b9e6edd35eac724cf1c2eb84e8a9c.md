...
|:---|---:|---:|
| Total |  7.78 |  4.96 |
| regex_program |  7.75 |  4.92 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  3,872.50 |  7,745 |  4,922 |  2,823 |
...
| `execute_metered_insn_mi/s` |  124.24 | -          |  124.24 |  124.24 |
| `execute_preflight_insns` |  2,054,298.50 |  4,108,597 |  2,211,000 |  1,897,597 |
| `execute_preflight_time_ms` |  97 |  194 |  105 |  89 |
| `execute_preflight_insn_mi/s` |  28.56 | -          |  30.99 |  26.14 |
| `trace_gen_time_ms   ` |  406 |  812 |  520 |  292 |
| `memory_finalize_time_ms` |  8 |  16 |  14 |  2 |
| `stark_prove_excluding_trace_time_ms` |  3,138 |  6,276 |  4,056 |  2,220 |
| `main_trace_commit_time_ms` |  630 |  1,260 |  848 |  412 |
| `generate_perm_trace_time_ms` |  238 |  476 |  306 |  170 |
| `perm_trace_commit_time_ms` |  671 |  1,342 |  850 |  492 |
| `quotient_poly_compute_time_ms` |  320 |  640 |  435 |  205 |
| `quotient_poly_commit_time_ms` |  301 |  602 |  406 |  196 |
| `pcs_opening_time_ms ` |  970 |  1,940 |  1,207 |  733 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 1 | 2,823 | 6 | 1 | 33 | 4,108,597 | 124.24 | 46 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 520 | 4,922 | 211,758,557 | 373,183,036 | 520 | 4,056 | 0 | 435 | 406 | 850 | 1,207 | 8 | 14 | 848 | 91,281,687 | 306 | 105 | 2,211,000 | 26.14 | 
| regex_program | 1 | 292 | 2,823 | 174,326,267 | 196,838,026 | 292 | 2,220 | 55 | 205 | 196 | 492 | 733 | 6 | 2 | 412 | 73,453,305 | 170 | 89 | 1,897,597 | 30.99 | 

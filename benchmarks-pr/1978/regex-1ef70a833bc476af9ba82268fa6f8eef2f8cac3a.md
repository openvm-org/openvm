...
|:---|---:|---:|
| Total |  7.69 |  4.96 |
| regex_program |  7.66 |  4.92 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  3,831 |  7,662 |  4,924 |  2,738 |
...
| `execute_metered_insn_mi/s` |  124.59 | -          |  124.59 |  124.59 |
| `execute_preflight_insns` |  2,054,298.50 |  4,108,597 |  2,211,000 |  1,897,597 |
| `execute_preflight_time_ms` |  93 |  186 |  100 |  86 |
| `execute_preflight_insn_mi/s` |  28.48 | -          |  30.89 |  26.08 |
| `trace_gen_time_ms   ` |  385.50 |  771 |  497 |  274 |
| `memory_finalize_time_ms` |  7.50 |  15 |  13 |  2 |
| `stark_prove_excluding_trace_time_ms` |  3,123.50 |  6,247 |  4,082 |  2,165 |
| `main_trace_commit_time_ms` |  628 |  1,256 |  848 |  408 |
| `generate_perm_trace_time_ms` |  230.50 |  461 |  304 |  157 |
| `perm_trace_commit_time_ms` |  667.50 |  1,335 |  889 |  446 |
| `quotient_poly_compute_time_ms` |  328 |  656 |  436 |  220 |
| `quotient_poly_commit_time_ms` |  300.50 |  601 |  395 |  206 |
| `pcs_opening_time_ms ` |  960.50 |  1,921 |  1,202 |  719 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 1 | 2,738 | 7 | 1 | 32 | 4,108,597 | 124.59 | 45 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 497 | 4,924 | 211,758,557 | 373,183,036 | 497 | 4,082 | 0 | 436 | 395 | 889 | 1,202 | 8 | 13 | 848 | 91,281,687 | 304 | 100 | 2,211,000 | 26.08 | 
| regex_program | 1 | 274 | 2,738 | 174,326,267 | 196,838,026 | 274 | 2,165 | 51 | 220 | 206 | 446 | 719 | 6 | 2 | 408 | 73,453,305 | 157 | 86 | 1,897,597 | 30.89 | 

...
| `execute_metered_insn_mi/s` |  17.68 | -          |  17.68 |  17.68 |
| `execute_preflight_insns` |  872,871 |  1,745,742 |  1,157,000 |  588,742 |
| `execute_preflight_time_ms` |  97.50 |  195 |  135 |  60 |
| `execute_preflight_insn_mi/s` |  13.35 | -          |  17.92 |  8.78 |
| `trace_gen_time_ms   ` |  175 |  350 |  195 |  155 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  371.50 |  743 |  432 |  311 |
| `main_trace_commit_time_ms` |  65.50 |  131 |  76 |  55 |
| `generate_perm_trace_time_ms` |  43.50 |  87 |  48 |  39 |
| `perm_trace_commit_time_ms` |  77.53 |  155.06 |  90.77 |  64.29 |
| `quotient_poly_compute_time_ms` |  79.58 |  159.16 |  87.68 |  71.48 |
| `quotient_poly_commit_time_ms` |  17.05 |  34.11 |  19.25 |  14.85 |
| `pcs_opening_time_ms ` |  83.50 |  167 |  114 |  53 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 607 | 1 | 98 | 1,745,742 | 17.68 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 155 | 867 | 32,689,110 | 172,558,444 | 155 | 432 | 0 | 87.68 | 19.25 | 6 | 90.77 | 114 | 133 | 114 | 1 | 76 | 16,059,916 | 39 | 135 | 1,157,000 | 8.78 | 26 | 107 | 1 | 114 | 
| pairing | 1 | 195 | 607 | 22,314,288 | 119,958,502 | 194 | 311 | 1 | 71.48 | 14.85 | 6 | 64.29 | 53 | 115 | 52 | 0 | 55 | 9,408,294 | 48 | 60 | 588,742 | 17.92 | 20 | 86 | 1 | 52 | 

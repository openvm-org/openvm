...
| `total_proof_time_ms ` |  583.75 |  2,335 |  718 |  537 |
...
| `execute_preflight_insn_mi/s` |  30.81 | -          |  32.07 |  28.25 |
| `trace_gen_time_ms   ` |  179 |  716 |  213 |  157 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  284 |  1,136 |  316 |  267 |
| `main_trace_commit_time_ms` |  51 |  204 |  56 |  49 |
| `generate_perm_trace_time_ms` |  34.50 |  138 |  54 |  19 |
| `perm_trace_commit_time_ms` |  63.74 |  254.95 |  69.61 |  54.31 |
| `quotient_poly_compute_time_ms` |  59.23 |  236.91 |  71.08 |  52.01 |
| `quotient_poly_commit_time_ms` |  15.22 |  60.88 |  17.59 |  12.76 |
| `pcs_opening_time_ms ` |  57.25 |  229 |  62 |  55 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 537 | 1 | 36 | 4,137,502 | 112.77 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 213 | 718 | 23,446,148 | 150,778,428 | 213 | 316 | 0 | 60.62 | 17.59 | 5 | 69.61 | 55 | 125 | 55 | 4 | 56 | 10,899,170 | 54 | 45 | 1,103,000 | 28.25 | 21 | 78 | 1 | 55 | 
| regex_program | 1 | 157 | 541 | 11,598,276 | 128,513,066 | 157 | 278 | 1 | 53.20 | 14.71 | 4 | 64.81 | 56 | 103 | 55 | 0 | 50 | 2,196,106 | 38 | 65 | 1,104,000 | 32.07 | 16 | 68 | 0 | 55 | 
| regex_program | 2 | 163 | 539 | 11,579,064 | 128,513,066 | 163 | 275 | 1 | 52.01 | 15.81 | 4 | 66.22 | 62 | 94 | 62 | 0 | 49 | 2,177,334 | 27 | 59 | 1,104,000 | 31.44 | 17 | 68 | 0 | 62 | 
| regex_program | 3 | 183 | 537 | 11,853,872 | 103,456,394 | 183 | 267 | 0 | 71.08 | 12.76 | 5 | 54.31 | 56 | 76 | 55 | 0 | 49 | 2,422,606 | 19 | 45 | 826,502 | 31.48 | 18 | 84 | 1 | 55 | 
...
Commit: https://github.com/openvm-org/openvm/commit/cb65d1bba38e1117397863285dbe1f50198a72db
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19350217881)

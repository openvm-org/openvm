...
| `total_proof_time_ms ` |  1,081 |  2,162 |  1,354 |  808 |
| `execute_metered_time_ms` |  34 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  75.70 | -          |  75.70 |  75.70 |
| `execute_preflight_insns` |  1,289,951.50 |  2,579,903 |  1,540,000 |  1,039,903 |
| `execute_preflight_time_ms` |  96.50 |  193 |  131 |  62 |
| `execute_preflight_insn_mi/s` |  35.27 | -          |  36.25 |  34.29 |
| `trace_gen_time_ms   ` |  58.50 |  117 |  72 |  45 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  811 |  1,622 |  1,033 |  589 |
| `prover.main_trace_commit_time_ms` |  227.50 |  455 |  307 |  148 |
| `prover.rap_constraints_time_ms` |  521 |  1,042 |  651 |  391 |
| `prover.openings_time_ms` |  61.50 |  123 |  74 |  49 |
| `prover.rap_constraints.logup_gkr_time_ms` |  152.50 |  305 |  167 |  138 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/a5750efb86696daeab68fe152ab624e430f69e40/kitchen_sink-a5750efb86696daeab68fe152ab624e430f69e40.memory.svg)
...
| app_proof |  |  |  |  |  | 808 |  |  | 34 | 2,579,903 | 75.70 | 0 | 2,200 |  | 
...
| internal_recursive.0 | 1 | 10 | 113 | 10 | 2 | 0 | 2 | 0 | 1 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 53,472,003 | 138 | 40 | 0 | 4 | 64 | 20 | 19 | 29 | 15 | 0 | 32 | 8 | 23 | 1 | 21 | 41 | 64 | 0 | 1 | 14 | 0 | 0 | 
...
| leaf | 0 | prover | 428,317,568 | 322 | 130 | 0 | 10 | 146 | 49 | 48 | 37 | 59 | 0 | 44 | 12 | 31 | 7 | 24 | 131 | 146 | 0 | 2 | 58 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 787,664,364 | 1,033 | 306 | 0 | 176 | 651 | 351 | 350 | 131 | 167 | 67 | 74 | 12 | 61 | 16 | 45 | 307 | 651 | 0 | 1 | 99 | 0 | 0 | 
| app_proof | prover | 1 | 700,866,292 | 589 | 148 | 0 | 23 | 391 | 176 | 176 | 76 | 138 | 75 | 49 | 12 | 37 | 14 | 22 | 148 | 391 | 0 | 1 | 61 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 72 | 1,354 | 72 | 185 | 0 | 3 | 62 | 1,540,000 | 34.29 | 
| app_proof | 1 | 45 | 808 | 45 | 40 | 0 | 1 | 131 | 1,039,903 | 36.25 | 

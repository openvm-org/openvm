...
| `total_proof_time_ms ` |  1,148.50 |  2,297 |  1,834 |  463 |
| `execute_metered_time_ms` |  35 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  73.46 | -          |  73.46 |  73.46 |
| `execute_preflight_insns` |  1,289,951.50 |  2,579,903 |  2,020,000 |  559,903 |
| `execute_preflight_time_ms` |  76.50 |  153 |  77 |  76 |
| `execute_preflight_insn_mi/s` |  35.60 | -          |  36.07 |  35.12 |
| `trace_gen_time_ms   ` |  57.50 |  115 |  94 |  21 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  899.50 |  1,799 |  1,476 |  323 |
| `prover.main_trace_commit_time_ms` |  295 |  590 |  508 |  82 |
| `prover.rap_constraints_time_ms` |  539 |  1,078 |  874 |  204 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/133ce7d4ed27ee20c8bf4a8e59bf76694cedfe5c/kitchen_sink-133ce7d4ed27ee20c8bf4a8e59bf76694cedfe5c.memory.svg)
...
| app_proof |  |  |  |  |  | 463 |  |  | 35 | 2,579,903 | 73.46 | 0 | 2,337 |  | 
...
| leaf | 0 | 120 | 442 | 120 | 26 | 12 | 21 | 2 | 2 | 
...
| leaf | 0 | prover | 428,317,568 | 321 | 131 | 0 | 10 | 146 | 48 | 48 | 37 | 59 | 0 | 43 | 12 | 31 | 7 | 24 | 131 | 146 | 0 | 2 | 58 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,221,261,804 | 1,476 | 508 | 0 | 290 | 874 | 453 | 452 | 143 | 277 | 139 | 93 | 16 | 76 | 25 | 50 | 508 | 874 | 0 | 1 | 137 | 0 | 0 | 
| app_proof | prover | 1 | 370,741,140 | 323 | 82 | 0 | 17 | 204 | 114 | 113 | 46 | 43 | 0 | 36 | 10 | 25 | 7 | 18 | 82 | 204 | 0 | 1 | 43 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 94 | 1,834 | 94 | 186 | 0 | 3 | 76 | 2,020,000 | 35.12 | 
| app_proof | 1 | 21 | 463 | 21 | 40 | 0 | 1 | 77 | 559,903 | 36.07 | 

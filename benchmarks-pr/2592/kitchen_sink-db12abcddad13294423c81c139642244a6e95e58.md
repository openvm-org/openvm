...
| `total_proof_time_ms ` |  1,146.50 |  2,293 |  1,828 |  465 |
...
| `execute_preflight_insn_mi/s` |  36.16 | -          |  37.46 |  34.87 |
| `trace_gen_time_ms   ` |  57 |  114 |  93 |  21 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  897.50 |  1,795 |  1,471 |  324 |
| `prover.main_trace_commit_time_ms` |  292 |  584 |  502 |  82 |
| `prover.rap_constraints_time_ms` |  539 |  1,078 |  873 |  205 |
| `prover.openings_time_ms` |  65.50 |  131 |  95 |  36 |
| `prover.rap_constraints.logup_gkr_time_ms` |  158 |  316 |  273 |  43 |
| `prover.rap_constraints.round0_time_ms` |  284.50 |  569 |  455 |  114 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/db12abcddad13294423c81c139642244a6e95e58/kitchen_sink-db12abcddad13294423c81c139642244a6e95e58.memory.svg)
...
| app_proof |  |  |  |  |  | 465 |  |  | 34 | 2,579,903 | 74.98 | 0 | 2,332 |  | 
...
| leaf | 0 | 123 | 447 | 122 | 27 | 12 | 20 | 2 | 2 | 
...
| leaf | 0 | prover | 428,317,568 | 324 | 131 | 0 | 10 | 148 | 49 | 49 | 37 | 60 | 0 | 43 | 12 | 31 | 7 | 24 | 132 | 148 | 0 | 2 | 59 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,221,261,804 | 1,471 | 501 | 0 | 284 | 873 | 455 | 454 | 144 | 273 | 134 | 95 | 17 | 78 | 26 | 51 | 502 | 873 | 0 | 1 | 137 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 93 | 1,828 | 93 | 184 | 0 | 3 | 77 | 2,020,000 | 34.87 | 
| app_proof | 1 | 21 | 465 | 21 | 40 | 0 | 1 | 78 | 559,903 | 37.46 | 

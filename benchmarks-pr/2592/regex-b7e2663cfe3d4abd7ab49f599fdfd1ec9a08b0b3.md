...
| `total_proof_time_ms ` |  719.50 |  1,439 |  774 |  665 |
| `execute_metered_time_ms` |  31 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  131.42 | -          |  131.42 |  131.42 |
| `execute_preflight_insns` |  2,068,533.50 |  4,137,067 |  2,208,000 |  1,929,067 |
| `execute_preflight_time_ms` |  74.50 |  149 |  77 |  72 |
| `execute_preflight_insn_mi/s` |  39.07 | -          |  39.95 |  38.19 |
| `trace_gen_time_ms   ` |  155 |  310 |  156 |  154 |
| `memory_finalize_time_ms` |  1 |  2 |  2 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  383.50 |  767 |  396 |  371 |
| `prover.main_trace_commit_time_ms` |  97 |  194 |  99 |  95 |
| `prover.rap_constraints_time_ms` |  237 |  474 |  251 |  223 |
| `prover.openings_time_ms` |  48.50 |  97 |  49 |  48 |
| `prover.rap_constraints.logup_gkr_time_ms` |  139 |  278 |  141 |  137 |
| `prover.rap_constraints.round0_time_ms` |  66 |  132 |  81 |  51 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/b7e2663cfe3d4abd7ab49f599fdfd1ec9a08b0b3/regex-b7e2663cfe3d4abd7ab49f599fdfd1ec9a08b0b3.memory.svg)
...
| app_proof |  |  |  |  |  | 665 |  |  | 31 | 4,137,067 | 131.42 | 0 | 1,484 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 41,036,547 | 233 | 84 | 0 | 5 | 100 | 30 | 29 | 45 | 23 | 0 | 48 | 22 | 26 | 2 | 23 | 84 | 100 | 0 | 2 | 23 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 23,651,975 | 168 | 49 | 0 | 3 | 69 | 23 | 23 | 27 | 18 | 0 | 48 | 24 | 23 | 1 | 21 | 49 | 69 | 0 | 2 | 17 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 17,507,975 | 139 | 34 | 0 | 3 | 64 | 22 | 22 | 24 | 16 | 0 | 40 | 18 | 22 | 1 | 20 | 34 | 64 | 0 | 2 | 16 | 0 | 0 | 
| leaf | 0 | prover | 115,080,128 | 331 | 130 | 0 | 8 | 138 | 52 | 51 | 37 | 47 | 0 | 62 | 31 | 30 | 6 | 23 | 130 | 138 | 0 | 5 | 46 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 335,517,254 | 371 | 99 | 0 | 2 | 223 | 51 | 51 | 34 | 137 | 0 | 49 | 21 | 28 | 10 | 17 | 99 | 223 | 0 | 3 | 136 | 0 | 0 | 
| app_proof | prover | 1 | 303,289,171 | 396 | 95 | 0 | 15 | 251 | 81 | 80 | 29 | 141 | 0 | 48 | 22 | 26 | 8 | 17 | 95 | 251 | 0 | 2 | 140 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 154 | 774 | 154 | 169 | 2 | 137 | 77 | 2,208,000 | 39.95 | 
| app_proof | 1 | 156 | 665 | 156 | 40 | 0 | 138 | 72 | 1,929,067 | 38.19 | 

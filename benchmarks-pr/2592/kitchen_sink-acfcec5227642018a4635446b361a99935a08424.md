...
| `total_proof_time_ms ` |  1,132.50 |  2,265 |  1,803 |  462 |
| `execute_metered_time_ms` |  34 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  74.90 | -          |  74.90 |  74.90 |
| `execute_preflight_insns` |  1,289,951.50 |  2,579,903 |  2,020,000 |  559,903 |
| `execute_preflight_time_ms` |  75 |  150 |  76 |  74 |
| `execute_preflight_insn_mi/s` |  37.22 | -          |  38.39 |  36.06 |
| `trace_gen_time_ms   ` |  57 |  114 |  93 |  21 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  886.50 |  1,773 |  1,450 |  323 |
| `prover.main_trace_commit_time_ms` |  290 |  580 |  498 |  82 |
| `prover.rap_constraints_time_ms` |  531.50 |  1,063 |  859 |  204 |
| `prover.openings_time_ms` |  64.50 |  129 |  93 |  36 |
| `prover.rap_constraints.logup_gkr_time_ms` |  157.50 |  315 |  272 |  43 |
| `prover.rap_constraints.round0_time_ms` |  278 |  556 |  443 |  113 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/acfcec5227642018a4635446b361a99935a08424/kitchen_sink-acfcec5227642018a4635446b361a99935a08424.memory.svg)
...
| app_proof |  |  |  |  |  | 462 |  |  | 34 | 2,579,903 | 74.90 | 0 | 2,303 |  | 
...
| leaf | 0 | 121 | 441 | 120 | 26 | 12 | 22 | 2 | 2 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 53,472,003 | 139 | 40 | 0 | 4 | 64 | 19 | 18 | 29 | 15 | 0 | 33 | 9 | 23 | 1 | 21 | 41 | 64 | 0 | 1 | 14 | 0 | 0 | 
...
| leaf | 0 | prover | 428,317,568 | 320 | 130 | 0 | 10 | 144 | 47 | 46 | 37 | 60 | 0 | 44 | 13 | 31 | 7 | 24 | 130 | 144 | 0 | 2 | 59 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,221,261,804 | 1,450 | 497 | 0 | 282 | 859 | 443 | 442 | 143 | 272 | 133 | 93 | 17 | 76 | 25 | 50 | 498 | 859 | 0 | 1 | 137 | 0 | 0 | 
| app_proof | prover | 1 | 370,741,140 | 323 | 82 | 0 | 17 | 204 | 113 | 112 | 47 | 43 | 0 | 36 | 9 | 26 | 7 | 18 | 82 | 204 | 0 | 1 | 43 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 93 | 1,803 | 93 | 184 | 0 | 3 | 74 | 2,020,000 | 36.06 | 
| app_proof | 1 | 21 | 462 | 21 | 40 | 0 | 1 | 76 | 559,903 | 38.39 | 

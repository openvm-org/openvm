...
| `total_proof_time_ms ` |  1,152.50 |  2,305 |  1,837 |  468 |
| `execute_metered_time_ms` |  34 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  75.18 | -          |  75.18 |  75.18 |
| `execute_preflight_insns` |  1,289,951.50 |  2,579,903 |  2,020,000 |  559,903 |
| `execute_preflight_time_ms` |  80.50 |  161 |  81 |  80 |
| `execute_preflight_insn_mi/s` |  34.30 | -          |  34.95 |  33.64 |
| `trace_gen_time_ms   ` |  57.50 |  115 |  94 |  21 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  899 |  1,798 |  1,474 |  324 |
| `prover.main_trace_commit_time_ms` |  293.50 |  587 |  505 |  82 |
| `prover.rap_constraints_time_ms` |  538.50 |  1,077 |  872 |  205 |
| `prover.openings_time_ms` |  66 |  132 |  96 |  36 |
| `prover.rap_constraints.logup_gkr_time_ms` |  159 |  318 |  275 |  43 |
| `prover.rap_constraints.round0_time_ms` |  283 |  566 |  452 |  114 |
| `prover.rap_constraints.mle_rounds_time_ms` |  96 |  192 |  145 |  47 |
| `prover.openings.stacked_reduction_time_ms` |  52 |  104 |  78 |  26 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/d13e237011e73decbea1c511be2bea6f11685461/kitchen_sink-d13e237011e73decbea1c511be2bea6f11685461.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 74 | 3 |  |  | 0 |  | 346 | 3 |  |  |  |  |  |  | 
| app_proof |  |  |  |  |  | 468 |  |  | 34 | 2,579,903 | 75.18 | 0 | 2,344 |  | 
...
| leaf | 0 | 126 | 450 | 126 | 27 | 12 | 21 | 2 | 2 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 53,472,003 | 139 | 41 | 0 | 4 | 66 | 20 | 20 | 29 | 16 | 0 | 31 | 8 | 23 | 1 | 22 | 41 | 66 | 0 | 1 | 15 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 23,651,975 | 102 | 19 | 0 | 4 | 51 | 17 | 17 | 20 | 13 | 0 | 30 | 9 | 21 | 1 | 20 | 19 | 51 | 0 | 1 | 12 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 17,507,975 | 95 | 14 | 0 | 4 | 49 | 17 | 17 | 18 | 13 | 0 | 30 | 9 | 21 | 0 | 20 | 15 | 49 | 0 | 1 | 12 | 0 | 0 | 
| leaf | 0 | prover | 428,317,568 | 323 | 131 | 0 | 10 | 147 | 49 | 49 | 37 | 60 | 0 | 43 | 11 | 31 | 7 | 24 | 132 | 147 | 0 | 2 | 59 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,221,261,804 | 1,474 | 504 | 0 | 285 | 872 | 452 | 451 | 145 | 275 | 136 | 96 | 17 | 78 | 26 | 51 | 505 | 872 | 0 | 1 | 137 | 0 | 0 | 
| app_proof | prover | 1 | 370,741,140 | 324 | 82 | 0 | 17 | 205 | 114 | 113 | 47 | 43 | 0 | 36 | 10 | 26 | 7 | 18 | 82 | 205 | 0 | 1 | 42 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 94 | 1,837 | 94 | 188 | 0 | 3 | 80 | 2,020,000 | 33.64 | 
| app_proof | 1 | 21 | 468 | 21 | 40 | 0 | 1 | 81 | 559,903 | 34.95 | 

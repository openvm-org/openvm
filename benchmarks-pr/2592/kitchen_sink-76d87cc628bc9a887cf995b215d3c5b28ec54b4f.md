...
| `total_proof_time_ms ` |  1,142.50 |  2,285 |  1,822 |  463 |
| `execute_metered_time_ms` |  34 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  75.54 | -          |  75.54 |  75.54 |
| `execute_preflight_insns` |  1,289,951.50 |  2,579,903 |  2,020,000 |  559,903 |
| `execute_preflight_time_ms` |  77.50 |  155 |  79 |  76 |
| `execute_preflight_insn_mi/s` |  34.17 | -          |  34.55 |  33.80 |
| `trace_gen_time_ms   ` |  56.50 |  113 |  93 |  20 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  894.50 |  1,789 |  1,468 |  321 |
| `prover.main_trace_commit_time_ms` |  295.50 |  591 |  509 |  82 |
| `prover.rap_constraints_time_ms` |  533.50 |  1,067 |  865 |  202 |
| `prover.openings_time_ms` |  64.50 |  129 |  93 |  36 |
| `prover.rap_constraints.logup_gkr_time_ms` |  160 |  320 |  277 |  43 |
| `prover.rap_constraints.round0_time_ms` |  277.50 |  555 |  443 |  112 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/76d87cc628bc9a887cf995b215d3c5b28ec54b4f/kitchen_sink-76d87cc628bc9a887cf995b215d3c5b28ec54b4f.memory.svg)
...
| app_proof |  |  |  |  |  | 463 |  |  | 34 | 2,579,903 | 75.54 | 0 | 2,323 |  | 
| internal_for_leaf |  |  |  | 156 |  |  |  |  |  |  |  |  |  | 157 | 
...
| internal_recursive.0 | 1 | prover | 23,651,975 | 100 | 19 | 0 | 3 | 50 | 16 | 16 | 20 | 13 | 0 | 30 | 9 | 21 | 1 | 20 | 19 | 50 | 0 | 1 | 12 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,221,261,804 | 1,468 | 508 | 0 | 290 | 865 | 443 | 442 | 144 | 277 | 139 | 93 | 16 | 77 | 25 | 51 | 509 | 865 | 0 | 1 | 136 | 0 | 0 | 
| app_proof | prover | 1 | 370,741,140 | 321 | 82 | 0 | 17 | 202 | 112 | 111 | 47 | 43 | 0 | 36 | 10 | 26 | 7 | 18 | 82 | 202 | 0 | 1 | 42 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 93 | 1,822 | 93 | 183 | 0 | 3 | 76 | 2,020,000 | 34.55 | 
| app_proof | 1 | 20 | 463 | 20 | 40 | 0 | 1 | 79 | 559,903 | 33.80 | 

...
|:---|---:|---:|---:|
| Total |  11.54 |  3.52 |  3.52 |
| app_proof |  9.31 |  1.80 |  1.80 |
| leaf |  1.41 |  0.89 |  0.89 |
...
| `total_proof_time_ms ` |  1,529 |  9,174 |  1,665 |  1,442 |
...
| `execute_preflight_insn_mi/s` |  39.90 | -          |  40.50 |  38.20 |
| `trace_gen_time_ms   ` |  132.17 |  793 |  165 |  113 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,196.33 |  7,178 |  1,238 |  1,161 |
| `prover.main_trace_commit_time_ms` |  288 |  1,728 |  290 |  287 |
| `prover.rap_constraints_time_ms` |  816.67 |  4,900 |  857 |  780 |
| `prover.openings_time_ms` |  90.50 |  543 |  94 |  88 |
| `prover.rap_constraints.logup_gkr_time_ms` |  276.17 |  1,657 |  315 |  256 |
| `prover.rap_constraints.round0_time_ms` |  370.50 |  2,223 |  374 |  359 |
| `prover.rap_constraints.mle_rounds_time_ms` |  169.17 |  1,015 |  171 |  164 |
| `prover.openings.stacked_reduction_time_ms` |  61 |  366 |  63 |  60 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  704.50 |  1,409 |  894 |  515 |
| `execute_preflight_time_ms` |  2 |  4 |  2 |  2 |
| `trace_gen_time_ms   ` |  76 |  152 |  103 |  49 |
| `generate_blob_total_time_ms` |  10.50 |  21 |  14 |  7 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  628 |  1,256 |  791 |  465 |
| `prover.main_trace_commit_time_ms` |  318.50 |  637 |  412 |  225 |
| `prover.rap_constraints_time_ms` |  231 |  462 |  290 |  172 |
| `prover.openings_time_ms` |  77 |  154 |  87 |  67 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/223ff2a648a9cc517817437f5035963a8877df8a/sha2_bench-223ff2a648a9cc517817437f5035963a8877df8a.memory.svg)
...
| app_proof |  |  |  |  |  | 1,442 |  |  | 139 | 14,793,960 | 106.24 | 0 | 9,321 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 31 | 486 | 30 | 11 | 2 | 2 | 1 | 1 | 
| internal_recursive.0 | 1 | 12 | 185 | 12 | 2 | 1 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 9 | 152 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 103 | 894 | 102 | 38 | 14 | 2 | 3 | 3 | 
| leaf | 1 | 49 | 515 | 49 | 19 | 7 | 2 | 3 | 3 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 75,647,860 | 455 | 230 | 0 | 13 | 168 | 45 | 44 | 87 | 36 | 0 | 56 | 19 | 37 | 7 | 30 | 230 | 168 | 0 | 2 | 34 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,879 | 172 | 51 | 0 | 4 | 78 | 26 | 25 | 28 | 23 | 0 | 41 | 17 | 24 | 1 | 22 | 52 | 78 | 0 | 2 | 22 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 142 | 34 | 0 | 4 | 66 | 22 | 22 | 24 | 19 | 0 | 41 | 19 | 22 | 1 | 21 | 34 | 66 | 0 | 2 | 18 | 0 | 0 | 
| leaf | 0 | prover | 266,560,230 | 791 | 412 | 0 | 26 | 290 | 131 | 130 | 80 | 78 | 0 | 87 | 31 | 56 | 22 | 33 | 412 | 290 | 0 | 6 | 77 | 0 | 0 | 
| leaf | 1 | prover | 135,246,516 | 465 | 224 | 0 | 13 | 172 | 72 | 72 | 48 | 50 | 0 | 67 | 29 | 38 | 11 | 26 | 225 | 172 | 0 | 5 | 49 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 353,899,717 | 1,238 | 287 | 0 | 21 | 857 | 372 | 372 | 169 | 314 | 73 | 94 | 30 | 63 | 32 | 30 | 287 | 857 | 0 | 3 | 241 | 0 | 0 | 
| app_proof | prover | 1 | 353,899,532 | 1,234 | 288 | 0 | 19 | 857 | 371 | 370 | 171 | 315 | 74 | 88 | 27 | 60 | 32 | 28 | 288 | 857 | 0 | 3 | 240 | 0 | 0 | 
| app_proof | prover | 2 | 353,899,532 | 1,181 | 287 | 0 | 19 | 802 | 374 | 374 | 171 | 256 | 0 | 90 | 28 | 61 | 32 | 29 | 287 | 802 | 0 | 3 | 255 | 0 | 0 | 
| app_proof | prover | 3 | 353,899,532 | 1,182 | 288 | 0 | 19 | 802 | 374 | 374 | 169 | 257 | 0 | 91 | 30 | 60 | 32 | 27 | 288 | 802 | 0 | 3 | 256 | 0 | 0 | 
| app_proof | prover | 4 | 353,899,532 | 1,182 | 288 | 0 | 19 | 802 | 373 | 373 | 171 | 258 | 0 | 90 | 29 | 61 | 32 | 29 | 288 | 802 | 0 | 3 | 257 | 0 | 0 | 
| app_proof | prover | 5 | 353,980,012 | 1,161 | 290 | 0 | 20 | 780 | 359 | 358 | 164 | 257 | 0 | 90 | 28 | 61 | 31 | 29 | 290 | 780 | 0 | 3 | 255 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 165 | 1,652 | 165 | 161 | 0 | 3 | 85 | 2,623,000 | 38.20 | 
| app_proof | 1 | 140 | 1,665 | 140 | 136 | 0 | 2 | 153 | 2,625,000 | 40.37 | 
| app_proof | 2 | 113 | 1,471 | 113 | 41 | 0 | 3 | 135 | 2,625,000 | 40.19 | 
| app_proof | 3 | 113 | 1,473 | 113 | 41 | 0 | 2 | 136 | 2,625,000 | 40.20 | 
| app_proof | 4 | 113 | 1,471 | 113 | 41 | 0 | 2 | 135 | 2,625,000 | 40.50 | 
| app_proof | 5 | 149 | 1,442 | 149 | 41 | 0 | 2 | 90 | 1,670,960 | 39.96 | 

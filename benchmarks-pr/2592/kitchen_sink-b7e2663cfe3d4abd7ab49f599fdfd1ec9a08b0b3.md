...
| `total_proof_time_ms ` |  1,139 |  2,278 |  1,818 |  460 |
| `execute_metered_time_ms` |  39 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  65.12 | -          |  65.12 |  65.12 |
| `execute_preflight_insns` |  1,289,951.50 |  2,579,903 |  2,020,000 |  559,903 |
| `execute_preflight_time_ms` |  78 |  156 |  79 |  77 |
| `execute_preflight_insn_mi/s` |  36.33 | -          |  37.80 |  34.86 |
| `trace_gen_time_ms   ` |  56.50 |  113 |  92 |  21 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  891 |  1,782 |  1,463 |  319 |
| `prover.main_trace_commit_time_ms` |  293.50 |  587 |  505 |  82 |
| `prover.rap_constraints_time_ms` |  531 |  1,062 |  862 |  200 |
| `prover.openings_time_ms` |  65 |  130 |  95 |  35 |
| `prover.rap_constraints.logup_gkr_time_ms` |  158 |  316 |  274 |  42 |
| `prover.rap_constraints.round0_time_ms` |  276.50 |  553 |  442 |  111 |
| `prover.rap_constraints.mle_rounds_time_ms` |  95 |  190 |  144 |  46 |
| `prover.openings.stacked_reduction_time_ms` |  52 |  104 |  78 |  26 |
| `prover.openings.stacked_reduction.round0_time_ms` |  16.50 |  33 |  26 |  7 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  35 |  70 |  52 |  18 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/b7e2663cfe3d4abd7ab49f599fdfd1ec9a08b0b3/kitchen_sink-b7e2663cfe3d4abd7ab49f599fdfd1ec9a08b0b3.memory.svg)
...
| app_proof |  |  |  |  |  | 460 |  |  | 39 | 2,579,903 | 65.12 | 0 | 2,322 |  | 
| internal_for_leaf |  |  |  | 156 |  |  |  |  |  |  |  |  |  | 156 | 
| internal_recursive.0 |  |  |  | 110 |  |  |  |  |  |  |  |  |  | 111 | 
...
| leaf | 0 | 119 | 440 | 119 | 26 | 12 | 22 | 2 | 2 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 53,472,003 | 138 | 41 | 0 | 4 | 64 | 19 | 19 | 29 | 15 | 0 | 32 | 9 | 23 | 1 | 21 | 41 | 64 | 0 | 1 | 14 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 23,651,975 | 100 | 19 | 0 | 4 | 50 | 17 | 16 | 20 | 13 | 0 | 29 | 8 | 21 | 1 | 20 | 19 | 50 | 0 | 1 | 12 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 17,507,975 | 93 | 14 | 0 | 4 | 49 | 16 | 16 | 18 | 13 | 0 | 29 | 7 | 21 | 0 | 20 | 15 | 49 | 0 | 1 | 13 | 0 | 0 | 
| leaf | 0 | prover | 428,317,568 | 320 | 130 | 0 | 10 | 144 | 47 | 46 | 37 | 59 | 0 | 45 | 13 | 31 | 7 | 24 | 131 | 144 | 0 | 2 | 58 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,221,261,804 | 1,463 | 504 | 0 | 286 | 862 | 442 | 441 | 144 | 274 | 136 | 95 | 17 | 78 | 26 | 52 | 505 | 862 | 0 | 1 | 137 | 0 | 0 | 
| app_proof | prover | 1 | 370,741,140 | 319 | 82 | 0 | 17 | 200 | 111 | 110 | 46 | 42 | 0 | 35 | 9 | 26 | 7 | 18 | 82 | 200 | 0 | 1 | 41 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 92 | 1,818 | 92 | 184 | 0 | 3 | 77 | 2,020,000 | 34.86 | 
| app_proof | 1 | 21 | 460 | 21 | 40 | 0 | 1 | 79 | 559,903 | 37.80 | 

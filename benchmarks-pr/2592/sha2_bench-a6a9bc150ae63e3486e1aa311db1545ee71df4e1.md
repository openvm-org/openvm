...
|:---|---:|---:|---:|
| Total |  11.47 |  3.57 |  3.56 |
| app_proof |  9.25 |  1.86 |  1.86 |
| leaf |  1.41 |  0.89 |  0.89 |
...
| `total_proof_time_ms ` |  1,518.33 |  9,110 |  1,720 |  1,445 |
| `execute_metered_time_ms` |  139 | -          | -          | -          |
| `execute_metered_insns` |  14,793,960 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  106.09 | -          |  106.09 |  106.09 |
| `execute_preflight_insns` |  2,465,660 |  14,793,960 |  2,625,000 |  1,670,960 |
| `execute_preflight_time_ms` |  123.83 |  743 |  154 |  85 |
| `execute_preflight_insn_mi/s` |  39.84 | -          |  41 |  37.33 |
| `trace_gen_time_ms   ` |  123 |  738 |  165 |  94 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,207.83 |  7,247 |  1,298 |  1,164 |
| `prover.main_trace_commit_time_ms` |  288.33 |  1,730 |  289 |  287 |
| `prover.rap_constraints_time_ms` |  828.67 |  4,972 |  917 |  789 |
| `prover.openings_time_ms` |  89.67 |  538 |  93 |  85 |
| `prover.rap_constraints.logup_gkr_time_ms` |  282.67 |  1,696 |  388 |  260 |
| `prover.rap_constraints.round0_time_ms` |  375.33 |  2,252 |  386 |  360 |
| `prover.rap_constraints.mle_rounds_time_ms` |  169.50 |  1,017 |  171 |  165 |
| `prover.openings.stacked_reduction_time_ms` |  60.83 |  365 |  63 |  59 |
...
| `prover.openings.whir_time_ms` |  28.50 |  171 |  32 |  26 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  702.50 |  1,405 |  891 |  514 |
| `execute_preflight_time_ms` |  2 |  4 |  2 |  2 |
| `trace_gen_time_ms   ` |  76 |  152 |  103 |  49 |
| `generate_blob_total_time_ms` |  10.50 |  21 |  14 |  7 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  626 |  1,252 |  787 |  465 |
| `prover.main_trace_commit_time_ms` |  317.50 |  635 |  412 |  223 |
| `prover.rap_constraints_time_ms` |  229 |  458 |  288 |  170 |
| `prover.openings_time_ms` |  79 |  158 |  87 |  71 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/a6a9bc150ae63e3486e1aa311db1545ee71df4e1/sha2_bench-a6a9bc150ae63e3486e1aa311db1545ee71df4e1.memory.svg)
...
| app_proof |  |  |  |  |  | 1,445 |  |  | 139 | 14,793,960 | 106.09 | 0 | 9,258 |  | 
...
| leaf | 0 | 103 | 891 | 103 | 38 | 14 | 2 | 3 | 3 | 
| leaf | 1 | 49 | 514 | 48 | 19 | 7 | 2 | 3 | 3 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 100,404,864 | 454 | 230 | 0 | 13 | 166 | 45 | 45 | 87 | 33 | 0 | 57 | 20 | 37 | 7 | 30 | 230 | 166 | 0 | 3 | 32 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 25,962,119 | 170 | 51 | 0 | 3 | 76 | 24 | 24 | 29 | 22 | 0 | 42 | 18 | 24 | 1 | 21 | 51 | 76 | 0 | 2 | 22 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 17,507,975 | 138 | 34 | 0 | 4 | 63 | 22 | 21 | 24 | 17 | 0 | 39 | 17 | 22 | 1 | 21 | 35 | 63 | 0 | 2 | 16 | 0 | 0 | 
| leaf | 0 | prover | 341,718,010 | 787 | 411 | 0 | 26 | 288 | 130 | 129 | 79 | 78 | 0 | 87 | 31 | 55 | 22 | 33 | 412 | 288 | 0 | 5 | 77 | 0 | 0 | 
| leaf | 1 | prover | 179,641,792 | 465 | 223 | 0 | 13 | 170 | 72 | 72 | 48 | 49 | 0 | 71 | 33 | 38 | 11 | 27 | 223 | 170 | 0 | 5 | 48 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 630,037,121 | 1,298 | 289 | 0 | 21 | 917 | 360 | 359 | 168 | 388 | 139 | 91 | 28 | 63 | 32 | 30 | 289 | 917 | 0 | 3 | 248 | 0 | 0 | 
| app_proof | prover | 1 | 630,036,532 | 1,196 | 288 | 0 | 19 | 816 | 378 | 378 | 171 | 265 | 0 | 91 | 29 | 61 | 32 | 28 | 288 | 816 | 0 | 3 | 264 | 0 | 0 | 
| app_proof | prover | 2 | 630,036,532 | 1,194 | 289 | 0 | 19 | 814 | 381 | 381 | 171 | 261 | 0 | 90 | 28 | 61 | 32 | 29 | 289 | 814 | 0 | 3 | 259 | 0 | 0 | 
| app_proof | prover | 3 | 630,036,532 | 1,195 | 288 | 0 | 19 | 818 | 386 | 385 | 171 | 260 | 0 | 88 | 28 | 60 | 32 | 28 | 288 | 818 | 0 | 3 | 259 | 0 | 0 | 
| app_proof | prover | 4 | 630,036,532 | 1,200 | 287 | 0 | 19 | 818 | 385 | 385 | 171 | 261 | 0 | 93 | 32 | 61 | 32 | 28 | 287 | 818 | 0 | 3 | 260 | 0 | 0 | 
| app_proof | prover | 5 | 630,124,756 | 1,164 | 289 | 0 | 20 | 789 | 362 | 361 | 165 | 261 | 0 | 85 | 26 | 59 | 31 | 27 | 289 | 789 | 0 | 3 | 259 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 165 | 1,720 | 165 | 170 | 0 | 3 | 85 | 2,623,000 | 38.39 | 
| app_proof | 1 | 94 | 1,486 | 94 | 41 | 0 | 2 | 154 | 2,625,000 | 40.71 | 
| app_proof | 2 | 113 | 1,484 | 113 | 41 | 0 | 2 | 135 | 2,625,000 | 41 | 
| app_proof | 3 | 111 | 1,484 | 111 | 41 | 0 | 2 | 136 | 2,625,000 | 40.89 | 
| app_proof | 4 | 107 | 1,491 | 107 | 41 | 0 | 2 | 142 | 2,625,000 | 37.33 | 
| app_proof | 5 | 148 | 1,445 | 148 | 41 | 0 | 2 | 91 | 1,670,960 | 40.71 | 

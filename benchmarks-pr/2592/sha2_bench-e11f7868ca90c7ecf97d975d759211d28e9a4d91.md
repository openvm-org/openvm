...
|:---|---:|---:|---:|
| Total |  11.41 |  3.50 |  3.50 |
| app_proof |  9.18 |  1.78 |  1.78 |
| leaf |  1.40 |  0.89 |  0.89 |
...
| `total_proof_time_ms ` |  1,507.67 |  9,046 |  1,648 |  1,427 |
...
| `execute_preflight_time_ms` |  128.17 |  769 |  161 |  87 |
| `execute_preflight_insn_mi/s` |  40.19 | -          |  40.71 |  38.14 |
| `trace_gen_time_ms   ` |  123.33 |  740 |  160 |  101 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,177.33 |  7,064 |  1,218 |  1,149 |
| `prover.main_trace_commit_time_ms` |  285.67 |  1,714 |  286 |  285 |
| `prover.rap_constraints_time_ms` |  800.67 |  4,804 |  844 |  772 |
| `prover.openings_time_ms` |  89.67 |  538 |  92 |  88 |
| `prover.rap_constraints.logup_gkr_time_ms` |  273.17 |  1,639 |  314 |  253 |
| `prover.rap_constraints.round0_time_ms` |  360 |  2,160 |  364 |  353 |
| `prover.rap_constraints.mle_rounds_time_ms` |  166.67 |  1,000 |  169 |  165 |
...
| `prover.openings.whir_time_ms` |  28.67 |  172 |  31 |  27 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  699 |  1,398 |  886 |  512 |
| `execute_preflight_time_ms` |  2 |  4 |  2 |  2 |
| `trace_gen_time_ms   ` |  78.50 |  157 |  106 |  51 |
| `generate_blob_total_time_ms` |  10.50 |  21 |  14 |  7 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  620 |  1,240 |  779 |  461 |
| `prover.main_trace_commit_time_ms` |  317 |  634 |  411 |  223 |
| `prover.rap_constraints_time_ms` |  226 |  452 |  281 |  171 |
| `prover.openings_time_ms` |  76.50 |  153 |  87 |  66 |
| `prover.rap_constraints.logup_gkr_time_ms` |  62.50 |  125 |  75 |  50 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/e11f7868ca90c7ecf97d975d759211d28e9a4d91/sha2_bench-e11f7868ca90c7ecf97d975d759211d28e9a4d91.memory.svg)
...
| app_proof |  |  |  |  |  | 1,427 |  |  | 137 | 14,793,960 | 107.40 | 0 | 9,191 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 31 | 488 | 31 | 11 | 2 | 2 | 1 | 1 | 
| internal_recursive.0 | 1 | 13 | 186 | 12 | 2 | 1 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 9 | 151 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 106 | 886 | 105 | 39 | 14 | 2 | 3 | 3 | 
| leaf | 1 | 51 | 512 | 51 | 19 | 7 | 2 | 3 | 3 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 75,647,860 | 456 | 227 | 0 | 13 | 166 | 44 | 43 | 86 | 35 | 0 | 62 | 25 | 36 | 7 | 29 | 227 | 166 | 0 | 3 | 34 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,879 | 173 | 51 | 0 | 4 | 78 | 25 | 24 | 28 | 23 | 0 | 43 | 19 | 24 | 1 | 22 | 51 | 78 | 0 | 2 | 22 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 141 | 33 | 0 | 3 | 66 | 23 | 22 | 24 | 18 | 0 | 40 | 17 | 22 | 1 | 21 | 34 | 66 | 0 | 2 | 17 | 0 | 0 | 
| leaf | 0 | prover | 266,560,230 | 779 | 410 | 0 | 26 | 281 | 126 | 125 | 79 | 75 | 0 | 87 | 31 | 55 | 21 | 33 | 411 | 281 | 0 | 5 | 74 | 0 | 0 | 
| leaf | 1 | prover | 135,246,516 | 461 | 222 | 0 | 13 | 171 | 72 | 71 | 48 | 50 | 0 | 66 | 28 | 37 | 11 | 26 | 223 | 171 | 0 | 5 | 49 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 353,899,717 | 1,216 | 285 | 0 | 21 | 838 | 362 | 361 | 166 | 309 | 74 | 92 | 29 | 62 | 32 | 29 | 285 | 838 | 0 | 3 | 234 | 0 | 0 | 
| app_proof | prover | 1 | 353,899,532 | 1,218 | 285 | 0 | 19 | 844 | 361 | 360 | 168 | 314 | 74 | 88 | 27 | 61 | 32 | 29 | 285 | 844 | 0 | 3 | 239 | 0 | 0 | 
| app_proof | prover | 2 | 353,899,532 | 1,156 | 286 | 0 | 19 | 781 | 359 | 359 | 167 | 254 | 0 | 88 | 27 | 60 | 32 | 28 | 286 | 781 | 0 | 3 | 254 | 0 | 0 | 
| app_proof | prover | 3 | 353,899,532 | 1,164 | 286 | 0 | 19 | 784 | 361 | 360 | 169 | 253 | 0 | 92 | 31 | 60 | 32 | 28 | 286 | 784 | 0 | 3 | 253 | 0 | 0 | 
| app_proof | prover | 4 | 353,899,532 | 1,161 | 286 | 0 | 19 | 785 | 364 | 363 | 165 | 255 | 0 | 89 | 29 | 60 | 32 | 28 | 286 | 785 | 0 | 3 | 254 | 0 | 0 | 
| app_proof | prover | 5 | 353,980,012 | 1,149 | 286 | 0 | 20 | 772 | 353 | 352 | 165 | 254 | 0 | 89 | 29 | 60 | 31 | 28 | 286 | 772 | 0 | 3 | 252 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 160 | 1,628 | 160 | 162 | 0 | 3 | 87 | 2,623,000 | 38.14 | 
| app_proof | 1 | 130 | 1,648 | 130 | 137 | 0 | 2 | 161 | 2,625,000 | 40.71 | 
| app_proof | 2 | 104 | 1,445 | 104 | 41 | 0 | 3 | 142 | 2,625,000 | 40.66 | 
| app_proof | 3 | 103 | 1,450 | 103 | 41 | 0 | 2 | 142 | 2,625,000 | 40.70 | 
| app_proof | 4 | 101 | 1,448 | 101 | 41 | 0 | 2 | 144 | 2,625,000 | 40.54 | 
| app_proof | 5 | 142 | 1,427 | 142 | 41 | 0 | 2 | 93 | 1,670,960 | 40.42 | 

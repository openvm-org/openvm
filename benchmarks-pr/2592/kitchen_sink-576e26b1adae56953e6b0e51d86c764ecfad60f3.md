...
| `total_proof_time_ms ` |  1,134.50 |  2,269 |  1,811 |  458 |
| `execute_metered_time_ms` |  34 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  75.32 | -          |  75.32 |  75.32 |
| `execute_preflight_insns` |  1,289,951.50 |  2,579,903 |  2,020,000 |  559,903 |
| `execute_preflight_time_ms` |  76.50 |  153 |  77 |  76 |
| `execute_preflight_insn_mi/s` |  36.21 | -          |  37.37 |  35.05 |
| `trace_gen_time_ms   ` |  57 |  114 |  93 |  21 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  887 |  1,774 |  1,455 |  319 |
| `prover.main_trace_commit_time_ms` |  290.50 |  581 |  499 |  82 |
| `prover.rap_constraints_time_ms` |  531 |  1,062 |  861 |  201 |
| `prover.openings_time_ms` |  65 |  130 |  94 |  36 |
| `prover.rap_constraints.logup_gkr_time_ms` |  157 |  314 |  271 |  43 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/576e26b1adae56953e6b0e51d86c764ecfad60f3/kitchen_sink-576e26b1adae56953e6b0e51d86c764ecfad60f3.memory.svg)
...
| app_proof |  |  |  |  |  | 458 |  |  | 34 | 2,579,903 | 75.32 | 0 | 2,308 |  | 
...
| leaf | 0 | 120 | 439 | 120 | 27 | 12 | 22 | 2 | 2 | 
...
| leaf | 0 | prover | 428,317,568 | 318 | 129 | 0 | 10 | 143 | 47 | 46 | 37 | 58 | 0 | 44 | 13 | 31 | 7 | 24 | 129 | 143 | 0 | 2 | 58 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,221,261,804 | 1,455 | 498 | 0 | 283 | 861 | 447 | 446 | 141 | 271 | 133 | 94 | 17 | 77 | 25 | 51 | 499 | 861 | 0 | 1 | 137 | 0 | 0 | 
| app_proof | prover | 1 | 370,741,140 | 319 | 82 | 0 | 17 | 201 | 111 | 110 | 46 | 43 | 0 | 36 | 9 | 26 | 7 | 18 | 82 | 201 | 0 | 1 | 42 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 93 | 1,811 | 93 | 185 | 0 | 3 | 77 | 2,020,000 | 35.05 | 
| app_proof | 1 | 21 | 458 | 21 | 40 | 0 | 1 | 76 | 559,903 | 37.37 | 

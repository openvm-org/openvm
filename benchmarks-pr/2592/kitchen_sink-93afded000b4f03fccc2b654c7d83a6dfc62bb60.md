...
| `total_proof_time_ms ` |  946.50 |  1,893 |  1,211 |  682 |
| `execute_metered_time_ms` |  35 | -          | -          | -          |
| `execute_metered_insns` |  2,579,903 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  73.41 | -          |  73.41 |  73.41 |
| `execute_preflight_insns` |  1,289,951.50 |  2,579,903 |  1,540,000 |  1,039,903 |
| `execute_preflight_time_ms` |  103.50 |  207 |  144 |  63 |
| `execute_preflight_insn_mi/s` |  35.68 | -          |  36.69 |  34.67 |
| `trace_gen_time_ms   ` |  25.50 |  51 |  35 |  16 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  707.50 |  1,415 |  935 |  480 |
| `prover.main_trace_commit_time_ms` |  213 |  426 |  289 |  137 |
| `prover.rap_constraints_time_ms` |  448.50 |  897 |  594 |  303 |
| `prover.openings_time_ms` |  45 |  90 |  51 |  39 |
| `prover.rap_constraints.logup_gkr_time_ms` |  82.50 |  165 |  111 |  54 |
| `prover.rap_constraints.round0_time_ms` |  263 |  526 |  352 |  174 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/93afded000b4f03fccc2b654c7d83a6dfc62bb60/kitchen_sink-93afded000b4f03fccc2b654c7d83a6dfc62bb60.memory.svg)
...
| app_proof |  |  |  |  |  | 682 |  |  | 35 | 2,579,903 | 73.41 | 0 | 1,934 |  | 
...
| leaf | 0 | 113 | 411 | 113 | 25 | 11 | 21 | 5 | 5 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,577,915 | 117 | 38 | 0 | 0 | 63 | 21 | 20 | 29 | 12 | 0 | 16 | 8 | 7 | 1 | 6 | 38 | 63 | 0 | 1 | 11 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,703 | 80 | 16 | 0 | 0 | 47 | 17 | 17 | 20 | 9 | 0 | 16 | 10 | 5 | 1 | 4 | 16 | 47 | 0 | 1 | 9 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 75 | 11 | 0 | 0 | 48 | 19 | 18 | 18 | 10 | 0 | 15 | 9 | 5 | 0 | 4 | 11 | 48 | 0 | 1 | 9 | 0 | 0 | 
| leaf | 0 | prover | 265,006,708 | 297 | 128 | 0 | 1 | 140 | 48 | 47 | 37 | 54 | 0 | 28 | 12 | 15 | 7 | 8 | 129 | 140 | 0 | 2 | 53 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 567,917,156 | 935 | 289 | 0 | 160 | 594 | 352 | 351 | 130 | 111 | 55 | 51 | 12 | 38 | 15 | 22 | 289 | 594 | 0 | 1 | 55 | 0 | 0 | 
| app_proof | prover | 1 | 537,266,124 | 480 | 137 | 0 | 2 | 303 | 174 | 173 | 74 | 54 | 0 | 39 | 12 | 27 | 14 | 13 | 137 | 303 | 0 | 1 | 53 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 35 | 1,211 | 35 | 176 | 1 | 3 | 63 | 1,540,000 | 34.67 | 
| app_proof | 1 | 16 | 682 | 16 | 40 | 0 | 1 | 144 | 1,039,903 | 36.69 | 

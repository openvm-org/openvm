...
| `total_proof_time_ms ` |  698.50 |  1,397 |  754 |  643 |
| `execute_metered_time_ms` |  31 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  130.67 | -          |  130.67 |  130.67 |
| `execute_preflight_insns` |  2,068,533.50 |  4,137,067 |  2,208,000 |  1,929,067 |
| `execute_preflight_time_ms` |  74 |  148 |  78 |  70 |
| `execute_preflight_insn_mi/s` |  38.66 | -          |  39.27 |  38.04 |
| `trace_gen_time_ms   ` |  145.50 |  291 |  148 |  143 |
| `memory_finalize_time_ms` |  1 |  2 |  2 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  373 |  746 |  383 |  363 |
| `prover.main_trace_commit_time_ms` |  95 |  190 |  98 |  92 |
| `prover.rap_constraints_time_ms` |  232 |  464 |  247 |  217 |
| `prover.openings_time_ms` |  44.50 |  89 |  46 |  43 |
| `prover.rap_constraints.logup_gkr_time_ms` |  138 |  276 |  140 |  136 |
| `prover.rap_constraints.round0_time_ms` |  62 |  124 |  77 |  47 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/45182cf45ba6a76d937aa93949c95b0b538956a9/regex-45182cf45ba6a76d937aa93949c95b0b538956a9.memory.svg)
...
| app_proof |  |  |  |  |  | 643 |  |  | 31 | 4,137,067 | 130.67 | 0 | 1,443 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 41,036,547 | 224 | 81 | 0 | 5 | 96 | 28 | 28 | 44 | 23 | 0 | 44 | 18 | 26 | 2 | 23 | 82 | 96 | 0 | 2 | 22 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 23,651,975 | 159 | 47 | 0 | 3 | 68 | 23 | 22 | 27 | 17 | 0 | 43 | 19 | 23 | 1 | 21 | 47 | 68 | 0 | 2 | 17 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 17,507,975 | 137 | 33 | 0 | 3 | 62 | 21 | 21 | 24 | 16 | 0 | 40 | 18 | 22 | 1 | 20 | 33 | 62 | 0 | 2 | 16 | 0 | 0 | 
| leaf | 0 | prover | 115,080,128 | 318 | 127 | 0 | 8 | 133 | 50 | 49 | 36 | 46 | 0 | 57 | 26 | 30 | 6 | 23 | 127 | 133 | 0 | 5 | 46 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 335,517,254 | 363 | 98 | 0 | 2 | 217 | 47 | 47 | 33 | 136 | 0 | 46 | 19 | 27 | 10 | 17 | 98 | 217 | 0 | 3 | 135 | 0 | 0 | 
| app_proof | prover | 1 | 303,289,171 | 383 | 92 | 0 | 15 | 247 | 77 | 77 | 29 | 140 | 0 | 43 | 17 | 25 | 8 | 17 | 92 | 247 | 0 | 2 | 138 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 143 | 754 | 143 | 168 | 2 | 126 | 78 | 2,208,000 | 38.04 | 
| app_proof | 1 | 148 | 643 | 148 | 40 | 0 | 131 | 70 | 1,929,067 | 39.27 | 

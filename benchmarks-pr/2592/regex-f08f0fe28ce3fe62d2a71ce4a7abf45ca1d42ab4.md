...
| `total_proof_time_ms ` |  695.50 |  1,391 |  757 |  634 |
| `execute_metered_time_ms` |  32 | -          | -          | -          |
| `execute_metered_insns` |  4,137,067 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  129.03 | -          |  129.03 |  129.03 |
| `execute_preflight_insns` |  2,068,533.50 |  4,137,067 |  2,208,000 |  1,929,067 |
| `execute_preflight_time_ms` |  74 |  148 |  79 |  69 |
| `execute_preflight_insn_mi/s` |  39.29 | -          |  40.25 |  38.32 |
| `trace_gen_time_ms   ` |  147.50 |  295 |  150 |  145 |
| `memory_finalize_time_ms` |  1 |  2 |  2 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  371.50 |  743 |  374 |  369 |
| `prover.main_trace_commit_time_ms` |  93.50 |  187 |  99 |  88 |
| `prover.rap_constraints_time_ms` |  238 |  476 |  249 |  227 |
| `prover.openings_time_ms` |  38.50 |  77 |  41 |  36 |
| `prover.rap_constraints.logup_gkr_time_ms` |  136 |  272 |  138 |  134 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/f08f0fe28ce3fe62d2a71ce4a7abf45ca1d42ab4/regex-f08f0fe28ce3fe62d2a71ce4a7abf45ca1d42ab4.memory.svg)
...
| app_proof |  |  |  |  |  | 634 |  |  | 32 | 4,137,067 | 129.03 | 0 | 1,437 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 27,256,571 | 208 | 80 | 0 | 0 | 96 | 31 | 30 | 45 | 19 | 0 | 30 | 18 | 11 | 2 | 8 | 81 | 96 | 0 | 2 | 18 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,703 | 140 | 45 | 0 | 0 | 66 | 24 | 24 | 27 | 14 | 0 | 26 | 18 | 8 | 1 | 6 | 46 | 66 | 0 | 2 | 12 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 119 | 31 | 0 | 0 | 61 | 23 | 22 | 24 | 13 | 0 | 26 | 18 | 7 | 1 | 5 | 31 | 61 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 79,962,804 | 309 | 126 | 0 | 0 | 136 | 54 | 53 | 37 | 44 | 0 | 45 | 30 | 15 | 6 | 8 | 126 | 136 | 0 | 5 | 43 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 123,384,338 | 369 | 99 | 0 | 0 | 227 | 54 | 54 | 34 | 138 | 0 | 41 | 21 | 19 | 10 | 9 | 99 | 227 | 0 | 3 | 137 | 0 | 0 | 
| app_proof | prover | 1 | 106,568,591 | 374 | 88 | 0 | 8 | 249 | 84 | 84 | 29 | 134 | 0 | 36 | 17 | 18 | 8 | 10 | 88 | 249 | 0 | 2 | 133 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 145 | 757 | 145 | 162 | 2 | 7 | 79 | 2,208,000 | 38.32 | 
| app_proof | 1 | 150 | 634 | 150 | 41 | 0 | 2 | 69 | 1,929,067 | 40.25 | 

...
|:---|---:|---:|---:|
| Total |  2.64 |  1.96 |  1.96 |
| app_proof |  1.92 |  1.24 |  1.24 |
| leaf |  0.41 |  0.41 |  0.41 |
...
| `total_proof_time_ms ` |  942 |  1,884 |  1,208 |  676 |
| `execute_metered_time_ms` |  34 | -          | -          | -          |
| `execute_metered_insns` |  2,579,903 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  74.39 | -          |  74.39 |  74.39 |
| `execute_preflight_insns` |  1,289,951.50 |  2,579,903 |  1,540,000 |  1,039,903 |
| `execute_preflight_time_ms` |  100.50 |  201 |  137 |  64 |
| `execute_preflight_insn_mi/s` |  35.27 | -          |  36.32 |  34.23 |
| `trace_gen_time_ms   ` |  25.50 |  51 |  35 |  16 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  706.50 |  1,413 |  932 |  481 |
| `prover.main_trace_commit_time_ms` |  211.50 |  423 |  287 |  136 |
| `prover.rap_constraints_time_ms` |  447.50 |  895 |  590 |  305 |
| `prover.openings_time_ms` |  47 |  94 |  54 |  40 |
| `prover.rap_constraints.logup_gkr_time_ms` |  81 |  162 |  109 |  53 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/b8194ef7a93d5abead2ef60d2ce9a38e2b287521/kitchen_sink-b8194ef7a93d5abead2ef60d2ce9a38e2b287521.memory.svg)
...
| app_proof |  |  |  |  |  | 676 |  |  | 34 | 2,579,903 | 74.39 | 0 | 1,924 |  | 
...
| leaf | 0 | 112 | 409 | 112 | 23 | 9 | 21 | 5 | 5 | 
...
| leaf | 0 | prover | 265,006,708 | 296 | 127 | 0 | 1 | 139 | 48 | 47 | 37 | 53 | 0 | 28 | 12 | 15 | 7 | 8 | 128 | 139 | 0 | 2 | 53 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 567,917,156 | 932 | 286 | 0 | 158 | 590 | 353 | 351 | 127 | 109 | 53 | 54 | 13 | 41 | 15 | 25 | 287 | 590 | 0 | 1 | 55 | 0 | 0 | 
| app_proof | prover | 1 | 537,266,124 | 481 | 135 | 0 | 1 | 305 | 176 | 175 | 74 | 53 | 0 | 40 | 12 | 27 | 14 | 13 | 136 | 305 | 0 | 1 | 52 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 35 | 1,208 | 35 | 176 | 0 | 3 | 64 | 1,540,000 | 34.23 | 
| app_proof | 1 | 16 | 676 | 16 | 40 | 0 | 1 | 137 | 1,039,903 | 36.32 | 

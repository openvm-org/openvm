...
| `total_proof_time_ms ` |  1,137.50 |  2,275 |  1,815 |  460 |
| `execute_metered_time_ms` |  34 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  74.71 | -          |  74.71 |  74.71 |
| `execute_preflight_insns` |  1,289,951.50 |  2,579,903 |  2,020,000 |  559,903 |
| `execute_preflight_time_ms` |  76.50 |  153 |  77 |  76 |
| `execute_preflight_insn_mi/s` |  36.35 | -          |  37.58 |  35.13 |
| `trace_gen_time_ms   ` |  57 |  114 |  93 |  21 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  892 |  1,784 |  1,463 |  321 |
| `prover.main_trace_commit_time_ms` |  293 |  586 |  504 |  82 |
| `prover.rap_constraints_time_ms` |  532.50 |  1,065 |  863 |  202 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/28d01d234d8b79ef6def2c0139ab9f6eb9f26336/kitchen_sink-28d01d234d8b79ef6def2c0139ab9f6eb9f26336.memory.svg)
...
| app_proof |  |  |  |  |  | 460 |  |  | 34 | 2,579,903 | 74.71 | 0 | 2,315 |  | 
...
| leaf | 0 | 121 | 441 | 120 | 26 | 12 | 21 | 2 | 2 | 
...
| internal_recursive.0 | 1 | prover | 23,651,975 | 100 | 19 | 0 | 4 | 51 | 17 | 16 | 20 | 13 | 0 | 30 | 8 | 21 | 1 | 20 | 19 | 51 | 0 | 1 | 12 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 17,507,975 | 93 | 14 | 0 | 4 | 48 | 16 | 16 | 18 | 13 | 0 | 30 | 9 | 21 | 0 | 20 | 14 | 48 | 0 | 1 | 12 | 0 | 0 | 
| leaf | 0 | prover | 428,317,568 | 319 | 130 | 0 | 10 | 145 | 47 | 46 | 37 | 60 | 0 | 43 | 11 | 31 | 7 | 24 | 131 | 145 | 0 | 2 | 59 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,221,261,804 | 1,463 | 503 | 0 | 285 | 863 | 447 | 445 | 142 | 273 | 135 | 94 | 17 | 77 | 26 | 51 | 504 | 863 | 0 | 1 | 137 | 0 | 0 | 
| app_proof | prover | 1 | 370,741,140 | 321 | 82 | 0 | 17 | 202 | 112 | 111 | 46 | 43 | 0 | 35 | 9 | 26 | 7 | 18 | 82 | 202 | 0 | 1 | 43 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 93 | 1,815 | 93 | 182 | 0 | 3 | 76 | 2,020,000 | 35.13 | 
| app_proof | 1 | 21 | 460 | 20 | 40 | 0 | 1 | 77 | 559,903 | 37.58 | 

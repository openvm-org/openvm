...
| halo2_outer |  154.10 |  154.10 |  154.10 |
...
| `execute_preflight_time_ms` |  2 |  2 |  2 |  2 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  28,189 |  28,189 |  28,189 |  28,189 |
| `prover.main_trace_commit_time_ms` |  740 |  740 |  740 |  740 |
| `prover.rap_constraints_time_ms` |  4,618 |  4,618 |  4,618 |  4,618 |
| `prover.openings_time_ms` |  22,831 |  22,831 |  22,831 |  22,831 |
| `prover.rap_constraints.logup_gkr_time_ms` |  4,568 |  4,568 |  4,568 |  4,568 |
| `prover.rap_constraints.round0_time_ms` |  19 |  19 |  19 |  19 |
...
| `prover.openings.whir_time_ms` |  22,806 |  22,806 |  22,806 |  22,806 |

| halo2_outer |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  154,096 |  154,096 |  154,096 |  154,096 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/2a70f589f134d26d3b717e3133994bb35a4830ed/ecrecover_e2e-2a70f589f134d26d3b717e3133994bb35a4830ed.memory.svg)
...
| internal_recursive.0 | 1 | prover | 23,651,975 | 100 | 19 | 0 | 3 | 51 | 17 | 16 | 20 | 13 | 0 | 30 | 8 | 21 | 1 | 20 | 19 | 51 | 0 | 1 | 12 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 17,507,975 | 93 | 14 | 0 | 3 | 49 | 17 | 16 | 18 | 13 | 0 | 28 | 7 | 21 | 0 | 20 | 14 | 49 | 0 | 1 | 12 | 0 | 0 | 
| leaf | 0 | prover | 76,380,355 | 126 | 24 | 0 | 3 | 68 | 23 | 23 | 19 | 24 | 0 | 33 | 10 | 22 | 1 | 20 | 25 | 68 | 0 | 2 | 24 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| root | prover | 22,883,486 | 28,189 | 739 | 0 | 5 | 4,618 | 19 | 18 | 30 | 4,568 | 0 | 22,831 | 22,806 | 24 | 1 | 23 | 740 | 4,618 | 0 | 185 | 15 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 40,267,556 | 159 | 24 | 0 | 18 | 107 | 63 | 63 | 16 | 27 | 0 | 27 | 7 | 19 | 1 | 18 | 24 | 107 | 0 | 1 | 26 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 143 | 554 | 143 | 240 | 0 | 2 | 12 | 123,583 | 13.86 | 

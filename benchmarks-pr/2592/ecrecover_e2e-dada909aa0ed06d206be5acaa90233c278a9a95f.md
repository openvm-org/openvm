...
| root |  29.11 |  29.11 |  29.11 |
| halo2_outer |  154.91 |  154.91 |  154.91 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  29,108 |  29,108 |  29,108 |  29,108 |
| `execute_preflight_time_ms` |  2 |  2 |  2 |  2 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  28,986 |  28,986 |  28,986 |  28,986 |
| `prover.main_trace_commit_time_ms` |  739 |  739 |  739 |  739 |
| `prover.rap_constraints_time_ms` |  5,580 |  5,580 |  5,580 |  5,580 |
| `prover.openings_time_ms` |  22,666 |  22,666 |  22,666 |  22,666 |
| `prover.rap_constraints.logup_gkr_time_ms` |  5,530 |  5,530 |  5,530 |  5,530 |
| `prover.rap_constraints.round0_time_ms` |  19 |  19 |  19 |  19 |
...
| `prover.openings.whir_time_ms` |  22,641 |  22,641 |  22,641 |  22,641 |

| halo2_outer |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  154,911 |  154,911 |  154,911 |  154,911 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/dada909aa0ed06d206be5acaa90233c278a9a95f/ecrecover_e2e-dada909aa0ed06d206be5acaa90233c278a9a95f.memory.svg)
...
| internal_recursive.0 | 1 | prover | 23,651,975 | 100 | 19 | 0 | 3 | 50 | 17 | 17 | 19 | 13 | 0 | 30 | 8 | 21 | 1 | 20 | 19 | 50 | 0 | 1 | 12 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 17,507,975 | 95 | 14 | 0 | 4 | 49 | 17 | 16 | 18 | 13 | 0 | 30 | 8 | 22 | 0 | 21 | 15 | 49 | 0 | 1 | 13 | 0 | 0 | 
| leaf | 0 | prover | 76,380,355 | 128 | 24 | 0 | 3 | 67 | 23 | 22 | 19 | 24 | 0 | 35 | 12 | 22 | 1 | 20 | 25 | 67 | 0 | 2 | 24 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| root | prover | 22,883,486 | 28,986 | 739 | 0 | 5 | 5,580 | 19 | 18 | 30 | 5,530 | 0 | 22,666 | 22,641 | 24 | 1 | 22 | 739 | 5,580 | 0 | 185 | 15 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 40,267,556 | 157 | 23 | 0 | 18 | 106 | 63 | 62 | 15 | 27 | 0 | 26 | 7 | 19 | 1 | 18 | 24 | 106 | 0 | 1 | 27 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 145 | 553 | 145 | 237 | 0 | 2 | 12 | 123,583 | 14.49 | 

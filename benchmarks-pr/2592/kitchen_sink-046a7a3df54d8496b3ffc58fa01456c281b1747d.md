...
| `total_proof_time_ms ` |  1,046 |  2,092 |  1,313 |  779 |
...
| `execute_preflight_insn_mi/s` |  34.25 | -          |  35.22 |  33.28 |
| `trace_gen_time_ms   ` |  26 |  52 |  36 |  16 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  807 |  1,614 |  1,026 |  588 |
| `prover.main_trace_commit_time_ms` |  226.50 |  453 |  304 |  149 |
| `prover.rap_constraints_time_ms` |  518.50 |  1,037 |  648 |  389 |
| `prover.openings_time_ms` |  61.50 |  123 |  74 |  49 |
| `prover.rap_constraints.logup_gkr_time_ms` |  152.50 |  305 |  170 |  135 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/046a7a3df54d8496b3ffc58fa01456c281b1747d/kitchen_sink-046a7a3df54d8496b3ffc58fa01456c281b1747d.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 71 | 3 |  |  | 0 |  | 337 | 3 |  |  |  |  |  |  | 
| app_proof |  |  |  |  |  | 779 |  |  | 34 | 2,579,903 | 73.84 | 0 | 2,132 |  | 
...
| leaf | 0 | 113 | 433 | 112 | 24 | 11 | 20 | 4 | 4 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 787,664,364 | 1,026 | 303 | 0 | 173 | 648 | 348 | 347 | 129 | 170 | 70 | 74 | 12 | 62 | 15 | 46 | 304 | 648 | 0 | 1 | 98 | 0 | 0 | 
| app_proof | prover | 1 | 700,866,292 | 588 | 148 | 0 | 23 | 389 | 177 | 177 | 75 | 135 | 73 | 49 | 12 | 37 | 14 | 22 | 149 | 389 | 0 | 1 | 61 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 36 | 1,313 | 36 | 185 | 0 | 3 | 64 | 1,540,000 | 33.28 | 
| app_proof | 1 | 16 | 779 | 16 | 40 | 0 | 1 | 133 | 1,039,903 | 35.22 | 

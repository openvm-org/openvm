...
|:---|---:|---:|---:|
| Total |  12.55 |  3.60 |  3.60 |
| app_proof |  10.34 |  1.88 |  1.88 |
| leaf |  1.46 |  0.97 |  0.97 |
...
| `total_proof_time_ms ` |  1,700.17 |  10,201 |  1,738 |  1,644 |
| `execute_metered_time_ms` |  139 | -          | -          | -          |
| `execute_metered_insns` |  14,793,960 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  106.41 | -          |  106.41 |  106.41 |
| `execute_preflight_insns` |  2,465,660 |  14,793,960 |  2,625,000 |  1,670,960 |
| `execute_preflight_time_ms` |  122.50 |  735 |  154 |  85 |
| `execute_preflight_insn_mi/s` |  40.92 | -          |  41.51 |  38.86 |
| `trace_gen_time_ms   ` |  161.50 |  969 |  195 |  138 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,276.67 |  7,660 |  1,306 |  1,233 |
| `prover.main_trace_commit_time_ms` |  285.33 |  1,712 |  287 |  284 |
| `prover.rap_constraints_time_ms` |  905.50 |  5,433 |  931 |  861 |
| `prover.openings_time_ms` |  85.17 |  511 |  90 |  82 |
| `prover.rap_constraints.logup_gkr_time_ms` |  292.33 |  1,754 |  308 |  242 |
| `prover.rap_constraints.round0_time_ms` |  444.17 |  2,665 |  458 |  386 |
| `prover.rap_constraints.mle_rounds_time_ms` |  168 |  1,008 |  170 |  164 |
...
| `prover.openings.whir_time_ms` |  30.33 |  182 |  34 |  28 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  729 |  1,458 |  967 |  491 |
| `execute_preflight_time_ms` |  2 |  4 |  2 |  2 |
| `trace_gen_time_ms   ` |  76 |  152 |  103 |  49 |
| `generate_blob_total_time_ms` |  9.50 |  19 |  13 |  6 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  652 |  1,304 |  863 |  441 |
| `prover.main_trace_commit_time_ms` |  360.50 |  721 |  501 |  220 |
| `prover.rap_constraints_time_ms` |  225.50 |  451 |  284 |  167 |
| `prover.openings_time_ms` |  65 |  130 |  77 |  53 |
...
| `prover.openings.whir_time_ms` |  33.50 |  67 |  36 |  31 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/307dc7e2b3ffbcceb0252c03e59d77171375fc5e/sha2_bench-307dc7e2b3ffbcceb0252c03e59d77171375fc5e.memory.svg)
...
| app_proof |  |  |  |  |  | 1,701 |  |  | 139 | 14,793,960 | 106.41 | 0 | 10,348 |  | 
| internal_for_leaf |  |  |  | 462 |  |  |  |  |  |  |  |  |  | 463 | 
...
| leaf | 0 | 103 | 967 | 102 | 36 | 13 | 2 | 3 | 3 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 75,647,860 | 431 | 224 | 0 | 1 | 161 | 45 | 45 | 86 | 30 | 0 | 44 | 22 | 22 | 7 | 15 | 225 | 161 | 0 | 3 | 29 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,879 | 150 | 49 | 0 | 0 | 73 | 26 | 25 | 29 | 17 | 0 | 27 | 18 | 8 | 1 | 6 | 49 | 73 | 0 | 2 | 16 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 122 | 31 | 0 | 0 | 62 | 24 | 23 | 24 | 13 | 0 | 27 | 20 | 7 | 1 | 5 | 31 | 62 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 266,560,230 | 863 | 501 | 0 | 95 | 284 | 132 | 131 | 79 | 73 | 0 | 77 | 36 | 40 | 22 | 18 | 501 | 284 | 0 | 6 | 71 | 0 | 0 | 
| leaf | 1 | prover | 135,246,516 | 441 | 220 | 0 | 1 | 167 | 73 | 72 | 48 | 45 | 0 | 53 | 31 | 22 | 11 | 11 | 220 | 167 | 0 | 5 | 44 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 353,899,717 | 1,233 | 287 | 0 | 1 | 861 | 386 | 385 | 167 | 308 | 76 | 84 | 29 | 55 | 31 | 23 | 287 | 861 | 0 | 3 | 230 | 0 | 0 | 
| app_proof | prover | 1 | 353,899,532 | 1,306 | 285 | 0 | 1 | 931 | 458 | 458 | 170 | 302 | 77 | 90 | 34 | 55 | 32 | 22 | 285 | 931 | 0 | 4 | 224 | 0 | 0 | 
| app_proof | prover | 2 | 353,899,532 | 1,300 | 286 | 0 | 1 | 929 | 457 | 457 | 169 | 301 | 76 | 84 | 30 | 54 | 32 | 22 | 286 | 929 | 0 | 3 | 222 | 0 | 0 | 
| app_proof | prover | 3 | 353,899,532 | 1,241 | 285 | 0 | 1 | 870 | 457 | 457 | 170 | 242 | 0 | 86 | 31 | 54 | 32 | 22 | 285 | 870 | 0 | 4 | 241 | 0 | 0 | 
| app_proof | prover | 4 | 353,899,532 | 1,298 | 284 | 0 | 1 | 928 | 457 | 457 | 168 | 302 | 77 | 85 | 30 | 54 | 31 | 22 | 284 | 928 | 0 | 4 | 224 | 0 | 0 | 
| app_proof | prover | 5 | 353,980,012 | 1,282 | 284 | 0 | 1 | 914 | 450 | 449 | 164 | 299 | 77 | 82 | 28 | 53 | 31 | 21 | 285 | 914 | 0 | 3 | 221 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 163 | 1,644 | 163 | 162 | 0 | 3 | 85 | 2,623,000 | 38.86 | 
| app_proof | 1 | 138 | 1,738 | 138 | 138 | 0 | 2 | 154 | 2,625,000 | 41.38 | 
| app_proof | 2 | 159 | 1,728 | 159 | 133 | 0 | 2 | 136 | 2,625,000 | 41.14 | 
| app_proof | 3 | 157 | 1,667 | 157 | 132 | 0 | 2 | 135 | 2,625,000 | 41.51 | 
| app_proof | 4 | 157 | 1,723 | 157 | 131 | 0 | 2 | 135 | 2,625,000 | 41.51 | 
| app_proof | 5 | 195 | 1,701 | 195 | 133 | 0 | 2 | 90 | 1,670,960 | 41.14 | 

...
| `total_proof_time_ms ` |  542.86 |  3,800 |  653 |  518 |
| `execute_metered_time_ms` |  65 | -          | -          | -          |
| `execute_metered_insns` |  12,000,265 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  182.81 | -          |  182.81 |  182.81 |
| `execute_preflight_insns` |  1,714,323.57 |  12,000,265 |  1,747,000 |  1,518,265 |
| `execute_preflight_time_ms` |  58 |  406 |  62 |  51 |
| `execute_preflight_insn_mi/s` |  39.36 | -          |  39.43 |  39.10 |
| `trace_gen_time_ms   ` |  161 |  1,127 |  168 |  158 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  264.57 |  1,852 |  269 |  258 |
| `prover.main_trace_commit_time_ms` |  59 |  413 |  59 |  59 |
| `prover.rap_constraints_time_ms` |  169.71 |  1,188 |  174 |  167 |
| `prover.openings_time_ms` |  34.57 |  242 |  40 |  30 |
| `prover.rap_constraints.logup_gkr_time_ms` |  116.57 |  816 |  119 |  115 |
| `prover.rap_constraints.round0_time_ms` |  32.57 |  228 |  34 |  32 |
| `prover.rap_constraints.mle_rounds_time_ms` |  19.71 |  138 |  20 |  19 |
| `prover.openings.stacked_reduction_time_ms` |  11.86 |  83 |  13 |  11 |
...
| `prover.openings.whir_time_ms` |  22 |  154 |  27 |  18 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  460.50 |  921 |  533 |  388 |
| `execute_preflight_time_ms` |  1 |  2 |  1 |  1 |
| `trace_gen_time_ms   ` |  48 |  96 |  59 |  37 |
| `generate_blob_total_time_ms` |  3 |  6 |  3 |  3 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  411.50 |  823 |  473 |  350 |
| `prover.main_trace_commit_time_ms` |  197 |  394 |  234 |  160 |
| `prover.rap_constraints_time_ms` |  163.50 |  327 |  182 |  145 |
| `prover.openings_time_ms` |  50 |  100 |  56 |  44 |
| `prover.rap_constraints.logup_gkr_time_ms` |  38.50 |  77 |  44 |  33 |
...
| `prover.openings.whir_time_ms` |  29 |  58 |  32 |  26 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/93afded000b4f03fccc2b654c7d83a6dfc62bb60/fibonacci-93afded000b4f03fccc2b654c7d83a6dfc62bb60.memory.svg)
...
| app_proof |  |  |  |  |  | 524 |  |  | 65 | 12,000,265 | 182.81 | 0 | 3,874 |  | 
| internal_for_leaf |  |  |  | 371 |  |  |  |  |  |  |  |  |  | 371 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 53,005,172 | 344 | 160 | 0 | 0 | 145 | 42 | 41 | 72 | 29 | 0 | 37 | 20 | 17 | 5 | 12 | 160 | 145 | 0 | 2 | 28 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,703 | 142 | 46 | 0 | 0 | 68 | 25 | 25 | 28 | 13 | 0 | 27 | 18 | 8 | 1 | 6 | 46 | 68 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 118 | 31 | 0 | 0 | 61 | 23 | 23 | 24 | 13 | 0 | 24 | 17 | 7 | 1 | 5 | 31 | 61 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 147,940,262 | 473 | 233 | 0 | 1 | 182 | 85 | 84 | 52 | 44 | 0 | 56 | 32 | 24 | 12 | 11 | 234 | 182 | 0 | 6 | 43 | 0 | 0 | 
| leaf | 1 | prover | 98,736,950 | 350 | 160 | 0 | 0 | 145 | 67 | 66 | 45 | 33 | 0 | 44 | 26 | 17 | 8 | 9 | 160 | 145 | 0 | 5 | 31 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 70,295,622 | 269 | 59 | 0 | 0 | 174 | 34 | 34 | 20 | 119 | 0 | 35 | 22 | 12 | 6 | 6 | 59 | 174 | 0 | 3 | 118 | 0 | 0 | 
| app_proof | prover | 1 | 70,248,284 | 258 | 59 | 0 | 0 | 167 | 32 | 31 | 19 | 115 | 0 | 30 | 18 | 11 | 6 | 5 | 59 | 167 | 0 | 3 | 115 | 0 | 0 | 
| app_proof | prover | 2 | 70,248,284 | 264 | 59 | 0 | 0 | 168 | 32 | 32 | 19 | 116 | 0 | 36 | 24 | 11 | 6 | 5 | 59 | 168 | 0 | 3 | 115 | 0 | 0 | 
| app_proof | prover | 3 | 70,248,284 | 263 | 59 | 0 | 0 | 170 | 33 | 33 | 20 | 116 | 0 | 33 | 20 | 12 | 6 | 5 | 59 | 170 | 0 | 3 | 115 | 0 | 0 | 
| app_proof | prover | 4 | 70,248,284 | 269 | 59 | 0 | 0 | 169 | 32 | 31 | 20 | 117 | 0 | 40 | 27 | 12 | 6 | 5 | 59 | 169 | 0 | 3 | 116 | 0 | 0 | 
| app_proof | prover | 5 | 70,248,284 | 265 | 59 | 0 | 0 | 168 | 32 | 31 | 20 | 116 | 0 | 36 | 24 | 12 | 6 | 5 | 59 | 168 | 0 | 3 | 115 | 0 | 0 | 
| app_proof | prover | 6 | 70,295,004 | 264 | 59 | 0 | 0 | 172 | 33 | 33 | 20 | 117 | 0 | 32 | 19 | 13 | 6 | 6 | 59 | 172 | 0 | 3 | 115 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 158 | 653 | 158 | 162 | 0 | 3 | 62 | 1,747,000 | 39.10 | 
| app_proof | 1 | 159 | 518 | 159 | 40 | 0 | 1 | 59 | 1,747,000 | 39.40 | 
| app_proof | 2 | 161 | 525 | 161 | 40 | 0 | 1 | 58 | 1,747,000 | 39.40 | 
| app_proof | 3 | 160 | 523 | 160 | 40 | 0 | 1 | 59 | 1,747,000 | 39.36 | 
| app_proof | 4 | 159 | 530 | 159 | 41 | 0 | 1 | 59 | 1,747,000 | 39.42 | 
| app_proof | 5 | 162 | 527 | 162 | 41 | 0 | 1 | 58 | 1,747,000 | 39.43 | 
| app_proof | 6 | 168 | 524 | 167 | 41 | 0 | 1 | 51 | 1,518,265 | 39.39 | 

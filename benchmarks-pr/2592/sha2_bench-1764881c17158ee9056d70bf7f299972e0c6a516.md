...
|:---|---:|---:|---:|
| Total |  11.50 |  3.52 |  3.52 |
| app_proof |  9.27 |  1.80 |  1.80 |
| leaf |  1.41 |  0.90 |  0.90 |
...
| `total_proof_time_ms ` |  1,521 |  9,126 |  1,657 |  1,434 |
| `execute_metered_time_ms` |  145 | -          | -          | -          |
| `execute_metered_insns` |  14,793,960 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  102.01 | -          |  102.01 |  102.01 |
| `execute_preflight_insns` |  2,465,660 |  14,793,960 |  2,625,000 |  1,670,960 |
| `execute_preflight_time_ms` |  120.50 |  723 |  151 |  82 |
| `execute_preflight_insn_mi/s` |  41.51 | -          |  42.41 |  39.75 |
| `trace_gen_time_ms   ` |  133 |  798 |  169 |  112 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,189.17 |  7,135 |  1,228 |  1,156 |
| `prover.main_trace_commit_time_ms` |  287.17 |  1,723 |  289 |  285 |
| `prover.rap_constraints_time_ms` |  810 |  4,860 |  849 |  776 |
| `prover.openings_time_ms` |  90.50 |  543 |  93 |  89 |
| `prover.rap_constraints.logup_gkr_time_ms` |  274.67 |  1,648 |  313 |  255 |
| `prover.rap_constraints.round0_time_ms` |  366.17 |  2,197 |  372 |  357 |
| `prover.rap_constraints.mle_rounds_time_ms` |  168.17 |  1,009 |  171 |  163 |
...
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  28.67 |  172 |  29 |  28 |
| `prover.openings.whir_time_ms` |  28.83 |  173 |  30 |  28 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  705.50 |  1,411 |  899 |  512 |
| `execute_preflight_time_ms` |  2 |  4 |  2 |  2 |
| `trace_gen_time_ms   ` |  79 |  158 |  109 |  49 |
| `generate_blob_total_time_ms` |  14 |  28 |  21 |  7 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  625.50 |  1,251 |  789 |  462 |
| `prover.main_trace_commit_time_ms` |  318 |  636 |  411 |  225 |
| `prover.rap_constraints_time_ms` |  230 |  460 |  289 |  171 |
| `prover.openings_time_ms` |  77 |  154 |  89 |  65 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/1764881c17158ee9056d70bf7f299972e0c6a516/sha2_bench-1764881c17158ee9056d70bf7f299972e0c6a516.memory.svg)
...
| app_proof |  |  |  |  |  | 1,434 |  |  | 145 | 14,793,960 | 102.01 | 0 | 9,279 |  | 
...
| leaf | 0 | 109 | 899 | 109 | 44 | 21 | 2 | 3 | 3 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 75,647,860 | 451 | 228 | 0 | 13 | 166 | 44 | 44 | 87 | 35 | 0 | 55 | 18 | 37 | 7 | 29 | 229 | 166 | 0 | 3 | 34 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,879 | 173 | 50 | 0 | 4 | 78 | 25 | 24 | 28 | 23 | 0 | 44 | 20 | 23 | 1 | 21 | 50 | 78 | 0 | 2 | 23 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 142 | 34 | 0 | 4 | 66 | 22 | 22 | 24 | 19 | 0 | 41 | 18 | 22 | 1 | 20 | 34 | 66 | 0 | 2 | 17 | 0 | 0 | 
| leaf | 0 | prover | 266,560,230 | 789 | 410 | 0 | 26 | 289 | 131 | 130 | 79 | 78 | 0 | 89 | 33 | 55 | 22 | 33 | 411 | 289 | 0 | 5 | 76 | 0 | 0 | 
| leaf | 1 | prover | 135,246,516 | 462 | 224 | 0 | 13 | 171 | 72 | 71 | 48 | 50 | 0 | 65 | 27 | 37 | 11 | 26 | 225 | 171 | 0 | 5 | 49 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 353,899,717 | 1,228 | 287 | 0 | 21 | 847 | 367 | 367 | 167 | 312 | 72 | 93 | 30 | 62 | 32 | 29 | 287 | 847 | 0 | 3 | 239 | 0 | 0 | 
| app_proof | prover | 1 | 353,899,532 | 1,226 | 286 | 0 | 19 | 849 | 366 | 365 | 169 | 313 | 73 | 89 | 28 | 61 | 33 | 28 | 286 | 849 | 0 | 3 | 239 | 0 | 0 | 
| app_proof | prover | 2 | 353,899,532 | 1,176 | 285 | 0 | 19 | 799 | 372 | 372 | 170 | 256 | 0 | 90 | 28 | 62 | 33 | 29 | 285 | 799 | 0 | 3 | 255 | 0 | 0 | 
| app_proof | prover | 3 | 353,899,532 | 1,176 | 288 | 0 | 19 | 795 | 367 | 366 | 171 | 256 | 0 | 92 | 30 | 61 | 32 | 29 | 288 | 795 | 0 | 3 | 255 | 0 | 0 | 
| app_proof | prover | 4 | 353,899,532 | 1,173 | 288 | 0 | 19 | 794 | 368 | 367 | 169 | 256 | 0 | 90 | 29 | 60 | 32 | 28 | 288 | 794 | 0 | 3 | 255 | 0 | 0 | 
| app_proof | prover | 5 | 353,980,012 | 1,156 | 289 | 0 | 20 | 776 | 357 | 356 | 163 | 255 | 0 | 89 | 28 | 61 | 31 | 29 | 289 | 776 | 0 | 3 | 254 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 169 | 1,643 | 169 | 163 | 0 | 3 | 82 | 2,623,000 | 39.75 | 
| app_proof | 1 | 142 | 1,657 | 142 | 136 | 0 | 2 | 151 | 2,625,000 | 42.03 | 
| app_proof | 2 | 114 | 1,465 | 114 | 41 | 0 | 3 | 133 | 2,625,000 | 42.13 | 
| app_proof | 3 | 112 | 1,465 | 112 | 41 | 0 | 2 | 135 | 2,625,000 | 40.95 | 
| app_proof | 4 | 114 | 1,462 | 114 | 41 | 0 | 2 | 133 | 2,625,000 | 42.41 | 
| app_proof | 5 | 147 | 1,434 | 147 | 41 | 0 | 2 | 89 | 1,670,960 | 41.84 | 

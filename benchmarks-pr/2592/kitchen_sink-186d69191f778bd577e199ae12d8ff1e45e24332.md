...
| `total_proof_time_ms ` |  1,081 |  2,162 |  1,349 |  813 |
...
| `execute_preflight_insn_mi/s` |  35.28 | -          |  36.49 |  34.07 |
| `trace_gen_time_ms   ` |  58 |  116 |  71 |  45 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  808.50 |  1,617 |  1,027 |  590 |
| `prover.main_trace_commit_time_ms` |  225.50 |  451 |  304 |  147 |
| `prover.rap_constraints_time_ms` |  520 |  1,040 |  648 |  392 |
| `prover.openings_time_ms` |  62 |  124 |  74 |  50 |
| `prover.rap_constraints.logup_gkr_time_ms` |  150.50 |  301 |  166 |  135 |
| `prover.rap_constraints.round0_time_ms` |  264.50 |  529 |  351 |  178 |
| `prover.rap_constraints.mle_rounds_time_ms` |  104 |  208 |  130 |  78 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/186d69191f778bd577e199ae12d8ff1e45e24332/kitchen_sink-186d69191f778bd577e199ae12d8ff1e45e24332.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 72 | 3 |  |  | 0 |  | 351 | 3 |  |  |  |  |  |  | 
| app_proof |  |  |  |  |  | 813 |  |  | 34 | 2,579,903 | 74.98 | 0 | 2,202 |  | 
...
| internal_recursive.0 | 1 | 10 | 114 | 10 | 2 | 0 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 9 | 103 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 117 | 440 | 116 | 25 | 11 | 21 | 4 | 5 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 53,472,003 | 140 | 40 | 0 | 4 | 65 | 20 | 20 | 29 | 15 | 0 | 33 | 9 | 23 | 1 | 21 | 41 | 65 | 0 | 1 | 15 | 0 | 0 | 
...
| leaf | 0 | prover | 428,317,568 | 323 | 130 | 0 | 10 | 146 | 50 | 49 | 37 | 59 | 0 | 45 | 13 | 31 | 7 | 24 | 131 | 146 | 0 | 2 | 58 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 787,664,364 | 1,027 | 303 | 0 | 172 | 648 | 351 | 350 | 130 | 166 | 65 | 74 | 12 | 61 | 16 | 45 | 304 | 648 | 0 | 1 | 99 | 0 | 0 | 
| app_proof | prover | 1 | 700,866,292 | 590 | 147 | 0 | 23 | 392 | 178 | 177 | 78 | 135 | 73 | 50 | 13 | 37 | 14 | 22 | 147 | 392 | 0 | 1 | 61 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 71 | 1,349 | 71 | 186 | 0 | 3 | 64 | 1,540,000 | 34.07 | 
| app_proof | 1 | 45 | 813 | 45 | 40 | 0 | 1 | 137 | 1,039,903 | 36.49 | 

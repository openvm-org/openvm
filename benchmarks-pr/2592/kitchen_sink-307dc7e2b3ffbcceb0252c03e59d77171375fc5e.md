...
| `total_proof_time_ms ` |  955.50 |  1,911 |  1,223 |  688 |
...
| `execute_preflight_time_ms` |  106 |  212 |  148 |  64 |
| `execute_preflight_insn_mi/s` |  35.36 | -          |  36.32 |  34.40 |
| `trace_gen_time_ms   ` |  25.50 |  51 |  35 |  16 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  714 |  1,428 |  946 |  482 |
| `prover.main_trace_commit_time_ms` |  215 |  430 |  293 |  137 |
| `prover.rap_constraints_time_ms` |  451.50 |  903 |  598 |  305 |
| `prover.openings_time_ms` |  47 |  94 |  55 |  39 |
| `prover.rap_constraints.logup_gkr_time_ms` |  84 |  168 |  113 |  55 |
| `prover.rap_constraints.round0_time_ms` |  264.50 |  529 |  354 |  175 |
| `prover.rap_constraints.mle_rounds_time_ms` |  102 |  204 |  130 |  74 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/307dc7e2b3ffbcceb0252c03e59d77171375fc5e/kitchen_sink-307dc7e2b3ffbcceb0252c03e59d77171375fc5e.memory.svg)
...
| app_proof |  |  |  |  |  | 688 |  |  | 34 | 2,579,903 | 73.87 | 0 | 1,951 |  | 
...
| internal_recursive.1 | 1 | prover | 9,750,799 | 75 | 11 | 0 | 0 | 48 | 19 | 18 | 18 | 10 | 0 | 14 | 8 | 5 | 0 | 4 | 11 | 48 | 0 | 1 | 9 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 567,917,156 | 946 | 292 | 0 | 163 | 598 | 354 | 352 | 130 | 113 | 56 | 55 | 13 | 41 | 15 | 25 | 293 | 598 | 0 | 1 | 55 | 0 | 0 | 
| app_proof | prover | 1 | 537,266,124 | 482 | 136 | 0 | 2 | 305 | 175 | 175 | 74 | 55 | 0 | 39 | 12 | 27 | 13 | 13 | 137 | 305 | 0 | 1 | 54 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 35 | 1,223 | 35 | 177 | 0 | 3 | 64 | 1,540,000 | 34.40 | 
| app_proof | 1 | 16 | 688 | 16 | 40 | 0 | 1 | 148 | 1,039,903 | 36.32 | 

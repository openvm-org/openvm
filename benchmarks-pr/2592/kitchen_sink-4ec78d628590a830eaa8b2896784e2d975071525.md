...
| `total_proof_time_ms ` |  944.50 |  1,889 |  1,214 |  675 |
...
| `execute_preflight_time_ms` |  100.50 |  201 |  139 |  62 |
| `execute_preflight_insn_mi/s` |  35.84 | -          |  36.72 |  34.95 |
| `trace_gen_time_ms   ` |  26.50 |  53 |  37 |  16 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  707 |  1,414 |  936 |  478 |
| `prover.main_trace_commit_time_ms` |  213 |  426 |  290 |  136 |
| `prover.rap_constraints_time_ms` |  448 |  896 |  594 |  302 |
| `prover.openings_time_ms` |  45 |  90 |  51 |  39 |
| `prover.rap_constraints.logup_gkr_time_ms` |  82.50 |  165 |  112 |  53 |
| `prover.rap_constraints.round0_time_ms` |  262.50 |  525 |  352 |  173 |
...
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  17 |  34 |  22 |  12 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/4ec78d628590a830eaa8b2896784e2d975071525/kitchen_sink-4ec78d628590a830eaa8b2896784e2d975071525.memory.svg)
...
| app_proof |  |  |  |  |  | 675 |  |  | 34 | 2,579,903 | 73.94 | 0 | 1,928 |  | 
...
| leaf | 0 | 112 | 409 | 112 | 24 | 11 | 21 | 5 | 5 | 
...
| leaf | 0 | prover | 265,006,708 | 297 | 128 | 0 | 1 | 139 | 48 | 47 | 37 | 53 | 0 | 28 | 12 | 15 | 7 | 8 | 129 | 139 | 0 | 2 | 53 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 567,917,156 | 936 | 289 | 0 | 159 | 594 | 352 | 351 | 129 | 112 | 55 | 51 | 12 | 38 | 15 | 22 | 290 | 594 | 0 | 1 | 56 | 0 | 0 | 
| app_proof | prover | 1 | 537,266,124 | 478 | 135 | 0 | 2 | 302 | 173 | 173 | 74 | 53 | 0 | 39 | 12 | 27 | 14 | 12 | 136 | 302 | 0 | 1 | 52 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 37 | 1,214 | 37 | 177 | 0 | 3 | 62 | 1,540,000 | 34.95 | 
| app_proof | 1 | 16 | 675 | 16 | 40 | 0 | 1 | 139 | 1,039,903 | 36.72 | 

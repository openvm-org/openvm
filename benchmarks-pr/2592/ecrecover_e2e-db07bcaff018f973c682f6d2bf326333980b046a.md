...
| root |  29.27 |  29.27 |  29.27 |
| halo2_outer |  154.67 |  154.67 |  154.67 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  29,274 |  29,274 |  29,274 |  29,274 |
| `execute_preflight_time_ms` |  2 |  2 |  2 |  2 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  29,156 |  29,156 |  29,156 |  29,156 |
| `prover.main_trace_commit_time_ms` |  739 |  739 |  739 |  739 |
| `prover.rap_constraints_time_ms` |  5,573 |  5,573 |  5,573 |  5,573 |
| `prover.openings_time_ms` |  22,842 |  22,842 |  22,842 |  22,842 |
| `prover.rap_constraints.logup_gkr_time_ms` |  5,523 |  5,523 |  5,523 |  5,523 |
| `prover.rap_constraints.round0_time_ms` |  19 |  19 |  19 |  19 |
...
| `prover.openings.whir_time_ms` |  22,818 |  22,818 |  22,818 |  22,818 |

| halo2_outer |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  154,672 |  154,672 |  154,672 |  154,672 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/db07bcaff018f973c682f6d2bf326333980b046a/ecrecover_e2e-db07bcaff018f973c682f6d2bf326333980b046a.memory.svg)
...
| internal_recursive.0 | 1 | prover | 23,651,975 | 102 | 19 | 0 | 4 | 51 | 17 | 17 | 20 | 13 | 0 | 31 | 9 | 22 | 1 | 20 | 19 | 51 | 0 | 1 | 12 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 17,507,975 | 93 | 14 | 0 | 3 | 48 | 17 | 16 | 18 | 13 | 0 | 29 | 8 | 21 | 0 | 20 | 14 | 48 | 0 | 1 | 12 | 0 | 0 | 
| leaf | 0 | prover | 76,380,355 | 125 | 24 | 0 | 4 | 67 | 23 | 22 | 19 | 24 | 0 | 32 | 10 | 22 | 1 | 20 | 24 | 67 | 0 | 2 | 24 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| root | prover | 22,883,486 | 29,156 | 739 | 0 | 5 | 5,573 | 19 | 18 | 30 | 5,523 | 0 | 22,842 | 22,818 | 24 | 1 | 23 | 739 | 5,573 | 0 | 185 | 15 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 40,267,556 | 160 | 24 | 0 | 18 | 107 | 64 | 63 | 16 | 27 | 0 | 27 | 7 | 19 | 1 | 18 | 24 | 107 | 0 | 1 | 27 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 142 | 554 | 142 | 238 | 0 | 2 | 12 | 123,583 | 13.94 | 

...
|:---|---:|---:|
| Total |  3.04 |  1.78 |
| regex_program |  2.100 |  1.74 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,499.50 |  2,999 |  1,738 |  1,261 |
...
| `execute_metered_insn_mi/s` |  93.68 | -          |  93.68 |  93.68 |
| `execute_preflight_insns` |  2,054,241.50 |  4,108,483 |  2,211,000 |  1,897,483 |
| `execute_preflight_time_ms` |  95.50 |  191 |  109 |  82 |
| `execute_preflight_insn_mi/s` |  31.61 | -          |  33.71 |  29.52 |
| `trace_gen_time_ms   ` |  319 |  638 |  340 |  298 |
| `memory_finalize_time_ms` |  2 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  996.50 |  1,993 |  1,230 |  763 |
| `main_trace_commit_time_ms` |  144 |  288 |  188 |  100 |
| `generate_perm_trace_time_ms` |  63.50 |  127 |  79 |  48 |
| `perm_trace_commit_time_ms` |  176.43 |  352.86 |  229.48 |  123.38 |
| `quotient_poly_compute_time_ms` |  168.58 |  337.17 |  185.13 |  152.04 |
| `quotient_poly_commit_time_ms` |  37.12 |  74.23 |  49.24 |  24.100 |
| `pcs_opening_time_ms ` |  399.50 |  799 |  528 |  271 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 1,261 | 41 | 1 | 43 | 4,108,483 | 93.68 | 248 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 298 | 1,738 | 23,397,108 | 373,183,036 | 298 | 1,230 | 0 | 152.04 | 49.24 | 6 | 229.48 | 528 | 309 | 528 | 4 | 188 | 10,866,434 | 79 | 82 | 2,211,000 | 29.52 | 47 | 203 | 2 | 528 | 
| regex_program | 1 | 340 | 1,261 | 11,981,356 | 196,739,722 | 340 | 763 | 2 | 185.13 | 24.100 | 5 | 123.38 | 271 | 175 | 271 | 0 | 100 | 2,537,170 | 48 | 109 | 1,897,483 | 33.71 | 28 | 215 | 2 | 271 | 

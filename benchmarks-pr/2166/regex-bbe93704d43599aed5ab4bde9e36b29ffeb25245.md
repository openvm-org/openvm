...
|:---|---:|---:|
| Total |  2.33 |  0.74 |
| regex_program |  2.29 |  0.70 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  573.75 |  2,295 |  704 |  518 |
...
| `execute_metered_insn_mi/s` |  118.65 | -          |  118.65 |  118.65 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  52.50 |  210 |  65 |  44 |
| `execute_preflight_insn_mi/s` |  32.11 | -          |  33.17 |  29.19 |
| `trace_gen_time_ms   ` |  179.75 |  719 |  214 |  156 |
| `memory_finalize_time_ms` |  0.75 |  3 |  3 |  0 |
| `stark_prove_excluding_trace_time_ms` |  273 |  1,092 |  298 |  255 |
| `main_trace_commit_time_ms` |  50.50 |  202 |  55 |  49 |
| `generate_perm_trace_time_ms` |  25 |  100 |  30 |  23 |
| `perm_trace_commit_time_ms` |  64.26 |  257.04 |  70.47 |  55.16 |
| `quotient_poly_compute_time_ms` |  57.27 |  229.09 |  68.22 |  51.11 |
| `quotient_poly_commit_time_ms` |  14.71 |  58.86 |  16.39 |  12.66 |
| `pcs_opening_time_ms ` |  58 |  232 |  72 |  47 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 552 | 40 | 1 | 34 | 4,137,502 | 118.65 | 169 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 214 | 704 | 23,446,148 | 150,778,428 | 214 | 298 | 0 | 58.16 | 16.39 | 5 | 70.47 | 72 | 95 | 72 | 3 | 55 | 10,899,170 | 23 | 44 | 1,103,000 | 29.19 | 21 | 75 | 1 | 71 | 
| regex_program | 1 | 156 | 521 | 11,598,276 | 128,513,066 | 156 | 258 | 1 | 51.11 | 14.54 | 4 | 65.14 | 52 | 89 | 52 | 0 | 49 | 2,196,106 | 23 | 65 | 1,104,000 | 32.93 | 16 | 66 | 0 | 52 | 
| regex_program | 2 | 164 | 518 | 11,579,064 | 128,513,066 | 164 | 255 | 1 | 51.61 | 15.28 | 4 | 66.27 | 47 | 90 | 47 | 0 | 49 | 2,177,334 | 24 | 57 | 1,104,000 | 33.17 | 17 | 67 | 0 | 47 | 
| regex_program | 3 | 185 | 552 | 11,853,872 | 103,456,394 | 184 | 281 | 0 | 68.22 | 12.66 | 5 | 55.16 | 61 | 88 | 61 | 0 | 49 | 2,422,606 | 30 | 44 | 826,502 | 33.17 | 18 | 81 | 1 | 61 | 

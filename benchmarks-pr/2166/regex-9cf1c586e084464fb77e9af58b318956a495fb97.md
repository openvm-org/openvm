...
| `total_proof_time_ms ` |  599.75 |  2,399 |  724 |  541 |
...
| `execute_metered_insn_mi/s` |  122 | -          |  122 |  122 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  53 |  212 |  66 |  44 |
| `execute_preflight_insn_mi/s` |  31.91 | -          |  33.25 |  29.15 |
| `trace_gen_time_ms   ` |  184.25 |  737 |  217 |  161 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  294 |  1,176 |  314 |  272 |
| `main_trace_commit_time_ms` |  53 |  212 |  58 |  51 |
| `generate_perm_trace_time_ms` |  32.50 |  130 |  50 |  23 |
| `perm_trace_commit_time_ms` |  65.34 |  261.38 |  73.74 |  55.16 |
| `quotient_poly_compute_time_ms` |  60.06 |  240.22 |  72.50 |  53.46 |
| `quotient_poly_commit_time_ms` |  15.11 |  60.45 |  16.96 |  13.08 |
| `pcs_opening_time_ms ` |  65 |  260 |  75 |  57 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 559 | 41 | 1 | 33 | 4,137,502 | 122 | 170 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 217 | 724 | 23,446,148 | 150,778,428 | 217 | 314 | 0 | 60.58 | 16.96 | 5 | 73.74 | 75 | 101 | 75 | 4 | 58 | 10,899,170 | 27 | 45 | 1,103,000 | 29.15 | 22 | 78 | 1 | 75 | 
| regex_program | 1 | 161 | 541 | 11,598,276 | 128,513,066 | 161 | 272 | 1 | 53.46 | 14.51 | 4 | 66.38 | 61 | 90 | 61 | 0 | 51 | 2,196,106 | 23 | 66 | 1,104,000 | 32.17 | 16 | 68 | 0 | 61 | 
| regex_program | 2 | 169 | 575 | 11,579,064 | 128,513,066 | 169 | 306 | 1 | 53.68 | 15.89 | 4 | 66.10 | 67 | 116 | 67 | 0 | 52 | 2,177,334 | 50 | 57 | 1,104,000 | 33.08 | 17 | 70 | 0 | 67 | 
| regex_program | 3 | 190 | 559 | 11,853,872 | 103,456,394 | 190 | 284 | 0 | 72.50 | 13.08 | 5 | 55.16 | 57 | 88 | 57 | 0 | 51 | 2,422,606 | 30 | 44 | 826,502 | 33.25 | 19 | 86 | 1 | 57 | 

...
| `total_proof_time_ms ` |  577 |  2,308 |  706 |  530 |
...
| `execute_preflight_insn_mi/s` |  30.10 | -          |  31.19 |  27 |
| `trace_gen_time_ms   ` |  173 |  692 |  206 |  149 |
| `memory_finalize_time_ms` |  0.75 |  3 |  3 |  0 |
| `stark_prove_excluding_trace_time_ms` |  281 |  1,124 |  308 |  264 |
| `main_trace_commit_time_ms` |  50.75 |  203 |  55 |  48 |
| `generate_perm_trace_time_ms` |  34.75 |  139 |  55 |  19 |
| `perm_trace_commit_time_ms` |  62.82 |  251.26 |  67.33 |  54.15 |
| `quotient_poly_compute_time_ms` |  55.29 |  221.17 |  69.19 |  49.95 |
| `quotient_poly_commit_time_ms` |  14.46 |  57.85 |  16.34 |  12.44 |
| `pcs_opening_time_ms ` |  60 |  240 |  62 |  56 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 532 | 40 | 1 | 34 | 4,137,502 | 119.23 | 167 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 206 | 706 | 23,446,148 | 150,778,428 | 206 | 308 | 0 | 50.27 | 16.34 | 5 | 67.33 | 61 | 123 | 61 | 3 | 55 | 10,899,170 | 55 | 47 | 1,103,000 | 27 | 21 | 67 | 1 | 61 | 
| regex_program | 1 | 149 | 540 | 11,598,276 | 128,513,066 | 149 | 281 | 1 | 49.95 | 14.47 | 4 | 64.65 | 62 | 103 | 62 | 0 | 50 | 2,196,106 | 38 | 68 | 1,104,000 | 31.17 | 16 | 64 | 0 | 62 | 
| regex_program | 2 | 157 | 530 | 11,579,064 | 128,513,066 | 157 | 271 | 1 | 51.77 | 14.59 | 4 | 65.14 | 61 | 93 | 60 | 0 | 50 | 2,177,334 | 27 | 59 | 1,104,000 | 31.03 | 16 | 66 | 0 | 60 | 
| regex_program | 3 | 180 | 532 | 11,853,872 | 103,456,394 | 180 | 264 | 0 | 69.19 | 12.44 | 5 | 54.15 | 56 | 76 | 55 | 0 | 48 | 2,422,606 | 19 | 46 | 826,502 | 31.19 | 18 | 82 | 1 | 55 | 

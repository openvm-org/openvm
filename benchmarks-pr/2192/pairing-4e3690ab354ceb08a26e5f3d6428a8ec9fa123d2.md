...
| `total_proof_time_ms ` |  715 |  1,430 |  826 |  604 |
...
| `execute_preflight_insn_mi/s` |  13.62 | -          |  18.03 |  9.20 |
| `trace_gen_time_ms   ` |  178 |  356 |  194 |  162 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  349.50 |  699 |  390 |  309 |
| `main_trace_commit_time_ms` |  64 |  128 |  74 |  54 |
| `generate_perm_trace_time_ms` |  38.50 |  77 |  41 |  36 |
| `perm_trace_commit_time_ms` |  76.58 |  153.17 |  89.07 |  64.10 |
| `quotient_poly_compute_time_ms` |  80.02 |  160.03 |  87.59 |  72.44 |
| `quotient_poly_commit_time_ms` |  15.89 |  31.79 |  17.18 |  14.61 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 604 | 41 | 1 | 89 | 1,745,742 | 19.54 | 145 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 162 | 826 | 32,689,110 | 172,558,444 | 162 | 390 | 0 | 87.59 | 17.18 | 6 | 89.07 | 81 | 129 | 80 | 1 | 74 | 16,059,916 | 36 | 129 | 1,157,000 | 9.20 | 26 | 105 | 1 | 80 | 
| pairing | 1 | 194 | 604 | 22,314,288 | 119,958,502 | 194 | 309 | 1 | 72.44 | 14.61 | 6 | 64.10 | 59 | 107 | 59 | 0 | 54 | 9,408,294 | 41 | 59 | 588,742 | 18.03 | 20 | 87 | 1 | 59 | 

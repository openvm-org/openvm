...
| `total_proof_time_ms ` |  753.50 |  1,507 |  884 |  623 |
...
| `execute_preflight_insn_mi/s` |  13.49 | -          |  17.86 |  9.12 |
| `trace_gen_time_ms   ` |  181 |  362 |  197 |  165 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  383 |  766 |  444 |  322 |
| `main_trace_commit_time_ms` |  66 |  132 |  76 |  56 |
| `generate_perm_trace_time_ms` |  37.50 |  75 |  39 |  36 |
| `perm_trace_commit_time_ms` |  76.82 |  153.64 |  87.51 |  66.13 |
| `quotient_poly_compute_time_ms` |  79.31 |  158.62 |  86.33 |  72.29 |
| `quotient_poly_commit_time_ms` |  16.99 |  33.98 |  19.21 |  14.77 |
| `pcs_opening_time_ms ` |  101 |  202 |  132 |  70 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 623 | 40 | 1 | 89 | 1,745,742 | 19.56 | 148 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 165 | 884 | 32,689,110 | 172,558,444 | 165 | 444 | 0 | 86.33 | 19.21 | 7 | 87.51 | 132 | 127 | 132 | 1 | 76 | 16,059,916 | 36 | 130 | 1,157,000 | 9.12 | 27 | 106 | 1 | 132 | 
| pairing | 1 | 197 | 623 | 22,314,288 | 119,958,502 | 197 | 322 | 1 | 72.29 | 14.77 | 6 | 66.13 | 70 | 108 | 69 | 0 | 56 | 9,408,294 | 39 | 62 | 588,742 | 17.86 | 20 | 87 | 1 | 69 | 

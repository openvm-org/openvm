...
| `total_proof_time_ms ` |  717.50 |  1,435 |  831 |  604 |
...
| `execute_preflight_insn_mi/s` |  13.39 | -          |  17.81 |  8.97 |
| `trace_gen_time_ms   ` |  176 |  352 |  194 |  158 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  352 |  704 |  396 |  308 |
| `main_trace_commit_time_ms` |  63.50 |  127 |  74 |  53 |
| `generate_perm_trace_time_ms` |  38 |  76 |  40 |  36 |
| `perm_trace_commit_time_ms` |  76.25 |  152.50 |  88.55 |  63.95 |
| `quotient_poly_compute_time_ms` |  79.18 |  158.36 |  86.62 |  71.74 |
| `quotient_poly_commit_time_ms` |  16.57 |  33.13 |  18.52 |  14.61 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 604 | 41 | 1 | 90 | 1,745,742 | 19.18 | 147 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 158 | 831 | 32,689,110 | 172,558,444 | 158 | 396 | 0 | 86.62 | 18.52 | 6 | 88.55 | 86 | 128 | 86 | 1 | 74 | 16,059,916 | 36 | 132 | 1,157,000 | 8.97 | 26 | 105 | 1 | 86 | 
| pairing | 1 | 194 | 604 | 22,314,288 | 119,958,502 | 194 | 308 | 1 | 71.74 | 14.61 | 6 | 63.95 | 59 | 107 | 59 | 0 | 53 | 9,408,294 | 40 | 60 | 588,742 | 17.81 | 21 | 86 | 1 | 59 | 

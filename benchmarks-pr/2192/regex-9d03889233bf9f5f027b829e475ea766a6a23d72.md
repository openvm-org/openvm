...
| `total_proof_time_ms ` |  596.25 |  2,385 |  748 |  542 |
...
| `execute_preflight_time_ms` |  56.75 |  227 |  71 |  46 |
| `execute_preflight_insn_mi/s` |  29.94 | -          |  31.13 |  27.57 |
| `trace_gen_time_ms   ` |  175.75 |  703 |  211 |  150 |
| `memory_finalize_time_ms` |  0.75 |  3 |  3 |  0 |
| `stark_prove_excluding_trace_time_ms` |  296 |  1,184 |  345 |  271 |
| `main_trace_commit_time_ms` |  51.75 |  207 |  56 |  50 |
| `generate_perm_trace_time_ms` |  35.25 |  141 |  55 |  20 |
| `perm_trace_commit_time_ms` |  64.78 |  259.11 |  70.22 |  56.03 |
| `quotient_poly_compute_time_ms` |  58.97 |  235.87 |  70.18 |  51.93 |
| `quotient_poly_commit_time_ms` |  15.48 |  61.94 |  17.45 |  13.31 |
| `pcs_opening_time_ms ` |  66.75 |  267 |  83 |  57 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 542 | 41 | 1 | 33 | 4,137,502 | 122.71 | 168 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 211 | 748 | 23,446,148 | 150,778,428 | 211 | 345 | 0 | 60.78 | 17.45 | 5 | 70.22 | 83 | 126 | 82 | 3 | 56 | 10,899,170 | 55 | 46 | 1,103,000 | 27.57 | 21 | 78 | 1 | 82 | 
| regex_program | 1 | 150 | 550 | 11,598,276 | 128,513,066 | 150 | 288 | 1 | 51.93 | 15.52 | 4 | 65.93 | 63 | 104 | 63 | 0 | 51 | 2,196,106 | 38 | 71 | 1,104,000 | 30.46 | 17 | 68 | 0 | 63 | 
| regex_program | 2 | 161 | 545 | 11,579,064 | 128,513,066 | 161 | 280 | 1 | 52.99 | 15.66 | 4 | 66.94 | 64 | 95 | 64 | 0 | 50 | 2,177,334 | 28 | 62 | 1,104,000 | 30.62 | 17 | 69 | 0 | 64 | 
| regex_program | 3 | 181 | 542 | 11,853,872 | 103,456,394 | 181 | 271 | 0 | 70.18 | 13.31 | 5 | 56.03 | 57 | 78 | 57 | 0 | 50 | 2,422,606 | 20 | 48 | 826,502 | 31.13 | 19 | 84 | 1 | 57 | 

...
| `total_proof_time_ms ` |  586.25 |  2,345 |  723 |  537 |
...
| `execute_metered_insn_mi/s` |  120.67 | -          |  120.67 |  120.67 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  55.75 |  223 |  68 |  47 |
| `execute_preflight_insn_mi/s` |  29.49 | -          |  30.84 |  27.08 |
| `trace_gen_time_ms   ` |  174.50 |  698 |  206 |  152 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  288.25 |  1,153 |  323 |  269 |
| `main_trace_commit_time_ms` |  51.75 |  207 |  57 |  50 |
| `generate_perm_trace_time_ms` |  34.75 |  139 |  55 |  19 |
| `perm_trace_commit_time_ms` |  64 |  256.01 |  69.57 |  55.45 |
| `quotient_poly_compute_time_ms` |  58.75 |  235.01 |  69.57 |  53.34 |
| `quotient_poly_commit_time_ms` |  14.88 |  59.53 |  17.57 |  12.62 |
| `pcs_opening_time_ms ` |  60.75 |  243 |  63 |  56 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 538 | 40 | 1 | 34 | 4,137,502 | 120.67 | 166 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 206 | 723 | 23,446,148 | 150,778,428 | 206 | 323 | 0 | 58.62 | 17.57 | 5 | 69.57 | 63 | 125 | 63 | 4 | 57 | 10,899,170 | 55 | 48 | 1,103,000 | 27.08 | 22 | 76 | 1 | 63 | 
| regex_program | 1 | 152 | 547 | 11,598,276 | 128,513,066 | 152 | 286 | 1 | 53.34 | 14.66 | 4 | 64.77 | 63 | 103 | 63 | 0 | 50 | 2,196,106 | 38 | 68 | 1,104,000 | 30.46 | 16 | 68 | 0 | 63 | 
| regex_program | 2 | 160 | 537 | 11,579,064 | 128,513,066 | 160 | 275 | 1 | 53.48 | 14.67 | 4 | 66.22 | 61 | 94 | 61 | 0 | 50 | 2,177,334 | 27 | 60 | 1,104,000 | 30.84 | 16 | 68 | 0 | 61 | 
| regex_program | 3 | 180 | 538 | 11,853,872 | 103,456,394 | 180 | 269 | 0 | 69.57 | 12.62 | 5 | 55.45 | 56 | 78 | 56 | 0 | 50 | 2,422,606 | 19 | 47 | 826,502 | 29.56 | 18 | 83 | 1 | 56 | 

...
| `total_proof_time_ms ` |  587.75 |  2,351 |  738 |  533 |
...
| `execute_metered_insn_mi/s` |  121.26 | -          |  121.26 |  121.26 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  55 |  220 |  68 |  46 |
| `execute_preflight_insn_mi/s` |  30.08 | -          |  31.11 |  27.70 |
| `trace_gen_time_ms   ` |  174.25 |  697 |  206 |  152 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  291.50 |  1,166 |  343 |  265 |
| `main_trace_commit_time_ms` |  51 |  204 |  57 |  48 |
| `generate_perm_trace_time_ms` |  34.75 |  139 |  55 |  18 |
| `perm_trace_commit_time_ms` |  63.69 |  254.75 |  69 |  54.96 |
| `quotient_poly_compute_time_ms` |  57.63 |  230.50 |  68.47 |  51.23 |
| `quotient_poly_commit_time_ms` |  15.02 |  60.07 |  17.30 |  12.33 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 533 | 40 | 1 | 34 | 4,137,502 | 121.26 | 166 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 206 | 738 | 23,446,148 | 150,778,428 | 206 | 343 | 0 | 58.35 | 17.30 | 5 | 69 | 83 | 125 | 83 | 4 | 57 | 10,899,170 | 55 | 46 | 1,103,000 | 27.70 | 21 | 76 | 1 | 83 | 
| regex_program | 1 | 152 | 546 | 11,598,276 | 128,513,066 | 152 | 284 | 1 | 52.45 | 14.86 | 4 | 64.81 | 62 | 103 | 62 | 0 | 50 | 2,196,106 | 38 | 68 | 1,104,000 | 30.82 | 16 | 67 | 0 | 62 | 
| regex_program | 2 | 158 | 534 | 11,579,064 | 128,513,066 | 158 | 274 | 1 | 51.23 | 15.58 | 4 | 65.97 | 62 | 94 | 62 | 0 | 49 | 2,177,334 | 28 | 60 | 1,104,000 | 30.67 | 16 | 67 | 0 | 62 | 
| regex_program | 3 | 181 | 533 | 11,853,872 | 103,456,394 | 181 | 265 | 0 | 68.47 | 12.33 | 5 | 54.96 | 57 | 76 | 57 | 0 | 48 | 2,422,606 | 18 | 46 | 826,502 | 31.11 | 18 | 81 | 1 | 57 | 
...
Commit: https://github.com/openvm-org/openvm/commit/f1ff382ce408668596ea342e33df980b323e6f2d
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19000354187)

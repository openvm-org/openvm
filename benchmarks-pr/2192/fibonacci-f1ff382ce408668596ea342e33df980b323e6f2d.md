...
| `total_proof_time_ms ` |  505.50 |  1,011 |  573 |  438 |
...
| `execute_metered_insn_mi/s` |  149.39 | -          |  149.39 |  149.39 |
| `execute_preflight_insns` |  750,104.50 |  1,500,209 |  873,000 |  627,209 |
| `execute_preflight_time_ms` |  29.50 |  59 |  33 |  26 |
| `execute_preflight_insn_mi/s` |  36.13 | -          |  37.99 |  34.27 |
| `trace_gen_time_ms   ` |  194 |  388 |  199 |  189 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  188.50 |  377 |  203 |  174 |
| `main_trace_commit_time_ms` |  30.50 |  61 |  33 |  28 |
| `generate_perm_trace_time_ms` |  22.50 |  45 |  24 |  21 |
| `perm_trace_commit_time_ms` |  41.55 |  83.10 |  44.07 |  39.03 |
| `quotient_poly_compute_time_ms` |  31.36 |  62.71 |  34.21 |  28.50 |
| `quotient_poly_commit_time_ms` |  12.15 |  24.30 |  12.76 |  11.55 |
| `pcs_opening_time_ms ` |  48.50 |  97 |  53 |  44 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 438 | 41 | 1 | 10 | 1,500,209 | 149.39 | 142 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 199 | 573 | 9,677,708 | 84,395,212 | 199 | 203 | 0 | 34.21 | 12.76 | 4 | 44.07 | 53 | 69 | 53 | 0 | 33 | 1,035,986 | 24 | 26 | 873,000 | 34.27 | 14 | 47 | 0 | 53 | 
| fibonacci_program | 1 | 189 | 438 | 9,708,170 | 74,305,770 | 189 | 174 | 1 | 28.50 | 11.55 | 4 | 39.03 | 44 | 60 | 44 | 0 | 28 | 1,064,416 | 21 | 33 | 627,209 | 37.99 | 11 | 40 | 0 | 44 | 

...
| `execute_metered_insn_mi/s` |  122.47 | -          |  122.47 |  122.47 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  58.25 |  233 |  73 |  48 |
| `execute_preflight_insn_mi/s` |  29.91 | -          |  31.86 |  26.50 |
| `trace_gen_time_ms   ` |  170.25 |  681 |  203 |  146 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  287.25 |  1,149 |  335 |  261 |
| `main_trace_commit_time_ms` |  51.50 |  206 |  57 |  49 |
| `generate_perm_trace_time_ms` |  34.50 |  138 |  55 |  19 |
| `perm_trace_commit_time_ms` |  63.22 |  252.87 |  69.16 |  54.88 |
| `quotient_poly_compute_time_ms` |  57.14 |  228.55 |  69.72 |  50.52 |
| `quotient_poly_commit_time_ms` |  14.55 |  58.22 |  16.58 |  12.42 |
| `pcs_opening_time_ms ` |  63.25 |  253 |  78 |  51 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 529 | 41 | 1 | 33 | 4,137,502 | 122.47 | 168 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 203 | 733 | 23,446,148 | 150,778,428 | 203 | 335 | 0 | 57.01 | 16.58 | 5 | 69.16 | 78 | 125 | 78 | 4 | 57 | 10,899,170 | 55 | 49 | 1,103,000 | 26.50 | 22 | 74 | 1 | 78 | 
| regex_program | 1 | 146 | 544 | 11,598,276 | 128,513,066 | 146 | 284 | 1 | 50.52 | 15.12 | 4 | 65.03 | 63 | 104 | 63 | 0 | 50 | 2,196,106 | 38 | 73 | 1,104,000 | 29.69 | 17 | 66 | 0 | 63 | 
| regex_program | 2 | 155 | 530 | 11,579,064 | 128,513,066 | 155 | 269 | 1 | 51.30 | 14.10 | 4 | 63.80 | 61 | 91 | 61 | 0 | 50 | 2,177,334 | 26 | 63 | 1,104,000 | 31.57 | 16 | 65 | 0 | 61 | 
| regex_program | 3 | 177 | 529 | 11,853,872 | 103,456,394 | 177 | 261 | 0 | 69.72 | 12.42 | 5 | 54.88 | 51 | 77 | 50 | 0 | 49 | 2,422,606 | 19 | 48 | 826,502 | 31.86 | 18 | 83 | 1 | 50 | 

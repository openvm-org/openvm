...
| `total_proof_time_ms ` |  587 |  2,348 |  744 |  525 |
...
| `execute_preflight_time_ms` |  55.25 |  221 |  67 |  47 |
| `execute_preflight_insn_mi/s` |  30.41 | -          |  31.82 |  27.68 |
| `trace_gen_time_ms   ` |  176.75 |  707 |  209 |  155 |
| `memory_finalize_time_ms` |  1.25 |  5 |  5 |  0 |
| `stark_prove_excluding_trace_time_ms` |  288 |  1,152 |  342 |  263 |
| `main_trace_commit_time_ms` |  51.50 |  206 |  55 |  50 |
| `generate_perm_trace_time_ms` |  33.75 |  135 |  54 |  19 |
| `perm_trace_commit_time_ms` |  64.05 |  256.19 |  69.16 |  55.89 |
| `quotient_poly_compute_time_ms` |  58.54 |  234.17 |  69.13 |  52.48 |
| `quotient_poly_commit_time_ms` |  14.96 |  59.84 |  17.92 |  12.53 |
| `pcs_opening_time_ms ` |  62 |  248 |  83 |  49 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 539 | 1 | 36 | 4,137,502 | 113.74 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 209 | 744 | 23,446,148 | 150,778,428 | 209 | 342 | 0 | 59.83 | 17.92 | 5 | 69.16 | 83 | 124 | 82 | 5 | 55 | 10,899,170 | 54 | 48 | 1,103,000 | 27.68 | 21 | 78 | 1 | 82 | 
| regex_program | 1 | 155 | 540 | 11,598,276 | 128,513,066 | 154 | 277 | 1 | 52.48 | 14.39 | 4 | 64.63 | 59 | 100 | 59 | 0 | 50 | 2,196,106 | 35 | 67 | 1,104,000 | 31.82 | 16 | 67 | 0 | 59 | 
| regex_program | 2 | 162 | 525 | 11,579,064 | 128,513,066 | 162 | 263 | 1 | 52.72 | 15 | 4 | 66.50 | 49 | 94 | 49 | 0 | 50 | 2,177,334 | 27 | 59 | 1,104,000 | 31.50 | 16 | 68 | 0 | 49 | 
| regex_program | 3 | 181 | 539 | 11,853,872 | 103,456,394 | 181 | 270 | 0 | 69.13 | 12.53 | 5 | 55.89 | 57 | 78 | 57 | 0 | 51 | 2,422,606 | 19 | 47 | 826,502 | 30.63 | 18 | 82 | 1 | 57 | 

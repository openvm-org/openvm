...
| `total_proof_time_ms ` |  719 |  1,438 |  819 |  619 |
...
| `execute_metered_insn_mi/s` |  17.69 | -          |  17.69 |  17.69 |
| `execute_preflight_insns` |  872,871 |  1,745,742 |  1,157,000 |  588,742 |
| `execute_preflight_time_ms` |  98 |  196 |  135 |  61 |
| `execute_preflight_insn_mi/s` |  13.32 | -          |  17.87 |  8.78 |
| `trace_gen_time_ms   ` |  176 |  352 |  195 |  157 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  352 |  704 |  383 |  321 |
| `main_trace_commit_time_ms` |  65 |  130 |  76 |  54 |
| `generate_perm_trace_time_ms` |  36.50 |  73 |  40 |  33 |
| `perm_trace_commit_time_ms` |  77.19 |  154.39 |  89.50 |  64.89 |
| `quotient_poly_compute_time_ms` |  80.46 |  160.92 |  88.13 |  72.79 |
| `quotient_poly_commit_time_ms` |  16.25 |  32.51 |  18.04 |  14.47 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 619 | 1 | 98 | 1,745,742 | 17.69 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 157 | 819 | 32,689,110 | 172,558,444 | 157 | 383 | 0 | 88.13 | 18.04 | 6 | 89.50 | 67 | 132 | 67 | 0 | 76 | 16,059,916 | 40 | 135 | 1,157,000 | 8.78 | 26 | 106 | 1 | 67 | 
| pairing | 1 | 195 | 619 | 22,314,288 | 119,958,502 | 195 | 321 | 1 | 72.79 | 14.47 | 6 | 64.89 | 77 | 101 | 77 | 0 | 54 | 9,408,294 | 33 | 61 | 588,742 | 17.87 | 21 | 87 | 1 | 77 | 

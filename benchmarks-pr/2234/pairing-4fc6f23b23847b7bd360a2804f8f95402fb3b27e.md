...
| `total_proof_time_ms ` |  748 |  1,496 |  850 |  646 |
...
| `execute_metered_insn_mi/s` |  17.56 | -          |  17.56 |  17.56 |
| `execute_preflight_insns` |  872,871 |  1,745,742 |  1,157,000 |  588,742 |
| `execute_preflight_time_ms` |  97.50 |  195 |  136 |  59 |
| `execute_preflight_insn_mi/s` |  13.52 | -          |  18.34 |  8.71 |
| `trace_gen_time_ms   ` |  175.50 |  351 |  195 |  156 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  382.50 |  765 |  414 |  351 |
| `main_trace_commit_time_ms` |  64 |  128 |  74 |  54 |
| `generate_perm_trace_time_ms` |  55 |  110 |  71 |  39 |
| `perm_trace_commit_time_ms` |  76.55 |  153.11 |  88.73 |  64.38 |
| `quotient_poly_compute_time_ms` |  79.11 |  158.23 |  87.56 |  70.66 |
| `quotient_poly_commit_time_ms` |  15.88 |  31.77 |  17.02 |  14.74 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 646 | 1 | 99 | 1,745,742 | 17.56 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 156 | 850 | 32,689,110 | 172,558,444 | 156 | 414 | 0 | 87.56 | 17.02 | 6 | 88.73 | 103 | 130 | 103 | 1 | 74 | 16,059,916 | 39 | 136 | 1,157,000 | 8.71 | 26 | 105 | 1 | 103 | 
| pairing | 1 | 195 | 646 | 22,314,288 | 119,958,502 | 195 | 351 | 1 | 70.66 | 14.74 | 5 | 64.38 | 72 | 139 | 71 | 0 | 54 | 9,408,294 | 71 | 59 | 588,742 | 18.34 | 20 | 86 | 1 | 71 | 

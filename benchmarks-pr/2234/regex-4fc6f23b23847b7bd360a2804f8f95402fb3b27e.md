...
| `total_proof_time_ms ` |  579.75 |  2,319 |  703 |  537 |
...
| `execute_preflight_insn_mi/s` |  30.92 | -          |  31.95 |  28.04 |
| `trace_gen_time_ms   ` |  176.75 |  707 |  210 |  154 |
| `memory_finalize_time_ms` |  0.75 |  3 |  3 |  0 |
| `stark_prove_excluding_trace_time_ms` |  282 |  1,128 |  304 |  268 |
| `main_trace_commit_time_ms` |  50.75 |  203 |  55 |  49 |
| `generate_perm_trace_time_ms` |  29.75 |  119 |  38 |  19 |
| `perm_trace_commit_time_ms` |  63.48 |  253.94 |  68.56 |  55.58 |
| `quotient_poly_compute_time_ms` |  56.76 |  227.03 |  69.75 |  51.67 |
| `quotient_poly_commit_time_ms` |  14.49 |  57.96 |  16.38 |  12.59 |
| `pcs_opening_time_ms ` |  63.50 |  254 |  75 |  56 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 537 | 1 | 36 | 4,137,502 | 113.91 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 210 | 703 | 23,446,148 | 150,778,428 | 210 | 304 | 0 | 52.20 | 16.38 | 5 | 68.56 | 75 | 103 | 74 | 3 | 55 | 10,899,170 | 34 | 45 | 1,103,000 | 28.04 | 21 | 69 | 1 | 74 | 
| regex_program | 1 | 154 | 542 | 11,598,276 | 128,513,066 | 154 | 281 | 1 | 51.67 | 14.30 | 4 | 63.95 | 62 | 102 | 62 | 0 | 49 | 2,196,106 | 38 | 65 | 1,104,000 | 31.89 | 16 | 66 | 0 | 62 | 
| regex_program | 2 | 162 | 537 | 11,579,064 | 128,513,066 | 162 | 275 | 1 | 53.41 | 14.69 | 4 | 65.85 | 61 | 94 | 61 | 0 | 50 | 2,177,334 | 28 | 58 | 1,104,000 | 31.95 | 16 | 68 | 0 | 61 | 
| regex_program | 3 | 181 | 537 | 11,853,872 | 103,456,394 | 181 | 268 | 0 | 69.75 | 12.59 | 5 | 55.58 | 56 | 78 | 56 | 0 | 49 | 2,422,606 | 19 | 46 | 826,502 | 31.80 | 18 | 83 | 1 | 56 | 
...
Commit: https://github.com/openvm-org/openvm/commit/4fc6f23b23847b7bd360a2804f8f95402fb3b27e
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19352512455)

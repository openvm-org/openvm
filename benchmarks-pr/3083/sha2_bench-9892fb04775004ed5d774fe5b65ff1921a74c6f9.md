...
| `total_proof_time_ms ` |  2,355 |  4,710 |  3,220 |  1,490 |
| `compile_metered_time_ms` |  6 |  6 |  6 |  6 |
| `execute_metered_time_ms` |  56 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  196.23 | -          |  196.23 |  196.23 |
| `execute_preflight_insns` |  5,583,980.50 |  11,167,961 |  7,136,000 |  4,031,961 |
| `execute_preflight_time_ms` |  163.50 |  327 |  219 |  108 |
| `execute_preflight_insn_mi/s` |  36.05 | -          |  37.73 |  34.38 |
| `trace_gen_time_ms   ` |  65.50 |  131 |  103 |  28 |
| `set_initial_memory_time_ms` |  0 |  0 |  0 |  0 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  2,124 |  4,248 |  2,896 |  1,352 |
| `prover.main_trace_commit_time_ms` |  739 |  1,478 |  1,261 |  217 |
| `prover.rap_constraints_time_ms` |  1,118 |  2,236 |  1,292 |  944 |
| `prover.openings_time_ms` |  266 |  532 |  342 |  190 |
| `prover.rap_constraints.logup_gkr_time_ms` |  412 |  824 |  468 |  356 |
| `prover.rap_constraints.round0_time_ms` |  524.50 |  1,049 |  701 |  348 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/9892fb04775004ed5d774fe5b65ff1921a74c6f9/sha2_bench-9892fb04775004ed5d774fe5b65ff1921a74c6f9.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 60 |  |  |  | 298 |  |  |  |  |  |  | 
| app_proof |  |  |  | 1,490 |  | 56 | 11,167,961 | 196.23 | 0 | 4,777 |  | 
...
| leaf | 0 | 126 | 529 | 125 | 32 | 12 | 2 | 10 | 10 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 174 | 46 | 0 | 0 | 79 | 29 | 28 | 36 | 13 | 0 | 46 | 36 | 10 | 2 | 7 | 47 | 46 | 79 | 0 | 1 | 12 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,285,848,458 | 2,896 | 1,261 | 0 | 0 | 1,292 | 701 | 700 | 234 | 356 | 1 | 342 | 248 | 93 | 57 | 36 | 1,261 | 1,261 | 1,292 | 0 | 1 | 355 | 0 | 0 | 
| app_proof | prover | 1 | 690,310,084 | 1,352 | 217 | 0 | 0 | 944 | 348 | 348 | 126 | 468 | 0 | 190 | 138 | 52 | 30 | 21 | 217 | 217 | 944 | 0 | 1 | 191 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 0 | 2 | 103 | 3,220 | 3 | 0 | 0 | 0 | 12,567,738,156 | 2,865,208,140 | 15,432,946,296 | 2,097,152 | 2 | 0 | 0 | 0 | 3 | 100 | 219 | 7,136,000 | 34.38 | 0 | 0 | 
| app_proof | 1 | 0 | 2 | 28 | 1,490 | 2 | 0 | 0 | 0 | 7,133,254,296 | 1,693,718,849 | 8,826,973,145 | 2,097,152 | 2 | 0 | 0 | 0 | 2 | 25 | 108 | 4,031,961 | 37.73 | 0 | 0 | 

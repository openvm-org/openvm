...
|:---|---:|---:|---:|
| Total |  5.74 |  4.25 |  4.25 |
| app_proof |  4.77 |  3.28 |  3.28 |
| leaf |  0.54 |  0.54 |  0.54 |
...
| `total_proof_time_ms ` |  2,357.50 |  4,715 |  3,226 |  1,489 |
...
| `execute_preflight_time_ms` |  158 |  316 |  216 |  100 |
| `execute_preflight_insn_mi/s` |  37.87 | -          |  40.74 |  35.01 |
| `trace_gen_time_ms   ` |  65.50 |  131 |  103 |  28 |
| `set_initial_memory_time_ms` |  0 |  0 |  0 |  0 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  2,131.50 |  4,263 |  2,905 |  1,358 |
| `prover.main_trace_commit_time_ms` |  745 |  1,490 |  1,273 |  217 |
| `prover.rap_constraints_time_ms` |  1,120.50 |  2,241 |  1,290 |  951 |
| `prover.openings_time_ms` |  265.50 |  531 |  341 |  190 |
| `prover.rap_constraints.logup_gkr_time_ms` |  414 |  828 |  474 |  354 |
| `prover.rap_constraints.round0_time_ms` |  525.50 |  1,051 |  702 |  349 |
| `prover.rap_constraints.mle_rounds_time_ms` |  180 |  360 |  233 |  127 |
...
| `prover.openings.whir_time_ms` |  192.50 |  385 |  247 |  138 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  538 |  538 |  538 |  538 |
| `execute_preflight_time_ms` |  2 |  2 |  2 |  2 |
| `trace_gen_time_ms   ` |  127 |  127 |  127 |  127 |
| `generate_blob_total_time_ms` |  12 |  12 |  12 |  12 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  410 |  410 |  410 |  410 |
...
| `prover.openings.whir_time_ms` |  100 |  100 |  100 |  100 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/5dfb2b8c3417d4bf22c1599d4a940cc561b5a1eb/sha2_bench-5dfb2b8c3417d4bf22c1599d4a940cc561b5a1eb.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 57 |  |  |  | 294 |  |  |  |  |  |  | 
| app_proof |  |  |  | 1,489 |  | 56 | 11,167,961 | 196.67 | 0 | 4,781 |  | 
...
| app_proof | VmAirWrapper<Rv64BaseAluImmU16AdapterAir, ShiftLogicalImmCoreAir<4, 16> | 0 | 0 | 1 | 
...
| app_proof | VmAirWrapper<Rv64LoadMultiByteAdapterAir, LoadSignExtendCoreAir<4, 3> | 1 | 2 | 2 | 
...
| internal_recursive.0 | 1 | 11 | 121 | 10 | 1 | 0 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 10 | 109 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 127 | 538 | 126 | 32 | 12 | 2 | 10 | 10 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 178 | 46 | 0 | 0 | 81 | 29 | 28 | 37 | 15 | 0 | 49 | 39 | 10 | 2 | 7 | 46 | 46 | 81 | 0 | 1 | 12 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 110 | 20 | 0 | 0 | 55 | 20 | 20 | 23 | 10 | 0 | 34 | 26 | 7 | 1 | 6 | 20 | 20 | 55 | 0 | 1 | 10 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 99 | 14 | 0 | 0 | 53 | 20 | 19 | 21 | 10 | 0 | 30 | 23 | 7 | 1 | 5 | 15 | 14 | 53 | 0 | 1 | 10 | 0 | 0 | 
| leaf | 0 | prover | 237,929,272 | 410 | 145 | 0 | 0 | 142 | 71 | 69 | 44 | 26 | 0 | 122 | 100 | 21 | 10 | 11 | 145 | 145 | 142 | 0 | 3 | 25 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,285,848,458 | 2,905 | 1,273 | 0 | 0 | 1,290 | 702 | 702 | 233 | 354 | 1 | 341 | 247 | 93 | 57 | 36 | 1,273 | 1,273 | 1,290 | 0 | 1 | 353 | 0 | 0 | 
| app_proof | prover | 1 | 690,310,084 | 1,358 | 216 | 0 | 0 | 951 | 349 | 348 | 127 | 474 | 0 | 190 | 138 | 51 | 30 | 21 | 217 | 216 | 951 | 0 | 1 | 191 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 0 | 2 | 103 | 3,226 | 3 | 0 | 0 | 0 | 12,567,738,156 | 2,865,208,140 | 15,432,946,296 | 2,097,152 | 2 | 0 | 0 | 0 | 3 | 99 | 216 | 7,136,000 | 35.01 | 0 | 0 | 
| app_proof | 1 | 0 | 2 | 28 | 1,489 | 2 | 0 | 0 | 0 | 7,133,254,296 | 1,693,718,849 | 8,826,973,145 | 2,097,152 | 2 | 0 | 0 | 0 | 2 | 26 | 100 | 4,031,961 | 40.74 | 0 | 0 | 

...
|:---|---:|---:|
| Total |  7.79 |  4.96 |
| regex_program |  7.76 |  4.92 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  3,879.50 |  7,759 |  4,924 |  2,835 |
...
| `execute_preflight_insn_mi/s` |  31.04 | -          |  33.83 |  28.24 |
| `trace_gen_time_ms   ` |  389.50 |  779 |  499 |  280 |
| `memory_finalize_time_ms` |  7.50 |  15 |  13 |  2 |
| `stark_prove_excluding_trace_time_ms` |  3,167 |  6,334 |  4,084 |  2,250 |
| `main_trace_commit_time_ms` |  636 |  1,272 |  857 |  415 |
| `generate_perm_trace_time_ms` |  242.50 |  485 |  310 |  175 |
| `perm_trace_commit_time_ms` |  661 |  1,322 |  864 |  458 |
| `quotient_poly_compute_time_ms` |  319.50 |  639 |  438 |  201 |
| `quotient_poly_commit_time_ms` |  306 |  612 |  403 |  209 |
| `pcs_opening_time_ms ` |  994 |  1,988 |  1,206 |  782 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2 | 2,835 | 6 | 1 | 31 | 4,108,597 | 128.52 | 44 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 499 | 4,924 | 211,758,557 | 373,183,036 | 499 | 4,084 | 0 | 438 | 403 | 864 | 1,206 | 7 | 13 | 857 | 91,281,687 | 310 | 94 | 2,211,000 | 28.24 | 
| regex_program | 1 | 280 | 2,835 | 174,326,267 | 196,838,026 | 280 | 2,250 | 52 | 201 | 209 | 458 | 782 | 7 | 2 | 415 | 73,453,305 | 175 | 79 | 1,897,597 | 33.83 | 

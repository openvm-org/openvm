...
| `total_proof_time_ms ` |  695.50 |  1,391 |  803 |  588 |
...
| `execute_metered_insn_mi/s` |  19.26 | -          |  19.26 |  19.26 |
| `execute_preflight_insns` |  872,871 |  1,745,742 |  1,157,000 |  588,742 |
| `execute_preflight_time_ms` |  94 |  188 |  129 |  59 |
| `execute_preflight_insn_mi/s` |  13.69 | -          |  18.20 |  9.18 |
| `trace_gen_time_ms   ` |  175.50 |  351 |  192 |  159 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  333.50 |  667 |  371 |  296 |
| `main_trace_commit_time_ms` |  64 |  128 |  73 |  55 |
| `generate_perm_trace_time_ms` |  35 |  70 |  36 |  34 |
| `perm_trace_commit_time_ms` |  76.11 |  152.22 |  87.46 |  64.77 |
| `quotient_poly_compute_time_ms` |  77.78 |  155.57 |  86.41 |  69.15 |
| `quotient_poly_commit_time_ms` |  16.51 |  33.02 |  19 |  14.02 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 588 | 40 | 1 | 90 | 1,745,742 | 19.26 | 144 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 159 | 803 | 32,689,110 | 172,558,444 | 159 | 371 | 0 | 86.41 | 19 | 6 | 87.46 | 65 | 126 | 64 | 1 | 73 | 16,059,916 | 36 | 129 | 1,157,000 | 9.18 | 26 | 106 | 1 | 64 | 
| pairing | 1 | 192 | 588 | 22,314,288 | 119,958,502 | 192 | 296 | 1 | 69.15 | 14.02 | 6 | 64.77 | 55 | 101 | 54 | 0 | 55 | 9,408,294 | 34 | 59 | 588,742 | 18.20 | 20 | 83 | 1 | 54 | 
...
Commit: https://github.com/openvm-org/openvm/commit/3db7a615ee47a887dfcfb1ab8645c430bfd55442
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19200307222)

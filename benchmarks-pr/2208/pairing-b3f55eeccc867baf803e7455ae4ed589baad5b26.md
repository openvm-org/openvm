...
| `total_proof_time_ms ` |  705 |  1,410 |  814 |  596 |
...
| `execute_preflight_time_ms` |  93 |  186 |  128 |  58 |
| `execute_preflight_insn_mi/s` |  13.92 | -          |  18.56 |  9.29 |
| `trace_gen_time_ms   ` |  180.50 |  361 |  197 |  164 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  338 |  676 |  377 |  299 |
| `main_trace_commit_time_ms` |  65.50 |  131 |  76 |  55 |
| `generate_perm_trace_time_ms` |  35.50 |  71 |  37 |  34 |
| `perm_trace_commit_time_ms` |  77.74 |  155.48 |  90.05 |  65.42 |
| `quotient_poly_compute_time_ms` |  78.92 |  157.85 |  87.64 |  70.21 |
| `quotient_poly_commit_time_ms` |  16.28 |  32.55 |  17.92 |  14.63 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 596 | 40 | 1 | 90 | 1,745,742 | 19.23 | 144 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 164 | 814 | 32,689,110 | 172,558,444 | 164 | 377 | 0 | 87.64 | 17.92 | 6 | 90.05 | 65 | 129 | 65 | 1 | 76 | 16,059,916 | 37 | 128 | 1,157,000 | 9.29 | 26 | 106 | 1 | 65 | 
| pairing | 1 | 197 | 596 | 22,314,288 | 119,958,502 | 197 | 299 | 1 | 70.21 | 14.63 | 6 | 65.42 | 55 | 102 | 55 | 0 | 55 | 9,408,294 | 34 | 58 | 588,742 | 18.56 | 20 | 85 | 1 | 55 | 

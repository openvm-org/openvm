...
| `total_proof_time_ms ` |  581.25 |  2,325 |  699 |  537 |
...
| `execute_metered_insn_mi/s` |  114.98 | -          |  114.98 |  114.98 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  53 |  212 |  65 |  44 |
| `execute_preflight_insn_mi/s` |  31.57 | -          |  32.98 |  28.87 |
| `trace_gen_time_ms   ` |  179.25 |  717 |  213 |  157 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  281.75 |  1,127 |  298 |  266 |
| `main_trace_commit_time_ms` |  50.75 |  203 |  55 |  49 |
| `generate_perm_trace_time_ms` |  25 |  100 |  34 |  19 |
| `perm_trace_commit_time_ms` |  64.52 |  258.08 |  69.22 |  55.79 |
| `quotient_poly_compute_time_ms` |  58.77 |  235.07 |  68.90 |  51.60 |
| `quotient_poly_commit_time_ms` |  15.13 |  60.53 |  17.70 |  12.40 |
| `pcs_opening_time_ms ` |  64.50 |  258 |  73 |  56 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 537 | 41 | 1 | 35 | 4,137,502 | 114.98 | 167 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 213 | 699 | 23,446,148 | 150,778,428 | 213 | 298 | 0 | 61.68 | 17.70 | 5 | 69.22 | 58 | 104 | 57 | 4 | 55 | 10,899,170 | 34 | 44 | 1,103,000 | 28.87 | 21 | 80 | 1 | 57 | 
| regex_program | 1 | 157 | 539 | 11,598,276 | 128,513,066 | 157 | 276 | 1 | 51.60 | 14.77 | 5 | 66.14 | 71 | 87 | 71 | 0 | 49 | 2,196,106 | 20 | 65 | 1,104,000 | 32.75 | 16 | 66 | 0 | 71 | 
| regex_program | 2 | 164 | 550 | 11,579,064 | 128,513,066 | 164 | 287 | 1 | 52.89 | 15.66 | 4 | 66.92 | 73 | 95 | 72 | 0 | 49 | 2,177,334 | 27 | 57 | 1,104,000 | 32.98 | 16 | 69 | 0 | 72 | 
| regex_program | 3 | 183 | 537 | 11,853,872 | 103,456,394 | 183 | 266 | 0 | 68.90 | 12.40 | 5 | 55.79 | 56 | 77 | 56 | 0 | 50 | 2,422,606 | 19 | 46 | 826,502 | 31.67 | 18 | 82 | 1 | 56 | 
...
Commit: https://github.com/openvm-org/openvm/commit/360e2094559280a5cc3807a489024c3fc54660e7
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19199347847)

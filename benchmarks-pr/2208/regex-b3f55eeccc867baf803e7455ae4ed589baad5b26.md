...
|:---|---:|---:|
| Total |  2.38 |  0.74 |
| regex_program |  2.35 |  0.70 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  586.75 |  2,347 |  699 |  543 |
...
| `execute_metered_insn_mi/s` |  109.98 | -          |  109.98 |  109.98 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  55 |  220 |  67 |  45 |
| `execute_preflight_insn_mi/s` |  31 | -          |  32.66 |  28.75 |
| `trace_gen_time_ms   ` |  180.50 |  722 |  213 |  158 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  283.50 |  1,134 |  296 |  269 |
| `main_trace_commit_time_ms` |  52.50 |  210 |  58 |  49 |
| `generate_perm_trace_time_ms` |  23.50 |  94 |  32 |  19 |
| `perm_trace_commit_time_ms` |  65.53 |  262.11 |  72.30 |  55.75 |
| `quotient_poly_compute_time_ms` |  60.37 |  241.47 |  72.23 |  53.17 |
| `quotient_poly_commit_time_ms` |  15.40 |  61.59 |  17.49 |  13.10 |
| `pcs_opening_time_ms ` |  62.75 |  251 |  81 |  53 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 543 | 41 | 1 | 37 | 4,137,502 | 109.98 | 168 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 213 | 699 | 23,446,148 | 150,778,428 | 213 | 296 | 0 | 61.58 | 17.49 | 5 | 72.30 | 61 | 96 | 60 | 4 | 58 | 10,899,170 | 23 | 45 | 1,103,000 | 28.75 | 21 | 79 | 1 | 60 | 
| regex_program | 1 | 158 | 559 | 11,598,276 | 128,513,066 | 158 | 291 | 1 | 54.50 | 14.87 | 4 | 67.51 | 81 | 87 | 81 | 0 | 51 | 2,196,106 | 19 | 67 | 1,104,000 | 32.66 | 16 | 69 | 0 | 81 | 
| regex_program | 2 | 164 | 546 | 11,579,064 | 128,513,066 | 164 | 278 | 1 | 53.17 | 16.13 | 4 | 66.54 | 56 | 99 | 56 | 0 | 52 | 2,177,334 | 32 | 62 | 1,104,000 | 29.93 | 17 | 69 | 0 | 56 | 
| regex_program | 3 | 187 | 543 | 11,853,872 | 103,456,394 | 187 | 269 | 0 | 72.23 | 13.10 | 5 | 55.75 | 53 | 78 | 53 | 0 | 49 | 2,422,606 | 20 | 46 | 826,502 | 32.66 | 18 | 86 | 1 | 53 | 
...
Commit: https://github.com/openvm-org/openvm/commit/b3f55eeccc867baf803e7455ae4ed589baad5b26
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19203864499)

...
| `total_proof_time_ms ` |  713.50 |  1,427 |  825 |  602 |
...
| `execute_preflight_time_ms` |  94.50 |  189 |  128 |  61 |
| `execute_preflight_insn_mi/s` |  13.90 | -          |  18.53 |  9.27 |
| `trace_gen_time_ms   ` |  183.50 |  367 |  198 |  169 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  342.50 |  685 |  383 |  302 |
| `main_trace_commit_time_ms` |  65.50 |  131 |  77 |  54 |
| `generate_perm_trace_time_ms` |  35.50 |  71 |  37 |  34 |
| `perm_trace_commit_time_ms` |  78.45 |  156.89 |  91.13 |  65.76 |
| `quotient_poly_compute_time_ms` |  80.48 |  160.95 |  88.91 |  72.04 |
| `quotient_poly_commit_time_ms` |  17.18 |  34.37 |  19.31 |  15.05 |
| `pcs_opening_time_ms ` |  60.50 |  121 |  65 |  56 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 602 | 40 | 1 | 90 | 1,745,742 | 19.19 | 145 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 169 | 825 | 32,689,110 | 172,558,444 | 169 | 383 | 0 | 88.91 | 19.31 | 6 | 91.13 | 65 | 131 | 65 | 1 | 77 | 16,059,916 | 37 | 128 | 1,157,000 | 9.27 | 27 | 109 | 1 | 65 | 
| pairing | 1 | 198 | 602 | 22,314,288 | 119,958,502 | 198 | 302 | 1 | 72.04 | 15.05 | 6 | 65.76 | 56 | 103 | 56 | 0 | 54 | 9,408,294 | 34 | 61 | 588,742 | 18.53 | 21 | 87 | 1 | 56 | 
...
Commit: https://github.com/openvm-org/openvm/commit/b3e94f0d52823c9ebe6fb2cd2a5d347c34e287b6
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19200067994)

...
|:---|---:|---:|
| Total |  1.05 |  0.57 |
| fibonacci_program |  1.04 |  0.56 |


| fibonacci_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  518 |  1,036 |  561 |  475 |
...
| `execute_preflight_insn_mi/s` |  37.62 | -          |  40.18 |  35.05 |
| `trace_gen_time_ms   ` |  193 |  386 |  198 |  188 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  203 |  406 |  213 |  193 |
| `main_trace_commit_time_ms` |  30.50 |  61 |  33 |  28 |
| `generate_perm_trace_time_ms` |  30.50 |  61 |  33 |  28 |
| `perm_trace_commit_time_ms` |  41.49 |  82.97 |  44.18 |  38.79 |
| `quotient_poly_compute_time_ms` |  30.99 |  61.98 |  32.39 |  29.59 |
| `quotient_poly_commit_time_ms` |  12.05 |  24.09 |  12.78 |  11.31 |
| `pcs_opening_time_ms ` |  55.50 |  111 |  70 |  41 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 475 | 41 | 1 | 13 | 1,500,209 | 114.69 | 138 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 198 | 561 | 9,677,708 | 84,395,212 | 198 | 193 | 0 | 32.39 | 12.78 | 4 | 44.18 | 41 | 73 | 41 | 0 | 33 | 1,035,986 | 28 | 25 | 873,000 | 35.05 | 14 | 45 | 0 | 41 | 
| fibonacci_program | 1 | 188 | 475 | 9,708,170 | 74,305,770 | 188 | 213 | 1 | 29.59 | 11.31 | 4 | 38.79 | 70 | 73 | 70 | 0 | 28 | 1,064,416 | 33 | 32 | 627,209 | 40.18 | 11 | 41 | 0 | 70 | 

...
| `total_proof_time_ms ` |  588.25 |  2,353 |  703 |  544 |
...
| `execute_preflight_time_ms` |  53.75 |  215 |  65 |  46 |
| `execute_preflight_insn_mi/s` |  30.72 | -          |  31.95 |  28.07 |
| `trace_gen_time_ms   ` |  179.25 |  717 |  213 |  157 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  287.75 |  1,151 |  299 |  274 |
| `main_trace_commit_time_ms` |  51.50 |  206 |  57 |  49 |
| `generate_perm_trace_time_ms` |  22.50 |  90 |  28 |  19 |
| `perm_trace_commit_time_ms` |  65.74 |  262.95 |  72.50 |  55.68 |
| `quotient_poly_compute_time_ms` |  58.90 |  235.60 |  68.89 |  52.68 |
| `quotient_poly_commit_time_ms` |  15.47 |  61.88 |  17.95 |  12.40 |
| `pcs_opening_time_ms ` |  70.50 |  282 |  82 |  62 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 544 | 40 | 1 | 36 | 4,137,502 | 114.01 | 166 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 213 | 703 | 23,446,148 | 150,778,428 | 213 | 299 | 0 | 60.41 | 17.95 | 5 | 72.50 | 66 | 96 | 66 | 4 | 57 | 10,899,170 | 23 | 46 | 1,103,000 | 28.07 | 21 | 79 | 1 | 66 | 
| regex_program | 1 | 157 | 556 | 11,598,276 | 128,513,066 | 157 | 292 | 1 | 53.62 | 15.78 | 4 | 68.06 | 82 | 89 | 81 | 0 | 50 | 2,196,106 | 20 | 65 | 1,104,000 | 31.67 | 16 | 69 | 0 | 81 | 
| regex_program | 2 | 164 | 550 | 11,579,064 | 128,513,066 | 164 | 286 | 1 | 52.68 | 15.75 | 4 | 66.71 | 72 | 95 | 72 | 0 | 49 | 2,177,334 | 28 | 58 | 1,104,000 | 31.95 | 16 | 69 | 0 | 72 | 
| regex_program | 3 | 183 | 544 | 11,853,872 | 103,456,394 | 183 | 274 | 0 | 68.89 | 12.40 | 5 | 55.68 | 62 | 77 | 62 | 0 | 50 | 2,422,606 | 19 | 46 | 826,502 | 31.21 | 18 | 82 | 1 | 62 | 
...
Commit: https://github.com/openvm-org/openvm/commit/e6df58de0966b7d35b3ce8770602323260aa9d34
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19200134176)

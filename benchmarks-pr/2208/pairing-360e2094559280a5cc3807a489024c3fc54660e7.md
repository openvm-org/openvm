...
| `total_proof_time_ms ` |  706.50 |  1,413 |  818 |  595 |
...
| `execute_preflight_insn_mi/s` |  13.63 | -          |  18.07 |  9.18 |
| `trace_gen_time_ms   ` |  180.50 |  361 |  196 |  165 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  339 |  678 |  380 |  298 |
| `main_trace_commit_time_ms` |  65.50 |  131 |  76 |  55 |
| `generate_perm_trace_time_ms` |  35.50 |  71 |  37 |  34 |
| `perm_trace_commit_time_ms` |  77.54 |  155.07 |  89.81 |  65.27 |
| `quotient_poly_compute_time_ms` |  80.12 |  160.25 |  88.65 |  71.60 |
| `quotient_poly_commit_time_ms` |  16.99 |  33.98 |  19.27 |  14.71 |
| `pcs_opening_time_ms ` |  58.50 |  117 |  65 |  52 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 595 | 40 | 1 | 90 | 1,745,742 | 19.20 | 145 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 165 | 818 | 32,689,110 | 172,558,444 | 165 | 380 | 0 | 88.65 | 19.27 | 6 | 89.81 | 65 | 129 | 65 | 1 | 76 | 16,059,916 | 37 | 129 | 1,157,000 | 9.18 | 27 | 108 | 1 | 65 | 
| pairing | 1 | 196 | 595 | 22,314,288 | 119,958,502 | 196 | 298 | 1 | 71.60 | 14.71 | 5 | 65.27 | 52 | 102 | 52 | 0 | 55 | 9,408,294 | 34 | 59 | 588,742 | 18.07 | 20 | 86 | 1 | 52 | 

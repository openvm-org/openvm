...
| `total_proof_time_ms ` |  2,203.50 |  4,407 |  2,915 |  1,492 |
| `compile_metered_time_ms` |  0 |  0 |  0 |  0 |
| `execute_metered_time_ms` |  61 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  180.83 | -          |  180.83 |  180.83 |
...
| `execute_preflight_insn_mi/s` |  21.94 | -          |  24.52 |  20.67 |
| `postflight_time_ms  ` |  131.50 |  263 |  194 |  69 |
| `postflight_memory_chronology_time_ms` |  12 |  24 |  20 |  4 |
| `postflight_program_index_time_ms` |  1 |  2 |  1 |  1 |
| `trace_gen_time_ms   ` |  53.50 |  107 |  75 |  32 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,730.50 |  3,461 |  2,259 |  1,202 |
| `prover.main_trace_commit_time_ms` |  384 |  768 |  557 |  211 |
| `prover.rap_constraints_time_ms` |  1,080 |  2,160 |  1,364 |  796 |
| `prover.openings_time_ms` |  265 |  530 |  336 |  194 |
| `prover.rap_constraints.logup_gkr_time_ms` |  251 |  502 |  275 |  227 |
| `prover.rap_constraints.round0_time_ms` |  644.50 |  1,289 |  848 |  441 |
| `prover.rap_constraints.mle_rounds_time_ms` |  183.50 |  367 |  240 |  127 |
...
| `prover.openings.whir_time_ms` |  192.50 |  385 |  242 |  143 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/38792216df00300054f151299cc86091b60aa622/sha2_bench-38792216df00300054f151299cc86091b60aa622.memory.svg)
...
| leaf | 0 | 112 | 529 | 112 | 32 | 12 | 2 | 9 | 9 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,627,133 | 176 | 45 | 0 | 0 | 81 | 29 | 28 | 37 | 14 | 0 | 48 | 38 | 10 | 2 | 7 | 45 | 45 | 81 | 0 | 1 | 13 | 0 | 0 | 
...
| leaf | 0 | prover | 237,994,808 | 416 | 143 | 0 | 0 | 156 | 83 | 81 | 44 | 28 | 0 | 115 | 93 | 22 | 10 | 11 | 144 | 143 | 156 | 0 | 3 | 27 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover |  | 0 | 1,281,523,083 | 2,259 | 557 | 0 | 0 | 1,364 | 848 | 848 | 240 | 275 | 1 | 336 | 242 | 93 | 57 | 36 | 557 | 557 | 1,364 | 0 | 1 | 273 | 0 | 0 | 
| app_proof | prover |  | 1 | 687,699,844 | 1,202 | 211 | 0 | 0 | 796 | 441 | 440 | 127 | 227 | 0 | 194 | 143 | 51 | 30 | 21 | 211 | 211 | 796 | 0 | 1 | 226 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof |  | 1,492 | 61 | 11,167,961 | 180.83 | 0 | 4,473 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof |  | 0 | 4 | 2 | 75 | 2,915 | 6 | 4 | 0 | 194 | 1 | 20 | 0 | 125,829,120 | 10,960,542,912 | 10,267,656,192 | 12,915,749,568 | 3,171,807,276 | 16,087,556,844 | 9,383,484,608 | 10,960,542,912 | 2 | 0 | 2 | 5 | 69 | 345 | 7,136,000 | 20.67 | 0 | 0 | 
| app_proof |  | 1 | 3 | 2 | 32 | 1,492 | 3 | 3 | 0 | 69 | 1 | 4 | 0 | 125,829,120 | 6,812,188,528 | 5,519,704,064 | 7,305,829,524 | 2,259,069,164 | 9,564,898,688 | 6,057,508,928 | 6,812,188,528 | 2 | 0 | 0 | 2 | 29 | 164 | 4,031,961 | 24.52 | 0 | 0 | 

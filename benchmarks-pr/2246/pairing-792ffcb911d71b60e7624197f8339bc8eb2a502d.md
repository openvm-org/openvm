...
| `total_proof_time_ms ` |  766 |  1,532 |  853 |  679 |
...
| `execute_metered_insn_mi/s` |  17.82 | -          |  17.82 |  17.82 |
| `execute_preflight_insns` |  872,871 |  1,745,742 |  1,157,000 |  588,742 |
| `execute_preflight_time_ms` |  97 |  194 |  135 |  59 |
| `execute_preflight_insn_mi/s` |  13.51 | -          |  18.23 |  8.79 |
| `trace_gen_time_ms   ` |  177 |  354 |  197 |  157 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  399.50 |  799 |  417 |  382 |
| `main_trace_commit_time_ms` |  64.50 |  129 |  75 |  54 |
| `generate_perm_trace_time_ms` |  55.50 |  111 |  72 |  39 |
| `perm_trace_commit_time_ms` |  76.90 |  153.81 |  89.40 |  64.41 |
| `quotient_poly_compute_time_ms` |  80.16 |  160.31 |  88.08 |  72.24 |
| `quotient_poly_commit_time_ms` |  16.10 |  32.20 |  17.31 |  14.89 |
| `pcs_opening_time_ms ` |  101 |  202 |  103 |  99 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 679 | 1 | 97 | 1,745,742 | 17.82 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 157 | 853 | 32,689,110 | 172,558,444 | 157 | 417 | 0 | 88.08 | 17.31 | 6 | 89.40 | 103 | 131 | 103 | 0 | 75 | 16,059,916 | 39 | 135 | 1,157,000 | 8.79 | 26 | 106 | 1 | 103 | 
| pairing | 1 | 197 | 679 | 22,314,288 | 119,958,502 | 197 | 382 | 1 | 72.24 | 14.89 | 5 | 64.41 | 99 | 139 | 99 | 0 | 54 | 9,408,294 | 72 | 59 | 588,742 | 18.23 | 21 | 87 | 1 | 99 | 

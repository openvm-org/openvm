...
| `total_proof_time_ms ` |  571.75 |  2,287 |  687 |  527 |
...
| `execute_metered_insn_mi/s` |  116.84 | -          |  116.84 |  116.84 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  53.75 |  215 |  66 |  45 |
| `execute_preflight_insn_mi/s` |  31.03 | -          |  32.03 |  28.30 |
| `trace_gen_time_ms   ` |  176.50 |  706 |  210 |  154 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  274 |  1,096 |  286 |  262 |
| `main_trace_commit_time_ms` |  51.25 |  205 |  57 |  49 |
| `generate_perm_trace_time_ms` |  26.25 |  105 |  38 |  18 |
| `perm_trace_commit_time_ms` |  64.25 |  256.99 |  71.19 |  55.56 |
| `quotient_poly_compute_time_ms` |  57.78 |  231.12 |  68.51 |  51.76 |
| `quotient_poly_commit_time_ms` |  14.81 |  59.23 |  16.83 |  12.52 |
| `pcs_opening_time_ms ` |  56.50 |  226 |  62 |  52 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 530 | 1 | 35 | 4,137,502 | 116.84 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 210 | 687 | 23,446,148 | 150,778,428 | 210 | 286 | 0 | 59.02 | 16.83 | 5 | 71.19 | 57 | 94 | 57 | 4 | 57 | 10,899,170 | 22 | 46 | 1,103,000 | 28.30 | 21 | 76 | 1 | 57 | 
| regex_program | 1 | 154 | 543 | 11,598,276 | 128,513,066 | 154 | 281 | 1 | 51.76 | 14.31 | 4 | 64.27 | 62 | 102 | 62 | 0 | 49 | 2,196,106 | 38 | 66 | 1,104,000 | 32.03 | 16 | 66 | 0 | 62 | 
| regex_program | 2 | 160 | 527 | 11,579,064 | 128,513,066 | 160 | 267 | 1 | 51.82 | 15.57 | 4 | 65.97 | 55 | 93 | 55 | 0 | 49 | 2,177,334 | 27 | 58 | 1,104,000 | 31.80 | 16 | 67 | 0 | 55 | 
| regex_program | 3 | 182 | 530 | 11,853,872 | 103,456,394 | 182 | 262 | 0 | 68.51 | 12.52 | 5 | 55.56 | 52 | 76 | 52 | 0 | 50 | 2,422,606 | 18 | 45 | 826,502 | 31.99 | 18 | 82 | 1 | 51 | 
...
Commit: https://github.com/openvm-org/openvm/commit/792ffcb911d71b60e7624197f8339bc8eb2a502d
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19372957251)

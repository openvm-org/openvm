...
| `total_proof_time_ms ` |  750.50 |  1,501 |  818 |  683 |
...
| `execute_preflight_time_ms` |  97 |  194 |  135 |  59 |
| `execute_preflight_insn_mi/s` |  13.48 | -          |  18.21 |  8.75 |
| `trace_gen_time_ms   ` |  178 |  356 |  198 |  158 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  382.50 |  765 |  384 |  381 |
| `main_trace_commit_time_ms` |  66 |  132 |  76 |  56 |
| `generate_perm_trace_time_ms` |  53.50 |  107 |  71 |  36 |
| `perm_trace_commit_time_ms` |  78.13 |  156.27 |  90.26 |  66 |
| `quotient_poly_compute_time_ms` |  80.75 |  161.51 |  90.04 |  71.47 |
| `quotient_poly_commit_time_ms` |  16.38 |  32.76 |  17.83 |  14.93 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 683 | 1 | 98 | 1,745,742 | 17.71 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 158 | 818 | 32,689,110 | 172,558,444 | 158 | 381 | 0 | 90.04 | 17.83 | 6 | 90.26 | 66 | 129 | 66 | 1 | 76 | 16,059,916 | 36 | 135 | 1,157,000 | 8.75 | 26 | 108 | 1 | 66 | 
| pairing | 1 | 198 | 683 | 22,314,288 | 119,958,502 | 198 | 384 | 1 | 71.47 | 14.93 | 5 | 66 | 99 | 141 | 99 | 0 | 56 | 9,408,294 | 71 | 59 | 588,742 | 18.21 | 20 | 87 | 1 | 99 | 

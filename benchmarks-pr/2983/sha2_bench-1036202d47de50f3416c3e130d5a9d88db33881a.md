...
| `total_proof_time_ms ` |  1,968.50 |  3,937 |  2,354 |  1,583 |
| `compile_metered_time_ms` |  6 |  6 |  6 |  6 |
| `execute_metered_time_ms` |  56 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  199.10 | -          |  199.10 |  199.10 |
| `execute_preflight_insns` |  5,583,980.50 |  11,167,961 |  7,136,000 |  4,031,961 |
| `execute_preflight_time_ms` |  342.50 |  685 |  483 |  202 |
| `execute_preflight_insn_mi/s` |  36.71 | -          |  37.04 |  36.37 |
| `trace_gen_time_ms   ` |  73 |  146 |  102 |  44 |
| `set_initial_memory_time_ms` |  0 |  0 |  0 |  0 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,551 |  3,102 |  2,047 |  1,055 |
| `prover.main_trace_commit_time_ms` |  391 |  782 |  569 |  213 |
| `prover.rap_constraints_time_ms` |  891.50 |  1,783 |  1,132 |  651 |
| `prover.openings_time_ms` |  267.50 |  535 |  346 |  189 |
| `prover.rap_constraints.logup_gkr_time_ms` |  206.50 |  413 |  231 |  182 |
| `prover.rap_constraints.round0_time_ms` |  507 |  1,014 |  669 |  345 |
| `prover.rap_constraints.mle_rounds_time_ms` |  177 |  354 |  231 |  123 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/1036202d47de50f3416c3e130d5a9d88db33881a/sha2_bench-1036202d47de50f3416c3e130d5a9d88db33881a.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 58 |  |  |  | 289 |  |  |  |  |  |  | 
| app_proof |  |  |  | 1,583 |  | 56 | 11,167,961 | 199.10 | 0 | 4,001 |  | 
...
| leaf | 0 | 116 | 524 | 116 | 34 | 12 | 2 | 9 | 9 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 171 | 46 | 0 | 0 | 78 | 27 | 27 | 37 | 13 | 0 | 46 | 35 | 10 | 2 | 7 | 47 | 46 | 78 | 0 | 1 | 12 | 0 | 0 | 
...
| leaf | 0 | prover | 237,929,144 | 408 | 145 | 0 | 0 | 141 | 70 | 69 | 44 | 25 | 0 | 120 | 98 | 22 | 10 | 11 | 145 | 145 | 141 | 0 | 3 | 25 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,280,083,194 | 2,047 | 568 | 0 | 0 | 1,132 | 669 | 668 | 231 | 231 | 1 | 346 | 252 | 93 | 57 | 36 | 569 | 568 | 1,132 | 0 | 1 | 229 | 0 | 0 | 
| app_proof | prover | 1 | 687,443,728 | 1,055 | 213 | 0 | 0 | 651 | 345 | 344 | 123 | 182 | 0 | 189 | 138 | 51 | 30 | 20 | 213 | 213 | 651 | 0 | 1 | 181 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 0 | 2 | 102 | 2,354 | 102 | 0 | 12,567,225,180 | 2,800,224,348 | 15,367,449,528 | 2,097,152 | 0 | 4 | 202 | 7,136,000 | 36.37 | 
| app_proof | 1 | 0 | 1 | 44 | 1,583 | 44 | 0 | 7,131,913,452 | 1,123,862,484 | 8,255,775,936 | 2,097,152 | 0 | 2 | 483 | 4,031,961 | 37.04 | 

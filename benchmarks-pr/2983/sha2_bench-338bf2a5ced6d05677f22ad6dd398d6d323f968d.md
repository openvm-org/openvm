...
|:---|---:|---:|---:|
| Total |  9.75 |  6.77 |  6.77 |
| app_proof |  8.08 |  5.11 |  5.11 |
...
| `total_proof_time_ms ` |  3,996.50 |  7,993 |  5,019 |  2,974 |
| `compile_metered_time_ms` |  4 |  4 |  4 |  4 |
| `execute_metered_time_ms` |  89 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  125.37 | -          |  125.37 |  125.37 |
| `execute_preflight_insns` |  5,583,980.50 |  11,167,961 |  7,124,000 |  4,043,961 |
| `execute_preflight_time_ms` |  247.50 |  495 |  288 |  207 |
| `execute_preflight_insn_mi/s` |  37.29 | -          |  39.54 |  35.04 |
| `trace_gen_time_ms   ` |  122 |  244 |  172 |  72 |
| `set_initial_memory_time_ms` |  0 |  0 |  0 |  0 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  3,625.50 |  7,251 |  4,639 |  2,612 |
| `prover.main_trace_commit_time_ms` |  959.50 |  1,919 |  1,331 |  588 |
| `prover.rap_constraints_time_ms` |  1,959 |  3,918 |  2,420 |  1,498 |
| `prover.openings_time_ms` |  705.50 |  1,411 |  886 |  525 |
| `prover.rap_constraints.logup_gkr_time_ms` |  550.50 |  1,101 |  592 |  509 |
| `prover.rap_constraints.round0_time_ms` |  1,030 |  2,060 |  1,340 |  720 |
| `prover.rap_constraints.mle_rounds_time_ms` |  377.50 |  755 |  487 |  268 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  998 |  998 |  998 |  998 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/338bf2a5ced6d05677f22ad6dd398d6d323f968d/sha2_bench-338bf2a5ced6d05677f22ad6dd398d6d323f968d.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 67 |  |  |  | 341 |  |  |  |  |  |  | 
| app_proof |  |  |  | 2,974 |  | 89 | 11,167,961 | 125.37 | 0 | 8,088 |  | 
...
| leaf | 0 | 110 | 998 | 110 | 34 | 17 | 2 | 7 | 7 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 321 | 116 | 0 | 0 | 106 | 34 | 33 | 51 | 20 | 0 | 98 | 84 | 13 | 3 | 9 | 117 | 116 | 106 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 166 | 46 | 0 | 0 | 66 | 24 | 23 | 27 | 14 | 0 | 52 | 44 | 8 | 1 | 6 | 46 | 46 | 66 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 137 | 32 | 0 | 0 | 61 | 23 | 22 | 24 | 13 | 0 | 42 | 35 | 7 | 1 | 5 | 33 | 32 | 61 | 0 | 3 | 12 | 0 | 0 | 
| leaf | 0 | prover | 237,929,016 | 888 | 372 | 0 | 0 | 225 | 108 | 107 | 66 | 51 | 0 | 289 | 252 | 36 | 19 | 17 | 372 | 372 | 225 | 0 | 10 | 50 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,286,242,554 | 4,639 | 1,331 | 0 | 0 | 2,420 | 1,340 | 1,339 | 487 | 592 | 0 | 886 | 676 | 210 | 131 | 78 | 1,331 | 1,331 | 2,420 | 0 | 5 | 591 | 0 | 0 | 
| app_proof | prover | 1 | 750,289,144 | 2,612 | 588 | 0 | 0 | 1,498 | 720 | 720 | 268 | 509 | 0 | 525 | 409 | 115 | 69 | 46 | 588 | 588 | 1,498 | 0 | 6 | 508 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 0 | 1 | 172 | 5,019 | 172 | 0 | 13,306,647,852 | 2,134,713,996 | 15,441,361,848 | 2,097,152 | 0 | 3 | 207 | 7,124,000 | 35.04 | 
| app_proof | 1 | 0 | 1 | 72 | 2,974 | 72 | 0 | 7,584,540,132 | 1,503,573,469 | 9,088,113,601 | 2,097,152 | 0 | 2 | 288 | 4,043,961 | 39.54 | 

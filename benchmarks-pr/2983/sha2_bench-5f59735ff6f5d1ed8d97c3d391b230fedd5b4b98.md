...
|:---|---:|---:|---:|
| Total |  4.91 |  3.31 |  3.31 |
| app_proof |  3.96 |  2.36 |  2.36 |
| leaf |  0.52 |  0.52 |  0.52 |
...
| `total_proof_time_ms ` |  1,952 |  3,904 |  2,300 |  1,604 |
| `compile_metered_time_ms` |  5 |  5 |  5 |  5 |
| `execute_metered_time_ms` |  56 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  199.04 | -          |  199.04 |  199.04 |
| `execute_preflight_insns` |  5,583,980.50 |  11,167,961 |  7,124,000 |  4,043,961 |
| `execute_preflight_time_ms` |  343 |  686 |  477 |  209 |
| `execute_preflight_insn_mi/s` |  36.14 | -          |  37.12 |  35.16 |
| `trace_gen_time_ms   ` |  70 |  140 |  96 |  44 |
| `set_initial_memory_time_ms` |  0 |  0 |  0 |  0 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,537 |  3,074 |  1,993 |  1,081 |
| `prover.main_trace_commit_time_ms` |  382.50 |  765 |  546 |  219 |
| `prover.rap_constraints_time_ms` |  890 |  1,780 |  1,116 |  664 |
| `prover.openings_time_ms` |  264 |  528 |  331 |  197 |
| `prover.rap_constraints.logup_gkr_time_ms` |  204.50 |  409 |  223 |  186 |
| `prover.rap_constraints.round0_time_ms` |  506.50 |  1,013 |  663 |  350 |
| `prover.rap_constraints.mle_rounds_time_ms` |  177.50 |  355 |  228 |  127 |
| `prover.openings.stacked_reduction_time_ms` |  72 |  144 |  91 |  53 |
| `prover.openings.stacked_reduction.round0_time_ms` |  44 |  88 |  56 |  32 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/5f59735ff6f5d1ed8d97c3d391b230fedd5b4b98/sha2_bench-5f59735ff6f5d1ed8d97c3d391b230fedd5b4b98.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 58 |  |  |  | 290 |  |  |  |  |  |  | 
| app_proof |  |  |  | 1,604 |  | 56 | 11,167,961 | 199.04 | 0 | 3,969 |  | 
...
| app_proof | VmAirWrapper<Rv64JalrAdapterAir, Rv64JalrCoreAir> | 1 | 15 | 16 | 
...
| leaf | 0 | 111 | 517 | 111 | 33 | 12 | 2 | 9 | 9 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 175 | 46 | 0 | 0 | 80 | 27 | 27 | 37 | 14 | 0 | 48 | 37 | 10 | 2 | 7 | 47 | 46 | 80 | 0 | 1 | 12 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 115 | 20 | 0 | 0 | 58 | 23 | 22 | 23 | 11 | 0 | 36 | 28 | 7 | 1 | 6 | 20 | 20 | 58 | 0 | 1 | 10 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 98 | 15 | 0 | 0 | 53 | 20 | 19 | 21 | 10 | 0 | 30 | 22 | 7 | 1 | 5 | 15 | 15 | 53 | 0 | 1 | 10 | 0 | 0 | 
| leaf | 0 | prover | 237,929,144 | 405 | 145 | 0 | 0 | 141 | 70 | 69 | 44 | 26 | 0 | 118 | 96 | 21 | 10 | 11 | 145 | 145 | 141 | 0 | 3 | 25 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,233,945,850 | 1,993 | 545 | 0 | 0 | 1,116 | 663 | 663 | 228 | 223 | 0 | 331 | 239 | 91 | 56 | 35 | 546 | 545 | 1,116 | 0 | 1 | 222 | 0 | 0 | 
| app_proof | prover | 1 | 698,978,064 | 1,081 | 219 | 0 | 0 | 664 | 350 | 350 | 127 | 186 | 0 | 197 | 144 | 53 | 32 | 21 | 219 | 219 | 664 | 0 | 1 | 184 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 0 | 2 | 96 | 2,300 | 96 | 0 | 12,684,755,076 | 2,129,046,324 | 14,813,801,400 | 2,097,152 | 0 | 4 | 209 | 7,124,000 | 35.16 | 
| app_proof | 1 | 0 | 1 | 44 | 1,604 | 44 | 0 | 7,231,569,048 | 1,162,618,920 | 8,394,187,968 | 2,097,152 | 0 | 2 | 477 | 4,043,961 | 37.12 | 

...
| `total_proof_time_ms ` |  422.50 |  845 |  426 |  419 |
| `compile_metered_time_ms` |  4 |  4 |  4 |  4 |
| `execute_metered_time_ms` |  21 | -          | -          | -          |
| `execute_metered_insns` |  4,000,051 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  186.79 | -          |  186.79 |  186.79 |
| `execute_preflight_insns` |  2,000,025.50 |  4,000,051 |  2,621,000 |  1,379,051 |
| `execute_preflight_time_ms` |  51.50 |  103 |  63 |  40 |
| `execute_preflight_insn_mi/s` |  46.41 | -          |  49.91 |  42.90 |
| `trace_gen_time_ms   ` |  32 |  64 |  41 |  23 |
| `set_initial_memory_time_ms` |  0 |  0 |  0 |  0 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  337.50 |  675 |  338 |  337 |
| `prover.main_trace_commit_time_ms` |  72.50 |  145 |  73 |  72 |
| `prover.rap_constraints_time_ms` |  184 |  368 |  186 |  182 |
| `prover.openings_time_ms` |  80 |  160 |  81 |  79 |
| `prover.rap_constraints.logup_gkr_time_ms` |  127 |  254 |  127 |  127 |
| `prover.rap_constraints.round0_time_ms` |  36 |  72 |  38 |  34 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  386 |  386 |  386 |  386 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/338bf2a5ced6d05677f22ad6dd398d6d323f968d/fibonacci-338bf2a5ced6d05677f22ad6dd398d6d323f968d.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 66 |  |  |  | 335 |  |  |  |  |  |  | 
| app_proof |  |  |  | 419 |  | 21 | 4,000,051 | 186.79 | 0 | 872 |  | 
...
| internal_recursive.0 | 1 | prover | 15,378,769 | 167 | 46 | 0 | 0 | 66 | 24 | 23 | 27 | 14 | 0 | 54 | 45 | 8 | 1 | 6 | 46 | 46 | 66 | 0 | 3 | 12 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 134 | 31 | 0 | 0 | 60 | 23 | 22 | 24 | 12 | 0 | 42 | 35 | 7 | 1 | 5 | 31 | 31 | 60 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 74,737,560 | 348 | 121 | 0 | 0 | 115 | 51 | 50 | 34 | 29 | 0 | 110 | 96 | 14 | 6 | 8 | 121 | 121 | 115 | 0 | 6 | 27 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 90,436,180 | 338 | 72 | 0 | 0 | 186 | 38 | 37 | 20 | 127 | 0 | 79 | 64 | 15 | 7 | 7 | 72 | 72 | 186 | 0 | 3 | 126 | 0 | 0 | 
| app_proof | prover | 1 | 90,435,040 | 337 | 73 | 0 | 0 | 182 | 34 | 34 | 19 | 127 | 0 | 81 | 67 | 14 | 7 | 6 | 73 | 73 | 182 | 0 | 3 | 127 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 0 | 2 | 23 | 426 | 23 | 0 | 2,145,305,497 | 522,291 | 2,145,827,788 | 2,097,152 | 0 | 4 | 63 | 2,621,000 | 42.90 | 
| app_proof | 1 | 0 | 1 | 41 | 419 | 41 | 0 | 1,164,981,971 | 980,826,252 | 2,145,808,223 | 2,097,152 | 0 | 2 | 40 | 1,379,051 | 49.91 | 

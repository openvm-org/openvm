...
|:---|---:|---:|---:|
| Total |  5.04 |  3.37 |  3.37 |
| app_proof |  4.09 |  2.42 |  2.42 |
| leaf |  0.52 |  0.52 |  0.52 |
...
| `total_proof_time_ms ` |  2,015.50 |  4,031 |  2,360 |  1,671 |
| `compile_metered_time_ms` |  5 |  5 |  5 |  5 |
| `execute_metered_time_ms` |  59 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  188.29 | -          |  188.29 |  188.29 |
| `execute_preflight_insns` |  5,583,980.50 |  11,167,961 |  7,124,000 |  4,043,961 |
| `execute_preflight_time_ms` |  350 |  700 |  496 |  204 |
| `execute_preflight_insn_mi/s` |  35.73 | -          |  36.08 |  35.38 |
| `trace_gen_time_ms   ` |  73.50 |  147 |  101 |  46 |
| `set_initial_memory_time_ms` |  0 |  0 |  0 |  0 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,591 |  3,182 |  2,054 |  1,128 |
| `prover.main_trace_commit_time_ms` |  396.50 |  793 |  562 |  231 |
| `prover.rap_constraints_time_ms` |  922.50 |  1,845 |  1,151 |  694 |
| `prover.openings_time_ms` |  271 |  542 |  340 |  202 |
| `prover.rap_constraints.logup_gkr_time_ms` |  218 |  436 |  238 |  198 |
| `prover.rap_constraints.round0_time_ms` |  519.50 |  1,039 |  678 |  361 |
| `prover.rap_constraints.mle_rounds_time_ms` |  184 |  368 |  235 |  133 |
| `prover.openings.stacked_reduction_time_ms` |  74 |  148 |  93 |  55 |
| `prover.openings.stacked_reduction.round0_time_ms` |  45 |  90 |  57 |  33 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  28.50 |  57 |  35 |  22 |
| `prover.openings.whir_time_ms` |  196 |  392 |  246 |  146 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/79c1fe8b799abbd1e6bd2e169b37099135f89917/sha2_bench-79c1fe8b799abbd1e6bd2e169b37099135f89917.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 59 |  |  |  | 292 |  |  |  |  |  |  | 
| app_proof |  |  |  | 1,671 |  | 59 | 11,167,961 | 188.29 | 0 | 4,099 |  | 
...
| app_proof | VmAirWrapper<Rv64LoadAdapterAir, LoadCoreAir<8, 3, 5> | 0 | 5 | 9 | 
...
| app_proof | VmAirWrapper<Rv64StoreAdapterAir, StoreCoreAir<8, 3, 4> | 0 | 7 | 10 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 173 | 46 | 0 | 0 | 79 | 27 | 27 | 37 | 14 | 0 | 46 | 36 | 10 | 2 | 7 | 47 | 46 | 79 | 0 | 1 | 12 | 0 | 0 | 
...
| leaf | 0 | prover | 237,929,144 | 406 | 146 | 0 | 0 | 142 | 71 | 69 | 44 | 26 | 0 | 116 | 94 | 22 | 10 | 11 | 147 | 146 | 142 | 0 | 3 | 25 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,265,927,418 | 2,054 | 561 | 0 | 0 | 1,151 | 678 | 677 | 235 | 238 | 0 | 340 | 246 | 93 | 57 | 35 | 562 | 561 | 1,151 | 0 | 1 | 236 | 0 | 0 | 
| app_proof | prover | 1 | 730,173,064 | 1,128 | 231 | 0 | 0 | 694 | 361 | 360 | 133 | 198 | 0 | 202 | 146 | 55 | 33 | 22 | 231 | 231 | 694 | 0 | 1 | 197 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 0 | 2 | 101 | 2,360 | 101 | 0 | 13,064,174,616 | 2,133,405,600 | 15,197,580,216 | 2,097,152 | 0 | 4 | 204 | 7,124,000 | 36.08 | 
| app_proof | 1 | 0 | 1 | 46 | 1,671 | 46 | 0 | 7,446,912,480 | 1,841,116,631 | 9,288,029,111 | 2,097,152 | 0 | 2 | 496 | 4,043,961 | 35.38 | 

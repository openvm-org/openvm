...
| `total_proof_time_ms ` |  434.50 |  869 |  440 |  429 |
| `compile_metered_time_ms` |  4 |  4 |  4 |  4 |
| `execute_metered_time_ms` |  21 | -          | -          | -          |
| `execute_metered_insns` |  4,000,051 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  189.94 | -          |  189.94 |  189.94 |
| `execute_preflight_insns` |  2,000,025.50 |  4,000,051 |  2,621,000 |  1,379,051 |
| `execute_preflight_time_ms` |  52 |  104 |  63 |  41 |
| `execute_preflight_insn_mi/s` |  46.02 | -          |  49.40 |  42.65 |
| `trace_gen_time_ms   ` |  34 |  68 |  44 |  24 |
| `set_initial_memory_time_ms` |  0 |  0 |  0 |  0 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  347 |  694 |  351 |  343 |
| `prover.main_trace_commit_time_ms` |  75.50 |  151 |  76 |  75 |
| `prover.rap_constraints_time_ms` |  189 |  378 |  192 |  186 |
| `prover.openings_time_ms` |  81 |  162 |  82 |  80 |
| `prover.rap_constraints.logup_gkr_time_ms` |  130 |  260 |  130 |  130 |
| `prover.rap_constraints.round0_time_ms` |  38.50 |  77 |  41 |  36 |
...
| `prover.openings.whir_time_ms` |  66 |  132 |  67 |  65 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/ee9a87629b7848fafe73f016f88e900a519baac8/fibonacci-ee9a87629b7848fafe73f016f88e900a519baac8.memory.svg)
...
| 20 | VmAirWrapper<Rv64LoadAdapterAir, LoadSignExtendCoreAir<4, 3, 2> |  | 28 | 19 | 3 | 
...
| 23 | VmAirWrapper<Rv64LoadAdapterAir, LoadSignExtendCoreAir<2, 3, 1> |  | 27 | 18 | 3 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 68 |  |  |  | 341 |  |  |  |  |  |  | 
| app_proof |  |  |  | 429 |  | 21 | 4,000,051 | 189.94 | 0 | 895 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 27,277,885 | 257 | 81 | 0 | 0 | 98 | 32 | 32 | 45 | 20 | 0 | 76 | 64 | 11 | 2 | 8 | 82 | 81 | 98 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 169 | 46 | 0 | 0 | 67 | 24 | 24 | 28 | 13 | 0 | 55 | 46 | 8 | 1 | 6 | 47 | 46 | 67 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 136 | 32 | 0 | 0 | 61 | 23 | 22 | 24 | 13 | 0 | 42 | 35 | 7 | 1 | 5 | 32 | 32 | 61 | 0 | 3 | 13 | 0 | 0 | 
| leaf | 0 | prover | 74,817,208 | 351 | 123 | 0 | 0 | 117 | 53 | 52 | 35 | 28 | 0 | 109 | 95 | 14 | 6 | 8 | 124 | 123 | 117 | 0 | 6 | 28 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 90,436,104 | 351 | 76 | 0 | 0 | 192 | 41 | 41 | 20 | 130 | 0 | 82 | 67 | 15 | 7 | 7 | 76 | 76 | 192 | 0 | 3 | 129 | 0 | 0 | 
| app_proof | prover | 1 | 90,435,021 | 343 | 75 | 0 | 0 | 186 | 36 | 36 | 20 | 130 | 0 | 80 | 65 | 14 | 8 | 6 | 75 | 75 | 186 | 0 | 3 | 129 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 0 | 2 | 24 | 440 | 24 | 0 | 2,145,306,208 | 522,291 | 2,145,828,499 | 2,097,152 | 0 | 3 | 63 | 2,621,000 | 42.65 | 
| app_proof | 1 | 0 | 1 | 44 | 429 | 44 | 0 | 1,164,982,148 | 980,826,253 | 2,145,808,401 | 2,097,152 | 0 | 2 | 41 | 1,379,051 | 49.40 | 

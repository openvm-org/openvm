...
|:---|---:|---:|---:|
| Total |  5.17 |  3.54 |  3.54 |
| app_proof |  4.23 |  2.61 |  2.61 |
| leaf |  0.51 |  0.51 |  0.51 |
...
| `total_proof_time_ms ` |  2,088 |  4,176 |  2,554 |  1,622 |
| `compile_metered_time_ms` |  4 |  4 |  4 |  4 |
| `execute_metered_time_ms` |  56 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  198.19 | -          |  198.19 |  198.19 |
| `execute_preflight_insns` |  5,583,980.50 |  11,167,961 |  7,136,000 |  4,031,961 |
| `execute_preflight_time_ms` |  350.50 |  701 |  479 |  222 |
| `execute_preflight_insn_mi/s` |  35.90 | -          |  38.07 |  33.73 |
| `trace_gen_time_ms   ` |  75 |  150 |  105 |  45 |
| `set_initial_memory_time_ms` |  0 |  0 |  0 |  0 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,662 |  3,324 |  2,226 |  1,098 |
| `prover.main_trace_commit_time_ms` |  402 |  804 |  581 |  223 |
| `prover.rap_constraints_time_ms` |  983.50 |  1,967 |  1,291 |  676 |
| `prover.openings_time_ms` |  275 |  550 |  353 |  197 |
| `prover.rap_constraints.logup_gkr_time_ms` |  273.50 |  547 |  354 |  193 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/693ead36f64266f8f8430f7aa74ef939f72d0a85/sha2_bench-693ead36f64266f8f8430f7aa74ef939f72d0a85.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 55 |  |  |  | 287 |  |  |  |  |  |  | 
| app_proof |  |  |  | 1,622 |  | 56 | 11,167,961 | 198.19 | 0 | 4,240 |  | 
...
| app_proof | VmAirWrapper<Rv64BranchAdapterAir, BranchEqualCoreAir<4> | 0 | 3 | 4 | 
...
| app_proof | VmAirWrapper<Rv64LoadMultiByteAdapterAir, LoadCoreAir<8, 3, 5> | 0 | 5 | 8 | 
...
| app_proof | VmAirWrapper<Rv64StoreMultiByteAdapterAir, StoreCoreAir<8, 3, 4> | 0 | 6 | 12 | 
...
| leaf | 0 | 113 | 514 | 112 | 34 | 13 | 2 | 9 | 9 | 
...
| leaf | 0 | prover | 237,929,144 | 401 | 144 | 0 | 0 | 141 | 70 | 69 | 44 | 26 | 0 | 114 | 93 | 21 | 10 | 11 | 145 | 144 | 141 | 0 | 3 | 25 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,324,516,602 | 2,226 | 581 | 0 | 0 | 1,291 | 702 | 702 | 234 | 354 | 1 | 353 | 256 | 96 | 59 | 37 | 581 | 581 | 1,291 | 0 | 1 | 352 | 0 | 0 | 
| app_proof | prover | 1 | 716,475,896 | 1,098 | 223 | 0 | 0 | 676 | 355 | 355 | 126 | 193 | 0 | 197 | 144 | 53 | 31 | 21 | 223 | 223 | 676 | 0 | 1 | 192 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 0 | 2 | 105 | 2,554 | 105 | 0 | 12,918,735,564 | 2,978,228,460 | 15,896,964,024 | 2,097,152 | 0 | 4 | 222 | 7,136,000 | 33.73 | 
| app_proof | 1 | 0 | 1 | 45 | 1,622 | 45 | 0 | 7,331,586,696 | 1,706,847,983 | 9,038,434,679 | 2,097,152 | 0 | 2 | 479 | 4,031,961 | 38.07 | 

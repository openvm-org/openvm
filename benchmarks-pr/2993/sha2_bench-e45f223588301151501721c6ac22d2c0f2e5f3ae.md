...
|:---|---:|---:|---:|
| Total |  9.74 |  6.80 |  6.80 |
| app_proof |  8.05 |  5.11 |  5.11 |
| leaf |  1 |  1 |  1 |
...
| `total_proof_time_ms ` |  3,981 |  7,962 |  5,020 |  2,942 |
| `compile_metered_time_ms` |  4 |  4 |  4 |  4 |
| `execute_metered_time_ms` |  93 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  119.04 | -          |  119.04 |  119.04 |
| `execute_preflight_insns` |  5,583,980.50 |  11,167,961 |  7,124,000 |  4,043,961 |
| `execute_preflight_time_ms` |  241 |  482 |  274 |  208 |
| `execute_preflight_insn_mi/s` |  37.10 | -          |  39.42 |  34.77 |
| `trace_gen_time_ms   ` |  123 |  246 |  173 |  73 |
| `set_initial_memory_time_ms` |  0 |  0 |  0 |  0 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  3,616 |  7,232 |  4,638 |  2,594 |
| `prover.main_trace_commit_time_ms` |  957 |  1,914 |  1,325 |  589 |
| `prover.rap_constraints_time_ms` |  1,955 |  3,910 |  2,425 |  1,485 |
| `prover.openings_time_ms` |  703 |  1,406 |  887 |  519 |
| `prover.rap_constraints.logup_gkr_time_ms` |  555 |  1,110 |  598 |  512 |
| `prover.rap_constraints.round0_time_ms` |  1,023 |  2,046 |  1,340 |  706 |
| `prover.rap_constraints.mle_rounds_time_ms` |  375 |  750 |  485 |  265 |
...
| `prover.openings.whir_time_ms` |  536.50 |  1,073 |  672 |  401 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,004 |  1,004 |  1,004 |  1,004 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/e45f223588301151501721c6ac22d2c0f2e5f3ae/sha2_bench-e45f223588301151501721c6ac22d2c0f2e5f3ae.memory.svg)

| Module | Max (GB) | Max At |
| --- | ---: | --- |
| prover.stacked_commit | 14.47 | app_proof.prover.0 |
| frac_sumcheck.gkr_rounds | 12.44 | app_proof.prover.0 |
| prover.batch_constraints.before_round0 | 12.44 | app_proof.prover.0 |
| prover.gkr_input_evals | 12.10 | app_proof.prover.0 |
| frac_sumcheck.segment_tree | 12.10 | app_proof.prover.0 |
...
| 20 | VmAirWrapper<Rv64StoreAdapterAir, StoreCoreAir<8, 3, 4> |  | 29 | 24 | 3 | 
| 21 | VmAirWrapper<Rv64LoadAdapterAir, LoadCoreAir<8, 3, 5> |  | 28 | 25 | 3 | 
| 22 | VmAirWrapper<Rv64StoreAdapterAir, StoreCoreAir<4, 3, 2> |  | 27 | 22 | 3 | 
| 23 | VmAirWrapper<Rv64LoadAdapterAir, LoadCoreAir<4, 3, 3> |  | 26 | 23 | 3 | 
| 24 | VmAirWrapper<Rv64LoadAdapterAir, LoadSignExtendCoreAir<4, 3, 3> |  | 28 | 24 | 3 | 
| 25 | VmAirWrapper<Rv64StoreAdapterAir, StoreCoreAir<2, 3, 1> |  | 26 | 21 | 3 | 
| 26 | VmAirWrapper<Rv64LoadAdapterAir, LoadCoreAir<2, 3, 2> |  | 25 | 22 | 3 | 
| 27 | VmAirWrapper<Rv64LoadAdapterAir, LoadSignExtendCoreAir<2, 3, 2> |  | 27 | 23 | 3 | 
| 28 | VmAirWrapper<Rv64StoreAdapterAir, StoreByteCoreAir> |  | 25 | 18 | 3 | 
| 29 | VmAirWrapper<Rv64LoadAdapterAir, LoadByteCoreAir> |  | 24 | 19 | 3 | 
| 3 | MemoryMerkleAir<8> | 1 | 4 | 35 | 3 | 
| 30 | VmAirWrapper<Rv64LoadAdapterAir, LoadSignExtendByteCoreAir> |  | 25 | 20 | 3 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 68 |  |  |  | 342 |  |  |  |  |  |  | 
| app_proof |  |  |  | 2,942 |  | 93 | 11,167,961 | 119.04 | 0 | 8,062 |  | 
...
| app_proof | VmAirWrapper<Rv64LoadAdapterAir, LoadSignExtendByteCoreAir> | 16 | VmAirWrapper<Rv64LoadAdapterAir, LoadSignExtendByteCoreAir> | 1 | 512 | 
...
| app_proof | VmAirWrapper<Rv64StoreAdapterAir, StoreByteCoreAir> | 18 | VmAirWrapper<Rv64StoreAdapterAir, StoreByteCoreAir> | 1 | 2,560 | 
...
| app_proof | 20 | VmAirWrapper<Rv64StoreAdapterAir, StoreCoreAir<8, 3, 4> | prover | 0 | 1,048,576 | 53 | 55,574,528 | 
| app_proof | 21 | VmAirWrapper<Rv64LoadAdapterAir, LoadCoreAir<8, 3, 5> | prover | 0 | 1,048,576 | 51 | 53,477,376 | 
| app_proof | 24 | VmAirWrapper<Rv64LoadAdapterAir, LoadSignExtendCoreAir<4, 3, 3> | prover | 0 | 131,072 | 48 | 6,291,456 | 
...
| app_proof | 20 | VmAirWrapper<Rv64StoreAdapterAir, StoreCoreAir<8, 3, 4> | prover | 1 | 1,048,576 | 53 | 55,574,528 | 
| app_proof | 21 | VmAirWrapper<Rv64LoadAdapterAir, LoadCoreAir<8, 3, 5> | prover | 1 | 1,048,576 | 51 | 53,477,376 | 
| app_proof | 24 | VmAirWrapper<Rv64LoadAdapterAir, LoadSignExtendCoreAir<4, 3, 3> | prover | 1 | 65,536 | 48 | 3,145,728 | 
| app_proof | 28 | VmAirWrapper<Rv64StoreAdapterAir, StoreByteCoreAir> | prover | 1 | 64 | 40 | 2,560 | 
| app_proof | 3 | MemoryMerkleAir<8> | prover | 1 | 1,024 | 32 | 32,768 | 
| app_proof | 30 | VmAirWrapper<Rv64LoadAdapterAir, LoadSignExtendByteCoreAir> | prover | 1 | 8 | 39 | 312 | 
...
| app_proof | 20 | VmAirWrapper<Rv64StoreAdapterAir, StoreCoreAir<8, 3, 4>
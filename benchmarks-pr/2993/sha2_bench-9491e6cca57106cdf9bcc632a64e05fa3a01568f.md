...
|:---|---:|---:|---:|
| Total |  9.47 |  6.61 |  6.61 |
| app_proof |  7.82 |  4.96 |  4.96 |
| leaf |  0.99 |  0.99 |  0.99 |
...
| `total_proof_time_ms ` |  3,861.50 |  7,723 |  4,867 |  2,856 |
| `compile_metered_time_ms` |  4 |  4 |  4 |  4 |
| `execute_metered_time_ms` |  95 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  117.52 | -          |  117.52 |  117.52 |
| `execute_preflight_insns` |  5,583,980.50 |  11,167,961 |  7,124,000 |  4,043,961 |
| `execute_preflight_time_ms` |  235 |  470 |  271 |  199 |
| `execute_preflight_insn_mi/s` |  38.89 | -          |  41.32 |  36.45 |
| `trace_gen_time_ms   ` |  122 |  244 |  171 |  73 |
| `set_initial_memory_time_ms` |  0 |  0 |  0 |  0 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  3,503.50 |  7,007 |  4,496 |  2,511 |
| `prover.main_trace_commit_time_ms` |  926.50 |  1,853 |  1,288 |  565 |
| `prover.rap_constraints_time_ms` |  1,889.50 |  3,779 |  2,340 |  1,439 |
| `prover.openings_time_ms` |  685.50 |  1,371 |  866 |  505 |
| `prover.rap_constraints.logup_gkr_time_ms` |  544.50 |  1,089 |  588 |  501 |
| `prover.rap_constraints.round0_time_ms` |  980.50 |  1,961 |  1,282 |  679 |
| `prover.rap_constraints.mle_rounds_time_ms` |  363 |  726 |  469 |  257 |
| `prover.openings.stacked_reduction_time_ms` |  157.50 |  315 |  203 |  112 |
| `prover.openings.stacked_reduction.round0_time_ms` |  97 |  194 |  126 |  68 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  60 |  120 |  76 |  44 |
| `prover.openings.whir_time_ms` |  528 |  1,056 |  663 |  393 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/9491e6cca57106cdf9bcc632a64e05fa3a01568f/sha2_bench-9491e6cca57106cdf9bcc632a64e05fa3a01568f.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 71 |  |  |  | 341 |  |  |  |  |  |  | 
| app_proof |  |  |  | 2,856 |  | 95 | 11,167,961 | 117.52 | 0 | 7,824 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 319 | 115 | 0 | 0 | 106 | 34 | 34 | 51 | 20 | 0 | 97 | 83 | 13 | 3 | 9 | 115 | 115 | 106 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 163 | 45 | 0 | 0 | 63 | 22 | 22 | 27 | 13 | 0 | 53 | 45 | 8 | 1 | 6 | 45 | 45 | 63 | 0 | 2 | 12 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 137 | 32 | 0 | 0 | 60 | 22 | 21 | 24 | 13 | 0 | 44 | 36 | 7 | 1 | 5 | 32 | 32 | 60 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 237,929,144 | 879 | 366 | 0 | 0 | 222 | 106 | 105 | 65 | 50 | 0 | 289 | 252 | 37 | 19 | 17 | 367 | 366 | 222 | 0 | 9 | 49 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,265,926,394 | 4,496 | 1,288 | 0 | 0 | 2,340 | 1,282 | 1,281 | 469 | 588 | 1 | 866 | 663 | 203 | 126 | 76 | 1,288 | 1,288 | 2,340 | 0 | 4 | 586 | 0 | 0 | 
| app_proof | prover | 1 | 730,172,040 | 2,511 | 565 | 0 | 0 | 1,439 | 679 | 679 | 257 | 501 | 0 | 505 | 393 | 112 | 68 | 44 | 565 | 565 | 1,439 | 0 | 5 | 500 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 0 | 1 | 171 | 4,867 | 171 | 0 | 13,064,165,664 | 2,133,402,264 | 15,197,567,928 | 2,097,152 | 0 | 3 | 199 | 7,124,000 | 36.45 | 
| app_proof | 1 | 0 | 1 | 73 | 2,856 | 73 | 0 | 7,446,903,480 | 1,841,121,535 | 9,288,025,015 | 2,097,152 | 0 | 2 | 271 | 4,043,961 | 41.32 | 

...
| `total_proof_time_ms ` |  2,123.50 |  4,247 |  2,584 |  1,663 |
| `compile_metered_time_ms` |  5 |  5 |  5 |  5 |
| `execute_metered_time_ms` |  56 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  196.48 | -          |  196.48 |  196.48 |
| `execute_preflight_insns` |  5,583,980.50 |  11,167,961 |  7,136,000 |  4,031,961 |
| `execute_preflight_time_ms` |  356 |  712 |  499 |  213 |
| `execute_preflight_insn_mi/s` |  37.65 | -          |  39.94 |  35.36 |
| `trace_gen_time_ms   ` |  79 |  158 |  111 |  47 |
| `set_initial_memory_time_ms` |  0 |  0 |  0 |  0 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,687 |  3,374 |  2,259 |  1,115 |
| `prover.main_trace_commit_time_ms` |  410.50 |  821 |  595 |  226 |
| `prover.rap_constraints_time_ms` |  999.50 |  1,999 |  1,310 |  689 |
| `prover.openings_time_ms` |  276 |  552 |  353 |  199 |
| `prover.rap_constraints.logup_gkr_time_ms` |  279 |  558 |  361 |  197 |
| `prover.rap_constraints.round0_time_ms` |  534.50 |  1,069 |  709 |  360 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/9c9dc3886787d71836b8416a318be9f04be8fde4/sha2_bench-9c9dc3886787d71836b8416a318be9f04be8fde4.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 58 |  |  |  | 290 |  |  |  |  |  |  | 
| app_proof |  |  |  | 1,663 |  | 56 | 11,167,961 | 196.48 | 0 | 4,313 |  | 
...
| leaf | 0 | 118 | 524 | 118 | 36 | 12 | 2 | 10 | 10 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 174 | 46 | 0 | 0 | 80 | 29 | 28 | 36 | 13 | 0 | 46 | 36 | 10 | 2 | 7 | 46 | 46 | 80 | 0 | 1 | 12 | 0 | 0 | 
...
| leaf | 0 | prover | 237,929,144 | 405 | 145 | 0 | 0 | 142 | 71 | 70 | 44 | 26 | 0 | 116 | 94 | 21 | 10 | 11 | 146 | 145 | 142 | 0 | 3 | 25 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,324,516,602 | 2,259 | 595 | 0 | 0 | 1,310 | 709 | 708 | 238 | 361 | 1 | 353 | 256 | 97 | 59 | 37 | 595 | 595 | 1,310 | 0 | 1 | 359 | 0 | 0 | 
| app_proof | prover | 1 | 716,475,896 | 1,115 | 226 | 0 | 0 | 689 | 360 | 359 | 131 | 197 | 0 | 199 | 145 | 53 | 32 | 21 | 226 | 226 | 689 | 0 | 1 | 196 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 0 | 2 | 111 | 2,584 | 111 | 0 | 12,918,735,564 | 2,978,228,460 | 15,896,964,024 | 2,097,152 | 0 | 4 | 213 | 7,136,000 | 35.36 | 
| app_proof | 1 | 0 | 1 | 47 | 1,663 | 47 | 0 | 7,331,586,696 | 1,706,847,983 | 9,038,434,679 | 2,097,152 | 0 | 2 | 499 | 4,031,961 | 39.94 | 

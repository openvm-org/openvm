...
|:---|---:|---:|---:|
| Total |  5.16 |  3.54 |  3.54 |
| app_proof |  4.22 |  2.60 |  2.60 |
| leaf |  0.52 |  0.52 |  0.52 |
...
| `total_proof_time_ms ` |  2,084 |  4,168 |  2,544 |  1,624 |
| `compile_metered_time_ms` |  5 |  5 |  5 |  5 |
| `execute_metered_time_ms` |  56 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  198.30 | -          |  198.30 |  198.30 |
| `execute_preflight_insns` |  5,583,980.50 |  11,167,961 |  7,136,000 |  4,031,961 |
| `execute_preflight_time_ms` |  343 |  686 |  475 |  211 |
| `execute_preflight_insn_mi/s` |  37.74 | -          |  39.90 |  35.58 |
| `trace_gen_time_ms   ` |  74.50 |  149 |  105 |  44 |
| `set_initial_memory_time_ms` |  0 |  0 |  0 |  0 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,665 |  3,330 |  2,226 |  1,104 |
| `prover.main_trace_commit_time_ms` |  402.50 |  805 |  581 |  224 |
| `prover.rap_constraints_time_ms` |  985.50 |  1,971 |  1,292 |  679 |
| `prover.openings_time_ms` |  275.50 |  551 |  352 |  199 |
| `prover.rap_constraints.logup_gkr_time_ms` |  274 |  548 |  353 |  195 |
| `prover.rap_constraints.round0_time_ms` |  530 |  1,060 |  704 |  356 |
| `prover.rap_constraints.mle_rounds_time_ms` |  180.50 |  361 |  234 |  127 |
| `prover.openings.stacked_reduction_time_ms` |  74.50 |  149 |  95 |  54 |
| `prover.openings.stacked_reduction.round0_time_ms` |  45 |  90 |  58 |  32 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  522 |  522 |  522 |  522 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/71adc7aece96e30fd50d8712bf36b8ee8c620ce7/sha2_bench-71adc7aece96e30fd50d8712bf36b8ee8c620ce7.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 58 |  |  |  | 287 |  |  |  |  |  |  | 
| app_proof |  |  |  | 1,624 |  | 56 | 11,167,961 | 198.30 | 0 | 4,233 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 176 | 46 | 0 | 0 | 79 | 29 | 28 | 36 | 13 | 0 | 49 | 38 | 10 | 2 | 7 | 47 | 46 | 79 | 0 | 1 | 12 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 107 | 20 | 0 | 0 | 55 | 20 | 20 | 23 | 11 | 0 | 31 | 23 | 7 | 1 | 6 | 20 | 20 | 55 | 0 | 1 | 10 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 94 | 15 | 0 | 0 | 54 | 20 | 19 | 21 | 12 | 0 | 24 | 17 | 7 | 1 | 5 | 15 | 15 | 54 | 0 | 1 | 10 | 0 | 0 | 
| leaf | 0 | prover | 237,929,144 | 408 | 145 | 0 | 0 | 141 | 71 | 69 | 44 | 26 | 0 | 120 | 98 | 21 | 10 | 11 | 146 | 145 | 141 | 0 | 3 | 25 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,324,516,602 | 2,226 | 581 | 0 | 0 | 1,292 | 704 | 703 | 234 | 353 | 1 | 352 | 256 | 95 | 58 | 37 | 581 | 581 | 1,292 | 0 | 1 | 351 | 0 | 0 | 
| app_proof | prover | 1 | 716,475,896 | 1,104 | 224 | 0 | 0 | 679 | 356 | 356 | 127 | 195 | 0 | 199 | 145 | 54 | 32 | 21 | 224 | 224 | 679 | 0 | 1 | 193 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 0 | 2 | 105 | 2,544 | 104 | 0 | 12,918,735,564 | 2,978,228,460 | 15,896,964,024 | 2,097,152 | 0 | 4 | 211 | 7,136,000 | 35.58 | 
| app_proof | 1 | 0 | 1 | 44 | 1,624 | 44 | 0 | 7,331,586,696 | 1,706,847,983 | 9,038,434,679 | 2,097,152 | 0 | 2 | 475 | 4,031,961 | 39.90 | 

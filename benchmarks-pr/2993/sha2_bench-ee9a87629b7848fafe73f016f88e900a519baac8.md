...
| `total_proof_time_ms ` |  3,922.50 |  7,845 |  4,946 |  2,899 |
...
| `execute_preflight_time_ms` |  236.50 |  473 |  271 |  202 |
| `execute_preflight_insn_mi/s` |  38.25 | -          |  40.64 |  35.86 |
| `trace_gen_time_ms   ` |  122.50 |  245 |  172 |  73 |
| `set_initial_memory_time_ms` |  0 |  0 |  0 |  0 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  3,562 |  7,124 |  4,571 |  2,553 |
| `prover.main_trace_commit_time_ms` |  942 |  1,884 |  1,309 |  575 |
| `prover.rap_constraints_time_ms` |  1,928 |  3,856 |  2,388 |  1,468 |
| `prover.openings_time_ms` |  691 |  1,382 |  873 |  509 |
| `prover.rap_constraints.logup_gkr_time_ms` |  553 |  1,106 |  597 |  509 |
| `prover.rap_constraints.round0_time_ms` |  1,000 |  2,000 |  1,308 |  692 |
| `prover.rap_constraints.mle_rounds_time_ms` |  374.50 |  749 |  483 |  266 |
| `prover.openings.stacked_reduction_time_ms` |  161.50 |  323 |  208 |  115 |
| `prover.openings.stacked_reduction.round0_time_ms` |  99.50 |  199 |  129 |  70 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/ee9a87629b7848fafe73f016f88e900a519baac8/sha2_bench-ee9a87629b7848fafe73f016f88e900a519baac8.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 67 |  |  |  | 345 |  |  |  |  |  |  | 
| app_proof |  |  |  | 2,899 |  | 94 | 11,167,961 | 117.67 | 0 | 7,946 |  | 
...
| leaf | 0 | 108 | 1,000 | 108 | 33 | 16 | 2 | 7 | 7 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 325 | 117 | 0 | 0 | 107 | 35 | 34 | 51 | 21 | 0 | 100 | 86 | 13 | 3 | 9 | 117 | 117 | 107 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 170 | 46 | 0 | 0 | 67 | 24 | 24 | 28 | 13 | 0 | 56 | 47 | 8 | 1 | 6 | 47 | 46 | 67 | 0 | 3 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 137 | 31 | 0 | 0 | 62 | 23 | 23 | 25 | 13 | 0 | 43 | 36 | 7 | 1 | 5 | 31 | 31 | 62 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 237,929,144 | 891 | 373 | 0 | 0 | 224 | 107 | 106 | 65 | 51 | 0 | 292 | 255 | 37 | 19 | 17 | 373 | 373 | 224 | 0 | 10 | 50 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,266,057,466 | 4,571 | 1,309 | 0 | 0 | 2,388 | 1,308 | 1,307 | 483 | 597 | 0 | 873 | 665 | 208 | 129 | 78 | 1,309 | 1,309 | 2,388 | 0 | 5 | 595 | 0 | 0 | 
| app_proof | prover | 1 | 730,237,576 | 2,553 | 575 | 0 | 0 | 1,468 | 692 | 691 | 266 | 509 | 0 | 509 | 394 | 115 | 70 | 45 | 575 | 575 | 1,468 | 0 | 5 | 508 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 0 | 1 | 172 | 4,946 | 172 | 0 | 13,065,419,808 | 2,133,720,984 | 15,199,140,792 | 2,097,152 | 0 | 4 | 202 | 7,124,000 | 35.86 | 
| app_proof | 1 | 0 | 1 | 73 | 2,899 | 73 | 0 | 7,447,615,524 | 1,840,671,635 | 9,288,287,159 | 2,097,152 | 0 | 2 | 271 | 4,043,961 | 40.64 | 

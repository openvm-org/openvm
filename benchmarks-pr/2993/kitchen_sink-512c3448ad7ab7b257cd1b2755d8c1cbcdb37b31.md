...
| `total_proof_time_ms ` |  3,787 |  3,787 |  3,787 |  3,787 |
| `compile_metered_time_ms` |  2 |  2 |  2 |  2 |
| `execute_metered_time_ms` |  23 | -          | -          | -          |
| `execute_metered_insns` |  1,979,971 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  83.53 | -          |  83.53 |  83.53 |
| `execute_preflight_insns` |  1,979,971 |  1,979,971 |  1,979,971 |  1,979,971 |
| `execute_preflight_time_ms` |  68 |  68 |  68 |  68 |
| `execute_preflight_insn_mi/s` |  32.02 | -          |  32.02 |  32.02 |
| `trace_gen_time_ms   ` |  71 |  71 |  71 |  71 |
| `set_initial_memory_time_ms` |  0 |  0 |  0 |  0 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  3,646 |  3,646 |  3,646 |  3,646 |
| `prover.main_trace_commit_time_ms` |  1,151 |  1,151 |  1,151 |  1,151 |
| `prover.rap_constraints_time_ms` |  1,707 |  1,707 |  1,707 |  1,707 |
| `prover.openings_time_ms` |  788 |  788 |  788 |  788 |
| `prover.rap_constraints.logup_gkr_time_ms` |  291 |  291 |  291 |  291 |
| `prover.rap_constraints.round0_time_ms` |  1,024 |  1,024 |  1,024 |  1,024 |
| `prover.rap_constraints.mle_rounds_time_ms` |  391 |  391 |  391 |  391 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  889 |  889 |  889 |  889 |
| `execute_preflight_time_ms` |  18 |  18 |  18 |  18 |
| `trace_gen_time_ms   ` |  103 |  103 |  103 |  103 |
| `generate_blob_total_time_ms` |  9 |  9 |  9 |  9 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  785 |  785 |  785 |  785 |
| `prover.main_trace_commit_time_ms` |  260 |  260 |  260 |  260 |
| `prover.rap_constraints_time_ms` |  304 |  304 |  304 |  304 |
| `prover.openings_time_ms` |  220 |  220 |  220 |  220 |
...
| `prover.openings.whir_time_ms` |  192 |  192 |  192 |  192 |
...
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  338 |  338 |  338 |  338 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/512c3448ad7ab7b257cd1b2755d8c1cbcdb37b31/kitchen_sink-512c3448ad7ab7b257cd1b2755d8c1cbcdb37b31.memory.svg)

| Module | Max (GB) | Max At |
| --- | ---: | --- |
| prover.stacked_commit | 12.27 | app_proof.prover.0 |
| prover.rap_constraints | 9.10 | app_proof.prover.0 |
| prover.openings | 8.31 | app_proof.prover.0 |
| prover.merkle_tree | 8.31 | app_proof.prover.0 |
| prover.prove_whir_opening | 8.31 | app_proof.prover.0 |
| prover.rs_code_matrix | 8.30 | app_proof.prover.0 |
| frac_sumcheck.gkr_rounds | 7.41 | app_proof.prover.0 |
| prover.batch_constraints.before_round0 | 7.41 | app_proof.prover.0 |
| prover.gkr_input_evals | 7.35 | app_proof.prover.0 |
| frac_sumcheck.segment_tree | 7.35 | app_proof.prover.0 |
| prover.batch_constraints.round0 | 7.09 | app_proof.prover.0 |
| prover.batch_constraints.fold_ple_evals | 7.09 | app_proof.prover.0 |
| prover.before_gkr_input_evals | 4.21 | app_proof.prover.0 |
...
| 70 | VmAirWrapper<Rv64StoreAdapterAir, StoreCoreAir<8, 3, 4> |  | 29 | 15 | 3 | 
| 71 | VmAirWrapper<Rv64LoadAdapterAir, LoadCoreAir<8, 3, 5> |  | 28 | 17 | 3 | 
| 72 | VmAirWrapper<Rv64StoreAdapterAir, StoreCoreAir<4, 3, 2> |  | 27 | 15 | 3 | 
| 73 | VmAirWrapper<Rv64LoadAdapterAir, LoadCoreAir<4, 3, 3> |  | 26 | 17 | 3 | 
| 74 | VmAirWrapper<Rv64LoadAdapterAir, LoadSignExtendCoreAir<4, 3, 3> |  | 28 | 18 | 3 | 
| 75 | VmAirWrapper<Rv64StoreAdapterAir, StoreCoreAir<2, 3, 1> |  | 26 | 15 | 3 | 
| 76 | VmAirWrapper<Rv64LoadAdapterAir, LoadCoreAir<2, 3, 2> |  | 25 | 17 | 3 | 
| 77 | VmAirWrapper<Rv64LoadAdapterAir, LoadSignExtendCoreAir<2, 3, 2> |  | 27 | 18 | 3 | 
| 78 | VmAirWrapper<Rv64StoreByteAdapterAir, StoreByteCoreAir> |  | 19 | 14 | 3 | 
| 79 | VmAirWrapper<Rv64LoadByteAdapterAir, LoadByteCoreAir> |  | 18 | 16 | 3 | 
| 8 | VmAirWrapper<Rv64VecHeapAdapterAir<1, 8, 8>, FieldExpressionCoreAir> |  | 464 | 280 | 3 | 
| 80 | VmAirWrapper<Rv64LoadByteAdapterAir, LoadSignExtendByteCoreAir> |  | 19 | 17 | 3 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 79 |  |  |  | 389 |  |  |  |  |  |  | 
| app_proof |  |  |  | 3,787 |  | 23 | 1,979,971 | 83.53 | 0 | 3,814 |  | 
| internal_for_leaf |  |  | 357 |  |  |  |  |  |  |  | 357 | 
...
| app_proof | VmAirWrapper<Rv64LoadAdapterAir, LoadCoreAir<8, 3, 5> | 25 | VmAirWrapper<Rv64LoadAdapterAir, LoadCoreAir<8, 3, 5> | 0 | 18,573,440 | 
| app_proof | VmAirWrapper<Rv64LoadAdapterAir, LoadSignExtendCoreAir<4, 3, 3> | 22 | VmAirWrapper<Rv64LoadAdapterAir, LoadSignExtendCoreAir<4, 3, 3> | 0 | 1,455,424 | 
| app_proof | VmAirWrapper<Rv64LoadByteAdapterAir, LoadByteCoreAir> | 17 | VmAirWrapper<Rv64LoadByteAdapterAir, LoadByteCoreAir> | 0 | 454,080 | 
| app_proof | VmAirWrapper<Rv64LoadByteAdapterAir, LoadSignExtendByteCoreAir> | 16 | VmAirWrapper<Rv64LoadByteAdapterAir, LoadSignExtendByteCoreAir> | 0 | 102,400 | 
...
| app_proof | VmAirWrapper<Rv64StoreAdapterAir, StoreCoreAir<4, 3, 2> | 24 | VmAirWrapper<Rv64StoreAdapterAir, StoreCoreAir<4, 3, 2> | 0 | 103,552 | 
| app_proof | VmAirWrapper<Rv64StoreAdapterAir, StoreCoreAir<8, 3, 4> | 26 | VmAirWrapper<Rv64StoreAdapterAir, StoreCoreAir<8, 3, 4> | 0 | 19,647,872 | 
| app_proof | VmAirWrapper<Rv64StoreByteAdapterAir, StoreByteCoreAir> | 18 | VmAirWrapper<Rv64StoreByteAdapterAir, StoreByteCoreAir> | 0 | 591,424 | 
...
| app_proof | VmAirWrapper<Rv64LoadAdapterAir, LoadCoreAir<8, 3, 5> | 0 | 1 | 1 | 
...
| app_proof | VmAirWrapper<Rv64StoreAdapterAir, StoreCoreAir<4, 3, 2> | 0 | 0 | 0 | 
| app_proof | VmAirWrapper<Rv64StoreAdapterAir, StoreCoreAir<8, 3, 4> | 0 | 1 | 1 | 
...
| app_proof | 70 | VmAirWrapper<Rv64StoreAdapterAir, StoreCoreAir<8, 3, 4> | STORED | 0 | 306,998 | 
| app_proof | 71 | VmAirWrapper<Rv64LoadAdapterAir, LoadCoreAir<8, 3, 5> | LOADD | 0 | 290,210 | 
| app_proof | 72 | VmAirWrapper<Rv64StoreAdapterAir, StoreCoreAir
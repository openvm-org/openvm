...
|:---|---:|---:|---:|
| Total |  9.78 |  6.83 |  6.83 |
| app_proof |  8.07 |  5.12 |  5.12 |
| leaf |  1.02 |  1.02 |  1.02 |
...
| `total_proof_time_ms ` |  3,989 |  7,978 |  5,024 |  2,954 |
| `compile_metered_time_ms` |  3 |  3 |  3 |  3 |
| `execute_metered_time_ms` |  94 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  117.86 | -          |  117.86 |  117.86 |
| `execute_preflight_insns` |  5,583,980.50 |  11,167,961 |  7,124,000 |  4,043,961 |
| `execute_preflight_time_ms` |  241 |  482 |  280 |  202 |
| `execute_preflight_insn_mi/s` |  38.13 | -          |  40.47 |  35.79 |
| `trace_gen_time_ms   ` |  122.50 |  245 |  172 |  73 |
| `set_initial_memory_time_ms` |  0 |  0 |  0 |  0 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  3,624 |  7,248 |  4,649 |  2,599 |
| `prover.main_trace_commit_time_ms` |  952 |  1,904 |  1,323 |  581 |
| `prover.rap_constraints_time_ms` |  1,974.50 |  3,949 |  2,444 |  1,505 |
| `prover.openings_time_ms` |  696.50 |  1,393 |  880 |  513 |
| `prover.rap_constraints.logup_gkr_time_ms` |  562.50 |  1,125 |  605 |  520 |
| `prover.rap_constraints.round0_time_ms` |  1,031.50 |  2,063 |  1,348 |  715 |
| `prover.rap_constraints.mle_rounds_time_ms` |  379.50 |  759 |  490 |  269 |
| `prover.openings.stacked_reduction_time_ms` |  165 |  330 |  213 |  117 |
| `prover.openings.stacked_reduction.round0_time_ms` |  101.50 |  203 |  132 |  71 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  63 |  126 |  80 |  46 |
| `prover.openings.whir_time_ms` |  531 |  1,062 |  667 |  395 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,019 |  1,019 |  1,019 |  1,019 |
| `execute_preflight_time_ms` |  2 |  2 |  2 |  2 |
| `trace_gen_time_ms   ` |  111 |  111 |  111 |  111 |
| `generate_blob_total_time_ms` |  16 |  16 |  16 |  16 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  908 |  908 |  908 |  908 |
| `prover.main_trace_commit_time_ms` |  377 |  377 |  377 |  377 |
| `prover.rap_constraints_time_ms` |  231 |  231 |  231 |  231 |
| `prover.openings_time_ms` |  299 |  299 |  299 |  299 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/8072f6996b80e9de85d3fb2d5f2c0c3a5ab9f4be/sha2_bench-8072f6996b80e9de85d3fb2d5f2c0c3a5ab9f4be.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 71 |  |  |  | 345 |  |  |  |  |  |  | 
| app_proof |  |  |  | 2,954 |  | 94 | 11,167,961 | 117.86 | 0 | 8,078 |  | 
| internal_for_leaf |  |  | 354 |  |  |  |  |  |  |  | 354 | 
| internal_recursive.0 |  |  | 188 |  |  |  |  |  |  |  | 188 | 
...
| app_proof | VmAirWrapper<Rv64LoadAdapterAir, LoadCoreAir<8, 3, 5> | 0 | 6 | 11 | 
...
| internal_recursive.0 | 1 | 11 | 188 | 11 | 1 | 0 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 9 | 149 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 111 | 1,019 | 110 | 34 | 16 | 2 | 7 | 7 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 331 | 119 | 0 | 0 | 109 | 36 | 36 | 51 | 20 | 0 | 102 | 89 | 13 | 3 | 9 | 119 | 119 | 109 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 177 | 47 | 0 | 0 | 70 | 25 | 25 | 28 | 16 | 0 | 58 | 50 | 8 | 1 | 6 | 47 | 47 | 70 | 0 | 3 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 139 | 32 | 0 | 0 | 63 | 24 | 23 | 25 | 14 | 0 | 42 | 35 | 7 | 1 | 5 | 32 | 32 | 63 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 237,929,144 | 908 | 376 | 0 | 0 | 231 | 112 | 111 | 68 | 50 | 0 | 299 | 261 | 37 | 19 | 17 | 377 | 376 | 231 | 0 | 12 | 50 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,265,926,394 | 4,649 | 1,323 | 0 | 0 | 2,444 | 1,348 | 1,348 | 490 | 605 | 0 | 880 | 667 | 213 | 132 | 80 | 1,323 | 1,323 | 2,444 | 0 | 6 | 603 | 0 | 0 | 
| app_proof | prover | 1 | 730,172,040 | 2,599 | 580 | 0 | 0 | 1,505 | 715 | 714 | 269 | 520 | 0 | 513 | 395 | 117 | 71 | 46 | 581 | 580 | 1,505 | 0 | 7 | 519 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 0 | 1 | 172 | 5,024 | 172 | 0 | 13,064,165,664 | 2,133,402,264 | 15,197,567,928 | 2,097,152 | 0 | 3 | 202 | 7,124,000 | 35.79 | 
| app_proof | 1 | 0 | 1 | 73 | 2,954 | 73 | 0 | 7,446,903,480 | 1,841,121,535 | 9,288,025,015 | 2,097,152 | 0 | 2 | 280 | 4,043,961 | 40.47 | 

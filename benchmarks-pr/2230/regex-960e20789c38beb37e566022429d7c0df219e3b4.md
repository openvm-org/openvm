...
| `total_proof_time_ms ` |  592.25 |  2,369 |  751 |  535 |
...
| `execute_metered_insn_mi/s` |  100.97 | -          |  100.97 |  100.97 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  53.75 |  215 |  66 |  45 |
| `execute_preflight_insn_mi/s` |  31.31 | -          |  32.45 |  28.29 |
| `trace_gen_time_ms   ` |  180.75 |  723 |  216 |  155 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  290.75 |  1,163 |  347 |  262 |
| `main_trace_commit_time_ms` |  52 |  208 |  56 |  50 |
| `generate_perm_trace_time_ms` |  33.75 |  135 |  55 |  18 |
| `perm_trace_commit_time_ms` |  64.07 |  256.28 |  70.11 |  55.67 |
| `quotient_poly_compute_time_ms` |  58.89 |  235.57 |  69.05 |  52.15 |
| `quotient_poly_commit_time_ms` |  15.08 |  60.34 |  17.93 |  12.65 |
| `pcs_opening_time_ms ` |  64 |  256 |  83 |  52 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 535 | 66 | 1 | 40 | 4,137,502 | 100.97 | 192 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 216 | 751 | 23,446,148 | 150,778,428 | 216 | 347 | 0 | 61.74 | 17.93 | 5 | 70.11 | 83 | 126 | 82 | 4 | 56 | 10,899,170 | 55 | 45 | 1,103,000 | 28.29 | 21 | 80 | 1 | 82 | 
| regex_program | 1 | 155 | 543 | 11,598,276 | 128,513,066 | 155 | 280 | 1 | 52.15 | 15.07 | 4 | 65.44 | 59 | 101 | 59 | 0 | 51 | 2,196,106 | 35 | 66 | 1,104,000 | 32.41 | 16 | 67 | 0 | 59 | 
| regex_program | 2 | 166 | 540 | 11,579,064 | 128,513,066 | 166 | 274 | 1 | 52.63 | 14.68 | 4 | 65.06 | 62 | 93 | 62 | 0 | 51 | 2,177,334 | 27 | 58 | 1,104,000 | 32.45 | 16 | 67 | 0 | 62 | 
| regex_program | 3 | 186 | 535 | 11,853,872 | 103,456,394 | 186 | 262 | 0 | 69.05 | 12.65 | 5 | 55.67 | 52 | 77 | 51 | 0 | 50 | 2,422,606 | 18 | 46 | 826,502 | 32.09 | 18 | 82 | 1 | 51 | 
...
Commit: https://github.com/openvm-org/openvm/commit/960e20789c38beb37e566022429d7c0df219e3b4
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19318314617)

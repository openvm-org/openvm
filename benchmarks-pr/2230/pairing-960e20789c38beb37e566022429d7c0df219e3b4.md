...
| `total_proof_time_ms ` |  714.50 |  1,429 |  813 |  616 |
...
| `execute_preflight_insn_mi/s` |  13.69 | -          |  18.17 |  9.21 |
| `trace_gen_time_ms   ` |  177 |  354 |  194 |  160 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  349 |  698 |  378 |  320 |
| `main_trace_commit_time_ms` |  63 |  126 |  71 |  55 |
| `generate_perm_trace_time_ms` |  42 |  84 |  47 |  37 |
| `perm_trace_commit_time_ms` |  76.63 |  153.25 |  88.79 |  64.46 |
| `quotient_poly_compute_time_ms` |  78.42 |  156.84 |  87.04 |  69.80 |
| `quotient_poly_commit_time_ms` |  15.71 |  31.43 |  17.51 |  13.92 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 616 | 40 | 1 | 90 | 1,745,742 | 19.37 | 145 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 160 | 813 | 32,689,110 | 172,558,444 | 160 | 378 | 0 | 87.04 | 17.51 | 6 | 88.79 | 72 | 128 | 72 | 1 | 71 | 16,059,916 | 37 | 129 | 1,157,000 | 9.21 | 26 | 105 | 1 | 72 | 
| pairing | 1 | 194 | 616 | 22,314,288 | 119,958,502 | 194 | 320 | 1 | 69.80 | 13.92 | 6 | 64.46 | 66 | 114 | 65 | 0 | 55 | 9,408,294 | 47 | 59 | 588,742 | 18.17 | 20 | 84 | 1 | 65 | 

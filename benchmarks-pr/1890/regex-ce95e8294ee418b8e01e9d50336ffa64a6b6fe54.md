...
| `execute_e3_insn_mi/s` |  16.92 | -          |  17.92 |  15.92 |
| `memory_finalize_time_ms` |  7 |  14 |  12 |  2 |
| `boundary_finalize_time_ms` |  2 |  4 |  4 |  0 |
| `merkle_finalize_time_ms` |  154.50 |  309 |  241 |  68 |
| `stark_prove_excluding_trace_time_ms` |  3,038.50 |  6,077 |  3,819 |  2,258 |
| `main_trace_commit_time_ms` |  588.50 |  1,177 |  757 |  420 |
| `generate_perm_trace_time_ms` |  258 |  516 |  323 |  193 |
| `perm_trace_commit_time_ms` |  611 |  1,222 |  762 |  460 |
| `quotient_poly_compute_time_ms` |  327.50 |  655 |  423 |  232 |
| `quotient_poly_commit_time_ms` |  282.50 |  565 |  376 |  189 |
| `pcs_opening_time_ms ` |  961 |  1,922 |  1,169 |  753 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 3,895 | 24 | 4,165,433 | 1 | 36 | 112.90 | 62 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 511 | 211,864,680 | 373,166,268 | 3,819 | 423 | 376 | 762 | 1,169 | 241 | 25 | 12 | 757 | 91,153,694 | 2,244,000 | 323 | 140 | 15.92 | 4 | 
| regex_program | 1 | 287 | 176,237,560 | 242,975,370 | 2,258 | 232 | 189 | 460 | 753 | 68 | 24 | 2 | 420 | 74,277,990 | 1,921,433 | 193 | 107 | 17.92 | 0 | 

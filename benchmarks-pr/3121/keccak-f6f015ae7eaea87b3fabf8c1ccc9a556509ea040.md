...
|:---|---:|---:|---:|
| Total |  9.72 |  3.47 |  3.47 |
| app_proof |  7.63 |  1.89 |  1.89 |
| leaf |  1.53 |  1.02 |  1.02 |
...
| `total_proof_time_ms ` |  1,251.17 |  7,507 |  1,354 |  1,212 |
| `compile_metered_time_ms` |  4 |  4 |  4 |  4 |
| `execute_metered_time_ms` |  127 | -          | -          | -          |
| `execute_metered_insns` |  14,365,133 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  112.93 | -          |  112.93 |  112.93 |
| `set_initial_memory_time_ms` |  0.17 |  1 |  1 |  0 |
| `execute_preflight_insns` |  2,394,188.83 |  14,365,133 |  2,413,000 |  2,300,133 |
| `execute_preflight_time_ms` |  85.17 |  511 |  106 |  78 |
| `execute_preflight_insn_mi/s` |  28.11 | -          |  29.43 |  22.63 |
| `postflight_time_ms  ` |  30.33 |  182 |  31 |  29 |
| `postflight_memory_chronology_time_ms` |  2 |  12 |  2 |  2 |
| `postflight_program_index_time_ms` |  0 |  0 |  0 |  0 |
| `trace_gen_time_ms   ` |  12.83 |  77 |  17 |  12 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,105.83 |  6,635 |  1,186 |  1,077 |
| `prover.main_trace_commit_time_ms` |  346.33 |  2,078 |  360 |  339 |
| `prover.rap_constraints_time_ms` |  515.50 |  3,093 |  517 |  511 |
| `prover.openings_time_ms` |  242.83 |  1,457 |  308 |  225 |
| `prover.rap_constraints.logup_gkr_time_ms` |  105 |  630 |  106 |  103 |
| `prover.rap_constraints.round0_time_ms` |  284.17 |  1,705 |  285 |  282 |
| `prover.rap_constraints.mle_rounds_time_ms` |  125.33 |  752 |  126 |  125 |
| `prover.openings.stacked_reduction_time_ms` |  61.83 |  371 |  63 |  61 |
| `prover.openings.stacked_reduction.round0_time_ms` |  36.83 |  221 |  38 |  36 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  24.50 |  147 |  25 |  24 |
| `prover.openings.whir_time_ms` |  180.50 |  1,083 |  246 |  164 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  763.50 |  1,527 |  1,023 |  504 |
| `execute_preflight_time_ms` |  4 |  8 |  4 |  4 |
| `trace_gen_time_ms   ` |  139 |  278 |  185 |  93 |
| `generate_blob_total_time_ms` |  16 |  32 |  22 |  10 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  624.50 |  1,249 |  838 |  411 |
| `prover.main_trace_commit_time_ms` |  270 |  540 |  391 |  149 |
| `prover.rap_constraints_time_ms` |  189 |  378 |  236 |  142 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/f6f015ae7eaea87b3fabf8c1ccc9a556509ea040/keccak-f6f015ae7eaea87b3fabf8c1ccc9a556509ea040.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 42 | 327 | 41 | 14 | 3 | 2 | 2 | 2 | 
| internal_recursive.0 | 1 | 14 | 130 | 14 | 2 | 0 | 2 | 2 | 2 | 
| internal_recursive.1 | 1 | 10 | 107 | 10 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 185 | 1,023 | 184 | 59 | 22 | 4 | 10 | 10 | 
| leaf | 1 | 93 | 504 | 93 | 30 | 10 | 4 | 10 | 10 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 81,415,160 | 285 | 93 | 0 | 0 | 114 | 39 | 38 | 56 | 17 | 0 | 76 | 61 | 15 | 5 | 9 | 94 | 93 | 114 | 0 | 1 | 16 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,945 | 115 | 21 | 0 | 0 | 59 | 21 | 21 | 24 | 13 | 0 | 34 | 26 | 8 | 1 | 6 | 21 | 21 | 59 | 0 | 1 | 12 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 96 | 15 | 0 | 0 | 53 | 20 | 19 | 21 | 11 | 0 | 27 | 20 | 7 | 1 | 5 | 15 | 15 | 53 | 0 | 1 | 10 | 0 | 0 | 
| leaf | 0 | prover | 476,578,798 | 838 | 390 | 0 | 0 | 236 | 122 | 121 | 71 | 41 | 0 | 211 | 173 | 37 | 20 | 17 | 391 | 390 | 236 | 0 | 3 | 40 | 0 | 0 | 
| leaf | 1 | prover | 240,255,800 | 411 | 148 | 0 | 0 | 142 | 71 | 70 | 45 | 26 | 0 | 118 | 96 | 22 | 10 | 11 | 149 | 148 | 142 | 0 | 3 | 25 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover |  | 0 | 830,158,476 | 1,186 | 360 | 0 | 55 | 516 | 285 | 284 | 125 | 106 | 0 | 308 | 246 | 62 | 37 | 24 | 360 | 360 | 516 | 0 | 1 | 104 | 0 | 0 | 
| app_proof | prover |  | 1 | 830,158,476 | 1,094 | 342 | 0 | 0 | 517 | 285 | 285 | 125 | 106 | 0 | 234 | 172 | 61 | 36 | 24 | 342 | 342 | 517 | 0 | 1 | 104 | 0 | 0 | 
| app_proof | prover |  | 2 | 830,158,476 | 1,087 | 341 | 0 | 0 | 516 | 284 | 283 | 125 | 105 | 0 | 229 | 165 | 63 | 38 | 25 | 342 | 341 | 516 | 0 | 1 | 104 | 0 | 0 | 
| app_proof | prover |  | 3 | 830,158,476 | 1,095 | 347 | 0 | 0 | 516 | 284 | 283 | 126 | 105 | 0 | 231 | 168 | 62 | 37 | 25 | 347 | 347 | 516 | 0 | 1 | 104 | 0 | 0 | 
| app_proof | prover |  | 4 | 830,158,476 | 1,096 | 347 | 0 | 0 | 517 | 285 | 284 | 126 | 105 | 0 | 230 | 168 | 62 | 37 | 25 | 348 | 347 | 517 | 0 | 1 | 105 | 0 | 0 | 
| app_proof | prover |  | 5 | 819,934,860 | 1,077 | 339 | 0 | 0 | 511 | 282 | 282 | 125 | 103 | 1 | 225 | 164 | 61 | 36 | 24 | 339 | 339 | 511 | 0 | 1 | 101 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof |  | 1,212 | 127 | 14,365,133 | 112.93 | 0 | 7,644 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof |  | 0 | 0 | 2 | 17 | 1,354 | 3 | 0 | 0 | 29 | 0 | 2 | 0 | 9,337,486,584 | 624,415,128 | 9,961,901,712 | 2,097,152 | 2 | 0 | 0 | 3 | 14 | 106 | 2,413,000 | 22.63 | 0 | 0 | 
| app_proof |  | 1 | 1 | 2 | 12 | 1,236 | 2 | 1 | 0 | 31 | 0 | 2 | 0 | 9,337,793,604 | 625,029,708 | 9,962,823,312 | 2,097,152 | 2 | 0 | 0 | 2 | 9 | 82 | 2,413,000 | 29.21 | 0 | 0 | 
| app_proof |  | 2 | 0 | 2 | 12 | 1,229 | 2 | 0 | 0 | 31 | 0 | 2 | 0 | 9,337,030,356 | 625,792,956 | 9,962,823,312 | 2,097,152 | 2 | 0 | 0 | 2 | 9 | 81 | 2,413,000 | 29.43 | 0 | 0 | 
| app_proof |  | 3 | 0 | 2 | 12 | 1,238 | 2 | 0 | 0 | 30 | 0 | 2 | 0 | 9,337,792,860 | 625,030,452 | 9,962,823,312 | 2,097,152 | 2 | 0 | 0 | 2 | 9 | 83 | 2,413,000 | 29.01 | 0 | 0 | 
| app_proof |  | 4 | 0 | 2 | 12 | 1,238 | 2 | 0 | 0 | 31 | 0 | 2 | 0 | 9,337,030,236 | 625,793,076 | 9,962,823,312 | 2,097,152 | 2 | 0 | 0 | 2 | 9 | 81 | 2,413,000 | 29.43 | 0 | 0 | 
| app_proof |  | 5 | 0 | 2 | 12 | 1,212 | 3 | 0 | 0 | 30 | 0 | 2 | 0 | 8,903,917,596 | 936,222,324 | 9,840,139,920 | 2,097,152 | 2 | 0 | 0 | 2 | 8 | 78 | 2,300,133 | 29.18 | 0 | 0 | 

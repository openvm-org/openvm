...
| `total_proof_time_ms ` |  1,190 |  2,380 |  1,422 |  958 |
| `execute_metered_time_ms` |  7 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  20.57 | -          |  20.57 |  20.57 |
| `execute_preflight_insns` |  77,381.50 |  154,763 |  121,000 |  33,763 |
| `execute_preflight_time_ms` |  70.50 |  141 |  121 |  20 |
| `execute_preflight_insn_mi/s` |  8.60 | -          |  11.38 |  5.81 |
| `trace_gen_time_ms   ` |  160.50 |  321 |  191 |  130 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  845 |  1,690 |  1,025 |  665 |
| `prover.main_trace_commit_time_ms` |  222.50 |  445 |  296 |  149 |
| `prover.rap_constraints_time_ms` |  560 |  1,120 |  655 |  465 |
| `prover.openings_time_ms` |  61.50 |  123 |  73 |  50 |
| `prover.rap_constraints.logup_gkr_time_ms` |  140.50 |  281 |  153 |  128 |
| `prover.rap_constraints.round0_time_ms` |  285.50 |  571 |  361 |  210 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/ac3cc3e6a0e8c1ba76a439b9cd226490a83dcd36/kitchen_sink-ac3cc3e6a0e8c1ba76a439b9cd226490a83dcd36.memory.svg)
...
| app_proof |  |  |  |  |  | 958 |  |  | 7 | 154,763 | 20.57 | 0 | 2,393 |  | 
...
| app_proof | VmAirWrapper<Rv32BranchAdapterAir, BranchEqualCoreAir<4> | 0 | 101 | 
...
| leaf | 0 | 105 | 417 | 105 | 25 | 11 | 18 | 4 | 5 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 53,472,003 | 140 | 40 | 0 | 4 | 64 | 19 | 18 | 29 | 15 | 0 | 34 | 11 | 23 | 1 | 21 | 41 | 64 | 0 | 1 | 14 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 23,651,975 | 99 | 19 | 0 | 4 | 50 | 16 | 16 | 20 | 13 | 0 | 29 | 7 | 21 | 1 | 20 | 19 | 50 | 0 | 1 | 12 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 17,507,975 | 93 | 14 | 0 | 4 | 48 | 16 | 16 | 18 | 13 | 0 | 29 | 8 | 21 | 0 | 20 | 15 | 48 | 0 | 1 | 12 | 0 | 0 | 
| leaf | 0 | prover | 407,935,872 | 311 | 124 | 0 | 9 | 141 | 45 | 44 | 36 | 60 | 0 | 44 | 13 | 31 | 7 | 24 | 125 | 141 | 0 | 2 | 59 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 816,542,084 | 1,025 | 295 | 0 | 165 | 655 | 361 | 360 | 140 | 153 | 61 | 73 | 12 | 60 | 15 | 44 | 296 | 655 | 0 | 1 | 90 | 0 | 0 | 
| app_proof | prover | 1 | 800,298,548 | 665 | 149 | 0 | 20 | 465 | 210 | 210 | 126 | 128 | 74 | 50 | 13 | 37 | 14 | 22 | 149 | 465 | 0 | 1 | 53 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 191 | 1,422 | 191 | 185 | 0 | 51 | 20 | 121,000 | 11.38 | 
| app_proof | 1 | 130 | 958 | 130 | 40 | 0 | 3 | 121 | 33,763 | 5.81 | 

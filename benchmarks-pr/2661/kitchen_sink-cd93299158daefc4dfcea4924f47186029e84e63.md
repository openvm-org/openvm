...
| `total_proof_time_ms ` |  1,143.50 |  2,287 |  1,822 |  465 |
| `execute_metered_time_ms` |  34 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  75.30 | -          |  75.30 |  75.30 |
| `execute_preflight_insns` |  1,289,951.50 |  2,579,903 |  2,020,000 |  559,903 |
| `execute_preflight_time_ms` |  76.50 |  153 |  77 |  76 |
| `execute_preflight_insn_mi/s` |  36.40 | -          |  37.63 |  35.18 |
| `trace_gen_time_ms   ` |  57.50 |  115 |  93 |  22 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  894.50 |  1,789 |  1,465 |  324 |
| `prover.main_trace_commit_time_ms` |  292.50 |  585 |  503 |  82 |
| `prover.rap_constraints_time_ms` |  536.50 |  1,073 |  868 |  205 |
...
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  34 |  68 |  50 |  18 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/cd93299158daefc4dfcea4924f47186029e84e63/kitchen_sink-cd93299158daefc4dfcea4924f47186029e84e63.memory.svg)
...
| app_proof |  |  |  |  |  | 465 |  |  | 34 | 2,579,903 | 75.30 | 0 | 2,326 |  | 
...
| internal_recursive.0 | 1 | 11 | 112 | 11 | 2 | 0 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 9 | 102 | 8 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 123 | 443 | 122 | 26 | 12 | 21 | 2 | 2 | 
...
| leaf | 0 | prover | 428,317,568 | 320 | 130 | 0 | 10 | 145 | 48 | 48 | 37 | 59 | 0 | 43 | 12 | 31 | 7 | 24 | 131 | 145 | 0 | 2 | 58 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,221,261,804 | 1,465 | 503 | 0 | 285 | 868 | 450 | 448 | 144 | 274 | 135 | 93 | 16 | 76 | 25 | 50 | 503 | 868 | 0 | 1 | 137 | 0 | 0 | 
| app_proof | prover | 1 | 370,741,140 | 324 | 82 | 0 | 17 | 205 | 114 | 113 | 47 | 43 | 0 | 36 | 10 | 26 | 7 | 18 | 82 | 205 | 0 | 1 | 43 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 93 | 1,822 | 93 | 186 | 0 | 3 | 76 | 2,020,000 | 35.18 | 
| app_proof | 1 | 22 | 465 | 22 | 40 | 0 | 2 | 77 | 559,903 | 37.63 | 

...
|:---|---:|---:|
| Total | <span style='color: red'>(+0 [+2.1%])</span> 1.57 | <span style='color: red'>(+0 [+3.3%])</span> 0.94 |
| pairing | <span style='color: red'>(+0 [+2.1%])</span> 1.48 | <span style='color: red'>(+0 [+3.5%])</span> 0.85 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+16 [+2.1%])</span> 737.50 | <span style='color: red'>(+31 [+2.1%])</span> 1,475 | <span style='color: red'>(+29 [+3.5%])</span> 853 | <span style='color: red'>(+2 [+0.3%])</span> 622 |
...
| `execute_metered_insn_mi/s` | <span style='color: green'>(-0 [-0.6%])</span> 19.08 | -          | <span style='color: green'>(-0 [-0.6%])</span> 19.08 | <span style='color: green'>(-0 [-0.6%])</span> 19.08 |
| `execute_preflight_insns` |  872,871 |  1,745,742 |  1,157,000 |  588,742 |
| `execute_preflight_time_ms` | <span style='color: red'>(+1 [+1.1%])</span> 95.50 | <span style='color: red'>(+2 [+1.1%])</span> 191 |  130 | <span style='color: red'>(+2 [+3.4%])</span> 61 |
| `execute_preflight_insn_mi/s` |  13.42 | -          | <span style='color: green'>(-0 [-0.3%])</span> 17.69 | <span style='color: red'>(+0 [+0.3%])</span> 9.15 |
| `trace_gen_time_ms   ` | <span style='color: green'>(-5 [-2.7%])</span> 177 | <span style='color: green'>(-10 [-2.7%])</span> 354 | <span style='color: green'>(-5 [-2.5%])</span> 194 | <span style='color: green'>(-5 [-3.0%])</span> 160 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+21 [+6.0%])</span> 373 | <span style='color: red'>(+42 [+6.0%])</span> 746 | <span style='color: red'>(+37 [+9.6%])</span> 421 | <span style='color: red'>(+5 [+1.6%])</span> 325 |
| `main_trace_commit_time_ms` |  65 |  130 | <span style='color: red'>(+1 [+1.3%])</span> 76 | <span style='color: green'>(-1 [-1.8%])</span> 54 |
...
| `perm_trace_commit_time_ms` | <span style='color: red'>(+1 [+1.8%])</span> 77.93 | <span style='color: red'>(+3 [+1.8%])</span> 155.86 | <span style='color: red'>(+1 [+0.6%])</span> 90.17 | <span style='color: red'>(+2 [+3.6%])</span> 65.69 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+1 [+1.6%])</span> 79.57 | <span style='color: red'>(+2 [+1.6%])</span> 159.14 | <span style='color: green'>(-0 [-0.6%])</span> 87.67 | <span style='color: red'>(+3 [+4.3%])</span> 71.47 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+1 [+4.3%])</span> 16.99 | <span style='color: red'>(+1 [+4.3%])</span> 33.97 | <span style='color: red'>(+1 [+3.9%])</span> 19.02 | <span style='color: red'>(+1 [+4.7%])</span> 14.96 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+19 [+28.8%])</span> 85 | <span style='color: red'>(+38 [+28.8%])</span> 170 | <span style='color: red'>(+37 [+55.2%])</span> 104 | <span style='color: red'>(+1 [+1.5%])</span> 66 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 622 | 1 | 91 | 1,745,742 | 19.08 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 160 | 853 | 32,689,110 | 172,558,444 | 160 | 421 | 0 | 87.67 | 19.02 | 6 | 90.17 | 104 | 132 | 104 | 1 | 76 | 16,059,916 | 39 | 130 | 1,157,000 | 9.15 | 26 | 107 | 1 | 104 | 
| pairing | 1 | 194 | 622 | 22,314,288 | 119,958,502 | 194 | 325 | 1 | 71.47 | 14.96 | 6 | 65.69 | 66 | 117 | 66 | 0 | 54 | 9,408,294 | 48 | 61 | 588,742 | 17.69 | 20 | 87 | 1 | 66 | 

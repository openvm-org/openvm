...
|:---|---:|---:|
| Total | <span style='color: red'>(+0 [+4.2%])</span> 1.58 | <span style='color: red'>(+0 [+0.3%])</span> 0.91 |
| pairing | <span style='color: red'>(+0 [+4.6%])</span> 1.49 | <span style='color: red'>(+0 [+0.6%])</span> 0.82 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+32 [+4.6%])</span> 745.50 | <span style='color: red'>(+65 [+4.6%])</span> 1,491 | <span style='color: red'>(+5 [+0.6%])</span> 816 | <span style='color: red'>(+60 [+9.8%])</span> 675 |
...
| `execute_preflight_insn_mi/s` | <span style='color: green'>(-0 [-0.8%])</span> 13.56 | -          | <span style='color: green'>(-0 [-1.6%])</span> 17.92 | <span style='color: red'>(+0 [+0.8%])</span> 9.21 |
| `trace_gen_time_ms   ` |  178 |  356 | <span style='color: green'>(-2 [-1.0%])</span> 192 | <span style='color: red'>(+2 [+1.2%])</span> 164 |
...
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+32 [+9.4%])</span> 380 | <span style='color: red'>(+65 [+9.4%])</span> 760 | <span style='color: red'>(+5 [+1.3%])</span> 380 | <span style='color: red'>(+60 [+18.8%])</span> 380 |
...
| `generate_perm_trace_time_ms` | <span style='color: red'>(+13 [+30.2%])</span> 56 | <span style='color: red'>(+26 [+30.2%])</span> 112 | <span style='color: red'>(+25 [+53.2%])</span> 72 | <span style='color: red'>(+1 [+2.6%])</span> 40 |
| `perm_trace_commit_time_ms` | <span style='color: green'>(-0 [-0.5%])</span> 76.40 | <span style='color: green'>(-1 [-0.5%])</span> 152.81 | <span style='color: red'>(+1 [+0.9%])</span> 89.11 | <span style='color: green'>(-2 [-2.4%])</span> 63.69 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+0 [+0.2%])</span> 79.11 | <span style='color: red'>(+0 [+0.2%])</span> 158.22 | <span style='color: green'>(-0 [-0.3%])</span> 86.81 | <span style='color: red'>(+1 [+0.8%])</span> 71.42 |
| `quotient_poly_commit_time_ms` | <span style='color: green'>(-1 [-3.2%])</span> 15.91 | <span style='color: green'>(-1 [-3.2%])</span> 31.83 | <span style='color: green'>(-1 [-6.6%])</span> 17.13 | <span style='color: red'>(+0 [+1.0%])</span> 14.69 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+18 [+26.5%])</span> 83.50 | <span style='color: red'>(+35 [+26.5%])</span> 167 | <span style='color: red'>(+33 [+49.3%])</span> 100 | <span style='color: red'>(+2 [+3.1%])</span> 67 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 675 | 1 | 90 | 1,745,742 | 19.31 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 164 | 816 | 32,689,110 | 172,558,444 | 164 | 380 | 0 | 86.81 | 17.13 | 6 | 89.11 | 67 | 132 | 67 | 1 | 74 | 16,059,916 | 40 | 129 | 1,157,000 | 9.21 | 26 | 104 | 1 | 67 | 
| pairing | 1 | 192 | 675 | 22,314,288 | 119,958,502 | 192 | 380 | 1 | 71.42 | 14.69 | 6 | 63.69 | 100 | 139 | 100 | 0 | 54 | 9,408,294 | 72 | 61 | 588,742 | 17.92 | 20 | 86 | 1 | 100 | 

...
|:---|---:|---:|
| Total | <span style='color: green'>(-0 [-0.5%])</span> 0.99 | <span style='color: green'>(-0 [-0.7%])</span> 0.56 |
| fibonacci_program | <span style='color: green'>(-0 [-0.5%])</span> 0.98 | <span style='color: green'>(-0 [-0.7%])</span> 0.55 |


| fibonacci_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: green'>(-2 [-0.5%])</span> 488.50 | <span style='color: green'>(-5 [-0.5%])</span> 977 | <span style='color: green'>(-4 [-0.7%])</span> 551 | <span style='color: green'>(-1 [-0.2%])</span> 426 |
...
| `execute_metered_insn_mi/s` | <span style='color: green'>(-2 [-1.5%])</span> 110.82 | -          | <span style='color: green'>(-2 [-1.5%])</span> 110.82 | <span style='color: green'>(-2 [-1.5%])</span> 110.82 |
| `execute_preflight_insns` |  750,104.50 |  1,500,209 |  873,000 |  627,209 |
| `execute_preflight_time_ms` | <span style='color: red'>(+1 [+3.4%])</span> 30.50 | <span style='color: red'>(+2 [+3.4%])</span> 61 | <span style='color: red'>(+2 [+6.1%])</span> 35 |  26 |
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+0 [+0.3%])</span> 36.01 | -          | <span style='color: red'>(+0 [+1.0%])</span> 37.63 | <span style='color: green'>(-0 [-0.4%])</span> 34.39 |
...
| `stark_prove_excluding_trace_time_ms` | <span style='color: green'>(-2 [-1.4%])</span> 175.50 | <span style='color: green'>(-5 [-1.4%])</span> 351 | <span style='color: green'>(-4 [-2.1%])</span> 187 | <span style='color: green'>(-1 [-0.6%])</span> 164 |
| `main_trace_commit_time_ms` |  30.50 |  61 |  33 |  28 |
| `generate_perm_trace_time_ms` | <span style='color: red'>(+3 [+24.0%])</span> 15.50 | <span style='color: red'>(+6 [+24.0%])</span> 31 | <span style='color: red'>(+6 [+46.2%])</span> 19 |  12 |
| `perm_trace_commit_time_ms` | <span style='color: green'>(-1 [-1.7%])</span> 41.97 | <span style='color: green'>(-1 [-1.7%])</span> 83.94 | <span style='color: green'>(-1 [-1.9%])</span> 43.98 | <span style='color: green'>(-1 [-1.6%])</span> 39.96 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+0 [+1.6%])</span> 30.85 | <span style='color: red'>(+1 [+1.6%])</span> 61.71 | <span style='color: red'>(+2 [+4.9%])</span> 32.65 | <span style='color: green'>(-1 [-1.8%])</span> 29.06 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+0 [+2.6%])</span> 12.04 | <span style='color: red'>(+1 [+2.6%])</span> 24.09 | <span style='color: red'>(+1 [+8.0%])</span> 12.75 | <span style='color: green'>(-0 [-2.8%])</span> 11.33 |
| `pcs_opening_time_ms ` | <span style='color: green'>(-6 [-11.5%])</span> 42.50 | <span style='color: green'>(-11 [-11.5%])</span> 85 | <span style='color: green'>(-11 [-20.0%])</span> 44 |  41 |
...
| --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 426 | 1 | 13 | 1,500,209 | 110.82 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 193 | 551 | 9,677,708 | 84,395,212 | 192 | 187 | 0 | 32.65 | 12.75 | 4 | 43.98 | 44 | 64 | 44 | 0 | 33 | 1,035,986 | 19 | 26 | 873,000 | 34.39 | 14 | 45 | 0 | 44 | 
| fibonacci_program | 1 | 186 | 426 | 9,708,170 | 74,305,770 | 186 | 164 | 1 | 29.06 | 11.33 | 4 | 39.96 | 41 | 53 | 41 | 0 | 28 | 1,064,416 | 12 | 35 | 627,209 | 37.63 | 11 | 40 | 0 | 41 | 

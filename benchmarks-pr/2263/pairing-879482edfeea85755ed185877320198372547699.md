...
|:---|---:|---:|
| Total | <span style='color: red'>(+0 [+3.2%])</span> 1.58 | <span style='color: green'>(-0 [-0.5%])</span> 0.91 |
| pairing | <span style='color: red'>(+0 [+3.4%])</span> 1.49 | <span style='color: green'>(-0 [-0.6%])</span> 0.82 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+24 [+3.4%])</span> 746.50 | <span style='color: red'>(+49 [+3.4%])</span> 1,493 | <span style='color: green'>(-5 [-0.6%])</span> 819 | <span style='color: red'>(+54 [+8.7%])</span> 674 |
...
| `execute_metered_insn_mi/s` | <span style='color: red'>(+0 [+0.6%])</span> 19.32 | -          | <span style='color: red'>(+0 [+0.6%])</span> 19.32 | <span style='color: red'>(+0 [+0.6%])</span> 19.32 |
| `execute_preflight_insns` |  872,871 |  1,745,742 |  1,157,000 |  588,742 |
| `execute_preflight_time_ms` | <span style='color: red'>(+2 [+1.6%])</span> 96 | <span style='color: red'>(+3 [+1.6%])</span> 192 | <span style='color: red'>(+1 [+0.8%])</span> 131 | <span style='color: red'>(+2 [+3.4%])</span> 61 |
| `execute_preflight_insn_mi/s` | <span style='color: green'>(-0 [-0.3%])</span> 13.39 | -          |  17.73 | <span style='color: green'>(-0 [-0.9%])</span> 9.05 |
| `trace_gen_time_ms   ` | <span style='color: green'>(-6 [-3.6%])</span> 175.50 | <span style='color: green'>(-13 [-3.6%])</span> 351 | <span style='color: green'>(-5 [-2.5%])</span> 194 | <span style='color: green'>(-8 [-4.8%])</span> 157 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+30 [+8.5%])</span> 382 | <span style='color: red'>(+60 [+8.5%])</span> 764 | <span style='color: red'>(+2 [+0.5%])</span> 386 | <span style='color: red'>(+58 [+18.1%])</span> 378 |
...
| `generate_perm_trace_time_ms` | <span style='color: red'>(+15 [+34.1%])</span> 59 | <span style='color: red'>(+30 [+34.1%])</span> 118 | <span style='color: red'>(+24 [+50.0%])</span> 72 | <span style='color: red'>(+6 [+15.0%])</span> 46 |
| `perm_trace_commit_time_ms` | <span style='color: red'>(+0 [+0.2%])</span> 76.70 | <span style='color: red'>(+0 [+0.2%])</span> 153.40 | <span style='color: green'>(-1 [-1.3%])</span> 88.48 | <span style='color: red'>(+1 [+2.3%])</span> 64.92 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+1 [+1.0%])</span> 79.10 | <span style='color: red'>(+2 [+1.0%])</span> 158.20 | <span style='color: green'>(-1 [-1.3%])</span> 87.04 | <span style='color: red'>(+3 [+3.9%])</span> 71.16 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+0 [+0.6%])</span> 16.38 | <span style='color: red'>(+0 [+0.6%])</span> 32.77 | <span style='color: green'>(-0 [-0.4%])</span> 18.23 | <span style='color: red'>(+0 [+1.8%])</span> 14.53 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+16 [+24.2%])</span> 82 | <span style='color: red'>(+32 [+24.2%])</span> 164 | <span style='color: red'>(+31 [+46.3%])</span> 98 | <span style='color: red'>(+1 [+1.5%])</span> 66 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 674 | 1 | 90 | 1,745,742 | 19.32 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 157 | 819 | 32,689,110 | 172,558,444 | 157 | 386 | 0 | 87.04 | 18.23 | 6 | 88.48 | 66 | 137 | 65 | 1 | 76 | 16,059,916 | 46 | 131 | 1,157,000 | 9.05 | 26 | 106 | 1 | 65 | 
| pairing | 1 | 194 | 674 | 22,314,288 | 119,958,502 | 194 | 378 | 1 | 71.16 | 14.53 | 6 | 64.92 | 98 | 140 | 97 | 0 | 53 | 9,408,294 | 72 | 61 | 588,742 | 17.73 | 20 | 86 | 1 | 97 | 

...
|:---|---:|---:|---:|
| Total |  6.91 |  2.72 |  2.72 |
| app_proof |  4.35 |  0.80 |  0.80 |
| leaf |  1.32 |  0.68 |  0.68 |
...
| `total_proof_time_ms ` |  611.43 |  4,280 |  730 |  588 |
...
| `execute_preflight_insn_mi/s` |  49.99 | -          |  50.72 |  48.78 |
| `trace_gen_time_ms   ` |  162.71 |  1,139 |  167 |  161 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  339.14 |  2,374 |  342 |  335 |
| `prover.main_trace_commit_time_ms` |  58.29 |  408 |  59 |  57 |
| `prover.rap_constraints_time_ms` |  236.71 |  1,657 |  241 |  234 |
| `prover.openings_time_ms` |  43.14 |  302 |  47 |  42 |
| `prover.rap_constraints.logup_gkr_time_ms` |  171.43 |  1,200 |  172 |  170 |
| `prover.rap_constraints.round0_time_ms` |  36.71 |  257 |  40 |  36 |
| `prover.rap_constraints.mle_rounds_time_ms` |  27.57 |  193 |  28 |  27 |
| `prover.openings.stacked_reduction_time_ms` |  21 |  147 |  24 |  20 |
| `prover.openings.stacked_reduction.round0_time_ms` |  9.29 |  65 |  10 |  9 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  11 |  77 |  14 |  10 |
| `prover.openings.whir_time_ms` |  21.57 |  151 |  26 |  19 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  658.50 |  1,317 |  676 |  641 |
| `execute_preflight_time_ms` |  2 |  4 |  2 |  2 |
| `trace_gen_time_ms   ` |  66.50 |  133 |  80 |  53 |
| `generate_blob_total_time_ms` |  5 |  10 |  6 |  4 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  591 |  1,182 |  595 |  587 |
| `prover.main_trace_commit_time_ms` |  249.50 |  499 |  251 |  248 |
| `prover.rap_constraints_time_ms` |  255 |  510 |  255 |  255 |
| `prover.openings_time_ms` |  85.50 |  171 |  88 |  83 |
| `prover.rap_constraints.logup_gkr_time_ms` |  65.50 |  131 |  66 |  65 |
| `prover.rap_constraints.round0_time_ms` |  98 |  196 |  99 |  97 |
| `prover.rap_constraints.mle_rounds_time_ms` |  90 |  180 |  90 |  90 |
| `prover.openings.stacked_reduction_time_ms` |  51.50 |  103 |  52 |  51 |
| `prover.openings.stacked_reduction.round0_time_ms` |  21.50 |  43 |  22 |  21 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/1d45a7694e286e8dbfec95826233d3870974cb6e/fibonacci-1d45a7694e286e8dbfec95826233d3870974cb6e.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 76 | 39 |  |  | 0 |  | 458 | 38 |  |  |  |  |  |  | 
| app_proof |  |  |  |  |  | 592 |  |  | 65 | 12,000,265 | 182.89 | 0 | 4,355 |  | 
| internal_for_leaf |  |  |  | 666 |  |  |  |  |  |  |  |  |  | 666 | 
| internal_recursive.0 |  |  |  | 309 |  |  |  |  |  |  |  |  |  | 310 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 38 | 666 | 38 | 17 | 3 | 3 | 1 | 1 | 
| internal_recursive.0 | 1 | 14 | 309 | 14 | 3 | 0 | 2 | 0 | 0 | 
| internal_recursive.1 | 1 | 14 | 276 | 13 | 3 | 0 | 3 | 0 | 0 | 
| leaf | 0 | 80 | 676 | 80 | 38 | 6 | 2 | 1 | 1 | 
| leaf | 1 | 53 | 641 | 53 | 28 | 4 | 2 | 1 | 1 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover |
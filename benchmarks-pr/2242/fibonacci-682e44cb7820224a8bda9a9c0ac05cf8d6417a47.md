...
|:---|---:|---:|
| Total | <span style='color: green'>(-0 [-1.4%])</span> 0.98 | <span style='color: green'>(-0 [-0.9%])</span> 0.56 |
...
| `total_proof_time_ms ` | <span style='color: green'>(-7 [-1.4%])</span> 484 | <span style='color: green'>(-14 [-1.4%])</span> 968 | <span style='color: green'>(-5 [-0.9%])</span> 550 | <span style='color: green'>(-9 [-2.1%])</span> 418 |
...
| `execute_metered_insn_mi/s` | <span style='color: green'>(-0 [-0.3%])</span> 112.18 | -          | <span style='color: green'>(-0 [-0.3%])</span> 112.18 | <span style='color: green'>(-0 [-0.3%])</span> 112.18 |
| `execute_preflight_insns` |  750,104.50 |  1,500,209 |  873,000 |  627,209 |
| `execute_preflight_time_ms` |  29.50 |  59 |  33 |  26 |
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+1 [+2.2%])</span> 36.69 | -          | <span style='color: red'>(+1 [+3.5%])</span> 38.59 | <span style='color: red'>(+0 [+0.8%])</span> 34.79 |
| `trace_gen_time_ms   ` | <span style='color: green'>(-3 [-1.6%])</span> 188 | <span style='color: green'>(-6 [-1.6%])</span> 376 | <span style='color: green'>(-1 [-0.5%])</span> 194 | <span style='color: green'>(-5 [-2.7%])</span> 182 |
...
| `generate_perm_trace_time_ms` | <span style='color: red'>(+3 [+24.0%])</span> 15.50 | <span style='color: red'>(+6 [+24.0%])</span> 31 | <span style='color: red'>(+5 [+38.5%])</span> 18 | <span style='color: red'>(+1 [+8.3%])</span> 13 |
| `perm_trace_commit_time_ms` | <span style='color: green'>(-0 [-0.8%])</span> 42.36 | <span style='color: green'>(-1 [-0.8%])</span> 84.73 | <span style='color: red'>(+0 [+0.3%])</span> 44.94 | <span style='color: green'>(-1 [-2.0%])</span> 39.79 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+1 [+1.9%])</span> 30.94 | <span style='color: red'>(+1 [+1.9%])</span> 61.89 | <span style='color: red'>(+3 [+9.3%])</span> 34.01 | <span style='color: green'>(-2 [-5.8%])</span> 27.88 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+0 [+1.2%])</span> 11.87 | <span style='color: red'>(+0 [+1.2%])</span> 23.75 | <span style='color: red'>(+0 [+1.1%])</span> 11.94 | <span style='color: red'>(+0 [+1.2%])</span> 11.81 |
| `pcs_opening_time_ms ` | <span style='color: green'>(-6 [-13.5%])</span> 41.50 | <span style='color: green'>(-13 [-13.5%])</span> 83 | <span style='color: green'>(-11 [-20.0%])</span> 44 | <span style='color: green'>(-2 [-4.9%])</span> 39 |
...
| --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 418 | 1 | 13 | 1,500,209 | 112.18 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 194 | 550 | 9,677,708 | 84,395,212 | 194 | 187 | 0 | 34.01 | 11.94 | 4 | 44.94 | 44 | 63 | 44 | 0 | 33 | 1,035,986 | 18 | 26 | 873,000 | 34.79 | 13 | 46 | 0 | 44 | 
| fibonacci_program | 1 | 182 | 418 | 9,708,170 | 74,305,770 | 182 | 161 | 1 | 27.88 | 11.81 | 4 | 39.79 | 39 | 53 | 39 | 0 | 28 | 1,064,416 | 13 | 33 | 627,209 | 38.59 | 11 | 40 | 0 | 39 | 

...
|:---|---:|---:|
| Total | <span style='color: red'>(+0 [+0.6%])</span> 2.40 | <span style='color: green'>(-0 [-0.5%])</span> 0.77 |
| regex_program | <span style='color: red'>(+0 [+0.6%])</span> 2.36 | <span style='color: green'>(-0 [-0.4%])</span> 0.74 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+4 [+0.6%])</span> 591 | <span style='color: red'>(+15 [+0.6%])</span> 2,364 | <span style='color: green'>(-3 [-0.4%])</span> 735 | <span style='color: red'>(+2 [+0.4%])</span> 538 |
...
| `execute_metered_insn_mi/s` | <span style='color: red'>(+4 [+3.3%])</span> 122.66 | -          | <span style='color: red'>(+4 [+3.3%])</span> 122.66 | <span style='color: red'>(+4 [+3.3%])</span> 122.66 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` | <span style='color: red'>(+1 [+1.9%])</span> 54.50 | <span style='color: red'>(+4 [+1.9%])</span> 218 | <span style='color: red'>(+1 [+1.5%])</span> 66 |  45 |
| `execute_preflight_insn_mi/s` | <span style='color: green'>(-1 [-2.7%])</span> 30.15 | -          | <span style='color: green'>(-1 [-2.2%])</span> 31.42 | <span style='color: green'>(-0 [-1.2%])</span> 27.75 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+2 [+1.1%])</span> 179.25 | <span style='color: red'>(+8 [+1.1%])</span> 717 | <span style='color: red'>(+3 [+1.4%])</span> 213 | <span style='color: red'>(+2 [+1.3%])</span> 156 |
...
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+1 [+0.4%])</span> 290 | <span style='color: red'>(+5 [+0.4%])</span> 1,160 | <span style='color: green'>(-6 [-1.8%])</span> 331 | <span style='color: red'>(+5 [+1.9%])</span> 271 |
...
| `generate_perm_trace_time_ms` | <span style='color: green'>(-4 [-11.9%])</span> 29.75 | <span style='color: green'>(-16 [-11.9%])</span> 119 | <span style='color: green'>(-15 [-27.8%])</span> 39 |  19 |
| `perm_trace_commit_time_ms` | <span style='color: red'>(+1 [+2.1%])</span> 64.88 | <span style='color: red'>(+5 [+2.1%])</span> 259.53 | <span style='color: red'>(+4 [+6.2%])</span> 72.40 | <span style='color: red'>(+2 [+3.3%])</span> 56.50 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+1 [+2.3%])</span> 58.51 | <span style='color: red'>(+5 [+2.3%])</span> 234.05 | <span style='color: green'>(-1 [-0.9%])</span> 69.51 | <span style='color: red'>(+1 [+1.9%])</span> 52.49 |
| `quotient_poly_commit_time_ms` | <span style='color: green'>(-0 [-2.9%])</span> 14.67 | <span style='color: green'>(-2 [-2.9%])</span> 58.70 | <span style='color: green'>(-1 [-5.4%])</span> 16.76 | <span style='color: red'>(+0 [+3.4%])</span> 12.98 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+2 [+2.7%])</span> 66.75 | <span style='color: red'>(+7 [+2.7%])</span> 267 | <span style='color: red'>(+5 [+6.0%])</span> 88 |  56 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 542 | 1 | 33 | 4,137,502 | 122.66 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 213 | 735 | 23,446,148 | 150,778,428 | 213 | 331 | 0 | 59.01 | 16.76 | 5 | 72.40 | 88 | 107 | 88 | 5 | 58 | 10,899,170 | 34 | 47 | 1,103,000 | 27.75 | 21 | 76 | 1 | 88 | 
| regex_program | 1 | 156 | 549 | 11,598,276 | 128,513,066 | 156 | 285 | 1 | 53.04 | 14.49 | 4 | 65.23 | 62 | 104 | 61 | 0 | 50 | 2,196,106 | 39 | 66 | 1,104,000 | 31.04 | 16 | 68 | 0 | 61 | 
| regex_program | 2 | 163 | 538 | 11,579,064 | 128,513,066 | 163 | 273 | 1 | 52.49 | 14.47 | 4 | 65.39 | 61 | 93 | 61 | 0 | 51 | 2,177,334 | 27 | 60 | 1,104,000 | 30.38 | 16 | 67 | 0 | 61 | 
| regex_program | 3 | 185 | 542 | 11,853,872 | 103,456,394 | 185 | 271 | 0 | 69.51 | 12.98 | 5 | 56.50 | 56 | 78 | 56 | 0 | 51 | 2,422,606 | 19 | 45 | 826,502 | 31.42 | 18 | 83 | 1 | 56 | 

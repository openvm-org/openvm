...
|:---|---:|---:|
| Total | <span style='color: red'>(+0 [+4.2%])</span> 1.58 | <span style='color: red'>(+0 [+6.3%])</span> 0.96 |
| pairing | <span style='color: red'>(+0 [+4.4%])</span> 1.49 | <span style='color: red'>(+0 [+6.9%])</span> 0.87 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+32 [+4.4%])</span> 744.50 | <span style='color: red'>(+63 [+4.4%])</span> 1,489 | <span style='color: red'>(+56 [+6.9%])</span> 867 | <span style='color: red'>(+7 [+1.1%])</span> 622 |
...
| `execute_metered_insn_mi/s` | <span style='color: green'>(-0 [-0.2%])</span> 19.38 | -          | <span style='color: green'>(-0 [-0.2%])</span> 19.38 | <span style='color: green'>(-0 [-0.2%])</span> 19.38 |
| `execute_preflight_insns` |  872,871 |  1,745,742 |  1,157,000 |  588,742 |
| `execute_preflight_time_ms` | <span style='color: red'>(+3 [+3.2%])</span> 97 | <span style='color: red'>(+6 [+3.2%])</span> 194 | <span style='color: red'>(+2 [+1.6%])</span> 131 | <span style='color: red'>(+4 [+6.8%])</span> 63 |
| `execute_preflight_insn_mi/s` | <span style='color: green'>(-0 [-1.7%])</span> 13.41 | -          | <span style='color: green'>(-0 [-1.8%])</span> 17.80 | <span style='color: green'>(-0 [-1.5%])</span> 9.02 |
| `trace_gen_time_ms   ` |  180 |  360 | <span style='color: green'>(-2 [-1.0%])</span> 195 | <span style='color: red'>(+2 [+1.2%])</span> 165 |
...
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+29 [+8.4%])</span> 374.50 | <span style='color: red'>(+58 [+8.4%])</span> 749 | <span style='color: red'>(+53 [+14.2%])</span> 427 | <span style='color: red'>(+5 [+1.6%])</span> 322 |
| `main_trace_commit_time_ms` | <span style='color: red'>(+4 [+5.6%])</span> 66 | <span style='color: red'>(+7 [+5.6%])</span> 132 | <span style='color: red'>(+4 [+5.6%])</span> 76 | <span style='color: red'>(+3 [+5.7%])</span> 56 |
| `generate_perm_trace_time_ms` | <span style='color: red'>(+26 [+72.9%])</span> 60.50 | <span style='color: red'>(+51 [+72.9%])</span> 121 | <span style='color: red'>(+45 [+118.4%])</span> 83 | <span style='color: red'>(+6 [+18.8%])</span> 38 |
| `perm_trace_commit_time_ms` | <span style='color: red'>(+1 [+1.1%])</span> 78.14 | <span style='color: red'>(+2 [+1.1%])</span> 156.28 | <span style='color: green'>(-0 [-0.2%])</span> 89.94 | <span style='color: red'>(+2 [+3.0%])</span> 66.35 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+1 [+1.1%])</span> 80.57 | <span style='color: red'>(+2 [+1.1%])</span> 161.14 | <span style='color: red'>(+1 [+1.7%])</span> 88.77 | <span style='color: red'>(+0 [+0.3%])</span> 72.38 |
| `quotient_poly_commit_time_ms` | <span style='color: green'>(-0 [-1.8%])</span> 16.45 | <span style='color: green'>(-1 [-1.8%])</span> 32.90 | <span style='color: green'>(-1 [-6.3%])</span> 17.71 | <span style='color: red'>(+1 [+3.9%])</span> 15.19 |
| `pcs_opening_time_ms ` | <span style='color: green'>(-1 [-1.5%])</span> 67.50 | <span style='color: green'>(-2 [-1.5%])</span> 135 |  70 | <span style='color: green'>(-2 [-3.0%])</span> 65 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 622 | 1 | 90 | 1,745,742 | 19.38 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 165 | 867 | 32,689,110 | 172,558,444 | 165 | 427 | 0 | 88.77 | 17.71 | 6 | 89.94 | 65 | 176 | 65 | 1 | 76 | 16,059,916 | 83 | 131 | 1,157,000 | 9.02 | 26 | 107 | 1 | 65 | 
| pairing | 1 | 195 | 622 | 22,314,288 | 119,958,502 | 195 | 322 | 1 | 72.38 | 15.19 | 6 | 66.35 | 70 | 107 | 70 | 0 | 56 | 9,408,294 | 38 | 63 | 588,742 | 17.80 | 20 | 88 | 1 | 70 | 
...
Commit: https://github.com/openvm-org/openvm/commit/5919a72aca5fad0ca70f726e5f3a2199c460ee9d
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19352616599)

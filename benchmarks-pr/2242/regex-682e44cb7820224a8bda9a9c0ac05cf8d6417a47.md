...
|:---|---:|---:|
| Total | <span style='color: red'>(+0 [+1.3%])</span> 2.41 | <span style='color: red'>(+0 [+2.2%])</span> 0.78 |
| regex_program | <span style='color: red'>(+0 [+1.4%])</span> 2.37 | <span style='color: red'>(+0 [+2.6%])</span> 0.75 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+8 [+1.4%])</span> 593 | <span style='color: red'>(+32 [+1.4%])</span> 2,372 | <span style='color: red'>(+19 [+2.6%])</span> 749 | <span style='color: red'>(+13 [+2.5%])</span> 537 |
...
| `execute_metered_insn_mi/s` | <span style='color: red'>(+4 [+3.4%])</span> 115.50 | -          | <span style='color: red'>(+4 [+3.4%])</span> 115.50 | <span style='color: red'>(+4 [+3.4%])</span> 115.50 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` | <span style='color: green'>(-0 [-0.9%])</span> 54.25 | <span style='color: green'>(-2 [-0.9%])</span> 217 | <span style='color: green'>(-3 [-4.4%])</span> 65 | <span style='color: red'>(+1 [+2.2%])</span> 46 |
| `execute_preflight_insn_mi/s` | <span style='color: green'>(-0 [-0.5%])</span> 30.30 | -          | <span style='color: green'>(-0 [-1.2%])</span> 31.40 | <span style='color: green'>(-0 [-1.2%])</span> 27.52 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+0 [+0.1%])</span> 179.25 | <span style='color: red'>(+1 [+0.1%])</span> 717 | <span style='color: red'>(+1 [+0.5%])</span> 212 | <span style='color: red'>(+2 [+1.3%])</span> 157 |
| `memory_finalize_time_ms` |  1 |  4 |  4 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+9 [+3.3%])</span> 292.50 | <span style='color: red'>(+37 [+3.3%])</span> 1,170 | <span style='color: red'>(+18 [+5.5%])</span> 345 | <span style='color: red'>(+7 [+2.7%])</span> 266 |
...
| `generate_perm_trace_time_ms` | <span style='color: red'>(+1 [+3.0%])</span> 34.50 | <span style='color: red'>(+4 [+3.0%])</span> 138 | <span style='color: red'>(+1 [+1.9%])</span> 55 |  18 |
| `perm_trace_commit_time_ms` | <span style='color: green'>(-0 [-0.7%])</span> 63.84 | <span style='color: green'>(-2 [-0.7%])</span> 255.35 | <span style='color: green'>(-1 [-1.6%])</span> 69.51 | <span style='color: green'>(-0 [-0.4%])</span> 55.70 |
| `quotient_poly_compute_time_ms` | <span style='color: green'>(-1 [-1.3%])</span> 58.30 | <span style='color: green'>(-3 [-1.3%])</span> 233.21 | <span style='color: green'>(-1 [-0.8%])</span> 68.93 | <span style='color: green'>(-1 [-1.7%])</span> 51.86 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+0 [+1.1%])</span> 15.13 | <span style='color: red'>(+1 [+1.1%])</span> 60.52 | <span style='color: green'>(-0 [-0.9%])</span> 18.08 | <span style='color: red'>(+0 [+0.7%])</span> 12.41 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+10 [+18.8%])</span> 66.50 | <span style='color: red'>(+42 [+18.8%])</span> 266 | <span style='color: red'>(+20 [+31.7%])</span> 83 | <span style='color: red'>(+11 [+23.9%])</span> 57 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 537 | 1 | 35 | 4,137,502 | 115.50 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 212 | 749 | 23,446,148 | 150,778,428 | 212 | 345 | 0 | 60.50 | 18.08 | 5 | 69.51 | 83 | 126 | 83 | 4 | 56 | 10,899,170 | 55 | 47 | 1,103,000 | 27.52 | 21 | 79 | 1 | 83 | 
| regex_program | 1 | 157 | 549 | 11,598,276 | 128,513,066 | 157 | 286 | 1 | 51.92 | 15.03 | 4 | 65.15 | 64 | 104 | 64 | 0 | 50 | 2,196,106 | 38 | 65 | 1,104,000 | 31.40 | 16 | 67 | 0 | 63 | 
| regex_program | 2 | 164 | 537 | 11,579,064 | 128,513,066 | 164 | 273 | 1 | 51.86 | 15 | 4 | 64.100 | 62 | 92 | 62 | 0 | 50 | 2,177,334 | 27 | 59 | 1,104,000 | 31.24 | 17 | 67 | 0 | 62 | 
| regex_program | 3 | 184 | 537 | 11,853,872 | 103,456,394 | 184 | 266 | 0 | 68.93 | 12.41 | 5 | 55.70 | 57 | 77 | 56 | 0 | 49 | 2,422,606 | 18 | 46 | 826,502 | 31.06 | 18 | 82 | 1 | 56 | 

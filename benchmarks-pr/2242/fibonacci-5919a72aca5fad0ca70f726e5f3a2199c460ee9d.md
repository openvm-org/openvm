...
|:---|---:|---:|
| Total | <span style='color: green'>(-0 [-0.4%])</span> 0.98 | <span style='color: green'>(-0 [-0.7%])</span> 0.56 |
| fibonacci_program | <span style='color: green'>(-0 [-0.4%])</span> 0.97 | <span style='color: green'>(-0 [-0.7%])</span> 0.55 |


| fibonacci_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: green'>(-2 [-0.4%])</span> 484 | <span style='color: green'>(-4 [-0.4%])</span> 968 | <span style='color: green'>(-4 [-0.7%])</span> 548 |  420 |
...
| `execute_metered_insn_mi/s` | <span style='color: green'>(-1 [-0.7%])</span> 146.88 | -          | <span style='color: green'>(-1 [-0.7%])</span> 146.88 | <span style='color: green'>(-1 [-0.7%])</span> 146.88 |
| `execute_preflight_insns` |  750,104.50 |  1,500,209 |  873,000 |  627,209 |
| `execute_preflight_time_ms` |  29.50 |  59 |  33 |  26 |
| `execute_preflight_insn_mi/s` | <span style='color: green'>(-1 [-3.0%])</span> 35.07 | -          | <span style='color: green'>(-1 [-2.1%])</span> 36.79 | <span style='color: green'>(-1 [-4.1%])</span> 33.35 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+3 [+1.6%])</span> 190.50 | <span style='color: red'>(+6 [+1.6%])</span> 381 | <span style='color: red'>(+1 [+0.5%])</span> 196 | <span style='color: red'>(+5 [+2.8%])</span> 185 |
...
| `generate_perm_trace_time_ms` | <span style='color: green'>(-2 [-10.0%])</span> 13.50 | <span style='color: green'>(-3 [-10.0%])</span> 27 | <span style='color: green'>(-1 [-5.9%])</span> 16 | <span style='color: green'>(-2 [-15.4%])</span> 11 |
| `perm_trace_commit_time_ms` | <span style='color: green'>(-1 [-2.5%])</span> 41.08 | <span style='color: green'>(-2 [-2.5%])</span> 82.15 | <span style='color: green'>(-1 [-1.3%])</span> 44.23 | <span style='color: green'>(-2 [-3.9%])</span> 37.92 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+1 [+2.0%])</span> 31.52 | <span style='color: red'>(+1 [+2.0%])</span> 63.03 | <span style='color: green'>(-0 [-0.4%])</span> 32.99 | <span style='color: red'>(+1 [+4.7%])</span> 30.04 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+0 [+3.0%])</span> 12.28 | <span style='color: red'>(+1 [+3.0%])</span> 24.56 | <span style='color: red'>(+0 [+3.7%])</span> 12.71 | <span style='color: red'>(+0 [+2.2%])</span> 11.85 |
...
| --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 420 | 1 | 10 | 1,500,209 | 146.88 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 196 | 548 | 9,677,708 | 84,395,212 | 196 | 185 | 0 | 32.99 | 12.71 | 4 | 44.23 | 44 | 61 | 44 | 0 | 33 | 1,035,986 | 16 | 26 | 873,000 | 33.35 | 14 | 46 | 0 | 44 | 
| fibonacci_program | 1 | 185 | 420 | 9,708,170 | 74,305,770 | 185 | 160 | 1 | 30.04 | 11.85 | 4 | 37.92 | 39 | 50 | 39 | 0 | 28 | 1,064,416 | 11 | 33 | 627,209 | 36.79 | 11 | 42 | 0 | 39 | 

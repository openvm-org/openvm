...
| `total_proof_time_ms ` |  1,243 |  7,458 |  1,360 |  1,204 |
| `compile_metered_time_ms` |  2 |  2 |  2 |  2 |
| `execute_metered_time_ms` |  126 | -          | -          | -          |
| `execute_metered_insns` |  14,365,133 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  113.34 | -          |  113.34 |  113.34 |
| `set_initial_memory_time_ms` |  0 |  0 |  0 |  0 |
| `execute_preflight_insns` |  2,394,188.83 |  14,365,133 |  2,413,000 |  2,300,133 |
| `execute_preflight_time_ms` |  84.67 |  508 |  105 |  78 |
| `execute_preflight_insn_mi/s` |  28.28 | -          |  29.78 |  22.78 |
| `postflight_time_ms  ` |  29.17 |  175 |  31 |  27 |
| `postflight_memory_chronology_time_ms` |  2.17 |  13 |  3 |  2 |
| `postflight_program_index_time_ms` |  0 |  0 |  0 |  0 |
| `trace_gen_time_ms   ` |  12.67 |  76 |  18 |  11 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,099.33 |  6,596 |  1,191 |  1,072 |
| `prover.main_trace_commit_time_ms` |  346.83 |  2,081 |  366 |  338 |
| `prover.rap_constraints_time_ms` |  511.33 |  3,068 |  513 |  508 |
| `prover.openings_time_ms` |  240.17 |  1,441 |  311 |  224 |
| `prover.rap_constraints.logup_gkr_time_ms` |  103.83 |  623 |  105 |  103 |
| `prover.rap_constraints.round0_time_ms` |  282.33 |  1,694 |  284 |  281 |
| `prover.rap_constraints.mle_rounds_time_ms` |  124.17 |  745 |  125 |  123 |
...
| `prover.openings.whir_time_ms` |  178.67 |  1,072 |  249 |  163 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  767 |  1,534 |  1,027 |  507 |
| `execute_preflight_time_ms` |  4.50 |  9 |  5 |  4 |
| `trace_gen_time_ms   ` |  144.50 |  289 |  193 |  96 |
...
| `prover.rap_constraints.round0_time_ms` |  96 |  192 |  122 |  70 |
...
| `prover.openings.whir_time_ms` |  135 |  270 |  173 |  97 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/efb2bad6dc6ec643587843a014cadc837ad03fcd/keccak-efb2bad6dc6ec643587843a014cadc837ad03fcd.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 43 | 331 | 42 | 14 | 3 | 2 | 3 | 3 | 
| internal_recursive.0 | 1 | 14 | 128 | 14 | 2 | 0 | 2 | 2 | 2 | 
| internal_recursive.1 | 1 | 10 | 105 | 10 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 193 | 1,027 | 192 | 60 | 21 | 4 | 11 | 11 | 
| leaf | 1 | 96 | 507 | 96 | 32 | 10 | 5 | 11 | 11 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 81,415,160 | 288 | 93 | 0 | 0 | 113 | 39 | 38 | 56 | 17 | 0 | 80 | 65 | 15 | 5 | 9 | 93 | 93 | 113 | 0 | 1 | 16 | 0 | 0 | 
...
| leaf | 0 | prover | 476,578,798 | 834 | 389 | 0 | 0 | 233 | 122 | 121 | 70 | 40 | 0 | 210 | 173 | 37 | 20 | 17 | 389 | 389 | 233 | 0 | 3 | 40 | 0 | 0 | 
| leaf | 1 | prover | 240,255,800 | 410 | 147 | 0 | 0 | 143 | 70 | 69 | 45 | 26 | 0 | 119 | 97 | 22 | 10 | 11 | 147 | 147 | 143 | 0 | 3 | 25 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover |  | 0 | 830,158,476 | 1,191 | 365 | 0 | 56 | 513 | 284 | 283 | 124 | 104 | 0 | 311 | 249 | 62 | 37 | 24 | 366 | 365 | 513 | 0 | 1 | 103 | 0 | 0 | 
| app_proof | prover |  | 1 | 830,158,476 | 1,081 | 341 | 0 | 0 | 512 | 283 | 282 | 124 | 105 | 0 | 226 | 165 | 60 | 36 | 24 | 342 | 341 | 512 | 0 | 1 | 104 | 0 | 0 | 
| app_proof | prover |  | 2 | 830,158,476 | 1,083 | 343 | 0 | 0 | 512 | 282 | 281 | 125 | 104 | 0 | 228 | 167 | 61 | 36 | 24 | 343 | 343 | 512 | 0 | 1 | 103 | 0 | 0 | 
| app_proof | prover |  | 3 | 830,158,476 | 1,083 | 346 | 0 | 0 | 510 | 281 | 280 | 125 | 103 | 0 | 226 | 164 | 61 | 36 | 24 | 346 | 346 | 510 | 0 | 1 | 103 | 0 | 0 | 
| app_proof | prover |  | 4 | 830,158,476 | 1,086 | 346 | 0 | 0 | 513 | 283 | 282 | 124 | 104 | 0 | 226 | 164 | 62 | 37 | 25 | 346 | 346 | 513 | 0 | 1 | 103 | 0 | 0 | 
| app_proof | prover |  | 5 | 819,934,860 | 1,072 | 338 | 0 | 0 | 508 | 281 | 280 | 123 | 103 | 0 | 224 | 163 | 60 | 36 | 24 | 338 | 338 | 508 | 0 | 1 | 102 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof |  | 1,204 | 126 | 14,365,133 | 113.34 | 0 | 7,593 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof |  | 0 | 0 | 2 | 18 | 1,360 | 3 | 0 | 0 | 29 | 0 | 3 | 0 | 9,337,486,584 | 624,415,128 | 9,961,901,712 | 2,097,152 | 2 | 0 | 0 | 2 | 14 | 105 | 2,413,000 | 22.78 | 0 | 0 | 
| app_proof |  | 1 | 0 | 2 | 12 | 1,224 | 2 | 0 | 0 | 31 | 0 | 2 | 0 | 9,337,793,604 | 625,029,708 | 9,962,823,312 | 2,097,152 | 2 | 0 | 0 | 2 | 9 | 81 | 2,413,000 | 29.64 | 0 | 0 | 
| app_proof |  | 2 | 0 | 2 | 12 | 1,224 | 2 | 0 | 0 | 30 | 0 | 2 | 0 | 9,337,030,356 | 625,792,956 | 9,962,823,312 | 2,097,152 | 2 | 0 | 0 | 2 | 9 | 82 | 2,413,000 | 29.27 | 0 | 0 | 
| app_proof |  | 3 | 0 | 2 | 12 | 1,221 | 2 | 0 | 0 | 29 | 0 | 2 | 0 | 9,337,792,860 | 625,030,452 | 9,962,823,312 | 2,097,152 | 2 | 0 | 0 | 2 | 9 | 81 | 2,413,000 | 29.78 | 0 | 0 | 
| app_proof |  | 4 | 0 | 2 | 11 | 1,225 | 2 | 0 | 0 | 29 | 0 | 2 | 0 | 9,337,030,236 | 625,793,076 | 9,962,823,312 | 2,097,152 | 2 | 0 | 0 | 2 | 9 | 81 | 2,413,000 | 29.61 | 0 | 0 | 
| app_proof |  | 5 | 0 | 2 | 11 | 1,204 | 2 | 0 | 0 | 27 | 0 | 2 | 0 | 8,903,917,596 | 936,222,324 | 9,840,139,920 | 2,097,152 | 2 | 0 | 0 | 2 | 9 | 78 | 2,300,133 | 29.26 | 0 | 0 | 

...
|:---|---:|---:|---:|
| Total |  2.45 |  0.77 | 0.77 |
| regex_program |  2.45 |  0.77 |  0.77 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  603.25 |  2,413 |  729 |  537 |
...
| `execute_preflight_time_ms` |  45.25 |  181 |  56 |  35 |
| `execute_preflight_insn_mi/s` |  31.54 | -          |  32.07 |  30.79 |
| `trace_gen_time_ms   ` |  181.75 |  727 |  201 |  173 |
| `memory_finalize_time_ms` |  0.75 |  3 |  3 |  0 |
| `stark_prove_excluding_trace_time_ms` |  301.75 |  1,207 |  329 |  273 |
| `main_trace_commit_time_ms` |  51.50 |  206 |  58 |  49 |
| `generate_perm_trace_time_ms` |  38.75 |  155 |  46 |  22 |
| `perm_trace_commit_time_ms` |  63.96 |  255.83 |  70.33 |  53.71 |
| `quotient_poly_compute_time_ms` |  58.74 |  234.95 |  65.87 |  52.86 |
| `quotient_poly_commit_time_ms` |  16.15 |  64.62 |  18.09 |  14.02 |
| `pcs_opening_time_ms ` |  69.25 |  277 |  94 |  49 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 606 | 1 | 36 | 4,137,600 | 114.36 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 173 | 729 | 150,778,428 | 173 | 327 | 0 | 62.38 | 18.09 | 6 | 70.33 | 72 | 115 | 72 | 3 | 58 | 44 | 56 | 1,103,000 | 30.79 | 22 | 81 | 1 | 72 | 
| regex_program | 1 | 176 | 541 | 128,513,066 | 176 | 278 | 1 | 52.86 | 15.96 | 5 | 64.68 | 49 | 109 | 49 | 0 | 49 | 43 | 45 | 1,104,000 | 32.07 | 17 | 69 | 0 | 49 | 
| regex_program | 2 | 177 | 537 | 128,513,066 | 177 | 273 | 1 | 53.83 | 16.55 | 4 | 67.11 | 62 | 90 | 62 | 0 | 49 | 22 | 45 | 1,104,000 | 31.95 | 17 | 70 | 0 | 62 | 
| regex_program | 3 | 201 | 606 | 103,473,675 | 200 | 329 | 0 | 65.87 | 14.02 | 5 | 53.71 | 94 | 103 | 93 | 0 | 50 | 46 | 35 | 826,600 | 31.34 | 19 | 80 | 1 | 93 | 

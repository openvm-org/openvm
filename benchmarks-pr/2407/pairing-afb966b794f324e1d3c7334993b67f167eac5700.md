...
| `total_proof_time_ms ` |  748 |  1,496 |  877 |  619 |
...
| `execute_preflight_insn_mi/s` |  14.40 | -          |  17.85 |  10.95 |
| `trace_gen_time_ms   ` |  177.50 |  355 |  200 |  155 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  379 |  758 |  429 |  329 |
| `main_trace_commit_time_ms` |  64.50 |  129 |  74 |  55 |
| `generate_perm_trace_time_ms` |  51 |  102 |  71 |  31 |
| `perm_trace_commit_time_ms` |  76.50 |  153.01 |  87.98 |  65.03 |
| `quotient_poly_compute_time_ms` |  82.06 |  164.12 |  90.26 |  73.87 |
| `quotient_poly_commit_time_ms` |  17.20 |  34.40 |  19.08 |  15.31 |
| `pcs_opening_time_ms ` |  83 |  166 |  84 |  82 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 619 | 1 | 68 | 1,745,757 | 25.63 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 155 | 877 | 172,558,444 | 155 | 429 | 0 | 90.26 | 19.08 | 6 | 87.98 | 82 | 161 | 82 | 1 | 74 | 71 | 123 | 1,151,000 | 10.95 | 26 | 110 | 1 | 82 | 
| pairing | 1 | 200 | 619 | 119,958,502 | 200 | 329 | 1 | 73.87 | 15.31 | 6 | 65.03 | 84 | 99 | 84 | 0 | 55 | 31 | 48 | 594,757 | 17.85 | 21 | 89 | 1 | 84 | 

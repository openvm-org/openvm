...
|:---|---:|---:|---:|
| Total |  1.61 |  0.98 | 0.98 |
| pairing |  1.61 |  0.98 |  0.98 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  769.50 |  1,539 |  910 |  629 |
...
| `execute_preflight_insn_mi/s` |  14.48 | -          |  17.92 |  11.04 |
| `trace_gen_time_ms   ` |  183 |  366 |  202 |  164 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  395.50 |  791 |  454 |  337 |
| `main_trace_commit_time_ms` |  65 |  130 |  76 |  54 |
| `generate_perm_trace_time_ms` |  37.50 |  75 |  40 |  35 |
| `perm_trace_commit_time_ms` |  78.17 |  156.35 |  90.71 |  65.63 |
| `quotient_poly_compute_time_ms` |  83.35 |  166.69 |  92.73 |  73.96 |
| `quotient_poly_commit_time_ms` |  17.89 |  35.77 |  20.11 |  15.67 |
| `pcs_opening_time_ms ` |  109.50 |  219 |  135 |  84 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 629 | 1 | 67 | 1,745,757 | 25.87 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 164 | 910 | 172,558,444 | 164 | 454 | 0 | 92.73 | 20.11 | 6 | 90.71 | 135 | 129 | 135 | 1 | 76 | 35 | 122 | 1,151,000 | 11.04 | 27 | 113 | 1 | 135 | 
| pairing | 1 | 202 | 629 | 119,958,502 | 202 | 337 | 1 | 73.96 | 15.67 | 6 | 65.63 | 84 | 108 | 83 | 0 | 54 | 40 | 48 | 594,757 | 17.92 | 21 | 90 | 1 | 83 | 

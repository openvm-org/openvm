...
| `total_proof_time_ms ` |  764 |  1,528 |  934 |  594 |
| `execute_metered_time_ms` |  67 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  25.88 | -          |  25.88 |  25.88 |
| `execute_preflight_insns` |  872,878.50 |  1,745,757 |  1,151,000 |  594,757 |
| `execute_preflight_time_ms` |  86.50 |  173 |  124 |  49 |
| `execute_preflight_insn_mi/s` |  14.55 | -          |  17.97 |  11.14 |
| `trace_gen_time_ms   ` |  181 |  362 |  201 |  161 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  391 |  782 |  480 |  302 |
| `main_trace_commit_time_ms` |  65 |  130 |  75 |  55 |
| `generate_perm_trace_time_ms` |  60 |  120 |  88 |  32 |
| `perm_trace_commit_time_ms` |  76.92 |  153.83 |  88.64 |  65.19 |
| `quotient_poly_compute_time_ms` |  82.99 |  165.97 |  92.19 |  73.78 |
| `quotient_poly_commit_time_ms` |  16.95 |  33.91 |  18.58 |  15.33 |
| `pcs_opening_time_ms ` |  84 |  168 |  113 |  55 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 594 | 1 | 67 | 1,745,757 | 25.88 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 161 | 934 | 172,558,444 | 161 | 480 | 0 | 92.19 | 18.58 | 7 | 88.64 | 113 | 180 | 112 | 1 | 75 | 88 | 124 | 1,151,000 | 11.14 | 27 | 111 | 1 | 112 | 
| pairing | 1 | 201 | 594 | 119,958,502 | 201 | 302 | 1 | 73.78 | 15.33 | 6 | 65.19 | 55 | 101 | 54 | 0 | 55 | 32 | 49 | 594,757 | 17.97 | 21 | 89 | 1 | 54 | 

...
| `total_proof_time_ms ` |  719 |  1,438 |  832 |  606 |
...
| `execute_preflight_insn_mi/s` |  14.56 | -          |  18.04 |  11.08 |
| `trace_gen_time_ms   ` |  183 |  366 |  203 |  163 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  344 |  688 |  375 |  313 |
| `main_trace_commit_time_ms` |  63 |  126 |  72 |  54 |
| `generate_perm_trace_time_ms` |  40.50 |  81 |  47 |  34 |
| `perm_trace_commit_time_ms` |  77.24 |  154.49 |  89.49 |  65 |
| `quotient_poly_compute_time_ms` |  82.01 |  164.02 |  90.45 |  73.57 |
| `quotient_poly_commit_time_ms` |  17.52 |  35.04 |  19.61 |  15.42 |
| `pcs_opening_time_ms ` |  60 |  120 |  66 |  54 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 606 | 1 | 67 | 1,745,757 | 25.70 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 163 | 832 | 172,558,444 | 163 | 375 | 0 | 90.45 | 19.61 | 6 | 89.49 | 66 | 126 | 66 | 1 | 72 | 34 | 122 | 1,151,000 | 11.08 | 27 | 110 | 1 | 66 | 
| pairing | 1 | 203 | 606 | 119,958,502 | 203 | 313 | 1 | 73.57 | 15.42 | 6 | 65 | 54 | 114 | 54 | 0 | 54 | 47 | 48 | 594,757 | 18.04 | 21 | 89 | 1 | 54 | 

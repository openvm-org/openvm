...
|:---|---:|---:|---:|
| Total |  1.58 |  0.98 | 0.98 |
| pairing |  1.58 |  0.98 |  0.98 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  756 |  1,512 |  910 |  602 |
...
| `execute_preflight_time_ms` |  85 |  170 |  123 |  47 |
| `execute_preflight_insn_mi/s` |  14.60 | -          |  18.12 |  11.08 |
| `trace_gen_time_ms   ` |  180.50 |  361 |  201 |  160 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  384.50 |  769 |  458 |  311 |
| `main_trace_commit_time_ms` |  64.50 |  129 |  75 |  54 |
| `generate_perm_trace_time_ms` |  37 |  74 |  39 |  35 |
| `perm_trace_commit_time_ms` |  77.08 |  154.16 |  89.42 |  64.74 |
| `quotient_poly_compute_time_ms` |  83.44 |  166.88 |  92.89 |  73.99 |
| `quotient_poly_commit_time_ms` |  17.65 |  35.31 |  19.98 |  15.32 |
| `pcs_opening_time_ms ` |  100.50 |  201 |  142 |  59 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 602 | 1 | 67 | 1,745,757 | 26.04 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 160 | 910 | 172,558,444 | 160 | 458 | 0 | 92.89 | 19.98 | 6 | 89.42 | 142 | 126 | 142 | 1 | 75 | 35 | 123 | 1,151,000 | 11.08 | 27 | 113 | 1 | 142 | 
| pairing | 1 | 201 | 602 | 119,958,502 | 201 | 311 | 1 | 73.99 | 15.32 | 6 | 64.74 | 59 | 107 | 58 | 0 | 54 | 39 | 47 | 594,757 | 18.12 | 21 | 89 | 1 | 58 | 

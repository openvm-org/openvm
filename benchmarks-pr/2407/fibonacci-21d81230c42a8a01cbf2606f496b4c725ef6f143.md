...
| `total_proof_time_ms ` |  534.50 |  1,069 |  622 |  447 |
| `execute_metered_time_ms` |  9 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  161.60 | -          |  161.60 |  161.60 |
| `execute_preflight_insns` |  750,132.50 |  1,500,265 |  873,000 |  627,265 |
| `execute_preflight_time_ms` |  27 |  54 |  32 |  22 |
| `execute_preflight_insn_mi/s` |  38.23 | -          |  38.51 |  37.95 |
| `trace_gen_time_ms   ` |  194.50 |  389 |  198 |  191 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  207.50 |  415 |  229 |  186 |
| `main_trace_commit_time_ms` |  30.50 |  61 |  33 |  28 |
| `generate_perm_trace_time_ms` |  21.50 |  43 |  27 |  16 |
| `perm_trace_commit_time_ms` |  41.80 |  83.61 |  45.82 |  37.78 |
| `quotient_poly_compute_time_ms` |  32.06 |  64.12 |  35.65 |  28.47 |
| `quotient_poly_commit_time_ms` |  12.74 |  25.48 |  12.77 |  12.71 |
| `pcs_opening_time_ms ` |  67 |  134 |  84 |  50 |
...
| --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 447 | 1 | 9 | 1,500,265 | 161.60 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 191 | 622 | 84,399,632 | 191 | 229 | 0 | 35.65 | 12.71 | 5 | 45.82 | 84 | 62 | 84 | 0 | 33 | 16 | 32 | 873,000 | 38.51 | 14 | 48 | 0 | 84 | 
| fibonacci_program | 1 | 198 | 447 | 74,305,770 | 198 | 186 | 1 | 28.47 | 12.77 | 4 | 37.78 | 50 | 65 | 49 | 0 | 28 | 27 | 22 | 627,265 | 37.95 | 11 | 41 | 0 | 49 | 

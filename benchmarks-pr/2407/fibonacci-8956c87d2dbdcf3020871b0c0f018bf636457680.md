...
| `total_proof_time_ms ` |  527 |  1,054 |  589 |  465 |
| `execute_metered_time_ms` |  9 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  161.61 | -          |  161.61 |  161.61 |
| `execute_preflight_insns` |  750,132.50 |  1,500,265 |  873,000 |  627,265 |
| `execute_preflight_time_ms` |  30 |  60 |  35 |  25 |
| `execute_preflight_insn_mi/s` |  38.17 | -          |  38.42 |  37.93 |
| `trace_gen_time_ms   ` |  193.50 |  387 |  198 |  189 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  192.50 |  385 |  199 |  186 |
| `main_trace_commit_time_ms` |  30.50 |  61 |  33 |  28 |
| `generate_perm_trace_time_ms` |  21.50 |  43 |  29 |  14 |
| `perm_trace_commit_time_ms` |  41.95 |  83.90 |  44.85 |  39.05 |
| `quotient_poly_compute_time_ms` |  31.29 |  62.58 |  33.67 |  28.90 |
| `quotient_poly_commit_time_ms` |  12.73 |  25.46 |  13.15 |  12.31 |
| `pcs_opening_time_ms ` |  52.50 |  105 |  60 |  45 |
...
| --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 465 | 1 | 9 | 1,500,265 | 161.61 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 189 | 589 | 84,399,632 | 189 | 186 | 0 | 33.67 | 13.15 | 5 | 44.85 | 45 | 60 | 45 | 0 | 33 | 14 | 35 | 873,000 | 37.93 | 15 | 47 | 1 | 45 | 
| fibonacci_program | 1 | 198 | 465 | 74,305,770 | 198 | 199 | 1 | 28.90 | 12.31 | 4 | 39.05 | 60 | 68 | 60 | 0 | 28 | 29 | 25 | 627,265 | 38.42 | 11 | 41 | 0 | 60 | 

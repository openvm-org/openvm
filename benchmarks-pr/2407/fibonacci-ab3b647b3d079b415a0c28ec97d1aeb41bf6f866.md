...
| `total_proof_time_ms ` |  515.50 |  1,031 |  579 |  452 |
| `execute_metered_time_ms` |  9 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  164.32 | -          |  164.32 |  164.32 |
| `execute_preflight_insns` |  750,132.50 |  1,500,265 |  873,000 |  627,265 |
| `execute_preflight_time_ms` |  27.50 |  55 |  33 |  22 |
| `execute_preflight_insn_mi/s` |  37.84 | -          |  38.87 |  36.82 |
| `trace_gen_time_ms   ` |  190.50 |  381 |  192 |  189 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  192.50 |  385 |  197 |  188 |
| `main_trace_commit_time_ms` |  30.50 |  61 |  33 |  28 |
| `generate_perm_trace_time_ms` |  22 |  44 |  29 |  15 |
| `perm_trace_commit_time_ms` |  41.65 |  83.31 |  44.55 |  38.76 |
| `quotient_poly_compute_time_ms` |  32.39 |  64.78 |  35.43 |  29.35 |
| `quotient_poly_commit_time_ms` |  11.95 |  23.90 |  12.43 |  11.47 |
| `pcs_opening_time_ms ` |  52 |  104 |  58 |  46 |
...
| --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 452 | 1 | 9 | 1,500,265 | 164.32 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 189 | 579 | 84,399,632 | 189 | 188 | 0 | 35.43 | 12.43 | 4 | 44.55 | 46 | 60 | 45 | 0 | 33 | 15 | 33 | 873,000 | 36.82 | 14 | 48 | 0 | 45 | 
| fibonacci_program | 1 | 192 | 452 | 74,305,770 | 192 | 197 | 1 | 29.35 | 11.47 | 4 | 38.76 | 58 | 68 | 58 | 0 | 28 | 29 | 22 | 627,265 | 38.87 | 11 | 41 | 0 | 58 | 

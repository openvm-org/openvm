...
|:---|---:|---:|---:|
| Total |  2.37 |  0.73 | 0.73 |
| regex_program |  2.37 |  0.73 |  0.73 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  584 |  2,336 |  691 |  546 |
...
| `execute_preflight_insn_mi/s` |  31.29 | -          |  31.91 |  30.11 |
| `trace_gen_time_ms   ` |  180.50 |  722 |  201 |  170 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  283.75 |  1,135 |  294 |  269 |
| `main_trace_commit_time_ms` |  52 |  208 |  58 |  49 |
| `generate_perm_trace_time_ms` |  36.50 |  146 |  46 |  28 |
| `perm_trace_commit_time_ms` |  62.95 |  251.81 |  68.92 |  52.84 |
| `quotient_poly_compute_time_ms` |  57.85 |  231.41 |  68.14 |  53.01 |
| `quotient_poly_commit_time_ms` |  15.91 |  63.65 |  18.37 |  13.31 |
| `pcs_opening_time_ms ` |  55.25 |  221 |  60 |  51 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 546 | 1 | 36 | 4,137,600 | 113.44 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 170 | 691 | 150,778,428 | 170 | 294 | 0 | 56.90 | 18.37 | 5 | 68.92 | 59 | 100 | 59 | 4 | 58 | 30 | 58 | 1,103,000 | 30.11 | 22 | 76 | 1 | 59 | 
| regex_program | 1 | 175 | 551 | 128,513,066 | 175 | 288 | 1 | 53.01 | 16.29 | 4 | 65.31 | 60 | 108 | 60 | 0 | 49 | 42 | 46 | 1,104,000 | 31.66 | 17 | 69 | 0 | 60 | 
| regex_program | 2 | 176 | 548 | 128,513,066 | 176 | 284 | 1 | 53.36 | 15.68 | 4 | 64.74 | 51 | 112 | 51 | 0 | 51 | 46 | 46 | 1,104,000 | 31.47 | 17 | 69 | 0 | 51 | 
| regex_program | 3 | 201 | 546 | 103,473,675 | 201 | 269 | 0 | 68.14 | 13.31 | 5 | 52.84 | 51 | 84 | 51 | 0 | 50 | 28 | 34 | 826,600 | 31.91 | 18 | 82 | 1 | 51 | 

...
| `total_proof_time_ms ` |  589.50 |  2,358 |  702 |  524 |
...
| `execute_preflight_insn_mi/s` |  31.90 | -          |  32.36 |  31.14 |
| `trace_gen_time_ms   ` |  180 |  720 |  199 |  172 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  290.50 |  1,162 |  326 |  263 |
| `main_trace_commit_time_ms` |  52 |  208 |  57 |  50 |
| `generate_perm_trace_time_ms` |  30.75 |  123 |  46 |  20 |
| `perm_trace_commit_time_ms` |  63.88 |  255.51 |  70.62 |  52.52 |
| `quotient_poly_compute_time_ms` |  59.33 |  237.31 |  66.97 |  54.10 |
| `quotient_poly_commit_time_ms` |  15.22 |  60.86 |  17.61 |  13.36 |
| `pcs_opening_time_ms ` |  66.25 |  265 |  91 |  51 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 601 | 1 | 36 | 4,137,600 | 114.06 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 172 | 702 | 150,778,428 | 172 | 305 | 0 | 61.78 | 17.61 | 5 | 70.62 | 63 | 104 | 62 | 4 | 57 | 33 | 56 | 1,103,000 | 31.14 | 21 | 80 | 1 | 62 | 
| regex_program | 1 | 174 | 524 | 128,513,066 | 174 | 263 | 1 | 54.47 | 15.04 | 4 | 66.09 | 51 | 90 | 50 | 0 | 51 | 24 | 45 | 1,104,000 | 32.36 | 16 | 70 | 0 | 50 | 
| regex_program | 2 | 175 | 531 | 128,513,066 | 175 | 268 | 1 | 54.10 | 14.85 | 4 | 66.29 | 60 | 87 | 60 | 0 | 50 | 20 | 46 | 1,104,000 | 32.01 | 16 | 69 | 0 | 60 | 
| regex_program | 3 | 199 | 601 | 103,473,675 | 199 | 326 | 0 | 66.97 | 13.36 | 5 | 52.52 | 91 | 102 | 91 | 0 | 50 | 46 | 34 | 826,600 | 32.09 | 19 | 81 | 1 | 91 | 

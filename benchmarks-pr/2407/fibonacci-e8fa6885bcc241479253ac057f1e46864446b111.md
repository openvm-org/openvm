...
| `total_proof_time_ms ` |  520 |  1,040 |  603 |  437 |
| `execute_metered_time_ms` |  9 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  162.72 | -          |  162.72 |  162.72 |
| `execute_preflight_insns` |  750,132.50 |  1,500,265 |  873,000 |  627,265 |
| `execute_preflight_time_ms` |  28 |  56 |  33 |  23 |
| `execute_preflight_insn_mi/s` |  37.34 | -          |  38.13 |  36.55 |
| `trace_gen_time_ms   ` |  193 |  386 |  196 |  190 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  193.50 |  387 |  210 |  177 |
| `main_trace_commit_time_ms` |  30.50 |  61 |  33 |  28 |
| `generate_perm_trace_time_ms` |  21 |  42 |  28 |  14 |
| `perm_trace_commit_time_ms` |  41.64 |  83.28 |  45.04 |  38.24 |
| `quotient_poly_compute_time_ms` |  32.44 |  64.87 |  34.27 |  30.60 |
| `quotient_poly_commit_time_ms` |  12.65 |  25.31 |  13.45 |  11.86 |
| `pcs_opening_time_ms ` |  52.50 |  105 |  67 |  38 |
...
| --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 437 | 1 | 9 | 1,500,265 | 162.72 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 190 | 603 | 84,399,632 | 190 | 210 | 0 | 34.27 | 13.45 | 4 | 45.04 | 67 | 60 | 67 | 0 | 33 | 14 | 33 | 873,000 | 38.13 | 14 | 48 | 0 | 67 | 
| fibonacci_program | 1 | 196 | 437 | 74,305,770 | 196 | 177 | 1 | 30.60 | 11.86 | 4 | 38.24 | 38 | 67 | 37 | 0 | 28 | 28 | 23 | 627,265 | 36.55 | 11 | 42 | 0 | 37 | 

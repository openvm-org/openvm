...
|:---|---:|---:|---:|
| Total |  1.57 |  0.96 | 0.96 |
| pairing |  1.57 |  0.96 |  0.96 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  754 |  1,508 |  897 |  611 |
...
| `execute_preflight_insn_mi/s` |  14.51 | -          |  18.02 |  11.01 |
| `trace_gen_time_ms   ` |  181.50 |  363 |  201 |  162 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  381.50 |  763 |  443 |  320 |
| `main_trace_commit_time_ms` |  64 |  128 |  75 |  53 |
| `generate_perm_trace_time_ms` |  70 |  140 |  89 |  51 |
| `perm_trace_commit_time_ms` |  77.10 |  154.21 |  89.26 |  64.95 |
| `quotient_poly_compute_time_ms` |  84.76 |  169.53 |  95.54 |  73.98 |
| `quotient_poly_commit_time_ms` |  17.39 |  34.78 |  19.61 |  15.17 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 611 | 1 | 67 | 1,745,757 | 25.74 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 162 | 897 | 172,558,444 | 162 | 443 | 0 | 95.54 | 19.61 | 6 | 89.26 | 71 | 180 | 70 | 1 | 75 | 89 | 123 | 1,151,000 | 11.01 | 27 | 115 | 1 | 70 | 
| pairing | 1 | 201 | 611 | 119,958,502 | 201 | 320 | 1 | 73.98 | 15.17 | 6 | 64.95 | 57 | 119 | 57 | 0 | 53 | 51 | 47 | 594,757 | 18.02 | 21 | 89 | 1 | 57 | 

...
|:---|---:|---:|---:|
| Total |  1.03 |  0.58 | 0.58 |
| fibonacci_program |  1.03 |  0.58 |  0.58 |


| fibonacci_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  509 |  1,018 |  575 |  443 |
| `execute_metered_time_ms` |  9 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  164.54 | -          |  164.54 |  164.54 |
| `execute_preflight_insns` |  750,132.50 |  1,500,265 |  873,000 |  627,265 |
| `execute_preflight_time_ms` |  27.50 |  55 |  33 |  22 |
| `execute_preflight_insn_mi/s` |  37.43 | -          |  37.60 |  37.26 |
| `trace_gen_time_ms   ` |  190 |  380 |  195 |  185 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  186 |  372 |  188 |  184 |
| `main_trace_commit_time_ms` |  30.50 |  61 |  33 |  28 |
| `generate_perm_trace_time_ms` |  21 |  42 |  28 |  14 |
| `perm_trace_commit_time_ms` |  41.28 |  82.56 |  45.17 |  37.39 |
| `quotient_poly_compute_time_ms` |  31.14 |  62.29 |  34.35 |  27.94 |
| `quotient_poly_commit_time_ms` |  12.74 |  25.49 |  13.12 |  12.37 |
...
| --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 443 | 1 | 9 | 1,500,265 | 164.54 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 185 | 575 | 84,399,632 | 184 | 188 | 0 | 34.35 | 13.12 | 4 | 45.17 | 46 | 60 | 46 | 0 | 33 | 14 | 33 | 873,000 | 37.26 | 14 | 47 | 0 | 46 | 
| fibonacci_program | 1 | 195 | 443 | 74,305,770 | 195 | 184 | 1 | 27.94 | 12.37 | 4 | 37.39 | 49 | 66 | 49 | 0 | 28 | 28 | 22 | 627,265 | 37.60 | 11 | 40 | 0 | 49 | 

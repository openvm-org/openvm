...
|:---|---:|---:|---:|
| Total |  2.38 |  0.73 | 0.73 |
| regex_program |  2.38 |  0.73 |  0.73 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  585 |  2,340 |  695 |  537 |
...
| `execute_preflight_insn_mi/s` |  31.45 | -          |  31.66 |  31.04 |
| `trace_gen_time_ms   ` |  179.25 |  717 |  200 |  171 |
| `memory_finalize_time_ms` |  1.25 |  5 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  285.50 |  1,142 |  297 |  275 |
| `main_trace_commit_time_ms` |  52.25 |  209 |  57 |  50 |
| `generate_perm_trace_time_ms` |  26.25 |  105 |  33 |  20 |
| `perm_trace_commit_time_ms` |  63.92 |  255.67 |  71.40 |  54.09 |
| `quotient_poly_compute_time_ms` |  58.75 |  235.01 |  66.48 |  53.36 |
| `quotient_poly_commit_time_ms` |  15.77 |  63.08 |  18.72 |  13.92 |
| `pcs_opening_time_ms ` |  65.75 |  263 |  82 |  56 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 555 | 1 | 36 | 4,137,600 | 112.98 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 171 | 695 | 150,778,428 | 171 | 297 | 0 | 60.87 | 18.72 | 5 | 71.40 | 56 | 102 | 56 | 4 | 57 | 30 | 57 | 1,103,000 | 31.04 | 22 | 80 | 1 | 56 | 
| regex_program | 1 | 172 | 553 | 128,513,066 | 172 | 292 | 1 | 54.29 | 15.06 | 4 | 65.59 | 82 | 88 | 81 | 1 | 51 | 22 | 47 | 1,104,000 | 31.54 | 16 | 69 | 0 | 81 | 
| regex_program | 2 | 174 | 537 | 128,513,066 | 174 | 275 | 1 | 53.36 | 15.38 | 4 | 64.59 | 56 | 98 | 55 | 0 | 51 | 33 | 46 | 1,104,000 | 31.66 | 17 | 69 | 0 | 55 | 
| regex_program | 3 | 200 | 555 | 103,473,675 | 200 | 278 | 0 | 66.48 | 13.92 | 5 | 54.09 | 69 | 77 | 68 | 0 | 50 | 20 | 35 | 826,600 | 31.56 | 19 | 81 | 1 | 68 | 

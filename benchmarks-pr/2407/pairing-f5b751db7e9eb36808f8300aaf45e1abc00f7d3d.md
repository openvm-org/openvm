...
| `total_proof_time_ms ` |  713 |  1,426 |  832 |  594 |
...
| `execute_preflight_time_ms` |  85 |  170 |  122 |  48 |
| `execute_preflight_insn_mi/s` |  14.57 | -          |  18.06 |  11.09 |
| `trace_gen_time_ms   ` |  184 |  368 |  203 |  165 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  338.50 |  677 |  376 |  301 |
| `main_trace_commit_time_ms` |  64.50 |  129 |  74 |  55 |
| `generate_perm_trace_time_ms` |  32 |  64 |  35 |  29 |
| `perm_trace_commit_time_ms` |  74.88 |  149.77 |  84.33 |  65.44 |
| `quotient_poly_compute_time_ms` |  82.83 |  165.67 |  90.78 |  74.89 |
| `quotient_poly_commit_time_ms` |  17.88 |  35.76 |  20.08 |  15.68 |
| `pcs_opening_time_ms ` |  62 |  124 |  67 |  57 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 594 | 1 | 67 | 1,745,757 | 25.76 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 165 | 832 | 172,558,444 | 165 | 376 | 0 | 90.78 | 20.08 | 6 | 84.33 | 67 | 122 | 66 | 1 | 74 | 35 | 122 | 1,151,000 | 11.09 | 27 | 111 | 1 | 66 | 
| pairing | 1 | 203 | 594 | 119,958,502 | 203 | 301 | 1 | 74.89 | 15.68 | 6 | 65.44 | 57 | 97 | 57 | 0 | 55 | 29 | 48 | 594,757 | 18.06 | 21 | 91 | 1 | 57 | 

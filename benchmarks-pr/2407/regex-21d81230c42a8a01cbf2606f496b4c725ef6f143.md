...
|:---|---:|---:|---:|
| Total |  2.42 |  0.73 | 0.73 |
| regex_program |  2.42 |  0.73 |  0.73 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  595.75 |  2,383 |  698 |  533 |
| `execute_metered_time_ms` |  35 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  115.32 | -          |  115.32 |  115.32 |
| `execute_preflight_insns` |  1,034,400 |  4,137,600 |  1,104,000 |  826,600 |
| `execute_preflight_time_ms` |  46 |  184 |  58 |  35 |
| `execute_preflight_insn_mi/s` |  31.40 | -          |  32.05 |  30.43 |
| `trace_gen_time_ms   ` |  183 |  732 |  203 |  172 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  292 |  1,168 |  329 |  266 |
| `main_trace_commit_time_ms` |  52.25 |  209 |  59 |  49 |
| `generate_perm_trace_time_ms` |  29.25 |  117 |  46 |  22 |
| `perm_trace_commit_time_ms` |  65.24 |  260.96 |  73.20 |  52.69 |
| `quotient_poly_compute_time_ms` |  60.41 |  241.62 |  69.12 |  54.63 |
| `quotient_poly_commit_time_ms` |  15.78 |  63.11 |  18.13 |  13.51 |
| `pcs_opening_time_ms ` |  65.50 |  262 |  93 |  52 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 609 | 1 | 35 | 4,137,600 | 115.32 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 172 | 698 | 150,778,428 | 172 | 296 | 0 | 61.99 | 18.13 | 6 | 73.20 | 56 | 99 | 56 | 4 | 59 | 25 | 58 | 1,103,000 | 30.43 | 22 | 80 | 1 | 56 | 
| regex_program | 1 | 178 | 533 | 128,513,066 | 178 | 266 | 1 | 54.63 | 15.45 | 4 | 66.19 | 52 | 91 | 52 | 0 | 51 | 24 | 46 | 1,104,000 | 31.56 | 17 | 70 | 0 | 52 | 
| regex_program | 2 | 179 | 543 | 128,513,066 | 179 | 277 | 1 | 55.89 | 16.02 | 4 | 68.88 | 61 | 92 | 61 | 0 | 50 | 22 | 45 | 1,104,000 | 32.05 | 17 | 72 | 0 | 61 | 
| regex_program | 3 | 203 | 609 | 103,473,675 | 203 | 329 | 0 | 69.12 | 13.51 | 5 | 52.69 | 93 | 102 | 92 | 0 | 49 | 46 | 35 | 826,600 | 31.57 | 18 | 83 | 1 | 92 | 

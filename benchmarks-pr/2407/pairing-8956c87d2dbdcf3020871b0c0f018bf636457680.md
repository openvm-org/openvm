...
| `total_proof_time_ms ` |  714.50 |  1,429 |  840 |  589 |
...
| `execute_preflight_insn_mi/s` |  14.43 | -          |  17.89 |  10.97 |
| `trace_gen_time_ms   ` |  179.50 |  359 |  201 |  158 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  343 |  686 |  388 |  298 |
| `main_trace_commit_time_ms` |  64.50 |  129 |  74 |  55 |
| `generate_perm_trace_time_ms` |  32 |  64 |  35 |  29 |
| `perm_trace_commit_time_ms` |  76.01 |  152.01 |  88.09 |  63.93 |
| `quotient_poly_compute_time_ms` |  82.28 |  164.57 |  90.83 |  73.74 |
| `quotient_poly_commit_time_ms` |  16.37 |  32.74 |  18 |  14.74 |
| `pcs_opening_time_ms ` |  67 |  134 |  77 |  57 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 589 | 1 | 67 | 1,745,757 | 25.91 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 158 | 840 | 172,558,444 | 158 | 388 | 0 | 90.83 | 18 | 6 | 88.09 | 77 | 125 | 77 | 1 | 74 | 35 | 124 | 1,151,000 | 10.97 | 26 | 109 | 1 | 77 | 
| pairing | 1 | 201 | 589 | 119,958,502 | 201 | 298 | 1 | 73.74 | 14.74 | 6 | 63.93 | 57 | 95 | 57 | 0 | 55 | 29 | 48 | 594,757 | 17.89 | 21 | 89 | 1 | 57 | 

...
| `total_proof_time_ms ` |  725 |  1,450 |  835 |  615 |
| `execute_metered_time_ms` |  68 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  25.65 | -          |  25.65 |  25.65 |
| `execute_preflight_insns` |  872,878.50 |  1,745,757 |  1,151,000 |  594,757 |
| `execute_preflight_time_ms` |  85.50 |  171 |  123 |  48 |
| `execute_preflight_insn_mi/s` |  14.48 | -          |  17.90 |  11.06 |
| `trace_gen_time_ms   ` |  182 |  364 |  204 |  160 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  351 |  702 |  381 |  321 |
| `main_trace_commit_time_ms` |  65 |  130 |  75 |  55 |
| `generate_perm_trace_time_ms` |  41.50 |  83 |  48 |  35 |
| `perm_trace_commit_time_ms` |  76.71 |  153.41 |  89.05 |  64.36 |
| `quotient_poly_compute_time_ms` |  84.29 |  168.57 |  93.31 |  75.26 |
| `quotient_poly_commit_time_ms` |  17.37 |  34.73 |  18.88 |  15.86 |
| `pcs_opening_time_ms ` |  62 |  124 |  66 |  58 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 615 | 1 | 68 | 1,745,757 | 25.65 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 160 | 835 | 172,558,444 | 160 | 381 | 0 | 93.31 | 18.88 | 6 | 89.05 | 66 | 127 | 65 | 1 | 75 | 35 | 123 | 1,151,000 | 11.06 | 27 | 113 | 1 | 65 | 
| pairing | 1 | 204 | 615 | 119,958,502 | 204 | 321 | 1 | 75.26 | 15.86 | 6 | 64.36 | 58 | 115 | 58 | 0 | 55 | 48 | 48 | 594,757 | 17.90 | 21 | 91 | 1 | 58 | 

...
|:---|---:|---:|
| Total |  13.78 |  7.75 |
| regex_program |  13.78 |  7.75 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  6,888.50 |  13,777 |  7,751 |  6,026 |
...
| `trace_gen_time_ms   ` | <span style='color: red'>(+4 [+0.3%])</span> 1,078 | <span style='color: red'>(+7 [+0.3%])</span> 2,156 | <span style='color: red'>(+6 [+0.5%])</span> 1,236 | <span style='color: red'>(+1 [+0.1%])</span> 920 |
| `stark_prove_excluding_trace_time_ms` |  5,372 |  10,744 |  6,043 | <span style='color: red'>(+8 [+0.2%])</span> 4,701 |
| `main_trace_commit_time_ms` | <span style='color: red'>(+28 [+2.7%])</span> 1,047 | <span style='color: red'>(+55 [+2.7%])</span> 2,094 | <span style='color: red'>(+9 [+0.7%])</span> 1,270 | <span style='color: red'>(+46 [+5.9%])</span> 824 |
| `generate_perm_trace_time_ms` | <span style='color: red'>(+2 [+1.2%])</span> 168 | <span style='color: red'>(+4 [+1.2%])</span> 336 | <span style='color: red'>(+6 [+3.2%])</span> 193 | <span style='color: green'>(-2 [-1.4%])</span> 143 |
| `perm_trace_commit_time_ms` | <span style='color: red'>(+7 [+0.6%])</span> 1,145 | <span style='color: red'>(+14 [+0.6%])</span> 2,290 | <span style='color: green'>(-5 [-0.4%])</span> 1,197 | <span style='color: red'>(+19 [+1.8%])</span> 1,093 |
| `quotient_poly_compute_time_ms` | <span style='color: green'>(-9 [-1.2%])</span> 740 | <span style='color: green'>(-18 [-1.2%])</span> 1,480 | <span style='color: green'>(-6 [-0.7%])</span> 861 | <span style='color: green'>(-12 [-1.9%])</span> 619 |
| `quotient_poly_commit_time_ms` | <span style='color: green'>(-9 [-0.9%])</span> 939 | <span style='color: green'>(-18 [-0.9%])</span> 1,878 | <span style='color: green'>(-2 [-0.2%])</span> 1,093 | <span style='color: green'>(-16 [-2.0%])</span> 785 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+2 [+0.1%])</span> 1,320 | <span style='color: red'>(+3 [+0.1%])</span> 2,640 |  1,420 | <span style='color: red'>(+3 [+0.2%])</span> 1,220 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,236 | 7,751 |  | 209,921,543 | 6,043 | 861 | 1,093 | 1,197 | 1,420 | 1,270 | 92,686,348 | 193 | 472 | 
| regex_program | 1 | 920 | 6,026 | 1,914,103 | 149,454,692 | 4,701 | 619 | 785 | 1,093 | 1,220 | 824 | 72,769,025 | 143 | 405 | 

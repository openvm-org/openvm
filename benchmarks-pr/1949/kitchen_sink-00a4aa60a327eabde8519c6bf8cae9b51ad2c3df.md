...
| leaf |  21.16 |  21.16 |
| internal.0 |  4.98 |  4.98 |
| root |  38.53 |  38.53 |
| halo2_outer |  91.68 |  91.68 |
...
| `total_proof_time_ms ` |  14,451 |  14,451 |  14,451 |  14,451 |
...
| `main_trace_commit_time_ms` |  4,519 |  4,519 |  4,519 |  4,519 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  21,156 |  21,156 |  21,156 |  21,156 |
| `main_cells_used     ` |  769,363,454 |  769,363,454 |  769,363,454 |  769,363,454 |
| `total_cells_used    ` |  2,050,268,876 |  2,050,268,876 |  2,050,268,876 |  2,050,268,876 |
| `insns               ` |  7,904,009 |  7,904,009 |  7,904,009 |  7,904,009 |
| `execute_preflight_time_ms` |  1,339 |  1,339 |  1,339 |  1,339 |
...
| `generate_perm_trace_time_ms` |  1,607 |  1,607 |  1,607 |  1,607 |
| `perm_trace_commit_time_ms` |  4,804 |  4,804 |  4,804 |  4,804 |
| `quotient_poly_compute_time_ms` |  2,133 |  2,133 |  2,133 |  2,133 |
| `quotient_poly_commit_time_ms` |  1,313 |  1,313 |  1,313 |  1,313 |
| `pcs_opening_time_ms ` |  4,575 |  4,575 |  4,575 |  4,575 |

| internal.0 |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  4,978 |  4,978 |  4,978 |  4,978 |
| `main_cells_used     ` |  79,526,631 |  79,526,631 |  79,526,631 |  79,526,631 |
| `total_cells_used    ` |  143,462,909 |  143,462,909 |  143,462,909 |  143,462,909 |
...
| `stark_prove_excluding_trace_time_ms` |  4,303 |  4,303 |  4,303 |  4,303 |
...
| `main_cells_used     ` |  41,517,330 |  41,517,330 |  41,517,330 |  41,517,330 |
| `total_cells_used    ` |  64,199,188 |  64,199,188 |  64,199,188 |  64,199,188 |
| `insns               ` |  772,500 |  772,500 |  772,500 |  772,500 |
...
| `stark_prove_excluding_trace_time_ms` |  38,247 |  38,247 |  38,247 |  38,247 |
...
| `quotient_poly_commit_time_ms` |  13,659 |  13,659 |  13,659 |  13,659 |
| `pcs_opening_time_ms ` |  3,892 |  3,892 |  3,892 |  3,892 |

| halo2_outer |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  91,684 |  91,684 |  91,684 |  91,684 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
|  | 115 | 64,199,188 | 115 | 0 | 91,698 | 44,373 | 8 | 41,517,330 | 772,500 | 297 | 5.41 | 14,752 | 39,597 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| halo2_outer | 91,684 |  |  |  |  |  | 65,627,358 |  |  |  |  |  | 
| halo2_wrapper | 44,373 |  |  |  |  |  |  |  |  |  |  |  | 
| internal.0 |  |  | 6,030 |  | 3 |  |  |  | 2 |  |  |  | 
| kitchen_sink |  |  |  | 14,700 |  | 6 |  | 153,644 | 1 | 10 | 14.62 | 36 | 
| leaf |  | 22,266 |  |  | 1 |  |  |  | 1 |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal.0 | 0 | 180 | 4,978 | 143,462,909 | 224,975,330 | 180 | 4,303 | 0 | 611 | 686 | 658 | 1,235 | 9 | 913 | 79,526,631 | 1,197,715 | 193 |  | 495 | 3.52 | 
| leaf | 0 | 1,626 | 21,156 | 2,050,268,876 | 2,500,267,498 | 1,626 | 18,191 | 0 | 2,133 | 1,313 | 4,804 | 4,575 | 19 | 3,752 | 769,363,454 | 7,904,009 | 1,607 |  | 1,339 | 6.85 | 
| root | 0 | 115 | 38,527 | 64,199,188 | 80,435,354 | 115 | 38,247 | 0 | 717 | 13,659 | 7,578 | 3,892 | 8 | 12,307 | 41,517,330 | 772,500 | 88 | 3 | 165 | 5.13 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| kitchen_sink | 0 | 211 | 14,451 | 1,226,975,002 | 1,481,193,346 | 211 | 14,137 | 3 | 6,250 | 284 | 1,363 | 1,214 | 6 | 3 | 4,519 | 904,738,232 | 153,644 | 462 | 103 | 7.38 | 

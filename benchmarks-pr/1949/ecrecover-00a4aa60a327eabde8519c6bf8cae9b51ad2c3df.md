...
|:---|---:|---:|
| Total |  10.94 |  10.94 |
| ecrecover_program | <span style='color: green'>(-0 [-0.2%])</span> 1.14 | <span style='color: green'>(-0 [-0.2%])</span> 1.14 |
| leaf |  9.79 |  9.79 |
...
| `total_proof_time_ms ` | <span style='color: green'>(-2 [-0.2%])</span> 1,143 | <span style='color: green'>(-2 [-0.2%])</span> 1,143 | <span style='color: green'>(-2 [-0.2%])</span> 1,143 | <span style='color: green'>(-2 [-0.2%])</span> 1,143 |
...
| `execute_metered_insn_mi/s` | <span style='color: red'>(+0 [+0.5%])</span> 20.58 | -          | <span style='color: red'>(+0 [+0.5%])</span> 20.58 | <span style='color: red'>(+0 [+0.5%])</span> 20.58 |
| `execute_preflight_time_ms` | <span style='color: red'>(+1 [+1.3%])</span> 80 | <span style='color: red'>(+1 [+1.3%])</span> 80 | <span style='color: red'>(+1 [+1.3%])</span> 80 | <span style='color: red'>(+1 [+1.3%])</span> 80 |
| `execute_preflight_insn_mi/s` | <span style='color: green'>(-0 [-0.8%])</span> 1.84 | -          | <span style='color: green'>(-0 [-0.8%])</span> 1.84 | <span style='color: green'>(-0 [-0.8%])</span> 1.84 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+2 [+2.2%])</span> 95 | <span style='color: red'>(+2 [+2.2%])</span> 95 | <span style='color: red'>(+2 [+2.2%])</span> 95 | <span style='color: red'>(+2 [+2.2%])</span> 95 |
| `memory_finalize_time_ms` |  1 |  1 |  1 |  1 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: green'>(-5 [-0.5%])</span> 968 | <span style='color: green'>(-5 [-0.5%])</span> 968 | <span style='color: green'>(-5 [-0.5%])</span> 968 | <span style='color: green'>(-5 [-0.5%])</span> 968 |
| `main_trace_commit_time_ms` | <span style='color: red'>(+5 [+3.6%])</span> 143 | <span style='color: red'>(+5 [+3.6%])</span> 143 | <span style='color: red'>(+5 [+3.6%])</span> 143 | <span style='color: red'>(+5 [+3.6%])</span> 143 |
...
| `perm_trace_commit_time_ms` | <span style='color: green'>(-15 [-9.8%])</span> 138 | <span style='color: green'>(-15 [-9.8%])</span> 138 | <span style='color: green'>(-15 [-9.8%])</span> 138 | <span style='color: green'>(-15 [-9.8%])</span> 138 |
...
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+5 [+3.8%])</span> 137 | <span style='color: red'>(+5 [+3.8%])</span> 137 | <span style='color: red'>(+5 [+3.8%])</span> 137 | <span style='color: red'>(+5 [+3.8%])</span> 137 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+3 [+0.7%])</span> 423 | <span style='color: red'>(+3 [+0.7%])</span> 423 | <span style='color: red'>(+3 [+0.7%])</span> 423 | <span style='color: red'>(+3 [+0.7%])</span> 423 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  9,788 |  9,788 |  9,788 |  9,788 |
| `main_cells_used     ` |  247,226,658 |  247,226,658 |  247,226,658 |  247,226,658 |
| `total_cells_used    ` |  646,606,852 |  646,606,852 |  646,606,852 |  646,606,852 |
| `insns               ` |  2,934,910 |  2,934,910 |  2,934,910 |  2,934,910 |
...
| `stark_prove_excluding_trace_time_ms` |  8,601 |  8,601 |  8,601 |  8,601 |
| `main_trace_commit_time_ms` |  1,657 |  1,657 |  1,657 |  1,657 |
| `generate_perm_trace_time_ms` |  785 |  785 |  785 |  785 |
| `perm_trace_commit_time_ms` |  2,310 |  2,310 |  2,310 |  2,310 |
| `quotient_poly_compute_time_ms` |  908 |  908 |  908 |  908 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program |  | 1,395 |  | 6 | 140,487 | 1 | 6 | 20.58 | 39 | 
| leaf | 10,888 |  | 1 |  |  | 1 |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 621 | 9,788 | 646,606,852 | 992,054,762 | 621 | 8,601 | 0 | 908 | 697 | 2,310 | 2,239 | 15 | 1,657 | 247,226,658 | 2,934,910 | 785 | 566 | 5.44 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 95 | 1,143 | 26,518,220 | 32,927,986 | 95 | 968 | 0 | 79 | 137 | 138 | 423 | 7 | 1 | 143 | 8,866,654 | 140,487 | 31 | 80 | 1.84 | 

...
|:---|---:|---:|---:|
| Total |  16.59 |  4.93 |  4.93 |
| app_proof |  13.54 |  2.65 |  2.65 |
| leaf |  2.20 |  1.43 |  1.43 |
...
| `total_proof_time_ms ` |  2,234.17 |  13,405 |  2,517 |  2,145 |
...
| `execute_preflight_time_ms` |  250.50 |  1,503 |  341 |  91 |
| `execute_preflight_insn_mi/s` |  33.18 | -          |  33.95 |  30.77 |
| `trace_gen_time_ms   ` |  52.83 |  317 |  148 |  33 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,867.33 |  11,204 |  2,106 |  1,815 |
| `prover.main_trace_commit_time_ms` |  704.17 |  4,225 |  872 |  670 |
| `prover.rap_constraints_time_ms` |  978.50 |  5,871 |  1,047 |  960 |
| `prover.openings_time_ms` |  183.33 |  1,100 |  186 |  180 |
| `prover.rap_constraints.logup_gkr_time_ms` |  165.67 |  994 |  223 |  154 |
| `prover.rap_constraints.round0_time_ms` |  507.17 |  3,043 |  513 |  499 |
| `prover.rap_constraints.mle_rounds_time_ms` |  304.50 |  1,827 |  324 |  300 |
| `prover.openings.stacked_reduction_time_ms` |  141.17 |  847 |  144 |  140 |
| `prover.openings.stacked_reduction.round0_time_ms` |  81.67 |  490 |  83 |  81 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  59.50 |  357 |  61 |  58 |
| `prover.openings.whir_time_ms` |  41.33 |  248 |  44 |  39 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,100.50 |  2,201 |  1,427 |  774 |
| `execute_preflight_time_ms` |  5.50 |  11 |  6 |  5 |
| `trace_gen_time_ms   ` |  139.50 |  279 |  186 |  93 |
| `generate_blob_total_time_ms` |  24.50 |  49 |  33 |  16 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  960 |  1,920 |  1,240 |  680 |
| `prover.main_trace_commit_time_ms` |  542.50 |  1,085 |  713 |  372 |
| `prover.rap_constraints_time_ms` |  313.50 |  627 |  403 |  224 |
| `prover.openings_time_ms` |  103 |  206 |  123 |  83 |
| `prover.rap_constraints.logup_gkr_time_ms` |  66.50 |  133 |  83 |  50 |
| `prover.rap_constraints.round0_time_ms` |  152 |  304 |  198 |  106 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/516acf2b605bae3d10df65329981fd27dcceb188/keccak-516acf2b605bae3d10df65329981fd27dcceb188.memory.svg)
...
| app_proof |  |  |  |  |  | 2,145 |  |  | 138 | 14,365,133 | 103.70 | 0 | 13,552 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 42 | 515 | 41 | 14 | 4 | 2 | 2 | 2 | 
| internal_recursive.0 | 1 | 14 | 184 | 14 | 2 | 1 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 10 | 149 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 186 | 1,427 | 186 | 65 | 33 | 6 | 7 | 8 | 
| leaf | 1 | 93 | 774 | 93 | 32 | 16 | 5 | 8 | 8 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 109,497,984 | 473 | 242 | 0 | 14 | 174 | 48 | 47 | 92 | 33 | 0 | 56 | 18 | 38 | 7 | 30 | 242 | 174 | 0 | 2 | 32 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 25,962,119 | 169 | 50 | 0 | 3 | 76 | 24 | 24 | 29 | 22 | 0 | 41 | 17 | 23 | 2 | 21 | 51 | 76 | 0 | 2 | 21 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 17,507,975 | 138 |
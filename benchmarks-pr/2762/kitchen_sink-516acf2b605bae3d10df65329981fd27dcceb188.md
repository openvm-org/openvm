...
|:---|---:|---:|---:|
| Total |  2.90 |  2.13 |  2.13 |
| app_proof |  2.09 |  1.32 |  1.32 |
| leaf |  0.43 |  0.43 |  0.43 |
...
| `total_proof_time_ms ` |  1,035 |  2,070 |  1,297 |  773 |
...
| `execute_preflight_time_ms` |  91.50 |  183 |  129 |  54 |
| `execute_preflight_insn_mi/s` |  31.96 | -          |  32.87 |  31.05 |
| `trace_gen_time_ms   ` |  29.50 |  59 |  43 |  16 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  799.50 |  1,599 |  1,012 |  587 |
| `prover.main_trace_commit_time_ms` |  224.50 |  449 |  300 |  149 |
| `prover.rap_constraints_time_ms` |  510.50 |  1,021 |  635 |  386 |
| `prover.openings_time_ms` |  63.50 |  127 |  76 |  51 |
| `prover.rap_constraints.logup_gkr_time_ms` |  147 |  294 |  162 |  132 |
| `prover.rap_constraints.round0_time_ms` |  260 |  520 |  343 |  177 |
| `prover.rap_constraints.mle_rounds_time_ms` |  102.50 |  205 |  129 |  76 |
| `prover.openings.stacked_reduction_time_ms` |  50.50 |  101 |  62 |  39 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/516acf2b605bae3d10df65329981fd27dcceb188/kitchen_sink-516acf2b605bae3d10df65329981fd27dcceb188.memory.svg)

| Module | Max (GB) | Max At |
| --- | ---: | --- |
| prover.rap_constraints | 10.23 | app_proof.prover.0 |
| prover.batch_constraints.before_round0 | 9.30 | app_proof.prover.0 |
| frac_sumcheck.gkr_rounds | 9.30 | app_proof.prover.0 |
| prover.gkr_input_evals | 9.23 | app_proof.prover.0 |
| frac_sumcheck.segment_tree | 9.23 | app_proof.prover.0 |
...
| prover.batch_constraints.fold_ple_evals | 8.62 | app_proof.prover.0 |
| prover.batch_constraints.round0 | 8.62 | app_proof.prover.0 |
...
| VmAirWrapper<Rv64IsEqualModAdapterAir<2, 6, 8, 48>, ModularIsEqualCoreAir<48, 8, 8> | 65 | 314 | 3 | 
...
| VmAirWrapper<Rv64VecHeapAdapterAir<1, 12, 12, 8, 8>, FieldExpressionCoreAir> | 880 | 513 | 3 | 
| VmAirWrapper<Rv64VecHeapAdapterAir<1, 8, 8, 8, 8>, FieldExpressionCoreAir> | 463 | 280 | 3 | 
| VmAirWrapper<Rv64VecHeapAdapterAir<2, 12, 12, 8, 8>, FieldExpressionCoreAir> | 740 | 381 | 3 | 
| VmAirWrapper<Rv64VecHeapAdapterAir<2, 4, 4, 8, 8>, 2, 4, 4, 8, 32, 32>, BaseAluCoreAir<32, 8> | 97 | 85 | 3 | 
| VmAirWrapper<Rv64VecHeapAdapterAir<2, 4, 4, 8, 8>, 2, 4, 4, 8, 32, 32>, LessThanCoreAir<32, 8> | 67 | 119 | 3 | 
| VmAirWrapper<Rv64VecHeapAdapterAir<2, 4, 4, 8, 8>, 2, 4, 4, 8, 32, 32>, MultiplicationCoreAir<32, 8> | 97 | 16 | 2 | 
| VmAirWrapper<Rv64VecHeapAdapterAir<2, 4, 4, 8, 8>, 2, 4, 4, 8, 32, 32>, ShiftCoreAir<32, 8> | 115 | 2,127 | 3 | 
| VmAirWrapper<Rv64VecHeapAdapterAir<2, 4, 4, 8, 8>, FieldExpressionCoreAir> | 218 | 117 | 3 | 
| VmAirWrapper<Rv64VecHeapAdapterAir<2, 6, 6, 8, 8>, FieldExpressionCoreAir> | 282 | 171 | 3 | 
| VmAirWrapper<Rv64VecHeapAdapterAir<2, 8, 8, 8, 8>, FieldExpressionCoreAir> | 500 | 257 | 3 | 
| VmAirWrapper<Rv64VecHeapBranchAdapterAir<2, 4, 8>, 2, 4, 8, 32>, BranchEqualCoreAir<32> | 44 | 47 | 3 | 
| VmAirWrapper<Rv64VecHeapBranchAdapterAir<2, 4, 8>, 2, 4, 8, 32>, BranchLessThanCoreAir<32, 8> | 46 | 117 | 3 | 
...
| app_proof |  |  |  |  |  | 773 |  |  | 23 | 1,979,971 | 83.69 | 0 | 2,098 |  | 
...
| leaf | 19 | ProofShapeAir<4, 8> | 0 | prover | 256 | 48 | 91,136 | 
...
| app_proof | 10 | VmAirWrapper<Rv64VecHeapAdapterAir<1, 8, 8, 8, 8>, FieldExpressionCoreAir> | prover | 0 | 4 | 583 | 9,740 | 
| app_proof | 11 | VmAirWrapper<Rv64VecHeapAdapterAir<2, 8, 8, 8, 8>, FieldExpressionCoreAir> | prover | 0 | 1 | 679 | 2,679 | 
| app_proof | 12 | VmAirWrapper<Rv64VecHeapAdapterAir<2, 12, 12, 8, 8>, FieldExpressionCoreAir> | prover | 0 | 2 | 811 | 5,998 | 
| app_proof | 13 | VmAirWrapper<Rv64VecHeapAdapterAir<2, 12, 12, 8, 8>, FieldExpressionCoreAir> | prover | 0 | 2 | 619 | 4,078 | 
| app_proof | 14 | VmAirWrapper<Rv64VecHeapAdapterAir<2, 8, 8, 8, 8>, FieldExpressionCoreAir> | prover | 0 | 2 | 551 | 4,070 | 
| app_proof | 15 | VmAirWrapper<Rv64VecHeapAdapterAir<2, 8, 8, 8, 8>, FieldExpressionCoreAir> | prover | 0 | 2 | 423 | 2,790 | 
| app_proof | 16 | VmAirWrapper<Rv64IsEqualModAdapterAir<2, 4, 8, 32>, ModularIsEqualCoreAir<32, 8, 8> | prover | 0 | 4 | 188 | 1,536 | 
| app_proof | 17 | VmAirWrapper<Rv64VecHeapAdapterAir<2, 4, 4, 8, 8>, FieldExpressionCoreAir> | prover | 0 | 64 | 314 | 75,904 | 
| app_proof | 18 | VmAirWrapper<Rv64VecHeapAdapterAir<2, 4, 4, 8, 8>, FieldExpressionCoreAir> | prover | 0 | 64 | 250 | 55,424 | 
| app_proof | 19 | VmAirWrapper<Rv64IsEqualModAdapterAir<2, 4, 8, 32>, ModularIsEqualCoreAir<32, 8, 8> | prover | 0 | 2 | 188 | 768 | 
| app_proof | 2 | PersistentBoundaryAir<8> | prover | 0 | 8,192 | 20 | 262,144 | 
| app_proof | 20 | VmAirWrapper<Rv64VecHeapAdapterAir<2, 4, 4, 8, 8>, FieldExpressionCoreAir> | prover | 0 | 2 | 290 | 2,132 | 
| app_proof | 21 | VmAirWrapper<Rv64VecHeapAdapterAir<2, 4, 4, 8, 8>, FieldExpressionCoreAir> | prover | 0 | 2 | 226 | 1,492 | 
| app_proof | 22 | VmAirWrapper<Rv64IsEqualModAdapterAir<2, 6, 8, 48>, ModularIsEqualCoreAir<48, 8, 8> | prover | 0 | 8 | 264 | 4,192 | 
| app_proof | 23 | VmAirWrapper<Rv64VecHeapAdapterAir<2, 6, 6, 8, 8>, FieldExpressionCoreAir> | prover | 0 | 2 | 420 | 3,096 | 
| app_proof | 24 | VmAirWrapper<Rv64VecHeapAdapterAir<2, 6, 6, 8, 8>, FieldExpressionCoreAir> | prover | 0 | 4 | 324 | 4,272 | 
| app_proof | 25 | VmAirWrapper<Rv64IsEqualModAdapterAir<2, 4, 8, 32>, ModularIsEqualCoreAir<32, 8, 8> | prover | 0 | 2 | 188 | 768 | 
| app_proof | 26 | VmAirWrapper<Rv64VecHeapAdapterAir<2, 4, 4, 8, 8>, FieldExpressionCoreAir> | prover | 0 | 2 | 290 | 2,132 | 
| app_proof | 27 | VmAirWrapper<Rv64VecHeapAdapterAir<2, 4, 4, 8, 8>, FieldExpressionCoreAir> | prover | 0 | 2 | 226 | 1,492 | 
| app_proof | 28 | VmAirWrapper<Rv64IsEqualModAdapterAir<2, 4, 8, 32>, ModularIsEqualCoreAir<32, 8, 8> | prover | 0 | 8 | 188 | 3,072 | 
| app_proof | 29 | VmAirWrapper<Rv64VecHeapAdapterAir<2, 4, 4, 8, 8>, FieldExpressionCoreAir> | prover | 0 | 2 | 290 | 2,132 | 
| app_proof | 3 | MemoryMerkleAir<8> | prover | 0 | 8,192 | 32 | 393,216 | 
| app_proof | 30 | VmAirWrapper<Rv64VecHeapAdapterAir<2, 4, 4, 8, 8>, FieldExpressionCoreAir> | prover | 0 | 4 | 226 | 2,984 | 
| app_proof | 31 | VmAirWrapper<Rv64IsEqualModAdapterAir<2, 4, 8, 32>, ModularIsEqualCoreAir<32, 8, 8> | prover | 0 | 2 | 188 | 768 | 
| app_proof | 32 | VmAirWrapper<Rv64VecHeapAdapterAir<2, 4, 4, 8, 8>, FieldExpressionCoreAir> | prover | 0 | 2 | 290 | 2,132 | 
| app_proof | 33 | VmAirWrapper<Rv64VecHeapAdapterAir<2, 4, 4, 8, 8>, FieldExpressionCoreAir> | prover | 0 | 2 | 226 | 1,492 | 
| app_proof | 34 | VmAirWrapper<Rv64IsEqualModAdapterAir<2, 4, 8, 32>, ModularIsEqualCoreAir<32, 8, 8> | prover | 0 | 8 | 188 | 3,072 | 
| app_proof | 35 | VmAirWrapper<Rv64VecHeapAdapterAir<2, 4, 4, 8, 8>, FieldExpressionCoreAir> | prover | 0 | 2 | 290 | 2,132 | 
| app_proof | 36 | VmAirWrapper<Rv64VecHeapAdapterAir<2, 4, 4, 8, 8>, FieldExpressionCoreAir> | prover | 0 | 4 | 226 | 2,984 | 
| app_proof | 37 | VmAirWrapper<Rv64IsEqualModAdapterAir<2, 4, 8, 32>, ModularIsEqualCoreAir<32, 8, 8> | prover | 0 | 2 | 188 | 768 | 
| app_proof | 38 | VmAirWrapper<Rv64VecHeapAdapterAir<2, 4, 4, 8, 8>, FieldExpressionCoreAir> | prover | 0 | 2 | 290 | 2,132 | 
| app_proof | 39 | VmAirWrapper<Rv64VecHeapAdapterAir<2, 4, 4, 8, 8>, FieldExpressionCoreAir> | prover | 0 | 2 | 226 | 1,492 | 
| app_proof | 4 | VmAirWrapper<Rv64VecHeapAdapterAir<1, 12, 12, 8, 8>, FieldExpressionCoreAir> | prover | 0 | 4 | 1,056 | 18,304 | 
| app_proof | 40 | VmAirWrapper<Rv64IsEqualModAdapterAir<2, 4, 8, 32>, ModularIsEqualCoreAir<32, 8, 8> | prover | 0 | 8 | 188 | 3,072 | 
| app_proof | 41 | VmAirWrapper<Rv64VecHeapAdapterAir<2, 4, 4, 8, 8>, FieldExpressionCoreAir> | prover | 0 | 2 | 290 | 2,132 | 
| app_proof | 42 | VmAirWrapper<Rv64VecHeapAdapterAir<2, 4, 4, 8, 8>, FieldExpressionCoreAir> | prover | 0 | 4 | 226 | 2,984 | 
| app_proof | 43 | VmAirWrapper<Rv64VecHeapAdapterAir<2, 4, 4, 8, 8>, 2, 4, 4, 8, 32, 32>, ShiftCoreAir<32, 8> | prover | 0 | 512 | 268 | 372,736 | 
| app_proof | 44 | VmAirWrapper<Rv64VecHeapAdapterAir<2, 4, 4, 8, 8>, 2, 4, 4, 8, 32, 32>, MultiplicationCoreAir<32, 8> | prover | 0 | 256 | 191 | 148,224 | 
| app_proof | 46 | VmAirWrapper<Rv64VecHeapBranchAdapterAir<2, 4, 8>, 2, 4, 8, 32>, BranchEqualCoreAir<32> | prover | 0 | 256 | 142 | 81,408 | 
| app_proof | 47 | VmAirWrapper<Rv64VecHeapAdapterAir<2, 4, 4, 8, 8>, 2, 4, 4, 8, 32, 32>, LessThanCoreAir<32, 8> | prover | 0 | 256 | 196 | 118,784 | 
| app_proof | 48 | VmAirWrapper<Rv64VecHeapAdapterAir<2, 4, 4, 8, 8>, 2, 4, 4, 8, 32, 32>, BaseAluCoreAir<32, 8> | prover | 0 | 1,024 | 195 | 596,992 | 
| app_proof | 5 | VmAirWrapper<Rv64VecHeapAdapterAir<2, 12, 12, 8, 8>, FieldExpressionCoreAir> | prover | 0 | 1 | 1,003 | 3,963 | 
| app_proof | 53 | VmAirWrapper<Rv64MultAdapterAir, MultiplicationCoreAir<8, 8> | prover | 0 | 256 | 47 | 35,584 | 
| app_proof | 54 | RangeTupleCheckerAir<2> | prover | 0 | 2,097,152 | 3 | 14,680,064 | 
| app_proof | 57 | Sha2MainAir<Sha256Config> | prover | 0 | 16,384 | 236 | 9,371,648 | 
| app_proof | 58 | Sha2BlockHasherVmAir<Sha256Config> | prover | 0 | 262,144 | 456 | 149,946,368 | 
| app_proof | 59 | KeccakfOpAir | prover | 0 | 8,192 | 486 | 10,862,592 | 
| app_proof | 6 | VmAirWrapper<Rv64VecHeapAdapterAir<1, 8, 8, 8, 8>, FieldExpressionCoreAir> | prover | 0 | 4 | 583 | 9,740 | 
| app_proof | 60 | KeccakfPermAir | prover | 0 | 131,072 | 2,634 | 346,292,224 | 
| app_proof | 61 | XorinVmAir | prover | 0 | 8,192 | 741 | 17,735,680 | 
| app_proof | 63 | VmAirWrapper<Rv64RdWriteAdapterAir, Rv64AuipcCoreAir> | prover | 0 | 32,768 | 25 | 2,392,064 | 
| app_proof | 64 | VmAirWrapper<Rv64JalrAdapterAir, Rv64JalrCoreAir> | prover | 0 | 65,536 | 32 | 6,291,456 | 
| app_proof | 65 | VmAirWrapper<Rv64CondRdWriteAdapterAir, Rv64JalLuiCoreAir> | prover | 0 | 65,536 | 23 | 4,128,768 | 
| app_proof | 66 | VmAirWrapper<Rv64BranchAdapterAir, BranchLessThanCoreAir<8, 8> | prover | 0 | 65,536 | 44 | 6,291,456 | 
| app_proof | 67 | VmAirWrapper<Rv64BranchAdapterAir, BranchEqualCoreAir<8> | prover | 0 | 131,072 | 38 | 10,747,904 | 
| app_proof | 68 | VmAirWrapper<Rv64LoadStoreAdapterAir, LoadSignExtendCoreAir<8, 8> | prover | 0 | 16,384 | 48 | 1,966,080 | 
| app_proof | 69 | VmAirWrapper<Rv64LoadStoreAdapterAir, LoadStoreCoreAir<8> | prover | 0 | 524,288 | 56 | 65,011,712 | 
| app_proof | 7 | VmAirWrapper<Rv64VecHeapAdapterAir<2, 8, 8, 8, 8>, FieldExpressionCoreAir> | prover | 0 | 1 | 679 | 2,679 | 
| app_proof | 70 | VmAirWrapper<Rv64BaseAluWAdapterAir, ShiftCoreAir<4, 8> | prover | 0 | 512 | 66 | 84,992 | 
| app_proof | 71 | VmAirWrapper<Rv64BaseAluAdapterAir, ShiftCoreAir<8, 8> | prover | 0 | 65,536 | 77 | 12,910,592 | 
| app_proof | 72 | VmAirWrapper<Rv64BaseAluAdapterAir, LessThanCoreAir<8, 8> | prover | 0 | 512 | 53 | 64,000 | 
| app_proof | 73 | VmAirWrapper<Rv64BaseAluWAdapterAir, BaseAluCoreAir<4, 8> | prover | 0 | 16,384 | 49 | 2,179,072 | 
| app_proof | 74 | VmAirWrapper<Rv64BaseAluAdapterAir, BaseAluCoreAir<8, 8> | prover | 0 | 524,288 | 52 | 77,594,624 | 
| app_proof | 75 | BitwiseOperationLookupAir<8> | prover | 0 | 65,536 | 18 | 1,703,936 | 
| app_proof | 77 | Poseidon2PeripheryAir<BabyBearParameters>, 1> | prover | 0 | 4,096 | 300 | 1,245,184 | 
| app_proof | 78 | VariableRangeCheckerAir | prover | 0 | 262,144 | 4 | 2,097,152 | 
| app_proof | 8 | VmAirWrapper<Rv64VecHeapAdapterAir<1, 8, 8, 8, 8>, FieldExpressionCoreAir> | prover | 0 | 4 | 583 | 9,740 | 
| app_proof | 9 | VmAirWrapper<Rv64VecHeapAdapterAir<2, 8, 8, 8, 8>, FieldExpressionCoreAir> | prover | 0 | 1 | 679 | 2,679 | 
...
| app_proof | 43 | VmAirWrapper<Rv64VecHeapAdapterAir<2, 4, 4, 8, 8>, 2, 4, 4, 8, 32, 32>, ShiftCoreAir<32, 8> | prover | 1 | 128 | 268 | 93,184 | 
| app_proof | 44 | VmAirWrapper<Rv64VecHeapAdapterAir<2, 4, 4, 8, 8>, 2, 4, 4, 8, 32, 32>, MultiplicationCoreAir<32, 8> | prover | 1 | 64 | 191 | 37,056 | 
| app_proof | 46 | VmAirWrapper<Rv64VecHeapBranchAdapterAir<2, 4, 8>, 2, 4, 8, 32>, BranchEqualCoreAir<32> | prover | 1 | 64 | 142 | 20,352 | 
| app_proof | 47 | VmAirWrapper<Rv64VecHeapAdapterAir<2, 4, 4, 8, 8>, 2, 4, 4, 8, 32, 32>, LessThanCoreAir<32, 8> | prover | 1 | 128 | 196 | 59,392 | 
| app_proof | 48 | VmAirWrapper<Rv64VecHeapAdapterAir<2, 4, 4, 8, 8>, 2, 4, 4, 8, 32, 32>, BaseAluCoreAir<32, 8> | prover | 1 | 256 | 195 | 149,248 | 
| app_proof | 53 | VmAirWrapper<Rv64MultAdapterAir, MultiplicationCoreAir<8, 8> | prover | 1 | 64 | 47 | 8,896 | 
| app_proof | 54 | RangeTupleCheckerAir<2> | prover | 1 | 2,097,152 | 3 | 14,680,064 | 
| app_proof | 57 | Sha2MainAir<Sha256Config> | prover | 1 | 16,384 | 236 | 9,371,648 | 
| app_proof | 58 | Sha2BlockHasherVmAir<Sha256Config> | prover | 1 | 262,144 | 456 | 149,946,368 | 
| app_proof | 59 | KeccakfOpAir | prover | 1 | 4,096 | 486 | 5,431,296 | 
| app_proof | 60 | KeccakfPermAir | prover | 1 | 131,072 | 2,634 | 346,292,224 | 
| app_proof | 61 | XorinVmAir | prover | 1 | 4,096 | 741 | 8,867,840 | 
| app_proof | 63 | VmAirWrapper<Rv64RdWriteAdapterAir, Rv64AuipcCoreAir> | prover | 1 | 16,384 | 25 | 1,196,032 | 
| app_proof | 64 | VmAirWrapper<Rv64JalrAdapterAir, Rv64JalrCoreAir> | prover | 1 | 65,536 | 32 | 6,291,456 | 
| app_proof | 65 | VmAirWrapper<Rv64CondRdWriteAdapterAir, Rv64JalLuiCoreAir> | prover | 1 | 65,536 | 23 | 4,128,768 | 
| app_proof | 66 | VmAirWrapper<Rv64BranchAdapterAir, BranchLessThanCoreAir<8, 8> | prover | 1 | 65,536 | 44 | 6,291,456 | 
| app_proof | 67 | VmAirWrapper<Rv64BranchAdapterAir, BranchEqualCoreAir<8> | prover | 1 | 131,072 | 38 | 10,747,904 | 
| app_proof | 68 | VmAirWrapper<Rv64LoadStoreAdapterAir, LoadSignExtendCoreAir<8, 8> | prover | 1 | 16,384 | 48 | 1,966,080 | 
| app_proof | 69 | VmAirWrapper<Rv64LoadStoreAdapterAir, LoadStoreCoreAir<8> | prover | 1 | 262,144 | 56 | 32,505,856 | 
| app_proof | 70 | VmAirWrapper<Rv64BaseAluWAdapterAir, ShiftCoreAir<4, 8> | prover | 1 | 128 | 66 | 21,248 | 
| app_proof | 71 | VmAirWrapper<Rv64BaseAluAdapterAir, ShiftCoreAir<8, 8> | prover | 1 | 32,768 | 77 | 6,455,296 | 
| app_proof | 72 | VmAirWrapper<Rv64BaseAluAdapterAir, LessThanCoreAir<8, 8> | prover | 1 | 128 | 53 | 16,000 | 
| app_proof | 73 | VmAirWrapper<Rv64BaseAluWAdapterAir, BaseAluCoreAir<4, 8> | prover | 1 | 16,384 | 49 | 2,179,072 | 
| app_proof | 74 | VmAirWrapper<Rv64BaseAluAdapterAir, BaseAluCoreAir<8, 8> | prover | 1 | 524,288 | 52 | 77,594,624 | 
| app_proof | 75 | BitwiseOperationLookupAir<8> | prover | 1 | 65,536 | 18 | 1,703,936 | 
| app_proof | 77 | Poseidon2PeripheryAir<BabyBearParameters>, 1> | prover | 1 | 4,096 | 300 | 1,245,184 | 
| app_proof | 78 | VariableRangeCheckerAir | prover | 1 | 262,144 | 4 | 2,097,152 | 
...
| agg_keygen | ProofShapeAir<4, 8> | 77 | 86 | 4 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 53,472,003 | 138 | 40 | 0 | 4 | 65 | 20 | 19 | 29 | 15 | 0 | 32 | 9 | 23 | 1 | 21 | 40 | 65 | 0 | 1 | 15 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 23,651,975 | 103 | 19 | 0 | 4 | 52 | 17 | 17 | 20 | 13 | 0 | 31 | 9 | 22 | 1 | 21 | 19 | 52 | 0 | 1 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 17,507,975 | 95 | 14 | 0 | 4 | 50 | 18 | 17 | 18 | 13 | 0 | 30 | 8 | 21 | 0 | 20 | 15 | 50 | 0 | 1 | 12 | 0 | 0 | 
| leaf | 0 | prover | 424,647,808 | 318 | 128 | 0 | 10 | 145 | 48 | 47 | 37 | 59 | 0 | 43 | 12 | 31 | 7 | 24 | 129 | 145 | 0 | 2 | 58 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 745,984,412 | 1,012 | 300 | 0 | 170 | 635 | 343 | 342 | 129 | 162 | 65 | 76 | 13 | 62 | 15 | 46 | 300 | 635 | 0 | 1 | 95 | 0 | 0 | 
| app_proof | prover | 1 | 689,840,052 | 587 | 149 | 0 | 24 | 386 | 177 | 176 | 76 | 132 | 74 | 51 | 12 | 39 | 14 | 24 | 149 | 386 | 0 | 1 | 58 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 43 | 1,297 | 43 | 185 | 0 | 3 | 54 | 1,168,000 | 31.05 | 
| app_proof | 1 | 16 | 773 | 16 | 41 | 0 | 1 | 129 | 811,971 | 32.87 | 

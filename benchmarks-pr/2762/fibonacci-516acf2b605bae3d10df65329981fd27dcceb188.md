...
|:---|---:|---:|---:|
| Total |  3.03 |  1.77 |  1.77 |
| app_proof |  1.89 |  0.63 |  0.63 |
| leaf |  0.53 |  0.53 |  0.53 |
| internal_for_leaf |  0.29 |  0.29 |  0.29 |
...
| `total_proof_time_ms ` |  467.75 |  1,871 |  614 |  322 |
| `execute_metered_time_ms` |  20 | -          | -          | -          |
| `execute_metered_insns` |  4,000,051 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  197.77 | -          |  197.77 |  197.77 |
| `execute_preflight_insns` |  1,000,012.75 |  4,000,051 |  1,310,000 |  70,051 |
| `execute_preflight_time_ms` |  35.25 |  141 |  50 |  4 |
| `execute_preflight_insn_mi/s` |  40.30 | -          |  41.62 |  36.85 |
| `trace_gen_time_ms   ` |  175 |  700 |  201 |  159 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  183.50 |  734 |  228 |  75 |
| `prover.main_trace_commit_time_ms` |  47.75 |  191 |  59 |  16 |
| `prover.rap_constraints_time_ms` |  100.25 |  401 |  128 |  33 |
| `prover.openings_time_ms` |  34 |  136 |  40 |  25 |
| `prover.rap_constraints.logup_gkr_time_ms` |  60.50 |  242 |  77 |  16 |
...
| `prover.openings.stacked_reduction.round0_time_ms` |  4.50 |  18 |  6 |  0 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  9 |  36 |  12 |  7 |
| `prover.openings.whir_time_ms` |  19.75 |  79 |  21 |  17 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/516acf2b605bae3d10df65329981fd27dcceb188/fibonacci-516acf2b605bae3d10df65329981fd27dcceb188.memory.svg)
...
| app_proof |  |  |  |  |  | 322 |  |  | 20 | 4,000,051 | 197.77 | 0 | 1,897 |  | 
| internal_for_leaf |  |  |  | 289 |  |  |  |  |  |  |  |  |  | 289 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 53,545,731 | 271 | 117 | 0 | 7 | 108 | 33 | 32 | 50 | 24 | 0 | 44 | 15 | 28 | 3 | 24 | 117 | 108 | 0 | 2 | 23 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 23,651,975 | 162 | 48 | 0 | 3 | 68 | 23 | 23 | 27 | 17 | 0 | 44 | 20 | 23 | 1 | 21 | 49 | 68 | 0 | 2 | 17 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 17,507,975 | 136 | 34 | 0 | 3 | 62 | 21 | 21 | 23 | 16 | 0 | 39 | 17 | 22 | 1 | 21 | 34 | 62 | 0 | 2 | 16 | 0 | 0 | 
| leaf | 0 | prover | 178,914,234 | 471 | 226 | 0 | 14 | 176 | 77 | 76 | 50 | 48 | 0 | 69 | 30 | 38 | 11 | 26 | 226 | 176 | 0 | 5 | 47 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 187,977,302 | 228 | 58 | 0 | 1 | 128 | 33 | 33 | 17 | 77 | 0 | 40 | 21 | 18 | 6 | 12 | 59 | 128 | 0 | 3 | 76 | 0 | 0 | 
| app_proof | prover | 1 | 187,929,140 | 217 | 58 | 0 | 1 | 121 | 29 | 29 | 17 | 75 | 0 | 36 | 21 | 15 | 6 | 9 | 58 | 121 | 0 | 3 | 74 | 0 | 0 | 
| app_proof | prover | 2 | 187,929,140 | 214 | 58 | 0 | 1 | 119 | 28 | 28 | 16 | 74 | 0 | 35 | 20 | 15 | 6 | 8 | 58 | 119 | 0 | 3 | 74 | 0 | 0 | 
| app_proof | prover | 3 | 22,332,812 | 75 | 16 | 0 | 1 | 33 | 9 | 8 | 7 | 16 | 0 | 25 | 17 | 8 | 0 | 7 | 16 | 33 | 0 | 2 | 15 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 176 | 614 | 176 | 169 | 0 | 3 | 40 | 1,310,000 | 36.85 | 
| app_proof | 1 | 159 | 468 | 159 | 41 | 0 | 1 | 50 | 1,310,000 | 41.59 | 
| app_proof | 2 | 164 | 467 | 164 | 40 | 0 | 1 | 47 | 1,310,000 | 41.62 | 
| app_proof | 3 | 201 | 322 | 201 | 40 | 0 | 1 | 4 | 70,051 | 41.16 | 

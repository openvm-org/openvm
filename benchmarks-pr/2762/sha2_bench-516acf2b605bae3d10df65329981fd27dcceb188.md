...
|:---|---:|---:|---:|
| Total |  11.34 |  4.68 |  4.68 |
| app_proof |  9.38 |  2.71 |  2.71 |
| leaf |  1.24 |  1.24 |  1.24 |
...
| `total_proof_time_ms ` |  2,321.25 |  9,285 |  2,621 |  2,212 |
| `execute_metered_time_ms` |  94 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  118.14 | -          |  118.14 |  118.14 |
| `execute_preflight_insns` |  2,791,990.25 |  11,167,961 |  2,851,000 |  2,614,961 |
| `execute_preflight_time_ms` |  167.50 |  670 |  211 |  101 |
| `execute_preflight_insn_mi/s` |  35.72 | -          |  36.79 |  33.29 |
| `trace_gen_time_ms   ` |  94 |  376 |  164 |  58 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,985.25 |  7,941 |  2,184 |  1,916 |
| `prover.main_trace_commit_time_ms` |  550.75 |  2,203 |  656 |  515 |
| `prover.rap_constraints_time_ms` |  1,290.25 |  5,161 |  1,379 |  1,256 |
| `prover.openings_time_ms` |  142.75 |  571 |  147 |  140 |
| `prover.rap_constraints.logup_gkr_time_ms` |  330.50 |  1,322 |  421 |  299 |
| `prover.rap_constraints.round0_time_ms` |  650.50 |  2,602 |  654 |  646 |
| `prover.rap_constraints.mle_rounds_time_ms` |  308.25 |  1,233 |  311 |  306 |
| `prover.openings.stacked_reduction_time_ms` |  107 |  428 |  109 |  105 |
| `prover.openings.stacked_reduction.round0_time_ms` |  60.75 |  243 |  62 |  60 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  46 |  184 |  48 |  45 |
| `prover.openings.whir_time_ms` |  35.50 |  142 |  38 |  33 |
...
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,095 |  1,095 |  1,095 |  1,095 |
| `prover.main_trace_commit_time_ms` |  637 |  637 |  637 |  637 |
...
| `prover.rap_constraints.round0_time_ms` |  161 |  161 |  161 |  161 |
...
| `prover.rap_constraints.mle_rounds_time_ms` |  62 |  62 |  62 |  62 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/516acf2b605bae3d10df65329981fd27dcceb188/sha2_bench-516acf2b605bae3d10df65329981fd27dcceb188.memory.svg)
...
| app_proof |  |  |  |  |  | 2,212 |  |  | 94 | 11,167,961 | 118.14 | 0 | 9,388 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 24 | 392 | 24 | 7 | 2 | 2 | 3 | 3 | 
| internal_recursive.0 | 1 | 12 | 181 | 11 | 2 | 0 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 10 | 146 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 149 | 1,244 | 148 | 54 | 25 | 3 | 6 | 6 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 78,342,915 | 367 | 182 | 0 | 11 | 130 | 36 | 35 | 62 | 31 | 0 | 53 | 20 | 33 | 5 | 27 | 183 | 130 | 0 | 2 | 30 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 25,962,119 | 168 | 50 | 0 | 3 | 75 | 24 | 23 | 29 | 22 | 0 | 41 | 17 | 23 | 1 | 21 | 51 | 75 | 0 | 2 | 21 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 17,507,975 | 136 | 33 | 0 | 3 | 64 | 22 | 21 | 24 | 17 | 0 | 38 | 15 | 22 | 1 | 20 | 33 | 64 | 0 | 2 | 16 | 0 | 0 | 
| leaf | 0 | prover | 503,738,490 | 1,095 | 637 | 0 | 42 | 342 | 161 | 160 | 102 | 79 | 0 | 114 | 36 | 78 | 36 | 41 | 637 | 342 | 0 | 6 | 77 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,057,043,293 | 2,184 | 656 | 0 | 183 | 1,379 | 646 | 646 | 311 | 421 | 127 | 147 | 38 | 109 | 61 | 48 | 656 | 1,379 | 0 | 3 | 293 | 0 | 0 | 
| app_proof | prover | 1 | 1,057,042,484 | 1,923 | 515 | 0 | 39 | 1,264 | 653 | 652 | 308 | 302 | 0 | 142 | 36 | 106 | 60 | 45 | 515 | 1,264 | 0 | 3 | 301 | 0 | 0 | 
| app_proof | prover | 2 | 1,057,042,484 | 1,918 | 515 | 0 | 39 | 1,262 | 654 | 654 | 308 | 299 | 0 | 140 | 35 | 105 | 60 | 45 | 515 | 1,262 | 0 | 3 | 298 | 0 | 0 | 
| app_proof | prover | 3 | 1,057,120,972 | 1,916 | 517 | 0 | 41 | 1,256 | 649 | 648 | 306 | 300 | 0 | 142 | 33 | 108 | 62 | 46 | 517 | 1,256 | 0 | 3 | 299 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 164 | 2,621 | 164 | 171 | 0 | 3 | 101 | 2,851,000 | 33.29 | 
| app_proof | 1 | 58 | 2,233 | 58 | 41 | 0 | 2 | 211 | 2,851,000 | 36.25 | 
| app_proof | 2 | 75 | 2,219 | 75 | 41 | 0 | 1 | 183 | 2,851,000 | 36.79 | 
| app_proof | 3 | 79 | 2,212 | 79 | 41 | 0 | 1 | 175 | 2,614,961 | 36.54 | 

...
|:---|---:|---:|
| Total |  7.66 |  4.93 |
| regex_program |  7.62 |  4.90 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  3,811.50 |  7,623 |  4,901 |  2,722 |
...
| `execute_preflight_time_ms` |  92.50 |  185 |  99 |  86 |
| `execute_preflight_insn_mi/s` |  28.78 | -          |  31.20 |  26.36 |
| `trace_gen_time_ms   ` |  385.50 |  771 |  498 |  273 |
| `memory_finalize_time_ms` |  7.50 |  15 |  13 |  2 |
| `stark_prove_excluding_trace_time_ms` |  3,099.50 |  6,199 |  4,060 |  2,139 |
| `main_trace_commit_time_ms` |  614.50 |  1,229 |  842 |  387 |
| `generate_perm_trace_time_ms` |  225 |  450 |  300 |  150 |
| `perm_trace_commit_time_ms` |  658.50 |  1,317 |  868 |  449 |
| `quotient_poly_compute_time_ms` |  320.50 |  641 |  434 |  207 |
| `quotient_poly_commit_time_ms` |  303.50 |  607 |  401 |  206 |
| `pcs_opening_time_ms ` |  969 |  1,938 |  1,209 |  729 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 1 | 2,722 | 6 | 1 | 32 | 4,108,597 | 126.35 | 44 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 498 | 4,901 | 211,758,557 | 373,183,036 | 498 | 4,060 | 0 | 434 | 401 | 868 | 1,209 | 8 | 13 | 842 | 91,281,687 | 300 | 99 | 2,211,000 | 26.36 | 
| regex_program | 1 | 273 | 2,722 | 174,326,267 | 196,838,026 | 273 | 2,139 | 51 | 207 | 206 | 449 | 729 | 6 | 2 | 387 | 73,453,305 | 150 | 86 | 1,897,597 | 31.20 | 

...
|:---|---:|---:|
| Total |  7.74 |  4.96 |
| regex_program |  7.71 |  4.93 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  3,854 |  7,708 |  4,929 |  2,779 |
...
| `execute_metered_insn_mi/s` |  123.15 | -          |  123.15 |  123.15 |
| `execute_preflight_insns` |  2,054,298.50 |  4,108,597 |  2,211,000 |  1,897,597 |
| `execute_preflight_time_ms` |  94 |  188 |  101 |  87 |
| `execute_preflight_insn_mi/s` |  28.63 | -          |  31.03 |  26.23 |
| `trace_gen_time_ms   ` |  384 |  768 |  497 |  271 |
| `memory_finalize_time_ms` |  7.50 |  15 |  13 |  2 |
| `stark_prove_excluding_trace_time_ms` |  3,149.50 |  6,299 |  4,090 |  2,209 |
| `main_trace_commit_time_ms` |  625.50 |  1,251 |  840 |  411 |
| `generate_perm_trace_time_ms` |  236.50 |  473 |  303 |  170 |
| `perm_trace_commit_time_ms` |  673.50 |  1,347 |  853 |  494 |
| `quotient_poly_compute_time_ms` |  311 |  622 |  428 |  194 |
| `quotient_poly_commit_time_ms` |  303 |  606 |  399 |  207 |
| `pcs_opening_time_ms ` |  992.50 |  1,985 |  1,263 |  722 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 1 | 2,779 | 6 | 1 | 33 | 4,108,597 | 123.15 | 45 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 497 | 4,929 | 211,758,557 | 373,183,036 | 496 | 4,090 | 0 | 428 | 399 | 853 | 1,263 | 8 | 13 | 840 | 91,281,687 | 303 | 101 | 2,211,000 | 26.23 | 
| regex_program | 1 | 271 | 2,779 | 174,326,267 | 196,838,026 | 271 | 2,209 | 50 | 194 | 207 | 494 | 722 | 6 | 2 | 411 | 73,453,305 | 170 | 87 | 1,897,597 | 31.03 | 

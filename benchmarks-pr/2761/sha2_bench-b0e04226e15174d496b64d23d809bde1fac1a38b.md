...
|:---|---:|---:|---:|
| Total |  11.79 |  4.83 |  4.83 |
| app_proof |  9.75 |  2.80 |  2.80 |
| leaf |  1.29 |  1.29 |  1.29 |
...
| `total_proof_time_ms ` |  2,415.25 |  9,661 |  2,707 |  2,310 |
...
| `execute_preflight_time_ms` |  163.25 |  653 |  205 |  98 |
| `execute_preflight_insn_mi/s` |  36.27 | -          |  37.16 |  33.82 |
| `trace_gen_time_ms   ` |  107.75 |  431 |  176 |  66 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  2,069.75 |  8,279 |  2,261 |  2,000 |
| `prover.main_trace_commit_time_ms` |  566.75 |  2,267 |  671 |  531 |
| `prover.rap_constraints_time_ms` |  1,350.75 |  5,403 |  1,434 |  1,317 |
| `prover.openings_time_ms` |  151.25 |  605 |  155 |  149 |
| `prover.rap_constraints.logup_gkr_time_ms` |  337.25 |  1,349 |  429 |  306 |
| `prover.rap_constraints.round0_time_ms` |  687 |  2,748 |  697 |  678 |
| `prover.rap_constraints.mle_rounds_time_ms` |  325.50 |  1,302 |  326 |  325 |
| `prover.openings.stacked_reduction_time_ms` |  111.75 |  447 |  113 |  111 |
| `prover.openings.stacked_reduction.round0_time_ms` |  63.75 |  255 |  65 |  63 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  47.75 |  191 |  49 |  47 |
| `prover.openings.whir_time_ms` |  39 |  156 |  41 |  36 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,294 |  1,294 |  1,294 |  1,294 |
...
| `prover.main_trace_commit_time_ms` |  661 |  661 |  661 |  661 |
| `prover.rap_constraints_time_ms` |  363 |  363 |  363 |  363 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/b0e04226e15174d496b64d23d809bde1fac1a38b/sha2_bench-b0e04226e15174d496b64d23d809bde1fac1a38b.memory.svg)
...
| app_proof |  |  |  |  |  | 2,310 |  |  | 93 | 11,167,961 | 119.49 | 0 | 9,762 |  | 
| internal_for_leaf |  |  |  | 405 |  |  |  |  |  |  |  |  |  | 405 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 78,342,915 | 380 | 190 | 0 | 11 | 135 | 37 | 37 | 65 | 32 | 0 | 54 | 19 | 34 | 5 | 28 | 190 | 135 | 0 | 2 | 31 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 25,962,119 | 172 | 51 | 0 | 4 | 76 | 24 | 24 | 29 | 22 | 0 | 44 | 19 | 24 | 1 | 22 | 52 | 76 | 0 | 2 | 21 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 17,507,975 | 138 | 34 | 0 | 4 | 64 | 23 | 22 | 24 | 16 | 0 | 39 | 16 | 22 | 1 | 21 | 34 | 64 | 0 | 2 | 16 | 0 | 0 | 
| leaf | 0 | prover | 503,738,490 | 1,145 | 661 | 0 | 42 | 363 | 172 | 171 | 110 | 79 | 0 | 120 | 39 | 80 | 37 | 43 | 661 | 363 | 0 | 6 | 78 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,057,043,293 | 2,261 | 671 | 0 | 184 | 1,434 | 678 | 678 | 326 | 429 | 128 | 155 | 41 | 113 | 64 | 49 | 671 | 1,434 | 0 | 3 | 299 | 0 | 0 | 
| app_proof | prover | 1 | 1,057,042,484 | 2,007 | 531 | 0 | 40 | 1,323 | 689 | 688 | 326 | 307 | 0 | 152 | 41 | 111 | 63 | 47 | 531 | 1,323 | 0 | 4 | 306 | 0 | 0 | 
| app_proof | prover | 2 | 1,057,042,484 | 2,011 | 532 | 0 | 39 | 1,329 | 697 | 697 | 325 | 306 | 0 | 149 | 36 | 112 | 65 | 47 | 532 | 1,329 | 0 | 3 | 306 | 0 | 0 | 
| app_proof | prover | 3 | 1,057,120,972 | 2,000 | 533 | 0 | 41 | 1,317 | 684 | 683 | 325 | 307 | 0 | 149 | 38 | 111 | 63 | 48 | 533 | 1,317 | 0 | 4 | 307 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 176 | 2,707 | 176 | 170 | 0 | 3 | 98 | 2,851,000 | 33.82 | 
| app_proof | 1 | 66 | 2,320 | 66 | 41 | 0 | 2 | 205 | 2,851,000 | 37.11 | 
| app_proof | 2 | 92 | 2,324 | 92 | 41 | 0 | 2 | 179 | 2,851,000 | 37.16 | 
| app_proof | 3 | 97 | 2,310 | 97 | 41 | 0 | 2 | 171 | 2,614,961 | 36.98 | 

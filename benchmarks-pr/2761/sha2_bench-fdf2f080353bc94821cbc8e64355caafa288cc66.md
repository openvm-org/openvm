...
|:---|---:|---:|---:|
| Total |  11.44 |  4.72 |  4.72 |
| app_proof |  9.45 |  2.73 |  2.73 |
| leaf |  1.26 |  1.26 |  1.26 |
...
| `total_proof_time_ms ` |  2,338 |  9,352 |  2,632 |  2,232 |
| `execute_metered_time_ms` |  93 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  119.80 | -          |  119.80 |  119.80 |
| `execute_preflight_insns` |  2,791,990.25 |  11,167,961 |  2,851,000 |  2,614,961 |
| `execute_preflight_time_ms` |  165.25 |  661 |  211 |  99 |
| `execute_preflight_insn_mi/s` |  36.32 | -          |  37.17 |  33.77 |
| `trace_gen_time_ms   ` |  97 |  388 |  164 |  58 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  2,001.25 |  8,005 |  2,198 |  1,933 |
| `prover.main_trace_commit_time_ms` |  553 |  2,212 |  659 |  517 |
| `prover.rap_constraints_time_ms` |  1,301.25 |  5,205 |  1,388 |  1,267 |
| `prover.openings_time_ms` |  145.75 |  583 |  149 |  144 |
| `prover.rap_constraints.logup_gkr_time_ms` |  331 |  1,324 |  423 |  300 |
| `prover.rap_constraints.round0_time_ms` |  660.50 |  2,642 |  665 |  652 |
| `prover.rap_constraints.mle_rounds_time_ms` |  308.75 |  1,235 |  312 |  306 |
| `prover.openings.stacked_reduction_time_ms` |  108.75 |  435 |  109 |  108 |
| `prover.openings.stacked_reduction.round0_time_ms` |  61.25 |  245 |  62 |  60 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  46.75 |  187 |  48 |  45 |
| `prover.openings.whir_time_ms` |  36.50 |  146 |  39 |  35 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,262 |  1,262 |  1,262 |  1,262 |
| `execute_preflight_time_ms` |  3 |  3 |  3 |  3 |
| `trace_gen_time_ms   ` |  153 |  153 |  153 |  153 |
| `generate_blob_total_time_ms` |  25 |  25 |  25 |  25 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,108 |  1,108 |  1,108 |  1,108 |
| `prover.main_trace_commit_time_ms` |  640 |  640 |  640 |  640 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/fdf2f080353bc94821cbc8e64355caafa288cc66/sha2_bench-fdf2f080353bc94821cbc8e64355caafa288cc66.memory.svg)
...
| app_proof |  |  |  |  |  | 2,232 |  |  | 93 | 11,167,961 | 119.80 | 0 | 9,452 |  | 
| internal_for_leaf |  |  |  | 397 |  |  |  |  |  |  |  |  |  | 397 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 24 | 397 | 24 | 8 | 2 | 2 | 3 | 3 | 
| internal_recursive.0 | 1 | 12 | 186 | 11 | 2 | 0 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 10 | 146 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 153 | 1,262 | 153 | 55 | 25 | 3 | 6 | 6 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 78,342,915 | 372 | 185 | 0 | 11 | 132 | 36 | 36 | 63 | 32 | 0 | 54 | 20 | 33 | 5 | 27 | 185 | 132 | 0 | 2 | 30 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 25,962,119 | 174 | 51 | 0 | 3 | 75 | 23 | 23 | 28 | 22 | 0 | 48 | 24 | 23 | 1 | 21 | 51 | 75 | 0 | 2 | 21 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 17,507,975 | 136 | 33 | 0 | 4 | 64 | 22 | 22 | 24 | 17 | 0 | 37 | 15 | 22 | 1 | 21 | 34 | 64 | 0 | 2 | 16 | 0 | 0 | 
| leaf | 0 | prover | 503,738,490 | 1,108 | 639 | 0 | 42 | 349 | 165 | 164 | 105 | 79 | 0 | 118 | 41 | 77 | 35 | 41 | 640 | 349 | 0 | 6 | 78 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,057,043,293 | 2,198 | 659 | 0 | 182 | 1,388 | 652 | 652 | 312 | 423 | 127 | 149 | 39 | 109 | 60 | 48 | 659 | 1,388 | 0 | 3 | 295 | 0 | 0 | 
| app_proof | prover | 1 | 1,057,042,484 | 1,939 | 516 | 0 | 39 | 1,277 | 665 | 665 | 310 | 301 | 0 | 144 | 36 | 108 | 62 | 45 | 517 | 1,277 | 0 | 3 | 300 | 0 | 0 | 
| app_proof | prover | 2 | 1,057,042,484 | 1,935 | 517 | 0 | 39 | 1,273 | 665 | 665 | 307 | 300 | 0 | 145 | 35 | 109 | 62 | 47 | 517 | 1,273 | 0 | 3 | 299 | 0 | 0 | 
| app_proof | prover | 3 | 1,057,120,972 | 1,933 | 519 | 0 | 41 | 1,267 | 660 | 659 | 306 | 300 | 0 | 145 | 36 | 109 | 61 | 47 | 519 | 1,267 | 0 | 3 | 299 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 164 | 2,632 | 164 | 170 | 0 | 3 | 99 | 2,851,000 | 33.77 | 
| app_proof | 1 | 58 | 2,250 | 57 | 41 | 0 | 2 | 211 | 2,851,000 | 37.17 | 
| app_proof | 2 | 80 | 2,238 | 80 | 41 | 0 | 2 | 180 | 2,851,000 | 37.16 | 
| app_proof | 3 | 86 | 2,232 | 86 | 41 | 0 | 2 | 171 | 2,614,961 | 37.16 | 

...
| `total_proof_time_ms ` |  477.50 |  1,910 |  620 |  329 |
| `execute_metered_time_ms` |  20 | -          | -          | -          |
| `execute_metered_insns` |  4,000,051 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  196.72 | -          |  196.72 |  196.72 |
| `execute_preflight_insns` |  1,000,012.75 |  4,000,051 |  1,310,000 |  70,051 |
| `execute_preflight_time_ms` |  35.25 |  141 |  50 |  4 |
| `execute_preflight_insn_mi/s` |  40.07 | -          |  41.31 |  36.89 |
| `trace_gen_time_ms   ` |  181.25 |  725 |  207 |  167 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  186.50 |  746 |  228 |  76 |
| `prover.main_trace_commit_time_ms` |  49 |  196 |  60 |  16 |
| `prover.rap_constraints_time_ms` |  101.50 |  406 |  127 |  33 |
| `prover.openings_time_ms` |  35 |  140 |  40 |  26 |
| `prover.rap_constraints.logup_gkr_time_ms` |  60.75 |  243 |  77 |  16 |
| `prover.rap_constraints.round0_time_ms` |  25 |  100 |  31 |  9 |
| `prover.rap_constraints.mle_rounds_time_ms` |  14.50 |  58 |  17 |  7 |
| `prover.openings.stacked_reduction_time_ms` |  14 |  56 |  18 |  8 |
| `prover.openings.stacked_reduction.round0_time_ms` |  4.75 |  19 |  6 |  1 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  9.25 |  37 |  12 |  7 |
| `prover.openings.whir_time_ms` |  20.25 |  81 |  22 |  17 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  546 |  546 |  546 |  546 |
...
| `prover.rap_constraints_time_ms` |  183 |  183 |  183 |  183 |
...
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  278 |  278 |  278 |  278 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/fdf2f080353bc94821cbc8e64355caafa288cc66/fibonacci-fdf2f080353bc94821cbc8e64355caafa288cc66.memory.svg)
...
| app_proof |  |  |  |  |  | 329 |  |  | 20 | 4,000,051 | 196.72 | 0 | 1,936 |  | 
| internal_for_leaf |  |  |  | 296 |  |  |  |  |  |  |  |  |  | 296 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 53,545,731 | 278 | 120 | 0 | 7 | 111 | 34 | 33 | 51 | 25 | 0 | 46 | 17 | 28 | 3 | 24 | 120 | 111 | 0 | 2 | 23 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 23,651,975 | 164 | 48 | 0 | 3 | 70 | 24 | 24 | 27 | 18 | 0 | 44 | 21 | 23 | 1 | 21 | 49 | 70 | 0 | 2 | 17 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 17,507,975 | 144 | 34 | 0 | 3 | 65 | 23 | 23 | 24 | 17 | 0 | 43 | 21 | 22 | 1 | 20 | 34 | 65 | 0 | 2 | 16 | 0 | 0 | 
| leaf | 0 | prover | 178,914,234 | 482 | 230 | 0 | 14 | 183 | 81 | 80 | 52 | 49 | 0 | 67 | 29 | 38 | 11 | 26 | 230 | 183 | 0 | 5 | 48 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 187,977,302 | 228 | 60 | 0 | 1 | 127 | 31 | 31 | 17 | 77 | 0 | 40 | 21 | 18 | 6 | 12 | 60 | 126 | 0 | 3 | 76 | 0 | 0 | 
| app_proof | prover | 1 | 187,929,140 | 221 | 59 | 0 | 1 | 123 | 30 | 30 | 17 | 75 | 0 | 37 | 21 | 15 | 6 | 9 | 60 | 123 | 0 | 3 | 75 | 0 | 0 | 
| app_proof | prover | 2 | 187,929,140 | 221 | 60 | 0 | 1 | 123 | 30 | 30 | 17 | 75 | 0 | 37 | 22 | 15 | 6 | 9 | 60 | 123 | 0 | 3 | 75 | 0 | 0 | 
| app_proof | prover | 3 | 22,332,812 | 76 | 16 | 0 | 1 | 33 | 9 | 9 | 7 | 16 | 0 | 26 | 17 | 8 | 1 | 7 | 16 | 33 | 0 | 2 | 15 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 181 | 620 | 181 | 170 | 0 | 3 | 40 | 1,310,000 | 36.89 | 
| app_proof | 1 | 167 | 480 | 167 | 41 | 0 | 1 | 50 | 1,310,000 | 41.26 | 
| app_proof | 2 | 170 | 481 | 170 | 41 | 0 | 1 | 47 | 1,310,000 | 41.31 | 
| app_proof | 3 | 207 | 329 | 207 | 41 | 0 | 1 | 4 | 70,051 | 40.82 | 

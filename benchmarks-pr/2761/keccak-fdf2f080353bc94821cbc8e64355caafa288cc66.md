...
| `total_proof_time_ms ` |  2,271.33 |  13,628 |  2,544 |  2,180 |
| `execute_metered_time_ms` |  137 | -          | -          | -          |
| `execute_metered_insns` |  14,365,133 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  104.18 | -          |  104.18 |  104.18 |
| `execute_preflight_insns` |  2,394,188.83 |  14,365,133 |  2,413,000 |  2,300,133 |
| `execute_preflight_time_ms` |  242 |  1,452 |  320 |  90 |
| `execute_preflight_insn_mi/s` |  33.34 | -          |  33.96 |  30.72 |
| `trace_gen_time_ms   ` |  54.17 |  325 |  156 |  33 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,911.50 |  11,469 |  2,126 |  1,861 |
| `prover.main_trace_commit_time_ms` |  715.67 |  4,294 |  877 |  682 |
| `prover.rap_constraints_time_ms` |  1,006.17 |  6,037 |  1,061 |  993 |
| `prover.openings_time_ms` |  188.83 |  1,133 |  191 |  186 |
| `prover.rap_constraints.logup_gkr_time_ms` |  165.83 |  995 |  219 |  154 |
| `prover.rap_constraints.round0_time_ms` |  525.83 |  3,155 |  531 |  511 |
| `prover.rap_constraints.mle_rounds_time_ms` |  313 |  1,878 |  329 |  309 |
| `prover.openings.stacked_reduction_time_ms` |  146.67 |  880 |  149 |  146 |
| `prover.openings.stacked_reduction.round0_time_ms` |  85.17 |  511 |  87 |  84 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,126 |  2,252 |  1,462 |  790 |
| `execute_preflight_time_ms` |  5.50 |  11 |  6 |  5 |
| `trace_gen_time_ms   ` |  139.50 |  279 |  187 |  92 |
| `generate_blob_total_time_ms` |  24.50 |  49 |  33 |  16 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  986.50 |  1,973 |  1,275 |  698 |
| `prover.main_trace_commit_time_ms` |  555 |  1,110 |  732 |  378 |
| `prover.rap_constraints_time_ms` |  319.50 |  639 |  411 |  228 |
| `prover.openings_time_ms` |  110.50 |  221 |  131 |  90 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/fdf2f080353bc94821cbc8e64355caafa288cc66/keccak-fdf2f080353bc94821cbc8e64355caafa288cc66.memory.svg)
...
| app_proof |  |  |  |  |  | 2,180 |  |  | 137 | 14,365,133 | 104.18 | 0 | 13,774 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 40 | 524 | 40 | 13 | 4 | 2 | 2 | 2 | 
| internal_recursive.0 | 1 | 14 | 185 | 14 | 2 | 1 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 9 | 149 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 187 | 1,462 | 186 | 64 | 33 | 6 | 7 | 7 | 
| leaf | 1 | 92 | 790 | 92 | 32 | 16 | 5 | 7 | 7 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 109,497,984 | 484 | 249 | 0 | 14 | 175 | 48 | 47 | 93 | 33 | 0 | 58 | 20 | 38 | 7 | 30 | 249 | 175 | 0 | 2 | 32 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 25,962,119 | 170 | 51 | 0 | 3 | 77 | 24 | 24 | 29 | 23 | 0 | 40 | 16 | 23 | 1 | 21 | 52 | 77 | 0 | 2 | 21 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 17,507,975 | 140 | 34 | 0 | 4 | 65 | 23 | 22 | 24 | 17 | 0 | 39 | 17 | 22 | 1 | 21 | 34 | 65 | 0 | 2 | 16 | 0 | 0 | 
| leaf | 0 | prover | 588,836,986 | 1,275 | 731 | 0 | 47 | 411 | 207 | 206 | 121 | 82 | 0 | 131 | 42 | 88 | 42 | 46 | 732 | 411 | 0 | 6 | 81 | 0 | 0 | 
| leaf | 1 | prover | 303,201,280 | 698 | 378 | 0 | 24 | 228 | 109 | 108 | 67 | 51 | 0 | 90 | 37 | 52 | 20 | 32 | 378 | 228 | 0 | 6 | 50 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,117,098,036 | 2,126 | 876 | 0 | 254 | 1,061 | 511 | 511 | 329 | 219 | 65 | 188 | 39 | 149 | 87 | 61 | 877 | 1,061 | 0 | 3 | 153 | 0 | 0 | 
| app_proof | prover | 1 | 1,117,175,860 | 1,861 | 681 | 0 | 58 | 993 | 527 | 527 | 310 | 154 | 0 | 186 | 39 | 146 | 85 | 60 | 682 | 993 | 0 | 3 | 154 | 0 | 0 | 
| app_proof | prover | 2 | 1,117,175,860 | 1,868 | 683 | 0 | 58 | 997 | 531 | 530 | 310 | 155 | 0 | 187 | 41 | 146 | 84 | 61 | 683 | 997 | 0 | 3 | 154 | 0 | 0 | 
| app_proof | prover | 3 | 1,117,175,860 | 1,872 | 684 | 0 | 58 | 996 | 529 | 528 | 310 | 156 | 0 | 190 | 44 | 146 | 85 | 60 | 684 | 996 | 0 | 3 | 155 | 0 | 0 | 
| app_proof | prover | 4 | 1,117,175,860 | 1,873 | 684 | 0 | 58 | 996 | 529 | 529 | 310 | 156 | 0 | 191 | 44 | 147 | 85 | 61 | 684 | 996 | 0 | 4 | 155 | 0 | 0 | 
| app_proof | prover | 5 | 1,117,098,036 | 1,869 | 684 | 0 | 58 | 994 | 528 | 528 | 309 | 155 | 0 | 191 | 44 | 146 | 85 | 61 | 684 | 994 | 0 | 3 | 154 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 156 | 2,544 | 156 | 170 | 0 | 3 | 90 | 2,413,000 | 30.72 | 
| app_proof | 1 | 34 | 2,257 | 34 | 41 | 0 | 1 | 320 | 2,413,000 | 33.90 | 
| app_proof | 2 | 34 | 2,213 | 34 | 41 | 0 | 1 | 269 | 2,413,000 | 33.89 | 
| app_proof | 3 | 34 | 2,217 | 34 | 41 | 0 | 1 | 269 | 2,413,000 | 33.96 | 
| app_proof | 4 | 34 | 2,217 | 34 | 41 | 0 | 1 | 269 | 2,413,000 | 33.68 | 
| app_proof | 5 | 33 | 2,180 | 33 | 41 | 0 | 1 | 235 | 2,300,133 | 33.90 | 

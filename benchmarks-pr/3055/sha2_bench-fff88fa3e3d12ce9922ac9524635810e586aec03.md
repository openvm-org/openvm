...
| `total_proof_time_ms ` |  2,373 |  4,746 |  3,254 |  1,492 |
| `compile_metered_time_ms` |  6 |  6 |  6 |  6 |
| `execute_metered_time_ms` |  56 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  198 | -          |  198 |  198 |
| `execute_preflight_insns` |  5,583,980.50 |  11,167,961 |  7,136,000 |  4,031,961 |
| `execute_preflight_time_ms` |  161 |  322 |  218 |  104 |
| `execute_preflight_insn_mi/s` |  36.98 | -          |  39.51 |  34.46 |
| `trace_gen_time_ms   ` |  66 |  132 |  104 |  28 |
| `set_initial_memory_time_ms` |  0 |  0 |  0 |  0 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  2,143.50 |  4,287 |  2,929 |  1,358 |
| `prover.main_trace_commit_time_ms` |  749 |  1,498 |  1,274 |  224 |
| `prover.rap_constraints_time_ms` |  1,117 |  2,234 |  1,299 |  935 |
| `prover.openings_time_ms` |  276.50 |  553 |  355 |  198 |
| `prover.rap_constraints.logup_gkr_time_ms` |  403 |  806 |  452 |  354 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/fff88fa3e3d12ce9922ac9524635810e586aec03/sha2_bench-fff88fa3e3d12ce9922ac9524635810e586aec03.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 60 |  |  |  | 298 |  |  |  |  |  |  | 
| app_proof |  |  |  | 1,492 |  | 56 | 11,167,961 | 198 | 0 | 4,811 |  | 
...
| leaf | 0 | 126 | 533 | 126 | 33 | 12 | 2 | 9 | 9 | 
...
| leaf | 0 | prover | 237,929,272 | 406 | 146 | 0 | 0 | 141 | 70 | 69 | 44 | 26 | 0 | 117 | 95 | 22 | 10 | 11 | 146 | 146 | 141 | 0 | 3 | 25 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,315,601,831 | 2,929 | 1,274 | 0 | 0 | 1,299 | 705 | 705 | 239 | 354 | 1 | 355 | 259 | 96 | 59 | 37 | 1,274 | 1,274 | 1,299 | 0 | 1 | 353 | 0 | 0 | 
| app_proof | prover | 1 | 709,381,428 | 1,358 | 224 | 0 | 0 | 935 | 353 | 353 | 129 | 452 | 268 | 198 | 144 | 53 | 31 | 22 | 224 | 224 | 935 | 0 | 1 | 183 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 0 | 2 | 104 | 3,254 | 3 | 0 | 0 | 0 | 12,820,730,880 | 2,969,255,892 | 15,789,986,772 | 2,097,152 | 2 | 0 | 0 | 0 | 3 | 101 | 218 | 7,136,000 | 34.46 | 0 | 0 | 
| app_proof | 1 | 0 | 2 | 28 | 1,492 | 2 | 0 | 0 | 0 | 7,276,196,868 | 1,627,061,653 | 8,903,258,521 | 2,097,152 | 2 | 0 | 0 | 0 | 2 | 26 | 104 | 4,031,961 | 39.51 | 0 | 0 | 

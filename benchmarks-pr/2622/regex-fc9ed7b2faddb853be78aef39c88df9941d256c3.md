...
| `total_proof_time_ms ` |  806.50 |  1,613 |  896 |  717 |
| `execute_metered_time_ms` |  35 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  115.02 | -          |  115.02 |  115.02 |
| `execute_preflight_insns` |  2,068,347 |  4,136,694 |  2,208,000 |  1,928,694 |
| `execute_preflight_time_ms` |  91 |  182 |  101 |  81 |
| `execute_preflight_insn_mi/s` |  31.90 | -          |  32.97 |  30.83 |
| `trace_gen_time_ms   ` |  131 |  262 |  139 |  123 |
| `memory_finalize_time_ms` |  2 |  4 |  4 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  479.50 |  959 |  504 |  455 |
| `prover.main_trace_commit_time_ms` |  96 |  192 |  100 |  92 |
| `prover.rap_constraints_time_ms` |  232.50 |  465 |  243 |  222 |
| `prover.openings_time_ms` |  150 |  300 |  181 |  119 |
| `prover.rap_constraints.logup_gkr_time_ms` |  137.50 |  275 |  138 |  137 |
| `prover.rap_constraints.round0_time_ms` |  63 |  126 |  77 |  49 |
| `prover.rap_constraints.mle_rounds_time_ms` |  31 |  62 |  34 |  28 |
...
| `prover.openings.whir_time_ms` |  123.50 |  247 |  153 |  94 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/fc9ed7b2faddb853be78aef39c88df9941d256c3/regex-fc9ed7b2faddb853be78aef39c88df9941d256c3.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof |  |  | 717 | 35 | 4,136,694 | 115.02 | 0 | 1,664 |  | 
| internal_for_leaf |  | 315 |  |  |  |  |  |  | 315 | 
| internal_recursive.0 |  | 210 |  |  |  |  |  |  | 210 | 
| internal_recursive.1 |  | 184 |  |  |  |  |  |  | 184 | 
| leaf | 533 |  |  |  |  |  |  |  | 533 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 15 | 315 | 15 | 4 | 0 | 3 | 1 | 
| internal_recursive.0 | 1 | 9 | 210 | 9 | 1 | 0 | 3 | 0 | 
| internal_recursive.1 | 1 | 8 | 184 | 8 | 1 | 0 | 2 | 0 | 
| leaf | 0 | 46 | 533 | 45 | 13 | 3 | 14 | 10 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 41,110,275 | 300 | 83 | 0 | 5 | 98 | 30 | 29 | 45 | 23 | 0 | 117 | 91 | 26 | 2 | 23 | 83 | 98 | 2 | 22 | 0 | 
| internal_recursive.0 | 1 | prover | 23,651,975 | 200 | 48 | 0 | 3 | 69 | 23 | 22 | 27 | 18 | 0 | 82 | 58 | 23 | 1 | 21 | 48 | 69 | 2 | 17 | 0 | 
| internal_recursive.1 | 1 | prover | 17,507,975 | 175 | 34 | 0 | 3 | 62 | 21 | 20 | 24 | 17 | 0 | 78 | 55 | 22 | 1 | 21 | 34 | 62 | 2 | 16 | 0 | 
| leaf | 0 | prover | 113,138,688 | 487 | 128 | 0 | 8 | 135 | 50 | 49 | 36 | 48 | 0 | 222 | 192 | 30 | 6 | 23 | 128 | 135 | 5 | 46 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 339,711,558 | 504 | 100 | 0 | 2 | 222 | 49 | 48 | 34 | 138 | 0 | 181 | 153 | 28 | 10 | 17 | 100 | 222 | 2 | 137 | 0 | 
| app_proof | prover | 1 | 303,309,204 | 455 | 92 | 0 | 13 | 243 | 77 | 76 | 28 | 137 | 0 | 119 | 94 | 25 | 8 | 16 | 92 | 243 | 2 | 136 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 123 | 896 | 123 | 166 | 4 | 106 | 101 | 2,208,000 | 30.83 | 
| app_proof | 1 | 139 | 717 | 139 | 40 | 0 | 123 | 81 | 1,928,694 | 32.97 | 

...
|:---|---:|---:|---:|
| Total |  3.14 |  2.19 |  2.19 |
| app_proof |  2.37 |  1.41 |  1.41 |
| leaf |  0.40 |  0.40 |  0.40 |
...
| `total_proof_time_ms ` |  1,179.50 |  2,359 |  1,408 |  951 |
| `execute_metered_time_ms` |  7 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  20.14 | -          |  20.14 |  20.14 |
| `execute_preflight_insns` |  77,381.50 |  154,763 |  121,000 |  33,763 |
| `execute_preflight_time_ms` |  70.50 |  141 |  121 |  20 |
| `execute_preflight_insn_mi/s` |  8.55 | -          |  11.33 |  5.78 |
| `trace_gen_time_ms   ` |  158 |  316 |  188 |  128 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  837.50 |  1,675 |  1,015 |  660 |
| `prover.main_trace_commit_time_ms` |  219 |  438 |  289 |  149 |
| `prover.rap_constraints_time_ms` |  556 |  1,112 |  652 |  460 |
| `prover.openings_time_ms` |  61 |  122 |  73 |  49 |
| `prover.rap_constraints.logup_gkr_time_ms` |  140 |  280 |  154 |  126 |
| `prover.rap_constraints.round0_time_ms` |  284 |  568 |  359 |  209 |
| `prover.rap_constraints.mle_rounds_time_ms` |  130.50 |  261 |  138 |  123 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/dec4b7c0e14b281394e28e0a302e74beb16a8a6b/kitchen_sink-dec4b7c0e14b281394e28e0a302e74beb16a8a6b.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 3 |  |  | 0 |  | 334 | 3 |  |  |  |  |  |  | 
| app_proof |  |  |  |  | 951 |  |  | 7 | 154,763 | 20.14 | 0 | 2,372 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 19 | 159 | 18 | 6 | 1 | 5 | 2 | 
| internal_recursive.0 | 1 | 10 | 110 | 10 | 1 | 0 | 3 | 1 | 
| internal_recursive.1 | 1 | 8 | 105 | 8 | 1 | 0 | 2 | 0 | 
| leaf | 0 | 97 | 404 | 97 | 25 | 11 | 25 | 7 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 53,472,003 | 139 | 40 | 0 | 4 | 64 | 19 | 18 | 28 | 15 | 0 | 34 | 10 | 23 | 1 | 21 | 41 | 64 | 1 | 14 | 0 | 
| internal_recursive.0 | 1 | prover | 23,651,975 | 99 | 19 | 0 | 4 | 50 | 16 | 16 | 20 | 13 | 0 | 29 | 7 | 21 | 1 | 20 | 19 | 50 | 1 | 12 | 0 | 
| internal_recursive.1 | 1 | prover | 17,507,975 | 96 | 14 | 0 | 4 | 50 | 17 | 16 | 18 | 13 | 0 | 31 | 9 | 21 | 0 | 20 | 15 | 50 | 1 | 12 | 0 | 
| leaf | 0 | prover | 407,935,872 | 307 | 123 | 0 | 9 | 138 | 44 | 43 | 36 | 58 | 0 | 43 | 12 | 30 | 6 | 23 | 124 | 138 | 2 | 57 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 816,542,084 | 1,015 | 288 | 0 | 159 | 652 | 359 | 358 | 138 | 154 | 62 | 73 | 12 | 60 | 15 | 44 | 289 | 652 | 1 | 91 | 0 | 
| app_proof | prover | 1 | 800,298,548 | 660 | 149 | 0 | 20 | 460 | 209 | 209 | 123 | 126 | 72 | 49 | 13 | 36 | 14 | 22 | 149 | 460 | 1 | 53 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 188 | 1,408 | 188 | 184 | 0 | 50 | 20 | 121,000 | 11.33 | 
| app_proof | 1 | 128 | 951 | 128 | 40 | 0 | 3 | 121 | 33,763 | 5.78 | 

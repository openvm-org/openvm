...
|:---|---:|---:|---:|
| Total |  6.49 |  2.55 |  2.55 |
| app_proof |  4.23 |  0.81 |  0.81 |
| leaf |  1.36 |  0.83 |  0.83 |
...
| `total_proof_time_ms ` |  593.57 |  4,155 |  737 |  568 |
| `execute_metered_time_ms` |  72 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  166.17 | -          |  166.17 |  166.17 |
| `execute_preflight_insns` |  1,714,323.57 |  12,000,265 |  1,747,000 |  1,518,265 |
| `execute_preflight_time_ms` |  57 |  399 |  62 |  50 |
| `execute_preflight_insn_mi/s` |  39.89 | -          |  40.54 |  39.20 |
| `trace_gen_time_ms   ` |  156.29 |  1,094 |  163 |  152 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  320.29 |  2,242 |  349 |  314 |
| `prover.main_trace_commit_time_ms` |  58.86 |  412 |  60 |  57 |
| `prover.rap_constraints_time_ms` |  174 |  1,218 |  178 |  173 |
| `prover.openings_time_ms` |  86.43 |  605 |  110 |  81 |
| `prover.rap_constraints.logup_gkr_time_ms` |  126.14 |  883 |  127 |  126 |
| `prover.rap_constraints.round0_time_ms` |  27.86 |  195 |  31 |  27 |
...
| `prover.openings.whir_time_ms` |  69.43 |  486 |  91 |  65 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  677.50 |  1,355 |  833 |  522 |
| `execute_preflight_time_ms` |  9 |  18 |  14 |  4 |
| `trace_gen_time_ms   ` |  46.50 |  93 |  60 |  33 |
| `generate_blob_total_time_ms` |  4 |  8 |  5 |  3 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  630.50 |  1,261 |  773 |  488 |
| `prover.main_trace_commit_time_ms` |  195.50 |  391 |  234 |  157 |
| `prover.rap_constraints_time_ms` |  162 |  324 |  181 |  143 |
| `prover.openings_time_ms` |  272 |  544 |  357 |  187 |
...
| `prover.openings.whir_time_ms` |  235.50 |  471 |  317 |  154 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/2c5a7720e4bd56ff0bbc41ccbfbe480d29dbe810/fibonacci-2c5a7720e4bd56ff0bbc41ccbfbe480d29dbe810.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof |  |  | 570 | 72 | 12,000,265 | 166.17 | 0 | 4,236 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 26 | 518 | 26 | 9 | 2 | 4 | 1 | 
| internal_recursive.0 | 1 | 11 | 216 | 11 | 1 | 0 | 3 | 1 | 
| internal_recursive.1 | 1 | 9 | 174 | 8 | 1 | 0 | 2 | 0 | 
| leaf | 0 | 60 | 833 | 59 | 25 | 5 | 14 | 12 | 
| leaf | 1 | 33 | 522 | 33 | 17 | 3 | 4 | 2 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 75,533,952 | 492 | 160 | 0 | 9 | 144 | 39 | 38 | 72 | 32 | 0 | 187 | 155 | 32 | 5 | 26 | 160 | 144 | 2 | 31 | 0 | 
| internal_recursive.0 | 1 | prover | 23,651,975 | 205 | 47 | 0 | 3 | 70 | 23 | 22 | 27 | 19 | 0 | 86 | 63 | 23 | 1 | 21 | 48 | 70 | 2 | 17 | 0 | 
| internal_recursive.1 | 1 | prover | 17,507,975 |
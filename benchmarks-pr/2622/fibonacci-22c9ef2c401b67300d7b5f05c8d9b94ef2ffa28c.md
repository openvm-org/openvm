...
| `total_proof_time_ms ` |  545.71 |  3,820 |  669 |  523 |
| `execute_metered_time_ms` |  73 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  162.63 | -          |  162.63 |  162.63 |
| `execute_preflight_insns` |  1,714,323.57 |  12,000,265 |  1,747,000 |  1,518,265 |
| `execute_preflight_time_ms` |  56.57 |  396 |  63 |  49 |
| `execute_preflight_insn_mi/s` |  40.41 | -          |  40.83 |  39.23 |
| `trace_gen_time_ms   ` |  158.57 |  1,110 |  167 |  153 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  270 |  1,890 |  279 |  267 |
| `prover.main_trace_commit_time_ms` |  58.71 |  411 |  59 |  58 |
| `prover.rap_constraints_time_ms` |  174.14 |  1,219 |  179 |  173 |
| `prover.openings_time_ms` |  35.57 |  249 |  40 |  33 |
| `prover.rap_constraints.logup_gkr_time_ms` |  126.43 |  885 |  127 |  126 |
| `prover.rap_constraints.round0_time_ms` |  28.14 |  197 |  31 |  27 |
...
| `prover.openings.whir_time_ms` |  18.57 |  130 |  20 |  17 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  467.50 |  935 |  541 |  394 |
| `execute_preflight_time_ms` |  8.50 |  17 |  13 |  4 |
| `trace_gen_time_ms   ` |  47 |  94 |  61 |  33 |
| `generate_blob_total_time_ms` |  4 |  8 |  5 |  3 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  420 |  840 |  479 |  361 |
| `prover.main_trace_commit_time_ms` |  195.50 |  391 |  233 |  158 |
| `prover.rap_constraints_time_ms` |  160.50 |  321 |  179 |  142 |
| `prover.openings_time_ms` |  63.50 |  127 |  67 |  60 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/22c9ef2c401b67300d7b5f05c8d9b94ef2ffa28c/fibonacci-22c9ef2c401b67300d7b5f05c8d9b94ef2ffa28c.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 9 |  |  | 0 |  | 350 | 9 |  |  |  |  |  |  | 
| app_proof |  |  |  |  | 528 |  |  | 73 | 12,000,265 | 162.63 | 0 | 3,903 |  | 
| internal_for_leaf |  |  | 389 |  |  |  |  |  |  |  |  |  | 389 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 26 | 389 | 26 | 10 | 1 | 4 | 2 | 
| internal_recursive.0 | 1 | 11 | 170 | 11 | 1 | 0 | 3 | 1 | 
| internal_recursive.1 | 1 | 9 | 150 | 9 | 1 | 0 | 2 | 0 | 
| leaf | 0 | 61 | 541 | 61 | 25 | 5 | 13 | 11 | 
| leaf | 1 | 33 | 394 | 32 | 17 | 3 | 4 | 2 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 75,533,952 | 362 | 161 | 0 | 9 | 145 | 39 | 38 | 73 | 32 | 0 | 55 | 23 | 32 | 5 | 27 | 161 | 145 | 2 | 31 | 0 | 
| internal_recursive.0 | 1 | prover | 23,651,975 | 158 | 47 | 0 | 4 | 69 | 23 | 22 | 28 | 18 | 0 | 40 | 16 | 23 | 1 | 21 | 48 | 69 | 2 | 17 | 0 | 
| internal_recursive.1 | 1 | prover | 17,507,975 |
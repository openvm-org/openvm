...
|:---|---:|---:|---:|
| Total |  4.54 |  3.23 |  3.23 |
| app_proof |  3.29 |  1.97 |  1.97 |
| leaf |  0.72 |  0.72 |  0.72 |
...
| `total_proof_time_ms ` |  1,639 |  3,278 |  1,965 |  1,313 |
| `execute_metered_time_ms` |  7 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  20.63 | -          |  20.63 |  20.63 |
| `execute_preflight_insns` |  77,381.50 |  154,763 |  121,000 |  33,763 |
| `execute_preflight_time_ms` |  70 |  140 |  120 |  20 |
| `execute_preflight_insn_mi/s` |  8.51 | -          |  11.18 |  5.85 |
| `trace_gen_time_ms   ` |  157.50 |  315 |  187 |  128 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,297 |  2,594 |  1,570 |  1,024 |
| `prover.main_trace_commit_time_ms` |  220 |  440 |  290 |  150 |
| `prover.rap_constraints_time_ms` |  556.50 |  1,113 |  653 |  460 |
| `prover.openings_time_ms` |  519.50 |  1,039 |  626 |  413 |
| `prover.rap_constraints.logup_gkr_time_ms` |  139 |  278 |  151 |  127 |
| `prover.rap_constraints.round0_time_ms` |  284.50 |  569 |  362 |  207 |
| `prover.rap_constraints.mle_rounds_time_ms` |  132 |  264 |  139 |  125 |
| `prover.openings.stacked_reduction_time_ms` |  48.50 |  97 |  60 |  37 |
...
| `prover.openings.whir_time_ms` |  471 |  942 |  566 |  376 |
...
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  629 |  629 |  629 |  629 |
...
| `prover.openings.whir_time_ms` |  331 |  331 |  331 |  331 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/fc9ed7b2faddb853be78aef39c88df9941d256c3/kitchen_sink-fc9ed7b2faddb853be78aef39c88df9941d256c3.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof |  |  | 1,313 | 7 | 154,763 | 20.63 | 0 | 3,291 |  | 
...
| app_proof | VmAirWrapper<Rv32BaseAluAdapterAir, ShiftCoreAir<4, 8> | 1 | 105 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 18 | 254 | 18 | 6 | 1 | 5 | 2 | 
| internal_recursive.0 | 1 | 10 | 151 | 10 | 1 | 0 | 3 | 1 | 
| internal_recursive.1 | 1 | 8 | 129 | 8 | 1 | 0 | 2 | 0 | 
| leaf | 0 | 93 | 723 | 92 | 25 | 11 | 24 | 6 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 53,472,003 | 236 | 40 | 0 | 4 | 64 | 19 | 18 | 29 | 15 | 0 | 130 | 107 | 23 | 1 | 21 | 41 | 64 | 1 | 14 | 0 | 
| internal_recursive.0 | 1 | prover | 23,651,975 | 140 | 19 | 0 | 4 | 50 | 16 | 16 | 20 | 13 | 0 | 70 | 48 | 21 | 1 | 20 | 19 | 50 | 1 | 12 | 0 | 
| internal_recursive.1 | 1 | prover | 17,507,975 | 120 | 14 | 0 | 4 | 50 | 18 | 17 | 18 | 13 | 0 | 55 | 33 | 21 | 0 | 20 | 15 | 50 | 1 | 12 | 0 | 
| leaf | 0 | prover | 407,935,872 | 629 | 125 | 0 | 9 | 140 | 44 | 43 | 36 | 60 | 0 | 362 | 331 | 30 | 7 | 23 | 126 | 140 | 2 | 59 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 816,542,084 | 1,570 | 289 | 0 | 160 | 653 | 362 | 360 | 139 | 151 | 60 | 626 | 566 | 60 | 15 | 44 | 290 | 653 | 1 | 90 | 0 | 
| app_proof | prover | 1 | 800,298,548 | 1,024 | 150 | 0 | 20 | 460 | 207 | 207 | 125 | 127 | 73 | 413 | 376 | 37 | 14 | 22 | 150 | 460 | 1 | 53 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 187 | 1,965 | 187 | 186 | 0 | 50 | 20 | 121,000 | 11.18 | 
| app_proof | 1 | 128 | 1,313 | 128 | 41 | 0 | 3 | 120 | 33,763 | 5.85 | 

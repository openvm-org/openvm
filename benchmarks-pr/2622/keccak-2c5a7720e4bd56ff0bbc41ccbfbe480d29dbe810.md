...
|:---|---:|---:|---:|
| Total |  23.88 |  7.31 |  7.31 |
| app_proof |  19.36 |  3.86 |  3.86 |
| leaf |  3.40 |  2.33 |  2.33 |
...
| `total_proof_time_ms ` |  3,221.33 |  19,328 |  3,824 |  3,083 |
| `execute_metered_time_ms` |  37 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  32.99 | -          |  32.99 |  32.99 |
| `execute_preflight_insns` |  205,869.67 |  1,235,218 |  207,000 |  200,218 |
| `execute_preflight_time_ms` |  186 |  1,116 |  265 |  15 |
| `execute_preflight_insn_mi/s` |  19.51 | -          |  19.60 |  19.25 |
| `trace_gen_time_ms   ` |  387 |  2,322 |  544 |  350 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  2,585 |  15,510 |  3,093 |  2,478 |
| `prover.main_trace_commit_time_ms` |  692.50 |  4,155 |  852 |  660 |
| `prover.rap_constraints_time_ms` |  1,113.17 |  6,679 |  1,224 |  1,087 |
| `prover.openings_time_ms` |  778.50 |  4,671 |  1,017 |  729 |
| `prover.rap_constraints.logup_gkr_time_ms` |  275.17 |  1,651 |  382 |  253 |
| `prover.rap_constraints.round0_time_ms` |  520 |  3,120 |  527 |  516 |
| `prover.rap_constraints.mle_rounds_time_ms` |  316.67 |  1,900 |  319 |  315 |
| `prover.openings.stacked_reduction_time_ms` |  140.67 |  844 |  142 |  140 |
| `prover.openings.stacked_reduction.round0_time_ms` |  85.33 |  512 |  86 |  84 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  54.50 |  327 |  56 |  53 |
| `prover.openings.whir_time_ms` |  637.17 |  3,823 |  874 |  587 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,697.50 |  3,395 |  2,329 |  1,066 |
| `execute_preflight_time_ms` |  23 |  46 |  31 |  15 |
| `trace_gen_time_ms   ` |  127 |  254 |  170 |  84 |
| `generate_blob_total_time_ms` |  25.50 |  51 |  34 |  17 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,569.50 |  3,139 |  2,158 |  981 |
| `prover.main_trace_commit_time_ms` |  547 |  1,094 |  719 |  375 |
| `prover.rap_constraints_time_ms` |  309 |  618 |  396 |  222 |
| `prover.openings_time_ms` |  713 |  1,426 |  1,043 |  383 |
| `prover.rap_constraints.logup_gkr_time_ms` |  65.50 |  131 |  81 |  50 |
| `prover.rap_constraints.round0_time_ms` |  149 |  298 |  194 |  104 |
...
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  38 |  76 |  44 |  32 |
| `prover.openings.whir_time_ms` |  644 |  1,288 |  957 |  331 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/2c5a7720e4bd56ff0bbc41ccbfbe480d29dbe810/keccak-2c5a7720e4bd56ff0bbc41ccbfbe480d29dbe810.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof |  |  | 3,091 | 37 | 1,235,218 | 32.99 | 0 | 19,373 |  | 
| internal_for_leaf |  | 725 |  |  |  |  |  |  | 725 | 
| internal_recursive.0 |  | 224 |  |  |  |  |  |  | 225 | 
...
| app_proof | VmAirWrapper<Rv32LoadStoreAdapterAir, LoadStoreCoreAir<4> | 4 | 348 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 36 | 725 | 36 | 13 | 4 | 6 | 4 | 
| internal_recursive.0 | 1 | 12 | 224 | 12 | 2 | 1 | 4 | 1 | 
| internal_recursive.1 | 1 | 9 | 174 | 9 | 1 | 0 | 2 | 0 | 
| leaf | 0 | 170 | 2,329 | 170 | 65 | 34 | 31 | 25 | 
| leaf | 1 | 84 | 1,066 | 84 | 32 | 17 | 15 | 10 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| intern
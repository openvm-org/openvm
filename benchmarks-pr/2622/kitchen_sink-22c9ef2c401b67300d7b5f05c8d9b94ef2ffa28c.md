...
|:---|---:|---:|---:|
| Total |  3.15 |  2.19 |  2.19 |
| app_proof |  2.38 |  1.42 |  1.42 |
| leaf |  0.41 |  0.41 |  0.41 |
...
| `total_proof_time_ms ` |  1,185 |  2,370 |  1,412 |  958 |
| `execute_metered_time_ms` |  7 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  20.45 | -          |  20.45 |  20.45 |
| `execute_preflight_insns` |  77,381.50 |  154,763 |  121,000 |  33,763 |
| `execute_preflight_time_ms` |  72.50 |  145 |  125 |  20 |
| `execute_preflight_insn_mi/s` |  8.61 | -          |  11.40 |  5.83 |
| `trace_gen_time_ms   ` |  158 |  316 |  187 |  129 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  839.50 |  1,679 |  1,017 |  662 |
| `prover.main_trace_commit_time_ms` |  220 |  440 |  290 |  150 |
| `prover.rap_constraints_time_ms` |  557.50 |  1,115 |  654 |  461 |
| `prover.openings_time_ms` |  61 |  122 |  72 |  50 |
| `prover.rap_constraints.logup_gkr_time_ms` |  140.50 |  281 |  153 |  128 |
| `prover.rap_constraints.round0_time_ms` |  284.50 |  569 |  362 |  207 |
| `prover.rap_constraints.mle_rounds_time_ms` |  131.50 |  263 |  138 |  125 |
| `prover.openings.stacked_reduction_time_ms` |  48 |  96 |  59 |  37 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/22c9ef2c401b67300d7b5f05c8d9b94ef2ffa28c/kitchen_sink-22c9ef2c401b67300d7b5f05c8d9b94ef2ffa28c.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 3 |  |  | 0 |  | 330 | 3 |  |  |  |  |  |  | 
| app_proof |  |  |  |  | 958 |  |  | 7 | 154,763 | 20.45 | 0 | 2,382 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 19 | 156 | 18 | 6 | 1 | 5 | 2 | 
| internal_recursive.0 | 1 | 10 | 110 | 9 | 1 | 0 | 3 | 1 | 
| internal_recursive.1 | 1 | 8 | 102 | 8 | 1 | 0 | 2 | 0 | 
| leaf | 0 | 99 | 408 | 99 | 25 | 11 | 25 | 6 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 53,472,003 | 137 | 40 | 0 | 4 | 64 | 19 | 19 | 29 | 15 | 0 | 31 | 8 | 23 | 1 | 21 | 41 | 64 | 1 | 14 | 0 | 
| internal_recursive.0 | 1 | prover | 23,651,975 | 100 | 19 | 0 | 4 | 50 | 16 | 16 | 20 | 13 | 0 | 30 | 9 | 21 | 1 | 20 | 19 | 50 | 1 | 12 | 0 | 
| internal_recursive.1 | 1 | prover | 17,507,975 | 94 | 14 | 0 | 4 | 49 | 16 | 16 | 18 | 13 | 0 | 30 | 8 | 21 | 0 | 20 | 15 | 49 | 1 | 12 | 0 | 
| leaf | 0 | prover | 407,935,872 | 308 | 124 | 0 | 9 | 140 | 44 | 43 | 36 | 59 | 0 | 43 | 12 | 31 | 6 | 24 | 125 | 140 | 2 | 58 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 816,542,084 | 1,017 | 289 | 0 | 161 | 654 | 362 | 361 | 138 | 153 | 61 | 72 | 13 | 59 | 15 | 44 | 290 | 654 | 1 | 91 | 0 | 
| app_proof | prover | 1 | 800,298,548 | 662 | 150 | 0 | 20 | 461 | 207 | 206 | 125 | 128 | 74 | 50 | 13 | 37 | 14 | 22 | 150 | 461 | 1 | 53 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 187 | 1,412 | 187 | 185 | 0 | 50 | 20 | 121,000 | 11.40 | 
| app_proof | 1 | 129 | 958 | 129 | 40 | 0 | 3 | 125 | 33,763 | 5.83 | 

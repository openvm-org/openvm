...
|:---|---:|---:|---:|
| Total |  4.57 |  3.25 |  3.25 |
| app_proof |  3.31 |  1.99 |  1.99 |
| leaf |  0.73 |  0.73 |  0.73 |
...
| `total_proof_time_ms ` |  1,652.50 |  3,305 |  1,984 |  1,321 |
| `execute_metered_time_ms` |  7 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  20.34 | -          |  20.34 |  20.34 |
| `execute_preflight_insns` |  77,381.50 |  154,763 |  121,000 |  33,763 |
| `execute_preflight_time_ms` |  70 |  140 |  121 |  19 |
| `execute_preflight_insn_mi/s` |  8.91 | -          |  11.73 |  6.09 |
| `trace_gen_time_ms   ` |  158.50 |  317 |  188 |  129 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,307.50 |  2,615 |  1,587 |  1,028 |
| `prover.main_trace_commit_time_ms` |  223 |  446 |  296 |  150 |
| `prover.rap_constraints_time_ms` |  561.50 |  1,123 |  658 |  465 |
| `prover.openings_time_ms` |  522 |  1,044 |  632 |  412 |
| `prover.rap_constraints.logup_gkr_time_ms` |  143 |  286 |  157 |  129 |
| `prover.rap_constraints.round0_time_ms` |  283.50 |  567 |  359 |  208 |
| `prover.rap_constraints.mle_rounds_time_ms` |  134 |  268 |  141 |  127 |
...
| `prover.openings.whir_time_ms` |  473.50 |  947 |  572 |  375 |
...
| `prover.openings_time_ms` |  131 |  131 |  131 |  131 |
...
| `prover.openings.whir_time_ms` |  108 |  108 |  108 |  108 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/2c5a7720e4bd56ff0bbc41ccbfbe480d29dbe810/kitchen_sink-2c5a7720e4bd56ff0bbc41ccbfbe480d29dbe810.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof |  |  | 1,321 | 7 | 154,763 | 20.34 | 0 | 3,317 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 19 | 256 | 19 | 6 | 1 | 5 | 2 | 
| internal_recursive.0 | 1 | 10 | 151 | 9 | 1 | 0 | 3 | 1 | 
| internal_recursive.1 | 1 | 8 | 128 | 8 | 1 | 0 | 2 | 0 | 
| leaf | 0 | 98 | 727 | 97 | 25 | 11 | 25 | 7 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 53,472,003 | 237 | 40 | 0 | 4 | 64 | 19 | 18 | 29 | 15 | 0 | 131 | 108 | 23 | 1 | 21 | 41 | 64 | 1 | 15 | 0 | 
| internal_recursive.0 | 1 | prover | 23,651,975 | 141 | 19 | 0 | 4 | 51 | 17 | 16 | 20 | 13 | 0 | 70 | 48 | 21 | 1 | 20 | 19 | 51 | 1 | 13 | 0 | 
| internal_recursive.1 | 1 | prover | 17,507,975 | 119 | 14 | 0 | 4 | 49 | 16 | 16 | 18 | 13 | 0 | 55 | 33 | 21 | 0 | 20 | 15 | 49 | 1 | 12 | 0 | 
| leaf | 0 | prover | 407,935,872 | 628 | 123 | 0 | 9 | 141 | 44 | 43 | 36 | 60 | 0 | 362 | 331 | 31 | 7 | 23 | 124 | 141 | 2 | 59 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 816,542,084 | 1,587 | 296 | 0 | 166 | 658 | 359 | 358 | 141 | 157 | 63 | 632 | 572 | 60 | 15 | 44 | 296 | 658 | 1 | 92 | 0 | 
| app_proof | prover | 1 | 800,298,548 | 1,028 | 150 | 0 | 20 | 465 | 208 | 207 | 127 | 129 | 76 | 412 | 375 | 36 | 14 | 22 | 150 | 465 | 1 | 53 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 188 | 1,984 | 188 | 187 | 0 | 51 | 19 | 121,000 | 11.73 | 
| app_proof | 1 | 129 | 1,321 | 129 | 41 | 0 | 3 | 121 | 33,763 | 6.09 | 

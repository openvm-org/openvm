...
| `total_proof_time_ms ` |  1,651.50 |  3,303 |  1,988 |  1,315 |
...
| `execute_preflight_insn_mi/s` |  8.72 | -          |  11.43 |  6.01 |
| `trace_gen_time_ms   ` |  157.50 |  315 |  187 |  128 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,307.50 |  2,615 |  1,593 |  1,022 |
| `prover.main_trace_commit_time_ms` |  221.50 |  443 |  292 |  151 |
| `prover.rap_constraints_time_ms` |  555.50 |  1,111 |  654 |  457 |
| `prover.openings_time_ms` |  528.50 |  1,057 |  645 |  412 |
| `prover.rap_constraints.logup_gkr_time_ms` |  139 |  278 |  152 |  126 |
| `prover.rap_constraints.round0_time_ms` |  283.50 |  567 |  362 |  205 |
...
| `prover.openings.whir_time_ms` |  479.50 |  959 |  584 |  375 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/2401d3a424612e185c0f47381c5ae5b7902f2924/kitchen_sink-2401d3a424612e185c0f47381c5ae5b7902f2924.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof |  |  | 1,315 | 7 | 154,763 | 20.14 | 0 | 3,315 |  | 
| internal_for_leaf |  | 253 |  |  |  |  |  |  | 254 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 18 | 253 | 18 | 6 | 1 | 5 | 2 | 
| internal_recursive.0 | 1 | 9 | 150 | 9 | 1 | 0 | 3 | 1 | 
| internal_recursive.1 | 1 | 8 | 130 | 8 | 1 | 0 | 2 | 0 | 
| leaf | 0 | 96 | 724 | 95 | 25 | 12 | 25 | 7 | 
...
| internal_recursive.0 | 1 | prover | 23,651,975 | 140 | 19 | 0 | 4 | 50 | 16 | 16 | 20 | 13 | 0 | 69 | 48 | 21 | 1 | 20 | 19 | 50 | 1 | 12 | 0 | 
| internal_recursive.1 | 1 | prover | 17,507,975 | 122 | 14 | 0 | 4 | 49 | 17 | 16 | 18 | 13 | 0 | 57 | 35 | 21 | 0 | 20 | 15 | 49 | 1 | 12 | 0 | 
| leaf | 0 | prover | 407,935,872 | 628 | 123 | 0 | 9 | 139 | 44 | 43 | 36 | 59 | 0 | 363 | 332 | 31 | 6 | 24 | 124 | 139 | 2 | 58 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 816,542,084 | 1,593 | 292 | 0 | 162 | 654 | 362 | 361 | 139 | 152 | 61 | 645 | 584 | 61 | 16 | 44 | 292 | 654 | 1 | 90 | 0 | 
| app_proof | prover | 1 | 800,298,548 | 1,022 | 150 | 0 | 20 | 457 | 205 | 205 | 125 | 126 | 73 | 412 | 375 | 37 | 14 | 22 | 151 | 457 | 1 | 53 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 187 | 1,988 | 187 | 186 | 0 | 49 | 20 | 121,000 | 11.43 | 
| app_proof | 1 | 128 | 1,315 | 128 | 40 | 0 | 3 | 123 | 33,763 | 6.01 | 

...
| `total_proof_time_ms ` |  2,609.50 |  15,657 |  2,974 |  2,517 |
...
| `execute_preflight_time_ms` |  176 |  1,056 |  262 |  16 |
| `execute_preflight_insn_mi/s` |  19.27 | -          |  19.48 |  18.68 |
| `trace_gen_time_ms   ` |  389.67 |  2,338 |  542 |  350 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,980.50 |  11,883 |  2,244 |  1,920 |
| `prover.main_trace_commit_time_ms` |  689.17 |  4,135 |  846 |  657 |
| `prover.rap_constraints_time_ms` |  1,109.17 |  6,655 |  1,218 |  1,080 |
| `prover.openings_time_ms` |  181 |  1,086 |  184 |  178 |
| `prover.rap_constraints.logup_gkr_time_ms` |  275.17 |  1,651 |  383 |  253 |
| `prover.rap_constraints.round0_time_ms` |  520.17 |  3,121 |  524 |  514 |
| `prover.rap_constraints.mle_rounds_time_ms` |  313.17 |  1,879 |  316 |  312 |
| `prover.openings.stacked_reduction_time_ms` |  139.17 |  835 |  142 |  137 |
| `prover.openings.stacked_reduction.round0_time_ms` |  83.67 |  502 |  85 |  82 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  54.67 |  328 |  56 |  54 |
| `prover.openings.whir_time_ms` |  41.33 |  248 |  44 |  39 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,088 |  2,176 |  1,408 |  768 |
| `execute_preflight_time_ms` |  22.50 |  45 |  30 |  15 |
| `trace_gen_time_ms   ` |  126.50 |  253 |  168 |  85 |
| `generate_blob_total_time_ms` |  25.50 |  51 |  34 |  17 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  961 |  1,922 |  1,239 |  683 |
| `prover.main_trace_commit_time_ms` |  544.50 |  1,089 |  715 |  374 |
| `prover.rap_constraints_time_ms` |  310.50 |  621 |  398 |  223 |
| `prover.openings_time_ms` |  105.50 |  211 |  126 |  85 |
| `prover.rap_constraints.logup_gkr_time_ms` |  66 |  132 |  82 |  50 |
| `prover.rap_constraints.round0_time_ms` |  148.50 |  297 |  193 |  104 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/da62e677245c0889a21f326470cc2cfd9357a97b/keccak-da62e677245c0889a21f326470cc2cfd9357a97b.memory.svg)
...
| app_proof |  |  |  |  | 2,530 |  |  | 37 | 1,235,218 | 33.18 | 0 | 15,702 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 36 | 516 | 36 | 13 | 5 | 6 | 4 | 
| internal_recursive.0 | 1 | 12 | 184 | 12 | 2 | 1 | 4 | 1 | 
| internal_recursive.1 | 1 | 9 | 149 | 9 | 1 | 0 | 3 | 0 | 
| leaf | 0 | 168 | 1,408 | 168 | 65 | 34 | 30 | 24 | 
| leaf | 1 | 85 | 768 | 84 | 33 | 17 | 15 | 10 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 109,497,984 |
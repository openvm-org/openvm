...
|:---|---:|---:|---:|
| Total |  23.81 |  7.30 |  7.30 |
| app_proof |  19.30 |  3.86 |  3.86 |
| leaf |  3.39 |  2.32 |  2.32 |
...
| `total_proof_time_ms ` |  3,209.83 |  19,259 |  3,818 |  3,074 |
| `execute_metered_time_ms` |  37 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  33.01 | -          |  33.01 |  33.01 |
| `execute_preflight_insns` |  205,869.67 |  1,235,218 |  207,000 |  200,218 |
| `execute_preflight_time_ms` |  175.33 |  1,052 |  261 |  15 |
| `execute_preflight_insn_mi/s` |  19.53 | -          |  19.67 |  19.27 |
| `trace_gen_time_ms   ` |  389.67 |  2,338 |  544 |  351 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  2,581.17 |  15,487 |  3,088 |  2,477 |
| `prover.main_trace_commit_time_ms` |  691.83 |  4,151 |  852 |  658 |
| `prover.rap_constraints_time_ms` |  1,113.50 |  6,681 |  1,226 |  1,088 |
| `prover.openings_time_ms` |  775 |  4,650 |  1,009 |  726 |
| `prover.rap_constraints.logup_gkr_time_ms` |  275.67 |  1,654 |  386 |  253 |
| `prover.rap_constraints.round0_time_ms` |  520.83 |  3,125 |  522 |  520 |
| `prover.rap_constraints.mle_rounds_time_ms` |  315.67 |  1,894 |  318 |  314 |
| `prover.openings.stacked_reduction_time_ms` |  139.50 |  837 |  142 |  138 |
| `prover.openings.stacked_reduction.round0_time_ms` |  84.50 |  507 |  85 |  84 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  54.33 |  326 |  56 |  53 |
| `prover.openings.whir_time_ms` |  634.83 |  3,809 |  866 |  587 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,694 |  3,388 |  2,319 |  1,069 |
| `execute_preflight_time_ms` |  22.50 |  45 |  30 |  15 |
| `trace_gen_time_ms   ` |  125.50 |  251 |  167 |  84 |
| `generate_blob_total_time_ms` |  25.50 |  51 |  34 |  17 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,568 |  3,136 |  2,151 |  985 |
| `prover.main_trace_commit_time_ms` |  546 |  1,092 |  715 |  377 |
| `prover.rap_constraints_time_ms` |  310.50 |  621 |  400 |  221 |
| `prover.openings_time_ms` |  710.50 |  1,421 |  1,035 |  386 |
| `prover.rap_constraints.logup_gkr_time_ms` |  66 |  132 |  82 |  50 |
| `prover.rap_constraints.round0_time_ms` |  148 |  296 |  194 |  102 |
| `prover.rap_constraints.mle_rounds_time_ms` |  95 |  190 |  123 |  67 |
| `prover.openings.stacked_reduction_time_ms` |  69 |  138 |  86 |  52 |
...
| `prover.openings.whir_time_ms` |  641.50 |  1,283 |  949 |  334 |

| internal_for_leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  721 |  721 |  721 |  721 |
...
| `prover.openings.whir_time_ms` |  228 |  228 |  228 |  228 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/fc9ed7b2faddb853be78aef39c88df9941d256c3/keccak-fc9ed7b2faddb853be78aef39c88df9941d256c3.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof |  |  | 3,082 | 37 | 1,235,218 | 33.01 | 0 | 19,304 |  | 
| internal_for_leaf |  | 721 |  |  |  |  |  |  | 722 | 
...
| app_proof | VmAirWrapper<Rv32RdWriteAdapterAir, Rv32AuipcCoreAir> | 0 | 347 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 |
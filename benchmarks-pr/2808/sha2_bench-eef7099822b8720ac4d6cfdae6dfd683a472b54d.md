...
|:---|---:|---:|---:|
| Total |  11.64 |  4.74 |  4.75 |
| app_proof |  9.51 |  2.62 |  2.62 |
| leaf |  1.44 |  1.44 |  1.44 |
...
| `total_proof_time_ms ` |  2,353.50 |  9,414 |  2,523 |  2,274 |
...
| `execute_preflight_time_ms` |  171.75 |  687 |  219 |  105 |
| `execute_preflight_insn_mi/s` |  33.46 | -          |  34.27 |  31.31 |
| `trace_gen_time_ms   ` |  57.75 |  231 |  63 |  54 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  2,057.75 |  8,231 |  2,218 |  2,000 |
| `prover.main_trace_commit_time_ms` |  557 |  2,228 |  648 |  526 |
| `prover.rap_constraints_time_ms` |  1,355.75 |  5,423 |  1,427 |  1,327 |
| `prover.openings_time_ms` |  143.75 |  575 |  146 |  141 |
| `prover.rap_constraints.logup_gkr_time_ms` |  349.50 |  1,398 |  426 |  324 |
| `prover.rap_constraints.round0_time_ms` |  679.75 |  2,719 |  686 |  673 |
| `prover.rap_constraints.mle_rounds_time_ms` |  325.25 |  1,301 |  327 |  323 |
| `prover.openings.stacked_reduction_time_ms` |  103.75 |  415 |  105 |  103 |
| `prover.openings.stacked_reduction.round0_time_ms` |  62.75 |  251 |  64 |  62 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  40.25 |  161 |  41 |  40 |
| `prover.openings.whir_time_ms` |  39.50 |  158 |  42 |  36 |
...
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,289 |  1,289 |  1,289 |  1,289 |
| `prover.main_trace_commit_time_ms` |  814 |  814 |  814 |  814 |
| `prover.rap_constraints_time_ms` |  364 |  364 |  364 |  364 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/eef7099822b8720ac4d6cfdae6dfd683a472b54d/sha2_bench-eef7099822b8720ac4d6cfdae6dfd683a472b54d.memory.svg)
...
| app_proof |  |  |  |  |  | 2,274 |  |  | 98 | 11,167,961 | 113.01 | 0 | 9,519 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 61,220,603 | 362 | 186 | 0 | 0 | 133 | 39 | 38 | 66 | 27 | 0 | 40 | 21 | 18 | 5 | 13 | 187 | 133 | 0 | 3 | 27 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,879 | 151 | 50 | 0 | 0 | 75 | 26 | 25 | 30 | 18 | 0 | 25 | 16 | 8 | 2 | 6 | 50 | 75 | 0 | 2 | 17 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 123 | 31 | 0 | 0 | 63 | 24 | 23 | 25 | 13 | 0 | 27 | 20 | 7 | 1 | 5 | 32 | 63 | 0 | 3 | 12 | 0 | 0 | 
| leaf | 0 | prover | 425,198,438 | 1,289 | 814 | 0 | 159 | 364 | 178 | 177 | 108 | 77 | 0 | 109 | 44 | 65 | 36 | 28 | 814 | 364 | 0 | 7 | 75 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 654,475,553 | 2,218 | 648 | 0 | 125 | 1,427 | 673 | 673 | 326 | 426 | 120 | 141 | 36 | 105 | 64 | 41 | 648 | 1,427 | 0 | 3 | 306 | 0 | 0 | 
| app_proof | prover | 1 | 654,475,276 | 2,006 | 526 | 0 | 2 | 1,335 | 683 | 683 | 327 | 324 | 0 | 144 | 40 | 104 | 63 | 40 | 526 | 1,335 | 0 | 4 | 322 | 0 | 0 | 
| app_proof | prover | 2 | 654,475,276 | 2,007 | 526 | 0 | 2 | 1,334 | 686 | 685 | 323 | 324 | 0 | 146 | 42 | 103 | 62 | 40 | 526 | 1,334 | 0 | 4 | 323 | 0 | 0 | 
| app_proof | prover | 3 | 654,475,524 | 2,000 | 527 | 0 | 2 | 1,327 | 677 | 677 | 325 | 324 | 0 | 144 | 40 | 103 | 62 | 40 | 528 | 1,327 | 0 | 4 | 323 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 63 | 2,523 | 63 | 135 | 0 | 3 | 105 | 2,851,000 | 31.31 | 
| app_proof | 1 | 57 | 2,325 | 57 | 41 | 0 | 1 | 219 | 2,851,000 | 33.100 | 
| app_proof | 2 | 57 | 2,292 | 57 | 41 | 0 | 1 | 185 | 2,851,000 | 34.27 | 
| app_proof | 3 | 54 | 2,274 | 54 | 41 | 0 | 1 | 178 | 2,614,961 | 34.26 | 

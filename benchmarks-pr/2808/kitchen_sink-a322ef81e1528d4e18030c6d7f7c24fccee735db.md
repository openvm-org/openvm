...
|:---|---:|---:|---:|
| Total |  2.57 |  1.89 |  1.89 |
| app_proof |  1.85 |  1.17 |  1.17 |
| leaf |  0.41 |  0.41 |  0.41 |
...
| `total_proof_time_ms ` |  911.50 |  1,823 |  1,141 |  682 |
| `execute_metered_time_ms` |  24 | -          | -          | -          |
| `execute_metered_insns` |  1,979,971 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  81.88 | -          |  81.88 |  81.88 |
| `execute_preflight_insns` |  989,985.50 |  1,979,971 |  1,168,000 |  811,971 |
| `execute_preflight_time_ms` |  96 |  192 |  131 |  61 |
| `execute_preflight_insn_mi/s` |  30.26 | -          |  30.71 |  29.81 |
| `trace_gen_time_ms   ` |  23.50 |  47 |  32 |  15 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  702.50 |  1,405 |  912 |  493 |
| `prover.main_trace_commit_time_ms` |  205 |  410 |  272 |  138 |
| `prover.rap_constraints_time_ms` |  451 |  902 |  589 |  313 |
| `prover.openings_time_ms` |  45.50 |  91 |  50 |  41 |
| `prover.rap_constraints.logup_gkr_time_ms` |  84.50 |  169 |  113 |  56 |
| `prover.rap_constraints.round0_time_ms` |  264 |  528 |  349 |  179 |
| `prover.rap_constraints.mle_rounds_time_ms` |  100.50 |  201 |  125 |  76 |
...
| `prover.openings.whir_time_ms` |  12.50 |  25 |  13 |  12 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  408 |  408 |  408 |  408 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/a322ef81e1528d4e18030c6d7f7c24fccee735db/kitchen_sink-a322ef81e1528d4e18030c6d7f7c24fccee735db.memory.svg)

| Module | Max (GB) | Max At |
| --- | ---: | --- |
| prover.rap_constraints | 10.17 | app_proof.prover.0 |
| prover.prove_whir_opening | 8.89 | app_proof.prover.0 |
| prover.openings | 8.89 | app_proof.prover.0 |
| prover.merkle_tree | 8.89 | app_proof.prover.0 |
| frac_sumcheck.segment_tree | 8.80 | app_proof.prover.0 |
| frac_sumcheck.gkr_rounds | 8.80 | app_proof.prover.0 |
| prover.batch_constraints.before_round0 | 8.80 | app_proof.prover.0 |
| prover.gkr_input_evals | 8.80 | app_proof.prover.0 |
| prover.batch_constraints.round0 | 8.57 | app_proof.prover.0 |
| prover.batch_constraints.fold_ple_evals | 8.57 | app_proof.prover.0 |
| prover.before_gkr_input_evals | 7.13 | app_proof.prover.0 |
| prover.stacked_commit | 7.13 | app_proof.prover.0 |
| prover.rs_code_matrix | 7.11 | app_proof.prover.0 |
...
| app_proof |  |  |  |  |  | 682 |  |  | 24 | 1,979,971 | 81.88 | 0 | 1,851 |  | 
...
| app_proof | 57 | Sha2MainAir<Sha256Config> | prover | 0 | 16,384 | 220 | 3,604,480 | 
...
| app_proof | 61 | XorinVmAir | prover | 0 | 8,192 | 673 | 5,513,216 | 
...
| app_proof | 65 | VmAirWrapper<Rv64CondRdWriteAdapterAir, Rv64JalLuiCoreAir> | prover | 0 | 65,536 | 19 | 1,245,184 | 
...
| app_proof | 57 | Sha2MainAir<Sha256Config> | prover | 1 | 16,384 | 220 | 3,604,480 | 
...
| app_proof | 61 | XorinVmAir | prover | 1 | 4,096 | 673 | 2,756,608 | 
| app_proof | 63 | VmAirWrapper<Rv64RdWriteAdapterAir, Rv64AuipcCoreAir> | prover | 1 | 16,384 | 21 | 344,064 | 
| app_proof | 64 | VmAirWrapper<Rv64JalrAdapterAir, Rv64JalrCoreAir> | prover | 1 | 65,536 | 28 | 1,835,008 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,577,915 | 120 | 38 | 0 | 0 | 63 | 21 | 20 | 29 | 12 | 0 | 17 | 10 | 7 | 1 | 6 | 38 | 63 | 0 | 1 | 11 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,703 | 80 | 16 | 0 | 0 | 49 | 18 | 17 | 20 | 10 | 0 | 14 | 8 | 5 | 1 | 4 | 17 | 49 | 0 | 1 | 9 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 74 | 11 | 0 | 0 | 48 | 19 | 18 | 19 | 10 | 0 | 13 | 8 | 5 | 0 | 4 | 11 | 48 | 0 | 1 | 9 | 0 | 0 | 
| leaf | 0 | prover | 263,565,172 | 297 | 128 | 0 | 1 | 140 | 48 | 47 | 37 | 54 | 0 | 27 | 12 | 15 | 7 | 8 | 129 | 140 | 0 | 2 | 53 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 560,358,052 | 912 | 271 | 0 | 142 | 589 | 349 | 348 | 125 | 113 | 57 | 50 | 12 | 37 | 15 | 21 | 272 | 589 | 0 | 1 | 55 | 0 | 0 | 
| app_proof | prover | 1 | 537,646,220 | 493 | 138 | 0 | 2 | 313 | 179 | 179 | 76 | 56 | 0 | 41 | 13 | 27 | 14 | 13 | 138 | 313 | 0 | 1 | 56 | 0 | 0 | 

| group | phase | segment | trace_height_constraint | weighted_sum | threshold |
| --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 0 | 50,889,698 | 2,013,265,921 | 
| app_proof | prover | 1 | 0 | 42,776,970 | 2,013,265,921 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 32 | 1,141 | 32 | 134 | 0 | 3 | 61 | 1,168,000 | 29.81 | 
| app_proof | 1 | 15 | 682 | 15 | 40 | 0 | 1 | 131 | 811,971 | 30.71 | 

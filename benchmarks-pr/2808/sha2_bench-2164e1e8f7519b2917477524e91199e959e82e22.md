...
| `total_proof_time_ms ` |  2,285.25 |  9,141 |  2,462 |  2,208 |
| `execute_metered_time_ms` |  96 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  115.91 | -          |  115.91 |  115.91 |
| `execute_preflight_insns` |  2,791,990.25 |  11,167,961 |  2,851,000 |  2,614,961 |
| `execute_preflight_time_ms` |  171 |  684 |  212 |  106 |
| `execute_preflight_insn_mi/s` |  32.70 | -          |  33.76 |  30.90 |
| `trace_gen_time_ms   ` |  57.75 |  231 |  63 |  54 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,990.50 |  7,962 |  2,155 |  1,934 |
| `prover.main_trace_commit_time_ms` |  542.25 |  2,169 |  632 |  512 |
| `prover.rap_constraints_time_ms` |  1,311 |  5,244 |  1,387 |  1,282 |
| `prover.openings_time_ms` |  136.50 |  546 |  139 |  135 |
| `prover.rap_constraints.logup_gkr_time_ms` |  339 |  1,356 |  416 |  313 |
| `prover.rap_constraints.round0_time_ms` |  659 |  2,636 |  662 |  656 |
| `prover.rap_constraints.mle_rounds_time_ms` |  311.75 |  1,247 |  314 |  310 |
| `prover.openings.stacked_reduction_time_ms` |  98 |  392 |  100 |  94 |
| `prover.openings.stacked_reduction.round0_time_ms` |  59.25 |  237 |  61 |  56 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  38.25 |  153 |  39 |  37 |
| `prover.openings.whir_time_ms` |  38 |  152 |  42 |  34 |
...
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,244 |  1,244 |  1,244 |  1,244 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/2164e1e8f7519b2917477524e91199e959e82e22/sha2_bench-2164e1e8f7519b2917477524e91199e959e82e22.memory.svg)
...
| app_proof |  |  |  |  |  | 2,208 |  |  | 96 | 11,167,961 | 115.91 | 0 | 9,244 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 61,220,603 | 351 | 181 | 0 | 0 | 130 | 37 | 37 | 64 | 27 | 0 | 39 | 20 | 18 | 5 | 12 | 182 | 130 | 0 | 3 | 26 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,879 | 149 | 48 | 0 | 0 | 72 | 24 | 24 | 29 | 17 | 0 | 28 | 19 | 8 | 1 | 6 | 49 | 72 | 0 | 2 | 16 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 116 | 31 | 0 | 0 | 61 | 23 | 22 | 24 | 13 | 0 | 23 | 16 | 7 | 1 | 5 | 31 | 61 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 425,198,438 | 1,244 | 795 | 0 | 157 | 344 | 166 | 165 | 102 | 74 | 0 | 104 | 40 | 63 | 35 | 27 | 795 | 344 | 0 | 6 | 73 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 654,475,553 | 2,155 | 632 | 0 | 122 | 1,387 | 656 | 655 | 314 | 416 | 118 | 135 | 34 | 100 | 61 | 39 | 632 | 1,387 | 0 | 3 | 297 | 0 | 0 | 
| app_proof | prover | 1 | 654,475,276 | 1,937 | 511 | 0 | 2 | 1,288 | 662 | 661 | 311 | 314 | 0 | 136 | 38 | 98 | 59 | 38 | 512 | 1,288 | 0 | 3 | 313 | 0 | 0 | 
| app_proof | prover | 2 | 654,475,276 | 1,936 | 512 | 0 | 2 | 1,287 | 661 | 660 | 312 | 313 | 0 | 136 | 42 | 94 | 56 | 37 | 512 | 1,287 | 0 | 4 | 312 | 0 | 0 | 
| app_proof | prover | 3 | 654,475,524 | 1,934 | 513 | 0 | 2 | 1,282 | 657 | 657 | 310 | 313 | 0 | 139 | 38 | 100 | 61 | 39 | 513 | 1,282 | 0 | 3 | 312 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 63 | 2,462 | 63 | 137 | 0 | 3 | 106 | 2,851,000 | 30.90 | 
| app_proof | 1 | 57 | 2,248 | 57 | 41 | 0 | 1 | 212 | 2,851,000 | 33.51 | 
| app_proof | 2 | 57 | 2,223 | 57 | 41 | 0 | 1 | 188 | 2,851,000 | 32.63 | 
| app_proof | 3 | 54 | 2,208 | 54 | 41 | 0 | 1 | 178 | 2,614,961 | 33.76 | 

...
| `total_proof_time_ms ` |  904.50 |  1,809 |  1,133 |  676 |
| `execute_metered_time_ms` |  24 | -          | -          | -          |
| `execute_metered_insns` |  1,979,971 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  81.31 | -          |  81.31 |  81.31 |
| `execute_preflight_insns` |  989,985.50 |  1,979,971 |  1,168,000 |  811,971 |
| `execute_preflight_time_ms` |  93.50 |  187 |  128 |  59 |
| `execute_preflight_insn_mi/s` |  30.38 | -          |  30.62 |  30.14 |
| `trace_gen_time_ms   ` |  24 |  48 |  33 |  15 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  698.50 |  1,397 |  906 |  491 |
| `prover.main_trace_commit_time_ms` |  202.50 |  405 |  268 |  137 |
| `prover.rap_constraints_time_ms` |  449.50 |  899 |  587 |  312 |
| `prover.openings_time_ms` |  45 |  90 |  50 |  40 |
| `prover.rap_constraints.logup_gkr_time_ms` |  85 |  170 |  114 |  56 |
| `prover.rap_constraints.round0_time_ms` |  264 |  528 |  348 |  180 |
| `prover.rap_constraints.mle_rounds_time_ms` |  100 |  200 |  124 |  76 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/caee7ffff25d219a7007373d1d6919a485dcdbc7/kitchen_sink-caee7ffff25d219a7007373d1d6919a485dcdbc7.memory.svg)
...
| app_proof |  |  |  |  |  | 676 |  |  | 24 | 1,979,971 | 81.31 | 0 | 1,838 |  | 
...
| internal_recursive.1 | 1 | 9 | 83 | 9 | 1 | 0 | 1 | 0 | 0 | 
| leaf | 0 | 107 | 403 | 107 | 24 | 11 | 18 | 4 | 4 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,577,915 | 118 | 38 | 0 | 0 | 63 | 21 | 20 | 29 | 12 | 0 | 16 | 9 | 7 | 1 | 5 | 38 | 63 | 0 | 1 | 11 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,703 | 80 | 16 | 0 | 0 | 48 | 18 | 17 | 20 | 10 | 0 | 14 | 8 | 5 | 1 | 4 | 16 | 48 | 0 | 1 | 9 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 73 | 11 | 0 | 0 | 47 | 18 | 17 | 18 | 10 | 0 | 14 | 8 | 5 | 0 | 4 | 11 | 47 | 0 | 1 | 9 | 0 | 0 | 
| leaf | 0 | prover | 263,565,172 | 296 | 127 | 0 | 1 | 139 | 48 | 47 | 37 | 54 | 0 | 28 | 12 | 15 | 7 | 8 | 128 | 139 | 0 | 2 | 53 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 560,358,052 | 906 | 268 | 0 | 140 | 587 | 348 | 347 | 124 | 114 | 57 | 50 | 12 | 37 | 15 | 21 | 268 | 587 | 0 | 1 | 56 | 0 | 0 | 
| app_proof | prover | 1 | 537,646,220 | 491 | 137 | 0 | 2 | 312 | 180 | 179 | 76 | 56 | 0 | 40 | 13 | 27 | 14 | 13 | 137 | 312 | 0 | 1 | 55 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 33 | 1,133 | 33 | 134 | 0 | 3 | 59 | 1,168,000 | 30.14 | 
| app_proof | 1 | 15 | 676 | 15 | 40 | 0 | 1 | 128 | 811,971 | 30.62 | 

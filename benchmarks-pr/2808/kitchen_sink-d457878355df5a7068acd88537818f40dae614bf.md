...
| `total_proof_time_ms ` |  995.50 |  1,991 |  1,554 |  437 |
| `execute_metered_time_ms` |  24 | -          | -          | -          |
| `execute_metered_insns` |  1,979,971 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  81.51 | -          |  81.51 |  81.51 |
| `execute_preflight_insns` |  989,985.50 |  1,979,971 |  1,445,000 |  534,971 |
| `execute_preflight_time_ms` |  74 |  148 |  84 |  64 |
| `execute_preflight_insn_mi/s` |  30.71 | -          |  31.73 |  29.70 |
| `trace_gen_time_ms   ` |  28 |  56 |  45 |  11 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  803 |  1,606 |  1,306 |  300 |
| `prover.main_trace_commit_time_ms` |  273.50 |  547 |  475 |  72 |
| `prover.rap_constraints_time_ms` |  481.50 |  963 |  762 |  201 |
| `prover.openings_time_ms` |  47 |  94 |  68 |  26 |
| `prover.rap_constraints.logup_gkr_time_ms` |  82 |  164 |  127 |  37 |
| `prover.rap_constraints.round0_time_ms` |  273 |  546 |  429 |  117 |
| `prover.rap_constraints.mle_rounds_time_ms` |  126 |  252 |  206 |  46 |
| `prover.openings.stacked_reduction_time_ms` |  34 |  68 |  52 |  16 |
| `prover.openings.stacked_reduction.round0_time_ms` |  16 |  32 |  25 |  7 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  17.50 |  35 |  26 |  9 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/d457878355df5a7068acd88537818f40dae614bf/kitchen_sink-d457878355df5a7068acd88537818f40dae614bf.memory.svg)
...
| app_proof |  |  |  |  |  | 437 |  |  | 24 | 1,979,971 | 81.51 | 0 | 2,019 |  | 
...
| leaf | 0 | 107 | 404 | 107 | 25 | 11 | 18 | 2 | 2 | 
...
| internal_recursive.0 | 1 | prover | 15,378,703 | 80 | 16 | 0 | 0 | 49 | 18 | 17 | 20 | 10 | 0 | 13 | 8 | 5 | 1 | 4 | 16 | 49 | 0 | 1 | 9 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 74 | 11 | 0 | 0 | 48 | 19 | 18 | 18 | 10 | 0 | 14 | 9 | 5 | 0 | 4 | 11 | 48 | 0 | 1 | 9 | 0 | 0 | 
| leaf | 0 | prover | 260,616,052 | 296 | 127 | 0 | 1 | 139 | 48 | 47 | 37 | 54 | 0 | 28 | 13 | 15 | 7 | 8 | 128 | 139 | 0 | 2 | 53 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 902,782,844 | 1,306 | 475 | 0 | 269 | 762 | 429 | 427 | 206 | 127 | 66 | 68 | 15 | 52 | 25 | 26 | 475 | 762 | 0 | 1 | 59 | 0 | 0 | 
| app_proof | prover | 1 | 279,963,980 | 300 | 72 | 0 | 1 | 201 | 117 | 117 | 46 | 37 | 0 | 26 | 9 | 16 | 7 | 9 | 72 | 201 | 0 | 1 | 36 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 45 | 1,554 | 45 | 137 | 0 | 3 | 64 | 1,445,000 | 29.70 | 
| app_proof | 1 | 11 | 437 | 10 | 40 | 0 | 1 | 84 | 534,971 | 31.73 | 

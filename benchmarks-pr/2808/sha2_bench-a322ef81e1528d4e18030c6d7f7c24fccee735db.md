...
|:---|---:|---:|---:|
| Total |  11.57 |  4.71 |  4.71 |
| app_proof |  9.47 |  2.60 |  2.60 |
| leaf |  1.43 |  1.43 |  1.43 |
...
| `total_proof_time_ms ` |  2,342.75 |  9,371 |  2,505 |  2,269 |
| `execute_metered_time_ms` |  97 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  114.53 | -          |  114.53 |  114.53 |
| `execute_preflight_insns` |  2,791,990.25 |  11,167,961 |  2,851,000 |  2,614,961 |
| `execute_preflight_time_ms` |  172.50 |  690 |  219 |  104 |
| `execute_preflight_insn_mi/s` |  33.67 | -          |  34.46 |  31.57 |
| `trace_gen_time_ms   ` |  57.75 |  231 |  63 |  54 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  2,046.50 |  8,186 |  2,201 |  1,994 |
| `prover.main_trace_commit_time_ms` |  552.75 |  2,211 |  644 |  521 |
| `prover.rap_constraints_time_ms` |  1,351.75 |  5,407 |  1,418 |  1,326 |
| `prover.openings_time_ms` |  141.25 |  565 |  143 |  138 |
| `prover.rap_constraints.logup_gkr_time_ms` |  349.25 |  1,397 |  425 |  322 |
| `prover.rap_constraints.round0_time_ms` |  682 |  2,728 |  689 |  673 |
| `prover.rap_constraints.mle_rounds_time_ms` |  319.50 |  1,278 |  321 |  318 |
| `prover.openings.stacked_reduction_time_ms` |  101.50 |  406 |  103 |  98 |
| `prover.openings.stacked_reduction.round0_time_ms` |  60.75 |  243 |  62 |  58 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  39.75 |  159 |  40 |  39 |
| `prover.openings.whir_time_ms` |  39 |  156 |  42 |  35 |
...
| `prover.rap_constraints.round0_time_ms` |  173 |  173 |  173 |  173 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/a322ef81e1528d4e18030c6d7f7c24fccee735db/sha2_bench-a322ef81e1528d4e18030c6d7f7c24fccee735db.memory.svg)

| Module | Max (GB) | Max At |
| --- | ---: | --- |
| prover.batch_constraints.before_round0 | 11.30 | app_proof.prover.3 |
| frac_sumcheck.gkr_rounds | 11.30 | app_proof.prover.3 |
| frac_sumcheck.segment_tree | 11.20 | app_proof.prover.0 |
| prover.gkr_input_evals | 11.20 | app_proof.prover.0 |
| prover.rap_constraints | 11.16 | app_proof.prover.0 |
| prover.batch_constraints.fold_ple_evals | 10.56 | app_proof.prover.0 |
| prover.batch_constraints.round0 | 10.56 | app_proof.prover.0 |
| prover.prove_whir_opening | 9.95 | app_proof.prover.0 |
| prover.merkle_tree | 9.95 | app_proof.prover.0 |
| prover.openings | 9.95 | app_proof.prover.0 |
...
| 18 | VmAirWrapper<Rv64BranchAdapterAir, BranchLessThanCoreAir<8, 8> | 20 | 37 | 3 | 
...
| 24 | VmAirWrapper<Rv64BaseAluAdapterAir, LessThanCoreAir<8, 8> | 25 | 44 | 3 | 
...
| app_proof |  |  |  |  |  | 2,269 |  |  | 97 | 11,167,961 | 114.53 | 0 | 9,475 |  | 
| internal_for_leaf |  |  |  | 383 |  |  |  |  |  |  |  |  |  | 383 | 
...
| app_proof | 12 | Sha2MainAir<Sha256Config> | prover | 0 | 65,536 | 220 | 14,417,920 | 
...
| app_proof | 12 | Sha2MainAir<Sha256Config> | prover | 1 | 65,536 | 220 | 14,417,920 | 
...
| app_proof | 12 | Sha2MainAir<Sha256Config> | prover | 2 | 65,536 | 220 | 14,417,920 | 
...
| app_proof | 12 | Sha2MainAir<Sha256Config> | prover | 3 | 65,536 | 220 | 14,417,920 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 61,220,603 | 358 | 187 | 0 | 0 | 132 | 39 | 38 | 66 | 27 | 0 | 37 | 18 | 18 | 5 | 12 | 187 | 132 | 0 | 3 | 26 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,879 | 152 | 48 | 0 | 0 | 71 | 24 | 24 | 29 | 16 | 0 | 31 | 22 | 8 | 2 | 6 | 49 | 71 | 0 | 2 | 16 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 118 | 32 | 0 | 0 | 61 | 23 | 22 | 24 | 13 | 0 | 24 | 17 | 7 | 1 | 5 | 32 | 61 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 425,198,438 | 1,279 | 809 | 0 | 156 | 355 | 173 | 172 | 104 | 76 | 0 | 113 | 48 | 65 | 36 | 28 | 810 | 355 | 0 | 7 | 74 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 654,475,553 | 2,201 | 644 | 0 | 124 | 1,418 | 673 | 673 | 319 | 425 | 120 | 138 | 35 | 102 | 61 | 40 | 644 | 1,418 | 0 | 3 | 304 | 0 | 0 | 
| app_proof | prover | 1 | 654,475,276 | 1,997 | 521 | 0 | 2 | 1,333 | 689 | 689 | 321 | 322 | 0 | 143 | 39 | 103 | 62 | 40 | 521 | 1,333 | 0 | 3 | 320 | 0 | 0 | 
| app_proof | prover | 2 | 654,475,276 | 1,994 | 522 | 0 | 2 | 1,330 | 689 | 689 | 318 | 322 | 0 | 141 | 42 | 98 | 58 | 39 | 522 | 1,330 | 0 | 4 | 321 | 0 | 0 | 
| app_proof | prover | 3 | 654,475,524 | 1,994 | 523 | 0 | 2 | 1,326 | 677 | 677 | 320 | 328 | 0 | 143 | 40 | 103 | 62 | 40 | 524 | 1,326 | 0 | 4 | 327 | 0 | 0 | 

| group | phase | segment | trace_height_constraint | weighted_sum | threshold |
| --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 0 | 112,550,299 | 2,013,265,921 | 
| app_proof | prover | 1 | 0 | 112,550,154 | 2,013,265,921 | 
| app_proof | prover | 2 | 0 | 112,550,154 | 2,013,265,921 | 
| app_proof | prover | 3 | 0 | 112,550,270 | 2,013,265,921 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 63 | 2,505 | 63 | 135 | 0 | 3 | 104 | 2,851,000 | 31.57 | 
| app_proof | 1 | 57 | 2,316 | 57 | 41 | 0 | 1 | 219 | 2,851,000 | 34.24 | 
| app_proof | 2 | 57 | 2,281 | 57 | 41 | 0 | 1 | 188 | 2,851,000 | 34.40 | 
| app_proof | 3 | 54 | 2,269 | 54 | 41 | 0 | 1 | 179 | 2,614,961 | 34.46 | 

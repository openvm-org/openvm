...
|:---|---:|---:|---:|
| Total |  17.28 |  5.06 |  5.06 |
| app_proof |  14.11 |  2.65 |  2.65 |
| leaf |  2.38 |  1.61 |  1.61 |
...
| `total_proof_time_ms ` |  2,327.50 |  13,965 |  2,512 |  2,236 |
...
| `execute_preflight_time_ms` |  241.50 |  1,449 |  324 |  90 |
| `execute_preflight_insn_mi/s` |  31.99 | -          |  32.79 |  29.50 |
| `trace_gen_time_ms   ` |  36.83 |  221 |  51 |  34 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,991 |  11,946 |  2,233 |  1,924 |
| `prover.main_trace_commit_time_ms` |  695.33 |  4,172 |  854 |  662 |
| `prover.rap_constraints_time_ms` |  1,113 |  6,678 |  1,194 |  1,076 |
| `prover.openings_time_ms` |  181.67 |  1,090 |  186 |  175 |
| `prover.rap_constraints.logup_gkr_time_ms` |  286.67 |  1,720 |  349 |  257 |
| `prover.rap_constraints.round0_time_ms` |  509.50 |  3,057 |  512 |  503 |
| `prover.rap_constraints.mle_rounds_time_ms` |  315.83 |  1,895 |  336 |  306 |
...
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  52.50 |  315 |  54 |  51 |
| `prover.openings.whir_time_ms` |  46 |  276 |  50 |  40 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,189 |  2,378 |  1,611 |  767 |
| `execute_preflight_time_ms` |  5 |  10 |  5 |  5 |
| `trace_gen_time_ms   ` |  134.50 |  269 |  179 |  90 |
| `generate_blob_total_time_ms` |  24 |  48 |  32 |  16 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,053.50 |  2,107 |  1,431 |  676 |
| `prover.main_trace_commit_time_ms` |  638 |  1,276 |  900 |  376 |
| `prover.rap_constraints_time_ms` |  322 |  644 |  415 |  229 |
| `prover.openings_time_ms` |  92.50 |  185 |  115 |  70 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/d457878355df5a7068acd88537818f40dae614bf/keccak-d457878355df5a7068acd88537818f40dae614bf.memory.svg)
...
| app_proof |  |  |  |  |  | 2,236 |  |  | 142 | 14,365,133 | 100.71 | 0 | 14,114 |  | 
...
| leaf | 0 | 179 | 1,611 | 179 | 63 | 32 | 5 | 7 | 7 | 
| leaf | 1 | 90 | 767 | 90 | 32 | 16 | 5 | 7 | 7 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 81,415,028 | 462 | 243 | 0 | 1 | 172 | 49 | 48 | 92 | 30 | 0 | 46 | 22 | 23 | 7 | 15 | 244 | 172 | 0 | 3 | 29 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,879 | 150 | 49 | 0 | 0 | 72 | 25 | 24 | 29 | 17 | 0 | 27 | 18 | 8 | 1 | 6 | 49 | 72 | 0 | 2 | 17 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 120 | 31 | 0 | 0 | 62 | 23 | 23 | 25 | 13 | 0 | 26 | 19 | 7 | 1 | 5 | 31 | 62 | 0 | 2 | 13 | 0 | 0 | 
| leaf | 0 | prover | 476,578,662 | 1,431 | 899 | 0 | 178 | 415 | 205 | 204 | 125 | 85 | 0 | 115 | 43 | 71 | 40 | 30 | 900 | 415 | 0 | 7 | 84 | 0 | 0 | 
| leaf | 1 | prover | 240,255,732 | 676 | 376 | 0 | 1 | 229 | 109 | 108 | 68 | 52 | 0 | 70 | 33 | 37 | 19 | 17 | 376 | 229 | 0 | 6 | 50 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 840,496,780 | 2,233 | 853 | 0 | 193 | 1,194 | 509 | 509 | 336 | 349 | 95 | 184 | 48 | 135 | 82 | 53 | 854 | 1,194 | 0 | 3 | 252 | 0 | 0 | 
| app_proof | prover | 1 | 840,496,780 | 1,939 | 662 | 0 | 3 | 1,101 | 512 | 512 | 330 | 257 | 0 | 175 | 40 | 134 | 81 | 52 | 663 | 1,101 | 0 | 3 | 256 | 0 | 0 | 
| app_proof | prover | 2 | 840,496,780 | 1,997 | 662 | 0 | 3 | 1,153 | 503 | 502 | 311 | 338 | 99 | 181 | 46 | 134 | 82 | 51 | 662 | 1,153 | 0 | 3 | 238 | 0 | 0 | 
| app_proof | prover | 3 | 840,496,780 | 1,924 | 664 | 0 | 3 | 1,077 | 511 | 510 | 306 | 259 | 0 | 183 | 47 | 136 | 81 | 54 | 664 | 1,077 | 0 | 4 | 257 | 0 | 0 | 
| app_proof | prover | 4 | 840,496,780 | 1,928 | 664 | 0 | 3 | 1,076 | 511 | 511 | 306 | 258 | 0 | 186 | 50 | 136 | 83 | 53 | 664 | 1,076 | 0 | 3 | 257 | 0 | 0 | 
| app_proof | prover | 5 | 840,496,780 | 1,925 | 665 | 0 | 3 | 1,077 | 511 | 511 | 306 | 259 | 0 | 181 | 45 | 136 | 83 | 52 | 665 | 1,077 | 0 | 4 | 257 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 51 | 2,512 | 51 | 135 | 0 | 3 | 90 | 2,413,000 | 29.50 | 
| app_proof | 1 | 34 | 2,339 | 34 | 41 | 0 | 1 | 324 | 2,413,000 | 31.83 | 
| app_proof | 2 | 34 | 2,340 | 34 | 41 | 0 | 1 | 267 | 2,413,000 | 32.61 | 
| app_proof | 3 | 34 | 2,267 | 34 | 41 | 0 | 1 | 266 | 2,413,000 | 32.79 | 
| app_proof | 4 | 34 | 2,271 | 34 | 41 | 0 | 1 | 267 | 2,413,000 | 32.65 | 
| app_proof | 5 | 34 | 2,236 | 34 | 41 | 0 | 1 | 235 | 2,300,133 | 32.55 | 

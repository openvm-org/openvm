...
|:---|---:|---:|---:|
| Total |  17.42 |  5.16 |  5.16 |
| app_proof |  14.21 |  2.72 |  2.72 |
| leaf |  2.41 |  1.63 |  1.63 |
...
| `total_proof_time_ms ` |  2,344.17 |  14,065 |  2,576 |  2,253 |
| `execute_metered_time_ms` |  141 | -          | -          | -          |
| `execute_metered_insns` |  14,365,133 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  101.31 | -          |  101.31 |  101.31 |
| `execute_preflight_insns` |  2,394,188.83 |  14,365,133 |  2,413,000 |  2,300,133 |
| `execute_preflight_time_ms` |  247.50 |  1,485 |  339 |  93 |
| `execute_preflight_insn_mi/s` |  31.68 | -          |  32.41 |  29.88 |
| `trace_gen_time_ms   ` |  36.50 |  219 |  50 |  33 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  2,002.17 |  12,013 |  2,295 |  1,932 |
| `prover.main_trace_commit_time_ms` |  707.33 |  4,244 |  869 |  672 |
| `prover.rap_constraints_time_ms` |  1,108.17 |  6,649 |  1,243 |  1,074 |
| `prover.openings_time_ms` |  185.33 |  1,112 |  191 |  179 |
| `prover.rap_constraints.logup_gkr_time_ms` |  257.17 |  1,543 |  319 |  243 |
| `prover.rap_constraints.round0_time_ms` |  533.17 |  3,199 |  609 |  514 |
| `prover.rap_constraints.mle_rounds_time_ms` |  317.17 |  1,903 |  338 |  312 |
| `prover.openings.stacked_reduction_time_ms` |  139.83 |  839 |  141 |  138 |
| `prover.openings.stacked_reduction.round0_time_ms` |  84.33 |  506 |  86 |  83 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  54.50 |  327 |  56 |  53 |
| `prover.openings.whir_time_ms` |  45.17 |  271 |  50 |  41 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,205.50 |  2,411 |  1,632 |  779 |
| `execute_preflight_time_ms` |  5.50 |  11 |  6 |  5 |
| `trace_gen_time_ms   ` |  135.50 |  271 |  180 |  91 |
| `generate_blob_total_time_ms` |  24.50 |  49 |  33 |  16 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,069 |  2,138 |  1,451 |  687 |
| `prover.main_trace_commit_time_ms` |  645 |  1,290 |  911 |  379 |
| `prover.rap_constraints_time_ms` |  327 |  654 |  421 |  233 |
| `prover.openings_time_ms` |  97 |  194 |  119 |  75 |
...
| `prover.openings.whir_time_ms` |  40.50 |  81 |  45 |  36 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/eef7099822b8720ac4d6cfdae6dfd683a472b54d/keccak-eef7099822b8720ac4d6cfdae6dfd683a472b54d.memory.svg)

| Module | Max (GB) | Max At |
| --- | ---: | --- |
| prover.rap_constraints | 14.36 | app_proof.prover.0 |
| prover.merkle_tree | 13.01 | app_proof.prover.0 |
| prover.prove_whir_opening | 13.01 | app_proof.prover.0 |
| prover.openings | 13.01 | app_proof.prover.0 |
| prover.batch_constraints.fold_ple_evals | 12.50 | app_proof.prover.0 |
| prover.batch_constraints.round0 | 12.50 | app_proof.prover.0 |
| prover.batch_constraints.before_round0 | 12.38 | app_proof.prover.0 |
| frac_sumcheck.gkr_rounds | 12.38 | app_proof.prover.0 |
| frac_sumcheck.segment_tree | 12.24 | app_proof.prover.0 |
| prover.gkr_input_evals | 12.24 | app_proof.prover.0 |
| prover.before_gkr_input_evals | 9.88 | app_proof.prover.0 |
| prover.stacked_commit | 9.88 | app_proof.prover.0 |
| prover.rs_code_matrix | 9.86 | app_proof.prover.0 |
...
| app_proof |  |  |  |  |  | 2,253 |  |  | 141 | 14,365,133 | 101.31 | 0 | 14,212 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 40 | 508 | 40 | 13 | 4 | 2 | 2 | 2 | 
| internal_recursive.0 | 1 | 14 | 167 | 14 | 2 | 1 | 2 | 2 | 2 | 
| internal_recursive.1 | 1 | 9 | 133 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 180 | 1,632 | 180 | 64 | 33 | 6 | 7 | 7 | 
| leaf | 1 | 91 | 779 | 91 | 32 | 16 | 5 | 7 | 7 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 81,415,028 | 467 | 247 | 0 | 1 | 175 | 50 | 49 | 93 | 31 | 0 | 44 | 20 | 23 | 7 | 16 | 247 | 175 | 0 | 3 | 30 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,879 | 152 | 50 | 0 | 0 | 74 | 26 | 25 | 30 | 18 | 0 | 27 | 18 | 8 | 2 | 6 | 50 | 74 | 0 | 2 | 17 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 123 | 32 | 0 | 0 | 63 | 24 | 23 | 24 | 14 | 0 | 27 | 20 | 7 | 1 | 5 | 32 | 63 | 0 | 2 | 13 | 0 | 0 | 
| leaf | 0 | prover | 476,578,662 | 1,451 | 910 | 0 | 180 | 421 | 207 | 207 | 125 | 87 | 0 | 119 | 45 | 74 | 41 | 32 | 911 | 421 | 0 | 7 | 86 | 0 | 0 | 
| leaf | 1 | prover | 240,255,732 | 687 | 378 | 0 | 1 | 233 | 112 | 111 | 69 | 52 | 0 | 75 | 36 | 38 | 20 | 17 | 379 | 233 | 0 | 7 | 51 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 850,917,004 | 2,295 | 869 | 0 | 196 | 1,243 | 609 | 608 | 315 | 319 | 81 | 182 | 44 | 138 | 84 | 53 | 869 | 1,243 | 0 | 4 | 235 | 0 | 0 | 
| app_proof | prover | 1 | 850,917,004 | 1,963 | 674 | 0 | 3 | 1,096 | 514 | 513 | 338 | 243 | 0 | 191 | 50 | 141 | 86 | 54 | 674 | 1,096 | 0 | 4 | 242 | 0 | 0 | 
| app_proof | prover | 2 | 850,917,004 | 1,932 | 672 | 0 | 2 | 1,079 | 521 | 521 | 312 | 246 | 0 | 179 | 41 | 138 | 83 | 54 | 672 | 1,079 | 0 | 4 | 244 | 0 | 0 | 
| app_proof | prover | 3 | 850,917,004 | 1,944 | 676 | 0 | 2 | 1,077 | 518 | 517 | 312 | 246 | 0 | 190 | 48 | 141 | 84 | 56 | 676 | 1,077 | 0 | 4 | 245 | 0 | 0 | 
| app_proof | prover | 4 | 850,917,004 | 1,939 | 676 | 0 | 3 | 1,080 | 522 | 522 | 312 | 245 | 0 | 182 | 41 | 140 | 84 | 55 | 676 | 1,080 | 0 | 4 | 244 | 0 | 0 | 
| app_proof | prover | 5 | 850,917,004 | 1,940 | 676 | 0 | 3 | 1,074 | 515 | 515 | 314 | 244 | 0 | 188 | 47 | 141 | 85 | 55 | 677 | 1,074 | 0 | 4 | 243 | 0 | 0 | 

| group | phase | segment | trace_height_constraint | weighted_sum | threshold |
| --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 0 | 75,224,842 | 2,013,265,921 | 
| app_proof | prover | 1 | 0 | 75,224,842 | 2,013,265,921 | 
| app_proof | prover | 2 | 0 | 75,224,842 | 2,013,265,921 | 
| app_proof | prover | 3 | 0 | 75,224,842 | 2,013,265,921 | 
| app_proof | prover | 4 | 0 | 75,224,842 | 2,013,265,921 | 
| app_proof | prover | 5 | 0 | 75,224,842 | 2,013,265,921 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 50 | 2,576 | 50 | 136 | 0 | 3 | 93 | 2,413,000 | 29.88 | 
| app_proof | 1 | 34 | 2,378 | 34 | 41 | 0 | 1 | 339 | 2,413,000 | 32.11 | 
| app_proof | 2 | 34 | 2,278 | 34 | 41 | 0 | 1 | 270 | 2,413,000 | 32.41 | 
| app_proof | 3 | 34 | 2,292 | 34 | 41 | 0 | 1 | 272 | 2,413,000 | 32.26 | 
| app_proof | 4 | 34 | 2,288 | 34 | 41 | 0 | 1 | 273 | 2,413,000 | 31.17 | 
| app_proof | 5 | 33 | 2,253 | 33 | 41 | 0 | 1 | 238 | 2,300,133 | 32.25 | 

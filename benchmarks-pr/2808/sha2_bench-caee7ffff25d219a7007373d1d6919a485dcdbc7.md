...
|:---|---:|---:|---:|
| Total |  11.36 |  4.64 |  4.64 |
| app_proof |  9.28 |  2.57 |  2.57 |
| leaf |  1.40 |  1.40 |  1.40 |
...
| `total_proof_time_ms ` |  2,295.75 |  9,183 |  2,473 |  2,209 |
...
| `execute_preflight_time_ms` |  169.25 |  677 |  214 |  105 |
| `execute_preflight_insn_mi/s` |  33.62 | -          |  34.44 |  31.21 |
| `trace_gen_time_ms   ` |  58 |  232 |  64 |  54 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  2,003.50 |  8,014 |  2,169 |  1,938 |
| `prover.main_trace_commit_time_ms` |  544.50 |  2,178 |  637 |  513 |
| `prover.rap_constraints_time_ms` |  1,319.50 |  5,278 |  1,394 |  1,286 |
| `prover.openings_time_ms` |  138 |  552 |  140 |  136 |
| `prover.rap_constraints.logup_gkr_time_ms` |  342.25 |  1,369 |  422 |  315 |
| `prover.rap_constraints.round0_time_ms` |  663.25 |  2,653 |  672 |  654 |
| `prover.rap_constraints.mle_rounds_time_ms` |  313 |  1,252 |  317 |  310 |
| `prover.openings.stacked_reduction_time_ms` |  100.50 |  402 |  101 |  100 |
| `prover.openings.stacked_reduction.round0_time_ms` |  60.75 |  243 |  61 |  60 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  39 |  156 |  39 |  39 |
| `prover.openings.whir_time_ms` |  37.25 |  149 |  39 |  35 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,402 |  1,402 |  1,402 |  1,402 |
| `execute_preflight_time_ms` |  3 |  3 |  3 |  3 |
| `trace_gen_time_ms   ` |  153 |  153 |  153 |  153 |
| `generate_blob_total_time_ms` |  25 |  25 |  25 |  25 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,249 |  1,249 |  1,249 |  1,249 |
| `prover.main_trace_commit_time_ms` |  799 |  799 |  799 |  799 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/caee7ffff25d219a7007373d1d6919a485dcdbc7/sha2_bench-caee7ffff25d219a7007373d1d6919a485dcdbc7.memory.svg)
...
| app_proof |  |  |  |  |  | 2,209 |  |  | 98 | 11,167,961 | 113.50 | 0 | 9,289 |  | 
| internal_for_leaf |  |  |  | 377 |  |  |  |  |  |  |  |  |  | 377 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 61,220,603 | 353 | 182 | 0 | 0 | 130 | 37 | 37 | 64 | 27 | 0 | 39 | 20 | 18 | 5 | 12 | 183 | 130 | 0 | 2 | 26 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,879 | 150 | 48 | 0 | 0 | 72 | 24 | 24 | 29 | 17 | 0 | 29 | 20 | 8 | 1 | 6 | 49 | 72 | 0 | 2 | 16 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 122 | 31 | 0 | 0 | 61 | 22 | 22 | 24 | 14 | 0 | 29 | 21 | 7 | 1 | 5 | 31 | 61 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 425,198,438 | 1,249 | 798 | 0 | 160 | 346 | 169 | 168 | 102 | 74 | 0 | 103 | 39 | 63 | 36 | 27 | 799 | 346 | 0 | 6 | 73 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 654,475,553 | 2,169 | 637 | 0 | 126 | 1,394 | 654 | 654 | 317 | 422 | 121 | 136 | 35 | 101 | 61 | 39 | 637 | 1,394 | 0 | 3 | 300 | 0 | 0 | 
| app_proof | prover | 1 | 654,475,276 | 1,950 | 513 | 0 | 2 | 1,297 | 667 | 667 | 313 | 316 | 0 | 138 | 37 | 100 | 61 | 39 | 514 | 1,297 | 0 | 3 | 314 | 0 | 0 | 
| app_proof | prover | 2 | 654,475,276 | 1,957 | 514 | 0 | 2 | 1,301 | 672 | 672 | 312 | 316 | 0 | 140 | 39 | 101 | 61 | 39 | 514 | 1,301 | 0 | 3 | 315 | 0 | 0 | 
| app_proof | prover | 3 | 654,475,524 | 1,938 | 513 | 0 | 2 | 1,286 | 660 | 659 | 310 | 315 | 0 | 138 | 38 | 100 | 60 | 39 | 513 | 1,286 | 0 | 3 | 314 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 64 | 2,473 | 64 | 135 | 0 | 3 | 105 | 2,851,000 | 31.21 | 
| app_proof | 1 | 57 | 2,263 | 57 | 41 | 0 | 1 | 214 | 2,851,000 | 34.39 | 
| app_proof | 2 | 57 | 2,238 | 57 | 41 | 0 | 1 | 182 | 2,851,000 | 34.42 | 
| app_proof | 3 | 54 | 2,209 | 54 | 41 | 0 | 1 | 176 | 2,614,961 | 34.44 | 

...
| `total_proof_time_ms ` |  391.75 |  1,567 |  512 |  220 |
| `execute_metered_time_ms` |  20 | -          | -          | -          |
| `execute_metered_insns` |  4,000,051 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  199.70 | -          |  199.70 |  199.70 |
| `execute_preflight_insns` |  1,000,012.75 |  4,000,051 |  1,310,000 |  70,051 |
| `execute_preflight_time_ms` |  38.50 |  154 |  53 |  4 |
| `execute_preflight_insn_mi/s` |  36.77 | -          |  37.08 |  36.03 |
| `trace_gen_time_ms   ` |  72.50 |  290 |  101 |  62 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  215 |  860 |  265 |  73 |
| `prover.main_trace_commit_time_ms` |  42.50 |  170 |  52 |  15 |
| `prover.rap_constraints_time_ms` |  140.75 |  563 |  177 |  34 |
| `prover.openings_time_ms` |  30.25 |  121 |  37 |  23 |
| `prover.rap_constraints.logup_gkr_time_ms` |  97.50 |  390 |  125 |  17 |
| `prover.rap_constraints.round0_time_ms` |  27.50 |  110 |  34 |  9 |
...
| `prover.openings.whir_time_ms` |  20.75 |  83 |  26 |  19 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/eef7099822b8720ac4d6cfdae6dfd683a472b54d/fibonacci-eef7099822b8720ac4d6cfdae6dfd683a472b54d.memory.svg)
...
| app_proof |  |  |  |  |  | 220 |  |  | 20 | 4,000,051 | 199.70 | 0 | 1,593 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 27,289,339 | 210 | 81 | 0 | 0 | 96 | 31 | 31 | 45 | 19 | 0 | 32 | 21 | 11 | 2 | 8 | 81 | 96 | 0 | 2 | 18 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,703 | 142 | 46 | 0 | 0 | 67 | 25 | 24 | 28 | 14 | 0 | 28 | 19 | 8 | 1 | 6 | 46 | 67 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 118 | 31 | 0 | 0 | 60 | 22 | 21 | 24 | 13 | 0 | 25 | 18 | 7 | 1 | 5 | 32 | 60 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 103,146,406 | 376 | 170 | 0 | 0 | 160 | 70 | 69 | 46 | 43 | 0 | 45 | 27 | 18 | 8 | 9 | 171 | 160 | 0 | 5 | 42 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 65,794,666 | 261 | 51 | 0 | 0 | 177 | 34 | 34 | 17 | 125 | 0 | 31 | 19 | 11 | 5 | 5 | 52 | 177 | 0 | 3 | 124 | 0 | 0 | 
| app_proof | prover | 1 | 65,748,660 | 261 | 52 | 0 | 0 | 177 | 33 | 33 | 17 | 125 | 0 | 30 | 19 | 11 | 5 | 5 | 52 | 177 | 0 | 3 | 125 | 0 | 0 | 
| app_proof | prover | 2 | 65,748,660 | 265 | 51 | 0 | 0 | 175 | 34 | 33 | 18 | 123 | 0 | 37 | 26 | 11 | 6 | 5 | 51 | 175 | 0 | 3 | 123 | 0 | 0 | 
| app_proof | prover | 3 | 9,268,712 | 73 | 15 | 0 | 0 | 34 | 9 | 9 | 7 | 17 | 0 | 23 | 19 | 3 | 0 | 2 | 15 | 34 | 0 | 2 | 16 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 62 | 512 | 62 | 136 | 0 | 3 | 53 | 1,310,000 | 36.92 | 
| app_proof | 1 | 63 | 415 | 63 | 40 | 0 | 1 | 49 | 1,310,000 | 37.08 | 
| app_proof | 2 | 64 | 420 | 64 | 40 | 0 | 1 | 48 | 1,310,000 | 37.07 | 
| app_proof | 3 | 101 | 220 | 101 | 40 | 0 | 1 | 4 | 70,051 | 36.03 | 

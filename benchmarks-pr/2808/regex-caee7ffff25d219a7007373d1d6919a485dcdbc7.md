...
| `total_proof_time_ms ` |  737 |  1,474 |  876 |  598 |
| `execute_metered_time_ms` |  34 | -          | -          | -          |
| `execute_metered_insns` |  4,090,656 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  119.57 | -          |  119.57 |  119.57 |
| `execute_preflight_insns` |  2,045,328 |  4,090,656 |  2,327,000 |  1,763,656 |
| `execute_preflight_time_ms` |  86 |  172 |  96 |  76 |
| `execute_preflight_insn_mi/s` |  32.83 | -          |  34.48 |  31.17 |
| `trace_gen_time_ms   ` |  36.50 |  73 |  44 |  29 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  524.50 |  1,049 |  613 |  436 |
| `prover.main_trace_commit_time_ms` |  122 |  244 |  138 |  106 |
| `prover.rap_constraints_time_ms` |  355 |  710 |  423 |  287 |
| `prover.openings_time_ms` |  46.50 |  93 |  51 |  42 |
| `prover.rap_constraints.logup_gkr_time_ms` |  220 |  440 |  292 |  148 |
| `prover.rap_constraints.round0_time_ms` |  93.50 |  187 |  102 |  85 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/caee7ffff25d219a7007373d1d6919a485dcdbc7/regex-caee7ffff25d219a7007373d1d6919a485dcdbc7.memory.svg)
...
| app_proof |  |  |  |  |  | 598 |  |  | 34 | 4,090,656 | 119.57 | 0 | 1,522 |  | 
...
| internal_recursive.1 | 1 | 9 | 130 | 8 | 1 | 0 | 1 | 0 | 0 | 
| leaf | 0 | 51 | 356 | 51 | 14 | 3 | 4 | 1 | 1 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 27,289,339 | 212 | 81 | 0 | 0 | 99 | 33 | 33 | 45 | 19 | 0 | 30 | 18 | 11 | 2 | 8 | 82 | 99 | 0 | 2 | 18 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,703 | 141 | 46 | 0 | 0 | 66 | 24 | 24 | 28 | 13 | 0 | 27 | 19 | 8 | 1 | 6 | 46 | 66 | 0 | 2 | 12 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 120 | 31 | 0 | 0 | 62 | 24 | 23 | 24 | 13 | 0 | 26 | 19 | 7 | 1 | 5 | 31 | 62 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 79,659,764 | 304 | 128 | 0 | 0 | 133 | 54 | 53 | 37 | 41 | 0 | 42 | 27 | 15 | 6 | 8 | 128 | 133 | 0 | 5 | 41 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 169,896,914 | 613 | 138 | 0 | 0 | 423 | 85 | 84 | 45 | 292 | 72 | 51 | 24 | 26 | 14 | 12 | 138 | 423 | 0 | 3 | 219 | 0 | 0 | 
| app_proof | prover | 1 | 129,384,977 | 436 | 106 | 0 | 9 | 287 | 102 | 102 | 36 | 148 | 0 | 42 | 20 | 21 | 10 | 11 | 106 | 287 | 0 | 3 | 147 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 29 | 876 | 29 | 137 | 1 | 4 | 96 | 2,327,000 | 31.17 | 
| app_proof | 1 | 44 | 598 | 44 | 40 | 0 | 2 | 76 | 1,763,656 | 34.48 | 

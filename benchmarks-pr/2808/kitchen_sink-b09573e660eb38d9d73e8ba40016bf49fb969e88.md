...
| `total_proof_time_ms ` |  915.50 |  1,831 |  1,142 |  689 |
| `execute_metered_time_ms` |  24 | -          | -          | -          |
| `execute_metered_insns` |  1,979,971 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  81.07 | -          |  81.07 |  81.07 |
| `execute_preflight_insns` |  989,985.50 |  1,979,971 |  1,168,000 |  811,971 |
| `execute_preflight_time_ms` |  97 |  194 |  133 |  61 |
| `execute_preflight_insn_mi/s` |  29.67 | -          |  29.84 |  29.50 |
| `trace_gen_time_ms   ` |  24.50 |  49 |  33 |  16 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  705 |  1,410 |  912 |  498 |
| `prover.main_trace_commit_time_ms` |  204.50 |  409 |  270 |  139 |
| `prover.rap_constraints_time_ms` |  454 |  908 |  590 |  318 |
| `prover.openings_time_ms` |  46 |  92 |  51 |  41 |
| `prover.rap_constraints.logup_gkr_time_ms` |  84.50 |  169 |  113 |  56 |
| `prover.rap_constraints.round0_time_ms` |  267 |  534 |  350 |  184 |
| `prover.rap_constraints.mle_rounds_time_ms` |  101.50 |  203 |  126 |  77 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/b09573e660eb38d9d73e8ba40016bf49fb969e88/kitchen_sink-b09573e660eb38d9d73e8ba40016bf49fb969e88.memory.svg)
...
| app_proof |  |  |  |  |  | 689 |  |  | 24 | 1,979,971 | 81.07 | 0 | 1,860 |  | 
...
| leaf | 0 | 110 | 410 | 110 | 24 | 11 | 19 | 4 | 4 | 
...
| internal_recursive.1 | 1 | prover | 9,750,799 | 73 | 11 | 0 | 0 | 47 | 18 | 18 | 18 | 10 | 0 | 13 | 8 | 5 | 0 | 4 | 12 | 47 | 0 | 1 | 9 | 0 | 0 | 
| leaf | 0 | prover | 263,565,172 | 299 | 129 | 0 | 1 | 141 | 49 | 48 | 37 | 54 | 0 | 28 | 12 | 15 | 7 | 8 | 130 | 141 | 0 | 2 | 54 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 560,358,052 | 912 | 269 | 0 | 140 | 590 | 350 | 348 | 126 | 113 | 57 | 51 | 13 | 38 | 16 | 22 | 270 | 590 | 0 | 1 | 55 | 0 | 0 | 
| app_proof | prover | 1 | 537,646,220 | 498 | 138 | 0 | 2 | 318 | 184 | 183 | 77 | 56 | 0 | 41 | 13 | 28 | 14 | 13 | 139 | 318 | 0 | 1 | 55 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 33 | 1,142 | 33 | 136 | 0 | 3 | 61 | 1,168,000 | 29.50 | 
| app_proof | 1 | 16 | 689 | 16 | 40 | 0 | 1 | 133 | 811,971 | 29.84 | 

...
| `total_proof_time_ms ` |  906 |  1,812 |  1,138 |  674 |
| `execute_metered_time_ms` |  24 | -          | -          | -          |
| `execute_metered_insns` |  1,979,971 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  81.91 | -          |  81.91 |  81.91 |
| `execute_preflight_insns` |  989,985.50 |  1,979,971 |  1,168,000 |  811,971 |
| `execute_preflight_time_ms` |  93.50 |  187 |  127 |  60 |
| `execute_preflight_insn_mi/s` |  29.71 | -          |  29.90 |  29.53 |
| `trace_gen_time_ms   ` |  24 |  48 |  32 |  16 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  699.50 |  1,399 |  909 |  490 |
| `prover.main_trace_commit_time_ms` |  204 |  408 |  271 |  137 |
| `prover.rap_constraints_time_ms` |  449 |  898 |  587 |  311 |
| `prover.openings_time_ms` |  45 |  90 |  50 |  40 |
| `prover.rap_constraints.logup_gkr_time_ms` |  85 |  170 |  114 |  56 |
| `prover.rap_constraints.round0_time_ms` |  262.50 |  525 |  346 |  179 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/2164e1e8f7519b2917477524e91199e959e82e22/kitchen_sink-2164e1e8f7519b2917477524e91199e959e82e22.memory.svg)
...
| app_proof |  |  |  |  |  | 674 |  |  | 24 | 1,979,971 | 81.91 | 0 | 1,842 |  | 
...
| leaf | 0 | 108 | 407 | 108 | 24 | 11 | 18 | 4 | 4 | 
...
| internal_recursive.0 | 1 | prover | 15,378,703 | 79 | 16 | 0 | 0 | 48 | 18 | 17 | 20 | 10 | 0 | 13 | 7 | 5 | 1 | 4 | 16 | 48 | 0 | 1 | 9 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 74 | 11 | 0 | 0 | 47 | 19 | 18 | 18 | 9 | 0 | 14 | 8 | 5 | 0 | 4 | 11 | 47 | 0 | 1 | 9 | 0 | 0 | 
| leaf | 0 | prover | 263,565,172 | 298 | 128 | 0 | 1 | 140 | 48 | 47 | 37 | 54 | 0 | 28 | 13 | 15 | 7 | 8 | 129 | 140 | 0 | 2 | 53 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 560,358,052 | 909 | 270 | 0 | 140 | 587 | 346 | 345 | 125 | 114 | 58 | 50 | 12 | 37 | 15 | 21 | 271 | 587 | 0 | 1 | 55 | 0 | 0 | 
| app_proof | prover | 1 | 537,646,220 | 490 | 137 | 0 | 2 | 311 | 179 | 178 | 76 | 56 | 0 | 40 | 13 | 27 | 14 | 13 | 137 | 311 | 0 | 1 | 55 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 32 | 1,138 | 32 | 136 | 0 | 3 | 60 | 1,168,000 | 29.53 | 
| app_proof | 1 | 16 | 674 | 15 | 40 | 0 | 1 | 127 | 811,971 | 29.90 | 

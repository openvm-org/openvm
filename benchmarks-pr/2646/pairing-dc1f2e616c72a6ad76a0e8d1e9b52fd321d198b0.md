...
|:---|---:|---:|---:|
| Total |  1.86 |  1.86 |  1.86 |
| app_proof |  0.98 |  0.98 |  0.98 |
| leaf |  0.31 |  0.31 |  0.31 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/dc1f2e616c72a6ad76a0e8d1e9b52fd321d198b0/pairing-dc1f2e616c72a6ad76a0e8d1e9b52fd321d198b0.memory.svg)

| Module | Max (GB) | Max At |
| --- | ---: | --- |
| generate mem proving ctxs | 4.89 | app_proof.0 |
| set initial memory | 4.88 | app_proof.0 |
| frac_sumcheck.gkr_rounds | 3.92 | app_proof.prover.0 |
| prover.batch_constraints.before_round0 | 3.92 | app_proof.prover.0 |
| prover.gkr_input_evals | 3.81 | app_proof.prover.0 |
| frac_sumcheck.segment_tree | 3.81 | app_proof.prover.0 |
| prover.rap_constraints | 2.26 | app_proof.prover.0 |
| prover.openings | 2.09 | app_proof.prover.0 |
| prover.prove_whir_opening | 2.09 | app_proof.prover.0 |
| prover.merkle_tree | 2.09 | app_proof.prover.0 |
| prover.batch_constraints.fold_ple_evals | 2.08 | app_proof.prover.0 |
| prover.batch_constraints.round0 | 2.08 | app_proof.prover.0 |
| prover.before_gkr_input_evals | 1.79 | app_proof.prover.0 |
| prover.stacked_commit | 1.79 | app_proof.prover.0 |
...
| tracegen.whir_folding | 0.54 | leaf.0 |
| tracegen.whir_non_initial_opened_values | 0.54 | leaf.0 |
| tracegen.whir_initial_opened_values | 0.54 | leaf.0 |
...
| app_proof |  |  |  |  |  | 912 |  |  | 69 | 1,745,757 | 25.17 | 0 | 987 |  | 
...
| app_proof | 11 | VmAirWrapper<Rv32IsEqualModAdapterAir<2, 8, 4, 32>, ModularIsEqualCoreAir<32, 4, 8> | prover | 0 | 32 | 208 | 17,024 | 
| app_proof | 12 | VmAirWrapper<Rv32VecHeapAdapterAir<2, 8, 8, 4, 4>, FieldExpressionCoreAir> | prover | 0 | 1,024 | 326 | 1,325,056 | 
| app_proof | 13 | VmAirWrapper<Rv32VecHeapAdapterAir<2, 8, 8, 4, 4>, FieldExpressionCoreAir> | prover | 0 | 64 | 262 | 62,336 | 
| app_proof | 15 | VmAirWrapper<Rv32MultAdapterAir, MulHCoreAir<4, 8> | prover | 0 | 256 | 39 | 34,560 | 
| app_proof | 16 | VmAirWrapper<Rv32MultAdapterAir, MultiplicationCoreAir<4, 8> | prover | 0 | 512 | 31 | 54,784 | 
| app_proof | 17 | RangeTupleCheckerAir<2> | prover | 0 | 524,288 | 3 | 3,670,016 | 
| app_proof | 18 | Rv32HintStoreAir | prover | 0 | 256 | 32 | 26,624 | 
| app_proof | 19 | VmAirWrapper<Rv32RdWriteAdapterAir, Rv32AuipcCoreAir> | prover | 0 | 32,768 | 20 | 2,228,224 | 
| app_proof | 2 | PersistentBoundaryAir<8> | prover | 0 | 32,768 | 21 | 1,212,416 | 
| app_proof | 20 | VmAirWrapper<Rv32JalrAdapterAir, Rv32JalrCoreAir> | prover | 0 | 65,536 | 28 | 6,029,312 | 
| app_proof | 21 | VmAirWrapper<Rv32CondRdWriteAdapterAir, Rv32JalLuiCoreAir> | prover | 0 | 8,192 | 18 | 475,136 | 
| app_proof | 22 | VmAirWrapper<Rv32BranchAdapterAir, BranchLessThanCoreAir<4, 8> | prover | 0 | 131,072 | 32 | 11,010,048 | 
| app_proof | 23 | VmAirWrapper<Rv32BranchAdapterAir, BranchEqualCoreAir<4> | prover | 0 | 131,072 | 26 | 9,175,040 | 
| app_proof | 25 | VmAirWrapper<Rv32LoadStoreAdapterAir, LoadStoreCoreAir<4> | prover | 0 | 1,048,576 | 41 | 114,294,784 | 
| app_proof | 26 | VmAirWrapper<Rv32BaseAluAdapterAir, ShiftCoreAir<4, 8> | prover | 0 | 2,048 | 53 | 305,152 | 
| app_proof | 27 | VmAirWrapper<Rv32BaseAluAdapterAir, LessThanCoreAir<4, 8> | prover | 0 | 65,536 | 37 | 7,143,424 | 
| app_proof | 28 | VmAirWrapper<Rv32BaseAluAdapterAir, BaseAluCoreAir<4, 8> | prover | 0 | 1,048,576 | 36 | 121,634,816 | 
| app_proof | 29 | BitwiseOperationLookupAir<8> | prover | 0 | 65,536 | 18 | 1,703,936 | 
| app_proof | 3 | MemoryMerkleAir<8> | prover | 0 | 32,768 | 32 | 1,572,864 | 
| app_proof | 30 | PhantomAir | prover | 0 | 1 | 6 | 18 | 
| app_proof | 31 | Poseidon2PeripheryAir<BabyBearParameters>, 1> | prover | 0 | 32,768 | 300 | 9,961,472 | 
| app_proof | 32 | VariableRangeCheckerAir | prover | 0 | 262,144 | 4 | 2,097,152 | 
| app_proof | 6 | VmAirWrapper<Rv32VecHeapAdapterAir<2, 16, 16, 4, 4>, FieldExpressionCoreAir> | prover | 0 | 16,384 | 623 | 40,812,544 | 
| app_proof | 7 | VmAirWrapper<Rv32VecHeapAdapterAir<2, 16, 16, 4, 4>, FieldExpressionCoreAir> | prover | 0 | 8,192 | 495 | 15,163,392 | 
...
| internal_recursive.1 | 1 | 9 | 151 | 8 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 32 | 311 | 32 | 6 | 1 | 3 | 8 | 8 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 41,110,275 | 232 | 84 | 0 | 5 | 99 | 30 | 29 | 45 | 23 | 0 | 47 | 20 | 26 | 2 | 23 | 85 | 99 | 0 | 2 | 23 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 23,651,975 | 160 | 47 | 0 | 3 | 70 | 23 | 23 | 27 | 18 | 0 | 41 | 18 | 23 | 1 | 21 | 48 | 70 | 0 | 2 | 17 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 17,507,975 | 142 | 34 | 0 | 3 | 65 | 23 | 22 | 24 | 17 | 0 | 42 | 20 | 22 | 1 | 20 | 34 | 65 | 0 | 2 | 16 | 0 | 0 | 
| leaf | 0 | prover | 121,292,195 | 278 | 92 | 0 | 6 | 132 | 46 | 46 | 31 | 54 | 0 | 52 | 25 | 27 | 4 | 22 | 92 | 132 | 0 | 5 | 53 | 0 | 0 | 
...
| leaf | 0 | prover | 0 | 16,532,834 | 2,013,265,921 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 350,468,934 | 415 | 104 | 0 | 11 | 260 | 73 | 73 | 41 | 144 | 0 | 50 | 21 | 28 | 10 | 18 | 104 | 260 | 0 | 2 | 143 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 222 | 912 | 222 | 169 | 1 | 4 | 104 | 1,745,757 | 19.70 | 

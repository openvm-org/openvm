...
|:---|---:|---:|---:|
| Total |  3.54 |  2.74 |  2.74 |
| app_proof |  2.39 |  1.59 |  1.59 |
| leaf |  0.78 |  0.78 |  0.78 |
...
| `total_proof_time_ms ` |  1,177 |  2,354 |  1,557 |  797 |
| `execute_metered_time_ms` |  34 | -          | -          | -          |
| `execute_metered_insns` |  2,580,026 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  75.50 | -          |  75.50 |  75.50 |
| `execute_preflight_insns` |  1,290,013 |  2,580,026 |  1,540,000 |  1,040,026 |
| `execute_preflight_time_ms` |  98 |  196 |  130 |  66 |
| `execute_preflight_insn_mi/s` |  37.25 | -          |  37.47 |  37.03 |
| `trace_gen_time_ms   ` |  56.50 |  113 |  70 |  43 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  907 |  1,814 |  1,232 |  582 |
| `prover.main_trace_commit_time_ms` |  236 |  472 |  324 |  148 |
| `prover.rap_constraints_time_ms` |  605.50 |  1,211 |  827 |  384 |
| `prover.openings_time_ms` |  64.50 |  129 |  80 |  49 |
| `prover.rap_constraints.logup_gkr_time_ms` |  161 |  322 |  188 |  134 |
| `prover.rap_constraints.round0_time_ms` |  338 |  676 |  502 |  174 |
| `prover.rap_constraints.mle_rounds_time_ms` |  105.50 |  211 |  136 |  75 |
| `prover.openings.stacked_reduction_time_ms` |  52 |  104 |  67 |  37 |
...
| `prover.rap_constraints_time_ms` |  335 |  335 |  335 |  335 |
| `prover.openings_time_ms` |  47 |  47 |  47 |  47 |
| `prover.rap_constraints.logup_gkr_time_ms` |  236 |  236 |  236 |  236 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/dc1f2e616c72a6ad76a0e8d1e9b52fd321d198b0/kitchen_sink-dc1f2e616c72a6ad76a0e8d1e9b52fd321d198b0.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- |
| 1,077 | 3 | 0 | 264,807 | 225,370 | 3 | 74 | 
...
| app_proof |  |  |  |  |  | 797 |  |  | 34 | 2,580,026 | 75.50 | 0 | 2,393 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 58,092,291 | 142 | 42 | 0 | 4 | 66 | 20 | 19 | 30 | 15 | 0 | 32 | 9 | 23 | 1 | 21 | 43 | 66 | 0 | 1 | 14 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 23,651,975 | 100 | 19 | 0 | 4 | 51 | 17 | 16 | 19 | 13 | 0 | 29 | 8 | 21 | 1 | 20 | 19 | 51 | 0 | 1 | 12 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 17,507,975 | 93 | 14 | 0 | 4 | 48 | 17 | 16 | 18 | 13 | 0 | 29 | 8 | 21 | 0 | 20 | 14 | 48 | 0 | 1 | 12 | 0 | 0 | 
| leaf | 0 | prover | 593,173,376 | 641 | 257 | 0 | 119 | 335 | 56 | 56 | 42 | 236 | 145 | 47 | 13 | 33 | 8 | 24 | 258 | 335 | 0 | 2 | 91 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 787,728,110 | 1,232 | 324 | 0 | 192 | 827 | 502 | 501 | 136 | 188 | 64 | 80 | 12 | 67 | 16 | 51 | 324 | 827 | 0 | 1 | 122 | 0 | 0 | 
| app_proof | prover | 1 | 700,866,292 | 582 | 148 | 0 | 23 | 384 | 174 | 174 | 75 | 134 | 73 | 49 | 11 | 37 | 14 | 22 | 148 | 384 | 0 | 1 | 60 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 70 | 1,557 | 70 | 188 | 0 | 3 | 66 | 1,540,000 | 37.03 | 
| app_proof | 1 | 43 | 797 | 43 | 40 | 0 | 1 | 130 | 1,040,026 | 37.47 | 

...
|:---|---:|---:|---:|
| Total |  3.58 |  2.77 |  2.78 |
| app_proof |  2.41 |  1.61 |  1.61 |
| leaf |  0.79 |  0.79 |  0.79 |
...
| `total_proof_time_ms ` |  1,189 |  2,378 |  1,573 |  805 |
| `execute_metered_time_ms` |  34 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  75.13 | -          |  75.13 |  75.13 |
| `execute_preflight_insns` |  1,290,013 |  2,580,026 |  1,540,000 |  1,040,026 |
| `execute_preflight_time_ms` |  99 |  198 |  131 |  67 |
| `execute_preflight_insn_mi/s` |  37.13 | -          |  37.48 |  36.78 |
| `trace_gen_time_ms   ` |  56.50 |  113 |  70 |  43 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  916.50 |  1,833 |  1,244 |  589 |
| `prover.main_trace_commit_time_ms` |  238 |  476 |  328 |  148 |
| `prover.rap_constraints_time_ms` |  611.50 |  1,223 |  832 |  391 |
| `prover.openings_time_ms` |  66 |  132 |  83 |  49 |
| `prover.rap_constraints.logup_gkr_time_ms` |  163 |  326 |  190 |  136 |
| `prover.rap_constraints.round0_time_ms` |  339.50 |  679 |  502 |  177 |
| `prover.rap_constraints.mle_rounds_time_ms` |  108 |  216 |  139 |  77 |
| `prover.openings.stacked_reduction_time_ms` |  52.50 |  105 |  68 |  37 |
| `prover.openings.stacked_reduction.round0_time_ms` |  15.50 |  31 |  17 |  14 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  36.50 |  73 |  51 |  22 |
| `prover.openings.whir_time_ms` |  13.50 |  27 |  15 |  12 |
...
| `prover.rap_constraints_time_ms` |  341 |  341 |  341 |  341 |
| `prover.openings_time_ms` |  47 |  47 |  47 |  47 |
| `prover.rap_constraints.logup_gkr_time_ms` |  241 |  241 |  241 |  241 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/c00c20c787a62472f48eeba5ecb406b1d8643cd0/kitchen_sink-c00c20c787a62472f48eeba5ecb406b1d8643cd0.memory.svg)

| Module | Max (GB) | Max At |
| --- | ---: | --- |
| prover.gkr_input_evals | 10.71 | leaf.0.prover |
| prover.batch_constraints.before_round0 | 10.71 | leaf.0.prover |
| frac_sumcheck.segment_tree | 10.71 | leaf.0.prover |
| frac_sumcheck.gkr_rounds | 10.71 | leaf.0.prover |
| prover.rap_constraints | 10.41 | app_proof.prover.0 |
| prover.openings | 9.10 | app_proof.prover.0 |
| prover.merkle_tree | 9.10 | app_proof.prover.0 |
| prover.prove_whir_opening | 9.10 | app_proof.prover.0 |
| prover.batch_constraints.fold_ple_evals | 8.78 | app_proof.prover.0 |
| prover.batch_constraints.round0 | 8.78 | app_proof.prover.0 |
| prover.before_gkr_input_evals | 7.33 | app_proof.prover.0 |
| prover.stacked_commit | 7.33 | app_proof.prover.0 |
| prover.rs_code_matrix | 7.32 | app_proof.prover.0 |
| generate mem proving ctxs | 5.46 | app_proof.0 |
| set initial memory | 5.45 | app_proof.1 |
| tracegen.pow_checker | 2.14 | leaf.0 |
| tracegen.whir_final_poly_query_eval | 2.14 | leaf.0 |
| tracegen.exp_bits_len | 2.14 | leaf.0 |
...
| --- | --- | --- | --- | --- | --- | --- |
| 1,125 | 3 | 0 | 264,807 | 227,784 | 3 | 64 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 70 | 3 |  |  | 0 |  | 350 | 3 |  |  |  |  |  |  | 
| app_proof |  |  |  |  |  | 805 |  |  | 34 | 2,580,026 | 75.13 | 0 | 2,417 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 18 | 161 | 18 | 6 | 2 | 2 | 2 | 2 | 
| internal_recursive.0 | 1 | 10 | 113 | 10 | 1 | 0 | 2 | 0 | 0 | 
| internal_recursive.1 | 1 | 9 | 104 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 140 | 790 | 140 | 25 | 11 | 30 | 5 | 5 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 58,092,291 | 142 | 42 | 0 | 4 | 66 | 20 | 19 | 30 | 15 | 0 | 32 | 8 | 23 | 1 | 21 | 43 | 66 | 0 | 1 | 14 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 23,651,975 | 102 | 19 | 0 | 4 | 52 | 18 | 17 | 20 | 13 | 0 | 30 | 8 | 21 | 1 | 20 | 19 | 52 | 0 | 1 | 12 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 17,507,975 | 95 | 14 | 0 | 4 | 49 | 17 | 17 | 18 | 13 | 0 | 30 | 8 | 21 | 0 | 20 | 15 | 49 | 0 | 1 | 12 | 0 | 0 | 
| leaf | 0 | prover | 593,173,376 | 649 | 259 | 0 | 120 | 341 | 57 | 56 | 42 | 241 | 150 | 47 | 13 | 33 | 8 | 25 | 259 | 341 | 0 | 2 | 90 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 787,728,110 | 1,244 | 328 | 0 | 196 | 832 | 502 | 500 | 139 | 190 | 66 | 83 | 15 | 68 | 17 | 51 | 328 | 832 | 0 | 1 | 122 | 0 | 0 | 
| app_proof | prover | 1 | 700,866,292 | 589 | 148 | 0 | 23 | 391 | 177 | 176 | 77 | 136 | 74 | 49 | 12 | 37 | 14 | 22 | 148 | 391 | 0 | 1 | 60 | 0 | 0 | 

| group | phase | segment | trace_height_constraint | weighted_sum | threshold |
| --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 0 | 54,950,208 | 2,013,265,921 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 70 | 1,573 | 70 | 190 | 0 | 3 | 67 | 1,540,000 | 36.78 | 
| app_proof | 1 | 43 | 805 | 43 | 40 | 0 | 1 | 131 | 1,040,026 | 37.48 | 

...
| `execute_preflight_insn_mi/s` |  36.94 | -          |  37.08 |  36.81 |
| `trace_gen_time_ms   ` |  57 |  114 |  71 |  43 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  906.50 |  1,813 |  1,231 |  582 |
| `prover.main_trace_commit_time_ms` |  235 |  470 |  322 |  148 |
| `prover.rap_constraints_time_ms` |  607 |  1,214 |  829 |  385 |
| `prover.openings_time_ms` |  63 |  126 |  78 |  48 |
| `prover.rap_constraints.logup_gkr_time_ms` |  161.50 |  323 |  187 |  136 |
| `prover.rap_constraints.round0_time_ms` |  339 |  678 |  504 |  174 |
| `prover.rap_constraints.mle_rounds_time_ms` |  106 |  212 |  137 |  75 |
| `prover.openings.stacked_reduction_time_ms` |  51 |  102 |  66 |  36 |
| `prover.openings.stacked_reduction.round0_time_ms` |  15 |  30 |  16 |  14 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  35.50 |  71 |  49 |  22 |
...
| `trace_gen_time_ms   ` |  138 |  138 |  138 |  138 |
...
| `prover.rap_constraints_time_ms` |  333 |  333 |  333 |  333 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/0cc0b0b1c120814d78371083e96a17115c7c1ba9/kitchen_sink-0cc0b0b1c120814d78371083e96a17115c7c1ba9.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- |
| 1,102 | 3 | 0 | 264,807 | 227,810 | 3 | 64 | 
...
| app_proof |  |  |  |  |  | 797 |  |  | 35 | 2,580,026 | 73.23 | 0 | 2,393 |  | 
...
| leaf | 0 | 138 | 770 | 137 | 25 | 11 | 30 | 4 | 4 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 58,092,291 | 142 | 42 | 0 | 4 | 66 | 20 | 20 | 30 | 15 | 0 | 32 | 8 | 23 | 1 | 21 | 43 | 66 | 0 | 1 | 14 | 0 | 0 | 
...
| leaf | 0 | prover | 593,173,376 | 632 | 252 | 0 | 117 | 333 | 57 | 56 | 42 | 234 | 141 | 45 | 12 | 33 | 8 | 24 | 253 | 333 | 0 | 2 | 91 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 787,728,110 | 1,231 | 321 | 0 | 192 | 829 | 504 | 502 | 137 | 187 | 64 | 78 | 12 | 66 | 16 | 49 | 322 | 829 | 0 | 1 | 122 | 0 | 0 | 
| app_proof | prover | 1 | 700,866,292 | 582 | 147 | 0 | 23 | 385 | 174 | 173 | 75 | 136 | 75 | 48 | 11 | 36 | 14 | 22 | 148 | 385 | 0 | 1 | 60 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 71 | 1,557 | 71 | 188 | 0 | 4 | 66 | 1,540,000 | 36.81 | 
| app_proof | 1 | 43 | 797 | 43 | 40 | 0 | 1 | 130 | 1,040,026 | 37.08 | 

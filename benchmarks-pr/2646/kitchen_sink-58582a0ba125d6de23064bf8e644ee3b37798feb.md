...
|:---|---:|---:|---:|
| Total |  3.44 |  2.98 |  2.98 |
| app_proof |  2.53 |  2.06 |  2.06 |
| leaf |  0.54 |  0.54 |  0.54 |
...
| `total_proof_time_ms ` |  1,246 |  2,492 |  2,031 |  461 |
| `execute_metered_time_ms` |  34 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  75.75 | -          |  75.75 |  75.75 |
| `execute_preflight_insns` |  1,290,013 |  2,580,026 |  2,020,000 |  560,026 |
| `execute_preflight_time_ms` |  79 |  158 |  81 |  77 |
| `execute_preflight_insn_mi/s` |  35.56 | -          |  36.42 |  34.70 |
| `trace_gen_time_ms   ` |  57 |  114 |  94 |  20 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  994 |  1,988 |  1,667 |  321 |
| `prover.main_trace_commit_time_ms` |  303 |  606 |  524 |  82 |
| `prover.rap_constraints_time_ms` |  622.50 |  1,245 |  1,043 |  202 |
| `prover.openings_time_ms` |  68 |  136 |  99 |  37 |
| `prover.rap_constraints.logup_gkr_time_ms` |  169.50 |  339 |  296 |  43 |
| `prover.rap_constraints.round0_time_ms` |  353 |  706 |  595 |  111 |
| `prover.rap_constraints.mle_rounds_time_ms` |  98.50 |  197 |  150 |  47 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  542 |  542 |  542 |  542 |
...
| `prover.main_trace_commit_time_ms` |  149 |  149 |  149 |  149 |
| `prover.rap_constraints_time_ms` |  201 |  201 |  201 |  201 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/58582a0ba125d6de23064bf8e644ee3b37798feb/kitchen_sink-58582a0ba125d6de23064bf8e644ee3b37798feb.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- |
| 1,074 | 3 | 0 | 264,807 | 226,981 | 3 | 65 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 71 | 3 |  |  | 0 |  | 358 | 3 |  |  |  |  |  |  | 
| app_proof |  |  |  |  |  | 461 |  |  | 34 | 2,580,026 | 75.75 | 0 | 2,531 |  | 
| internal_for_leaf |  |  |  | 160 |  |  |  |  |  |  |  |  |  | 160 | 
| internal_recursive.0 |  |  |  | 109 |  |  |  |  |  |  |  |  |  | 109 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 18 | 160 | 18 | 6 | 2 | 2 | 2 | 2 | 
| internal_recursive.0 | 1 | 9 | 109 | 9 | 1 | 0 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 8 | 101 | 8 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 145 | 542 | 145 | 27 | 12 | 31 | 2 | 2 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 58,092,291 | 141 | 42 | 0 | 4 | 65 | 19 | 19 | 30 | 15 | 0 | 32 | 8 | 23 | 1 | 21 | 43 | 65 | 0 | 1 | 14 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 23,651,975 | 99 | 19 | 0 | 4 | 50 | 17 | 16 | 19 | 13 | 0 | 29 | 7 | 21 | 1 | 20 | 19 | 50 | 0 | 1 | 12 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 17,507,975 | 92 | 14 | 0 | 4 | 48 | 16 | 16 | 18 | 13 | 0 | 29 | 8 | 21 | 0 | 20 | 14 | 48 | 0 | 1 | 12 | 0 | 0 | 
| leaf | 0 | prover | 593,173,376 | 397 | 148 | 0 | 11 | 201 | 56 | 55 | 42 | 102 | 0 | 46 | 13 | 33 | 8 | 24 | 149 | 201 | 0 | 2 | 101 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,221,325,550 | 1,667 | 523 | 0 | 306 | 1,043 | 595 | 594 | 150 | 296 | 135 | 99 | 16 | 83 | 26 | 56 | 524 | 1,043 | 0 | 1 | 160 | 0 | 0 | 
| app_proof | prover | 1 | 370,741,140 | 321 | 82 | 0 | 17 | 202 | 111 | 111 | 47 | 43 | 0 | 37 | 11 | 26 | 7 | 18 | 82 | 202 | 0 | 1 | 42 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 94 | 2,031 | 94 | 189 | 0 | 3 | 81 | 2,020,000 | 34.70 | 
| app_proof | 1 | 20 | 461 | 20 | 40 | 0 | 1 | 77 | 560,026 | 36.42 | 

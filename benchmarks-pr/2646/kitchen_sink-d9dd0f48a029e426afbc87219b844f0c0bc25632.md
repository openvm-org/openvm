...
|:---|---:|---:|---:|
| Total |  3.59 |  2.78 |  2.78 |
| app_proof |  2.42 |  1.61 |  1.61 |
| leaf |  0.79 |  0.79 |  0.79 |
...
| `total_proof_time_ms ` |  1,195.50 |  2,391 |  1,579 |  812 |
| `execute_metered_time_ms` |  34 | -          | -          | -          |
| `execute_metered_insns` |  2,580,026 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  75.37 | -          |  75.37 |  75.37 |
| `execute_preflight_insns` |  1,290,013 |  2,580,026 |  1,540,000 |  1,040,026 |
| `execute_preflight_time_ms` |  102 |  204 |  137 |  67 |
| `execute_preflight_insn_mi/s` |  36.92 | -          |  36.97 |  36.87 |
| `trace_gen_time_ms   ` |  57 |  114 |  71 |  43 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  919.50 |  1,839 |  1,250 |  589 |
| `prover.main_trace_commit_time_ms` |  238.50 |  477 |  328 |  149 |
| `prover.rap_constraints_time_ms` |  614.50 |  1,229 |  839 |  390 |
| `prover.openings_time_ms` |  65.50 |  131 |  82 |  49 |
| `prover.rap_constraints.logup_gkr_time_ms` |  164 |  328 |  191 |  137 |
| `prover.rap_constraints.round0_time_ms` |  342 |  684 |  507 |  177 |
| `prover.rap_constraints.mle_rounds_time_ms` |  107 |  214 |  139 |  75 |
| `prover.openings.stacked_reduction_time_ms` |  51.50 |  103 |  67 |  36 |
| `prover.openings.stacked_reduction.round0_time_ms` |  15 |  30 |  16 |  14 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  36 |  72 |  50 |  22 |
...
| `prover.rap_constraints_time_ms` |  339 |  339 |  339 |  339 |
| `prover.openings_time_ms` |  46 |  46 |  46 |  46 |
| `prover.rap_constraints.logup_gkr_time_ms` |  238 |  238 |  238 |  238 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/d9dd0f48a029e426afbc87219b844f0c0bc25632/kitchen_sink-d9dd0f48a029e426afbc87219b844f0c0bc25632.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- |
| 1,111 | 3 | 0 | 264,807 | 226,842 | 3 | 74 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 77 | 3 |  |  | 0 |  | 372 | 3 |  |  |  |  |  |  | 
| app_proof |  |  |  |  |  | 812 |  |  | 34 | 2,580,026 | 75.37 | 0 | 2,430 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 58,092,291 | 144 | 43 | 0 | 4 | 67 | 20 | 20 | 31 | 15 | 0 | 32 | 9 | 23 | 1 | 21 | 43 | 67 | 0 | 1 | 15 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 23,651,975 | 100 | 19 | 0 | 4 | 51 | 17 | 17 | 20 | 13 | 0 | 29 | 8 | 21 | 1 | 20 | 19 | 51 | 0 | 1 | 12 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 17,507,975 | 95 | 14 | 0 | 4 | 49 | 17 | 17 | 18 | 13 | 0 | 31 | 9 | 21 | 0 | 20 | 14 | 49 | 0 | 1 | 12 | 0 | 0 | 
| leaf | 0 | prover | 593,173,376 | 645 | 259 | 0 | 120 | 339 | 57 | 56 | 43 | 238 | 148 | 46 | 13 | 33 | 8 | 25 | 260 | 339 | 0 | 2 | 89 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 787,728,110 | 1,250 | 327 | 0 | 196 | 839 | 507 | 506 | 139 | 191 | 68 | 82 | 15 | 67 | 16 | 50 | 328 | 839 | 0 | 1 | 122 | 0 | 0 | 
| app_proof | prover | 1 | 700,866,292 | 589 | 149 | 0 | 23 | 390 | 177 | 177 | 75 | 137 | 76 | 49 | 12 | 36 | 14 | 22 | 149 | 390 | 0 | 1 | 60 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 71 | 1,579 | 71 | 190 | 0 | 3 | 67 | 1,540,000 | 36.87 | 
| app_proof | 1 | 43 | 812 | 43 | 40 | 0 | 1 | 137 | 1,040,026 | 36.97 | 

...
| `total_proof_time_ms ` |  1,251 |  2,502 |  2,039 |  463 |
| `execute_metered_time_ms` |  34 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  75.21 | -          |  75.21 |  75.21 |
| `execute_preflight_insns` |  1,290,013 |  2,580,026 |  2,020,000 |  560,026 |
| `execute_preflight_time_ms` |  80.50 |  161 |  82 |  79 |
| `execute_preflight_insn_mi/s` |  35.45 | -          |  36.43 |  34.47 |
| `trace_gen_time_ms   ` |  57 |  114 |  94 |  20 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  998 |  1,996 |  1,674 |  322 |
| `prover.main_trace_commit_time_ms` |  302 |  604 |  522 |  82 |
| `prover.rap_constraints_time_ms` |  626.50 |  1,253 |  1,051 |  202 |
| `prover.openings_time_ms` |  68.50 |  137 |  100 |  37 |
| `prover.rap_constraints.logup_gkr_time_ms` |  169 |  338 |  295 |  43 |
| `prover.rap_constraints.round0_time_ms` |  357.50 |  715 |  604 |  111 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/d96449eaaa0a469a246086b52f6c2f00bc52440c/kitchen_sink-d96449eaaa0a469a246086b52f6c2f00bc52440c.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- |
| 1,073 | 3 | 0 | 264,807 | 226,447 | 3 | 63 | 
...
| app_proof |  |  |  |  |  | 463 |  |  | 34 | 2,580,026 | 75.21 | 0 | 2,541 |  | 
...
| leaf | 0 | 147 | 544 | 147 | 26 | 12 | 32 | 2 | 2 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 58,092,291 | 143 | 43 | 0 | 4 | 66 | 20 | 19 | 31 | 15 | 0 | 33 | 9 | 23 | 1 | 21 | 43 | 66 | 0 | 1 | 14 | 0 | 0 | 
...
| leaf | 0 | prover | 593,173,376 | 396 | 148 | 0 | 11 | 201 | 56 | 55 | 42 | 102 | 0 | 46 | 12 | 33 | 8 | 24 | 148 | 201 | 0 | 2 | 101 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,221,325,550 | 1,674 | 521 | 0 | 302 | 1,051 | 604 | 603 | 150 | 295 | 134 | 100 | 16 | 83 | 27 | 56 | 522 | 1,051 | 0 | 1 | 160 | 0 | 0 | 
| app_proof | prover | 1 | 370,741,140 | 322 | 82 | 0 | 17 | 202 | 111 | 111 | 47 | 43 | 0 | 37 | 11 | 26 | 7 | 18 | 82 | 202 | 0 | 1 | 42 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 94 | 2,039 | 94 | 188 | 0 | 3 | 82 | 2,020,000 | 34.47 | 
| app_proof | 1 | 20 | 463 | 20 | 40 | 0 | 1 | 79 | 560,026 | 36.43 | 

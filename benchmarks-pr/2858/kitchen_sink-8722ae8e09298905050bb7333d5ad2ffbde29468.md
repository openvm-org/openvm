...
|:---|---:|---:|---:|
| Total |  5.36 |  3.77 |  3.77 |
| app_proof |  3.85 |  2.26 |  2.26 |
| leaf |  0.95 |  0.95 |  0.95 |
...
| `total_proof_time_ms ` |  1,908.50 |  3,817 |  2,227 |  1,590 |
...
| `execute_preflight_insn_mi/s` |  35.10 | -          |  35.91 |  34.28 |
| `trace_gen_time_ms   ` |  139 |  278 |  183 |  95 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,560.50 |  3,121 |  1,803 |  1,318 |
| `prover.main_trace_commit_time_ms` |  510.50 |  1,021 |  594 |  427 |
| `prover.rap_constraints_time_ms` |  926 |  1,852 |  1,074 |  778 |
| `prover.openings_time_ms` |  123 |  246 |  134 |  112 |
| `prover.rap_constraints.logup_gkr_time_ms` |  166 |  332 |  197 |  135 |
| `prover.rap_constraints.round0_time_ms` |  559.50 |  1,119 |  666 |  453 |
| `prover.rap_constraints.mle_rounds_time_ms` |  199.50 |  399 |  210 |  189 |
| `prover.openings.stacked_reduction_time_ms` |  89 |  178 |  100 |  78 |
| `prover.openings.stacked_reduction.round0_time_ms` |  48 |  96 |  50 |  46 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  40.50 |  81 |  50 |  31 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/8722ae8e09298905050bb7333d5ad2ffbde29468/kitchen_sink-8722ae8e09298905050bb7333d5ad2ffbde29468.memory.svg)
...
| app_proof |  |  |  |  |  | 1,590 |  |  | 34 | 2,579,903 | 74.06 | 0 | 3,856 |  | 
...
| leaf | 0 | 121 | 945 | 121 | 23 | 9 | 21 | 5 | 5 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,577,979 | 257 | 116 | 0 | 0 | 107 | 35 | 34 | 51 | 19 | 0 | 33 | 20 | 13 | 3 | 9 | 116 | 107 | 0 | 2 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,767 | 143 | 45 | 0 | 0 | 67 | 24 | 23 | 28 | 14 | 0 | 30 | 21 | 8 | 1 | 6 | 45 | 67 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 119 | 31 | 0 | 0 | 62 | 24 | 23 | 24 | 14 | 0 | 24 | 17 | 7 | 1 | 5 | 32 | 62 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 265,003,892 | 823 | 399 | 0 | 1 | 348 | 133 | 132 | 78 | 136 | 0 | 74 | 34 | 40 | 21 | 18 | 399 | 348 | 0 | 6 | 135 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 567,917,156 | 1,803 | 593 | 0 | 187 | 1,074 | 666 | 665 | 210 | 197 | 56 | 134 | 33 | 100 | 50 | 50 | 594 | 1,074 | 0 | 3 | 139 | 0 | 0 | 
| app_proof | prover | 1 | 537,266,124 | 1,318 | 426 | 0 | 1 | 778 | 453 | 453 | 189 | 135 | 0 | 112 | 34 | 78 | 46 | 31 | 427 | 778 | 0 | 3 | 134 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 183 | 2,227 | 183 | 176 | 0 | 4 | 63 | 1,540,000 | 34.28 | 
| app_proof | 1 | 95 | 1,590 | 95 | 41 | 0 | 2 | 134 | 1,039,903 | 35.91 | 

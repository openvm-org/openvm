...
|:---|---:|---:|---:|
| Total |  3.14 |  2.67 |  2.67 |
| app_proof |  2.32 |  1.86 |  1.86 |
| leaf |  0.44 |  0.44 |  0.44 |
...
| `total_proof_time_ms ` |  1,143.50 |  2,287 |  1,823 |  464 |
| `execute_metered_time_ms` |  34 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  74.06 | -          |  74.06 |  74.06 |
| `execute_preflight_insns` |  1,289,951.50 |  2,579,903 |  2,020,000 |  559,903 |
| `execute_preflight_time_ms` |  78.50 |  157 |  79 |  78 |
| `execute_preflight_insn_mi/s` |  35.48 | -          |  35.99 |  34.96 |
| `trace_gen_time_ms   ` |  57.50 |  115 |  94 |  21 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  893.50 |  1,787 |  1,464 |  323 |
| `prover.main_trace_commit_time_ms` |  294 |  588 |  506 |  82 |
| `prover.rap_constraints_time_ms` |  533 |  1,066 |  863 |  203 |
| `prover.openings_time_ms` |  65 |  130 |  94 |  36 |
| `prover.rap_constraints.logup_gkr_time_ms` |  158 |  316 |  273 |  43 |
| `prover.rap_constraints.round0_time_ms` |  278.50 |  557 |  445 |  112 |
| `prover.rap_constraints.mle_rounds_time_ms` |  96 |  192 |  144 |  48 |
...
| `prover.openings.whir_time_ms` |  12.50 |  25 |  16 |  9 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/e55af66968149eb3bbb0714fe896ccb1abd424ad/kitchen_sink-e55af66968149eb3bbb0714fe896ccb1abd424ad.memory.svg)
...
| app_proof |  |  |  |  |  | 464 |  |  | 34 | 2,579,903 | 74.06 | 0 | 2,328 |  | 
...
| internal_recursive.0 | 1 | 9 | 111 | 9 | 1 | 0 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 8 | 104 | 8 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 122 | 443 | 122 | 26 | 12 | 21 | 2 | 2 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 53,472,003 | 139 | 41 | 0 | 4 | 66 | 20 | 20 | 29 | 15 | 0 | 32 | 8 | 23 | 1 | 21 | 41 | 66 | 0 | 1 | 15 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 23,651,975 | 101 | 19 | 0 | 4 | 50 | 17 | 16 | 20 | 13 | 0 | 30 | 8 | 21 | 1 | 20 | 19 | 50 | 0 | 1 | 12 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 17,507,975 | 95 | 14 | 0 | 4 | 48 | 16 | 16 | 18 | 13 | 0 | 31 | 9 | 21 | 0 | 20 | 15 | 48 | 0 | 1 | 12 | 0 | 0 | 
| leaf | 0 | prover | 428,317,568 | 320 | 131 | 0 | 10 | 145 | 47 | 46 | 37 | 59 | 0 | 43 | 11 | 31 | 7 | 24 | 132 | 145 | 0 | 2 | 59 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,221,261,804 | 1,464 | 505 | 0 | 286 | 863 | 445 | 444 | 144 | 273 | 134 | 94 | 16 | 77 | 25 | 51 | 506 | 863 | 0 | 1 | 137 | 0 | 0 | 
| app_proof | prover | 1 | 370,741,140 | 323 | 82 | 0 | 17 | 203 | 112 | 112 | 48 | 43 | 0 | 36 | 9 | 26 | 7 | 18 | 82 | 203 | 0 | 1 | 42 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 94 | 1,823 | 94 | 186 | 0 | 3 | 78 | 2,020,000 | 34.96 | 
| app_proof | 1 | 21 | 464 | 21 | 40 | 0 | 2 | 79 | 559,903 | 35.99 | 

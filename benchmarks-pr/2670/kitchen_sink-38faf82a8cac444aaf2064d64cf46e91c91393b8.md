...
|:---|---:|---:|---:|
| Total |  3.15 |  2.68 |  2.68 |
| app_proof |  2.33 |  1.86 |  1.86 |
| leaf |  0.45 |  0.45 |  0.45 |
...
| `total_proof_time_ms ` |  1,148 |  2,296 |  1,825 |  471 |
| `execute_metered_time_ms` |  34 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  75.17 | -          |  75.17 |  75.17 |
| `execute_preflight_insns` |  1,289,951.50 |  2,579,903 |  2,020,000 |  559,903 |
| `execute_preflight_time_ms` |  84 |  168 |  84 |  84 |
| `execute_preflight_insn_mi/s` |  32.64 | -          |  33.73 |  31.55 |
| `trace_gen_time_ms   ` |  55.50 |  111 |  90 |  21 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  894 |  1,788 |  1,464 |  324 |
| `prover.main_trace_commit_time_ms` |  292.50 |  585 |  503 |  82 |
| `prover.rap_constraints_time_ms` |  535.50 |  1,071 |  866 |  205 |
| `prover.openings_time_ms` |  65 |  130 |  94 |  36 |
| `prover.rap_constraints.logup_gkr_time_ms` |  157.50 |  315 |  272 |  43 |
| `prover.rap_constraints.round0_time_ms` |  281.50 |  563 |  449 |  114 |
| `prover.rap_constraints.mle_rounds_time_ms` |  95 |  190 |  143 |  47 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/38faf82a8cac444aaf2064d64cf46e91c91393b8/kitchen_sink-38faf82a8cac444aaf2064d64cf46e91c91393b8.memory.svg)
...
| app_proof |  |  |  |  |  | 471 |  |  | 34 | 2,579,903 | 75.17 | 0 | 2,335 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 18 | 157 | 17 | 6 | 1 | 2 | 1 | 1 | 
| internal_recursive.0 | 1 | 10 | 110 | 10 | 1 | 0 | 2 | 0 | 0 | 
| internal_recursive.1 | 1 | 9 | 103 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 124 | 447 | 124 | 27 | 12 | 21 | 2 | 2 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 53,472,003 | 139 | 40 | 0 | 4 | 64 | 20 | 19 | 29 | 15 | 0 | 33 | 9 | 23 | 1 | 21 | 41 | 64 | 0 | 1 | 14 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 23,651,975 | 100 | 19 | 0 | 4 | 50 | 17 | 17 | 19 | 13 | 0 | 29 | 7 | 21 | 1 | 20 | 19 | 50 | 0 | 1 | 12 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 17,507,975 | 93 | 14 | 0 | 4 | 48 | 17 | 16 | 18 | 13 | 0 | 30 | 8 | 21 | 0 | 20 | 15 | 48 | 0 | 1 | 12 | 0 | 0 | 
| leaf | 0 | prover | 428,317,568 | 322 | 131 | 0 | 9 | 146 | 49 | 48 | 37 | 60 | 0 | 43 | 11 | 31 | 7 | 24 | 132 | 146 | 0 | 2 | 59 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,221,261,804 | 1,464 | 502 | 0 | 283 | 866 | 449 | 448 | 143 | 272 | 134 | 94 | 16 | 78 | 26 | 51 | 503 | 866 | 0 | 1 | 137 | 0 | 0 | 
| app_proof | prover | 1 | 370,741,140 | 324 | 82 | 0 | 17 | 205 | 114 | 114 | 47 | 43 | 0 | 36 | 10 | 26 | 7 | 18 | 82 | 205 | 0 | 1 | 43 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 90 | 1,825 | 90 | 185 | 0 | 3 | 84 | 2,020,000 | 31.55 | 
| app_proof | 1 | 21 | 471 | 21 | 40 | 0 | 1 | 84 | 559,903 | 33.73 | 

...
| `total_proof_time_ms ` |  931.50 |  1,863 |  1,194 |  669 |
| `execute_metered_time_ms` |  34 | -          | -          | -          |
| `execute_metered_insns` |  2,579,903 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  73.90 | -          |  73.90 |  73.90 |
| `execute_preflight_insns` |  1,289,951.50 |  2,579,903 |  1,540,000 |  1,039,903 |
| `execute_preflight_time_ms` |  100.50 |  201 |  137 |  64 |
| `execute_preflight_insn_mi/s` |  35.25 | -          |  36.21 |  34.30 |
| `trace_gen_time_ms   ` |  25.50 |  51 |  35 |  16 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  696 |  1,392 |  919 |  473 |
| `prover.main_trace_commit_time_ms` |  214.50 |  429 |  292 |  137 |
| `prover.rap_constraints_time_ms` |  433.50 |  867 |  572 |  295 |
...
| `prover.rap_constraints.mle_rounds_time_ms` |  85.50 |  171 |  107 |  64 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/ae3b7c38ca9f0b4d0184225aee4e0e80727c5557/kitchen_sink-ae3b7c38ca9f0b4d0184225aee4e0e80727c5557.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 67 | 3 |  |  | 0 |  | 331 | 3 |  |  |  |  |  |  | 
| app_proof |  |  |  |  |  | 669 |  |  | 34 | 2,579,903 | 73.90 | 0 | 1,902 |  | 
...
| internal_recursive.1 | 1 | prover | 9,750,799 | 73 | 11 | 0 | 0 | 47 | 18 | 17 | 18 | 9 | 0 | 14 | 9 | 5 | 0 | 4 | 11 | 47 | 0 | 1 | 9 | 0 | 0 | 
| leaf | 0 | prover | 265,003,636 | 297 | 128 | 0 | 1 | 139 | 48 | 47 | 37 | 53 | 0 | 28 | 13 | 15 | 7 | 8 | 128 | 139 | 0 | 2 | 53 | 0 | 0 | 
...
| leaf | 0 | prover | 0 | 40,825,923 | 2,013,265,921 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 567,917,156 | 919 | 292 | 0 | 162 | 572 | 352 | 351 | 107 | 112 | 56 | 53 | 12 | 41 | 15 | 25 | 292 | 572 | 0 | 1 | 55 | 0 | 0 | 
| app_proof | prover | 1 | 537,266,124 | 473 | 136 | 0 | 2 | 295 | 176 | 176 | 64 | 54 | 0 | 40 | 13 | 27 | 14 | 13 | 137 | 295 | 0 | 1 | 53 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 35 | 1,194 | 35 | 175 | 0 | 3 | 64 | 1,540,000 | 34.30 | 
| app_proof | 1 | 16 | 669 | 16 | 40 | 0 | 1 | 137 | 1,039,903 | 36.21 | 

...
| `total_proof_time_ms ` |  766 |  3,064 |  921 |  552 |
| `execute_metered_time_ms` |  67 | -          | -          | -          |
| `execute_metered_insns` |  12,000,265 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  178 | -          |  178 |  178 |
| `execute_preflight_insns` |  3,000,066.25 |  12,000,265 |  3,495,000 |  1,515,265 |
| `execute_preflight_time_ms` |  82.50 |  330 |  101 |  43 |
| `execute_preflight_insn_mi/s` |  49.19 | -          |  50.28 |  46.28 |
| `trace_gen_time_ms   ` |  141 |  564 |  173 |  124 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  472.50 |  1,890 |  538 |  295 |
| `prover.main_trace_commit_time_ms` |  98.25 |  393 |  112 |  59 |
| `prover.rap_constraints_time_ms` |  272.25 |  1,089 |  309 |  168 |
| `prover.openings_time_ms` |  101 |  404 |  116 |  67 |
| `prover.rap_constraints.logup_gkr_time_ms` |  195.25 |  781 |  223 |  116 |
| `prover.rap_constraints.round0_time_ms` |  51.75 |  207 |  60 |  34 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/af3a6287087dee6fde826414b6c9e72be350313c/fibonacci-af3a6287087dee6fde826414b6c9e72be350313c.memory.svg)
...
| app_proof |  |  |  |  |  | 552 |  |  | 67 | 12,000,265 | 178 | 0 | 3,138 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,747 | 324 | 117 | 0 | 0 | 106 | 34 | 34 | 51 | 20 | 0 | 99 | 85 | 13 | 3 | 9 | 117 | 106 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,767 | 167 | 46 | 0 | 0 | 66 | 24 | 23 | 28 | 14 | 0 | 53 | 45 | 8 | 1 | 6 | 47 | 66 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 136 | 32 | 0 | 0 | 61 | 22 | 22 | 24 | 13 | 0 | 42 | 34 | 7 | 1 | 5 | 33 | 61 | 0 | 2 | 13 | 0 | 0 | 
| leaf | 0 | prover | 147,934,246 | 609 | 233 | 0 | 0 | 183 | 84 | 83 | 54 | 45 | 0 | 192 | 167 | 24 | 12 | 12 | 233 | 183 | 0 | 8 | 44 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 136,618,054 | 538 | 112 | 0 | 0 | 309 | 60 | 60 | 27 | 221 | 0 | 116 | 94 | 22 | 12 | 9 | 112 | 309 | 0 | 3 | 220 | 0 | 0 | 
| app_proof | prover | 1 | 136,570,716 | 530 | 111 | 0 | 0 | 307 | 56 | 56 | 27 | 223 | 0 | 111 | 89 | 21 | 12 | 9 | 111 | 306 | 0 | 3 | 222 | 0 | 0 | 
| app_proof | prover | 2 | 136,570,716 | 527 | 111 | 0 | 0 | 305 | 57 | 57 | 26 | 221 | 0 | 110 | 88 | 21 | 12 | 9 | 111 | 305 | 0 | 3 | 220 | 0 | 0 | 
| app_proof | prover | 3 | 70,295,004 | 295 | 59 | 0 | 0 | 168 | 34 | 33 | 17 | 116 | 0 | 67 | 54 | 12 | 6 | 6 | 59 | 168 | 0 | 3 | 115 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 138 | 921 | 138 | 154 | 2,770,197,065 | 323,292,691 | 3,093,489,756 | 2,097,152 | 0 | 3 | 89 | 3,495,000 | 46.28 | 
| app_proof | 1 | 124 | 797 | 124 | 41 | 2,768,862,357 | 322,353,414 | 3,091,215,771 | 2,097,152 | 0 | 1 | 101 | 3,495,000 | 50.22 | 
| app_proof | 2 | 129 | 794 | 129 | 41 | 2,768,862,357 | 322,353,414 | 3,091,215,771 | 2,097,152 | 0 | 1 | 97 | 3,495,000 | 50.28 | 
| app_proof | 3 | 173 | 552 | 173 | 41 | 1,230,956,171 | 342,871,578 | 1,573,827,749 | 2,097,152 | 0 | 2 | 43 | 1,515,265 | 49.99 | 

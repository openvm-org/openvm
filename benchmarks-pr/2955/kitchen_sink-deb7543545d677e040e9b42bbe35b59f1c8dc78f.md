...
| `execute_metered_insn_mi/s` |  70.72 | -          |  70.72 |  70.72 |
...
| `prover.main_trace_commit_time_ms` |  1,191 |  1,191 |  1,191 |  1,191 |
| `prover.rap_constraints_time_ms` |  1,746 |  1,746 |  1,746 |  1,746 |
| `prover.openings_time_ms` |  812 |  812 |  812 |  812 |
| `prover.rap_constraints.logup_gkr_time_ms` |  300 |  300 |  300 |  300 |
| `prover.rap_constraints.round0_time_ms` |  1,049 |  1,049 |  1,049 |  1,049 |
| `prover.rap_constraints.mle_rounds_time_ms` |  396 |  396 |  396 |  396 |
| `prover.openings.stacked_reduction_time_ms` |  195 |  195 |  195 |  195 |
| `prover.openings.stacked_reduction.round0_time_ms` |  110 |  110 |  110 |  110 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  84 |  84 |  84 |  84 |
| `prover.openings.whir_time_ms` |  617 |  617 |  617 |  617 |
...
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  788 |  788 |  788 |  788 |
| `prover.main_trace_commit_time_ms` |  262 |  262 |  262 |  262 |
| `prover.rap_constraints_time_ms` |  306 |  306 |  306 |  306 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/deb7543545d677e040e9b42bbe35b59f1c8dc78f/kitchen_sink-deb7543545d677e040e9b42bbe35b59f1c8dc78f.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 72 |  |  |  | 385 |  |  |  |  |  |  | 
| app_proof |  |  |  | 4,186 |  | 36 | 2,579,903 | 70.72 | 0 | 4,227 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,577,981 | 335 | 120 | 0 | 0 | 112 | 36 | 35 | 52 | 23 | 0 | 102 | 88 | 13 | 3 | 10 | 120 | 120 | 112 | 0 | 3 | 20 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 173 | 48 | 0 | 0 | 68 | 26 | 25 | 28 | 14 | 0 | 54 | 46 | 8 | 1 | 6 | 49 | 48 | 68 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 137 | 32 | 0 | 0 | 63 | 24 | 23 | 24 | 14 | 0 | 40 | 33 | 7 | 1 | 5 | 33 | 32 | 63 | 0 | 3 | 13 | 0 | 0 | 
| leaf | 0 | prover | 170,433,085 | 788 | 261 | 0 | 0 | 306 | 111 | 110 | 61 | 133 | 0 | 219 | 191 | 28 | 14 | 13 | 262 | 261 | 306 | 0 | 9 | 132 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,121,338,980 | 3,751 | 1,191 | 0 | 0 | 1,746 | 1,049 | 1,048 | 396 | 300 | 1 | 812 | 617 | 195 | 110 | 84 | 1,191 | 1,191 | 1,746 | 0 | 5 | 298 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 156 | 178 | 4,186 | 178 | 156 | 10,592,943,552 | 2,968,407,792 | 13,561,351,344 | 2,097,152 | 0 | 4 | 99 | 2,579,903 | 34.21 | 

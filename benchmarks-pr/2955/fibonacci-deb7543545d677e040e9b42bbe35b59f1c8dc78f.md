...
| `total_proof_time_ms ` |  768.25 |  3,073 |  921 |  555 |
| `execute_metered_time_ms` |  67 | -          | -          | -          |
| `execute_metered_insns` |  12,000,265 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  178.60 | -          |  178.60 |  178.60 |
| `execute_preflight_insns` |  3,000,066.25 |  12,000,265 |  3,495,000 |  1,515,265 |
| `execute_preflight_time_ms` |  81.75 |  327 |  101 |  42 |
| `execute_preflight_insn_mi/s` |  49.49 | -          |  50.52 |  46.52 |
| `trace_gen_time_ms   ` |  143.25 |  573 |  177 |  126 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  472.25 |  1,889 |  538 |  293 |
| `prover.main_trace_commit_time_ms` |  99.25 |  397 |  113 |  60 |
| `prover.rap_constraints_time_ms` |  272.25 |  1,089 |  311 |  166 |
| `prover.openings_time_ms` |  100 |  400 |  113 |  67 |
| `prover.rap_constraints.logup_gkr_time_ms` |  195.75 |  783 |  223 |  115 |
| `prover.rap_constraints.round0_time_ms` |  50.75 |  203 |  60 |  33 |
...
| `prover.openings.whir_time_ms` |  81 |  324 |  92 |  54 |
...
| `prover.main_trace_commit_time_ms` |  234 |  234 |  234 |  234 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/deb7543545d677e040e9b42bbe35b59f1c8dc78f/fibonacci-deb7543545d677e040e9b42bbe35b59f1c8dc78f.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 73 |  |  |  | 351 |  |  |  |  |  |  | 
| app_proof |  |  |  | 555 |  | 67 | 12,000,265 | 178.60 | 0 | 3,147 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 330 | 117 | 0 | 0 | 107 | 35 | 34 | 51 | 20 | 0 | 105 | 91 | 13 | 3 | 9 | 117 | 117 | 107 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 175 | 47 | 0 | 0 | 70 | 26 | 25 | 28 | 15 | 0 | 57 | 49 | 8 | 1 | 6 | 47 | 47 | 70 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 140 | 32 | 0 | 0 | 63 | 24 | 23 | 24 | 14 | 0 | 43 | 36 | 7 | 1 | 5 | 32 | 32 | 63 | 0 | 3 | 13 | 0 | 0 | 
| leaf | 0 | prover | 147,934,254 | 610 | 234 | 0 | 0 | 184 | 85 | 84 | 53 | 45 | 0 | 191 | 166 | 24 | 12 | 12 | 234 | 234 | 184 | 0 | 8 | 44 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 136,618,310 | 538 | 112 | 0 | 0 | 311 | 60 | 60 | 27 | 223 | 0 | 113 | 92 | 21 | 11 | 9 | 112 | 112 | 311 | 0 | 3 | 222 | 0 | 0 | 
| app_proof | prover | 1 | 136,570,844 | 528 | 112 | 0 | 0 | 306 | 55 | 55 | 27 | 222 | 0 | 110 | 89 | 20 | 11 | 8 | 112 | 112 | 306 | 0 | 3 | 222 | 0 | 0 | 
| app_proof | prover | 2 | 136,570,844 | 530 | 113 | 0 | 0 | 306 | 55 | 55 | 27 | 223 | 0 | 110 | 89 | 21 | 12 | 9 | 113 | 113 | 306 | 0 | 3 | 222 | 0 | 0 | 
| app_proof | prover | 3 | 70,295,260 | 293 | 60 | 0 | 0 | 166 | 33 | 33 | 17 | 115 | 0 | 67 | 54 | 12 | 6 | 5 | 60 | 60 | 166 | 0 | 3 | 114 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 155 | 138 | 921 | 138 | 155 | 2,770,199,817 | 323,294,035 | 3,093,493,852 | 2,097,152 | 0 | 3 | 88 | 3,495,000 | 46.52 | 
| app_proof | 1 | 41 | 126 | 797 | 126 | 41 | 2,768,863,045 | 322,353,750 | 3,091,216,795 | 2,097,152 | 0 | 1 | 101 | 3,495,000 | 50.52 | 
| app_proof | 2 | 41 | 132 | 800 | 132 | 41 | 2,768,863,045 | 322,353,750 | 3,091,216,795 | 2,097,152 | 0 | 1 | 96 | 3,495,000 | 50.51 | 
| app_proof | 3 | 41 | 177 | 555 | 177 | 41 | 1,230,958,923 | 342,872,922 | 1,573,831,845 | 2,097,152 | 0 | 2 | 42 | 1,515,265 | 50.42 | 

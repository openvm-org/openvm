...
|:---|---:|---:|---:|
| Total |  5.88 |  2.18 |  2.17 |
| app_proof |  3.97 |  0.73 |  0.73 |
| leaf |  1.13 |  0.66 |  0.66 |
...
| `total_proof_time_ms ` |  557.14 |  3,900 |  665 |  537 |
| `execute_metered_time_ms` |  67 | -          | -          | -          |
| `execute_metered_insns` |  12,000,265 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  177.32 | -          |  177.32 |  177.32 |
| `execute_preflight_insns` |  1,714,323.57 |  12,000,265 |  1,747,000 |  1,518,265 |
| `execute_preflight_time_ms` |  48.29 |  338 |  52 |  42 |
| `execute_preflight_insn_mi/s` |  50.54 | -          |  50.86 |  49.97 |
| `trace_gen_time_ms   ` |  164 |  1,148 |  170 |  162 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  286.29 |  2,004 |  291 |  284 |
| `prover.main_trace_commit_time_ms` |  57.71 |  404 |  58 |  56 |
| `prover.rap_constraints_time_ms` |  162.29 |  1,136 |  166 |  161 |
| `prover.openings_time_ms` |  65.14 |  456 |  67 |  64 |
| `prover.rap_constraints.logup_gkr_time_ms` |  113.29 |  793 |  115 |  110 |
| `prover.rap_constraints.round0_time_ms` |  31.29 |  219 |  34 |  30 |
...
| `prover.openings.whir_time_ms` |  53 |  371 |  55 |  52 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  565 |  1,130 |  656 |  474 |
| `execute_preflight_time_ms` |  1 |  2 |  1 |  1 |
| `trace_gen_time_ms   ` |  47.50 |  95 |  57 |  38 |
| `generate_blob_total_time_ms` |  2.50 |  5 |  3 |  2 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  516.50 |  1,033 |  598 |  435 |
| `prover.main_trace_commit_time_ms` |  191.50 |  383 |  228 |  155 |
| `prover.rap_constraints_time_ms` |  161 |  322 |  179 |  143 |
| `prover.openings_time_ms` |  162.50 |  325 |  190 |  135 |
| `prover.rap_constraints.logup_gkr_time_ms` |  38 |  76 |  45 |  31 |
| `prover.rap_constraints.round0_time_ms` |  74.50 |  149 |  81 |  68 |
...
| `prover.openings.whir_time_ms` |  142 |  284 |  166 |  118 |
...
| `prover.openings.whir_time_ms` |  118 |  118 |  118 |  118 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/efb532a654b2c2e67b9df496ce4147a362e36a5a/fibonacci-efb532a654b2c2e67b9df496ce4147a362e36a5a.memory.svg)
...
| app_proof |  |  |  |  |  | 538 |  |  | 67 | 12,000,265 | 177.32 | 0 | 3,977 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 28 | 462 | 27 | 9 | 1 | 2 | 1 | 1 | 
| internal_recursive.0 | 1 | 11 | 181 | 11 | 1 | 0 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 9 | 144 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 57 | 656 | 57 | 23 | 3 | 1 | 1 | 1 | 
| leaf | 1 | 38 | 474 | 38 | 17 | 2 | 1 | 1 | 1 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 53,005,300 | 434 | 157 | 0 | 0 | 141 | 41 | 40 | 71 | 28 | 0 | 135 | 118 | 17 | 5 | 11 | 157 | 141 | 0 | 3 | 28 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,767 | 169 | 46 | 0 | 0 | 66 | 24 | 23 | 27 | 13 | 0 | 55 | 47 | 8 | 1 | 6 | 47 | 66 | 0 | 3 | 12 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 134 | 31 | 0 | 0 | 62 | 23 | 22 | 24 | 14 | 0 | 41 | 33 | 7 | 1 | 5 | 31 | 62 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 147,934,246 | 598 | 228 | 0 | 0 | 179 | 81 | 80 | 52 | 45 | 0 | 190 | 166 | 23 | 11 | 12 | 228 | 179 | 0 | 7 | 43 | 0 | 0 | 
| leaf | 1 | prover | 98,728,630 | 435 | 155 | 0 | 0 | 143 | 68 | 67 | 43 | 31 | 0 | 135 | 118 | 17 | 8 | 9 | 155 | 143 | 0 | 7 | 31 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 70,295,622 | 291 | 58 | 0 | 0 | 166 | 34 | 33 | 17 | 115 | 0 | 65 | 52 | 12 | 6 | 6 | 58 | 166 | 0 | 3 | 114 | 0 | 0 | 
| app_proof | prover | 1 | 70,248,284 | 284 | 56 | 0 | 0 | 162 | 33 | 33 | 17 | 110 | 0 | 65 | 53 | 12 | 6 | 5 | 56 | 162 | 0 | 3 | 110 | 0 | 0 | 
| app_proof | prover | 2 | 70,248,284 | 285 | 58 | 0 | 0 | 162 | 31 | 30 | 17 | 114 | 0 | 64 | 52 | 12 | 6 | 5 | 58 | 162 | 0 | 3 | 113 | 0 | 0 | 
| app_proof | prover | 3 | 70,248,284 | 285 | 58 | 0 | 0 | 161 | 30 | 30 | 17 | 114 | 0 | 65 | 53 | 12 | 6 | 5 | 58 | 161 | 0 | 3 | 112 | 0 | 0 | 
| app_proof | prover | 4 | 70,248,284 | 288 | 58 | 0 | 0 | 161 | 30 | 30 | 17 | 113 | 0 | 67 | 55 | 12 | 6 | 5 | 58 | 161 | 0 | 3 | 113 | 0 | 0 | 
| app_proof | prover | 5 | 70,248,284 | 286 | 58 | 0 | 0 | 162 | 30 | 30 | 17 | 114 | 0 | 66 | 54 | 11 | 6 | 5 | 58 | 162 | 0 | 3 | 113 | 0 | 0 | 
| app_proof | prover | 6 | 70,295,004 | 285 | 57 | 0 | 0 | 162 | 31 | 31 | 17 | 113 | 0 | 64 | 52 | 12 | 6 | 5 | 58 | 162 | 0 | 3 | 112 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 162 | 665 | 162 | 158 | 1,411,127,546 | 162,713,442 | 1,573,840,988 | 2,097,152 | 0 | 3 | 52 | 1,747,000 | 50.28 | 
| app_proof | 1 | 162 | 537 | 162 | 40 | 1,409,791,968 | 161,775,035 | 1,571,567,003 | 2,097,152 | 0 | 1 | 50 | 1,747,000 | 50.61 | 
| app_proof | 2 | 163 | 539 | 163 | 41 | 1,409,792,265 | 161,774,738 | 1,571,567,003 | 2,097,152 | 0 | 1 | 49 | 1,747,000 | 50.68 | 
| app_proof | 3 | 164 | 540 | 164 | 40 | 1,409,792,837 | 161,774,166 | 1,571,567,003 | 2,097,152 | 0 | 1 | 48 | 1,747,000 | 50.66 | 
| app_proof | 4 | 163 | 541 | 163 | 40 | 1,409,791,968 | 161,775,035 | 1,571,567,003 | 2,097,152 | 0 | 1 | 49 | 1,747,000 | 49.97 | 
| app_proof | 5 | 164 | 540 | 164 | 40 | 1,409,792,265 | 161,774,738 | 1,571,567,003 | 2,097,152 | 0 | 1 | 48 | 1,747,000 | 50.86 | 
| app_proof | 6 | 170 | 538 | 170 | 40 | 1,233,288,671 | 340,539,078 | 1,573,827,749 | 2,097,152 | 0 | 2 | 42 | 1,518,265 | 50.71 | 

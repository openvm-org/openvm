...
|:---|---:|---:|---:|
| Total |  5.91 |  2.17 |  2.17 |
| app_proof |  3.100 |  0.74 |  0.74 |
| leaf |  1.14 |  0.66 |  0.66 |
...
| `total_proof_time_ms ` |  561.57 |  3,931 |  672 |  541 |
| `execute_metered_time_ms` |  68 | -          | -          | -          |
| `execute_metered_insns` |  12,000,265 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  176.06 | -          |  176.06 |  176.06 |
| `execute_preflight_insns` |  1,714,323.57 |  12,000,265 |  1,747,000 |  1,518,265 |
| `execute_preflight_time_ms` |  48.71 |  341 |  53 |  42 |
| `execute_preflight_insn_mi/s` |  49.100 | -          |  50.34 |  49.41 |
| `trace_gen_time_ms   ` |  164.71 |  1,153 |  171 |  162 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  288.71 |  2,021 |  294 |  286 |
| `prover.main_trace_commit_time_ms` |  58.14 |  407 |  59 |  58 |
| `prover.rap_constraints_time_ms` |  163.71 |  1,146 |  168 |  161 |
| `prover.openings_time_ms` |  65.43 |  458 |  66 |  64 |
| `prover.rap_constraints.logup_gkr_time_ms` |  114.43 |  801 |  116 |  113 |
| `prover.rap_constraints.round0_time_ms` |  31.14 |  218 |  35 |  30 |
| `prover.rap_constraints.mle_rounds_time_ms` |  17 |  119 |  17 |  17 |
| `prover.openings.stacked_reduction_time_ms` |  11.57 |  81 |  12 |  11 |
...
| `prover.openings.whir_time_ms` |  53.14 |  372 |  54 |  52 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  569 |  1,138 |  657 |  481 |
| `execute_preflight_time_ms` |  1 |  2 |  1 |  1 |
| `trace_gen_time_ms   ` |  47.50 |  95 |  58 |  37 |
| `generate_blob_total_time_ms` |  2.50 |  5 |  3 |  2 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  521 |  1,042 |  599 |  443 |
| `prover.main_trace_commit_time_ms` |  194 |  388 |  231 |  157 |
| `prover.rap_constraints_time_ms` |  161 |  322 |  178 |  144 |
| `prover.openings_time_ms` |  165 |  330 |  190 |  140 |
...
| `prover.openings.whir_time_ms` |  144 |  288 |  165 |  123 |
...
| `prover.openings.whir_time_ms` |  109 |  109 |  109 |  109 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/ed1f13e4669459eb31bbe3e276db494e07bb2db5/fibonacci-ed1f13e4669459eb31bbe3e276db494e07bb2db5.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 76 | 9 |  |  | 0 |  | 370 | 9 |  |  |  |  |  |  | 
| app_proof |  |  |  |  |  | 546 |  |  | 68 | 12,000,265 | 176.06 | 0 | 4,007 |  | 
| internal_for_leaf |  |  |  | 454 |  |  |  |  |  |  |  |  |  | 454 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 27 | 454 | 27 | 9 | 1 | 2 | 1 | 1 | 
| internal_recursive.0 | 1 | 11 | 177 | 11 | 1 | 0 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 9 | 146 | 9 | 1 | 0 | 1 | 0 | 0 | 
| leaf | 0 | 58 | 657 | 57 | 23 | 3 | 1 | 1 | 1 | 
| leaf | 1 | 37 | 481 | 37 | 17 | 2 | 1 | 1 | 1 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 53,005,300 | 426 | 156 | 0 | 0 | 142 | 41 | 40 | 71 | 29 | 0 | 127 | 109 | 17 | 5 | 11 | 157 | 142 | 0 | 3 | 28 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,767 | 165 | 46 | 0 | 0 | 65 | 24 | 23 | 27 | 13 | 0 | 52 | 44 | 8 | 1 | 6 | 46 | 65 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 137 | 32 | 0 | 0 | 60 | 22 | 22 | 24 | 13 | 0 | 43 | 36 | 7 | 1 | 5 | 32 | 60 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 147,934,246 | 599 | 230 | 0 | 0 | 178 | 81 | 80 | 52 | 44 | 0 | 190 | 165 | 24 | 12 | 12 | 231 | 178 | 0 | 7 | 43 | 0 | 0 | 
| leaf | 1 | prover | 98,728,630 | 443 | 157 | 0 | 0 | 144 | 68 | 67 | 44 | 32 | 0 | 140 | 123 | 17 | 8 | 9 | 157 | 144 | 0 | 6 | 31 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 70,295,622 | 294 | 58 | 0 | 0 | 168 | 35 | 35 | 17 | 115 | 0 | 66 | 53 | 12 | 6 | 6 | 58 | 168 | 0 | 3 | 114 | 0 | 0 | 
| app_proof | prover | 1 | 70,248,284 | 288 | 58 | 0 | 0 | 164 | 30 | 30 | 17 | 115 | 0 | 66 | 53 | 12 | 6 | 5 | 58 | 164 | 0 | 3 | 115 | 0 | 0 | 
| app_proof | prover | 2 | 70,248,284 | 286 | 58 | 0 | 0 | 162 | 30 | 30 | 17 | 114 | 0 | 64 | 52 | 11 | 6 | 5 | 58 | 162 | 0 | 3 | 114 | 0 | 0 | 
| app_proof | prover | 3 | 70,248,284 | 286 | 58 | 0 | 0 | 162 | 30 | 30 | 17 | 114 | 0 | 65 | 53 | 12 | 6 | 5 | 58 | 162 | 0 | 3 | 113 | 0 | 0 | 
| app_proof | prover | 4 | 70,248,284 | 287 | 58 | 0 | 0 | 161 | 30 | 30 | 17 | 113 | 0 | 66 | 54 | 11 | 6 | 5 | 58 | 161 | 0 | 3 | 113 | 0 | 0 | 
| app_proof | prover | 5 | 70,248,284 | 289 | 58 | 0 | 0 | 164 | 32 | 32 | 17 | 114 | 0 | 66 | 54 | 11 | 6 | 5 | 58 | 164 | 0 | 3 | 114 | 0 | 0 | 
| app_proof | prover | 6 | 70,295,004 | 291 | 58 | 0 | 0 | 165 | 31 | 31 | 17 | 116 | 0 | 65 | 53 | 12 | 6 | 6 | 59 | 165 | 0 | 3 | 116 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 163 | 672 | 163 | 159 | 1,411,127,546 | 162,713,442 | 1,573,840,988 | 2,097,152 | 0 | 4 | 53 | 1,747,000 | 49.41 | 
| app_proof | 1 | 162 | 543 | 162 | 40 | 1,409,791,968 | 161,775,035 | 1,571,567,003 | 2,097,152 | 0 | 1 | 50 | 1,747,000 | 50.18 | 
| app_proof | 2 | 164 | 541 | 164 | 40 | 1,409,792,265 | 161,774,738 | 1,571,567,003 | 2,097,152 | 0 | 1 | 49 | 1,747,000 | 50.34 | 
| app_proof | 3 | 164 | 541 | 164 | 40 | 1,409,792,837 | 161,774,166 | 1,571,567,003 | 2,097,152 | 0 | 1 | 49 | 1,747,000 | 49.53 | 
| app_proof | 4 | 165 | 543 | 165 | 40 | 1,409,791,968 | 161,775,035 | 1,571,567,003 | 2,097,152 | 0 | 1 | 49 | 1,747,000 | 50.16 | 
| app_proof | 5 | 164 | 545 | 164 | 40 | 1,409,792,265 | 161,774,738 | 1,571,567,003 | 2,097,152 | 0 | 1 | 49 | 1,747,000 | 50.21 | 
| app_proof | 6 | 171 | 546 | 171 | 41 | 1,233,288,671 | 340,539,078 | 1,573,827,749 | 2,097,152 | 0 | 1 | 42 | 1,518,265 | 50.17 | 

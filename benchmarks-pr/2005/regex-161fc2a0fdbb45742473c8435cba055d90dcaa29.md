...
|:---|---:|---:|
| Total |  7.63 |  4.88 |
| regex_program |  7.59 |  4.85 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  3,797 |  7,594 |  4,853 |  2,741 |
...
| `execute_preflight_insn_mi/s` |  28.71 | -          |  31.01 |  26.42 |
| `trace_gen_time_ms   ` |  379 |  758 |  487 |  271 |
| `memory_finalize_time_ms` |  8 |  16 |  14 |  2 |
| `stark_prove_excluding_trace_time_ms` |  3,091.50 |  6,183 |  4,025 |  2,158 |
| `main_trace_commit_time_ms` |  616 |  1,232 |  841 |  391 |
| `generate_perm_trace_time_ms` |  229.50 |  459 |  308 |  151 |
| `perm_trace_commit_time_ms` |  658.50 |  1,317 |  847 |  470 |
| `quotient_poly_compute_time_ms` |  321 |  642 |  433 |  209 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2,741 | 6 | 1 | 31 | 4,108,597 | 130.13 | 45 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 487 | 4,853 | 211,758,557 | 373,183,036 | 487 | 4,025 | 0 | 433 | 395 | 847 | 1,196 | 7 | 14 | 841 | 91,281,687 | 308 | 101 | 2,211,000 | 26.42 | 
| regex_program | 1 | 271 | 2,741 | 174,326,267 | 196,838,026 | 271 | 2,158 | 50 | 209 | 206 | 470 | 719 | 6 | 2 | 391 | 73,453,305 | 151 | 84 | 1,897,597 | 31.01 | 

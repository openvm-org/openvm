...
| `total_proof_time_ms ` |  4,172.50 |  8,345 |  5,273 |  3,072 |
...
| `execute_preflight_time_ms` |  266.50 |  533 |  287 |  246 |
| `execute_preflight_insn_mi/s` |  33.08 | -          |  35.04 |  31.12 |
| `trace_gen_time_ms   ` |  125 |  250 |  175 |  75 |
| `set_initial_memory_time_ms` |  88 |  176 |  135 |  41 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  3,691.50 |  7,383 |  4,715 |  2,668 |
| `prover.main_trace_commit_time_ms` |  965.50 |  1,931 |  1,336 |  595 |
| `prover.rap_constraints_time_ms` |  2,013 |  4,026 |  2,478 |  1,548 |
| `prover.openings_time_ms` |  712 |  1,424 |  900 |  524 |
| `prover.rap_constraints.logup_gkr_time_ms` |  562.50 |  1,125 |  601 |  524 |
| `prover.rap_constraints.round0_time_ms` |  1,063 |  2,126 |  1,377 |  749 |
| `prover.rap_constraints.mle_rounds_time_ms` |  386.50 |  773 |  499 |  274 |
| `prover.openings.stacked_reduction_time_ms` |  168.50 |  337 |  217 |  120 |
| `prover.openings.stacked_reduction.round0_time_ms` |  104 |  208 |  136 |  72 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  64 |  128 |  81 |  47 |
| `prover.openings.whir_time_ms` |  543.50 |  1,087 |  683 |  404 |
...
| `generate_blob_total_time_ms` |  23 |  23 |  23 |  23 |
| __Prover__ |||||
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/f32b41e98433d526fefca1dfa4e380a3589a3061/sha2_bench-f32b41e98433d526fefca1dfa4e380a3589a3061.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 70 |  |  |  | 341 |  |  |  |  |  |  | 
| app_proof |  |  |  | 3,072 |  | 98 | 11,167,961 | 113.04 | 0 | 8,450 |  | 
...
| leaf | 0 | 113 | 1,019 | 113 | 41 | 23 | 2 | 7 | 7 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 327 | 119 | 0 | 0 | 108 | 35 | 35 | 52 | 20 | 0 | 99 | 85 | 13 | 3 | 9 | 119 | 119 | 108 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 170 | 48 | 0 | 0 | 69 | 25 | 25 | 28 | 14 | 0 | 52 | 44 | 8 | 1 | 6 | 48 | 48 | 69 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 138 | 32 | 0 | 0 | 64 | 24 | 23 | 24 | 15 | 0 | 40 | 33 | 7 | 1 | 5 | 32 | 32 | 64 | 0 | 3 | 13 | 0 | 0 | 
| leaf | 0 | prover | 237,929,016 | 906 | 377 | 0 | 0 | 232 | 112 | 111 | 68 | 51 | 0 | 296 | 258 | 38 | 20 | 17 | 378 | 377 | 231 | 0 | 13 | 50 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,286,242,554 | 4,715 | 1,335 | 0 | 0 | 2,478 | 1,377 | 1,377 | 499 | 601 | 0 | 900 | 683 | 217 | 136 | 81 | 1,336 | 1,335 | 2,478 | 0 | 6 | 600 | 0 | 0 | 
| app_proof | prover | 1 | 750,289,144 | 2,668 | 595 | 0 | 0 | 1,548 | 749 | 748 | 274 | 524 | 0 | 524 | 404 | 120 | 72 | 47 | 595 | 595 | 1,548 | 0 | 8 | 523 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 135 | 1 | 175 | 5,273 | 175 | 135 | 13,311,936,132 | 2,137,449,780 | 15,449,385,912 | 2,097,152 | 0 | 3 | 246 | 7,124,000 | 31.12 | 
| app_proof | 1 | 41 | 1 | 75 | 3,072 | 75 | 41 | 7,588,526,580 | 1,502,398,413 | 9,090,924,993 | 2,097,152 | 0 | 2 | 287 | 4,043,961 | 35.04 | 

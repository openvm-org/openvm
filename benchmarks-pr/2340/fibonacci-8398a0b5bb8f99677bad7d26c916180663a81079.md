...
|:---|---:|---:|---:|
| Total | <span style='color: green'>(-0 [-2.4%])</span> 1.03 | <span style='color: green'>(-0 [-4.5%])</span> 0.60 | 0.59 |
| fibonacci_program | <span style='color: green'>(-0 [-2.4%])</span> 1.03 | <span style='color: green'>(-0 [-4.5%])</span> 0.60 |  0.60 |


| fibonacci_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: green'>(-12 [-2.4%])</span> 511 | <span style='color: green'>(-25 [-2.4%])</span> 1,022 | <span style='color: green'>(-28 [-4.6%])</span> 586 | <span style='color: red'>(+3 [+0.7%])</span> 436 |
...
| `execute_metered_insn_mi/s` | <span style='color: red'>(+1 [+0.5%])</span> 161.35 | -          | <span style='color: red'>(+1 [+0.5%])</span> 161.35 | <span style='color: red'>(+1 [+0.5%])</span> 161.35 |
| `execute_preflight_insns` |  750,104.50 |  1,500,209 |  873,000 |  627,209 |
| `execute_preflight_time_ms` | <span style='color: red'>(+0 [+1.9%])</span> 26.50 | <span style='color: red'>(+1 [+1.9%])</span> 53 | <span style='color: red'>(+1 [+3.2%])</span> 32 |  21 |
| `execute_preflight_insn_mi/s` | <span style='color: green'>(-1 [-3.5%])</span> 38.70 | -          | <span style='color: green'>(-1 [-3.4%])</span> 38.80 | <span style='color: green'>(-1 [-3.6%])</span> 38.60 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+2 [+0.8%])</span> 193.50 | <span style='color: red'>(+3 [+0.8%])</span> 387 | <span style='color: red'>(+2 [+1.0%])</span> 198 | <span style='color: red'>(+1 [+0.5%])</span> 189 |
...
| `generate_perm_trace_time_ms` | <span style='color: green'>(-2 [-9.6%])</span> 23.50 | <span style='color: green'>(-5 [-9.6%])</span> 47 | <span style='color: green'>(-5 [-16.1%])</span> 26 |  21 |
| `perm_trace_commit_time_ms` | <span style='color: red'>(+1 [+2.5%])</span> 41.64 | <span style='color: red'>(+2 [+2.5%])</span> 83.28 | <span style='color: red'>(+2 [+4.1%])</span> 44.60 | <span style='color: red'>(+0 [+0.6%])</span> 38.68 |
| `quotient_poly_compute_time_ms` | <span style='color: green'>(-0 [-1.0%])</span> 31.73 | <span style='color: green'>(-1 [-1.0%])</span> 63.46 |  34.53 | <span style='color: green'>(-1 [-2.0%])</span> 28.93 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+1 [+5.5%])</span> 12.46 | <span style='color: red'>(+1 [+5.5%])</span> 24.92 | <span style='color: red'>(+1 [+8.2%])</span> 13.19 | <span style='color: red'>(+0 [+2.6%])</span> 11.72 |
| `pcs_opening_time_ms ` | <span style='color: green'>(-14 [-23.9%])</span> 43 | <span style='color: green'>(-27 [-23.9%])</span> 86 | <span style='color: green'>(-26 [-37.1%])</span> 44 | <span style='color: green'>(-1 [-2.3%])</span> 42 |
...
| --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 436 | 1 | 9 | 1,500,209 | 161.35 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 189 | 586 | 9,677,708 | 84,395,212 | 189 | 195 | 0 | 34.53 | 13.19 | 4 | 44.60 | 42 | 71 | 42 | 0 | 32 | 1,035,986 | 26 | 32 | 873,000 | 38.60 | 14 | 48 | 0 | 42 | 
| fibonacci_program | 1 | 198 | 436 | 9,708,170 | 74,305,770 | 198 | 175 | 1 | 28.93 | 11.72 | 4 | 38.68 | 44 | 60 | 44 | 0 | 28 | 1,064,416 | 21 | 21 | 627,209 | 38.80 | 11 | 41 | 0 | 44 | 

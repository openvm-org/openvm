...
|:---|---:|---:|---:|
| Total | <span style='color: red'>(+0 [+1.4%])</span> 1.51 | <span style='color: red'>(+0 [+1.0%])</span> 0.91 | 0.91 |
| pairing | <span style='color: red'>(+0 [+1.3%])</span> 1.51 | <span style='color: red'>(+0 [+0.9%])</span> 0.91 |  0.91 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+10 [+1.4%])</span> 722.50 | <span style='color: red'>(+20 [+1.4%])</span> 1,445 | <span style='color: red'>(+8 [+1.0%])</span> 843 | <span style='color: red'>(+12 [+2.0%])</span> 602 |
| `main_cells_used     ` |  12,704,151 |  25,408,302 |  15,909,408 |  9,498,894 |
| `total_cells_used    ` |  27,472,173 |  54,944,346 |  32,480,114 |  22,464,232 |
| `execute_metered_time_ms` | <span style='color: red'>(+1 [+1.6%])</span> 63 | -          | -          | -          |
| `execute_metered_insn_mi/s` | <span style='color: green'>(-0 [-0.4%])</span> 27.65 | -          | <span style='color: green'>(-0 [-0.4%])</span> 27.65 | <span style='color: green'>(-0 [-0.4%])</span> 27.65 |
| `execute_preflight_insns` |  872,871 |  1,745,742 |  1,149,000 |  596,742 |
| `execute_preflight_time_ms` | <span style='color: red'>(+1 [+1.2%])</span> 84 | <span style='color: red'>(+2 [+1.2%])</span> 168 | <span style='color: red'>(+1 [+0.8%])</span> 120 | <span style='color: red'>(+1 [+2.1%])</span> 48 |
| `execute_preflight_insn_mi/s` | <span style='color: green'>(-0 [-0.5%])</span> 14.74 | -          | <span style='color: green'>(-0 [-0.9%])</span> 18.09 | <span style='color: red'>(+0 [+0.2%])</span> 11.40 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+4 [+1.9%])</span> 183 | <span style='color: red'>(+7 [+1.9%])</span> 366 | <span style='color: red'>(+5 [+2.5%])</span> 204 | <span style='color: red'>(+2 [+1.2%])</span> 162 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+4 [+1.3%])</span> 349.50 | <span style='color: red'>(+9 [+1.3%])</span> 699 | <span style='color: red'>(+2 [+0.5%])</span> 390 | <span style='color: red'>(+7 [+2.3%])</span> 309 |
| `main_trace_commit_time_ms` | <span style='color: red'>(+0 [+0.8%])</span> 65 | <span style='color: red'>(+1 [+0.8%])</span> 130 |  75 | <span style='color: red'>(+1 [+1.9%])</span> 55 |
| `generate_perm_trace_time_ms` | <span style='color: red'>(+0 [+1.4%])</span> 36.50 | <span style='color: red'>(+1 [+1.4%])</span> 73 | <span style='color: red'>(+1 [+2.8%])</span> 37 |  36 |
| `perm_trace_commit_time_ms` | <span style='color: red'>(+2 [+2.0%])</span> 77.39 | <span style='color: red'>(+3 [+2.0%])</span> 154.78 | <span style='color: red'>(+2 [+1.9%])</span> 89.20 | <span style='color: red'>(+1 [+2.3%])</span> 65.58 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+1 [+1.1%])</span> 83.26 | <span style='color: red'>(+2 [+1.1%])</span> 166.52 | <span style='color: green'>(-0 [-0.5%])</span> 91.33 | <span style='color: red'>(+2 [+3.1%])</span> 75.19 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+0 [+2.0%])</span> 17.35 | <span style='color: red'>(+1 [+2.0%])</span> 34.70 | <span style='color: green'>(-0 [-0.2%])</span> 19.12 | <span style='color: red'>(+1 [+4.8%])</span> 15.58 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+0 [+0.8%])</span> 65 | <span style='color: red'>(+1 [+0.8%])</span> 130 | <span style='color: red'>(+1 [+1.4%])</span> 74 |  56 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 602 | 1 | 63 | 1,745,742 | 27.65 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 162 | 843 | 32,480,114 | 172,558,444 | 162 | 390 | 0 | 91.33 | 19.12 | 6 | 89.20 | 74 | 128 | 74 | 1 | 75 | 15,909,408 | 36 | 120 | 1,149,000 | 11.40 | 27 | 111 | 1 | 74 | 
| pairing | 1 | 204 | 602 | 22,464,232 | 119,958,502 | 204 | 309 | 1 | 75.19 | 15.58 | 6 | 65.58 | 56 | 105 | 56 | 0 | 55 | 9,498,894 | 37 | 48 | 596,742 | 18.09 | 21 | 91 | 1 | 56 | 

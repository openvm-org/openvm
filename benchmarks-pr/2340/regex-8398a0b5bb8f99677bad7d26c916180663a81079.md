...
|:---|---:|---:|---:|
| Total | <span style='color: red'>(+0 [+1.1%])</span> 2.39 | <span style='color: red'>(+0 [+1.4%])</span> 0.75 | 0.75 |
| regex_program | <span style='color: red'>(+0 [+1.1%])</span> 2.39 | <span style='color: red'>(+0 [+1.4%])</span> 0.75 |  0.75 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+6 [+1.1%])</span> 588.50 | <span style='color: red'>(+25 [+1.1%])</span> 2,354 | <span style='color: red'>(+10 [+1.4%])</span> 713 | <span style='color: red'>(+3 [+0.6%])</span> 531 |
...
| `execute_metered_insn_mi/s` | <span style='color: red'>(+1 [+0.8%])</span> 113.66 | -          | <span style='color: red'>(+1 [+0.8%])</span> 113.66 | <span style='color: red'>(+1 [+0.8%])</span> 113.66 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` | <span style='color: green'>(-1 [-2.7%])</span> 45 | <span style='color: green'>(-5 [-2.7%])</span> 180 |  57 | <span style='color: green'>(-2 [-5.7%])</span> 33 |
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+1 [+3.7%])</span> 31.95 | -          | <span style='color: red'>(+1 [+3.6%])</span> 32.55 | <span style='color: red'>(+1 [+1.9%])</span> 30.47 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+3 [+1.5%])</span> 182.50 | <span style='color: red'>(+11 [+1.5%])</span> 730 | <span style='color: red'>(+3 [+1.5%])</span> 199 | <span style='color: red'>(+2 [+1.2%])</span> 173 |
| `memory_finalize_time_ms` | <span style='color: red'>(+0 [+66.7%])</span> 1.25 | <span style='color: red'>(+2 [+66.7%])</span> 5 | <span style='color: red'>(+2 [+66.7%])</span> 5 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+4 [+1.5%])</span> 286.50 | <span style='color: red'>(+17 [+1.5%])</span> 1,146 | <span style='color: red'>(+8 [+2.6%])</span> 312 | <span style='color: red'>(+1 [+0.4%])</span> 265 |
| `main_trace_commit_time_ms` | <span style='color: red'>(+0 [+1.0%])</span> 52.25 | <span style='color: red'>(+2 [+1.0%])</span> 209 | <span style='color: green'>(-1 [-1.7%])</span> 57 | <span style='color: red'>(+1 [+2.0%])</span> 50 |
| `generate_perm_trace_time_ms` | <span style='color: red'>(+2 [+6.0%])</span> 30.75 | <span style='color: red'>(+7 [+6.0%])</span> 123 | <span style='color: red'>(+5 [+14.3%])</span> 40 | <span style='color: red'>(+1 [+4.5%])</span> 23 |
| `perm_trace_commit_time_ms` | <span style='color: red'>(+1 [+0.8%])</span> 64.86 | <span style='color: red'>(+2 [+0.8%])</span> 259.45 | <span style='color: red'>(+1 [+2.1%])</span> 70.78 | <span style='color: red'>(+0 [+0.7%])</span> 56.18 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+2 [+3.8%])</span> 61.30 | <span style='color: red'>(+9 [+3.8%])</span> 245.21 | <span style='color: red'>(+1 [+1.6%])</span> 71.35 | <span style='color: red'>(+0 [+0.8%])</span> 54.52 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+0 [+3.0%])</span> 16.12 | <span style='color: red'>(+2 [+3.0%])</span> 64.46 | <span style='color: red'>(+1 [+3.6%])</span> 18.75 | <span style='color: red'>(+1 [+3.9%])</span> 14.42 |
| `pcs_opening_time_ms ` | <span style='color: green'>(-2 [-2.9%])</span> 57.75 | <span style='color: green'>(-7 [-2.9%])</span> 231 | <span style='color: green'>(-3 [-4.5%])</span> 64 | <span style='color: green'>(-4 [-7.5%])</span> 49 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 576 | 1 | 36 | 4,137,502 | 113.66 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 173 | 713 | 23,446,148 | 150,778,428 | 173 | 312 | 0 | 64.36 | 18.75 | 5 | 70.78 | 64 | 106 | 63 | 5 | 57 | 10,899,170 | 35 | 57 | 1,103,000 | 30.47 | 22 | 83 | 1 | 63 | 
| regex_program | 1 | 179 | 534 | 11,598,276 | 128,513,066 | 179 | 267 | 1 | 54.52 | 15.73 | 4 | 66.04 | 55 | 89 | 55 | 0 | 51 | 2,196,106 | 23 | 45 | 1,104,000 | 32.55 | 17 | 70 | 0 | 55 | 
| regex_program | 2 | 179 | 531 | 11,579,064 | 128,513,066 | 179 | 265 | 1 | 54.98 | 15.56 | 4 | 66.44 | 49 | 92 | 49 | 0 | 51 | 2,177,334 | 25 | 45 | 1,104,000 | 32.37 | 17 | 71 | 0 | 49 | 
| regex_program | 3 | 199 | 576 | 11,853,872 | 103,456,394 | 199 | 302 | 0 | 71.35 | 14.42 | 5 | 56.18 | 63 | 100 | 63 | 0 | 50 | 2,422,606 | 40 | 33 | 826,502 | 32.40 | 19 | 86 | 1 | 63 | 
...
Commit: https://github.com/openvm-org/openvm/commit/8398a0b5bb8f99677bad7d26c916180663a81079
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/20705262980)

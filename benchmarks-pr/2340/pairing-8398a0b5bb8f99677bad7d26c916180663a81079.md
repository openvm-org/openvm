...
|:---|---:|---:|---:|
| Total | <span style='color: red'>(+0 [+1.3%])</span> 1.51 | <span style='color: red'>(+0 [+1.3%])</span> 0.91 | 0.91 |
| pairing | <span style='color: red'>(+0 [+1.2%])</span> 1.51 | <span style='color: red'>(+0 [+1.1%])</span> 0.91 |  0.91 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+9 [+1.3%])</span> 721.50 | <span style='color: red'>(+18 [+1.3%])</span> 1,443 | <span style='color: red'>(+10 [+1.2%])</span> 845 | <span style='color: red'>(+8 [+1.4%])</span> 598 |
| `main_cells_used     ` |  12,704,151 |  25,408,302 |  15,909,408 |  9,498,894 |
| `total_cells_used    ` |  27,472,173 |  54,944,346 |  32,480,114 |  22,464,232 |
| `execute_metered_time_ms` | <span style='color: red'>(+2 [+3.2%])</span> 64 | -          | -          | -          |
| `execute_metered_insn_mi/s` | <span style='color: green'>(-1 [-1.9%])</span> 27.23 | -          | <span style='color: green'>(-1 [-1.9%])</span> 27.23 | <span style='color: green'>(-1 [-1.9%])</span> 27.23 |
...
| `execute_preflight_insn_mi/s` |  14.81 | -          | <span style='color: green'>(-0 [-0.4%])</span> 18.18 | <span style='color: red'>(+0 [+0.6%])</span> 11.45 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+4 [+2.5%])</span> 184 | <span style='color: red'>(+9 [+2.5%])</span> 368 | <span style='color: red'>(+4 [+2.0%])</span> 203 | <span style='color: red'>(+5 [+3.1%])</span> 165 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+4 [+1.2%])</span> 349 | <span style='color: red'>(+8 [+1.2%])</span> 698 | <span style='color: red'>(+4 [+1.0%])</span> 392 | <span style='color: red'>(+4 [+1.3%])</span> 306 |
...
| `generate_perm_trace_time_ms` | <span style='color: green'>(-0 [-1.4%])</span> 35.50 | <span style='color: green'>(-1 [-1.4%])</span> 71 |  36 | <span style='color: green'>(-1 [-2.8%])</span> 35 |
| `perm_trace_commit_time_ms` | <span style='color: red'>(+1 [+0.7%])</span> 76.42 | <span style='color: red'>(+1 [+0.7%])</span> 152.84 | <span style='color: red'>(+1 [+1.6%])</span> 88.98 | <span style='color: green'>(-0 [-0.4%])</span> 63.86 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+1 [+1.0%])</span> 83.16 | <span style='color: red'>(+2 [+1.0%])</span> 166.33 | <span style='color: red'>(+2 [+1.8%])</span> 93.43 |  72.90 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+0 [+1.8%])</span> 17.32 | <span style='color: red'>(+1 [+1.8%])</span> 34.65 | <span style='color: red'>(+0 [+2.0%])</span> 19.54 | <span style='color: red'>(+0 [+1.6%])</span> 15.10 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+2 [+3.9%])</span> 67 | <span style='color: red'>(+5 [+3.9%])</span> 134 |  73 | <span style='color: red'>(+5 [+8.9%])</span> 61 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 598 | 1 | 64 | 1,745,742 | 27.23 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 165 | 845 | 32,480,114 | 172,558,444 | 165 | 392 | 0 | 93.43 | 19.54 | 6 | 88.98 | 73 | 129 | 73 | 1 | 75 | 15,909,408 | 36 | 119 | 1,149,000 | 11.45 | 27 | 113 | 1 | 73 | 
| pairing | 1 | 203 | 598 | 22,464,232 | 119,958,502 | 203 | 306 | 1 | 72.90 | 15.10 | 5 | 63.86 | 61 | 102 | 61 | 0 | 53 | 9,498,894 | 35 | 48 | 596,742 | 18.18 | 21 | 88 | 1 | 61 | 

...
| `total_proof_time_ms ` |  1,149.50 |  2,299 |  1,834 |  465 |
| `execute_metered_time_ms` |  34 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  74.69 | -          |  74.69 |  74.69 |
| `execute_preflight_insns` |  1,289,951.50 |  2,579,903 |  2,020,000 |  559,903 |
| `execute_preflight_time_ms` |  79.50 |  159 |  80 |  79 |
| `execute_preflight_insn_mi/s` |  34.42 | -          |  36.11 |  32.73 |
| `trace_gen_time_ms   ` |  57.50 |  115 |  94 |  21 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  898 |  1,796 |  1,472 |  324 |
| `prover.main_trace_commit_time_ms` |  294 |  588 |  506 |  82 |
| `prover.rap_constraints_time_ms` |  538 |  1,076 |  871 |  205 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/ec7b84d10e17d924ee3a56bfacda31e44964e145/kitchen_sink-ec7b84d10e17d924ee3a56bfacda31e44964e145.memory.svg)
...
| app_proof |  |  |  |  |  | 465 |  |  | 34 | 2,579,903 | 74.69 | 0 | 2,338 |  | 
...
| leaf | 0 | prover | 428,317,568 | 321 | 130 | 0 | 10 | 145 | 48 | 47 | 37 | 59 | 0 | 44 | 12 | 31 | 7 | 24 | 131 | 145 | 0 | 2 | 58 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,221,261,804 | 1,472 | 505 | 0 | 288 | 871 | 452 | 451 | 143 | 275 | 137 | 93 | 17 | 76 | 25 | 51 | 506 | 871 | 0 | 1 | 136 | 0 | 0 | 
| app_proof | prover | 1 | 370,741,140 | 324 | 81 | 0 | 17 | 205 | 114 | 114 | 46 | 43 | 0 | 36 | 10 | 26 | 7 | 18 | 82 | 205 | 0 | 1 | 43 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 94 | 1,834 | 94 | 187 | 0 | 3 | 80 | 2,020,000 | 32.73 | 
| app_proof | 1 | 21 | 465 | 21 | 40 | 0 | 1 | 79 | 559,903 | 36.11 | 

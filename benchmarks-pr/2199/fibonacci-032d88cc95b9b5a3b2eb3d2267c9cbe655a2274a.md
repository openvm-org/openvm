...
| `total_proof_time_ms ` |  501 |  1,002 |  555 |  447 |
...
| `execute_metered_insn_mi/s` |  146.92 | -          |  146.92 |  146.92 |
| `execute_preflight_insns` |  750,104.50 |  1,500,209 |  873,000 |  627,209 |
| `execute_preflight_time_ms` |  28.50 |  57 |  32 |  25 |
| `execute_preflight_insn_mi/s` |  37.77 | -          |  39.88 |  35.65 |
| `trace_gen_time_ms   ` |  192 |  384 |  195 |  189 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  187.50 |  375 |  191 |  184 |
| `main_trace_commit_time_ms` |  30.50 |  61 |  33 |  28 |
| `generate_perm_trace_time_ms` |  25.50 |  51 |  37 |  14 |
| `perm_trace_commit_time_ms` |  42.51 |  85.02 |  45.88 |  39.13 |
| `quotient_poly_compute_time_ms` |  32.23 |  64.46 |  35.60 |  28.86 |
| `quotient_poly_commit_time_ms` |  12.09 |  24.19 |  12.67 |  11.52 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 447 | 67 | 1 | 10 | 1,500,209 | 146.92 | 173 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 195 | 555 | 9,677,708 | 84,395,212 | 195 | 191 | 0 | 35.60 | 12.67 | 4 | 45.88 | 46 | 61 | 46 | 0 | 33 | 1,035,986 | 14 | 25 | 873,000 | 35.65 | 14 | 48 | 0 | 46 | 
| fibonacci_program | 1 | 189 | 447 | 9,708,170 | 74,305,770 | 189 | 184 | 1 | 28.86 | 11.52 | 4 | 39.13 | 37 | 77 | 37 | 0 | 28 | 1,064,416 | 37 | 32 | 627,209 | 39.88 | 11 | 40 | 0 | 37 | 
...
Commit: https://github.com/openvm-org/openvm/commit/032d88cc95b9b5a3b2eb3d2267c9cbe655a2274a
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19116582780)

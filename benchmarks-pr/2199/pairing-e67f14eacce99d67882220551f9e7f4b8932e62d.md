...
| `total_proof_time_ms ` |  722 |  1,444 |  833 |  611 |
...
| `execute_preflight_insn_mi/s` |  13.54 | -          |  17.95 |  9.14 |
| `trace_gen_time_ms   ` |  179 |  358 |  196 |  162 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  356.50 |  713 |  399 |  314 |
| `main_trace_commit_time_ms` |  65 |  130 |  75 |  55 |
| `generate_perm_trace_time_ms` |  33 |  66 |  37 |  29 |
| `perm_trace_commit_time_ms` |  77.08 |  154.15 |  89.76 |  64.40 |
| `quotient_poly_compute_time_ms` |  80.16 |  160.32 |  88.54 |  71.78 |
| `quotient_poly_commit_time_ms` |  16.10 |  32.20 |  17.50 |  14.70 |
| `pcs_opening_time_ms ` |  80 |  160 |  86 |  74 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 611 | 41 | 1 | 89 | 1,745,742 | 19.42 | 150 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 162 | 833 | 32,689,110 | 172,558,444 | 162 | 399 | 0 | 88.54 | 17.50 | 6 | 89.76 | 86 | 130 | 86 | 1 | 75 | 16,059,916 | 37 | 130 | 1,157,000 | 9.14 | 26 | 106 | 1 | 86 | 
| pairing | 1 | 196 | 611 | 22,314,288 | 119,958,502 | 196 | 314 | 1 | 71.78 | 14.70 | 6 | 64.40 | 74 | 96 | 74 | 0 | 55 | 9,408,294 | 29 | 59 | 588,742 | 17.95 | 21 | 87 | 1 | 74 | 

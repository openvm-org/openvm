...
| `total_proof_time_ms ` |  580.50 |  2,322 |  702 |  537 |
...
| `execute_metered_insn_mi/s` |  115.53 | -          |  115.53 |  115.53 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  52.75 |  211 |  65 |  43 |
| `execute_preflight_insn_mi/s` |  32.22 | -          |  33.47 |  28.100 |
| `trace_gen_time_ms   ` |  179 |  716 |  214 |  156 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  280.75 |  1,123 |  298 |  272 |
| `main_trace_commit_time_ms` |  51.50 |  206 |  57 |  49 |
| `generate_perm_trace_time_ms` |  25.75 |  103 |  35 |  20 |
| `perm_trace_commit_time_ms` |  64.83 |  259.31 |  70.81 |  55.98 |
| `quotient_poly_compute_time_ms` |  57.76 |  231.02 |  68.93 |  51.70 |
| `quotient_poly_commit_time_ms` |  14.100 |  59.98 |  16.69 |  13.19 |
| `pcs_opening_time_ms ` |  62.50 |  250 |  73 |  58 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 542 | 41 | 1 | 35 | 4,137,502 | 115.53 | 171 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 214 | 702 | 23,446,148 | 150,778,428 | 214 | 298 | 0 | 57.62 | 16.69 | 5 | 70.81 | 58 | 107 | 58 | 4 | 57 | 10,899,170 | 35 | 43 | 1,103,000 | 28.100 | 21 | 75 | 1 | 58 | 
| regex_program | 1 | 156 | 541 | 11,598,276 | 128,513,066 | 156 | 279 | 1 | 51.70 | 15.37 | 4 | 66.58 | 73 | 88 | 73 | 0 | 49 | 2,196,106 | 21 | 65 | 1,104,000 | 33.42 | 17 | 67 | 0 | 73 | 
| regex_program | 2 | 163 | 537 | 11,579,064 | 128,513,066 | 163 | 274 | 1 | 52.77 | 14.74 | 4 | 65.95 | 61 | 93 | 61 | 0 | 50 | 2,177,334 | 27 | 58 | 1,104,000 | 33.01 | 16 | 68 | 0 | 61 | 
| regex_program | 3 | 183 | 542 | 11,853,872 | 103,456,394 | 183 | 272 | 0 | 68.93 | 13.19 | 5 | 55.98 | 58 | 79 | 58 | 0 | 50 | 2,422,606 | 20 | 45 | 826,502 | 33.47 | 18 | 83 | 1 | 58 | 
...
Commit: https://github.com/openvm-org/openvm/commit/d1c59f8b20cd95b574593fc332b977e44e5ee538
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19146940618)

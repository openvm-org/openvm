...
|:---|---:|---:|---:|
| Total |  23.72 |  7.26 |  7.26 |
| app_proof |  19.22 |  3.83 |  3.83 |
| leaf |  3.38 |  2.32 |  2.32 |
...
| `total_proof_time_ms ` |  3,198 |  19,188 |  3,797 |  3,062 |
| `execute_metered_time_ms` |  37 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  33.11 | -          |  33.11 |  33.11 |
| `execute_preflight_insns` |  205,869.67 |  1,235,218 |  207,000 |  200,218 |
| `execute_preflight_time_ms` |  180 |  1,080 |  265 |  15 |
| `execute_preflight_insn_mi/s` |  19.10 | -          |  19.26 |  18.83 |
| `trace_gen_time_ms   ` |  385.67 |  2,314 |  539 |  350 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  2,568.83 |  15,413 |  3,071 |  2,464 |
| `prover.main_trace_commit_time_ms` |  688.33 |  4,130 |  844 |  657 |
| `prover.rap_constraints_time_ms` |  1,104.50 |  6,627 |  1,213 |  1,081 |
| `prover.openings_time_ms` |  774.83 |  4,649 |  1,013 |  723 |
| `prover.rap_constraints.logup_gkr_time_ms` |  275 |  1,650 |  382 |  253 |
| `prover.rap_constraints.round0_time_ms` |  516.67 |  3,100 |  518 |  515 |
| `prover.rap_constraints.mle_rounds_time_ms` |  312.67 |  1,876 |  314 |  310 |
| `prover.openings.stacked_reduction_time_ms` |  138.83 |  833 |  140 |  138 |
...
| `prover.openings.whir_time_ms` |  635.67 |  3,814 |  873 |  585 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,689 |  3,378 |  2,317 |  1,061 |
| `execute_preflight_time_ms` |  22.50 |  45 |  30 |  15 |
| `trace_gen_time_ms   ` |  126.50 |  253 |  168 |  85 |
| `generate_blob_total_time_ms` |  25.50 |  51 |  34 |  17 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,562.50 |  3,125 |  2,149 |  976 |
| `prover.main_trace_commit_time_ms` |  543.50 |  1,087 |  714 |  373 |
| `prover.rap_constraints_time_ms` |  306 |  612 |  393 |  219 |
| `prover.openings_time_ms` |  711 |  1,422 |  1,040 |  382 |
| `prover.rap_constraints.logup_gkr_time_ms` |  65.50 |  131 |  81 |  50 |
| `prover.rap_constraints.round0_time_ms` |  145.50 |  291 |  190 |  101 |
...
| `prover.openings.whir_time_ms` |  642.50 |  1,285 |  955 |  330 |
...
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  680 |  680 |  680 |  680 |
...
| `prover.openings.whir_time_ms` |  224 |  224 |  224 |  224 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/12cffe87fc45fbf2909942b42ecc8a82e92bb62d/keccak-12cffe87fc45fbf2909942b42ecc8a82e92bb62d.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof |  |  | 3,067 | 37 | 1,235,218 | 33.11 | 0 | 19,233 |  | 
| internal_for_leaf |  | 716 |  |  |  |  |  |  | 716 | 
| internal_recursive.0 |  | 227 |  |  |  |  |  |  | 227 | 
...
| app_proof | VmAirWrapper<Rv32LoadStoreAdapterAir, LoadStoreCoreAir<4> | 3 | 347 | 
...
| app_proof | VmAirWrapper<Rv32LoadStoreAdapterAir, LoadStoreCoreAir<4> | 4 | 346 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 36 | 716 | 35 | 13 | 4 | 6 | 4 | 
| internal_recursive.0 | 1 | 13 | 227 | 12 | 2 | 1 | 4 | 1 | 
| internal_recursive.1 | 1 | 9 | 170 | 9 | 1 | 0 | 2 | 0 | 
| leaf | 0 |
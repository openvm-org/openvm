...
|:---|---:|---:|---:|
| Total |  6.46 |  2.54 |  2.54 |
| app_proof |  4.21 |  0.81 |  0.81 |
| leaf |  1.36 |  0.84 |  0.84 |
...
| `total_proof_time_ms ` |  590.71 |  4,135 |  735 |  565 |
| `execute_metered_time_ms` |  72 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  165.82 | -          |  165.82 |  165.82 |
| `execute_preflight_insns` |  1,714,323.57 |  12,000,265 |  1,747,000 |  1,518,265 |
| `execute_preflight_time_ms` |  57.71 |  404 |  65 |  51 |
| `execute_preflight_insn_mi/s` |  39.38 | -          |  40.26 |  38.01 |
| `trace_gen_time_ms   ` |  153.29 |  1,073 |  160 |  148 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  318.86 |  2,232 |  347 |  312 |
| `prover.main_trace_commit_time_ms` |  58.43 |  409 |  59 |  58 |
| `prover.rap_constraints_time_ms` |  173.29 |  1,213 |  177 |  172 |
| `prover.openings_time_ms` |  86.14 |  603 |  110 |  80 |
| `prover.rap_constraints.logup_gkr_time_ms` |  126 |  882 |  127 |  125 |
| `prover.rap_constraints.round0_time_ms` |  27.71 |  194 |  30 |  27 |
| `prover.rap_constraints.mle_rounds_time_ms` |  18.57 |  130 |  19 |  18 |
| `prover.openings.stacked_reduction_time_ms` |  16.71 |  117 |  19 |  16 |
| `prover.openings.stacked_reduction.round0_time_ms` |  5.71 |  40 |  6 |  5 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  10.71 |  75 |  13 |  10 |
| `prover.openings.whir_time_ms` |  69.14 |  484 |  91 |  64 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  679.50 |  1,359 |  837 |  522 |
| `execute_preflight_time_ms` |  9.50 |  19 |  15 |  4 |
| `trace_gen_time_ms   ` |  46 |  92 |  59 |  33 |
| `generate_blob_total_time_ms` |  3.50 |  7 |  4 |  3 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  633 |  1,266 |  778 |  488 |
| `prover.main_trace_commit_time_ms` |  194.50 |  389 |  232 |  157 |
| `prover.rap_constraints_time_ms` |  158.50 |  317 |  175 |  142 |
| `prover.openings_time_ms` |  279.50 |  559 |  371 |  188 |
| `prover.rap_constraints.logup_gkr_time_ms` |  41 |  82 |  48 |  34 |
| `prover.rap_constraints.round0_time_ms` |  69 |  138 |  75 |  63 |
...
| `prover.openings.whir_time_ms` |  243 |  486 |  331 |  155 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/e395b986569fa29a5511c0bfa3ba5c6cd71de734/fibonacci-e395b986569fa29a5511c0bfa3ba5c6cd71de734.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof |  |  | 569 | 72 | 12,000,265 | 165.82 | 0 | 4,217 |  | 
| internal_for_leaf |  | 516 |  |  |  |  |  |  | 516 | 
| internal_recursive.0 |  | 208 |  |  |  |  |  |  | 208 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 27 | 516 | 26 | 10 | 2 | 4 | 1 | 
| internal_recursive.0 | 1 | 11 | 207 | 11 | 1 | 0 | 3 | 1 | 
| internal_recursive.1 | 1 | 9 | 175 | 9 | 1 | 0 | 2 | 0 | 
| leaf | 0 | 59 | 837 | 58 | 23 | 4 | 15 | 13 | 
| leaf | 1 | 33 | 522 | 33 | 18 | 3 | 4 | 2 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 75,533,952 | 489 | 159 | 0 | 9 | 143 | 38 | 37 | 71 | 33 | 0 | 186 | 154 | 32 | 5 | 26 | 159 | 143 | 2 | 31 | 0 | 
| internal_recursive.0 | 1 | prover | 23,651,975 |
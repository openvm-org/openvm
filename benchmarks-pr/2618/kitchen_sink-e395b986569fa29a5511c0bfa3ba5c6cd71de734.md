...
|:---|---:|---:|---:|
| Total |  4.56 |  3.24 |  3.24 |
| app_proof |  3.30 |  1.98 |  1.98 |
| leaf |  0.72 |  0.72 |  0.72 |
...
| `total_proof_time_ms ` |  1,647 |  3,294 |  1,975 |  1,319 |
| `execute_metered_time_ms` |  7 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  20.38 | -          |  20.38 |  20.38 |
| `execute_preflight_insns` |  77,381.50 |  154,763 |  121,000 |  33,763 |
| `execute_preflight_time_ms` |  70.50 |  141 |  121 |  20 |
| `execute_preflight_insn_mi/s` |  8.54 | -          |  11.29 |  5.78 |
| `trace_gen_time_ms   ` |  158.50 |  317 |  188 |  129 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,303.50 |  2,607 |  1,580 |  1,027 |
| `prover.main_trace_commit_time_ms` |  220.50 |  441 |  291 |  150 |
| `prover.rap_constraints_time_ms` |  561 |  1,122 |  658 |  464 |
| `prover.openings_time_ms` |  521.50 |  1,043 |  631 |  412 |
| `prover.rap_constraints.logup_gkr_time_ms` |  140.50 |  281 |  154 |  127 |
| `prover.rap_constraints.round0_time_ms` |  287.50 |  575 |  364 |  211 |
...
| `prover.openings.whir_time_ms` |  472.50 |  945 |  570 |  375 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  723 |  723 |  723 |  723 |
...
| `prover.openings.whir_time_ms` |  332 |  332 |  332 |  332 |
...
| `prover.openings.whir_time_ms` |  106 |  106 |  106 |  106 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/e395b986569fa29a5511c0bfa3ba5c6cd71de734/kitchen_sink-e395b986569fa29a5511c0bfa3ba5c6cd71de734.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof |  |  | 1,320 | 7 | 154,763 | 20.38 | 0 | 3,308 |  | 
| internal_for_leaf |  | 254 |  |  |  |  |  |  | 254 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 19 | 254 | 19 | 6 | 1 | 5 | 2 | 
| internal_recursive.0 | 1 | 10 | 151 | 10 | 1 | 0 | 3 | 1 | 
| internal_recursive.1 | 1 | 8 | 128 | 8 | 1 | 0 | 2 | 0 | 
| leaf | 0 | 95 | 723 | 94 | 25 | 11 | 24 | 6 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 53,472,003 | 235 | 40 | 0 | 4 | 64 | 19 | 18 | 28 | 15 | 0 | 129 | 106 | 23 | 1 | 21 | 41 | 63 | 1 | 14 | 0 | 
| internal_recursive.0 | 1 | prover | 23,651,975 | 141 | 19 | 0 | 4 | 50 | 16 | 16 | 20 | 13 | 0 | 70 | 49 | 21 | 1 | 20 | 19 | 50 | 1 | 12 | 0 | 
| internal_recursive.1 | 1 | prover | 17,507,975 | 119 | 14 | 0 | 4 | 48 | 16 | 16 | 18 | 13 | 0 | 55 | 34 | 21 | 0 | 20 | 15 | 48 | 1 | 12 | 0 | 
| leaf | 0 | prover | 407,935,872 | 628 | 124 | 0 | 9 | 140 | 44 | 43 | 36 | 59 | 0 | 363 | 332 | 30 | 6 | 23 | 124 | 140 | 2 | 59 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 816,542,084 | 1,580 | 290 | 0 | 162 | 658 | 364 | 363 | 139 | 154 | 61 | 631 | 570 | 60 | 15 | 44 | 291 | 658 | 1 | 91 | 0 | 
| app_proof | prover | 1 | 800,298,548 | 1,027 | 150 | 0 | 20 | 464 | 211 | 210 | 125 | 127 | 74 | 412 | 375 | 36 | 14 | 22 | 150 | 464 | 1 | 53 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 188 | 1,975 | 188 | 186 | 0 | 50 | 20 | 121,000 | 11.29 | 
| app_proof | 1 | 129 | 1,319 | 129 | 41 | 0 | 3 | 121 | 33,763 | 5.78 | 

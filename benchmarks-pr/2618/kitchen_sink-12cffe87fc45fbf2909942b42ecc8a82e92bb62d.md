...
| `total_proof_time_ms ` |  1,651.50 |  3,303 |  1,979 |  1,324 |
| `execute_metered_time_ms` |  7 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  20.01 | -          |  20.01 |  20.01 |
| `execute_preflight_insns` |  77,381.50 |  154,763 |  121,000 |  33,763 |
| `execute_preflight_time_ms` |  71 |  142 |  122 |  20 |
| `execute_preflight_insn_mi/s` |  8.55 | -          |  11.11 |  5.99 |
| `trace_gen_time_ms   ` |  158 |  316 |  188 |  128 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,307.50 |  2,615 |  1,583 |  1,032 |
| `prover.main_trace_commit_time_ms` |  221 |  442 |  293 |  149 |
| `prover.rap_constraints_time_ms` |  563.50 |  1,127 |  658 |  469 |
| `prover.openings_time_ms` |  522 |  1,044 |  631 |  413 |
| `prover.rap_constraints.logup_gkr_time_ms` |  142 |  284 |  154 |  130 |
| `prover.rap_constraints.round0_time_ms` |  286 |  572 |  362 |  210 |
| `prover.rap_constraints.mle_rounds_time_ms` |  134 |  268 |  140 |  128 |
...
| `prover.openings.whir_time_ms` |  473 |  946 |  570 |  376 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/12cffe87fc45fbf2909942b42ecc8a82e92bb62d/kitchen_sink-12cffe87fc45fbf2909942b42ecc8a82e92bb62d.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof |  |  | 1,324 | 7 | 154,763 | 20.01 | 0 | 3,316 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 18 | 256 | 18 | 6 | 1 | 5 | 2 | 
| internal_recursive.0 | 1 | 10 | 153 | 9 | 1 | 0 | 3 | 0 | 
| internal_recursive.1 | 1 | 8 | 128 | 8 | 1 | 0 | 2 | 0 | 
| leaf | 0 | 97 | 723 | 96 | 25 | 12 | 24 | 6 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 53,472,003 | 237 | 40 | 0 | 4 | 65 | 20 | 19 | 29 | 15 | 0 | 129 | 106 | 23 | 1 | 21 | 41 | 65 | 1 | 15 | 0 | 
| internal_recursive.0 | 1 | prover | 23,651,975 | 143 | 19 | 0 | 4 | 51 | 17 | 16 | 20 | 13 | 0 | 71 | 50 | 21 | 1 | 20 | 19 | 51 | 1 | 13 | 0 | 
| internal_recursive.1 | 1 | prover | 17,507,975 | 119 | 14 | 0 | 4 | 49 | 17 | 16 | 18 | 13 | 0 | 54 | 33 | 21 | 0 | 20 | 15 | 49 | 1 | 12 | 0 | 
| leaf | 0 | prover | 407,935,872 | 626 | 123 | 0 | 9 | 139 | 44 | 43 | 36 | 58 | 0 | 362 | 331 | 31 | 6 | 24 | 124 | 139 | 2 | 58 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 816,542,084 | 1,583 | 293 | 0 | 163 | 658 | 362 | 361 | 140 | 154 | 62 | 631 | 570 | 60 | 15 | 45 | 293 | 657 | 1 | 90 | 0 | 
| app_proof | prover | 1 | 800,298,548 | 1,032 | 149 | 0 | 20 | 469 | 210 | 209 | 128 | 130 | 76 | 413 | 376 | 36 | 14 | 22 | 149 | 469 | 1 | 53 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 188 | 1,979 | 188 | 186 | 0 | 50 | 20 | 121,000 | 11.11 | 
| app_proof | 1 | 128 | 1,324 | 128 | 41 | 0 | 3 | 122 | 33,763 | 5.99 | 

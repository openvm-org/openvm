...
|:---|---:|---:|---:|
| Total |  23.73 |  7.28 |  7.28 |
| app_proof |  19.23 |  3.84 |  3.84 |
| leaf |  3.37 |  2.31 |  2.31 |
...
| `total_proof_time_ms ` |  3,199.67 |  19,198 |  3,806 |  3,063 |
...
| `execute_preflight_time_ms` |  179.50 |  1,077 |  263 |  15 |
| `execute_preflight_insn_mi/s` |  19.35 | -          |  19.58 |  19.12 |
| `trace_gen_time_ms   ` |  386.33 |  2,318 |  540 |  350 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  2,570.33 |  15,422 |  3,079 |  2,464 |
| `prover.main_trace_commit_time_ms` |  687.67 |  4,126 |  846 |  655 |
| `prover.rap_constraints_time_ms` |  1,107.67 |  6,646 |  1,222 |  1,080 |
| `prover.openings_time_ms` |  774 |  4,644 |  1,010 |  721 |
| `prover.rap_constraints.logup_gkr_time_ms` |  275.33 |  1,652 |  384 |  253 |
| `prover.rap_constraints.round0_time_ms` |  518.83 |  3,113 |  522 |  515 |
| `prover.rap_constraints.mle_rounds_time_ms` |  312 |  1,872 |  318 |  307 |
| `prover.openings.stacked_reduction_time_ms` |  138.17 |  829 |  141 |  131 |
| `prover.openings.stacked_reduction.round0_time_ms` |  83.17 |  499 |  85 |  76 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  54.67 |  328 |  56 |  53 |
| `prover.openings.whir_time_ms` |  635 |  3,810 |  869 |  586 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,686.50 |  3,373 |  2,312 |  1,061 |
| `execute_preflight_time_ms` |  22.50 |  45 |  30 |  15 |
| `trace_gen_time_ms   ` |  125 |  250 |  166 |  84 |
| `generate_blob_total_time_ms` |  25.50 |  51 |  34 |  17 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,560.50 |  3,121 |  2,145 |  976 |
| `prover.main_trace_commit_time_ms` |  542.50 |  1,085 |  713 |  372 |
| `prover.rap_constraints_time_ms` |  306.50 |  613 |  393 |  220 |
| `prover.openings_time_ms` |  710 |  1,420 |  1,037 |  383 |
...
| `prover.openings.whir_time_ms` |  640 |  1,280 |  949 |  331 |
...
| `prover.openings.whir_time_ms` |  229 |  229 |  229 |  229 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/57a96d3aa88952db28680b85f82b197bb230538c/keccak-57a96d3aa88952db28680b85f82b197bb230538c.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof |  |  | 3,065 | 37 | 1,235,218 | 32.93 | 0 | 19,243 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 36 | 725 | 35 | 13 | 4 | 6 | 4 | 
| internal_recursive.0 | 1 | 12 | 225 | 12 | 2 | 1 | 4 | 1 | 
| internal_recursive.1 | 1 | 9 | 176 | 8 | 1 | 0 | 2 | 0 | 
| leaf | 0 | 166 | 2,312 | 166 | 64 | 34 | 30 | 24 | 
| leaf | 1 | 84 | 1,061 | 83 | 32 | 17 | 15 | 10 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 109,497,984 |
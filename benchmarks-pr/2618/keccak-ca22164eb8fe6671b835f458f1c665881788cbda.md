...
|:---|---:|---:|---:|
| Total |  23.69 |  7.26 |  7.26 |
| app_proof |  19.21 |  3.84 |  3.84 |
| leaf |  3.36 |  2.30 |  2.30 |
...
| `total_proof_time_ms ` |  3,195.67 |  19,174 |  3,799 |  3,058 |
| `execute_metered_time_ms` |  37 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  32.80 | -          |  32.80 |  32.80 |
| `execute_preflight_insns` |  205,869.67 |  1,235,218 |  207,000 |  200,218 |
| `execute_preflight_time_ms` |  183.17 |  1,099 |  279 |  16 |
| `execute_preflight_insn_mi/s` |  19.30 | -          |  19.54 |  18.99 |
| `trace_gen_time_ms   ` |  385.83 |  2,315 |  541 |  350 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  2,563.33 |  15,380 |  3,072 |  2,459 |
| `prover.main_trace_commit_time_ms` |  686.33 |  4,118 |  844 |  654 |
| `prover.rap_constraints_time_ms` |  1,102.50 |  6,615 |  1,212 |  1,080 |
| `prover.openings_time_ms` |  773.50 |  4,641 |  1,014 |  723 |
| `prover.rap_constraints.logup_gkr_time_ms` |  275.50 |  1,653 |  384 |  253 |
| `prover.rap_constraints.round0_time_ms` |  515.50 |  3,093 |  518 |  512 |
| `prover.rap_constraints.mle_rounds_time_ms` |  310.83 |  1,865 |  315 |  309 |
| `prover.openings.stacked_reduction_time_ms` |  137.67 |  826 |  141 |  136 |
| `prover.openings.stacked_reduction.round0_time_ms` |  83.17 |  499 |  85 |  82 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  53.67 |  322 |  55 |  52 |
| `prover.openings.whir_time_ms` |  635.17 |  3,811 |  873 |  586 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,679 |  3,358 |  2,300 |  1,058 |
| `execute_preflight_time_ms` |  22.50 |  45 |  30 |  15 |
| `trace_gen_time_ms   ` |  125.50 |  251 |  167 |  84 |
| `generate_blob_total_time_ms` |  25.50 |  51 |  34 |  17 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,553.50 |  3,107 |  2,133 |  974 |
| `prover.main_trace_commit_time_ms` |  541.50 |  1,083 |  711 |  372 |
| `prover.rap_constraints_time_ms` |  305 |  610 |  391 |  219 |
| `prover.openings_time_ms` |  706.50 |  1,413 |  1,030 |  383 |
| `prover.rap_constraints.logup_gkr_time_ms` |  66 |  132 |  82 |  50 |
| `prover.rap_constraints.round0_time_ms` |  146 |  292 |  191 |  101 |
...
| `prover.openings.whir_time_ms` |  638 |  1,276 |  945 |  331 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/ca22164eb8fe6671b835f458f1c665881788cbda/keccak-ca22164eb8fe6671b835f458f1c665881788cbda.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof |  |  | 3,058 | 37 | 1,235,218 | 32.80 | 0 | 19,218 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 36 | 719 | 36 | 13 | 5 | 6 | 4 | 
| internal_recursive.0 | 1 | 12 | 225 | 12 | 2 | 1 | 4 | 1 | 
| internal_recursive.1 | 1 | 9 | 176 | 9 | 1 | 0 | 2 | 0 | 
| leaf | 0 | 167 | 2,300 | 167 | 64 | 34 | 30 | 24 | 
| leaf | 1 | 84 | 1,058 | 83 | 32 | 17 | 15 | 10 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 109,497,984 |
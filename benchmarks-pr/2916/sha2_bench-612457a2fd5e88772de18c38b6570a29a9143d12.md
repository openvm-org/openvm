...
| `total_proof_time_ms ` |  4,093.50 |  8,187 |  5,175 |  3,012 |
...
| `execute_preflight_time_ms` |  258 |  516 |  289 |  227 |
| `execute_preflight_insn_mi/s` |  36.01 | -          |  37.90 |  34.13 |
| `trace_gen_time_ms   ` |  125.50 |  251 |  176 |  75 |
| `set_initial_memory_time_ms` |  88.50 |  177 |  136 |  41 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  3,620.50 |  7,241 |  4,635 |  2,606 |
| `prover.main_trace_commit_time_ms` |  956 |  1,912 |  1,326 |  586 |
| `prover.rap_constraints_time_ms` |  1,960.50 |  3,921 |  2,418 |  1,503 |
| `prover.openings_time_ms` |  703 |  1,406 |  890 |  516 |
| `prover.rap_constraints.logup_gkr_time_ms` |  550.50 |  1,101 |  592 |  509 |
| `prover.rap_constraints.round0_time_ms` |  1,034 |  2,068 |  1,344 |  724 |
| `prover.rap_constraints.mle_rounds_time_ms` |  374.50 |  749 |  481 |  268 |
| `prover.openings.stacked_reduction_time_ms` |  164 |  328 |  211 |  117 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/612457a2fd5e88772de18c38b6570a29a9143d12/sha2_bench-612457a2fd5e88772de18c38b6570a29a9143d12.memory.svg)
...
| app_proof |  |  |  |  |  | 3,012 |  |  | 99 | 11,167,961 | 111.97 | 0 | 8,292 |  | 
...
| leaf | 0 | 110 | 995 | 110 | 34 | 17 | 2 | 7 | 7 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 324 | 116 | 0 | 0 | 107 | 35 | 34 | 51 | 20 | 0 | 100 | 87 | 13 | 3 | 9 | 116 | 107 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 170 | 47 | 0 | 0 | 67 | 24 | 24 | 28 | 13 | 0 | 56 | 47 | 8 | 1 | 6 | 47 | 67 | 0 | 3 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 136 | 31 | 0 | 0 | 61 | 23 | 22 | 25 | 13 | 0 | 42 | 35 | 7 | 1 | 5 | 31 | 61 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 237,896,248 | 884 | 370 | 0 | 0 | 226 | 108 | 107 | 67 | 50 | 0 | 287 | 250 | 37 | 20 | 17 | 370 | 226 | 0 | 10 | 49 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,288,077,561 | 4,635 | 1,325 | 0 | 0 | 2,418 | 1,344 | 1,343 | 481 | 592 | 0 | 890 | 678 | 211 | 132 | 79 | 1,326 | 2,418 | 0 | 4 | 590 | 0 | 0 | 
| app_proof | prover | 1 | 751,206,644 | 2,606 | 586 | 0 | 0 | 1,503 | 724 | 724 | 268 | 509 | 0 | 516 | 399 | 117 | 70 | 46 | 586 | 1,503 | 0 | 5 | 508 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 1 | 176 | 5,175 | 176 | 136 | 13,329,494,472 | 2,141,911,524 | 15,471,405,996 | 2,097,152 | 0 | 3 | 227 | 7,124,000 | 34.13 | 
| app_proof | 1 | 1 | 75 | 3,012 | 75 | 41 | 7,598,498,184 | 1,557,865,504 | 9,156,363,688 | 2,097,152 | 0 | 2 | 289 | 4,043,961 | 37.90 | 

...
|:---|---:|---:|
| Total | <span style='color: green'>(-0 [-6.0%])</span> 1.71 | <span style='color: green'>(-0 [-7.2%])</span> 1 |
| pairing | <span style='color: green'>(-0 [-6.2%])</span> 1.62 | <span style='color: green'>(-0 [-7.8%])</span> 0.91 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: green'>(-54 [-6.2%])</span> 810.50 | <span style='color: green'>(-108 [-6.2%])</span> 1,621 | <span style='color: green'>(-77 [-7.8%])</span> 913 | <span style='color: green'>(-31 [-4.2%])</span> 708 |
...
| `execute_metered_insn_mi/s` | <span style='color: red'>(+0 [+0.9%])</span> 20.83 | -          | <span style='color: red'>(+0 [+0.9%])</span> 20.83 | <span style='color: red'>(+0 [+0.9%])</span> 20.83 |
| `execute_preflight_insns` |  941,469.50 |  1,882,939 |  1,143,000 |  739,939 |
| `execute_preflight_time_ms` | <span style='color: green'>(-2 [-2.0%])</span> 99 | <span style='color: green'>(-4 [-2.0%])</span> 198 | <span style='color: green'>(-3 [-2.3%])</span> 125 | <span style='color: green'>(-1 [-1.4%])</span> 73 |
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+1 [+3.6%])</span> 14.27 | -          | <span style='color: red'>(+1 [+4.6%])</span> 19.18 | <span style='color: red'>(+0 [+1.7%])</span> 9.36 |
| `trace_gen_time_ms   ` | <span style='color: green'>(-18 [-9.6%])</span> 174 | <span style='color: green'>(-37 [-9.6%])</span> 348 | <span style='color: green'>(-19 [-9.2%])</span> 188 | <span style='color: green'>(-18 [-10.1%])</span> 160 |
...
| `stark_prove_excluding_trace_time_ms` | <span style='color: green'>(-33 [-6.9%])</span> 443 | <span style='color: green'>(-66 [-6.9%])</span> 886 | <span style='color: green'>(-55 [-10.3%])</span> 481 | <span style='color: green'>(-11 [-2.6%])</span> 405 |
| `main_trace_commit_time_ms` | <span style='color: green'>(-10 [-13.5%])</span> 61 | <span style='color: green'>(-19 [-13.5%])</span> 122 | <span style='color: green'>(-9 [-11.7%])</span> 68 | <span style='color: green'>(-10 [-15.6%])</span> 54 |
| `generate_perm_trace_time_ms` | <span style='color: green'>(-12 [-22.4%])</span> 41.50 | <span style='color: green'>(-24 [-22.4%])</span> 83 | <span style='color: green'>(-27 [-37.0%])</span> 46 | <span style='color: red'>(+3 [+8.8%])</span> 37 |
| `perm_trace_commit_time_ms` | <span style='color: green'>(-9 [-10.7%])</span> 73.91 | <span style='color: green'>(-18 [-10.7%])</span> 147.82 | <span style='color: green'>(-8 [-9.2%])</span> 82.89 | <span style='color: green'>(-9 [-12.4%])</span> 64.92 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+5 [+6.1%])</span> 78.76 | <span style='color: red'>(+9 [+6.1%])</span> 157.52 | <span style='color: red'>(+4 [+4.9%])</span> 84.90 | <span style='color: red'>(+5 [+7.5%])</span> 72.62 |
| `quotient_poly_commit_time_ms` | <span style='color: green'>(-4 [-20.9%])</span> 14.81 | <span style='color: green'>(-8 [-20.9%])</span> 29.63 | <span style='color: green'>(-4 [-21.8%])</span> 15.89 | <span style='color: green'>(-3 [-19.8%])</span> 13.74 |
| `pcs_opening_time_ms ` | <span style='color: green'>(-4 [-2.3%])</span> 167.50 | <span style='color: green'>(-8 [-2.3%])</span> 335 | <span style='color: green'>(-11 [-5.8%])</span> 178 | <span style='color: red'>(+3 [+1.9%])</span> 157 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 708 | 40 | 1 | 90 | 1,882,939 | 20.83 | 147 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 160 | 913 | 31,041,944 | 160,949,612 | 160 | 481 | 0 | 84.90 | 15.89 | 6 | 82.89 | 178 | 132 | 178 | 0 | 68 | 15,014,446 | 46 | 125 | 1,143,000 | 9.36 | 25 | 101 | 3 | 178 | 
| pairing | 1 | 188 | 708 | 24,485,078 | 124,079,782 | 188 | 405 | 1 | 72.62 | 13.74 | 6 | 64.92 | 157 | 105 | 157 | 0 | 54 | 10,833,316 | 37 | 73 | 739,939 | 19.18 | 21 | 86 | 2 | 157 | 

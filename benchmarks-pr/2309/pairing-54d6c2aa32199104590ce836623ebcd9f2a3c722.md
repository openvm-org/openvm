...
| `total_proof_time_ms ` |  744 |  1,488 |  872 |  616 |
...
| `execute_metered_insn_mi/s` |  27.68 | -          |  27.68 |  27.68 |
| `execute_preflight_insns` |  872,871 |  1,745,742 |  1,149,000 |  596,742 |
| `execute_preflight_time_ms` |  83.50 |  167 |  106 |  61 |
| `execute_preflight_insn_mi/s` |  14.66 | -          |  18.11 |  11.21 |
| `trace_gen_time_ms   ` |  190 |  380 |  194 |  186 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  364.50 |  729 |  410 |  319 |
| `main_trace_commit_time_ms` |  65 |  130 |  75 |  55 |
| `generate_perm_trace_time_ms` |  46.50 |  93 |  54 |  39 |
| `perm_trace_commit_time_ms` |  77.64 |  155.27 |  89.88 |  65.40 |
| `quotient_poly_compute_time_ms` |  83.22 |  166.44 |  92.35 |  74.09 |
| `quotient_poly_commit_time_ms` |  17.59 |  35.19 |  20.12 |  15.07 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 616 | 1 | 63 | 1,745,742 | 27.68 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 186 | 872 | 32,480,114 | 172,558,444 | 186 | 410 | 0 | 92.35 | 20.12 | 7 | 89.88 | 74 | 146 | 74 | 1 | 75 | 15,909,408 | 54 | 106 | 1,149,000 | 11.21 | 27 | 113 | 1 | 74 | 
| pairing | 1 | 194 | 616 | 22,464,232 | 119,958,502 | 194 | 319 | 1 | 74.09 | 15.07 | 6 | 65.40 | 65 | 108 | 65 | 0 | 55 | 9,498,894 | 39 | 61 | 596,742 | 18.11 | 21 | 89 | 1 | 65 | 

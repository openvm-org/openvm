...
| `total_proof_time_ms ` |  737 |  1,474 |  867 |  607 |
...
| `execute_metered_insn_mi/s` |  27.62 | -          |  27.62 |  27.62 |
| `execute_preflight_insns` |  872,871 |  1,745,742 |  1,149,000 |  596,742 |
| `execute_preflight_time_ms` |  83.50 |  167 |  104 |  63 |
| `execute_preflight_insn_mi/s` |  14.89 | -          |  18.43 |  11.35 |
| `trace_gen_time_ms   ` |  193 |  386 |  194 |  192 |
| `memory_finalize_time_ms` |  1 |  2 |  1 |  1 |
| `stark_prove_excluding_trace_time_ms` |  355 |  710 |  401 |  309 |
| `main_trace_commit_time_ms` |  63.50 |  127 |  73 |  54 |
| `generate_perm_trace_time_ms` |  41 |  82 |  43 |  39 |
| `perm_trace_commit_time_ms` |  77.16 |  154.32 |  88.63 |  65.69 |
| `quotient_poly_compute_time_ms` |  84.38 |  168.77 |  94.19 |  74.58 |
| `quotient_poly_commit_time_ms` |  17.42 |  34.84 |  19.42 |  15.41 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 608 | 1 | 63 | 1,745,742 | 27.62 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 192 | 867 | 32,480,114 | 172,558,444 | 192 | 401 | 0 | 94.19 | 19.42 | 7 | 88.63 | 78 | 135 | 77 | 1 | 73 | 15,909,408 | 43 | 104 | 1,149,000 | 11.35 | 27 | 114 | 1 | 77 | 
| pairing | 1 | 194 | 607 | 22,464,232 | 119,958,502 | 194 | 309 | 1 | 74.58 | 15.41 | 6 | 65.69 | 55 | 108 | 54 | 1 | 54 | 9,498,894 | 39 | 63 | 596,742 | 18.43 | 21 | 90 | 1 | 54 | 
...
Commit: https://github.com/openvm-org/openvm/commit/a1b1ce887125618f1fd9b65e517a2ec6de1d8ba9
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/20043095433)

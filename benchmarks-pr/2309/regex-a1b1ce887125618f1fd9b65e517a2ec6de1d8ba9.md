...
| `total_proof_time_ms ` |  598.75 |  2,395 |  742 |  548 |
...
| `execute_preflight_time_ms` |  52.25 |  209 |  63 |  43 |
| `execute_preflight_insn_mi/s` |  32.23 | -          |  33.81 |  27.96 |
| `trace_gen_time_ms   ` |  180.75 |  723 |  212 |  158 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  291.75 |  1,167 |  314 |  279 |
| `main_trace_commit_time_ms` |  52.50 |  210 |  58 |  50 |
| `generate_perm_trace_time_ms` |  24.50 |  98 |  29 |  20 |
| `perm_trace_commit_time_ms` |  65.35 |  261.38 |  72.69 |  55.91 |
| `quotient_poly_compute_time_ms` |  59.83 |  239.32 |  70.72 |  54.14 |
| `quotient_poly_commit_time_ms` |  15.96 |  63.86 |  17.76 |  13.70 |
| `pcs_opening_time_ms ` |  70.50 |  282 |  74 |  63 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 550 | 1 | 37 | 4,137,502 | 110.51 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 212 | 742 | 23,446,148 | 150,778,428 | 212 | 314 | 0 | 59.63 | 17.76 | 5 | 72.69 | 74 | 103 | 73 | 4 | 58 | 10,899,170 | 29 | 47 | 1,103,000 | 27.96 | 22 | 78 | 1 | 73 | 
| regex_program | 1 | 158 | 548 | 11,598,276 | 128,513,066 | 158 | 284 | 1 | 54.83 | 15.93 | 4 | 66.87 | 72 | 89 | 72 | 0 | 51 | 2,196,106 | 21 | 63 | 1,104,000 | 33.45 | 17 | 71 | 0 | 72 | 
| regex_program | 2 | 167 | 555 | 11,579,064 | 128,513,066 | 167 | 290 | 1 | 54.14 | 16.48 | 4 | 65.90 | 73 | 94 | 73 | 0 | 50 | 2,177,334 | 28 | 56 | 1,104,000 | 33.81 | 17 | 71 | 0 | 73 | 
| regex_program | 3 | 186 | 550 | 11,853,872 | 103,456,394 | 186 | 279 | 0 | 70.72 | 13.70 | 5 | 55.91 | 63 | 79 | 62 | 0 | 51 | 2,422,606 | 20 | 43 | 826,502 | 33.69 | 19 | 85 | 1 | 62 | 

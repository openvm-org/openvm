...
|:---|---:|---:|
| Total |  1.07 |  0.62 |
| fibonacci_program |  1.06 |  0.61 |


| fibonacci_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  530 |  1,060 |  612 |  448 |
...
| `execute_metered_insn_mi/s` |  132.95 | -          |  132.95 |  132.95 |
| `execute_preflight_insns` |  750,104.50 |  1,500,209 |  873,000 |  627,209 |
| `execute_preflight_time_ms` |  29.50 |  59 |  33 |  26 |
| `execute_preflight_insn_mi/s` |  37.39 | -          |  39.84 |  34.93 |
| `trace_gen_time_ms   ` |  187 |  374 |  192 |  182 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  207.50 |  415 |  224 |  191 |
| `main_trace_commit_time_ms` |  30.50 |  61 |  33 |  28 |
| `generate_perm_trace_time_ms` |  32 |  64 |  33 |  31 |
| `perm_trace_commit_time_ms` |  40.72 |  81.44 |  43.09 |  38.35 |
| `quotient_poly_compute_time_ms` |  30.21 |  60.43 |  32.83 |  27.59 |
| `quotient_poly_commit_time_ms` |  12.17 |  24.34 |  12.82 |  11.52 |
| `pcs_opening_time_ms ` |  60.50 |  121 |  70 |  51 |
...
| --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 448 | 1 | 11 | 1,500,209 | 132.95 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 192 | 612 | 9,677,708 | 84,395,212 | 192 | 224 | 0 | 32.83 | 12.82 | 4 | 43.09 | 70 | 74 | 70 | 0 | 33 | 1,035,986 | 31 | 26 | 873,000 | 34.93 | 14 | 46 | 0 | 70 | 
| fibonacci_program | 1 | 182 | 448 | 9,708,170 | 74,305,770 | 182 | 191 | 1 | 27.59 | 11.52 | 4 | 38.35 | 51 | 72 | 50 | 0 | 28 | 1,064,416 | 33 | 33 | 627,209 | 39.84 | 11 | 39 | 0 | 50 | 

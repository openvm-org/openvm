...
|:---|---:|---:|
| Total |  1.08 |  0.60 |
| fibonacci_program |  1.07 |  0.59 |


| fibonacci_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  533.50 |  1,067 |  592 |  475 |
...
| `execute_metered_insn_mi/s` |  157.68 | -          |  157.68 |  157.68 |
| `execute_preflight_insns` |  750,104.50 |  1,500,209 |  873,000 |  627,209 |
| `execute_preflight_time_ms` |  28.50 |  57 |  32 |  25 |
| `execute_preflight_insn_mi/s` |  37.69 | -          |  39.81 |  35.57 |
| `trace_gen_time_ms   ` |  190.50 |  381 |  196 |  185 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  207 |  414 |  216 |  198 |
| `main_trace_commit_time_ms` |  30.50 |  61 |  33 |  28 |
| `generate_perm_trace_time_ms` |  29.50 |  59 |  31 |  28 |
| `perm_trace_commit_time_ms` |  40.93 |  81.86 |  44.23 |  37.62 |
| `quotient_poly_compute_time_ms` |  31.76 |  63.52 |  33.79 |  29.73 |
| `quotient_poly_commit_time_ms` |  12.77 |  25.54 |  13.10 |  12.43 |
| `pcs_opening_time_ms ` |  59.50 |  119 |  75 |  44 |
...
| --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 475 | 1 | 9 | 1,500,209 | 157.68 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 196 | 592 | 9,677,708 | 84,395,212 | 196 | 198 | 0 | 33.79 | 13.10 | 6 | 44.23 | 44 | 73 | 43 | 0 | 33 | 1,035,986 | 28 | 25 | 873,000 | 35.57 | 14 | 47 | 0 | 43 | 
| fibonacci_program | 1 | 185 | 475 | 9,708,170 | 74,305,770 | 185 | 216 | 1 | 29.73 | 12.43 | 5 | 37.62 | 75 | 69 | 75 | 0 | 28 | 1,064,416 | 31 | 32 | 627,209 | 39.81 | 11 | 42 | 0 | 75 | 

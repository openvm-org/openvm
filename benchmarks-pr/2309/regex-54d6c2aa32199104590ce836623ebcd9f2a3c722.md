...
|:---|---:|---:|
| Total |  2.44 |  0.78 |
| regex_program |  2.41 |  0.74 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  602 |  2,408 |  743 |  552 |
...
| `execute_preflight_insn_mi/s` |  31.57 | -          |  32.94 |  28.94 |
| `trace_gen_time_ms   ` |  184 |  736 |  218 |  161 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  291 |  1,164 |  310 |  276 |
| `main_trace_commit_time_ms` |  52.50 |  210 |  57 |  51 |
| `generate_perm_trace_time_ms` |  24 |  96 |  29 |  21 |
| `perm_trace_commit_time_ms` |  66.61 |  266.44 |  74.80 |  56.88 |
| `quotient_poly_compute_time_ms` |  61.27 |  245.07 |  70.85 |  55.75 |
| `quotient_poly_commit_time_ms` |  15.94 |  63.78 |  19.17 |  13.68 |
| `pcs_opening_time_ms ` |  67.50 |  270 |  73 |  57 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 552 | 1 | 37 | 4,137,502 | 111.66 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 218 | 743 | 23,446,148 | 150,778,428 | 218 | 310 | 0 | 62.65 | 19.17 | 5 | 74.80 | 68 | 101 | 68 | 4 | 57 | 10,899,170 | 25 | 45 | 1,103,000 | 28.94 | 22 | 82 | 1 | 68 | 
| regex_program | 1 | 161 | 552 | 11,598,276 | 128,513,066 | 161 | 285 | 1 | 55.81 | 15.49 | 4 | 67.38 | 72 | 88 | 72 | 0 | 51 | 2,196,106 | 21 | 63 | 1,104,000 | 32.94 | 17 | 71 | 0 | 72 | 
| regex_program | 2 | 167 | 561 | 11,579,064 | 128,513,066 | 167 | 293 | 1 | 55.75 | 15.44 | 4 | 67.37 | 73 | 97 | 73 | 0 | 51 | 2,177,334 | 29 | 58 | 1,104,000 | 31.59 | 17 | 71 | 0 | 73 | 
| regex_program | 3 | 190 | 552 | 11,853,872 | 103,456,394 | 190 | 276 | 0 | 70.85 | 13.68 | 5 | 56.88 | 57 | 81 | 57 | 0 | 51 | 2,422,606 | 21 | 44 | 826,502 | 32.80 | 19 | 85 | 1 | 57 | 
...
Commit: https://github.com/openvm-org/openvm/commit/54d6c2aa32199104590ce836623ebcd9f2a3c722
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/20042027156)

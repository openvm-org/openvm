...
| `total_proof_time_ms ` |  743 |  1,486 |  814 |  672 |
...
| `execute_metered_insn_mi/s` |  17.45 | -          |  17.45 |  17.45 |
| `execute_preflight_insns` |  872,871 |  1,745,742 |  1,157,000 |  588,742 |
| `execute_preflight_time_ms` |  98 |  196 |  137 |  59 |
| `execute_preflight_insn_mi/s` |  13.33 | -          |  18.04 |  8.62 |
| `trace_gen_time_ms   ` |  172 |  344 |  193 |  151 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  379 |  758 |  380 |  378 |
| `main_trace_commit_time_ms` |  64.50 |  129 |  75 |  54 |
| `generate_perm_trace_time_ms` |  55 |  110 |  71 |  39 |
| `perm_trace_commit_time_ms` |  76.29 |  152.59 |  88.31 |  64.28 |
| `quotient_poly_compute_time_ms` |  78.32 |  156.65 |  86.72 |  69.93 |
| `quotient_poly_commit_time_ms` |  16.65 |  33.29 |  18.90 |  14.39 |
| `pcs_opening_time_ms ` |  83.50 |  167 |  99 |  68 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 672 | 1 | 100 | 1,745,742 | 17.45 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 151 | 814 | 32,689,110 | 172,558,444 | 151 | 380 | 0 | 86.72 | 18.90 | 6 | 88.31 | 68 | 130 | 68 | 0 | 75 | 16,059,916 | 39 | 137 | 1,157,000 | 8.62 | 26 | 106 | 1 | 68 | 
| pairing | 1 | 193 | 672 | 22,314,288 | 119,958,502 | 193 | 378 | 1 | 69.93 | 14.39 | 5 | 64.28 | 99 | 139 | 99 | 0 | 54 | 9,408,294 | 71 | 59 | 588,742 | 18.04 | 20 | 84 | 1 | 99 | 
...
Commit: https://github.com/openvm-org/openvm/commit/83f8bcf5a4d13adacb4b53398637bce6b826a033
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19354758754)

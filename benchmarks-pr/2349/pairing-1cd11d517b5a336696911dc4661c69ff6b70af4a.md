...
|:---|---:|---:|---:|
| Total | <span style='color: green'>(-0 [-4.1%])</span> 1.54 | <span style='color: red'>(+0 [+0.5%])</span> 0.94 | 0.94 |
| pairing | <span style='color: green'>(-0 [-4.1%])</span> 1.54 | <span style='color: red'>(+0 [+0.5%])</span> 0.94 |  0.94 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: green'>(-33 [-4.3%])</span> 739 | <span style='color: green'>(-66 [-4.3%])</span> 1,478 | <span style='color: red'>(+5 [+0.6%])</span> 881 | <span style='color: green'>(-71 [-10.6%])</span> 597 |
...
| `execute_metered_insn_mi/s` | <span style='color: green'>(-0 [-0.3%])</span> 27.33 | -          | <span style='color: green'>(-0 [-0.3%])</span> 27.33 | <span style='color: green'>(-0 [-0.3%])</span> 27.33 |
| `execute_preflight_insns` |  872,871 |  1,745,742 |  1,149,000 |  596,742 |
| `execute_preflight_time_ms` | <span style='color: green'>(-1 [-1.2%])</span> 82 | <span style='color: green'>(-2 [-1.2%])</span> 164 | <span style='color: green'>(-2 [-1.7%])</span> 117 |  47 |
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+0 [+1.3%])</span> 14.98 | -          | <span style='color: red'>(+0 [+1.0%])</span> 18.34 | <span style='color: red'>(+0 [+1.9%])</span> 11.62 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+3 [+1.6%])</span> 187 | <span style='color: red'>(+6 [+1.6%])</span> 374 | <span style='color: red'>(+1 [+0.5%])</span> 205 | <span style='color: red'>(+5 [+3.0%])</span> 169 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: green'>(-35 [-8.8%])</span> 363.50 | <span style='color: green'>(-70 [-8.8%])</span> 727 | <span style='color: red'>(+1 [+0.2%])</span> 423 | <span style='color: green'>(-71 [-18.9%])</span> 304 |
| `main_trace_commit_time_ms` |  65 |  130 |  75 |  55 |
| `generate_perm_trace_time_ms` | <span style='color: green'>(-41 [-50.9%])</span> 39.50 | <span style='color: green'>(-82 [-50.9%])</span> 79 | <span style='color: green'>(-39 [-43.8%])</span> 50 | <span style='color: green'>(-43 [-59.7%])</span> 29 |
| `perm_trace_commit_time_ms` | <span style='color: red'>(+1 [+0.8%])</span> 77.79 | <span style='color: red'>(+1 [+0.8%])</span> 155.57 | <span style='color: red'>(+1 [+0.8%])</span> 90.20 | <span style='color: red'>(+1 [+0.9%])</span> 65.37 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+1 [+1.1%])</span> 84.22 | <span style='color: red'>(+2 [+1.1%])</span> 168.44 | <span style='color: red'>(+2 [+1.6%])</span> 94.05 | <span style='color: red'>(+0 [+0.5%])</span> 74.39 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+0 [+1.2%])</span> 17.95 | <span style='color: red'>(+0 [+1.2%])</span> 35.89 | <span style='color: red'>(+0 [+2.0%])</span> 20.27 |  15.62 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+4 [+5.0%])</span> 73.50 | <span style='color: red'>(+7 [+5.0%])</span> 147 | <span style='color: red'>(+15 [+20.8%])</span> 87 | <span style='color: green'>(-8 [-11.8%])</span> 60 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 597 | 1 | 63 | 1,745,742 | 27.33 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 169 | 881 | 32,480,114 | 172,558,444 | 169 | 423 | 0 | 94.05 | 20.27 | 6 | 90.20 | 87 | 144 | 87 | 1 | 75 | 15,909,408 | 50 | 117 | 1,149,000 | 11.62 | 27 | 115 | 1 | 87 | 
| pairing | 1 | 205 | 597 | 22,464,232 | 119,958,502 | 205 | 304 | 1 | 74.39 | 15.62 | 6 | 65.37 | 60 | 97 | 60 | 0 | 55 | 9,498,894 | 29 | 47 | 596,742 | 18.34 | 21 | 90 | 1 | 60 | 

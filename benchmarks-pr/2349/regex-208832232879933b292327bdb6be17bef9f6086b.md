...
|:---|---:|---:|---:|
| Total | <span style='color: red'>(+0 [+0.2%])</span> 2.42 | <span style='color: green'>(-0 [-0.1%])</span> 0.75 | 0.74 |
| regex_program | <span style='color: red'>(+0 [+0.2%])</span> 2.42 | <span style='color: green'>(-0 [-0.3%])</span> 0.75 |  0.75 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+1 [+0.2%])</span> 596.25 | <span style='color: red'>(+4 [+0.2%])</span> 2,385 | <span style='color: green'>(-2 [-0.3%])</span> 709 | <span style='color: green'>(-6 [-1.1%])</span> 532 |
...
| `execute_metered_insn_mi/s` | <span style='color: green'>(-2 [-1.4%])</span> 113.71 | -          | <span style='color: green'>(-2 [-1.4%])</span> 113.71 | <span style='color: green'>(-2 [-1.4%])</span> 113.71 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` | <span style='color: green'>(-0 [-1.1%])</span> 44.75 | <span style='color: green'>(-2 [-1.1%])</span> 179 | <span style='color: green'>(-1 [-1.8%])</span> 55 |  34 |
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+0 [+1.1%])</span> 32.03 | -          | <span style='color: red'>(+0 [+1.3%])</span> 32.49 | <span style='color: red'>(+0 [+0.8%])</span> 30.92 |
| `trace_gen_time_ms   ` | <span style='color: green'>(-0 [-0.1%])</span> 178.75 | <span style='color: green'>(-1 [-0.1%])</span> 715 | <span style='color: green'>(-1 [-0.5%])</span> 193 | <span style='color: red'>(+1 [+0.6%])</span> 171 |
...
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+2 [+0.7%])</span> 299 | <span style='color: red'>(+8 [+0.7%])</span> 1,196 | <span style='color: green'>(-2 [-0.6%])</span> 312 | <span style='color: green'>(-5 [-1.8%])</span> 270 |
...
| `generate_perm_trace_time_ms` | <span style='color: red'>(+4 [+13.4%])</span> 38 | <span style='color: red'>(+18 [+13.4%])</span> 152 | <span style='color: green'>(-1 [-2.0%])</span> 50 | <span style='color: green'>(-1 [-4.2%])</span> 23 |
| `perm_trace_commit_time_ms` | <span style='color: green'>(-1 [-1.0%])</span> 63.87 | <span style='color: green'>(-2 [-1.0%])</span> 255.49 | <span style='color: green'>(-1 [-0.7%])</span> 71.20 | <span style='color: red'>(+0 [+0.6%])</span> 55.29 |
| `quotient_poly_compute_time_ms` | <span style='color: green'>(-1 [-2.3%])</span> 59.42 | <span style='color: green'>(-6 [-2.3%])</span> 237.69 | <span style='color: green'>(-3 [-3.7%])</span> 70.22 | <span style='color: green'>(-1 [-1.8%])</span> 53 |
| `quotient_poly_commit_time_ms` | <span style='color: green'>(-1 [-4.2%])</span> 15.41 | <span style='color: green'>(-3 [-4.2%])</span> 61.65 | <span style='color: green'>(-1 [-5.1%])</span> 17.80 | <span style='color: green'>(-0 [-2.5%])</span> 13.24 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+1 [+1.1%])</span> 67.25 | <span style='color: red'>(+3 [+1.1%])</span> 269 |  74 | <span style='color: green'>(-2 [-3.2%])</span> 60 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 572 | 1 | 36 | 4,137,502 | 113.71 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 171 | 709 | 23,446,148 | 150,778,428 | 171 | 312 | 0 | 61.36 | 17.80 | 5 | 71.20 | 73 | 101 | 72 | 3 | 57 | 10,899,170 | 29 | 55 | 1,103,000 | 30.92 | 21 | 79 | 1 | 72 | 
| regex_program | 1 | 176 | 532 | 11,598,276 | 128,513,066 | 176 | 270 | 1 | 53 | 15.25 | 4 | 64.59 | 62 | 88 | 62 | 0 | 49 | 2,196,106 | 23 | 45 | 1,104,000 | 32.34 | 17 | 68 | 0 | 62 | 
| regex_program | 2 | 175 | 572 | 11,579,064 | 128,513,066 | 175 | 310 | 1 | 53.10 | 15.37 | 4 | 64.40 | 74 | 115 | 74 | 0 | 51 | 2,177,334 | 50 | 45 | 1,104,000 | 32.39 | 17 | 69 | 0 | 74 | 
| regex_program | 3 | 193 | 572 | 11,853,872 | 103,456,394 | 193 | 304 | 0 | 70.22 | 13.24 | 5 | 55.29 | 60 | 109 | 60 | 0 | 50 | 2,422,606 | 50 | 34 | 826,502 | 32.49 | 18 | 84 | 1 | 60 | 
...
Commit: https://github.com/openvm-org/openvm/commit/208832232879933b292327bdb6be17bef9f6086b
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/20938037383)

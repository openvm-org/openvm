...
| `total_proof_time_ms ` |  521 |  1,042 |  574 |  468 |
| `compile_metered_time_ms` |  4 |  4 |  4 |  4 |
| `execute_metered_time_ms` |  20 | -          | -          | -          |
| `execute_metered_insns` |  4,000,051 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  193.42 | -          |  193.42 |  193.42 |
| `execute_preflight_insns` |  2,000,025.50 |  4,000,051 |  2,621,000 |  1,379,051 |
| `execute_preflight_time_ms` |  53 |  106 |  64 |  42 |
| `execute_preflight_insn_mi/s` |  48.55 | -          |  51.95 |  45.16 |
| `trace_gen_time_ms   ` |  28.50 |  57 |  35 |  22 |
| `set_initial_memory_time_ms` |  89 |  178 |  137 |  41 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  349.50 |  699 |  350 |  349 |
| `prover.main_trace_commit_time_ms` |  74.50 |  149 |  76 |  73 |
| `prover.rap_constraints_time_ms` |  191 |  382 |  193 |  189 |
| `prover.openings_time_ms` |  82.50 |  165 |  83 |  82 |
| `prover.rap_constraints.logup_gkr_time_ms` |  131 |  262 |  132 |  130 |
| `prover.rap_constraints.round0_time_ms` |  39 |  78 |  41 |  37 |
...
| `prover.openings.whir_time_ms` |  67 |  134 |  68 |  66 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/f0e5fdd6ec20258a24d7e9c7e53f8cbf5ac0b026/fibonacci-f0e5fdd6ec20258a24d7e9c7e53f8cbf5ac0b026.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 69 |  |  |  | 341 |  |  |  |  |  |  | 
| app_proof |  |  |  | 468 |  | 20 | 4,000,051 | 193.42 | 0 | 1,068 |  | 
| internal_for_leaf |  |  | 277 |  |  |  |  |  |  |  | 278 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 27,277,885 | 261 | 84 | 0 | 0 | 99 | 32 | 32 | 45 | 21 | 0 | 77 | 65 | 11 | 2 | 8 | 84 | 84 | 99 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 172 | 47 | 0 | 0 | 68 | 25 | 24 | 28 | 14 | 0 | 56 | 47 | 8 | 1 | 6 | 47 | 47 | 68 | 0 | 3 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 141 | 32 | 0 | 0 | 64 | 24 | 24 | 25 | 14 | 0 | 44 | 37 | 7 | 1 | 5 | 32 | 32 | 64 | 0 | 3 | 13 | 0 | 0 | 
| leaf | 0 | prover | 74,737,560 | 356 | 126 | 0 | 0 | 117 | 53 | 52 | 35 | 29 | 0 | 112 | 97 | 14 | 6 | 8 | 126 | 126 | 117 | 0 | 7 | 28 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 90,436,180 | 350 | 73 | 0 | 0 | 193 | 41 | 41 | 21 | 130 | 0 | 82 | 66 | 16 | 8 | 7 | 73 | 73 | 193 | 0 | 3 | 129 | 0 | 0 | 
| app_proof | prover | 1 | 90,435,040 | 349 | 75 | 0 | 0 | 189 | 37 | 36 | 20 | 132 | 0 | 83 | 68 | 14 | 8 | 6 | 76 | 75 | 189 | 0 | 3 | 131 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 137 | 2 | 22 | 574 | 22 | 137 | 2,146,766,901 | 1,588,503 | 2,148,355,404 | 2,097,152 | 0 | 4 | 64 | 2,621,000 | 45.16 | 
| app_proof | 1 | 41 | 1 | 35 | 468 | 35 | 41 | 1,165,989,930 | 980,940,213 | 2,146,930,143 | 2,097,152 | 0 | 2 | 42 | 1,379,051 | 51.95 | 

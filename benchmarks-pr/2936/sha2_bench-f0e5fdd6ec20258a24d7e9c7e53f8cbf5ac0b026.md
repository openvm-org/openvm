...
| `total_proof_time_ms ` |  4,111.50 |  8,223 |  5,188 |  3,035 |
...
| `execute_preflight_time_ms` |  241 |  482 |  273 |  209 |
| `execute_preflight_insn_mi/s` |  39.39 | -          |  41.37 |  37.42 |
| `trace_gen_time_ms   ` |  122.50 |  245 |  173 |  72 |
| `set_initial_memory_time_ms` |  88 |  176 |  135 |  41 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  3,658.50 |  7,317 |  4,670 |  2,647 |
| `prover.main_trace_commit_time_ms` |  961.50 |  1,923 |  1,329 |  594 |
| `prover.rap_constraints_time_ms` |  1,984 |  3,968 |  2,446 |  1,522 |
| `prover.openings_time_ms` |  712 |  1,424 |  894 |  530 |
| `prover.rap_constraints.logup_gkr_time_ms` |  557 |  1,114 |  595 |  519 |
| `prover.rap_constraints.round0_time_ms` |  1,043 |  2,086 |  1,357 |  729 |
| `prover.rap_constraints.mle_rounds_time_ms` |  382.50 |  765 |  493 |  272 |
| `prover.openings.stacked_reduction_time_ms` |  167.50 |  335 |  216 |  119 |
| `prover.openings.stacked_reduction.round0_time_ms` |  103.50 |  207 |  135 |  72 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  63.50 |  127 |  81 |  46 |
| `prover.openings.whir_time_ms` |  544 |  1,088 |  677 |  411 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/f0e5fdd6ec20258a24d7e9c7e53f8cbf5ac0b026/sha2_bench-f0e5fdd6ec20258a24d7e9c7e53f8cbf5ac0b026.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 70 |  |  |  | 346 |  |  |  |  |  |  | 
| app_proof |  |  |  | 3,035 |  | 98 | 11,167,961 | 113.13 | 0 | 8,328 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 327 | 118 | 0 | 0 | 109 | 35 | 34 | 52 | 21 | 0 | 99 | 85 | 13 | 3 | 9 | 118 | 118 | 109 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 173 | 48 | 0 | 0 | 69 | 25 | 24 | 28 | 15 | 0 | 56 | 47 | 8 | 1 | 6 | 48 | 48 | 69 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 140 | 32 | 0 | 0 | 61 | 23 | 22 | 24 | 13 | 0 | 45 | 38 | 7 | 1 | 5 | 33 | 32 | 61 | 0 | 3 | 13 | 0 | 0 | 
| leaf | 0 | prover | 237,929,016 | 903 | 376 | 0 | 0 | 230 | 109 | 108 | 68 | 51 | 0 | 296 | 257 | 38 | 20 | 17 | 377 | 376 | 230 | 0 | 11 | 50 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,286,242,554 | 4,670 | 1,329 | 0 | 0 | 2,446 | 1,357 | 1,357 | 493 | 595 | 0 | 894 | 677 | 216 | 135 | 81 | 1,329 | 1,329 | 2,446 | 0 | 5 | 593 | 0 | 0 | 
| app_proof | prover | 1 | 750,289,144 | 2,647 | 594 | 0 | 0 | 1,522 | 729 | 729 | 272 | 519 | 0 | 530 | 411 | 119 | 72 | 46 | 594 | 594 | 1,522 | 0 | 6 | 518 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 135 | 2 | 173 | 5,188 | 173 | 135 | 13,311,936,132 | 2,137,449,780 | 15,449,385,912 | 2,097,152 | 0 | 6 | 209 | 7,124,000 | 37.42 | 
| app_proof | 1 | 41 | 1 | 72 | 3,035 | 72 | 41 | 7,588,526,580 | 1,502,398,413 | 9,090,924,993 | 2,097,152 | 0 | 2 | 273 | 4,043,961 | 41.37 | 

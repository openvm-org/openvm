...
|:---|---:|---:|---:|
| Total |  10.01 |  6.95 |  6.95 |
| app_proof |  8.32 |  5.27 |  5.27 |
| leaf |  1.01 |  1.01 |  1.01 |
...
| `total_proof_time_ms ` |  4,119 |  8,238 |  5,186 |  3,052 |
| `compile_metered_time_ms` |  4 |  4 |  4 |  4 |
| `execute_metered_time_ms` |  86 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  128.51 | -          |  128.51 |  128.51 |
| `execute_preflight_insns` |  5,583,980.50 |  11,167,961 |  7,124,000 |  4,043,961 |
| `execute_preflight_time_ms` |  240.50 |  481 |  277 |  204 |
| `execute_preflight_insn_mi/s` |  37.82 | -          |  40.12 |  35.53 |
| `trace_gen_time_ms   ` |  121 |  242 |  170 |  72 |
| `set_initial_memory_time_ms` |  89 |  178 |  137 |  41 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  3,666.50 |  7,333 |  4,674 |  2,659 |
| `prover.main_trace_commit_time_ms` |  960.50 |  1,921 |  1,329 |  592 |
| `prover.rap_constraints_time_ms` |  1,992.50 |  3,985 |  2,451 |  1,534 |
| `prover.openings_time_ms` |  712.50 |  1,425 |  893 |  532 |
| `prover.rap_constraints.logup_gkr_time_ms` |  557.50 |  1,115 |  595 |  520 |
| `prover.rap_constraints.round0_time_ms` |  1,053.50 |  2,107 |  1,364 |  743 |
| `prover.rap_constraints.mle_rounds_time_ms` |  381.50 |  763 |  492 |  271 |
| `prover.openings.stacked_reduction_time_ms` |  166.50 |  333 |  214 |  119 |
...
| `prover.openings.whir_time_ms` |  545.50 |  1,091 |  678 |  413 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,006 |  1,006 |  1,006 |  1,006 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/62582280ac6822fd15d0fda3f96bcc9f31cd2cde/sha2_bench-62582280ac6822fd15d0fda3f96bcc9f31cd2cde.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 70 |  |  |  | 342 |  |  |  |  |  |  | 
| app_proof |  |  |  | 3,052 |  | 86 | 11,167,961 | 128.51 | 0 | 8,331 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 326 | 117 | 0 | 0 | 107 | 34 | 34 | 51 | 20 | 0 | 101 | 87 | 13 | 3 | 9 | 117 | 117 | 107 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 169 | 47 | 0 | 0 | 67 | 25 | 24 | 28 | 14 | 0 | 53 | 45 | 8 | 1 | 6 | 48 | 47 | 67 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 137 | 32 | 0 | 0 | 62 | 23 | 22 | 24 | 13 | 0 | 42 | 34 | 7 | 1 | 5 | 33 | 32 | 61 | 0 | 2 | 13 | 0 | 0 | 
| leaf | 0 | prover | 237,929,016 | 897 | 375 | 0 | 0 | 229 | 111 | 110 | 68 | 50 | 0 | 291 | 254 | 37 | 19 | 17 | 375 | 375 | 229 | 0 | 10 | 50 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,286,242,554 | 4,674 | 1,329 | 0 | 0 | 2,451 | 1,364 | 1,363 | 492 | 595 | 0 | 893 | 678 | 214 | 134 | 80 | 1,329 | 1,329 | 2,451 | 0 | 6 | 593 | 0 | 0 | 
| app_proof | prover | 1 | 750,289,144 | 2,659 | 592 | 0 | 0 | 1,534 | 743 | 742 | 271 | 520 | 0 | 532 | 413 | 119 | 72 | 46 | 592 | 592 | 1,534 | 0 | 7 | 519 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 137 | 1 | 170 | 5,186 | 170 | 137 | 13,306,647,852 | 2,134,713,996 | 15,441,361,848 | 2,097,152 | 0 | 3 | 204 | 7,124,000 | 35.53 | 
| app_proof | 1 | 41 | 1 | 72 | 3,052 | 72 | 41 | 7,584,540,132 | 1,503,573,469 | 9,088,113,601 | 2,097,152 | 0 | 2 | 277 | 4,043,961 | 40.12 | 

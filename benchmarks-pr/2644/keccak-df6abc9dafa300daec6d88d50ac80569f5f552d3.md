...
|:---|---:|---:|---:|
| Total |  19.06 |  5.35 |  5.35 |
| app_proof |  15.97 |  3.05 |  3.05 |
| leaf |  2.23 |  1.45 |  1.45 |
...
| `total_proof_time_ms ` |  2,656.50 |  15,939 |  3,012 |  2,568 |
| `execute_metered_time_ms` |  36 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  33.64 | -          |  33.64 |  33.64 |
| `execute_preflight_insns` |  205,869.67 |  1,235,218 |  207,000 |  200,218 |
| `execute_preflight_time_ms` |  187.83 |  1,127 |  276 |  16 |
| `execute_preflight_insn_mi/s` |  19.17 | -          |  19.40 |  18.68 |
| `trace_gen_time_ms   ` |  387.67 |  2,326 |  548 |  350 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  2,017.33 |  12,104 |  2,276 |  1,962 |
| `prover.main_trace_commit_time_ms` |  700.17 |  4,201 |  856 |  667 |
| `prover.rap_constraints_time_ms` |  1,128 |  6,768 |  1,231 |  1,105 |
| `prover.openings_time_ms` |  188.83 |  1,133 |  195 |  184 |
| `prover.rap_constraints.logup_gkr_time_ms` |  276.50 |  1,659 |  383 |  254 |
| `prover.rap_constraints.round0_time_ms` |  528 |  3,168 |  531 |  523 |
| `prover.rap_constraints.mle_rounds_time_ms` |  322.50 |  1,935 |  324 |  322 |
| `prover.openings.stacked_reduction_time_ms` |  143.17 |  859 |  145 |  142 |
| `prover.openings.stacked_reduction.round0_time_ms` |  87 |  522 |  88 |  86 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  55.67 |  334 |  57 |  54 |
| `prover.openings.whir_time_ms` |  45 |  270 |  52 |  40 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,116.50 |  2,233 |  1,447 |  786 |
| `execute_preflight_time_ms` |  4.50 |  9 |  5 |  4 |
| `trace_gen_time_ms   ` |  139 |  278 |  187 |  91 |
| `generate_blob_total_time_ms` |  25.50 |  51 |  34 |  17 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  977 |  1,954 |  1,260 |  694 |
| `prover.main_trace_commit_time_ms` |  554.50 |  1,109 |  727 |  382 |
| `prover.rap_constraints_time_ms` |  317 |  634 |  409 |  225 |
| `prover.openings_time_ms` |  104.50 |  209 |  123 |  86 |
| `prover.rap_constraints.logup_gkr_time_ms` |  67 |  134 |  83 |  51 |
| `prover.rap_constraints.round0_time_ms` |  154.50 |  309 |  203 |  106 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/df6abc9dafa300daec6d88d50ac80569f5f552d3/keccak-df6abc9dafa300daec6d88d50ac80569f5f552d3.memory.svg)
...
| app_proof |  |  |  |  |  | 2,570 |  |  | 36 | 1,235,218 | 33.64 | 0 | 15,984 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 39 | 525 | 39 | 13 | 4 | 2 | 2 | 2 | 
| internal_recursive.0 | 1 | 12 | 181 | 12 | 2 | 1 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 9 | 149 | 8 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 187 | 1,447 | 186 | 65 | 34 | 5 | 8 | 8 | 
| leaf | 1 | 91 | 786 | 90 | 32 | 17 | 4 | 8 | 8 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 109,497,984 | 486 | 251 | 0 | 14 | 174 | 46 | 45 | 93 | 34 | 0 | 59 | 20 | 38 | 7 | 30 | 252 | 174 | 0 | 3 | 32 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 25,962,119 | 169 | 52 | 0 | 3 | 75 | 24 | 23 | 29 | 22 | 0 | 40 | 16 | 23 | 1 | 21 | 52 | 75 | 0 | 2 | 21 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 17,507,975 | 140 | 34 | 0 | 3 | 64 | 22 | 22 | 24 | 16 | 0 | 40 | 18 | 22 | 1 | 20 | 34 | 64 | 0 | 2 | 16 | 0 | 0 | 
| leaf | 0 | prover | 583,523,386 | 1,260 | 726 | 0 | 47 | 409 | 203 | 202 | 122 | 83 | 0 | 123 | 37 | 86 | 41 | 45 | 727 | 409 | 0 | 6 | 82 | 0 | 0 | 
| leaf | 1 | prover | 300,618,208 | 694 | 381 | 0 | 24 | 225 | 106 | 105 | 68 | 51 | 0 | 86 | 34 | 52 | 20 | 32 | 382 | 225 | 0 | 6 | 50 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,205,061,845 | 2,276 | 856 | 0 | 241 | 1,231 | 523 | 523 | 324 | 383 | 127 | 188 | 42 | 145 | 88 | 57 | 856 | 1,231 | 0 | 3 | 255 | 0 | 0 | 
| app_proof | prover | 1 | 1,205,053,652 | 1,962 | 667 | 0 | 51 | 1,105 | 528 | 527 | 322 | 254 | 0 | 190 | 48 | 142 | 87 | 54 | 667 | 1,105 | 0 | 4 | 254 | 0 | 0 | 
| app_proof | prover | 2 | 1,205,053,652 | 1,962 | 669 | 0 | 51 | 1,108 | 529 | 529 | 322 | 255 | 0 | 184 | 40 | 143 | 87 | 56 | 670 | 1,108 | 0 | 4 | 254 | 0 | 0 | 
| app_proof | prover | 3 | 1,205,053,652 | 1,964 | 670 | 0 | 51 | 1,106 | 528 | 528 | 322 | 255 | 0 | 188 | 45 | 142 | 87 | 55 | 670 | 1,105 | 0 | 4 | 254 | 0 | 0 | 
| app_proof | prover | 4 | 1,205,053,652 | 1,974 | 670 | 0 | 51 | 1,108 | 529 | 528 | 322 | 256 | 0 | 195 | 52 | 143 | 87 | 55 | 670 | 1,108 | 0 | 3 | 254 | 0 | 0 | 
| app_proof | prover | 5 | 1,205,062,652 | 1,966 | 668 | 0 | 52 | 1,110 | 531 | 530 | 323 | 256 | 0 | 188 | 43 | 144 | 86 | 57 | 668 | 1,110 | 0 | 4 | 255 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 548 | 3,012 | 548 | 170 | 0 | 196 | 16 | 207,000 | 18.68 | 
| app_proof | 1 | 350 | 2,630 | 350 | 41 | 0 | 1 | 276 | 207,000 | 19.34 | 
| app_proof | 2 | 351 | 2,573 | 351 | 41 | 0 | 1 | 218 | 207,000 | 19.32 | 
| app_proof | 3 | 353 | 2,568 | 353 | 41 | 0 | 3 | 209 | 207,000 | 19.33 | 
| app_proof | 4 | 351 | 2,586 | 351 | 41 | 0 | 2 | 219 | 207,000 | 18.92 | 
| app_proof | 5 | 373 | 2,570 | 373 | 41 | 0 | 23 | 189 | 200,218 | 19.40 | 

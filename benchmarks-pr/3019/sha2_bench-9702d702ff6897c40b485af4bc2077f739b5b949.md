...
|:---|---:|---:|---:|
| Total |  4.99 |  3.35 |  3.35 |
| app_proof |  4.03 |  2.39 |  2.39 |
| leaf |  0.52 |  0.52 |  0.52 |
...
| `total_proof_time_ms ` |  1,986.50 |  3,973 |  2,335 |  1,638 |
| `compile_metered_time_ms` |  6 |  6 |  6 |  6 |
| `execute_metered_time_ms` |  57 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  194.22 | -          |  194.22 |  194.22 |
| `execute_preflight_insns` |  5,583,980.50 |  11,167,961 |  7,124,000 |  4,043,961 |
| `execute_preflight_time_ms` |  364 |  728 |  506 |  222 |
| `execute_preflight_insn_mi/s` |  35.16 | -          |  37.24 |  33.08 |
| `trace_gen_time_ms   ` |  76 |  152 |  104 |  48 |
| `set_initial_memory_time_ms` |  0 |  0 |  0 |  0 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,545.50 |  3,091 |  2,007 |  1,084 |
| `prover.main_trace_commit_time_ms` |  386.50 |  773 |  554 |  219 |
| `prover.rap_constraints_time_ms` |  894.50 |  1,789 |  1,123 |  666 |
| `prover.openings_time_ms` |  264 |  528 |  330 |  198 |
| `prover.rap_constraints.logup_gkr_time_ms` |  206 |  412 |  225 |  187 |
| `prover.rap_constraints.round0_time_ms` |  508 |  1,016 |  667 |  349 |
| `prover.rap_constraints.mle_rounds_time_ms` |  179 |  358 |  230 |  128 |
| `prover.openings.stacked_reduction_time_ms` |  71.50 |  143 |  90 |  53 |
...
| `prover.openings.whir_time_ms` |  192.50 |  385 |  240 |  145 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/9702d702ff6897c40b485af4bc2077f739b5b949/sha2_bench-9702d702ff6897c40b485af4bc2077f739b5b949.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 57 |  |  |  | 293 |  |  |  |  |  |  | 
| app_proof |  |  |  | 1,639 |  | 57 | 11,167,961 | 194.22 | 0 | 4,039 |  | 
...
| app_proof | VmAirWrapper<Rv64BaseAluU16AdapterAir, AddSubCoreAir<4, 16> | 0 |  | 20 | 
...
| app_proof | VmAirWrapper<Rv64BranchAdapterAir, BranchLessThanCoreAir<4, 16> | 0 | 2 | 2 | 
...
| leaf | 0 | 118 | 524 | 118 | 35 | 12 | 2 | 10 | 10 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 177 | 46 | 0 | 0 | 79 | 28 | 27 | 37 | 14 | 0 | 50 | 40 | 10 | 2 | 7 | 47 | 46 | 79 | 0 | 1 | 13 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 111 | 20 | 0 | 0 | 58 | 23 | 22 | 23 | 11 | 0 | 32 | 24 | 7 | 1 | 6 | 20 | 20 | 58 | 0 | 1 | 10 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 99 | 15 | 0 | 0 | 54 | 21 | 19 | 22 | 11 | 0 | 29 | 22 | 7 | 1 | 5 | 15 | 15 | 54 | 0 | 1 | 10 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,233,945,850 | 2,007 | 553 | 0 | 0 | 1,123 | 667 | 666 | 230 | 225 | 1 | 330 | 240 | 90 | 55 | 34 | 554 | 553 | 1,123 | 0 | 1 | 223 | 0 | 0 | 
| app_proof | prover | 1 | 698,978,064 | 1,084 | 219 | 0 | 0 | 666 | 349 | 349 | 128 | 187 | 0 | 198 | 145 | 53 | 31 | 21 | 219 | 219 | 666 | 0 | 1 | 186 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 0 | 2 | 104 | 2,335 | 104 | 0 | 12,684,755,076 | 2,129,046,324 | 14,813,801,400 | 2,097,152 | 0 | 4 | 222 | 7,124,000 | 33.08 | 
| app_proof | 1 | 0 | 1 | 48 | 1,638 | 48 | 0 | 7,231,569,048 | 1,162,618,920 | 8,394,187,968 | 2,097,152 | 0 | 2 | 506 | 4,043,961 | 37.24 | 

...
| `total_proof_time_ms ` |  1,977 |  3,954 |  2,324 |  1,630 |
| `compile_metered_time_ms` |  6 |  6 |  6 |  6 |
| `execute_metered_time_ms` |  57 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  195.17 | -          |  195.17 |  195.17 |
| `execute_preflight_insns` |  5,583,980.50 |  11,167,961 |  7,124,000 |  4,043,961 |
| `execute_preflight_time_ms` |  355.50 |  711 |  496 |  215 |
| `execute_preflight_insn_mi/s` |  34.21 | -          |  34.36 |  34.06 |
| `trace_gen_time_ms   ` |  72.50 |  145 |  99 |  46 |
| `set_initial_memory_time_ms` |  0 |  0 |  0 |  0 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,547.50 |  3,095 |  2,008 |  1,087 |
| `prover.main_trace_commit_time_ms` |  385 |  770 |  550 |  220 |
| `prover.rap_constraints_time_ms` |  895.50 |  1,791 |  1,124 |  667 |
| `prover.openings_time_ms` |  265 |  530 |  332 |  198 |
| `prover.rap_constraints.logup_gkr_time_ms` |  206 |  412 |  225 |  187 |
| `prover.rap_constraints.round0_time_ms` |  509.50 |  1,019 |  667 |  352 |
| `prover.rap_constraints.mle_rounds_time_ms` |  179.50 |  359 |  231 |  128 |
| `prover.openings.stacked_reduction_time_ms` |  72.50 |  145 |  92 |  53 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/3b562907edae931410762a6162096c27a31122f7/sha2_bench-3b562907edae931410762a6162096c27a31122f7.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 58 |  |  |  | 289 |  |  |  |  |  |  | 
| app_proof |  |  |  | 1,630 |  | 57 | 11,167,961 | 195.17 | 0 | 4,020 |  | 
...
| leaf | 0 | 112 | 519 | 111 | 34 | 12 | 2 | 9 | 9 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 175 | 46 | 0 | 0 | 79 | 28 | 27 | 37 | 13 | 0 | 48 | 38 | 10 | 2 | 7 | 47 | 46 | 79 | 0 | 1 | 12 | 0 | 0 | 
...
| leaf | 0 | prover | 237,929,144 | 406 | 146 | 0 | 0 | 141 | 70 | 69 | 44 | 26 | 0 | 117 | 95 | 22 | 10 | 11 | 146 | 146 | 141 | 0 | 3 | 25 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,233,945,850 | 2,008 | 550 | 0 | 0 | 1,124 | 667 | 666 | 231 | 225 | 1 | 332 | 240 | 92 | 56 | 35 | 550 | 550 | 1,124 | 0 | 1 | 224 | 0 | 0 | 
| app_proof | prover | 1 | 698,978,064 | 1,087 | 220 | 0 | 0 | 667 | 352 | 351 | 128 | 187 | 0 | 198 | 144 | 53 | 32 | 21 | 220 | 220 | 667 | 0 | 1 | 186 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 0 | 2 | 99 | 2,324 | 99 | 0 | 12,684,755,076 | 2,129,046,324 | 14,813,801,400 | 2,097,152 | 0 | 4 | 215 | 7,124,000 | 34.06 | 
| app_proof | 1 | 0 | 1 | 46 | 1,630 | 46 | 0 | 7,231,569,048 | 1,162,618,920 | 8,394,187,968 | 2,097,152 | 0 | 2 | 496 | 4,043,961 | 34.36 | 

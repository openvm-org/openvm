...
| `total_proof_time_ms ` |  1,968.50 |  3,937 |  2,312 |  1,625 |
...
| `execute_preflight_time_ms` |  346.50 |  693 |  490 |  203 |
| `execute_preflight_insn_mi/s` |  35.49 | -          |  36.10 |  34.88 |
| `trace_gen_time_ms   ` |  71 |  142 |  97 |  45 |
| `set_initial_memory_time_ms` |  0 |  0 |  0 |  0 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,549 |  3,098 |  2,010 |  1,088 |
| `prover.main_trace_commit_time_ms` |  385 |  770 |  549 |  221 |
| `prover.rap_constraints_time_ms` |  898.50 |  1,797 |  1,128 |  669 |
| `prover.openings_time_ms` |  264.50 |  529 |  332 |  197 |
| `prover.rap_constraints.logup_gkr_time_ms` |  206.50 |  413 |  226 |  187 |
| `prover.rap_constraints.round0_time_ms` |  509.50 |  1,019 |  667 |  352 |
| `prover.rap_constraints.mle_rounds_time_ms` |  181 |  362 |  233 |  129 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/80cd0964a554e04b8fe036c6129eb4a225a58b72/sha2_bench-80cd0964a554e04b8fe036c6129eb4a225a58b72.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 58 |  |  |  | 284 |  |  |  |  |  |  | 
| app_proof |  |  |  | 1,625 |  | 56 | 11,167,961 | 196.88 | 0 | 4,002 |  | 
...
| leaf | 0 | 111 | 519 | 111 | 33 | 12 | 2 | 9 | 9 | 
...
| internal_recursive.0 | 1 | prover | 15,378,769 | 109 | 20 | 0 | 0 | 57 | 23 | 22 | 23 | 10 | 0 | 30 | 22 | 7 | 1 | 6 | 20 | 20 | 57 | 0 | 1 | 10 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 97 | 15 | 0 | 0 | 53 | 20 | 19 | 21 | 10 | 0 | 28 | 20 | 7 | 1 | 5 | 15 | 15 | 53 | 0 | 1 | 10 | 0 | 0 | 
| leaf | 0 | prover | 237,929,144 | 407 | 146 | 0 | 0 | 143 | 71 | 69 | 44 | 28 | 0 | 116 | 94 | 22 | 10 | 11 | 147 | 146 | 143 | 0 | 3 | 25 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,233,945,850 | 2,010 | 549 | 0 | 0 | 1,128 | 667 | 667 | 233 | 226 | 0 | 332 | 240 | 91 | 56 | 35 | 549 | 549 | 1,128 | 0 | 1 | 225 | 0 | 0 | 
| app_proof | prover | 1 | 698,978,064 | 1,088 | 220 | 0 | 0 | 669 | 352 | 351 | 129 | 187 | 0 | 197 | 144 | 52 | 31 | 21 | 221 | 220 | 669 | 0 | 1 | 186 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 0 | 2 | 97 | 2,312 | 97 | 0 | 12,684,755,076 | 2,129,046,324 | 14,813,801,400 | 2,097,152 | 0 | 3 | 203 | 7,124,000 | 36.10 | 
| app_proof | 1 | 0 | 1 | 45 | 1,625 | 45 | 0 | 7,231,569,048 | 1,162,618,920 | 8,394,187,968 | 2,097,152 | 0 | 2 | 490 | 4,043,961 | 34.88 | 

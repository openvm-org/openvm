...
|:---|---:|---:|---:|
| Total |  5.08 |  3.52 |  3.52 |
| app_proof |  4.13 |  2.57 |  2.57 |
| leaf |  0.52 |  0.52 |  0.52 |
...
| `total_proof_time_ms ` |  2,036.50 |  4,073 |  2,518 |  1,555 |
...
| `execute_preflight_time_ms` |  327 |  654 |  455 |  199 |
| `execute_preflight_insn_mi/s` |  39.64 | -          |  41.24 |  38.04 |
| `trace_gen_time_ms   ` |  70 |  140 |  98 |  42 |
| `set_initial_memory_time_ms` |  0 |  0 |  0 |  0 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,637.50 |  3,275 |  2,219 |  1,056 |
| `prover.main_trace_commit_time_ms` |  401.50 |  803 |  590 |  213 |
| `prover.rap_constraints_time_ms` |  962.50 |  1,925 |  1,273 |  652 |
| `prover.openings_time_ms` |  273.50 |  547 |  356 |  191 |
| `prover.rap_constraints.logup_gkr_time_ms` |  263 |  526 |  344 |  182 |
| `prover.rap_constraints.round0_time_ms` |  519.50 |  1,039 |  694 |  345 |
| `prover.rap_constraints.mle_rounds_time_ms` |  179.50 |  359 |  235 |  124 |
...
| `prover.openings.whir_time_ms` |  198.50 |  397 |  258 |  139 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/b244edf19fd2ec9a24a3415c555665f98b687c98/sha2_bench-b244edf19fd2ec9a24a3415c555665f98b687c98.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 58 |  |  |  | 290 |  |  |  |  |  |  | 
| app_proof |  |  |  | 1,555 |  | 56 | 11,167,961 | 197.15 | 0 | 4,139 |  | 
...
| leaf | 0 | 114 | 520 | 114 | 34 | 13 | 2 | 9 | 9 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 176 | 46 | 0 | 0 | 80 | 29 | 28 | 36 | 14 | 0 | 49 | 39 | 10 | 2 | 7 | 47 | 46 | 80 | 0 | 1 | 12 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,336,182,185 | 2,219 | 589 | 0 | 0 | 1,273 | 694 | 693 | 235 | 344 | 1 | 356 | 258 | 97 | 60 | 37 | 590 | 589 | 1,273 | 0 | 1 | 341 | 0 | 0 | 
| app_proof | prover | 1 | 680,368,204 | 1,056 | 213 | 0 | 0 | 652 | 345 | 344 | 124 | 182 | 0 | 191 | 139 | 52 | 30 | 21 | 213 | 213 | 652 | 0 | 1 | 181 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 0 | 2 | 98 | 2,518 | 98 | 0 | 12,486,190,272 | 3,550,760,748 | 16,036,951,020 | 2,097,152 | 0 | 3 | 199 | 7,147,000 | 38.04 | 
| app_proof | 1 | 0 | 1 | 42 | 1,555 | 42 | 0 | 7,057,361,712 | 1,113,507,936 | 8,170,869,648 | 2,097,152 | 0 | 2 | 455 | 4,020,961 | 41.24 | 

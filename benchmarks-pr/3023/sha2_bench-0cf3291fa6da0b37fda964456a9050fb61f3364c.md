...
| `total_proof_time_ms ` |  2,053 |  4,106 |  2,527 |  1,579 |
| `compile_metered_time_ms` |  5 |  5 |  5 |  5 |
| `execute_metered_time_ms` |  56 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  196.16 | -          |  196.16 |  196.16 |
| `execute_preflight_insns` |  5,583,980.50 |  11,167,961 |  7,147,000 |  4,020,961 |
| `execute_preflight_time_ms` |  340.50 |  681 |  477 |  204 |
| `execute_preflight_insn_mi/s` |  36.49 | -          |  36.81 |  36.16 |
| `trace_gen_time_ms   ` |  71.50 |  143 |  100 |  43 |
| `set_initial_memory_time_ms` |  0 |  0 |  0 |  0 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,639.50 |  3,279 |  2,221 |  1,058 |
| `prover.main_trace_commit_time_ms` |  403 |  806 |  593 |  213 |
| `prover.rap_constraints_time_ms` |  961.50 |  1,923 |  1,272 |  651 |
| `prover.openings_time_ms` |  274 |  548 |  355 |  193 |
| `prover.rap_constraints.logup_gkr_time_ms` |  262 |  524 |  343 |  181 |
...
| `prover.openings.whir_time_ms` |  199.50 |  399 |  258 |  141 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/0cf3291fa6da0b37fda964456a9050fb61f3364c/sha2_bench-0cf3291fa6da0b37fda964456a9050fb61f3364c.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 56 |  |  |  | 286 |  |  |  |  |  |  | 
| app_proof |  |  |  | 1,579 |  | 56 | 11,167,961 | 196.16 | 0 | 4,172 |  | 
...
| leaf | 0 | prover | 237,929,272 | 403 | 145 | 0 | 0 | 140 | 70 | 69 | 44 | 25 | 0 | 117 | 95 | 21 | 10 | 11 | 145 | 145 | 140 | 0 | 3 | 25 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,336,444,330 | 2,221 | 593 | 0 | 0 | 1,272 | 694 | 693 | 234 | 343 | 1 | 355 | 258 | 97 | 59 | 37 | 593 | 593 | 1,272 | 0 | 1 | 341 | 0 | 0 | 
| app_proof | prover | 1 | 680,499,328 | 1,058 | 213 | 0 | 0 | 651 | 345 | 344 | 124 | 181 | 0 | 193 | 141 | 51 | 30 | 21 | 213 | 213 | 651 | 0 | 1 | 180 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 0 | 2 | 100 | 2,527 | 100 | 0 | 12,490,827,132 | 3,552,956,028 | 16,043,783,160 | 2,097,152 | 0 | 3 | 204 | 7,147,000 | 36.16 | 
| app_proof | 1 | 0 | 1 | 43 | 1,579 | 43 | 0 | 7,058,879,292 | 1,113,563,844 | 8,172,443,136 | 2,097,152 | 0 | 2 | 477 | 4,020,961 | 36.81 | 

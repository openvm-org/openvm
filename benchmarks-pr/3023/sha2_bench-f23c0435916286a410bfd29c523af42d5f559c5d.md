...
| `total_proof_time_ms ` |  2,086 |  4,172 |  2,552 |  1,620 |
...
| `execute_preflight_time_ms` |  350.50 |  701 |  506 |  195 |
| `execute_preflight_insn_mi/s` |  37.74 | -          |  37.90 |  37.58 |
| `trace_gen_time_ms   ` |  76 |  152 |  106 |  46 |
| `set_initial_memory_time_ms` |  0 |  0 |  0 |  0 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,658 |  3,316 |  2,249 |  1,067 |
| `prover.main_trace_commit_time_ms` |  409 |  818 |  602 |  216 |
| `prover.rap_constraints_time_ms` |  973.50 |  1,947 |  1,288 |  659 |
| `prover.openings_time_ms` |  275 |  550 |  358 |  192 |
| `prover.rap_constraints.logup_gkr_time_ms` |  266.50 |  533 |  349 |  184 |
| `prover.rap_constraints.round0_time_ms` |  523 |  1,046 |  699 |  347 |
| `prover.rap_constraints.mle_rounds_time_ms` |  183 |  366 |  239 |  127 |
...
| `prover.openings.whir_time_ms` |  200 |  400 |  260 |  140 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/f23c0435916286a410bfd29c523af42d5f559c5d/sha2_bench-f23c0435916286a410bfd29c523af42d5f559c5d.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 60 |  |  |  | 298 |  |  |  |  |  |  | 
| app_proof |  |  |  | 1,620 |  | 56 | 11,167,961 | 196.03 | 0 | 4,238 |  | 
...
| app_proof | VmAirWrapper<Rv64BaseAluRegU16AdapterAir, AddSubCoreAir<4, 16> | 0 |  | 12 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 183 | 47 | 0 | 0 | 80 | 29 | 28 | 37 | 14 | 0 | 55 | 44 | 10 | 2 | 7 | 47 | 47 | 80 | 0 | 1 | 12 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 109 | 20 | 0 | 0 | 55 | 21 | 20 | 23 | 10 | 0 | 32 | 24 | 7 | 1 | 6 | 21 | 20 | 55 | 0 | 1 | 10 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 99 | 15 | 0 | 0 | 55 | 22 | 21 | 21 | 11 | 0 | 28 | 21 | 7 | 1 | 5 | 15 | 15 | 55 | 0 | 1 | 10 | 0 | 0 | 
| leaf | 0 | prover | 237,929,272 | 409 | 147 | 0 | 0 | 142 | 71 | 70 | 44 | 26 | 0 | 118 | 96 | 22 | 10 | 11 | 147 | 147 | 142 | 0 | 3 | 25 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,336,444,330 | 2,249 | 601 | 0 | 0 | 1,288 | 699 | 698 | 239 | 349 | 1 | 358 | 260 | 98 | 60 | 38 | 602 | 601 | 1,288 | 0 | 1 | 347 | 0 | 0 | 
| app_proof | prover | 1 | 680,499,328 | 1,067 | 216 | 0 | 0 | 659 | 347 | 346 | 127 | 184 | 0 | 192 | 140 | 51 | 30 | 21 | 216 | 216 | 659 | 0 | 1 | 183 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 0 | 2 | 106 | 2,552 | 106 | 0 | 12,490,827,132 | 3,552,956,028 | 16,043,783,160 | 2,097,152 | 0 | 3 | 195 | 7,147,000 | 37.90 | 
| app_proof | 1 | 0 | 1 | 46 | 1,620 | 46 | 0 | 7,058,879,292 | 1,113,563,844 | 8,172,443,136 | 2,097,152 | 0 | 2 | 506 | 4,020,961 | 37.58 | 

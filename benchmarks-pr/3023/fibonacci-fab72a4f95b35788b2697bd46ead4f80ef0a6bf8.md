...
|:---|---:|---:|---:|
| Total |  1.05 |  0.93 |  0.93 |
| app_proof |  0.43 |  0.31 |  0.31 |
| leaf |  0.24 |  0.24 |  0.24 |
...
| `total_proof_time_ms ` |  206 |  412 |  293 |  119 |
| `compile_metered_time_ms` |  5 |  5 |  5 |  5 |
| `execute_metered_time_ms` |  13 | -          | -          | -          |
| `execute_metered_insns` |  4,000,051 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  290.36 | -          |  290.36 |  290.36 |
| `execute_preflight_insns` |  2,000,025.50 |  4,000,051 |  3,495,000 |  505,051 |
| `execute_preflight_time_ms` |  50.50 |  101 |  81 |  20 |
| `execute_preflight_insn_mi/s` |  51.02 | -          |  57.41 |  44.62 |
| `trace_gen_time_ms   ` |  22.50 |  45 |  23 |  22 |
| `set_initial_memory_time_ms` |  0 |  0 |  0 |  0 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  131.50 |  263 |  187 |  76 |
| `prover.main_trace_commit_time_ms` |  26 |  52 |  40 |  12 |
| `prover.rap_constraints_time_ms` |  70.50 |  141 |  100 |  41 |
| `prover.openings_time_ms` |  34 |  68 |  45 |  23 |
| `prover.rap_constraints.logup_gkr_time_ms` |  40.50 |  81 |  59 |  22 |
| `prover.rap_constraints.round0_time_ms` |  18.50 |  37 |  27 |  10 |
...
| `prover.openings.whir_time_ms` |  25.50 |  51 |  33 |  18 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/fab72a4f95b35788b2697bd46ead4f80ef0a6bf8/fibonacci-fab72a4f95b35788b2697bd46ead4f80ef0a6bf8.memory.svg)
...
| 12 | VmAirWrapper<Rv64BaseAluImmU16AdapterAir, LessThanImmCoreAir<4, 16> |  | 14 | 23 | 3 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 58 |  |  |  | 292 |  |  |  |  |  |  | 
| app_proof |  |  |  | 119 |  | 13 | 4,000,051 | 290.36 | 0 | 435 |  | 
...
| app_proof | 12 | VmAirWrapper<Rv64BaseAluImmU16AdapterAir, LessThanImmCoreAir<4, 16> | prover | 0 | 1 | 30 | 30 | 
...
| app_proof | 12 | VmAirWrapper<Rv64BaseAluImmU16AdapterAir, LessThanImmCoreAir<4, 16> | 0 | 1 |  | 75 |  | 120 |  | 30 |  | 508 |  | 14 |  | 
...
| internal_recursive.1 | 1 | prover | 9,750,865 | 93 | 14 | 0 | 0 | 53 | 20 | 19 | 21 | 11 | 0 | 25 | 18 | 7 | 1 | 5 | 15 | 14 | 53 | 0 | 1 | 10 | 0 | 0 | 
| leaf | 0 | prover | 76,005,176 | 196 | 50 | 0 | 0 | 88 | 42 | 41 | 27 | 17 | 0 | 56 | 45 | 11 | 3 | 7 | 51 | 50 | 88 | 0 | 3 | 16 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 118,747,885 | 187 | 40 | 0 | 0 | 100 | 27 | 27 | 13 | 59 | 0 | 45 | 33 | 11 | 5 | 6 | 40 | 40 | 100 | 0 | 1 | 58 | 0 | 0 | 
| app_proof | prover | 1 | 26,209,995 | 76 | 11 | 0 | 0 | 41 | 10 | 10 | 7 | 22 | 0 | 23 | 18 | 4 | 1 | 3 | 12 | 11 | 41 | 0 | 1 | 22 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 0 | 2 | 23 | 293 | 23 | 0 | 2,424,655,300 | 461,599,480 | 2,886,254,780 | 2,097,152 | 0 | 3 | 81 | 3,495,000 | 44.62 | 
| app_proof | 1 | 0 | 1 | 22 | 119 | 22 | 0 | 415,773,063 | 190,268,034 | 606,041,097 | 2,097,152 | 0 | 2 | 20 | 505,051 | 57.41 | 

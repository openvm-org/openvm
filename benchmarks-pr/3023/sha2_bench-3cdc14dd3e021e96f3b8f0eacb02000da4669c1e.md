...
| `total_proof_time_ms ` |  2,066 |  4,132 |  2,544 |  1,588 |
...
| `execute_preflight_time_ms` |  342.50 |  685 |  477 |  208 |
| `execute_preflight_insn_mi/s` |  35.82 | -          |  36.13 |  35.51 |
| `trace_gen_time_ms   ` |  72 |  144 |  100 |  44 |
| `set_initial_memory_time_ms` |  0 |  0 |  0 |  0 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,650 |  3,300 |  2,234 |  1,066 |
| `prover.main_trace_commit_time_ms` |  404 |  808 |  594 |  214 |
| `prover.rap_constraints_time_ms` |  969.50 |  1,939 |  1,281 |  658 |
| `prover.openings_time_ms` |  275.50 |  551 |  358 |  193 |
| `prover.rap_constraints.logup_gkr_time_ms` |  265 |  530 |  348 |  182 |
| `prover.rap_constraints.round0_time_ms` |  522.50 |  1,045 |  696 |  349 |
| `prover.rap_constraints.mle_rounds_time_ms` |  181 |  362 |  236 |  126 |
| `prover.openings.stacked_reduction_time_ms` |  74.50 |  149 |  98 |  51 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/3cdc14dd3e021e96f3b8f0eacb02000da4669c1e/sha2_bench-3cdc14dd3e021e96f3b8f0eacb02000da4669c1e.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 58 |  |  |  | 289 |  |  |  |  |  |  | 
| app_proof |  |  |  | 1,588 |  | 56 | 11,167,961 | 196.24 | 0 | 4,197 |  | 
...
| app_proof | VmAirWrapper<Rv64LoadAdapterAir, LoadCoreAir<8, 1> | 0 | 4 | 9 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 176 | 46 | 0 | 0 | 81 | 29 | 28 | 36 | 14 | 0 | 48 | 38 | 10 | 2 | 7 | 47 | 46 | 81 | 0 | 1 | 12 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,336,444,330 | 2,234 | 594 | 0 | 0 | 1,281 | 696 | 696 | 236 | 348 | 1 | 358 | 259 | 98 | 60 | 37 | 594 | 594 | 1,281 | 0 | 1 | 346 | 0 | 0 | 
| app_proof | prover | 1 | 680,499,328 | 1,066 | 214 | 0 | 0 | 658 | 349 | 348 | 126 | 182 | 0 | 193 | 141 | 51 | 30 | 21 | 214 | 214 | 658 | 0 | 1 | 181 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 0 | 2 | 100 | 2,544 | 100 | 0 | 12,490,827,132 | 3,552,956,028 | 16,043,783,160 | 2,097,152 | 0 | 3 | 208 | 7,147,000 | 35.51 | 
| app_proof | 1 | 0 | 1 | 44 | 1,588 | 44 | 0 | 7,058,879,292 | 1,113,563,844 | 8,172,443,136 | 2,097,152 | 0 | 2 | 477 | 4,020,961 | 36.13 | 

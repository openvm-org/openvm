...
| `total_proof_time_ms ` |  2,078 |  4,156 |  2,557 |  1,599 |
| `compile_metered_time_ms` |  6 |  6 |  6 |  6 |
| `execute_metered_time_ms` |  57 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  193.05 | -          |  193.05 |  193.05 |
| `execute_preflight_insns` |  5,583,980.50 |  11,167,961 |  7,147,000 |  4,020,961 |
| `execute_preflight_time_ms` |  350 |  700 |  487 |  213 |
| `execute_preflight_insn_mi/s` |  36.76 | -          |  38.83 |  34.70 |
| `trace_gen_time_ms   ` |  74 |  148 |  103 |  45 |
| `set_initial_memory_time_ms` |  0 |  0 |  0 |  0 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,653 |  3,306 |  2,240 |  1,066 |
| `prover.main_trace_commit_time_ms` |  406 |  812 |  598 |  214 |
| `prover.rap_constraints_time_ms` |  970.50 |  1,941 |  1,284 |  657 |
| `prover.openings_time_ms` |  275 |  550 |  357 |  193 |
| `prover.rap_constraints.logup_gkr_time_ms` |  265.50 |  531 |  348 |  183 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/3436d5842c41e5a832e1f704e94b347af568b18e/sha2_bench-3436d5842c41e5a832e1f704e94b347af568b18e.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 58 |  |  |  | 296 |  |  |  |  |  |  | 
| app_proof |  |  |  | 1,599 |  | 57 | 11,167,961 | 193.05 | 0 | 4,223 |  | 
...
| leaf | 0 | 120 | 528 | 119 | 36 | 12 | 2 | 9 | 9 | 
...
| internal_recursive.1 | 1 | prover | 9,750,865 | 100 | 15 | 0 | 0 | 55 | 21 | 20 | 21 | 11 | 0 | 30 | 22 | 7 | 1 | 5 | 15 | 15 | 55 | 0 | 1 | 10 | 0 | 0 | 
| leaf | 0 | prover | 237,929,272 | 408 | 145 | 0 | 0 | 142 | 71 | 70 | 44 | 27 | 0 | 119 | 97 | 22 | 10 | 11 | 146 | 145 | 142 | 0 | 3 | 25 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,336,444,330 | 2,240 | 598 | 0 | 0 | 1,284 | 698 | 698 | 236 | 348 | 1 | 357 | 259 | 98 | 60 | 37 | 598 | 598 | 1,284 | 0 | 1 | 346 | 0 | 0 | 
| app_proof | prover | 1 | 680,499,328 | 1,066 | 214 | 0 | 0 | 657 | 347 | 347 | 127 | 183 | 0 | 193 | 142 | 51 | 30 | 21 | 214 | 214 | 657 | 0 | 1 | 181 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 0 | 2 | 103 | 2,557 | 103 | 0 | 12,490,827,132 | 3,552,956,028 | 16,043,783,160 | 2,097,152 | 0 | 3 | 213 | 7,147,000 | 34.70 | 
| app_proof | 1 | 0 | 1 | 45 | 1,599 | 45 | 0 | 7,058,879,292 | 1,113,563,844 | 8,172,443,136 | 2,097,152 | 0 | 2 | 487 | 4,020,961 | 38.83 | 

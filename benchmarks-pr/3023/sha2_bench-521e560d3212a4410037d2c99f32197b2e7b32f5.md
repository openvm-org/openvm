...
| `total_proof_time_ms ` |  2,068.50 |  4,137 |  2,550 |  1,587 |
...
| `execute_preflight_time_ms` |  334 |  668 |  473 |  195 |
| `execute_preflight_insn_mi/s` |  38.82 | -          |  39.91 |  37.73 |
| `trace_gen_time_ms   ` |  71 |  142 |  99 |  43 |
| `set_initial_memory_time_ms` |  0 |  0 |  0 |  0 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,661 |  3,322 |  2,253 |  1,069 |
| `prover.main_trace_commit_time_ms` |  406.50 |  813 |  597 |  216 |
| `prover.rap_constraints_time_ms` |  978 |  1,956 |  1,294 |  662 |
| `prover.openings_time_ms` |  275.50 |  551 |  361 |  190 |
| `prover.rap_constraints.logup_gkr_time_ms` |  270 |  540 |  354 |  186 |
| `prover.rap_constraints.round0_time_ms` |  524.50 |  1,049 |  701 |  348 |
| `prover.rap_constraints.mle_rounds_time_ms` |  183 |  366 |  239 |  127 |
| `prover.openings.stacked_reduction_time_ms` |  76 |  152 |  99 |  53 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/521e560d3212a4410037d2c99f32197b2e7b32f5/sha2_bench-521e560d3212a4410037d2c99f32197b2e7b32f5.memory.svg)
...
| 36 | VmAirWrapper<Rv64BaseAluWImmU16AdapterAir, ShiftRightArithmeticImmCoreAir<2, 16> |  | 17 | 63 | 3 | 
...
| 39 | VmAirWrapper<Rv64BaseAluWRegU16AdapterAir, ShiftRightArithmeticCoreAir<2, 16> |  | 22 | 64 | 3 | 
...
| 41 | VmAirWrapper<Rv64BaseAluRegU16AdapterAir, ShiftRightArithmeticCoreAir<4, 16> |  | 25 | 79 | 3 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 56 |  |  |  | 290 |  |  |  |  |  |  | 
| app_proof |  |  |  | 1,587 |  | 56 | 11,167,961 | 196.22 | 0 | 4,202 |  | 
...
| leaf | 0 | 117 | 523 | 117 | 34 | 12 | 2 | 9 | 9 | 
...
| internal_recursive.1 | 1 | prover | 9,750,865 | 96 | 15 | 0 | 0 | 56 | 21 | 20 | 22 | 11 | 0 | 24 | 17 | 7 | 1 | 5 | 15 | 15 | 56 | 0 | 1 | 10 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,336,444,330 | 2,253 | 597 | 0 | 0 | 1,294 | 701 | 700 | 239 | 354 | 1 | 361 | 261 | 99 | 61 | 38 | 597 | 597 | 1,294 | 0 | 1 | 352 | 0 | 0 | 
| app_proof | prover | 1 | 680,499,328 | 1,069 | 216 | 0 | 0 | 662 | 348 | 347 | 127 | 186 | 0 | 190 | 137 | 53 | 31 | 21 | 216 | 216 | 662 | 0 | 1 | 185 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 0 | 2 | 99 | 2,550 | 99 | 0 | 12,490,827,132 | 3,552,956,028 | 16,043,783,160 | 2,097,152 | 0 | 3 | 195 | 7,147,000 | 37.73 | 
| app_proof | 1 | 0 | 1 | 43 | 1,587 | 43 | 0 | 7,058,879,292 | 1,113,563,844 | 8,172,443,136 | 2,097,152 | 0 | 2 | 473 | 4,020,961 | 39.91 | 

...
| `total_proof_time_ms ` |  951 |  1,902 |  1,226 |  676 |
| `execute_metered_time_ms` |  36 | -          | -          | -          |
| `execute_metered_insns` |  2,579,903 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  70.43 | -          |  70.43 |  70.43 |
| `execute_preflight_insns` |  1,289,951.50 |  2,579,903 |  1,540,000 |  1,039,903 |
| `execute_preflight_time_ms` |  97.50 |  195 |  133 |  62 |
| `execute_preflight_insn_mi/s` |  35.94 | -          |  36.98 |  34.89 |
| `trace_gen_time_ms   ` |  26.50 |  53 |  37 |  16 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  716.50 |  1,433 |  947 |  486 |
| `prover.main_trace_commit_time_ms` |  216 |  432 |  294 |  138 |
| `prover.rap_constraints_time_ms` |  452 |  904 |  597 |  307 |
| `prover.openings_time_ms` |  47.50 |  95 |  55 |  40 |
| `prover.rap_constraints.logup_gkr_time_ms` |  84 |  168 |  113 |  55 |
| `prover.rap_constraints.round0_time_ms` |  265 |  530 |  355 |  175 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/f49e1598ed6bf0f4fe9934a0ef1e429e0c9c898e/kitchen_sink-f49e1598ed6bf0f4fe9934a0ef1e429e0c9c898e.memory.svg)
...
| app_proof |  |  |  |  |  | 676 |  |  | 36 | 2,579,903 | 70.43 | 0 | 1,944 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 567,917,156 | 947 | 293 | 0 | 163 | 597 | 355 | 353 | 129 | 113 | 56 | 55 | 13 | 41 | 16 | 25 | 294 | 597 | 0 | 1 | 56 | 0 | 0 | 
| app_proof | prover | 1 | 537,266,124 | 486 | 138 | 0 | 1 | 307 | 175 | 174 | 76 | 55 | 0 | 40 | 12 | 28 | 14 | 13 | 138 | 307 | 0 | 1 | 54 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 37 | 1,226 | 37 | 178 | 0 | 3 | 62 | 1,540,000 | 34.89 | 
| app_proof | 1 | 16 | 676 | 16 | 40 | 0 | 1 | 133 | 1,039,903 | 36.98 | 

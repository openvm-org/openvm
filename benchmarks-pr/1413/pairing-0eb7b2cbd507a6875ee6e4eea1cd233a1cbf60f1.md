...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  14,080 |  14,080 |  14,080 |  14,080 |
| `main_cells_used     ` |  275,098,752 |  275,098,752 |  275,098,752 |  275,098,752 |
| `total_cycles        ` |  3,302,115 |  3,302,115 |  3,302,115 |  3,302,115 |
| `execute_time_ms     ` |  1,222 |  1,222 |  1,222 |  1,222 |
| `trace_gen_time_ms   ` |  2,572 |  2,572 |  2,572 |  2,572 |
| `stark_prove_excluding_trace_time_ms` |  10,286 |  10,286 |  10,286 |  10,286 |
| `main_trace_commit_time_ms` |  1,776 |  1,776 |  1,776 |  1,776 |
| `generate_perm_trace_time_ms` |  704 |  704 |  704 |  704 |
| `perm_trace_commit_time_ms` |  3,367 |  3,367 |  3,367 |  3,367 |
| `quotient_poly_compute_time_ms` |  1,476 |  1,476 |  1,476 |  1,476 |
| `quotient_poly_commit_time_ms` |  975 |  975 |  975 |  975 |
| `pcs_opening_time_ms ` |  1,984 |  1,984 |  1,984 |  1,984 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 2,572 | 14,080 | 3,302,115 | 1,072,008,682 | 10,286 | 1,476 | 975 | 3,367 | 1,984 | 1,776 | 275,098,752 | 704 | 1,222 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 893 | 4,725 | 1,711,640 | 297,186,413 | 3,177 | 468 | 334 | 790 | 763 | 600 | 92,585,975 | 206 | 655 | 

...
| `total_proof_time_ms ` |  4,691 |  4,691 |  4,691 |  4,691 |
| `main_cells_used     ` |  88,086,857 |  88,086,857 |  88,086,857 |  88,086,857 |
| `total_cycles        ` |  1,612,247 |  1,612,247 |  1,612,247 |  1,612,247 |
...
| `pcs_opening_time_ms ` |  815 |  815 |  815 |  815 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  24,031 |  24,031 |  24,031 |  24,031 |
| `main_cells_used     ` |  431,029,045 |  431,029,045 |  431,029,045 |  431,029,045 |
| `total_cycles        ` |  4,507,220 |  4,507,220 |  4,507,220 |  4,507,220 |
| `execute_time_ms     ` |  1,712 |  1,712 |  1,712 |  1,712 |
| `trace_gen_time_ms   ` |  4,161 |  4,161 |  4,161 |  4,161 |
| `stark_prove_excluding_trace_time_ms` |  18,158 |  18,158 |  18,158 |  18,158 |
| `main_trace_commit_time_ms` |  3,254 |  3,254 |  3,254 |  3,254 |
| `generate_perm_trace_time_ms` |  1,349 |  1,349 |  1,349 |  1,349 |
| `perm_trace_commit_time_ms` |  6,121 |  6,121 |  6,121 |  6,121 |
| `quotient_poly_compute_time_ms` |  2,494 |  2,494 |  2,494 |  2,494 |
| `quotient_poly_commit_time_ms` |  1,634 |  1,634 |  1,634 |  1,634 |
| `pcs_opening_time_ms ` |  3,301 |  3,301 |  3,301 |  3,301 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 4,161 | 24,031 | 4,507,220 | 1,912,212,970 | 18,158 | 2,494 | 1,634 | 6,121 | 3,301 | 3,254 | 431,029,045 | 1,349 | 1,712 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 886 | 4,691 | 1,612,247 | 288,863,405 | 3,178 | 456 | 340 | 757 | 815 | 594 | 88,086,857 | 186 | 627 | 

...
| `total_proof_time_ms ` |  4,644 |  4,644 |  4,644 |  4,644 |
| `main_cells_used     ` |  87,543,575 |  87,543,575 |  87,543,575 |  87,543,575 |
| `total_cycles        ` |  1,599,034 |  1,599,034 |  1,599,034 |  1,599,034 |
| `execute_time_ms     ` |  633 |  633 |  633 |  633 |
| `trace_gen_time_ms   ` |  881 |  881 |  881 |  881 |
...
| `perm_trace_commit_time_ms` |  759 |  759 |  759 |  759 |
| `quotient_poly_compute_time_ms` |  454 |  454 |  454 |  454 |
| `quotient_poly_commit_time_ms` |  337 |  337 |  337 |  337 |
| `pcs_opening_time_ms ` |  778 |  778 |  778 |  778 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  24,193 |  24,193 |  24,193 |  24,193 |
| `main_cells_used     ` |  462,274,276 |  462,274,276 |  462,274,276 |  462,274,276 |
| `total_cycles        ` |  4,779,489 |  4,779,489 |  4,779,489 |  4,779,489 |
| `execute_time_ms     ` |  1,830 |  1,830 |  1,830 |  1,830 |
| `trace_gen_time_ms   ` |  4,342 |  4,342 |  4,342 |  4,342 |
| `stark_prove_excluding_trace_time_ms` |  18,021 |  18,021 |  18,021 |  18,021 |
| `main_trace_commit_time_ms` |  3,241 |  3,241 |  3,241 |  3,241 |
| `generate_perm_trace_time_ms` |  1,320 |  1,320 |  1,320 |  1,320 |
| `perm_trace_commit_time_ms` |  6,070 |  6,070 |  6,070 |  6,070 |
| `quotient_poly_compute_time_ms` |  2,488 |  2,488 |  2,488 |  2,488 |
| `quotient_poly_commit_time_ms` |  1,634 |  1,634 |  1,634 |  1,634 |
| `pcs_opening_time_ms ` |  3,261 |  3,261 |  3,261 |  3,261 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 4,342 | 24,193 | 4,779,489 | 1,912,212,970 | 18,021 | 2,488 | 1,634 | 6,070 | 3,261 | 3,241 | 462,274,276 | 1,320 | 1,830 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 881 | 4,644 | 1,599,034 | 288,799,165 | 3,130 | 454 | 337 | 759 | 778 | 588 | 87,543,575 | 180 | 633 | 

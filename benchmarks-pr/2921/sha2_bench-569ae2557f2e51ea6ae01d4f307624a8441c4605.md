...
| `execute_preflight_time_ms` |  246.50 |  493 |  274 |  219 |
| `execute_preflight_insn_mi/s` |  37 | -          |  38.66 |  35.35 |
| `trace_gen_time_ms   ` |  122 |  244 |  171 |  73 |
| `set_initial_memory_time_ms` |  88.50 |  177 |  136 |  41 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  3,684.50 |  7,369 |  4,704 |  2,665 |
| `prover.main_trace_commit_time_ms` |  970 |  1,940 |  1,344 |  596 |
| `prover.rap_constraints_time_ms` |  2,004 |  4,008 |  2,466 |  1,542 |
| `prover.openings_time_ms` |  709.50 |  1,419 |  893 |  526 |
| `prover.rap_constraints.logup_gkr_time_ms` |  562.50 |  1,125 |  601 |  524 |
| `prover.rap_constraints.round0_time_ms` |  1,053 |  2,106 |  1,365 |  741 |
| `prover.rap_constraints.mle_rounds_time_ms` |  387.50 |  775 |  499 |  276 |
...
| `prover.openings.whir_time_ms` |  542 |  1,084 |  678 |  406 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/569ae2557f2e51ea6ae01d4f307624a8441c4605/sha2_bench-569ae2557f2e51ea6ae01d4f307624a8441c4605.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 68 |  |  |  | 336 |  |  |  |  |  |  | 
| app_proof |  |  |  | 3,055 |  | 98 | 11,167,961 | 113.45 | 0 | 8,390 |  | 
...
| leaf | 0 | 109 | 1,018 | 108 | 34 | 17 | 2 | 7 | 7 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 328 | 119 | 0 | 0 | 108 | 35 | 35 | 52 | 20 | 0 | 100 | 86 | 13 | 3 | 9 | 119 | 119 | 108 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 171 | 48 | 0 | 0 | 69 | 26 | 25 | 28 | 14 | 0 | 52 | 43 | 8 | 1 | 6 | 49 | 48 | 69 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 143 | 32 | 0 | 0 | 63 | 23 | 22 | 24 | 14 | 0 | 47 | 39 | 7 | 1 | 5 | 33 | 32 | 63 | 0 | 3 | 13 | 0 | 0 | 
| leaf | 0 | prover | 237,929,016 | 909 | 378 | 0 | 0 | 232 | 111 | 111 | 69 | 51 | 0 | 297 | 258 | 38 | 20 | 17 | 378 | 378 | 232 | 0 | 12 | 50 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,286,242,554 | 4,704 | 1,343 | 0 | 0 | 2,466 | 1,365 | 1,365 | 499 | 601 | 0 | 893 | 678 | 214 | 135 | 79 | 1,344 | 1,343 | 2,466 | 0 | 6 | 599 | 0 | 0 | 
| app_proof | prover | 1 | 750,289,144 | 2,665 | 596 | 0 | 0 | 1,542 | 741 | 741 | 276 | 524 | 0 | 526 | 406 | 120 | 72 | 47 | 596 | 596 | 1,542 | 0 | 7 | 522 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 136 | 1 | 171 | 5,231 | 171 | 136 | 13,311,936,132 | 2,137,449,780 | 15,449,385,912 | 2,097,152 | 0 | 3 | 219 | 7,124,000 | 35.35 | 
| app_proof | 1 | 41 | 1 | 73 | 3,055 | 73 | 41 | 7,588,526,580 | 1,502,398,413 | 9,090,924,993 | 2,097,152 | 0 | 2 | 274 | 4,043,961 | 38.66 | 

...
|:---|---:|---:|---:|
| Total |  10.07 |  7.03 |  7.03 |
| app_proof |  8.37 |  5.33 |  5.33 |
| leaf |  1.01 |  1.01 |  1.01 |
...
| `total_proof_time_ms ` |  4,136.50 |  8,273 |  5,227 |  3,046 |
...
| `execute_preflight_time_ms` |  250 |  500 |  275 |  225 |
| `execute_preflight_insn_mi/s` |  36.16 | -          |  38.03 |  34.28 |
| `trace_gen_time_ms   ` |  125 |  250 |  175 |  75 |
| `set_initial_memory_time_ms` |  88 |  176 |  135 |  41 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  3,672 |  7,344 |  4,691 |  2,653 |
| `prover.main_trace_commit_time_ms` |  968 |  1,936 |  1,338 |  598 |
| `prover.rap_constraints_time_ms` |  1,994 |  3,988 |  2,455 |  1,533 |
| `prover.openings_time_ms` |  708.50 |  1,417 |  896 |  521 |
| `prover.rap_constraints.logup_gkr_time_ms` |  562.50 |  1,125 |  602 |  523 |
| `prover.rap_constraints.round0_time_ms` |  1,044.50 |  2,089 |  1,355 |  734 |
| `prover.rap_constraints.mle_rounds_time_ms` |  386 |  772 |  497 |  275 |
| `prover.openings.stacked_reduction_time_ms` |  167 |  334 |  216 |  118 |
...
| `prover.openings.whir_time_ms` |  541.50 |  1,083 |  680 |  403 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/76ca53c369580b21b4005ff976e8d02af68412a6/sha2_bench-76ca53c369580b21b4005ff976e8d02af68412a6.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 69 |  |  |  | 344 |  |  |  |  |  |  | 
| app_proof |  |  |  | 3,046 |  | 99 | 11,167,961 | 112.55 | 0 | 8,378 |  | 
| internal_for_leaf |  |  | 359 |  |  |  |  |  |  |  | 359 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 338 | 121 | 0 | 0 | 108 | 35 | 34 | 51 | 21 | 0 | 107 | 94 | 13 | 3 | 9 | 121 | 121 | 108 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 171 | 47 | 0 | 0 | 68 | 25 | 24 | 28 | 14 | 0 | 56 | 47 | 8 | 1 | 6 | 47 | 47 | 68 | 0 | 3 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 135 | 31 | 0 | 0 | 59 | 21 | 21 | 24 | 13 | 0 | 43 | 36 | 7 | 1 | 5 | 32 | 31 | 59 | 0 | 3 | 12 | 0 | 0 | 
| leaf | 0 | prover | 237,896,248 | 903 | 378 | 0 | 0 | 231 | 110 | 109 | 68 | 52 | 0 | 292 | 254 | 37 | 20 | 17 | 378 | 378 | 231 | 0 | 10 | 50 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,288,077,561 | 4,691 | 1,338 | 0 | 0 | 2,455 | 1,355 | 1,354 | 497 | 602 | 1 | 896 | 680 | 216 | 136 | 80 | 1,338 | 1,338 | 2,455 | 0 | 5 | 601 | 0 | 0 | 
| app_proof | prover | 1 | 751,206,644 | 2,653 | 598 | 0 | 0 | 1,533 | 734 | 734 | 275 | 523 | 0 | 521 | 403 | 118 | 70 | 47 | 598 | 598 | 1,533 | 0 | 6 | 522 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 135 | 1 | 175 | 5,227 | 175 | 135 | 13,329,494,472 | 2,141,911,524 | 15,471,405,996 | 2,097,152 | 0 | 3 | 225 | 7,124,000 | 34.28 | 
| app_proof | 1 | 41 | 1 | 75 | 3,046 | 75 | 41 | 7,598,498,184 | 1,557,865,504 | 9,156,363,688 | 2,097,152 | 0 | 2 | 275 | 4,043,961 | 38.03 | 

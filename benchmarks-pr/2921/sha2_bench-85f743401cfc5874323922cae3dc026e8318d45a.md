...
| `total_proof_time_ms ` |  4,145.50 |  8,291 |  5,237 |  3,054 |
...
| `execute_preflight_time_ms` |  248 |  496 |  277 |  219 |
| `execute_preflight_insn_mi/s` |  37.14 | -          |  38.86 |  35.42 |
| `trace_gen_time_ms   ` |  121.50 |  243 |  171 |  72 |
| `set_initial_memory_time_ms` |  88 |  176 |  135 |  41 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  3,686.50 |  7,373 |  4,711 |  2,662 |
| `prover.main_trace_commit_time_ms` |  971 |  1,942 |  1,343 |  599 |
| `prover.rap_constraints_time_ms` |  2,000.50 |  4,001 |  2,469 |  1,532 |
| `prover.openings_time_ms` |  714 |  1,428 |  898 |  530 |
| `prover.rap_constraints.logup_gkr_time_ms` |  561 |  1,122 |  601 |  521 |
| `prover.rap_constraints.round0_time_ms` |  1,049 |  2,098 |  1,364 |  734 |
| `prover.rap_constraints.mle_rounds_time_ms` |  389 |  778 |  502 |  276 |
| `prover.openings.stacked_reduction_time_ms` |  169.50 |  339 |  218 |  121 |
...
| `prover.openings.whir_time_ms` |  544.50 |  1,089 |  680 |  409 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/85f743401cfc5874323922cae3dc026e8318d45a/sha2_bench-85f743401cfc5874323922cae3dc026e8318d45a.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 70 |  |  |  | 344 |  |  |  |  |  |  | 
| app_proof |  |  |  | 3,054 |  | 98 | 11,167,961 | 112.85 | 0 | 8,397 |  | 
| internal_for_leaf |  |  | 361 |  |  |  |  |  |  |  | 361 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 337 | 119 | 0 | 0 | 108 | 35 | 34 | 52 | 21 | 0 | 108 | 95 | 13 | 3 | 9 | 120 | 119 | 108 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 171 | 47 | 0 | 0 | 69 | 27 | 26 | 28 | 14 | 0 | 54 | 46 | 8 | 1 | 6 | 47 | 47 | 69 | 0 | 3 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 138 | 31 | 0 | 0 | 63 | 24 | 23 | 24 | 14 | 0 | 42 | 35 | 7 | 1 | 5 | 32 | 31 | 63 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 237,929,016 | 902 | 377 | 0 | 0 | 230 | 110 | 109 | 67 | 52 | 0 | 293 | 254 | 38 | 20 | 17 | 378 | 377 | 230 | 0 | 11 | 50 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,286,242,554 | 4,711 | 1,343 | 0 | 0 | 2,469 | 1,364 | 1,364 | 502 | 601 | 1 | 898 | 680 | 218 | 137 | 81 | 1,343 | 1,343 | 2,469 | 0 | 6 | 600 | 0 | 0 | 
| app_proof | prover | 1 | 750,289,144 | 2,662 | 599 | 0 | 0 | 1,532 | 734 | 734 | 276 | 521 | 0 | 530 | 409 | 121 | 73 | 47 | 599 | 599 | 1,532 | 0 | 6 | 519 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 135 | 1 | 171 | 5,237 | 171 | 135 | 13,311,936,132 | 2,137,449,780 | 15,449,385,912 | 2,097,152 | 0 | 3 | 219 | 7,124,000 | 35.42 | 
| app_proof | 1 | 41 | 1 | 72 | 3,054 | 72 | 41 | 7,588,526,580 | 1,502,398,413 | 9,090,924,993 | 2,097,152 | 0 | 2 | 277 | 4,043,961 | 38.86 | 

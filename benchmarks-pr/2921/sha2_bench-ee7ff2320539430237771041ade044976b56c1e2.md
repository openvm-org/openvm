...
|:---|---:|---:|---:|
| Total |  10.08 |  7.03 |  7.03 |
| app_proof |  8.39 |  5.33 |  5.33 |
| leaf |  1.01 |  1.01 |  1.01 |
...
| `total_proof_time_ms ` |  4,143 |  8,286 |  5,231 |  3,055 |
...
| `execute_preflight_time_ms` |  260.50 |  521 |  291 |  230 |
| `execute_preflight_insn_mi/s` |  35.70 | -          |  37.64 |  33.76 |
| `trace_gen_time_ms   ` |  125.50 |  251 |  176 |  75 |
| `set_initial_memory_time_ms` |  89 |  178 |  137 |  41 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  3,667 |  7,334 |  4,687 |  2,647 |
| `prover.main_trace_commit_time_ms` |  965 |  1,930 |  1,334 |  596 |
| `prover.rap_constraints_time_ms` |  1,993.50 |  3,987 |  2,457 |  1,530 |
| `prover.openings_time_ms` |  707 |  1,414 |  895 |  519 |
| `prover.rap_constraints.logup_gkr_time_ms` |  561.50 |  1,123 |  602 |  521 |
| `prover.rap_constraints.round0_time_ms` |  1,044.50 |  2,089 |  1,356 |  733 |
| `prover.rap_constraints.mle_rounds_time_ms` |  386.50 |  773 |  498 |  275 |
...
| `prover.openings.whir_time_ms` |  539.50 |  1,079 |  678 |  401 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/ee7ff2320539430237771041ade044976b56c1e2/sha2_bench-ee7ff2320539430237771041ade044976b56c1e2.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 70 |  |  |  | 345 |  |  |  |  |  |  | 
| app_proof |  |  |  | 3,055 |  | 100 | 11,167,961 | 111.15 | 0 | 8,392 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 330 | 121 | 0 | 0 | 109 | 35 | 34 | 51 | 21 | 0 | 99 | 85 | 13 | 3 | 9 | 122 | 121 | 108 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 173 | 47 | 0 | 0 | 68 | 25 | 24 | 28 | 14 | 0 | 58 | 49 | 8 | 1 | 6 | 47 | 47 | 68 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 137 | 32 | 0 | 0 | 60 | 22 | 21 | 24 | 13 | 0 | 43 | 36 | 7 | 1 | 5 | 32 | 32 | 60 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 237,896,248 | 903 | 375 | 0 | 0 | 227 | 108 | 108 | 67 | 51 | 0 | 299 | 261 | 38 | 20 | 17 | 375 | 375 | 227 | 0 | 11 | 50 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,288,077,561 | 4,687 | 1,333 | 0 | 0 | 2,457 | 1,356 | 1,355 | 498 | 602 | 0 | 895 | 678 | 217 | 136 | 80 | 1,334 | 1,333 | 2,457 | 0 | 6 | 601 | 0 | 0 | 
| app_proof | prover | 1 | 751,206,644 | 2,647 | 596 | 0 | 0 | 1,530 | 733 | 733 | 275 | 521 | 0 | 519 | 401 | 118 | 70 | 47 | 596 | 596 | 1,530 | 0 | 6 | 519 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 137 | 1 | 176 | 5,231 | 176 | 137 | 13,329,494,472 | 2,141,911,524 | 15,471,405,996 | 2,097,152 | 0 | 4 | 230 | 7,124,000 | 33.76 | 
| app_proof | 1 | 41 | 1 | 75 | 3,055 | 75 | 41 | 7,598,498,184 | 1,557,865,504 | 9,156,363,688 | 2,097,152 | 0 | 2 | 291 | 4,043,961 | 37.64 | 

...
|:---|---:|---:|---:|
| Total |  9.88 |  6.89 |  6.89 |
| app_proof |  8.21 |  5.23 |  5.23 |
| leaf |  0.99 |  0.99 |  0.99 |
...
| `total_proof_time_ms ` |  4,058 |  8,116 |  5,127 |  2,989 |
...
| `execute_preflight_time_ms` |  246.50 |  493 |  280 |  213 |
| `execute_preflight_insn_mi/s` |  38.33 | -          |  40.09 |  36.56 |
| `trace_gen_time_ms   ` |  121.50 |  243 |  171 |  72 |
| `set_initial_memory_time_ms` |  88 |  176 |  135 |  41 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  3,600.50 |  7,201 |  4,606 |  2,595 |
| `prover.main_trace_commit_time_ms` |  954 |  1,908 |  1,321 |  587 |
| `prover.rap_constraints_time_ms` |  1,946.50 |  3,893 |  2,401 |  1,492 |
| `prover.openings_time_ms` |  699.50 |  1,399 |  884 |  515 |
| `prover.rap_constraints.logup_gkr_time_ms` |  550.50 |  1,101 |  592 |  509 |
| `prover.rap_constraints.round0_time_ms` |  1,020 |  2,040 |  1,325 |  715 |
| `prover.rap_constraints.mle_rounds_time_ms` |  374.50 |  749 |  482 |  267 |
...
| `prover.openings.whir_time_ms` |  537.50 |  1,075 |  675 |  400 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/f850f6fc71b30f100a6c7d9235af3fc086515c04/sha2_bench-f850f6fc71b30f100a6c7d9235af3fc086515c04.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 71 |  |  |  | 344 |  |  |  |  |  |  | 
| app_proof |  |  |  | 2,989 |  | 99 | 11,167,961 | 112.80 | 0 | 8,221 |  | 
...
| leaf | 0 | 107 | 994 | 107 | 34 | 17 | 2 | 7 | 7 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 325 | 117 | 0 | 0 | 107 | 36 | 35 | 51 | 20 | 0 | 100 | 87 | 13 | 3 | 9 | 117 | 117 | 107 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 166 | 47 | 0 | 0 | 66 | 24 | 24 | 28 | 13 | 0 | 51 | 43 | 8 | 1 | 6 | 47 | 47 | 66 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 139 | 31 | 0 | 0 | 62 | 23 | 22 | 25 | 14 | 0 | 44 | 37 | 7 | 1 | 5 | 32 | 31 | 62 | 0 | 2 | 13 | 0 | 0 | 
| leaf | 0 | prover | 237,896,248 | 886 | 370 | 0 | 0 | 225 | 108 | 108 | 67 | 49 | 0 | 289 | 252 | 37 | 19 | 17 | 370 | 370 | 225 | 0 | 9 | 49 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,288,077,561 | 4,606 | 1,320 | 0 | 0 | 2,401 | 1,325 | 1,325 | 482 | 592 | 0 | 884 | 675 | 208 | 130 | 78 | 1,321 | 1,320 | 2,401 | 0 | 5 | 591 | 0 | 0 | 
| app_proof | prover | 1 | 751,206,644 | 2,595 | 587 | 0 | 0 | 1,492 | 715 | 715 | 267 | 509 | 0 | 515 | 400 | 115 | 69 | 45 | 587 | 587 | 1,492 | 0 | 6 | 507 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 135 | 1 | 171 | 5,127 | 171 | 135 | 13,329,494,472 | 2,141,911,524 | 15,471,405,996 | 2,097,152 | 0 | 4 | 213 | 7,124,000 | 36.56 | 
| app_proof | 1 | 41 | 1 | 72 | 2,989 | 72 | 41 | 7,598,498,184 | 1,557,865,504 | 9,156,363,688 | 2,097,152 | 0 | 2 | 280 | 4,043,961 | 40.09 | 

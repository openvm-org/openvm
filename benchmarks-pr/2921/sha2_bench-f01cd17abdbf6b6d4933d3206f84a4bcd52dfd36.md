...
|:---|---:|---:|---:|
| Total |  9.84 |  6.87 |  6.87 |
| app_proof |  8.18 |  5.21 |  5.21 |
| leaf |  0.99 |  0.99 |  0.99 |
...
| `total_proof_time_ms ` |  4,040.50 |  8,081 |  5,109 |  2,972 |
| `compile_metered_time_ms` |  3 |  3 |  3 |  3 |
| `execute_metered_time_ms` |  99 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  112.14 | -          |  112.14 |  112.14 |
| `execute_preflight_insns` |  5,583,980.50 |  11,167,961 |  7,124,000 |  4,043,961 |
| `execute_preflight_time_ms` |  250 |  500 |  284 |  216 |
| `execute_preflight_insn_mi/s` |  37.74 | -          |  39.54 |  35.94 |
| `trace_gen_time_ms   ` |  121 |  242 |  170 |  72 |
| `set_initial_memory_time_ms` |  87.50 |  175 |  134 |  41 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  3,579.50 |  7,159 |  4,586 |  2,573 |
| `prover.main_trace_commit_time_ms` |  950.50 |  1,901 |  1,319 |  582 |
| `prover.rap_constraints_time_ms` |  1,930 |  3,860 |  2,384 |  1,476 |
| `prover.openings_time_ms` |  697 |  1,394 |  881 |  513 |
| `prover.rap_constraints.logup_gkr_time_ms` |  543.50 |  1,087 |  587 |  500 |
| `prover.rap_constraints.round0_time_ms` |  1,011.50 |  2,023 |  1,314 |  709 |
| `prover.rap_constraints.mle_rounds_time_ms` |  374 |  748 |  482 |  266 |
...
| `prover.openings.whir_time_ms` |  534.50 |  1,069 |  672 |  397 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  988 |  988 |  988 |  988 |
| `execute_preflight_time_ms` |  2 |  2 |  2 |  2 |
| `trace_gen_time_ms   ` |  106 |  106 |  106 |  106 |
| `generate_blob_total_time_ms` |  17 |  17 |  17 |  17 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  881 |  881 |  881 |  881 |
| `prover.main_trace_commit_time_ms` |  369 |  369 |  369 |  369 |
| `prover.rap_constraints_time_ms` |  223 |  223 |  223 |  223 |
| `prover.openings_time_ms` |  288 |  288 |  288 |  288 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/f01cd17abdbf6b6d4933d3206f84a4bcd52dfd36/sha2_bench-f01cd17abdbf6b6d4933d3206f84a4bcd52dfd36.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 74 |  |  |  | 365 |  |  |  |  |  |  | 
| app_proof |  |  |  | 2,972 |  | 99 | 11,167,961 | 112.14 | 0 | 8,186 |  | 
...
| app_proof | VmAirWrapper<Rv64LoadStoreAdapterAir, LoadStoreCoreAir<8> | 14 | VmAirWrapper<Rv64LoadStoreAdapterAir, LoadStoreCoreAir<8> | 0 | 117,267,416 | 
...
| app_proof | VmAirWrapper<Rv64LoadStoreAdapterAir, LoadStoreCoreAir<8> | 14 | VmAirWrapper<Rv64LoadStoreAdapterAir, LoadStoreCoreAir<8> | 1 | 66,558,576 | 
...
| internal_recursive.0 | 1 | 10 | 179 | 10 | 1 | 0 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 9 | 146 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 106 | 988 | 106 | 34 | 17 | 2 | 7 | 7 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 327 | 116 | 0 | 0 | 106 | 35 | 34 | 50 | 20 | 0 | 104 | 90 | 13 | 3 | 9 | 116 | 116 | 106 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 168 | 46 | 0 | 0 | 67 | 24 | 24 | 28 | 14 | 0 | 54 | 45 | 8 | 1 | 6 | 46 | 46 | 67 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 137 | 32 | 0 | 0 | 61 | 22 | 21 | 25 | 14 | 0 | 42 | 35 | 7 | 1 | 5 | 32 | 32 | 61 | 0 | 2 | 13 | 0 | 0 | 
| leaf | 0 | prover | 237,896,248 | 881 | 369 | 0 | 0 | 223 | 105 | 104 | 67 | 51 | 0 | 288 | 251 | 36 | 19 | 16 | 369 | 369 | 223 | 0 | 9 | 49 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,288,077,561 | 4,586 | 1,319 | 0 | 0 | 2,384 | 1,314 | 1,314 | 482 | 587 | 0 | 881 | 672 | 209 | 130 | 78 | 1,319 | 1,319 | 2,384 | 0 | 4 | 586 | 0 | 0 | 
| app_proof | prover | 1 | 751,206,644 | 2,573 | 582 | 0 | 0 | 1,476 | 709 | 708 | 266 | 500 | 0 | 513 | 397 | 116 | 70 | 45 | 582 | 582 | 1,476 | 0 | 4 | 499 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 134 | 1 | 170 | 5,109 | 170 | 134 | 13,329,494,472 | 2,141,911,524 | 15,471,405,996 | 2,097,152 | 0 | 3 | 216 | 7,124,000 | 35.94 | 
| app_proof | 1 | 41 | 1 | 72 | 2,972 | 72 | 41 | 7,598,498,184 | 1,557,865,504 | 9,156,363,688 | 2,097,152 | 0 | 2 | 284 | 4,043,961 | 39.54 | 

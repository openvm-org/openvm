...
| `total_proof_time_ms ` |  762.50 |  1,525 |  853 |  672 |
...
| `execute_metered_insn_mi/s` |  19.21 | -          |  19.21 |  19.21 |
| `execute_preflight_insns` |  872,871 |  1,745,742 |  1,157,000 |  588,742 |
| `execute_preflight_time_ms` |  93.50 |  187 |  128 |  59 |
| `execute_preflight_insn_mi/s` |  13.78 | -          |  18.29 |  9.28 |
| `trace_gen_time_ms   ` |  178 |  356 |  193 |  163 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  398 |  796 |  418 |  378 |
| `main_trace_commit_time_ms` |  65.50 |  131 |  76 |  55 |
| `generate_perm_trace_time_ms` |  55 |  110 |  71 |  39 |
| `perm_trace_commit_time_ms` |  77.27 |  154.54 |  89.46 |  65.08 |
| `quotient_poly_compute_time_ms` |  78.43 |  156.86 |  86.90 |  69.96 |
| `quotient_poly_commit_time_ms` |  16.69 |  33.38 |  18.91 |  14.47 |
| `pcs_opening_time_ms ` |  100 |  200 |  103 |  97 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 672 | 40 | 1 | 90 | 1,745,742 | 19.21 | 145 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 163 | 853 | 32,689,110 | 172,558,444 | 163 | 418 | 0 | 86.90 | 18.91 | 6 | 89.46 | 103 | 131 | 103 | 1 | 76 | 16,059,916 | 39 | 128 | 1,157,000 | 9.28 | 26 | 106 | 1 | 103 | 
| pairing | 1 | 193 | 672 | 22,314,288 | 119,958,502 | 193 | 378 | 1 | 69.96 | 14.47 | 6 | 65.08 | 97 | 139 | 97 | 0 | 55 | 9,408,294 | 71 | 59 | 588,742 | 18.29 | 20 | 85 | 1 | 97 | 

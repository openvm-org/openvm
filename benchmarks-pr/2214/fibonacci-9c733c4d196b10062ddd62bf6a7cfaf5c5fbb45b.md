...
| `total_proof_time_ms ` |  489 |  978 |  553 |  425 |
...
| `execute_metered_insn_mi/s` |  117.82 | -          |  117.82 |  117.82 |
| `execute_preflight_insns` |  750,104.50 |  1,500,209 |  873,000 |  627,209 |
| `execute_preflight_time_ms` |  28.50 |  57 |  32 |  25 |
| `execute_preflight_insn_mi/s` |  38.17 | -          |  40.29 |  36.05 |
| `trace_gen_time_ms   ` |  191.50 |  383 |  197 |  186 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  177 |  354 |  190 |  164 |
| `main_trace_commit_time_ms` |  30.50 |  61 |  33 |  28 |
| `generate_perm_trace_time_ms` |  14.50 |  29 |  16 |  13 |
| `perm_trace_commit_time_ms` |  42.05 |  84.09 |  44.02 |  40.07 |
| `quotient_poly_compute_time_ms` |  30.65 |  61.30 |  32.70 |  28.59 |
| `quotient_poly_commit_time_ms` |  12.32 |  24.64 |  12.66 |  11.98 |
| `pcs_opening_time_ms ` |  44.50 |  89 |  49 |  40 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 425 | 40 | 1 | 12 | 1,500,209 | 117.82 | 138 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 197 | 553 | 9,677,708 | 84,395,212 | 197 | 190 | 0 | 32.70 | 12.66 | 4 | 44.02 | 49 | 61 | 49 | 0 | 33 | 1,035,986 | 16 | 25 | 873,000 | 36.05 | 14 | 45 | 0 | 49 | 
| fibonacci_program | 1 | 186 | 425 | 9,708,170 | 74,305,770 | 186 | 164 | 1 | 28.59 | 11.98 | 4 | 40.07 | 40 | 53 | 40 | 0 | 28 | 1,064,416 | 13 | 32 | 627,209 | 40.29 | 11 | 40 | 0 | 40 | 

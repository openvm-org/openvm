...
| `total_proof_time_ms ` |  591.75 |  2,367 |  744 |  536 |
...
| `execute_preflight_time_ms` |  54 |  216 |  65 |  45 |
| `execute_preflight_insn_mi/s` |  30.65 | -          |  32.27 |  28.35 |
| `trace_gen_time_ms   ` |  177.75 |  711 |  211 |  156 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  292.50 |  1,170 |  344 |  269 |
| `main_trace_commit_time_ms` |  52 |  208 |  56 |  50 |
| `generate_perm_trace_time_ms` |  34.75 |  139 |  55 |  19 |
| `perm_trace_commit_time_ms` |  63.85 |  255.41 |  69.60 |  55.97 |
| `quotient_poly_compute_time_ms` |  58.15 |  232.61 |  69.13 |  51.45 |
| `quotient_poly_commit_time_ms` |  14.91 |  59.64 |  17.78 |  12.92 |
| `pcs_opening_time_ms ` |  66 |  264 |  83 |  57 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 540 | 66 | 1 | 38 | 4,137,502 | 106.44 | 194 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 211 | 744 | 23,446,148 | 150,778,428 | 211 | 344 | 0 | 59.78 | 17.78 | 5 | 69.60 | 83 | 126 | 83 | 4 | 56 | 10,899,170 | 55 | 45 | 1,103,000 | 28.35 | 21 | 78 | 1 | 83 | 
| regex_program | 1 | 156 | 547 | 11,598,276 | 128,513,066 | 156 | 284 | 1 | 51.45 | 14.48 | 4 | 65.10 | 62 | 104 | 62 | 0 | 50 | 2,196,106 | 38 | 65 | 1,104,000 | 32.27 | 16 | 66 | 0 | 62 | 
| regex_program | 2 | 161 | 536 | 11,579,064 | 128,513,066 | 161 | 273 | 1 | 52.25 | 14.45 | 4 | 64.74 | 62 | 92 | 61 | 0 | 51 | 2,177,334 | 27 | 60 | 1,104,000 | 30.35 | 16 | 67 | 0 | 61 | 
| regex_program | 3 | 183 | 540 | 11,853,872 | 103,456,394 | 183 | 269 | 0 | 69.13 | 12.92 | 5 | 55.97 | 57 | 78 | 57 | 0 | 51 | 2,422,606 | 19 | 46 | 826,502 | 31.64 | 18 | 83 | 1 | 57 | 
...
Commit: https://github.com/openvm-org/openvm/commit/9c733c4d196b10062ddd62bf6a7cfaf5c5fbb45b
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19241307442)

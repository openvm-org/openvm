...
| `execute_metered_insn_mi/s` |  67.79 | -          |  67.79 |  67.79 |
| `execute_e3_time_ms  ` |  121.50 |  243 |  137 |  106 |
| `execute_e3_insn_mi/s` |  17.12 | -          |  17.97 |  16.26 |
| `memory_finalize_time_ms` |  6.50 |  13 |  11 |  2 |
| `boundary_finalize_time_ms` |  2 |  4 |  4 |  0 |
| `merkle_finalize_time_ms` |  154.50 |  309 |  240 |  69 |
| `stark_prove_excluding_trace_time_ms` |  2,631.50 |  5,263 |  2,849 |  2,414 |
| `main_trace_commit_time_ms` |  524.50 |  1,049 |  581 |  468 |
| `generate_perm_trace_time_ms` |  218 |  436 |  229 |  207 |
| `perm_trace_commit_time_ms` |  557.50 |  1,115 |  595 |  520 |
| `quotient_poly_compute_time_ms` |  273.50 |  547 |  301 |  246 |
| `quotient_poly_commit_time_ms` |  251 |  502 |  295 |  207 |
| `pcs_opening_time_ms ` |  800 |  1,600 |  843 |  757 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 4,020 | 24 | 4,165,433 | 1 | 61 | 67.79 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 520 | 275,648,700 | 2,849 | 301 | 295 | 595 | 843 | 240 | 26 | 11 | 581 | 2,243,700 | 229 | 137 | 16.26 | 4 | 
| regex_program | 1 | 300 | 242,975,370 | 2,414 | 246 | 207 | 520 | 757 | 69 | 25 | 2 | 468 | 1,921,733 | 207 | 106 | 17.97 | 0 | 

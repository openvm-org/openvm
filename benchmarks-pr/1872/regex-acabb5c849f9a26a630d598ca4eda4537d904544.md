...
| `execute_metered_insn_mi/s` |  68.06 | -          |  68.06 |  68.06 |
| `execute_e3_time_ms  ` |  121.50 |  243 |  137 |  106 |
| `execute_e3_insn_mi/s` |  17.19 | -          |  18.05 |  16.33 |
| `memory_finalize_time_ms` |  6 |  12 |  10 |  2 |
| `boundary_finalize_time_ms` |  2 |  4 |  4 |  0 |
| `merkle_finalize_time_ms` |  156.50 |  313 |  244 |  69 |
| `stark_prove_excluding_trace_time_ms` |  2,644 |  5,288 |  2,854 |  2,434 |
| `main_trace_commit_time_ms` |  528 |  1,056 |  584 |  472 |
| `generate_perm_trace_time_ms` |  216.50 |  433 |  227 |  206 |
| `perm_trace_commit_time_ms` |  558 |  1,116 |  599 |  517 |
| `quotient_poly_compute_time_ms` |  264.50 |  529 |  285 |  244 |
| `quotient_poly_commit_time_ms` |  240.50 |  481 |  272 |  209 |
| `pcs_opening_time_ms ` |  829 |  1,658 |  882 |  776 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 4,034 | 24 | 4,165,433 | 1 | 61 | 68.06 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 524 | 275,648,700 | 2,854 | 285 | 272 | 599 | 882 | 244 | 29 | 10 | 584 | 2,243,700 | 227 | 137 | 16.33 | 4 | 
| regex_program | 1 | 299 | 242,975,370 | 2,434 | 244 | 209 | 517 | 776 | 69 | 25 | 2 | 472 | 1,921,733 | 206 | 106 | 18.05 | 0 | 

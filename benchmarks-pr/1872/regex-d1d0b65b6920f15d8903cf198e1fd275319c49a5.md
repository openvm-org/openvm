...
| `execute_e3_time_ms  ` |  122 |  244 |  137 |  107 |
| `execute_e3_insn_mi/s` |  17.10 | -          |  17.95 |  16.26 |
| `memory_finalize_time_ms` |  6.50 |  13 |  11 |  2 |
| `boundary_finalize_time_ms` |  2 |  4 |  4 |  0 |
| `merkle_finalize_time_ms` |  155 |  310 |  242 |  68 |
| `stark_prove_excluding_trace_time_ms` |  2,625.50 |  5,251 |  2,840 |  2,411 |
| `main_trace_commit_time_ms` |  522.50 |  1,045 |  577 |  468 |
| `generate_perm_trace_time_ms` |  210 |  420 |  228 |  192 |
| `perm_trace_commit_time_ms` |  559.50 |  1,119 |  600 |  519 |
| `quotient_poly_compute_time_ms` |  260 |  520 |  283 |  237 |
| `quotient_poly_commit_time_ms` |  245 |  490 |  276 |  214 |
| `pcs_opening_time_ms ` |  820.50 |  1,641 |  871 |  770 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 4,036 | 24 | 4,165,433 | 1 | 61 | 67.62 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 520 | 275,648,700 | 2,840 | 283 | 276 | 600 | 871 | 242 | 25 | 11 | 577 | 2,243,700 | 228 | 137 | 16.26 | 4 | 
| regex_program | 1 | 295 | 242,975,370 | 2,411 | 237 | 214 | 519 | 770 | 68 | 24 | 2 | 468 | 1,921,733 | 192 | 107 | 17.95 | 0 | 

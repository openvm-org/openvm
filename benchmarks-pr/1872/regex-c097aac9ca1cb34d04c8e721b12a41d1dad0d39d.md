...
| `execute_metered_insn_mi/s` |  67.62 | -          |  67.62 |  67.62 |
| `execute_e3_time_ms  ` |  122 |  244 |  138 |  106 |
| `execute_e3_insn_mi/s` |  17.15 | -          |  18.04 |  16.25 |
| `memory_finalize_time_ms` |  6.50 |  13 |  10 |  3 |
| `boundary_finalize_time_ms` |  2 |  4 |  4 |  0 |
| `merkle_finalize_time_ms` |  155.50 |  311 |  240 |  71 |
| `stark_prove_excluding_trace_time_ms` |  2,614 |  5,228 |  2,819 |  2,409 |
| `main_trace_commit_time_ms` |  528 |  1,056 |  586 |  470 |
| `generate_perm_trace_time_ms` |  213 |  426 |  227 |  199 |
| `perm_trace_commit_time_ms` |  561.50 |  1,123 |  597 |  526 |
| `quotient_poly_compute_time_ms` |  263 |  526 |  285 |  241 |
| `quotient_poly_commit_time_ms` |  237 |  474 |  270 |  204 |
| `pcs_opening_time_ms ` |  803.50 |  1,607 |  848 |  759 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 4,037 | 24 | 4,165,433 | 1 | 61 | 67.62 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 522 | 275,648,700 | 2,819 | 285 | 270 | 597 | 848 | 240 | 25 | 10 | 586 | 2,243,700 | 227 | 138 | 16.25 | 4 | 
| regex_program | 1 | 304 | 242,975,370 | 2,409 | 241 | 204 | 526 | 759 | 71 | 28 | 3 | 470 | 1,921,733 | 199 | 106 | 18.04 | 0 | 

...
| `execute_metered_insn_mi/s` |  67.52 | -          |  67.52 |  67.52 |
| `execute_e3_time_ms  ` |  121.50 |  243 |  137 |  106 |
| `execute_e3_insn_mi/s` |  17.18 | -          |  18.10 |  16.26 |
| `memory_finalize_time_ms` |  8 |  16 |  14 |  2 |
| `boundary_finalize_time_ms` |  2 |  4 |  4 |  0 |
| `merkle_finalize_time_ms` |  156 |  312 |  244 |  68 |
| `stark_prove_excluding_trace_time_ms` |  2,645.50 |  5,291 |  2,866 |  2,425 |
| `main_trace_commit_time_ms` |  524.50 |  1,049 |  580 |  469 |
| `generate_perm_trace_time_ms` |  216.50 |  433 |  237 |  196 |
| `perm_trace_commit_time_ms` |  556.50 |  1,113 |  598 |  515 |
| `quotient_poly_compute_time_ms` |  272 |  544 |  288 |  256 |
| `quotient_poly_commit_time_ms` |  246 |  492 |  286 |  206 |
| `pcs_opening_time_ms ` |  822 |  1,644 |  873 |  771 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 4,041 | 24 | 4,165,433 | 1 | 61 | 67.52 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 539 | 275,648,700 | 2,866 | 288 | 286 | 598 | 873 | 244 | 26 | 14 | 580 | 2,243,700 | 237 | 137 | 16.26 | 4 | 
| regex_program | 1 | 309 | 242,975,370 | 2,425 | 256 | 206 | 515 | 771 | 68 | 24 | 2 | 469 | 1,921,733 | 196 | 106 | 18.10 | 0 | 

...
| `execute_metered_insn_mi/s` |  67.60 | -          |  67.60 |  67.60 |
| `execute_e3_time_ms  ` |  122 |  244 |  138 |  106 |
| `execute_e3_insn_mi/s` |  17.12 | -          |  18.03 |  16.22 |
| `memory_finalize_time_ms` |  6.50 |  13 |  11 |  2 |
| `boundary_finalize_time_ms` |  2 |  4 |  4 |  0 |
| `merkle_finalize_time_ms` |  156.50 |  313 |  245 |  68 |
| `stark_prove_excluding_trace_time_ms` |  2,627.50 |  5,255 |  2,854 |  2,401 |
| `main_trace_commit_time_ms` |  519.50 |  1,039 |  576 |  463 |
| `generate_perm_trace_time_ms` |  211.50 |  423 |  226 |  197 |
| `perm_trace_commit_time_ms` |  571.50 |  1,143 |  626 |  517 |
| `quotient_poly_compute_time_ms` |  275 |  550 |  292 |  258 |
| `quotient_poly_commit_time_ms` |  242.50 |  485 |  279 |  206 |
| `pcs_opening_time_ms ` |  801 |  1,602 |  850 |  752 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 3,996 | 24 | 4,165,433 | 1 | 61 | 67.60 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 517 | 275,648,700 | 2,854 | 292 | 279 | 626 | 850 | 245 | 25 | 11 | 576 | 2,243,700 | 226 | 138 | 16.22 | 4 | 
| regex_program | 1 | 290 | 242,975,370 | 2,401 | 258 | 206 | 517 | 752 | 68 | 24 | 2 | 463 | 1,921,733 | 197 | 106 | 18.03 | 0 | 

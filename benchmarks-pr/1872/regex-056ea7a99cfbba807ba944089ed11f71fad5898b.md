...
| `execute_metered_insn_mi/s` |  65.72 | -          |  65.72 |  65.72 |
| `execute_e3_time_ms  ` |  122 |  244 |  138 |  106 |
| `execute_e3_insn_mi/s` |  17.07 | -          |  17.96 |  16.19 |
| `memory_finalize_time_ms` |  7 |  14 |  12 |  2 |
| `boundary_finalize_time_ms` |  2 |  4 |  4 |  0 |
| `merkle_finalize_time_ms` |  157.50 |  315 |  247 |  68 |
| `stark_prove_excluding_trace_time_ms` |  2,619.50 |  5,239 |  2,834 |  2,405 |
| `main_trace_commit_time_ms` |  517 |  1,034 |  571 |  463 |
| `generate_perm_trace_time_ms` |  217 |  434 |  233 |  201 |
| `perm_trace_commit_time_ms` |  557 |  1,114 |  598 |  516 |
| `quotient_poly_compute_time_ms` |  269 |  538 |  297 |  241 |
| `quotient_poly_commit_time_ms` |  240.50 |  481 |  275 |  206 |
| `pcs_opening_time_ms ` |  812.50 |  1,625 |  855 |  770 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 3,999 | 24 | 4,165,433 | 1 | 63 | 65.72 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 524 | 275,648,700 | 2,834 | 297 | 275 | 598 | 855 | 247 | 25 | 12 | 571 | 2,243,700 | 233 | 138 | 16.19 | 4 | 
| regex_program | 1 | 297 | 242,975,370 | 2,405 | 241 | 206 | 516 | 770 | 68 | 25 | 2 | 463 | 1,921,733 | 201 | 106 | 17.96 | 0 | 

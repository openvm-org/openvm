...
|:---|---:|---:|---:|
| Total |  5.39 |  3.79 |  3.79 |
| app_proof |  3.88 |  2.28 |  2.28 |
| leaf |  0.95 |  0.95 |  0.95 |
...
| `total_proof_time_ms ` |  1,925 |  3,850 |  2,246 |  1,604 |
...
| `execute_preflight_time_ms` |  99.50 |  199 |  136 |  63 |
| `execute_preflight_insn_mi/s` |  35.72 | -          |  36.63 |  34.82 |
| `trace_gen_time_ms   ` |  138 |  276 |  184 |  92 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,576.50 |  3,153 |  1,819 |  1,334 |
| `prover.main_trace_commit_time_ms` |  512.50 |  1,025 |  598 |  427 |
| `prover.rap_constraints_time_ms` |  934.50 |  1,869 |  1,084 |  785 |
| `prover.openings_time_ms` |  127.50 |  255 |  135 |  120 |
| `prover.rap_constraints.logup_gkr_time_ms` |  171 |  342 |  206 |  136 |
| `prover.rap_constraints.round0_time_ms` |  561 |  1,122 |  665 |  457 |
| `prover.rap_constraints.mle_rounds_time_ms` |  201 |  402 |  212 |  190 |
| `prover.openings.stacked_reduction_time_ms` |  92.50 |  185 |  100 |  85 |
| `prover.openings.stacked_reduction.round0_time_ms` |  49.50 |  99 |  50 |  49 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  42 |  84 |  49 |  35 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/af9a5fad837c882e624fb0828ae7321483f5e6fb/kitchen_sink-af9a5fad837c882e624fb0828ae7321483f5e6fb.memory.svg)
...
| app_proof |  |  |  |  |  | 1,604 |  |  | 34 | 2,579,903 | 74.15 | 0 | 3,890 |  | 
...
| leaf | 0 | 124 | 948 | 123 | 25 | 11 | 21 | 5 | 5 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,577,979 | 257 | 116 | 0 | 0 | 108 | 36 | 35 | 51 | 20 | 0 | 32 | 18 | 13 | 3 | 9 | 116 | 108 | 0 | 2 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,767 | 145 | 46 | 0 | 0 | 68 | 25 | 25 | 28 | 13 | 0 | 30 | 21 | 8 | 1 | 6 | 46 | 68 | 0 | 3 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 118 | 31 | 0 | 0 | 62 | 23 | 23 | 23 | 14 | 0 | 24 | 17 | 7 | 1 | 5 | 31 | 62 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 265,003,892 | 824 | 400 | 0 | 1 | 346 | 133 | 132 | 77 | 135 | 0 | 76 | 36 | 40 | 21 | 18 | 401 | 346 | 0 | 6 | 134 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 567,917,156 | 1,819 | 598 | 0 | 190 | 1,084 | 665 | 664 | 212 | 206 | 66 | 135 | 34 | 100 | 50 | 49 | 598 | 1,084 | 0 | 3 | 139 | 0 | 0 | 
| app_proof | prover | 1 | 537,266,124 | 1,334 | 427 | 0 | 1 | 785 | 457 | 457 | 190 | 136 | 0 | 120 | 35 | 85 | 49 | 35 | 427 | 785 | 0 | 4 | 135 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 184 | 2,246 | 184 | 180 | 0 | 4 | 63 | 1,540,000 | 34.82 | 
| app_proof | 1 | 92 | 1,604 | 92 | 41 | 0 | 2 | 136 | 1,039,903 | 36.63 | 

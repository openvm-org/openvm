...
|:---|---:|---:|---:|
| Total |  12.78 |  3.65 |  3.65 |
| app_proof |  10.54 |  1.90 |  1.90 |
| leaf |  1.48 |  0.98 |  0.98 |
...
| `total_proof_time_ms ` |  1,733 |  10,398 |  1,764 |  1,681 |
| `compile_metered_time_ms` |  3 |  3 |  3 |  3 |
| `execute_metered_time_ms` |  138 | -          | -          | -          |
| `execute_metered_insns` |  14,793,960 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  107.02 | -          |  107.02 |  107.02 |
| `execute_preflight_insns` |  2,465,660 |  14,793,960 |  2,625,000 |  1,670,960 |
| `execute_preflight_time_ms` |  124.33 |  746 |  159 |  85 |
| `execute_preflight_insn_mi/s` |  40.56 | -          |  41.37 |  39.09 |
| `trace_gen_time_ms   ` |  166.50 |  999 |  199 |  139 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,301.50 |  7,809 |  1,327 |  1,263 |
| `prover.main_trace_commit_time_ms` |  290 |  1,740 |  291 |  289 |
| `prover.rap_constraints_time_ms` |  922.50 |  5,535 |  948 |  882 |
| `prover.openings_time_ms` |  88 |  528 |  91 |  83 |
| `prover.rap_constraints.logup_gkr_time_ms` |  296.83 |  1,781 |  312 |  246 |
| `prover.rap_constraints.round0_time_ms` |  451.83 |  2,711 |  467 |  394 |
| `prover.rap_constraints.mle_rounds_time_ms` |  172.83 |  1,037 |  175 |  167 |
| `prover.openings.stacked_reduction_time_ms` |  55.50 |  333 |  56 |  54 |
...
| `prover.openings.whir_time_ms` |  31.83 |  191 |  36 |  28 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  742 |  1,484 |  984 |  500 |
| `execute_preflight_time_ms` |  2 |  4 |  2 |  2 |
| `trace_gen_time_ms   ` |  76 |  152 |  102 |  50 |
| `generate_blob_total_time_ms` |  9.50 |  19 |  13 |  6 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  665 |  1,330 |  881 |  449 |
| `prover.main_trace_commit_time_ms` |  368.50 |  737 |  512 |  225 |
| `prover.rap_constraints_time_ms` |  227.50 |  455 |  289 |  166 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/6950753b5334fa13928a17bfa411a007819a9d44/sha2_bench-6950753b5334fa13928a17bfa411a007819a9d44.memory.svg)
...
| app_proof |  |  |  |  |  | 1,724 |  |  | 138 | 14,793,960 | 107.02 | 0 | 10,543 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 30 | 469 | 30 | 10 | 2 | 2 | 1 | 1 | 
| internal_recursive.0 | 1 | 13 | 162 | 12 | 2 | 1 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 9 | 128 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 102 | 984 | 102 | 37 | 13 | 2 | 3 | 3 | 
| leaf | 1 | 50 | 500 | 50 | 19 | 6 | 2 | 3 | 3 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 75,647,860 | 438 | 229 | 0 | 1 | 166 | 46 | 46 | 88 | 30 | 0 | 42 | 20 | 22 | 7 | 15 | 229 | 166 | 0 | 3 | 29 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,879 | 149 | 49 | 0 | 0 | 74 | 26 | 25 | 29 | 18 | 0 | 25 | 16 | 8 | 2 | 6 | 49 | 74 | 0 | 2 | 17 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 118 | 32 | 0 | 0 | 62 | 23 | 22 | 24 | 14 | 0 | 23 | 16 | 7 | 1 | 5 | 32 | 62 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 266,560,230 | 881 | 512 | 0 | 97 | 289 | 134 | 133 | 80 | 74 | 0 | 79 | 37 | 41 | 22 | 18 | 512 | 289 | 0 | 6 | 74 | 0 | 0 | 
| leaf | 1 | prover | 135,246,516 | 449 | 224 | 0 | 1 | 166 | 72 | 71 | 47 | 46 | 0 | 56 | 33 | 22 | 11 | 11 | 225 | 166 | 0 | 6 | 45 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 353,899,717 | 1,263 | 290 | 0 | 1 | 882 | 394 | 394 | 174 | 312 | 77 | 89 | 33 | 56 | 32 | 23 | 290 | 882 | 0 | 4 | 234 | 0 | 0 | 
| app_proof | prover | 1 | 353,899,532 | 1,325 | 289 | 0 | 1 | 948 | 465 | 465 | 174 | 308 | 79 | 87 | 30 | 56 | 33 | 22 | 289 | 948 | 0 | 3 | 227 | 0 | 0 | 
| app_proof | prover | 2 | 353,899,532 | 1,325 | 289 | 0 | 1 | 944 | 464 | 464 | 173 | 306 | 78 | 91 | 36 | 55 | 33 | 22 | 289 | 944 | 0 | 3 | 227 | 0 | 0 | 
| app_proof | prover | 3 | 353,899,532 | 1,268 | 290 | 0 | 1 | 889 | 467 | 467 | 175 | 246 | 0 | 88 | 31 | 56 | 32 | 23 | 291 | 889 | 0 | 4 | 246 | 0 | 0 | 
| app_proof | prover | 4 | 353,899,532 | 1,327 | 291 | 0 | 1 | 945 | 465 | 464 | 174 | 306 | 77 | 90 | 33 | 56 | 32 | 23 | 291 | 945 | 0 | 4 | 228 | 0 | 0 | 
| app_proof | prover | 5 | 353,980,012 | 1,301 | 290 | 0 | 1 | 927 | 456 | 456 | 167 | 303 | 76 | 83 | 28 | 54 | 32 | 21 | 290 | 927 | 0 | 4 | 226 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 171 | 1,681 | 171 | 161 | 0 | 3 | 85 | 2,623,000 | 39.09 | 
| app_proof | 1 | 139 | 1,764 | 139 | 139 | 0 | 2 | 159 | 2,625,000 | 40.45 | 
| app_proof | 2 | 163 | 1,762 | 163 | 134 | 0 | 2 | 138 | 2,625,000 | 40.35 | 
| app_proof | 3 | 163 | 1,706 | 163 | 137 | 0 | 2 | 137 | 2,625,000 | 40.81 | 
| app_proof | 4 | 164 | 1,761 | 164 | 131 | 0 | 2 | 136 | 2,625,000 | 41.37 | 
| app_proof | 5 | 199 | 1,724 | 199 | 131 | 0 | 2 | 91 | 1,670,960 | 41.30 | 

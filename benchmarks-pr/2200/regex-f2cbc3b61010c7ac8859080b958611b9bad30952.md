...
| `total_proof_time_ms ` |  583.25 |  2,333 |  702 |  538 |
...
| `execute_preflight_insn_mi/s` |  31.09 | -          |  32.38 |  27.98 |
| `trace_gen_time_ms   ` |  177.50 |  710 |  211 |  154 |
| `memory_finalize_time_ms` |  0.75 |  3 |  3 |  0 |
| `stark_prove_excluding_trace_time_ms` |  284 |  1,136 |  299 |  275 |
| `main_trace_commit_time_ms` |  51.75 |  207 |  56 |  50 |
| `generate_perm_trace_time_ms` |  25.75 |  103 |  36 |  19 |
| `perm_trace_commit_time_ms` |  64.66 |  258.64 |  70.41 |  56.05 |
| `quotient_poly_compute_time_ms` |  57.94 |  231.77 |  68.100 |  51.57 |
| `quotient_poly_commit_time_ms` |  15 |  60 |  17.13 |  12.69 |
| `pcs_opening_time_ms ` |  66.50 |  266 |  73 |  58 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 545 | 41 | 1 | 35 | 4,137,502 | 117.08 | 168 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 211 | 702 | 23,446,148 | 150,778,428 | 211 | 299 | 0 | 59.62 | 17.13 | 5 | 70.41 | 58 | 107 | 57 | 3 | 56 | 10,899,170 | 36 | 46 | 1,103,000 | 27.98 | 21 | 77 | 1 | 57 | 
| regex_program | 1 | 154 | 538 | 11,598,276 | 128,513,066 | 154 | 276 | 1 | 51.57 | 14.53 | 4 | 65.95 | 72 | 87 | 71 | 0 | 50 | 2,196,106 | 20 | 66 | 1,104,000 | 31.89 | 16 | 66 | 0 | 71 | 
| regex_program | 2 | 162 | 548 | 11,579,064 | 128,513,066 | 162 | 286 | 1 | 51.58 | 15.65 | 4 | 66.23 | 73 | 94 | 73 | 0 | 50 | 2,177,334 | 28 | 58 | 1,104,000 | 32.09 | 17 | 67 | 0 | 73 | 
| regex_program | 3 | 183 | 545 | 11,853,872 | 103,456,394 | 183 | 275 | 0 | 68.100 | 12.69 | 5 | 56.05 | 63 | 78 | 62 | 0 | 51 | 2,422,606 | 19 | 45 | 826,502 | 32.38 | 18 | 82 | 1 | 62 | 
...
Commit: https://github.com/openvm-org/openvm/commit/f2cbc3b61010c7ac8859080b958611b9bad30952
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19120201403)

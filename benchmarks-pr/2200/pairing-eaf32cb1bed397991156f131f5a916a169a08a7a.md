...
| `total_proof_time_ms ` |  719 |  1,438 |  843 |  595 |
...
| `execute_preflight_insn_mi/s` |  13.25 | -          |  17.55 |  8.95 |
| `trace_gen_time_ms   ` |  177.50 |  355 |  194 |  161 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  351.50 |  703 |  405 |  298 |
| `main_trace_commit_time_ms` |  65.50 |  131 |  76 |  55 |
| `generate_perm_trace_time_ms` |  39.50 |  79 |  49 |  30 |
| `perm_trace_commit_time_ms` |  77.55 |  155.11 |  89.30 |  65.80 |
| `quotient_poly_compute_time_ms` |  79.12 |  158.24 |  86.94 |  71.30 |
| `quotient_poly_commit_time_ms` |  16.76 |  33.52 |  18.74 |  14.78 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 595 | 41 | 1 | 90 | 1,745,742 | 19.20 | 147 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 161 | 843 | 32,689,110 | 172,558,444 | 161 | 405 | 0 | 86.94 | 18.74 | 6 | 89.30 | 80 | 141 | 80 | 1 | 76 | 16,059,916 | 49 | 133 | 1,157,000 | 8.95 | 27 | 106 | 1 | 80 | 
| pairing | 1 | 194 | 595 | 22,314,288 | 119,958,502 | 194 | 298 | 1 | 71.30 | 14.78 | 6 | 65.80 | 55 | 100 | 55 | 0 | 55 | 9,408,294 | 30 | 61 | 588,742 | 17.55 | 21 | 86 | 1 | 55 | 

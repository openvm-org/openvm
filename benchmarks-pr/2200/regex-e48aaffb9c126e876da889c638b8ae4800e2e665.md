...
| `total_proof_time_ms ` |  578 |  2,312 |  692 |  537 |
...
| `execute_preflight_insn_mi/s` |  31.98 | -          |  33.12 |  28.79 |
| `trace_gen_time_ms   ` |  176 |  704 |  208 |  154 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  282 |  1,128 |  295 |  273 |
| `main_trace_commit_time_ms` |  51 |  204 |  57 |  49 |
| `generate_perm_trace_time_ms` |  22.25 |  89 |  28 |  19 |
| `perm_trace_commit_time_ms` |  64.45 |  257.79 |  70.22 |  55.22 |
| `quotient_poly_compute_time_ms` |  57.47 |  229.87 |  69.23 |  50.72 |
| `quotient_poly_commit_time_ms` |  15.16 |  60.66 |  17.78 |  12.72 |
| `pcs_opening_time_ms ` |  68.50 |  274 |  73 |  62 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 540 | 40 | 1 | 39 | 4,137,502 | 105.91 | 166 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 208 | 692 | 23,446,148 | 150,778,428 | 208 | 295 | 0 | 58.82 | 17.78 | 5 | 70.22 | 67 | 93 | 67 | 4 | 57 | 10,899,170 | 22 | 44 | 1,103,000 | 28.79 | 21 | 77 | 1 | 67 | 
| regex_program | 1 | 154 | 537 | 11,598,276 | 128,513,066 | 154 | 276 | 1 | 51.10 | 14.82 | 4 | 66.40 | 72 | 87 | 72 | 0 | 49 | 2,196,106 | 20 | 64 | 1,104,000 | 32.94 | 16 | 66 | 0 | 72 | 
| regex_program | 2 | 161 | 543 | 11,579,064 | 128,513,066 | 161 | 284 | 1 | 50.72 | 15.34 | 4 | 65.95 | 73 | 94 | 73 | 0 | 49 | 2,177,334 | 28 | 57 | 1,104,000 | 33.12 | 17 | 66 | 0 | 73 | 
| regex_program | 3 | 181 | 540 | 11,853,872 | 103,456,394 | 181 | 273 | 0 | 69.23 | 12.72 | 5 | 55.22 | 62 | 77 | 62 | 0 | 49 | 2,422,606 | 19 | 45 | 826,502 | 33.09 | 19 | 82 | 1 | 62 | 

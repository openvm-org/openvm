...
| `total_proof_time_ms ` |  497 |  994 |  558 |  436 |
...
| `execute_metered_insn_mi/s` |  128.31 | -          |  128.31 |  128.31 |
| `execute_preflight_insns` |  750,104.50 |  1,500,209 |  873,000 |  627,209 |
| `execute_preflight_time_ms` |  28.50 |  57 |  32 |  25 |
| `execute_preflight_insn_mi/s` |  37.59 | -          |  39.88 |  35.30 |
| `trace_gen_time_ms   ` |  190.50 |  381 |  194 |  187 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  184.50 |  369 |  193 |  176 |
| `main_trace_commit_time_ms` |  30.50 |  61 |  33 |  28 |
| `generate_perm_trace_time_ms` |  28.50 |  57 |  29 |  28 |
| `perm_trace_commit_time_ms` |  40.68 |  81.36 |  43.71 |  37.65 |
| `quotient_poly_compute_time_ms` |  31.46 |  62.92 |  32.60 |  30.32 |
| `quotient_poly_commit_time_ms` |  12.42 |  24.84 |  12.77 |  12.07 |
| `pcs_opening_time_ms ` |  39 |  78 |  41 |  37 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 436 | 66 | 1 | 11 | 1,500,209 | 128.31 | 165 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 194 | 558 | 9,677,708 | 84,395,212 | 194 | 193 | 0 | 32.60 | 12.77 | 4 | 43.71 | 41 | 72 | 41 | 0 | 33 | 1,035,986 | 28 | 25 | 873,000 | 35.30 | 14 | 45 | 0 | 41 | 
| fibonacci_program | 1 | 187 | 436 | 9,708,170 | 74,305,770 | 187 | 176 | 1 | 30.32 | 12.07 | 4 | 37.65 | 37 | 67 | 37 | 0 | 28 | 1,064,416 | 29 | 32 | 627,209 | 39.88 | 11 | 42 | 0 | 37 | 
...
Commit: https://github.com/openvm-org/openvm/commit/e48aaffb9c126e876da889c638b8ae4800e2e665
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19144963789)

...
| `total_proof_time_ms ` |  726 |  1,452 |  844 |  608 |
...
| `execute_preflight_insn_mi/s` |  13.91 | -          |  18.57 |  9.26 |
| `trace_gen_time_ms   ` |  181 |  362 |  196 |  166 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  357.50 |  715 |  405 |  310 |
| `main_trace_commit_time_ms` |  65 |  130 |  75 |  55 |
| `generate_perm_trace_time_ms` |  41 |  82 |  50 |  32 |
| `perm_trace_commit_time_ms` |  77.72 |  155.45 |  89.87 |  65.58 |
| `quotient_poly_compute_time_ms` |  79.54 |  159.09 |  87.65 |  71.44 |
| `quotient_poly_commit_time_ms` |  16.84 |  33.68 |  18.82 |  14.86 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 608 | 40 | 1 | 90 | 1,745,742 | 19.25 | 145 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 166 | 844 | 32,689,110 | 172,558,444 | 166 | 405 | 0 | 87.65 | 18.82 | 6 | 89.87 | 80 | 142 | 79 | 1 | 75 | 16,059,916 | 50 | 128 | 1,157,000 | 9.26 | 26 | 107 | 1 | 79 | 
| pairing | 1 | 196 | 608 | 22,314,288 | 119,958,502 | 196 | 310 | 1 | 71.44 | 14.86 | 6 | 65.58 | 66 | 101 | 65 | 0 | 55 | 9,408,294 | 32 | 60 | 588,742 | 18.57 | 20 | 86 | 1 | 65 | 

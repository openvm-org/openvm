...
| `total_proof_time_ms ` |  590.50 |  2,362 |  710 |  546 |
...
| `execute_metered_insn_mi/s` |  105.68 | -          |  105.68 |  105.68 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  52.75 |  211 |  65 |  44 |
| `execute_preflight_insn_mi/s` |  31.94 | -          |  32.95 |  29.14 |
| `trace_gen_time_ms   ` |  183.75 |  735 |  218 |  161 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  286.50 |  1,146 |  303 |  279 |
| `main_trace_commit_time_ms` |  52.25 |  209 |  57 |  50 |
| `generate_perm_trace_time_ms` |  23 |  92 |  28 |  20 |
| `perm_trace_commit_time_ms` |  66.73 |  266.91 |  74.45 |  57.03 |
| `quotient_poly_compute_time_ms` |  59.86 |  239.44 |  70.51 |  54.25 |
| `quotient_poly_commit_time_ms` |  15.62 |  62.46 |  17.70 |  12.95 |
| `pcs_opening_time_ms ` |  66 |  264 |  73 |  61 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 554 | 65 | 1 | 39 | 4,137,502 | 105.68 | 190 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 218 | 710 | 23,446,148 | 150,778,428 | 218 | 303 | 0 | 60.09 | 17.70 | 5 | 74.45 | 67 | 99 | 67 | 4 | 57 | 10,899,170 | 24 | 44 | 1,103,000 | 29.14 | 22 | 78 | 1 | 67 | 
| regex_program | 1 | 161 | 552 | 11,598,276 | 128,513,066 | 161 | 285 | 1 | 54.58 | 15.72 | 5 | 67.93 | 73 | 89 | 73 | 0 | 51 | 2,196,106 | 20 | 65 | 1,104,000 | 32.78 | 17 | 70 | 0 | 73 | 
| regex_program | 2 | 168 | 546 | 11,579,064 | 128,513,066 | 168 | 279 | 1 | 54.25 | 16.09 | 4 | 67.51 | 61 | 96 | 61 | 0 | 50 | 2,177,334 | 28 | 57 | 1,104,000 | 32.95 | 17 | 70 | 0 | 61 | 
| regex_program | 3 | 188 | 554 | 11,853,872 | 103,456,394 | 188 | 279 | 0 | 70.51 | 12.95 | 5 | 57.03 | 63 | 80 | 63 | 0 | 51 | 2,422,606 | 20 | 45 | 826,502 | 32.89 | 19 | 84 | 1 | 63 | 
...
Commit: https://github.com/openvm-org/openvm/commit/545b7323748022838f3ead2778a1209f9d46e27f
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19148989700)

...
| `total_proof_time_ms ` |  713.50 |  1,427 |  836 |  591 |
...
| `execute_preflight_insn_mi/s` |  13.66 | -          |  18.19 |  9.13 |
| `trace_gen_time_ms   ` |  178 |  356 |  196 |  160 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  349 |  698 |  404 |  294 |
| `main_trace_commit_time_ms` |  64.50 |  129 |  74 |  55 |
| `generate_perm_trace_time_ms` |  38.50 |  77 |  48 |  29 |
| `perm_trace_commit_time_ms` |  77.40 |  154.80 |  90.18 |  64.62 |
| `quotient_poly_compute_time_ms` |  78.93 |  157.87 |  87.62 |  70.25 |
| `quotient_poly_commit_time_ms` |  16.74 |  33.48 |  19.21 |  14.27 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 591 | 40 | 1 | 90 | 1,745,742 | 19.26 | 147 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 160 | 836 | 32,689,110 | 172,558,444 | 160 | 404 | 0 | 87.62 | 19.21 | 6 | 90.18 | 79 | 141 | 79 | 1 | 74 | 16,059,916 | 48 | 130 | 1,157,000 | 9.13 | 26 | 107 | 1 | 79 | 
| pairing | 1 | 196 | 591 | 22,314,288 | 119,958,502 | 196 | 294 | 1 | 70.25 | 14.27 | 6 | 64.62 | 55 | 97 | 55 | 0 | 55 | 9,408,294 | 29 | 59 | 588,742 | 18.19 | 20 | 85 | 1 | 55 | 

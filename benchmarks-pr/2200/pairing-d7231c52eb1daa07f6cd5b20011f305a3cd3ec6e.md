...
| `total_proof_time_ms ` |  757 |  1,514 |  834 |  680 |
...
| `execute_preflight_time_ms` |  93.50 |  187 |  127 |  60 |
| `execute_preflight_insn_mi/s` |  13.88 | -          |  18.43 |  9.34 |
| `trace_gen_time_ms   ` |  183 |  366 |  198 |  168 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  386.50 |  773 |  394 |  379 |
| `main_trace_commit_time_ms` |  66 |  132 |  76 |  56 |
| `generate_perm_trace_time_ms` |  45 |  90 |  47 |  43 |
| `perm_trace_commit_time_ms` |  78.17 |  156.34 |  91.44 |  64.91 |
| `quotient_poly_compute_time_ms` |  79.59 |  159.19 |  87.82 |  71.37 |
| `quotient_poly_commit_time_ms` |  16.83 |  33.66 |  19.07 |  14.59 |
| `pcs_opening_time_ms ` |  96 |  192 |  120 |  72 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 680 | 40 | 1 | 91 | 1,745,742 | 19.17 | 144 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 168 | 834 | 32,689,110 | 172,558,444 | 168 | 394 | 0 | 87.82 | 19.07 | 6 | 91.44 | 72 | 137 | 72 | 1 | 76 | 16,059,916 | 43 | 127 | 1,157,000 | 9.34 | 27 | 107 | 1 | 72 | 
| pairing | 1 | 198 | 680 | 22,314,288 | 119,958,502 | 198 | 379 | 1 | 71.37 | 14.59 | 6 | 64.91 | 120 | 115 | 120 | 0 | 56 | 9,408,294 | 47 | 60 | 588,742 | 18.43 | 21 | 86 | 1 | 120 | 

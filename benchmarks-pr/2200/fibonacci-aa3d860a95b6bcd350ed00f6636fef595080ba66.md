...
|:---|---:|---:|
| Total |  1.04 |  0.59 |
| fibonacci_program |  1.03 |  0.58 |


| fibonacci_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  513.50 |  1,027 |  576 |  451 |
...
| `execute_metered_insn_mi/s` |  155.72 | -          |  155.72 |  155.72 |
| `execute_preflight_insns` |  750,104.50 |  1,500,209 |  873,000 |  627,209 |
| `execute_preflight_time_ms` |  29 |  58 |  33 |  25 |
| `execute_preflight_insn_mi/s` |  38.01 | -          |  40.14 |  35.88 |
| `trace_gen_time_ms   ` |  191.50 |  383 |  197 |  186 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  199.50 |  399 |  209 |  190 |
| `main_trace_commit_time_ms` |  30.50 |  61 |  33 |  28 |
| `generate_perm_trace_time_ms` |  31 |  62 |  32 |  30 |
| `perm_trace_commit_time_ms` |  41.29 |  82.58 |  43.94 |  38.65 |
| `quotient_poly_compute_time_ms` |  31.55 |  63.10 |  33.47 |  29.62 |
| `quotient_poly_commit_time_ms` |  11.85 |  23.71 |  12.45 |  11.26 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 451 | 40 | 1 | 9 | 1,500,209 | 155.72 | 139 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 197 | 576 | 9,677,708 | 84,395,212 | 197 | 209 | 0 | 33.47 | 12.45 | 4 | 43.94 | 52 | 77 | 52 | 0 | 33 | 1,035,986 | 32 | 25 | 873,000 | 35.88 | 14 | 46 | 0 | 52 | 
| fibonacci_program | 1 | 186 | 451 | 9,708,170 | 74,305,770 | 186 | 190 | 1 | 29.62 | 11.26 | 5 | 38.65 | 50 | 69 | 50 | 0 | 28 | 1,064,416 | 30 | 33 | 627,209 | 40.14 | 11 | 41 | 0 | 50 | 
...
Commit: https://github.com/openvm-org/openvm/commit/aa3d860a95b6bcd350ed00f6636fef595080ba66
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19183317056)

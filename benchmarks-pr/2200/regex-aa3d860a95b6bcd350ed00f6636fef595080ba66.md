...
| `total_proof_time_ms ` |  593.25 |  2,373 |  714 |  550 |
...
| `execute_preflight_time_ms` |  52 |  208 |  64 |  44 |
| `execute_preflight_insn_mi/s` |  32.29 | -          |  33.58 |  28.94 |
| `trace_gen_time_ms   ` |  185.25 |  741 |  217 |  162 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  288.25 |  1,153 |  307 |  273 |
| `main_trace_commit_time_ms` |  53.25 |  213 |  58 |  51 |
| `generate_perm_trace_time_ms` |  26 |  104 |  36 |  20 |
| `perm_trace_commit_time_ms` |  65.94 |  263.77 |  73.23 |  57.07 |
| `quotient_poly_compute_time_ms` |  59.47 |  237.89 |  70.75 |  53.38 |
| `quotient_poly_commit_time_ms` |  15.15 |  60.60 |  17.35 |  12.83 |
| `pcs_opening_time_ms ` |  65.50 |  262 |  73 |  56 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 550 | 40 | 1 | 37 | 4,137,502 | 110.65 | 167 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 217 | 714 | 23,446,148 | 150,778,428 | 217 | 307 | 0 | 59.90 | 17.35 | 5 | 73.23 | 60 | 110 | 60 | 4 | 58 | 10,899,170 | 36 | 44 | 1,103,000 | 28.94 | 22 | 77 | 1 | 60 | 
| regex_program | 1 | 162 | 550 | 11,598,276 | 128,513,066 | 162 | 283 | 1 | 53.38 | 15.29 | 4 | 67.37 | 73 | 89 | 73 | 0 | 51 | 2,196,106 | 21 | 64 | 1,104,000 | 33.58 | 17 | 69 | 0 | 73 | 
| regex_program | 2 | 171 | 559 | 11,579,064 | 128,513,066 | 171 | 290 | 1 | 53.86 | 15.14 | 4 | 66.10 | 73 | 94 | 73 | 0 | 52 | 2,177,334 | 27 | 56 | 1,104,000 | 33.54 | 17 | 69 | 0 | 73 | 
| regex_program | 3 | 191 | 550 | 11,853,872 | 103,456,394 | 191 | 273 | 0 | 70.75 | 12.83 | 5 | 57.07 | 56 | 80 | 56 | 0 | 52 | 2,422,606 | 20 | 44 | 826,502 | 33.09 | 19 | 84 | 1 | 56 | 

...
| `total_proof_time_ms ` |  724 |  1,448 |  844 |  604 |
...
| `execute_preflight_insn_mi/s` |  13.83 | -          |  18.37 |  9.29 |
| `trace_gen_time_ms   ` |  181 |  362 |  196 |  166 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  356.50 |  713 |  406 |  307 |
| `main_trace_commit_time_ms` |  65.50 |  131 |  75 |  56 |
| `generate_perm_trace_time_ms` |  42.50 |  85 |  48 |  37 |
| `perm_trace_commit_time_ms` |  78.34 |  156.68 |  90.94 |  65.74 |
| `quotient_poly_compute_time_ms` |  79.88 |  159.77 |  88.50 |  71.27 |
| `quotient_poly_commit_time_ms` |  16.86 |  33.71 |  19.26 |  14.45 |
| `pcs_opening_time_ms ` |  69 |  138 |  80 |  58 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 604 | 40 | 1 | 94 | 1,745,742 | 18.55 | 145 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 166 | 844 | 32,689,110 | 172,558,444 | 166 | 406 | 0 | 88.50 | 19.26 | 6 | 90.94 | 80 | 142 | 80 | 1 | 75 | 16,059,916 | 48 | 128 | 1,157,000 | 9.29 | 27 | 108 | 1 | 80 | 
| pairing | 1 | 196 | 604 | 22,314,288 | 119,958,502 | 196 | 307 | 1 | 71.27 | 14.45 | 6 | 65.74 | 58 | 106 | 57 | 0 | 56 | 9,408,294 | 37 | 59 | 588,742 | 18.37 | 20 | 86 | 1 | 57 | 

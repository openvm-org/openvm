...
| `total_proof_time_ms ` |  727.50 |  1,455 |  826 |  629 |
...
| `execute_preflight_insn_mi/s` |  13.84 | -          |  18.51 |  9.17 |
| `trace_gen_time_ms   ` |  181.50 |  363 |  197 |  166 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  358 |  716 |  386 |  330 |
| `main_trace_commit_time_ms` |  64.50 |  129 |  75 |  54 |
| `generate_perm_trace_time_ms` |  43.50 |  87 |  48 |  39 |
| `perm_trace_commit_time_ms` |  78.26 |  156.51 |  90.53 |  65.98 |
| `quotient_poly_compute_time_ms` |  80.09 |  160.19 |  88.58 |  71.61 |
| `quotient_poly_commit_time_ms` |  16.65 |  33.30 |  18.38 |  14.92 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 629 | 40 | 1 | 91 | 1,745,742 | 19.12 | 145 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 166 | 826 | 32,689,110 | 172,558,444 | 166 | 386 | 0 | 88.58 | 18.38 | 6 | 90.53 | 70 | 132 | 69 | 1 | 75 | 16,059,916 | 39 | 129 | 1,157,000 | 9.17 | 27 | 107 | 1 | 69 | 
| pairing | 1 | 197 | 629 | 22,314,288 | 119,958,502 | 197 | 330 | 1 | 71.61 | 14.92 | 6 | 65.98 | 71 | 117 | 71 | 0 | 54 | 9,408,294 | 48 | 60 | 588,742 | 18.51 | 20 | 87 | 1 | 71 | 

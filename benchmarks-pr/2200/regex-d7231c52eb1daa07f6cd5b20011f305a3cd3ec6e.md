...
| `total_proof_time_ms ` |  587.50 |  2,350 |  709 |  542 |
...
| `execute_metered_insn_mi/s` |  108.38 | -          |  108.38 |  108.38 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  53 |  212 |  66 |  44 |
| `execute_preflight_insn_mi/s` |  31.81 | -          |  32.95 |  28.55 |
| `trace_gen_time_ms   ` |  181 |  724 |  216 |  157 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  285.75 |  1,143 |  303 |  276 |
| `main_trace_commit_time_ms` |  52.50 |  210 |  58 |  50 |
| `generate_perm_trace_time_ms` |  25.25 |  101 |  36 |  19 |
| `perm_trace_commit_time_ms` |  64.87 |  259.50 |  71.24 |  56.21 |
| `quotient_poly_compute_time_ms` |  58.34 |  233.36 |  69.57 |  52.29 |
| `quotient_poly_commit_time_ms` |  14.98 |  59.94 |  17.40 |  12.42 |
| `pcs_opening_time_ms ` |  66.75 |  267 |  73 |  59 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 548 | 65 | 1 | 38 | 4,137,502 | 108.38 | 192 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 216 | 709 | 23,446,148 | 150,778,428 | 216 | 303 | 0 | 58.45 | 17.40 | 5 | 71.24 | 59 | 108 | 59 | 4 | 58 | 10,899,170 | 36 | 45 | 1,103,000 | 28.55 | 22 | 76 | 1 | 59 | 
| regex_program | 1 | 157 | 542 | 11,598,276 | 128,513,066 | 157 | 277 | 1 | 53.05 | 14.47 | 4 | 65.92 | 72 | 85 | 72 | 0 | 51 | 2,196,106 | 19 | 66 | 1,104,000 | 32.86 | 16 | 68 | 0 | 72 | 
| regex_program | 2 | 165 | 551 | 11,579,064 | 128,513,066 | 165 | 287 | 1 | 52.29 | 15.65 | 4 | 66.13 | 73 | 94 | 73 | 0 | 50 | 2,177,334 | 27 | 57 | 1,104,000 | 32.90 | 17 | 68 | 0 | 73 | 
| regex_program | 3 | 186 | 548 | 11,853,872 | 103,456,394 | 185 | 276 | 0 | 69.57 | 12.42 | 5 | 56.21 | 63 | 78 | 62 | 0 | 51 | 2,422,606 | 19 | 44 | 826,502 | 32.95 | 18 | 83 | 1 | 62 | 
...
Commit: https://github.com/openvm-org/openvm/commit/d7231c52eb1daa07f6cd5b20011f305a3cd3ec6e
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19151372643)

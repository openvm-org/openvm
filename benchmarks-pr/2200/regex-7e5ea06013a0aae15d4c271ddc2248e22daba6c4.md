...
|:---|---:|---:|
| Total |  2.34 |  0.73 |
| regex_program |  2.30 |  0.70 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  574.75 |  2,299 |  698 |  518 |
...
| `execute_metered_insn_mi/s` |  112.73 | -          |  112.73 |  112.73 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  52.25 |  209 |  64 |  44 |
| `execute_preflight_insn_mi/s` |  31.88 | -          |  33.03 |  29.08 |
| `trace_gen_time_ms   ` |  177.25 |  709 |  211 |  154 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  277.50 |  1,110 |  298 |  257 |
| `main_trace_commit_time_ms` |  51.75 |  207 |  57 |  50 |
| `generate_perm_trace_time_ms` |  25 |  100 |  35 |  19 |
| `perm_trace_commit_time_ms` |  63.83 |  255.32 |  69.63 |  55.18 |
| `quotient_poly_compute_time_ms` |  57.56 |  230.22 |  68.31 |  51.39 |
| `quotient_poly_commit_time_ms` |  14.82 |  59.29 |  16.95 |  12.24 |
| `pcs_opening_time_ms ` |  61.50 |  246 |  72 |  53 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 540 | 41 | 1 | 36 | 4,137,502 | 112.73 | 166 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 211 | 698 | 23,446,148 | 150,778,428 | 211 | 298 | 0 | 57.92 | 16.95 | 5 | 69.63 | 59 | 106 | 58 | 4 | 57 | 10,899,170 | 35 | 44 | 1,103,000 | 29.08 | 21 | 75 | 1 | 58 | 
| regex_program | 1 | 154 | 518 | 11,598,276 | 128,513,066 | 154 | 257 | 1 | 51.39 | 15.60 | 5 | 65.74 | 53 | 85 | 53 | 0 | 50 | 2,196,106 | 19 | 64 | 1,104,000 | 32.62 | 16 | 67 | 0 | 53 | 
| regex_program | 2 | 162 | 543 | 11,579,064 | 128,513,066 | 162 | 283 | 1 | 52.61 | 14.51 | 4 | 64.76 | 72 | 92 | 72 | 0 | 50 | 2,177,334 | 27 | 57 | 1,104,000 | 33.03 | 16 | 67 | 0 | 72 | 
| regex_program | 3 | 182 | 540 | 11,853,872 | 103,456,394 | 182 | 272 | 0 | 68.31 | 12.24 | 5 | 55.18 | 62 | 77 | 62 | 0 | 50 | 2,422,606 | 19 | 44 | 826,502 | 32.78 | 18 | 81 | 1 | 62 | 
...
Commit: https://github.com/openvm-org/openvm/commit/7e5ea06013a0aae15d4c271ddc2248e22daba6c4
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19144240400)

...
| `total_proof_time_ms ` |  583.50 |  2,334 |  719 |  535 |
...
| `execute_metered_insn_mi/s` |  102.25 | -          |  102.25 |  102.25 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  52.75 |  211 |  65 |  44 |
| `execute_preflight_insn_mi/s` |  31.84 | -          |  32.87 |  29.12 |
| `trace_gen_time_ms   ` |  178.50 |  714 |  214 |  155 |
| `memory_finalize_time_ms` |  1.25 |  5 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  284.50 |  1,138 |  317 |  269 |
| `main_trace_commit_time_ms` |  52.25 |  209 |  58 |  50 |
| `generate_perm_trace_time_ms` |  22.25 |  89 |  27 |  20 |
| `perm_trace_commit_time_ms` |  65.02 |  260.08 |  71.40 |  55.97 |
| `quotient_poly_compute_time_ms` |  58.86 |  235.42 |  69.53 |  52.20 |
| `quotient_poly_commit_time_ms` |  15.25 |  60.99 |  17.78 |  13.20 |
| `pcs_opening_time_ms ` |  68 |  272 |  84 |  56 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 538 | 65 | 1 | 40 | 4,137,502 | 102.25 | 192 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 214 | 719 | 23,446,148 | 150,778,428 | 214 | 317 | 0 | 61.01 | 17.78 | 5 | 71.40 | 84 | 94 | 84 | 4 | 58 | 10,899,170 | 22 | 44 | 1,103,000 | 29.12 | 21 | 79 | 1 | 84 | 
| regex_program | 1 | 155 | 542 | 11,598,276 | 128,513,066 | 155 | 280 | 1 | 52.68 | 15.65 | 4 | 67.68 | 71 | 88 | 71 | 1 | 50 | 2,196,106 | 20 | 65 | 1,104,000 | 32.73 | 16 | 68 | 0 | 71 | 
| regex_program | 2 | 163 | 535 | 11,579,064 | 128,513,066 | 163 | 272 | 1 | 52.20 | 14.35 | 4 | 65.03 | 61 | 92 | 61 | 0 | 51 | 2,177,334 | 27 | 57 | 1,104,000 | 32.62 | 16 | 67 | 0 | 61 | 
| regex_program | 3 | 182 | 538 | 11,853,872 | 103,456,394 | 182 | 269 | 0 | 69.53 | 13.20 | 5 | 55.97 | 56 | 79 | 55 | 0 | 50 | 2,422,606 | 20 | 45 | 826,502 | 32.87 | 18 | 83 | 1 | 55 | 
...
Commit: https://github.com/openvm-org/openvm/commit/e717e1ba75dfba4b478012b58524260a9b7820ed
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19148371408)

...
| `total_proof_time_ms ` |  719.50 |  1,439 |  821 |  618 |
...
| `execute_preflight_time_ms` |  97 |  194 |  128 |  66 |
| `execute_preflight_insn_mi/s` |  13.84 | -          |  18.41 |  9.27 |
| `trace_gen_time_ms   ` |  177.50 |  355 |  190 |  165 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  351 |  702 |  382 |  320 |
| `main_trace_commit_time_ms` |  63.50 |  127 |  72 |  55 |
| `generate_perm_trace_time_ms` |  44.50 |  89 |  47 |  42 |
| `perm_trace_commit_time_ms` |  76.70 |  153.40 |  89.04 |  64.36 |
| `quotient_poly_compute_time_ms` |  79.36 |  158.72 |  87.51 |  71.21 |
| `quotient_poly_commit_time_ms` |  15.92 |  31.84 |  17.28 |  14.56 |
| `pcs_opening_time_ms ` |  66 |  132 |  70 |  62 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 618 | 41 | 1 | 90 | 1,745,742 | 19.29 | 148 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 165 | 821 | 32,689,110 | 172,558,444 | 165 | 382 | 0 | 87.51 | 17.28 | 6 | 89.04 | 70 | 133 | 70 | 1 | 72 | 16,059,916 | 42 | 128 | 1,157,000 | 9.27 | 26 | 105 | 1 | 70 | 
| pairing | 1 | 190 | 618 | 22,314,288 | 119,958,502 | 190 | 320 | 1 | 71.21 | 14.56 | 6 | 64.36 | 62 | 115 | 62 | 0 | 55 | 9,408,294 | 47 | 66 | 588,742 | 18.41 | 21 | 86 | 1 | 62 | 
...
Commit: https://github.com/openvm-org/openvm/commit/885f45c7855dd0bbf97a176e3eab2bda20c162a6
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19149403764)

...
|:---|---:|---:|
| Total | <span style='color: green'>(-0 [-1.1%])</span> 1.84 | <span style='color: green'>(-0 [-1.4%])</span> 1.08 |
| pairing | <span style='color: green'>(-0 [-1.0%])</span> 1.75 | <span style='color: green'>(-0 [-1.2%])</span> 0.99 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: green'>(-8 [-1.0%])</span> 874 | <span style='color: green'>(-17 [-1.0%])</span> 1,748 | <span style='color: green'>(-12 [-1.2%])</span> 989 | <span style='color: green'>(-5 [-0.7%])</span> 759 |
| `main_cells_used     ` |  12,923,881 |  25,847,762 |  15,014,446 |  10,833,316 |
| `total_cells_used    ` |  27,763,511 |  55,527,022 |  31,041,944 |  24,485,078 |
| `execute_metered_time_ms` | <span style='color: green'>(-3 [-3.2%])</span> 90 | -          | -          | -          |
| `execute_metered_insn_mi/s` | <span style='color: red'>(+0 [+2.4%])</span> 20.72 | -          | <span style='color: red'>(+0 [+2.4%])</span> 20.72 | <span style='color: red'>(+0 [+2.4%])</span> 20.72 |
| `execute_preflight_insns` |  941,469.50 |  1,882,939 |  1,143,000 |  739,939 |
| `execute_preflight_time_ms` |  99.50 |  199 | <span style='color: red'>(+1 [+0.8%])</span> 127 | <span style='color: green'>(-1 [-1.4%])</span> 72 |
| `execute_preflight_insn_mi/s` | <span style='color: green'>(-0 [-2.2%])</span> 13.78 | -          | <span style='color: green'>(-1 [-2.9%])</span> 18.34 | <span style='color: green'>(-0 [-0.6%])</span> 9.23 |
| `trace_gen_time_ms   ` | <span style='color: green'>(-1 [-0.5%])</span> 190 | <span style='color: green'>(-2 [-0.5%])</span> 380 | <span style='color: red'>(+1 [+0.5%])</span> 205 | <span style='color: green'>(-3 [-1.7%])</span> 175 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: green'>(-7 [-1.4%])</span> 490 | <span style='color: green'>(-14 [-1.4%])</span> 980 | <span style='color: green'>(-9 [-1.6%])</span> 540 | <span style='color: green'>(-5 [-1.1%])</span> 440 |
| `main_trace_commit_time_ms` | <span style='color: green'>(-1 [-1.4%])</span> 69 | <span style='color: green'>(-2 [-1.4%])</span> 138 | <span style='color: green'>(-2 [-2.6%])</span> 75 |  63 |
| `generate_perm_trace_time_ms` |  47.50 |  95 |  52 |  43 |
| `perm_trace_commit_time_ms` | <span style='color: green'>(-2 [-1.9%])</span> 81.32 | <span style='color: green'>(-3 [-1.9%])</span> 162.63 | <span style='color: green'>(-3 [-3.0%])</span> 89.93 | <span style='color: green'>(-0 [-0.5%])</span> 72.71 |
| `quotient_poly_compute_time_ms` | <span style='color: green'>(-3 [-2.8%])</span> 93.25 | <span style='color: green'>(-5 [-2.8%])</span> 186.49 | <span style='color: green'>(-3 [-2.6%])</span> 99.01 | <span style='color: green'>(-3 [-3.0%])</span> 87.48 |
| `quotient_poly_commit_time_ms` | <span style='color: green'>(-0 [-2.6%])</span> 18.49 | <span style='color: green'>(-1 [-2.6%])</span> 36.98 | <span style='color: green'>(-1 [-2.6%])</span> 20.34 | <span style='color: green'>(-0 [-2.7%])</span> 16.64 |
| `pcs_opening_time_ms ` | <span style='color: green'>(-2 [-0.8%])</span> 175.50 | <span style='color: green'>(-3 [-0.8%])</span> 351 | <span style='color: green'>(-2 [-1.0%])</span> 198 | <span style='color: green'>(-1 [-0.6%])</span> 153 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 759 | 40 | 1 | 90 | 1,882,939 | 20.72 | 145 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 175 | 989 | 31,041,944 | 160,949,612 | 175 | 540 | 0 | 99.01 | 20.34 | 6 | 89.93 | 198 | 144 | 198 | 1 | 75 | 15,014,446 | 52 | 127 | 1,143,000 | 9.23 | 23 | 120 | 3 | 198 | 
| pairing | 1 | 205 | 759 | 24,485,078 | 124,079,782 | 205 | 440 | 1 | 87.48 | 16.64 | 6 | 72.71 | 153 | 118 | 153 | 0 | 63 | 10,833,316 | 43 | 72 | 739,939 | 18.34 | 19 | 104 | 2 | 153 | 

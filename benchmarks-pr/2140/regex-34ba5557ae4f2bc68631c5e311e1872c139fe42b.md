...
|:---|---:|---:|
| Total | <span style='color: red'>(+0 [+3.0%])</span> 3.08 | <span style='color: red'>(+0 [+1.2%])</span> 0.91 |
| regex_program | <span style='color: red'>(+0 [+3.0%])</span> 3.05 | <span style='color: red'>(+0 [+1.2%])</span> 0.87 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+22 [+3.0%])</span> 762.75 | <span style='color: red'>(+90 [+3.0%])</span> 3,051 | <span style='color: red'>(+10 [+1.2%])</span> 874 | <span style='color: red'>(+16 [+2.4%])</span> 689 |
...
| `execute_metered_insn_mi/s` | <span style='color: green'>(-1 [-0.7%])</span> 120.14 | -          | <span style='color: green'>(-1 [-0.7%])</span> 120.14 | <span style='color: green'>(-1 [-0.7%])</span> 120.14 |
| `execute_preflight_insns` |  1,027,120.75 |  4,108,483 |  1,108,000 |  790,483 |
| `execute_preflight_time_ms` | <span style='color: red'>(+4 [+8.6%])</span> 57 | <span style='color: red'>(+18 [+8.6%])</span> 228 | <span style='color: red'>(+8 [+12.7%])</span> 71 | <span style='color: red'>(+3 [+6.8%])</span> 47 |
| `execute_preflight_insn_mi/s` | <span style='color: green'>(-2 [-5.1%])</span> 30.47 | -          | <span style='color: green'>(-1 [-4.4%])</span> 31.68 | <span style='color: green'>(-2 [-5.4%])</span> 27.63 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+3 [+1.5%])</span> 198.25 | <span style='color: red'>(+12 [+1.5%])</span> 793 | <span style='color: red'>(+5 [+2.2%])</span> 234 |  173 |
| `memory_finalize_time_ms` |  1 |  4 |  4 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+15 [+3.5%])</span> 438.50 | <span style='color: red'>(+59 [+3.5%])</span> 1,754 | <span style='color: red'>(+44 [+9.6%])</span> 502 | <span style='color: red'>(+8 [+2.0%])</span> 403 |
| `main_trace_commit_time_ms` | <span style='color: red'>(+1 [+1.3%])</span> 57.25 | <span style='color: red'>(+3 [+1.3%])</span> 229 |  62 | <span style='color: red'>(+1 [+1.9%])</span> 54 |
| `generate_perm_trace_time_ms` | <span style='color: green'>(-4 [-12.5%])</span> 29.75 | <span style='color: green'>(-17 [-12.5%])</span> 119 |  38 | <span style='color: green'>(-6 [-20.7%])</span> 23 |
| `perm_trace_commit_time_ms` | <span style='color: red'>(+2 [+2.7%])</span> 70.53 | <span style='color: red'>(+7 [+2.7%])</span> 282.12 | <span style='color: red'>(+1 [+1.9%])</span> 75.94 | <span style='color: red'>(+1 [+1.2%])</span> 59.53 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+7 [+9.6%])</span> 80.30 | <span style='color: red'>(+28 [+9.6%])</span> 321.18 | <span style='color: red'>(+25 [+18.9%])</span> 157.88 | <span style='color: red'>(+2 [+4.7%])</span> 53.73 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+0 [+2.1%])</span> 18.27 | <span style='color: red'>(+1 [+2.1%])</span> 73.06 | <span style='color: red'>(+0 [+0.9%])</span> 19.86 | <span style='color: red'>(+0 [+2.1%])</span> 15.54 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+8 [+4.8%])</span> 178.75 | <span style='color: red'>(+33 [+4.8%])</span> 715 | <span style='color: red'>(+1 [+0.5%])</span> 187 | <span style='color: red'>(+11 [+7.0%])</span> 169 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 794 | 41 | 1 | 34 | 4,108,483 | 120.14 | 170 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 234 | 874 | 23,395,260 | 150,778,428 | 234 | 441 | 0 | 55.01 | 19.86 | 5 | 75.94 | 187 | 115 | 187 | 4 | 62 | 10,864,634 | 38 | 48 | 1,102,000 | 27.63 | 20 | 75 | 2 | 187 | 
| regex_program | 1 | 173 | 689 | 11,589,074 | 132,682,794 | 173 | 403 | 1 | 53.73 | 19.17 | 5 | 73.21 | 169 | 103 | 169 | 0 | 56 | 2,191,608 | 29 | 71 | 1,108,000 | 31.14 | 16 | 73 | 1 | 169 | 
| regex_program | 2 | 183 | 694 | 11,583,256 | 132,682,794 | 183 | 408 | 1 | 54.57 | 18.48 | 5 | 73.44 | 179 | 97 | 179 | 0 | 57 | 2,185,918 | 23 | 62 | 1,108,000 | 31.68 | 15 | 73 | 1 | 179 | 
| regex_program | 3 | 203 | 794 | 11,847,840 | 103,522,954 | 203 | 502 | 0 | 157.88 | 15.54 | 5 | 59.53 | 180 | 92 | 180 | 0 | 54 | 2,420,726 | 29 | 47 | 790,483 | 31.43 | 17 | 174 | 2 | 180 | 

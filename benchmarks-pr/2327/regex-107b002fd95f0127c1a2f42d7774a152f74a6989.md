...
|:---|---:|---:|---:|
| Total |  2.43 |  0.79 | 0.79 |
| regex_program |  2.43 |  0.79 |  0.79 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  598.25 |  2,393 |  757 |  545 |
...
| `execute_preflight_time_ms` |  55.75 |  223 |  67 |  47 |
| `execute_preflight_insn_mi/s` |  29.10 | -          |  29.93 |  26.75 |
| `trace_gen_time_ms   ` |  174.50 |  698 |  210 |  151 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  293.75 |  1,175 |  328 |  277 |
| `main_trace_commit_time_ms` |  51.50 |  206 |  56 |  49 |
| `generate_perm_trace_time_ms` |  24 |  96 |  28 |  20 |
| `perm_trace_commit_time_ms` |  64.08 |  256.30 |  70.17 |  55.15 |
| `quotient_poly_compute_time_ms` |  59.51 |  238.04 |  70.18 |  52.46 |
| `quotient_poly_commit_time_ms` |  15.91 |  63.64 |  18.65 |  13.79 |
| `pcs_opening_time_ms ` |  75.50 |  302 |  92 |  62 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 546 | 1 | 36 | 4,137,502 | 112.54 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 210 | 757 | 23,446,148 | 150,778,428 | 210 | 328 | 0 | 61.23 | 18.65 | 5 | 70.17 | 92 | 98 | 92 | 4 | 56 | 10,899,170 | 27 | 48 | 1,103,000 | 26.75 | 22 | 80 | 1 | 92 | 
| regex_program | 1 | 151 | 545 | 11,598,276 | 128,513,066 | 151 | 285 | 1 | 54.18 | 15.53 | 4 | 66.24 | 76 | 87 | 76 | 0 | 51 | 2,196,106 | 20 | 67 | 1,104,000 | 29.85 | 17 | 70 | 0 | 76 | 
| regex_program | 2 | 158 | 545 | 11,579,064 | 128,513,066 | 158 | 285 | 1 | 52.46 | 15.67 | 4 | 64.74 | 72 | 93 | 72 | 0 | 50 | 2,177,334 | 28 | 61 | 1,104,000 | 29.93 | 17 | 68 | 0 | 72 | 
| regex_program | 3 | 179 | 546 | 11,853,872 | 103,456,394 | 179 | 277 | 0 | 70.18 | 13.79 | 5 | 55.15 | 62 | 79 | 62 | 0 | 49 | 2,422,606 | 21 | 47 | 826,502 | 29.87 | 19 | 85 | 1 | 62 | 
...
Commit: https://github.com/openvm-org/openvm/commit/107b002fd95f0127c1a2f42d7774a152f74a6989
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/20355794110)

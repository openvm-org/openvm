...
|:---|---:|---:|---:|
| Total |  2.41 |  0.77 | 0.77 |
| regex_program |  2.41 |  0.77 |  0.77 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  592.50 |  2,370 |  730 |  543 |
...
| `execute_preflight_time_ms` |  55 |  220 |  69 |  45 |
| `execute_preflight_insn_mi/s` |  30.86 | -          |  32.48 |  28.59 |
| `trace_gen_time_ms   ` |  175 |  700 |  211 |  150 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  287.75 |  1,151 |  301 |  280 |
| `main_trace_commit_time_ms` |  52.25 |  209 |  58 |  49 |
| `generate_perm_trace_time_ms` |  23.75 |  95 |  29 |  21 |
| `perm_trace_commit_time_ms` |  64.29 |  257.15 |  70.50 |  55.58 |
| `quotient_poly_compute_time_ms` |  59.62 |  238.48 |  70.09 |  52.85 |
| `quotient_poly_commit_time_ms` |  15.85 |  63.42 |  18.44 |  13.91 |
| `pcs_opening_time_ms ` |  68.50 |  274 |  73 |  63 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 548 | 1 | 37 | 4,137,502 | 109.58 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 211 | 730 | 23,446,148 | 150,778,428 | 211 | 301 | 0 | 61.73 | 18.44 | 5 | 70.50 | 66 | 95 | 66 | 4 | 58 | 10,899,170 | 23 | 45 | 1,103,000 | 28.59 | 22 | 80 | 1 | 66 | 
| regex_program | 1 | 150 | 543 | 11,598,276 | 128,513,066 | 150 | 282 | 1 | 53.81 | 15.82 | 4 | 65.99 | 72 | 87 | 72 | 0 | 51 | 2,196,106 | 21 | 69 | 1,104,000 | 30.59 | 17 | 70 | 0 | 72 | 
| regex_program | 2 | 158 | 549 | 11,579,064 | 128,513,066 | 158 | 288 | 1 | 52.85 | 15.25 | 4 | 65.08 | 73 | 95 | 73 | 0 | 51 | 2,177,334 | 29 | 60 | 1,104,000 | 31.77 | 17 | 68 | 0 | 73 | 
| regex_program | 3 | 181 | 548 | 11,853,872 | 103,456,394 | 181 | 280 | 0 | 70.09 | 13.91 | 5 | 55.58 | 63 | 81 | 63 | 0 | 49 | 2,422,606 | 22 | 46 | 826,502 | 32.48 | 19 | 85 | 1 | 63 | 

...
|:---|---:|---:|---:|
| Total |  2.38 |  0.76 | 0.76 |
| regex_program |  2.38 |  0.76 |  0.76 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  586.50 |  2,346 |  725 |  536 |
...
| `execute_metered_insn_mi/s` |  115.06 | -          |  115.06 |  115.06 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  54.75 |  219 |  67 |  46 |
| `execute_preflight_insn_mi/s` |  30.76 | -          |  32.05 |  28.26 |
| `trace_gen_time_ms   ` |  174 |  696 |  207 |  151 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  283.75 |  1,135 |  301 |  275 |
| `main_trace_commit_time_ms` |  50.50 |  202 |  55 |  48 |
| `generate_perm_trace_time_ms` |  26.50 |  106 |  37 |  21 |
| `perm_trace_commit_time_ms` |  63.05 |  252.20 |  69.28 |  53.87 |
| `quotient_poly_compute_time_ms` |  59.39 |  237.54 |  71 |  52.22 |
| `quotient_poly_commit_time_ms` |  15.32 |  61.28 |  17.83 |  13.33 |
| `pcs_opening_time_ms ` |  65.75 |  263 |  72 |  58 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 542 | 1 | 35 | 4,137,502 | 115.06 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 207 | 725 | 23,446,148 | 150,778,428 | 207 | 301 | 0 | 61.50 | 17.83 | 5 | 69.28 | 58 | 107 | 58 | 4 | 55 | 10,899,170 | 37 | 46 | 1,103,000 | 28.26 | 21 | 80 | 1 | 58 | 
| regex_program | 1 | 151 | 536 | 11,598,276 | 128,513,066 | 151 | 276 | 1 | 52.82 | 14.92 | 4 | 64.94 | 71 | 86 | 71 | 0 | 49 | 2,196,106 | 21 | 67 | 1,104,000 | 32.05 | 16 | 68 | 0 | 71 | 
| regex_program | 2 | 159 | 543 | 11,579,064 | 128,513,066 | 159 | 283 | 1 | 52.22 | 15.20 | 4 | 64.12 | 72 | 92 | 72 | 0 | 50 | 2,177,334 | 27 | 59 | 1,104,000 | 31.87 | 17 | 67 | 0 | 72 | 
| regex_program | 3 | 179 | 542 | 11,853,872 | 103,456,394 | 179 | 275 | 0 | 71 | 13.33 | 5 | 53.87 | 62 | 77 | 62 | 0 | 48 | 2,422,606 | 21 | 47 | 826,502 | 30.86 | 18 | 85 | 1 | 62 | 
...
Commit: https://github.com/openvm-org/openvm/commit/b7c6600f057cbbcb69f4f6a3d8a443f03b00b7ad
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/20356013116)

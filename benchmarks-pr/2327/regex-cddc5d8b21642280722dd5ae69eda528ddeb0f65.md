...
|:---|---:|---:|---:|
| Total |  2.42 |  0.77 | 0.77 |
| regex_program |  2.42 |  0.77 |  0.77 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  594.75 |  2,379 |  733 |  545 |
...
| `execute_preflight_time_ms` |  57 |  228 |  70 |  47 |
| `execute_preflight_insn_mi/s` |  31.34 | -          |  32.72 |  27.90 |
| `trace_gen_time_ms   ` |  176.25 |  705 |  212 |  152 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  288 |  1,152 |  306 |  273 |
| `main_trace_commit_time_ms` |  52 |  208 |  58 |  50 |
| `generate_perm_trace_time_ms` |  26.50 |  106 |  37 |  20 |
| `perm_trace_commit_time_ms` |  64.95 |  259.79 |  72.01 |  55.24 |
| `quotient_poly_compute_time_ms` |  59.96 |  239.85 |  71.77 |  53.85 |
| `quotient_poly_commit_time_ms` |  15.76 |  63.06 |  18.78 |  13.67 |
| `pcs_opening_time_ms ` |  65.50 |  262 |  75 |  56 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 545 | 1 | 36 | 4,137,502 | 112.87 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 212 | 733 | 23,446,148 | 150,778,428 | 212 | 306 | 0 | 58.84 | 18.78 | 5 | 72.01 | 59 | 110 | 59 | 4 | 58 | 10,899,170 | 37 | 47 | 1,103,000 | 27.90 | 22 | 78 | 1 | 59 | 
| regex_program | 1 | 152 | 547 | 11,598,276 | 128,513,066 | 152 | 283 | 1 | 53.85 | 15.32 | 4 | 65.87 | 75 | 87 | 75 | 0 | 50 | 2,196,106 | 20 | 70 | 1,104,000 | 32.31 | 17 | 69 | 0 | 75 | 
| regex_program | 2 | 160 | 554 | 11,579,064 | 128,513,066 | 160 | 290 | 1 | 55.39 | 15.29 | 4 | 66.67 | 72 | 95 | 72 | 0 | 50 | 2,177,334 | 28 | 62 | 1,104,000 | 32.72 | 17 | 71 | 0 | 72 | 
| regex_program | 3 | 181 | 545 | 11,853,872 | 103,456,394 | 181 | 273 | 0 | 71.77 | 13.67 | 5 | 55.24 | 56 | 80 | 56 | 0 | 50 | 2,422,606 | 21 | 49 | 826,502 | 32.41 | 19 | 86 | 1 | 56 | 
...
Commit: https://github.com/openvm-org/openvm/commit/cddc5d8b21642280722dd5ae69eda528ddeb0f65
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/20381447868)

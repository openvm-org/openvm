...
|:---|---:|---:|---:|
| Total |  1.54 |  0.94 | 0.94 |
| pairing |  1.54 |  0.94 |  0.94 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  741 |  1,482 |  874 |  608 |
...
| `execute_preflight_insn_mi/s` |  14.66 | -          |  18.08 |  11.25 |
| `trace_gen_time_ms   ` |  191 |  382 |  195 |  187 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  361.50 |  723 |  412 |  311 |
| `main_trace_commit_time_ms` |  64 |  128 |  75 |  53 |
| `generate_perm_trace_time_ms` |  41 |  82 |  53 |  29 |
| `perm_trace_commit_time_ms` |  77.22 |  154.43 |  88.81 |  65.63 |
| `quotient_poly_compute_time_ms` |  83.53 |  167.06 |  92.65 |  74.41 |
| `quotient_poly_commit_time_ms` |  16.88 |  33.76 |  18.52 |  15.24 |
| `pcs_opening_time_ms ` |  73.50 |  147 |  78 |  69 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 608 | 1 | 63 | 1,745,742 | 27.48 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 187 | 874 | 32,480,114 | 172,558,444 | 187 | 412 | 0 | 92.65 | 18.52 | 6 | 88.81 | 78 | 145 | 78 | 1 | 75 | 15,909,408 | 53 | 105 | 1,149,000 | 11.25 | 27 | 112 | 1 | 78 | 
| pairing | 1 | 195 | 608 | 22,464,232 | 119,958,502 | 195 | 311 | 1 | 74.41 | 15.24 | 6 | 65.63 | 69 | 98 | 69 | 0 | 53 | 9,498,894 | 29 | 60 | 596,742 | 18.08 | 21 | 90 | 1 | 69 | 

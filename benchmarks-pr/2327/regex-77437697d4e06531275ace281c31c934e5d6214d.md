...
| `total_proof_time_ms ` |  586.25 |  2,345 |  725 |  538 |
...
| `execute_preflight_insn_mi/s` |  31.19 | -          |  32.36 |  28.28 |
| `trace_gen_time_ms   ` |  175 |  700 |  208 |  153 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  284 |  1,136 |  303 |  271 |
| `main_trace_commit_time_ms` |  51.25 |  205 |  57 |  48 |
| `generate_perm_trace_time_ms` |  26.25 |  105 |  37 |  20 |
| `perm_trace_commit_time_ms` |  63.09 |  252.37 |  68.84 |  54.05 |
| `quotient_poly_compute_time_ms` |  58.91 |  235.62 |  69.56 |  52.57 |
| `quotient_poly_commit_time_ms` |  15.29 |  61.18 |  18.28 |  12.92 |
| `pcs_opening_time_ms ` |  66 |  264 |  72 |  59 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 538 | 1 | 36 | 4,137,502 | 112.19 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 208 | 725 | 23,446,148 | 150,778,428 | 208 | 303 | 0 | 60.09 | 18.28 | 5 | 68.84 | 59 | 106 | 59 | 4 | 57 | 10,899,170 | 37 | 45 | 1,103,000 | 28.28 | 22 | 79 | 1 | 59 | 
| regex_program | 1 | 153 | 538 | 11,598,276 | 128,513,066 | 153 | 278 | 1 | 53.40 | 14.94 | 4 | 65.45 | 72 | 85 | 71 | 0 | 50 | 2,196,106 | 20 | 66 | 1,104,000 | 31.89 | 16 | 68 | 0 | 71 | 
| regex_program | 2 | 159 | 544 | 11,579,064 | 128,513,066 | 159 | 284 | 1 | 52.57 | 15.04 | 4 | 64.03 | 72 | 92 | 72 | 0 | 50 | 2,177,334 | 28 | 58 | 1,104,000 | 32.23 | 17 | 68 | 0 | 72 | 
| regex_program | 3 | 180 | 538 | 11,853,872 | 103,456,394 | 180 | 271 | 0 | 69.56 | 12.92 | 5 | 54.05 | 61 | 77 | 61 | 0 | 48 | 2,422,606 | 20 | 45 | 826,502 | 32.36 | 18 | 83 | 1 | 61 | 
...
Commit: https://github.com/openvm-org/openvm/commit/77437697d4e06531275ace281c31c934e5d6214d
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/20355644315)

...
|:---|---:|---:|---:|
| Total |  1.04 |  0.59 | 0.59 |
| fibonacci_program |  1.04 |  0.59 |  0.59 |


| fibonacci_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  514 |  1,028 |  580 |  448 |
...
| `execute_metered_insn_mi/s` |  111.14 | -          |  111.14 |  111.14 |
| `execute_preflight_insns` |  750,104.50 |  1,500,209 |  873,000 |  627,209 |
| `execute_preflight_time_ms` |  28.50 |  57 |  32 |  25 |
| `execute_preflight_insn_mi/s` |  37.56 | -          |  39.75 |  35.36 |
| `trace_gen_time_ms   ` |  188 |  376 |  193 |  183 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  192.50 |  385 |  193 |  192 |
| `main_trace_commit_time_ms` |  30.50 |  61 |  33 |  28 |
| `generate_perm_trace_time_ms` |  29 |  58 |  30 |  28 |
| `perm_trace_commit_time_ms` |  40.10 |  80.20 |  42.81 |  37.40 |
| `quotient_poly_compute_time_ms` |  31.99 |  63.99 |  33.94 |  30.05 |
| `quotient_poly_commit_time_ms` |  12.09 |  24.17 |  12.31 |  11.86 |
| `pcs_opening_time_ms ` |  46.50 |  93 |  52 |  41 |
...
| --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 448 | 1 | 13 | 1,500,209 | 111.14 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 193 | 580 | 9,677,708 | 84,395,212 | 193 | 193 | 0 | 33.94 | 12.31 | 4 | 42.81 | 41 | 71 | 40 | 0 | 33 | 1,035,986 | 28 | 25 | 873,000 | 35.36 | 14 | 46 | 0 | 40 | 
| fibonacci_program | 1 | 183 | 448 | 9,708,170 | 74,305,770 | 183 | 192 | 1 | 30.05 | 11.86 | 4 | 37.40 | 52 | 68 | 52 | 0 | 28 | 1,064,416 | 30 | 32 | 627,209 | 39.75 | 11 | 42 | 0 | 52 | 

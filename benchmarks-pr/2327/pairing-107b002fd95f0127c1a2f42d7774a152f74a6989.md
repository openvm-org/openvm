...
| `total_proof_time_ms ` |  748 |  1,496 |  878 |  618 |
...
| `execute_preflight_insn_mi/s` |  14.57 | -          |  17.96 |  11.18 |
| `trace_gen_time_ms   ` |  192 |  384 |  196 |  188 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  366 |  732 |  414 |  318 |
| `main_trace_commit_time_ms` |  64.50 |  129 |  75 |  54 |
| `generate_perm_trace_time_ms` |  46 |  92 |  53 |  39 |
| `perm_trace_commit_time_ms` |  77.66 |  155.32 |  90.03 |  65.29 |
| `quotient_poly_compute_time_ms` |  83.66 |  167.31 |  92.39 |  74.92 |
| `quotient_poly_commit_time_ms` |  17.28 |  34.57 |  19.12 |  15.45 |
| `pcs_opening_time_ms ` |  71.50 |  143 |  78 |  65 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 618 | 1 | 63 | 1,745,742 | 27.30 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 188 | 878 | 32,480,114 | 172,558,444 | 188 | 414 | 0 | 92.39 | 19.12 | 6 | 90.03 | 78 | 147 | 78 | 1 | 75 | 15,909,408 | 53 | 106 | 1,149,000 | 11.18 | 27 | 112 | 1 | 78 | 
| pairing | 1 | 196 | 618 | 22,464,232 | 119,958,502 | 196 | 318 | 1 | 74.92 | 15.45 | 6 | 65.29 | 65 | 107 | 65 | 0 | 54 | 9,498,894 | 39 | 62 | 596,742 | 17.96 | 21 | 90 | 1 | 65 | 

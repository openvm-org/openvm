...
| `total_proof_time_ms ` |  734 |  1,468 |  866 |  602 |
...
| `execute_preflight_insn_mi/s` |  14.85 | -          |  18.46 |  11.24 |
| `trace_gen_time_ms   ` |  190 |  380 |  194 |  186 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  356.50 |  713 |  407 |  306 |
| `main_trace_commit_time_ms` |  65 |  130 |  75 |  55 |
| `generate_perm_trace_time_ms` |  43.50 |  87 |  49 |  38 |
| `perm_trace_commit_time_ms` |  76.32 |  152.64 |  88.19 |  64.45 |
| `quotient_poly_compute_time_ms` |  81.68 |  163.36 |  90.56 |  72.80 |
| `quotient_poly_commit_time_ms` |  17.35 |  34.71 |  19.48 |  15.23 |
| `pcs_opening_time_ms ` |  68 |  136 |  80 |  56 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 602 | 1 | 63 | 1,745,742 | 27.57 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 186 | 866 | 32,480,114 | 172,558,444 | 186 | 407 | 0 | 90.56 | 19.48 | 6 | 88.19 | 80 | 140 | 80 | 1 | 75 | 15,909,408 | 49 | 105 | 1,149,000 | 11.24 | 26 | 110 | 1 | 80 | 
| pairing | 1 | 194 | 602 | 22,464,232 | 119,958,502 | 194 | 306 | 1 | 72.80 | 15.23 | 5 | 64.45 | 56 | 105 | 56 | 0 | 55 | 9,498,894 | 38 | 59 | 596,742 | 18.46 | 21 | 88 | 1 | 56 | 

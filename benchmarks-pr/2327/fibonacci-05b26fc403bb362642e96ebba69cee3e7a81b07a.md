...
|:---|---:|---:|---:|
| Total |  1.06 |  0.61 | 0.61 |
| fibonacci_program |  1.06 |  0.61 |  0.61 |


| fibonacci_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  523 |  1,046 |  598 |  448 |
...
| `execute_metered_insn_mi/s` |  136.87 | -          |  136.87 |  136.87 |
| `execute_preflight_insns` |  750,104.50 |  1,500,209 |  873,000 |  627,209 |
| `execute_preflight_time_ms` |  29 |  58 |  33 |  25 |
| `execute_preflight_insn_mi/s` |  36.22 | -          |  36.75 |  35.69 |
| `trace_gen_time_ms   ` |  188.50 |  377 |  194 |  183 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  200.50 |  401 |  210 |  191 |
| `main_trace_commit_time_ms` |  30 |  60 |  32 |  28 |
| `generate_perm_trace_time_ms` |  32.50 |  65 |  34 |  31 |
| `perm_trace_commit_time_ms` |  41 |  82 |  43.56 |  38.44 |
| `quotient_poly_compute_time_ms` |  29.96 |  59.92 |  31.95 |  27.97 |
| `quotient_poly_commit_time_ms` |  12.21 |  24.42 |  13.06 |  11.35 |
| `pcs_opening_time_ms ` |  52.50 |  105 |  53 |  52 |
...
| --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 448 | 1 | 10 | 1,500,209 | 136.87 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 194 | 598 | 9,677,708 | 84,395,212 | 194 | 210 | 0 | 31.95 | 13.06 | 4 | 43.56 | 53 | 78 | 53 | 0 | 32 | 1,035,986 | 34 | 25 | 873,000 | 35.69 | 14 | 45 | 0 | 53 | 
| fibonacci_program | 1 | 183 | 448 | 9,708,170 | 74,305,770 | 183 | 191 | 1 | 27.97 | 11.35 | 4 | 38.44 | 52 | 70 | 52 | 0 | 28 | 1,064,416 | 31 | 33 | 627,209 | 36.75 | 11 | 39 | 0 | 52 | 
...
Commit: https://github.com/openvm-org/openvm/commit/05b26fc403bb362642e96ebba69cee3e7a81b07a
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/20356579700)

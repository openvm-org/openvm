...
|:---|---:|---:|---:|
| Total |  1.12 |  0.62 | 0.62 |
| fibonacci_program |  1.12 |  0.62 |  0.62 |


| fibonacci_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  554.50 |  1,109 |  605 |  504 |
...
| `execute_preflight_insn_mi/s` |  37.78 | -          |  39.91 |  35.66 |
| `trace_gen_time_ms   ` |  189.50 |  379 |  194 |  185 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  231.50 |  463 |  246 |  217 |
| `main_trace_commit_time_ms` |  30.50 |  61 |  33 |  28 |
| `generate_perm_trace_time_ms` |  38.50 |  77 |  43 |  34 |
| `perm_trace_commit_time_ms` |  41.06 |  82.12 |  43.52 |  38.60 |
| `quotient_poly_compute_time_ms` |  30 |  60 |  31.76 |  28.24 |
| `quotient_poly_commit_time_ms` |  12.48 |  24.96 |  13.22 |  11.73 |
| `pcs_opening_time_ms ` |  77 |  154 |  103 |  51 |
...
| --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 504 | 1 | 13 | 1,500,209 | 111.14 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 194 | 605 | 9,677,708 | 84,395,212 | 194 | 217 | 0 | 31.76 | 13.22 | 4 | 43.52 | 51 | 87 | 51 | 0 | 33 | 1,035,986 | 43 | 25 | 873,000 | 35.66 | 14 | 45 | 0 | 51 | 
| fibonacci_program | 1 | 185 | 504 | 9,708,170 | 74,305,770 | 185 | 246 | 1 | 28.24 | 11.73 | 4 | 38.60 | 103 | 73 | 103 | 0 | 28 | 1,064,416 | 34 | 32 | 627,209 | 39.91 | 11 | 40 | 0 | 103 | 

...
| `total_proof_time_ms ` |  1,041 |  2,082 |  1,309 |  773 |
...
| `execute_preflight_time_ms` |  98.50 |  197 |  132 |  65 |
| `execute_preflight_insn_mi/s` |  34.09 | -          |  35.49 |  32.69 |
| `trace_gen_time_ms   ` |  25.50 |  51 |  34 |  17 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  803 |  1,606 |  1,023 |  583 |
| `prover.main_trace_commit_time_ms` |  225 |  450 |  302 |  148 |
| `prover.rap_constraints_time_ms` |  515 |  1,030 |  645 |  385 |
| `prover.openings_time_ms` |  62 |  124 |  75 |  49 |
| `prover.rap_constraints.logup_gkr_time_ms` |  149.50 |  299 |  165 |  134 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/d4d2ec8fc5f6fbd1aea751d06892d2accaa49ec0/kitchen_sink-d4d2ec8fc5f6fbd1aea751d06892d2accaa49ec0.memory.svg)
...
| app_proof |  |  |  |  |  | 773 |  |  | 35 | 2,579,903 | 73.16 | 0 | 2,122 |  | 
...
| leaf | 0 | 114 | 434 | 114 | 24 | 11 | 20 | 4 | 4 | 
...
| leaf | 0 | prover | 428,317,568 | 320 | 130 | 0 | 10 | 144 | 48 | 47 | 37 | 59 | 0 | 43 | 12 | 31 | 7 | 24 | 131 | 144 | 0 | 2 | 58 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 787,664,364 | 1,023 | 301 | 0 | 172 | 645 | 350 | 349 | 128 | 165 | 65 | 75 | 12 | 63 | 16 | 47 | 302 | 645 | 0 | 1 | 99 | 0 | 0 | 
| app_proof | prover | 1 | 700,866,292 | 583 | 148 | 0 | 23 | 385 | 175 | 175 | 75 | 134 | 72 | 49 | 12 | 37 | 14 | 22 | 148 | 385 | 0 | 1 | 60 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 34 | 1,309 | 34 | 185 | 0 | 3 | 65 | 1,540,000 | 32.69 | 
| app_proof | 1 | 17 | 773 | 17 | 40 | 0 | 1 | 132 | 1,039,903 | 35.49 | 

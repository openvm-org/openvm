...
|:---|---:|---:|
| Total | <span style='color: red'>(+0 [+0.5%])</span> 1.54 | <span style='color: red'>(+0 [+0.8%])</span> 0.93 |
| pairing | <span style='color: red'>(+0 [+0.5%])</span> 1.45 | <span style='color: red'>(+0 [+0.7%])</span> 0.84 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+4 [+0.5%])</span> 724.50 | <span style='color: red'>(+7 [+0.5%])</span> 1,449 | <span style='color: red'>(+6 [+0.7%])</span> 835 | <span style='color: red'>(+1 [+0.2%])</span> 614 |
...
| `execute_metered_insn_mi/s` | <span style='color: green'>(-0 [-1.2%])</span> 19.20 | -          | <span style='color: green'>(-0 [-1.2%])</span> 19.20 | <span style='color: green'>(-0 [-1.2%])</span> 19.20 |
...
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+0 [+2.0%])</span> 13.79 | -          | <span style='color: red'>(+1 [+2.9%])</span> 18.40 | <span style='color: red'>(+0 [+0.3%])</span> 9.19 |
| `trace_gen_time_ms   ` | <span style='color: green'>(-2 [-1.1%])</span> 180 | <span style='color: green'>(-4 [-1.1%])</span> 360 | <span style='color: green'>(-3 [-1.5%])</span> 195 | <span style='color: green'>(-1 [-0.6%])</span> 165 |
...
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+6 [+1.7%])</span> 354 | <span style='color: red'>(+12 [+1.7%])</span> 708 | <span style='color: red'>(+8 [+2.1%])</span> 392 | <span style='color: red'>(+4 [+1.3%])</span> 316 |
| `main_trace_commit_time_ms` | <span style='color: green'>(-1 [-1.5%])</span> 65 | <span style='color: green'>(-2 [-1.5%])</span> 130 |  76 | <span style='color: green'>(-2 [-3.6%])</span> 54 |
| `generate_perm_trace_time_ms` | <span style='color: red'>(+8 [+27.0%])</span> 40 | <span style='color: red'>(+17 [+27.0%])</span> 80 | <span style='color: red'>(+12 [+35.3%])</span> 46 | <span style='color: red'>(+5 [+17.2%])</span> 34 |
| `perm_trace_commit_time_ms` | <span style='color: green'>(-1 [-1.3%])</span> 77.11 | <span style='color: green'>(-2 [-1.3%])</span> 154.22 | <span style='color: green'>(-1 [-1.1%])</span> 88.92 | <span style='color: green'>(-1 [-1.6%])</span> 65.30 |
| `quotient_poly_compute_time_ms` |  79.74 |  159.49 | <span style='color: green'>(-1 [-1.2%])</span> 86.80 | <span style='color: red'>(+1 [+1.6%])</span> 72.69 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+0 [+2.2%])</span> 17.08 | <span style='color: red'>(+1 [+2.2%])</span> 34.16 | <span style='color: red'>(+1 [+3.2%])</span> 19.37 | <span style='color: red'>(+0 [+1.0%])</span> 14.79 |
| `pcs_opening_time_ms ` | <span style='color: green'>(-0 [-0.7%])</span> 70 | <span style='color: green'>(-1 [-0.7%])</span> 140 | <span style='color: green'>(-2 [-2.8%])</span> 70 | <span style='color: red'>(+1 [+1.4%])</span> 70 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 614 | 41 | 1 | 90 | 1,745,742 | 19.20 | 148 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 165 | 835 | 32,689,110 | 172,558,444 | 165 | 392 | 0 | 86.80 | 19.37 | 6 | 88.92 | 70 | 138 | 69 | 0 | 76 | 16,059,916 | 46 | 129 | 1,157,000 | 9.19 | 27 | 106 | 1 | 69 | 
| pairing | 1 | 195 | 614 | 22,314,288 | 119,958,502 | 195 | 316 | 1 | 72.69 | 14.79 | 6 | 65.30 | 70 | 102 | 70 | 0 | 54 | 9,408,294 | 34 | 60 | 588,742 | 18.40 | 21 | 88 | 1 | 70 | 

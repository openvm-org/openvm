...
|:---|---:|---:|
| Total | <span style='color: green'>(-0 [-1.9%])</span> 2.37 | <span style='color: green'>(-0 [-2.9%])</span> 0.75 |
| regex_program | <span style='color: green'>(-0 [-1.9%])</span> 2.34 | <span style='color: green'>(-0 [-3.0%])</span> 0.71 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: green'>(-11 [-1.9%])</span> 584.50 | <span style='color: green'>(-45 [-1.9%])</span> 2,338 | <span style='color: green'>(-22 [-3.0%])</span> 711 | <span style='color: green'>(-3 [-0.6%])</span> 530 |
...
| `execute_metered_insn_mi/s` | <span style='color: red'>(+0 [+0.3%])</span> 120.43 | -          | <span style='color: red'>(+0 [+0.3%])</span> 120.43 | <span style='color: red'>(+0 [+0.3%])</span> 120.43 |
| `execute_preflight_insns` |  1,034,343 |  4,137,372 |  1,104,000 |  826,372 |
| `execute_preflight_time_ms` | <span style='color: green'>(-1 [-1.9%])</span> 53 | <span style='color: green'>(-4 [-1.9%])</span> 212 | <span style='color: green'>(-1 [-1.5%])</span> 65 |  45 |
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+1 [+1.7%])</span> 31.54 | -          | <span style='color: red'>(+1 [+2.7%])</span> 32.90 | <span style='color: red'>(+0 [+1.7%])</span> 28.66 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+0 [+0.1%])</span> 179.50 | <span style='color: red'>(+1 [+0.1%])</span> 718 | <span style='color: green'>(-1 [-0.5%])</span> 212 | <span style='color: red'>(+2 [+1.3%])</span> 157 |
| `memory_finalize_time_ms` |  1 |  4 |  4 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: green'>(-11 [-3.8%])</span> 283.50 | <span style='color: green'>(-45 [-3.8%])</span> 1,134 | <span style='color: green'>(-21 [-6.4%])</span> 306 | <span style='color: green'>(-2 [-0.7%])</span> 267 |
| `main_trace_commit_time_ms` | <span style='color: green'>(-0 [-0.5%])</span> 51.50 | <span style='color: green'>(-1 [-0.5%])</span> 206 | <span style='color: green'>(-1 [-1.8%])</span> 55 |  50 |
| `generate_perm_trace_time_ms` | <span style='color: green'>(-11 [-26.2%])</span> 30.25 | <span style='color: green'>(-43 [-26.2%])</span> 121 | <span style='color: green'>(-24 [-37.5%])</span> 40 | <span style='color: green'>(-4 [-15.4%])</span> 22 |
| `perm_trace_commit_time_ms` | <span style='color: green'>(-0 [-0.7%])</span> 63.97 | <span style='color: green'>(-2 [-0.7%])</span> 255.89 | <span style='color: green'>(-2 [-2.8%])</span> 69.99 | <span style='color: red'>(+0 [+0.8%])</span> 55.59 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+0 [+0.1%])</span> 58.53 | <span style='color: red'>(+0 [+0.1%])</span> 234.11 | <span style='color: red'>(+0 [+0.6%])</span> 69.99 | <span style='color: green'>(-1 [-1.2%])</span> 51.48 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+0 [+0.4%])</span> 15.18 | <span style='color: red'>(+0 [+0.4%])</span> 60.70 | <span style='color: red'>(+1 [+4.3%])</span> 18.06 | <span style='color: red'>(+0 [+1.4%])</span> 12.86 |
| `pcs_opening_time_ms ` |  60.75 |  243 | <span style='color: green'>(-18 [-19.1%])</span> 76 | <span style='color: red'>(+5 [+10.4%])</span> 53 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 559 | 40 | 1 | 34 | 4,137,372 | 120.43 | 166 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 212 | 711 | 23,468,048 | 150,778,428 | 212 | 306 | 0 | 60.15 | 18.06 | 6 | 69.99 | 76 | 94 | 76 | 4 | 55 | 10,916,118 | 23 | 45 | 1,103,000 | 28.66 | 21 | 78 | 1 | 76 | 
| regex_program | 1 | 157 | 530 | 11,615,600 | 128,513,066 | 157 | 267 | 1 | 52.48 | 14.38 | 5 | 64.89 | 61 | 87 | 61 | 0 | 50 | 2,207,750 | 22 | 65 | 1,104,000 | 32.59 | 16 | 67 | 0 | 61 | 
| regex_program | 2 | 164 | 538 | 11,604,416 | 128,513,066 | 164 | 274 | 1 | 51.48 | 15.40 | 5 | 65.42 | 53 | 102 | 53 | 0 | 51 | 2,196,886 | 36 | 57 | 1,104,000 | 32.90 | 17 | 67 | 0 | 53 | 
| regex_program | 3 | 185 | 559 | 11,876,674 | 103,522,954 | 185 | 287 | 0 | 69.99 | 12.86 | 5 | 55.59 | 53 | 99 | 53 | 0 | 50 | 2,438,640 | 40 | 45 | 826,372 | 32.02 | 18 | 84 | 1 | 53 | 

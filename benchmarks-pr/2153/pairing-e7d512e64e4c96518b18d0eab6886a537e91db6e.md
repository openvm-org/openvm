...
|:---|---:|---:|
| Total | <span style='color: red'>(+0 [+1.2%])</span> 1.55 | <span style='color: red'>(+0 [+1.0%])</span> 0.93 |
| pairing | <span style='color: red'>(+0 [+0.8%])</span> 1.45 | <span style='color: red'>(+0 [+0.2%])</span> 0.83 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+6 [+0.8%])</span> 727 | <span style='color: red'>(+12 [+0.8%])</span> 1,454 | <span style='color: red'>(+2 [+0.2%])</span> 831 | <span style='color: red'>(+10 [+1.6%])</span> 623 |
| `main_cells_used     ` |  12,734,105 |  25,468,210 |  16,059,916 |  9,408,294 |
| `total_cells_used    ` |  27,501,699 |  55,003,398 |  32,689,110 |  22,314,288 |
| `execute_metered_time_ms` | <span style='color: red'>(+7 [+7.9%])</span> 96 | -          | -          | -          |
| `execute_metered_insn_mi/s` | <span style='color: green'>(-1 [-7.3%])</span> 18.02 | -          | <span style='color: green'>(-1 [-7.3%])</span> 18.02 | <span style='color: green'>(-1 [-7.3%])</span> 18.02 |
| `execute_preflight_insns` |  872,871 |  1,745,742 |  1,157,000 |  588,742 |
| `execute_preflight_time_ms` | <span style='color: green'>(-4 [-3.6%])</span> 92.50 | <span style='color: green'>(-7 [-3.6%])</span> 185 | <span style='color: green'>(-3 [-2.3%])</span> 127 | <span style='color: green'>(-4 [-6.5%])</span> 58 |
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+0 [+2.9%])</span> 13.91 | -          | <span style='color: red'>(+1 [+3.6%])</span> 18.52 | <span style='color: red'>(+0 [+1.5%])</span> 9.30 |
| `trace_gen_time_ms   ` | <span style='color: green'>(-3 [-1.6%])</span> 179 | <span style='color: green'>(-6 [-1.6%])</span> 358 | <span style='color: green'>(-3 [-1.5%])</span> 195 | <span style='color: green'>(-3 [-1.8%])</span> 163 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+13 [+3.7%])</span> 361 | <span style='color: red'>(+26 [+3.7%])</span> 722 | <span style='color: red'>(+10 [+2.6%])</span> 394 | <span style='color: red'>(+16 [+5.1%])</span> 328 |
| `main_trace_commit_time_ms` | <span style='color: green'>(-4 [-6.1%])</span> 62 | <span style='color: green'>(-8 [-6.1%])</span> 124 | <span style='color: green'>(-6 [-7.9%])</span> 70 | <span style='color: green'>(-2 [-3.6%])</span> 54 |
| `generate_perm_trace_time_ms` | <span style='color: red'>(+18 [+55.6%])</span> 49 | <span style='color: red'>(+35 [+55.6%])</span> 98 | <span style='color: red'>(+17 [+50.0%])</span> 51 | <span style='color: red'>(+18 [+62.1%])</span> 47 |
| `perm_trace_commit_time_ms` | <span style='color: green'>(-2 [-2.3%])</span> 76.32 | <span style='color: green'>(-4 [-2.3%])</span> 152.64 | <span style='color: green'>(-1 [-1.0%])</span> 89.03 | <span style='color: green'>(-3 [-4.1%])</span> 63.61 |
| `quotient_poly_compute_time_ms` | <span style='color: green'>(-1 [-1.2%])</span> 78.70 | <span style='color: green'>(-2 [-1.2%])</span> 157.41 | <span style='color: green'>(-0 [-0.5%])</span> 87.35 | <span style='color: green'>(-1 [-2.1%])</span> 70.06 |
| `quotient_poly_commit_time_ms` | <span style='color: green'>(-0 [-1.4%])</span> 16.47 | <span style='color: green'>(-0 [-1.4%])</span> 32.95 | <span style='color: red'>(+0 [+1.0%])</span> 18.95 | <span style='color: green'>(-1 [-4.5%])</span> 13.99 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+3 [+4.3%])</span> 73.50 | <span style='color: red'>(+6 [+4.3%])</span> 147 | <span style='color: red'>(+4 [+5.6%])</span> 76 | <span style='color: red'>(+2 [+2.9%])</span> 71 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 623 | 40 | 1 | 96 | 1,745,742 | 18.02 | 144 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 163 | 831 | 32,689,110 | 172,558,444 | 163 | 394 | 0 | 87.35 | 18.95 | 6 | 89.03 | 76 | 139 | 76 | 0 | 70 | 16,059,916 | 47 | 127 | 1,157,000 | 9.30 | 26 | 107 | 1 | 76 | 
| pairing | 1 | 195 | 623 | 22,314,288 | 119,958,502 | 195 | 328 | 1 | 70.06 | 13.99 | 6 | 63.61 | 71 | 117 | 70 | 1 | 54 | 9,408,294 | 51 | 58 | 588,742 | 18.52 | 20 | 84 | 1 | 70 | 

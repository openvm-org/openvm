...
|:---|---:|---:|
| Total | <span style='color: green'>(-0 [-0.1%])</span> 2.41 | <span style='color: green'>(-0 [-2.3%])</span> 0.75 |
| regex_program |  2.38 | <span style='color: green'>(-0 [-2.3%])</span> 0.72 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  595.25 |  2,381 | <span style='color: green'>(-17 [-2.3%])</span> 716 | <span style='color: red'>(+1 [+0.2%])</span> 534 |
...
| `execute_metered_insn_mi/s` | <span style='color: red'>(+3 [+2.2%])</span> 122.70 | -          | <span style='color: red'>(+3 [+2.2%])</span> 122.70 | <span style='color: red'>(+3 [+2.2%])</span> 122.70 |
| `execute_preflight_insns` |  1,034,343 |  4,137,372 |  1,104,000 |  826,372 |
| `execute_preflight_time_ms` | <span style='color: green'>(-0 [-0.9%])</span> 53.50 | <span style='color: green'>(-2 [-0.9%])</span> 214 | <span style='color: green'>(-1 [-1.5%])</span> 65 |  45 |
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+1 [+2.0%])</span> 31.63 | -          | <span style='color: red'>(+1 [+2.0%])</span> 32.68 | <span style='color: red'>(+1 [+3.2%])</span> 29.08 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+2 [+1.4%])</span> 181.75 | <span style='color: red'>(+10 [+1.4%])</span> 727 | <span style='color: red'>(+5 [+2.3%])</span> 218 | <span style='color: red'>(+3 [+1.9%])</span> 158 |
| `memory_finalize_time_ms` |  1 |  4 |  4 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: green'>(-4 [-1.3%])</span> 291 | <span style='color: green'>(-15 [-1.3%])</span> 1,164 | <span style='color: green'>(-14 [-4.3%])</span> 313 |  269 |
| `main_trace_commit_time_ms` | <span style='color: red'>(+1 [+1.9%])</span> 52.75 | <span style='color: red'>(+4 [+1.9%])</span> 211 | <span style='color: red'>(+2 [+3.6%])</span> 58 | <span style='color: red'>(+1 [+2.0%])</span> 51 |
| `generate_perm_trace_time_ms` | <span style='color: green'>(-4 [-8.5%])</span> 37.50 | <span style='color: green'>(-14 [-8.5%])</span> 150 | <span style='color: green'>(-3 [-4.7%])</span> 61 | <span style='color: green'>(-2 [-7.7%])</span> 24 |
| `perm_trace_commit_time_ms` | <span style='color: red'>(+1 [+1.3%])</span> 65.26 | <span style='color: red'>(+3 [+1.3%])</span> 261.02 | <span style='color: red'>(+0 [+0.4%])</span> 72.26 | <span style='color: red'>(+1 [+2.0%])</span> 56.26 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+2 [+2.6%])</span> 59.94 | <span style='color: red'>(+6 [+2.6%])</span> 239.77 | <span style='color: red'>(+1 [+1.5%])</span> 70.65 | <span style='color: red'>(+1 [+2.4%])</span> 53.33 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+0 [+0.8%])</span> 15.24 | <span style='color: red'>(+1 [+0.8%])</span> 60.96 | <span style='color: red'>(+0 [+0.3%])</span> 17.36 | <span style='color: red'>(+1 [+4.0%])</span> 13.20 |
| `pcs_opening_time_ms ` | <span style='color: green'>(-3 [-5.3%])</span> 57.50 | <span style='color: green'>(-13 [-5.3%])</span> 230 | <span style='color: green'>(-26 [-27.7%])</span> 68 |  48 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 552 | 40 | 1 | 33 | 4,137,372 | 122.70 | 166 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 218 | 716 | 23,468,048 | 150,778,428 | 218 | 303 | 0 | 61.24 | 17.36 | 6 | 72.26 | 68 | 97 | 68 | 4 | 58 | 10,916,118 | 24 | 45 | 1,103,000 | 29.08 | 21 | 79 | 1 | 68 | 
| regex_program | 1 | 158 | 534 | 11,615,600 | 128,513,066 | 158 | 269 | 1 | 53.33 | 15.46 | 5 | 66.83 | 48 | 101 | 47 | 0 | 51 | 2,207,750 | 33 | 65 | 1,104,000 | 32.48 | 16 | 69 | 0 | 47 | 
| regex_program | 2 | 165 | 579 | 11,604,416 | 128,513,066 | 165 | 313 | 1 | 54.54 | 14.93 | 5 | 65.68 | 63 | 127 | 63 | 0 | 51 | 2,196,886 | 61 | 59 | 1,104,000 | 32.26 | 16 | 70 | 0 | 63 | 
| regex_program | 3 | 186 | 552 | 11,876,674 | 103,522,954 | 186 | 279 | 0 | 70.65 | 13.20 | 5 | 56.26 | 51 | 92 | 50 | 0 | 51 | 2,438,640 | 32 | 45 | 826,372 | 32.68 | 18 | 85 | 1 | 50 | 

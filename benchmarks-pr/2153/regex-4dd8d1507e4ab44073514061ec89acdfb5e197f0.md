...
|:---|---:|---:|
| Total |  2.42 | <span style='color: green'>(-0 [-4.6%])</span> 0.73 |
| regex_program |  2.38 | <span style='color: green'>(-0 [-4.8%])</span> 0.70 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  596 |  2,384 | <span style='color: green'>(-35 [-4.8%])</span> 698 | <span style='color: red'>(+5 [+0.9%])</span> 538 |
...
| `execute_metered_insn_mi/s` | <span style='color: red'>(+1 [+0.6%])</span> 120.74 | -          | <span style='color: red'>(+1 [+0.6%])</span> 120.74 | <span style='color: red'>(+1 [+0.6%])</span> 120.74 |
| `execute_preflight_insns` |  1,034,343 |  4,137,372 |  1,104,000 |  826,372 |
| `execute_preflight_time_ms` | <span style='color: green'>(-1 [-1.4%])</span> 53.25 | <span style='color: green'>(-3 [-1.4%])</span> 213 | <span style='color: green'>(-1 [-1.5%])</span> 65 |  45 |
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+0 [+1.5%])</span> 31.47 | -          | <span style='color: red'>(+0 [+1.0%])</span> 32.36 | <span style='color: red'>(+1 [+2.7%])</span> 28.94 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+2 [+1.0%])</span> 181 | <span style='color: red'>(+7 [+1.0%])</span> 724 | <span style='color: red'>(+1 [+0.5%])</span> 214 | <span style='color: red'>(+3 [+1.9%])</span> 158 |
| `memory_finalize_time_ms` |  1 |  4 |  4 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: green'>(-1 [-0.3%])</span> 293.75 | <span style='color: green'>(-4 [-0.3%])</span> 1,175 | <span style='color: red'>(+5 [+1.5%])</span> 332 | <span style='color: red'>(+4 [+1.5%])</span> 273 |
...
| `generate_perm_trace_time_ms` | <span style='color: red'>(+2 [+5.5%])</span> 43.25 | <span style='color: red'>(+9 [+5.5%])</span> 173 | <span style='color: red'>(+17 [+26.6%])</span> 81 | <span style='color: green'>(-2 [-7.7%])</span> 24 |
| `perm_trace_commit_time_ms` | <span style='color: red'>(+0 [+0.8%])</span> 64.94 | <span style='color: red'>(+2 [+0.8%])</span> 259.75 | <span style='color: red'>(+0 [+0.3%])</span> 72.19 | <span style='color: green'>(-1 [-1.0%])</span> 54.60 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+1 [+1.3%])</span> 59.18 | <span style='color: red'>(+3 [+1.3%])</span> 236.73 | <span style='color: red'>(+2 [+3.6%])</span> 72.08 | <span style='color: red'>(+1 [+1.4%])</span> 52.83 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+0 [+1.3%])</span> 15.31 | <span style='color: red'>(+1 [+1.3%])</span> 61.22 | <span style='color: green'>(-0 [-2.6%])</span> 16.87 | <span style='color: red'>(+0 [+0.2%])</span> 12.71 |
| `pcs_opening_time_ms ` | <span style='color: green'>(-6 [-9.5%])</span> 55 | <span style='color: green'>(-23 [-9.5%])</span> 220 | <span style='color: green'>(-31 [-33.0%])</span> 63 |  48 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 551 | 41 | 1 | 34 | 4,137,372 | 120.74 | 167 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 214 | 698 | 23,468,048 | 150,778,428 | 214 | 292 | 0 | 58.80 | 16.87 | 5 | 72.19 | 59 | 97 | 59 | 4 | 58 | 10,916,118 | 24 | 45 | 1,103,000 | 28.94 | 21 | 76 | 1 | 59 | 
| regex_program | 1 | 158 | 538 | 11,615,600 | 128,513,066 | 158 | 273 | 1 | 52.83 | 15.91 | 5 | 66.87 | 48 | 103 | 48 | 0 | 51 | 2,207,750 | 36 | 65 | 1,104,000 | 32.36 | 17 | 69 | 0 | 48 | 
| regex_program | 2 | 166 | 597 | 11,604,416 | 128,513,066 | 166 | 332 | 1 | 53.02 | 15.73 | 5 | 66.10 | 63 | 148 | 63 | 0 | 51 | 2,196,886 | 81 | 58 | 1,104,000 | 32.29 | 17 | 69 | 0 | 63 | 
| regex_program | 3 | 186 | 551 | 11,876,674 | 103,522,954 | 186 | 278 | 0 | 72.08 | 12.71 | 5 | 54.60 | 50 | 90 | 50 | 0 | 51 | 2,438,640 | 32 | 45 | 826,372 | 32.29 | 18 | 85 | 1 | 50 | 

...
|:---|---:|---:|
| Total | <span style='color: green'>(-0 [-0.6%])</span> 2.40 | <span style='color: green'>(-0 [-4.2%])</span> 0.74 |
| regex_program | <span style='color: green'>(-0 [-0.6%])</span> 2.37 | <span style='color: green'>(-0 [-4.4%])</span> 0.70 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: green'>(-4 [-0.6%])</span> 592 | <span style='color: green'>(-15 [-0.6%])</span> 2,368 | <span style='color: green'>(-32 [-4.4%])</span> 701 |  533 |
...
| `execute_metered_insn_mi/s` | <span style='color: red'>(+1 [+1.1%])</span> 121.31 | -          | <span style='color: red'>(+1 [+1.1%])</span> 121.31 | <span style='color: red'>(+1 [+1.1%])</span> 121.31 |
| `execute_preflight_insns` |  1,034,343 |  4,137,372 |  1,104,000 |  826,372 |
| `execute_preflight_time_ms` | <span style='color: green'>(-2 [-3.7%])</span> 52 | <span style='color: green'>(-8 [-3.7%])</span> 208 | <span style='color: green'>(-3 [-4.5%])</span> 63 | <span style='color: green'>(-1 [-2.2%])</span> 44 |
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+2 [+4.9%])</span> 32.51 | -          | <span style='color: red'>(+2 [+5.2%])</span> 33.70 | <span style='color: red'>(+1 [+4.9%])</span> 29.56 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+1 [+0.6%])</span> 180.25 | <span style='color: red'>(+4 [+0.6%])</span> 721 | <span style='color: red'>(+1 [+0.5%])</span> 214 | <span style='color: red'>(+4 [+2.6%])</span> 159 |
| `memory_finalize_time_ms` |  1 |  4 |  4 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: green'>(-4 [-1.2%])</span> 291.25 | <span style='color: green'>(-14 [-1.2%])</span> 1,165 | <span style='color: green'>(-1 [-0.3%])</span> 326 |  269 |
| `main_trace_commit_time_ms` |  51.75 |  207 |  56 | <span style='color: green'>(-1 [-2.0%])</span> 49 |
| `generate_perm_trace_time_ms` | <span style='color: green'>(-9 [-21.3%])</span> 32.25 | <span style='color: green'>(-35 [-21.3%])</span> 129 | <span style='color: green'>(-25 [-39.1%])</span> 39 | <span style='color: green'>(-1 [-3.8%])</span> 25 |
| `perm_trace_commit_time_ms` | <span style='color: red'>(+1 [+1.3%])</span> 65.30 | <span style='color: red'>(+3 [+1.3%])</span> 261.20 | <span style='color: red'>(+1 [+1.6%])</span> 73.14 | <span style='color: red'>(+1 [+1.1%])</span> 55.75 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+0 [+0.3%])</span> 58.64 | <span style='color: red'>(+1 [+0.3%])</span> 234.58 | <span style='color: green'>(-1 [-1.1%])</span> 68.83 | <span style='color: red'>(+0 [+0.7%])</span> 52.47 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+0 [+0.8%])</span> 15.23 | <span style='color: red'>(+0 [+0.8%])</span> 60.91 | <span style='color: green'>(-0 [-1.7%])</span> 17.03 |  12.67 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+4 [+7.0%])</span> 65 | <span style='color: red'>(+17 [+7.0%])</span> 260 | <span style='color: red'>(+5 [+5.3%])</span> 99 |  48 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 545 | 41 | 1 | 34 | 4,137,372 | 121.31 | 170 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 214 | 701 | 23,468,048 | 150,778,428 | 214 | 296 | 0 | 60.39 | 17.03 | 6 | 73.14 | 62 | 99 | 61 | 4 | 56 | 10,916,118 | 25 | 44 | 1,103,000 | 29.56 | 22 | 78 | 1 | 61 | 
| regex_program | 1 | 159 | 533 | 11,615,600 | 128,513,066 | 158 | 269 | 1 | 52.89 | 15.52 | 5 | 66.24 | 48 | 100 | 48 | 0 | 51 | 2,207,750 | 33 | 63 | 1,104,000 | 33.35 | 17 | 69 | 0 | 48 | 
| regex_program | 2 | 164 | 589 | 11,604,416 | 128,513,066 | 164 | 326 | 1 | 52.47 | 15.69 | 5 | 66.07 | 99 | 106 | 99 | 0 | 51 | 2,196,886 | 39 | 57 | 1,104,000 | 33.70 | 17 | 68 | 0 | 99 | 
| regex_program | 3 | 184 | 545 | 11,876,674 | 103,522,954 | 184 | 274 | 0 | 68.83 | 12.67 | 5 | 55.75 | 51 | 91 | 50 | 0 | 49 | 2,438,640 | 32 | 44 | 826,372 | 33.44 | 18 | 82 | 1 | 50 | 

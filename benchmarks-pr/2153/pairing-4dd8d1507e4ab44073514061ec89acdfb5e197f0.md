...
|:---|---:|---:|
| Total | <span style='color: red'>(+0 [+1.9%])</span> 1.56 | <span style='color: red'>(+0 [+1.9%])</span> 0.94 |
| pairing | <span style='color: red'>(+0 [+1.9%])</span> 1.47 | <span style='color: red'>(+0 [+1.9%])</span> 0.85 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+14 [+1.9%])</span> 735 | <span style='color: red'>(+28 [+1.9%])</span> 1,470 | <span style='color: red'>(+16 [+1.9%])</span> 845 | <span style='color: red'>(+12 [+2.0%])</span> 625 |
...
| `execute_metered_insn_mi/s` | <span style='color: green'>(-0 [-0.7%])</span> 19.30 | -          | <span style='color: green'>(-0 [-0.7%])</span> 19.30 | <span style='color: green'>(-0 [-0.7%])</span> 19.30 |
...
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+0 [+2.8%])</span> 13.90 | -          | <span style='color: red'>(+1 [+3.3%])</span> 18.48 | <span style='color: red'>(+0 [+1.7%])</span> 9.32 |
| `trace_gen_time_ms   ` | <span style='color: green'>(-2 [-0.8%])</span> 180.50 | <span style='color: green'>(-3 [-0.8%])</span> 361 | <span style='color: green'>(-2 [-1.0%])</span> 196 | <span style='color: green'>(-1 [-0.6%])</span> 165 |
...
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+20 [+5.6%])</span> 367.50 | <span style='color: red'>(+39 [+5.6%])</span> 735 | <span style='color: red'>(+22 [+5.7%])</span> 406 | <span style='color: red'>(+17 [+5.4%])</span> 329 |
| `main_trace_commit_time_ms` | <span style='color: green'>(-2 [-3.0%])</span> 64 | <span style='color: green'>(-4 [-3.0%])</span> 128 | <span style='color: green'>(-1 [-1.3%])</span> 75 | <span style='color: green'>(-3 [-5.4%])</span> 53 |
| `generate_perm_trace_time_ms` | <span style='color: red'>(+22 [+69.8%])</span> 53.50 | <span style='color: red'>(+44 [+69.8%])</span> 107 | <span style='color: red'>(+28 [+82.4%])</span> 62 | <span style='color: red'>(+16 [+55.2%])</span> 45 |
| `perm_trace_commit_time_ms` | <span style='color: green'>(-2 [-2.1%])</span> 76.49 | <span style='color: green'>(-3 [-2.1%])</span> 152.98 | <span style='color: green'>(-2 [-1.9%])</span> 88.21 | <span style='color: green'>(-2 [-2.4%])</span> 64.78 |
| `quotient_poly_compute_time_ms` | <span style='color: green'>(-1 [-1.3%])</span> 78.66 | <span style='color: green'>(-2 [-1.3%])</span> 157.32 | <span style='color: green'>(-1 [-1.1%])</span> 86.87 | <span style='color: green'>(-1 [-1.5%])</span> 70.45 |
| `quotient_poly_commit_time_ms` | <span style='color: green'>(-0 [-1.9%])</span> 16.39 | <span style='color: green'>(-1 [-1.9%])</span> 32.78 | <span style='color: green'>(-1 [-3.6%])</span> 18.09 | <span style='color: red'>(+0 [+0.3%])</span> 14.69 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 625 | 40 | 1 | 90 | 1,745,742 | 19.30 | 143 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 165 | 845 | 32,689,110 | 172,558,444 | 165 | 406 | 0 | 86.87 | 18.09 | 6 | 88.21 | 71 | 154 | 70 | 0 | 75 | 16,059,916 | 62 | 127 | 1,157,000 | 9.32 | 26 | 105 | 1 | 70 | 
| pairing | 1 | 196 | 625 | 22,314,288 | 119,958,502 | 196 | 329 | 1 | 70.45 | 14.69 | 6 | 64.78 | 76 | 113 | 76 | 0 | 53 | 9,408,294 | 45 | 58 | 588,742 | 18.48 | 20 | 85 | 1 | 76 | 

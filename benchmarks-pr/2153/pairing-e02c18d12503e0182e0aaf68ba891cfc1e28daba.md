...
|:---|---:|---:|
| Total | <span style='color: red'>(+0 [+1.0%])</span> 1.55 | <span style='color: red'>(+0 [+0.3%])</span> 0.92 |
| pairing | <span style='color: red'>(+0 [+1.0%])</span> 1.46 | <span style='color: red'>(+0 [+0.4%])</span> 0.83 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+8 [+1.0%])</span> 728.50 | <span style='color: red'>(+15 [+1.0%])</span> 1,457 | <span style='color: red'>(+3 [+0.4%])</span> 832 | <span style='color: red'>(+12 [+2.0%])</span> 625 |
...
| `execute_preflight_time_ms` | <span style='color: green'>(-2 [-1.6%])</span> 94.50 | <span style='color: green'>(-3 [-1.6%])</span> 189 | <span style='color: green'>(-1 [-0.8%])</span> 129 | <span style='color: green'>(-2 [-3.2%])</span> 60 |
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+0 [+1.9%])</span> 13.79 | -          | <span style='color: red'>(+0 [+2.7%])</span> 18.37 | <span style='color: red'>(+0 [+0.5%])</span> 9.21 |
...
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+14 [+3.9%])</span> 361.50 | <span style='color: red'>(+27 [+3.9%])</span> 723 | <span style='color: red'>(+9 [+2.3%])</span> 393 | <span style='color: red'>(+18 [+5.8%])</span> 330 |
| `main_trace_commit_time_ms` | <span style='color: green'>(-4 [-5.3%])</span> 62.50 | <span style='color: green'>(-7 [-5.3%])</span> 125 | <span style='color: green'>(-5 [-6.6%])</span> 71 | <span style='color: green'>(-2 [-3.6%])</span> 54 |
...
| `perm_trace_commit_time_ms` | <span style='color: green'>(-2 [-2.3%])</span> 76.37 | <span style='color: green'>(-4 [-2.3%])</span> 152.75 | <span style='color: green'>(-2 [-2.2%])</span> 87.93 | <span style='color: green'>(-2 [-2.3%])</span> 64.82 |
| `quotient_poly_compute_time_ms` | <span style='color: green'>(-1 [-1.3%])</span> 78.68 | <span style='color: green'>(-2 [-1.3%])</span> 157.36 | <span style='color: green'>(-1 [-1.2%])</span> 86.76 | <span style='color: green'>(-1 [-1.3%])</span> 70.60 |
| `quotient_poly_commit_time_ms` |  16.72 |  33.44 | <span style='color: red'>(+0 [+0.4%])</span> 18.84 | <span style='color: green'>(-0 [-0.4%])</span> 14.60 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+6 [+7.8%])</span> 76 | <span style='color: red'>(+11 [+7.8%])</span> 152 | <span style='color: red'>(+4 [+5.6%])</span> 76 | <span style='color: red'>(+7 [+10.1%])</span> 76 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 625 | 41 | 1 | 89 | 1,745,742 | 19.45 | 150 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 162 | 832 | 32,689,110 | 172,558,444 | 162 | 393 | 0 | 86.76 | 18.84 | 7 | 87.93 | 76 | 139 | 76 | 1 | 71 | 16,059,916 | 47 | 129 | 1,157,000 | 9.21 | 26 | 106 | 1 | 76 | 
| pairing | 1 | 192 | 625 | 22,314,288 | 119,958,502 | 192 | 330 | 1 | 70.60 | 14.60 | 6 | 64.82 | 76 | 113 | 76 | 0 | 54 | 9,408,294 | 45 | 60 | 588,742 | 18.37 | 20 | 85 | 1 | 76 | 

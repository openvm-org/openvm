...
|:---|---:|---:|
| Total | <span style='color: green'>(-0 [-1.5%])</span> 1.02 | <span style='color: green'>(-0 [-3.2%])</span> 0.58 |
| fibonacci_program | <span style='color: green'>(-0 [-1.5%])</span> 1.01 | <span style='color: green'>(-0 [-3.2%])</span> 0.57 |


| fibonacci_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: green'>(-8 [-1.5%])</span> 504.50 | <span style='color: green'>(-15 [-1.5%])</span> 1,009 | <span style='color: green'>(-19 [-3.2%])</span> 574 | <span style='color: red'>(+4 [+0.9%])</span> 435 |
...
| `execute_metered_insn_mi/s` | <span style='color: red'>(+1 [+0.8%])</span> 146.81 | -          | <span style='color: red'>(+1 [+0.8%])</span> 146.81 | <span style='color: red'>(+1 [+0.8%])</span> 146.81 |
| `execute_preflight_insns` |  750,104.50 |  1,500,209 |  873,000 |  627,209 |
| `execute_preflight_time_ms` |  28.50 |  57 |  32 |  25 |
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+0 [+0.9%])</span> 38.51 | -          | <span style='color: red'>(+1 [+1.5%])</span> 40.69 | <span style='color: red'>(+0 [+0.3%])</span> 36.32 |
...
| `stark_prove_excluding_trace_time_ms` | <span style='color: green'>(-10 [-4.8%])</span> 187 | <span style='color: green'>(-19 [-4.8%])</span> 374 | <span style='color: green'>(-21 [-9.4%])</span> 202 | <span style='color: red'>(+2 [+1.2%])</span> 172 |
...
| `generate_perm_trace_time_ms` | <span style='color: red'>(+3 [+12.0%])</span> 28 | <span style='color: red'>(+6 [+12.0%])</span> 56 | <span style='color: red'>(+4 [+13.3%])</span> 34 | <span style='color: red'>(+2 [+10.0%])</span> 22 |
| `perm_trace_commit_time_ms` | <span style='color: red'>(+0 [+0.7%])</span> 41.22 | <span style='color: red'>(+1 [+0.7%])</span> 82.43 |  43.88 | <span style='color: red'>(+1 [+1.5%])</span> 38.55 |
| `quotient_poly_compute_time_ms` | <span style='color: green'>(-0 [-1.3%])</span> 29.84 | <span style='color: green'>(-1 [-1.3%])</span> 59.68 | <span style='color: red'>(+1 [+1.5%])</span> 33.62 | <span style='color: green'>(-1 [-4.7%])</span> 26.05 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+0 [+2.7%])</span> 12.07 | <span style='color: red'>(+1 [+2.7%])</span> 24.14 | <span style='color: red'>(+0 [+3.2%])</span> 12.63 | <span style='color: red'>(+0 [+2.1%])</span> 11.51 |
| `pcs_opening_time_ms ` | <span style='color: green'>(-13 [-23.0%])</span> 43.50 | <span style='color: green'>(-26 [-23.0%])</span> 87 | <span style='color: green'>(-25 [-36.2%])</span> 44 | <span style='color: green'>(-1 [-2.3%])</span> 43 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 435 | 41 | 1 | 10 | 1,500,209 | 146.81 | 140 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 200 | 574 | 9,677,708 | 84,395,212 | 200 | 202 | 0 | 33.62 | 12.63 | 5 | 43.88 | 43 | 78 | 43 | 0 | 33 | 1,035,986 | 34 | 25 | 873,000 | 36.32 | 14 | 46 | 0 | 43 | 
| fibonacci_program | 1 | 189 | 435 | 9,708,170 | 74,305,770 | 189 | 172 | 1 | 26.05 | 11.51 | 4 | 38.55 | 44 | 61 | 44 | 0 | 28 | 1,064,416 | 22 | 32 | 627,209 | 40.69 | 11 | 37 | 0 | 44 | 

...
| `total_proof_time_ms ` |  588.50 |  2,354 |  745 |  528 |
...
| `execute_preflight_insn_mi/s` |  30.44 | -          |  31.62 |  27.48 |
| `trace_gen_time_ms   ` |  176.50 |  706 |  208 |  154 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  290 |  1,160 |  345 |  266 |
| `main_trace_commit_time_ms` |  51.25 |  205 |  56 |  49 |
| `generate_perm_trace_time_ms` |  34.75 |  139 |  55 |  19 |
| `perm_trace_commit_time_ms` |  63.56 |  254.25 |  69.75 |  55.34 |
| `quotient_poly_compute_time_ms` |  58.67 |  234.68 |  69.67 |  51.98 |
| `quotient_poly_commit_time_ms` |  14.83 |  59.33 |  17.91 |  12.28 |
| `pcs_opening_time_ms ` |  64 |  256 |  84 |  54 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 535 | 41 | 1 | 34 | 4,137,502 | 120.08 | 167 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 208 | 745 | 23,446,148 | 150,778,428 | 208 | 345 | 0 | 59.89 | 17.91 | 5 | 69.75 | 84 | 125 | 84 | 4 | 56 | 10,899,170 | 55 | 47 | 1,103,000 | 27.48 | 22 | 78 | 1 | 84 | 
| regex_program | 1 | 154 | 546 | 11,598,276 | 128,513,066 | 154 | 283 | 1 | 51.98 | 14.49 | 4 | 64.35 | 62 | 103 | 62 | 0 | 49 | 2,196,106 | 39 | 67 | 1,104,000 | 31.25 | 16 | 67 | 0 | 62 | 
| regex_program | 2 | 161 | 528 | 11,579,064 | 128,513,066 | 161 | 266 | 1 | 53.14 | 14.65 | 4 | 64.81 | 54 | 92 | 54 | 0 | 51 | 2,177,334 | 26 | 59 | 1,104,000 | 31.42 | 16 | 68 | 0 | 54 | 
| regex_program | 3 | 183 | 535 | 11,853,872 | 103,456,394 | 183 | 266 | 0 | 69.67 | 12.28 | 5 | 55.34 | 56 | 77 | 56 | 0 | 49 | 2,422,606 | 19 | 45 | 826,502 | 31.62 | 18 | 82 | 1 | 56 | 

...
| `total_proof_time_ms ` |  589.25 |  2,357 |  744 |  535 |
...
| `execute_preflight_insn_mi/s` |  29.93 | -          |  30.90 |  27.44 |
| `trace_gen_time_ms   ` |  176.50 |  706 |  208 |  155 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  291 |  1,164 |  345 |  266 |
| `main_trace_commit_time_ms` |  51.50 |  206 |  56 |  50 |
| `generate_perm_trace_time_ms` |  34 |  136 |  55 |  19 |
| `perm_trace_commit_time_ms` |  63.100 |  255.99 |  69.50 |  55.79 |
| `quotient_poly_compute_time_ms` |  58.81 |  235.25 |  69.72 |  52.27 |
| `quotient_poly_commit_time_ms` |  15.17 |  60.66 |  17.87 |  13.25 |
| `pcs_opening_time_ms ` |  63.75 |  255 |  83 |  52 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 535 | 41 | 1 | 33 | 4,137,502 | 121.70 | 171 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 208 | 744 | 23,446,148 | 150,778,428 | 208 | 345 | 0 | 60.51 | 17.87 | 5 | 69.50 | 83 | 126 | 83 | 4 | 56 | 10,899,170 | 55 | 47 | 1,103,000 | 27.44 | 21 | 79 | 1 | 83 | 
| regex_program | 1 | 155 | 541 | 11,598,276 | 128,513,066 | 155 | 278 | 1 | 52.27 | 14.62 | 4 | 64.54 | 58 | 100 | 58 | 0 | 50 | 2,196,106 | 35 | 66 | 1,104,000 | 30.70 | 16 | 67 | 0 | 58 | 
| regex_program | 2 | 161 | 537 | 11,579,064 | 128,513,066 | 161 | 275 | 1 | 52.75 | 14.92 | 4 | 66.15 | 62 | 94 | 61 | 0 | 50 | 2,177,334 | 27 | 59 | 1,104,000 | 30.90 | 16 | 68 | 0 | 61 | 
| regex_program | 3 | 182 | 535 | 11,853,872 | 103,456,394 | 182 | 266 | 0 | 69.72 | 13.25 | 6 | 55.79 | 52 | 78 | 52 | 0 | 50 | 2,422,606 | 19 | 46 | 826,502 | 30.66 | 18 | 83 | 1 | 52 | 

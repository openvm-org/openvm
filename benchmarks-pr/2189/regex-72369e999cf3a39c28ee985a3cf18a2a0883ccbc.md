...
| `total_proof_time_ms ` |  583 |  2,332 |  711 |  536 |
...
| `execute_metered_insn_mi/s` |  122.19 | -          |  122.19 |  122.19 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  55 |  220 |  68 |  45 |
| `execute_preflight_insn_mi/s` |  30.24 | -          |  31.72 |  27.44 |
| `trace_gen_time_ms   ` |  177.25 |  709 |  210 |  155 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  282.50 |  1,130 |  309 |  265 |
| `main_trace_commit_time_ms` |  52.50 |  210 |  58 |  50 |
| `generate_perm_trace_time_ms` |  32 |  128 |  45 |  19 |
| `perm_trace_commit_time_ms` |  64.08 |  256.34 |  70.56 |  56.15 |
| `quotient_poly_compute_time_ms` |  58.65 |  234.59 |  69.47 |  52.52 |
| `quotient_poly_commit_time_ms` |  14.95 |  59.79 |  17.72 |  13.05 |
| `pcs_opening_time_ms ` |  57.50 |  230 |  62 |  52 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 536 | 40 | 1 | 33 | 4,137,502 | 122.19 | 167 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 210 | 711 | 23,446,148 | 150,778,428 | 210 | 309 | 0 | 60.05 | 17.72 | 5 | 70.56 | 55 | 116 | 55 | 4 | 58 | 10,899,170 | 45 | 47 | 1,103,000 | 27.44 | 21 | 78 | 1 | 55 | 
| regex_program | 1 | 155 | 549 | 11,598,276 | 128,513,066 | 155 | 283 | 1 | 52.55 | 14.67 | 4 | 64.69 | 62 | 103 | 62 | 0 | 50 | 2,196,106 | 37 | 68 | 1,104,000 | 31.19 | 16 | 67 | 0 | 62 | 
| regex_program | 2 | 161 | 536 | 11,579,064 | 128,513,066 | 161 | 273 | 1 | 52.52 | 14.35 | 4 | 64.94 | 61 | 92 | 61 | 0 | 51 | 2,177,334 | 27 | 60 | 1,104,000 | 30.61 | 16 | 67 | 0 | 61 | 
| regex_program | 3 | 183 | 536 | 11,853,872 | 103,456,394 | 183 | 265 | 0 | 69.47 | 13.05 | 5 | 56.15 | 52 | 78 | 52 | 0 | 51 | 2,422,606 | 19 | 45 | 826,502 | 31.72 | 18 | 83 | 1 | 52 | 

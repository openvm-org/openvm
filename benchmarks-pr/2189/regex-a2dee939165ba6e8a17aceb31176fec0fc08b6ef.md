...
| `total_proof_time_ms ` |  591.25 |  2,365 |  743 |  533 |
...
| `execute_metered_insn_mi/s` |  121.06 | -          |  121.06 |  121.06 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  54.75 |  219 |  66 |  46 |
| `execute_preflight_insn_mi/s` |  29.100 | -          |  30.93 |  27.49 |
| `trace_gen_time_ms   ` |  178.50 |  714 |  212 |  157 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  290.25 |  1,161 |  338 |  263 |
| `main_trace_commit_time_ms` |  51.75 |  207 |  57 |  50 |
| `generate_perm_trace_time_ms` |  34.75 |  139 |  55 |  19 |
| `perm_trace_commit_time_ms` |  64.54 |  258.16 |  71.39 |  55.44 |
| `quotient_poly_compute_time_ms` |  57.74 |  230.94 |  69.44 |  51.54 |
| `quotient_poly_commit_time_ms` |  14.97 |  59.87 |  16.68 |  12.41 |
| `pcs_opening_time_ms ` |  63.25 |  253 |  77 |  51 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 533 | 40 | 1 | 34 | 4,137,502 | 121.06 | 166 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 212 | 743 | 23,446,148 | 150,778,428 | 212 | 338 | 0 | 58.26 | 16.68 | 5 | 71.39 | 77 | 127 | 77 | 4 | 57 | 10,899,170 | 55 | 47 | 1,103,000 | 27.49 | 21 | 75 | 1 | 77 | 
| regex_program | 1 | 157 | 551 | 11,598,276 | 128,513,066 | 157 | 286 | 1 | 51.70 | 15.39 | 4 | 65.69 | 63 | 104 | 63 | 0 | 50 | 2,196,106 | 38 | 66 | 1,104,000 | 30.93 | 17 | 67 | 0 | 63 | 
| regex_program | 2 | 162 | 538 | 11,579,064 | 128,513,066 | 162 | 274 | 1 | 51.54 | 15.39 | 4 | 65.64 | 62 | 93 | 62 | 0 | 50 | 2,177,334 | 27 | 60 | 1,104,000 | 30.76 | 17 | 67 | 0 | 62 | 
| regex_program | 3 | 183 | 533 | 11,853,872 | 103,456,394 | 183 | 263 | 0 | 69.44 | 12.41 | 5 | 55.44 | 51 | 78 | 51 | 0 | 50 | 2,422,606 | 19 | 46 | 826,502 | 30.79 | 18 | 82 | 1 | 51 | 
...
Commit: https://github.com/openvm-org/openvm/commit/a2dee939165ba6e8a17aceb31176fec0fc08b6ef
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19048013803)

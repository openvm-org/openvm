...
| `total_proof_time_ms ` |  724.50 |  1,449 |  832 |  617 |
...
| `execute_preflight_insn_mi/s` |  12.65 | -          |  16.48 |  8.81 |
| `trace_gen_time_ms   ` |  174.50 |  349 |  193 |  156 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  357.50 |  715 |  397 |  318 |
| `main_trace_commit_time_ms` |  65 |  130 |  76 |  54 |
| `generate_perm_trace_time_ms` |  46 |  92 |  47 |  45 |
| `perm_trace_commit_time_ms` |  78.21 |  156.42 |  90.80 |  65.62 |
| `quotient_poly_compute_time_ms` |  80.03 |  160.06 |  88.44 |  71.62 |
| `quotient_poly_commit_time_ms` |  17.13 |  34.26 |  19.22 |  15.04 |
| `pcs_opening_time_ms ` |  66.50 |  133 |  71 |  62 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 617 | 41 | 1 | 89 | 1,745,742 | 19.44 | 146 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 156 | 832 | 32,689,110 | 172,558,444 | 156 | 397 | 0 | 88.44 | 19.22 | 6 | 90.80 | 71 | 141 | 71 | 1 | 76 | 16,059,916 | 47 | 134 | 1,157,000 | 8.81 | 27 | 108 | 1 | 71 | 
| pairing | 1 | 193 | 617 | 22,314,288 | 119,958,502 | 193 | 318 | 1 | 71.62 | 15.04 | 6 | 65.62 | 62 | 114 | 62 | 0 | 54 | 9,408,294 | 45 | 64 | 588,742 | 16.48 | 20 | 87 | 1 | 62 | 

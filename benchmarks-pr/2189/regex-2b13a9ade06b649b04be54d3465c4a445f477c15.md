...
| `total_proof_time_ms ` |  579.75 |  2,319 |  712 |  531 |
...
| `execute_metered_insn_mi/s` |  119.94 | -          |  119.94 |  119.94 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  54.75 |  219 |  66 |  46 |
| `execute_preflight_insn_mi/s` |  30.09 | -          |  31.24 |  27.41 |
| `trace_gen_time_ms   ` |  176 |  704 |  208 |  153 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  281.75 |  1,127 |  313 |  261 |
| `main_trace_commit_time_ms` |  51 |  204 |  57 |  49 |
| `generate_perm_trace_time_ms` |  34.25 |  137 |  55 |  19 |
| `perm_trace_commit_time_ms` |  63.96 |  255.83 |  70.46 |  54.44 |
| `quotient_poly_compute_time_ms` |  58.13 |  232.50 |  70.76 |  51.86 |
| `quotient_poly_commit_time_ms` |  14.88 |  59.53 |  16.58 |  12.64 |
| `pcs_opening_time_ms ` |  56.50 |  226 |  63 |  51 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 531 | 41 | 1 | 34 | 4,137,502 | 119.94 | 168 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 208 | 712 | 23,446,148 | 150,778,428 | 208 | 313 | 0 | 57.07 | 16.58 | 5 | 70.46 | 54 | 126 | 54 | 4 | 57 | 10,899,170 | 55 | 47 | 1,103,000 | 27.41 | 21 | 74 | 1 | 54 | 
| regex_program | 1 | 153 | 538 | 11,598,276 | 128,513,066 | 153 | 277 | 1 | 52.81 | 14.64 | 4 | 64.69 | 58 | 100 | 58 | 0 | 49 | 2,196,106 | 35 | 66 | 1,104,000 | 30.70 | 16 | 68 | 0 | 58 | 
| regex_program | 2 | 161 | 538 | 11,579,064 | 128,513,066 | 161 | 276 | 1 | 51.86 | 15.67 | 4 | 66.24 | 63 | 94 | 62 | 0 | 49 | 2,177,334 | 28 | 60 | 1,104,000 | 31.01 | 17 | 68 | 0 | 62 | 
| regex_program | 3 | 182 | 531 | 11,853,872 | 103,456,394 | 182 | 261 | 0 | 70.76 | 12.64 | 5 | 54.44 | 51 | 77 | 50 | 0 | 49 | 2,422,606 | 19 | 46 | 826,502 | 31.24 | 18 | 84 | 1 | 50 | 
...
Commit: https://github.com/openvm-org/openvm/commit/2b13a9ade06b649b04be54d3465c4a445f477c15
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19048586125)

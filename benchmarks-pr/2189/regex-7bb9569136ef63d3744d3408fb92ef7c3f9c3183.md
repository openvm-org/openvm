...
| `total_proof_time_ms ` |  595.75 |  2,383 |  749 |  541 |
...
| `execute_metered_insn_mi/s` |  121.79 | -          |  121.79 |  121.79 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  55.25 |  221 |  66 |  46 |
| `execute_preflight_insn_mi/s` |  29.57 | -          |  30.72 |  26.62 |
| `trace_gen_time_ms   ` |  178 |  712 |  210 |  156 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  295 |  1,180 |  345 |  270 |
| `main_trace_commit_time_ms` |  51.75 |  207 |  56 |  50 |
| `generate_perm_trace_time_ms` |  35.50 |  142 |  56 |  20 |
| `perm_trace_commit_time_ms` |  64.68 |  258.72 |  70.24 |  55.63 |
| `quotient_poly_compute_time_ms` |  58.72 |  234.89 |  69.100 |  51.81 |
| `quotient_poly_commit_time_ms` |  15.42 |  61.70 |  17.16 |  12.95 |
| `pcs_opening_time_ms ` |  66 |  264 |  82 |  56 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 541 | 40 | 1 | 33 | 4,137,502 | 121.79 | 168 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 210 | 749 | 23,446,148 | 150,778,428 | 210 | 345 | 0 | 59.84 | 17.16 | 5 | 70.24 | 82 | 127 | 82 | 4 | 56 | 10,899,170 | 56 | 49 | 1,103,000 | 26.62 | 21 | 77 | 1 | 82 | 
| regex_program | 1 | 156 | 552 | 11,598,276 | 128,513,066 | 156 | 288 | 1 | 51.81 | 15.89 | 4 | 65.98 | 64 | 104 | 63 | 0 | 51 | 2,196,106 | 38 | 66 | 1,104,000 | 30.42 | 17 | 68 | 0 | 63 | 
| regex_program | 2 | 162 | 541 | 11,579,064 | 128,513,066 | 162 | 277 | 1 | 53.25 | 15.68 | 4 | 66.87 | 62 | 95 | 61 | 0 | 50 | 2,177,334 | 28 | 60 | 1,104,000 | 30.72 | 16 | 69 | 0 | 61 | 
| regex_program | 3 | 184 | 541 | 11,853,872 | 103,456,394 | 184 | 270 | 0 | 69.100 | 12.95 | 5 | 55.63 | 56 | 78 | 56 | 0 | 50 | 2,422,606 | 20 | 46 | 826,502 | 30.52 | 18 | 83 | 1 | 56 | 

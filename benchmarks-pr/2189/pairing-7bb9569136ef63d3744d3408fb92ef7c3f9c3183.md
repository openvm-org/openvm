...
| `total_proof_time_ms ` |  721.50 |  1,443 |  839 |  604 |
...
| `execute_preflight_time_ms` |  100 |  200 |  133 |  67 |
| `execute_preflight_insn_mi/s` |  13.32 | -          |  17.69 |  8.95 |
| `trace_gen_time_ms   ` |  174 |  348 |  190 |  158 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  353.50 |  707 |  401 |  306 |
| `main_trace_commit_time_ms` |  65 |  130 |  76 |  54 |
| `generate_perm_trace_time_ms` |  39 |  78 |  41 |  37 |
| `perm_trace_commit_time_ms` |  76.95 |  153.89 |  89.12 |  64.78 |
| `quotient_poly_compute_time_ms` |  80.04 |  160.08 |  88.36 |  71.72 |
| `quotient_poly_commit_time_ms` |  16.62 |  33.24 |  19.03 |  14.21 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 604 | 40 | 1 | 90 | 1,745,742 | 19.35 | 147 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 158 | 839 | 32,689,110 | 172,558,444 | 158 | 401 | 0 | 88.36 | 19.03 | 6 | 89.12 | 86 | 130 | 86 | 1 | 76 | 16,059,916 | 37 | 133 | 1,157,000 | 8.95 | 26 | 108 | 1 | 86 | 
| pairing | 1 | 190 | 604 | 22,314,288 | 119,958,502 | 190 | 306 | 1 | 71.72 | 14.21 | 5 | 64.78 | 56 | 108 | 56 | 0 | 54 | 9,408,294 | 41 | 67 | 588,742 | 17.69 | 21 | 86 | 1 | 56 | 

...
| `total_proof_time_ms ` |  711 |  1,422 |  814 |  608 |
...
| `execute_preflight_insn_mi/s` |  13.58 | -          |  18.06 |  9.11 |
| `trace_gen_time_ms   ` |  180 |  360 |  199 |  161 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  343 |  686 |  379 |  307 |
| `main_trace_commit_time_ms` |  65.50 |  131 |  75 |  56 |
| `generate_perm_trace_time_ms` |  38.50 |  77 |  41 |  36 |
| `perm_trace_commit_time_ms` |  77.76 |  155.52 |  89.88 |  65.64 |
| `quotient_poly_compute_time_ms` |  80.06 |  160.12 |  88.83 |  71.29 |
| `quotient_poly_commit_time_ms` |  16.17 |  32.34 |  17.88 |  14.46 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 608 | 40 | 1 | 89 | 1,745,742 | 19.52 | 145 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 161 | 814 | 32,689,110 | 172,558,444 | 161 | 379 | 0 | 88.83 | 17.88 | 6 | 89.88 | 67 | 129 | 66 | 1 | 75 | 16,059,916 | 36 | 130 | 1,157,000 | 9.11 | 26 | 107 | 1 | 66 | 
| pairing | 1 | 199 | 608 | 22,314,288 | 119,958,502 | 199 | 307 | 1 | 71.29 | 14.46 | 6 | 65.64 | 55 | 110 | 54 | 0 | 56 | 9,408,294 | 41 | 60 | 588,742 | 18.06 | 20 | 86 | 1 | 54 | 

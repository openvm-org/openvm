...
| `total_proof_time_ms ` |  574 |  2,296 |  695 |  522 |
...
| `execute_metered_insn_mi/s` |  120.63 | -          |  120.63 |  120.63 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  54.75 |  219 |  67 |  46 |
| `execute_preflight_insn_mi/s` |  29.96 | -          |  31.07 |  27 |
| `trace_gen_time_ms   ` |  175 |  700 |  207 |  153 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  276.75 |  1,107 |  296 |  261 |
| `main_trace_commit_time_ms` |  51.50 |  206 |  57 |  49 |
| `generate_perm_trace_time_ms` |  30.25 |  121 |  49 |  19 |
| `perm_trace_commit_time_ms` |  64.57 |  258.29 |  70.50 |  55.63 |
| `quotient_poly_compute_time_ms` |  58.48 |  233.93 |  69.19 |  52.06 |
| `quotient_poly_commit_time_ms` |  15.43 |  61.72 |  17.32 |  13.28 |
| `pcs_opening_time_ms ` |  53 |  212 |  59 |  47 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 537 | 41 | 1 | 34 | 4,137,502 | 120.63 | 166 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 207 | 695 | 23,446,148 | 150,778,428 | 207 | 296 | 0 | 60.38 | 17.32 | 5 | 70.50 | 59 | 100 | 59 | 4 | 57 | 10,899,170 | 28 | 47 | 1,103,000 | 27 | 21 | 78 | 1 | 59 | 
| regex_program | 1 | 153 | 542 | 11,598,276 | 128,513,066 | 153 | 281 | 1 | 52.06 | 15.54 | 4 | 65.84 | 47 | 115 | 47 | 0 | 49 | 2,196,106 | 49 | 67 | 1,104,000 | 31.07 | 16 | 68 | 0 | 47 | 
| regex_program | 2 | 160 | 522 | 11,579,064 | 128,513,066 | 160 | 261 | 1 | 52.30 | 15.59 | 4 | 66.32 | 50 | 92 | 50 | 0 | 50 | 2,177,334 | 25 | 59 | 1,104,000 | 30.94 | 16 | 68 | 0 | 50 | 
| regex_program | 3 | 180 | 537 | 11,853,872 | 103,456,394 | 180 | 269 | 0 | 69.19 | 13.28 | 5 | 55.63 | 56 | 77 | 56 | 0 | 50 | 2,422,606 | 19 | 46 | 826,502 | 30.82 | 18 | 83 | 1 | 56 | 
...
Commit: https://github.com/openvm-org/openvm/commit/62ab1150923b52d04de038312be1f15dd98d9220
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19042429877)

...
| `total_proof_time_ms ` |  706.50 |  1,413 |  812 |  601 |
...
| `execute_preflight_insn_mi/s` |  12.86 | -          |  16.90 |  8.82 |
| `trace_gen_time_ms   ` |  174 |  348 |  190 |  158 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  340.50 |  681 |  375 |  306 |
| `main_trace_commit_time_ms` |  63.50 |  127 |  74 |  53 |
| `generate_perm_trace_time_ms` |  37.50 |  75 |  40 |  35 |
| `perm_trace_commit_time_ms` |  76.20 |  152.39 |  88.49 |  63.90 |
| `quotient_poly_compute_time_ms` |  79.21 |  158.43 |  87.36 |  71.07 |
| `quotient_poly_commit_time_ms` |  16.15 |  32.30 |  17.82 |  14.48 |
| `pcs_opening_time_ms ` |  62.50 |  125 |  66 |  59 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 601 | 40 | 1 | 89 | 1,745,742 | 19.56 | 147 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 158 | 812 | 32,689,110 | 172,558,444 | 158 | 375 | 0 | 87.36 | 17.82 | 6 | 88.49 | 66 | 127 | 66 | 1 | 74 | 16,059,916 | 35 | 135 | 1,157,000 | 8.82 | 26 | 106 | 1 | 66 | 
| pairing | 1 | 190 | 601 | 22,314,288 | 119,958,502 | 190 | 306 | 1 | 71.07 | 14.48 | 6 | 63.90 | 59 | 107 | 59 | 0 | 53 | 9,408,294 | 40 | 63 | 588,742 | 16.90 | 20 | 86 | 1 | 59 | 

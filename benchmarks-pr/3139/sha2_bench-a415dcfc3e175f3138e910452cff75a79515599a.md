...
|:---|---:|---:|---:|
| Total | <span style='color: green'>(-1 [-14.5%])</span> 5.43 | <span style='color: red'>(+1 [+16.0%])</span> 4.10 | <span style='color: red'>(+1 [+16.0%])</span> 4.10 |
| app_proof | <span style='color: green'>(-1 [-15.8%])</span> 4.47 | <span style='color: red'>(+1 [+25.1%])</span> 3.14 | <span style='color: red'>(+1 [+25.1%])</span> 3.14 |
| leaf | <span style='color: green'>(-0 [-9.2%])</span> 0.53 | <span style='color: green'>(-0 [-9.2%])</span> 0.53 | <span style='color: green'>(-0 [-9.2%])</span> 0.53 |
...
| `total_proof_time_ms ` | <span style='color: red'>(+456 [+26.1%])</span> 2,203.50 | <span style='color: green'>(-836 [-15.9%])</span> 4,407 | <span style='color: red'>(+1018 [+53.6%])</span> 2,916 | <span style='color: green'>(-155 [-9.4%])</span> 1,491 |
| `compile_metered_time_ms` |  0 |  0 |  0 |  0 |
| `execute_metered_time_ms` | <span style='color: green'>(-17 [-21.8%])</span> 61 | -          | -          | -          |
| `execute_metered_insns` | <span style='color: green'>(-3625999 [-24.5%])</span> 11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` | <span style='color: green'>(-9 [-4.6%])</span> 180.85 | -          | <span style='color: green'>(-9 [-4.6%])</span> 180.85 | <span style='color: green'>(-9 [-4.6%])</span> 180.85 |
| `set_initial_memory_time_ms` | <span style='color: green'>(-58 [-94.3%])</span> 3.50 | <span style='color: green'>(-177 [-96.2%])</span> 7 | <span style='color: green'>(-120 [-96.8%])</span> 4 | <span style='color: green'>(-27 [-90.0%])</span> 3 |
...
| `execute_preflight_time_ms` | <span style='color: green'>(-58 [-18.6%])</span> 256.50 | <span style='color: green'>(-432 [-45.7%])</span> 513 | <span style='color: green'>(-140 [-28.7%])</span> 348 | <span style='color: red'>(+7 [+4.4%])</span> 165 |
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+6 [+39.1%])</span> 21.77 | -          | <span style='color: green'>(-30 [-55.3%])</span> 24.29 | <span style='color: green'>(-22 [-51.8%])</span> 20.49 |
| `postflight_time_ms  ` |  129.50 |  259 |  190 |  69 |
| `postflight_memory_chronology_time_ms` |  12 |  24 |  20 |  4 |
| `postflight_program_index_time_ms` |  1 |  2 |  1 |  1 |
| `trace_gen_time_ms   ` | <span style='color: green'>(-1 [-1.5%])</span> 53.50 | <span style='color: green'>(-56 [-34.4%])</span> 107 | <span style='color: red'>(+15 [+25.0%])</span> 75 | <span style='color: green'>(-17 [-34.7%])</span> 32 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+407 [+30.9%])</span> 1,722 | <span style='color: green'>(-502 [-12.7%])</span> 3,444 | <span style='color: red'>(+924 [+69.7%])</span> 2,249 | <span style='color: green'>(-107 [-8.2%])</span> 1,195 |
| `prover.main_trace_commit_time_ms` | <span style='color: red'>(+143 [+59.6%])</span> 382.50 | <span style='color: red'>(+46 [+6.4%])</span> 765 | <span style='color: red'>(+264 [+90.4%])</span> 556 | <span style='color: green'>(-4 [-1.9%])</span> 209 |
| `prover.rap_constraints_time_ms` | <span style='color: red'>(+190 [+21.5%])</span> 1,075 | <span style='color: green'>(-504 [-19.0%])</span> 2,150 | <span style='color: red'>(+436 [+47.3%])</span> 1,358 | <span style='color: green'>(-23 [-2.8%])</span> 792 |
| `prover.openings_time_ms` | <span style='color: red'>(+74 [+38.7%])</span> 263.50 | <span style='color: green'>(-43 [-7.5%])</span> 527 | <span style='color: red'>(+140 [+72.2%])</span> 334 | <span style='color: red'>(+5 [+2.7%])</span> 193 |
| `prover.rap_constraints.logup_gkr_time_ms` | <span style='color: red'>(+27 [+12.1%])</span> 249.50 | <span style='color: green'>(-169 [-25.3%])</span> 499 | <span style='color: red'>(+51 [+22.9%])</span> 274 | <span style='color: red'>(+3 [+1.4%])</span> 225 |
| `prover.rap_constraints.round0_time_ms` | <span style='color: red'>(+114 [+21.5%])</span> 643.50 | <span style='color: green'>(-302 [-19.0%])</span> 1,287 | <span style='color: red'>(+280 [+49.4%])</span> 847 | <span style='color: green'>(-19 [-4.1%])</span> 440 |
| `prover.rap_constraints.mle_rounds_time_ms` | <span style='color: red'>(+50 [+38.2%])</span> 181 | <span style='color: green'>(-31 [-7.9%])</span> 362 | <span style='color: red'>(+105 [+80.2%])</span> 236 | <span style='color: green'>(-5 [-3.8%])</span> 126 |
| `prover.openings.stacked_reduction_time_ms` | <span style='color: red'>(+20 [+38.3%])</span> 71 | <span style='color: green'>(-12 [-7.8%])</span> 142 | <span style='color: red'>(+40 [+76.9%])</span> 92 | <span style='color: green'>(-1 [-2.0%])</span> 50 |
| `prover.openings.stacked_reduction.round0_time_ms` | <span style='color: red'>(+12 [+38.7%])</span> 43 | <span style='color: green'>(-7 [-7.5%])</span> 86 | <span style='color: red'>(+26 [+83.9%])</span> 57 | <span style='color: green'>(-2 [-6.5%])</span> 29 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` | <span style='color: red'>(+7 [+35.2%])</span> 27.50 | <span style='color: green'>(-6 [-9.8%])</span> 55 | <span style='color: red'>(+14 [+66.7%])</span> 35 |  20 |
| `prover.openings.whir_time_ms` | <span style='color: red'>(+53 [+38.4%])</span> 191.50 | <span style='color: green'>(-32 [-7.7%])</span> 383 | <span style='color: red'>(+100 [+70.9%])</span> 241 | <span style='color: red'>(+5 [+3.6%])</span> 142 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: green'>(-54 [-9.2%])</span> 532 | <span style='color: green'>(-54 [-9.2%])</span> 532 | <span style='color: green'>(-54 [-9.2%])</span> 532 | <span style='color: green'>(-54 [-9.2%])</span> 532 |
| `execute_preflight_time_ms` |  2 |  2 |  2 |  2 |
| `trace_gen_time_ms   ` | <span style='color: green'>(-2 [-1.7%])</span> 117 | <span style='color: green'>(-2 [-1.7%])</span> 117 | <span style='color: green'>(-2 [-1.7%])</span> 117 | <span style='color: green'>(-2 [-1.7%])</span> 117 |
| `generate_blob_total_time_ms` |  12 |  12 |  12 |  12 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` | <span style='color: green'>(-53 [-11.3%])</span> 414 | <span style='color: green'>(-53 [-11.3%])</span> 414 | <span style='color: green'>(-53 [-11.3%])</span> 414 | <span style='color: green'>(-53 [-11.3%])</span> 414 |
| `prover.main_trace_commit_time_ms` | <span style='color: green'>(-12 [-7.7%])</span> 143 | <span style='color: green'>(-12 [-7.7%])</span> 143 | <span style='color: green'>(-12 [-7.7%])</span> 143 | <span style='color: green'>(-12 [-7.7%])</span> 143 |
...
| `prover.openings_time_ms` | <span style='color: green'>(-11 [-8.8%])</span> 114 | <span style='color: green'>(-11 [-8.8%])</span> 114 | <span style='color: green'>(-11 [-8.8%])</span> 114 | <span style='color: green'>(-11 [-8.8%])</span> 114 |
| `prover.rap_constraints.logup_gkr_time_ms` | <span style='color: green'>(-12 [-30.0%])</span> 28 | <span style='color: green'>(-12 [-30.0%])</span> 28 | <span style='color: green'>(-12 [-30.0%])</span> 28 | <span style='color: green'>(-12 [-30.0%])</span> 28 |
...
| `prover.openings.whir_time_ms` | <span style='color: green'>(-10 [-9.8%])</span> 92 | <span style='color: green'>(-10 [-9.8%])</span> 92 | <span style='color: green'>(-10 [-9.8%])</span> 92 | <span style='color: green'>(-10 [-9.8%])</span> 92 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/a415dcfc3e175f3138e910452cff75a79515599a/sha2_bench-a415dcfc3e175f3138e910452cff75a79515599a.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,627,133 | 177 | 45 | 0 | 0 | 80 | 28 | 28 | 37 | 13 | 0 | 51 | 40 | 10 | 2 | 7 | 45 | 45 | 80 | 0 | 1 | 13 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,386,961 | 111 | 19 | 0 | 0 | 57 | 22 | 21 | 23 | 11 | 0 | 33 | 25 | 7 | 1 | 6 | 20 | 19 | 57 | 0 | 1 | 10 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,759,057 | 95 | 14 | 0 | 0 | 54 | 20 | 19 | 21 | 12 | 0 | 25 | 18 | 7 | 1 | 5 | 14 | 14 | 54 | 0 | 1 | 10 | 0 | 0 | 
| leaf | 0 | prover | 237,994,808 | 414 | 142 | 0 | 0 | 156 | 83 | 81 | 44 | 28 | 0 | 114 | 92 | 21 | 10 | 11 | 143 | 142 | 156 | 0 | 3 | 27 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover |  | 0 | 1,281,523,083 | 2,249 | 556 | 0 | 0 | 1,358 | 847 | 846 | 236 | 274 | 1 | 334 | 241 | 92 | 57 | 35 | 556 | 556 | 1,358 | 0 | 1 | 272 | 0 | 0 | 
| app_proof | prover |  | 1 | 687,699,844 | 1,195 | 209 | 0 | 0 | 792 | 440 | 439 | 126 | 225 | 0 | 193 | 142 | 50 | 29 | 20 | 209 | 209 | 792 | 0 | 1 | 224 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof |  | 1,491 | 61 | 11,167,961 | 180.85 | 0 | 4,474 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof |  | 0 | 4 | 2 | 75 | 2,916 | 5 | 4 | 0 | 190 | 1 | 20 | 0 | 125,829,120 | 10,960,542,912 | 10,267,656,192 | 12,915,749,568 | 3,171,807,276 | 16,087,556,844 | 9,383,484,608 | 10,960,542,912 | 2 | 0 | 2 | 5 | 69 | 348 | 7,136,000 | 20.49 | 0 | 0 | 
| app_proof |  | 1 | 3 | 2 | 32 | 1,491 | 3 | 3 | 0 | 69 | 1 | 4 | 0 | 125,829,120 | 6,812,188,528 | 5,519,704,064 | 7,305,829,524 | 2,259,069,164 | 9,564,898,688 | 6,057,508,928 | 6,812,188,528 | 2 | 0 | 0 | 2 | 29 | 165 | 4,031,961 | 24.29 | 0 | 0 | 

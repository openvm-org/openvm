...
|:---|---:|---:|---:|
| Total |  4.54 |  2.36 |  2.36 |
| app_proof |  3.18 |  0.100 |  0.100 |
| leaf |  0.69 |  0.69 |  0.69 |
...
| `total_proof_time_ms ` |  778.25 |  3,113 |  929 |  563 |
| `execute_metered_time_ms` |  66 | -          | -          | -          |
| `execute_metered_insns` |  12,000,265 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  179.32 | -          |  179.32 |  179.32 |
| `execute_preflight_insns` |  3,000,066.25 |  12,000,265 |  3,495,000 |  1,515,265 |
| `execute_preflight_time_ms` |  81.75 |  327 |  101 |  42 |
| `execute_preflight_insn_mi/s` |  49.58 | -          |  50.59 |  46.60 |
| `trace_gen_time_ms   ` |  146.75 |  587 |  180 |  129 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  479.25 |  1,917 |  543 |  299 |
| `prover.main_trace_commit_time_ms` |  100.75 |  403 |  116 |  59 |
| `prover.rap_constraints_time_ms` |  275.50 |  1,102 |  313 |  171 |
| `prover.openings_time_ms` |  102 |  408 |  118 |  67 |
| `prover.rap_constraints.logup_gkr_time_ms` |  197 |  788 |  226 |  118 |
| `prover.rap_constraints.round0_time_ms` |  52.75 |  211 |  62 |  34 |
| `prover.rap_constraints.mle_rounds_time_ms` |  24.75 |  99 |  27 |  18 |
| `prover.openings.stacked_reduction_time_ms` |  19.25 |  77 |  22 |  12 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/fb8eea9f49e6f762162ff235bf11aec9feb62ff2/fibonacci-fb8eea9f49e6f762162ff235bf11aec9feb62ff2.memory.svg)
...
| app_proof |  |  |  |  |  | 563 |  |  | 66 | 12,000,265 | 179.32 | 0 | 3,187 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 327 | 119 | 0 | 0 | 107 | 34 | 34 | 51 | 20 | 0 | 100 | 86 | 13 | 3 | 9 | 119 | 107 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 171 | 48 | 0 | 0 | 67 | 24 | 24 | 28 | 14 | 0 | 55 | 46 | 8 | 1 | 6 | 48 | 67 | 0 | 3 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 140 | 32 | 0 | 0 | 60 | 22 | 21 | 24 | 14 | 0 | 46 | 39 | 7 | 1 | 5 | 32 | 60 | 0 | 3 | 12 | 0 | 0 | 
| leaf | 0 | prover | 147,934,254 | 618 | 236 | 0 | 0 | 187 | 86 | 85 | 54 | 45 | 0 | 194 | 169 | 24 | 12 | 12 | 236 | 187 | 0 | 8 | 44 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 136,618,054 | 542 | 114 | 0 | 0 | 309 | 62 | 61 | 27 | 220 | 0 | 118 | 95 | 22 | 12 | 10 | 114 | 309 | 0 | 3 | 218 | 0 | 0 | 
| app_proof | prover | 1 | 136,570,716 | 543 | 116 | 0 | 0 | 313 | 59 | 59 | 27 | 226 | 0 | 113 | 91 | 22 | 12 | 9 | 116 | 313 | 0 | 3 | 226 | 0 | 0 | 
| app_proof | prover | 2 | 136,570,716 | 533 | 114 | 0 | 0 | 309 | 56 | 56 | 27 | 224 | 0 | 110 | 88 | 21 | 11 | 9 | 114 | 309 | 0 | 4 | 224 | 0 | 0 | 
| app_proof | prover | 3 | 70,295,004 | 299 | 59 | 0 | 0 | 171 | 34 | 34 | 18 | 118 | 0 | 67 | 54 | 12 | 6 | 6 | 59 | 171 | 0 | 3 | 116 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 144 | 929 | 144 | 153 | 2,770,197,065 | 323,292,691 | 3,093,489,756 | 2,097,152 | 0 | 3 | 88 | 3,495,000 | 46.60 | 
| app_proof | 1 | 129 | 815 | 129 | 41 | 2,768,862,357 | 322,353,414 | 3,091,215,771 | 2,097,152 | 0 | 1 | 101 | 3,495,000 | 50.57 | 
| app_proof | 2 | 134 | 806 | 134 | 41 | 2,768,862,357 | 322,353,414 | 3,091,215,771 | 2,097,152 | 0 | 1 | 96 | 3,495,000 | 50.59 | 
| app_proof | 3 | 180 | 563 | 180 | 41 | 1,230,956,171 | 342,871,578 | 1,573,827,749 | 2,097,152 | 0 | 2 | 42 | 1,515,265 | 50.58 | 

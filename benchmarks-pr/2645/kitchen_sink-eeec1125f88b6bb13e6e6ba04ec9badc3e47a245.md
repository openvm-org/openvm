...
| `total_proof_time_ms ` |  1,138.50 |  2,277 |  1,816 |  461 |
...
| `execute_preflight_insn_mi/s` |  37.17 | -          |  38.38 |  35.97 |
| `trace_gen_time_ms   ` |  57 |  114 |  93 |  21 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  891.50 |  1,783 |  1,462 |  321 |
| `prover.main_trace_commit_time_ms` |  292.50 |  585 |  503 |  82 |
| `prover.rap_constraints_time_ms` |  533.50 |  1,067 |  864 |  203 |
| `prover.openings_time_ms` |  64 |  128 |  93 |  35 |
| `prover.rap_constraints.logup_gkr_time_ms` |  158 |  316 |  273 |  43 |
| `prover.rap_constraints.round0_time_ms` |  280.50 |  561 |  448 |  113 |
| `prover.rap_constraints.mle_rounds_time_ms` |  94.50 |  189 |  143 |  46 |
| `prover.openings.stacked_reduction_time_ms` |  50.50 |  101 |  76 |  25 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/eeec1125f88b6bb13e6e6ba04ec9badc3e47a245/kitchen_sink-eeec1125f88b6bb13e6e6ba04ec9badc3e47a245.memory.svg)
...
| app_proof |  |  |  |  |  | 461 |  |  | 34 | 2,579,903 | 75.62 | 0 | 2,315 |  | 
...
| leaf | 0 | 121 | 440 | 120 | 26 | 12 | 22 | 2 | 2 | 
...
| internal_recursive.0 | 1 | prover | 23,651,975 | 102 | 19 | 0 | 4 | 50 | 16 | 16 | 20 | 13 | 0 | 32 | 11 | 21 | 0 | 20 | 19 | 50 | 0 | 1 | 12 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 17,507,975 | 94 | 14 | 0 | 3 | 48 | 16 | 16 | 18 | 13 | 0 | 31 | 10 | 21 | 0 | 20 | 14 | 48 | 0 | 1 | 12 | 0 | 0 | 
| leaf | 0 | prover | 428,317,568 | 319 | 130 | 0 | 10 | 145 | 47 | 46 | 37 | 59 | 0 | 43 | 12 | 31 | 7 | 23 | 131 | 145 | 0 | 2 | 59 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,221,261,804 | 1,462 | 503 | 0 | 285 | 864 | 448 | 446 | 143 | 273 | 135 | 93 | 16 | 76 | 25 | 50 | 503 | 864 | 0 | 1 | 137 | 0 | 0 | 
| app_proof | prover | 1 | 370,741,140 | 321 | 81 | 0 | 17 | 203 | 113 | 112 | 46 | 43 | 0 | 35 | 9 | 25 | 7 | 18 | 82 | 203 | 0 | 1 | 43 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 93 | 1,816 | 93 | 184 | 0 | 3 | 75 | 2,020,000 | 35.97 | 
| app_proof | 1 | 21 | 461 | 21 | 40 | 0 | 1 | 77 | 559,903 | 38.38 | 

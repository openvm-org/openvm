...
|:---|---:|---:|---:|
| Total |  5.33 |  4.02 |  4.02 |
| app_proof |  4.38 |  3.06 |  3.06 |
| leaf |  0.53 |  0.53 |  0.53 |
...
| `total_proof_time_ms ` |  2,160.50 |  4,321 |  2,846 |  1,475 |
| `compile_metered_time_ms` |  5 |  5 |  5 |  5 |
| `execute_metered_time_ms` |  56 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  197.74 | -          |  197.74 |  197.74 |
| `set_initial_memory_time_ms` |  3.50 |  7 |  4 |  3 |
| `execute_preflight_insns` |  5,583,980.50 |  11,167,961 |  7,136,000 |  4,031,961 |
| `execute_preflight_time_ms` |  248 |  496 |  333 |  163 |
| `execute_preflight_insn_mi/s` |  22.52 | -          |  24.60 |  21.39 |
| `postflight_time_ms  ` |  102.50 |  205 |  143 |  62 |
...
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,719 |  3,438 |  2,247 |  1,191 |
| `prover.main_trace_commit_time_ms` |  382 |  764 |  554 |  210 |
| `prover.rap_constraints_time_ms` |  1,078 |  2,156 |  1,360 |  796 |
| `prover.openings_time_ms` |  258 |  516 |  332 |  184 |
| `prover.rap_constraints.logup_gkr_time_ms` |  251 |  502 |  274 |  228 |
| `prover.rap_constraints.round0_time_ms` |  644.50 |  1,289 |  848 |  441 |
| `prover.rap_constraints.mle_rounds_time_ms` |  181.50 |  363 |  237 |  126 |
| `prover.openings.stacked_reduction_time_ms` |  70.50 |  141 |  91 |  50 |
| `prover.openings.stacked_reduction.round0_time_ms` |  42.50 |  85 |  56 |  29 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  27.50 |  55 |  35 |  20 |
| `prover.openings.whir_time_ms` |  186.50 |  373 |  240 |  133 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  528 |  528 |  528 |  528 |
...
| `prover.main_trace_commit_time_ms` |  143 |  143 |  143 |  143 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/b0471ad23a281adb5fc1e2acebf5cd0c57e2181d/sha2_bench-b0471ad23a281adb5fc1e2acebf5cd0c57e2181d.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 174 | 45 | 0 | 0 | 81 | 28 | 28 | 37 | 15 | 0 | 47 | 36 | 10 | 2 | 7 | 45 | 45 | 81 | 0 | 1 | 13 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 108 | 19 | 0 | 0 | 56 | 21 | 20 | 23 | 11 | 0 | 31 | 23 | 7 | 1 | 6 | 20 | 20 | 56 | 0 | 1 | 10 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 99 | 14 | 0 | 0 | 53 | 20 | 19 | 21 | 11 | 0 | 30 | 23 | 7 | 1 | 5 | 15 | 14 | 53 | 0 | 1 | 10 | 0 | 0 | 
| leaf | 0 | prover | 237,929,272 | 416 | 143 | 0 | 0 | 156 | 83 | 81 | 44 | 28 | 0 | 116 | 94 | 22 | 10 | 11 | 143 | 143 | 156 | 0 | 3 | 27 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover |  | 0 | 1,280,474,507 | 2,247 | 554 | 0 | 0 | 1,360 | 848 | 847 | 237 | 274 | 0 | 332 | 240 | 91 | 56 | 35 | 554 | 554 | 1,360 | 0 | 1 | 273 | 0 | 0 | 
| app_proof | prover |  | 1 | 687,175,556 | 1,191 | 209 | 0 | 0 | 796 | 441 | 441 | 126 | 228 | 0 | 184 | 133 | 50 | 29 | 20 | 210 | 209 | 796 | 0 | 1 | 226 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof |  | 1,475 | 56 | 11,167,961 | 197.74 | 0 | 4,387 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof |  | 0 | 4 | 2 | 74 | 2,846 | 6 | 4 | 0 | 143 | 2 | 20 | 0 | 12,528,770,136 | 2,839,688,748 | 15,368,458,884 | 2,097,152 | 2 | 0 | 2 | 5 | 68 | 333 | 7,136,000 | 21.39 | 0 | 0 | 
| app_proof |  | 1 | 3 | 2 | 32 | 1,475 | 3 | 3 | 0 | 62 | 1 | 5 | 0 | 7,111,262,244 | 1,553,197,749 | 8,664,459,993 | 2,097,152 | 2 | 0 | 0 | 2 | 29 | 163 | 4,031,961 | 24.60 | 0 | 0 | 

...
|:---|---:|---:|
| Total |  7.12 |  4.03 |
| regex_program |  6.78 |  3.69 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  3,388.50 |  6,777 |  3,686 |  3,091 |
...
| `execute_e3_time_ms  ` |  288.50 |  577 |  314 |  263 |
| `execute_e3_insn_mi/s` |  7.21 | -          |  7.30 |  7.13 |
| `trace_gen_time_ms   ` |  506 |  1,012 |  585 |  427 |
| `memory_finalize_time_ms` |  228.50 |  457 |  286 |  171 |
| `boundary_finalize_time_ms` |  2.50 |  5 |  5 |  0 |
| `merkle_finalize_time_ms` |  212.50 |  425 |  262 |  163 |
| `stark_prove_excluding_trace_time_ms` |  2,594 |  5,188 |  2,787 |  2,401 |
| `main_trace_commit_time_ms` |  504 |  1,008 |  563 |  445 |
| `generate_perm_trace_time_ms` |  217 |  434 |  230 |  204 |
| `perm_trace_commit_time_ms` |  554.50 |  1,109 |  586 |  523 |
| `quotient_poly_compute_time_ms` |  266.50 |  533 |  285 |  248 |
| `quotient_poly_commit_time_ms` |  241.50 |  483 |  278 |  205 |
| `pcs_opening_time_ms ` |  803 |  1,606 |  839 |  767 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2 | 582 | 4,165,433 | 1 | 345 | 12.05 | 20 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 585 | 3,686 | 2,243,700 | 275,648,700 | 2,787 | 285 | 278 | 586 | 839 | 262 | 286 | 563 | 93,502,324 | 2,243,700 | 230 | 314 | 7.13 | 5 | 
| regex_program | 1 | 427 | 3,091 | 1,921,732 | 242,975,388 | 2,401 | 248 | 205 | 523 | 767 | 163 | 171 | 445 | 73,017,132 | 1,921,733 | 204 | 263 | 7.30 | 0 | 

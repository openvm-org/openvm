...
|:---|---:|---:|
| Total |  7.13 |  4.05 |
| regex_program |  6.79 |  3.70 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  3,392.50 |  6,785 |  3,702 |  3,083 |
...
| `trace_gen_time_ms   ` |  499 |  998 |  564 |  434 |
| `memory_finalize_time_ms` |  227 |  454 |  284 |  170 |
| `boundary_finalize_time_ms` |  2 |  4 |  4 |  0 |
| `merkle_finalize_time_ms` |  211.50 |  423 |  261 |  162 |
| `stark_prove_excluding_trace_time_ms` |  2,605 |  5,210 |  2,825 |  2,385 |
| `main_trace_commit_time_ms` |  502 |  1,004 |  561 |  443 |
| `generate_perm_trace_time_ms` |  217 |  434 |  239 |  195 |
| `perm_trace_commit_time_ms` |  551 |  1,102 |  585 |  517 |
| `quotient_poly_compute_time_ms` |  265 |  530 |  286 |  244 |
| `quotient_poly_commit_time_ms` |  243 |  486 |  275 |  211 |
| `pcs_opening_time_ms ` |  818 |  1,636 |  873 |  763 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2 | 582 | 4,165,433 | 1 | 346 | 12.02 | 20 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 564 | 3,702 | 2,243,700 | 275,648,700 | 2,825 | 286 | 275 | 585 | 873 | 261 | 284 | 561 | 93,502,324 | 2,243,700 | 239 | 313 | 7.15 | 4 | 
| regex_program | 1 | 434 | 3,083 | 1,921,732 | 242,975,388 | 2,385 | 244 | 211 | 517 | 763 | 162 | 170 | 443 | 73,017,132 | 1,921,733 | 195 | 264 | 7.26 | 0 | 

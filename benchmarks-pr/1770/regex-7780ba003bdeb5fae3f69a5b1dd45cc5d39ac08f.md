...
|:---|---:|---:|
| Total |  7.09 |  4.02 |
| regex_program |  6.74 |  3.68 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  3,370 |  6,740 |  3,678 |  3,062 |
...
| `execute_metered_insn_mi/s` |  12.02 | -          | -          | -          |
| `execute_e3_time_ms  ` |  286 |  572 |  311 |  261 |
| `execute_e3_insn_mi/s` |  7.28 | -          |  7.35 |  7.21 |
| `trace_gen_time_ms   ` |  503 |  1,006 |  571 |  435 |
| `memory_finalize_time_ms` |  228 |  456 |  287 |  169 |
| `boundary_finalize_time_ms` |  3.50 |  7 |  6 |  1 |
| `merkle_finalize_time_ms` |  211.50 |  423 |  262 |  161 |
| `stark_prove_excluding_trace_time_ms` |  2,581 |  5,162 |  2,796 |  2,366 |
| `main_trace_commit_time_ms` |  501.50 |  1,003 |  560 |  443 |
| `generate_perm_trace_time_ms` |  211 |  422 |  242 |  180 |
| `perm_trace_commit_time_ms` |  558.50 |  1,117 |  601 |  516 |
| `quotient_poly_compute_time_ms` |  262 |  524 |  281 |  243 |
| `quotient_poly_commit_time_ms` |  240.50 |  481 |  271 |  210 |
| `pcs_opening_time_ms ` |  799.50 |  1,599 |  836 |  763 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2 | 586 | 4,165,433 | 1 | 346 | 12.02 | 20 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 571 | 3,678 | 2,243,700 | 275,648,700 | 2,796 | 281 | 271 | 601 | 836 | 262 | 287 | 560 | 93,502,324 | 2,243,700 | 242 | 311 | 7.21 | 6 | 
| regex_program | 1 | 435 | 3,062 | 1,921,732 | 242,975,388 | 2,366 | 243 | 210 | 516 | 763 | 161 | 169 | 443 | 73,017,132 | 1,921,733 | 180 | 261 | 7.35 | 1 | 

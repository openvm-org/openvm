...
|:---|---:|---:|
| Total |  7.17 |  4.05 |
| regex_program |  6.83 |  3.70 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  3,414 |  6,828 |  3,703 |  3,125 |
...
| `execute_e3_time_ms  ` |  288.50 |  577 |  313 |  264 |
| `execute_e3_insn_mi/s` |  7.20 | -          |  7.26 |  7.15 |
| `trace_gen_time_ms   ` |  498 |  996 |  574 |  422 |
| `memory_finalize_time_ms` |  228.50 |  457 |  288 |  169 |
| `boundary_finalize_time_ms` |  3 |  6 |  6 |  0 |
| `merkle_finalize_time_ms` |  212.50 |  425 |  263 |  162 |
| `stark_prove_excluding_trace_time_ms` |  2,627.50 |  5,255 |  2,816 |  2,439 |
| `main_trace_commit_time_ms` |  506 |  1,012 |  564 |  448 |
| `generate_perm_trace_time_ms` |  227 |  454 |  238 |  216 |
| `perm_trace_commit_time_ms` |  553.50 |  1,107 |  587 |  520 |
| `quotient_poly_compute_time_ms` |  270 |  540 |  286 |  254 |
| `quotient_poly_commit_time_ms` |  243.50 |  487 |  280 |  207 |
| `pcs_opening_time_ms ` |  820.50 |  1,641 |  856 |  785 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2 | 585 | 4,165,433 | 1 | 346 | 12.03 | 19 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 574 | 3,703 | 2,243,700 | 275,648,700 | 2,816 | 286 | 280 | 587 | 856 | 263 | 288 | 564 | 93,502,324 | 2,243,700 | 238 | 313 | 7.15 | 6 | 
| regex_program | 1 | 422 | 3,125 | 1,921,732 | 242,975,388 | 2,439 | 254 | 207 | 520 | 785 | 162 | 169 | 448 | 73,017,132 | 1,921,733 | 216 | 264 | 7.26 | 0 | 

...
| `total_proof_time_ms ` |  595 |  2,380 |  752 |  539 |
...
| `execute_preflight_insn_mi/s` |  31.26 | -          |  32.64 |  28.83 |
| `trace_gen_time_ms   ` |  180.50 |  722 |  216 |  158 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  293.75 |  1,175 |  347 |  268 |
| `main_trace_commit_time_ms` |  52 |  208 |  57 |  50 |
| `generate_perm_trace_time_ms` |  34.50 |  138 |  55 |  18 |
| `perm_trace_commit_time_ms` |  63.74 |  254.95 |  69.56 |  55.83 |
| `quotient_poly_compute_time_ms` |  58.66 |  234.65 |  69.34 |  52.18 |
| `quotient_poly_commit_time_ms` |  15.07 |  60.27 |  18.09 |  12.65 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 540 | 66 | 1 | 36 | 4,137,502 | 114.77 | 192 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 216 | 752 | 23,446,148 | 150,778,428 | 216 | 347 | 0 | 60.29 | 18.09 | 5 | 69.56 | 84 | 125 | 84 | 4 | 57 | 10,899,170 | 55 | 44 | 1,103,000 | 28.83 | 22 | 79 | 1 | 84 | 
| regex_program | 1 | 158 | 549 | 11,598,276 | 128,513,066 | 158 | 285 | 1 | 52.18 | 14.70 | 4 | 64.81 | 63 | 104 | 63 | 0 | 50 | 2,196,106 | 38 | 64 | 1,104,000 | 32.64 | 16 | 67 | 0 | 63 | 
| regex_program | 2 | 163 | 539 | 11,579,064 | 128,513,066 | 163 | 275 | 1 | 52.84 | 14.82 | 4 | 64.75 | 63 | 92 | 62 | 0 | 51 | 2,177,334 | 27 | 59 | 1,104,000 | 31.34 | 17 | 68 | 0 | 62 | 
| regex_program | 3 | 185 | 540 | 11,853,872 | 103,456,394 | 185 | 268 | 0 | 69.34 | 12.65 | 5 | 55.83 | 57 | 77 | 57 | 0 | 50 | 2,422,606 | 18 | 45 | 826,502 | 32.23 | 19 | 83 | 1 | 57 | 
...
Commit: https://github.com/openvm-org/openvm/commit/26a41c6638f7d64a6a75bf8097a68f541812b56a
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19220228536)

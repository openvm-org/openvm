...
| `total_proof_time_ms ` |  588 |  2,352 |  728 |  538 |
...
| `execute_metered_insn_mi/s` |  113.95 | -          |  113.95 |  113.95 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  54.75 |  219 |  68 |  45 |
| `execute_preflight_insn_mi/s` |  31.36 | -          |  32.66 |  28.23 |
| `trace_gen_time_ms   ` |  176.75 |  707 |  210 |  153 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  288.50 |  1,154 |  327 |  270 |
| `main_trace_commit_time_ms` |  52.25 |  209 |  58 |  50 |
| `generate_perm_trace_time_ms` |  34.75 |  139 |  55 |  19 |
| `perm_trace_commit_time_ms` |  64.11 |  256.43 |  70.25 |  56.11 |
| `quotient_poly_compute_time_ms` |  58.41 |  233.64 |  69.18 |  52.30 |
| `quotient_poly_commit_time_ms` |  14.96 |  59.82 |  17.86 |  13.11 |
| `pcs_opening_time_ms ` |  61 |  244 |  63 |  57 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 540 | 66 | 1 | 36 | 4,137,502 | 113.95 | 192 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 210 | 728 | 23,446,148 | 150,778,428 | 210 | 327 | 0 | 59.75 | 17.86 | 5 | 70.25 | 63 | 126 | 63 | 4 | 58 | 10,899,170 | 55 | 45 | 1,103,000 | 28.23 | 21 | 78 | 1 | 63 | 
| regex_program | 1 | 153 | 546 | 11,598,276 | 128,513,066 | 153 | 283 | 1 | 52.41 | 14.31 | 4 | 64.43 | 62 | 103 | 62 | 0 | 50 | 2,196,106 | 38 | 68 | 1,104,000 | 32.44 | 16 | 67 | 0 | 62 | 
| regex_program | 2 | 162 | 538 | 11,579,064 | 128,513,066 | 162 | 274 | 1 | 52.30 | 14.54 | 4 | 65.64 | 62 | 93 | 61 | 0 | 51 | 2,177,334 | 27 | 60 | 1,104,000 | 32.12 | 16 | 67 | 0 | 61 | 
| regex_program | 3 | 182 | 540 | 11,853,872 | 103,456,394 | 182 | 270 | 0 | 69.18 | 13.11 | 5 | 56.11 | 57 | 78 | 56 | 0 | 50 | 2,422,606 | 19 | 46 | 826,502 | 32.66 | 18 | 83 | 1 | 56 | 
...
Commit: https://github.com/openvm-org/openvm/commit/6af144a56211d39f0f881db94ad17ce52119e987
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19220774314)

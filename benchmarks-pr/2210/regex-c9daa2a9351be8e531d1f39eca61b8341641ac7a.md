...
| `total_proof_time_ms ` |  591.25 |  2,365 |  714 |  540 |
...
| `execute_metered_insn_mi/s` |  113.78 | -          |  113.78 |  113.78 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  52.75 |  211 |  64 |  45 |
| `execute_preflight_insn_mi/s` |  31.40 | -          |  32.68 |  28.22 |
| `trace_gen_time_ms   ` |  181.25 |  725 |  214 |  158 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  289.75 |  1,159 |  310 |  269 |
| `main_trace_commit_time_ms` |  52.50 |  210 |  58 |  50 |
| `generate_perm_trace_time_ms` |  38.75 |  155 |  65 |  18 |
| `perm_trace_commit_time_ms` |  64.31 |  257.24 |  69.81 |  55.95 |
| `quotient_poly_compute_time_ms` |  58.61 |  234.44 |  69.55 |  51.83 |
| `quotient_poly_commit_time_ms` |  14.100 |  59.99 |  18.02 |  12.43 |
| `pcs_opening_time_ms ` |  57 |  228 |  61 |  55 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 542 | 65 | 1 | 36 | 4,137,502 | 113.78 | 193 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 214 | 714 | 23,446,148 | 150,778,428 | 214 | 310 | 0 | 60.34 | 18.02 | 6 | 69.81 | 56 | 115 | 56 | 4 | 58 | 10,899,170 | 45 | 45 | 1,103,000 | 28.22 | 21 | 79 | 1 | 56 | 
| regex_program | 1 | 158 | 569 | 11,598,276 | 128,513,066 | 158 | 305 | 1 | 51.83 | 14.95 | 4 | 65.25 | 55 | 131 | 55 | 0 | 50 | 2,196,106 | 65 | 64 | 1,104,000 | 32.50 | 17 | 67 | 0 | 55 | 
| regex_program | 2 | 166 | 540 | 11,579,064 | 128,513,066 | 166 | 275 | 1 | 52.71 | 14.60 | 4 | 66.24 | 61 | 94 | 61 | 0 | 51 | 2,177,334 | 27 | 57 | 1,104,000 | 32.68 | 16 | 67 | 0 | 61 | 
| regex_program | 3 | 187 | 542 | 11,853,872 | 103,456,394 | 187 | 269 | 0 | 69.55 | 12.43 | 5 | 55.95 | 56 | 77 | 56 | 0 | 51 | 2,422,606 | 18 | 45 | 826,502 | 32.19 | 18 | 83 | 1 | 56 | 

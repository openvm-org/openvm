...
| `total_proof_time_ms ` |  708.50 |  1,417 |  812 |  605 |
...
| `execute_metered_insn_mi/s` |  19.25 | -          |  19.25 |  19.25 |
| `execute_preflight_insns` |  872,871 |  1,745,742 |  1,157,000 |  588,742 |
| `execute_preflight_time_ms` |  93.50 |  187 |  129 |  58 |
| `execute_preflight_insn_mi/s` |  13.86 | -          |  18.51 |  9.22 |
| `trace_gen_time_ms   ` |  177.50 |  355 |  196 |  159 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  344.50 |  689 |  380 |  309 |
| `main_trace_commit_time_ms` |  64 |  128 |  75 |  53 |
| `generate_perm_trace_time_ms` |  44 |  88 |  48 |  40 |
| `perm_trace_commit_time_ms` |  76.94 |  153.88 |  88.52 |  65.36 |
| `quotient_poly_compute_time_ms` |  79.39 |  158.79 |  87.50 |  71.29 |
| `quotient_poly_commit_time_ms` |  16.46 |  32.91 |  18.20 |  14.71 |
| `pcs_opening_time_ms ` |  59.50 |  119 |  67 |  52 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 605 | 66 | 1 | 90 | 1,745,742 | 19.25 | 170 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 159 | 812 | 32,689,110 | 172,558,444 | 159 | 380 | 0 | 87.50 | 18.20 | 6 | 88.52 | 67 | 131 | 67 | 1 | 75 | 16,059,916 | 40 | 129 | 1,157,000 | 9.22 | 26 | 106 | 1 | 67 | 
| pairing | 1 | 196 | 605 | 22,314,288 | 119,958,502 | 196 | 309 | 1 | 71.29 | 14.71 | 6 | 65.36 | 52 | 116 | 52 | 0 | 53 | 9,408,294 | 48 | 58 | 588,742 | 18.51 | 20 | 86 | 1 | 52 | 

...
| `total_proof_time_ms ` |  742.50 |  1,485 |  841 |  644 |
...
| `execute_preflight_insn_mi/s` |  13.61 | -          |  18.01 |  9.20 |
| `trace_gen_time_ms   ` |  177 |  354 |  192 |  162 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  379 |  758 |  408 |  350 |
| `main_trace_commit_time_ms` |  64.50 |  129 |  74 |  55 |
| `generate_perm_trace_time_ms` |  55 |  110 |  71 |  39 |
| `perm_trace_commit_time_ms` |  76.28 |  152.55 |  88.08 |  64.47 |
| `quotient_poly_compute_time_ms` |  78.22 |  156.44 |  86.76 |  69.68 |
| `quotient_poly_commit_time_ms` |  15.37 |  30.75 |  16.99 |  13.76 |
| `pcs_opening_time_ms ` |  85.50 |  171 |  99 |  72 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 644 | 66 | 1 | 90 | 1,745,742 | 19.20 | 170 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 162 | 841 | 32,689,110 | 172,558,444 | 162 | 408 | 0 | 86.76 | 16.99 | 6 | 88.08 | 99 | 129 | 98 | 1 | 74 | 16,059,916 | 39 | 129 | 1,157,000 | 9.20 | 26 | 104 | 1 | 98 | 
| pairing | 1 | 192 | 644 | 22,314,288 | 119,958,502 | 192 | 350 | 1 | 69.68 | 13.76 | 6 | 64.47 | 72 | 138 | 72 | 0 | 55 | 9,408,294 | 71 | 60 | 588,742 | 18.01 | 20 | 84 | 1 | 72 | 

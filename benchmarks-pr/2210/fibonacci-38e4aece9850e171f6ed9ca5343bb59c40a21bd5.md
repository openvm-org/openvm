...
|:---|---:|---:|
| Total |  1.05 |  0.62 |
| fibonacci_program |  1.03 |  0.61 |


| fibonacci_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  516.50 |  1,033 |  610 |  423 |
...
| `execute_preflight_insn_mi/s` |  38.44 | -          |  40.56 |  36.31 |
| `trace_gen_time_ms   ` |  190 |  380 |  194 |  186 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  206 |  412 |  248 |  164 |
| `main_trace_commit_time_ms` |  30.50 |  61 |  33 |  28 |
| `generate_perm_trace_time_ms` |  13 |  26 |  14 |  12 |
| `perm_trace_commit_time_ms` |  42.30 |  84.59 |  45.10 |  39.50 |
| `quotient_poly_compute_time_ms` |  31.36 |  62.71 |  34.73 |  27.99 |
| `quotient_poly_commit_time_ms` |  12.16 |  24.32 |  12.23 |  12.09 |
| `pcs_opening_time_ms ` |  74 |  148 |  107 |  41 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 423 | 65 | 1 | 13 | 1,500,209 | 112.52 | 163 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 194 | 610 | 9,677,708 | 84,395,212 | 194 | 248 | 0 | 34.73 | 12.23 | 4 | 45.10 | 107 | 60 | 107 | 0 | 33 | 1,035,986 | 14 | 25 | 873,000 | 36.31 | 13 | 47 | 0 | 107 | 
| fibonacci_program | 1 | 186 | 423 | 9,708,170 | 74,305,770 | 186 | 164 | 1 | 27.99 | 12.09 | 4 | 39.50 | 41 | 52 | 41 | 0 | 28 | 1,064,416 | 12 | 31 | 627,209 | 40.56 | 11 | 40 | 0 | 41 | 
...
Commit: https://github.com/openvm-org/openvm/commit/38e4aece9850e171f6ed9ca5343bb59c40a21bd5
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19219761604)

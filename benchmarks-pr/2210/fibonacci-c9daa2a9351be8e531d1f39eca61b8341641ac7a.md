...
| `total_proof_time_ms ` |  490.50 |  981 |  553 |  428 |
...
| `execute_metered_insn_mi/s` |  119.84 | -          |  119.84 |  119.84 |
| `execute_preflight_insns` |  750,104.50 |  1,500,209 |  873,000 |  627,209 |
| `execute_preflight_time_ms` |  28.50 |  57 |  32 |  25 |
| `execute_preflight_insn_mi/s` |  38.12 | -          |  40.21 |  36.02 |
| `trace_gen_time_ms   ` |  193 |  386 |  198 |  188 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  177 |  354 |  187 |  167 |
| `main_trace_commit_time_ms` |  30.50 |  61 |  33 |  28 |
| `generate_perm_trace_time_ms` |  15 |  30 |  17 |  13 |
| `perm_trace_commit_time_ms` |  42.27 |  84.55 |  44.14 |  40.40 |
| `quotient_poly_compute_time_ms` |  31.87 |  63.74 |  34.70 |  29.04 |
| `quotient_poly_commit_time_ms` |  12.38 |  24.76 |  12.46 |  12.30 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 428 | 65 | 1 | 12 | 1,500,209 | 119.84 | 164 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 198 | 553 | 9,677,708 | 84,395,212 | 198 | 187 | 0 | 34.70 | 12.46 | 4 | 44.14 | 44 | 62 | 44 | 0 | 33 | 1,035,986 | 17 | 25 | 873,000 | 36.02 | 14 | 47 | 0 | 44 | 
| fibonacci_program | 1 | 188 | 428 | 9,708,170 | 74,305,770 | 188 | 167 | 1 | 29.04 | 12.30 | 4 | 40.40 | 42 | 54 | 42 | 0 | 28 | 1,064,416 | 13 | 32 | 627,209 | 40.21 | 11 | 41 | 0 | 42 | 
...
Commit: https://github.com/openvm-org/openvm/commit/c9daa2a9351be8e531d1f39eca61b8341641ac7a
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19220580754)

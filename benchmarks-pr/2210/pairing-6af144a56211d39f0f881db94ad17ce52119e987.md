...
| `total_proof_time_ms ` |  735.50 |  1,471 |  859 |  612 |
...
| `execute_preflight_insn_mi/s` |  13.69 | -          |  18.19 |  9.19 |
| `trace_gen_time_ms   ` |  179.50 |  359 |  195 |  164 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  365.50 |  731 |  419 |  312 |
| `main_trace_commit_time_ms` |  65 |  130 |  76 |  54 |
| `generate_perm_trace_time_ms` |  43.50 |  87 |  48 |  39 |
| `perm_trace_commit_time_ms` |  77.80 |  155.61 |  89.78 |  65.82 |
| `quotient_poly_compute_time_ms` |  79.51 |  159.02 |  87.45 |  71.57 |
| `quotient_poly_commit_time_ms` |  17.01 |  34.02 |  18.90 |  15.11 |
| `pcs_opening_time_ms ` |  78.50 |  157 |  103 |  54 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 612 | 66 | 1 | 91 | 1,745,742 | 19.02 | 173 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 164 | 859 | 32,689,110 | 172,558,444 | 164 | 419 | 0 | 87.45 | 18.90 | 6 | 89.78 | 103 | 132 | 102 | 1 | 76 | 16,059,916 | 39 | 130 | 1,157,000 | 9.19 | 26 | 107 | 1 | 102 | 
| pairing | 1 | 195 | 612 | 22,314,288 | 119,958,502 | 195 | 312 | 1 | 71.57 | 15.11 | 6 | 65.82 | 54 | 116 | 54 | 0 | 54 | 9,408,294 | 48 | 63 | 588,742 | 18.19 | 20 | 87 | 1 | 54 | 

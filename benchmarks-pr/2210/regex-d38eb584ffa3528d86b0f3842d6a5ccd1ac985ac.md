...
| `total_proof_time_ms ` |  589.25 |  2,357 |  739 |  538 |
...
| `execute_metered_insn_mi/s` |  114 | -          |  114 |  114 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  52.75 |  211 |  64 |  44 |
| `execute_preflight_insn_mi/s` |  31.39 | -          |  32.60 |  28.22 |
| `trace_gen_time_ms   ` |  178.25 |  713 |  211 |  156 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  290.75 |  1,163 |  338 |  269 |
| `main_trace_commit_time_ms` |  50.75 |  203 |  56 |  49 |
| `generate_perm_trace_time_ms` |  34.25 |  137 |  55 |  19 |
| `perm_trace_commit_time_ms` |  64.18 |  256.71 |  70.09 |  54.52 |
| `quotient_poly_compute_time_ms` |  59.10 |  236.38 |  71.40 |  52.53 |
| `quotient_poly_commit_time_ms` |  15.05 |  60.20 |  17.24 |  12.81 |
| `pcs_opening_time_ms ` |  63.75 |  255 |  77 |  57 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 538 | 64 | 1 | 36 | 4,137,502 | 114 | 192 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 211 | 739 | 23,446,148 | 150,778,428 | 210 | 338 | 0 | 59.43 | 17.24 | 5 | 70.09 | 77 | 126 | 77 | 4 | 56 | 10,899,170 | 55 | 46 | 1,103,000 | 28.22 | 21 | 77 | 1 | 77 | 
| regex_program | 1 | 156 | 541 | 11,598,276 | 128,513,066 | 156 | 279 | 1 | 53.02 | 14.56 | 4 | 65.69 | 59 | 101 | 59 | 0 | 49 | 2,196,106 | 35 | 64 | 1,104,000 | 32.60 | 16 | 68 | 0 | 59 | 
| regex_program | 2 | 163 | 539 | 11,579,064 | 128,513,066 | 163 | 277 | 1 | 52.53 | 15.59 | 4 | 66.41 | 62 | 95 | 62 | 0 | 49 | 2,177,334 | 28 | 57 | 1,104,000 | 32.55 | 16 | 68 | 0 | 62 | 
| regex_program | 3 | 183 | 538 | 11,853,872 | 103,456,394 | 183 | 269 | 0 | 71.40 | 12.81 | 5 | 54.52 | 57 | 77 | 56 | 0 | 49 | 2,422,606 | 19 | 44 | 826,502 | 32.20 | 18 | 85 | 1 | 56 | 
...
Commit: https://github.com/openvm-org/openvm/commit/d38eb584ffa3528d86b0f3842d6a5ccd1ac985ac
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19220086288)

...
| `total_proof_time_ms ` |  704 |  1,408 |  813 |  595 |
...
| `execute_preflight_insn_mi/s` |  13.83 | -          |  18.37 |  9.28 |
| `trace_gen_time_ms   ` |  179 |  358 |  195 |  163 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  338.50 |  677 |  378 |  299 |
| `main_trace_commit_time_ms` |  65.50 |  131 |  76 |  55 |
| `generate_perm_trace_time_ms` |  35.50 |  71 |  37 |  34 |
| `perm_trace_commit_time_ms` |  77.66 |  155.33 |  89.93 |  65.40 |
| `quotient_poly_compute_time_ms` |  79.23 |  158.45 |  87.51 |  70.95 |
| `quotient_poly_commit_time_ms` |  16.85 |  33.69 |  19.08 |  14.61 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 595 | 65 | 1 | 91 | 1,745,742 | 19.15 | 170 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 163 | 813 | 32,689,110 | 172,558,444 | 163 | 378 | 0 | 87.51 | 19.08 | 6 | 89.93 | 65 | 129 | 65 | 1 | 76 | 16,059,916 | 37 | 128 | 1,157,000 | 9.28 | 26 | 107 | 1 | 65 | 
| pairing | 1 | 195 | 595 | 22,314,288 | 119,958,502 | 195 | 299 | 1 | 70.95 | 14.61 | 6 | 65.40 | 55 | 102 | 55 | 0 | 55 | 9,408,294 | 34 | 59 | 588,742 | 18.37 | 20 | 86 | 1 | 55 | 

...
| `total_proof_time_ms ` |  702.50 |  1,405 |  812 |  593 |
...
| `execute_metered_insn_mi/s` |  19.33 | -          |  19.33 |  19.33 |
| `execute_preflight_insns` |  872,871 |  1,745,742 |  1,157,000 |  588,742 |
| `execute_preflight_time_ms` |  95 |  190 |  130 |  60 |
| `execute_preflight_insn_mi/s` |  13.77 | -          |  18.32 |  9.22 |
| `trace_gen_time_ms   ` |  177.50 |  355 |  194 |  161 |
| `memory_finalize_time_ms` |  1 |  2 |  2 |  0 |
| `stark_prove_excluding_trace_time_ms` |  337 |  674 |  376 |  298 |
| `main_trace_commit_time_ms` |  64.50 |  129 |  75 |  54 |
| `generate_perm_trace_time_ms` |  35 |  70 |  36 |  34 |
| `perm_trace_commit_time_ms` |  77.16 |  154.32 |  89.36 |  64.97 |
| `quotient_poly_compute_time_ms` |  78.79 |  157.57 |  86.73 |  70.84 |
| `quotient_poly_commit_time_ms` |  16.50 |  33.01 |  18.75 |  14.26 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 593 | 69 | 1 | 90 | 1,745,742 | 19.33 | 174 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 161 | 812 | 32,689,110 | 172,558,444 | 161 | 376 | 0 | 86.73 | 18.75 | 6 | 89.36 | 65 | 129 | 65 | 2 | 75 | 16,059,916 | 36 | 130 | 1,157,000 | 9.22 | 26 | 106 | 1 | 65 | 
| pairing | 1 | 194 | 593 | 22,314,288 | 119,958,502 | 194 | 298 | 1 | 70.84 | 14.26 | 6 | 64.97 | 55 | 102 | 55 | 0 | 54 | 9,408,294 | 34 | 60 | 588,742 | 18.32 | 20 | 85 | 1 | 55 | 

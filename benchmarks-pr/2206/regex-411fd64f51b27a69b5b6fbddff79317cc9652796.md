...
| `total_proof_time_ms ` |  582 |  2,328 |  705 |  539 |
...
| `execute_preflight_insn_mi/s` |  32.23 | -          |  33.39 |  29.03 |
| `trace_gen_time_ms   ` |  178.50 |  714 |  212 |  155 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  283 |  1,132 |  304 |  270 |
| `main_trace_commit_time_ms` |  51.75 |  207 |  57 |  48 |
| `generate_perm_trace_time_ms` |  25.25 |  101 |  37 |  18 |
| `perm_trace_commit_time_ms` |  64.27 |  257.09 |  71.15 |  55.43 |
| `quotient_poly_compute_time_ms` |  58.20 |  232.81 |  68.94 |  52.36 |
| `quotient_poly_commit_time_ms` |  14.73 |  58.91 |  17.28 |  12.46 |
| `pcs_opening_time_ms ` |  65.50 |  262 |  71 |  59 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 541 | 41 | 1 | 36 | 4,137,502 | 112.76 | 167 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 212 | 705 | 23,446,148 | 150,778,428 | 212 | 304 | 0 | 58.99 | 17.28 | 5 | 71.15 | 59 | 109 | 59 | 4 | 57 | 10,899,170 | 37 | 44 | 1,103,000 | 29.03 | 21 | 76 | 1 | 59 | 
| regex_program | 1 | 155 | 539 | 11,598,276 | 128,513,066 | 155 | 277 | 1 | 52.52 | 14.84 | 4 | 66.38 | 71 | 86 | 71 | 0 | 51 | 2,196,106 | 20 | 66 | 1,104,000 | 33.39 | 16 | 67 | 0 | 71 | 
| regex_program | 2 | 163 | 543 | 11,579,064 | 128,513,066 | 163 | 281 | 1 | 52.36 | 14.33 | 4 | 64.13 | 71 | 91 | 71 | 0 | 51 | 2,177,334 | 26 | 57 | 1,104,000 | 33.29 | 16 | 67 | 0 | 71 | 
| regex_program | 3 | 184 | 541 | 11,853,872 | 103,456,394 | 184 | 270 | 0 | 68.94 | 12.46 | 5 | 55.43 | 61 | 77 | 61 | 0 | 48 | 2,422,606 | 18 | 44 | 826,502 | 33.22 | 18 | 82 | 1 | 61 | 

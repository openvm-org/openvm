...
| `total_proof_time_ms ` |  576.75 |  2,307 |  706 |  530 |
...
| `execute_metered_insn_mi/s` |  115.10 | -          |  115.10 |  115.10 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  52.25 |  209 |  64 |  43 |
| `execute_preflight_insn_mi/s` |  32.56 | -          |  33.91 |  28.99 |
| `trace_gen_time_ms   ` |  178.50 |  714 |  211 |  156 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  279 |  1,116 |  306 |  268 |
| `main_trace_commit_time_ms` |  51.25 |  205 |  56 |  49 |
| `generate_perm_trace_time_ms` |  22 |  88 |  26 |  20 |
| `perm_trace_commit_time_ms` |  64.05 |  256.21 |  71.04 |  55.41 |
| `quotient_poly_compute_time_ms` |  57.40 |  229.61 |  68.48 |  50.88 |
| `quotient_poly_commit_time_ms` |  14.65 |  58.61 |  16.93 |  13.10 |
| `pcs_opening_time_ms ` |  66.25 |  265 |  78 |  56 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 537 | 66 | 1 | 35 | 4,137,502 | 115.10 | 196 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 211 | 706 | 23,446,148 | 150,778,428 | 211 | 306 | 0 | 58.57 | 16.93 | 5 | 71.04 | 78 | 94 | 78 | 4 | 56 | 10,899,170 | 22 | 45 | 1,103,000 | 28.99 | 21 | 76 | 1 | 78 | 
| regex_program | 1 | 156 | 534 | 11,598,276 | 128,513,066 | 156 | 273 | 1 | 51.68 | 14.24 | 4 | 65.40 | 71 | 86 | 70 | 0 | 49 | 2,196,106 | 20 | 64 | 1,104,000 | 33.77 | 16 | 66 | 0 | 70 | 
| regex_program | 2 | 163 | 530 | 11,579,064 | 128,513,066 | 163 | 269 | 1 | 50.88 | 14.35 | 4 | 64.36 | 60 | 91 | 60 | 0 | 50 | 2,177,334 | 26 | 57 | 1,104,000 | 33.56 | 16 | 65 | 0 | 60 | 
| regex_program | 3 | 184 | 537 | 11,853,872 | 103,456,394 | 184 | 268 | 0 | 68.48 | 13.10 | 5 | 55.41 | 56 | 78 | 55 | 0 | 50 | 2,422,606 | 20 | 43 | 826,502 | 33.91 | 18 | 82 | 1 | 55 | 
...
Commit: https://github.com/openvm-org/openvm/commit/15a8c25b51378628fef0ddacf73bee8afb34f9b8
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19187532603)

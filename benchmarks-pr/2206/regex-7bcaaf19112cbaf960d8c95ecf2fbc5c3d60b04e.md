...
| `total_proof_time_ms ` |  581.25 |  2,325 |  700 |  536 |
...
| `execute_metered_insn_mi/s` |  114.05 | -          |  114.05 |  114.05 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  52 |  208 |  64 |  43 |
| `execute_preflight_insn_mi/s` |  32.58 | -          |  33.66 |  29.67 |
| `trace_gen_time_ms   ` |  180 |  720 |  214 |  157 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  282.25 |  1,129 |  299 |  266 |
| `main_trace_commit_time_ms` |  51.25 |  205 |  57 |  49 |
| `generate_perm_trace_time_ms` |  25.25 |  101 |  35 |  19 |
| `perm_trace_commit_time_ms` |  65.02 |  260.07 |  71.14 |  55.58 |
| `quotient_poly_compute_time_ms` |  58.48 |  233.93 |  69.02 |  52.81 |
| `quotient_poly_commit_time_ms` |  14.98 |  59.91 |  16.97 |  12.63 |
| `pcs_opening_time_ms ` |  63.50 |  254 |  72 |  55 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 536 | 41 | 1 | 36 | 4,137,502 | 114.05 | 166 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 214 | 700 | 23,446,148 | 150,778,428 | 214 | 299 | 0 | 58.82 | 16.97 | 5 | 71.14 | 57 | 107 | 57 | 4 | 57 | 10,899,170 | 35 | 43 | 1,103,000 | 29.67 | 21 | 76 | 1 | 57 | 
| regex_program | 1 | 157 | 542 | 11,598,276 | 128,513,066 | 157 | 280 | 1 | 52.81 | 15.66 | 4 | 67.09 | 72 | 88 | 72 | 0 | 49 | 2,196,106 | 20 | 64 | 1,104,000 | 33.42 | 17 | 69 | 0 | 72 | 
| regex_program | 2 | 164 | 547 | 11,579,064 | 128,513,066 | 164 | 284 | 1 | 53.27 | 14.65 | 4 | 66.26 | 70 | 93 | 70 | 0 | 50 | 2,177,334 | 27 | 57 | 1,104,000 | 33.66 | 16 | 68 | 0 | 70 | 
| regex_program | 3 | 185 | 536 | 11,853,872 | 103,456,394 | 185 | 266 | 0 | 69.02 | 12.63 | 5 | 55.58 | 55 | 77 | 55 | 0 | 49 | 2,422,606 | 19 | 44 | 826,502 | 33.59 | 18 | 82 | 1 | 55 | 
...
Commit: https://github.com/openvm-org/openvm/commit/7bcaaf19112cbaf960d8c95ecf2fbc5c3d60b04e
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19188297187)

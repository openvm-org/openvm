...
| `total_proof_time_ms ` |  710 |  1,420 |  816 |  604 |
...
| `execute_preflight_insn_mi/s` |  13.99 | -          |  18.63 |  9.35 |
| `trace_gen_time_ms   ` |  182 |  364 |  198 |  166 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  342 |  684 |  378 |  306 |
| `main_trace_commit_time_ms` |  65.50 |  131 |  75 |  56 |
| `generate_perm_trace_time_ms` |  39 |  78 |  41 |  37 |
| `perm_trace_commit_time_ms` |  77.54 |  155.08 |  90.50 |  64.58 |
| `quotient_poly_compute_time_ms` |  79.60 |  159.21 |  88.28 |  70.93 |
| `quotient_poly_commit_time_ms` |  16.20 |  32.41 |  18.04 |  14.37 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 604 | 65 | 1 | 91 | 1,745,742 | 19.16 | 169 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 166 | 816 | 32,689,110 | 172,558,444 | 166 | 378 | 0 | 88.28 | 18.04 | 6 | 90.50 | 65 | 130 | 65 | 1 | 75 | 16,059,916 | 37 | 127 | 1,157,000 | 9.35 | 26 | 107 | 1 | 64 | 
| pairing | 1 | 198 | 604 | 22,314,288 | 119,958,502 | 198 | 306 | 1 | 70.93 | 14.37 | 5 | 64.58 | 55 | 108 | 55 | 0 | 56 | 9,408,294 | 41 | 58 | 588,742 | 18.63 | 20 | 85 | 1 | 55 | 

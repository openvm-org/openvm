...
|:---|---:|---:|---:|
| Total | <span style='color: green'>(-0 [-1.7%])</span> 1.53 | <span style='color: green'>(-0 [-1.8%])</span> 0.93 | 0.93 |
| pairing | <span style='color: green'>(-0 [-1.7%])</span> 1.53 | <span style='color: green'>(-0 [-1.8%])</span> 0.93 |  0.93 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: green'>(-14 [-1.8%])</span> 731.50 | <span style='color: green'>(-27 [-1.8%])</span> 1,463 | <span style='color: green'>(-17 [-1.9%])</span> 863 | <span style='color: green'>(-10 [-1.6%])</span> 600 |
...
| `execute_metered_insn_mi/s` | <span style='color: red'>(+0 [+0.2%])</span> 27.44 | -          | <span style='color: red'>(+0 [+0.2%])</span> 27.44 | <span style='color: red'>(+0 [+0.2%])</span> 27.44 |
| `execute_preflight_insns` |  872,871 |  1,745,742 |  1,149,000 |  596,742 |
| `execute_preflight_time_ms` | <span style='color: red'>(+0 [+0.6%])</span> 83 | <span style='color: red'>(+1 [+0.6%])</span> 166 | <span style='color: red'>(+1 [+1.0%])</span> 106 |  60 |
| `execute_preflight_insn_mi/s` | <span style='color: green'>(-0 [-0.1%])</span> 14.67 | -          | <span style='color: red'>(+0 [+0.3%])</span> 18.11 | <span style='color: green'>(-0 [-0.8%])</span> 11.22 |
| `trace_gen_time_ms   ` | <span style='color: green'>(-6 [-3.4%])</span> 186.50 | <span style='color: green'>(-13 [-3.4%])</span> 373 | <span style='color: green'>(-4 [-2.0%])</span> 193 | <span style='color: green'>(-9 [-4.8%])</span> 180 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: green'>(-8 [-2.2%])</span> 356.50 | <span style='color: green'>(-16 [-2.2%])</span> 713 | <span style='color: green'>(-10 [-2.4%])</span> 408 | <span style='color: green'>(-6 [-1.9%])</span> 305 |
| `main_trace_commit_time_ms` | <span style='color: green'>(-2 [-3.0%])</span> 64 | <span style='color: green'>(-4 [-3.0%])</span> 128 | <span style='color: green'>(-1 [-1.3%])</span> 76 | <span style='color: green'>(-3 [-5.5%])</span> 52 |
| `generate_perm_trace_time_ms` | <span style='color: green'>(-4 [-7.5%])</span> 43 | <span style='color: green'>(-7 [-7.5%])</span> 86 | <span style='color: green'>(-5 [-9.3%])</span> 49 | <span style='color: green'>(-2 [-5.1%])</span> 37 |
| `perm_trace_commit_time_ms` | <span style='color: green'>(-1 [-0.8%])</span> 76.74 | <span style='color: green'>(-1 [-0.8%])</span> 153.48 | <span style='color: green'>(-1 [-1.2%])</span> 89.17 | <span style='color: green'>(-0 [-0.3%])</span> 64.32 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+1 [+1.2%])</span> 85.58 | <span style='color: red'>(+2 [+1.2%])</span> 171.16 | <span style='color: red'>(+1 [+1.6%])</span> 94.55 | <span style='color: red'>(+0 [+0.6%])</span> 76.61 |
| `quotient_poly_commit_time_ms` | <span style='color: green'>(-0 [-1.7%])</span> 17.29 | <span style='color: green'>(-1 [-1.7%])</span> 34.58 | <span style='color: green'>(-1 [-3.1%])</span> 19.53 |  15.05 |
| `pcs_opening_time_ms ` | <span style='color: green'>(-4 [-5.1%])</span> 64.50 | <span style='color: green'>(-7 [-5.1%])</span> 129 | <span style='color: green'>(-4 [-5.1%])</span> 75 | <span style='color: green'>(-3 [-5.3%])</span> 54 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 600 | 1 | 63 | 1,745,742 | 27.44 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 180 | 863 | 32,480,114 | 172,558,444 | 180 | 408 | 0 | 94.55 | 19.53 | 6 | 89.17 | 75 | 140 | 75 | 1 | 76 | 15,909,408 | 49 | 106 | 1,149,000 | 11.22 | 27 | 114 | 1 | 75 | 
| pairing | 1 | 193 | 600 | 22,464,232 | 119,958,502 | 193 | 305 | 1 | 76.61 | 15.05 | 6 | 64.32 | 54 | 105 | 54 | 0 | 52 | 9,498,894 | 37 | 60 | 596,742 | 18.11 | 21 | 92 | 1 | 54 | 

...
|:---|---:|---:|---:|
| Total | <span style='color: green'>(-0 [-1.3%])</span> 2.37 | <span style='color: green'>(-0 [-3.5%])</span> 0.74 | 0.73 |
| regex_program | <span style='color: green'>(-0 [-1.3%])</span> 2.37 | <span style='color: green'>(-0 [-3.7%])</span> 0.74 |  0.74 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: green'>(-8 [-1.4%])</span> 583.25 | <span style='color: green'>(-32 [-1.4%])</span> 2,333 | <span style='color: green'>(-28 [-3.9%])</span> 697 | <span style='color: green'>(-3 [-0.6%])</span> 541 |
...
| `execute_metered_insn_mi/s` | <span style='color: green'>(-1 [-0.7%])</span> 108.25 | -          | <span style='color: green'>(-1 [-0.7%])</span> 108.25 | <span style='color: green'>(-1 [-0.7%])</span> 108.25 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` | <span style='color: red'>(+2 [+4.2%])</span> 55.25 | <span style='color: red'>(+9 [+4.2%])</span> 221 | <span style='color: red'>(+3 [+4.6%])</span> 68 | <span style='color: red'>(+2 [+4.4%])</span> 47 |
| `execute_preflight_insn_mi/s` | <span style='color: green'>(-1 [-2.7%])</span> 31.06 | -          | <span style='color: green'>(-1 [-2.4%])</span> 32.33 | <span style='color: green'>(-1 [-3.2%])</span> 27.95 |
| `trace_gen_time_ms   ` | <span style='color: green'>(-10 [-5.7%])</span> 168.25 | <span style='color: green'>(-41 [-5.7%])</span> 673 | <span style='color: green'>(-30 [-14.2%])</span> 181 | <span style='color: green'>(-2 [-1.3%])</span> 153 |
| `memory_finalize_time_ms` |  1 |  4 |  4 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  286 |  1,144 | <span style='color: red'>(+1 [+0.3%])</span> 300 | <span style='color: green'>(-1 [-0.4%])</span> 272 |
...
| `generate_perm_trace_time_ms` | <span style='color: green'>(-1 [-4.2%])</span> 23 | <span style='color: green'>(-4 [-4.2%])</span> 92 |  28 | <span style='color: green'>(-2 [-9.1%])</span> 20 |
| `perm_trace_commit_time_ms` |  64.71 |  258.86 | <span style='color: red'>(+1 [+1.1%])</span> 72.56 | <span style='color: green'>(-0 [-0.8%])</span> 55.26 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+0 [+0.3%])</span> 59.15 | <span style='color: red'>(+1 [+0.3%])</span> 236.59 | <span style='color: green'>(-1 [-2.1%])</span> 69.22 | <span style='color: red'>(+0 [+0.9%])</span> 53.87 |
| `quotient_poly_commit_time_ms` | <span style='color: green'>(-0 [-2.9%])</span> 15.53 | <span style='color: green'>(-2 [-2.9%])</span> 62.14 | <span style='color: green'>(-1 [-5.9%])</span> 17.49 | <span style='color: green'>(-1 [-5.2%])</span> 13.11 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+1 [+1.1%])</span> 68.50 | <span style='color: red'>(+3 [+1.1%])</span> 274 | <span style='color: red'>(+1 [+1.4%])</span> 75 | <span style='color: red'>(+2 [+3.5%])</span> 59 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 541 | 1 | 38 | 4,137,502 | 108.25 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 179 | 697 | 23,446,148 | 150,778,428 | 179 | 300 | 0 | 59.63 | 17.49 | 5 | 72.56 | 66 | 98 | 66 | 4 | 57 | 10,899,170 | 24 | 47 | 1,103,000 | 27.95 | 22 | 77 | 1 | 66 | 
| regex_program | 1 | 153 | 544 | 11,598,276 | 128,513,066 | 153 | 282 | 1 | 53.87 | 15.20 | 4 | 64.84 | 75 | 85 | 75 | 0 | 50 | 2,196,106 | 20 | 68 | 1,104,000 | 31.84 | 17 | 69 | 0 | 75 | 
| regex_program | 2 | 160 | 551 | 11,579,064 | 128,513,066 | 160 | 290 | 1 | 53.87 | 16.34 | 4 | 66.19 | 74 | 95 | 73 | 0 | 49 | 2,177,334 | 28 | 59 | 1,104,000 | 32.10 | 17 | 70 | 0 | 73 | 
| regex_program | 3 | 181 | 541 | 11,853,872 | 103,456,394 | 180 | 272 | 0 | 69.22 | 13.11 | 5 | 55.26 | 59 | 78 | 58 | 0 | 50 | 2,422,606 | 20 | 47 | 826,502 | 32.33 | 19 | 83 | 1 | 58 | 
...
Commit: https://github.com/openvm-org/openvm/commit/e7a05ebca464c9e8d87b36d29af2c9134a2a6a1b
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/20379868365)

...
|:---|---:|---:|---:|
| Total | <span style='color: green'>(-0 [-1.4%])</span> 2.37 | <span style='color: green'>(-0 [-4.1%])</span> 0.73 | 0.73 |
| regex_program | <span style='color: green'>(-0 [-1.5%])</span> 2.37 | <span style='color: green'>(-0 [-4.2%])</span> 0.73 |  0.73 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: green'>(-9 [-1.5%])</span> 582.50 | <span style='color: green'>(-35 [-1.5%])</span> 2,330 | <span style='color: green'>(-32 [-4.4%])</span> 693 | <span style='color: green'>(-1 [-0.2%])</span> 543 |
...
| `execute_metered_insn_mi/s` | <span style='color: green'>(-1 [-0.5%])</span> 108.45 | -          | <span style='color: green'>(-1 [-0.5%])</span> 108.45 | <span style='color: green'>(-1 [-0.5%])</span> 108.45 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` | <span style='color: red'>(+0 [+0.9%])</span> 53.50 | <span style='color: red'>(+2 [+0.9%])</span> 214 | <span style='color: red'>(+1 [+1.5%])</span> 66 |  45 |
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+0 [+0.7%])</span> 32.14 | -          | <span style='color: red'>(+0 [+0.4%])</span> 33.27 | <span style='color: red'>(+0 [+0.2%])</span> 28.94 |
| `trace_gen_time_ms   ` | <span style='color: green'>(-10 [-5.3%])</span> 169 | <span style='color: green'>(-38 [-5.3%])</span> 676 | <span style='color: green'>(-29 [-13.7%])</span> 182 | <span style='color: green'>(-2 [-1.3%])</span> 153 |
| `memory_finalize_time_ms` |  1 |  4 |  4 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+1 [+0.4%])</span> 287 | <span style='color: red'>(+5 [+0.4%])</span> 1,148 | <span style='color: red'>(+2 [+0.7%])</span> 301 | <span style='color: red'>(+1 [+0.4%])</span> 274 |
| `main_trace_commit_time_ms` | <span style='color: green'>(-0 [-1.0%])</span> 50.75 | <span style='color: green'>(-2 [-1.0%])</span> 203 |  56 | <span style='color: green'>(-1 [-2.0%])</span> 48 |
| `generate_perm_trace_time_ms` | <span style='color: green'>(-0 [-1.0%])</span> 23.75 | <span style='color: green'>(-1 [-1.0%])</span> 95 |  28 | <span style='color: green'>(-2 [-9.1%])</span> 20 |
| `perm_trace_commit_time_ms` | <span style='color: green'>(-1 [-1.0%])</span> 64.05 | <span style='color: green'>(-2 [-1.0%])</span> 256.20 | <span style='color: red'>(+1 [+0.9%])</span> 72.45 | <span style='color: green'>(-1 [-2.2%])</span> 54.48 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+0 [+0.4%])</span> 59.25 | <span style='color: red'>(+1 [+0.4%])</span> 236.98 | <span style='color: red'>(+1 [+0.7%])</span> 71.22 | <span style='color: green'>(-1 [-1.5%])</span> 52.59 |
| `quotient_poly_commit_time_ms` | <span style='color: green'>(-1 [-3.1%])</span> 15.50 | <span style='color: green'>(-2 [-3.1%])</span> 61.100 | <span style='color: green'>(-0 [-1.6%])</span> 18.29 | <span style='color: green'>(-0 [-3.0%])</span> 13.40 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+3 [+4.8%])</span> 71 | <span style='color: red'>(+13 [+4.8%])</span> 284 | <span style='color: red'>(+8 [+10.8%])</span> 82 | <span style='color: red'>(+5 [+8.8%])</span> 62 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 543 | 1 | 38 | 4,137,502 | 108.45 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 180 | 693 | 23,446,148 | 150,778,428 | 180 | 301 | 0 | 60.35 | 18.29 | 5 | 72.45 | 67 | 98 | 66 | 4 | 56 | 10,899,170 | 25 | 45 | 1,103,000 | 28.94 | 22 | 79 | 1 | 66 | 
| regex_program | 1 | 153 | 548 | 11,598,276 | 128,513,066 | 153 | 288 | 1 | 52.59 | 15.35 | 4 | 65 | 82 | 87 | 82 | 0 | 49 | 2,196,106 | 22 | 66 | 1,104,000 | 33.10 | 17 | 68 | 0 | 82 | 
| regex_program | 2 | 161 | 546 | 11,579,064 | 128,513,066 | 161 | 285 | 1 | 52.82 | 14.95 | 4 | 64.26 | 73 | 92 | 73 | 0 | 50 | 2,177,334 | 28 | 58 | 1,104,000 | 33.27 | 16 | 68 | 0 | 73 | 
| regex_program | 3 | 182 | 543 | 11,853,872 | 103,456,394 | 182 | 274 | 0 | 71.22 | 13.40 | 5 | 54.48 | 62 | 77 | 62 | 0 | 48 | 2,422,606 | 20 | 45 | 826,502 | 33.27 | 18 | 85 | 1 | 62 | 
...
Commit: https://github.com/openvm-org/openvm/commit/8eb1a45f1c90c2ebc4fda00fa8ef35d67f46f04b
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/20380894494)

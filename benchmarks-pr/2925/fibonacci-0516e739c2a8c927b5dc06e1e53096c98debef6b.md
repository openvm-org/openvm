...
| `total_proof_time_ms ` |  519 |  1,038 |  573 |  465 |
| `compile_metered_time_ms` |  4 |  4 |  4 |  4 |
| `execute_metered_time_ms` |  20 | -          | -          | -          |
| `execute_metered_insns` |  4,000,051 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  194.01 | -          |  194.01 |  194.01 |
| `execute_preflight_insns` |  2,000,025.50 |  4,000,051 |  2,621,000 |  1,379,051 |
| `execute_preflight_time_ms` |  54.50 |  109 |  67 |  42 |
| `execute_preflight_insn_mi/s` |  45.83 | -          |  48.78 |  42.88 |
| `trace_gen_time_ms   ` |  28 |  56 |  34 |  22 |
| `set_initial_memory_time_ms` |  89 |  178 |  137 |  41 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  346 |  692 |  346 |  346 |
| `prover.main_trace_commit_time_ms` |  74 |  148 |  75 |  73 |
| `prover.rap_constraints_time_ms` |  188.50 |  377 |  191 |  186 |
| `prover.openings_time_ms` |  82 |  164 |  84 |  80 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/0516e739c2a8c927b5dc06e1e53096c98debef6b/fibonacci-0516e739c2a8c927b5dc06e1e53096c98debef6b.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 66 |  |  |  | 335 |  |  |  |  |  |  | 
| app_proof |  |  |  | 465 |  | 20 | 4,000,051 | 194.01 | 0 | 1,064 |  | 
...
| app_proof | VmAirWrapper<Rv64LoadStoreAdapterAir, LoadStoreCoreAir<8> | 14 | VmAirWrapper<Rv64LoadStoreAdapterAir, LoadStoreCoreAir<8> | 0 | 640 | 
...
| app_proof | VmAirWrapper<Rv64LoadStoreAdapterAir, LoadStoreCoreAir<8> | 14 | VmAirWrapper<Rv64LoadStoreAdapterAir, LoadStoreCoreAir<8> | 1 | 160 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 27,277,885 | 267 | 82 | 0 | 0 | 99 | 33 | 33 | 45 | 20 | 0 | 84 | 73 | 11 | 2 | 8 | 82 | 82 | 99 | 0 | 3 | 18 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 170 | 47 | 0 | 0 | 67 | 25 | 25 | 28 | 13 | 0 | 54 | 46 | 8 | 1 | 6 | 47 | 47 | 67 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 135 | 31 | 0 | 0 | 63 | 24 | 23 | 24 | 14 | 0 | 40 | 32 | 7 | 1 | 5 | 32 | 31 | 63 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 74,737,560 | 352 | 123 | 0 | 0 | 117 | 53 | 52 | 35 | 29 | 0 | 110 | 95 | 14 | 6 | 8 | 123 | 123 | 117 | 0 | 7 | 28 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 90,436,180 | 346 | 73 | 0 | 0 | 191 | 41 | 40 | 20 | 129 | 0 | 80 | 65 | 15 | 8 | 7 | 73 | 73 | 191 | 0 | 3 | 128 | 0 | 0 | 
| app_proof | prover | 1 | 90,435,040 | 346 | 75 | 0 | 0 | 186 | 36 | 36 | 20 | 129 | 0 | 84 | 69 | 14 | 8 | 6 | 75 | 75 | 186 | 0 | 3 | 129 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 137 | 2 | 22 | 573 | 22 | 137 | 2,146,766,901 | 1,588,503 | 2,148,355,404 | 2,097,152 | 0 | 4 | 67 | 2,621,000 | 42.88 | 
| app_proof | 1 | 41 | 1 | 34 | 465 | 34 | 41 | 1,165,989,930 | 980,940,213 | 2,146,930,143 | 2,097,152 | 0 | 2 | 42 | 1,379,051 | 48.78 | 

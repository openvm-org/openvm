...
|:---|---:|---:|---:|
| Total |  5.38 |  3.78 |  3.78 |
| app_proof |  3.87 |  2.27 |  2.27 |
| leaf |  0.95 |  0.95 |  0.95 |
...
| `total_proof_time_ms ` |  1,916 |  3,832 |  2,233 |  1,599 |
...
| `execute_preflight_time_ms` |  96 |  192 |  130 |  62 |
| `execute_preflight_insn_mi/s` |  35.77 | -          |  36.55 |  34.98 |
| `trace_gen_time_ms   ` |  141 |  282 |  185 |  97 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,569 |  3,138 |  1,808 |  1,330 |
| `prover.main_trace_commit_time_ms` |  512 |  1,024 |  597 |  427 |
| `prover.rap_constraints_time_ms` |  929.50 |  1,859 |  1,077 |  782 |
| `prover.openings_time_ms` |  126.50 |  253 |  133 |  120 |
| `prover.rap_constraints.logup_gkr_time_ms` |  166.50 |  333 |  197 |  136 |
| `prover.rap_constraints.round0_time_ms` |  561.50 |  1,123 |  668 |  455 |
| `prover.rap_constraints.mle_rounds_time_ms` |  200.50 |  401 |  211 |  190 |
| `prover.openings.stacked_reduction_time_ms` |  91.50 |  183 |  99 |  84 |
| `prover.openings.stacked_reduction.round0_time_ms` |  48.50 |  97 |  49 |  48 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  42.50 |  85 |  49 |  36 |
...
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  825 |  825 |  825 |  825 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/aad70783ed3f1be2bc7115293b69c45c3228eae9/kitchen_sink-aad70783ed3f1be2bc7115293b69c45c3228eae9.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 72 | 9 |  |  | 0 |  | 376 | 9 |  |  |  |  |  |  | 
| app_proof |  |  |  |  |  | 1,599 |  |  | 34 | 2,579,903 | 74.07 | 0 | 3,871 |  | 
...
| internal_recursive.0 | 1 | 11 | 163 | 11 | 1 | 0 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 9 | 131 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 119 | 945 | 119 | 23 | 9 | 21 | 5 | 5 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,577,979 | 255 | 116 | 0 | 0 | 106 | 34 | 33 | 51 | 20 | 0 | 32 | 18 | 13 | 3 | 9 | 117 | 106 | 0 | 2 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,767 | 151 | 46 | 0 | 0 | 68 | 25 | 24 | 28 | 14 | 0 | 36 | 28 | 8 | 1 | 6 | 46 | 68 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 122 | 32 | 0 | 0 | 62 | 24 | 23 | 24 | 14 | 0 | 27 | 20 | 7 | 1 | 5 | 32 | 62 | 0 | 2 | 13 | 0 | 0 | 
| leaf | 0 | prover | 265,003,892 | 825 | 400 | 0 | 1 | 348 | 134 | 133 | 77 | 136 | 0 | 76 | 35 | 40 | 22 | 18 | 400 | 348 | 0 | 6 | 135 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 567,917,156 | 1,808 | 597 | 0 | 188 | 1,077 | 668 | 666 | 211 | 197 | 56 | 133 | 34 | 99 | 49 | 49 | 597 | 1,077 | 0 | 3 | 139 | 0 | 0 | 
| app_proof | prover | 1 | 537,266,124 | 1,330 | 427 | 0 | 1 | 782 | 455 | 454 | 190 | 136 | 0 | 120 | 35 | 84 | 48 | 36 | 427 | 782 | 0 | 4 | 135 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 185 | 2,233 | 185 | 177 | 0 | 4 | 62 | 1,540,000 | 34.98 | 
| app_proof | 1 | 97 | 1,599 | 97 | 41 | 0 | 2 | 130 | 1,039,903 | 36.55 | 

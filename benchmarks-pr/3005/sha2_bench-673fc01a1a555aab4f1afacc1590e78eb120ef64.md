...
|:---|---:|---:|---:|
| Total |  4.96 |  3.32 |  3.32 |
| app_proof |  4.01 |  2.37 |  2.37 |
| leaf |  0.52 |  0.52 |  0.52 |
...
| `total_proof_time_ms ` |  1,975 |  3,950 |  2,313 |  1,637 |
...
| `execute_preflight_time_ms` |  358 |  716 |  508 |  208 |
| `execute_preflight_insn_mi/s` |  35.30 | -          |  35.33 |  35.27 |
| `trace_gen_time_ms   ` |  74.50 |  149 |  103 |  46 |
| `set_initial_memory_time_ms` |  0 |  0 |  0 |  0 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,540.50 |  3,081 |  2,000 |  1,081 |
| `prover.main_trace_commit_time_ms` |  386 |  772 |  552 |  220 |
| `prover.rap_constraints_time_ms` |  890.50 |  1,781 |  1,118 |  663 |
| `prover.openings_time_ms` |  263.50 |  527 |  330 |  197 |
| `prover.rap_constraints.logup_gkr_time_ms` |  205.50 |  411 |  224 |  187 |
| `prover.rap_constraints.round0_time_ms` |  505.50 |  1,011 |  662 |  349 |
| `prover.rap_constraints.mle_rounds_time_ms` |  179 |  358 |  231 |  127 |
| `prover.openings.stacked_reduction_time_ms` |  71 |  142 |  90 |  52 |
| `prover.openings.stacked_reduction.round0_time_ms` |  43 |  86 |  55 |  31 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  27.50 |  55 |  34 |  21 |
| `prover.openings.whir_time_ms` |  191.50 |  383 |  239 |  144 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/673fc01a1a555aab4f1afacc1590e78eb120ef64/sha2_bench-673fc01a1a555aab4f1afacc1590e78eb120ef64.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 59 |  |  |  | 293 |  |  |  |  |  |  | 
| app_proof |  |  |  | 1,637 |  | 57 | 11,167,961 | 195.40 | 0 | 4,016 |  | 
...
| app_proof | VmAirWrapper<Rv64BranchAdapterAir, BranchLessThanCoreAir<4, 16> | 0 | 1 | 2 | 
...
| app_proof | VmAirWrapper<Rv64RdWriteAdapterAir, Rv64AuipcCoreAir> | 0 | 6 | 6 | 
| app_proof | VmAirWrapper<Rv64StoreAdapterAir, StoreCoreAir<8, 1> | 0 | 6 | 9 | 
...
| app_proof | VmAirWrapper<Rv64CondRdWriteAdapterAir, Rv64JalLuiCoreAir> | 1 | 1 | 1 | 
...
| leaf | 0 | 116 | 522 | 116 | 34 | 12 | 2 | 9 | 9 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 175 | 46 | 0 | 0 | 80 | 28 | 27 | 37 | 14 | 0 | 47 | 36 | 10 | 2 | 7 | 47 | 46 | 80 | 0 | 1 | 13 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 113 | 20 | 0 | 0 | 60 | 23 | 22 | 23 | 13 | 0 | 31 | 23 | 7 | 1 | 6 | 20 | 20 | 60 | 0 | 1 | 10 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 97 | 15 | 0 | 0 | 54 | 20 | 19 | 21 | 11 | 0 | 27 | 20 | 7 | 1 | 5 | 15 | 15 | 54 | 0 | 1 | 10 | 0 | 0 | 
| leaf | 0 | prover | 237,929,144 | 405 | 146 | 0 | 0 | 142 | 71 | 69 | 44 | 26 | 0 | 116 | 93 | 22 | 10 | 11 | 147 | 146 | 142 | 0 | 3 | 25 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,233,945,850 | 2,000 | 552 | 0 | 0 | 1,118 | 662 | 661 | 231 | 224 | 0 | 330 | 239 | 90 | 55 | 34 | 552 | 552 | 1,117 | 0 | 1 | 222 | 0 | 0 | 
| app_proof | prover | 1 | 698,978,064 | 1,081 | 220 | 0 | 0 | 663 | 349 | 348 | 127 | 187 | 0 | 197 | 144 | 52 | 31 | 21 | 220 | 220 | 663 | 0 | 1 | 185 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 0 | 2 | 103 | 2,313 | 103 | 0 | 12,684,755,076 | 2,129,046,324 | 14,813,801,400 | 2,097,152 | 0 | 5 | 208 | 7,124,000 | 35.33 | 
| app_proof | 1 | 0 | 1 | 46 | 1,637 | 46 | 0 | 7,231,569,048 | 1,162,618,920 | 8,394,187,968 | 2,097,152 | 0 | 2 | 508 | 4,043,961 | 35.27 | 

...
|:---|---:|---:|
| Total | <span style='color: green'>(-0 [-0.2%])</span> 13.83 |  7.77 |
| regex_program | <span style='color: green'>(-0 [-0.2%])</span> 13.83 |  7.77 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: green'>(-11 [-0.2%])</span> 6,913 | <span style='color: green'>(-22 [-0.2%])</span> 13,826 |  7,770 | <span style='color: green'>(-22 [-0.4%])</span> 6,056 |
| `main_cells_used     ` |  82,727,686.50 |  165,455,373 |  92,686,348 |  72,769,025 |
| `total_cycles        ` |  1,914,103 |  1,914,103 |  1,914,103 |  1,914,103 |
| `execute_time_ms     ` | <span style='color: green'>(-2 [-0.3%])</span> 438.50 | <span style='color: green'>(-3 [-0.3%])</span> 877 | <span style='color: green'>(-3 [-0.6%])</span> 471 |  406 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+8 [+0.7%])</span> 1,100 | <span style='color: red'>(+16 [+0.7%])</span> 2,200 | <span style='color: red'>(+5 [+0.4%])</span> 1,254 | <span style='color: red'>(+11 [+1.2%])</span> 946 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: green'>(-18 [-0.3%])</span> 5,374.50 | <span style='color: green'>(-35 [-0.3%])</span> 10,749 |  6,045 | <span style='color: green'>(-33 [-0.7%])</span> 4,704 |
| `main_trace_commit_time_ms` | <span style='color: red'>(+2 [+0.2%])</span> 1,027 | <span style='color: red'>(+4 [+0.2%])</span> 2,054 | <span style='color: red'>(+3 [+0.2%])</span> 1,266 | <span style='color: red'>(+1 [+0.1%])</span> 788 |
| `generate_perm_trace_time_ms` | <span style='color: green'>(-9 [-4.8%])</span> 178 | <span style='color: green'>(-18 [-4.8%])</span> 356 | <span style='color: red'>(+5 [+2.7%])</span> 192 | <span style='color: green'>(-23 [-12.3%])</span> 164 |
| `perm_trace_commit_time_ms` | <span style='color: red'>(+4 [+0.3%])</span> 1,148 | <span style='color: red'>(+8 [+0.3%])</span> 2,296 |  1,199 | <span style='color: red'>(+7 [+0.6%])</span> 1,097 |
| `quotient_poly_compute_time_ms` | <span style='color: green'>(-12 [-1.6%])</span> 732.50 | <span style='color: green'>(-24 [-1.6%])</span> 1,465 | <span style='color: green'>(-7 [-0.8%])</span> 855 | <span style='color: green'>(-17 [-2.7%])</span> 610 |
| `quotient_poly_commit_time_ms` | <span style='color: green'>(-4 [-0.4%])</span> 962 | <span style='color: green'>(-7 [-0.4%])</span> 1,924 | <span style='color: red'>(+6 [+0.5%])</span> 1,107 | <span style='color: green'>(-13 [-1.6%])</span> 817 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+2 [+0.1%])</span> 1,316.50 | <span style='color: red'>(+3 [+0.1%])</span> 2,633 | <span style='color: green'>(-11 [-0.8%])</span> 1,417 | <span style='color: red'>(+14 [+1.2%])</span> 1,216 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,254 | 7,770 |  | 209,921,543 | 6,045 | 855 | 1,107 | 1,199 | 1,417 | 1,266 | 92,686,348 | 192 | 471 | 
| regex_program | 1 | 946 | 6,056 | 1,914,103 | 149,454,692 | 4,704 | 610 | 817 | 1,097 | 1,216 | 788 | 72,769,025 | 164 | 406 | 

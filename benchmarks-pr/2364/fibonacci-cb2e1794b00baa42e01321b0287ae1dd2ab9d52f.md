...
|:---|---:|---:|---:|
| Total |  9.60 |  5.82 | 5.82 |
| fibonacci_program |  9.60 |  5.82 |  5.82 |


| fibonacci_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  4,797 |  9,594 |  5,806 |  3,788 |
...
| `execute_metered_insn_mi/s` |  160.90 | -          |  160.90 |  160.90 |
| `execute_preflight_insns` |  750,104.50 |  1,500,209 |  873,000 |  627,209 |
| `execute_preflight_time_ms` |  27 |  54 |  32 |  22 |
| `execute_preflight_insn_mi/s` |  37.68 | -          |  37.91 |  37.45 |
| `trace_gen_time_ms   ` |  193 |  386 |  197 |  189 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  4,471 |  8,942 |  5,414 |  3,528 |
| `main_trace_commit_time_ms` |  30.50 |  61 |  33 |  28 |
| `generate_perm_trace_time_ms` |  86 |  172 |  138 |  34 |
| `perm_trace_commit_time_ms` |  41.28 |  82.55 |  43.75 |  38.81 |
| `quotient_poly_compute_time_ms` |  31.14 |  62.28 |  34.10 |  28.18 |
| `quotient_poly_commit_time_ms` |  12.27 |  24.55 |  13.03 |  11.52 |
| `pcs_opening_time_ms ` |  4,267.50 |  8,535 |  5,150 |  3,385 |
...
| --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 3,788 | 1 | 9 | 1,500,209 | 160.90 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 189 | 5,806 | 9,677,708 | 84,395,212 | 189 | 5,414 | 0 | 34.10 | 13.03 | 6 | 43.75 | 5,150 | 182 | 5,150 | 0 | 33 | 1,035,986 | 138 | 32 | 873,000 | 37.91 | 14 | 47 | 0 | 5,150 | 
| fibonacci_program | 1 | 197 | 3,788 | 9,708,170 | 74,305,770 | 197 | 3,528 | 1 | 28.18 | 11.52 | 5 | 38.81 | 3,385 | 73 | 3,385 | 0 | 28 | 1,064,416 | 34 | 22 | 627,209 | 37.45 | 11 | 40 | 0 | 3,384 | 

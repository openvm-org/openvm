...
|:---|---:|---:|---:|
| Total |  33.34 |  20.83 | 20.83 |
| kitchen_sink |  11.20 |  5.75 |  5.75 |
| leaf |  19.21 |  12.14 |  12.14 |
| internal.0 |  2.93 |  2.93 |  2.93 |


| kitchen_sink |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  5,598 |  11,196 |  5,747 |  5,449 |
...
| `execute_metered_insn_mi/s` |  20.05 | -          |  20.05 |  20.05 |
| `execute_preflight_insns` |  77,381.50 |  154,763 |  121,000 |  33,763 |
| `execute_preflight_time_ms` |  113 |  226 |  132 |  94 |
| `execute_preflight_insn_mi/s` |  8.66 | -          |  11.37 |  5.95 |
| `trace_gen_time_ms   ` |  134 |  268 |  138 |  130 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  5,258.50 |  10,517 |  5,482 |  5,035 |
| `main_trace_commit_time_ms` |  193 |  386 |  208 |  178 |
| `generate_perm_trace_time_ms` |  93 |  186 |  135 |  51 |
| `perm_trace_commit_time_ms` |  80.24 |  160.48 |  95.98 |  64.50 |
| `quotient_poly_compute_time_ms` |  373.01 |  746.01 |  451.61 |  294.40 |
| `quotient_poly_commit_time_ms` |  9.33 |  18.66 |  10.18 |  8.48 |
| `pcs_opening_time_ms ` |  4,492.50 |  8,985 |  4,878 |  4,107 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  9,604 |  19,208 |  12,145 |  7,063 |
| `main_cells_used     ` |  62,627,580 |  125,255,160 |  83,653,770 |  41,601,390 |
| `total_cells_used    ` |  143,430,882 |  286,861,764 |  193,621,744 |  93,240,020 |
| `execute_preflight_insns` |  6,289,127.50 |  12,578,255 |  9,308,715 |  3,269,540 |
| `execute_preflight_time_ms` |  1,941.50 |  3,883 |  2,483 |  1,400 |
| `execute_preflight_insn_mi/s` |  5.78 | -          |  5.86 |  5.70 |
| `trace_gen_time_ms   ` |  419 |  838 |  618 |  220 |
| `memory_finalize_time_ms` |  28.50 |  57 |  34 |  23 |
| `stark_prove_excluding_trace_time_ms` |  7,241.50 |  14,483 |  9,042 |  5,441 |
| `main_trace_commit_time_ms` |  447 |  894 |  739 |  155 |
| `generate_perm_trace_time_ms` |  290 |  580 |  473 |  107 |
| `perm_trace_commit_time_ms` |  927.86 |  1,855.71 |  1,608.34 |  247.37 |
| `quotient_poly_compute_time_ms` |  346.28 |  692.57 |  521.54 |  171.03 |
| `quotient_poly_commit_time_ms` |  130.76 |  261.53 |  231.18 |  30.34 |
| `pcs_opening_time_ms ` |  5,085 |  10,170 |  5,443 |  4,727 |

| internal.0 |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  2,928 |  2,928 |  2,928 |  2,928 |
| `main_cells_used     ` |  20,599,986 |  20,599,986 |  20,599,986 |  20,599,986 |
| `total_cells_used    ` |  43,722,760 |  43,722,760 |  43,722,760 |  43,722,760 |
| `execute_preflight_insns` |  4,042,090 |  4,042,090 |  4,042,090 |  4,042,090 |
| `execute_preflight_time_ms` |  1,509 |  1,509 |  1,509 |  1,509 |
| `execute_preflight_insn_mi/s` |  5.98 | -          |  5.98 |  5.98 |
...
| `perm_trace_commit_time_ms` |  189.05 |  189.05 |  189.05 |  189.05 |
| `quotient_poly_compute_time_ms` |  281.41 |  281.41 |  281.41 |  281.41 |
| `quotient_poly_commit_time_ms` |  74.40 |  74.40 |  74.40 |  74.40 |
| `pcs_opening_time_ms ` |  339 |  339 |  339 |  339 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal.0 |  | 2,933 |  | 3 | 2 |  |  |  |  | 
| kitchen_sink |  |  | 5,747 |  | 1 | 7 | 154,763 | 20.05 | 0 | 
| leaf | 7,068 |  |  | 1 | 1 |  |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal.0 | 0 | 155 | 2,928 | 43,722,760 | 732,015,074 | 155 | 1,262 | 0 | 281.41 | 74.40 | 5 | 189.05 | 339 | 308 | 339 | 16 | 256 | 20,599,986 | 118 | 1,509 | 4,042,090 | 5.98 | 44 | 357 | 0 | 339 | 
| leaf | 0 | 618 | 12,145 | 193,621,744 | 3,758,099,946 | 618 | 9,042 | 0 | 521.54 | 231.18 | 6 | 1,608.34 | 5,443 | 2,082 | 5,443 | 34 | 739 | 83,653,770 | 473 | 2,483 | 9,308,715 | 5.70 | 205 | 777 | 36 | 5,443 | 
| leaf | 1 | 220 | 7,063 | 93,240,020 | 1,225,346,538 | 220 | 5,441 | 0 | 171.03 | 30.34 | 6 | 247.37 | 4,727 | 355 | 4,727 | 23 | 155 | 41,601,390 | 107 | 1,400 | 3,269,540 | 5.86 | 43 | 202 | 0 | 4,727 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| kitchen_sink | 0 | 138 | 5,449 | 39,702,956 | 760,599,754 | 138 | 5,035 | 0 | 451.61 | 10.18 | 17 | 95.98 | 4,107 | 255 | 4,107 | 0 | 208 | 10,085,858 | 135 | 132 | 121,000 | 11.37 | 61 | 462 | 3 | 4,107 | 
| kitchen_sink | 1 | 130 | 5,747 | 36,350,580 | 747,143,466 | 130 | 5,482 | 0 | 294.40 | 8.48 | 9 | 64.50 | 4,878 | 122 | 4,877 | 0 | 178 | 8,253,090 | 51 | 94 | 33,763 | 5.95 | 29 | 303 | 1 | 4,877 | 

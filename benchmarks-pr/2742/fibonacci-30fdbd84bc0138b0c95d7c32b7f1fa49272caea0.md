...
| `total_proof_time_ms ` |  547.57 |  3,833 |  667 |  524 |
| `execute_metered_time_ms` |  73 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  163.12 | -          |  163.12 |  163.12 |
| `execute_preflight_insns` |  1,714,323.57 |  12,000,265 |  1,747,000 |  1,518,265 |
| `execute_preflight_time_ms` |  56.86 |  398 |  63 |  50 |
| `execute_preflight_insn_mi/s` |  39.89 | -          |  40.17 |  39.62 |
| `trace_gen_time_ms   ` |  158.29 |  1,108 |  165 |  155 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  272.43 |  1,907 |  280 |  269 |
| `prover.main_trace_commit_time_ms` |  59.14 |  414 |  60 |  59 |
| `prover.rap_constraints_time_ms` |  175 |  1,225 |  179 |  174 |
| `prover.openings_time_ms` |  37.43 |  262 |  41 |  34 |
| `prover.rap_constraints.logup_gkr_time_ms` |  126.14 |  883 |  127 |  126 |
| `prover.rap_constraints.round0_time_ms` |  29.14 |  204 |  32 |  28 |
...
| `prover.openings.whir_time_ms` |  20 |  140 |  22 |  18 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  477.50 |  955 |  549 |  406 |
| `execute_preflight_time_ms` |  1 |  2 |  1 |  1 |
| `trace_gen_time_ms   ` |  48.50 |  97 |  60 |  37 |
| `generate_blob_total_time_ms` |  3.50 |  7 |  4 |  3 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  428 |  856 |  488 |  368 |
...
| `prover.rap_constraints.round0_time_ms` |  73.50 |  147 |  81 |  66 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/30fdbd84bc0138b0c95d7c32b7f1fa49272caea0/fibonacci-30fdbd84bc0138b0c95d7c32b7f1fa49272caea0.memory.svg)
...
| app_proof |  |  |  |  |  | 532 |  |  | 73 | 12,000,265 | 163.12 | 0 | 3,916 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 28 | 387 | 27 | 10 | 2 | 2 | 1 | 1 | 
| internal_recursive.0 | 1 | 11 | 171 | 11 | 1 | 0 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 9 | 149 | 8 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 60 | 549 | 60 | 23 | 4 | 1 | 1 | 1 | 
| leaf | 1 | 37 | 406 | 37 | 17 | 3 | 1 | 1 | 1 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 75,533,952 | 358 | 160 | 0 | 9 | 146 | 40 | 39 | 72 | 33 | 0 | 51 | 19 | 32 | 5 | 26 | 161 | 146 | 0 | 2 | 32 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 23,651,975 | 159 | 47 | 0 | 3 | 70 | 23 | 23 | 27 | 18 | 0 | 41 | 17 | 23 | 1 | 21 | 48 | 70 | 0 | 2 | 17 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 17,507,975 | 140 | 33 | 0 | 3 | 64 | 22 | 22 | 24 | 17 | 0 | 40 | 18 | 22 | 1 | 20 | 34 | 64 | 0 | 2 | 17 | 0 | 0 | 
| leaf | 0 | prover | 187,180,090 | 488 | 234 | 0 | 15 | 182 | 81 | 80 | 52 | 48 | 0 | 70 | 31 | 39 | 12 | 27 | 235 | 182 | 0 | 5 | 47 | 0 | 0 | 
| leaf | 1 | prover | 130,615,306 | 368 | 159 | 0 | 10 | 146 | 66 | 65 | 44 | 35 | 0 | 62 | 29 | 32 | 8 | 24 | 159 | 146 | 0 | 5 | 34 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 212,425,530 | 280 | 59 | 0 | 1 | 179 | 32 | 31 | 19 | 127 | 0 | 41 | 21 | 19 | 6 | 13 | 59 | 179 | 0 | 3 | 126 | 0 | 0 | 
| app_proof | prover | 1 | 212,366,468 | 269 | 59 | 0 | 1 | 174 | 29 | 28 | 19 | 126 | 0 | 34 | 18 | 16 | 6 | 10 | 59 | 174 | 0 | 3 | 125 | 0 | 0 | 
| app_proof | prover | 2 | 212,366,468 | 269 | 59 | 0 | 1 | 174 | 28 | 28 | 19 | 126 | 0 | 36 | 19 | 16 | 6 | 10 | 59 | 174 | 0 | 3 | 125 | 0 | 0 | 
| app_proof | prover | 3 | 212,366,468 | 270 | 59 | 0 | 1 | 174 | 28 | 28 | 19 | 126 | 0 | 36 | 20 | 16 | 6 | 10 | 59 | 174 | 0 | 3 | 125 | 0 | 0 | 
| app_proof | prover | 4 | 212,366,468 | 271 | 59 | 0 | 1 | 174 | 29 | 28 | 19 | 126 | 0 | 37 | 20 | 16 | 6 | 10 | 59 | 174 | 0 | 3 | 125 | 0 | 0 | 
| app_proof | prover | 5 | 212,366,468 | 273 | 58 | 0 | 1 | 174 | 28 | 28 | 19 | 126 | 0 | 39 | 22 | 16 | 6 | 10 | 59 | 174 | 0 | 3 | 125 | 0 | 0 | 
| app_proof | prover | 6 | 212,423,724 | 275 | 59 | 0 | 1 | 176 | 30 | 30 | 19 | 126 | 0 | 39 | 20 | 18 | 6 | 12 | 60 | 176 | 0 | 3 | 126 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 155 | 667 | 155 | 168 | 0 | 3 | 63 | 1,747,000 | 39.62 | 
| app_proof | 1 | 156 | 524 | 156 | 40 | 0 | 1 | 57 | 1,747,000 | 39.91 | 
| app_proof | 2 | 158 | 526 | 157 | 40 | 0 | 1 | 57 | 1,747,000 | 39.97 | 
| app_proof | 3 | 158 | 527 | 158 | 40 | 0 | 1 | 57 | 1,747,000 | 40.17 | 
| app_proof | 4 | 158 | 528 | 158 | 41 | 0 | 1 | 57 | 1,747,000 | 40 | 
| app_proof | 5 | 158 | 529 | 158 | 40 | 0 | 1 | 57 | 1,747,000 | 39.91 | 
| app_proof | 6 | 165 | 532 | 165 | 40 | 0 | 1 | 50 | 1,518,265 | 39.63 | 

...
|:---|---:|---:|---:|
| Total |  18.90 |  5.32 |  5.32 |
| app_proof |  15.83 |  3.03 |  3.03 |
| leaf |  2.21 |  1.43 |  1.43 |
...
| `total_proof_time_ms ` |  2,632.17 |  15,793 |  2,994 |  2,542 |
...
| `execute_preflight_time_ms` |  179.67 |  1,078 |  276 |  15 |
| `execute_preflight_insn_mi/s` |  19.30 | -          |  19.61 |  18.93 |
| `trace_gen_time_ms   ` |  390.33 |  2,342 |  543 |  351 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,998.33 |  11,990 |  2,264 |  1,943 |
| `prover.main_trace_commit_time_ms` |  695.50 |  4,173 |  855 |  663 |
| `prover.rap_constraints_time_ms` |  1,118.83 |  6,713 |  1,227 |  1,091 |
| `prover.openings_time_ms` |  182.83 |  1,097 |  188 |  178 |
| `prover.rap_constraints.logup_gkr_time_ms` |  275.83 |  1,655 |  385 |  253 |
| `prover.rap_constraints.round0_time_ms` |  529 |  3,174 |  533 |  523 |
| `prover.rap_constraints.mle_rounds_time_ms` |  313 |  1,878 |  318 |  308 |
| `prover.openings.stacked_reduction_time_ms` |  140.50 |  843 |  144 |  137 |
| `prover.openings.stacked_reduction.round0_time_ms` |  84.33 |  506 |  87 |  79 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  55.33 |  332 |  57 |  53 |
| `prover.openings.whir_time_ms` |  42.17 |  253 |  44 |  40 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,107.50 |  2,215 |  1,433 |  782 |
| `execute_preflight_time_ms` |  4.50 |  9 |  5 |  4 |
| `trace_gen_time_ms   ` |  138 |  276 |  186 |  90 |
| `generate_blob_total_time_ms` |  25.50 |  51 |  34 |  17 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  969 |  1,938 |  1,247 |  691 |
| `prover.main_trace_commit_time_ms` |  549 |  1,098 |  722 |  376 |
| `prover.rap_constraints_time_ms` |  313 |  626 |  401 |  225 |
| `prover.openings_time_ms` |  105.50 |  211 |  123 |  88 |
| `prover.rap_constraints.logup_gkr_time_ms` |  65.50 |  131 |  81 |  50 |
| `prover.rap_constraints.round0_time_ms` |  154.50 |  309 |  202 |  107 |
...
| `prover.openings.whir_time_ms` |  36.50 |  73 |  37 |  36 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/30fdbd84bc0138b0c95d7c32b7f1fa49272caea0/keccak-30fdbd84bc0138b0c95d7c32b7f1fa49272caea0.memory.svg)
...
| app_proof |  |  |  |  |  | 2,555 |  |  | 36 | 1,235,218 | 33.51 | 0 | 15,836 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 40 | 525 | 39 | 14 | 4 | 2 | 2 | 2 | 
| internal_recursive.0 | 1 | 13 | 183 | 13 | 2 | 1 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 9 | 152 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 186 | 1,433 | 185 | 65 | 34 | 5 | 7 | 7 | 
| leaf | 1 | 90 | 782 | 90 | 33 | 17 | 4 | 7 | 7 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 109,497,984 | 485 | 248 | 0 | 14 | 173 | 46 | 46 | 93 | 33 | 0 | 62 | 24 | 38 | 7 | 30 | 248 | 173 | 0 | 3 | 32 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 25,962,119 | 169 | 51 | 0 | 3 | 76 | 24 | 24 | 29 | 22 | 0 | 40 | 16 | 24 | 2 | 21 | 51 | 76 | 0 | 2 | 21 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 17,507,975 | 142 | 34 | 0 | 3 | 64 | 22 | 22 | 24 | 17 | 0 | 44 | 21 | 22 | 1 | 20 | 34 | 64 | 0 | 2 | 16 | 0 | 0 | 
| leaf | 0 | prover | 583,523,386 | 1,247 | 721 | 0 | 47 | 401 | 202 | 201 | 117 | 81 | 0 | 123 | 37 | 86 | 40 | 45 | 722 | 401 | 0 | 6 | 80 | 0 | 0 | 
| leaf | 1 | prover | 300,618,208 | 691 | 376 | 0 | 24 | 225 | 107 | 106 | 67 | 50 | 0 | 88 | 36 | 52 | 19 | 32 | 376 | 225 | 0 | 6 | 50 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,205,061,845 | 2,264 | 855 | 0 | 246 | 1,227 | 523 | 522 | 318 | 385 | 129 | 181 | 40 | 141 | 84 | 56 | 855 | 1,227 | 0 | 3 | 254 | 0 | 0 | 
| app_proof | prover | 1 | 1,205,053,652 | 1,944 | 663 | 0 | 51 | 1,095 | 528 | 527 | 313 | 253 | 0 | 185 | 44 | 141 | 87 | 53 | 663 | 1,095 | 0 | 3 | 252 | 0 | 0 | 
| app_proof | prover | 2 | 1,205,053,652 | 1,943 | 663 | 0 | 51 | 1,097 | 531 | 531 | 311 | 254 | 0 | 181 | 41 | 139 | 85 | 54 | 664 | 1,097 | 0 | 3 | 253 | 0 | 0 | 
| app_proof | prover | 3 | 1,205,053,652 | 1,943 | 663 | 0 | 51 | 1,100 | 532 | 531 | 314 | 254 | 0 | 178 | 41 | 137 | 79 | 57 | 663 | 1,100 | 0 | 4 | 252 | 0 | 0 | 
| app_proof | prover | 4 | 1,205,053,652 | 1,943 | 663 | 0 | 51 | 1,091 | 527 | 527 | 308 | 254 | 0 | 188 | 44 | 144 | 87 | 56 | 663 | 1,091 | 0 | 4 | 253 | 0 | 0 | 
| app_proof | prover | 5 | 1,205,062,652 | 1,953 | 665 | 0 | 52 | 1,103 | 533 | 532 | 314 | 255 | 0 | 184 | 43 | 141 | 84 | 56 | 665 | 1,103 | 0 | 3 | 254 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 543 | 2,994 | 543 | 170 | 0 | 3 | 15 | 207,000 | 18.93 | 
| app_proof | 1 | 351 | 2,614 | 351 | 41 | 0 | 1 | 276 | 207,000 | 19.13 | 
| app_proof | 2 | 356 | 2,544 | 356 | 41 | 0 | 1 | 203 | 207,000 | 19.60 | 
| app_proof | 3 | 354 | 2,542 | 354 | 41 | 0 | 1 | 203 | 207,000 | 19.07 | 
| app_proof | 4 | 354 | 2,544 | 354 | 41 | 0 | 1 | 205 | 207,000 | 19.61 | 
| app_proof | 5 | 384 | 2,555 | 384 | 41 | 0 | 1 | 176 | 200,218 | 19.49 | 

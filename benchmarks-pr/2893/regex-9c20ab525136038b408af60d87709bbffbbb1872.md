...
|:---|---:|---:|---:|
| Total |  2.58 |  1.94 |  1.94 |
| app_proof |  1.56 |  0.92 |  0.92 |
| leaf |  0.43 |  0.43 |  0.43 |
...
| `total_proof_time_ms ` |  763 |  1,526 |  882 |  644 |
...
| `execute_preflight_insn_mi/s` |  33.49 | -          |  34.92 |  32.06 |
| `trace_gen_time_ms   ` |  37 |  74 |  43 |  31 |
| `memory_finalize_time_ms` |  1 |  2 |  2 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  551.50 |  1,103 |  620 |  483 |
| `prover.main_trace_commit_time_ms` |  115 |  230 |  129 |  101 |
| `prover.rap_constraints_time_ms` |  323 |  646 |  364 |  282 |
| `prover.openings_time_ms` |  113.50 |  227 |  127 |  100 |
| `prover.rap_constraints.logup_gkr_time_ms` |  198 |  396 |  241 |  155 |
| `prover.rap_constraints.round0_time_ms` |  90.50 |  181 |  96 |  85 |
...
| `prover.openings.whir_time_ms` |  90 |  180 |  101 |  79 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/9c20ab525136038b408af60d87709bbffbbb1872/regex-9c20ab525136038b408af60d87709bbffbbb1872.memory.svg)

| Module | Max (GB) | Max At |
| --- | ---: | --- |
| frac_sumcheck.gkr_rounds | 3.62 | app_proof.prover.0 |
| prover.batch_constraints.before_round0 | 3.62 | app_proof.prover.0 |
| frac_sumcheck.segment_tree | 3.49 | app_proof.prover.0 |
| prover.gkr_input_evals | 3.49 | app_proof.prover.0 |
| generate mem proving ctxs | 2.77 | app_proof.0 |
| set initial memory | 2.75 | app_proof.1 |
| prover.stacked_commit | 2.09 | app_proof.prover.0 |
...
| prover.batch_constraints.fold_ple_evals | 1.55 | app_proof.prover.0 |
| prover.rap_constraints | 1.55 | app_proof.prover.0 |
| prover.batch_constraints.round0 | 1.55 | app_proof.prover.0 |
...
| app_proof |  |  |  |  |  | 644 |  |  | 34 | 4,090,656 | 119.28 | 0 | 1,574 |  | 
...
| app_proof | VmAirWrapper<Rv64BaseAluAdapterAir, ShiftLeftCoreAir<8, 8> | 0 | 2 | 
...
| app_proof | VmAirWrapper<Rv64BaseAluWAdapterAir, ShiftLeftCoreAir<4, 8> | 1 | 0 | 
...
| app_proof | 21 | VmAirWrapper<Rv64BaseAluWAdapterAir, ShiftRightCoreAir<4, 8> | SRL | 0 | 96 | 
| app_proof | 23 | VmAirWrapper<Rv64BaseAluAdapterAir, ShiftRightCoreAir<8, 8> | SRA | 0 | 91 | 
| app_proof | 23 | VmAirWrapper<Rv64BaseAluAdapterAir, ShiftRightCoreAir<8, 8> | SRL | 0 | 29,300 | 
| app_proof | 24 | VmAirWrapper<Rv64BaseAluAdapterAir, ShiftLeftCoreAir<8, 8> | SLL | 0 | 163,176 | 
| app_proof | 25 | VmAirWrapper<Rv64BaseAluU16AdapterAir, LessThanCoreAir<4, 16> | SLT | 0 | 92 | 
| app_proof | 25 | VmAirWrapper<Rv64BaseAluU16AdapterAir, LessThanCoreAir<4, 16> | SLTU | 0 | 10,484 | 
| app_proof | 26 | VmAirWrapper<Rv64BaseAluWAdapterAir, BaseAluCoreAir<4, 8> | ADD | 0 | 435 | 
| app_proof | 26 | VmAirWrapper<Rv64BaseAluWAdapterAir, BaseAluCoreAir<4, 8> | SUB | 0 | 2,791 | 
| app_proof | 27 | VmAirWrapper<Rv64BaseAluAdapterAir, BaseAluCoreAir<8, 8> | ADD | 0 | 517,824 | 
| app_proof | 27 | VmAirWrapper<Rv64BaseAluAdapterAir, BaseAluCoreAir<8, 8> | AND | 0 | 50,230 | 
| app_proof | 27 | VmAirWrapper<Rv64BaseAluAdapterAir, BaseAluCoreAir<8, 8> | OR | 0 | 8,815 | 
| app_proof | 27 | VmAirWrapper<Rv64BaseAluAdapterAir, BaseAluCoreAir<8, 8> | SUB | 0 | 31,612 | 
| app_proof | 27 | VmAirWrapper<Rv64BaseAluAdapterAir, BaseAluCoreAir<8, 8> | XOR | 0 | 5,393 | 
...
| app_proof | 22 | VmAirWrapper<Rv64BaseAluWAdapterAir, ShiftLeftCoreAir<4, 8> | SLL | 1 | 1 | 
| app_proof | 23 | VmAirWrapper<Rv64BaseAluAdapterAir, ShiftRightCoreAir<8, 8> | SRL | 1 | 23,365 | 
| app_proof | 24 | VmAirWrapper<Rv64BaseAluAdapterAir, ShiftLeftCoreAir<8, 8> | SLL | 1 | 132,956 | 
| app_proof | 25 | VmAirWrapper<Rv64BaseAluU16AdapterAir, LessThanCoreAir<4, 16> | SLT | 1 | 2 | 
| app_proof | 25 | VmAirWrapper<Rv64BaseAluU16AdapterAir, LessThanCoreAir<4, 16> | SLTU | 1 | 8,214 | 
| app_proof | 26 | VmAirWrapper<Rv64BaseAluWAdapterAir, BaseAluCoreAir<4, 8> | ADD | 1 | 3 | 
| app_proof | 26 | VmAirWrapper<Rv64BaseAluWAdapterAir, BaseAluCoreAir<4, 8> | SUB | 1 | 2,244 | 
| app_proof | 27 | VmAirWrapper<Rv64BaseAluAdapterAir, BaseAluCoreAir<8, 8> | ADD | 1 | 395,973 | 
| app_proof | 27 | VmAirWrapper<Rv64BaseAluAdapterAir, BaseAluCoreAir<8, 8> | AND | 1 | 36,308 | 
| app_proof | 27 | VmAirWrapper<Rv64BaseAluAdapterAir, BaseAluCoreAir<8, 8> | OR | 1 | 4,137 | 
| app_proof | 27 | VmAirWrapper<Rv64BaseAluAdapterAir, BaseAluCoreAir<8, 8> | SUB | 1 | 25,375 | 
| app_proof | 27 | VmAirWrapper<Rv64BaseAluAdapterAir, BaseAluCoreAir<8, 8> | XOR | 1 | 4,110 | 
...
| app_proof | 21 | VmAirWrapper<Rv64BaseAluWAdapterAir, ShiftRightCoreAir<4, 8> | prover | 0 | 128 | 56 | 7,168 | 
| app_proof | 23 | VmAirWrapper<Rv64BaseAluAdapterAir, ShiftRightCoreAir<8, 8> | prover | 0 | 32,768 | 71 | 2,326,528 | 
| app_proof | 24 | VmAirWrapper<Rv64BaseAluAdapterAir, ShiftLeftCoreAir<8, 8> | prover | 0 | 262,144 | 69 | 18,087,936 | 
| app_proof | 25 | VmAirWrapper<Rv64BaseAluU16AdapterAir, LessThanCoreAir<4, 16> | prover | 0 | 16,384 | 38 | 622,592 | 
| app_proof | 26 | VmAirWrapper<Rv64BaseAluWAdapterAir, BaseAluCoreAir<4, 8> | prover | 0 | 4,096 | 41 | 167,936 | 
...
| app_proof | 30 | Poseidon2PeripheryAir<BabyBearParameters>, 1> | prover | 0 | 16,384 | 300 | 4,915,200 | 
...
| app_proof | 22 | VmAirWrapper<Rv64BaseAluWAdapterAir, ShiftLeftCoreAir<4, 8> | prover | 1 | 1 | 54 | 54 | 
| app_proof | 23 | VmAirWrapper<Rv64BaseAluAdapterAir, ShiftRightCoreAir<8, 8> | prover | 1 | 32,768 | 71 | 2,326,528 | 
| app_proof | 24 | VmAirWrapper<Rv64BaseAluAdapterAir, ShiftLeftCoreAir<8, 8> | prover | 1 | 262,144 | 69 | 18,087,936 | 
| app_proof | 25 | VmAirWrapper<Rv64BaseAluU16AdapterAir, LessThanCoreAir<4, 16> | prover | 1 | 16,384 | 38 | 622,592 | 
| app_proof | 26 | VmAirWrapper<Rv64BaseAluWAdapterAir, BaseAluCoreAir<4, 8> | prover | 1 | 4,096 | 41 | 167,936 | 
| app_proof | 27 | VmAirWrapper<Rv64BaseAluAdapterAir, BaseAluCoreAir<8, 8> | prover | 1 | 524,288 | 48 | 25,165,824 | 
...
| app_proof | 30 | Poseidon2PeripheryAir<BabyBearParameters>, 1> | prover | 1 | 2,048 | 300 | 614,400 | 
...
| app_proof | 21 | VmAirWrapper<Rv64BaseAluWAdapterAir, ShiftRightCoreAir<4, 8> | 0 | 96 | 32 | 13,440 | 4,480 | 21,504 | 7,168 | 5,376 | 1,792 | 100,920 | 33,640 | 2,784 | 928 | 
| app_proof | 23 | VmAirWrapper<Rv64BaseAluAdapterAir, ShiftRightCoreAir<8, 8> | 0 | 29,391 | 3,377 | 5,216,903 | 599,417 | 8,347,044 | 959,068 | 2,086,761 | 239,767 | 40,486,103 | 4,651,817 | 1,116,858 | 128,326 | 
| app_proof | 24 | VmAirWrapper<Rv64BaseAluAdapterAir, ShiftLeftCoreAir<8, 8> | 0 | 163,176 | 98,968 | 28,147,860 | 17,071,980 | 45,036,576 | 27,315,168 | 11,259,144 | 6,828,792 | 218,859,810 | 132,740,830 | 6,037,512 | 3,661,816 | 
| app_proof | 25 | VmAirWrapper<Rv64BaseAluU16AdapterAir, LessThanCoreAir<4, 16> | 0 | 10,576 | 5,808 | 1,004,720 | 551,760 | 1,607,552 | 882,816 | 401,888 | 220,704 | 7,284,220 | 4,000,260 | 200,944 | 110,352 | 
| app_proof | 26 | VmAirWrapper<Rv64BaseAluWAdapterAir, BaseAluCoreAir<4, 8> | 0 | 3,226 | 870 | 330,665 | 89,175 | 529,064 | 142,680 | 132,266 | 35,670 | 2,923,563 | 788,437 | 80,650 | 21,750 | 
| app_proof | 27 | VmAirWrapper<Rv64BaseAluAdapterAir, BaseAluCoreAir<8, 8> | 0 | 613,874 | 434,702 | 73,664,880 | 52,164,240 | 117,863,808 | 83,462,784 | 29,465,952 | 20,865,696 | 712,093,840 | 504,254,320 | 19,643,968 | 13,910,464 | 
...
| app_proof | 30 | Poseidon2PeripheryAir<BabyBearParameters>, 1> | 0 |
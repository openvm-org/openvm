...
|:---|---:|---:|
| Total | <span style='color: red'>(+0 [+0.7%])</span> 1.52 | <span style='color: red'>(+0 [+1.1%])</span> 0.91 |
| pairing | <span style='color: red'>(+0 [+0.8%])</span> 1.43 | <span style='color: red'>(+0 [+1.2%])</span> 0.82 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+6 [+0.8%])</span> 716 | <span style='color: red'>(+11 [+0.8%])</span> 1,432 | <span style='color: red'>(+10 [+1.2%])</span> 823 | <span style='color: red'>(+1 [+0.2%])</span> 609 |
...
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+0 [+0.9%])</span> 13.74 | -          | <span style='color: red'>(+0 [+1.3%])</span> 18.33 | <span style='color: red'>(+0 [+0.2%])</span> 9.14 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+5 [+2.8%])</span> 181 | <span style='color: red'>(+10 [+2.8%])</span> 362 | <span style='color: red'>(+4 [+2.1%])</span> 197 | <span style='color: red'>(+6 [+3.8%])</span> 165 |
...
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+1 [+0.3%])</span> 346.50 | <span style='color: red'>(+2 [+0.3%])</span> 693 | <span style='color: red'>(+5 [+1.3%])</span> 383 | <span style='color: green'>(-3 [-1.0%])</span> 310 |
...
| `generate_perm_trace_time_ms` | <span style='color: green'>(-5 [-14.1%])</span> 30.50 | <span style='color: green'>(-10 [-14.1%])</span> 61 | <span style='color: green'>(-4 [-10.5%])</span> 34 | <span style='color: green'>(-6 [-18.2%])</span> 27 |
| `perm_trace_commit_time_ms` | <span style='color: red'>(+1 [+1.8%])</span> 77.64 | <span style='color: red'>(+3 [+1.8%])</span> 155.29 | <span style='color: red'>(+2 [+2.0%])</span> 89.52 | <span style='color: red'>(+1 [+1.6%])</span> 65.77 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+1 [+1.4%])</span> 79.40 | <span style='color: red'>(+2 [+1.4%])</span> 158.79 | <span style='color: red'>(+1 [+1.3%])</span> 88.43 | <span style='color: red'>(+1 [+1.4%])</span> 70.36 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+0 [+1.9%])</span> 15.95 | <span style='color: red'>(+1 [+1.9%])</span> 31.90 | <span style='color: green'>(-0 [-1.3%])</span> 17.40 | <span style='color: red'>(+1 [+6.1%])</span> 14.50 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+2 [+3.5%])</span> 73 | <span style='color: red'>(+5 [+3.5%])</span> 146 |  73 | <span style='color: red'>(+5 [+7.4%])</span> 73 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 609 | 40 | 1 | 89 | 1,745,742 | 19.49 | 148 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 165 | 823 | 32,689,110 | 172,558,444 | 165 | 383 | 0 | 88.43 | 17.40 | 6 | 89.52 | 73 | 126 | 73 | 1 | 75 | 16,059,916 | 34 | 130 | 1,157,000 | 9.14 | 26 | 106 | 1 | 73 | 
| pairing | 1 | 197 | 609 | 22,314,288 | 119,958,502 | 197 | 310 | 1 | 70.36 | 14.50 | 6 | 65.77 | 73 | 96 | 73 | 0 | 55 | 9,408,294 | 27 | 60 | 588,742 | 18.33 | 21 | 85 | 1 | 73 | 

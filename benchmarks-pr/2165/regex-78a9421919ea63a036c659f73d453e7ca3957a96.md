...
|:---|---:|---:|
| Total | <span style='color: red'>(+0 [+3.0%])</span> 2.43 | <span style='color: red'>(+0 [+4.4%])</span> 0.78 |
| regex_program | <span style='color: red'>(+0 [+3.0%])</span> 2.40 | <span style='color: red'>(+0 [+4.5%])</span> 0.75 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+18 [+3.0%])</span> 599.25 | <span style='color: red'>(+70 [+3.0%])</span> 2,397 | <span style='color: red'>(+32 [+4.5%])</span> 750 | <span style='color: red'>(+23 [+4.4%])</span> 545 |
...
| `execute_metered_insn_mi/s` | <span style='color: green'>(-1 [-0.9%])</span> 120.99 | -          | <span style='color: green'>(-1 [-0.9%])</span> 120.99 | <span style='color: green'>(-1 [-0.9%])</span> 120.99 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  54.25 |  217 | <span style='color: green'>(-3 [-4.3%])</span> 66 | <span style='color: red'>(+2 [+4.5%])</span> 46 |
| `execute_preflight_insn_mi/s` | <span style='color: green'>(-2 [-5.3%])</span> 30.29 | -          | <span style='color: green'>(-2 [-5.7%])</span> 31.42 | <span style='color: green'>(-1 [-2.5%])</span> 27.72 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+2 [+1.0%])</span> 181.75 | <span style='color: red'>(+7 [+1.0%])</span> 727 | <span style='color: red'>(+1 [+0.5%])</span> 216 | <span style='color: red'>(+5 [+3.2%])</span> 159 |
| `memory_finalize_time_ms` |  1 |  4 |  4 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+17 [+6.0%])</span> 295.25 | <span style='color: red'>(+67 [+6.0%])</span> 1,181 | <span style='color: red'>(+35 [+11.4%])</span> 342 | <span style='color: red'>(+14 [+5.4%])</span> 271 |
...
| `generate_perm_trace_time_ms` | <span style='color: red'>(+10 [+42.9%])</span> 35 | <span style='color: red'>(+42 [+42.9%])</span> 140 | <span style='color: red'>(+26 [+89.7%])</span> 55 | <span style='color: red'>(+1 [+5.6%])</span> 19 |
| `perm_trace_commit_time_ms` | <span style='color: red'>(+0 [+0.2%])</span> 65.10 | <span style='color: red'>(+0 [+0.2%])</span> 260.40 | <span style='color: green'>(-1 [-1.3%])</span> 70.52 | <span style='color: red'>(+1 [+2.0%])</span> 56.52 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+0 [+0.7%])</span> 59.73 | <span style='color: red'>(+2 [+0.7%])</span> 238.91 | <span style='color: green'>(-0 [-0.3%])</span> 69.94 |  53.47 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+0 [+2.9%])</span> 15.44 | <span style='color: red'>(+2 [+2.9%])</span> 61.77 | <span style='color: red'>(+1 [+8.1%])</span> 17.100 | <span style='color: green'>(-1 [-3.8%])</span> 12.66 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+5 [+7.9%])</span> 64.75 | <span style='color: red'>(+19 [+7.9%])</span> 259 | <span style='color: red'>(+5 [+6.8%])</span> 78 | <span style='color: red'>(+5 [+9.6%])</span> 57 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 545 | 41 | 1 | 34 | 4,137,502 | 120.99 | 168 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 216 | 750 | 23,446,148 | 150,778,428 | 216 | 342 | 0 | 61.80 | 17.100 | 5 | 70.52 | 78 | 126 | 77 | 4 | 56 | 10,899,170 | 55 | 46 | 1,103,000 | 27.72 | 21 | 80 | 1 | 77 | 
| regex_program | 1 | 159 | 557 | 11,598,276 | 128,513,066 | 159 | 290 | 1 | 53.47 | 15.100 | 4 | 66.18 | 63 | 105 | 63 | 0 | 51 | 2,196,106 | 38 | 66 | 1,104,000 | 31.42 | 17 | 70 | 0 | 63 | 
| regex_program | 2 | 166 | 545 | 11,579,064 | 128,513,066 | 166 | 278 | 1 | 53.69 | 15.12 | 4 | 67.18 | 61 | 96 | 61 | 0 | 50 | 2,177,334 | 28 | 59 | 1,104,000 | 31.17 | 16 | 69 | 0 | 61 | 
| regex_program | 3 | 186 | 545 | 11,853,872 | 103,456,394 | 186 | 271 | 0 | 69.94 | 12.66 | 5 | 56.52 | 57 | 78 | 57 | 0 | 51 | 2,422,606 | 19 | 46 | 826,502 | 30.83 | 18 | 83 | 1 | 57 | 

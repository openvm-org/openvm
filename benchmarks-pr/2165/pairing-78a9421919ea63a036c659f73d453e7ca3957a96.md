...
|:---|---:|---:|
| Total | <span style='color: red'>(+0 [+3.4%])</span> 1.56 | <span style='color: red'>(+0 [+1.8%])</span> 0.92 |
| pairing | <span style='color: red'>(+0 [+3.7%])</span> 1.47 | <span style='color: red'>(+0 [+2.0%])</span> 0.83 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+26 [+3.7%])</span> 736.50 | <span style='color: red'>(+52 [+3.7%])</span> 1,473 | <span style='color: red'>(+16 [+2.0%])</span> 829 | <span style='color: red'>(+36 [+5.9%])</span> 644 |
...
| `execute_metered_insn_mi/s` | <span style='color: red'>(+0 [+0.4%])</span> 19.50 | -          | <span style='color: red'>(+0 [+0.4%])</span> 19.50 | <span style='color: red'>(+0 [+0.4%])</span> 19.50 |
...
| `execute_preflight_insn_mi/s` | <span style='color: green'>(-0 [-1.0%])</span> 13.48 | -          | <span style='color: green'>(-0 [-1.6%])</span> 17.82 | <span style='color: red'>(+0 [+0.1%])</span> 9.14 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+4 [+2.0%])</span> 179.50 | <span style='color: red'>(+7 [+2.0%])</span> 359 | <span style='color: red'>(+2 [+1.0%])</span> 195 | <span style='color: red'>(+5 [+3.1%])</span> 164 |
...
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+23 [+6.7%])</span> 368.50 | <span style='color: red'>(+46 [+6.7%])</span> 737 | <span style='color: red'>(+14 [+3.7%])</span> 392 | <span style='color: red'>(+32 [+10.2%])</span> 345 |
...
| `generate_perm_trace_time_ms` | <span style='color: red'>(+18 [+50.7%])</span> 53.50 | <span style='color: red'>(+36 [+50.7%])</span> 107 | <span style='color: red'>(+17 [+44.7%])</span> 55 | <span style='color: red'>(+19 [+57.6%])</span> 52 |
| `perm_trace_commit_time_ms` | <span style='color: red'>(+1 [+1.4%])</span> 77.30 | <span style='color: red'>(+2 [+1.4%])</span> 154.61 | <span style='color: red'>(+2 [+2.2%])</span> 89.73 | <span style='color: red'>(+0 [+0.2%])</span> 64.88 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+1 [+1.9%])</span> 79.79 | <span style='color: red'>(+3 [+1.9%])</span> 159.57 | <span style='color: red'>(+1 [+1.2%])</span> 88.31 | <span style='color: red'>(+2 [+2.7%])</span> 71.26 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+0 [+1.9%])</span> 15.95 | <span style='color: red'>(+1 [+1.9%])</span> 31.91 |  17.62 | <span style='color: red'>(+1 [+4.6%])</span> 14.29 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+2 [+2.8%])</span> 72.50 | <span style='color: red'>(+4 [+2.8%])</span> 145 | <span style='color: red'>(+8 [+11.0%])</span> 81 | <span style='color: green'>(-4 [-5.9%])</span> 64 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 644 | 66 | 1 | 89 | 1,745,742 | 19.50 | 171 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 164 | 829 | 32,689,110 | 172,558,444 | 164 | 392 | 0 | 88.31 | 17.62 | 6 | 89.73 | 64 | 145 | 64 | 1 | 75 | 16,059,916 | 52 | 130 | 1,157,000 | 9.14 | 26 | 106 | 1 | 64 | 
| pairing | 1 | 195 | 644 | 22,314,288 | 119,958,502 | 195 | 345 | 1 | 71.26 | 14.29 | 6 | 64.88 | 81 | 123 | 80 | 0 | 54 | 9,408,294 | 55 | 62 | 588,742 | 17.82 | 21 | 86 | 1 | 80 | 

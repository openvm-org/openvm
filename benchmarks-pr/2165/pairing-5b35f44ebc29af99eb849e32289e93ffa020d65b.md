...
|:---|---:|---:|
| Total | <span style='color: green'>(-0 [-0.2%])</span> 1.51 | <span style='color: red'>(+0 [+2.0%])</span> 0.92 |
| pairing | <span style='color: green'>(-0 [-0.3%])</span> 1.42 | <span style='color: red'>(+0 [+2.1%])</span> 0.83 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: green'>(-2 [-0.3%])</span> 708.50 | <span style='color: green'>(-4 [-0.3%])</span> 1,417 | <span style='color: red'>(+17 [+2.1%])</span> 830 | <span style='color: green'>(-21 [-3.5%])</span> 587 |
...
| `execute_metered_insn_mi/s` | <span style='color: green'>(-0 [-0.9%])</span> 19.25 | -          | <span style='color: green'>(-0 [-0.9%])</span> 19.25 | <span style='color: green'>(-0 [-0.9%])</span> 19.25 |
...
| `execute_preflight_insn_mi/s` | <span style='color: green'>(-0 [-0.1%])</span> 13.60 | -          | <span style='color: green'>(-0 [-0.2%])</span> 18.07 |  9.12 |
| `trace_gen_time_ms   ` | <span style='color: green'>(-2 [-1.1%])</span> 174 | <span style='color: green'>(-4 [-1.1%])</span> 348 | <span style='color: green'>(-3 [-1.6%])</span> 190 | <span style='color: green'>(-1 [-0.6%])</span> 158 |
...
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+0 [+0.1%])</span> 346 | <span style='color: red'>(+1 [+0.1%])</span> 692 | <span style='color: red'>(+20 [+5.3%])</span> 398 | <span style='color: green'>(-19 [-6.1%])</span> 294 |
| `main_trace_commit_time_ms` | <span style='color: red'>(+1 [+1.6%])</span> 65 | <span style='color: red'>(+2 [+1.6%])</span> 130 | <span style='color: red'>(+1 [+1.4%])</span> 75 | <span style='color: red'>(+1 [+1.9%])</span> 55 |
| `generate_perm_trace_time_ms` | <span style='color: red'>(+16 [+46.5%])</span> 52 | <span style='color: red'>(+33 [+46.5%])</span> 104 | <span style='color: red'>(+32 [+84.2%])</span> 70 | <span style='color: red'>(+1 [+3.0%])</span> 34 |
| `perm_trace_commit_time_ms` | <span style='color: green'>(-2 [-2.9%])</span> 74.06 | <span style='color: green'>(-4 [-2.9%])</span> 148.12 | <span style='color: green'>(-4 [-4.7%])</span> 83.68 | <span style='color: green'>(-0 [-0.5%])</span> 64.44 |
| `quotient_poly_compute_time_ms` | <span style='color: green'>(-2 [-3.0%])</span> 75.95 | <span style='color: green'>(-5 [-3.0%])</span> 151.90 | <span style='color: green'>(-4 [-5.0%])</span> 82.88 | <span style='color: green'>(-0 [-0.5%])</span> 69.02 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+0 [+3.0%])</span> 16.11 | <span style='color: red'>(+1 [+3.0%])</span> 32.22 | <span style='color: red'>(+1 [+3.4%])</span> 18.23 | <span style='color: red'>(+0 [+2.4%])</span> 13.100 |
| `pcs_opening_time_ms ` | <span style='color: green'>(-12 [-17.7%])</span> 58 | <span style='color: green'>(-25 [-17.7%])</span> 116 | <span style='color: green'>(-10 [-13.7%])</span> 63 | <span style='color: green'>(-15 [-22.1%])</span> 53 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 587 | 65 | 1 | 90 | 1,745,742 | 19.25 | 172 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 158 | 830 | 32,689,110 | 172,558,444 | 158 | 398 | 0 | 82.88 | 18.23 | 6 | 83.68 | 63 | 157 | 63 | 1 | 75 | 16,059,916 | 70 | 130 | 1,157,000 | 9.12 | 26 | 101 | 1 | 63 | 
| pairing | 1 | 190 | 587 | 22,314,288 | 119,958,502 | 189 | 294 | 1 | 69.02 | 13.100 | 6 | 64.44 | 53 | 101 | 53 | 0 | 55 | 9,408,294 | 34 | 62 | 588,742 | 18.07 | 20 | 83 | 1 | 53 | 

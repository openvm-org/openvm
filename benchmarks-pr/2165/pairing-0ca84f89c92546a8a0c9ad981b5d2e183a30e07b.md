...
|:---|---:|---:|
| Total | <span style='color: red'>(+0 [+0.7%])</span> 1.54 | <span style='color: red'>(+0 [+1.5%])</span> 0.94 |
| pairing | <span style='color: red'>(+0 [+0.6%])</span> 1.45 | <span style='color: red'>(+0 [+1.6%])</span> 0.85 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+4 [+0.6%])</span> 726.50 | <span style='color: red'>(+9 [+0.6%])</span> 1,453 | <span style='color: red'>(+13 [+1.6%])</span> 848 | <span style='color: green'>(-4 [-0.7%])</span> 605 |
...
| `execute_metered_insn_mi/s` | <span style='color: green'>(-0 [-0.7%])</span> 19.32 | -          | <span style='color: green'>(-0 [-0.7%])</span> 19.32 | <span style='color: green'>(-0 [-0.7%])</span> 19.32 |
| `execute_preflight_insns` |  872,871 |  1,745,742 |  1,157,000 |  588,742 |
| `execute_preflight_time_ms` |  95 |  190 |  130 |  60 |
| `execute_preflight_insn_mi/s` | <span style='color: green'>(-0 [-1.3%])</span> 13.51 | -          | <span style='color: green'>(-0 [-1.9%])</span> 17.94 | <span style='color: green'>(-0 [-0.2%])</span> 9.09 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+6 [+3.7%])</span> 184 | <span style='color: red'>(+13 [+3.7%])</span> 368 | <span style='color: red'>(+7 [+3.6%])</span> 201 | <span style='color: red'>(+6 [+3.7%])</span> 167 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: green'>(-2 [-0.4%])</span> 353.50 | <span style='color: green'>(-3 [-0.4%])</span> 707 | <span style='color: red'>(+9 [+2.3%])</span> 405 | <span style='color: green'>(-12 [-3.8%])</span> 302 |
| `main_trace_commit_time_ms` | <span style='color: red'>(+2 [+3.9%])</span> 66.50 | <span style='color: red'>(+5 [+3.9%])</span> 133 | <span style='color: red'>(+3 [+4.1%])</span> 77 | <span style='color: red'>(+2 [+3.7%])</span> 56 |
| `generate_perm_trace_time_ms` | <span style='color: green'>(-8 [-16.7%])</span> 37.50 | <span style='color: green'>(-15 [-16.7%])</span> 75 | <span style='color: green'>(-6 [-12.0%])</span> 44 | <span style='color: green'>(-9 [-22.5%])</span> 31 |
| `perm_trace_commit_time_ms` | <span style='color: red'>(+2 [+2.7%])</span> 78.22 | <span style='color: red'>(+4 [+2.7%])</span> 156.44 | <span style='color: red'>(+3 [+3.6%])</span> 90.54 | <span style='color: red'>(+1 [+1.5%])</span> 65.90 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+3 [+4.2%])</span> 81.09 | <span style='color: red'>(+7 [+4.2%])</span> 162.17 | <span style='color: red'>(+4 [+4.7%])</span> 89.89 | <span style='color: red'>(+3 [+3.6%])</span> 72.28 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+1 [+4.1%])</span> 15.100 | <span style='color: red'>(+1 [+4.1%])</span> 31.99 | <span style='color: red'>(+1 [+7.0%])</span> 17.78 | <span style='color: red'>(+0 [+0.6%])</span> 14.22 |
| `pcs_opening_time_ms ` | <span style='color: green'>(-3 [-4.2%])</span> 69 | <span style='color: green'>(-6 [-4.2%])</span> 138 | <span style='color: red'>(+4 [+5.2%])</span> 81 | <span style='color: green'>(-10 [-14.9%])</span> 57 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 605 | 66 | 1 | 90 | 1,745,742 | 19.32 | 173 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 167 | 848 | 32,689,110 | 172,558,444 | 167 | 405 | 0 | 89.89 | 17.78 | 6 | 90.54 | 81 | 137 | 80 | 1 | 77 | 16,059,916 | 44 | 130 | 1,157,000 | 9.09 | 26 | 108 | 1 | 80 | 
| pairing | 1 | 201 | 605 | 22,314,288 | 119,958,502 | 201 | 302 | 1 | 72.28 | 14.22 | 6 | 65.90 | 57 | 100 | 57 | 0 | 56 | 9,408,294 | 31 | 60 | 588,742 | 17.94 | 21 | 87 | 1 | 57 | 

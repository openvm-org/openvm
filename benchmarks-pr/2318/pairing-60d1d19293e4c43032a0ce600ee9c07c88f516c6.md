...
| `total_proof_time_ms ` |  728 |  1,456 |  864 |  592 |
...
| `execute_metered_insn_mi/s` |  25.60 | -          |  25.60 |  25.60 |
| `execute_preflight_insns` |  872,871 |  1,745,742 |  1,149,000 |  596,742 |
| `execute_preflight_time_ms` |  84 |  168 |  107 |  61 |
| `execute_preflight_insn_mi/s` |  14.69 | -          |  18.38 |  11 |
| `trace_gen_time_ms   ` |  190.50 |  381 |  194 |  187 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  347 |  694 |  399 |  295 |
| `main_trace_commit_time_ms` |  64.50 |  129 |  75 |  54 |
| `generate_perm_trace_time_ms` |  32.50 |  65 |  38 |  27 |
| `perm_trace_commit_time_ms` |  77 |  154.01 |  88.39 |  65.62 |
| `quotient_poly_compute_time_ms` |  80.73 |  161.46 |  86.94 |  74.51 |
| `quotient_poly_commit_time_ms` |  16.69 |  33.38 |  18.90 |  14.47 |
| `pcs_opening_time_ms ` |  70.50 |  141 |  87 |  54 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 592 | 1 | 68 | 1,745,742 | 25.60 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 187 | 864 | 32,480,114 | 172,558,444 | 187 | 399 | 0 | 86.94 | 18.90 | 6 | 88.39 | 87 | 129 | 87 | 1 | 75 | 15,909,408 | 38 | 107 | 1,149,000 | 11 | 26 | 106 | 1 | 87 | 
| pairing | 1 | 194 | 592 | 22,464,232 | 119,958,502 | 194 | 295 | 1 | 74.51 | 14.47 | 6 | 65.62 | 54 | 96 | 54 | 0 | 54 | 9,498,894 | 27 | 61 | 596,742 | 18.38 | 20 | 89 | 1 | 54 | 

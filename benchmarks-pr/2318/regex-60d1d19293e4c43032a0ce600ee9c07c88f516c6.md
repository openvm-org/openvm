...
| `total_proof_time_ms ` |  582.75 |  2,331 |  728 |  516 |
...
| `execute_preflight_insn_mi/s` |  32.22 | -          |  33.67 |  28.80 |
| `trace_gen_time_ms   ` |  179.25 |  717 |  211 |  157 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  277.50 |  1,110 |  302 |  254 |
| `main_trace_commit_time_ms` |  50.25 |  201 |  55 |  48 |
| `generate_perm_trace_time_ms` |  24.75 |  99 |  29 |  19 |
| `perm_trace_commit_time_ms` |  64.84 |  259.35 |  71.22 |  54.90 |
| `quotient_poly_compute_time_ms` |  57.40 |  229.61 |  69.57 |  51.78 |
| `quotient_poly_commit_time_ms` |  14.94 |  59.76 |  16.50 |  13.20 |
| `pcs_opening_time_ms ` |  62.50 |  250 |  74 |  52 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 552 | 1 | 37 | 4,137,502 | 109.44 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 211 | 728 | 23,446,148 | 150,778,428 | 211 | 302 | 0 | 55.78 | 16.50 | 5 | 71.22 | 74 | 99 | 74 | 4 | 55 | 10,899,170 | 27 | 46 | 1,103,000 | 28.80 | 21 | 73 | 1 | 74 | 
| regex_program | 1 | 157 | 535 | 11,598,276 | 128,513,066 | 157 | 273 | 1 | 52.49 | 15.84 | 4 | 67.41 | 63 | 92 | 62 | 0 | 49 | 2,196,106 | 24 | 63 | 1,104,000 | 33.07 | 17 | 68 | 0 | 62 | 
| regex_program | 2 | 164 | 516 | 11,579,064 | 128,513,066 | 164 | 254 | 1 | 51.78 | 14.22 | 4 | 65.81 | 52 | 86 | 52 | 0 | 49 | 2,177,334 | 19 | 56 | 1,104,000 | 33.34 | 16 | 66 | 0 | 51 | 
| regex_program | 3 | 185 | 552 | 11,853,872 | 103,456,394 | 185 | 281 | 0 | 69.57 | 13.20 | 5 | 54.90 | 61 | 87 | 61 | 0 | 48 | 2,422,606 | 29 | 43 | 826,502 | 33.67 | 18 | 83 | 1 | 61 | 

...
| `total_proof_time_ms ` |  588.25 |  2,353 |  732 |  534 |
...
| `execute_metered_insn_mi/s` |  113.86 | -          |  113.86 |  113.86 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  55.75 |  223 |  69 |  47 |
| `execute_preflight_insn_mi/s` |  29.69 | -          |  30.71 |  27.07 |
| `trace_gen_time_ms   ` |  176 |  704 |  210 |  152 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  288.50 |  1,154 |  330 |  263 |
| `main_trace_commit_time_ms` |  52 |  208 |  57 |  50 |
| `generate_perm_trace_time_ms` |  29.50 |  118 |  38 |  19 |
| `perm_trace_commit_time_ms` |  64.52 |  258.07 |  70.19 |  55.80 |
| `quotient_poly_compute_time_ms` |  58.74 |  234.98 |  69.71 |  52.94 |
| `quotient_poly_commit_time_ms` |  14.91 |  59.64 |  17.20 |  12.60 |
| `pcs_opening_time_ms ` |  66 |  264 |  90 |  51 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 534 | 65 | 1 | 36 | 4,137,502 | 113.86 | 194 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 210 | 732 | 23,446,148 | 150,778,428 | 210 | 330 | 0 | 59.36 | 17.20 | 5 | 70.19 | 90 | 105 | 90 | 4 | 57 | 10,899,170 | 34 | 47 | 1,103,000 | 27.07 | 21 | 77 | 1 | 90 | 
| regex_program | 1 | 152 | 549 | 11,598,276 | 128,513,066 | 152 | 287 | 1 | 52.94 | 14.93 | 4 | 65.83 | 62 | 104 | 62 | 0 | 51 | 2,196,106 | 38 | 69 | 1,104,000 | 30.71 | 16 | 68 | 0 | 62 | 
| regex_program | 2 | 161 | 538 | 11,579,064 | 128,513,066 | 161 | 274 | 1 | 52.98 | 14.90 | 4 | 66.26 | 61 | 94 | 61 | 0 | 50 | 2,177,334 | 27 | 60 | 1,104,000 | 30.42 | 16 | 68 | 0 | 61 | 
| regex_program | 3 | 181 | 534 | 11,853,872 | 103,456,394 | 181 | 263 | 0 | 69.71 | 12.60 | 5 | 55.80 | 51 | 78 | 51 | 0 | 50 | 2,422,606 | 19 | 47 | 826,502 | 30.55 | 18 | 83 | 1 | 51 | 
...
Commit: https://github.com/openvm-org/openvm/commit/87efacf3bcef13ec26c54195b7ab16ed673c0880
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19280536246)

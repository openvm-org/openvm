...
| `total_proof_time_ms ` |  742 |  1,484 |  814 |  670 |
...
| `execute_preflight_insn_mi/s` |  13.74 | -          |  18.23 |  9.26 |
| `trace_gen_time_ms   ` |  175 |  350 |  192 |  158 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  380 |  760 |  382 |  378 |
| `main_trace_commit_time_ms` |  64 |  128 |  74 |  54 |
| `generate_perm_trace_time_ms` |  58 |  116 |  71 |  45 |
| `perm_trace_commit_time_ms` |  75.40 |  150.80 |  87.71 |  63.09 |
| `quotient_poly_compute_time_ms` |  77.90 |  155.80 |  85.60 |  70.20 |
| `quotient_poly_commit_time_ms` |  15.95 |  31.90 |  17.60 |  14.30 |
| `pcs_opening_time_ms ` |  84 |  168 |  100 |  68 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 670 | 41 | 1 | 91 | 1,745,742 | 19.07 | 145 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 158 | 814 | 32,689,110 | 172,558,444 | 158 | 382 | 0 | 85.60 | 17.60 | 6 | 87.71 | 68 | 135 | 68 | 1 | 74 | 16,059,916 | 45 | 128 | 1,157,000 | 9.26 | 26 | 104 | 1 | 68 | 
| pairing | 1 | 192 | 670 | 22,314,288 | 119,958,502 | 192 | 378 | 1 | 70.20 | 14.30 | 6 | 63.09 | 100 | 138 | 100 | 0 | 54 | 9,408,294 | 71 | 59 | 588,742 | 18.23 | 20 | 85 | 1 | 100 | 

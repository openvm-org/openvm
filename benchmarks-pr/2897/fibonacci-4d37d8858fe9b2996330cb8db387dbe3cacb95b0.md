...
|:---|---:|---:|---:|
| Total |  2.77 |  1.68 |  1.68 |
| app_proof |  1.66 |  0.56 |  0.56 |
| leaf |  0.52 |  0.52 |  0.52 |
...
| `total_proof_time_ms ` |  408.75 |  1,635 |  542 |  223 |
| `compile_metered_time_ms` |  3 |  3 |  3 |  3 |
| `execute_metered_time_ms` |  21 | -          | -          | -          |
| `execute_metered_insns` |  4,000,051 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  188.62 | -          |  188.62 |  188.62 |
| `execute_preflight_insns` |  1,000,012.75 |  4,000,051 |  1,310,000 |  70,051 |
| `execute_preflight_time_ms` |  35.25 |  141 |  48 |  4 |
| `execute_preflight_insn_mi/s` |  41.28 | -          |  41.41 |  41.06 |
| `trace_gen_time_ms   ` |  75.25 |  301 |  101 |  66 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  232.50 |  930 |  290 |  76 |
| `prover.main_trace_commit_time_ms` |  40.75 |  163 |  50 |  15 |
| `prover.rap_constraints_time_ms` |  135.75 |  543 |  174 |  33 |
| `prover.openings_time_ms` |  54.75 |  219 |  65 |  27 |
| `prover.rap_constraints.logup_gkr_time_ms` |  93.75 |  375 |  121 |  17 |
| `prover.rap_constraints.round0_time_ms` |  28 |  112 |  36 |  9 |
| `prover.rap_constraints.mle_rounds_time_ms` |  13.25 |  53 |  16 |  7 |
...
| `prover.openings.whir_time_ms` |  46 |  184 |  55 |  24 |
...
| `prover.openings.whir_time_ms` |  120 |  120 |  120 |  120 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/4d37d8858fe9b2996330cb8db387dbe3cacb95b0/fibonacci-4d37d8858fe9b2996330cb8db387dbe3cacb95b0.memory.svg)
...
| app_proof |  |  |  |  |  | 223 |  |  | 21 | 4,000,051 | 188.62 | 0 | 1,663 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 27,289,403 | 259 | 81 | 0 | 0 | 96 | 31 | 31 | 45 | 19 | 0 | 80 | 69 | 11 | 2 | 8 | 81 | 96 | 0 | 3 | 18 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,767 | 166 | 45 | 0 | 0 | 66 | 25 | 24 | 27 | 14 | 0 | 53 | 45 | 8 | 1 | 6 | 46 | 66 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 137 | 31 | 0 | 0 | 61 | 22 | 22 | 24 | 14 | 0 | 43 | 36 | 7 | 1 | 5 | 32 | 61 | 0 | 3 | 12 | 0 | 0 | 
| leaf | 0 | prover | 102,779,942 | 463 | 166 | 0 | 0 | 157 | 68 | 67 | 45 | 42 | 0 | 139 | 120 | 18 | 8 | 9 | 166 | 157 | 0 | 6 | 41 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 62,648,824 | 290 | 50 | 0 | 0 | 174 | 36 | 36 | 16 | 121 | 0 | 64 | 53 | 11 | 5 | 5 | 50 | 174 | 0 | 3 | 120 | 0 | 0 | 
| app_proof | prover | 1 | 62,602,932 | 281 | 48 | 0 | 0 | 166 | 33 | 33 | 15 | 117 | 0 | 65 | 55 | 10 | 5 | 5 | 48 | 166 | 0 | 3 | 116 | 0 | 0 | 
| app_proof | prover | 2 | 62,602,932 | 283 | 49 | 0 | 0 | 170 | 34 | 33 | 15 | 120 | 0 | 63 | 52 | 10 | 5 | 5 | 50 | 170 | 0 | 3 | 120 | 0 | 0 | 
| app_proof | prover | 3 | 9,072,096 | 76 | 15 | 0 | 0 | 33 | 9 | 8 | 7 | 17 | 0 | 27 | 24 | 3 | 0 | 2 | 15 | 33 | 0 | 2 | 16 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 67 | 542 | 67 | 136 | 1,626,487,336 | 2,099,944 | 1,628,587,280 | 2,097,152 | 0 | 4 | 48 | 1,310,000 | 41.41 | 
| app_proof | 1 | 66 | 434 | 66 | 40 | 1,625,164,404 | 1,206,055 | 1,626,370,459 | 2,097,152 | 0 | 1 | 45 | 1,310,000 | 41.38 | 
| app_proof | 2 | 67 | 436 | 67 | 40 | 1,625,164,404 | 1,206,055 | 1,626,370,459 | 2,097,152 | 0 | 1 | 44 | 1,310,000 | 41.26 | 
| app_proof | 3 | 101 | 223 | 101 | 40 | 160,245,438 | 14,292,769 | 174,538,207 | 2,097,152 | 0 | 1 | 4 | 70,051 | 41.06 | 

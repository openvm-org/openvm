...
|:---|---:|---:|---:|
| Total |  13.29 |  5.60 |  5.60 |
| app_proof |  10.50 |  2.81 |  2.81 |
| leaf |  1.95 |  1.95 |  1.95 |
...
| `total_proof_time_ms ` |  2,600 |  10,400 |  2,711 |  2,543 |
| `compile_metered_time_ms` |  3 |  3 |  3 |  3 |
| `execute_metered_time_ms` |  100 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  111.55 | -          |  111.55 |  111.55 |
| `execute_preflight_insns` |  2,791,990.25 |  11,167,961 |  2,851,000 |  2,614,961 |
| `execute_preflight_time_ms` |  160 |  640 |  201 |  97 |
| `execute_preflight_insn_mi/s` |  35.35 | -          |  36.34 |  33.10 |
| `trace_gen_time_ms   ` |  58.75 |  235 |  67 |  54 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  2,315.50 |  9,262 |  2,410 |  2,281 |
| `prover.main_trace_commit_time_ms` |  615 |  2,460 |  619 |  612 |
| `prover.rap_constraints_time_ms` |  1,227.25 |  4,909 |  1,232 |  1,217 |
| `prover.openings_time_ms` |  472.25 |  1,889 |  561 |  440 |
| `prover.rap_constraints.logup_gkr_time_ms` |  308.75 |  1,235 |  309 |  308 |
| `prover.rap_constraints.round0_time_ms` |  673.25 |  2,693 |  677 |  666 |
| `prover.rap_constraints.mle_rounds_time_ms` |  244.25 |  977 |  246 |  242 |
| `prover.openings.stacked_reduction_time_ms` |  97.50 |  390 |  99 |  95 |
| `prover.openings.stacked_reduction.round0_time_ms` |  59 |  236 |  60 |  57 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  38 |  152 |  38 |  38 |
| `prover.openings.whir_time_ms` |  374.25 |  1,497 |  465 |  342 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,945 |  1,945 |  1,945 |  1,945 |
...
| `prover.main_trace_commit_time_ms` |  806 |  806 |  806 |  806 |
| `prover.rap_constraints_time_ms` |  352 |  352 |  352 |  352 |
| `prover.openings_time_ms` |  636 |  636 |  636 |  636 |
| `prover.rap_constraints.logup_gkr_time_ms` |  76 |  76 |  76 |  76 |
| `prover.rap_constraints.round0_time_ms` |  169 |  169 |  169 |  169 |
| `prover.rap_constraints.mle_rounds_time_ms` |  106 |  106 |  106 |  106 |
| `prover.openings.stacked_reduction_time_ms` |  64 |  64 |  64 |  64 |
...
| `prover.openings.whir_time_ms` |  572 |  572 |  572 |  572 |

| internal_for_leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  498 |  498 |  498 |  498 |
| `execute_preflight_time_ms` |  2 |  2 |  2 |  2 |
...
| `prover.rap_constraints_time_ms` |  130 |  130 |  130 |  130 |
| `prover.openings_time_ms` |  156 |  156 |  156 |  156 |
...
| `prover.openings.whir_time_ms` |  138 |  138 |  138 |  138 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/
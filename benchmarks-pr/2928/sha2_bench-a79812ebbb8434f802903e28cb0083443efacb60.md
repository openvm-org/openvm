...
|:---|---:|---:|---:|
| Total |  10.04 |  6.100 |  6.100 |
| app_proof |  8.36 |  5.32 |  5.32 |
...
| `total_proof_time_ms ` |  4,132 |  8,264 |  5,219 |  3,045 |
...
| `execute_preflight_time_ms` |  275.50 |  551 |  302 |  249 |
| `execute_preflight_insn_mi/s` |  32.16 | -          |  33.44 |  30.89 |
| `trace_gen_time_ms   ` |  125 |  250 |  175 |  75 |
| `set_initial_memory_time_ms` |  88.50 |  177 |  136 |  41 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  3,642 |  7,284 |  4,658 |  2,626 |
| `prover.main_trace_commit_time_ms` |  961 |  1,922 |  1,330 |  592 |
| `prover.rap_constraints_time_ms` |  1,977 |  3,954 |  2,438 |  1,516 |
| `prover.openings_time_ms` |  702.50 |  1,405 |  888 |  517 |
| `prover.rap_constraints.logup_gkr_time_ms` |  556.50 |  1,113 |  597 |  516 |
| `prover.rap_constraints.round0_time_ms` |  1,039.50 |  2,079 |  1,350 |  729 |
| `prover.rap_constraints.mle_rounds_time_ms` |  380 |  760 |  490 |  270 |
...
| `prover.openings.whir_time_ms` |  538.50 |  1,077 |  677 |  400 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/a79812ebbb8434f802903e28cb0083443efacb60/sha2_bench-a79812ebbb8434f802903e28cb0083443efacb60.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 68 |  |  |  | 340 |  |  |  |  |  |  | 
| app_proof |  |  |  | 3,045 |  | 99 | 11,167,961 | 112.17 | 0 | 8,369 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 329 | 117 | 0 | 0 | 108 | 35 | 34 | 51 | 21 | 0 | 102 | 88 | 13 | 3 | 9 | 117 | 117 | 108 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 169 | 46 | 0 | 0 | 67 | 24 | 24 | 28 | 14 | 0 | 54 | 46 | 8 | 1 | 6 | 46 | 46 | 67 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 141 | 32 | 0 | 0 | 62 | 22 | 22 | 24 | 14 | 0 | 45 | 38 | 7 | 1 | 5 | 33 | 32 | 62 | 0 | 2 | 13 | 0 | 0 | 
| leaf | 0 | prover | 237,896,248 | 890 | 373 | 0 | 0 | 228 | 110 | 109 | 67 | 50 | 0 | 288 | 251 | 36 | 19 | 16 | 373 | 373 | 228 | 0 | 10 | 50 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,288,077,561 | 4,658 | 1,330 | 0 | 0 | 2,438 | 1,350 | 1,349 | 490 | 597 | 1 | 888 | 677 | 211 | 131 | 79 | 1,330 | 1,330 | 2,438 | 0 | 5 | 595 | 0 | 0 | 
| app_proof | prover | 1 | 751,206,644 | 2,626 | 591 | 0 | 0 | 1,516 | 729 | 729 | 270 | 516 | 0 | 517 | 400 | 116 | 70 | 46 | 592 | 591 | 1,516 | 0 | 6 | 514 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 136 | 1 | 175 | 5,219 | 175 | 136 | 13,329,494,472 | 2,141,911,524 | 15,471,405,996 | 2,097,152 | 0 | 4 | 249 | 7,124,000 | 30.89 | 
| app_proof | 1 | 41 | 1 | 75 | 3,045 | 75 | 41 | 7,598,498,184 | 1,557,865,504 | 9,156,363,688 | 2,097,152 | 0 | 2 | 302 | 4,043,961 | 33.44 | 

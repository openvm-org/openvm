...
| `total_proof_time_ms ` |  512.50 |  1,025 |  570 |  455 |
| `compile_metered_time_ms` |  4 |  4 |  4 |  4 |
| `execute_metered_time_ms` |  21 | -          | -          | -          |
| `execute_metered_insns` |  4,000,051 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  186.42 | -          |  186.42 |  186.42 |
| `execute_preflight_insns` |  2,000,025.50 |  4,000,051 |  2,621,000 |  1,379,051 |
| `execute_preflight_time_ms` |  56.50 |  113 |  69 |  44 |
| `execute_preflight_insn_mi/s` |  44.60 | -          |  47.42 |  41.78 |
| `trace_gen_time_ms   ` |  26.50 |  53 |  32 |  21 |
| `set_initial_memory_time_ms` |  88.50 |  177 |  136 |  41 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  340 |  680 |  343 |  337 |
| `prover.main_trace_commit_time_ms` |  73 |  146 |  73 |  73 |
| `prover.rap_constraints_time_ms` |  186.50 |  373 |  189 |  184 |
| `prover.openings_time_ms` |  78.50 |  157 |  79 |  78 |
| `prover.rap_constraints.logup_gkr_time_ms` |  129.50 |  259 |  130 |  129 |
| `prover.rap_constraints.round0_time_ms` |  36.50 |  73 |  38 |  35 |
...
| `prover.openings.whir_time_ms` |  64 |  128 |  64 |  64 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/8e6d552a4bcf767a6bebfcd893aec187447e72ac/fibonacci-8e6d552a4bcf767a6bebfcd893aec187447e72ac.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 66 |  |  |  | 336 |  |  |  |  |  |  | 
| app_proof |  |  |  | 455 |  | 21 | 4,000,051 | 186.42 | 0 | 1,053 |  | 
...
| app_proof | VmAirWrapper<Rv64BranchAdapterAir, BranchEqualCoreAir<4> | 1 | 2 | 2 | 
...
| internal_recursive.0 | 1 | 11 | 181 | 11 | 1 | 0 | 2 | 0 | 1 | 
| internal_recursive.1 | 1 | 10 | 148 | 10 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 38 | 387 | 38 | 12 | 2 | 1 | 1 | 1 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 27,277,885 | 255 | 81 | 0 | 0 | 97 | 31 | 31 | 45 | 19 | 0 | 77 | 65 | 11 | 2 | 8 | 81 | 81 | 97 | 0 | 3 | 18 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 169 | 46 | 0 | 0 | 68 | 25 | 24 | 28 | 15 | 0 | 54 | 46 | 8 | 1 | 6 | 46 | 46 | 68 | 0 | 3 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 138 | 31 | 0 | 0 | 63 | 23 | 22 | 24 | 15 | 0 | 43 | 36 | 7 | 1 | 5 | 31 | 31 | 63 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 74,737,560 | 349 | 121 | 0 | 0 | 115 | 51 | 50 | 34 | 28 | 0 | 111 | 96 | 14 | 6 | 8 | 122 | 121 | 115 | 0 | 6 | 28 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 90,436,180 | 343 | 73 | 0 | 0 | 189 | 38 | 38 | 20 | 130 | 0 | 79 | 64 | 15 | 7 | 7 | 73 | 73 | 189 | 0 | 3 | 129 | 0 | 0 | 
| app_proof | prover | 1 | 90,435,040 | 337 | 73 | 0 | 0 | 184 | 35 | 34 | 20 | 129 | 0 | 78 | 64 | 14 | 7 | 6 | 73 | 73 | 184 | 0 | 3 | 128 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 136 | 2 | 21 | 570 | 21 | 136 | 2,146,766,901 | 1,588,503 | 2,148,355,404 | 2,097,152 | 0 | 3 | 69 | 2,621,000 | 41.78 | 
| app_proof | 1 | 41 | 1 | 32 | 455 | 32 | 41 | 1,165,989,930 | 980,940,213 | 2,146,930,143 | 2,097,152 | 0 | 2 | 44 | 1,379,051 | 47.42 | 

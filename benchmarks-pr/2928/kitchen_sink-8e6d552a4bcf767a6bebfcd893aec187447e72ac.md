...
|:---|---:|---:|---:|
| Total |  5.47 |  5.47 |  5.47 |
| app_proof |  3.94 |  3.94 |  3.94 |
| leaf |  0.86 |  0.86 |  0.86 |
...
| `execute_metered_insn_mi/s` |  76.68 | -          |  76.68 |  76.68 |
| `execute_preflight_insns` |  1,979,971 |  1,979,971 |  1,979,971 |  1,979,971 |
| `execute_preflight_time_ms` |  89 |  89 |  89 |  89 |
| `execute_preflight_insn_mi/s` |  29.62 | -          |  29.62 |  29.62 |
...
| `prover.main_trace_commit_time_ms` |  1,147 |  1,147 |  1,147 |  1,147 |
| `prover.rap_constraints_time_ms` |  1,676 |  1,676 |  1,676 |  1,676 |
| `prover.openings_time_ms` |  786 |  786 |  786 |  786 |
| `prover.rap_constraints.logup_gkr_time_ms` |  279 |  279 |  279 |  279 |
| `prover.rap_constraints.round0_time_ms` |  1,017 |  1,017 |  1,017 |  1,017 |
| `prover.rap_constraints.mle_rounds_time_ms` |  379 |  379 |  379 |  379 |
| `prover.openings.stacked_reduction_time_ms` |  187 |  187 |  187 |  187 |
...
| `prover.openings.whir_time_ms` |  599 |  599 |  599 |  599 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  863 |  863 |  863 |  863 |
| `execute_preflight_time_ms` |  18 |  18 |  18 |  18 |
| `trace_gen_time_ms   ` |  103 |  103 |  103 |  103 |
| `generate_blob_total_time_ms` |  9 |  9 |  9 |  9 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  760 |  760 |  760 |  760 |
| `prover.main_trace_commit_time_ms` |  254 |  254 |  254 |  254 |
| `prover.rap_constraints_time_ms` |  295 |  295 |  295 |  295 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/8e6d552a4bcf767a6bebfcd893aec187447e72ac/kitchen_sink-8e6d552a4bcf767a6bebfcd893aec187447e72ac.memory.svg)
...
| 69 | VmAirWrapper<Rv64LoadStoreAdapterAir, LoadSignExtendCoreAir<8, 8> |  | 22 | 22 | 3 | 
| 7 | VmAirWrapper<Rv64VecHeapAdapterAir<2, 8, 8>, FieldExpressionCoreAir> |  | 501 | 257 | 2 | 
| 70 | VmAirWrapper<Rv64LoadStoreAdapterAir, LoadStoreCoreAir<8> |  | 25 | 31 | 3 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 69 |  |  |  | 368 |  |  |  |  |  |  | 
| app_proof |  |  |  | 3,910 |  | 25 | 1,979,971 | 76.68 | 0 | 3,940 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 18 | 343 | 18 | 5 | 1 | 2 | 1 | 1 | 
| internal_recursive.0 | 1 | 12 | 180 | 11 | 1 | 0 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 10 | 148 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 103 | 863 | 102 | 18 | 9 | 18 | 17 | 17 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,577,981 | 324 | 117 | 0 | 0 | 108 | 35 | 34 | 51 | 21 | 0 | 98 | 84 | 13 | 3 | 9 | 117 | 117 | 108 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 168 | 47 | 0 | 0 | 68 | 25 | 24 | 28 | 14 | 0 | 52 | 44 | 8 | 1 | 6 | 47 | 47 | 68 | 0 | 3 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 138 | 31 | 0 | 0 | 62 | 23 | 22 | 25 | 13 | 0 | 44 | 37 | 7 | 1 | 5 | 31 | 31 | 62 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 167,484,093 | 760 | 253 | 0 | 0 | 295 | 104 | 103 | 59 | 131 | 0 | 210 | 183 | 27 | 14 | 13 | 254 | 253 | 295 | 0 | 8 | 129 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,089,667,964 | 3,611 | 1,146 | 0 | 0 | 1,676 | 1,017 | 1,016 | 379 | 279 | 1 | 786 | 599 | 187 | 108 | 79 | 1,147 | 1,146 | 1,676 | 0 | 5 | 277 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 136 | 2 | 73 | 3,910 | 73 | 136 | 10,281,410,592 | 2,838,841,776 | 13,120,252,368 | 2,097,152 | 0 | 4 | 89 | 1,979,971 | 29.62 | 

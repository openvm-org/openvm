...
|:---|---:|---:|---:|
| Total |  10.03 |  6.100 |  6.100 |
| app_proof |  8.34 |  5.31 |  5.31 |
| leaf |  1.01 |  1.01 |  1.01 |
...
| `total_proof_time_ms ` |  4,122.50 |  8,245 |  5,211 |  3,034 |
| `compile_metered_time_ms` |  4 |  4 |  4 |  4 |
| `execute_metered_time_ms` |  99 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  111.88 | -          |  111.88 |  111.88 |
| `execute_preflight_insns` |  5,583,980.50 |  11,167,961 |  7,124,000 |  4,043,961 |
| `execute_preflight_time_ms` |  270.50 |  541 |  293 |  248 |
| `execute_preflight_insn_mi/s` |  33.05 | -          |  34.79 |  31.31 |
| `trace_gen_time_ms   ` |  126 |  252 |  177 |  75 |
| `set_initial_memory_time_ms` |  89 |  178 |  137 |  41 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  3,636 |  7,272 |  4,648 |  2,624 |
| `prover.main_trace_commit_time_ms` |  963.50 |  1,927 |  1,334 |  593 |
| `prover.rap_constraints_time_ms` |  1,964 |  3,928 |  2,417 |  1,511 |
| `prover.openings_time_ms` |  707 |  1,414 |  895 |  519 |
| `prover.rap_constraints.logup_gkr_time_ms` |  557 |  1,114 |  598 |  516 |
| `prover.rap_constraints.round0_time_ms` |  1,020.50 |  2,041 |  1,320 |  721 |
| `prover.rap_constraints.mle_rounds_time_ms` |  385.50 |  771 |  498 |  273 |
| `prover.openings.stacked_reduction_time_ms` |  165.50 |  331 |  214 |  117 |
| `prover.openings.stacked_reduction.round0_time_ms` |  102 |  204 |  133 |  71 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  63 |  126 |  80 |  46 |
| `prover.openings.whir_time_ms` |  540.50 |  1,081 |  680 |  401 |
...
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  898 |  898 |  898 |  898 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/8e6d552a4bcf767a6bebfcd893aec187447e72ac/sha2_bench-8e6d552a4bcf767a6bebfcd893aec187447e72ac.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 73 |  |  |  | 354 |  |  |  |  |  |  | 
| app_proof |  |  |  | 3,034 |  | 99 | 11,167,961 | 111.88 | 0 | 8,352 |  | 
...
| leaf | 0 | 110 | 1,009 | 110 | 34 | 17 | 2 | 7 | 7 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 330 | 118 | 0 | 0 | 109 | 36 | 35 | 51 | 21 | 0 | 101 | 88 | 13 | 3 | 9 | 118 | 118 | 109 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 168 | 46 | 0 | 0 | 68 | 25 | 24 | 28 | 14 | 0 | 53 | 44 | 8 | 1 | 6 | 46 | 46 | 68 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 137 | 32 | 0 | 0 | 61 | 23 | 22 | 24 | 13 | 0 | 42 | 35 | 7 | 1 | 5 | 33 | 32 | 61 | 0 | 2 | 13 | 0 | 0 | 
| leaf | 0 | prover | 237,896,248 | 898 | 374 | 0 | 0 | 233 | 113 | 112 | 68 | 51 | 0 | 289 | 252 | 37 | 20 | 17 | 375 | 375 | 233 | 0 | 9 | 50 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,288,077,561 | 4,648 | 1,334 | 0 | 0 | 2,417 | 1,320 | 1,320 | 498 | 598 | 1 | 895 | 680 | 214 | 133 | 80 | 1,334 | 1,334 | 2,417 | 0 | 5 | 595 | 0 | 0 | 
| app_proof | prover | 1 | 751,206,644 | 2,624 | 593 | 0 | 0 | 1,511 | 721 | 720 | 273 | 516 | 0 | 519 | 401 | 117 | 71 | 46 | 593 | 593 | 1,511 | 0 | 5 | 514 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 137 | 1 | 177 | 5,211 | 177 | 137 | 13,329,494,472 | 2,141,911,524 | 15,471,405,996 | 2,097,152 | 0 | 4 | 248 | 7,124,000 | 31.31 | 
| app_proof | 1 | 41 | 1 | 75 | 3,034 | 75 | 41 | 7,598,498,184 | 1,557,865,504 | 9,156,363,688 | 2,097,152 | 0 | 2 | 293 | 4,043,961 | 34.79 | 

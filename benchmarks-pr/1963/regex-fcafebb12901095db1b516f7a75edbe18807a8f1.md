...
|:---|---:|---:|
| Total |  7.70 |  4.93 |
| regex_program |  7.67 |  4.90 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  3,834.50 |  7,669 |  4,901 |  2,768 |
...
| `execute_metered_insn_mi/s` |  125.76 | -          |  125.76 |  125.76 |
| `execute_preflight_time_ms` |  97.50 |  195 |  106 |  89 |
| `execute_preflight_insn_mi/s` |  27.44 | -          |  29.76 |  25.12 |
| `trace_gen_time_ms   ` |  387 |  774 |  496 |  278 |
| `memory_finalize_time_ms` |  8 |  16 |  14 |  2 |
| `stark_prove_excluding_trace_time_ms` |  3,122 |  6,244 |  4,058 |  2,186 |
| `main_trace_commit_time_ms` |  629 |  1,258 |  844 |  414 |
| `generate_perm_trace_time_ms` |  231 |  462 |  306 |  156 |
| `perm_trace_commit_time_ms` |  650.50 |  1,301 |  851 |  450 |
| `quotient_poly_compute_time_ms` |  322 |  644 |  428 |  216 |
| `quotient_poly_commit_time_ms` |  306 |  612 |  406 |  206 |
| `pcs_opening_time_ms ` |  974 |  1,948 |  1,216 |  732 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2,768 | 6 | 4,108,597 | 1 | 32 | 125.76 | 45 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 496 | 4,901 | 211,758,557 | 373,183,036 | 496 | 4,058 | 0 | 428 | 406 | 851 | 1,216 | 7 | 14 | 844 | 91,281,687 | 2,211,000 | 306 | 106 | 25.12 | 
| regex_program | 1 | 278 | 2,768 | 174,326,267 | 196,838,026 | 278 | 2,186 | 52 | 216 | 206 | 450 | 732 | 6 | 2 | 414 | 73,453,305 | 1,897,597 | 156 | 89 | 29.76 | 

...
| `total_proof_time_ms ` |  3,784 |  7,568 |  4,856 |  2,712 |
...
| `execute_preflight_insn_mi/s` |  27.35 | -          |  29.50 |  25.20 |
| `trace_gen_time_ms   ` |  383.50 |  767 |  494 |  273 |
| `memory_finalize_time_ms` |  7.50 |  15 |  13 |  2 |
| `stark_prove_excluding_trace_time_ms` |  3,075 |  6,150 |  4,018 |  2,132 |
| `main_trace_commit_time_ms` |  615 |  1,230 |  842 |  388 |
| `generate_perm_trace_time_ms` |  229.50 |  459 |  302 |  157 |
| `perm_trace_commit_time_ms` |  648 |  1,296 |  848 |  448 |
| `quotient_poly_compute_time_ms` |  320.50 |  641 |  430 |  211 |
| `quotient_poly_commit_time_ms` |  301 |  602 |  396 |  206 |
| `pcs_opening_time_ms ` |  954 |  1,908 |  1,196 |  712 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2,712 | 6 | 4,108,597 | 1 | 32 | 125.17 | 45 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 494 | 4,856 | 211,758,557 | 373,183,036 | 494 | 4,018 | 0 | 430 | 396 | 848 | 1,196 | 8 | 13 | 842 | 91,281,687 | 2,211,000 | 302 | 104 | 25.20 | 
| regex_program | 1 | 273 | 2,712 | 174,326,267 | 196,838,026 | 273 | 2,132 | 51 | 211 | 206 | 448 | 712 | 6 | 2 | 388 | 73,453,305 | 1,897,597 | 157 | 90 | 29.50 | 

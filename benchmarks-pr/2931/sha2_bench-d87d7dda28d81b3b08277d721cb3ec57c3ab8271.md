...
| `total_proof_time_ms ` |  4,132.50 |  8,265 |  5,210 |  3,055 |
...
| `execute_preflight_time_ms` |  238 |  476 |  272 |  204 |
| `execute_preflight_insn_mi/s` |  37.69 | -          |  39.96 |  35.42 |
| `trace_gen_time_ms   ` |  121.50 |  243 |  170 |  73 |
| `set_initial_memory_time_ms` |  88.50 |  177 |  136 |  41 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  3,683.50 |  7,367 |  4,699 |  2,668 |
| `prover.main_trace_commit_time_ms` |  967 |  1,934 |  1,337 |  597 |
| `prover.rap_constraints_time_ms` |  2,001.50 |  4,003 |  2,465 |  1,538 |
| `prover.openings_time_ms` |  713.50 |  1,427 |  895 |  532 |
| `prover.rap_constraints.logup_gkr_time_ms` |  561.50 |  1,123 |  601 |  522 |
| `prover.rap_constraints.round0_time_ms` |  1,051 |  2,102 |  1,363 |  739 |
| `prover.rap_constraints.mle_rounds_time_ms` |  388.50 |  777 |  501 |  276 |
| `prover.openings.stacked_reduction_time_ms` |  169 |  338 |  218 |  120 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/d87d7dda28d81b3b08277d721cb3ec57c3ab8271/sha2_bench-d87d7dda28d81b3b08277d721cb3ec57c3ab8271.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 70 |  |  |  | 343 |  |  |  |  |  |  | 
| app_proof |  |  |  | 3,055 |  | 87 | 11,167,961 | 127.43 | 0 | 8,359 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 335 | 119 | 0 | 0 | 108 | 35 | 35 | 52 | 20 | 0 | 106 | 92 | 13 | 3 | 9 | 120 | 119 | 108 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 173 | 46 | 0 | 0 | 67 | 24 | 23 | 27 | 14 | 0 | 58 | 50 | 8 | 1 | 6 | 47 | 46 | 67 | 0 | 3 | 12 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 139 | 32 | 0 | 0 | 63 | 24 | 23 | 24 | 14 | 0 | 42 | 35 | 7 | 1 | 5 | 33 | 32 | 63 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 237,929,016 | 904 | 378 | 0 | 0 | 229 | 110 | 109 | 66 | 52 | 0 | 295 | 257 | 38 | 20 | 17 | 378 | 378 | 229 | 0 | 12 | 50 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,286,242,554 | 4,699 | 1,337 | 0 | 0 | 2,465 | 1,363 | 1,362 | 501 | 601 | 0 | 895 | 676 | 218 | 137 | 81 | 1,337 | 1,337 | 2,465 | 0 | 7 | 600 | 0 | 0 | 
| app_proof | prover | 1 | 750,289,144 | 2,668 | 597 | 0 | 0 | 1,538 | 739 | 739 | 276 | 522 | 0 | 532 | 412 | 120 | 73 | 46 | 597 | 597 | 1,538 | 0 | 7 | 521 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 136 | 1 | 170 | 5,210 | 170 | 136 | 13,306,647,852 | 2,134,713,996 | 15,441,361,848 | 2,097,152 | 0 | 3 | 204 | 7,124,000 | 35.42 | 
| app_proof | 1 | 41 | 1 | 73 | 3,055 | 73 | 41 | 7,584,540,132 | 1,503,573,469 | 9,088,113,601 | 2,097,152 | 0 | 2 | 272 | 4,043,961 | 39.96 | 

...
|:---|---:|---:|---:|
| Total |  9.88 |  6.91 |  6.91 |
| app_proof |  8.22 |  5.24 |  5.24 |
| leaf |  0.99 |  0.99 |  0.99 |
...
| `total_proof_time_ms ` |  4,060 |  8,120 |  5,141 |  2,979 |
...
| `execute_preflight_insn_mi/s` |  37.39 | -          |  39.79 |  34.98 |
| `trace_gen_time_ms   ` |  125 |  250 |  175 |  75 |
| `set_initial_memory_time_ms` |  88.50 |  177 |  136 |  41 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  3,604.50 |  7,209 |  4,621 |  2,588 |
| `prover.main_trace_commit_time_ms` |  958.50 |  1,917 |  1,328 |  589 |
| `prover.rap_constraints_time_ms` |  1,946.50 |  3,893 |  2,406 |  1,487 |
| `prover.openings_time_ms` |  698 |  1,396 |  885 |  511 |
| `prover.rap_constraints.logup_gkr_time_ms` |  546.50 |  1,093 |  589 |  504 |
| `prover.rap_constraints.round0_time_ms` |  1,023 |  2,046 |  1,332 |  714 |
| `prover.rap_constraints.mle_rounds_time_ms` |  376 |  752 |  484 |  268 |
| `prover.openings.stacked_reduction_time_ms` |  161.50 |  323 |  212 |  111 |
| `prover.openings.stacked_reduction.round0_time_ms` |  100 |  200 |  133 |  67 |
...
| `prover.openings_time_ms` |  284 |  284 |  284 |  284 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/205572f35e0c6625fdd6ff9c09abc7db253ac634/sha2_bench-205572f35e0c6625fdd6ff9c09abc7db253ac634.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 69 |  |  |  | 341 |  |  |  |  |  |  | 
| app_proof |  |  |  | 2,979 |  | 99 | 11,167,961 | 112.15 | 0 | 8,226 |  | 
...
| leaf | 0 | 107 | 993 | 107 | 34 | 17 | 2 | 7 | 7 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 323 | 117 | 0 | 0 | 107 | 34 | 33 | 52 | 20 | 0 | 98 | 85 | 13 | 3 | 9 | 117 | 117 | 107 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 165 | 46 | 0 | 0 | 66 | 24 | 23 | 28 | 13 | 0 | 51 | 43 | 8 | 1 | 6 | 46 | 46 | 66 | 0 | 3 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 141 | 32 | 0 | 0 | 64 | 24 | 23 | 24 | 15 | 0 | 43 | 36 | 7 | 1 | 5 | 33 | 32 | 64 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 237,929,016 | 885 | 371 | 0 | 0 | 228 | 109 | 108 | 67 | 50 | 0 | 284 | 247 | 37 | 20 | 17 | 372 | 371 | 227 | 0 | 9 | 49 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,286,242,554 | 4,621 | 1,328 | 0 | 0 | 2,406 | 1,332 | 1,332 | 484 | 589 | 0 | 885 | 672 | 212 | 133 | 79 | 1,328 | 1,328 | 2,406 | 0 | 4 | 587 | 0 | 0 | 
| app_proof | prover | 1 | 750,289,144 | 2,588 | 588 | 0 | 0 | 1,487 | 714 | 714 | 268 | 504 | 0 | 511 | 399 | 111 | 67 | 43 | 589 | 588 | 1,487 | 0 | 5 | 503 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 136 | 1 | 175 | 5,141 | 175 | 136 | 13,306,647,852 | 2,134,713,996 | 15,441,361,848 | 2,097,152 | 0 | 3 | 207 | 7,124,000 | 34.98 | 
| app_proof | 1 | 41 | 1 | 75 | 2,979 | 75 | 41 | 7,584,540,132 | 1,503,573,469 | 9,088,113,601 | 2,097,152 | 0 | 2 | 274 | 4,043,961 | 39.79 | 

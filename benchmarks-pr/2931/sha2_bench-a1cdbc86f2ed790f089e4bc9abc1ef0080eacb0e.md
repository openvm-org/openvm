...
|:---|---:|---:|---:|
| Total |  9.93 |  6.91 |  6.91 |
| app_proof |  8.25 |  5.23 |  5.23 |
| leaf |  1 |  1 |  1 |
...
| `total_proof_time_ms ` |  4,080.50 |  8,161 |  5,142 |  3,019 |
...
| `execute_preflight_time_ms` |  244.50 |  489 |  284 |  205 |
| `execute_preflight_insn_mi/s` |  37.62 | -          |  39.91 |  35.33 |
| `trace_gen_time_ms   ` |  121.50 |  243 |  171 |  72 |
| `set_initial_memory_time_ms` |  88.50 |  177 |  136 |  41 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  3,625 |  7,250 |  4,629 |  2,621 |
| `prover.main_trace_commit_time_ms` |  960.50 |  1,921 |  1,330 |  591 |
| `prover.rap_constraints_time_ms` |  1,954.50 |  3,909 |  2,408 |  1,501 |
| `prover.openings_time_ms` |  709 |  1,418 |  890 |  528 |
| `prover.rap_constraints.logup_gkr_time_ms` |  549 |  1,098 |  590 |  508 |
| `prover.rap_constraints.round0_time_ms` |  1,026.50 |  2,053 |  1,331 |  722 |
| `prover.rap_constraints.mle_rounds_time_ms` |  378 |  756 |  486 |  270 |
| `prover.openings.stacked_reduction_time_ms` |  164.50 |  329 |  212 |  117 |
| `prover.openings.stacked_reduction.round0_time_ms` |  101.50 |  203 |  133 |  70 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  62.50 |  125 |  79 |  46 |
| `prover.openings.whir_time_ms` |  543.50 |  1,087 |  677 |  410 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/a1cdbc86f2ed790f089e4bc9abc1ef0080eacb0e/sha2_bench-a1cdbc86f2ed790f089e4bc9abc1ef0080eacb0e.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 70 |  |  |  | 343 |  |  |  |  |  |  | 
| app_proof |  |  |  | 3,019 |  | 87 | 11,167,961 | 127.48 | 0 | 8,255 |  | 
...
| leaf | 0 | 110 | 1,005 | 110 | 35 | 17 | 2 | 7 | 7 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 327 | 117 | 0 | 0 | 107 | 35 | 34 | 51 | 20 | 0 | 101 | 88 | 13 | 3 | 9 | 118 | 117 | 107 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 171 | 47 | 0 | 0 | 68 | 25 | 24 | 28 | 15 | 0 | 55 | 46 | 8 | 1 | 6 | 47 | 47 | 68 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 137 | 32 | 0 | 0 | 60 | 22 | 21 | 24 | 13 | 0 | 44 | 37 | 7 | 1 | 5 | 32 | 32 | 60 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 237,929,016 | 894 | 373 | 0 | 0 | 227 | 108 | 107 | 67 | 51 | 0 | 293 | 256 | 37 | 20 | 17 | 373 | 373 | 227 | 0 | 10 | 50 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,286,242,554 | 4,629 | 1,330 | 0 | 0 | 2,408 | 1,331 | 1,330 | 486 | 590 | 0 | 890 | 677 | 212 | 133 | 79 | 1,330 | 1,330 | 2,408 | 0 | 5 | 589 | 0 | 0 | 
| app_proof | prover | 1 | 750,289,144 | 2,621 | 591 | 0 | 0 | 1,501 | 722 | 721 | 270 | 508 | 0 | 528 | 410 | 117 | 70 | 46 | 591 | 591 | 1,501 | 0 | 6 | 507 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 136 | 1 | 171 | 5,142 | 171 | 136 | 13,306,647,852 | 2,134,713,996 | 15,441,361,848 | 2,097,152 | 0 | 3 | 205 | 7,124,000 | 35.33 | 
| app_proof | 1 | 41 | 1 | 72 | 3,019 | 72 | 41 | 7,584,540,132 | 1,503,573,469 | 9,088,113,601 | 2,097,152 | 0 | 2 | 284 | 4,043,961 | 39.91 | 

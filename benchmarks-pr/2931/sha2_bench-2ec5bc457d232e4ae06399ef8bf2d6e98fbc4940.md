...
|:---|---:|---:|---:|
| Total |  9.81 |  6.85 |  6.85 |
| app_proof |  8.15 |  5.19 |  5.19 |
| leaf |  0.99 |  0.99 |  0.99 |
...
| `total_proof_time_ms ` |  4,022 |  8,044 |  5,084 |  2,960 |
| `compile_metered_time_ms` |  4 |  4 |  4 |  4 |
| `execute_metered_time_ms` |  105 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  105.90 | -          |  105.90 |  105.90 |
| `execute_preflight_insns` |  5,583,980.50 |  11,167,961 |  7,124,000 |  4,043,961 |
| `execute_preflight_time_ms` |  242.50 |  485 |  277 |  208 |
| `execute_preflight_insn_mi/s` |  36.85 | -          |  39.06 |  34.65 |
| `trace_gen_time_ms   ` |  125 |  250 |  175 |  75 |
| `set_initial_memory_time_ms` |  88 |  176 |  135 |  41 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  3,565 |  7,130 |  4,564 |  2,566 |
| `prover.main_trace_commit_time_ms` |  948 |  1,896 |  1,314 |  582 |
| `prover.rap_constraints_time_ms` |  1,922 |  3,844 |  2,367 |  1,477 |
| `prover.openings_time_ms` |  694 |  1,388 |  882 |  506 |
| `prover.rap_constraints.logup_gkr_time_ms` |  544 |  1,088 |  582 |  506 |
| `prover.rap_constraints.round0_time_ms` |  1,006 |  2,012 |  1,306 |  706 |
| `prover.rap_constraints.mle_rounds_time_ms` |  370.50 |  741 |  477 |  264 |
| `prover.openings.stacked_reduction_time_ms` |  159.50 |  319 |  207 |  112 |
| `prover.openings.stacked_reduction.round0_time_ms` |  98 |  196 |  129 |  67 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  60.50 |  121 |  77 |  44 |
| `prover.openings.whir_time_ms` |  534.50 |  1,069 |  675 |  394 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/2ec5bc457d232e4ae06399ef8bf2d6e98fbc4940/sha2_bench-2ec5bc457d232e4ae06399ef8bf2d6e98fbc4940.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 70 |  |  |  | 345 |  |  |  |  |  |  | 
| app_proof |  |  |  | 2,960 |  | 105 | 11,167,961 | 105.90 | 0 | 8,156 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 321 | 116 | 0 | 0 | 105 | 33 | 33 | 51 | 20 | 0 | 98 | 84 | 13 | 3 | 9 | 116 | 116 | 105 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 169 | 46 | 0 | 0 | 67 | 24 | 24 | 27 | 14 | 0 | 54 | 46 | 8 | 1 | 6 | 47 | 46 | 67 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 135 | 31 | 0 | 0 | 61 | 23 | 22 | 24 | 13 | 0 | 42 | 35 | 7 | 1 | 5 | 32 | 31 | 61 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 237,929,016 | 883 | 369 | 0 | 0 | 224 | 105 | 104 | 66 | 51 | 0 | 289 | 252 | 36 | 19 | 16 | 369 | 369 | 224 | 0 | 9 | 49 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,286,242,554 | 4,564 | 1,314 | 0 | 0 | 2,367 | 1,306 | 1,306 | 477 | 582 | 1 | 882 | 675 | 207 | 129 | 77 | 1,314 | 1,314 | 2,367 | 0 | 4 | 580 | 0 | 0 | 
| app_proof | prover | 1 | 750,289,144 | 2,566 | 582 | 0 | 0 | 1,477 | 706 | 705 | 264 | 506 | 0 | 506 | 394 | 112 | 67 | 44 | 582 | 582 | 1,477 | 0 | 4 | 505 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 135 | 1 | 175 | 5,084 | 175 | 135 | 13,306,647,852 | 2,134,713,996 | 15,441,361,848 | 2,097,152 | 0 | 3 | 208 | 7,124,000 | 34.65 | 
| app_proof | 1 | 41 | 1 | 75 | 2,960 | 75 | 41 | 7,584,540,132 | 1,503,573,469 | 9,088,113,601 | 2,097,152 | 0 | 2 | 277 | 4,043,961 | 39.06 | 

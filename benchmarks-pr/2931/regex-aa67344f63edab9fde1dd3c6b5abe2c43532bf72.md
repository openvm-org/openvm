...
| `total_proof_time_ms ` |  1,164 |  1,164 |  1,164 |  1,164 |
| `compile_metered_time_ms` |  8 |  8 |  8 |  8 |
| `execute_metered_time_ms` |  29 | -          | -          | -          |
| `execute_metered_insns` |  4,090,656 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  136.46 | -          |  136.46 |  136.46 |
| `execute_preflight_insns` |  4,090,656 |  4,090,656 |  4,090,656 |  4,090,656 |
| `execute_preflight_time_ms` |  131 |  131 |  131 |  131 |
| `execute_preflight_insn_mi/s` |  32.69 | -          |  32.69 |  32.69 |
| `trace_gen_time_ms   ` |  39 |  39 |  39 |  39 |
| `set_initial_memory_time_ms` |  137 |  137 |  137 |  137 |
| `memory_finalize_time_ms` |  1 |  1 |  1 |  1 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  856 |  856 |  856 |  856 |
| `prover.main_trace_commit_time_ms` |  193 |  193 |  193 |  193 |
| `prover.rap_constraints_time_ms` |  486 |  486 |  486 |  486 |
| `prover.openings_time_ms` |  176 |  176 |  176 |  176 |
| `prover.rap_constraints.logup_gkr_time_ms` |  288 |  288 |  288 |  288 |
| `prover.rap_constraints.round0_time_ms` |  147 |  147 |  147 |  147 |
...
| `prover.openings.whir_time_ms` |  139 |  139 |  139 |  139 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/aa67344f63edab9fde1dd3c6b5abe2c43532bf72/regex-aa67344f63edab9fde1dd3c6b5abe2c43532bf72.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 70 |  |  |  | 343 |  |  |  |  |  |  | 
| app_proof |  |  |  | 1,164 |  | 29 | 4,090,656 | 136.46 | 0 | 1,207 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 15 | 272 | 15 | 4 | 0 | 2 | 0 | 0 | 
| internal_recursive.0 | 1 | 11 | 181 | 10 | 1 | 0 | 2 | 0 | 0 | 
| internal_recursive.1 | 1 | 9 | 145 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 41 | 352 | 41 | 8 | 2 | 5 | 10 | 10 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 27,277,885 | 257 | 81 | 0 | 0 | 96 | 30 | 30 | 45 | 19 | 0 | 79 | 67 | 11 | 2 | 8 | 81 | 81 | 96 | 0 | 3 | 18 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 170 | 46 | 0 | 0 | 67 | 24 | 24 | 28 | 13 | 0 | 56 | 47 | 8 | 1 | 6 | 47 | 46 | 67 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 135 | 32 | 0 | 0 | 62 | 22 | 22 | 24 | 14 | 0 | 40 | 33 | 7 | 1 | 5 | 32 | 32 | 62 | 0 | 2 | 13 | 0 | 0 | 
| leaf | 0 | prover | 65,360,477 | 311 | 103 | 0 | 0 | 108 | 46 | 45 | 31 | 30 | 0 | 98 | 85 | 13 | 5 | 7 | 103 | 103 | 108 | 0 | 6 | 29 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 238,925,643 | 856 | 192 | 0 | 0 | 486 | 147 | 146 | 50 | 288 | 17 | 176 | 139 | 36 | 19 | 17 | 193 | 192 | 486 | 0 | 4 | 270 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 137 | 2 | 39 | 1,164 | 39 | 137 | 4,179,589,434 | 897,887,370 | 5,077,476,804 | 2,097,152 | 1 | 6 | 131 | 4,090,656 | 32.69 | 

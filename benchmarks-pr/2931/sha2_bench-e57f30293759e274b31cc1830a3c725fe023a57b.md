...
| `total_proof_time_ms ` |  4,133.50 |  8,267 |  5,213 |  3,054 |
...
| `execute_preflight_time_ms` |  241 |  482 |  275 |  207 |
| `execute_preflight_insn_mi/s` |  37.31 | -          |  39.63 |  34.100 |
| `trace_gen_time_ms   ` |  121.50 |  243 |  171 |  72 |
| `set_initial_memory_time_ms` |  88.50 |  177 |  136 |  41 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  3,680.50 |  7,361 |  4,698 |  2,663 |
| `prover.main_trace_commit_time_ms` |  965 |  1,930 |  1,335 |  595 |
| `prover.rap_constraints_time_ms` |  2,000 |  4,000 |  2,465 |  1,535 |
| `prover.openings_time_ms` |  714 |  1,428 |  896 |  532 |
| `prover.rap_constraints.logup_gkr_time_ms` |  561.50 |  1,123 |  601 |  522 |
| `prover.rap_constraints.round0_time_ms` |  1,050 |  2,100 |  1,363 |  737 |
| `prover.rap_constraints.mle_rounds_time_ms` |  387.50 |  775 |  500 |  275 |
...
| `prover.openings.whir_time_ms` |  544.50 |  1,089 |  678 |  411 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/e57f30293759e274b31cc1830a3c725fe023a57b/sha2_bench-e57f30293759e274b31cc1830a3c725fe023a57b.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 71 |  |  |  | 343 |  |  |  |  |  |  | 
| app_proof |  |  |  | 3,054 |  | 88 | 11,167,961 | 125.67 | 0 | 8,362 |  | 
...
| leaf | 0 | 111 | 1,022 | 111 | 35 | 17 | 2 | 7 | 7 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 329 | 118 | 0 | 0 | 109 | 35 | 34 | 52 | 21 | 0 | 100 | 87 | 13 | 3 | 9 | 119 | 118 | 109 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 171 | 47 | 0 | 0 | 67 | 25 | 24 | 28 | 14 | 0 | 56 | 47 | 8 | 1 | 6 | 47 | 47 | 67 | 0 | 3 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 142 | 32 | 0 | 0 | 63 | 24 | 23 | 25 | 13 | 0 | 46 | 38 | 7 | 1 | 5 | 32 | 32 | 63 | 0 | 2 | 13 | 0 | 0 | 
| leaf | 0 | prover | 237,929,016 | 910 | 377 | 0 | 0 | 230 | 110 | 109 | 68 | 51 | 0 | 302 | 263 | 38 | 20 | 17 | 377 | 377 | 230 | 0 | 11 | 50 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,286,242,554 | 4,698 | 1,335 | 0 | 0 | 2,465 | 1,363 | 1,362 | 500 | 601 | 0 | 896 | 678 | 218 | 136 | 81 | 1,335 | 1,335 | 2,465 | 0 | 6 | 600 | 0 | 0 | 
| app_proof | prover | 1 | 750,289,144 | 2,663 | 595 | 0 | 0 | 1,535 | 737 | 737 | 275 | 522 | 0 | 532 | 411 | 120 | 73 | 47 | 595 | 595 | 1,535 | 0 | 6 | 521 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 136 | 1 | 171 | 5,213 | 171 | 136 | 13,861,091,516 | 2,223,660,412 | 16,084,751,928 | 2,097,152 | 0 | 4 | 207 | 7,124,000 | 34.100 | 
| app_proof | 1 | 41 | 1 | 72 | 3,054 | 72 | 41 | 7,987,193,316 | 1,503,573,469 | 9,490,766,785 | 2,097,152 | 0 | 2 | 275 | 4,043,961 | 39.63 | 

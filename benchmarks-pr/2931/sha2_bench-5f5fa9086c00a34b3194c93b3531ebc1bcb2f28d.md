...
| `total_proof_time_ms ` |  4,076 |  8,152 |  5,140 |  3,012 |
...
| `execute_preflight_time_ms` |  241 |  482 |  281 |  201 |
| `execute_preflight_insn_mi/s` |  38.45 | -          |  40.90 |  36 |
| `trace_gen_time_ms   ` |  121.50 |  243 |  171 |  72 |
| `set_initial_memory_time_ms` |  88 |  176 |  135 |  41 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  3,624 |  7,248 |  4,632 |  2,616 |
| `prover.main_trace_commit_time_ms` |  956 |  1,912 |  1,326 |  586 |
| `prover.rap_constraints_time_ms` |  1,962 |  3,924 |  2,421 |  1,503 |
| `prover.openings_time_ms` |  704.50 |  1,409 |  883 |  526 |
| `prover.rap_constraints.logup_gkr_time_ms` |  550.50 |  1,101 |  590 |  511 |
| `prover.rap_constraints.round0_time_ms` |  1,036.50 |  2,073 |  1,349 |  724 |
...
| `prover.openings.whir_time_ms` |  541 |  1,082 |  672 |  410 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/5f5fa9086c00a34b3194c93b3531ebc1bcb2f28d/sha2_bench-5f5fa9086c00a34b3194c93b3531ebc1bcb2f28d.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 71 |  |  |  | 344 |  |  |  |  |  |  | 
| app_proof |  |  |  | 3,012 |  | 87 | 11,167,961 | 127.25 | 0 | 8,246 |  | 
...
| leaf | 0 | 108 | 1,000 | 108 | 34 | 17 | 2 | 7 | 7 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 328 | 117 | 0 | 0 | 107 | 34 | 33 | 52 | 20 | 0 | 103 | 89 | 13 | 3 | 9 | 117 | 117 | 107 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 169 | 47 | 0 | 0 | 67 | 25 | 24 | 28 | 14 | 0 | 53 | 45 | 8 | 1 | 6 | 47 | 47 | 67 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 142 | 31 | 0 | 0 | 62 | 23 | 23 | 24 | 13 | 0 | 47 | 40 | 7 | 1 | 5 | 32 | 31 | 62 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 237,929,016 | 891 | 372 | 0 | 0 | 227 | 108 | 107 | 66 | 51 | 0 | 292 | 254 | 37 | 20 | 17 | 372 | 372 | 227 | 0 | 11 | 49 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,286,242,554 | 4,632 | 1,326 | 0 | 0 | 2,421 | 1,349 | 1,348 | 482 | 590 | 1 | 883 | 672 | 211 | 131 | 79 | 1,326 | 1,326 | 2,421 | 0 | 5 | 589 | 0 | 0 | 
| app_proof | prover | 1 | 750,289,144 | 2,616 | 586 | 0 | 0 | 1,503 | 724 | 723 | 267 | 511 | 0 | 526 | 410 | 115 | 69 | 46 | 586 | 586 | 1,503 | 0 | 6 | 510 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 135 | 1 | 171 | 5,140 | 171 | 135 | 13,369,416,740 | 2,137,634,692 | 15,507,051,432 | 2,097,152 | 0 | 3 | 201 | 7,124,000 | 36 | 
| app_proof | 1 | 41 | 1 | 72 | 3,012 | 72 | 41 | 7,653,619,468 | 1,457,562,773 | 9,111,182,241 | 2,097,152 | 0 | 2 | 281 | 4,043,961 | 40.90 | 

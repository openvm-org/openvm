...
| `total_proof_time_ms ` |  4,106.50 |  8,213 |  5,177 |  3,036 |
| `compile_metered_time_ms` |  4 |  4 |  4 |  4 |
| `execute_metered_time_ms` |  87 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  127 | -          |  127 |  127 |
| `execute_preflight_insns` |  5,583,980.50 |  11,167,961 |  7,124,000 |  4,043,961 |
| `execute_preflight_time_ms` |  242.50 |  485 |  283 |  202 |
| `execute_preflight_insn_mi/s` |  37.87 | -          |  39.91 |  35.84 |
| `trace_gen_time_ms   ` |  121.50 |  243 |  171 |  72 |
| `set_initial_memory_time_ms` |  88 |  176 |  135 |  41 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  3,653 |  7,306 |  4,668 |  2,638 |
| `prover.main_trace_commit_time_ms` |  963 |  1,926 |  1,334 |  592 |
| `prover.rap_constraints_time_ms` |  1,979 |  3,958 |  2,442 |  1,516 |
| `prover.openings_time_ms` |  710.50 |  1,421 |  892 |  529 |
| `prover.rap_constraints.logup_gkr_time_ms` |  555.50 |  1,111 |  595 |  516 |
| `prover.rap_constraints.round0_time_ms` |  1,040 |  2,080 |  1,352 |  728 |
| `prover.rap_constraints.mle_rounds_time_ms` |  382.50 |  765 |  494 |  271 |
| `prover.openings.stacked_reduction_time_ms` |  166.50 |  333 |  215 |  118 |
...
| `prover.openings.whir_time_ms` |  543.50 |  1,087 |  676 |  411 |
...
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  897 |  897 |  897 |  897 |
| `prover.main_trace_commit_time_ms` |  374 |  374 |  374 |  374 |
| `prover.rap_constraints_time_ms` |  229 |  229 |  229 |  229 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/fb178e1cbb246c4cbeb9ea76d40e8c47ffd075ea/sha2_bench-fb178e1cbb246c4cbeb9ea76d40e8c47ffd075ea.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 74 |  |  |  | 352 |  |  |  |  |  |  | 
| app_proof |  |  |  | 3,036 |  | 87 | 11,167,961 | 127 | 0 | 8,308 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 326 | 118 | 0 | 0 | 107 | 34 | 34 | 52 | 20 | 0 | 99 | 86 | 13 | 3 | 9 | 118 | 118 | 107 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 170 | 47 | 0 | 0 | 70 | 25 | 25 | 28 | 15 | 0 | 53 | 44 | 8 | 1 | 6 | 47 | 47 | 70 | 0 | 3 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 138 | 31 | 0 | 0 | 62 | 24 | 23 | 24 | 13 | 0 | 43 | 36 | 7 | 1 | 5 | 32 | 31 | 62 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 237,929,016 | 897 | 374 | 0 | 0 | 229 | 109 | 108 | 68 | 51 | 0 | 293 | 256 | 37 | 19 | 17 | 374 | 374 | 229 | 0 | 11 | 50 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,286,242,554 | 4,668 | 1,333 | 0 | 0 | 2,442 | 1,352 | 1,351 | 494 | 595 | 0 | 892 | 676 | 215 | 134 | 80 | 1,334 | 1,333 | 2,442 | 0 | 5 | 594 | 0 | 0 | 
| app_proof | prover | 1 | 750,289,144 | 2,638 | 591 | 0 | 0 | 1,516 | 728 | 727 | 271 | 516 | 0 | 529 | 411 | 118 | 72 | 46 | 592 | 591 | 1,516 | 0 | 6 | 516 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 135 | 1 | 171 | 5,177 | 171 | 135 | 13,369,416,740 | 2,137,634,692 | 15,507,051,432 | 2,097,152 | 0 | 3 | 202 | 7,124,000 | 35.84 | 
| app_proof | 1 | 41 | 1 | 72 | 3,036 | 72 | 41 | 7,653,619,468 | 1,457,562,773 | 9,111,182,241 | 2,097,152 | 0 | 2 | 283 | 4,043,961 | 39.91 | 

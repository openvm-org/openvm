...
|:---|---:|---:|---:|
| Total |  9.94 |  6.93 |  6.93 |
| app_proof |  8.27 |  5.26 |  5.26 |
...
| `total_proof_time_ms ` |  4,084.50 |  8,169 |  5,157 |  3,012 |
| `compile_metered_time_ms` |  4 |  4 |  4 |  4 |
| `execute_metered_time_ms` |  103 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  108.10 | -          |  108.10 |  108.10 |
| `execute_preflight_insns` |  5,583,980.50 |  11,167,961 |  7,124,000 |  4,043,961 |
| `execute_preflight_time_ms` |  248 |  496 |  286 |  210 |
| `execute_preflight_insn_mi/s` |  36.71 | -          |  39.09 |  34.34 |
| `trace_gen_time_ms   ` |  125.50 |  251 |  176 |  75 |
| `set_initial_memory_time_ms` |  88 |  176 |  135 |  41 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  3,622 |  7,244 |  4,635 |  2,609 |
| `prover.main_trace_commit_time_ms` |  956 |  1,912 |  1,327 |  585 |
| `prover.rap_constraints_time_ms` |  1,965 |  3,930 |  2,423 |  1,507 |
| `prover.openings_time_ms` |  699.50 |  1,399 |  883 |  516 |
| `prover.rap_constraints.logup_gkr_time_ms` |  551 |  1,102 |  590 |  512 |
| `prover.rap_constraints.round0_time_ms` |  1,040 |  2,080 |  1,353 |  727 |
| `prover.rap_constraints.mle_rounds_time_ms` |  373 |  746 |  479 |  267 |
| `prover.openings.stacked_reduction_time_ms` |  163 |  326 |  210 |  116 |
...
| `prover.openings.whir_time_ms` |  535.50 |  1,071 |  672 |  399 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/96524f8c32665b99eb77a98c78167d9e88b339d0/sha2_bench-96524f8c32665b99eb77a98c78167d9e88b339d0.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 70 |  |  |  | 344 |  |  |  |  |  |  | 
| app_proof |  |  |  | 3,012 |  | 103 | 11,167,961 | 108.10 | 0 | 8,279 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 322 | 116 | 0 | 0 | 105 | 33 | 33 | 51 | 20 | 0 | 99 | 86 | 13 | 3 | 9 | 116 | 116 | 105 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 170 | 46 | 0 | 0 | 68 | 25 | 24 | 28 | 14 | 0 | 55 | 46 | 8 | 1 | 6 | 46 | 46 | 68 | 0 | 3 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 139 | 32 | 0 | 0 | 62 | 24 | 23 | 24 | 14 | 0 | 42 | 35 | 7 | 1 | 5 | 33 | 32 | 62 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 237,929,016 | 887 | 371 | 0 | 0 | 224 | 106 | 105 | 67 | 50 | 0 | 291 | 254 | 36 | 19 | 17 | 371 | 371 | 224 | 0 | 11 | 49 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,286,242,554 | 4,635 | 1,327 | 0 | 0 | 2,423 | 1,353 | 1,353 | 479 | 590 | 1 | 883 | 672 | 210 | 131 | 79 | 1,327 | 1,327 | 2,423 | 0 | 5 | 588 | 0 | 0 | 
| app_proof | prover | 1 | 750,289,144 | 2,609 | 585 | 0 | 0 | 1,507 | 727 | 727 | 267 | 512 | 0 | 516 | 399 | 116 | 70 | 45 | 585 | 585 | 1,507 | 0 | 6 | 510 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 135 | 1 | 176 | 5,157 | 176 | 135 | 13,306,647,852 | 2,134,713,996 | 15,441,361,848 | 2,097,152 | 0 | 3 | 210 | 7,124,000 | 34.34 | 
| app_proof | 1 | 41 | 1 | 75 | 3,012 | 75 | 41 | 7,584,540,132 | 1,503,573,469 | 9,088,113,601 | 2,097,152 | 0 | 2 | 286 | 4,043,961 | 39.09 | 

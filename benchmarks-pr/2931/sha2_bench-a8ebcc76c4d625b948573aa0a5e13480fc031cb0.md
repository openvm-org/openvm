...
| `total_proof_time_ms ` |  4,024 |  8,048 |  5,087 |  2,961 |
...
| `execute_preflight_time_ms` |  249.50 |  499 |  282 |  217 |
| `execute_preflight_insn_mi/s` |  35.60 | -          |  37.99 |  33.21 |
| `trace_gen_time_ms   ` |  125.50 |  251 |  176 |  75 |
| `set_initial_memory_time_ms` |  88.50 |  177 |  136 |  41 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  3,560 |  7,120 |  4,557 |  2,563 |
| `prover.main_trace_commit_time_ms` |  944.50 |  1,889 |  1,308 |  581 |
| `prover.rap_constraints_time_ms` |  1,919.50 |  3,839 |  2,368 |  1,471 |
| `prover.openings_time_ms` |  694.50 |  1,389 |  879 |  510 |
| `prover.rap_constraints.logup_gkr_time_ms` |  542.50 |  1,085 |  581 |  504 |
| `prover.rap_constraints.round0_time_ms` |  1,006.50 |  2,013 |  1,309 |  704 |
| `prover.rap_constraints.mle_rounds_time_ms` |  369 |  738 |  476 |  262 |
| `prover.openings.stacked_reduction_time_ms` |  160 |  320 |  206 |  114 |
| `prover.openings.stacked_reduction.round0_time_ms` |  98.50 |  197 |  129 |  68 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  61 |  122 |  77 |  45 |
| `prover.openings.whir_time_ms` |  534 |  1,068 |  672 |  396 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/a8ebcc76c4d625b948573aa0a5e13480fc031cb0/sha2_bench-a8ebcc76c4d625b948573aa0a5e13480fc031cb0.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 74 |  |  |  | 352 |  |  |  |  |  |  | 
| app_proof |  |  |  | 2,961 |  | 102 | 11,167,961 | 109.13 | 0 | 8,157 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 21 | 344 | 20 | 5 | 1 | 2 | 2 | 2 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 323 | 115 | 0 | 0 | 105 | 33 | 33 | 51 | 20 | 0 | 102 | 88 | 13 | 3 | 9 | 115 | 115 | 105 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 166 | 45 | 0 | 0 | 65 | 24 | 23 | 27 | 13 | 0 | 54 | 45 | 8 | 1 | 6 | 46 | 45 | 65 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 136 | 32 | 0 | 0 | 63 | 23 | 22 | 24 | 15 | 0 | 40 | 33 | 7 | 1 | 5 | 32 | 32 | 63 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 237,929,016 | 883 | 366 | 0 | 0 | 222 | 105 | 104 | 66 | 50 | 0 | 293 | 256 | 37 | 19 | 17 | 366 | 366 | 222 | 0 | 9 | 49 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,286,242,554 | 4,557 | 1,308 | 0 | 0 | 2,368 | 1,309 | 1,309 | 476 | 581 | 0 | 879 | 672 | 206 | 129 | 77 | 1,308 | 1,308 | 2,368 | 0 | 4 | 580 | 0 | 0 | 
| app_proof | prover | 1 | 750,289,144 | 2,563 | 580 | 0 | 0 | 1,471 | 704 | 704 | 262 | 504 | 0 | 510 | 396 | 114 | 68 | 45 | 581 | 580 | 1,471 | 0 | 4 | 503 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 136 | 1 | 176 | 5,087 | 176 | 136 | 13,306,647,852 | 2,134,713,996 | 15,441,361,848 | 2,097,152 | 0 | 4 | 217 | 7,124,000 | 33.21 | 
| app_proof | 1 | 41 | 1 | 75 | 2,961 | 75 | 41 | 7,584,540,132 | 1,503,573,469 | 9,088,113,601 | 2,097,152 | 0 | 2 | 282 | 4,043,961 | 37.99 | 

...
|:---|---:|---:|---:|
| Total |  9.81 |  6.84 |  6.84 |
| app_proof |  8.15 |  5.18 |  5.18 |
| leaf |  0.99 |  0.99 |  0.99 |
...
| `total_proof_time_ms ` |  4,023.50 |  8,047 |  5,081 |  2,966 |
...
| `execute_preflight_time_ms` |  240.50 |  481 |  274 |  207 |
| `execute_preflight_insn_mi/s` |  37.37 | -          |  39.82 |  34.93 |
| `trace_gen_time_ms   ` |  125.50 |  251 |  176 |  75 |
| `set_initial_memory_time_ms` |  88.50 |  177 |  136 |  41 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  3,568 |  7,136 |  4,561 |  2,575 |
| `prover.main_trace_commit_time_ms` |  953.50 |  1,907 |  1,322 |  585 |
| `prover.rap_constraints_time_ms` |  1,916 |  3,832 |  2,356 |  1,476 |
| `prover.openings_time_ms` |  697 |  1,394 |  881 |  513 |
| `prover.rap_constraints.logup_gkr_time_ms` |  544 |  1,088 |  585 |  503 |
| `prover.rap_constraints.round0_time_ms` |  997 |  1,994 |  1,289 |  705 |
...
| `prover.openings.whir_time_ms` |  533.50 |  1,067 |  670 |  397 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/1eef51c49277daf013846d83443e08dc0c61fcd9/sha2_bench-1eef51c49277daf013846d83443e08dc0c61fcd9.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 72 |  |  |  | 348 |  |  |  |  |  |  | 
| app_proof |  |  |  | 2,966 |  | 103 | 11,167,961 | 107.100 | 0 | 8,156 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 320 | 115 | 0 | 0 | 106 | 34 | 34 | 51 | 20 | 0 | 97 | 84 | 13 | 3 | 9 | 116 | 115 | 106 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 168 | 46 | 0 | 0 | 67 | 24 | 24 | 28 | 14 | 0 | 54 | 46 | 8 | 1 | 6 | 47 | 46 | 66 | 0 | 3 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 136 | 31 | 0 | 0 | 62 | 24 | 23 | 24 | 13 | 0 | 42 | 35 | 7 | 1 | 5 | 32 | 31 | 62 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 237,929,016 | 881 | 370 | 0 | 0 | 224 | 106 | 105 | 67 | 50 | 0 | 285 | 249 | 36 | 19 | 16 | 371 | 370 | 224 | 0 | 9 | 50 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,286,242,554 | 4,561 | 1,322 | 0 | 0 | 2,356 | 1,289 | 1,288 | 481 | 585 | 0 | 881 | 670 | 210 | 131 | 79 | 1,322 | 1,322 | 2,356 | 0 | 4 | 584 | 0 | 0 | 
| app_proof | prover | 1 | 750,289,144 | 2,575 | 585 | 0 | 0 | 1,476 | 705 | 704 | 267 | 503 | 0 | 513 | 397 | 116 | 70 | 45 | 585 | 585 | 1,476 | 0 | 4 | 502 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 136 | 1 | 176 | 5,081 | 176 | 136 | 13,306,647,852 | 2,134,713,996 | 15,441,361,848 | 2,097,152 | 0 | 3 | 207 | 7,124,000 | 34.93 | 
| app_proof | 1 | 41 | 1 | 75 | 2,966 | 75 | 41 | 7,584,540,132 | 1,503,573,469 | 9,088,113,601 | 2,097,152 | 0 | 2 | 274 | 4,043,961 | 39.82 | 

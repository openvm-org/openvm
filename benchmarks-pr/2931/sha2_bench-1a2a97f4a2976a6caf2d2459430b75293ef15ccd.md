...
|:---|---:|---:|---:|
| Total |  9.82 |  6.85 |  6.85 |
| app_proof |  8.16 |  5.19 |  5.19 |
| leaf |  0.99 |  0.99 |  0.99 |
...
| `total_proof_time_ms ` |  4,033 |  8,066 |  5,095 |  2,971 |
...
| `execute_preflight_time_ms` |  240 |  480 |  272 |  208 |
| `execute_preflight_insn_mi/s` |  37.23 | -          |  39.70 |  34.75 |
| `trace_gen_time_ms   ` |  125 |  250 |  174 |  76 |
| `set_initial_memory_time_ms` |  88 |  176 |  135 |  41 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  3,578.50 |  7,157 |  4,576 |  2,581 |
| `prover.main_trace_commit_time_ms` |  943.50 |  1,887 |  1,306 |  581 |
| `prover.rap_constraints_time_ms` |  1,935.50 |  3,871 |  2,387 |  1,484 |
| `prover.openings_time_ms` |  698 |  1,396 |  881 |  515 |
| `prover.rap_constraints.logup_gkr_time_ms` |  547 |  1,094 |  585 |  509 |
| `prover.rap_constraints.round0_time_ms` |  1,016.50 |  2,033 |  1,323 |  710 |
| `prover.rap_constraints.mle_rounds_time_ms` |  371.50 |  743 |  478 |  265 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  989 |  989 |  989 |  989 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/1a2a97f4a2976a6caf2d2459430b75293ef15ccd/sha2_bench-1a2a97f4a2976a6caf2d2459430b75293ef15ccd.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 69 |  |  |  | 344 |  |  |  |  |  |  | 
| app_proof |  |  |  | 2,971 |  | 95 | 11,167,961 | 117.48 | 0 | 8,167 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 320 | 115 | 0 | 0 | 107 | 34 | 33 | 52 | 20 | 0 | 97 | 83 | 13 | 3 | 9 | 116 | 115 | 107 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 168 | 45 | 0 | 0 | 65 | 24 | 23 | 27 | 13 | 0 | 56 | 48 | 8 | 1 | 6 | 46 | 45 | 65 | 0 | 3 | 12 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 140 | 31 | 0 | 0 | 62 | 24 | 23 | 24 | 13 | 0 | 46 | 38 | 7 | 1 | 5 | 32 | 31 | 62 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 237,929,016 | 880 | 369 | 0 | 0 | 223 | 107 | 106 | 66 | 49 | 0 | 286 | 250 | 36 | 19 | 16 | 369 | 369 | 223 | 0 | 9 | 48 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,286,242,554 | 4,576 | 1,306 | 0 | 0 | 2,387 | 1,323 | 1,323 | 478 | 585 | 0 | 881 | 673 | 208 | 130 | 78 | 1,306 | 1,306 | 2,387 | 0 | 4 | 583 | 0 | 0 | 
| app_proof | prover | 1 | 750,289,144 | 2,581 | 581 | 0 | 0 | 1,484 | 710 | 709 | 265 | 509 | 0 | 515 | 398 | 116 | 70 | 45 | 581 | 581 | 1,484 | 0 | 5 | 508 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 136 | 1 | 174 | 5,095 | 174 | 135 | 13,306,647,852 | 2,134,713,996 | 15,441,361,848 | 2,097,152 | 0 | 3 | 208 | 7,124,000 | 34.75 | 
| app_proof | 1 | 41 | 1 | 76 | 2,971 | 76 | 41 | 7,584,540,132 | 1,503,573,469 | 9,088,113,601 | 2,097,152 | 0 | 2 | 272 | 4,043,961 | 39.70 | 

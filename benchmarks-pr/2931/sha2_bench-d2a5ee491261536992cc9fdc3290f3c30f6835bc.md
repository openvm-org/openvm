...
| `total_proof_time_ms ` |  4,109 |  8,218 |  5,188 |  3,030 |
...
| `execute_preflight_time_ms` |  235 |  470 |  270 |  200 |
| `execute_preflight_insn_mi/s` |  38.61 | -          |  40.100 |  36.23 |
| `trace_gen_time_ms   ` |  121 |  242 |  170 |  72 |
| `set_initial_memory_time_ms` |  88.50 |  177 |  136 |  41 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  3,662.50 |  7,325 |  4,680 |  2,645 |
| `prover.main_trace_commit_time_ms` |  970 |  1,940 |  1,344 |  596 |
| `prover.rap_constraints_time_ms` |  1,978.50 |  3,957 |  2,438 |  1,519 |
| `prover.openings_time_ms` |  713.50 |  1,427 |  897 |  530 |
| `prover.rap_constraints.logup_gkr_time_ms` |  555.50 |  1,111 |  595 |  516 |
| `prover.rap_constraints.round0_time_ms` |  1,036 |  2,072 |  1,345 |  727 |
| `prover.rap_constraints.mle_rounds_time_ms` |  385.50 |  771 |  496 |  275 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/d2a5ee491261536992cc9fdc3290f3c30f6835bc/sha2_bench-d2a5ee491261536992cc9fdc3290f3c30f6835bc.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 71 |  |  |  | 344 |  |  |  |  |  |  | 
| app_proof |  |  |  | 3,030 |  | 87 | 11,167,961 | 127.48 | 0 | 8,311 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 332 | 118 | 0 | 0 | 109 | 35 | 34 | 52 | 22 | 0 | 103 | 89 | 13 | 3 | 9 | 118 | 118 | 109 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 168 | 46 | 0 | 0 | 68 | 25 | 24 | 28 | 14 | 0 | 52 | 44 | 8 | 1 | 6 | 47 | 46 | 68 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 139 | 33 | 0 | 0 | 61 | 23 | 22 | 24 | 13 | 0 | 44 | 36 | 7 | 1 | 5 | 33 | 33 | 61 | 0 | 3 | 13 | 0 | 0 | 
| leaf | 0 | prover | 237,929,016 | 904 | 376 | 0 | 0 | 230 | 110 | 109 | 68 | 51 | 0 | 296 | 258 | 38 | 20 | 17 | 377 | 376 | 230 | 0 | 10 | 51 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,286,242,554 | 4,680 | 1,344 | 0 | 0 | 2,438 | 1,345 | 1,345 | 496 | 595 | 1 | 897 | 680 | 216 | 135 | 81 | 1,344 | 1,344 | 2,437 | 0 | 5 | 593 | 0 | 0 | 
| app_proof | prover | 1 | 750,289,144 | 2,645 | 596 | 0 | 0 | 1,519 | 727 | 726 | 275 | 516 | 0 | 530 | 410 | 119 | 72 | 46 | 596 | 596 | 1,519 | 0 | 5 | 515 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 136 | 1 | 170 | 5,188 | 170 | 136 | 13,369,416,740 | 2,137,634,692 | 15,507,051,432 | 2,097,152 | 0 | 3 | 200 | 7,124,000 | 36.23 | 
| app_proof | 1 | 41 | 1 | 72 | 3,030 | 72 | 41 | 7,653,619,468 | 1,457,562,773 | 9,111,182,241 | 2,097,152 | 0 | 2 | 270 | 4,043,961 | 40.100 | 

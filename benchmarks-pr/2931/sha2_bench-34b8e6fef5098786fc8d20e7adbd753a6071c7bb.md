...
|:---|---:|---:|---:|
| Total |  9.98 |  6.95 |  6.95 |
| app_proof |  8.29 |  5.27 |  5.27 |
| leaf |  1 |  1 |  1 |
...
| `total_proof_time_ms ` |  4,103.50 |  8,207 |  5,185 |  3,022 |
| `compile_metered_time_ms` |  3 |  3 |  3 |  3 |
| `execute_metered_time_ms` |  87 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  128.33 | -          |  128.33 |  128.33 |
| `execute_preflight_insns` |  5,583,980.50 |  11,167,961 |  7,124,000 |  4,043,961 |
| `execute_preflight_time_ms` |  239.50 |  479 |  271 |  208 |
| `execute_preflight_insn_mi/s` |  37.31 | -          |  39.86 |  34.76 |
| `trace_gen_time_ms   ` |  125.50 |  251 |  176 |  75 |
| `set_initial_memory_time_ms` |  88.50 |  177 |  136 |  41 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  3,649 |  7,298 |  4,664 |  2,634 |
| `prover.main_trace_commit_time_ms` |  965.50 |  1,931 |  1,338 |  593 |
| `prover.rap_constraints_time_ms` |  1,974 |  3,948 |  2,430 |  1,518 |
| `prover.openings_time_ms` |  708.50 |  1,417 |  895 |  522 |
| `prover.rap_constraints.logup_gkr_time_ms` |  555.50 |  1,111 |  596 |  515 |
| `prover.rap_constraints.round0_time_ms` |  1,035 |  2,070 |  1,342 |  728 |
| `prover.rap_constraints.mle_rounds_time_ms` |  382 |  764 |  491 |  273 |
| `prover.openings.stacked_reduction_time_ms` |  167 |  334 |  214 |  120 |
| `prover.openings.stacked_reduction.round0_time_ms` |  103.50 |  207 |  134 |  73 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  63.50 |  127 |  80 |  47 |
| `prover.openings.whir_time_ms` |  541 |  1,082 |  680 |  402 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/34b8e6fef5098786fc8d20e7adbd753a6071c7bb/sha2_bench-34b8e6fef5098786fc8d20e7adbd753a6071c7bb.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 70 |  |  |  | 338 |  |  |  |  |  |  | 
| app_proof |  |  |  | 3,022 |  | 87 | 11,167,961 | 128.33 | 0 | 8,300 |  | 
...
| app_proof | VmAirWrapper<Rv64LoadStoreAdapterAir, LoadStoreCoreAir<8> | 0 | 17 | 32 | 
...
| leaf | 0 | 108 | 1,002 | 107 | 34 | 17 | 2 | 7 | 7 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 330 | 118 | 0 | 0 | 108 | 35 | 34 | 51 | 21 | 0 | 103 | 89 | 13 | 3 | 9 | 118 | 118 | 108 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 168 | 47 | 0 | 0 | 67 | 25 | 24 | 27 | 14 | 0 | 53 | 45 | 8 | 1 | 6 | 47 | 47 | 67 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 141 | 32 | 0 | 0 | 62 | 24 | 23 | 24 | 14 | 0 | 44 | 37 | 7 | 1 | 5 | 33 | 32 | 62 | 0 | 2 | 13 | 0 | 0 | 
| leaf | 0 | prover | 237,929,016 | 894 | 375 | 0 | 0 | 231 | 112 | 111 | 67 | 51 | 0 | 287 | 250 | 36 | 19 | 17 | 376 | 375 | 231 | 0 | 9 | 50 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,286,242,554 | 4,664 | 1,338 | 0 | 0 | 2,430 | 1,342 | 1,341 | 491 | 596 | 0 | 895 | 680 | 214 | 134 | 80 | 1,338 | 1,338 | 2,430 | 0 | 5 | 595 | 0 | 0 | 
| app_proof | prover | 1 | 750,289,144 | 2,634 | 593 | 0 | 0 | 1,518 | 728 | 728 | 273 | 515 | 0 | 522 | 402 | 120 | 73 | 47 | 593 | 593 | 1,518 | 0 | 6 | 514 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 136 | 1 | 176 | 5,185 | 176 | 136 | 13,306,647,852 | 2,134,713,996 | 15,441,361,848 | 2,097,152 | 0 | 3 | 208 | 7,124,000 | 34.76 | 
| app_proof | 1 | 41 | 1 | 75 | 3,022 | 75 | 41 | 7,584,540,132 | 1,503,573,469 | 9,088,113,601 | 2,097,152 | 0 | 2 | 271 | 4,043,961 | 39.86 | 

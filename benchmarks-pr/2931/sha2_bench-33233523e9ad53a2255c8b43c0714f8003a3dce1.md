...
| `total_proof_time_ms ` |  4,082 |  8,164 |  5,139 |  3,025 |
...
| `execute_preflight_time_ms` |  250.50 |  501 |  297 |  204 |
| `execute_preflight_insn_mi/s` |  35.37 | -          |  35.39 |  35.36 |
| `trace_gen_time_ms   ` |  122 |  244 |  172 |  72 |
| `set_initial_memory_time_ms` |  88 |  176 |  135 |  41 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  3,620 |  7,240 |  4,627 |  2,613 |
| `prover.main_trace_commit_time_ms` |  961.50 |  1,923 |  1,332 |  591 |
| `prover.rap_constraints_time_ms` |  1,951 |  3,902 |  2,405 |  1,497 |
| `prover.openings_time_ms` |  706.50 |  1,413 |  888 |  525 |
| `prover.rap_constraints.logup_gkr_time_ms` |  548 |  1,096 |  589 |  507 |
| `prover.rap_constraints.round0_time_ms` |  1,024.50 |  2,049 |  1,330 |  719 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/33233523e9ad53a2255c8b43c0714f8003a3dce1/sha2_bench-33233523e9ad53a2255c8b43c0714f8003a3dce1.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 68 |  |  |  | 342 |  |  |  |  |  |  | 
| app_proof |  |  |  | 3,025 |  | 86 | 11,167,961 | 129.33 | 0 | 8,257 |  | 
...
| leaf | 0 | 113 | 1,004 | 113 | 35 | 17 | 2 | 7 | 7 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 330 | 117 | 0 | 0 | 108 | 34 | 33 | 52 | 21 | 0 | 104 | 91 | 13 | 3 | 9 | 117 | 117 | 108 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 170 | 47 | 0 | 0 | 67 | 25 | 24 | 28 | 13 | 0 | 54 | 46 | 8 | 1 | 6 | 48 | 47 | 67 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 143 | 32 | 0 | 0 | 62 | 23 | 22 | 24 | 13 | 0 | 49 | 41 | 7 | 1 | 5 | 32 | 32 | 62 | 0 | 3 | 13 | 0 | 0 | 
| leaf | 0 | prover | 237,929,016 | 891 | 372 | 0 | 0 | 227 | 108 | 107 | 66 | 52 | 0 | 290 | 253 | 37 | 19 | 17 | 372 | 372 | 227 | 0 | 10 | 50 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,286,242,554 | 4,627 | 1,332 | 0 | 0 | 2,405 | 1,330 | 1,330 | 484 | 589 | 1 | 888 | 676 | 212 | 133 | 79 | 1,332 | 1,332 | 2,405 | 0 | 4 | 588 | 0 | 0 | 
| app_proof | prover | 1 | 750,289,144 | 2,613 | 590 | 0 | 0 | 1,497 | 719 | 718 | 270 | 507 | 0 | 525 | 407 | 117 | 71 | 46 | 591 | 590 | 1,497 | 0 | 5 | 506 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 135 | 1 | 172 | 5,139 | 172 | 135 | 13,306,647,852 | 2,134,713,996 | 15,441,361,848 | 2,097,152 | 0 | 4 | 204 | 7,124,000 | 35.39 | 
| app_proof | 1 | 41 | 1 | 72 | 3,025 | 72 | 41 | 7,584,540,132 | 1,503,573,469 | 9,088,113,601 | 2,097,152 | 0 | 2 | 297 | 4,043,961 | 35.36 | 

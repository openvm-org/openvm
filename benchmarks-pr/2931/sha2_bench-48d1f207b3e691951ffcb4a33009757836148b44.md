...
| `total_proof_time_ms ` |  4,090.50 |  8,181 |  5,156 |  3,025 |
...
| `execute_preflight_time_ms` |  245 |  490 |  283 |  207 |
| `execute_preflight_insn_mi/s` |  37.05 | -          |  39.16 |  34.94 |
| `trace_gen_time_ms   ` |  122 |  244 |  171 |  73 |
| `set_initial_memory_time_ms` |  88.50 |  177 |  136 |  41 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  3,633 |  7,266 |  4,639 |  2,627 |
| `prover.main_trace_commit_time_ms` |  960.50 |  1,921 |  1,331 |  590 |
| `prover.rap_constraints_time_ms` |  1,962.50 |  3,925 |  2,418 |  1,507 |
| `prover.openings_time_ms` |  709.50 |  1,419 |  890 |  529 |
| `prover.rap_constraints.logup_gkr_time_ms` |  552 |  1,104 |  591 |  513 |
| `prover.rap_constraints.round0_time_ms` |  1,031.50 |  2,063 |  1,340 |  723 |
...
| `prover.openings.whir_time_ms` |  543 |  1,086 |  676 |  410 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/48d1f207b3e691951ffcb4a33009757836148b44/sha2_bench-48d1f207b3e691951ffcb4a33009757836148b44.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 70 |  |  |  | 339 |  |  |  |  |  |  | 
| app_proof |  |  |  | 3,025 |  | 88 | 11,167,961 | 126.24 | 0 | 8,275 |  | 
...
| leaf | 0 | 119 | 1,005 | 119 | 36 | 17 | 2 | 9 | 9 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 325 | 117 | 0 | 0 | 107 | 35 | 34 | 51 | 20 | 0 | 99 | 85 | 13 | 3 | 9 | 117 | 117 | 107 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 173 | 47 | 0 | 0 | 70 | 24 | 24 | 27 | 17 | 0 | 55 | 47 | 8 | 1 | 6 | 47 | 47 | 70 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 139 | 31 | 0 | 0 | 60 | 22 | 21 | 24 | 13 | 0 | 46 | 38 | 7 | 1 | 5 | 32 | 31 | 60 | 0 | 3 | 12 | 0 | 0 | 
| leaf | 0 | prover | 237,929,016 | 885 | 372 | 0 | 0 | 227 | 109 | 108 | 67 | 50 | 0 | 285 | 248 | 36 | 19 | 16 | 372 | 372 | 227 | 0 | 9 | 49 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,286,242,554 | 4,639 | 1,331 | 0 | 0 | 2,418 | 1,340 | 1,340 | 485 | 591 | 0 | 890 | 676 | 213 | 133 | 80 | 1,331 | 1,331 | 2,418 | 0 | 5 | 589 | 0 | 0 | 
| app_proof | prover | 1 | 750,289,144 | 2,627 | 590 | 0 | 0 | 1,507 | 723 | 723 | 270 | 513 | 0 | 529 | 410 | 118 | 71 | 46 | 590 | 590 | 1,507 | 0 | 6 | 511 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 136 | 1 | 171 | 5,156 | 171 | 136 | 13,306,647,852 | 2,134,713,996 | 15,441,361,848 | 2,097,152 | 0 | 3 | 207 | 7,124,000 | 34.94 | 
| app_proof | 1 | 41 | 1 | 73 | 3,025 | 73 | 41 | 7,584,540,132 | 1,503,573,469 | 9,088,113,601 | 2,097,152 | 0 | 2 | 283 | 4,043,961 | 39.16 | 

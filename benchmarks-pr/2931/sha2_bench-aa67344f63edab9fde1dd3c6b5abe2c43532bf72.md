...
|:---|---:|---:|---:|
| Total |  9.73 |  6.79 |  6.79 |
| app_proof |  8.08 |  5.14 |  5.14 |
| leaf |  0.98 |  0.98 |  0.98 |
...
| `total_proof_time_ms ` |  3,996.50 |  7,993 |  5,056 |  2,937 |
...
| `execute_preflight_time_ms` |  241 |  482 |  274 |  208 |
| `execute_preflight_insn_mi/s` |  37.18 | -          |  39.60 |  34.76 |
| `trace_gen_time_ms   ` |  125.50 |  251 |  176 |  75 |
| `set_initial_memory_time_ms` |  88.50 |  177 |  136 |  41 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  3,541.50 |  7,083 |  4,536 |  2,547 |
| `prover.main_trace_commit_time_ms` |  943.50 |  1,887 |  1,308 |  579 |
| `prover.rap_constraints_time_ms` |  1,903.50 |  3,807 |  2,348 |  1,459 |
| `prover.openings_time_ms` |  693 |  1,386 |  878 |  508 |
| `prover.rap_constraints.logup_gkr_time_ms` |  537 |  1,074 |  581 |  493 |
| `prover.rap_constraints.round0_time_ms` |  999.50 |  1,999 |  1,295 |  704 |
| `prover.rap_constraints.mle_rounds_time_ms` |  366 |  732 |  471 |  261 |
| `prover.openings.stacked_reduction_time_ms` |  159 |  318 |  206 |  112 |
| `prover.openings.stacked_reduction.round0_time_ms` |  97.50 |  195 |  128 |  67 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  61 |  122 |  77 |  45 |
| `prover.openings.whir_time_ms` |  533.50 |  1,067 |  672 |  395 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  984 |  984 |  984 |  984 |
| `execute_preflight_time_ms` |  2 |  2 |  2 |  2 |
| `trace_gen_time_ms   ` |  107 |  107 |  107 |  107 |
| `generate_blob_total_time_ms` |  17 |  17 |  17 |  17 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  876 |  876 |  876 |  876 |
| `prover.main_trace_commit_time_ms` |  367 |  367 |  367 |  367 |
| `prover.rap_constraints_time_ms` |  221 |  221 |  221 |  221 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  339 |  339 |  339 |  339 |
| `execute_preflight_time_ms` |  2 |  2 |  2 |  2 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/aa67344f63edab9fde1dd3c6b5abe2c43532bf72/sha2_bench-aa67344f63edab9fde1dd3c6b5abe2c43532bf72.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 69 |  |  |  | 339 |  |  |  |  |  |  | 
| app_proof |  |  |  | 2,937 |  | 87 | 11,167,961 | 128.26 | 0 | 8,087 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 318 | 115 | 0 | 0 | 106 | 34 | 33 | 51 | 20 | 0 | 96 | 83 | 13 | 3 | 9 | 115 | 115 | 106 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 168 | 45 | 0 | 0 | 66 | 24 | 23 | 27 | 13 | 0 | 56 | 47 | 8 | 1 | 6 | 46 | 45 | 66 | 0 | 3 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 136 | 31 | 0 | 0 | 61 | 23 | 23 | 24 | 13 | 0 | 42 | 35 | 7 | 1 | 5 | 32 | 31 | 61 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 237,929,016 | 876 | 367 | 0 | 0 | 221 | 105 | 104 | 66 | 50 | 0 | 287 | 250 | 36 | 19 | 16 | 367 | 367 | 221 | 0 | 8 | 49 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,286,242,554 | 4,536 | 1,308 | 0 | 0 | 2,348 | 1,295 | 1,294 | 471 | 581 | 0 | 878 | 672 | 206 | 128 | 77 | 1,308 | 1,308 | 2,348 | 0 | 4 | 580 | 0 | 0 | 
| app_proof | prover | 1 | 750,289,144 | 2,547 | 579 | 0 | 0 | 1,459 | 704 | 703 | 261 | 493 | 0 | 508 | 395 | 112 | 67 | 45 | 579 | 579 | 1,459 | 0 | 4 | 492 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 136 | 1 | 176 | 5,056 | 176 | 136 | 13,306,647,852 | 2,134,713,996 | 15,441,361,848 | 2,097,152 | 0 | 3 | 208 | 7,124,000 | 34.76 | 
| app_proof | 1 | 41 | 1 | 75 | 2,937 | 75 | 41 | 7,584,540,132 | 1,503,573,469 | 9,088,113,601 | 2,097,152 | 0 | 2 | 274 | 4,043,961 | 39.60 | 

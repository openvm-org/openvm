...
| `total_proof_time_ms ` |  4,042.50 |  8,085 |  5,113 |  2,972 |
| `compile_metered_time_ms` |  4 |  4 |  4 |  4 |
| `execute_metered_time_ms` |  95 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  116.36 | -          |  116.36 |  116.36 |
| `execute_preflight_insns` |  5,583,980.50 |  11,167,961 |  7,124,000 |  4,043,961 |
| `execute_preflight_time_ms` |  241 |  482 |  274 |  208 |
| `execute_preflight_insn_mi/s` |  37.24 | -          |  39.75 |  34.74 |
| `trace_gen_time_ms   ` |  125.50 |  251 |  176 |  75 |
| `set_initial_memory_time_ms` |  88.50 |  177 |  136 |  41 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  3,586 |  7,172 |  4,591 |  2,581 |
| `prover.main_trace_commit_time_ms` |  950 |  1,900 |  1,317 |  583 |
| `prover.rap_constraints_time_ms` |  1,936.50 |  3,873 |  2,389 |  1,484 |
| `prover.openings_time_ms` |  698.50 |  1,397 |  885 |  512 |
| `prover.rap_constraints.logup_gkr_time_ms` |  546 |  1,092 |  589 |  503 |
| `prover.rap_constraints.round0_time_ms` |  1,018 |  2,036 |  1,320 |  716 |
| `prover.rap_constraints.mle_rounds_time_ms` |  371.50 |  743 |  479 |  264 |
| `prover.openings.stacked_reduction_time_ms` |  162 |  324 |  210 |  114 |
| `prover.openings.stacked_reduction.round0_time_ms` |  99.50 |  199 |  131 |  68 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  62 |  124 |  79 |  45 |
| `prover.openings.whir_time_ms` |  535.50 |  1,071 |  674 |  397 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  990 |  990 |  990 |  990 |
...
| `prover.rap_constraints_time_ms` |  224 |  224 |  224 |  224 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/fded558eb2aafa1bcc24bd7e9443b3477814095c/sha2_bench-fded558eb2aafa1bcc24bd7e9443b3477814095c.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 72 |  |  |  | 344 |  |  |  |  |  |  | 
| app_proof |  |  |  | 2,972 |  | 95 | 11,167,961 | 116.36 | 0 | 8,187 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 320 | 116 | 0 | 0 | 105 | 33 | 32 | 51 | 20 | 0 | 98 | 84 | 13 | 3 | 9 | 116 | 116 | 105 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 167 | 46 | 0 | 0 | 64 | 23 | 22 | 28 | 13 | 0 | 55 | 47 | 8 | 1 | 6 | 46 | 46 | 64 | 0 | 2 | 12 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 138 | 32 | 0 | 0 | 61 | 23 | 22 | 24 | 13 | 0 | 43 | 36 | 7 | 1 | 5 | 32 | 32 | 61 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 237,929,016 | 882 | 369 | 0 | 0 | 224 | 107 | 106 | 66 | 51 | 0 | 287 | 250 | 37 | 20 | 16 | 370 | 369 | 224 | 0 | 10 | 49 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,286,242,554 | 4,591 | 1,317 | 0 | 0 | 2,389 | 1,320 | 1,320 | 479 | 589 | 0 | 885 | 674 | 210 | 131 | 79 | 1,317 | 1,317 | 2,389 | 0 | 4 | 588 | 0 | 0 | 
| app_proof | prover | 1 | 750,289,144 | 2,581 | 583 | 0 | 0 | 1,484 | 716 | 716 | 264 | 503 | 0 | 512 | 397 | 114 | 68 | 45 | 583 | 583 | 1,484 | 0 | 5 | 502 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 136 | 1 | 176 | 5,113 | 176 | 136 | 13,306,647,852 | 2,134,713,996 | 15,441,361,848 | 2,097,152 | 0 | 3 | 208 | 7,124,000 | 34.74 | 
| app_proof | 1 | 41 | 1 | 75 | 2,972 | 75 | 41 | 7,584,540,132 | 1,503,573,469 | 9,088,113,601 | 2,097,152 | 0 | 2 | 274 | 4,043,961 | 39.75 | 

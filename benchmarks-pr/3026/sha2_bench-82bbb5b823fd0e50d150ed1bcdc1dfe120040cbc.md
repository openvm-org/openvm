...
|:---|---:|---:|---:|
| Total |  4.94 |  3.35 |  3.35 |
| app_proof |  3.100 |  2.41 |  2.41 |
| leaf |  0.52 |  0.52 |  0.52 |
...
| `total_proof_time_ms ` |  1,969.50 |  3,939 |  2,352 |  1,587 |
| `compile_metered_time_ms` |  6 |  6 |  6 |  6 |
| `execute_metered_time_ms` |  56 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  199.12 | -          |  199.12 |  199.12 |
| `execute_preflight_insns` |  5,583,980.50 |  11,167,961 |  7,136,000 |  4,031,961 |
| `execute_preflight_time_ms` |  340 |  680 |  476 |  204 |
| `execute_preflight_insn_mi/s` |  36.09 | -          |  36.19 |  35.99 |
| `trace_gen_time_ms   ` |  72 |  144 |  101 |  43 |
| `set_initial_memory_time_ms` |  0 |  0 |  0 |  0 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,555.50 |  3,111 |  2,045 |  1,066 |
| `prover.main_trace_commit_time_ms` |  391 |  782 |  567 |  215 |
| `prover.rap_constraints_time_ms` |  897 |  1,794 |  1,135 |  659 |
| `prover.openings_time_ms` |  266.50 |  533 |  342 |  191 |
| `prover.rap_constraints.logup_gkr_time_ms` |  208 |  416 |  231 |  185 |
| `prover.rap_constraints.round0_time_ms` |  509 |  1,018 |  670 |  348 |
| `prover.rap_constraints.mle_rounds_time_ms` |  179.50 |  359 |  233 |  126 |
...
| `prover.openings.whir_time_ms` |  194 |  388 |  249 |  139 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  519 |  519 |  519 |  519 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/82bbb5b823fd0e50d150ed1bcdc1dfe120040cbc/sha2_bench-82bbb5b823fd0e50d150ed1bcdc1dfe120040cbc.memory.svg)
...
| prover.gkr_input_evals | 12.18 | app_proof.prover.0 |
| frac_sumcheck.segment_tree | 12.18 | app_proof.prover.0 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 56 |  |  |  | 285 |  |  |  |  |  |  | 
| app_proof |  |  |  | 1,587 |  | 56 | 11,167,961 | 199.12 | 0 | 4,004 |  | 
...
| app_proof | VmAirWrapper<Rv64LoadAdapterAir, LoadCoreAir<8, 1> | 0 | 4 | 6 | 
...
| leaf | 0 | 114 | 519 | 114 | 33 | 12 | 2 | 9 | 9 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 172 | 47 | 0 | 0 | 79 | 27 | 26 | 37 | 14 | 0 | 45 | 35 | 10 | 2 | 7 | 47 | 47 | 79 | 0 | 1 | 12 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 112 | 20 | 0 | 0 | 56 | 21 | 20 | 23 | 11 | 0 | 34 | 26 | 7 | 1 | 6 | 20 | 20 | 56 | 0 | 1 | 10 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 98 | 15 | 0 | 0 | 53 | 20 | 19 | 21 | 11 | 0 | 28 | 21 | 7 | 1 | 5 | 15 | 15 | 53 | 0 | 1 | 10 | 0 | 0 | 
| leaf | 0 | prover | 237,929,144 | 405 | 147 | 0 | 0 | 142 | 70 | 69 | 44 | 26 | 0 | 115 | 93 | 22 | 10 | 11 | 147 | 147 | 142 | 0 | 3 | 25 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,280,083,194 | 2,045 | 567 | 0 | 0 | 1,135 | 670 | 670 | 233 | 231 | 1 | 342 | 249 | 93 | 57 | 36 | 567 | 567 | 1,135 | 0 | 1 | 229 | 0 | 0 | 
| app_proof | prover | 1 | 687,443,728 | 1,066 | 215 | 0 | 0 | 659 | 348 | 347 | 126 | 185 | 0 | 191 | 139 | 51 | 30 | 20 | 215 | 215 | 659 | 0 | 1 | 183 | 0 | 0 | 

| group | phase | segment | trace_height_constraint | weighted_sum | threshold |
| --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 0 | 239,100,298 | 2,013,265,921 | 
| app_proof | prover | 1 | 0 | 145,450,682 | 2,013,265,921 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 0 | 2 | 101 | 2,352 | 101 | 0 | 12,567,225,180 | 2,800,224,348 | 15,367,449,528 | 2,097,152 | 0 | 3 | 204 | 7,136,000 | 35.99 | 
| app_proof | 1 | 0 | 1 | 43 | 1,587 | 43 | 0 | 7,131,913,452 | 1,123,862,484 | 8,255,775,936 | 2,097,152 | 0 | 2 | 476 | 4,031,961 | 36.19 | 

...
|:---|---:|---:|---:|
| Total |  4.93 |  3.35 |  3.35 |
| app_proof |  3.98 |  2.40 |  2.40 |
| leaf |  0.52 |  0.52 |  0.52 |
...
| `total_proof_time_ms ` |  1,964 |  3,928 |  2,346 |  1,582 |
| `compile_metered_time_ms` |  5 |  5 |  5 |  5 |
| `execute_metered_time_ms` |  56 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  198.49 | -          |  198.49 |  198.49 |
| `execute_preflight_insns` |  5,583,980.50 |  11,167,961 |  7,136,000 |  4,031,961 |
| `execute_preflight_time_ms` |  337 |  674 |  472 |  202 |
| `execute_preflight_insn_mi/s` |  37.18 | -          |  37.88 |  36.48 |
| `trace_gen_time_ms   ` |  73 |  146 |  101 |  45 |
| `set_initial_memory_time_ms` |  0 |  0 |  0 |  0 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,553 |  3,106 |  2,042 |  1,064 |
| `prover.main_trace_commit_time_ms` |  389 |  778 |  564 |  214 |
...
| `prover.rap_constraints.round0_time_ms` |  509.50 |  1,019 |  671 |  348 |
...
| `prover.openings.whir_time_ms` |  193 |  386 |  247 |  139 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/47957d6dfb8e7c107ea340db122e5d2ab6adf100/sha2_bench-47957d6dfb8e7c107ea340db122e5d2ab6adf100.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 56 |  |  |  | 291 |  |  |  |  |  |  | 
| app_proof |  |  |  | 1,582 |  | 56 | 11,167,961 | 198.49 | 0 | 3,993 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 176 | 46 | 0 | 0 | 79 | 27 | 27 | 37 | 14 | 0 | 49 | 39 | 10 | 2 | 7 | 46 | 46 | 79 | 0 | 1 | 12 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 110 | 20 | 0 | 0 | 55 | 21 | 20 | 23 | 11 | 0 | 33 | 26 | 7 | 1 | 6 | 20 | 20 | 55 | 0 | 1 | 10 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 101 | 15 | 0 | 0 | 54 | 20 | 19 | 21 | 11 | 0 | 32 | 24 | 7 | 1 | 5 | 15 | 15 | 53 | 0 | 1 | 10 | 0 | 0 | 
| leaf | 0 | prover | 237,929,144 | 403 | 145 | 0 | 0 | 141 | 71 | 69 | 44 | 26 | 0 | 116 | 94 | 21 | 10 | 11 | 145 | 145 | 141 | 0 | 3 | 25 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,280,083,194 | 2,042 | 564 | 0 | 0 | 1,135 | 671 | 670 | 231 | 232 | 1 | 341 | 247 | 94 | 57 | 36 | 564 | 564 | 1,135 | 0 | 1 | 231 | 0 | 0 | 
| app_proof | prover | 1 | 687,443,728 | 1,064 | 214 | 0 | 0 | 659 | 348 | 347 | 125 | 184 | 0 | 190 | 139 | 51 | 30 | 20 | 214 | 214 | 659 | 0 | 1 | 183 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 0 | 2 | 101 | 2,346 | 101 | 0 | 12,567,225,180 | 2,800,224,348 | 15,367,449,528 | 2,097,152 | 0 | 4 | 202 | 7,136,000 | 36.48 | 
| app_proof | 1 | 0 | 1 | 45 | 1,582 | 45 | 0 | 7,131,913,452 | 1,123,862,484 | 8,255,775,936 | 2,097,152 | 0 | 2 | 472 | 4,031,961 | 37.88 | 

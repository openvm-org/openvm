...
|:---|---:|---:|---:|
| Total |  4.96 |  3.38 |  3.38 |
| app_proof |  4.01 |  2.43 |  2.43 |
| leaf |  0.53 |  0.53 |  0.53 |
...
| `total_proof_time_ms ` |  1,972 |  3,944 |  2,358 |  1,586 |
| `compile_metered_time_ms` |  5 |  5 |  5 |  5 |
| `execute_metered_time_ms` |  70 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  159.24 | -          |  159.24 |  159.24 |
| `execute_preflight_insns` |  5,583,980.50 |  11,167,961 |  7,136,000 |  4,031,961 |
| `execute_preflight_time_ms` |  340.50 |  681 |  476 |  205 |
| `execute_preflight_insn_mi/s` |  37.89 | -          |  39.94 |  35.83 |
| `trace_gen_time_ms   ` |  73.50 |  147 |  103 |  44 |
| `set_initial_memory_time_ms` |  0 |  0 |  0 |  0 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,556.50 |  3,113 |  2,049 |  1,064 |
| `prover.main_trace_commit_time_ms` |  391.50 |  783 |  569 |  214 |
| `prover.rap_constraints_time_ms` |  897 |  1,794 |  1,137 |  657 |
| `prover.openings_time_ms` |  267 |  534 |  342 |  192 |
| `prover.rap_constraints.logup_gkr_time_ms` |  208 |  416 |  232 |  184 |
| `prover.rap_constraints.round0_time_ms` |  509.50 |  1,019 |  672 |  347 |
...
| `prover.openings.whir_time_ms` |  193.50 |  387 |  248 |  139 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/9ad0da184976b132549f70abb888ac3acf7e7ea0/sha2_bench-9ad0da184976b132549f70abb888ac3acf7e7ea0.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 55 |  |  |  | 287 |  |  |  |  |  |  | 
| app_proof |  |  |  | 1,586 |  | 70 | 11,167,961 | 159.24 | 0 | 4,022 |  | 
| internal_for_leaf |  |  | 196 |  |  |  |  |  |  |  | 196 | 
| internal_recursive.0 |  |  | 118 |  |  |  |  |  |  |  | 119 | 
...
| app_proof | VmAirWrapper<Rv64LoadAdapterAir, LoadCoreAir<8, 1> | 0 | 5 | 7 | 
...
| app_proof | VmAirWrapper<Rv64StoreAdapterAir, StoreCoreAir<8, 1> | 0 | 5 | 10 | 
...
| app_proof | VmAirWrapper<Rv64LoadAdapterAir, LoadCoreAir<8, 1> | 1 | 3 | 3 | 
...
| leaf | 0 | 121 | 527 | 121 | 34 | 12 | 2 | 9 | 9 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 175 | 46 | 0 | 0 | 78 | 27 | 27 | 37 | 13 | 0 | 49 | 39 | 10 | 2 | 7 | 47 | 46 | 78 | 0 | 1 | 12 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 107 | 20 | 0 | 0 | 56 | 21 | 20 | 23 | 11 | 0 | 30 | 22 | 7 | 1 | 6 | 20 | 20 | 56 | 0 | 1 | 10 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 99 | 15 | 0 | 0 | 54 | 20 | 19 | 21 | 12 | 0 | 29 | 22 | 7 | 1 | 5 | 15 | 15 | 54 | 0 | 1 | 10 | 0 | 0 | 
| leaf | 0 | prover | 237,929,144 | 405 | 145 | 0 | 0 | 141 | 70 | 69 | 44 | 26 | 0 | 117 | 95 | 22 | 10 | 11 | 146 | 145 | 141 | 0 | 3 | 25 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,280,083,194 | 2,049 | 568 | 0 | 0 | 1,137 | 672 | 672 | 231 | 232 | 1 | 342 | 248 | 94 | 57 | 36 | 569 | 568 | 1,137 | 0 | 1 | 231 | 0 | 0 | 
| app_proof | prover | 1 | 687,443,728 | 1,064 | 214 | 0 | 0 | 657 | 347 | 346 | 125 | 184 | 0 | 192 | 139 | 52 | 31 | 21 | 214 | 214 | 657 | 0 | 1 | 183 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 0 | 2 | 103 | 2,358 | 103 | 0 | 12,567,225,180 | 2,800,224,348 | 15,367,449,528 | 2,097,152 | 0 | 3 | 205 | 7,136,000 | 35.83 | 
| app_proof | 1 | 0 | 1 | 44 | 1,586 | 44 | 0 | 7,131,913,452 | 1,123,862,484 | 8,255,775,936 | 2,097,152 | 0 | 2 | 476 | 4,031,961 | 39.94 | 

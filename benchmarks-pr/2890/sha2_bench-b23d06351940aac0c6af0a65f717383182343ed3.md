...
|:---|---:|---:|---:|
| Total |  13.19 |  5.55 |  5.55 |
| app_proof |  10.43 |  2.80 |  2.80 |
| leaf |  1.93 |  1.93 |  1.93 |
...
| `total_proof_time_ms ` |  2,583.75 |  10,335 |  2,699 |  2,528 |
...
| `execute_preflight_time_ms` |  160 |  640 |  201 |  98 |
| `execute_preflight_insn_mi/s` |  35.31 | -          |  36.26 |  32.68 |
| `trace_gen_time_ms   ` |  58.25 |  233 |  66 |  53 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  2,299 |  9,196 |  2,398 |  2,265 |
| `prover.main_trace_commit_time_ms` |  613.75 |  2,455 |  616 |  612 |
| `prover.rap_constraints_time_ms` |  1,213.75 |  4,855 |  1,220 |  1,205 |
| `prover.openings_time_ms` |  470.50 |  1,882 |  560 |  438 |
| `prover.rap_constraints.logup_gkr_time_ms` |  307.75 |  1,231 |  309 |  307 |
| `prover.rap_constraints.round0_time_ms` |  662 |  2,648 |  666 |  656 |
| `prover.rap_constraints.mle_rounds_time_ms` |  243.25 |  973 |  246 |  240 |
| `prover.openings.stacked_reduction_time_ms` |  96.75 |  387 |  98 |  95 |
| `prover.openings.stacked_reduction.round0_time_ms` |  58.50 |  234 |  60 |  57 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  37.50 |  150 |  38 |  37 |
| `prover.openings.whir_time_ms` |  373 |  1,492 |  461 |  342 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,929 |  1,929 |  1,929 |  1,929 |
...
| `prover.openings_time_ms` |  634 |  634 |  634 |  634 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/b23d06351940aac0c6af0a65f717383182343ed3/sha2_bench-b23d06351940aac0c6af0a65f717383182343ed3.memory.svg)
...
| app_proof |  |  |  |  |  | 2,528 |  |  | 99 | 11,167,961 | 111.92 | 0 | 10,441 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 61,220,667 | 459 | 182 | 0 | 0 | 130 | 38 | 37 | 64 | 27 | 0 | 146 | 127 | 18 | 5 | 13 | 182 | 130 | 0 | 3 | 26 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,943 | 180 | 49 | 0 | 0 | 72 | 24 | 24 | 29 | 18 | 0 | 58 | 49 | 8 | 1 | 6 | 49 | 72 | 0 | 2 | 17 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 136 | 32 | 0 | 0 | 62 | 23 | 22 | 24 | 14 | 0 | 41 | 34 | 7 | 1 | 5 | 32 | 62 | 0 | 2 | 13 | 0 | 0 | 
| leaf | 0 | prover | 425,192,422 | 1,784 | 804 | 0 | 88 | 345 | 166 | 165 | 104 | 74 | 0 | 634 | 569 | 64 | 35 | 28 | 804 | 345 | 0 | 9 | 74 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 640,057,593 | 2,398 | 616 | 0 | 70 | 1,220 | 666 | 666 | 244 | 309 | 0 | 560 | 461 | 98 | 59 | 38 | 616 | 1,220 | 0 | 4 | 307 | 0 | 0 | 
| app_proof | prover | 1 | 640,057,356 | 2,265 | 612 | 0 | 0 | 1,215 | 661 | 661 | 246 | 307 | 0 | 438 | 342 | 95 | 57 | 37 | 612 | 1,215 | 0 | 4 | 306 | 0 | 0 | 
| app_proof | prover | 2 | 640,057,356 | 2,267 | 612 | 0 | 0 | 1,215 | 665 | 664 | 243 | 307 | 0 | 439 | 343 | 96 | 58 | 37 | 612 | 1,215 | 0 | 5 | 306 | 0 | 0 | 
| app_proof | prover | 3 | 640,057,588 | 2,266 | 614 | 0 | 0 | 1,205 | 656 | 656 | 240 | 308 | 0 | 445 | 346 | 98 | 60 | 38 | 615 | 1,205 | 0 | 5 | 306 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 66 | 2,699 | 66 | 136 | 5,529,436,044 | 2,165,730,336 | 7,695,166,380 | 2,097,152 | 0 | 3 | 98 | 2,851,000 | 32.68 | 
| app_proof | 1 | 57 | 2,566 | 57 | 41 | 5,529,347,520 | 2,165,557,968 | 7,694,905,488 | 2,097,152 | 0 | 1 | 201 | 2,851,000 | 36.05 | 
| app_proof | 2 | 57 | 2,542 | 57 | 41 | 5,529,349,296 | 2,165,556,192 | 7,694,905,488 | 2,097,152 | 0 | 1 | 175 | 2,851,000 | 36.26 | 
| app_proof | 3 | 53 | 2,528 | 53 | 41 | 5,077,435,956 | 2,617,472,316 | 7,694,908,272 | 2,097,152 | 0 | 1 | 166 | 2,614,961 | 36.26 | 

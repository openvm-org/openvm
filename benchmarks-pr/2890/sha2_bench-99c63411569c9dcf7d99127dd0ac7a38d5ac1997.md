...
|:---|---:|---:|---:|
| Total |  13.39 |  5.63 |  5.63 |
| app_proof |  10.60 |  2.84 |  2.84 |
| leaf |  1.96 |  1.96 |  1.96 |
...
| `total_proof_time_ms ` |  2,625.75 |  10,503 |  2,737 |  2,574 |
...
| `execute_preflight_time_ms` |  163 |  652 |  207 |  98 |
| `execute_preflight_insn_mi/s` |  35.17 | -          |  36.38 |  32.82 |
| `trace_gen_time_ms   ` |  59 |  236 |  68 |  54 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  2,338 |  9,352 |  2,434 |  2,301 |
| `prover.main_trace_commit_time_ms` |  621.75 |  2,487 |  624 |  620 |
| `prover.rap_constraints_time_ms` |  1,239.25 |  4,957 |  1,243 |  1,236 |
| `prover.openings_time_ms` |  475.75 |  1,903 |  570 |  442 |
| `prover.rap_constraints.logup_gkr_time_ms` |  310.75 |  1,243 |  311 |  310 |
| `prover.rap_constraints.round0_time_ms` |  680 |  2,720 |  685 |  675 |
| `prover.rap_constraints.mle_rounds_time_ms` |  247.25 |  989 |  251 |  243 |
...
| `prover.openings.whir_time_ms` |  375.75 |  1,503 |  468 |  343 |
...
| `prover.openings_time_ms` |  645 |  645 |  645 |  645 |
...
| `prover.openings.whir_time_ms` |  580 |  580 |  580 |  580 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/99c63411569c9dcf7d99127dd0ac7a38d5ac1997/sha2_bench-99c63411569c9dcf7d99127dd0ac7a38d5ac1997.memory.svg)
...
| app_proof |  |  |  |  |  | 2,574 |  |  | 100 | 11,167,961 | 111.45 | 0 | 10,609 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 27 | 490 | 27 | 7 | 2 | 2 | 3 | 3 | 
| internal_recursive.0 | 1 | 13 | 193 | 12 | 1 | 0 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 9 | 148 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 145 | 1,960 | 144 | 50 | 22 | 3 | 6 | 6 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 61,220,667 | 462 | 185 | 0 | 0 | 131 | 38 | 37 | 65 | 27 | 0 | 145 | 126 | 18 | 5 | 13 | 186 | 131 | 0 | 4 | 26 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,943 | 180 | 50 | 0 | 0 | 73 | 25 | 25 | 29 | 18 | 0 | 55 | 46 | 8 | 2 | 6 | 51 | 73 | 0 | 3 | 17 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 138 | 32 | 0 | 0 | 61 | 23 | 22 | 24 | 13 | 0 | 43 | 36 | 7 | 1 | 5 | 33 | 61 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 425,192,422 | 1,815 | 816 | 0 | 90 | 352 | 171 | 170 | 104 | 75 | 0 | 645 | 580 | 65 | 37 | 27 | 817 | 352 | 0 | 11 | 75 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 640,057,593 | 2,434 | 624 | 0 | 72 | 1,240 | 684 | 684 | 243 | 311 | 0 | 570 | 468 | 101 | 61 | 39 | 624 | 1,240 | 0 | 4 | 309 | 0 | 0 | 
| app_proof | prover | 1 | 640,057,356 | 2,301 | 619 | 0 | 0 | 1,238 | 676 | 676 | 251 | 310 | 0 | 442 | 343 | 99 | 59 | 39 | 620 | 1,238 | 0 | 5 | 309 | 0 | 0 | 
| app_proof | prover | 2 | 640,057,356 | 2,309 | 620 | 0 | 0 | 1,243 | 685 | 685 | 246 | 311 | 0 | 444 | 344 | 100 | 60 | 39 | 620 | 1,243 | 0 | 5 | 310 | 0 | 0 | 
| app_proof | prover | 3 | 640,057,588 | 2,308 | 623 | 0 | 0 | 1,236 | 675 | 675 | 249 | 311 | 0 | 447 | 348 | 98 | 59 | 39 | 623 | 1,236 | 0 | 5 | 310 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 68 | 2,737 | 68 | 135 | 5,529,436,044 | 2,165,730,336 | 7,695,166,380 | 2,097,152 | 0 | 4 | 98 | 2,851,000 | 32.82 | 
| app_proof | 1 | 57 | 2,607 | 57 | 41 | 5,529,347,520 | 2,165,557,968 | 7,694,905,488 | 2,097,152 | 0 | 1 | 207 | 2,851,000 | 36.34 | 
| app_proof | 2 | 57 | 2,585 | 57 | 41 | 5,529,349,296 | 2,165,556,192 | 7,694,905,488 | 2,097,152 | 0 | 1 | 177 | 2,851,000 | 36.38 | 
| app_proof | 3 | 54 | 2,574 | 54 | 41 | 5,077,435,956 | 2,617,472,316 | 7,694,908,272 | 2,097,152 | 0 | 1 | 170 | 2,614,961 | 35.15 | 

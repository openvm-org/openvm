...
|:---|---:|---:|---:|
| Total |  4.46 |  2.34 |  2.34 |
| app_proof |  3.09 |  0.98 |  0.98 |
| leaf |  0.68 |  0.68 |  0.68 |
...
| `total_proof_time_ms ` |  757.25 |  3,029 |  912 |  545 |
| `execute_metered_time_ms` |  66 | -          | -          | -          |
| `execute_metered_insns` |  12,000,265 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  180.15 | -          |  180.15 |  180.15 |
| `execute_preflight_insns` |  3,000,066.25 |  12,000,265 |  3,495,000 |  1,515,265 |
| `execute_preflight_time_ms` |  66.75 |  267 |  95 |  32 |
| `execute_preflight_insn_mi/s` |  49.03 | -          |  50.19 |  46.53 |
| `trace_gen_time_ms   ` |  160 |  640 |  192 |  116 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  484.25 |  1,937 |  579 |  300 |
| `prover.main_trace_commit_time_ms` |  99 |  396 |  112 |  60 |
| `prover.rap_constraints_time_ms` |  284.25 |  1,137 |  353 |  171 |
| `prover.openings_time_ms` |  100.25 |  401 |  113 |  68 |
| `prover.rap_constraints.logup_gkr_time_ms` |  207 |  828 |  264 |  119 |
| `prover.rap_constraints.round0_time_ms` |  52 |  208 |  61 |  34 |
| `prover.rap_constraints.mle_rounds_time_ms` |  24.25 |  97 |  27 |  17 |
...
| `prover.openings.whir_time_ms` |  80.75 |  323 |  92 |  55 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/b6f63a5ce389afc92afb17485ebe283fa9b4bf32/fibonacci-b6f63a5ce389afc92afb17485ebe283fa9b4bf32.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 72 |  |  |  | 345 |  |  |  |  |  |  | 
| app_proof |  |  |  | 545 |  | 66 | 12,000,265 | 180.15 | 0 | 3,103 |  | 
...
| app_proof | Rv32HintStoreAir | 0 | 0 | 72 | 
...
| app_proof | VmAirWrapper<Rv32BranchAdapterAir, BranchEqualCoreAir<4> | 3 | 182 | 182 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 333 | 118 | 0 | 0 | 107 | 35 | 35 | 51 | 20 | 0 | 107 | 93 | 13 | 3 | 9 | 118 | 118 | 107 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 168 | 46 | 0 | 0 | 69 | 26 | 25 | 27 | 15 | 0 | 51 | 43 | 8 | 1 | 6 | 47 | 46 | 69 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 139 | 32 | 0 | 0 | 62 | 23 | 22 | 24 | 13 | 0 | 44 | 36 | 7 | 1 | 5 | 33 | 32 | 62 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 147,934,254 | 608 | 232 | 0 | 0 | 182 | 84 | 83 | 52 | 45 | 0 | 192 | 167 | 24 | 12 | 12 | 232 | 232 | 182 | 0 | 8 | 43 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 136,618,310 | 579 | 112 | 0 | 0 | 353 | 61 | 60 | 27 | 264 | 2 | 113 | 92 | 21 | 11 | 9 | 112 | 112 | 353 | 0 | 3 | 261 | 0 | 0 | 
| app_proof | prover | 1 | 136,570,844 | 530 | 112 | 0 | 0 | 307 | 57 | 56 | 26 | 223 | 0 | 110 | 88 | 21 | 12 | 9 | 112 | 112 | 307 | 0 | 3 | 221 | 0 | 0 | 
| app_proof | prover | 2 | 136,570,844 | 528 | 112 | 0 | 0 | 306 | 56 | 56 | 27 | 222 | 0 | 110 | 88 | 21 | 12 | 9 | 112 | 112 | 306 | 0 | 3 | 221 | 0 | 0 | 
| app_proof | prover | 3 | 70,295,260 | 300 | 60 | 0 | 0 | 171 | 34 | 34 | 17 | 119 | 0 | 68 | 55 | 12 | 6 | 6 | 60 | 60 | 171 | 0 | 3 | 118 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 120 | 116 | 912 | 5 | 120 | 0 | 0 | 2 | 2,770,199,817 | 323,294,035 | 3,093,493,852 | 2,097,152 | 1 | 0 | 0 | 1 | 3 | 109 | 95 | 3,495,000 | 46.53 | 1 | 0 | 
| app_proof | 1 | 19 | 166 | 787 | 154 | 19 | 0 | 0 | 5 | 2,768,863,045 | 322,353,750 | 3,091,216,795 | 2,097,152 | 1 | 0 | 0 | 0 | 2 | 7 | 70 | 3,495,000 | 50.15 | 151 | 0 | 
| app_proof | 2 | 19 | 166 | 785 | 154 | 19 | 0 | 0 | 5 | 2,768,863,045 | 322,353,750 | 3,091,216,795 | 2,097,152 | 1 | 0 | 0 | 0 | 2 | 6 | 70 | 3,495,000 | 50.19 | 151 | 0 | 
| app_proof | 3 | 19 | 192 | 545 | 8 | 19 | 0 | 0 | 1 | 1,230,958,923 | 342,872,922 | 1,573,831,845 | 2,097,152 | 1 | 0 | 0 | 0 | 2 | 183 | 32 | 1,515,265 | 49.24 | 5 | 0 | 

...
|:---|---:|---:|---:|
| Total |  6.09 |  6.09 |  6.09 |
| app_proof |  4.54 |  4.54 |  4.54 |
| leaf |  0.88 |  0.88 |  0.88 |
...
| `total_proof_time_ms ` |  4,505 |  4,505 |  4,505 |  4,505 |
| `execute_metered_time_ms` |  36 | -          | -          | -          |
| `execute_metered_insns` |  2,579,903 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  70.57 | -          |  70.57 |  70.57 |
...
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  4,117 |  4,117 |  4,117 |  4,117 |
| `prover.main_trace_commit_time_ms` |  1,606 |  1,606 |  1,606 |  1,606 |
| `prover.rap_constraints_time_ms` |  1,707 |  1,707 |  1,707 |  1,707 |
| `prover.openings_time_ms` |  802 |  802 |  802 |  802 |
...
| `prover.openings_time_ms` |  215 |  215 |  215 |  215 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/b6f63a5ce389afc92afb17485ebe283fa9b4bf32/kitchen_sink-b6f63a5ce389afc92afb17485ebe283fa9b4bf32.memory.svg)
...
| generate mem proving ctxs | 5.40 | app_proof.0 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 71 |  |  |  | 370 |  |  |  |  |  |  | 
| app_proof |  |  |  | 4,505 |  | 36 | 2,579,903 | 70.57 | 0 | 4,546 |  | 
...
| --- | --- | --- | --- | --- |
| app_proof | BitwiseOperationLookupAir<8> | 0 |  | 4 | 
| app_proof | KeccakfOpAir | 0 |  | 2 | 
| app_proof | KeccakfPermAir | 0 |  | 0 | 
| app_proof | PhantomAir | 0 |  | 0 | 
| app_proof | Poseidon2PeripheryAir<BabyBearParameters>, 1> | 0 |  | 33 | 
...
| app_proof | VmAirWrapper<Rv32BaseAluAdapterAir, BaseAluCoreAir<4, 8> | 0 | 4 | 9 | 
...
| app_proof | VmAirWrapper<Rv32LoadStoreAdapterAir, LoadStoreCoreAir<4> | 0 | 6 | 17 | 
...
| app_proof | VmAirWrapper<Rv32VecHeapAdapterAir<1, 24, 24, 4, 4>, FieldExpressionCoreAir> | 0 |  | 73 | 
...
| app_proof | VmAirWrapper<Rv32VecHeapAdapterAir<2, 8, 8, 4, 4>, 2, 8, 8, 4, 32, 32>, ShiftCoreAir<32, 8> | 0 |  | 0 | 
...
| app_proof | VmAirWrapper<Rv32VecHeapBranchAdapterAir<2, 8, 4>, 2, 8, 4, 32>, BranchLessThanCoreAir<32, 8> | 0 |  | 0 | 
| app_proof | XorinVmAir | 0 |  | 2 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,577,981 | 323 | 116 | 0 | 0 | 108 | 36 | 35 | 51 | 20 | 0 | 97 | 83 | 13 | 3 | 9 | 117 | 116 | 108 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 173 | 47 | 0 | 0 | 67 | 24 | 24 | 28 | 14 | 0 | 58 | 49 | 8 | 1 | 6 | 47 | 47 | 67 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 137 | 31 | 0 | 0 | 62 | 23 | 22 | 25 | 14 | 0 | 42 | 35 | 7 | 1 | 5 | 32 | 31 | 62 | 0 | 3 | 13 | 0 | 0 | 
| leaf | 0 | prover | 170,433,085 | 767 | 254 | 0 | 0 | 297 | 106 | 105 | 59 | 131 | 0 | 215 | 187 | 27 | 14 | 13 | 255 | 254 | 297 | 0 | 8 | 130 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,121,338,980 | 4,117 | 1,606 | 0 | 0 | 1,707 | 1,033 | 1,032 | 381 | 292 | 1 | 802 | 613 | 188 | 107 | 81 | 1,606 | 1,606 | 1,707 | 0 | 4 | 290 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 119 | 171 | 4,505 | 4 | 119 | 0 | 0 | 39 | 10,592,943,552 | 2,968,407,792 | 13,561,351,344 | 2,097,152 | 2 | 0 | 0 | 1 | 3 | 127 | 96 | 2,579,903 | 34.05 | 0 | 0 | 

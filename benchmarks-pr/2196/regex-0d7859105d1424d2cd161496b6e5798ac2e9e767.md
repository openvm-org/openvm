...
| `total_proof_time_ms ` |  591 |  2,364 |  748 |  533 |
...
| `execute_metered_insn_mi/s` |  122.21 | -          |  122.21 |  122.21 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  56 |  224 |  69 |  47 |
| `execute_preflight_insn_mi/s` |  29.62 | -          |  30.89 |  27.57 |
| `trace_gen_time_ms   ` |  175.75 |  703 |  211 |  151 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  291.50 |  1,166 |  345 |  264 |
| `main_trace_commit_time_ms` |  51.75 |  207 |  57 |  49 |
| `generate_perm_trace_time_ms` |  34.75 |  139 |  55 |  19 |
| `perm_trace_commit_time_ms` |  63.39 |  253.57 |  69.19 |  55.43 |
| `quotient_poly_compute_time_ms` |  58.38 |  233.52 |  69.45 |  52.10 |
| `quotient_poly_commit_time_ms` |  14.97 |  59.87 |  17.83 |  12.84 |
| `pcs_opening_time_ms ` |  65 |  260 |  84 |  52 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 533 | 41 | 1 | 33 | 4,137,502 | 122.21 | 167 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 211 | 748 | 23,446,148 | 150,778,428 | 211 | 345 | 0 | 59.17 | 17.83 | 5 | 69.19 | 84 | 125 | 84 | 4 | 57 | 10,899,170 | 55 | 47 | 1,103,000 | 27.57 | 21 | 77 | 1 | 84 | 
| regex_program | 1 | 151 | 545 | 11,598,276 | 128,513,066 | 151 | 283 | 1 | 52.10 | 14.48 | 4 | 64.29 | 62 | 103 | 62 | 0 | 49 | 2,196,106 | 38 | 69 | 1,104,000 | 30.12 | 16 | 67 | 0 | 62 | 
| regex_program | 2 | 161 | 538 | 11,579,064 | 128,513,066 | 161 | 274 | 1 | 52.80 | 14.71 | 4 | 64.66 | 62 | 92 | 62 | 0 | 51 | 2,177,334 | 27 | 61 | 1,104,000 | 29.91 | 16 | 68 | 0 | 62 | 
| regex_program | 3 | 180 | 533 | 11,853,872 | 103,456,394 | 180 | 264 | 0 | 69.45 | 12.84 | 5 | 55.43 | 52 | 78 | 51 | 0 | 50 | 2,422,606 | 19 | 47 | 826,502 | 30.89 | 19 | 83 | 1 | 51 | 
...
Commit: https://github.com/openvm-org/openvm/commit/0d7859105d1424d2cd161496b6e5798ac2e9e767
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19050586152)

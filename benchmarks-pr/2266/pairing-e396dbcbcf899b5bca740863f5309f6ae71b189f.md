...
|:---|---:|---:|
| Total | <span style='color: red'>(+0 [+2.7%])</span> 1.57 | <span style='color: green'>(-0 [-1.1%])</span> 0.90 |
| pairing | <span style='color: red'>(+0 [+2.8%])</span> 1.48 | <span style='color: green'>(-0 [-1.3%])</span> 0.81 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+20 [+2.8%])</span> 742 | <span style='color: red'>(+40 [+2.8%])</span> 1,484 | <span style='color: green'>(-11 [-1.3%])</span> 813 | <span style='color: red'>(+51 [+8.2%])</span> 671 |
...
| `execute_metered_insn_mi/s` | <span style='color: green'>(-0 [-0.3%])</span> 19.14 | -          | <span style='color: green'>(-0 [-0.3%])</span> 19.14 | <span style='color: green'>(-0 [-0.3%])</span> 19.14 |
| `execute_preflight_insns` |  872,871 |  1,745,742 |  1,157,000 |  588,742 |
| `execute_preflight_time_ms` | <span style='color: red'>(+0 [+0.5%])</span> 95 | <span style='color: red'>(+1 [+0.5%])</span> 190 |  130 | <span style='color: red'>(+1 [+1.7%])</span> 60 |
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+0 [+0.6%])</span> 13.51 | -          | <span style='color: red'>(+0 [+0.8%])</span> 17.88 | <span style='color: red'>(+0 [+0.2%])</span> 9.15 |
| `trace_gen_time_ms   ` | <span style='color: green'>(-6 [-3.6%])</span> 175.50 | <span style='color: green'>(-13 [-3.6%])</span> 351 | <span style='color: green'>(-7 [-3.5%])</span> 192 | <span style='color: green'>(-6 [-3.6%])</span> 159 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+26 [+7.5%])</span> 378.50 | <span style='color: red'>(+53 [+7.5%])</span> 757 | <span style='color: green'>(-4 [-1.0%])</span> 380 | <span style='color: red'>(+57 [+17.8%])</span> 377 |
| `main_trace_commit_time_ms` | <span style='color: green'>(-1 [-1.5%])</span> 64 | <span style='color: green'>(-2 [-1.5%])</span> 128 |  75 | <span style='color: green'>(-2 [-3.6%])</span> 53 |
| `generate_perm_trace_time_ms` | <span style='color: red'>(+11 [+25.0%])</span> 55 | <span style='color: red'>(+22 [+25.0%])</span> 110 | <span style='color: red'>(+23 [+47.9%])</span> 71 | <span style='color: green'>(-1 [-2.5%])</span> 39 |
| `perm_trace_commit_time_ms` | <span style='color: green'>(-1 [-1.8%])</span> 75.17 | <span style='color: green'>(-3 [-1.8%])</span> 150.35 | <span style='color: green'>(-4 [-4.8%])</span> 85.29 | <span style='color: red'>(+2 [+2.6%])</span> 65.06 |
| `quotient_poly_compute_time_ms` | <span style='color: green'>(-1 [-0.8%])</span> 77.72 | <span style='color: green'>(-1 [-0.8%])</span> 155.45 | <span style='color: green'>(-4 [-4.1%])</span> 84.53 | <span style='color: red'>(+2 [+3.5%])</span> 70.92 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+0 [+1.5%])</span> 16.54 | <span style='color: red'>(+0 [+1.5%])</span> 33.08 | <span style='color: red'>(+0 [+0.2%])</span> 18.35 | <span style='color: red'>(+0 [+3.1%])</span> 14.73 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+20 [+29.5%])</span> 85.50 | <span style='color: red'>(+39 [+29.5%])</span> 171 | <span style='color: red'>(+30 [+44.8%])</span> 97 | <span style='color: red'>(+9 [+13.8%])</span> 74 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 671 | 1 | 91 | 1,745,742 | 19.14 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 159 | 813 | 32,689,110 | 172,558,444 | 159 | 380 | 0 | 84.53 | 18.35 | 7 | 85.29 | 74 | 127 | 73 | 1 | 75 | 16,059,916 | 39 | 130 | 1,157,000 | 9.15 | 26 | 103 | 1 | 73 | 
| pairing | 1 | 192 | 671 | 22,314,288 | 119,958,502 | 192 | 377 | 1 | 70.92 | 14.73 | 6 | 65.06 | 97 | 139 | 97 | 0 | 53 | 9,408,294 | 71 | 60 | 588,742 | 17.88 | 20 | 86 | 1 | 97 | 

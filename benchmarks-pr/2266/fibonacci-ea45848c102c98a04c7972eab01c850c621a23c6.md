...
| `execute_metered_insn_mi/s` | <span style='color: green'>(-6 [-5.5%])</span> 108.98 | -          | <span style='color: green'>(-6 [-5.5%])</span> 108.98 | <span style='color: green'>(-6 [-5.5%])</span> 108.98 |
...
| `execute_preflight_insn_mi/s` |  36.68 | -          |  38.64 | <span style='color: green'>(-0 [-0.2%])</span> 34.72 |
| `trace_gen_time_ms   ` |  191 |  382 |  196 |  186 |
| `memory_finalize_time_ms` | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: green'>(-3 [-1.7%])</span> 174 | <span style='color: green'>(-6 [-1.7%])</span> 348 | <span style='color: green'>(-4 [-2.1%])</span> 184 | <span style='color: green'>(-2 [-1.2%])</span> 164 |
| `main_trace_commit_time_ms` |  30.50 |  61 |  33 |  28 |
| `generate_perm_trace_time_ms` | <span style='color: green'>(-2 [-10.7%])</span> 12.50 | <span style='color: green'>(-3 [-10.7%])</span> 25 | <span style='color: green'>(-3 [-18.8%])</span> 13 |  12 |
| `perm_trace_commit_time_ms` | <span style='color: green'>(-0 [-0.2%])</span> 42.18 | <span style='color: green'>(-0 [-0.2%])</span> 84.37 | <span style='color: green'>(-0 [-0.8%])</span> 45.19 | <span style='color: red'>(+0 [+0.4%])</span> 39.18 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+0 [+1.1%])</span> 32.94 | <span style='color: red'>(+1 [+1.1%])</span> 65.89 | <span style='color: red'>(+1 [+2.1%])</span> 35.26 |  30.63 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+0 [+0.9%])</span> 12.31 | <span style='color: red'>(+0 [+0.9%])</span> 24.61 | <span style='color: red'>(+0 [+0.3%])</span> 12.34 | <span style='color: red'>(+0 [+1.6%])</span> 12.27 |
...
| --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 424 | 1 | 13 | 1,500,209 | 108.98 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 196 | 548 | 9,677,708 | 84,395,212 | 196 | 184 | 0 | 35.26 | 12.34 | 4 | 45.19 | 43 | 59 | 43 | 0 | 33 | 1,035,986 | 13 | 26 | 873,000 | 34.72 | 14 | 48 | 0 | 43 | 
| fibonacci_program | 1 | 186 | 424 | 9,708,170 | 74,305,770 | 186 | 164 | 1 | 30.63 | 12.27 | 4 | 39.18 | 39 | 52 | 39 | 0 | 28 | 1,064,416 | 12 | 33 | 627,209 | 38.64 | 11 | 43 | 0 | 39 | 

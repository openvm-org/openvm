...
| `total_proof_time_ms ` |  511.50 |  1,023 |  584 |  439 |
| `execute_metered_time_ms` |  9 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  162.61 | -          |  162.61 |  162.61 |
| `execute_preflight_insns` |  750,132.50 |  1,500,265 |  873,000 |  627,265 |
| `execute_preflight_time_ms` |  28 |  56 |  33 |  23 |
| `execute_preflight_insn_mi/s` |  36.60 | -          |  37.07 |  36.13 |
| `trace_gen_time_ms   ` |  193 |  386 |  196 |  190 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  185 |  370 |  191 |  179 |
| `main_trace_commit_time_ms` |  30.50 |  61 |  33 |  28 |
| `generate_perm_trace_time_ms` |  21.50 |  43 |  28 |  15 |
| `perm_trace_commit_time_ms` |  41.65 |  83.30 |  45.42 |  37.88 |
| `quotient_poly_compute_time_ms` |  32.16 |  64.32 |  36.10 |  28.22 |
| `quotient_poly_commit_time_ms` |  12.68 |  25.36 |  12.79 |  12.57 |
...
| --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 439 | 1 | 9 | 1,500,265 | 162.61 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 190 | 584 | 84,399,632 | 190 | 191 | 0 | 36.10 | 12.79 | 4 | 45.42 | 46 | 61 | 46 | 0 | 33 | 15 | 33 | 873,000 | 37.07 | 14 | 49 | 0 | 46 | 
| fibonacci_program | 1 | 196 | 439 | 74,305,770 | 196 | 179 | 1 | 28.22 | 12.57 | 4 | 37.88 | 42 | 66 | 42 | 0 | 28 | 28 | 23 | 627,265 | 36.13 | 11 | 41 | 0 | 42 | 

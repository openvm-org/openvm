...
| `total_proof_time_ms ` |  522.50 |  1,045 |  584 |  461 |
| `execute_metered_time_ms` |  9 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  161.44 | -          |  161.44 |  161.44 |
| `execute_preflight_insns` |  750,132.50 |  1,500,265 |  873,000 |  627,265 |
| `execute_preflight_time_ms` |  30 |  60 |  36 |  24 |
| `execute_preflight_insn_mi/s` |  34.99 | -          |  35.28 |  34.69 |
| `trace_gen_time_ms   ` |  189.50 |  379 |  196 |  183 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  193 |  386 |  200 |  186 |
| `main_trace_commit_time_ms` |  30.50 |  61 |  33 |  28 |
| `generate_perm_trace_time_ms` |  23 |  46 |  30 |  16 |
| `perm_trace_commit_time_ms` |  41.72 |  83.45 |  44.95 |  38.50 |
| `quotient_poly_compute_time_ms` |  29.41 |  58.82 |  31.25 |  27.57 |
| `quotient_poly_commit_time_ms` |  11.84 |  23.68 |  12.10 |  11.59 |
| `pcs_opening_time_ms ` |  54 |  108 |  61 |  47 |
...
| --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 461 | 1 | 9 | 1,500,265 | 161.44 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 183 | 584 | 84,399,632 | 183 | 186 | 0 | 31.25 | 11.59 | 4 | 44.95 | 47 | 61 | 47 | 0 | 33 | 16 | 36 | 873,000 | 34.69 | 14 | 43 | 0 | 47 | 
| fibonacci_program | 1 | 196 | 461 | 74,305,770 | 196 | 200 | 1 | 27.57 | 12.10 | 4 | 38.50 | 61 | 69 | 61 | 0 | 28 | 30 | 24 | 627,265 | 35.28 | 11 | 40 | 0 | 61 | 

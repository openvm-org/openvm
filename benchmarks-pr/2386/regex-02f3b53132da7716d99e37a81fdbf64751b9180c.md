...
|:---|---:|---:|---:|
| Total |  2.48 |  0.77 | 0.77 |
| regex_program |  2.48 |  0.77 |  0.77 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  610.25 |  2,441 |  732 |  514 |
...
| `execute_preflight_insn_mi/s` |  31.57 | -          |  31.95 |  30.89 |
| `trace_gen_time_ms   ` |  179.25 |  717 |  199 |  169 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  311 |  1,244 |  385 |  252 |
| `main_trace_commit_time_ms` |  51.75 |  207 |  58 |  49 |
| `generate_perm_trace_time_ms` |  32.50 |  130 |  48 |  17 |
| `perm_trace_commit_time_ms` |  63.79 |  255.17 |  69.90 |  55.40 |
| `quotient_poly_compute_time_ms` |  61.10 |  244.42 |  72.98 |  53.82 |
| `quotient_poly_commit_time_ms` |  15.72 |  62.88 |  17.81 |  13.95 |
| `pcs_opening_time_ms ` |  82.25 |  329 |  144 |  49 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 660 | 1 | 35 | 4,137,727 | 115.35 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 169 | 732 | 150,778,428 | 169 | 334 | 0 | 62.12 | 17.81 | 5 | 69.90 | 75 | 119 | 75 | 4 | 58 | 48 | 58 | 1,103,000 | 30.89 | 21 | 80 | 1 | 75 | 
| regex_program | 1 | 175 | 514 | 128,513,066 | 175 | 252 | 1 | 53.82 | 15.22 | 4 | 65.26 | 49 | 83 | 49 | 0 | 49 | 17 | 46 | 1,104,000 | 31.60 | 17 | 69 | 0 | 48 | 
| regex_program | 2 | 174 | 535 | 128,513,066 | 174 | 273 | 1 | 55.50 | 15.90 | 4 | 64.62 | 61 | 88 | 61 | 0 | 50 | 23 | 46 | 1,104,000 | 31.95 | 17 | 71 | 0 | 61 | 
| regex_program | 3 | 199 | 660 | 103,475,717 | 199 | 385 | 0 | 72.98 | 13.95 | 5 | 55.40 | 144 | 101 | 144 | 0 | 50 | 42 | 35 | 826,727 | 31.85 | 20 | 87 | 1 | 144 | 

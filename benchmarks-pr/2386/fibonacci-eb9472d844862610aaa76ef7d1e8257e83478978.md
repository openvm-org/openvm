...
| `total_proof_time_ms ` |  508 |  1,016 |  578 |  438 |
| `execute_metered_time_ms` |  9 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  163.29 | -          |  163.29 |  163.29 |
| `execute_preflight_insns` |  750,132.50 |  1,500,265 |  873,000 |  627,265 |
| `execute_preflight_time_ms` |  27.50 |  55 |  33 |  22 |
| `execute_preflight_insn_mi/s` |  37.62 | -          |  38.10 |  37.14 |
| `trace_gen_time_ms   ` |  191.50 |  383 |  195 |  188 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  182.50 |  365 |  186 |  179 |
| `main_trace_commit_time_ms` |  30.50 |  61 |  33 |  28 |
| `generate_perm_trace_time_ms` |  20 |  40 |  27 |  13 |
| `perm_trace_commit_time_ms` |  41.17 |  82.33 |  44.67 |  37.66 |
| `quotient_poly_compute_time_ms` |  31.90 |  63.80 |  33.30 |  30.50 |
| `quotient_poly_commit_time_ms` |  12.84 |  25.69 |  13.29 |  12.40 |
...
| --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 438 | 1 | 9 | 1,500,265 | 163.29 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 188 | 578 | 84,399,632 | 188 | 186 | 0 | 33.30 | 13.29 | 4 | 44.67 | 47 | 58 | 46 | 0 | 33 | 13 | 33 | 873,000 | 38.10 | 14 | 47 | 0 | 46 | 
| fibonacci_program | 1 | 195 | 438 | 74,305,770 | 195 | 179 | 1 | 30.50 | 12.40 | 4 | 37.66 | 41 | 65 | 41 | 0 | 28 | 27 | 22 | 627,265 | 37.14 | 11 | 43 | 0 | 41 | 

...
| `total_proof_time_ms ` |  581.75 |  2,327 |  694 |  520 |
| `execute_metered_time_ms` |  35 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  115.44 | -          |  115.44 |  115.44 |
| `execute_preflight_insns` |  1,034,501 |  4,138,004 |  1,104,000 |  827,004 |
| `execute_preflight_time_ms` |  45.25 |  181 |  56 |  34 |
| `execute_preflight_insn_mi/s` |  31.45 | -          |  31.88 |  30.77 |
| `trace_gen_time_ms   ` |  179.50 |  718 |  199 |  172 |
| `memory_finalize_time_ms` |  0.75 |  3 |  3 |  0 |
| `stark_prove_excluding_trace_time_ms` |  283.50 |  1,134 |  298 |  259 |
| `main_trace_commit_time_ms` |  51.75 |  207 |  56 |  49 |
| `generate_perm_trace_time_ms` |  31 |  124 |  39 |  22 |
| `perm_trace_commit_time_ms` |  65.08 |  260.31 |  72.62 |  56.21 |
| `quotient_poly_compute_time_ms` |  60.10 |  240.39 |  71.12 |  53.93 |
| `quotient_poly_commit_time_ms` |  15.73 |  62.94 |  18.51 |  13.17 |
| `pcs_opening_time_ms ` |  56 |  224 |  62 |  48 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 568 | 1 | 35 | 4,138,004 | 115.44 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 172 | 694 | 150,778,428 | 172 | 298 | 0 | 60.77 | 18.51 | 5 | 72.62 | 62 | 98 | 62 | 3 | 56 | 25 | 56 | 1,103,000 | 30.77 | 22 | 79 | 1 | 62 | 
| regex_program | 1 | 174 | 545 | 128,513,066 | 174 | 284 | 1 | 54.58 | 14.98 | 4 | 64.35 | 59 | 103 | 59 | 0 | 50 | 38 | 46 | 1,104,000 | 31.60 | 16 | 70 | 0 | 59 | 
| regex_program | 2 | 173 | 520 | 128,513,066 | 173 | 259 | 1 | 53.93 | 16.27 | 5 | 67.12 | 48 | 90 | 48 | 0 | 49 | 22 | 45 | 1,104,000 | 31.88 | 17 | 70 | 0 | 48 | 
| regex_program | 3 | 199 | 568 | 103,475,717 | 199 | 293 | 0 | 71.12 | 13.17 | 5 | 56.21 | 55 | 99 | 55 | 0 | 52 | 39 | 34 | 827,004 | 31.54 | 20 | 85 | 1 | 55 | 

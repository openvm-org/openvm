...
| `total_proof_time_ms ` |  737.50 |  1,475 |  875 |  600 |
...
| `execute_preflight_insn_mi/s` |  14.47 | -          |  17.89 |  11.04 |
| `trace_gen_time_ms   ` |  182 |  364 |  202 |  162 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  364 |  728 |  420 |  308 |
| `main_trace_commit_time_ms` |  64.50 |  129 |  75 |  54 |
| `generate_perm_trace_time_ms` |  39 |  78 |  45 |  33 |
| `perm_trace_commit_time_ms` |  76.91 |  153.82 |  89.56 |  64.26 |
| `quotient_poly_compute_time_ms` |  83.66 |  167.32 |  91.57 |  75.75 |
| `quotient_poly_commit_time_ms` |  17.26 |  34.53 |  19.60 |  14.93 |
| `pcs_opening_time_ms ` |  78 |  156 |  95 |  61 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 600 | 1 | 67 | 1,745,757 | 25.96 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 162 | 875 | 172,558,444 | 162 | 420 | 0 | 91.57 | 19.60 | 6 | 89.56 | 95 | 138 | 94 | 1 | 75 | 45 | 123 | 1,151,000 | 11.04 | 27 | 112 | 1 | 94 | 
| pairing | 1 | 202 | 600 | 119,958,502 | 202 | 308 | 1 | 75.75 | 14.93 | 6 | 64.26 | 61 | 100 | 61 | 0 | 54 | 33 | 48 | 594,757 | 17.89 | 21 | 91 | 1 | 61 | 

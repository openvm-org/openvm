...
|:---|---:|---:|---:|
| Total |  1.53 |  0.94 | 0.94 |
| pairing |  1.53 |  0.94 |  0.94 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  732.50 |  1,465 |  869 |  596 |
...
| `execute_preflight_insn_mi/s` |  14.45 | -          |  18.01 |  10.89 |
| `trace_gen_time_ms   ` |  183 |  366 |  203 |  163 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  357.50 |  715 |  412 |  303 |
| `main_trace_commit_time_ms` |  65 |  130 |  76 |  54 |
| `generate_perm_trace_time_ms` |  43.50 |  87 |  54 |  33 |
| `perm_trace_commit_time_ms` |  78.07 |  156.15 |  90.97 |  65.18 |
| `quotient_poly_compute_time_ms` |  85.44 |  170.87 |  95.42 |  75.45 |
| `quotient_poly_commit_time_ms` |  18.10 |  36.21 |  20.44 |  15.76 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 596 | 1 | 67 | 1,745,757 | 25.78 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 163 | 869 | 172,558,444 | 163 | 412 | 0 | 95.42 | 20.44 | 6 | 90.97 | 71 | 147 | 71 | 1 | 76 | 54 | 124 | 1,151,000 | 10.89 | 27 | 116 | 1 | 71 | 
| pairing | 1 | 203 | 596 | 119,958,502 | 203 | 303 | 1 | 75.45 | 15.76 | 6 | 65.18 | 55 | 101 | 55 | 0 | 54 | 33 | 48 | 594,757 | 18.01 | 21 | 91 | 1 | 55 | 

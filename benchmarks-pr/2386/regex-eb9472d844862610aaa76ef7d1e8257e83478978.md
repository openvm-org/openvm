...
|:---|---:|---:|---:|
| Total |  2.38 |  0.72 | 0.72 |
| regex_program |  2.38 |  0.72 |  0.72 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  585 |  2,340 |  686 |  527 |
...
| `execute_preflight_insn_mi/s` |  31.45 | -          |  32.06 |  29.84 |
| `trace_gen_time_ms   ` |  177 |  708 |  197 |  167 |
| `memory_finalize_time_ms` |  0.75 |  3 |  3 |  0 |
| `stark_prove_excluding_trace_time_ms` |  289 |  1,156 |  320 |  268 |
| `main_trace_commit_time_ms` |  51.25 |  205 |  56 |  49 |
| `generate_perm_trace_time_ms` |  44.50 |  178 |  86 |  25 |
| `perm_trace_commit_time_ms` |  63.04 |  252.18 |  67.87 |  55.82 |
| `quotient_poly_compute_time_ms` |  57.54 |  230.15 |  70.09 |  52.96 |
| `quotient_poly_commit_time_ms` |  15.41 |  61.63 |  17.32 |  13.70 |
| `pcs_opening_time_ms ` |  54 |  216 |  60 |  48 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 548 | 1 | 36 | 4,137,727 | 112.86 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 167 | 686 | 150,778,428 | 167 | 292 | 0 | 52.96 | 17.32 | 5 | 67.87 | 60 | 105 | 60 | 3 | 56 | 36 | 57 | 1,103,000 | 29.84 | 22 | 70 | 1 | 60 | 
| regex_program | 1 | 172 | 579 | 128,513,066 | 172 | 320 | 1 | 53.13 | 15.58 | 4 | 64.69 | 48 | 152 | 48 | 0 | 50 | 86 | 45 | 1,104,000 | 32.01 | 16 | 69 | 0 | 48 | 
| regex_program | 2 | 172 | 527 | 128,513,066 | 172 | 268 | 1 | 53.98 | 15.04 | 5 | 63.80 | 53 | 95 | 53 | 0 | 49 | 31 | 45 | 1,104,000 | 31.90 | 16 | 69 | 0 | 53 | 
| regex_program | 3 | 197 | 548 | 103,475,717 | 197 | 276 | 0 | 70.09 | 13.70 | 5 | 55.82 | 55 | 85 | 55 | 0 | 50 | 25 | 34 | 826,727 | 32.06 | 20 | 84 | 1 | 55 | 

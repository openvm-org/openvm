...
| `total_proof_time_ms ` |  2,607.17 |  15,643 |  2,977 |  2,517 |
...
| `execute_preflight_time_ms` |  174.67 |  1,048 |  260 |  15 |
| `execute_preflight_insn_mi/s` |  19.28 | -          |  19.43 |  18.99 |
| `trace_gen_time_ms   ` |  390 |  2,340 |  539 |  350 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,978.83 |  11,873 |  2,251 |  1,920 |
| `prover.main_trace_commit_time_ms` |  688.33 |  4,130 |  850 |  656 |
| `prover.rap_constraints_time_ms` |  1,109.33 |  6,656 |  1,221 |  1,082 |
| `prover.openings_time_ms` |  180.50 |  1,083 |  186 |  177 |
| `prover.rap_constraints.logup_gkr_time_ms` |  275.50 |  1,653 |  385 |  253 |
| `prover.rap_constraints.round0_time_ms` |  519.50 |  3,117 |  522 |  516 |
| `prover.rap_constraints.mle_rounds_time_ms` |  312.67 |  1,876 |  316 |  311 |
| `prover.openings.stacked_reduction_time_ms` |  138.17 |  829 |  141 |  137 |
...
| `prover.openings.whir_time_ms` |  41.83 |  251 |  44 |  40 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,096 |  2,192 |  1,421 |  771 |
| `execute_preflight_time_ms` |  4.50 |  9 |  5 |  4 |
| `trace_gen_time_ms   ` |  137 |  274 |  184 |  90 |
| `generate_blob_total_time_ms` |  25.50 |  51 |  34 |  17 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  958.50 |  1,917 |  1,236 |  681 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/238ff0754aefca31855d91381e7e332da39fe402/keccak-238ff0754aefca31855d91381e7e332da39fe402.memory.svg)
...
| app_proof |  |  |  |  |  | 2,533 |  |  | 36 | 1,235,218 | 33.49 | 0 | 15,686 |  | 
...
| app_proof | VmAirWrapper<Rv32RdWriteAdapterAir, Rv32AuipcCoreAir> | 0 | 344 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 39 | 518 | 39 | 13 | 4 | 2 | 2 | 2 | 
| internal_recursive.0 | 1 | 12 | 184 | 12 | 2 | 1 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 9 | 150 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 184 | 1,421 | 184 | 65 | 34 | 5 | 7 | 7 | 
| leaf | 1 | 90 | 771 | 89 | 32 | 17 | 4 | 7 | 7 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 109,497,984 | 478 | 246 | 0 | 14 | 172 | 45 | 45 | 93 | 33 | 0 | 59 | 20 | 38 | 7 | 31 | 246 | 172 | 0 | 3 | 32 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 25,962,119 | 171 | 51 | 0 | 4 | 75 | 23 | 23 | 29 | 22 | 0 | 44 | 20 | 24 | 1 | 22 | 51 | 75 | 0 | 2 | 21 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 17,507,975 | 141 | 33 | 0 | 3 | 63 | 22 | 21 | 24 | 17 | 0 | 43 | 20 | 22 | 1 | 21 | 34 | 63 | 0 | 2 | 16 | 0 | 0 | 
| leaf | 0 | prover | 583,523,386 | 1,236 | 713 | 0 | 47 | 396 | 192 | 191 | 122 | 81 | 0 | 125 | 39 | 85 | 40 | 45 | 714 | 396 | 0 | 6 | 80 | 0 | 0 | 
| leaf | 1 | prover | 300,618,208 | 681 | 372 | 0 | 24 | 222 | 103 | 102 | 67 | 51 | 0 | 86 | 33 | 52 | 20 | 32 | 373 | 222 | 0 | 5 | 49 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,205,061,845 | 2,251 | 850 | 0 | 245 | 1,221 | 519 | 519 | 316 | 385 | 130 | 180 | 40 | 139 | 83 | 56 | 850 | 1,221 | 0 | 3 | 253 | 0 | 0 | 
| app_proof | prover | 1 | 1,205,053,652 | 1,920 | 656 | 0 | 51 | 1,082 | 516 | 515 | 312 | 253 | 0 | 181 | 44 | 137 | 83 | 53 | 656 | 1,082 | 0 | 3 | 252 | 0 | 0 | 
| app_proof | prover | 2 | 1,205,053,652 | 1,920 | 655 | 0 | 51 | 1,085 | 519 | 519 | 311 | 253 | 0 | 179 | 41 | 137 | 84 | 53 | 656 | 1,085 | 0 | 3 | 252 | 0 | 0 | 
| app_proof | prover | 3 | 1,205,053,652 | 1,920 | 656 | 0 | 51 | 1,086 | 519 | 519 | 311 | 254 | 0 | 177 | 40 | 137 | 84 | 53 | 656 | 1,086 | 0 | 3 | 252 | 0 | 0 | 
| app_proof | prover | 4 | 1,205,053,652 | 1,927 | 656 | 0 | 51 | 1,090 | 522 | 522 | 313 | 253 | 0 | 180 | 42 | 138 | 84 | 54 | 656 | 1,090 | 0 | 3 | 252 | 0 | 0 | 
| app_proof | prover | 5 | 1,205,062,652 | 1,935 | 656 | 0 | 52 | 1,092 | 522 | 522 | 313 | 255 | 0 | 186 | 44 | 141 | 85 | 56 | 656 | 1,092 | 0 | 3 | 253 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 539 | 2,977 | 539 | 170 | 0 | 189 | 15 | 207,000 | 18.99 | 
| app_proof | 1 | 350 | 2,573 | 350 | 41 | 0 | 1 | 260 | 207,000 | 19.32 | 
| app_proof | 2 | 356 | 2,518 | 356 | 41 | 0 | 6 | 200 | 207,000 | 19.28 | 
| app_proof | 3 | 355 | 2,517 | 355 | 41 | 0 | 6 | 200 | 207,000 | 19.40 | 
| app_proof | 4 | 356 | 2,525 | 356 | 41 | 0 | 6 | 200 | 207,000 | 19.28 | 
| app_proof | 5 | 384 | 2,533 | 384 | 41 | 0 | 35 | 173 | 200,218 | 19.43 | 

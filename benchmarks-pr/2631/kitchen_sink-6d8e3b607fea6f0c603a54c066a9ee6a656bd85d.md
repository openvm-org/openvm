...
| `total_proof_time_ms ` |  1,141 |  2,282 |  1,819 |  463 |
| `execute_metered_time_ms` |  34 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  75.40 | -          |  75.40 |  75.40 |
| `execute_preflight_insns` |  1,289,951.50 |  2,579,903 |  2,020,000 |  559,903 |
| `execute_preflight_time_ms` |  78.50 |  157 |  80 |  77 |
| `execute_preflight_insn_mi/s` |  36.11 | -          |  37.26 |  34.97 |
| `trace_gen_time_ms   ` |  57.50 |  115 |  94 |  21 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  891 |  1,782 |  1,462 |  320 |
| `prover.main_trace_commit_time_ms` |  291 |  582 |  500 |  82 |
| `prover.rap_constraints_time_ms` |  534.50 |  1,069 |  867 |  202 |
...
| `prover.rap_constraints.mle_rounds_time_ms` |  95.50 |  191 |  145 |  46 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/6d8e3b607fea6f0c603a54c066a9ee6a656bd85d/kitchen_sink-6d8e3b607fea6f0c603a54c066a9ee6a656bd85d.memory.svg)
...
| app_proof |  |  |  |  |  | 463 |  |  | 34 | 2,579,903 | 75.40 | 0 | 2,321 |  | 
...
| leaf | 0 | 121 | 438 | 121 | 26 | 12 | 22 | 2 | 2 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 53,472,003 | 138 | 40 | 0 | 4 | 64 | 19 | 18 | 29 | 15 | 0 | 32 | 8 | 23 | 1 | 21 | 40 | 64 | 0 | 1 | 15 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 23,651,975 | 103 | 19 | 0 | 4 | 51 | 17 | 16 | 20 | 13 | 0 | 32 | 10 | 21 | 1 | 20 | 19 | 51 | 0 | 1 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 17,507,975 | 95 | 14 | 0 | 4 | 48 | 16 | 16 | 18 | 13 | 0 | 31 | 9 | 21 | 0 | 20 | 14 | 48 | 0 | 1 | 12 | 0 | 0 | 
| leaf | 0 | prover | 428,317,568 | 317 | 129 | 0 | 10 | 143 | 47 | 46 | 37 | 59 | 0 | 43 | 12 | 31 | 7 | 24 | 130 | 143 | 0 | 2 | 58 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,221,261,804 | 1,462 | 499 | 0 | 285 | 867 | 447 | 446 | 145 | 274 | 135 | 94 | 17 | 77 | 25 | 51 | 500 | 867 | 0 | 1 | 137 | 0 | 0 | 
| app_proof | prover | 1 | 370,741,140 | 320 | 81 | 0 | 17 | 202 | 111 | 111 | 46 | 43 | 0 | 35 | 9 | 26 | 7 | 18 | 82 | 202 | 0 | 1 | 43 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 94 | 1,819 | 94 | 185 | 0 | 3 | 77 | 2,020,000 | 34.97 | 
| app_proof | 1 | 21 | 463 | 21 | 40 | 0 | 1 | 80 | 559,903 | 37.26 | 

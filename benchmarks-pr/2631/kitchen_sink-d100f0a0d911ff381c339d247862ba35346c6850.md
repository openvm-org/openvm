...
| `total_proof_time_ms ` |  1,133 |  2,266 |  1,804 |  462 |
| `execute_metered_time_ms` |  34 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  74.100 | -          |  74.100 |  74.100 |
| `execute_preflight_insns` |  1,289,951.50 |  2,579,903 |  2,020,000 |  559,903 |
| `execute_preflight_time_ms` |  78 |  156 |  79 |  77 |
| `execute_preflight_insn_mi/s` |  35.97 | -          |  37.45 |  34.49 |
| `trace_gen_time_ms   ` |  56.50 |  113 |  92 |  21 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  886 |  1,772 |  1,451 |  321 |
| `prover.main_trace_commit_time_ms` |  289 |  578 |  496 |  82 |
| `prover.rap_constraints_time_ms` |  531 |  1,062 |  859 |  203 |
| `prover.openings_time_ms` |  64.50 |  129 |  94 |  35 |
| `prover.rap_constraints.logup_gkr_time_ms` |  156.50 |  313 |  270 |  43 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/d100f0a0d911ff381c339d247862ba35346c6850/kitchen_sink-d100f0a0d911ff381c339d247862ba35346c6850.memory.svg)
...
| app_proof |  |  |  |  |  | 462 |  |  | 34 | 2,579,903 | 74.100 | 0 | 2,306 |  | 
...
| leaf | 0 | 120 | 439 | 120 | 26 | 12 | 22 | 2 | 2 | 
...
| internal_recursive.0 | 1 | prover | 23,651,975 | 100 | 19 | 0 | 3 | 50 | 16 | 16 | 20 | 13 | 0 | 30 | 8 | 21 | 1 | 20 | 19 | 50 | 0 | 1 | 12 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 17,507,975 | 96 | 14 | 0 | 3 | 48 | 16 | 16 | 18 | 13 | 0 | 32 | 11 | 21 | 0 | 20 | 14 | 48 | 0 | 1 | 12 | 0 | 0 | 
| leaf | 0 | prover | 428,317,568 | 318 | 130 | 0 | 10 | 143 | 47 | 46 | 37 | 58 | 0 | 43 | 12 | 31 | 7 | 24 | 130 | 143 | 0 | 2 | 58 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,221,261,804 | 1,451 | 496 | 0 | 278 | 859 | 445 | 444 | 143 | 270 | 132 | 94 | 17 | 77 | 26 | 51 | 496 | 859 | 0 | 1 | 137 | 0 | 0 | 
| app_proof | prover | 1 | 370,741,140 | 321 | 81 | 0 | 17 | 203 | 112 | 111 | 47 | 43 | 0 | 35 | 9 | 26 | 7 | 18 | 82 | 202 | 0 | 1 | 43 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 92 | 1,804 | 92 | 183 | 0 | 3 | 77 | 2,020,000 | 34.49 | 
| app_proof | 1 | 21 | 462 | 21 | 40 | 0 | 1 | 79 | 559,903 | 37.45 | 

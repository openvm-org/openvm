...
| `execute_metered_insn_mi/s` |  65.89 | -          |  65.89 |  65.89 |
| `execute_e3_time_ms  ` |  122.50 |  245 |  138 |  107 |
| `execute_e3_insn_mi/s` |  17.04 | -          |  17.94 |  16.14 |
| `memory_finalize_time_ms` |  6.50 |  13 |  11 |  2 |
| `boundary_finalize_time_ms` |  2 |  4 |  4 |  0 |
| `merkle_finalize_time_ms` |  149 |  298 |  231 |  67 |
| `stark_prove_excluding_trace_time_ms` |  2,657 |  5,314 |  2,861 |  2,453 |
| `main_trace_commit_time_ms` |  529 |  1,058 |  585 |  473 |
| `generate_perm_trace_time_ms` |  216.50 |  433 |  228 |  205 |
| `perm_trace_commit_time_ms` |  561 |  1,122 |  599 |  523 |
| `quotient_poly_compute_time_ms` |  265.50 |  531 |  292 |  239 |
| `quotient_poly_commit_time_ms` |  265 |  530 |  294 |  236 |
| `pcs_opening_time_ms ` |  810 |  1,620 |  853 |  767 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 4,076 | 24 | 4,165,433 | 1 | 63 | 65.89 | 62 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 524 | 275,648,700 | 2,861 | 292 | 294 | 599 | 853 | 231 | 25 | 11 | 585 | 2,243,700 | 228 | 138 | 16.14 | 4 | 
| regex_program | 1 | 310 | 242,975,370 | 2,453 | 239 | 236 | 523 | 767 | 67 | 24 | 2 | 473 | 1,921,733 | 205 | 107 | 17.94 | 0 | 

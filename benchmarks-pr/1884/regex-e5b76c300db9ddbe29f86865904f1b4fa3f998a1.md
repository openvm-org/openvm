...
| `execute_e3_insn_mi/s` |  17.08 | -          |  17.96 |  16.21 |
| `memory_finalize_time_ms` |  6.50 |  13 |  11 |  2 |
| `boundary_finalize_time_ms` |  2.50 |  5 |  5 |  0 |
| `merkle_finalize_time_ms` |  157 |  314 |  246 |  68 |
| `stark_prove_excluding_trace_time_ms` |  2,622.50 |  5,245 |  2,857 |  2,388 |
| `main_trace_commit_time_ms` |  513.50 |  1,027 |  583 |  444 |
| `generate_perm_trace_time_ms` |  223.50 |  447 |  240 |  207 |
| `perm_trace_commit_time_ms` |  559 |  1,118 |  599 |  519 |
| `quotient_poly_compute_time_ms` |  262.50 |  525 |  283 |  242 |
| `quotient_poly_commit_time_ms` |  250 |  500 |  292 |  208 |
| `pcs_opening_time_ms ` |  806.50 |  1,613 |  854 |  759 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 4,024 | 24 | 4,165,433 | 1 | 61 | 67.52 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 528 | 275,648,700 | 2,857 | 283 | 292 | 599 | 854 | 246 | 25 | 11 | 583 | 2,243,700 | 240 | 138 | 16.21 | 5 | 
| regex_program | 1 | 298 | 242,975,370 | 2,388 | 242 | 208 | 519 | 759 | 68 | 23 | 2 | 444 | 1,921,733 | 207 | 106 | 17.96 | 0 | 

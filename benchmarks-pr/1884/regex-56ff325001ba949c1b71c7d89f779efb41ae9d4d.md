...
| `execute_metered_insn_mi/s` |  66.05 | -          |  66.05 |  66.05 |
| `execute_e3_time_ms  ` |  122 |  244 |  138 |  106 |
| `execute_e3_insn_mi/s` |  17.13 | -          |  18.03 |  16.22 |
| `memory_finalize_time_ms` |  7 |  14 |  12 |  2 |
| `boundary_finalize_time_ms` |  2 |  4 |  4 |  0 |
| `merkle_finalize_time_ms` |  156.50 |  313 |  245 |  68 |
| `stark_prove_excluding_trace_time_ms` |  2,616.50 |  5,233 |  2,838 |  2,395 |
| `main_trace_commit_time_ms` |  526 |  1,052 |  586 |  466 |
| `generate_perm_trace_time_ms` |  222 |  444 |  235 |  209 |
| `perm_trace_commit_time_ms` |  557.50 |  1,115 |  598 |  517 |
| `quotient_poly_compute_time_ms` |  258.50 |  517 |  283 |  234 |
| `quotient_poly_commit_time_ms` |  250.50 |  501 |  297 |  204 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 4,003 | 24 | 4,165,433 | 1 | 63 | 66.05 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 537 | 275,648,700 | 2,838 | 283 | 297 | 598 | 833 | 245 | 25 | 12 | 586 | 2,243,700 | 235 | 138 | 16.22 | 4 | 
| regex_program | 1 | 309 | 242,975,370 | 2,395 | 234 | 204 | 517 | 755 | 68 | 24 | 2 | 466 | 1,921,733 | 209 | 106 | 18.03 | 0 | 

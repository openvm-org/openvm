...
| `execute_metered_insn_mi/s` |  67.28 | -          |  67.28 |  67.28 |
| `execute_e3_time_ms  ` |  122.50 |  245 |  138 |  107 |
| `execute_e3_insn_mi/s` |  17.01 | -          |  17.88 |  16.15 |
| `memory_finalize_time_ms` |  6.50 |  13 |  11 |  2 |
| `boundary_finalize_time_ms` |  2 |  4 |  4 |  0 |
| `merkle_finalize_time_ms` |  150.50 |  301 |  234 |  67 |
| `stark_prove_excluding_trace_time_ms` |  2,654 |  5,308 |  2,859 |  2,449 |
| `main_trace_commit_time_ms` |  529 |  1,058 |  587 |  471 |
| `generate_perm_trace_time_ms` |  215.50 |  431 |  229 |  202 |
| `perm_trace_commit_time_ms` |  560.50 |  1,121 |  602 |  519 |
| `quotient_poly_compute_time_ms` |  257.50 |  515 |  281 |  234 |
| `quotient_poly_commit_time_ms` |  271.50 |  543 |  301 |  242 |
| `pcs_opening_time_ms ` |  811.50 |  1,623 |  854 |  769 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 4,080 | 24 | 4,165,433 | 1 | 61 | 67.28 | 62 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 526 | 275,648,700 | 2,859 | 281 | 301 | 602 | 854 | 234 | 25 | 11 | 587 | 2,243,700 | 229 | 138 | 16.15 | 4 | 
| regex_program | 1 | 309 | 242,975,370 | 2,449 | 234 | 242 | 519 | 769 | 67 | 23 | 2 | 471 | 1,921,733 | 202 | 107 | 17.88 | 0 | 

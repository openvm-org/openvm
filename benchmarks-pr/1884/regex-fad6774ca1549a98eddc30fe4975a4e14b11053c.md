...
| `execute_e3_insn_mi/s` |  17.03 | -          |  17.91 |  16.15 |
| `memory_finalize_time_ms` |  6.50 |  13 |  11 |  2 |
| `boundary_finalize_time_ms` |  2 |  4 |  4 |  0 |
| `merkle_finalize_time_ms` |  149.50 |  299 |  231 |  68 |
| `stark_prove_excluding_trace_time_ms` |  2,632 |  5,264 |  2,866 |  2,398 |
| `main_trace_commit_time_ms` |  522.50 |  1,045 |  577 |  468 |
| `generate_perm_trace_time_ms` |  211.50 |  423 |  232 |  191 |
| `perm_trace_commit_time_ms` |  559 |  1,118 |  599 |  519 |
| `quotient_poly_compute_time_ms` |  272 |  544 |  304 |  240 |
| `quotient_poly_commit_time_ms` |  256 |  512 |  306 |  206 |
| `pcs_opening_time_ms ` |  802.50 |  1,605 |  841 |  764 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 4,015 | 24 | 4,165,433 | 1 | 61 | 67.60 | 61 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 502 | 275,648,700 | 2,866 | 304 | 306 | 599 | 841 | 231 | 24 | 11 | 577 | 2,243,700 | 232 | 138 | 16.15 | 4 | 
| regex_program | 1 | 290 | 242,975,370 | 2,398 | 240 | 206 | 519 | 764 | 68 | 24 | 2 | 468 | 1,921,733 | 191 | 107 | 17.91 | 0 | 

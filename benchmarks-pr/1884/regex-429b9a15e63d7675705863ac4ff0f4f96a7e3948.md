...
| `execute_metered_insn_mi/s` |  67.26 | -          |  67.26 |  67.26 |
| `execute_e3_time_ms  ` |  121.50 |  243 |  137 |  106 |
| `execute_e3_insn_mi/s` |  17.16 | -          |  18.05 |  16.26 |
| `memory_finalize_time_ms` |  6.50 |  13 |  11 |  2 |
| `boundary_finalize_time_ms` |  2 |  4 |  4 |  0 |
| `merkle_finalize_time_ms` |  150 |  300 |  233 |  67 |
| `stark_prove_excluding_trace_time_ms` |  2,627 |  5,254 |  2,827 |  2,427 |
| `main_trace_commit_time_ms` |  524.50 |  1,049 |  580 |  469 |
| `generate_perm_trace_time_ms` |  225 |  450 |  236 |  214 |
| `perm_trace_commit_time_ms` |  557 |  1,114 |  597 |  517 |
| `quotient_poly_compute_time_ms` |  267 |  534 |  282 |  252 |
| `quotient_poly_commit_time_ms` |  252 |  504 |  294 |  210 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 4,047 | 23 | 4,165,433 | 1 | 61 | 67.26 | 61 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 526 | 275,648,700 | 2,827 | 282 | 294 | 597 | 833 | 233 | 24 | 11 | 580 | 2,243,700 | 236 | 137 | 16.26 | 4 | 
| regex_program | 1 | 308 | 242,975,370 | 2,427 | 252 | 210 | 517 | 755 | 67 | 23 | 2 | 469 | 1,921,733 | 214 | 106 | 18.05 | 0 | 

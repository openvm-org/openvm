...
|:---|---:|---:|
| Total | <span style='color: green'>(-0 [-1.0%])</span> 1.85 | <span style='color: green'>(-0 [-0.9%])</span> 1.10 |
| pairing | <span style='color: green'>(-0 [-1.1%])</span> 1.76 | <span style='color: green'>(-0 [-1.0%])</span> 1.01 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: green'>(-10 [-1.1%])</span> 878.50 | <span style='color: green'>(-19 [-1.1%])</span> 1,757 | <span style='color: green'>(-10 [-1.0%])</span> 1,007 | <span style='color: green'>(-9 [-1.2%])</span> 750 |
...
| `execute_metered_insn_mi/s` | <span style='color: red'>(+0 [+0.8%])</span> 20.69 | -          | <span style='color: red'>(+0 [+0.8%])</span> 20.69 | <span style='color: red'>(+0 [+0.8%])</span> 20.69 |
| `execute_preflight_insns` |  941,469.50 |  1,882,939 |  1,143,000 |  739,939 |
| `execute_preflight_time_ms` | <span style='color: green'>(-2 [-2.0%])</span> 97.50 | <span style='color: green'>(-4 [-2.0%])</span> 195 | <span style='color: green'>(-3 [-2.4%])</span> 124 | <span style='color: green'>(-1 [-1.4%])</span> 71 |
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+0 [+2.6%])</span> 14.33 | -          | <span style='color: red'>(+0 [+2.6%])</span> 19.22 | <span style='color: red'>(+0 [+2.6%])</span> 9.44 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+2 [+1.3%])</span> 191 | <span style='color: red'>(+5 [+1.3%])</span> 382 | <span style='color: green'>(-1 [-0.5%])</span> 204 | <span style='color: red'>(+6 [+3.5%])</span> 178 |
...
| `stark_prove_excluding_trace_time_ms` | <span style='color: green'>(-12 [-2.3%])</span> 495 | <span style='color: green'>(-23 [-2.3%])</span> 990 | <span style='color: green'>(-15 [-2.6%])</span> 557 | <span style='color: green'>(-8 [-1.8%])</span> 433 |
| `main_trace_commit_time_ms` |  68.50 |  137 | <span style='color: red'>(+1 [+1.3%])</span> 76 | <span style='color: green'>(-1 [-1.6%])</span> 61 |
| `generate_perm_trace_time_ms` | <span style='color: green'>(-1 [-1.6%])</span> 60 | <span style='color: green'>(-2 [-1.6%])</span> 120 | <span style='color: green'>(-1 [-1.3%])</span> 78 | <span style='color: green'>(-1 [-2.3%])</span> 42 |
| `perm_trace_commit_time_ms` | <span style='color: green'>(-0 [-0.6%])</span> 81.22 | <span style='color: green'>(-1 [-0.6%])</span> 162.45 | <span style='color: green'>(-2 [-1.7%])</span> 89.63 | <span style='color: red'>(+1 [+0.7%])</span> 72.82 |
| `quotient_poly_compute_time_ms` | <span style='color: green'>(-0 [-0.4%])</span> 93.12 | <span style='color: green'>(-1 [-0.4%])</span> 186.24 |  99.37 | <span style='color: green'>(-1 [-0.9%])</span> 86.86 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+1 [+4.6%])</span> 18.94 | <span style='color: red'>(+2 [+4.6%])</span> 37.88 | <span style='color: red'>(+1 [+5.8%])</span> 20.45 | <span style='color: red'>(+1 [+3.1%])</span> 17.43 |
| `pcs_opening_time_ms ` | <span style='color: green'>(-10 [-5.6%])</span> 168.50 | <span style='color: green'>(-20 [-5.6%])</span> 337 | <span style='color: green'>(-14 [-6.9%])</span> 189 | <span style='color: green'>(-6 [-3.9%])</span> 148 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 750 | 40 | 1 | 91 | 1,882,939 | 20.69 | 149 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 178 | 1,007 | 31,041,944 | 160,949,612 | 178 | 557 | 0 | 99.37 | 20.45 | 6 | 89.63 | 189 | 171 | 189 | 1 | 76 | 15,014,446 | 78 | 124 | 1,143,000 | 9.44 | 24 | 120 | 3 | 189 | 
| pairing | 1 | 204 | 750 | 24,485,078 | 124,079,782 | 204 | 433 | 1 | 86.86 | 17.43 | 6 | 72.82 | 148 | 118 | 148 | 0 | 61 | 10,833,316 | 42 | 71 | 739,939 | 19.22 | 19 | 104 | 2 | 148 | 

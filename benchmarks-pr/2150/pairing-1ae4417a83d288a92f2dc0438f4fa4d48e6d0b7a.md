...
|:---|---:|---:|
| Total | <span style='color: green'>(-0 [-0.9%])</span> 1.51 | <span style='color: green'>(-0 [-5.6%])</span> 0.87 |
| pairing | <span style='color: green'>(-0 [-1.0%])</span> 1.42 | <span style='color: green'>(-0 [-6.3%])</span> 0.78 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: green'>(-7 [-1.0%])</span> 709.50 | <span style='color: green'>(-14 [-1.0%])</span> 1,419 | <span style='color: green'>(-52 [-6.3%])</span> 779 | <span style='color: red'>(+38 [+6.3%])</span> 640 |
...
| `execute_metered_insn_mi/s` | <span style='color: red'>(+0 [+0.5%])</span> 20.63 | -          | <span style='color: red'>(+0 [+0.5%])</span> 20.63 | <span style='color: red'>(+0 [+0.5%])</span> 20.63 |
| `execute_preflight_insns` |  941,469.50 |  1,882,939 |  1,143,000 |  739,939 |
| `execute_preflight_time_ms` | <span style='color: red'>(+0 [+0.5%])</span> 99 | <span style='color: red'>(+1 [+0.5%])</span> 198 |  126 | <span style='color: red'>(+1 [+1.4%])</span> 72 |
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+0 [+1.4%])</span> 14.11 | -          | <span style='color: red'>(+0 [+1.8%])</span> 18.86 | <span style='color: red'>(+0 [+0.8%])</span> 9.37 |
| `trace_gen_time_ms   ` | <span style='color: green'>(-2 [-1.4%])</span> 172.50 | <span style='color: green'>(-5 [-1.4%])</span> 345 | <span style='color: green'>(-3 [-1.6%])</span> 187 | <span style='color: green'>(-2 [-1.2%])</span> 158 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: green'>(-6 [-1.7%])</span> 343 | <span style='color: green'>(-12 [-1.7%])</span> 686 | <span style='color: green'>(-52 [-13.0%])</span> 347 | <span style='color: red'>(+40 [+13.4%])</span> 339 |
| `main_trace_commit_time_ms` | <span style='color: green'>(-1 [-1.6%])</span> 60.50 | <span style='color: green'>(-2 [-1.6%])</span> 121 |  66 | <span style='color: green'>(-2 [-3.5%])</span> 55 |
| `generate_perm_trace_time_ms` | <span style='color: green'>(-14 [-31.8%])</span> 30 | <span style='color: green'>(-28 [-31.8%])</span> 60 | <span style='color: green'>(-29 [-49.2%])</span> 30 | <span style='color: red'>(+1 [+3.4%])</span> 30 |
| `perm_trace_commit_time_ms` | <span style='color: green'>(-0 [-0.5%])</span> 74.71 | <span style='color: green'>(-1 [-0.5%])</span> 149.43 |  83.27 | <span style='color: green'>(-1 [-1.1%])</span> 66.15 |
| `quotient_poly_compute_time_ms` | <span style='color: green'>(-1 [-0.7%])</span> 78.24 | <span style='color: green'>(-1 [-0.7%])</span> 156.48 | <span style='color: green'>(-1 [-1.0%])</span> 84.01 | <span style='color: green'>(-0 [-0.3%])</span> 72.47 |
| `quotient_poly_commit_time_ms` | <span style='color: green'>(-1 [-4.1%])</span> 15.32 | <span style='color: green'>(-1 [-4.1%])</span> 30.64 | <span style='color: green'>(-1 [-8.1%])</span> 16.02 | <span style='color: red'>(+0 [+0.7%])</span> 14.62 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+11 [+16.1%])</span> 79.50 | <span style='color: red'>(+22 [+16.1%])</span> 159 | <span style='color: red'>(+13 [+15.7%])</span> 96 | <span style='color: red'>(+9 [+16.7%])</span> 63 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 640 | 65 | 1 | 91 | 1,882,939 | 20.63 | 175 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 158 | 779 | 31,040,212 | 160,949,612 | 158 | 347 | 0 | 84.01 | 16.02 | 6 | 83.27 | 63 | 116 | 63 | 1 | 66 | 15,012,818 | 30 | 126 | 1,143,000 | 9.37 | 25 | 100 | 1 | 63 | 
| pairing | 1 | 187 | 640 | 24,484,058 | 124,079,782 | 187 | 339 | 1 | 72.47 | 14.62 | 6 | 66.15 | 96 | 99 | 96 | 0 | 55 | 10,832,352 | 30 | 72 | 739,939 | 18.86 | 21 | 87 | 1 | 96 | 

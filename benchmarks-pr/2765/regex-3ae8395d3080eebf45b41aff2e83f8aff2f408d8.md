...
|:---|---:|---:|---:|
| Total |  2.61 |  1.89 |  1.89 |
| app_proof |  1.66 |  0.94 |  0.94 |
| leaf |  0.38 |  0.38 |  0.38 |
...
| `total_proof_time_ms ` |  812 |  1,624 |  904 |  720 |
| `execute_metered_time_ms` |  31 | -          | -          | -          |
| `execute_metered_insns` |  4,090,656 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  128.46 | -          |  128.46 |  128.46 |
| `execute_preflight_insns` |  2,045,328 |  4,090,656 |  2,327,000 |  1,763,656 |
| `execute_preflight_time_ms` |  79.50 |  159 |  85 |  74 |
| `execute_preflight_insn_mi/s` |  35.14 | -          |  36.95 |  33.33 |
| `trace_gen_time_ms   ` |  150 |  300 |  150 |  150 |
| `memory_finalize_time_ms` |  1 |  2 |  2 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  479.50 |  959 |  505 |  454 |
| `prover.main_trace_commit_time_ms` |  129.50 |  259 |  146 |  113 |
| `prover.rap_constraints_time_ms` |  291.50 |  583 |  296 |  287 |
| `prover.openings_time_ms` |  58 |  116 |  63 |  53 |
| `prover.rap_constraints.logup_gkr_time_ms` |  157 |  314 |  166 |  148 |
| `prover.rap_constraints.round0_time_ms` |  92.50 |  185 |  102 |  83 |
| `prover.rap_constraints.mle_rounds_time_ms` |  41 |  82 |  46 |  36 |
| `prover.openings.stacked_reduction_time_ms` |  33.50 |  67 |  36 |  31 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/3ae8395d3080eebf45b41aff2e83f8aff2f408d8/regex-3ae8395d3080eebf45b41aff2e83f8aff2f408d8.memory.svg)
...
| app_proof |  |  |  |  |  | 720 |  |  | 31 | 4,090,656 | 128.46 | 0 | 1,669 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 27,256,571 | 232 | 84 | 0 | 5 | 104 | 31 | 31 | 45 | 27 | 0 | 43 | 16 | 26 | 2 | 23 | 84 | 104 | 0 | 2 | 24 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,703 | 165 | 49 | 0 | 3 | 71 | 24 | 23 | 27 | 19 | 0 | 44 | 20 | 23 | 1 | 21 | 49 | 71 | 0 | 2 | 18 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 142 | 34 | 0 | 4 | 66 | 23 | 22 | 24 | 18 | 0 | 42 | 19 | 22 | 1 | 21 | 34 | 66 | 0 | 2 | 17 | 0 | 0 | 
| leaf | 0 | prover | 79,962,868 | 331 | 130 | 0 | 8 | 142 | 55 | 54 | 38 | 48 | 0 | 59 | 28 | 30 | 6 | 23 | 130 | 142 | 0 | 5 | 46 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 179,663,570 | 505 | 145 | 0 | 10 | 296 | 83 | 82 | 46 | 166 | 0 | 63 | 26 | 36 | 15 | 21 | 146 | 296 | 0 | 3 | 165 | 0 | 0 | 
| app_proof | prover | 1 | 133,369,433 | 454 | 113 | 0 | 16 | 287 | 102 | 102 | 36 | 148 | 0 | 53 | 22 | 31 | 11 | 19 | 113 | 287 | 0 | 3 | 147 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 150 | 904 | 150 | 162 | 2 | 6 | 85 | 2,327,000 | 33.33 | 
| app_proof | 1 | 150 | 720 | 150 | 41 | 0 | 2 | 74 | 1,763,656 | 36.95 | 

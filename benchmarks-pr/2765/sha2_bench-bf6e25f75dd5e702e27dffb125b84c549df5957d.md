...
|:---|---:|---:|---:|
| Total |  11.65 |  4.79 |  4.79 |
| app_proof |  9.57 |  2.71 |  2.71 |
| leaf |  1.42 |  1.42 |  1.42 |
...
| `total_proof_time_ms ` |  2,368.25 |  9,473 |  2,613 |  2,259 |
| `execute_metered_time_ms` |  93 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  119.27 | -          |  119.27 |  119.27 |
| `execute_preflight_insns` |  2,791,990.25 |  11,167,961 |  2,851,000 |  2,614,961 |
| `execute_preflight_time_ms` |  162.75 |  651 |  205 |  97 |
| `execute_preflight_insn_mi/s` |  36.77 | -          |  37.84 |  34.33 |
| `trace_gen_time_ms   ` |  101.25 |  405 |  171 |  59 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  2,032 |  8,128 |  2,183 |  1,953 |
| `prover.main_trace_commit_time_ms` |  559.75 |  2,239 |  666 |  524 |
| `prover.rap_constraints_time_ms` |  1,329 |  5,316 |  1,371 |  1,287 |
| `prover.openings_time_ms` |  142.25 |  569 |  146 |  135 |
| `prover.rap_constraints.logup_gkr_time_ms` |  345.25 |  1,381 |  388 |  299 |
| `prover.rap_constraints.round0_time_ms` |  663.25 |  2,653 |  673 |  655 |
| `prover.rap_constraints.mle_rounds_time_ms` |  319.75 |  1,279 |  322 |  317 |
| `prover.openings.stacked_reduction_time_ms` |  101 |  404 |  104 |  95 |
| `prover.openings.stacked_reduction.round0_time_ms` |  61 |  244 |  63 |  57 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  39 |  156 |  40 |  37 |
| `prover.openings.whir_time_ms` |  40.50 |  162 |  43 |  39 |
...
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,270 |  1,270 |  1,270 |  1,270 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/bf6e25f75dd5e702e27dffb125b84c549df5957d/sha2_bench-bf6e25f75dd5e702e27dffb125b84c549df5957d.memory.svg)
...
| frac_sumcheck.segment_tree | 10.88 | app_proof.prover.3 |
| prover.gkr_input_evals | 10.88 | app_proof.prover.3 |
...
| app_proof |  |  |  |  |  | 2,261 |  |  | 93 | 11,167,961 | 119.27 | 0 | 9,573 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 61,220,603 | 354 | 184 | 0 | 0 | 129 | 38 | 37 | 64 | 27 | 0 | 39 | 20 | 18 | 5 | 12 | 185 | 129 | 0 | 3 | 26 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,879 | 150 | 49 | 0 | 0 | 72 | 25 | 24 | 29 | 17 | 0 | 27 | 19 | 8 | 1 | 6 | 49 | 72 | 0 | 2 | 16 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 121 | 31 | 0 | 0 | 62 | 23 | 23 | 25 | 13 | 0 | 26 | 19 | 7 | 1 | 5 | 31 | 62 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 424,379,238 | 1,270 | 799 | 0 | 153 | 353 | 170 | 169 | 106 | 76 | 0 | 116 | 50 | 65 | 37 | 27 | 800 | 353 | 0 | 7 | 75 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 662,392,121 | 2,183 | 665 | 0 | 143 | 1,371 | 661 | 660 | 321 | 388 | 99 | 145 | 40 | 104 | 63 | 40 | 666 | 1,371 | 0 | 3 | 288 | 0 | 0 | 
| app_proof | prover | 1 | 662,391,820 | 2,034 | 524 | 0 | 2 | 1,366 | 655 | 655 | 322 | 388 | 110 | 143 | 40 | 102 | 62 | 39 | 524 | 1,366 | 0 | 3 | 277 | 0 | 0 | 
| app_proof | prover | 2 | 662,391,820 | 1,953 | 525 | 0 | 2 | 1,292 | 673 | 672 | 319 | 299 | 0 | 135 | 39 | 95 | 57 | 37 | 525 | 1,292 | 0 | 4 | 298 | 0 | 0 | 
| app_proof | prover | 3 | 662,468,884 | 1,958 | 524 | 0 | 2 | 1,287 | 664 | 663 | 317 | 306 | 0 | 146 | 43 | 103 | 62 | 40 | 524 | 1,287 | 0 | 3 | 305 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 171 | 2,613 | 171 | 160 | 0 | 3 | 97 | 2,851,000 | 34.33 | 
| app_proof | 1 | 59 | 2,340 | 59 | 41 | 0 | 2 | 205 | 2,851,000 | 37.84 | 
| app_proof | 2 | 84 | 2,259 | 84 | 41 | 0 | 2 | 180 | 2,851,000 | 37.14 | 
| app_proof | 3 | 91 | 2,261 | 91 | 41 | 0 | 2 | 169 | 2,614,961 | 37.76 | 

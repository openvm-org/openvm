...
|:---|---:|---:|---:|
| Total |  2.86 |  2.12 |  2.11 |
| app_proof |  2.05 |  1.31 |  1.31 |
| leaf |  0.43 |  0.43 |  0.43 |
...
| `total_proof_time_ms ` |  1,014.50 |  2,029 |  1,288 |  741 |
| `execute_metered_time_ms` |  23 | -          | -          | -          |
| `execute_metered_insns` |  1,979,971 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  82.71 | -          |  82.71 |  82.71 |
| `execute_preflight_insns` |  989,985.50 |  1,979,971 |  1,168,000 |  811,971 |
| `execute_preflight_time_ms` |  90.50 |  181 |  128 |  53 |
| `execute_preflight_insn_mi/s` |  32.83 | -          |  33.70 |  31.97 |
| `trace_gen_time_ms   ` |  30 |  60 |  45 |  15 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  783 |  1,566 |  1,010 |  556 |
| `prover.main_trace_commit_time_ms` |  224.50 |  449 |  300 |  149 |
| `prover.rap_constraints_time_ms` |  493 |  986 |  633 |  353 |
| `prover.openings_time_ms` |  64.50 |  129 |  76 |  53 |
| `prover.rap_constraints.logup_gkr_time_ms` |  101 |  202 |  139 |  63 |
| `prover.rap_constraints.round0_time_ms` |  282 |  564 |  351 |  213 |
| `prover.rap_constraints.mle_rounds_time_ms` |  108.50 |  217 |  142 |  75 |
| `prover.openings.stacked_reduction_time_ms` |  50.50 |  101 |  63 |  38 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/e6af7e918a2edbe80d2fe20f866a27bbcddec470/kitchen_sink-e6af7e918a2edbe80d2fe20f866a27bbcddec470.memory.svg)
...
| app_proof |  |  |  |  |  | 741 |  |  | 23 | 1,979,971 | 82.71 | 0 | 2,058 |  | 
...
| internal_recursive.0 | 1 | 10 | 115 | 10 | 2 | 0 | 2 | 0 | 0 | 
| internal_recursive.1 | 1 | 8 | 105 | 8 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 110 | 427 | 110 | 25 | 11 | 20 | 4 | 4 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,577,915 | 139 | 40 | 0 | 4 | 65 | 20 | 19 | 29 | 16 | 0 | 32 | 8 | 23 | 1 | 22 | 41 | 65 | 0 | 1 | 15 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,703 | 104 | 19 | 0 | 4 | 54 | 19 | 18 | 20 | 14 | 0 | 30 | 8 | 21 | 1 | 20 | 19 | 54 | 0 | 1 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 97 | 14 | 0 | 4 | 52 | 20 | 19 | 18 | 14 | 0 | 29 | 7 | 21 | 0 | 20 | 15 | 52 | 0 | 1 | 13 | 0 | 0 | 
| leaf | 0 | prover | 263,565,172 | 316 | 129 | 0 | 10 | 143 | 48 | 48 | 37 | 56 | 0 | 43 | 12 | 31 | 7 | 24 | 130 | 143 | 0 | 2 | 56 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 565,122,580 | 1,010 | 299 | 0 | 171 | 633 | 351 | 349 | 142 | 139 | 43 | 76 | 13 | 63 | 15 | 47 | 300 | 633 | 0 | 1 | 94 | 0 | 0 | 
| app_proof | prover | 1 | 541,799,820 | 556 | 149 | 0 | 24 | 353 | 213 | 213 | 75 | 63 | 0 | 53 | 14 | 38 | 14 | 24 | 149 | 353 | 0 | 1 | 62 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 45 | 1,288 | 45 | 178 | 0 | 3 | 53 | 1,168,000 | 31.97 | 
| app_proof | 1 | 15 | 741 | 15 | 40 | 0 | 1 | 128 | 811,971 | 33.70 | 

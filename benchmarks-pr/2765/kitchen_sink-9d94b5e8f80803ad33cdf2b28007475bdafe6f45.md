...
| `total_proof_time_ms ` |  1,016 |  2,032 |  1,289 |  743 |
| `execute_metered_time_ms` |  23 | -          | -          | -          |
| `execute_metered_insns` |  1,979,971 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  84.14 | -          |  84.14 |  84.14 |
| `execute_preflight_insns` |  989,985.50 |  1,979,971 |  1,168,000 |  811,971 |
| `execute_preflight_time_ms` |  90 |  180 |  127 |  53 |
| `execute_preflight_insn_mi/s` |  33.22 | -          |  34.31 |  32.13 |
| `trace_gen_time_ms   ` |  30 |  60 |  44 |  16 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  787 |  1,574 |  1,015 |  559 |
| `prover.main_trace_commit_time_ms` |  227 |  454 |  305 |  149 |
| `prover.rap_constraints_time_ms` |  494.50 |  989 |  634 |  355 |
| `prover.openings_time_ms` |  64 |  128 |  75 |  53 |
| `prover.rap_constraints.logup_gkr_time_ms` |  102.50 |  205 |  141 |  64 |
| `prover.rap_constraints.round0_time_ms` |  280 |  560 |  347 |  213 |
| `prover.rap_constraints.mle_rounds_time_ms` |  110.50 |  221 |  144 |  77 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/9d94b5e8f80803ad33cdf2b28007475bdafe6f45/kitchen_sink-9d94b5e8f80803ad33cdf2b28007475bdafe6f45.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 77 | 3 |  |  | 0 |  | 357 | 3 |  |  |  |  |  |  | 
| app_proof |  |  |  |  |  | 743 |  |  | 23 | 1,979,971 | 84.14 | 0 | 2,060 |  | 
...
| leaf | 0 | 111 | 430 | 110 | 25 | 11 | 20 | 5 | 5 | 
...
| internal_recursive.0 | 1 | prover | 15,378,703 | 106 | 19 | 0 | 4 | 54 | 19 | 18 | 20 | 14 | 0 | 32 | 10 | 21 | 1 | 20 | 19 | 54 | 0 | 1 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 97 | 14 | 0 | 4 | 52 | 20 | 19 | 18 | 13 | 0 | 29 | 8 | 21 | 0 | 20 | 15 | 52 | 0 | 1 | 13 | 0 | 0 | 
| leaf | 0 | prover | 263,565,172 | 319 | 130 | 0 | 10 | 144 | 49 | 48 | 37 | 57 | 0 | 43 | 12 | 31 | 7 | 24 | 130 | 144 | 0 | 2 | 56 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 565,122,580 | 1,015 | 304 | 0 | 174 | 634 | 347 | 345 | 144 | 141 | 45 | 75 | 12 | 63 | 16 | 47 | 305 | 634 | 0 | 1 | 95 | 0 | 0 | 
| app_proof | prover | 1 | 541,799,820 | 559 | 149 | 0 | 24 | 355 | 213 | 213 | 77 | 64 | 0 | 53 | 14 | 39 | 14 | 24 | 149 | 355 | 0 | 1 | 64 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 44 | 1,289 | 44 | 176 | 0 | 3 | 53 | 1,168,000 | 32.13 | 
| app_proof | 1 | 16 | 743 | 16 | 40 | 0 | 2 | 127 | 811,971 | 34.31 | 

...
| `total_proof_time_ms ` |  1,012.50 |  2,025 |  1,291 |  734 |
| `execute_metered_time_ms` |  23 | -          | -          | -          |
| `execute_metered_insns` |  1,979,971 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  84.03 | -          |  84.03 |  84.03 |
| `execute_preflight_insns` |  989,985.50 |  1,979,971 |  1,168,000 |  811,971 |
| `execute_preflight_time_ms` |  88.50 |  177 |  124 |  53 |
| `execute_preflight_insn_mi/s` |  33.07 | -          |  34.15 |  31.98 |
| `trace_gen_time_ms   ` |  30.50 |  61 |  45 |  16 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  784 |  1,568 |  1,016 |  552 |
| `prover.main_trace_commit_time_ms` |  226 |  452 |  304 |  148 |
| `prover.rap_constraints_time_ms` |  493 |  986 |  635 |  351 |
| `prover.openings_time_ms` |  64 |  128 |  76 |  52 |
| `prover.rap_constraints.logup_gkr_time_ms` |  101.50 |  203 |  141 |  62 |
| `prover.rap_constraints.round0_time_ms` |  280.50 |  561 |  348 |  213 |
| `prover.rap_constraints.mle_rounds_time_ms` |  110 |  220 |  145 |  75 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/3faceb64adac207a7a97d17f96d642d4ea13b9e5/kitchen_sink-3faceb64adac207a7a97d17f96d642d4ea13b9e5.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 73 | 3 |  |  | 0 |  | 349 | 3 |  |  |  |  |  |  | 
| app_proof |  |  |  |  |  | 734 |  |  | 23 | 1,979,971 | 84.03 | 0 | 2,054 |  | 
...
| internal_recursive.1 | 1 | 9 | 110 | 8 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 108 | 425 | 107 | 24 | 11 | 20 | 4 | 4 | 
...
| internal_recursive.0 | 1 | prover | 15,378,703 | 106 | 19 | 0 | 4 | 54 | 20 | 18 | 20 | 14 | 0 | 32 | 10 | 21 | 1 | 20 | 19 | 54 | 0 | 1 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 101 | 14 | 0 | 4 | 54 | 21 | 20 | 18 | 14 | 0 | 32 | 10 | 21 | 0 | 20 | 14 | 54 | 0 | 1 | 13 | 0 | 0 | 
| leaf | 0 | prover | 263,565,172 | 317 | 129 | 0 | 10 | 143 | 48 | 47 | 37 | 57 | 0 | 43 | 11 | 31 | 7 | 24 | 129 | 143 | 0 | 2 | 57 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 565,122,580 | 1,016 | 303 | 0 | 175 | 635 | 348 | 347 | 145 | 141 | 45 | 76 | 13 | 63 | 15 | 47 | 304 | 635 | 0 | 1 | 95 | 0 | 0 | 
| app_proof | prover | 1 | 541,799,820 | 552 | 148 | 0 | 24 | 351 | 213 | 212 | 75 | 62 | 0 | 52 | 14 | 38 | 14 | 24 | 148 | 351 | 0 | 1 | 61 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 45 | 1,291 | 45 | 177 | 0 | 3 | 53 | 1,168,000 | 31.98 | 
| app_proof | 1 | 16 | 734 | 16 | 40 | 0 | 1 | 124 | 811,971 | 34.15 | 

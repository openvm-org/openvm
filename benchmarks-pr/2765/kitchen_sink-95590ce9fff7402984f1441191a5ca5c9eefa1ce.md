...
| `total_proof_time_ms ` |  939 |  1,878 |  1,199 |  679 |
| `execute_metered_time_ms` |  23 | -          | -          | -          |
| `execute_metered_insns` |  1,979,971 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  83.07 | -          |  83.07 |  83.07 |
| `execute_preflight_insns` |  989,985.50 |  1,979,971 |  1,168,000 |  811,971 |
| `execute_preflight_time_ms` |  93.50 |  187 |  131 |  56 |
| `execute_preflight_insn_mi/s` |  31.24 | -          |  33.25 |  29.23 |
| `trace_gen_time_ms   ` |  28.50 |  57 |  41 |  16 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  706 |  1,412 |  923 |  489 |
| `prover.main_trace_commit_time_ms` |  213 |  426 |  289 |  137 |
| `prover.rap_constraints_time_ms` |  446 |  892 |  582 |  310 |
| `prover.openings_time_ms` |  46 |  92 |  51 |  41 |
| `prover.rap_constraints.logup_gkr_time_ms` |  78 |  156 |  103 |  53 |
| `prover.rap_constraints.round0_time_ms` |  261.50 |  523 |  344 |  179 |
| `prover.rap_constraints.mle_rounds_time_ms` |  105 |  210 |  134 |  76 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/95590ce9fff7402984f1441191a5ca5c9eefa1ce/kitchen_sink-95590ce9fff7402984f1441191a5ca5c9eefa1ce.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 72 | 3 |  |  | 0 |  | 340 | 3 |  |  |  |  |  |  | 
| app_proof |  |  |  |  |  | 679 |  |  | 23 | 1,979,971 | 83.07 | 0 | 1,906 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,577,915 | 118 | 37 | 0 | 0 | 62 | 21 | 20 | 29 | 12 | 0 | 17 | 9 | 7 | 1 | 5 | 38 | 62 | 0 | 1 | 11 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,703 | 78 | 16 | 0 | 0 | 47 | 17 | 16 | 20 | 9 | 0 | 14 | 8 | 5 | 1 | 4 | 16 | 47 | 0 | 1 | 9 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 75 | 11 | 0 | 0 | 49 | 19 | 18 | 18 | 10 | 0 | 14 | 9 | 5 | 0 | 4 | 11 | 48 | 0 | 1 | 9 | 0 | 0 | 
| leaf | 0 | prover | 263,565,172 | 296 | 127 | 0 | 1 | 140 | 48 | 47 | 37 | 54 | 0 | 28 | 12 | 15 | 7 | 8 | 128 | 140 | 0 | 2 | 53 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 565,122,580 | 923 | 289 | 0 | 161 | 582 | 344 | 342 | 134 | 103 | 48 | 51 | 13 | 37 | 15 | 22 | 289 | 582 | 0 | 1 | 54 | 0 | 0 | 
| app_proof | prover | 1 | 541,799,820 | 489 | 137 | 0 | 1 | 310 | 179 | 179 | 76 | 53 | 0 | 41 | 14 | 27 | 14 | 13 | 137 | 310 | 0 | 1 | 53 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 41 | 1,199 | 41 | 178 | 0 | 3 | 56 | 1,168,000 | 29.23 | 
| app_proof | 1 | 16 | 679 | 16 | 40 | 0 | 1 | 131 | 811,971 | 33.25 | 

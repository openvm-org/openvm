...
| `total_proof_time_ms ` |  944.50 |  1,889 |  1,203 |  686 |
...
| `execute_preflight_time_ms` |  92 |  184 |  132 |  52 |
| `execute_preflight_insn_mi/s` |  33.38 | -          |  34.37 |  32.39 |
| `trace_gen_time_ms   ` |  30.50 |  61 |  45 |  16 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  711.50 |  1,423 |  927 |  496 |
| `prover.main_trace_commit_time_ms` |  215.50 |  431 |  292 |  139 |
| `prover.rap_constraints_time_ms` |  448 |  896 |  582 |  314 |
| `prover.openings_time_ms` |  47 |  94 |  52 |  42 |
| `prover.rap_constraints.logup_gkr_time_ms` |  79 |  158 |  103 |  55 |
| `prover.rap_constraints.round0_time_ms` |  262.50 |  525 |  345 |  180 |
| `prover.rap_constraints.mle_rounds_time_ms` |  105 |  210 |  133 |  77 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/c2fbeabb683502e54d0234915163087cb56ea47e/kitchen_sink-c2fbeabb683502e54d0234915163087cb56ea47e.memory.svg)
...
| app_proof |  |  |  |  |  | 686 |  |  | 23 | 1,979,971 | 83.22 | 0 | 1,916 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,577,915 | 121 | 38 | 0 | 0 | 65 | 22 | 21 | 29 | 12 | 0 | 17 | 9 | 7 | 1 | 6 | 39 | 65 | 0 | 1 | 12 | 0 | 0 | 
...
| leaf | 0 | prover | 263,565,172 | 298 | 128 | 0 | 1 | 141 | 49 | 48 | 37 | 53 | 0 | 28 | 12 | 15 | 7 | 8 | 128 | 140 | 0 | 2 | 52 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 565,122,580 | 927 | 292 | 0 | 160 | 582 | 345 | 343 | 133 | 103 | 48 | 52 | 13 | 38 | 16 | 22 | 292 | 582 | 0 | 1 | 53 | 0 | 0 | 
| app_proof | prover | 1 | 541,799,820 | 496 | 139 | 0 | 1 | 314 | 180 | 180 | 77 | 55 | 0 | 42 | 14 | 28 | 14 | 13 | 139 | 314 | 0 | 1 | 54 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 45 | 1,203 | 45 | 177 | 0 | 3 | 52 | 1,168,000 | 32.39 | 
| app_proof | 1 | 16 | 686 | 16 | 41 | 0 | 1 | 132 | 811,971 | 34.37 | 

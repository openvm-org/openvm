...
| `total_proof_time_ms ` |  801.50 |  1,603 |  890 |  713 |
| `execute_metered_time_ms` |  31 | -          | -          | -          |
| `execute_metered_insns` |  4,090,656 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  130.38 | -          |  130.38 |  130.38 |
| `execute_preflight_insns` |  2,045,328 |  4,090,656 |  2,327,000 |  1,763,656 |
| `execute_preflight_time_ms` |  79.50 |  159 |  86 |  73 |
| `execute_preflight_insn_mi/s` |  35.21 | -          |  37.61 |  32.80 |
| `trace_gen_time_ms   ` |  147 |  294 |  148 |  146 |
| `memory_finalize_time_ms` |  1 |  2 |  2 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  473.50 |  947 |  497 |  450 |
| `prover.main_trace_commit_time_ms` |  129 |  258 |  145 |  113 |
| `prover.rap_constraints_time_ms` |  288 |  576 |  292 |  284 |
| `prover.openings_time_ms` |  55.50 |  111 |  59 |  52 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/6659be49555b8a2987f28818cf4f08a2cd547dc9/regex-6659be49555b8a2987f28818cf4f08a2cd547dc9.memory.svg)
...
| app_proof |  |  |  |  |  | 713 |  |  | 31 | 4,090,656 | 130.38 | 0 | 1,649 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 27,256,571 | 233 | 84 | 0 | 5 | 102 | 31 | 30 | 45 | 25 | 0 | 46 | 19 | 26 | 2 | 23 | 84 | 102 | 0 | 2 | 25 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,703 | 161 | 48 | 0 | 4 | 71 | 23 | 23 | 27 | 19 | 0 | 41 | 17 | 24 | 1 | 22 | 48 | 71 | 0 | 2 | 18 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 147 | 34 | 0 | 4 | 66 | 23 | 23 | 24 | 18 | 0 | 46 | 23 | 22 | 1 | 21 | 34 | 66 | 0 | 2 | 18 | 0 | 0 | 
| leaf | 0 | prover | 79,962,868 | 332 | 129 | 0 | 8 | 140 | 54 | 53 | 37 | 48 | 0 | 62 | 31 | 30 | 6 | 23 | 129 | 140 | 0 | 5 | 47 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 179,663,570 | 497 | 144 | 0 | 10 | 292 | 81 | 81 | 45 | 165 | 0 | 59 | 22 | 36 | 15 | 21 | 145 | 292 | 0 | 3 | 163 | 0 | 0 | 
| app_proof | prover | 1 | 133,369,433 | 450 | 113 | 0 | 16 | 284 | 101 | 101 | 36 | 146 | 0 | 52 | 21 | 30 | 10 | 19 | 113 | 284 | 0 | 2 | 145 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 146 | 890 | 146 | 160 | 2 | 6 | 86 | 2,327,000 | 32.80 | 
| app_proof | 1 | 148 | 713 | 148 | 40 | 0 | 2 | 73 | 1,763,656 | 37.61 | 

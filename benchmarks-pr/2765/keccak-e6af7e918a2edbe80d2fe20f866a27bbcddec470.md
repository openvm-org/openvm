...
|:---|---:|---:|---:|
| Total |  16.81 |  4.100 |  4.100 |
| app_proof |  13.70 |  2.68 |  2.68 |
| leaf |  2.24 |  1.45 |  1.45 |
...
| `total_proof_time_ms ` |  2,260.50 |  13,563 |  2,544 |  2,165 |
| `execute_metered_time_ms` |  140 | -          | -          | -          |
| `execute_metered_insns` |  14,365,133 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  102.58 | -          |  102.58 |  102.58 |
| `execute_preflight_insns` |  2,394,188.83 |  14,365,133 |  2,413,000 |  2,300,133 |
| `execute_preflight_time_ms` |  237.33 |  1,424 |  320 |  86 |
| `execute_preflight_insn_mi/s` |  35.18 | -          |  36.25 |  32.22 |
| `trace_gen_time_ms   ` |  54.33 |  326 |  157 |  33 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,906.67 |  11,440 |  2,137 |  1,857 |
| `prover.main_trace_commit_time_ms` |  711.50 |  4,269 |  877 |  677 |
| `prover.rap_constraints_time_ms` |  1,007.33 |  6,044 |  1,069 |  993 |
| `prover.openings_time_ms` |  186.83 |  1,121 |  190 |  185 |
| `prover.rap_constraints.logup_gkr_time_ms` |  180 |  1,080 |  234 |  169 |
| `prover.rap_constraints.round0_time_ms` |  516 |  3,096 |  520 |  505 |
| `prover.rap_constraints.mle_rounds_time_ms` |  310.17 |  1,861 |  329 |  306 |
| `prover.openings.stacked_reduction_time_ms` |  145 |  870 |  148 |  144 |
...
| `prover.openings.whir_time_ms` |  41.50 |  249 |  44 |  40 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,122 |  2,244 |  1,453 |  791 |
| `execute_preflight_time_ms` |  5.50 |  11 |  6 |  5 |
| `trace_gen_time_ms   ` |  136.50 |  273 |  182 |  91 |
| `generate_blob_total_time_ms` |  24.50 |  49 |  33 |  16 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  985 |  1,970 |  1,271 |  699 |
| `prover.main_trace_commit_time_ms` |  552 |  1,104 |  726 |  378 |
| `prover.rap_constraints_time_ms` |  324.50 |  649 |  416 |  233 |
| `prover.openings_time_ms` |  107.50 |  215 |  128 |  87 |
| `prover.rap_constraints.logup_gkr_time_ms` |  71.50 |  143 |  87 |  56 |
| `prover.rap_constraints.round0_time_ms` |  156 |  312 |  204 |  108 |
...
| `prover.openings.whir_time_ms` |  36.50 |  73 |  40 |  33 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/e6af7e918a2edbe80d2fe20f866a27bbcddec470/keccak-e6af7e918a2edbe80d2fe20f866a27bbcddec470.memory.svg)
...
| app_proof |  |  |  |  |  | 2,165 |  |  | 140 | 14,365,133 | 102.58 | 0 | 13,709 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 37 | 519 | 37 | 13 | 4 | 2 | 2 | 2 | 
| internal_recursive.0 | 1 | 13 | 188 | 13 | 2 | 1 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 9 | 152 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 182 | 1,453 | 181 | 64 | 33 | 6 | 7 | 7 | 
| leaf | 1 | 91 | 791 | 91 | 32 | 16 | 5 | 7 | 7 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 81,415,028 | 481 | 246 | 0 | 14 | 177 | 49 | 48 | 91 | 36 | 0 | 57 | 18 | 38 | 7 | 31 | 247 | 177 | 0 | 2 | 35 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,879 | 174 | 51 | 0 | 4 | 77 | 24 | 24 | 29 | 23 | 0 | 45 | 20 | 24 | 1 | 22 | 51 | 77 | 0 | 2 | 22 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 143 | 33 | 0 | 4 | 67 | 24 | 23 | 24 | 18 | 0 | 40 | 17 | 22 | 1 | 21 | 34 | 67 | 0 | 2 | 18 | 0 | 0 | 
| leaf | 0 | prover | 476,578,662 | 1,271 | 726 | 0 | 48 | 416 | 204 | 204 | 123 | 87 | 0 | 128 | 40 | 87 | 41 | 46 | 726 | 416 | 0 | 6 | 87 | 0 | 0 | 
| leaf | 1 | prover | 240,255,732 | 699 | 378 | 0 | 24 | 233 | 108 | 107 | 68 | 56 | 0 | 87 | 33 | 53 | 20 | 32 | 378 | 233 | 0 | 5 | 55 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 857,743,372 | 2,137 | 877 | 0 | 259 | 1,069 | 505 | 504 | 329 | 234 | 64 | 190 | 42 | 148 | 86 | 61 | 877 | 1,069 | 0 | 3 | 168 | 0 | 0 | 
| app_proof | prover | 1 | 857,820,172 | 1,864 | 678 | 0 | 58 | 996 | 520 | 520 | 306 | 169 | 0 | 188 | 44 | 144 | 84 | 60 | 678 | 996 | 0 | 3 | 168 | 0 | 0 | 
| app_proof | prover | 2 | 857,820,172 | 1,857 | 677 | 0 | 58 | 993 | 516 | 515 | 307 | 169 | 0 | 186 | 41 | 144 | 83 | 60 | 677 | 993 | 0 | 3 | 169 | 0 | 0 | 
| app_proof | prover | 3 | 857,820,172 | 1,861 | 677 | 0 | 58 | 996 | 520 | 519 | 306 | 169 | 0 | 186 | 42 | 144 | 83 | 60 | 678 | 996 | 0 | 3 | 168 | 0 | 0 | 
| app_proof | prover | 4 | 857,820,172 | 1,860 | 679 | 0 | 58 | 995 | 518 | 517 | 307 | 169 | 0 | 185 | 40 | 145 | 85 | 60 | 680 | 995 | 0 | 3 | 168 | 0 | 0 | 
| app_proof | prover | 5 | 857,743,372 | 1,861 | 679 | 0 | 58 | 995 | 517 | 517 | 306 | 170 | 0 | 186 | 40 | 145 | 85 | 60 | 679 | 995 | 0 | 3 | 170 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 157 | 2,544 | 157 | 163 | 0 | 3 | 86 | 2,413,000 | 32.22 | 
| app_proof | 1 | 34 | 2,260 | 34 | 41 | 0 | 1 | 320 | 2,413,000 | 35.89 | 
| app_proof | 2 | 34 | 2,196 | 34 | 41 | 0 | 1 | 263 | 2,413,000 | 35.97 | 
| app_proof | 3 | 34 | 2,198 | 34 | 41 | 0 | 1 | 262 | 2,413,000 | 36.25 | 
| app_proof | 4 | 34 | 2,200 | 34 | 41 | 0 | 1 | 264 | 2,413,000 | 34.88 | 
| app_proof | 5 | 33 | 2,165 | 33 | 41 | 0 | 1 | 229 | 2,300,133 | 35.89 | 

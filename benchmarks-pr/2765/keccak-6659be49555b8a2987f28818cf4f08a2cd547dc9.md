...
|:---|---:|---:|---:|
| Total |  16.92 |  5.02 |  5.02 |
| app_proof |  13.80 |  2.69 |  2.69 |
| leaf |  2.25 |  1.46 |  1.46 |
...
| `total_proof_time_ms ` |  2,276.67 |  13,660 |  2,550 |  2,182 |
...
| `execute_preflight_time_ms` |  242.50 |  1,455 |  334 |  87 |
| `execute_preflight_insn_mi/s` |  35.38 | -          |  36.24 |  32.15 |
| `trace_gen_time_ms   ` |  54.33 |  326 |  157 |  33 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,918.17 |  11,509 |  2,145 |  1,868 |
| `prover.main_trace_commit_time_ms` |  713.33 |  4,280 |  876 |  679 |
| `prover.rap_constraints_time_ms` |  1,017.33 |  6,104 |  1,081 |  1,000 |
| `prover.openings_time_ms` |  186.83 |  1,121 |  189 |  185 |
| `prover.rap_constraints.logup_gkr_time_ms` |  181.33 |  1,088 |  234 |  170 |
| `prover.rap_constraints.round0_time_ms` |  522.83 |  3,137 |  528 |  515 |
| `prover.rap_constraints.mle_rounds_time_ms` |  312 |  1,872 |  331 |  308 |
| `prover.openings.stacked_reduction_time_ms` |  145 |  870 |  146 |  144 |
| `prover.openings.stacked_reduction.round0_time_ms` |  84.50 |  507 |  85 |  84 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  60 |  360 |  60 |  60 |
| `prover.openings.whir_time_ms` |  41.33 |  248 |  44 |  39 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,125.50 |  2,251 |  1,458 |  793 |
| `execute_preflight_time_ms` |  5.50 |  11 |  6 |  5 |
| `trace_gen_time_ms   ` |  140.50 |  281 |  188 |  93 |
| `generate_blob_total_time_ms` |  24.50 |  49 |  33 |  16 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  984.50 |  1,969 |  1,269 |  700 |
| `prover.main_trace_commit_time_ms` |  553 |  1,106 |  728 |  378 |
| `prover.rap_constraints_time_ms` |  325 |  650 |  416 |  234 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/6659be49555b8a2987f28818cf4f08a2cd547dc9/keccak-6659be49555b8a2987f28818cf4f08a2cd547dc9.memory.svg)
...
| app_proof |  |  |  |  |  | 2,182 |  |  | 138 | 14,365,133 | 103.82 | 0 | 13,806 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 39 | 525 | 39 | 14 | 4 | 2 | 2 | 2 | 
| internal_recursive.0 | 1 | 15 | 195 | 14 | 2 | 1 | 2 | 2 | 2 | 
| internal_recursive.1 | 1 | 9 | 153 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 188 | 1,458 | 188 | 69 | 33 | 6 | 7 | 7 | 
| leaf | 1 | 93 | 793 | 93 | 32 | 16 | 5 | 7 | 8 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 81,415,028 | 486 | 246 | 0 | 14 | 179 | 48 | 47 | 94 | 36 | 0 | 59 | 20 | 39 | 8 | 30 | 247 | 179 | 0 | 2 | 35 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,879 | 180 | 50 | 0 | 4 | 77 | 24 | 23 | 29 | 23 | 0 | 51 | 27 | 24 | 2 | 22 | 50 | 77 | 0 | 2 | 22 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 144 | 34 | 0 | 4 | 68 | 24 | 23 | 24 | 19 | 0 | 41 | 18 | 22 | 1 | 21 | 34 | 68 | 0 | 2 | 18 | 0 | 0 | 
| leaf | 0 | prover | 476,578,662 | 1,269 | 728 | 0 | 47 | 416 | 207 | 206 | 120 | 88 | 0 | 124 | 37 | 86 | 40 | 45 | 728 | 416 | 0 | 6 | 88 | 0 | 0 | 
| leaf | 1 | prover | 240,255,732 | 700 | 377 | 0 | 24 | 234 | 110 | 109 | 68 | 56 | 0 | 86 | 34 | 52 | 20 | 32 | 378 | 234 | 0 | 5 | 55 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 857,743,372 | 2,145 | 876 | 0 | 255 | 1,081 | 515 | 514 | 331 | 234 | 65 | 187 | 41 | 146 | 85 | 60 | 876 | 1,081 | 0 | 3 | 168 | 0 | 0 | 
| app_proof | prover | 1 | 857,820,172 | 1,868 | 678 | 0 | 59 | 1,000 | 521 | 521 | 308 | 170 | 0 | 189 | 44 | 144 | 84 | 60 | 679 | 1,000 | 0 | 3 | 169 | 0 | 0 | 
| app_proof | prover | 2 | 857,820,172 | 1,870 | 681 | 0 | 58 | 1,001 | 521 | 520 | 308 | 171 | 0 | 187 | 42 | 145 | 84 | 60 | 681 | 1,001 | 0 | 3 | 170 | 0 | 0 | 
| app_proof | prover | 3 | 857,820,172 | 1,877 | 681 | 0 | 58 | 1,009 | 528 | 527 | 308 | 171 | 0 | 187 | 42 | 145 | 84 | 60 | 681 | 1,009 | 0 | 3 | 171 | 0 | 0 | 
| app_proof | prover | 4 | 857,820,172 | 1,875 | 683 | 0 | 59 | 1,006 | 526 | 525 | 308 | 171 | 0 | 185 | 39 | 145 | 85 | 60 | 683 | 1,006 | 0 | 3 | 170 | 0 | 0 | 
| app_proof | prover | 5 | 857,743,372 | 1,874 | 680 | 0 | 58 | 1,007 | 526 | 526 | 309 | 171 | 0 | 186 | 40 | 145 | 85 | 60 | 680 | 1,007 | 0 | 3 | 170 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 157 | 2,550 | 157 | 160 | 0 | 3 | 87 | 2,413,000 | 32.15 | 
| app_proof | 1 | 34 | 2,278 | 34 | 41 | 0 | 1 | 334 | 2,413,000 | 35.53 | 
| app_proof | 2 | 34 | 2,211 | 34 | 41 | 0 | 1 | 265 | 2,413,000 | 36.13 | 
| app_proof | 3 | 34 | 2,219 | 34 | 41 | 0 | 1 | 266 | 2,413,000 | 36.16 | 
| app_proof | 4 | 34 | 2,220 | 34 | 41 | 0 | 1 | 269 | 2,413,000 | 36.24 | 
| app_proof | 5 | 33 | 2,182 | 33 | 41 | 0 | 1 | 234 | 2,300,133 | 36.07 | 

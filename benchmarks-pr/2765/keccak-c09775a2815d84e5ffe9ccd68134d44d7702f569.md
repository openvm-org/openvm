...
| `total_proof_time_ms ` |  2,232.67 |  13,396 |  2,516 |  2,134 |
...
| `execute_preflight_time_ms` |  240.17 |  1,441 |  331 |  86 |
| `execute_preflight_insn_mi/s` |  35.23 | -          |  36.26 |  32.37 |
| `trace_gen_time_ms   ` |  53.33 |  320 |  151 |  33 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,877.33 |  11,264 |  2,117 |  1,826 |
| `prover.main_trace_commit_time_ms` |  701.67 |  4,210 |  870 |  667 |
| `prover.rap_constraints_time_ms` |  992.50 |  5,955 |  1,063 |  976 |
| `prover.openings_time_ms` |  182.17 |  1,093 |  184 |  181 |
| `prover.rap_constraints.logup_gkr_time_ms` |  178.83 |  1,073 |  234 |  167 |
| `prover.rap_constraints.round0_time_ms` |  510.17 |  3,061 |  513 |  505 |
| `prover.rap_constraints.mle_rounds_time_ms` |  302.50 |  1,815 |  324 |  296 |
...
| `prover.openings.whir_time_ms` |  40.83 |  245 |  44 |  40 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,102 |  2,204 |  1,428 |  776 |
| `execute_preflight_time_ms` |  5.50 |  11 |  6 |  5 |
| `trace_gen_time_ms   ` |  137 |  274 |  183 |  91 |
| `generate_blob_total_time_ms` |  24.50 |  49 |  33 |  16 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  964.50 |  1,929 |  1,244 |  685 |
| `prover.main_trace_commit_time_ms` |  540 |  1,080 |  711 |  369 |
| `prover.rap_constraints_time_ms` |  317 |  634 |  407 |  227 |
| `prover.openings_time_ms` |  106.50 |  213 |  125 |  88 |
...
| `prover.openings.whir_time_ms` |  37.50 |  75 |  39 |  36 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/c09775a2815d84e5ffe9ccd68134d44d7702f569/keccak-c09775a2815d84e5ffe9ccd68134d44d7702f569.memory.svg)
...
| app_proof |  |  |  |  |  | 2,134 |  |  | 138 | 14,365,133 | 103.64 | 0 | 13,542 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 38 | 513 | 37 | 13 | 4 | 3 | 2 | 2 | 
| internal_recursive.0 | 1 | 13 | 184 | 13 | 2 | 1 | 2 | 2 | 2 | 
| internal_recursive.1 | 1 | 9 | 153 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 183 | 1,428 | 183 | 65 | 33 | 6 | 7 | 7 | 
| leaf | 1 | 91 | 776 | 91 | 32 | 16 | 5 | 7 | 7 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 81,415,028 | 475 | 241 | 0 | 14 | 174 | 48 | 47 | 91 | 35 | 0 | 58 | 20 | 38 | 7 | 30 | 241 | 174 | 0 | 3 | 34 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,879 | 170 | 50 | 0 | 4 | 76 | 23 | 23 | 29 | 23 | 0 | 42 | 18 | 24 | 1 | 22 | 51 | 76 | 0 | 2 | 22 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 143 | 33 | 0 | 4 | 65 | 23 | 22 | 24 | 17 | 0 | 44 | 21 | 22 | 1 | 21 | 33 | 65 | 0 | 2 | 17 | 0 | 0 | 
| leaf | 0 | prover | 476,578,662 | 1,244 | 711 | 0 | 47 | 407 | 198 | 197 | 119 | 89 | 0 | 125 | 39 | 85 | 40 | 45 | 711 | 407 | 0 | 6 | 87 | 0 | 0 | 
| leaf | 1 | prover | 240,255,732 | 685 | 368 | 0 | 24 | 227 | 106 | 105 | 66 | 54 | 0 | 88 | 36 | 51 | 19 | 31 | 369 | 227 | 0 | 5 | 54 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 857,743,372 | 2,117 | 870 | 0 | 261 | 1,063 | 505 | 504 | 324 | 234 | 66 | 183 | 40 | 142 | 82 | 60 | 870 | 1,063 | 0 | 3 | 166 | 0 | 0 | 
| app_proof | prover | 1 | 857,820,172 | 1,829 | 667 | 0 | 59 | 977 | 512 | 512 | 296 | 167 | 0 | 184 | 44 | 140 | 81 | 59 | 667 | 977 | 0 | 3 | 166 | 0 | 0 | 
| app_proof | prover | 2 | 857,820,172 | 1,831 | 668 | 0 | 58 | 979 | 511 | 511 | 299 | 168 | 0 | 183 | 41 | 141 | 81 | 59 | 668 | 979 | 0 | 3 | 167 | 0 | 0 | 
| app_proof | prover | 3 | 857,820,172 | 1,826 | 668 | 0 | 59 | 976 | 509 | 508 | 299 | 168 | 0 | 181 | 40 | 140 | 81 | 58 | 668 | 976 | 0 | 3 | 167 | 0 | 0 | 
| app_proof | prover | 4 | 857,820,172 | 1,832 | 668 | 0 | 58 | 981 | 513 | 513 | 298 | 168 | 0 | 181 | 40 | 141 | 82 | 59 | 669 | 981 | 0 | 3 | 167 | 0 | 0 | 
| app_proof | prover | 5 | 857,743,372 | 1,829 | 668 | 0 | 58 | 979 | 511 | 510 | 299 | 168 | 0 | 181 | 40 | 141 | 82 | 59 | 668 | 979 | 0 | 3 | 167 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 151 | 2,516 | 151 | 162 | 0 | 3 | 86 | 2,413,000 | 32.37 | 
| app_proof | 1 | 34 | 2,236 | 34 | 41 | 0 | 1 | 331 | 2,413,000 | 35.69 | 
| app_proof | 2 | 34 | 2,170 | 34 | 41 | 0 | 1 | 263 | 2,413,000 | 35.97 | 
| app_proof | 3 | 34 | 2,165 | 34 | 41 | 0 | 1 | 263 | 2,413,000 | 36.26 | 
| app_proof | 4 | 34 | 2,175 | 34 | 41 | 0 | 1 | 268 | 2,413,000 | 35.07 | 
| app_proof | 5 | 33 | 2,134 | 33 | 41 | 0 | 1 | 230 | 2,300,133 | 36.03 | 

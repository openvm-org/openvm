...
|:---|---:|---:|---:|
| Total |  11.79 |  4.88 |  4.88 |
| app_proof |  9.62 |  2.72 |  2.72 |
| leaf |  1.43 |  1.43 |  1.43 |
...
| `total_proof_time_ms ` |  2,382.50 |  9,530 |  2,629 |  2,273 |
...
| `execute_preflight_time_ms` |  162 |  648 |  208 |  98 |
| `execute_preflight_insn_mi/s` |  37.45 | -          |  38.67 |  34.08 |
| `trace_gen_time_ms   ` |  102.50 |  410 |  169 |  58 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  2,045.50 |  8,182 |  2,198 |  1,968 |
| `prover.main_trace_commit_time_ms` |  558 |  2,232 |  666 |  521 |
| `prover.rap_constraints_time_ms` |  1,338.75 |  5,355 |  1,383 |  1,296 |
| `prover.openings_time_ms` |  147.75 |  591 |  150 |  145 |
| `prover.rap_constraints.logup_gkr_time_ms` |  356.75 |  1,427 |  403 |  308 |
| `prover.rap_constraints.round0_time_ms` |  663 |  2,652 |  674 |  656 |
| `prover.rap_constraints.mle_rounds_time_ms` |  318.50 |  1,274 |  321 |  316 |
| `prover.openings.stacked_reduction_time_ms` |  109.50 |  438 |  112 |  107 |
| `prover.openings.stacked_reduction.round0_time_ms` |  62.25 |  249 |  63 |  61 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  47 |  188 |  48 |  46 |
| `prover.openings.whir_time_ms` |  37.75 |  151 |  40 |  36 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/3ae8395d3080eebf45b41aff2e83f8aff2f408d8/sha2_bench-3ae8395d3080eebf45b41aff2e83f8aff2f408d8.memory.svg)
...
| app_proof |  |  |  |  |  | 2,273 |  |  | 93 | 11,167,961 | 119.44 | 0 | 9,630 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 61,220,603 | 376 | 187 | 0 | 10 | 134 | 36 | 36 | 64 | 32 | 0 | 54 | 20 | 33 | 5 | 27 | 187 | 134 | 0 | 2 | 31 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,879 | 170 | 51 | 0 | 3 | 77 | 24 | 24 | 29 | 23 | 0 | 41 | 17 | 23 | 1 | 21 | 52 | 77 | 0 | 2 | 22 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 142 | 33 | 0 | 3 | 66 | 23 | 22 | 24 | 18 | 0 | 41 | 18 | 22 | 1 | 20 | 34 | 66 | 0 | 2 | 18 | 0 | 0 | 
| leaf | 0 | prover | 424,379,238 | 1,277 | 799 | 0 | 195 | 351 | 170 | 169 | 103 | 78 | 0 | 125 | 46 | 78 | 36 | 42 | 800 | 351 | 0 | 6 | 77 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 662,392,121 | 2,198 | 665 | 0 | 187 | 1,383 | 659 | 658 | 321 | 403 | 96 | 148 | 36 | 112 | 63 | 48 | 666 | 1,383 | 0 | 3 | 305 | 0 | 0 | 
| app_proof | prover | 1 | 662,391,820 | 2,047 | 521 | 0 | 39 | 1,376 | 656 | 655 | 320 | 400 | 112 | 148 | 38 | 110 | 63 | 47 | 521 | 1,376 | 0 | 3 | 286 | 0 | 0 | 
| app_proof | prover | 2 | 662,391,820 | 1,968 | 522 | 0 | 39 | 1,300 | 674 | 673 | 317 | 308 | 0 | 145 | 37 | 107 | 61 | 46 | 522 | 1,300 | 0 | 3 | 307 | 0 | 0 | 
| app_proof | prover | 3 | 662,468,884 | 1,969 | 523 | 0 | 41 | 1,296 | 663 | 662 | 316 | 316 | 0 | 150 | 40 | 109 | 62 | 47 | 523 | 1,296 | 0 | 3 | 315 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 169 | 2,629 | 169 | 162 | 0 | 3 | 98 | 2,851,000 | 34.08 | 
| app_proof | 1 | 58 | 2,355 | 58 | 41 | 0 | 2 | 208 | 2,851,000 | 38.44 | 
| app_proof | 2 | 89 | 2,273 | 89 | 41 | 0 | 2 | 174 | 2,851,000 | 38.61 | 
| app_proof | 3 | 94 | 2,273 | 94 | 41 | 0 | 2 | 168 | 2,614,961 | 38.67 | 

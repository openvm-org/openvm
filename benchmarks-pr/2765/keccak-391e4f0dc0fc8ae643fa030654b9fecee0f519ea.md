...
|:---|---:|---:|---:|
| Total |  16.64 |  4.89 |  4.89 |
| app_proof |  13.64 |  2.66 |  2.66 |
| leaf |  2.20 |  1.43 |  1.43 |
...
| `total_proof_time_ms ` |  2,250.17 |  13,501 |  2,520 |  2,160 |
| `execute_metered_time_ms` |  141 | -          | -          | -          |
| `execute_metered_insns` |  14,365,133 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  101.48 | -          |  101.48 |  101.48 |
| `execute_preflight_insns` |  2,394,188.83 |  14,365,133 |  2,413,000 |  2,300,133 |
| `execute_preflight_time_ms` |  241.33 |  1,448 |  322 |  92 |
| `execute_preflight_insn_mi/s` |  32.56 | -          |  33.25 |  29.69 |
| `trace_gen_time_ms   ` |  53.33 |  320 |  151 |  33 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,894 |  11,364 |  2,116 |  1,847 |
| `prover.main_trace_commit_time_ms` |  709.67 |  4,258 |  874 |  676 |
| `prover.rap_constraints_time_ms` |  1,001.83 |  6,011 |  1,057 |  986 |
| `prover.openings_time_ms` |  181.33 |  1,088 |  184 |  179 |
| `prover.rap_constraints.logup_gkr_time_ms` |  173.50 |  1,041 |  223 |  163 |
| `prover.rap_constraints.round0_time_ms` |  516.83 |  3,101 |  522 |  507 |
| `prover.rap_constraints.mle_rounds_time_ms` |  310.17 |  1,861 |  326 |  306 |
| `prover.openings.stacked_reduction_time_ms` |  137.17 |  823 |  138 |  137 |
...
| `prover.openings.whir_time_ms` |  43.83 |  263 |  47 |  42 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,100 |  2,200 |  1,429 |  771 |
| `execute_preflight_time_ms` |  5.50 |  11 |  6 |  5 |
| `trace_gen_time_ms   ` |  136.50 |  273 |  181 |  92 |
| `generate_blob_total_time_ms` |  24.50 |  49 |  33 |  16 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  963.50 |  1,927 |  1,248 |  679 |
| `prover.main_trace_commit_time_ms` |  550.50 |  1,101 |  725 |  376 |
| `prover.rap_constraints_time_ms` |  319.50 |  639 |  410 |  229 |
| `prover.openings_time_ms` |  92.50 |  185 |  112 |  73 |
...
| `prover.openings.whir_time_ms` |  38.50 |  77 |  41 |  36 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/391e4f0dc0fc8ae643fa030654b9fecee0f519ea/keccak-391e4f0dc0fc8ae643fa030654b9fecee0f519ea.memory.svg)
...
| app_proof |  |  |  |  |  | 2,160 |  |  | 141 | 14,365,133 | 101.48 | 0 | 13,650 |  | 
...
| internal_recursive.0 | 1 | 13 | 168 | 13 | 2 | 1 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 9 | 129 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 181 | 1,429 | 180 | 64 | 33 | 6 | 7 | 7 | 
| leaf | 1 | 92 | 771 | 91 | 32 | 16 | 5 | 7 | 7 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 81,415,028 | 462 | 244 | 0 | 1 | 171 | 48 | 48 | 91 | 31 | 0 | 45 | 21 | 23 | 7 | 15 | 244 | 171 | 0 | 2 | 30 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,879 | 154 | 48 | 0 | 0 | 72 | 25 | 24 | 29 | 17 | 0 | 32 | 23 | 8 | 1 | 6 | 49 | 72 | 0 | 2 | 17 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 120 | 32 | 0 | 0 | 61 | 24 | 23 | 24 | 13 | 0 | 25 | 18 | 7 | 1 | 5 | 32 | 61 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 476,578,662 | 1,248 | 724 | 0 | 2 | 410 | 204 | 203 | 119 | 86 | 0 | 112 | 41 | 70 | 40 | 30 | 725 | 410 | 0 | 7 | 85 | 0 | 0 | 
| leaf | 1 | prover | 240,255,732 | 679 | 375 | 0 | 1 | 229 | 110 | 109 | 67 | 50 | 0 | 73 | 36 | 37 | 19 | 17 | 376 | 229 | 0 | 6 | 50 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 857,743,372 | 2,116 | 874 | 0 | 202 | 1,057 | 507 | 506 | 326 | 223 | 68 | 184 | 45 | 138 | 84 | 54 | 874 | 1,057 | 0 | 4 | 154 | 0 | 0 | 
| app_proof | prover | 1 | 857,820,172 | 1,847 | 676 | 0 | 2 | 986 | 514 | 513 | 307 | 164 | 0 | 184 | 47 | 137 | 84 | 52 | 676 | 986 | 0 | 3 | 163 | 0 | 0 | 
| app_proof | prover | 2 | 857,820,172 | 1,851 | 677 | 0 | 3 | 991 | 518 | 518 | 308 | 163 | 0 | 181 | 44 | 137 | 83 | 53 | 678 | 991 | 0 | 4 | 162 | 0 | 0 | 
| app_proof | prover | 3 | 857,820,172 | 1,850 | 676 | 0 | 3 | 993 | 521 | 521 | 307 | 163 | 0 | 180 | 42 | 137 | 83 | 53 | 677 | 993 | 0 | 4 | 162 | 0 | 0 | 
| app_proof | prover | 4 | 857,820,172 | 1,848 | 677 | 0 | 3 | 990 | 519 | 519 | 306 | 164 | 0 | 179 | 42 | 137 | 84 | 53 | 677 | 990 | 0 | 4 | 163 | 0 | 0 | 
| app_proof | prover | 5 | 857,743,372 | 1,852 | 676 | 0 | 3 | 994 | 522 | 522 | 307 | 164 | 0 | 180 | 43 | 137 | 83 | 53 | 676 | 994 | 0 | 3 | 163 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 151 | 2,520 | 151 | 160 | 0 | 3 | 92 | 2,413,000 | 29.69 | 
| app_proof | 1 | 34 | 2,245 | 34 | 41 | 0 | 1 | 322 | 2,413,000 | 33 | 
| app_proof | 2 | 34 | 2,192 | 34 | 41 | 0 | 1 | 266 | 2,413,000 | 33.20 | 
| app_proof | 3 | 34 | 2,192 | 34 | 41 | 0 | 1 | 266 | 2,413,000 | 33.25 | 
| app_proof | 4 | 34 | 2,192 | 34 | 41 | 0 | 1 | 269 | 2,413,000 | 33.14 | 
| app_proof | 5 | 33 | 2,160 | 33 | 41 | 0 | 1 | 233 | 2,300,133 | 33.05 | 

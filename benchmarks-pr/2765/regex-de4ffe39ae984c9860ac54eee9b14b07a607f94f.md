...
| `total_proof_time_ms ` |  802.50 |  1,605 |  891 |  714 |
| `execute_metered_time_ms` |  31 | -          | -          | -          |
| `execute_metered_insns` |  4,090,656 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  129.42 | -          |  129.42 |  129.42 |
| `execute_preflight_insns` |  2,045,328 |  4,090,656 |  2,327,000 |  1,763,656 |
| `execute_preflight_time_ms` |  81.50 |  163 |  87 |  76 |
| `execute_preflight_insn_mi/s` |  34.54 | -          |  36.48 |  32.61 |
| `trace_gen_time_ms   ` |  145.50 |  291 |  146 |  145 |
| `memory_finalize_time_ms` |  1 |  2 |  2 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  472.50 |  945 |  495 |  450 |
| `prover.main_trace_commit_time_ms` |  129 |  258 |  145 |  113 |
| `prover.rap_constraints_time_ms` |  287 |  574 |  291 |  283 |
| `prover.openings_time_ms` |  55.50 |  111 |  58 |  53 |
| `prover.rap_constraints.logup_gkr_time_ms` |  154 |  308 |  164 |  144 |
| `prover.rap_constraints.round0_time_ms` |  91 |  182 |  102 |  80 |
| `prover.rap_constraints.mle_rounds_time_ms` |  41 |  82 |  46 |  36 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/de4ffe39ae984c9860ac54eee9b14b07a607f94f/regex-de4ffe39ae984c9860ac54eee9b14b07a607f94f.memory.svg)
...
| app_proof |  |  |  |  |  | 714 |  |  | 31 | 4,090,656 | 129.42 | 0 | 1,651 |  | 
| internal_for_leaf |  |  |  | 247 |  |  |  |  |  |  |  |  |  | 247 | 
| internal_recursive.0 |  |  |  | 172 |  |  |  |  |  |  |  |  |  | 173 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 15 | 247 | 15 | 4 | 0 | 2 | 1 | 1 | 
| internal_recursive.0 | 1 | 10 | 172 | 9 | 1 | 0 | 2 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 27,256,571 | 232 | 84 | 0 | 5 | 102 | 31 | 30 | 45 | 25 | 0 | 44 | 18 | 26 | 2 | 23 | 85 | 102 | 0 | 2 | 24 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,703 | 162 | 47 | 0 | 4 | 71 | 24 | 23 | 27 | 19 | 0 | 43 | 19 | 23 | 1 | 21 | 48 | 71 | 0 | 2 | 19 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 148 | 34 | 0 | 4 | 67 | 23 | 23 | 24 | 19 | 0 | 46 | 23 | 22 | 1 | 21 | 34 | 67 | 0 | 2 | 18 | 0 | 0 | 
| leaf | 0 | prover | 79,962,868 | 328 | 130 | 0 | 8 | 138 | 53 | 52 | 37 | 47 | 0 | 59 | 28 | 30 | 6 | 24 | 130 | 138 | 0 | 5 | 46 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 179,663,570 | 495 | 145 | 0 | 10 | 291 | 80 | 80 | 46 | 164 | 0 | 58 | 22 | 36 | 15 | 21 | 145 | 291 | 0 | 3 | 162 | 0 | 0 | 
| app_proof | prover | 1 | 133,369,433 | 450 | 113 | 0 | 17 | 283 | 102 | 102 | 36 | 144 | 0 | 53 | 22 | 30 | 10 | 19 | 113 | 283 | 0 | 3 | 143 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 145 | 891 | 145 | 162 | 2 | 6 | 87 | 2,327,000 | 32.61 | 
| app_proof | 1 | 146 | 714 | 146 | 41 | 0 | 2 | 76 | 1,763,656 | 36.48 | 

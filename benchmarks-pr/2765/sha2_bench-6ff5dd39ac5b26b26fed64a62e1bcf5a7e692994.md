...
|:---|---:|---:|---:|
| Total |  11.79 |  4.90 |  4.90 |
| app_proof |  9.63 |  2.74 |  2.74 |
| leaf |  1.42 |  1.42 |  1.42 |
...
| `total_proof_time_ms ` |  2,381.75 |  9,527 |  2,636 |  2,267 |
| `execute_metered_time_ms` |  108 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  102.69 | -          |  102.69 |  102.69 |
| `execute_preflight_insns` |  2,791,990.25 |  11,167,961 |  2,851,000 |  2,614,961 |
| `execute_preflight_time_ms` |  163.25 |  653 |  208 |  96 |
| `execute_preflight_insn_mi/s` |  37.56 | -          |  38.64 |  34.81 |
| `trace_gen_time_ms   ` |  102.50 |  410 |  173 |  58 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  2,044 |  8,176 |  2,204 |  1,960 |
| `prover.main_trace_commit_time_ms` |  559 |  2,236 |  667 |  523 |
| `prover.rap_constraints_time_ms` |  1,335.50 |  5,342 |  1,385 |  1,291 |
| `prover.openings_time_ms` |  148.25 |  593 |  150 |  145 |
| `prover.rap_constraints.logup_gkr_time_ms` |  356.25 |  1,425 |  404 |  308 |
| `prover.rap_constraints.round0_time_ms` |  655.75 |  2,623 |  662 |  651 |
| `prover.rap_constraints.mle_rounds_time_ms` |  322.25 |  1,289 |  325 |  320 |
| `prover.openings.stacked_reduction_time_ms` |  109.50 |  438 |  111 |  109 |
| `prover.openings.stacked_reduction.round0_time_ms` |  62 |  248 |  62 |  62 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  46.75 |  187 |  48 |  46 |
| `prover.openings.whir_time_ms` |  38.25 |  153 |  40 |  36 |
...
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,273 |  1,273 |  1,273 |  1,273 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/6ff5dd39ac5b26b26fed64a62e1bcf5a7e692994/sha2_bench-6ff5dd39ac5b26b26fed64a62e1bcf5a7e692994.memory.svg)
...
| app_proof |  |  |  |  |  | 2,271 |  |  | 108 | 11,167,961 | 102.69 | 0 | 9,643 |  | 
| internal_for_leaf |  |  |  | 401 |  |  |  |  |  |  |  |  |  | 401 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 24 | 401 | 24 | 7 | 2 | 2 | 3 | 3 | 
| internal_recursive.0 | 1 | 12 | 180 | 12 | 2 | 0 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 9 | 154 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 148 | 1,421 | 148 | 54 | 25 | 3 | 6 | 6 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 61,220,603 | 376 | 186 | 0 | 11 | 135 | 36 | 36 | 64 | 33 | 0 | 53 | 19 | 34 | 5 | 28 | 187 | 135 | 0 | 2 | 32 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,879 | 168 | 50 | 0 | 4 | 73 | 22 | 22 | 29 | 21 | 0 | 43 | 19 | 24 | 1 | 22 | 51 | 73 | 0 | 2 | 20 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 145 | 34 | 0 | 4 | 68 | 25 | 24 | 24 | 18 | 0 | 41 | 19 | 22 | 1 | 21 | 34 | 68 | 0 | 2 | 17 | 0 | 0 | 
| leaf | 0 | prover | 424,379,238 | 1,273 | 801 | 0 | 194 | 354 | 170 | 169 | 105 | 78 | 0 | 116 | 37 | 78 | 35 | 42 | 801 | 354 | 0 | 6 | 77 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 662,392,121 | 2,204 | 667 | 0 | 186 | 1,385 | 655 | 655 | 325 | 404 | 95 | 150 | 39 | 111 | 62 | 48 | 667 | 1,385 | 0 | 3 | 308 | 0 | 0 | 
| app_proof | prover | 1 | 662,391,820 | 2,045 | 523 | 0 | 39 | 1,374 | 651 | 651 | 324 | 397 | 111 | 148 | 38 | 109 | 62 | 46 | 523 | 1,374 | 0 | 3 | 285 | 0 | 0 | 
| app_proof | prover | 2 | 662,391,820 | 1,960 | 523 | 0 | 39 | 1,291 | 662 | 661 | 320 | 308 | 0 | 145 | 36 | 109 | 62 | 46 | 523 | 1,291 | 0 | 3 | 307 | 0 | 0 | 
| app_proof | prover | 3 | 662,468,884 | 1,967 | 523 | 0 | 41 | 1,292 | 655 | 654 | 320 | 316 | 0 | 150 | 40 | 109 | 62 | 47 | 523 | 1,292 | 0 | 3 | 315 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 173 | 2,636 | 173 | 162 | 0 | 3 | 96 | 2,851,000 | 34.81 | 
| app_proof | 1 | 58 | 2,353 | 58 | 41 | 0 | 2 | 208 | 2,851,000 | 38.18 | 
| app_proof | 2 | 88 | 2,267 | 88 | 41 | 0 | 2 | 178 | 2,851,000 | 38.64 | 
| app_proof | 3 | 91 | 2,271 | 91 | 41 | 0 | 2 | 171 | 2,614,961 | 38.61 | 

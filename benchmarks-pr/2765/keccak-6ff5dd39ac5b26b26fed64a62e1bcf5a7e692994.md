...
|:---|---:|---:|---:|
| Total |  16.90 |  5.01 |  5.01 |
| app_proof |  13.79 |  2.70 |  2.70 |
| leaf |  2.25 |  1.46 |  1.46 |
...
| `total_proof_time_ms ` |  2,275.50 |  13,653 |  2,557 |  2,179 |
| `execute_metered_time_ms` |  141 | -          | -          | -          |
| `execute_metered_insns` |  14,365,133 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  101.85 | -          |  101.85 |  101.85 |
| `execute_preflight_insns` |  2,394,188.83 |  14,365,133 |  2,413,000 |  2,300,133 |
| `execute_preflight_time_ms` |  236.33 |  1,418 |  320 |  86 |
| `execute_preflight_insn_mi/s` |  35.33 | -          |  36.43 |  32.10 |
| `trace_gen_time_ms   ` |  54.50 |  327 |  158 |  33 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,922.67 |  11,536 |  2,150 |  1,875 |
| `prover.main_trace_commit_time_ms` |  717 |  4,302 |  881 |  683 |
| `prover.rap_constraints_time_ms` |  1,015.83 |  6,095 |  1,076 |  1,001 |
| `prover.openings_time_ms` |  188.50 |  1,131 |  191 |  185 |
| `prover.rap_constraints.logup_gkr_time_ms` |  181.33 |  1,088 |  233 |  170 |
| `prover.rap_constraints.round0_time_ms` |  519.67 |  3,118 |  526 |  508 |
| `prover.rap_constraints.mle_rounds_time_ms` |  314 |  1,884 |  334 |  309 |
| `prover.openings.stacked_reduction_time_ms` |  146.33 |  878 |  150 |  144 |
| `prover.openings.stacked_reduction.round0_time_ms` |  85.17 |  511 |  88 |  83 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  60.83 |  365 |  61 |  60 |
| `prover.openings.whir_time_ms` |  41.83 |  251 |  45 |  40 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,124.50 |  2,249 |  1,455 |  794 |
| `execute_preflight_time_ms` |  5.50 |  11 |  6 |  5 |
| `trace_gen_time_ms   ` |  136.50 |  273 |  181 |  92 |
| `generate_blob_total_time_ms` |  24.50 |  49 |  33 |  16 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  987.50 |  1,975 |  1,273 |  702 |
| `prover.main_trace_commit_time_ms` |  554.50 |  1,109 |  729 |  380 |
| `prover.rap_constraints_time_ms` |  326.50 |  653 |  418 |  235 |
...
| `prover.rap_constraints.mle_rounds_time_ms` |  94.50 |  189 |  121 |  68 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/6ff5dd39ac5b26b26fed64a62e1bcf5a7e692994/keccak-6ff5dd39ac5b26b26fed64a62e1bcf5a7e692994.memory.svg)
...
| app_proof |  |  |  |  |  | 2,179 |  |  | 141 | 14,365,133 | 101.85 | 0 | 13,801 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 38 | 523 | 38 | 13 | 4 | 2 | 2 | 2 | 
| internal_recursive.0 | 1 | 13 | 186 | 13 | 2 | 1 | 2 | 2 | 2 | 
| internal_recursive.1 | 1 | 9 | 150 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 181 | 1,455 | 181 | 64 | 33 | 6 | 7 | 7 | 
| leaf | 1 | 92 | 794 | 91 | 32 | 16 | 5 | 7 | 7 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 81,415,028 | 485 | 248 | 0 | 14 | 179 | 49 | 48 | 93 | 36 | 0 | 57 | 18 | 39 | 7 | 31 | 248 | 179 | 0 | 3 | 35 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,879 | 172 | 50 | 0 | 4 | 77 | 24 | 23 | 29 | 23 | 0 | 43 | 19 | 24 | 1 | 22 | 51 | 77 | 0 | 2 | 23 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 141 | 34 | 0 | 4 | 66 | 23 | 22 | 24 | 18 | 0 | 40 | 17 | 22 | 1 | 21 | 35 | 66 | 0 | 2 | 17 | 0 | 0 | 
| leaf | 0 | prover | 476,578,662 | 1,273 | 729 | 0 | 47 | 418 | 207 | 207 | 121 | 88 | 0 | 125 | 38 | 87 | 41 | 45 | 729 | 418 | 0 | 6 | 87 | 0 | 0 | 
| leaf | 1 | prover | 240,255,732 | 702 | 379 | 0 | 24 | 235 | 110 | 109 | 68 | 56 | 0 | 86 | 33 | 53 | 20 | 32 | 380 | 235 | 0 | 6 | 55 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 857,743,372 | 2,150 | 881 | 0 | 258 | 1,076 | 508 | 508 | 334 | 233 | 64 | 191 | 41 | 150 | 88 | 61 | 881 | 1,076 | 0 | 3 | 167 | 0 | 0 | 
| app_proof | prover | 1 | 857,820,172 | 1,880 | 683 | 0 | 58 | 1,005 | 522 | 521 | 310 | 172 | 0 | 191 | 45 | 146 | 85 | 61 | 683 | 1,005 | 0 | 3 | 172 | 0 | 0 | 
| app_proof | prover | 2 | 857,820,172 | 1,876 | 685 | 0 | 59 | 1,002 | 520 | 520 | 310 | 171 | 0 | 188 | 42 | 146 | 85 | 61 | 685 | 1,002 | 0 | 3 | 170 | 0 | 0 | 
| app_proof | prover | 3 | 857,820,172 | 1,879 | 684 | 0 | 58 | 1,006 | 523 | 523 | 310 | 172 | 0 | 188 | 42 | 145 | 84 | 61 | 684 | 1,006 | 0 | 3 | 171 | 0 | 0 | 
| app_proof | prover | 4 | 857,820,172 | 1,875 | 684 | 0 | 59 | 1,005 | 526 | 525 | 309 | 170 | 0 | 185 | 40 | 144 | 83 | 61 | 684 | 1,005 | 0 | 4 | 169 | 0 | 0 | 
| app_proof | prover | 5 | 857,743,372 | 1,876 | 685 | 0 | 58 | 1,001 | 519 | 519 | 311 | 170 | 0 | 188 | 41 | 147 | 86 | 60 | 685 | 1,001 | 0 | 4 | 169 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 158 | 2,557 | 158 | 162 | 0 | 3 | 86 | 2,413,000 | 32.10 | 
| app_proof | 1 | 34 | 2,276 | 34 | 41 | 0 | 1 | 320 | 2,413,000 | 35.46 | 
| app_proof | 2 | 34 | 2,214 | 34 | 41 | 0 | 1 | 262 | 2,413,000 | 35.95 | 
| app_proof | 3 | 34 | 2,216 | 34 | 41 | 0 | 1 | 262 | 2,413,000 | 36.14 | 
| app_proof | 4 | 34 | 2,211 | 34 | 41 | 0 | 1 | 260 | 2,413,000 | 36.43 | 
| app_proof | 5 | 33 | 2,179 | 33 | 41 | 0 | 1 | 228 | 2,300,133 | 35.91 | 

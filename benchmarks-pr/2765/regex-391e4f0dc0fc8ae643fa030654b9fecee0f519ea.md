...
|:---|---:|---:|---:|
| Total |  2.44 |  1.75 |  1.75 |
| app_proof |  1.58 |  0.90 |  0.90 |
| leaf |  0.35 |  0.35 |  0.35 |
...
| `total_proof_time_ms ` |  775.50 |  1,551 |  866 |  685 |
| `execute_metered_time_ms` |  31 | -          | -          | -          |
| `execute_metered_insns` |  4,090,656 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  129.14 | -          |  129.14 |  129.14 |
| `execute_preflight_insns` |  2,045,328 |  4,090,656 |  2,327,000 |  1,763,656 |
| `execute_preflight_time_ms` |  79.50 |  159 |  85 |  74 |
| `execute_preflight_insn_mi/s` |  35.63 | -          |  37.93 |  33.33 |
| `trace_gen_time_ms   ` |  143.50 |  287 |  144 |  143 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  449 |  898 |  473 |  425 |
| `prover.main_trace_commit_time_ms` |  124 |  248 |  141 |  107 |
| `prover.rap_constraints_time_ms` |  277 |  554 |  281 |  273 |
| `prover.openings_time_ms` |  46.50 |  93 |  49 |  44 |
| `prover.rap_constraints.logup_gkr_time_ms` |  146.50 |  293 |  157 |  136 |
| `prover.rap_constraints.round0_time_ms` |  89.50 |  179 |  100 |  79 |
| `prover.rap_constraints.mle_rounds_time_ms` |  40.50 |  81 |  45 |  36 |
| `prover.openings.stacked_reduction_time_ms` |  24 |  48 |  27 |  21 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/391e4f0dc0fc8ae643fa030654b9fecee0f519ea/regex-391e4f0dc0fc8ae643fa030654b9fecee0f519ea.memory.svg)
...
| frac_sumcheck.segment_tree | 4.39 | app_proof.prover.0 |
| prover.gkr_input_evals | 4.39 | app_proof.prover.0 |
...
| app_proof |  |  |  |  |  | 685 |  |  | 31 | 4,090,656 | 129.14 | 0 | 1,596 |  | 
...
| internal_recursive.1 | 1 | 8 | 130 | 8 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 51 | 354 | 50 | 14 | 3 | 5 | 1 | 1 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 27,256,571 | 207 | 81 | 0 | 0 | 95 | 31 | 30 | 45 | 19 | 0 | 29 | 18 | 11 | 2 | 8 | 82 | 95 | 0 | 2 | 18 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,703 | 140 | 45 | 0 | 0 | 65 | 24 | 23 | 27 | 13 | 0 | 28 | 20 | 8 | 1 | 6 | 46 | 65 | 0 | 2 | 12 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 121 | 31 | 0 | 0 | 60 | 23 | 22 | 24 | 12 | 0 | 29 | 22 | 7 | 1 | 5 | 31 | 60 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 79,962,868 | 303 | 126 | 0 | 0 | 134 | 54 | 53 | 37 | 42 | 0 | 42 | 27 | 15 | 6 | 8 | 126 | 134 | 0 | 5 | 41 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 179,663,570 | 473 | 141 | 0 | 0 | 281 | 79 | 79 | 45 | 157 | 0 | 49 | 21 | 27 | 15 | 12 | 141 | 281 | 0 | 3 | 155 | 0 | 0 | 
| app_proof | prover | 1 | 133,369,433 | 425 | 106 | 0 | 9 | 273 | 100 | 100 | 36 | 136 | 0 | 44 | 22 | 21 | 10 | 11 | 107 | 273 | 0 | 3 | 135 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 143 | 866 | 143 | 163 | 1 | 6 | 85 | 2,327,000 | 33.33 | 
| app_proof | 1 | 144 | 685 | 144 | 40 | 0 | 2 | 74 | 1,763,656 | 37.93 | 

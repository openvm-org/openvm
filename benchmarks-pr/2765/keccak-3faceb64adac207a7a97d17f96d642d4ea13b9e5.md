...
| `total_proof_time_ms ` |  2,245.67 |  13,474 |  2,523 |  2,160 |
| `execute_metered_time_ms` |  138 | -          | -          | -          |
| `execute_metered_insns` |  14,365,133 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  103.62 | -          |  103.62 |  103.62 |
| `execute_preflight_insns` |  2,394,188.83 |  14,365,133 |  2,413,000 |  2,300,133 |
| `execute_preflight_time_ms` |  233.50 |  1,401 |  315 |  85 |
| `execute_preflight_insn_mi/s` |  35.52 | -          |  36.38 |  32.57 |
| `trace_gen_time_ms   ` |  54.17 |  325 |  156 |  33 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,895.83 |  11,375 |  2,118 |  1,844 |
| `prover.main_trace_commit_time_ms` |  706.83 |  4,241 |  871 |  673 |
| `prover.rap_constraints_time_ms` |  1,005.17 |  6,031 |  1,062 |  990 |
| `prover.openings_time_ms` |  182.50 |  1,095 |  185 |  179 |
| `prover.rap_constraints.logup_gkr_time_ms` |  180 |  1,080 |  233 |  169 |
| `prover.rap_constraints.round0_time_ms` |  518.17 |  3,109 |  527 |  502 |
| `prover.rap_constraints.mle_rounds_time_ms` |  306.50 |  1,839 |  327 |  302 |
| `prover.openings.stacked_reduction_time_ms` |  142.67 |  856 |  144 |  141 |
| `prover.openings.stacked_reduction.round0_time_ms` |  82.50 |  495 |  83 |  81 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  59.33 |  356 |  60 |  59 |
| `prover.openings.whir_time_ms` |  39.83 |  239 |  42 |  38 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,107.50 |  2,215 |  1,438 |  777 |
| `execute_preflight_time_ms` |  5.50 |  11 |  6 |  5 |
| `trace_gen_time_ms   ` |  135.50 |  271 |  181 |  90 |
| `generate_blob_total_time_ms` |  24.50 |  49 |  33 |  16 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  971.50 |  1,943 |  1,257 |  686 |
| `prover.main_trace_commit_time_ms` |  547.50 |  1,095 |  720 |  375 |
| `prover.rap_constraints_time_ms` |  318.50 |  637 |  410 |  227 |
| `prover.openings_time_ms` |  104.50 |  209 |  126 |  83 |
| `prover.rap_constraints.logup_gkr_time_ms` |  72 |  144 |  89 |  55 |
| `prover.rap_constraints.round0_time_ms` |  152.50 |  305 |  200 |  105 |
| `prover.rap_constraints.mle_rounds_time_ms` |  93 |  186 |  120 |  66 |
...
| `prover.openings.whir_time_ms` |  35 |  70 |  40 |  30 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/3faceb64adac207a7a97d17f96d642d4ea13b9e5/keccak-3faceb64adac207a7a97d17f96d642d4ea13b9e5.memory.svg)
...
| app_proof |  |  |  |  |  | 2,160 |  |  | 138 | 14,365,133 | 103.62 | 0 | 13,618 |  | 
| internal_for_leaf |  |  |  | 523 |  |  |  |  |  |  |  |  |  | 523 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 38 | 523 | 37 | 13 | 4 | 2 | 2 | 2 | 
| internal_recursive.0 | 1 | 13 | 188 | 13 | 2 | 1 | 2 | 2 | 2 | 
| internal_recursive.1 | 1 | 9 | 150 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 181 | 1,438 | 180 | 64 | 33 | 6 | 7 | 7 | 
| leaf | 1 | 90 | 777 | 90 | 32 | 16 | 5 | 7 | 7 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 81,415,028 | 485 | 243 | 0 | 14 | 176 | 48 | 47 | 91 | 36 | 0 | 64 | 26 | 38 | 7 | 31 | 243 | 176 | 0 | 2 | 35 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,879 | 174 | 50 | 0 | 4 | 77 | 23 | 23 | 29 | 23 | 0 | 45 | 21 | 24 | 1 | 22 | 51 | 77 | 0 | 2 | 23 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 140 | 34 | 0 | 4 | 65 | 23 | 22 | 24 | 18 | 0 | 39 | 17 | 22 | 1 | 21 | 34 | 65 | 0 | 2 | 17 | 0 | 0 | 
| leaf | 0 | prover | 476,578,662 | 1,257 | 720 | 0 | 48 | 410 | 200 | 200 | 120 | 89 | 0 | 126 | 40 | 85 | 40 | 45 | 720 | 410 | 0 | 6 | 88 | 0 | 0 | 
| leaf | 1 | prover | 240,255,732 | 686 | 375 | 0 | 24 | 227 | 105 | 104 | 66 | 55 | 0 | 83 | 30 | 52 | 20 | 32 | 375 | 227 | 0 | 6 | 54 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 857,743,372 | 2,118 | 871 | 0 | 258 | 1,062 | 502 | 501 | 327 | 233 | 64 | 184 | 40 | 144 | 83 | 60 | 871 | 1,062 | 0 | 3 | 167 | 0 | 0 | 
| app_proof | prover | 1 | 857,820,172 | 1,854 | 672 | 0 | 58 | 995 | 522 | 521 | 303 | 169 | 0 | 185 | 42 | 143 | 83 | 60 | 673 | 995 | 0 | 3 | 169 | 0 | 0 | 
| app_proof | prover | 2 | 857,820,172 | 1,853 | 674 | 0 | 58 | 993 | 522 | 521 | 302 | 169 | 0 | 184 | 41 | 143 | 83 | 59 | 674 | 993 | 0 | 3 | 168 | 0 | 0 | 
| app_proof | prover | 3 | 857,820,172 | 1,848 | 674 | 0 | 58 | 991 | 519 | 518 | 302 | 170 | 0 | 181 | 39 | 142 | 82 | 59 | 674 | 991 | 0 | 3 | 169 | 0 | 0 | 
| app_proof | prover | 4 | 857,820,172 | 1,844 | 673 | 0 | 58 | 990 | 517 | 516 | 303 | 170 | 0 | 179 | 38 | 141 | 81 | 59 | 674 | 990 | 0 | 3 | 169 | 0 | 0 | 
| app_proof | prover | 5 | 857,743,372 | 1,858 | 674 | 0 | 58 | 1,000 | 527 | 526 | 302 | 169 | 0 | 182 | 39 | 143 | 83 | 59 | 675 | 1,000 | 0 | 3 | 169 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 156 | 2,523 | 156 | 162 | 0 | 3 | 85 | 2,413,000 | 32.57 | 
| app_proof | 1 | 34 | 2,245 | 34 | 41 | 0 | 1 | 315 | 2,413,000 | 35.82 | 
| app_proof | 2 | 34 | 2,186 | 34 | 41 | 0 | 1 | 257 | 2,413,000 | 36.21 | 
| app_proof | 3 | 34 | 2,182 | 34 | 41 | 0 | 1 | 258 | 2,413,000 | 36.38 | 
| app_proof | 4 | 34 | 2,178 | 34 | 41 | 0 | 1 | 259 | 2,413,000 | 36.20 | 
| app_proof | 5 | 33 | 2,160 | 33 | 41 | 0 | 1 | 227 | 2,300,133 | 35.93 | 

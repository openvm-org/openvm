...
|:---|---:|---:|---:|
| Total |  11.92 |  4.91 |  4.91 |
| app_proof |  9.76 |  2.75 |  2.75 |
| leaf |  1.46 |  1.46 |  1.46 |
...
| `total_proof_time_ms ` |  2,415.75 |  9,663 |  2,660 |  2,292 |
...
| `execute_preflight_time_ms` |  188.75 |  755 |  244 |  104 |
| `execute_preflight_insn_mi/s` |  34.98 | -          |  35.94 |  32.43 |
| `trace_gen_time_ms   ` |  90 |  360 |  168 |  62 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  2,063.75 |  8,255 |  2,221 |  1,981 |
| `prover.main_trace_commit_time_ms` |  564.50 |  2,258 |  676 |  527 |
| `prover.rap_constraints_time_ms` |  1,351.25 |  5,405 |  1,395 |  1,310 |
| `prover.openings_time_ms` |  146.50 |  586 |  150 |  142 |
| `prover.rap_constraints.logup_gkr_time_ms` |  353.75 |  1,415 |  400 |  303 |
| `prover.rap_constraints.round0_time_ms` |  670.75 |  2,683 |  679 |  664 |
| `prover.rap_constraints.mle_rounds_time_ms` |  325.75 |  1,303 |  329 |  323 |
| `prover.openings.stacked_reduction_time_ms` |  103.50 |  414 |  105 |  102 |
| `prover.openings.stacked_reduction.round0_time_ms` |  62.75 |  251 |  64 |  61 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  40.50 |  162 |  41 |  40 |
| `prover.openings.whir_time_ms` |  42.25 |  169 |  45 |  39 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/de73e22d80e2d5770e9a215858dd09cc6e930036/sha2_bench-de73e22d80e2d5770e9a215858dd09cc6e930036.memory.svg)
...
| app_proof |  |  |  |  |  | 2,298 |  |  | 94 | 11,167,961 | 117.57 | 0 | 9,766 |  | 
...
| app_proof | VmAirWrapper<Rv64BaseAluAdapterAir, BaseAluCoreAir<8, 8> | 1 | 7 | 
...
| app_proof | VmAirWrapper<Rv64JalrAdapterAir, Rv64JalrCoreAir> | 1 | 37 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 30 | 393 | 29 | 8 | 2 | 2 | 4 | 4 | 
| internal_recursive.0 | 1 | 15 | 176 | 15 | 2 | 0 | 2 | 2 | 2 | 
| internal_recursive.1 | 1 | 12 | 134 | 12 | 1 | 0 | 2 | 1 | 1 | 
| leaf | 0 | 167 | 1,455 | 167 | 60 | 26 | 3 | 7 | 7 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 61,220,603 | 363 | 185 | 0 | 1 | 135 | 40 | 39 | 67 | 27 | 0 | 41 | 21 | 19 | 5 | 13 | 186 | 135 | 0 | 3 | 26 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,879 | 160 | 49 | 0 | 0 | 75 | 26 | 25 | 31 | 17 | 0 | 34 | 25 | 8 | 2 | 6 | 50 | 75 | 0 | 2 | 17 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 121 | 32 | 0 | 0 | 64 | 24 | 23 | 25 | 14 | 0 | 24 | 17 | 7 | 1 | 5 | 32 | 64 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 424,379,238 | 1,288 | 816 | 0 | 163 | 360 | 176 | 175 | 106 | 77 | 0 | 110 | 45 | 65 | 36 | 29 | 816 | 360 | 0 | 7 | 76 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 662,392,121 | 2,221 | 676 | 0 | 151 | 1,395 | 667 | 666 | 329 | 399 | 105 | 148 | 42 | 105 | 64 | 41 | 676 | 1,395 | 0 | 3 | 292 | 0 | 0 | 
| app_proof | prover | 1 | 662,391,820 | 2,064 | 527 | 0 | 3 | 1,389 | 664 | 664 | 325 | 400 | 118 | 146 | 43 | 102 | 61 | 40 | 527 | 1,389 | 0 | 4 | 281 | 0 | 0 | 
| app_proof | prover | 2 | 662,391,820 | 1,981 | 528 | 0 | 2 | 1,310 | 679 | 679 | 326 | 303 | 0 | 142 | 39 | 102 | 62 | 40 | 528 | 1,310 | 0 | 4 | 302 | 0 | 0 | 
| app_proof | prover | 3 | 662,468,884 | 1,989 | 527 | 0 | 2 | 1,311 | 673 | 673 | 323 | 313 | 0 | 150 | 45 | 105 | 64 | 41 | 527 | 1,311 | 0 | 3 | 312 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 168 | 2,660 | 168 | 166 | 0 | 3 | 104 | 2,851,000 | 32.43 | 
| app_proof | 1 | 64 | 2,413 | 64 | 41 | 0 | 1 | 244 | 2,851,000 | 35.83 | 
| app_proof | 2 | 66 | 2,292 | 66 | 41 | 0 | 2 | 203 | 2,851,000 | 35.72 | 
| app_proof | 3 | 62 | 2,298 | 62 | 41 | 0 | 2 | 204 | 2,614,961 | 35.94 | 

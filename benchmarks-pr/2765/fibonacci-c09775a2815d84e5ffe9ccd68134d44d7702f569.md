...
|:---|---:|---:|---:|
| Total |  3.10 |  1.82 |  1.82 |
| app_proof |  1.91 |  0.64 |  0.64 |
| leaf |  0.54 |  0.54 |  0.54 |
...
| `total_proof_time_ms ` |  473.50 |  1,894 |  619 |  323 |
| `execute_metered_time_ms` |  20 | -          | -          | -          |
| `execute_metered_insns` |  4,000,051 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  198.92 | -          |  198.92 |  198.92 |
| `execute_preflight_insns` |  1,000,012.75 |  4,000,051 |  1,310,000 |  70,051 |
| `execute_preflight_time_ms` |  37.50 |  150 |  55 |  4 |
| `execute_preflight_insn_mi/s` |  39.46 | -          |  41.08 |  36.25 |
| `trace_gen_time_ms   ` |  172.75 |  691 |  200 |  156 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  189.25 |  757 |  236 |  77 |
| `prover.main_trace_commit_time_ms` |  48.25 |  193 |  60 |  16 |
| `prover.rap_constraints_time_ms` |  107.25 |  429 |  137 |  35 |
| `prover.openings_time_ms` |  32.50 |  130 |  38 |  24 |
| `prover.rap_constraints.logup_gkr_time_ms` |  67 |  268 |  85 |  18 |
| `prover.rap_constraints.round0_time_ms` |  25.25 |  101 |  34 |  9 |
| `prover.rap_constraints.mle_rounds_time_ms` |  14.25 |  57 |  17 |  8 |
| `prover.openings.stacked_reduction_time_ms` |  14 |  56 |  19 |  8 |
...
| `prover.openings.whir_time_ms` |  18.25 |  73 |  19 |  16 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/c09775a2815d84e5ffe9ccd68134d44d7702f569/fibonacci-c09775a2815d84e5ffe9ccd68134d44d7702f569.memory.svg)
...
| app_proof |  |  |  |  |  | 323 |  |  | 20 | 4,000,051 | 198.92 | 0 | 1,921 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 19 | 305 | 18 | 5 | 1 | 2 | 1 | 1 | 
| internal_recursive.0 | 1 | 13 | 175 | 12 | 1 | 0 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 12 | 161 | 11 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 67 | 542 | 67 | 24 | 3 | 1 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,683 | 286 | 117 | 0 | 7 | 111 | 34 | 33 | 51 | 26 | 0 | 56 | 26 | 29 | 3 | 25 | 117 | 111 | 0 | 2 | 25 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,703 | 162 | 47 | 0 | 4 | 72 | 24 | 23 | 28 | 19 | 0 | 42 | 17 | 24 | 1 | 22 | 47 | 72 | 0 | 2 | 19 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 148 | 33 | 0 | 4 | 67 | 23 | 23 | 24 | 18 | 0 | 46 | 23 | 23 | 1 | 21 | 34 | 67 | 0 | 2 | 18 | 0 | 0 | 
| leaf | 0 | prover | 142,033,830 | 474 | 225 | 0 | 14 | 181 | 79 | 78 | 51 | 49 | 0 | 68 | 29 | 39 | 11 | 27 | 225 | 181 | 0 | 5 | 47 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 69,989,002 | 236 | 59 | 0 | 1 | 137 | 34 | 34 | 17 | 85 | 0 | 38 | 19 | 19 | 6 | 12 | 60 | 137 | 0 | 2 | 84 | 0 | 0 | 
| app_proof | prover | 1 | 69,945,164 | 221 | 58 | 0 | 1 | 128 | 29 | 28 | 16 | 82 | 0 | 34 | 19 | 14 | 6 | 8 | 58 | 128 | 0 | 3 | 81 | 0 | 0 | 
| app_proof | prover | 2 | 69,945,164 | 223 | 59 | 0 | 1 | 129 | 29 | 28 | 16 | 83 | 0 | 34 | 19 | 15 | 6 | 8 | 59 | 129 | 0 | 3 | 82 | 0 | 0 | 
| app_proof | prover | 3 | 9,531,164 | 77 | 16 | 0 | 1 | 35 | 9 | 9 | 8 | 18 | 0 | 24 | 16 | 8 | 1 | 7 | 16 | 35 | 0 | 2 | 17 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 174 | 619 | 174 | 166 | 0 | 3 | 41 | 1,310,000 | 36.25 | 
| app_proof | 1 | 156 | 475 | 156 | 41 | 0 | 1 | 55 | 1,310,000 | 40.95 | 
| app_proof | 2 | 161 | 477 | 161 | 41 | 0 | 1 | 50 | 1,310,000 | 41.08 | 
| app_proof | 3 | 200 | 323 | 200 | 41 | 0 | 1 | 4 | 70,051 | 39.58 | 

...
| `total_proof_time_ms ` |  936.50 |  1,873 |  1,196 |  677 |
| `execute_metered_time_ms` |  23 | -          | -          | -          |
| `execute_metered_insns` |  1,979,971 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  83.13 | -          |  83.13 |  83.13 |
| `execute_preflight_insns` |  989,985.50 |  1,979,971 |  1,168,000 |  811,971 |
| `execute_preflight_time_ms` |  88.50 |  177 |  125 |  52 |
| `execute_preflight_insn_mi/s` |  32.56 | -          |  33.23 |  31.88 |
| `trace_gen_time_ms   ` |  30.50 |  61 |  45 |  16 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  708.50 |  1,417 |  922 |  495 |
| `prover.main_trace_commit_time_ms` |  213.50 |  427 |  289 |  138 |
| `prover.rap_constraints_time_ms` |  447.50 |  895 |  581 |  314 |
| `prover.openings_time_ms` |  46.50 |  93 |  51 |  42 |
| `prover.rap_constraints.logup_gkr_time_ms` |  78 |  156 |  102 |  54 |
| `prover.rap_constraints.round0_time_ms` |  264 |  528 |  345 |  183 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/f8732f62e83d7ca775b6e09605b8ad1c470d56fb/kitchen_sink-f8732f62e83d7ca775b6e09605b8ad1c470d56fb.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 75 | 3 |  |  | 0 |  | 349 | 3 |  |  |  |  |  |  | 
| app_proof |  |  |  |  |  | 677 |  |  | 23 | 1,979,971 | 83.13 | 0 | 1,902 |  | 
...
| leaf | 0 | 111 | 410 | 110 | 25 | 11 | 20 | 4 | 4 | 
...
| internal_recursive.0 | 1 | prover | 15,378,703 | 82 | 16 | 0 | 0 | 48 | 17 | 17 | 20 | 10 | 0 | 17 | 11 | 5 | 1 | 4 | 16 | 48 | 0 | 1 | 9 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 76 | 11 | 0 | 0 | 48 | 19 | 18 | 18 | 10 | 0 | 16 | 10 | 5 | 0 | 4 | 11 | 48 | 0 | 1 | 9 | 0 | 0 | 
| leaf | 0 | prover | 263,565,172 | 299 | 128 | 0 | 1 | 140 | 48 | 47 | 37 | 54 | 0 | 30 | 14 | 15 | 7 | 8 | 128 | 140 | 0 | 2 | 53 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 565,122,580 | 922 | 288 | 0 | 159 | 581 | 345 | 344 | 133 | 102 | 48 | 51 | 13 | 38 | 15 | 22 | 289 | 581 | 0 | 1 | 53 | 0 | 0 | 
| app_proof | prover | 1 | 541,799,820 | 495 | 138 | 0 | 2 | 314 | 183 | 182 | 76 | 54 | 0 | 42 | 14 | 27 | 14 | 13 | 138 | 314 | 0 | 1 | 54 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 45 | 1,196 | 45 | 175 | 0 | 3 | 52 | 1,168,000 | 31.88 | 
| app_proof | 1 | 16 | 677 | 16 | 40 | 0 | 1 | 125 | 811,971 | 33.23 | 

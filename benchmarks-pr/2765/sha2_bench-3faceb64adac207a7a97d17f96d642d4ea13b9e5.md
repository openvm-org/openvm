...
|:---|---:|---:|---:|
| Total |  11.84 |  4.91 |  4.91 |
| app_proof |  9.67 |  2.74 |  2.74 |
| leaf |  1.43 |  1.43 |  1.43 |
...
| `total_proof_time_ms ` |  2,393.75 |  9,575 |  2,647 |  2,279 |
| `execute_metered_time_ms` |  93 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  120.03 | -          |  120.03 |  120.03 |
| `execute_preflight_insns` |  2,791,990.25 |  11,167,961 |  2,851,000 |  2,614,961 |
| `execute_preflight_time_ms` |  158.75 |  635 |  200 |  96 |
| `execute_preflight_insn_mi/s` |  37.55 | -          |  38.66 |  34.69 |
| `trace_gen_time_ms   ` |  106.25 |  425 |  173 |  64 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  2,056.75 |  8,227 |  2,215 |  1,973 |
| `prover.main_trace_commit_time_ms` |  561 |  2,244 |  670 |  524 |
| `prover.rap_constraints_time_ms` |  1,345 |  5,380 |  1,393 |  1,300 |
| `prover.openings_time_ms` |  149.25 |  597 |  154 |  145 |
| `prover.rap_constraints.logup_gkr_time_ms` |  358.50 |  1,434 |  405 |  309 |
| `prover.rap_constraints.round0_time_ms` |  662.75 |  2,651 |  668 |  660 |
| `prover.rap_constraints.mle_rounds_time_ms` |  322.75 |  1,291 |  324 |  320 |
| `prover.openings.stacked_reduction_time_ms` |  111 |  444 |  113 |  109 |
| `prover.openings.stacked_reduction.round0_time_ms` |  63.25 |  253 |  65 |  62 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  47.25 |  189 |  49 |  46 |
| `prover.openings.whir_time_ms` |  37.75 |  151 |  41 |  35 |
...
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,283 |  1,283 |  1,283 |  1,283 |
| `prover.main_trace_commit_time_ms` |  807 |  807 |  807 |  807 |
...
| `prover.main_trace_commit_time_ms` |  188 |  188 |  188 |  188 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/3faceb64adac207a7a97d17f96d642d4ea13b9e5/sha2_bench-3faceb64adac207a7a97d17f96d642d4ea13b9e5.memory.svg)
...
| app_proof |  |  |  |  |  | 2,285 |  |  | 93 | 11,167,961 | 120.03 | 0 | 9,675 |  | 
...
| internal_recursive.0 | 1 | 12 | 185 | 11 | 2 | 0 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 9 | 153 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 146 | 1,430 | 146 | 53 | 25 | 3 | 6 | 6 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 61,220,603 | 376 | 187 | 0 | 10 | 136 | 37 | 36 | 66 | 32 | 0 | 52 | 18 | 33 | 5 | 28 | 188 | 136 | 0 | 2 | 32 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,879 | 173 | 51 | 0 | 4 | 78 | 24 | 23 | 29 | 23 | 0 | 42 | 18 | 24 | 1 | 22 | 52 | 78 | 0 | 2 | 23 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 143 | 34 | 0 | 4 | 65 | 22 | 21 | 24 | 19 | 0 | 43 | 20 | 22 | 1 | 21 | 34 | 65 | 0 | 2 | 18 | 0 | 0 | 
| leaf | 0 | prover | 424,379,238 | 1,283 | 807 | 0 | 197 | 355 | 169 | 168 | 107 | 78 | 0 | 120 | 41 | 78 | 36 | 42 | 807 | 355 | 0 | 6 | 77 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 662,392,121 | 2,215 | 670 | 0 | 187 | 1,393 | 663 | 662 | 324 | 405 | 97 | 150 | 39 | 111 | 62 | 49 | 670 | 1,393 | 0 | 3 | 307 | 0 | 0 | 
| app_proof | prover | 1 | 662,391,820 | 2,058 | 523 | 0 | 39 | 1,385 | 660 | 660 | 323 | 401 | 113 | 148 | 36 | 111 | 64 | 46 | 524 | 1,385 | 0 | 3 | 287 | 0 | 0 | 
| app_proof | prover | 2 | 662,391,820 | 1,973 | 524 | 0 | 39 | 1,302 | 668 | 668 | 324 | 309 | 0 | 145 | 35 | 109 | 62 | 46 | 525 | 1,302 | 0 | 3 | 308 | 0 | 0 | 
| app_proof | prover | 3 | 662,468,884 | 1,981 | 525 | 0 | 41 | 1,300 | 660 | 659 | 320 | 319 | 0 | 154 | 41 | 113 | 65 | 48 | 525 | 1,300 | 0 | 3 | 318 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 173 | 2,647 | 173 | 162 | 0 | 3 | 96 | 2,851,000 | 34.69 | 
| app_proof | 1 | 64 | 2,364 | 64 | 41 | 0 | 2 | 200 | 2,851,000 | 38.50 | 
| app_proof | 2 | 92 | 2,279 | 92 | 41 | 0 | 2 | 173 | 2,851,000 | 38.66 | 
| app_proof | 3 | 96 | 2,285 | 96 | 41 | 0 | 2 | 166 | 2,614,961 | 38.33 | 

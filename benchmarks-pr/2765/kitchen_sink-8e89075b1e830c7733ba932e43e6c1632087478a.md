...
| `total_proof_time_ms ` |  934 |  1,868 |  1,196 |  672 |
...
| `execute_preflight_time_ms` |  87.50 |  175 |  123 |  52 |
| `execute_preflight_insn_mi/s` |  32.74 | -          |  33.82 |  31.65 |
| `trace_gen_time_ms   ` |  31 |  62 |  46 |  16 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  705.50 |  1,411 |  921 |  490 |
| `prover.main_trace_commit_time_ms` |  213 |  426 |  288 |  138 |
| `prover.rap_constraints_time_ms` |  446 |  892 |  581 |  311 |
| `prover.openings_time_ms` |  46 |  92 |  51 |  41 |
| `prover.rap_constraints.logup_gkr_time_ms` |  77 |  154 |  102 |  52 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/8e89075b1e830c7733ba932e43e6c1632087478a/kitchen_sink-8e89075b1e830c7733ba932e43e6c1632087478a.memory.svg)
...
| app_proof |  |  |  |  |  | 672 |  |  | 23 | 1,979,971 | 83.69 | 0 | 1,896 |  | 
...
| leaf | 0 | 110 | 407 | 109 | 24 | 11 | 20 | 4 | 4 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 565,122,580 | 921 | 287 | 0 | 157 | 581 | 345 | 344 | 132 | 102 | 47 | 51 | 13 | 38 | 15 | 22 | 288 | 581 | 0 | 1 | 53 | 0 | 0 | 
| app_proof | prover | 1 | 541,799,820 | 490 | 137 | 0 | 2 | 311 | 181 | 180 | 77 | 52 | 0 | 41 | 13 | 27 | 14 | 13 | 138 | 311 | 0 | 1 | 51 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 46 | 1,196 | 46 | 175 | 0 | 3 | 52 | 1,168,000 | 31.65 | 
| app_proof | 1 | 16 | 672 | 16 | 40 | 0 | 1 | 123 | 811,971 | 33.82 | 

...
|:---|---:|---:|---:|
| Total |  11.48 |  4.73 |  4.73 |
| app_proof |  9.43 |  2.68 |  2.68 |
| leaf |  1.38 |  1.38 |  1.38 |
...
| `total_proof_time_ms ` |  2,334 |  9,336 |  2,584 |  2,219 |
| `execute_metered_time_ms` |  93 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  119.05 | -          |  119.05 |  119.05 |
| `execute_preflight_insns` |  2,791,990.25 |  11,167,961 |  2,851,000 |  2,614,961 |
| `execute_preflight_time_ms` |  165.25 |  661 |  208 |  98 |
| `execute_preflight_insn_mi/s` |  36.99 | -          |  37.91 |  34.25 |
| `trace_gen_time_ms   ` |  96 |  384 |  164 |  58 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  2,000.50 |  8,002 |  2,159 |  1,918 |
| `prover.main_trace_commit_time_ms` |  552.25 |  2,209 |  665 |  514 |
| `prover.rap_constraints_time_ms` |  1,307 |  5,228 |  1,354 |  1,263 |
| `prover.openings_time_ms` |  139.75 |  559 |  142 |  138 |
| `prover.rap_constraints.logup_gkr_time_ms` |  340.75 |  1,363 |  387 |  291 |
| `prover.rap_constraints.round0_time_ms` |  654 |  2,616 |  660 |  649 |
| `prover.rap_constraints.mle_rounds_time_ms` |  311.50 |  1,246 |  314 |  308 |
| `prover.openings.stacked_reduction_time_ms` |  99.75 |  399 |  100 |  99 |
| `prover.openings.stacked_reduction.round0_time_ms` |  60.50 |  242 |  61 |  59 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  39 |  156 |  39 |  39 |
| `prover.openings.whir_time_ms` |  39.25 |  157 |  41 |  38 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,384 |  1,384 |  1,384 |  1,384 |
| `execute_preflight_time_ms` |  3 |  3 |  3 |  3 |
| `trace_gen_time_ms   ` |  146 |  146 |  146 |  146 |
| `generate_blob_total_time_ms` |  26 |  26 |  26 |  26 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,238 |  1,238 |  1,238 |  1,238 |
| `prover.main_trace_commit_time_ms` |  789 |  789 |  789 |  789 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/391e4f0dc0fc8ae643fa030654b9fecee0f519ea/sha2_bench-391e4f0dc0fc8ae643fa030654b9fecee0f519ea.memory.svg)
...
| app_proof |  |  |  |  |  | 2,220 |  |  | 93 | 11,167,961 | 119.05 | 0 | 9,436 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 61,220,603 | 348 | 181 | 0 | 0 | 128 | 37 | 36 | 63 | 27 | 0 | 38 | 20 | 18 | 5 | 12 | 181 | 128 | 0 | 2 | 26 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,879 | 152 | 48 | 0 | 0 | 71 | 24 | 23 | 29 | 17 | 0 | 31 | 22 | 8 | 1 | 6 | 49 | 71 | 0 | 2 | 16 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 122 | 31 | 0 | 0 | 61 | 23 | 22 | 25 | 13 | 0 | 29 | 22 | 7 | 1 | 5 | 31 | 61 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 424,379,238 | 1,238 | 788 | 0 | 155 | 345 | 165 | 164 | 104 | 75 | 0 | 103 | 40 | 62 | 35 | 27 | 789 | 345 | 0 | 6 | 73 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 662,392,121 | 2,159 | 665 | 0 | 152 | 1,354 | 653 | 653 | 313 | 387 | 102 | 139 | 39 | 99 | 59 | 39 | 665 | 1,354 | 0 | 3 | 283 | 0 | 0 | 
| app_proof | prover | 1 | 662,391,820 | 2,005 | 515 | 0 | 2 | 1,348 | 649 | 648 | 314 | 385 | 112 | 140 | 39 | 100 | 61 | 39 | 515 | 1,348 | 0 | 3 | 272 | 0 | 0 | 
| app_proof | prover | 2 | 662,391,820 | 1,918 | 515 | 0 | 2 | 1,263 | 660 | 660 | 311 | 291 | 0 | 138 | 38 | 100 | 61 | 39 | 515 | 1,263 | 0 | 3 | 290 | 0 | 0 | 
| app_proof | prover | 3 | 662,468,884 | 1,920 | 513 | 0 | 2 | 1,263 | 654 | 653 | 308 | 300 | 0 | 142 | 41 | 100 | 61 | 39 | 514 | 1,263 | 0 | 3 | 299 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 164 | 2,584 | 164 | 161 | 0 | 3 | 98 | 2,851,000 | 34.25 | 
| app_proof | 1 | 58 | 2,313 | 57 | 41 | 0 | 1 | 208 | 2,851,000 | 37.89 | 
| app_proof | 2 | 77 | 2,219 | 77 | 41 | 0 | 2 | 182 | 2,851,000 | 37.91 | 
| app_proof | 3 | 85 | 2,220 | 85 | 41 | 0 | 2 | 173 | 2,614,961 | 37.90 | 

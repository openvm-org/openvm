...
| `total_proof_time_ms ` |  2,365.50 |  9,462 |  2,620 |  2,244 |
...
| `execute_preflight_time_ms` |  161.25 |  645 |  205 |  96 |
| `execute_preflight_insn_mi/s` |  37.29 | -          |  38.39 |  34.48 |
| `trace_gen_time_ms   ` |  101.25 |  405 |  169 |  58 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  2,030.75 |  8,123 |  2,192 |  1,940 |
| `prover.main_trace_commit_time_ms` |  556.75 |  2,227 |  667 |  519 |
| `prover.rap_constraints_time_ms` |  1,327.25 |  5,309 |  1,375 |  1,282 |
| `prover.openings_time_ms` |  146 |  584 |  150 |  137 |
| `prover.rap_constraints.logup_gkr_time_ms` |  354 |  1,416 |  403 |  303 |
| `prover.rap_constraints.round0_time_ms` |  655.75 |  2,623 |  663 |  652 |
| `prover.rap_constraints.mle_rounds_time_ms` |  315.75 |  1,263 |  317 |  315 |
| `prover.openings.stacked_reduction_time_ms` |  107.25 |  429 |  110 |  101 |
| `prover.openings.stacked_reduction.round0_time_ms` |  60.50 |  242 |  62 |  57 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  46.25 |  185 |  48 |  44 |
| `prover.openings.whir_time_ms` |  38 |  152 |  40 |  35 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/6659be49555b8a2987f28818cf4f08a2cd547dc9/sha2_bench-6659be49555b8a2987f28818cf4f08a2cd547dc9.memory.svg)
...
| app_proof |  |  |  |  |  | 2,256 |  |  | 92 | 11,167,961 | 120.08 | 0 | 9,561 |  | 
...
| internal_recursive.0 | 1 | 11 | 183 | 11 | 2 | 0 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 9 | 147 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 147 | 1,416 | 147 | 54 | 26 | 3 | 6 | 6 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 61,220,603 | 370 | 185 | 0 | 10 | 133 | 36 | 36 | 63 | 32 | 0 | 50 | 16 | 33 | 5 | 28 | 185 | 133 | 0 | 2 | 32 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,879 | 171 | 50 | 0 | 4 | 77 | 24 | 23 | 29 | 23 | 0 | 43 | 18 | 24 | 1 | 22 | 51 | 77 | 0 | 2 | 22 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 138 | 34 | 0 | 4 | 64 | 22 | 21 | 24 | 17 | 0 | 40 | 17 | 22 | 1 | 21 | 34 | 64 | 0 | 2 | 17 | 0 | 0 | 
| leaf | 0 | prover | 424,379,238 | 1,268 | 800 | 0 | 198 | 352 | 166 | 165 | 105 | 80 | 0 | 114 | 37 | 77 | 35 | 42 | 800 | 352 | 0 | 6 | 78 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 662,392,121 | 2,192 | 667 | 0 | 188 | 1,375 | 654 | 654 | 316 | 403 | 96 | 149 | 39 | 110 | 61 | 48 | 667 | 1,375 | 0 | 3 | 307 | 0 | 0 | 
| app_proof | prover | 1 | 662,391,820 | 2,037 | 519 | 0 | 39 | 1,369 | 652 | 652 | 317 | 398 | 112 | 148 | 38 | 109 | 62 | 46 | 519 | 1,369 | 0 | 3 | 285 | 0 | 0 | 
| app_proof | prover | 2 | 662,391,820 | 1,940 | 520 | 0 | 40 | 1,283 | 663 | 663 | 315 | 303 | 0 | 137 | 35 | 101 | 57 | 44 | 520 | 1,283 | 0 | 3 | 302 | 0 | 0 | 
| app_proof | prover | 3 | 662,468,884 | 1,954 | 521 | 0 | 41 | 1,282 | 654 | 654 | 315 | 312 | 0 | 150 | 40 | 109 | 62 | 47 | 521 | 1,282 | 0 | 3 | 312 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 169 | 2,620 | 169 | 161 | 0 | 3 | 96 | 2,851,000 | 34.48 | 
| app_proof | 1 | 58 | 2,342 | 58 | 41 | 0 | 2 | 205 | 2,851,000 | 38.06 | 
| app_proof | 2 | 86 | 2,244 | 86 | 41 | 0 | 2 | 176 | 2,851,000 | 38.25 | 
| app_proof | 3 | 92 | 2,256 | 91 | 41 | 0 | 2 | 168 | 2,614,961 | 38.39 | 

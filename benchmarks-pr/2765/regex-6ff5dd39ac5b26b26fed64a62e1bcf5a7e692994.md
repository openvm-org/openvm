...
| `total_proof_time_ms ` |  795 |  1,590 |  884 |  706 |
| `execute_metered_time_ms` |  31 | -          | -          | -          |
| `execute_metered_insns` |  4,090,656 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  129.96 | -          |  129.96 |  129.96 |
| `execute_preflight_insns` |  2,045,328 |  4,090,656 |  2,327,000 |  1,763,656 |
| `execute_preflight_time_ms` |  79 |  158 |  85 |  73 |
| `execute_preflight_insn_mi/s` |  35.59 | -          |  37.83 |  33.35 |
| `trace_gen_time_ms   ` |  145.50 |  291 |  146 |  145 |
| `memory_finalize_time_ms` |  1 |  2 |  2 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  468.50 |  937 |  491 |  446 |
| `prover.main_trace_commit_time_ms` |  128 |  256 |  144 |  112 |
| `prover.rap_constraints_time_ms` |  284 |  568 |  288 |  280 |
| `prover.openings_time_ms` |  55 |  110 |  58 |  52 |
| `prover.rap_constraints.logup_gkr_time_ms` |  154 |  308 |  163 |  145 |
| `prover.rap_constraints.round0_time_ms` |  89.50 |  179 |  99 |  80 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/6ff5dd39ac5b26b26fed64a62e1bcf5a7e692994/regex-6ff5dd39ac5b26b26fed64a62e1bcf5a7e692994.memory.svg)
...
| app_proof |  |  |  |  |  | 706 |  |  | 31 | 4,090,656 | 129.96 | 0 | 1,635 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 15 | 245 | 15 | 4 | 0 | 2 | 0 | 0 | 
| internal_recursive.0 | 1 | 9 | 175 | 9 | 1 | 0 | 2 | 0 | 0 | 
| internal_recursive.1 | 1 | 9 | 155 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 50 | 378 | 49 | 14 | 3 | 5 | 1 | 1 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 27,256,571 | 230 | 83 | 0 | 5 | 102 | 31 | 30 | 45 | 25 | 0 | 44 | 17 | 26 | 2 | 23 | 83 | 102 | 0 | 2 | 24 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,703 | 165 | 47 | 0 | 4 | 71 | 23 | 23 | 27 | 19 | 0 | 45 | 21 | 23 | 1 | 22 | 48 | 71 | 0 | 2 | 18 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 146 | 34 | 0 | 4 | 64 | 22 | 21 | 23 | 18 | 0 | 46 | 24 | 22 | 1 | 21 | 34 | 64 | 0 | 2 | 17 | 0 | 0 | 
| leaf | 0 | prover | 79,962,868 | 328 | 128 | 0 | 8 | 140 | 54 | 53 | 37 | 48 | 0 | 59 | 28 | 30 | 6 | 24 | 128 | 140 | 0 | 5 | 46 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 179,663,570 | 491 | 144 | 0 | 10 | 288 | 80 | 79 | 45 | 163 | 0 | 58 | 21 | 36 | 14 | 21 | 144 | 288 | 0 | 3 | 161 | 0 | 0 | 
| app_proof | prover | 1 | 133,369,433 | 446 | 112 | 0 | 17 | 280 | 99 | 99 | 36 | 145 | 0 | 52 | 21 | 30 | 10 | 19 | 112 | 280 | 0 | 2 | 144 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 145 | 884 | 145 | 161 | 2 | 6 | 85 | 2,327,000 | 33.35 | 
| app_proof | 1 | 146 | 706 | 146 | 40 | 0 | 2 | 73 | 1,763,656 | 37.83 | 

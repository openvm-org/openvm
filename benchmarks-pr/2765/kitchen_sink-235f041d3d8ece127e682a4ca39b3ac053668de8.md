...
| `total_proof_time_ms ` |  1,020.50 |  2,041 |  1,299 |  742 |
| `execute_metered_time_ms` |  23 | -          | -          | -          |
| `execute_metered_insns` |  1,979,971 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  83.03 | -          |  83.03 |  83.03 |
| `execute_preflight_insns` |  989,985.50 |  1,979,971 |  1,168,000 |  811,971 |
| `execute_preflight_time_ms` |  92.50 |  185 |  132 |  53 |
| `execute_preflight_insn_mi/s` |  32.80 | -          |  33.65 |  31.94 |
| `trace_gen_time_ms   ` |  30.50 |  61 |  46 |  15 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  787 |  1,574 |  1,021 |  553 |
| `prover.main_trace_commit_time_ms` |  226.50 |  453 |  305 |  148 |
| `prover.rap_constraints_time_ms` |  495 |  990 |  638 |  352 |
| `prover.openings_time_ms` |  64.50 |  129 |  77 |  52 |
| `prover.rap_constraints.logup_gkr_time_ms` |  101.50 |  203 |  141 |  62 |
| `prover.rap_constraints.round0_time_ms` |  282 |  564 |  350 |  214 |
| `prover.rap_constraints.mle_rounds_time_ms` |  111 |  222 |  146 |  76 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/235f041d3d8ece127e682a4ca39b3ac053668de8/kitchen_sink-235f041d3d8ece127e682a4ca39b3ac053668de8.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 76 | 3 |  |  | 0 |  | 351 | 3 |  |  |  |  |  |  | 
| app_proof |  |  |  |  |  | 742 |  |  | 23 | 1,979,971 | 83.03 | 0 | 2,069 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,577,915 | 141 | 40 | 0 | 4 | 66 | 20 | 19 | 29 | 16 | 0 | 33 | 9 | 23 | 1 | 22 | 40 | 66 | 0 | 1 | 15 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,703 | 107 | 19 | 0 | 4 | 55 | 20 | 19 | 20 | 13 | 0 | 32 | 10 | 21 | 1 | 20 | 19 | 55 | 0 | 1 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 102 | 14 | 0 | 4 | 54 | 21 | 20 | 18 | 13 | 0 | 32 | 11 | 21 | 0 | 20 | 15 | 54 | 0 | 1 | 13 | 0 | 0 | 
| leaf | 0 | prover | 263,565,172 | 320 | 130 | 0 | 10 | 145 | 49 | 48 | 37 | 58 | 0 | 44 | 12 | 31 | 7 | 24 | 130 | 145 | 0 | 2 | 57 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 565,122,580 | 1,021 | 304 | 0 | 174 | 638 | 350 | 348 | 146 | 141 | 45 | 77 | 13 | 63 | 16 | 47 | 305 | 638 | 0 | 1 | 95 | 0 | 0 | 
| app_proof | prover | 1 | 541,799,820 | 553 | 148 | 0 | 24 | 352 | 214 | 213 | 76 | 62 | 0 | 52 | 13 | 39 | 14 | 24 | 148 | 352 | 0 | 1 | 61 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 46 | 1,299 | 46 | 177 | 0 | 4 | 53 | 1,168,000 | 31.94 | 
| app_proof | 1 | 15 | 742 | 15 | 40 | 0 | 1 | 132 | 811,971 | 33.65 | 

...
| `total_proof_time_ms ` |  2,235.67 |  13,414 |  2,518 |  2,145 |
| `execute_metered_time_ms` |  138 | -          | -          | -          |
| `execute_metered_insns` |  14,365,133 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  103.82 | -          |  103.82 |  103.82 |
| `execute_preflight_insns` |  2,394,188.83 |  14,365,133 |  2,413,000 |  2,300,133 |
| `execute_preflight_time_ms` |  235 |  1,410 |  317 |  86 |
| `execute_preflight_insn_mi/s` |  35.46 | -          |  36.43 |  32.10 |
| `trace_gen_time_ms   ` |  53.33 |  320 |  151 |  33 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,885 |  11,310 |  2,117 |  1,834 |
| `prover.main_trace_commit_time_ms` |  703.50 |  4,221 |  871 |  668 |
| `prover.rap_constraints_time_ms` |  998 |  5,988 |  1,060 |  983 |
| `prover.openings_time_ms` |  182.67 |  1,096 |  186 |  181 |
| `prover.rap_constraints.logup_gkr_time_ms` |  178.67 |  1,072 |  232 |  167 |
| `prover.rap_constraints.round0_time_ms` |  514.33 |  3,086 |  520 |  504 |
| `prover.rap_constraints.mle_rounds_time_ms` |  304.17 |  1,825 |  323 |  300 |
| `prover.openings.stacked_reduction_time_ms` |  141.67 |  850 |  143 |  141 |
| `prover.openings.stacked_reduction.round0_time_ms` |  82.17 |  493 |  83 |  81 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  59 |  354 |  60 |  58 |
| `prover.openings.whir_time_ms` |  40.50 |  243 |  43 |  39 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,099.50 |  2,199 |  1,422 |  777 |
| `execute_preflight_time_ms` |  5.50 |  11 |  6 |  5 |
| `trace_gen_time_ms   ` |  136 |  272 |  181 |  91 |
| `generate_blob_total_time_ms` |  24.50 |  49 |  33 |  16 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  962.50 |  1,925 |  1,240 |  685 |
| `prover.main_trace_commit_time_ms` |  543.50 |  1,087 |  715 |  372 |
| `prover.rap_constraints_time_ms` |  314.50 |  629 |  403 |  226 |
| `prover.openings_time_ms` |  103 |  206 |  120 |  86 |
| `prover.rap_constraints.logup_gkr_time_ms` |  70 |  140 |  86 |  54 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/9d94b5e8f80803ad33cdf2b28007475bdafe6f45/keccak-9d94b5e8f80803ad33cdf2b28007475bdafe6f45.memory.svg)
...
| app_proof |  |  |  |  |  | 2,145 |  |  | 138 | 14,365,133 | 103.82 | 0 | 13,559 |  | 
...
| app_proof | VmAirWrapper<Rv64BranchAdapterAir, BranchEqualCoreAir<8> | 5 | 1 | 
...
| internal_recursive.0 | 1 | 13 | 182 | 13 | 2 | 1 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 9 | 152 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 181 | 1,422 | 181 | 64 | 33 | 6 | 7 | 7 | 
| leaf | 1 | 91 | 777 | 91 | 32 | 16 | 5 | 7 | 7 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 81,415,028 | 476 | 243 | 0 | 14 | 173 | 47 | 46 | 90 | 35 | 0 | 59 | 20 | 38 | 7 | 30 | 243 | 173 | 0 | 2 | 34 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,879 | 169 | 51 | 0 | 4 | 76 | 24 | 23 | 29 | 22 | 0 | 40 | 16 | 24 | 1 | 21 | 51 | 76 | 0 | 2 | 22 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 142 | 33 | 0 | 4 | 66 | 24 | 23 | 24 | 18 | 0 | 41 | 19 | 22 | 1 | 20 | 33 | 66 | 0 | 2 | 17 | 0 | 0 | 
| leaf | 0 | prover | 476,578,662 | 1,240 | 715 | 0 | 48 | 403 | 199 | 198 | 117 | 86 | 0 | 120 | 36 | 84 | 39 | 44 | 715 | 403 | 0 | 6 | 85 | 0 | 0 | 
| leaf | 1 | prover | 240,255,732 | 685 | 372 | 0 | 24 | 226 | 104 | 103 | 67 | 54 | 0 | 86 | 34 | 51 | 19 | 31 | 372 | 226 | 0 | 5 | 54 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 857,743,372 | 2,117 | 871 | 0 | 258 | 1,060 | 504 | 503 | 323 | 232 | 64 | 186 | 42 | 143 | 83 | 60 | 871 | 1,060 | 0 | 3 | 166 | 0 | 0 | 
| app_proof | prover | 1 | 857,820,172 | 1,839 | 668 | 0 | 58 | 985 | 516 | 515 | 301 | 167 | 0 | 184 | 43 | 141 | 81 | 59 | 668 | 985 | 0 | 3 | 167 | 0 | 0 | 
| app_proof | prover | 2 | 857,820,172 | 1,834 | 668 | 0 | 58 | 983 | 515 | 515 | 300 | 167 | 0 | 181 | 39 | 141 | 82 | 59 | 669 | 983 | 0 | 3 | 166 | 0 | 0 | 
| app_proof | prover | 3 | 857,820,172 | 1,841 | 671 | 0 | 58 | 988 | 519 | 518 | 300 | 168 | 0 | 181 | 40 | 141 | 82 | 58 | 672 | 988 | 0 | 3 | 167 | 0 | 0 | 
| app_proof | prover | 4 | 857,820,172 | 1,837 | 671 | 0 | 58 | 983 | 512 | 511 | 301 | 169 | 0 | 182 | 39 | 142 | 83 | 59 | 671 | 983 | 0 | 3 | 168 | 0 | 0 | 
| app_proof | prover | 5 | 857,743,372 | 1,842 | 670 | 0 | 58 | 989 | 520 | 519 | 300 | 169 | 0 | 182 | 40 | 142 | 82 | 59 | 670 | 989 | 0 | 3 | 168 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 151 | 2,518 | 151 | 161 | 0 | 3 | 86 | 2,413,000 | 32.10 | 
| app_proof | 1 | 34 | 2,232 | 34 | 41 | 0 | 1 | 317 | 2,413,000 | 35.80 | 
| app_proof | 2 | 34 | 2,171 | 34 | 41 | 0 | 1 | 261 | 2,413,000 | 36.04 | 
| app_proof | 3 | 34 | 2,176 | 34 | 41 | 0 | 1 | 260 | 2,413,000 | 36.43 | 
| app_proof | 4 | 34 | 2,172 | 34 | 41 | 0 | 1 | 259 | 2,413,000 | 36.37 | 
| app_proof | 5 | 33 | 2,145 | 33 | 41 | 0 | 1 | 227 | 2,300,133 | 36.03 | 

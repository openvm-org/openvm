...
| `total_proof_time_ms ` |  934 |  1,868 |  1,195 |  673 |
| `execute_metered_time_ms` |  23 | -          | -          | -          |
| `execute_metered_insns` |  1,979,971 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  83.64 | -          |  83.64 |  83.64 |
| `execute_preflight_insns` |  989,985.50 |  1,979,971 |  1,168,000 |  811,971 |
| `execute_preflight_time_ms` |  90 |  180 |  128 |  52 |
| `execute_preflight_insn_mi/s` |  32.84 | -          |  33.97 |  31.70 |
| `trace_gen_time_ms   ` |  30 |  60 |  44 |  16 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  704.50 |  1,409 |  921 |  488 |
| `prover.main_trace_commit_time_ms` |  213.50 |  427 |  290 |  137 |
| `prover.rap_constraints_time_ms` |  443.50 |  887 |  579 |  308 |
| `prover.openings_time_ms` |  46 |  92 |  51 |  41 |
| `prover.rap_constraints.logup_gkr_time_ms` |  77.50 |  155 |  103 |  52 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/bf6e25f75dd5e702e27dffb125b84c549df5957d/kitchen_sink-bf6e25f75dd5e702e27dffb125b84c549df5957d.memory.svg)
...
| app_proof |  |  |  |  |  | 673 |  |  | 23 | 1,979,971 | 83.64 | 0 | 1,896 |  | 
...
| leaf | 0 | 109 | 405 | 109 | 24 | 11 | 20 | 4 | 4 | 
...
| internal_recursive.0 | 1 | prover | 15,378,703 | 78 | 16 | 0 | 0 | 47 | 17 | 16 | 20 | 10 | 0 | 14 | 8 | 5 | 1 | 4 | 16 | 47 | 0 | 1 | 9 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 74 | 11 | 0 | 0 | 48 | 19 | 18 | 18 | 10 | 0 | 14 | 8 | 5 | 0 | 4 | 11 | 48 | 0 | 1 | 9 | 0 | 0 | 
| leaf | 0 | prover | 263,565,172 | 296 | 127 | 0 | 1 | 139 | 48 | 47 | 37 | 53 | 0 | 27 | 12 | 15 | 7 | 8 | 128 | 139 | 0 | 2 | 53 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 565,122,580 | 921 | 290 | 0 | 160 | 579 | 343 | 341 | 132 | 103 | 48 | 51 | 13 | 38 | 15 | 22 | 290 | 579 | 0 | 1 | 53 | 0 | 0 | 
| app_proof | prover | 1 | 541,799,820 | 488 | 137 | 0 | 1 | 308 | 179 | 179 | 76 | 52 | 0 | 41 | 14 | 27 | 14 | 13 | 137 | 308 | 0 | 1 | 51 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 44 | 1,195 | 44 | 176 | 0 | 3 | 52 | 1,168,000 | 31.70 | 
| app_proof | 1 | 16 | 673 | 16 | 40 | 0 | 1 | 128 | 811,971 | 33.97 | 

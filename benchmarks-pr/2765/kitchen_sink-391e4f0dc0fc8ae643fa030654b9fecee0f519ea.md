...
|:---|---:|---:|---:|
| Total |  2.61 |  1.93 |  1.93 |
| app_proof |  1.89 |  1.22 |  1.22 |
| leaf |  0.41 |  0.41 |  0.41 |
...
| `total_proof_time_ms ` |  934 |  1,868 |  1,194 |  674 |
| `execute_metered_time_ms` |  23 | -          | -          | -          |
| `execute_metered_insns` |  1,979,971 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  83.99 | -          |  83.99 |  83.99 |
| `execute_preflight_insns` |  989,985.50 |  1,979,971 |  1,168,000 |  811,971 |
| `execute_preflight_time_ms` |  89.50 |  179 |  126 |  53 |
| `execute_preflight_insn_mi/s` |  32.60 | -          |  33.64 |  31.56 |
| `trace_gen_time_ms   ` |  30 |  60 |  44 |  16 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  705.50 |  1,411 |  921 |  490 |
| `prover.main_trace_commit_time_ms` |  214.50 |  429 |  290 |  139 |
| `prover.rap_constraints_time_ms` |  443.50 |  887 |  578 |  309 |
| `prover.openings_time_ms` |  46 |  92 |  51 |  41 |
| `prover.rap_constraints.logup_gkr_time_ms` |  77.50 |  155 |  102 |  53 |
| `prover.rap_constraints.round0_time_ms` |  260.50 |  521 |  343 |  178 |
| `prover.rap_constraints.mle_rounds_time_ms` |  104.50 |  209 |  133 |  76 |
| `prover.openings.stacked_reduction_time_ms` |  33 |  66 |  38 |  28 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/391e4f0dc0fc8ae643fa030654b9fecee0f519ea/kitchen_sink-391e4f0dc0fc8ae643fa030654b9fecee0f519ea.memory.svg)
...
| app_proof |  |  |  |  |  | 674 |  |  | 23 | 1,979,971 | 83.99 | 0 | 1,895 |  | 
...
| leaf | 0 | 110 | 410 | 110 | 24 | 11 | 20 | 4 | 4 | 
...
| leaf | 0 | prover | 263,565,172 | 300 | 129 | 0 | 1 | 141 | 49 | 48 | 37 | 54 | 0 | 28 | 12 | 16 | 7 | 8 | 130 | 141 | 0 | 2 | 54 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 565,122,580 | 921 | 290 | 0 | 160 | 578 | 343 | 342 | 133 | 102 | 47 | 51 | 13 | 38 | 15 | 22 | 290 | 578 | 0 | 1 | 53 | 0 | 0 | 
| app_proof | prover | 1 | 541,799,820 | 490 | 139 | 0 | 2 | 309 | 178 | 177 | 76 | 53 | 0 | 41 | 13 | 28 | 14 | 13 | 139 | 309 | 0 | 1 | 53 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 44 | 1,194 | 44 | 174 | 0 | 3 | 53 | 1,168,000 | 31.56 | 
| app_proof | 1 | 16 | 674 | 16 | 40 | 0 | 1 | 126 | 811,971 | 33.64 | 

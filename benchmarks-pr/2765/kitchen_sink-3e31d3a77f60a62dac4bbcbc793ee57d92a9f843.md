...
| `total_proof_time_ms ` |  1,018.50 |  2,037 |  1,296 |  741 |
...
| `execute_preflight_insn_mi/s` |  33.25 | -          |  34.23 |  32.26 |
| `trace_gen_time_ms   ` |  31 |  62 |  46 |  16 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  789 |  1,578 |  1,020 |  558 |
| `prover.main_trace_commit_time_ms` |  226.50 |  453 |  303 |  150 |
| `prover.rap_constraints_time_ms` |  497 |  994 |  640 |  354 |
| `prover.openings_time_ms` |  64.50 |  129 |  76 |  53 |
| `prover.rap_constraints.logup_gkr_time_ms` |  103 |  206 |  142 |  64 |
| `prover.rap_constraints.round0_time_ms` |  281.50 |  563 |  350 |  213 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/3e31d3a77f60a62dac4bbcbc793ee57d92a9f843/kitchen_sink-3e31d3a77f60a62dac4bbcbc793ee57d92a9f843.memory.svg)
...
| app_proof |  |  |  |  |  | 741 |  |  | 23 | 1,979,971 | 83.05 | 0 | 2,065 |  | 
...
| leaf | 0 | 111 | 435 | 111 | 24 | 11 | 20 | 4 | 4 | 
...
| internal_recursive.0 | 1 | prover | 15,378,703 | 106 | 19 | 0 | 4 | 55 | 20 | 19 | 20 | 14 | 0 | 31 | 9 | 21 | 1 | 20 | 19 | 55 | 0 | 1 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 98 | 14 | 0 | 4 | 53 | 21 | 20 | 18 | 13 | 0 | 28 | 7 | 21 | 0 | 20 | 15 | 53 | 0 | 1 | 13 | 0 | 0 | 
| leaf | 0 | prover | 263,565,172 | 324 | 131 | 0 | 10 | 146 | 49 | 48 | 37 | 59 | 0 | 44 | 13 | 31 | 7 | 24 | 132 | 146 | 0 | 2 | 58 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 565,122,580 | 1,020 | 302 | 0 | 172 | 640 | 350 | 348 | 147 | 142 | 46 | 76 | 13 | 63 | 16 | 47 | 303 | 640 | 0 | 1 | 95 | 0 | 0 | 
| app_proof | prover | 1 | 541,799,820 | 558 | 149 | 0 | 23 | 354 | 213 | 213 | 76 | 64 | 0 | 53 | 14 | 39 | 14 | 24 | 150 | 354 | 0 | 1 | 63 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 46 | 1,296 | 46 | 177 | 0 | 3 | 52 | 1,168,000 | 32.26 | 
| app_proof | 1 | 16 | 741 | 16 | 40 | 0 | 1 | 125 | 811,971 | 34.23 | 

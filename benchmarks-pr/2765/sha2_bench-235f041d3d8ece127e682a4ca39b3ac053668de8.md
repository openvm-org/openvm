...
|:---|---:|---:|---:|
| Total |  11.94 |  4.95 |  4.95 |
| app_proof |  9.75 |  2.76 |  2.76 |
| leaf |  1.44 |  1.44 |  1.44 |
...
| `total_proof_time_ms ` |  2,414.25 |  9,657 |  2,664 |  2,298 |
...
| `execute_preflight_time_ms` |  164.25 |  657 |  213 |  98 |
| `execute_preflight_insn_mi/s` |  37.16 | -          |  38.41 |  34.31 |
| `trace_gen_time_ms   ` |  103.50 |  414 |  172 |  58 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  2,074.25 |  8,297 |  2,231 |  1,990 |
| `prover.main_trace_commit_time_ms` |  565.50 |  2,262 |  676 |  526 |
| `prover.rap_constraints_time_ms` |  1,357.50 |  5,430 |  1,402 |  1,315 |
| `prover.openings_time_ms` |  149.75 |  599 |  152 |  147 |
| `prover.rap_constraints.logup_gkr_time_ms` |  360.50 |  1,442 |  409 |  312 |
| `prover.rap_constraints.round0_time_ms` |  671 |  2,684 |  677 |  667 |
| `prover.rap_constraints.mle_rounds_time_ms` |  325.25 |  1,301 |  326 |  325 |
| `prover.openings.stacked_reduction_time_ms` |  111.50 |  446 |  113 |  111 |
| `prover.openings.stacked_reduction.round0_time_ms` |  63.50 |  254 |  64 |  63 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/235f041d3d8ece127e682a4ca39b3ac053668de8/sha2_bench-235f041d3d8ece127e682a4ca39b3ac053668de8.memory.svg)
...
| app_proof |  |  |  |  |  | 2,305 |  |  | 93 | 11,167,961 | 119.14 | 0 | 9,757 |  | 
...
| leaf | 0 | 147 | 1,440 | 147 | 54 | 26 | 3 | 6 | 6 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 61,220,603 | 380 | 188 | 0 | 10 | 135 | 37 | 36 | 64 | 33 | 0 | 56 | 21 | 34 | 5 | 28 | 189 | 135 | 0 | 2 | 32 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,879 | 175 | 52 | 0 | 4 | 77 | 24 | 24 | 29 | 23 | 0 | 44 | 20 | 24 | 1 | 22 | 52 | 77 | 0 | 2 | 22 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 145 | 34 | 0 | 4 | 67 | 23 | 22 | 24 | 19 | 0 | 44 | 21 | 22 | 1 | 21 | 34 | 67 | 0 | 2 | 18 | 0 | 0 | 
| leaf | 0 | prover | 424,379,238 | 1,292 | 813 | 0 | 200 | 361 | 174 | 173 | 105 | 81 | 0 | 117 | 37 | 80 | 36 | 43 | 813 | 361 | 0 | 6 | 80 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 662,392,121 | 2,231 | 676 | 0 | 189 | 1,402 | 667 | 666 | 325 | 409 | 97 | 152 | 39 | 113 | 63 | 49 | 676 | 1,402 | 0 | 3 | 311 | 0 | 0 | 
| app_proof | prover | 1 | 662,391,820 | 2,077 | 529 | 0 | 39 | 1,398 | 668 | 668 | 326 | 403 | 113 | 149 | 37 | 111 | 64 | 47 | 529 | 1,398 | 0 | 3 | 289 | 0 | 0 | 
| app_proof | prover | 2 | 662,391,820 | 1,990 | 526 | 0 | 39 | 1,315 | 677 | 676 | 325 | 312 | 0 | 147 | 35 | 111 | 64 | 47 | 526 | 1,315 | 0 | 3 | 311 | 0 | 0 | 
| app_proof | prover | 3 | 662,468,884 | 1,999 | 531 | 0 | 41 | 1,315 | 672 | 671 | 325 | 318 | 0 | 151 | 39 | 111 | 63 | 48 | 531 | 1,315 | 0 | 3 | 317 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 172 | 2,664 | 172 | 161 | 0 | 3 | 98 | 2,851,000 | 34.31 | 
| app_proof | 1 | 58 | 2,390 | 58 | 41 | 0 | 2 | 213 | 2,851,000 | 37.81 | 
| app_proof | 2 | 89 | 2,298 | 89 | 41 | 0 | 2 | 177 | 2,851,000 | 38.10 | 
| app_proof | 3 | 95 | 2,305 | 95 | 41 | 0 | 2 | 169 | 2,614,961 | 38.41 | 

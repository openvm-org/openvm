...
| `total_proof_time_ms ` |  2,262.50 |  13,575 |  2,543 |  2,171 |
...
| `execute_preflight_time_ms` |  236.17 |  1,417 |  322 |  86 |
| `execute_preflight_insn_mi/s` |  35.44 | -          |  36.40 |  32.23 |
| `trace_gen_time_ms   ` |  54.33 |  326 |  157 |  33 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,910.17 |  11,461 |  2,138 |  1,863 |
| `prover.main_trace_commit_time_ms` |  713.33 |  4,280 |  876 |  680 |
| `prover.rap_constraints_time_ms` |  1,009.17 |  6,055 |  1,071 |  996 |
| `prover.openings_time_ms` |  186.67 |  1,120 |  190 |  184 |
| `prover.rap_constraints.logup_gkr_time_ms` |  180.67 |  1,084 |  233 |  169 |
| `prover.rap_constraints.round0_time_ms` |  516 |  3,096 |  520 |  507 |
| `prover.rap_constraints.mle_rounds_time_ms` |  311 |  1,866 |  329 |  307 |
| `prover.openings.stacked_reduction_time_ms` |  145.17 |  871 |  147 |  144 |
...
| `prover.openings.whir_time_ms` |  41 |  246 |  44 |  39 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,123.50 |  2,247 |  1,456 |  791 |
...
| `prover.main_trace_commit_time_ms` |  551 |  1,102 |  726 |  376 |
| `prover.rap_constraints_time_ms` |  322.50 |  645 |  414 |  231 |
| `prover.openings_time_ms` |  112 |  224 |  133 |  91 |
| `prover.rap_constraints.logup_gkr_time_ms` |  72.50 |  145 |  90 |  55 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/a8a77ba0f707ce54281d23014a4be7fd2a902252/keccak-a8a77ba0f707ce54281d23014a4be7fd2a902252.memory.svg)
...
| app_proof |  |  |  |  |  | 2,171 |  |  | 138 | 14,365,133 | 103.55 | 0 | 13,720 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 39 | 528 | 38 | 13 | 4 | 2 | 2 | 2 | 
| internal_recursive.0 | 1 | 13 | 185 | 13 | 2 | 1 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 9 | 154 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 182 | 1,456 | 181 | 64 | 33 | 6 | 7 | 7 | 
| leaf | 1 | 92 | 791 | 92 | 32 | 16 | 5 | 7 | 7 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 81,415,028 | 488 | 248 | 0 | 14 | 177 | 48 | 47 | 92 | 36 | 0 | 62 | 23 | 38 | 7 | 31 | 248 | 177 | 0 | 2 | 35 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,879 | 171 | 51 | 0 | 4 | 77 | 24 | 24 | 29 | 23 | 0 | 42 | 18 | 24 | 1 | 22 | 51 | 77 | 0 | 2 | 22 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 144 | 34 | 0 | 4 | 67 | 23 | 23 | 24 | 19 | 0 | 42 | 20 | 22 | 1 | 21 | 34 | 67 | 0 | 2 | 18 | 0 | 0 | 
| leaf | 0 | prover | 476,578,662 | 1,274 | 726 | 0 | 47 | 414 | 204 | 203 | 119 | 90 | 0 | 133 | 46 | 86 | 41 | 45 | 726 | 414 | 0 | 6 | 89 | 0 | 0 | 
| leaf | 1 | prover | 240,255,732 | 699 | 375 | 0 | 24 | 231 | 107 | 106 | 68 | 55 | 0 | 91 | 38 | 52 | 20 | 32 | 376 | 231 | 0 | 6 | 54 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 857,743,372 | 2,138 | 876 | 0 | 256 | 1,071 | 507 | 506 | 329 | 233 | 64 | 190 | 42 | 147 | 85 | 62 | 876 | 1,071 | 0 | 3 | 167 | 0 | 0 | 
| app_proof | prover | 1 | 857,820,172 | 1,866 | 680 | 0 | 59 | 996 | 517 | 517 | 308 | 169 | 0 | 189 | 44 | 145 | 84 | 60 | 680 | 996 | 0 | 3 | 168 | 0 | 0 | 
| app_proof | prover | 2 | 857,820,172 | 1,863 | 681 | 0 | 59 | 996 | 516 | 516 | 308 | 171 | 0 | 185 | 40 | 145 | 84 | 60 | 681 | 996 | 0 | 3 | 170 | 0 | 0 | 
| app_proof | prover | 3 | 857,820,172 | 1,865 | 680 | 0 | 58 | 998 | 520 | 519 | 307 | 171 | 0 | 185 | 40 | 144 | 84 | 60 | 681 | 998 | 0 | 4 | 170 | 0 | 0 | 
| app_proof | prover | 4 | 857,820,172 | 1,863 | 680 | 0 | 59 | 997 | 517 | 517 | 307 | 171 | 0 | 184 | 39 | 145 | 84 | 60 | 681 | 997 | 0 | 3 | 170 | 0 | 0 | 
| app_proof | prover | 5 | 857,743,372 | 1,866 | 681 | 0 | 58 | 997 | 519 | 519 | 307 | 169 | 0 | 187 | 41 | 145 | 85 | 60 | 681 | 997 | 0 | 3 | 169 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 157 | 2,543 | 157 | 161 | 0 | 3 | 86 | 2,413,000 | 32.23 | 
| app_proof | 1 | 34 | 2,263 | 34 | 41 | 0 | 1 | 322 | 2,413,000 | 35.66 | 
| app_proof | 2 | 34 | 2,199 | 34 | 41 | 0 | 1 | 260 | 2,413,000 | 35.95 | 
| app_proof | 3 | 34 | 2,202 | 34 | 41 | 0 | 1 | 261 | 2,413,000 | 36.40 | 
| app_proof | 4 | 34 | 2,197 | 34 | 41 | 0 | 1 | 259 | 2,413,000 | 36.38 | 
| app_proof | 5 | 33 | 2,171 | 33 | 41 | 0 | 1 | 229 | 2,300,133 | 36.04 | 

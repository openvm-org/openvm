...
| `total_proof_time_ms ` |  2,369.50 |  9,478 |  2,612 |  2,257 |
...
| `execute_preflight_time_ms` |  169 |  676 |  217 |  98 |
| `execute_preflight_insn_mi/s` |  36.94 | -          |  38.04 |  34.23 |
| `trace_gen_time_ms   ` |  97.75 |  391 |  169 |  58 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  2,030.50 |  8,122 |  2,182 |  1,951 |
| `prover.main_trace_commit_time_ms` |  557.75 |  2,231 |  666 |  520 |
| `prover.rap_constraints_time_ms` |  1,328.25 |  5,313 |  1,371 |  1,286 |
| `prover.openings_time_ms` |  143.25 |  573 |  145 |  141 |
| `prover.rap_constraints.logup_gkr_time_ms` |  344.75 |  1,379 |  388 |  298 |
| `prover.rap_constraints.round0_time_ms` |  662.25 |  2,649 |  667 |  659 |
| `prover.rap_constraints.mle_rounds_time_ms` |  320 |  1,280 |  323 |  317 |
| `prover.openings.stacked_reduction_time_ms` |  102 |  408 |  103 |  100 |
| `prover.openings.stacked_reduction.round0_time_ms` |  61.75 |  247 |  63 |  60 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  39.75 |  159 |  40 |  39 |
| `prover.openings.whir_time_ms` |  40.75 |  163 |  42 |  40 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/8122b5c10b48f7d44327717f7ebddc6c7432ae53/sha2_bench-8122b5c10b48f7d44327717f7ebddc6c7432ae53.memory.svg)
...
| app_proof |  |  |  |  |  | 2,259 |  |  | 93 | 11,167,961 | 119.29 | 0 | 9,578 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 61,220,603 | 359 | 184 | 0 | 0 | 131 | 38 | 38 | 66 | 27 | 0 | 43 | 24 | 18 | 5 | 13 | 184 | 131 | 0 | 3 | 26 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,879 | 148 | 48 | 0 | 0 | 72 | 24 | 24 | 30 | 18 | 0 | 27 | 18 | 8 | 2 | 6 | 48 | 72 | 0 | 2 | 17 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 123 | 31 | 0 | 0 | 60 | 22 | 22 | 25 | 13 | 0 | 30 | 23 | 7 | 1 | 5 | 32 | 60 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 424,379,238 | 1,261 | 801 | 0 | 155 | 353 | 169 | 168 | 107 | 76 | 0 | 106 | 41 | 64 | 36 | 28 | 801 | 353 | 0 | 7 | 75 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 662,392,121 | 2,182 | 666 | 0 | 145 | 1,371 | 659 | 658 | 323 | 388 | 100 | 143 | 40 | 102 | 62 | 40 | 666 | 1,371 | 0 | 3 | 287 | 0 | 0 | 
| app_proof | prover | 1 | 662,391,820 | 2,033 | 520 | 0 | 2 | 1,367 | 659 | 658 | 320 | 387 | 111 | 144 | 41 | 103 | 63 | 40 | 520 | 1,367 | 0 | 4 | 275 | 0 | 0 | 
| app_proof | prover | 2 | 662,391,820 | 1,951 | 523 | 0 | 2 | 1,286 | 667 | 667 | 320 | 298 | 0 | 141 | 40 | 100 | 60 | 39 | 523 | 1,286 | 0 | 4 | 297 | 0 | 0 | 
| app_proof | prover | 3 | 662,468,884 | 1,956 | 522 | 0 | 2 | 1,289 | 664 | 664 | 317 | 306 | 0 | 145 | 42 | 103 | 62 | 40 | 522 | 1,289 | 0 | 4 | 305 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 169 | 2,612 | 169 | 161 | 0 | 3 | 98 | 2,851,000 | 34.23 | 
| app_proof | 1 | 58 | 2,350 | 58 | 41 | 0 | 2 | 217 | 2,851,000 | 37.69 | 
| app_proof | 2 | 81 | 2,257 | 81 | 41 | 0 | 2 | 183 | 2,851,000 | 37.81 | 
| app_proof | 3 | 83 | 2,259 | 83 | 41 | 0 | 2 | 178 | 2,614,961 | 38.04 | 

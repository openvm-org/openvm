...
|:---|---:|---:|---:|
| Total |  9.84 |  6.82 |  6.82 |
| app_proof |  8.15 |  5.14 |  5.14 |
| leaf |  1.01 |  1.01 |  1.01 |
...
| `total_proof_time_ms ` |  4,032.50 |  8,065 |  5,049 |  3,016 |
...
| `execute_preflight_time_ms` |  251 |  502 |  297 |  205 |
| `execute_preflight_insn_mi/s` |  37.56 | -          |  39.81 |  35.31 |
| `trace_gen_time_ms   ` |  121.50 |  243 |  170 |  73 |
| `set_initial_memory_time_ms` |  0 |  0 |  0 |  0 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  3,659 |  7,318 |  4,673 |  2,645 |
| `prover.main_trace_commit_time_ms` |  961 |  1,922 |  1,329 |  593 |
| `prover.rap_constraints_time_ms` |  1,983.50 |  3,967 |  2,446 |  1,521 |
| `prover.openings_time_ms` |  713 |  1,426 |  896 |  530 |
| `prover.rap_constraints.logup_gkr_time_ms` |  556.50 |  1,113 |  597 |  516 |
| `prover.rap_constraints.round0_time_ms` |  1,044 |  2,088 |  1,356 |  732 |
...
| `prover.openings.whir_time_ms` |  545 |  1,090 |  680 |  410 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/90e5824086f8c3de7dcb9e1648431b0a900dd483/sha2_bench-90e5824086f8c3de7dcb9e1648431b0a900dd483.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 69 |  |  |  | 337 |  |  |  |  |  |  | 
| app_proof |  |  |  | 3,016 |  | 87 | 11,167,961 | 127.67 | 0 | 8,159 |  | 
...
| leaf | 0 | 109 | 1,008 | 109 | 34 | 17 | 2 | 7 | 7 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 331 | 118 | 0 | 0 | 107 | 35 | 34 | 51 | 20 | 0 | 104 | 90 | 13 | 3 | 9 | 118 | 118 | 107 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 167 | 46 | 0 | 0 | 68 | 25 | 24 | 27 | 15 | 0 | 52 | 44 | 8 | 1 | 6 | 46 | 46 | 68 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 135 | 32 | 0 | 0 | 61 | 22 | 21 | 24 | 14 | 0 | 41 | 34 | 7 | 1 | 5 | 32 | 32 | 61 | 0 | 3 | 12 | 0 | 0 | 
| leaf | 0 | prover | 237,929,016 | 899 | 376 | 0 | 0 | 227 | 109 | 108 | 67 | 51 | 0 | 294 | 257 | 37 | 19 | 17 | 376 | 376 | 227 | 0 | 11 | 50 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,286,242,554 | 4,673 | 1,329 | 0 | 0 | 2,446 | 1,356 | 1,356 | 492 | 597 | 0 | 896 | 680 | 216 | 135 | 81 | 1,329 | 1,329 | 2,446 | 0 | 6 | 596 | 0 | 0 | 
| app_proof | prover | 1 | 750,289,144 | 2,645 | 593 | 0 | 0 | 1,521 | 732 | 731 | 272 | 516 | 0 | 530 | 410 | 120 | 72 | 47 | 593 | 593 | 1,521 | 0 | 6 | 515 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 0 | 1 | 170 | 5,049 | 170 | 0 | 13,306,647,852 | 2,134,713,996 | 15,441,361,848 | 2,097,152 | 0 | 3 | 205 | 7,124,000 | 35.31 | 
| app_proof | 1 | 0 | 1 | 73 | 3,016 | 73 | 0 | 7,584,540,132 | 1,503,573,469 | 9,088,113,601 | 2,097,152 | 0 | 2 | 297 | 4,043,961 | 39.81 | 

...
|:---|---:|---:|---:|
| Total |  9.93 |  6.90 |  6.90 |
| app_proof |  8.21 |  5.19 |  5.19 |
| leaf |  1.02 |  1.02 |  1.02 |
...
| `total_proof_time_ms ` |  4,063.50 |  8,127 |  5,100 |  3,027 |
...
| `execute_preflight_time_ms` |  242.50 |  485 |  282 |  203 |
| `execute_preflight_insn_mi/s` |  37.96 | -          |  40.29 |  35.62 |
| `trace_gen_time_ms   ` |  122.50 |  245 |  173 |  72 |
| `set_initial_memory_time_ms` |  0 |  0 |  0 |  0 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  3,697 |  7,394 |  4,723 |  2,671 |
| `prover.main_trace_commit_time_ms` |  978.50 |  1,957 |  1,358 |  599 |
| `prover.rap_constraints_time_ms` |  2,001.50 |  4,003 |  2,466 |  1,537 |
| `prover.openings_time_ms` |  716 |  1,432 |  898 |  534 |
| `prover.rap_constraints.logup_gkr_time_ms` |  562 |  1,124 |  603 |  521 |
| `prover.rap_constraints.round0_time_ms` |  1,049 |  2,098 |  1,361 |  737 |
| `prover.rap_constraints.mle_rounds_time_ms` |  389.50 |  779 |  501 |  278 |
...
| `prover.openings.whir_time_ms` |  548 |  1,096 |  683 |  413 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/f02812af21dc89b341db1e3f853751424588df54/sha2_bench-f02812af21dc89b341db1e3f853751424588df54.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 71 |  |  |  | 342 |  |  |  |  |  |  | 
| app_proof |  |  |  | 3,027 |  | 88 | 11,167,961 | 126.44 | 0 | 8,222 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 332 | 119 | 0 | 0 | 110 | 35 | 34 | 53 | 20 | 0 | 102 | 88 | 14 | 3 | 9 | 119 | 119 | 110 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 174 | 48 | 0 | 0 | 68 | 25 | 24 | 28 | 14 | 0 | 56 | 48 | 8 | 1 | 6 | 48 | 48 | 68 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 146 | 32 | 0 | 0 | 65 | 25 | 24 | 25 | 14 | 0 | 46 | 39 | 7 | 1 | 5 | 33 | 33 | 65 | 0 | 3 | 13 | 0 | 0 | 
| leaf | 0 | prover | 237,929,016 | 908 | 379 | 0 | 0 | 232 | 113 | 112 | 68 | 51 | 0 | 295 | 258 | 37 | 20 | 17 | 379 | 379 | 232 | 0 | 12 | 50 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,286,242,554 | 4,723 | 1,358 | 0 | 0 | 2,466 | 1,361 | 1,360 | 501 | 603 | 0 | 898 | 683 | 214 | 134 | 80 | 1,358 | 1,358 | 2,466 | 0 | 6 | 602 | 0 | 0 | 
| app_proof | prover | 1 | 750,289,144 | 2,671 | 599 | 0 | 0 | 1,537 | 737 | 736 | 278 | 521 | 0 | 534 | 413 | 120 | 73 | 47 | 599 | 599 | 1,537 | 0 | 6 | 520 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 0 | 1 | 173 | 5,100 | 173 | 0 | 13,306,647,852 | 2,134,713,996 | 15,441,361,848 | 2,097,152 | 0 | 3 | 203 | 7,124,000 | 35.62 | 
| app_proof | 1 | 0 | 1 | 72 | 3,027 | 72 | 0 | 7,584,540,132 | 1,503,573,469 | 9,088,113,601 | 2,097,152 | 0 | 2 | 282 | 4,043,961 | 40.29 | 

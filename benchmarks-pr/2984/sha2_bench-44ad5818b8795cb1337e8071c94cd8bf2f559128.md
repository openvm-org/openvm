...
|:---|---:|---:|---:|
| Total |  9.87 |  6.85 |  6.85 |
| app_proof |  8.18 |  5.16 |  5.16 |
| leaf |  1.01 |  1.01 |  1.01 |
...
| `total_proof_time_ms ` |  4,046.50 |  8,093 |  5,076 |  3,017 |
...
| `execute_preflight_insn_mi/s` |  37.56 | -          |  39.78 |  35.34 |
| `trace_gen_time_ms   ` |  121 |  242 |  170 |  72 |
| `set_initial_memory_time_ms` |  0 |  0 |  0 |  0 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  3,683 |  7,366 |  4,700 |  2,666 |
| `prover.main_trace_commit_time_ms` |  964.50 |  1,929 |  1,335 |  594 |
| `prover.rap_constraints_time_ms` |  2,003 |  4,006 |  2,467 |  1,539 |
| `prover.openings_time_ms` |  714.50 |  1,429 |  897 |  532 |
| `prover.rap_constraints.logup_gkr_time_ms` |  560.50 |  1,121 |  600 |  521 |
| `prover.rap_constraints.round0_time_ms` |  1,058 |  2,116 |  1,371 |  745 |
...
| `prover.openings.whir_time_ms` |  546 |  1,092 |  680 |  412 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/44ad5818b8795cb1337e8071c94cd8bf2f559128/sha2_bench-44ad5818b8795cb1337e8071c94cd8bf2f559128.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 71 |  |  |  | 345 |  |  |  |  |  |  | 
| app_proof |  |  |  | 3,017 |  | 87 | 11,167,961 | 127.11 | 0 | 8,187 |  | 
...
| leaf | 0 | 109 | 1,008 | 108 | 34 | 17 | 2 | 7 | 7 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 320 | 117 | 0 | 0 | 107 | 34 | 34 | 52 | 20 | 0 | 95 | 81 | 13 | 3 | 9 | 118 | 117 | 107 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 175 | 47 | 0 | 0 | 67 | 25 | 24 | 28 | 14 | 0 | 59 | 50 | 8 | 1 | 6 | 47 | 47 | 67 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 140 | 32 | 0 | 0 | 66 | 24 | 24 | 25 | 16 | 0 | 41 | 33 | 7 | 1 | 5 | 33 | 32 | 66 | 0 | 3 | 13 | 0 | 0 | 
| leaf | 0 | prover | 237,929,016 | 899 | 376 | 0 | 0 | 230 | 111 | 110 | 68 | 50 | 0 | 291 | 254 | 37 | 19 | 17 | 377 | 376 | 230 | 0 | 11 | 50 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,286,242,554 | 4,700 | 1,335 | 0 | 0 | 2,467 | 1,371 | 1,370 | 495 | 600 | 0 | 897 | 680 | 216 | 135 | 81 | 1,335 | 1,335 | 2,467 | 0 | 6 | 598 | 0 | 0 | 
| app_proof | prover | 1 | 750,289,144 | 2,666 | 594 | 0 | 0 | 1,539 | 745 | 744 | 272 | 521 | 0 | 532 | 412 | 119 | 72 | 47 | 594 | 594 | 1,538 | 0 | 7 | 520 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 0 | 1 | 170 | 5,076 | 170 | 0 | 13,306,647,852 | 2,134,713,996 | 15,441,361,848 | 2,097,152 | 0 | 3 | 205 | 7,124,000 | 35.34 | 
| app_proof | 1 | 0 | 1 | 72 | 3,017 | 72 | 0 | 7,584,540,132 | 1,503,573,469 | 9,088,113,601 | 2,097,152 | 0 | 2 | 278 | 4,043,961 | 39.78 | 

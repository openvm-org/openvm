...
| `total_proof_time_ms ` |  3,989 |  7,978 |  5,002 |  2,976 |
...
| `execute_preflight_insn_mi/s` |  37.47 | -          |  39.70 |  35.23 |
| `trace_gen_time_ms   ` |  121 |  242 |  170 |  72 |
| `set_initial_memory_time_ms` |  0 |  0 |  0 |  0 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  3,624.50 |  7,249 |  4,625 |  2,624 |
| `prover.main_trace_commit_time_ms` |  952 |  1,904 |  1,318 |  586 |
| `prover.rap_constraints_time_ms` |  1,965 |  3,930 |  2,419 |  1,511 |
| `prover.openings_time_ms` |  705.50 |  1,411 |  886 |  525 |
| `prover.rap_constraints.logup_gkr_time_ms` |  551.50 |  1,103 |  590 |  513 |
| `prover.rap_constraints.round0_time_ms` |  1,036 |  2,072 |  1,343 |  729 |
| `prover.rap_constraints.mle_rounds_time_ms` |  376.50 |  753 |  485 |  268 |
...
| `prover.openings.whir_time_ms` |  543 |  1,086 |  677 |  409 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/8b43b7616d136f7997a73fc29ff863900720903e/sha2_bench-8b43b7616d136f7997a73fc29ff863900720903e.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 68 |  |  |  | 341 |  |  |  |  |  |  | 
| app_proof |  |  |  | 2,976 |  | 87 | 11,167,961 | 127.30 | 0 | 8,071 |  | 
...
| leaf | 0 | 109 | 1,002 | 108 | 35 | 17 | 2 | 7 | 7 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 326 | 116 | 0 | 0 | 107 | 33 | 33 | 51 | 21 | 0 | 102 | 88 | 13 | 3 | 10 | 117 | 116 | 107 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 168 | 47 | 0 | 0 | 67 | 24 | 23 | 27 | 14 | 0 | 53 | 45 | 8 | 1 | 6 | 47 | 47 | 67 | 0 | 3 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 134 | 31 | 0 | 0 | 62 | 23 | 22 | 24 | 13 | 0 | 40 | 32 | 7 | 1 | 5 | 32 | 31 | 61 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 237,929,016 | 893 | 372 | 0 | 0 | 225 | 107 | 106 | 67 | 50 | 0 | 295 | 257 | 37 | 19 | 17 | 372 | 372 | 225 | 0 | 11 | 50 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,286,242,554 | 4,625 | 1,318 | 0 | 0 | 2,419 | 1,343 | 1,343 | 485 | 590 | 0 | 886 | 677 | 209 | 130 | 79 | 1,318 | 1,318 | 2,419 | 0 | 6 | 589 | 0 | 0 | 
| app_proof | prover | 1 | 750,289,144 | 2,624 | 586 | 0 | 0 | 1,511 | 729 | 729 | 268 | 513 | 0 | 525 | 409 | 116 | 70 | 46 | 586 | 586 | 1,511 | 0 | 6 | 512 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 0 | 1 | 170 | 5,002 | 170 | 0 | 13,306,647,852 | 2,134,713,996 | 15,441,361,848 | 2,097,152 | 0 | 3 | 205 | 7,124,000 | 35.23 | 
| app_proof | 1 | 0 | 1 | 72 | 2,976 | 72 | 0 | 7,584,540,132 | 1,503,573,469 | 9,088,113,601 | 2,097,152 | 0 | 2 | 278 | 4,043,961 | 39.70 | 

...
|:---|---:|---:|---:|
| Total | <span style='color: green'>(-0 [-3.0%])</span> 9.50 | <span style='color: green'>(-0 [-1.0%])</span> 5.19 | 5.19 |
| pairing | <span style='color: green'>(-0 [-3.0%])</span> 9.50 | <span style='color: green'>(-0 [-1.0%])</span> 5.19 |  5.19 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: green'>(-146 [-3.0%])</span> 4,717 | <span style='color: green'>(-293 [-3.0%])</span> 9,434 | <span style='color: green'>(-50 [-1.0%])</span> 5,130 | <span style='color: green'>(-243 [-5.3%])</span> 4,304 |
...
| `execute_metered_insn_mi/s` | <span style='color: green'>(-0 [-1.5%])</span> 27.28 | -          | <span style='color: green'>(-0 [-1.5%])</span> 27.28 | <span style='color: green'>(-0 [-1.5%])</span> 27.28 |
| `execute_preflight_insns` |  872,871 |  1,745,742 |  1,149,000 |  596,742 |
| `execute_preflight_time_ms` | <span style='color: green'>(-2 [-1.8%])</span> 82.50 | <span style='color: green'>(-3 [-1.8%])</span> 165 | <span style='color: green'>(-2 [-1.7%])</span> 118 | <span style='color: green'>(-1 [-2.1%])</span> 47 |
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+1 [+4.0%])</span> 15.03 | -          | <span style='color: red'>(+1 [+5.3%])</span> 18.58 | <span style='color: red'>(+0 [+2.0%])</span> 11.47 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+2 [+1.4%])</span> 185.50 | <span style='color: red'>(+5 [+1.4%])</span> 371 | <span style='color: red'>(+3 [+1.5%])</span> 205 | <span style='color: red'>(+2 [+1.2%])</span> 166 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: green'>(-146 [-3.3%])</span> 4,344 | <span style='color: green'>(-293 [-3.3%])</span> 8,688 | <span style='color: green'>(-211 [-4.3%])</span> 4,677 | <span style='color: green'>(-82 [-2.0%])</span> 4,011 |
| `main_trace_commit_time_ms` | <span style='color: green'>(-2 [-2.3%])</span> 63.50 | <span style='color: green'>(-3 [-2.3%])</span> 127 | <span style='color: green'>(-1 [-1.3%])</span> 74 | <span style='color: green'>(-2 [-3.6%])</span> 53 |
| `generate_perm_trace_time_ms` | <span style='color: red'>(+49 [+105.4%])</span> 95.50 | <span style='color: red'>(+98 [+105.4%])</span> 191 | <span style='color: red'>(+56 [+119.1%])</span> 103 | <span style='color: red'>(+42 [+91.3%])</span> 88 |
| `perm_trace_commit_time_ms` |  76.72 |  153.44 | <span style='color: green'>(-1 [-1.0%])</span> 88.78 | <span style='color: red'>(+1 [+1.3%])</span> 64.66 |
| `quotient_poly_compute_time_ms` | <span style='color: green'>(-2 [-2.6%])</span> 81.05 | <span style='color: green'>(-4 [-2.6%])</span> 162.11 | <span style='color: green'>(-2 [-2.6%])</span> 89.99 | <span style='color: green'>(-2 [-2.5%])</span> 72.12 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+0 [+0.9%])</span> 17.41 | <span style='color: red'>(+0 [+0.9%])</span> 34.83 | <span style='color: red'>(+0 [+2.4%])</span> 20.06 | <span style='color: green'>(-0 [-1.0%])</span> 14.77 |
| `pcs_opening_time_ms ` | <span style='color: green'>(-192 [-4.6%])</span> 4,004 | <span style='color: green'>(-385 [-4.6%])</span> 8,008 | <span style='color: green'>(-318 [-6.9%])</span> 4,310 | <span style='color: green'>(-67 [-1.8%])</span> 3,698 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 4,304 | 1 | 63 | 1,745,742 | 27.28 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 166 | 5,130 | 32,480,114 | 172,558,444 | 166 | 4,677 | 0 | 89.99 | 20.06 | 8 | 88.78 | 4,310 | 180 | 4,310 | 1 | 74 | 15,909,408 | 88 | 118 | 1,149,000 | 11.47 | 27 | 110 | 1 | 4,310 | 
| pairing | 1 | 205 | 4,304 | 22,464,232 | 119,958,502 | 205 | 4,011 | 1 | 72.12 | 14.77 | 8 | 64.66 | 3,698 | 171 | 3,698 | 0 | 53 | 9,498,894 | 103 | 47 | 596,742 | 18.58 | 21 | 87 | 1 | 3,698 | 

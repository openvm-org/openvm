...
|:---|---:|---:|---:|
| Total | <span style='color: red'>(+1 [+28.4%])</span> 5.29 | <span style='color: red'>(+1 [+28.4%])</span> 5.29 | 5.29 |
| ecrecover_program | <span style='color: red'>(+1 [+28.4%])</span> 5.29 | <span style='color: red'>(+1 [+28.4%])</span> 5.29 |  5.29 |


| ecrecover_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+1171 [+28.5%])</span> 5,281 | <span style='color: red'>(+1171 [+28.5%])</span> 5,281 | <span style='color: red'>(+1171 [+28.5%])</span> 5,281 | <span style='color: red'>(+1171 [+28.5%])</span> 5,281 |
...
| `execute_metered_insn_mi/s` | <span style='color: red'>(+0 [+1.8%])</span> 19.96 | -          | <span style='color: red'>(+0 [+1.8%])</span> 19.96 | <span style='color: red'>(+0 [+1.8%])</span> 19.96 |
...
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+0 [+0.2%])</span> 2.21 | -          | <span style='color: red'>(+0 [+0.2%])</span> 2.21 | <span style='color: red'>(+0 [+0.2%])</span> 2.21 |
...
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+1163 [+31.7%])</span> 4,835 | <span style='color: red'>(+1163 [+31.7%])</span> 4,835 | <span style='color: red'>(+1163 [+31.7%])</span> 4,835 | <span style='color: red'>(+1163 [+31.7%])</span> 4,835 |
| `main_trace_commit_time_ms` |  37 |  37 |  37 |  37 |
| `generate_perm_trace_time_ms` | <span style='color: green'>(-76 [-60.3%])</span> 50 | <span style='color: green'>(-76 [-60.3%])</span> 50 | <span style='color: green'>(-76 [-60.3%])</span> 50 | <span style='color: green'>(-76 [-60.3%])</span> 50 |
| `perm_trace_commit_time_ms` |  34.19 |  34.19 |  34.19 |  34.19 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+1 [+0.6%])</span> 104.85 | <span style='color: red'>(+1 [+0.6%])</span> 104.85 | <span style='color: red'>(+1 [+0.6%])</span> 104.85 | <span style='color: red'>(+1 [+0.6%])</span> 104.85 |
...
| `pcs_opening_time_ms ` | <span style='color: red'>(+1238 [+36.9%])</span> 4,591 | <span style='color: red'>(+1238 [+36.9%])</span> 4,591 | <span style='color: red'>(+1238 [+36.9%])</span> 4,591 | <span style='color: red'>(+1238 [+36.9%])</span> 4,591 |
...
| --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 5,281 | 1 | 6 | 122,859 | 19.96 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 213 | 5,281 | 11,345,240 | 31,789,298 | 213 | 4,835 | 0 | 104.85 | 9.14 | 10 | 34.19 | 4,591 | 91 | 4,591 | 0 | 37 | 2,263,998 | 50 | 62 | 122,859 | 2.21 | 21 | 114 | 1 | 4,591 | 

...
| `total_proof_time_ms ` |  1,494.50 |  2,989 |  1,730 |  1,259 |
...
| `execute_metered_insn_mi/s` |  94.22 | -          |  94.22 |  94.22 |
| `execute_preflight_insns` |  2,054,241.50 |  4,108,483 |  2,211,000 |  1,897,483 |
| `execute_preflight_time_ms` |  93.50 |  187 |  107 |  80 |
| `execute_preflight_insn_mi/s` |  31.57 | -          |  32.93 |  30.22 |
| `trace_gen_time_ms   ` |  320 |  640 |  341 |  299 |
| `memory_finalize_time_ms` |  2 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  992.50 |  1,985 |  1,222 |  763 |
| `main_trace_commit_time_ms` |  143 |  286 |  186 |  100 |
| `generate_perm_trace_time_ms` |  63 |  126 |  79 |  47 |
| `perm_trace_commit_time_ms` |  172.92 |  345.84 |  224.07 |  121.77 |
| `quotient_poly_compute_time_ms` |  169.01 |  338.02 |  188.77 |  149.25 |
| `quotient_poly_commit_time_ms` |  36.41 |  72.82 |  47.58 |  25.24 |
| `pcs_opening_time_ms ` |  401.50 |  803 |  532 |  271 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 1,259 | 40 | 1 | 43 | 4,108,483 | 94.22 | 248 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 299 | 1,730 | 23,397,108 | 373,183,036 | 299 | 1,222 | 0 | 149.25 | 47.58 | 6 | 224.07 | 532 | 304 | 532 | 4 | 186 | 10,866,434 | 79 | 80 | 2,211,000 | 30.22 | 47 | 198 | 2 | 532 | 
| regex_program | 1 | 341 | 1,259 | 11,981,356 | 196,739,722 | 341 | 763 | 2 | 188.77 | 25.24 | 5 | 121.77 | 271 | 172 | 271 | 0 | 100 | 2,537,170 | 47 | 107 | 1,897,483 | 32.93 | 28 | 219 | 2 | 271 | 

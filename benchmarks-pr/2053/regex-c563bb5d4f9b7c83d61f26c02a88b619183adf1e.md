...
| `total_proof_time_ms ` |  1,484 |  2,968 |  1,719 |  1,249 |
...
| `execute_metered_insn_mi/s` |  92.39 | -          |  92.39 |  92.39 |
| `execute_preflight_insns` |  2,054,241.50 |  4,108,483 |  2,211,000 |  1,897,483 |
| `execute_preflight_time_ms` |  95 |  190 |  108 |  82 |
| `execute_preflight_insn_mi/s` |  31.42 | -          |  33.54 |  29.31 |
| `trace_gen_time_ms   ` |  313 |  626 |  334 |  292 |
| `memory_finalize_time_ms` |  2 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  988.50 |  1,977 |  1,218 |  759 |
| `main_trace_commit_time_ms` |  141 |  282 |  183 |  99 |
| `generate_perm_trace_time_ms` |  62.50 |  125 |  78 |  47 |
| `perm_trace_commit_time_ms` |  172.20 |  344.40 |  223.98 |  120.42 |
| `quotient_poly_compute_time_ms` |  167.14 |  334.27 |  186.87 |  147.40 |
| `quotient_poly_commit_time_ms` |  36.74 |  73.49 |  48.32 |  25.16 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 1,249 | 40 | 1 | 44 | 4,108,483 | 92.39 | 248 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 292 | 1,719 | 23,397,108 | 373,183,036 | 292 | 1,218 | 0 | 147.40 | 48.32 | 6 | 223.98 | 532 | 303 | 532 | 4 | 183 | 10,866,434 | 78 | 82 | 2,211,000 | 29.31 | 47 | 197 | 2 | 532 | 
| regex_program | 1 | 334 | 1,249 | 11,981,356 | 196,739,722 | 333 | 759 | 2 | 186.87 | 25.16 | 5 | 120.42 | 270 | 171 | 270 | 0 | 99 | 2,537,170 | 47 | 108 | 1,897,483 | 33.54 | 28 | 217 | 2 | 270 | 

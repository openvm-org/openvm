...
| `total_proof_time_ms ` |  1,475 |  2,950 |  1,708 |  1,242 |
...
| `execute_preflight_insn_mi/s` |  31.59 | -          |  33.63 |  29.55 |
| `trace_gen_time_ms   ` |  313 |  626 |  335 |  291 |
| `memory_finalize_time_ms` |  2 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  980.50 |  1,961 |  1,208 |  753 |
| `main_trace_commit_time_ms` |  141 |  282 |  183 |  99 |
| `generate_perm_trace_time_ms` |  61.50 |  123 |  77 |  46 |
| `perm_trace_commit_time_ms` |  169.28 |  338.55 |  218.13 |  120.42 |
| `quotient_poly_compute_time_ms` |  165.43 |  330.87 |  184.58 |  146.29 |
| `quotient_poly_commit_time_ms` |  35.54 |  71.07 |  47.62 |  23.46 |
| `pcs_opening_time_ms ` |  400.50 |  801 |  532 |  269 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 1,242 | 40 | 1 | 39 | 4,108,483 | 102.87 | 248 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 291 | 1,708 | 23,397,108 | 373,183,036 | 291 | 1,208 | 0 | 146.29 | 47.62 | 6 | 218.13 | 532 | 296 | 531 | 4 | 183 | 10,866,434 | 77 | 82 | 2,211,000 | 29.55 | 47 | 195 | 2 | 531 | 
| regex_program | 1 | 335 | 1,242 | 11,981,356 | 196,739,722 | 335 | 753 | 2 | 184.58 | 23.46 | 6 | 120.42 | 269 | 170 | 269 | 0 | 99 | 2,537,170 | 46 | 107 | 1,897,483 | 33.63 | 28 | 213 | 2 | 269 | 

...
|:---|---:|---:|---:|
| Total |  18.96 |  5.35 |  5.35 |
| app_proof |  15.88 |  3.05 |  3.05 |
| leaf |  2.23 |  1.45 |  1.45 |
...
| `total_proof_time_ms ` |  2,640.33 |  15,842 |  3,016 |  2,552 |
| `execute_metered_time_ms` |  37 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  32.82 | -          |  32.82 |  32.82 |
| `execute_preflight_insns` |  205,869.67 |  1,235,218 |  207,000 |  200,218 |
| `execute_preflight_time_ms` |  176.67 |  1,060 |  263 |  16 |
| `execute_preflight_insn_mi/s` |  17.96 | -          |  18.07 |  17.78 |
| `trace_gen_time_ms   ` |  392.33 |  2,354 |  546 |  350 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  2,007.17 |  12,043 |  2,281 |  1,947 |
| `prover.main_trace_commit_time_ms` |  697.50 |  4,185 |  860 |  664 |
| `prover.rap_constraints_time_ms` |  1,123 |  6,738 |  1,236 |  1,096 |
| `prover.openings_time_ms` |  185.50 |  1,113 |  191 |  183 |
| `prover.rap_constraints.logup_gkr_time_ms` |  277.17 |  1,663 |  389 |  254 |
| `prover.rap_constraints.round0_time_ms` |  523.67 |  3,142 |  525 |  520 |
| `prover.rap_constraints.mle_rounds_time_ms` |  321 |  1,926 |  326 |  318 |
| `prover.openings.stacked_reduction_time_ms` |  142.50 |  855 |  146 |  140 |
| `prover.openings.stacked_reduction.round0_time_ms` |  85.83 |  515 |  88 |  84 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  55.83 |  335 |  58 |  55 |
| `prover.openings.whir_time_ms` |  42.33 |  254 |  45 |  40 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,114.50 |  2,229 |  1,447 |  782 |
| `execute_preflight_time_ms` |  4.50 |  9 |  5 |  4 |
| `trace_gen_time_ms   ` |  137.50 |  275 |  185 |  90 |
| `generate_blob_total_time_ms` |  25.50 |  51 |  34 |  17 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  976.50 |  1,953 |  1,261 |  692 |
| `prover.main_trace_commit_time_ms` |  552 |  1,104 |  725 |  379 |
| `prover.rap_constraints_time_ms` |  315 |  630 |  405 |  225 |
| `prover.openings_time_ms` |  108.50 |  217 |  129 |  88 |
| `prover.rap_constraints.logup_gkr_time_ms` |  66 |  132 |  82 |  50 |
| `prover.rap_constraints.round0_time_ms` |  153 |  306 |  200 |  106 |
...
| `prover.openings.whir_time_ms` |  39 |  78 |  43 |  35 |
...
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  481 |  481 |  481 |  481 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/46e2f4e886e2bda251d0aa1e5b024cc4e5dea5bf/keccak-46e2f4e886e2bda251d0aa1e5b024cc4e5dea5bf.memory.svg)
...
| app_proof |  |  |  |  |  | 2,563 |  |  | 37 | 1,235,218 | 32.82 | 0 | 15,886 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 38 | 519 | 37 | 13 | 4 | 2 | 2 | 2 | 
| internal_recursive.0 | 1 | 12 | 182 | 12 | 2 | 1 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 8 | 152 | 8 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 185 | 1,447 | 185 | 65 | 34 | 5 | 7 | 7 | 
| leaf | 1 | 90 | 782 | 89 | 32 | 17 | 4 | 7 | 7 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 109,497,984 | 481 | 250 | 0 | 14 | 174 | 46 | 45 | 94 | 33 | 0 | 56 | 18 | 38 | 7 | 30 | 250 | 174 | 0 | 2 | 32 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 25,962,119 | 170 | 51 | 0 | 3 | 76 | 23 | 23 | 29 | 23 | 0 | 42 | 18 | 24 | 1 | 22 | 51 | 76 | 0 | 2 | 21 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 17,507,975 | 143 | 34 | 0 | 3 | 63 | 22 | 21 | 24 | 17 | 0 | 44 | 22 | 22 | 1 | 21 | 34 | 63 | 0 | 2 | 16 | 0 | 0 | 
| leaf | 0 | prover | 583,523,386 | 1,261 | 725 | 0 | 47 | 405 | 200 | 199 | 122 | 82 | 0 | 129 | 43 | 86 | 41 | 45 | 725 | 405 | 0 | 6 | 81 | 0 | 0 | 
| leaf | 1 | prover | 300,618,208 | 692 | 378 | 0 | 24 | 225 | 106 | 105 | 68 | 50 | 0 | 88 | 35 | 52 | 20 | 32 | 379 | 225 | 0 | 5 | 50 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,205,061,845 | 2,281 | 860 | 0 | 248 | 1,236 | 520 | 520 | 326 | 389 | 133 | 184 | 40 | 144 | 85 | 58 | 860 | 1,236 | 0 | 4 | 255 | 0 | 0 | 
| app_proof | prover | 1 | 1,205,053,652 | 1,947 | 664 | 0 | 51 | 1,096 | 523 | 523 | 318 | 254 | 0 | 186 | 44 | 141 | 85 | 55 | 664 | 1,096 | 0 | 4 | 253 | 0 | 0 | 
| app_proof | prover | 2 | 1,205,053,652 | 1,950 | 664 | 0 | 51 | 1,102 | 525 | 525 | 321 | 255 | 0 | 183 | 41 | 141 | 86 | 55 | 664 | 1,102 | 0 | 4 | 254 | 0 | 0 | 
| app_proof | prover | 3 | 1,205,053,652 | 1,952 | 664 | 0 | 51 | 1,103 | 525 | 525 | 321 | 255 | 0 | 184 | 40 | 143 | 87 | 55 | 664 | 1,103 | 0 | 4 | 254 | 0 | 0 | 
| app_proof | prover | 4 | 1,205,053,652 | 1,953 | 667 | 0 | 51 | 1,100 | 524 | 523 | 320 | 255 | 0 | 185 | 44 | 140 | 84 | 55 | 667 | 1,100 | 0 | 3 | 254 | 0 | 0 | 
| app_proof | prover | 5 | 1,205,062,652 | 1,960 | 666 | 0 | 52 | 1,101 | 525 | 525 | 320 | 255 | 0 | 191 | 45 | 146 | 88 | 57 | 666 | 1,101 | 0 | 3 | 254 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 546 | 3,016 | 546 | 172 | 0 | 193 | 16 | 207,000 | 17.78 | 
| app_proof | 1 | 350 | 2,602 | 350 | 41 | 0 | 1 | 263 | 207,000 | 17.94 | 
| app_proof | 2 | 357 | 2,552 | 357 | 41 | 0 | 8 | 202 | 207,000 | 18.02 | 
| app_proof | 3 | 359 | 2,554 | 359 | 41 | 0 | 10 | 201 | 207,000 | 18.07 | 
| app_proof | 4 | 357 | 2,555 | 357 | 41 | 0 | 8 | 202 | 207,000 | 18.02 | 
| app_proof | 5 | 385 | 2,563 | 385 | 41 | 0 | 35 | 176 | 200,218 | 17.92 | 

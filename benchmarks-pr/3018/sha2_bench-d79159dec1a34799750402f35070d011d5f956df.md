...
| `total_proof_time_ms ` |  2,037.50 |  4,075 |  2,380 |  1,695 |
...
| `execute_preflight_time_ms` |  344 |  688 |  493 |  195 |
| `execute_preflight_insn_mi/s` |  37.09 | -          |  37.71 |  36.47 |
| `trace_gen_time_ms   ` |  74 |  148 |  101 |  47 |
| `set_initial_memory_time_ms` |  0 |  0 |  0 |  0 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,618 |  3,236 |  2,082 |  1,154 |
| `prover.main_trace_commit_time_ms` |  404.50 |  809 |  573 |  236 |
| `prover.rap_constraints_time_ms` |  935.50 |  1,871 |  1,162 |  709 |
| `prover.openings_time_ms` |  277.50 |  555 |  347 |  208 |
| `prover.rap_constraints.logup_gkr_time_ms` |  218 |  436 |  235 |  201 |
| `prover.rap_constraints.round0_time_ms` |  529 |  1,058 |  686 |  372 |
| `prover.rap_constraints.mle_rounds_time_ms` |  187 |  374 |  239 |  135 |
| `prover.openings.stacked_reduction_time_ms` |  75 |  150 |  95 |  55 |
...
| `prover.openings.whir_time_ms` |  201.50 |  403 |  251 |  152 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/d79159dec1a34799750402f35070d011d5f956df/sha2_bench-d79159dec1a34799750402f35070d011d5f956df.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 58 |  |  |  | 291 |  |  |  |  |  |  | 
| app_proof |  |  |  | 1,695 |  | 57 | 11,167,961 | 195.33 | 0 | 4,140 |  | 
...
| leaf | 0 | 118 | 525 | 117 | 35 | 13 | 2 | 10 | 10 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 175 | 47 | 0 | 0 | 80 | 29 | 28 | 37 | 14 | 0 | 47 | 37 | 10 | 2 | 7 | 47 | 47 | 80 | 0 | 1 | 12 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 110 | 20 | 0 | 0 | 55 | 20 | 20 | 23 | 11 | 0 | 33 | 26 | 7 | 1 | 6 | 20 | 20 | 55 | 0 | 1 | 10 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 101 | 15 | 0 | 0 | 54 | 20 | 19 | 22 | 11 | 0 | 31 | 24 | 7 | 1 | 5 | 15 | 15 | 54 | 0 | 1 | 10 | 0 | 0 | 
| leaf | 0 | prover | 237,929,016 | 407 | 147 | 0 | 0 | 142 | 71 | 70 | 44 | 26 | 0 | 117 | 95 | 22 | 10 | 11 | 147 | 147 | 142 | 0 | 3 | 25 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,286,243,578 | 2,082 | 572 | 0 | 0 | 1,162 | 686 | 686 | 239 | 235 | 0 | 347 | 251 | 95 | 58 | 36 | 573 | 572 | 1,162 | 0 | 1 | 234 | 0 | 0 | 
| app_proof | prover | 1 | 750,290,168 | 1,154 | 236 | 0 | 0 | 709 | 372 | 371 | 135 | 201 | 0 | 208 | 152 | 55 | 33 | 22 | 236 | 236 | 709 | 0 | 1 | 199 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 0 | 2 | 101 | 2,380 | 101 | 0 | 13,306,656,804 | 2,134,717,332 | 15,441,374,136 | 2,097,152 | 0 | 3 | 195 | 7,124,000 | 37.71 | 
| app_proof | 1 | 0 | 1 | 47 | 1,695 | 47 | 0 | 7,584,549,132 | 1,503,568,565 | 9,088,117,697 | 2,097,152 | 0 | 2 | 493 | 4,043,961 | 36.47 | 

...
| `total_proof_time_ms ` |  3,464.50 |  6,929 |  4,502 |  2,427 |
...
| `execute_e3_time_ms  ` |  119 |  238 |  135 |  103 |
| `execute_e3_insn_mi/s` |  17.36 | -          |  18.35 |  16.37 |
| `trace_gen_time_ms   ` |  393 |  786 |  507 |  279 |
| `memory_finalize_time_ms` |  8 |  16 |  13 |  3 |
| `boundary_finalize_time_ms` |  2 |  4 |  4 |  0 |
| `merkle_finalize_time_ms` |  138.50 |  277 |  226 |  51 |
| `stark_prove_excluding_trace_time_ms` |  2,952.50 |  5,905 |  3,860 |  2,045 |
| `main_trace_commit_time_ms` |  563 |  1,126 |  755 |  371 |
| `generate_perm_trace_time_ms` |  220.50 |  441 |  295 |  146 |
| `perm_trace_commit_time_ms` |  580.50 |  1,161 |  761 |  400 |
| `quotient_poly_compute_time_ms` |  322 |  644 |  433 |  211 |
| `quotient_poly_commit_time_ms` |  275 |  550 |  368 |  182 |
| `pcs_opening_time_ms ` |  983.50 |  1,967 |  1,242 |  725 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2,674 | 6 | 4,108,597 | 1 | 32 | 126.83 | 44 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 507 | 4,502 | 209,713,811 | 373,183,036 | 507 | 3,860 | 2 | 433 | 368 | 761 | 1,242 | 226 | 9 | 13 | 755 | 90,228,333 | 2,211,000 | 295 | 135 | 16.37 | 4 | 
| regex_program | 1 | 279 | 2,427 | 174,303,431 | 196,838,026 | 279 | 2,045 | 2 | 211 | 182 | 400 | 725 | 51 | 6 | 3 | 371 | 73,441,541 | 1,897,597 | 146 | 103 | 18.35 | 0 | 

...
|:---|---:|---:|---:|
| Total | <span style='color: green'>(-1 [-17.4%])</span> 7.04 | <span style='color: green'>(-1 [-13.8%])</span> 4.37 | 4.37 |
| pairing | <span style='color: green'>(-1 [-17.4%])</span> 7.04 | <span style='color: green'>(-1 [-13.8%])</span> 4.37 |  4.37 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: green'>(-740 [-17.5%])</span> 3,488.50 | <span style='color: green'>(-1479 [-17.5%])</span> 6,977 | <span style='color: green'>(-699 [-14.0%])</span> 4,303 | <span style='color: green'>(-780 [-22.6%])</span> 2,674 |
...
| `execute_metered_insn_mi/s` | <span style='color: red'>(+0 [+0.6%])</span> 27.67 | -          | <span style='color: red'>(+0 [+0.6%])</span> 27.67 | <span style='color: red'>(+0 [+0.6%])</span> 27.67 |
| `execute_preflight_insns` |  872,871 |  1,745,742 |  1,149,000 |  596,742 |
| `execute_preflight_time_ms` | <span style='color: green'>(-3 [-3.5%])</span> 82.50 | <span style='color: green'>(-6 [-3.5%])</span> 165 | <span style='color: green'>(-5 [-4.1%])</span> 117 | <span style='color: green'>(-1 [-2.0%])</span> 48 |
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+0 [+1.4%])</span> 14.95 | -          | <span style='color: red'>(+0 [+1.3%])</span> 18.30 | <span style='color: red'>(+0 [+1.4%])</span> 11.61 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+2 [+1.4%])</span> 187 | <span style='color: red'>(+5 [+1.4%])</span> 374 | <span style='color: green'>(-1 [-0.5%])</span> 205 | <span style='color: red'>(+6 [+3.7%])</span> 169 |
| `memory_finalize_time_ms` | <span style='color: green'>(-1 [-100.0%])</span> 0 | <span style='color: green'>(-2 [-100.0%])</span> 0 | <span style='color: green'>(-1 [-100.0%])</span> 0 | <span style='color: green'>(-1 [-100.0%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: green'>(-740 [-19.2%])</span> 3,113 | <span style='color: green'>(-1479 [-19.2%])</span> 6,226 | <span style='color: green'>(-859 [-18.3%])</span> 3,846 | <span style='color: green'>(-620 [-20.7%])</span> 2,380 |
| `main_trace_commit_time_ms` | <span style='color: green'>(-1 [-1.5%])</span> 64.50 | <span style='color: green'>(-2 [-1.5%])</span> 129 | <span style='color: green'>(-1 [-1.3%])</span> 75 | <span style='color: green'>(-1 [-1.8%])</span> 54 |
| `generate_perm_trace_time_ms` | <span style='color: green'>(-36 [-42.9%])</span> 48.50 | <span style='color: green'>(-73 [-42.9%])</span> 97 | <span style='color: green'>(-37 [-37.4%])</span> 62 | <span style='color: green'>(-36 [-50.7%])</span> 35 |
| `perm_trace_commit_time_ms` |  77.31 |  154.62 | <span style='color: green'>(-1 [-0.6%])</span> 89.53 | <span style='color: red'>(+1 [+0.9%])</span> 65.09 |
| `quotient_poly_compute_time_ms` | <span style='color: green'>(-1 [-1.0%])</span> 82.65 | <span style='color: green'>(-2 [-1.0%])</span> 165.30 | <span style='color: red'>(+0 [+0.1%])</span> 91.07 | <span style='color: green'>(-2 [-2.2%])</span> 74.23 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+1 [+7.5%])</span> 17.19 | <span style='color: red'>(+2 [+7.5%])</span> 34.38 | <span style='color: red'>(+2 [+14.8%])</span> 19.26 | <span style='color: green'>(-0 [-0.5%])</span> 15.12 |
| `pcs_opening_time_ms ` | <span style='color: green'>(-704 [-20.0%])</span> 2,816 | <span style='color: green'>(-1409 [-20.0%])</span> 5,632 | <span style='color: green'>(-862 [-19.6%])</span> 3,529 | <span style='color: green'>(-547 [-20.6%])</span> 2,103 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 2,674 | 1 | 63 | 1,745,742 | 27.67 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 169 | 4,303 | 32,480,114 | 172,558,444 | 169 | 3,846 | 0 | 91.07 | 19.26 | 9 | 89.53 | 3,529 | 128 | 3,529 | 0 | 75 | 15,909,408 | 35 | 117 | 1,149,000 | 11.61 | 26 | 111 | 1 | 3,529 | 
| pairing | 1 | 205 | 2,674 | 22,464,232 | 119,958,502 | 205 | 2,380 | 1 | 74.23 | 15.12 | 8 | 65.09 | 2,103 | 131 | 2,103 | 0 | 54 | 9,498,894 | 62 | 48 | 596,742 | 18.30 | 20 | 90 | 1 | 2,103 | 

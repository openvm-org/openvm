...
|:---|---:|---:|
| Total |  2.44 |  0.79 |
| regex_program |  2.41 |  0.76 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  602.25 |  2,409 |  755 |  544 |
...
| `execute_preflight_insn_mi/s` |  30.93 | -          |  32.59 |  27.01 |
| `trace_gen_time_ms   ` |  183.75 |  735 |  217 |  161 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  296.75 |  1,187 |  345 |  269 |
| `main_trace_commit_time_ms` |  53 |  212 |  58 |  50 |
| `generate_perm_trace_time_ms` |  35 |  140 |  55 |  19 |
| `perm_trace_commit_time_ms` |  65.19 |  260.76 |  70.89 |  56.22 |
| `quotient_poly_compute_time_ms` |  61.13 |  244.52 |  72.91 |  54.04 |
| `quotient_poly_commit_time_ms` |  15.68 |  62.71 |  18.28 |  13.25 |
| `pcs_opening_time_ms ` |  63.75 |  255 |  78 |  52 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 544 | 41 | 1 | 35 | 4,137,502 | 115.79 | 170 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 217 | 755 | 23,446,148 | 150,778,428 | 217 | 345 | 0 | 62.47 | 18.28 | 5 | 70.89 | 78 | 127 | 78 | 4 | 58 | 10,899,170 | 55 | 47 | 1,103,000 | 27.01 | 21 | 81 | 1 | 78 | 
| regex_program | 1 | 161 | 562 | 11,598,276 | 128,513,066 | 161 | 294 | 1 | 55.11 | 15.92 | 4 | 67.48 | 63 | 106 | 63 | 0 | 52 | 2,196,106 | 38 | 65 | 1,104,000 | 32.59 | 16 | 71 | 0 | 63 | 
| regex_program | 2 | 169 | 548 | 11,579,064 | 128,513,066 | 169 | 279 | 1 | 54.04 | 15.26 | 4 | 66.18 | 62 | 94 | 62 | 0 | 52 | 2,177,334 | 28 | 58 | 1,104,000 | 32.34 | 17 | 69 | 0 | 62 | 
| regex_program | 3 | 188 | 544 | 11,853,872 | 103,456,394 | 188 | 269 | 0 | 72.91 | 13.25 | 5 | 56.22 | 52 | 79 | 51 | 0 | 50 | 2,422,606 | 19 | 46 | 826,502 | 31.80 | 18 | 87 | 1 | 51 | 
...
Commit: https://github.com/openvm-org/openvm/commit/ac8258707fc388628947cad72024302975495809
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19281705452)

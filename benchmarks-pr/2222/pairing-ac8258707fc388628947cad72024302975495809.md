...
| `total_proof_time_ms ` |  711.50 |  1,423 |  817 |  606 |
...
| `execute_preflight_insn_mi/s` |  13.92 | -          |  18.60 |  9.23 |
| `trace_gen_time_ms   ` |  178.50 |  357 |  195 |  162 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  345.50 |  691 |  382 |  309 |
| `main_trace_commit_time_ms` |  64.50 |  129 |  76 |  53 |
| `generate_perm_trace_time_ms` |  44 |  88 |  48 |  40 |
| `perm_trace_commit_time_ms` |  77.07 |  154.14 |  89.10 |  65.04 |
| `quotient_poly_compute_time_ms` |  78.80 |  157.59 |  86.83 |  70.76 |
| `quotient_poly_commit_time_ms` |  16.79 |  33.58 |  18.76 |  14.82 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 606 | 40 | 1 | 95 | 1,745,742 | 18.37 | 144 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 162 | 817 | 32,689,110 | 172,558,444 | 162 | 382 | 0 | 86.83 | 18.76 | 6 | 89.10 | 68 | 131 | 67 | 1 | 76 | 16,059,916 | 40 | 128 | 1,157,000 | 9.23 | 26 | 106 | 1 | 67 | 
| pairing | 1 | 195 | 606 | 22,314,288 | 119,958,502 | 195 | 309 | 1 | 70.76 | 14.82 | 6 | 65.04 | 53 | 116 | 53 | 0 | 53 | 9,408,294 | 48 | 60 | 588,742 | 18.60 | 20 | 86 | 1 | 53 | 

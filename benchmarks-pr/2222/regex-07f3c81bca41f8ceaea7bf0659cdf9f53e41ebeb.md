...
| `total_proof_time_ms ` |  588.25 |  2,353 |  743 |  534 |
...
| `execute_metered_insn_mi/s` |  111.02 | -          |  111.02 |  111.02 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  53.75 |  215 |  66 |  45 |
| `execute_preflight_insn_mi/s` |  31.05 | -          |  32.06 |  28.45 |
| `trace_gen_time_ms   ` |  177.50 |  710 |  211 |  155 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  289.50 |  1,158 |  342 |  265 |
| `main_trace_commit_time_ms` |  51.75 |  207 |  57 |  48 |
| `generate_perm_trace_time_ms` |  33.75 |  135 |  55 |  18 |
| `perm_trace_commit_time_ms` |  63.69 |  254.75 |  71.10 |  54.43 |
| `quotient_poly_compute_time_ms` |  57.97 |  231.89 |  70.89 |  51.45 |
| `quotient_poly_commit_time_ms` |  14.69 |  58.76 |  16.51 |  12.79 |
| `pcs_opening_time_ms ` |  64.50 |  258 |  82 |  56 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 535 | 66 | 1 | 37 | 4,137,502 | 111.02 | 193 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 211 | 743 | 23,446,148 | 150,778,428 | 211 | 342 | 0 | 57.45 | 16.51 | 5 | 71.10 | 82 | 127 | 82 | 4 | 57 | 10,899,170 | 55 | 45 | 1,103,000 | 28.45 | 21 | 74 | 1 | 82 | 
| regex_program | 1 | 155 | 541 | 11,598,276 | 128,513,066 | 155 | 279 | 1 | 51.45 | 15.12 | 4 | 65.11 | 59 | 101 | 59 | 0 | 51 | 2,196,106 | 35 | 66 | 1,104,000 | 32.06 | 17 | 67 | 0 | 59 | 
| regex_program | 2 | 162 | 534 | 11,579,064 | 128,513,066 | 162 | 272 | 1 | 52.09 | 14.34 | 4 | 64.11 | 61 | 92 | 61 | 0 | 51 | 2,177,334 | 27 | 58 | 1,104,000 | 31.77 | 16 | 67 | 0 | 61 | 
| regex_program | 3 | 182 | 535 | 11,853,872 | 103,456,394 | 182 | 265 | 0 | 70.89 | 12.79 | 5 | 54.43 | 56 | 75 | 56 | 0 | 48 | 2,422,606 | 18 | 46 | 826,502 | 31.91 | 18 | 84 | 1 | 56 | 
...
Commit: https://github.com/openvm-org/openvm/commit/07f3c81bca41f8ceaea7bf0659cdf9f53e41ebeb
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19280857108)

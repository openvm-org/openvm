...
|:---|---:|---:|
| Total |  2.36 |  0.77 |
| regex_program |  2.33 |  0.74 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  581.75 |  2,327 |  737 |  525 |
...
| `execute_preflight_insn_mi/s` |  31.53 | -          |  32.75 |  28.35 |
| `trace_gen_time_ms   ` |  172.50 |  690 |  207 |  149 |
| `memory_finalize_time_ms` |  0.75 |  3 |  3 |  0 |
| `stark_prove_excluding_trace_time_ms` |  288.50 |  1,154 |  341 |  264 |
| `main_trace_commit_time_ms` |  50.75 |  203 |  56 |  49 |
| `generate_perm_trace_time_ms` |  34.75 |  139 |  55 |  19 |
| `perm_trace_commit_time_ms` |  62.70 |  250.79 |  69.28 |  53.45 |
| `quotient_poly_compute_time_ms` |  57.74 |  230.97 |  70.18 |  50.68 |
| `quotient_poly_commit_time_ms` |  14.64 |  58.55 |  17.03 |  12.59 |
| `pcs_opening_time_ms ` |  65 |  260 |  82 |  55 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 528 | 65 | 1 | 36 | 4,137,502 | 113.49 | 193 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 207 | 737 | 23,446,148 | 150,778,428 | 207 | 341 | 0 | 58.64 | 17.03 | 5 | 69.28 | 82 | 125 | 82 | 3 | 56 | 10,899,170 | 55 | 45 | 1,103,000 | 28.35 | 21 | 76 | 1 | 82 | 
| regex_program | 1 | 149 | 537 | 11,598,276 | 128,513,066 | 149 | 281 | 1 | 51.47 | 14.74 | 4 | 64.13 | 62 | 102 | 61 | 0 | 49 | 2,196,106 | 38 | 66 | 1,104,000 | 32.50 | 16 | 66 | 0 | 61 | 
| regex_program | 2 | 156 | 525 | 11,579,064 | 128,513,066 | 156 | 268 | 1 | 50.68 | 14.19 | 4 | 63.93 | 61 | 91 | 60 | 0 | 49 | 2,177,334 | 27 | 58 | 1,104,000 | 32.54 | 16 | 65 | 0 | 60 | 
| regex_program | 3 | 178 | 528 | 11,853,872 | 103,456,394 | 178 | 264 | 0 | 70.18 | 12.59 | 5 | 53.45 | 55 | 75 | 55 | 0 | 49 | 2,422,606 | 19 | 45 | 826,502 | 32.75 | 18 | 83 | 1 | 55 | 
...
Commit: https://github.com/openvm-org/openvm/commit/320339a898b6e855dbcf44b8d863ab510b716353
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19281018561)

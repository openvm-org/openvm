...
| `total_proof_time_ms ` |  1,187 |  2,374 |  1,422 |  952 |
| `execute_metered_time_ms` |  7 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  20.20 | -          |  20.20 |  20.20 |
| `execute_preflight_insns` |  77,381.50 |  154,763 |  121,000 |  33,763 |
| `execute_preflight_time_ms` |  70 |  140 |  121 |  19 |
| `execute_preflight_insn_mi/s` |  8.97 | -          |  11.85 |  6.09 |
| `trace_gen_time_ms   ` |  159.50 |  319 |  190 |  129 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  843 |  1,686 |  1,025 |  661 |
| `prover.main_trace_commit_time_ms` |  222 |  444 |  295 |  149 |
| `prover.rap_constraints_time_ms` |  558 |  1,116 |  656 |  460 |
| `prover.openings_time_ms` |  62 |  124 |  73 |  51 |
| `prover.rap_constraints.logup_gkr_time_ms` |  140 |  280 |  153 |  127 |
| `prover.rap_constraints.round0_time_ms` |  285.50 |  571 |  363 |  208 |
| `prover.rap_constraints.mle_rounds_time_ms` |  131.50 |  263 |  139 |  124 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/9818ca09ed823556382cab10cba5b4cd2afb33c6/kitchen_sink-9818ca09ed823556382cab10cba5b4cd2afb33c6.memory.svg)
...
| app_proof |  |  |  |  |  | 952 |  |  | 7 | 154,763 | 20.20 | 0 | 2,386 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 18 | 159 | 18 | 6 | 1 | 5 | 2 | 
| internal_recursive.0 | 1 | 10 | 112 | 9 | 1 | 0 | 3 | 1 | 
| internal_recursive.1 | 1 | 8 | 103 | 8 | 1 | 0 | 2 | 0 | 
| leaf | 0 | 95 | 406 | 95 | 25 | 11 | 25 | 7 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 53,472,003 | 141 | 40 | 0 | 4 | 64 | 19 | 18 | 29 | 15 | 0 | 35 | 11 | 23 | 1 | 21 | 41 | 64 | 0 | 1 | 15 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 23,651,975 | 102 | 19 | 0 | 4 | 50 | 17 | 16 | 20 | 13 | 0 | 31 | 9 | 21 | 1 | 20 | 19 | 50 | 0 | 1 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 17,507,975 | 94 | 14 | 0 | 4 | 48 | 16 | 16 | 18 | 13 | 0 | 30 | 9 | 21 | 0 | 20 | 15 | 48 | 0 | 1 | 12 | 0 | 0 | 
| leaf | 0 | prover | 407,935,872 | 310 | 124 | 0 | 9 | 142 | 45 | 44 | 36 | 60 | 0 | 43 | 12 | 31 | 6 | 24 | 124 | 142 | 0 | 2 | 59 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 816,542,084 | 1,025 | 294 | 0 | 165 | 656 | 363 | 362 | 139 | 153 | 61 | 73 | 12 | 60 | 15 | 44 | 295 | 656 | 0 | 1 | 91 | 0 | 0 | 
| app_proof | prover | 1 | 800,298,548 | 661 | 148 | 0 | 20 | 460 | 208 | 207 | 124 | 127 | 73 | 51 | 13 | 37 | 15 | 22 | 149 | 460 | 0 | 1 | 53 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 190 | 1,422 | 190 | 186 | 0 | 51 | 19 | 121,000 | 11.85 | 
| app_proof | 1 | 129 | 952 | 129 | 40 | 0 | 2 | 121 | 33,763 | 6.09 | 

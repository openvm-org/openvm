...
| `total_proof_time_ms ` |  2,607.33 |  15,644 |  2,984 |  2,513 |
| `execute_metered_time_ms` |  37 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  33.27 | -          |  33.27 |  33.27 |
| `execute_preflight_insns` |  205,869.67 |  1,235,218 |  207,000 |  200,218 |
| `execute_preflight_time_ms` |  180.83 |  1,085 |  280 |  15 |
| `execute_preflight_insn_mi/s` |  19.07 | -          |  19.16 |  18.88 |
| `trace_gen_time_ms   ` |  387.67 |  2,326 |  541 |  351 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,975.33 |  11,852 |  2,256 |  1,915 |
| `prover.main_trace_commit_time_ms` |  687.67 |  4,126 |  852 |  654 |
| `prover.rap_constraints_time_ms` |  1,105.17 |  6,631 |  1,221 |  1,074 |
| `prover.openings_time_ms` |  181.50 |  1,089 |  188 |  178 |
| `prover.rap_constraints.logup_gkr_time_ms` |  276.17 |  1,657 |  389 |  253 |
| `prover.rap_constraints.round0_time_ms` |  517.50 |  3,105 |  524 |  515 |
| `prover.rap_constraints.mle_rounds_time_ms` |  310.33 |  1,862 |  315 |  304 |
| `prover.openings.stacked_reduction_time_ms` |  139.33 |  836 |  143 |  137 |
| `prover.openings.stacked_reduction.round0_time_ms` |  84.33 |  506 |  87 |  83 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  54.33 |  326 |  56 |  53 |
| `prover.openings.whir_time_ms` |  41.83 |  251 |  46 |  39 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,088.50 |  2,177 |  1,410 |  767 |
| `execute_preflight_time_ms` |  22.50 |  45 |  30 |  15 |
| `trace_gen_time_ms   ` |  126 |  252 |  168 |  84 |
| `generate_blob_total_time_ms` |  25.50 |  51 |  34 |  17 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  961.50 |  1,923 |  1,241 |  682 |
| `prover.main_trace_commit_time_ms` |  542.50 |  1,085 |  713 |  372 |
| `prover.rap_constraints_time_ms` |  308 |  616 |  395 |  221 |
| `prover.openings_time_ms` |  110 |  220 |  132 |  88 |
| `prover.rap_constraints.logup_gkr_time_ms` |  66.50 |  133 |  82 |  51 |
| `prover.rap_constraints.round0_time_ms` |  147.50 |  295 |  194 |  101 |
...
| `prover.openings.whir_time_ms` |  41.50 |  83 |  47 |  36 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/2316f2561cb3d2295c15df6b172a7554397216da/keccak-2316f2561cb3d2295c15df6b172a7554397216da.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof |  |  | 2,524 | 37 | 1,235,218 | 33.27 | 0 | 15,690 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 36 | 513 | 36 | 13 | 4 | 7 | 4 | 
| internal_recursive.0 | 1 | 12 | 183 | 12 | 2 | 1 | 4 | 1 | 
| internal_recursive.1 | 1 | 9 | 153 | 8 | 1 | 0 | 2 | 0 | 
| leaf | 0 | 168 | 1,410 | 168 | 64 | 34 | 30 | 26 | 
| leaf | 1 | 84 | 767 | 84 | 32 | 17 | 15 | 10 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 109,497,984 | 476 | 244 | 0 | 14 | 172 | 45 | 45 | 92 | 34 | 0 | 58 | 19 | 38 | 7 | 30 | 245 | 172 | 0 | 2 | 32 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 25,962,119 | 170 | 51 | 0 | 3 | 76 | 24 | 23 | 29 | 22 | 0 | 42 | 18 | 24 | 1 | 22 | 52 | 76 | 0 | 2 | 21 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 17,507,975 | 143 | 33 | 0 | 3 | 64 | 22 | 22 | 24 | 17 | 0 | 44 | 22 | 22 | 1 | 21 | 34 | 64 | 0 | 2 | 16 | 0 | 0 | 
| leaf | 0 | prover | 583,523,386 | 1,241 | 713 | 0 | 47 | 395 | 194 | 194 | 117 | 82 | 0 | 132 | 47 | 85 | 40 | 44 | 713 | 395 | 0 | 6 | 81 | 0 | 0 | 
| leaf | 1 | prover | 300,618,208 | 682 | 372 | 0 | 24 | 221 | 101 | 101 | 67 | 51 | 0 | 88 | 36 | 52 | 20 | 32 | 372 | 221 | 0 | 6 | 50 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,205,061,845 | 2,256 | 852 | 0 | 250 | 1,221 | 515 | 515 | 315 | 389 | 134 | 182 | 41 | 141 | 86 | 55 | 852 | 1,221 | 0 | 3 | 254 | 0 | 0 | 
| app_proof | prover | 1 | 1,205,053,652 | 1,916 | 654 | 0 | 51 | 1,078 | 515 | 515 | 309 | 253 | 0 | 183 | 46 | 137 | 83 | 53 | 654 | 1,078 | 0 | 3 | 252 | 0 | 0 | 
| app_proof | prover | 2 | 1,205,053,652 | 1,915 | 655 | 0 | 51 | 1,081 | 516 | 516 | 310 | 254 | 0 | 178 | 40 | 137 | 83 | 54 | 655 | 1,081 | 0 | 3 | 253 | 0 | 0 | 
| app_proof | prover | 3 | 1,205,053,652 | 1,918 | 655 | 0 | 51 | 1,074 | 516 | 516 | 304 | 253 | 0 | 188 | 45 | 143 | 87 | 55 | 655 | 1,074 | 0 | 3 | 252 | 0 | 0 | 
| app_proof | prover | 4 | 1,205,053,652 | 1,921 | 655 | 0 | 51 | 1,086 | 519 | 518 | 312 | 254 | 0 | 179 | 40 | 138 | 84 | 53 | 655 | 1,086 | 0 | 3 | 253 | 0 | 0 | 
| app_proof | prover | 5 | 1,205,062,652 | 1,926 | 655 | 0 | 52 | 1,091 | 524 | 524 | 312 | 254 | 0 | 179 | 39 | 140 | 83 | 56 | 655 | 1,091 | 0 | 3 | 253 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 541 | 2,984 | 541 | 170 | 0 | 190 | 15 | 207,000 | 18.88 | 
| app_proof | 1 | 351 | 2,588 | 351 | 40 | 0 | 1 | 280 | 207,000 | 19.16 | 
| app_proof | 2 | 352 | 2,513 | 352 | 40 | 0 | 2 | 204 | 207,000 | 19.12 | 
| app_proof | 3 | 352 | 2,516 | 352 | 40 | 0 | 3 | 204 | 207,000 | 19.09 | 
| app_proof | 4 | 351 | 2,519 | 351 | 40 | 0 | 2 | 205 | 207,000 | 19.11 | 
| app_proof | 5 | 379 | 2,524 | 379 | 40 | 0 | 31 | 177 | 200,218 | 19.08 | 

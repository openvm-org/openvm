...
|:---|---:|---:|---:|
| Total |  5.48 |  5.48 |  5.48 |
| app_proof |  3.95 |  3.95 |  3.95 |
| leaf |  0.86 |  0.86 |  0.86 |
...
| `total_proof_time_ms ` |  3,923 |  3,923 |  3,923 |  3,923 |
| `compile_metered_time_ms` |  3 |  3 |  3 |  3 |
| `execute_metered_time_ms` |  25 | -          | -          | -          |
| `execute_metered_insns` |  1,979,971 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  76.67 | -          |  76.67 |  76.67 |
| `execute_preflight_insns` |  1,979,971 |  1,979,971 |  1,979,971 |  1,979,971 |
| `execute_preflight_time_ms` |  90 |  90 |  90 |  90 |
| `execute_preflight_insn_mi/s` |  28.54 | -          |  28.54 |  28.54 |
| `trace_gen_time_ms   ` |  100 |  100 |  100 |  100 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  3,595 |  3,595 |  3,595 |  3,595 |
| `prover.main_trace_commit_time_ms` |  1,139 |  1,139 |  1,139 |  1,139 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/431bff9fe725a5aec2d6d4e2fa1b7f379f4b8bab/kitchen_sink-431bff9fe725a5aec2d6d4e2fa1b7f379f4b8bab.memory.svg)

| Module | Max (GB) | Max At |
| --- | ---: | --- |
| prover.stacked_commit | 12.86 | app_proof.prover.0 |
| prover.rap_constraints | 9.67 | app_proof.prover.0 |
| prover.prove_whir_opening | 8.87 | app_proof.prover.0 |
| prover.openings | 8.87 | app_proof.prover.0 |
| prover.merkle_tree | 8.87 | app_proof.prover.0 |
| prover.rs_code_matrix | 8.86 | app_proof.prover.0 |
| frac_sumcheck.gkr_rounds | 7.85 | app_proof.prover.0 |
| prover.batch_constraints.before_round0 | 7.85 | app_proof.prover.0 |
| frac_sumcheck.segment_tree | 7.76 | app_proof.prover.0 |
| prover.gkr_input_evals | 7.76 | app_proof.prover.0 |
| prover.batch_constraints.round0 | 7.62 | app_proof.prover.0 |
| prover.batch_constraints.fold_ple_evals | 7.62 | app_proof.prover.0 |
...
| 74 | VmAirWrapper<Rv64BaseAluAdapterAir, BitwiseLogicCoreAir<8, 8> |  | 24 | 16 | 3 | 
| 75 | VmAirWrapper<Rv64BaseAluU16AdapterAir, AddSubCoreAir<4, 16> |  | 20 | 21 | 3 | 
...
| app_proof |  |  |  |  |  | 3,923 |  |  | 25 | 1,979,971 | 76.67 | 0 | 3,953 |  | 
...
| app_proof | 74 | VmAirWrapper<Rv64BaseAluAdapterAir, BitwiseLogicCoreAir<8, 8> | AND | 0 | 126,677 | 
| app_proof | 74 | VmAirWrapper<Rv64BaseAluAdapterAir, BitwiseLogicCoreAir<8, 8> | OR | 0 | 16,863 | 
| app_proof | 74 | VmAirWrapper<Rv64BaseAluAdapterAir, BitwiseLogicCoreAir<8, 8> | XOR | 0 | 400 | 
| app_proof | 75 | VmAirWrapper<Rv64BaseAluU16AdapterAir, AddSubCoreAir<4, 16> | ADD | 0 | 494,337 | 
| app_proof | 75 | VmAirWrapper<Rv64BaseAluU16AdapterAir, AddSubCoreAir<4, 16> | SUB | 0 | 81,683 | 
...
| app_proof | 74 | VmAirWrapper<Rv64BaseAluAdapterAir, BitwiseLogicCoreAir<8, 8> | prover | 0 | 262,144 | 46 | 12,058,624 | 
| app_proof | 75 | VmAirWrapper<Rv64BaseAluU16AdapterAir, AddSubCoreAir<4, 16> | prover | 0 | 1,048,576 | 34 | 35,651,584 | 
...
| app_proof | 74 | VmAirWrapper<Rv64BaseAluAdapterAir, BitwiseLogicCoreAir<8, 8> | 0 | 143,940 | 118,204 | 16,553,100 | 13,593,460 | 26,484,960 | 21,749,536 | 6,621,240 | 5,437,384 | 125,227,800 | 102,837,480 | 3,454,560 | 2,836,896 | 
| app_proof | 75 | VmAirWrapper<Rv64BaseAluU16AdapterAir, AddSubCoreAir<4, 16> | 0 | 576,020 | 472,556 | 48,961,700 | 40,167,260 | 78,338,720 | 64,267,616 | 19,584,680 | 16,066,904 | 417,614,500 | 342,603,100 | 11,520,400 | 9,451,120 | 
...
| leaf | 0 | 104 | 863 | 104 | 18 | 9 | 18 | 18 | 18 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,577,979 | 323 | 116 | 0 | 0 | 106 | 34 | 33 | 51 | 20 | 0 | 98 | 85 | 13 | 3 | 9 | 117 | 106 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,767 | 169 | 46 | 0 | 0 | 66 | 24 | 23 | 28 | 14 | 0 | 55 | 47 | 8 | 1 | 6 | 47 | 66 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 138 | 32 | 0 | 0 | 61 | 23 | 22 | 25 | 13 | 0 | 42 | 35 | 7 | 1 | 5 | 33 | 61 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 167,484,091 | 758 | 253 | 0 | 0 | 295 | 105 | 104 | 58 | 130 | 0 | 209 | 182 | 26 | 13 | 12 | 254 | 295 | 0 | 8 | 129 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,089,957,244 | 3,595 | 1,138 | 0 | 0 | 1,676 | 1,017 | 1,016 | 375 | 283 | 1 | 779 | 593 | 185 | 106 | 78 | 1,139 | 1,676 | 0 | 5 | 281 | 0 | 0 | 

| group | phase | segment | trace_height_constraint | weighted_sum | threshold |
| --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 0 | 95,326,462 | 2,013,265,921 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 100 | 3,923 | 100 | 136 | 10,283,766,528 | 2,839,957,200 | 13,123,723,728 | 2,097,152 | 0 | 4 | 90 | 1,979,971 | 28.54 | 

...
| `total_proof_time_ms ` |  4,061 |  8,122 |  5,137 |  2,985 |
...
| `execute_preflight_time_ms` |  248 |  496 |  274 |  222 |
| `execute_preflight_insn_mi/s` |  36.89 | -          |  38.85 |  34.93 |
| `trace_gen_time_ms   ` |  125 |  250 |  175 |  75 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  3,598 |  7,196 |  4,602 |  2,594 |
| `prover.main_trace_commit_time_ms` |  957.50 |  1,915 |  1,328 |  587 |
| `prover.rap_constraints_time_ms` |  1,939 |  3,878 |  2,387 |  1,491 |
| `prover.openings_time_ms` |  700.50 |  1,401 |  887 |  514 |
| `prover.rap_constraints.logup_gkr_time_ms` |  551.50 |  1,103 |  593 |  510 |
| `prover.rap_constraints.round0_time_ms` |  1,008 |  2,016 |  1,306 |  710 |
| `prover.rap_constraints.mle_rounds_time_ms` |  378.50 |  757 |  487 |  270 |
...
| `prover.openings.whir_time_ms` |  536 |  1,072 |  675 |  397 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/3fe80367551b44993864e3539429940fa581ee3b/sha2_bench-3fe80367551b44993864e3539429940fa581ee3b.memory.svg)
...
| app_proof |  |  |  |  |  | 2,985 |  |  | 98 | 11,167,961 | 113.44 | 0 | 8,225 |  | 
...
| leaf | 0 | 108 | 994 | 107 | 34 | 17 | 2 | 7 | 7 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 321 | 116 | 0 | 0 | 106 | 34 | 34 | 51 | 20 | 0 | 99 | 85 | 13 | 3 | 9 | 116 | 106 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 168 | 46 | 0 | 0 | 67 | 24 | 24 | 28 | 14 | 0 | 54 | 46 | 8 | 1 | 6 | 46 | 67 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 135 | 32 | 0 | 0 | 61 | 22 | 21 | 25 | 13 | 0 | 40 | 33 | 7 | 1 | 5 | 33 | 61 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 237,896,248 | 885 | 372 | 0 | 0 | 225 | 108 | 107 | 66 | 51 | 0 | 287 | 250 | 37 | 19 | 17 | 372 | 225 | 0 | 9 | 49 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,288,077,561 | 4,602 | 1,328 | 0 | 0 | 2,387 | 1,306 | 1,306 | 487 | 593 | 1 | 887 | 675 | 211 | 132 | 79 | 1,328 | 2,387 | 0 | 4 | 591 | 0 | 0 | 
| app_proof | prover | 1 | 751,206,644 | 2,594 | 587 | 0 | 0 | 1,491 | 710 | 709 | 270 | 510 | 0 | 514 | 397 | 117 | 71 | 46 | 587 | 1,491 | 0 | 5 | 509 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 1 | 175 | 5,137 | 175 | 136 | 13,329,494,472 | 2,141,911,524 | 15,471,405,996 | 2,097,152 | 0 | 3 | 222 | 7,124,000 | 34.93 | 
| app_proof | 1 | 1 | 75 | 2,985 | 75 | 41 | 7,598,498,184 | 1,557,865,504 | 9,156,363,688 | 2,097,152 | 0 | 2 | 274 | 4,043,961 | 38.85 | 

...
| `execute_metered_insn_mi/s` |  74.18 | -          |  74.18 |  74.18 |
| `execute_preflight_insns` |  1,979,971 |  1,979,971 |  1,979,971 |  1,979,971 |
| `execute_preflight_time_ms` |  85 |  85 |  85 |  85 |
| `execute_preflight_insn_mi/s` |  30.18 | -          |  30.18 |  30.18 |
| `trace_gen_time_ms   ` |  108 |  108 |  108 |  108 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  3,683 |  3,683 |  3,683 |  3,683 |
| `prover.main_trace_commit_time_ms` |  1,161 |  1,161 |  1,161 |  1,161 |
| `prover.rap_constraints_time_ms` |  1,727 |  1,727 |  1,727 |  1,727 |
| `prover.openings_time_ms` |  794 |  794 |  794 |  794 |
| `prover.rap_constraints.logup_gkr_time_ms` |  300 |  300 |  300 |  300 |
| `prover.rap_constraints.round0_time_ms` |  1,046 |  1,046 |  1,046 |  1,046 |
| `prover.rap_constraints.mle_rounds_time_ms` |  380 |  380 |  380 |  380 |
| `prover.openings.stacked_reduction_time_ms` |  189 |  189 |  189 |  189 |
...
| `prover.openings.whir_time_ms` |  605 |  605 |  605 |  605 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/068dbdc9f530e2893d789f0fb26bae3f4bec70f6/kitchen_sink-068dbdc9f530e2893d789f0fb26bae3f4bec70f6.memory.svg)

| Module | Max (GB) | Max At |
| --- | ---: | --- |
| prover.stacked_commit | 13.00 | app_proof.prover.0 |
| prover.rap_constraints | 9.74 | app_proof.prover.0 |
| prover.openings | 8.96 | app_proof.prover.0 |
| prover.merkle_tree | 8.96 | app_proof.prover.0 |
| prover.prove_whir_opening | 8.96 | app_proof.prover.0 |
| prover.rs_code_matrix | 8.96 | app_proof.prover.0 |
| frac_sumcheck.gkr_rounds | 8.27 | app_proof.prover.0 |
| prover.batch_constraints.before_round0 | 8.27 | app_proof.prover.0 |
| prover.gkr_input_evals | 8.18 | app_proof.prover.0 |
| frac_sumcheck.segment_tree | 8.18 | app_proof.prover.0 |
| prover.batch_constraints.fold_ple_evals | 7.67 | app_proof.prover.0 |
| prover.batch_constraints.round0 | 7.67 | app_proof.prover.0 |
| prover.before_gkr_input_evals | 4.79 | app_proof.prover.0 |
| generate mem proving ctxs | 3.16 | app_proof.0 |
| set initial memory | 3.16 | app_proof.0 |
...
| 55 | Sha2MainAir<Sha512Config> | 1 | 149 | 39 | 3 | 
| 56 | Sha2BlockHasherVmAir<Sha512Config> | 1 | 53 | 1,481 | 3 | 
| 57 | Sha2MainAir<Sha256Config> | 1 | 85 | 23 | 3 | 
...
| 68 | VmAirWrapper<Rv64LoadStoreAdapterAir, LoadSignExtendCoreAir<8, 8> |  | 22 | 22 | 3 | 
| 69 | VmAirWrapper<Rv64LoadStoreAdapterAir, LoadStoreCoreAir<8> |  | 25 | 31 | 3 | 
...
| 74 | VmAirWrapper<Rv64BaseAluAdapterAir, XorOrAndCoreAir<8, 8> |  | 24 | 16 | 3 | 
| 75 | VmAirWrapper<Rv64BaseAluAdapterAir, AddSubCoreAir<8, 8> |  | 32 | 31 | 3 | 
| 76 | BitwiseOperationLookupAir<8> | 1 | 2 | 19 | 2 | 
| 77 | PhantomAir |  | 3 | 1 | 2 | 
| 78 | Poseidon2PeripheryAir<BabyBearParameters>, 1> |  | 1 | 282 | 3 | 
| 79 | VariableRangeCheckerAir | 1 | 1 | 10 | 3 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 70 | 9 |  |  | 0 |  | 360 | 9 |  |  |  |  |  |  | 
| app_proof |  |  |  |  |  | 4,015 |  |  | 26 | 1,979,971 | 74.18 | 0 | 4,046 |  | 
...
| app_proof | VmAirWrapper<Rv64BaseAluAdapterAir, AddSubCoreAir<8, 8> | 0 | 9 | 
| app_proof | VmAirWrapper<Rv64BaseAluAdapterAir, ShiftCoreAir<8, 8> | 0 | 1 | 
| app_proof | VmAirWrapper<Rv64BaseAluAdapterAir, XorOrAndCoreAir<8, 8> | 0 | 2 | 
...
| app_proof | VmAirWrapper<Rv64JalrAdapterAir, Rv64JalrCoreAir> | 0 | 1 | 
| app_proof | VmAirWrapper<Rv64LoadStoreAdapterAir, LoadSignExtendCoreAir<8, 8> | 0 | 0 | 
| app_proof | VmAirWrapper<Rv64LoadStoreAdapterAir, LoadStoreCoreAir<8> | 0 | 12 | 
...
| app_proof | 74 | VmAirWrapper<Rv64BaseAluAdapterAir, XorOrAndCoreAir<8, 8> | AND | 0 | 126,677 | 
| app_proof | 74 | VmAirWrapper<Rv64BaseAluAdapterAir, XorOrAndCoreAir<8, 8> | OR | 0 | 16,863 | 
| app_proof | 74 | VmAirWrapper<Rv64BaseAluAdapterAir, XorOrAndCoreAir<8, 8> | XOR | 0 | 400 | 
| app_proof | 75 | VmAirWrapper<Rv64BaseAluAdapterAir, AddSubCoreAir<8, 8> | ADD | 0 | 494,337 | 
| app_proof | 75 | VmAirWrapper<Rv64BaseAluAdapterAir, AddSubCoreAir<8, 8> | SUB | 0 | 81,683 | 
...
| app_proof | 57 | Sha2MainAir<Sha256Config> | prover | 0 | 32,768 | 150 | 4,915,200 | 
| app_proof | 58 | Sha2BlockHasherVmAir<Sha256Config> | prover | 0 | 524,288 | 456 | 239,075,328 | 
| app_proof | 59 | KeccakfOpAir | prover | 0 | 16,384 | 284 | 4,653,056 | 
...
| app_proof | 61 | XorinVmAir | prover | 0 | 16,384 | 669 | 10,960,896 | 
...
| app_proof | 69 | VmAirWrapper<Rv64LoadStoreAdapterAir, LoadStoreCoreAir<8>
...
|:---|---:|---:|---:|
| Total |  2.57 |  1.93 |  1.93 |
| app_proof |  1.52 |  0.89 |  0.89 |
| leaf |  0.43 |  0.43 |  0.43 |
...
| `total_proof_time_ms ` |  745 |  1,490 |  851 |  639 |
| `compile_metered_time_ms` |  7 |  7 |  7 |  7 |
| `execute_metered_time_ms` |  35 | -          | -          | -          |
| `execute_metered_insns` |  4,090,656 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  115.49 | -          |  115.49 |  115.49 |
| `execute_preflight_insns` |  2,045,328 |  4,090,656 |  2,327,000 |  1,763,656 |
| `execute_preflight_time_ms` |  82.50 |  165 |  91 |  74 |
| `execute_preflight_insn_mi/s` |  33.12 | -          |  34.25 |  31.100 |
| `trace_gen_time_ms   ` |  42 |  84 |  47 |  37 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  531.50 |  1,063 |  587 |  476 |
| `prover.main_trace_commit_time_ms` |  108 |  216 |  117 |  99 |
| `prover.rap_constraints_time_ms` |  312.50 |  625 |  347 |  278 |
| `prover.openings_time_ms` |  110 |  220 |  122 |  98 |
| `prover.rap_constraints.logup_gkr_time_ms` |  189 |  378 |  228 |  150 |
| `prover.rap_constraints.round0_time_ms` |  88.50 |  177 |  97 |  80 |
...
| `prover.openings.whir_time_ms` |  88.50 |  177 |  99 |  78 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/f60795ac29d172302f718ac73e75424928822365/regex-f60795ac29d172302f718ac73e75424928822365.memory.svg)
...
| app_proof |  |  |  |  |  | 639 |  |  | 35 | 4,090,656 | 115.49 | 0 | 1,539 |  | 
| internal_for_leaf |  |  |  | 286 |  |  |  |  |  |  |  |  |  | 286 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 27,289,403 | 270 | 82 | 0 | 0 | 97 | 32 | 31 | 45 | 20 | 0 | 88 | 77 | 11 | 2 | 8 | 83 | 97 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,767 | 171 | 46 | 0 | 0 | 67 | 24 | 24 | 28 | 13 | 0 | 56 | 48 | 8 | 1 | 6 | 47 | 67 | 0 | 3 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 136 | 33 | 0 | 0 | 61 | 23 | 22 | 24 | 13 | 0 | 41 | 34 | 7 | 1 | 5 | 33 | 61 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 79,656,756 | 383 | 129 | 0 | 0 | 135 | 55 | 54 | 37 | 42 | 0 | 118 | 102 | 15 | 6 | 8 | 129 | 135 | 0 | 7 | 41 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 150,178,258 | 587 | 116 | 0 | 0 | 347 | 80 | 80 | 38 | 228 | 0 | 122 | 99 | 23 | 12 | 10 | 117 | 347 | 0 | 3 | 227 | 0 | 0 | 
| app_proof | prover | 1 | 118,931,775 | 476 | 99 | 0 | 0 | 278 | 97 | 96 | 30 | 150 | 0 | 98 | 78 | 20 | 9 | 10 | 99 | 278 | 0 | 3 | 149 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 37 | 851 | 37 | 134 | 2,617,621,893 | 731,688,651 | 3,349,310,544 | 2,097,152 | 1 | 4 | 91 | 2,327,000 | 31.100 | 
| app_proof | 1 | 47 | 639 | 47 | 41 | 1,871,910,265 | 705,871,930 | 2,577,782,195 | 2,097,152 | 0 | 2 | 74 | 1,763,656 | 34.25 | 

...
|:---|---:|---:|---:|
| Total |  9.86 |  6.88 |  6.88 |
| app_proof |  8.21 |  5.22 |  5.22 |
| leaf |  0.99 |  0.99 |  0.99 |
...
| `total_proof_time_ms ` |  4,054 |  8,108 |  5,123 |  2,985 |
...
| `execute_preflight_time_ms` |  250.50 |  501 |  279 |  222 |
| `execute_preflight_insn_mi/s` |  36.86 | -          |  38.93 |  34.78 |
| `trace_gen_time_ms   ` |  125 |  250 |  175 |  75 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  3,589.50 |  7,179 |  4,590 |  2,589 |
| `prover.main_trace_commit_time_ms` |  956 |  1,912 |  1,323 |  589 |
| `prover.rap_constraints_time_ms` |  1,935 |  3,870 |  2,382 |  1,488 |
| `prover.openings_time_ms` |  698 |  1,396 |  884 |  512 |
| `prover.rap_constraints.logup_gkr_time_ms` |  549 |  1,098 |  592 |  506 |
| `prover.rap_constraints.round0_time_ms` |  1,008 |  2,016 |  1,305 |  711 |
| `prover.rap_constraints.mle_rounds_time_ms` |  376.50 |  753 |  484 |  269 |
| `prover.openings.stacked_reduction_time_ms` |  161.50 |  323 |  211 |  112 |
| `prover.openings.stacked_reduction.round0_time_ms` |  100 |  200 |  132 |  68 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  61 |  122 |  79 |  43 |
| `prover.openings.whir_time_ms` |  536 |  1,072 |  672 |  400 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/1ad89094adaae344a240c2d91bcbd072fdddb7aa/sha2_bench-1ad89094adaae344a240c2d91bcbd072fdddb7aa.memory.svg)
...
| app_proof |  |  |  |  |  | 2,985 |  |  | 98 | 11,167,961 | 112.93 | 0 | 8,213 |  | 
...
| app_proof | VmAirWrapper<Rv64BaseAluAdapterAir, BitwiseLogicCoreAir<8, 8> | 0 | 5 | 
...
| app_proof | VmAirWrapper<Rv64BranchAdapterAir, BranchEqualCoreAir<4> | 0 | 4 | 
...
| app_proof | VmAirWrapper<Rv64LoadStoreAdapterAir, LoadSignExtendCoreAir<8, 8> | 0 | 1 | 
| app_proof | VmAirWrapper<Rv64LoadStoreAdapterAir, LoadStoreCoreAir<8> | 0 | 31 | 
| app_proof | VmAirWrapper<Rv64MultAdapterAir, MultiplicationCoreAir<8, 8> | 0 | 1 | 
| app_proof | VmAirWrapper<Rv64RdWriteAdapterAir, Rv64AuipcCoreAir> | 0 | 84 | 
...
| app_proof | VmAirWrapper<Rv64JalrAdapterAir, Rv64JalrCoreAir> | 1 | 45 | 
| app_proof | VmAirWrapper<Rv64LoadStoreAdapterAir, LoadSignExtendCoreAir<8, 8> | 1 | 0 | 
| app_proof | VmAirWrapper<Rv64LoadStoreAdapterAir, LoadStoreCoreAir<8> | 1 | 7 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 319 | 116 | 0 | 0 | 107 | 35 | 34 | 51 | 20 | 0 | 95 | 82 | 13 | 3 | 9 | 116 | 107 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 169 | 46 | 0 | 0 | 66 | 24 | 23 | 28 | 13 | 0 | 56 | 47 | 8 | 1 | 6 | 46 | 66 | 0 | 3 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 133 | 31 | 0 | 0 | 60 | 22 | 21 | 24 | 13 | 0 | 40 | 33 | 7 | 1 | 5 | 32 | 60 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 237,896,248 | 884 | 370 | 0 | 0 | 226 | 109 | 108 | 66 | 50 | 0 | 287 | 250 | 37 | 19 | 17 | 370 | 226 | 0 | 9 | 49 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,288,077,561 | 4,590 | 1,323 | 0 | 0 | 2,382 | 1,305 | 1,305 | 484 | 592 | 0 | 884 | 672 | 211 | 132 | 79 | 1,323 | 2,382 | 0 | 4 | 590 | 0 | 0 | 
| app_proof | prover | 1 | 751,206,644 | 2,589 | 589 | 0 | 0 | 1,488 | 711 | 711 | 269 | 506 | 0 | 512 | 400 | 112 | 68 | 43 | 589 | 1,488 | 0 | 5 | 505 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 1 | 175 | 5,123 | 175 | 135 | 13,329,494,472 | 2,141,911,524 | 15,471,405,996 | 2,097,152 | 0 | 3 | 222 | 7,124,000 | 34.78 | 
| app_proof | 1 | 1 | 75 | 2,985 | 75 | 41 | 7,598,498,184 | 1,557,865,504 | 9,156,363,688 | 2,097,152 | 0 | 2 | 279 | 4,043,961 | 38.93 | 

...
| `total_proof_time_ms ` |  4,099 |  8,198 |  5,186 |  3,012 |
| `compile_metered_time_ms` |  3 |  3 |  3 |  3 |
| `execute_metered_time_ms` |  98 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  113.33 | -          |  113.33 |  113.33 |
| `execute_preflight_insns` |  5,583,980.50 |  11,167,961 |  7,124,000 |  4,043,961 |
| `execute_preflight_time_ms` |  247.50 |  495 |  275 |  220 |
| `execute_preflight_insn_mi/s` |  36.82 | -          |  38.57 |  35.07 |
| `trace_gen_time_ms   ` |  125 |  250 |  175 |  75 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  3,636 |  7,272 |  4,653 |  2,619 |
| `prover.main_trace_commit_time_ms` |  958 |  1,916 |  1,326 |  590 |
| `prover.rap_constraints_time_ms` |  1,973 |  3,946 |  2,434 |  1,512 |
| `prover.openings_time_ms` |  704.50 |  1,409 |  892 |  517 |
| `prover.rap_constraints.logup_gkr_time_ms` |  553.50 |  1,107 |  593 |  514 |
| `prover.rap_constraints.round0_time_ms` |  1,041 |  2,082 |  1,355 |  727 |
| `prover.rap_constraints.mle_rounds_time_ms` |  377.50 |  755 |  485 |  270 |
...
| `prover.openings.whir_time_ms` |  538.50 |  1,077 |  678 |  399 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/c0561903201f6b10dd31a454154e2e74cf941400/sha2_bench-c0561903201f6b10dd31a454154e2e74cf941400.memory.svg)
...
| app_proof |  |  |  |  |  | 3,012 |  |  | 98 | 11,167,961 | 113.33 | 0 | 8,302 |  | 
...
| leaf | 0 | 110 | 999 | 109 | 34 | 17 | 2 | 7 | 7 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 326 | 117 | 0 | 0 | 107 | 35 | 35 | 51 | 20 | 0 | 101 | 87 | 13 | 3 | 9 | 117 | 107 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 171 | 47 | 0 | 0 | 67 | 25 | 24 | 28 | 13 | 0 | 56 | 47 | 8 | 1 | 6 | 47 | 67 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 138 | 32 | 0 | 0 | 61 | 22 | 22 | 24 | 13 | 0 | 43 | 36 | 7 | 1 | 5 | 33 | 61 | 0 | 2 | 13 | 0 | 0 | 
| leaf | 0 | prover | 237,896,248 | 889 | 372 | 0 | 0 | 227 | 110 | 109 | 66 | 50 | 0 | 289 | 251 | 37 | 19 | 17 | 372 | 227 | 0 | 9 | 49 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,288,077,561 | 4,653 | 1,326 | 0 | 0 | 2,434 | 1,355 | 1,354 | 485 | 593 | 1 | 892 | 678 | 214 | 133 | 80 | 1,326 | 2,434 | 0 | 5 | 591 | 0 | 0 | 
| app_proof | prover | 1 | 751,206,644 | 2,619 | 590 | 0 | 0 | 1,512 | 727 | 727 | 270 | 514 | 0 | 517 | 399 | 117 | 70 | 46 | 590 | 1,512 | 0 | 6 | 513 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 1 | 175 | 5,186 | 175 | 136 | 13,329,494,472 | 2,141,911,524 | 15,471,405,996 | 2,097,152 | 0 | 3 | 220 | 7,124,000 | 35.07 | 
| app_proof | 1 | 1 | 75 | 3,012 | 75 | 41 | 7,598,498,184 | 1,557,865,504 | 9,156,363,688 | 2,097,152 | 0 | 2 | 275 | 4,043,961 | 38.57 | 

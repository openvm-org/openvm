...
|:---|---:|---:|---:|
| Total |  10.81 |  4.75 |  4.75 |
| app_proof |  8.99 |  2.93 |  2.93 |
| leaf |  1.15 |  1.15 |  1.15 |
...
| `total_proof_time_ms ` |  2,224 |  8,896 |  2,828 |  573 |
| `compile_metered_time_ms` |  4 |  4 |  4 |  4 |
| `execute_metered_time_ms` |  98 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  112.94 | -          |  112.94 |  112.94 |
| `execute_preflight_insns` |  2,791,990.25 |  11,167,961 |  3,562,000 |  481,961 |
| `execute_preflight_time_ms` |  175 |  700 |  285 |  34 |
| `execute_preflight_insn_mi/s` |  34.06 | -          |  35.12 |  32.32 |
| `trace_gen_time_ms   ` |  72.25 |  289 |  83 |  66 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,910.25 |  7,641 |  2,489 |  413 |
| `prover.main_trace_commit_time_ms` |  498.75 |  1,995 |  641 |  85 |
| `prover.rap_constraints_time_ms` |  1,013.75 |  4,055 |  1,278 |  236 |
| `prover.openings_time_ms` |  396.50 |  1,586 |  575 |  90 |
| `prover.rap_constraints.logup_gkr_time_ms` |  258.75 |  1,035 |  320 |  79 |
| `prover.rap_constraints.round0_time_ms` |  554.50 |  2,218 |  704 |  113 |
| `prover.rap_constraints.mle_rounds_time_ms` |  199.75 |  799 |  254 |  43 |
| `prover.openings.stacked_reduction_time_ms` |  81 |  324 |  105 |  17 |
| `prover.openings.stacked_reduction.round0_time_ms` |  48.75 |  195 |  64 |  9 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  32 |  128 |  40 |  8 |
| `prover.openings.whir_time_ms` |  315 |  1,260 |  475 |  73 |
...
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,019 |  1,019 |  1,019 |  1,019 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/068dbdc9f530e2893d789f0fb26bae3f4bec70f6/sha2_bench-068dbdc9f530e2893d789f0fb26bae3f4bec70f6.memory.svg)

| Module | Max (GB) | Max At |
| --- | ---: | --- |
| prover.stacked_commit | 7.64 | app_proof.prover.0 |
| frac_sumcheck.gkr_rounds | 6.82 | app_proof.prover.0 |
| prover.batch_constraints.before_round0 | 6.82 | app_proof.prover.0 |
| prover.gkr_input_evals | 6.73 | app_proof.prover.0 |
| frac_sumcheck.segment_tree | 6.73 | app_proof.prover.0 |
| prover.rap_constraints | 5.60 | app_proof.prover.0 |
| prover.batch_constraints.fold_ple_evals | 5.59 | app_proof.prover.0 |
| prover.batch_constraints.round0 | 5.59 | app_proof.prover.0 |
| prover.merkle_tree | 5.25 | app_proof.prover.0 |
| prover.openings | 5.25 | app_proof.prover.0 |
| prover.prove_whir_opening | 5.25 | app_proof.prover.0 |
| prover.rs_code_matrix | 5.24 | app_proof.prover.0 |
| generate mem proving ctxs | 2.74 | app_proof.3 |
| set initial memory | 2.74 | app_proof.1 |
| prover.before_gkr_input_evals | 2.72 | app_proof.prover.0 |
...
| 27 | VmAirWrapper<Rv64BaseAluAdapterAir, AddSubCoreAir<8, 8> |  | 32 | 31 | 3 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 69 | 9 |  |  | 0 |  | 336 | 9 |  |  |  |  |  |  | 
| app_proof |  |  |  |  |  | 573 |  |  | 98 | 11,167,961 | 112.94 | 0 | 9,001 |  | 
...
| app_proof | 27 | VmAirWrapper<Rv64BaseAluAdapterAir, AddSubCoreAir<8, 8> | ADD | 0 | 891,673 | 
| app_proof | 27 | VmAirWrapper<Rv64BaseAluAdapterAir, AddSubCoreAir<8, 8> | SUB | 0 | 156,751 | 
...
| app_proof | 27 | VmAirWrapper<Rv64BaseAluAdapterAir, AddSubCoreAir<8, 8> | ADD | 1 | 891,727 | 
| app_proof | 27 | VmAirWrapper<Rv64BaseAluAdapterAir, AddSubCoreAir<8, 8> | SUB | 1 | 156,788 | 
...
| app_proof | 27 | VmAirWrapper<Rv64BaseAluAdapterAir, AddSubCoreAir<8, 8> | ADD | 2 | 891,724 | 
| app_proof | 27 | VmAirWrapper<Rv64BaseAluAdapterAir, AddSubCoreAir<8, 8> | SUB | 2 | 156,787 | 
...
| app_proof | 27 | VmAirWrapper<Rv64BaseAluAdapterAir, AddSubCoreAir<8, 8> | ADD | 3 | 120,646 | 
| app_proof | 27 | VmAirWrapper<Rv64BaseAluAdapterAir, AddSubCoreAir<8, 8> | SUB | 3 | 21,204 | 
...
| app_proof | 27 | VmAirWrapper<Rv64BaseAluAdapterAir, AddSubCoreAir<8, 8> | prover | 0 | 1,048,576 | 45 | 47,185,920 | 
...
| app_proof | 27 | VmAirWrapper<Rv64BaseAluAdapterAir, AddSubCoreAir<8, 8> | prover | 1 | 1,048,576 | 45 | 47,185,920 | 
...
| app_proof | 27 | VmAirWrapper<Rv64BaseAluAdapterAir, AddSubCoreAir<8, 8> | prover | 2 | 1,048,576 | 45 | 47,185,920 | 
...
| app_proof | 27 | VmAirWrapper<Rv64BaseAluAdapterAir, AddSubCoreAir<8, 8> | prover | 3 | 262,144 | 45 | 11,796,480 | 
...
| --- | --- | --- | --- | --- | --- |
| app_proof | 27 | VmAirWrapper<Rv64BaseAluAdapterAir, AddSubCoreAir<8, 8> | height | 0 | 1 | 
| app_proof | 27 | VmAirWrapper<Rv64BaseAluAdapterAir, AddSubCoreAir<8, 8> | height | 1 | 1 | 
| app_proof | 27 | VmAirWrapper<Rv64BaseAluAdapterAir, AddSubCoreAir<8, 8>
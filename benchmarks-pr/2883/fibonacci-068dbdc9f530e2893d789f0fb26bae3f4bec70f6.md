...
|:---|---:|---:|---:|
| Total |  2.76 |  1.68 |  1.68 |
| app_proof |  1.63 |  0.55 |  0.55 |
| leaf |  0.53 |  0.53 |  0.53 |
...
| `total_proof_time_ms ` |  402.25 |  1,609 |  531 |  222 |
| `compile_metered_time_ms` |  3 |  3 |  3 |  3 |
| `execute_metered_time_ms` |  21 | -          | -          | -          |
| `execute_metered_insns` |  4,000,051 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  186.95 | -          |  186.95 |  186.95 |
| `execute_preflight_insns` |  1,000,012.75 |  4,000,051 |  1,310,000 |  70,051 |
| `execute_preflight_time_ms` |  36.75 |  147 |  50 |  4 |
| `execute_preflight_insn_mi/s` |  39.45 | -          |  39.70 |  39.05 |
| `trace_gen_time_ms   ` |  74.25 |  297 |  101 |  65 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  226 |  904 |  281 |  75 |
| `prover.main_trace_commit_time_ms` |  40.50 |  162 |  49 |  15 |
| `prover.rap_constraints_time_ms` |  129 |  516 |  163 |  32 |
| `prover.openings_time_ms` |  55 |  220 |  68 |  26 |
| `prover.rap_constraints.logup_gkr_time_ms` |  92 |  368 |  118 |  17 |
| `prover.rap_constraints.round0_time_ms` |  24.25 |  97 |  32 |  8 |
| `prover.rap_constraints.mle_rounds_time_ms` |  12.50 |  50 |  15 |  7 |
| `prover.openings.stacked_reduction_time_ms` |  8.50 |  34 |  11 |  3 |
| `prover.openings.stacked_reduction.round0_time_ms` |  3.75 |  15 |  5 |  0 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  4.25 |  17 |  5 |  2 |
| `prover.openings.whir_time_ms` |  46 |  184 |  56 |  23 |
...
| `prover.openings_time_ms` |  140 |  140 |  140 |  140 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/068dbdc9f530e2893d789f0fb26bae3f4bec70f6/fibonacci-068dbdc9f530e2893d789f0fb26bae3f4bec70f6.memory.svg)

| Module | Max (GB) | Max At |
| --- | ---: | --- |
| generate mem proving ctxs | 2.74 | app_proof.0 |
| set initial memory | 2.74 | app_proof.1 |
| prover.stacked_commit | 2.21 | leaf.0.prover |
| prover.merkle_tree | 1.95 | leaf.0.prover |
| prover.openings | 1.95 | leaf.0.prover |
| prover.prove_whir_opening | 1.95 | leaf.0.prover |
| prover.rs_code_matrix | 1.95 | leaf.0.prover |
| prover.batch_constraints.before_round0 | 1.74 | app_proof.prover.0 |
| frac_sumcheck.gkr_rounds | 1.74 | app_proof.prover.0 |
| frac_sumcheck.segment_tree | 1.63 | app_proof.prover.0 |
| prover.gkr_input_evals | 1.63 | app_proof.prover.0 |
...
| tracegen.pow_checker | 0.72 | leaf.0 |
| tracegen.exp_bits_len | 0.72 | leaf.0 |
| tracegen.whir_final_poly_query_eval | 0.72 | leaf.0 |
...
| 22 | VmAirWrapper<Rv64BaseAluAdapterAir, XorOrAndCoreAir<8, 8> |  | 24 | 16 | 3 | 
| 23 | VmAirWrapper<Rv64BaseAluAdapterAir, AddSubCoreAir<8, 8> |  | 32 | 31 | 3 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 69 | 9 |  |  | 0 |  | 337 | 9 |  |  |  |  |  |  | 
| app_proof |  |  |  |  |  | 222 |  |  | 21 | 4,000,051 | 186.95 | 0 | 1,636 |  | 
...
| app_proof | 22 | VmAirWrapper<Rv64BaseAluAdapterAir, XorOrAndCoreAir<8, 8> | AND | 0 | 2 | 
| app_proof | 23 | VmAirWrapper<Rv64BaseAluAdapterAir, AddSubCoreAir<8, 8> | ADD | 0 | 1,047,978 | 
| app_proof | 23 | VmAirWrapper<Rv64BaseAluAdapterAir, AddSubCoreAir<8, 8> | SUB | 0 | 1 | 
| app_proof | 25 | PhantomAir | PHANTOM | 0 | 1 | 
| app_proof | 15 | VmAirWrapper<Rv64BranchAdapterAir, BranchEqualCoreAir<4> | BNE | 1 | 262,000 | 
| app_proof | 23 | VmAirWrapper<Rv64BaseAluAdapterAir, AddSubCoreAir<8, 8> | ADD | 1 | 1,048,000 | 
| app_proof | 15 | VmAirWrapper<Rv64BranchAdapterAir, BranchEqualCoreAir<4> | BNE | 2 | 262,000 | 
| app_proof | 23 | VmAirWrapper<Rv64BaseAluAdapterAir, AddSubCoreAir<8, 8> | ADD | 2 | 1,048,000 | 
...
| app_proof | 23 | VmAirWrapper<Rv64BaseAluAdapterAir, AddSubCoreAir<8, 8> | ADD | 3 | 56,038 | 
...
| app_proof | 22 | VmAirWrapper<Rv64BaseAluAdapterAir, XorOrAndCoreAir<8, 8> | prover | 0 | 2 | 46 | 92 | 
| app_proof | 23 | VmAirWrapper<Rv64BaseAluAdapterAir, AddSubCoreAir<8, 8> | prover | 0 | 1,048,576 | 45 | 47,185,920 | 
...
| app_proof | 23 | VmAirWrapper<Rv64BaseAluAdapterAir, AddSubCoreAir<8, 8> | prover | 1 | 1,048,576 | 45 | 47,185,920 | 
...
| app_proof | 23 | VmAirWrapper<Rv64BaseAluAdapterAir, AddSubCoreAir<8, 8> | prover | 2 | 1,048,576 | 45 | 47,185,920 | 
...
| app_proof | 23 | VmAirWrapper<Rv64BaseAluAdapterAir, AddSubCoreAir<8, 8>
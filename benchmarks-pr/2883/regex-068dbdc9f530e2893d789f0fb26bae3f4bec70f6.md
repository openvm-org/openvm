...
|:---|---:|---:|---:|
| Total |  2.67 |  2.02 |  2.02 |
| app_proof |  1.64 |  0.99 |  0.99 |
| leaf |  0.43 |  0.43 |  0.43 |
...
| `total_proof_time_ms ` |  801.50 |  1,603 |  954 |  649 |
| `compile_metered_time_ms` |  7 |  7 |  7 |  7 |
| `execute_metered_time_ms` |  36 | -          | -          | -          |
| `execute_metered_insns` |  4,090,656 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  113.14 | -          |  113.14 |  113.14 |
| `execute_preflight_insns` |  2,045,328 |  4,090,656 |  2,327,000 |  1,763,656 |
| `execute_preflight_time_ms` |  86.50 |  173 |  95 |  78 |
| `execute_preflight_insn_mi/s` |  32.51 | -          |  33.67 |  31.34 |
| `trace_gen_time_ms   ` |  34.50 |  69 |  42 |  27 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  590.50 |  1,181 |  693 |  488 |
| `prover.main_trace_commit_time_ms` |  115 |  230 |  129 |  101 |
| `prover.rap_constraints_time_ms` |  362 |  724 |  441 |  283 |
| `prover.openings_time_ms` |  113 |  226 |  123 |  103 |
| `prover.rap_constraints.logup_gkr_time_ms` |  238 |  476 |  321 |  155 |
| `prover.rap_constraints.round0_time_ms` |  88 |  176 |  96 |  80 |
| `prover.rap_constraints.mle_rounds_time_ms` |  34.50 |  69 |  38 |  31 |
| `prover.openings.stacked_reduction_time_ms` |  22.50 |  45 |  25 |  20 |
| `prover.openings.stacked_reduction.round0_time_ms` |  11 |  22 |  13 |  9 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  10.50 |  21 |  11 |  10 |
| `prover.openings.whir_time_ms` |  90 |  180 |  98 |  82 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/068dbdc9f530e2893d789f0fb26bae3f4bec70f6/regex-068dbdc9f530e2893d789f0fb26bae3f4bec70f6.memory.svg)

| Module | Max (GB) | Max At |
| --- | ---: | --- |
| frac_sumcheck.gkr_rounds | 3.64 | app_proof.prover.0 |
| prover.batch_constraints.before_round0 | 3.64 | app_proof.prover.0 |
| frac_sumcheck.segment_tree | 3.51 | app_proof.prover.0 |
| prover.gkr_input_evals | 3.51 | app_proof.prover.0 |
...
| app_proof |  |  |  |  |  | 649 |  |  | 36 | 4,090,656 | 113.14 | 0 | 1,653 |  | 
...
| app_proof | VmAirWrapper<Rv64BaseAluAdapterAir, AddSubCoreAir<8, 8> | 0 | 2 | 
...
| app_proof | VmAirWrapper<Rv64BaseAluAdapterAir, AddSubCoreAir<8, 8> | 1 | 2 | 
...
| app_proof | 25 | VmAirWrapper<Rv64BaseAluAdapterAir, XorOrAndCoreAir<8, 8> | AND | 0 | 50,230 | 
| app_proof | 25 | VmAirWrapper<Rv64BaseAluAdapterAir, XorOrAndCoreAir<8, 8> | OR | 0 | 8,815 | 
| app_proof | 25 | VmAirWrapper<Rv64BaseAluAdapterAir, XorOrAndCoreAir<8, 8> | XOR | 0 | 5,393 | 
| app_proof | 26 | VmAirWrapper<Rv64BaseAluAdapterAir, AddSubCoreAir<8, 8> | ADD | 0 | 517,824 | 
| app_proof | 26 | VmAirWrapper<Rv64BaseAluAdapterAir, AddSubCoreAir<8, 8> | SUB | 0 | 31,612 | 
...
| app_proof | 25 | VmAirWrapper<Rv64BaseAluAdapterAir, XorOrAndCoreAir<8, 8> | AND | 1 | 36,308 | 
| app_proof | 25 | VmAirWrapper<Rv64BaseAluAdapterAir, XorOrAndCoreAir<8, 8> | OR | 1 | 4,137 | 
| app_proof | 25 | VmAirWrapper<Rv64BaseAluAdapterAir, XorOrAndCoreAir<8, 8> | XOR | 1 | 4,110 | 
| app_proof | 26 | VmAirWrapper<Rv64BaseAluAdapterAir, AddSubCoreAir<8, 8> | ADD | 1 | 395,973 | 
| app_proof | 26 | VmAirWrapper<Rv64BaseAluAdapterAir, AddSubCoreAir<8, 8> | SUB | 1 | 25,375 | 
...
| app_proof | 25 | VmAirWrapper<Rv64BaseAluAdapterAir, XorOrAndCoreAir<8, 8> | prover | 0 | 65,536 | 46 | 3,014,656 | 
...
| app_proof | 29 | Poseidon2PeripheryAir<BabyBearParameters>, 1> | prover | 0 | 16,384 | 300 | 4,915,200 | 
...
| app_proof | 25 | VmAirWrapper<Rv64BaseAluAdapterAir, XorOrAndCoreAir<8, 8> | prover | 1 | 65,536 | 46 | 3,014,656 | 
| app_proof | 26 | VmAirWrapper<Rv64BaseAluAdapterAir, AddSubCoreAir<8, 8> | prover | 1 | 524,288 | 45 | 23,592,960 | 
| app_proof | 27 | BitwiseOperationLookupAir<8> | prover | 1 | 65,536 | 18 | 1,179,648 | 
| app_proof | 29 | Poseidon2PeripheryAir<BabyBearParameters>, 1> | prover | 1 | 2,048 | 300 | 614,400 | 
...
| app_proof | 25 | VmAirWrapper<Rv64BaseAluAdapterAir, XorOrAndCoreAir<8, 8> | 0 | 64,438 | 1,098 | 7,410,370 | 126,270 | 11,856,592 | 202,032 | 2,964,148 | 50,508 | 56,061,060 | 955,260 | 1,546,512 | 26,352 | 
| app_proof | 26 | VmAirWrapper<Rv64BaseAluAdapterAir, AddSubCoreAir<8, 8>
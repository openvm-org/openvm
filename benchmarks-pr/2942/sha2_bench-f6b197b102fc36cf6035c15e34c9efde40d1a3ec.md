...
|:---|---:|---:|---:|
| Total |  9.83 |  6.82 |  6.82 |
| app_proof |  8.14 |  5.14 |  5.14 |
| leaf |  1 |  1 |  1 |
...
| `total_proof_time_ms ` |  4,029 |  8,058 |  5,050 |  3,008 |
...
| `execute_preflight_time_ms` |  246.50 |  493 |  288 |  205 |
| `execute_preflight_insn_mi/s` |  37.56 | -          |  39.86 |  35.27 |
| `trace_gen_time_ms   ` |  121 |  242 |  170 |  72 |
| `set_initial_memory_time_ms` |  0 |  0 |  0 |  0 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  3,659.50 |  7,319 |  4,673 |  2,646 |
| `prover.main_trace_commit_time_ms` |  962.50 |  1,925 |  1,333 |  592 |
| `prover.rap_constraints_time_ms` |  1,984.50 |  3,969 |  2,447 |  1,522 |
| `prover.openings_time_ms` |  711 |  1,422 |  892 |  530 |
| `prover.rap_constraints.logup_gkr_time_ms` |  557.50 |  1,115 |  598 |  517 |
| `prover.rap_constraints.round0_time_ms` |  1,041.50 |  2,083 |  1,352 |  731 |
| `prover.rap_constraints.mle_rounds_time_ms` |  384.50 |  769 |  496 |  273 |
| `prover.openings.stacked_reduction_time_ms` |  166 |  332 |  215 |  117 |
| `prover.openings.stacked_reduction.round0_time_ms` |  103 |  206 |  135 |  71 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  63 |  126 |  80 |  46 |
| `prover.openings.whir_time_ms` |  544 |  1,088 |  676 |  412 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/f6b197b102fc36cf6035c15e34c9efde40d1a3ec/sha2_bench-f6b197b102fc36cf6035c15e34c9efde40d1a3ec.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 70 |  |  |  | 345 |  |  |  |  |  |  | 
| app_proof |  |  |  | 3,008 |  | 87 | 11,167,961 | 127.58 | 0 | 8,152 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 329 | 119 | 0 | 0 | 108 | 35 | 34 | 52 | 20 | 0 | 102 | 88 | 13 | 3 | 9 | 119 | 119 | 108 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 170 | 47 | 0 | 0 | 67 | 24 | 23 | 28 | 13 | 0 | 55 | 47 | 8 | 1 | 6 | 47 | 47 | 67 | 0 | 2 | 12 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 137 | 32 | 0 | 0 | 62 | 23 | 22 | 24 | 14 | 0 | 41 | 34 | 7 | 1 | 5 | 33 | 32 | 62 | 0 | 2 | 13 | 0 | 0 | 
| leaf | 0 | prover | 237,929,016 | 895 | 375 | 0 | 0 | 230 | 110 | 109 | 68 | 52 | 0 | 288 | 251 | 37 | 20 | 17 | 375 | 375 | 230 | 0 | 10 | 49 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,286,242,554 | 4,673 | 1,333 | 0 | 0 | 2,447 | 1,352 | 1,352 | 496 | 598 | 1 | 892 | 676 | 215 | 135 | 80 | 1,333 | 1,333 | 2,447 | 0 | 5 | 596 | 0 | 0 | 
| app_proof | prover | 1 | 750,289,144 | 2,646 | 592 | 0 | 0 | 1,522 | 731 | 731 | 273 | 517 | 0 | 530 | 412 | 117 | 71 | 46 | 592 | 592 | 1,522 | 0 | 6 | 516 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 0 | 1 | 170 | 5,050 | 170 | 0 | 13,306,647,852 | 2,134,713,996 | 15,441,361,848 | 2,097,152 | 0 | 3 | 205 | 7,124,000 | 35.27 | 
| app_proof | 1 | 0 | 1 | 72 | 3,008 | 72 | 0 | 7,584,540,132 | 1,503,573,469 | 9,088,113,601 | 2,097,152 | 0 | 2 | 288 | 4,043,961 | 39.86 | 

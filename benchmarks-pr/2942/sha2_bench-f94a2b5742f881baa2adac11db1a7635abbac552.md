...
|:---|---:|---:|---:|
| Total |  9.91 |  6.86 |  6.86 |
| app_proof |  8.18 |  5.14 |  5.14 |
| leaf |  1.03 |  1.03 |  1.03 |
...
| `total_proof_time_ms ` |  4,046.50 |  8,093 |  5,048 |  3,045 |
...
| `execute_preflight_time_ms` |  278 |  556 |  345 |  211 |
| `execute_preflight_insn_mi/s` |  36.98 | -          |  39.54 |  34.43 |
| `trace_gen_time_ms   ` |  127.50 |  255 |  180 |  75 |
| `set_initial_memory_time_ms` |  0 |  0 |  0 |  0 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  3,639.50 |  7,279 |  4,656 |  2,623 |
| `prover.main_trace_commit_time_ms` |  970.50 |  1,941 |  1,351 |  590 |
| `prover.rap_constraints_time_ms` |  1,961 |  3,922 |  2,415 |  1,507 |
| `prover.openings_time_ms` |  707 |  1,414 |  889 |  525 |
| `prover.rap_constraints.logup_gkr_time_ms` |  550.50 |  1,101 |  590 |  511 |
| `prover.rap_constraints.round0_time_ms` |  1,029 |  2,058 |  1,336 |  722 |
| `prover.rap_constraints.mle_rounds_time_ms` |  380 |  760 |  488 |  272 |
| `prover.openings.stacked_reduction_time_ms` |  164 |  328 |  212 |  116 |
| `prover.openings.stacked_reduction.round0_time_ms` |  100 |  200 |  131 |  69 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  63 |  126 |  80 |  46 |
| `prover.openings.whir_time_ms` |  542.50 |  1,085 |  677 |  408 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,031 |  1,031 |  1,031 |  1,031 |
| `execute_preflight_time_ms` |  2 |  2 |  2 |  2 |
| `trace_gen_time_ms   ` |  131 |  131 |  131 |  131 |
| `generate_blob_total_time_ms` |  17 |  17 |  17 |  17 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  899 |  899 |  899 |  899 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/f94a2b5742f881baa2adac11db1a7635abbac552/sha2_bench-f94a2b5742f881baa2adac11db1a7635abbac552.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 74 |  |  |  | 369 |  |  |  |  |  |  | 
| app_proof |  |  |  | 3,045 |  | 88 | 11,167,961 | 126.67 | 0 | 8,188 |  | 
...
| app_proof | VmAirWrapper<Rv64BaseAluU16AdapterAir, AddSubCoreAir<4, 16> | 0 |  | 26 | 
...
| app_proof | VmAirWrapper<Rv64LoadStoreAdapterAir, LoadStoreCoreAir<8> | 0 | 13 | 29 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 23 | 356 | 23 | 6 | 1 | 2 | 3 | 3 | 
| internal_recursive.0 | 1 | 12 | 184 | 12 | 2 | 0 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 11 | 154 | 11 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 131 | 1,031 | 131 | 38 | 17 | 2 | 9 | 9 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 332 | 117 | 0 | 0 | 109 | 34 | 33 | 53 | 22 | 0 | 105 | 91 | 13 | 3 | 9 | 117 | 117 | 109 | 0 | 3 | 20 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 171 | 45 | 0 | 0 | 67 | 24 | 23 | 28 | 14 | 0 | 58 | 49 | 8 | 1 | 6 | 45 | 45 | 67 | 0 | 3 | 12 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 143 | 32 | 0 | 0 | 65 | 24 | 23 | 26 | 14 | 0 | 45 | 37 | 7 | 1 | 5 | 32 | 32 | 65 | 0 | 2 | 13 | 0 | 0 | 
| leaf | 0 | prover | 237,929,016 | 899 | 373 | 0 | 0 | 234 | 111 | 110 | 70 | 52 | 0 | 291 | 254 | 37 | 20 | 17 | 373 | 373 | 234 | 0 | 9 | 50 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,286,242,554 | 4,656 | 1,350 | 0 | 0 | 2,415 | 1,336 | 1,335 | 488 | 590 | 1 | 889 | 677 | 212 | 131 | 80 | 1,351 | 1,350 | 2,415 | 0 | 5 | 589 | 0 | 0 | 
| app_proof | prover | 1 | 750,289,144 | 2,623 | 590 | 0 | 0 | 1,507 | 722 | 722 | 272 | 511 | 0 | 525 | 408 | 116 | 69 | 46 | 590 | 590 | 1,507 | 0 | 5 | 510 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 0 | 1 | 180 | 5,048 | 180 | 0 | 13,306,647,852 | 2,134,713,996 | 15,441,361,848 | 2,097,152 | 0 | 4 | 211 | 7,124,000 | 34.43 | 
| app_proof | 1 | 0 | 1 | 75 | 3,045 | 75 | 0 | 7,584,540,132 | 1,503,573,469 | 9,088,113,601 | 2,097,152 | 0 | 2 | 345 | 4,043,961 | 39.54 | 

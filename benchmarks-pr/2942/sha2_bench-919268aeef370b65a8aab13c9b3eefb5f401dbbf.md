...
|:---|---:|---:|---:|
| Total |  9.88 |  6.86 |  6.86 |
| app_proof |  8.18 |  5.17 |  5.17 |
| leaf |  1.01 |  1.01 |  1.01 |
...
| `total_proof_time_ms ` |  4,048.50 |  8,097 |  5,078 |  3,019 |
...
| `execute_preflight_time_ms` |  241.50 |  483 |  283 |  200 |
| `execute_preflight_insn_mi/s` |  38.58 | -          |  40.90 |  36.25 |
| `trace_gen_time_ms   ` |  121.50 |  243 |  171 |  72 |
| `set_initial_memory_time_ms` |  0 |  0 |  0 |  0 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  3,683.50 |  7,367 |  4,705 |  2,662 |
| `prover.main_trace_commit_time_ms` |  973 |  1,946 |  1,347 |  599 |
| `prover.rap_constraints_time_ms` |  1,996.50 |  3,993 |  2,463 |  1,530 |
| `prover.openings_time_ms` |  713.50 |  1,427 |  895 |  532 |
| `prover.rap_constraints.logup_gkr_time_ms` |  560.50 |  1,121 |  602 |  519 |
| `prover.rap_constraints.round0_time_ms` |  1,047.50 |  2,095 |  1,361 |  734 |
| `prover.rap_constraints.mle_rounds_time_ms` |  387 |  774 |  498 |  276 |
| `prover.openings.stacked_reduction_time_ms` |  167 |  334 |  215 |  119 |
...
| `prover.openings.whir_time_ms` |  545.50 |  1,091 |  679 |  412 |
...
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  905 |  905 |  905 |  905 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/919268aeef370b65a8aab13c9b3eefb5f401dbbf/sha2_bench-919268aeef370b65a8aab13c9b3eefb5f401dbbf.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 68 |  |  |  | 341 |  |  |  |  |  |  | 
| app_proof |  |  |  | 3,019 |  | 87 | 11,167,961 | 127.44 | 0 | 8,191 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 326 | 119 | 0 | 0 | 108 | 35 | 35 | 52 | 20 | 0 | 98 | 84 | 13 | 3 | 9 | 119 | 119 | 108 | 0 | 3 | 20 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 172 | 47 | 0 | 0 | 68 | 25 | 24 | 28 | 14 | 0 | 56 | 47 | 8 | 1 | 6 | 48 | 47 | 68 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 141 | 32 | 0 | 0 | 62 | 23 | 22 | 24 | 14 | 0 | 44 | 37 | 7 | 1 | 5 | 33 | 32 | 62 | 0 | 2 | 13 | 0 | 0 | 
| leaf | 0 | prover | 237,929,016 | 905 | 378 | 0 | 0 | 231 | 110 | 109 | 67 | 52 | 0 | 295 | 257 | 37 | 20 | 17 | 379 | 378 | 230 | 0 | 11 | 51 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,286,242,554 | 4,705 | 1,346 | 0 | 0 | 2,463 | 1,361 | 1,360 | 498 | 602 | 0 | 895 | 679 | 215 | 135 | 80 | 1,347 | 1,346 | 2,462 | 0 | 5 | 601 | 0 | 0 | 
| app_proof | prover | 1 | 750,289,144 | 2,662 | 599 | 0 | 0 | 1,530 | 734 | 734 | 276 | 519 | 0 | 532 | 412 | 119 | 72 | 47 | 599 | 599 | 1,530 | 0 | 6 | 518 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 0 | 1 | 171 | 5,078 | 171 | 0 | 13,306,647,852 | 2,134,713,996 | 15,441,361,848 | 2,097,152 | 0 | 4 | 200 | 7,124,000 | 36.25 | 
| app_proof | 1 | 0 | 1 | 72 | 3,019 | 72 | 0 | 7,584,540,132 | 1,503,573,469 | 9,088,113,601 | 2,097,152 | 0 | 2 | 283 | 4,043,961 | 40.90 | 

...
| `total_proof_time_ms ` |  1,024 |  1,024 |  1,024 |  1,024 |
| `compile_metered_time_ms` |  8 |  8 |  8 |  8 |
| `execute_metered_time_ms` |  31 | -          | -          | -          |
| `execute_metered_insns` |  4,090,656 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  129.45 | -          |  129.45 |  129.45 |
| `execute_preflight_insns` |  4,090,656 |  4,090,656 |  4,090,656 |  4,090,656 |
| `execute_preflight_time_ms` |  119 |  119 |  119 |  119 |
| `execute_preflight_insn_mi/s` |  36.03 | -          |  36.03 |  36.03 |
...
| `prover.main_trace_commit_time_ms` |  194 |  194 |  194 |  194 |
| `prover.rap_constraints_time_ms` |  496 |  496 |  496 |  496 |
| `prover.openings_time_ms` |  178 |  178 |  178 |  178 |
| `prover.rap_constraints.logup_gkr_time_ms` |  295 |  295 |  295 |  295 |
| `prover.rap_constraints.round0_time_ms` |  149 |  149 |  149 |  149 |
...
| `prover.openings.whir_time_ms` |  141 |  141 |  141 |  141 |
...
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  314 |  314 |  314 |  314 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/f94a2b5742f881baa2adac11db1a7635abbac552/regex-f94a2b5742f881baa2adac11db1a7635abbac552.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 68 |  |  |  | 343 |  |  |  |  |  |  | 
| app_proof |  |  |  | 1,024 |  | 31 | 4,090,656 | 129.45 | 0 | 1,069 |  | 
| internal_for_leaf |  |  | 274 |  |  |  |  |  |  |  | 274 | 
| internal_recursive.0 |  |  | 177 |  |  |  |  |  |  |  | 178 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 27,277,885 | 259 | 82 | 0 | 0 | 98 | 31 | 30 | 45 | 21 | 0 | 77 | 66 | 11 | 2 | 8 | 82 | 82 | 98 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 167 | 46 | 0 | 0 | 66 | 24 | 23 | 28 | 13 | 0 | 54 | 45 | 8 | 1 | 6 | 46 | 46 | 66 | 0 | 3 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 136 | 32 | 0 | 0 | 63 | 24 | 23 | 24 | 14 | 0 | 40 | 32 | 7 | 1 | 5 | 32 | 32 | 63 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 65,360,477 | 314 | 104 | 0 | 0 | 110 | 47 | 46 | 32 | 31 | 0 | 99 | 86 | 13 | 5 | 7 | 104 | 104 | 110 | 0 | 6 | 29 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 238,925,643 | 869 | 193 | 0 | 0 | 496 | 149 | 148 | 51 | 295 | 20 | 178 | 141 | 36 | 19 | 17 | 194 | 193 | 496 | 0 | 4 | 274 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 0 | 2 | 34 | 1,024 | 34 | 0 | 4,179,589,434 | 897,887,370 | 5,077,476,804 | 2,097,152 | 1 | 5 | 119 | 4,090,656 | 36.03 | 

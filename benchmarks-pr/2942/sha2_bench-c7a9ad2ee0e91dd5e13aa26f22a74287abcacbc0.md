...
|:---|---:|---:|---:|
| Total |  9.70 |  6.74 |  6.74 |
| app_proof |  8.03 |  5.06 |  5.06 |
...
| `total_proof_time_ms ` |  3,971 |  7,942 |  4,978 |  2,964 |
...
| `execute_preflight_time_ms` |  241 |  482 |  282 |  200 |
| `execute_preflight_insn_mi/s` |  38.63 | -          |  41.01 |  36.25 |
| `trace_gen_time_ms   ` |  121.50 |  243 |  170 |  73 |
| `set_initial_memory_time_ms` |  0 |  0 |  0 |  0 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  3,607 |  7,214 |  4,606 |  2,608 |
| `prover.main_trace_commit_time_ms` |  947.50 |  1,895 |  1,311 |  584 |
| `prover.rap_constraints_time_ms` |  1,956.50 |  3,913 |  2,414 |  1,499 |
| `prover.openings_time_ms` |  702 |  1,404 |  880 |  524 |
| `prover.rap_constraints.logup_gkr_time_ms` |  547 |  1,094 |  586 |  508 |
| `prover.rap_constraints.round0_time_ms` |  1,034.50 |  2,069 |  1,343 |  726 |
| `prover.rap_constraints.mle_rounds_time_ms` |  374 |  748 |  484 |  264 |
| `prover.openings.stacked_reduction_time_ms` |  161.50 |  323 |  208 |  115 |
| `prover.openings.stacked_reduction.round0_time_ms` |  99 |  198 |  129 |  69 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  62 |  124 |  78 |  46 |
| `prover.openings.whir_time_ms` |  539.50 |  1,079 |  671 |  408 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/c7a9ad2ee0e91dd5e13aa26f22a74287abcacbc0/sha2_bench-c7a9ad2ee0e91dd5e13aa26f22a74287abcacbc0.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 70 |  |  |  | 346 |  |  |  |  |  |  | 
| app_proof |  |  |  | 2,964 |  | 86 | 11,167,961 | 128.44 | 0 | 8,035 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 331 | 116 | 0 | 0 | 107 | 34 | 33 | 51 | 21 | 0 | 107 | 93 | 13 | 3 | 9 | 116 | 116 | 107 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 169 | 45 | 0 | 0 | 64 | 23 | 22 | 27 | 13 | 0 | 58 | 50 | 8 | 1 | 6 | 45 | 45 | 64 | 0 | 2 | 12 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 136 | 32 | 0 | 0 | 60 | 23 | 22 | 24 | 13 | 0 | 43 | 35 | 7 | 1 | 5 | 32 | 32 | 60 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 237,929,016 | 885 | 370 | 0 | 0 | 226 | 108 | 107 | 67 | 50 | 0 | 288 | 251 | 36 | 19 | 16 | 370 | 370 | 226 | 0 | 11 | 49 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,286,242,554 | 4,606 | 1,311 | 0 | 0 | 2,414 | 1,343 | 1,343 | 484 | 586 | 1 | 880 | 671 | 208 | 129 | 78 | 1,311 | 1,311 | 2,414 | 0 | 6 | 584 | 0 | 0 | 
| app_proof | prover | 1 | 750,289,144 | 2,608 | 584 | 0 | 0 | 1,499 | 726 | 726 | 264 | 508 | 0 | 524 | 408 | 115 | 69 | 46 | 584 | 584 | 1,499 | 0 | 5 | 507 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 0 | 1 | 170 | 4,978 | 170 | 0 | 13,306,647,852 | 2,134,713,996 | 15,441,361,848 | 2,097,152 | 0 | 3 | 200 | 7,124,000 | 36.25 | 
| app_proof | 1 | 0 | 1 | 73 | 2,964 | 73 | 0 | 7,584,540,132 | 1,503,573,469 | 9,088,113,601 | 2,097,152 | 0 | 2 | 282 | 4,043,961 | 41.01 | 

...
| `total_proof_time_ms ` |  4,011.50 |  8,023 |  5,031 |  2,992 |
...
| `execute_preflight_time_ms` |  242.50 |  485 |  278 |  207 |
| `execute_preflight_insn_mi/s` |  37.26 | -          |  39.52 |  34.100 |
| `trace_gen_time_ms   ` |  121 |  242 |  170 |  72 |
| `set_initial_memory_time_ms` |  0 |  0 |  0 |  0 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  3,646.50 |  7,293 |  4,653 |  2,640 |
| `prover.main_trace_commit_time_ms` |  957 |  1,914 |  1,324 |  590 |
| `prover.rap_constraints_time_ms` |  1,980 |  3,960 |  2,438 |  1,522 |
| `prover.openings_time_ms` |  709 |  1,418 |  890 |  528 |
| `prover.rap_constraints.logup_gkr_time_ms` |  556.50 |  1,113 |  594 |  519 |
| `prover.rap_constraints.round0_time_ms` |  1,043 |  2,086 |  1,355 |  731 |
| `prover.rap_constraints.mle_rounds_time_ms` |  379 |  758 |  488 |  270 |
| `prover.openings.stacked_reduction_time_ms` |  165 |  330 |  214 |  116 |
...
| `prover.openings.whir_time_ms` |  543 |  1,086 |  675 |  411 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/3b2c48f329b6d218c7522b9d399bd4e0b3a89847/sha2_bench-3b2c48f329b6d218c7522b9d399bd4e0b3a89847.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 67 |  |  |  | 338 |  |  |  |  |  |  | 
| app_proof |  |  |  | 2,992 |  | 88 | 11,167,961 | 126.28 | 0 | 8,118 |  | 
...
| leaf | 0 | 108 | 1,000 | 107 | 34 | 17 | 2 | 7 | 7 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 325 | 117 | 0 | 0 | 108 | 35 | 35 | 52 | 20 | 0 | 99 | 85 | 13 | 3 | 9 | 118 | 117 | 108 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 169 | 47 | 0 | 0 | 67 | 25 | 24 | 28 | 13 | 0 | 54 | 45 | 8 | 1 | 6 | 48 | 47 | 67 | 0 | 2 | 12 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 134 | 31 | 0 | 0 | 60 | 22 | 21 | 24 | 13 | 0 | 42 | 35 | 7 | 1 | 5 | 32 | 31 | 60 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 237,929,016 | 892 | 373 | 0 | 0 | 230 | 111 | 110 | 68 | 51 | 0 | 287 | 250 | 37 | 20 | 17 | 374 | 373 | 230 | 0 | 10 | 50 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,286,242,554 | 4,653 | 1,324 | 0 | 0 | 2,438 | 1,355 | 1,355 | 488 | 594 | 0 | 890 | 675 | 214 | 134 | 80 | 1,324 | 1,324 | 2,438 | 0 | 5 | 593 | 0 | 0 | 
| app_proof | prover | 1 | 750,289,144 | 2,640 | 590 | 0 | 0 | 1,522 | 731 | 731 | 270 | 519 | 0 | 528 | 411 | 116 | 70 | 46 | 590 | 590 | 1,522 | 0 | 7 | 518 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 0 | 1 | 170 | 5,031 | 170 | 0 | 13,306,647,852 | 2,134,713,996 | 15,441,361,848 | 2,097,152 | 0 | 4 | 207 | 7,124,000 | 34.100 | 
| app_proof | 1 | 0 | 1 | 72 | 2,992 | 72 | 0 | 7,584,540,132 | 1,503,573,469 | 9,088,113,601 | 2,097,152 | 0 | 2 | 278 | 4,043,961 | 39.52 | 

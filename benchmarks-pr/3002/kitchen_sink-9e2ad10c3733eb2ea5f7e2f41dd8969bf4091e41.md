...
|:---|---:|---:|---:|
| Total |  6.03 |  6.03 |  6.04 |
| app_proof |  4.50 |  4.50 |  4.50 |
| leaf |  0.87 |  0.87 |  0.87 |
...
| `execute_metered_insn_mi/s` |  71.12 | -          |  71.12 |  71.12 |
| `execute_preflight_insns` |  2,579,903 |  2,579,903 |  2,579,903 |  2,579,903 |
| `execute_preflight_time_ms` |  97 |  97 |  97 |  97 |
| `execute_preflight_insn_mi/s` |  34.02 | -          |  34.02 |  34.02 |
| `trace_gen_time_ms   ` |  160 |  160 |  160 |  160 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  4,081 |  4,081 |  4,081 |  4,081 |
| `prover.main_trace_commit_time_ms` |  1,603 |  1,603 |  1,603 |  1,603 |
| `prover.rap_constraints_time_ms` |  1,679 |  1,679 |  1,679 |  1,679 |
| `prover.openings_time_ms` |  798 |  798 |  798 |  798 |
| `prover.rap_constraints.logup_gkr_time_ms` |  287 |  287 |  287 |  287 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  870 |  870 |  870 |  870 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/9e2ad10c3733eb2ea5f7e2f41dd8969bf4091e41/kitchen_sink-9e2ad10c3733eb2ea5f7e2f41dd8969bf4091e41.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 68 |  |  |  | 377 |  |  |  |  |  |  | 
| app_proof |  |  |  | 4,460 |  | 36 | 2,579,903 | 71.12 | 0 | 4,500 |  | 
...
| app_proof | VmAirWrapper<Rv32VecHeapAdapterAir<2, 8, 8, 4, 4>, 2, 8, 8, 4, 32, 32>, MultiplicationCoreAir<32, 8> | 0 |  | 62 | 
...
| leaf | 0 | 111 | 870 | 111 | 18 | 9 | 21 | 19 | 19 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,577,981 | 321 | 115 | 0 | 0 | 105 | 34 | 33 | 51 | 20 | 0 | 100 | 87 | 13 | 3 | 9 | 115 | 115 | 105 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 171 | 45 | 0 | 0 | 65 | 24 | 23 | 28 | 13 | 0 | 59 | 50 | 8 | 1 | 6 | 46 | 45 | 65 | 0 | 2 | 12 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 138 | 31 | 0 | 0 | 60 | 23 | 22 | 24 | 13 | 0 | 45 | 38 | 7 | 1 | 5 | 31 | 31 | 60 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 170,433,085 | 758 | 251 | 0 | 0 | 293 | 104 | 103 | 58 | 129 | 0 | 212 | 186 | 26 | 13 | 12 | 252 | 251 | 293 | 0 | 7 | 128 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,121,338,980 | 4,081 | 1,603 | 0 | 0 | 1,679 | 1,014 | 1,013 | 377 | 287 | 1 | 798 | 611 | 187 | 107 | 80 | 1,603 | 1,603 | 1,679 | 0 | 4 | 285 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 120 | 160 | 4,460 | 4 | 120 | 0 | 0 | 39 | 10,592,943,552 | 2,968,407,792 | 13,561,351,344 | 2,097,152 | 2 | 0 | 0 | 1 | 3 | 116 | 97 | 2,579,903 | 34.02 | 0 | 0 | 

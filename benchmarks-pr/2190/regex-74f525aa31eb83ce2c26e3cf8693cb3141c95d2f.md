...
|:---|---:|---:|
| Total |  2.34 |  0.76 |
| regex_program |  2.31 |  0.73 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  577.25 |  2,309 |  729 |  525 |
...
| `execute_preflight_insn_mi/s` |  30.20 | -          |  31.54 |  27.43 |
| `trace_gen_time_ms   ` |  172.50 |  690 |  205 |  150 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  282.50 |  1,130 |  333 |  259 |
| `main_trace_commit_time_ms` |  50.75 |  203 |  56 |  48 |
| `generate_perm_trace_time_ms` |  34 |  136 |  54 |  19 |
| `perm_trace_commit_time_ms` |  62.44 |  249.74 |  69.43 |  53.48 |
| `quotient_poly_compute_time_ms` |  57.38 |  229.53 |  70.04 |  50.74 |
| `quotient_poly_commit_time_ms` |  14.30 |  57.20 |  16.41 |  12.41 |
| `pcs_opening_time_ms ` |  60.50 |  242 |  77 |  51 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 525 | 41 | 1 | 34 | 4,137,502 | 120.79 | 172 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 205 | 729 | 23,446,148 | 150,778,428 | 205 | 333 | 0 | 57.44 | 16.41 | 5 | 69.43 | 77 | 124 | 77 | 4 | 56 | 10,899,170 | 54 | 47 | 1,103,000 | 27.43 | 21 | 74 | 1 | 77 | 
| regex_program | 1 | 150 | 527 | 11,598,276 | 128,513,066 | 150 | 269 | 1 | 50.74 | 14.12 | 4 | 63.39 | 52 | 100 | 52 | 0 | 49 | 2,196,106 | 37 | 67 | 1,104,000 | 31.06 | 16 | 65 | 0 | 52 | 
| regex_program | 2 | 157 | 528 | 11,579,064 | 128,513,066 | 157 | 269 | 1 | 51.30 | 14.27 | 4 | 63.43 | 62 | 90 | 61 | 0 | 50 | 2,177,334 | 26 | 60 | 1,104,000 | 30.76 | 16 | 66 | 0 | 61 | 
| regex_program | 3 | 178 | 525 | 11,853,872 | 103,456,394 | 178 | 259 | 0 | 70.04 | 12.41 | 5 | 53.48 | 51 | 76 | 50 | 0 | 48 | 2,422,606 | 19 | 46 | 826,502 | 31.54 | 18 | 83 | 1 | 50 | 

...
|:---|---:|---:|
| Total |  1.06 |  0.58 |
| fibonacci_program |  1.05 |  0.57 |


| fibonacci_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  523.50 |  1,047 |  575 |  472 |
...
| `execute_metered_insn_mi/s` |  160.71 | -          |  160.71 |  160.71 |
| `execute_preflight_insns` |  750,104.50 |  1,500,209 |  873,000 |  627,209 |
| `execute_preflight_time_ms` |  30.50 |  61 |  35 |  26 |
| `execute_preflight_insn_mi/s` |  35.20 | -          |  36.22 |  34.18 |
| `trace_gen_time_ms   ` |  192 |  384 |  198 |  186 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  207 |  414 |  208 |  206 |
| `main_trace_commit_time_ms` |  30.50 |  61 |  33 |  28 |
| `generate_perm_trace_time_ms` |  15 |  30 |  18 |  12 |
| `perm_trace_commit_time_ms` |  41.87 |  83.75 |  45.39 |  38.36 |
| `quotient_poly_compute_time_ms` |  32.79 |  65.59 |  34.57 |  31.02 |
| `quotient_poly_commit_time_ms` |  12.57 |  25.14 |  13.02 |  12.12 |
| `pcs_opening_time_ms ` |  71.50 |  143 |  84 |  59 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 472 | 41 | 1 | 9 | 1,500,209 | 160.71 | 141 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 198 | 575 | 9,677,708 | 84,395,212 | 198 | 206 | 0 | 34.57 | 13.02 | 5 | 45.39 | 59 | 64 | 59 | 0 | 33 | 1,035,986 | 18 | 26 | 873,000 | 34.18 | 14 | 48 | 0 | 59 | 
| fibonacci_program | 1 | 186 | 472 | 9,708,170 | 74,305,770 | 186 | 208 | 1 | 31.02 | 12.12 | 4 | 38.36 | 84 | 51 | 84 | 0 | 28 | 1,064,416 | 12 | 35 | 627,209 | 36.22 | 11 | 43 | 0 | 84 | 

...
| `total_proof_time_ms ` |  720 |  1,440 |  837 |  603 |
...
| `execute_metered_insn_mi/s` |  19.51 | -          |  19.51 |  19.51 |
| `execute_preflight_insns` |  872,871 |  1,745,742 |  1,157,000 |  588,742 |
| `execute_preflight_time_ms` |  96 |  192 |  131 |  61 |
| `execute_preflight_insn_mi/s` |  13.43 | -          |  17.79 |  9.08 |
| `trace_gen_time_ms   ` |  177.50 |  355 |  193 |  162 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  353 |  706 |  399 |  307 |
| `main_trace_commit_time_ms` |  64.50 |  129 |  75 |  54 |
| `generate_perm_trace_time_ms` |  39 |  78 |  41 |  37 |
| `perm_trace_commit_time_ms` |  77.02 |  154.03 |  89.83 |  64.20 |
| `quotient_poly_compute_time_ms` |  79.57 |  159.14 |  87.31 |  71.83 |
| `quotient_poly_commit_time_ms` |  16.65 |  33.30 |  19 |  14.29 |
| `pcs_opening_time_ms ` |  71.50 |  143 |  86 |  57 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 603 | 40 | 1 | 89 | 1,745,742 | 19.51 | 146 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 162 | 837 | 32,689,110 | 172,558,444 | 162 | 399 | 0 | 87.31 | 19 | 6 | 89.83 | 86 | 130 | 86 | 1 | 75 | 16,059,916 | 37 | 131 | 1,157,000 | 9.08 | 26 | 107 | 1 | 86 | 
| pairing | 1 | 193 | 603 | 22,314,288 | 119,958,502 | 193 | 307 | 1 | 71.83 | 14.29 | 6 | 64.20 | 57 | 108 | 57 | 0 | 54 | 9,408,294 | 41 | 61 | 588,742 | 17.79 | 21 | 86 | 1 | 57 | 

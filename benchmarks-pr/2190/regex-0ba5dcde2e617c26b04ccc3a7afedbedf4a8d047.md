...
| `total_proof_time_ms ` |  575.75 |  2,303 |  700 |  522 |
...
| `execute_metered_insn_mi/s` |  121.40 | -          |  121.40 |  121.40 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  55 |  220 |  67 |  47 |
| `execute_preflight_insn_mi/s` |  29.79 | -          |  30.79 |  27.22 |
| `trace_gen_time_ms   ` |  177 |  708 |  210 |  155 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  276.25 |  1,105 |  300 |  259 |
| `main_trace_commit_time_ms` |  51.75 |  207 |  56 |  50 |
| `generate_perm_trace_time_ms` |  30.75 |  123 |  40 |  18 |
| `perm_trace_commit_time_ms` |  64.29 |  257.15 |  71.20 |  55.70 |
| `quotient_poly_compute_time_ms` |  58.20 |  232.80 |  68.69 |  52.51 |
| `quotient_poly_commit_time_ms` |  14.56 |  58.23 |  16.86 |  12.43 |
| `pcs_opening_time_ms ` |  53.25 |  213 |  62 |  46 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 534 | 41 | 1 | 34 | 4,137,502 | 121.40 | 168 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 210 | 700 | 23,446,148 | 150,778,428 | 210 | 300 | 0 | 58.54 | 16.86 | 5 | 71.20 | 54 | 113 | 54 | 4 | 56 | 10,899,170 | 40 | 47 | 1,103,000 | 27.22 | 21 | 76 | 1 | 54 | 
| regex_program | 1 | 155 | 547 | 11,598,276 | 128,513,066 | 155 | 284 | 1 | 52.51 | 14.40 | 4 | 64.63 | 62 | 103 | 62 | 0 | 50 | 2,196,106 | 38 | 67 | 1,104,000 | 30.48 | 16 | 67 | 0 | 62 | 
| regex_program | 2 | 161 | 522 | 11,579,064 | 128,513,066 | 161 | 259 | 1 | 53.07 | 14.54 | 4 | 65.62 | 46 | 93 | 46 | 0 | 51 | 2,177,334 | 27 | 59 | 1,104,000 | 30.65 | 16 | 68 | 0 | 46 | 
| regex_program | 3 | 182 | 534 | 11,853,872 | 103,456,394 | 182 | 262 | 0 | 68.69 | 12.43 | 5 | 55.70 | 51 | 78 | 51 | 0 | 50 | 2,422,606 | 18 | 47 | 826,502 | 30.79 | 18 | 82 | 1 | 51 | 

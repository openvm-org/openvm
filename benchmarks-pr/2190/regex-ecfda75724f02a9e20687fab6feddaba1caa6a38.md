...
| `total_proof_time_ms ` |  588.75 |  2,355 |  744 |  535 |
...
| `execute_metered_insn_mi/s` |  121.88 | -          |  121.88 |  121.88 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  55.75 |  223 |  69 |  46 |
| `execute_preflight_insn_mi/s` |  30.20 | -          |  31.32 |  27.29 |
| `trace_gen_time_ms   ` |  175.50 |  702 |  209 |  151 |
| `memory_finalize_time_ms` |  0.75 |  3 |  3 |  0 |
| `stark_prove_excluding_trace_time_ms` |  289.75 |  1,159 |  342 |  265 |
| `main_trace_commit_time_ms` |  50.75 |  203 |  56 |  48 |
| `generate_perm_trace_time_ms` |  35 |  140 |  55 |  19 |
| `perm_trace_commit_time_ms` |  63.75 |  254.99 |  69.08 |  55.02 |
| `quotient_poly_compute_time_ms` |  58.13 |  232.53 |  69.62 |  51.85 |
| `quotient_poly_commit_time_ms` |  15.03 |  60.11 |  17.80 |  12.34 |
| `pcs_opening_time_ms ` |  64.25 |  257 |  83 |  55 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 535 | 41 | 1 | 33 | 4,137,502 | 121.88 | 174 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 209 | 744 | 23,446,148 | 150,778,428 | 209 | 342 | 0 | 58.96 | 17.80 | 5 | 69.08 | 83 | 125 | 82 | 3 | 56 | 10,899,170 | 55 | 47 | 1,103,000 | 27.29 | 21 | 77 | 1 | 82 | 
| regex_program | 1 | 151 | 538 | 11,598,276 | 128,513,066 | 151 | 276 | 1 | 52.10 | 14.33 | 4 | 64.70 | 55 | 103 | 55 | 0 | 49 | 2,196,106 | 38 | 69 | 1,104,000 | 31.12 | 16 | 67 | 0 | 55 | 
| regex_program | 2 | 160 | 538 | 11,579,064 | 128,513,066 | 159 | 276 | 1 | 51.85 | 15.64 | 4 | 66.18 | 63 | 95 | 62 | 0 | 50 | 2,177,334 | 28 | 61 | 1,104,000 | 31.32 | 17 | 68 | 0 | 62 | 
| regex_program | 3 | 182 | 535 | 11,853,872 | 103,456,394 | 182 | 265 | 0 | 69.62 | 12.34 | 5 | 55.02 | 56 | 77 | 56 | 0 | 48 | 2,422,606 | 19 | 46 | 826,502 | 31.07 | 18 | 83 | 1 | 56 | 

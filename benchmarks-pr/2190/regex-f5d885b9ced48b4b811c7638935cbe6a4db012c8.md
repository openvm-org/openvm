...
| `total_proof_time_ms ` |  591 |  2,364 |  729 |  539 |
...
| `execute_preflight_insn_mi/s` |  29.84 | -          |  31.02 |  26.95 |
| `trace_gen_time_ms   ` |  178 |  712 |  211 |  154 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  289 |  1,156 |  325 |  266 |
| `main_trace_commit_time_ms` |  51.50 |  206 |  56 |  49 |
| `generate_perm_trace_time_ms` |  35 |  140 |  55 |  19 |
| `perm_trace_commit_time_ms` |  64.83 |  259.32 |  69.95 |  56.18 |
| `quotient_poly_compute_time_ms` |  59.12 |  236.49 |  69.60 |  52.39 |
| `quotient_poly_commit_time_ms` |  15.64 |  62.56 |  17.76 |  13.55 |
| `pcs_opening_time_ms ` |  59.75 |  239 |  63 |  52 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 539 | 41 | 1 | 36 | 4,137,502 | 113.75 | 170 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 211 | 729 | 23,446,148 | 150,778,428 | 211 | 325 | 0 | 61.10 | 17.76 | 5 | 69.95 | 62 | 126 | 62 | 4 | 56 | 10,899,170 | 55 | 48 | 1,103,000 | 26.95 | 21 | 79 | 1 | 62 | 
| regex_program | 1 | 154 | 553 | 11,598,276 | 128,513,066 | 154 | 288 | 1 | 52.39 | 15.81 | 4 | 66.19 | 63 | 105 | 63 | 0 | 51 | 2,196,106 | 38 | 69 | 1,104,000 | 30.64 | 17 | 68 | 0 | 63 | 
| regex_program | 2 | 163 | 543 | 11,579,064 | 128,513,066 | 163 | 277 | 1 | 53.40 | 15.45 | 4 | 66.100 | 62 | 95 | 61 | 0 | 49 | 2,177,334 | 28 | 61 | 1,104,000 | 31.02 | 16 | 69 | 0 | 61 | 
| regex_program | 3 | 184 | 539 | 11,853,872 | 103,456,394 | 184 | 266 | 0 | 69.60 | 13.55 | 5 | 56.18 | 52 | 78 | 52 | 0 | 50 | 2,422,606 | 19 | 47 | 826,502 | 30.74 | 19 | 84 | 1 | 52 | 

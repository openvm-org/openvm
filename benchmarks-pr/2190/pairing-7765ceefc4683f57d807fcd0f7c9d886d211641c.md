...
| `total_proof_time_ms ` |  715.50 |  1,431 |  830 |  601 |
...
| `execute_preflight_insn_mi/s` |  13.56 | -          |  18.03 |  9.09 |
| `trace_gen_time_ms   ` |  177 |  354 |  194 |  160 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  349.50 |  699 |  395 |  304 |
| `main_trace_commit_time_ms` |  63.50 |  127 |  74 |  53 |
| `generate_perm_trace_time_ms` |  32 |  64 |  36 |  28 |
| `perm_trace_commit_time_ms` |  75.53 |  151.05 |  88.72 |  62.33 |
| `quotient_poly_compute_time_ms` |  77.60 |  155.19 |  86.87 |  68.32 |
| `quotient_poly_commit_time_ms` |  16.41 |  32.81 |  18.64 |  14.18 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 601 | 41 | 1 | 89 | 1,745,742 | 19.52 | 145 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 160 | 830 | 32,689,110 | 172,558,444 | 160 | 395 | 0 | 86.87 | 18.64 | 6 | 88.72 | 86 | 128 | 85 | 1 | 74 | 16,059,916 | 36 | 131 | 1,157,000 | 9.09 | 26 | 106 | 1 | 85 | 
| pairing | 1 | 194 | 601 | 22,314,288 | 119,958,502 | 194 | 304 | 1 | 68.32 | 14.18 | 5 | 62.33 | 74 | 93 | 74 | 0 | 53 | 9,408,294 | 28 | 61 | 588,742 | 18.03 | 20 | 83 | 1 | 74 | 

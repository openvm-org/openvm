...
| `total_proof_time_ms ` |  589.50 |  2,358 |  744 |  533 |
...
| `execute_metered_insn_mi/s` |  120.93 | -          |  120.93 |  120.93 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  55 |  220 |  67 |  46 |
| `execute_preflight_insn_mi/s` |  29.87 | -          |  30.90 |  26.95 |
| `trace_gen_time_ms   ` |  175.50 |  702 |  207 |  153 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  290.75 |  1,163 |  343 |  264 |
| `main_trace_commit_time_ms` |  51.50 |  206 |  56 |  49 |
| `generate_perm_trace_time_ms` |  34.75 |  139 |  55 |  19 |
| `perm_trace_commit_time_ms` |  63.46 |  253.83 |  69.28 |  55.99 |
| `quotient_poly_compute_time_ms` |  58.69 |  234.76 |  69.01 |  52.30 |
| `quotient_poly_commit_time_ms` |  15.08 |  60.32 |  17.89 |  13.21 |
| `pcs_opening_time_ms ` |  64.25 |  257 |  83 |  51 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 533 | 41 | 1 | 34 | 4,137,502 | 120.93 | 167 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 207 | 744 | 23,446,148 | 150,778,428 | 207 | 343 | 0 | 59.100 | 17.89 | 5 | 69.28 | 83 | 125 | 83 | 4 | 56 | 10,899,170 | 55 | 47 | 1,103,000 | 26.95 | 21 | 78 | 1 | 83 | 
| regex_program | 1 | 153 | 547 | 11,598,276 | 128,513,066 | 153 | 284 | 1 | 53.45 | 14.87 | 4 | 64.26 | 62 | 103 | 62 | 0 | 49 | 2,196,106 | 38 | 67 | 1,104,000 | 30.89 | 16 | 68 | 0 | 62 | 
| regex_program | 2 | 161 | 534 | 11,579,064 | 128,513,066 | 161 | 272 | 1 | 52.30 | 14.35 | 4 | 64.29 | 61 | 91 | 61 | 0 | 51 | 2,177,334 | 27 | 60 | 1,104,000 | 30.90 | 16 | 67 | 0 | 61 | 
| regex_program | 3 | 181 | 533 | 11,853,872 | 103,456,394 | 181 | 264 | 0 | 69.01 | 13.21 | 5 | 55.99 | 51 | 78 | 51 | 0 | 50 | 2,422,606 | 19 | 46 | 826,502 | 30.76 | 18 | 83 | 1 | 51 | 

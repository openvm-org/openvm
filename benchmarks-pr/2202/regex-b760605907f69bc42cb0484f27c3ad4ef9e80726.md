...
| `total_proof_time_ms ` |  585.75 |  2,343 |  715 |  538 |
...
| `execute_metered_insn_mi/s` |  110.12 | -          |  110.12 |  110.12 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  53.25 |  213 |  66 |  44 |
| `execute_preflight_insn_mi/s` |  31.91 | -          |  33.02 |  28.96 |
| `trace_gen_time_ms   ` |  178 |  712 |  211 |  155 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  286.75 |  1,147 |  314 |  269 |
| `main_trace_commit_time_ms` |  50.75 |  203 |  55 |  49 |
| `generate_perm_trace_time_ms` |  22.75 |  91 |  28 |  19 |
| `perm_trace_commit_time_ms` |  64.64 |  258.54 |  70.100 |  55.37 |
| `quotient_poly_compute_time_ms` |  58.16 |  232.63 |  68.60 |  51.63 |
| `quotient_poly_commit_time_ms` |  15.20 |  60.79 |  17.99 |  12.43 |
| `pcs_opening_time_ms ` |  72 |  288 |  83 |  58 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 540 | 41 | 1 | 37 | 4,137,502 | 110.12 | 167 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 211 | 715 | 23,446,148 | 150,778,428 | 211 | 314 | 0 | 60.35 | 17.99 | 5 | 70.100 | 83 | 96 | 82 | 4 | 55 | 10,899,170 | 24 | 44 | 1,103,000 | 28.96 | 22 | 79 | 1 | 82 | 
| regex_program | 1 | 155 | 538 | 11,598,276 | 128,513,066 | 155 | 276 | 1 | 52.05 | 14.72 | 4 | 65.78 | 72 | 87 | 72 | 0 | 49 | 2,196,106 | 20 | 66 | 1,104,000 | 32.75 | 16 | 67 | 0 | 72 | 
| regex_program | 2 | 162 | 550 | 11,579,064 | 128,513,066 | 162 | 288 | 1 | 51.63 | 15.65 | 4 | 66.40 | 75 | 95 | 75 | 0 | 49 | 2,177,334 | 28 | 58 | 1,104,000 | 33.02 | 17 | 67 | 0 | 75 | 
| regex_program | 3 | 184 | 540 | 11,853,872 | 103,456,394 | 184 | 269 | 0 | 68.60 | 12.43 | 5 | 55.37 | 58 | 77 | 58 | 0 | 50 | 2,422,606 | 19 | 45 | 826,502 | 32.93 | 18 | 82 | 1 | 58 | 
...
Commit: https://github.com/openvm-org/openvm/commit/b760605907f69bc42cb0484f27c3ad4ef9e80726
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19156784713)

...
| `total_proof_time_ms ` |  750 |  1,500 |  823 |  677 |
...
| `execute_preflight_insn_mi/s` |  13.74 | -          |  18.21 |  9.27 |
| `trace_gen_time_ms   ` |  177.50 |  355 |  193 |  162 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  385 |  770 |  388 |  382 |
| `main_trace_commit_time_ms` |  64 |  128 |  74 |  54 |
| `generate_perm_trace_time_ms` |  48 |  96 |  54 |  42 |
| `perm_trace_commit_time_ms` |  77.25 |  154.50 |  89.90 |  64.60 |
| `quotient_poly_compute_time_ms` |  79.10 |  158.21 |  87.57 |  70.64 |
| `quotient_poly_commit_time_ms` |  16.32 |  32.65 |  18.18 |  14.47 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 677 | 40 | 1 | 91 | 1,745,742 | 19.12 | 146 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 162 | 823 | 32,689,110 | 172,558,444 | 162 | 388 | 0 | 87.57 | 18.18 | 6 | 89.90 | 71 | 135 | 71 | 1 | 74 | 16,059,916 | 42 | 128 | 1,157,000 | 9.27 | 26 | 106 | 1 | 71 | 
| pairing | 1 | 193 | 677 | 22,314,288 | 119,958,502 | 193 | 382 | 1 | 70.64 | 14.47 | 6 | 64.60 | 119 | 122 | 118 | 0 | 54 | 9,408,294 | 54 | 60 | 588,742 | 18.21 | 20 | 85 | 1 | 118 | 

...
| `total_proof_time_ms ` |  578.50 |  2,314 |  695 |  537 |
...
| `execute_metered_insn_mi/s` |  113.80 | -          |  113.80 |  113.80 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  52.50 |  210 |  64 |  44 |
| `execute_preflight_insn_mi/s` |  31.100 | -          |  33.36 |  29.23 |
| `trace_gen_time_ms   ` |  177.25 |  709 |  211 |  155 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  281 |  1,124 |  295 |  271 |
| `main_trace_commit_time_ms` |  51.25 |  205 |  55 |  49 |
| `generate_perm_trace_time_ms` |  22 |  88 |  27 |  19 |
| `perm_trace_commit_time_ms` |  64.86 |  259.44 |  73.68 |  55.17 |
| `quotient_poly_compute_time_ms` |  57.50 |  230.01 |  68.26 |  51.82 |
| `quotient_poly_commit_time_ms` |  14.64 |  58.57 |  16.50 |  12.39 |
| `pcs_opening_time_ms ` |  68 |  272 |  72 |  62 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 539 | 41 | 1 | 36 | 4,137,502 | 113.80 | 167 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 211 | 695 | 23,446,148 | 150,778,428 | 211 | 295 | 0 | 57.49 | 16.50 | 5 | 73.68 | 66 | 98 | 66 | 4 | 55 | 10,899,170 | 23 | 44 | 1,103,000 | 29.23 | 21 | 74 | 1 | 66 | 
| regex_program | 1 | 155 | 537 | 11,598,276 | 128,513,066 | 155 | 276 | 1 | 52.43 | 15.29 | 4 | 65.80 | 72 | 85 | 72 | 0 | 50 | 2,196,106 | 19 | 64 | 1,104,000 | 33.04 | 16 | 68 | 0 | 72 | 
| regex_program | 2 | 161 | 543 | 11,579,064 | 128,513,066 | 161 | 282 | 1 | 51.82 | 14.40 | 4 | 64.79 | 72 | 92 | 72 | 0 | 51 | 2,177,334 | 27 | 58 | 1,104,000 | 32.34 | 16 | 66 | 0 | 72 | 
| regex_program | 3 | 182 | 539 | 11,853,872 | 103,456,394 | 182 | 271 | 0 | 68.26 | 12.39 | 5 | 55.17 | 62 | 76 | 62 | 0 | 49 | 2,422,606 | 19 | 44 | 826,502 | 33.36 | 18 | 81 | 1 | 62 | 

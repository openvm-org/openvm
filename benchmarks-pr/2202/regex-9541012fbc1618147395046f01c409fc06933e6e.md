...
| `total_proof_time_ms ` |  587 |  2,348 |  714 |  540 |
...
| `execute_preflight_time_ms` |  52.75 |  211 |  66 |  44 |
| `execute_preflight_insn_mi/s` |  31.40 | -          |  33.04 |  29.11 |
| `trace_gen_time_ms   ` |  177.75 |  711 |  211 |  154 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  288.75 |  1,155 |  314 |  271 |
| `main_trace_commit_time_ms` |  51.25 |  205 |  57 |  49 |
| `generate_perm_trace_time_ms` |  22 |  88 |  27 |  19 |
| `perm_trace_commit_time_ms` |  64.64 |  258.55 |  71.87 |  55.45 |
| `quotient_poly_compute_time_ms` |  58.18 |  232.74 |  68.30 |  52.82 |
| `quotient_poly_commit_time_ms` |  14.67 |  58.69 |  17.57 |  12.26 |
| `pcs_opening_time_ms ` |  75 |  300 |  85 |  62 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 540 | 40 | 1 | 36 | 4,137,502 | 112.80 | 165 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 211 | 714 | 23,446,148 | 150,778,428 | 211 | 314 | 0 | 58.45 | 17.57 | 5 | 71.87 | 85 | 95 | 84 | 4 | 57 | 10,899,170 | 22 | 44 | 1,103,000 | 29.11 | 22 | 76 | 1 | 84 | 
| regex_program | 1 | 154 | 547 | 11,598,276 | 128,513,066 | 154 | 285 | 1 | 52.82 | 14.33 | 5 | 65.51 | 81 | 86 | 81 | 0 | 49 | 2,196,106 | 20 | 66 | 1,104,000 | 30.44 | 16 | 67 | 0 | 81 | 
| regex_program | 2 | 163 | 547 | 11,579,064 | 128,513,066 | 163 | 285 | 1 | 53.17 | 14.54 | 4 | 65.72 | 72 | 94 | 72 | 0 | 50 | 2,177,334 | 27 | 57 | 1,104,000 | 33.04 | 16 | 68 | 0 | 72 | 
| regex_program | 3 | 183 | 540 | 11,853,872 | 103,456,394 | 183 | 271 | 0 | 68.30 | 12.26 | 5 | 55.45 | 62 | 77 | 62 | 0 | 49 | 2,422,606 | 19 | 44 | 826,502 | 33.03 | 18 | 81 | 1 | 62 | 
...
Commit: https://github.com/openvm-org/openvm/commit/9541012fbc1618147395046f01c409fc06933e6e
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19159845158)

...
| `total_proof_time_ms ` |  581.75 |  2,327 |  691 |  538 |
...
| `execute_preflight_insn_mi/s` |  30.73 | -          |  32.08 |  28.19 |
| `trace_gen_time_ms   ` |  178 |  712 |  212 |  156 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  282 |  1,128 |  289 |  275 |
| `main_trace_commit_time_ms` |  52 |  208 |  57 |  50 |
| `generate_perm_trace_time_ms` |  23 |  92 |  27 |  19 |
| `perm_trace_commit_time_ms` |  64.34 |  257.37 |  70.51 |  55.86 |
| `quotient_poly_compute_time_ms` |  59.55 |  238.19 |  73.29 |  51.76 |
| `quotient_poly_commit_time_ms` |  14.98 |  59.92 |  17.49 |  12.93 |
| `pcs_opening_time_ms ` |  65 |  260 |  72 |  54 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 551 | 41 | 1 | 36 | 4,137,502 | 114.69 | 167 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 212 | 691 | 23,446,148 | 150,778,428 | 212 | 289 | 0 | 60.59 | 17.49 | 5 | 70.51 | 54 | 97 | 54 | 4 | 57 | 10,899,170 | 26 | 45 | 1,103,000 | 28.19 | 21 | 78 | 1 | 54 | 
| regex_program | 1 | 156 | 538 | 11,598,276 | 128,513,066 | 156 | 275 | 1 | 52.55 | 14.49 | 4 | 65.65 | 71 | 85 | 71 | 0 | 50 | 2,196,106 | 19 | 65 | 1,104,000 | 32.08 | 16 | 67 | 0 | 71 | 
| regex_program | 2 | 162 | 547 | 11,579,064 | 128,513,066 | 162 | 284 | 1 | 51.76 | 15.01 | 4 | 65.36 | 72 | 93 | 72 | 0 | 51 | 2,177,334 | 27 | 59 | 1,104,000 | 31.37 | 16 | 67 | 0 | 72 | 
| regex_program | 3 | 182 | 551 | 11,853,872 | 103,456,394 | 182 | 280 | 0 | 73.29 | 12.93 | 5 | 55.86 | 63 | 79 | 62 | 0 | 50 | 2,422,606 | 20 | 46 | 826,502 | 31.27 | 18 | 87 | 1 | 62 | 
...
Commit: https://github.com/openvm-org/openvm/commit/654c6a137544cf0146596b2c2ed59c1dd30f10e3
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19158963120)

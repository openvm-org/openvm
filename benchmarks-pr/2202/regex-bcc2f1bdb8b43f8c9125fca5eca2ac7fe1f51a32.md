...
| `total_proof_time_ms ` |  580.50 |  2,322 |  704 |  537 |
...
| `execute_metered_insn_mi/s` |  102.08 | -          |  102.08 |  102.08 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  55.25 |  221 |  68 |  46 |
| `execute_preflight_insn_mi/s` |  30.05 | -          |  31.05 |  27.18 |
| `trace_gen_time_ms   ` |  175.75 |  703 |  210 |  152 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  282.50 |  1,130 |  302 |  271 |
| `main_trace_commit_time_ms` |  51.25 |  205 |  57 |  48 |
| `generate_perm_trace_time_ms` |  22.75 |  91 |  27 |  18 |
| `perm_trace_commit_time_ms` |  63.90 |  255.61 |  71.28 |  54.91 |
| `quotient_poly_compute_time_ms` |  57.65 |  230.61 |  68.66 |  51.45 |
| `quotient_poly_commit_time_ms` |  14.33 |  57.32 |  16.48 |  12.22 |
| `pcs_opening_time_ms ` |  69 |  276 |  72 |  62 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 539 | 41 | 1 | 40 | 4,137,502 | 102.08 | 167 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 210 | 704 | 23,446,148 | 150,778,428 | 210 | 302 | 0 | 57.40 | 16.48 | 5 | 71.28 | 70 | 99 | 70 | 4 | 57 | 10,899,170 | 27 | 47 | 1,103,000 | 27.18 | 21 | 74 | 1 | 70 | 
| regex_program | 1 | 152 | 537 | 11,598,276 | 128,513,066 | 152 | 276 | 1 | 53.10 | 14.50 | 5 | 65.42 | 72 | 84 | 72 | 0 | 50 | 2,196,106 | 18 | 68 | 1,104,000 | 30.97 | 16 | 68 | 0 | 72 | 
| regex_program | 2 | 160 | 542 | 11,579,064 | 128,513,066 | 160 | 281 | 1 | 51.45 | 14.12 | 4 | 64 | 72 | 91 | 72 | 0 | 50 | 2,177,334 | 26 | 60 | 1,104,000 | 31.05 | 16 | 66 | 0 | 72 | 
| regex_program | 3 | 181 | 539 | 11,853,872 | 103,456,394 | 181 | 271 | 0 | 68.66 | 12.22 | 5 | 54.91 | 62 | 77 | 62 | 0 | 48 | 2,422,606 | 20 | 46 | 826,502 | 30.99 | 18 | 81 | 1 | 62 | 
...
Commit: https://github.com/openvm-org/openvm/commit/bcc2f1bdb8b43f8c9125fca5eca2ac7fe1f51a32
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19159328011)

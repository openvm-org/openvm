...
| `total_proof_time_ms ` |  587.75 |  2,351 |  726 |  540 |
...
| `execute_metered_insn_mi/s` |  116.95 | -          |  116.95 |  116.95 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  52.50 |  210 |  64 |  44 |
| `execute_preflight_insn_mi/s` |  31.93 | -          |  33.12 |  28.82 |
| `trace_gen_time_ms   ` |  178.50 |  714 |  211 |  156 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  289.25 |  1,157 |  326 |  271 |
| `main_trace_commit_time_ms` |  51.50 |  206 |  56 |  48 |
| `generate_perm_trace_time_ms` |  22.50 |  90 |  27 |  18 |
| `perm_trace_commit_time_ms` |  64.36 |  257.45 |  70.69 |  55.28 |
| `quotient_poly_compute_time_ms` |  58.56 |  234.23 |  69.40 |  52.16 |
| `quotient_poly_commit_time_ms` |  14.96 |  59.86 |  17.91 |  12.31 |
| `pcs_opening_time_ms ` |  74 |  296 |  92 |  62 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 541 | 41 | 1 | 35 | 4,137,502 | 116.95 | 166 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 211 | 726 | 23,446,148 | 150,778,428 | 211 | 326 | 0 | 60.24 | 17.91 | 5 | 70.69 | 92 | 98 | 92 | 4 | 56 | 10,899,170 | 26 | 44 | 1,103,000 | 28.82 | 21 | 78 | 1 | 92 | 
| regex_program | 1 | 156 | 540 | 11,598,276 | 128,513,066 | 156 | 278 | 1 | 52.42 | 15.32 | 4 | 66.89 | 71 | 87 | 71 | 0 | 51 | 2,196,106 | 19 | 64 | 1,104,000 | 33.12 | 16 | 68 | 0 | 71 | 
| regex_program | 2 | 163 | 544 | 11,579,064 | 128,513,066 | 163 | 282 | 1 | 52.16 | 14.32 | 4 | 64.59 | 71 | 92 | 71 | 0 | 51 | 2,177,334 | 27 | 57 | 1,104,000 | 32.83 | 16 | 67 | 0 | 71 | 
| regex_program | 3 | 184 | 541 | 11,853,872 | 103,456,394 | 184 | 271 | 0 | 69.40 | 12.31 | 5 | 55.28 | 62 | 76 | 62 | 0 | 48 | 2,422,606 | 18 | 45 | 826,502 | 32.97 | 18 | 82 | 1 | 62 | 
...
Commit: https://github.com/openvm-org/openvm/commit/76ffe50e17313f012455161ac25becb8a23031bc
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19156555420)

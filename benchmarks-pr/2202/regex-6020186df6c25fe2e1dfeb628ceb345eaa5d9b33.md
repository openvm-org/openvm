...
|:---|---:|---:|
| Total |  2.35 |  0.73 |
| regex_program |  2.32 |  0.70 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  579.75 |  2,319 |  695 |  535 |
...
| `execute_metered_insn_mi/s` |  116.04 | -          |  116.04 |  116.04 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  53.75 |  215 |  66 |  45 |
| `execute_preflight_insn_mi/s` |  30.83 | -          |  32.16 |  27.86 |
| `trace_gen_time_ms   ` |  175.25 |  701 |  208 |  153 |
| `memory_finalize_time_ms` |  0.75 |  3 |  3 |  0 |
| `stark_prove_excluding_trace_time_ms` |  283.25 |  1,133 |  297 |  268 |
| `main_trace_commit_time_ms` |  51.50 |  206 |  57 |  49 |
| `generate_perm_trace_time_ms` |  25.25 |  101 |  35 |  19 |
| `perm_trace_commit_time_ms` |  64.58 |  258.32 |  71.28 |  55.42 |
| `quotient_poly_compute_time_ms` |  57.34 |  229.36 |  68.15 |  51.03 |
| `quotient_poly_commit_time_ms` |  14.54 |  58.14 |  16.45 |  12.56 |
| `pcs_opening_time_ms ` |  66.75 |  267 |  81 |  57 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 535 | 40 | 1 | 35 | 4,137,502 | 116.04 | 166 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 208 | 695 | 23,446,148 | 150,778,428 | 208 | 297 | 0 | 57.76 | 16.45 | 5 | 71.28 | 57 | 107 | 57 | 3 | 57 | 10,899,170 | 35 | 45 | 1,103,000 | 27.86 | 21 | 74 | 1 | 57 | 
| regex_program | 1 | 153 | 545 | 11,598,276 | 128,513,066 | 153 | 284 | 1 | 51.03 | 14.41 | 4 | 65.71 | 81 | 87 | 81 | 0 | 49 | 2,196,106 | 20 | 66 | 1,104,000 | 31.79 | 16 | 66 | 0 | 81 | 
| regex_program | 2 | 160 | 544 | 11,579,064 | 128,513,066 | 160 | 284 | 1 | 52.42 | 14.73 | 4 | 65.92 | 71 | 93 | 71 | 0 | 50 | 2,177,334 | 27 | 58 | 1,104,000 | 32.16 | 16 | 67 | 0 | 71 | 
| regex_program | 3 | 180 | 535 | 11,853,872 | 103,456,394 | 180 | 268 | 0 | 68.15 | 12.56 | 5 | 55.42 | 58 | 77 | 57 | 0 | 50 | 2,422,606 | 19 | 46 | 826,502 | 31.50 | 18 | 81 | 1 | 57 | 
...
Commit: https://github.com/openvm-org/openvm/commit/6020186df6c25fe2e1dfeb628ceb345eaa5d9b33
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19160048051)

...
| `total_proof_time_ms ` |  2,641.33 |  15,848 |  3,004 |  2,556 |
...
| `execute_preflight_insn_mi/s` |  18.92 | -          |  19.02 |  18.70 |
| `trace_gen_time_ms   ` |  393.50 |  2,361 |  545 |  351 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  2,009.17 |  12,055 |  2,272 |  1,954 |
| `prover.main_trace_commit_time_ms` |  697.50 |  4,185 |  854 |  665 |
| `prover.rap_constraints_time_ms` |  1,123.83 |  6,743 |  1,230 |  1,097 |
| `prover.openings_time_ms` |  186.67 |  1,120 |  192 |  183 |
| `prover.rap_constraints.logup_gkr_time_ms` |  276.17 |  1,657 |  383 |  254 |
| `prover.rap_constraints.round0_time_ms` |  525.83 |  3,155 |  529 |  522 |
| `prover.rap_constraints.mle_rounds_time_ms` |  320.83 |  1,925 |  323 |  319 |
| `prover.openings.stacked_reduction_time_ms` |  143.50 |  861 |  146 |  141 |
| `prover.openings.stacked_reduction.round0_time_ms` |  87.50 |  525 |  88 |  87 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  55.50 |  333 |  58 |  54 |
| `prover.openings.whir_time_ms` |  42.67 |  256 |  49 |  40 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,109 |  2,218 |  1,438 |  780 |
| `execute_preflight_time_ms` |  4.50 |  9 |  5 |  4 |
| `trace_gen_time_ms   ` |  138.50 |  277 |  187 |  90 |
| `generate_blob_total_time_ms` |  25.50 |  51 |  34 |  17 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  970 |  1,940 |  1,251 |  689 |
| `prover.main_trace_commit_time_ms` |  552.50 |  1,105 |  726 |  379 |
| `prover.rap_constraints_time_ms` |  312 |  624 |  399 |  225 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/bc53ae279ff18e948d79b63a34bc0786d93f3049/keccak-bc53ae279ff18e948d79b63a34bc0786d93f3049.memory.svg)
...
| app_proof |  |  |  |  |  | 2,561 |  |  | 37 | 1,235,218 | 33.25 | 0 | 15,893 |  | 
...
| app_proof | VmAirWrapper<Rv32LoadStoreAdapterAir, LoadStoreCoreAir<4> | 3 | 345 | 
...
| leaf | 0 | 187 | 1,438 | 186 | 65 | 34 | 5 | 7 | 7 | 
| leaf | 1 | 90 | 780 | 90 | 32 | 17 | 4 | 7 | 7 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 109,497,984 | 485 | 251 | 0 | 14 | 174 | 45 | 45 | 94 | 33 | 0 | 59 | 20 | 38 | 7 | 31 | 251 | 174 | 0 | 3 | 33 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 25,962,119 | 172 | 51 | 0 | 3 | 76 | 23 | 23 | 29 | 22 | 0 | 44 | 19 | 24 | 1 | 22 | 51 | 76 | 0 | 2 | 22 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 17,507,975 | 140 | 34 | 0 | 4 | 64 | 22 | 21 | 24 | 17 | 0 | 41 | 18 | 22 | 1 | 21 | 34 | 64 | 0 | 2 | 16 | 0 | 0 | 
| leaf | 0 | prover | 583,523,386 | 1,251 | 726 | 0 | 47 | 399 | 196 | 195 | 120 | 81 | 0 | 125 | 38 | 86 | 41 | 45 | 726 | 399 | 0 | 6 | 81 | 0 | 0 | 
| leaf | 1 | prover | 300,618,208 | 689 | 379 | 0 | 24 | 225 | 105 | 104 | 67 | 51 | 0 | 84 | 32 | 52 | 20 | 32 | 379 | 225 | 0 | 5 | 50 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,205,061,845 | 2,272 | 854 | 0 | 242 | 1,230 | 522 | 522 | 323 | 383 | 128 | 187 | 42 | 145 | 87 | 57 | 854 | 1,230 | 0 | 4 | 254 | 0 | 0 | 
| app_proof | prover | 1 | 1,205,053,652 | 1,956 | 666 | 0 | 51 | 1,097 | 523 | 522 | 319 | 254 | 0 | 192 | 49 | 143 | 88 | 54 | 666 | 1,097 | 0 | 4 | 253 | 0 | 0 | 
| app_proof | prover | 2 | 1,205,053,652 | 1,954 | 665 | 0 | 51 | 1,104 | 529 | 528 | 320 | 255 | 0 | 183 | 41 | 142 | 87 | 55 | 665 | 1,104 | 0 | 3 | 253 | 0 | 0 | 
| app_proof | prover | 3 | 1,205,053,652 | 1,957 | 666 | 0 | 51 | 1,104 | 527 | 527 | 321 | 255 | 0 | 186 | 44 | 141 | 87 | 54 | 666 | 1,104 | 0 | 3 | 254 | 0 | 0 | 
| app_proof | prover | 4 | 1,205,053,652 | 1,958 | 667 | 0 | 51 | 1,105 | 529 | 528 | 320 | 255 | 0 | 185 | 40 | 144 | 88 | 55 | 667 | 1,105 | 0 | 4 | 254 | 0 | 0 | 
| app_proof | prover | 5 | 1,205,062,652 | 1,958 | 667 | 0 | 52 | 1,103 | 525 | 525 | 322 | 255 | 0 | 187 | 40 | 146 | 88 | 58 | 667 | 1,103 | 0 | 4 | 254 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 545 | 3,004 | 545 | 170 | 0 | 194 | 15 | 207,000 | 18.70 | 
| app_proof | 1 | 351 | 2,609 | 351 | 41 | 0 | 1 | 260 | 207,000 | 19 | 
| app_proof | 2 | 359 | 2,556 | 359 | 41 | 0 | 10 | 201 | 207,000 | 18.88 | 
| app_proof | 3 | 358 | 2,557 | 358 | 41 | 0 | 10 | 201 | 207,000 | 18.97 | 
| app_proof | 4 | 361 | 2,561 | 361 | 41 | 0 | 11 | 201 | 207,000 | 18.93 | 
| app_proof | 5 | 387 | 2,561 | 387 | 41 | 0 | 37 | 174 | 200,218 | 19.02 | 

...
| `total_proof_time_ms ` |  2,591.67 |  15,550 |  2,954 |  2,502 |
...
| `execute_preflight_time_ms` |  175.67 |  1,054 |  262 |  15 |
| `execute_preflight_insn_mi/s` |  19.16 | -          |  19.27 |  19.05 |
| `trace_gen_time_ms   ` |  387.83 |  2,327 |  540 |  351 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,964.67 |  11,788 |  2,227 |  1,908 |
| `prover.main_trace_commit_time_ms` |  683 |  4,098 |  836 |  651 |
| `prover.rap_constraints_time_ms` |  1,099.67 |  6,598 |  1,207 |  1,076 |
| `prover.openings_time_ms` |  180.67 |  1,084 |  184 |  178 |
| `prover.rap_constraints.logup_gkr_time_ms` |  274.33 |  1,646 |  381 |  253 |
| `prover.rap_constraints.round0_time_ms` |  515.83 |  3,095 |  520 |  512 |
| `prover.rap_constraints.mle_rounds_time_ms` |  308.50 |  1,851 |  313 |  303 |
| `prover.openings.stacked_reduction_time_ms` |  138.33 |  830 |  142 |  136 |
| `prover.openings.stacked_reduction.round0_time_ms` |  83.67 |  502 |  85 |  83 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  53.83 |  323 |  56 |  53 |
| `prover.openings.whir_time_ms` |  41.83 |  251 |  47 |  39 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,091 |  2,182 |  1,416 |  766 |
| `execute_preflight_time_ms` |  4.50 |  9 |  5 |  4 |
| `trace_gen_time_ms   ` |  137.50 |  275 |  186 |  89 |
| `generate_blob_total_time_ms` |  25.50 |  51 |  34 |  17 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  952.50 |  1,905 |  1,229 |  676 |
| `prover.main_trace_commit_time_ms` |  540.50 |  1,081 |  711 |  370 |
| `prover.rap_constraints_time_ms` |  304.50 |  609 |  390 |  219 |
| `prover.openings_time_ms` |  107 |  214 |  128 |  86 |
| `prover.rap_constraints.logup_gkr_time_ms` |  66 |  132 |  81 |  51 |
| `prover.rap_constraints.round0_time_ms` |  144.50 |  289 |  188 |  101 |
...
| `prover.openings.whir_time_ms` |  38 |  76 |  41 |  35 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/4710d91acc638fbfa102e334aaf93c68fcbd685e/keccak-4710d91acc638fbfa102e334aaf93c68fcbd685e.memory.svg)
...
| app_proof |  |  |  |  |  | 2,516 |  |  | 37 | 1,235,218 | 33.28 | 0 | 15,595 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 39 | 517 | 39 | 13 | 4 | 2 | 2 | 2 | 
| internal_recursive.0 | 1 | 12 | 183 | 12 | 2 | 1 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 8 | 146 | 8 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 186 | 1,416 | 186 | 65 | 34 | 5 | 7 | 7 | 
| leaf | 1 | 89 | 766 | 89 | 32 | 17 | 4 | 7 | 7 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 109,497,984 | 477 | 245 | 0 | 14 | 173 | 45 | 44 | 94 | 33 | 0 | 58 | 19 | 38 | 7 | 30 | 245 | 173 | 0 | 2 | 32 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 25,962,119 | 170 | 51 | 0 | 3 | 75 | 23 | 23 | 29 | 22 | 0 | 43 | 19 | 23 | 2 | 21 | 51 | 75 | 0 | 2 | 21 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 17,507,975 | 137 | 33 | 0 | 3 | 64 | 21 | 21 | 24 | 18 | 0 | 38 | 16 | 22 | 1 | 20 | 34 | 64 | 0 | 2 | 17 | 0 | 0 | 
| leaf | 0 | prover | 583,523,386 | 1,229 | 710 | 0 | 47 | 390 | 188 | 188 | 119 | 81 | 0 | 128 | 41 | 86 | 41 | 45 | 711 | 390 | 0 | 6 | 80 | 0 | 0 | 
| leaf | 1 | prover | 300,618,208 | 676 | 370 | 0 | 24 | 219 | 101 | 100 | 66 | 51 | 0 | 86 | 35 | 51 | 19 | 31 | 370 | 219 | 0 | 6 | 49 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,205,061,845 | 2,227 | 836 | 0 | 237 | 1,207 | 512 | 512 | 313 | 381 | 126 | 183 | 41 | 142 | 85 | 56 | 836 | 1,207 | 0 | 3 | 253 | 0 | 0 | 
| app_proof | prover | 1 | 1,205,053,652 | 1,912 | 651 | 0 | 51 | 1,076 | 514 | 514 | 308 | 253 | 0 | 184 | 47 | 137 | 83 | 53 | 651 | 1,076 | 0 | 3 | 252 | 0 | 0 | 
| app_proof | prover | 2 | 1,205,053,652 | 1,908 | 653 | 0 | 51 | 1,076 | 513 | 513 | 309 | 253 | 0 | 178 | 40 | 137 | 83 | 53 | 653 | 1,076 | 0 | 3 | 252 | 0 | 0 | 
| app_proof | prover | 3 | 1,205,053,652 | 1,912 | 652 | 0 | 51 | 1,078 | 517 | 516 | 307 | 253 | 0 | 180 | 43 | 136 | 83 | 53 | 652 | 1,078 | 0 | 3 | 252 | 0 | 0 | 
| app_proof | prover | 4 | 1,205,053,652 | 1,909 | 652 | 0 | 51 | 1,076 | 519 | 519 | 303 | 253 | 0 | 179 | 39 | 139 | 84 | 54 | 652 | 1,076 | 0 | 3 | 251 | 0 | 0 | 
| app_proof | prover | 5 | 1,205,062,652 | 1,920 | 654 | 0 | 52 | 1,085 | 520 | 519 | 311 | 253 | 0 | 180 | 41 | 139 | 84 | 54 | 654 | 1,085 | 0 | 3 | 252 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 540 | 2,954 | 540 | 170 | 0 | 188 | 15 | 207,000 | 19.05 | 
| app_proof | 1 | 351 | 2,567 | 351 | 41 | 0 | 1 | 262 | 207,000 | 19.26 | 
| app_proof | 2 | 352 | 2,502 | 352 | 41 | 0 | 2 | 201 | 207,000 | 19.27 | 
| app_proof | 3 | 353 | 2,507 | 353 | 41 | 0 | 3 | 201 | 207,000 | 19.12 | 
| app_proof | 4 | 352 | 2,504 | 352 | 41 | 0 | 3 | 201 | 207,000 | 19.13 | 
| app_proof | 5 | 379 | 2,516 | 379 | 41 | 0 | 30 | 174 | 200,218 | 19.17 | 

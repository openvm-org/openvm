...
|:---|---:|---:|---:|
| Total |  3.18 |  2.21 |  2.21 |
| app_proof |  2.39 |  1.42 |  1.42 |
| leaf |  0.42 |  0.42 |  0.42 |
...
| `total_proof_time_ms ` |  1,190.50 |  2,381 |  1,418 |  963 |
| `execute_metered_time_ms` |  7 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  19.66 | -          |  19.66 |  19.66 |
| `execute_preflight_insns` |  77,381.50 |  154,763 |  121,000 |  33,763 |
| `execute_preflight_time_ms` |  74 |  148 |  128 |  20 |
| `execute_preflight_insn_mi/s` |  8.55 | -          |  11.29 |  5.81 |
| `trace_gen_time_ms   ` |  158.50 |  317 |  189 |  128 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  845 |  1,690 |  1,024 |  666 |
| `prover.main_trace_commit_time_ms` |  221 |  442 |  293 |  149 |
| `prover.rap_constraints_time_ms` |  561 |  1,122 |  657 |  465 |
| `prover.openings_time_ms` |  61.50 |  123 |  73 |  50 |
| `prover.rap_constraints.logup_gkr_time_ms` |  141.50 |  283 |  154 |  129 |
| `prover.rap_constraints.round0_time_ms` |  286.50 |  573 |  363 |  210 |
| `prover.rap_constraints.mle_rounds_time_ms` |  133 |  266 |  140 |  126 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/4710d91acc638fbfa102e334aaf93c68fcbd685e/kitchen_sink-4710d91acc638fbfa102e334aaf93c68fcbd685e.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 66 | 3 |  |  | 0 |  | 323 | 3 |  |  |  |  |  |  | 
| app_proof |  |  |  |  |  | 963 |  |  | 7 | 154,763 | 19.66 | 0 | 2,394 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 53,472,003 | 140 | 40 | 0 | 4 | 64 | 19 | 19 | 29 | 15 | 0 | 34 | 10 | 23 | 1 | 22 | 41 | 64 | 0 | 1 | 15 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 23,651,975 | 100 | 19 | 0 | 4 | 51 | 17 | 16 | 20 | 13 | 0 | 29 | 7 | 21 | 1 | 20 | 19 | 51 | 0 | 1 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 17,507,975 | 95 | 14 | 0 | 4 | 49 | 17 | 16 | 18 | 13 | 0 | 31 | 9 | 21 | 0 | 20 | 15 | 49 | 0 | 1 | 12 | 0 | 0 | 
| leaf | 0 | prover | 407,935,872 | 310 | 123 | 0 | 9 | 141 | 45 | 44 | 36 | 59 | 0 | 44 | 13 | 31 | 6 | 24 | 123 | 141 | 0 | 2 | 59 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 816,542,084 | 1,024 | 293 | 0 | 164 | 657 | 363 | 361 | 140 | 154 | 62 | 73 | 12 | 60 | 15 | 44 | 293 | 657 | 0 | 1 | 90 | 0 | 0 | 
| app_proof | prover | 1 | 800,298,548 | 666 | 149 | 0 | 20 | 465 | 210 | 209 | 126 | 129 | 75 | 50 | 13 | 37 | 14 | 22 | 149 | 465 | 0 | 1 | 53 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 189 | 1,418 | 189 | 183 | 0 | 50 | 20 | 121,000 | 11.29 | 
| app_proof | 1 | 128 | 963 | 128 | 40 | 0 | 3 | 128 | 33,763 | 5.81 | 

...
|:---|---:|---:|---:|
| Total |  9.55 |  3.42 |  3.42 |
| app_proof |  7.48 |  1.84 |  1.84 |
| leaf |  1.50 |  1.01 |  1.01 |
...
| `total_proof_time_ms ` |  1,224.83 |  7,349 |  1,340 |  1,184 |
...
| `execute_preflight_time_ms` |  80 |  480 |  107 |  72 |
| `execute_preflight_insn_mi/s` |  29.93 | -          |  32.18 |  22.54 |
| `postflight_time_ms  ` |  26 |  156 |  29 |  25 |
| `postflight_memory_chronology_time_ms` |  2 |  12 |  2 |  2 |
| `postflight_program_index_time_ms` |  0 |  0 |  0 |  0 |
| `trace_gen_time_ms   ` |  12.50 |  75 |  17 |  11 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,091.17 |  6,547 |  1,170 |  1,061 |
| `prover.main_trace_commit_time_ms` |  337.67 |  2,026 |  355 |  330 |
| `prover.rap_constraints_time_ms` |  511.67 |  3,070 |  514 |  509 |
| `prover.openings_time_ms` |  240.33 |  1,442 |  303 |  221 |
| `prover.rap_constraints.logup_gkr_time_ms` |  104.50 |  627 |  106 |  103 |
| `prover.rap_constraints.round0_time_ms` |  283 |  1,698 |  284 |  282 |
...
| `prover.openings.whir_time_ms` |  179 |  1,074 |  242 |  160 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  752.50 |  1,505 |  1,009 |  496 |
| `execute_preflight_time_ms` |  4 |  8 |  4 |  4 |
| `trace_gen_time_ms   ` |  134.50 |  269 |  180 |  89 |
| `generate_blob_total_time_ms` |  15.50 |  31 |  21 |  10 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  617.50 |  1,235 |  829 |  406 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/c144dcbae4b38d6040ef069626cfa4c9aad72c41/keccak-c144dcbae4b38d6040ef069626cfa4c9aad72c41.memory.svg)
...
| internal_recursive.0 | 1 | 13 | 133 | 12 | 2 | 0 | 2 | 2 | 2 | 
| internal_recursive.1 | 1 | 10 | 109 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 180 | 1,009 | 179 | 57 | 21 | 4 | 10 | 10 | 
| leaf | 1 | 89 | 496 | 88 | 29 | 10 | 4 | 10 | 10 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 81,415,160 | 288 | 93 | 0 | 0 | 114 | 39 | 38 | 56 | 18 | 0 | 80 | 65 | 15 | 5 | 10 | 93 | 93 | 114 | 0 | 1 | 17 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,945 | 120 | 21 | 0 | 0 | 60 | 21 | 20 | 24 | 14 | 0 | 38 | 30 | 7 | 1 | 6 | 21 | 21 | 60 | 0 | 1 | 12 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 99 | 15 | 0 | 0 | 53 | 20 | 19 | 21 | 10 | 0 | 30 | 23 | 7 | 1 | 5 | 15 | 15 | 52 | 0 | 1 | 10 | 0 | 0 | 
| leaf | 0 | prover | 476,578,798 | 829 | 382 | 0 | 0 | 234 | 121 | 120 | 71 | 41 | 0 | 211 | 174 | 37 | 20 | 17 | 383 | 382 | 234 | 0 | 3 | 40 | 0 | 0 | 
| leaf | 1 | prover | 240,255,800 | 406 | 146 | 0 | 0 | 142 | 70 | 69 | 44 | 26 | 0 | 117 | 95 | 22 | 10 | 11 | 146 | 146 | 141 | 0 | 3 | 25 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover |  | 0 | 830,158,476 | 1,170 | 355 | 0 | 52 | 511 | 282 | 282 | 123 | 104 | 0 | 303 | 242 | 61 | 36 | 24 | 355 | 355 | 511 | 0 | 1 | 103 | 0 | 0 | 
| app_proof | prover |  | 1 | 830,158,476 | 1,083 | 335 | 0 | 0 | 511 | 283 | 282 | 123 | 104 | 0 | 235 | 173 | 62 | 37 | 25 | 335 | 335 | 511 | 0 | 1 | 103 | 0 | 0 | 
| app_proof | prover |  | 2 | 830,158,476 | 1,075 | 334 | 0 | 0 | 514 | 284 | 284 | 123 | 106 | 0 | 225 | 164 | 61 | 36 | 24 | 334 | 334 | 514 | 0 | 1 | 105 | 0 | 0 | 
| app_proof | prover |  | 3 | 830,158,476 | 1,079 | 336 | 0 | 0 | 513 | 283 | 283 | 123 | 106 | 0 | 228 | 167 | 61 | 36 | 24 | 336 | 336 | 513 | 0 | 1 | 105 | 0 | 0 | 
| app_proof | prover |  | 4 | 830,158,476 | 1,079 | 336 | 0 | 0 | 512 | 283 | 282 | 124 | 104 | 0 | 230 | 168 | 62 | 37 | 24 | 336 | 336 | 512 | 0 | 1 | 104 | 0 | 0 | 
| app_proof | prover |  | 5 | 819,934,860 | 1,061 | 330 | 0 | 0 | 509 | 283 | 282 | 123 | 103 | 0 | 221 | 160 | 60 | 36 | 24 | 330 | 330 | 509 | 0 | 1 | 102 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof |  | 1,184 | 127 | 14,365,133 | 112.59 | 0 | 7,486 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof |  | 0 | 0 | 2 | 17 | 1,340 | 3 | 0 | 0 | 29 | 0 | 2 | 0 | 9,337,486,584 | 624,415,128 | 9,961,901,712 | 2,097,152 | 2 | 0 | 0 | 3 | 14 | 107 | 2,413,000 | 22.54 | 0 | 0 | 
| app_proof |  | 1 | 0 | 2 | 12 | 1,215 | 2 | 0 | 0 | 27 | 0 | 2 | 0 | 9,337,793,604 | 625,029,708 | 9,962,823,312 | 2,097,152 | 2 | 0 | 0 | 2 | 9 | 77 | 2,413,000 | 30.96 | 0 | 0 | 
| app_proof |  | 2 | 0 | 2 | 12 | 1,201 | 2 | 0 | 0 | 25 | 0 | 2 | 0 | 9,337,030,356 | 625,792,956 | 9,962,823,312 | 2,097,152 | 2 | 0 | 0 | 2 | 9 | 75 | 2,413,000 | 31.99 | 0 | 0 | 
| app_proof |  | 3 | 0 | 2 | 11 | 1,204 | 2 | 0 | 0 | 25 | 0 | 2 | 0 | 9,337,792,860 | 625,030,452 | 9,962,823,312 | 2,097,152 | 2 | 0 | 0 | 2 | 9 | 74 | 2,413,000 | 32.18 | 0 | 0 | 
| app_proof |  | 4 | 0 | 2 | 12 | 1,205 | 2 | 0 | 0 | 25 | 0 | 2 | 0 | 9,337,030,236 | 625,793,076 | 9,962,823,312 | 2,097,152 | 2 | 0 | 0 | 2 | 9 | 75 | 2,413,000 | 31.99 | 0 | 0 | 
| app_proof |  | 5 | 0 | 2 | 11 | 1,184 | 2 | 0 | 0 | 25 | 0 | 2 | 0 | 8,903,917,596 | 936,222,324 | 9,840,139,920 | 2,097,152 | 2 | 0 | 0 | 2 | 8 | 72 | 2,300,133 | 31.64 | 0 | 0 | 

...
|:---|---:|---:|---:|
| Total |  3.50 |  3.03 |  3.03 |
| app_proof |  2.58 |  2.11 |  2.11 |
| leaf |  0.55 |  0.55 |  0.55 |
...
| `total_proof_time_ms ` |  1,272.50 |  2,545 |  2,074 |  471 |
| `execute_metered_time_ms` |  34 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  74.97 | -          |  74.97 |  74.97 |
| `execute_preflight_insns` |  1,290,013 |  2,580,026 |  2,020,000 |  560,026 |
| `execute_preflight_time_ms` |  85.50 |  171 |  86 |  85 |
| `execute_preflight_insn_mi/s` |  34.96 | -          |  35.77 |  34.16 |
| `trace_gen_time_ms   ` |  57 |  114 |  94 |  20 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,011 |  2,022 |  1,699 |  323 |
| `prover.main_trace_commit_time_ms` |  310 |  620 |  538 |  82 |
| `prover.rap_constraints_time_ms` |  632 |  1,264 |  1,061 |  203 |
| `prover.openings_time_ms` |  68.50 |  137 |  99 |  38 |
| `prover.rap_constraints.logup_gkr_time_ms` |  174 |  348 |  305 |  43 |
| `prover.rap_constraints.round0_time_ms` |  357.50 |  715 |  603 |  112 |
| `prover.rap_constraints.mle_rounds_time_ms` |  99.50 |  199 |  152 |  47 |
| `prover.openings.stacked_reduction_time_ms` |  54.50 |  109 |  83 |  26 |
| `prover.openings.stacked_reduction.round0_time_ms` |  16.50 |  33 |  26 |  7 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  37 |  74 |  56 |  18 |
...
| `execute_preflight_time_ms` |  32 |  32 |  32 |  32 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/c03ed4ddbf9cb1c2761086f87ae40296b4fc382d/kitchen_sink-c03ed4ddbf9cb1c2761086f87ae40296b4fc382d.memory.svg)

| Module | Max (GB) | Max At |
| --- | ---: | --- |
| prover.rap_constraints | 16.63 | app_proof.prover.0 |
| prover.batch_constraints.before_round0 | 15.65 | app_proof.prover.0 |
| frac_sumcheck.gkr_rounds | 15.65 | app_proof.prover.0 |
| prover.gkr_input_evals | 15.63 | app_proof.prover.0 |
| frac_sumcheck.segment_tree | 15.63 | app_proof.prover.0 |
| prover.openings | 14.78 | app_proof.prover.0 |
| prover.merkle_tree | 14.78 | app_proof.prover.0 |
| prover.prove_whir_opening | 14.78 | app_proof.prover.0 |
| prover.batch_constraints.fold_ple_evals | 14.15 | app_proof.prover.0 |
| prover.batch_constraints.round0 | 14.15 | app_proof.prover.0 |
| prover.before_gkr_input_evals | 11.52 | app_proof.prover.0 |
| prover.stacked_commit | 11.52 | app_proof.prover.0 |
| prover.rs_code_matrix | 11.50 | app_proof.prover.0 |
| generate mem proving ctxs | 5.46 | app_proof.0 |
| set initial memory | 5.45 | app_proof.1 |
| tracegen.pow_checker | 2.15 | leaf.0 |
| tracegen.exp_bits_len | 2.15 | leaf.0 |
| tracegen.whir_final_poly_query_eval | 2.15 | leaf.0 |
...
| tracegen.proof_shape | 1.89 | leaf.0 |
| tracegen.range_checker | 1.89 | leaf.0 |
| tracegen.public_values | 1.89 | leaf.0 |
...
| --- | --- | --- | --- | --- | --- | --- |
| 1,158 | 3 | 0 | 264,807 | 226,814 | 3 | 64 | 
...
| VmAirWrapper<Rv32VecHeapAdapterAir<1, 24, 24, 4, 4>, FieldExpressionCoreAir> | 2,008 | 1,058 | 2 | 
| VmAirWrapper<Rv32VecHeapAdapterAir<1, 36, 36, 4, 4>, FieldExpressionCoreAir> | 2,086 | 1,143 | 2 | 
| VmAirWrapper<Rv32VecHeapAdapterAir<2, 12, 12, 4, 4>, FieldExpressionCoreAir> | 354 | 189 | 3 | 
| VmAirWrapper<Rv32VecHeapAdapterAir<2, 16, 16, 4, 4>, FieldExpressionCoreAir> | 467 | 218 | 3 | 
| VmAirWrapper<Rv32VecHeapAdapterAir<2, 24, 24, 4, 4>, FieldExpressionCoreAir> | 2,043 | 1,050 | 3 | 
| VmAirWrapper<Rv32VecHeapAdapterAir<2, 36, 36, 4, 4>, FieldExpressionCoreAir> | 2,764 | 1,469 | 2 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 75 | 3 |  |  | 0 |  | 358 | 3 |  |  |  |  |  |  | 
| app_proof |  |  |  |  |  | 471 |  |  | 34 | 2,580,026 | 74.97 | 0 | 2,584 |  | 
...
| app_proof | VmAirWrapper<Rv32VecHeapAdapterAir<1, 36, 36, 4, 4>, FieldExpressionCoreAir> | 0 | 0 | 
...
| app_proof | VmAirWrapper<Rv32VecHeapAdapterAir<2, 36, 36, 4, 4>, FieldExpressionCoreAir> | 0 | 0 | 
...
| app_proof | VmAirWrapper<Rv32RdWriteAdapterAir, Rv32AuipcCoreAir> | 1 | 2 | 
...
| leaf | 26 | OpeningClaimsAir | 0 | prover | 65,536 | 63 | 9,895,936 | 
...
| leaf | 3 | SymbolicExpressionAir<BabyBearParameters> | 0 | prover | 1,048,576 | 60 | 281,018,368 | 
...
| leaf | 8 | Eq3bAir | 0 | prover | 1,048,576 | 25 | 38,797,312 | 
...
| app_proof | 10 | VmAirWrapper<Rv32VecHeapAdapterAir<1, 24, 24, 4, 4>, FieldExpressionCoreAir> | prover | 0 | 2 | 1,485 | 13,634 | 
| app_proof | 11 | VmAirWrapper<Rv32VecHeapAdapterAir<2, 24, 24, 4, 4>, FieldExpressionCoreAir> | prover | 0 | 2 | 1,950 | 17,684 | 
...
| app_proof | 22 | VmAirWrapper<Rv32IsEqualModAdapterAir<2, 12, 4, 48>, ModularIsEqualCoreAir<48, 4, 8> | prover | 0 | 2 | 296 | 1,496 | 
| app_proof | 23 | VmAirWrapper<Rv32VecHeapAdapterAir<2, 12, 12, 4, 4>, FieldExpressionCoreAir> | prover | 0 | 2 | 474 | 3,780 | 
| app_proof | 24 | VmAirWrapper<Rv32VecHeapAdapterAir<2, 12, 12, 4, 4>, FieldExpressionCoreAir> | prover | 0 | 2 | 378 | 2,820 | 
...
| app_proof | 28 | VmAirWrapper<Rv32IsEqualModAdapterAir<2, 8, 4, 32>, ModularIsEqualCoreAir<32, 4, 8> | prover | 0 | 2 | 208 | 1,064 | 
...
| app_proof | 30 | VmAirWrapper<Rv32VecHeapAdapterAir<2, 8, 8, 4, 4>, FieldExpressionCoreAir> | prover | 0 | 2 | 262 | 1,948 | 
...
| app_proof | 34 | VmAirWrapper<Rv32IsEqualModAdapterAir<2, 8, 4, 32>, ModularIsEqualCoreAir<32, 4, 8> | prover | 0 | 2 | 208 | 1,064 | 
| app_proof | 35 | VmAirWrapper<Rv32VecHeapAdapterAir<2, 8, 8, 4, 4>, FieldExpressionCoreAir> | prover | 0 | 2 | 326 | 2,588 | 
| app_proof | 36 | VmAirWrapper<Rv32VecHeapAdapterAir<2, 8, 8, 4, 4>, FieldExpressionCoreAir> | prover | 0 | 2 | 262 | 1,948 | 
...
| app_proof | 4 | VmAirWrapper<Rv32VecHeapAdapterAir<1, 36, 36, 4, 4>, FieldExpressionCoreAir> | prover | 0 | 2 | 2,310 | 21,308 | 
| app_proof | 40 | VmAirWrapper<Rv32IsEqualModAdapterAir<2, 8, 4, 32>, ModularIsEqualCoreAir<32, 4, 8> | prover | 0 | 2 | 208 | 1,064 | 
| app_proof | 41 | VmAirWrapper<Rv32VecHeapAdapterAir<2, 8, 8, 4, 4>, FieldExpressionCoreAir> | prover | 0 | 2 | 326 | 2,588 | 
| app_proof | 42 | VmAirWrapper<Rv32VecHeapAdapterAir<2, 8, 8, 4, 4>, FieldExpressionCoreAir> | prover | 0 | 2 | 262 | 1,948 | 
...
| app_proof | 5 | VmAirWrapper<Rv32VecHeapAdapterAir<2, 36, 36, 4, 4>, FieldExpressionCoreAir> | prover | 0 | 2 | 3,099 | 28,310 | 
...
| app_proof | 6 | VmAirWrapper<Rv32VecHeapAdapterAir<1, 24, 24, 4, 4>, FieldExpressionCoreAir> | prover | 0 | 2 | 1,485 | 13,634 | 
...
| app_proof | 7 | VmAirWrapper<Rv32VecHeapAdapterAir<2, 24, 24, 4, 4>, FieldExpressionCoreAir> | prover | 0 | 2 | 1,950 | 17,684 | 
...
| app_proof | 8 | VmAirWrapper<Rv32VecHeapAdapterAir<1, 24, 24, 4, 4>, FieldExpressionCoreAir> | prover | 0 | 2 | 2,160 | 20,384 | 
| app_proof | 9 | VmAirWrapper<Rv32VecHeapAdapterAir<2, 24, 24, 4, 4>, FieldExpressionCoreAir> | prover | 0 | 2 | 2,270 | 20,884 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 19 | 162 | 19 | 6 | 2 | 2 | 2 | 2 | 
| internal_recursive.0 | 1 | 11 | 113 | 10 | 1 | 0 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 8 | 102 | 8 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 150 | 548 | 149 | 27 | 12 | 32 | 2 | 2 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 58,092,291 | 142 | 42 | 0 | 4 | 66 | 19 | 19 | 31 | 15 | 0 | 32 | 8 | 23 | 1 | 21 | 43 | 66 | 0 | 1 | 14 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 23,651,975 | 102 | 19 | 0 | 4 | 51 | 17 | 16 | 20 | 13 | 0 | 31 | 9 | 21 | 1 | 20 | 19 | 51 | 0 | 1 | 12 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 17,507,975 | 93 | 14 | 0 | 4 | 49 | 16 | 16 | 18 | 13 | 0 | 29 | 8 | 21 | 0 | 20 | 15 | 48 | 0 | 1 | 12 | 0 | 0 | 
| leaf | 0 | prover | 593,173,376 | 398 | 149 | 0 | 11 | 202 | 56 | 55 | 42 | 102 | 0 | 45 | 12 | 33 | 8 | 25 | 150 | 202 | 0 | 2 | 101 | 0 | 0 | 

| group | idx | phase | trace_height_constraint | weighted_sum | threshold |
| --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 0 | 4,149,506 | 2,013,265,921 | 
| internal_recursive.0 | 1 | prover | 0 | 2,068,318 | 2,013,265,921 | 
| internal_recursive.1 | 1 | prover | 0 | 1,939,294 | 2,013,265,921 | 
| leaf | 0 | prover | 0 | 70,384,451 | 2,013,265,921 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,221,325,550 | 1,699 | 537 | 0 | 322 | 1,061 | 603 | 601 | 152 | 305 | 144 | 99 | 16 | 83 | 26 | 56 | 538 | 1,061 | 0 | 1 | 159 | 0 | 0 | 
| app_proof | prover | 1 | 370,741,140 | 323 | 82 | 0 | 17 | 203 | 112 | 111 | 47 | 43 | 0 | 38 | 11 | 26 | 7 | 18 | 82 | 203 | 0 | 1 | 42 | 0 | 0 | 

| group | phase | segment | trace_height_constraint | weighted_sum | threshold |
| --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 0 | 69,909,824 | 2,013,265,921 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 94 | 2,074 | 94 | 193 | 0 | 3 | 86 | 2,020,000 | 34.16 | 
| app_proof | 1 | 20 | 471 | 20 | 40 | 0 | 1 | 85 | 560,026 | 35.77 | 

...
|:---|---:|---:|---:|
| Total |  3.45 |  2.98 |  2.98 |
| app_proof |  2.53 |  2.07 |  2.07 |
| leaf |  0.54 |  0.54 |  0.54 |
...
| `total_proof_time_ms ` |  1,249.50 |  2,499 |  2,035 |  464 |
| `execute_metered_time_ms` |  34 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  75.38 | -          |  75.38 |  75.38 |
| `execute_preflight_insns` |  1,290,013 |  2,580,026 |  2,020,000 |  560,026 |
| `execute_preflight_time_ms` |  83 |  166 |  85 |  81 |
| `execute_preflight_insn_mi/s` |  34.37 | -          |  35.73 |  33.01 |
| `trace_gen_time_ms   ` |  56.50 |  113 |  93 |  20 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  994.50 |  1,989 |  1,668 |  321 |
| `prover.main_trace_commit_time_ms` |  303 |  606 |  524 |  82 |
| `prover.rap_constraints_time_ms` |  621.50 |  1,243 |  1,043 |  200 |
| `prover.openings_time_ms` |  68.50 |  137 |  100 |  37 |
| `prover.rap_constraints.logup_gkr_time_ms` |  169 |  338 |  296 |  42 |
| `prover.rap_constraints.round0_time_ms` |  354 |  708 |  597 |  111 |
| `prover.rap_constraints.mle_rounds_time_ms` |  98 |  196 |  149 |  47 |
| `prover.openings.stacked_reduction_time_ms` |  55 |  110 |  84 |  26 |
| `prover.openings.stacked_reduction.round0_time_ms` |  17 |  34 |  27 |  7 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  543 |  543 |  543 |  543 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/7cba12f9fd1140139a73223dfbaa5541c1786a5d/kitchen_sink-7cba12f9fd1140139a73223dfbaa5541c1786a5d.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- |
| 1,098 | 3 | 0 | 264,807 | 227,215 | 3 | 64 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 78 | 3 |  |  | 0 |  | 371 | 3 |  |  |  |  |  |  | 
| app_proof |  |  |  |  |  | 464 |  |  | 34 | 2,580,026 | 75.38 | 0 | 2,538 |  | 
...
| internal_recursive.0 | 1 | 9 | 110 | 9 | 1 | 0 | 2 | 0 | 0 | 
| internal_recursive.1 | 1 | 8 | 101 | 8 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 146 | 543 | 146 | 26 | 12 | 32 | 2 | 2 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 58,092,291 | 142 | 42 | 0 | 4 | 66 | 19 | 19 | 30 | 15 | 0 | 32 | 8 | 23 | 1 | 21 | 43 | 66 | 0 | 1 | 15 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 23,651,975 | 100 | 19 | 0 | 4 | 50 | 17 | 16 | 20 | 13 | 0 | 30 | 8 | 21 | 1 | 20 | 19 | 50 | 0 | 1 | 12 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 17,507,975 | 92 | 14 | 0 | 4 | 48 | 16 | 16 | 18 | 13 | 0 | 29 | 7 | 21 | 0 | 20 | 14 | 48 | 0 | 1 | 12 | 0 | 0 | 
| leaf | 0 | prover | 593,173,376 | 397 | 149 | 0 | 11 | 201 | 56 | 55 | 42 | 102 | 0 | 46 | 12 | 33 | 8 | 24 | 149 | 201 | 0 | 2 | 101 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,221,325,550 | 1,668 | 523 | 0 | 306 | 1,043 | 597 | 595 | 149 | 296 | 134 | 100 | 16 | 84 | 27 | 56 | 524 | 1,042 | 0 | 1 | 160 | 0 | 0 | 
| app_proof | prover | 1 | 370,741,140 | 321 | 82 | 0 | 17 | 200 | 111 | 110 | 47 | 42 | 0 | 37 | 11 | 26 | 7 | 18 | 82 | 200 | 0 | 1 | 42 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 93 | 2,035 | 93 | 188 | 0 | 3 | 85 | 2,020,000 | 33.01 | 
| app_proof | 1 | 20 | 464 | 20 | 40 | 0 | 1 | 81 | 560,026 | 35.73 | 

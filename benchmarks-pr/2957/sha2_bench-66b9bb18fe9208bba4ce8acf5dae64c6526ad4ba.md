...
|:---|---:|---:|---:|
| Total |  4.96 |  3.37 |  3.37 |
| app_proof |  4.01 |  2.42 |  2.42 |
| leaf |  0.52 |  0.52 |  0.52 |
...
| `total_proof_time_ms ` |  1,975.50 |  3,951 |  2,366 |  1,585 |
| `compile_metered_time_ms` |  5 |  5 |  5 |  5 |
| `execute_metered_time_ms` |  56 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  196.28 | -          |  196.28 |  196.28 |
| `execute_preflight_insns` |  5,583,980.50 |  11,167,961 |  7,136,000 |  4,031,961 |
| `execute_preflight_time_ms` |  342.50 |  685 |  475 |  210 |
| `execute_preflight_insn_mi/s` |  35.82 | -          |  36.58 |  35.06 |
| `trace_gen_time_ms   ` |  72 |  144 |  101 |  43 |
| `set_initial_memory_time_ms` |  0 |  0 |  0 |  0 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,559 |  3,118 |  2,053 |  1,065 |
| `prover.main_trace_commit_time_ms` |  392.50 |  785 |  570 |  215 |
| `prover.rap_constraints_time_ms` |  898.50 |  1,797 |  1,138 |  659 |
| `prover.openings_time_ms` |  267 |  534 |  344 |  190 |
| `prover.rap_constraints.logup_gkr_time_ms` |  207.50 |  415 |  231 |  184 |
| `prover.rap_constraints.round0_time_ms` |  510.50 |  1,021 |  673 |  348 |
...
| `prover.openings.whir_time_ms` |  194 |  388 |  250 |  138 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/66b9bb18fe9208bba4ce8acf5dae64c6526ad4ba/sha2_bench-66b9bb18fe9208bba4ce8acf5dae64c6526ad4ba.memory.svg)
...
| 39 | VmAirWrapper<Rv64RegBaseAluU16AdapterAir, AddSubCoreAir<4, 16> |  | 19 | 14 | 3 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 57 |  |  |  | 288 |  |  |  |  |  |  | 
| app_proof |  |  |  | 1,585 |  | 56 | 11,167,961 | 196.28 | 0 | 4,016 |  | 
...
| app_proof | VmAirWrapper<Rv64ImmBaseAluU16AdapterAir, AddICoreAir<4, 16> | 32 | VmAirWrapper<Rv64ImmBaseAluU16AdapterAir, AddICoreAir<4, 16> | 0 | 46,285,580 | 
...
| app_proof | VmAirWrapper<Rv64RegBaseAluU16AdapterAir, AddSubCoreAir<4, 16> | 8 | VmAirWrapper<Rv64RegBaseAluU16AdapterAir, AddSubCoreAir<4, 16> | 0 | 62,911,500 | 
...
| app_proof | VmAirWrapper<Rv64ImmBaseAluU16AdapterAir, AddICoreAir<4, 16> | 32 | VmAirWrapper<Rv64ImmBaseAluU16AdapterAir, AddICoreAir<4, 16> | 1 | 26,152,192 | 
...
| app_proof | VmAirWrapper<Rv64RegBaseAluU16AdapterAir, AddSubCoreAir<4, 16> | 8 | VmAirWrapper<Rv64RegBaseAluU16AdapterAir, AddSubCoreAir<4, 16> | 1 | 35,547,720 | 
...
| app_proof | VmAirWrapper<Rv64ImmBaseAluU16AdapterAir, AddICoreAir<4, 16> | 0 |  | 12 | 
...
| app_proof | VmAirWrapper<Rv64RegBaseAluU16AdapterAir, AddSubCoreAir<4, 16> | 0 |  | 8 | 
...
| app_proof | VmAirWrapper<Rv64ImmBaseAluU16AdapterAir, AddICoreAir<4, 16> | 1 |  | 17 | 
...
| app_proof | VmAirWrapper<Rv64RegBaseAluU16AdapterAir, AddSubCoreAir<4, 16> | 1 |  | 3 | 
...
| app_proof | 15 | VmAirWrapper<Rv64ImmBaseAluU16AdapterAir, AddICoreAir<4, 16> | ADDI | 0 | 1,051,945 | 
...
| app_proof | 39 | VmAirWrapper<Rv64RegBaseAluU16AdapterAir, AddSubCoreAir<4, 16> | ADD | 0 | 734,457 | 
| app_proof | 39 | VmAirWrapper<Rv64RegBaseAluU16AdapterAir, AddSubCoreAir<4, 16> | SUB | 0 | 314,068 | 
...
| app_proof | 15 | VmAirWrapper<Rv64ImmBaseAluU16AdapterAir, AddICoreAir<4, 16> | ADDI | 1 | 594,368 | 
...
| app_proof | 39 | VmAirWrapper<Rv64RegBaseAluU16AdapterAir, AddSubCoreAir<4, 16> | ADD | 1 | 415,000 | 
| app_proof | 39 | VmAirWrapper<Rv64RegBaseAluU16AdapterAir, AddSubCoreAir<4, 16> | SUB | 1 | 177,462 | 
...
| app_proof | 39 | VmAirWrapper<Rv64RegBaseAluU16AdapterAir, AddSubCoreAir<4, 16> | prover | 0 | 1,048,576 | 32 | 33,554,432 | 
...
| app_proof | 39 | VmAirWrapper<Rv64RegBaseAluU16AdapterAir, AddSubCoreAir<4, 16> | prover | 1 | 1,048,576 | 32 | 33,554,432 | 
...
| app_proof | 15 | VmAirWrapper<Rv64ImmBaseAluU16AdapterAir, AddICoreAir<4, 16> | 0 | 1,051,945 | 1,045,207 | 65,746,563 | 65,325,437 | 105,194,500 | 104,520,700 | 26,298,625 | 26,130,175 | 610,128,100 | 606,220,060 | 16,831,120 | 16,723,312 | 
...
| app_proof | 39 | VmAirWrapper<Rv64RegBaseAluU16AdapterAir, AddSubCoreAir<4, 16> | 0 | 1,048,525 | 51 | 83,882,000 | 4,080 | 134,211,200 | 6,528 | 33,552,800 | 1,632 | 722,171,594 | 35,126 | 19,921,975 | 969 | 
...
| app_proof | 15 | VmAirWrapper<Rv64ImmBaseAluU16AdapterAir, AddICoreAir<4, 16> | 1 | 594,368 | 454,208 | 37,148,000 | 28,388,000 | 59,436,800 | 45,420,800 | 14,859,200 | 11,355,200 | 344,733,440 | 263,440,640 | 9,509,888 | 7,267,328 | 
...
| app_proof | 39 | VmAirWrapper<Rv64RegBaseAluU16AdapterAir, AddSubCoreAir<4, 16> | 1 | 592,462 | 456,114 | 47,396,960 | 36,489,120 | 75,835,136 | 58,382,592 | 18,958,784 | 14,595,648 | 408,058,203 | 314,148,517 | 11,256,778 | 8,666,166 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 175 | 47 | 0 | 0 | 79 | 27 | 27 | 37 | 13 | 0 | 48 | 38 | 10 | 2 | 7 | 47 | 47 | 79 | 0 | 1 | 12 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 107 | 20 | 0 | 0 | 55 | 21 | 20 | 23 | 11 | 0 | 30 | 22 | 7 | 1 | 6 | 21 | 20 | 55 | 0 | 1 | 10 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 102 | 15 | 0 | 0 | 53 | 20 | 19 | 21 | 10 | 0 | 32 | 25 | 7 | 1 | 5 | 15 | 15 | 53 | 0 | 1 | 10 | 0 | 0 | 
| leaf | 0 | prover | 237,929,144 | 407 | 147 | 0 | 0 | 142 | 71 | 70 | 44 | 26 | 0 | 117 | 95 | 22 | 10 | 11 | 147 | 147 | 142 | 0 | 3 | 25 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,280,083,194 | 2,053 | 570 | 0 | 0 | 1,138 | 673 | 672 | 233 | 231 | 0 | 344 | 250 | 93 | 57 | 35 | 570 | 570 | 1,138 | 0 | 1 | 230 | 0 | 0 | 
| app_proof | prover | 1 | 687,443,728 | 1,065 | 215 | 0 | 0 | 659 | 348 | 347 | 126 | 184 | 0 | 190 | 138 | 51 | 30 | 21 | 215 | 215 | 659 | 0 | 1 | 182 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 0 | 2 | 101 | 2,366 | 101 | 0 | 12,567,225,180 | 2,800,224,348 | 15,367,449,528 | 2,097,152 | 0 | 3 | 210 | 7,136,000 | 35.06 | 
| app_proof | 1 | 0 | 1 | 43 | 1,585 | 43 | 0 | 7,131,913,452 | 1,123,862,484 | 8,255,775,936 | 2,097,152 | 0 | 2 | 475 | 4,031,961 | 36.58 | 

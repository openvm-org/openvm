...
|:---|---:|---:|---:|
| Total |  10.01 |  7.02 |  7.02 |
| app_proof |  8.31 |  5.32 |  5.32 |
| leaf |  1.02 |  1.02 |  1.02 |
...
| `total_proof_time_ms ` |  4,113.50 |  8,227 |  5,232 |  2,995 |
...
| `execute_preflight_insn_mi/s` |  39.14 | -          |  41.60 |  36.67 |
| `trace_gen_time_ms   ` |  123 |  246 |  175 |  71 |
| `set_initial_memory_time_ms` |  88.50 |  177 |  136 |  41 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  3,661.50 |  7,323 |  4,721 |  2,602 |
| `prover.main_trace_commit_time_ms` |  968 |  1,936 |  1,350 |  586 |
| `prover.rap_constraints_time_ms` |  1,983 |  3,966 |  2,462 |  1,504 |
| `prover.openings_time_ms` |  710 |  1,420 |  908 |  512 |
| `prover.rap_constraints.logup_gkr_time_ms` |  557 |  1,114 |  607 |  507 |
| `prover.rap_constraints.round0_time_ms` |  1,041.50 |  2,083 |  1,359 |  724 |
| `prover.rap_constraints.mle_rounds_time_ms` |  383.50 |  767 |  496 |  271 |
| `prover.openings.stacked_reduction_time_ms` |  167.50 |  335 |  218 |  117 |
...
| `prover.openings.whir_time_ms` |  542 |  1,084 |  689 |  395 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/eb3f6fdc56150d781e874b4200f527a8d8de3537/sha2_bench-eb3f6fdc56150d781e874b4200f527a8d8de3537.memory.svg)

| Module | Max (GB) | Max At |
| --- | ---: | --- |
| prover.stacked_commit | 14.68 | app_proof.prover.0 |
| frac_sumcheck.gkr_rounds | 12.61 | app_proof.prover.0 |
| prover.batch_constraints.before_round0 | 12.61 | app_proof.prover.0 |
| prover.gkr_input_evals | 12.27 | app_proof.prover.0 |
| frac_sumcheck.segment_tree | 12.27 | app_proof.prover.0 |
| prover.batch_constraints.round0 | 10.73 | app_proof.prover.0 |
| prover.batch_constraints.fold_ple_evals | 10.73 | app_proof.prover.0 |
| prover.rap_constraints | 10.73 | app_proof.prover.0 |
| prover.merkle_tree | 9.91 | app_proof.prover.0 |
| prover.openings | 9.91 | app_proof.prover.0 |
| prover.prove_whir_opening | 9.91 | app_proof.prover.0 |
| prover.rs_code_matrix | 9.90 | app_proof.prover.0 |
...
| 30 | VmAirWrapper<Rv64AddSubAdapterAir, AddSubCoreAir<4, 16> |  | 19 | 14 | 3 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 70 |  |  |  | 339 |  |  |  |  |  |  | 
| app_proof |  |  |  | 2,995 |  | 86 | 11,167,961 | 128.96 | 0 | 8,320 |  | 
...
| app_proof | VmAirWrapper<Rv64AddSubAdapterAir, AddSubCoreAir<4, 16> | 8 | VmAirWrapper<Rv64AddSubAdapterAir, AddSubCoreAir<4, 16> | 0 | 62,893,740 | 
...
| app_proof | VmAirWrapper<Rv64AddSubAdapterAir, AddSubCoreAir<4, 16> | 8 | VmAirWrapper<Rv64AddSubAdapterAir, AddSubCoreAir<4, 16> | 1 | 35,565,480 | 
...
| app_proof | VmAirWrapper<Rv64AddIAdapterAir, AddICoreAir<4, 16> | 0 |  | 92 | 
| app_proof | VmAirWrapper<Rv64AddSubAdapterAir, AddSubCoreAir<4, 16> | 0 |  | 11 | 
...
| app_proof | VmAirWrapper<Rv64BranchAdapterAir, BranchEqualCoreAir<4> | 0 | 2 | 6 | 
...
| app_proof | VmAirWrapper<Rv64RdWriteAdapterAir, Rv64AuipcCoreAir> | 0 | 2 | 3 | 
| app_proof | Sha2MainAir<Sha256Config> | 1 |  | 1 | 
| app_proof | VmAirWrapper<Rv64AddIAdapterAir, AddICoreAir<4, 16> | 1 |  | 46 | 
| app_proof | VmAirWrapper<Rv64AddSubAdapterAir, AddSubCoreAir<4, 16> | 1 |  | 3 | 
...
| app_proof | 15 | VmAirWrapper<Rv64AddIAdapterAir, AddICoreAir<4, 16> | ADDI | 0 | 1,051,651 | 
...
| app_proof | 30 | VmAirWrapper<Rv64AddSubAdapterAir, AddSubCoreAir<4, 16> | ADD | 0 | 734,251 | 
| app_proof | 30 | VmAirWrapper<Rv64AddSubAdapterAir, AddSubCoreAir<4, 16> | SUB | 0 | 313,978 | 
...
| app_proof | 15 | VmAirWrapper<Rv64AddIAdapterAir, AddICoreAir<4, 16> | ADDI | 1 | 594,662 | 
...
| app_proof | 30 | VmAirWrapper<Rv64AddSubAdapterAir, AddSubCoreAir<4, 16> | ADD | 1 | 415,206 | 
| app_proof | 30 | VmAirWrapper<Rv64AddSubAdapterAir, AddSubCoreAir<4, 16> | SUB | 1 | 177,552 | 
...
| app_proof | 30 | VmAirWrapper<Rv64AddSubAdapterAir, AddSubCoreAir<4, 16> | prover | 0 | 1,048,576 | 32 | 33,554,432 | 
...
| app_proof | 15 | VmAirWrapper<Rv64AddIAdapterAir, AddICoreAir<4, 16> | prover | 1 | 1,048,576 | 25 | 26,214,400 | 
...
| app_proof | 30 | VmAirWrapper<Rv64AddSubAdapterAir, AddSubCoreAir<4, 16> | prover | 1 | 1,048,576 | 32 | 33,554,432 | 
...
| app_proof | 15 | VmAirWrapper<Rv64AddIAdapterAir, AddICoreAir<4, 16> | 0 | 1,051,651 | 1,045,501 | 65,728,188 | 65,343,812 | 105,165,100 | 104,550,100 | 26,291,275 | 26,137,525 | 609,957,580 | 606,390,580 | 16,826,416 | 16,728,016 | 
...
| app_proof | 30 | VmAirWrapper<Rv64AddSubAdapterAir, AddSubCoreAir<4, 16> | 0 | 1,048,229 | 347 | 83,858,320 | 27,760 | 134,173,312 | 44,416 | 33,543,328 | 11,104 | 721,967,724 | 238,996 | 19,916,351 | 6,593 | 
...
| app_proof | 15 | VmAirWrapper<Rv64AddIAdapterAir, AddICoreAir<4, 16> | 1 | 594,662 | 453,914 | 37,166,375 | 28,369,625 | 59,466,200 | 45,391,400 | 14,866,550 | 11,347,850 | 344,903,960 | 263,270,120 | 9,514,592 | 7,262,624 | 
...
| app_proof | 30 | VmAirWrapper<Rv64AddSubAdapterAir, AddSubCoreAir<4, 16> | 1 | 592,758 | 455,818 | 47,420,640 | 36,465,440 | 75,873,024 | 58,344,704 | 18,968,256 | 14,586,176 | 408,262,073 | 313,944,647 | 11,262,402 | 8,660,542 | 
...
| leaf | 0 | 112 | 1,019 | 112 | 35 | 17 | 2 | 7 | 7 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 327 | 118 | 0 | 0 | 108 | 35 | 35 | 51 | 20 | 0 | 99 | 86 | 13 | 3 | 9 | 119 | 118 | 108 | 0 | 3 | 20 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 169 | 47 | 0 | 0 | 68 | 25 | 24 | 28 | 15 | 0 | 52 | 43 | 8 | 1 | 6 | 48 | 48 | 68 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 139 | 32 | 0 | 0 | 63 | 23 | 22 | 24 | 14 | 0 | 43 | 36 | 7 | 1 | 5 | 32 | 32 | 63 | 0 | 3 | 13 | 0 | 0 | 
| leaf | 0 | prover | 237,929,016 | 907 | 375 | 0 | 0 | 230 | 110 | 109 | 68 | 51 | 0 | 300 | 262 | 37 | 20 | 17 | 376 | 375 | 230 | 0 | 11 | 50 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,300,922,618 | 4,721 | 1,350 | 0 | 0 | 2,462 | 1,359 | 1,358 | 496 | 607 | 1 | 908 | 689 | 218 | 136 | 81 | 1,350 | 1,350 | 2,462 | 0 | 5 | 605 | 0 | 0 | 
| app_proof | prover | 1 | 738,754,808 | 2,602 | 586 | 0 | 0 | 1,504 | 724 | 724 | 271 | 507 | 0 | 512 | 395 | 117 | 70 | 46 | 586 | 586 | 1,503 | 0 | 6 | 506 | 0 | 0 | 

| group | phase | segment | trace_height_constraint | weighted_sum | threshold |
| --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 0 | 238,707,082 | 2,013,265,921 | 
| app_proof | prover | 1 | 0 | 162,554,210 | 2,013,265,921 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 136 | 1 | 175 | 5,232 | 175 | 136 | 13,186,426,332 | 2,431,096,284 | 15,617,522,616 | 2,097,152 | 0 | 3 | 198 | 7,134,000 | 36.67 | 
| app_proof | 1 | 41 | 1 | 71 | 2,995 | 71 | 41 | 7,487,576,160 | 1,383,932,736 | 8,871,508,896 | 2,097,152 | 0 | 2 | 279 | 4,033,961 | 41.60 | 

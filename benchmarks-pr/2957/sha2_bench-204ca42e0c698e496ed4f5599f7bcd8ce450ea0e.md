...
| `total_proof_time_ms ` |  1,970.50 |  3,941 |  2,348 |  1,593 |
| `compile_metered_time_ms` |  6 |  6 |  6 |  6 |
| `execute_metered_time_ms` |  56 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  196.06 | -          |  196.06 |  196.06 |
| `execute_preflight_insns` |  5,583,980.50 |  11,167,961 |  7,136,000 |  4,031,961 |
| `execute_preflight_time_ms` |  339.50 |  679 |  485 |  194 |
| `execute_preflight_insn_mi/s` |  36.80 | -          |  37.88 |  35.72 |
| `trace_gen_time_ms   ` |  73 |  146 |  102 |  44 |
| `set_initial_memory_time_ms` |  0 |  0 |  0 |  0 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,556.50 |  3,113 |  2,050 |  1,063 |
| `prover.main_trace_commit_time_ms` |  390.50 |  781 |  567 |  214 |
| `prover.rap_constraints_time_ms` |  897 |  1,794 |  1,137 |  657 |
| `prover.openings_time_ms` |  268.50 |  537 |  345 |  192 |
| `prover.rap_constraints.logup_gkr_time_ms` |  208.50 |  417 |  232 |  185 |
| `prover.rap_constraints.round0_time_ms` |  509.50 |  1,019 |  672 |  347 |
| `prover.rap_constraints.mle_rounds_time_ms` |  178 |  356 |  232 |  124 |
| `prover.openings.stacked_reduction_time_ms` |  72.50 |  145 |  93 |  52 |
...
| `prover.openings.whir_time_ms` |  196 |  392 |  252 |  140 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/204ca42e0c698e496ed4f5599f7bcd8ce450ea0e/sha2_bench-204ca42e0c698e496ed4f5599f7bcd8ce450ea0e.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 58 |  |  |  | 283 |  |  |  |  |  |  | 
| app_proof |  |  |  | 1,593 |  | 56 | 11,167,961 | 196.06 | 0 | 4,007 |  | 
...
| internal_recursive.0 | 1 | 14 | 122 | 10 | 1 | 0 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 9 | 104 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 117 | 520 | 117 | 35 | 12 | 2 | 9 | 9 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 177 | 46 | 0 | 0 | 78 | 27 | 27 | 37 | 13 | 0 | 52 | 41 | 10 | 2 | 7 | 46 | 46 | 78 | 0 | 1 | 12 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,280,083,194 | 2,050 | 567 | 0 | 0 | 1,137 | 672 | 671 | 232 | 232 | 1 | 345 | 252 | 93 | 57 | 36 | 567 | 567 | 1,137 | 0 | 1 | 230 | 0 | 0 | 
| app_proof | prover | 1 | 687,443,728 | 1,063 | 213 | 0 | 0 | 657 | 347 | 346 | 124 | 185 | 0 | 192 | 140 | 52 | 31 | 21 | 214 | 213 | 657 | 0 | 1 | 184 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 0 | 2 | 102 | 2,348 | 102 | 0 | 12,567,225,180 | 2,800,224,348 | 15,367,449,528 | 2,097,152 | 0 | 3 | 194 | 7,136,000 | 37.88 | 
| app_proof | 1 | 0 | 1 | 44 | 1,593 | 44 | 0 | 7,131,913,452 | 1,123,862,484 | 8,255,775,936 | 2,097,152 | 0 | 2 | 485 | 4,031,961 | 35.72 | 

...
| `prover.main_trace_commit_time_ms` |  199 |  199 |  199 |  199 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/eb3f6fdc56150d781e874b4200f527a8d8de3537/regex-eb3f6fdc56150d781e874b4200f527a8d8de3537.memory.svg)

| Module | Max (GB) | Max At |
| --- | ---: | --- |
| prover.batch_constraints.before_round0 | 4.77 | app_proof.prover.0 |
| frac_sumcheck.gkr_rounds | 4.77 | app_proof.prover.0 |
| prover.gkr_input_evals | 4.65 | app_proof.prover.0 |
| frac_sumcheck.segment_tree | 4.65 | app_proof.prover.0 |
| prover.stacked_commit | 2.89 | app_proof.prover.0 |
| prover.batch_constraints.fold_ple_evals | 2.39 | app_proof.prover.0 |
| prover.rap_constraints | 2.39 | app_proof.prover.0 |
| prover.batch_constraints.round0 | 2.39 | app_proof.prover.0 |
| prover.merkle_tree | 2.04 | app_proof.prover.0 |
| prover.openings | 2.04 | app_proof.prover.0 |
| prover.prove_whir_opening | 2.04 | app_proof.prover.0 |
| prover.rs_code_matrix | 2.03 | app_proof.prover.0 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 71 |  |  |  | 340 |  |  |  |  |  |  | 
| app_proof |  |  |  | 1,200 |  | 30 | 4,090,656 | 135.07 | 0 | 1,245 |  | 
...
| app_proof | VmAirWrapper<Rv64AddSubAdapterAir, AddSubCoreAir<4, 16> | 8 | VmAirWrapper<Rv64AddSubAdapterAir, AddSubCoreAir<4, 16> | 0 | 18,102,060 | 
...
| app_proof | VmAirWrapper<Rv64AddSubAdapterAir, AddSubCoreAir<4, 16> | 0 |  | 1 | 
...
| app_proof | 14 | VmAirWrapper<Rv64AddIAdapterAir, AddICoreAir<4, 16> | ADDI | 0 | 669,083 | 
...
| app_proof | 29 | VmAirWrapper<Rv64AddSubAdapterAir, AddSubCoreAir<4, 16> | ADD | 0 | 244,714 | 
| app_proof | 29 | VmAirWrapper<Rv64AddSubAdapterAir, AddSubCoreAir<4, 16> | SUB | 0 | 56,987 | 
...
| app_proof | 29 | VmAirWrapper<Rv64AddSubAdapterAir, AddSubCoreAir<4, 16> | prover | 0 | 524,288 | 32 | 16,777,216 | 
...
| app_proof | 14 | VmAirWrapper<Rv64AddIAdapterAir, AddICoreAir<4, 16> | 0 | 669,083 | 379,493 | 41,817,688 | 23,718,312 | 66,908,300 | 37,949,300 | 16,727,075 | 9,487,325 | 388,068,140 | 220,105,940 | 10,705,328 | 6,071,888 | 
...
| app_proof | 29 | VmAirWrapper<Rv64AddSubAdapterAir, AddSubCoreAir<4, 16> | 0 | 301,701 | 222,587 | 24,136,080 | 17,806,960 | 38,617,728 | 28,491,136 | 9,654,432 | 7,122,784 | 207,796,564 | 153,306,796 | 5,732,319 | 4,229,153 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 27,277,885 | 264 | 82 | 0 | 0 | 98 | 31 | 31 | 45 | 20 | 0 | 82 | 71 | 11 | 2 | 8 | 82 | 82 | 98 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 168 | 46 | 0 | 0 | 67 | 24 | 24 | 28 | 14 | 0 | 54 | 45 | 8 | 1 | 6 | 46 | 46 | 67 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 134 | 32 | 0 | 0 | 61 | 23 | 23 | 24 | 13 | 0 | 39 | 32 | 7 | 1 | 5 | 32 | 32 | 61 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 65,360,477 | 323 | 104 | 0 | 0 | 111 | 47 | 46 | 32 | 31 | 0 | 106 | 93 | 13 | 5 | 7 | 105 | 104 | 111 | 0 | 6 | 29 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 246,265,675 | 893 | 199 | 0 | 0 | 512 | 150 | 149 | 51 | 310 | 31 | 181 | 143 | 37 | 19 | 17 | 199 | 199 | 512 | 0 | 4 | 277 | 0 | 0 | 

| group | phase | segment | trace_height_constraint | weighted_sum | threshold |
| --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 0 | 115,502,176 | 2,013,265,921 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 135 | 2 | 33 | 1,200 | 33 | 135 | 4,045,135,142 | 1,270,761,630 | 5,315,896,772 | 2,097,152 | 1 | 5 | 137 | 4,090,656 | 31.29 | 

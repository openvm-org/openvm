...
|:---|---:|---:|---:|
| Total |  9.86 |  6.92 |  6.92 |
| app_proof |  8.20 |  5.25 |  5.25 |
| leaf |  0.99 |  0.99 |  0.99 |
...
| `total_proof_time_ms ` |  4,055.50 |  8,111 |  5,165 |  2,946 |
...
| `execute_preflight_time_ms` |  243.50 |  487 |  283 |  204 |
| `execute_preflight_insn_mi/s` |  38.43 | -          |  41.37 |  35.50 |
| `trace_gen_time_ms   ` |  127 |  254 |  183 |  71 |
| `set_initial_memory_time_ms` |  91.50 |  183 |  142 |  41 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  3,591.50 |  7,183 |  4,634 |  2,549 |
| `prover.main_trace_commit_time_ms` |  962.50 |  1,925 |  1,347 |  578 |
| `prover.rap_constraints_time_ms` |  1,926.50 |  3,853 |  2,388 |  1,465 |
| `prover.openings_time_ms` |  701 |  1,402 |  897 |  505 |
| `prover.rap_constraints.logup_gkr_time_ms` |  544.50 |  1,089 |  595 |  494 |
| `prover.rap_constraints.round0_time_ms` |  1,011.50 |  2,023 |  1,315 |  708 |
| `prover.rap_constraints.mle_rounds_time_ms` |  370 |  740 |  478 |  262 |
...
| `prover.openings.whir_time_ms` |  539 |  1,078 |  687 |  391 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/bd7eb1b2937f97df326ed49da3263ee368c815c3/sha2_bench-bd7eb1b2937f97df326ed49da3263ee368c815c3.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 81 |  |  |  | 362 |  |  |  |  |  |  | 
| app_proof |  |  |  | 2,946 |  | 88 | 11,167,961 | 126.47 | 0 | 8,205 |  | 
...
| app_proof | VmAirWrapper<Rv64AddSubAdapterAir, AddSubCoreAir<4, 16> | 0 |  | 12 | 
| app_proof | VmAirWrapper<Rv64BaseAluAdapterAir, BitwiseLogicCoreAir<8, 8> | 0 | 4 | 8 | 
...
| leaf | 0 | 108 | 994 | 108 | 34 | 17 | 2 | 7 | 7 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 326 | 116 | 0 | 0 | 107 | 33 | 33 | 51 | 21 | 0 | 101 | 88 | 13 | 3 | 9 | 116 | 116 | 107 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 164 | 45 | 0 | 0 | 66 | 24 | 23 | 27 | 14 | 0 | 52 | 43 | 8 | 1 | 6 | 46 | 45 | 66 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 138 | 32 | 0 | 0 | 61 | 22 | 21 | 24 | 14 | 0 | 43 | 36 | 7 | 1 | 5 | 32 | 32 | 61 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 237,929,016 | 885 | 368 | 0 | 0 | 225 | 107 | 106 | 65 | 52 | 0 | 291 | 254 | 36 | 19 | 17 | 369 | 368 | 225 | 0 | 9 | 49 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,300,922,618 | 4,634 | 1,347 | 0 | 0 | 2,388 | 1,315 | 1,314 | 478 | 595 | 1 | 897 | 687 | 210 | 131 | 78 | 1,347 | 1,347 | 2,388 | 0 | 4 | 593 | 0 | 0 | 
| app_proof | prover | 1 | 738,754,808 | 2,549 | 578 | 0 | 0 | 1,465 | 708 | 707 | 262 | 494 | 0 | 505 | 391 | 114 | 69 | 45 | 578 | 578 | 1,465 | 0 | 4 | 492 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 142 | 1 | 183 | 5,165 | 183 | 142 | 13,186,426,332 | 2,431,096,284 | 15,617,522,616 | 2,097,152 | 0 | 4 | 204 | 7,134,000 | 35.50 | 
| app_proof | 1 | 41 | 1 | 71 | 2,946 | 71 | 41 | 7,487,576,160 | 1,383,932,736 | 8,871,508,896 | 2,097,152 | 0 | 2 | 283 | 4,033,961 | 41.37 | 

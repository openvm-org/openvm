...
|:---|---:|---:|---:|
| Total |  1.90 |  1.66 |  1.66 |
| app_proof |  0.91 |  0.67 |  0.67 |
| leaf |  0.39 |  0.39 |  0.39 |
...
| `total_proof_time_ms ` |  446 |  892 |  652 |  240 |
| `compile_metered_time_ms` |  3 |  3 |  3 |  3 |
| `execute_metered_time_ms` |  20 | -          | -          | -          |
| `execute_metered_insns` |  4,000,051 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  192.40 | -          |  192.40 |  192.40 |
| `execute_preflight_insns` |  2,000,025.50 |  4,000,051 |  3,495,000 |  505,051 |
| `execute_preflight_time_ms` |  46 |  92 |  77 |  15 |
| `execute_preflight_insn_mi/s` |  49.06 | -          |  52.20 |  45.92 |
| `trace_gen_time_ms   ` |  39 |  78 |  55 |  23 |
| `set_initial_memory_time_ms` |  88.50 |  177 |  136 |  41 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  271 |  542 |  414 |  128 |
| `prover.main_trace_commit_time_ms` |  62 |  124 |  98 |  26 |
| `prover.rap_constraints_time_ms` |  141.50 |  283 |  218 |  65 |
| `prover.openings_time_ms` |  67 |  134 |  98 |  36 |
| `prover.rap_constraints.logup_gkr_time_ms` |  95 |  190 |  148 |  42 |
| `prover.rap_constraints.round0_time_ms` |  29.50 |  59 |  46 |  13 |
...
| `prover.openings.whir_time_ms` |  54.50 |  109 |  79 |  30 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/eb3f6fdc56150d781e874b4200f527a8d8de3537/fibonacci-eb3f6fdc56150d781e874b4200f527a8d8de3537.memory.svg)
...
| 11 | VmAirWrapper<Rv64AddIAdapterAir, AddICoreAir<4, 16> |  | 16 | 8 | 3 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 68 |  |  |  | 340 |  |  |  |  |  |  | 
| app_proof |  |  |  | 240 |  | 20 | 4,000,051 | 192.40 | 0 | 919 |  | 
...
| app_proof | VmAirWrapper<Rv64AddIAdapterAir, AddICoreAir<4, 16> | 23 | VmAirWrapper<Rv64AddIAdapterAir, AddICoreAir<4, 16> | 0 | 92,267,384 | 
...
| app_proof | VmAirWrapper<Rv64AddIAdapterAir, AddICoreAir<4, 16> | 23 | VmAirWrapper<Rv64AddIAdapterAir, AddICoreAir<4, 16> | 1 | 13,333,276 | 
...
| app_proof | VmAirWrapper<Rv64AddIAdapterAir, AddICoreAir<4, 16> | 0 |  | 7 | 
...
| app_proof | 11 | VmAirWrapper<Rv64AddIAdapterAir, AddICoreAir<4, 16> | ADDI | 0 | 2,096,986 | 
...
| app_proof | 11 | VmAirWrapper<Rv64AddIAdapterAir, AddICoreAir<4, 16> | ADDI | 1 | 303,029 | 
...
| app_proof | 11 | VmAirWrapper<Rv64AddIAdapterAir, AddICoreAir<4, 16> | prover | 0 | 2,097,152 | 25 | 52,428,800 | 
...
| app_proof | 11 | VmAirWrapper<Rv64AddIAdapterAir, AddICoreAir<4, 16> | prover | 1 | 524,288 | 25 | 13,107,200 | 
...
| --- | --- | --- | --- | --- | --- |
| app_proof | 11 | VmAirWrapper<Rv64AddIAdapterAir, AddICoreAir<4, 16> | height | 0 | 1 | 
...
| app_proof | 11 | VmAirWrapper<Rv64AddIAdapterAir, AddICoreAir<4, 16> | 0 | 2,096,986 | 166 | 131,061,625 | 10,375 | 209,698,600 | 16,600 | 52,424,650 | 4,150 | 1,216,251,880 | 96,280 | 33,551,776 | 2,656 | 
...
| app_proof | 11 | VmAirWrapper<Rv64AddIAdapterAir, AddICoreAir<4, 16> | 1 | 303,029 | 221,259 | 18,939,313 | 13,828,687 | 30,302,900 | 22,125,900 | 7,575,725 | 5,531,475 | 175,756,820 | 128,330,220 | 4,848,464 | 3,540,144 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 16 | 274 | 16 | 5 | 0 | 2 | 1 | 1 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 27,277,885 | 257 | 82 | 0 | 0 | 98 | 32 | 31 | 45 | 20 | 0 | 77 | 65 | 11 | 2 | 8 | 82 | 82 | 98 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 173 | 47 | 0 | 0 | 67 | 25 | 24 | 28 | 13 | 0 | 57 | 49 | 8 | 1 | 6 | 47 | 47 | 67 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 136 | 32 | 0 | 0 | 62 | 23 | 22 | 24 | 14 | 0 | 41 | 34 | 7 | 1 | 5 | 32 | 32 | 62 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 74,814,264 | 350 | 123 | 0 | 0 | 117 | 53 | 52 | 35 | 28 | 0 | 109 | 94 | 14 | 6 | 8 | 124 | 123 | 117 | 0 | 6 | 28 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 118,747,732 | 414 | 97 | 0 | 0 | 218 | 46 | 46 | 22 | 148 | 0 | 98 | 79 | 18 | 10 | 8 | 98 | 97 | 218 | 0 | 3 | 147 | 0 | 0 | 
| app_proof | prover | 1 | 26,209,760 | 128 | 26 | 0 | 0 | 65 | 13 | 13 | 9 | 42 | 0 | 36 | 30 | 5 | 2 | 3 | 26 | 26 | 65 | 0 | 3 | 41 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 136 | 2 | 23 | 652 | 23 | 136 | 2,424,712,491 | 461,541,025 | 2,886,253,516 | 2,097,152 | 0 | 4 | 77 | 3,495,000 | 45.92 | 
| app_proof | 1 | 41 | 1 | 55 | 240 | 55 | 41 | 415,772,173 | 190,267,730 | 606,039,903 | 2,097,152 | 0 | 2 | 15 | 505,051 | 52.20 | 

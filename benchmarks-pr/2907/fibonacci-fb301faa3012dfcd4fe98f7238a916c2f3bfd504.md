...
|:---|---:|---:|---:|
| Total |  4.48 |  2.34 |  2.34 |
| app_proof |  3.12 |  0.99 |  0.99 |
| leaf |  0.68 |  0.68 |  0.68 |
...
| `total_proof_time_ms ` |  764.25 |  3,057 |  918 |  551 |
| `execute_metered_time_ms` |  67 | -          | -          | -          |
| `execute_metered_insns` |  12,000,265 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  177.01 | -          |  177.01 |  177.01 |
| `execute_preflight_insns` |  3,000,066.25 |  12,000,265 |  3,495,000 |  1,515,265 |
| `execute_preflight_time_ms` |  84 |  336 |  103 |  43 |
| `execute_preflight_insn_mi/s` |  47.93 | -          |  49.08 |  44.99 |
| `trace_gen_time_ms   ` |  139 |  556 |  173 |  122 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  471 |  1,884 |  535 |  293 |
| `prover.main_trace_commit_time_ms` |  98.50 |  394 |  112 |  59 |
| `prover.rap_constraints_time_ms` |  271.75 |  1,087 |  310 |  167 |
| `prover.openings_time_ms` |  99.75 |  399 |  114 |  66 |
| `prover.rap_constraints.logup_gkr_time_ms` |  195.75 |  783 |  222 |  117 |
| `prover.rap_constraints.round0_time_ms` |  50.50 |  202 |  59 |  31 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/fb301faa3012dfcd4fe98f7238a916c2f3bfd504/fibonacci-fb301faa3012dfcd4fe98f7238a916c2f3bfd504.memory.svg)
...
| app_proof |  |  |  |  |  | 551 |  |  | 67 | 12,000,265 | 177.01 | 0 | 3,132 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 330 | 117 | 0 | 0 | 106 | 34 | 34 | 51 | 20 | 0 | 106 | 92 | 13 | 3 | 9 | 117 | 106 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 173 | 48 | 0 | 0 | 68 | 25 | 24 | 28 | 14 | 0 | 56 | 48 | 8 | 1 | 6 | 48 | 68 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 138 | 32 | 0 | 0 | 61 | 23 | 22 | 24 | 13 | 0 | 44 | 37 | 7 | 1 | 5 | 32 | 61 | 0 | 2 | 13 | 0 | 0 | 
| leaf | 0 | prover | 147,934,254 | 604 | 231 | 0 | 0 | 181 | 83 | 83 | 52 | 44 | 0 | 190 | 166 | 24 | 12 | 12 | 232 | 181 | 0 | 7 | 43 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 136,618,054 | 535 | 110 | 0 | 0 | 310 | 59 | 59 | 27 | 222 | 0 | 114 | 92 | 21 | 11 | 9 | 111 | 310 | 0 | 3 | 221 | 0 | 0 | 
| app_proof | prover | 1 | 136,570,716 | 528 | 112 | 0 | 0 | 305 | 56 | 55 | 27 | 222 | 0 | 110 | 89 | 21 | 11 | 8 | 112 | 305 | 0 | 3 | 221 | 0 | 0 | 
| app_proof | prover | 2 | 136,570,716 | 528 | 112 | 0 | 0 | 305 | 56 | 56 | 26 | 222 | 0 | 109 | 88 | 21 | 12 | 9 | 112 | 305 | 0 | 3 | 221 | 0 | 0 | 
| app_proof | prover | 3 | 70,295,004 | 293 | 58 | 0 | 0 | 167 | 31 | 31 | 17 | 117 | 0 | 66 | 54 | 12 | 6 | 6 | 59 | 167 | 0 | 3 | 116 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 135 | 918 | 135 | 155 | 2,770,197,065 | 323,292,691 | 3,093,489,756 | 2,097,152 | 0 | 3 | 91 | 3,495,000 | 44.99 | 
| app_proof | 1 | 122 | 794 | 122 | 41 | 2,768,862,357 | 322,353,414 | 3,091,215,771 | 2,097,152 | 0 | 1 | 103 | 3,495,000 | 49.08 | 
| app_proof | 2 | 126 | 794 | 126 | 41 | 2,768,862,357 | 322,353,414 | 3,091,215,771 | 2,097,152 | 0 | 1 | 99 | 3,495,000 | 48.88 | 
| app_proof | 3 | 173 | 551 | 173 | 41 | 1,230,956,171 | 342,871,578 | 1,573,827,749 | 2,097,152 | 0 | 1 | 43 | 1,515,265 | 48.78 | 

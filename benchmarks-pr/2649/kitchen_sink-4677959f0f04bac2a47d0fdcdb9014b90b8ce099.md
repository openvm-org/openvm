...
| `total_proof_time_ms ` |  1,187.50 |  2,375 |  1,421 |  954 |
...
| `execute_preflight_insn_mi/s` |  8.26 | -          |  10.90 |  5.62 |
| `trace_gen_time_ms   ` |  158 |  316 |  187 |  129 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  845 |  1,690 |  1,028 |  662 |
| `prover.main_trace_commit_time_ms` |  223 |  446 |  295 |  151 |
| `prover.rap_constraints_time_ms` |  559.50 |  1,119 |  659 |  460 |
| `prover.openings_time_ms` |  61.50 |  123 |  73 |  50 |
| `prover.rap_constraints.logup_gkr_time_ms` |  140.50 |  281 |  155 |  126 |
| `prover.rap_constraints.round0_time_ms` |  285 |  570 |  362 |  208 |
| `prover.rap_constraints.mle_rounds_time_ms` |  133 |  266 |  141 |  125 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/4677959f0f04bac2a47d0fdcdb9014b90b8ce099/kitchen_sink-4677959f0f04bac2a47d0fdcdb9014b90b8ce099.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 68 | 3 |  |  | 0 |  | 322 | 3 |  |  |  |  |  |  | 
| app_proof |  |  |  |  |  | 954 |  |  | 7 | 154,763 | 20.29 | 0 | 2,388 |  | 
...
| leaf | 0 | 104 | 413 | 104 | 25 | 11 | 17 | 5 | 5 | 
...
| leaf | 0 | prover | 407,935,872 | 308 | 124 | 0 | 9 | 139 | 45 | 44 | 36 | 58 | 0 | 43 | 12 | 30 | 7 | 23 | 124 | 139 | 0 | 2 | 57 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 816,542,084 | 1,028 | 295 | 0 | 164 | 659 | 362 | 361 | 141 | 155 | 62 | 73 | 12 | 60 | 15 | 44 | 295 | 659 | 0 | 1 | 91 | 0 | 0 | 
| app_proof | prover | 1 | 800,298,548 | 662 | 151 | 0 | 20 | 460 | 208 | 207 | 125 | 126 | 73 | 50 | 13 | 37 | 14 | 22 | 151 | 460 | 0 | 1 | 53 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 187 | 1,421 | 187 | 184 | 0 | 50 | 20 | 121,000 | 10.90 | 
| app_proof | 1 | 129 | 954 | 129 | 40 | 0 | 3 | 121 | 33,763 | 5.62 | 

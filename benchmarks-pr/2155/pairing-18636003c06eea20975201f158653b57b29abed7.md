...
|:---|---:|---:|
| Total | <span style='color: red'>(+0 [+0.8%])</span> 1.54 | <span style='color: red'>(+0 [+0.5%])</span> 0.92 |
| pairing | <span style='color: red'>(+0 [+0.8%])</span> 1.45 | <span style='color: red'>(+0 [+0.4%])</span> 0.83 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+6 [+0.8%])</span> 726.50 | <span style='color: red'>(+11 [+0.8%])</span> 1,453 | <span style='color: red'>(+3 [+0.4%])</span> 832 | <span style='color: red'>(+8 [+1.3%])</span> 621 |
...
| `execute_metered_insn_mi/s` | <span style='color: green'>(-0 [-2.2%])</span> 19.01 | -          | <span style='color: green'>(-0 [-2.2%])</span> 19.01 | <span style='color: green'>(-0 [-2.2%])</span> 19.01 |
...
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+0 [+1.9%])</span> 13.78 | -          | <span style='color: red'>(+0 [+2.6%])</span> 18.35 | <span style='color: red'>(+0 [+0.6%])</span> 9.21 |
...
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+12 [+3.6%])</span> 360.50 | <span style='color: red'>(+25 [+3.6%])</span> 721 | <span style='color: red'>(+9 [+2.3%])</span> 393 | <span style='color: red'>(+16 [+5.1%])</span> 328 |
| `main_trace_commit_time_ms` | <span style='color: green'>(-2 [-2.3%])</span> 64.50 | <span style='color: green'>(-3 [-2.3%])</span> 129 | <span style='color: green'>(-2 [-2.6%])</span> 74 | <span style='color: green'>(-1 [-1.8%])</span> 55 |
| `generate_perm_trace_time_ms` | <span style='color: red'>(+17 [+54.0%])</span> 48.50 | <span style='color: red'>(+34 [+54.0%])</span> 97 | <span style='color: red'>(+16 [+47.1%])</span> 50 | <span style='color: red'>(+18 [+62.1%])</span> 47 |
| `perm_trace_commit_time_ms` | <span style='color: green'>(-2 [-2.2%])</span> 76.40 | <span style='color: green'>(-3 [-2.2%])</span> 152.80 | <span style='color: green'>(-1 [-1.6%])</span> 88.50 | <span style='color: green'>(-2 [-3.1%])</span> 64.30 |
| `quotient_poly_compute_time_ms` | <span style='color: green'>(-2 [-2.1%])</span> 78.04 | <span style='color: green'>(-3 [-2.1%])</span> 156.08 | <span style='color: green'>(-1 [-1.5%])</span> 86.52 | <span style='color: green'>(-2 [-2.8%])</span> 69.56 |
| `quotient_poly_commit_time_ms` | <span style='color: green'>(-2 [-9.0%])</span> 15.21 | <span style='color: green'>(-3 [-9.0%])</span> 30.41 | <span style='color: green'>(-2 [-10.4%])</span> 16.82 | <span style='color: green'>(-1 [-7.2%])</span> 13.60 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+2 [+3.5%])</span> 73 | <span style='color: red'>(+5 [+3.5%])</span> 146 | <span style='color: red'>(+3 [+4.2%])</span> 75 | <span style='color: red'>(+2 [+2.9%])</span> 71 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 621 | 65 | 1 | 91 | 1,745,742 | 19.01 | 170 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 162 | 832 | 32,689,110 | 172,558,444 | 162 | 393 | 0 | 86.52 | 16.82 | 6 | 88.50 | 75 | 139 | 74 | 0 | 74 | 16,059,916 | 47 | 129 | 1,157,000 | 9.21 | 26 | 104 | 1 | 74 | 
| pairing | 1 | 192 | 621 | 22,314,288 | 119,958,502 | 192 | 328 | 1 | 69.56 | 13.60 | 6 | 64.30 | 71 | 117 | 71 | 0 | 55 | 9,408,294 | 50 | 60 | 588,742 | 18.35 | 20 | 83 | 1 | 71 | 

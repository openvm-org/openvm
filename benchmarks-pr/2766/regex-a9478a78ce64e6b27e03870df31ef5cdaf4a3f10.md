...
| `total_proof_time_ms ` |  717.50 |  1,435 |  776 |  659 |
| `execute_metered_time_ms` |  35 | -          | -          | -          |
| `execute_metered_insns` |  4,137,067 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  116.07 | -          |  116.07 |  116.07 |
| `execute_preflight_insns` |  2,068,533.50 |  4,137,067 |  2,208,000 |  1,929,067 |
| `execute_preflight_time_ms` |  86.50 |  173 |  90 |  83 |
| `execute_preflight_insn_mi/s` |  35.22 | -          |  36.20 |  34.23 |
| `trace_gen_time_ms   ` |  137 |  274 |  137 |  137 |
| `memory_finalize_time_ms` |  1 |  2 |  2 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  388 |  776 |  397 |  379 |
| `prover.main_trace_commit_time_ms` |  98 |  196 |  101 |  95 |
| `prover.rap_constraints_time_ms` |  241 |  482 |  255 |  227 |
...
| `prover.openings.stacked_reduction_time_ms` |  28 |  56 |  29 |  27 |
| `prover.openings.stacked_reduction.round0_time_ms` |  9 |  18 |  10 |  8 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  18 |  36 |  18 |  18 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/a9478a78ce64e6b27e03870df31ef5cdaf4a3f10/regex-a9478a78ce64e6b27e03870df31ef5cdaf4a3f10.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 86 | 9 |  |  | 0 |  | 385 | 9 |  |  |  |  |  |  | 
| app_proof |  |  |  |  |  | 659 |  |  | 35 | 4,137,067 | 116.07 | 0 | 1,489 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 41,036,547 | 232 | 83 | 0 | 5 | 102 | 31 | 30 | 46 | 24 | 0 | 46 | 19 | 27 | 3 | 24 | 83 | 102 | 0 | 2 | 23 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 23,651,975 | 166 | 49 | 0 | 4 | 72 | 25 | 24 | 28 | 18 | 0 | 43 | 19 | 24 | 1 | 22 | 49 | 72 | 0 | 2 | 17 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 17,507,975 | 144 | 33 | 0 | 4 | 67 | 24 | 23 | 25 | 17 | 0 | 42 | 18 | 23 | 1 | 21 | 34 | 67 | 0 | 2 | 16 | 0 | 0 | 
| leaf | 0 | prover | 115,080,128 | 332 | 129 | 0 | 8 | 142 | 55 | 54 | 38 | 48 | 0 | 59 | 28 | 31 | 6 | 24 | 130 | 142 | 0 | 5 | 47 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 335,517,254 | 379 | 101 | 0 | 2 | 227 | 52 | 52 | 35 | 138 | 0 | 50 | 21 | 29 | 10 | 18 | 101 | 226 | 0 | 3 | 137 | 0 | 0 | 
| app_proof | prover | 1 | 303,289,171 | 397 | 95 | 0 | 15 | 255 | 82 | 82 | 30 | 142 | 0 | 45 | 18 | 27 | 8 | 18 | 95 | 255 | 0 | 3 | 140 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 137 | 776 | 137 | 169 | 2 | 7 | 90 | 2,208,000 | 34.23 | 
| app_proof | 1 | 137 | 659 | 137 | 41 | 0 | 2 | 83 | 1,929,067 | 36.20 | 

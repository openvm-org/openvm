...
|:---|---:|---:|
| Total | <span style='color: green'>(-0 [-1.9%])</span> 1.83 | <span style='color: green'>(-0 [-2.1%])</span> 1.09 |
| pairing | <span style='color: green'>(-0 [-2.0%])</span> 1.74 | <span style='color: green'>(-0 [-2.3%])</span> 0.100 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: green'>(-18 [-2.0%])</span> 871.50 | <span style='color: green'>(-36 [-2.0%])</span> 1,743 | <span style='color: green'>(-23 [-2.3%])</span> 995 | <span style='color: green'>(-13 [-1.7%])</span> 748 |
...
| `execute_metered_insn_mi/s` | <span style='color: green'>(-0 [-0.7%])</span> 20.51 | -          | <span style='color: green'>(-0 [-0.7%])</span> 20.51 | <span style='color: green'>(-0 [-0.7%])</span> 20.51 |
...
| `execute_preflight_insn_mi/s` |  13.90 | -          |  18.57 | <span style='color: red'>(+0 [+0.2%])</span> 9.23 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+1 [+0.5%])</span> 189.50 | <span style='color: red'>(+2 [+0.5%])</span> 379 |  204 | <span style='color: red'>(+2 [+1.2%])</span> 175 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: green'>(-16 [-3.3%])</span> 488 | <span style='color: green'>(-33 [-3.3%])</span> 976 | <span style='color: green'>(-24 [-4.2%])</span> 546 | <span style='color: green'>(-9 [-2.1%])</span> 430 |
| `main_trace_commit_time_ms` | <span style='color: green'>(-0 [-0.7%])</span> 68.50 | <span style='color: green'>(-1 [-0.7%])</span> 137 | <span style='color: green'>(-1 [-1.3%])</span> 76 |  61 |
| `generate_perm_trace_time_ms` | <span style='color: green'>(-4 [-7.1%])</span> 59 | <span style='color: green'>(-9 [-7.1%])</span> 118 | <span style='color: green'>(-7 [-8.3%])</span> 77 | <span style='color: green'>(-2 [-4.7%])</span> 41 |
| `perm_trace_commit_time_ms` | <span style='color: green'>(-3 [-3.3%])</span> 79.97 | <span style='color: green'>(-6 [-3.3%])</span> 159.95 | <span style='color: green'>(-5 [-5.2%])</span> 87.05 | <span style='color: green'>(-1 [-1.0%])</span> 72.90 |
| `quotient_poly_compute_time_ms` | <span style='color: green'>(-7 [-6.7%])</span> 91.31 | <span style='color: green'>(-13 [-6.7%])</span> 182.62 | <span style='color: green'>(-7 [-6.9%])</span> 96.83 | <span style='color: green'>(-6 [-6.5%])</span> 85.79 |
| `quotient_poly_commit_time_ms` | <span style='color: green'>(-0 [-0.7%])</span> 18.38 | <span style='color: green'>(-0 [-0.7%])</span> 36.76 | <span style='color: green'>(-0 [-0.2%])</span> 19.95 | <span style='color: green'>(-0 [-1.2%])</span> 16.81 |
| `pcs_opening_time_ms ` | <span style='color: green'>(-2 [-1.2%])</span> 166.50 | <span style='color: green'>(-4 [-1.2%])</span> 333 | <span style='color: green'>(-5 [-2.6%])</span> 184 | <span style='color: red'>(+1 [+0.7%])</span> 149 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 748 | 40 | 1 | 91 | 1,882,939 | 20.51 | 145 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 175 | 995 | 31,041,944 | 160,949,612 | 175 | 546 | 0 | 96.83 | 19.95 | 7 | 87.05 | 184 | 167 | 184 | 1 | 76 | 15,014,446 | 77 | 127 | 1,143,000 | 9.23 | 24 | 117 | 3 | 184 | 
| pairing | 1 | 204 | 748 | 24,485,078 | 124,079,782 | 204 | 430 | 1 | 85.79 | 16.81 | 6 | 72.90 | 149 | 116 | 148 | 0 | 61 | 10,833,316 | 41 | 72 | 739,939 | 18.57 | 19 | 103 | 2 | 148 | 

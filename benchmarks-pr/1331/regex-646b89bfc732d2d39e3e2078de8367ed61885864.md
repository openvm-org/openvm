...
|:---|---:|---:|
| Total | <span style='color: green'>(-0 [-0.5%])</span> 14.82 | <span style='color: green'>(-0 [-0.3%])</span> 8.31 |
| regex_program | <span style='color: green'>(-0 [-0.5%])</span> 14.82 | <span style='color: green'>(-0 [-0.3%])</span> 8.31 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: green'>(-37 [-0.5%])</span> 7,410.50 | <span style='color: green'>(-74 [-0.5%])</span> 14,821 | <span style='color: green'>(-21 [-0.3%])</span> 8,313 | <span style='color: green'>(-53 [-0.8%])</span> 6,508 |
...
| `trace_gen_time_ms   ` | <span style='color: green'>(-18 [-1.2%])</span> 1,432.50 | <span style='color: green'>(-35 [-1.2%])</span> 2,865 | <span style='color: green'>(-17 [-1.1%])</span> 1,594 | <span style='color: green'>(-18 [-1.4%])</span> 1,271 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: green'>(-20 [-0.4%])</span> 5,527.50 | <span style='color: green'>(-41 [-0.4%])</span> 11,055 |  6,234 | <span style='color: green'>(-35 [-0.7%])</span> 4,821 |
| `main_trace_commit_time_ms` |  1,117 |  2,234 |  1,342 |  892 |
| `generate_perm_trace_time_ms` | <span style='color: green'>(-8 [-4.2%])</span> 172 | <span style='color: green'>(-15 [-4.2%])</span> 344 | <span style='color: green'>(-1 [-0.5%])</span> 193 | <span style='color: green'>(-14 [-8.5%])</span> 151 |
| `perm_trace_commit_time_ms` | <span style='color: green'>(-8 [-0.6%])</span> 1,183.50 | <span style='color: green'>(-15 [-0.6%])</span> 2,367 |  1,253 | <span style='color: green'>(-16 [-1.4%])</span> 1,114 |
| `quotient_poly_compute_time_ms` | <span style='color: green'>(-4 [-0.5%])</span> 736 | <span style='color: green'>(-7 [-0.5%])</span> 1,472 | <span style='color: green'>(-2 [-0.2%])</span> 857 | <span style='color: green'>(-5 [-0.8%])</span> 615 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+6 [+0.6%])</span> 984 | <span style='color: red'>(+11 [+0.6%])</span> 1,968 |  1,145 | <span style='color: red'>(+10 [+1.2%])</span> 823 |
| `pcs_opening_time_ms ` | <span style='color: green'>(-6 [-0.5%])</span> 1,322.50 | <span style='color: green'>(-13 [-0.5%])</span> 2,645 | <span style='color: green'>(-4 [-0.3%])</span> 1,436 | <span style='color: green'>(-9 [-0.7%])</span> 1,209 |
...
| --- | --- | --- | --- | --- | --- | --- |
| AccessAdapterAir<2> | 0 | 1,048,576 |  | 12 | 11 | 24,117,248 | 
| AccessAdapterAir<2> | 1 | 1,048,576 |  | 12 | 11 | 24,117,248 | 
| AccessAdapterAir<4> | 0 | 524,288 |  | 12 | 13 | 13,107,200 | 
| AccessAdapterAir<4> | 1 | 524,288 |  | 12 | 13 | 13,107,200 | 
| AccessAdapterAir<8> | 0 | 256 |  | 12 | 17 | 7,424 | 
| AccessAdapterAir<8> | 1 | 512 |  | 12 | 17 | 14,848 | 
| FriReducedOpeningAir | 0 | 524,288 |  | 36 | 25 | 31,981,568 | 
| FriReducedOpeningAir | 1 | 524,288 |  | 36 | 25 | 31,981,568 | 
...
| PhantomAir | 0 | 32,768 |  | 8 | 6 | 458,752 | 
| PhantomAir | 1 | 32,768 |  | 8 | 6 | 458,752 | 
| ProgramAir | 0 | 524,288 |  | 8 | 10 | 9,437,184 | 
| ProgramAir | 1 | 524,288 |  | 8 | 10 | 9,437,184 | 
...
| VmAirWrapper<JalNativeAdapterAir, JalCoreAir> | 0 | 65,536 |  | 12 | 9 | 1,376,256 | 
| VmAirWrapper<JalNativeAdapterAir, JalCoreAir> | 1 | 65,536 |  | 12 | 9 | 1,376,256 | 
...
| VmAirWrapper<NativeLoadStoreAdapterAir<4>, NativeLoadStoreCoreAir<4> | 0 | 65,536 |  | 24 | 31 | 3,604,480 | 
| VmAirWrapper<NativeLoadStoreAdapterAir<4>, NativeLoadStoreCoreAir<4> | 1 | 65,536 |  | 24 | 31 | 3,604,480 | 
| VmAirWrapper<NativeVectorizedAdapterAir<4>, FieldExtensionCoreAir> | 0 | 262,144 |  | 20 | 38 | 15,204,352 | 
| VmAirWrapper<NativeVectorizedAdapterAir<4>, FieldExtensionCoreAir> | 1 | 262,144 |  | 20 | 38 | 15,204,352 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,594 | 8,313 |  | 209,921,543 | 6,234 | 857 | 1,145 | 1,253 | 1,436 | 1,342 | 92,686,348 | 193 | 485 | 
| regex_program | 1 | 1,271 | 6,508 | 1,914,103 | 149,454,692 | 4,821 | 615 | 823 | 1,114 | 1,209 | 892 | 72,769,025 | 151 | 416 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 0 | 2,562 | 19,393 | 2,977,969 | 353,773,272 | 16,139 | 2,065 | 3,069 | 3,445 | 3,718 | 3,559 | 131,047,058 | 280 | 692 | 
| 1 | 2,501 | 17,814 | 2,905,376 | 353,780,696 | 14,641 | 2,932 | 2,294 | 2,228 | 3,698 | 3,013 | 127,848,151 | 473 | 672 | 

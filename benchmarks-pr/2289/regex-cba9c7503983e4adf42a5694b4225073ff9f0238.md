...
| `total_proof_time_ms ` |  570.75 |  2,283 |  691 |  516 |
...
| `execute_preflight_insn_mi/s` |  32.41 | -          |  33.79 |  29.24 |
| `trace_gen_time_ms   ` |  176.50 |  706 |  211 |  154 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  273.25 |  1,093 |  289 |  256 |
| `main_trace_commit_time_ms` |  51.50 |  206 |  57 |  49 |
| `generate_perm_trace_time_ms` |  22 |  88 |  25 |  18 |
| `perm_trace_commit_time_ms` |  63.94 |  255.77 |  70.81 |  54.30 |
| `quotient_poly_compute_time_ms` |  58.25 |  232.99 |  70.59 |  51.92 |
| `quotient_poly_commit_time_ms` |  14.83 |  59.34 |  17.80 |  12.58 |
| `pcs_opening_time_ms ` |  59.25 |  237 |  72 |  52 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 535 | 1 | 38 | 4,137,512 | 107.83 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 211 | 691 | 23,437,436 | 150,778,428 | 211 | 289 | 0 | 58.08 | 17.80 | 5 | 70.81 | 60 | 94 | 60 | 4 | 57 | 10,891,066 | 22 | 44 | 1,103,000 | 29.24 | 21 | 76 | 1 | 60 | 
| regex_program | 1 | 154 | 541 | 11,597,664 | 128,513,066 | 154 | 280 | 1 | 51.92 | 14.53 | 4 | 64.77 | 72 | 90 | 72 | 0 | 50 | 2,195,390 | 25 | 65 | 1,104,000 | 33.19 | 16 | 67 | 0 | 72 | 
| regex_program | 2 | 161 | 516 | 11,579,760 | 128,513,066 | 161 | 256 | 1 | 52.40 | 14.43 | 4 | 65.89 | 53 | 84 | 53 | 0 | 50 | 2,177,774 | 18 | 57 | 1,104,000 | 33.43 | 16 | 67 | 0 | 53 | 
| regex_program | 3 | 180 | 535 | 11,853,280 | 103,456,394 | 180 | 268 | 0 | 70.59 | 12.58 | 5 | 54.30 | 52 | 81 | 52 | 0 | 49 | 2,421,998 | 23 | 45 | 826,512 | 33.79 | 18 | 84 | 1 | 52 | 
...
Commit: https://github.com/openvm-org/openvm/commit/cba9c7503983e4adf42a5694b4225073ff9f0238
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19909782249)

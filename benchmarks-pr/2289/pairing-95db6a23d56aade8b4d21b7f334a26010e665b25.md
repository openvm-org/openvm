...
| `total_proof_time_ms ` |  753.50 |  1,507 |  876 |  631 |
...
| `execute_preflight_insn_mi/s` |  14.45 | -          |  18.04 |  10.86 |
| `trace_gen_time_ms   ` |  187.50 |  375 |  195 |  180 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  375.50 |  751 |  417 |  334 |
| `main_trace_commit_time_ms` |  65 |  130 |  75 |  55 |
| `generate_perm_trace_time_ms` |  37 |  74 |  42 |  32 |
| `perm_trace_commit_time_ms` |  76.97 |  153.93 |  88.52 |  65.42 |
| `quotient_poly_compute_time_ms` |  79.12 |  158.24 |  86.98 |  71.26 |
| `quotient_poly_commit_time_ms` |  16.41 |  32.83 |  18.21 |  14.62 |
| `pcs_opening_time_ms ` |  96 |  192 |  101 |  91 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 631 | 1 | 68 | 1,745,757 | 25.58 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 180 | 876 | 32,579,050 | 172,558,444 | 180 | 417 | 0 | 86.98 | 18.21 | 6 | 88.52 | 101 | 133 | 101 | 1 | 75 | 15,992,408 | 42 | 109 | 1,151,000 | 10.86 | 26 | 106 | 1 | 101 | 
| pairing | 1 | 195 | 631 | 22,427,652 | 119,958,502 | 195 | 334 | 1 | 71.26 | 14.62 | 6 | 65.42 | 91 | 101 | 91 | 0 | 55 | 9,471,642 | 32 | 61 | 594,757 | 18.04 | 20 | 86 | 1 | 91 | 

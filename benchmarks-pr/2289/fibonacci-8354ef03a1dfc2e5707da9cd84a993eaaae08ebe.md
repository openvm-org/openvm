...
|:---|---:|---:|
| Total |  1.06 |  0.59 |
| fibonacci_program |  1.04 |  0.58 |


| fibonacci_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  522 |  1,044 |  580 |  464 |
...
| `execute_preflight_insn_mi/s` |  36.82 | -          |  38.70 |  34.94 |
| `trace_gen_time_ms   ` |  192 |  384 |  196 |  188 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  194.50 |  389 |  202 |  187 |
| `main_trace_commit_time_ms` |  30.50 |  61 |  33 |  28 |
| `generate_perm_trace_time_ms` |  16.50 |  33 |  20 |  13 |
| `perm_trace_commit_time_ms` |  41.75 |  83.51 |  43.64 |  39.87 |
| `quotient_poly_compute_time_ms` |  31.59 |  63.18 |  34.88 |  28.30 |
| `quotient_poly_commit_time_ms` |  12.12 |  24.25 |  12.23 |  12.02 |
...
| --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 464 | 1 | 13 | 1,500,269 | 111.67 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 196 | 580 | 9,680,746 | 84,399,632 | 196 | 187 | 0 | 34.88 | 12.02 | 4 | 43.64 | 42 | 64 | 42 | 0 | 33 | 1,038,336 | 20 | 25 | 873,000 | 34.94 | 14 | 47 | 1 | 42 | 
| fibonacci_program | 1 | 188 | 464 | 9,708,456 | 74,305,770 | 188 | 202 | 1 | 28.30 | 12.23 | 4 | 39.87 | 78 | 53 | 78 | 0 | 28 | 1,064,414 | 13 | 32 | 627,269 | 38.70 | 11 | 40 | 0 | 78 | 

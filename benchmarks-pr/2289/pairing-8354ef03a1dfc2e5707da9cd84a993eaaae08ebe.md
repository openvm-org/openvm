...
| `total_proof_time_ms ` |  738 |  1,476 |  845 |  631 |
...
| `execute_metered_insn_mi/s` |  25.70 | -          |  25.70 |  25.70 |
| `execute_preflight_insns` |  872,878.50 |  1,745,757 |  1,151,000 |  594,757 |
| `execute_preflight_time_ms` |  85 |  170 |  109 |  61 |
| `execute_preflight_insn_mi/s` |  14.48 | -          |  18.11 |  10.86 |
| `trace_gen_time_ms   ` |  186 |  372 |  191 |  181 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  361 |  722 |  385 |  337 |
| `main_trace_commit_time_ms` |  65 |  130 |  75 |  55 |
| `generate_perm_trace_time_ms` |  53.50 |  107 |  67 |  40 |
| `perm_trace_commit_time_ms` |  74.48 |  148.95 |  84.56 |  64.39 |
| `quotient_poly_compute_time_ms` |  76.83 |  153.66 |  83.75 |  69.90 |
| `quotient_poly_commit_time_ms` |  15.59 |  31.18 |  17.34 |  13.84 |
| `pcs_opening_time_ms ` |  70.50 |  141 |  79 |  62 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 631 | 1 | 67 | 1,745,757 | 25.70 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 181 | 845 | 32,579,050 | 172,558,444 | 181 | 385 | 0 | 83.75 | 17.34 | 6 | 84.56 | 79 | 127 | 79 | 0 | 75 | 15,992,408 | 40 | 109 | 1,151,000 | 10.86 | 26 | 101 | 1 | 79 | 
| pairing | 1 | 191 | 631 | 22,427,652 | 119,958,502 | 191 | 337 | 1 | 69.90 | 13.84 | 6 | 64.39 | 62 | 135 | 62 | 0 | 55 | 9,471,642 | 67 | 61 | 594,757 | 18.11 | 20 | 84 | 1 | 62 | 

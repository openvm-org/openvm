...
| `total_proof_time_ms ` |  711.50 |  1,423 |  823 |  600 |
| `main_cells_used     ` |  12,732,025 |  25,464,050 |  15,992,408 |  9,471,642 |
| `total_cells_used    ` |  27,503,351 |  55,006,702 |  32,579,050 |  22,427,652 |
...
| `execute_preflight_time_ms` |  85 |  170 |  108 |  62 |
| `execute_preflight_insn_mi/s` |  14.63 | -          |  18.32 |  10.95 |
| `trace_gen_time_ms   ` |  187 |  374 |  191 |  183 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  346 |  692 |  387 |  305 |
| `main_trace_commit_time_ms` |  65 |  130 |  75 |  55 |
| `generate_perm_trace_time_ms` |  33.50 |  67 |  34 |  33 |
| `perm_trace_commit_time_ms` |  76.93 |  153.86 |  88.84 |  65.02 |
| `quotient_poly_compute_time_ms` |  79.08 |  158.16 |  87.38 |  70.78 |
| `quotient_poly_commit_time_ms` |  15.89 |  31.78 |  17.29 |  14.49 |
| `pcs_opening_time_ms ` |  71 |  142 |  80 |  62 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 600 | 1 | 67 | 1,745,757 | 25.67 | 0 | 
...
| pairing | Rv32HintStoreAir | 2 | 19 | 29 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 183 | 823 | 32,579,050 | 172,558,444 | 183 | 387 | 0 | 87.38 | 17.29 | 6 | 88.84 | 80 | 125 | 80 | 0 | 75 | 15,992,408 | 34 | 108 | 1,151,000 | 10.95 | 26 | 105 | 1 | 80 | 
| pairing | 1 | 191 | 600 | 22,427,652 | 119,958,502 | 191 | 305 | 1 | 70.78 | 14.49 | 6 | 65.02 | 62 | 101 | 61 | 0 | 55 | 9,471,642 | 33 | 62 | 594,757 | 18.32 | 20 | 85 | 1 | 61 | 

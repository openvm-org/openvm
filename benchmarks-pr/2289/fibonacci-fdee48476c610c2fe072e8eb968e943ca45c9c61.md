...
| `total_proof_time_ms ` |  486.50 |  973 |  546 |  427 |
...
| `execute_metered_insn_mi/s` |  144.74 | -          |  144.74 |  144.74 |
| `execute_preflight_insns` |  750,134.50 |  1,500,269 |  873,000 |  627,269 |
| `execute_preflight_time_ms` |  28 |  56 |  31 |  25 |
| `execute_preflight_insn_mi/s` |  38.49 | -          |  40.56 |  36.42 |
| `trace_gen_time_ms   ` |  188.50 |  377 |  194 |  183 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  177.50 |  355 |  184 |  171 |
| `main_trace_commit_time_ms` |  30 |  60 |  32 |  28 |
| `generate_perm_trace_time_ms` |  16 |  32 |  19 |  13 |
| `perm_trace_commit_time_ms` |  41.25 |  82.50 |  44.46 |  38.05 |
| `quotient_poly_compute_time_ms` |  29.32 |  58.64 |  31.27 |  27.37 |
| `quotient_poly_commit_time_ms` |  11.47 |  22.94 |  11.88 |  11.06 |
...
| --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 427 | 1 | 10 | 1,500,269 | 144.74 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 194 | 546 | 9,680,746 | 84,399,632 | 194 | 184 | 0 | 31.27 | 11.88 | 4 | 44.46 | 49 | 58 | 48 | 0 | 32 | 1,038,336 | 13 | 25 | 873,000 | 36.42 | 14 | 43 | 1 | 48 | 
| fibonacci_program | 1 | 183 | 427 | 9,708,456 | 74,305,770 | 183 | 171 | 1 | 27.37 | 11.06 | 4 | 38.05 | 46 | 57 | 46 | 0 | 28 | 1,064,414 | 19 | 31 | 627,269 | 40.56 | 11 | 38 | 0 | 46 | 
...
Commit: https://github.com/openvm-org/openvm/commit/fdee48476c610c2fe072e8eb968e943ca45c9c61
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19876179411)

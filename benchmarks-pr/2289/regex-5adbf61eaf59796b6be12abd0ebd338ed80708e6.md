...
|:---|---:|---:|
| Total |  2.36 |  0.75 |
| regex_program |  2.32 |  0.71 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  581 |  2,324 |  714 |  529 |
...
| `execute_preflight_time_ms` |  52 |  208 |  64 |  43 |
| `execute_preflight_insn_mi/s` |  32.42 | -          |  33.53 |  29.25 |
| `trace_gen_time_ms   ` |  184.75 |  739 |  218 |  162 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  277 |  1,108 |  309 |  261 |
| `main_trace_commit_time_ms` |  52.50 |  210 |  58 |  50 |
| `generate_perm_trace_time_ms` |  26.75 |  107 |  39 |  19 |
| `perm_trace_commit_time_ms` |  65.53 |  262.13 |  71.30 |  56.34 |
| `quotient_poly_compute_time_ms` |  60.17 |  240.67 |  71.30 |  53.48 |
| `quotient_poly_commit_time_ms` |  15.35 |  61.39 |  18.08 |  12.95 |
| `pcs_opening_time_ms ` |  53.25 |  213 |  57 |  49 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 549 | 1 | 38 | 4,137,512 | 106.17 | 0 | 
...
| regex_program | Rv32HintStoreAir | 2 | 19 | 29 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 218 | 714 | 23,437,436 | 150,778,428 | 218 | 309 | 0 | 62 | 18.08 | 5 | 71.30 | 57 | 111 | 57 | 4 | 58 | 10,891,066 | 39 | 44 | 1,103,000 | 29.25 | 21 | 80 | 1 | 57 | 
| regex_program | 1 | 162 | 532 | 11,597,664 | 128,513,066 | 162 | 264 | 1 | 53.90 | 15.27 | 4 | 66.96 | 49 | 93 | 49 | 0 | 51 | 2,195,390 | 25 | 64 | 1,104,000 | 33.53 | 16 | 69 | 0 | 49 | 
| regex_program | 2 | 169 | 529 | 11,579,760 | 128,513,066 | 169 | 261 | 1 | 53.48 | 15.08 | 4 | 67.53 | 54 | 87 | 54 | 0 | 50 | 2,177,774 | 19 | 57 | 1,104,000 | 33.36 | 16 | 69 | 0 | 54 | 
| regex_program | 3 | 190 | 549 | 11,853,280 | 103,456,394 | 190 | 274 | 0 | 71.30 | 12.95 | 5 | 56.34 | 53 | 84 | 53 | 0 | 51 | 2,421,998 | 24 | 43 | 826,512 | 33.53 | 18 | 85 | 1 | 53 | 
...
| regex_program | 0 | 6 | 3,318,528 | 2,013,265,921 | 
| regex_program | 0 | 7 | 69,632 | 2,013,265,921 | 
| regex_program | 0 | 8 | 27,752,717 | 2,013,265,921 | 
...
Commit: https://github.com/openvm-org/openvm/commit/5adbf61eaf59796b6be12abd0ebd338ed80708e6
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19909279618)

...
| `total_proof_time_ms ` |  702 |  1,404 |  813 |  591 |
...
| `execute_preflight_insn_mi/s` |  14.66 | -          |  18.30 |  11.01 |
| `trace_gen_time_ms   ` |  187.50 |  375 |  195 |  180 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  338 |  676 |  381 |  295 |
| `main_trace_commit_time_ms` |  64.50 |  129 |  74 |  55 |
| `generate_perm_trace_time_ms` |  33.50 |  67 |  34 |  33 |
| `perm_trace_commit_time_ms` |  76.39 |  152.78 |  87.72 |  65.06 |
| `quotient_poly_compute_time_ms` |  78.38 |  156.75 |  86.74 |  70.01 |
| `quotient_poly_commit_time_ms` |  16.17 |  32.34 |  18.65 |  13.69 |
| `pcs_opening_time_ms ` |  65 |  130 |  76 |  54 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 591 | 1 | 68 | 1,745,757 | 25.51 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 180 | 813 | 32,579,050 | 172,558,444 | 180 | 381 | 0 | 86.74 | 18.65 | 6 | 87.72 | 76 | 124 | 76 | 1 | 74 | 15,992,408 | 34 | 108 | 1,151,000 | 11.01 | 26 | 106 | 1 | 76 | 
| pairing | 1 | 195 | 591 | 22,427,652 | 119,958,502 | 195 | 295 | 1 | 70.01 | 13.69 | 5 | 65.06 | 54 | 101 | 54 | 0 | 55 | 9,471,642 | 33 | 59 | 594,757 | 18.30 | 20 | 84 | 1 | 54 | 

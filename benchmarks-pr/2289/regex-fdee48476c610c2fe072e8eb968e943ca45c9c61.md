...
| `total_proof_time_ms ` |  577 |  2,308 |  710 |  527 |
...
| `execute_metered_insn_mi/s` |  96.36 | -          |  96.36 |  96.36 |
| `execute_preflight_insns` |  1,034,378 |  4,137,512 |  1,104,000 |  826,512 |
| `execute_preflight_time_ms` |  54.25 |  217 |  66 |  46 |
| `execute_preflight_insn_mi/s` |  32.14 | -          |  33.60 |  28.58 |
| `trace_gen_time_ms   ` |  178.25 |  713 |  212 |  155 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  276.50 |  1,106 |  305 |  263 |
| `main_trace_commit_time_ms` |  51.50 |  206 |  56 |  50 |
| `generate_perm_trace_time_ms` |  30 |  120 |  32 |  28 |
| `perm_trace_commit_time_ms` |  63.71 |  254.84 |  70.37 |  54.66 |
| `quotient_poly_compute_time_ms` |  57.100 |  231.98 |  68.73 |  51.80 |
| `quotient_poly_commit_time_ms` |  14.90 |  59.59 |  17.82 |  12.30 |
| `pcs_opening_time_ms ` |  54.75 |  219 |  69 |  50 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 543 | 1 | 42 | 4,137,512 | 96.36 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 212 | 710 | 23,437,436 | 150,778,428 | 212 | 305 | 0 | 59.39 | 17.82 | 5 | 70.37 | 69 | 101 | 69 | 4 | 56 | 10,891,066 | 29 | 46 | 1,103,000 | 28.58 | 21 | 77 | 1 | 69 | 
| regex_program | 1 | 155 | 528 | 11,597,664 | 128,513,066 | 155 | 265 | 1 | 52.07 | 14.24 | 4 | 64.69 | 50 | 97 | 50 | 0 | 50 | 2,195,390 | 32 | 66 | 1,104,000 | 32.98 | 16 | 66 | 0 | 50 | 
| regex_program | 2 | 163 | 527 | 11,579,760 | 128,513,066 | 163 | 263 | 1 | 51.80 | 15.24 | 4 | 65.11 | 50 | 94 | 50 | 0 | 50 | 2,177,774 | 28 | 59 | 1,104,000 | 33.38 | 17 | 67 | 0 | 50 | 
| regex_program | 3 | 183 | 543 | 11,853,280 | 103,456,394 | 183 | 273 | 0 | 68.73 | 12.30 | 5 | 54.66 | 50 | 89 | 50 | 0 | 50 | 2,421,998 | 31 | 46 | 826,512 | 33.60 | 18 | 82 | 1 | 50 | 

...
| `total_proof_time_ms ` |  582.50 |  2,330 |  723 |  515 |
...
| `execute_metered_insn_mi/s` |  107.95 | -          |  107.95 |  107.95 |
| `execute_preflight_insns` |  1,034,378 |  4,137,512 |  1,104,000 |  826,512 |
| `execute_preflight_time_ms` |  52 |  208 |  63 |  44 |
| `execute_preflight_insn_mi/s` |  32.64 | -          |  34.02 |  29.04 |
| `trace_gen_time_ms   ` |  177 |  708 |  208 |  156 |
| `memory_finalize_time_ms` |  1.25 |  5 |  5 |  0 |
| `stark_prove_excluding_trace_time_ms` |  279.25 |  1,117 |  303 |  255 |
| `main_trace_commit_time_ms` |  52 |  208 |  57 |  50 |
| `generate_perm_trace_time_ms` |  33 |  132 |  47 |  18 |
| `perm_trace_commit_time_ms` |  63.53 |  254.12 |  69.55 |  54.03 |
| `quotient_poly_compute_time_ms` |  58.42 |  233.68 |  70.31 |  52.07 |
| `quotient_poly_commit_time_ms` |  14.99 |  59.96 |  17.83 |  12.49 |
| `pcs_opening_time_ms ` |  54 |  216 |  64 |  47 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 571 | 1 | 38 | 4,137,512 | 107.95 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 208 | 723 | 23,437,436 | 150,778,428 | 208 | 299 | 0 | 58.86 | 17.83 | 5 | 69.55 | 56 | 108 | 56 | 5 | 57 | 10,891,066 | 37 | 45 | 1,103,000 | 29.04 | 21 | 77 | 1 | 56 | 
| regex_program | 1 | 156 | 515 | 11,597,664 | 128,513,066 | 156 | 255 | 1 | 52.43 | 15.27 | 4 | 66.28 | 49 | 85 | 49 | 0 | 51 | 2,195,390 | 18 | 63 | 1,104,000 | 34.02 | 16 | 68 | 0 | 49 | 
| regex_program | 2 | 162 | 521 | 11,579,760 | 128,513,066 | 162 | 260 | 1 | 52.07 | 14.37 | 4 | 64.25 | 47 | 94 | 47 | 0 | 50 | 2,177,774 | 30 | 56 | 1,104,000 | 34.01 | 16 | 67 | 0 | 47 | 
| regex_program | 3 | 182 | 571 | 11,853,280 | 103,456,394 | 182 | 303 | 0 | 70.31 | 12.49 | 5 | 54.03 | 64 | 104 | 64 | 0 | 50 | 2,421,998 | 47 | 44 | 826,512 | 33.49 | 18 | 83 | 1 | 64 | 
...
Commit: https://github.com/openvm-org/openvm/commit/8354ef03a1dfc2e5707da9cd84a993eaaae08ebe
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19968669537)

...
|:---|---:|---:|
| Total | <span style='color: red'>(+0 [+0.2%])</span> 1.50 | <span style='color: red'>(+0 [+1.8%])</span> 0.90 |
| pairing | <span style='color: red'>(+0 [+0.3%])</span> 1.44 | <span style='color: red'>(+0 [+2.2%])</span> 0.83 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+2 [+0.3%])</span> 718 | <span style='color: red'>(+5 [+0.3%])</span> 1,436 | <span style='color: red'>(+18 [+2.2%])</span> 834 | <span style='color: green'>(-13 [-2.1%])</span> 602 |
| `main_cells_used     ` | <span style='color: red'>(+27874 [+0.2%])</span> 12,732,025 | <span style='color: red'>(+55748 [+0.2%])</span> 25,464,050 | <span style='color: red'>(+83000 [+0.5%])</span> 15,992,408 | <span style='color: green'>(-27252 [-0.3%])</span> 9,471,642 |
| `total_cells_used    ` | <span style='color: red'>(+31178 [+0.1%])</span> 27,503,351 | <span style='color: red'>(+62356 [+0.1%])</span> 55,006,702 | <span style='color: red'>(+98936 [+0.3%])</span> 32,579,050 | <span style='color: green'>(-36580 [-0.2%])</span> 22,427,652 |
| `execute_metered_time_ms` | <span style='color: green'>(-2 [-2.9%])</span> 68 | -          | -          | -          |
| `execute_metered_insn_mi/s` | <span style='color: red'>(+1 [+2.5%])</span> 25.54 | -          | <span style='color: red'>(+1 [+2.5%])</span> 25.54 | <span style='color: red'>(+1 [+2.5%])</span> 25.54 |
| `execute_preflight_insns` |  872,878.50 |  1,745,757 | <span style='color: red'>(+2000 [+0.2%])</span> 1,151,000 | <span style='color: green'>(-1985 [-0.3%])</span> 594,757 |
| `execute_preflight_time_ms` | <span style='color: red'>(+2 [+2.4%])</span> 85.50 | <span style='color: red'>(+4 [+2.4%])</span> 171 | <span style='color: red'>(+1 [+0.9%])</span> 109 | <span style='color: red'>(+3 [+5.1%])</span> 62 |
| `execute_preflight_insn_mi/s` | <span style='color: green'>(-0 [-2.0%])</span> 14.49 | -          | <span style='color: green'>(-0 [-2.6%])</span> 18.11 | <span style='color: green'>(-0 [-1.1%])</span> 10.87 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+2 [+0.8%])</span> 187 | <span style='color: red'>(+3 [+0.8%])</span> 374 | <span style='color: red'>(+1 [+0.5%])</span> 193 | <span style='color: red'>(+2 [+1.1%])</span> 181 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: green'>(-2 [-0.7%])</span> 352 | <span style='color: green'>(-5 [-0.7%])</span> 704 | <span style='color: red'>(+12 [+3.1%])</span> 398 | <span style='color: green'>(-17 [-5.3%])</span> 306 |
| `main_trace_commit_time_ms` | <span style='color: green'>(-0 [-0.8%])</span> 63.50 | <span style='color: green'>(-1 [-0.8%])</span> 127 |  74 | <span style='color: green'>(-1 [-1.9%])</span> 53 |
| `generate_perm_trace_time_ms` | <span style='color: red'>(+3 [+7.9%])</span> 41 | <span style='color: red'>(+6 [+7.9%])</span> 82 | <span style='color: red'>(+1 [+2.5%])</span> 41 | <span style='color: red'>(+5 [+13.9%])</span> 41 |
| `perm_trace_commit_time_ms` | <span style='color: green'>(-2 [-2.4%])</span> 74.11 | <span style='color: green'>(-4 [-2.4%])</span> 148.22 | <span style='color: green'>(-4 [-4.7%])</span> 83.86 | <span style='color: red'>(+0 [+0.8%])</span> 64.36 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+0 [+0.1%])</span> 77.94 | <span style='color: red'>(+0 [+0.1%])</span> 155.89 | <span style='color: green'>(-1 [-0.8%])</span> 85.45 | <span style='color: red'>(+1 [+1.3%])</span> 70.43 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+1 [+5.0%])</span> 16.59 | <span style='color: red'>(+2 [+5.0%])</span> 33.17 | <span style='color: red'>(+2 [+10.4%])</span> 19.01 | <span style='color: green'>(-0 [-1.4%])</span> 14.16 |
| `pcs_opening_time_ms ` | <span style='color: green'>(-3 [-3.9%])</span> 74 | <span style='color: green'>(-6 [-3.9%])</span> 148 | <span style='color: red'>(+11 [+13.9%])</span> 90 | <span style='color: green'>(-17 [-22.7%])</span> 58 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 602 | 1 | 68 | 1,745,757 | 25.54 | 0 | 
...
| pairing | Rv32HintStoreAir | 2 | 19 | 28 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 181 | 834 | 32,579,050 | 172,558,444 | 181 | 398 | 0 | 85.45 | 19.01 | 6 | 83.86 | 90 | 127 | 89 | 0 | 74 | 15,992,408 | 41 | 109 | 1,151,000 | 10.87 | 26 | 105 | 1 | 89 | 
| pairing | 1 | 193 | 602 | 22,427,652 | 119,958,502 | 193 | 306 | 1 | 70.43 | 14.16 | 5 | 64.36 | 58 | 109 | 57 | 1 | 53 | 9,471,642 | 41 | 62 | 594,757 | 18.11 | 20 | 85 | 1 | 57 | 
...
| pairing | 0 | 6 | 3,152,144 | 2,013,265,921 | 
| pairing | 0 | 7 | 3,072 | 2,013,265,921 | 
| pairing | 0 | 8 | 32,586,069 | 2,013,265,921 | 
...
Commit: https://github.com/openvm-org/openvm/commit/fed41ee05ca81b24d1fd106886dbfcf16b950909
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19867591224)

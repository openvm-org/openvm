...
| `total_proof_time_ms ` |  716.50 |  1,433 |  846 |  587 |
...
| `execute_metered_insn_mi/s` |  25.58 | -          |  25.58 |  25.58 |
| `execute_preflight_insns` |  872,878.50 |  1,745,757 |  1,151,000 |  594,757 |
| `execute_preflight_time_ms` |  85 |  170 |  110 |  60 |
| `execute_preflight_insn_mi/s` |  14.60 | -          |  18.30 |  10.90 |
| `trace_gen_time_ms   ` |  183.50 |  367 |  191 |  176 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  355 |  710 |  416 |  294 |
| `main_trace_commit_time_ms` |  63.50 |  127 |  74 |  53 |
| `generate_perm_trace_time_ms` |  38.50 |  77 |  44 |  33 |
| `perm_trace_commit_time_ms` |  76.46 |  152.92 |  88.46 |  64.46 |
| `quotient_poly_compute_time_ms` |  77.85 |  155.69 |  85.53 |  70.16 |
| `quotient_poly_commit_time_ms` |  15.43 |  30.86 |  16.73 |  14.13 |
| `pcs_opening_time_ms ` |  78 |  156 |  103 |  53 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 587 | 1 | 68 | 1,745,757 | 25.58 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 176 | 846 | 32,579,050 | 172,558,444 | 176 | 416 | 0 | 85.53 | 16.73 | 6 | 88.46 | 103 | 135 | 103 | 1 | 74 | 15,992,408 | 44 | 110 | 1,151,000 | 10.90 | 26 | 103 | 1 | 103 | 
| pairing | 1 | 191 | 587 | 22,427,652 | 119,958,502 | 191 | 294 | 1 | 70.16 | 14.13 | 6 | 64.46 | 53 | 101 | 53 | 0 | 53 | 9,471,642 | 33 | 60 | 594,757 | 18.30 | 20 | 84 | 1 | 53 | 

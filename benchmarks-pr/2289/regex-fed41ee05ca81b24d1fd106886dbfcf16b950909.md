...
|:---|---:|---:|
| Total | <span style='color: green'>(-0 [-0.1%])</span> 2.38 | <span style='color: green'>(-0 [-1.9%])</span> 0.73 |
| regex_program | <span style='color: green'>(-0 [-0.2%])</span> 2.35 | <span style='color: green'>(-0 [-2.3%])</span> 0.69 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: green'>(-1 [-0.2%])</span> 586.50 | <span style='color: green'>(-5 [-0.2%])</span> 2,346 | <span style='color: green'>(-16 [-2.3%])</span> 693 | <span style='color: red'>(+11 [+2.1%])</span> 536 |
...
| `execute_metered_insn_mi/s` | <span style='color: green'>(-6 [-5.7%])</span> 107.16 | -          | <span style='color: green'>(-6 [-5.7%])</span> 107.16 | <span style='color: green'>(-6 [-5.7%])</span> 107.16 |
| `execute_preflight_insns` |  1,034,378 |  4,137,512 |  1,104,000 |  826,512 |
| `execute_preflight_time_ms` | <span style='color: red'>(+1 [+1.4%])</span> 52.75 | <span style='color: red'>(+3 [+1.4%])</span> 211 | <span style='color: red'>(+1 [+1.6%])</span> 64 | <span style='color: red'>(+1 [+2.3%])</span> 44 |
| `execute_preflight_insn_mi/s` |  32.36 | -          | <span style='color: green'>(-0 [-0.5%])</span> 33.60 | <span style='color: red'>(+0 [+0.6%])</span> 29.34 |
| `trace_gen_time_ms   ` | <span style='color: green'>(-2 [-1.1%])</span> 178.50 | <span style='color: green'>(-8 [-1.1%])</span> 714 | <span style='color: green'>(-1 [-0.5%])</span> 212 | <span style='color: green'>(-2 [-1.3%])</span> 156 |
...
| `stark_prove_excluding_trace_time_ms` |  287.50 |  1,150 | <span style='color: green'>(-7 [-2.3%])</span> 299 | <span style='color: red'>(+3 [+1.1%])</span> 266 |
| `main_trace_commit_time_ms` | <span style='color: red'>(+0 [+0.5%])</span> 51.75 | <span style='color: red'>(+1 [+0.5%])</span> 207 | <span style='color: green'>(-1 [-1.8%])</span> 55 | <span style='color: red'>(+1 [+2.0%])</span> 50 |
| `generate_perm_trace_time_ms` | <span style='color: green'>(-3 [-9.4%])</span> 29 | <span style='color: green'>(-12 [-9.4%])</span> 116 | <span style='color: green'>(-11 [-22.4%])</span> 38 | <span style='color: green'>(-2 [-8.7%])</span> 21 |
| `perm_trace_commit_time_ms` | <span style='color: green'>(-0 [-0.2%])</span> 64.54 | <span style='color: green'>(-0 [-0.2%])</span> 258.15 | <span style='color: red'>(+1 [+1.5%])</span> 72.63 |  55.56 |
| `quotient_poly_compute_time_ms` | <span style='color: green'>(-1 [-1.1%])</span> 57.55 | <span style='color: green'>(-2 [-1.1%])</span> 230.21 | <span style='color: green'>(-1 [-1.6%])</span> 68.47 | <span style='color: red'>(+0 [+0.9%])</span> 51.90 |
| `quotient_poly_commit_time_ms` | <span style='color: green'>(-0 [-3.1%])</span> 14.72 | <span style='color: green'>(-2 [-3.1%])</span> 58.89 | <span style='color: green'>(-1 [-5.6%])</span> 16.47 | <span style='color: green'>(-1 [-6.0%])</span> 12.30 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+4 [+5.5%])</span> 66.75 | <span style='color: red'>(+14 [+5.5%])</span> 267 | <span style='color: red'>(+11 [+15.1%])</span> 84 |  53 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 536 | 1 | 38 | 4,137,512 | 107.16 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 212 | 693 | 23,437,436 | 150,778,428 | 212 | 291 | 0 | 57.87 | 16.47 | 5 | 72.63 | 61 | 98 | 61 | 4 | 55 | 10,891,066 | 25 | 45 | 1,103,000 | 29.34 | 21 | 75 | 1 | 61 | 
| regex_program | 1 | 156 | 556 | 11,597,664 | 128,513,066 | 156 | 294 | 1 | 51.90 | 15.79 | 4 | 65.70 | 69 | 104 | 69 | 0 | 51 | 2,195,390 | 38 | 64 | 1,104,000 | 33.60 | 17 | 68 | 0 | 69 | 
| regex_program | 2 | 162 | 561 | 11,579,760 | 128,513,066 | 162 | 299 | 1 | 51.96 | 14.33 | 4 | 64.26 | 84 | 97 | 84 | 0 | 50 | 2,177,774 | 32 | 58 | 1,104,000 | 33.21 | 16 | 66 | 0 | 84 | 
| regex_program | 3 | 184 | 536 | 11,853,280 | 103,456,394 | 184 | 266 | 0 | 68.47 | 12.30 | 5 | 55.56 | 53 | 79 | 52 | 0 | 51 | 2,421,998 | 21 | 44 | 826,512 | 33.27 | 18 | 81 | 1 | 52 | 

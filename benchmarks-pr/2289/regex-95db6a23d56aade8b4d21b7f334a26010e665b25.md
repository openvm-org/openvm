...
| `total_proof_time_ms ` |  600.25 |  2,401 |  740 |  514 |
...
| `execute_preflight_insn_mi/s` |  31.57 | -          |  32.95 |  28.40 |
| `trace_gen_time_ms   ` |  176.75 |  707 |  210 |  154 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  296.75 |  1,187 |  317 |  254 |
| `main_trace_commit_time_ms` |  51.25 |  205 |  56 |  49 |
| `generate_perm_trace_time_ms` |  35.50 |  142 |  54 |  20 |
| `perm_trace_commit_time_ms` |  62.78 |  251.14 |  68.76 |  53.76 |
| `quotient_poly_compute_time_ms` |  58.20 |  232.78 |  69.16 |  51.27 |
| `quotient_poly_commit_time_ms` |  14.69 |  58.75 |  17.57 |  12.28 |
| `pcs_opening_time_ms ` |  71.50 |  286 |  112 |  50 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 569 | 1 | 44 | 4,137,512 | 91.99 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 210 | 740 | 23,437,436 | 150,778,428 | 210 | 316 | 0 | 60.15 | 17.57 | 5 | 68.76 | 58 | 123 | 57 | 4 | 56 | 10,891,066 | 54 | 45 | 1,103,000 | 28.40 | 21 | 78 | 1 | 57 | 
| regex_program | 1 | 154 | 578 | 11,597,664 | 128,513,066 | 154 | 317 | 1 | 51.27 | 14.40 | 4 | 64.06 | 112 | 89 | 112 | 0 | 49 | 2,195,390 | 24 | 65 | 1,104,000 | 32.36 | 16 | 66 | 0 | 112 | 
| regex_program | 2 | 161 | 514 | 11,579,760 | 128,513,066 | 161 | 254 | 1 | 52.20 | 14.50 | 4 | 64.56 | 50 | 86 | 50 | 0 | 50 | 2,177,774 | 20 | 57 | 1,104,000 | 32.95 | 16 | 67 | 0 | 50 | 
| regex_program | 3 | 182 | 569 | 11,853,280 | 103,456,394 | 182 | 300 | 0 | 69.16 | 12.28 | 5 | 53.76 | 66 | 101 | 66 | 0 | 50 | 2,421,998 | 44 | 44 | 826,512 | 32.58 | 18 | 82 | 1 | 66 | 

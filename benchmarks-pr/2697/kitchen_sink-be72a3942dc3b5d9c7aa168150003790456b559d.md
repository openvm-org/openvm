...
| `total_proof_time_ms ` |  1,182 |  2,364 |  1,411 |  953 |
...
| `execute_preflight_insn_mi/s` |  8.19 | -          |  10.84 |  5.54 |
| `trace_gen_time_ms   ` |  158.50 |  317 |  189 |  128 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  840 |  1,680 |  1,018 |  662 |
| `prover.main_trace_commit_time_ms` |  219 |  438 |  288 |  150 |
| `prover.rap_constraints_time_ms` |  559 |  1,118 |  656 |  462 |
| `prover.openings_time_ms` |  60.50 |  121 |  72 |  49 |
| `prover.rap_constraints.logup_gkr_time_ms` |  138.50 |  277 |  152 |  125 |
| `prover.rap_constraints.round0_time_ms` |  289.50 |  579 |  366 |  213 |
| `prover.rap_constraints.mle_rounds_time_ms` |  130 |  260 |  137 |  123 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/be72a3942dc3b5d9c7aa168150003790456b559d/kitchen_sink-be72a3942dc3b5d9c7aa168150003790456b559d.memory.svg)
...
| app_proof |  |  |  |  |  | 953 |  |  | 7 | 154,763 | 20.24 | 0 | 2,377 |  | 
...
| leaf | 0 | 105 | 412 | 104 | 25 | 11 | 17 | 5 | 5 | 
...
| internal_recursive.0 | 1 | prover | 23,651,975 | 100 | 19 | 0 | 4 | 51 | 17 | 17 | 19 | 13 | 0 | 29 | 8 | 21 | 1 | 20 | 19 | 51 | 0 | 1 | 12 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 17,507,975 | 94 | 14 | 0 | 4 | 48 | 17 | 16 | 18 | 13 | 0 | 30 | 9 | 21 | 0 | 20 | 14 | 48 | 0 | 1 | 12 | 0 | 0 | 
| leaf | 0 | prover | 407,935,872 | 307 | 123 | 0 | 9 | 140 | 46 | 45 | 35 | 58 | 0 | 42 | 11 | 31 | 6 | 24 | 123 | 140 | 0 | 2 | 57 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 816,542,084 | 1,018 | 288 | 0 | 159 | 656 | 366 | 365 | 137 | 152 | 59 | 72 | 12 | 60 | 15 | 44 | 288 | 656 | 0 | 1 | 91 | 0 | 0 | 
| app_proof | prover | 1 | 800,298,548 | 662 | 150 | 0 | 20 | 462 | 213 | 213 | 123 | 125 | 71 | 49 | 12 | 36 | 14 | 22 | 150 | 462 | 0 | 1 | 53 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 189 | 1,411 | 189 | 183 | 0 | 5 | 20 | 121,000 | 10.84 | 
| app_proof | 1 | 128 | 953 | 128 | 40 | 0 | 3 | 121 | 33,763 | 5.54 | 

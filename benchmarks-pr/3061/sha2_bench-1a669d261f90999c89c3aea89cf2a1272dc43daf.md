...
|:---|---:|---:|---:|
| Total |  5.65 |  4.21 |  4.21 |
| app_proof |  4.70 |  3.26 |  3.26 |
| leaf |  0.53 |  0.53 |  0.53 |
...
| `total_proof_time_ms ` |  2,319 |  4,638 |  3,197 |  1,441 |
| `compile_metered_time_ms` |  6 |  6 |  6 |  6 |
| `execute_metered_time_ms` |  66 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  167.99 | -          |  167.99 |  167.99 |
| `execute_preflight_insns` |  5,583,980.50 |  11,167,961 |  7,136,000 |  4,031,961 |
| `execute_preflight_time_ms` |  158.50 |  317 |  216 |  101 |
| `execute_preflight_insn_mi/s` |  37.94 | -          |  40.26 |  35.62 |
| `trace_gen_time_ms   ` |  63.50 |  127 |  99 |  28 |
| `set_initial_memory_time_ms` |  0 |  0 |  0 |  0 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  2,095 |  4,190 |  2,880 |  1,310 |
| `prover.main_trace_commit_time_ms` |  728 |  1,456 |  1,232 |  224 |
| `prover.rap_constraints_time_ms` |  1,091.50 |  2,183 |  1,295 |  888 |
| `prover.openings_time_ms` |  275 |  550 |  352 |  198 |
| `prover.rap_constraints.logup_gkr_time_ms` |  379 |  758 |  405 |  353 |
...
| `prover.openings.whir_time_ms` |  199.50 |  399 |  254 |  145 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/1a669d261f90999c89c3aea89cf2a1272dc43daf/sha2_bench-1a669d261f90999c89c3aea89cf2a1272dc43daf.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 58 |  |  |  | 287 |  |  |  |  |  |  | 
| app_proof |  |  |  | 1,441 |  | 66 | 11,167,961 | 167.99 | 0 | 4,714 |  | 
...
| app_proof | 3 | MemoryMerkleAir<8> | 0 | 721 | 303 | 126,175 | 53,025 | 100,940 | 42,420 | 25,235 | 10,605 | 104,545 | 43,935 | 2,884 | 1,212 | 
...
| app_proof | 3 | MemoryMerkleAir<8> | 1 | 458 | 54 | 80,150 | 9,450 | 64,120 | 7,560 | 16,030 | 1,890 | 66,410 | 7,830 | 1,832 | 216 | 
...
| leaf | 0 | 120 | 525 | 120 | 33 | 13 | 2 | 9 | 9 | 
...
| leaf | 0 | prover | 237,929,272 | 405 | 145 | 0 | 0 | 141 | 70 | 69 | 44 | 26 | 0 | 117 | 95 | 21 | 10 | 11 | 146 | 145 | 141 | 0 | 3 | 25 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,315,603,879 | 2,880 | 1,232 | 0 | 0 | 1,295 | 704 | 703 | 237 | 353 | 1 | 352 | 254 | 97 | 59 | 37 | 1,232 | 1,232 | 1,295 | 0 | 1 | 351 | 0 | 0 | 
| app_proof | prover | 1 | 709,382,452 | 1,310 | 224 | 0 | 0 | 888 | 352 | 351 | 130 | 405 | 263 | 198 | 145 | 52 | 31 | 21 | 224 | 224 | 888 | 0 | 1 | 141 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 0 | 2 | 99 | 3,197 | 3 | 0 | 0 | 0 | 12,820,630,284 | 2,969,381,064 | 15,790,011,348 | 2,097,152 | 2 | 0 | 0 | 0 | 3 | 96 | 216 | 7,136,000 | 35.62 | 0 | 0 | 
| app_proof | 1 | 0 | 1 | 28 | 1,441 | 2 | 0 | 0 | 0 | 7,274,065,428 | 1,627,789,445 | 8,901,854,873 | 2,097,152 | 2 | 0 | 0 | 0 | 2 | 25 | 101 | 4,031,961 | 40.26 | 0 | 0 | 

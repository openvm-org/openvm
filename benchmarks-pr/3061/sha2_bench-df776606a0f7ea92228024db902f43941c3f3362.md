...
| `total_proof_time_ms ` |  2,081.50 |  4,163 |  2,816 |  1,347 |
| `compile_metered_time_ms` |  2 |  2 |  2 |  2 |
| `execute_metered_time_ms` |  65 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  170.91 | -          |  170.91 |  170.91 |
...
| `execute_preflight_insn_mi/s` |  21.44 | -          |  24.92 |  19.77 |
| `postflight_time_ms  ` |  82 |  164 |  111 |  53 |
| `postflight_memory_chronology_time_ms` |  7 |  14 |  10 |  4 |
| `postflight_program_index_time_ms` |  1 |  2 |  1 |  1 |
| `trace_gen_time_ms   ` |  58.50 |  117 |  93 |  24 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,646.50 |  3,293 |  2,209 |  1,084 |
| `prover.main_trace_commit_time_ms` |  395.50 |  791 |  573 |  218 |
| `prover.rap_constraints_time_ms` |  981 |  1,962 |  1,289 |  673 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/df776606a0f7ea92228024db902f43941c3f3362/sha2_bench-df776606a0f7ea92228024db902f43941c3f3362.memory.svg)
...
| leaf | 0 | 117 | 523 | 117 | 36 | 12 | 2 | 10 | 10 | 
...
| leaf | 0 | prover | 237,929,272 | 405 | 145 | 0 | 0 | 142 | 71 | 69 | 44 | 26 | 0 | 116 | 94 | 22 | 10 | 11 | 146 | 145 | 142 | 0 | 3 | 25 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover |  | 0 | 1,285,848,458 | 2,209 | 572 | 0 | 0 | 1,289 | 701 | 701 | 233 | 353 | 1 | 346 | 251 | 94 | 57 | 36 | 573 | 572 | 1,289 | 0 | 1 | 351 | 0 | 0 | 
| app_proof | prover |  | 1 | 690,310,084 | 1,084 | 218 | 0 | 0 | 673 | 350 | 349 | 127 | 196 | 0 | 191 | 139 | 52 | 30 | 21 | 218 | 218 | 673 | 0 | 1 | 195 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof |  | 1,347 | 65 | 11,167,961 | 170.91 | 0 | 4,235 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof |  | 0 | 0 | 2 | 93 | 2,816 | 3 | 0 | 0 | 111 | 1 | 10 | 0 | 12,567,620,256 | 2,865,326,040 | 15,432,946,296 | 2,097,152 | 2 | 0 | 0 | 3 | 90 | 360 | 7,136,000 | 19.77 | 0 | 0 | 
| app_proof |  | 1 | 0 | 2 | 24 | 1,347 | 2 | 0 | 0 | 53 | 1 | 4 | 0 | 7,131,111,864 | 1,694,453,537 | 8,825,565,401 | 2,097,152 | 2 | 0 | 0 | 2 | 21 | 161 | 4,031,961 | 24.92 | 0 | 0 | 

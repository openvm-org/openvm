...
|:---|---:|---:|---:|
| Total |  11.54 |  3.53 |  3.53 |
| app_proof |  9.30 |  1.81 |  1.81 |
| leaf |  1.41 |  0.90 |  0.90 |
...
| `total_proof_time_ms ` |  1,527.67 |  9,166 |  1,676 |  1,439 |
| `execute_metered_time_ms` |  136 | -          | -          | -          |
| `execute_metered_insns` |  14,793,960 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  108.02 | -          |  108.02 |  108.02 |
| `execute_preflight_insns` |  2,465,660 |  14,793,960 |  2,625,000 |  1,670,960 |
| `execute_preflight_time_ms` |  125.67 |  754 |  160 |  86 |
| `execute_preflight_insn_mi/s` |  39.75 | -          |  40.31 |  37.85 |
| `trace_gen_time_ms   ` |  128.67 |  772 |  164 |  109 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,194.50 |  7,167 |  1,241 |  1,160 |
| `prover.main_trace_commit_time_ms` |  288.50 |  1,731 |  289 |  288 |
| `prover.rap_constraints_time_ms` |  814.67 |  4,888 |  861 |  781 |
| `prover.openings_time_ms` |  90.17 |  541 |  92 |  88 |
| `prover.rap_constraints.logup_gkr_time_ms` |  276.83 |  1,661 |  320 |  255 |
| `prover.rap_constraints.round0_time_ms` |  366 |  2,196 |  371 |  357 |
| `prover.rap_constraints.mle_rounds_time_ms` |  170.33 |  1,022 |  173 |  166 |
| `prover.openings.stacked_reduction_time_ms` |  61 |  366 |  61 |  61 |
| `prover.openings.stacked_reduction.round0_time_ms` |  31.83 |  191 |  32 |  31 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  28.50 |  171 |  29 |  28 |
| `prover.openings.whir_time_ms` |  28.83 |  173 |  31 |  27 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  707 |  1,414 |  900 |  514 |
| `execute_preflight_time_ms` |  2 |  4 |  2 |  2 |
| `trace_gen_time_ms   ` |  76.50 |  153 |  103 |  50 |
| `generate_blob_total_time_ms` |  10.50 |  21 |  14 |  7 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  630 |  1,260 |  796 |  464 |
...
| `prover.rap_constraints.logup_gkr_time_ms` |  64.50 |  129 |  78 |  51 |
| `prover.rap_constraints.round0_time_ms` |  102.50 |  205 |  133 |  72 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/293c488325d91a561b3bde8e063d07f2e5b20b3e/sha2_bench-293c488325d91a561b3bde8e063d07f2e5b20b3e.memory.svg)

| Module | Max (GB) | Max At |
| --- | ---: | --- |
| prover.batch_constraints.before_round0 | 6.63 | app_proof.prover.5 |
| frac_sumcheck.gkr_rounds | 6.63 | app_proof.prover.5 |
| prover.rap_constraints | 6.45 | leaf.0.prover |
| frac_sumcheck.segment_tree | 6.41 | app_proof.prover.5 |
| prover.gkr_input_evals | 6.41 | app_proof.prover.5 |
| prover.openings | 6.15 | leaf.0.prover |
| prover.prove_whir_opening | 6.15 | leaf.0.prover |
| prover.merkle_tree | 6.15 | leaf.0.prover |
| prover.batch_constraints.fold_ple_evals | 5.82 | leaf.0.prover |
| prover.batch_constraints.round0 | 5.82 | leaf.0.prover |
...
| app_proof |  |  |  |  |  | 1,439 |  |  | 136 | 14,793,960 | 108.02 | 0 | 9,310 |  | 
...
| leaf | 0 | 103 | 900 | 103 | 38 | 14 | 2 | 3 | 3 | 
| leaf | 1 | 50 | 514 | 49 | 19 | 7 | 2 | 3 | 3 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 75,647,860 | 454 | 227 | 0 | 13 | 168 | 45 | 44 | 86 | 35 | 0 | 57 | 20 | 37 | 7 | 30 | 228 | 168 | 0 | 2 | 34 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,879 | 174 | 52 | 0 | 4 | 78 | 26 | 25 | 29 | 23 | 0 | 43 | 19 | 24 | 2 | 22 | 52 | 78 | 0 | 2 | 22 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 142 | 34 | 0 | 4 | 67 | 22 | 22 | 24 | 19 | 0 | 40 | 17 | 22 | 1 | 21 | 34 | 67 | 0 | 2 | 18 | 0 | 0 | 
| leaf | 0 | prover | 266,560,230 | 796 | 412 | 0 | 26 | 292 | 133 | 132 | 79 | 78 | 0 | 91 | 34 | 56 | 22 | 33 | 413 | 292 | 0 | 5 | 78 | 0 | 0 | 
| leaf | 1 | prover | 135,246,516 | 464 | 225 | 0 | 14 | 172 | 72 | 71 | 48 | 51 | 0 | 66 | 27 | 38 | 11 | 26 | 226 | 172 | 0 | 5 | 49 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 353,899,717 | 1,234 | 288 | 0 | 21 | 855 | 368 | 367 | 171 | 315 | 75 | 90 | 29 | 61 | 32 | 28 | 288 | 855 | 0 | 3 | 238 | 0 | 0 | 
| app_proof | prover | 1 | 353,899,532 | 1,241 | 288 | 0 | 19 | 861 | 368 | 368 | 171 | 320 | 77 | 91 | 29 | 61 | 32 | 28 | 288 | 861 | 0 | 3 | 242 | 0 | 0 | 
| app_proof | prover | 2 | 353,899,532 | 1,175 | 289 | 0 | 19 | 797 | 367 | 367 | 171 | 257 | 0 | 88 | 27 | 61 | 32 | 29 | 289 | 797 | 0 | 3 | 256 | 0 | 0 | 
| app_proof | prover | 3 | 353,899,532 | 1,180 | 289 | 0 | 19 | 797 | 371 | 371 | 170 | 255 | 0 | 92 | 31 | 61 | 32 | 28 | 289 | 797 | 0 | 3 | 254 | 0 | 0 | 
| app_proof | prover | 4 | 353,899,532 | 1,177 | 289 | 0 | 19 | 797 | 365 | 365 | 173 | 257 | 0 | 91 | 29 | 61 | 32 | 29 | 289 | 797 | 0 | 3 | 256 | 0 | 0 | 
| app_proof | prover | 5 | 353,980,012 | 1,160 | 288 | 0 | 20 | 781 | 357 | 356 | 166 | 257 | 0 | 89 | 28 | 61 | 31 | 29 | 288 | 781 | 0 | 3 | 255 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 164 | 1,648 | 164 | 162 | 0 | 3 | 86 | 2,623,000 | 37.85 | 
| app_proof | 1 | 134 | 1,676 | 134 | 140 | 0 | 2 | 160 | 2,625,000 | 40.15 | 
| app_proof | 2 | 111 | 1,466 | 111 | 41 | 0 | 3 | 138 | 2,625,000 | 40.31 | 
| app_proof | 3 | 110 | 1,470 | 110 | 41 | 0 | 2 | 138 | 2,625,000 | 40.23 | 
| app_proof | 4 | 109 | 1,467 | 109 | 41 | 0 | 2 | 139 | 2,625,000 | 39.76 | 
| app_proof | 5 | 144 | 1,439 | 144 | 41 | 0 | 2 | 93 | 1,670,960 | 40.18 | 

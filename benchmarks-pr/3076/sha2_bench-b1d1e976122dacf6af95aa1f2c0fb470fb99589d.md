...
| `total_proof_time_ms ` |  2,388 |  4,776 |  3,272 |  1,504 |
| `compile_metered_time_ms` |  6 |  6 |  6 |  6 |
| `execute_metered_time_ms` |  56 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  198.44 | -          |  198.44 |  198.44 |
| `execute_preflight_insns` |  5,583,980.50 |  11,167,961 |  7,136,000 |  4,031,961 |
| `execute_preflight_time_ms` |  163 |  326 |  221 |  105 |
| `execute_preflight_insn_mi/s` |  36.56 | -          |  39.07 |  34.05 |
| `trace_gen_time_ms   ` |  65 |  130 |  103 |  27 |
| `set_initial_memory_time_ms` |  0 |  0 |  0 |  0 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  2,158 |  4,316 |  2,945 |  1,371 |
| `prover.main_trace_commit_time_ms` |  754 |  1,508 |  1,283 |  225 |
| `prover.rap_constraints_time_ms` |  1,126 |  2,252 |  1,305 |  947 |
| `prover.openings_time_ms` |  277 |  554 |  356 |  198 |
| `prover.rap_constraints.logup_gkr_time_ms` |  409.50 |  819 |  461 |  358 |
| `prover.rap_constraints.round0_time_ms` |  530.50 |  1,061 |  707 |  354 |
| `prover.rap_constraints.mle_rounds_time_ms` |  184.50 |  369 |  238 |  131 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/b1d1e976122dacf6af95aa1f2c0fb470fb99589d/sha2_bench-b1d1e976122dacf6af95aa1f2c0fb470fb99589d.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 58 |  |  |  | 290 |  |  |  |  |  |  | 
| app_proof |  |  |  | 1,504 |  | 56 | 11,167,961 | 198.44 | 0 | 4,842 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 173 | 46 | 0 | 0 | 80 | 29 | 28 | 36 | 13 | 0 | 46 | 36 | 10 | 2 | 7 | 47 | 46 | 80 | 0 | 1 | 12 | 0 | 0 | 
...
| leaf | 0 | prover | 237,929,272 | 406 | 146 | 0 | 0 | 142 | 71 | 69 | 44 | 26 | 0 | 117 | 95 | 22 | 10 | 11 | 146 | 146 | 142 | 0 | 3 | 25 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,315,601,831 | 2,945 | 1,283 | 0 | 0 | 1,305 | 707 | 706 | 238 | 358 | 1 | 356 | 259 | 96 | 59 | 37 | 1,283 | 1,283 | 1,305 | 0 | 1 | 357 | 0 | 0 | 
| app_proof | prover | 1 | 709,381,428 | 1,371 | 225 | 0 | 0 | 947 | 354 | 353 | 131 | 461 | 278 | 198 | 144 | 53 | 31 | 21 | 225 | 225 | 947 | 0 | 1 | 183 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 0 | 2 | 103 | 3,272 | 3 | 0 | 0 | 0 | 12,820,730,880 | 2,969,255,892 | 15,789,986,772 | 2,097,152 | 2 | 0 | 0 | 0 | 3 | 100 | 221 | 7,136,000 | 34.05 | 0 | 0 | 
| app_proof | 1 | 0 | 2 | 27 | 1,504 | 2 | 0 | 0 | 0 | 7,276,196,868 | 1,627,061,653 | 8,903,258,521 | 2,097,152 | 2 | 0 | 0 | 0 | 2 | 24 | 105 | 4,031,961 | 39.07 | 0 | 0 | 

...
| `total_proof_time_ms ` |  587.75 |  2,351 |  745 |  534 |
...
| `execute_preflight_insn_mi/s` |  30.47 | -          |  32.19 |  26.06 |
| `trace_gen_time_ms   ` |  176.75 |  707 |  205 |  157 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  290 |  1,160 |  346 |  268 |
| `main_trace_commit_time_ms` |  51.50 |  206 |  57 |  49 |
| `generate_perm_trace_time_ms` |  34.50 |  138 |  55 |  18 |
| `perm_trace_commit_time_ms` |  63.95 |  255.81 |  69.95 |  55.94 |
| `quotient_poly_compute_time_ms` |  58.11 |  232.45 |  68.93 |  51.39 |
| `quotient_poly_commit_time_ms` |  15.02 |  60.08 |  18.08 |  12.52 |
| `pcs_opening_time_ms ` |  63.25 |  253 |  83 |  51 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 536 | 1 | 38 | 4,137,502 | 108.22 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 205 | 745 | 23,446,148 | 150,778,428 | 205 | 346 | 0 | 59.93 | 18.08 | 5 | 69.95 | 83 | 126 | 83 | 4 | 57 | 10,899,170 | 55 | 49 | 1,103,000 | 26.06 | 21 | 78 | 1 | 83 | 
| regex_program | 1 | 157 | 534 | 11,598,276 | 128,513,066 | 157 | 272 | 1 | 52.19 | 14.34 | 4 | 64.35 | 51 | 103 | 51 | 0 | 49 | 2,196,106 | 38 | 64 | 1,104,000 | 32.19 | 16 | 67 | 0 | 51 | 
| regex_program | 2 | 163 | 536 | 11,579,064 | 128,513,066 | 163 | 274 | 1 | 51.39 | 15.14 | 4 | 65.56 | 62 | 93 | 62 | 0 | 50 | 2,177,334 | 27 | 58 | 1,104,000 | 31.82 | 17 | 67 | 0 | 62 | 
| regex_program | 3 | 182 | 536 | 11,853,872 | 103,456,394 | 182 | 268 | 0 | 68.93 | 12.52 | 5 | 55.94 | 57 | 77 | 57 | 0 | 50 | 2,422,606 | 18 | 45 | 826,502 | 31.81 | 18 | 82 | 1 | 57 | 
...
Commit: https://github.com/openvm-org/openvm/commit/6234f8e62c51075d34a5fc72a3311a679aae7518
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19355095138)

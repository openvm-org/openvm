...
| `total_proof_time_ms ` |  488 |  976 |  552 |  424 |
...
| `execute_metered_insn_mi/s` |  111.86 | -          |  111.86 |  111.86 |
| `execute_preflight_insns` |  750,104.50 |  1,500,209 |  873,000 |  627,209 |
| `execute_preflight_time_ms` |  29.50 |  59 |  33 |  26 |
| `execute_preflight_insn_mi/s` |  36.15 | -          |  38.14 |  34.16 |
| `trace_gen_time_ms   ` |  191.50 |  383 |  196 |  187 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  174 |  348 |  186 |  162 |
| `main_trace_commit_time_ms` |  30.50 |  61 |  33 |  28 |
| `generate_perm_trace_time_ms` |  13.50 |  27 |  16 |  11 |
| `perm_trace_commit_time_ms` |  41.65 |  83.30 |  44.54 |  38.77 |
| `quotient_poly_compute_time_ms` |  31.22 |  62.44 |  32.21 |  30.23 |
| `quotient_poly_commit_time_ms` |  12.15 |  24.31 |  12.75 |  11.56 |
| `pcs_opening_time_ms ` |  43.50 |  87 |  46 |  41 |
...
| --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 424 | 1 | 13 | 1,500,209 | 111.86 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 196 | 552 | 9,677,708 | 84,395,212 | 196 | 186 | 0 | 32.21 | 12.75 | 4 | 44.54 | 46 | 61 | 45 | 0 | 33 | 1,035,986 | 16 | 26 | 873,000 | 34.16 | 14 | 45 | 0 | 45 | 
| fibonacci_program | 1 | 187 | 424 | 9,708,170 | 74,305,770 | 187 | 162 | 1 | 30.23 | 11.56 | 4 | 38.77 | 41 | 50 | 40 | 0 | 28 | 1,064,416 | 11 | 33 | 627,209 | 38.14 | 11 | 42 | 0 | 40 | 

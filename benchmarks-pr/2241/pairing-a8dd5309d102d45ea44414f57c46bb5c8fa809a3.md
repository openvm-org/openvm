...
| `total_proof_time_ms ` |  742.50 |  1,485 |  814 |  671 |
...
| `execute_preflight_time_ms` |  99 |  198 |  137 |  61 |
| `execute_preflight_insn_mi/s` |  13.17 | -          |  17.68 |  8.66 |
| `trace_gen_time_ms   ` |  173.50 |  347 |  192 |  155 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  378 |  756 |  379 |  377 |
| `main_trace_commit_time_ms` |  63.50 |  127 |  74 |  53 |
| `generate_perm_trace_time_ms` |  55.50 |  111 |  71 |  40 |
| `perm_trace_commit_time_ms` |  75.92 |  151.85 |  87.35 |  64.50 |
| `quotient_poly_compute_time_ms` |  77.99 |  155.99 |  86.06 |  69.93 |
| `quotient_poly_commit_time_ms` |  16.47 |  32.94 |  18.38 |  14.56 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 671 | 1 | 98 | 1,745,742 | 17.76 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 155 | 814 | 32,689,110 | 172,558,444 | 155 | 379 | 0 | 86.06 | 18.38 | 6 | 87.35 | 68 | 130 | 67 | 1 | 74 | 16,059,916 | 40 | 137 | 1,157,000 | 8.66 | 26 | 105 | 1 | 67 | 
| pairing | 1 | 192 | 671 | 22,314,288 | 119,958,502 | 192 | 377 | 1 | 69.93 | 14.56 | 6 | 64.50 | 98 | 139 | 98 | 0 | 53 | 9,408,294 | 71 | 61 | 588,742 | 17.68 | 20 | 85 | 1 | 98 | 

...
| `total_proof_time_ms ` |  593.25 |  2,373 |  744 |  539 |
...
| `execute_metered_insn_mi/s` |  114.52 | -          |  114.52 |  114.52 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  53.75 |  215 |  65 |  45 |
| `execute_preflight_insn_mi/s` |  30.86 | -          |  32.01 |  28.15 |
| `trace_gen_time_ms   ` |  180 |  720 |  213 |  158 |
| `memory_finalize_time_ms` |  1.25 |  5 |  5 |  0 |
| `stark_prove_excluding_trace_time_ms` |  291.75 |  1,167 |  340 |  267 |
| `main_trace_commit_time_ms` |  51.50 |  206 |  56 |  49 |
| `generate_perm_trace_time_ms` |  34.25 |  137 |  54 |  18 |
| `perm_trace_commit_time_ms` |  64.14 |  256.55 |  70.29 |  55.54 |
| `quotient_poly_compute_time_ms` |  58.60 |  234.41 |  68.99 |  52.05 |
| `quotient_poly_commit_time_ms` |  15.04 |  60.18 |  17.47 |  12.62 |
| `pcs_opening_time_ms ` |  64.75 |  259 |  77 |  57 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 539 | 1 | 36 | 4,137,502 | 114.52 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 213 | 744 | 23,446,148 | 150,778,428 | 213 | 340 | 0 | 61 | 17.47 | 5 | 70.29 | 77 | 126 | 77 | 5 | 56 | 10,899,170 | 54 | 47 | 1,103,000 | 28.15 | 21 | 79 | 1 | 77 | 
| regex_program | 1 | 158 | 551 | 11,598,276 | 128,513,066 | 158 | 286 | 1 | 52.05 | 15.06 | 4 | 65.41 | 63 | 104 | 63 | 0 | 50 | 2,196,106 | 38 | 65 | 1,104,000 | 31.69 | 17 | 67 | 0 | 62 | 
| regex_program | 2 | 164 | 539 | 11,579,064 | 128,513,066 | 164 | 274 | 1 | 52.37 | 15.02 | 4 | 65.32 | 62 | 93 | 62 | 0 | 51 | 2,177,334 | 27 | 58 | 1,104,000 | 32.01 | 17 | 67 | 0 | 62 | 
| regex_program | 3 | 185 | 539 | 11,853,872 | 103,456,394 | 185 | 267 | 0 | 68.99 | 12.62 | 5 | 55.54 | 57 | 77 | 57 | 0 | 49 | 2,422,606 | 18 | 45 | 826,502 | 31.59 | 18 | 82 | 1 | 57 | 

...
| `total_proof_time_ms ` |  712 |  1,424 |  813 |  611 |
...
| `execute_metered_insn_mi/s` |  17.90 | -          |  17.90 |  17.90 |
| `execute_preflight_insns` |  872,871 |  1,745,742 |  1,157,000 |  588,742 |
| `execute_preflight_time_ms` |  97.50 |  195 |  135 |  60 |
| `execute_preflight_insn_mi/s` |  13.57 | -          |  18.37 |  8.76 |
| `trace_gen_time_ms   ` |  170.50 |  341 |  190 |  151 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  350.50 |  701 |  382 |  319 |
| `main_trace_commit_time_ms` |  63.50 |  127 |  73 |  54 |
| `generate_perm_trace_time_ms` |  46.50 |  93 |  48 |  45 |
| `perm_trace_commit_time_ms` |  76.04 |  152.07 |  88.32 |  63.76 |
| `quotient_poly_compute_time_ms` |  77.94 |  155.88 |  86.12 |  69.76 |
| `quotient_poly_commit_time_ms` |  15.66 |  31.32 |  17.52 |  13.80 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 611 | 1 | 97 | 1,745,742 | 17.90 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 151 | 813 | 32,689,110 | 172,558,444 | 151 | 382 | 0 | 86.12 | 17.52 | 6 | 88.32 | 67 | 136 | 67 | 1 | 73 | 16,059,916 | 45 | 135 | 1,157,000 | 8.76 | 27 | 104 | 1 | 67 | 
| pairing | 1 | 190 | 611 | 22,314,288 | 119,958,502 | 190 | 319 | 1 | 69.76 | 13.80 | 6 | 63.76 | 65 | 115 | 65 | 0 | 54 | 9,408,294 | 48 | 60 | 588,742 | 18.37 | 20 | 84 | 1 | 65 | 

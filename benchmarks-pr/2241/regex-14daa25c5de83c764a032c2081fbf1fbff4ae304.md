...
| `total_proof_time_ms ` |  588.75 |  2,355 |  742 |  534 |
...
| `execute_preflight_time_ms` |  53.75 |  215 |  64 |  46 |
| `execute_preflight_insn_mi/s` |  30.49 | -          |  31.77 |  27.98 |
| `trace_gen_time_ms   ` |  176.25 |  705 |  209 |  154 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  290.75 |  1,163 |  342 |  268 |
| `main_trace_commit_time_ms` |  50.75 |  203 |  56 |  49 |
| `generate_perm_trace_time_ms` |  34.50 |  138 |  54 |  19 |
| `perm_trace_commit_time_ms` |  63.25 |  253.01 |  68.98 |  53.92 |
| `quotient_poly_compute_time_ms` |  58.86 |  235.46 |  70.97 |  51.57 |
| `quotient_poly_commit_time_ms` |  14.89 |  59.54 |  17.45 |  12.70 |
| `pcs_opening_time_ms ` |  65.50 |  262 |  82 |  57 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 538 | 1 | 36 | 4,137,502 | 114.06 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 209 | 742 | 23,446,148 | 150,778,428 | 209 | 342 | 0 | 60.92 | 17.45 | 5 | 68.98 | 82 | 124 | 82 | 4 | 56 | 10,899,170 | 54 | 46 | 1,103,000 | 27.98 | 21 | 79 | 1 | 82 | 
| regex_program | 1 | 154 | 541 | 11,598,276 | 128,513,066 | 154 | 280 | 1 | 51.57 | 14.23 | 4 | 64.01 | 62 | 102 | 62 | 0 | 49 | 2,196,106 | 38 | 64 | 1,104,000 | 31.77 | 16 | 66 | 0 | 62 | 
| regex_program | 2 | 160 | 534 | 11,579,064 | 128,513,066 | 160 | 273 | 1 | 52.01 | 15.17 | 4 | 66.10 | 61 | 94 | 61 | 0 | 49 | 2,177,334 | 27 | 59 | 1,104,000 | 31.66 | 16 | 67 | 0 | 61 | 
| regex_program | 3 | 182 | 538 | 11,853,872 | 103,456,394 | 182 | 268 | 0 | 70.97 | 12.70 | 6 | 53.92 | 57 | 76 | 56 | 0 | 49 | 2,422,606 | 19 | 46 | 826,502 | 30.53 | 18 | 84 | 1 | 56 | 
...
Commit: https://github.com/openvm-org/openvm/commit/14daa25c5de83c764a032c2081fbf1fbff4ae304
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19354966120)

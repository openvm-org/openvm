...
| `stark_prove_excluding_trace_time_ms` |  2,157 |  2,157 |  2,157 |  2,157 |
| `main_trace_commit_time_ms` |  383 |  383 |  383 |  383 |
| `generate_perm_trace_time_ms` |  33 |  33 |  33 |  33 |
| `perm_trace_commit_time_ms` |  350 |  350 |  350 |  350 |
| `quotient_poly_compute_time_ms` |  232 |  232 |  232 |  232 |
| `quotient_poly_commit_time_ms` |  475 |  475 |  475 |  475 |
| `pcs_opening_time_ms ` |  672 |  672 |  672 |  672 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  16,231 |  16,231 |  16,231 |  16,231 |
| `main_cells_used     ` |  168,285,437 |  168,285,437 |  168,285,437 |  168,285,437 |
| `total_cycles        ` |  3,484,740 |  3,484,740 |  3,484,740 |  3,484,740 |
| `execute_time_ms     ` |  931 |  931 |  931 |  931 |
| `trace_gen_time_ms   ` |  2,482 |  2,482 |  2,482 |  2,482 |
| `stark_prove_excluding_trace_time_ms` |  12,818 |  12,818 |  12,818 |  12,818 |
| `main_trace_commit_time_ms` |  2,734 |  2,734 |  2,734 |  2,734 |
| `generate_perm_trace_time_ms` |  335 |  335 |  335 |  335 |
| `perm_trace_commit_time_ms` |  2,711 |  2,711 |  2,711 |  2,711 |
| `quotient_poly_compute_time_ms` |  1,896 |  1,896 |  1,896 |  1,896 |
| `quotient_poly_commit_time_ms` |  2,401 |  2,401 |  2,401 |  2,401 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 2,482 | 16,231 | 3,484,740 | 430,851,032 | 12,818 | 1,896 | 2,401 | 2,711 | 2,737 | 2,734 | 168,285,437 | 335 | 931 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 180 | 2,483 | 284,567 | 38,417,467 | 2,157 | 232 | 475 | 350 | 672 | 383 | 15,055,723 | 33 | 146 | 

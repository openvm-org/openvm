...
| `total_proof_time_ms ` |  2,532 |  2,532 |  2,532 |  2,532 |
...
| `stark_prove_excluding_trace_time_ms` |  2,166 |  2,166 |  2,166 |  2,166 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  16,513 |  16,513 |  16,513 |  16,513 |
| `main_cells_used     ` |  168,286,112 |  168,286,112 |  168,286,112 |  168,286,112 |
| `total_cycles        ` |  3,484,815 |  3,484,815 |  3,484,815 |  3,484,815 |
| `execute_time_ms     ` |  932 |  932 |  932 |  932 |
| `trace_gen_time_ms   ` |  2,546 |  2,546 |  2,546 |  2,546 |
| `stark_prove_excluding_trace_time_ms` |  13,035 |  13,035 |  13,035 |  13,035 |
| `main_trace_commit_time_ms` |  2,728 |  2,728 |  2,728 |  2,728 |
| `generate_perm_trace_time_ms` |  345 |  345 |  345 |  345 |
| `perm_trace_commit_time_ms` |  2,719 |  2,719 |  2,719 |  2,719 |
| `quotient_poly_compute_time_ms` |  1,919 |  1,919 |  1,919 |  1,919 |
| `quotient_poly_commit_time_ms` |  2,428 |  2,428 |  2,428 |  2,428 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 2,546 | 16,513 | 3,484,815 | 430,851,032 | 13,035 | 1,919 | 2,428 | 2,719 | 2,893 | 2,728 | 168,286,112 | 345 | 932 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 218 | 2,532 | 284,567 | 38,417,467 | 2,166 | 226 | 475 | 359 | 659 | 396 | 15,055,723 | 39 | 148 | 

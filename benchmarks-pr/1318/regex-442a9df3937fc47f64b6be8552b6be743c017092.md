...
| `total_proof_time_ms ` |  7,598.50 |  15,197 |  8,539 |  6,658 |
...
| `trace_gen_time_ms   ` |  1,636.50 |  3,273 |  1,821 |  1,452 |
| `stark_prove_excluding_trace_time_ms` |  5,512 |  11,024 |  6,234 |  4,790 |
| `main_trace_commit_time_ms` |  1,092.50 |  2,185 |  1,343 |  842 |
| `generate_perm_trace_time_ms` |  174.50 |  349 |  192 |  157 |
| `perm_trace_commit_time_ms` |  1,187 |  2,374 |  1,262 |  1,112 |
| `quotient_poly_compute_time_ms` |  737.50 |  1,475 |  856 |  619 |
| `quotient_poly_commit_time_ms` |  981.50 |  1,963 |  1,137 |  826 |
| `pcs_opening_time_ms ` |  1,327.50 |  2,655 |  1,435 |  1,220 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  14,612.50 |  29,225 |  14,725 |  14,500 |
| `main_cells_used     ` |  129,446,727 |  258,893,454 |  131,045,879 |  127,847,575 |
| `total_cycles        ` |  2,941,575 |  5,883,150 |  2,977,838 |  2,905,312 |
| `execute_time_ms     ` |  644 |  1,288 |  697 |  591 |
| `trace_gen_time_ms   ` |  2,542 |  5,084 |  2,678 |  2,406 |
| `stark_prove_excluding_trace_time_ms` |  11,426.50 |  22,853 |  11,456 |  11,397 |
| `main_trace_commit_time_ms` |  2,355.50 |  4,711 |  2,375 |  2,336 |
| `generate_perm_trace_time_ms` |  288.50 |  577 |  290 |  287 |
| `perm_trace_commit_time_ms` |  2,306 |  4,612 |  2,317 |  2,295 |
| `quotient_poly_compute_time_ms` |  1,644 |  3,288 |  1,649 |  1,639 |
| `quotient_poly_commit_time_ms` |  2,235.50 |  4,471 |  2,246 |  2,225 |
| `pcs_opening_time_ms ` |  2,592 |  5,184 |  2,594 |  2,590 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 2,406 | 14,500 | 2,977,838 | 353,773,272 | 11,397 | 1,639 | 2,246 | 2,295 | 2,590 | 2,336 | 131,045,879 | 287 | 697 | 
| leaf | 1 | 2,678 | 14,725 | 2,905,312 | 353,780,696 | 11,456 | 1,649 | 2,225 | 2,317 | 2,594 | 2,375 | 127,847,575 | 290 | 591 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,821 | 8,539 |  | 209,921,543 | 6,234 | 856 | 1,137 | 1,262 | 1,435 | 1,343 | 92,686,348 | 192 | 484 | 
| regex_program | 1 | 1,452 | 6,658 | 1,914,103 | 149,454,692 | 4,790 | 619 | 826 | 1,112 | 1,220 | 842 | 72,769,025 | 157 | 416 | 

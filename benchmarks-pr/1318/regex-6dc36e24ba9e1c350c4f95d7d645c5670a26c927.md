...
| `total_proof_time_ms ` |  6,891 |  13,782 |  7,765 |  6,017 |
...
| `trace_gen_time_ms   ` |  1,090.50 |  2,181 |  1,252 |  929 |
| `stark_prove_excluding_trace_time_ms` |  5,362 |  10,724 |  6,041 |  4,683 |
| `main_trace_commit_time_ms` |  1,022 |  2,044 |  1,255 |  789 |
| `generate_perm_trace_time_ms` |  186.50 |  373 |  187 |  186 |
| `perm_trace_commit_time_ms` |  1,116 |  2,232 |  1,183 |  1,049 |
| `quotient_poly_compute_time_ms` |  746.50 |  1,493 |  870 |  623 |
| `quotient_poly_commit_time_ms` |  952 |  1,904 |  1,113 |  791 |
| `pcs_opening_time_ms ` |  1,329 |  2,658 |  1,425 |  1,233 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,724 |  15,448 |  7,974 |  7,474 |
| `main_cells_used     ` |  77,082,617.50 |  154,165,235 |  78,163,073 |  76,002,162 |
| `total_cycles        ` |  1,020,538.50 |  2,041,077 |  1,037,683 |  1,003,394 |
| `execute_time_ms     ` |  378.50 |  757 |  411 |  346 |
| `trace_gen_time_ms   ` |  1,132.50 |  2,265 |  1,208 |  1,057 |
| `stark_prove_excluding_trace_time_ms` |  6,213 |  12,426 |  6,506 |  5,920 |
| `main_trace_commit_time_ms` |  1,224 |  2,448 |  1,278 |  1,170 |
| `generate_perm_trace_time_ms` |  162 |  324 |  171 |  153 |
| `perm_trace_commit_time_ms` |  1,226.50 |  2,453 |  1,267 |  1,186 |
| `quotient_poly_compute_time_ms` |  965.50 |  1,931 |  1,028 |  903 |
| `quotient_poly_commit_time_ms` |  1,194 |  2,388 |  1,261 |  1,127 |
| `pcs_opening_time_ms ` |  1,437 |  2,874 |  1,498 |  1,376 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,057 | 7,974 | 1,037,683 | 220,669,656 | 6,506 | 1,028 | 1,261 | 1,267 | 1,498 | 1,278 | 78,163,073 | 171 | 411 | 
| leaf | 1 | 1,208 | 7,474 | 1,003,394 | 194,986,968 | 5,920 | 903 | 1,127 | 1,186 | 1,376 | 1,170 | 76,002,162 | 153 | 346 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,252 | 7,765 |  | 209,921,543 | 6,041 | 870 | 1,113 | 1,183 | 1,425 | 1,255 | 92,686,348 | 186 | 472 | 
| regex_program | 1 | 929 | 6,017 | 1,914,103 | 149,454,692 | 4,683 | 623 | 791 | 1,049 | 1,233 | 789 | 72,769,025 | 187 | 405 | 

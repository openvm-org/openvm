...
| `total_proof_time_ms ` |  2,505 |  2,505 |  2,505 |  2,505 |
...
| `stark_prove_excluding_trace_time_ms` |  2,135 |  2,135 |  2,135 |  2,135 |
| `main_trace_commit_time_ms` |  389 |  389 |  389 |  389 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  16,522 |  16,522 |  16,522 |  16,522 |
| `main_cells_used     ` |  169,239,433 |  169,239,433 |  169,239,433 |  169,239,433 |
| `total_cycles        ` |  3,521,158 |  3,521,158 |  3,521,158 |  3,521,158 |
| `execute_time_ms     ` |  935 |  935 |  935 |  935 |
| `trace_gen_time_ms   ` |  2,571 |  2,571 |  2,571 |  2,571 |
| `stark_prove_excluding_trace_time_ms` |  13,016 |  13,016 |  13,016 |  13,016 |
| `main_trace_commit_time_ms` |  2,707 |  2,707 |  2,707 |  2,707 |
| `generate_perm_trace_time_ms` |  340 |  340 |  340 |  340 |
| `perm_trace_commit_time_ms` |  2,737 |  2,737 |  2,737 |  2,737 |
| `quotient_poly_compute_time_ms` |  1,908 |  1,908 |  1,908 |  1,908 |
| `quotient_poly_commit_time_ms` |  2,444 |  2,444 |  2,444 |  2,444 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 2,571 | 16,522 | 3,521,158 | 431,539,160 | 13,016 | 1,908 | 2,444 | 2,737 | 2,875 | 2,707 | 169,239,433 | 340 | 935 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 217 | 2,505 | 284,567 | 38,417,467 | 2,135 | 227 | 467 | 356 | 650 | 389 | 15,055,723 | 33 | 153 | 

...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  17,578 |  17,578 |  17,578 |  17,578 |
| `main_cells_used     ` |  186,731,644 |  186,731,644 |  186,731,644 |  186,731,644 |
| `total_cycles        ` |  4,157,785 |  4,157,785 |  4,157,785 |  4,157,785 |
| `execute_time_ms     ` |  945 |  945 |  945 |  945 |
| `trace_gen_time_ms   ` |  3,064 |  3,064 |  3,064 |  3,064 |
| `stark_prove_excluding_trace_time_ms` |  13,569 |  13,569 |  13,569 |  13,569 |
| `main_trace_commit_time_ms` |  2,755 |  2,755 |  2,755 |  2,755 |
| `generate_perm_trace_time_ms` |  359 |  359 |  359 |  359 |
| `perm_trace_commit_time_ms` |  2,859 |  2,859 |  2,859 |  2,859 |
| `quotient_poly_compute_time_ms` |  2,053 |  2,053 |  2,053 |  2,053 |
| `quotient_poly_commit_time_ms` |  2,620 |  2,620 |  2,620 |  2,620 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 3,064 | 17,578 | 4,157,785 | 459,031,512 | 13,569 | 2,053 | 2,620 | 2,859 | 2,918 | 2,755 | 186,731,644 | 359 | 945 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 241 | 2,505 | 284,567 | 38,417,467 | 2,117 | 219 | 461 | 353 | 650 | 388 | 15,055,723 | 33 | 147 | 

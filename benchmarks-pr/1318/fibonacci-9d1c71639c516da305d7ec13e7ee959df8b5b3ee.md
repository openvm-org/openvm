...
| `trace_gen_time_ms   ` |  641 |  641 |  641 |  641 |
| `stark_prove_excluding_trace_time_ms` |  3,986 |  3,986 |  3,986 |  3,986 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  5,944 |  5,944 |  5,944 |  5,944 |
| `main_cells_used     ` |  49,912,304 |  49,912,304 |  49,912,304 |  49,912,304 |
| `total_cycles        ` |  1,212,836 |  1,212,836 |  1,212,836 |  1,212,836 |
| `execute_time_ms     ` |  327 |  327 |  327 |  327 |
| `trace_gen_time_ms   ` |  756 |  756 |  756 |  756 |
| `stark_prove_excluding_trace_time_ms` |  4,861 |  4,861 |  4,861 |  4,861 |
| `main_trace_commit_time_ms` |  967 |  967 |  967 |  967 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 756 | 5,944 | 1,212,836 | 139,379,672 | 4,861 | 665 | 971 | 910 | 1,226 | 967 | 49,912,304 | 118 | 327 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 641 | 4,936 | 1,500,095 | 122,458,476 | 3,986 | 517 | 741 | 742 | 1,045 | 796 | 51,485,080 | 141 | 309 | 

...
| `total_proof_time_ms ` |  5,273 |  5,273 |  5,273 |  5,273 |
| `main_cells_used     ` |  51,485,080 |  51,485,080 |  51,485,080 |  51,485,080 |
| `total_cycles        ` |  1,500,095 |  1,500,095 |  1,500,095 |  1,500,095 |
| `execute_time_ms     ` |  310 |  310 |  310 |  310 |
| `trace_gen_time_ms   ` |  772 |  772 |  772 |  772 |
| `stark_prove_excluding_trace_time_ms` |  4,191 |  4,191 |  4,191 |  4,191 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  6,978 |  6,978 |  6,978 |  6,978 |
| `main_cells_used     ` |  69,417,601 |  69,417,601 |  69,417,601 |  69,417,601 |
| `total_cycles        ` |  1,924,790 |  1,924,790 |  1,924,790 |  1,924,790 |
| `execute_time_ms     ` |  305 |  305 |  305 |  305 |
| `trace_gen_time_ms   ` |  1,237 |  1,237 |  1,237 |  1,237 |
...
| `perm_trace_commit_time_ms` |  1,037 |  1,037 |  1,037 |  1,037 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,237 | 6,978 | 1,924,790 | 157,336,536 | 5,436 | 784 | 1,096 | 1,037 | 1,310 | 1,069 | 69,417,601 | 135 | 305 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 772 | 5,273 | 1,500,095 | 122,458,476 | 4,191 | 528 | 791 | 804 | 1,065 | 863 | 51,485,080 | 136 | 310 | 

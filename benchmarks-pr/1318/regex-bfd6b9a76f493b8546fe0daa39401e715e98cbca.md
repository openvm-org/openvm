...
| `total_proof_time_ms ` |  7,105 |  14,210 |  8,066 |  6,144 |
| `main_cells_used     ` |  82,727,686.50 |  165,455,373 |  92,686,348 |  72,769,025 |
| `total_cycles        ` |  1,914,103 |  1,914,103 |  1,914,103 |  1,914,103 |
| `execute_time_ms     ` |  437.50 |  875 |  471 |  404 |
| `trace_gen_time_ms   ` |  1,158 |  2,316 |  1,372 |  944 |
| `stark_prove_excluding_trace_time_ms` |  5,509.50 |  11,019 |  6,223 |  4,796 |
| `main_trace_commit_time_ms` |  1,103 |  2,206 |  1,334 |  872 |
| `generate_perm_trace_time_ms` |  174.50 |  349 |  184 |  165 |
| `perm_trace_commit_time_ms` |  1,173 |  2,346 |  1,245 |  1,101 |
| `quotient_poly_compute_time_ms` |  741 |  1,482 |  870 |  612 |
| `quotient_poly_commit_time_ms` |  992.50 |  1,985 |  1,142 |  843 |
| `pcs_opening_time_ms ` |  1,317.50 |  2,635 |  1,441 |  1,194 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  12,882 |  25,764 |  13,051 |  12,713 |
| `main_cells_used     ` |  109,708,910 |  219,417,820 |  111,342,952 |  108,074,868 |
| `total_cycles        ` |  2,221,432 |  4,442,864 |  2,259,222 |  2,183,642 |
| `execute_time_ms     ` |  616 |  1,232 |  661 |  571 |
| `trace_gen_time_ms   ` |  1,818.50 |  3,637 |  1,985 |  1,652 |
| `stark_prove_excluding_trace_time_ms` |  10,447.50 |  20,895 |  10,738 |  10,157 |
| `main_trace_commit_time_ms` |  2,161 |  4,322 |  2,210 |  2,112 |
| `generate_perm_trace_time_ms` |  251.50 |  503 |  265 |  238 |
| `perm_trace_commit_time_ms` |  2,076 |  4,152 |  2,128 |  2,024 |
| `quotient_poly_compute_time_ms` |  1,488 |  2,976 |  1,544 |  1,432 |
| `quotient_poly_commit_time_ms` |  2,041 |  4,082 |  2,107 |  1,975 |
| `pcs_opening_time_ms ` |  2,426.50 |  4,853 |  2,480 |  2,373 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,652 | 13,051 | 2,259,222 | 328,738,520 | 10,738 | 1,544 | 2,107 | 2,128 | 2,480 | 2,210 | 111,342,952 | 265 | 661 | 
| leaf | 1 | 1,985 | 12,713 | 2,183,642 | 304,628,696 | 10,157 | 1,432 | 1,975 | 2,024 | 2,373 | 2,112 | 108,074,868 | 238 | 571 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,372 | 8,066 |  | 209,921,543 | 6,223 | 870 | 1,142 | 1,245 | 1,441 | 1,334 | 92,686,348 | 184 | 471 | 
| regex_program | 1 | 944 | 6,144 | 1,914,103 | 149,454,692 | 4,796 | 612 | 843 | 1,101 | 1,194 | 872 | 72,769,025 | 165 | 404 | 

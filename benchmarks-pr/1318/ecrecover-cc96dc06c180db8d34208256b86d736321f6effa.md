...
| `stark_prove_excluding_trace_time_ms` |  2,144 |  2,144 |  2,144 |  2,144 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  10,910 |  10,910 |  10,910 |  10,910 |
| `main_cells_used     ` |  117,306,003 |  117,306,003 |  117,306,003 |  117,306,003 |
| `total_cycles        ` |  1,592,216 |  1,592,216 |  1,592,216 |  1,592,216 |
| `execute_time_ms     ` |  573 |  573 |  573 |  573 |
| `trace_gen_time_ms   ` |  1,535 |  1,535 |  1,535 |  1,535 |
...
| `quotient_poly_compute_time_ms` |  1,454 |  1,454 |  1,454 |  1,454 |
| `quotient_poly_commit_time_ms` |  1,597 |  1,597 |  1,597 |  1,597 |
| `pcs_opening_time_ms ` |  1,841 |  1,841 |  1,841 |  1,841 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,535 | 10,910 | 1,592,216 | 334,709,720 | 8,802 | 1,454 | 1,597 | 1,892 | 1,841 | 1,748 | 117,306,003 | 267 | 573 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 182 | 2,473 | 284,567 | 38,417,467 | 2,144 | 226 | 470 | 353 | 668 | 381 | 15,055,723 | 33 | 147 | 

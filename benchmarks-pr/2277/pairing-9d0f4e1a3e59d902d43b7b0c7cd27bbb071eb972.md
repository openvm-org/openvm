...
|:---|---:|---:|
| Total | <span style='color: green'>(-0 [-1.3%])</span> 1.47 | <span style='color: green'>(-0 [-2.3%])</span> 0.88 |
| pairing | <span style='color: green'>(-0 [-1.1%])</span> 1.40 | <span style='color: green'>(-0 [-2.0%])</span> 0.81 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: green'>(-8 [-1.1%])</span> 702 | <span style='color: green'>(-16 [-1.1%])</span> 1,404 | <span style='color: green'>(-17 [-2.0%])</span> 813 | <span style='color: red'>(+1 [+0.2%])</span> 591 |
| `main_cells_used     ` |  12,734,105 |  25,468,210 |  16,059,916 |  9,408,294 |
| `total_cells_used    ` |  27,501,699 |  55,003,398 |  32,689,110 |  22,314,288 |
| `execute_metered_time_ms` | <span style='color: green'>(-4 [-6.0%])</span> 63 | -          | -          | -          |
| `execute_metered_insn_mi/s` | <span style='color: red'>(+2 [+6.3%])</span> 27.39 | -          | <span style='color: red'>(+2 [+6.3%])</span> 27.39 | <span style='color: red'>(+2 [+6.3%])</span> 27.39 |
| `execute_preflight_insns` |  872,871 |  1,745,742 |  1,157,000 |  588,742 |
| `execute_preflight_time_ms` |  83 |  166 | <span style='color: green'>(-2 [-1.9%])</span> 106 | <span style='color: red'>(+2 [+3.4%])</span> 60 |
| `execute_preflight_insn_mi/s` | <span style='color: green'>(-0 [-0.5%])</span> 14.70 | -          | <span style='color: green'>(-0 [-2.2%])</span> 18.15 | <span style='color: red'>(+0 [+2.3%])</span> 11.25 |
| `trace_gen_time_ms   ` | <span style='color: green'>(-2 [-0.8%])</span> 188.50 | <span style='color: green'>(-3 [-0.8%])</span> 377 | <span style='color: green'>(-1 [-0.5%])</span> 195 | <span style='color: green'>(-2 [-1.1%])</span> 182 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: green'>(-6 [-1.7%])</span> 337 | <span style='color: green'>(-12 [-1.7%])</span> 674 | <span style='color: green'>(-13 [-3.3%])</span> 380 | <span style='color: red'>(+1 [+0.3%])</span> 294 |
...
| `perm_trace_commit_time_ms` | <span style='color: green'>(-0 [-0.4%])</span> 76.82 | <span style='color: green'>(-1 [-0.4%])</span> 153.64 | <span style='color: green'>(-1 [-0.8%])</span> 88.46 | <span style='color: red'>(+0 [+0.2%])</span> 65.18 |
| `quotient_poly_compute_time_ms` |  78.93 |  157.86 | <span style='color: green'>(-0 [-0.3%])</span> 86.93 | <span style='color: red'>(+0 [+0.3%])</span> 70.93 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+1 [+4.9%])</span> 16.60 | <span style='color: red'>(+2 [+4.9%])</span> 33.20 | <span style='color: red'>(+2 [+9.1%])</span> 18.73 |  14.47 |
| `pcs_opening_time_ms ` | <span style='color: green'>(-7 [-10.7%])</span> 58.50 | <span style='color: green'>(-14 [-10.7%])</span> 117 | <span style='color: green'>(-15 [-19.0%])</span> 64 | <span style='color: red'>(+1 [+1.9%])</span> 53 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 591 | 1 | 63 | 1,745,742 | 27.39 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 182 | 813 | 32,689,110 | 172,558,444 | 182 | 380 | 0 | 86.93 | 18.73 | 6 | 88.46 | 64 | 133 | 63 | 1 | 76 | 16,059,916 | 41 | 106 | 1,157,000 | 11.25 | 26 | 106 | 1 | 63 | 
| pairing | 1 | 195 | 591 | 22,314,288 | 119,958,502 | 195 | 294 | 1 | 70.93 | 14.47 | 6 | 65.18 | 53 | 100 | 53 | 0 | 54 | 9,408,294 | 32 | 60 | 588,742 | 18.15 | 20 | 86 | 1 | 53 | 
...
Commit: https://github.com/openvm-org/openvm/commit/9d0f4e1a3e59d902d43b7b0c7cd27bbb071eb972
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19585050114)

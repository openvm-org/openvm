...
|:---|---:|---:|
| Total | <span style='color: red'>(+0 [+0.5%])</span> 1.49 | <span style='color: red'>(+0 [+0.3%])</span> 0.90 |
| pairing | <span style='color: red'>(+0 [+0.9%])</span> 1.43 | <span style='color: red'>(+0 [+1.0%])</span> 0.84 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+6 [+0.9%])</span> 715.50 | <span style='color: red'>(+13 [+0.9%])</span> 1,431 | <span style='color: red'>(+8 [+1.0%])</span> 836 | <span style='color: red'>(+5 [+0.8%])</span> 595 |
...
| `execute_metered_insn_mi/s` | <span style='color: red'>(+2 [+7.2%])</span> 27.49 | -          | <span style='color: red'>(+2 [+7.2%])</span> 27.49 | <span style='color: red'>(+2 [+7.2%])</span> 27.49 |
| `execute_preflight_insns` |  872,871 |  1,745,742 |  1,157,000 |  588,742 |
| `execute_preflight_time_ms` | <span style='color: green'>(-4 [-5.2%])</span> 82.50 | <span style='color: green'>(-9 [-5.2%])</span> 165 | <span style='color: green'>(-4 [-3.6%])</span> 106 | <span style='color: green'>(-5 [-7.8%])</span> 59 |
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+0 [+1.2%])</span> 14.66 | -          | <span style='color: red'>(+0 [+0.2%])</span> 18.12 | <span style='color: red'>(+0 [+2.8%])</span> 11.20 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+6 [+3.5%])</span> 192.50 | <span style='color: red'>(+13 [+3.5%])</span> 385 | <span style='color: red'>(+7 [+3.7%])</span> 197 | <span style='color: red'>(+6 [+3.3%])</span> 188 |
...
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+6 [+1.6%])</span> 347 | <span style='color: red'>(+11 [+1.6%])</span> 694 | <span style='color: red'>(+9 [+2.3%])</span> 398 | <span style='color: red'>(+2 [+0.7%])</span> 296 |
| `main_trace_commit_time_ms` | <span style='color: red'>(+3 [+4.8%])</span> 65.50 | <span style='color: red'>(+6 [+4.8%])</span> 131 | <span style='color: red'>(+5 [+7.0%])</span> 76 | <span style='color: red'>(+1 [+1.9%])</span> 55 |
| `generate_perm_trace_time_ms` | <span style='color: red'>(+1 [+2.8%])</span> 37 | <span style='color: red'>(+2 [+2.8%])</span> 74 | <span style='color: red'>(+2 [+5.0%])</span> 42 |  32 |
| `perm_trace_commit_time_ms` | <span style='color: red'>(+0 [+0.3%])</span> 77.29 | <span style='color: red'>(+1 [+0.3%])</span> 154.58 | <span style='color: green'>(-0 [-0.1%])</span> 89.17 | <span style='color: red'>(+1 [+1.0%])</span> 65.41 |
| `quotient_poly_compute_time_ms` |  79.22 |  158.44 | <span style='color: green'>(-1 [-0.6%])</span> 87.08 | <span style='color: red'>(+1 [+0.9%])</span> 71.36 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+1 [+5.5%])</span> 16.81 | <span style='color: red'>(+2 [+5.5%])</span> 33.62 | <span style='color: red'>(+1 [+8.0%])</span> 18.88 | <span style='color: red'>(+0 [+2.3%])</span> 14.75 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+0 [+0.8%])</span> 66.50 | <span style='color: red'>(+1 [+0.8%])</span> 133 | <span style='color: red'>(+1 [+1.3%])</span> 80 |  53 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 595 | 1 | 63 | 1,745,742 | 27.49 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 188 | 836 | 32,689,110 | 172,558,444 | 188 | 398 | 0 | 87.08 | 18.88 | 6 | 89.17 | 80 | 134 | 80 | 0 | 76 | 16,059,916 | 42 | 106 | 1,157,000 | 11.20 | 26 | 106 | 1 | 80 | 
| pairing | 1 | 197 | 595 | 22,314,288 | 119,958,502 | 197 | 296 | 1 | 71.36 | 14.75 | 6 | 65.41 | 53 | 101 | 53 | 0 | 55 | 9,408,294 | 32 | 59 | 588,742 | 18.12 | 20 | 86 | 1 | 53 | 

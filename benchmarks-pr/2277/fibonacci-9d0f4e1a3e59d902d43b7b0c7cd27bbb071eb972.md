...
|:---|---:|---:|
| Total | <span style='color: red'>(+0 [+0.2%])</span> 0.99 |  0.57 |
| fibonacci_program | <span style='color: red'>(+0 [+0.2%])</span> 0.98 |  0.55 |


| fibonacci_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+1 [+0.2%])</span> 487.50 | <span style='color: red'>(+2 [+0.2%])</span> 975 |  552 | <span style='color: red'>(+2 [+0.5%])</span> 423 |
...
| `execute_metered_insn_mi/s` | <span style='color: red'>(+1 [+1.0%])</span> 113.98 | -          | <span style='color: red'>(+1 [+1.0%])</span> 113.98 | <span style='color: red'>(+1 [+1.0%])</span> 113.98 |
| `execute_preflight_insns` |  750,104.50 |  1,500,209 |  873,000 |  627,209 |
| `execute_preflight_time_ms` |  30 |  60 |  34 |  26 |
| `execute_preflight_insn_mi/s` |  36.54 | -          |  38.63 |  34.45 |
| `trace_gen_time_ms   ` |  189 |  378 | <span style='color: green'>(-1 [-0.5%])</span> 194 | <span style='color: red'>(+1 [+0.5%])</span> 184 |
| `memory_finalize_time_ms` | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+1 [+0.6%])</span> 175 | <span style='color: red'>(+2 [+0.6%])</span> 350 | <span style='color: red'>(+2 [+1.1%])</span> 187 |  163 |
...
| `generate_perm_trace_time_ms` | <span style='color: red'>(+1 [+6.9%])</span> 15.50 | <span style='color: red'>(+2 [+6.9%])</span> 31 | <span style='color: red'>(+1 [+5.9%])</span> 18 | <span style='color: red'>(+1 [+8.3%])</span> 13 |
| `perm_trace_commit_time_ms` | <span style='color: red'>(+1 [+1.2%])</span> 42.15 | <span style='color: red'>(+1 [+1.2%])</span> 84.29 | <span style='color: red'>(+1 [+1.3%])</span> 44.24 | <span style='color: red'>(+0 [+1.1%])</span> 40.05 |
| `quotient_poly_compute_time_ms` | <span style='color: green'>(-0 [-0.6%])</span> 31.39 | <span style='color: green'>(-0 [-0.6%])</span> 62.77 |  34.38 | <span style='color: green'>(-0 [-1.3%])</span> 28.39 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+0 [+2.4%])</span> 11.99 | <span style='color: red'>(+1 [+2.4%])</span> 23.97 | <span style='color: green'>(-0 [-2.1%])</span> 11.99 | <span style='color: red'>(+1 [+7.3%])</span> 11.98 |
| `pcs_opening_time_ms ` | <span style='color: green'>(-0 [-1.2%])</span> 42 | <span style='color: green'>(-1 [-1.2%])</span> 84 |  44 | <span style='color: green'>(-1 [-2.4%])</span> 40 |
...
| --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 423 | 1 | 13 | 1,500,209 | 113.98 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 194 | 552 | 9,677,708 | 84,395,212 | 194 | 187 | 0 | 34.38 | 11.98 | 4 | 44.24 | 44 | 62 | 44 | 0 | 33 | 1,035,986 | 18 | 26 | 873,000 | 34.45 | 13 | 46 | 0 | 44 | 
| fibonacci_program | 1 | 184 | 423 | 9,708,170 | 74,305,770 | 184 | 163 | 1 | 28.39 | 11.99 | 4 | 40.05 | 40 | 53 | 40 | 0 | 28 | 1,064,416 | 13 | 34 | 627,209 | 38.63 | 11 | 40 | 0 | 40 | 

...
|:---|---:|---:|
| Total |  2.38 |  0.77 |
| regex_program |  2.35 |  0.73 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  586.75 |  2,347 |  733 |  535 |
...
| `execute_preflight_time_ms` |  56 |  224 |  69 |  45 |
| `execute_preflight_insn_mi/s` |  31.23 | -          |  32.38 |  28.15 |
| `trace_gen_time_ms   ` |  174.50 |  698 |  210 |  151 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  288.50 |  1,154 |  332 |  268 |
| `main_trace_commit_time_ms` |  51 |  204 |  57 |  49 |
| `generate_perm_trace_time_ms` |  34.50 |  138 |  54 |  19 |
| `perm_trace_commit_time_ms` |  63.68 |  254.72 |  70.41 |  54.49 |
| `quotient_poly_compute_time_ms` |  58.45 |  233.81 |  71.34 |  51.83 |
| `quotient_poly_commit_time_ms` |  14.71 |  58.85 |  16.81 |  12.76 |
| `pcs_opening_time_ms ` |  63 |  252 |  72 |  56 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 537 | 1 | 37 | 4,137,502 | 111.71 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 210 | 733 | 23,446,148 | 150,778,428 | 210 | 332 | 0 | 58.54 | 16.81 | 5 | 70.41 | 72 | 126 | 72 | 4 | 57 | 10,899,170 | 54 | 45 | 1,103,000 | 28.15 | 21 | 76 | 1 | 72 | 
| regex_program | 1 | 151 | 542 | 11,598,276 | 128,513,066 | 151 | 280 | 1 | 51.83 | 14.24 | 4 | 63.61 | 62 | 102 | 61 | 0 | 49 | 2,196,106 | 38 | 69 | 1,104,000 | 32.38 | 16 | 66 | 0 | 61 | 
| regex_program | 2 | 158 | 535 | 11,579,064 | 128,513,066 | 158 | 274 | 1 | 52.11 | 15.05 | 4 | 66.21 | 62 | 94 | 61 | 0 | 49 | 2,177,334 | 27 | 62 | 1,104,000 | 32.29 | 16 | 67 | 0 | 61 | 
| regex_program | 3 | 179 | 537 | 11,853,872 | 103,456,394 | 179 | 268 | 0 | 71.34 | 12.76 | 5 | 54.49 | 56 | 77 | 56 | 0 | 49 | 2,422,606 | 19 | 48 | 826,502 | 32.09 | 18 | 85 | 1 | 56 | 
...
Commit: https://github.com/openvm-org/openvm/commit/1ce8a825a3d657a9a5ec06cbc7fdeddffd96d58e
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19438841161)

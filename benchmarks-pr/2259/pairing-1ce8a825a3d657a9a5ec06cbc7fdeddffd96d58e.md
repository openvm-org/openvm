...
| `total_proof_time_ms ` |  744.50 |  1,489 |  817 |  672 |
...
| `execute_preflight_time_ms` |  97.50 |  195 |  130 |  65 |
| `execute_preflight_insn_mi/s` |  13.48 | -          |  17.82 |  9.13 |
| `trace_gen_time_ms   ` |  173 |  346 |  187 |  159 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  379.50 |  759 |  381 |  378 |
| `main_trace_commit_time_ms` |  63 |  126 |  74 |  52 |
| `generate_perm_trace_time_ms` |  55.50 |  111 |  71 |  40 |
| `perm_trace_commit_time_ms` |  76.12 |  152.23 |  88.86 |  63.37 |
| `quotient_poly_compute_time_ms` |  78.22 |  156.45 |  85.71 |  70.74 |
| `quotient_poly_commit_time_ms` |  15.97 |  31.94 |  17.52 |  14.41 |
| `pcs_opening_time_ms ` |  84.50 |  169 |  100 |  69 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 672 | 1 | 90 | 1,745,742 | 19.19 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 159 | 817 | 32,689,110 | 172,558,444 | 159 | 381 | 0 | 85.71 | 17.52 | 6 | 88.86 | 69 | 132 | 69 | 1 | 74 | 16,059,916 | 40 | 130 | 1,157,000 | 9.13 | 26 | 104 | 1 | 69 | 
| pairing | 1 | 187 | 672 | 22,314,288 | 119,958,502 | 187 | 378 | 1 | 70.74 | 14.41 | 6 | 63.37 | 100 | 138 | 100 | 0 | 52 | 9,408,294 | 71 | 65 | 588,742 | 17.82 | 20 | 85 | 1 | 100 | 

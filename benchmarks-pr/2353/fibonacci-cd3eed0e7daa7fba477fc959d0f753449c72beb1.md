...
| `total_proof_time_ms ` |  521 |  1,042 |  581 |  461 |
| `execute_metered_time_ms` |  9 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  161.21 | -          |  161.21 |  161.21 |
| `execute_preflight_insns` |  750,132.50 |  1,500,265 |  873,000 |  627,265 |
| `execute_preflight_time_ms` |  26.50 |  53 |  32 |  21 |
| `execute_preflight_insn_mi/s` |  39.17 | -          |  39.89 |  38.44 |
| `trace_gen_time_ms   ` |  195 |  390 |  199 |  191 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  193.50 |  387 |  199 |  188 |
| `main_trace_commit_time_ms` |  30.50 |  61 |  33 |  28 |
| `generate_perm_trace_time_ms` |  21 |  42 |  29 |  13 |
| `perm_trace_commit_time_ms` |  42.19 |  84.38 |  45.12 |  39.26 |
| `quotient_poly_compute_time_ms` |  32.11 |  64.23 |  33.63 |  30.60 |
| `quotient_poly_commit_time_ms` |  12.65 |  25.30 |  13.44 |  11.86 |
...
| --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 461 | 1 | 9 | 1,500,265 | 161.21 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 191 | 581 | 84,399,632 | 191 | 188 | 0 | 33.63 | 13.44 | 4 | 45.12 | 47 | 59 | 47 | 0 | 33 | 13 | 32 | 873,000 | 38.44 | 14 | 47 | 0 | 47 | 
| fibonacci_program | 1 | 199 | 461 | 74,305,770 | 199 | 199 | 1 | 30.60 | 11.86 | 4 | 39.26 | 59 | 68 | 59 | 0 | 28 | 29 | 21 | 627,265 | 39.89 | 11 | 42 | 0 | 59 | 

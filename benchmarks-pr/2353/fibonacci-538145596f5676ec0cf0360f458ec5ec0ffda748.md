...
|:---|---:|---:|---:|
| Total |  1.02 |  0.58 | 0.58 |
| fibonacci_program |  1.02 |  0.58 |  0.58 |


| fibonacci_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  506.50 |  1,013 |  572 |  441 |
| `execute_metered_time_ms` |  9 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  161.34 | -          |  161.34 |  161.34 |
| `execute_preflight_insns` |  750,132.50 |  1,500,265 |  873,000 |  627,265 |
| `execute_preflight_time_ms` |  26 |  52 |  31 |  21 |
| `execute_preflight_insn_mi/s` |  39.74 | -          |  39.90 |  39.58 |
| `trace_gen_time_ms   ` |  189.50 |  379 |  193 |  186 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  185 |  370 |  185 |  185 |
| `main_trace_commit_time_ms` |  30 |  60 |  32 |  28 |
| `generate_perm_trace_time_ms` |  21 |  42 |  28 |  14 |
| `perm_trace_commit_time_ms` |  40.80 |  81.60 |  44.25 |  37.36 |
| `quotient_poly_compute_time_ms` |  30.60 |  61.20 |  32.14 |  29.07 |
| `quotient_poly_commit_time_ms` |  12.74 |  25.48 |  13.17 |  12.31 |
...
| --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 441 | 1 | 9 | 1,500,265 | 161.34 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 186 | 572 | 84,399,632 | 186 | 185 | 0 | 32.14 | 13.17 | 5 | 44.25 | 47 | 58 | 47 | 0 | 32 | 14 | 31 | 873,000 | 39.58 | 14 | 45 | 0 | 47 | 
| fibonacci_program | 1 | 193 | 441 | 74,305,770 | 193 | 185 | 1 | 29.07 | 12.31 | 4 | 37.36 | 48 | 66 | 48 | 0 | 28 | 28 | 21 | 627,265 | 39.90 | 11 | 41 | 0 | 48 | 

...
|:---|---:|---:|---:|
| Total |  2.49 |  0.74 | 0.74 |
| regex_program |  2.49 |  0.74 |  0.74 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  613.50 |  2,454 |  705 |  553 |
| `execute_metered_time_ms` |  37 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  111.70 | -          |  111.70 |  111.70 |
| `execute_preflight_insns` |  1,034,492.25 |  4,137,969 |  1,104,000 |  826,969 |
| `execute_preflight_time_ms` |  46.25 |  185 |  57 |  35 |
| `execute_preflight_insn_mi/s` |  31.08 | -          |  31.55 |  30.44 |
| `trace_gen_time_ms   ` |  181.25 |  725 |  201 |  172 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  312.50 |  1,250 |  358 |  288 |
| `main_trace_commit_time_ms` |  52 |  208 |  56 |  49 |
| `generate_perm_trace_time_ms` |  51.25 |  205 |  94 |  26 |
| `perm_trace_commit_time_ms` |  65.54 |  262.17 |  73.65 |  56.42 |
| `quotient_poly_compute_time_ms` |  60.36 |  241.43 |  71.51 |  53.82 |
| `quotient_poly_commit_time_ms` |  16.23 |  64.94 |  18.35 |  13.96 |
| `pcs_opening_time_ms ` |  64 |  256 |  70 |  58 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 636 | 1 | 37 | 4,137,969 | 111.70 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 172 | 705 | 150,778,428 | 172 | 308 | 0 | 60.98 | 18.35 | 5 | 73.65 | 70 | 100 | 70 | 4 | 56 | 26 | 57 | 1,103,000 | 30.44 | 22 | 80 | 1 | 70 | 
| regex_program | 1 | 177 | 553 | 128,513,066 | 177 | 288 | 1 | 55.12 | 16.12 | 4 | 66.58 | 58 | 107 | 57 | 0 | 51 | 40 | 46 | 1,104,000 | 31.53 | 17 | 71 | 0 | 57 | 
| regex_program | 2 | 175 | 560 | 128,513,066 | 175 | 296 | 1 | 53.82 | 16.51 | 5 | 65.52 | 64 | 111 | 64 | 0 | 49 | 45 | 47 | 1,104,000 | 30.81 | 17 | 70 | 0 | 64 | 
| regex_program | 3 | 201 | 636 | 103,476,504 | 201 | 358 | 0 | 71.51 | 13.96 | 5 | 56.42 | 64 | 154 | 64 | 0 | 52 | 94 | 35 | 826,969 | 31.55 | 20 | 86 | 1 | 64 | 

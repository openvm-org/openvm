...
| `total_proof_time_ms ` |  592.75 |  2,371 |  703 |  545 |
...
| `execute_preflight_time_ms` |  49 |  196 |  62 |  38 |
| `execute_preflight_insn_mi/s` |  31.62 | -          |  32.27 |  29.95 |
| `trace_gen_time_ms   ` |  175 |  700 |  190 |  166 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  292.50 |  1,170 |  298 |  283 |
| `main_trace_commit_time_ms` |  50.75 |  203 |  56 |  49 |
| `generate_perm_trace_time_ms` |  37.75 |  151 |  46 |  29 |
| `perm_trace_commit_time_ms` |  63.39 |  253.57 |  70.37 |  54.87 |
| `quotient_poly_compute_time_ms` |  59.60 |  238.38 |  69.91 |  53.14 |
| `quotient_poly_commit_time_ms` |  15.65 |  62.59 |  18.59 |  14.08 |
| `pcs_opening_time_ms ` |  61.75 |  247 |  74 |  57 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 568 | 1 | 37 | 4,137,631 | 111.60 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 166 | 703 | 150,778,428 | 166 | 296 | 0 | 62.09 | 18.59 | 5 | 70.37 | 57 | 100 | 56 | 4 | 56 | 29 | 62 | 1,103,000 | 29.95 | 22 | 81 | 1 | 56 | 
| regex_program | 1 | 172 | 545 | 128,513,066 | 172 | 283 | 1 | 53.14 | 14.95 | 5 | 63.98 | 58 | 106 | 57 | 0 | 49 | 41 | 48 | 1,104,000 | 32.26 | 16 | 68 | 0 | 57 | 
| regex_program | 2 | 172 | 555 | 128,513,066 | 172 | 293 | 1 | 53.24 | 14.97 | 5 | 64.36 | 74 | 100 | 74 | 0 | 49 | 35 | 48 | 1,104,000 | 32.27 | 16 | 68 | 0 | 74 | 
| regex_program | 3 | 190 | 568 | 103,456,394 | 190 | 298 | 0 | 69.91 | 14.08 | 5 | 54.87 | 58 | 105 | 58 | 0 | 49 | 46 | 38 | 826,631 | 32 | 19 | 85 | 1 | 58 | 
...
Commit: https://github.com/openvm-org/openvm/commit/478e1eb4c66d09a68d845a1a959e7656320dad35
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/21051651172)

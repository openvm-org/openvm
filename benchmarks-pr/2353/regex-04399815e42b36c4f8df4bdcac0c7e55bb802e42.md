...
|:---|---:|---:|---:|
| Total |  2.43 |  0.75 | 0.75 |
| regex_program |  2.43 |  0.75 |  0.75 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  599 |  2,396 |  712 |  544 |
| `execute_metered_time_ms` |  35 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  116.68 | -          |  116.68 |  116.68 |
| `execute_preflight_insns` |  1,034,492.25 |  4,137,969 |  1,104,000 |  826,969 |
| `execute_preflight_time_ms` |  45.50 |  182 |  56 |  34 |
| `execute_preflight_insn_mi/s` |  31.19 | -          |  31.46 |  30.68 |
| `trace_gen_time_ms   ` |  183.25 |  733 |  204 |  175 |
| `memory_finalize_time_ms` |  0.75 |  3 |  3 |  0 |
| `stark_prove_excluding_trace_time_ms` |  296 |  1,184 |  310 |  279 |
| `main_trace_commit_time_ms` |  52.50 |  210 |  57 |  50 |
| `generate_perm_trace_time_ms` |  38.75 |  155 |  44 |  31 |
| `perm_trace_commit_time_ms` |  64.95 |  259.80 |  72.26 |  56 |
| `quotient_poly_compute_time_ms` |  61.05 |  244.21 |  73.75 |  54.20 |
| `quotient_poly_commit_time_ms` |  16.07 |  64.28 |  18.09 |  14.29 |
| `pcs_opening_time_ms ` |  59.50 |  238 |  66 |  51 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 580 | 1 | 35 | 4,137,969 | 116.68 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 175 | 712 | 150,778,428 | 175 | 310 | 0 | 60.80 | 18.09 | 5 | 72.26 | 57 | 116 | 56 | 3 | 57 | 43 | 56 | 1,103,000 | 30.68 | 22 | 79 | 1 | 56 | 
| regex_program | 1 | 177 | 544 | 128,513,066 | 177 | 279 | 1 | 55.46 | 15.89 | 4 | 66.66 | 51 | 104 | 51 | 0 | 51 | 37 | 46 | 1,104,000 | 31.29 | 17 | 71 | 0 | 51 | 
| regex_program | 2 | 177 | 560 | 128,513,066 | 177 | 295 | 1 | 54.20 | 16 | 4 | 64.88 | 64 | 109 | 64 | 0 | 50 | 44 | 46 | 1,104,000 | 31.31 | 17 | 70 | 0 | 64 | 
| regex_program | 3 | 204 | 580 | 103,476,504 | 204 | 300 | 0 | 73.75 | 14.29 | 5 | 56 | 66 | 91 | 66 | 0 | 52 | 31 | 34 | 826,969 | 31.46 | 21 | 89 | 1 | 66 | 

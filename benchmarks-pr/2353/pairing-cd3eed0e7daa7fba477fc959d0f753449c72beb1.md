...
|:---|---:|---:|---:|
| Total |  1.52 |  0.90 | 0.90 |
| pairing |  1.52 |  0.90 |  0.90 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  724.50 |  1,449 |  837 |  612 |
...
| `execute_preflight_time_ms` |  84.50 |  169 |  122 |  47 |
| `execute_preflight_insn_mi/s` |  14.53 | -          |  17.99 |  11.07 |
| `trace_gen_time_ms   ` |  180 |  360 |  201 |  159 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  355 |  710 |  388 |  322 |
| `main_trace_commit_time_ms` |  65 |  130 |  75 |  55 |
| `generate_perm_trace_time_ms` |  38.50 |  77 |  41 |  36 |
| `perm_trace_commit_time_ms` |  76.59 |  153.17 |  89.36 |  63.81 |
| `quotient_poly_compute_time_ms` |  83.38 |  166.77 |  93.08 |  73.69 |
| `quotient_poly_commit_time_ms` |  17.66 |  35.32 |  19.66 |  15.66 |
| `pcs_opening_time_ms ` |  69 |  138 |  70 |  68 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 612 | 1 | 67 | 1,745,757 | 25.89 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 159 | 837 | 172,558,444 | 159 | 388 | 0 | 93.08 | 19.66 | 6 | 89.36 | 70 | 128 | 70 | 1 | 75 | 36 | 122 | 1,151,000 | 11.07 | 27 | 113 | 1 | 70 | 
| pairing | 1 | 201 | 612 | 119,958,502 | 201 | 322 | 1 | 73.69 | 15.66 | 6 | 63.81 | 68 | 107 | 68 | 0 | 55 | 41 | 47 | 594,757 | 17.99 | 21 | 89 | 1 | 68 | 

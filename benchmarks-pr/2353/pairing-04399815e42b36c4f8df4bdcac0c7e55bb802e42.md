...
|:---|---:|---:|---:|
| Total |  1.55 |  0.93 | 0.93 |
| pairing |  1.55 |  0.93 |  0.93 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  741 |  1,482 |  859 |  623 |
...
| `execute_preflight_insn_mi/s` |  14.35 | -          |  17.82 |  10.88 |
| `trace_gen_time_ms   ` |  188 |  376 |  209 |  167 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  361 |  722 |  398 |  324 |
| `main_trace_commit_time_ms` |  65 |  130 |  76 |  54 |
| `generate_perm_trace_time_ms` |  41 |  82 |  45 |  37 |
| `perm_trace_commit_time_ms` |  78.19 |  156.38 |  90.03 |  66.35 |
| `quotient_poly_compute_time_ms` |  83.74 |  167.48 |  92.08 |  75.41 |
| `quotient_poly_commit_time_ms` |  17.46 |  34.91 |  19.39 |  15.52 |
| `pcs_opening_time_ms ` |  71 |  142 |  79 |  63 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 623 | 1 | 67 | 1,745,757 | 25.79 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 167 | 859 | 172,558,444 | 167 | 398 | 0 | 92.08 | 19.39 | 6 | 90.03 | 79 | 129 | 79 | 1 | 76 | 37 | 124 | 1,151,000 | 10.88 | 27 | 112 | 1 | 79 | 
| pairing | 1 | 209 | 623 | 119,958,502 | 209 | 324 | 1 | 75.41 | 15.52 | 5 | 66.35 | 63 | 114 | 63 | 0 | 54 | 45 | 48 | 594,757 | 17.82 | 21 | 91 | 1 | 63 | 

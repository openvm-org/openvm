...
| `total_proof_time_ms ` |  503 |  1,006 |  576 |  430 |
| `execute_metered_time_ms` |  9 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  161.56 | -          |  161.56 |  161.56 |
| `execute_preflight_insns` |  750,132.50 |  1,500,265 |  873,000 |  627,265 |
| `execute_preflight_time_ms` |  26 |  52 |  31 |  21 |
| `execute_preflight_insn_mi/s` |  39.90 | -          |  40.12 |  39.67 |
| `trace_gen_time_ms   ` |  193 |  386 |  198 |  188 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  178.50 |  357 |  188 |  169 |
| `main_trace_commit_time_ms` |  30.50 |  61 |  33 |  28 |
| `generate_perm_trace_time_ms` |  14 |  28 |  15 |  13 |
| `perm_trace_commit_time_ms` |  41.92 |  83.83 |  45.01 |  38.82 |
| `quotient_poly_compute_time_ms` |  31.88 |  63.76 |  34.25 |  29.51 |
| `quotient_poly_commit_time_ms` |  12.54 |  25.07 |  13.38 |  11.69 |
| `pcs_opening_time_ms ` |  45.50 |  91 |  47 |  44 |
...
| --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 430 | 1 | 9 | 1,500,265 | 161.56 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 188 | 576 | 84,399,632 | 188 | 188 | 0 | 34.25 | 13.38 | 4 | 45.01 | 47 | 59 | 47 | 0 | 33 | 13 | 31 | 873,000 | 39.67 | 14 | 48 | 1 | 47 | 
| fibonacci_program | 1 | 198 | 430 | 74,305,770 | 198 | 169 | 1 | 29.51 | 11.69 | 4 | 38.82 | 44 | 54 | 44 | 0 | 28 | 15 | 21 | 627,265 | 40.12 | 11 | 41 | 0 | 44 | 

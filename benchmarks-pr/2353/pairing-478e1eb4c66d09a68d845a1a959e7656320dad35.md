...
| `total_proof_time_ms ` |  740 |  1,480 |  853 |  627 |
...
| `execute_preflight_insn_mi/s` |  14.59 | -          |  17.79 |  11.40 |
| `trace_gen_time_ms   ` |  187.50 |  375 |  207 |  168 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  361 |  722 |  393 |  329 |
| `main_trace_commit_time_ms` |  65.50 |  131 |  76 |  55 |
| `generate_perm_trace_time_ms` |  40 |  80 |  44 |  36 |
| `perm_trace_commit_time_ms` |  78.47 |  156.94 |  90.52 |  66.42 |
| `quotient_poly_compute_time_ms` |  84.50 |  169.01 |  92.92 |  76.09 |
| `quotient_poly_commit_time_ms` |  17.40 |  34.81 |  18.77 |  16.04 |
| `pcs_opening_time_ms ` |  70 |  140 |  74 |  66 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 627 | 1 | 63 | 1,745,757 | 27.42 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 168 | 853 | 172,558,444 | 168 | 393 | 0 | 92.92 | 18.77 | 6 | 90.52 | 74 | 129 | 74 | 1 | 76 | 36 | 121 | 1,151,000 | 11.40 | 27 | 112 | 1 | 74 | 
| pairing | 1 | 207 | 627 | 119,958,502 | 207 | 329 | 1 | 76.09 | 16.04 | 6 | 66.42 | 66 | 114 | 66 | 0 | 55 | 44 | 48 | 594,757 | 17.79 | 21 | 92 | 1 | 66 | 

...
| `total_proof_time_ms ` |  741 |  1,482 |  833 |  649 |
...
| `execute_preflight_insn_mi/s` |  14.89 | -          |  18.18 |  11.61 |
| `trace_gen_time_ms   ` |  187 |  374 |  206 |  168 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  367.50 |  735 |  381 |  354 |
| `main_trace_commit_time_ms` |  64.50 |  129 |  75 |  54 |
| `generate_perm_trace_time_ms` |  40.50 |  81 |  45 |  36 |
| `perm_trace_commit_time_ms` |  77.82 |  155.65 |  89.75 |  65.90 |
| `quotient_poly_compute_time_ms` |  83.12 |  166.24 |  91.77 |  74.47 |
| `quotient_poly_commit_time_ms` |  17.07 |  34.14 |  18.99 |  15.15 |
| `pcs_opening_time_ms ` |  79.50 |  159 |  94 |  65 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 649 | 1 | 63 | 1,745,757 | 27.58 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 168 | 833 | 172,558,444 | 168 | 381 | 0 | 91.77 | 18.99 | 6 | 89.75 | 65 | 128 | 64 | 1 | 75 | 36 | 117 | 1,151,000 | 11.61 | 26 | 111 | 1 | 64 | 
| pairing | 1 | 206 | 649 | 119,958,502 | 206 | 354 | 1 | 74.47 | 15.15 | 6 | 65.90 | 94 | 114 | 94 | 0 | 54 | 45 | 47 | 594,757 | 18.18 | 21 | 90 | 1 | 94 | 

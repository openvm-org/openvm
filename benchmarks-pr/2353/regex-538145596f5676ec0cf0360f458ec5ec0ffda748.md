...
| `total_proof_time_ms ` |  596.75 |  2,387 |  719 |  533 |
...
| `execute_preflight_insn_mi/s` |  31.14 | -          |  31.66 |  30.38 |
| `trace_gen_time_ms   ` |  186 |  744 |  206 |  176 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  290.50 |  1,162 |  315 |  264 |
| `main_trace_commit_time_ms` |  53.25 |  213 |  58 |  50 |
| `generate_perm_trace_time_ms` |  29.50 |  118 |  37 |  23 |
| `perm_trace_commit_time_ms` |  66.25 |  264.98 |  71.74 |  57.96 |
| `quotient_poly_compute_time_ms` |  62.25 |  249.01 |  73.67 |  55.38 |
| `quotient_poly_commit_time_ms` |  16.51 |  66.03 |  19.13 |  13.97 |
| `pcs_opening_time_ms ` |  59.75 |  239 |  67 |  48 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 590 | 1 | 35 | 4,137,979 | 116.37 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 176 | 719 | 150,778,428 | 176 | 315 | 0 | 63.61 | 19.13 | 5 | 71.74 | 63 | 109 | 63 | 4 | 58 | 37 | 57 | 1,103,000 | 30.38 | 22 | 83 | 1 | 63 | 
| regex_program | 1 | 181 | 533 | 128,513,066 | 181 | 264 | 1 | 56.36 | 16.64 | 4 | 68.13 | 48 | 92 | 47 | 0 | 50 | 23 | 46 | 1,104,000 | 31.66 | 17 | 73 | 0 | 47 | 
| regex_program | 2 | 181 | 545 | 128,513,066 | 181 | 276 | 1 | 55.38 | 16.28 | 4 | 67.15 | 61 | 90 | 60 | 0 | 52 | 23 | 46 | 1,104,000 | 31.51 | 17 | 72 | 0 | 60 | 
| regex_program | 3 | 206 | 590 | 103,476,504 | 206 | 307 | 0 | 73.67 | 13.97 | 5 | 57.96 | 67 | 97 | 67 | 0 | 53 | 35 | 35 | 826,979 | 31.01 | 20 | 88 | 1 | 67 | 

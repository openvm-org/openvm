...
| `total_proof_time_ms ` |  518.50 |  1,037 |  578 |  459 |
| `execute_metered_time_ms` |  9 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  161.42 | -          |  161.42 |  161.42 |
| `execute_preflight_insns` |  750,132.50 |  1,500,265 |  873,000 |  627,265 |
| `execute_preflight_time_ms` |  26.50 |  53 |  32 |  21 |
| `execute_preflight_insn_mi/s` |  39.16 | -          |  39.29 |  39.02 |
| `trace_gen_time_ms   ` |  193 |  386 |  198 |  188 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  193 |  386 |  198 |  188 |
| `main_trace_commit_time_ms` |  30.50 |  61 |  33 |  28 |
| `generate_perm_trace_time_ms` |  21 |  42 |  29 |  13 |
| `perm_trace_commit_time_ms` |  42.05 |  84.10 |  45.05 |  39.05 |
| `quotient_poly_compute_time_ms` |  31.77 |  63.53 |  33.75 |  29.78 |
| `quotient_poly_commit_time_ms` |  12.56 |  25.13 |  13.43 |  11.70 |
| `pcs_opening_time_ms ` |  52.50 |  105 |  58 |  47 |
...
| --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 459 | 1 | 9 | 1,500,265 | 161.42 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 188 | 578 | 84,399,632 | 188 | 188 | 0 | 33.75 | 13.43 | 4 | 45.05 | 47 | 59 | 47 | 0 | 33 | 13 | 32 | 873,000 | 39.02 | 15 | 47 | 0 | 47 | 
| fibonacci_program | 1 | 198 | 459 | 74,305,770 | 198 | 198 | 1 | 29.78 | 11.70 | 4 | 39.05 | 58 | 68 | 58 | 0 | 28 | 29 | 21 | 627,265 | 39.29 | 11 | 41 | 0 | 58 | 

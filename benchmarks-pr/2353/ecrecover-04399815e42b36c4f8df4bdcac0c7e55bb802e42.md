...
| ecrecover_program |  0.78 |  0.78 |  0.78 |
...
| `execute_preflight_insns` |  123,858 |  123,858 |  123,858 |  123,858 |
...
| `perm_trace_commit_time_ms` |  35.45 |  35.45 |  35.45 |  35.45 |
| `quotient_poly_compute_time_ms` |  105.04 |  105.04 |  105.04 |  105.04 |
| `quotient_poly_commit_time_ms` |  9.25 |  9.25 |  9.25 |  9.25 |
| `pcs_opening_time_ms ` |  73 |  73 |  73 |  73 |
...
| --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 773 | 1 | 6 | 123,858 | 19.87 | 0 | 
...
| ecrecover_program | 21 | KeccakfOpAir | 0 | 16 |  | 624 | 362 | 15,776 | 
...
| ecrecover_program | 25 | VmAirWrapper<Rv32RdWriteAdapterAir, Rv32AuipcCoreAir> | 0 | 2,048 |  | 28 | 20 | 98,304 | 
| ecrecover_program | 26 | VmAirWrapper<Rv32JalrAdapterAir, Rv32JalrCoreAir> | 0 | 4,096 |  | 36 | 28 | 262,144 | 
| ecrecover_program | 27 | VmAirWrapper<Rv32CondRdWriteAdapterAir, Rv32JalLuiCoreAir> | 0 | 4,096 |  | 28 | 18 | 188,416 | 
| ecrecover_program | 28 | VmAirWrapper<Rv32BranchAdapterAir, BranchLessThanCoreAir<4, 8> | 0 | 8,192 |  | 32 | 32 | 524,288 | 
| ecrecover_program | 29 | VmAirWrapper<Rv32BranchAdapterAir, BranchEqualCoreAir<4> | 0 | 16,384 |  | 28 | 26 | 884,736 | 
...
| ecrecover_program | 31 | VmAirWrapper<Rv32LoadStoreAdapterAir, LoadStoreCoreAir<4> | 0 | 65,536 |  | 52 | 41 | 6,094,848 | 
| ecrecover_program | 32 | VmAirWrapper<Rv32BaseAluAdapterAir, ShiftCoreAir<4, 8> | 0 | 8,192 |  | 52 | 53 | 860,160 | 
| ecrecover_program | 33 | VmAirWrapper<Rv32BaseAluAdapterAir, LessThanCoreAir<4, 8> | 0 | 4,096 |  | 40 | 37 | 315,392 | 
| ecrecover_program | 34 | VmAirWrapper<Rv32BaseAluAdapterAir, BaseAluCoreAir<4, 8> | 0 | 65,536 |  | 52 | 36 | 5,767,168 | 
...
| ecrecover_program | KeccakfOpAir | 2 | 309 | 217 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 218 | 773 | 31,619,554 | 218 | 323 | 0 | 105.04 | 9.25 | 8 | 35.45 | 73 | 95 | 73 | 0 | 38 | 53 | 62 | 123,858 | 2.26 | 23 | 114 | 2 | 73 | 

| group | segment | trace_height_constraint | weighted_sum | threshold |
| --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 0 | 375,748 | 2,013,265,921 | 
| ecrecover_program | 0 | 1 | 1,161,632 | 2,013,265,921 | 
| ecrecover_program | 0 | 2 | 187,874 | 2,013,265,921 | 
| ecrecover_program | 0 | 3 | 2,526,708 | 2,013,265,921 | 
| ecrecover_program | 0 | 4 | 16,384 | 2,013,265,921 | 
| ecrecover_program | 0 | 5 | 8,192 | 2,013,265,921 | 
| ecrecover_program | 0 | 6 | 431,752 | 2,013,265,921 | 
| ecrecover_program | 0 | 7 | 272 | 2,013,265,921 | 
| ecrecover_program | 0 | 8 | 320 | 2,013,265,921 | 
| ecrecover_program | 0 | 9 | 5,663,250 | 2,013,265,921 | 

</details>


Commit: https://github.com/openvm-org/openvm/commit/04399815e42b36c4f8df4bdcac0c7e55bb802e42
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/21053247262)

...
| `total_proof_time_ms ` |  499 |  998 |  570 |  428 |
| `execute_metered_time_ms` |  9 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  161.01 | -          |  161.01 |  161.01 |
| `execute_preflight_insns` |  750,132.50 |  1,500,265 |  873,000 |  627,265 |
| `execute_preflight_time_ms` |  26 |  52 |  31 |  21 |
| `execute_preflight_insn_mi/s` |  39.81 | -          |  40.05 |  39.57 |
| `trace_gen_time_ms   ` |  191.50 |  383 |  194 |  189 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  175 |  350 |  180 |  170 |
| `main_trace_commit_time_ms` |  30.50 |  61 |  33 |  28 |
| `generate_perm_trace_time_ms` |  14.50 |  29 |  15 |  14 |
| `perm_trace_commit_time_ms` |  41.31 |  82.62 |  43.85 |  38.78 |
| `quotient_poly_compute_time_ms` |  29.79 |  59.58 |  30.26 |  29.31 |
| `quotient_poly_commit_time_ms` |  12.04 |  24.08 |  12.45 |  11.63 |
...
| --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 428 | 1 | 9 | 1,500,265 | 161.01 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 189 | 570 | 84,399,632 | 189 | 180 | 0 | 30.26 | 11.63 | 4 | 43.85 | 46 | 58 | 46 | 0 | 33 | 14 | 31 | 873,000 | 39.57 | 14 | 42 | 0 | 46 | 
| fibonacci_program | 1 | 194 | 428 | 74,305,770 | 194 | 170 | 1 | 29.31 | 12.45 | 4 | 38.78 | 45 | 54 | 45 | 0 | 28 | 15 | 21 | 627,265 | 40.05 | 11 | 42 | 0 | 45 | 

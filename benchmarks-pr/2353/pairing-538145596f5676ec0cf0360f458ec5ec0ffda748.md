...
| `total_proof_time_ms ` |  729.50 |  1,459 |  842 |  617 |
| `execute_metered_time_ms` |  67 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  26.02 | -          |  26.02 |  26.02 |
| `execute_preflight_insns` |  872,878.50 |  1,745,757 |  1,151,000 |  594,757 |
| `execute_preflight_time_ms` |  85.50 |  171 |  123 |  48 |
| `execute_preflight_insn_mi/s` |  14.40 | -          |  17.84 |  10.96 |
| `trace_gen_time_ms   ` |  183.50 |  367 |  206 |  161 |
...
| `perm_trace_commit_time_ms` |  77.25 |  154.50 |  89.21 |  65.29 |
| `quotient_poly_compute_time_ms` |  84.30 |  168.60 |  94.47 |  74.14 |
| `quotient_poly_commit_time_ms` |  17.54 |  35.08 |  19.56 |  15.53 |
| `pcs_opening_time_ms ` |  66.50 |  133 |  70 |  63 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 617 | 1 | 67 | 1,745,757 | 26.02 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 161 | 842 | 172,558,444 | 161 | 388 | 0 | 94.47 | 19.56 | 6 | 89.21 | 70 | 127 | 69 | 1 | 75 | 36 | 123 | 1,151,000 | 10.96 | 27 | 114 | 1 | 69 | 
| pairing | 1 | 206 | 617 | 119,958,502 | 206 | 322 | 1 | 74.14 | 15.53 | 6 | 65.29 | 63 | 112 | 63 | 0 | 55 | 44 | 48 | 594,757 | 17.84 | 21 | 90 | 1 | 63 | 

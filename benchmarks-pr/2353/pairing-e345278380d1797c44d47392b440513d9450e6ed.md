...
| `total_proof_time_ms ` |  718 |  1,436 |  833 |  603 |
...
| `execute_preflight_insn_mi/s` |  14.47 | -          |  18 |  10.93 |
| `trace_gen_time_ms   ` |  181.50 |  363 |  202 |  161 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  345.50 |  691 |  379 |  312 |
| `main_trace_commit_time_ms` |  63.50 |  127 |  74 |  53 |
| `generate_perm_trace_time_ms` |  40 |  80 |  45 |  35 |
| `perm_trace_commit_time_ms` |  76.53 |  153.06 |  88.09 |  64.97 |
| `quotient_poly_compute_time_ms` |  82.83 |  165.66 |  91.47 |  74.19 |
| `quotient_poly_commit_time_ms` |  16.62 |  33.25 |  17.74 |  15.51 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 603 | 1 | 67 | 1,745,757 | 25.91 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 161 | 833 | 172,558,444 | 161 | 379 | 0 | 91.47 | 17.74 | 6 | 88.09 | 68 | 125 | 68 | 1 | 74 | 35 | 123 | 1,151,000 | 10.93 | 26 | 110 | 1 | 68 | 
| pairing | 1 | 202 | 603 | 119,958,502 | 202 | 312 | 1 | 74.19 | 15.51 | 6 | 64.97 | 55 | 113 | 55 | 0 | 53 | 45 | 47 | 594,757 | 18 | 21 | 90 | 1 | 55 | 

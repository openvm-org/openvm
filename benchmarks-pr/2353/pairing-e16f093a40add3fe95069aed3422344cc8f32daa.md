...
| `total_proof_time_ms ` |  725.50 |  1,451 |  838 |  613 |
...
| `execute_preflight_time_ms` |  86 |  172 |  123 |  49 |
| `execute_preflight_insn_mi/s` |  14.73 | -          |  18.30 |  11.15 |
| `trace_gen_time_ms   ` |  181.50 |  363 |  201 |  162 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  350 |  700 |  378 |  322 |
| `main_trace_commit_time_ms` |  65 |  130 |  75 |  55 |
| `generate_perm_trace_time_ms` |  40.50 |  81 |  45 |  36 |
| `perm_trace_commit_time_ms` |  75 |  150.01 |  86.10 |  63.91 |
| `quotient_poly_compute_time_ms` |  82.82 |  165.65 |  91.37 |  74.27 |
| `quotient_poly_commit_time_ms` |  17.14 |  34.28 |  19.59 |  14.70 |
| `pcs_opening_time_ms ` |  64.50 |  129 |  65 |  64 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 613 | 1 | 67 | 1,745,757 | 25.90 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 162 | 838 | 172,558,444 | 162 | 378 | 0 | 91.37 | 19.59 | 6 | 86.10 | 65 | 125 | 65 | 1 | 75 | 36 | 123 | 1,151,000 | 11.15 | 27 | 111 | 1 | 65 | 
| pairing | 1 | 201 | 613 | 119,958,502 | 201 | 322 | 1 | 74.27 | 14.70 | 6 | 63.91 | 64 | 112 | 64 | 0 | 55 | 45 | 49 | 594,757 | 18.30 | 21 | 89 | 1 | 64 | 

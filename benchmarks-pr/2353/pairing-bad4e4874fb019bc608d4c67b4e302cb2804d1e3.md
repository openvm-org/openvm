...
|:---|---:|---:|---:|
| Total |  1.51 |  0.90 | 0.90 |
| pairing |  1.51 |  0.90 |  0.90 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  723.50 |  1,447 |  835 |  612 |
...
| `execute_preflight_insn_mi/s` |  14.39 | -          |  17.84 |  10.95 |
| `trace_gen_time_ms   ` |  182 |  364 |  203 |  161 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  350.50 |  701 |  381 |  320 |
| `main_trace_commit_time_ms` |  63.50 |  127 |  74 |  53 |
| `generate_perm_trace_time_ms` |  40 |  80 |  45 |  35 |
| `perm_trace_commit_time_ms` |  76.65 |  153.29 |  88.33 |  64.96 |
| `quotient_poly_compute_time_ms` |  82.65 |  165.30 |  91.41 |  73.90 |
| `quotient_poly_commit_time_ms` |  16.86 |  33.72 |  18.79 |  14.93 |
| `pcs_opening_time_ms ` |  66 |  132 |  69 |  63 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 612 | 1 | 67 | 1,745,757 | 25.92 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 161 | 835 | 172,558,444 | 161 | 381 | 0 | 91.41 | 18.79 | 6 | 88.33 | 69 | 126 | 68 | 1 | 74 | 35 | 123 | 1,151,000 | 10.95 | 26 | 111 | 1 | 68 | 
| pairing | 1 | 203 | 612 | 119,958,502 | 203 | 320 | 1 | 73.90 | 14.93 | 6 | 64.96 | 63 | 113 | 62 | 0 | 53 | 45 | 48 | 594,757 | 17.84 | 20 | 89 | 1 | 62 | 

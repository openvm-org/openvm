...
|:---|---:|---:|
| Total |  7.77 |  5.04 |
| regex_program |  7.74 |  5.01 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  3,870 |  7,740 |  5,010 |  2,730 |
...
| `execute_preflight_insn_mi/s` |  27.100 | -          |  30.58 |  25.42 |
| `trace_gen_time_ms   ` |  403 |  806 |  513 |  293 |
| `memory_finalize_time_ms` |  7.50 |  15 |  13 |  2 |
| `stark_prove_excluding_trace_time_ms` |  3,145.50 |  6,291 |  4,152 |  2,139 |
| `main_trace_commit_time_ms` |  621 |  1,242 |  850 |  392 |
| `generate_perm_trace_time_ms` |  234.50 |  469 |  306 |  163 |
| `perm_trace_commit_time_ms` |  679 |  1,358 |  909 |  449 |
| `quotient_poly_compute_time_ms` |  319 |  638 |  438 |  200 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2,730 | 8 | 1 | 32 | 4,108,597 | 127.70 | 45 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 513 | 5,010 | 211,758,557 | 373,183,036 | 513 | 4,152 | 0 | 438 | 397 | 909 | 1,247 | 8 | 13 | 850 | 91,281,687 | 306 | 103 | 2,211,000 | 25.42 | 
| regex_program | 1 | 293 | 2,730 | 174,326,267 | 196,838,026 | 293 | 2,139 | 56 | 200 | 206 | 449 | 718 | 6 | 2 | 392 | 73,453,305 | 163 | 85 | 1,897,597 | 30.58 | 

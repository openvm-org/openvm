...
|:---|---:|---:|
| Total |  7.77 |  4.98 |
| regex_program |  7.74 |  4.95 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  3,871 |  7,742 |  4,946 |  2,796 |
...
| `execute_metered_insn_mi/s` |  130.44 | -          |  130.44 |  130.44 |
| `execute_preflight_insns` |  2,054,298.50 |  4,108,597 |  2,211,000 |  1,897,597 |
| `execute_preflight_time_ms` |  92.50 |  185 |  100 |  85 |
| `execute_preflight_insn_mi/s` |  28.62 | -          |  31.07 |  26.17 |
| `trace_gen_time_ms   ` |  404 |  808 |  516 |  292 |
| `memory_finalize_time_ms` |  7 |  14 |  12 |  2 |
| `stark_prove_excluding_trace_time_ms` |  3,136 |  6,272 |  4,082 |  2,190 |
| `main_trace_commit_time_ms` |  626.50 |  1,253 |  841 |  412 |
| `generate_perm_trace_time_ms` |  233 |  466 |  303 |  163 |
| `perm_trace_commit_time_ms` |  659.50 |  1,319 |  849 |  470 |
| `quotient_poly_compute_time_ms` |  325 |  650 |  440 |  210 |
| `quotient_poly_commit_time_ms` |  302.50 |  605 |  397 |  208 |
| `pcs_opening_time_ms ` |  981 |  1,962 |  1,245 |  717 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2,796 | 6 | 1 | 31 | 4,108,597 | 130.44 | 45 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 516 | 4,946 | 211,758,557 | 373,183,036 | 516 | 4,082 | 0 | 440 | 397 | 849 | 1,245 | 7 | 12 | 841 | 91,281,687 | 303 | 100 | 2,211,000 | 26.17 | 
| regex_program | 1 | 292 | 2,796 | 174,326,267 | 196,838,026 | 292 | 2,190 | 56 | 210 | 208 | 470 | 717 | 6 | 2 | 412 | 73,453,305 | 163 | 85 | 1,897,597 | 31.07 | 

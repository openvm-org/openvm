...
|:---|---:|---:|---:|
| Total |  16.35 |  4.74 |  4.74 |
| app_proof |  13.36 |  2.52 |  2.52 |
| leaf |  2.19 |  1.43 |  1.43 |
...
| `total_proof_time_ms ` |  2,204 |  13,224 |  2,383 |  2,127 |
| `execute_metered_time_ms` |  137 | -          | -          | -          |
| `execute_metered_insns` |  14,365,133 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  104.20 | -          |  104.20 |  104.20 |
| `execute_preflight_insns` |  2,394,188.83 |  14,365,133 |  2,413,000 |  2,300,133 |
| `execute_preflight_time_ms` |  239.33 |  1,436 |  322 |  87 |
| `execute_preflight_insn_mi/s` |  33.71 | -          |  34.63 |  30.74 |
| `trace_gen_time_ms   ` |  36.50 |  219 |  54 |  33 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,869.67 |  11,218 |  2,103 |  1,808 |
| `prover.main_trace_commit_time_ms` |  693.50 |  4,161 |  855 |  660 |
| `prover.rap_constraints_time_ms` |  996 |  5,976 |  1,058 |  974 |
| `prover.openings_time_ms` |  179.50 |  1,077 |  189 |  174 |
| `prover.rap_constraints.logup_gkr_time_ms` |  171.17 |  1,027 |  222 |  160 |
| `prover.rap_constraints.round0_time_ms` |  511.83 |  3,071 |  516 |  506 |
| `prover.rap_constraints.mle_rounds_time_ms` |  311.67 |  1,870 |  330 |  302 |
| `prover.openings.stacked_reduction_time_ms` |  133.50 |  801 |  137 |  132 |
...
| `prover.openings.whir_time_ms` |  45.33 |  272 |  52 |  41 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,095.50 |  2,191 |  1,425 |  766 |
| `execute_preflight_time_ms` |  5 |  10 |  5 |  5 |
| `trace_gen_time_ms   ` |  133.50 |  267 |  177 |  90 |
| `generate_blob_total_time_ms` |  24 |  48 |  32 |  16 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  961.50 |  1,923 |  1,247 |  676 |
| `prover.main_trace_commit_time_ms` |  547.50 |  1,095 |  723 |  372 |
| `prover.rap_constraints_time_ms` |  318.50 |  637 |  411 |  226 |
| `prover.openings_time_ms` |  95 |  190 |  113 |  77 |
...
| `prover.openings.whir_time_ms` |  40.50 |  81 |  41 |  40 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/80f197b5ed0efa972279de31b1fa6a6681ec2e7a/keccak-80f197b5ed0efa972279de31b1fa6a6681ec2e7a.memory.svg)
...
| app_proof |  |  |  |  |  | 2,127 |  |  | 137 | 14,365,133 | 104.20 | 0 | 13,369 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 41 | 501 | 41 | 15 | 4 | 2 | 2 | 2 | 
| internal_recursive.0 | 1 | 14 | 166 | 14 | 3 | 1 | 2 | 2 | 2 | 
| internal_recursive.1 | 1 | 9 | 128 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 177 | 1,425 | 177 | 63 | 32 | 5 | 7 | 7 | 
| leaf | 1 | 90 | 766 | 90 | 31 | 16 | 5 | 7 | 8 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 81,415,028 | 459 | 241 | 0 | 1 | 172 | 48 | 48 | 92 | 31 | 0 | 44 | 20 | 23 | 7 | 16 | 242 | 172 | 0 | 3 | 30 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,879 | 152 | 49 | 0 | 0 | 73 | 25 | 24 | 30 | 17 | 0 | 29 | 20 | 8 | 2 | 6 | 49 | 73 | 0 | 2 | 17 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 118 | 31 | 0 | 0 |
...
|:---|---:|---:|---:|
| Total |  11.24 |  4.62 |  4.62 |
| app_proof |  9.15 |  2.53 |  2.53 |
| leaf |  1.42 |  1.42 |  1.42 |
...
| `total_proof_time_ms ` |  2,264.25 |  9,057 |  2,440 |  2,174 |
| `execute_metered_time_ms` |  93 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  119.07 | -          |  119.07 |  119.07 |
| `execute_preflight_insns` |  2,791,990.25 |  11,167,961 |  2,851,000 |  2,614,961 |
| `execute_preflight_time_ms` |  158.75 |  635 |  204 |  94 |
| `execute_preflight_insn_mi/s` |  36.98 | -          |  38.09 |  34.35 |
| `trace_gen_time_ms   ` |  60 |  240 |  72 |  54 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,979.75 |  7,919 |  2,137 |  1,915 |
| `prover.main_trace_commit_time_ms` |  540.25 |  2,161 |  629 |  510 |
| `prover.rap_constraints_time_ms` |  1,299.50 |  5,198 |  1,368 |  1,261 |
| `prover.openings_time_ms` |  139.25 |  557 |  143 |  135 |
| `prover.rap_constraints.logup_gkr_time_ms` |  322.50 |  1,290 |  393 |  292 |
| `prover.rap_constraints.round0_time_ms` |  671 |  2,684 |  677 |  667 |
| `prover.rap_constraints.mle_rounds_time_ms` |  304.75 |  1,219 |  307 |  300 |
| `prover.openings.stacked_reduction_time_ms` |  100.50 |  402 |  102 |  99 |
| `prover.openings.stacked_reduction.round0_time_ms` |  60.50 |  242 |  62 |  59 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  39.25 |  157 |  40 |  39 |
| `prover.openings.whir_time_ms` |  38.50 |  154 |  40 |  36 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/61f9e07e58c0b2ff5ee2c14c6f00968177be7ca3/sha2_bench-61f9e07e58c0b2ff5ee2c14c6f00968177be7ca3.memory.svg)
...
| app_proof |  |  |  |  |  | 2,174 |  |  | 93 | 11,167,961 | 119.07 | 0 | 9,157 |  | 
...
| leaf | 0 | 145 | 1,418 | 144 | 53 | 25 | 2 | 6 | 6 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 61,220,603 | 355 | 185 | 0 | 0 | 130 | 37 | 37 | 65 | 27 | 0 | 39 | 20 | 18 | 5 | 12 | 186 | 130 | 0 | 3 | 26 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,879 | 151 | 48 | 0 | 0 | 73 | 25 | 24 | 30 | 17 | 0 | 28 | 19 | 8 | 1 | 6 | 49 | 73 | 0 | 2 | 16 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 120 | 31 | 0 | 0 | 63 | 24 | 23 | 24 | 14 | 0 | 25 | 18 | 7 | 1 | 5 | 31 | 63 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 424,379,238 | 1,273 | 807 | 0 | 158 | 355 | 173 | 172 | 105 | 77 | 0 | 109 | 44 | 64 | 36 | 27 | 807 | 355 | 0 | 7 | 75 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 639,992,057 | 2,137 | 629 | 0 | 121 | 1,368 | 667 | 666 | 307 | 393 | 107 | 138 | 38 | 100 | 60 | 39 | 629 | 1,368 | 0 | 3 | 286 | 0 | 0 | 
| app_proof | prover | 1 | 639,991,820 | 1,935 | 509 | 0 | 2 | 1,283 | 673 | 673 | 306 | 303 | 0 | 141 | 40 | 101 | 61 | 39 | 510 | 1,283 | 0 | 4 | 303 | 0 | 0 | 
| app_proof | prover | 2 | 639,991,820 | 1,932 | 511 | 0 | 2 | 1,286 | 677 | 677 | 306 | 302 | 0 | 135 | 36 | 99 | 59 | 39 | 511 | 1,286 | 0 | 4 | 301 | 0 | 0 | 
| app_proof | prover | 3 | 639,992,052 | 1,915 | 510 | 0 | 2 | 1,261 | 667 | 667 | 300 | 292 | 0 | 143 | 40 | 102 | 62 | 40 | 511 | 1,261 | 0 | 4 | 291 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 72 | 2,440 | 72 | 136 | 0 | 3 | 94 | 2,851,000 | 34.35 | 
| app_proof | 1 | 57 | 2,238 | 57 | 41 | 0 | 1 | 204 | 2,851,000 | 37.78 | 
| app_proof | 2 | 57 | 2,205 | 57 | 41 | 0 | 1 | 174 | 2,851,000 | 37.70 | 
| app_proof | 3 | 54 | 2,174 | 54 | 41 | 0 | 1 | 163 | 2,614,961 | 38.09 | 

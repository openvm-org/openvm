...
| `total_proof_time_ms ` |  2,273 |  9,092 |  2,451 |  2,199 |
...
| `execute_preflight_time_ms` |  156.50 |  626 |  198 |  92 |
| `execute_preflight_insn_mi/s` |  38.20 | -          |  39.29 |  35.30 |
| `trace_gen_time_ms   ` |  60.75 |  243 |  75 |  54 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,990.75 |  7,963 |  2,148 |  1,931 |
| `prover.main_trace_commit_time_ms` |  543 |  2,172 |  630 |  513 |
| `prover.rap_constraints_time_ms` |  1,308.25 |  5,233 |  1,374 |  1,284 |
| `prover.openings_time_ms` |  138 |  552 |  142 |  130 |
| `prover.rap_constraints.logup_gkr_time_ms` |  327.75 |  1,311 |  393 |  305 |
| `prover.rap_constraints.round0_time_ms` |  668 |  2,672 |  669 |  667 |
| `prover.rap_constraints.mle_rounds_time_ms` |  311 |  1,244 |  313 |  308 |
| `prover.openings.stacked_reduction_time_ms` |  100 |  400 |  102 |  94 |
| `prover.openings.stacked_reduction.round0_time_ms` |  60.50 |  242 |  62 |  56 |
...
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,281 |  1,281 |  1,281 |  1,281 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/1fab9d05f2db7333111943f62e6779febee801dd/sha2_bench-1fab9d05f2db7333111943f62e6779febee801dd.memory.svg)
...
| app_proof |  |  |  |  |  | 2,199 |  |  | 93 | 11,167,961 | 119.80 | 0 | 9,192 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 61,220,603 | 358 | 186 | 0 | 0 | 133 | 39 | 38 | 66 | 27 | 0 | 38 | 19 | 18 | 5 | 13 | 186 | 133 | 0 | 3 | 26 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,879 | 152 | 48 | 0 | 0 | 73 | 24 | 24 | 29 | 18 | 0 | 30 | 21 | 8 | 1 | 6 | 49 | 73 | 0 | 2 | 17 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 124 | 32 | 0 | 0 | 61 | 23 | 22 | 24 | 13 | 0 | 30 | 23 | 7 | 1 | 5 | 32 | 61 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 424,379,238 | 1,281 | 808 | 0 | 157 | 360 | 176 | 175 | 106 | 76 | 0 | 112 | 47 | 65 | 36 | 28 | 808 | 360 | 0 | 7 | 75 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 644,972,797 | 2,148 | 630 | 0 | 116 | 1,374 | 667 | 666 | 313 | 393 | 103 | 142 | 40 | 102 | 62 | 40 | 630 | 1,374 | 0 | 4 | 289 | 0 | 0 | 
| app_proof | prover | 1 | 644,972,556 | 1,931 | 513 | 0 | 2 | 1,286 | 667 | 667 | 311 | 307 | 0 | 130 | 36 | 94 | 56 | 37 | 513 | 1,286 | 0 | 4 | 305 | 0 | 0 | 
| app_proof | prover | 2 | 644,972,556 | 1,945 | 514 | 0 | 2 | 1,289 | 669 | 668 | 312 | 306 | 0 | 141 | 38 | 102 | 62 | 39 | 514 | 1,289 | 0 | 4 | 305 | 0 | 0 | 
| app_proof | prover | 3 | 644,972,804 | 1,939 | 515 | 0 | 2 | 1,284 | 669 | 669 | 308 | 305 | 0 | 139 | 36 | 102 | 62 | 40 | 515 | 1,284 | 0 | 4 | 303 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 75 | 2,451 | 75 | 136 | 0 | 3 | 92 | 2,851,000 | 35.30 | 
| app_proof | 1 | 57 | 2,228 | 57 | 41 | 0 | 1 | 198 | 2,851,000 | 39.14 | 
| app_proof | 2 | 57 | 2,214 | 57 | 41 | 0 | 1 | 171 | 2,851,000 | 39.29 | 
| app_proof | 3 | 54 | 2,199 | 54 | 41 | 0 | 1 | 165 | 2,614,961 | 39.07 | 

...
|:---|---:|---:|---:|
| Total |  2.43 |  1.46 |  1.46 |
| app_proof |  1.46 |  0.49 |  0.49 |
| leaf |  0.45 |  0.45 |  0.45 |
...
| `total_proof_time_ms ` |  360.75 |  1,443 |  474 |  224 |
| `execute_metered_time_ms` |  19 | -          | -          | -          |
| `execute_metered_insns` |  4,000,051 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  200.59 | -          |  200.59 |  200.59 |
| `execute_preflight_insns` |  1,000,012.75 |  4,000,051 |  1,310,000 |  70,051 |
| `execute_preflight_time_ms` |  34.75 |  139 |  48 |  4 |
| `execute_preflight_insn_mi/s` |  43.48 | -          |  43.55 |  43.40 |
| `trace_gen_time_ms   ` |  79.50 |  318 |  105 |  69 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  181.25 |  725 |  220 |  73 |
| `prover.main_trace_commit_time_ms` |  42.50 |  170 |  52 |  16 |
| `prover.rap_constraints_time_ms` |  107.75 |  431 |  136 |  34 |
| `prover.openings_time_ms` |  30.25 |  121 |  36 |  22 |
| `prover.rap_constraints.logup_gkr_time_ms` |  66 |  264 |  83 |  17 |
| `prover.rap_constraints.round0_time_ms` |  26.25 |  105 |  35 |  9 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/0c7dbcd17c57bc6543a51a290609e8d974c23f6b/fibonacci-0c7dbcd17c57bc6543a51a290609e8d974c23f6b.memory.svg)
...
| app_proof |  |  |  |  |  | 224 |  |  | 19 | 4,000,051 | 200.59 | 0 | 1,470 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 27,289,339 | 220 | 83 | 0 | 0 | 101 | 34 | 33 | 46 | 20 | 0 | 35 | 23 | 11 | 2 | 8 | 83 | 101 | 0 | 2 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,703 | 145 | 46 | 0 | 0 | 67 | 25 | 25 | 28 | 13 | 0 | 30 | 22 | 8 | 1 | 6 | 46 | 67 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 123 | 32 | 0 | 0 | 62 | 23 | 23 | 24 | 14 | 0 | 27 | 20 | 7 | 1 | 5 | 32 | 62 | 0 | 2 | 13 | 0 | 0 | 
| leaf | 0 | prover | 102,581,158 | 389 | 171 | 0 | 0 | 163 | 72 | 71 | 47 | 43 | 0 | 54 | 35 | 18 | 8 | 9 | 171 | 163 | 0 | 5 | 43 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 62,648,816 | 219 | 51 | 0 | 0 | 136 | 35 | 34 | 17 | 83 | 0 | 32 | 20 | 11 | 5 | 5 | 51 | 136 | 0 | 3 | 83 | 0 | 0 | 
| app_proof | prover | 1 | 62,602,932 | 220 | 52 | 0 | 0 | 131 | 31 | 30 | 17 | 82 | 0 | 36 | 25 | 11 | 5 | 5 | 52 | 131 | 0 | 3 | 82 | 0 | 0 | 
| app_proof | prover | 2 | 62,602,932 | 213 | 51 | 0 | 0 | 130 | 30 | 30 | 17 | 82 | 0 | 31 | 20 | 11 | 5 | 5 | 51 | 130 | 0 | 3 | 81 | 0 | 0 | 
| app_proof | prover | 3 | 9,072,096 | 73 | 16 | 0 | 0 | 34 | 9 | 9 | 7 | 17 | 0 | 22 | 18 | 3 | 0 | 2 | 16 | 34 | 0 | 2 | 16 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 71 | 474 | 71 | 133 | 0 | 3 | 48 | 1,310,000 | 43.48 | 
| app_proof | 1 | 69 | 374 | 69 | 40 | 0 | 1 | 44 | 1,310,000 | 43.55 | 
| app_proof | 2 | 73 | 371 | 73 | 41 | 0 | 1 | 43 | 1,310,000 | 43.49 | 
| app_proof | 3 | 105 | 224 | 105 | 41 | 0 | 1 | 4 | 70,051 | 43.40 | 

...
|:---|---:|---:|---:|
| Total |  16.35 |  4.73 |  4.73 |
| app_proof |  13.37 |  2.51 |  2.51 |
| leaf |  2.19 |  1.43 |  1.43 |
...
| `total_proof_time_ms ` |  2,206 |  13,236 |  2,372 |  2,129 |
| `execute_metered_time_ms` |  138 | -          | -          | -          |
| `execute_metered_insns` |  14,365,133 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  103.41 | -          |  103.41 |  103.41 |
| `execute_preflight_insns` |  2,394,188.83 |  14,365,133 |  2,413,000 |  2,300,133 |
| `execute_preflight_time_ms` |  236.33 |  1,418 |  322 |  83 |
| `execute_preflight_insn_mi/s` |  35.29 | -          |  36.39 |  32.32 |
| `trace_gen_time_ms   ` |  37.33 |  224 |  57 |  33 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,874.67 |  11,248 |  2,096 |  1,824 |
| `prover.main_trace_commit_time_ms` |  693.33 |  4,160 |  851 |  661 |
| `prover.rap_constraints_time_ms` |  1,002.67 |  6,016 |  1,067 |  982 |
| `prover.openings_time_ms` |  177.67 |  1,066 |  181 |  174 |
| `prover.rap_constraints.logup_gkr_time_ms` |  171.17 |  1,027 |  222 |  160 |
| `prover.rap_constraints.round0_time_ms` |  517.83 |  3,107 |  521 |  511 |
| `prover.rap_constraints.mle_rounds_time_ms` |  312.67 |  1,876 |  333 |  303 |
...
| `prover.openings.whir_time_ms` |  43.17 |  259 |  47 |  40 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,094 |  2,188 |  1,425 |  763 |
| `execute_preflight_time_ms` |  5.50 |  11 |  6 |  5 |
| `trace_gen_time_ms   ` |  133.50 |  267 |  177 |  90 |
| `generate_blob_total_time_ms` |  24 |  48 |  32 |  16 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  959.50 |  1,919 |  1,247 |  672 |
| `prover.main_trace_commit_time_ms` |  548 |  1,096 |  723 |  373 |
| `prover.rap_constraints_time_ms` |  318 |  636 |  407 |  229 |
| `prover.openings_time_ms` |  93 |  186 |  116 |  70 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/1a396655b09449e89c47f25c187542e485641a21/keccak-1a396655b09449e89c47f25c187542e485641a21.memory.svg)
...
| app_proof |  |  |  |  |  | 2,129 |  |  | 138 | 14,365,133 | 103.41 | 0 | 13,383 |  | 
...
| internal_recursive.0 | 1 | 14 | 164 | 14 | 2 | 1 | 2 | 2 | 2 | 
| internal_recursive.1 | 1 | 9 | 128 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 177 | 1,425 | 177 | 63 | 32 | 6 | 7 | 7 | 
| leaf | 1 | 90 | 763 | 89 | 32 | 16 | 5 | 7 | 7 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 81,415,028 | 460 | 242 | 0 | 1 | 173 | 49 | 48 | 92 | 30 | 0 | 44 | 20 | 23 | 7 | 15 | 243 | 173 | 0 | 3 | 29 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,879 | 149 | 49 | 0 | 0 | 72 | 25 | 24 | 29 | 17 | 0 | 27 | 18 | 8 | 1 | 6 | 49 | 72 | 0 | 2 | 16 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 118 | 31 | 0 | 0 | 63 | 24 | 24 | 24 | 13 | 0 | 23 | 16 | 7 | 1 | 5 | 31 | 63 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 474,940,262 | 1,247 | 723 | 0 | 2 | 407 | 203 | 202 | 118 | 85 | 0 | 116 | 45 | 70 | 40 | 30 | 723 | 407 | 0 | 7 | 85 | 0 | 0 | 
| leaf | 1 | prover | 239,436,532 | 672 | 372 | 0 | 1 | 229 | 109 | 108 | 68 | 51 | 0 | 70 | 33 | 37 | 19 | 17 | 373 | 229 | 0 | 6 | 49 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 842,692,236 | 2,096 | 850 | 0 | 189 | 1,067 | 511 | 511 | 333 | 222 | 67 | 177 | 42 | 134 | 82 | 52 | 851 | 1,067 | 0 | 3 | 152 | 0 | 0 | 
| app_proof | prover | 1 | 842,692,236 | 1,845 | 661 | 0 | 3 | 1,006 | 518 | 517 | 328 | 160 | 0 | 177 | 44 | 133 | 81 | 52 | 661 | 1,006 | 0 | 3 | 159 | 0 | 0 | 
| app_proof | prover | 2 | 842,692,236 | 1,825 | 661 | 0 | 3 | 982 | 517 | 517 | 303 | 160 | 0 | 181 | 47 | 134 | 82 | 51 | 662 | 982 | 0 | 3 | 159 | 0 | 0 | 
| app_proof | prover | 3 | 842,692,236 | 1,829 | 662 | 0 | 3 | 987 | 520 | 520 | 304 | 162 | 0 | 178 | 43 | 134 | 82 | 52 | 663 | 987 | 0 | 4 | 161 | 0 | 0 | 
| app_proof | prover | 4 | 842,692,236 | 1,824 | 661 | 0 | 3 | 987 | 521 | 521 | 303 | 162 | 0 | 174 | 40 | 133 | 81 | 52 | 661 | 987 | 0 | 3 | 161 | 0 | 0 | 
| app_proof | prover | 5 | 842,692,236 | 1,829 | 662 | 0 | 3 | 987 | 520 | 520 | 305 | 161 | 0 | 179 | 43 | 135 | 83 | 52 | 662 | 987 | 0 | 4 | 160 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 57 | 2,372 | 57 | 135 | 0 | 3 | 83 | 2,413,000 | 32.32 | 
| app_proof | 1 | 33 | 2,242 | 33 | 41 | 0 | 1 | 322 | 2,413,000 | 35.94 | 
| app_proof | 2 | 33 | 2,160 | 33 | 41 | 0 | 1 | 259 | 2,413,000 | 35.52 | 
| app_proof | 3 | 34 | 2,170 | 34 | 41 | 0 | 1 | 265 | 2,413,000 | 36.39 | 
| app_proof | 4 | 34 | 2,163 | 34 | 41 | 0 | 1 | 263 | 2,413,000 | 35.73 | 
| app_proof | 5 | 33 | 2,129 | 33 | 41 | 0 | 1 | 226 | 2,300,133 | 35.86 | 

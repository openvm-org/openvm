...
| `total_proof_time_ms ` |  2,369.83 |  14,219 |  2,544 |  2,291 |
...
| `execute_preflight_time_ms` |  251.50 |  1,509 |  344 |  97 |
| `execute_preflight_insn_mi/s` |  30.64 | -          |  31.46 |  28.31 |
| `trace_gen_time_ms   ` |  35.83 |  215 |  46 |  33 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  2,024.67 |  12,148 |  2,264 |  1,966 |
| `prover.main_trace_commit_time_ms` |  718.33 |  4,310 |  879 |  685 |
| `prover.rap_constraints_time_ms` |  1,115.67 |  6,694 |  1,193 |  1,093 |
| `prover.openings_time_ms` |  189.67 |  1,138 |  192 |  187 |
| `prover.rap_constraints.logup_gkr_time_ms` |  267 |  1,602 |  331 |  253 |
| `prover.rap_constraints.round0_time_ms` |  526.50 |  3,159 |  528 |  523 |
| `prover.rap_constraints.mle_rounds_time_ms` |  321.67 |  1,930 |  338 |  314 |
| `prover.openings.stacked_reduction_time_ms` |  148.50 |  891 |  150 |  147 |
| `prover.openings.stacked_reduction.round0_time_ms` |  85.83 |  515 |  87 |  84 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  62 |  372 |  63 |  61 |
| `prover.openings.whir_time_ms` |  40.67 |  244 |  42 |  38 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,134 |  2,268 |  1,470 |  798 |
...
| `prover.main_trace_commit_time_ms` |  558 |  1,116 |  734 |  382 |
| `prover.rap_constraints_time_ms` |  331.50 |  663 |  425 |  238 |
| `prover.openings_time_ms` |  106 |  212 |  127 |  85 |
| `prover.rap_constraints.logup_gkr_time_ms` |  74 |  148 |  91 |  57 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/bc2f2d05609390bbd1d278b600e9a6ed6336f41a/keccak-bc2f2d05609390bbd1d278b600e9a6ed6336f41a.memory.svg)
...
| app_proof |  |  |  |  |  | 2,291 |  |  | 138 | 14,365,133 | 103.38 | 0 | 14,364 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 38 | 528 | 38 | 13 | 4 | 2 | 2 | 2 | 
| internal_recursive.0 | 1 | 13 | 187 | 13 | 2 | 1 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 9 | 159 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 183 | 1,470 | 183 | 64 | 33 | 6 | 7 | 7 | 
| leaf | 1 | 92 | 798 | 92 | 32 | 16 | 5 | 7 | 7 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 81,415,028 | 489 | 249 | 0 | 14 | 179 | 48 | 47 | 93 | 36 | 0 | 60 | 20 | 39 | 7 | 31 | 249 | 179 | 0 | 3 | 36 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,879 | 173 | 52 | 0 | 4 | 77 | 24 | 24 | 29 | 23 | 0 | 43 | 18 | 25 | 2 | 23 | 52 | 77 | 0 | 2 | 23 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 149 | 34 | 0 | 4 | 69 | 24 | 23 | 25 | 19 | 0 | 45 | 22 | 23 | 1 | 21 | 34 | 68 | 0 | 2 | 18 | 0 | 0 | 
| leaf | 0 | prover | 476,578,662 | 1,287 | 733 | 0 | 47 | 425 | 208 | 207 | 126 | 91 | 0 | 127 | 40 | 86 | 41 | 45 | 734 | 425 | 0 | 6 | 89 | 0 | 0 | 
| leaf | 1 | prover | 240,255,732 | 706 | 381 | 0 | 24 | 238 | 111 | 110 | 69 | 57 | 0 | 85 | 32 | 53 | 20 | 32 | 382 | 238 | 0 | 6 | 55 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 857,732,748 | 2,264 | 879 | 0 | 252 | 1,193 | 523 | 523 | 338 | 331 | 77 | 191 | 42 | 149 | 87 | 61 | 879 | 1,193 | 0 | 4 | 253 | 0 | 0 | 
| app_proof | prover | 1 | 857,732,748 | 1,997 | 685 | 0 | 58 | 1,119 | 528 | 527 | 335 | 255 | 0 | 191 | 41 | 150 | 87 | 62 | 686 | 1,119 | 0 | 4 | 253 | 0 | 0 | 
| app_proof | prover | 2 | 857,732,748 | 1,966 | 685 | 0 | 58 | 1,093 | 525 | 524 | 315 | 253 | 0 | 187 | 38 | 148 | 86 | 62 | 685 | 1,093 | 0 | 3 | 252 | 0 | 0 | 
| app_proof | prover | 3 | 857,732,748 | 1,975 | 685 | 0 | 58 | 1,098 | 528 | 527 | 314 | 255 | 0 | 190 | 42 | 148 | 85 | 62 | 686 | 1,098 | 0 | 3 | 254 | 0 | 0 | 
| app_proof | prover | 4 | 857,732,748 | 1,974 | 686 | 0 | 58 | 1,094 | 527 | 526 | 314 | 253 | 0 | 192 | 42 | 149 | 86 | 63 | 687 | 1,094 | 0 | 3 | 251 | 0 | 0 | 
| app_proof | prover | 5 | 857,732,748 | 1,972 | 687 | 0 | 58 | 1,097 | 528 | 527 | 314 | 255 | 0 | 187 | 39 | 147 | 84 | 62 | 687 | 1,097 | 0 | 3 | 254 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 46 | 2,544 | 46 | 135 | 0 | 3 | 97 | 2,413,000 | 28.31 | 
| app_proof | 1 | 34 | 2,416 | 34 | 41 | 0 | 1 | 344 | 2,413,000 | 31.06 | 
| app_proof | 2 | 34 | 2,321 | 34 | 41 | 0 | 1 | 278 | 2,413,000 | 30.58 | 
| app_proof | 3 | 34 | 2,324 | 34 | 41 | 0 | 1 | 273 | 2,413,000 | 31.38 | 
| app_proof | 4 | 34 | 2,323 | 34 | 41 | 0 | 1 | 274 | 2,413,000 | 31.46 | 
| app_proof | 5 | 33 | 2,291 | 33 | 41 | 0 | 1 | 243 | 2,300,133 | 31.04 | 

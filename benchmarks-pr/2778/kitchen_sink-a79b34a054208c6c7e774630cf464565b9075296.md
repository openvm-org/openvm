...
|:---|---:|---:|---:|
| Total |  2.80 |  2.05 |  2.05 |
| app_proof |  1.98 |  1.24 |  1.24 |
| leaf |  0.43 |  0.43 |  0.43 |
...
| `total_proof_time_ms ` |  981 |  1,962 |  1,219 |  743 |
| `execute_metered_time_ms` |  23 | -          | -          | -          |
| `execute_metered_insns` |  1,979,971 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  83.94 | -          |  83.94 |  83.94 |
| `execute_preflight_insns` |  989,985.50 |  1,979,971 |  1,168,000 |  811,971 |
| `execute_preflight_time_ms` |  92 |  184 |  127 |  57 |
| `execute_preflight_insn_mi/s` |  29.50 | -          |  30.25 |  28.74 |
| `trace_gen_time_ms   ` |  24.50 |  49 |  33 |  16 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  775 |  1,550 |  992 |  558 |
| `prover.main_trace_commit_time_ms` |  216 |  432 |  284 |  148 |
| `prover.rap_constraints_time_ms` |  494 |  988 |  631 |  357 |
| `prover.openings_time_ms` |  63 |  126 |  75 |  51 |
| `prover.rap_constraints.logup_gkr_time_ms` |  109.50 |  219 |  153 |  66 |
| `prover.rap_constraints.round0_time_ms` |  283 |  566 |  350 |  216 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/a79b34a054208c6c7e774630cf464565b9075296/kitchen_sink-a79b34a054208c6c7e774630cf464565b9075296.memory.svg)
...
| app_proof |  |  |  |  |  | 743 |  |  | 23 | 1,979,971 | 83.94 | 0 | 1,990 |  | 
...
| leaf | 0 | 111 | 431 | 110 | 24 | 11 | 20 | 4 | 4 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,577,915 | 140 | 40 | 0 | 4 | 65 | 20 | 19 | 29 | 16 | 0 | 33 | 9 | 23 | 1 | 21 | 40 | 65 | 0 | 1 | 15 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,703 | 105 | 19 | 0 | 4 | 54 | 20 | 19 | 20 | 14 | 0 | 31 | 9 | 21 | 1 | 20 | 19 | 54 | 0 | 1 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 97 | 14 | 0 | 4 | 52 | 19 | 18 | 18 | 13 | 0 | 30 | 8 | 21 | 0 | 20 | 14 | 52 | 0 | 1 | 13 | 0 | 0 | 
| leaf | 0 | prover | 263,565,172 | 319 | 129 | 0 | 10 | 144 | 48 | 48 | 37 | 58 | 0 | 44 | 13 | 31 | 7 | 24 | 129 | 144 | 0 | 2 | 57 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 564,299,284 | 992 | 284 | 0 | 155 | 631 | 350 | 349 | 127 | 153 | 54 | 75 | 13 | 62 | 15 | 47 | 284 | 631 | 0 | 1 | 98 | 0 | 0 | 
| app_proof | prover | 1 | 541,080,972 | 558 | 148 | 0 | 23 | 357 | 216 | 215 | 75 | 66 | 0 | 51 | 12 | 38 | 14 | 24 | 148 | 357 | 0 | 1 | 65 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 33 | 1,219 | 33 | 135 | 0 | 4 | 57 | 1,168,000 | 28.74 | 
| app_proof | 1 | 16 | 743 | 16 | 40 | 0 | 1 | 127 | 811,971 | 30.25 | 

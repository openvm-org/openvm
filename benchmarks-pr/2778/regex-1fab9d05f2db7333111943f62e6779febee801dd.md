...
| `total_proof_time_ms ` |  675.50 |  1,351 |  770 |  581 |
| `execute_metered_time_ms` |  31 | -          | -          | -          |
| `execute_metered_insns` |  4,090,656 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  130.32 | -          |  130.32 |  130.32 |
| `execute_preflight_insns` |  2,045,328 |  4,090,656 |  2,327,000 |  1,763,656 |
| `execute_preflight_time_ms` |  79.50 |  159 |  84 |  75 |
| `execute_preflight_insn_mi/s` |  35.22 | -          |  37.18 |  33.27 |
| `trace_gen_time_ms   ` |  44 |  88 |  45 |  43 |
| `memory_finalize_time_ms` |  1 |  2 |  2 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  462.50 |  925 |  506 |  419 |
| `prover.main_trace_commit_time_ms` |  117 |  234 |  131 |  103 |
| `prover.rap_constraints_time_ms` |  300.50 |  601 |  326 |  275 |
| `prover.openings_time_ms` |  44.50 |  89 |  48 |  41 |
| `prover.rap_constraints.logup_gkr_time_ms` |  169 |  338 |  200 |  138 |
| `prover.rap_constraints.round0_time_ms` |  91 |  182 |  101 |  81 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/1fab9d05f2db7333111943f62e6779febee801dd/regex-1fab9d05f2db7333111943f62e6779febee801dd.memory.svg)
...
| app_proof |  |  |  |  |  | 581 |  |  | 31 | 4,090,656 | 130.32 | 0 | 1,396 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 27,289,339 | 209 | 81 | 0 | 0 | 98 | 33 | 32 | 45 | 19 | 0 | 29 | 18 | 11 | 2 | 8 | 81 | 98 | 0 | 2 | 18 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,703 | 144 | 46 | 0 | 0 | 67 | 24 | 24 | 28 | 14 | 0 | 30 | 22 | 8 | 1 | 6 | 47 | 67 | 0 | 2 | 12 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 119 | 31 | 0 | 0 | 62 | 24 | 23 | 24 | 13 | 0 | 24 | 17 | 7 | 1 | 5 | 32 | 62 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 79,659,764 | 310 | 127 | 0 | 0 | 137 | 55 | 54 | 38 | 44 | 0 | 44 | 28 | 15 | 6 | 8 | 128 | 137 | 0 | 5 | 41 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 164,023,250 | 506 | 130 | 0 | 0 | 326 | 81 | 80 | 45 | 200 | 57 | 48 | 23 | 25 | 13 | 11 | 131 | 326 | 0 | 3 | 142 | 0 | 0 | 
| app_proof | prover | 1 | 125,436,227 | 419 | 102 | 0 | 8 | 275 | 101 | 100 | 35 | 138 | 0 | 41 | 19 | 21 | 10 | 10 | 103 | 275 | 0 | 3 | 137 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 43 | 770 | 43 | 135 | 2 | 4 | 84 | 2,327,000 | 33.27 | 
| app_proof | 1 | 45 | 581 | 45 | 41 | 0 | 2 | 75 | 1,763,656 | 37.18 | 

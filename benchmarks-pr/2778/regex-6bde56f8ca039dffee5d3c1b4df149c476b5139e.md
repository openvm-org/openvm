...
| `total_proof_time_ms ` |  751.50 |  1,503 |  891 |  612 |
| `execute_metered_time_ms` |  31 | -          | -          | -          |
| `execute_metered_insns` |  4,090,656 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  128.03 | -          |  128.03 |  128.03 |
| `execute_preflight_insns` |  2,045,328 |  4,090,656 |  2,327,000 |  1,763,656 |
| `execute_preflight_time_ms` |  85 |  170 |  90 |  80 |
| `execute_preflight_insn_mi/s` |  31.47 | -          |  33.05 |  29.88 |
| `trace_gen_time_ms   ` |  39 |  78 |  41 |  37 |
| `memory_finalize_time_ms` |  1 |  2 |  2 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  538.50 |  1,077 |  627 |  450 |
| `prover.main_trace_commit_time_ms` |  119.50 |  239 |  131 |  108 |
| `prover.rap_constraints_time_ms` |  364 |  728 |  435 |  293 |
| `prover.openings_time_ms` |  54 |  108 |  60 |  48 |
| `prover.rap_constraints.logup_gkr_time_ms` |  229.50 |  459 |  303 |  156 |
| `prover.rap_constraints.round0_time_ms` |  94 |  188 |  101 |  87 |
...
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  18.50 |  37 |  19 |  18 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/6bde56f8ca039dffee5d3c1b4df149c476b5139e/regex-6bde56f8ca039dffee5d3c1b4df149c476b5139e.memory.svg)
...
| app_proof |  |  |  |  |  | 612 |  |  | 31 | 4,090,656 | 128.03 | 0 | 1,548 |  | 
| internal_for_leaf |  |  |  | 252 |  |  |  |  |  |  |  |  |  | 252 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 27,289,339 | 237 | 83 | 0 | 5 | 101 | 30 | 30 | 45 | 25 | 0 | 51 | 25 | 26 | 2 | 23 | 83 | 101 | 0 | 2 | 24 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,703 | 167 | 49 | 0 | 3 | 72 | 25 | 24 | 27 | 19 | 0 | 45 | 21 | 23 | 1 | 21 | 50 | 72 | 0 | 2 | 18 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 144 | 33 | 0 | 3 | 67 | 24 | 23 | 24 | 18 | 0 | 43 | 20 | 22 | 1 | 20 | 34 | 67 | 0 | 2 | 18 | 0 | 0 | 
| leaf | 0 | prover | 79,659,764 | 326 | 129 | 0 | 8 | 139 | 54 | 53 | 37 | 47 | 0 | 55 | 25 | 30 | 6 | 23 | 130 | 139 | 0 | 5 | 46 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 164,023,250 | 627 | 131 | 0 | 8 | 435 | 87 | 86 | 44 | 303 | 67 | 60 | 26 | 34 | 14 | 19 | 131 | 435 | 0 | 3 | 235 | 0 | 0 | 
| app_proof | prover | 1 | 125,436,227 | 450 | 108 | 0 | 15 | 293 | 101 | 100 | 35 | 156 | 0 | 48 | 19 | 28 | 9 | 18 | 108 | 293 | 0 | 3 | 155 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 37 | 891 | 37 | 135 | 2 | 4 | 90 | 2,327,000 | 29.88 | 
| app_proof | 1 | 41 | 612 | 41 | 40 | 0 | 2 | 80 | 1,763,656 | 33.05 | 

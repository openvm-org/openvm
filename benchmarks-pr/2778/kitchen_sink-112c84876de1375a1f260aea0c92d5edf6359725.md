...
|:---|---:|---:|---:|
| Total |  2.77 |  2.03 |  2.03 |
| app_proof |  1.96 |  1.22 |  1.22 |
| leaf |  0.43 |  0.43 |  0.43 |
...
| `total_proof_time_ms ` |  970.50 |  1,941 |  1,195 |  746 |
| `execute_metered_time_ms` |  23 | -          | -          | -          |
| `execute_metered_insns` |  1,979,971 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  84.28 | -          |  84.28 |  84.28 |
| `execute_preflight_insns` |  989,985.50 |  1,979,971 |  1,168,000 |  811,971 |
| `execute_preflight_time_ms` |  100 |  200 |  140 |  60 |
| `execute_preflight_insn_mi/s` |  31.62 | -          |  32.30 |  30.95 |
| `trace_gen_time_ms   ` |  24 |  48 |  33 |  15 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  756.50 |  1,513 |  964 |  549 |
| `prover.main_trace_commit_time_ms` |  210 |  420 |  275 |  145 |
| `prover.rap_constraints_time_ms` |  482 |  964 |  613 |  351 |
| `prover.openings_time_ms` |  63 |  126 |  75 |  51 |
| `prover.rap_constraints.logup_gkr_time_ms` |  107.50 |  215 |  150 |  65 |
| `prover.rap_constraints.round0_time_ms` |  275.50 |  551 |  339 |  212 |
| `prover.rap_constraints.mle_rounds_time_ms` |  99 |  198 |  124 |  74 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/112c84876de1375a1f260aea0c92d5edf6359725/kitchen_sink-112c84876de1375a1f260aea0c92d5edf6359725.memory.svg)
...
| app_proof |  |  |  |  |  | 746 |  |  | 23 | 1,979,971 | 84.28 | 0 | 1,969 |  | 
...
| leaf | 0 | 112 | 431 | 111 | 25 | 10 | 18 | 5 | 5 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,577,915 | 141 | 40 | 0 | 4 | 67 | 22 | 21 | 29 | 16 | 0 | 32 | 9 | 23 | 1 | 21 | 41 | 67 | 0 | 1 | 15 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,703 | 102 | 19 | 0 | 4 | 51 | 17 | 17 | 20 | 13 | 0 | 30 | 8 | 21 | 1 | 20 | 19 | 51 | 0 | 1 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 98 | 14 | 0 | 4 | 53 | 20 | 19 | 18 | 13 | 0 | 29 | 8 | 21 | 0 | 20 | 15 | 53 | 0 | 1 | 13 | 0 | 0 | 
| leaf | 0 | prover | 261,140,340 | 318 | 129 | 0 | 10 | 143 | 48 | 47 | 37 | 57 | 0 | 44 | 13 | 31 | 7 | 24 | 130 | 143 | 0 | 2 | 57 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 555,262,116 | 964 | 275 | 0 | 147 | 613 | 339 | 337 | 124 | 150 | 53 | 75 | 13 | 62 | 15 | 46 | 275 | 613 | 0 | 1 | 95 | 0 | 0 | 
| app_proof | prover | 1 | 533,498,636 | 549 | 145 | 0 | 22 | 351 | 212 | 211 | 74 | 65 | 0 | 51 | 12 | 38 | 14 | 24 | 145 | 351 | 0 | 1 | 64 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 33 | 1,195 | 33 | 136 | 0 | 4 | 60 | 1,168,000 | 30.95 | 
| app_proof | 1 | 15 | 746 | 15 | 40 | 0 | 1 | 140 | 811,971 | 32.30 | 

...
|:---|---:|---:|---:|
| Total |  11.17 |  4.60 |  4.60 |
| app_proof |  9.09 |  2.52 |  2.52 |
| leaf |  1.41 |  1.41 |  1.41 |
...
| `total_proof_time_ms ` |  2,249.50 |  8,998 |  2,429 |  2,168 |
| `execute_metered_time_ms` |  92 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  120.78 | -          |  120.78 |  120.78 |
| `execute_preflight_insns` |  2,791,990.25 |  11,167,961 |  2,851,000 |  2,614,961 |
| `execute_preflight_time_ms` |  155 |  620 |  196 |  91 |
| `execute_preflight_insn_mi/s` |  37.97 | -          |  39.55 |  35.54 |
| `trace_gen_time_ms   ` |  60.50 |  242 |  74 |  54 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,968 |  7,872 |  2,127 |  1,911 |
| `prover.main_trace_commit_time_ms` |  537.75 |  2,151 |  626 |  508 |
| `prover.rap_constraints_time_ms` |  1,291.75 |  5,167 |  1,359 |  1,266 |
| `prover.openings_time_ms` |  137.25 |  549 |  140 |  136 |
| `prover.rap_constraints.logup_gkr_time_ms` |  324.50 |  1,298 |  392 |  301 |
| `prover.rap_constraints.round0_time_ms` |  661.50 |  2,646 |  666 |  657 |
| `prover.rap_constraints.mle_rounds_time_ms` |  304.25 |  1,217 |  309 |  301 |
| `prover.openings.stacked_reduction_time_ms` |  100 |  400 |  101 |  98 |
...
| `prover.openings.whir_time_ms` |  36.75 |  147 |  39 |  35 |
...
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,257 |  1,257 |  1,257 |  1,257 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/ebfb12e2465f1dea9e46b0a75d9dc7311e1b82c9/sha2_bench-ebfb12e2465f1dea9e46b0a75d9dc7311e1b82c9.memory.svg)
...
| 24 | VmAirWrapper<Rv64BaseAluAdapterU16Air, LessThanCoreAir<4, 16> | 19 | 30 | 3 | 
...
| app_proof |  |  |  |  |  | 2,168 |  |  | 92 | 11,167,961 | 120.78 | 0 | 9,096 |  | 
| internal_for_leaf |  |  |  | 377 |  |  |  |  |  |  |  |  |  | 378 | 
...
| leaf | 0 | 151 | 1,408 | 150 | 57 | 25 | 2 | 6 | 6 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 61,220,603 | 352 | 183 | 0 | 0 | 130 | 37 | 37 | 64 | 27 | 0 | 38 | 19 | 18 | 5 | 12 | 184 | 130 | 0 | 3 | 26 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,879 | 150 | 47 | 0 | 0 | 72 | 24 | 24 | 29 | 17 | 0 | 30 | 21 | 8 | 2 | 6 | 48 | 72 | 0 | 2 | 17 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 120 | 31 | 0 | 0 | 62 | 23 | 22 | 24 | 14 | 0 | 26 | 19 | 7 | 1 | 5 | 31 | 61 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 424,379,238 | 1,257 | 802 | 0 | 158 | 348 | 170 | 169 | 102 | 74 | 0 | 106 | 42 | 64 | 36 | 28 | 802 | 348 | 0 | 7 | 73 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 644,972,797 | 2,127 | 626 | 0 | 119 | 1,359 | 657 | 657 | 309 | 392 | 106 | 140 | 39 | 101 | 61 | 39 | 626 | 1,359 | 0 | 4 | 285 | 0 | 0 | 
| app_proof | prover | 1 | 644,972,556 | 1,920 | 508 | 0 | 2 | 1,274 | 666 | 665 | 304 | 303 | 0 | 137 | 36 | 101 | 62 | 39 | 508 | 1,274 | 0 | 4 | 301 | 0 | 0 | 
| app_proof | prover | 2 | 644,972,556 | 1,914 | 509 | 0 | 2 | 1,268 | 662 | 662 | 303 | 301 | 0 | 136 | 37 | 98 | 60 | 38 | 509 | 1,268 | 0 | 3 | 300 | 0 | 0 | 
| app_proof | prover | 3 | 644,972,804 | 1,911 | 508 | 0 | 2 | 1,266 | 661 | 661 | 301 | 302 | 0 | 136 | 35 | 100 | 61 | 39 | 508 | 1,266 | 0 | 4 | 301 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 74 | 2,429 | 74 | 136 | 0 | 3 | 91 | 2,851,000 | 35.54 | 
| app_proof | 1 | 57 | 2,215 | 57 | 41 | 0 | 1 | 196 | 2,851,000 | 39.16 | 
| app_proof | 2 | 57 | 2,186 | 57 | 41 | 0 | 1 | 172 | 2,851,000 | 37.63 | 
| app_proof | 3 | 54 | 2,168 | 54 | 41 | 0 | 1 | 161 | 2,614,961 | 39.55 | 

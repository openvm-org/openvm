...
|:---|---:|---:|---:|
| Total |  2.81 |  1.73 |  1.73 |
| app_proof |  1.64 |  0.56 |  0.56 |
| leaf |  0.54 |  0.54 |  0.54 |
...
| `total_proof_time_ms ` |  406.25 |  1,625 |  545 |  224 |
| `execute_metered_time_ms` |  19 | -          | -          | -          |
| `execute_metered_insns` |  4,000,051 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  200.97 | -          |  200.97 |  200.97 |
| `execute_preflight_insns` |  1,000,012.75 |  4,000,051 |  1,310,000 |  70,051 |
| `execute_preflight_time_ms` |  40.50 |  162 |  58 |  4 |
| `execute_preflight_insn_mi/s` |  34.47 | -          |  35.61 |  31.62 |
| `trace_gen_time_ms   ` |  69.75 |  279 |  101 |  52 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  229.50 |  918 |  289 |  77 |
| `prover.main_trace_commit_time_ms` |  48.50 |  194 |  60 |  16 |
| `prover.rap_constraints_time_ms` |  147 |  588 |  190 |  36 |
| `prover.openings_time_ms` |  32.75 |  131 |  38 |  24 |
| `prover.rap_constraints.logup_gkr_time_ms` |  100.25 |  401 |  130 |  18 |
| `prover.rap_constraints.round0_time_ms` |  30.25 |  121 |  41 |  9 |
| `prover.rap_constraints.mle_rounds_time_ms` |  15.50 |  62 |  18 |  8 |
| `prover.openings.stacked_reduction_time_ms` |  14.50 |  58 |  19 |  8 |
...
| `prover.openings.whir_time_ms` |  17.75 |  71 |  19 |  16 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/bc2f2d05609390bbd1d278b600e9a6ed6336f41a/fibonacci-bc2f2d05609390bbd1d278b600e9a6ed6336f41a.memory.svg)
...
| app_proof |  |  |  |  |  | 224 |  |  | 19 | 4,000,051 | 200.97 | 0 | 1,652 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,683 | 279 | 118 | 0 | 7 | 111 | 34 | 33 | 51 | 25 | 0 | 49 | 20 | 29 | 3 | 25 | 118 | 111 | 0 | 2 | 25 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,703 | 166 | 48 | 0 | 4 | 72 | 24 | 24 | 28 | 19 | 0 | 44 | 20 | 23 | 1 | 21 | 48 | 72 | 0 | 2 | 18 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 143 | 33 | 0 | 4 | 66 | 23 | 22 | 24 | 18 | 0 | 42 | 19 | 22 | 1 | 21 | 34 | 66 | 0 | 2 | 17 | 0 | 0 | 
| leaf | 0 | prover | 142,599,078 | 478 | 228 | 0 | 14 | 179 | 78 | 77 | 51 | 48 | 0 | 70 | 31 | 39 | 11 | 27 | 228 | 179 | 0 | 5 | 47 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 69,989,034 | 289 | 60 | 0 | 2 | 190 | 41 | 40 | 18 | 130 | 0 | 38 | 18 | 19 | 6 | 12 | 60 | 190 | 0 | 3 | 128 | 0 | 0 | 
| app_proof | prover | 1 | 69,942,964 | 276 | 59 | 0 | 1 | 182 | 36 | 36 | 18 | 127 | 0 | 34 | 18 | 16 | 6 | 9 | 59 | 182 | 0 | 3 | 126 | 0 | 0 | 
| app_proof | prover | 2 | 69,942,964 | 276 | 59 | 0 | 1 | 180 | 35 | 35 | 18 | 126 | 0 | 35 | 19 | 15 | 6 | 9 | 59 | 180 | 0 | 3 | 126 | 0 | 0 | 
| app_proof | prover | 3 | 9,530,860 | 77 | 16 | 0 | 1 | 36 | 9 | 9 | 8 | 18 | 0 | 24 | 16 | 8 | 1 | 7 | 16 | 35 | 0 | 2 | 17 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 70 | 545 | 70 | 138 | 0 | 3 | 46 | 1,310,000 | 31.62 | 
| app_proof | 1 | 52 | 428 | 52 | 41 | 0 | 1 | 58 | 1,310,000 | 35.61 | 
| app_proof | 2 | 56 | 428 | 56 | 41 | 0 | 1 | 54 | 1,310,000 | 35.55 | 
| app_proof | 3 | 101 | 224 | 101 | 41 | 0 | 1 | 4 | 70,051 | 35.10 | 

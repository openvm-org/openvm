...
| `total_proof_time_ms ` |  352 |  1,408 |  462 |  221 |
| `execute_metered_time_ms` |  19 | -          | -          | -          |
| `execute_metered_insns` |  4,000,051 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  201.33 | -          |  201.33 |  201.33 |
| `execute_preflight_insns` |  1,000,012.75 |  4,000,051 |  1,310,000 |  70,051 |
| `execute_preflight_time_ms` |  34.75 |  139 |  48 |  4 |
| `execute_preflight_insn_mi/s` |  43.49 | -          |  43.67 |  43.24 |
| `trace_gen_time_ms   ` |  75.75 |  303 |  101 |  67 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  176 |  704 |  211 |  74 |
| `prover.main_trace_commit_time_ms` |  41.25 |  165 |  50 |  15 |
| `prover.rap_constraints_time_ms` |  102.50 |  410 |  126 |  33 |
| `prover.openings_time_ms` |  31.25 |  125 |  34 |  24 |
| `prover.rap_constraints.logup_gkr_time_ms` |  64 |  256 |  81 |  16 |
| `prover.rap_constraints.round0_time_ms` |  23.75 |  95 |  30 |  9 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/0d37807f81ca10c7aa550cd241eac41abde64fd6/fibonacci-0d37807f81ca10c7aa550cd241eac41abde64fd6.memory.svg)
...
| app_proof |  |  |  |  |  | 221 |  |  | 19 | 4,000,051 | 201.33 | 0 | 1,434 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 27,289,339 | 213 | 81 | 0 | 0 | 97 | 31 | 30 | 45 | 20 | 0 | 33 | 22 | 11 | 2 | 8 | 81 | 97 | 0 | 2 | 18 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,703 | 142 | 44 | 0 | 0 | 67 | 25 | 24 | 28 | 13 | 0 | 29 | 21 | 8 | 1 | 6 | 45 | 67 | 0 | 2 | 12 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 119 | 31 | 0 | 0 | 61 | 23 | 22 | 24 | 13 | 0 | 27 | 19 | 7 | 1 | 5 | 31 | 61 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 102,581,158 | 377 | 166 | 0 | 0 | 158 | 69 | 68 | 46 | 43 | 0 | 51 | 32 | 18 | 8 | 9 | 166 | 158 | 0 | 5 | 42 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 62,648,832 | 211 | 50 | 0 | 0 | 126 | 30 | 30 | 16 | 79 | 0 | 34 | 23 | 11 | 5 | 5 | 50 | 126 | 0 | 3 | 78 | 0 | 0 | 
| app_proof | prover | 1 | 62,602,932 | 209 | 50 | 0 | 0 | 125 | 28 | 27 | 16 | 80 | 0 | 34 | 22 | 12 | 5 | 6 | 50 | 125 | 0 | 3 | 79 | 0 | 0 | 
| app_proof | prover | 2 | 62,602,932 | 210 | 50 | 0 | 0 | 126 | 28 | 28 | 16 | 81 | 0 | 33 | 21 | 11 | 5 | 6 | 50 | 126 | 0 | 3 | 80 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 67 | 462 | 67 | 135 | 0 | 3 | 48 | 1,310,000 | 43.55 | 
| app_proof | 1 | 67 | 362 | 67 | 40 | 0 | 1 | 44 | 1,310,000 | 43.50 | 
| app_proof | 2 | 68 | 363 | 68 | 40 | 0 | 1 | 43 | 1,310,000 | 43.67 | 
| app_proof | 3 | 101 | 221 | 101 | 41 | 0 | 1 | 4 | 70,051 | 43.24 | 

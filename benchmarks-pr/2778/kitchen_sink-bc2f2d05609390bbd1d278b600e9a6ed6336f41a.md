...
| `total_proof_time_ms ` |  984.50 |  1,969 |  1,226 |  743 |
| `execute_metered_time_ms` |  23 | -          | -          | -          |
| `execute_metered_insns` |  1,979,971 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  84.89 | -          |  84.89 |  84.89 |
| `execute_preflight_insns` |  989,985.50 |  1,979,971 |  1,168,000 |  811,971 |
| `execute_preflight_time_ms` |  92 |  184 |  128 |  56 |
| `execute_preflight_insn_mi/s` |  29.26 | -          |  29.96 |  28.56 |
| `trace_gen_time_ms   ` |  25 |  50 |  34 |  16 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  779.50 |  1,559 |  1,001 |  558 |
| `prover.main_trace_commit_time_ms` |  217 |  434 |  286 |  148 |
| `prover.rap_constraints_time_ms` |  498 |  996 |  638 |  358 |
| `prover.openings_time_ms` |  63.50 |  127 |  76 |  51 |
| `prover.rap_constraints.logup_gkr_time_ms` |  110.50 |  221 |  155 |  66 |
| `prover.rap_constraints.round0_time_ms` |  284 |  568 |  352 |  216 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/bc2f2d05609390bbd1d278b600e9a6ed6336f41a/kitchen_sink-bc2f2d05609390bbd1d278b600e9a6ed6336f41a.memory.svg)
...
| app_proof |  |  |  |  |  | 743 |  |  | 23 | 1,979,971 | 84.89 | 0 | 1,997 |  | 
...
| app_proof | VmAirWrapper<Rv64VecHeapAdapterAir<1, 12, 12, 8, 8>, FieldExpressionCoreAir> | 0 | 1 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,577,915 | 141 | 40 | 0 | 4 | 66 | 20 | 19 | 29 | 16 | 0 | 33 | 9 | 23 | 1 | 21 | 41 | 66 | 0 | 1 | 15 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,703 | 104 | 19 | 0 | 4 | 54 | 20 | 19 | 20 | 14 | 0 | 30 | 8 | 21 | 1 | 20 | 19 | 54 | 0 | 1 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 99 | 14 | 0 | 4 | 53 | 20 | 19 | 18 | 13 | 0 | 31 | 9 | 21 | 0 | 20 | 15 | 53 | 0 | 1 | 13 | 0 | 0 | 
| leaf | 0 | prover | 263,565,172 | 319 | 130 | 0 | 10 | 144 | 48 | 47 | 37 | 58 | 0 | 43 | 12 | 31 | 7 | 24 | 130 | 144 | 0 | 2 | 57 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 564,299,284 | 1,001 | 285 | 0 | 156 | 638 | 352 | 351 | 129 | 155 | 55 | 76 | 13 | 62 | 15 | 47 | 286 | 638 | 0 | 1 | 99 | 0 | 0 | 
| app_proof | prover | 1 | 541,080,972 | 558 | 147 | 0 | 24 | 358 | 216 | 215 | 76 | 66 | 0 | 51 | 12 | 38 | 14 | 24 | 148 | 358 | 0 | 1 | 65 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 34 | 1,226 | 34 | 134 | 0 | 3 | 56 | 1,168,000 | 28.56 | 
| app_proof | 1 | 16 | 743 | 16 | 40 | 0 | 1 | 128 | 811,971 | 29.96 | 

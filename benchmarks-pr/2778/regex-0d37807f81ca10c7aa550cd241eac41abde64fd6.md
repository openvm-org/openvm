...
|:---|---:|---:|---:|
| Total |  2.23 |  1.65 |  1.66 |
| app_proof |  1.37 |  0.79 |  0.79 |
| leaf |  0.35 |  0.35 |  0.35 |
...
| `total_proof_time_ms ` |  667 |  1,334 |  763 |  571 |
| `execute_metered_time_ms` |  31 | -          | -          | -          |
| `execute_metered_insns` |  4,090,656 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  129.04 | -          |  129.04 |  129.04 |
| `execute_preflight_insns` |  2,045,328 |  4,090,656 |  2,327,000 |  1,763,656 |
| `execute_preflight_time_ms` |  78.50 |  157 |  83 |  74 |
| `execute_preflight_insn_mi/s` |  35.50 | -          |  37.40 |  33.59 |
| `trace_gen_time_ms   ` |  43 |  86 |  43 |  43 |
| `memory_finalize_time_ms` |  1 |  2 |  2 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  455 |  910 |  499 |  411 |
| `prover.main_trace_commit_time_ms` |  114 |  228 |  128 |  100 |
| `prover.rap_constraints_time_ms` |  296.50 |  593 |  323 |  270 |
| `prover.openings_time_ms` |  43.50 |  87 |  47 |  40 |
| `prover.rap_constraints.logup_gkr_time_ms` |  168 |  336 |  200 |  136 |
| `prover.rap_constraints.round0_time_ms` |  88.50 |  177 |  99 |  78 |
| `prover.rap_constraints.mle_rounds_time_ms` |  38.50 |  77 |  43 |  34 |
| `prover.openings.stacked_reduction_time_ms` |  22.50 |  45 |  25 |  20 |
| `prover.openings.stacked_reduction.round0_time_ms` |  11.50 |  23 |  14 |  9 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/0d37807f81ca10c7aa550cd241eac41abde64fd6/regex-0d37807f81ca10c7aa550cd241eac41abde64fd6.memory.svg)

| Module | Max (GB) | Max At |
| --- | ---: | --- |
| prover.batch_constraints.before_round0 | 4.21 | app_proof.prover.0 |
| frac_sumcheck.gkr_rounds | 4.21 | app_proof.prover.0 |
| prover.gkr_input_evals | 4.21 | app_proof.prover.0 |
| frac_sumcheck.segment_tree | 4.21 | app_proof.prover.0 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 77 | 9 |  |  | 0 |  | 366 | 9 |  |  |  |  |  |  | 
| app_proof |  |  |  |  |  | 571 |  |  | 31 | 4,090,656 | 129.04 | 0 | 1,379 |  | 
...
| internal_recursive.0 | 1 | 10 | 151 | 10 | 1 | 0 | 2 | 0 | 0 | 
| internal_recursive.1 | 1 | 9 | 133 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 49 | 354 | 49 | 14 | 3 | 4 | 1 | 1 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 27,289,339 | 207 | 80 | 0 | 0 | 96 | 31 | 30 | 45 | 19 | 0 | 30 | 19 | 11 | 2 | 8 | 80 | 96 | 0 | 2 | 18 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,703 | 141 | 45 | 0 | 0 | 66 | 24 | 24 | 27 | 13 | 0 | 28 | 20 | 8 | 1 | 6 | 45 | 66 | 0 | 2 | 12 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 123 | 31 | 0 | 0 | 62 | 24 | 23 | 24 | 13 | 0 | 30 | 22 | 7 | 1 | 5 | 31 | 62 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 79,659,764 | 304 | 125 | 0 | 0 | 133 | 53 | 52 | 37 | 41 | 0 | 44 | 29 | 15 | 6 | 8 | 126 | 133 | 0 | 5 | 41 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 164,023,250 | 499 | 128 | 0 | 0 | 323 | 78 | 78 | 43 | 200 | 57 | 47 | 22 | 25 | 14 | 11 | 128 | 323 | 0 | 3 | 141 | 0 | 0 | 
| app_proof | prover | 1 | 125,436,227 | 411 | 100 | 0 | 8 | 270 | 99 | 98 | 34 | 136 | 0 | 40 | 19 | 20 | 9 | 10 | 100 | 270 | 0 | 3 | 136 | 0 | 0 | 

| group | phase | segment | trace_height_constraint | weighted_sum | threshold |
| --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 0 | 63,348,429 | 2,013,265,921 | 
| app_proof | prover | 1 | 0 | 47,135,286 | 2,013,265,921 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 43 | 763 | 43 | 137 | 2 | 4 | 83 | 2,327,000 | 33.59 | 
| app_proof | 1 | 43 | 571 | 43 | 41 | 0 | 2 | 74 | 1,763,656 | 37.40 | 

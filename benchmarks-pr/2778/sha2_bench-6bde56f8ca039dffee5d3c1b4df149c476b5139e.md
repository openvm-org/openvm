...
|:---|---:|---:|---:|
| Total |  11.48 |  4.69 |  4.69 |
| app_proof |  9.34 |  2.55 |  2.55 |
| leaf |  1.41 |  1.41 |  1.41 |
...
| `total_proof_time_ms ` |  2,311 |  9,244 |  2,457 |  2,216 |
| `execute_metered_time_ms` |  94 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  118.57 | -          |  118.57 |  118.57 |
| `execute_preflight_insns` |  2,791,990.25 |  11,167,961 |  2,851,000 |  2,614,961 |
| `execute_preflight_time_ms` |  182.75 |  731 |  232 |  105 |
| `execute_preflight_insn_mi/s` |  34.01 | -          |  35.19 |  31.39 |
| `trace_gen_time_ms   ` |  58.75 |  235 |  65 |  54 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  2,003.50 |  8,014 |  2,149 |  1,919 |
| `prover.main_trace_commit_time_ms` |  533.75 |  2,135 |  623 |  504 |
| `prover.rap_constraints_time_ms` |  1,329.50 |  5,318 |  1,385 |  1,276 |
| `prover.openings_time_ms` |  139.25 |  557 |  143 |  137 |
| `prover.rap_constraints.logup_gkr_time_ms` |  378 |  1,512 |  433 |  323 |
| `prover.rap_constraints.round0_time_ms` |  651.75 |  2,607 |  655 |  648 |
| `prover.rap_constraints.mle_rounds_time_ms` |  299.25 |  1,197 |  300 |  299 |
| `prover.openings.stacked_reduction_time_ms` |  104.75 |  419 |  107 |  103 |
| `prover.openings.stacked_reduction.round0_time_ms` |  59.25 |  237 |  61 |  58 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  44.75 |  179 |  46 |  44 |
| `prover.openings.whir_time_ms` |  34.25 |  137 |  36 |  33 |
...
| `prover.rap_constraints.round0_time_ms` |  164 |  164 |  164 |  164 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/6bde56f8ca039dffee5d3c1b4df149c476b5139e/sha2_bench-6bde56f8ca039dffee5d3c1b4df149c476b5139e.memory.svg)
...
| app_proof |  |  |  |  |  | 2,217 |  |  | 94 | 11,167,961 | 118.57 | 0 | 9,346 |  | 
...
| leaf | 0 | 151 | 1,407 | 151 | 54 | 25 | 2 | 6 | 6 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 61,220,603 | 373 | 182 | 0 | 11 | 133 | 36 | 35 | 64 | 32 | 0 | 56 | 22 | 34 | 5 | 28 | 183 | 133 | 0 | 2 | 31 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,879 | 170 | 50 | 0 | 4 | 76 | 24 | 23 | 29 | 23 | 0 | 42 | 18 | 24 | 1 | 22 | 51 | 76 | 0 | 2 | 22 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 143 | 33 | 0 | 4 | 68 | 24 | 23 | 24 | 19 | 0 | 40 | 17 | 22 | 1 | 21 | 34 | 68 | 0 | 2 | 18 | 0 | 0 | 
| leaf | 0 | prover | 425,198,438 | 1,255 | 796 | 0 | 198 | 344 | 164 | 163 | 102 | 77 | 0 | 114 | 36 | 78 | 36 | 42 | 796 | 344 | 0 | 6 | 76 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 644,972,797 | 2,149 | 622 | 0 | 159 | 1,385 | 652 | 652 | 299 | 433 | 114 | 140 | 35 | 105 | 58 | 46 | 623 | 1,385 | 0 | 3 | 317 | 0 | 0 | 
| app_proof | prover | 1 | 644,972,556 | 2,022 | 503 | 0 | 35 | 1,380 | 648 | 647 | 300 | 432 | 130 | 137 | 33 | 103 | 59 | 44 | 504 | 1,380 | 0 | 3 | 300 | 0 | 0 | 
| app_proof | prover | 2 | 644,972,556 | 1,919 | 503 | 0 | 35 | 1,277 | 655 | 654 | 299 | 323 | 0 | 137 | 33 | 104 | 59 | 44 | 504 | 1,277 | 0 | 3 | 322 | 0 | 0 | 
| app_proof | prover | 3 | 644,972,804 | 1,924 | 504 | 0 | 38 | 1,276 | 652 | 651 | 299 | 324 | 0 | 143 | 36 | 107 | 61 | 45 | 504 | 1,276 | 0 | 3 | 323 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 65 | 2,457 | 65 | 138 | 0 | 3 | 105 | 2,851,000 | 31.39 | 
| app_proof | 1 | 58 | 2,354 | 58 | 41 | 0 | 1 | 232 | 2,851,000 | 35.12 | 
| app_proof | 2 | 58 | 2,216 | 58 | 41 | 0 | 1 | 198 | 2,851,000 | 35.19 | 
| app_proof | 3 | 54 | 2,217 | 54 | 41 | 0 | 1 | 196 | 2,614,961 | 34.35 | 

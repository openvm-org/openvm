...
|:---|---:|---:|---:|
| Total |  16.51 |  4.79 |  4.79 |
| app_proof |  13.48 |  2.53 |  2.53 |
| leaf |  2.22 |  1.45 |  1.45 |
...
| `total_proof_time_ms ` |  2,223.33 |  13,340 |  2,391 |  2,151 |
...
| `execute_preflight_time_ms` |  231.67 |  1,390 |  310 |  81 |
| `execute_preflight_insn_mi/s` |  34.95 | -          |  36.21 |  32.96 |
| `trace_gen_time_ms   ` |  37.83 |  227 |  60 |  33 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,895.83 |  11,375 |  2,113 |  1,844 |
| `prover.main_trace_commit_time_ms` |  700.33 |  4,202 |  857 |  668 |
| `prover.rap_constraints_time_ms` |  1,013.50 |  6,081 |  1,072 |  994 |
| `prover.openings_time_ms` |  181.17 |  1,087 |  183 |  178 |
| `prover.rap_constraints.logup_gkr_time_ms` |  172.83 |  1,037 |  222 |  162 |
| `prover.rap_constraints.round0_time_ms` |  523 |  3,138 |  527 |  517 |
| `prover.rap_constraints.mle_rounds_time_ms` |  316.67 |  1,900 |  334 |  307 |
| `prover.openings.stacked_reduction_time_ms` |  136.67 |  820 |  140 |  134 |
| `prover.openings.stacked_reduction.round0_time_ms` |  83.17 |  499 |  85 |  79 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  53.33 |  320 |  55 |  52 |
| `prover.openings.whir_time_ms` |  43.83 |  263 |  46 |  43 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,112 |  2,224 |  1,451 |  773 |
| `execute_preflight_time_ms` |  5.50 |  11 |  6 |  5 |
| `trace_gen_time_ms   ` |  135 |  270 |  179 |  91 |
| `generate_blob_total_time_ms` |  24 |  48 |  32 |  16 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  976.50 |  1,953 |  1,271 |  682 |
| `prover.main_trace_commit_time_ms` |  553.50 |  1,107 |  731 |  376 |
| `prover.rap_constraints_time_ms` |  324 |  648 |  417 |  231 |
| `prover.openings_time_ms` |  97.50 |  195 |  122 |  73 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/b11f626c6b1ccafffa05599bf687e30ff6044787/keccak-b11f626c6b1ccafffa05599bf687e30ff6044787.memory.svg)
...
| app_proof |  |  |  |  |  | 2,151 |  |  | 138 | 14,365,133 | 104.03 | 0 | 13,485 |  | 
...
| leaf | 0 | 179 | 1,451 | 179 | 64 | 32 | 6 | 7 | 7 | 
| leaf | 1 | 91 | 773 | 90 | 32 | 16 | 5 | 7 | 7 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 81,415,028 | 468 | 247 | 0 | 1 | 174 | 49 | 48 | 93 | 31 | 0 | 46 | 22 | 23 | 7 | 16 | 247 | 174 | 0 | 3 | 30 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,879 | 153 | 49 | 0 | 0 | 73 | 25 | 25 | 29 | 17 | 0 | 29 | 20 | 8 | 2 | 6 | 50 | 73 | 0 | 2 | 16 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 122 | 31 | 0 | 0 | 61 | 23 | 22 | 24 | 13 | 0 | 29 | 22 | 7 | 1 | 5 | 32 | 61 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 474,940,262 | 1,271 | 731 | 0 | 2 | 417 | 205 | 204 | 125 | 86 | 0 | 122 | 49 | 72 | 41 | 31 | 731 | 417 | 0 | 7 | 85 | 0 | 0 | 
| leaf | 1 | prover | 239,436,532 | 682 | 376 | 0 | 1 | 231 | 111 | 110 | 68 | 51 | 0 | 73 | 35 | 37 | 20 | 17 | 376 | 231 | 0 | 7 | 50 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 842,692,236 | 2,113 | 857 | 0 | 189 | 1,072 | 517 | 517 | 332 | 222 | 67 | 183 | 43 | 140 | 85 | 55 | 857 | 1,072 | 0 | 4 | 154 | 0 | 0 | 
| app_proof | prover | 1 | 842,692,236 | 1,872 | 668 | 0 | 3 | 1,021 | 524 | 523 | 334 | 162 | 0 | 182 | 46 | 136 | 83 | 52 | 669 | 1,021 | 0 | 4 | 161 | 0 | 0 | 
| app_proof | prover | 2 | 842,692,236 | 1,851 | 668 | 0 | 3 | 1,000 | 527 | 527 | 308 | 164 | 0 | 181 | 43 | 137 | 84 | 53 | 669 | 1,000 | 0 | 4 | 162 | 0 | 0 | 
| app_proof | prover | 3 | 842,692,236 | 1,844 | 668 | 0 | 3 | 994 | 522 | 521 | 309 | 163 | 0 | 181 | 43 | 137 | 84 | 53 | 668 | 994 | 0 | 4 | 162 | 0 | 0 | 
| app_proof | prover | 4 | 842,692,236 | 1,848 | 670 | 0 | 3 | 999 | 524 | 524 | 310 | 163 | 0 | 178 | 43 | 134 | 79 | 55 | 670 | 999 | 0 | 4 | 161 | 0 | 0 | 
| app_proof | prover | 5 | 842,692,236 | 1,847 | 668 | 0 | 3 | 995 | 524 | 523 | 307 | 163 | 0 | 182 | 45 | 136 | 84 | 52 | 669 | 995 | 0 | 3 | 162 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 60 | 2,391 | 60 | 135 | 0 | 3 | 81 | 2,413,000 | 32.96 | 
| app_proof | 1 | 34 | 2,258 | 34 | 41 | 0 | 1 | 310 | 2,413,000 | 35.88 | 
| app_proof | 2 | 34 | 2,183 | 34 | 41 | 0 | 1 | 256 | 2,413,000 | 35.18 | 
| app_proof | 3 | 33 | 2,176 | 33 | 41 | 0 | 1 | 256 | 2,413,000 | 35.25 | 
| app_proof | 4 | 33 | 2,181 | 33 | 41 | 0 | 1 | 257 | 2,413,000 | 36.21 | 
| app_proof | 5 | 33 | 2,151 | 33 | 41 | 0 | 1 | 230 | 2,300,133 | 34.20 | 

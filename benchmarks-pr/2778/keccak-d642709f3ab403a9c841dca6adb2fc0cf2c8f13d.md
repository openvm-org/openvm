...
|:---|---:|---:|---:|
| Total |  16.34 |  4.73 |  4.73 |
| app_proof |  13.36 |  2.51 |  2.51 |
| leaf |  2.19 |  1.43 |  1.43 |
...
| `total_proof_time_ms ` |  2,203.83 |  13,223 |  2,377 |  2,127 |
| `execute_metered_time_ms` |  138 | -          | -          | -          |
| `execute_metered_insns` |  14,365,133 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  103.75 | -          |  103.75 |  103.75 |
| `execute_preflight_insns` |  2,394,188.83 |  14,365,133 |  2,413,000 |  2,300,133 |
| `execute_preflight_time_ms` |  236.33 |  1,418 |  318 |  84 |
| `execute_preflight_insn_mi/s` |  34.69 | -          |  35.58 |  31.70 |
| `trace_gen_time_ms   ` |  36.83 |  221 |  55 |  33 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,872.33 |  11,234 |  2,101 |  1,817 |
| `prover.main_trace_commit_time_ms` |  692.17 |  4,153 |  850 |  657 |
| `prover.rap_constraints_time_ms` |  999.33 |  5,996 |  1,062 |  979 |
| `prover.openings_time_ms` |  179.67 |  1,078 |  187 |  175 |
| `prover.rap_constraints.logup_gkr_time_ms` |  171 |  1,026 |  219 |  161 |
| `prover.rap_constraints.round0_time_ms` |  515.67 |  3,094 |  519 |  507 |
| `prover.rap_constraints.mle_rounds_time_ms` |  311.67 |  1,870 |  335 |  302 |
| `prover.openings.stacked_reduction_time_ms` |  133.67 |  802 |  134 |  133 |
| `prover.openings.stacked_reduction.round0_time_ms` |  81.50 |  489 |  82 |  81 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  51.33 |  308 |  52 |  51 |
| `prover.openings.whir_time_ms` |  45.50 |  273 |  53 |  41 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,096.50 |  2,193 |  1,428 |  765 |
| `execute_preflight_time_ms` |  5.50 |  11 |  6 |  5 |
| `trace_gen_time_ms   ` |  133.50 |  267 |  178 |  89 |
| `generate_blob_total_time_ms` |  24 |  48 |  32 |  16 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  962 |  1,924 |  1,249 |  675 |
| `prover.main_trace_commit_time_ms` |  548 |  1,096 |  722 |  374 |
| `prover.rap_constraints_time_ms` |  317.50 |  635 |  409 |  226 |
| `prover.openings_time_ms` |  96 |  192 |  117 |  75 |
...
| `prover.openings.whir_time_ms` |  41 |  82 |  45 |  37 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/d642709f3ab403a9c841dca6adb2fc0cf2c8f13d/keccak-d642709f3ab403a9c841dca6adb2fc0cf2c8f13d.memory.svg)

| Module | Max (GB) | Max At |
| --- | ---: | --- |
| prover.rap_constraints | 14.21 | app_proof.prover.0 |
| prover.merkle_tree | 12.87 | app_proof.prover.0 |
| prover.prove_whir_opening | 12.87 | app_proof.prover.0 |
| prover.openings | 12.87 | app_proof.prover.0 |
| prover.batch_constraints.before_round0 | 11.78 | app_proof.prover.0 |
| frac_sumcheck.gkr_rounds | 11.78 | app_proof.prover.0 |
| prover.gkr_input_evals | 11.78 | app_proof.prover.0 |
| frac_sumcheck.segment_tree | 11.78 | app_proof.prover.0 |
| prover.batch_constraints.fold_ple_evals | 11.50 | app_proof.prover.0 |
| prover.batch_constraints.round0 | 11.50 | app_proof.prover.0 |
| prover.before_gkr_input_evals | 9.76 | app_proof.prover.0 |
| prover.stacked_commit | 9.76 | app_proof.prover.0 |
...
| 13 | Rv64HintStoreAir | 17 | 15 | 3 | 
| 14 | VmAirWrapper<Rv64RdWriteAdapterAir, Rv64AuipcCoreAir> | 12 | 4 | 3 | 
| 15 | VmAirWrapper<Rv64JalrAdapterAir, Rv64JalrCoreAir> | 17 | 9 | 3 | 
| 16 | VmAirWrapper<Rv64CondRdWriteAdapterAir, Rv64JalLuiCoreAir> | 12 | 10 | 3 | 
| 17 | VmAirWrapper<Rv64BranchAdapterAir, BranchLessThanCoreAir<4, 16> | 14 | 25 | 3 | 
| 18 | VmAirWrapper<Rv64BranchAdapterAir, BranchEqualCoreAir<4, 16> | 11 | 11 | 3 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 72 | 9 |  |  | 0 |  | 344 | 9 |  |  |  |  |  |  | 
| app_proof |  |  |  |  |  | 2,127 |  |  | 138 | 14,365,133 | 103.75 | 0 | 13,369 |  | 
| internal_for_leaf |  |  |  | 499 |  |  |  |  |  |  |  |  |  | 499 | 
...
| app_proof | VmAirWrapper<Rv64BranchAdapterAir, BranchEqualCoreAir<4, 16> | 4 | 0 | 
...
| app_proof | VmAirWrapper<Rv64BranchAdapterAir, BranchEqualCoreAir<4, 16> | 5 | 0 | 
...
| leaf | 8 | Eq3bAir | 1 | prover | 32,768 | 25 | 819,200 | 
...
| app_proof | 14 | VmAirWrapper<Rv64RdWriteAdapterAir, Rv64AuipcCoreAir> | prover | 0 | 65,536 | 16 | 1,048,576 | 
...
| app_proof | 18 | VmAirWrapper<Rv64BranchAdapterAir, BranchEqualCoreAir<4, 16> | prover | 0 | 262,144 | 26 | 6,815,744 | 
...
| app_proof | 14 | VmAirWrapper<Rv64RdWriteAdapterAir, Rv64AuipcCoreAir> | prover | 1 | 65,536 | 16 | 1,048,576 | 
...
| app_proof | 18 | VmAirWrapper<Rv64BranchAdapterAir, BranchEqualCoreAir<4, 16> | prover | 1 | 262,144 | 26 | 6,815,744 | 
...
| app_proof | 14 | VmAirWrapper<Rv64RdWriteAdapterAir, Rv64AuipcCoreAir> | prover | 2 | 65,536 | 16 | 1,048,576 | 
...
| app_proof | 18 | VmAirWrapper<Rv64BranchAdapterAir, BranchEqualCoreAir<4, 16> | prover | 2 | 262,144 | 26 | 6,815,744 | 
...
| app_proof | 14 | VmAirWrapper<Rv64RdWriteAdapterAir, Rv64AuipcCoreAir> | prover | 3 | 65,536 | 16 | 1,048,576 | 
...
| app_proof | 18 | VmAirWrapper<Rv64BranchAdapterAir, BranchEqualCoreAir<4, 16> | prover | 3 | 262,144 | 26 | 6,815,744 | 
...
| app_proof | 14 | VmAirWrapper<Rv64RdWriteAdapterAir, Rv64AuipcCoreAir> | prover | 4 | 65,536 | 16 | 1,048,576 | 
...
| app_proof | 18 | VmAirWrapper<Rv64BranchAdapterAir, BranchEqualCoreAir<4, 16> | prover | 4 | 262,144 | 26 | 6,815,744 | 
...
| app_proof | 14 | VmAirWrapper<Rv64RdWriteAdapterAir, Rv64AuipcCoreAir> | prover | 5 | 65,536 | 16 | 1,048,576 | 
...
| app_proof | 18 | VmAirWrapper<Rv64BranchAdapterAir, BranchEqualCoreAir<4, 16> | prover | 5 | 262,144 | 26 | 6,815,744 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 39 | 499 | 39 | 13 | 4 | 2 | 2 | 2 | 
| internal_recursive.0 | 1 | 14 | 161 | 13 | 2 | 1 | 2 | 2 | 2 | 
| internal_recursive.1 | 1 | 9 | 129 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 178 | 1,428 | 178 | 64 | 32 | 6 | 7 | 7 | 
| leaf | 1 | 89 | 765 | 89 | 32 | 16 | 5 | 7 | 7 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 81,415,028 | 459 | 242 | 0 | 1 | 172 | 48 | 48 | 92 | 31 | 0 | 44 | 20 | 23 | 7 | 16 | 242 | 172 | 0 | 3 | 29 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,879 | 147 | 47 | 0 | 0 | 68 | 22 | 22 | 29 | 16 | 0 | 30 | 22 | 8 | 1 | 6 | 48 | 68 | 0 | 2 | 15 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 120 | 31 | 0 | 0 | 60 | 23 | 22 | 24 | 13 | 0 | 27 | 20 | 7 | 1 | 5 | 31 | 60 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 474,940,262 | 1,249 | 722 | 0 | 2 | 409 | 203 | 202 | 121 | 85 | 0 | 117 | 45 | 71 | 40 | 31 | 722 | 409 | 0 | 6 | 84 | 0 | 0 | 
| leaf | 1 | prover | 239,436,532 | 675 | 373 | 0 | 1 | 226 | 107 | 106 | 67 | 51 | 0 | 75 | 37 | 37 | 19 | 17 | 374 | 226 | 0 | 6 | 50 | 0 | 0 | 
...
| leaf | 0 | prover | 0 | 27,867,973 | 2,013,265,921 | 
| leaf | 1 | prover | 0 | 15,638,083 | 2,013,265,921 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 840,431,244 | 2,101 | 850 | 0 | 192 | 1,062 | 507 | 507 | 335 | 219 | 68 | 187 | 53 | 134 | 82 | 51 | 850 | 1,062 | 0 | 3 | 150 | 0 | 0 | 
| app_proof | prover | 1 | 840,431,244 | 1,845 | 661 | 0 | 3 | 1,008 | 519 | 518 | 327 | 161 | 0 | 175 | 41 | 133 | 82 | 51 | 661 | 1,008 | 0 | 4 | 160 | 0 | 0 | 
| app_proof | prover | 2 | 840,431,244 | 1,823 | 661 | 0 | 3 | 979 | 515 | 515 | 302 | 161 | 0 | 181 | 47 | 134 | 81 | 52 | 661 | 979 | 0 | 4 | 160 | 0 | 0 | 
| app_proof | prover | 3 | 840,431,244 | 1,817 | 660 | 0 | 3 | 981 | 517 | 516 | 302 | 161 | 0 | 175 | 41 | 133 | 81 | 51 | 661 | 981 | 0 | 4 | 160 | 0 | 0 | 
| app_proof | prover | 4 | 840,431,244 | 1,827 | 662 | 0 | 3 | 983 | 518 | 518 | 302 | 162 | 0 | 180 | 46 | 134 | 81 | 52 | 663 | 983 | 0 | 4 | 160 | 0 | 0 | 
| app_proof | prover | 5 | 840,431,244 | 1,821 | 657 | 0 | 3 | 983 | 518 | 518 | 302 | 162 | 0 | 180 | 45 | 134 | 82 | 51 | 657 | 983 | 0 | 3 | 159 | 0 | 0 | 

| group | phase | segment | trace_height_constraint | weighted_sum | threshold |
| --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 0 | 63,674,122 | 2,013,265,921 | 
| app_proof | prover | 1 | 0 | 63,674,122 | 2,013,265,921 | 
| app_proof | prover | 2 | 0 | 63,674,122 | 2,013,265,921 | 
| app_proof | prover | 3 | 0 | 63,674,122 | 2,013,265,921 | 
| app_proof | prover | 4 | 0 | 63,674,122 | 2,013,265,921 | 
| app_proof | prover | 5 | 0 | 63,674,122 | 2,013,265,921 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 55 | 2,377 | 55 | 136 | 0 | 3 | 84 | 2,413,000 | 31.70 | 
| app_proof | 1 | 33 | 2,239 | 33 | 41 | 0 | 1 | 318 | 2,413,000 | 35.15 | 
| app_proof | 2 | 34 | 2,161 | 34 | 41 | 0 | 1 | 262 | 2,413,000 | 35.23 | 
| app_proof | 3 | 33 | 2,155 | 33 | 41 | 0 | 1 | 262 | 2,413,000 | 35.58 | 
| app_proof | 4 | 33 | 2,164 | 33 | 41 | 0 | 1 | 261 | 2,413,000 | 35.32 | 
| app_proof | 5 | 33 | 2,127 | 33 | 41 | 0 | 1 | 231 | 2,300,133 | 35.18 | 

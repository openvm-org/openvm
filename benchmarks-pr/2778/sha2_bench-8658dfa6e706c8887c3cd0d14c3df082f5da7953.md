...
|:---|---:|---:|---:|
| Total |  11.41 |  4.65 |  4.65 |
| app_proof |  9.32 |  2.55 |  2.55 |
| leaf |  1.41 |  1.41 |  1.41 |
...
| `total_proof_time_ms ` |  2,306.25 |  9,225 |  2,459 |  2,207 |
| `execute_metered_time_ms` |  93 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  119.51 | -          |  119.51 |  119.51 |
| `execute_preflight_insns` |  2,791,990.25 |  11,167,961 |  2,851,000 |  2,614,961 |
| `execute_preflight_time_ms` |  163.50 |  654 |  205 |  100 |
| `execute_preflight_insn_mi/s` |  34.36 | -          |  35.26 |  32.07 |
| `trace_gen_time_ms   ` |  58.75 |  235 |  66 |  54 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  2,018.50 |  8,074 |  2,157 |  1,940 |
| `prover.main_trace_commit_time_ms` |  539.25 |  2,157 |  629 |  508 |
| `prover.rap_constraints_time_ms` |  1,342 |  5,368 |  1,391 |  1,291 |
| `prover.openings_time_ms` |  136.25 |  545 |  139 |  132 |
| `prover.rap_constraints.logup_gkr_time_ms` |  369 |  1,476 |  423 |  316 |
| `prover.rap_constraints.round0_time_ms` |  666.50 |  2,666 |  673 |  660 |
| `prover.rap_constraints.mle_rounds_time_ms` |  305.50 |  1,222 |  307 |  303 |
| `prover.openings.stacked_reduction_time_ms` |  97.75 |  391 |  100 |  93 |
| `prover.openings.stacked_reduction.round0_time_ms` |  59.25 |  237 |  61 |  56 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  38.25 |  153 |  39 |  36 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/8658dfa6e706c8887c3cd0d14c3df082f5da7953/sha2_bench-8658dfa6e706c8887c3cd0d14c3df082f5da7953.memory.svg)

| Module | Max (GB) | Max At |
| --- | ---: | --- |
| frac_sumcheck.gkr_rounds | 11.20 | app_proof.prover.3 |
| prover.batch_constraints.before_round0 | 11.20 | app_proof.prover.3 |
| prover.gkr_input_evals | 11.11 | app_proof.prover.0 |
| frac_sumcheck.segment_tree | 11.11 | app_proof.prover.0 |
...
| app_proof |  |  |  |  |  | 2,207 |  |  | 93 | 11,167,961 | 119.51 | 0 | 9,326 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 61,220,603 | 362 | 184 | 0 | 0 | 130 | 38 | 38 | 64 | 27 | 0 | 46 | 27 | 18 | 5 | 12 | 185 | 130 | 0 | 3 | 26 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,879 | 154 | 48 | 0 | 0 | 72 | 24 | 24 | 29 | 18 | 0 | 33 | 24 | 8 | 1 | 6 | 49 | 72 | 0 | 3 | 17 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 117 | 31 | 0 | 0 | 60 | 22 | 21 | 24 | 13 | 0 | 25 | 17 | 7 | 1 | 5 | 31 | 60 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 425,198,438 | 1,269 | 806 | 0 | 157 | 352 | 172 | 171 | 104 | 75 | 0 | 110 | 46 | 64 | 36 | 28 | 806 | 352 | 0 | 7 | 74 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 644,972,797 | 2,157 | 629 | 0 | 119 | 1,390 | 663 | 663 | 306 | 420 | 118 | 137 | 36 | 100 | 61 | 39 | 629 | 1,390 | 0 | 3 | 300 | 0 | 0 | 
| app_proof | prover | 1 | 644,972,556 | 2,035 | 510 | 0 | 2 | 1,391 | 660 | 660 | 307 | 423 | 127 | 132 | 39 | 93 | 56 | 36 | 510 | 1,391 | 0 | 3 | 295 | 0 | 0 | 
| app_proof | prover | 2 | 644,972,556 | 1,942 | 508 | 0 | 2 | 1,296 | 673 | 672 | 306 | 317 | 0 | 137 | 37 | 99 | 60 | 39 | 508 | 1,296 | 0 | 3 | 316 | 0 | 0 | 
| app_proof | prover | 3 | 644,972,804 | 1,940 | 510 | 0 | 2 | 1,291 | 670 | 670 | 303 | 316 | 0 | 139 | 39 | 99 | 60 | 39 | 510 | 1,291 | 0 | 3 | 315 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 66 | 2,459 | 66 | 135 | 0 | 3 | 100 | 2,851,000 | 32.07 | 
| app_proof | 1 | 57 | 2,339 | 57 | 41 | 0 | 1 | 205 | 2,851,000 | 35.08 | 
| app_proof | 2 | 58 | 2,220 | 58 | 41 | 0 | 1 | 178 | 2,851,000 | 35.26 | 
| app_proof | 3 | 54 | 2,207 | 54 | 41 | 0 | 1 | 171 | 2,614,961 | 35.03 | 

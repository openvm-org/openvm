...
|:---|---:|---:|---:|
| Total |  2.51 |  1.89 |  1.89 |
| app_proof |  1.56 |  0.94 |  0.94 |
| leaf |  0.38 |  0.38 |  0.38 |
...
| `total_proof_time_ms ` |  765.50 |  1,531 |  906 |  625 |
...
| `execute_preflight_time_ms` |  87.50 |  175 |  95 |  80 |
| `execute_preflight_insn_mi/s` |  30.99 | -          |  32.68 |  29.30 |
| `trace_gen_time_ms   ` |  35.50 |  71 |  38 |  33 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  552.50 |  1,105 |  641 |  464 |
| `prover.main_trace_commit_time_ms` |  128 |  256 |  143 |  113 |
| `prover.rap_constraints_time_ms` |  369 |  738 |  438 |  300 |
| `prover.openings_time_ms` |  54.50 |  109 |  59 |  50 |
| `prover.rap_constraints.logup_gkr_time_ms` |  231 |  462 |  305 |  157 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/bc2f2d05609390bbd1d278b600e9a6ed6336f41a/regex-bc2f2d05609390bbd1d278b600e9a6ed6336f41a.memory.svg)

| Module | Max (GB) | Max At |
| --- | ---: | --- |
| frac_sumcheck.gkr_rounds | 4.88 | app_proof.prover.0 |
| prover.batch_constraints.before_round0 | 4.88 | app_proof.prover.0 |
| frac_sumcheck.segment_tree | 4.66 | app_proof.prover.0 |
| prover.gkr_input_evals | 4.66 | app_proof.prover.0 |
| prover.rap_constraints | 3.01 | app_proof.prover.0 |
| generate mem proving ctxs | 2.86 | app_proof.0 |
| set initial memory | 2.85 | app_proof.1 |
| prover.batch_constraints.round0 | 2.81 | app_proof.prover.0 |
| prover.batch_constraints.fold_ple_evals | 2.81 | app_proof.prover.0 |
| prover.prove_whir_opening | 2.75 | app_proof.prover.0 |
| prover.openings | 2.75 | app_proof.prover.0 |
| prover.merkle_tree | 2.75 | app_proof.prover.0 |
| prover.before_gkr_input_evals | 2.34 | app_proof.prover.0 |
| prover.stacked_commit | 2.34 | app_proof.prover.0 |
| prover.rs_code_matrix | 2.32 | app_proof.prover.0 |
...
| app_proof |  |  |  |  |  | 625 |  |  | 33 | 4,090,656 | 121.61 | 0 | 1,578 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 27,256,571 | 229 | 84 | 0 | 5 | 102 | 30 | 30 | 45 | 25 | 0 | 42 | 15 | 26 | 2 | 23 | 85 | 102 | 0 | 2 | 25 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,703 | 162 | 48 | 0 | 4 | 72 | 24 | 23 | 27 | 19 | 0 | 40 | 17 | 23 | 1 | 21 | 48 | 72 | 0 | 2 | 18 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 176,321,234 | 641 | 143 | 0 | 10 | 438 | 87 | 86 | 46 | 305 | 70 | 59 | 22 | 36 | 15 | 21 | 143 | 438 | 0 | 3 | 234 | 0 | 0 | 
| app_proof | prover | 1 | 133,284,441 | 464 | 113 | 0 | 16 | 300 | 105 | 105 | 36 | 157 | 0 | 50 | 20 | 30 | 10 | 19 | 113 | 300 | 0 | 3 | 157 | 0 | 0 | 

| group | phase | segment | trace_height_constraint | weighted_sum | threshold |
| --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 0 | 76,857,549 | 2,013,265,921 | 
| app_proof | prover | 1 | 0 | 55,376,543 | 2,013,265,921 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 33 | 906 | 33 | 136 | 1 | 5 | 95 | 2,327,000 | 29.30 | 
| app_proof | 1 | 38 | 625 | 38 | 40 | 0 | 2 | 80 | 1,763,656 | 32.68 | 

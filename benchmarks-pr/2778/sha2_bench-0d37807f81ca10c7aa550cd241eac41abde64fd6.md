...
|:---|---:|---:|---:|
| Total |  11.29 |  4.63 |  4.63 |
| app_proof |  9.19 |  2.54 |  2.54 |
| leaf |  1.42 |  1.42 |  1.42 |
...
| `total_proof_time_ms ` |  2,274 |  9,096 |  2,443 |  2,206 |
| `execute_metered_time_ms` |  95 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  117.51 | -          |  117.51 |  117.51 |
| `execute_preflight_insns` |  2,791,990.25 |  11,167,961 |  2,851,000 |  2,614,961 |
| `execute_preflight_time_ms` |  164.75 |  659 |  203 |  93 |
| `execute_preflight_insn_mi/s` |  37.72 | -          |  38.88 |  35.01 |
| `trace_gen_time_ms   ` |  61 |  244 |  73 |  57 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,982.75 |  7,931 |  2,142 |  1,922 |
| `prover.main_trace_commit_time_ms` |  540.50 |  2,162 |  630 |  510 |
| `prover.rap_constraints_time_ms` |  1,303 |  5,212 |  1,370 |  1,273 |
| `prover.openings_time_ms` |  138.25 |  553 |  141 |  137 |
| `prover.rap_constraints.logup_gkr_time_ms` |  326.75 |  1,307 |  395 |  303 |
| `prover.rap_constraints.round0_time_ms` |  669 |  2,676 |  673 |  665 |
| `prover.rap_constraints.mle_rounds_time_ms` |  306.25 |  1,225 |  308 |  302 |
| `prover.openings.stacked_reduction_time_ms` |  100.75 |  403 |  102 |  99 |
...
| `prover.openings.whir_time_ms` |  37 |  148 |  39 |  35 |
...
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,271 |  1,271 |  1,271 |  1,271 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/0d37807f81ca10c7aa550cd241eac41abde64fd6/sha2_bench-0d37807f81ca10c7aa550cd241eac41abde64fd6.memory.svg)

| Module | Max (GB) | Max At |
| --- | ---: | --- |
| prover.rap_constraints | 11.01 | app_proof.prover.0 |
| frac_sumcheck.gkr_rounds | 10.80 | app_proof.prover.3 |
| prover.batch_constraints.before_round0 | 10.80 | app_proof.prover.3 |
| frac_sumcheck.segment_tree | 10.71 | app_proof.prover.0 |
| prover.gkr_input_evals | 10.71 | app_proof.prover.0 |
...
| app_proof |  |  |  |  |  | 2,211 |  |  | 95 | 11,167,961 | 117.51 | 0 | 9,197 |  | 
...
| app_proof | VmAirWrapper<Rv64BranchAdapterAir, BranchLessThanCoreAir<4, 16> | 3 | 1 | 
| app_proof | VmAirWrapper<Rv64CondRdWriteAdapterAir, Rv64JalLuiCoreAir> | 3 | 1 | 
...
| leaf | 0 | 147 | 1,419 | 147 | 53 | 25 | 3 | 6 | 6 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 61,220,603 | 356 | 185 | 0 | 0 | 131 | 38 | 38 | 65 | 27 | 0 | 38 | 19 | 18 | 5 | 13 | 186 | 131 | 0 | 3 | 26 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,879 | 152 | 49 | 0 | 0 | 73 | 25 | 25 | 29 | 17 | 0 | 29 | 20 | 8 | 1 | 6 | 49 | 73 | 0 | 2 | 17 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 119 | 31 | 0 | 0 | 61 | 23 | 22 | 24 | 13 | 0 | 26 | 19 | 7 | 1 | 5 | 31 | 61 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 424,379,238 | 1,271 | 805 | 0 | 156 | 354 | 171 | 170 | 106 | 77 | 0 | 110 | 45 | 65 | 37 | 28 | 805 | 354 | 0 | 7 | 76 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 644,972,797 | 2,142 | 630 | 0 | 120 | 1,370 | 665 | 664 | 308 | 395 | 107 | 141 | 39 | 102 | 62 | 39 | 630 | 1,370 | 0 | 3 | 287 | 0 | 0 | 
| app_proof | prover | 1 | 644,972,556 | 1,934 | 511 | 0 | 2 | 1,284 | 673 | 673 | 307 | 303 | 0 | 138 | 36 | 101 | 61 | 39 | 511 | 1,284 | 0 | 3 | 301 | 0 | 0 | 
| app_proof | prover | 2 | 644,972,556 | 1,933 | 509 | 0 | 2 | 1,285 | 672 | 672 | 308 | 304 | 0 | 137 | 38 | 99 | 60 | 39 | 510 | 1,285 | 0 | 3 | 302 | 0 | 0 | 
| app_proof | prover | 3 | 644,972,804 | 1,922 | 511 | 0 | 2 | 1,273 | 666 | 665 | 302 | 305 | 0 | 137 | 35 | 101 | 61 | 39 | 511 | 1,273 | 0 | 3 | 303 | 0 | 0 | 

| group | phase | segment | trace_height_constraint | weighted_sum | threshold |
| --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 0 | 99,574,157 | 2,013,265,921 | 
| app_proof | prover | 1 | 0 | 99,574,026 | 2,013,265,921 | 
| app_proof | prover | 2 | 0 | 99,574,026 | 2,013,265,921 | 
| app_proof | prover | 3 | 0 | 99,574,126 | 2,013,265,921 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 73 | 2,443 | 73 | 134 | 0 | 3 | 93 | 2,851,000 | 35.01 | 
| app_proof | 1 | 57 | 2,236 | 57 | 41 | 0 | 1 | 203 | 2,851,000 | 38.88 | 
| app_proof | 2 | 57 | 2,206 | 57 | 41 | 0 | 1 | 174 | 2,851,000 | 38.25 | 
| app_proof | 3 | 57 | 2,211 | 57 | 41 | 0 | 1 | 189 | 2,614,961 | 38.75 | 

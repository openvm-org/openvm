...
| `total_proof_time_ms ` |  746.50 |  1,493 |  892 |  601 |
| `execute_metered_time_ms` |  32 | -          | -          | -          |
| `execute_metered_insns` |  4,090,656 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  125.53 | -          |  125.53 |  125.53 |
| `execute_preflight_insns` |  2,045,328 |  4,090,656 |  2,327,000 |  1,763,656 |
| `execute_preflight_time_ms` |  83.50 |  167 |  88 |  79 |
| `execute_preflight_insn_mi/s` |  32.22 | -          |  33.86 |  30.58 |
| `trace_gen_time_ms   ` |  42 |  84 |  43 |  41 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  531 |  1,062 |  626 |  436 |
| `prover.main_trace_commit_time_ms` |  118 |  236 |  132 |  104 |
| `prover.rap_constraints_time_ms` |  364 |  728 |  439 |  289 |
| `prover.openings_time_ms` |  47.50 |  95 |  54 |  41 |
| `prover.rap_constraints.logup_gkr_time_ms` |  225.50 |  451 |  303 |  148 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/8658dfa6e706c8887c3cd0d14c3df082f5da7953/regex-8658dfa6e706c8887c3cd0d14c3df082f5da7953.memory.svg)

| Module | Max (GB) | Max At |
| --- | ---: | --- |
| frac_sumcheck.gkr_rounds | 4.74 | app_proof.prover.0 |
| prover.batch_constraints.before_round0 | 4.74 | app_proof.prover.0 |
| prover.gkr_input_evals | 4.61 | app_proof.prover.0 |
| frac_sumcheck.segment_tree | 4.61 | app_proof.prover.0 |
...
| app_proof |  |  |  |  |  | 601 |  |  | 32 | 4,090,656 | 125.53 | 0 | 1,539 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 15 | 231 | 15 | 4 | 0 | 2 | 0 | 0 | 
| internal_recursive.0 | 1 | 10 | 145 | 10 | 1 | 0 | 2 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 27,289,339 | 215 | 83 | 0 | 0 | 98 | 31 | 31 | 46 | 20 | 0 | 33 | 22 | 11 | 2 | 8 | 83 | 98 | 0 | 2 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,703 | 134 | 45 | 0 | 0 | 64 | 23 | 22 | 27 | 13 | 0 | 24 | 16 | 8 | 1 | 6 | 46 | 64 | 0 | 2 | 12 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 123 | 31 | 0 | 0 | 62 | 24 | 23 | 24 | 13 | 0 | 28 | 21 | 7 | 1 | 5 | 31 | 62 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 79,659,764 | 310 | 129 | 0 | 0 | 137 | 56 | 55 | 38 | 42 | 0 | 42 | 27 | 15 | 6 | 8 | 130 | 137 | 0 | 5 | 41 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 164,023,250 | 626 | 132 | 0 | 0 | 439 | 89 | 89 | 45 | 303 | 71 | 54 | 29 | 25 | 14 | 11 | 132 | 439 | 0 | 3 | 231 | 0 | 0 | 
| app_proof | prover | 1 | 125,436,227 | 436 | 104 | 0 | 8 | 289 | 104 | 104 | 35 | 148 | 0 | 41 | 19 | 21 | 10 | 11 | 104 | 289 | 0 | 3 | 147 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 41 | 892 | 41 | 135 | 1 | 5 | 88 | 2,327,000 | 30.58 | 
| app_proof | 1 | 43 | 601 | 43 | 41 | 0 | 2 | 79 | 1,763,656 | 33.86 | 

...
| `total_proof_time_ms ` |  894 |  1,788 |  1,116 |  672 |
| `execute_metered_time_ms` |  23 | -          | -          | -          |
| `execute_metered_insns` |  1,979,971 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  83.62 | -          |  83.62 |  83.62 |
| `execute_preflight_insns` |  989,985.50 |  1,979,971 |  1,168,000 |  811,971 |
| `execute_preflight_time_ms` |  92 |  184 |  128 |  56 |
| `execute_preflight_insn_mi/s` |  32.96 | -          |  33.74 |  32.17 |
| `trace_gen_time_ms   ` |  23.50 |  47 |  32 |  15 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  688 |  1,376 |  890 |  486 |
| `prover.main_trace_commit_time_ms` |  200.50 |  401 |  265 |  136 |
| `prover.rap_constraints_time_ms` |  441 |  882 |  574 |  308 |
| `prover.openings_time_ms` |  45.50 |  91 |  50 |  41 |
| `prover.rap_constraints.logup_gkr_time_ms` |  79 |  158 |  104 |  54 |
| `prover.rap_constraints.round0_time_ms` |  259.50 |  519 |  342 |  177 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/077b9080da1e395662136d021e664301503372ca/kitchen_sink-077b9080da1e395662136d021e664301503372ca.memory.svg)
...
| app_proof |  |  |  |  |  | 672 |  |  | 23 | 1,979,971 | 83.62 | 0 | 1,816 |  | 
...
| leaf | 0 | 107 | 404 | 107 | 24 | 10 | 18 | 5 | 5 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,577,915 | 121 | 38 | 0 | 0 | 63 | 21 | 20 | 28 | 12 | 0 | 19 | 11 | 7 | 1 | 6 | 38 | 63 | 0 | 1 | 11 | 0 | 0 | 
...
| leaf | 0 | prover | 261,140,340 | 296 | 128 | 0 | 1 | 139 | 48 | 47 | 37 | 54 | 0 | 27 | 11 | 15 | 7 | 8 | 129 | 139 | 0 | 2 | 53 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 555,262,116 | 890 | 264 | 0 | 136 | 574 | 342 | 340 | 127 | 104 | 50 | 50 | 13 | 37 | 15 | 21 | 265 | 574 | 0 | 1 | 53 | 0 | 0 | 
| app_proof | prover | 1 | 533,498,636 | 486 | 136 | 0 | 2 | 308 | 177 | 177 | 75 | 54 | 0 | 41 | 13 | 27 | 14 | 13 | 136 | 308 | 0 | 1 | 53 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 32 | 1,116 | 32 | 136 | 0 | 3 | 56 | 1,168,000 | 32.17 | 
| app_proof | 1 | 15 | 672 | 15 | 40 | 0 | 1 | 128 | 811,971 | 33.74 | 

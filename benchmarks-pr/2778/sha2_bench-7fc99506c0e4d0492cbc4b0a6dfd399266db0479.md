...
|:---|---:|---:|---:|
| Total |  11.18 |  4.60 |  4.60 |
| app_proof |  9.09 |  2.51 |  2.51 |
| leaf |  1.41 |  1.41 |  1.41 |
...
| `total_proof_time_ms ` |  2,248.75 |  8,995 |  2,415 |  2,164 |
...
| `execute_preflight_insn_mi/s` |  36.29 | -          |  37.22 |  33.65 |
| `trace_gen_time_ms   ` |  59.25 |  237 |  69 |  54 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,961 |  7,844 |  2,113 |  1,899 |
| `prover.main_trace_commit_time_ms` |  535.25 |  2,141 |  623 |  505 |
| `prover.rap_constraints_time_ms` |  1,288.75 |  5,155 |  1,351 |  1,259 |
| `prover.openings_time_ms` |  136.25 |  545 |  138 |  133 |
| `prover.rap_constraints.logup_gkr_time_ms` |  321 |  1,284 |  390 |  291 |
| `prover.rap_constraints.round0_time_ms` |  666.25 |  2,665 |  672 |  657 |
| `prover.rap_constraints.mle_rounds_time_ms` |  300.50 |  1,202 |  303 |  297 |
| `prover.openings.stacked_reduction_time_ms` |  97.50 |  390 |  100 |  92 |
| `prover.openings.stacked_reduction.round0_time_ms` |  59.50 |  238 |  61 |  56 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  37.75 |  151 |  39 |  36 |
| `prover.openings.whir_time_ms` |  38 |  152 |  40 |  36 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/7fc99506c0e4d0492cbc4b0a6dfd399266db0479/sha2_bench-7fc99506c0e4d0492cbc4b0a6dfd399266db0479.memory.svg)
...
| app_proof |  |  |  |  |  | 2,164 |  |  | 93 | 11,167,961 | 119.80 | 0 | 9,094 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 61,220,603 | 359 | 185 | 0 | 1 | 133 | 39 | 38 | 66 | 27 | 0 | 40 | 21 | 18 | 5 | 13 | 185 | 133 | 0 | 3 | 26 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,879 | 148 | 47 | 0 | 0 | 68 | 22 | 22 | 29 | 16 | 0 | 32 | 23 | 8 | 1 | 6 | 47 | 68 | 0 | 2 | 15 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 122 | 32 | 0 | 0 | 61 | 23 | 22 | 24 | 13 | 0 | 28 | 21 | 7 | 1 | 5 | 32 | 61 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 424,379,238 | 1,262 | 802 | 0 | 160 | 352 | 168 | 167 | 107 | 76 | 0 | 106 | 42 | 64 | 35 | 28 | 803 | 352 | 0 | 7 | 75 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 639,992,057 | 2,113 | 622 | 0 | 119 | 1,351 | 657 | 657 | 303 | 390 | 106 | 138 | 37 | 100 | 61 | 39 | 623 | 1,351 | 0 | 4 | 283 | 0 | 0 | 
| app_proof | prover | 1 | 639,991,820 | 1,915 | 506 | 0 | 2 | 1,270 | 667 | 667 | 300 | 303 | 0 | 138 | 39 | 98 | 60 | 38 | 506 | 1,270 | 0 | 3 | 301 | 0 | 0 | 
| app_proof | prover | 2 | 639,991,820 | 1,917 | 504 | 0 | 2 | 1,275 | 672 | 671 | 302 | 300 | 0 | 136 | 36 | 100 | 61 | 38 | 505 | 1,275 | 0 | 4 | 299 | 0 | 0 | 
| app_proof | prover | 3 | 639,992,052 | 1,899 | 506 | 0 | 2 | 1,259 | 669 | 669 | 297 | 291 | 0 | 133 | 40 | 92 | 56 | 36 | 507 | 1,259 | 0 | 4 | 290 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 69 | 2,415 | 69 | 136 | 0 | 4 | 96 | 2,851,000 | 33.65 | 
| app_proof | 1 | 57 | 2,223 | 57 | 41 | 0 | 1 | 209 | 2,851,000 | 37.16 | 
| app_proof | 2 | 57 | 2,193 | 57 | 41 | 0 | 1 | 177 | 2,851,000 | 37.22 | 
| app_proof | 3 | 54 | 2,164 | 54 | 41 | 0 | 1 | 169 | 2,614,961 | 37.13 | 

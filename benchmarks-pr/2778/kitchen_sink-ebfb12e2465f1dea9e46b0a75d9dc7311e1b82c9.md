...
| `total_proof_time_ms ` |  893.50 |  1,787 |  1,117 |  670 |
| `execute_metered_time_ms` |  23 | -          | -          | -          |
| `execute_metered_insns` |  1,979,971 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  82.82 | -          |  82.82 |  82.82 |
| `execute_preflight_insns` |  989,985.50 |  1,979,971 |  1,168,000 |  811,971 |
| `execute_preflight_time_ms` |  90.50 |  181 |  127 |  54 |
| `execute_preflight_insn_mi/s` |  34.31 | -          |  35.48 |  33.14 |
| `trace_gen_time_ms   ` |  23.50 |  47 |  32 |  15 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  689 |  1,378 |  893 |  485 |
| `prover.main_trace_commit_time_ms` |  200.50 |  401 |  265 |  136 |
| `prover.rap_constraints_time_ms` |  442 |  884 |  577 |  307 |
| `prover.openings_time_ms` |  46 |  92 |  51 |  41 |
| `prover.rap_constraints.logup_gkr_time_ms` |  79 |  158 |  105 |  53 |
| `prover.rap_constraints.round0_time_ms` |  260.50 |  521 |  342 |  179 |
| `prover.rap_constraints.mle_rounds_time_ms` |  101 |  202 |  128 |  74 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  407 |  407 |  407 |  407 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/ebfb12e2465f1dea9e46b0a75d9dc7311e1b82c9/kitchen_sink-ebfb12e2465f1dea9e46b0a75d9dc7311e1b82c9.memory.svg)
...
| 72 | VmAirWrapper<Rv64BaseAluAdapterU16Air, LessThanCoreAir<4, 16> | 19 | 30 | 3 | 
...
| app_proof |  |  |  |  |  | 670 |  |  | 23 | 1,979,971 | 82.82 | 0 | 1,815 |  | 
...
| internal_recursive.0 | 1 | 10 | 91 | 10 | 1 | 0 | 2 | 0 | 1 | 
| internal_recursive.1 | 1 | 8 | 84 | 8 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 109 | 407 | 109 | 24 | 11 | 18 | 4 | 4 | 
...
| internal_recursive.0 | 1 | prover | 15,378,703 | 81 | 16 | 0 | 0 | 48 | 17 | 17 | 20 | 9 | 0 | 15 | 9 | 5 | 1 | 4 | 16 | 48 | 0 | 1 | 9 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 75 | 11 | 0 | 0 | 48 | 19 | 18 | 18 | 10 | 0 | 15 | 9 | 5 | 0 | 4 | 11 | 48 | 0 | 1 | 9 | 0 | 0 | 
| leaf | 0 | prover | 261,140,340 | 298 | 127 | 0 | 1 | 141 | 49 | 48 | 37 | 54 | 0 | 28 | 12 | 15 | 7 | 8 | 128 | 141 | 0 | 2 | 53 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 555,262,116 | 893 | 264 | 0 | 136 | 577 | 342 | 341 | 128 | 105 | 51 | 51 | 14 | 37 | 15 | 21 | 265 | 577 | 0 | 1 | 53 | 0 | 0 | 
| app_proof | prover | 1 | 533,498,636 | 485 | 136 | 0 | 2 | 307 | 179 | 178 | 74 | 53 | 0 | 41 | 13 | 27 | 14 | 13 | 136 | 307 | 0 | 1 | 52 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 32 | 1,117 | 32 | 136 | 0 | 3 | 54 | 1,168,000 | 33.14 | 
| app_proof | 1 | 15 | 670 | 15 | 40 | 0 | 1 | 127 | 811,971 | 35.48 | 

...
|:---|---:|---:|---:|
| Total |  16.42 |  4.76 |  4.76 |
| app_proof |  13.42 |  2.52 |  2.52 |
| leaf |  2.21 |  1.44 |  1.44 |
...
| `total_proof_time_ms ` |  2,213 |  13,278 |  2,387 |  2,142 |
...
| `execute_preflight_time_ms` |  232 |  1,392 |  314 |  84 |
| `execute_preflight_insn_mi/s` |  34.70 | -          |  35.53 |  31.85 |
| `trace_gen_time_ms   ` |  37.33 |  224 |  58 |  33 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,885.50 |  11,313 |  2,109 |  1,829 |
| `prover.main_trace_commit_time_ms` |  696.33 |  4,178 |  855 |  663 |
| `prover.rap_constraints_time_ms` |  1,006.17 |  6,037 |  1,059 |  986 |
| `prover.openings_time_ms` |  181.83 |  1,091 |  193 |  176 |
| `prover.rap_constraints.logup_gkr_time_ms` |  171.67 |  1,030 |  220 |  161 |
| `prover.rap_constraints.round0_time_ms` |  519.33 |  3,116 |  524 |  506 |
| `prover.rap_constraints.mle_rounds_time_ms` |  314.17 |  1,885 |  332 |  304 |
| `prover.openings.stacked_reduction_time_ms` |  135.83 |  815 |  140 |  134 |
| `prover.openings.stacked_reduction.round0_time_ms` |  83 |  498 |  86 |  82 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  52.33 |  314 |  54 |  52 |
| `prover.openings.whir_time_ms` |  45.50 |  273 |  53 |  40 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,104.50 |  2,209 |  1,441 |  768 |
| `execute_preflight_time_ms` |  5.50 |  11 |  6 |  5 |
| `trace_gen_time_ms   ` |  134.50 |  269 |  180 |  89 |
| `generate_blob_total_time_ms` |  24 |  48 |  32 |  16 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  969.50 |  1,939 |  1,260 |  679 |
| `prover.main_trace_commit_time_ms` |  550 |  1,100 |  726 |  374 |
...
| `prover.openings.whir_time_ms` |  42 |  84 |  47 |  37 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/0c7dbcd17c57bc6543a51a290609e8d974c23f6b/keccak-0c7dbcd17c57bc6543a51a290609e8d974c23f6b.memory.svg)
...
| app_proof |  |  |  |  |  | 2,142 |  |  | 138 | 14,365,133 | 103.43 | 0 | 13,423 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 41 | 507 | 41 | 13 | 4 | 2 | 2 | 2 | 
| internal_recursive.0 | 1 | 13 | 162 | 13 | 2 | 1 | 2 | 2 | 2 | 
| internal_recursive.1 | 1 | 9 | 127 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 180 | 1,441 | 180 | 63 | 32 | 6 | 7 | 7 | 
| leaf | 1 | 89 | 768 | 89 | 31 | 16 | 5 | 7 | 7 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 81,415,028 | 465 | 245 | 0 | 1 | 174 | 50 | 49 | 92 | 30 | 0 | 45 | 21 | 24 | 8 | 16 | 245 | 174 | 0 | 3 | 29 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,879 | 148 | 48 | 0 | 0 | 72 | 24 | 24 | 30 | 17 | 0 | 26 | 17 | 8 | 2 | 6 | 49 | 72 | 0 | 2 | 17 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 118 | 31 | 0 | 0 | 61 | 23 | 22 | 24 | 13 | 0 | 24 | 17 | 7 | 1 | 5 | 32 | 61 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 474,940,262 | 1,260 | 725 | 0 | 2 | 414 | 205 | 205 | 121 | 87 | 0 | 119 | 47 | 71 | 40 | 30 | 726 | 414 | 0 | 7 | 85 | 0 | 0 | 
| leaf | 1 | prover | 239,436,532 | 679 | 374 | 0 | 1 | 230 | 110 | 110 | 68 | 51 | 0 | 74 | 37 | 37 | 19 | 17 | 374 | 230 | 0 | 6 | 50 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 840,431,244 | 2,109 | 855 | 0 | 193 | 1,059 | 506 | 506 | 332 | 220 | 68 | 193 | 53 | 140 | 86 | 54 | 855 | 1,059 | 0 | 4 | 151 | 0 | 0 | 
| app_proof | prover | 1 | 840,431,244 | 1,855 | 663 | 0 | 2 | 1,015 | 521 | 521 | 330 | 162 | 0 | 176 | 41 | 134 | 82 | 52 | 663 | 1,015 | 0 | 4 | 161 | 0 | 0 | 
| app_proof | prover | 2 | 840,431,244 | 1,840 | 664 | 0 | 3 | 991 | 523 | 523 | 306 | 162 | 0 | 183 | 48 | 135 | 82 | 52 | 664 | 991 | 0 | 4 | 161 | 0 | 0 | 
| app_proof | prover | 3 | 840,431,244 | 1,829 | 665 | 0 | 3 | 986 | 520 | 519 | 304 | 162 | 0 | 177 | 40 | 136 | 83 | 52 | 665 | 986 | 0 | 3 | 161 | 0 | 0 | 
| app_proof | prover | 4 | 840,431,244 | 1,838 | 665 | 0 | 3 | 991 | 522 | 521 | 306 | 161 | 0 | 181 | 46 | 135 | 82 | 52 | 666 | 991 | 0 | 4 | 160 | 0 | 0 | 
| app_proof | prover | 5 | 840,431,244 | 1,842 | 665 | 0 | 3 | 995 | 524 | 523 | 307 | 163 | 0 | 181 | 45 | 135 | 83 | 52 | 665 | 995 | 0 | 4 | 161 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 58 | 2,387 | 58 | 135 | 0 | 3 | 84 | 2,413,000 | 31.85 | 
| app_proof | 1 | 34 | 2,245 | 34 | 41 | 0 | 1 | 314 | 2,413,000 | 34.88 | 
| app_proof | 2 | 33 | 2,173 | 33 | 41 | 0 | 1 | 257 | 2,413,000 | 35.31 | 
| app_proof | 3 | 33 | 2,161 | 33 | 41 | 0 | 1 | 256 | 2,413,000 | 35.53 | 
| app_proof | 4 | 33 | 2,170 | 33 | 41 | 0 | 1 | 256 | 2,413,000 | 35.40 | 
| app_proof | 5 | 33 | 2,142 | 33 | 41 | 0 | 1 | 225 | 2,300,133 | 35.22 | 

...
|:---|---:|---:|---:|
| Total |  16.64 |  4.82 |  4.82 |
| app_proof |  13.60 |  2.56 |  2.56 |
| leaf |  2.23 |  1.45 |  1.45 |
...
| `total_proof_time_ms ` |  2,243.83 |  13,463 |  2,424 |  2,167 |
...
| `execute_preflight_time_ms` |  236.33 |  1,418 |  319 |  84 |
| `execute_preflight_insn_mi/s` |  34.78 | -          |  35.50 |  31.91 |
| `trace_gen_time_ms   ` |  37.50 |  225 |  59 |  33 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,912.17 |  11,473 |  2,145 |  1,855 |
| `prover.main_trace_commit_time_ms` |  705.33 |  4,232 |  865 |  672 |
| `prover.rap_constraints_time_ms` |  1,020.50 |  6,123 |  1,086 |  998 |
| `prover.openings_time_ms` |  185.33 |  1,112 |  194 |  179 |
| `prover.rap_constraints.logup_gkr_time_ms` |  174.17 |  1,045 |  223 |  164 |
| `prover.rap_constraints.round0_time_ms` |  525 |  3,150 |  528 |  519 |
| `prover.rap_constraints.mle_rounds_time_ms` |  320.33 |  1,922 |  343 |  305 |
| `prover.openings.stacked_reduction_time_ms` |  138 |  828 |  142 |  136 |
| `prover.openings.stacked_reduction.round0_time_ms` |  84 |  504 |  86 |  83 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  53.50 |  321 |  56 |  52 |
| `prover.openings.whir_time_ms` |  46.83 |  281 |  55 |  42 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,114.50 |  2,229 |  1,453 |  776 |
| `execute_preflight_time_ms` |  5.50 |  11 |  6 |  5 |
| `trace_gen_time_ms   ` |  133.50 |  267 |  178 |  89 |
| `generate_blob_total_time_ms` |  24 |  48 |  32 |  16 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  980 |  1,960 |  1,274 |  686 |
| `prover.main_trace_commit_time_ms` |  558 |  1,116 |  737 |  379 |
...
| `prover.openings.whir_time_ms` |  41.50 |  83 |  46 |  37 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/04d5961665bb43507373cf0fd67b070c28b24074/keccak-04d5961665bb43507373cf0fd67b070c28b24074.memory.svg)
...
| app_proof |  |  |  |  |  | 2,167 |  |  | 138 | 14,365,133 | 103.91 | 0 | 13,608 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 39 | 514 | 39 | 13 | 4 | 2 | 2 | 2 | 
| internal_recursive.0 | 1 | 14 | 164 | 13 | 2 | 1 | 2 | 2 | 2 | 
| internal_recursive.1 | 1 | 9 | 129 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 178 | 1,453 | 178 | 63 | 32 | 6 | 7 | 7 | 
| leaf | 1 | 89 | 776 | 89 | 32 | 16 | 5 | 7 | 7 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 81,415,028 | 474 | 246 | 0 | 1 | 179 | 50 | 49 | 96 | 32 | 0 | 48 | 23 | 24 | 8 | 16 | 246 | 179 | 0 | 3 | 30 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,879 | 150 | 49 | 0 | 0 | 73 | 25 | 24 | 30 | 17 | 0 | 26 | 17 | 8 | 2 | 6 | 49 | 73 | 0 | 2 | 17 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 119 | 31 | 0 | 0 | 62 | 24 | 23 | 24 | 13 | 0 | 25 | 17 | 7 | 1 | 5 | 32 | 62 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover |
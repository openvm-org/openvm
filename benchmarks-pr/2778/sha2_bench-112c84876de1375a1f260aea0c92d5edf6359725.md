...
|:---|---:|---:|---:|
| Total |  11.44 |  4.69 |  4.69 |
| app_proof |  9.29 |  2.54 |  2.54 |
| leaf |  1.40 |  1.40 |  1.40 |
...
| `total_proof_time_ms ` |  2,300 |  9,200 |  2,450 |  2,202 |
| `execute_metered_time_ms` |  92 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  120.79 | -          |  120.79 |  120.79 |
| `execute_preflight_insns` |  2,791,990.25 |  11,167,961 |  2,851,000 |  2,614,961 |
| `execute_preflight_time_ms` |  164 |  656 |  206 |  99 |
| `execute_preflight_insn_mi/s` |  34.60 | -          |  35.45 |  32.35 |
| `trace_gen_time_ms   ` |  58 |  232 |  64 |  54 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  2,012.50 |  8,050 |  2,151 |  1,935 |
| `prover.main_trace_commit_time_ms` |  534.75 |  2,139 |  622 |  505 |
| `prover.rap_constraints_time_ms` |  1,335.25 |  5,341 |  1,386 |  1,285 |
| `prover.openings_time_ms` |  141.75 |  567 |  143 |  139 |
| `prover.rap_constraints.logup_gkr_time_ms` |  377.25 |  1,509 |  431 |  324 |
| `prover.rap_constraints.round0_time_ms` |  654.75 |  2,619 |  661 |  649 |
| `prover.rap_constraints.mle_rounds_time_ms` |  302 |  1,208 |  303 |  301 |
| `prover.openings.stacked_reduction_time_ms` |  106.25 |  425 |  107 |  105 |
...
| `prover.openings.whir_time_ms` |  34.50 |  138 |  36 |  33 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/112c84876de1375a1f260aea0c92d5edf6359725/sha2_bench-112c84876de1375a1f260aea0c92d5edf6359725.memory.svg)
...
| app_proof |  |  |  |  |  | 2,202 |  |  | 92 | 11,167,961 | 120.79 | 0 | 9,299 |  | 
...
| internal_recursive.0 | 1 | 13 | 186 | 12 | 2 | 0 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 9 | 155 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 145 | 1,404 | 144 | 53 | 25 | 2 | 6 | 6 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 61,220,603 | 375 | 184 | 0 | 11 | 133 | 36 | 35 | 63 | 32 | 0 | 57 | 23 | 33 | 5 | 28 | 184 | 133 | 0 | 2 | 31 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,879 | 172 | 51 | 0 | 4 | 76 | 24 | 23 | 29 | 23 | 0 | 44 | 20 | 24 | 1 | 22 | 51 | 76 | 0 | 2 | 22 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 145 | 34 | 0 | 4 | 68 | 24 | 23 | 24 | 18 | 0 | 43 | 20 | 22 | 1 | 21 | 34 | 67 | 0 | 2 | 18 | 0 | 0 | 
| leaf | 0 | prover | 425,198,438 | 1,259 | 799 | 0 | 197 | 344 | 165 | 164 | 101 | 77 | 0 | 115 | 36 | 78 | 36 | 42 | 799 | 344 | 0 | 6 | 76 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 644,972,797 | 2,151 | 621 | 0 | 157 | 1,386 | 651 | 651 | 303 | 431 | 112 | 143 | 35 | 107 | 59 | 47 | 622 | 1,386 | 0 | 3 | 317 | 0 | 0 | 
| app_proof | prover | 1 | 644,972,556 | 2,026 | 505 | 0 | 35 | 1,381 | 649 | 649 | 301 | 430 | 127 | 139 | 33 | 105 | 60 | 45 | 505 | 1,381 | 0 | 3 | 301 | 0 | 0 | 
| app_proof | prover | 2 | 644,972,556 | 1,938 | 506 | 0 | 35 | 1,289 | 661 | 661 | 303 | 324 | 0 | 142 | 34 | 107 | 61 | 45 | 506 | 1,289 | 0 | 3 | 323 | 0 | 0 | 
| app_proof | prover | 3 | 644,972,804 | 1,935 | 506 | 0 | 37 | 1,285 | 658 | 658 | 301 | 324 | 0 | 143 | 36 | 106 | 61 | 45 | 506 | 1,285 | 0 | 3 | 323 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 64 | 2,450 | 64 | 134 | 0 | 3 | 99 | 2,851,000 | 32.35 | 
| app_proof | 1 | 57 | 2,332 | 57 | 41 | 0 | 1 | 206 | 2,851,000 | 35.28 | 
| app_proof | 2 | 57 | 2,216 | 57 | 41 | 0 | 1 | 179 | 2,851,000 | 35.45 | 
| app_proof | 3 | 54 | 2,202 | 54 | 40 | 0 | 1 | 172 | 2,614,961 | 35.32 | 

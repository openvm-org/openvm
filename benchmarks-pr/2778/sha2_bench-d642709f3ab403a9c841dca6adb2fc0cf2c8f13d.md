...
|:---|---:|---:|---:|
| Total |  11.11 |  4.58 |  4.58 |
| app_proof |  9.03 |  2.50 |  2.50 |
| leaf |  1.41 |  1.41 |  1.41 |
...
| `total_proof_time_ms ` |  2,234.25 |  8,937 |  2,404 |  2,144 |
| `execute_metered_time_ms` |  93 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  119.44 | -          |  119.44 |  119.44 |
| `execute_preflight_insns` |  2,791,990.25 |  11,167,961 |  2,851,000 |  2,614,961 |
| `execute_preflight_time_ms` |  160.75 |  643 |  207 |  95 |
| `execute_preflight_insn_mi/s` |  37.06 | -          |  38.03 |  34.34 |
| `trace_gen_time_ms   ` |  59.25 |  237 |  70 |  53 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,948.25 |  7,793 |  2,102 |  1,885 |
| `prover.main_trace_commit_time_ms` |  531.75 |  2,127 |  617 |  503 |
| `prover.rap_constraints_time_ms` |  1,280.25 |  5,121 |  1,350 |  1,245 |
| `prover.openings_time_ms` |  135.25 |  541 |  137 |  134 |
| `prover.rap_constraints.logup_gkr_time_ms` |  318 |  1,272 |  389 |  288 |
| `prover.rap_constraints.round0_time_ms` |  662.75 |  2,651 |  668 |  656 |
| `prover.rap_constraints.mle_rounds_time_ms` |  298.25 |  1,193 |  303 |  294 |
| `prover.openings.stacked_reduction_time_ms` |  97.25 |  389 |  98 |  96 |
| `prover.openings.stacked_reduction.round0_time_ms` |  59.25 |  237 |  60 |  58 |
...
| `prover.main_trace_commit_time_ms` |  797 |  797 |  797 |  797 |
...
| `prover.rap_constraints.round0_time_ms` |  167 |  167 |  167 |  167 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/d642709f3ab403a9c841dca6adb2fc0cf2c8f13d/sha2_bench-d642709f3ab403a9c841dca6adb2fc0cf2c8f13d.memory.svg)
...
| app_proof |  |  |  |  |  | 2,144 |  |  | 93 | 11,167,961 | 119.44 | 0 | 9,038 |  | 
...
| leaf | 0 | 148 | 1,407 | 148 | 53 | 25 | 3 | 6 | 6 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 61,220,603 | 353 | 182 | 0 | 0 | 128 | 37 | 37 | 64 | 26 | 0 | 41 | 22 | 18 | 5 | 12 | 183 | 128 | 0 | 2 | 26 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,879 | 150 | 48 | 0 | 0 | 73 | 25 | 25 | 29 | 18 | 0 | 28 | 19 | 8 | 1 | 6 | 49 | 73 | 0 | 2 | 16 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 120 | 31 | 0 | 0 | 64 | 25 | 24 | 25 | 13 | 0 | 25 | 17 | 7 | 1 | 5 | 31 | 64 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 424,379,238 | 1,258 | 797 | 0 | 159 | 346 | 167 | 166 | 103 | 74 | 0 | 113 | 49 | 64 | 35 | 28 | 797 | 346 | 0 | 6 | 73 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 639,992,057 | 2,102 | 617 | 0 | 117 | 1,350 | 656 | 656 | 303 | 389 | 106 | 134 | 37 | 96 | 58 | 38 | 617 | 1,350 | 0 | 3 | 282 | 0 | 0 | 
| app_proof | prover | 1 | 639,991,820 | 1,905 | 504 | 0 | 2 | 1,263 | 665 | 664 | 299 | 298 | 0 | 137 | 39 | 98 | 60 | 38 | 504 | 1,263 | 0 | 4 | 297 | 0 | 0 | 
| app_proof | prover | 2 | 639,991,820 | 1,901 | 503 | 0 | 2 | 1,263 | 668 | 667 | 297 | 297 | 0 | 134 | 35 | 98 | 60 | 38 | 503 | 1,263 | 0 | 4 | 297 | 0 | 0 | 
| app_proof | prover | 3 | 639,992,052 | 1,885 | 503 | 0 | 2 | 1,245 | 662 | 662 | 294 | 288 | 0 | 136 | 38 | 97 | 59 | 38 | 503 | 1,245 | 0 | 3 | 287 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 70 | 2,404 | 70 | 136 | 0 | 4 | 95 | 2,851,000 | 34.34 | 
| app_proof | 1 | 57 | 2,212 | 57 | 41 | 0 | 1 | 207 | 2,851,000 | 37.84 | 
| app_proof | 2 | 57 | 2,177 | 57 | 41 | 0 | 1 | 177 | 2,851,000 | 38.03 | 
| app_proof | 3 | 53 | 2,144 | 53 | 41 | 0 | 1 | 164 | 2,614,961 | 38.01 | 

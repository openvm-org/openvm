...
|:---|---:|---:|---:|
| Total |  2.64 |  1.93 |  1.93 |
| app_proof |  1.89 |  1.18 |  1.18 |
| leaf |  0.43 |  0.43 |  0.43 |
...
| `total_proof_time_ms ` |  933.50 |  1,867 |  1,153 |  714 |
| `execute_metered_time_ms` |  24 | -          | -          | -          |
| `execute_metered_insns` |  1,979,971 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  79.22 | -          |  79.22 |  79.22 |
| `execute_preflight_insns` |  989,985.50 |  1,979,971 |  1,168,000 |  811,971 |
| `execute_preflight_time_ms` |  119 |  238 |  164 |  74 |
| `execute_preflight_insn_mi/s` |  29.58 | -          |  30.99 |  28.17 |
| `trace_gen_time_ms   ` |  27 |  54 |  37 |  17 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  696 |  1,392 |  901 |  491 |
| `prover.main_trace_commit_time_ms` |  203 |  406 |  269 |  137 |
| `prover.rap_constraints_time_ms` |  447 |  894 |  581 |  313 |
| `prover.openings_time_ms` |  45.50 |  91 |  50 |  41 |
| `prover.rap_constraints.logup_gkr_time_ms` |  85.50 |  171 |  114 |  57 |
| `prover.rap_constraints.round0_time_ms` |  261.50 |  523 |  344 |  179 |
| `prover.rap_constraints.mle_rounds_time_ms` |  98.50 |  197 |  122 |  75 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/8658dfa6e706c8887c3cd0d14c3df082f5da7953/kitchen_sink-8658dfa6e706c8887c3cd0d14c3df082f5da7953.memory.svg)
...
| frac_sumcheck.gkr_rounds | 8.73 | app_proof.prover.0 |
| prover.gkr_input_evals | 8.73 | app_proof.prover.0 |
| frac_sumcheck.segment_tree | 8.73 | app_proof.prover.0 |
| prover.batch_constraints.before_round0 | 8.73 | app_proof.prover.0 |
...
| 16 | VmAirWrapper<Rv64IsEqualModAdapterU16Air<2, 4, 4, 16>, ModularIsEqualCoreAir<16, 4, 16> | 50 | 118 | 3 | 
...
| 19 | VmAirWrapper<Rv64IsEqualModAdapterU16Air<2, 4, 4, 16>, ModularIsEqualCoreAir<16, 4, 16> | 50 | 118 | 3 | 
...
| 22 | VmAirWrapper<Rv64IsEqualModAdapterU16Air<2, 6, 4, 24>, ModularIsEqualCoreAir<24, 4, 16> | 66 | 170 | 3 | 
...
| 25 | VmAirWrapper<Rv64IsEqualModAdapterU16Air<2, 4, 4, 16>, ModularIsEqualCoreAir<16, 4, 16> | 50 | 118 | 3 | 
...
| 28 | VmAirWrapper<Rv64IsEqualModAdapterU16Air<2, 4, 4, 16>, ModularIsEqualCoreAir<16, 4, 16> | 50 | 118 | 3 | 
...
| 31 | VmAirWrapper<Rv64IsEqualModAdapterU16Air<2, 4, 4, 16>, ModularIsEqualCoreAir<16, 4, 16> | 50 | 118 | 3 | 
...
| 34 | VmAirWrapper<Rv64IsEqualModAdapterU16Air<2, 4, 4, 16>, ModularIsEqualCoreAir<16, 4, 16> | 50 | 118 | 3 | 
...
| 37 | VmAirWrapper<Rv64IsEqualModAdapterU16Air<2, 4, 4, 16>, ModularIsEqualCoreAir<16, 4, 16> | 50 | 118 | 3 | 
...
| 40 | VmAirWrapper<Rv64IsEqualModAdapterU16Air<2, 4, 4, 16>, ModularIsEqualCoreAir<16, 4, 16> | 50 | 118 | 3 | 
...
| 43 | VmAirWrapper<Rv64VecHeapAdapterAir<2, 4, 4, 8, 8>, 2, 4, 4, 8, 32, 32>, ShiftCoreAir<32, 8> | 147 | 2,127 | 3 | 
| 44 | VmAirWrapper<Rv64VecHeapAdapterAir<2, 4, 4, 8, 8>, 2, 4, 4, 8, 32, 32>, MultiplicationCoreAir<32, 8> | 129 | 16 | 2 | 
| 45 | VmAirWrapper<Rv64VecHeapBranchAdapterAir<2, 4, 4>, 2, 4, 4, 16>, BranchLessThanCoreAir<16, 16> | 77 | 69 | 3 | 
| 46 | VmAirWrapper<Rv64VecHeapBranchAdapterAir<2, 4, 4>, 2, 4, 4, 16>, BranchEqualCoreAir<16, 16> | 76 | 31 | 3 | 
| 47 | VmAirWrapper<Rv64VecHeapU16AdapterAir<2, 4, 4, 4, 4>, 2, 4, 4, 4, 16, 16>, LessThanCoreAir<16, 16> | 98 | 71 | 3 | 
| 48 | VmAirWrapper<Rv64VecHeapAdapterAir<2, 4, 4, 8, 8>, 2, 4, 4, 8, 32, 32>, BaseAluCoreAir<32, 8> | 129 | 85 | 3 | 
...
| 66 | VmAirWrapper<Rv64BranchAdapterAir, BranchLessThanCoreAir<4, 16> | 20 | 25 | 3 | 
| 67 | VmAirWrapper<Rv64BranchAdapterAir, BranchEqualCoreAir<4, 16> | 19 | 11 | 3 | 
...
| 72 | VmAirWrapper<Rv64BaseAluAdapterU16Air, LessThanCoreAir<4, 16> | 25 | 30 | 3 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 74 | 3 |  |  | 0 |  | 360 | 3 |  |  |  |  |  |  | 
| app_proof |  |  |  |  |  | 714 |  |  | 24 | 1,979,971 | 79.22 | 0 | 1,896 |  | 
| internal_for_leaf |  |  |  | 139 |  |  |  |  |  |  |  |  |  | 139 | 
| internal_recursive.0 |  |  |  | 94 |  |  |  |  |  |  |  |  |  | 94 | 
...
| app_proof | VmAirWrapper<Rv64IsEqualModAdapterU16Air<2, 6, 4, 24>, ModularIsEqualCoreAir<24, 4, 16> | 0 | 0 | 
...
| app_proof | VmAirWrapper<Rv64BaseAluAdapterU16Air, LessThanCoreAir<4, 16> | 1 | 0 | 
...
| app_proof | 16 | VmAirWrapper<Rv64IsEqualModAdapterU16Air<2, 4, 4, 16>, ModularIsEqualCoreAir<16, 4, 16> | prover | 0 | 4 | 120 | 480 | 
...
| app_proof | 19 | VmAirWrapper<Rv64IsEqualModAdapterU16Air<2, 4, 4, 16>, ModularIsEqualCoreAir<16, 4, 16> | prover | 0 | 2 | 120 | 240 | 
...
| app_proof | 22 | VmAirWrapper<Rv64IsEqualModAdapterU16Air<2, 6, 4, 24>, ModularIsEqualCoreAir<24, 4, 16> | prover | 0 | 8 | 164 | 1,312 | 
...
| app_proof | 25 | VmAirWrapper<Rv64IsEqualModAdapterU16Air<2, 4, 4, 16>, ModularIsEqualCoreAir<16, 4, 16> | prover | 0 | 2 | 120 | 240 | 
...
| app_proof | 28 | VmAirWrapper<Rv64IsEqualModAdapterU16Air<2, 4, 4, 16>, ModularIsEqualCoreAir<16, 4, 16> | prover | 0 | 8 | 120 | 960 | 
...
| app_proof | 31 | VmAirWrapper<Rv64IsEqualModAdapterU16Air<2, 4, 4, 16>, ModularIsEqualCoreAir<16, 4, 16> | prover | 0 | 2 | 120 | 240 | 
...
| app_proof | 34 | VmAirWrapper<Rv64IsEqualModAdapterU16Air<2, 4, 4, 16>, ModularIsEqualCoreAir<16, 4, 16> | prover | 0 | 8 | 120 | 960 | 
...
| app_proof | 37 | VmAirWrapper<Rv64IsEqualModAdapterU16Air<2, 4, 4, 16>, ModularIsEqualCoreAir<16, 4, 16> | prover | 0 | 2 | 120 | 240 | 
...
| app_proof | 40 | VmAirWrapper<Rv64IsEqualModAdapterU16Air<2, 4, 4, 16>, ModularIsEqualCoreAir<16, 4, 16> | prover | 0 | 8 | 120 | 960 | 
...
| app_proof | 72 | VmAirWrapper<Rv64BaseAluAdapterU16Air, LessThanCoreAir<4, 16> | prover | 0 | 512 | 38 | 19,456 | 
...
| app_proof | 72 | VmAirWrapper<Rv64BaseAluAdapterU16Air, LessThanCoreAir<4, 16> | prover | 1 | 128 | 38 | 4,864 | 
...
| internal_recursive.0 | 1 | 11 | 94 | 11 | 1 | 0 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 10 | 87 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 130 | 430 | 130 | 30 | 11 | 18 | 6 | 6 | 
...
| internal_recursive.0 | 1 | prover | 15,378,703 | 83 | 16 | 0 | 0 | 49 | 18 | 17 | 20 | 10 | 0 | 16 | 10 | 5 | 1 | 4 | 16 | 49 | 0 | 1 | 9 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 77 | 11 | 0 | 0 | 49 | 20 | 18 | 18 | 10 | 0 | 15 | 10 | 5 | 0 | 4 | 11 | 49 | 0 | 1 | 9 | 0 | 0 | 
| leaf | 0 | prover | 261,140,340 | 299 | 128 | 0 | 2 | 141 | 49 | 48 | 37 | 55 | 0 | 28 | 12 | 15 | 7 | 8 | 129 | 141 | 0 | 2 | 54 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 555,262,116 | 901 | 268 | 0 | 139 | 581 | 344 | 343 | 122 | 114 | 57 | 50 | 12 | 37 | 15 | 21 | 269 | 581 | 0 | 1 | 55 | 0 | 0 | 
| app_proof | prover | 1 | 533,498,636 | 491 | 136 | 0 | 2 | 313 | 179 | 179 | 75 | 57 | 0 | 41 | 13 | 27 | 14 | 13 | 137 | 313 | 0 | 1 | 56 | 0 | 0 | 

| group | phase | segment | trace_height_constraint | weighted_sum | threshold |
| --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 0 | 50,947,086 | 2,013,265,921 | 
| app_proof | prover | 1 | 0 | 42,838,410 | 2,013,265,921 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 37 | 1,153 | 37 | 139 | 0 | 4 | 74 | 1,168,000 | 28.17 | 
| app_proof | 1 | 17 | 714 | 17 | 40 | 0 | 1 | 164 | 811,971 | 30.99 | 

...
| `total_proof_time_ms ` |  898 |  1,796 |  1,115 |  681 |
| `execute_metered_time_ms` |  23 | -          | -          | -          |
| `execute_metered_insns` |  1,979,971 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  83.52 | -          |  83.52 |  83.52 |
| `execute_preflight_insns` |  989,985.50 |  1,979,971 |  1,168,000 |  811,971 |
| `execute_preflight_time_ms` |  96 |  192 |  139 |  53 |
| `execute_preflight_insn_mi/s` |  34.47 | -          |  35.27 |  33.67 |
...
| `prover.rap_constraints_time_ms` |  443 |  886 |  577 |  309 |
| `prover.openings_time_ms` |  45 |  90 |  50 |  40 |
| `prover.rap_constraints.logup_gkr_time_ms` |  79 |  158 |  105 |  53 |
| `prover.rap_constraints.round0_time_ms` |  261 |  522 |  343 |  179 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/b11f626c6b1ccafffa05599bf687e30ff6044787/kitchen_sink-b11f626c6b1ccafffa05599bf687e30ff6044787.memory.svg)

| Module | Max (GB) | Max At |
| --- | ---: | --- |
| prover.rap_constraints | 10.07 | app_proof.prover.0 |
...
| frac_sumcheck.gkr_rounds | 8.53 | app_proof.prover.0 |
| prover.batch_constraints.before_round0 | 8.53 | app_proof.prover.0 |
| frac_sumcheck.segment_tree | 8.53 | app_proof.prover.0 |
| prover.gkr_input_evals | 8.53 | app_proof.prover.0 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 70 | 3 |  |  | 0 |  | 354 | 3 |  |  |  |  |  |  | 
| app_proof |  |  |  |  |  | 681 |  |  | 23 | 1,979,971 | 83.52 | 0 | 1,824 |  | 
...
| app_proof | 57 | Sha2MainAir<Sha256Config> | prover | 0 | 16,384 | 156 | 2,555,904 | 
...
| app_proof | 57 | Sha2MainAir<Sha256Config> | prover | 1 | 16,384 | 156 | 2,555,904 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 18 | 139 | 17 | 6 | 1 | 2 | 1 | 1 | 
| internal_recursive.0 | 1 | 10 | 89 | 10 | 1 | 0 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 9 | 83 | 8 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 109 | 406 | 109 | 24 | 10 | 18 | 4 | 4 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,577,915 | 121 | 38 | 0 | 0 | 63 | 22 | 21 | 29 | 12 | 0 | 18 | 10 | 7 | 1 | 6 | 38 | 63 | 0 | 1 | 11 | 0 | 0 | 
...
| leaf | 0 | prover | 261,140,340 | 297 | 128 | 0 | 1 | 139 | 48 | 47 | 37 | 54 | 0 | 28 | 12 | 15 | 7 | 8 | 129 | 139 | 0 | 2 | 53 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 554,737,828 | 893 | 265 | 0 | 136 | 577 | 343 | 341 | 128 | 105 | 51 | 50 | 13 | 37 | 15 | 21 | 265 | 577 | 0 | 1 | 53 | 0 | 0 | 
| app_proof | prover | 1 | 532,974,348 | 485 | 136 | 0 | 2 | 309 | 179 | 179 | 75 | 53 | 0 | 40 | 12 | 27 | 14 | 13 | 136 | 309 | 0 | 1 | 53 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 32 | 1,115 | 32 | 135 | 0 | 3 | 53 | 1,168,000 | 33.67 | 
| app_proof | 1 | 15 | 681 | 15 | 40 | 0 | 1 | 139 | 811,971 | 35.27 | 

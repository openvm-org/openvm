...
|:---|---:|---:|---:|
| Total |  16.39 |  4.74 |  4.74 |
| app_proof |  13.40 |  2.51 |  2.51 |
| leaf |  2.19 |  1.42 |  1.42 |
...
| `total_proof_time_ms ` |  2,211 |  13,266 |  2,374 |  2,133 |
...
| `execute_preflight_time_ms` |  235.83 |  1,415 |  316 |  85 |
| `execute_preflight_insn_mi/s` |  34.09 | -          |  35.05 |  31.45 |
| `trace_gen_time_ms   ` |  36.33 |  218 |  52 |  33 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,881 |  11,286 |  2,101 |  1,830 |
| `prover.main_trace_commit_time_ms` |  693.50 |  4,161 |  850 |  657 |
| `prover.rap_constraints_time_ms` |  1,008.50 |  6,051 |  1,072 |  986 |
| `prover.openings_time_ms` |  177.67 |  1,066 |  180 |  176 |
| `prover.rap_constraints.logup_gkr_time_ms` |  171.33 |  1,028 |  223 |  160 |
| `prover.rap_constraints.round0_time_ms` |  523.33 |  3,140 |  532 |  516 |
| `prover.rap_constraints.mle_rounds_time_ms` |  312.50 |  1,875 |  332 |  302 |
| `prover.openings.stacked_reduction_time_ms` |  134 |  804 |  136 |  133 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,094 |  2,188 |  1,424 |  764 |
| `execute_preflight_time_ms` |  5 |  10 |  5 |  5 |
| `trace_gen_time_ms   ` |  135.50 |  271 |  180 |  91 |
| `generate_blob_total_time_ms` |  24 |  48 |  32 |  16 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  958.50 |  1,917 |  1,244 |  673 |
| `prover.main_trace_commit_time_ms` |  548 |  1,096 |  724 |  372 |
| `prover.rap_constraints_time_ms` |  316.50 |  633 |  405 |  228 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/077b9080da1e395662136d021e664301503372ca/keccak-077b9080da1e395662136d021e664301503372ca.memory.svg)
...
| app_proof |  |  |  |  |  | 2,133 |  |  | 138 | 14,365,133 | 103.89 | 0 | 13,410 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 39 | 503 | 39 | 14 | 4 | 2 | 2 | 2 | 
| internal_recursive.0 | 1 | 13 | 169 | 13 | 2 | 1 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 10 | 130 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 180 | 1,424 | 179 | 65 | 32 | 5 | 7 | 7 | 
| leaf | 1 | 91 | 764 | 90 | 32 | 16 | 5 | 7 | 7 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 81,415,028 | 463 | 242 | 0 | 1 | 173 | 48 | 47 | 93 | 31 | 0 | 46 | 23 | 23 | 7 | 15 | 243 | 173 | 0 | 3 | 29 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,879 | 156 | 49 | 0 | 0 | 72 | 25 | 24 | 29 | 17 | 0 | 33 | 24 | 8 | 1 | 6 | 49 | 72 | 0 | 2 | 17 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 120 | 32 | 0 | 0 | 62 | 24 | 23 | 24 | 13 | 0 | 25 | 17 | 7 | 1 | 5 | 32 | 62 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 474,940,262 | 1,244 | 724 | 0 | 2 | 405 | 201 | 201 | 117 | 85 | 0 | 114 | 43 | 70 | 40 | 30 | 724 | 405 | 0 | 7 | 84 | 0 | 0 | 
| leaf | 1 | prover | 239,436,532 | 673 | 372 | 0 | 1 | 228 | 108 | 107 | 68 | 51 | 0 | 72 | 34 | 37 | 20 | 17 | 372 | 228 | 0 | 6 | 50 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 842,692,236 | 2,101 | 850 | 0 | 193 | 1,072 | 516 | 515 | 332 | 223 | 68 | 177 | 42 | 134 | 82 | 52 | 850 | 1,072 | 0 | 4 | 152 | 0 | 0 | 
| app_proof | prover | 1 | 842,692,236 | 1,853 | 657 | 0 | 3 | 1,017 | 526 | 525 | 330 | 160 | 0 | 177 | 44 | 133 | 82 | 51 | 657 | 1,017 | 0 | 3 | 159 | 0 | 0 | 
| app_proof | prover | 2 | 842,692,236 | 1,830 | 662 | 0 | 3 | 987 | 522 | 522 | 302 | 161 | 0 | 180 | 46 | 133 | 81 | 51 | 662 | 987 | 0 | 3 | 160 | 0 | 0 | 
| app_proof | prover | 3 | 842,692,236 | 1,841 | 664 | 0 | 3 | 1,000 | 532 | 532 | 304 | 162 | 0 | 176 | 41 | 134 | 82 | 52 | 664 | 1,000 | 0 | 3 | 161 | 0 | 0 | 
| app_proof | prover | 4 | 842,692,236 | 1,831 | 662 | 0 | 3 | 989 | 524 | 524 | 303 | 161 | 0 | 178 | 43 | 134 | 82 | 51 | 663 | 989 | 0 | 4 | 160 | 0 | 0 | 
| app_proof | prover | 5 | 842,692,236 | 1,830 | 664 | 0 | 3 | 986 | 520 | 520 | 304 | 161 | 0 | 178 | 42 | 136 | 83 | 52 | 665 | 986 | 0 | 4 | 160 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 52 | 2,374 | 52 | 135 | 0 | 3 | 85 | 2,413,000 | 31.45 | 
| app_proof | 1 | 34 | 2,245 | 34 | 41 | 0 | 1 | 316 | 2,413,000 | 34.60 | 
| app_proof | 2 | 33 | 2,166 | 33 | 41 | 0 | 1 | 261 | 2,413,000 | 34.58 | 
| app_proof | 3 | 33 | 2,180 | 33 | 41 | 0 | 1 | 263 | 2,413,000 | 34.59 | 
| app_proof | 4 | 33 | 2,168 | 33 | 41 | 0 | 1 | 262 | 2,413,000 | 35.05 | 
| app_proof | 5 | 33 | 2,133 | 33 | 41 | 0 | 1 | 228 | 2,300,133 | 34.25 | 

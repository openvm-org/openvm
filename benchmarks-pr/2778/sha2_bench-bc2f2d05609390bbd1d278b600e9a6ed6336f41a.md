...
| `total_proof_time_ms ` |  2,345.25 |  9,381 |  2,505 |  2,237 |
| `execute_metered_time_ms` |  92 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  120.95 | -          |  120.95 |  120.95 |
| `execute_preflight_insns` |  2,791,990.25 |  11,167,961 |  2,851,000 |  2,614,961 |
| `execute_preflight_time_ms` |  172 |  688 |  215 |  107 |
| `execute_preflight_insn_mi/s` |  32.87 | -          |  33.66 |  30.79 |
| `trace_gen_time_ms   ` |  58 |  232 |  63 |  54 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  2,049.50 |  8,198 |  2,198 |  1,963 |
| `prover.main_trace_commit_time_ms` |  548.50 |  2,194 |  640 |  517 |
| `prover.rap_constraints_time_ms` |  1,354.25 |  5,417 |  1,409 |  1,298 |
| `prover.openings_time_ms` |  145.50 |  582 |  148 |  144 |
| `prover.rap_constraints.logup_gkr_time_ms` |  381.50 |  1,526 |  435 |  328 |
| `prover.rap_constraints.round0_time_ms` |  656.50 |  2,626 |  660 |  652 |
| `prover.rap_constraints.mle_rounds_time_ms` |  315 |  1,260 |  318 |  313 |
| `prover.openings.stacked_reduction_time_ms` |  108.25 |  433 |  109 |  107 |
| `prover.openings.stacked_reduction.round0_time_ms` |  61.25 |  245 |  63 |  60 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/bc2f2d05609390bbd1d278b600e9a6ed6336f41a/sha2_bench-bc2f2d05609390bbd1d278b600e9a6ed6336f41a.memory.svg)

| Module | Max (GB) | Max At |
| --- | ---: | --- |
| frac_sumcheck.gkr_rounds | 11.38 | app_proof.prover.3 |
| prover.batch_constraints.before_round0 | 11.38 | app_proof.prover.3 |
| prover.rap_constraints | 11.26 | app_proof.prover.0 |
| frac_sumcheck.segment_tree | 11.16 | app_proof.prover.3 |
| prover.gkr_input_evals | 11.16 | app_proof.prover.3 |
| prover.batch_constraints.round0 | 10.64 | app_proof.prover.0 |
| prover.batch_constraints.fold_ple_evals | 10.64 | app_proof.prover.0 |
| prover.prove_whir_opening | 10.04 | app_proof.prover.0 |
| prover.openings | 10.04 | app_proof.prover.0 |
| prover.merkle_tree | 10.04 | app_proof.prover.0 |
...
| app_proof |  |  |  |  |  | 2,237 |  |  | 92 | 11,167,961 | 120.95 | 0 | 9,479 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 24 | 396 | 24 | 8 | 2 | 2 | 3 | 3 | 
| internal_recursive.0 | 1 | 12 | 182 | 11 | 2 | 0 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 9 | 154 | 8 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 148 | 1,408 | 148 | 54 | 26 | 3 | 6 | 6 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 61,220,603 | 371 | 184 | 0 | 11 | 133 | 36 | 36 | 64 | 32 | 0 | 52 | 18 | 33 | 5 | 27 | 185 | 133 | 0 | 2 | 31 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,879 | 170 | 51 | 0 | 3 | 77 | 24 | 23 | 29 | 23 | 0 | 41 | 17 | 23 | 1 | 21 | 52 | 77 | 0 | 2 | 22 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 145 | 33 | 0 | 4 | 67 | 24 | 23 | 24 | 18 | 0 | 43 | 21 | 22 | 1 | 21 | 34 | 67 | 0 | 2 | 17 | 0 | 0 | 
| leaf | 0 | prover | 425,198,438 | 1,259 | 795 | 0 | 195 | 348 | 167 | 166 | 102 | 78 | 0 | 115 | 37 | 78 | 36 | 41 | 795 | 348 | 0 | 6 | 77 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 662,339,897 | 2,198 | 640 | 0 | 166 | 1,409 | 657 | 657 | 315 | 435 | 113 | 148 | 38 | 109 | 60 | 48 | 640 | 1,409 | 0 | 3 | 321 | 0 | 0 | 
| app_proof | prover | 1 | 662,339,596 | 2,071 | 518 | 0 | 39 | 1,407 | 652 | 652 | 318 | 435 | 130 | 145 | 35 | 109 | 63 | 45 | 518 | 1,407 | 0 | 3 | 305 | 0 | 0 | 
| app_proof | prover | 2 | 662,339,596 | 1,966 | 517 | 0 | 39 | 1,303 | 660 | 660 | 314 | 328 | 0 | 145 | 36 | 108 | 62 | 46 | 517 | 1,303 | 0 | 3 | 325 | 0 | 0 | 
| app_proof | prover | 3 | 662,339,860 | 1,963 | 519 | 0 | 41 | 1,298 | 657 | 656 | 313 | 328 | 0 | 144 | 37 | 107 | 60 | 46 | 519 | 1,298 | 0 | 3 | 326 | 0 | 0 | 

| group | phase | segment | trace_height_constraint | weighted_sum | threshold |
| --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 0 | 112,550,307 | 2,013,265,921 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 63 | 2,505 | 63 | 135 | 0 | 3 | 107 | 2,851,000 | 30.79 | 
| app_proof | 1 | 58 | 2,386 | 58 | 41 | 0 | 1 | 215 | 2,851,000 | 33.60 | 
| app_proof | 2 | 57 | 2,253 | 57 | 41 | 0 | 1 | 188 | 2,851,000 | 33.45 | 
| app_proof | 3 | 54 | 2,237 | 54 | 41 | 0 | 1 | 178 | 2,614,961 | 33.66 | 

...
|:---|---:|---:|---:|
| Total |  2.51 |  1.85 |  1.85 |
| app_proof |  1.80 |  1.14 |  1.14 |
| leaf |  0.40 |  0.40 |  0.40 |
...
| `total_proof_time_ms ` |  890 |  1,780 |  1,112 |  668 |
...
| `execute_preflight_time_ms` |  90 |  180 |  127 |  53 |
| `execute_preflight_insn_mi/s` |  34.81 | -          |  35.71 |  33.92 |
| `trace_gen_time_ms   ` |  23.50 |  47 |  32 |  15 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  687 |  1,374 |  890 |  484 |
| `prover.main_trace_commit_time_ms` |  201 |  402 |  265 |  137 |
| `prover.rap_constraints_time_ms` |  440.50 |  881 |  574 |  307 |
| `prover.openings_time_ms` |  45 |  90 |  51 |  39 |
| `prover.rap_constraints.logup_gkr_time_ms` |  79 |  158 |  105 |  53 |
| `prover.rap_constraints.round0_time_ms` |  259.50 |  519 |  341 |  178 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/0d37807f81ca10c7aa550cd241eac41abde64fd6/kitchen_sink-0d37807f81ca10c7aa550cd241eac41abde64fd6.memory.svg)
...
| app_proof |  |  |  |  |  | 668 |  |  | 23 | 1,979,971 | 83.51 | 0 | 1,808 |  | 
...
| leaf | 0 | 107 | 403 | 107 | 24 | 10 | 19 | 5 | 5 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,577,915 | 120 | 38 | 0 | 0 | 63 | 21 | 20 | 29 | 12 | 0 | 18 | 10 | 7 | 1 | 6 | 38 | 63 | 0 | 1 | 11 | 0 | 0 | 
...
| leaf | 0 | prover | 261,140,340 | 295 | 127 | 0 | 1 | 139 | 48 | 47 | 36 | 54 | 0 | 27 | 12 | 15 | 7 | 8 | 128 | 139 | 0 | 2 | 53 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 555,262,116 | 890 | 264 | 0 | 135 | 574 | 341 | 339 | 127 | 105 | 51 | 51 | 13 | 37 | 15 | 21 | 265 | 574 | 0 | 1 | 53 | 0 | 0 | 
| app_proof | prover | 1 | 533,498,636 | 484 | 136 | 0 | 2 | 307 | 178 | 177 | 75 | 53 | 0 | 39 | 12 | 27 | 14 | 13 | 137 | 307 | 0 | 1 | 52 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 32 | 1,112 | 32 | 135 | 0 | 3 | 53 | 1,168,000 | 33.92 | 
| app_proof | 1 | 15 | 668 | 15 | 40 | 0 | 1 | 127 | 811,971 | 35.71 | 

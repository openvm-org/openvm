...
|:---|---:|---:|---:|
| Total |  2.27 |  1.68 |  1.68 |
| app_proof |  1.39 |  0.80 |  0.80 |
| leaf |  0.36 |  0.36 |  0.36 |
...
| `total_proof_time_ms ` |  678.50 |  1,357 |  772 |  585 |
...
| `execute_preflight_insn_mi/s` |  34.89 | -          |  37.05 |  32.74 |
| `trace_gen_time_ms   ` |  46.50 |  93 |  47 |  46 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  464.50 |  929 |  508 |  421 |
| `prover.main_trace_commit_time_ms` |  116.50 |  233 |  130 |  103 |
| `prover.rap_constraints_time_ms` |  301 |  602 |  326 |  276 |
| `prover.openings_time_ms` |  46 |  92 |  51 |  41 |
| `prover.rap_constraints.logup_gkr_time_ms` |  169.50 |  339 |  200 |  139 |
| `prover.rap_constraints.round0_time_ms` |  91.50 |  183 |  102 |  81 |
| `prover.rap_constraints.mle_rounds_time_ms` |  39 |  78 |  44 |  34 |
...
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  216 |  216 |  216 |  216 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/d642709f3ab403a9c841dca6adb2fc0cf2c8f13d/regex-d642709f3ab403a9c841dca6adb2fc0cf2c8f13d.memory.svg)

| Module | Max (GB) | Max At |
| --- | ---: | --- |
| prover.batch_constraints.before_round0 | 4.19 | app_proof.prover.0 |
| frac_sumcheck.gkr_rounds | 4.19 | app_proof.prover.0 |
| prover.gkr_input_evals | 4.18 | app_proof.prover.0 |
| frac_sumcheck.segment_tree | 4.18 | app_proof.prover.0 |
| generate mem proving ctxs | 2.86 | app_proof.0 |
| set initial memory | 2.85 | app_proof.1 |
| prover.rap_constraints | 2.82 | app_proof.prover.0 |
| prover.batch_constraints.round0 | 2.65 | app_proof.prover.0 |
| prover.batch_constraints.fold_ple_evals | 2.65 | app_proof.prover.0 |
| prover.merkle_tree | 2.56 | app_proof.prover.0 |
| prover.openings | 2.56 | app_proof.prover.0 |
| prover.prove_whir_opening | 2.56 | app_proof.prover.0 |
...
| app_proof |  |  |  |  |  | 585 |  |  | 31 | 4,090,656 | 129.82 | 0 | 1,402 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 15 | 231 | 15 | 4 | 0 | 2 | 0 | 1 | 
| internal_recursive.0 | 1 | 10 | 155 | 9 | 1 | 0 | 2 | 0 | 0 | 
| internal_recursive.1 | 1 | 10 | 132 | 10 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 49 | 360 | 49 | 14 | 3 | 4 | 1 | 1 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 27,289,339 | 216 | 82 | 0 | 0 | 99 | 32 | 32 | 46 | 20 | 0 | 33 | 22 | 11 | 2 | 8 | 82 | 99 | 0 | 2 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,703 | 145 | 46 | 0 | 0 | 68 | 25 | 24 | 28 | 14 | 0 | 30 | 22 | 8 | 1 | 6 | 47 | 68 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 121 | 31 | 0 | 0 | 62 | 24 | 23 | 24 | 13 | 0 | 26 | 19 | 7 | 1 | 5 | 32 | 62 | 0 | 2 | 13 | 0 | 0 | 
| leaf | 0 | prover | 79,659,764 | 310 | 129 | 0 | 0 | 136 | 55 | 54 | 37 | 43 | 0 | 44 | 29 | 15 | 6 | 8 | 129 | 136 | 0 | 6 | 42 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 161,778,130 | 508 | 130 | 0 | 0 | 326 | 81 | 80 | 44 | 200 | 56 | 51 | 25 | 25 | 14 | 11 | 130 | 326 | 0 | 3 | 143 | 0 | 0 | 
| app_proof | prover | 1 | 123,191,615 | 421 | 103 | 0 | 8 | 276 | 102 | 101 | 34 | 139 | 0 | 41 | 20 | 21 | 10 | 10 | 103 | 276 | 0 | 3 | 138 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 46 | 772 | 46 | 133 | 1 | 5 | 83 | 2,327,000 | 32.74 | 
| app_proof | 1 | 47 | 585 | 47 | 40 | 0 | 2 | 74 | 1,763,656 | 37.05 | 

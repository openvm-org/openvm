...
|:---|---:|---:|---:|
| Total |  16.59 |  4.80 |  4.80 |
| app_proof |  13.57 |  2.56 |  2.56 |
| leaf |  2.22 |  1.44 |  1.44 |
...
| `total_proof_time_ms ` |  2,238.50 |  13,431 |  2,420 |  2,154 |
| `execute_metered_time_ms` |  138 | -          | -          | -          |
| `execute_metered_insns` |  14,365,133 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  103.77 | -          |  103.77 |  103.77 |
| `execute_preflight_insns` |  2,394,188.83 |  14,365,133 |  2,413,000 |  2,300,133 |
| `execute_preflight_time_ms` |  247.67 |  1,486 |  323 |  87 |
| `execute_preflight_insn_mi/s` |  33.78 | -          |  34.88 |  31.01 |
| `trace_gen_time_ms   ` |  37.33 |  224 |  54 |  33 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,894.67 |  11,368 |  2,136 |  1,841 |
| `prover.main_trace_commit_time_ms` |  698.33 |  4,190 |  859 |  665 |
| `prover.rap_constraints_time_ms` |  1,013.67 |  6,082 |  1,084 |  992 |
| `prover.openings_time_ms` |  181.33 |  1,088 |  192 |  175 |
| `prover.rap_constraints.logup_gkr_time_ms` |  172.83 |  1,037 |  224 |  162 |
| `prover.rap_constraints.round0_time_ms` |  522 |  3,132 |  527 |  517 |
| `prover.rap_constraints.mle_rounds_time_ms` |  317.67 |  1,906 |  339 |  307 |
...
| `prover.openings.whir_time_ms` |  46.67 |  280 |  56 |  41 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,108 |  2,216 |  1,437 |  779 |
| `execute_preflight_time_ms` |  5.50 |  11 |  6 |  5 |
| `trace_gen_time_ms   ` |  142 |  284 |  185 |  99 |
| `generate_blob_total_time_ms` |  24 |  48 |  32 |  16 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  965 |  1,930 |  1,251 |  679 |
| `prover.main_trace_commit_time_ms` |  550.50 |  1,101 |  726 |  375 |
| `prover.rap_constraints_time_ms` |  319 |  638 |  410 |  228 |
| `prover.openings_time_ms` |  94.50 |  189 |  114 |  75 |
| `prover.rap_constraints.logup_gkr_time_ms` |  68.50 |  137 |  86 |  51 |
| `prover.rap_constraints.round0_time_ms` |  156.50 |  313 |  204 |  109 |
| `prover.rap_constraints.mle_rounds_time_ms` |  93 |  186 |  119 |  67 |
...
| `prover.openings.whir_time_ms` |  40 |  80 |  42 |  38 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/dd9371cf4e670e337b3bcdf26e1ec15c64cdd8eb/keccak-dd9371cf4e670e337b3bcdf26e1ec15c64cdd8eb.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 75 | 9 |  |  | 0 |  | 379 | 9 |  |  |  |  |  |  | 
| app_proof |  |  |  |  |  | 2,154 |  |  | 138 | 14,365,133 | 103.77 | 0 | 13,577 |  | 
...
| app_proof | VmAirWrapper<Rv64BaseAluAdapterAir, BaseAluCoreAir<8, 8> | 4 | 6 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 42 | 503 | 41 | 13 | 4 | 2 | 2 | 2 | 
| internal_recursive.0 | 1 | 14 | 170 | 14 | 2 | 1 | 2 | 1 | 2 | 
| internal_recursive.1 | 1 | 9 | 132 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 185 | 1,437 | 185 | 64 | 32 | 6 | 8 | 8 | 
| leaf | 1 | 99 | 779 | 99 | 32 | 16 | 5 | 10 | 10 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 81,415,028 | 461 | 244 | 0 | 1 | 173 | 50 | 49 | 92 | 30 | 0 | 43 | 19 | 23 | 7 | 15 | 244 | 173 | 0 | 3 | 29 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,879 |
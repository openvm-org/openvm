...
| `total_proof_time_ms ` |  352.75 |  1,411 |  469 |  219 |
| `execute_metered_time_ms` |  19 | -          | -          | -          |
| `execute_metered_insns` |  4,000,051 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  200.10 | -          |  200.10 |  200.10 |
| `execute_preflight_insns` |  1,000,012.75 |  4,000,051 |  1,310,000 |  70,051 |
| `execute_preflight_time_ms` |  35 |  140 |  48 |  4 |
| `execute_preflight_insn_mi/s` |  41.70 | -          |  41.82 |  41.52 |
| `trace_gen_time_ms   ` |  76.25 |  305 |  103 |  65 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  176 |  704 |  216 |  71 |
| `prover.main_trace_commit_time_ms` |  41.75 |  167 |  51 |  15 |
| `prover.rap_constraints_time_ms` |  104.50 |  418 |  133 |  33 |
| `prover.openings_time_ms` |  29.25 |  117 |  34 |  22 |
| `prover.rap_constraints.logup_gkr_time_ms` |  65.25 |  261 |  82 |  17 |
| `prover.rap_constraints.round0_time_ms` |  24.75 |  99 |  34 |  9 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/7fc99506c0e4d0492cbc4b0a6dfd399266db0479/fibonacci-7fc99506c0e4d0492cbc4b0a6dfd399266db0479.memory.svg)
...
| app_proof |  |  |  |  |  | 219 |  |  | 19 | 4,000,051 | 200.10 | 0 | 1,438 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 27,289,339 | 211 | 81 | 0 | 0 | 99 | 34 | 33 | 45 | 19 | 0 | 30 | 18 | 11 | 2 | 8 | 82 | 99 | 0 | 2 | 18 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,703 | 143 | 46 | 0 | 0 | 69 | 25 | 24 | 28 | 15 | 0 | 27 | 18 | 8 | 1 | 6 | 46 | 69 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 119 | 32 | 0 | 0 | 60 | 22 | 22 | 24 | 13 | 0 | 26 | 19 | 7 | 1 | 5 | 32 | 60 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 102,581,158 | 376 | 169 | 0 | 0 | 160 | 71 | 70 | 46 | 42 | 0 | 46 | 28 | 18 | 8 | 9 | 169 | 160 | 0 | 5 | 42 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 62,648,816 | 216 | 51 | 0 | 0 | 133 | 34 | 33 | 17 | 82 | 0 | 32 | 20 | 11 | 5 | 5 | 51 | 133 | 0 | 3 | 81 | 0 | 0 | 
| app_proof | prover | 1 | 62,602,932 | 212 | 50 | 0 | 0 | 128 | 29 | 29 | 16 | 82 | 0 | 34 | 23 | 10 | 5 | 5 | 50 | 128 | 0 | 3 | 81 | 0 | 0 | 
| app_proof | prover | 2 | 62,602,932 | 205 | 50 | 0 | 0 | 124 | 27 | 27 | 16 | 80 | 0 | 29 | 19 | 10 | 5 | 5 | 51 | 124 | 0 | 3 | 79 | 0 | 0 | 
| app_proof | prover | 3 | 9,072,096 | 71 | 15 | 0 | 0 | 33 | 9 | 8 | 7 | 17 | 0 | 22 | 18 | 3 | 0 | 2 | 15 | 33 | 0 | 2 | 16 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 68 | 469 | 68 | 135 | 0 | 3 | 48 | 1,310,000 | 41.82 | 
| app_proof | 1 | 65 | 363 | 65 | 40 | 0 | 1 | 44 | 1,310,000 | 41.75 | 
| app_proof | 2 | 69 | 360 | 69 | 40 | 0 | 1 | 44 | 1,310,000 | 41.70 | 
| app_proof | 3 | 103 | 219 | 103 | 40 | 0 | 1 | 4 | 70,051 | 41.52 | 

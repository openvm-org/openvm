...
| `total_proof_time_ms ` |  349.50 |  1,398 |  463 |  218 |
| `execute_metered_time_ms` |  19 | -          | -          | -          |
| `execute_metered_insns` |  4,000,051 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  200.88 | -          |  200.88 |  200.88 |
| `execute_preflight_insns` |  1,000,012.75 |  4,000,051 |  1,310,000 |  70,051 |
| `execute_preflight_time_ms` |  34.75 |  139 |  48 |  4 |
| `execute_preflight_insn_mi/s` |  43.41 | -          |  43.68 |  43.13 |
| `trace_gen_time_ms   ` |  75.25 |  301 |  102 |  64 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  173.75 |  695 |  211 |  71 |
| `prover.main_trace_commit_time_ms` |  41 |  164 |  50 |  15 |
| `prover.rap_constraints_time_ms` |  103 |  412 |  130 |  33 |
| `prover.openings_time_ms` |  28.50 |  114 |  33 |  22 |
| `prover.rap_constraints.logup_gkr_time_ms` |  64 |  256 |  81 |  16 |
| `prover.rap_constraints.round0_time_ms` |  24 |  96 |  32 |  9 |
...
| `prover.openings.whir_time_ms` |  19.50 |  78 |  23 |  18 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/d642709f3ab403a9c841dca6adb2fc0cf2c8f13d/fibonacci-d642709f3ab403a9c841dca6adb2fc0cf2c8f13d.memory.svg)
...
| app_proof |  |  |  |  |  | 218 |  |  | 19 | 4,000,051 | 200.88 | 0 | 1,425 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 27,289,339 | 207 | 81 | 0 | 0 | 96 | 31 | 31 | 45 | 19 | 0 | 28 | 17 | 11 | 2 | 8 | 82 | 96 | 0 | 2 | 18 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,703 | 143 | 45 | 0 | 0 | 67 | 25 | 24 | 28 | 14 | 0 | 29 | 21 | 8 | 1 | 6 | 45 | 67 | 0 | 2 | 12 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 121 | 31 | 0 | 0 | 61 | 23 | 23 | 24 | 13 | 0 | 28 | 20 | 7 | 1 | 5 | 31 | 61 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 102,581,158 | 373 | 167 | 0 | 0 | 159 | 70 | 69 | 46 | 43 | 0 | 46 | 28 | 18 | 8 | 9 | 167 | 159 | 0 | 5 | 42 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 62,648,816 | 211 | 49 | 0 | 0 | 130 | 32 | 32 | 16 | 81 | 0 | 30 | 19 | 11 | 5 | 5 | 49 | 130 | 0 | 3 | 80 | 0 | 0 | 
| app_proof | prover | 1 | 62,602,932 | 209 | 50 | 0 | 0 | 125 | 28 | 28 | 16 | 80 | 0 | 33 | 23 | 10 | 5 | 5 | 50 | 125 | 0 | 3 | 79 | 0 | 0 | 
| app_proof | prover | 2 | 62,602,932 | 204 | 50 | 0 | 0 | 124 | 27 | 27 | 16 | 79 | 0 | 29 | 18 | 10 | 5 | 4 | 50 | 124 | 0 | 3 | 78 | 0 | 0 | 
| app_proof | prover | 3 | 9,072,096 | 71 | 15 | 0 | 0 | 33 | 9 | 8 | 7 | 16 | 0 | 22 | 18 | 3 | 0 | 2 | 15 | 33 | 0 | 2 | 16 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 66 | 463 | 66 | 136 | 0 | 3 | 48 | 1,310,000 | 43.37 | 
| app_proof | 1 | 64 | 359 | 64 | 40 | 0 | 1 | 44 | 1,310,000 | 43.46 | 
| app_proof | 2 | 69 | 358 | 69 | 40 | 0 | 1 | 43 | 1,310,000 | 43.68 | 
| app_proof | 3 | 102 | 218 | 102 | 40 | 0 | 1 | 4 | 70,051 | 43.13 | 

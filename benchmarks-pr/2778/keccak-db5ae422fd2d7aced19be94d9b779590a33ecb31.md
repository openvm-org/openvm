...
|:---|---:|---:|---:|
| Total |  17.44 |  5.16 |  5.16 |
| app_proof |  14.13 |  2.65 |  2.65 |
| leaf |  2.44 |  1.64 |  1.64 |
...
| `total_proof_time_ms ` |  2,332 |  13,992 |  2,507 |  2,258 |
| `execute_metered_time_ms` |  139 | -          | -          | -          |
| `execute_metered_insns` |  14,365,133 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  102.92 | -          |  102.92 |  102.92 |
| `execute_preflight_insns` |  2,394,188.83 |  14,365,133 |  2,413,000 |  2,300,133 |
| `execute_preflight_time_ms` |  242.83 |  1,457 |  334 |  90 |
| `execute_preflight_insn_mi/s` |  32.46 | -          |  33.30 |  29.77 |
| `trace_gen_time_ms   ` |  36.33 |  218 |  52 |  33 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,995 |  11,970 |  2,229 |  1,941 |
| `prover.main_trace_commit_time_ms` |  704 |  4,224 |  864 |  669 |
| `prover.rap_constraints_time_ms` |  1,100.83 |  6,605 |  1,184 |  1,074 |
| `prover.openings_time_ms` |  188.83 |  1,133 |  196 |  180 |
| `prover.rap_constraints.logup_gkr_time_ms` |  263 |  1,578 |  326 |  249 |
| `prover.rap_constraints.round0_time_ms` |  520.33 |  3,122 |  524 |  518 |
| `prover.rap_constraints.mle_rounds_time_ms` |  316.33 |  1,898 |  337 |  306 |
| `prover.openings.stacked_reduction_time_ms` |  146.17 |  877 |  149 |  142 |
| `prover.openings.stacked_reduction.round0_time_ms` |  83.67 |  502 |  85 |  82 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  62 |  372 |  64 |  60 |
| `prover.openings.whir_time_ms` |  42.33 |  254 |  47 |  38 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,217.50 |  2,435 |  1,642 |  793 |
| `execute_preflight_time_ms` |  5.50 |  11 |  6 |  5 |
| `trace_gen_time_ms   ` |  135.50 |  271 |  182 |  89 |
| `generate_blob_total_time_ms` |  24 |  48 |  32 |  16 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,082 |  2,164 |  1,460 |  704 |
| `prover.main_trace_commit_time_ms` |  644.50 |  1,289 |  909 |  380 |
| `prover.rap_constraints_time_ms` |  331 |  662 |  425 |  237 |
| `prover.openings_time_ms` |  105.50 |  211 |  125 |  86 |
| `prover.rap_constraints.logup_gkr_time_ms` |  74 |  148 |  92 |  56 |
| `prover.rap_constraints.round0_time_ms` |  158.50 |  317 |  206 |  111 |
| `prover.rap_constraints.mle_rounds_time_ms` |  97.50 |  195 |  126 |  69 |
...
| `prover.openings.whir_time_ms` |  35.50 |  71 |  38 |  33 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/db5ae422fd2d7aced19be94d9b779590a33ecb31/keccak-db5ae422fd2d7aced19be94d9b779590a33ecb31.memory.svg)
...
| frac_sumcheck.gkr_rounds | 12.28 | app_proof.prover.0 |
| prover.batch_constraints.before_round0 | 12.28 | app_proof.prover.0 |
| prover.gkr_input_evals | 12.06 | app_proof.prover.0 |
| frac_sumcheck.segment_tree | 12.06 | app_proof.prover.0 |
...
| 17 | VmAirWrapper<Rv64BranchAdapterAir, BranchLessThanCoreAir<4, 16> | 20 | 25 | 3 | 
| 18 | VmAirWrapper<Rv64BranchAdapterAir, BranchEqualCoreAir<4, 16> | 19 | 11 | 3 | 
...
| 23 | VmAirWrapper<Rv64BaseAluAdapterU16Air, LessThanCoreAir<4, 16> | 25 | 30 | 3 | 
...
| app_proof |  |  |  |  |  | 2,258 |  |  | 139 | 14,365,133 | 102.92 | 0 | 14,139 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 39 | 524 | 39 | 13 | 4 | 2 | 2 | 2 | 
| internal_recursive.0 | 1 | 14 | 188 | 13 | 2 | 1 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 9 | 158 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 182 | 1,642 | 181 | 64 | 32 | 6 | 7 | 7 | 
| leaf | 1 | 89 | 793 | 89 | 32 | 16 | 5 | 7 | 7 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 81,415,028 |
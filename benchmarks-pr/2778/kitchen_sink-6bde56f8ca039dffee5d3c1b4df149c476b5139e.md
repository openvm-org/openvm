...
|:---|---:|---:|---:|
| Total |  2.79 |  2.04 |  2.04 |
| app_proof |  1.98 |  1.23 |  1.23 |
| leaf |  0.43 |  0.43 |  0.43 |
...
| `total_proof_time_ms ` |  977.50 |  1,955 |  1,210 |  745 |
| `execute_metered_time_ms` |  23 | -          | -          | -          |
| `execute_metered_insns` |  1,979,971 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  84.47 | -          |  84.47 |  84.47 |
| `execute_preflight_insns` |  989,985.50 |  1,979,971 |  1,168,000 |  811,971 |
| `execute_preflight_time_ms` |  97.50 |  195 |  137 |  58 |
| `execute_preflight_insn_mi/s` |  31.74 | -          |  32.25 |  31.24 |
| `trace_gen_time_ms   ` |  24 |  48 |  33 |  15 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  765.50 |  1,531 |  980 |  551 |
| `prover.main_trace_commit_time_ms` |  213.50 |  427 |  281 |  146 |
| `prover.rap_constraints_time_ms` |  488.50 |  977 |  624 |  353 |
| `prover.openings_time_ms` |  63 |  126 |  75 |  51 |
| `prover.rap_constraints.logup_gkr_time_ms` |  109 |  218 |  153 |  65 |
| `prover.rap_constraints.round0_time_ms` |  277.50 |  555 |  343 |  212 |
| `prover.rap_constraints.mle_rounds_time_ms` |  101 |  202 |  127 |  75 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/6bde56f8ca039dffee5d3c1b4df149c476b5139e/kitchen_sink-6bde56f8ca039dffee5d3c1b4df149c476b5139e.memory.svg)
...
| frac_sumcheck.gkr_rounds | 8.71 | app_proof.prover.0 |
| prover.batch_constraints.before_round0 | 8.71 | app_proof.prover.0 |
| prover.gkr_input_evals | 8.62 | app_proof.prover.0 |
| frac_sumcheck.segment_tree | 8.62 | app_proof.prover.0 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 72 | 3 |  |  | 0 |  | 346 | 3 |  |  |  |  |  |  | 
| app_proof |  |  |  |  |  | 745 |  |  | 23 | 1,979,971 | 84.47 | 0 | 1,982 |  | 
| internal_for_leaf |  |  |  | 162 |  |  |  |  |  |  |  |  |  | 162 | 
| internal_recursive.0 |  |  |  | 112 |  |  |  |  |  |  |  |  |  | 113 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,577,915 | 143 | 41 | 0 | 4 | 67 | 22 | 21 | 29 | 16 | 0 | 33 | 9 | 23 | 1 | 21 | 41 | 67 | 0 | 1 | 15 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,703 | 102 | 19 | 0 | 4 | 52 | 17 | 17 | 20 | 14 | 0 | 30 | 8 | 21 | 1 | 20 | 19 | 52 | 0 | 1 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 100 | 14 | 0 | 4 | 54 | 21 | 20 | 18 | 14 | 0 | 31 | 9 | 21 | 0 | 20 | 15 | 54 | 0 | 1 | 13 | 0 | 0 | 
| leaf | 0 | prover | 261,140,340 | 317 | 129 | 0 | 10 | 144 | 48 | 47 | 37 | 58 | 0 | 43 | 11 | 31 | 7 | 24 | 130 | 144 | 0 | 2 | 57 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 555,262,116 | 980 | 280 | 0 | 152 | 624 | 343 | 341 | 127 | 153 | 56 | 75 | 13 | 62 | 15 | 46 | 281 | 624 | 0 | 1 | 96 | 0 | 0 | 
| app_proof | prover | 1 | 533,498,636 | 551 | 146 | 0 | 22 | 353 | 212 | 211 | 75 | 65 | 0 | 51 | 12 | 38 | 14 | 24 | 146 | 353 | 0 | 1 | 64 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 33 | 1,210 | 33 | 137 | 0 | 3 | 58 | 1,168,000 | 31.24 | 
| app_proof | 1 | 15 | 745 | 15 | 40 | 0 | 1 | 137 | 811,971 | 32.25 | 

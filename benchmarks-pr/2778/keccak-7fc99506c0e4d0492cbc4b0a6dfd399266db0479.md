...
| `total_proof_time_ms ` |  2,203.17 |  13,219 |  2,375 |  2,133 |
| `execute_metered_time_ms` |  139 | -          | -          | -          |
| `execute_metered_insns` |  14,365,133 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  103.06 | -          |  103.06 |  103.06 |
| `execute_preflight_insns` |  2,394,188.83 |  14,365,133 |  2,413,000 |  2,300,133 |
| `execute_preflight_time_ms` |  236.17 |  1,417 |  314 |  86 |
| `execute_preflight_insn_mi/s` |  33.84 | -          |  34.70 |  30.91 |
| `trace_gen_time_ms   ` |  36.50 |  219 |  54 |  33 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,872.67 |  11,236 |  2,098 |  1,819 |
| `prover.main_trace_commit_time_ms` |  691.83 |  4,151 |  848 |  659 |
| `prover.rap_constraints_time_ms` |  1,000.83 |  6,005 |  1,061 |  979 |
| `prover.openings_time_ms` |  179 |  1,074 |  188 |  173 |
| `prover.rap_constraints.logup_gkr_time_ms` |  171 |  1,026 |  221 |  160 |
| `prover.rap_constraints.round0_time_ms` |  517.33 |  3,104 |  524 |  504 |
| `prover.rap_constraints.mle_rounds_time_ms` |  311.33 |  1,868 |  336 |  300 |
| `prover.openings.stacked_reduction_time_ms` |  132.83 |  797 |  134 |  132 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,090.50 |  2,181 |  1,421 |  760 |
| `execute_preflight_time_ms` |  5.50 |  11 |  6 |  5 |
| `trace_gen_time_ms   ` |  133 |  266 |  177 |  89 |
| `generate_blob_total_time_ms` |  24 |  48 |  32 |  16 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  957.50 |  1,915 |  1,244 |  671 |
| `prover.main_trace_commit_time_ms` |  545 |  1,090 |  720 |  370 |
...
| `prover.openings.whir_time_ms` |  41.50 |  83 |  49 |  34 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/7fc99506c0e4d0492cbc4b0a6dfd399266db0479/keccak-7fc99506c0e4d0492cbc4b0a6dfd399266db0479.memory.svg)
...
| app_proof |  |  |  |  |  | 2,133 |  |  | 139 | 14,365,133 | 103.06 | 0 | 13,365 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 41 | 499 | 41 | 13 | 4 | 2 | 2 | 2 | 
| internal_recursive.0 | 1 | 13 | 162 | 13 | 2 | 1 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 9 | 127 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 177 | 1,421 | 177 | 63 | 32 | 6 | 7 | 7 | 
| leaf | 1 | 89 | 760 | 88 | 32 | 16 | 5 | 7 | 7 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 81,415,028 | 458 | 242 | 0 | 1 | 171 | 48 | 48 | 92 | 30 | 0 | 44 | 20 | 23 | 7 | 15 | 242 | 171 | 0 | 3 | 29 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,879 | 148 | 49 | 0 | 0 | 72 | 24 | 24 | 29 | 17 | 0 | 26 | 18 | 8 | 1 | 6 | 49 | 71 | 0 | 2 | 16 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 118 | 31 | 0 | 0 | 61 | 23 | 22 | 24 | 13 | 0 | 24 | 17 | 7 | 1 | 5 | 31 | 61 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 474,940,262 | 1,244 | 720 | 0 | 2 | 403 | 200 | 199 | 117 | 85 | 0 | 119 | 49 | 70 | 40 | 30 | 720 | 403 | 0 | 7 | 84 | 0 | 0 | 
| leaf | 1 | prover | 239,436,532 | 671 | 370 | 0 | 1 | 228 | 109 | 108 | 67 | 51 | 0 | 71 | 34 | 37 | 20 | 17 | 370 | 228 | 0 | 6 | 49 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 840,431,244 | 2,098 | 848 | 0 | 193 | 1,061 | 504 | 503 | 336 | 221 | 69 | 188 | 53 | 134 | 83 | 51 | 848 | 1,061 | 0 | 3 | 151 | 0 | 0 | 
| app_proof | prover | 1 | 840,431,244 | 1,842 | 660 | 0 | 3 | 1,007 | 517 | 517 | 329 | 160 | 0 | 173 | 41 | 132 | 80 | 51 | 660 | 1,007 | 0 | 3 | 159 | 0 | 0 | 
| app_proof | prover | 2 | 840,431,244 | 1,819 | 659 | 0 | 3 | 979 | 517 | 516 | 301 | 160 | 0 | 181 | 47 | 133 | 81 | 51 | 659 | 979 | 0 | 4 | 159 | 0 | 0 | 
| app_proof | prover | 3 | 840,431,244 | 1,819 | 661 | 0 | 3 | 983 | 520 | 520 | 301 | 161 | 0 | 174 | 41 | 132 | 82 | 50 | 661 | 983 | 0 | 4 | 159 | 0 | 0 | 
| app_proof | prover | 4 | 840,431,244 | 1,829 | 662 | 0 | 3 | 987 | 524 | 524 | 300 | 161 | 0 | 179 | 46 | 133 | 81 | 51 | 662 | 987 | 0 | 3 | 160 | 0 | 0 | 
| app_proof | prover | 5 | 840,431,244 | 1,829 | 661 | 0 | 3 | 988 | 522 | 522 | 301 | 163 | 0 | 179 | 45 | 133 | 81 | 51 | 661 | 988 | 0 | 3 | 161 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 54 | 2,375 | 54 | 135 | 0 | 3 | 86 | 2,413,000 | 30.91 | 
| app_proof | 1 | 33 | 2,231 | 33 | 41 | 0 | 1 | 314 | 2,413,000 | 34.40 | 
| app_proof | 2 | 33 | 2,157 | 33 | 41 | 0 | 1 | 262 | 2,413,000 | 34.38 | 
| app_proof | 3 | 33 | 2,157 | 33 | 41 | 0 | 1 | 263 | 2,413,000 | 34.34 | 
| app_proof | 4 | 33 | 2,166 | 33 | 41 | 0 | 1 | 262 | 2,413,000 | 34.70 | 
| app_proof | 5 | 33 | 2,133 | 33 | 41 | 0 | 1 | 230 | 2,300,133 | 34.35 | 

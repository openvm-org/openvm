...
|:---|---:|---:|---:|
| Total |  11.19 |  4.60 |  4.60 |
| app_proof |  9.10 |  2.50 |  2.50 |
| leaf |  1.41 |  1.41 |  1.41 |
...
| `total_proof_time_ms ` |  2,251.50 |  9,006 |  2,412 |  2,176 |
| `execute_metered_time_ms` |  93 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  119.40 | -          |  119.40 |  119.40 |
| `execute_preflight_insns` |  2,791,990.25 |  11,167,961 |  2,851,000 |  2,614,961 |
| `execute_preflight_time_ms` |  164.50 |  658 |  204 |  96 |
| `execute_preflight_insn_mi/s` |  36.48 | -          |  37.55 |  33.62 |
| `trace_gen_time_ms   ` |  59.25 |  237 |  69 |  54 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,963 |  7,852 |  2,112 |  1,905 |
| `prover.main_trace_commit_time_ms` |  536 |  2,144 |  621 |  507 |
| `prover.rap_constraints_time_ms` |  1,290.50 |  5,162 |  1,353 |  1,260 |
| `prover.openings_time_ms` |  135.50 |  542 |  137 |  133 |
| `prover.rap_constraints.logup_gkr_time_ms` |  320 |  1,280 |  388 |  291 |
| `prover.rap_constraints.round0_time_ms` |  669 |  2,676 |  673 |  660 |
| `prover.rap_constraints.mle_rounds_time_ms` |  300.75 |  1,203 |  304 |  299 |
| `prover.openings.stacked_reduction_time_ms` |  97.50 |  390 |  98 |  97 |
| `prover.openings.stacked_reduction.round0_time_ms` |  58.75 |  235 |  59 |  58 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/0c7dbcd17c57bc6543a51a290609e8d974c23f6b/sha2_bench-0c7dbcd17c57bc6543a51a290609e8d974c23f6b.memory.svg)
...
| app_proof |  |  |  |  |  | 2,176 |  |  | 93 | 11,167,961 | 119.40 | 0 | 9,107 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 61,220,603 | 356 | 184 | 0 | 0 | 132 | 37 | 37 | 66 | 27 | 0 | 39 | 20 | 18 | 5 | 13 | 185 | 131 | 0 | 3 | 26 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,879 | 149 | 47 | 0 | 0 | 72 | 24 | 24 | 29 | 17 | 0 | 28 | 19 | 8 | 1 | 6 | 48 | 72 | 0 | 2 | 17 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 125 | 31 | 0 | 0 | 61 | 23 | 22 | 24 | 13 | 0 | 31 | 24 | 7 | 1 | 5 | 32 | 61 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 424,379,238 | 1,259 | 801 | 0 | 157 | 351 | 171 | 170 | 104 | 75 | 0 | 105 | 40 | 64 | 36 | 28 | 801 | 351 | 0 | 7 | 74 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 639,992,057 | 2,112 | 621 | 0 | 116 | 1,353 | 660 | 660 | 304 | 388 | 104 | 136 | 38 | 98 | 59 | 39 | 621 | 1,353 | 0 | 3 | 283 | 0 | 0 | 
| app_proof | prover | 1 | 639,991,820 | 1,920 | 506 | 0 | 2 | 1,275 | 673 | 672 | 300 | 301 | 0 | 137 | 39 | 97 | 59 | 38 | 507 | 1,275 | 0 | 3 | 300 | 0 | 0 | 
| app_proof | prover | 2 | 639,991,820 | 1,915 | 507 | 0 | 2 | 1,274 | 673 | 672 | 300 | 300 | 0 | 133 | 36 | 97 | 58 | 38 | 508 | 1,274 | 0 | 3 | 299 | 0 | 0 | 
| app_proof | prover | 3 | 639,992,052 | 1,905 | 507 | 0 | 2 | 1,260 | 670 | 669 | 299 | 291 | 0 | 136 | 37 | 98 | 59 | 38 | 508 | 1,260 | 0 | 3 | 290 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 69 | 2,412 | 69 | 134 | 0 | 3 | 96 | 2,851,000 | 33.62 | 
| app_proof | 1 | 57 | 2,222 | 57 | 41 | 0 | 1 | 204 | 2,851,000 | 37.55 | 
| app_proof | 2 | 57 | 2,196 | 57 | 41 | 0 | 1 | 182 | 2,851,000 | 37.41 | 
| app_proof | 3 | 54 | 2,176 | 54 | 41 | 0 | 1 | 176 | 2,614,961 | 37.34 | 

...
|:---|---:|---:|---:|
| Total |  2.95 |  2.34 |  2.34 |
| app_proof |  2.23 |  1.63 |  1.63 |
| leaf |  0.41 |  0.41 |  0.41 |
...
| `total_proof_time_ms ` |  1,104.50 |  2,209 |  1,604 |  605 |
| `execute_metered_time_ms` |  23 | -          | -          | -          |
| `execute_metered_insns` |  1,979,971 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  83.79 | -          |  83.79 |  83.79 |
| `execute_preflight_insns` |  989,985.50 |  1,979,971 |  1,266,000 |  713,971 |
| `execute_preflight_time_ms` |  87.50 |  175 |  117 |  58 |
| `execute_preflight_insn_mi/s` |  33.05 | -          |  33.62 |  32.48 |
| `trace_gen_time_ms   ` |  27.50 |  55 |  42 |  13 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  900 |  1,800 |  1,367 |  433 |
| `prover.main_trace_commit_time_ms` |  297.50 |  595 |  479 |  116 |
| `prover.rap_constraints_time_ms` |  549.50 |  1,099 |  819 |  280 |
| `prover.openings_time_ms` |  52 |  104 |  68 |  36 |
| `prover.rap_constraints.logup_gkr_time_ms` |  73 |  146 |  111 |  35 |
| `prover.rap_constraints.round0_time_ms` |  335 |  670 |  490 |  180 |
| `prover.rap_constraints.mle_rounds_time_ms` |  141 |  282 |  217 |  65 |
| `prover.openings.stacked_reduction_time_ms` |  37.50 |  75 |  51 |  24 |
| `prover.openings.stacked_reduction.round0_time_ms` |  18 |  36 |  24 |  12 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  18.50 |  37 |  26 |  11 |
| `prover.openings.whir_time_ms` |  14 |  28 |  17 |  11 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/7fc99506c0e4d0492cbc4b0a6dfd399266db0479/kitchen_sink-7fc99506c0e4d0492cbc4b0a6dfd399266db0479.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 73 | 3 |  |  | 0 |  | 343 | 3 |  |  |  |  |  |  | 
| app_proof |  |  |  |  |  | 605 |  |  | 23 | 1,979,971 | 83.79 | 0 | 2,237 |  | 
...
| internal_recursive.0 | 1 | 10 | 91 | 9 | 1 | 0 | 2 | 0 | 1 | 
| internal_recursive.1 | 1 | 8 | 80 | 8 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 114 | 408 | 114 | 28 | 13 | 18 | 4 | 4 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,577,915 | 117 | 38 | 0 | 0 | 62 | 20 | 19 | 29 | 12 | 0 | 16 | 8 | 8 | 1 | 6 | 38 | 62 | 0 | 1 | 11 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,703 | 80 | 16 | 0 | 0 | 48 | 17 | 16 | 20 | 10 | 0 | 15 | 9 | 5 | 1 | 4 | 16 | 48 | 0 | 1 | 9 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 71 | 11 | 0 | 0 | 46 | 17 | 16 | 18 | 10 | 0 | 13 | 7 | 5 | 0 | 4 | 11 | 46 | 0 | 1 | 9 | 0 | 0 | 
| leaf | 0 | prover | 260,616,052 | 294 | 127 | 0 | 1 | 137 | 48 | 47 | 36 | 52 | 0 | 28 | 13 | 15 | 7 | 8 | 127 | 137 | 0 | 2 | 51 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 898,719,612 | 1,367 | 478 | 0 | 271 | 819 | 490 | 488 | 217 | 111 | 52 | 68 | 17 | 51 | 24 | 26 | 479 | 819 | 0 | 1 | 59 | 0 | 0 | 
| app_proof | prover | 1 | 455,842,444 | 433 | 116 | 0 | 1 | 280 | 180 | 179 | 65 | 35 | 0 | 36 | 11 | 24 | 12 | 11 | 116 | 280 | 0 | 1 | 34 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 42 | 1,604 | 42 | 135 | 0 | 3 | 58 | 1,266,000 | 32.48 | 
| app_proof | 1 | 13 | 605 | 13 | 40 | 0 | 1 | 117 | 713,971 | 33.62 | 

...
|:---|---:|---:|---:|
| Total |  16.45 |  4.76 |  4.76 |
| app_proof |  13.45 |  2.53 |  2.53 |
| leaf |  2.20 |  1.43 |  1.43 |
...
| `total_proof_time_ms ` |  2,219.17 |  13,315 |  2,392 |  2,148 |
| `execute_metered_time_ms` |  138 | -          | -          | -          |
| `execute_metered_insns` |  14,365,133 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  103.48 | -          |  103.48 |  103.48 |
| `execute_preflight_insns` |  2,394,188.83 |  14,365,133 |  2,413,000 |  2,300,133 |
| `execute_preflight_time_ms` |  233.67 |  1,402 |  313 |  84 |
| `execute_preflight_insn_mi/s` |  35.20 | -          |  36.24 |  31.80 |
| `trace_gen_time_ms   ` |  37.17 |  223 |  57 |  33 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,890.17 |  11,341 |  2,115 |  1,836 |
| `prover.main_trace_commit_time_ms` |  699 |  4,194 |  858 |  666 |
| `prover.rap_constraints_time_ms` |  1,010.50 |  6,063 |  1,077 |  989 |
| `prover.openings_time_ms` |  179.33 |  1,076 |  182 |  178 |
| `prover.rap_constraints.logup_gkr_time_ms` |  172.83 |  1,037 |  223 |  162 |
| `prover.rap_constraints.round0_time_ms` |  520.83 |  3,125 |  528 |  516 |
| `prover.rap_constraints.mle_rounds_time_ms` |  316 |  1,896 |  337 |  306 |
| `prover.openings.stacked_reduction_time_ms` |  135.17 |  811 |  136 |  134 |
| `prover.openings.stacked_reduction.round0_time_ms` |  82.83 |  497 |  84 |  82 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  52 |  312 |  52 |  52 |
| `prover.openings.whir_time_ms` |  43.67 |  262 |  46 |  42 |
...
| `trace_gen_time_ms   ` |  134.50 |  269 |  179 |  90 |
| `generate_blob_total_time_ms` |  24 |  48 |  32 |  16 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  965.50 |  1,931 |  1,251 |  680 |
| `prover.main_trace_commit_time_ms` |  550.50 |  1,101 |  727 |  374 |
| `prover.rap_constraints_time_ms` |  320.50 |  641 |  411 |  230 |
| `prover.openings_time_ms` |  93.50 |  187 |  112 |  75 |
...
| `prover.openings.whir_time_ms` |  39 |  78 |  41 |  37 |

| internal_for_leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  506 |  506 |  506 |  506 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/0d37807f81ca10c7aa550cd241eac41abde64fd6/keccak-0d37807f81ca10c7aa550cd241eac41abde64fd6.memory.svg)

| Module | Max (GB) | Max At |
| --- | ---: | --- |
| prover.rap_constraints | 14.24 | app_proof.prover.0 |
...
| prover.batch_constraints.before_round0 | 11.81 | app_proof.prover.0 |
| frac_sumcheck.gkr_rounds | 11.81 | app_proof.prover.0 |
| prover.gkr_input_evals | 11.80 | app_proof.prover.0 |
| frac_sumcheck.segment_tree | 11.80 | app_proof.prover.0 |
| prover.batch_constraints.round0 | 11.53 | app_proof.prover.0 |
| prover.batch_constraints.fold_ple_evals | 11.53 | app_proof.prover.0 |
| prover.before_gkr_input_evals | 9.78 | app_proof.prover.0 |
| prover.stacked_commit | 9.78 | app_proof.prover.0 |
...
| app_proof |  |  |  |  |  | 2,148 |  |  | 138 | 14,365,133 | 103.48 | 0 | 13,460 |  | 
| internal_for_leaf |  |  |  | 506 |  |  |  |  |  |  |  |  |  | 506 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 41 | 506 | 40 | 13 | 4 | 2 | 2 | 2 | 
| internal_recursive.0 | 1 | 14 | 162 | 13 | 2 | 1 | 2 | 2 | 2 | 
| internal_recursive.1 | 1 | 9 | 133 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 179 | 1,430 | 178 | 64 | 32 | 6 | 7 | 7 | 
| leaf | 1 | 90 | 771 | 90 | 32 | 16 | 5 | 7 | 7 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 81,415,028 |
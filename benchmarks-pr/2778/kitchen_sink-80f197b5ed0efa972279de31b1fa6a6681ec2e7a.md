...
| `total_proof_time_ms ` |  1,098.50 |  2,197 |  1,595 |  602 |
| `execute_metered_time_ms` |  23 | -          | -          | -          |
| `execute_metered_insns` |  1,979,971 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  83.72 | -          |  83.72 |  83.72 |
| `execute_preflight_insns` |  989,985.50 |  1,979,971 |  1,266,000 |  713,971 |
| `execute_preflight_time_ms` |  85 |  170 |  112 |  58 |
| `execute_preflight_insn_mi/s` |  33.29 | -          |  34.03 |  32.54 |
| `trace_gen_time_ms   ` |  27.50 |  55 |  42 |  13 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  896 |  1,792 |  1,358 |  434 |
| `prover.main_trace_commit_time_ms` |  294.50 |  589 |  472 |  117 |
| `prover.rap_constraints_time_ms` |  549 |  1,098 |  817 |  281 |
| `prover.openings_time_ms` |  52 |  104 |  68 |  36 |
| `prover.rap_constraints.logup_gkr_time_ms` |  73.50 |  147 |  111 |  36 |
| `prover.rap_constraints.round0_time_ms` |  333.50 |  667 |  487 |  180 |
| `prover.rap_constraints.mle_rounds_time_ms` |  141.50 |  283 |  218 |  65 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  406 |  406 |  406 |  406 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/80f197b5ed0efa972279de31b1fa6a6681ec2e7a/kitchen_sink-80f197b5ed0efa972279de31b1fa6a6681ec2e7a.memory.svg)
...
| app_proof |  |  |  |  |  | 602 |  |  | 23 | 1,979,971 | 83.72 | 0 | 2,225 |  | 
...
| leaf | 0 | 112 | 406 | 112 | 27 | 13 | 18 | 3 | 3 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,577,915 | 120 | 38 | 0 | 0 | 63 | 22 | 21 | 29 | 12 | 0 | 18 | 10 | 7 | 1 | 6 | 38 | 63 | 0 | 1 | 11 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,703 | 79 | 16 | 0 | 0 | 47 | 17 | 16 | 20 | 9 | 0 | 15 | 9 | 5 | 1 | 4 | 16 | 47 | 0 | 1 | 9 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 74 | 11 | 0 | 0 | 48 | 19 | 18 | 18 | 10 | 0 | 13 | 8 | 5 | 0 | 4 | 11 | 48 | 0 | 1 | 9 | 0 | 0 | 
| leaf | 0 | prover | 260,616,052 | 293 | 127 | 0 | 1 | 137 | 48 | 46 | 37 | 52 | 0 | 27 | 12 | 15 | 7 | 8 | 127 | 137 | 0 | 2 | 51 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 898,719,612 | 1,358 | 471 | 0 | 266 | 817 | 487 | 485 | 218 | 111 | 51 | 68 | 17 | 51 | 24 | 27 | 472 | 817 | 0 | 1 | 60 | 0 | 0 | 
| app_proof | prover | 1 | 455,842,444 | 434 | 117 | 0 | 1 | 281 | 180 | 179 | 65 | 36 | 0 | 36 | 11 | 24 | 12 | 11 | 117 | 281 | 0 | 1 | 35 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 42 | 1,595 | 42 | 135 | 0 | 3 | 58 | 1,266,000 | 32.54 | 
| app_proof | 1 | 13 | 602 | 13 | 40 | 0 | 1 | 112 | 713,971 | 34.03 | 

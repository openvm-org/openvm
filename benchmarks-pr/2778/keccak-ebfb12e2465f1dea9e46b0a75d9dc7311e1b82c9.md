...
|:---|---:|---:|---:|
| Total |  16.36 |  4.73 |  4.73 |
| app_proof |  13.38 |  2.52 |  2.52 |
| leaf |  2.19 |  1.42 |  1.42 |
...
| `total_proof_time_ms ` |  2,206.17 |  13,237 |  2,379 |  2,132 |
| `execute_metered_time_ms` |  138 | -          | -          | -          |
| `execute_metered_insns` |  14,365,133 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  103.43 | -          |  103.43 |  103.43 |
| `execute_preflight_insns` |  2,394,188.83 |  14,365,133 |  2,413,000 |  2,300,133 |
| `execute_preflight_time_ms` |  231.50 |  1,389 |  311 |  82 |
| `execute_preflight_insn_mi/s` |  35.45 | -          |  36.47 |  32.62 |
| `trace_gen_time_ms   ` |  37.83 |  227 |  58 |  33 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,879 |  11,274 |  2,100 |  1,826 |
| `prover.main_trace_commit_time_ms` |  696.50 |  4,179 |  853 |  664 |
| `prover.rap_constraints_time_ms` |  1,002.17 |  6,013 |  1,067 |  983 |
| `prover.openings_time_ms` |  178.83 |  1,073 |  183 |  176 |
| `prover.rap_constraints.logup_gkr_time_ms` |  171.83 |  1,031 |  223 |  161 |
| `prover.rap_constraints.round0_time_ms` |  515 |  3,090 |  518 |  508 |
| `prover.rap_constraints.mle_rounds_time_ms` |  314.33 |  1,886 |  335 |  303 |
| `prover.openings.stacked_reduction_time_ms` |  135.17 |  811 |  136 |  134 |
| `prover.openings.stacked_reduction.round0_time_ms` |  82.50 |  495 |  83 |  82 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  52 |  312 |  53 |  51 |
| `prover.openings.whir_time_ms` |  43.17 |  259 |  47 |  41 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,096 |  2,192 |  1,424 |  768 |
| `execute_preflight_time_ms` |  5 |  10 |  5 |  5 |
| `trace_gen_time_ms   ` |  133.50 |  267 |  178 |  89 |
| `generate_blob_total_time_ms` |  24 |  48 |  32 |  16 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  962 |  1,924 |  1,246 |  678 |
| `prover.main_trace_commit_time_ms` |  549 |  1,098 |  724 |  374 |
| `prover.rap_constraints_time_ms` |  317 |  634 |  406 |  228 |
| `prover.openings_time_ms` |  95 |  190 |  115 |  75 |
...
| `prover.openings.whir_time_ms` |  41 |  82 |  44 |  38 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/ebfb12e2465f1dea9e46b0a75d9dc7311e1b82c9/keccak-ebfb12e2465f1dea9e46b0a75d9dc7311e1b82c9.memory.svg)
...
| 23 | VmAirWrapper<Rv64BaseAluAdapterU16Air, LessThanCoreAir<4, 16> | 19 | 30 | 3 | 
...
| app_proof |  |  |  |  |  | 2,132 |  |  | 138 | 14,365,133 | 103.43 | 0 | 13,382 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 38 | 501 | 38 | 13 | 4 | 2 | 2 | 2 | 
| internal_recursive.0 | 1 | 14 | 161 | 14 | 2 | 1 | 2 | 2 | 2 | 
| internal_recursive.1 | 1 | 9 | 129 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 178 | 1,424 | 178 | 64 | 32 | 5 | 7 | 7 | 
| leaf | 1 | 89 | 768 | 89 | 32 | 16 | 5 | 7 | 7 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 81,415,028 | 462 | 244 | 0 | 1 | 173 | 49 | 49 | 92 | 31 | 0 | 44 | 20 | 23 | 8 | 15 | 244 | 173 | 0 | 2 | 30 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,879 |
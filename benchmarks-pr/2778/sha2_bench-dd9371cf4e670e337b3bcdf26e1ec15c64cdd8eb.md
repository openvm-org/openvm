...
|:---|---:|---:|---:|
| Total |  11.16 |  4.60 |  4.60 |
| app_proof |  9.08 |  2.51 |  2.51 |
| leaf |  1.41 |  1.41 |  1.41 |
...
| `total_proof_time_ms ` |  2,246 |  8,984 |  2,420 |  2,161 |
| `execute_metered_time_ms` |  93 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  118.96 | -          |  118.96 |  118.96 |
| `execute_preflight_insns` |  2,791,990.25 |  11,167,961 |  2,851,000 |  2,614,961 |
| `execute_preflight_time_ms` |  159.25 |  637 |  200 |  96 |
| `execute_preflight_insn_mi/s` |  35.80 | -          |  36.80 |  33.27 |
| `trace_gen_time_ms   ` |  59.25 |  237 |  69 |  54 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,961.75 |  7,847 |  2,118 |  1,898 |
| `prover.main_trace_commit_time_ms` |  537 |  2,148 |  624 |  507 |
| `prover.rap_constraints_time_ms` |  1,287 |  5,148 |  1,355 |  1,252 |
| `prover.openings_time_ms` |  136.50 |  546 |  139 |  134 |
| `prover.rap_constraints.logup_gkr_time_ms` |  320.50 |  1,282 |  391 |  291 |
| `prover.rap_constraints.round0_time_ms` |  663 |  2,652 |  669 |  658 |
| `prover.rap_constraints.mle_rounds_time_ms` |  302.50 |  1,210 |  305 |  300 |
| `prover.openings.stacked_reduction_time_ms` |  98.25 |  393 |  100 |  97 |
| `prover.openings.stacked_reduction.round0_time_ms` |  59.50 |  238 |  61 |  58 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  38.25 |  153 |  39 |  38 |
| `prover.openings.whir_time_ms` |  37.50 |  150 |  39 |  36 |
...
| `prover.main_trace_commit_time_ms` |  802 |  802 |  802 |  802 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/dd9371cf4e670e337b3bcdf26e1ec15c64cdd8eb/sha2_bench-dd9371cf4e670e337b3bcdf26e1ec15c64cdd8eb.memory.svg)

| Module | Max (GB) | Max At |
| --- | ---: | --- |
| prover.rap_constraints | 10.92 | app_proof.prover.0 |
| prover.batch_constraints.before_round0 | 10.75 | app_proof.prover.3 |
| frac_sumcheck.gkr_rounds | 10.75 | app_proof.prover.3 |
| frac_sumcheck.segment_tree | 10.65 | app_proof.prover.0 |
| prover.gkr_input_evals | 10.65 | app_proof.prover.0 |
| prover.batch_constraints.round0 | 10.39 | app_proof.prover.0 |
| prover.batch_constraints.fold_ple_evals | 10.39 | app_proof.prover.0 |
| prover.merkle_tree | 9.76 | app_proof.prover.0 |
| prover.prove_whir_opening | 9.76 | app_proof.prover.0 |
| prover.openings | 9.76 | app_proof.prover.0 |
...
| 19 | VmAirWrapper<Rv64BranchAdapterAir, BranchEqualCoreAir<4, 16> | 11 | 11 | 3 | 
...
| app_proof |  |  |  |  |  | 2,161 |  |  | 93 | 11,167,961 | 118.96 | 0 | 9,084 |  | 
...
| leaf | 0 | 146 | 1,410 | 145 | 53 | 25 | 2 | 6 | 6 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 61,220,603 | 356 | 185 | 0 | 0 | 130 | 37 | 37 | 65 | 27 | 0 | 40 | 21 | 18 | 5 | 13 | 186 | 130 | 0 | 3 | 26 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,879 | 151 | 48 | 0 | 0 | 72 | 25 | 24 | 29 | 17 | 0 | 29 | 20 | 8 | 1 | 6 | 49 | 72 | 0 | 2 | 16 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 120 | 31 | 0 | 0 | 62 | 24 | 23 | 24 | 13 | 0 | 25 | 18 | 7 | 1 | 5 | 31 | 62 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 424,379,238 | 1,264 | 802 | 0 | 157 | 353 | 172 | 171 | 103 | 76 | 0 | 108 | 43 | 64 | 36 | 27 | 802 | 353 | 0 | 7 | 75 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 639,992,057 | 2,118 | 624 | 0 | 118 | 1,355 | 658 | 657 | 305 | 391 | 106 | 138 | 37 | 100 | 61 | 39 | 624 | 1,355 | 0 | 4 | 284 | 0 | 0 | 
| app_proof | prover | 1 | 639,991,820 | 1,921 | 506 | 0 | 2 | 1,274 | 669 | 669 | 304 | 300 | 0 | 139 | 39 | 99 | 60 | 38 | 507 | 1,274 | 0 | 4 | 299 | 0 | 0 | 
| app_proof | prover | 2 | 639,991,820 | 1,910 | 508 | 0 | 2 | 1,267 | 665 | 664 | 301 | 300 | 0 | 134 | 36 | 97 | 59 | 38 | 508 | 1,267 | 0 | 3 | 299 | 0 | 0 | 
| app_proof | prover | 3 | 639,992,052 | 1,898 | 509 | 0 | 2 | 1,252 | 660 | 660 | 300 | 291 | 0 | 135 | 38 | 97 | 58 | 38 | 509 | 1,252 | 0 | 3 | 289 | 0 | 0 | 

| group | phase | segment | trace_height_constraint | weighted_sum | threshold |
| --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 0 | 99,639,693 | 2,013,265,921 | 
| app_proof | prover | 1 | 0 | 99,639,562 | 2,013,265,921 | 
| app_proof | prover | 2 | 0 | 99,639,562 | 2,013,265,921 | 
| app_proof | prover | 3 | 0 | 99,639,662 | 2,013,265,921 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 69 | 2,420 | 69 | 135 | 0 | 3 | 96 | 2,851,000 | 33.27 | 
| app_proof | 1 | 57 | 2,220 | 57 | 41 | 0 | 1 | 200 | 2,851,000 | 36.74 | 
| app_proof | 2 | 57 | 2,183 | 57 | 41 | 0 | 1 | 174 | 2,851,000 | 36.80 | 
| app_proof | 3 | 54 | 2,161 | 54 | 41 | 0 | 1 | 167 | 2,614,961 | 36.39 | 

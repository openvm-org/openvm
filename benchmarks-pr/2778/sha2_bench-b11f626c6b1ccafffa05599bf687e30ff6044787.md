...
| `total_proof_time_ms ` |  2,247.25 |  8,989 |  2,419 |  2,163 |
| `execute_metered_time_ms` |  96 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  116.28 | -          |  116.28 |  116.28 |
| `execute_preflight_insns` |  2,791,990.25 |  11,167,961 |  2,851,000 |  2,614,961 |
| `execute_preflight_time_ms` |  163.50 |  654 |  219 |  92 |
| `execute_preflight_insn_mi/s` |  36.98 | -          |  39.48 |  33.68 |
| `trace_gen_time_ms   ` |  60.50 |  242 |  73 |  54 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,958 |  7,832 |  2,118 |  1,899 |
| `prover.main_trace_commit_time_ms` |  535.75 |  2,143 |  624 |  505 |
| `prover.rap_constraints_time_ms` |  1,284.50 |  5,138 |  1,355 |  1,253 |
| `prover.openings_time_ms` |  136.25 |  545 |  138 |  135 |
| `prover.rap_constraints.logup_gkr_time_ms` |  320.75 |  1,283 |  392 |  292 |
| `prover.rap_constraints.round0_time_ms` |  661.75 |  2,647 |  665 |  657 |
| `prover.rap_constraints.mle_rounds_time_ms` |  301.25 |  1,205 |  306 |  298 |
| `prover.openings.stacked_reduction_time_ms` |  98.50 |  394 |  99 |  98 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/b11f626c6b1ccafffa05599bf687e30ff6044787/sha2_bench-b11f626c6b1ccafffa05599bf687e30ff6044787.memory.svg)

| Module | Max (GB) | Max At |
| --- | ---: | --- |
| prover.rap_constraints | 10.95 | app_proof.prover.0 |
| prover.batch_constraints.before_round0 | 10.77 | app_proof.prover.3 |
| frac_sumcheck.gkr_rounds | 10.77 | app_proof.prover.3 |
| frac_sumcheck.segment_tree | 10.68 | app_proof.prover.0 |
| prover.gkr_input_evals | 10.68 | app_proof.prover.0 |
...
| app_proof |  |  |  |  |  | 2,163 |  |  | 96 | 11,167,961 | 116.28 | 0 | 9,091 |  | 
...
| app_proof | 12 | Sha2MainAir<Sha256Config> | prover | 0 | 65,536 | 156 | 10,223,616 | 
...
| app_proof | 12 | Sha2MainAir<Sha256Config> | prover | 1 | 65,536 | 156 | 10,223,616 | 
...
| app_proof | 12 | Sha2MainAir<Sha256Config> | prover | 2 | 65,536 | 156 | 10,223,616 | 
...
| app_proof | 12 | Sha2MainAir<Sha256Config> | prover | 3 | 65,536 | 156 | 10,223,616 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 61,220,603 | 352 | 183 | 0 | 0 | 129 | 37 | 37 | 64 | 27 | 0 | 38 | 19 | 18 | 5 | 12 | 183 | 129 | 0 | 2 | 26 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,879 | 151 | 49 | 0 | 0 | 72 | 25 | 24 | 29 | 17 | 0 | 29 | 20 | 8 | 1 | 6 | 49 | 72 | 0 | 2 | 16 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 124 | 31 | 0 | 0 | 62 | 24 | 23 | 24 | 13 | 0 | 29 | 22 | 7 | 1 | 5 | 31 | 62 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 424,379,238 | 1,254 | 799 | 0 | 157 | 349 | 168 | 167 | 105 | 75 | 0 | 104 | 41 | 63 | 36 | 27 | 800 | 349 | 0 | 6 | 74 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 642,875,645 | 2,118 | 624 | 0 | 119 | 1,355 | 657 | 656 | 306 | 392 | 106 | 137 | 38 | 99 | 60 | 39 | 624 | 1,355 | 0 | 3 | 284 | 0 | 0 | 
| app_proof | prover | 1 | 642,875,404 | 1,907 | 507 | 0 | 2 | 1,264 | 663 | 663 | 301 | 299 | 0 | 135 | 35 | 99 | 61 | 38 | 507 | 1,264 | 0 | 4 | 297 | 0 | 0 | 
| app_proof | prover | 2 | 642,875,404 | 1,908 | 505 | 0 | 2 | 1,266 | 665 | 665 | 300 | 300 | 0 | 135 | 37 | 98 | 59 | 38 | 505 | 1,266 | 0 | 3 | 298 | 0 | 0 | 
| app_proof | prover | 3 | 642,875,652 | 1,899 | 507 | 0 | 2 | 1,253 | 662 | 662 | 298 | 292 | 0 | 138 | 39 | 98 | 59 | 38 | 507 | 1,253 | 0 | 3 | 291 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 73 | 2,419 | 73 | 136 | 0 | 3 | 92 | 2,851,000 | 35.42 | 
| app_proof | 1 | 58 | 2,226 | 58 | 41 | 0 | 1 | 219 | 2,851,000 | 33.68 | 
| app_proof | 2 | 57 | 2,181 | 57 | 41 | 0 | 1 | 175 | 2,851,000 | 39.34 | 
| app_proof | 3 | 54 | 2,163 | 54 | 41 | 0 | 1 | 168 | 2,614,961 | 39.48 | 

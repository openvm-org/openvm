...
|:---|---:|---:|---:|
| Total |  2.48 |  1.87 |  1.87 |
| app_proof |  1.53 |  0.92 |  0.92 |
| leaf |  0.37 |  0.37 |  0.37 |
...
| `total_proof_time_ms ` |  749.50 |  1,499 |  890 |  609 |
| `execute_metered_time_ms` |  31 | -          | -          | -          |
| `execute_metered_insns` |  4,090,656 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  128.81 | -          |  128.81 |  128.81 |
| `execute_preflight_insns` |  2,045,328 |  4,090,656 |  2,327,000 |  1,763,656 |
| `execute_preflight_time_ms` |  83 |  166 |  89 |  77 |
| `execute_preflight_insn_mi/s` |  32.58 | -          |  34.64 |  30.53 |
| `trace_gen_time_ms   ` |  40 |  80 |  42 |  38 |
| `memory_finalize_time_ms` |  1 |  2 |  2 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  537 |  1,074 |  626 |  448 |
| `prover.main_trace_commit_time_ms` |  119.50 |  239 |  131 |  108 |
| `prover.rap_constraints_time_ms` |  362 |  724 |  433 |  291 |
| `prover.openings_time_ms` |  54 |  108 |  60 |  48 |
| `prover.rap_constraints.logup_gkr_time_ms` |  229.50 |  459 |  303 |  156 |
| `prover.rap_constraints.round0_time_ms` |  92.50 |  185 |  99 |  86 |
| `prover.rap_constraints.mle_rounds_time_ms` |  39.50 |  79 |  44 |  35 |
| `prover.openings.stacked_reduction_time_ms` |  31.50 |  63 |  34 |  29 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/db5ae422fd2d7aced19be94d9b779590a33ecb31/regex-db5ae422fd2d7aced19be94d9b779590a33ecb31.memory.svg)

| Module | Max (GB) | Max At |
| --- | ---: | --- |
| frac_sumcheck.gkr_rounds | 4.74 | app_proof.prover.0 |
| prover.batch_constraints.before_round0 | 4.74 | app_proof.prover.0 |
| prover.gkr_input_evals | 4.52 | app_proof.prover.0 |
| frac_sumcheck.segment_tree | 4.52 | app_proof.prover.0 |
...
| prover.batch_constraints.round0 | 2.67 | app_proof.prover.0 |
| prover.batch_constraints.fold_ple_evals | 2.67 | app_proof.prover.0 |
| prover.openings | 2.60 | app_proof.prover.0 |
| prover.merkle_tree | 2.60 | app_proof.prover.0 |
| prover.prove_whir_opening | 2.60 | app_proof.prover.0 |
| prover.before_gkr_input_evals | 2.20 | app_proof.prover.0 |
| prover.stacked_commit | 2.20 | app_proof.prover.0 |
...
| app_proof |  |  |  |  |  | 609 |  |  | 31 | 4,090,656 | 128.81 | 0 | 1,543 |  | 
| internal_for_leaf |  |  |  | 253 |  |  |  |  |  |  |  |  |  | 253 | 
...
| app_proof | 21 | VmAirWrapper<Rv64BaseAluWAdapterAir, ShiftCoreAir<4, 8> | prover | 0 | 128 | 62 | 7,936 | 
| app_proof | 22 | VmAirWrapper<Rv64BaseAluAdapterAir, ShiftCoreAir<8, 8> | prover | 0 | 262,144 | 73 | 19,136,512 | 
| app_proof | 23 | VmAirWrapper<Rv64BaseAluAdapterU16Air, LessThanCoreAir<4, 16> | prover | 0 | 16,384 | 38 | 622,592 | 
| app_proof | 24 | VmAirWrapper<Rv64BaseAluWAdapterAir, BaseAluCoreAir<4, 8> | prover | 0 | 4,096 | 45 | 184,320 | 
...
| app_proof | 18 | VmAirWrapper<Rv64BranchAdapterAir, BranchEqualCoreAir<4, 16> | prover | 1 | 131,072 | 26 | 3,407,872 | 
...
| app_proof | 21 | VmAirWrapper<Rv64BaseAluWAdapterAir, ShiftCoreAir<4, 8> | prover | 1 | 1 | 62 | 62 | 
| app_proof | 22 | VmAirWrapper<Rv64BaseAluAdapterAir, ShiftCoreAir<8, 8> | prover | 1 | 262,144 | 73 | 19,136,512 | 
| app_proof | 23 | VmAirWrapper<Rv64BaseAluAdapterU16Air, LessThanCoreAir<4, 16> | prover | 1 | 16,384 | 38 | 622,592 | 
| app_proof | 24 | VmAirWrapper<Rv64BaseAluWAdapterAir, BaseAluCoreAir<4, 8> | prover | 1 | 4,096 | 45 | 184,320 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 15 | 253 | 15 | 4 | 0 | 2 | 1 | 1 | 
| internal_recursive.0 | 1 | 9 | 172 | 9 | 1 | 0 | 2 | 0 | 0 | 
| internal_recursive.1 | 1 | 9 | 151 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 49 | 373 | 49 | 14 | 3 | 5 | 1 | 1 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 27,289,339 | 237 | 84 | 0 | 5 | 101 | 30 | 29 | 45 | 25 | 0 | 52 | 25 | 26 | 2 | 23 | 84 | 101 | 0 | 2 | 24 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,703 | 162 | 48 | 0 | 4 | 72 | 24 | 23 | 27 | 20 | 0 | 41 | 17 | 23 | 1 | 21 | 48 | 72 | 0 | 2 | 18 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 141 | 34 | 0 | 4 | 65 | 22 | 21 | 24 | 18 | 0 | 41 | 19 | 22 | 1 | 21 | 34 | 65 | 0 | 2 | 18 | 0 | 0 | 
| leaf | 0 | prover | 79,659,764 | 324 | 129 | 0 | 8 | 138 | 53 | 52 | 37 | 47 | 0 | 56 | 25 | 30 | 6 | 23 | 129 | 138 | 0 | 5 | 46 | 0 | 0 | 
...
| leaf | 0 | prover | 0 | 8,672,835 | 2,013,265,921 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 164,023,250 | 626 | 131 | 0 | 8 | 433 | 86 | 85 | 44 | 303 | 68 | 60 | 25 | 34 | 14 | 20 | 131 | 433 | 0 | 3 | 234 | 0 | 0 | 
| app_proof | prover | 1 | 125,436,227 | 448 | 108 | 0 | 15 | 291 | 99 | 98 | 35 | 156 | 0 | 48 | 18 | 29 | 10 | 19 | 108 | 291 | 0 | 3 | 155 | 0 | 0 | 

| group | phase | segment | trace_height_constraint | weighted_sum | threshold |
| --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 0 | 76,832,973 | 2,013,265,921 | 
| app_proof | prover | 1 | 0 | 55,376,442 | 2,013,265,921 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 38 | 890 | 38 | 136 | 2 | 4 | 89 | 2,327,000 | 30.53 | 
| app_proof | 1 | 42 | 609 | 42 | 40 | 0 | 2 | 77 | 1,763,656 | 34.64 | 

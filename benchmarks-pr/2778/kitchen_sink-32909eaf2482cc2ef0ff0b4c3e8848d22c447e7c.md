...
|:---|---:|---:|---:|
| Total |  2.80 |  2.06 |  2.06 |
| app_proof |  1.99 |  1.24 |  1.24 |
| leaf |  0.43 |  0.43 |  0.43 |
...
| `total_proof_time_ms ` |  982 |  1,964 |  1,220 |  744 |
| `execute_metered_time_ms` |  23 | -          | -          | -          |
| `execute_metered_insns` |  1,979,971 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  83.59 | -          |  83.59 |  83.59 |
| `execute_preflight_insns` |  989,985.50 |  1,979,971 |  1,168,000 |  811,971 |
| `execute_preflight_time_ms` |  92 |  184 |  127 |  57 |
| `execute_preflight_insn_mi/s` |  29.38 | -          |  30.12 |  28.65 |
| `trace_gen_time_ms   ` |  24 |  48 |  32 |  16 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  777 |  1,554 |  995 |  559 |
| `prover.main_trace_commit_time_ms` |  217.50 |  435 |  286 |  149 |
| `prover.rap_constraints_time_ms` |  495 |  990 |  632 |  358 |
| `prover.openings_time_ms` |  64 |  128 |  76 |  52 |
| `prover.rap_constraints.logup_gkr_time_ms` |  110 |  220 |  154 |  66 |
| `prover.rap_constraints.round0_time_ms` |  281.50 |  563 |  349 |  214 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/32909eaf2482cc2ef0ff0b4c3e8848d22c447e7c/kitchen_sink-32909eaf2482cc2ef0ff0b4c3e8848d22c447e7c.memory.svg)

| Module | Max (GB) | Max At |
| --- | ---: | --- |
| prover.rap_constraints | 10.22 | app_proof.prover.0 |
...
| prover.batch_constraints.before_round0 | 8.84 | app_proof.prover.0 |
| frac_sumcheck.gkr_rounds | 8.84 | app_proof.prover.0 |
| frac_sumcheck.segment_tree | 8.76 | app_proof.prover.0 |
| prover.gkr_input_evals | 8.76 | app_proof.prover.0 |
...
| 45 | VmAirWrapper<Rv64VecHeapBranchAdapterAir<2, 4, 8>, 2, 4, 8, 32>, BranchLessThanCoreAir<32, 8> | 77 | 117 | 3 | 
| 46 | VmAirWrapper<Rv64VecHeapBranchAdapterAir<2, 4, 8>, 2, 4, 8, 32>, BranchEqualCoreAir<32> | 76 | 47 | 3 | 
| 47 | VmAirWrapper<Rv64VecHeapAdapterAir<2, 4, 4, 8, 8>, 2, 4, 4, 8, 32, 32>, LessThanCoreAir<32, 8> | 98 | 119 | 3 | 
...
| app_proof |  |  |  |  |  | 744 |  |  | 23 | 1,979,971 | 83.59 | 0 | 1,992 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,577,915 | 142 | 40 | 0 | 4 | 66 | 20 | 19 | 29 | 16 | 0 | 34 | 10 | 23 | 1 | 22 | 41 | 66 | 0 | 1 | 15 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,703 | 104 | 19 | 0 | 4 | 54 | 20 | 19 | 20 | 13 | 0 | 30 | 8 | 21 | 1 | 20 | 19 | 54 | 0 | 1 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 98 | 14 | 0 | 4 | 52 | 19 | 18 | 18 | 13 | 0 | 30 | 9 | 21 | 0 | 20 | 15 | 52 | 0 | 1 | 13 | 0 | 0 | 
| leaf | 0 | prover | 263,565,172 | 321 | 130 | 0 | 10 | 144 | 48 | 48 | 37 | 58 | 0 | 45 | 14 | 31 | 7 | 24 | 130 | 144 | 0 | 2 | 57 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 564,299,284 | 995 | 285 | 0 | 155 | 632 | 349 | 348 | 128 | 154 | 54 | 76 | 13 | 63 | 16 | 47 | 286 | 632 | 0 | 1 | 99 | 0 | 0 | 
| app_proof | prover | 1 | 541,080,972 | 559 | 149 | 0 | 24 | 358 | 214 | 214 | 76 | 66 | 0 | 52 | 12 | 39 | 14 | 24 | 149 | 357 | 0 | 1 | 65 | 0 | 0 | 

| group | phase | segment | trace_height_constraint | weighted_sum | threshold |
| --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 0 | 51,708,898 | 2,013,265,921 | 
| app_proof | prover | 1 | 0 | 43,186,570 | 2,013,265,921 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 32 | 1,220 | 32 | 135 | 0 | 3 | 57 | 1,168,000 | 28.65 | 
| app_proof | 1 | 16 | 744 | 16 | 40 | 0 | 1 | 127 | 811,971 | 30.12 | 

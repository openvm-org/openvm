...
|:---|---:|---:|---:|
| Total |  17.15 |  4.95 |  4.95 |
| app_proof |  14.07 |  2.66 |  2.66 |
| leaf |  2.22 |  1.44 |  1.44 |
...
| `total_proof_time_ms ` |  2,321.83 |  13,931 |  2,516 |  2,239 |
...
| `execute_preflight_time_ms` |  246.67 |  1,480 |  330 |  96 |
| `execute_preflight_insn_mi/s` |  30.85 | -          |  31.57 |  28.51 |
| `trace_gen_time_ms   ` |  35.33 |  212 |  43 |  33 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,981.67 |  11,890 |  2,239 |  1,920 |
| `prover.main_trace_commit_time_ms` |  706.50 |  4,239 |  873 |  673 |
| `prover.rap_constraints_time_ms` |  1,091.33 |  6,548 |  1,182 |  1,060 |
| `prover.openings_time_ms` |  183 |  1,098 |  186 |  181 |
| `prover.rap_constraints.logup_gkr_time_ms` |  261.50 |  1,569 |  332 |  246 |
| `prover.rap_constraints.round0_time_ms` |  517.67 |  3,106 |  524 |  510 |
| `prover.rap_constraints.mle_rounds_time_ms` |  311 |  1,866 |  332 |  298 |
| `prover.openings.stacked_reduction_time_ms` |  142.67 |  856 |  145 |  139 |
| `prover.openings.stacked_reduction.round0_time_ms` |  81.83 |  491 |  84 |  77 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  60.33 |  362 |  61 |  59 |
| `prover.openings.whir_time_ms` |  40.17 |  241 |  43 |  38 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,109.50 |  2,219 |  1,437 |  782 |
| `execute_preflight_time_ms` |  5.50 |  11 |  6 |  5 |
| `trace_gen_time_ms   ` |  138 |  276 |  183 |  93 |
| `generate_blob_total_time_ms` |  24.50 |  49 |  33 |  16 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  971 |  1,942 |  1,253 |  689 |
| `prover.main_trace_commit_time_ms` |  546.50 |  1,093 |  718 |  375 |
| `prover.rap_constraints_time_ms` |  320.50 |  641 |  412 |  229 |
| `prover.openings_time_ms` |  103 |  206 |  122 |  84 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/a79b34a054208c6c7e774630cf464565b9075296/keccak-a79b34a054208c6c7e774630cf464565b9075296.memory.svg)

| Module | Max (GB) | Max At |
| --- | ---: | --- |
| prover.rap_constraints | 14.45 | app_proof.prover.0 |
| prover.prove_whir_opening | 13.09 | app_proof.prover.0 |
| prover.openings | 13.09 | app_proof.prover.0 |
| prover.merkle_tree | 13.09 | app_proof.prover.0 |
| prover.batch_constraints.before_round0 | 12.50 | app_proof.prover.0 |
| frac_sumcheck.gkr_rounds | 12.50 | app_proof.prover.0 |
| frac_sumcheck.segment_tree | 12.29 | app_proof.prover.0 |
| prover.gkr_input_evals | 12.29 | app_proof.prover.0 |
| prover.batch_constraints.fold_ple_evals | 11.70 | app_proof.prover.0 |
| prover.batch_constraints.round0 | 11.70 | app_proof.prover.0 |
| prover.before_gkr_input_evals | 9.95 | app_proof.prover.0 |
| prover.stacked_commit | 9.95 | app_proof.prover.0 |
...
| app_proof |  |  |  |  |  | 2,239 |  |  | 141 | 14,365,133 | 101.24 | 0 | 14,079 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 81,415,028 | 482 | 245 | 0 | 14 | 176 | 48 | 47 | 91 | 36 | 0 | 60 | 21 | 38 | 7 | 30 | 245 | 176 | 0 | 3 | 35 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,879 | 170 | 50 | 0 | 4 | 77 | 24 | 23 | 29 | 23 | 0 | 42 | 18 | 24 | 1 | 21 | 50 | 77 | 0 | 2 | 22 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 141 | 34 | 0 | 4 | 66 | 23 | 22 | 24 | 18 | 0 | 40 | 17 | 22 | 1 | 21 | 34 | 66 | 0 | 2 | 17 | 0 | 0 | 
| leaf | 0 | prover | 476,578,662 | 1
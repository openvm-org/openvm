...
| `total_proof_time_ms ` |  742.50 |  1,485 |  810 |  675 |
...
| `execute_preflight_insn_mi/s` |  13.78 | -          |  18.30 |  9.26 |
| `trace_gen_time_ms   ` |  175 |  350 |  190 |  160 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  379.50 |  759 |  382 |  377 |
| `main_trace_commit_time_ms` |  64.50 |  129 |  74 |  55 |
| `generate_perm_trace_time_ms` |  55.50 |  111 |  72 |  39 |
| `perm_trace_commit_time_ms` |  76.66 |  153.32 |  88.06 |  65.26 |
| `quotient_poly_compute_time_ms` |  78.32 |  156.64 |  85.90 |  70.74 |
| `quotient_poly_commit_time_ms` |  15.99 |  31.97 |  17.23 |  14.74 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 675 | 40 | 1 | 89 | 1,745,742 | 19.43 | 146 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 160 | 810 | 32,689,110 | 172,558,444 | 160 | 377 | 0 | 85.90 | 17.23 | 6 | 88.06 | 67 | 130 | 67 | 1 | 74 | 16,059,916 | 39 | 129 | 1,157,000 | 9.26 | 26 | 103 | 1 | 67 | 
| pairing | 1 | 190 | 675 | 22,314,288 | 119,958,502 | 190 | 382 | 1 | 70.74 | 14.74 | 6 | 65.26 | 99 | 141 | 98 | 0 | 55 | 9,408,294 | 72 | 61 | 588,742 | 18.30 | 20 | 86 | 1 | 98 | 

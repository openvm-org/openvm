...
| `total_proof_time_ms ` |  2,354.50 |  4,709 |  3,249 |  1,460 |
| `compile_metered_time_ms` |  6 |  6 |  6 |  6 |
| `execute_metered_time_ms` |  56 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  197.59 | -          |  197.59 |  197.59 |
| `execute_preflight_insns` |  5,583,980.50 |  11,167,961 |  7,136,000 |  4,031,961 |
| `execute_preflight_time_ms` |  154.50 |  309 |  204 |  105 |
| `execute_preflight_insn_mi/s` |  37.100 | -          |  38.92 |  37.07 |
| `trace_gen_time_ms   ` |  66 |  132 |  104 |  28 |
| `set_initial_memory_time_ms` |  0 |  0 |  0 |  0 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  2,132.50 |  4,265 |  2,939 |  1,326 |
| `prover.main_trace_commit_time_ms` |  748.50 |  1,497 |  1,271 |  226 |
| `prover.rap_constraints_time_ms` |  1,106.50 |  2,213 |  1,310 |  903 |
| `prover.openings_time_ms` |  276 |  552 |  356 |  196 |
| `prover.rap_constraints.logup_gkr_time_ms` |  388 |  776 |  416 |  360 |
| `prover.rap_constraints.round0_time_ms` |  532 |  1,064 |  709 |  355 |
| `prover.rap_constraints.mle_rounds_time_ms` |  185.50 |  371 |  240 |  131 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/7f9d02adbe1f40bc21cc608849295d61a0089318/sha2_bench-7f9d02adbe1f40bc21cc608849295d61a0089318.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 60 |  |  |  | 297 |  |  |  |  |  |  | 
| app_proof |  |  |  | 1,460 |  | 56 | 11,167,961 | 197.59 | 0 | 4,775 |  | 
...
| leaf | 0 | 125 | 533 | 125 | 33 | 12 | 2 | 10 | 10 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 179 | 46 | 0 | 0 | 79 | 28 | 27 | 37 | 14 | 0 | 51 | 41 | 10 | 2 | 7 | 47 | 46 | 79 | 0 | 1 | 12 | 0 | 0 | 
...
| leaf | 0 | prover | 237,929,272 | 407 | 147 | 0 | 0 | 142 | 71 | 70 | 44 | 26 | 0 | 117 | 95 | 22 | 10 | 11 | 147 | 147 | 142 | 0 | 3 | 25 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,315,603,879 | 2,939 | 1,271 | 0 | 0 | 1,310 | 709 | 708 | 240 | 360 | 1 | 356 | 258 | 97 | 60 | 37 | 1,271 | 1,271 | 1,310 | 0 | 1 | 358 | 0 | 0 | 
| app_proof | prover | 1 | 709,400,372 | 1,326 | 226 | 0 | 0 | 903 | 355 | 354 | 131 | 416 | 273 | 196 | 142 | 53 | 31 | 22 | 226 | 226 | 903 | 0 | 1 | 143 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 0 | 2 | 104 | 3,249 | 4 | 0 | 0 | 0 | 12,820,745,040 | 2,969,266,308 | 15,790,011,348 | 2,097,152 | 2 | 0 | 0 | 1 | 4 | 100 | 204 | 7,136,000 | 37.07 | 0 | 0 | 
| app_proof | 1 | 0 | 1 | 28 | 1,460 | 2 | 0 | 0 | 0 | 7,276,211,748 | 1,627,054,965 | 8,903,266,713 | 2,097,152 | 1 | 0 | 0 | 0 | 2 | 25 | 105 | 4,031,961 | 38.92 | 0 | 0 | 

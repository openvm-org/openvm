...
| `total_proof_time_ms ` |  3,809 |  7,618 |  4,880 |  2,738 |
...
| `execute_preflight_insn_mi/s` |  28.36 | -          |  30.75 |  25.97 |
| `trace_gen_time_ms   ` |  377 |  754 |  485 |  269 |
| `memory_finalize_time_ms` |  7.50 |  15 |  13 |  2 |
| `stark_prove_excluding_trace_time_ms` |  3,106 |  6,212 |  4,052 |  2,160 |
| `main_trace_commit_time_ms` |  627 |  1,254 |  841 |  413 |
| `generate_perm_trace_time_ms` |  242.50 |  485 |  321 |  164 |
| `perm_trace_commit_time_ms` |  647.50 |  1,295 |  849 |  446 |
| `quotient_poly_compute_time_ms` |  317 |  634 |  433 |  201 |
| `quotient_poly_commit_time_ms` |  306 |  612 |  405 |  207 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2,738 | 7 | 1 | 31 | 4,108,597 | 130.93 | 45 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 485 | 4,880 | 211,758,557 | 373,183,036 | 485 | 4,052 | 0 | 433 | 405 | 849 | 1,196 | 7 | 13 | 841 | 91,281,687 | 321 | 101 | 2,211,000 | 25.97 | 
| regex_program | 1 | 269 | 2,738 | 174,326,267 | 196,838,026 | 269 | 2,160 | 49 | 201 | 207 | 446 | 720 | 6 | 2 | 413 | 73,453,305 | 164 | 85 | 1,897,597 | 30.75 | 

...
| `total_proof_time_ms ` |  3,809.50 |  7,619 |  4,889 |  2,730 |
...
| `execute_metered_insn_mi/s` |  127.56 | -          |  127.56 |  127.56 |
| `execute_preflight_insns` |  2,054,298.50 |  4,108,597 |  2,211,000 |  1,897,597 |
| `execute_preflight_time_ms` |  95.50 |  191 |  104 |  87 |
| `execute_preflight_insn_mi/s` |  28.07 | -          |  30.53 |  25.62 |
| `trace_gen_time_ms   ` |  381 |  762 |  488 |  274 |
| `memory_finalize_time_ms` |  8 |  16 |  14 |  2 |
| `stark_prove_excluding_trace_time_ms` |  3,105 |  6,210 |  4,055 |  2,155 |
| `main_trace_commit_time_ms` |  621.50 |  1,243 |  834 |  409 |
| `generate_perm_trace_time_ms` |  228 |  456 |  301 |  155 |
| `perm_trace_commit_time_ms` |  648.50 |  1,297 |  850 |  447 |
| `quotient_poly_compute_time_ms` |  326 |  652 |  446 |  206 |
| `quotient_poly_commit_time_ms` |  305.50 |  611 |  403 |  208 |
| `pcs_opening_time_ms ` |  963.50 |  1,927 |  1,208 |  719 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2,730 | 6 | 1 | 32 | 4,108,597 | 127.56 | 45 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 488 | 4,889 | 211,758,557 | 373,183,036 | 488 | 4,055 | 0 | 446 | 403 | 850 | 1,208 | 8 | 14 | 834 | 91,281,687 | 301 | 104 | 2,211,000 | 25.62 | 
| regex_program | 1 | 274 | 2,730 | 174,326,267 | 196,838,026 | 274 | 2,155 | 51 | 206 | 208 | 447 | 719 | 6 | 2 | 409 | 73,453,305 | 155 | 87 | 1,897,597 | 30.53 | 

...
| `total_proof_time_ms ` |  3,791.50 |  7,583 |  4,871 |  2,712 |
...
| `execute_preflight_insn_mi/s` |  28.05 | -          |  30.59 |  25.52 |
| `trace_gen_time_ms   ` |  387 |  774 |  497 |  277 |
| `memory_finalize_time_ms` |  8.50 |  17 |  13 |  4 |
| `stark_prove_excluding_trace_time_ms` |  3,072 |  6,144 |  4,022 |  2,122 |
| `main_trace_commit_time_ms` |  616 |  1,232 |  842 |  390 |
| `generate_perm_trace_time_ms` |  229 |  458 |  306 |  152 |
| `perm_trace_commit_time_ms` |  647.50 |  1,295 |  848 |  447 |
| `quotient_poly_compute_time_ms` |  325 |  650 |  432 |  218 |
| `quotient_poly_commit_time_ms` |  295.50 |  591 |  398 |  193 |
| `pcs_opening_time_ms ` |  951.50 |  1,903 |  1,190 |  713 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2,712 | 6 | 1 | 32 | 4,108,597 | 126.89 | 44 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 497 | 4,871 | 211,758,557 | 373,183,036 | 497 | 4,022 | 0 | 432 | 398 | 848 | 1,190 | 7 | 13 | 842 | 91,281,687 | 306 | 107 | 2,211,000 | 25.52 | 
| regex_program | 1 | 277 | 2,712 | 174,326,267 | 196,838,026 | 277 | 2,122 | 52 | 218 | 193 | 447 | 713 | 8 | 4 | 390 | 73,453,305 | 152 | 90 | 1,897,597 | 30.59 | 

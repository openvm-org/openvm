...
|:---|---:|---:|
| Total |  7.71 |  4.92 |
| regex_program |  7.68 |  4.89 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  3,840 |  7,680 |  4,889 |  2,791 |
...
| `execute_preflight_insn_mi/s` |  28.45 | -          |  30.83 |  26.08 |
| `trace_gen_time_ms   ` |  392.50 |  785 |  498 |  287 |
| `memory_finalize_time_ms` |  8 |  16 |  14 |  2 |
| `stark_prove_excluding_trace_time_ms` |  3,120.50 |  6,241 |  4,042 |  2,199 |
| `main_trace_commit_time_ms` |  624.50 |  1,249 |  838 |  411 |
| `generate_perm_trace_time_ms` |  246 |  492 |  314 |  178 |
| `perm_trace_commit_time_ms` |  662 |  1,324 |  848 |  476 |
| `quotient_poly_compute_time_ms` |  315 |  630 |  428 |  202 |
| `quotient_poly_commit_time_ms` |  304 |  608 |  400 |  208 |
| `pcs_opening_time_ms ` |  961.50 |  1,923 |  1,208 |  715 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2,792 | 7 | 1 | 31 | 4,108,597 | 129.65 | 45 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 498 | 4,889 | 211,758,557 | 373,183,036 | 498 | 4,042 | 0 | 428 | 400 | 848 | 1,208 | 7 | 14 | 838 | 91,281,687 | 314 | 101 | 2,211,000 | 26.08 | 
| regex_program | 1 | 287 | 2,791 | 174,326,267 | 196,838,026 | 287 | 2,199 | 53 | 202 | 208 | 476 | 715 | 6 | 2 | 411 | 73,453,305 | 178 | 85 | 1,897,597 | 30.83 | 

...
|:---|---:|---:|---:|
| Total |  4.55 |  2.40 |  2.40 |
| app_proof |  3.19 |  1.04 |  1.04 |
| leaf |  0.68 |  0.68 |  0.68 |
...
| `total_proof_time_ms ` |  781.50 |  3,126 |  976 |  557 |
| `execute_metered_time_ms` |  67 | -          | -          | -          |
| `execute_metered_insns` |  12,000,265 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  178.27 | -          |  178.27 |  178.27 |
| `execute_preflight_insns` |  3,000,066.25 |  12,000,265 |  3,495,000 |  1,515,265 |
| `execute_preflight_time_ms` |  69.25 |  277 |  97 |  33 |
| `execute_preflight_insn_mi/s` |  46.64 | -          |  47.75 |  44.01 |
| `trace_gen_time_ms   ` |  160.75 |  643 |  183 |  150 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  481 |  1,924 |  574 |  298 |
| `prover.main_trace_commit_time_ms` |  98 |  392 |  111 |  59 |
| `prover.rap_constraints_time_ms` |  281.25 |  1,125 |  347 |  171 |
| `prover.openings_time_ms` |  100.75 |  403 |  115 |  68 |
| `prover.rap_constraints.logup_gkr_time_ms` |  205 |  820 |  261 |  118 |
| `prover.rap_constraints.round0_time_ms` |  51.25 |  205 |  59 |  34 |
| `prover.rap_constraints.mle_rounds_time_ms` |  23.75 |  95 |  26 |  17 |
| `prover.openings.stacked_reduction_time_ms` |  18.75 |  75 |  21 |  12 |
| `prover.openings.stacked_reduction.round0_time_ms` |  10.25 |  41 |  12 |  6 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  8.25 |  33 |  9 |  6 |
| `prover.openings.whir_time_ms` |  81.50 |  326 |  93 |  55 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/bcd4d0318e1da0b9d679bea80bcd89105c31ea2c/fibonacci-bcd4d0318e1da0b9d679bea80bcd89105c31ea2c.memory.svg)

| Module | Max (GB) | Max At |
| --- | ---: | --- |
| generate mem proving ctxs | 5.21 | app_proof.0 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 72 |  |  |  | 345 |  |  |  |  |  |  | 
| app_proof |  |  |  | 557 |  | 67 | 12,000,265 | 178.27 | 0 | 3,200 |  | 
...
| app_proof | Rv32HintStoreAir | 0 | 0 | 106 | 
| app_proof | VariableRangeCheckerAir | 0 |  | 0 | 
| app_proof | VmAirWrapper<Rv32BaseAluAdapterAir, BaseAluCoreAir<4, 8> | 0 | 11 | 21 | 
| app_proof | VmAirWrapper<Rv32BaseAluAdapterAir, LessThanCoreAir<4, 8> | 0 | 3 | 8 | 
...
| app_proof | VmAirWrapper<Rv32CondRdWriteAdapterAir, Rv32JalLuiCoreAir> | 0 | 1 | 1 | 
...
| app_proof | RangeTupleCheckerAir<2> | 1 |  | 3 | 
| app_proof | Rv32HintStoreAir | 1 |  | 0 | 
| app_proof | VariableRangeCheckerAir | 1 |  | 0 | 
| app_proof | VmAirWrapper<Rv32BaseAluAdapterAir, BaseAluCoreAir<4, 8> | 1 | 0 | 7 | 
...
| app_proof | VmAirWrapper<Rv32LoadStoreAdapterAir, LoadStoreCoreAir<4> | 1 |  | 0 | 
...
| app_proof | Poseidon2PeripheryAir<BabyBearParameters>, 1> | 2 |  | 0 | 
| app_proof | RangeTupleCheckerAir<2> | 2 |  | 3 | 
| app_proof | Rv32HintStoreAir | 2 |  | 0 | 
| app_proof | VariableRangeCheckerAir | 2 |  | 0 | 
| app_proof | VmAirWrapper<Rv32BaseAluAdapterAir, BaseAluCoreAir<4, 8> | 2 | 0 | 6 | 
...
| app_proof | VmAirWrapper<Rv32LoadStoreAdapterAir, LoadStoreCoreAir<4> | 2 |  | 0 | 
...
| app_proof | Poseidon2PeripheryAir<BabyBearParameters>, 1> | 3 |  | 0 | 
...
| app_proof | VmAirWrapper<Rv32BranchAdapterAir, BranchEqualCoreAir<4> | 3 | 173 | 173 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 330 | 116 | 0 | 0 | 107 | 35 | 34 | 51 | 20 | 0 | 105 | 91 | 13 | 3 | 9 | 117 | 116 | 107 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 171 | 47 | 0 | 0 | 68 | 24 | 24 | 28 | 15 | 0 | 54 | 46 | 8 | 1 | 6 | 47 | 47 | 68 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 137 | 32 | 0 | 0 | 62 | 22 | 22 | 25 | 14 | 0 | 41 | 34 | 7 | 1 | 5 | 33 | 32 | 62 | 0 | 2 | 13 | 0 | 0 | 
| leaf | 0 | prover | 147,934,254 | 607 | 231 | 0 | 0 | 182 | 84 | 83 | 52 | 44 | 0 | 192 | 168 | 24 | 12 | 11 | 232 | 231 | 182 | 0 | 7 | 43 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 136,618,310 | 574 | 111 | 0 | 0 | 347 | 59 | 58 | 26 | 261 | 2 | 115 | 93 | 21 | 11 | 9 | 111 | 111 | 347 | 0 | 3 | 257 | 0 | 0 | 
| app_proof | prover | 1 | 136,570,844 | 526 | 110 | 0 | 0 | 304 | 56 | 56 | 26 | 221 | 0 | 110 | 89 | 21 | 12 | 9 | 111 | 110 | 304 | 0 | 3 | 219 | 0 | 0 | 
| app_proof | prover | 2 | 136,570,844 | 526 | 111 | 0 | 0 | 303 | 56 | 56 | 26 | 220 | 0 | 110 | 89 | 21 | 12 | 9 | 111 | 111 | 303 | 0 | 3 | 219 | 0 | 0 | 
| app_proof | prover | 3 | 70,295,260 | 298 | 59 | 0 | 0 | 171 | 34 | 33 | 17 | 118 | 0 | 68 | 55 | 12 | 6 | 6 | 59 | 59 | 171 | 0 | 3 | 117 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 153 | 150 | 976 | 5 | 153 | 0 | 0 | 2 | 2,770,199,817 | 323,294,035 | 3,093,493,852 | 2,097,152 | 2 | 0 | 0 | 1 | 3 | 143 | 97 | 3,495,000 | 44.01 | 1 | 0 | 
| app_proof | 1 | 41 | 155 | 797 | 142 | 41 | 0 | 0 | 5 | 2,768,863,045 | 322,353,750 | 3,091,216,795 | 2,097,152 | 1 | 0 | 0 | 0 | 1 | 7 | 73 | 3,495,000 | 47.75 | 140 | 0 | 
| app_proof | 2 | 41 | 155 | 796 | 142 | 41 | 0 | 0 | 5 | 2,768,863,045 | 322,353,750 | 3,091,216,795 | 2,097,152 | 1 | 0 | 0 | 0 | 2 | 6 | 74 | 3,495,000 | 47.63 | 140 | 0 | 
| app_proof | 3 | 41 | 183 | 557 | 7 | 41 | 0 | 0 | 1 | 1,230,958,923 | 342,872,922 | 1,573,831,845 | 2,097,152 | 1 | 0 | 0 | 0 | 2 | 173 | 33 | 1,515,265 | 47.17 | 5 | 0 | 

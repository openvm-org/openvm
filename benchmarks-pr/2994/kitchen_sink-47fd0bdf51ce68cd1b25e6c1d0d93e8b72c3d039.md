...
|:---|---:|---:|---:|
| Total |  6.22 |  6.22 |  6.22 |
| app_proof |  4.66 |  4.66 |  4.66 |
| leaf |  0.89 |  0.89 |  0.89 |
...
| `total_proof_time_ms ` |  4,620 |  4,620 |  4,620 |  4,620 |
| `execute_metered_time_ms` |  36 | -          | -          | -          |
| `execute_metered_insns` |  2,579,903 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  70.46 | -          |  70.46 |  70.46 |
| `execute_preflight_insns` |  2,579,903 |  2,579,903 |  2,579,903 |  2,579,903 |
| `execute_preflight_time_ms` |  100 |  100 |  100 |  100 |
| `execute_preflight_insn_mi/s` |  33.40 | -          |  33.40 |  33.40 |
| `trace_gen_time_ms   ` |  201 |  201 |  201 |  201 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  4,160 |  4,160 |  4,160 |  4,160 |
| `prover.main_trace_commit_time_ms` |  1,647 |  1,647 |  1,647 |  1,647 |
| `prover.rap_constraints_time_ms` |  1,710 |  1,710 |  1,710 |  1,710 |
...
| `prover.rap_constraints.mle_rounds_time_ms` |  386 |  386 |  386 |  386 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/47fd0bdf51ce68cd1b25e6c1d0d93e8b72c3d039/kitchen_sink-47fd0bdf51ce68cd1b25e6c1d0d93e8b72c3d039.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 73 |  |  |  | 392 |  |  |  |  |  |  | 
| app_proof |  |  |  | 4,620 |  | 36 | 2,579,903 | 70.46 | 0 | 4,661 |  | 
...
| --- | --- | --- | --- | --- |
| app_proof | BitwiseOperationLookupAir<8> | 0 |  | 3 | 
| app_proof | KeccakfOpAir | 0 |  | 2 | 
| app_proof | KeccakfPermAir | 0 |  | 0 | 
| app_proof | PhantomAir | 0 |  | 0 | 
| app_proof | Poseidon2PeripheryAir<BabyBearParameters>, 1> | 0 |  | 30 | 
...
| app_proof | VmAirWrapper<Rv32BranchAdapterAir, BranchEqualCoreAir<4> | 0 | 0 | 2 | 
...
| app_proof | VmAirWrapper<Rv32VecHeapAdapterAir<1, 24, 24, 4, 4>, FieldExpressionCoreAir> | 0 |  | 102 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,577,981 | 325 | 116 | 0 | 0 | 108 | 36 | 35 | 51 | 20 | 0 | 99 | 85 | 13 | 3 | 9 | 116 | 116 | 108 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 171 | 46 | 0 | 0 | 68 | 25 | 24 | 28 | 14 | 0 | 55 | 46 | 8 | 1 | 6 | 47 | 46 | 68 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 137 | 32 | 0 | 0 | 62 | 23 | 22 | 25 | 14 | 0 | 41 | 34 | 7 | 1 | 5 | 33 | 32 | 62 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 170,433,085 | 769 | 255 | 0 | 0 | 298 | 105 | 104 | 60 | 132 | 0 | 215 | 187 | 27 | 14 | 13 | 255 | 255 | 298 | 0 | 8 | 131 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,121,338,980 | 4,160 | 1,647 | 0 | 0 | 1,710 | 1,031 | 1,030 | 386 | 292 | 1 | 802 | 612 | 190 | 108 | 81 | 1,647 | 1,647 | 1,710 | 0 | 4 | 289 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 157 | 201 | 4,620 | 4 | 157 | 0 | 0 | 38 | 10,592,943,552 | 2,968,407,792 | 13,561,351,344 | 2,097,152 | 2 | 0 | 0 | 1 | 4 | 158 | 100 | 2,579,903 | 33.40 | 0 | 0 | 

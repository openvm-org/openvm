...
| `total_proof_time_ms ` |  1,299 |  1,299 |  1,299 |  1,299 |
| `execute_metered_time_ms` |  32 | -          | -          | -          |
| `execute_metered_insns` |  4,137,067 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  126.38 | -          |  126.38 |  126.38 |
| `execute_preflight_insns` |  4,137,067 |  4,137,067 |  4,137,067 |  4,137,067 |
| `execute_preflight_time_ms` |  129 |  129 |  129 |  129 |
| `execute_preflight_insn_mi/s` |  38.51 | -          |  38.51 |  38.51 |
| `trace_gen_time_ms   ` |  143 |  143 |  143 |  143 |
| `memory_finalize_time_ms` |  2 |  2 |  2 |  2 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  871 |  871 |  871 |  871 |
| `prover.main_trace_commit_time_ms` |  179 |  179 |  179 |  179 |
| `prover.rap_constraints_time_ms` |  519 |  519 |  519 |  519 |
| `prover.openings_time_ms` |  172 |  172 |  172 |  172 |
| `prover.rap_constraints.logup_gkr_time_ms` |  343 |  343 |  343 |  343 |
| `prover.rap_constraints.round0_time_ms` |  130 |  130 |  130 |  130 |
| `prover.rap_constraints.mle_rounds_time_ms` |  45 |  45 |  45 |  45 |
| `prover.openings.stacked_reduction_time_ms` |  35 |  35 |  35 |  35 |
...
| `prover.openings.whir_time_ms` |  136 |  136 |  136 |  136 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  359 |  359 |  359 |  359 |
...
| `prover.main_trace_commit_time_ms` |  106 |  106 |  106 |  106 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/bcd4d0318e1da0b9d679bea80bcd89105c31ea2c/regex-bcd4d0318e1da0b9d679bea80bcd89105c31ea2c.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 71 |  |  |  | 348 |  |  |  |  |  |  | 
| app_proof |  |  |  | 1,299 |  | 32 | 4,137,067 | 126.38 | 0 | 1,346 |  | 
...
| app_proof | VmAirWrapper<Rv32MultAdapterAir, DivRemCoreAir<4, 8> | 0 | 0 | 80 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 27,277,885 | 264 | 84 | 0 | 0 | 99 | 31 | 31 | 46 | 20 | 0 | 80 | 68 | 11 | 2 | 8 | 84 | 84 | 99 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 169 | 47 | 0 | 0 | 68 | 25 | 24 | 28 | 14 | 0 | 52 | 44 | 8 | 1 | 6 | 47 | 47 | 68 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 136 | 32 | 0 | 0 | 62 | 23 | 22 | 24 | 13 | 0 | 41 | 33 | 7 | 1 | 5 | 33 | 32 | 62 | 0 | 3 | 13 | 0 | 0 | 
| leaf | 0 | prover | 65,490,109 | 318 | 106 | 0 | 0 | 111 | 48 | 47 | 32 | 30 | 0 | 99 | 86 | 13 | 5 | 7 | 106 | 106 | 111 | 0 | 6 | 29 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 218,939,669 | 871 | 179 | 0 | 0 | 519 | 130 | 129 | 45 | 343 | 2 | 172 | 136 | 35 | 18 | 16 | 179 | 179 | 519 | 0 | 4 | 339 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 155 | 143 | 1,299 | 6 | 155 | 0 | 0 | 3 | 3,565,520,329 | 1,192,118,024 | 4,757,638,353 | 2,097,152 | 2 | 0 | 2 | 2 | 5 | 132 | 129 | 4,137,067 | 38.51 | 1 | 0 | 

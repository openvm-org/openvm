...
|:---|---:|---:|
| Total |  6.80 |  3.68 |
| regex_program |  6.74 |  3.62 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  3,371 |  6,742 |  3,623 |  3,119 |
...
| `execute_metered_insn_mi/s` |  68.55 | -          |  68.55 |  68.55 |
| `execute_e3_time_ms  ` |  164.50 |  329 |  178 |  151 |
| `execute_e3_insn_mi/s` |  12.64 | -          |  12.68 |  12.60 |
| `trace_gen_time_ms   ` |  725 |  1,450 |  740 |  710 |
| `memory_finalize_time_ms` |  161 |  322 |  253 |  69 |
| `boundary_finalize_time_ms` |  2.50 |  5 |  5 |  0 |
| `merkle_finalize_time_ms` |  147 |  294 |  230 |  64 |
| `stark_prove_excluding_trace_time_ms` |  2,481.50 |  4,963 |  2,705 |  2,258 |
| `main_trace_commit_time_ms` |  458.50 |  917 |  517 |  400 |
| `generate_perm_trace_time_ms` |  221.50 |  443 |  233 |  210 |
| `perm_trace_commit_time_ms` |  495.50 |  991 |  530 |  461 |
| `quotient_poly_compute_time_ms` |  264.50 |  529 |  286 |  243 |
| `quotient_poly_commit_time_ms` |  222.50 |  445 |  255 |  190 |
| `pcs_opening_time_ms ` |  808.50 |  1,617 |  875 |  742 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2 | 24 | 4,165,433 | 1 | 6,874 | 60 | 68.55 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 740 | 3,623 | 2,243,700 | 275,648,700 | 2,705 | 286 | 255 | 2,931 | 530 | 875 | 230 | 25 | 253 | 517 | 93,439,220 | 2,243,700 | 233 | 178 | 12.60 | 5 | 
| regex_program | 1 | 710 | 3,119 | 1,921,732 | 242,975,388 | 2,258 | 243 | 190 | 2,856 | 461 | 742 | 64 | 23 | 69 | 400 | 73,010,366 | 1,921,733 | 210 | 151 | 12.68 | 0 | 

...
|:---|---:|---:|
| Total |  7.08 |  3.78 |
| regex_program |  7.02 |  3.72 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  3,508 |  7,016 |  3,723 |  3,293 |
...
| `trace_gen_time_ms   ` |  733 |  1,466 |  743 |  723 |
| `memory_finalize_time_ms` |  167.50 |  335 |  261 |  74 |
| `boundary_finalize_time_ms` |  2.50 |  5 |  5 |  0 |
| `merkle_finalize_time_ms` |  154 |  308 |  238 |  70 |
| `stark_prove_excluding_trace_time_ms` |  2,609.50 |  5,219 |  2,801 |  2,418 |
| `main_trace_commit_time_ms` |  511 |  1,022 |  577 |  445 |
| `generate_perm_trace_time_ms` |  205.50 |  411 |  222 |  189 |
| `perm_trace_commit_time_ms` |  556.50 |  1,113 |  591 |  522 |
| `quotient_poly_compute_time_ms` |  279.50 |  559 |  283 |  276 |
| `quotient_poly_commit_time_ms` |  244.50 |  489 |  281 |  208 |
| `pcs_opening_time_ms ` |  803 |  1,606 |  842 |  764 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2 | 24 | 4,165,433 | 1 | 7,088 | 60 | 68.39 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 743 | 3,723 | 2,243,700 | 275,648,700 | 2,801 | 283 | 281 | 3,025 | 591 | 842 | 238 | 25 | 261 | 577 | 93,439,220 | 2,243,700 | 222 | 179 | 12.49 | 5 | 
| regex_program | 1 | 723 | 3,293 | 1,921,732 | 242,975,388 | 2,418 | 276 | 208 | 3,013 | 522 | 764 | 70 | 24 | 74 | 445 | 73,010,366 | 1,921,733 | 189 | 152 | 12.63 | 0 | 

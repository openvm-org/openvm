...
|:---|---:|---:|
| Total |  7.01 |  3.81 |
| regex_program |  6.95 |  3.75 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  3,476.50 |  6,953 |  3,749 |  3,204 |
...
| `execute_e3_time_ms  ` |  166.50 |  333 |  179 |  154 |
| `execute_e3_insn_mi/s` |  12.45 | -          |  12.47 |  12.43 |
| `trace_gen_time_ms   ` |  708.50 |  1,417 |  745 |  672 |
| `memory_finalize_time_ms` |  168 |  336 |  263 |  73 |
| `boundary_finalize_time_ms` |  2 |  4 |  4 |  0 |
| `merkle_finalize_time_ms` |  155 |  310 |  241 |  69 |
| `stark_prove_excluding_trace_time_ms` |  2,601.50 |  5,203 |  2,825 |  2,378 |
| `main_trace_commit_time_ms` |  510 |  1,020 |  575 |  445 |
| `generate_perm_trace_time_ms` |  220 |  440 |  243 |  197 |
| `perm_trace_commit_time_ms` |  554.50 |  1,109 |  591 |  518 |
| `quotient_poly_compute_time_ms` |  267 |  534 |  292 |  242 |
| `quotient_poly_commit_time_ms` |  243.50 |  487 |  282 |  205 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2 | 24 | 4,165,433 | 1 | 6,944 | 60 | 68.68 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 745 | 3,749 | 2,243,700 | 275,648,700 | 2,825 | 292 | 282 | 3,050 | 591 | 839 | 241 | 25 | 263 | 575 | 93,439,220 | 2,243,700 | 243 | 179 | 12.47 | 4 | 
| regex_program | 1 | 672 | 3,204 | 1,921,732 | 242,975,388 | 2,378 | 242 | 205 | 2,972 | 518 | 757 | 69 | 24 | 73 | 445 | 73,010,366 | 1,921,733 | 197 | 154 | 12.43 | 0 | 

...
|:---|---:|---:|
| Total |  7.02 |  3.81 |
| regex_program |  6.96 |  3.75 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  3,482.50 |  6,965 |  3,753 |  3,212 |
...
| `execute_metered_insn_mi/s` |  68.28 | -          |  68.28 |  68.28 |
| `execute_e3_time_ms  ` |  165.50 |  331 |  179 |  152 |
| `execute_e3_insn_mi/s` |  12.56 | -          |  12.59 |  12.52 |
| `trace_gen_time_ms   ` |  719.50 |  1,439 |  754 |  685 |
| `memory_finalize_time_ms` |  167 |  334 |  261 |  73 |
| `boundary_finalize_time_ms` |  2.50 |  5 |  5 |  0 |
| `merkle_finalize_time_ms` |  153 |  306 |  238 |  68 |
| `stark_prove_excluding_trace_time_ms` |  2,597.50 |  5,195 |  2,820 |  2,375 |
| `main_trace_commit_time_ms` |  509.50 |  1,019 |  576 |  443 |
| `generate_perm_trace_time_ms` |  214.50 |  429 |  228 |  201 |
| `perm_trace_commit_time_ms` |  551.50 |  1,103 |  588 |  515 |
| `quotient_poly_compute_time_ms` |  271.50 |  543 |  296 |  247 |
| `quotient_poly_commit_time_ms` |  239 |  478 |  272 |  206 |
| `pcs_opening_time_ms ` |  804 |  1,608 |  855 |  753 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2 | 23 | 4,165,433 | 1 | 7,030 | 60 | 68.28 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 754 | 3,753 | 2,243,700 | 275,648,700 | 2,820 | 296 | 272 | 3,045 | 588 | 855 | 238 | 23 | 261 | 576 | 93,439,220 | 2,243,700 | 228 | 179 | 12.52 | 5 | 
| regex_program | 1 | 685 | 3,212 | 1,921,732 | 242,975,388 | 2,375 | 247 | 206 | 2,969 | 515 | 753 | 68 | 23 | 73 | 443 | 73,010,366 | 1,921,733 | 201 | 152 | 12.59 | 0 | 

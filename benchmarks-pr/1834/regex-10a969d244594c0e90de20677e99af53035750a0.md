...
|:---|---:|---:|
| Total |  7.04 |  3.79 |
| regex_program |  6.98 |  3.73 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  3,488.50 |  6,977 |  3,726 |  3,251 |
...
| `execute_metered_insn_mi/s` |  64.32 | -          |  64.32 |  64.32 |
| `execute_e3_time_ms  ` |  165.50 |  331 |  179 |  152 |
| `execute_e3_insn_mi/s` |  12.54 | -          |  12.60 |  12.48 |
| `trace_gen_time_ms   ` |  729 |  1,458 |  746 |  712 |
| `memory_finalize_time_ms` |  167.50 |  335 |  261 |  74 |
| `boundary_finalize_time_ms` |  2.50 |  5 |  5 |  0 |
| `merkle_finalize_time_ms` |  153.50 |  307 |  237 |  70 |
| `stark_prove_excluding_trace_time_ms` |  2,594 |  5,188 |  2,801 |  2,387 |
| `main_trace_commit_time_ms` |  508.50 |  1,017 |  573 |  444 |
| `generate_perm_trace_time_ms` |  219.50 |  439 |  235 |  204 |
| `perm_trace_commit_time_ms` |  553.50 |  1,107 |  589 |  518 |
| `quotient_poly_compute_time_ms` |  264.50 |  529 |  285 |  244 |
| `quotient_poly_commit_time_ms` |  239.50 |  479 |  273 |  206 |
| `pcs_opening_time_ms ` |  798 |  1,596 |  839 |  757 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2 | 24 | 4,165,433 | 1 | 6,962 | 64 | 64.32 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 746 | 3,726 | 2,243,700 | 275,648,700 | 2,801 | 285 | 273 | 3,026 | 589 | 839 | 237 | 25 | 261 | 573 | 93,439,220 | 2,243,700 | 235 | 179 | 12.48 | 5 | 
| regex_program | 1 | 712 | 3,251 | 1,921,732 | 242,975,388 | 2,387 | 244 | 206 | 2,981 | 518 | 757 | 70 | 24 | 74 | 444 | 73,010,366 | 1,921,733 | 204 | 152 | 12.60 | 0 | 

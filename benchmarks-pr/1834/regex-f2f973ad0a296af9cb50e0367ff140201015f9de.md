...
|:---|---:|---:|
| Total |  7.03 |  3.81 |
| regex_program |  6.96 |  3.74 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  3,481.50 |  6,963 |  3,744 |  3,219 |
...
| `execute_metered_insn_mi/s` |  66.63 | -          |  66.63 |  66.63 |
| `execute_e3_time_ms  ` |  165 |  330 |  178 |  152 |
| `execute_e3_insn_mi/s` |  12.59 | -          |  12.63 |  12.55 |
| `trace_gen_time_ms   ` |  715.50 |  1,431 |  753 |  678 |
| `memory_finalize_time_ms` |  168 |  336 |  264 |  72 |
| `boundary_finalize_time_ms` |  2.50 |  5 |  5 |  0 |
| `merkle_finalize_time_ms` |  154.50 |  309 |  240 |  69 |
| `stark_prove_excluding_trace_time_ms` |  2,601 |  5,202 |  2,813 |  2,389 |
| `main_trace_commit_time_ms` |  512 |  1,024 |  578 |  446 |
| `generate_perm_trace_time_ms` |  223.50 |  447 |  236 |  211 |
...
| `pcs_opening_time_ms ` |  796 |  1,592 |  837 |  755 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2 | 22 | 4,165,433 | 1 | 6,978 | 62 | 66.63 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 753 | 3,744 | 2,243,700 | 275,648,700 | 2,813 | 287 | 281 | 3,038 | 590 | 837 | 240 | 23 | 264 | 578 | 93,439,220 | 2,243,700 | 236 | 178 | 12.55 | 5 | 
| regex_program | 1 | 678 | 3,219 | 1,921,732 | 242,975,388 | 2,389 | 241 | 209 | 2,983 | 517 | 755 | 69 | 23 | 72 | 446 | 73,010,366 | 1,921,733 | 211 | 152 | 12.63 | 0 | 

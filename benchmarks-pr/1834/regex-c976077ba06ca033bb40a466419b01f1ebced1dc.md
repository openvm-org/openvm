...
|:---|---:|---:|
| Total |  7.03 |  3.81 |
| regex_program |  6.97 |  3.75 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  3,485 |  6,970 |  3,753 |  3,217 |
...
| `execute_metered_insn_mi/s` |  68.65 | -          |  68.65 |  68.65 |
| `execute_e3_time_ms  ` |  166 |  332 |  180 |  152 |
| `execute_e3_insn_mi/s` |  12.53 | -          |  12.63 |  12.44 |
| `trace_gen_time_ms   ` |  717.50 |  1,435 |  747 |  688 |
| `memory_finalize_time_ms` |  169.50 |  339 |  263 |  76 |
| `boundary_finalize_time_ms` |  2 |  4 |  4 |  0 |
| `merkle_finalize_time_ms` |  155 |  310 |  240 |  70 |
| `stark_prove_excluding_trace_time_ms` |  2,601.50 |  5,203 |  2,826 |  2,377 |
| `main_trace_commit_time_ms` |  510.50 |  1,021 |  575 |  446 |
| `generate_perm_trace_time_ms` |  215 |  430 |  234 |  196 |
| `perm_trace_commit_time_ms` |  556.50 |  1,113 |  597 |  516 |
| `quotient_poly_compute_time_ms` |  262 |  524 |  283 |  241 |
| `quotient_poly_commit_time_ms` |  247 |  494 |  286 |  208 |
| `pcs_opening_time_ms ` |  803 |  1,606 |  845 |  761 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2 | 26 | 4,165,433 | 1 | 6,958 | 60 | 68.65 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 747 | 3,753 | 2,243,700 | 275,648,700 | 2,826 | 283 | 286 | 3,051 | 597 | 845 | 240 | 26 | 263 | 575 | 93,439,220 | 2,243,700 | 234 | 180 | 12.44 | 4 | 
| regex_program | 1 | 688 | 3,217 | 1,921,732 | 242,975,388 | 2,377 | 241 | 208 | 2,971 | 516 | 761 | 70 | 24 | 76 | 446 | 73,010,366 | 1,921,733 | 196 | 152 | 12.63 | 0 | 

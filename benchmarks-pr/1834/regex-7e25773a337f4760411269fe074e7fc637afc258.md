...
|:---|---:|---:|
| Total |  7.10 |  3.83 |
| regex_program |  7.04 |  3.77 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  3,521 |  7,042 |  3,772 |  3,270 |
...
| `execute_metered_insn_mi/s` |  68.68 | -          |  68.68 |  68.68 |
| `execute_e3_time_ms  ` |  166.50 |  333 |  180 |  153 |
| `execute_e3_insn_mi/s` |  12.46 | -          |  12.49 |  12.43 |
| `trace_gen_time_ms   ` |  734 |  1,468 |  756 |  712 |
| `memory_finalize_time_ms` |  167.50 |  335 |  261 |  74 |
| `boundary_finalize_time_ms` |  2.50 |  5 |  5 |  0 |
| `merkle_finalize_time_ms` |  153.50 |  307 |  238 |  69 |
| `stark_prove_excluding_trace_time_ms` |  2,620.50 |  5,241 |  2,836 |  2,405 |
| `main_trace_commit_time_ms` |  509.50 |  1,019 |  575 |  444 |
| `generate_perm_trace_time_ms` |  214 |  428 |  231 |  197 |
| `perm_trace_commit_time_ms` |  566 |  1,132 |  593 |  539 |
| `quotient_poly_compute_time_ms` |  269.50 |  539 |  300 |  239 |
| `quotient_poly_commit_time_ms` |  246.50 |  493 |  283 |  210 |
| `pcs_opening_time_ms ` |  808 |  1,616 |  849 |  767 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2 | 25 | 4,165,433 | 1 | 7,181 | 60 | 68.68 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 756 | 3,772 | 2,243,700 | 275,648,700 | 2,836 | 300 | 283 | 3,061 | 593 | 849 | 238 | 24 | 261 | 575 | 93,439,220 | 2,243,700 | 231 | 180 | 12.43 | 5 | 
| regex_program | 1 | 712 | 3,270 | 1,921,732 | 242,975,388 | 2,405 | 239 | 210 | 2,999 | 539 | 767 | 69 | 24 | 74 | 444 | 73,010,366 | 1,921,733 | 197 | 153 | 12.49 | 0 | 

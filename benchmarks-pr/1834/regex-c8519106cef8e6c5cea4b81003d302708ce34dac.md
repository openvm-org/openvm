...
|:---|---:|---:|
| Total |  6.77 |  3.65 |
| regex_program |  6.71 |  3.59 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  3,354.50 |  6,709 |  3,591 |  3,118 |
...
| `execute_metered_insn_mi/s` |  68.63 | -          |  68.63 |  68.63 |
| `execute_e3_time_ms  ` |  162.50 |  325 |  176 |  149 |
| `execute_e3_insn_mi/s` |  12.75 | -          |  12.82 |  12.68 |
| `trace_gen_time_ms   ` |  723.50 |  1,447 |  751 |  696 |
| `memory_finalize_time_ms` |  162 |  324 |  255 |  69 |
| `boundary_finalize_time_ms` |  2.50 |  5 |  5 |  0 |
| `merkle_finalize_time_ms` |  149 |  298 |  233 |  65 |
| `stark_prove_excluding_trace_time_ms` |  2,468.50 |  4,937 |  2,664 |  2,273 |
| `main_trace_commit_time_ms` |  459.50 |  919 |  520 |  399 |
| `generate_perm_trace_time_ms` |  219 |  438 |  226 |  212 |
| `perm_trace_commit_time_ms` |  497.50 |  995 |  530 |  465 |
| `quotient_poly_compute_time_ms` |  261 |  522 |  285 |  237 |
| `quotient_poly_commit_time_ms` |  227.50 |  455 |  263 |  192 |
| `pcs_opening_time_ms ` |  794 |  1,588 |  833 |  755 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2 | 25 | 4,165,433 | 1 | 6,915 | 60 | 68.63 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 751 | 3,591 | 2,243,700 | 275,648,700 | 2,664 | 285 | 263 | 2,890 | 530 | 833 | 233 | 25 | 255 | 520 | 93,439,220 | 2,243,700 | 226 | 176 | 12.68 | 5 | 
| regex_program | 1 | 696 | 3,118 | 1,921,732 | 242,975,388 | 2,273 | 237 | 192 | 2,871 | 465 | 755 | 65 | 23 | 69 | 399 | 73,010,366 | 1,921,733 | 212 | 149 | 12.82 | 0 | 

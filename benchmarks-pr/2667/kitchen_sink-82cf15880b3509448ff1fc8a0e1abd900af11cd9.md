...
| `total_proof_time_ms ` |  1,137 |  2,274 |  1,812 |  462 |
| `execute_metered_time_ms` |  34 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  75.58 | -          |  75.58 |  75.58 |
| `execute_preflight_insns` |  1,289,951.50 |  2,579,903 |  2,020,000 |  559,903 |
| `execute_preflight_time_ms` |  77.50 |  155 |  78 |  77 |
| `execute_preflight_insn_mi/s` |  35.58 | -          |  36.46 |  34.69 |
| `trace_gen_time_ms   ` |  57.50 |  115 |  94 |  21 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  890.50 |  1,781 |  1,459 |  322 |
| `prover.main_trace_commit_time_ms` |  290.50 |  581 |  499 |  82 |
| `prover.rap_constraints_time_ms` |  533 |  1,066 |  863 |  203 |
| `prover.openings_time_ms` |  65.50 |  131 |  95 |  36 |
| `prover.rap_constraints.logup_gkr_time_ms` |  156 |  312 |  270 |  42 |
| `prover.rap_constraints.round0_time_ms` |  281 |  562 |  449 |  113 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/82cf15880b3509448ff1fc8a0e1abd900af11cd9/kitchen_sink-82cf15880b3509448ff1fc8a0e1abd900af11cd9.memory.svg)
...
| app_proof |  |  |  |  |  | 462 |  |  | 34 | 2,579,903 | 75.58 | 0 | 2,313 |  | 
...
| leaf | 0 | 120 | 440 | 119 | 26 | 12 | 21 | 2 | 2 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 53,472,003 | 138 | 40 | 0 | 4 | 65 | 20 | 19 | 29 | 15 | 0 | 32 | 8 | 23 | 1 | 21 | 41 | 65 | 0 | 1 | 14 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 23,651,975 | 101 | 19 | 0 | 4 | 51 | 18 | 17 | 20 | 13 | 0 | 30 | 8 | 21 | 1 | 20 | 19 | 51 | 0 | 1 | 12 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 17,507,975 | 93 | 14 | 0 | 4 | 49 | 17 | 16 | 18 | 13 | 0 | 29 | 8 | 21 | 0 | 20 | 15 | 49 | 0 | 1 | 12 | 0 | 0 | 
| leaf | 0 | prover | 428,317,568 | 320 | 130 | 0 | 10 | 145 | 48 | 48 | 37 | 59 | 0 | 43 | 12 | 31 | 7 | 24 | 130 | 145 | 0 | 2 | 58 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,221,261,804 | 1,459 | 499 | 0 | 280 | 863 | 449 | 448 | 143 | 270 | 131 | 95 | 16 | 78 | 26 | 51 | 499 | 863 | 0 | 1 | 137 | 0 | 0 | 
| app_proof | prover | 1 | 370,741,140 | 322 | 82 | 0 | 17 | 203 | 113 | 112 | 47 | 42 | 0 | 36 | 10 | 26 | 7 | 18 | 82 | 203 | 0 | 1 | 42 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 94 | 1,812 | 94 | 181 | 0 | 3 | 77 | 2,020,000 | 34.69 | 
| app_proof | 1 | 21 | 462 | 21 | 40 | 0 | 1 | 78 | 559,903 | 36.46 | 

...
| `total_proof_time_ms ` |  710.50 |  1,421 |  809 |  612 |
...
| `execute_metered_insn_mi/s` |  17.72 | -          |  17.72 |  17.72 |
| `execute_preflight_insns` |  872,871 |  1,745,742 |  1,157,000 |  588,742 |
| `execute_preflight_time_ms` |  97.50 |  195 |  135 |  60 |
| `execute_preflight_insn_mi/s` |  13.29 | -          |  17.81 |  8.77 |
| `trace_gen_time_ms   ` |  172 |  344 |  192 |  152 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  348 |  696 |  377 |  319 |
| `main_trace_commit_time_ms` |  64 |  128 |  74 |  54 |
| `generate_perm_trace_time_ms` |  43.50 |  87 |  47 |  40 |
| `perm_trace_commit_time_ms` |  76.07 |  152.14 |  87.72 |  64.41 |
| `quotient_poly_compute_time_ms` |  77.33 |  154.67 |  85.91 |  68.76 |
| `quotient_poly_commit_time_ms` |  15.92 |  31.85 |  18.23 |  13.62 |
| `pcs_opening_time_ms ` |  66.50 |  133 |  67 |  66 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 612 | 1 | 98 | 1,745,742 | 17.72 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 152 | 809 | 32,689,110 | 172,558,444 | 152 | 377 | 0 | 85.91 | 18.23 | 6 | 87.72 | 67 | 130 | 67 | 1 | 74 | 16,059,916 | 40 | 135 | 1,157,000 | 8.77 | 26 | 104 | 1 | 67 | 
| pairing | 1 | 192 | 612 | 22,314,288 | 119,958,502 | 192 | 319 | 1 | 68.76 | 13.62 | 6 | 64.41 | 66 | 115 | 66 | 0 | 54 | 9,408,294 | 47 | 60 | 588,742 | 17.81 | 20 | 82 | 1 | 66 | 

...
| `total_proof_time_ms ` |  583 |  2,332 |  738 |  527 |
...
| `execute_preflight_insn_mi/s` |  30.58 | -          |  31.63 |  28.10 |
| `trace_gen_time_ms   ` |  174.50 |  698 |  206 |  152 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  286.25 |  1,145 |  340 |  267 |
| `main_trace_commit_time_ms` |  51.25 |  205 |  56 |  49 |
| `generate_perm_trace_time_ms` |  31.50 |  126 |  54 |  20 |
| `perm_trace_commit_time_ms` |  63.75 |  255.02 |  69.76 |  55.22 |
| `quotient_poly_compute_time_ms` |  57.57 |  230.27 |  68.65 |  51.54 |
| `quotient_poly_commit_time_ms` |  14.97 |  59.88 |  17.38 |  12.65 |
| `pcs_opening_time_ms ` |  63.75 |  255 |  82 |  56 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 536 | 1 | 36 | 4,137,502 | 114.22 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 206 | 738 | 23,446,148 | 150,778,428 | 206 | 340 | 0 | 58.20 | 17.38 | 5 | 69.76 | 82 | 125 | 82 | 4 | 56 | 10,899,170 | 54 | 46 | 1,103,000 | 28.10 | 21 | 76 | 1 | 82 | 
| regex_program | 1 | 152 | 527 | 11,598,276 | 128,513,066 | 152 | 267 | 1 | 51.54 | 15.66 | 4 | 65.97 | 57 | 91 | 57 | 0 | 49 | 2,196,106 | 25 | 67 | 1,104,000 | 31.16 | 17 | 67 | 0 | 57 | 
| regex_program | 2 | 159 | 531 | 11,579,064 | 128,513,066 | 159 | 270 | 1 | 51.88 | 14.20 | 4 | 64.07 | 60 | 91 | 60 | 0 | 50 | 2,177,334 | 27 | 60 | 1,104,000 | 31.63 | 16 | 66 | 0 | 60 | 
| regex_program | 3 | 181 | 536 | 11,853,872 | 103,456,394 | 181 | 268 | 0 | 68.65 | 12.65 | 5 | 55.22 | 56 | 78 | 56 | 0 | 50 | 2,422,606 | 20 | 46 | 826,502 | 31.43 | 18 | 82 | 1 | 56 | 
...
Commit: https://github.com/openvm-org/openvm/commit/23b78a567882e1affd28eb38152e227203143811
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19379354125)

...
|:---|---:|---:|---:|
| Total | <span style='color: red'>(+0 [+2.7%])</span> 1.24 | <span style='color: red'>(+0 [+2.7%])</span> 1.24 | <span style='color: red'>(+0 [+2.7%])</span> 1.23 |
| app_proof | <span style='color: red'>(+0 [+5.3%])</span> 0.65 | <span style='color: red'>(+0 [+5.3%])</span> 0.65 | <span style='color: red'>(+0 [+5.3%])</span> 0.65 |
| leaf |  0.19 |  0.19 |  0.19 |
...
| `total_proof_time_ms ` | <span style='color: red'>(+33 [+5.8%])</span> 602 | <span style='color: red'>(+33 [+5.8%])</span> 602 | <span style='color: red'>(+33 [+5.8%])</span> 602 | <span style='color: red'>(+33 [+5.8%])</span> 602 |
| `execute_metered_time_ms` |  52 | -          | -          | -          |
| `execute_metered_insns` |  1,745,757 | -          | -          | -          |
| `execute_metered_insn_mi/s` | <span style='color: red'>(+1 [+1.5%])</span> 33.47 | -          | <span style='color: red'>(+1 [+1.5%])</span> 33.47 | <span style='color: red'>(+1 [+1.5%])</span> 33.47 |
| `execute_preflight_insns` |  1,745,757 |  1,745,757 |  1,745,757 |  1,745,757 |
| `execute_preflight_time_ms` | <span style='color: red'>(+1 [+0.9%])</span> 109 | <span style='color: red'>(+1 [+0.9%])</span> 109 | <span style='color: red'>(+1 [+0.9%])</span> 109 | <span style='color: red'>(+1 [+0.9%])</span> 109 |
| `execute_preflight_insn_mi/s` | <span style='color: green'>(-0 [-0.3%])</span> 23.87 | -          | <span style='color: green'>(-0 [-0.3%])</span> 23.87 | <span style='color: green'>(-0 [-0.3%])</span> 23.87 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+28 [+26.9%])</span> 132 | <span style='color: red'>(+28 [+26.9%])</span> 132 | <span style='color: red'>(+28 [+26.9%])</span> 132 | <span style='color: red'>(+28 [+26.9%])</span> 132 |
...
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` | <span style='color: green'>(-1 [-0.6%])</span> 158 | <span style='color: green'>(-1 [-0.6%])</span> 158 | <span style='color: green'>(-1 [-0.6%])</span> 158 | <span style='color: green'>(-1 [-0.6%])</span> 158 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: green'>(-5 [-4.0%])</span> 119 | <span style='color: green'>(-5 [-4.0%])</span> 119 | <span style='color: green'>(-5 [-4.0%])</span> 119 | <span style='color: green'>(-5 [-4.0%])</span> 119 |
| `execute_preflight_time_ms` |  2 |  2 |  2 |  2 |
...
| `generate_blob_total_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` | <span style='color: green'>(-6 [-5.3%])</span> 108 | <span style='color: green'>(-6 [-5.3%])</span> 108 | <span style='color: green'>(-6 [-5.3%])</span> 108 | <span style='color: green'>(-6 [-5.3%])</span> 108 |
...
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  6 |  6 |  6 |  6 |
| `prover.openings.whir_time_ms` | <span style='color: green'>(-6 [-21.4%])</span> 22 | <span style='color: green'>(-6 [-21.4%])</span> 22 | <span style='color: green'>(-6 [-21.4%])</span> 22 | <span style='color: green'>(-6 [-21.4%])</span> 22 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/8438fd0f4eaf48ddc054bb60350fc67a116bfb50/pairing-8438fd0f4eaf48ddc054bb60350fc67a116bfb50.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 61 |  |  |  | 300 |  |  |  |  |  |  | 
| app_proof |  |  |  | 602 |  | 52 | 1,745,757 | 33.47 | 0 | 663 |  | 
...
| internal_recursive.1 | 1 | prover | 9,750,865 | 99 | 14 | 0 | 0 | 54 | 20 | 19 | 22 | 11 | 0 | 29 | 22 | 7 | 1 | 5 | 15 | 14 | 54 | 0 | 1 | 10 | 0 | 0 | 
| leaf | 0 | prover | 47,295,069 | 158 | 32 | 0 | 0 | 82 | 35 | 34 | 24 | 22 | 0 | 42 | 33 | 9 | 2 | 6 | 33 | 32 | 82 | 0 | 3 | 22 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 136 | 132 | 602 | 132 | 136 | 1,764,151,656 | 917,748,960 | 2,681,900,616 | 2,097,152 | 1 | 4 | 109 | 1,745,757 | 23.87 | 

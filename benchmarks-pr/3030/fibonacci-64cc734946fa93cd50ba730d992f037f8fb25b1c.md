...
|:---|---:|---:|---:|
| Total | <span style='color: red'>(+0 [+1.7%])</span> 2.44 | <span style='color: red'>(+0 [+1.1%])</span> 1.34 | <span style='color: red'>(+0 [+1.1%])</span> 1.34 |
| app_proof | <span style='color: red'>(+0 [+1.8%])</span> 1.64 | <span style='color: red'>(+0 [+0.6%])</span> 0.54 | <span style='color: red'>(+0 [+0.9%])</span> 0.54 |
| leaf | <span style='color: red'>(+0 [+1.1%])</span> 0.37 | <span style='color: red'>(+0 [+1.1%])</span> 0.37 | <span style='color: red'>(+0 [+1.1%])</span> 0.37 |
...
| internal_recursive.0 | <span style='color: green'>(-0 [-3.1%])</span> 0.12 | <span style='color: green'>(-0 [-3.1%])</span> 0.12 | <span style='color: green'>(-0 [-3.1%])</span> 0.12 |
...
| `total_proof_time_ms ` | <span style='color: red'>(+7 [+1.8%])</span> 400.75 | <span style='color: red'>(+29 [+1.8%])</span> 1,603 | <span style='color: red'>(+3 [+0.6%])</span> 503 | <span style='color: red'>(+2 [+0.7%])</span> 295 |
| `execute_metered_time_ms` | <span style='color: red'>(+2 [+5.6%])</span> 38 | -          | -          | -          |
| `execute_metered_insns` |  12,000,265 | -          | -          | -          |
| `execute_metered_insn_mi/s` | <span style='color: green'>(-11 [-3.2%])</span> 315.63 | -          | <span style='color: green'>(-11 [-3.2%])</span> 315.63 | <span style='color: green'>(-11 [-3.2%])</span> 315.63 |
| `execute_preflight_insns` |  3,000,066.25 |  12,000,265 |  3,495,000 |  1,515,265 |
| `execute_preflight_time_ms` | <span style='color: red'>(+11 [+13.5%])</span> 94.50 | <span style='color: red'>(+45 [+13.5%])</span> 378 | <span style='color: red'>(+15 [+14.0%])</span> 122 | <span style='color: red'>(+10 [+25.6%])</span> 49 |
| `execute_preflight_insn_mi/s` | <span style='color: green'>(-6 [-8.7%])</span> 60.38 | -          | <span style='color: green'>(-6 [-8.5%])</span> 64.96 | <span style='color: green'>(-1 [-2.3%])</span> 50.46 |
| `trace_gen_time_ms   ` | <span style='color: green'>(-6 [-14.6%])</span> 36.50 | <span style='color: green'>(-25 [-14.6%])</span> 146 | <span style='color: green'>(-8 [-10.1%])</span> 71 |  21 |
...
| `prover.rap_constraints.logup_gkr_time_ms` | <span style='color: red'>(+0 [+0.3%])</span> 79 | <span style='color: red'>(+1 [+0.3%])</span> 316 |  89 |  50 |
...
| `prover.openings.whir_time_ms` | <span style='color: red'>(+0 [+0.7%])</span> 33.75 | <span style='color: red'>(+1 [+0.7%])</span> 135 |  37 |  25 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+4 [+1.1%])</span> 367 | <span style='color: red'>(+4 [+1.1%])</span> 367 | <span style='color: red'>(+4 [+1.1%])</span> 367 | <span style='color: red'>(+4 [+1.1%])</span> 367 |
| `execute_preflight_time_ms` |  1 |  1 |  1 |  1 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+1 [+1.4%])</span> 71 | <span style='color: red'>(+1 [+1.4%])</span> 71 | <span style='color: red'>(+1 [+1.4%])</span> 71 | <span style='color: red'>(+1 [+1.4%])</span> 71 |
| `generate_blob_total_time_ms` |  4 |  4 |  4 |  4 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+2 [+0.7%])</span> 295 | <span style='color: red'>(+2 [+0.7%])</span> 295 | <span style='color: red'>(+2 [+0.7%])</span> 295 | <span style='color: red'>(+2 [+0.7%])</span> 295 |
| `prover.main_trace_commit_time_ms` |  90 |  90 |  90 |  90 |
| `prover.rap_constraints_time_ms` | <span style='color: red'>(+2 [+1.7%])</span> 120 | <span style='color: red'>(+2 [+1.7%])</span> 120 | <span style='color: red'>(+2 [+1.7%])</span> 120 | <span style='color: red'>(+2 [+1.7%])</span> 120 |
| `prover.openings_time_ms` |  84 |  84 |  84 |  84 |
| `prover.rap_constraints.logup_gkr_time_ms` |  23 |  23 |  23 |  23 |
| `prover.rap_constraints.round0_time_ms` | <span style='color: red'>(+1 [+1.7%])</span> 59 | <span style='color: red'>(+1 [+1.7%])</span> 59 | <span style='color: red'>(+1 [+1.7%])</span> 59 | <span style='color: red'>(+1 [+1.7%])</span> 59 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+7 [+3.6%])</span> 199 | <span style='color: red'>(+7 [+3.6%])</span> 199 | <span style='color: red'>(+7 [+3.6%])</span> 199 | <span style='color: red'>(+7 [+3.6%])</span> 199 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: green'>(-4 [-3.1%])</span> 123 | <span style='color: green'>(-4 [-3.1%])</span> 123 | <span style='color: green'>(-4 [-3.1%])</span> 123 | <span style='color: green'>(-4 [-3.1%])</span> 123 |
| `execute_preflight_time_ms` |  2 |  2 |  2 |  2 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/64cc734946fa93cd50ba730d992f037f8fb25b1c/fibonacci-64cc734946fa93cd50ba730d992f037f8fb25b1c.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 65 |  |  |  | 311 |  |  |  |  |  |  | 
| app_proof |  |  |  | 295 |  | 38 | 12,000,265 | 315.63 | 0 | 1,652 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 180 | 46 | 0 | 0 | 81 | 29 | 28 | 37 | 14 | 0 | 52 | 41 | 10 | 2 | 7 | 47 | 46 | 81 | 0 | 1 | 12 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 111 | 20 | 0 | 0 | 57 | 22 | 21 | 23 | 11 | 0 | 32 | 24 | 7 | 1 | 6 | 20 | 20 | 57 | 0 | 1 | 10 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 97 | 15 | 0 | 0 | 55 | 21 | 20 | 21 | 11 | 0 | 27 | 19 | 7 | 1 | 5 | 15 | 15 | 55 | 0 | 1 | 10 | 0 | 0 | 
| leaf | 0 | prover | 147,934,254 | 295 | 90 | 0 | 0 | 120 | 59 | 57 | 37 | 23 | 0 | 84 | 68 | 16 | 6 | 9 | 90 | 90 | 120 | 0 | 3 | 22 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 136,618,310 | 234 | 45 | 0 | 0 | 138 | 32 | 32 | 16 | 88 | 0 | 50 | 37 | 12 | 6 | 6 | 45 | 45 | 137 | 0 | 1 | 87 | 0 | 0 | 
| app_proof | prover | 1 | 136,570,844 | 229 | 45 | 0 | 0 | 134 | 28 | 28 | 16 | 89 | 0 | 48 | 37 | 11 | 5 | 5 | 45 | 45 | 134 | 0 | 1 | 88 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 135 | 32 | 503 | 32 | 135 | 2,770,199,817 | 323,294,035 | 3,093,493,852 | 2,097,152 | 0 | 2 | 100 | 3,495,000 | 50.46 | 
| app_proof | 1 | 37 | 21 | 410 | 21 | 37 | 2,768,863,045 | 322,353,750 | 3,091,216,795 | 2,097,152 | 0 | 1 | 122 | 3,495,000 | 64.96 | 
| app_proof | 2 | 37 | 22 | 395 | 22 | 37 | 2,768,863,045 | 322,353,750 | 3,091,216,795 | 2,097,152 | 0 | 2 | 107 | 3,495,000 | 64.20 | 
| app_proof | 3 | 35 | 71 | 295 | 71 | 35 | 1,230,958,923 | 342,872,922 | 1,573,831,845 | 2,097,152 | 0 | 2 | 49 | 1,515,265 | 61.88 | 

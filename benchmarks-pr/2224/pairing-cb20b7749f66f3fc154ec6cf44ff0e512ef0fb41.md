...
| `total_proof_time_ms ` |  753.50 |  1,507 |  844 |  663 |
...
| `execute_preflight_time_ms` |  95 |  190 |  129 |  61 |
| `execute_preflight_insn_mi/s` |  13.84 | -          |  18.45 |  9.24 |
| `trace_gen_time_ms   ` |  173.50 |  347 |  189 |  158 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  391 |  782 |  410 |  372 |
| `main_trace_commit_time_ms` |  63.50 |  127 |  74 |  53 |
| `generate_perm_trace_time_ms` |  55 |  110 |  71 |  39 |
| `perm_trace_commit_time_ms` |  76.02 |  152.04 |  88.05 |  63.99 |
| `quotient_poly_compute_time_ms` |  76.71 |  153.41 |  84.80 |  68.61 |
| `quotient_poly_commit_time_ms` |  15.51 |  31.02 |  16.100 |  14.02 |
| `pcs_opening_time_ms ` |  99 |  198 |  102 |  96 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 663 | 40 | 1 | 90 | 1,745,742 | 19.24 | 145 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 158 | 844 | 32,689,110 | 172,558,444 | 158 | 410 | 0 | 84.80 | 16.100 | 6 | 88.05 | 102 | 130 | 102 | 1 | 74 | 16,059,916 | 39 | 129 | 1,157,000 | 9.24 | 26 | 102 | 1 | 102 | 
| pairing | 1 | 189 | 663 | 22,314,288 | 119,958,502 | 189 | 372 | 1 | 68.61 | 14.02 | 6 | 63.99 | 96 | 138 | 96 | 0 | 53 | 9,408,294 | 71 | 61 | 588,742 | 18.45 | 20 | 83 | 1 | 96 | 

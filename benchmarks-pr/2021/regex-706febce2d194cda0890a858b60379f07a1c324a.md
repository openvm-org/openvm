...
| `total_proof_time_ms ` |  3,813 |  7,626 |  4,877 |  2,749 |
...
| `trace_gen_time_ms   ` |  376.50 |  753 |  483 |  270 |
| `memory_finalize_time_ms` |  9 |  18 |  14 |  4 |
| `stark_prove_excluding_trace_time_ms` |  3,108.50 |  6,217 |  4,048 |  2,169 |
| `main_trace_commit_time_ms` |  627 |  1,254 |  845 |  409 |
| `generate_perm_trace_time_ms` |  236 |  472 |  301 |  171 |
| `perm_trace_commit_time_ms` |  650 |  1,300 |  853 |  447 |
| `quotient_poly_compute_time_ms` |  333.50 |  667 |  450 |  217 |
| `quotient_poly_commit_time_ms` |  295.50 |  591 |  396 |  195 |
| `pcs_opening_time_ms ` |  957 |  1,914 |  1,194 |  720 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2,749 | 7 | 1 | 31 | 4,108,597 | 129.64 | 45 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 483 | 4,877 | 211,758,557 | 373,183,036 | 483 | 4,048 | 0 | 450 | 396 | 853 | 1,194 | 7 | 14 | 845 | 91,281,687 | 301 | 102 | 2,211,000 | 26.15 | 
| regex_program | 1 | 270 | 2,749 | 174,326,267 | 196,838,026 | 270 | 2,169 | 49 | 217 | 195 | 447 | 720 | 6 | 4 | 409 | 73,453,305 | 171 | 87 | 1,897,597 | 30.98 | 

...
| `execute_preflight_insn_mi/s` |  28.41 | -          |  30.81 |  26 |
| `trace_gen_time_ms   ` |  390 |  780 |  500 |  280 |
| `memory_finalize_time_ms` |  7.50 |  15 |  13 |  2 |
| `stark_prove_excluding_trace_time_ms` |  3,087.50 |  6,175 |  4,041 |  2,134 |
| `main_trace_commit_time_ms` |  623 |  1,246 |  832 |  414 |
| `generate_perm_trace_time_ms` |  237.50 |  475 |  324 |  151 |
| `perm_trace_commit_time_ms` |  657 |  1,314 |  869 |  445 |
| `quotient_poly_compute_time_ms` |  315.50 |  631 |  430 |  201 |
| `quotient_poly_commit_time_ms` |  298 |  596 |  393 |  203 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2,712 | 7 | 1 | 32 | 4,108,597 | 128.18 | 44 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 500 | 4,883 | 211,758,557 | 373,183,036 | 500 | 4,041 | 0 | 430 | 393 | 869 | 1,188 | 7 | 13 | 832 | 91,281,687 | 324 | 100 | 2,211,000 | 26 | 
| regex_program | 1 | 280 | 2,712 | 174,326,267 | 196,838,026 | 280 | 2,134 | 52 | 201 | 203 | 445 | 710 | 6 | 2 | 414 | 73,453,305 | 151 | 84 | 1,897,597 | 30.81 | 

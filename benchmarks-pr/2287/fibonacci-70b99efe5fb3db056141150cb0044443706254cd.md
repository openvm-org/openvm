...
|:---|---:|---:|
| Total | <span style='color: red'>(+0 [+2.8%])</span> 1.01 | <span style='color: red'>(+0 [+4.3%])</span> 0.58 |
| fibonacci_program | <span style='color: red'>(+0 [+2.8%])</span> 0.99 | <span style='color: red'>(+0 [+4.4%])</span> 0.57 |


| fibonacci_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+14 [+2.8%])</span> 497 | <span style='color: red'>(+27 [+2.8%])</span> 994 | <span style='color: red'>(+24 [+4.4%])</span> 571 | <span style='color: red'>(+3 [+0.7%])</span> 423 |
...
| `execute_metered_insn_mi/s` | <span style='color: red'>(+2 [+1.5%])</span> 113.47 | -          | <span style='color: red'>(+2 [+1.5%])</span> 113.47 | <span style='color: red'>(+2 [+1.5%])</span> 113.47 |
...
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+0 [+1.0%])</span> 36.99 | -          | <span style='color: red'>(+1 [+1.7%])</span> 39.08 | <span style='color: red'>(+0 [+0.2%])</span> 34.89 |
...
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+14 [+7.8%])</span> 186.50 | <span style='color: red'>(+27 [+7.8%])</span> 373 | <span style='color: red'>(+25 [+13.6%])</span> 209 | <span style='color: red'>(+2 [+1.2%])</span> 164 |
...
| `generate_perm_trace_time_ms` | <span style='color: red'>(+12 [+88.9%])</span> 25.50 | <span style='color: red'>(+24 [+88.9%])</span> 51 | <span style='color: red'>(+20 [+125.0%])</span> 36 | <span style='color: red'>(+4 [+36.4%])</span> 15 |
| `perm_trace_commit_time_ms` | <span style='color: red'>(+0 [+0.2%])</span> 41.21 | <span style='color: red'>(+0 [+0.2%])</span> 82.42 | <span style='color: green'>(-1 [-2.5%])</span> 43.12 | <span style='color: red'>(+1 [+3.4%])</span> 39.30 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+0 [+1.5%])</span> 31.63 | <span style='color: red'>(+1 [+1.5%])</span> 63.27 | <span style='color: red'>(+2 [+5.7%])</span> 33.99 | <span style='color: green'>(-1 [-2.9%])</span> 29.28 |
| `quotient_poly_commit_time_ms` | <span style='color: green'>(-0 [-0.9%])</span> 12.22 | <span style='color: green'>(-0 [-0.9%])</span> 24.44 | <span style='color: green'>(-0 [-3.5%])</span> 12.34 | <span style='color: red'>(+0 [+2.0%])</span> 12.10 |
...
| --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 423 | 1 | 13 | 1,500,209 | 113.47 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 194 | 571 | 9,677,708 | 84,395,212 | 194 | 209 | 0 | 33.99 | 12.34 | 5 | 43.12 | 49 | 80 | 49 | 0 | 32 | 1,035,986 | 36 | 25 | 873,000 | 34.89 | 13 | 46 | 0 | 49 | 
| fibonacci_program | 1 | 184 | 423 | 9,708,170 | 74,305,770 | 184 | 164 | 1 | 29.28 | 12.10 | 4 | 39.30 | 39 | 54 | 39 | 0 | 28 | 1,064,416 | 15 | 33 | 627,209 | 39.08 | 11 | 41 | 0 | 39 | 

...
| `total_proof_time_ms ` |  952 |  1,904 |  1,226 |  678 |
| `execute_metered_time_ms` |  34 | -          | -          | -          |
| `execute_metered_insns` |  2,579,903 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  74.04 | -          |  74.04 |  74.04 |
| `execute_preflight_insns` |  1,289,951.50 |  2,579,903 |  1,540,000 |  1,039,903 |
| `execute_preflight_time_ms` |  99.50 |  199 |  134 |  65 |
| `execute_preflight_insn_mi/s` |  34.62 | -          |  36.19 |  33.04 |
...
| `prover.rap_constraints_time_ms` |  453.50 |  907 |  599 |  308 |
| `prover.openings_time_ms` |  48 |  96 |  55 |  41 |
| `prover.rap_constraints.logup_gkr_time_ms` |  83 |  166 |  112 |  54 |
| `prover.rap_constraints.round0_time_ms` |  267 |  534 |  356 |  178 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/2ef2c8f150e8c51e46b8078adcdd68c7630d9fb4/kitchen_sink-2ef2c8f150e8c51e46b8078adcdd68c7630d9fb4.memory.svg)
...
| app_proof |  |  |  |  |  | 678 |  |  | 34 | 2,579,903 | 74.04 | 0 | 1,944 |  | 
...
| leaf | 0 | 112 | 413 | 111 | 23 | 9 | 21 | 4 | 4 | 
...
| leaf | 0 | prover | 265,006,708 | 301 | 129 | 0 | 1 | 142 | 49 | 48 | 37 | 55 | 0 | 28 | 13 | 15 | 7 | 8 | 129 | 142 | 0 | 2 | 54 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 567,917,156 | 947 | 291 | 0 | 162 | 599 | 356 | 355 | 130 | 112 | 55 | 55 | 14 | 41 | 16 | 25 | 292 | 599 | 0 | 1 | 55 | 0 | 0 | 
| app_proof | prover | 1 | 537,266,124 | 487 | 137 | 0 | 2 | 308 | 178 | 177 | 76 | 54 | 0 | 41 | 13 | 27 | 14 | 13 | 137 | 308 | 0 | 1 | 53 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 34 | 1,226 | 34 | 178 | 0 | 3 | 65 | 1,540,000 | 33.04 | 
| app_proof | 1 | 16 | 678 | 16 | 40 | 0 | 1 | 134 | 1,039,903 | 36.19 | 

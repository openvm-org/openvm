...
| `total_proof_time_ms ` |  712 |  1,424 |  775 |  649 |
...
| `execute_preflight_time_ms` |  74.50 |  149 |  78 |  71 |
| `execute_preflight_insn_mi/s` |  38.81 | -          |  39.17 |  38.45 |
| `trace_gen_time_ms   ` |  153.50 |  307 |  154 |  153 |
| `memory_finalize_time_ms` |  1 |  2 |  2 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  381.50 |  763 |  383 |  380 |
| `prover.main_trace_commit_time_ms` |  95.50 |  191 |  101 |  90 |
| `prover.rap_constraints_time_ms` |  245 |  490 |  255 |  235 |
| `prover.openings_time_ms` |  39.50 |  79 |  42 |  37 |
| `prover.rap_constraints.logup_gkr_time_ms` |  139.50 |  279 |  142 |  137 |
| `prover.rap_constraints.round0_time_ms` |  72 |  144 |  87 |  57 |
| `prover.rap_constraints.mle_rounds_time_ms` |  32 |  64 |  35 |  29 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/135025cdc9b4abc301e2ce792bd5f2c3d43c1ed5/regex-135025cdc9b4abc301e2ce792bd5f2c3d43c1ed5.memory.svg)
...
| app_proof |  |  |  |  |  | 649 |  |  | 31 | 4,137,067 | 129.70 | 0 | 1,470 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 27,256,571 | 212 | 82 | 0 | 0 | 98 | 32 | 31 | 46 | 20 | 0 | 30 | 19 | 11 | 2 | 8 | 83 | 98 | 0 | 2 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,703 | 141 | 46 | 0 | 0 | 67 | 25 | 24 | 28 | 13 | 0 | 26 | 18 | 8 | 1 | 6 | 47 | 67 | 0 | 2 | 12 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 122 | 32 | 0 | 0 | 62 | 23 | 22 | 24 | 13 | 0 | 28 | 20 | 7 | 1 | 5 | 32 | 62 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 79,962,804 | 315 | 129 | 0 | 0 | 137 | 56 | 55 | 38 | 42 | 0 | 46 | 31 | 15 | 6 | 8 | 130 | 137 | 0 | 5 | 42 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 123,384,338 | 380 | 101 | 0 | 0 | 235 | 57 | 56 | 35 | 142 | 0 | 42 | 22 | 20 | 10 | 9 | 101 | 235 | 0 | 3 | 140 | 0 | 0 | 
| app_proof | prover | 1 | 106,568,591 | 383 | 90 | 0 | 8 | 255 | 87 | 87 | 29 | 137 | 0 | 37 | 18 | 19 | 8 | 10 | 90 | 255 | 0 | 3 | 136 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 153 | 775 | 153 | 162 | 2 | 7 | 78 | 2,208,000 | 39.17 | 
| app_proof | 1 | 154 | 649 | 154 | 41 | 0 | 2 | 71 | 1,929,067 | 38.45 | 

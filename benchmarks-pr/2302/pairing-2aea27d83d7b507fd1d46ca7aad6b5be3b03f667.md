...
|:---|---:|---:|
| Total |  1.54 | <span style='color: red'>(+0 [+0.9%])</span> 0.92 |
| pairing | <span style='color: red'>(+0 [+0.1%])</span> 1.47 | <span style='color: red'>(+0 [+1.3%])</span> 0.86 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+1 [+0.1%])</span> 736.50 | <span style='color: red'>(+2 [+0.1%])</span> 1,473 | <span style='color: red'>(+11 [+1.3%])</span> 861 | <span style='color: green'>(-9 [-1.4%])</span> 612 |
...
| `execute_metered_time_ms` | <span style='color: green'>(-3 [-4.5%])</span> 63 | -          | -          | -          |
| `execute_metered_insn_mi/s` | <span style='color: red'>(+1 [+4.5%])</span> 27.42 | -          | <span style='color: red'>(+1 [+4.5%])</span> 27.42 | <span style='color: red'>(+1 [+4.5%])</span> 27.42 |
...
| `execute_preflight_time_ms` |  82.50 |  165 | <span style='color: green'>(-1 [-1.0%])</span> 104 | <span style='color: red'>(+1 [+1.7%])</span> 61 |
| `execute_preflight_insn_mi/s` | <span style='color: green'>(-0 [-0.2%])</span> 14.79 | -          | <span style='color: green'>(-0 [-1.2%])</span> 18.18 | <span style='color: red'>(+0 [+1.4%])</span> 11.40 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+1 [+0.5%])</span> 189.50 | <span style='color: red'>(+2 [+0.5%])</span> 379 |  193 | <span style='color: red'>(+2 [+1.1%])</span> 186 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: green'>(-0 [-0.1%])</span> 358.50 | <span style='color: green'>(-1 [-0.1%])</span> 717 | <span style='color: red'>(+10 [+2.6%])</span> 401 | <span style='color: green'>(-11 [-3.4%])</span> 316 |
| `main_trace_commit_time_ms` | <span style='color: red'>(+2 [+2.4%])</span> 65 | <span style='color: red'>(+3 [+2.4%])</span> 130 | <span style='color: red'>(+2 [+2.7%])</span> 76 | <span style='color: red'>(+1 [+1.9%])</span> 54 |
| `generate_perm_trace_time_ms` | <span style='color: red'>(+10 [+29.9%])</span> 43.50 | <span style='color: red'>(+20 [+29.9%])</span> 87 | <span style='color: red'>(+13 [+34.2%])</span> 51 | <span style='color: red'>(+7 [+24.1%])</span> 36 |
| `perm_trace_commit_time_ms` | <span style='color: green'>(-0 [-0.4%])</span> 77.19 | <span style='color: green'>(-1 [-0.4%])</span> 154.38 | <span style='color: red'>(+0 [+0.3%])</span> 89.86 | <span style='color: green'>(-1 [-1.2%])</span> 64.52 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+1 [+1.1%])</span> 84.60 | <span style='color: red'>(+2 [+1.1%])</span> 169.20 | <span style='color: green'>(-0 [-0.4%])</span> 93.30 | <span style='color: red'>(+2 [+2.9%])</span> 75.90 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+0 [+1.2%])</span> 17.75 | <span style='color: red'>(+0 [+1.2%])</span> 35.50 | <span style='color: red'>(+0 [+0.2%])</span> 20.04 | <span style='color: red'>(+0 [+2.7%])</span> 15.45 |
| `pcs_opening_time_ms ` | <span style='color: green'>(-12 [-15.5%])</span> 65.50 | <span style='color: green'>(-24 [-15.5%])</span> 131 | <span style='color: green'>(-19 [-22.4%])</span> 66 | <span style='color: green'>(-5 [-7.1%])</span> 65 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 612 | 1 | 63 | 1,745,757 | 27.42 | 0 | 
...
| pairing | Rv32HintStoreAir | 2 | 18 | 29 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 186 | 861 | 32,579,050 | 172,558,444 | 186 | 401 | 0 | 93.30 | 20.04 | 7 | 89.86 | 66 | 143 | 66 | 1 | 76 | 15,992,408 | 51 | 104 | 1,151,000 | 11.40 | 27 | 114 | 1 | 66 | 
| pairing | 1 | 193 | 612 | 22,427,652 | 119,958,502 | 193 | 316 | 1 | 75.90 | 15.45 | 6 | 64.52 | 65 | 104 | 65 | 0 | 54 | 9,471,642 | 36 | 61 | 594,757 | 18.18 | 21 | 91 | 1 | 65 | 
...
Commit: https://github.com/openvm-org/openvm/commit/2aea27d83d7b507fd1d46ca7aad6b5be3b03f667
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19998258927)

...
|:---|---:|---:|
| Total |  2.40 | <span style='color: green'>(-0 [-4.0%])</span> 0.76 |
| regex_program |  2.36 | <span style='color: green'>(-0 [-4.2%])</span> 0.73 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  590.50 |  2,362 | <span style='color: green'>(-32 [-4.2%])</span> 725 | <span style='color: red'>(+5 [+0.9%])</span> 537 |
...
| `execute_metered_insn_mi/s` | <span style='color: red'>(+0 [+0.1%])</span> 108.56 | -          | <span style='color: red'>(+0 [+0.1%])</span> 108.56 | <span style='color: red'>(+0 [+0.1%])</span> 108.56 |
| `execute_preflight_insns` |  1,034,378 |  4,137,512 |  1,104,000 |  826,512 |
| `execute_preflight_time_ms` |  52.75 |  211 | <span style='color: green'>(-2 [-3.1%])</span> 63 |  44 |
| `execute_preflight_insn_mi/s` | <span style='color: green'>(-1 [-1.6%])</span> 31.46 | -          | <span style='color: red'>(+0 [+0.9%])</span> 33.67 | <span style='color: red'>(+0 [+0.7%])</span> 28.82 |
| `trace_gen_time_ms   ` | <span style='color: green'>(-1 [-0.4%])</span> 178.75 | <span style='color: green'>(-3 [-0.4%])</span> 715 | <span style='color: green'>(-1 [-0.5%])</span> 211 | <span style='color: red'>(+2 [+1.3%])</span> 158 |
| `memory_finalize_time_ms` |  1 |  4 |  4 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+1 [+0.4%])</span> 285.25 | <span style='color: red'>(+5 [+0.4%])</span> 1,141 | <span style='color: green'>(-30 [-9.1%])</span> 299 | <span style='color: red'>(+8 [+3.0%])</span> 274 |
| `main_trace_commit_time_ms` | <span style='color: green'>(-1 [-1.9%])</span> 50.75 | <span style='color: green'>(-4 [-1.9%])</span> 203 | <span style='color: green'>(-1 [-1.8%])</span> 56 | <span style='color: green'>(-1 [-2.0%])</span> 49 |
| `generate_perm_trace_time_ms` | <span style='color: green'>(-2 [-4.6%])</span> 31 | <span style='color: green'>(-6 [-4.6%])</span> 124 | <span style='color: green'>(-15 [-27.3%])</span> 40 | <span style='color: red'>(+7 [+36.8%])</span> 26 |
| `perm_trace_commit_time_ms` | <span style='color: red'>(+1 [+1.2%])</span> 64.83 | <span style='color: red'>(+3 [+1.2%])</span> 259.31 | <span style='color: red'>(+2 [+2.5%])</span> 71.89 | <span style='color: green'>(-1 [-1.5%])</span> 54.78 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+1 [+2.4%])</span> 60.05 | <span style='color: red'>(+6 [+2.4%])</span> 240.19 | <span style='color: red'>(+0 [+0.6%])</span> 70.90 | <span style='color: red'>(+6 [+13.0%])</span> 54.26 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+0 [+2.3%])</span> 16.12 | <span style='color: red'>(+1 [+2.3%])</span> 64.47 | <span style='color: green'>(-0 [-0.7%])</span> 18.62 | <span style='color: green'>(-0 [-0.5%])</span> 13.39 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+2 [+3.0%])</span> 59.50 | <span style='color: red'>(+7 [+3.0%])</span> 238 | <span style='color: red'>(+1 [+1.6%])</span> 64 | <span style='color: red'>(+3 [+5.8%])</span> 55 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 563 | 1 | 38 | 4,137,512 | 108.56 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 211 | 725 | 23,437,436 | 150,778,428 | 211 | 299 | 0 | 60.71 | 18.62 | 5 | 71.89 | 64 | 99 | 63 | 4 | 56 | 10,891,066 | 26 | 44 | 1,103,000 | 28.82 | 22 | 80 | 1 | 63 | 
| regex_program | 1 | 158 | 537 | 11,597,664 | 128,513,066 | 158 | 275 | 1 | 54.26 | 16.33 | 4 | 66.51 | 59 | 94 | 59 | 0 | 49 | 2,195,390 | 27 | 63 | 1,104,000 | 33.46 | 17 | 71 | 0 | 59 | 
| regex_program | 2 | 161 | 537 | 11,579,760 | 128,513,066 | 161 | 274 | 1 | 54.32 | 16.13 | 4 | 66.13 | 55 | 97 | 55 | 0 | 49 | 2,177,774 | 31 | 60 | 1,104,000 | 29.91 | 17 | 71 | 0 | 55 | 
| regex_program | 3 | 185 | 563 | 11,853,280 | 103,456,394 | 185 | 293 | 0 | 70.90 | 13.39 | 5 | 54.78 | 60 | 98 | 60 | 0 | 49 | 2,421,998 | 40 | 44 | 826,512 | 33.67 | 18 | 85 | 1 | 60 | 

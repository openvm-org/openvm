...
|:---|---:|---:|
| Total | <span style='color: green'>(-0 [-0.3%])</span> 2.37 | <span style='color: red'>(+0 [+2.3%])</span> 0.77 |
| regex_program | <span style='color: green'>(-0 [-0.3%])</span> 2.33 | <span style='color: red'>(+0 [+2.4%])</span> 0.73 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: green'>(-2 [-0.3%])</span> 582.50 | <span style='color: green'>(-8 [-0.3%])</span> 2,330 | <span style='color: red'>(+17 [+2.4%])</span> 734 | <span style='color: green'>(-17 [-3.2%])</span> 520 |
...
| `execute_metered_insn_mi/s` | <span style='color: red'>(+1 [+0.6%])</span> 108.59 | -          | <span style='color: red'>(+1 [+0.6%])</span> 108.59 | <span style='color: red'>(+1 [+0.6%])</span> 108.59 |
| `execute_preflight_insns` |  1,034,378 |  4,137,512 |  1,104,000 |  826,512 |
| `execute_preflight_time_ms` | <span style='color: green'>(-2 [-3.8%])</span> 51.25 | <span style='color: green'>(-8 [-3.8%])</span> 205 | <span style='color: green'>(-3 [-4.6%])</span> 62 | <span style='color: green'>(-2 [-4.4%])</span> 43 |
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+1 [+2.6%])</span> 32.64 | -          | <span style='color: red'>(+1 [+3.4%])</span> 34.08 | <span style='color: red'>(+1 [+2.3%])</span> 29.37 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+2 [+1.3%])</span> 180.25 | <span style='color: red'>(+9 [+1.3%])</span> 721 | <span style='color: red'>(+1 [+0.5%])</span> 212 | <span style='color: red'>(+4 [+2.6%])</span> 159 |
| `memory_finalize_time_ms` |  1 |  4 |  4 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: green'>(-2 [-0.5%])</span> 277.75 | <span style='color: green'>(-6 [-0.5%])</span> 1,111 | <span style='color: red'>(+20 [+6.9%])</span> 310 | <span style='color: green'>(-14 [-5.2%])</span> 257 |
| `main_trace_commit_time_ms` | <span style='color: green'>(-1 [-1.4%])</span> 51 | <span style='color: green'>(-3 [-1.4%])</span> 204 |  57 | <span style='color: green'>(-1 [-2.0%])</span> 49 |
| `generate_perm_trace_time_ms` | <span style='color: red'>(+3 [+11.7%])</span> 31 | <span style='color: red'>(+13 [+11.7%])</span> 124 | <span style='color: red'>(+5 [+12.8%])</span> 44 |  20 |
| `perm_trace_commit_time_ms` |  63.96 |  255.82 | <span style='color: red'>(+1 [+0.9%])</span> 70.72 | <span style='color: green'>(-2 [-2.8%])</span> 54.40 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+0 [+0.5%])</span> 58.48 | <span style='color: red'>(+1 [+0.5%])</span> 233.93 | <span style='color: red'>(+2 [+2.2%])</span> 71.25 | <span style='color: green'>(-1 [-2.5%])</span> 51.61 |
| `quotient_poly_commit_time_ms` | <span style='color: green'>(-1 [-3.8%])</span> 15.09 | <span style='color: green'>(-2 [-3.8%])</span> 60.37 | <span style='color: green'>(-1 [-2.8%])</span> 17.79 | <span style='color: green'>(-1 [-6.8%])</span> 12.88 |
| `pcs_opening_time_ms ` | <span style='color: green'>(-4 [-6.4%])</span> 54.75 | <span style='color: green'>(-15 [-6.4%])</span> 219 | <span style='color: red'>(+4 [+6.6%])</span> 65 | <span style='color: green'>(-8 [-14.5%])</span> 47 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 540 | 1 | 38 | 4,137,512 | 108.59 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 212 | 734 | 23,437,436 | 150,778,428 | 212 | 310 | 0 | 58.85 | 17.79 | 5 | 70.72 | 65 | 109 | 65 | 4 | 57 | 10,891,066 | 37 | 44 | 1,103,000 | 29.37 | 22 | 77 | 1 | 65 | 
| regex_program | 1 | 159 | 520 | 11,597,664 | 128,513,066 | 159 | 257 | 1 | 52.22 | 14.70 | 4 | 65.74 | 53 | 86 | 53 | 0 | 49 | 2,195,390 | 20 | 62 | 1,104,000 | 33.55 | 16 | 67 | 0 | 53 | 
| regex_program | 2 | 164 | 536 | 11,579,760 | 128,513,066 | 164 | 274 | 1 | 51.61 | 15 | 4 | 64.95 | 47 | 109 | 47 | 0 | 49 | 2,177,774 | 44 | 56 | 1,104,000 | 33.57 | 16 | 67 | 0 | 47 | 
| regex_program | 3 | 186 | 540 | 11,853,280 | 103,456,394 | 186 | 270 | 0 | 71.25 | 12.88 | 5 | 54.40 | 54 | 81 | 54 | 0 | 49 | 2,421,998 | 23 | 43 | 826,512 | 34.08 | 18 | 85 | 1 | 54 | 

...
|:---|---:|---:|
| Total | <span style='color: red'>(+0 [+1.5%])</span> 2.43 | <span style='color: green'>(-0 [-2.0%])</span> 0.78 |
| regex_program | <span style='color: red'>(+0 [+1.6%])</span> 2.40 | <span style='color: green'>(-0 [-2.0%])</span> 0.74 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+9 [+1.6%])</span> 599.25 | <span style='color: red'>(+37 [+1.6%])</span> 2,397 | <span style='color: green'>(-15 [-2.0%])</span> 742 | <span style='color: red'>(+1 [+0.2%])</span> 533 |
...
| `execute_metered_insn_mi/s` | <span style='color: red'>(+1 [+1.0%])</span> 109.51 | -          | <span style='color: red'>(+1 [+1.0%])</span> 109.51 | <span style='color: red'>(+1 [+1.0%])</span> 109.51 |
| `execute_preflight_insns` |  1,034,378 |  4,137,512 |  1,104,000 |  826,512 |
| `execute_preflight_time_ms` | <span style='color: green'>(-1 [-1.9%])</span> 51.75 | <span style='color: green'>(-4 [-1.9%])</span> 207 | <span style='color: green'>(-2 [-3.1%])</span> 63 | <span style='color: green'>(-1 [-2.3%])</span> 43 |
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+0 [+1.0%])</span> 32.28 | -          | <span style='color: red'>(+1 [+1.6%])</span> 33.92 | <span style='color: red'>(+0 [+0.8%])</span> 28.85 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+8 [+4.2%])</span> 187 | <span style='color: red'>(+30 [+4.2%])</span> 748 | <span style='color: red'>(+11 [+5.2%])</span> 223 | <span style='color: red'>(+5 [+3.2%])</span> 161 |
| `memory_finalize_time_ms` |  1 |  4 |  4 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+2 [+0.7%])</span> 286 | <span style='color: red'>(+8 [+0.7%])</span> 1,144 | <span style='color: green'>(-25 [-7.6%])</span> 304 | <span style='color: red'>(+1 [+0.4%])</span> 267 |
| `main_trace_commit_time_ms` | <span style='color: red'>(+1 [+1.9%])</span> 52.75 | <span style='color: red'>(+4 [+1.9%])</span> 211 | <span style='color: red'>(+2 [+3.5%])</span> 59 |  50 |
| `generate_perm_trace_time_ms` | <span style='color: green'>(-3 [-10.0%])</span> 29.25 | <span style='color: green'>(-13 [-10.0%])</span> 117 | <span style='color: green'>(-14 [-25.5%])</span> 41 | <span style='color: red'>(+4 [+21.1%])</span> 23 |
| `perm_trace_commit_time_ms` | <span style='color: red'>(+3 [+4.9%])</span> 67.20 | <span style='color: red'>(+12 [+4.9%])</span> 268.80 | <span style='color: red'>(+4 [+5.6%])</span> 74.08 | <span style='color: red'>(+1 [+1.8%])</span> 56.65 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+4 [+6.9%])</span> 62.69 | <span style='color: red'>(+16 [+6.9%])</span> 250.75 | <span style='color: red'>(+1 [+2.1%])</span> 71.99 | <span style='color: red'>(+9 [+18.7%])</span> 56.100 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+1 [+6.8%])</span> 16.83 | <span style='color: red'>(+4 [+6.8%])</span> 67.34 | <span style='color: red'>(+1 [+6.0%])</span> 19.87 | <span style='color: red'>(+1 [+7.7%])</span> 14.48 |
| `pcs_opening_time_ms ` | <span style='color: green'>(-3 [-5.2%])</span> 54.75 | <span style='color: green'>(-12 [-5.2%])</span> 219 | <span style='color: green'>(-1 [-1.6%])</span> 62 | <span style='color: green'>(-4 [-7.7%])</span> 48 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 580 | 1 | 37 | 4,137,512 | 109.51 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 223 | 742 | 23,437,436 | 150,778,428 | 223 | 304 | 0 | 63.32 | 19.87 | 5 | 74.08 | 58 | 103 | 57 | 4 | 59 | 10,891,066 | 28 | 44 | 1,103,000 | 28.85 | 22 | 83 | 1 | 57 | 
| regex_program | 1 | 161 | 533 | 11,597,664 | 128,513,066 | 161 | 267 | 1 | 56.100 | 16.42 | 4 | 68.83 | 48 | 94 | 47 | 0 | 50 | 2,195,390 | 25 | 63 | 1,104,000 | 32.95 | 17 | 74 | 0 | 47 | 
| regex_program | 2 | 172 | 542 | 11,579,760 | 128,513,066 | 172 | 271 | 1 | 58.44 | 16.57 | 4 | 69.24 | 51 | 93 | 51 | 0 | 51 | 2,177,774 | 23 | 57 | 1,104,000 | 33.42 | 17 | 75 | 0 | 51 | 
| regex_program | 3 | 192 | 580 | 11,853,280 | 103,456,394 | 192 | 302 | 0 | 71.99 | 14.48 | 5 | 56.65 | 62 | 100 | 62 | 0 | 51 | 2,421,998 | 41 | 43 | 826,512 | 33.92 | 19 | 87 | 1 | 62 | 

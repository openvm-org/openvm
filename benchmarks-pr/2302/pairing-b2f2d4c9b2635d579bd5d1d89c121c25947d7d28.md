...
|:---|---:|---:|
| Total | <span style='color: red'>(+0 [+2.7%])</span> 1.57 | <span style='color: red'>(+0 [+5.6%])</span> 0.96 |
| pairing | <span style='color: red'>(+0 [+2.8%])</span> 1.51 | <span style='color: red'>(+0 [+6.0%])</span> 0.90 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+20 [+2.8%])</span> 754.50 | <span style='color: red'>(+41 [+2.8%])</span> 1,509 | <span style='color: red'>(+51 [+6.0%])</span> 896 | <span style='color: green'>(-10 [-1.6%])</span> 613 |
...
| `execute_metered_insn_mi/s` | <span style='color: red'>(+0 [+0.7%])</span> 27.69 | -          | <span style='color: red'>(+0 [+0.7%])</span> 27.69 | <span style='color: red'>(+0 [+0.7%])</span> 27.69 |
...
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+1 [+5.8%])</span> 14.65 | -          | <span style='color: red'>(+1 [+6.6%])</span> 18.06 | <span style='color: red'>(+0 [+4.5%])</span> 11.25 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+6 [+3.0%])</span> 189.50 | <span style='color: red'>(+11 [+3.0%])</span> 379 | <span style='color: red'>(+4 [+2.1%])</span> 194 | <span style='color: red'>(+7 [+3.9%])</span> 185 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+19 [+5.3%])</span> 376.50 | <span style='color: red'>(+38 [+5.3%])</span> 753 | <span style='color: red'>(+50 [+12.9%])</span> 437 | <span style='color: green'>(-12 [-3.7%])</span> 316 |
| `main_trace_commit_time_ms` | <span style='color: red'>(+2 [+2.3%])</span> 66 | <span style='color: red'>(+3 [+2.3%])</span> 132 | <span style='color: red'>(+1 [+1.3%])</span> 76 | <span style='color: red'>(+2 [+3.7%])</span> 56 |
| `generate_perm_trace_time_ms` | <span style='color: red'>(+23 [+70.8%])</span> 55.50 | <span style='color: red'>(+46 [+70.8%])</span> 111 | <span style='color: red'>(+39 [+108.3%])</span> 75 | <span style='color: red'>(+7 [+24.1%])</span> 36 |
| `perm_trace_commit_time_ms` | <span style='color: red'>(+1 [+0.8%])</span> 77.85 | <span style='color: red'>(+1 [+0.8%])</span> 155.71 | <span style='color: red'>(+0 [+0.2%])</span> 89.91 | <span style='color: red'>(+1 [+1.6%])</span> 65.79 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+1 [+1.0%])</span> 84.48 | <span style='color: red'>(+2 [+1.0%])</span> 168.97 | <span style='color: red'>(+1 [+1.2%])</span> 94.04 | <span style='color: red'>(+1 [+0.9%])</span> 74.92 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+0 [+0.9%])</span> 17.68 | <span style='color: red'>(+0 [+0.9%])</span> 35.36 | <span style='color: red'>(+0 [+1.9%])</span> 20.11 | <span style='color: green'>(-0 [-0.5%])</span> 15.25 |
| `pcs_opening_time_ms ` | <span style='color: green'>(-7 [-9.0%])</span> 70.50 | <span style='color: green'>(-14 [-9.0%])</span> 141 | <span style='color: green'>(-9 [-10.5%])</span> 77 | <span style='color: green'>(-5 [-7.2%])</span> 64 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 613 | 1 | 63 | 1,745,757 | 27.69 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 185 | 896 | 32,579,050 | 172,558,444 | 185 | 437 | 0 | 94.04 | 20.11 | 7 | 89.91 | 77 | 168 | 77 | 1 | 76 | 15,992,408 | 75 | 106 | 1,151,000 | 11.25 | 27 | 115 | 1 | 77 | 
| pairing | 1 | 194 | 613 | 22,427,652 | 119,958,502 | 194 | 316 | 1 | 74.92 | 15.25 | 6 | 65.79 | 64 | 105 | 64 | 0 | 56 | 9,471,642 | 36 | 61 | 594,757 | 18.06 | 21 | 90 | 1 | 64 | 
...
Commit: https://github.com/openvm-org/openvm/commit/b2f2d4c9b2635d579bd5d1d89c121c25947d7d28
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19984455030)

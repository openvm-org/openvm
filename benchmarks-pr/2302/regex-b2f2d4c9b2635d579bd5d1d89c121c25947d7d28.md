...
|:---|---:|---:|
| Total | <span style='color: red'>(+0 [+0.9%])</span> 2.40 | <span style='color: red'>(+0 [+1.1%])</span> 0.76 |
| regex_program | <span style='color: red'>(+0 [+0.9%])</span> 2.36 | <span style='color: red'>(+0 [+1.3%])</span> 0.73 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+6 [+0.9%])</span> 590 | <span style='color: red'>(+22 [+0.9%])</span> 2,360 | <span style='color: red'>(+9 [+1.3%])</span> 726 | <span style='color: green'>(-8 [-1.5%])</span> 529 |
...
| `execute_metered_insn_mi/s` | <span style='color: red'>(+2 [+2.3%])</span> 110.38 | -          | <span style='color: red'>(+2 [+2.3%])</span> 110.38 | <span style='color: red'>(+2 [+2.3%])</span> 110.38 |
| `execute_preflight_insns` |  1,034,378 |  4,137,512 |  1,104,000 |  826,512 |
| `execute_preflight_time_ms` | <span style='color: green'>(-1 [-2.3%])</span> 52 | <span style='color: green'>(-5 [-2.3%])</span> 208 | <span style='color: green'>(-1 [-1.5%])</span> 64 | <span style='color: green'>(-2 [-4.4%])</span> 43 |
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+0 [+1.4%])</span> 32.26 | -          | <span style='color: red'>(+1 [+2.9%])</span> 33.90 | <span style='color: red'>(+0 [+0.8%])</span> 28.94 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+3 [+1.5%])</span> 180.75 | <span style='color: red'>(+11 [+1.5%])</span> 723 | <span style='color: red'>(+4 [+1.9%])</span> 215 | <span style='color: red'>(+2 [+1.3%])</span> 157 |
| `memory_finalize_time_ms` |  1 |  4 |  4 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+4 [+1.4%])</span> 283.25 | <span style='color: red'>(+16 [+1.4%])</span> 1,133 | <span style='color: red'>(+9 [+3.1%])</span> 299 | <span style='color: green'>(-4 [-1.5%])</span> 267 |
| `main_trace_commit_time_ms` |  51.75 |  207 | <span style='color: green'>(-1 [-1.8%])</span> 56 |  50 |
| `generate_perm_trace_time_ms` | <span style='color: red'>(+6 [+23.4%])</span> 34.25 | <span style='color: red'>(+26 [+23.4%])</span> 137 | <span style='color: red'>(+2 [+5.1%])</span> 41 | <span style='color: red'>(+8 [+40.0%])</span> 28 |
| `perm_trace_commit_time_ms` | <span style='color: red'>(+0 [+0.2%])</span> 64.14 | <span style='color: red'>(+1 [+0.2%])</span> 256.54 | <span style='color: red'>(+2 [+2.2%])</span> 71.66 | <span style='color: green'>(-0 [-0.7%])</span> 55.54 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+2 [+3.2%])</span> 60.06 | <span style='color: red'>(+7 [+3.2%])</span> 240.24 | <span style='color: red'>(+1 [+1.0%])</span> 70.36 | <span style='color: red'>(+1 [+1.2%])</span> 53.55 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+0 [+1.4%])</span> 15.91 | <span style='color: red'>(+1 [+1.4%])</span> 63.66 | <span style='color: red'>(+0 [+1.7%])</span> 18.63 | <span style='color: red'>(+0 [+1.7%])</span> 14.04 |
| `pcs_opening_time_ms ` | <span style='color: green'>(-5 [-8.5%])</span> 53.50 | <span style='color: green'>(-20 [-8.5%])</span> 214 | <span style='color: red'>(+1 [+1.6%])</span> 62 | <span style='color: green'>(-9 [-16.4%])</span> 46 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 571 | 1 | 37 | 4,137,512 | 110.38 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 215 | 726 | 23,437,436 | 150,778,428 | 215 | 296 | 0 | 62.66 | 18.63 | 5 | 71.66 | 56 | 100 | 56 | 4 | 56 | 10,891,066 | 28 | 44 | 1,103,000 | 28.94 | 22 | 82 | 1 | 56 | 
| regex_program | 1 | 157 | 534 | 11,597,664 | 128,513,066 | 157 | 271 | 1 | 53.55 | 15.05 | 4 | 64.35 | 46 | 104 | 46 | 0 | 50 | 2,195,390 | 39 | 64 | 1,104,000 | 32.52 | 16 | 69 | 0 | 46 | 
| regex_program | 2 | 164 | 529 | 11,579,760 | 128,513,066 | 164 | 267 | 1 | 53.67 | 15.94 | 4 | 64.99 | 50 | 95 | 50 | 0 | 51 | 2,177,774 | 29 | 57 | 1,104,000 | 33.69 | 17 | 70 | 0 | 50 | 
| regex_program | 3 | 187 | 571 | 11,853,280 | 103,456,394 | 187 | 299 | 0 | 70.36 | 14.04 | 5 | 55.54 | 62 | 100 | 62 | 0 | 50 | 2,421,998 | 41 | 43 | 826,512 | 33.90 | 19 | 85 | 1 | 62 | 

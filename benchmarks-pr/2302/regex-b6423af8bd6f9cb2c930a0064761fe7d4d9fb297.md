...
|:---|---:|---:|---:|
| Total |  2.40 | <span style='color: red'>(+0 [+1.0%])</span> 0.77 | 0.77 |
| regex_program |  2.40 | <span style='color: red'>(+0 [+1.0%])</span> 0.77 |  0.77 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  591.50 |  2,366 | <span style='color: red'>(+8 [+1.1%])</span> 733 | <span style='color: green'>(-14 [-2.6%])</span> 530 |
...
| `execute_metered_insn_mi/s` | <span style='color: red'>(+2 [+1.4%])</span> 110.52 | -          | <span style='color: red'>(+2 [+1.4%])</span> 110.52 | <span style='color: red'>(+2 [+1.4%])</span> 110.52 |
| `execute_preflight_insns` |  1,034,378 |  4,137,512 |  1,104,000 |  826,512 |
| `execute_preflight_time_ms` | <span style='color: green'>(-1 [-1.4%])</span> 52.25 | <span style='color: green'>(-3 [-1.4%])</span> 209 | <span style='color: green'>(-1 [-1.5%])</span> 64 | <span style='color: green'>(-1 [-2.2%])</span> 44 |
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+0 [+0.7%])</span> 32.15 | -          | <span style='color: red'>(+0 [+0.3%])</span> 33.24 | <span style='color: red'>(+0 [+0.3%])</span> 28.96 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+2 [+1.3%])</span> 180.75 | <span style='color: red'>(+9 [+1.3%])</span> 723 | <span style='color: red'>(+4 [+1.9%])</span> 215 | <span style='color: red'>(+3 [+1.9%])</span> 158 |
| `memory_finalize_time_ms` |  1 |  4 |  4 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: green'>(-0 [-0.2%])</span> 285.25 | <span style='color: green'>(-2 [-0.2%])</span> 1,141 | <span style='color: red'>(+6 [+2.0%])</span> 305 | <span style='color: green'>(-6 [-2.2%])</span> 267 |
| `main_trace_commit_time_ms` | <span style='color: red'>(+0 [+0.5%])</span> 51.50 | <span style='color: red'>(+1 [+0.5%])</span> 206 |  56 |  49 |
| `generate_perm_trace_time_ms` | <span style='color: red'>(+11 [+46.9%])</span> 35.25 | <span style='color: red'>(+45 [+46.9%])</span> 141 | <span style='color: red'>(+29 [+103.6%])</span> 57 | <span style='color: green'>(-1 [-4.5%])</span> 21 |
| `perm_trace_commit_time_ms` | <span style='color: red'>(+1 [+0.8%])</span> 65.20 | <span style='color: red'>(+2 [+0.8%])</span> 260.81 | <span style='color: green'>(-1 [-0.8%])</span> 71.17 |  55.63 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+2 [+2.6%])</span> 60.52 | <span style='color: red'>(+6 [+2.6%])</span> 242.09 | <span style='color: red'>(+0 [+0.2%])</span> 70.83 | <span style='color: red'>(+1 [+2.6%])</span> 54.74 |
| `quotient_poly_commit_time_ms` | <span style='color: green'>(-0 [-0.5%])</span> 15.92 | <span style='color: green'>(-0 [-0.5%])</span> 63.67 | <span style='color: green'>(-1 [-3.5%])</span> 17.95 | <span style='color: red'>(+0 [+2.5%])</span> 14.18 |
| `pcs_opening_time_ms ` | <span style='color: green'>(-14 [-21.0%])</span> 53.50 | <span style='color: green'>(-57 [-21.0%])</span> 214 | <span style='color: green'>(-18 [-24.3%])</span> 56 | <span style='color: green'>(-6 [-10.5%])</span> 51 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 541 | 1 | 37 | 4,137,512 | 110.52 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 215 | 733 | 23,437,436 | 150,778,428 | 215 | 305 | 0 | 61.62 | 17.95 | 5 | 71.17 | 56 | 111 | 56 | 4 | 56 | 10,891,066 | 39 | 44 | 1,103,000 | 28.96 | 22 | 80 | 1 | 56 | 
| regex_program | 1 | 158 | 530 | 11,597,664 | 128,513,066 | 158 | 267 | 1 | 54.74 | 16.06 | 4 | 68.16 | 54 | 90 | 54 | 0 | 50 | 2,195,390 | 21 | 64 | 1,104,000 | 33.18 | 17 | 71 | 0 | 54 | 
| regex_program | 2 | 165 | 562 | 11,579,760 | 128,513,066 | 165 | 299 | 1 | 54.89 | 15.49 | 4 | 65.86 | 53 | 123 | 53 | 0 | 51 | 2,177,774 | 57 | 57 | 1,104,000 | 33.23 | 17 | 70 | 0 | 53 | 
| regex_program | 3 | 185 | 541 | 11,853,280 | 103,456,394 | 185 | 270 | 0 | 70.83 | 14.18 | 5 | 55.63 | 51 | 83 | 51 | 0 | 49 | 2,421,998 | 24 | 44 | 826,512 | 33.24 | 19 | 86 | 1 | 51 | 

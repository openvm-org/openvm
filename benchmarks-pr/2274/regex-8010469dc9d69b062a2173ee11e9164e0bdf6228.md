...
|:---|---:|---:|
| Total | <span style='color: red'>(+0 [+0.3%])</span> 2.40 | <span style='color: red'>(+0 [+0.4%])</span> 0.78 |
| regex_program | <span style='color: red'>(+0 [+0.3%])</span> 2.37 | <span style='color: red'>(+0 [+0.4%])</span> 0.75 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+2 [+0.3%])</span> 591.25 | <span style='color: red'>(+6 [+0.3%])</span> 2,365 | <span style='color: red'>(+3 [+0.4%])</span> 746 | <span style='color: red'>(+8 [+1.5%])</span> 535 |
...
| `execute_preflight_time_ms` | <span style='color: green'>(-3 [-5.7%])</span> 54 | <span style='color: green'>(-13 [-5.7%])</span> 216 | <span style='color: green'>(-4 [-5.6%])</span> 67 | <span style='color: green'>(-2 [-4.3%])</span> 45 |
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+1 [+2.4%])</span> 31.92 | -          | <span style='color: red'>(+1 [+1.7%])</span> 33.10 | <span style='color: red'>(+1 [+4.0%])</span> 28.81 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+2 [+1.1%])</span> 178 | <span style='color: red'>(+8 [+1.1%])</span> 712 | <span style='color: red'>(+2 [+0.9%])</span> 214 | <span style='color: red'>(+3 [+2.0%])</span> 153 |
| `memory_finalize_time_ms` |  0.75 |  3 |  3 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+3 [+1.0%])</span> 291.75 | <span style='color: red'>(+12 [+1.0%])</span> 1,167 | <span style='color: red'>(+4 [+1.2%])</span> 342 | <span style='color: red'>(+7 [+2.7%])</span> 270 |
...
| `generate_perm_trace_time_ms` | <span style='color: red'>(+0 [+1.5%])</span> 34.50 | <span style='color: red'>(+2 [+1.5%])</span> 138 |  54 |  19 |
| `perm_trace_commit_time_ms` | <span style='color: green'>(-1 [-0.9%])</span> 63.76 | <span style='color: green'>(-2 [-0.9%])</span> 255.04 | <span style='color: green'>(-2 [-3.0%])</span> 69.21 | <span style='color: red'>(+1 [+0.9%])</span> 56.45 |
| `quotient_poly_compute_time_ms` | <span style='color: green'>(-0 [-0.4%])</span> 58.54 | <span style='color: green'>(-1 [-0.4%])</span> 234.16 | <span style='color: green'>(-1 [-1.9%])</span> 69.21 | <span style='color: green'>(-1 [-1.1%])</span> 52.16 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+0 [+1.3%])</span> 15.01 | <span style='color: red'>(+1 [+1.3%])</span> 60.05 | <span style='color: red'>(+1 [+6.9%])</span> 17.73 | <span style='color: red'>(+0 [+3.4%])</span> 13.31 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+4 [+6.1%])</span> 65 | <span style='color: red'>(+15 [+6.1%])</span> 260 | <span style='color: red'>(+5 [+6.5%])</span> 82 | <span style='color: red'>(+6 [+12.0%])</span> 56 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 540 | 1 | 37 | 4,137,502 | 111.65 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 214 | 746 | 23,446,148 | 150,778,428 | 214 | 342 | 0 | 60.22 | 17.73 | 6 | 69.21 | 82 | 124 | 82 | 3 | 56 | 10,899,170 | 54 | 45 | 1,103,000 | 28.81 | 21 | 78 | 1 | 82 | 
| regex_program | 1 | 153 | 544 | 11,598,276 | 128,513,066 | 153 | 282 | 1 | 52.16 | 14.45 | 4 | 64.38 | 61 | 103 | 61 | 0 | 49 | 2,196,106 | 38 | 67 | 1,104,000 | 32.92 | 16 | 67 | 0 | 61 | 
| regex_program | 2 | 162 | 535 | 11,579,064 | 128,513,066 | 162 | 273 | 1 | 52.56 | 14.56 | 4 | 64.100 | 61 | 92 | 61 | 0 | 51 | 2,177,334 | 27 | 59 | 1,104,000 | 32.85 | 16 | 67 | 0 | 61 | 
| regex_program | 3 | 183 | 540 | 11,853,872 | 103,456,394 | 183 | 270 | 0 | 69.21 | 13.31 | 5 | 56.45 | 56 | 79 | 56 | 0 | 50 | 2,422,606 | 19 | 45 | 826,502 | 33.10 | 18 | 83 | 1 | 56 | 
...
Commit: https://github.com/openvm-org/openvm/commit/8010469dc9d69b062a2173ee11e9164e0bdf6228
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19575061437)

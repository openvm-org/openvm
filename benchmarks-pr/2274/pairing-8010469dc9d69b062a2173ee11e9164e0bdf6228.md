...
|:---|---:|---:|
| Total | <span style='color: red'>(+0 [+1.5%])</span> 1.49 | <span style='color: red'>(+0 [+1.5%])</span> 0.89 |
| pairing | <span style='color: red'>(+0 [+1.6%])</span> 1.43 | <span style='color: red'>(+0 [+1.6%])</span> 0.83 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+11 [+1.6%])</span> 712.50 | <span style='color: red'>(+22 [+1.6%])</span> 1,425 | <span style='color: red'>(+13 [+1.6%])</span> 830 | <span style='color: red'>(+9 [+1.5%])</span> 595 |
...
| `execute_metered_insn_mi/s` | <span style='color: red'>(+0 [+0.1%])</span> 27.33 | -          | <span style='color: red'>(+0 [+0.1%])</span> 27.33 | <span style='color: red'>(+0 [+0.1%])</span> 27.33 |
...
| `execute_preflight_insn_mi/s` |  14.80 | -          |  18.28 | <span style='color: red'>(+0 [+0.1%])</span> 11.32 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+4 [+2.4%])</span> 191.50 | <span style='color: red'>(+9 [+2.4%])</span> 383 | <span style='color: red'>(+6 [+3.1%])</span> 197 | <span style='color: red'>(+3 [+1.6%])</span> 186 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+8 [+2.5%])</span> 346 | <span style='color: red'>(+17 [+2.5%])</span> 692 | <span style='color: red'>(+11 [+2.9%])</span> 395 | <span style='color: red'>(+6 [+2.1%])</span> 297 |
...
| `perm_trace_commit_time_ms` | <span style='color: red'>(+3 [+3.8%])</span> 77.29 | <span style='color: red'>(+6 [+3.8%])</span> 154.59 | <span style='color: red'>(+6 [+6.7%])</span> 90.06 |  64.53 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+2 [+3.2%])</span> 79.75 | <span style='color: red'>(+5 [+3.2%])</span> 159.50 | <span style='color: red'>(+4 [+4.5%])</span> 88.04 | <span style='color: red'>(+1 [+1.7%])</span> 71.46 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+0 [+1.8%])</span> 16.44 | <span style='color: red'>(+1 [+1.8%])</span> 32.87 | <span style='color: red'>(+0 [+2.6%])</span> 18.77 | <span style='color: red'>(+0 [+0.7%])</span> 14.10 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+2 [+2.3%])</span> 65.50 | <span style='color: red'>(+3 [+2.3%])</span> 131 | <span style='color: red'>(+1 [+1.3%])</span> 77 | <span style='color: red'>(+2 [+3.8%])</span> 54 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 595 | 1 | 63 | 1,745,742 | 27.33 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 186 | 830 | 32,689,110 | 172,558,444 | 186 | 395 | 0 | 88.04 | 18.77 | 6 | 90.06 | 77 | 134 | 76 | 1 | 75 | 16,059,916 | 42 | 106 | 1,157,000 | 11.32 | 27 | 107 | 1 | 76 | 
| pairing | 1 | 197 | 595 | 22,314,288 | 119,958,502 | 197 | 297 | 1 | 71.46 | 14.10 | 6 | 64.53 | 54 | 101 | 54 | 0 | 55 | 9,408,294 | 33 | 59 | 588,742 | 18.28 | 21 | 86 | 1 | 54 | 

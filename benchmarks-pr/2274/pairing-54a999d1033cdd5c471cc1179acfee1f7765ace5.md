...
|:---|---:|---:|
| Total | <span style='color: red'>(+0 [+0.5%])</span> 1.47 | <span style='color: red'>(+0 [+0.3%])</span> 0.88 |
| pairing | <span style='color: red'>(+0 [+0.3%])</span> 1.41 | <span style='color: green'>(-0 [-0.1%])</span> 0.82 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+2 [+0.3%])</span> 703.50 | <span style='color: red'>(+4 [+0.3%])</span> 1,407 | <span style='color: green'>(-1 [-0.1%])</span> 816 | <span style='color: red'>(+5 [+0.9%])</span> 591 |
| `main_cells_used     ` |  12,734,105 |  25,468,210 |  16,059,916 |  9,408,294 |
| `total_cells_used    ` |  27,501,699 |  55,003,398 |  32,689,110 |  22,314,288 |
| `execute_metered_time_ms` | <span style='color: red'>(+4 [+6.3%])</span> 67 | -          | -          | -          |
| `execute_metered_insn_mi/s` | <span style='color: green'>(-2 [-5.7%])</span> 25.75 | -          | <span style='color: green'>(-2 [-5.7%])</span> 25.75 | <span style='color: green'>(-2 [-5.7%])</span> 25.75 |
| `execute_preflight_insns` |  872,871 |  1,745,742 |  1,157,000 |  588,742 |
| `execute_preflight_time_ms` |  83.50 |  167 | <span style='color: red'>(+3 [+2.8%])</span> 109 | <span style='color: green'>(-3 [-4.9%])</span> 58 |
| `execute_preflight_insn_mi/s` | <span style='color: green'>(-0 [-0.8%])</span> 14.68 | -          | <span style='color: red'>(+0 [+0.7%])</span> 18.41 | <span style='color: green'>(-0 [-3.1%])</span> 10.96 |
| `trace_gen_time_ms   ` |  187 |  374 | <span style='color: red'>(+4 [+2.1%])</span> 195 | <span style='color: green'>(-4 [-2.2%])</span> 179 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+2 [+0.4%])</span> 339 | <span style='color: red'>(+3 [+0.4%])</span> 678 | <span style='color: green'>(-2 [-0.5%])</span> 382 | <span style='color: red'>(+5 [+1.7%])</span> 296 |
...
| `generate_perm_trace_time_ms` |  37 |  74 |  41 |  33 |
| `perm_trace_commit_time_ms` | <span style='color: red'>(+2 [+2.5%])</span> 76.30 | <span style='color: red'>(+4 [+2.5%])</span> 152.60 | <span style='color: red'>(+4 [+4.7%])</span> 88.31 | <span style='color: green'>(-0 [-0.3%])</span> 64.29 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+2 [+2.3%])</span> 79.10 | <span style='color: red'>(+4 [+2.3%])</span> 158.19 | <span style='color: red'>(+3 [+3.4%])</span> 87.12 | <span style='color: red'>(+1 [+1.1%])</span> 71.08 |
| `quotient_poly_commit_time_ms` | <span style='color: green'>(-1 [-3.4%])</span> 15.59 | <span style='color: green'>(-1 [-3.4%])</span> 31.19 | <span style='color: green'>(-1 [-7.1%])</span> 17 | <span style='color: red'>(+0 [+1.3%])</span> 14.19 |
| `pcs_opening_time_ms ` | <span style='color: green'>(-2 [-3.1%])</span> 62 | <span style='color: green'>(-4 [-3.1%])</span> 124 | <span style='color: green'>(-6 [-7.9%])</span> 70 | <span style='color: red'>(+2 [+3.8%])</span> 54 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 591 | 1 | 67 | 1,745,742 | 25.75 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 179 | 816 | 32,689,110 | 172,558,444 | 179 | 382 | 0 | 87.12 | 17 | 6 | 88.31 | 70 | 132 | 70 | 1 | 74 | 16,059,916 | 41 | 109 | 1,157,000 | 10.96 | 26 | 104 | 1 | 70 | 
| pairing | 1 | 195 | 591 | 22,314,288 | 119,958,502 | 195 | 296 | 1 | 71.08 | 14.19 | 5 | 64.29 | 54 | 100 | 53 | 0 | 55 | 9,408,294 | 33 | 58 | 588,742 | 18.41 | 20 | 85 | 1 | 53 | 
...
Commit: https://github.com/openvm-org/openvm/commit/54a999d1033cdd5c471cc1179acfee1f7765ace5
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19581145967)

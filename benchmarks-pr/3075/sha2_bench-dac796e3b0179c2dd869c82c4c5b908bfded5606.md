...
| `total_proof_time_ms ` |  2,382 |  4,764 |  3,261 |  1,503 |
| `compile_metered_time_ms` |  6 |  6 |  6 |  6 |
| `execute_metered_time_ms` |  57 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  192.54 | -          |  192.54 |  192.54 |
| `execute_preflight_insns` |  5,583,980.50 |  11,167,961 |  7,136,000 |  4,031,961 |
| `execute_preflight_time_ms` |  156.50 |  313 |  209 |  104 |
| `execute_preflight_insn_mi/s` |  37.77 | -          |  39.45 |  36.08 |
| `trace_gen_time_ms   ` |  65.50 |  131 |  104 |  27 |
| `set_initial_memory_time_ms` |  0 |  0 |  0 |  0 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  2,158 |  4,316 |  2,946 |  1,370 |
| `prover.main_trace_commit_time_ms` |  758 |  1,516 |  1,293 |  223 |
| `prover.rap_constraints_time_ms` |  1,122.50 |  2,245 |  1,297 |  948 |
| `prover.openings_time_ms` |  276.50 |  553 |  355 |  198 |
| `prover.rap_constraints.logup_gkr_time_ms` |  409 |  818 |  464 |  354 |
| `prover.rap_constraints.round0_time_ms` |  530 |  1,060 |  705 |  355 |
| `prover.rap_constraints.mle_rounds_time_ms` |  183.50 |  367 |  238 |  129 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/dac796e3b0179c2dd869c82c4c5b908bfded5606/sha2_bench-dac796e3b0179c2dd869c82c4c5b908bfded5606.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 58 |  |  |  | 291 |  |  |  |  |  |  | 
| app_proof |  |  |  | 1,503 |  | 57 | 11,167,961 | 192.54 | 0 | 4,831 |  | 
...
| leaf | 0 | 122 | 526 | 122 | 32 | 12 | 2 | 9 | 9 | 
...
| internal_recursive.1 | 1 | prover | 9,750,865 | 97 | 15 | 0 | 0 | 55 | 22 | 20 | 21 | 11 | 0 | 27 | 19 | 7 | 1 | 5 | 15 | 15 | 55 | 0 | 1 | 10 | 0 | 0 | 
| leaf | 0 | prover | 237,929,272 | 403 | 145 | 0 | 0 | 141 | 71 | 70 | 44 | 26 | 0 | 115 | 93 | 22 | 10 | 11 | 145 | 145 | 141 | 0 | 3 | 25 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,315,601,831 | 2,946 | 1,293 | 0 | 0 | 1,297 | 705 | 704 | 238 | 354 | 1 | 355 | 258 | 96 | 59 | 37 | 1,293 | 1,293 | 1,297 | 0 | 1 | 352 | 0 | 0 | 
| app_proof | prover | 1 | 709,381,428 | 1,370 | 223 | 0 | 0 | 948 | 355 | 354 | 129 | 464 | 281 | 198 | 144 | 53 | 31 | 21 | 223 | 223 | 948 | 0 | 1 | 182 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 0 | 2 | 104 | 3,261 | 3 | 0 | 0 | 0 | 12,820,730,880 | 2,969,255,892 | 15,789,986,772 | 2,097,152 | 2 | 0 | 0 | 0 | 3 | 100 | 209 | 7,136,000 | 36.08 | 0 | 0 | 
| app_proof | 1 | 0 | 2 | 27 | 1,503 | 2 | 0 | 0 | 0 | 7,276,196,868 | 1,627,061,653 | 8,903,258,521 | 2,097,152 | 2 | 0 | 0 | 0 | 2 | 25 | 104 | 4,031,961 | 39.45 | 0 | 0 | 

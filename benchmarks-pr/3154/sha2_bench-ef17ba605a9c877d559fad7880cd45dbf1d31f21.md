...
| `total_proof_time_ms ` |  2,164 |  4,328 |  2,845 |  1,483 |
| `compile_metered_time_ms` |  0 |  0 |  0 |  0 |
| `execute_metered_time_ms` |  62 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  178.53 | -          |  178.53 |  178.53 |
| `set_initial_memory_time_ms` |  3.50 |  7 |  4 |  3 |
| `execute_preflight_insns` |  5,583,980.50 |  11,167,961 |  7,136,000 |  4,031,961 |
| `execute_preflight_time_ms` |  248.50 |  497 |  332 |  165 |
| `execute_preflight_insn_mi/s` |  22.47 | -          |  24.29 |  21.48 |
| `postflight_time_ms  ` |  105 |  210 |  149 |  61 |
| `postflight_memory_chronology_time_ms` |  12 |  24 |  20 |  4 |
| `postflight_program_index_time_ms` |  1.50 |  3 |  2 |  1 |
| `trace_gen_time_ms   ` |  53 |  106 |  74 |  32 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,724 |  3,448 |  2,249 |  1,199 |
| `prover.main_trace_commit_time_ms` |  380 |  760 |  550 |  210 |
| `prover.rap_constraints_time_ms` |  1,077.50 |  2,155 |  1,361 |  794 |
| `prover.openings_time_ms` |  265.50 |  531 |  337 |  194 |
| `prover.rap_constraints.logup_gkr_time_ms` |  250.50 |  501 |  275 |  226 |
| `prover.rap_constraints.round0_time_ms` |  644 |  1,288 |  847 |  441 |
| `prover.rap_constraints.mle_rounds_time_ms` |  182 |  364 |  238 |  126 |
| `prover.openings.stacked_reduction_time_ms` |  72 |  144 |  93 |  51 |
| `prover.openings.stacked_reduction.round0_time_ms` |  43.50 |  87 |  57 |  30 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  28 |  56 |  35 |  21 |
...
| `prover.rap_constraints.round0_time_ms` |  82 |  82 |  82 |  82 |
...
| `prover.openings.whir_time_ms` |  92 |  92 |  92 |  92 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/ef17ba605a9c877d559fad7880cd45dbf1d31f21/sha2_bench-ef17ba605a9c877d559fad7880cd45dbf1d31f21.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 175 | 45 | 0 | 0 | 81 | 28 | 27 | 37 | 15 | 0 | 48 | 37 | 10 | 2 | 7 | 45 | 45 | 81 | 0 | 1 | 13 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 112 | 19 | 0 | 0 | 57 | 22 | 21 | 23 | 11 | 0 | 34 | 26 | 7 | 1 | 6 | 20 | 19 | 57 | 0 | 1 | 10 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 97 | 14 | 0 | 0 | 53 | 20 | 19 | 21 | 11 | 0 | 28 | 21 | 7 | 1 | 5 | 15 | 14 | 53 | 0 | 1 | 10 | 0 | 0 | 
| leaf | 0 | prover | 237,929,272 | 415 | 143 | 0 | 0 | 156 | 82 | 81 | 44 | 28 | 0 | 115 | 92 | 22 | 10 | 11 | 143 | 143 | 156 | 0 | 3 | 27 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover |  | 0 | 1,281,523,083 | 2,249 | 550 | 0 | 0 | 1,361 | 847 | 846 | 238 | 275 | 1 | 337 | 243 | 93 | 57 | 35 | 550 | 550 | 1,361 | 0 | 1 | 273 | 0 | 0 | 
| app_proof | prover |  | 1 | 687,699,844 | 1,199 | 210 | 0 | 0 | 794 | 441 | 440 | 126 | 226 | 0 | 194 | 142 | 51 | 30 | 21 | 210 | 210 | 794 | 0 | 1 | 225 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof |  | 1,483 | 62 | 11,167,961 | 178.53 | 0 | 4,395 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof |  | 0 | 4 | 2 | 74 | 2,845 | 5 | 4 | 0 | 149 | 2 | 20 | 0 | 12,537,603,360 | 2,843,438,436 | 15,381,041,796 | 2,097,152 | 2 | 0 | 2 | 5 | 68 | 332 | 7,136,000 | 21.48 | 0 | 0 | 
| app_proof |  | 1 | 3 | 2 | 32 | 1,483 | 3 | 3 | 0 | 61 | 1 | 4 | 0 | 7,116,253,404 | 1,550,303,741 | 8,666,557,145 | 2,097,152 | 2 | 0 | 0 | 2 | 29 | 165 | 4,031,961 | 24.29 | 0 | 0 | 

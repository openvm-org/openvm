...
| `total_proof_time_ms ` |  2,126 |  4,252 |  2,825 |  1,427 |
| `compile_metered_time_ms` |  0 |  0 |  0 |  0 |
| `execute_metered_time_ms` |  63 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  174.83 | -          |  174.83 |  174.83 |
| `set_initial_memory_time_ms` |  3.50 |  7 |  4 |  3 |
| `execute_preflight_insns` |  5,583,980.50 |  11,167,961 |  7,136,000 |  4,031,961 |
| `execute_preflight_time_ms` |  226 |  452 |  337 |  115 |
| `execute_preflight_insn_mi/s` |  24.71 | -          |  35.05 |  21.15 |
| `postflight_time_ms  ` |  91 |  182 |  126 |  56 |
| `postflight_memory_chronology_time_ms` |  12 |  24 |  20 |  4 |
| `postflight_program_index_time_ms` |  1.50 |  3 |  2 |  1 |
| `trace_gen_time_ms   ` |  53 |  106 |  74 |  32 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,719.50 |  3,439 |  2,245 |  1,194 |
| `prover.main_trace_commit_time_ms` |  380.50 |  761 |  552 |  209 |
| `prover.rap_constraints_time_ms` |  1,074.50 |  2,149 |  1,357 |  792 |
| `prover.openings_time_ms` |  263.50 |  527 |  335 |  192 |
| `prover.rap_constraints.logup_gkr_time_ms` |  249.50 |  499 |  274 |  225 |
| `prover.rap_constraints.round0_time_ms` |  644 |  1,288 |  847 |  441 |
| `prover.rap_constraints.mle_rounds_time_ms` |  180 |  360 |  235 |  125 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/fe0c08ac3695ef70792db244aa3ac170ea2aa6e3/sha2_bench-fe0c08ac3695ef70792db244aa3ac170ea2aa6e3.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 172 | 45 | 0 | 0 | 80 | 28 | 27 | 37 | 14 | 0 | 45 | 35 | 10 | 2 | 7 | 45 | 45 | 80 | 0 | 1 | 13 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 109 | 20 | 0 | 0 | 57 | 22 | 21 | 23 | 11 | 0 | 31 | 23 | 7 | 1 | 6 | 20 | 20 | 57 | 0 | 1 | 10 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 97 | 14 | 0 | 0 | 53 | 20 | 19 | 21 | 11 | 0 | 29 | 22 | 7 | 1 | 5 | 15 | 14 | 53 | 0 | 1 | 10 | 0 | 0 | 
| leaf | 0 | prover | 237,929,272 | 414 | 142 | 0 | 0 | 156 | 83 | 81 | 44 | 28 | 0 | 115 | 93 | 21 | 10 | 11 | 142 | 142 | 156 | 0 | 3 | 27 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover |  | 0 | 1,281,523,083 | 2,245 | 551 | 0 | 0 | 1,357 | 847 | 846 | 235 | 274 | 1 | 335 | 243 | 92 | 56 | 35 | 552 | 552 | 1,357 | 0 | 1 | 272 | 0 | 0 | 
| app_proof | prover |  | 1 | 687,699,844 | 1,194 | 208 | 0 | 0 | 792 | 441 | 440 | 125 | 225 | 0 | 192 | 142 | 50 | 29 | 20 | 209 | 208 | 792 | 0 | 1 | 225 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof |  | 1,427 | 63 | 11,167,961 | 174.83 | 0 | 4,320 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof |  | 0 | 4 | 2 | 74 | 2,825 | 5 | 4 | 0 | 126 | 2 | 20 | 0 | 12,537,603,360 | 2,843,438,436 | 15,381,041,796 | 2,097,152 | 2 | 0 | 2 | 5 | 68 | 337 | 7,136,000 | 21.15 | 0 | 0 | 
| app_proof |  | 1 | 3 | 2 | 32 | 1,427 | 3 | 3 | 0 | 56 | 1 | 4 | 0 | 7,116,253,404 | 1,550,303,741 | 8,666,557,145 | 2,097,152 | 2 | 0 | 0 | 2 | 29 | 115 | 4,031,961 | 35.05 | 0 | 0 | 

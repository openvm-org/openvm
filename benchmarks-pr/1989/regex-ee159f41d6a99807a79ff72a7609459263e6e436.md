...
|:---|---:|---:|
| Total |  7.68 |  4.94 |
| regex_program |  7.64 |  4.91 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  3,822 |  7,644 |  4,912 |  2,732 |
...
| `execute_preflight_insn_mi/s` |  31.13 | -          |  33.97 |  28.28 |
| `trace_gen_time_ms   ` |  396.50 |  793 |  509 |  284 |
| `memory_finalize_time_ms` |  7.50 |  15 |  13 |  2 |
| `stark_prove_excluding_trace_time_ms` |  3,109.50 |  6,219 |  4,067 |  2,152 |
| `main_trace_commit_time_ms` |  627.50 |  1,255 |  844 |  411 |
| `generate_perm_trace_time_ms` |  248 |  496 |  334 |  162 |
| `perm_trace_commit_time_ms` |  648 |  1,296 |  849 |  447 |
| `quotient_poly_compute_time_ms` |  326.50 |  653 |  441 |  212 |
| `quotient_poly_commit_time_ms` |  295.50 |  591 |  397 |  194 |
| `pcs_opening_time_ms ` |  955.50 |  1,911 |  1,196 |  715 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2,732 | 6 | 1 | 32 | 4,108,597 | 127.77 | 45 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 509 | 4,912 | 211,758,557 | 373,183,036 | 509 | 4,067 | 0 | 441 | 397 | 849 | 1,196 | 8 | 13 | 844 | 91,281,687 | 334 | 94 | 2,211,000 | 28.28 | 
| regex_program | 1 | 284 | 2,732 | 174,326,267 | 196,838,026 | 284 | 2,152 | 53 | 212 | 194 | 447 | 715 | 6 | 2 | 411 | 73,453,305 | 162 | 79 | 1,897,597 | 33.97 | 

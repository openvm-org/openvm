...
|:---|---:|---:|---:|
| Total |  11.72 |  4.82 |  4.82 |
| app_proof |  9.62 |  2.73 |  2.73 |
| leaf |  1.42 |  1.42 |  1.42 |
...
| `total_proof_time_ms ` |  2,382.50 |  9,530 |  2,633 |  2,268 |
| `execute_metered_time_ms` |  93 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  119.76 | -          |  119.76 |  119.76 |
| `execute_preflight_insns` |  2,791,990.25 |  11,167,961 |  2,851,000 |  2,614,961 |
| `execute_preflight_time_ms` |  164 |  656 |  211 |  98 |
| `execute_preflight_insn_mi/s` |  36.57 | -          |  37.50 |  33.88 |
| `trace_gen_time_ms   ` |  102.75 |  411 |  171 |  58 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  2,043.25 |  8,173 |  2,201 |  1,961 |
| `prover.main_trace_commit_time_ms` |  561.75 |  2,247 |  672 |  525 |
| `prover.rap_constraints_time_ms` |  1,336 |  5,344 |  1,383 |  1,289 |
| `prover.openings_time_ms` |  144.25 |  577 |  147 |  141 |
| `prover.rap_constraints.logup_gkr_time_ms` |  349.50 |  1,398 |  395 |  301 |
| `prover.rap_constraints.round0_time_ms` |  662.25 |  2,649 |  669 |  657 |
| `prover.rap_constraints.mle_rounds_time_ms` |  323.25 |  1,293 |  325 |  322 |
| `prover.openings.stacked_reduction_time_ms` |  103 |  412 |  104 |  102 |
| `prover.openings.stacked_reduction.round0_time_ms` |  63 |  252 |  63 |  63 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  39.75 |  159 |  40 |  39 |
| `prover.openings.whir_time_ms` |  41 |  164 |  44 |  38 |
...
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,269 |  1,269 |  1,269 |  1,269 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/323ca3228e1fcc654aa8cea2fb0eb8ca503fc279/sha2_bench-323ca3228e1fcc654aa8cea2fb0eb8ca503fc279.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 79 | 9 |  |  | 0 |  | 368 | 9 |  |  |  |  |  |  | 
| app_proof |  |  |  |  |  | 2,268 |  |  | 93 | 11,167,961 | 119.76 | 0 | 9,630 |  | 
...
| internal_recursive.0 | 1 | 12 | 165 | 11 | 2 | 0 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 9 | 131 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 147 | 1,417 | 147 | 54 | 26 | 3 | 6 | 6 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 61,220,603 | 355 | 185 | 0 | 0 | 130 | 38 | 37 | 64 | 27 | 0 | 38 | 20 | 18 | 5 | 12 | 185 | 130 | 0 | 2 | 26 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,879 | 152 | 49 | 0 | 0 | 72 | 25 | 24 | 29 | 17 | 0 | 30 | 21 | 8 | 1 | 6 | 50 | 72 | 0 | 2 | 16 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 121 | 31 | 0 | 0 | 62 | 23 | 22 | 25 | 13 | 0 | 27 | 20 | 7 | 1 | 5 | 31 | 62 | 0 | 2 | 13 | 0 | 0 | 
| leaf | 0 | prover | 424,379,238 | 1,269 | 805 | 0 | 155 | 355 | 173 | 172 | 106 | 75 | 0 | 107 | 42 | 65 | 36 | 28 | 805 | 355 | 0 | 7 | 74 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 662,392,121 | 2,201 | 672 | 0 | 148 | 1,383 | 664 | 663 | 324 | 395 | 104 | 145 | 41 | 104 | 63 | 40 | 672 | 1,383 | 0 | 3 | 289 | 0 | 0 | 
| app_proof | prover | 1 | 662,391,820 | 2,048 | 525 | 0 | 2 | 1,378 | 659 | 659 | 325 | 393 | 115 | 144 | 41 | 103 | 63 | 40 | 525 | 1,378 | 0 | 3 | 277 | 0 | 0 | 
| app_proof | prover | 2 | 662,391,820 | 1,961 | 525 | 0 | 2 | 1,294 | 669 | 669 | 322 | 301 | 0 | 141 | 38 | 102 | 63 | 39 | 525 | 1,294 | 0 | 4 | 301 | 0 | 0 | 
| app_proof | prover | 3 | 662,468,884 | 1,963 | 525 | 0 | 2 | 1,289 | 657 | 657 | 322 | 309 | 0 | 147 | 44 | 103 | 63 | 40 | 525 | 1,289 | 0 | 3 | 308 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 171 | 2,633 | 171 | 161 | 0 | 4 | 98 | 2,851,000 | 33.88 | 
| app_proof | 1 | 58 | 2,359 | 58 | 41 | 0 | 2 | 211 | 2,851,000 | 37.48 | 
| app_proof | 2 | 88 | 2,270 | 88 | 41 | 0 | 2 | 178 | 2,851,000 | 37.44 | 
| app_proof | 3 | 94 | 2,268 | 94 | 41 | 0 | 2 | 169 | 2,614,961 | 37.50 | 

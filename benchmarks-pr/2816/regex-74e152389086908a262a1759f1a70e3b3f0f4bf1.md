...
| `total_proof_time_ms ` |  785 |  1,570 |  880 |  690 |
| `execute_metered_time_ms` |  31 | -          | -          | -          |
| `execute_metered_insns` |  4,090,656 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  128.18 | -          |  128.18 |  128.18 |
| `execute_preflight_insns` |  2,045,328 |  4,090,656 |  2,327,000 |  1,763,656 |
| `execute_preflight_time_ms` |  80 |  160 |  86 |  74 |
| `execute_preflight_insn_mi/s` |  35.87 | -          |  38.14 |  33.60 |
| `trace_gen_time_ms   ` |  146.50 |  293 |  147 |  146 |
| `memory_finalize_time_ms` |  1 |  2 |  2 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  456.50 |  913 |  485 |  428 |
| `prover.main_trace_commit_time_ms` |  125 |  250 |  143 |  107 |
| `prover.rap_constraints_time_ms` |  280.50 |  561 |  286 |  275 |
| `prover.openings_time_ms` |  50 |  100 |  55 |  45 |
| `prover.rap_constraints.logup_gkr_time_ms` |  148 |  296 |  158 |  138 |
| `prover.rap_constraints.round0_time_ms` |  91 |  182 |  100 |  82 |
...
| `prover.openings.whir_time_ms` |  24.50 |  49 |  27 |  22 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/74e152389086908a262a1759f1a70e3b3f0f4bf1/regex-74e152389086908a262a1759f1a70e3b3f0f4bf1.memory.svg)
...
| app_proof |  |  |  |  |  | 690 |  |  | 31 | 4,090,656 | 128.18 | 0 | 1,616 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 27,256,571 | 211 | 81 | 0 | 0 | 99 | 33 | 32 | 46 | 19 | 0 | 29 | 18 | 11 | 2 | 8 | 82 | 99 | 0 | 2 | 18 | 0 | 0 | 
...
| leaf | 0 | prover | 79,962,868 | 308 | 128 | 0 | 0 | 133 | 53 | 52 | 37 | 42 | 0 | 45 | 30 | 15 | 6 | 8 | 129 | 133 | 0 | 5 | 40 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 179,663,570 | 485 | 143 | 0 | 0 | 286 | 82 | 82 | 45 | 158 | 0 | 55 | 27 | 28 | 15 | 12 | 143 | 286 | 0 | 3 | 156 | 0 | 0 | 
| app_proof | prover | 1 | 133,369,433 | 428 | 107 | 0 | 9 | 275 | 100 | 99 | 36 | 138 | 0 | 45 | 22 | 22 | 10 | 11 | 107 | 275 | 0 | 3 | 137 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 146 | 880 | 146 | 162 | 2 | 6 | 86 | 2,327,000 | 33.60 | 
| app_proof | 1 | 147 | 690 | 147 | 41 | 0 | 2 | 74 | 1,763,656 | 38.14 | 

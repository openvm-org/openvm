...
| `total_proof_time_ms ` |  932.50 |  1,865 |  1,193 |  672 |
| `execute_metered_time_ms` |  23 | -          | -          | -          |
| `execute_metered_insns` |  1,979,971 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  84.20 | -          |  84.20 |  84.20 |
| `execute_preflight_insns` |  989,985.50 |  1,979,971 |  1,168,000 |  811,971 |
| `execute_preflight_time_ms` |  89 |  178 |  125 |  53 |
| `execute_preflight_insn_mi/s` |  32.52 | -          |  33.53 |  31.51 |
| `trace_gen_time_ms   ` |  30.50 |  61 |  45 |  16 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  702.50 |  1,405 |  916 |  489 |
| `prover.main_trace_commit_time_ms` |  212.50 |  425 |  287 |  138 |
| `prover.rap_constraints_time_ms` |  443 |  886 |  578 |  308 |
| `prover.openings_time_ms` |  46.50 |  93 |  51 |  42 |
| `prover.rap_constraints.logup_gkr_time_ms` |  76.50 |  153 |  101 |  52 |
| `prover.rap_constraints.round0_time_ms` |  262 |  524 |  345 |  179 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/74e152389086908a262a1759f1a70e3b3f0f4bf1/kitchen_sink-74e152389086908a262a1759f1a70e3b3f0f4bf1.memory.svg)
...
| app_proof |  |  |  |  |  | 672 |  |  | 23 | 1,979,971 | 84.20 | 0 | 1,893 |  | 
...
| internal_recursive.0 | 1 | prover | 15,378,703 | 79 | 16 | 0 | 0 | 48 | 17 | 17 | 20 | 9 | 0 | 15 | 9 | 5 | 1 | 4 | 16 | 48 | 0 | 1 | 9 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 565,122,580 | 916 | 286 | 0 | 156 | 578 | 345 | 344 | 131 | 101 | 46 | 51 | 13 | 38 | 15 | 22 | 287 | 578 | 0 | 1 | 53 | 0 | 0 | 
| app_proof | prover | 1 | 541,799,820 | 489 | 137 | 0 | 1 | 308 | 179 | 178 | 76 | 52 | 0 | 42 | 14 | 27 | 14 | 13 | 138 | 308 | 0 | 1 | 51 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 45 | 1,193 | 45 | 177 | 0 | 3 | 53 | 1,168,000 | 31.51 | 
| app_proof | 1 | 16 | 672 | 16 | 40 | 0 | 1 | 125 | 811,971 | 33.53 | 

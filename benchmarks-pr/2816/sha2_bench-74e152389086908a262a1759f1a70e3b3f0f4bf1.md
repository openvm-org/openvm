...
| `total_proof_time_ms ` |  2,360.75 |  9,443 |  2,609 |  2,246 |
...
| `execute_preflight_time_ms` |  165 |  660 |  211 |  100 |
| `execute_preflight_insn_mi/s` |  35.25 | -          |  36.60 |  33.07 |
| `trace_gen_time_ms   ` |  99.50 |  398 |  166 |  58 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  2,023.75 |  8,095 |  2,179 |  1,945 |
| `prover.main_trace_commit_time_ms` |  558.50 |  2,234 |  668 |  521 |
| `prover.rap_constraints_time_ms` |  1,324.25 |  5,297 |  1,369 |  1,283 |
| `prover.openings_time_ms` |  140 |  560 |  142 |  138 |
| `prover.rap_constraints.logup_gkr_time_ms` |  346 |  1,384 |  391 |  298 |
| `prover.rap_constraints.round0_time_ms` |  659 |  2,636 |  663 |  655 |
| `prover.rap_constraints.mle_rounds_time_ms` |  318.50 |  1,274 |  321 |  315 |
| `prover.openings.stacked_reduction_time_ms` |  98.75 |  395 |  101 |  94 |
| `prover.openings.stacked_reduction.round0_time_ms` |  59.50 |  238 |  61 |  56 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  38.50 |  154 |  40 |  37 |
| `prover.openings.whir_time_ms` |  40.50 |  162 |  44 |  39 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/74e152389086908a262a1759f1a70e3b3f0f4bf1/sha2_bench-74e152389086908a262a1759f1a70e3b3f0f4bf1.memory.svg)
...
| app_proof |  |  |  |  |  | 2,246 |  |  | 93 | 11,167,961 | 119.22 | 0 | 9,543 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 61,220,603 | 359 | 184 | 0 | 0 | 132 | 39 | 38 | 65 | 27 | 0 | 42 | 23 | 18 | 5 | 13 | 184 | 132 | 0 | 3 | 26 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,879 | 148 | 48 | 0 | 0 | 72 | 24 | 24 | 29 | 17 | 0 | 26 | 17 | 8 | 2 | 6 | 48 | 72 | 0 | 2 | 17 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 117 | 32 | 0 | 0 | 60 | 22 | 21 | 24 | 13 | 0 | 24 | 17 | 7 | 1 | 5 | 32 | 60 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 424,379,238 | 1,258 | 802 | 0 | 157 | 349 | 170 | 169 | 102 | 76 | 0 | 106 | 42 | 63 | 36 | 27 | 803 | 349 | 0 | 7 | 75 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 662,392,121 | 2,179 | 668 | 0 | 148 | 1,369 | 656 | 656 | 321 | 391 | 102 | 141 | 39 | 101 | 61 | 40 | 668 | 1,369 | 0 | 3 | 287 | 0 | 0 | 
| app_proof | prover | 1 | 662,391,820 | 2,026 | 521 | 0 | 2 | 1,362 | 655 | 654 | 317 | 389 | 113 | 142 | 40 | 101 | 61 | 39 | 521 | 1,362 | 0 | 3 | 275 | 0 | 0 | 
| app_proof | prover | 2 | 662,391,820 | 1,945 | 523 | 0 | 2 | 1,283 | 663 | 662 | 321 | 298 | 0 | 139 | 39 | 99 | 60 | 38 | 523 | 1,283 | 0 | 4 | 297 | 0 | 0 | 
| app_proof | prover | 3 | 662,468,884 | 1,945 | 522 | 0 | 2 | 1,283 | 662 | 661 | 315 | 306 | 0 | 138 | 44 | 94 | 56 | 37 | 522 | 1,283 | 0 | 3 | 305 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 166 | 2,609 | 166 | 163 | 0 | 3 | 100 | 2,851,000 | 33.07 | 
| app_proof | 1 | 58 | 2,337 | 58 | 41 | 0 | 1 | 211 | 2,851,000 | 35.08 | 
| app_proof | 2 | 84 | 2,251 | 84 | 41 | 0 | 2 | 179 | 2,851,000 | 36.60 | 
| app_proof | 3 | 90 | 2,246 | 90 | 41 | 0 | 2 | 170 | 2,614,961 | 36.22 | 

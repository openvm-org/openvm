...
|:---|---:|---:|---:|
| Total |  2.61 |  1.94 |  1.94 |
| app_proof |  1.90 |  1.22 |  1.22 |
| leaf |  0.41 |  0.41 |  0.41 |
...
| `total_proof_time_ms ` |  937 |  1,874 |  1,196 |  678 |
| `execute_metered_time_ms` |  23 | -          | -          | -          |
| `execute_metered_insns` |  1,979,971 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  83.57 | -          |  83.57 |  83.57 |
| `execute_preflight_insns` |  989,985.50 |  1,979,971 |  1,168,000 |  811,971 |
| `execute_preflight_time_ms` |  92 |  184 |  130 |  54 |
| `execute_preflight_insn_mi/s` |  32.51 | -          |  33.58 |  31.44 |
| `trace_gen_time_ms   ` |  30 |  60 |  44 |  16 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  705 |  1,410 |  920 |  490 |
| `prover.main_trace_commit_time_ms` |  213.50 |  427 |  289 |  138 |
| `prover.rap_constraints_time_ms` |  445 |  890 |  579 |  311 |
| `prover.openings_time_ms` |  45.50 |  91 |  51 |  40 |
| `prover.rap_constraints.logup_gkr_time_ms` |  78 |  156 |  102 |  54 |
| `prover.rap_constraints.round0_time_ms` |  263 |  526 |  345 |  181 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/d3079628a847d9ffedf8752ccaac8f2f38b23516/kitchen_sink-d3079628a847d9ffedf8752ccaac8f2f38b23516.memory.svg)
...
| prover.gkr_input_evals | 8.68 | app_proof.prover.0 |
| prover.batch_constraints.before_round0 | 8.68 | app_proof.prover.0 |
| frac_sumcheck.gkr_rounds | 8.68 | app_proof.prover.0 |
| frac_sumcheck.segment_tree | 8.68 | app_proof.prover.0 |
...
| app_proof |  |  |  |  |  | 678 |  |  | 23 | 1,979,971 | 83.57 | 0 | 1,902 |  | 
...
| leaf | 0 | 109 | 407 | 109 | 25 | 11 | 20 | 4 | 4 | 
...
| leaf | 0 | prover | 263,565,172 | 297 | 128 | 0 | 1 | 140 | 49 | 48 | 37 | 54 | 0 | 28 | 12 | 15 | 7 | 8 | 128 | 140 | 0 | 2 | 53 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 565,122,580 | 920 | 289 | 0 | 158 | 579 | 345 | 344 | 131 | 102 | 47 | 51 | 13 | 38 | 15 | 22 | 289 | 579 | 0 | 1 | 54 | 0 | 0 | 
| app_proof | prover | 1 | 541,799,820 | 490 | 137 | 0 | 1 | 311 | 181 | 180 | 76 | 54 | 0 | 40 | 12 | 27 | 14 | 13 | 138 | 311 | 0 | 1 | 53 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 44 | 1,196 | 44 | 176 | 0 | 3 | 54 | 1,168,000 | 31.44 | 
| app_proof | 1 | 16 | 678 | 16 | 40 | 0 | 1 | 130 | 811,971 | 33.58 | 

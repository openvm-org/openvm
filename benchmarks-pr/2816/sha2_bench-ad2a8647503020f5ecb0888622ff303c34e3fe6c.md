...
| `total_proof_time_ms ` |  2,368 |  9,472 |  2,615 |  2,256 |
| `execute_metered_time_ms` |  93 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  119.81 | -          |  119.81 |  119.81 |
| `execute_preflight_insns` |  2,791,990.25 |  11,167,961 |  2,851,000 |  2,614,961 |
| `execute_preflight_time_ms` |  162.75 |  651 |  205 |  98 |
| `execute_preflight_insn_mi/s` |  36.83 | -          |  37.99 |  33.95 |
| `trace_gen_time_ms   ` |  101 |  404 |  169 |  58 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  2,031.75 |  8,127 |  2,185 |  1,953 |
| `prover.main_trace_commit_time_ms` |  558 |  2,232 |  667 |  521 |
| `prover.rap_constraints_time_ms` |  1,329 |  5,316 |  1,372 |  1,284 |
| `prover.openings_time_ms` |  143.50 |  574 |  146 |  141 |
| `prover.rap_constraints.logup_gkr_time_ms` |  347 |  1,388 |  392 |  298 |
| `prover.rap_constraints.round0_time_ms` |  663 |  2,652 |  672 |  659 |
| `prover.rap_constraints.mle_rounds_time_ms` |  318.25 |  1,273 |  319 |  317 |
...
| `prover.openings.whir_time_ms` |  40.50 |  162 |  43 |  38 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/ad2a8647503020f5ecb0888622ff303c34e3fe6c/sha2_bench-ad2a8647503020f5ecb0888622ff303c34e3fe6c.memory.svg)
...
| app_proof |  |  |  |  |  | 2,256 |  |  | 93 | 11,167,961 | 119.81 | 0 | 9,572 |  | 
...
| leaf | 0 | 149 | 1,408 | 149 | 54 | 26 | 3 | 6 | 6 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 61,220,603 | 351 | 184 | 0 | 0 | 128 | 37 | 37 | 64 | 26 | 0 | 37 | 18 | 18 | 5 | 12 | 185 | 128 | 0 | 2 | 26 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,879 | 152 | 48 | 0 | 0 | 73 | 25 | 24 | 29 | 18 | 0 | 30 | 21 | 8 | 1 | 6 | 49 | 73 | 0 | 2 | 16 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 122 | 31 | 0 | 0 | 62 | 23 | 23 | 25 | 13 | 0 | 27 | 20 | 7 | 1 | 5 | 31 | 62 | 0 | 3 | 12 | 0 | 0 | 
| leaf | 0 | prover | 424,379,238 | 1,258 | 800 | 0 | 156 | 350 | 169 | 168 | 106 | 75 | 0 | 106 | 42 | 64 | 35 | 28 | 801 | 350 | 0 | 7 | 74 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 662,392,121 | 2,185 | 667 | 0 | 147 | 1,372 | 662 | 661 | 318 | 391 | 103 | 144 | 41 | 103 | 62 | 40 | 667 | 1,372 | 0 | 4 | 288 | 0 | 0 | 
| app_proof | prover | 1 | 662,391,820 | 2,036 | 521 | 0 | 2 | 1,370 | 659 | 659 | 319 | 392 | 114 | 143 | 40 | 103 | 63 | 39 | 522 | 1,370 | 0 | 3 | 276 | 0 | 0 | 
| app_proof | prover | 2 | 662,391,820 | 1,953 | 521 | 0 | 2 | 1,290 | 672 | 671 | 319 | 298 | 0 | 141 | 38 | 103 | 62 | 40 | 521 | 1,290 | 0 | 3 | 297 | 0 | 0 | 
| app_proof | prover | 3 | 662,468,884 | 1,953 | 522 | 0 | 2 | 1,284 | 659 | 659 | 317 | 307 | 0 | 146 | 43 | 102 | 62 | 40 | 522 | 1,284 | 0 | 4 | 306 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 169 | 2,615 | 169 | 162 | 0 | 3 | 98 | 2,851,000 | 33.95 | 
| app_proof | 1 | 58 | 2,341 | 58 | 41 | 0 | 1 | 205 | 2,851,000 | 37.56 | 
| app_proof | 2 | 86 | 2,260 | 86 | 41 | 0 | 2 | 178 | 2,851,000 | 37.84 | 
| app_proof | 3 | 91 | 2,256 | 91 | 41 | 0 | 2 | 170 | 2,614,961 | 37.99 | 

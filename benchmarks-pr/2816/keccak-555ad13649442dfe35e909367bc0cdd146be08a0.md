...
|:---|---:|---:|---:|
| Total |  16.40 |  4.83 |  4.83 |
| app_proof |  13.44 |  2.63 |  2.63 |
| leaf |  2.17 |  1.41 |  1.41 |
...
| `total_proof_time_ms ` |  2,217.33 |  13,304 |  2,491 |  2,124 |
...
| `execute_preflight_time_ms` |  239.50 |  1,437 |  326 |  87 |
| `execute_preflight_insn_mi/s` |  35.32 | -          |  36.19 |  32.02 |
| `trace_gen_time_ms   ` |  53.33 |  320 |  151 |  33 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,862.17 |  11,173 |  2,088 |  1,814 |
| `prover.main_trace_commit_time_ms` |  699.33 |  4,196 |  861 |  666 |
| `prover.rap_constraints_time_ms` |  984 |  5,904 |  1,045 |  970 |
| `prover.openings_time_ms` |  177.83 |  1,067 |  181 |  174 |
| `prover.rap_constraints.logup_gkr_time_ms` |  172.17 |  1,033 |  224 |  161 |
| `prover.rap_constraints.round0_time_ms` |  507.67 |  3,046 |  512 |  498 |
| `prover.rap_constraints.mle_rounds_time_ms` |  303.33 |  1,820 |  323 |  299 |
| `prover.openings.stacked_reduction_time_ms` |  133.50 |  801 |  137 |  129 |
| `prover.openings.stacked_reduction.round0_time_ms` |  81.33 |  488 |  85 |  76 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,083 |  2,166 |  1,411 |  755 |
| `execute_preflight_time_ms` |  5.50 |  11 |  6 |  5 |
| `trace_gen_time_ms   ` |  138 |  276 |  184 |  92 |
| `generate_blob_total_time_ms` |  24.50 |  49 |  33 |  16 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  945 |  1,890 |  1,227 |  663 |
| `prover.main_trace_commit_time_ms` |  541.50 |  1,083 |  713 |  370 |
| `prover.rap_constraints_time_ms` |  312 |  624 |  402 |  222 |
| `prover.openings_time_ms` |  90.50 |  181 |  111 |  70 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/555ad13649442dfe35e909367bc0cdd146be08a0/keccak-555ad13649442dfe35e909367bc0cdd146be08a0.memory.svg)
...
| app_proof |  |  |  |  |  | 2,124 |  |  | 140 | 14,365,133 | 102.46 | 0 | 13,450 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 39 | 496 | 38 | 13 | 4 | 2 | 2 | 2 | 
| internal_recursive.0 | 1 | 13 | 162 | 13 | 2 | 1 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 9 | 132 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 184 | 1,411 | 183 | 64 | 33 | 6 | 8 | 8 | 
| leaf | 1 | 92 | 755 | 91 | 32 | 16 | 5 | 8 | 8 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 81,415,028 | 457 | 241 | 0 | 1 | 170 | 48 | 48 | 90 | 30 | 0 | 45 | 21 | 23 | 7 | 15 | 241 | 170 | 0 | 2 | 29 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,879 | 149 | 48 | 0 | 0 | 71 | 25 | 24 | 29 | 17 | 0 | 28 | 19 | 8 | 1 | 6 | 48 | 71 | 0 | 2 | 16 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 123 | 31 | 0 | 0 | 62 | 24 | 23 | 24 | 13 | 0 | 29 | 22 | 7 | 1 | 5 | 31 | 62 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 476,578,662 | 1,227 | 712 | 0 | 2 | 402 | 198 | 197 | 119 | 84 | 0 | 111 | 41 | 70 | 40 | 29 | 713 | 402 | 0 | 7 | 83 | 0 | 0 | 
| leaf | 1 | prover | 240,255,732 | 663 | 369 | 0 | 1 | 222 | 105 | 104 | 66 | 51 | 0 | 70 | 33 | 36 | 19 | 16 | 370 | 222 | 0 | 6 | 50 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 857,743,372 | 2,088 | 861 | 0 | 199 | 1,045 | 498 | 497 | 323 | 224 | 67 | 181 | 43 | 137 | 85 | 52 | 861 | 1,045 | 0 | 3 | 155 | 0 | 0 | 
| app_proof | prover | 1 | 857,820,172 | 1,818 | 667 | 0 | 3 | 971 | 508 | 508 | 299 | 162 | 0 | 180 | 46 | 133 | 81 | 52 | 667 | 971 | 0 | 3 | 162 | 0 | 0 | 
| app_proof | prover | 2 | 857,820,172 | 1,814 | 667 | 0 | 3 | 970 | 507 | 507 | 300 | 163 | 0 | 174 | 45 | 129 | 76 | 52 | 668 | 970 | 0 | 4 | 162 | 0 | 0 | 
| app_proof | prover | 3 | 857,820,172 | 1,818 | 666 | 0 | 3 | 973 | 512 | 511 | 299 | 161 | 0 | 178 | 43 | 134 | 82 | 52 | 666 | 973 | 0 | 4 | 160 | 0 | 0 | 
| app_proof | prover | 4 | 857,820,172 | 1,817 | 667 | 0 | 3 | 972 | 511 | 511 | 299 | 161 | 0 | 177 | 42 | 134 | 82 | 52 | 667 | 972 | 0 | 4 | 160 | 0 | 0 | 
| app_proof | prover | 5 | 857,743,372 | 1,818 | 667 | 0 | 3 | 973 | 510 | 509 | 300 | 162 | 0 | 177 | 43 | 134 | 82 | 52 | 667 | 973 | 0 | 3 | 161 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 151 | 2,491 | 151 | 163 | 0 | 3 | 87 | 2,413,000 | 32.02 | 
| app_proof | 1 | 34 | 2,220 | 34 | 41 | 0 | 1 | 326 | 2,413,000 | 35.91 | 
| app_proof | 2 | 34 | 2,154 | 34 | 41 | 0 | 1 | 264 | 2,413,000 | 35.91 | 
| app_proof | 3 | 34 | 2,158 | 34 | 41 | 0 | 1 | 264 | 2,413,000 | 36.12 | 
| app_proof | 4 | 34 | 2,157 | 34 | 41 | 0 | 1 | 264 | 2,413,000 | 36.19 | 
| app_proof | 5 | 33 | 2,124 | 33 | 41 | 0 | 1 | 232 | 2,300,133 | 35.73 | 

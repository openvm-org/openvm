...
| `total_proof_time_ms ` |  942.50 |  1,885 |  1,204 |  681 |
| `execute_metered_time_ms` |  23 | -          | -          | -          |
| `execute_metered_insns` |  1,979,971 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  83.46 | -          |  83.46 |  83.46 |
| `execute_preflight_insns` |  989,985.50 |  1,979,971 |  1,168,000 |  811,971 |
| `execute_preflight_time_ms` |  92 |  184 |  131 |  53 |
| `execute_preflight_insn_mi/s` |  32.55 | -          |  33.43 |  31.66 |
| `trace_gen_time_ms   ` |  30.50 |  61 |  45 |  16 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  708.50 |  1,417 |  925 |  492 |
| `prover.main_trace_commit_time_ms` |  214 |  428 |  290 |  138 |
| `prover.rap_constraints_time_ms` |  447 |  894 |  582 |  312 |
| `prover.openings_time_ms` |  46.50 |  93 |  52 |  41 |
| `prover.rap_constraints.logup_gkr_time_ms` |  77.50 |  155 |  103 |  52 |
| `prover.rap_constraints.round0_time_ms` |  263 |  526 |  344 |  182 |
| `prover.rap_constraints.mle_rounds_time_ms` |  105.50 |  211 |  134 |  77 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/555ad13649442dfe35e909367bc0cdd146be08a0/kitchen_sink-555ad13649442dfe35e909367bc0cdd146be08a0.memory.svg)
...
| app_proof |  |  |  |  |  | 681 |  |  | 23 | 1,979,971 | 83.46 | 0 | 1,913 |  | 
...
| internal_recursive.1 | 1 | prover | 9,750,799 | 76 | 11 | 0 | 0 | 49 | 20 | 19 | 18 | 10 | 0 | 15 | 9 | 5 | 0 | 4 | 11 | 49 | 0 | 1 | 9 | 0 | 0 | 
| leaf | 0 | prover | 263,565,172 | 301 | 128 | 0 | 1 | 141 | 49 | 48 | 37 | 54 | 0 | 29 | 13 | 15 | 7 | 8 | 129 | 141 | 0 | 2 | 53 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 565,122,580 | 925 | 290 | 0 | 160 | 582 | 344 | 343 | 134 | 103 | 48 | 52 | 13 | 38 | 16 | 22 | 290 | 582 | 0 | 1 | 54 | 0 | 0 | 
| app_proof | prover | 1 | 541,799,820 | 492 | 137 | 0 | 2 | 312 | 182 | 181 | 77 | 52 | 0 | 41 | 13 | 28 | 14 | 13 | 138 | 312 | 0 | 1 | 51 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 45 | 1,204 | 45 | 179 | 0 | 3 | 53 | 1,168,000 | 31.66 | 
| app_proof | 1 | 16 | 681 | 16 | 41 | 0 | 1 | 131 | 811,971 | 33.43 | 

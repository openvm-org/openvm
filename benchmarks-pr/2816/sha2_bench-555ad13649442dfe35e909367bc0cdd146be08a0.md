...
| `total_proof_time_ms ` |  2,352 |  9,408 |  2,604 |  2,235 |
...
| `execute_preflight_time_ms` |  165 |  660 |  213 |  98 |
| `execute_preflight_insn_mi/s` |  36.65 | -          |  37.63 |  33.85 |
| `trace_gen_time_ms   ` |  98.75 |  395 |  167 |  58 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  2,016 |  8,064 |  2,176 |  1,935 |
| `prover.main_trace_commit_time_ms` |  555 |  2,220 |  665 |  518 |
| `prover.rap_constraints_time_ms` |  1,318.25 |  5,273 |  1,367 |  1,273 |
| `prover.openings_time_ms` |  141.75 |  567 |  143 |  139 |
| `prover.rap_constraints.logup_gkr_time_ms` |  345 |  1,380 |  392 |  295 |
| `prover.rap_constraints.round0_time_ms` |  655.50 |  2,622 |  664 |  650 |
| `prover.rap_constraints.mle_rounds_time_ms` |  316.75 |  1,267 |  320 |  314 |
| `prover.openings.stacked_reduction_time_ms` |  101 |  404 |  102 |  100 |
...
| `prover.openings.whir_time_ms` |  40.25 |  161 |  42 |  38 |
...
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,248 |  1,248 |  1,248 |  1,248 |
| `prover.main_trace_commit_time_ms` |  791 |  791 |  791 |  791 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/555ad13649442dfe35e909367bc0cdd146be08a0/sha2_bench-555ad13649442dfe35e909367bc0cdd146be08a0.memory.svg)
...
| app_proof |  |  |  |  |  | 2,235 |  |  | 93 | 11,167,961 | 119.49 | 0 | 9,507 |  | 
...
| leaf | 0 | 149 | 1,397 | 148 | 54 | 26 | 3 | 6 | 6 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 61,220,603 | 349 | 182 | 0 | 0 | 129 | 37 | 37 | 64 | 27 | 0 | 37 | 19 | 18 | 5 | 12 | 182 | 129 | 0 | 2 | 26 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,879 | 152 | 49 | 0 | 0 | 72 | 24 | 24 | 29 | 17 | 0 | 30 | 21 | 8 | 1 | 6 | 49 | 72 | 0 | 2 | 16 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 120 | 31 | 0 | 0 | 62 | 22 | 22 | 25 | 14 | 0 | 26 | 18 | 7 | 1 | 5 | 31 | 62 | 0 | 2 | 13 | 0 | 0 | 
| leaf | 0 | prover | 424,379,238 | 1,248 | 791 | 0 | 155 | 349 | 167 | 166 | 106 | 75 | 0 | 107 | 43 | 63 | 35 | 27 | 791 | 349 | 0 | 7 | 74 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 662,392,121 | 2,176 | 665 | 0 | 149 | 1,367 | 654 | 653 | 320 | 392 | 104 | 142 | 40 | 102 | 62 | 40 | 665 | 1,367 | 0 | 3 | 286 | 0 | 0 | 
| app_proof | prover | 1 | 662,391,820 | 2,018 | 518 | 0 | 2 | 1,356 | 650 | 649 | 316 | 389 | 113 | 143 | 41 | 102 | 62 | 40 | 518 | 1,356 | 0 | 4 | 275 | 0 | 0 | 
| app_proof | prover | 2 | 662,391,820 | 1,935 | 518 | 0 | 2 | 1,277 | 664 | 664 | 317 | 295 | 0 | 139 | 38 | 100 | 61 | 38 | 518 | 1,277 | 0 | 4 | 294 | 0 | 0 | 
| app_proof | prover | 3 | 662,468,884 | 1,935 | 518 | 0 | 2 | 1,273 | 654 | 653 | 314 | 304 | 0 | 143 | 42 | 100 | 60 | 39 | 519 | 1,273 | 0 | 3 | 303 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 167 | 2,604 | 167 | 161 | 0 | 3 | 98 | 2,851,000 | 33.85 | 
| app_proof | 1 | 58 | 2,331 | 58 | 41 | 0 | 1 | 213 | 2,851,000 | 37.63 | 
| app_proof | 2 | 82 | 2,238 | 82 | 41 | 0 | 2 | 179 | 2,851,000 | 37.54 | 
| app_proof | 3 | 88 | 2,235 | 88 | 41 | 0 | 2 | 170 | 2,614,961 | 37.56 | 

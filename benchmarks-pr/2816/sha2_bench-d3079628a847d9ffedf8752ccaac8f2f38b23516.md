...
| `total_proof_time_ms ` |  2,383 |  9,532 |  2,633 |  2,272 |
| `execute_metered_time_ms` |  93 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  119.43 | -          |  119.43 |  119.43 |
| `execute_preflight_insns` |  2,791,990.25 |  11,167,961 |  2,851,000 |  2,614,961 |
| `execute_preflight_time_ms` |  160.75 |  643 |  202 |  100 |
| `execute_preflight_insn_mi/s` |  36.52 | -          |  37.80 |  32.82 |
| `trace_gen_time_ms   ` |  104.50 |  418 |  168 |  63 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  2,045 |  8,180 |  2,200 |  1,966 |
| `prover.main_trace_commit_time_ms` |  561.25 |  2,245 |  671 |  524 |
| `prover.rap_constraints_time_ms` |  1,337.75 |  5,351 |  1,383 |  1,293 |
| `prover.openings_time_ms` |  145 |  580 |  148 |  143 |
| `prover.rap_constraints.logup_gkr_time_ms` |  348.25 |  1,393 |  394 |  301 |
| `prover.rap_constraints.round0_time_ms` |  666.25 |  2,665 |  674 |  662 |
| `prover.rap_constraints.mle_rounds_time_ms` |  322 |  1,288 |  323 |  320 |
| `prover.openings.stacked_reduction_time_ms` |  103.50 |  414 |  104 |  103 |
...
| `prover.openings.whir_time_ms` |  41 |  164 |  44 |  39 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/d3079628a847d9ffedf8752ccaac8f2f38b23516/sha2_bench-d3079628a847d9ffedf8752ccaac8f2f38b23516.memory.svg)
...
| app_proof |  |  |  |  |  | 2,272 |  |  | 93 | 11,167,961 | 119.43 | 0 | 9,632 |  | 
...
| internal_recursive.0 | 1 | 13 | 159 | 12 | 2 | 0 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 9 | 130 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 148 | 1,419 | 148 | 54 | 26 | 3 | 6 | 6 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 61,220,603 | 359 | 185 | 0 | 0 | 131 | 38 | 37 | 65 | 27 | 0 | 41 | 23 | 18 | 5 | 12 | 185 | 131 | 0 | 3 | 26 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,879 | 146 | 48 | 0 | 0 | 72 | 24 | 24 | 29 | 18 | 0 | 24 | 16 | 8 | 2 | 6 | 48 | 72 | 0 | 2 | 17 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 121 | 31 | 0 | 0 | 61 | 22 | 22 | 24 | 13 | 0 | 27 | 20 | 7 | 1 | 5 | 32 | 61 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 424,379,238 | 1,270 | 809 | 0 | 160 | 352 | 170 | 169 | 106 | 75 | 0 | 108 | 43 | 64 | 35 | 28 | 809 | 352 | 0 | 7 | 74 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 662,392,121 | 2,200 | 670 | 0 | 148 | 1,383 | 665 | 665 | 323 | 394 | 103 | 145 | 41 | 104 | 63 | 40 | 671 | 1,383 | 0 | 3 | 289 | 0 | 0 | 
| app_proof | prover | 1 | 662,391,820 | 2,047 | 524 | 0 | 2 | 1,378 | 664 | 664 | 323 | 389 | 111 | 144 | 40 | 103 | 63 | 40 | 524 | 1,378 | 0 | 3 | 277 | 0 | 0 | 
| app_proof | prover | 2 | 662,391,820 | 1,966 | 525 | 0 | 2 | 1,297 | 674 | 674 | 320 | 301 | 0 | 143 | 39 | 104 | 63 | 40 | 525 | 1,297 | 0 | 4 | 300 | 0 | 0 | 
| app_proof | prover | 3 | 662,468,884 | 1,967 | 525 | 0 | 2 | 1,293 | 662 | 661 | 322 | 309 | 0 | 148 | 44 | 103 | 62 | 40 | 525 | 1,293 | 0 | 3 | 308 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 168 | 2,633 | 168 | 163 | 0 | 3 | 100 | 2,851,000 | 32.82 | 
| app_proof | 1 | 63 | 2,353 | 63 | 41 | 0 | 2 | 202 | 2,851,000 | 37.70 | 
| app_proof | 2 | 91 | 2,274 | 91 | 41 | 0 | 2 | 175 | 2,851,000 | 37.80 | 
| app_proof | 3 | 96 | 2,272 | 96 | 41 | 0 | 2 | 166 | 2,614,961 | 37.75 | 

...
| `total_proof_time_ms ` |  3,838.50 |  7,677 |  4,886 |  2,791 |
...
| `execute_preflight_insn_mi/s` |  28.50 | -          |  30.86 |  26.15 |
| `trace_gen_time_ms   ` |  382.50 |  765 |  490 |  275 |
| `memory_finalize_time_ms` |  8 |  16 |  14 |  2 |
| `stark_prove_excluding_trace_time_ms` |  3,135.50 |  6,271 |  4,052 |  2,219 |
| `main_trace_commit_time_ms` |  627 |  1,254 |  843 |  411 |
| `generate_perm_trace_time_ms` |  234 |  468 |  312 |  156 |
| `perm_trace_commit_time_ms` |  667 |  1,334 |  863 |  471 |
| `quotient_poly_compute_time_ms` |  315 |  630 |  429 |  201 |
| `quotient_poly_commit_time_ms` |  303 |  606 |  401 |  205 |
| `pcs_opening_time_ms ` |  982 |  1,964 |  1,199 |  765 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2,791 | 6 | 1 | 31 | 4,108,597 | 129.28 | 44 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 490 | 4,886 | 211,758,557 | 373,183,036 | 490 | 4,052 | 0 | 429 | 401 | 863 | 1,199 | 7 | 14 | 843 | 91,281,687 | 312 | 103 | 2,211,000 | 26.15 | 
| regex_program | 1 | 275 | 2,791 | 174,326,267 | 196,838,026 | 275 | 2,219 | 51 | 201 | 205 | 471 | 765 | 7 | 2 | 411 | 73,453,305 | 156 | 85 | 1,897,597 | 30.86 | 

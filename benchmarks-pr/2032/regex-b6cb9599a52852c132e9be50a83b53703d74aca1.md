...
| `total_proof_time_ms ` |  3,797 |  7,594 |  4,873 |  2,721 |
...
| `execute_preflight_insn_mi/s` |  28.26 | -          |  30.99 |  25.54 |
| `trace_gen_time_ms   ` |  391 |  782 |  503 |  279 |
| `memory_finalize_time_ms` |  7.50 |  15 |  13 |  2 |
| `stark_prove_excluding_trace_time_ms` |  3,079.50 |  6,159 |  4,017 |  2,142 |
| `main_trace_commit_time_ms` |  628.50 |  1,257 |  844 |  413 |
| `generate_perm_trace_time_ms` |  223 |  446 |  299 |  147 |
| `perm_trace_commit_time_ms` |  649 |  1,298 |  851 |  447 |
| `quotient_poly_compute_time_ms` |  317.50 |  635 |  428 |  207 |
| `quotient_poly_commit_time_ms` |  298 |  596 |  392 |  204 |
| `pcs_opening_time_ms ` |  955.50 |  1,911 |  1,197 |  714 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2,721 | 6 | 1 | 31 | 4,108,597 | 129.97 | 44 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 503 | 4,873 | 211,758,557 | 373,183,036 | 503 | 4,017 | 0 | 428 | 392 | 851 | 1,197 | 9 | 13 | 844 | 91,281,687 | 299 | 103 | 2,211,000 | 25.54 | 
| regex_program | 1 | 279 | 2,721 | 174,326,267 | 196,838,026 | 279 | 2,142 | 52 | 207 | 204 | 447 | 714 | 8 | 2 | 413 | 73,453,305 | 147 | 83 | 1,897,597 | 30.99 | 

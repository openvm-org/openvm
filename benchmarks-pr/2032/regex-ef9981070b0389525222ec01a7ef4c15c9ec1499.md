...
| `total_proof_time_ms ` |  3,843.50 |  7,687 |  4,916 |  2,771 |
...
| `execute_preflight_insn_mi/s` |  28.49 | -          |  30.92 |  26.05 |
| `trace_gen_time_ms   ` |  400 |  800 |  512 |  288 |
| `memory_finalize_time_ms` |  8 |  16 |  14 |  2 |
| `stark_prove_excluding_trace_time_ms` |  3,122.50 |  6,245 |  4,063 |  2,182 |
| `main_trace_commit_time_ms` |  631 |  1,262 |  845 |  417 |
| `generate_perm_trace_time_ms` |  238 |  476 |  318 |  158 |
| `perm_trace_commit_time_ms` |  650.50 |  1,301 |  849 |  452 |
| `quotient_poly_compute_time_ms` |  327.50 |  655 |  443 |  212 |
| `quotient_poly_commit_time_ms` |  302.50 |  605 |  398 |  207 |
| `pcs_opening_time_ms ` |  964.50 |  1,929 |  1,206 |  723 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2,771 | 7 | 1 | 32 | 4,108,597 | 128.26 | 45 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 512 | 4,916 | 211,758,557 | 373,183,036 | 512 | 4,063 | 0 | 443 | 398 | 849 | 1,206 | 8 | 14 | 845 | 91,281,687 | 318 | 102 | 2,211,000 | 26.05 | 
| regex_program | 1 | 288 | 2,771 | 174,326,267 | 196,838,026 | 288 | 2,182 | 54 | 212 | 207 | 452 | 723 | 6 | 2 | 417 | 73,453,305 | 158 | 84 | 1,897,597 | 30.92 | 

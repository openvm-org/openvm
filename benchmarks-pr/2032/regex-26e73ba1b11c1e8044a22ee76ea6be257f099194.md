...
|:---|---:|---:|
| Total |  7.68 |  4.91 |
| regex_program |  7.64 |  4.88 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  3,822.50 |  7,645 |  4,877 |  2,768 |
...
| `execute_preflight_time_ms` |  94 |  188 |  102 |  86 |
| `execute_preflight_insn_mi/s` |  28.51 | -          |  30.71 |  26.30 |
| `trace_gen_time_ms   ` |  402 |  804 |  510 |  294 |
| `memory_finalize_time_ms` |  8.50 |  17 |  15 |  2 |
| `stark_prove_excluding_trace_time_ms` |  3,095.50 |  6,191 |  4,019 |  2,172 |
| `main_trace_commit_time_ms` |  622 |  1,244 |  835 |  409 |
| `generate_perm_trace_time_ms` |  232.50 |  465 |  301 |  164 |
| `perm_trace_commit_time_ms` |  653 |  1,306 |  849 |  457 |
| `quotient_poly_compute_time_ms` |  322.50 |  645 |  432 |  213 |
| `quotient_poly_commit_time_ms` |  302.50 |  605 |  408 |  197 |
| `pcs_opening_time_ms ` |  953.50 |  1,907 |  1,188 |  719 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2,768 | 6 | 1 | 32 | 4,108,597 | 128.15 | 45 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 510 | 4,877 | 211,758,557 | 373,183,036 | 510 | 4,019 | 0 | 432 | 408 | 849 | 1,188 | 7 | 15 | 835 | 91,281,687 | 301 | 102 | 2,211,000 | 26.30 | 
| regex_program | 1 | 294 | 2,768 | 174,326,267 | 196,838,026 | 293 | 2,172 | 56 | 213 | 197 | 457 | 719 | 7 | 2 | 409 | 73,453,305 | 164 | 86 | 1,897,597 | 30.71 | 

...
| `total_proof_time_ms ` |  3,810.50 |  7,621 |  4,896 |  2,725 |
...
| `execute_metered_insn_mi/s` |  126.02 | -          |  126.02 |  126.02 |
| `execute_preflight_insns` |  2,054,298.50 |  4,108,597 |  2,211,000 |  1,897,597 |
| `execute_preflight_time_ms` |  93.50 |  187 |  102 |  85 |
| `execute_preflight_insn_mi/s` |  28.17 | -          |  30.59 |  25.75 |
| `trace_gen_time_ms   ` |  391.50 |  783 |  501 |  282 |
| `memory_finalize_time_ms` |  7.50 |  15 |  13 |  2 |
| `stark_prove_excluding_trace_time_ms` |  3,095.50 |  6,191 |  4,049 |  2,142 |
| `main_trace_commit_time_ms` |  622.50 |  1,245 |  836 |  409 |
| `generate_perm_trace_time_ms` |  235 |  470 |  320 |  150 |
| `perm_trace_commit_time_ms` |  647 |  1,294 |  847 |  447 |
| `quotient_poly_compute_time_ms` |  317 |  634 |  430 |  204 |
| `quotient_poly_commit_time_ms` |  306 |  612 |  401 |  211 |
| `pcs_opening_time_ms ` |  959 |  1,918 |  1,209 |  709 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2,725 | 7 | 1 | 32 | 4,108,597 | 126.02 | 45 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 501 | 4,896 | 211,758,557 | 373,183,036 | 501 | 4,049 | 0 | 430 | 401 | 847 | 1,209 | 7 | 13 | 836 | 91,281,687 | 320 | 102 | 2,211,000 | 25.75 | 
| regex_program | 1 | 282 | 2,725 | 174,326,267 | 196,838,026 | 282 | 2,142 | 53 | 204 | 211 | 447 | 709 | 8 | 2 | 409 | 73,453,305 | 150 | 85 | 1,897,597 | 30.59 | 

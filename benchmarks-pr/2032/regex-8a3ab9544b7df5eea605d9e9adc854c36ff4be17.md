...
|:---|---:|---:|
| Total |  7.73 |  4.92 |
| regex_program |  7.70 |  4.89 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  3,847.50 |  7,695 |  4,888 |  2,807 |
...
| `execute_preflight_insn_mi/s` |  28.26 | -          |  30.57 |  25.96 |
| `trace_gen_time_ms   ` |  393 |  786 |  501 |  285 |
| `memory_finalize_time_ms` |  9 |  18 |  14 |  4 |
| `stark_prove_excluding_trace_time_ms` |  3,127 |  6,254 |  4,038 |  2,216 |
| `main_trace_commit_time_ms` |  627.50 |  1,255 |  837 |  418 |
| `generate_perm_trace_time_ms` |  240 |  480 |  312 |  168 |
| `perm_trace_commit_time_ms` |  678 |  1,356 |  850 |  506 |
| `quotient_poly_compute_time_ms` |  315 |  630 |  435 |  195 |
| `quotient_poly_commit_time_ms` |  301 |  602 |  396 |  206 |
| `pcs_opening_time_ms ` |  959 |  1,918 |  1,204 |  714 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2,807 | 6 | 1 | 31 | 4,108,597 | 130.14 | 45 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 501 | 4,888 | 211,758,557 | 373,183,036 | 501 | 4,038 | 0 | 435 | 396 | 850 | 1,204 | 8 | 14 | 837 | 91,281,687 | 312 | 104 | 2,211,000 | 25.96 | 
| regex_program | 1 | 285 | 2,807 | 174,326,267 | 196,838,026 | 285 | 2,216 | 54 | 195 | 206 | 506 | 714 | 7 | 4 | 418 | 73,453,305 | 168 | 87 | 1,897,597 | 30.57 | 

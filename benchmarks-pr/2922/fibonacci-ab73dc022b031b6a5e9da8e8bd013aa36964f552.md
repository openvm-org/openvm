...
|:---|---:|---:|---:|
| Total |  2.05 |  1.59 |  1.59 |
| app_proof |  1.05 |  0.59 |  0.59 |
| leaf |  0.39 |  0.39 |  0.39 |
...
| `total_proof_time_ms ` |  516 |  1,032 |  573 |  459 |
| `compile_metered_time_ms` |  4 |  4 |  4 |  4 |
| `execute_metered_time_ms` |  20 | -          | -          | -          |
| `execute_metered_insns` |  4,000,051 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  192.48 | -          |  192.48 |  192.48 |
| `execute_preflight_insns` |  2,000,025.50 |  4,000,051 |  2,621,000 |  1,379,051 |
| `execute_preflight_time_ms` |  52.50 |  105 |  64 |  41 |
| `execute_preflight_insn_mi/s` |  48.48 | -          |  51.88 |  45.09 |
| `trace_gen_time_ms   ` |  28 |  56 |  34 |  22 |
| `set_initial_memory_time_ms` |  88.50 |  177 |  136 |  41 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  345 |  690 |  349 |  341 |
| `prover.main_trace_commit_time_ms` |  74 |  148 |  74 |  74 |
| `prover.rap_constraints_time_ms` |  189.50 |  379 |  192 |  187 |
| `prover.openings_time_ms` |  81 |  162 |  82 |  80 |
| `prover.rap_constraints.logup_gkr_time_ms` |  130.50 |  261 |  131 |  130 |
| `prover.rap_constraints.round0_time_ms` |  38 |  76 |  40 |  36 |
| `prover.rap_constraints.mle_rounds_time_ms` |  20.50 |  41 |  21 |  20 |
| `prover.openings.stacked_reduction_time_ms` |  15.50 |  31 |  16 |  15 |
...
| `prover.openings.whir_time_ms` |  65.50 |  131 |  66 |  65 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  392 |  392 |  392 |  392 |
...
| `prover.main_trace_commit_time_ms` |  123 |  123 |  123 |  123 |
| `prover.rap_constraints_time_ms` |  116 |  116 |  116 |  116 |
| `prover.openings_time_ms` |  112 |  112 |  112 |  112 |
| `prover.rap_constraints.logup_gkr_time_ms` |  28 |  28 |  28 |  28 |
| `prover.rap_constraints.round0_time_ms` |  52 |  52 |  52 |  52 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/ab73dc022b031b6a5e9da8e8bd013aa36964f552/fibonacci-ab73dc022b031b6a5e9da8e8bd013aa36964f552.memory.svg)
...
| 16 | VmAirWrapper<Rv64StoreAdapterAir, StoreAlignedCoreAir<3, 1, 1> |  | 17 | 11 | 3 | 
| 17 | VmAirWrapper<Rv64LoadAdapterAir, LoadAlignedCoreAir<3, 1, 1> |  | 17 | 13 | 3 | 
| 18 | VmAirWrapper<Rv64StoreAdapterAir, StoreAlignedCoreAir<2, 2, 1> |  | 17 | 11 | 3 | 
| 19 | VmAirWrapper<Rv64LoadAdapterAir, LoadAlignedCoreAir<2, 2, 1> |  | 17 | 13 | 3 | 
| 2 | PersistentBoundaryAir<8> |  | 4 | 3 | 3 | 
| 20 | VmAirWrapper<Rv64LoadAdapterAir, LoadSignExtendAlignedCoreAir<2, 2, 1> |  | 18 | 14 | 3 | 
| 21 | VmAirWrapper<Rv64StoreAdapterAir, StoreAlignedCoreAir<1, 4, 2> |  | 17 | 13 | 3 | 
| 22 | VmAirWrapper<Rv64LoadAdapterAir, LoadAlignedCoreAir<1, 4, 2> |  | 17 | 15 | 3 | 
| 23 | VmAirWrapper<Rv64LoadAdapterAir, LoadSignExtendAlignedCoreAir<1, 4, 2> |  | 18 | 16 | 3 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 68 |  |  |  | 340 |  |  |  |  |  |  | 
| app_proof |  |  |  | 459 |  | 20 | 4,000,051 | 192.48 | 0 | 1,058 |  | 
...
| app_proof | VmAirWrapper<Rv64LoadAdapterAir, LoadAlignedCoreAir<3, 1, 1> | 25 | VmAirWrapper<Rv64LoadAdapterAir, LoadAlignedCoreAir<3, 1, 1> | 0 | 224 | 
...
| app_proof | VmAirWrapper<Rv64StoreAdapterAir, StoreAlignedCoreAir<3, 1, 1> | 26 | VmAirWrapper<Rv64StoreAdapterAir, StoreAlignedCoreAir<3, 1, 1> | 0 | 224 | 
...
| app_proof | VmAirWrapper<Rv64LoadAdapterAir, LoadAlignedCoreAir<3, 1, 1> | 25 | VmAirWrapper<Rv64LoadAdapterAir, LoadAlignedCoreAir<3, 1, 1> | 1 | 56 | 
| app_proof | VmAirWrapper<Rv64StoreAdapterAir, StoreAlignedCoreAir<3, 1, 1> | 26 | VmAirWrapper<Rv64StoreAdapterAir, StoreAlignedCoreAir<3, 1, 1> | 1 | 56 | 
...
| app_proof | VmAirWrapper<Rv64LoadAdapterAir, LoadAlignedCoreAir<3, 1, 1> | 0 | 0 | 0 | 
| app_proof | VmAirWrapper<Rv64RdWriteAdapterAir, Rv64AuipcCoreAir> | 0 | 0 | 0 | 
| app_proof | VmAirWrapper<Rv64StoreAdapterAir, StoreAlignedCoreAir<3, 1, 1> | 0 | 0 | 0 | 
...
| app_proof | VmAirWrapper<Rv64LoadAdapterAir, LoadAlignedCoreAir<3, 1, 1> | 1 | 0 | 0 | 
| app_proof | VmAirWrapper<Rv64StoreAdapterAir, StoreAlignedCoreAir<3, 1, 1> | 1 | 0 | 0 | 
...
| app_proof | 16 | VmAirWrapper<Rv64StoreAdapterAir, StoreAlignedCoreAir<3, 1, 1> | STORED | 0 | 4 | 
| app_proof | 17 | VmAirWrapper<Rv64LoadAdapterAir, LoadAlignedCoreAir<3, 1, 1> | LOADD | 0 | 4 | 
...
| app_proof | 16 | VmAirWrapper<Rv64StoreAdapterAir, StoreAlignedCoreAir<3, 1, 1> | STORED | 1 | 1 | 
| app_proof | 17 | VmAirWrapper<Rv64LoadAdapterAir, LoadAlignedCoreAir<3, 1, 1> | LOADD | 1 | 1 | 
...
| app_proof | 16 | VmAirWrapper<Rv64StoreAdapterAir, StoreAlignedCoreAir<3, 1, 1> | prover | 0 | 4 | 30 | 120 | 
| app_proof | 17 | VmAirWrapper<Rv64LoadAdapterAir, LoadAlignedCoreAir<3, 1, 1> | prover | 0 | 4 | 30 | 120 | 
...
| app_proof | 16 | VmAirWrapper<Rv64StoreAdapterAir, StoreAlignedCoreAir<3, 1, 1> | prover | 1 | 1 | 30 | 30 | 
| app_proof | 17 | VmAirWrapper<Rv64LoadAdapterAir, LoadAlignedCoreAir<3, 1, 1> | prover | 1 | 1 | 30 | 30 | 
...
| app_proof | 16 | VmAirWrapper<Rv64StoreAdapterAir, StoreAlignedCoreAir<3, 1, 1> | 0 | 4 |  | 300 |  | 480 |  | 120 |  | 2,465 |  | 68 |  | 
| app_proof | 17 | VmAirWrapper<Rv64LoadAdapterAir, LoadAlignedCoreAir<3, 1, 1> | 0 | 4 |  | 300 |  | 480 |  | 120 |  | 2,465 |  | 68 |  | 
...
| app_proof | 37 | Poseidon2PeripheryAir<BabyBearParameters>, 1> | 0 | 1,192 | 856 | 894,000 | 642,000 | 1,430,400 | 1,027,200 | 357,600 | 256,800 | 43,210 | 31,030 | 1,192 | 856 | 
...
| app_proof | 16 | VmAirWrapper<Rv64StoreAdapterAir, StoreAlignedCoreAir<3, 1, 1> | 1 | 1 |  | 75 |  | 120 |  | 30 |  | 617 |  | 17 |  | 
| app_proof | 17 | VmAirWrapper<Rv64LoadAdapterAir, LoadAlignedCoreAir<3, 1, 1> | 1 | 1 |  | 75 |  | 120 |  | 30 |  | 617 |  | 17 |  | 
...
| app_proof | 37 | Poseidon2PeripheryAir<BabyBearParameters>, 1> | 1 | 894 | 130 | 670,500 | 97,500 | 1,072,800 | 156,000 | 268,200 | 39,000 | 32,408 | 4,712 | 894 | 130 | 
...
| internal_recursive.0 | 1 | prover | 15,378,769 | 172 | 47 | 0 | 0 | 67 | 24 | 24 | 28 | 14 | 0 | 56 | 48 | 8 | 1 | 6 | 47 | 47 | 67 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 139 | 32 | 0 | 0 | 61 | 23 | 22 | 24 | 13 | 0 | 45 | 38 | 7 | 1 | 5 | 32 | 32 | 61 | 0 | 3 | 13 | 0 | 0 | 
| leaf | 0 | prover | 74,741,432 | 352 | 123 | 0 | 0 | 116 | 52 | 51 | 35 | 28 | 0 | 112 | 97 | 14 | 6 | 8 | 123 | 123 | 116 | 0 | 6 | 28 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 90,435,988 | 349 | 74 | 0 | 0 | 192 | 40 | 39 | 21 | 131 | 0 | 82 | 66 | 16 | 8 | 7 | 74 | 74 | 192 | 0 | 3 | 130 | 0 | 0 | 
| app_proof | prover | 1 | 90,434,992 | 341 | 74 | 0 | 0 | 187 | 36 | 36 | 20 | 130 | 0 | 80 | 65 | 15 | 8 | 6 | 74 | 74 | 187 | 0 | 3 | 129 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 136 | 2 | 22 | 573 | 22 | 136 | 2,146,763,813 | 1,588,503 | 2,148,352,316 | 2,097,152 | 0 | 4 | 64 | 2,621,000 | 45.09 | 
| app_proof | 1 | 41 | 1 | 34 | 459 | 34 | 41 | 1,165,989,158 | 980,940,213 | 2,146,929,371 | 2,097,152 | 0 | 2 | 41 | 1,379,051 | 51.88 | 

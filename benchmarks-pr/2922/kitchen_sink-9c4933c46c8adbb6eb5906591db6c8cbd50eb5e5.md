...
| `total_proof_time_ms ` |  3,769 |  3,769 |  3,769 |  3,769 |
| `compile_metered_time_ms` |  2 |  2 |  2 |  2 |
| `execute_metered_time_ms` |  23 | -          | -          | -          |
| `execute_metered_insns` |  1,979,971 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  85.08 | -          |  85.08 |  85.08 |
| `execute_preflight_insns` |  1,979,971 |  1,979,971 |  1,979,971 |  1,979,971 |
| `execute_preflight_time_ms` |  71 |  71 |  71 |  71 |
| `execute_preflight_insn_mi/s` |  30.49 | -          |  30.49 |  30.49 |
| `trace_gen_time_ms   ` |  68 |  68 |  68 |  68 |
| `set_initial_memory_time_ms` |  137 |  137 |  137 |  137 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  3,492 |  3,492 |  3,492 |  3,492 |
| `prover.main_trace_commit_time_ms` |  1,110 |  1,110 |  1,110 |  1,110 |
| `prover.rap_constraints_time_ms` |  1,619 |  1,619 |  1,619 |  1,619 |
| `prover.openings_time_ms` |  763 |  763 |  763 |  763 |
| `prover.rap_constraints.logup_gkr_time_ms` |  263 |  263 |  263 |  263 |
| `prover.rap_constraints.round0_time_ms` |  990 |  990 |  990 |  990 |
| `prover.rap_constraints.mle_rounds_time_ms` |  365 |  365 |  365 |  365 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  862 |  862 |  862 |  862 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/9c4933c46c8adbb6eb5906591db6c8cbd50eb5e5/kitchen_sink-9c4933c46c8adbb6eb5906591db6c8cbd50eb5e5.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 71 |  |  |  | 370 |  |  |  |  |  |  | 
| app_proof |  |  |  | 3,769 |  | 23 | 1,979,971 | 85.08 | 0 | 3,796 |  | 
...
| leaf | 0 | 104 | 862 | 104 | 18 | 9 | 18 | 18 | 18 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,577,981 | 323 | 117 | 0 | 0 | 109 | 36 | 35 | 51 | 21 | 0 | 97 | 83 | 13 | 3 | 9 | 117 | 117 | 109 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 171 | 47 | 0 | 0 | 69 | 24 | 24 | 28 | 15 | 0 | 55 | 46 | 8 | 1 | 6 | 47 | 47 | 69 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 140 | 31 | 0 | 0 | 63 | 23 | 22 | 24 | 15 | 0 | 45 | 38 | 7 | 1 | 5 | 32 | 31 | 63 | 0 | 3 | 13 | 0 | 0 | 
| leaf | 0 | prover | 167,484,221 | 758 | 252 | 0 | 0 | 292 | 102 | 101 | 59 | 130 | 0 | 212 | 185 | 27 | 13 | 13 | 253 | 252 | 292 | 0 | 7 | 129 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,064,525,180 | 3,492 | 1,109 | 0 | 0 | 1,619 | 990 | 988 | 365 | 263 | 0 | 763 | 581 | 182 | 104 | 77 | 1,110 | 1,109 | 1,619 | 0 | 5 | 261 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 137 | 2 | 68 | 3,769 | 68 | 137 | 10,085,885,784 | 2,732,653,176 | 12,818,538,960 | 2,097,152 | 0 | 4 | 71 | 1,979,971 | 30.49 | 

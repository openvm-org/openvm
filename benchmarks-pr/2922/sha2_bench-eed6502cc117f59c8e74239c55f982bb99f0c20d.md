...
|:---|---:|---:|---:|
| Total |  9.27 |  6.52 |  6.52 |
| app_proof |  7.61 |  4.86 |  4.86 |
| leaf |  0.99 |  0.99 |  0.99 |
...
| `total_proof_time_ms ` |  3,762.50 |  7,525 |  4,773 |  2,752 |
| `compile_metered_time_ms` |  3 |  3 |  3 |  3 |
| `execute_metered_time_ms` |  89 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  124.100 | -          |  124.100 |  124.100 |
| `execute_preflight_insns` |  5,583,980.50 |  11,167,961 |  7,124,000 |  4,043,961 |
| `execute_preflight_time_ms` |  225 |  450 |  260 |  190 |
| `execute_preflight_insn_mi/s` |  40.50 | -          |  42.90 |  38.11 |
| `trace_gen_time_ms   ` |  117.50 |  235 |  164 |  71 |
| `set_initial_memory_time_ms` |  0 |  0 |  0 |  0 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  3,418.50 |  6,837 |  4,417 |  2,420 |
| `prover.main_trace_commit_time_ms` |  903 |  1,806 |  1,262 |  544 |
| `prover.rap_constraints_time_ms` |  1,845.50 |  3,691 |  2,304 |  1,387 |
| `prover.openings_time_ms` |  668.50 |  1,337 |  850 |  487 |
| `prover.rap_constraints.logup_gkr_time_ms` |  516.50 |  1,033 |  560 |  473 |
| `prover.rap_constraints.round0_time_ms` |  970 |  1,940 |  1,279 |  661 |
| `prover.rap_constraints.mle_rounds_time_ms` |  358.50 |  717 |  464 |  253 |
| `prover.openings.stacked_reduction_time_ms` |  154 |  308 |  198 |  110 |
| `prover.openings.stacked_reduction.round0_time_ms` |  95.50 |  191 |  124 |  67 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  58.50 |  117 |  74 |  43 |
| `prover.openings.whir_time_ms` |  514 |  1,028 |  651 |  377 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  985 |  985 |  985 |  985 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/eed6502cc117f59c8e74239c55f982bb99f0c20d/sha2_bench-eed6502cc117f59c8e74239c55f982bb99f0c20d.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 70 |  |  |  | 345 |  |  |  |  |  |  | 
| app_proof |  |  |  | 2,752 |  | 89 | 11,167,961 | 124.100 | 0 | 7,620 |  | 
...
| app_proof | VmAirWrapper<Rv64LoadAdapterAir, LoadSignExtendCoreAir<4, 1> | 0 | 1 | 1 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 324 | 116 | 0 | 0 | 107 | 35 | 34 | 51 | 20 | 0 | 99 | 86 | 13 | 3 | 9 | 116 | 116 | 107 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 171 | 47 | 0 | 0 | 68 | 24 | 23 | 28 | 14 | 0 | 55 | 47 | 8 | 1 | 6 | 47 | 47 | 67 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 136 | 32 | 0 | 0 | 61 | 22 | 22 | 24 | 13 | 0 | 42 | 35 | 7 | 1 | 5 | 32 | 32 | 61 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 237,929,144 | 880 | 369 | 0 | 0 | 224 | 106 | 105 | 67 | 51 | 0 | 286 | 249 | 36 | 19 | 16 | 369 | 369 | 224 | 0 | 10 | 50 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,233,944,826 | 4,417 | 1,262 | 0 | 0 | 2,304 | 1,279 | 1,278 | 464 | 560 | 1 | 850 | 651 | 198 | 124 | 74 | 1,262 | 1,262 | 2,304 | 0 | 4 | 558 | 0 | 0 | 
| app_proof | prover | 1 | 698,977,040 | 2,420 | 544 | 0 | 0 | 1,387 | 661 | 660 | 253 | 473 | 0 | 487 | 377 | 110 | 67 | 43 | 544 | 544 | 1,387 | 0 | 4 | 471 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 0 | 1 | 164 | 4,773 | 164 | 0 | 12,684,746,124 | 2,129,042,988 | 14,813,789,112 | 2,097,152 | 0 | 4 | 190 | 7,124,000 | 38.11 | 
| app_proof | 1 | 0 | 1 | 71 | 2,752 | 71 | 0 | 7,231,560,048 | 1,162,615,632 | 8,394,175,680 | 2,097,152 | 0 | 2 | 260 | 4,043,961 | 42.90 | 

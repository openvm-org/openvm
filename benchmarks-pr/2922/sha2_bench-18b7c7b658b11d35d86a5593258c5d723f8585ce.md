...
|:---|---:|---:|---:|
| Total |  9.46 |  6.67 |  6.67 |
| app_proof |  7.80 |  5.01 |  5.01 |
| leaf |  0.98 |  0.98 |  0.98 |
...
| `total_proof_time_ms ` |  3,853.50 |  7,707 |  4,916 |  2,791 |
...
| `execute_preflight_time_ms` |  242.50 |  485 |  264 |  221 |
| `execute_preflight_insn_mi/s` |  37.17 | -          |  39.45 |  34.90 |
| `trace_gen_time_ms   ` |  118.50 |  237 |  165 |  72 |
| `set_initial_memory_time_ms` |  89 |  178 |  137 |  41 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  3,402 |  6,804 |  4,392 |  2,412 |
| `prover.main_trace_commit_time_ms` |  905 |  1,810 |  1,264 |  546 |
| `prover.rap_constraints_time_ms` |  1,828.50 |  3,657 |  2,276 |  1,381 |
| `prover.openings_time_ms` |  667 |  1,334 |  851 |  483 |
| `prover.rap_constraints.logup_gkr_time_ms` |  515.50 |  1,031 |  561 |  470 |
| `prover.rap_constraints.round0_time_ms` |  956.50 |  1,913 |  1,251 |  662 |
| `prover.rap_constraints.mle_rounds_time_ms` |  355.50 |  711 |  463 |  248 |
| `prover.openings.stacked_reduction_time_ms` |  154 |  308 |  198 |  110 |
| `prover.openings.stacked_reduction.round0_time_ms` |  94.50 |  189 |  123 |  66 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  58.50 |  117 |  74 |  43 |
| `prover.openings.whir_time_ms` |  512.50 |  1,025 |  652 |  373 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/18b7c7b658b11d35d86a5593258c5d723f8585ce/sha2_bench-18b7c7b658b11d35d86a5593258c5d723f8585ce.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 70 |  |  |  | 351 |  |  |  |  |  |  | 
| app_proof |  |  |  | 2,791 |  | 98 | 11,167,961 | 112.99 | 0 | 7,811 |  | 
...
| internal_recursive.0 | 1 | 12 | 180 | 10 | 1 | 0 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 9 | 147 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 103 | 984 | 103 | 33 | 16 | 2 | 7 | 7 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 324 | 116 | 0 | 0 | 105 | 34 | 34 | 51 | 19 | 0 | 102 | 88 | 13 | 3 | 9 | 116 | 116 | 105 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 168 | 45 | 0 | 0 | 67 | 24 | 23 | 28 | 14 | 0 | 54 | 46 | 8 | 1 | 6 | 45 | 45 | 67 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 137 | 32 | 0 | 0 | 61 | 23 | 22 | 24 | 13 | 0 | 43 | 36 | 7 | 1 | 5 | 32 | 32 | 61 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 237,929,144 | 880 | 368 | 0 | 0 | 222 | 106 | 105 | 65 | 51 | 0 | 289 | 252 | 36 | 19 | 16 | 369 | 368 | 222 | 0 | 9 | 49 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,238,008,057 | 4,392 | 1,264 | 0 | 0 | 2,276 | 1,251 | 1,251 | 463 | 561 | 0 | 851 | 652 | 198 | 123 | 74 | 1,264 | 1,264 | 2,276 | 0 | 4 | 559 | 0 | 0 | 
| app_proof | prover | 1 | 702,057,492 | 2,412 | 546 | 0 | 0 | 1,381 | 662 | 662 | 248 | 470 | 0 | 483 | 373 | 110 | 66 | 43 | 546 | 546 | 1,381 | 0 | 4 | 469 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 137 | 1 | 165 | 4,916 | 165 | 137 | 12,733,975,620 | 2,136,596,328 | 14,870,571,948 | 2,097,152 | 0 | 4 | 221 | 7,124,000 | 34.90 | 
| app_proof | 1 | 41 | 1 | 72 | 2,791 | 72 | 41 | 7,260,494,232 | 1,178,412,888 | 8,438,907,120 | 2,097,152 | 0 | 2 | 264 | 4,043,961 | 39.45 | 

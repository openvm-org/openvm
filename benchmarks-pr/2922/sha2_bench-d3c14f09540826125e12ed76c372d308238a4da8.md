...
|:---|---:|---:|---:|
| Total |  9.51 |  6.70 |  6.70 |
| app_proof |  7.84 |  5.04 |  5.04 |
| leaf |  0.99 |  0.99 |  0.99 |
...
| `total_proof_time_ms ` |  3,873 |  7,746 |  4,937 |  2,809 |
...
| `execute_preflight_time_ms` |  241 |  482 |  268 |  214 |
| `execute_preflight_insn_mi/s` |  38.15 | -          |  40.04 |  36.26 |
| `trace_gen_time_ms   ` |  118 |  236 |  164 |  72 |
| `set_initial_memory_time_ms` |  89 |  178 |  137 |  41 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  3,423.50 |  6,847 |  4,420 |  2,427 |
| `prover.main_trace_commit_time_ms` |  907.50 |  1,815 |  1,267 |  548 |
| `prover.rap_constraints_time_ms` |  1,844.50 |  3,689 |  2,296 |  1,393 |
| `prover.openings_time_ms` |  669.50 |  1,339 |  855 |  484 |
| `prover.rap_constraints.logup_gkr_time_ms` |  519.50 |  1,039 |  565 |  474 |
| `prover.rap_constraints.round0_time_ms` |  963.50 |  1,927 |  1,261 |  666 |
| `prover.rap_constraints.mle_rounds_time_ms` |  360.50 |  721 |  469 |  252 |
| `prover.openings.stacked_reduction_time_ms` |  156 |  312 |  202 |  110 |
...
| `prover.openings.whir_time_ms` |  513.50 |  1,027 |  653 |  374 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/d3c14f09540826125e12ed76c372d308238a4da8/sha2_bench-d3c14f09540826125e12ed76c372d308238a4da8.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 67 |  |  |  | 340 |  |  |  |  |  |  | 
| app_proof |  |  |  | 2,809 |  | 98 | 11,167,961 | 113.06 | 0 | 7,851 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 322 | 116 | 0 | 0 | 106 | 34 | 33 | 51 | 20 | 0 | 98 | 85 | 13 | 3 | 9 | 116 | 116 | 106 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 166 | 46 | 0 | 0 | 66 | 24 | 23 | 28 | 13 | 0 | 53 | 45 | 8 | 1 | 6 | 46 | 46 | 66 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 141 | 32 | 0 | 0 | 61 | 23 | 22 | 24 | 13 | 0 | 47 | 40 | 7 | 1 | 5 | 32 | 32 | 61 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 237,929,144 | 889 | 369 | 0 | 0 | 225 | 106 | 105 | 68 | 50 | 0 | 294 | 257 | 36 | 19 | 16 | 370 | 369 | 224 | 0 | 9 | 49 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,238,008,057 | 4,420 | 1,267 | 0 | 0 | 2,296 | 1,261 | 1,261 | 469 | 565 | 0 | 855 | 653 | 202 | 126 | 75 | 1,267 | 1,267 | 2,296 | 0 | 4 | 563 | 0 | 0 | 
| app_proof | prover | 1 | 702,057,492 | 2,427 | 548 | 0 | 0 | 1,393 | 666 | 665 | 252 | 474 | 0 | 484 | 374 | 110 | 66 | 43 | 548 | 548 | 1,393 | 0 | 4 | 473 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 137 | 1 | 164 | 4,937 | 164 | 137 | 12,733,975,620 | 2,136,596,328 | 14,870,571,948 | 2,097,152 | 0 | 3 | 214 | 7,124,000 | 36.26 | 
| app_proof | 1 | 41 | 1 | 72 | 2,809 | 72 | 41 | 7,260,494,232 | 1,178,412,888 | 8,438,907,120 | 2,097,152 | 0 | 2 | 268 | 4,043,961 | 40.04 | 

...
|:---|---:|---:|---:|
| Total |  9.67 |  6.81 |  6.81 |
| app_proof |  7.98 |  5.13 |  5.13 |
| leaf |  1.01 |  1.01 |  1.01 |
...
| `total_proof_time_ms ` |  3,942.50 |  7,885 |  5,026 |  2,859 |
...
| `execute_preflight_time_ms` |  239.50 |  479 |  266 |  213 |
| `execute_preflight_insn_mi/s` |  37.99 | -          |  39.76 |  36.23 |
| `trace_gen_time_ms   ` |  118.50 |  237 |  165 |  72 |
| `set_initial_memory_time_ms` |  88 |  176 |  135 |  41 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  3,494.50 |  6,989 |  4,510 |  2,479 |
| `prover.main_trace_commit_time_ms` |  920.50 |  1,841 |  1,285 |  556 |
| `prover.rap_constraints_time_ms` |  1,896.50 |  3,793 |  2,362 |  1,431 |
| `prover.openings_time_ms` |  676.50 |  1,353 |  862 |  491 |
| `prover.rap_constraints.logup_gkr_time_ms` |  530.50 |  1,061 |  576 |  485 |
| `prover.rap_constraints.round0_time_ms` |  994.50 |  1,989 |  1,304 |  685 |
| `prover.rap_constraints.mle_rounds_time_ms` |  371 |  742 |  481 |  261 |
| `prover.openings.stacked_reduction_time_ms` |  158.50 |  317 |  204 |  113 |
| `prover.openings.stacked_reduction.round0_time_ms` |  97.50 |  195 |  127 |  68 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  60.50 |  121 |  77 |  44 |
| `prover.openings.whir_time_ms` |  517.50 |  1,035 |  657 |  378 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/6dcd7ade21b6365de420ce9bd181e865e0879734/sha2_bench-6dcd7ade21b6365de420ce9bd181e865e0879734.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 69 |  |  |  | 342 |  |  |  |  |  |  | 
| app_proof |  |  |  | 2,859 |  | 99 | 11,167,961 | 112.08 | 0 | 7,991 |  | 
...
| leaf | 0 | 105 | 1,006 | 105 | 33 | 16 | 2 | 6 | 6 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 327 | 118 | 0 | 0 | 108 | 36 | 35 | 51 | 20 | 0 | 100 | 87 | 13 | 3 | 9 | 118 | 118 | 108 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 171 | 47 | 0 | 0 | 68 | 25 | 25 | 28 | 13 | 0 | 54 | 46 | 8 | 1 | 6 | 48 | 47 | 68 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 137 | 32 | 0 | 0 | 61 | 23 | 22 | 24 | 13 | 0 | 43 | 36 | 7 | 1 | 5 | 32 | 32 | 61 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 237,929,144 | 901 | 376 | 0 | 0 | 229 | 109 | 108 | 67 | 52 | 0 | 295 | 257 | 38 | 20 | 17 | 376 | 376 | 229 | 0 | 10 | 50 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,238,008,057 | 4,510 | 1,285 | 0 | 0 | 2,362 | 1,304 | 1,304 | 481 | 576 | 0 | 862 | 657 | 204 | 127 | 77 | 1,285 | 1,285 | 2,362 | 0 | 6 | 573 | 0 | 0 | 
| app_proof | prover | 1 | 702,057,492 | 2,479 | 556 | 0 | 0 | 1,431 | 685 | 684 | 261 | 485 | 0 | 491 | 378 | 113 | 68 | 44 | 556 | 556 | 1,431 | 0 | 5 | 483 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 135 | 1 | 165 | 5,026 | 165 | 135 | 12,733,975,620 | 2,136,596,328 | 14,870,571,948 | 2,097,152 | 0 | 4 | 213 | 7,124,000 | 36.23 | 
| app_proof | 1 | 41 | 1 | 72 | 2,859 | 72 | 41 | 7,260,494,232 | 1,178,412,888 | 8,438,907,120 | 2,097,152 | 0 | 2 | 266 | 4,043,961 | 39.76 | 

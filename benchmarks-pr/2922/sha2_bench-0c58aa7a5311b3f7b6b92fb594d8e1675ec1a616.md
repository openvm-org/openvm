...
|:---|---:|---:|---:|
| Total |  9.61 |  6.78 |  6.78 |
| app_proof |  7.92 |  5.09 |  5.09 |
| leaf |  1 |  1 |  1 |
...
| `total_proof_time_ms ` |  3,912.50 |  7,825 |  4,995 |  2,830 |
| `compile_metered_time_ms` |  3 |  3 |  3 |  3 |
| `execute_metered_time_ms` |  100 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  111.62 | -          |  111.62 |  111.62 |
| `execute_preflight_insns` |  5,583,980.50 |  11,167,961 |  7,124,000 |  4,043,961 |
| `execute_preflight_time_ms` |  237.50 |  475 |  263 |  212 |
| `execute_preflight_insn_mi/s` |  38.22 | -          |  39.99 |  36.45 |
| `trace_gen_time_ms   ` |  119 |  238 |  166 |  72 |
| `set_initial_memory_time_ms` |  88.50 |  177 |  136 |  41 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  3,466.50 |  6,933 |  4,480 |  2,453 |
| `prover.main_trace_commit_time_ms` |  919 |  1,838 |  1,286 |  552 |
| `prover.rap_constraints_time_ms` |  1,876.50 |  3,753 |  2,338 |  1,415 |
| `prover.openings_time_ms` |  670 |  1,340 |  855 |  485 |
| `prover.rap_constraints.logup_gkr_time_ms` |  522.50 |  1,045 |  569 |  476 |
| `prover.rap_constraints.round0_time_ms` |  989 |  1,978 |  1,296 |  682 |
| `prover.rap_constraints.mle_rounds_time_ms` |  364 |  728 |  472 |  256 |
...
| `prover.openings.whir_time_ms` |  514 |  1,028 |  653 |  375 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/0c58aa7a5311b3f7b6b92fb594d8e1675ec1a616/sha2_bench-0c58aa7a5311b3f7b6b92fb594d8e1675ec1a616.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 70 |  |  |  | 343 |  |  |  |  |  |  | 
| app_proof |  |  |  | 2,830 |  | 100 | 11,167,961 | 111.62 | 0 | 7,931 |  | 
...
| leaf | 0 | 106 | 1,000 | 106 | 33 | 16 | 2 | 6 | 6 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 329 | 117 | 0 | 0 | 108 | 35 | 34 | 52 | 20 | 0 | 102 | 88 | 13 | 3 | 9 | 118 | 117 | 108 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 173 | 47 | 0 | 0 | 67 | 24 | 24 | 28 | 14 | 0 | 58 | 49 | 8 | 1 | 6 | 48 | 47 | 67 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 138 | 32 | 0 | 0 | 62 | 24 | 23 | 24 | 14 | 0 | 42 | 35 | 7 | 1 | 5 | 32 | 32 | 62 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 237,929,144 | 894 | 373 | 0 | 0 | 225 | 107 | 107 | 65 | 51 | 0 | 295 | 258 | 37 | 19 | 17 | 373 | 373 | 225 | 0 | 10 | 50 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,238,008,057 | 4,480 | 1,286 | 0 | 0 | 2,338 | 1,296 | 1,296 | 472 | 569 | 0 | 855 | 653 | 202 | 124 | 77 | 1,286 | 1,286 | 2,338 | 0 | 4 | 566 | 0 | 0 | 
| app_proof | prover | 1 | 702,057,492 | 2,453 | 552 | 0 | 0 | 1,415 | 682 | 681 | 256 | 476 | 0 | 485 | 375 | 110 | 65 | 44 | 552 | 552 | 1,415 | 0 | 4 | 475 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 136 | 1 | 166 | 4,995 | 166 | 136 | 12,733,975,620 | 2,136,596,328 | 14,870,571,948 | 2,097,152 | 0 | 4 | 212 | 7,124,000 | 36.45 | 
| app_proof | 1 | 41 | 1 | 72 | 2,830 | 72 | 41 | 7,260,494,232 | 1,178,412,888 | 8,438,907,120 | 2,097,152 | 0 | 2 | 263 | 4,043,961 | 39.99 | 

...
|:---|---:|---:|---:|
| Total |  9.64 |  6.79 |  6.79 |
| app_proof |  7.96 |  5.10 |  5.10 |
| leaf |  1.01 |  1.01 |  1.01 |
...
| `total_proof_time_ms ` |  3,929 |  7,858 |  5,001 |  2,857 |
| `compile_metered_time_ms` |  4 |  4 |  4 |  4 |
| `execute_metered_time_ms` |  101 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  110.51 | -          |  110.51 |  110.51 |
| `execute_preflight_insns` |  5,583,980.50 |  11,167,961 |  7,124,000 |  4,043,961 |
| `execute_preflight_time_ms` |  234.50 |  469 |  266 |  203 |
| `execute_preflight_insn_mi/s` |  40.42 | -          |  42.41 |  38.42 |
| `trace_gen_time_ms   ` |  119.50 |  239 |  167 |  72 |
| `set_initial_memory_time_ms` |  88 |  176 |  135 |  41 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  3,485.50 |  6,971 |  4,494 |  2,477 |
| `prover.main_trace_commit_time_ms` |  918.50 |  1,837 |  1,283 |  554 |
| `prover.rap_constraints_time_ms` |  1,893 |  3,786 |  2,355 |  1,431 |
| `prover.openings_time_ms` |  672.50 |  1,345 |  854 |  491 |
| `prover.rap_constraints.logup_gkr_time_ms` |  528 |  1,056 |  572 |  484 |
| `prover.rap_constraints.round0_time_ms` |  996.50 |  1,993 |  1,305 |  688 |
| `prover.rap_constraints.mle_rounds_time_ms` |  367.50 |  735 |  477 |  258 |
| `prover.openings.stacked_reduction_time_ms` |  157.50 |  315 |  204 |  111 |
...
| `prover.openings.whir_time_ms` |  515 |  1,030 |  650 |  380 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,008 |  1,008 |  1,008 |  1,008 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/36a796fde38bed43466ab480e9c6d294130d5d99/sha2_bench-36a796fde38bed43466ab480e9c6d294130d5d99.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 69 |  |  |  | 347 |  |  |  |  |  |  | 
| app_proof |  |  |  | 2,857 |  | 101 | 11,167,961 | 110.51 | 0 | 7,965 |  | 
...
| leaf | 0 | 105 | 1,008 | 104 | 33 | 16 | 2 | 7 | 7 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 328 | 118 | 0 | 0 | 107 | 34 | 34 | 52 | 20 | 0 | 102 | 88 | 13 | 3 | 9 | 118 | 118 | 107 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 168 | 47 | 0 | 0 | 67 | 24 | 24 | 28 | 13 | 0 | 53 | 44 | 8 | 1 | 6 | 47 | 47 | 67 | 0 | 3 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 138 | 31 | 0 | 0 | 63 | 23 | 23 | 25 | 14 | 0 | 42 | 35 | 7 | 1 | 5 | 32 | 31 | 63 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 237,929,144 | 903 | 375 | 0 | 0 | 230 | 111 | 110 | 67 | 51 | 0 | 296 | 259 | 36 | 19 | 16 | 375 | 375 | 230 | 0 | 12 | 50 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,233,944,826 | 4,494 | 1,283 | 0 | 0 | 2,355 | 1,305 | 1,304 | 477 | 572 | 0 | 854 | 650 | 204 | 126 | 77 | 1,283 | 1,283 | 2,355 | 0 | 5 | 571 | 0 | 0 | 
| app_proof | prover | 1 | 698,977,040 | 2,477 | 553 | 0 | 0 | 1,431 | 688 | 688 | 258 | 484 | 0 | 491 | 380 | 111 | 67 | 44 | 554 | 553 | 1,431 | 0 | 5 | 483 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 135 | 1 | 167 | 5,001 | 167 | 135 | 12,690,034,404 | 2,131,778,772 | 14,821,813,176 | 2,097,152 | 0 | 3 | 203 | 7,124,000 | 38.42 | 
| app_proof | 1 | 41 | 1 | 72 | 2,857 | 72 | 41 | 7,235,546,496 | 1,166,395,200 | 8,401,941,696 | 2,097,152 | 0 | 2 | 266 | 4,043,961 | 42.41 | 

...
|:---|---:|---:|---:|
| Total |  5.31 |  5.31 |  5.31 |
| app_proof |  3.79 |  3.79 |  3.79 |
| leaf |  0.86 |  0.86 |  0.86 |
...
| `total_proof_time_ms ` |  3,760 |  3,760 |  3,760 |  3,760 |
| `compile_metered_time_ms` |  2 |  2 |  2 |  2 |
| `execute_metered_time_ms` |  26 | -          | -          | -          |
| `execute_metered_insns` |  1,979,971 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  75.15 | -          |  75.15 |  75.15 |
| `execute_preflight_insns` |  1,979,971 |  1,979,971 |  1,979,971 |  1,979,971 |
| `execute_preflight_time_ms` |  79 |  79 |  79 |  79 |
| `execute_preflight_insn_mi/s` |  33.51 | -          |  33.51 |  33.51 |
| `trace_gen_time_ms   ` |  68 |  68 |  68 |  68 |
| `set_initial_memory_time_ms` |  136 |  136 |  136 |  136 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  3,476 |  3,476 |  3,476 |  3,476 |
| `prover.main_trace_commit_time_ms` |  1,112 |  1,112 |  1,112 |  1,112 |
| `prover.rap_constraints_time_ms` |  1,611 |  1,611 |  1,611 |  1,611 |
| `prover.openings_time_ms` |  752 |  752 |  752 |  752 |
| `prover.rap_constraints.logup_gkr_time_ms` |  257 |  257 |  257 |  257 |
| `prover.rap_constraints.round0_time_ms` |  984 |  984 |  984 |  984 |
| `prover.rap_constraints.mle_rounds_time_ms` |  368 |  368 |  368 |  368 |
| `prover.openings.stacked_reduction_time_ms` |  176 |  176 |  176 |  176 |
| `prover.openings.stacked_reduction.round0_time_ms` |  100 |  100 |  100 |  100 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  75 |  75 |  75 |  75 |
| `prover.openings.whir_time_ms` |  576 |  576 |  576 |  576 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  855 |  855 |  855 |  855 |
| `execute_preflight_time_ms` |  18 |  18 |  18 |  18 |
| `trace_gen_time_ms   ` |  105 |  105 |  105 |  105 |
| `generate_blob_total_time_ms` |  9 |  9 |  9 |  9 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  750 |  750 |  750 |  750 |
| `prover.main_trace_commit_time_ms` |  250 |  250 |  250 |  250 |
| `prover.rap_constraints_time_ms` |  290 |  290 |  290 |  290 |
| `prover.openings_time_ms` |  209 |  209 |  209 |  209 |
...
| `prover.openings.whir_time_ms` |  182 |  182 |  182 |  182 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/0672b159accb6a8a87dae24635dec3347a8ca34f/kitchen_sink-0672b159accb6a8a87dae24635dec3347a8ca34f.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 71 |  |  |  | 365 |  |  |  |  |  |  | 
| app_proof |  |  |  | 3,760 |  | 26 | 1,979,971 | 75.15 | 0 | 3,790 |  | 
...
| leaf | 0 | 105 | 855 | 104 | 18 | 9 | 18 | 18 | 18 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,577,981 | 322 | 116 | 0 | 0 | 106 | 35 | 34 | 50 | 20 | 0 | 100 | 86 | 13 | 3 | 9 | 116 | 116 | 106 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 169 | 46 | 0 | 0 | 67 | 24 | 24 | 28 | 14 | 0 | 54 | 46 | 8 | 1 | 6 | 46 | 46 | 67 | 0 | 2 | 12 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 136 | 31 | 0 | 0 | 63 | 24 | 23 | 24 | 14 | 0 | 41 | 33 | 7 | 1 | 5 | 31 | 31 | 63 | 0 | 2 | 13 | 0 | 0 | 
| leaf | 0 | prover | 167,484,093 | 750 | 249 | 0 | 0 | 290 | 103 | 102 | 57 | 129 | 0 | 209 | 182 | 26 | 13 | 12 | 250 | 249 | 290 | 0 | 8 | 128 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,065,888,636 | 3,476 | 1,111 | 0 | 0 | 1,611 | 984 | 983 | 368 | 257 | 1 | 752 | 576 | 176 | 100 | 75 | 1,112 | 1,111 | 1,611 | 0 | 4 | 256 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 136 | 2 | 68 | 3,760 | 68 | 136 | 10,109,416,512 | 2,725,483,920 | 12,834,900,432 | 2,097,152 | 0 | 4 | 79 | 1,979,971 | 33.51 | 

...
| `prover.rap_constraints.round0_time_ms` |  992 |  992 |  992 |  992 |
| `prover.rap_constraints.mle_rounds_time_ms` |  370 |  370 |  370 |  370 |
| `prover.openings.stacked_reduction_time_ms` |  179 |  179 |  179 |  179 |
| `prover.openings.stacked_reduction.round0_time_ms` |  102 |  102 |  102 |  102 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  76 |  76 |  76 |  76 |
| `prover.openings.whir_time_ms` |  581 |  581 |  581 |  581 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  861 |  861 |  861 |  861 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/ab73dc022b031b6a5e9da8e8bd013aa36964f552/kitchen_sink-ab73dc022b031b6a5e9da8e8bd013aa36964f552.memory.svg)
...
| 70 | VmAirWrapper<Rv64StoreAdapterAir, StoreAlignedCoreAir<3, 1, 1> |  | 17 | 11 | 3 | 
| 71 | VmAirWrapper<Rv64LoadAdapterAir, LoadAlignedCoreAir<3, 1, 1> |  | 17 | 13 | 3 | 
| 72 | VmAirWrapper<Rv64StoreAdapterAir, StoreAlignedCoreAir<2, 2, 1> |  | 17 | 11 | 3 | 
| 73 | VmAirWrapper<Rv64LoadAdapterAir, LoadAlignedCoreAir<2, 2, 1> |  | 17 | 13 | 3 | 
| 74 | VmAirWrapper<Rv64LoadAdapterAir, LoadSignExtendAlignedCoreAir<2, 2, 1> |  | 18 | 14 | 3 | 
| 75 | VmAirWrapper<Rv64StoreAdapterAir, StoreAlignedCoreAir<1, 4, 2> |  | 17 | 13 | 3 | 
| 76 | VmAirWrapper<Rv64LoadAdapterAir, LoadAlignedCoreAir<1, 4, 2> |  | 17 | 15 | 3 | 
| 77 | VmAirWrapper<Rv64LoadAdapterAir, LoadSignExtendAlignedCoreAir<1, 4, 2> |  | 18 | 16 | 3 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 67 |  |  |  | 363 |  |  |  |  |  |  | 
| app_proof |  |  |  | 3,777 |  | 25 | 1,979,971 | 76.88 | 0 | 3,806 |  | 
...
| app_proof | VmAirWrapper<Rv64LoadAdapterAir, LoadAlignedCoreAir<3, 1, 1> | 25 | VmAirWrapper<Rv64LoadAdapterAir, LoadAlignedCoreAir<3, 1, 1> | 0 | 16,251,760 | 
| app_proof | VmAirWrapper<Rv64LoadAdapterAir, LoadByteCoreAir> | 17 | VmAirWrapper<Rv64LoadAdapterAir, LoadByteCoreAir> | 0 | 397,320 | 
| app_proof | VmAirWrapper<Rv64LoadAdapterAir, LoadSignExtendAlignedCoreAir<2, 2, 1> | 22 | VmAirWrapper<Rv64LoadAdapterAir, LoadSignExtendAlignedCoreAir<2, 2, 1> | 0 | 1,273,496 | 
...
| app_proof | VmAirWrapper<Rv64StoreAdapterAir, StoreAlignedCoreAir<2, 2, 1> | 24 | VmAirWrapper<Rv64StoreAdapterAir, StoreAlignedCoreAir<2, 2, 1> | 0 | 90,608 | 
| app_proof | VmAirWrapper<Rv64StoreAdapterAir, StoreAlignedCoreAir<3, 1, 1> | 26 | VmAirWrapper<Rv64StoreAdapterAir, StoreAlignedCoreAir<3, 1, 1> | 0 | 17,191,888 | 
...
| app_proof | VmAirWrapper<Rv64StoreAdapterAir, StoreAlignedCoreAir<2, 2, 1> | 0 | 0 | 0 | 
| app_proof | VmAirWrapper<Rv64StoreAdapterAir, StoreAlignedCoreAir<3, 1, 1> | 0 | 1 | 1 | 
...
| app_proof | 70 | VmAirWrapper<Rv64StoreAdapterAir, StoreAlignedCoreAir<3, 1, 1> | STORED | 0 | 306,998 | 
| app_proof | 71 | VmAirWrapper<Rv64LoadAdapterAir, LoadAlignedCoreAir<3, 1, 1> | LOADD | 0 | 290,210 | 
| app_proof | 72 | VmAirWrapper<Rv64StoreAdapterAir, StoreAlignedCoreAir<2, 2, 1> | STOREW | 0 | 1,618 | 
| app_proof | 74 | VmAirWrapper<Rv64LoadAdapterAir, LoadSignExtendAlignedCoreAir<2, 2, 1> | LOADW | 0 | 22,741 | 
...
| app_proof | 70 | VmAirWrapper<Rv64StoreAdapterAir, StoreAlignedCoreAir<3, 1, 1> | prover | 0 | 524,288 | 30 | 15,728,640 | 
| app_proof | 71 | VmAirWrapper<Rv64LoadAdapterAir, LoadAlignedCoreAir<3, 1, 1> | prover | 0 | 524,288 | 30 | 15,728,640 | 
| app_proof | 72 | VmAirWrapper<Rv64StoreAdapterAir, StoreAlignedCoreAir<2, 2, 1> | prover | 0 | 2,048 | 30 | 61,440 | 
| app_proof | 74 | VmAirWrapper<Rv64LoadAdapterAir, LoadSignExtendAlignedCoreAir<2, 2, 1> | prover | 0 | 32,768 | 31 | 1,015,808 | 
...
| app_proof | 70 | VmAirWrapper<Rv64StoreAdapterAir, StoreAlignedCoreAir<3, 1, 1> | 0 | 306,998 | 217,290 | 23,024,850 | 16,296,750 | 36,839,760 | 26,074,800 | 9,209,940 | 6,518,700 | 189,187,518 | 133,904,962 | 5,218,966 | 3,693,930 | 
| app_proof | 71 | VmAirWrapper<Rv64LoadAdapterAir, LoadAlignedCoreAir<3, 1, 1> | 0 | 290,210 | 234,078 | 21,765,750 | 17,555,850 | 34,825,200 | 28,089,360 | 8,706,300 | 7,022,340 | 178,841,913 | 144,250,567 | 4,933,570 | 3,979,326 | 
| app_proof | 72 | VmAirWrapper<Rv64StoreAdapterAir, StoreAlignedCoreAir<2, 2, 1> | 0 | 1,618 | 430 | 121,350 | 32,250 | 194,160 | 51,600 | 48,540 | 12,900 | 997,093 | 264,987 | 27,506 | 7,310 | 
| app_proof | 74 | VmAirWrapper<Rv64LoadAdapterAir, LoadSignExtendAlignedCoreAir<2, 2, 1> | 0 | 22,741 | 10,027 | 1,762,428 | 777,092 | 2,819,884 | 1,243,348 | 704,971 | 310,837 | 14,838,503 | 6,542,617 | 409,338 | 180,486 | 
...
| app_proof | 91 | Poseidon2PeripheryAir<BabyBearParameters>, 1> | 0 | 11,026 | 5,358 | 8,269,500 | 4,018,500 | 13,231,200 | 6,429,600 | 3,307,800 | 1,607,400 | 399,693 | 194,227 | 11,026 | 5,358 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,577,981 | 330 | 116 | 0 | 0 | 107 | 35 | 34 | 50 | 20 | 0 | 105 | 92 | 13 | 3 | 9 | 117 | 116 | 107 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 169 | 46 | 0 | 0 | 67 | 24 | 24 | 28 | 14 | 0 | 56 | 47 | 8 | 1 | 6 | 46 | 46 | 67 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 141 | 32 | 0 | 0 | 63 | 24 | 23 | 24 | 14 | 0 | 44 | 37 | 7 | 1 | 5 | 33 | 32 | 63 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 167,484,221 | 758 | 251 | 0 | 0 | 293 | 103 | 102 | 58 | 130 | 0 | 213 | 186 | 27 | 13 | 13 | 252 | 251 | 293 | 0 | 8 | 130 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,064,525,180 | 3,497 | 1,108 | 0 | 0 | 1,626 | 992 | 991 | 370 | 263 | 1 | 761 | 581 | 179 | 102 | 76 | 1,109 | 1,108 | 1,626 | 0 | 4 | 261 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 135 | 2 | 68 | 3,777 | 68 | 135 | 10,096,019,184 | 2,722,519,776 | 12,818,538,960 | 2,097,152 | 0 | 4 | 74 | 1,979,971 | 35.71 | 

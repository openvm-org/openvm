...
| `total_proof_time_ms ` |  3,886 |  7,772 |  4,939 |  2,833 |
| `compile_metered_time_ms` |  3 |  3 |  3 |  3 |
| `execute_metered_time_ms` |  88 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  126.40 | -          |  126.40 |  126.40 |
| `execute_preflight_insns` |  5,583,980.50 |  11,167,961 |  7,124,000 |  4,043,961 |
| `execute_preflight_time_ms` |  238.50 |  477 |  279 |  198 |
| `execute_preflight_insn_mi/s` |  38.83 | -          |  41.13 |  36.53 |
| `trace_gen_time_ms   ` |  118.50 |  237 |  165 |  72 |
| `set_initial_memory_time_ms` |  88.50 |  177 |  136 |  41 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  3,439 |  6,878 |  4,438 |  2,440 |
| `prover.main_trace_commit_time_ms` |  910 |  1,820 |  1,271 |  549 |
| `prover.rap_constraints_time_ms` |  1,860.50 |  3,721 |  2,317 |  1,404 |
| `prover.openings_time_ms` |  668 |  1,336 |  849 |  487 |
| `prover.rap_constraints.logup_gkr_time_ms` |  521.50 |  1,043 |  565 |  478 |
| `prover.rap_constraints.round0_time_ms` |  975 |  1,950 |  1,279 |  671 |
| `prover.rap_constraints.mle_rounds_time_ms` |  362.50 |  725 |  472 |  253 |
| `prover.openings.stacked_reduction_time_ms` |  155 |  310 |  202 |  108 |
| `prover.openings.stacked_reduction.round0_time_ms` |  95.50 |  191 |  126 |  65 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  59.50 |  119 |  76 |  43 |
| `prover.openings.whir_time_ms` |  512 |  1,024 |  646 |  378 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/d3318bea6681ffd558f507d950fdd3ef2f2d7228/sha2_bench-d3318bea6681ffd558f507d950fdd3ef2f2d7228.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 71 |  |  |  | 342 |  |  |  |  |  |  | 
| app_proof |  |  |  | 2,833 |  | 88 | 11,167,961 | 126.40 | 0 | 7,866 |  | 
...
| app_proof | VmAirWrapper<Rv64LoadAdapterAir, LoadSignExtendWidthAlignedCoreAir<2, 2, 1> | 22 | VmAirWrapper<Rv64LoadAdapterAir, LoadSignExtendWidthAlignedCoreAir<2, 2, 1> | 0 | 5,852,672 | 
| app_proof | VmAirWrapper<Rv64LoadAdapterAir, LoadWidthAlignedCoreAir<3, 1, 1> | 25 | VmAirWrapper<Rv64LoadAdapterAir, LoadWidthAlignedCoreAir<3, 1, 1> | 0 | 58,618,784 | 
...
| app_proof | VmAirWrapper<Rv64StoreAdapterAir, StoreWidthAlignedCoreAir<3, 1, 1> | 26 | VmAirWrapper<Rv64StoreAdapterAir, StoreWidthAlignedCoreAir<3, 1, 1> | 0 | 58,648,632 | 
...
| app_proof | VmAirWrapper<Rv64LoadAdapterAir, LoadSignExtendWidthAlignedCoreAir<2, 2, 1> | 22 | VmAirWrapper<Rv64LoadAdapterAir, LoadSignExtendWidthAlignedCoreAir<2, 2, 1> | 1 | 3,322,872 | 
| app_proof | VmAirWrapper<Rv64LoadAdapterAir, LoadWidthAlignedCoreAir<3, 1, 1> | 25 | VmAirWrapper<Rv64LoadAdapterAir, LoadWidthAlignedCoreAir<3, 1, 1> | 1 | 33,278,560 | 
...
| app_proof | VmAirWrapper<Rv64StoreAdapterAir, StoreWidthAlignedCoreAir<3, 1, 1> | 26 | VmAirWrapper<Rv64StoreAdapterAir, StoreWidthAlignedCoreAir<3, 1, 1> | 1 | 33,277,776 | 
...
| app_proof | VmAirWrapper<Rv64LoadAdapterAir, LoadWidthAlignedCoreAir<3, 1, 1> | 0 | 5 | 8 | 
...
| app_proof | VmAirWrapper<Rv64LoadAdapterAir, LoadWidthAlignedCoreAir<3, 1, 1> | 1 | 3 | 3 | 
...
| leaf | 0 | 108 | 999 | 108 | 33 | 16 | 2 | 7 | 7 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 325 | 117 | 0 | 0 | 107 | 34 | 34 | 51 | 21 | 0 | 100 | 87 | 13 | 3 | 9 | 117 | 117 | 107 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 165 | 46 | 0 | 0 | 66 | 24 | 23 | 28 | 13 | 0 | 52 | 44 | 8 | 1 | 6 | 47 | 46 | 66 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 136 | 32 | 0 | 0 | 62 | 21 | 21 | 25 | 15 | 0 | 42 | 34 | 7 | 1 | 5 | 32 | 32 | 62 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 237,929,144 | 890 | 373 | 0 | 0 | 227 | 108 | 107 | 67 | 51 | 0 | 289 | 252 | 36 | 19 | 16 | 373 | 373 | 227 | 0 | 10 | 50 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,233,944,826 | 4,438 | 1,271 | 0 | 0 | 2,317 | 1,279 | 1,278 | 472 | 565 | 0 | 849 | 646 | 202 | 126 | 76 | 1,271 | 1,271 | 2,317 | 0 | 5 | 563 | 0 | 0 | 
| app_proof | prover | 1 | 698,977,040 | 2,440 | 549 | 0 | 0 | 1,404 | 671 | 671 | 253 | 478 | 0 | 487 | 378 | 108 | 65 | 43 | 549 | 549 | 1,403 | 0 | 5 | 476 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 136 | 1 | 165 | 4,939 | 165 | 136 | 12,684,746,124 | 2,129,042,988 | 14,813,789,112 | 2,097,152 | 0 | 3 | 198 | 7,124,000 | 36.53 | 
| app_proof | 1 | 41 | 1 | 72 | 2,833 | 72 | 41 | 7,231,560,048 | 1,162,615,632 | 8,394,175,680 | 2,097,152 | 0 | 2 | 279 | 4,043,961 | 41.13 | 

...
| `total_proof_time_ms ` |  3,798 |  3,798 |  3,798 |  3,798 |
| `compile_metered_time_ms` |  3 |  3 |  3 |  3 |
| `execute_metered_time_ms` |  22 | -          | -          | -          |
| `execute_metered_insns` |  1,979,971 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  88.70 | -          |  88.70 |  88.70 |
| `execute_preflight_insns` |  1,979,971 |  1,979,971 |  1,979,971 |  1,979,971 |
| `execute_preflight_time_ms` |  66 |  66 |  66 |  66 |
| `execute_preflight_insn_mi/s` |  32.29 | -          |  32.29 |  32.29 |
| `trace_gen_time_ms   ` |  68 |  68 |  68 |  68 |
| `set_initial_memory_time_ms` |  136 |  136 |  136 |  136 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  3,525 |  3,525 |  3,525 |  3,525 |
| `prover.main_trace_commit_time_ms` |  1,120 |  1,120 |  1,120 |  1,120 |
| `prover.rap_constraints_time_ms` |  1,637 |  1,637 |  1,637 |  1,637 |
| `prover.openings_time_ms` |  767 |  767 |  767 |  767 |
| `prover.rap_constraints.logup_gkr_time_ms` |  266 |  266 |  266 |  266 |
| `prover.rap_constraints.round0_time_ms` |  997 |  997 |  997 |  997 |
...
| `prover.openings.whir_time_ms` |  584 |  584 |  584 |  584 |
...
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  332 |  332 |  332 |  332 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/d3318bea6681ffd558f507d950fdd3ef2f2d7228/kitchen_sink-d3318bea6681ffd558f507d950fdd3ef2f2d7228.memory.svg)

| Module | Max (GB) | Max At |
| --- | ---: | --- |
| prover.stacked_commit | 12.08 | app_proof.prover.0 |
| prover.rap_constraints | 8.98 | app_proof.prover.0 |
...
| frac_sumcheck.gkr_rounds | 6.98 | app_proof.prover.0 |
| prover.batch_constraints.before_round0 | 6.98 | app_proof.prover.0 |
| frac_sumcheck.segment_tree | 6.88 | app_proof.prover.0 |
| prover.gkr_input_evals | 6.88 | app_proof.prover.0 |
...
| 70 | VmAirWrapper<Rv64StoreAdapterAir, StoreWidthAlignedCoreAir<3, 1, 1> |  | 17 | 11 | 3 | 
| 71 | VmAirWrapper<Rv64LoadAdapterAir, LoadWidthAlignedCoreAir<3, 1, 1> |  | 17 | 13 | 3 | 
| 72 | VmAirWrapper<Rv64StoreAdapterAir, StoreWidthAlignedCoreAir<2, 2, 1> |  | 17 | 11 | 3 | 
| 73 | VmAirWrapper<Rv64LoadAdapterAir, LoadWidthAlignedCoreAir<2, 2, 1> |  | 17 | 13 | 3 | 
| 74 | VmAirWrapper<Rv64LoadAdapterAir, LoadSignExtendWidthAlignedCoreAir<2, 2, 1> |  | 18 | 14 | 3 | 
| 75 | VmAirWrapper<Rv64StoreAdapterAir, StoreWidthAlignedCoreAir<1, 4, 2> |  | 17 | 13 | 3 | 
| 76 | VmAirWrapper<Rv64LoadAdapterAir, LoadWidthAlignedCoreAir<1, 4, 2> |  | 17 | 15 | 3 | 
| 77 | VmAirWrapper<Rv64LoadAdapterAir, LoadSignExtendWidthAlignedCoreAir<1, 4, 2> |  | 18 | 16 | 3 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 71 |  |  |  | 366 |  |  |  |  |  |  | 
| app_proof |  |  |  | 3,798 |  | 22 | 1,979,971 | 88.70 | 0 | 3,824 |  | 
...
| app_proof | VmAirWrapper<Rv64LoadAdapterAir, LoadByteCoreAir> | 17 | VmAirWrapper<Rv64LoadAdapterAir, LoadByteCoreAir> | 0 | 397,320 | 
| app_proof | VmAirWrapper<Rv64LoadAdapterAir, LoadSignExtendByteCoreAir> | 16 | VmAirWrapper<Rv64LoadAdapterAir, LoadSignExtendByteCoreAir> | 0 | 89,600 | 
| app_proof | VmAirWrapper<Rv64LoadAdapterAir, LoadSignExtendWidthAlignedCoreAir<2, 2, 1> | 22 | VmAirWrapper<Rv64LoadAdapterAir, LoadSignExtendWidthAlignedCoreAir<2, 2, 1> | 0 | 1,273,496 | 
| app_proof | VmAirWrapper<Rv64LoadAdapterAir, LoadWidthAlignedCoreAir<3, 1, 1> | 25 | VmAirWrapper<Rv64LoadAdapterAir, LoadWidthAlignedCoreAir<3, 1, 1> | 0 | 16,251,760 | 
...
| app_proof | VmAirWrapper<Rv64StoreAdapterAir, StoreByteCoreAir> | 18 | VmAirWrapper<Rv64StoreAdapterAir, StoreByteCoreAir> | 0 | 517,496 | 
| app_proof | VmAirWrapper<Rv64StoreAdapterAir, StoreWidthAlignedCoreAir<2, 2, 1> | 24 | VmAirWrapper<Rv64StoreAdapterAir, StoreWidthAlignedCoreAir<2, 2, 1> | 0 | 90,608 | 
| app_proof | VmAirWrapper<Rv64StoreAdapterAir, StoreWidthAlignedCoreAir<3, 1, 1> | 26 | VmAirWrapper<Rv64StoreAdapterAir, StoreWidthAlignedCoreAir<3, 1, 1> | 0 | 17,191,888 | 
...
| app_proof | VmAirWrapper<Rv64LoadAdapterAir, LoadSignExtendWidthAlignedCoreAir<2, 2, 1> | 0 | 0 | 0 | 
| app_proof | VmAirWrapper<Rv64LoadAdapterAir, LoadWidthAlignedCoreAir<3, 1, 1> | 0 | 1 | 1 | 
...
| app_proof | VmAirWrapper<Rv64StoreAdapterAir, StoreWidthAlignedCoreAir<2, 2, 1> | 0 | 0 | 0 | 
| app_proof | VmAirWrapper<Rv64StoreAdapterAir, StoreWidthAlignedCoreAir<3, 1, 1> | 0 | 1 | 1 | 
...
| app_proof | 70 | VmAirWrapper<Rv64StoreAdapterAir, StoreWidthAlignedCoreAir<3, 1, 1> | STORED | 0 | 306,998 | 
| app_proof | 71 | VmAirWrapper<Rv64LoadAdapterAir, LoadWidthAlignedCoreAir<3, 1, 1> | LOADD | 0 | 290,210 | 
| app_proof | 72 | VmAirWrapper<Rv64StoreAdapterAir, StoreWidthAlignedCoreAir<2, 2, 1> | STOREW | 0 | 1,618 | 
| app_proof | 74 | VmAirWrapper<Rv64LoadAdapterAir, LoadSignExtendWidthAlignedCoreAir<2, 2, 1> | LOADW | 0 | 22,741 | 
...
| app_proof | 70 | VmAirWrapper<Rv64StoreAdapterAir, StoreWidthAlignedCoreAir<3, 1, 1> | prover | 0 | 524,288 | 30 | 15,728,640 | 
| app_proof | 71 | VmAirWrapper<Rv64LoadAdapterAir, LoadWidthAlignedCoreAir<3, 1, 1> | prover | 0 | 524,288 | 30 | 15,728,640 | 
| app_proof | 72 | VmAirWrapper<Rv64StoreAdapterAir, StoreWidthAlignedCoreAir<2, 2, 1> | prover | 0 | 2,048 | 30 | 61,440 | 
| app_proof | 74 | VmAirWrapper<Rv64LoadAdapterAir, LoadSignExtendWidthAlignedCoreAir<2, 2, 1> | prover | 0 | 32,768 | 31 | 1,015,808 | 
...
| app_proof | 70 | VmAirWrapper<Rv64StoreAdapterAir, StoreWidthAlignedCoreAir<3, 1, 1> | 0 | 306,998 | 217,290 | 23,024,850 | 16,296,750 | 36,839,760 | 26,074,800 | 9,209,940 | 6,518,700 | 189,187,518 | 133,904,962 | 5,218,966 | 3,693,930 | 
| app_proof | 71 | VmAirWrapper<Rv64LoadAdapterAir, LoadWidthAlignedCoreAir<3, 1, 1> | 0 | 290,210 | 234,078 | 21,765,750 | 17,555,850 | 34,825,200 | 28,089,360 | 8,706,300 | 7,022,340 | 178,841,913 | 144,250,567 | 4,933,570 | 3,979,326 | 
| app_proof | 72 | VmAirWrapper<Rv64StoreAdapterAir, StoreWidthAlignedCoreAir<2, 2, 1> | 0 | 1,618 | 430 | 121,350 | 32,250 | 194,160 | 51,600 | 48,540 | 12,900 | 997,093 | 264,987 | 27,506 | 7,310 | 
| app_proof | 74 | VmAirWrapper<Rv64LoadAdapterAir, LoadSignExtendWidthAlignedCoreAir<2, 2, 1> | 0 | 22,741 | 10,027 | 1,762,428 | 777,092 | 2,819,884 | 1,243,348 | 704,971 | 310,837 | 14,838,503 | 6,542,617 | 409,338 | 180,486 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 19 | 352 | 19 | 5 | 1 | 2 | 1 | 1 | 
| internal_recursive.0 | 1 | 12 | 183 | 11 | 1 | 0 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 9 | 151 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 106 | 867 | 105 | 18 | 9 | 18 | 18 | 18 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,577,981 | 332 | 118 | 0 | 0 | 108 | 36 | 35 | 51 | 20 | 0 | 104 | 90 | 13 | 3 | 9 | 118 | 118 | 108 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 171 | 46 | 0 | 0 | 68 | 24 | 24 | 28 | 14 | 0 | 56 | 47 | 8 | 1 | 6 | 47 | 46 | 68 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 141 | 33 | 0 | 0 | 62 | 24 | 23 | 24 | 14 | 0 | 45 | 38 | 7 | 1 | 5 | 33 | 33 | 62 | 0 | 2 | 13 | 0 | 0 | 
| leaf | 0 | prover | 167,484,221 | 761 | 252 | 0 | 0 | 295 | 105 | 104 | 59 | 130 | 0 | 212 | 185 | 27 | 13 | 13 | 253 | 252 | 295 | 0 | 8 | 129 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,064,525,180 | 3,525 | 1,119 | 0 | 0 | 1,637 | 997 | 996 | 373 | 266 | 1 | 767 | 584 | 182 | 103 | 78 | 1,120 | 1,119 | 1,637 | 0 | 5 | 264 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 136 | 2 | 68 | 3,798 | 68 | 136 | 10,085,885,784 | 2,732,653,176 | 12,818,538,960 | 2,097,152 | 0 | 4 | 66 | 1,979,971 | 32.29 | 

...
| `total_proof_time_ms ` |  1,960 |  3,920 |  2,305 |  1,615 |
| `compile_metered_time_ms` |  5 |  5 |  5 |  5 |
| `execute_metered_time_ms` |  56 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  196.17 | -          |  196.17 |  196.17 |
| `execute_preflight_insns` |  5,583,980.50 |  11,167,961 |  7,124,000 |  4,043,961 |
| `execute_preflight_time_ms` |  347.50 |  695 |  487 |  208 |
| `execute_preflight_insn_mi/s` |  34.40 | -          |  35.22 |  33.59 |
| `trace_gen_time_ms   ` |  71 |  142 |  97 |  45 |
| `set_initial_memory_time_ms` |  0 |  0 |  0 |  0 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,540.50 |  3,081 |  1,999 |  1,082 |
| `prover.main_trace_commit_time_ms` |  383.50 |  767 |  548 |  219 |
| `prover.rap_constraints_time_ms` |  892.50 |  1,785 |  1,119 |  666 |
| `prover.openings_time_ms` |  264 |  528 |  331 |  197 |
| `prover.rap_constraints.logup_gkr_time_ms` |  205 |  410 |  224 |  186 |
| `prover.rap_constraints.round0_time_ms` |  508 |  1,016 |  665 |  351 |
| `prover.rap_constraints.mle_rounds_time_ms` |  178.50 |  357 |  229 |  128 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/65899a324410852ccee8b8c4feaa05fa1525e638/sha2_bench-65899a324410852ccee8b8c4feaa05fa1525e638.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 56 |  |  |  | 290 |  |  |  |  |  |  | 
| app_proof |  |  |  | 1,615 |  | 56 | 11,167,961 | 196.17 | 0 | 3,985 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 21 | 194 | 21 | 7 | 1 | 2 | 2 | 2 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 173 | 46 | 0 | 0 | 78 | 28 | 27 | 37 | 13 | 0 | 47 | 36 | 10 | 2 | 7 | 47 | 46 | 78 | 0 | 1 | 12 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 118 | 20 | 0 | 0 | 58 | 23 | 22 | 23 | 12 | 0 | 38 | 30 | 7 | 1 | 6 | 20 | 20 | 58 | 0 | 1 | 10 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 101 | 15 | 0 | 0 | 55 | 20 | 19 | 21 | 12 | 0 | 31 | 23 | 7 | 1 | 5 | 15 | 15 | 55 | 0 | 1 | 10 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,233,945,850 | 1,999 | 547 | 0 | 0 | 1,119 | 665 | 664 | 229 | 224 | 0 | 331 | 240 | 91 | 56 | 35 | 548 | 547 | 1,119 | 0 | 1 | 222 | 0 | 0 | 
| app_proof | prover | 1 | 698,978,064 | 1,082 | 219 | 0 | 0 | 666 | 351 | 350 | 128 | 186 | 0 | 197 | 144 | 52 | 31 | 21 | 219 | 219 | 666 | 0 | 1 | 185 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 0 | 2 | 97 | 2,305 | 97 | 0 | 12,684,755,076 | 2,129,046,324 | 14,813,801,400 | 2,097,152 | 0 | 3 | 208 | 7,124,000 | 35.22 | 
| app_proof | 1 | 0 | 1 | 45 | 1,615 | 44 | 0 | 7,231,569,048 | 1,162,618,920 | 8,394,187,968 | 2,097,152 | 0 | 2 | 487 | 4,043,961 | 33.59 | 

...
|:---|---:|---:|---:|
| Total |  5.21 |  5.21 |  5.20 |
| app_proof |  3.67 |  3.67 |  3.67 |
| leaf |  0.86 |  0.86 |  0.86 |
...
| `total_proof_time_ms ` |  3,647 |  3,647 |  3,647 |  3,647 |
| `compile_metered_time_ms` |  3 |  3 |  3 |  3 |
| `execute_metered_time_ms` |  22 | -          | -          | -          |
| `execute_metered_insns` |  1,979,971 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  88.64 | -          |  88.64 |  88.64 |
| `execute_preflight_insns` |  1,979,971 |  1,979,971 |  1,979,971 |  1,979,971 |
| `execute_preflight_time_ms` |  65 |  65 |  65 |  65 |
| `execute_preflight_insn_mi/s` |  33.14 | -          |  33.14 |  33.14 |
| `trace_gen_time_ms   ` |  67 |  67 |  67 |  67 |
| `set_initial_memory_time_ms` |  0 |  0 |  0 |  0 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  3,513 |  3,513 |  3,513 |  3,513 |
| `prover.main_trace_commit_time_ms` |  1,111 |  1,111 |  1,111 |  1,111 |
| `prover.rap_constraints_time_ms` |  1,642 |  1,642 |  1,642 |  1,642 |
| `prover.openings_time_ms` |  759 |  759 |  759 |  759 |
| `prover.rap_constraints.logup_gkr_time_ms` |  265 |  265 |  265 |  265 |
| `prover.rap_constraints.round0_time_ms` |  1,004 |  1,004 |  1,004 |  1,004 |
| `prover.rap_constraints.mle_rounds_time_ms` |  372 |  372 |  372 |  372 |
| `prover.openings.stacked_reduction_time_ms` |  180 |  180 |  180 |  180 |
...
| `prover.openings.whir_time_ms` |  578 |  578 |  578 |  578 |
...
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  756 |  756 |  756 |  756 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/eed6502cc117f59c8e74239c55f982bb99f0c20d/kitchen_sink-eed6502cc117f59c8e74239c55f982bb99f0c20d.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 70 |  |  |  | 364 |  |  |  |  |  |  | 
| app_proof |  |  |  | 3,647 |  | 22 | 1,979,971 | 88.64 | 0 | 3,674 |  | 
...
| leaf | 0 | 105 | 861 | 105 | 18 | 9 | 18 | 18 | 18 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,577,981 | 327 | 117 | 0 | 0 | 106 | 35 | 34 | 51 | 20 | 0 | 103 | 89 | 13 | 3 | 9 | 117 | 117 | 106 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 168 | 47 | 0 | 0 | 67 | 24 | 24 | 28 | 14 | 0 | 52 | 43 | 8 | 1 | 6 | 47 | 47 | 67 | 0 | 3 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 141 | 31 | 0 | 0 | 62 | 23 | 22 | 24 | 13 | 0 | 47 | 40 | 7 | 1 | 5 | 31 | 31 | 62 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 167,484,221 | 756 | 251 | 0 | 0 | 293 | 103 | 102 | 59 | 130 | 0 | 210 | 183 | 27 | 14 | 13 | 252 | 251 | 293 | 0 | 8 | 129 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,064,525,180 | 3,513 | 1,110 | 0 | 0 | 1,642 | 1,004 | 1,003 | 372 | 265 | 0 | 759 | 578 | 180 | 102 | 78 | 1,111 | 1,110 | 1,642 | 0 | 7 | 263 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 0 | 2 | 67 | 3,647 | 67 | 0 | 10,085,885,784 | 2,732,653,176 | 12,818,538,960 | 2,097,152 | 0 | 4 | 65 | 1,979,971 | 33.14 | 

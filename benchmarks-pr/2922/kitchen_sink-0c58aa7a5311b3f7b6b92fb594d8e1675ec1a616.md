...
|:---|---:|---:|---:|
| Total |  5.35 |  5.35 |  5.35 |
| app_proof |  3.82 |  3.82 |  3.82 |
| leaf |  0.86 |  0.86 |  0.86 |
...
| `total_proof_time_ms ` |  3,796 |  3,796 |  3,796 |  3,796 |
| `compile_metered_time_ms` |  2 |  2 |  2 |  2 |
| `execute_metered_time_ms` |  25 | -          | -          | -          |
| `execute_metered_insns` |  1,979,971 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  76.50 | -          |  76.50 |  76.50 |
| `execute_preflight_insns` |  1,979,971 |  1,979,971 |  1,979,971 |  1,979,971 |
| `execute_preflight_time_ms` |  79 |  79 |  79 |  79 |
| `execute_preflight_insn_mi/s` |  33.54 | -          |  33.54 |  33.54 |
| `trace_gen_time_ms   ` |  69 |  69 |  69 |  69 |
| `set_initial_memory_time_ms` |  136 |  136 |  136 |  136 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  3,511 |  3,511 |  3,511 |  3,511 |
| `prover.main_trace_commit_time_ms` |  1,125 |  1,125 |  1,125 |  1,125 |
| `prover.rap_constraints_time_ms` |  1,626 |  1,626 |  1,626 |  1,626 |
| `prover.openings_time_ms` |  760 |  760 |  760 |  760 |
| `prover.rap_constraints.logup_gkr_time_ms` |  263 |  263 |  263 |  263 |
| `prover.rap_constraints.round0_time_ms` |  991 |  991 |  991 |  991 |
| `prover.rap_constraints.mle_rounds_time_ms` |  371 |  371 |  371 |  371 |
| `prover.openings.stacked_reduction_time_ms` |  182 |  182 |  182 |  182 |
| `prover.openings.stacked_reduction.round0_time_ms` |  105 |  105 |  105 |  105 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  77 |  77 |  77 |  77 |
| `prover.openings.whir_time_ms` |  577 |  577 |  577 |  577 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  857 |  857 |  857 |  857 |
| `execute_preflight_time_ms` |  18 |  18 |  18 |  18 |
| `trace_gen_time_ms   ` |  105 |  105 |  105 |  105 |
| `generate_blob_total_time_ms` |  9 |  9 |  9 |  9 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  752 |  752 |  752 |  752 |
| `prover.main_trace_commit_time_ms` |  252 |  252 |  252 |  252 |
| `prover.rap_constraints_time_ms` |  291 |  291 |  291 |  291 |
| `prover.openings_time_ms` |  208 |  208 |  208 |  208 |
| `prover.rap_constraints.logup_gkr_time_ms` |  128 |  128 |  128 |  128 |
| `prover.rap_constraints.round0_time_ms` |  104 |  104 |  104 |  104 |
...
| `prover.openings.whir_time_ms` |  181 |  181 |  181 |  181 |

| internal_for_leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  341 |  341 |  341 |  341 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/0c58aa7a5311b3f7b6b92fb594d8e1675ec1a616/kitchen_sink-0c58aa7a5311b3f7b6b92fb594d8e1675ec1a616.memory.svg)

| Module | Max (GB) | Max At |
| --- | ---: | --- |
| prover.stacked_commit | 12.10 | app_proof.prover.0 |
| prover.rap_constraints | 8.99 | app_proof.prover.0 |
| prover.prove_whir_opening | 8.20 | app_proof.prover.0 |
| prover.merkle_tree | 8.20 | app_proof.prover.0 |
| prover.openings | 8.20 | app_proof.prover.0 |
| prover.rs_code_matrix | 8.19 | app_proof.prover.0 |
| prover.batch_constraints.fold_ple_evals | 7.04 | app_proof.prover.0 |
| prover.batch_constraints.round0 | 7.04 | app_proof.prover.0 |
| prover.batch_constraints.before_round0 | 7.01 | app_proof.prover.0 |
| frac_sumcheck.gkr_rounds | 7.01 | app_proof.prover.0 |
| prover.gkr_input_evals | 6.91 | app_proof.prover.0 |
| frac_sumcheck.segment_tree | 6.91 | app_proof.prover.0 |
| prover.before_gkr_input_evals | 4.16 | app_proof.prover.0 |
...
| 48 | VmAirWrapper<Rv64VecHeapAdapterAir<2, 4, 4>, 2, 4, 4, 8, 32, 32>, BitwiseLogicCoreAir<32, 8> |  | 98 | 19 | 2 | 
| 49 | VmAirWrapper<Rv64VecHeapU16AdapterAir<2, 4, 4>, 2, 4, 4, 4, 16, 16>, AddSubCoreAir<16, 16> |  | 82 | 50 | 3 | 
| 5 | VmAirWrapper<Rv64VecHeapAdapterAir<2, 12, 12>, FieldExpressionCoreAir> |  | 741 | 381 | 2 | 
| 50 | VmAirWrapper<Rv64MultWAdapterAir, DivRemCoreAir<4, 8> |  | 30 | 65 | 3 | 
| 51 | VmAirWrapper<Rv64MultAdapterAir, DivRemCoreAir<8, 8> |  | 41 | 104 | 3 | 
| 52 | VmAirWrapper<Rv64MultAdapterAir, MulHCoreAir<8, 8> |  | 40 | 11 | 2 | 
| 53 | VmAirWrapper<Rv64MultWAdapterAir, MultiplicationCoreAir<4, 8> |  | 24 | 5 | 2 | 
| 54 | VmAirWrapper<Rv64MultAdapterAir, MultiplicationCoreAir<8, 8> |  | 31 | 4 | 2 | 
| 55 | RangeTupleCheckerAir<2> | 1 | 1 | 8 | 3 | 
| 56 | Sha2MainAir<Sha512Config> | 1 | 149 | 39 | 3 | 
| 57 | Sha2BlockHasherVmAir<Sha512Config> | 1 | 53 | 1,481 | 3 | 
| 58 | Sha2MainAir<Sha256Config> | 1 | 85 | 23 | 3 | 
| 59 | Sha2BlockHasherVmAir<Sha256Config> | 1 | 29 | 754 | 3 | 
| 6 | VmAirWrapper<Rv64VecHeapAdapterAir<1, 8, 8>, FieldExpressionCoreAir> |  | 464 | 280 | 3 | 
| 60 | KeccakfOpAir |  | 110 | 27 | 2 | 
| 61 | KeccakfPermAir | 1 | 2 | 3,183 | 3 | 
| 62 | XorinVmAir |  | 357 | 92 | 3 | 
| 63 | Rv64HintStoreAir | 1 | 17 | 15 | 3 | 
| 64 | VmAirWrapper<Rv64RdWriteAdapterAir, Rv64AuipcCoreAir> |  | 14 | 5 | 3 | 
| 65 | VmAirWrapper<Rv64JalrAdapterAir, Rv64JalrCoreAir> |  | 15 | 9 | 3 | 
| 66 | VmAirWrapper<Rv64CondRdWriteAdapterAir, Rv64JalLuiCoreAir> |  | 12 | 11 | 2 | 
| 67 | VmAirWrapper<Rv64BranchAdapterAir, BranchLessThanCoreAir<4, 16> |  | 14 | 25 | 3 | 
| 68 | VmAirWrapper<Rv64BranchAdapterAir, BranchEqualCoreAir<4> |  | 11 | 11 | 3 | 
| 69 | VmAirWrapper<Rv64LoadStoreAdapterAir, LoadStoreDoublewordCoreAir> |  | 17 | 15 | 3 | 
| 7 | VmAirWrapper<Rv64VecHeapAdapterAir<2, 8, 8>, FieldExpressionCoreAir> |  | 501 | 257 | 2 | 
| 70 | VmAirWrapper<Rv64LoadStoreAdapterAir, LoadStoreAlignedCoreAir<2, 4, 2> |  | 17 | 18 | 3 | 
| 71 | VmAirWrapper<Rv64LoadStoreAdapterAir, LoadSignExtendAlignedCoreAir<2, 2, 1> |  | 18 | 16 | 3 | 
| 72 | VmAirWrapper<Rv64LoadStoreAdapterAir, LoadStoreAlignedCoreAir<1, 8, 3> |  | 17 | 19 | 3 | 
| 73 | VmAirWrapper<Rv64LoadStoreAdapterAir, LoadSignExtendAlignedCoreAir<1, 4, 2> |  | 18 | 18 | 3 | 
| 74 | VmAirWrapper<Rv64LoadStoreAdapterAir, LoadStoreByteCoreAir> |  | 19 | 23 | 3 | 
| 75 | VmAirWrapper<Rv64LoadStoreAdapterAir, LoadSignExtendByteCoreAir> |  | 19 | 20 | 3 | 
| 76 | VmAirWrapper<Rv64BaseAluWAdapterAir, ShiftCoreAir<4, 8> |  | 29 | 77 | 3 | 
| 77 | VmAirWrapper<Rv64BaseAluAdapterAir, ShiftCoreAir<8, 8> |  | 38 | 180 | 3 | 
| 78 | VmAirWrapper<Rv64BaseAluU16AdapterAir, LessThanCoreAir<4, 16> |  | 19 | 30 | 3 | 
| 79 | VmAirWrapper<Rv64BaseAluWU16AdapterAir, AddSubCoreAir<2, 16> |  | 19 | 16 | 3 | 
| 8 | VmAirWrapper<Rv64VecHeapAdapterAir<1, 8, 8>, FieldExpressionCoreAir> |  | 464 | 280 | 3 | 
| 80 | VmAirWrapper<Rv64BaseAluAdapterAir, BitwiseLogicCoreAir<8, 8> |  | 24 | 16 | 3 | 
| 81 | VmAirWrapper<Rv64BaseAluU16AdapterAir, AddSubCoreAir<4, 16> |  | 20 | 21 | 3 | 
| 82 | BitwiseOperationLookupAir<8> | 1 | 2 | 19 | 2 | 
| 83 | PhantomAir |  | 3 | 1 | 2 | 
| 84 | Poseidon2PeripheryAir<BabyBearParameters>, 1> |  | 1 | 282 | 3 | 
| 85 | VariableRangeCheckerAir | 1 | 1 | 10 | 3 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 70 |  |  |  | 361 |  |  |  |  |  |  | 
| app_proof |  |  |  | 3,796 |  | 25 | 1,979,971 | 76.50 | 0 | 3,826 |  | 
| internal_for_leaf |  |  | 341 |  |  |  |  |  |  |  | 341 | 
...
| --- | --- | --- | --- | --- | --- |
| app_proof | KeccakfOpAir | 29 | KeccakfOpAir | 0 | 3,030,400 | 
| app_proof | Sha2MainAir<Sha256Config> | 31 | Sha2MainAir<Sha256Config> | 0 | 5,467,200 | 
...
| app_proof | VmAirWrapper<Rv64BaseAluAdapterAir, ShiftCoreAir<8, 8> | 12 | VmAirWrapper<Rv64BaseAluAdapterAir, ShiftCoreAir<8, 8> | 0 | 3,552,064 | 
...
| app_proof | VmAirWrapper<Rv64BaseAluWAdapterAir, ShiftCoreAir<4, 8> | 13 | VmAirWrapper<Rv64BaseAluWAdapterAir, ShiftCoreAir<4, 8> | 0 | 25,600 | 
...
| app_proof | VmAirWrapper<Rv64BranchAdapterAir, BranchEqualCoreAir<4> | 21 | VmAirWrapper<Rv64BranchAdapterAir, BranchEqualCoreAir<4> | 0 | 8,552,400 | 
| app_proof | VmAirWrapper<Rv64BranchAdapterAir, BranchLessThanCoreAir<4, 16> | 22 | VmAirWrapper<Rv64BranchAdapterAir, BranchLessThanCoreAir<4, 16> | 0 | 4,946,832 | 
| app_proof | VmAirWrapper<Rv64CondRdWriteAdapterAir, Rv64JalLuiCoreAir> | 23 | VmAirWrapper<Rv64CondRdWriteAdapterAir, Rv64JalLuiCoreAir> | 0 | 4,152,600 | 
| app_proof | VmAirWrapper<Rv64IsEqualModU16AdapterAir<2, 4, 16>, ModularIsEqualCoreAir<16, 4, 16> | 49 | VmAirWrapper<Rv64IsEqualModU16AdapterAir<2, 4, 16>, ModularIsEqualCoreAir<16, 4, 16> | 0 | 1,036 | 
| app_proof | VmAirWrapper<Rv64IsEqualModU16AdapterAir<2, 4, 16>, ModularIsEqualCoreAir<16, 4, 16> | 52 | VmAirWrapper<Rv64IsEqualModU16AdapterAir<2, 4, 16>, ModularIsEqualCoreAir<16, 4, 16> | 0 | 296 | 
| app_proof | VmAirWrapper<Rv64IsEqualModU16AdapterAir<2, 4, 16>, ModularIsEqualCoreAir<16, 4, 16> | 55 | VmAirWrapper<Rv64IsEqualModU16AdapterAir<2, 4, 16>, ModularIsEqualCoreAir<16, 4, 16> | 0 | 1,036 | 
| app_proof | VmAirWrapper<Rv64IsEqualModU16AdapterAir<2, 4, 16>, ModularIsEqualCoreAir<16, 4, 16> | 58 | VmAirWrapper<Rv64IsEqualModU16AdapterAir<2, 4, 16>, ModularIsEqualCoreAir<16, 4, 16> | 0 | 296 | 
| app_proof | VmAirWrapper<Rv64IsEqualModU16AdapterAir<2, 4, 16>, ModularIsEqualCoreAir<16, 4, 16> | 61 | VmAirWrapper<Rv64IsEqualModU16AdapterAir<2, 4, 16>, ModularIsEqualCoreAir<16, 4, 16> | 0 | 1,036 | 
...
| app_proof | VmAirWrapper<Rv64IsEqualModU16AdapterAir<2, 4, 16>, ModularIsEqualCoreAir<16, 4, 16> | 73 | VmAirWrapper<Rv64IsEqualModU16AdapterAir<2, 4, 16>, ModularIsEqualCoreAir<16, 4, 16> | 0 | 592 | 
| app_proof | VmAirWrapper<Rv64IsEqualModU16AdapterAir<2, 6, 24>, ModularIsEqualCoreAir<24, 4, 16> | 67 | VmAirWrapper<Rv64IsEqualModU16AdapterAir<2, 6, 24>, ModularIsEqualCoreAir<24, 4, 16> | 0 | 1,372 | 
| app_proof | VmAirWrapper<Rv64JalrAdapterAir, Rv64JalrCoreAir> | 24 | VmAirWrapper<Rv64JalrAdapterAir, Rv64JalrCoreAir> | 0 | 4,032,720 | 
| app_proof | VmAirWrapper<Rv64LoadStoreAdapterAir, LoadSignExtendAlignedCoreAir<2, 2, 1> | 18 | VmAirWrapper<Rv64LoadStoreAdapterAir, LoadSignExtendAlignedCoreAir<2, 2, 1> | 0 | 1,273,496 | 
| app_proof | VmAirWrapper<Rv64LoadStoreAdapterAir, LoadSignExtendByteCoreAir> | 14 | VmAirWrapper<Rv64LoadStoreAdapterAir, LoadSignExtendByteCoreAir> | 0 | 89,600 | 
| app_proof | VmAirWrapper<Rv64LoadStoreAdapterAir, LoadStoreAlignedCoreAir<2, 4, 2> | 19 | VmAirWrapper<Rv64LoadStoreAdapterAir, LoadStoreAlignedCoreAir<2, 4, 2> | 0 | 90,608 | 
| app_proof | VmAirWrapper<Rv64LoadStoreAdapterAir, LoadStoreByteCoreAir> | 15 | VmAirWrapper<Rv64LoadStoreAdapterAir, LoadStoreByteCoreAir> | 0 | 914,816 | 
| app_proof | VmAirWrapper<Rv64LoadStoreAdapterAir, LoadStoreDoublewordCoreAir> | 20 | VmAirWrapper<Rv64LoadStoreAdapterAir, LoadStoreDoublewordCoreAir> | 0 | 33,443,648 | 
| app_proof | VmAirWrapper<Rv64MultAdapterAir, MultiplicationCoreAir<8, 8> | 35 | VmAirWrapper<Rv64MultAdapterAir, MultiplicationCoreAir<8, 8> | 0 | 11,480 | 
| app_proof | VmAirWrapper<Rv64RdWriteAdapterAir, Rv64AuipcCoreAir> | 25 | VmAirWrapper<Rv64RdWriteAdapterAir, Rv64AuipcCoreAir> | 0 | 1,022,720 | 
| app_proof | VmAirWrapper<Rv64VecHeapAdapterAir<1, 12, 12>, FieldExpressionCoreAir> | 85 | VmAirWrapper<Rv64VecHeapAdapterAir<1, 12, 12>, FieldExpressionCoreAir> | 0 | 972 | 
...
| app_proof | VmAirWrapper<Rv64VecHeapAdapterAir<1, 8, 8>, FieldExpressionCoreAir> | 83 | VmAirWrapper<Rv64VecHeapAdapterAir<1, 8, 8>, FieldExpressionCoreAir> | 0 | 684 | 
| app_proof | VmAirWrapper<Rv64VecHeapAdapterAir<2, 12, 12>, FieldExpressionCoreAir> | 76 | VmAirWrapper<Rv64VecHeapAdapterAir<2, 12, 12>, FieldExpressionCoreAir> | 0 | 960 | 
| app_proof | VmAirWrapper<Rv64VecHeapAdapterAir<2, 12, 12>, FieldExpressionCoreAir> | 77 | VmAirWrapper<Rv64VecHeapAdapterAir<2, 12, 12>, FieldExpressionCoreAir> | 0 | 960 | 
| app_proof | VmAirWrapper<Rv64VecHeapAdapterAir<2, 12, 12>, FieldExpressionCoreAir> | 84 | VmAirWrapper<Rv64VecHeapAdapterAir<2, 12, 12>, FieldExpressionCoreAir> | 0 | 480 | 
| app_proof | VmAirWrapper<Rv64VecHeapAdapterAir<2, 4, 4>, 2, 4, 4, 8, 32, 32>, BitwiseLogicCoreAir<32, 8> | 41 | VmAirWrapper<Rv64VecHeapAdapterAir<2, 4, 4>, 2, 4, 4, 8, 32, 32>, BitwiseLogicCoreAir<32, 8> | 0 | 76,800 | 
| app_proof | VmAirWrapper<Rv64VecHeapAdapterAir<2, 4, 4>, 2, 4, 4, 8, 32, 32>, MultiplicationCoreAir<32, 8> | 45 | VmAirWrapper<Rv64VecHeapAdapterAir<2, 4, 4>, 2, 4, 4, 8, 32, 32>, MultiplicationCoreAir<32, 8> | 0 | 37,600 | 
| app_proof | VmAirWrapper<Rv64VecHeapAdapterAir<2, 4, 4>, 2, 4, 4, 8, 32, 32>, ShiftCoreAir<32, 8> | 46 | VmAirWrapper<Rv64VecHeapAdapterAir<2, 4, 4>, 2, 4, 4, 8, 32, 32>, ShiftCoreAir<32, 8> | 0 | 76,800 | 
| app_proof | VmAirWrapper<Rv64VecHeapAdapterAir<2, 4, 4>, FieldExpressionCoreAir> | 47 | VmAirWrapper<Rv64VecHeapAdapterAir<2, 4, 4>, FieldExpressionCoreAir> | 0 | 576 | 
...
| app_proof | VmAirWrapper<Rv64VecHeapAdapterAir<2, 4, 4>, FieldExpressionCoreAir> | 50 | VmAirWrapper<Rv64VecHeapAdapterAir<2, 4, 4>, FieldExpressionCoreAir> | 0 | 384 | 
| app_proof | VmAirWrapper<Rv64VecHeapAdapterAir<2, 4, 4>, FieldExpressionCoreAir> | 51 | VmAirWrapper<Rv64VecHeapAdapterAir<2, 4, 4>, FieldExpressionCoreAir> | 0 | 384 | 
| app_proof | VmAirWrapper<Rv64VecHeapAdapterAir<2, 4, 4>, FieldExpressionCoreAir> | 53 | VmAirWrapper<Rv64VecHeapAdapterAir<2, 4, 4>, FieldExpressionCoreAir> | 0 | 576 | 
...
| app_proof | VmAirWrapper<Rv64VecHeapAdapterAir<2, 4, 4>, FieldExpressionCoreAir> | 57 | VmAirWrapper<Rv64VecHeapAdapterAir<2, 4, 4>, FieldExpressionCoreAir> | 0 | 384 | 
| app_proof | VmAirWrapper<Rv64VecHeapAdapterAir<2, 4, 4>, FieldExpressionCoreAir> | 59 | VmAirWrapper<Rv64VecHeapAdapterAir<2, 4, 4>, FieldExpressionCoreAir> | 0 | 576 | 
...
| app_proof | VmAirWrapper<Rv64VecHeapAdapterAir<2, 4, 4>, FieldExpressionCoreAir> | 71 | VmAirWrapper<Rv64VecHeapAdapterAir<2, 4, 4>, FieldExpressionCoreAir> | 0 | 12,096 | 
| app_proof | VmAirWrapper<Rv64VecHeapAdapterAir<2, 4, 4>, FieldExpressionCoreAir> | 72 | VmAirWrapper<Rv64VecHeapAdapterAir<2, 4, 4>, FieldExpressionCoreAir> | 0 | 12,096 | 
| app_proof | VmAirWrapper<Rv64VecHeapAdapterAir<2, 6, 6>, FieldExpressionCoreAir> | 65 | VmAirWrapper<Rv64VecHeapAdapterAir<2, 6, 6>, FieldExpressionCoreAir> | 0 | 792 | 
| app_proof | VmAirWrapper<Rv64VecHeapAdapterAir<2, 6, 6>, FieldExpressionCoreAir> | 66 | VmAirWrapper<Rv64VecHeapAdapterAir<2, 6, 6>, FieldExpressionCoreAir> | 0 | 528 | 
| app_proof | VmAirWrapper<Rv64VecHeapAdapterAir<2, 8, 8>, FieldExpressionCoreAir> | 74 | VmAirWrapper<Rv64VecHeapAdapterAir<2, 8, 8>, FieldExpressionCoreAir> | 0 | 672 | 
| app_proof | VmAirWrapper<Rv64VecHeapAdapterAir<2, 8, 8>, FieldExpressionCoreAir> | 75 | VmAirWrapper<Rv64VecHeapAdapterAir<2, 8, 8>, FieldExpressionCoreAir> | 0 | 672 | 
...
| app_proof | VmAirWrapper<Rv64VecHeapAdapterAir<2, 8, 8>, FieldExpressionCoreAir> | 82 | VmAirWrapper<Rv64VecHeapAdapterAir<2, 8, 8>, FieldExpressionCoreAir> | 0 | 336 | 
| app_proof | VmAirWrapper<Rv64VecHeapBranchU16AdapterAir<2, 4>, 2, 4, 4, 16>, BranchEqualCoreAir<16> | 43 | VmAirWrapper<Rv64VecHeapBranchU16AdapterAir<2, 4>, 2, 4, 4, 16>, BranchEqualCoreAir<16> | 0 | 27,200 | 
| app_proof | VmAirWrapper<Rv64VecHeapU16AdapterAir<2, 4, 4>, 2, 4, 4, 4, 16, 16>, AddSubCoreAir<16, 16> | 40 | VmAirWrapper<Rv64VecHeapU16AdapterAir<2, 4, 4>, 2, 4, 4, 4, 16, 16>, AddSubCoreAir<16, 16> | 0 | 76,800 | 
| app_proof | VmAirWrapper<Rv64VecHeapU16AdapterAir<2, 4, 4>, 2, 4, 4, 4, 16, 16>, LessThanCoreAir<16, 16> | 42 | VmAirWrapper<Rv64VecHeapU16AdapterAir<2, 4, 4>, 2, 4, 4, 4, 16, 16>, LessThanCoreAir<16, 16> | 0 | 56,640 | 
| app_proof | XorinVmAir | 27 | XorinVmAir | 0 | 6,204,448 | 
...
| app_proof | VmAirWrapper<Rv64BaseAluAdapterAir, ShiftCoreAir<8, 8> | 0 | 0 | 0 | 
| app_proof | VmAirWrapper<Rv64BaseAluU16AdapterAir, AddSubCoreAir<4, 16> | 0 |  | 7 | 
...
| app_proof | VmAirWrapper<Rv64LoadStoreAdapterAir, LoadSignExtendAlignedCoreAir<2, 2, 1> | 0 | 0 | 0 | 
| app_proof | VmAirWrapper<Rv64LoadStoreAdapterAir, LoadSignExtendByteCoreAir> | 0 | 0 | 0 | 
| app_proof | VmAirWrapper<Rv64LoadStoreAdapterAir, LoadStoreAlignedCoreAir<2, 4, 2> | 0 | 0 | 0 | 
| app_proof | VmAirWrapper<Rv64LoadStoreAdapterAir, LoadStoreByteCoreAir> | 0 | 0 | 0 | 
| app_proof | VmAirWrapper<Rv64LoadStoreAdapterAir, LoadStoreDoublewordCoreAir> | 0 | 2 | 2 | 
...
| app_proof | 48 | VmAirWrapper<Rv64VecHeapAdapterAir<2, 4, 4>, 2, 4, 4, 8, 32, 32>, BitwiseLogicCoreAir<32, 8> | AND | 0 | 200 | 
| app_proof | 48 | VmAirWrapper<Rv64VecHeapAdapterAir<2, 4, 4>, 2, 4, 4, 8, 32, 32>, BitwiseLogicCoreAir<32, 8> | XOR | 0 | 200 | 
| app_proof | 49 | VmAirWrapper<Rv64VecHeapU16AdapterAir<2, 4, 4>, 2, 4, 4, 4, 16, 16>, AddSubCoreAir<16, 16> | ADD | 0 | 200 | 
| app_proof | 49 | VmAirWrapper<Rv64VecHeapU16AdapterAir<2, 4, 4>, 2, 4, 4, 4, 16, 16>, AddSubCoreAir<16, 16> | SUB | 0 | 200 | 
| app_proof | 5 | VmAirWrapper<Rv64VecHeapAdapterAir<2, 12, 12>, FieldExpressionCoreAir> | EcAddNe | 0 | 1 | 
| app_proof | 54 | VmAirWrapper<Rv64MultAdapterAir, MultiplicationCoreAir<8, 8> | MUL | 0 | 205 | 
| app_proof | 58 | Sha2MainAir<Sha256Config> | SHA256 | 0 | 20,100 | 
| app_proof | 6 | VmAirWrapper<Rv64VecHeapAdapterAir<1, 8, 8>, FieldExpressionCoreAir> | EcDouble | 0 | 3 | 
| app_proof | 60 | KeccakfOpAir | KECCAKF | 0 | 9,470 | 
| app_proof | 62 | XorinVmAir | XORIN | 0 | 9,458 | 
| app_proof | 64 | VmAirWrapper<Rv64RdWriteAdapterAir, Rv64AuipcCoreAir> | AUIPC | 0 | 31,960 | 
| app_proof | 65 | VmAirWrapper<Rv64JalrAdapterAir, Rv64JalrCoreAir> | JALR | 0 | 84,015 | 
| app_proof | 66 | VmAirWrapper<Rv64CondRdWriteAdapterAir, Rv64JalLuiCoreAir> | JAL | 0 | 82,058 | 
| app_proof | 66 | VmAirWrapper<Rv64CondRdWriteAdapterAir, Rv64JalLuiCoreAir> | LUI | 0 | 21,757 | 
| app_proof | 67 | VmAirWrapper<Rv64BranchAdapterAir, BranchLessThanCoreAir<4, 16> | BGE | 0 | 18 | 
| app_proof | 67 | VmAirWrapper<Rv64BranchAdapterAir, BranchLessThanCoreAir<4, 16> | BGEU | 0 | 30,573 | 
| app_proof | 67 | VmAirWrapper<Rv64BranchAdapterAir, BranchLessThanCoreAir<4, 16> | BLTU | 0 | 72,468 | 
| app_proof | 68 | VmAirWrapper<Rv64BranchAdapterAir, BranchEqualCoreAir<4> | BEQ | 0 | 123,385 | 
| app_proof | 68 | VmAirWrapper<Rv64BranchAdapterAir, BranchEqualCoreAir<4> | BNE | 0 | 54,790 | 
| app_proof | 69 | VmAirWrapper<Rv64LoadStoreAdapterAir, LoadStoreDoublewordCoreAir> | LOADD | 0 | 290,210 | 
| app_proof | 69 | VmAirWrapper<Rv64LoadStoreAdapterAir, LoadStoreDoublewordCoreAir> | STORED | 0 | 306,998 | 
| app_proof | 7 | VmAirWrapper<Rv64VecHeapAdapterAir<2, 8, 8>, FieldExpressionCoreAir> | EcAddNe | 0 | 1 | 
| app_proof | 70 | VmAirWrapper<Rv64LoadStoreAdapterAir, LoadStoreAlignedCoreAir<2, 4, 2> | STOREW | 0 | 1,618 | 
| app_proof | 71 | VmAirWrapper<Rv64LoadStoreAdapterAir, LoadSignExtendAlignedCoreAir<2, 2, 1> | LOADW | 0 | 22,741 | 
| app_proof | 74 | VmAirWrapper<Rv64LoadStoreAdapterAir, LoadStoreByteCoreAir> | LOADBU | 0 | 7,095 | 
| app_proof | 74 | VmAirWrapper<Rv64LoadStoreAdapterAir, LoadStoreByteCoreAir> | STOREB | 0 | 9,241 | 
| app_proof | 75 | VmAirWrapper<Rv64LoadStoreAdapterAir, LoadSignExtendByteCoreAir> | LOADB | 0 | 1,600 | 
| app_proof | 76 | VmAirWrapper<Rv64BaseAluWAdapterAir, ShiftCoreAir<4, 8> | SRL | 0 | 400 | 
| app_proof | 77 | VmAirWrapper<Rv64BaseAluAdapterAir, ShiftCoreAir<8, 8> | SLL | 0 | 28,161 | 
| app_proof | 77 | VmAirWrapper<Rv64BaseAluAdapterAir, ShiftCoreAir<8, 8> | SRL | 0 | 27,340 | 
| app_proof | 78 | VmAirWrapper<Rv64BaseAluU16AdapterAir, LessThanCoreAir<4, 16> | SLTU | 0 | 337 | 
| app_proof | 79 | VmAirWrapper<Rv64BaseAluWU16AdapterAir, AddSubCoreAir<2, 16> | ADDW | 0 | 758 | 
| app_proof | 79 | VmAirWrapper<Rv64BaseAluWU16AdapterAir, AddSubCoreAir<2, 16> | SUBW | 0 | 21,133 | 
| app_proof | 8 | VmAirWrapper<Rv64VecHeapAdapterAir<1, 8, 8>, FieldExpressionCoreAir> | EcDouble | 0 | 3 | 
| app_proof | 80 | VmAirWrapper<Rv64BaseAluAdapterAir, BitwiseLogicCoreAir<8, 8> | AND | 0 | 126,677 | 
| app_proof | 80 | VmAirWrapper<Rv64BaseAluAdapterAir, BitwiseLogicCoreAir<8, 8> | OR | 0 | 16,863 | 
| app_proof | 80 | VmAirWrapper<Rv64BaseAluAdapterAir, BitwiseLogicCoreAir<8, 8> | XOR | 0 | 400 | 
| app_proof | 81 | VmAirWrapper<Rv64BaseAluU16AdapterAir, AddSubCoreAir<4, 16> | ADD | 0 | 494,337 | 
| app_proof | 81 | VmAirWrapper<Rv64BaseAluU16AdapterAir, AddSubCoreAir<4, 16> | SUB | 0 | 81,683 | 
...
| app_proof | 47 | VmAirWrapper<Rv64VecHeapU16AdapterAir<2, 4, 4>, 2, 4, 4, 4, 16, 16>, LessThanCoreAir<16, 16> | prover | 0 | 512 | 126 | 64,512 | 
| app_proof | 48 | VmAirWrapper<Rv64VecHeapAdapterAir<2, 4, 4>, 2, 4, 4, 8, 32, 32>, BitwiseLogicCoreAir<32, 8> | prover | 0 | 512 | 171 | 87,552 | 
| app_proof | 49 | VmAirWrapper<Rv64VecHeapU16AdapterAir<2, 4, 4>, 2, 4, 4, 4, 16, 16>, AddSubCoreAir<16, 16> | prover | 0 | 512 | 122 | 62,464 | 
| app_proof | 5 | VmAirWrapper<Rv64VecHeapAdapterAir<2, 12, 12>, FieldExpressionCoreAir> | prover | 0 | 1 | 949 | 949 | 
| app_proof | 54 | VmAirWrapper<Rv64MultAdapterAir, MultiplicationCoreAir<8, 8> | prover | 0 | 256 | 43 | 11,008 | 
| app_proof | 55 | RangeTupleCheckerAir<2> | prover | 0 | 2,097,152 | 3 | 6,291,456 | 
| app_proof | 58 | Sha2MainAir<Sha256Config> | prover | 0 | 32,768 | 150 | 4,915,200 | 
| app_proof | 59 | Sha2BlockHasherVmAir<Sha256Config> | prover | 0 | 524,288 | 456 | 239,075,328 | 
| app_proof | 6 | VmAirWrapper<Rv64VecHeapAdapterAir<1, 8, 8>, FieldExpressionCoreAir> | prover | 0 | 4 | 547 | 2,188 | 
| app_proof | 60 | KeccakfOpAir | prover | 0 | 16,384 | 284 | 4,653,056 | 
| app_proof | 61 | KeccakfPermAir | prover | 0 | 262,144 | 2,634 | 690,487,296 | 
| app_proof | 62 | XorinVmAir | prover | 0 | 16,384 | 669 | 10,960,896 | 
| app_proof | 64 | VmAirWrapper<Rv64RdWriteAdapterAir, Rv64AuipcCoreAir> | prover | 0 | 32,768 | 17 | 557,056 | 
| app_proof | 65 | VmAirWrapper<Rv64JalrAdapterAir, Rv64JalrCoreAir> | prover | 0 | 131,072 | 24 | 3,145,728 | 
| app_proof | 66 | VmAirWrapper<Rv64CondRdWriteAdapterAir, Rv64JalLuiCoreAir> | prover | 0 | 131,072 | 18 | 2,359,296 | 
| app_proof | 67 | VmAirWrapper<Rv64BranchAdapterAir, BranchLessThanCoreAir<4, 16> | prover | 0 | 131,072 | 32 | 4,194,304 | 
| app_proof | 68 | VmAirWrapper<Rv64BranchAdapterAir, BranchEqualCoreAir<4> | prover | 0 | 262,144 | 26 | 6,815,744 | 
| app_proof | 69 | VmAirWrapper<Rv64LoadStoreAdapterAir, LoadStoreDoublewordCoreAir> | prover | 0 | 1,048,576 | 31 | 32,505,856 | 
| app_proof | 7 | VmAirWrapper<Rv64VecHeapAdapterAir<2, 8, 8>, FieldExpressionCoreAir> | prover | 0 | 1 | 641 | 641 | 
| app_proof | 70 | VmAirWrapper<Rv64LoadStoreAdapterAir, LoadStoreAlignedCoreAir<2, 4, 2> | prover | 0 | 2,048 | 33 | 67,584 | 
| app_proof | 71 | VmAirWrapper<Rv64LoadStoreAdapterAir, LoadSignExtendAlignedCoreAir<2, 2, 1> | prover | 0 | 32,768 | 32 | 1,048,576 | 
| app_proof | 74 | VmAirWrapper<Rv64LoadStoreAdapterAir, LoadStoreByteCoreAir> | prover | 0 | 16,384 | 40 | 655,360 | 
| app_proof | 75 | VmAirWrapper<Rv64LoadStoreAdapterAir, LoadSignExtendByteCoreAir> | prover | 0 | 2,048 | 36 | 73,728 | 
| app_proof | 76 | VmAirWrapper<Rv64BaseAluWAdapterAir, ShiftCoreAir<4, 8> | prover | 0 | 512 | 58 | 29,696 | 
| app_proof | 77 | VmAirWrapper<Rv64BaseAluAdapterAir, ShiftCoreAir<8, 8> | prover | 0 | 65,536 | 73 | 4,784,128 | 
| app_proof | 78 | VmAirWrapper<Rv64BaseAluU16AdapterAir, LessThanCoreAir<4, 16> | prover | 0 | 512 | 38 | 19,456 | 
| app_proof | 79 | VmAirWrapper<Rv64BaseAluWU16AdapterAir, AddSubCoreAir<2, 16> | prover | 0 | 32,768 | 33 | 1,081,344 | 
| app_proof | 8 | VmAirWrapper<Rv64VecHeapAdapterAir<1, 8, 8>, FieldExpressionCoreAir> | prover | 0 | 4 | 547 | 2,188 | 
| app_proof | 80 | VmAirWrapper<Rv64BaseAluAdapterAir, BitwiseLogicCoreAir<8, 8> | prover | 0 | 262,144 | 46 | 12,058,624 | 
| app_proof | 81 | VmAirWrapper<Rv64BaseAluU16AdapterAir, AddSubCoreAir<4, 16> | prover | 0 | 1,048,576 | 34 | 35,651,584 | 
| app_proof | 82 | BitwiseOperationLookupAir<8> | prover | 0 | 65,536 | 18 | 1,179,648 | 
| app_proof | 84 | Poseidon2PeripheryAir<BabyBearParameters>, 1> | prover | 0 | 4,096 | 300 | 1,228,800 | 
| app_proof | 85 | VariableRangeCheckerAir | prover | 0 | 262,144 | 4 | 1,048,576 | 
...
| app_proof | 3 | MemoryMerkleAir<8> | 0 | 6,290 | 1,902 | 1,006,400 | 304,320 | 805,120 | 243,456 | 201,280 | 60,864 | 912,050 | 275,790 | 25,160 | 7,608 | 
...
| app_proof | 43 | VmAirWrapper<Rv64VecHeapAdapterAir<2, 4, 4>, 2, 4, 4, 8, 32, 32>, ShiftCoreAir<32, 8> | 0 | 400 | 112 | 246,000 | 68,880 | 393,600 | 110,208 | 98,400 | 27,552 | 2,146,000 | 600,880 | 59,200 | 16,576 | 
| app_proof | 44 | VmAirWrapper<Rv64VecHeapAdapterAir<2, 4, 4>, 2, 4, 4, 8, 32, 32>, MultiplicationCoreAir<32, 8> | 0 | 200 | 56 | 84,500 | 23,660 | 135,200 | 37,856 | 33,800 | 9,464 | 942,500 | 263,900 | 26,000 | 7,280 | 
| app_proof | 46 | VmAirWrapper<Rv64VecHeapBranchU16AdapterAir<2, 4>, 2, 4, 4, 16>, BranchEqualCoreAir<16> | 0 | 200 | 56 | 45,000 | 12,600 | 72,000 | 20,160 | 18,000 | 5,040 | 326,250 | 91,350 | 9,000 | 2,520 | 
| app_proof | 47 | VmAirWrapper<Rv64VecHeapU16AdapterAir<2, 4, 4>, 2, 4, 4, 4, 16, 16>, LessThanCoreAir<16, 16> | 0 | 295 | 217 | 92,925 | 68,355 | 148,680 | 109,368 | 37,170 | 27,342 | 737,869 | 542,771 | 20,355 | 14,973 | 
| app_proof | 48 | VmAirWrapper<Rv64VecHeapAdapterAir<2, 4, 4>, 2, 4, 4, 8, 32, 32>, BitwiseLogicCoreAir<32, 8> | 0 | 400 | 112 | 171,000 | 47,880 | 273,600 | 76,608 | 68,400 | 19,152 | 1,421,000 | 397,880 | 39,200 | 10,976 | 
| app_proof | 49 | VmAirWrapper<Rv64VecHeapU16AdapterAir<2, 4, 4>, 2, 4, 4, 4, 16, 16>, AddSubCoreAir<16, 16> | 0 | 400 | 112 | 122,000 | 34,160 | 195,200 | 54,656 | 48,800 | 13,664 | 1,189,000 | 332,920 | 32,800 | 9,184 | 
| app_proof | 5 | VmAirWrapper<Rv64VecHeapAdapterAir<2, 12, 12>, FieldExpressionCoreAir> | 0 | 1 |  | 2,373 |  | 3,796 |  | 949 |  | 26,862 |  | 741 |  | 
| app_proof | 54 | VmAirWrapper<Rv64MultAdapterAir, MultiplicationCoreAir<8, 8> | 0 | 205 | 51 | 22,038 | 5,482 | 35,260 | 8,772 | 8,815 | 2,193 | 230,369 | 57,311 | 6,355 | 1,581 | 
| app_proof | 55 | RangeTupleCheckerAir<2> | 0 | 2,097,152 |  | 31,457,280 |  | 25,165,824 |  | 6,291,456 |  | 76,021,760 |  | 2,097,152 |  | 

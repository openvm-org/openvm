...
| `total_proof_time_ms ` |  1,987 |  3,974 |  2,329 |  1,645 |
...
| `execute_preflight_insn_mi/s` |  34.18 | -          |  34.51 |  33.84 |
| `trace_gen_time_ms   ` |  73.50 |  147 |  100 |  47 |
| `set_initial_memory_time_ms` |  0 |  0 |  0 |  0 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,549.50 |  3,099 |  2,010 |  1,089 |
| `prover.main_trace_commit_time_ms` |  385.50 |  771 |  550 |  221 |
| `prover.rap_constraints_time_ms` |  897.50 |  1,795 |  1,127 |  668 |
| `prover.openings_time_ms` |  265 |  530 |  332 |  198 |
| `prover.rap_constraints.logup_gkr_time_ms` |  206 |  412 |  225 |  187 |
| `prover.rap_constraints.round0_time_ms` |  510.50 |  1,021 |  669 |  352 |
| `prover.rap_constraints.mle_rounds_time_ms` |  180.50 |  361 |  232 |  129 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/a330369cc8d8821e937dc07bdc53852d75714aa0/sha2_bench-a330369cc8d8821e937dc07bdc53852d75714aa0.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 58 |  |  |  | 293 |  |  |  |  |  |  | 
| app_proof |  |  |  | 1,645 |  | 56 | 11,167,961 | 196.45 | 0 | 4,040 |  | 
...
| leaf | 0 | 117 | 524 | 116 | 34 | 13 | 2 | 9 | 9 | 
...
| leaf | 0 | prover | 237,929,144 | 407 | 147 | 0 | 0 | 142 | 71 | 70 | 44 | 26 | 0 | 116 | 94 | 22 | 10 | 11 | 147 | 147 | 142 | 0 | 3 | 25 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,233,945,850 | 2,010 | 550 | 0 | 0 | 1,127 | 669 | 668 | 232 | 225 | 0 | 332 | 240 | 92 | 56 | 35 | 550 | 550 | 1,127 | 0 | 1 | 224 | 0 | 0 | 
| app_proof | prover | 1 | 698,978,064 | 1,089 | 221 | 0 | 0 | 668 | 352 | 351 | 129 | 187 | 0 | 198 | 144 | 53 | 31 | 21 | 221 | 221 | 668 | 0 | 1 | 185 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 0 | 2 | 100 | 2,329 | 100 | 0 | 12,684,755,076 | 2,129,046,324 | 14,813,801,400 | 2,097,152 | 0 | 3 | 217 | 7,124,000 | 33.84 | 
| app_proof | 1 | 0 | 1 | 47 | 1,645 | 47 | 0 | 7,231,569,048 | 1,162,618,920 | 8,394,187,968 | 2,097,152 | 0 | 2 | 508 | 4,043,961 | 34.51 | 

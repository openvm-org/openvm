...
| `total_proof_time_ms ` |  3,915.50 |  7,831 |  4,990 |  2,841 |
...
| `execute_preflight_time_ms` |  244.50 |  489 |  272 |  217 |
| `execute_preflight_insn_mi/s` |  39.25 | -          |  42.29 |  36.20 |
| `trace_gen_time_ms   ` |  119 |  238 |  166 |  72 |
| `set_initial_memory_time_ms` |  89.50 |  179 |  138 |  41 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  3,460.50 |  6,921 |  4,467 |  2,454 |
| `prover.main_trace_commit_time_ms` |  911 |  1,822 |  1,273 |  549 |
| `prover.rap_constraints_time_ms` |  1,878.50 |  3,757 |  2,341 |  1,416 |
| `prover.openings_time_ms` |  670 |  1,340 |  851 |  489 |
| `prover.rap_constraints.logup_gkr_time_ms` |  522 |  1,044 |  566 |  478 |
| `prover.rap_constraints.round0_time_ms` |  997 |  1,994 |  1,308 |  686 |
| `prover.rap_constraints.mle_rounds_time_ms` |  358.50 |  717 |  466 |  251 |
| `prover.openings.stacked_reduction_time_ms` |  155 |  310 |  201 |  109 |
| `prover.openings.stacked_reduction.round0_time_ms` |  95 |  190 |  125 |  65 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  59 |  118 |  75 |  43 |
| `prover.openings.whir_time_ms` |  514.50 |  1,029 |  650 |  379 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/26202ea58256d7a9872c15b9dc090827fa68fb7b/sha2_bench-26202ea58256d7a9872c15b9dc090827fa68fb7b.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 73 |  |  |  | 350 |  |  |  |  |  |  | 
| app_proof |  |  |  | 2,841 |  | 101 | 11,167,961 | 110.48 | 0 | 7,938 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 333 | 116 | 0 | 0 | 107 | 34 | 34 | 51 | 20 | 0 | 108 | 95 | 13 | 3 | 9 | 116 | 116 | 107 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 171 | 45 | 0 | 0 | 66 | 24 | 23 | 28 | 14 | 0 | 58 | 50 | 8 | 1 | 6 | 46 | 45 | 66 | 0 | 3 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 135 | 31 | 0 | 0 | 61 | 23 | 22 | 25 | 13 | 0 | 41 | 34 | 7 | 1 | 5 | 32 | 31 | 61 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 237,929,144 | 886 | 371 | 0 | 0 | 226 | 108 | 107 | 67 | 50 | 0 | 288 | 251 | 36 | 19 | 16 | 371 | 371 | 226 | 0 | 11 | 49 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,233,944,826 | 4,467 | 1,273 | 0 | 0 | 2,341 | 1,308 | 1,307 | 466 | 566 | 1 | 851 | 650 | 201 | 125 | 75 | 1,273 | 1,273 | 2,341 | 0 | 5 | 564 | 0 | 0 | 
| app_proof | prover | 1 | 698,977,040 | 2,454 | 548 | 0 | 0 | 1,416 | 686 | 685 | 251 | 478 | 0 | 489 | 379 | 109 | 65 | 43 | 549 | 548 | 1,416 | 0 | 5 | 476 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 138 | 2 | 166 | 4,990 | 166 | 138 | 12,690,034,404 | 2,131,778,772 | 14,821,813,176 | 2,097,152 | 0 | 4 | 217 | 7,124,000 | 36.20 | 
| app_proof | 1 | 41 | 1 | 72 | 2,841 | 72 | 41 | 7,235,546,496 | 1,166,395,200 | 8,401,941,696 | 2,097,152 | 0 | 2 | 272 | 4,043,961 | 42.29 | 

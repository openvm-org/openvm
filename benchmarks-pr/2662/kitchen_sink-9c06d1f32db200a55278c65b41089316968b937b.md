...
| `total_proof_time_ms ` |  1,151.50 |  2,303 |  1,836 |  467 |
...
| `execute_preflight_time_ms` |  79 |  158 |  80 |  78 |
| `execute_preflight_insn_mi/s` |  35.80 | -          |  37.15 |  34.44 |
| `trace_gen_time_ms   ` |  57 |  114 |  93 |  21 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  902 |  1,804 |  1,479 |  325 |
| `prover.main_trace_commit_time_ms` |  296 |  592 |  510 |  82 |
| `prover.rap_constraints_time_ms` |  539.50 |  1,079 |  874 |  205 |
| `prover.openings_time_ms` |  65.50 |  131 |  95 |  36 |
| `prover.rap_constraints.logup_gkr_time_ms` |  160 |  320 |  277 |  43 |
| `prover.rap_constraints.round0_time_ms` |  281 |  562 |  448 |  114 |
| `prover.rap_constraints.mle_rounds_time_ms` |  97 |  194 |  147 |  47 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/9c06d1f32db200a55278c65b41089316968b937b/kitchen_sink-9c06d1f32db200a55278c65b41089316968b937b.memory.svg)
...
| app_proof |  |  |  |  |  | 467 |  |  | 34 | 2,579,903 | 75.37 | 0 | 2,342 |  | 
...
| leaf | 0 | 122 | 447 | 122 | 27 | 13 | 21 | 2 | 2 | 
...
| internal_recursive.1 | 1 | prover | 17,507,975 | 94 | 14 | 0 | 4 | 49 | 17 | 17 | 18 | 13 | 0 | 30 | 8 | 21 | 0 | 20 | 15 | 49 | 0 | 1 | 12 | 0 | 0 | 
| leaf | 0 | prover | 428,317,568 | 324 | 131 | 0 | 10 | 147 | 49 | 48 | 37 | 60 | 0 | 45 | 13 | 31 | 7 | 24 | 131 | 147 | 0 | 2 | 59 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,221,261,804 | 1,479 | 509 | 0 | 290 | 874 | 448 | 447 | 147 | 277 | 139 | 95 | 17 | 77 | 25 | 52 | 510 | 874 | 0 | 1 | 137 | 0 | 0 | 
| app_proof | prover | 1 | 370,741,140 | 325 | 82 | 0 | 17 | 205 | 114 | 113 | 47 | 43 | 0 | 36 | 10 | 26 | 7 | 18 | 82 | 205 | 0 | 1 | 43 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 93 | 1,836 | 93 | 184 | 0 | 3 | 78 | 2,020,000 | 34.44 | 
| app_proof | 1 | 21 | 467 | 20 | 40 | 0 | 1 | 80 | 559,903 | 37.15 | 

...
|:---|---:|---:|---:|
| Total |  3.13 |  2.66 |  2.66 |
| app_proof |  2.31 |  1.85 |  1.85 |
| leaf |  0.44 |  0.44 |  0.44 |
...
| `total_proof_time_ms ` |  1,140.50 |  2,281 |  1,814 |  467 |
| `execute_metered_time_ms` |  34 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  75.29 | -          |  75.29 |  75.29 |
| `execute_preflight_insns` |  1,289,951.50 |  2,579,903 |  2,020,000 |  559,903 |
| `execute_preflight_time_ms` |  80 |  160 |  83 |  77 |
| `execute_preflight_insn_mi/s` |  30.76 | -          |  34.61 |  26.92 |
| `trace_gen_time_ms   ` |  57.50 |  115 |  94 |  21 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  888.50 |  1,777 |  1,456 |  321 |
| `prover.main_trace_commit_time_ms` |  290 |  580 |  499 |  81 |
| `prover.rap_constraints_time_ms` |  533 |  1,066 |  863 |  203 |
| `prover.openings_time_ms` |  64.50 |  129 |  93 |  36 |
| `prover.rap_constraints.logup_gkr_time_ms` |  158 |  316 |  274 |  42 |
| `prover.rap_constraints.round0_time_ms` |  280 |  560 |  447 |  113 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/91758cd55f87e12fa6de3e9207f6d0ccd232d9f0/kitchen_sink-91758cd55f87e12fa6de3e9207f6d0ccd232d9f0.memory.svg)
...
| app_proof |  |  |  |  |  | 467 |  |  | 34 | 2,579,903 | 75.29 | 0 | 2,320 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 18 | 156 | 17 | 6 | 1 | 2 | 1 | 1 | 
| internal_recursive.0 | 1 | 10 | 110 | 9 | 1 | 0 | 2 | 0 | 1 | 
| internal_recursive.1 | 1 | 9 | 103 | 8 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 123 | 443 | 123 | 27 | 13 | 21 | 2 | 2 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 53,472,003 | 138 | 40 | 0 | 4 | 64 | 20 | 19 | 29 | 15 | 0 | 32 | 9 | 23 | 1 | 21 | 41 | 64 | 0 | 1 | 14 | 0 | 0 | 
...
| leaf | 0 | prover | 428,317,568 | 319 | 130 | 0 | 10 | 145 | 48 | 47 | 37 | 59 | 0 | 43 | 12 | 31 | 7 | 23 | 130 | 145 | 0 | 2 | 58 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,221,261,804 | 1,456 | 499 | 0 | 283 | 863 | 447 | 446 | 141 | 274 | 135 | 93 | 16 | 76 | 25 | 51 | 499 | 863 | 0 | 1 | 136 | 0 | 0 | 
| app_proof | prover | 1 | 370,741,140 | 321 | 81 | 0 | 17 | 203 | 113 | 113 | 46 | 42 | 0 | 36 | 10 | 26 | 7 | 18 | 81 | 203 | 0 | 1 | 42 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 94 | 1,814 | 94 | 185 | 0 | 3 | 77 | 2,020,000 | 34.61 | 
| app_proof | 1 | 21 | 467 | 21 | 40 | 0 | 1 | 83 | 559,903 | 26.92 | 

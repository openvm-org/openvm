...
| `total_proof_time_ms ` |  1,145.50 |  2,291 |  1,824 |  467 |
| `execute_metered_time_ms` |  34 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  75.31 | -          |  75.31 |  75.31 |
| `execute_preflight_insns` |  1,289,951.50 |  2,579,903 |  2,020,000 |  559,903 |
| `execute_preflight_time_ms` |  80 |  160 |  82 |  78 |
| `execute_preflight_insn_mi/s` |  35.59 | -          |  37.14 |  34.04 |
| `trace_gen_time_ms   ` |  57 |  114 |  93 |  21 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  895 |  1,790 |  1,468 |  322 |
| `prover.main_trace_commit_time_ms` |  293 |  586 |  504 |  82 |
| `prover.rap_constraints_time_ms` |  536 |  1,072 |  869 |  203 |
| `prover.openings_time_ms` |  65 |  130 |  94 |  36 |
| `prover.rap_constraints.logup_gkr_time_ms` |  158 |  316 |  274 |  42 |
| `prover.rap_constraints.round0_time_ms` |  282 |  564 |  451 |  113 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/506481c41e19f7e4cd06ef39f25482dacd450465/kitchen_sink-506481c41e19f7e4cd06ef39f25482dacd450465.memory.svg)
...
| app_proof |  |  |  |  |  | 467 |  |  | 34 | 2,579,903 | 75.31 | 0 | 2,330 |  | 
...
| leaf | 0 | 123 | 443 | 123 | 27 | 13 | 22 | 2 | 2 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,221,261,804 | 1,468 | 503 | 0 | 284 | 869 | 451 | 450 | 143 | 274 | 135 | 94 | 17 | 77 | 25 | 51 | 504 | 869 | 0 | 1 | 137 | 0 | 0 | 
| app_proof | prover | 1 | 370,741,140 | 322 | 82 | 0 | 17 | 203 | 113 | 113 | 46 | 42 | 0 | 36 | 10 | 26 | 7 | 18 | 82 | 203 | 0 | 1 | 42 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 93 | 1,824 | 93 | 183 | 0 | 3 | 78 | 2,020,000 | 34.04 | 
| app_proof | 1 | 21 | 467 | 21 | 40 | 0 | 1 | 82 | 559,903 | 37.14 | 

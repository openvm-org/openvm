...
|:---|---:|---:|---:|
| Total |  3.16 |  2.69 |  2.69 |
| app_proof |  2.34 |  1.87 |  1.87 |
| leaf |  0.45 |  0.45 |  0.45 |
...
| `total_proof_time_ms ` |  1,151.50 |  2,303 |  1,840 |  463 |
| `execute_metered_time_ms` |  34 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  75.10 | -          |  75.10 |  75.10 |
| `execute_preflight_insns` |  1,289,951.50 |  2,579,903 |  2,020,000 |  559,903 |
| `execute_preflight_time_ms` |  76.50 |  153 |  77 |  76 |
| `execute_preflight_insn_mi/s` |  36.38 | -          |  37.76 |  35.01 |
| `trace_gen_time_ms   ` |  57.50 |  115 |  94 |  21 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  903.50 |  1,807 |  1,483 |  324 |
| `prover.main_trace_commit_time_ms` |  297 |  594 |  512 |  82 |
| `prover.rap_constraints_time_ms` |  540.50 |  1,081 |  876 |  205 |
| `prover.openings_time_ms` |  65 |  130 |  94 |  36 |
| `prover.rap_constraints.logup_gkr_time_ms` |  160.50 |  321 |  278 |  43 |
| `prover.rap_constraints.round0_time_ms` |  283.50 |  567 |  453 |  114 |
| `prover.rap_constraints.mle_rounds_time_ms` |  95.50 |  191 |  144 |  47 |
| `prover.openings.stacked_reduction_time_ms` |  51.50 |  103 |  77 |  26 |
...
| `prover.openings.whir_time_ms` |  13.50 |  27 |  17 |  10 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/16724dfd3d3c06eb303df78619b14b66af8e265a/kitchen_sink-16724dfd3d3c06eb303df78619b14b66af8e265a.memory.svg)
...
| app_proof |  |  |  |  |  | 463 |  |  | 34 | 2,579,903 | 75.10 | 0 | 2,343 |  | 
...
| leaf | 0 | 123 | 447 | 123 | 27 | 13 | 21 | 2 | 2 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 53,472,003 | 139 | 41 | 0 | 4 | 65 | 20 | 20 | 29 | 15 | 0 | 32 | 8 | 23 | 1 | 21 | 41 | 65 | 0 | 1 | 14 | 0 | 0 | 
...
| leaf | 0 | prover | 428,317,568 | 323 | 131 | 0 | 10 | 146 | 48 | 48 | 37 | 60 | 0 | 45 | 13 | 31 | 7 | 24 | 132 | 146 | 0 | 2 | 59 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,221,261,804 | 1,483 | 512 | 0 | 292 | 876 | 453 | 452 | 144 | 278 | 140 | 94 | 17 | 77 | 25 | 51 | 512 | 876 | 0 | 1 | 136 | 0 | 0 | 
| app_proof | prover | 1 | 370,741,140 | 324 | 82 | 0 | 17 | 205 | 114 | 114 | 47 | 43 | 0 | 36 | 10 | 26 | 7 | 18 | 82 | 205 | 0 | 1 | 42 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 94 | 1,840 | 94 | 186 | 0 | 3 | 76 | 2,020,000 | 35.01 | 
| app_proof | 1 | 21 | 463 | 21 | 40 | 0 | 1 | 77 | 559,903 | 37.76 | 

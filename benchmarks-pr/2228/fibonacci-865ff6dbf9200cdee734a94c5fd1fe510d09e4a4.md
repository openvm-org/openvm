...
| `total_proof_time_ms ` |  485.50 |  971 |  552 |  419 |
...
| `execute_metered_insn_mi/s` |  116.23 | -          |  116.23 |  116.23 |
| `execute_preflight_insns` |  750,104.50 |  1,500,209 |  873,000 |  627,209 |
| `execute_preflight_time_ms` |  29 |  58 |  33 |  25 |
| `execute_preflight_insn_mi/s` |  37.70 | -          |  39.81 |  35.58 |
| `trace_gen_time_ms   ` |  189 |  378 |  196 |  182 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  173.50 |  347 |  186 |  161 |
| `main_trace_commit_time_ms` |  30 |  60 |  32 |  28 |
| `generate_perm_trace_time_ms` |  15 |  30 |  17 |  13 |
| `perm_trace_commit_time_ms` |  42.11 |  84.22 |  44.27 |  39.95 |
| `quotient_poly_compute_time_ms` |  31.62 |  63.23 |  34.69 |  28.54 |
| `quotient_poly_commit_time_ms` |  11.69 |  23.38 |  11.100 |  11.38 |
| `pcs_opening_time_ms ` |  41 |  82 |  43 |  39 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 419 | 65 | 1 | 12 | 1,500,209 | 116.23 | 164 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 196 | 552 | 9,677,708 | 84,395,212 | 196 | 186 | 0 | 34.69 | 11.100 | 4 | 44.27 | 43 | 62 | 43 | 0 | 32 | 1,035,986 | 17 | 25 | 873,000 | 35.58 | 13 | 47 | 0 | 43 | 
| fibonacci_program | 1 | 182 | 419 | 9,708,170 | 74,305,770 | 182 | 161 | 1 | 28.54 | 11.38 | 4 | 39.95 | 39 | 53 | 39 | 0 | 28 | 1,064,416 | 13 | 33 | 627,209 | 39.81 | 11 | 40 | 0 | 39 | 

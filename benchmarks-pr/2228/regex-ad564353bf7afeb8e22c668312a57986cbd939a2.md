...
| `total_proof_time_ms ` |  579 |  2,316 |  723 |  521 |
...
| `execute_preflight_insn_mi/s` |  31.53 | -          |  32.61 |  28.39 |
| `trace_gen_time_ms   ` |  177 |  708 |  210 |  155 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  281.50 |  1,126 |  322 |  261 |
| `main_trace_commit_time_ms` |  50.75 |  203 |  56 |  49 |
| `generate_perm_trace_time_ms` |  35 |  140 |  56 |  19 |
| `perm_trace_commit_time_ms` |  63.50 |  254 |  69.92 |  54.53 |
| `quotient_poly_compute_time_ms` |  57.93 |  231.72 |  70.57 |  50.98 |
| `quotient_poly_commit_time_ms` |  14.82 |  59.26 |  17.04 |  12.57 |
| `pcs_opening_time_ms ` |  55.75 |  223 |  61 |  50 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 536 | 66 | 1 | 36 | 4,137,502 | 114.17 | 194 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 210 | 723 | 23,446,148 | 150,778,428 | 210 | 322 | 0 | 58.85 | 17.04 | 5 | 69.92 | 61 | 126 | 61 | 4 | 56 | 10,899,170 | 56 | 45 | 1,103,000 | 28.39 | 21 | 76 | 1 | 61 | 
| regex_program | 1 | 155 | 536 | 11,598,276 | 128,513,066 | 155 | 275 | 1 | 51.32 | 14.28 | 4 | 63.94 | 56 | 103 | 56 | 0 | 49 | 2,196,106 | 38 | 64 | 1,104,000 | 32.54 | 16 | 66 | 0 | 56 | 
| regex_program | 2 | 161 | 521 | 11,579,064 | 128,513,066 | 161 | 261 | 1 | 50.98 | 15.37 | 4 | 65.62 | 50 | 93 | 50 | 0 | 49 | 2,177,334 | 27 | 58 | 1,104,000 | 32.61 | 17 | 66 | 0 | 50 | 
| regex_program | 3 | 182 | 536 | 11,853,872 | 103,456,394 | 182 | 268 | 0 | 70.57 | 12.57 | 5 | 54.53 | 56 | 77 | 56 | 0 | 49 | 2,422,606 | 19 | 45 | 826,502 | 32.57 | 18 | 84 | 1 | 56 | 

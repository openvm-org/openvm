...
| `total_proof_time_ms ` |  707.50 |  1,415 |  814 |  601 |
...
| `execute_preflight_insn_mi/s` |  13.53 | -          |  17.93 |  9.13 |
| `trace_gen_time_ms   ` |  175 |  350 |  193 |  157 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  344.50 |  689 |  383 |  306 |
| `main_trace_commit_time_ms` |  64 |  128 |  75 |  53 |
| `generate_perm_trace_time_ms` |  43.50 |  87 |  46 |  41 |
| `perm_trace_commit_time_ms` |  76.08 |  152.17 |  88.28 |  63.88 |
| `quotient_poly_compute_time_ms` |  78.71 |  157.42 |  86.83 |  70.59 |
| `quotient_poly_commit_time_ms` |  15.61 |  31.21 |  16.86 |  14.35 |
| `pcs_opening_time_ms ` |  62 |  124 |  65 |  59 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 601 | 40 | 1 | 90 | 1,745,742 | 19.32 | 143 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 157 | 814 | 32,689,110 | 172,558,444 | 157 | 383 | 0 | 86.83 | 16.86 | 7 | 88.28 | 65 | 137 | 65 | 1 | 75 | 16,059,916 | 46 | 131 | 1,157,000 | 9.13 | 26 | 104 | 1 | 65 | 
| pairing | 1 | 193 | 601 | 22,314,288 | 119,958,502 | 193 | 306 | 1 | 70.59 | 14.35 | 5 | 63.88 | 59 | 108 | 59 | 0 | 53 | 9,408,294 | 41 | 59 | 588,742 | 17.93 | 20 | 85 | 1 | 59 | 

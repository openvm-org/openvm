...
| `total_proof_time_ms ` |  753 |  1,506 |  828 |  678 |
...
| `execute_preflight_insn_mi/s` |  13.75 | -          |  18.32 |  9.18 |
| `trace_gen_time_ms   ` |  180.50 |  361 |  196 |  165 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  385 |  770 |  389 |  381 |
| `main_trace_commit_time_ms` |  65.50 |  131 |  76 |  55 |
| `generate_perm_trace_time_ms` |  55 |  110 |  71 |  39 |
| `perm_trace_commit_time_ms` |  76.82 |  153.64 |  89.40 |  64.24 |
| `quotient_poly_compute_time_ms` |  79.93 |  159.87 |  87.46 |  72.41 |
| `quotient_poly_commit_time_ms` |  16.88 |  33.75 |  19.18 |  14.58 |
| `pcs_opening_time_ms ` |  86 |  172 |  99 |  73 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 678 | 41 | 1 | 91 | 1,745,742 | 19.06 | 148 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 165 | 828 | 32,689,110 | 172,558,444 | 165 | 389 | 0 | 87.46 | 19.18 | 6 | 89.40 | 73 | 131 | 73 | 1 | 76 | 16,059,916 | 39 | 129 | 1,157,000 | 9.18 | 26 | 107 | 1 | 73 | 
| pairing | 1 | 196 | 678 | 22,314,288 | 119,958,502 | 196 | 381 | 1 | 72.41 | 14.58 | 6 | 64.24 | 99 | 138 | 99 | 0 | 55 | 9,408,294 | 71 | 59 | 588,742 | 18.32 | 21 | 87 | 1 | 99 | 
...
Commit: https://github.com/openvm-org/openvm/commit/e9da04e9174ec1566996f2a6f249d5c1f1cfcef5
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19304903037)

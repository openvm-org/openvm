...
| `total_proof_time_ms ` |  718 |  1,436 |  826 |  610 |
...
| `execute_preflight_insn_mi/s` |  13.66 | -          |  18.16 |  9.16 |
| `trace_gen_time_ms   ` |  180.50 |  361 |  196 |  165 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  349 |  698 |  386 |  312 |
| `main_trace_commit_time_ms` |  65 |  130 |  76 |  54 |
| `generate_perm_trace_time_ms` |  46.50 |  93 |  48 |  45 |
| `perm_trace_commit_time_ms` |  77 |  154.01 |  88.100 |  65.01 |
| `quotient_poly_compute_time_ms` |  79.95 |  159.90 |  88.02 |  71.87 |
| `quotient_poly_commit_time_ms` |  16.15 |  32.30 |  17.48 |  14.83 |
| `pcs_opening_time_ms ` |  59 |  118 |  65 |  53 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 610 | 41 | 1 | 90 | 1,745,742 | 19.24 | 146 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 165 | 826 | 32,689,110 | 172,558,444 | 165 | 386 | 0 | 88.02 | 17.48 | 6 | 88.100 | 65 | 137 | 65 | 1 | 76 | 16,059,916 | 45 | 130 | 1,157,000 | 9.16 | 26 | 106 | 1 | 65 | 
| pairing | 1 | 196 | 610 | 22,314,288 | 119,958,502 | 196 | 312 | 1 | 71.87 | 14.83 | 6 | 65.01 | 53 | 117 | 53 | 0 | 54 | 9,408,294 | 48 | 60 | 588,742 | 18.16 | 20 | 87 | 1 | 53 | 

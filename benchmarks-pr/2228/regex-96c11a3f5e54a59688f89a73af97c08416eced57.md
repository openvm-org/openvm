...
| `total_proof_time_ms ` |  590.75 |  2,363 |  747 |  534 |
...
| `execute_metered_insn_mi/s` |  104.74 | -          |  104.74 |  104.74 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  54.75 |  219 |  68 |  45 |
| `execute_preflight_insn_mi/s` |  30.80 | -          |  31.80 |  28.66 |
| `trace_gen_time_ms   ` |  176.25 |  705 |  213 |  151 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  291.50 |  1,166 |  343 |  269 |
| `main_trace_commit_time_ms` |  51.50 |  206 |  56 |  49 |
| `generate_perm_trace_time_ms` |  34.50 |  138 |  55 |  19 |
| `perm_trace_commit_time_ms` |  63.93 |  255.71 |  70.28 |  55.65 |
| `quotient_poly_compute_time_ms` |  58.15 |  232.60 |  69.15 |  51.67 |
| `quotient_poly_commit_time_ms` |  14.80 |  59.19 |  17.16 |  13.11 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 538 | 65 | 1 | 39 | 4,137,502 | 104.74 | 193 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 213 | 747 | 23,446,148 | 150,778,428 | 213 | 343 | 0 | 59.35 | 17.16 | 5 | 70.28 | 82 | 126 | 82 | 4 | 56 | 10,899,170 | 55 | 45 | 1,103,000 | 28.66 | 21 | 77 | 1 | 82 | 
| regex_program | 1 | 151 | 544 | 11,598,276 | 128,513,066 | 151 | 282 | 1 | 51.67 | 14.63 | 4 | 65.12 | 62 | 103 | 62 | 0 | 49 | 2,196,106 | 37 | 68 | 1,104,000 | 31.20 | 16 | 66 | 0 | 62 | 
| regex_program | 2 | 160 | 534 | 11,579,064 | 128,513,066 | 160 | 272 | 1 | 52.43 | 14.29 | 4 | 64.66 | 61 | 92 | 61 | 0 | 51 | 2,177,334 | 27 | 60 | 1,104,000 | 31.80 | 16 | 67 | 0 | 61 | 
| regex_program | 3 | 181 | 538 | 11,853,872 | 103,456,394 | 181 | 269 | 0 | 69.15 | 13.11 | 5 | 55.65 | 57 | 78 | 57 | 0 | 50 | 2,422,606 | 19 | 46 | 826,502 | 31.52 | 18 | 83 | 1 | 57 | 
...
Commit: https://github.com/openvm-org/openvm/commit/96c11a3f5e54a59688f89a73af97c08416eced57
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19309182550)

...
| `total_proof_time_ms ` |  586.75 |  2,347 |  743 |  529 |
...
| `execute_metered_insn_mi/s` |  115.65 | -          |  115.65 |  115.65 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  53.50 |  214 |  65 |  45 |
| `execute_preflight_insn_mi/s` |  31.56 | -          |  32.68 |  28.64 |
| `trace_gen_time_ms   ` |  174.25 |  697 |  207 |  151 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  291 |  1,164 |  345 |  262 |
| `main_trace_commit_time_ms` |  51.50 |  206 |  57 |  49 |
| `generate_perm_trace_time_ms` |  34.25 |  137 |  55 |  18 |
| `perm_trace_commit_time_ms` |  64.07 |  256.27 |  69.89 |  55.39 |
| `quotient_poly_compute_time_ms` |  57.29 |  229.16 |  68.92 |  50.44 |
| `quotient_poly_commit_time_ms` |  15.07 |  60.29 |  17.05 |  12.62 |
| `pcs_opening_time_ms ` |  65.25 |  261 |  84 |  52 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 529 | 66 | 1 | 35 | 4,137,502 | 115.65 | 194 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 207 | 743 | 23,446,148 | 150,778,428 | 207 | 345 | 0 | 58.29 | 17.05 | 5 | 69.89 | 84 | 126 | 84 | 4 | 57 | 10,899,170 | 55 | 45 | 1,103,000 | 28.64 | 22 | 76 | 1 | 84 | 
| regex_program | 1 | 151 | 543 | 11,598,276 | 128,513,066 | 151 | 285 | 1 | 51.52 | 15.60 | 4 | 65.48 | 63 | 103 | 63 | 0 | 50 | 2,196,106 | 37 | 65 | 1,104,000 | 32.68 | 16 | 67 | 0 | 63 | 
| regex_program | 2 | 160 | 532 | 11,579,064 | 128,513,066 | 160 | 272 | 1 | 50.44 | 15.03 | 4 | 65.51 | 62 | 93 | 62 | 0 | 49 | 2,177,334 | 27 | 58 | 1,104,000 | 32.40 | 17 | 66 | 0 | 62 | 
| regex_program | 3 | 179 | 529 | 11,853,872 | 103,456,394 | 179 | 262 | 0 | 68.92 | 12.62 | 5 | 55.39 | 52 | 77 | 51 | 0 | 50 | 2,422,606 | 18 | 46 | 826,502 | 32.50 | 18 | 82 | 1 | 51 | 
...
Commit: https://github.com/openvm-org/openvm/commit/865ff6dbf9200cdee734a94c5fd1fe510d09e4a4
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19310147015)

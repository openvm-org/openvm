...
|:---|---:|---:|---:|
| Total |  5.42 |  4.10 |  4.10 |
| app_proof |  4.46 |  3.15 |  3.15 |
| leaf |  0.53 |  0.53 |  0.53 |
...
| `total_proof_time_ms ` |  2,201 |  4,402 |  2,912 |  1,490 |
| `compile_metered_time_ms` |  0 |  0 |  0 |  0 |
| `execute_metered_time_ms` |  62 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  177.89 | -          |  177.89 |  177.89 |
| `set_initial_memory_time_ms` |  3.50 |  7 |  4 |  3 |
| `execute_preflight_insns` |  5,583,980.50 |  11,167,961 |  7,136,000 |  4,031,961 |
| `execute_preflight_time_ms` |  262 |  524 |  353 |  171 |
| `execute_preflight_insn_mi/s` |  21.31 | -          |  23.48 |  20.19 |
| `postflight_time_ms  ` |  128.50 |  257 |  189 |  68 |
| `postflight_memory_chronology_time_ms` |  12 |  24 |  20 |  4 |
| `postflight_program_index_time_ms` |  1.50 |  3 |  2 |  1 |
| `trace_gen_time_ms   ` |  54.50 |  109 |  76 |  33 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,722.50 |  3,445 |  2,252 |  1,193 |
| `prover.main_trace_commit_time_ms` |  382.50 |  765 |  557 |  208 |
| `prover.rap_constraints_time_ms` |  1,072 |  2,144 |  1,353 |  791 |
| `prover.openings_time_ms` |  267 |  534 |  341 |  193 |
| `prover.rap_constraints.logup_gkr_time_ms` |  248 |  496 |  272 |  224 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/f71d9d610df763fbb0d09218209402ee9177a5b7/sha2_bench-f71d9d610df763fbb0d09218209402ee9177a5b7.memory.svg)
...
| app_proof | VariableRangeCheckerAir |  | 1 | 2 | 
...
| leaf | 0 | 116 | 531 | 116 | 32 | 12 | 2 | 9 | 9 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 176 | 45 | 0 | 0 | 82 | 29 | 28 | 37 | 15 | 0 | 48 | 37 | 10 | 2 | 7 | 45 | 45 | 82 | 0 | 1 | 13 | 0 | 0 | 
...
| leaf | 0 | prover | 237,929,272 | 414 | 141 | 0 | 0 | 156 | 83 | 81 | 44 | 28 | 0 | 116 | 94 | 21 | 10 | 11 | 141 | 141 | 156 | 0 | 3 | 27 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover |  | 0 | 1,281,523,083 | 2,252 | 557 | 0 | 0 | 1,353 | 847 | 846 | 234 | 272 | 1 | 341 | 249 | 92 | 56 | 35 | 557 | 557 | 1,353 | 0 | 1 | 270 | 0 | 0 | 
| app_proof | prover |  | 1 | 687,699,844 | 1,193 | 207 | 0 | 0 | 791 | 441 | 441 | 125 | 224 | 0 | 193 | 142 | 50 | 30 | 20 | 208 | 207 | 791 | 0 | 1 | 223 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof |  | 1,490 | 62 | 11,167,961 | 177.89 | 0 | 4,470 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof |  | 0 | 4 | 2 | 76 | 2,912 | 6 | 4 | 0 | 189 | 2 | 20 | 0 | 12,537,603,360 | 2,843,438,436 | 15,381,041,796 | 2,097,152 | 2 | 0 | 2 | 5 | 69 | 353 | 7,136,000 | 20.19 | 0 | 0 | 
| app_proof |  | 1 | 3 | 2 | 33 | 1,490 | 3 | 3 | 0 | 68 | 1 | 4 | 0 | 7,116,253,404 | 1,550,303,741 | 8,666,557,145 | 2,097,152 | 2 | 0 | 0 | 2 | 30 | 171 | 4,031,961 | 23.48 | 0 | 0 | 

...
|:---|---:|---:|---:|
| Total |  5.43 |  4.10 |  4.10 |
| app_proof |  4.47 |  3.14 |  3.14 |
| leaf |  0.53 |  0.53 |  0.53 |
...
| `total_proof_time_ms ` |  2,206 |  4,412 |  2,914 |  1,498 |
| `compile_metered_time_ms` |  0 |  0 |  0 |  0 |
| `execute_metered_time_ms` |  61 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  182.36 | -          |  182.36 |  182.36 |
| `set_initial_memory_time_ms` |  3.50 |  7 |  4 |  3 |
| `execute_preflight_insns` |  5,583,980.50 |  11,167,961 |  7,136,000 |  4,031,961 |
| `execute_preflight_time_ms` |  257.50 |  515 |  348 |  167 |
| `execute_preflight_insn_mi/s` |  21.69 | -          |  24.12 |  20.48 |
| `postflight_time_ms  ` |  129 |  258 |  186 |  72 |
| `postflight_memory_chronology_time_ms` |  12 |  24 |  20 |  4 |
| `postflight_program_index_time_ms` |  1.50 |  3 |  2 |  1 |
| `trace_gen_time_ms   ` |  53.50 |  107 |  75 |  32 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,729.50 |  3,459 |  2,260 |  1,199 |
| `prover.main_trace_commit_time_ms` |  385 |  770 |  560 |  210 |
| `prover.rap_constraints_time_ms` |  1,078 |  2,156 |  1,361 |  795 |
| `prover.openings_time_ms` |  265 |  530 |  337 |  193 |
| `prover.rap_constraints.logup_gkr_time_ms` |  250 |  500 |  274 |  226 |
| `prover.rap_constraints.round0_time_ms` |  644.50 |  1,289 |  848 |  441 |
| `prover.rap_constraints.mle_rounds_time_ms` |  182.50 |  365 |  238 |  127 |
...
| `prover.openings.whir_time_ms` |  192.50 |  385 |  243 |  142 |
...
| `prover.openings_time_ms` |  115 |  115 |  115 |  115 |
...
| `prover.openings.whir_time_ms` |  93 |  93 |  93 |  93 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/6a4a53a1bd53c9e9704bc29f65ee555d30eba27c/sha2_bench-6a4a53a1bd53c9e9704bc29f65ee555d30eba27c.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 21 | 195 | 20 | 6 | 1 | 2 | 3 | 3 | 
| internal_recursive.0 | 1 | 11 | 122 | 11 | 2 | 0 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 10 | 109 | 10 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 116 | 532 | 115 | 33 | 12 | 2 | 9 | 9 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 174 | 45 | 0 | 0 | 80 | 28 | 28 | 37 | 13 | 0 | 47 | 37 | 10 | 2 | 7 | 45 | 45 | 80 | 0 | 1 | 13 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 111 | 20 | 0 | 0 | 58 | 22 | 21 | 23 | 11 | 0 | 32 | 24 | 7 | 1 | 6 | 20 | 20 | 58 | 0 | 1 | 10 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 98 | 14 | 0 | 0 | 55 | 20 | 19 | 21 | 12 | 0 | 28 | 21 | 7 | 1 | 5 | 15 | 14 | 55 | 0 | 1 | 10 | 0 | 0 | 
| leaf | 0 | prover | 237,929,272 | 416 | 143 | 0 | 0 | 157 | 83 | 82 | 44 | 29 | 0 | 115 | 93 | 22 | 10 | 11 | 143 | 143 | 157 | 0 | 3 | 27 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover |  | 0 | 1,281,523,083 | 2,260 | 560 | 0 | 0 | 1,361 | 848 | 847 | 238 | 274 | 1 | 337 | 243 | 93 | 57 | 36 | 560 | 560 | 1,361 | 0 | 1 | 273 | 0 | 0 | 
| app_proof | prover |  | 1 | 687,699,844 | 1,199 | 210 | 0 | 0 | 795 | 441 | 440 | 127 | 226 | 0 | 193 | 142 | 50 | 29 | 20 | 210 | 210 | 795 | 0 | 1 | 226 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof |  | 1,498 | 61 | 11,167,961 | 182.36 | 0 | 4,478 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof |  | 0 | 4 | 2 | 75 | 2,914 | 6 | 4 | 0 | 186 | 2 | 20 | 0 | 12,537,603,360 | 2,843,438,436 | 15,381,041,796 | 2,097,152 | 2 | 0 | 2 | 5 | 69 | 348 | 7,136,000 | 20.48 | 0 | 0 | 
| app_proof |  | 1 | 3 | 2 | 32 | 1,498 | 3 | 3 | 0 | 72 | 1 | 4 | 0 | 7,116,253,404 | 1,550,303,741 | 8,666,557,145 | 2,097,152 | 2 | 0 | 0 | 2 | 29 | 167 | 4,031,961 | 24.12 | 0 | 0 | 

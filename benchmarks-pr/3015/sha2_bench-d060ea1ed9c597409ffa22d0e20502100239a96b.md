...
| `total_proof_time_ms ` |  2,046 |  4,092 |  2,388 |  1,704 |
...
| `execute_preflight_time_ms` |  350.50 |  701 |  501 |  200 |
| `execute_preflight_insn_mi/s` |  35.30 | -          |  37.13 |  33.47 |
| `trace_gen_time_ms   ` |  74 |  148 |  103 |  45 |
| `set_initial_memory_time_ms` |  0 |  0 |  0 |  0 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,619.50 |  3,239 |  2,083 |  1,156 |
| `prover.main_trace_commit_time_ms` |  405 |  810 |  573 |  237 |
| `prover.rap_constraints_time_ms` |  937 |  1,874 |  1,163 |  711 |
| `prover.openings_time_ms` |  277.50 |  555 |  347 |  208 |
| `prover.rap_constraints.logup_gkr_time_ms` |  218 |  436 |  234 |  202 |
| `prover.rap_constraints.round0_time_ms` |  529.50 |  1,059 |  687 |  372 |
| `prover.rap_constraints.mle_rounds_time_ms` |  188.50 |  377 |  241 |  136 |
...
| `prover.openings.whir_time_ms` |  202 |  404 |  252 |  152 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/d060ea1ed9c597409ffa22d0e20502100239a96b/sha2_bench-d060ea1ed9c597409ffa22d0e20502100239a96b.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 61 |  |  |  | 304 |  |  |  |  |  |  | 
| app_proof |  |  |  | 1,704 |  | 57 | 11,167,961 | 192.97 | 0 | 4,158 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 184 | 46 | 0 | 0 | 81 | 29 | 28 | 37 | 14 | 0 | 55 | 45 | 10 | 2 | 7 | 47 | 46 | 81 | 0 | 1 | 12 | 0 | 0 | 
...
| leaf | 0 | prover | 237,929,016 | 409 | 146 | 0 | 0 | 143 | 71 | 69 | 44 | 27 | 0 | 118 | 96 | 22 | 10 | 11 | 147 | 146 | 143 | 0 | 3 | 25 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,286,243,578 | 2,083 | 573 | 0 | 0 | 1,163 | 687 | 686 | 241 | 234 | 1 | 347 | 252 | 94 | 58 | 36 | 573 | 573 | 1,163 | 0 | 1 | 232 | 0 | 0 | 
| app_proof | prover | 1 | 750,290,168 | 1,156 | 237 | 0 | 0 | 711 | 372 | 371 | 136 | 202 | 1 | 208 | 152 | 56 | 33 | 22 | 237 | 237 | 711 | 0 | 1 | 199 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 0 | 2 | 103 | 2,388 | 103 | 0 | 13,306,656,804 | 2,134,717,332 | 15,441,374,136 | 2,097,152 | 0 | 4 | 200 | 7,124,000 | 37.13 | 
| app_proof | 1 | 0 | 1 | 45 | 1,704 | 45 | 0 | 7,584,549,132 | 1,503,568,565 | 9,088,117,697 | 2,097,152 | 0 | 2 | 501 | 4,043,961 | 33.47 | 

...
|:---|---:|---:|---:|
| Total |  5.09 |  3.39 |  3.39 |
| app_proof |  4.13 |  2.44 |  2.44 |
| leaf |  0.53 |  0.53 |  0.53 |
...
| `total_proof_time_ms ` |  2,038.50 |  4,077 |  2,379 |  1,698 |
...
| `execute_preflight_time_ms` |  347.50 |  695 |  499 |  196 |
| `execute_preflight_insn_mi/s` |  35.88 | -          |  37.44 |  34.32 |
| `trace_gen_time_ms   ` |  72.50 |  145 |  101 |  44 |
| `set_initial_memory_time_ms` |  0 |  0 |  0 |  0 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,616.50 |  3,233 |  2,080 |  1,153 |
| `prover.main_trace_commit_time_ms` |  404.50 |  809 |  573 |  236 |
| `prover.rap_constraints_time_ms` |  933.50 |  1,867 |  1,159 |  708 |
| `prover.openings_time_ms` |  278 |  556 |  348 |  208 |
| `prover.rap_constraints.logup_gkr_time_ms` |  216.50 |  433 |  233 |  200 |
| `prover.rap_constraints.round0_time_ms` |  528.50 |  1,057 |  685 |  372 |
| `prover.rap_constraints.mle_rounds_time_ms` |  187 |  374 |  239 |  135 |
| `prover.openings.stacked_reduction_time_ms` |  75 |  150 |  94 |  56 |
| `prover.openings.stacked_reduction.round0_time_ms` |  45.50 |  91 |  58 |  33 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  29 |  58 |  36 |  22 |
| `prover.openings.whir_time_ms` |  202.50 |  405 |  253 |  152 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/6e1f16212b2d87e749c6bcf9be02f5f8a8f8bc94/sha2_bench-6e1f16212b2d87e749c6bcf9be02f5f8a8f8bc94.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 58 |  |  |  | 290 |  |  |  |  |  |  | 
| app_proof |  |  |  | 1,698 |  | 57 | 11,167,961 | 195.31 | 0 | 4,143 |  | 
...
| app_proof | VmAirWrapper<Rv64LoadStoreAdapterAir, LoadStoreCoreAir<8> | 0 | 11 | 19 | 
| app_proof | VmAirWrapper<Rv64MultAdapterAir, MultiplicationCoreAir<8, 8> | 0 | 0 | 1 | 
| app_proof | VmAirWrapper<Rv64RdWriteAdapterAir, Rv64AuipcCoreAir> | 0 | 5 | 5 | 
...
| leaf | 0 | prover | 237,929,016 | 408 | 146 | 0 | 0 | 142 | 71 | 69 | 44 | 26 | 0 | 119 | 97 | 22 | 10 | 11 | 146 | 146 | 142 | 0 | 3 | 25 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,286,243,578 | 2,080 | 572 | 0 | 0 | 1,159 | 685 | 685 | 239 | 233 | 1 | 348 | 253 | 94 | 58 | 36 | 573 | 572 | 1,159 | 0 | 1 | 231 | 0 | 0 | 
| app_proof | prover | 1 | 750,290,168 | 1,153 | 235 | 0 | 0 | 708 | 372 | 371 | 135 | 200 | 1 | 208 | 152 | 56 | 33 | 22 | 236 | 235 | 708 | 0 | 1 | 198 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 0 | 2 | 101 | 2,379 | 101 | 0 | 13,306,656,804 | 2,134,717,332 | 15,441,374,136 | 2,097,152 | 0 | 4 | 196 | 7,124,000 | 37.44 | 
| app_proof | 1 | 0 | 1 | 44 | 1,698 | 44 | 0 | 7,584,549,132 | 1,503,568,565 | 9,088,117,697 | 2,097,152 | 0 | 2 | 499 | 4,043,961 | 34.32 | 

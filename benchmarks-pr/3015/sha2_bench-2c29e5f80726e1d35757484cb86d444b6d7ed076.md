...
|:---|---:|---:|---:|
| Total |  5.11 |  3.39 |  3.39 |
| app_proof |  4.15 |  2.44 |  2.44 |
| leaf |  0.53 |  0.53 |  0.53 |
...
| `total_proof_time_ms ` |  2,048.50 |  4,097 |  2,379 |  1,718 |
...
| `execute_preflight_time_ms` |  362 |  724 |  524 |  200 |
| `execute_preflight_insn_mi/s` |  36.10 | -          |  36.94 |  35.25 |
| `trace_gen_time_ms   ` |  76.50 |  153 |  105 |  48 |
| `set_initial_memory_time_ms` |  0 |  0 |  0 |  0 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,609 |  3,218 |  2,073 |  1,145 |
| `prover.main_trace_commit_time_ms` |  405.50 |  811 |  576 |  235 |
| `prover.rap_constraints_time_ms` |  927.50 |  1,855 |  1,153 |  702 |
| `prover.openings_time_ms` |  275 |  550 |  343 |  207 |
| `prover.rap_constraints.logup_gkr_time_ms` |  216 |  432 |  233 |  199 |
| `prover.rap_constraints.round0_time_ms` |  526 |  1,052 |  683 |  369 |
...
| `prover.openings.whir_time_ms` |  200.50 |  401 |  250 |  151 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/2c29e5f80726e1d35757484cb86d444b6d7ed076/sha2_bench-2c29e5f80726e1d35757484cb86d444b6d7ed076.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 58 |  |  |  | 290 |  |  |  |  |  |  | 
| app_proof |  |  |  | 1,718 |  | 56 | 11,167,961 | 196.03 | 0 | 4,162 |  | 
...
| app_proof | VmAirWrapper<Rv64LoadStoreAdapterAir, LoadStoreCoreAir<8> | 0 | 12 | 20 | 
...
| leaf | 0 | 121 | 525 | 121 | 35 | 13 | 2 | 10 | 10 | 
...
| leaf | 0 | prover | 237,929,016 | 404 | 145 | 0 | 0 | 141 | 70 | 69 | 44 | 26 | 0 | 117 | 95 | 21 | 10 | 11 | 145 | 145 | 141 | 0 | 3 | 25 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,286,243,578 | 2,073 | 575 | 0 | 0 | 1,153 | 683 | 682 | 235 | 233 | 0 | 343 | 250 | 93 | 57 | 35 | 576 | 575 | 1,153 | 0 | 1 | 232 | 0 | 0 | 
| app_proof | prover | 1 | 750,290,168 | 1,145 | 235 | 0 | 0 | 702 | 369 | 369 | 133 | 199 | 0 | 207 | 151 | 55 | 33 | 22 | 235 | 235 | 702 | 0 | 1 | 197 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 0 | 2 | 105 | 2,379 | 105 | 0 | 13,306,656,804 | 2,134,717,332 | 15,441,374,136 | 2,097,152 | 0 | 4 | 200 | 7,124,000 | 36.94 | 
| app_proof | 1 | 0 | 1 | 48 | 1,718 | 48 | 0 | 7,584,549,132 | 1,503,568,565 | 9,088,117,697 | 2,097,152 | 0 | 2 | 524 | 4,043,961 | 35.25 | 

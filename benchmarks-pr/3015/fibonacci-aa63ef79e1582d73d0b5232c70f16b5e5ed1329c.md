...
| `total_proof_time_ms ` |  230.50 |  461 |  253 |  208 |
| `compile_metered_time_ms` |  5 |  5 |  5 |  5 |
| `execute_metered_time_ms` |  13 | -          | -          | -          |
| `execute_metered_insns` |  4,000,051 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  293.36 | -          |  293.36 |  293.36 |
| `execute_preflight_insns` |  2,000,025.50 |  4,000,051 |  2,621,000 |  1,379,051 |
| `execute_preflight_time_ms` |  52 |  104 |  65 |  39 |
| `execute_preflight_insn_mi/s` |  53.75 | -          |  65.56 |  41.94 |
...
| `prover.rap_constraints_time_ms` |  89.50 |  179 |  91 |  88 |
| `prover.openings_time_ms` |  39 |  78 |  41 |  37 |
| `prover.rap_constraints.logup_gkr_time_ms` |  55 |  110 |  55 |  55 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/aa63ef79e1582d73d0b5232c70f16b5e5ed1329c/fibonacci-aa63ef79e1582d73d0b5232c70f16b5e5ed1329c.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 57 |  |  |  | 292 |  |  |  |  |  |  | 
| app_proof |  |  |  | 208 |  | 13 | 4,000,051 | 293.36 | 0 | 482 |  | 
...
| internal_recursive.0 | 1 | prover | 15,378,769 | 109 | 20 | 0 | 0 | 58 | 23 | 22 | 23 | 11 | 0 | 31 | 23 | 7 | 1 | 6 | 20 | 20 | 58 | 0 | 1 | 10 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 100 | 14 | 0 | 0 | 55 | 21 | 20 | 21 | 12 | 0 | 28 | 21 | 7 | 1 | 5 | 15 | 14 | 55 | 0 | 1 | 10 | 0 | 0 | 
| leaf | 0 | prover | 74,737,560 | 189 | 50 | 0 | 0 | 85 | 40 | 39 | 27 | 17 | 0 | 54 | 42 | 11 | 3 | 7 | 50 | 50 | 85 | 0 | 3 | 16 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 0 | 1 | 22 | 253 | 22 | 0 | 2,145,306,169 | 522,643 | 2,145,828,812 | 2,097,152 | 0 | 3 | 65 | 2,621,000 | 41.94 | 
| app_proof | 1 | 0 | 1 | 11 | 208 | 11 | 0 | 1,164,982,691 | 980,826,556 | 2,145,809,247 | 2,097,152 | 0 | 2 | 39 | 1,379,051 | 65.56 | 

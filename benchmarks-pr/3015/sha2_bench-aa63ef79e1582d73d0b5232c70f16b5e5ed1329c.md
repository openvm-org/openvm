...
|:---|---:|---:|---:|
| Total |  5.06 |  3.37 |  3.37 |
| app_proof |  4.12 |  2.42 |  2.42 |
| leaf |  0.52 |  0.52 |  0.52 |
...
| `total_proof_time_ms ` |  2,030.50 |  4,061 |  2,362 |  1,699 |
...
| `execute_preflight_time_ms` |  354 |  708 |  510 |  198 |
| `execute_preflight_insn_mi/s` |  36.08 | -          |  37.27 |  34.88 |
| `trace_gen_time_ms   ` |  73.50 |  147 |  101 |  46 |
| `set_initial_memory_time_ms` |  0 |  0 |  0 |  0 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,601.50 |  3,203 |  2,061 |  1,142 |
| `prover.main_trace_commit_time_ms` |  401.50 |  803 |  569 |  234 |
| `prover.rap_constraints_time_ms` |  923.50 |  1,847 |  1,147 |  700 |
| `prover.openings_time_ms` |  276 |  552 |  345 |  207 |
| `prover.rap_constraints.logup_gkr_time_ms` |  215 |  430 |  232 |  198 |
| `prover.rap_constraints.round0_time_ms` |  524.50 |  1,049 |  681 |  368 |
| `prover.rap_constraints.mle_rounds_time_ms` |  183 |  366 |  233 |  133 |
...
| `prover.openings.whir_time_ms` |  201 |  402 |  251 |  151 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/aa63ef79e1582d73d0b5232c70f16b5e5ed1329c/sha2_bench-aa63ef79e1582d73d0b5232c70f16b5e5ed1329c.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 56 |  |  |  | 283 |  |  |  |  |  |  | 
| app_proof |  |  |  | 1,699 |  | 57 | 11,167,961 | 194.96 | 0 | 4,127 |  | 
...
| app_proof | VmAirWrapper<Rv64LoadStoreAdapterAir, LoadStoreCoreAir<8> | 1 | 5 | 6 | 
...
| leaf | 0 | 116 | 524 | 115 | 35 | 13 | 2 | 9 | 9 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 176 | 46 | 0 | 0 | 79 | 29 | 28 | 37 | 13 | 0 | 50 | 39 | 10 | 2 | 7 | 46 | 46 | 79 | 0 | 1 | 12 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 106 | 20 | 0 | 0 | 55 | 20 | 20 | 23 | 11 | 0 | 29 | 21 | 7 | 1 | 6 | 20 | 20 | 55 | 0 | 1 | 10 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 98 | 15 | 0 | 0 | 53 | 20 | 19 | 21 | 11 | 0 | 29 | 22 | 7 | 1 | 5 | 15 | 15 | 53 | 0 | 1 | 10 | 0 | 0 | 
| leaf | 0 | prover | 237,929,016 | 408 | 145 | 0 | 0 | 140 | 70 | 69 | 44 | 25 | 0 | 121 | 100 | 21 | 10 | 11 | 145 | 145 | 140 | 0 | 3 | 25 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,286,243,578 | 2,061 | 568 | 0 | 0 | 1,147 | 681 | 680 | 233 | 232 | 0 | 345 | 251 | 93 | 57 | 35 | 569 | 568 | 1,147 | 0 | 1 | 231 | 0 | 0 | 
| app_proof | prover | 1 | 750,290,168 | 1,142 | 234 | 0 | 0 | 700 | 368 | 368 | 133 | 198 | 0 | 207 | 151 | 55 | 33 | 22 | 234 | 234 | 700 | 0 | 1 | 196 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 0 | 2 | 101 | 2,362 | 101 | 0 | 13,306,656,804 | 2,134,717,332 | 15,441,374,136 | 2,097,152 | 1 | 3 | 198 | 7,124,000 | 37.27 | 
| app_proof | 1 | 0 | 1 | 46 | 1,699 | 46 | 0 | 7,584,549,132 | 1,503,568,565 | 9,088,117,697 | 2,097,152 | 0 | 2 | 510 | 4,043,961 | 34.88 | 

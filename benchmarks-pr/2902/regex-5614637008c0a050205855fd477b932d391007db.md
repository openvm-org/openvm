...
| `total_proof_time_ms ` |  736.50 |  1,473 |  840 |  633 |
...
| `execute_preflight_time_ms` |  78 |  156 |  87 |  69 |
| `execute_preflight_insn_mi/s` |  36.24 | -          |  38.13 |  34.35 |
| `trace_gen_time_ms   ` |  44.50 |  89 |  50 |  39 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  525.50 |  1,051 |  579 |  472 |
| `prover.main_trace_commit_time_ms` |  108.50 |  217 |  118 |  99 |
| `prover.rap_constraints_time_ms` |  306.50 |  613 |  339 |  274 |
| `prover.openings_time_ms` |  110 |  220 |  122 |  98 |
| `prover.rap_constraints.logup_gkr_time_ms` |  186.50 |  373 |  225 |  148 |
| `prover.rap_constraints.round0_time_ms` |  85.50 |  171 |  95 |  76 |
| `prover.rap_constraints.mle_rounds_time_ms` |  33 |  66 |  36 |  30 |
| `prover.openings.stacked_reduction_time_ms` |  21 |  42 |  23 |  19 |
...
| `prover.openings.whir_time_ms` |  88.50 |  177 |  98 |  79 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/5614637008c0a050205855fd477b932d391007db/regex-5614637008c0a050205855fd477b932d391007db.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 66 | 9 |  |  | 0 |  | 338 | 9 |  |  |  |  |  |  | 
| app_proof |  |  |  |  |  | 633 |  |  | 35 | 4,090,656 | 116.76 | 0 | 1,522 |  | 
...
| app_proof | 24 | VmAirWrapper<Rv64BaseAluWU16AdapterAir, AddSubCoreAir<2, 16> | ADDW | 0 | 435 | 
| app_proof | 24 | VmAirWrapper<Rv64BaseAluWU16AdapterAir, AddSubCoreAir<2, 16> | SUBW | 0 | 2,791 | 
...
| app_proof | 24 | VmAirWrapper<Rv64BaseAluWU16AdapterAir, AddSubCoreAir<2, 16> | ADDW | 1 | 3 | 
| app_proof | 24 | VmAirWrapper<Rv64BaseAluWU16AdapterAir, AddSubCoreAir<2, 16> | SUBW | 1 | 2,244 | 
...
| app_proof | 24 | VmAirWrapper<Rv64BaseAluWU16AdapterAir, AddSubCoreAir<2, 16> | prover | 0 | 4,096 | 33 | 135,168 | 
...
| app_proof | 24 | VmAirWrapper<Rv64BaseAluWU16AdapterAir, AddSubCoreAir<2, 16> | prover | 1 | 4,096 | 33 | 135,168 | 
...
| app_proof | 24 | VmAirWrapper<Rv64BaseAluWU16AdapterAir, AddSubCoreAir<2, 16> | 0 | 3,226 | 870 | 266,145 | 71,775 | 425,832 | 114,840 | 106,458 | 28,710 | 2,221,908 | 599,212 | 61,294 | 16,530 | 
...
| app_proof | 24 | VmAirWrapper<Rv64BaseAluWU16AdapterAir, AddSubCoreAir<2, 16> | 1 | 2,247 | 1,849 | 185,378 | 152,542 | 296,604 | 244,068 | 74,151 | 61,017 | 1,547,622 | 1,273,498 | 42,693 | 35,131 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 27,289,403 | 254 | 81 | 0 | 0 | 96 | 31 | 30 | 45 | 19 | 0 | 75 | 64 | 11 | 2 | 8 | 81 | 96 | 0 | 3 | 18 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,767 | 167 | 47 | 0 | 0 | 66 | 24 | 24 | 28 | 13 | 0 | 53 | 45 | 8 | 1 | 6 | 47 | 66 | 0 | 2 | 12 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 137 | 31 | 0 | 0 | 62 | 24 | 23 | 24 | 13 | 0 | 43 | 35 | 7 | 1 | 5 | 31 | 62 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 79,656,756 | 378 | 127 | 0 | 0 | 134 | 54 | 53 | 37 | 41 | 0 | 117 | 101 | 15 | 6 | 8 | 127 | 134 | 0 | 6 | 40 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 150,145,490 | 579 | 118 | 0 | 0 | 339 | 76 | 76 | 36 | 225 | 0 | 122 | 98 | 23 | 12 | 10 | 118 | 339 | 0 | 3 | 224 | 0 | 0 | 
| app_proof | prover | 1 | 118,899,007 | 472 | 98 | 0 | 0 | 274 | 95 | 95 | 30 | 148 | 0 | 98 | 79 | 19 | 9 | 10 | 99 | 274 | 0 | 3 | 147 | 0 | 0 | 

| group | phase | segment | trace_height_constraint | weighted_sum | threshold |
| --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 0 | 71,336,141 | 2,013,265,921 | 
| app_proof | prover | 1 | 0 | 57,350,714 | 2,013,265,921 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 39 | 840 | 39 | 134 | 2,616,817,006 | 731,471,586 | 3,348,288,592 | 2,097,152 | 1 | 4 | 87 | 2,327,000 | 34.35 | 
| app_proof | 1 | 50 | 633 | 50 | 41 | 1,871,349,639 | 705,410,604 | 2,576,760,243 | 2,097,152 | 0 | 2 | 69 | 1,763,656 | 38.13 | 

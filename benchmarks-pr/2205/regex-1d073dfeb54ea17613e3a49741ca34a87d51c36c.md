...
|:---|---:|---:|
| Total |  2.36 |  0.76 |
| regex_program |  2.32 |  0.72 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  581 |  2,324 |  720 |  517 |
...
| `execute_metered_insn_mi/s` |  109.31 | -          |  109.31 |  109.31 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  52.50 |  210 |  64 |  44 |
| `execute_preflight_insn_mi/s` |  31.98 | -          |  33.14 |  28.87 |
| `trace_gen_time_ms   ` |  176.50 |  706 |  210 |  153 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  284 |  1,136 |  320 |  258 |
| `main_trace_commit_time_ms` |  51.25 |  205 |  55 |  50 |
| `generate_perm_trace_time_ms` |  22.75 |  91 |  27 |  19 |
| `perm_trace_commit_time_ms` |  64.46 |  257.84 |  69.93 |  55.53 |
| `quotient_poly_compute_time_ms` |  57.52 |  230.08 |  68.22 |  51.03 |
| `quotient_poly_commit_time_ms` |  15.22 |  60.89 |  17.55 |  12.72 |
| `pcs_opening_time_ms ` |  70 |  280 |  92 |  53 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 541 | 65 | 1 | 37 | 4,137,502 | 109.31 | 195 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 210 | 720 | 23,446,148 | 150,778,428 | 210 | 320 | 0 | 58.56 | 17.55 | 5 | 69.93 | 92 | 95 | 92 | 4 | 55 | 10,899,170 | 24 | 44 | 1,103,000 | 28.87 | 21 | 76 | 1 | 92 | 
| regex_program | 1 | 153 | 517 | 11,598,276 | 128,513,066 | 153 | 258 | 1 | 51.03 | 15.24 | 5 | 66.73 | 53 | 88 | 52 | 0 | 50 | 2,196,106 | 21 | 64 | 1,104,000 | 32.80 | 17 | 66 | 0 | 52 | 
| regex_program | 2 | 162 | 546 | 11,579,064 | 128,513,066 | 162 | 285 | 1 | 52.28 | 15.38 | 4 | 65.66 | 73 | 93 | 72 | 0 | 50 | 2,177,334 | 27 | 57 | 1,104,000 | 33.12 | 16 | 68 | 0 | 72 | 
| regex_program | 3 | 181 | 541 | 11,853,872 | 103,456,394 | 181 | 273 | 0 | 68.22 | 12.72 | 5 | 55.53 | 62 | 77 | 62 | 0 | 50 | 2,422,606 | 19 | 45 | 826,502 | 33.14 | 18 | 82 | 1 | 62 | 

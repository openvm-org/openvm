...
| `total_proof_time_ms ` |  595.75 |  2,383 |  731 |  549 |
...
| `execute_metered_insn_mi/s` |  114.65 | -          |  114.65 |  114.65 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  52.50 |  210 |  65 |  43 |
| `execute_preflight_insn_mi/s` |  31.92 | -          |  33.11 |  28.56 |
| `trace_gen_time_ms   ` |  184 |  736 |  219 |  162 |
| `memory_finalize_time_ms` |  0.75 |  3 |  3 |  0 |
| `stark_prove_excluding_trace_time_ms` |  291 |  1,164 |  323 |  275 |
| `main_trace_commit_time_ms` |  51.50 |  206 |  55 |  50 |
| `generate_perm_trace_time_ms` |  24.25 |  97 |  32 |  20 |
| `perm_trace_commit_time_ms` |  65.78 |  263.12 |  71.08 |  56.76 |
| `quotient_poly_compute_time_ms` |  59.58 |  238.32 |  70.57 |  53.18 |
| `quotient_poly_commit_time_ms` |  15.67 |  62.68 |  17.67 |  13.21 |
| `pcs_opening_time_ms ` |  70.75 |  283 |  91 |  59 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 550 | 66 | 1 | 36 | 4,137,502 | 114.65 | 193 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 219 | 731 | 23,446,148 | 150,778,428 | 219 | 323 | 0 | 61.09 | 17.67 | 5 | 71.08 | 91 | 95 | 91 | 3 | 55 | 10,899,170 | 24 | 43 | 1,103,000 | 28.56 | 21 | 79 | 1 | 91 | 
| regex_program | 1 | 162 | 553 | 11,598,276 | 128,513,066 | 162 | 284 | 1 | 53.48 | 15.90 | 4 | 68.29 | 73 | 90 | 73 | 0 | 50 | 2,196,106 | 21 | 65 | 1,104,000 | 33.02 | 17 | 69 | 0 | 73 | 
| regex_program | 2 | 167 | 549 | 11,579,064 | 128,513,066 | 167 | 282 | 1 | 53.18 | 15.90 | 4 | 66.99 | 60 | 100 | 60 | 0 | 51 | 2,177,334 | 32 | 57 | 1,104,000 | 33.11 | 17 | 69 | 0 | 60 | 
| regex_program | 3 | 188 | 550 | 11,853,872 | 103,456,394 | 188 | 275 | 0 | 70.57 | 13.21 | 5 | 56.76 | 59 | 80 | 58 | 0 | 50 | 2,422,606 | 20 | 45 | 826,502 | 32.98 | 18 | 84 | 1 | 58 | 

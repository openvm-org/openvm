...
|:---|---:|---:|
| Total |  1.21 |  0.67 |
| fibonacci_program |  1.20 |  0.66 |


| fibonacci_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  598 |  1,196 |  664 |  532 |
...
| `execute_metered_insn_mi/s` | <span style='color: green'>(-0 [-0.2%])</span> 148.61 | -          | <span style='color: green'>(-0 [-0.2%])</span> 148.61 | <span style='color: green'>(-0 [-0.2%])</span> 148.61 |
| `execute_preflight_insns` |  750,105 |  1,500,210 |  873,000 |  627,210 |
| `execute_preflight_time_ms` |  28.50 |  57 |  32 |  25 |
| `execute_preflight_insn_mi/s` | <span style='color: green'>(-0 [-0.8%])</span> 37.85 | -          | <span style='color: green'>(-0 [-0.2%])</span> 40.11 | <span style='color: green'>(-1 [-1.5%])</span> 35.59 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+2 [+1.0%])</span> 207.50 | <span style='color: red'>(+4 [+1.0%])</span> 415 | <span style='color: red'>(+1 [+0.5%])</span> 212 | <span style='color: red'>(+3 [+1.5%])</span> 203 |
| `memory_finalize_time_ms` | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: green'>(-3 [-1.1%])</span> 266 | <span style='color: green'>(-6 [-1.1%])</span> 532 | <span style='color: green'>(-2 [-0.7%])</span> 278 | <span style='color: green'>(-4 [-1.6%])</span> 254 |
| `main_trace_commit_time_ms` | <span style='color: red'>(+0 [+1.5%])</span> 33 | <span style='color: red'>(+1 [+1.5%])</span> 66 | <span style='color: red'>(+1 [+2.9%])</span> 36 |  30 |
| `generate_perm_trace_time_ms` | <span style='color: green'>(-2 [-6.3%])</span> 29.50 | <span style='color: green'>(-4 [-6.3%])</span> 59 | <span style='color: green'>(-2 [-5.6%])</span> 34 | <span style='color: green'>(-2 [-7.4%])</span> 25 |
| `perm_trace_commit_time_ms` | <span style='color: red'>(+1 [+1.2%])</span> 43.30 | <span style='color: red'>(+1 [+1.2%])</span> 86.60 | <span style='color: red'>(+0 [+0.5%])</span> 45.85 | <span style='color: red'>(+1 [+2.1%])</span> 40.75 |
| `quotient_poly_compute_time_ms` | <span style='color: green'>(-2 [-6.4%])</span> 28.31 | <span style='color: green'>(-4 [-6.4%])</span> 56.62 | <span style='color: green'>(-1 [-3.8%])</span> 31.54 | <span style='color: green'>(-3 [-9.5%])</span> 25.07 |
| `quotient_poly_commit_time_ms` | <span style='color: green'>(-0 [-1.7%])</span> 13.37 | <span style='color: green'>(-0 [-1.7%])</span> 26.74 | <span style='color: green'>(-0 [-0.8%])</span> 13.55 | <span style='color: green'>(-0 [-2.6%])</span> 13.19 |
| `pcs_opening_time_ms ` |  116.50 |  233 |  124 |  109 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 532 | 66 | 1 | 10 | 1,500,210 | 148.61 | 172 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 212 | 664 | 9,684,992 | 84,395,212 | 212 | 278 | 0 | 31.54 | 13.55 | 4 | 45.85 | 124 | 72 | 124 | 0 | 36 | 1,040,430 | 25 | 25 | 873,000 | 35.59 | 13 | 45 | 1 | 124 | 
| fibonacci_program | 1 | 203 | 532 | 9,714,030 | 74,305,770 | 203 | 254 | 1 | 25.07 | 13.19 | 4 | 40.75 | 109 | 75 | 109 | 0 | 30 | 1,067,532 | 34 | 32 | 627,210 | 40.11 | 10 | 38 | 1 | 109 | 

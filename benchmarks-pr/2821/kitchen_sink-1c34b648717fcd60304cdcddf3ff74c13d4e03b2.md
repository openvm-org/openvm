...
|:---|---:|---:|---:|
| Total |  2.65 |  1.97 |  1.97 |
| app_proof |  1.93 |  1.25 |  1.25 |
| leaf |  0.41 |  0.41 |  0.41 |
...
| `total_proof_time_ms ` |  947.50 |  1,895 |  1,219 |  676 |
| `compile_metered_time_ms` |  3 |  3 |  3 |  3 |
| `execute_metered_time_ms` |  34 | -          | -          | -          |
| `execute_metered_insns` |  2,579,903 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  73.94 | -          |  73.94 |  73.94 |
| `execute_preflight_insns` |  1,289,951.50 |  2,579,903 |  1,540,000 |  1,039,903 |
| `execute_preflight_time_ms` |  97.50 |  195 |  131 |  64 |
| `execute_preflight_insn_mi/s` |  34.68 | -          |  36.30 |  33.06 |
| `trace_gen_time_ms   ` |  25.50 |  51 |  35 |  16 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  714.50 |  1,429 |  942 |  487 |
| `prover.main_trace_commit_time_ms` |  215.50 |  431 |  293 |  138 |
| `prover.rap_constraints_time_ms` |  450 |  900 |  592 |  308 |
| `prover.openings_time_ms` |  48 |  96 |  56 |  40 |
| `prover.rap_constraints.logup_gkr_time_ms` |  83 |  166 |  111 |  55 |
| `prover.rap_constraints.round0_time_ms` |  263.50 |  527 |  350 |  177 |
| `prover.rap_constraints.mle_rounds_time_ms` |  102 |  204 |  129 |  75 |
| `prover.openings.stacked_reduction_time_ms` |  34.50 |  69 |  42 |  27 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/1c34b648717fcd60304cdcddf3ff74c13d4e03b2/kitchen_sink-1c34b648717fcd60304cdcddf3ff74c13d4e03b2.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 70 | 3 |  |  | 0 |  | 332 | 3 |  |  |  |  |  |  | 
| app_proof |  |  |  |  |  | 676 |  |  | 34 | 2,579,903 | 73.94 | 0 | 1,935 |  | 
...
| leaf | 0 | 113 | 414 | 113 | 23 | 9 | 21 | 5 | 5 | 
...
| leaf | 0 | prover | 265,006,708 | 300 | 130 | 0 | 1 | 142 | 49 | 48 | 37 | 54 | 0 | 27 | 11 | 15 | 7 | 8 | 130 | 142 | 0 | 2 | 54 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 567,917,156 | 942 | 292 | 0 | 161 | 592 | 350 | 349 | 129 | 111 | 55 | 56 | 13 | 42 | 16 | 26 | 293 | 592 | 0 | 1 | 55 | 0 | 0 | 
| app_proof | prover | 1 | 537,266,124 | 487 | 138 | 0 | 2 | 308 | 177 | 176 | 75 | 55 | 0 | 40 | 12 | 27 | 14 | 13 | 138 | 308 | 0 | 1 | 54 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 35 | 1,219 | 35 | 177 | 0 | 3 | 64 | 1,540,000 | 33.06 | 
| app_proof | 1 | 16 | 676 | 16 | 40 | 0 | 1 | 131 | 1,039,903 | 36.30 | 

...
|:---|---:|---:|---:|
| Total | <span style='color: red'>(+0 [+0.6%])</span> 2.41 | <span style='color: red'>(+0 [+1.5%])</span> 0.75 | 0.75 |
| regex_program | <span style='color: red'>(+0 [+0.6%])</span> 2.41 | <span style='color: red'>(+0 [+1.6%])</span> 0.75 |  0.75 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+4 [+0.6%])</span> 592.75 | <span style='color: red'>(+15 [+0.6%])</span> 2,371 | <span style='color: red'>(+12 [+1.7%])</span> 712 | <span style='color: green'>(-2 [-0.4%])</span> 533 |
...
| `execute_metered_insn_mi/s` | <span style='color: red'>(+3 [+2.6%])</span> 111.24 | -          | <span style='color: red'>(+3 [+2.6%])</span> 111.24 | <span style='color: red'>(+3 [+2.6%])</span> 111.24 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` | <span style='color: green'>(-6 [-10.4%])</span> 47.25 | <span style='color: green'>(-22 [-10.4%])</span> 189 | <span style='color: green'>(-5 [-7.8%])</span> 59 | <span style='color: green'>(-9 [-20.5%])</span> 35 |
| `execute_preflight_insn_mi/s` | <span style='color: green'>(-1 [-3.2%])</span> 31.12 | -          | <span style='color: green'>(-2 [-5.3%])</span> 31.98 | <span style='color: red'>(+1 [+3.0%])</span> 29.97 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+4 [+2.2%])</span> 177 | <span style='color: red'>(+15 [+2.2%])</span> 708 | <span style='color: red'>(+11 [+6.0%])</span> 195 | <span style='color: red'>(+9 [+5.7%])</span> 168 |
| `memory_finalize_time_ms` |  1 |  4 |  4 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+6 [+2.3%])</span> 294.75 | <span style='color: red'>(+26 [+2.3%])</span> 1,179 | <span style='color: red'>(+16 [+5.4%])</span> 315 | <span style='color: red'>(+1 [+0.4%])</span> 271 |
| `main_trace_commit_time_ms` | <span style='color: green'>(-1 [-1.9%])</span> 51.25 | <span style='color: green'>(-4 [-1.9%])</span> 205 | <span style='color: red'>(+1 [+1.8%])</span> 58 | <span style='color: green'>(-2 [-4.0%])</span> 48 |
| `generate_perm_trace_time_ms` | <span style='color: red'>(+6 [+15.3%])</span> 41.50 | <span style='color: red'>(+22 [+15.3%])</span> 166 | <span style='color: red'>(+9 [+18.4%])</span> 58 |  29 |
| `perm_trace_commit_time_ms` | <span style='color: red'>(+1 [+1.0%])</span> 64.41 | <span style='color: red'>(+3 [+1.0%])</span> 257.63 | <span style='color: red'>(+1 [+1.3%])</span> 71.80 | <span style='color: red'>(+1 [+1.4%])</span> 54.92 |
| `quotient_poly_compute_time_ms` | <span style='color: green'>(-1 [-1.8%])</span> 59.88 | <span style='color: green'>(-4 [-1.8%])</span> 239.50 | <span style='color: green'>(-4 [-5.0%])</span> 69.67 | <span style='color: red'>(+0 [+0.9%])</span> 54.20 |
| `quotient_poly_commit_time_ms` | <span style='color: green'>(-0 [-0.7%])</span> 15.44 | <span style='color: green'>(-0 [-0.7%])</span> 61.77 | <span style='color: green'>(-0 [-0.5%])</span> 17.88 | <span style='color: green'>(-1 [-5.5%])</span> 13.16 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+3 [+5.4%])</span> 59 | <span style='color: red'>(+12 [+5.4%])</span> 236 | <span style='color: red'>(+17 [+29.3%])</span> 75 | <span style='color: green'>(-3 [-5.7%])</span> 50 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 571 | 1 | 37 | 4,137,502 | 111.24 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 168 | 712 | 23,446,148 | 150,778,428 | 168 | 315 | 0 | 61.03 | 17.88 | 6 | 71.80 | 75 | 102 | 74 | 4 | 58 | 10,899,170 | 29 | 59 | 1,103,000 | 29.97 | 22 | 79 | 1 | 74 | 
| regex_program | 1 | 172 | 555 | 11,598,276 | 128,513,066 | 172 | 293 | 1 | 54.20 | 15.19 | 5 | 64.76 | 58 | 114 | 58 | 0 | 50 | 2,196,106 | 49 | 47 | 1,104,000 | 31.54 | 16 | 70 | 0 | 58 | 
| regex_program | 2 | 173 | 533 | 11,579,064 | 128,513,066 | 173 | 271 | 1 | 54.61 | 15.53 | 4 | 66.15 | 53 | 96 | 53 | 0 | 49 | 2,177,334 | 30 | 48 | 1,104,000 | 31.01 | 17 | 70 | 0 | 53 | 
| regex_program | 3 | 195 | 571 | 11,853,872 | 103,456,394 | 194 | 300 | 0 | 69.67 | 13.16 | 5 | 54.92 | 50 | 116 | 49 | 0 | 48 | 2,422,606 | 58 | 35 | 826,502 | 31.98 | 18 | 83 | 1 | 49 | 

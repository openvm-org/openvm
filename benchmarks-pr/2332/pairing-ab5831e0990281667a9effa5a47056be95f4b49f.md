...
|:---|---:|---:|---:|
| Total | <span style='color: green'>(-0 [-2.6%])</span> 1.57 | <span style='color: green'>(-0 [-3.4%])</span> 0.93 | 0.93 |
| pairing | <span style='color: green'>(-0 [-2.6%])</span> 1.57 | <span style='color: green'>(-0 [-3.4%])</span> 0.93 |  0.93 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: green'>(-20 [-2.7%])</span> 751.50 | <span style='color: green'>(-41 [-2.7%])</span> 1,503 | <span style='color: green'>(-33 [-3.7%])</span> 869 | <span style='color: green'>(-8 [-1.2%])</span> 634 |
...
| `execute_metered_insn_mi/s` | <span style='color: green'>(-0 [-0.7%])</span> 27.29 | -          | <span style='color: green'>(-0 [-0.7%])</span> 27.29 | <span style='color: green'>(-0 [-0.7%])</span> 27.29 |
...
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+0 [+1.0%])</span> 14.75 | -          | <span style='color: red'>(+0 [+0.6%])</span> 18.10 | <span style='color: red'>(+0 [+1.7%])</span> 11.40 |
...
| `stark_prove_excluding_trace_time_ms` | <span style='color: green'>(-17 [-4.3%])</span> 377.50 | <span style='color: green'>(-34 [-4.3%])</span> 755 | <span style='color: green'>(-30 [-6.8%])</span> 414 | <span style='color: green'>(-4 [-1.2%])</span> 341 |
| `main_trace_commit_time_ms` | <span style='color: red'>(+0 [+0.8%])</span> 65.50 | <span style='color: red'>(+1 [+0.8%])</span> 131 |  76 | <span style='color: red'>(+1 [+1.9%])</span> 55 |
| `generate_perm_trace_time_ms` |  39 |  78 |  40 |  38 |
| `perm_trace_commit_time_ms` | <span style='color: green'>(-1 [-1.5%])</span> 77.46 | <span style='color: green'>(-2 [-1.5%])</span> 154.92 | <span style='color: green'>(-2 [-2.2%])</span> 89.01 | <span style='color: green'>(-0 [-0.5%])</span> 65.91 |
| `quotient_poly_compute_time_ms` | <span style='color: green'>(-1 [-1.2%])</span> 82.97 | <span style='color: green'>(-2 [-1.2%])</span> 165.95 | <span style='color: green'>(-1 [-1.1%])</span> 91.34 | <span style='color: green'>(-1 [-1.4%])</span> 74.60 |
| `quotient_poly_commit_time_ms` | <span style='color: green'>(-0 [-1.9%])</span> 17.23 | <span style='color: green'>(-1 [-1.9%])</span> 34.46 | <span style='color: red'>(+0 [+0.5%])</span> 19.30 | <span style='color: green'>(-1 [-4.8%])</span> 15.16 |
| `pcs_opening_time_ms ` | <span style='color: green'>(-14 [-13.4%])</span> 90.50 | <span style='color: green'>(-28 [-13.4%])</span> 181 | <span style='color: green'>(-27 [-22.1%])</span> 95 | <span style='color: green'>(-1 [-1.1%])</span> 86 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 634 | 1 | 63 | 1,745,742 | 27.29 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 166 | 869 | 32,480,114 | 172,558,444 | 166 | 414 | 0 | 91.34 | 19.30 | 6 | 89.01 | 95 | 130 | 95 | 1 | 76 | 15,909,408 | 38 | 119 | 1,149,000 | 11.40 | 27 | 111 | 1 | 95 | 
| pairing | 1 | 203 | 634 | 22,464,232 | 119,958,502 | 203 | 341 | 1 | 74.60 | 15.16 | 6 | 65.91 | 86 | 108 | 86 | 0 | 55 | 9,498,894 | 40 | 48 | 596,742 | 18.10 | 21 | 90 | 1 | 86 | 

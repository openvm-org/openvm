...
|:---|---:|---:|---:|
| Total | <span style='color: green'>(-0 [-0.7%])</span> 1.53 | <span style='color: green'>(-0 [-1.7%])</span> 0.92 | 0.92 |
| pairing | <span style='color: green'>(-0 [-0.7%])</span> 1.53 | <span style='color: green'>(-0 [-1.8%])</span> 0.92 |  0.92 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: green'>(-6 [-0.7%])</span> 731.50 | <span style='color: green'>(-11 [-0.7%])</span> 1,463 | <span style='color: green'>(-17 [-2.0%])</span> 854 | <span style='color: red'>(+6 [+1.0%])</span> 609 |
...
| `execute_metered_insn_mi/s` | <span style='color: green'>(-0 [-1.1%])</span> 27.12 | -          | <span style='color: green'>(-0 [-1.1%])</span> 27.12 | <span style='color: green'>(-0 [-1.1%])</span> 27.12 |
| `execute_preflight_insns` |  872,871 |  1,745,742 |  1,149,000 |  596,742 |
| `execute_preflight_time_ms` | <span style='color: red'>(+0 [+0.6%])</span> 84 | <span style='color: red'>(+1 [+0.6%])</span> 168 | <span style='color: red'>(+14 [+13.2%])</span> 120 | <span style='color: green'>(-13 [-21.3%])</span> 48 |
| `execute_preflight_insn_mi/s` | <span style='color: green'>(-0 [-0.2%])</span> 14.70 | -          | <span style='color: green'>(-0 [-1.2%])</span> 18.01 | <span style='color: red'>(+0 [+1.3%])</span> 11.40 |
| `trace_gen_time_ms   ` | <span style='color: green'>(-2 [-1.1%])</span> 184 | <span style='color: green'>(-4 [-1.1%])</span> 368 | <span style='color: red'>(+11 [+5.7%])</span> 203 | <span style='color: green'>(-15 [-8.3%])</span> 165 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: green'>(-3 [-0.8%])</span> 357.50 | <span style='color: green'>(-6 [-0.8%])</span> 715 | <span style='color: green'>(-14 [-3.4%])</span> 399 | <span style='color: red'>(+8 [+2.6%])</span> 316 |
| `main_trace_commit_time_ms` | <span style='color: green'>(-1 [-1.6%])</span> 63.50 | <span style='color: green'>(-2 [-1.6%])</span> 127 | <span style='color: green'>(-2 [-2.7%])</span> 73 |  54 |
| `generate_perm_trace_time_ms` | <span style='color: green'>(-4 [-10.0%])</span> 40.50 | <span style='color: green'>(-9 [-10.0%])</span> 81 | <span style='color: green'>(-10 [-18.9%])</span> 43 | <span style='color: red'>(+1 [+2.7%])</span> 38 |
| `perm_trace_commit_time_ms` | <span style='color: red'>(+0 [+0.2%])</span> 77.17 | <span style='color: red'>(+0 [+0.2%])</span> 154.34 |  89.49 | <span style='color: red'>(+0 [+0.6%])</span> 64.84 |
| `quotient_poly_compute_time_ms` | <span style='color: green'>(-1 [-1.2%])</span> 83.13 | <span style='color: green'>(-2 [-1.2%])</span> 166.26 | <span style='color: green'>(-0 [-0.3%])</span> 92.12 | <span style='color: green'>(-2 [-2.3%])</span> 74.14 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+1 [+4.7%])</span> 17.69 | <span style='color: red'>(+2 [+4.7%])</span> 35.37 | <span style='color: red'>(+1 [+6.7%])</span> 19.85 | <span style='color: red'>(+0 [+2.2%])</span> 15.52 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+2 [+3.7%])</span> 70 | <span style='color: red'>(+5 [+3.7%])</span> 140 | <span style='color: green'>(-4 [-5.1%])</span> 75 | <span style='color: red'>(+9 [+16.1%])</span> 65 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 609 | 1 | 64 | 1,745,742 | 27.12 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 165 | 854 | 32,480,114 | 172,558,444 | 165 | 399 | 0 | 92.12 | 19.85 | 6 | 89.49 | 75 | 136 | 75 | 1 | 73 | 15,909,408 | 43 | 120 | 1,149,000 | 11.40 | 27 | 112 | 1 | 75 | 
| pairing | 1 | 203 | 609 | 22,464,232 | 119,958,502 | 203 | 316 | 1 | 74.14 | 15.52 | 6 | 64.84 | 65 | 106 | 64 | 0 | 54 | 9,498,894 | 38 | 48 | 596,742 | 18.01 | 21 | 90 | 1 | 64 | 

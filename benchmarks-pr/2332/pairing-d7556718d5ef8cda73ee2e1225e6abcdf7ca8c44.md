...
|:---|---:|---:|---:|
| Total | <span style='color: red'>(+0 [+9.0%])</span> 1.68 | <span style='color: red'>(+0 [+16.2%])</span> 1.08 | 1.08 |
| pairing | <span style='color: green'>(-0 [-2.1%])</span> 1.68 | <span style='color: green'>(-0 [-2.2%])</span> 1.08 |  1.08 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: green'>(-18 [-2.4%])</span> 719 | <span style='color: green'>(-36 [-2.4%])</span> 1,438 | <span style='color: green'>(-24 [-2.8%])</span> 847 | <span style='color: green'>(-12 [-2.0%])</span> 591 |
| `main_cells_used     ` |  12,704,151 |  25,408,302 |  15,909,408 |  9,498,894 |
| `total_cells_used    ` |  27,472,173 |  54,944,346 |  32,480,114 |  22,464,232 |
| `execute_metered_time_ms` | <span style='color: red'>(+175 [+277.8%])</span> 238 | -          | -          | -          |
| `execute_metered_insn_mi/s` | <span style='color: green'>(-20 [-73.3%])</span> 7.32 | -          | <span style='color: green'>(-20 [-73.3%])</span> 7.32 | <span style='color: green'>(-20 [-73.3%])</span> 7.32 |
| `execute_preflight_insns` |  872,871 |  1,745,742 |  1,149,000 |  596,742 |
| `execute_preflight_time_ms` | <span style='color: green'>(-5 [-6.0%])</span> 78.50 | <span style='color: green'>(-10 [-6.0%])</span> 157 |  106 | <span style='color: green'>(-10 [-16.4%])</span> 51 |
| `execute_preflight_insn_mi/s` | <span style='color: green'>(-0 [-1.7%])</span> 14.48 | -          | <span style='color: green'>(-0 [-2.4%])</span> 17.78 | <span style='color: green'>(-0 [-0.5%])</span> 11.19 |
| `trace_gen_time_ms   ` | <span style='color: green'>(-3 [-1.6%])</span> 183 | <span style='color: green'>(-6 [-1.6%])</span> 366 | <span style='color: red'>(+2 [+1.0%])</span> 194 | <span style='color: green'>(-8 [-4.4%])</span> 172 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: green'>(-10 [-2.6%])</span> 351 | <span style='color: green'>(-19 [-2.6%])</span> 702 | <span style='color: green'>(-15 [-3.6%])</span> 398 | <span style='color: green'>(-4 [-1.3%])</span> 304 |
| `main_trace_commit_time_ms` | <span style='color: green'>(-3 [-4.7%])</span> 61.50 | <span style='color: green'>(-6 [-4.7%])</span> 123 | <span style='color: green'>(-5 [-6.7%])</span> 70 | <span style='color: green'>(-1 [-1.9%])</span> 53 |
| `generate_perm_trace_time_ms` | <span style='color: green'>(-0 [-1.1%])</span> 44.50 | <span style='color: green'>(-1 [-1.1%])</span> 89 | <span style='color: green'>(-1 [-1.9%])</span> 52 |  37 |
| `perm_trace_commit_time_ms` | <span style='color: green'>(-2 [-2.4%])</span> 75.17 | <span style='color: green'>(-4 [-2.4%])</span> 150.35 | <span style='color: green'>(-3 [-3.0%])</span> 86.89 | <span style='color: green'>(-1 [-1.5%])</span> 63.46 |
| `quotient_poly_compute_time_ms` | <span style='color: green'>(-3 [-3.8%])</span> 80.98 | <span style='color: green'>(-6 [-3.8%])</span> 161.96 | <span style='color: green'>(-3 [-2.9%])</span> 89.73 | <span style='color: green'>(-4 [-4.9%])</span> 72.23 |
| `quotient_poly_commit_time_ms` | <span style='color: green'>(-1 [-5.0%])</span> 16.06 | <span style='color: green'>(-2 [-5.0%])</span> 32.12 | <span style='color: green'>(-1 [-3.5%])</span> 17.95 | <span style='color: green'>(-1 [-6.7%])</span> 14.17 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+1 [+1.5%])</span> 68.50 | <span style='color: red'>(+2 [+1.5%])</span> 137 | <span style='color: green'>(-2 [-2.5%])</span> 77 | <span style='color: red'>(+4 [+7.1%])</span> 60 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 591 | 1 | 238 | 1,745,742 | 7.32 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 172 | 847 | 32,480,114 | 172,558,444 | 172 | 398 | 0 | 89.73 | 17.95 | 6 | 86.89 | 77 | 142 | 77 | 1 | 70 | 15,909,408 | 52 | 106 | 1,149,000 | 11.19 | 26 | 108 | 1 | 77 | 
| pairing | 1 | 194 | 591 | 22,464,232 | 119,958,502 | 194 | 304 | 1 | 72.23 | 14.17 | 6 | 63.46 | 60 | 103 | 60 | 0 | 53 | 9,498,894 | 37 | 51 | 596,742 | 17.78 | 21 | 87 | 1 | 60 | 

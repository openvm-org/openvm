...
|:---|---:|---:|---:|
| Total | <span style='color: green'>(-0 [-1.3%])</span> 1.03 | <span style='color: green'>(-0 [-1.8%])</span> 0.59 | 0.59 |
| fibonacci_program | <span style='color: green'>(-0 [-1.4%])</span> 1.03 | <span style='color: green'>(-0 [-2.0%])</span> 0.59 |  0.59 |


| fibonacci_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: green'>(-8 [-1.4%])</span> 511.50 | <span style='color: green'>(-15 [-1.4%])</span> 1,023 | <span style='color: green'>(-12 [-2.0%])</span> 584 | <span style='color: green'>(-3 [-0.7%])</span> 439 |
...
| `execute_metered_insn_mi/s` | <span style='color: green'>(-7 [-4.7%])</span> 143.49 | -          | <span style='color: green'>(-7 [-4.7%])</span> 143.49 | <span style='color: green'>(-7 [-4.7%])</span> 143.49 |
| `execute_preflight_insns` |  750,104.50 |  1,500,209 |  873,000 |  627,209 |
| `execute_preflight_time_ms` | <span style='color: green'>(-4 [-14.5%])</span> 26.50 | <span style='color: green'>(-9 [-14.5%])</span> 53 | <span style='color: green'>(-2 [-5.9%])</span> 32 | <span style='color: green'>(-7 [-25.0%])</span> 21 |
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+4 [+10.5%])</span> 38.63 | -          | <span style='color: red'>(+1 [+1.4%])</span> 38.73 | <span style='color: red'>(+7 [+21.5%])</span> 38.54 |
...
| `stark_prove_excluding_trace_time_ms` | <span style='color: green'>(-2 [-0.8%])</span> 186 | <span style='color: green'>(-3 [-0.8%])</span> 372 | <span style='color: green'>(-3 [-1.5%])</span> 193 |  179 |
...
| `generate_perm_trace_time_ms` |  24 |  48 | <span style='color: green'>(-1 [-3.8%])</span> 25 | <span style='color: red'>(+1 [+4.5%])</span> 23 |
| `perm_trace_commit_time_ms` | <span style='color: green'>(-1 [-2.4%])</span> 40.72 | <span style='color: green'>(-2 [-2.4%])</span> 81.45 | <span style='color: green'>(-2 [-3.7%])</span> 43.23 | <span style='color: green'>(-0 [-0.9%])</span> 38.22 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+1 [+2.4%])</span> 32.74 | <span style='color: red'>(+2 [+2.4%])</span> 65.48 | <span style='color: red'>(+2 [+5.5%])</span> 34.60 | <span style='color: green'>(-0 [-0.8%])</span> 30.88 |
| `quotient_poly_commit_time_ms` | <span style='color: green'>(-1 [-4.2%])</span> 12.46 | <span style='color: green'>(-1 [-4.2%])</span> 24.91 | <span style='color: green'>(-1 [-6.1%])</span> 12.59 | <span style='color: green'>(-0 [-2.2%])</span> 12.32 |
| `pcs_opening_time_ms ` |  43.50 |  87 | <span style='color: red'>(+1 [+2.3%])</span> 45 | <span style='color: green'>(-1 [-2.3%])</span> 42 |
...
| --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 439 | 1 | 10 | 1,500,209 | 143.49 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 190 | 584 | 9,677,708 | 84,395,212 | 190 | 193 | 0 | 34.60 | 12.59 | 5 | 43.23 | 42 | 69 | 42 | 0 | 33 | 1,035,986 | 25 | 32 | 873,000 | 38.54 | 14 | 47 | 0 | 42 | 
| fibonacci_program | 1 | 197 | 439 | 9,708,170 | 74,305,770 | 197 | 179 | 1 | 30.88 | 12.32 | 4 | 38.22 | 45 | 61 | 44 | 0 | 28 | 1,064,416 | 23 | 21 | 627,209 | 38.73 | 11 | 43 | 0 | 44 | 

...
|:---|---:|---:|---:|
| Total | <span style='color: green'>(-0 [-1.3%])</span> 2.36 | <span style='color: green'>(-0 [-0.5%])</span> 0.73 | 0.73 |
| regex_program | <span style='color: green'>(-0 [-1.2%])</span> 2.36 | <span style='color: green'>(-0 [-0.1%])</span> 0.73 |  0.73 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: green'>(-7 [-1.2%])</span> 581.75 | <span style='color: green'>(-29 [-1.2%])</span> 2,327 | <span style='color: green'>(-1 [-0.1%])</span> 699 | <span style='color: green'>(-4 [-0.7%])</span> 531 |
...
| `execute_metered_insn_mi/s` | <span style='color: red'>(+7 [+6.5%])</span> 115.48 | -          | <span style='color: red'>(+7 [+6.5%])</span> 115.48 | <span style='color: red'>(+7 [+6.5%])</span> 115.48 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` | <span style='color: green'>(-7 [-13.7%])</span> 45.50 | <span style='color: green'>(-29 [-13.7%])</span> 182 | <span style='color: green'>(-8 [-12.5%])</span> 56 | <span style='color: green'>(-10 [-22.7%])</span> 34 |
| `execute_preflight_insn_mi/s` | <span style='color: green'>(-0 [-1.2%])</span> 31.77 | -          | <span style='color: green'>(-1 [-3.7%])</span> 32.54 | <span style='color: red'>(+2 [+5.8%])</span> 30.78 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+8 [+4.6%])</span> 181.25 | <span style='color: red'>(+32 [+4.6%])</span> 725 | <span style='color: red'>(+13 [+7.1%])</span> 197 | <span style='color: red'>(+14 [+8.8%])</span> 173 |
| `memory_finalize_time_ms` |  1 |  4 |  4 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: green'>(-7 [-2.4%])</span> 281.25 | <span style='color: green'>(-28 [-2.4%])</span> 1,125 | <span style='color: red'>(+1 [+0.3%])</span> 300 | <span style='color: green'>(-4 [-1.5%])</span> 266 |
| `main_trace_commit_time_ms` | <span style='color: red'>(+0 [+0.5%])</span> 52.50 | <span style='color: red'>(+1 [+0.5%])</span> 210 | <span style='color: red'>(+2 [+3.5%])</span> 59 |  50 |
| `generate_perm_trace_time_ms` | <span style='color: green'>(-7 [-18.8%])</span> 29.25 | <span style='color: green'>(-27 [-18.8%])</span> 117 | <span style='color: green'>(-13 [-26.5%])</span> 36 | <span style='color: green'>(-7 [-24.1%])</span> 22 |
| `perm_trace_commit_time_ms` | <span style='color: red'>(+1 [+2.0%])</span> 65.04 | <span style='color: red'>(+5 [+2.0%])</span> 260.17 | <span style='color: red'>(+2 [+2.7%])</span> 72.78 | <span style='color: red'>(+0 [+0.5%])</span> 54.44 |
| `quotient_poly_compute_time_ms` | <span style='color: green'>(-0 [-0.2%])</span> 60.88 | <span style='color: green'>(-0 [-0.2%])</span> 243.51 | <span style='color: green'>(-1 [-0.8%])</span> 72.72 | <span style='color: red'>(+1 [+1.7%])</span> 54.64 |
| `quotient_poly_commit_time_ms` |  15.57 |  62.28 | <span style='color: green'>(-0 [-0.5%])</span> 17.88 | <span style='color: green'>(-0 [-1.4%])</span> 13.74 |
| `pcs_opening_time_ms ` | <span style='color: green'>(-1 [-2.2%])</span> 54.75 | <span style='color: green'>(-5 [-2.2%])</span> 219 | <span style='color: green'>(-1 [-1.7%])</span> 57 |  53 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 560 | 1 | 35 | 4,137,502 | 115.48 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 173 | 699 | 23,446,148 | 150,778,428 | 173 | 300 | 0 | 60.48 | 17.88 | 5 | 72.78 | 57 | 104 | 57 | 4 | 59 | 10,899,170 | 30 | 56 | 1,103,000 | 30.78 | 22 | 79 | 1 | 57 | 
| regex_program | 1 | 177 | 531 | 11,598,276 | 128,513,066 | 177 | 266 | 1 | 54.64 | 15.40 | 4 | 65.100 | 54 | 89 | 54 | 0 | 51 | 2,196,106 | 22 | 46 | 1,104,000 | 31.94 | 16 | 70 | 0 | 54 | 
| regex_program | 2 | 178 | 537 | 11,579,064 | 128,513,066 | 178 | 272 | 1 | 55.66 | 15.27 | 4 | 66.95 | 53 | 97 | 53 | 0 | 50 | 2,177,334 | 29 | 46 | 1,104,000 | 31.83 | 16 | 71 | 0 | 53 | 
| regex_program | 3 | 197 | 560 | 11,853,872 | 103,456,394 | 197 | 287 | 0 | 72.72 | 13.74 | 5 | 54.44 | 55 | 93 | 55 | 0 | 50 | 2,422,606 | 36 | 34 | 826,502 | 32.54 | 19 | 87 | 1 | 55 | 

...
|:---|---:|---:|---:|
| Total | <span style='color: green'>(-0 [-0.5%])</span> 1.54 | <span style='color: green'>(-0 [-1.0%])</span> 0.91 | 0.91 |
| pairing | <span style='color: green'>(-0 [-0.5%])</span> 1.54 | <span style='color: green'>(-0 [-0.9%])</span> 0.91 |  0.91 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: green'>(-4 [-0.5%])</span> 737.50 | <span style='color: green'>(-7 [-0.5%])</span> 1,475 | <span style='color: green'>(-8 [-0.9%])</span> 843 | <span style='color: red'>(+1 [+0.2%])</span> 632 |
...
| `execute_metered_insn_mi/s` | <span style='color: red'>(+0 [+1.3%])</span> 27.71 | -          | <span style='color: red'>(+0 [+1.3%])</span> 27.71 | <span style='color: red'>(+0 [+1.3%])</span> 27.71 |
| `execute_preflight_insns` |  872,871 |  1,745,742 |  1,149,000 |  596,742 |
| `execute_preflight_time_ms` | <span style='color: green'>(-2 [-2.4%])</span> 83 | <span style='color: green'>(-4 [-2.4%])</span> 166 | <span style='color: red'>(+12 [+11.3%])</span> 118 | <span style='color: green'>(-16 [-25.0%])</span> 48 |
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+0 [+0.5%])</span> 14.69 | -          | <span style='color: green'>(-0 [-0.3%])</span> 17.97 | <span style='color: red'>(+0 [+1.7%])</span> 11.41 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+4 [+1.9%])</span> 186 | <span style='color: red'>(+7 [+1.9%])</span> 372 | <span style='color: red'>(+19 [+10.2%])</span> 205 | <span style='color: green'>(-12 [-6.7%])</span> 167 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: green'>(-4 [-1.2%])</span> 363.50 | <span style='color: green'>(-9 [-1.2%])</span> 727 | <span style='color: green'>(-8 [-2.0%])</span> 389 | <span style='color: green'>(-1 [-0.3%])</span> 338 |
| `main_trace_commit_time_ms` |  64.50 |  129 | <span style='color: red'>(+2 [+2.7%])</span> 76 | <span style='color: green'>(-2 [-3.6%])</span> 53 |
| `generate_perm_trace_time_ms` | <span style='color: red'>(+2 [+3.9%])</span> 40 | <span style='color: red'>(+3 [+3.9%])</span> 80 | <span style='color: red'>(+1 [+2.6%])</span> 40 | <span style='color: red'>(+2 [+5.3%])</span> 40 |
| `perm_trace_commit_time_ms` | <span style='color: red'>(+1 [+1.6%])</span> 77.21 | <span style='color: red'>(+2 [+1.6%])</span> 154.43 | <span style='color: red'>(+2 [+2.1%])</span> 90.12 | <span style='color: red'>(+1 [+0.9%])</span> 64.31 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+2 [+2.1%])</span> 83.25 | <span style='color: red'>(+3 [+2.1%])</span> 166.51 | <span style='color: red'>(+1 [+1.6%])</span> 91.27 | <span style='color: red'>(+2 [+2.7%])</span> 75.24 |
| `quotient_poly_commit_time_ms` | <span style='color: green'>(-0 [-1.2%])</span> 17.18 | <span style='color: green'>(-0 [-1.2%])</span> 34.36 | <span style='color: red'>(+0 [+1.6%])</span> 19.42 | <span style='color: green'>(-1 [-4.5%])</span> 14.93 |
| `pcs_opening_time_ms ` | <span style='color: green'>(-10 [-11.1%])</span> 76 | <span style='color: green'>(-19 [-11.1%])</span> 152 | <span style='color: green'>(-2 [-2.3%])</span> 86 | <span style='color: green'>(-17 [-20.5%])</span> 66 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 632 | 1 | 62 | 1,745,742 | 27.71 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 167 | 843 | 32,480,114 | 172,558,444 | 167 | 389 | 0 | 91.27 | 19.42 | 6 | 90.12 | 66 | 134 | 66 | 1 | 76 | 15,909,408 | 40 | 118 | 1,149,000 | 11.41 | 26 | 111 | 1 | 66 | 
| pairing | 1 | 205 | 632 | 22,464,232 | 119,958,502 | 205 | 338 | 1 | 75.24 | 14.93 | 6 | 64.31 | 86 | 107 | 86 | 0 | 53 | 9,498,894 | 40 | 48 | 596,742 | 17.97 | 21 | 90 | 1 | 86 | 

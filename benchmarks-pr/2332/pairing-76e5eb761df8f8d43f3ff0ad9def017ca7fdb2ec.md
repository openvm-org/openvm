...
|:---|---:|---:|---:|
| Total | <span style='color: green'>(-0 [-5.9%])</span> 1.51 | <span style='color: green'>(-0 [-7.0%])</span> 0.90 | 0.90 |
| pairing | <span style='color: green'>(-0 [-5.9%])</span> 1.51 | <span style='color: green'>(-0 [-7.0%])</span> 0.90 |  0.90 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: green'>(-48 [-6.2%])</span> 724.50 | <span style='color: green'>(-95 [-6.2%])</span> 1,449 | <span style='color: green'>(-68 [-7.5%])</span> 834 | <span style='color: green'>(-27 [-4.2%])</span> 615 |
...
| `execute_metered_insn_mi/s` | <span style='color: red'>(+0 [+0.2%])</span> 27.56 | -          | <span style='color: red'>(+0 [+0.2%])</span> 27.56 | <span style='color: red'>(+0 [+0.2%])</span> 27.56 |
| `execute_preflight_insns` |  872,871 |  1,745,742 |  1,149,000 |  596,742 |
| `execute_preflight_time_ms` | <span style='color: red'>(+0 [+0.6%])</span> 84 | <span style='color: red'>(+1 [+0.6%])</span> 168 | <span style='color: red'>(+13 [+12.3%])</span> 119 | <span style='color: green'>(-12 [-19.7%])</span> 49 |
| `execute_preflight_insn_mi/s` | <span style='color: green'>(-0 [-0.2%])</span> 14.56 | -          | <span style='color: green'>(-0 [-1.0%])</span> 17.81 | <span style='color: red'>(+0 [+1.0%])</span> 11.32 |
| `trace_gen_time_ms   ` | <span style='color: green'>(-8 [-4.0%])</span> 180 | <span style='color: green'>(-15 [-4.0%])</span> 360 | <span style='color: red'>(+6 [+3.1%])</span> 199 | <span style='color: green'>(-21 [-11.5%])</span> 161 |
...
| `stark_prove_excluding_trace_time_ms` | <span style='color: green'>(-40 [-10.1%])</span> 354.50 | <span style='color: green'>(-80 [-10.1%])</span> 709 | <span style='color: green'>(-60 [-13.5%])</span> 384 | <span style='color: green'>(-20 [-5.8%])</span> 325 |
| `main_trace_commit_time_ms` |  65 |  130 | <span style='color: green'>(-1 [-1.3%])</span> 75 | <span style='color: red'>(+1 [+1.9%])</span> 55 |
| `generate_perm_trace_time_ms` | <span style='color: green'>(-4 [-9.0%])</span> 35.50 | <span style='color: green'>(-7 [-9.0%])</span> 71 | <span style='color: green'>(-2 [-5.0%])</span> 38 | <span style='color: green'>(-5 [-13.2%])</span> 33 |
| `perm_trace_commit_time_ms` | <span style='color: green'>(-2 [-2.6%])</span> 76.60 | <span style='color: green'>(-4 [-2.6%])</span> 153.20 | <span style='color: green'>(-2 [-2.6%])</span> 88.62 | <span style='color: green'>(-2 [-2.5%])</span> 64.57 |
| `quotient_poly_compute_time_ms` | <span style='color: green'>(-2 [-2.1%])</span> 82.28 | <span style='color: green'>(-3 [-2.1%])</span> 164.56 | <span style='color: green'>(-2 [-1.8%])</span> 90.75 | <span style='color: green'>(-2 [-2.4%])</span> 73.81 |
| `quotient_poly_commit_time_ms` | <span style='color: green'>(-0 [-1.4%])</span> 17.31 | <span style='color: green'>(-1 [-1.4%])</span> 34.61 | <span style='color: red'>(+0 [+1.7%])</span> 19.53 | <span style='color: green'>(-1 [-5.3%])</span> 15.09 |
| `pcs_opening_time_ms ` | <span style='color: green'>(-32 [-30.1%])</span> 73 | <span style='color: green'>(-63 [-30.1%])</span> 146 | <span style='color: green'>(-43 [-35.2%])</span> 79 | <span style='color: green'>(-20 [-23.0%])</span> 67 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 615 | 1 | 63 | 1,745,742 | 27.56 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 161 | 834 | 32,480,114 | 172,558,444 | 161 | 384 | 0 | 90.75 | 19.53 | 7 | 88.62 | 67 | 130 | 66 | 1 | 75 | 15,909,408 | 38 | 119 | 1,149,000 | 11.32 | 26 | 111 | 1 | 66 | 
| pairing | 1 | 199 | 615 | 22,464,232 | 119,958,502 | 199 | 325 | 1 | 73.81 | 15.09 | 5 | 64.57 | 79 | 101 | 79 | 1 | 55 | 9,498,894 | 33 | 49 | 596,742 | 17.81 | 20 | 89 | 1 | 79 | 

...
|:---|---:|---:|---:|
| Total | <span style='color: red'>(+0 [+0.5%])</span> 1.54 | <span style='color: red'>(+0 [+1.3%])</span> 0.95 | 0.95 |
| pairing | <span style='color: green'>(-0 [-1.1%])</span> 1.54 | <span style='color: green'>(-0 [-1.3%])</span> 0.95 |  0.95 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: green'>(-8 [-1.2%])</span> 728.50 | <span style='color: green'>(-17 [-1.2%])</span> 1,457 | <span style='color: green'>(-12 [-1.4%])</span> 859 | <span style='color: green'>(-5 [-0.8%])</span> 598 |
| `main_cells_used     ` |  12,704,151 |  25,408,302 |  15,909,408 |  9,498,894 |
| `total_cells_used    ` |  27,472,173 |  54,944,346 |  32,480,114 |  22,464,232 |
| `execute_metered_time_ms` | <span style='color: red'>(+24 [+38.1%])</span> 87 | -          | -          | -          |
| `execute_metered_insn_mi/s` | <span style='color: green'>(-7 [-27.3%])</span> 19.94 | -          | <span style='color: green'>(-7 [-27.3%])</span> 19.94 | <span style='color: green'>(-7 [-27.3%])</span> 19.94 |
...
| `execute_preflight_insn_mi/s` | <span style='color: green'>(-0 [-0.7%])</span> 14.64 | -          | <span style='color: green'>(-0 [-0.7%])</span> 18.09 | <span style='color: green'>(-0 [-0.6%])</span> 11.19 |
| `trace_gen_time_ms   ` |  186 |  372 | <span style='color: red'>(+4 [+2.1%])</span> 196 | <span style='color: green'>(-4 [-2.2%])</span> 176 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: green'>(-4 [-1.0%])</span> 357 | <span style='color: green'>(-7 [-1.0%])</span> 714 | <span style='color: green'>(-7 [-1.7%])</span> 406 |  308 |
| `main_trace_commit_time_ms` | <span style='color: green'>(-2 [-3.9%])</span> 62 | <span style='color: green'>(-5 [-3.9%])</span> 124 | <span style='color: green'>(-4 [-5.3%])</span> 71 | <span style='color: green'>(-1 [-1.9%])</span> 53 |
| `generate_perm_trace_time_ms` | <span style='color: red'>(+0 [+1.1%])</span> 45.50 | <span style='color: red'>(+1 [+1.1%])</span> 91 |  53 | <span style='color: red'>(+1 [+2.7%])</span> 38 |
| `perm_trace_commit_time_ms` | <span style='color: green'>(-1 [-1.0%])</span> 76.18 | <span style='color: green'>(-2 [-1.0%])</span> 152.36 | <span style='color: green'>(-1 [-1.5%])</span> 88.20 | <span style='color: green'>(-0 [-0.4%])</span> 64.15 |
| `quotient_poly_compute_time_ms` | <span style='color: green'>(-2 [-2.5%])</span> 82.04 | <span style='color: green'>(-4 [-2.5%])</span> 164.07 | <span style='color: green'>(-1 [-1.1%])</span> 91.34 | <span style='color: green'>(-3 [-4.2%])</span> 72.73 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+0 [+2.5%])</span> 17.32 | <span style='color: red'>(+1 [+2.5%])</span> 34.65 | <span style='color: red'>(+1 [+5.6%])</span> 19.64 | <span style='color: green'>(-0 [-1.3%])</span> 15.01 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+2 [+2.2%])</span> 69 | <span style='color: red'>(+3 [+2.2%])</span> 138 | <span style='color: green'>(-1 [-1.3%])</span> 78 | <span style='color: red'>(+4 [+7.1%])</span> 60 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 598 | 1 | 87 | 1,745,742 | 19.94 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 176 | 859 | 32,480,114 | 172,558,444 | 176 | 406 | 0 | 91.34 | 19.64 | 6 | 88.20 | 78 | 144 | 78 | 1 | 71 | 15,909,408 | 53 | 106 | 1,149,000 | 11.19 | 27 | 111 | 1 | 78 | 
| pairing | 1 | 196 | 598 | 22,464,232 | 119,958,502 | 196 | 308 | 1 | 72.73 | 15.01 | 6 | 64.15 | 60 | 105 | 60 | 0 | 53 | 9,498,894 | 38 | 51 | 596,742 | 18.09 | 21 | 88 | 1 | 60 | 

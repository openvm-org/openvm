...
|:---|---:|---:|---:|
| Total | <span style='color: green'>(-0 [-0.1%])</span> 1.54 | <span style='color: green'>(-0 [-1.0%])</span> 0.93 | 0.93 |
| pairing | <span style='color: green'>(-0 [-0.2%])</span> 1.54 | <span style='color: green'>(-0 [-1.1%])</span> 0.93 |  0.93 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: green'>(-2 [-0.2%])</span> 735.50 | <span style='color: green'>(-3 [-0.2%])</span> 1,471 | <span style='color: green'>(-10 [-1.1%])</span> 861 | <span style='color: red'>(+7 [+1.2%])</span> 610 |
...
| `execute_metered_insn_mi/s` | <span style='color: green'>(-0 [-0.9%])</span> 27.17 | -          | <span style='color: green'>(-0 [-0.9%])</span> 27.17 | <span style='color: green'>(-0 [-0.9%])</span> 27.17 |
...
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+0 [+0.5%])</span> 14.82 | -          |  18.23 | <span style='color: red'>(+0 [+1.3%])</span> 11.40 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+0 [+0.3%])</span> 186.50 | <span style='color: red'>(+1 [+0.3%])</span> 373 | <span style='color: red'>(+15 [+7.8%])</span> 207 | <span style='color: green'>(-14 [-7.8%])</span> 166 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  360.50 |  721 | <span style='color: green'>(-5 [-1.2%])</span> 408 | <span style='color: red'>(+5 [+1.6%])</span> 313 |
| `main_trace_commit_time_ms` | <span style='color: red'>(+0 [+0.8%])</span> 65 | <span style='color: red'>(+1 [+0.8%])</span> 130 | <span style='color: red'>(+1 [+1.3%])</span> 76 |  54 |
| `generate_perm_trace_time_ms` | <span style='color: green'>(-2 [-4.4%])</span> 43 | <span style='color: green'>(-4 [-4.4%])</span> 86 | <span style='color: green'>(-4 [-7.5%])</span> 49 |  37 |
| `perm_trace_commit_time_ms` | <span style='color: red'>(+1 [+0.8%])</span> 77.63 | <span style='color: red'>(+1 [+0.8%])</span> 155.26 | <span style='color: red'>(+0 [+0.4%])</span> 89.86 | <span style='color: red'>(+1 [+1.5%])</span> 65.40 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+0 [+0.4%])</span> 84.50 | <span style='color: red'>(+1 [+0.4%])</span> 169 | <span style='color: red'>(+1 [+0.7%])</span> 93.08 |  75.92 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+0 [+0.9%])</span> 17.06 | <span style='color: red'>(+0 [+0.9%])</span> 34.11 | <span style='color: red'>(+0 [+1.7%])</span> 18.92 |  15.19 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+1 [+1.5%])</span> 68.50 | <span style='color: red'>(+2 [+1.5%])</span> 137 | <span style='color: green'>(-3 [-3.8%])</span> 76 | <span style='color: red'>(+5 [+8.9%])</span> 61 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 610 | 1 | 64 | 1,745,742 | 27.17 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 166 | 861 | 32,480,114 | 172,558,444 | 165 | 408 | 0 | 93.08 | 18.92 | 6 | 89.86 | 76 | 142 | 75 | 1 | 76 | 15,909,408 | 49 | 119 | 1,149,000 | 11.40 | 27 | 112 | 1 | 75 | 
| pairing | 1 | 207 | 610 | 22,464,232 | 119,958,502 | 207 | 313 | 1 | 75.92 | 15.19 | 5 | 65.40 | 61 | 105 | 61 | 0 | 54 | 9,498,894 | 37 | 47 | 596,742 | 18.23 | 21 | 91 | 1 | 61 | 

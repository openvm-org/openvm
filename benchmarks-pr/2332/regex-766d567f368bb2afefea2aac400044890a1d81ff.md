...
|:---|---:|---:|---:|
| Total | <span style='color: green'>(-0 [-2.0%])</span> 2.35 | <span style='color: green'>(-0 [-0.5%])</span> 0.73 | 0.73 |
| regex_program | <span style='color: green'>(-0 [-1.9%])</span> 2.35 | <span style='color: green'>(-0 [-0.3%])</span> 0.73 |  0.73 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: green'>(-12 [-2.0%])</span> 577.50 | <span style='color: green'>(-46 [-2.0%])</span> 2,310 | <span style='color: green'>(-2 [-0.3%])</span> 698 | <span style='color: green'>(-15 [-2.8%])</span> 520 |
...
| `execute_metered_insn_mi/s` | <span style='color: red'>(+4 [+3.9%])</span> 112.59 | -          | <span style='color: red'>(+4 [+3.9%])</span> 112.59 | <span style='color: red'>(+4 [+3.9%])</span> 112.59 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` | <span style='color: green'>(-8 [-14.2%])</span> 45.25 | <span style='color: green'>(-30 [-14.2%])</span> 181 | <span style='color: green'>(-7 [-10.9%])</span> 57 | <span style='color: green'>(-9 [-20.5%])</span> 35 |
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+0 [+0.3%])</span> 32.25 | -          | <span style='color: green'>(-1 [-1.7%])</span> 33.20 | <span style='color: red'>(+2 [+7.2%])</span> 31.17 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+6 [+3.8%])</span> 179.75 | <span style='color: red'>(+26 [+3.8%])</span> 719 | <span style='color: red'>(+11 [+6.0%])</span> 195 | <span style='color: red'>(+12 [+7.5%])</span> 171 |
| `memory_finalize_time_ms` |  1 |  4 |  4 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: green'>(-10 [-3.6%])</span> 278 | <span style='color: green'>(-41 [-3.6%])</span> 1,112 | <span style='color: green'>(-1 [-0.3%])</span> 298 | <span style='color: green'>(-14 [-5.2%])</span> 256 |
| `main_trace_commit_time_ms` | <span style='color: green'>(-1 [-1.9%])</span> 51.25 | <span style='color: green'>(-4 [-1.9%])</span> 205 | <span style='color: green'>(-1 [-1.8%])</span> 56 | <span style='color: green'>(-1 [-2.0%])</span> 49 |
| `generate_perm_trace_time_ms` | <span style='color: green'>(-7 [-18.8%])</span> 29.25 | <span style='color: green'>(-27 [-18.8%])</span> 117 | <span style='color: green'>(-14 [-28.6%])</span> 35 | <span style='color: green'>(-6 [-20.7%])</span> 23 |
| `perm_trace_commit_time_ms` | <span style='color: red'>(+1 [+1.5%])</span> 64.71 | <span style='color: red'>(+4 [+1.5%])</span> 258.85 | <span style='color: red'>(+1 [+1.3%])</span> 71.82 | <span style='color: red'>(+2 [+3.1%])</span> 55.84 |
| `quotient_poly_compute_time_ms` | <span style='color: green'>(-1 [-1.3%])</span> 60.18 | <span style='color: green'>(-3 [-1.3%])</span> 240.72 | <span style='color: green'>(-3 [-4.1%])</span> 70.30 |  53.76 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+1 [+3.7%])</span> 16.12 | <span style='color: red'>(+2 [+3.7%])</span> 64.50 | <span style='color: red'>(+1 [+5.1%])</span> 18.88 | <span style='color: green'>(-0 [-2.9%])</span> 13.53 |
| `pcs_opening_time_ms ` | <span style='color: green'>(-2 [-4.5%])</span> 53.50 | <span style='color: green'>(-10 [-4.5%])</span> 214 | <span style='color: green'>(-1 [-1.7%])</span> 57 | <span style='color: green'>(-6 [-11.3%])</span> 47 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 557 | 1 | 36 | 4,137,502 | 112.59 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 171 | 698 | 23,446,148 | 150,778,428 | 171 | 298 | 0 | 62.21 | 18.88 | 5 | 71.82 | 57 | 103 | 56 | 4 | 56 | 10,899,170 | 30 | 57 | 1,103,000 | 31.17 | 22 | 81 | 1 | 56 | 
| regex_program | 1 | 177 | 520 | 11,598,276 | 128,513,066 | 177 | 256 | 1 | 53.76 | 15.53 | 4 | 65.07 | 47 | 88 | 47 | 0 | 50 | 2,196,106 | 23 | 44 | 1,104,000 | 33.20 | 17 | 69 | 0 | 47 | 
| regex_program | 2 | 176 | 535 | 11,579,064 | 128,513,066 | 176 | 272 | 1 | 54.45 | 16.56 | 4 | 66.12 | 54 | 95 | 54 | 0 | 49 | 2,177,334 | 29 | 45 | 1,104,000 | 32.84 | 17 | 71 | 0 | 54 | 
| regex_program | 3 | 195 | 557 | 11,853,872 | 103,456,394 | 195 | 286 | 0 | 70.30 | 13.53 | 5 | 55.84 | 56 | 94 | 56 | 0 | 50 | 2,422,606 | 35 | 35 | 826,502 | 31.79 | 19 | 84 | 1 | 56 | 

...
|:---|---:|---:|---:|
| Total |  4.74 |  2.45 |  2.45 |
| app_proof |  3.33 |  1.05 |  1.05 |
| leaf |  0.70 |  0.70 |  0.70 |
...
| `total_proof_time_ms ` |  816.50 |  3,266 |  979 |  592 |
...
| `execute_preflight_time_ms` |  83 |  332 |  103 |  43 |
| `execute_preflight_insn_mi/s` |  49.39 | -          |  50.51 |  46.48 |
| `trace_gen_time_ms   ` |  160 |  640 |  194 |  142 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  502.75 |  2,011 |  577 |  313 |
| `prover.main_trace_commit_time_ms` |  104 |  416 |  118 |  62 |
| `prover.rap_constraints_time_ms` |  292 |  1,168 |  335 |  180 |
| `prover.openings_time_ms` |  105.25 |  421 |  122 |  70 |
| `prover.rap_constraints.logup_gkr_time_ms` |  208.75 |  835 |  238 |  125 |
| `prover.rap_constraints.round0_time_ms` |  56.75 |  227 |  68 |  36 |
| `prover.rap_constraints.mle_rounds_time_ms` |  25.75 |  103 |  29 |  18 |
| `prover.openings.stacked_reduction_time_ms` |  19.75 |  79 |  22 |  13 |
...
| `prover.rap_constraints_time_ms` |  194 |  194 |  194 |  194 |
| `prover.openings_time_ms` |  196 |  196 |  196 |  196 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/f5c3a4553d95c5278e5d2c9be5fea99c5cb945a6/fibonacci-f5c3a4553d95c5278e5d2c9be5fea99c5cb945a6.memory.svg)
...
| app_proof |  |  |  |  |  | 592 |  |  | 67 | 12,000,265 | 178.58 | 0 | 3,340 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 20 | 364 | 19 | 5 | 1 | 2 | 1 | 1 | 
| internal_recursive.0 | 1 | 11 | 189 | 11 | 1 | 0 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 11 | 156 | 11 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 65 | 699 | 65 | 25 | 5 | 1 | 1 | 1 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 344 | 124 | 0 | 0 | 114 | 37 | 37 | 53 | 22 | 0 | 105 | 91 | 14 | 4 | 10 | 124 | 114 | 0 | 4 | 20 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 177 | 51 | 0 | 0 | 69 | 26 | 26 | 28 | 14 | 0 | 56 | 47 | 8 | 1 | 6 | 51 | 69 | 0 | 3 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 144 | 34 | 0 | 0 | 65 | 25 | 24 | 25 | 14 | 0 | 44 | 37 | 7 | 1 | 5 | 34 | 65 | 0 | 3 | 13 | 0 | 0 | 
| leaf | 0 | prover | 147,934,254 | 634 | 243 | 0 | 0 | 194 | 92 | 91 | 54 | 47 | 0 | 196 | 170 | 25 | 12 | 12 | 243 | 194 | 0 | 9 | 46 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 136,618,054 | 577 | 118 | 0 | 0 | 335 | 68 | 67 | 29 | 238 | 0 | 122 | 99 | 22 | 12 | 10 | 118 | 335 | 0 | 4 | 237 | 0 | 0 | 
| app_proof | prover | 1 | 136,570,716 | 564 | 118 | 0 | 0 | 329 | 63 | 62 | 28 | 237 | 0 | 116 | 94 | 22 | 12 | 9 | 118 | 329 | 0 | 4 | 236 | 0 | 0 | 
| app_proof | prover | 2 | 136,570,716 | 557 | 118 | 0 | 0 | 324 | 60 | 60 | 28 | 235 | 0 | 113 | 91 | 22 | 12 | 9 | 118 | 324 | 0 | 4 | 235 | 0 | 0 | 
| app_proof | prover | 3 | 70,295,004 | 313 | 62 | 0 | 0 | 180 | 36 | 36 | 18 | 125 | 0 | 70 | 56 | 13 | 6 | 6 | 62 | 180 | 0 | 4 | 124 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 157 | 979 | 157 | 154 | 2,770,197,065 | 323,292,691 | 3,093,489,756 | 2,097,152 | 0 | 4 | 89 | 3,495,000 | 46.48 | 
| app_proof | 1 | 142 | 851 | 142 | 41 | 2,768,862,357 | 322,353,414 | 3,091,215,771 | 2,097,152 | 0 | 2 | 103 | 3,495,000 | 50.38 | 
| app_proof | 2 | 147 | 844 | 147 | 41 | 2,768,862,357 | 322,353,414 | 3,091,215,771 | 2,097,152 | 0 | 2 | 97 | 3,495,000 | 50.51 | 
| app_proof | 3 | 194 | 592 | 194 | 41 | 1,230,956,171 | 342,871,578 | 1,573,827,749 | 2,097,152 | 0 | 2 | 43 | 1,515,265 | 50.18 | 

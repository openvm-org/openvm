...
|:---|---:|---:|---:|
| Total |  4.52 |  2.35 |  2.35 |
| app_proof |  3.16 |  0.100 |  0.100 |
| leaf |  0.68 |  0.68 |  0.68 |
...
| `total_proof_time_ms ` |  773.25 |  3,093 |  928 |  559 |
| `execute_metered_time_ms` |  67 | -          | -          | -          |
| `execute_metered_insns` |  12,000,265 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  176.56 | -          |  176.56 |  176.56 |
| `execute_preflight_insns` |  3,000,066.25 |  12,000,265 |  3,495,000 |  1,515,265 |
| `execute_preflight_time_ms` |  84.25 |  337 |  104 |  43 |
| `execute_preflight_insn_mi/s` |  47.94 | -          |  48.94 |  45.31 |
| `trace_gen_time_ms   ` |  141.50 |  566 |  177 |  124 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  476.25 |  1,905 |  542 |  297 |
| `prover.main_trace_commit_time_ms` |  99.50 |  398 |  113 |  59 |
| `prover.rap_constraints_time_ms` |  274.75 |  1,099 |  313 |  170 |
| `prover.openings_time_ms` |  100.75 |  403 |  115 |  66 |
| `prover.rap_constraints.logup_gkr_time_ms` |  197.25 |  789 |  224 |  119 |
| `prover.rap_constraints.round0_time_ms` |  52 |  208 |  60 |  33 |
...
| `prover.openings.whir_time_ms` |  81.75 |  327 |  94 |  54 |
...
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  611 |  611 |  611 |  611 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/279227c4c3d4577701b1b4a2e0bef0bcbf4e0c89/fibonacci-279227c4c3d4577701b1b4a2e0bef0bcbf4e0c89.memory.svg)
...
| app_proof |  |  |  |  |  | 559 |  |  | 67 | 12,000,265 | 176.56 | 0 | 3,169 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 323 | 118 | 0 | 0 | 107 | 35 | 34 | 51 | 20 | 0 | 97 | 83 | 13 | 3 | 9 | 118 | 107 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 172 | 47 | 0 | 0 | 67 | 25 | 24 | 28 | 14 | 0 | 56 | 47 | 8 | 1 | 6 | 47 | 67 | 0 | 3 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 141 | 32 | 0 | 0 | 62 | 24 | 23 | 24 | 13 | 0 | 44 | 37 | 7 | 1 | 5 | 33 | 62 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 147,934,254 | 611 | 234 | 0 | 0 | 184 | 85 | 84 | 54 | 45 | 0 | 191 | 166 | 24 | 12 | 12 | 235 | 184 | 0 | 8 | 44 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 136,618,054 | 542 | 113 | 0 | 0 | 313 | 60 | 60 | 27 | 224 | 0 | 115 | 94 | 21 | 11 | 9 | 113 | 313 | 0 | 3 | 223 | 0 | 0 | 
| app_proof | prover | 1 | 136,570,716 | 533 | 113 | 0 | 0 | 307 | 57 | 57 | 26 | 223 | 0 | 112 | 91 | 21 | 12 | 9 | 113 | 307 | 0 | 3 | 222 | 0 | 0 | 
| app_proof | prover | 2 | 136,570,716 | 533 | 113 | 0 | 0 | 309 | 58 | 57 | 27 | 223 | 0 | 110 | 88 | 21 | 12 | 9 | 113 | 309 | 0 | 3 | 223 | 0 | 0 | 
| app_proof | prover | 3 | 70,295,004 | 297 | 59 | 0 | 0 | 170 | 33 | 33 | 17 | 119 | 0 | 66 | 54 | 12 | 6 | 6 | 59 | 170 | 0 | 3 | 118 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 138 | 928 | 138 | 156 | 2,770,197,065 | 323,292,691 | 3,093,489,756 | 2,097,152 | 0 | 3 | 90 | 3,495,000 | 45.31 | 
| app_proof | 1 | 124 | 804 | 124 | 41 | 2,768,862,357 | 322,353,414 | 3,091,215,771 | 2,097,152 | 0 | 2 | 104 | 3,495,000 | 48.80 | 
| app_proof | 2 | 127 | 802 | 127 | 41 | 2,768,862,357 | 322,353,414 | 3,091,215,771 | 2,097,152 | 0 | 2 | 100 | 3,495,000 | 48.71 | 
| app_proof | 3 | 177 | 559 | 177 | 41 | 1,230,956,171 | 342,871,578 | 1,573,827,749 | 2,097,152 | 0 | 2 | 43 | 1,515,265 | 48.94 | 

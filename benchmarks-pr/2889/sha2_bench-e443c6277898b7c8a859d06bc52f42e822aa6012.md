...
|:---|---:|---:|---:|
| Total |  12.13 |  3.50 |  3.50 |
| app_proof |  9.95 |  1.80 |  1.80 |
| leaf |  1.43 |  0.95 |  0.95 |
...
| `total_proof_time_ms ` |  1,635.83 |  9,815 |  1,665 |  1,586 |
...
| `execute_preflight_time_ms` |  121 |  726 |  152 |  83 |
| `execute_preflight_insn_mi/s` |  41.69 | -          |  42.25 |  39.73 |
| `trace_gen_time_ms   ` |  157.50 |  945 |  190 |  135 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,219.33 |  7,316 |  1,245 |  1,181 |
| `prover.main_trace_commit_time_ms` |  280.33 |  1,682 |  281 |  280 |
| `prover.rap_constraints_time_ms` |  854.83 |  5,129 |  878 |  814 |
| `prover.openings_time_ms` |  83.33 |  500 |  86 |  79 |
| `prover.rap_constraints.logup_gkr_time_ms` |  286.17 |  1,717 |  303 |  236 |
| `prover.rap_constraints.round0_time_ms` |  436 |  2,616 |  450 |  378 |
| `prover.rap_constraints.mle_rounds_time_ms` |  131.50 |  789 |  134 |  128 |
| `prover.openings.stacked_reduction_time_ms` |  52.67 |  316 |  54 |  52 |
| `prover.openings.stacked_reduction.round0_time_ms` |  30.67 |  184 |  31 |  30 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  21.67 |  130 |  22 |  21 |
| `prover.openings.whir_time_ms` |  30.17 |  181 |  32 |  27 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  716.50 |  1,433 |  950 |  483 |
| `execute_preflight_time_ms` |  2 |  4 |  2 |  2 |
| `trace_gen_time_ms   ` |  74.50 |  149 |  101 |  48 |
| `generate_blob_total_time_ms` |  9.50 |  19 |  13 |  6 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  642 |  1,284 |  849 |  435 |
| `prover.main_trace_commit_time_ms` |  356 |  712 |  494 |  218 |
| `prover.rap_constraints_time_ms` |  219 |  438 |  275 |  163 |
...
| `prover.main_trace_commit_time_ms` |  220 |  220 |  220 |  220 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/e443c6277898b7c8a859d06bc52f42e822aa6012/sha2_bench-e443c6277898b7c8a859d06bc52f42e822aa6012.memory.svg)
...
| app_proof |  |  |  |  |  | 1,634 |  |  | 137 | 14,793,960 | 107.55 | 0 | 9,960 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 32 | 459 | 31 | 11 | 2 | 2 | 1 | 1 | 
| internal_recursive.0 | 1 | 12 | 162 | 12 | 2 | 1 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 9 | 126 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 101 | 950 | 101 | 36 | 13 | 2 | 3 | 3 | 
| leaf | 1 | 48 | 483 | 48 | 18 | 6 | 2 | 3 | 3 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 75,647,988 | 427 | 220 | 0 | 1 | 161 | 45 | 45 | 84 | 30 | 0 | 45 | 23 | 22 | 6 | 15 | 220 | 161 | 0 | 3 | 29 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,943 | 149 | 49 | 0 | 0 | 72 | 24 | 24 | 29 | 18 | 0 | 28 | 19 | 8 | 1 | 6 | 49 | 72 | 0 | 2 | 16 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 116 | 30 | 0 | 0 | 61 | 23 | 22 | 24 | 13 | 0 | 24 | 16 | 7 | 1 | 5 | 31 | 61 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 266,554,214 | 849 | 494 | 0 | 93 | 275 | 125 | 124 | 77 | 72 | 0 | 78 | 38 | 40 | 21 | 18 | 494 | 275 | 0 | 6 | 70 | 0 | 0 | 
| leaf | 1 | prover | 135,243,508 | 435 | 218 | 0 | 1 | 163 | 71 | 70 | 47 | 44 | 0 | 53 | 30 | 22 | 11 | 11 | 218 | 163 | 0 | 6 | 43 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 353,899,717 | 1,181 | 279 | 0 | 1 | 814 | 378 | 378 | 132 | 303 | 75 | 86 | 32 | 54 | 31 | 22 | 280 | 814 | 0 | 3 | 226 | 0 | 0 | 
| app_proof | prover | 1 | 353,899,532 | 1,240 | 280 | 0 | 1 | 878 | 449 | 449 | 131 | 296 | 74 | 82 | 29 | 52 | 31 | 21 | 280 | 878 | 0 | 3 | 221 | 0 | 0 | 
| app_proof | prover | 2 | 353,899,532 | 1,244 | 281 | 0 | 1 | 878 | 450 | 450 | 132 | 295 | 74 | 84 | 31 | 52 | 31 | 21 | 281 | 878 | 0 | 3 | 219 | 0 | 0 | 
| app_proof | prover | 3 | 353,899,532 | 1,183 | 280 | 0 | 1 | 818 | 449 | 449 | 132 | 236 | 0 | 84 | 30 | 53 | 31 | 22 | 280 | 818 | 0 | 4 | 235 | 0 | 0 | 
| app_proof | prover | 4 | 353,899,532 | 1,245 | 281 | 0 | 1 | 878 | 449 | 449 | 134 | 294 | 75 | 85 | 32 | 53 | 30 | 22 | 281 | 878 | 0 | 4 | 218 | 0 | 0 | 
| app_proof | prover | 5 | 353,980,012 | 1,223 | 280 | 0 | 1 | 863 | 441 | 440 | 128 | 293 | 75 | 79 | 27 | 52 | 30 | 22 | 280 | 863 | 0 | 3 | 217 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 159 | 1,586 | 159 | 161 | 0 | 3 | 83 | 2,623,000 | 39.73 | 
| app_proof | 1 | 135 | 1,665 | 135 | 136 | 0 | 2 | 152 | 2,625,000 | 41.71 | 
| app_proof | 2 | 154 | 1,663 | 154 | 130 | 0 | 2 | 134 | 2,625,000 | 42.19 | 
| app_proof | 3 | 153 | 1,603 | 153 | 130 | 0 | 2 | 134 | 2,625,000 | 42.25 | 
| app_proof | 4 | 154 | 1,664 | 154 | 130 | 0 | 2 | 134 | 2,625,000 | 42.23 | 
| app_proof | 5 | 190 | 1,634 | 190 | 130 | 0 | 2 | 89 | 1,670,960 | 42.06 | 

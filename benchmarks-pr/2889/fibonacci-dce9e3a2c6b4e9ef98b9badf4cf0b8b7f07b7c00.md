...
| `total_proof_time_ms ` |  766.25 |  3,065 |  922 |  554 |
| `execute_metered_time_ms` |  67 | -          | -          | -          |
| `execute_metered_insns` |  12,000,265 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  178.12 | -          |  178.12 |  178.12 |
| `execute_preflight_insns` |  3,000,066.25 |  12,000,265 |  3,495,000 |  1,515,265 |
| `execute_preflight_time_ms` |  84 |  336 |  104 |  43 |
| `execute_preflight_insn_mi/s` |  47.80 | -          |  48.90 |  45.22 |
| `trace_gen_time_ms   ` |  140.75 |  563 |  175 |  123 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  470.75 |  1,883 |  537 |  294 |
| `prover.main_trace_commit_time_ms` |  98.50 |  394 |  112 |  60 |
| `prover.rap_constraints_time_ms` |  270.75 |  1,083 |  310 |  168 |
| `prover.openings_time_ms` |  100.75 |  403 |  116 |  66 |
| `prover.rap_constraints.logup_gkr_time_ms` |  194.75 |  779 |  222 |  117 |
...
| `prover.openings.whir_time_ms` |  81.75 |  327 |  95 |  53 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/dce9e3a2c6b4e9ef98b9badf4cf0b8b7f07b7c00/fibonacci-dce9e3a2c6b4e9ef98b9badf4cf0b8b7f07b7c00.memory.svg)
...
| app_proof |  |  |  |  |  | 554 |  |  | 67 | 12,000,265 | 178.12 | 0 | 3,139 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 329 | 117 | 0 | 0 | 106 | 34 | 34 | 51 | 20 | 0 | 104 | 90 | 13 | 3 | 9 | 118 | 106 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 167 | 47 | 0 | 0 | 67 | 25 | 24 | 28 | 14 | 0 | 52 | 44 | 8 | 1 | 6 | 47 | 67 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 139 | 32 | 0 | 0 | 62 | 23 | 22 | 24 | 14 | 0 | 44 | 36 | 7 | 1 | 5 | 33 | 62 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 147,934,254 | 610 | 233 | 0 | 0 | 183 | 85 | 84 | 53 | 44 | 0 | 193 | 168 | 24 | 12 | 12 | 233 | 183 | 0 | 8 | 44 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 136,618,054 | 537 | 110 | 0 | 0 | 310 | 59 | 59 | 27 | 222 | 0 | 116 | 95 | 21 | 11 | 9 | 110 | 310 | 0 | 3 | 221 | 0 | 0 | 
| app_proof | prover | 1 | 136,570,716 | 529 | 112 | 0 | 0 | 303 | 55 | 55 | 27 | 220 | 0 | 113 | 92 | 21 | 11 | 9 | 112 | 303 | 0 | 3 | 220 | 0 | 0 | 
| app_proof | prover | 2 | 136,570,716 | 523 | 112 | 0 | 0 | 302 | 54 | 54 | 27 | 220 | 0 | 108 | 87 | 20 | 11 | 8 | 112 | 302 | 0 | 3 | 220 | 0 | 0 | 
| app_proof | prover | 3 | 70,295,004 | 294 | 60 | 0 | 0 | 168 | 32 | 32 | 17 | 117 | 0 | 66 | 53 | 12 | 6 | 6 | 60 | 168 | 0 | 3 | 116 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 137 | 922 | 137 | 156 | 2,770,197,065 | 323,292,691 | 3,093,489,756 | 2,097,152 | 0 | 3 | 91 | 3,495,000 | 45.22 | 
| app_proof | 1 | 123 | 798 | 123 | 41 | 2,768,862,357 | 322,353,414 | 3,091,215,771 | 2,097,152 | 0 | 1 | 104 | 3,495,000 | 48.30 | 
| app_proof | 2 | 128 | 791 | 128 | 41 | 2,768,862,357 | 322,353,414 | 3,091,215,771 | 2,097,152 | 0 | 1 | 98 | 3,495,000 | 48.90 | 
| app_proof | 3 | 175 | 554 | 175 | 41 | 1,230,956,171 | 342,871,578 | 1,573,827,749 | 2,097,152 | 0 | 2 | 43 | 1,515,265 | 48.78 | 

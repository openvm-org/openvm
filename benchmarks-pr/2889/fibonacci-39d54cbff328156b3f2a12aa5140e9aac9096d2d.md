...
| `total_proof_time_ms ` |  768.50 |  3,074 |  926 |  556 |
| `execute_metered_time_ms` |  68 | -          | -          | -          |
| `execute_metered_insns` |  12,000,265 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  176.43 | -          |  176.43 |  176.43 |
| `execute_preflight_insns` |  3,000,066.25 |  12,000,265 |  3,495,000 |  1,515,265 |
| `execute_preflight_time_ms` |  83.25 |  333 |  102 |  43 |
| `execute_preflight_insn_mi/s` |  48.78 | -          |  49.95 |  45.44 |
| `trace_gen_time_ms   ` |  140.50 |  562 |  175 |  123 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  473.25 |  1,893 |  541 |  296 |
| `prover.main_trace_commit_time_ms` |  98.75 |  395 |  113 |  59 |
| `prover.rap_constraints_time_ms` |  273.75 |  1,095 |  312 |  170 |
| `prover.openings_time_ms` |  100 |  400 |  116 |  66 |
| `prover.rap_constraints.logup_gkr_time_ms` |  196.75 |  787 |  223 |  118 |
| `prover.rap_constraints.round0_time_ms` |  51.50 |  206 |  61 |  33 |
...
| `prover.openings.whir_time_ms` |  80.75 |  323 |  94 |  53 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  684 |  684 |  684 |  684 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/39d54cbff328156b3f2a12aa5140e9aac9096d2d/fibonacci-39d54cbff328156b3f2a12aa5140e9aac9096d2d.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 73 |  |  |  | 352 |  |  |  |  |  |  | 
| app_proof |  |  |  | 556 |  | 68 | 12,000,265 | 176.43 | 0 | 3,149 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 328 | 117 | 0 | 0 | 107 | 35 | 34 | 51 | 20 | 0 | 102 | 89 | 13 | 3 | 9 | 118 | 117 | 107 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 172 | 47 | 0 | 0 | 67 | 25 | 24 | 28 | 14 | 0 | 56 | 48 | 8 | 1 | 6 | 47 | 47 | 67 | 0 | 3 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 139 | 31 | 0 | 0 | 64 | 24 | 24 | 24 | 14 | 0 | 43 | 36 | 7 | 1 | 5 | 32 | 31 | 64 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 147,934,254 | 614 | 234 | 0 | 0 | 184 | 84 | 83 | 53 | 45 | 0 | 196 | 171 | 24 | 12 | 12 | 234 | 234 | 184 | 0 | 8 | 44 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 136,618,054 | 541 | 113 | 0 | 0 | 312 | 61 | 60 | 27 | 223 | 0 | 116 | 94 | 22 | 12 | 9 | 113 | 113 | 312 | 0 | 3 | 221 | 0 | 0 | 
| app_proof | prover | 1 | 136,570,716 | 529 | 112 | 0 | 0 | 306 | 56 | 56 | 27 | 223 | 0 | 110 | 89 | 20 | 11 | 8 | 112 | 112 | 306 | 0 | 3 | 222 | 0 | 0 | 
| app_proof | prover | 2 | 136,570,716 | 527 | 111 | 0 | 0 | 307 | 56 | 56 | 27 | 223 | 0 | 108 | 87 | 21 | 12 | 9 | 111 | 111 | 307 | 0 | 3 | 222 | 0 | 0 | 
| app_proof | prover | 3 | 70,295,004 | 296 | 59 | 0 | 0 | 170 | 33 | 33 | 17 | 118 | 0 | 66 | 53 | 12 | 6 | 6 | 59 | 59 | 170 | 0 | 3 | 117 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 157 | 136 | 926 | 136 | 157 | 2,770,197,065 | 323,292,691 | 3,093,489,756 | 2,097,152 | 0 | 3 | 90 | 3,495,000 | 45.44 | 
| app_proof | 1 | 41 | 123 | 797 | 123 | 41 | 2,768,862,357 | 322,353,414 | 3,091,215,771 | 2,097,152 | 0 | 1 | 102 | 3,495,000 | 49.88 | 
| app_proof | 2 | 41 | 128 | 795 | 128 | 41 | 2,768,862,357 | 322,353,414 | 3,091,215,771 | 2,097,152 | 0 | 1 | 98 | 3,495,000 | 49.86 | 
| app_proof | 3 | 41 | 175 | 556 | 175 | 41 | 1,230,956,171 | 342,871,578 | 1,573,827,749 | 2,097,152 | 0 | 2 | 43 | 1,515,265 | 49.95 | 

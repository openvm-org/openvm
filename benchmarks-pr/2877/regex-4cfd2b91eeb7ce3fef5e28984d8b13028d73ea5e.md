...
| `total_proof_time_ms ` |  759 |  1,518 |  819 |  699 |
| `execute_metered_time_ms` |  33 | -          | -          | -          |
| `execute_metered_insns` |  4,137,067 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  122.99 | -          |  122.99 |  122.99 |
| `execute_preflight_insns` |  2,068,533.50 |  4,137,067 |  2,208,000 |  1,929,067 |
| `execute_preflight_time_ms` |  78 |  156 |  84 |  72 |
| `execute_preflight_insn_mi/s` |  37.27 | -          |  37.95 |  36.58 |
| `trace_gen_time_ms   ` |  149.50 |  299 |  153 |  146 |
...
| `prover.rap_constraints_time_ms` |  237 |  474 |  249 |  225 |
| `prover.openings_time_ms` |  97 |  194 |  102 |  92 |
| `prover.rap_constraints.logup_gkr_time_ms` |  138 |  276 |  140 |  136 |
...
| `prover.openings.whir_time_ms` |  78 |  156 |  82 |  74 |
...
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  382 |  382 |  382 |  382 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/4cfd2b91eeb7ce3fef5e28984d8b13028d73ea5e/regex-4cfd2b91eeb7ce3fef5e28984d8b13028d73ea5e.memory.svg)
...
| app_proof |  |  |  |  |  | 699 |  |  | 33 | 4,137,067 | 122.99 | 0 | 1,565 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 27,256,635 | 262 | 82 | 0 | 0 | 98 | 32 | 32 | 45 | 20 | 0 | 80 | 69 | 11 | 2 | 8 | 82 | 98 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,767 | 169 | 46 | 0 | 0 | 68 | 25 | 25 | 28 | 14 | 0 | 53 | 44 | 8 | 1 | 6 | 46 | 68 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 138 | 32 | 0 | 0 | 61 | 23 | 22 | 24 | 13 | 0 | 43 | 36 | 7 | 1 | 5 | 33 | 61 | 0 | 2 | 13 | 0 | 0 | 
| leaf | 0 | prover | 79,959,796 | 382 | 129 | 0 | 0 | 136 | 55 | 54 | 38 | 42 | 0 | 116 | 101 | 15 | 6 | 8 | 129 | 136 | 0 | 6 | 41 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 123,384,338 | 428 | 99 | 0 | 0 | 225 | 56 | 55 | 29 | 140 | 0 | 102 | 82 | 20 | 10 | 9 | 100 | 225 | 0 | 3 | 137 | 0 | 0 | 
| app_proof | prover | 1 | 106,568,591 | 432 | 89 | 0 | 0 | 249 | 86 | 86 | 25 | 136 | 0 | 92 | 74 | 18 | 8 | 9 | 90 | 249 | 0 | 3 | 135 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 146 | 819 | 146 | 159 | 2,052,973,566 | 668,936,290 | 2,721,909,856 | 2,097,152 | 3 | 7 | 84 | 2,208,000 | 36.58 | 
| app_proof | 1 | 153 | 699 | 153 | 41 | 1,584,899,101 | 646,500,736 | 2,231,399,837 | 2,097,152 | 0 | 2 | 72 | 1,929,067 | 37.95 | 

...
|:---|---:|---:|---:|
| Total |  6.02 |  2.22 |  2.21 |
| app_proof |  4.06 |  0.75 |  0.75 |
| leaf |  1.17 |  0.67 |  0.67 |
...
| `total_proof_time_ms ` |  570.43 |  3,993 |  681 |  547 |
| `execute_metered_time_ms` |  67 | -          | -          | -          |
| `execute_metered_insns` |  12,000,265 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  176.50 | -          |  176.50 |  176.50 |
| `execute_preflight_insns` |  1,714,323.57 |  12,000,265 |  1,747,000 |  1,518,265 |
| `execute_preflight_time_ms` |  49.71 |  348 |  54 |  43 |
| `execute_preflight_insn_mi/s` |  50.16 | -          |  50.29 |  49.96 |
| `trace_gen_time_ms   ` |  169.14 |  1,184 |  176 |  165 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  292.14 |  2,045 |  299 |  286 |
| `prover.main_trace_commit_time_ms` |  58.86 |  412 |  60 |  57 |
| `prover.rap_constraints_time_ms` |  166.14 |  1,163 |  172 |  161 |
| `prover.openings_time_ms` |  66.43 |  465 |  67 |  65 |
| `prover.rap_constraints.logup_gkr_time_ms` |  115.14 |  806 |  119 |  111 |
| `prover.rap_constraints.round0_time_ms` |  32.86 |  230 |  36 |  32 |
...
| `prover.openings.whir_time_ms` |  54 |  378 |  55 |  53 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  583.50 |  1,167 |  671 |  496 |
| `execute_preflight_time_ms` |  1 |  2 |  1 |  1 |
| `trace_gen_time_ms   ` |  51 |  102 |  64 |  38 |
| `generate_blob_total_time_ms` |  2.50 |  5 |  3 |  2 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  532 |  1,064 |  607 |  457 |
| `prover.main_trace_commit_time_ms` |  195.50 |  391 |  232 |  159 |
| `prover.rap_constraints_time_ms` |  165.50 |  331 |  183 |  148 |
| `prover.openings_time_ms` |  169.50 |  339 |  190 |  149 |
| `prover.rap_constraints.logup_gkr_time_ms` |  38 |  76 |  44 |  32 |
| `prover.rap_constraints.round0_time_ms` |  78 |  156 |  86 |  70 |
...
| `prover.openings.whir_time_ms` |  149 |  298 |  166 |  132 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/3a76cddb3cfd6b2ef00ef159f9c18b72082b4fdc/fibonacci-3a76cddb3cfd6b2ef00ef159f9c18b72082b4fdc.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 66 | 9 |  |  | 0 |  | 337 | 9 |  |  |  |  |  |  | 
| app_proof |  |  |  |  |  | 553 |  |  | 67 | 12,000,265 | 176.50 | 0 | 4,071 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 29 | 462 | 29 | 9 | 1 | 2 | 1 | 1 | 
| internal_recursive.0 | 1 | 12 | 189 | 12 | 1 | 0 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 9 | 145 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 64 | 671 | 64 | 23 | 3 | 1 | 1 | 1 | 
| leaf | 1 | 38 | 496 | 38 | 17 | 2 | 1 | 1 | 1 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 53,005,300 | 432 | 160 | 0 | 0 | 144 | 42 | 41 | 73 | 28 | 0 | 127 | 110 | 17 | 5 | 12 | 160 | 144 | 0 | 3 | 28 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,767 | 177 | 47 | 0 | 0 | 67 | 24 | 23 | 28 | 14 | 0 | 62 | 53 | 8 | 1 | 6 | 47 | 67 | 0 | 3 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 135 | 32 | 0 | 0 | 60 | 22 | 22 | 24 | 13 | 0 | 42 | 35 | 7 | 1 | 5 | 32 | 60 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 147,934,246 | 607 | 232 | 0 | 0 | 183 | 86 | 85 | 52 | 44 | 0 | 190 | 166 | 24 | 12 | 11 | 232 | 183 | 0 | 8 | 43 | 0 | 0 | 
| leaf | 1 | prover | 98,728,630 | 457 | 159 | 0 | 0 | 148 | 70 | 69 | 44 | 32 | 0 | 149 | 132 | 17 | 8 | 9 | 159 | 148 | 0 | 7 | 31 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 70,295,622 | 299 | 59 | 0 | 0 | 172 | 36 | 35 | 18 | 118 | 0 | 67 | 54 | 13 | 6 | 6 | 59 | 172 | 0 | 3 | 117 | 0 | 0 | 
| app_proof | prover | 1 | 70,248,284 | 292 | 59 | 0 | 0 | 166 | 32 | 32 | 17 | 116 | 0 | 66 | 54 | 12 | 6 | 5 | 59 | 166 | 0 | 3 | 115 | 0 | 0 | 
| app_proof | prover | 2 | 70,248,284 | 289 | 59 | 0 | 0 | 165 | 32 | 31 | 17 | 115 | 0 | 65 | 53 | 12 | 6 | 5 | 59 | 165 | 0 | 3 | 115 | 0 | 0 | 
| app_proof | prover | 3 | 70,248,284 | 295 | 59 | 0 | 0 | 169 | 32 | 32 | 17 | 119 | 0 | 66 | 53 | 12 | 6 | 5 | 59 | 169 | 0 | 3 | 117 | 0 | 0 | 
| app_proof | prover | 4 | 70,248,284 | 286 | 56 | 0 | 0 | 161 | 33 | 32 | 17 | 111 | 0 | 67 | 55 | 12 | 6 | 5 | 57 | 161 | 0 | 3 | 110 | 0 | 0 | 
| app_proof | prover | 5 | 70,248,284 | 292 | 59 | 0 | 0 | 165 | 33 | 33 | 17 | 113 | 0 | 67 | 55 | 12 | 6 | 5 | 59 | 165 | 0 | 3 | 113 | 0 | 0 | 
| app_proof | prover | 6 | 70,295,004 | 292 | 59 | 0 | 0 | 165 | 32 | 32 | 17 | 114 | 0 | 67 | 54 | 12 | 6 | 6 | 60 | 165 | 0 | 3 | 114 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 165 | 681 | 165 | 161 | 1,411,127,546 | 162,713,442 | 1,573,840,988 | 2,097,152 | 0 | 3 | 54 | 1,747,000 | 49.96 | 
| app_proof | 1 | 166 | 551 | 166 | 41 | 1,409,791,968 | 161,775,035 | 1,571,567,003 | 2,097,152 | 0 | 1 | 51 | 1,747,000 | 50.04 | 
| app_proof | 2 | 169 | 550 | 169 | 41 | 1,409,792,265 | 161,774,738 | 1,571,567,003 | 2,097,152 | 0 | 1 | 50 | 1,747,000 | 50.29 | 
| app_proof | 3 | 169 | 556 | 169 | 40 | 1,409,792,837 | 161,774,166 | 1,571,567,003 | 2,097,152 | 0 | 1 | 50 | 1,747,000 | 50.28 | 
| app_proof | 4 | 167 | 547 | 167 | 41 | 1,409,791,968 | 161,775,035 | 1,571,567,003 | 2,097,152 | 0 | 1 | 51 | 1,747,000 | 50.17 | 
| app_proof | 5 | 172 | 555 | 172 | 41 | 1,409,792,265 | 161,774,738 | 1,571,567,003 | 2,097,152 | 0 | 2 | 49 | 1,747,000 | 50.14 | 
| app_proof | 6 | 176 | 553 | 176 | 41 | 1,233,288,671 | 340,539,078 | 1,573,827,749 | 2,097,152 | 0 | 1 | 43 | 1,518,265 | 50.26 | 

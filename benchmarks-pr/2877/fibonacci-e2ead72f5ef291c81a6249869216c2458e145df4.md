...
|:---|---:|---:|---:|
| Total |  6.09 |  2.24 |  2.24 |
| app_proof |  4.11 |  0.76 |  0.76 |
| leaf |  1.17 |  0.68 |  0.68 |
...
| `total_proof_time_ms ` |  577.71 |  4,044 |  687 |  557 |
| `execute_metered_time_ms` |  68 | -          | -          | -          |
| `execute_metered_insns` |  12,000,265 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  174.62 | -          |  174.62 |  174.62 |
| `execute_preflight_insns` |  1,714,323.57 |  12,000,265 |  1,747,000 |  1,518,265 |
| `execute_preflight_time_ms` |  50.71 |  355 |  56 |  44 |
| `execute_preflight_insn_mi/s` |  50.35 | -          |  50.52 |  49.90 |
| `trace_gen_time_ms   ` |  169.86 |  1,189 |  176 |  166 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  297.71 |  2,084 |  302 |  295 |
| `prover.main_trace_commit_time_ms` |  59 |  413 |  59 |  59 |
| `prover.rap_constraints_time_ms` |  169.57 |  1,187 |  174 |  168 |
| `prover.openings_time_ms` |  68.14 |  477 |  70 |  67 |
| `prover.rap_constraints.logup_gkr_time_ms` |  117.14 |  820 |  118 |  116 |
| `prover.rap_constraints.round0_time_ms` |  33.43 |  234 |  37 |  32 |
| `prover.rap_constraints.mle_rounds_time_ms` |  17.86 |  125 |  18 |  17 |
...
| `prover.openings.whir_time_ms` |  55.14 |  386 |  57 |  54 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  586.50 |  1,173 |  682 |  491 |
| `execute_preflight_time_ms` |  1 |  2 |  1 |  1 |
| `trace_gen_time_ms   ` |  51 |  102 |  62 |  40 |
| `generate_blob_total_time_ms` |  2.50 |  5 |  3 |  2 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  535 |  1,070 |  620 |  450 |
| `prover.main_trace_commit_time_ms` |  196.50 |  393 |  235 |  158 |
| `prover.rap_constraints_time_ms` |  168 |  336 |  185 |  151 |
| `prover.openings_time_ms` |  169.50 |  339 |  199 |  140 |
| `prover.rap_constraints.logup_gkr_time_ms` |  39 |  78 |  45 |  33 |
| `prover.rap_constraints.round0_time_ms` |  78.50 |  157 |  86 |  71 |
| `prover.rap_constraints.mle_rounds_time_ms` |  50 |  100 |  54 |  46 |
...
| `prover.openings.whir_time_ms` |  148 |  296 |  174 |  122 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/e2ead72f5ef291c81a6249869216c2458e145df4/fibonacci-e2ead72f5ef291c81a6249869216c2458e145df4.memory.svg)
...
| app_proof |  |  |  |  |  | 560 |  |  | 68 | 12,000,265 | 174.62 | 0 | 4,122 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 29 | 470 | 29 | 10 | 1 | 2 | 1 | 1 | 
| internal_recursive.0 | 1 | 12 | 184 | 12 | 1 | 0 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 10 | 151 | 10 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 62 | 682 | 62 | 24 | 3 | 1 | 1 | 1 | 
| leaf | 1 | 40 | 491 | 40 | 18 | 2 | 1 | 1 | 1 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 53,005,300 | 440 | 160 | 0 | 0 | 149 | 42 | 42 | 76 | 29 | 0 | 130 | 113 | 17 | 5 | 12 | 160 | 148 | 0 | 3 | 28 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,767 | 171 | 47 | 0 | 0 | 68 | 25 | 24 | 28 | 14 | 0 | 55 | 46 | 8 | 1 | 6 | 47 | 68 | 0 | 3 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 140 | 33 | 0 | 0 | 63 | 24 | 23 | 25 | 14 | 0 | 43 | 35 | 7 | 1 | 5 | 33 | 63 | 0 | 2 | 13 | 0 | 0 | 
| leaf | 0 | prover | 147,934,246 | 620 | 234 | 0 | 0 | 185 | 86 | 85 | 54 | 45 | 0 | 199 | 174 | 24 | 12 | 12 | 235 | 185 | 0 | 9 | 44 | 0 | 0 | 
| leaf | 1 | prover | 98,728,630 | 450 | 158 | 0 | 0 | 151 | 71 | 70 | 46 | 33 | 0 | 140 | 122 | 18 | 8 | 9 | 158 | 151 | 0 | 7 | 32 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 70,295,622 | 302 | 59 | 0 | 0 | 174 | 37 | 37 | 18 | 117 | 0 | 68 | 55 | 13 | 6 | 6 | 59 | 174 | 0 | 3 | 116 | 0 | 0 | 
| app_proof | prover | 1 | 70,248,284 | 295 | 59 | 0 | 0 | 168 | 32 | 32 | 18 | 117 | 0 | 67 | 54 | 12 | 6 | 5 | 59 | 168 | 0 | 3 | 117 | 0 | 0 | 
| app_proof | prover | 2 | 70,248,284 | 295 | 59 | 0 | 0 | 168 | 33 | 32 | 18 | 117 | 0 | 67 | 54 | 12 | 6 | 5 | 59 | 168 | 0 | 3 | 116 | 0 | 0 | 
| app_proof | prover | 3 | 70,248,284 | 297 | 59 | 0 | 0 | 169 | 33 | 33 | 18 | 117 | 0 | 68 | 55 | 12 | 6 | 5 | 59 | 169 | 0 | 3 | 116 | 0 | 0 | 
| app_proof | prover | 4 | 70,248,284 | 299 | 59 | 0 | 0 | 169 | 33 | 33 | 18 | 116 | 0 | 70 | 57 | 12 | 6 | 6 | 59 | 168 | 0 | 3 | 116 | 0 | 0 | 
| app_proof | prover | 5 | 70,248,284 | 298 | 59 | 0 | 0 | 169 | 33 | 32 | 17 | 118 | 0 | 69 | 56 | 12 | 6 | 5 | 59 | 169 | 0 | 3 | 117 | 0 | 0 | 
| app_proof | prover | 6 | 70,295,004 | 298 | 59 | 0 | 0 | 170 | 33 | 33 | 18 | 118 | 0 | 68 | 55 | 12 | 6 | 6 | 59 | 170 | 0 | 3 | 117 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 166 | 687 | 166 | 162 | 1,411,127,546 | 162,713,442 | 1,573,840,988 | 2,097,152 | 0 | 3 | 56 | 1,747,000 | 49.90 | 
| app_proof | 1 | 167 | 557 | 167 | 41 | 1,409,791,968 | 161,775,035 | 1,571,567,003 | 2,097,152 | 0 | 2 | 52 | 1,747,000 | 50.50 | 
| app_proof | 2 | 170 | 558 | 170 | 41 | 1,409,792,265 | 161,774,738 | 1,571,567,003 | 2,097,152 | 0 | 2 | 51 | 1,747,000 | 50.45 | 
| app_proof | 3 | 170 | 559 | 170 | 41 | 1,409,792,837 | 161,774,166 | 1,571,567,003 | 2,097,152 | 0 | 2 | 50 | 1,747,000 | 50.52 | 
| app_proof | 4 | 170 | 562 | 170 | 41 | 1,409,791,968 | 161,775,035 | 1,571,567,003 | 2,097,152 | 0 | 2 | 51 | 1,747,000 | 50.35 | 
| app_proof | 5 | 170 | 561 | 170 | 41 | 1,409,792,265 | 161,774,738 | 1,571,567,003 | 2,097,152 | 0 | 1 | 51 | 1,747,000 | 50.50 | 
| app_proof | 6 | 176 | 560 | 176 | 41 | 1,233,288,671 | 340,539,078 | 1,573,827,749 | 2,097,152 | 0 | 2 | 44 | 1,518,265 | 50.23 | 

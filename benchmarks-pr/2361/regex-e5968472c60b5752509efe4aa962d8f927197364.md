...
|:---|---:|---:|---:|
| Total |  15.16 |  4.57 | 4.57 |
| regex_program |  15.16 |  4.57 |  4.57 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  3,781.50 |  15,126 |  4,530 |  3,093 |
...
| `execute_preflight_insn_mi/s` |  32.09 | -          |  32.59 |  30.97 |
| `trace_gen_time_ms   ` |  182 |  728 |  198 |  173 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  3,480 |  13,920 |  4,265 |  2,825 |
| `main_trace_commit_time_ms` |  52.75 |  211 |  57 |  51 |
| `generate_perm_trace_time_ms` |  71 |  284 |  103 |  56 |
| `perm_trace_commit_time_ms` |  64.86 |  259.45 |  71.37 |  56.26 |
| `quotient_poly_compute_time_ms` |  61.28 |  245.12 |  71.54 |  55.09 |
| `quotient_poly_commit_time_ms` |  16 |  64.01 |  18.17 |  13.75 |
| `pcs_opening_time_ms ` |  3,210.50 |  12,842 |  4,010 |  2,572 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 4,054 | 1 | 37 | 4,137,502 | 110.90 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 173 | 3,449 | 23,446,148 | 150,778,428 | 173 | 3,051 | 0 | 62.39 | 18.17 | 7 | 71.37 | 2,782 | 128 | 2,782 | 4 | 57 | 10,899,170 | 56 | 56 | 1,103,000 | 30.97 | 22 | 81 | 0 | 2,782 | 
| regex_program | 1 | 177 | 4,530 | 11,598,276 | 128,513,066 | 177 | 4,265 | 1 | 55.09 | 16.65 | 6 | 65.43 | 4,010 | 130 | 4,010 | 0 | 51 | 2,196,106 | 64 | 46 | 1,104,000 | 32.28 | 17 | 72 | 0 | 4,009 | 
| regex_program | 2 | 180 | 3,093 | 11,579,064 | 128,513,066 | 180 | 2,825 | 1 | 56.10 | 15.44 | 6 | 66.40 | 2,572 | 128 | 2,572 | 0 | 52 | 2,177,334 | 61 | 46 | 1,104,000 | 32.53 | 17 | 72 | 0 | 2,571 | 
| regex_program | 3 | 198 | 4,054 | 11,853,872 | 103,456,394 | 198 | 3,779 | 0 | 71.54 | 13.75 | 7 | 56.26 | 3,478 | 163 | 3,478 | 0 | 51 | 2,422,606 | 103 | 34 | 826,502 | 32.59 | 19 | 86 | 0 | 3,478 | 
...
Commit: https://github.com/openvm-org/openvm/commit/e5968472c60b5752509efe4aa962d8f927197364
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/21186722021)

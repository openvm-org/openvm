...
|:---|---:|---:|---:|
| Total |  21.26 |  7.42 | 7.42 |
| regex_program |  21.26 |  7.42 |  7.42 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  5,306.25 |  21,225 |  7,385 |  4,124 |
...
| `execute_preflight_insn_mi/s` |  30.84 | -          |  31.39 |  29.65 |
| `trace_gen_time_ms   ` |  179.50 |  718 |  194 |  173 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  5,007.25 |  20,029 |  7,114 |  3,725 |
| `main_trace_commit_time_ms` |  52.25 |  209 |  56 |  51 |
| `generate_perm_trace_time_ms` |  76.25 |  305 |  100 |  56 |
| `perm_trace_commit_time_ms` |  63.84 |  255.37 |  69.68 |  55.41 |
| `quotient_poly_compute_time_ms` |  61.05 |  244.20 |  70.81 |  54.90 |
| `quotient_poly_commit_time_ms` |  15.70 |  62.79 |  18.57 |  13.35 |
| `pcs_opening_time_ms ` |  4,734.75 |  18,939 |  6,817 |  3,459 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 7,385 | 1 | 36 | 4,137,502 | 113.89 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 173 | 4,124 | 23,446,148 | 150,778,428 | 173 | 3,725 | 0 | 63.56 | 18.57 | 9 | 69.68 | 3,459 | 126 | 3,459 | 4 | 56 | 10,899,170 | 56 | 57 | 1,103,000 | 29.65 | 22 | 82 | 0 | 3,458 | 
| regex_program | 1 | 176 | 5,140 | 11,598,276 | 128,513,066 | 176 | 4,877 | 1 | 54.93 | 15.56 | 6 | 65.73 | 4,623 | 131 | 4,623 | 0 | 51 | 2,196,106 | 65 | 46 | 1,104,000 | 31.23 | 17 | 71 | 0 | 4,623 | 
| regex_program | 2 | 175 | 4,576 | 11,579,064 | 128,513,066 | 175 | 4,313 | 1 | 54.90 | 15.31 | 6 | 64.56 | 4,040 | 150 | 4,040 | 0 | 51 | 2,177,334 | 84 | 46 | 1,104,000 | 31.39 | 17 | 70 | 0 | 4,040 | 
| regex_program | 3 | 194 | 7,385 | 11,853,872 | 103,456,394 | 194 | 7,114 | 0 | 70.81 | 13.35 | 7 | 55.41 | 6,817 | 160 | 6,817 | 0 | 51 | 2,422,606 | 100 | 35 | 826,502 | 31.08 | 19 | 85 | 0 | 6,817 | 
...
Commit: https://github.com/openvm-org/openvm/commit/04dd13b67df925b2dcd2b0535645716eedecdbf8
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/21188814322)

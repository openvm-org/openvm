...
|:---|---:|---:|---:|
| Total |  16.85 |  5.18 | 5.18 |
| regex_program |  16.85 |  5.18 |  5.18 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  4,203.75 |  16,815 |  5,146 |  3,192 |
...
| `execute_preflight_time_ms` |  49.25 |  197 |  66 |  35 |
| `execute_preflight_insn_mi/s` |  31.75 | -          |  32.61 |  30.59 |
| `trace_gen_time_ms   ` |  174.25 |  697 |  191 |  163 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  3,905.75 |  15,623 |  4,878 |  2,930 |
| `main_trace_commit_time_ms` |  52 |  208 |  58 |  50 |
| `generate_perm_trace_time_ms` |  67.50 |  270 |  81 |  57 |
| `perm_trace_commit_time_ms` |  63.95 |  255.80 |  69.69 |  55.12 |
| `quotient_poly_compute_time_ms` |  59.39 |  237.58 |  70.03 |  52.95 |
| `quotient_poly_commit_time_ms` |  16.26 |  65.05 |  18.66 |  13.94 |
| `pcs_opening_time_ms ` |  3,643.50 |  14,574 |  4,603 |  2,678 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 5,146 | 1 | 35 | 4,137,502 | 114.88 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 163 | 3,712 | 23,446,148 | 150,778,428 | 163 | 3,312 | 0 | 61.25 | 18.66 | 7 | 69.69 | 3,045 | 127 | 3,044 | 4 | 58 | 10,899,170 | 57 | 66 | 1,103,000 | 30.59 | 22 | 80 | 0 | 3,044 | 
| regex_program | 1 | 171 | 3,192 | 11,598,276 | 128,513,066 | 171 | 2,930 | 1 | 53.35 | 16.22 | 6 | 65.54 | 2,678 | 131 | 2,678 | 0 | 50 | 2,196,106 | 64 | 49 | 1,104,000 | 31.82 | 17 | 70 | 0 | 2,678 | 
| regex_program | 2 | 172 | 4,765 | 11,579,064 | 128,513,066 | 172 | 4,503 | 1 | 52.95 | 16.24 | 6 | 65.45 | 4,248 | 134 | 4,248 | 0 | 50 | 2,177,334 | 68 | 47 | 1,104,000 | 31.99 | 17 | 69 | 0 | 4,248 | 
| regex_program | 3 | 191 | 5,146 | 11,853,872 | 103,456,394 | 191 | 4,878 | 0 | 70.03 | 13.94 | 8 | 55.12 | 4,603 | 139 | 4,602 | 0 | 50 | 2,422,606 | 81 | 35 | 826,502 | 32.61 | 19 | 85 | 0 | 4,602 | 

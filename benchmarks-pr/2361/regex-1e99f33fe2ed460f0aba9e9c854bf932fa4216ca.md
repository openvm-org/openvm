...
|:---|---:|---:|---:|
| Total |  18.83 |  5.41 | 5.41 |
| regex_program |  18.83 |  5.41 |  5.41 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  4,699 |  18,796 |  5,378 |  3,489 |
...
| `execute_preflight_time_ms` |  45 |  180 |  55 |  34 |
| `execute_preflight_insn_mi/s` |  31.96 | -          |  32.67 |  30.92 |
| `trace_gen_time_ms   ` |  179.75 |  719 |  195 |  173 |
| `memory_finalize_time_ms` |  0.75 |  3 |  3 |  0 |
| `stark_prove_excluding_trace_time_ms` |  4,400 |  17,600 |  5,116 |  3,225 |
| `main_trace_commit_time_ms` |  52 |  208 |  58 |  49 |
| `generate_perm_trace_time_ms` |  63.75 |  255 |  123 |  24 |
| `perm_trace_commit_time_ms` |  64.96 |  259.83 |  72.56 |  55.59 |
| `quotient_poly_compute_time_ms` |  59.58 |  238.32 |  69.45 |  54.33 |
| `quotient_poly_commit_time_ms` |  15.75 |  62.99 |  17.55 |  13.33 |
| `pcs_opening_time_ms ` |  4,140.75 |  16,563 |  4,805 |  2,959 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 5,196 | 1 | 36 | 4,137,502 | 113.72 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 173 | 4,733 | 23,446,148 | 150,778,428 | 173 | 4,334 | 0 | 59.93 | 17.55 | 7 | 72.56 | 4,099 | 98 | 4,099 | 3 | 58 | 10,899,170 | 24 | 55 | 1,103,000 | 30.92 | 22 | 78 | 0 | 4,099 | 
| regex_program | 1 | 175 | 5,378 | 11,598,276 | 128,513,066 | 175 | 5,116 | 1 | 54.33 | 15.66 | 6 | 65.93 | 4,805 | 189 | 4,804 | 0 | 50 | 2,196,106 | 123 | 45 | 1,104,000 | 32.67 | 17 | 70 | 0 | 4,804 | 
| regex_program | 2 | 176 | 3,489 | 11,579,064 | 128,513,066 | 176 | 3,225 | 1 | 54.61 | 16.45 | 6 | 65.75 | 2,959 | 142 | 2,959 | 0 | 51 | 2,177,334 | 76 | 46 | 1,104,000 | 31.66 | 17 | 71 | 0 | 2,959 | 
| regex_program | 3 | 195 | 5,196 | 11,853,872 | 103,456,394 | 195 | 4,925 | 0 | 69.45 | 13.33 | 7 | 55.59 | 4,700 | 91 | 4,700 | 0 | 49 | 2,422,606 | 32 | 34 | 826,502 | 32.61 | 19 | 83 | 0 | 4,700 | 

...
|:---|---:|---:|---:|
| Total |  8.24 |  4.70 | 4.70 |
| pairing |  8.24 |  4.70 |  4.70 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  4,088.50 |  8,177 |  4,637 |  3,540 |
...
| `execute_metered_insn_mi/s` |  27.63 | -          |  27.63 |  27.63 |
| `execute_preflight_insns` |  872,871 |  1,745,742 |  1,149,000 |  596,742 |
| `execute_preflight_time_ms` |  83 |  166 |  119 |  47 |
| `execute_preflight_insn_mi/s` |  14.81 | -          |  18.20 |  11.41 |
| `trace_gen_time_ms   ` |  184.50 |  369 |  202 |  167 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  3,715.50 |  7,431 |  4,182 |  3,249 |
| `main_trace_commit_time_ms` |  62 |  124 |  71 |  53 |
| `generate_perm_trace_time_ms` |  72 |  144 |  105 |  39 |
| `perm_trace_commit_time_ms` |  75.68 |  151.37 |  87.02 |  64.35 |
| `quotient_poly_compute_time_ms` |  81.55 |  163.11 |  89.68 |  73.43 |
| `quotient_poly_commit_time_ms` |  17.19 |  34.38 |  19.03 |  15.35 |
| `pcs_opening_time_ms ` |  3,402 |  6,804 |  3,871 |  2,933 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 3,540 | 1 | 63 | 1,745,742 | 27.63 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 167 | 4,637 | 32,480,114 | 172,558,444 | 167 | 4,182 | 0 | 89.68 | 19.03 | 9 | 87.02 | 3,871 | 129 | 3,871 | 1 | 71 | 15,909,408 | 39 | 119 | 1,149,000 | 11.41 | 26 | 109 | 1 | 3,870 | 
| pairing | 1 | 202 | 3,540 | 22,464,232 | 119,958,502 | 202 | 3,249 | 1 | 73.43 | 15.35 | 8 | 64.35 | 2,933 | 173 | 2,933 | 0 | 53 | 9,498,894 | 105 | 47 | 596,742 | 18.20 | 20 | 89 | 1 | 2,932 | 

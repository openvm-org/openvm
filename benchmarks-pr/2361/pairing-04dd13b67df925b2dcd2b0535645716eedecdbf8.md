...
|:---|---:|---:|---:|
| Total |  8.67 |  4.41 | 4.41 |
| pairing |  8.67 |  4.41 |  4.41 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  4,304.50 |  8,609 |  4,348 |  4,261 |
...
| `execute_metered_insn_mi/s` |  27.60 | -          |  27.60 |  27.60 |
| `execute_preflight_insns` |  872,871 |  1,745,742 |  1,149,000 |  596,742 |
| `execute_preflight_time_ms` |  83 |  166 |  118 |  48 |
| `execute_preflight_insn_mi/s` |  14.85 | -          |  18.24 |  11.46 |
| `trace_gen_time_ms   ` |  182.50 |  365 |  201 |  164 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  3,933.50 |  7,867 |  3,971 |  3,896 |
| `main_trace_commit_time_ms` |  64 |  128 |  75 |  53 |
| `generate_perm_trace_time_ms` |  128 |  256 |  173 |  83 |
| `perm_trace_commit_time_ms` |  76.27 |  152.55 |  88.92 |  63.63 |
| `quotient_poly_compute_time_ms` |  81.80 |  163.59 |  91 |  72.59 |
| `quotient_poly_commit_time_ms` |  17.44 |  34.88 |  19.71 |  15.17 |
| `pcs_opening_time_ms ` |  3,561 |  7,122 |  3,589 |  3,533 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 4,261 | 1 | 63 | 1,745,742 | 27.60 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 164 | 4,348 | 32,480,114 | 172,558,444 | 164 | 3,896 | 0 | 91 | 19.71 | 9 | 88.92 | 3,533 | 175 | 3,533 | 1 | 75 | 15,909,408 | 83 | 118 | 1,149,000 | 11.46 | 26 | 111 | 1 | 3,533 | 
| pairing | 1 | 201 | 4,261 | 22,464,232 | 119,958,502 | 201 | 3,971 | 1 | 72.59 | 15.17 | 8 | 63.63 | 3,589 | 239 | 3,589 | 0 | 53 | 9,498,894 | 173 | 48 | 596,742 | 18.24 | 20 | 88 | 1 | 3,589 | 

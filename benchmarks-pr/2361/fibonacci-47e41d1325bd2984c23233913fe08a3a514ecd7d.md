...
|:---|---:|---:|---:|
| Total |  11.48 |  6.53 | 6.53 |
| fibonacci_program |  11.48 |  6.53 |  6.53 |


| fibonacci_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  5,737.50 |  11,475 |  6,524 |  4,951 |
...
| `execute_metered_insn_mi/s` |  164.19 | -          |  164.19 |  164.19 |
| `execute_preflight_insns` |  750,104.50 |  1,500,209 |  873,000 |  627,209 |
| `execute_preflight_time_ms` |  26 |  52 |  31 |  21 |
| `execute_preflight_insn_mi/s` |  39.54 | -          |  40.01 |  39.08 |
| `trace_gen_time_ms   ` |  195.50 |  391 |  199 |  192 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  5,409.50 |  10,819 |  6,130 |  4,689 |
| `main_trace_commit_time_ms` |  30.50 |  61 |  33 |  28 |
| `generate_perm_trace_time_ms` |  44.50 |  89 |  54 |  35 |
| `perm_trace_commit_time_ms` |  41.22 |  82.44 |  43.66 |  38.78 |
| `quotient_poly_compute_time_ms` |  32.60 |  65.20 |  35.52 |  29.68 |
| `quotient_poly_commit_time_ms` |  12.29 |  24.59 |  12.84 |  11.75 |
| `pcs_opening_time_ms ` |  5,245.50 |  10,491 |  5,948 |  4,543 |
...
| --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 4,951 | 1 | 9 | 1,500,209 | 164.19 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 192 | 6,524 | 9,677,708 | 84,395,212 | 192 | 6,130 | 0 | 35.52 | 12.84 | 6 | 43.66 | 5,948 | 98 | 5,948 | 0 | 33 | 1,035,986 | 54 | 31 | 873,000 | 40.01 | 14 | 48 | 0 | 5,948 | 
| fibonacci_program | 1 | 199 | 4,951 | 9,708,170 | 74,305,770 | 199 | 4,689 | 1 | 29.68 | 11.75 | 5 | 38.78 | 4,543 | 74 | 4,543 | 0 | 28 | 1,064,416 | 35 | 21 | 627,209 | 39.08 | 11 | 41 | 0 | 4,543 | 

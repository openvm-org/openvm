...
|:---|---:|---:|---:|
| Total |  8.21 |  4.35 | 4.35 |
| fibonacci_program |  8.21 |  4.35 |  4.35 |


| fibonacci_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  4,100.50 |  8,201 |  4,344 |  3,857 |
...
| `execute_metered_insn_mi/s` |  163.44 | -          |  163.44 |  163.44 |
| `execute_preflight_insns` |  750,104.50 |  1,500,209 |  873,000 |  627,209 |
| `execute_preflight_time_ms` |  26 |  52 |  31 |  21 |
| `execute_preflight_insn_mi/s` |  40.02 | -          |  40.11 |  39.92 |
| `trace_gen_time_ms   ` |  195 |  390 |  198 |  192 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  3,772 |  7,544 |  3,949 |  3,595 |
| `main_trace_commit_time_ms` |  30.50 |  61 |  33 |  28 |
| `generate_perm_trace_time_ms` |  45.50 |  91 |  55 |  36 |
| `perm_trace_commit_time_ms` |  40.95 |  81.89 |  43.83 |  38.06 |
| `quotient_poly_compute_time_ms` |  31.51 |  63.02 |  32.52 |  30.50 |
| `quotient_poly_commit_time_ms` |  13.07 |  26.13 |  13.42 |  12.71 |
| `pcs_opening_time_ms ` |  3,608 |  7,216 |  3,769 |  3,447 |
...
| --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 3,857 | 1 | 9 | 1,500,209 | 163.44 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 192 | 4,344 | 9,677,708 | 84,395,212 | 192 | 3,949 | 0 | 32.52 | 13.42 | 7 | 43.83 | 3,769 | 99 | 3,769 | 0 | 33 | 1,035,986 | 55 | 31 | 873,000 | 39.92 | 14 | 46 | 0 | 3,769 | 
| fibonacci_program | 1 | 198 | 3,857 | 9,708,170 | 74,305,770 | 198 | 3,595 | 1 | 30.50 | 12.71 | 5 | 38.06 | 3,447 | 75 | 3,446 | 0 | 28 | 1,064,416 | 36 | 21 | 627,209 | 40.11 | 11 | 43 | 0 | 3,446 | 

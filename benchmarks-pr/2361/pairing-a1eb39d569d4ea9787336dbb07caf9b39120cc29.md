...
|:---|---:|---:|---:|
| Total |  7.79 |  4.92 | 4.92 |
| pairing |  7.79 |  4.92 |  4.92 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  3,863.50 |  7,727 |  4,861 |  2,866 |
...
| `execute_preflight_time_ms` |  87 |  174 |  124 |  50 |
| `execute_preflight_insn_mi/s` |  14.90 | -          |  18.30 |  11.51 |
| `trace_gen_time_ms   ` |  181 |  362 |  201 |  161 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  3,490.50 |  6,981 |  4,569 |  2,412 |
| `main_trace_commit_time_ms` |  65 |  130 |  75 |  55 |
| `generate_perm_trace_time_ms` |  129.50 |  259 |  194 |  65 |
| `perm_trace_commit_time_ms` |  76.82 |  153.64 |  88.67 |  64.97 |
| `quotient_poly_compute_time_ms` |  83.70 |  167.40 |  93.56 |  73.84 |
| `quotient_poly_commit_time_ms` |  17.44 |  34.87 |  19.23 |  15.64 |
| `pcs_opening_time_ms ` |  3,112.50 |  6,225 |  4,160 |  2,065 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 4,861 | 1 | 63 | 1,745,742 | 27.47 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 161 | 2,866 | 32,480,114 | 172,558,444 | 161 | 2,412 | 0 | 93.56 | 19.23 | 9 | 88.67 | 2,065 | 157 | 2,064 | 1 | 75 | 15,909,408 | 65 | 124 | 1,149,000 | 11.51 | 27 | 113 | 1 | 2,064 | 
| pairing | 1 | 201 | 4,861 | 22,464,232 | 119,958,502 | 201 | 4,569 | 1 | 73.84 | 15.64 | 8 | 64.97 | 4,160 | 262 | 4,160 | 0 | 55 | 9,498,894 | 194 | 50 | 596,742 | 18.30 | 21 | 90 | 1 | 4,159 | 

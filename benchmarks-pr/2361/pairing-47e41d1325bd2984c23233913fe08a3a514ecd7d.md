...
|:---|---:|---:|---:|
| Total |  11.06 |  5.60 | 5.60 |
| pairing |  11.06 |  5.60 |  5.60 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  5,499 |  10,998 |  5,540 |  5,458 |
...
| `execute_preflight_insn_mi/s` |  14.73 | -          |  18.07 |  11.38 |
| `trace_gen_time_ms   ` |  190.50 |  381 |  209 |  172 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  5,119.50 |  10,239 |  5,241 |  4,998 |
| `main_trace_commit_time_ms` |  66 |  132 |  76 |  56 |
| `generate_perm_trace_time_ms` |  73.50 |  147 |  80 |  67 |
| `perm_trace_commit_time_ms` |  78.72 |  157.45 |  91.93 |  65.52 |
| `quotient_poly_compute_time_ms` |  82.66 |  165.31 |  90.59 |  74.73 |
| `quotient_poly_commit_time_ms` |  16.49 |  32.99 |  16.85 |  16.14 |
| `pcs_opening_time_ms ` |  4,797.50 |  9,595 |  4,944 |  4,651 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 5,540 | 1 | 63 | 1,745,742 | 27.54 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 172 | 5,458 | 32,480,114 | 172,558,444 | 172 | 4,998 | 0 | 90.59 | 16.85 | 9 | 91.93 | 4,651 | 162 | 4,650 | 1 | 76 | 15,909,408 | 67 | 119 | 1,149,000 | 11.38 | 26 | 108 | 1 | 4,650 | 
| pairing | 1 | 209 | 5,540 | 22,464,232 | 119,958,502 | 209 | 5,241 | 1 | 74.73 | 16.14 | 8 | 65.52 | 4,944 | 149 | 4,943 | 0 | 56 | 9,498,894 | 80 | 48 | 596,742 | 18.07 | 21 | 91 | 1 | 4,943 | 

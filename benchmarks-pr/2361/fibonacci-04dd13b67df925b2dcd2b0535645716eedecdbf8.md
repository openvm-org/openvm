...
|:---|---:|---:|---:|
| Total |  6.26 |  3.29 | 3.29 |
| fibonacci_program |  6.26 |  3.29 |  3.29 |


| fibonacci_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  3,124 |  6,248 |  3,285 |  2,963 |
...
| `execute_metered_insn_mi/s` |  164.71 | -          |  164.71 |  164.71 |
| `execute_preflight_insns` |  750,104.50 |  1,500,209 |  873,000 |  627,209 |
| `execute_preflight_time_ms` |  26 |  52 |  31 |  21 |
| `execute_preflight_insn_mi/s` |  40.33 | -          |  40.47 |  40.18 |
| `trace_gen_time_ms   ` |  194.50 |  389 |  196 |  193 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  2,798.50 |  5,597 |  2,892 |  2,705 |
| `main_trace_commit_time_ms` |  30.50 |  61 |  33 |  28 |
| `generate_perm_trace_time_ms` |  44.50 |  89 |  54 |  35 |
| `perm_trace_commit_time_ms` |  40.75 |  81.49 |  43.32 |  38.17 |
| `quotient_poly_compute_time_ms` |  31.89 |  63.78 |  34.66 |  29.12 |
| `quotient_poly_commit_time_ms` |  12.09 |  24.18 |  12.75 |  11.43 |
| `pcs_opening_time_ms ` |  2,636.50 |  5,273 |  2,712 |  2,561 |
...
| --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 2,963 | 1 | 9 | 1,500,209 | 164.71 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 193 | 3,285 | 9,677,708 | 84,395,212 | 193 | 2,892 | 0 | 34.66 | 12.75 | 6 | 43.32 | 2,712 | 98 | 2,712 | 0 | 33 | 1,035,986 | 54 | 31 | 873,000 | 40.18 | 14 | 47 | 0 | 2,712 | 
| fibonacci_program | 1 | 196 | 2,963 | 9,708,170 | 74,305,770 | 195 | 2,705 | 1 | 29.12 | 11.43 | 5 | 38.17 | 2,561 | 74 | 2,561 | 0 | 28 | 1,064,416 | 35 | 21 | 627,209 | 40.47 | 11 | 40 | 0 | 2,561 | 

...
|:---|---:|---:|---:|
| Total |  8.93 |  4.52 | 4.52 |
| fibonacci_program |  8.93 |  4.52 |  4.52 |


| fibonacci_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  4,461.50 |  8,923 |  4,513 |  4,410 |
...
| `execute_preflight_insn_mi/s` |  39.95 | -          |  40.05 |  39.85 |
| `trace_gen_time_ms   ` |  200 |  400 |  203 |  197 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  4,129 |  8,258 |  4,247 |  4,011 |
| `main_trace_commit_time_ms` |  31 |  62 |  33 |  29 |
| `generate_perm_trace_time_ms` |  28.50 |  57 |  32 |  25 |
| `perm_trace_commit_time_ms` |  41.46 |  82.93 |  44.57 |  38.35 |
| `quotient_poly_compute_time_ms` |  31.19 |  62.37 |  33.04 |  29.33 |
| `quotient_poly_commit_time_ms` |  12.53 |  25.06 |  12.72 |  12.34 |
| `pcs_opening_time_ms ` |  3,982.50 |  7,965 |  4,111 |  3,854 |
...
| --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 4,513 | 1 | 9 | 1,500,209 | 160.86 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 197 | 4,410 | 9,677,708 | 84,395,212 | 197 | 4,011 | 0 | 33.04 | 12.34 | 6 | 44.57 | 3,854 | 77 | 3,854 | 0 | 33 | 1,035,986 | 32 | 32 | 873,000 | 40.05 | 14 | 45 | 0 | 3,853 | 
| fibonacci_program | 1 | 203 | 4,513 | 9,708,170 | 74,305,770 | 203 | 4,247 | 1 | 29.33 | 12.72 | 5 | 38.35 | 4,111 | 63 | 4,111 | 0 | 29 | 1,064,416 | 25 | 21 | 627,209 | 39.85 | 11 | 42 | 0 | 4,111 | 

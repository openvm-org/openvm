...
|:---|---:|---:|---:|
| Total |  11.29 |  5.85 | 5.85 |
| fibonacci_program |  11.29 |  5.85 |  5.85 |


| fibonacci_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  5,639.50 |  11,279 |  5,844 |  5,435 |
...
| `execute_metered_insn_mi/s` |  155.04 | -          |  155.04 |  155.04 |
| `execute_preflight_insns` |  750,104.50 |  1,500,209 |  873,000 |  627,209 |
| `execute_preflight_time_ms` |  26 |  52 |  31 |  21 |
| `execute_preflight_insn_mi/s` |  39.78 | -          |  39.94 |  39.62 |
| `trace_gen_time_ms   ` |  196 |  392 |  200 |  192 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  5,312.50 |  10,625 |  5,582 |  5,043 |
| `main_trace_commit_time_ms` |  30.50 |  61 |  33 |  28 |
| `generate_perm_trace_time_ms` |  28 |  56 |  31 |  25 |
| `perm_trace_commit_time_ms` |  41.54 |  83.08 |  44.77 |  38.31 |
| `quotient_poly_compute_time_ms` |  32.72 |  65.45 |  34.13 |  31.32 |
| `quotient_poly_commit_time_ms` |  12.89 |  25.78 |  13.62 |  12.16 |
| `pcs_opening_time_ms ` |  5,164.50 |  10,329 |  5,445 |  4,884 |
...
| --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 5,844 | 1 | 9 | 1,500,209 | 155.04 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 192 | 5,435 | 9,677,708 | 84,395,212 | 192 | 5,043 | 0 | 34.13 | 13.62 | 6 | 44.77 | 4,884 | 76 | 4,884 | 0 | 33 | 1,035,986 | 31 | 31 | 873,000 | 39.94 | 14 | 48 | 0 | 4,884 | 
| fibonacci_program | 1 | 200 | 5,844 | 9,708,170 | 74,305,770 | 200 | 5,582 | 1 | 31.32 | 12.16 | 5 | 38.31 | 5,445 | 64 | 5,444 | 0 | 28 | 1,064,416 | 25 | 21 | 627,209 | 39.62 | 11 | 43 | 0 | 5,444 | 

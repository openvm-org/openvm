...
|:---|---:|---:|
| Total | <span style='color: green'>(-0 [-1.3%])</span> 2.37 | <span style='color: green'>(-0 [-0.6%])</span> 0.78 |
| regex_program | <span style='color: green'>(-0 [-1.3%])</span> 2.33 | <span style='color: green'>(-0 [-0.7%])</span> 0.74 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: green'>(-8 [-1.3%])</span> 582.25 | <span style='color: green'>(-30 [-1.3%])</span> 2,329 | <span style='color: green'>(-5 [-0.7%])</span> 740 | <span style='color: green'>(-17 [-3.2%])</span> 520 |
...
| `execute_metered_insn_mi/s` | <span style='color: green'>(-0 [-0.1%])</span> 113.87 | -          | <span style='color: green'>(-0 [-0.1%])</span> 113.87 | <span style='color: green'>(-0 [-0.1%])</span> 113.87 |
...
| `execute_preflight_insn_mi/s` | <span style='color: green'>(-0 [-1.5%])</span> 30.22 | -          | <span style='color: green'>(-1 [-2.0%])</span> 31.27 | <span style='color: red'>(+0 [+0.7%])</span> 27.84 |
| `trace_gen_time_ms   ` | <span style='color: green'>(-2 [-1.4%])</span> 175 | <span style='color: green'>(-10 [-1.4%])</span> 700 | <span style='color: green'>(-2 [-0.9%])</span> 209 | <span style='color: green'>(-3 [-2.0%])</span> 150 |
| `memory_finalize_time_ms` |  1 |  4 |  4 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: green'>(-5 [-1.8%])</span> 285.75 | <span style='color: green'>(-21 [-1.8%])</span> 1,143 | <span style='color: green'>(-1 [-0.3%])</span> 341 | <span style='color: green'>(-11 [-4.1%])</span> 259 |
...
| `generate_perm_trace_time_ms` | <span style='color: red'>(+0 [+1.5%])</span> 33.75 | <span style='color: red'>(+2 [+1.5%])</span> 135 |  54 | <span style='color: green'>(-1 [-5.0%])</span> 19 |
| `perm_trace_commit_time_ms` | <span style='color: green'>(-0 [-0.7%])</span> 64.01 | <span style='color: green'>(-2 [-0.7%])</span> 256.04 | <span style='color: green'>(-1 [-0.9%])</span> 70.22 | <span style='color: green'>(-0 [-0.7%])</span> 55.38 |
| `quotient_poly_compute_time_ms` | <span style='color: green'>(-1 [-1.4%])</span> 57.63 | <span style='color: green'>(-3 [-1.4%])</span> 230.52 | <span style='color: green'>(-0 [-0.6%])</span> 69.32 | <span style='color: green'>(-2 [-3.2%])</span> 51.24 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+0 [+0.3%])</span> 14.71 | <span style='color: red'>(+0 [+0.3%])</span> 58.83 | <span style='color: green'>(-0 [-1.7%])</span> 16.43 | <span style='color: green'>(-0 [-1.8%])</span> 12.63 |
| `pcs_opening_time_ms ` | <span style='color: green'>(-4 [-6.9%])</span> 60.50 | <span style='color: green'>(-18 [-6.9%])</span> 242 |  82 | <span style='color: green'>(-10 [-17.9%])</span> 46 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 536 | 1 | 36 | 4,137,502 | 113.87 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 209 | 740 | 23,446,148 | 150,778,428 | 209 | 341 | 0 | 57.90 | 16.43 | 5 | 70.22 | 82 | 125 | 82 | 4 | 57 | 10,899,170 | 54 | 46 | 1,103,000 | 27.84 | 21 | 75 | 1 | 82 | 
| regex_program | 1 | 150 | 533 | 11,598,276 | 128,513,066 | 150 | 275 | 1 | 51.24 | 14.37 | 4 | 64.50 | 58 | 100 | 58 | 0 | 50 | 2,196,106 | 35 | 66 | 1,104,000 | 30.61 | 16 | 66 | 0 | 58 | 
| regex_program | 2 | 160 | 520 | 11,579,064 | 128,513,066 | 160 | 259 | 1 | 52.06 | 15.40 | 4 | 65.95 | 46 | 94 | 46 | 0 | 49 | 2,177,334 | 27 | 59 | 1,104,000 | 31.27 | 16 | 68 | 0 | 46 | 
| regex_program | 3 | 181 | 536 | 11,853,872 | 103,456,394 | 181 | 268 | 0 | 69.32 | 12.63 | 5 | 55.38 | 56 | 78 | 56 | 0 | 50 | 2,422,606 | 19 | 45 | 826,502 | 31.17 | 18 | 82 | 1 | 56 | 
...
Commit: https://github.com/openvm-org/openvm/commit/7e61c24ce477bd8d9a8a4b9064aa737203e3c176
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19503582471)

...
|:---|---:|---:|
| Total |  2.40 | <span style='color: green'>(-0 [-1.0%])</span> 0.77 |
| regex_program |  2.36 | <span style='color: green'>(-0 [-0.9%])</span> 0.74 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  590.25 |  2,361 | <span style='color: green'>(-7 [-0.9%])</span> 738 |  537 |
...
| `execute_metered_insn_mi/s` | <span style='color: red'>(+2 [+1.9%])</span> 116.25 | -          | <span style='color: red'>(+2 [+1.9%])</span> 116.25 | <span style='color: red'>(+2 [+1.9%])</span> 116.25 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` | <span style='color: green'>(-1 [-1.4%])</span> 53 | <span style='color: green'>(-3 [-1.4%])</span> 212 | <span style='color: green'>(-1 [-1.5%])</span> 64 | <span style='color: green'>(-1 [-2.2%])</span> 44 |
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+1 [+2.1%])</span> 31.32 | -          | <span style='color: red'>(+1 [+3.1%])</span> 32.89 | <span style='color: red'>(+1 [+3.5%])</span> 28.60 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+1 [+0.7%])</span> 178.75 | <span style='color: red'>(+5 [+0.7%])</span> 715 |  211 | <span style='color: red'>(+4 [+2.6%])</span> 157 |
...
| `stark_prove_excluding_trace_time_ms` |  291 |  1,164 | <span style='color: green'>(-5 [-1.5%])</span> 337 | <span style='color: green'>(-2 [-0.7%])</span> 268 |
| `main_trace_commit_time_ms` | <span style='color: red'>(+0 [+0.5%])</span> 52 | <span style='color: red'>(+1 [+0.5%])</span> 208 |  57 |  50 |
| `generate_perm_trace_time_ms` | <span style='color: red'>(+1 [+3.0%])</span> 34.25 | <span style='color: red'>(+4 [+3.0%])</span> 137 |  54 | <span style='color: green'>(-2 [-10.0%])</span> 18 |
| `perm_trace_commit_time_ms` | <span style='color: green'>(-0 [-0.2%])</span> 64.35 | <span style='color: green'>(-0 [-0.2%])</span> 257.38 | <span style='color: red'>(+0 [+0.6%])</span> 71.27 | <span style='color: red'>(+0 [+0.7%])</span> 56.17 |
| `quotient_poly_compute_time_ms` | <span style='color: green'>(-0 [-0.2%])</span> 58.33 | <span style='color: green'>(-0 [-0.2%])</span> 233.33 | <span style='color: green'>(-1 [-0.8%])</span> 69.17 | <span style='color: green'>(-0 [-0.2%])</span> 52.81 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+0 [+0.6%])</span> 14.76 | <span style='color: red'>(+0 [+0.6%])</span> 59.03 | <span style='color: red'>(+0 [+0.7%])</span> 16.84 | <span style='color: green'>(-0 [-2.3%])</span> 12.56 |
| `pcs_opening_time_ms ` | <span style='color: green'>(-1 [-1.9%])</span> 63.75 | <span style='color: green'>(-5 [-1.9%])</span> 255 | <span style='color: green'>(-6 [-7.3%])</span> 76 |  56 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 539 | 1 | 35 | 4,137,502 | 116.25 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 211 | 738 | 23,446,148 | 150,778,428 | 211 | 337 | 0 | 58.54 | 16.84 | 5 | 71.27 | 76 | 126 | 76 | 3 | 57 | 10,899,170 | 54 | 44 | 1,103,000 | 28.60 | 21 | 76 | 1 | 76 | 
| regex_program | 1 | 157 | 547 | 11,598,276 | 128,513,066 | 157 | 285 | 1 | 52.81 | 14.89 | 4 | 65.01 | 62 | 104 | 62 | 0 | 50 | 2,196,106 | 38 | 64 | 1,104,000 | 32.65 | 16 | 68 | 0 | 62 | 
| regex_program | 2 | 162 | 537 | 11,579,064 | 128,513,066 | 162 | 274 | 1 | 52.83 | 14.74 | 4 | 64.92 | 61 | 92 | 61 | 0 | 51 | 2,177,334 | 27 | 59 | 1,104,000 | 31.13 | 16 | 68 | 0 | 61 | 
| regex_program | 3 | 185 | 539 | 11,853,872 | 103,456,394 | 185 | 268 | 0 | 69.17 | 12.56 | 5 | 56.17 | 56 | 78 | 56 | 0 | 50 | 2,422,606 | 18 | 45 | 826,502 | 32.89 | 18 | 82 | 1 | 56 | 

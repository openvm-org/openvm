...
| `total_proof_time_ms ` |  718.50 |  1,437 |  838 |  599 |
...
| `execute_preflight_insn_mi/s` |  13.52 | -          |  17.91 |  9.13 |
| `trace_gen_time_ms   ` |  181.50 |  363 |  200 |  163 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  349.50 |  699 |  401 |  298 |
| `main_trace_commit_time_ms` |  65.50 |  131 |  77 |  54 |
| `generate_perm_trace_time_ms` |  33 |  66 |  37 |  29 |
| `perm_trace_commit_time_ms` |  79.22 |  158.44 |  91.99 |  66.44 |
| `quotient_poly_compute_time_ms` |  80.41 |  160.82 |  88.81 |  72.01 |
| `quotient_poly_commit_time_ms` |  16.84 |  33.69 |  18.99 |  14.70 |
| `pcs_opening_time_ms ` |  69 |  138 |  82 |  56 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 599 | 40 | 1 | 89 | 1,745,742 | 19.42 | 145 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 163 | 838 | 32,689,110 | 172,558,444 | 163 | 401 | 0 | 88.81 | 18.99 | 6 | 91.99 | 82 | 132 | 82 | 1 | 77 | 16,059,916 | 37 | 130 | 1,157,000 | 9.13 | 26 | 108 | 1 | 82 | 
| pairing | 1 | 200 | 599 | 22,314,288 | 119,958,502 | 200 | 298 | 1 | 72.01 | 14.70 | 6 | 66.44 | 56 | 99 | 56 | 0 | 54 | 9,408,294 | 29 | 60 | 588,742 | 17.91 | 20 | 87 | 1 | 56 | 

...
| `total_proof_time_ms ` |  711 |  1,422 |  809 |  613 |
...
| `execute_preflight_insn_mi/s` |  13.49 | -          |  17.82 |  9.16 |
| `trace_gen_time_ms   ` |  178 |  356 |  195 |  161 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  345 |  690 |  375 |  315 |
| `main_trace_commit_time_ms` |  64 |  128 |  75 |  53 |
| `generate_perm_trace_time_ms` |  43 |  86 |  48 |  38 |
| `perm_trace_commit_time_ms` |  76.98 |  153.96 |  89.16 |  64.80 |
| `quotient_poly_compute_time_ms` |  79.29 |  158.58 |  87.58 |  70.99 |
| `quotient_poly_commit_time_ms` |  15.87 |  31.73 |  16.98 |  14.76 |
| `pcs_opening_time_ms ` |  61 |  122 |  64 |  58 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 613 | 65 | 1 | 89 | 1,745,742 | 19.43 | 170 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 161 | 809 | 32,689,110 | 172,558,444 | 161 | 375 | 0 | 87.58 | 16.98 | 6 | 89.16 | 64 | 130 | 63 | 1 | 75 | 16,059,916 | 38 | 129 | 1,157,000 | 9.16 | 26 | 105 | 1 | 63 | 
| pairing | 1 | 195 | 613 | 22,314,288 | 119,958,502 | 195 | 315 | 1 | 70.99 | 14.76 | 5 | 64.80 | 58 | 116 | 58 | 0 | 53 | 9,408,294 | 48 | 61 | 588,742 | 17.82 | 20 | 86 | 1 | 58 | 

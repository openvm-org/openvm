...
| `total_proof_time_ms ` |  552.14 |  3,865 |  673 |  528 |
| `execute_metered_time_ms` |  73 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  163.17 | -          |  163.17 |  163.17 |
| `execute_preflight_insns` |  1,714,323.57 |  12,000,265 |  1,747,000 |  1,518,265 |
| `execute_preflight_time_ms` |  55.43 |  388 |  60 |  48 |
| `execute_preflight_insn_mi/s` |  40.84 | -          |  41.39 |  39.82 |
| `trace_gen_time_ms   ` |  162.71 |  1,139 |  171 |  158 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  273.43 |  1,914 |  280 |  269 |
| `prover.main_trace_commit_time_ms` |  59.71 |  418 |  60 |  59 |
| `prover.rap_constraints_time_ms` |  176.29 |  1,234 |  180 |  174 |
| `prover.openings_time_ms` |  36.86 |  258 |  41 |  34 |
...
| `prover.openings.whir_time_ms` |  19.29 |  135 |  22 |  17 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  476 |  952 |  550 |  402 |
| `execute_preflight_time_ms` |  8.50 |  17 |  14 |  3 |
| `trace_gen_time_ms   ` |  44.50 |  89 |  57 |  32 |
| `generate_blob_total_time_ms` |  3.50 |  7 |  4 |  3 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  430.50 |  861 |  492 |  369 |
| `prover.main_trace_commit_time_ms` |  199.50 |  399 |  238 |  161 |
| `prover.rap_constraints_time_ms` |  164.50 |  329 |  184 |  145 |
| `prover.openings_time_ms` |  65.50 |  131 |  69 |  62 |
| `prover.rap_constraints.logup_gkr_time_ms` |  42 |  84 |  49 |  35 |
| `prover.rap_constraints.round0_time_ms` |  72.50 |  145 |  80 |  65 |
| `prover.rap_constraints.mle_rounds_time_ms` |  49.50 |  99 |  54 |  45 |
...
| `prover.openings.whir_time_ms` |  29 |  58 |  29 |  29 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/0b423cbf5135a83cd19bf77c752dcf95d3aae328/fibonacci-0b423cbf5135a83cd19bf77c752dcf95d3aae328.memory.svg)
...
| app_proof |  |  |  |  |  | 538 |  |  | 73 | 12,000,265 | 163.17 | 0 | 3,946 |  | 
| internal_for_leaf |  |  |  | 388 |  |  |  |  |  |  |  |  |  | 388 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 26 | 388 | 26 | 9 | 1 | 4 | 1 | 
| internal_recursive.0 | 1 | 10 | 174 | 10 | 1 | 0 | 3 | 1 | 
| internal_recursive.1 | 1 | 8 | 149 | 8 | 1 | 0 | 2 | 0 | 
| leaf | 0 | 57 | 550 | 57 | 23 | 4 | 14 | 12 | 
| leaf | 1 | 32 | 402 | 32 | 17 | 3 | 3 | 2 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 75,533,952 | 361 | 162 | 0 | 9 | 145 | 39 | 39 | 72 | 32 | 0 | 53 | 20 | 32 | 5 | 26 | 163 | 145 | 0 | 2 | 32 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 23,651,975 | 163 | 48 | 0 | 3 | 69 | 23 | 22 | 27 | 18 | 0 | 43 | 20 | 23 | 1 | 21 | 49 | 69 | 0 | 2 | 17 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 17,507,975 | 141 | 34 | 0 | 3 | 63 | 21 | 20 | 24 | 17 | 0 | 42 | 20 | 22 | 1 | 20 | 35 | 63 | 0 | 2 | 16 | 0 | 0 | 
| leaf | 0 | prover | 187,180,090 | 492 | 237 | 0 | 15 | 184 | 80 | 79 | 54 | 49 | 0 | 69 | 29 | 39 | 12 | 27 | 238 | 184 | 0 | 5 | 48 | 0 | 0 | 
| leaf | 1 | prover | 130,615,306 | 369 | 160 | 0 | 10 | 145 | 65 | 64 | 45 | 35 | 0 | 62 | 29 | 33 | 8 | 24 | 161 | 145 | 0 | 5 | 34 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 212,425,530 | 280 | 59 | 0 | 1 | 180 | 32 | 31 | 19 | 128 | 0 | 39 | 19 | 19 | 6 | 13 | 60 | 180 | 0 | 3 | 127 | 0 | 0 | 
| app_proof | prover | 1 | 212,366,468 | 272 | 59 | 0 | 1 | 175 | 28 | 28 | 19 | 127 | 0 | 37 | 21 | 16 | 6 | 10 | 59 | 175 | 0 | 3 | 125 | 0 | 0 | 
| app_proof | prover | 2 | 212,366,468 | 271 | 59 | 0 | 1 | 176 | 30 | 30 | 19 | 126 | 0 | 34 | 17 | 16 | 6 | 10 | 60 | 176 | 0 | 3 | 125 | 0 | 0 | 
| app_proof | prover | 3 | 212,366,468 | 269 | 59 | 0 | 1 | 174 | 28 | 28 | 19 | 126 | 0 | 35 | 18 | 16 | 6 | 10 | 59 | 174 | 0 | 3 | 125 | 0 | 0 | 
| app_proof | prover | 4 | 212,366,468 | 273 | 60 | 0 | 1 | 178 | 30 | 30 | 19 | 127 | 0 | 35 | 18 | 16 | 6 | 10 | 60 | 177 | 0 | 3 | 126 | 0 | 0 | 
| app_proof | prover | 5 | 212,366,468 | 272 | 60 | 0 | 1 | 175 | 28 | 28 | 19 | 126 | 0 | 37 | 20 | 16 | 6 | 10 | 60 | 175 | 0 | 3 | 126 | 0 | 0 | 
| app_proof | prover | 6 | 212,423,724 | 277 | 59 | 0 | 1 | 176 | 29 | 29 | 19 | 127 | 0 | 41 | 22 | 18 | 6 | 12 | 60 | 176 | 0 | 3 | 126 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 161 | 673 | 161 | 171 | 0 | 150 | 60 | 1,747,000 | 41.19 | 
| app_proof | 1 | 158 | 529 | 158 | 40 | 0 | 149 | 57 | 1,747,000 | 39.84 | 
| app_proof | 2 | 162 | 531 | 162 | 40 | 0 | 153 | 56 | 1,747,000 | 40.98 | 
| app_proof | 3 | 162 | 528 | 162 | 40 | 0 | 152 | 55 | 1,747,000 | 41.32 | 
| app_proof | 4 | 162 | 533 | 162 | 40 | 0 | 152 | 57 | 1,747,000 | 39.82 | 
| app_proof | 5 | 163 | 533 | 163 | 40 | 0 | 154 | 55 | 1,747,000 | 41.35 | 
| app_proof | 6 | 171 | 538 | 171 | 40 | 0 | 163 | 48 | 1,518,265 | 41.39 | 

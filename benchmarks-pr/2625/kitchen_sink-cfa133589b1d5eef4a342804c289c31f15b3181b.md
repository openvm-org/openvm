...
|:---|---:|---:|---:|
| Total |  3.13 |  2.18 |  2.18 |
| app_proof |  2.36 |  1.41 |  1.41 |
| leaf |  0.40 |  0.40 |  0.40 |
...
| `total_proof_time_ms ` |  1,177.50 |  2,355 |  1,404 |  951 |
...
| `execute_preflight_insn_mi/s` |  8.78 | -          |  11.54 |  6.03 |
| `trace_gen_time_ms   ` |  158 |  316 |  188 |  128 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  836 |  1,672 |  1,011 |  661 |
| `prover.main_trace_commit_time_ms` |  218 |  436 |  286 |  150 |
| `prover.rap_constraints_time_ms` |  555.50 |  1,111 |  651 |  460 |
| `prover.openings_time_ms` |  61 |  122 |  72 |  50 |
| `prover.rap_constraints.logup_gkr_time_ms` |  138 |  276 |  151 |  125 |
| `prover.rap_constraints.round0_time_ms` |  286 |  572 |  362 |  210 |
| `prover.rap_constraints.mle_rounds_time_ms` |  130.50 |  261 |  137 |  124 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/cfa133589b1d5eef4a342804c289c31f15b3181b/kitchen_sink-cfa133589b1d5eef4a342804c289c31f15b3181b.memory.svg)
...
| app_proof |  |  |  |  |  | 951 |  |  | 7 | 154,763 | 20.24 | 0 | 2,367 |  | 
...
| internal_recursive.1 | 1 | 9 | 102 | 9 | 1 | 0 | 2 | 0 | 
| leaf | 0 | 94 | 403 | 94 | 25 | 12 | 25 | 6 | 
...
| leaf | 0 | prover | 407,935,872 | 309 | 125 | 0 | 9 | 140 | 44 | 43 | 36 | 59 | 0 | 43 | 12 | 30 | 6 | 23 | 125 | 140 | 0 | 2 | 59 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 816,542,084 | 1,011 | 286 | 0 | 157 | 651 | 362 | 361 | 137 | 151 | 59 | 72 | 12 | 59 | 15 | 44 | 286 | 651 | 0 | 1 | 90 | 0 | 0 | 
| app_proof | prover | 1 | 800,298,548 | 661 | 150 | 0 | 20 | 460 | 210 | 209 | 124 | 125 | 72 | 50 | 13 | 36 | 14 | 22 | 150 | 460 | 0 | 1 | 53 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 188 | 1,404 | 188 | 183 | 0 | 50 | 19 | 121,000 | 11.54 | 
| app_proof | 1 | 128 | 951 | 128 | 40 | 0 | 3 | 120 | 33,763 | 6.03 | 

...
| `total_proof_time_ms ` |  544.57 |  3,812 |  664 |  522 |
| `execute_metered_time_ms` |  74 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  162.10 | -          |  162.10 |  162.10 |
| `execute_preflight_insns` |  1,714,323.57 |  12,000,265 |  1,747,000 |  1,518,265 |
| `execute_preflight_time_ms` |  55.86 |  391 |  60 |  48 |
| `execute_preflight_insn_mi/s` |  40.37 | -          |  40.84 |  38.34 |
| `trace_gen_time_ms   ` |  158.57 |  1,110 |  165 |  154 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  269.86 |  1,889 |  277 |  266 |
| `prover.main_trace_commit_time_ms` |  59 |  413 |  60 |  58 |
| `prover.rap_constraints_time_ms` |  173.86 |  1,217 |  178 |  172 |
| `prover.openings_time_ms` |  35.71 |  250 |  40 |  33 |
...
| `prover.openings.whir_time_ms` |  18.71 |  131 |  21 |  17 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  472 |  944 |  542 |  402 |
| `execute_preflight_time_ms` |  8 |  16 |  13 |  3 |
| `trace_gen_time_ms   ` |  45 |  90 |  58 |  32 |
| `generate_blob_total_time_ms` |  3.50 |  7 |  4 |  3 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  426.50 |  853 |  483 |  370 |
| `prover.main_trace_commit_time_ms` |  196.50 |  393 |  234 |  159 |
| `prover.rap_constraints_time_ms` |  162.50 |  325 |  179 |  146 |
| `prover.openings_time_ms` |  67 |  134 |  70 |  64 |
| `prover.rap_constraints.logup_gkr_time_ms` |  41.50 |  83 |  48 |  35 |
| `prover.rap_constraints.round0_time_ms` |  71 |  142 |  77 |  65 |
| `prover.rap_constraints.mle_rounds_time_ms` |  48.50 |  97 |  52 |  45 |
| `prover.openings.stacked_reduction_time_ms` |  36.50 |  73 |  39 |  34 |
| `prover.openings.stacked_reduction.round0_time_ms` |  10 |  20 |  12 |  8 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  26.50 |  53 |  27 |  26 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/80238388a4f83d2b1a19b1aac37bddb8e2e3d72a/fibonacci-80238388a4f83d2b1a19b1aac37bddb8e2e3d72a.memory.svg)
...
| app_proof |  |  |  |  |  | 529 |  |  | 74 | 12,000,265 | 162.10 | 0 | 3,894 |  | 
| internal_for_leaf |  |  |  | 387 |  |  |  |  |  |  |  |  |  | 387 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 27 | 387 | 26 | 10 | 2 | 4 | 1 | 
| internal_recursive.0 | 1 | 11 | 167 | 11 | 1 | 0 | 3 | 1 | 
| internal_recursive.1 | 1 | 8 | 147 | 8 | 1 | 0 | 2 | 0 | 
| leaf | 0 | 58 | 542 | 58 | 23 | 4 | 13 | 11 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 75,533,952 | 360 | 161 | 0 | 9 | 145 | 38 | 38 | 73 | 32 | 0 | 53 | 21 | 32 | 5 | 26 | 161 | 145 | 0 | 2 | 31 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 23,651,975 | 156 | 47 | 0 | 3 | 69 | 23 | 22 | 27 | 18 | 0 | 39 | 15 | 23 | 1 | 21 | 47 | 69 | 0 | 2 | 17 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 17,507,975 | 138 | 33 | 0 | 3 | 63 | 21 | 21 | 24 | 16 | 0 | 40 | 18 | 22 | 1 | 20 | 34 | 63 | 0 | 2 | 16 | 0 | 0 | 
| leaf | 0 | prover | 187,180,090 | 483 | 233 | 0 | 15 | 179 | 77 | 76 | 52 | 48 | 0 | 70 | 31 | 39 | 12 | 27 | 234 | 178 | 0 | 5 | 47 | 0 | 0 | 
| leaf | 1 | prover | 130,615,306 | 370 | 158 | 0 | 10 | 146 | 65 | 64 | 45 | 35 | 0 | 64 | 29 | 34 | 8 | 26 | 159 | 146 | 0 | 5 | 35 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 212,425,530 | 277 | 59 | 0 | 1 | 178 | 31 | 31 | 19 | 127 | 0 | 38 | 19 | 19 | 6 | 13 | 60 | 178 | 0 | 2 | 126 | 0 | 0 | 
| app_proof | prover | 1 | 212,366,468 | 269 | 58 | 0 | 1 | 174 | 27 | 27 | 19 | 127 | 0 | 36 | 20 | 16 | 6 | 10 | 58 | 174 | 0 | 3 | 125 | 0 | 0 | 
| app_proof | prover | 2 | 212,366,468 | 267 | 59 | 0 | 1 | 172 | 27 | 27 | 19 | 125 | 0 | 34 | 18 | 16 | 6 | 10 | 59 | 172 | 0 | 3 | 125 | 0 | 0 | 
| app_proof | prover | 3 | 212,366,468 | 266 | 59 | 0 | 1 | 173 | 28 | 27 | 19 | 125 | 0 | 33 | 17 | 16 | 6 | 10 | 59 | 173 | 0 | 3 | 125 | 0 | 0 | 
| app_proof | prover | 4 | 212,366,468 | 267 | 59 | 0 | 1 | 173 | 28 | 27 | 19 | 126 | 0 | 33 | 17 | 16 | 6 | 10 | 59 | 173 | 0 | 3 | 125 | 0 | 0 | 
| app_proof | prover | 5 | 212,366,468 | 269 | 59 | 0 | 1 | 173 | 27 | 27 | 19 | 126 | 0 | 36 | 19 | 16 | 6 | 10 | 59 | 173 | 0 | 3 | 125 | 0 | 0 | 
| app_proof | prover | 6 | 212,423,724 | 274 | 59 | 0 | 1 | 174 | 28 | 28 | 19 | 126 | 0 | 40 | 21 | 18 | 6 | 12 | 59 | 174 | 0 | 3 | 125 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 156 | 664 | 156 | 170 | 0 | 145 | 60 | 1,747,000 | 40.42 | 
| app_proof | 1 | 154 | 524 | 154 | 40 | 0 | 145 | 59 | 1,747,000 | 38.34 | 
| app_proof | 2 | 159 | 524 | 159 | 40 | 0 | 150 | 56 | 1,747,000 | 40.77 | 
| app_proof | 3 | 159 | 522 | 159 | 40 | 0 | 150 | 56 | 1,747,000 | 40.80 | 
| app_proof | 4 | 159 | 524 | 159 | 40 | 0 | 150 | 56 | 1,747,000 | 40.84 | 
| app_proof | 5 | 158 | 525 | 158 | 40 | 0 | 149 | 56 | 1,747,000 | 40.69 | 
| app_proof | 6 | 165 | 529 | 165 | 40 | 0 | 157 | 48 | 1,518,265 | 40.73 | 

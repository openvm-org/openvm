...
|:---|---:|---:|---:|
| Total |  18.86 |  5.32 |  5.32 |
| app_proof |  15.81 |  3.04 |  3.04 |
| leaf |  2.19 |  1.42 |  1.42 |
...
| `total_proof_time_ms ` |  2,629.33 |  15,776 |  3,007 |  2,538 |
...
| `execute_preflight_time_ms` |  187.67 |  1,126 |  283 |  16 |
| `execute_preflight_insn_mi/s` |  19.27 | -          |  19.71 |  18.99 |
| `trace_gen_time_ms   ` |  385.67 |  2,314 |  543 |  349 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,992.33 |  11,954 |  2,276 |  1,932 |
| `prover.main_trace_commit_time_ms` |  693.17 |  4,159 |  860 |  658 |
| `prover.rap_constraints_time_ms` |  1,114 |  6,684 |  1,233 |  1,086 |
| `prover.openings_time_ms` |  184 |  1,104 |  187 |  181 |
| `prover.rap_constraints.logup_gkr_time_ms` |  277.17 |  1,663 |  392 |  254 |
| `prover.rap_constraints.round0_time_ms` |  520.50 |  3,123 |  524 |  516 |
| `prover.rap_constraints.mle_rounds_time_ms` |  315.33 |  1,892 |  319 |  313 |
| `prover.openings.stacked_reduction_time_ms` |  141.33 |  848 |  143 |  140 |
| `prover.openings.stacked_reduction.round0_time_ms` |  86 |  516 |  87 |  85 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  54.83 |  329 |  57 |  54 |
| `prover.openings.whir_time_ms` |  41.83 |  251 |  46 |  39 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,094.50 |  2,189 |  1,418 |  771 |
| `execute_preflight_time_ms` |  23 |  46 |  31 |  15 |
| `trace_gen_time_ms   ` |  128 |  256 |  171 |  85 |
| `generate_blob_total_time_ms` |  25.50 |  51 |  34 |  17 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  966 |  1,932 |  1,246 |  686 |
| `prover.main_trace_commit_time_ms` |  547.50 |  1,095 |  719 |  376 |
| `prover.rap_constraints_time_ms` |  312 |  624 |  400 |  224 |
| `prover.openings_time_ms` |  105 |  210 |  125 |  85 |
| `prover.rap_constraints.logup_gkr_time_ms` |  66.50 |  133 |  82 |  51 |
| `prover.rap_constraints.round0_time_ms` |  149.50 |  299 |  195 |  104 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/cfa133589b1d5eef4a342804c289c31f15b3181b/keccak-cfa133589b1d5eef4a342804c289c31f15b3181b.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 76 | 9 |  |  | 0 |  | 358 | 9 |  |  |  |  |  |  | 
| app_proof |  |  |  |  |  | 2,541 |  |  | 36 | 1,235,218 | 33.45 | 0 | 15,822 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 37 | 523 | 36 | 13 | 4 | 6 | 4 | 
| internal_recursive.0 | 1 | 13 | 182 | 12 | 2 | 1 | 4 | 1 | 
| internal_recursive.1 | 1 | 9 | 151 | 8 | 1 | 0 | 2 | 0 | 
| leaf | 0 | 171 | 1,418 | 171 | 65 | 34 | 31 | 25 | 
| leaf | 1 | 85 | 771 | 84 | 32 | 17 | 15 | 10 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 109,497,984 | 486 | 248 | 0 | 14 | 173 | 45 | 45 | 94 | 33 | 0 | 64 | 25 | 38 | 7 | 31 | 248 | 173 | 0 | 3 | 32 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 25,962,119 | 169 | 51 | 0 | 4 | 76 | 23 | 23 | 29 | 23 | 0 | 40 | 16 | 24 | 2 | 22 | 52 | 76 | 0 | 2 | 21 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 17,507,975 | 142 | 34 | 0 | 4 | 65 | 22 | 22 | 24 | 17 | 0 | 42 | 19 | 22 | 1 | 21 | 34 | 65 | 0 | 2 | 17 | 0 | 0 | 
| leaf | 0 | prover | 583,523,386 | 1,246 | 719 | 0 | 47 | 400 | 195 | 195 | 122 | 82 | 0 | 125 | 39 | 86 | 40 | 45 | 719 | 400 | 0 | 6 | 81 | 0 | 0 | 
| leaf | 1 | prover | 300,618,208 | 686 | 375 | 0 | 24 | 224 | 104 | 104 | 68 | 51 | 0 | 85 | 32 | 52 | 19 | 32 | 376 | 224 | 0 | 5 | 49 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,205,061,845 | 2,276 | 860 | 0 | 254 | 1,233 | 521 | 520 | 319 | 392 | 136 | 182 | 39 | 142 | 85 | 57 | 860 | 1,233 | 0 | 3 | 254 | 0 | 0 | 
| app_proof | prover | 1 | 1,205,053,652 | 1,932 | 658 | 0 | 51 | 1,086 | 516 | 516 | 314 | 254 | 0 | 187 | 46 | 140 | 85 | 54 | 658 | 1,086 | 0 | 4 | 253 | 0 | 0 | 
| app_proof | prover | 2 | 1,205,053,652 | 1,933 | 659 | 0 | 51 | 1,090 | 522 | 521 | 313 | 254 | 0 | 183 | 41 | 141 | 87 | 54 | 659 | 1,090 | 0 | 3 | 253 | 0 | 0 | 
| app_proof | prover | 3 | 1,205,053,652 | 1,936 | 661 | 0 | 51 | 1,087 | 518 | 517 | 315 | 254 | 0 | 186 | 44 | 142 | 87 | 54 | 661 | 1,087 | 0 | 3 | 253 | 0 | 0 | 
| app_proof | prover | 4 | 1,205,053,652 | 1,935 | 661 | 0 | 51 | 1,091 | 522 | 522 | 314 | 254 | 0 | 181 | 40 | 140 | 86 | 54 | 661 | 1,091 | 0 | 3 | 252 | 0 | 0 | 
| app_proof | prover | 5 | 1,205,062,652 | 1,942 | 659 | 0 | 52 | 1,097 | 524 | 523 | 317 | 255 | 0 | 185 | 41 | 143 | 86 | 56 | 660 | 1,097 | 0 | 3 | 254 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 543 | 3,007 | 543 | 171 | 0 | 190 | 16 | 207,000 | 18.99 | 
| app_proof | 1 | 349 | 2,607 | 349 | 40 | 0 | 1 | 283 | 207,000 | 19.19 | 
| app_proof | 2 | 350 | 2,538 | 350 | 40 | 0 | 1 | 213 | 207,000 | 19.25 | 
| app_proof | 3 | 350 | 2,544 | 350 | 40 | 0 | 1 | 216 | 207,000 | 19.35 | 
| app_proof | 4 | 351 | 2,539 | 351 | 40 | 0 | 2 | 212 | 207,000 | 19.10 | 
| app_proof | 5 | 371 | 2,541 | 371 | 40 | 0 | 23 | 186 | 200,218 | 19.71 | 

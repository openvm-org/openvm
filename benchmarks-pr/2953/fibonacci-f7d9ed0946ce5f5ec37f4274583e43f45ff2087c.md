...
|:---|---:|---:|---:|
| Total |  2.01 |  1.77 |  1.77 |
| app_proof |  1 |  0.76 |  0.76 |
| leaf |  0.40 |  0.40 |  0.40 |
...
| `total_proof_time_ms ` |  490 |  980 |  736 |  244 |
| `compile_metered_time_ms` |  4 |  4 |  4 |  4 |
| `execute_metered_time_ms` |  21 | -          | -          | -          |
| `execute_metered_insns` |  4,000,051 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  188.45 | -          |  188.45 |  188.45 |
| `execute_preflight_insns` |  2,000,025.50 |  4,000,051 |  3,495,000 |  505,051 |
| `execute_preflight_time_ms` |  49.50 |  99 |  83 |  16 |
| `execute_preflight_insn_mi/s` |  45.52 | -          |  48.26 |  42.77 |
| `trace_gen_time_ms   ` |  40 |  80 |  57 |  23 |
| `set_initial_memory_time_ms` |  87.50 |  175 |  134 |  41 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  312 |  624 |  495 |  129 |
| `prover.main_trace_commit_time_ms` |  63.50 |  127 |  100 |  27 |
| `prover.rap_constraints_time_ms` |  177.50 |  355 |  289 |  66 |
| `prover.openings_time_ms` |  70 |  140 |  104 |  36 |
| `prover.rap_constraints.logup_gkr_time_ms` |  128 |  256 |  214 |  42 |
| `prover.rap_constraints.round0_time_ms` |  32 |  64 |  51 |  13 |
| `prover.rap_constraints.mle_rounds_time_ms` |  16 |  32 |  23 |  9 |
| `prover.openings.stacked_reduction_time_ms` |  12.50 |  25 |  20 |  5 |
| `prover.openings.stacked_reduction.round0_time_ms` |  6.50 |  13 |  11 |  2 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  6 |  12 |  9 |  3 |
| `prover.openings.whir_time_ms` |  57 |  114 |  84 |  30 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/f7d9ed0946ce5f5ec37f4274583e43f45ff2087c/fibonacci-f7d9ed0946ce5f5ec37f4274583e43f45ff2087c.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 73 |  |  |  | 347 |  |  |  |  |  |  | 
| app_proof |  |  |  | 244 |  | 21 | 4,000,051 | 188.45 | 0 | 1,007 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 27,277,885 | 262 | 83 | 0 | 0 | 100 | 32 | 31 | 46 | 22 | 0 | 77 | 66 | 11 | 2 | 8 | 84 | 84 | 100 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 174 | 48 | 0 | 0 | 68 | 26 | 25 | 28 | 14 | 0 | 56 | 48 | 8 | 1 | 6 | 48 | 48 | 68 | 0 | 3 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 137 | 32 | 0 | 0 | 63 | 23 | 23 | 24 | 14 | 0 | 40 | 33 | 7 | 1 | 5 | 33 | 32 | 63 | 0 | 3 | 13 | 0 | 0 | 
| leaf | 0 | prover | 74,839,864 | 361 | 125 | 0 | 0 | 118 | 53 | 52 | 35 | 29 | 0 | 116 | 101 | 14 | 6 | 8 | 126 | 125 | 118 | 0 | 7 | 28 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 120,844,884 | 495 | 100 | 0 | 0 | 289 | 51 | 51 | 23 | 214 | 0 | 104 | 84 | 20 | 11 | 9 | 100 | 100 | 289 | 0 | 3 | 213 | 0 | 0 | 
| app_proof | prover | 1 | 26,471,904 | 129 | 26 | 0 | 0 | 66 | 13 | 13 | 9 | 42 | 0 | 36 | 30 | 5 | 2 | 3 | 27 | 26 | 66 | 0 | 3 | 41 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 134 | 2 | 23 | 736 | 23 | 134 | 2,455,642,931 | 477,010,073 | 2,932,653,004 | 2,097,152 | 0 | 3 | 83 | 3,495,000 | 42.77 | 
| app_proof | 1 | 41 | 1 | 57 | 244 | 57 | 41 | 420,241,822 | 191,598,017 | 611,839,839 | 2,097,152 | 0 | 2 | 16 | 505,051 | 48.26 | 

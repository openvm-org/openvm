...
|:---|---:|---:|---:|
| Total |  9.99 |  6.99 |  6.99 |
| app_proof |  8.31 |  5.31 |  5.31 |
| leaf |  1 |  1 |  1 |
...
| `total_proof_time_ms ` |  4,112.50 |  8,225 |  5,224 |  3,001 |
...
| `execute_preflight_time_ms` |  246 |  492 |  284 |  208 |
| `execute_preflight_insn_mi/s` |  36.87 | -          |  38.84 |  34.89 |
| `trace_gen_time_ms   ` |  123.50 |  247 |  176 |  71 |
| `set_initial_memory_time_ms` |  87.50 |  175 |  134 |  41 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  3,654 |  7,308 |  4,705 |  2,603 |
| `prover.main_trace_commit_time_ms` |  969.50 |  1,939 |  1,353 |  586 |
| `prover.rap_constraints_time_ms` |  1,977 |  3,954 |  2,451 |  1,503 |
| `prover.openings_time_ms` |  706.50 |  1,413 |  900 |  513 |
| `prover.rap_constraints.logup_gkr_time_ms` |  556 |  1,112 |  606 |  506 |
| `prover.rap_constraints.round0_time_ms` |  1,043 |  2,086 |  1,356 |  730 |
| `prover.rap_constraints.mle_rounds_time_ms` |  377 |  754 |  488 |  266 |
...
| `prover.openings.whir_time_ms` |  540 |  1,080 |  684 |  396 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/f7d9ed0946ce5f5ec37f4274583e43f45ff2087c/sha2_bench-f7d9ed0946ce5f5ec37f4274583e43f45ff2087c.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 69 |  |  |  | 345 |  |  |  |  |  |  | 
| app_proof |  |  |  | 3,001 |  | 86 | 11,167,961 | 129.07 | 0 | 8,317 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 325 | 117 | 0 | 0 | 108 | 34 | 33 | 52 | 21 | 0 | 99 | 85 | 13 | 3 | 9 | 117 | 117 | 108 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 171 | 46 | 0 | 0 | 67 | 25 | 24 | 28 | 14 | 0 | 56 | 48 | 8 | 1 | 6 | 46 | 46 | 67 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 136 | 32 | 0 | 0 | 61 | 23 | 22 | 24 | 13 | 0 | 42 | 35 | 7 | 1 | 5 | 33 | 32 | 61 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 237,929,016 | 896 | 373 | 0 | 0 | 229 | 110 | 109 | 67 | 51 | 0 | 293 | 255 | 37 | 19 | 17 | 373 | 373 | 229 | 0 | 12 | 50 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,303,019,770 | 4,705 | 1,352 | 0 | 0 | 2,451 | 1,356 | 1,356 | 488 | 606 | 1 | 900 | 684 | 215 | 134 | 81 | 1,353 | 1,352 | 2,451 | 0 | 7 | 603 | 0 | 0 | 
| app_proof | prover | 1 | 740,851,960 | 2,603 | 586 | 0 | 0 | 1,503 | 730 | 729 | 266 | 506 | 0 | 513 | 396 | 116 | 70 | 46 | 586 | 586 | 1,503 | 0 | 6 | 505 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 134 | 1 | 176 | 5,224 | 176 | 134 | 13,211,583,828 | 2,431,104,612 | 15,642,688,440 | 2,097,152 | 0 | 4 | 208 | 7,134,000 | 34.89 | 
| app_proof | 1 | 41 | 1 | 71 | 3,001 | 71 | 41 | 7,501,802,352 | 1,396,518,993 | 8,898,321,345 | 2,097,152 | 0 | 2 | 284 | 4,033,961 | 38.84 | 

...
| `total_proof_time_ms ` |  1,976 |  3,952 |  2,365 |  1,587 |
| `compile_metered_time_ms` |  5 |  5 |  5 |  5 |
| `execute_metered_time_ms` |  57 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  194.71 | -          |  194.71 |  194.71 |
| `execute_preflight_insns` |  5,583,980.50 |  11,167,961 |  7,136,000 |  4,031,961 |
| `execute_preflight_time_ms` |  349 |  698 |  481 |  217 |
| `execute_preflight_insn_mi/s` |  34.94 | -          |  36.03 |  33.85 |
| `trace_gen_time_ms   ` |  73 |  146 |  102 |  44 |
| `set_initial_memory_time_ms` |  0 |  0 |  0 |  0 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,553 |  3,106 |  2,045 |  1,061 |
| `prover.main_trace_commit_time_ms` |  393 |  786 |  570 |  216 |
| `prover.rap_constraints_time_ms` |  892 |  1,784 |  1,129 |  655 |
| `prover.openings_time_ms` |  267 |  534 |  345 |  189 |
| `prover.rap_constraints.logup_gkr_time_ms` |  206.50 |  413 |  230 |  183 |
| `prover.rap_constraints.round0_time_ms` |  506.50 |  1,013 |  667 |  346 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/d20d10d946053c97e5427a503f5317bb60f95e94/sha2_bench-d20d10d946053c97e5427a503f5317bb60f95e94.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 58 |  |  |  | 288 |  |  |  |  |  |  | 
| app_proof |  |  |  | 1,587 |  | 57 | 11,167,961 | 194.71 | 0 | 4,017 |  | 
...
| leaf | 0 | prover | 237,929,144 | 404 | 145 | 0 | 0 | 141 | 70 | 69 | 44 | 26 | 0 | 116 | 94 | 22 | 10 | 11 | 145 | 145 | 141 | 0 | 3 | 25 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,282,180,346 | 2,045 | 569 | 0 | 0 | 1,129 | 667 | 666 | 231 | 230 | 1 | 345 | 251 | 93 | 57 | 36 | 570 | 569 | 1,129 | 0 | 1 | 228 | 0 | 0 | 
| app_proof | prover | 1 | 689,540,880 | 1,061 | 216 | 0 | 0 | 655 | 346 | 346 | 125 | 183 | 0 | 189 | 137 | 51 | 30 | 20 | 216 | 216 | 655 | 0 | 1 | 182 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 0 | 2 | 102 | 2,365 | 102 | 0 | 12,592,389,780 | 2,800,225,572 | 15,392,615,352 | 2,097,152 | 0 | 4 | 217 | 7,136,000 | 33.85 | 
| app_proof | 1 | 0 | 1 | 44 | 1,587 | 44 | 0 | 7,146,132,540 | 1,134,809,220 | 8,280,941,760 | 2,097,152 | 0 | 2 | 481 | 4,031,961 | 36.03 | 

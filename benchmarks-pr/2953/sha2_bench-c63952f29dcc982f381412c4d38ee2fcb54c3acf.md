...
|:---|---:|---:|---:|
| Total |  9.90 |  6.94 |  6.94 |
| app_proof |  8.22 |  5.26 |  5.26 |
| leaf |  1 |  1 |  1 |
...
| `total_proof_time_ms ` |  4,068 |  8,136 |  5,177 |  2,959 |
| `compile_metered_time_ms` |  3 |  3 |  3 |  3 |
| `execute_metered_time_ms` |  86 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  128.72 | -          |  128.72 |  128.72 |
| `execute_preflight_insns` |  5,583,980.50 |  11,167,961 |  7,134,000 |  4,033,961 |
| `execute_preflight_time_ms` |  239.50 |  479 |  272 |  207 |
| `execute_preflight_insn_mi/s` |  37.05 | -          |  39.15 |  34.95 |
| `trace_gen_time_ms   ` |  123 |  246 |  175 |  71 |
| `set_initial_memory_time_ms` |  87.50 |  175 |  134 |  41 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  3,616.50 |  7,233 |  4,660 |  2,573 |
| `prover.main_trace_commit_time_ms` |  962 |  1,924 |  1,340 |  584 |
| `prover.rap_constraints_time_ms` |  1,947 |  3,894 |  2,419 |  1,475 |
| `prover.openings_time_ms` |  706 |  1,412 |  900 |  512 |
| `prover.rap_constraints.logup_gkr_time_ms` |  550.50 |  1,101 |  601 |  500 |
| `prover.rap_constraints.round0_time_ms` |  1,018 |  2,036 |  1,328 |  708 |
| `prover.rap_constraints.mle_rounds_time_ms` |  378 |  756 |  489 |  267 |
| `prover.openings.stacked_reduction_time_ms` |  166.50 |  333 |  217 |  116 |
| `prover.openings.stacked_reduction.round0_time_ms` |  103 |  206 |  135 |  71 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  63 |  126 |  81 |  45 |
| `prover.openings.whir_time_ms` |  539.50 |  1,079 |  683 |  396 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/c63952f29dcc982f381412c4d38ee2fcb54c3acf/sha2_bench-c63952f29dcc982f381412c4d38ee2fcb54c3acf.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 67 |  |  |  | 341 |  |  |  |  |  |  | 
| app_proof |  |  |  | 2,959 |  | 86 | 11,167,961 | 128.72 | 0 | 8,228 |  | 
...
| app_proof | VmAirWrapper<Rv64BranchAdapterAir, BranchLessThanCoreAir<4, 16> | 0 | 1 | 4 | 
| app_proof | VmAirWrapper<Rv64CondRdWriteAdapterAir, Rv64JalLuiCoreAir> | 0 | 1 | 3 | 
| app_proof | VmAirWrapper<Rv64ImmBaseAluU16AdapterAir, AddICoreAir<4, 16> | 0 |  | 92 | 
...
| leaf | 0 | 110 | 1,002 | 110 | 35 | 17 | 2 | 7 | 7 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 325 | 118 | 0 | 0 | 109 | 36 | 35 | 52 | 20 | 0 | 97 | 84 | 13 | 3 | 9 | 118 | 118 | 109 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 173 | 47 | 0 | 0 | 68 | 25 | 24 | 28 | 14 | 0 | 56 | 48 | 8 | 1 | 6 | 48 | 47 | 68 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 136 | 31 | 0 | 0 | 60 | 22 | 21 | 24 | 13 | 0 | 44 | 37 | 7 | 1 | 5 | 32 | 31 | 60 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 237,929,016 | 891 | 373 | 0 | 0 | 228 | 109 | 108 | 67 | 51 | 0 | 289 | 251 | 37 | 20 | 17 | 373 | 373 | 228 | 0 | 9 | 50 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,303,019,770 | 4,660 | 1,339 | 0 | 0 | 2,419 | 1,328 | 1,327 | 489 | 601 | 0 | 900 | 683 | 217 | 135 | 81 | 1,340 | 1,339 | 2,419 | 0 | 5 | 599 | 0 | 0 | 
| app_proof | prover | 1 | 740,851,960 | 2,573 | 584 | 0 | 0 | 1,475 | 708 | 707 | 267 | 500 | 0 | 512 | 396 | 116 | 71 | 45 | 584 | 584 | 1,475 | 0 | 5 | 499 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 134 | 1 | 175 | 5,177 | 175 | 134 | 13,211,583,828 | 2,431,104,612 | 15,642,688,440 | 2,097,152 | 0 | 3 | 207 | 7,134,000 | 34.95 | 
| app_proof | 1 | 41 | 1 | 71 | 2,959 | 71 | 41 | 7,501,802,352 | 1,396,518,993 | 8,898,321,345 | 2,097,152 | 0 | 2 | 272 | 4,033,961 | 39.15 | 

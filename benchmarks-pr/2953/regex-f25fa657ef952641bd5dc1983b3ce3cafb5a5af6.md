...
| `total_proof_time_ms ` |  1,205 |  1,205 |  1,205 |  1,205 |
| `compile_metered_time_ms` |  8 |  8 |  8 |  8 |
| `execute_metered_time_ms` |  30 | -          | -          | -          |
| `execute_metered_insns` |  4,090,656 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  135.07 | -          |  135.07 |  135.07 |
| `execute_preflight_insns` |  4,090,656 |  4,090,656 |  4,090,656 |  4,090,656 |
| `execute_preflight_time_ms` |  125 |  125 |  125 |  125 |
| `execute_preflight_insn_mi/s` |  34.45 | -          |  34.45 |  34.45 |
| `trace_gen_time_ms   ` |  33 |  33 |  33 |  33 |
| `set_initial_memory_time_ms` |  133 |  133 |  133 |  133 |
| `memory_finalize_time_ms` |  1 |  1 |  1 |  1 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  913 |  913 |  913 |  913 |
| `prover.main_trace_commit_time_ms` |  203 |  203 |  203 |  203 |
| `prover.rap_constraints_time_ms` |  523 |  523 |  523 |  523 |
| `prover.openings_time_ms` |  186 |  186 |  186 |  186 |
| `prover.rap_constraints.logup_gkr_time_ms` |  314 |  314 |  314 |  314 |
| `prover.rap_constraints.round0_time_ms` |  155 |  155 |  155 |  155 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  362 |  362 |  362 |  362 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/f25fa657ef952641bd5dc1983b3ce3cafb5a5af6/regex-f25fa657ef952641bd5dc1983b3ce3cafb5a5af6.memory.svg)

| Module | Max (GB) | Max At |
| --- | ---: | --- |
| frac_sumcheck.gkr_rounds | 4.79 | app_proof.prover.0 |
| prover.batch_constraints.before_round0 | 4.79 | app_proof.prover.0 |
| prover.gkr_input_evals | 4.67 | app_proof.prover.0 |
| frac_sumcheck.segment_tree | 4.67 | app_proof.prover.0 |
| prover.stacked_commit | 2.91 | app_proof.prover.0 |
| prover.rap_constraints | 2.40 | app_proof.prover.0 |
| prover.batch_constraints.fold_ple_evals | 2.40 | app_proof.prover.0 |
| prover.batch_constraints.round0 | 2.40 | app_proof.prover.0 |
...
| prover.rs_code_matrix | 2.05 | app_proof.prover.0 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 71 |  |  |  | 347 |  |  |  |  |  |  | 
| app_proof |  |  |  | 1,205 |  | 30 | 4,090,656 | 135.07 | 0 | 1,249 |  | 
...
| --- | --- | --- | --- | --- | --- |
| app_proof | KeccakfOpAir | 27 | KeccakfOpAir | 0 | 320 | 
| app_proof | PhantomAir | 6 | PhantomAir | 0 | 20 | 
| app_proof | Rv64HintStoreAir | 24 | Rv64HintStoreAir | 0 | 127,936 | 
...
| app_proof | VmAirWrapper<Rv64BaseAluU16AdapterAir, AddSubCoreAir<4, 16> | 8 | VmAirWrapper<Rv64BaseAluU16AdapterAir, AddSubCoreAir<4, 16> | 0 | 19,308,864 | 
...
| app_proof | VmAirWrapper<Rv64ImmBaseAluU16AdapterAir, AddICoreAir<4, 16> | 23 | VmAirWrapper<Rv64ImmBaseAluU16AdapterAir, AddICoreAir<4, 16> | 0 | 29,439,652 | 
...
| app_proof | VmAirWrapper<Rv64MultAdapterAir, DivRemCoreAir<8, 8> | 32 | VmAirWrapper<Rv64MultAdapterAir, DivRemCoreAir<8, 8> | 0 | 2,280 | 
| app_proof | VmAirWrapper<Rv64MultAdapterAir, MulHCoreAir<8, 8> | 31 | VmAirWrapper<Rv64MultAdapterAir, MulHCoreAir<8, 8> | 0 | 9,540 | 
| app_proof | VmAirWrapper<Rv64MultAdapterAir, MultiplicationCoreAir<8, 8> | 29 | VmAirWrapper<Rv64MultAdapterAir, MultiplicationCoreAir<8, 8> | 0 | 293,328 | 
...
| app_proof | XorinVmAir | 25 | XorinVmAir | 0 | 656 | 
...
| app_proof | VmAirWrapper<Rv64BaseAluU16AdapterAir, AddSubCoreAir<4, 16> | 0 |  | 1 | 
...
| app_proof | 20 | VmAirWrapper<Rv64LoadStoreAdapterAir, LoadSignExtendCoreAir<8, 8> | LOADB | 0 | 854 | 
| app_proof | 20 | VmAirWrapper<Rv64LoadStoreAdapterAir, LoadSignExtendCoreAir<8, 8> | LOADH | 0 | 27 | 
| app_proof | 20 | VmAirWrapper<Rv64LoadStoreAdapterAir, LoadSignExtendCoreAir<8, 8> | LOADW | 0 | 84,632 | 
| app_proof | 21 | VmAirWrapper<Rv64LoadStoreAdapterAir, LoadStoreCoreAir<8> | LOADBU | 0 | 25,186 | 
| app_proof | 21 | VmAirWrapper<Rv64LoadStoreAdapterAir, LoadStoreCoreAir<8> | LOADD | 0 | 944,887 | 
| app_proof | 21 | VmAirWrapper<Rv64LoadStoreAdapterAir, LoadStoreCoreAir<8> | LOADHU | 0 | 85 | 
| app_proof | 21 | VmAirWrapper<Rv64LoadStoreAdapterAir, LoadStoreCoreAir<8> | LOADWU | 0 | 88,140 | 
| app_proof | 21 | VmAirWrapper<Rv64LoadStoreAdapterAir, LoadStoreCoreAir<8> | STOREB | 0 | 2,156 | 
| app_proof | 21 | VmAirWrapper<Rv64LoadStoreAdapterAir, LoadStoreCoreAir<8> | STORED | 0 | 643,811 | 
| app_proof | 21 | VmAirWrapper<Rv64LoadStoreAdapterAir, LoadStoreCoreAir<8> | STOREH | 0 | 10,078 | 
| app_proof | 21 | VmAirWrapper<Rv64LoadStoreAdapterAir, LoadStoreCoreAir<8> | STOREW | 0 | 117,456 | 
| app_proof | 23 | VmAirWrapper<Rv64BaseAluWU16AdapterAir, ShiftLogicalCoreAir<2, 16> | SLLW | 0 | 1 | 
| app_proof | 23 | VmAirWrapper<Rv64BaseAluWU16AdapterAir, ShiftLogicalCoreAir<2, 16> | SRLW | 0 | 96 | 
| app_proof | 24 | VmAirWrapper<Rv64BaseAluU16AdapterAir, ShiftRightArithmeticCoreAir<4, 16> | SRA | 0 | 91 | 
| app_proof | 25 | VmAirWrapper<Rv64BaseAluU16AdapterAir, ShiftLogicalCoreAir<4, 16> | SLL | 0 | 296,132 | 
| app_proof | 25 | VmAirWrapper<Rv64BaseAluU16AdapterAir, ShiftLogicalCoreAir<4, 16> | SRL | 0 | 52,665 | 
| app_proof | 26 | VmAirWrapper<Rv64BaseAluU16AdapterAir, LessThanCoreAir<4, 16> | SLT | 0 | 94 | 
| app_proof | 26 | VmAirWrapper<Rv64BaseAluU16AdapterAir, LessThanCoreAir<4, 16> | SLTU | 0 | 18,698 | 
| app_proof | 27 | VmAirWrapper<Rv64BaseAluWU16AdapterAir, AddSubCoreAir<2, 16> | ADDW | 0 | 438 | 
| app_proof | 27 | VmAirWrapper<Rv64BaseAluWU16AdapterAir, AddSubCoreAir<2, 16>
...
|:---|---:|---:|---:|
| Total |  10.14 |  7.09 |  7.09 |
| app_proof |  8.44 |  5.39 |  5.39 |
| leaf |  1.02 |  1.02 |  1.02 |
...
| `total_proof_time_ms ` |  4,174.50 |  8,349 |  5,299 |  3,050 |
...
| `execute_preflight_time_ms` |  244.50 |  489 |  280 |  209 |
| `execute_preflight_insn_mi/s` |  36.96 | -          |  39.33 |  34.59 |
| `trace_gen_time_ms   ` |  123.50 |  247 |  176 |  71 |
| `set_initial_memory_time_ms` |  87.50 |  175 |  134 |  41 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  3,717.50 |  7,435 |  4,779 |  2,656 |
| `prover.main_trace_commit_time_ms` |  977 |  1,954 |  1,360 |  594 |
| `prover.rap_constraints_time_ms` |  2,025 |  4,050 |  2,508 |  1,542 |
| `prover.openings_time_ms` |  714.50 |  1,429 |  910 |  519 |
| `prover.rap_constraints.logup_gkr_time_ms` |  566.50 |  1,133 |  614 |  519 |
| `prover.rap_constraints.round0_time_ms` |  1,069 |  2,138 |  1,390 |  748 |
| `prover.rap_constraints.mle_rounds_time_ms` |  388.50 |  777 |  503 |  274 |
| `prover.openings.stacked_reduction_time_ms` |  170.50 |  341 |  221 |  120 |
...
| `prover.openings.whir_time_ms` |  544 |  1,088 |  689 |  399 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/73552d98e87bbd9477e6888a1d37bc7cd612ae6f/sha2_bench-73552d98e87bbd9477e6888a1d37bc7cd612ae6f.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 70 |  |  |  | 342 |  |  |  |  |  |  | 
| app_proof |  |  |  | 3,050 |  | 86 | 11,167,961 | 128.79 | 0 | 8,442 |  | 
...
| leaf | 0 | 110 | 1,016 | 110 | 34 | 17 | 2 | 7 | 7 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 330 | 119 | 0 | 0 | 109 | 35 | 35 | 52 | 21 | 0 | 100 | 86 | 13 | 3 | 10 | 119 | 119 | 109 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 172 | 48 | 0 | 0 | 68 | 25 | 25 | 28 | 14 | 0 | 55 | 46 | 8 | 1 | 6 | 48 | 48 | 68 | 0 | 3 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 139 | 32 | 0 | 0 | 63 | 23 | 22 | 24 | 15 | 0 | 42 | 35 | 7 | 1 | 5 | 33 | 32 | 63 | 0 | 2 | 13 | 0 | 0 | 
| leaf | 0 | prover | 237,929,016 | 905 | 377 | 0 | 0 | 232 | 113 | 112 | 68 | 51 | 0 | 295 | 256 | 38 | 20 | 17 | 377 | 377 | 232 | 0 | 12 | 50 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,303,019,770 | 4,779 | 1,360 | 0 | 0 | 2,508 | 1,390 | 1,389 | 503 | 614 | 1 | 910 | 689 | 221 | 139 | 81 | 1,360 | 1,360 | 2,508 | 0 | 6 | 612 | 0 | 0 | 
| app_proof | prover | 1 | 740,851,960 | 2,656 | 593 | 0 | 0 | 1,542 | 748 | 748 | 274 | 519 | 0 | 519 | 399 | 120 | 72 | 47 | 594 | 593 | 1,542 | 0 | 7 | 518 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 134 | 1 | 176 | 5,299 | 176 | 134 | 13,211,583,828 | 2,431,104,612 | 15,642,688,440 | 2,097,152 | 0 | 3 | 209 | 7,134,000 | 34.59 | 
| app_proof | 1 | 41 | 1 | 71 | 3,050 | 71 | 41 | 7,501,802,352 | 1,396,518,993 | 8,898,321,345 | 2,097,152 | 0 | 2 | 280 | 4,033,961 | 39.33 | 

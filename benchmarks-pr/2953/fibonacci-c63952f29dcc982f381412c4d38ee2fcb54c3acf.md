...
| `total_proof_time_ms ` |  482 |  964 |  725 |  239 |
| `compile_metered_time_ms` |  4 |  4 |  4 |  4 |
| `execute_metered_time_ms` |  21 | -          | -          | -          |
| `execute_metered_insns` |  4,000,051 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  190.12 | -          |  190.12 |  190.12 |
| `execute_preflight_insns` |  2,000,025.50 |  4,000,051 |  3,495,000 |  505,051 |
| `execute_preflight_time_ms` |  47.50 |  95 |  80 |  15 |
| `execute_preflight_insn_mi/s` |  47.84 | -          |  50.84 |  44.85 |
| `trace_gen_time_ms   ` |  39 |  78 |  55 |  23 |
| `set_initial_memory_time_ms` |  87.50 |  175 |  134 |  41 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  306.50 |  613 |  487 |  126 |
| `prover.main_trace_commit_time_ms` |  62.50 |  125 |  99 |  26 |
| `prover.rap_constraints_time_ms` |  176.50 |  353 |  289 |  64 |
| `prover.openings_time_ms` |  67.50 |  135 |  99 |  36 |
| `prover.rap_constraints.logup_gkr_time_ms` |  127.50 |  255 |  214 |  41 |
| `prover.rap_constraints.round0_time_ms` |  32 |  64 |  51 |  13 |
...
| `prover.openings.whir_time_ms` |  55 |  110 |  80 |  30 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  388 |  388 |  388 |  388 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/c63952f29dcc982f381412c4d38ee2fcb54c3acf/fibonacci-c63952f29dcc982f381412c4d38ee2fcb54c3acf.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 68 |  |  |  | 354 |  |  |  |  |  |  | 
| app_proof |  |  |  | 239 |  | 21 | 4,000,051 | 190.12 | 0 | 990 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 27,277,885 | 258 | 81 | 0 | 0 | 97 | 31 | 31 | 45 | 19 | 0 | 79 | 67 | 11 | 2 | 8 | 82 | 81 | 97 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 170 | 46 | 0 | 0 | 68 | 25 | 24 | 28 | 15 | 0 | 54 | 46 | 8 | 1 | 6 | 47 | 46 | 68 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 135 | 31 | 0 | 0 | 61 | 23 | 22 | 24 | 13 | 0 | 41 | 34 | 7 | 1 | 5 | 32 | 31 | 61 | 0 | 3 | 12 | 0 | 0 | 
| leaf | 0 | prover | 74,839,864 | 349 | 123 | 0 | 0 | 115 | 51 | 51 | 34 | 29 | 0 | 109 | 95 | 14 | 6 | 8 | 123 | 123 | 115 | 0 | 6 | 27 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 120,844,884 | 487 | 98 | 0 | 0 | 289 | 51 | 50 | 22 | 214 | 0 | 99 | 80 | 19 | 10 | 8 | 99 | 98 | 289 | 0 | 3 | 213 | 0 | 0 | 
| app_proof | prover | 1 | 26,471,904 | 126 | 26 | 0 | 0 | 64 | 13 | 13 | 9 | 41 | 0 | 36 | 30 | 5 | 2 | 3 | 26 | 26 | 64 | 0 | 2 | 41 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 134 | 1 | 23 | 725 | 23 | 134 | 2,455,642,931 | 477,010,073 | 2,932,653,004 | 2,097,152 | 0 | 3 | 80 | 3,495,000 | 44.85 | 
| app_proof | 1 | 41 | 1 | 55 | 239 | 55 | 41 | 420,241,822 | 191,598,017 | 611,839,839 | 2,097,152 | 0 | 2 | 15 | 505,051 | 50.84 | 

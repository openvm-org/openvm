...
| `total_proof_time_ms ` |  1,484 |  2,968 |  1,715 |  1,253 |
...
| `execute_metered_insn_mi/s` |  91.92 | -          |  91.92 |  91.92 |
| `execute_preflight_insns` |  2,054,241.50 |  4,108,483 |  2,211,000 |  1,897,483 |
| `execute_preflight_time_ms` |  95 |  190 |  109 |  81 |
| `execute_preflight_insn_mi/s` |  31.96 | -          |  33.82 |  30.10 |
| `trace_gen_time_ms   ` |  314 |  628 |  335 |  293 |
| `memory_finalize_time_ms` |  2 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  986.50 |  1,973 |  1,212 |  761 |
| `main_trace_commit_time_ms` |  141 |  282 |  183 |  99 |
| `generate_perm_trace_time_ms` |  62.50 |  125 |  78 |  47 |
| `perm_trace_commit_time_ms` |  172.44 |  344.88 |  224.34 |  120.54 |
| `quotient_poly_compute_time_ms` |  167.22 |  334.44 |  186.69 |  147.76 |
| `quotient_poly_commit_time_ms` |  36.58 |  73.17 |  47.73 |  25.44 |
| `pcs_opening_time_ms ` |  399.50 |  799 |  527 |  272 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 1,253 | 41 | 1 | 44 | 4,108,483 | 91.92 | 250 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 293 | 1,715 | 23,397,108 | 373,183,036 | 293 | 1,212 | 0 | 147.76 | 47.73 | 6 | 224.34 | 527 | 303 | 527 | 4 | 183 | 10,866,434 | 78 | 81 | 2,211,000 | 30.10 | 47 | 197 | 2 | 527 | 
| regex_program | 1 | 335 | 1,253 | 11,981,356 | 196,739,722 | 335 | 761 | 2 | 186.69 | 25.44 | 6 | 120.54 | 272 | 171 | 272 | 0 | 99 | 2,537,170 | 47 | 109 | 1,897,483 | 33.82 | 28 | 217 | 2 | 272 | 

...
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,766 |  1,766 |  1,766 |  1,766 |
| `prover.main_trace_commit_time_ms` |  508 |  508 |  508 |  508 |
| `prover.rap_constraints_time_ms` |  920 |  920 |  920 |  920 |
| `prover.openings_time_ms` |  337 |  337 |  337 |  337 |
| `prover.rap_constraints.logup_gkr_time_ms` |  110 |  110 |  110 |  110 |
| `prover.rap_constraints.round0_time_ms` |  619 |  619 |  619 |  619 |
| `prover.rap_constraints.mle_rounds_time_ms` |  189 |  189 |  189 |  189 |
| `prover.openings.stacked_reduction_time_ms` |  83 |  83 |  83 |  83 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/c977c46950162baf22d27f7d3a3ad7b649e523ff/kitchen_sink-c977c46950162baf22d27f7d3a3ad7b649e523ff.memory.svg)

| Module | Max (GB) | Max At |
| --- | ---: | --- |
| prover.stacked_commit | 11.88 | app_proof.prover..0 |
...
| 76 | VmAirWrapper<StoreMultiByteAdapterAir, StoreCoreAir<8, 4> |  | 29 | 8 | 3 | 
| 77 | VmAirWrapper<LoadMultiByteAdapterAir, LoadCoreAir<8, 5> |  | 28 | 11 | 3 | 
| 78 | VmAirWrapper<StoreMultiByteAdapterAir, StoreCoreAir<4, 2> |  | 27 | 8 | 3 | 
| 79 | VmAirWrapper<LoadMultiByteAdapterAir, LoadCoreAir<4, 3> |  | 26 | 11 | 3 | 
| 8 | VmAirWrapper<VecHeapAdapterAir<1, 8, 8>, FieldExpressionCoreAir> |  | 464 | 262 | 3 | 
| 80 | VmAirWrapper<LoadMultiByteAdapterAir, LoadSignExtendCoreAir<4, 3> |  | 27 | 12 | 3 | 
| 81 | VmAirWrapper<StoreMultiByteAdapterAir, StoreCoreAir<2, 1> |  | 26 | 8 | 3 | 
| 82 | VmAirWrapper<LoadMultiByteAdapterAir, LoadCoreAir<2, 2> |  | 25 | 11 | 3 | 
| 83 | VmAirWrapper<LoadMultiByteAdapterAir, LoadSignExtendCoreAir<2, 2> |  | 26 | 12 | 3 | 
...
| app_proof | 76 | VmAirWrapper<StoreMultiByteAdapterAir, StoreCoreAir<8, 4> | prover |  | 0 | 524,288 | 39 | 20,447,232 | 
| app_proof | 77 | VmAirWrapper<LoadMultiByteAdapterAir, LoadCoreAir<8, 5> | prover |  | 0 | 524,288 | 39 | 20,447,232 | 
| app_proof | 78 | VmAirWrapper<StoreMultiByteAdapterAir, StoreCoreAir<4, 2> | prover |  | 0 | 2,048 | 37 | 75,776 | 
| app_proof | 8 | VmAirWrapper<VecHeapAdapterAir<1, 8, 8>, FieldExpressionCoreAir> | prover |  | 0 | 4 | 529 | 2,116 | 
| app_proof | 80 | VmAirWrapper<LoadMultiByteAdapterAir, LoadSignExtendCoreAir<4, 3> | prover |  | 0 | 32,768 | 38 | 1,245,184 | 
...
| app_proof | 100 | Poseidon2PeripheryAir<BabyBearParameters>, 1> |  | 0 | 4,444 | 3,748 | 3,333,000 | 2,811,000 | 5,332,800 | 4,497,600 | 1,333,200 | 1,124,400 | 161,095 | 135,865 | 4,444 | 3,748 | 
...
| app_proof | 76 | VmAirWrapper<StoreMultiByteAdapterAir, StoreCoreAir<8, 4> |  | 0 | 306,998 | 217,290 | 29,932,305 | 21,185,775 | 47,891,688 | 33,897,240 | 11,972,922 | 8,474,310 | 322,731,648 | 228,426,112 | 8,902,942 | 6,301,410 | 
| app_proof | 77 | VmAirWrapper<LoadMultiByteAdapterAir, LoadCoreAir<8, 5> |  | 0 | 290,210 | 234,078 | 28,295,475 | 22,822,605 | 45,272,760 | 36,516,168 | 11,318,190 | 9,129,042 | 294,563,150 | 237,589,170 | 8,125,880 | 6,554,184 | 
| app_proof | 78 | VmAirWrapper<StoreMultiByteAdapterAir, StoreCoreAir<4, 2> |  | 0 | 1,618 | 430 | 149,665 | 39,775 | 239,464 | 63,640 | 59,866 | 15,910 | 1,583,618 | 420,862 | 43,686 | 11,610 | 
...
| app_proof | 80 | VmAirWrapper<LoadMultiByteAdapterAir, LoadSignExtendCoreAir<4, 3> |  | 0 | 22,741 | 10,027 | 2,160,395 | 952,565 | 3,456,632 | 1,524,104 | 864,158 | 381,026 | 22,257,754 | 9,813,926 | 614,007 | 270,729 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover |  | 0 | 1,046,279,740 | 1,766 | 508 | 0 | 0 | 920 | 619 | 618 | 189 | 110 | 1 | 337 | 253 | 83 | 45 | 38 | 508 | 508 | 920 | 0 | 1 | 108 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof |  | 2,036 | 21 | 1,979,971 | 90.25 | 0 | 2,065 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof |  | 0 | 0 | 2 | 124 | 2,036 | 3 | 0 | 0 | 28 | 0 | 2 | 0 | 10,015,687,404 | 2,554,415,076 | 12,570,102,480 | 2,097,152 | 2 | 0 | 0 | 3 | 121 | 101 | 1,979,971 | 19.42 | 0 | 0 | 

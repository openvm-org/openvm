...
|:---|---:|---:|---:|
| Total |  9.56 |  3.43 |  3.43 |
| app_proof |  7.48 |  1.86 |  1.86 |
| leaf |  1.52 |  1.01 |  1.01 |
...
| `total_proof_time_ms ` |  1,225.83 |  7,355 |  1,353 |  1,186 |
| `compile_metered_time_ms` |  3 |  3 |  3 |  3 |
| `execute_metered_time_ms` |  125 | -          | -          | -          |
| `execute_metered_insns` |  14,365,133 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  114.17 | -          |  114.17 |  114.17 |
| `set_initial_memory_time_ms` |  0 |  0 |  0 |  0 |
| `execute_preflight_insns` |  2,394,188.83 |  14,365,133 |  2,413,000 |  2,300,133 |
| `execute_preflight_time_ms` |  81.67 |  490 |  108 |  74 |
| `execute_preflight_insn_mi/s` |  29.32 | -          |  31.77 |  22.22 |
| `postflight_time_ms  ` |  27.17 |  163 |  30 |  25 |
| `postflight_memory_chronology_time_ms` |  2 |  12 |  2 |  2 |
| `postflight_program_index_time_ms` |  0 |  0 |  0 |  0 |
| `trace_gen_time_ms   ` |  12.33 |  74 |  18 |  11 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,090.67 |  6,544 |  1,182 |  1,063 |
| `prover.main_trace_commit_time_ms` |  339.67 |  2,038 |  364 |  330 |
| `prover.rap_constraints_time_ms` |  510.67 |  3,064 |  513 |  507 |
| `prover.openings_time_ms` |  239.17 |  1,435 |  305 |  224 |
| `prover.rap_constraints.logup_gkr_time_ms` |  103.83 |  623 |  105 |  101 |
| `prover.rap_constraints.round0_time_ms` |  282.50 |  1,695 |  284 |  281 |
...
| `prover.openings.whir_time_ms` |  177.50 |  1,065 |  244 |  162 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  759 |  1,518 |  1,014 |  504 |
| `execute_preflight_time_ms` |  4 |  8 |  4 |  4 |
| `trace_gen_time_ms   ` |  138 |  276 |  183 |  93 |
| `generate_blob_total_time_ms` |  15.50 |  31 |  21 |  10 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  620 |  1,240 |  830 |  410 |
| `prover.main_trace_commit_time_ms` |  266.50 |  533 |  386 |  147 |
| `prover.rap_constraints_time_ms` |  187.50 |  375 |  233 |  142 |
| `prover.openings_time_ms` |  165.50 |  331 |  211 |  120 |
...
| `prover.openings.whir_time_ms` |  136 |  272 |  174 |  98 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/a31cf6ab46966aeddbd8c66c481a4bc5c5dba8d6/keccak-a31cf6ab46966aeddbd8c66c481a4bc5c5dba8d6.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 40 | 325 | 40 | 14 | 3 | 2 | 3 | 3 | 
| internal_recursive.0 | 1 | 15 | 126 | 14 | 2 | 0 | 2 | 2 | 2 | 
| internal_recursive.1 | 1 | 10 | 108 | 10 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 183 | 1,014 | 183 | 59 | 21 | 4 | 10 | 10 | 
| leaf | 1 | 93 | 504 | 93 | 31 | 10 | 4 | 10 | 10 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 81,415,160 | 284 | 93 | 0 | 0 | 113 | 39 | 38 | 56 | 17 | 0 | 77 | 62 | 14 | 4 | 9 | 93 | 93 | 113 | 0 | 1 | 16 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,945 | 111 | 21 | 0 | 0 | 59 | 21 | 21 | 24 | 12 | 0 | 30 | 22 | 8 | 1 | 6 | 21 | 21 | 59 | 0 | 1 | 12 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 98 | 15 | 0 | 0 | 53 | 20 | 19 | 21 | 10 | 0 | 29 | 22 | 7 | 1 | 5 | 15 | 15 | 53 | 0 | 1 | 10 | 0 | 0 | 
| leaf | 0 | prover | 476,578,798 | 830 | 385 | 0 | 0 | 233 | 121 | 120 | 70 | 40 | 0 | 211 | 174 | 37 | 20 | 17 | 386 | 385 | 233 | 0 | 3 | 40 | 0 | 0 | 
| leaf | 1 | prover | 240,255,800 | 410 | 146 | 0 | 0 | 142 | 70 | 69 | 44 | 27 | 0 | 120 | 98 | 22 | 10 | 11 | 147 | 146 | 142 | 0 | 3 | 25 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover |  | 0 | 830,158,476 | 1,182 | 364 | 0 | 51 | 511 | 282 | 282 | 123 | 104 | 0 | 305 | 244 | 61 | 36 | 24 | 364 | 364 | 511 | 0 | 1 | 103 | 0 | 0 | 
| app_proof | prover |  | 1 | 830,158,476 | 1,072 | 335 | 0 | 0 | 509 | 281 | 280 | 123 | 104 | 0 | 227 | 166 | 61 | 37 | 24 | 335 | 335 | 509 | 0 | 1 | 103 | 0 | 0 | 
| app_proof | prover |  | 2 | 830,158,476 | 1,076 | 336 | 0 | 0 | 511 | 283 | 282 | 124 | 104 | 0 | 228 | 165 | 62 | 37 | 25 | 336 | 336 | 511 | 0 | 1 | 103 | 0 | 0 | 
| app_proof | prover |  | 3 | 830,158,476 | 1,076 | 336 | 0 | 0 | 513 | 284 | 283 | 123 | 105 | 0 | 226 | 165 | 61 | 36 | 24 | 336 | 336 | 513 | 0 | 1 | 104 | 0 | 0 | 
| app_proof | prover |  | 4 | 830,158,476 | 1,075 | 337 | 0 | 0 | 513 | 283 | 283 | 124 | 105 | 0 | 224 | 163 | 61 | 36 | 24 | 337 | 337 | 513 | 0 | 1 | 104 | 0 | 0 | 
| app_proof | prover |  | 5 | 819,934,860 | 1,063 | 330 | 0 | 0 | 507 | 282 | 281 | 123 | 101 | 0 | 225 | 162 | 62 | 37 | 24 | 330 | 330 | 507 | 0 | 1 | 100 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof |  | 1,186 | 125 | 14,365,133 | 114.17 | 0 | 7,489 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof |  | 0 | 0 | 2 | 18 | 1,353 | 3 | 0 | 0 | 30 | 0 | 2 | 0 | 9,337,486,584 | 624,415,128 | 9,961,901,712 | 2,097,152 | 2 | 0 | 0 | 2 | 14 | 108 | 2,413,000 | 22.22 | 0 | 0 | 
| app_proof |  | 1 | 0 | 1 | 11 | 1,202 | 2 | 0 | 0 | 26 | 0 | 2 | 0 | 9,337,793,604 | 625,029,708 | 9,962,823,312 | 2,097,152 | 2 | 0 | 0 | 2 | 9 | 78 | 2,413,000 | 30.63 | 0 | 0 | 
| app_proof |  | 2 | 0 | 1 | 11 | 1,205 | 2 | 0 | 0 | 28 | 0 | 2 | 0 | 9,337,030,356 | 625,792,956 | 9,962,823,312 | 2,097,152 | 2 | 0 | 0 | 2 | 9 | 76 | 2,413,000 | 31.36 | 0 | 0 | 
| app_proof |  | 3 | 0 | 1 | 11 | 1,203 | 2 | 0 | 0 | 27 | 0 | 2 | 0 | 9,337,792,860 | 625,030,452 | 9,962,823,312 | 2,097,152 | 2 | 0 | 0 | 2 | 9 | 75 | 2,413,000 | 31.77 | 0 | 0 | 
| app_proof |  | 4 | 0 | 1 | 12 | 1,206 | 2 | 0 | 0 | 27 | 0 | 2 | 0 | 9,337,030,236 | 625,793,076 | 9,962,823,312 | 2,097,152 | 2 | 0 | 0 | 2 | 9 | 79 | 2,413,000 | 30.24 | 0 | 0 | 
| app_proof |  | 5 | 0 | 1 | 11 | 1,186 | 2 | 0 | 0 | 25 | 0 | 2 | 0 | 8,903,917,596 | 936,222,324 | 9,840,139,920 | 2,097,152 | 2 | 0 | 0 | 2 | 9 | 74 | 2,300,133 | 31.03 | 0 | 0 | 

...
|:---|---:|---:|---:|
| Total |  9.54 |  3.44 |  3.44 |
| app_proof |  7.45 |  1.85 |  1.85 |
| leaf |  1.52 |  1.02 |  1.02 |
...
| `total_proof_time_ms ` |  1,221.17 |  7,327 |  1,352 |  1,178 |
| `compile_metered_time_ms` |  2 |  2 |  2 |  2 |
| `execute_metered_time_ms` |  125 | -          | -          | -          |
| `execute_metered_insns` |  14,365,133 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  114.89 | -          |  114.89 |  114.89 |
| `set_initial_memory_time_ms` |  0 |  0 |  0 |  0 |
| `execute_preflight_insns` |  2,394,188.83 |  14,365,133 |  2,413,000 |  2,300,133 |
| `execute_preflight_time_ms` |  80.33 |  482 |  109 |  71 |
| `execute_preflight_insn_mi/s` |  29.80 | -          |  32.44 |  22.12 |
| `postflight_time_ms  ` |  27.83 |  167 |  31 |  26 |
| `postflight_memory_chronology_time_ms` |  2.17 |  13 |  3 |  2 |
| `postflight_program_index_time_ms` |  0 |  0 |  0 |  0 |
| `trace_gen_time_ms   ` |  12.17 |  73 |  17 |  11 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,087 |  6,522 |  1,179 |  1,057 |
| `prover.main_trace_commit_time_ms` |  337.67 |  2,026 |  362 |  328 |
| `prover.rap_constraints_time_ms` |  509.67 |  3,058 |  511 |  505 |
| `prover.openings_time_ms` |  238.33 |  1,430 |  305 |  222 |
...
| `prover.openings.stacked_reduction_time_ms` |  60.17 |  361 |  61 |  59 |
...
| `prover.openings.whir_time_ms` |  177.83 |  1,067 |  244 |  163 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  760 |  1,520 |  1,017 |  503 |
...
| `prover.openings_time_ms` |  167 |  334 |  213 |  121 |
...
| `prover.openings.whir_time_ms` |  137.50 |  275 |  176 |  99 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/330221c06e0dd0590cdbdbad9822fe7f9cfc8d95/keccak-330221c06e0dd0590cdbdbad9822fe7f9cfc8d95.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 40 | 330 | 40 | 14 | 3 | 2 | 3 | 3 | 
| internal_recursive.0 | 1 | 14 | 129 | 13 | 2 | 0 | 2 | 2 | 2 | 
| internal_recursive.1 | 1 | 10 | 109 | 10 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 188 | 1,017 | 187 | 60 | 21 | 4 | 11 | 11 | 
| leaf | 1 | 93 | 503 | 93 | 30 | 10 | 5 | 10 | 10 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 81,415,160 | 290 | 92 | 0 | 0 | 114 | 39 | 38 | 56 | 18 | 0 | 82 | 67 | 15 | 5 | 10 | 93 | 92 | 114 | 0 | 1 | 16 | 0 | 0 | 
...
| leaf | 0 | prover | 476,578,798 | 829 | 382 | 0 | 0 | 232 | 121 | 120 | 70 | 40 | 0 | 213 | 176 | 37 | 20 | 17 | 382 | 382 | 232 | 0 | 3 | 39 | 0 | 0 | 
| leaf | 1 | prover | 240,255,800 | 409 | 145 | 0 | 0 | 141 | 70 | 69 | 44 | 26 | 0 | 121 | 99 | 21 | 10 | 11 | 146 | 145 | 141 | 0 | 3 | 25 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover |  | 0 | 830,158,476 | 1,179 | 362 | 0 | 50 | 511 | 283 | 283 | 123 | 104 | 0 | 305 | 244 | 60 | 36 | 24 | 362 | 362 | 511 | 0 | 1 | 103 | 0 | 0 | 
| app_proof | prover |  | 1 | 830,158,476 | 1,071 | 333 | 0 | 0 | 510 | 282 | 281 | 123 | 104 | 0 | 227 | 166 | 61 | 36 | 24 | 333 | 333 | 510 | 0 | 1 | 103 | 0 | 0 | 
| app_proof | prover |  | 2 | 830,158,476 | 1,071 | 334 | 0 | 0 | 510 | 282 | 282 | 123 | 104 | 0 | 226 | 165 | 60 | 36 | 24 | 334 | 334 | 510 | 0 | 1 | 103 | 0 | 0 | 
| app_proof | prover |  | 3 | 830,158,476 | 1,073 | 334 | 0 | 0 | 511 | 282 | 282 | 123 | 104 | 0 | 226 | 165 | 61 | 36 | 24 | 334 | 334 | 511 | 0 | 1 | 103 | 0 | 0 | 
| app_proof | prover |  | 4 | 830,158,476 | 1,071 | 335 | 0 | 0 | 511 | 283 | 282 | 123 | 104 | 0 | 224 | 164 | 60 | 36 | 24 | 335 | 335 | 511 | 0 | 1 | 103 | 0 | 0 | 
| app_proof | prover |  | 5 | 819,934,860 | 1,057 | 328 | 0 | 0 | 505 | 281 | 280 | 122 | 102 | 0 | 222 | 163 | 59 | 35 | 24 | 328 | 328 | 505 | 0 | 1 | 101 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof |  | 1,178 | 125 | 14,365,133 | 114.89 | 0 | 7,460 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof |  | 0 | 0 | 2 | 17 | 1,352 | 3 | 0 | 0 | 31 | 0 | 3 | 0 | 9,337,486,584 | 624,415,128 | 9,961,901,712 | 2,097,152 | 2 | 0 | 0 | 2 | 14 | 109 | 2,413,000 | 22.12 | 0 | 0 | 
| app_proof |  | 1 | 0 | 1 | 12 | 1,200 | 2 | 0 | 0 | 27 | 0 | 2 | 0 | 9,337,793,604 | 625,029,708 | 9,962,823,312 | 2,097,152 | 2 | 0 | 0 | 2 | 9 | 77 | 2,413,000 | 31.23 | 0 | 0 | 
| app_proof |  | 2 | 0 | 1 | 11 | 1,200 | 2 | 0 | 0 | 29 | 0 | 2 | 0 | 9,337,030,356 | 625,792,956 | 9,962,823,312 | 2,097,152 | 2 | 0 | 0 | 2 | 9 | 75 | 2,413,000 | 31.88 | 0 | 0 | 
| app_proof |  | 3 | 0 | 1 | 11 | 1,198 | 2 | 0 | 0 | 27 | 0 | 2 | 0 | 9,337,792,860 | 625,030,452 | 9,962,823,312 | 2,097,152 | 2 | 0 | 0 | 2 | 9 | 74 | 2,413,000 | 32.44 | 0 | 0 | 
| app_proof |  | 4 | 0 | 1 | 11 | 1,199 | 2 | 0 | 0 | 27 | 0 | 2 | 0 | 9,337,030,236 | 625,793,076 | 9,962,823,312 | 2,097,152 | 2 | 0 | 0 | 2 | 9 | 76 | 2,413,000 | 31.46 | 0 | 0 | 
| app_proof |  | 5 | 0 | 1 | 11 | 1,178 | 2 | 0 | 0 | 26 | 0 | 2 | 0 | 8,903,917,596 | 936,222,324 | 9,840,139,920 | 2,097,152 | 2 | 0 | 0 | 2 | 8 | 71 | 2,300,133 | 31.100 | 0 | 0 | 

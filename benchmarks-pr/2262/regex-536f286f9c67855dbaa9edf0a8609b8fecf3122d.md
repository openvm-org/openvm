...
|:---|---:|---:|
| Total | <span style='color: red'>(+0 [+0.9%])</span> 2.40 | <span style='color: red'>(+0 [+1.2%])</span> 0.78 |
| regex_program | <span style='color: red'>(+0 [+1.0%])</span> 2.36 | <span style='color: red'>(+0 [+1.4%])</span> 0.74 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+6 [+1.0%])</span> 590.75 | <span style='color: red'>(+23 [+1.0%])</span> 2,363 | <span style='color: red'>(+10 [+1.4%])</span> 740 | <span style='color: red'>(+13 [+2.5%])</span> 537 |
...
| `execute_metered_insn_mi/s` | <span style='color: red'>(+2 [+1.7%])</span> 113.58 | -          | <span style='color: red'>(+2 [+1.7%])</span> 113.58 | <span style='color: red'>(+2 [+1.7%])</span> 113.58 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  54.75 |  219 |  68 |  45 |
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+0 [+0.8%])</span> 30.69 | -          |  31.79 | <span style='color: red'>(+0 [+0.8%])</span> 28.06 |
| `trace_gen_time_ms   ` | <span style='color: green'>(-2 [-1.3%])</span> 176.75 | <span style='color: green'>(-9 [-1.3%])</span> 707 | <span style='color: red'>(+1 [+0.5%])</span> 212 | <span style='color: green'>(-2 [-1.3%])</span> 153 |
| `memory_finalize_time_ms` |  1 |  4 |  4 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+8 [+2.9%])</span> 291.50 | <span style='color: red'>(+33 [+2.9%])</span> 1,166 | <span style='color: red'>(+10 [+3.1%])</span> 337 | <span style='color: red'>(+9 [+3.5%])</span> 268 |
| `main_trace_commit_time_ms` | <span style='color: green'>(-1 [-1.9%])</span> 51 | <span style='color: green'>(-4 [-1.9%])</span> 204 | <span style='color: green'>(-1 [-1.8%])</span> 56 | <span style='color: green'>(-1 [-2.0%])</span> 49 |
| `generate_perm_trace_time_ms` | <span style='color: red'>(+1 [+3.0%])</span> 34.50 | <span style='color: red'>(+4 [+3.0%])</span> 138 |  54 | <span style='color: red'>(+1 [+5.6%])</span> 19 |
| `perm_trace_commit_time_ms` | <span style='color: green'>(-0 [-0.6%])</span> 63.91 | <span style='color: green'>(-2 [-0.6%])</span> 255.65 | <span style='color: green'>(-1 [-1.5%])</span> 69.59 | <span style='color: green'>(-1 [-2.4%])</span> 54.61 |
| `quotient_poly_compute_time_ms` | <span style='color: green'>(-0 [-0.3%])</span> 58.90 | <span style='color: green'>(-1 [-0.3%])</span> 235.60 | <span style='color: red'>(+2 [+2.5%])</span> 71.24 | <span style='color: green'>(-0 [-0.6%])</span> 52.45 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+0 [+2.7%])</span> 15.37 | <span style='color: red'>(+2 [+2.7%])</span> 61.50 | <span style='color: green'>(-0 [-2.3%])</span> 17.84 | <span style='color: red'>(+1 [+4.6%])</span> 12.88 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+8 [+15.2%])</span> 64.50 | <span style='color: red'>(+34 [+15.2%])</span> 258 | <span style='color: red'>(+15 [+23.8%])</span> 78 | <span style='color: red'>(+10 [+21.7%])</span> 56 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 539 | 1 | 36 | 4,137,502 | 113.58 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 212 | 740 | 23,446,148 | 150,778,428 | 212 | 337 | 0 | 59.33 | 17.84 | 5 | 69.59 | 78 | 124 | 78 | 4 | 56 | 10,899,170 | 54 | 45 | 1,103,000 | 28.06 | 21 | 77 | 1 | 78 | 
| regex_program | 1 | 153 | 547 | 11,598,276 | 128,513,066 | 153 | 285 | 1 | 52.45 | 15.25 | 4 | 65.28 | 62 | 103 | 62 | 0 | 50 | 2,196,106 | 37 | 68 | 1,104,000 | 31.67 | 16 | 68 | 0 | 62 | 
| regex_program | 2 | 160 | 537 | 11,579,064 | 128,513,066 | 160 | 276 | 1 | 52.58 | 15.53 | 4 | 66.18 | 62 | 95 | 62 | 0 | 49 | 2,177,334 | 28 | 60 | 1,104,000 | 31.22 | 16 | 68 | 0 | 61 | 
| regex_program | 3 | 182 | 539 | 11,853,872 | 103,456,394 | 182 | 268 | 0 | 71.24 | 12.88 | 5 | 54.61 | 56 | 77 | 56 | 0 | 49 | 2,422,606 | 19 | 46 | 826,502 | 31.79 | 18 | 85 | 1 | 56 | 

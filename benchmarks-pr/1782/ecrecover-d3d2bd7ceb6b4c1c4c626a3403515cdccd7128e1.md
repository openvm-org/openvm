...
|:---|---:|---:|
| Total |  3.72 |  3.72 |
| ecrecover_program |  3.64 |  3.64 |


| ecrecover_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  3,638 |  3,638 |  3,638 |  3,638 |
...
| `execute_metered_insn_mi/s` |  1.68 | -          | -          | -          |
| `execute_e3_time_ms  ` |  85 |  85 |  85 |  85 |
| `execute_e3_insn_mi/s` |  1.60 | -          |  1.60 |  1.60 |
| `trace_gen_time_ms   ` |  2,607 |  2,607 |  2,607 |  2,607 |
| `memory_finalize_time_ms` |  2,312 |  2,312 |  2,312 |  2,312 |
| `boundary_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `merkle_finalize_time_ms` |  2,076 |  2,076 |  2,076 |  2,076 |
| `stark_prove_excluding_trace_time_ms` |  946 |  946 |  946 |  946 |
| `main_trace_commit_time_ms` |  129 |  129 |  129 |  129 |
| `generate_perm_trace_time_ms` |  35 |  35 |  35 |  35 |
| `perm_trace_commit_time_ms` |  132 |  132 |  132 |  132 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 1 | 906 | 137,261 | 1 | 81 | 1.68 | 10 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 2,607 | 3,638 | 137,260 | 32,925,330 | 946 | 82 | 131 | 132 | 422 | 2,076 | 2,312 | 129 | 8,151,353 | 137,261 | 35 | 85 | 1.60 | 0 | 

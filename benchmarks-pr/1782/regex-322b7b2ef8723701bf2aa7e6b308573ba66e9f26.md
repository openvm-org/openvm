...
|:---|---:|---:|
| Total |  10.11 |  5.43 |
| regex_program |  9.84 |  5.17 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  4,920 |  9,840 |  5,169 |  4,671 |
...
| `execute_e3_insn_mi/s` |  11.04 | -          |  11.13 |  10.95 |
| `trace_gen_time_ms   ` |  2,133.50 |  4,267 |  2,162 |  2,105 |
| `memory_finalize_time_ms` |  1,566.50 |  3,133 |  1,660 |  1,473 |
| `boundary_finalize_time_ms` |  3 |  6 |  6 |  0 |
| `merkle_finalize_time_ms` |  1,316.50 |  2,633 |  1,400 |  1,233 |
| `stark_prove_excluding_trace_time_ms` |  2,598.50 |  5,197 |  2,803 |  2,394 |
| `main_trace_commit_time_ms` |  509.50 |  1,019 |  574 |  445 |
| `generate_perm_trace_time_ms` |  221.50 |  443 |  233 |  210 |
| `perm_trace_commit_time_ms` |  555 |  1,110 |  593 |  517 |
| `quotient_poly_compute_time_ms` |  264.50 |  529 |  285 |  244 |
| `quotient_poly_commit_time_ms` |  242 |  484 |  278 |  206 |
| `pcs_opening_time_ms ` |  798 |  1,596 |  835 |  761 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2 | 547 | 4,165,433 | 1 | 266 | 15.66 | 20 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 2,162 | 5,169 | 2,243,700 | 275,648,700 | 2,803 | 285 | 278 | 593 | 835 | 1,400 | 1,660 | 574 | 93,502,324 | 2,243,700 | 233 | 204 | 10.95 | 6 | 
| regex_program | 1 | 2,105 | 4,671 | 1,921,732 | 242,975,388 | 2,394 | 244 | 206 | 517 | 761 | 1,233 | 1,473 | 445 | 73,017,132 | 1,921,733 | 210 | 172 | 11.13 | 0 | 

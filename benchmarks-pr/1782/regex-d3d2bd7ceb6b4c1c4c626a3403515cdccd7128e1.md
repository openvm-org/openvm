...
|:---|---:|---:|
| Total |  11.52 |  6.11 |
| regex_program |  11.26 |  5.85 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  5,628.50 |  11,257 |  5,854 |  5,403 |
| `main_cells_used     ` |  83,259,728 |  166,519,456 |  93,502,324 |  73,017,132 |
| `total_cycles        ` |  2,082,716 |  4,165,432 |  2,243,700 |  1,921,732 |
| `execute_metered_time_ms` |  260 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  15.98 | -          | -          | -          |
| `execute_e3_time_ms  ` |  189 |  378 |  205 |  173 |
| `execute_e3_insn_mi/s` |  11.01 | -          |  11.09 |  10.93 |
| `trace_gen_time_ms   ` |  2,948.50 |  5,897 |  2,968 |  2,929 |
| `memory_finalize_time_ms` |  2,370 |  4,740 |  2,474 |  2,266 |
| `boundary_finalize_time_ms` |  2.50 |  5 |  5 |  0 |
| `merkle_finalize_time_ms` |  2,122 |  4,244 |  2,216 |  2,028 |
| `stark_prove_excluding_trace_time_ms` |  2,491 |  4,982 |  2,681 |  2,301 |
| `main_trace_commit_time_ms` |  463 |  926 |  527 |  399 |
| `generate_perm_trace_time_ms` |  223 |  446 |  237 |  209 |
| `perm_trace_commit_time_ms` |  503 |  1,006 |  532 |  474 |
| `quotient_poly_compute_time_ms` |  266.50 |  533 |  289 |  244 |
| `quotient_poly_commit_time_ms` |  230 |  460 |  261 |  199 |
| `pcs_opening_time_ms ` |  798 |  1,596 |  830 |  766 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2 | 540 | 4,165,433 | 1 | 260 | 15.98 | 19 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 2,968 | 5,854 | 2,243,700 | 275,648,700 | 2,681 | 289 | 261 | 532 | 830 | 2,216 | 2,474 | 527 | 93,502,324 | 2,243,700 | 237 | 205 | 10.93 | 5 | 
| regex_program | 1 | 2,929 | 5,403 | 1,921,732 | 242,975,388 | 2,301 | 244 | 199 | 474 | 766 | 2,028 | 2,266 | 399 | 73,017,132 | 1,921,733 | 209 | 173 | 11.09 | 0 | 

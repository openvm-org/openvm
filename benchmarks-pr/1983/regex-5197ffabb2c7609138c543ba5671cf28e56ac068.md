...
|:---|---:|---:|
| Total |  7.73 |  4.97 |
| regex_program |  7.70 |  4.94 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  3,849 |  7,698 |  4,938 |  2,760 |
...
| `execute_preflight_time_ms` |  89.50 |  179 |  96 |  83 |
| `execute_preflight_insn_mi/s` |  30.56 | -          |  33.23 |  27.88 |
| `trace_gen_time_ms   ` |  396 |  792 |  508 |  284 |
| `memory_finalize_time_ms` |  8 |  16 |  13 |  3 |
| `stark_prove_excluding_trace_time_ms` |  3,124 |  6,248 |  4,084 |  2,164 |
| `main_trace_commit_time_ms` |  625.50 |  1,251 |  840 |  411 |
| `generate_perm_trace_time_ms` |  255.50 |  511 |  346 |  165 |
| `perm_trace_commit_time_ms` |  647.50 |  1,295 |  848 |  447 |
| `quotient_poly_compute_time_ms` |  328 |  656 |  448 |  208 |
| `quotient_poly_commit_time_ms` |  297.50 |  595 |  390 |  205 |
| `pcs_opening_time_ms ` |  961.50 |  1,923 |  1,205 |  718 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2 | 2,760 | 6 | 4,108,597 | 1 | 31 | 128.66 | 45 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 508 | 4,938 | 211,758,557 | 373,183,036 | 508 | 4,084 | 0 | 448 | 390 | 848 | 1,205 | 8 | 13 | 840 | 91,281,687 | 2,211,000 | 346 | 96 | 27.88 | 
| regex_program | 1 | 284 | 2,760 | 174,326,267 | 196,838,026 | 284 | 2,164 | 53 | 208 | 205 | 447 | 718 | 6 | 3 | 411 | 73,453,305 | 1,897,597 | 165 | 83 | 33.23 | 

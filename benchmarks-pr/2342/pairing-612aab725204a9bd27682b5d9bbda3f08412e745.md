...
|:---|---:|---:|
| Total | <span style='color: red'>(+0 [+3.2%])</span> 1.54 | <span style='color: red'>(+0 [+4.4%])</span> 0.94 |
| pairing | <span style='color: red'>(+0 [+3.3%])</span> 1.48 | <span style='color: red'>(+0 [+4.8%])</span> 0.88 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+24 [+3.3%])</span> 741 | <span style='color: red'>(+48 [+3.3%])</span> 1,482 | <span style='color: red'>(+40 [+4.8%])</span> 876 | <span style='color: red'>(+8 [+1.3%])</span> 606 |
...
| `execute_preflight_time_ms` |  82.50 |  165 | <span style='color: green'>(-13 [-11.0%])</span> 105 | <span style='color: red'>(+13 [+27.7%])</span> 60 |
| `execute_preflight_insn_mi/s` | <span style='color: green'>(-0 [-1.6%])</span> 14.82 | -          | <span style='color: green'>(-0 [-0.8%])</span> 18.38 | <span style='color: green'>(-0 [-2.8%])</span> 11.27 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+9 [+4.8%])</span> 195 | <span style='color: red'>(+18 [+4.8%])</span> 390 | <span style='color: green'>(-5 [-2.5%])</span> 199 | <span style='color: red'>(+23 [+13.7%])</span> 191 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+14 [+4.1%])</span> 358 | <span style='color: red'>(+28 [+4.1%])</span> 716 | <span style='color: red'>(+29 [+7.6%])</span> 411 | <span style='color: green'>(-1 [-0.3%])</span> 305 |
| `main_trace_commit_time_ms` |  65 |  130 |  75 |  55 |
| `generate_perm_trace_time_ms` | <span style='color: green'>(-1 [-2.7%])</span> 36 | <span style='color: green'>(-2 [-2.7%])</span> 72 | <span style='color: red'>(+5 [+13.5%])</span> 42 | <span style='color: green'>(-7 [-18.9%])</span> 30 |
| `perm_trace_commit_time_ms` | <span style='color: red'>(+1 [+1.4%])</span> 78.31 | <span style='color: red'>(+2 [+1.4%])</span> 156.61 | <span style='color: red'>(+2 [+1.7%])</span> 91.10 | <span style='color: red'>(+1 [+1.0%])</span> 65.52 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+3 [+3.4%])</span> 85.06 | <span style='color: red'>(+6 [+3.4%])</span> 170.12 | <span style='color: red'>(+2 [+2.6%])</span> 93.62 | <span style='color: red'>(+3 [+4.3%])</span> 76.49 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+1 [+5.3%])</span> 17.67 | <span style='color: red'>(+2 [+5.3%])</span> 35.34 | <span style='color: red'>(+2 [+8.6%])</span> 20.11 | <span style='color: red'>(+0 [+1.1%])</span> 15.23 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+10 [+16.5%])</span> 70.50 | <span style='color: red'>(+20 [+16.5%])</span> 141 | <span style='color: red'>(+19 [+29.2%])</span> 84 | <span style='color: red'>(+1 [+1.8%])</span> 57 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 606 | 1 | 63 | 1,745,742 | 27.36 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 191 | 876 | 32,480,114 | 172,558,444 | 191 | 411 | 0 | 93.62 | 20.11 | 6 | 91.10 | 84 | 136 | 84 | 1 | 75 | 15,909,408 | 42 | 105 | 1,149,000 | 11.27 | 27 | 114 | 1 | 84 | 
| pairing | 1 | 199 | 606 | 22,464,232 | 119,958,502 | 199 | 305 | 1 | 76.49 | 15.23 | 6 | 65.52 | 57 | 99 | 57 | 0 | 55 | 9,498,894 | 30 | 60 | 596,742 | 18.38 | 21 | 92 | 1 | 57 | 

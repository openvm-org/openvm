...
|:---|---:|---:|
| Total | <span style='color: red'>(+0 [+7.9%])</span> 1.62 | <span style='color: red'>(+0 [+1.8%])</span> 0.92 |
| pairing | <span style='color: red'>(+0 [+8.2%])</span> 1.55 | <span style='color: red'>(+0 [+1.8%])</span> 0.85 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+59 [+8.2%])</span> 776 | <span style='color: red'>(+118 [+8.2%])</span> 1,552 | <span style='color: red'>(+15 [+1.8%])</span> 851 | <span style='color: red'>(+103 [+17.2%])</span> 701 |
...
| `execute_metered_insn_mi/s` | <span style='color: green'>(-1 [-1.9%])</span> 27.09 | -          | <span style='color: green'>(-1 [-1.9%])</span> 27.09 | <span style='color: green'>(-1 [-1.9%])</span> 27.09 |
| `execute_preflight_insns` |  872,871 |  1,745,742 |  1,149,000 |  596,742 |
| `execute_preflight_time_ms` | <span style='color: red'>(+0 [+0.6%])</span> 83 | <span style='color: red'>(+1 [+0.6%])</span> 166 | <span style='color: green'>(-12 [-10.2%])</span> 106 | <span style='color: red'>(+13 [+27.7%])</span> 60 |
| `execute_preflight_insn_mi/s` | <span style='color: green'>(-0 [-2.9%])</span> 14.63 | -          | <span style='color: green'>(-0 [-2.6%])</span> 18.04 | <span style='color: green'>(-0 [-3.3%])</span> 11.22 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+6 [+3.5%])</span> 192.50 | <span style='color: red'>(+13 [+3.5%])</span> 385 | <span style='color: green'>(-7 [-3.4%])</span> 197 | <span style='color: red'>(+20 [+11.9%])</span> 188 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+50 [+14.7%])</span> 394.50 | <span style='color: red'>(+101 [+14.7%])</span> 789 | <span style='color: red'>(+20 [+5.2%])</span> 402 | <span style='color: red'>(+81 [+26.5%])</span> 387 |
| `main_trace_commit_time_ms` | <span style='color: red'>(+0 [+0.8%])</span> 65.50 | <span style='color: red'>(+1 [+0.8%])</span> 131 |  75 | <span style='color: red'>(+1 [+1.8%])</span> 56 |
| `generate_perm_trace_time_ms` | <span style='color: red'>(+14 [+37.8%])</span> 51 | <span style='color: red'>(+28 [+37.8%])</span> 102 | <span style='color: red'>(+21 [+56.8%])</span> 58 | <span style='color: red'>(+7 [+18.9%])</span> 44 |
| `perm_trace_commit_time_ms` | <span style='color: green'>(-2 [-2.9%])</span> 75.01 | <span style='color: green'>(-4 [-2.9%])</span> 150.03 | <span style='color: green'>(-5 [-5.5%])</span> 84.64 | <span style='color: red'>(+1 [+0.8%])</span> 65.39 |
| `quotient_poly_compute_time_ms` | <span style='color: green'>(-0 [-0.6%])</span> 81.82 | <span style='color: green'>(-1 [-0.6%])</span> 163.64 | <span style='color: green'>(-1 [-1.6%])</span> 89.76 | <span style='color: red'>(+1 [+0.7%])</span> 73.88 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+0 [+2.3%])</span> 17.18 | <span style='color: red'>(+1 [+2.3%])</span> 34.35 | <span style='color: red'>(+1 [+4.0%])</span> 19.25 | <span style='color: red'>(+0 [+0.2%])</span> 15.10 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+38 [+63.6%])</span> 99 | <span style='color: red'>(+77 [+63.6%])</span> 198 | <span style='color: red'>(+64 [+98.5%])</span> 129 | <span style='color: red'>(+13 [+23.2%])</span> 69 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 701 | 1 | 64 | 1,745,742 | 27.09 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 188 | 851 | 32,480,114 | 172,558,444 | 188 | 387 | 0 | 89.76 | 19.25 | 6 | 84.64 | 69 | 131 | 69 | 1 | 75 | 15,909,408 | 44 | 106 | 1,149,000 | 11.22 | 27 | 109 | 1 | 69 | 
| pairing | 1 | 197 | 701 | 22,464,232 | 119,958,502 | 197 | 402 | 1 | 73.88 | 15.10 | 6 | 65.39 | 129 | 127 | 128 | 0 | 56 | 9,498,894 | 58 | 60 | 596,742 | 18.04 | 21 | 89 | 1 | 128 | 

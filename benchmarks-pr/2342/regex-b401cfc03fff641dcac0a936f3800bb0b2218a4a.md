...
|:---|---:|---:|
| Total | <span style='color: red'>(+0 [+1.2%])</span> 2.37 | <span style='color: red'>(+0 [+4.8%])</span> 0.76 |
| regex_program | <span style='color: red'>(+0 [+1.2%])</span> 2.33 | <span style='color: red'>(+0 [+4.9%])</span> 0.73 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+7 [+1.2%])</span> 582.25 | <span style='color: red'>(+27 [+1.2%])</span> 2,329 | <span style='color: red'>(+34 [+4.9%])</span> 727 | <span style='color: green'>(-11 [-2.1%])</span> 520 |
...
| `execute_metered_insn_mi/s` | <span style='color: green'>(-4 [-3.3%])</span> 110.07 | -          | <span style='color: green'>(-4 [-3.3%])</span> 110.07 | <span style='color: green'>(-4 [-3.3%])</span> 110.07 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` | <span style='color: red'>(+14 [+30.0%])</span> 58.50 | <span style='color: red'>(+54 [+30.0%])</span> 234 | <span style='color: red'>(+16 [+28.6%])</span> 72 | <span style='color: red'>(+12 [+35.3%])</span> 46 |
| `execute_preflight_insn_mi/s` | <span style='color: green'>(-1 [-2.8%])</span> 31.02 | -          | <span style='color: green'>(-0 [-0.8%])</span> 32.30 | <span style='color: green'>(-3 [-8.3%])</span> 28.10 |
| `trace_gen_time_ms   ` | <span style='color: green'>(-6 [-3.1%])</span> 173.75 | <span style='color: green'>(-22 [-3.1%])</span> 695 | <span style='color: red'>(+17 [+8.7%])</span> 212 | <span style='color: green'>(-20 [-11.8%])</span> 149 |
| `memory_finalize_time_ms` |  1 |  4 |  4 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: green'>(-2 [-0.7%])</span> 275.50 | <span style='color: green'>(-8 [-0.7%])</span> 1,102 |  297 | <span style='color: green'>(-12 [-4.5%])</span> 257 |
| `main_trace_commit_time_ms` | <span style='color: green'>(-1 [-1.4%])</span> 51 | <span style='color: green'>(-3 [-1.4%])</span> 204 | <span style='color: green'>(-1 [-1.8%])</span> 56 |  49 |
| `generate_perm_trace_time_ms` | <span style='color: red'>(+4 [+18.3%])</span> 27.50 | <span style='color: red'>(+17 [+18.3%])</span> 110 | <span style='color: red'>(+1 [+3.4%])</span> 30 | <span style='color: red'>(+4 [+21.1%])</span> 23 |
| `perm_trace_commit_time_ms` | <span style='color: green'>(-1 [-1.0%])</span> 64.07 | <span style='color: green'>(-3 [-1.0%])</span> 256.27 |  70.33 | <span style='color: green'>(-0 [-0.9%])</span> 54.66 |
| `quotient_poly_compute_time_ms` | <span style='color: green'>(-1 [-0.9%])</span> 60.15 | <span style='color: green'>(-2 [-0.9%])</span> 240.58 | <span style='color: red'>(+1 [+1.0%])</span> 71.75 | <span style='color: green'>(-1 [-1.4%])</span> 53.45 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+0 [+2.3%])</span> 16.15 | <span style='color: red'>(+1 [+2.3%])</span> 64.60 | <span style='color: red'>(+0 [+2.3%])</span> 18.68 | <span style='color: red'>(+0 [+3.4%])</span> 13.87 |
| `pcs_opening_time_ms ` | <span style='color: green'>(-5 [-8.2%])</span> 53.25 | <span style='color: green'>(-19 [-8.2%])</span> 213 | <span style='color: green'>(-9 [-13.4%])</span> 58 | <span style='color: green'>(-7 [-13.0%])</span> 47 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 548 | 1 | 37 | 4,137,502 | 110.07 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 212 | 727 | 23,446,148 | 150,778,428 | 212 | 297 | 0 | 61.77 | 18.68 | 6 | 70.33 | 58 | 101 | 57 | 4 | 56 | 10,899,170 | 30 | 46 | 1,103,000 | 28.10 | 22 | 81 | 1 | 57 | 
| regex_program | 1 | 149 | 520 | 11,598,276 | 128,513,066 | 149 | 257 | 1 | 53.45 | 15.85 | 4 | 65.27 | 47 | 89 | 47 | 0 | 50 | 2,196,106 | 23 | 72 | 1,104,000 | 32.30 | 17 | 69 | 0 | 47 | 
| regex_program | 2 | 157 | 534 | 11,579,064 | 128,513,066 | 157 | 270 | 1 | 53.62 | 16.21 | 4 | 66.01 | 53 | 96 | 53 | 0 | 49 | 2,177,334 | 29 | 65 | 1,104,000 | 31.86 | 17 | 70 | 0 | 53 | 
| regex_program | 3 | 177 | 548 | 11,853,872 | 103,456,394 | 177 | 278 | 0 | 71.75 | 13.87 | 5 | 54.66 | 55 | 86 | 55 | 0 | 49 | 2,422,606 | 28 | 51 | 826,502 | 31.82 | 19 | 86 | 1 | 55 | 

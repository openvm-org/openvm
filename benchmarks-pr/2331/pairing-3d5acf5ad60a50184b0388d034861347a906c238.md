...
|:---|---:|---:|---:|
| Total | <span style='color: red'>(+1 [+45.7%])</span> 2.18 | <span style='color: red'>(+0 [+54.3%])</span> 1.39 | 1.39 |
| pairing | <span style='color: red'>(+1 [+45.7%])</span> 2.18 | <span style='color: red'>(+0 [+54.3%])</span> 1.39 |  1.39 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+341 [+47.7%])</span> 1,056 | <span style='color: red'>(+682 [+47.7%])</span> 2,112 | <span style='color: red'>(+489 [+58.4%])</span> 1,327 | <span style='color: red'>(+193 [+32.6%])</span> 785 |
...
| `execute_metered_insn_mi/s` | <span style='color: red'>(+0 [+1.1%])</span> 27.66 | -          | <span style='color: red'>(+0 [+1.1%])</span> 27.66 | <span style='color: red'>(+0 [+1.1%])</span> 27.66 |
| `execute_preflight_insns` |  872,871 |  1,745,742 |  1,149,000 |  596,742 |
| `execute_preflight_time_ms` | <span style='color: red'>(+0 [+0.6%])</span> 84 | <span style='color: red'>(+1 [+0.6%])</span> 168 |  107 | <span style='color: red'>(+1 [+1.7%])</span> 61 |
| `execute_preflight_insn_mi/s` | <span style='color: green'>(-0 [-1.3%])</span> 14.45 | -          | <span style='color: green'>(-0 [-2.1%])</span> 17.78 |  11.12 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+3 [+1.6%])</span> 186 | <span style='color: red'>(+6 [+1.6%])</span> 372 | <span style='color: red'>(+3 [+1.6%])</span> 192 | <span style='color: red'>(+3 [+1.7%])</span> 180 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+338 [+98.5%])</span> 681 | <span style='color: red'>(+676 [+98.5%])</span> 1,362 | <span style='color: red'>(+487 [+126.5%])</span> 872 | <span style='color: red'>(+189 [+62.8%])</span> 490 |
| `main_trace_commit_time_ms` | <span style='color: red'>(+2 [+2.4%])</span> 65 | <span style='color: red'>(+3 [+2.4%])</span> 130 | <span style='color: red'>(+3 [+4.1%])</span> 76 |  54 |
| `generate_perm_trace_time_ms` |  34.50 |  69 |  39 |  30 |
| `perm_trace_commit_time_ms` | <span style='color: red'>(+2 [+2.5%])</span> 77.70 | <span style='color: red'>(+4 [+2.5%])</span> 155.40 | <span style='color: red'>(+2 [+2.6%])</span> 90.24 | <span style='color: red'>(+2 [+2.4%])</span> 65.16 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+1 [+1.2%])</span> 83.25 | <span style='color: red'>(+2 [+1.2%])</span> 166.49 | <span style='color: red'>(+1 [+1.5%])</span> 92.52 | <span style='color: red'>(+1 [+0.9%])</span> 73.97 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+1 [+5.0%])</span> 17.77 | <span style='color: red'>(+2 [+5.0%])</span> 35.54 | <span style='color: red'>(+2 [+8.3%])</span> 19.65 | <span style='color: red'>(+0 [+1.3%])</span> 15.88 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+333 [+512.3%])</span> 398 | <span style='color: red'>(+666 [+512.3%])</span> 796 | <span style='color: red'>(+479 [+684.3%])</span> 549 | <span style='color: red'>(+187 [+311.7%])</span> 247 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 785 | 1 | 63 | 1,745,742 | 27.66 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 180 | 1,327 | 32,480,114 | 172,558,444 | 180 | 872 | 0 | 92.52 | 19.65 | 8 | 90.24 | 549 | 132 | 549 | 1 | 76 | 15,909,408 | 39 | 107 | 1,149,000 | 11.12 | 26 | 113 | 1 | 549 | 
| pairing | 1 | 192 | 785 | 22,464,232 | 119,958,502 | 192 | 490 | 1 | 73.97 | 15.88 | 9 | 65.16 | 247 | 98 | 246 | 0 | 54 | 9,498,894 | 30 | 61 | 596,742 | 17.78 | 21 | 90 | 1 | 246 | 

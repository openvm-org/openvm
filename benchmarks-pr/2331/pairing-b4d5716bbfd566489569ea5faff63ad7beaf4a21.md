...
|:---|---:|---:|---:|
| Total | <span style='color: red'>(+1 [+94.0%])</span> 2.91 | <span style='color: red'>(+1 [+86.9%])</span> 1.68 | 1.68 |
| pairing | <span style='color: red'>(+1 [+94.0%])</span> 2.91 | <span style='color: red'>(+1 [+86.9%])</span> 1.68 |  1.68 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+704 [+98.1%])</span> 1,421.50 | <span style='color: red'>(+1408 [+98.1%])</span> 2,843 | <span style='color: red'>(+781 [+93.4%])</span> 1,617 | <span style='color: red'>(+627 [+104.7%])</span> 1,226 |
...
| `execute_metered_insn_mi/s` | <span style='color: green'>(-0 [-0.2%])</span> 27.45 | -          | <span style='color: green'>(-0 [-0.2%])</span> 27.45 | <span style='color: green'>(-0 [-0.2%])</span> 27.45 |
| `execute_preflight_insns` |  872,871 |  1,745,742 |  1,149,000 |  596,742 |
| `execute_preflight_time_ms` | <span style='color: green'>(-0 [-0.6%])</span> 83.50 | <span style='color: green'>(-1 [-0.6%])</span> 167 |  106 | <span style='color: green'>(-1 [-1.6%])</span> 61 |
| `execute_preflight_insn_mi/s` | <span style='color: green'>(-0 [-0.5%])</span> 14.65 | -          | <span style='color: green'>(-0 [-0.8%])</span> 18.15 |  11.15 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+6 [+3.0%])</span> 186.50 | <span style='color: red'>(+11 [+3.0%])</span> 373 | <span style='color: red'>(+5 [+2.7%])</span> 192 | <span style='color: red'>(+6 [+3.4%])</span> 181 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+700 [+201.9%])</span> 1,046 | <span style='color: red'>(+1399 [+201.9%])</span> 2,092 | <span style='color: red'>(+938 [+244.3%])</span> 1,322 | <span style='color: red'>(+461 [+149.2%])</span> 770 |
...
| `generate_perm_trace_time_ms` | <span style='color: green'>(-0 [-1.5%])</span> 33.50 | <span style='color: green'>(-1 [-1.5%])</span> 67 | <span style='color: green'>(-2 [-5.1%])</span> 37 | <span style='color: red'>(+1 [+3.4%])</span> 30 |
| `perm_trace_commit_time_ms` | <span style='color: red'>(+1 [+1.9%])</span> 77.90 | <span style='color: red'>(+3 [+1.9%])</span> 155.81 | <span style='color: red'>(+3 [+2.9%])</span> 90.37 | <span style='color: red'>(+0 [+0.5%])</span> 65.44 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+1 [+1.4%])</span> 83.27 | <span style='color: red'>(+2 [+1.4%])</span> 166.54 | <span style='color: red'>(+3 [+3.0%])</span> 92.69 | <span style='color: green'>(-0 [-0.5%])</span> 73.85 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+1 [+6.3%])</span> 18.11 | <span style='color: red'>(+2 [+6.3%])</span> 36.23 | <span style='color: red'>(+1 [+6.6%])</span> 20.11 | <span style='color: red'>(+1 [+6.0%])</span> 16.12 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+695 [+1022.1%])</span> 763 | <span style='color: red'>(+1390 [+1022.1%])</span> 1,526 | <span style='color: red'>(+1009 [+1462.3%])</span> 1,078 | <span style='color: red'>(+381 [+568.7%])</span> 448 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 1,617 | 1 | 63 | 1,745,742 | 27.45 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 181 | 1,226 | 32,480,114 | 172,558,444 | 181 | 770 | 0 | 92.69 | 20.11 | 8 | 90.37 | 448 | 130 | 448 | 1 | 76 | 15,909,408 | 37 | 106 | 1,149,000 | 11.15 | 27 | 113 | 1 | 448 | 
| pairing | 1 | 192 | 1,617 | 22,464,232 | 119,958,502 | 192 | 1,322 | 1 | 73.85 | 16.12 | 8 | 65.44 | 1,078 | 99 | 1,078 | 0 | 54 | 9,498,894 | 30 | 61 | 596,742 | 18.15 | 21 | 90 | 1 | 1,078 | 

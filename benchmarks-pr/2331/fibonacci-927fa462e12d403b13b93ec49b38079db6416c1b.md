...
|:---|---:|---:|---:|
| Total | <span style='color: red'>(+6 [+569.8%])</span> 6.89 | <span style='color: red'>(+3 [+531.9%])</span> 3.70 | 3.70 |
| fibonacci_program | <span style='color: red'>(+6 [+569.8%])</span> 6.89 | <span style='color: red'>(+3 [+531.9%])</span> 3.70 |  3.70 |


| fibonacci_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+2932 [+574.8%])</span> 3,441.50 | <span style='color: red'>(+5863 [+574.8%])</span> 6,883 | <span style='color: red'>(+3117 [+540.2%])</span> 3,694 | <span style='color: red'>(+2746 [+619.9%])</span> 3,189 |
...
| `execute_metered_insn_mi/s` | <span style='color: green'>(-1 [-0.5%])</span> 162.17 | -          | <span style='color: green'>(-1 [-0.5%])</span> 162.17 | <span style='color: green'>(-1 [-0.5%])</span> 162.17 |
| `execute_preflight_insns` |  750,104.50 |  1,500,209 |  873,000 |  627,209 |
| `execute_preflight_time_ms` |  27.50 |  55 |  33 |  22 |
| `execute_preflight_insn_mi/s` | <span style='color: green'>(-1 [-1.9%])</span> 37.57 | -          | <span style='color: green'>(-1 [-1.3%])</span> 38.05 | <span style='color: green'>(-1 [-2.5%])</span> 37.09 |
...
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+2930 [+1571.3%])</span> 3,117 | <span style='color: red'>(+5861 [+1571.3%])</span> 6,234 | <span style='color: red'>(+3246 [+1717.5%])</span> 3,435 | <span style='color: red'>(+2615 [+1421.2%])</span> 2,799 |
| `main_trace_commit_time_ms` |  30.50 |  61 |  33 |  28 |
| `generate_perm_trace_time_ms` | <span style='color: red'>(+27 [+101.9%])</span> 53.50 | <span style='color: red'>(+54 [+101.9%])</span> 107 | <span style='color: red'>(+34 [+89.5%])</span> 72 | <span style='color: red'>(+20 [+133.3%])</span> 35 |
| `perm_trace_commit_time_ms` | <span style='color: green'>(-1 [-2.9%])</span> 40.51 | <span style='color: green'>(-2 [-2.9%])</span> 81.02 | <span style='color: green'>(-2 [-5.2%])</span> 42.81 | <span style='color: green'>(-0 [-0.1%])</span> 38.21 |
| `quotient_poly_compute_time_ms` | <span style='color: green'>(-1 [-2.7%])</span> 31.11 | <span style='color: green'>(-2 [-2.7%])</span> 62.22 | <span style='color: red'>(+0 [+0.1%])</span> 34.87 | <span style='color: green'>(-2 [-6.1%])</span> 27.34 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+0 [+1.4%])</span> 12.18 | <span style='color: red'>(+0 [+1.4%])</span> 24.36 | <span style='color: green'>(-0 [-3.5%])</span> 12.29 | <span style='color: red'>(+1 [+6.9%])</span> 12.07 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+2906 [+7001.2%])</span> 2,947 | <span style='color: red'>(+5811 [+7001.2%])</span> 5,894 | <span style='color: red'>(+3246 [+7056.5%])</span> 3,292 | <span style='color: red'>(+2565 [+6932.4%])</span> 2,602 |
...
| --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 3,694 | 1 | 9 | 1,500,209 | 162.17 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 186 | 3,189 | 9,677,708 | 84,395,212 | 186 | 2,799 | 0 | 34.87 | 12.29 | 6 | 42.81 | 2,602 | 115 | 2,602 | 0 | 33 | 1,035,986 | 72 | 33 | 873,000 | 38.05 | 14 | 47 | 0 | 2,601 | 
| fibonacci_program | 1 | 194 | 3,694 | 9,708,170 | 74,305,770 | 194 | 3,435 | 1 | 27.34 | 12.07 | 5 | 38.21 | 3,292 | 74 | 3,292 | 0 | 28 | 1,064,416 | 35 | 22 | 627,209 | 37.09 | 11 | 39 | 0 | 3,292 | 

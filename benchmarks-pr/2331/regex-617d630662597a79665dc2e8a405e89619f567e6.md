...
|:---|---:|---:|---:|
| Total | <span style='color: red'>(+1 [+48.1%])</span> 3.58 | <span style='color: red'>(+0 [+42.4%])</span> 1.06 | 1.06 |
| regex_program | <span style='color: red'>(+1 [+48.0%])</span> 3.58 | <span style='color: red'>(+0 [+42.2%])</span> 1.06 |  1.06 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+290 [+48.7%])</span> 885.25 | <span style='color: red'>(+1160 [+48.7%])</span> 3,541 | <span style='color: red'>(+315 [+44.3%])</span> 1,026 | <span style='color: red'>(+212 [+39.4%])</span> 750 |
...
| `execute_metered_insn_mi/s` | <span style='color: green'>(-2 [-1.8%])</span> 113.32 | -          | <span style='color: green'>(-2 [-1.8%])</span> 113.32 | <span style='color: green'>(-2 [-1.8%])</span> 113.32 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` | <span style='color: red'>(+2 [+3.9%])</span> 47 | <span style='color: red'>(+7 [+3.9%])</span> 188 | <span style='color: red'>(+1 [+1.8%])</span> 57 |  34 |
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+0 [+0.4%])</span> 31.83 | -          | <span style='color: red'>(+1 [+1.9%])</span> 32.67 | <span style='color: green'>(-0 [-1.2%])</span> 30.30 |
| `trace_gen_time_ms   ` | <span style='color: green'>(-5 [-2.8%])</span> 174 | <span style='color: green'>(-20 [-2.8%])</span> 696 | <span style='color: green'>(-4 [-2.1%])</span> 190 | <span style='color: green'>(-4 [-2.4%])</span> 166 |
| `memory_finalize_time_ms` |  1 |  4 |  4 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+293 [+98.7%])</span> 590.25 | <span style='color: red'>(+1173 [+98.7%])</span> 2,361 | <span style='color: red'>(+341 [+108.6%])</span> 655 | <span style='color: red'>(+216 [+78.5%])</span> 491 |
| `main_trace_commit_time_ms` | <span style='color: green'>(-2 [-2.9%])</span> 50.75 | <span style='color: green'>(-6 [-2.9%])</span> 203 | <span style='color: green'>(-2 [-3.5%])</span> 55 | <span style='color: green'>(-1 [-2.0%])</span> 49 |
| `generate_perm_trace_time_ms` | <span style='color: green'>(-5 [-14.2%])</span> 28.75 | <span style='color: green'>(-19 [-14.2%])</span> 115 | <span style='color: green'>(-17 [-33.3%])</span> 34 | <span style='color: red'>(+1 [+4.2%])</span> 25 |
| `perm_trace_commit_time_ms` | <span style='color: green'>(-1 [-1.2%])</span> 63.72 | <span style='color: green'>(-3 [-1.2%])</span> 254.87 | <span style='color: green'>(-3 [-4.1%])</span> 68.81 | <span style='color: green'>(-0 [-0.3%])</span> 54.81 |
| `quotient_poly_compute_time_ms` | <span style='color: green'>(-2 [-3.4%])</span> 58.74 | <span style='color: green'>(-8 [-3.4%])</span> 234.96 | <span style='color: green'>(-4 [-5.7%])</span> 68.75 | <span style='color: green'>(-1 [-2.0%])</span> 52.89 |
| `quotient_poly_commit_time_ms` | <span style='color: green'>(-0 [-1.5%])</span> 15.85 | <span style='color: green'>(-1 [-1.5%])</span> 63.41 | <span style='color: green'>(-0 [-1.8%])</span> 18.42 | <span style='color: red'>(+0 [+2.5%])</span> 13.93 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+303 [+455.3%])</span> 369.25 | <span style='color: red'>(+1211 [+455.3%])</span> 1,477 | <span style='color: red'>(+364 [+491.9%])</span> 438 | <span style='color: red'>(+216 [+348.4%])</span> 278 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 922 | 1 | 36 | 4,137,502 | 113.32 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 167 | 1,026 | 23,446,148 | 150,778,428 | 167 | 633 | 0 | 59.69 | 18.42 | 7 | 68.81 | 394 | 104 | 393 | 4 | 55 | 10,899,170 | 34 | 57 | 1,103,000 | 30.30 | 22 | 78 | 0 | 393 | 
| regex_program | 1 | 166 | 750 | 11,598,276 | 128,513,066 | 166 | 491 | 1 | 53.63 | 15 | 6 | 65.69 | 278 | 92 | 278 | 0 | 50 | 2,196,106 | 26 | 51 | 1,104,000 | 32.19 | 16 | 69 | 0 | 278 | 
| regex_program | 2 | 173 | 843 | 11,579,064 | 128,513,066 | 173 | 582 | 1 | 52.89 | 16.06 | 6 | 65.56 | 367 | 96 | 367 | 0 | 49 | 2,177,334 | 30 | 46 | 1,104,000 | 32.67 | 17 | 69 | 0 | 367 | 
| regex_program | 3 | 190 | 922 | 11,853,872 | 103,456,394 | 190 | 655 | 0 | 68.75 | 13.93 | 7 | 54.81 | 438 | 84 | 437 | 0 | 49 | 2,422,606 | 25 | 34 | 826,502 | 32.16 | 19 | 83 | 0 | 437 | 

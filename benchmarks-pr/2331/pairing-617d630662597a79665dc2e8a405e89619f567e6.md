...
|:---|---:|---:|---:|
| Total | <span style='color: red'>(+1 [+42.7%])</span> 2.24 | <span style='color: red'>(+0 [+37.4%])</span> 1.25 | 1.25 |
| pairing | <span style='color: red'>(+1 [+42.7%])</span> 2.24 | <span style='color: red'>(+0 [+37.4%])</span> 1.25 |  1.25 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+334 [+44.5%])</span> 1,086 | <span style='color: red'>(+669 [+44.5%])</span> 2,172 | <span style='color: red'>(+341 [+40.2%])</span> 1,190 | <span style='color: red'>(+328 [+50.2%])</span> 982 |
...
| `execute_metered_insn_mi/s` | <span style='color: red'>(+0 [+0.5%])</span> 27.70 | -          | <span style='color: red'>(+0 [+0.5%])</span> 27.70 | <span style='color: red'>(+0 [+0.5%])</span> 27.70 |
| `execute_preflight_insns` |  872,871 |  1,745,742 |  1,149,000 |  596,742 |
| `execute_preflight_time_ms` |  82 |  164 |  117 |  47 |
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+0 [+0.7%])</span> 15.02 | -          | <span style='color: red'>(+0 [+0.9%])</span> 18.42 | <span style='color: red'>(+0 [+0.3%])</span> 11.61 |
...
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+334 [+88.3%])</span> 711 | <span style='color: red'>(+667 [+88.3%])</span> 1,422 | <span style='color: red'>(+341 [+86.5%])</span> 735 | <span style='color: red'>(+326 [+90.3%])</span> 687 |
| `main_trace_commit_time_ms` |  63.50 |  127 | <span style='color: green'>(-1 [-1.4%])</span> 73 | <span style='color: red'>(+1 [+1.9%])</span> 54 |
| `generate_perm_trace_time_ms` | <span style='color: green'>(-16 [-26.8%])</span> 45 | <span style='color: green'>(-33 [-26.8%])</span> 90 | <span style='color: green'>(-35 [-41.2%])</span> 50 | <span style='color: red'>(+2 [+5.3%])</span> 40 |
| `perm_trace_commit_time_ms` |  77.45 |  154.90 | <span style='color: green'>(-0 [-0.2%])</span> 89.13 | <span style='color: red'>(+0 [+0.5%])</span> 65.77 |
| `quotient_poly_compute_time_ms` | <span style='color: green'>(-0 [-0.5%])</span> 84.21 | <span style='color: green'>(-1 [-0.5%])</span> 168.42 | <span style='color: green'>(-0 [-0.3%])</span> 94.05 | <span style='color: green'>(-1 [-0.9%])</span> 74.37 |
| `quotient_poly_commit_time_ms` | <span style='color: green'>(-1 [-3.3%])</span> 17.14 | <span style='color: green'>(-1 [-3.3%])</span> 34.28 | <span style='color: green'>(-1 [-4.0%])</span> 19.05 | <span style='color: green'>(-0 [-2.6%])</span> 15.23 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+350 [+519.3%])</span> 418 | <span style='color: red'>(+701 [+519.3%])</span> 836 | <span style='color: red'>(+349 [+478.1%])</span> 422 | <span style='color: red'>(+352 [+567.7%])</span> 414 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 982 | 1 | 63 | 1,745,742 | 27.70 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 170 | 1,190 | 32,480,114 | 172,558,444 | 170 | 735 | 0 | 94.05 | 19.05 | 8 | 89.13 | 414 | 132 | 414 | 1 | 73 | 15,909,408 | 40 | 117 | 1,149,000 | 11.61 | 27 | 113 | 1 | 414 | 
| pairing | 1 | 206 | 982 | 22,464,232 | 119,958,502 | 206 | 687 | 1 | 74.37 | 15.23 | 8 | 65.77 | 422 | 119 | 422 | 0 | 54 | 9,498,894 | 50 | 47 | 596,742 | 18.42 | 21 | 90 | 1 | 422 | 

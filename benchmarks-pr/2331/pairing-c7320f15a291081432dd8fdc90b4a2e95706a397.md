...
|:---|---:|---:|---:|
| Total | <span style='color: red'>(+1 [+92.7%])</span> 2.87 | <span style='color: red'>(+1 [+65.1%])</span> 1.48 | 1.48 |
| pairing | <span style='color: red'>(+1 [+92.5%])</span> 2.87 | <span style='color: red'>(+1 [+64.9%])</span> 1.48 |  1.48 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+688 [+96.6%])</span> 1,401 | <span style='color: red'>(+1377 [+96.6%])</span> 2,802 | <span style='color: red'>(+583 [+69.8%])</span> 1,418 | <span style='color: red'>(+794 [+134.6%])</span> 1,384 |
...
| `execute_metered_insn_mi/s` | <span style='color: green'>(-0 [-0.5%])</span> 27.63 | -          | <span style='color: green'>(-0 [-0.5%])</span> 27.63 | <span style='color: green'>(-0 [-0.5%])</span> 27.63 |
...
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+0 [+1.2%])</span> 14.99 | -          | <span style='color: red'>(+0 [+0.8%])</span> 18.40 | <span style='color: red'>(+0 [+1.8%])</span> 11.58 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+6 [+3.6%])</span> 186 | <span style='color: red'>(+13 [+3.6%])</span> 372 | <span style='color: red'>(+5 [+2.5%])</span> 204 | <span style='color: red'>(+8 [+5.0%])</span> 168 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+682 [+197.5%])</span> 1,026.50 | <span style='color: red'>(+1363 [+197.5%])</span> 2,053 | <span style='color: red'>(+737 [+189.9%])</span> 1,125 | <span style='color: red'>(+626 [+207.3%])</span> 928 |
...
| `generate_perm_trace_time_ms` | <span style='color: red'>(+16 [+45.8%])</span> 52.50 | <span style='color: red'>(+33 [+45.8%])</span> 105 | <span style='color: red'>(+27 [+75.0%])</span> 63 | <span style='color: red'>(+6 [+16.7%])</span> 42 |
| `perm_trace_commit_time_ms` | <span style='color: red'>(+1 [+1.6%])</span> 77.06 | <span style='color: red'>(+2 [+1.6%])</span> 154.13 | <span style='color: red'>(+1 [+1.7%])</span> 89.04 | <span style='color: red'>(+1 [+1.5%])</span> 65.09 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+1 [+1.4%])</span> 83.52 | <span style='color: red'>(+2 [+1.4%])</span> 167.05 | <span style='color: red'>(+2 [+2.0%])</span> 93.62 | <span style='color: red'>(+0 [+0.7%])</span> 73.43 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+0 [+0.4%])</span> 17.08 | <span style='color: red'>(+0 [+0.4%])</span> 34.16 | <span style='color: green'>(-0 [-1.2%])</span> 18.94 | <span style='color: red'>(+0 [+2.4%])</span> 15.23 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+662 [+1026.4%])</span> 726.50 | <span style='color: red'>(+1324 [+1026.4%])</span> 1,453 | <span style='color: red'>(+775 [+1061.6%])</span> 848 | <span style='color: red'>(+549 [+980.4%])</span> 605 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 1,418 | 1 | 63 | 1,745,742 | 27.63 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 168 | 1,384 | 32,480,114 | 172,558,444 | 168 | 928 | 0 | 93.62 | 18.94 | 9 | 89.04 | 605 | 134 | 605 | 1 | 75 | 15,909,408 | 42 | 118 | 1,149,000 | 11.58 | 27 | 113 | 1 | 605 | 
| pairing | 1 | 204 | 1,418 | 22,464,232 | 119,958,502 | 204 | 1,125 | 1 | 73.43 | 15.23 | 8 | 65.09 | 848 | 131 | 848 | 0 | 55 | 9,498,894 | 63 | 47 | 596,742 | 18.40 | 21 | 89 | 1 | 848 | 

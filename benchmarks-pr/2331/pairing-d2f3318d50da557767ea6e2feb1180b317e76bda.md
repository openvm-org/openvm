...
|:---|---:|---:|---:|
| Total | <span style='color: red'>(+1 [+44.7%])</span> 2.24 | <span style='color: red'>(+0 [+34.2%])</span> 1.23 | 1.23 |
| pairing | <span style='color: red'>(+1 [+44.7%])</span> 2.24 | <span style='color: red'>(+0 [+34.2%])</span> 1.23 |  1.23 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+345 [+46.6%])</span> 1,086 | <span style='color: red'>(+690 [+46.6%])</span> 2,172 | <span style='color: red'>(+313 [+36.8%])</span> 1,164 | <span style='color: red'>(+377 [+59.7%])</span> 1,008 |
...
| `execute_metered_insn_mi/s` | <span style='color: red'>(+0 [+1.1%])</span> 27.67 | -          | <span style='color: red'>(+0 [+1.1%])</span> 27.67 | <span style='color: red'>(+0 [+1.1%])</span> 27.67 |
| `execute_preflight_insns` |  872,871 |  1,745,742 |  1,149,000 |  596,742 |
| `execute_preflight_time_ms` | <span style='color: green'>(-2 [-1.8%])</span> 83.50 | <span style='color: green'>(-3 [-1.8%])</span> 167 | <span style='color: red'>(+1 [+0.9%])</span> 107 | <span style='color: green'>(-4 [-6.2%])</span> 60 |
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+0 [+0.2%])</span> 14.66 | -          | <span style='color: red'>(+0 [+0.8%])</span> 18.17 | <span style='color: green'>(-0 [-0.6%])</span> 11.15 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+4 [+1.9%])</span> 186 | <span style='color: red'>(+7 [+1.9%])</span> 372 | <span style='color: red'>(+7 [+3.8%])</span> 193 |  179 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+343 [+93.2%])</span> 711 | <span style='color: red'>(+686 [+93.2%])</span> 1,422 | <span style='color: red'>(+316 [+79.6%])</span> 713 | <span style='color: red'>(+370 [+109.1%])</span> 709 |
...
| `generate_perm_trace_time_ms` | <span style='color: green'>(-3 [-7.8%])</span> 35.50 | <span style='color: green'>(-6 [-7.8%])</span> 71 | <span style='color: red'>(+1 [+2.6%])</span> 40 | <span style='color: green'>(-7 [-18.4%])</span> 31 |
| `perm_trace_commit_time_ms` | <span style='color: red'>(+2 [+2.5%])</span> 77.87 | <span style='color: red'>(+4 [+2.5%])</span> 155.75 | <span style='color: red'>(+2 [+1.9%])</span> 89.96 | <span style='color: red'>(+2 [+3.2%])</span> 65.79 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+3 [+4.1%])</span> 84.83 | <span style='color: red'>(+7 [+4.1%])</span> 169.66 | <span style='color: red'>(+5 [+5.5%])</span> 94.74 | <span style='color: red'>(+2 [+2.3%])</span> 74.93 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+0 [+2.8%])</span> 17.87 | <span style='color: red'>(+1 [+2.8%])</span> 35.75 | <span style='color: red'>(+1 [+6.4%])</span> 20.34 | <span style='color: green'>(-0 [-1.5%])</span> 15.41 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+340 [+397.7%])</span> 425.50 | <span style='color: red'>(+680 [+397.7%])</span> 851 | <span style='color: red'>(+379 [+430.7%])</span> 467 | <span style='color: red'>(+301 [+362.7%])</span> 384 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 1,008 | 1 | 63 | 1,745,742 | 27.67 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 179 | 1,164 | 32,480,114 | 172,558,444 | 179 | 709 | 0 | 94.74 | 20.34 | 8 | 89.96 | 384 | 133 | 384 | 1 | 75 | 15,909,408 | 40 | 107 | 1,149,000 | 11.15 | 27 | 115 | 1 | 384 | 
| pairing | 1 | 193 | 1,008 | 22,464,232 | 119,958,502 | 193 | 713 | 1 | 74.93 | 15.41 | 8 | 65.79 | 467 | 99 | 466 | 0 | 55 | 9,498,894 | 31 | 60 | 596,742 | 18.17 | 21 | 90 | 1 | 466 | 

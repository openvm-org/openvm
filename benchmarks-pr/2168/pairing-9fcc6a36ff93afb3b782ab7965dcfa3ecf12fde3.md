...
| `total_proof_time_ms ` |  722.50 |  1,445 |  844 |  601 |
...
| `execute_preflight_insn_mi/s` |  13.48 | -          |  18 |  8.97 |
| `trace_gen_time_ms   ` |  181 |  362 |  193 |  169 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  347 |  694 |  393 |  301 |
| `main_trace_commit_time_ms` |  66 |  132 |  76 |  56 |
| `generate_perm_trace_time_ms` |  36 |  72 |  43 |  29 |
| `perm_trace_commit_time_ms` |  77.87 |  155.73 |  89.66 |  66.07 |
| `quotient_poly_compute_time_ms` |  79.37 |  158.73 |  87.77 |  70.96 |
| `quotient_poly_commit_time_ms` |  16.27 |  32.54 |  18.09 |  14.44 |
| `pcs_opening_time_ms ` |  66.50 |  133 |  73 |  60 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 601 | 42 | 1 | 90 | 1,745,742 | 19.36 | 150 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 169 | 844 | 32,689,110 | 172,558,444 | 169 | 393 | 0 | 87.77 | 18.09 | 6 | 89.66 | 73 | 136 | 72 | 1 | 76 | 16,059,916 | 43 | 133 | 1,157,000 | 8.97 | 26 | 106 | 1 | 72 | 
| pairing | 1 | 193 | 601 | 22,314,288 | 119,958,502 | 193 | 301 | 1 | 70.96 | 14.44 | 6 | 66.07 | 60 | 98 | 59 | 0 | 56 | 9,408,294 | 29 | 65 | 588,742 | 18 | 20 | 86 | 1 | 59 | 

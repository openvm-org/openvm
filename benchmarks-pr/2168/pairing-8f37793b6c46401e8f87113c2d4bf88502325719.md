...
| `total_proof_time_ms ` |  720.50 |  1,441 |  849 |  592 |
...
| `execute_preflight_insn_mi/s` |  13.52 | -          |  17.98 |  9.05 |
| `trace_gen_time_ms   ` |  177 |  354 |  194 |  160 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  354 |  708 |  412 |  296 |
| `main_trace_commit_time_ms` |  65 |  130 |  75 |  55 |
| `generate_perm_trace_time_ms` |  35 |  70 |  42 |  28 |
| `perm_trace_commit_time_ms` |  76.31 |  152.63 |  88.32 |  64.30 |
| `quotient_poly_compute_time_ms` |  79.06 |  158.12 |  87.27 |  70.84 |
| `quotient_poly_commit_time_ms` |  16.05 |  32.10 |  18.06 |  14.04 |
| `pcs_opening_time_ms ` |  79 |  158 |  98 |  60 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 592 | 40 | 1 | 89 | 1,745,742 | 19.45 | 145 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 160 | 849 | 32,689,110 | 172,558,444 | 160 | 412 | 0 | 87.27 | 18.06 | 6 | 88.32 | 98 | 133 | 97 | 1 | 75 | 16,059,916 | 42 | 131 | 1,157,000 | 9.05 | 26 | 106 | 1 | 97 | 
| pairing | 1 | 194 | 592 | 22,314,288 | 119,958,502 | 193 | 296 | 1 | 70.84 | 14.04 | 5 | 64.30 | 60 | 95 | 59 | 0 | 55 | 9,408,294 | 28 | 60 | 588,742 | 17.98 | 20 | 85 | 1 | 59 | 

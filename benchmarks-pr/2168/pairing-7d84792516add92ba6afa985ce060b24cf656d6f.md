...
| `total_proof_time_ms ` |  718 |  1,436 |  824 |  612 |
...
| `execute_preflight_insn_mi/s` |  13.45 | -          |  17.78 |  9.12 |
| `trace_gen_time_ms   ` |  179.50 |  359 |  195 |  164 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  350 |  700 |  385 |  315 |
| `main_trace_commit_time_ms` |  64 |  128 |  75 |  53 |
| `generate_perm_trace_time_ms` |  45.50 |  91 |  49 |  42 |
| `perm_trace_commit_time_ms` |  75.30 |  150.59 |  85.65 |  64.94 |
| `quotient_poly_compute_time_ms` |  77.99 |  155.98 |  85.11 |  70.88 |
| `quotient_poly_commit_time_ms` |  16.68 |  33.36 |  18.94 |  14.42 |
| `pcs_opening_time_ms ` |  66 |  132 |  73 |  59 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 612 | 40 | 1 | 89 | 1,745,742 | 19.49 | 150 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 164 | 824 | 32,689,110 | 172,558,444 | 164 | 385 | 0 | 85.11 | 18.94 | 6 | 85.65 | 73 | 131 | 73 | 1 | 75 | 16,059,916 | 42 | 130 | 1,157,000 | 9.12 | 26 | 104 | 1 | 73 | 
| pairing | 1 | 195 | 612 | 22,314,288 | 119,958,502 | 195 | 315 | 1 | 70.88 | 14.42 | 6 | 64.94 | 59 | 116 | 58 | 0 | 53 | 9,408,294 | 49 | 60 | 588,742 | 17.78 | 20 | 85 | 1 | 58 | 

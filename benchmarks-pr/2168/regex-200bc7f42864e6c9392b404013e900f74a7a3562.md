...
|:---|---:|---:|
| Total |  2.28 |  0.72 |
| regex_program |  2.25 |  0.69 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  562.75 |  2,251 |  691 |  508 |
...
| `execute_metered_insn_mi/s` |  123.14 | -          |  123.14 |  123.14 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  54.50 |  218 |  68 |  45 |
| `execute_preflight_insn_mi/s` |  30.01 | -          |  31.20 |  27.76 |
| `trace_gen_time_ms   ` |  172.50 |  690 |  207 |  149 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  267.75 |  1,071 |  291 |  251 |
| `main_trace_commit_time_ms` |  51 |  204 |  57 |  48 |
| `generate_perm_trace_time_ms` |  22.50 |  90 |  26 |  19 |
| `perm_trace_commit_time_ms` |  63.61 |  254.44 |  69.81 |  53.51 |
| `quotient_poly_compute_time_ms` |  56.86 |  227.45 |  69.05 |  49.65 |
| `quotient_poly_commit_time_ms` |  14.71 |  58.86 |  17.34 |  12.16 |
| `pcs_opening_time_ms ` |  56.25 |  225 |  64 |  49 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 524 | 41 | 1 | 33 | 4,137,502 | 123.14 | 168 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 207 | 691 | 23,446,148 | 150,778,428 | 207 | 291 | 0 | 59.10 | 17.34 | 5 | 69.81 | 63 | 94 | 63 | 4 | 57 | 10,899,170 | 23 | 46 | 1,103,000 | 27.76 | 21 | 77 | 1 | 63 | 
| regex_program | 1 | 149 | 528 | 11,598,276 | 128,513,066 | 149 | 270 | 1 | 49.65 | 14.37 | 4 | 64.70 | 64 | 92 | 63 | 0 | 49 | 2,196,106 | 26 | 68 | 1,104,000 | 30.11 | 16 | 64 | 0 | 63 | 
| regex_program | 2 | 156 | 508 | 11,579,064 | 128,513,066 | 156 | 251 | 1 | 49.65 | 14.98 | 4 | 66.41 | 49 | 86 | 49 | 0 | 50 | 2,177,334 | 19 | 59 | 1,104,000 | 30.99 | 16 | 65 | 0 | 49 | 
| regex_program | 3 | 178 | 524 | 11,853,872 | 103,456,394 | 178 | 259 | 0 | 69.05 | 12.16 | 5 | 53.51 | 49 | 79 | 49 | 0 | 48 | 2,422,606 | 22 | 45 | 826,502 | 31.20 | 18 | 82 | 1 | 49 | 

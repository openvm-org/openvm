...
| `total_proof_time_ms ` |  577.25 |  2,309 |  693 |  521 |
...
| `execute_metered_insn_mi/s` |  120.70 | -          |  120.70 |  120.70 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  54.75 |  219 |  66 |  46 |
| `execute_preflight_insn_mi/s` |  29.61 | -          |  30.54 |  26.99 |
| `trace_gen_time_ms   ` |  178 |  712 |  210 |  155 |
| `memory_finalize_time_ms` |  0.75 |  3 |  3 |  0 |
| `stark_prove_excluding_trace_time_ms` |  276.25 |  1,105 |  293 |  256 |
| `main_trace_commit_time_ms` |  51.75 |  207 |  57 |  49 |
| `generate_perm_trace_time_ms` |  22.25 |  89 |  28 |  18 |
| `perm_trace_commit_time_ms` |  65.30 |  261.19 |  72.20 |  55.17 |
| `quotient_poly_compute_time_ms` |  58.98 |  235.94 |  70.19 |  52.82 |
| `quotient_poly_commit_time_ms` |  14.91 |  59.63 |  16.71 |  12.55 |
| `pcs_opening_time_ms ` |  60 |  240 |  81 |  50 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 565 | 41 | 1 | 34 | 4,137,502 | 120.70 | 168 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 210 | 693 | 23,446,148 | 150,778,428 | 210 | 290 | 0 | 58.89 | 16.71 | 5 | 72.20 | 54 | 101 | 53 | 3 | 57 | 10,899,170 | 28 | 47 | 1,103,000 | 26.99 | 21 | 76 | 1 | 53 | 
| regex_program | 1 | 155 | 530 | 11,598,276 | 128,513,066 | 155 | 266 | 1 | 52.82 | 15.77 | 4 | 67.31 | 55 | 91 | 55 | 0 | 50 | 2,196,106 | 23 | 66 | 1,104,000 | 30.47 | 17 | 69 | 0 | 55 | 
| regex_program | 2 | 163 | 521 | 11,579,064 | 128,513,066 | 163 | 256 | 1 | 54.04 | 14.60 | 4 | 66.51 | 50 | 85 | 50 | 0 | 51 | 2,177,334 | 18 | 60 | 1,104,000 | 30.54 | 16 | 69 | 0 | 50 | 
| regex_program | 3 | 184 | 565 | 11,853,872 | 103,456,394 | 184 | 293 | 0 | 70.19 | 12.55 | 5 | 55.17 | 81 | 78 | 81 | 0 | 49 | 2,422,606 | 20 | 46 | 826,502 | 30.46 | 18 | 83 | 1 | 81 | 

...
| `total_proof_time_ms ` |  588 |  2,352 |  725 |  529 |
...
| `execute_metered_insn_mi/s` |  122.12 | -          |  122.12 |  122.12 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  56 |  224 |  68 |  47 |
| `execute_preflight_insn_mi/s` |  28.98 | -          |  30.14 |  26.40 |
| `trace_gen_time_ms   ` |  180 |  720 |  214 |  156 |
| `memory_finalize_time_ms` |  0.75 |  3 |  3 |  0 |
| `stark_prove_excluding_trace_time_ms` |  284.75 |  1,139 |  318 |  264 |
| `main_trace_commit_time_ms` |  52.25 |  209 |  58 |  50 |
| `generate_perm_trace_time_ms` |  25.75 |  103 |  33 |  21 |
| `perm_trace_commit_time_ms` |  65.39 |  261.56 |  72.24 |  55.87 |
| `quotient_poly_compute_time_ms` |  59.57 |  238.29 |  71.10 |  53.76 |
| `quotient_poly_commit_time_ms` |  15.07 |  60.29 |  17.67 |  13.10 |
| `pcs_opening_time_ms ` |  63 |  252 |  75 |  52 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 562 | 40 | 1 | 33 | 4,137,502 | 122.12 | 165 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 214 | 725 | 23,446,148 | 150,778,428 | 214 | 318 | 0 | 59.30 | 17.67 | 5 | 72.24 | 75 | 106 | 74 | 3 | 58 | 10,899,170 | 33 | 48 | 1,103,000 | 26.40 | 22 | 77 | 1 | 74 | 
| regex_program | 1 | 156 | 529 | 11,598,276 | 128,513,066 | 156 | 264 | 1 | 53.76 | 14.69 | 4 | 66.39 | 54 | 88 | 54 | 0 | 51 | 2,196,106 | 21 | 68 | 1,104,000 | 29.68 | 16 | 69 | 0 | 54 | 
| regex_program | 2 | 164 | 536 | 11,579,064 | 128,513,066 | 164 | 269 | 1 | 54.13 | 14.82 | 4 | 67.06 | 52 | 96 | 52 | 0 | 50 | 2,177,334 | 28 | 61 | 1,104,000 | 29.71 | 16 | 69 | 0 | 52 | 
| regex_program | 3 | 186 | 562 | 11,853,872 | 103,456,394 | 186 | 288 | 0 | 71.10 | 13.10 | 5 | 55.87 | 71 | 80 | 71 | 0 | 50 | 2,422,606 | 21 | 47 | 826,502 | 30.14 | 18 | 85 | 1 | 71 | 

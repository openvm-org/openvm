...
| `total_proof_time_ms ` |  585.75 |  2,343 |  707 |  528 |
...
| `execute_metered_insn_mi/s` |  120.36 | -          |  120.36 |  120.36 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  54.25 |  217 |  65 |  47 |
| `execute_preflight_insn_mi/s` |  31.82 | -          |  33.41 |  27.96 |
| `trace_gen_time_ms   ` |  175.50 |  702 |  209 |  153 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  286.75 |  1,147 |  300 |  268 |
| `main_trace_commit_time_ms` |  51 |  204 |  56 |  49 |
| `generate_perm_trace_time_ms` |  31.75 |  127 |  49 |  22 |
| `perm_trace_commit_time_ms` |  63.60 |  254.39 |  69.24 |  54.99 |
| `quotient_poly_compute_time_ms` |  56.84 |  227.35 |  68.07 |  51.39 |
| `quotient_poly_commit_time_ms` |  14.73 |  58.90 |  16.89 |  12.16 |
| `pcs_opening_time_ms ` |  65.50 |  262 |  73 |  61 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 549 | 41 | 1 | 34 | 4,137,502 | 120.36 | 168 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 209 | 707 | 23,446,148 | 150,778,428 | 209 | 300 | 0 | 55.15 | 16.89 | 5 | 69.24 | 73 | 97 | 72 | 4 | 56 | 10,899,170 | 26 | 47 | 1,103,000 | 27.96 | 21 | 72 | 1 | 72 | 
| regex_program | 1 | 153 | 528 | 11,598,276 | 128,513,066 | 153 | 268 | 1 | 52.74 | 14.48 | 4 | 64.92 | 61 | 88 | 61 | 0 | 50 | 2,196,106 | 22 | 65 | 1,104,000 | 32.78 | 16 | 67 | 0 | 61 | 
| regex_program | 2 | 161 | 559 | 11,579,064 | 128,513,066 | 161 | 299 | 1 | 51.39 | 15.37 | 5 | 65.24 | 67 | 114 | 67 | 0 | 49 | 2,177,334 | 49 | 57 | 1,104,000 | 33.13 | 17 | 67 | 0 | 67 | 
| regex_program | 3 | 179 | 549 | 11,853,872 | 103,456,394 | 179 | 280 | 0 | 68.07 | 12.16 | 5 | 54.99 | 61 | 88 | 60 | 0 | 49 | 2,422,606 | 30 | 48 | 826,502 | 33.41 | 18 | 81 | 1 | 60 | 

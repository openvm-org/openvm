...
|:---|---:|---:|
| Total |  1.01 |  0.59 |
| fibonacci_program |  1 |  0.58 |


| fibonacci_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  501.50 |  1,003 |  576 |  427 |
...
| `execute_metered_insn_mi/s` |  146.08 | -          |  146.08 |  146.08 |
| `execute_preflight_insns` |  750,104.50 |  1,500,209 |  873,000 |  627,209 |
| `execute_preflight_time_ms` |  30 |  60 |  34 |  26 |
| `execute_preflight_insn_mi/s` |  35.31 | -          |  36.42 |  34.19 |
| `trace_gen_time_ms   ` |  186 |  372 |  192 |  180 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  192.50 |  385 |  213 |  172 |
| `main_trace_commit_time_ms` |  30.50 |  61 |  33 |  28 |
| `generate_perm_trace_time_ms` |  26 |  52 |  31 |  21 |
| `perm_trace_commit_time_ms` |  40.68 |  81.36 |  43.11 |  38.25 |
| `quotient_poly_compute_time_ms` |  30.12 |  60.25 |  31.47 |  28.77 |
| `quotient_poly_commit_time_ms` |  11.77 |  23.55 |  12.42 |  11.13 |
| `pcs_opening_time_ms ` |  51.50 |  103 |  60 |  43 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 427 | 42 | 1 | 10 | 1,500,209 | 146.08 | 141 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 192 | 576 | 9,677,708 | 84,395,212 | 192 | 213 | 0 | 31.47 | 12.42 | 4 | 43.11 | 60 | 74 | 60 | 0 | 33 | 1,035,986 | 31 | 26 | 873,000 | 34.19 | 14 | 44 | 0 | 60 | 
| fibonacci_program | 1 | 180 | 427 | 9,708,170 | 74,305,770 | 180 | 172 | 1 | 28.77 | 11.13 | 4 | 38.25 | 43 | 59 | 43 | 0 | 28 | 1,064,416 | 21 | 34 | 627,209 | 36.42 | 11 | 40 | 0 | 43 | 

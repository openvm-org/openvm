...
| `total_proof_time_ms ` |  582.75 |  2,331 |  717 |  528 |
...
| `execute_metered_insn_mi/s` |  119.85 | -          |  119.85 |  119.85 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  53.50 |  214 |  65 |  44 |
| `execute_preflight_insn_mi/s` |  31.74 | -          |  33.40 |  27.44 |
| `trace_gen_time_ms   ` |  181.75 |  727 |  212 |  159 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  279 |  1,116 |  310 |  260 |
| `main_trace_commit_time_ms` |  52 |  208 |  57 |  50 |
| `generate_perm_trace_time_ms` |  24.75 |  99 |  30 |  19 |
| `perm_trace_commit_time_ms` |  65.32 |  261.28 |  71.92 |  55.92 |
| `quotient_poly_compute_time_ms` |  59.60 |  238.38 |  69.72 |  53.09 |
| `quotient_poly_commit_time_ms` |  14.100 |  59.99 |  17.33 |  12.68 |
| `pcs_opening_time_ms ` |  59 |  236 |  73 |  52 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 555 | 41 | 1 | 34 | 4,137,502 | 119.85 | 168 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 212 | 717 | 23,446,148 | 150,778,428 | 212 | 310 | 0 | 61.31 | 17.33 | 5 | 71.92 | 73 | 99 | 73 | 4 | 57 | 10,899,170 | 26 | 47 | 1,103,000 | 27.44 | 21 | 79 | 1 | 73 | 
| regex_program | 1 | 159 | 531 | 11,598,276 | 128,513,066 | 159 | 265 | 1 | 53.09 | 15.47 | 5 | 66.53 | 54 | 91 | 54 | 0 | 50 | 2,196,106 | 24 | 65 | 1,104,000 | 33.25 | 17 | 69 | 0 | 54 | 
| regex_program | 2 | 168 | 528 | 11,579,064 | 128,513,066 | 168 | 260 | 1 | 54.27 | 14.52 | 4 | 66.90 | 52 | 86 | 52 | 0 | 51 | 2,177,334 | 19 | 58 | 1,104,000 | 32.86 | 16 | 69 | 0 | 52 | 
| regex_program | 3 | 188 | 555 | 11,853,872 | 103,456,394 | 188 | 281 | 0 | 69.72 | 12.68 | 5 | 55.92 | 57 | 89 | 57 | 0 | 50 | 2,422,606 | 30 | 44 | 826,502 | 33.40 | 19 | 83 | 1 | 57 | 

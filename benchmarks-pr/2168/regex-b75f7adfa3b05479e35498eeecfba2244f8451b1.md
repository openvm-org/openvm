...
| `total_proof_time_ms ` |  569 |  2,276 |  689 |  515 |
...
| `execute_metered_insn_mi/s` |  121.19 | -          |  121.19 |  121.19 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  55 |  220 |  67 |  46 |
| `execute_preflight_insn_mi/s` |  30.14 | -          |  31.22 |  27.15 |
| `trace_gen_time_ms   ` |  176.50 |  706 |  210 |  153 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  270.50 |  1,082 |  288 |  253 |
| `main_trace_commit_time_ms` |  52.50 |  210 |  57 |  51 |
| `generate_perm_trace_time_ms` |  24.25 |  97 |  34 |  19 |
| `perm_trace_commit_time_ms` |  64.90 |  259.59 |  71.51 |  55.61 |
| `quotient_poly_compute_time_ms` |  58.64 |  234.55 |  69.61 |  52.69 |
| `quotient_poly_commit_time_ms` |  15.23 |  60.94 |  17.82 |  13.10 |
| `pcs_opening_time_ms ` |  52.25 |  209 |  57 |  46 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 552 | 40 | 1 | 34 | 4,137,502 | 121.19 | 177 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 210 | 689 | 23,446,148 | 150,778,428 | 210 | 288 | 0 | 59.44 | 17.82 | 5 | 71.51 | 57 | 95 | 57 | 4 | 57 | 10,899,170 | 23 | 47 | 1,103,000 | 27.15 | 21 | 77 | 1 | 57 | 
| regex_program | 1 | 153 | 515 | 11,598,276 | 128,513,066 | 153 | 253 | 1 | 52.81 | 14.62 | 4 | 65.78 | 46 | 87 | 46 | 0 | 51 | 2,196,106 | 21 | 67 | 1,104,000 | 31.16 | 16 | 67 | 0 | 46 | 
| regex_program | 2 | 161 | 520 | 11,579,064 | 128,513,066 | 161 | 258 | 1 | 52.69 | 15.40 | 4 | 66.69 | 51 | 86 | 51 | 0 | 51 | 2,177,334 | 19 | 60 | 1,104,000 | 31.02 | 16 | 68 | 0 | 51 | 
| regex_program | 3 | 182 | 552 | 11,853,872 | 103,456,394 | 181 | 283 | 0 | 69.61 | 13.10 | 5 | 55.61 | 55 | 92 | 55 | 0 | 51 | 2,422,606 | 34 | 46 | 826,502 | 31.22 | 18 | 83 | 1 | 55 | 

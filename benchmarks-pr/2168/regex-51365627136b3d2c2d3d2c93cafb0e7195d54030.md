...
| `total_proof_time_ms ` |  588.50 |  2,354 |  745 |  527 |
...
| `execute_metered_insn_mi/s` |  123.31 | -          |  123.31 |  123.31 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  54.25 |  217 |  66 |  46 |
| `execute_preflight_insn_mi/s` |  30.11 | -          |  31.03 |  27.61 |
| `trace_gen_time_ms   ` |  175.75 |  703 |  210 |  152 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  291 |  1,164 |  344 |  259 |
| `main_trace_commit_time_ms` |  51 |  204 |  57 |  48 |
| `generate_perm_trace_time_ms` |  34.50 |  138 |  54 |  19 |
| `perm_trace_commit_time_ms` |  64.05 |  256.20 |  69.86 |  54.61 |
| `quotient_poly_compute_time_ms` |  58.06 |  232.24 |  68.83 |  51.86 |
| `quotient_poly_commit_time_ms` |  15.01 |  60.03 |  16.79 |  12.27 |
| `pcs_opening_time_ms ` |  64.75 |  259 |  84 |  51 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 527 | 41 | 1 | 33 | 4,137,502 | 123.31 | 166 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 210 | 745 | 23,446,148 | 150,778,428 | 210 | 344 | 0 | 58.94 | 16.79 | 5 | 69.86 | 84 | 125 | 84 | 4 | 57 | 10,899,170 | 54 | 46 | 1,103,000 | 27.61 | 21 | 76 | 1 | 84 | 
| regex_program | 1 | 152 | 546 | 11,598,276 | 128,513,066 | 152 | 286 | 1 | 52.60 | 15.41 | 5 | 65.27 | 62 | 103 | 62 | 0 | 50 | 2,196,106 | 37 | 66 | 1,104,000 | 31.03 | 16 | 68 | 0 | 62 | 
| regex_program | 2 | 160 | 536 | 11,579,064 | 128,513,066 | 160 | 275 | 1 | 51.86 | 15.56 | 4 | 66.45 | 62 | 95 | 62 | 0 | 49 | 2,177,334 | 28 | 59 | 1,104,000 | 31.03 | 16 | 67 | 0 | 62 | 
| regex_program | 3 | 181 | 527 | 11,853,872 | 103,456,394 | 181 | 259 | 0 | 68.83 | 12.27 | 5 | 54.61 | 51 | 76 | 51 | 0 | 48 | 2,422,606 | 19 | 46 | 826,502 | 30.76 | 18 | 82 | 1 | 51 | 

...
| `total_proof_time_ms ` |  578.75 |  2,315 |  707 |  518 |
...
| `execute_metered_insn_mi/s` |  120.06 | -          |  120.06 |  120.06 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  54.25 |  217 |  66 |  46 |
| `execute_preflight_insn_mi/s` |  30.15 | -          |  31.32 |  27.56 |
| `trace_gen_time_ms   ` |  179 |  716 |  212 |  157 |
| `memory_finalize_time_ms` |  0.75 |  3 |  3 |  0 |
| `stark_prove_excluding_trace_time_ms` |  278 |  1,112 |  306 |  253 |
| `main_trace_commit_time_ms` |  51.50 |  206 |  57 |  49 |
| `generate_perm_trace_time_ms` |  28.75 |  115 |  39 |  20 |
| `perm_trace_commit_time_ms` |  64.53 |  258.13 |  72.04 |  54.34 |
| `quotient_poly_compute_time_ms` |  58.92 |  235.67 |  71.46 |  52.77 |
| `quotient_poly_commit_time_ms` |  14.66 |  58.66 |  16.62 |  12.78 |
| `pcs_opening_time_ms ` |  56.75 |  227 |  63 |  48 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 565 | 40 | 1 | 34 | 4,137,502 | 120.06 | 166 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 212 | 707 | 23,446,148 | 150,778,428 | 212 | 306 | 0 | 58.49 | 16.62 | 5 | 72.04 | 63 | 108 | 63 | 3 | 57 | 10,899,170 | 35 | 46 | 1,103,000 | 27.56 | 21 | 75 | 1 | 63 | 
| regex_program | 1 | 157 | 525 | 11,598,276 | 128,513,066 | 157 | 260 | 1 | 52.95 | 14.40 | 4 | 65.61 | 54 | 87 | 54 | 0 | 51 | 2,196,106 | 21 | 66 | 1,104,000 | 31.32 | 16 | 67 | 0 | 54 | 
| regex_program | 2 | 163 | 518 | 11,579,064 | 128,513,066 | 163 | 253 | 1 | 52.77 | 14.86 | 4 | 66.15 | 48 | 86 | 48 | 0 | 49 | 2,177,334 | 20 | 59 | 1,104,000 | 30.98 | 16 | 68 | 0 | 48 | 
| regex_program | 3 | 184 | 565 | 11,853,872 | 103,456,394 | 184 | 293 | 0 | 71.46 | 12.78 | 5 | 54.34 | 62 | 96 | 62 | 0 | 49 | 2,422,606 | 39 | 46 | 826,502 | 30.74 | 18 | 85 | 1 | 62 | 

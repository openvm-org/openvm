...
| `total_proof_time_ms ` |  573 |  2,292 |  702 |  520 |
...
| `execute_metered_insn_mi/s` |  112.69 | -          |  112.69 |  112.69 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  54.75 |  219 |  67 |  46 |
| `execute_preflight_insn_mi/s` |  30.30 | -          |  31.42 |  27.10 |
| `trace_gen_time_ms   ` |  175.75 |  703 |  208 |  153 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  275 |  1,100 |  302 |  258 |
| `main_trace_commit_time_ms` |  51.50 |  206 |  57 |  49 |
| `generate_perm_trace_time_ms` |  28.50 |  114 |  34 |  20 |
| `perm_trace_commit_time_ms` |  63.93 |  255.73 |  70.84 |  55.29 |
| `quotient_poly_compute_time_ms` |  57.40 |  229.61 |  68.33 |  50.90 |
| `quotient_poly_commit_time_ms` |  14.47 |  57.87 |  16.68 |  12.19 |
| `pcs_opening_time_ms ` |  56.50 |  226 |  64 |  53 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 546 | 66 | 1 | 36 | 4,137,502 | 112.69 | 192 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 208 | 702 | 23,446,148 | 150,778,428 | 208 | 302 | 0 | 57.83 | 16.68 | 5 | 70.84 | 64 | 105 | 63 | 4 | 57 | 10,899,170 | 33 | 47 | 1,103,000 | 27.10 | 21 | 75 | 1 | 63 | 
| regex_program | 1 | 153 | 520 | 11,598,276 | 128,513,066 | 153 | 258 | 1 | 52.56 | 14.61 | 4 | 64.77 | 54 | 86 | 54 | 0 | 50 | 2,196,106 | 20 | 67 | 1,104,000 | 31.26 | 16 | 67 | 0 | 54 | 
| regex_program | 2 | 161 | 524 | 11,579,064 | 128,513,066 | 161 | 262 | 1 | 50.90 | 14.39 | 4 | 64.83 | 53 | 92 | 52 | 0 | 50 | 2,177,334 | 27 | 59 | 1,104,000 | 31.40 | 16 | 65 | 0 | 52 | 
| regex_program | 3 | 181 | 546 | 11,853,872 | 103,456,394 | 181 | 278 | 0 | 68.33 | 12.19 | 5 | 55.29 | 55 | 92 | 55 | 0 | 49 | 2,422,606 | 34 | 46 | 826,502 | 31.42 | 18 | 81 | 1 | 55 | 

...
| `total_proof_time_ms ` |  714 |  1,428 |  839 |  589 |
...
| `execute_preflight_insn_mi/s` |  13.33 | -          |  17.61 |  9.06 |
| `trace_gen_time_ms   ` |  174 |  348 |  192 |  156 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  351.50 |  703 |  409 |  294 |
| `main_trace_commit_time_ms` |  65 |  130 |  75 |  55 |
| `generate_perm_trace_time_ms` |  35.50 |  71 |  42 |  29 |
| `perm_trace_commit_time_ms` |  73.79 |  147.58 |  83.62 |  63.96 |
| `quotient_poly_compute_time_ms` |  78.61 |  157.22 |  84.99 |  72.23 |
| `quotient_poly_commit_time_ms` |  16.69 |  33.39 |  19.03 |  14.36 |
| `pcs_opening_time_ms ` |  77 |  154 |  99 |  55 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 589 | 41 | 1 | 90 | 1,745,742 | 19.33 | 144 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 156 | 839 | 32,689,110 | 172,558,444 | 156 | 409 | 0 | 84.99 | 19.03 | 6 | 83.62 | 99 | 129 | 99 | 1 | 75 | 16,059,916 | 42 | 132 | 1,157,000 | 9.06 | 27 | 104 | 1 | 99 | 
| pairing | 1 | 192 | 589 | 22,314,288 | 119,958,502 | 192 | 294 | 1 | 72.23 | 14.36 | 6 | 63.96 | 55 | 96 | 55 | 0 | 55 | 9,408,294 | 29 | 61 | 588,742 | 17.61 | 21 | 87 | 1 | 55 | 

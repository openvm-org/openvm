...
|:---|---:|---:|
| Total |  2.41 |  0.75 |
| regex_program |  2.38 |  0.71 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  594.50 |  2,378 |  713 |  539 |
...
| `execute_preflight_insn_mi/s` |  31.81 | -          |  33.26 |  29.04 |
| `trace_gen_time_ms   ` |  180.75 |  723 |  214 |  157 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  291.50 |  1,166 |  307 |  273 |
| `main_trace_commit_time_ms` |  52 |  208 |  57 |  50 |
| `generate_perm_trace_time_ms` |  32 |  128 |  48 |  23 |
| `perm_trace_commit_time_ms` |  65.11 |  260.45 |  72.60 |  55.33 |
| `quotient_poly_compute_time_ms` |  58.67 |  234.69 |  70.62 |  52.86 |
| `quotient_poly_commit_time_ms` |  14.85 |  59.41 |  16.45 |  12.88 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 559 | 41 | 1 | 33 | 4,137,502 | 122.91 | 167 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 214 | 713 | 23,446,148 | 150,778,428 | 214 | 307 | 0 | 57.94 | 16.45 | 5 | 72.60 | 73 | 100 | 73 | 4 | 57 | 10,899,170 | 27 | 45 | 1,103,000 | 29.04 | 21 | 75 | 1 | 73 | 
| regex_program | 1 | 157 | 539 | 11,598,276 | 128,513,066 | 157 | 273 | 1 | 52.86 | 15.38 | 4 | 66.69 | 62 | 90 | 62 | 0 | 50 | 2,196,106 | 23 | 67 | 1,104,000 | 32.02 | 16 | 68 | 0 | 62 | 
| regex_program | 2 | 166 | 567 | 11,579,064 | 128,513,066 | 166 | 301 | 1 | 53.28 | 14.70 | 4 | 65.84 | 66 | 115 | 66 | 0 | 50 | 2,177,334 | 48 | 58 | 1,104,000 | 33.26 | 16 | 68 | 0 | 66 | 
| regex_program | 3 | 186 | 559 | 11,853,872 | 103,456,394 | 186 | 285 | 0 | 70.62 | 12.88 | 6 | 55.33 | 61 | 88 | 61 | 0 | 51 | 2,422,606 | 30 | 45 | 826,502 | 32.91 | 18 | 84 | 1 | 61 | 

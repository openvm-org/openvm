...
|:---|---:|---:|
| Total |  2.34 |  0.74 |
| regex_program |  2.30 |  0.71 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  575 |  2,300 |  705 |  519 |
...
| `execute_preflight_insn_mi/s` |  30.11 | -          |  31.24 |  27.17 |
| `trace_gen_time_ms   ` |  177.50 |  710 |  209 |  155 |
| `memory_finalize_time_ms` |  0.75 |  3 |  3 |  0 |
| `stark_prove_excluding_trace_time_ms` |  275 |  1,100 |  303 |  255 |
| `main_trace_commit_time_ms` |  52.25 |  209 |  57 |  50 |
| `generate_perm_trace_time_ms` |  25 |  100 |  33 |  19 |
| `perm_trace_commit_time_ms` |  64.86 |  259.42 |  70.80 |  54.64 |
| `quotient_poly_compute_time_ms` |  59.49 |  237.95 |  71.63 |  53.19 |
| `quotient_poly_commit_time_ms` |  15.24 |  60.97 |  17.10 |  13.02 |
| `pcs_opening_time_ms ` |  55.25 |  221 |  63 |  46 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 553 | 41 | 1 | 36 | 4,137,502 | 114.59 | 166 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 209 | 705 | 23,446,148 | 150,778,428 | 209 | 303 | 0 | 59.92 | 17.10 | 5 | 70.80 | 63 | 105 | 62 | 3 | 57 | 10,899,170 | 33 | 47 | 1,103,000 | 27.17 | 21 | 77 | 1 | 62 | 
| regex_program | 1 | 155 | 519 | 11,598,276 | 128,513,066 | 155 | 255 | 1 | 53.21 | 15.26 | 4 | 66.47 | 46 | 88 | 46 | 0 | 51 | 2,196,106 | 21 | 66 | 1,104,000 | 31.24 | 16 | 69 | 0 | 46 | 
| regex_program | 2 | 163 | 523 | 11,579,064 | 128,513,066 | 163 | 259 | 1 | 53.19 | 15.60 | 4 | 67.50 | 51 | 87 | 51 | 0 | 51 | 2,177,334 | 19 | 59 | 1,104,000 | 31.09 | 16 | 69 | 0 | 51 | 
| regex_program | 3 | 183 | 553 | 11,853,872 | 103,456,394 | 183 | 283 | 0 | 71.63 | 13.02 | 5 | 54.64 | 61 | 85 | 61 | 0 | 50 | 2,422,606 | 27 | 46 | 826,502 | 30.94 | 18 | 85 | 1 | 61 | 

...
| `total_proof_time_ms ` |  709.50 |  1,419 |  821 |  598 |
...
| `execute_preflight_insn_mi/s` |  13.41 | -          |  17.77 |  9.05 |
| `trace_gen_time_ms   ` |  177 |  354 |  195 |  159 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  342.50 |  685 |  385 |  300 |
| `main_trace_commit_time_ms` |  65 |  130 |  76 |  54 |
| `generate_perm_trace_time_ms` |  34.50 |  69 |  40 |  29 |
| `perm_trace_commit_time_ms` |  76.89 |  153.78 |  89.18 |  64.60 |
| `quotient_poly_compute_time_ms` |  79.80 |  159.60 |  87.54 |  72.06 |
| `quotient_poly_commit_time_ms` |  16.64 |  33.27 |  18.28 |  14.100 |
| `pcs_opening_time_ms ` |  64.50 |  129 |  69 |  60 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 598 | 41 | 1 | 89 | 1,745,742 | 19.49 | 147 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 159 | 821 | 32,689,110 | 172,558,444 | 159 | 385 | 0 | 87.54 | 18.28 | 6 | 89.18 | 69 | 132 | 69 | 0 | 76 | 16,059,916 | 40 | 131 | 1,157,000 | 9.05 | 26 | 106 | 1 | 69 | 
| pairing | 1 | 195 | 598 | 22,314,288 | 119,958,502 | 195 | 300 | 1 | 72.06 | 14.100 | 6 | 64.60 | 60 | 97 | 59 | 0 | 54 | 9,408,294 | 29 | 61 | 588,742 | 17.77 | 21 | 87 | 1 | 59 | 

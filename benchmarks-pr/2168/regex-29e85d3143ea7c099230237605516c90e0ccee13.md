...
| `total_proof_time_ms ` |  591.50 |  2,366 |  714 |  531 |
...
| `execute_preflight_insn_mi/s` |  31.41 | -          |  32.58 |  28.12 |
| `trace_gen_time_ms   ` |  181 |  724 |  213 |  159 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  289 |  1,156 |  307 |  266 |
| `main_trace_commit_time_ms` |  51.75 |  207 |  58 |  49 |
| `generate_perm_trace_time_ms` |  32 |  128 |  49 |  24 |
| `perm_trace_commit_time_ms` |  65.09 |  260.37 |  72.36 |  55.74 |
| `quotient_poly_compute_time_ms` |  58.46 |  233.83 |  69.60 |  52.23 |
| `quotient_poly_commit_time_ms` |  14.87 |  59.50 |  16.46 |  12.55 |
| `pcs_opening_time_ms ` |  63 |  252 |  72 |  53 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 557 | 41 | 1 | 34 | 4,137,502 | 121.58 | 171 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 213 | 714 | 23,446,148 | 150,778,428 | 213 | 307 | 0 | 58.89 | 16.46 | 5 | 72.36 | 72 | 100 | 72 | 4 | 58 | 10,899,170 | 26 | 46 | 1,103,000 | 28.12 | 21 | 76 | 1 | 72 | 
| regex_program | 1 | 159 | 531 | 11,598,276 | 128,513,066 | 159 | 266 | 1 | 53.10 | 15.68 | 4 | 67.60 | 53 | 92 | 53 | 0 | 49 | 2,196,106 | 24 | 64 | 1,104,000 | 32.58 | 17 | 69 | 0 | 53 | 
| regex_program | 2 | 165 | 564 | 11,579,064 | 128,513,066 | 165 | 300 | 1 | 52.23 | 14.79 | 4 | 64.67 | 66 | 114 | 66 | 0 | 51 | 2,177,334 | 49 | 58 | 1,104,000 | 32.49 | 17 | 67 | 0 | 66 | 
| regex_program | 3 | 187 | 557 | 11,853,872 | 103,456,394 | 187 | 283 | 0 | 69.60 | 12.55 | 5 | 55.74 | 61 | 88 | 61 | 0 | 49 | 2,422,606 | 29 | 45 | 826,502 | 32.46 | 18 | 83 | 1 | 61 | 

...
| `total_proof_time_ms ` |  590.50 |  2,362 |  717 |  534 |
...
| `execute_metered_insn_mi/s` |  121.63 | -          |  121.63 |  121.63 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  56.50 |  226 |  70 |  47 |
| `execute_preflight_insn_mi/s` |  29.95 | -          |  31.05 |  27.12 |
| `trace_gen_time_ms   ` |  182.50 |  730 |  217 |  159 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  283.50 |  1,134 |  305 |  265 |
| `main_trace_commit_time_ms` |  53 |  212 |  57 |  51 |
| `generate_perm_trace_time_ms` |  30.25 |  121 |  40 |  22 |
| `perm_trace_commit_time_ms` |  65.72 |  262.87 |  71.01 |  56.100 |
| `quotient_poly_compute_time_ms` |  59.25 |  236.99 |  71.27 |  54.16 |
| `quotient_poly_commit_time_ms` |  15.34 |  61.37 |  18.38 |  13.34 |
| `pcs_opening_time_ms ` |  57 |  228 |  65 |  50 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 573 | 41 | 1 | 33 | 4,137,502 | 121.63 | 170 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 217 | 717 | 23,446,148 | 150,778,428 | 217 | 305 | 0 | 56.56 | 18.38 | 5 | 71.01 | 65 | 106 | 65 | 4 | 57 | 10,899,170 | 34 | 48 | 1,103,000 | 27.12 | 22 | 75 | 1 | 65 | 
| regex_program | 1 | 159 | 538 | 11,598,276 | 128,513,066 | 159 | 268 | 1 | 54.99 | 14.94 | 4 | 67.94 | 55 | 90 | 54 | 0 | 52 | 2,196,106 | 22 | 70 | 1,104,000 | 31.05 | 16 | 70 | 0 | 54 | 
| regex_program | 2 | 166 | 534 | 11,579,064 | 128,513,066 | 166 | 265 | 1 | 54.16 | 14.72 | 4 | 66.92 | 50 | 93 | 50 | 0 | 52 | 2,177,334 | 25 | 61 | 1,104,000 | 30.77 | 16 | 69 | 0 | 50 | 
| regex_program | 3 | 188 | 573 | 11,853,872 | 103,456,394 | 188 | 296 | 0 | 71.27 | 13.34 | 5 | 56.100 | 58 | 100 | 58 | 0 | 51 | 2,422,606 | 40 | 47 | 826,502 | 30.88 | 19 | 85 | 1 | 58 | 

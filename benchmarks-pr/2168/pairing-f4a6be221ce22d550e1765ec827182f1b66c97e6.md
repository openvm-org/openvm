...
| `execute_preflight_insn_mi/s` |  13.43 | -          |  17.77 |  9.09 |
| `trace_gen_time_ms   ` |  177 |  354 |  192 |  162 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  357.50 |  715 |  404 |  311 |
| `main_trace_commit_time_ms` |  64.50 |  129 |  74 |  55 |
| `generate_perm_trace_time_ms` |  43.50 |  87 |  51 |  36 |
| `perm_trace_commit_time_ms` |  77.62 |  155.24 |  89.53 |  65.71 |
| `quotient_poly_compute_time_ms` |  79.56 |  159.13 |  88.15 |  70.98 |
| `quotient_poly_commit_time_ms` |  16.80 |  33.60 |  18.97 |  14.63 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 609 | 41 | 1 | 90 | 1,745,742 | 19.39 | 148 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 162 | 845 | 32,689,110 | 172,558,444 | 162 | 404 | 0 | 88.15 | 18.97 | 6 | 89.53 | 77 | 144 | 77 | 1 | 74 | 16,059,916 | 51 | 131 | 1,157,000 | 9.09 | 27 | 107 | 1 | 77 | 
| pairing | 1 | 192 | 609 | 22,314,288 | 119,958,502 | 192 | 311 | 1 | 70.98 | 14.63 | 6 | 65.71 | 64 | 104 | 64 | 0 | 55 | 9,408,294 | 36 | 64 | 588,742 | 17.77 | 21 | 86 | 1 | 64 | 

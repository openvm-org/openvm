...
| `total_proof_time_ms ` |  493.50 |  987 |  559 |  428 |
...
| `execute_metered_insn_mi/s` |  146.15 | -          |  146.15 |  146.15 |
| `execute_preflight_insns` |  750,104.50 |  1,500,209 |  873,000 |  627,209 |
| `execute_preflight_time_ms` |  30 |  60 |  34 |  26 |
| `execute_preflight_insn_mi/s` |  35.85 | -          |  37.19 |  34.52 |
| `trace_gen_time_ms   ` |  189.50 |  379 |  196 |  183 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  180.50 |  361 |  192 |  169 |
| `main_trace_commit_time_ms` |  30.50 |  61 |  33 |  28 |
| `generate_perm_trace_time_ms` |  24.50 |  49 |  28 |  21 |
| `perm_trace_commit_time_ms` |  40.64 |  81.28 |  42.100 |  38.28 |
| `quotient_poly_compute_time_ms` |  30.49 |  60.98 |  33.93 |  27.05 |
| `quotient_poly_commit_time_ms` |  11.76 |  23.51 |  12.20 |  11.31 |
| `pcs_opening_time_ms ` |  41 |  82 |  42 |  40 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 428 | 41 | 1 | 10 | 1,500,209 | 146.15 | 141 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 196 | 559 | 9,677,708 | 84,395,212 | 196 | 192 | 0 | 33.93 | 12.20 | 4 | 42.100 | 40 | 71 | 40 | 0 | 33 | 1,035,986 | 28 | 26 | 873,000 | 34.52 | 13 | 46 | 0 | 40 | 
| fibonacci_program | 1 | 183 | 428 | 9,708,170 | 74,305,770 | 183 | 169 | 1 | 27.05 | 11.31 | 4 | 38.28 | 42 | 59 | 42 | 0 | 28 | 1,064,416 | 21 | 34 | 627,209 | 37.19 | 11 | 38 | 0 | 42 | 

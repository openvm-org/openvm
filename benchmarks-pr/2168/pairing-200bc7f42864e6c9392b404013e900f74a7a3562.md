...
| `total_proof_time_ms ` |  706.50 |  1,413 |  820 |  593 |
...
| `execute_preflight_insn_mi/s` |  13.56 | -          |  18 |  9.12 |
| `trace_gen_time_ms   ` |  177 |  354 |  193 |  161 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  341 |  682 |  384 |  298 |
| `main_trace_commit_time_ms` |  64.50 |  129 |  74 |  55 |
| `generate_perm_trace_time_ms` |  37.50 |  75 |  44 |  31 |
| `perm_trace_commit_time_ms` |  77.04 |  154.09 |  89.47 |  64.62 |
| `quotient_poly_compute_time_ms` |  78.81 |  157.62 |  87.39 |  70.23 |
| `quotient_poly_commit_time_ms` |  15.97 |  31.93 |  17.90 |  14.03 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 593 | 40 | 1 | 90 | 1,745,742 | 19.36 | 144 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 161 | 820 | 32,689,110 | 172,558,444 | 161 | 384 | 0 | 87.39 | 17.90 | 6 | 89.47 | 65 | 137 | 65 | 1 | 74 | 16,059,916 | 44 | 130 | 1,157,000 | 9.12 | 26 | 106 | 1 | 65 | 
| pairing | 1 | 193 | 593 | 22,314,288 | 119,958,502 | 193 | 298 | 1 | 70.23 | 14.03 | 6 | 64.62 | 57 | 99 | 57 | 0 | 55 | 9,408,294 | 31 | 60 | 588,742 | 18 | 21 | 84 | 1 | 57 | 

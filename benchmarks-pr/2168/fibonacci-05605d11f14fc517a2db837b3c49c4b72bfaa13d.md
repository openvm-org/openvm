...
|:---|---:|---:|
| Total |  1.04 |  0.61 |
| fibonacci_program |  1.03 |  0.60 |


| fibonacci_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  515.50 |  1,031 |  596 |  435 |
...
| `execute_metered_insn_mi/s` |  155.35 | -          |  155.35 |  155.35 |
| `execute_preflight_insns` |  750,104.50 |  1,500,209 |  873,000 |  627,209 |
| `execute_preflight_time_ms` |  30 |  60 |  34 |  26 |
| `execute_preflight_insn_mi/s` |  35.97 | -          |  37.43 |  34.50 |
| `trace_gen_time_ms   ` |  191.50 |  383 |  197 |  186 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  200 |  400 |  227 |  173 |
| `main_trace_commit_time_ms` |  30.50 |  61 |  33 |  28 |
| `generate_perm_trace_time_ms` |  26 |  52 |  31 |  21 |
| `perm_trace_commit_time_ms` |  41.18 |  82.36 |  43.43 |  38.93 |
| `quotient_poly_compute_time_ms` |  31.75 |  63.50 |  35.03 |  28.47 |
| `quotient_poly_commit_time_ms` |  11.84 |  23.67 |  12.15 |  11.52 |
| `pcs_opening_time_ms ` |  56.50 |  113 |  70 |  43 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 435 | 42 | 1 | 9 | 1,500,209 | 155.35 | 143 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 197 | 596 | 9,677,708 | 84,395,212 | 197 | 227 | 0 | 35.03 | 12.15 | 4 | 43.43 | 70 | 75 | 70 | 0 | 33 | 1,035,986 | 31 | 26 | 873,000 | 34.50 | 13 | 47 | 0 | 70 | 
| fibonacci_program | 1 | 186 | 435 | 9,708,170 | 74,305,770 | 186 | 173 | 1 | 28.47 | 11.52 | 4 | 38.93 | 43 | 60 | 43 | 0 | 28 | 1,064,416 | 21 | 34 | 627,209 | 37.43 | 11 | 40 | 0 | 43 | 

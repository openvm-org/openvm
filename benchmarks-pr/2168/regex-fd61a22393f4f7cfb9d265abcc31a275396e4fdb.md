...
|:---|---:|---:|
| Total |  2.33 |  0.74 |
| regex_program |  2.29 |  0.71 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  573.50 |  2,294 |  705 |  516 |
...
| `execute_metered_insn_mi/s` |  120.05 | -          |  120.05 |  120.05 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  52.50 |  210 |  63 |  44 |
| `execute_preflight_insn_mi/s` |  31.75 | -          |  32.93 |  28.82 |
| `trace_gen_time_ms   ` |  176.50 |  706 |  210 |  153 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  276 |  1,104 |  301 |  256 |
| `main_trace_commit_time_ms` |  51.50 |  206 |  57 |  49 |
| `generate_perm_trace_time_ms` |  28.50 |  114 |  48 |  19 |
| `perm_trace_commit_time_ms` |  63.100 |  255.99 |  70.81 |  54.63 |
| `quotient_poly_compute_time_ms` |  57.45 |  229.80 |  68.67 |  51.40 |
| `quotient_poly_commit_time_ms` |  14.56 |  58.26 |  16.49 |  12 |
| `pcs_opening_time_ms ` |  56.50 |  226 |  71 |  51 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 556 | 40 | 1 | 34 | 4,137,502 | 120.05 | 167 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 210 | 705 | 23,446,148 | 150,778,428 | 210 | 301 | 0 | 57.56 | 16.49 | 5 | 70.81 | 71 | 97 | 71 | 4 | 57 | 10,899,170 | 25 | 45 | 1,103,000 | 28.82 | 21 | 74 | 1 | 71 | 
| regex_program | 1 | 153 | 517 | 11,598,276 | 128,513,066 | 153 | 258 | 1 | 52.17 | 14.58 | 4 | 64.98 | 52 | 87 | 52 | 0 | 50 | 2,196,106 | 22 | 63 | 1,104,000 | 32.93 | 16 | 67 | 0 | 52 | 
| regex_program | 2 | 161 | 516 | 11,579,064 | 128,513,066 | 161 | 256 | 1 | 51.40 | 15.19 | 4 | 65.57 | 52 | 85 | 52 | 0 | 50 | 2,177,334 | 19 | 58 | 1,104,000 | 32.45 | 16 | 67 | 0 | 52 | 
| regex_program | 3 | 182 | 556 | 11,853,872 | 103,456,394 | 181 | 289 | 0 | 68.67 | 12 | 5 | 54.63 | 51 | 106 | 51 | 0 | 49 | 2,422,606 | 48 | 44 | 826,502 | 32.79 | 18 | 81 | 1 | 51 | 

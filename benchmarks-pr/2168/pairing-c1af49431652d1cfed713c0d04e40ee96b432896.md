...
| `total_proof_time_ms ` |  721.50 |  1,443 |  825 |  618 |
...
| `execute_preflight_insn_mi/s` |  13.44 | -          |  17.81 |  9.07 |
| `trace_gen_time_ms   ` |  178 |  356 |  195 |  161 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  355 |  710 |  389 |  321 |
| `main_trace_commit_time_ms` |  65 |  130 |  75 |  55 |
| `generate_perm_trace_time_ms` |  34.50 |  69 |  42 |  27 |
| `perm_trace_commit_time_ms` |  76.84 |  153.68 |  89.09 |  64.60 |
| `quotient_poly_compute_time_ms` |  79.96 |  159.92 |  88.06 |  71.86 |
| `quotient_poly_commit_time_ms` |  16.40 |  32.81 |  17.90 |  14.90 |
| `pcs_opening_time_ms ` |  77 |  154 |  82 |  72 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 618 | 40 | 1 | 89 | 1,745,742 | 19.51 | 147 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 161 | 825 | 32,689,110 | 172,558,444 | 161 | 389 | 0 | 88.06 | 17.90 | 6 | 89.09 | 72 | 134 | 71 | 1 | 75 | 16,059,916 | 42 | 131 | 1,157,000 | 9.07 | 26 | 106 | 1 | 71 | 
| pairing | 1 | 195 | 618 | 22,314,288 | 119,958,502 | 195 | 321 | 1 | 71.86 | 14.90 | 5 | 64.60 | 82 | 95 | 82 | 0 | 55 | 9,408,294 | 27 | 60 | 588,742 | 17.81 | 20 | 87 | 1 | 82 | 

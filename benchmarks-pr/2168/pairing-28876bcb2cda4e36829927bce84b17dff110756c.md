...
| `total_proof_time_ms ` |  731.50 |  1,463 |  858 |  605 |
...
| `execute_preflight_insn_mi/s` |  13.43 | -          |  17.80 |  9.05 |
| `trace_gen_time_ms   ` |  179 |  358 |  196 |  162 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  360.50 |  721 |  416 |  305 |
| `main_trace_commit_time_ms` |  65 |  130 |  75 |  55 |
| `generate_perm_trace_time_ms` |  46.50 |  93 |  59 |  34 |
| `perm_trace_commit_time_ms` |  77.55 |  155.10 |  89.81 |  65.29 |
| `quotient_poly_compute_time_ms` |  79.75 |  159.51 |  88.74 |  70.77 |
| `quotient_poly_commit_time_ms` |  15.75 |  31.49 |  17.45 |  14.05 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 605 | 40 | 1 | 90 | 1,745,742 | 19.19 | 147 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 162 | 858 | 32,689,110 | 172,558,444 | 162 | 416 | 0 | 88.74 | 17.45 | 6 | 89.81 | 81 | 152 | 81 | 1 | 75 | 16,059,916 | 59 | 131 | 1,157,000 | 9.05 | 26 | 107 | 1 | 81 | 
| pairing | 1 | 196 | 605 | 22,314,288 | 119,958,502 | 196 | 305 | 1 | 70.77 | 14.05 | 5 | 65.29 | 62 | 102 | 62 | 0 | 55 | 9,408,294 | 34 | 62 | 588,742 | 17.80 | 21 | 85 | 1 | 62 | 

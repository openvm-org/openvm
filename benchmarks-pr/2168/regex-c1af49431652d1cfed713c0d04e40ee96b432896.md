...
| `total_proof_time_ms ` |  575 |  2,300 |  701 |  506 |
...
| `execute_metered_insn_mi/s` |  121.56 | -          |  121.56 |  121.56 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  54.50 |  218 |  66 |  45 |
| `execute_preflight_insn_mi/s` |  30 | -          |  31.21 |  27.01 |
| `trace_gen_time_ms   ` |  175.50 |  702 |  208 |  153 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  276.50 |  1,106 |  298 |  245 |
| `main_trace_commit_time_ms` |  50.75 |  203 |  55 |  49 |
| `generate_perm_trace_time_ms` |  34 |  136 |  56 |  21 |
| `perm_trace_commit_time_ms` |  63.63 |  254.51 |  69.57 |  55.09 |
| `quotient_poly_compute_time_ms` |  56.72 |  226.88 |  69.09 |  47.12 |
| `quotient_poly_commit_time_ms` |  15.11 |  60.44 |  17.50 |  13.01 |
| `pcs_opening_time_ms ` |  53 |  212 |  63 |  46 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 566 | 41 | 1 | 34 | 4,137,502 | 121.56 | 171 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 208 | 701 | 23,446,148 | 150,778,428 | 208 | 298 | 0 | 58.61 | 17.50 | 5 | 69.57 | 63 | 101 | 63 | 4 | 55 | 10,899,170 | 31 | 48 | 1,103,000 | 27.01 | 21 | 76 | 1 | 63 | 
| regex_program | 1 | 153 | 506 | 11,598,276 | 128,513,066 | 153 | 245 | 1 | 47.12 | 14.79 | 5 | 64.32 | 46 | 86 | 46 | 0 | 49 | 2,196,106 | 21 | 66 | 1,104,000 | 30.92 | 16 | 62 | 0 | 46 | 
| regex_program | 2 | 160 | 527 | 11,579,064 | 128,513,066 | 160 | 265 | 1 | 52.06 | 15.14 | 5 | 65.53 | 53 | 94 | 53 | 0 | 49 | 2,177,334 | 28 | 59 | 1,104,000 | 30.88 | 16 | 67 | 0 | 53 | 
| regex_program | 3 | 181 | 566 | 11,853,872 | 103,456,394 | 181 | 298 | 0 | 69.09 | 13.01 | 5 | 55.09 | 50 | 114 | 50 | 0 | 50 | 2,422,606 | 56 | 45 | 826,502 | 31.21 | 18 | 83 | 1 | 50 | 

...
| `total_proof_time_ms ` |  753 |  1,506 |  900 |  606 |
...
| `execute_preflight_insn_mi/s` |  13.50 | -          |  17.93 |  9.08 |
| `trace_gen_time_ms   ` |  182.50 |  365 |  201 |  164 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  382 |  764 |  460 |  304 |
| `main_trace_commit_time_ms` |  66 |  132 |  76 |  56 |
| `generate_perm_trace_time_ms` |  35.50 |  71 |  42 |  29 |
| `perm_trace_commit_time_ms` |  79.27 |  158.55 |  91.84 |  66.71 |
| `quotient_poly_compute_time_ms` |  81.80 |  163.60 |  91.25 |  72.35 |
| `quotient_poly_commit_time_ms` |  17.41 |  34.81 |  19.95 |  14.86 |
| `pcs_opening_time_ms ` |  96.50 |  193 |  133 |  60 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 606 | 41 | 1 | 90 | 1,745,742 | 19.22 | 147 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 164 | 900 | 32,689,110 | 172,558,444 | 164 | 460 | 0 | 91.25 | 19.95 | 6 | 91.84 | 133 | 137 | 133 | 1 | 76 | 16,059,916 | 42 | 131 | 1,157,000 | 9.08 | 27 | 112 | 1 | 133 | 
| pairing | 1 | 201 | 606 | 22,314,288 | 119,958,502 | 201 | 304 | 1 | 72.35 | 14.86 | 6 | 66.71 | 60 | 98 | 60 | 0 | 56 | 9,408,294 | 29 | 60 | 588,742 | 17.93 | 21 | 87 | 1 | 60 | 

...
|:---|---:|---:|---:|
| Total |  4.48 |  2.33 |  2.33 |
| app_proof |  3.13 |  0.99 |  0.99 |
| leaf |  0.68 |  0.68 |  0.68 |
...
| `total_proof_time_ms ` |  765.75 |  3,063 |  918 |  555 |
| `execute_metered_time_ms` |  67 | -          | -          | -          |
| `execute_metered_insns` |  12,000,265 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  176.75 | -          |  176.75 |  176.75 |
| `execute_preflight_insns` |  3,000,066.25 |  12,000,265 |  3,495,000 |  1,515,265 |
| `execute_preflight_time_ms` |  83.50 |  334 |  103 |  43 |
| `execute_preflight_insn_mi/s` |  49.54 | -          |  50.61 |  46.40 |
| `trace_gen_time_ms   ` |  140.25 |  561 |  173 |  123 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  471.50 |  1,886 |  536 |  297 |
| `prover.main_trace_commit_time_ms` |  98.75 |  395 |  112 |  59 |
| `prover.rap_constraints_time_ms` |  272 |  1,088 |  310 |  169 |
| `prover.openings_time_ms` |  99.75 |  399 |  113 |  68 |
| `prover.rap_constraints.logup_gkr_time_ms` |  195.50 |  782 |  222 |  118 |
| `prover.rap_constraints.round0_time_ms` |  50.75 |  203 |  59 |  33 |
...
| `prover.openings.whir_time_ms` |  80.50 |  322 |  92 |  55 |
...
| `prover.openings_time_ms` |  197 |  197 |  197 |  197 |
...
| `prover.openings.whir_time_ms` |  173 |  173 |  173 |  173 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/7802fde0cffab92529fcf7e058b64cd8bee31fd7/fibonacci-7802fde0cffab92529fcf7e058b64cd8bee31fd7.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 70 |  |  |  | 348 |  |  |  |  |  |  | 
| app_proof |  |  |  | 555 |  | 67 | 12,000,265 | 176.75 | 0 | 3,138 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 324 | 117 | 0 | 0 | 107 | 35 | 35 | 50 | 20 | 0 | 100 | 86 | 13 | 3 | 9 | 117 | 117 | 107 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 168 | 47 | 0 | 0 | 68 | 26 | 25 | 27 | 13 | 0 | 52 | 44 | 8 | 1 | 6 | 48 | 47 | 68 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 136 | 32 | 0 | 0 | 62 | 23 | 23 | 24 | 14 | 0 | 41 | 34 | 7 | 1 | 5 | 32 | 32 | 62 | 0 | 3 | 13 | 0 | 0 | 
| leaf | 0 | prover | 147,934,254 | 612 | 232 | 0 | 0 | 182 | 85 | 84 | 52 | 44 | 0 | 197 | 173 | 24 | 12 | 11 | 232 | 232 | 182 | 0 | 8 | 43 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 136,618,310 | 536 | 112 | 0 | 0 | 310 | 59 | 59 | 27 | 222 | 0 | 113 | 92 | 21 | 11 | 9 | 112 | 112 | 310 | 0 | 3 | 221 | 0 | 0 | 
| app_proof | prover | 1 | 136,570,844 | 525 | 112 | 0 | 0 | 303 | 55 | 55 | 27 | 220 | 0 | 108 | 87 | 20 | 12 | 8 | 112 | 112 | 303 | 0 | 3 | 220 | 0 | 0 | 
| app_proof | prover | 2 | 136,570,844 | 528 | 112 | 0 | 0 | 306 | 56 | 56 | 26 | 222 | 0 | 110 | 88 | 21 | 12 | 9 | 112 | 112 | 306 | 0 | 3 | 221 | 0 | 0 | 
| app_proof | prover | 3 | 70,295,260 | 297 | 59 | 0 | 0 | 169 | 33 | 32 | 17 | 118 | 0 | 68 | 55 | 12 | 6 | 6 | 59 | 59 | 169 | 0 | 3 | 117 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 155 | 136 | 918 | 136 | 155 | 2,770,199,817 | 323,294,035 | 3,093,493,852 | 2,097,152 | 0 | 3 | 90 | 3,495,000 | 46.40 | 
| app_proof | 1 | 41 | 123 | 793 | 123 | 41 | 2,768,863,045 | 322,353,750 | 3,091,216,795 | 2,097,152 | 0 | 2 | 103 | 3,495,000 | 50.59 | 
| app_proof | 2 | 41 | 129 | 797 | 129 | 41 | 2,768,863,045 | 322,353,750 | 3,091,216,795 | 2,097,152 | 0 | 1 | 98 | 3,495,000 | 50.61 | 
| app_proof | 3 | 41 | 173 | 555 | 173 | 41 | 1,230,958,923 | 342,872,922 | 1,573,831,845 | 2,097,152 | 0 | 2 | 43 | 1,515,265 | 50.56 | 

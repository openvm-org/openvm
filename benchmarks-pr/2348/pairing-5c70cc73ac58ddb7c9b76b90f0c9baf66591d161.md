...
|:---|---:|---:|---:|
| Total | <span style='color: red'>(+0 [+2.4%])</span> 1.56 | <span style='color: red'>(+0 [+2.1%])</span> 0.94 | 0.94 |
| pairing | <span style='color: red'>(+0 [+2.4%])</span> 1.56 | <span style='color: red'>(+0 [+2.1%])</span> 0.94 |  0.94 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+18 [+2.5%])</span> 750.50 | <span style='color: red'>(+36 [+2.5%])</span> 1,501 | <span style='color: red'>(+19 [+2.2%])</span> 879 | <span style='color: red'>(+17 [+2.8%])</span> 622 |
...
| `execute_metered_insn_mi/s` | <span style='color: green'>(-0 [-0.2%])</span> 27.58 | -          | <span style='color: green'>(-0 [-0.2%])</span> 27.58 | <span style='color: green'>(-0 [-0.2%])</span> 27.58 |
| `execute_preflight_insns` |  872,871 |  1,745,742 |  1,149,000 |  596,742 |
| `execute_preflight_time_ms` |  83 |  166 |  118 |  48 |
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+0 [+1.0%])</span> 14.79 | -          | <span style='color: red'>(+0 [+1.6%])</span> 18.10 | <span style='color: red'>(+0 [+0.2%])</span> 11.47 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+3 [+1.6%])</span> 187 | <span style='color: red'>(+6 [+1.6%])</span> 374 | <span style='color: red'>(+3 [+1.5%])</span> 206 | <span style='color: red'>(+3 [+1.8%])</span> 168 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+15 [+4.2%])</span> 374.50 | <span style='color: red'>(+30 [+4.2%])</span> 749 | <span style='color: red'>(+16 [+3.9%])</span> 423 | <span style='color: red'>(+14 [+4.5%])</span> 326 |
| `main_trace_commit_time_ms` |  65 |  130 | <span style='color: red'>(+1 [+1.3%])</span> 76 | <span style='color: green'>(-1 [-1.8%])</span> 54 |
| `generate_perm_trace_time_ms` | <span style='color: red'>(+5 [+10.9%])</span> 51 | <span style='color: red'>(+10 [+10.9%])</span> 102 | <span style='color: red'>(+16 [+28.6%])</span> 72 | <span style='color: green'>(-6 [-16.7%])</span> 30 |
| `perm_trace_commit_time_ms` | <span style='color: red'>(+0 [+0.4%])</span> 77.72 | <span style='color: red'>(+1 [+0.4%])</span> 155.43 |  89.96 | <span style='color: red'>(+1 [+1.2%])</span> 65.47 |
| `quotient_poly_compute_time_ms` | <span style='color: green'>(-1 [-1.1%])</span> 83 | <span style='color: green'>(-2 [-1.1%])</span> 166 | <span style='color: green'>(-2 [-2.5%])</span> 92.12 | <span style='color: red'>(+1 [+0.7%])</span> 73.89 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+0 [+1.3%])</span> 17.96 | <span style='color: red'>(+0 [+1.3%])</span> 35.92 | <span style='color: red'>(+0 [+1.1%])</span> 20.32 | <span style='color: red'>(+0 [+1.6%])</span> 15.60 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+12 [+18.0%])</span> 75.50 | <span style='color: red'>(+23 [+18.0%])</span> 151 | <span style='color: red'>(+17 [+25.8%])</span> 83 | <span style='color: red'>(+6 [+9.7%])</span> 68 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 622 | 1 | 63 | 1,745,742 | 27.58 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 168 | 879 | 32,480,114 | 172,558,444 | 168 | 423 | 0 | 92.12 | 20.32 | 6 | 89.96 | 68 | 165 | 68 | 1 | 76 | 15,909,408 | 72 | 118 | 1,149,000 | 11.47 | 27 | 113 | 1 | 68 | 
| pairing | 1 | 206 | 622 | 22,464,232 | 119,958,502 | 206 | 326 | 1 | 73.89 | 15.60 | 6 | 65.47 | 83 | 98 | 83 | 0 | 54 | 9,498,894 | 30 | 48 | 596,742 | 18.10 | 21 | 90 | 1 | 83 | 

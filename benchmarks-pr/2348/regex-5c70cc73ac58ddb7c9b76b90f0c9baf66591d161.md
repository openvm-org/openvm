...
|:---|---:|---:|---:|
| Total | <span style='color: red'>(+0 [+2.0%])</span> 2.44 | <span style='color: red'>(+0 [+2.0%])</span> 0.76 | 0.76 |
| regex_program | <span style='color: red'>(+0 [+2.0%])</span> 2.44 | <span style='color: red'>(+0 [+2.0%])</span> 0.76 |  0.76 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+12 [+2.0%])</span> 601 | <span style='color: red'>(+48 [+2.0%])</span> 2,404 | <span style='color: red'>(+15 [+2.1%])</span> 720 | <span style='color: red'>(+2 [+0.4%])</span> 547 |
...
| `execute_preflight_time_ms` | <span style='color: red'>(+0 [+0.6%])</span> 45.25 | <span style='color: red'>(+1 [+0.6%])</span> 181 | <span style='color: red'>(+2 [+3.6%])</span> 58 | <span style='color: green'>(-1 [-2.9%])</span> 33 |
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+0 [+0.6%])</span> 32.15 | -          | <span style='color: red'>(+0 [+0.9%])</span> 32.78 |  30.64 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+1 [+0.7%])</span> 183.50 | <span style='color: red'>(+5 [+0.7%])</span> 734 | <span style='color: red'>(+2 [+1.0%])</span> 199 |  174 |
| `memory_finalize_time_ms` |  1 |  4 |  4 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+11 [+3.9%])</span> 298.75 | <span style='color: red'>(+45 [+3.9%])</span> 1,195 | <span style='color: red'>(+14 [+4.6%])</span> 318 | <span style='color: red'>(+8 [+2.9%])</span> 280 |
| `main_trace_commit_time_ms` | <span style='color: red'>(+0 [+1.0%])</span> 52.50 | <span style='color: red'>(+2 [+1.0%])</span> 210 |  57 | <span style='color: red'>(+1 [+2.0%])</span> 51 |
| `generate_perm_trace_time_ms` | <span style='color: red'>(+0 [+1.4%])</span> 35 | <span style='color: red'>(+2 [+1.4%])</span> 140 | <span style='color: red'>(+3 [+6.2%])</span> 51 | <span style='color: red'>(+2 [+8.7%])</span> 25 |
| `perm_trace_commit_time_ms` | <span style='color: red'>(+1 [+1.0%])</span> 65.36 | <span style='color: red'>(+3 [+1.0%])</span> 261.46 | <span style='color: red'>(+1 [+1.1%])</span> 72.02 | <span style='color: red'>(+1 [+2.3%])</span> 56.15 |
| `quotient_poly_compute_time_ms` | <span style='color: green'>(-0 [-0.2%])</span> 61.69 | <span style='color: green'>(-0 [-0.2%])</span> 246.76 | <span style='color: green'>(-3 [-4.3%])</span> 70.65 | <span style='color: red'>(+1 [+1.3%])</span> 55.75 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+0 [+0.1%])</span> 16.42 | <span style='color: red'>(+0 [+0.1%])</span> 65.67 | <span style='color: red'>(+0 [+1.3%])</span> 18.87 | <span style='color: red'>(+0 [+0.8%])</span> 14.14 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+10 [+17.8%])</span> 64.50 | <span style='color: red'>(+39 [+17.8%])</span> 258 | <span style='color: red'>(+14 [+23.3%])</span> 74 | <span style='color: red'>(+2 [+4.0%])</span> 52 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 558 | 1 | 36 | 4,137,502 | 112.52 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 174 | 720 | 23,446,148 | 150,778,428 | 174 | 318 | 0 | 64.26 | 18.87 | 5 | 72.02 | 74 | 101 | 74 | 4 | 57 | 10,899,170 | 28 | 58 | 1,103,000 | 30.64 | 22 | 83 | 1 | 74 | 
| regex_program | 1 | 181 | 547 | 11,598,276 | 128,513,066 | 181 | 280 | 1 | 56.10 | 15.87 | 4 | 67.37 | 63 | 93 | 62 | 0 | 51 | 2,196,106 | 25 | 45 | 1,104,000 | 32.67 | 17 | 72 | 0 | 62 | 
| regex_program | 2 | 180 | 579 | 11,579,064 | 128,513,066 | 180 | 312 | 1 | 55.75 | 16.80 | 4 | 65.92 | 69 | 117 | 69 | 0 | 51 | 2,177,334 | 51 | 45 | 1,104,000 | 32.52 | 17 | 73 | 0 | 69 | 
| regex_program | 3 | 199 | 558 | 11,853,872 | 103,456,394 | 198 | 285 | 0 | 70.65 | 14.14 | 5 | 56.15 | 52 | 95 | 52 | 0 | 51 | 2,422,606 | 36 | 33 | 826,502 | 32.78 | 19 | 85 | 1 | 52 | 

...
|:---|---:|---:|---:|
| Total |  9.51 |  3.42 |  3.42 |
| app_proof |  7.43 |  1.85 |  1.85 |
| leaf |  1.51 |  1.01 |  1.01 |
...
| `total_proof_time_ms ` |  1,217.83 |  7,307 |  1,345 |  1,178 |
...
| `execute_preflight_time_ms` |  81.17 |  487 |  112 |  74 |
| `execute_preflight_insn_mi/s` |  29.50 | -          |  32.44 |  21.36 |
| `postflight_time_ms  ` |  26.67 |  160 |  30 |  25 |
| `postflight_memory_chronology_time_ms` |  2 |  12 |  2 |  2 |
| `postflight_program_index_time_ms` |  0 |  0 |  0 |  0 |
| `trace_gen_time_ms   ` |  12.83 |  77 |  17 |  12 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,083.50 |  6,501 |  1,169 |  1,054 |
| `prover.main_trace_commit_time_ms` |  336 |  2,016 |  354 |  328 |
| `prover.rap_constraints_time_ms` |  506.67 |  3,040 |  509 |  503 |
| `prover.openings_time_ms` |  239.83 |  1,439 |  305 |  223 |
| `prover.rap_constraints.logup_gkr_time_ms` |  103 |  618 |  104 |  101 |
| `prover.rap_constraints.round0_time_ms` |  280.50 |  1,683 |  282 |  279 |
...
| `prover.openings.whir_time_ms` |  179.17 |  1,075 |  243 |  163 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  756 |  1,512 |  1,014 |  498 |
...
| `prover.main_trace_commit_time_ms` |  263 |  526 |  381 |  145 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/07dc0d28ec4dd4ab45bf700c8765e216880a3c2a/keccak-07dc0d28ec4dd4ab45bf700c8765e216880a3c2a.memory.svg)
...
| leaf | 0 | 189 | 1,014 | 188 | 59 | 21 | 4 | 11 | 11 | 
| leaf | 1 | 93 | 498 | 93 | 30 | 10 | 5 | 10 | 10 | 
...
| internal_recursive.1 | 1 | prover | 9,750,865 | 97 | 15 | 0 | 0 | 52 | 20 | 19 | 21 | 10 | 0 | 29 | 21 | 7 | 1 | 5 | 15 | 15 | 52 | 0 | 1 | 10 | 0 | 0 | 
| leaf | 0 | prover | 476,578,798 | 825 | 381 | 0 | 0 | 232 | 120 | 119 | 71 | 40 | 0 | 211 | 174 | 36 | 19 | 16 | 381 | 381 | 232 | 0 | 3 | 39 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover |  | 0 | 830,158,476 | 1,169 | 354 | 0 | 50 | 509 | 282 | 282 | 122 | 104 | 0 | 305 | 243 | 61 | 36 | 24 | 354 | 354 | 509 | 0 | 1 | 102 | 0 | 0 | 
| app_proof | prover |  | 1 | 830,158,476 | 1,070 | 332 | 0 | 0 | 505 | 279 | 279 | 122 | 103 | 0 | 232 | 172 | 60 | 35 | 24 | 332 | 332 | 505 | 0 | 1 | 102 | 0 | 0 | 
| app_proof | prover |  | 2 | 830,158,476 | 1,063 | 332 | 0 | 0 | 506 | 280 | 280 | 122 | 103 | 0 | 223 | 164 | 59 | 35 | 24 | 332 | 332 | 506 | 0 | 1 | 102 | 0 | 0 | 
| app_proof | prover |  | 3 | 830,158,476 | 1,071 | 334 | 0 | 0 | 508 | 281 | 281 | 122 | 104 | 0 | 227 | 166 | 60 | 36 | 24 | 335 | 334 | 508 | 0 | 1 | 103 | 0 | 0 | 
| app_proof | prover |  | 4 | 830,158,476 | 1,074 | 335 | 0 | 0 | 509 | 282 | 282 | 122 | 103 | 0 | 229 | 167 | 61 | 37 | 24 | 335 | 335 | 509 | 0 | 1 | 103 | 0 | 0 | 
| app_proof | prover |  | 5 | 819,934,860 | 1,054 | 327 | 0 | 0 | 503 | 279 | 279 | 121 | 101 | 0 | 223 | 163 | 59 | 35 | 24 | 328 | 327 | 503 | 0 | 1 | 100 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof |  | 1,178 | 126 | 14,365,133 | 113.76 | 0 | 7,442 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof |  | 0 | 1 | 2 | 17 | 1,345 | 3 | 1 | 0 | 30 | 0 | 2 | 0 | 9,337,486,584 | 624,415,128 | 9,961,901,712 | 2,097,152 | 2 | 0 | 0 | 3 | 14 | 112 | 2,413,000 | 21.36 | 0 | 0 | 
| app_proof |  | 1 | 0 | 2 | 12 | 1,197 | 2 | 0 | 0 | 26 | 0 | 2 | 0 | 9,337,793,604 | 625,029,708 | 9,962,823,312 | 2,097,152 | 2 | 0 | 0 | 2 | 9 | 76 | 2,413,000 | 31.55 | 0 | 0 | 
| app_proof |  | 2 | 0 | 2 | 12 | 1,190 | 2 | 0 | 0 | 26 | 0 | 2 | 0 | 9,337,030,356 | 625,792,956 | 9,962,823,312 | 2,097,152 | 2 | 0 | 0 | 2 | 9 | 76 | 2,413,000 | 31.47 | 0 | 0 | 
| app_proof |  | 3 | 0 | 2 | 12 | 1,198 | 2 | 0 | 0 | 27 | 0 | 2 | 0 | 9,337,792,860 | 625,030,452 | 9,962,823,312 | 2,097,152 | 2 | 0 | 0 | 2 | 9 | 75 | 2,413,000 | 31.97 | 0 | 0 | 
| app_proof |  | 4 | 0 | 2 | 12 | 1,199 | 2 | 0 | 0 | 26 | 0 | 2 | 0 | 9,337,030,236 | 625,793,076 | 9,962,823,312 | 2,097,152 | 2 | 0 | 0 | 2 | 9 | 74 | 2,413,000 | 32.44 | 0 | 0 | 
| app_proof |  | 5 | 0 | 2 | 12 | 1,178 | 2 | 0 | 0 | 25 | 0 | 2 | 0 | 8,903,917,596 | 936,222,324 | 9,840,139,920 | 2,097,152 | 2 | 0 | 0 | 2 | 8 | 74 | 2,300,133 | 30.75 | 0 | 0 | 

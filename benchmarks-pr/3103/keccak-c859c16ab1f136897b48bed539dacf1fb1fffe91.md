...
|:---|---:|---:|---:|
| Total |  9.69 |  3.48 |  3.48 |
| app_proof |  7.58 |  1.89 |  1.89 |
| leaf |  1.54 |  1.03 |  1.03 |
...
| `total_proof_time_ms ` |  1,242.83 |  7,457 |  1,353 |  1,206 |
| `compile_metered_time_ms` |  3 |  3 |  3 |  3 |
| `execute_metered_time_ms` |  125 | -          | -          | -          |
| `execute_metered_insns` |  14,365,133 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  114.24 | -          |  114.24 |  114.24 |
| `set_initial_memory_time_ms` |  0.17 |  1 |  1 |  0 |
| `execute_preflight_insns` |  2,394,188.83 |  14,365,133 |  2,413,000 |  2,300,133 |
| `execute_preflight_time_ms` |  86.33 |  518 |  109 |  80 |
| `execute_preflight_insn_mi/s` |  27.73 | -          |  29.29 |  21.94 |
| `postflight_time_ms  ` |  30 |  180 |  32 |  29 |
| `postflight_memory_chronology_time_ms` |  2.17 |  13 |  3 |  2 |
| `postflight_program_index_time_ms` |  0 |  0 |  0 |  0 |
| `trace_gen_time_ms   ` |  12.83 |  77 |  17 |  12 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,095.83 |  6,575 |  1,178 |  1,067 |
| `prover.main_trace_commit_time_ms` |  344.50 |  2,067 |  358 |  338 |
| `prover.rap_constraints_time_ms` |  509.17 |  3,055 |  511 |  503 |
| `prover.openings_time_ms` |  241.17 |  1,447 |  308 |  224 |
| `prover.rap_constraints.logup_gkr_time_ms` |  103.67 |  622 |  105 |  100 |
| `prover.rap_constraints.round0_time_ms` |  281.83 |  1,691 |  283 |  280 |
...
| `prover.openings.whir_time_ms` |  180.33 |  1,082 |  247 |  164 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  770.50 |  1,541 |  1,029 |  512 |
| `execute_preflight_time_ms` |  4.50 |  9 |  5 |  4 |
| `trace_gen_time_ms   ` |  147 |  294 |  196 |  98 |
| `generate_blob_total_time_ms` |  16 |  32 |  22 |  10 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  622.50 |  1,245 |  832 |  413 |
| `prover.main_trace_commit_time_ms` |  267.50 |  535 |  388 |  147 |
| `prover.rap_constraints_time_ms` |  188 |  376 |  234 |  142 |
| `prover.openings_time_ms` |  165.50 |  331 |  208 |  123 |
| `prover.rap_constraints.logup_gkr_time_ms` |  33 |  66 |  40 |  26 |
| `prover.rap_constraints.round0_time_ms` |  96.50 |  193 |  122 |  71 |
...
| `prover.openings.whir_time_ms` |  136.50 |  273 |  171 |  102 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/c859c16ab1f136897b48bed539dacf1fb1fffe91/keccak-c859c16ab1f136897b48bed539dacf1fb1fffe91.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 43 | 329 | 43 | 15 | 3 | 2 | 2 | 2 | 
| internal_recursive.0 | 1 | 14 | 129 | 14 | 2 | 0 | 2 | 2 | 2 | 
| internal_recursive.1 | 1 | 11 | 109 | 10 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 196 | 1,029 | 195 | 63 | 22 | 4 | 11 | 11 | 
| leaf | 1 | 98 | 512 | 97 | 32 | 10 | 5 | 11 | 11 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 81,415,160 | 285 | 93 | 0 | 0 | 114 | 39 | 38 | 56 | 17 | 0 | 77 | 62 | 15 | 5 | 9 | 93 | 93 | 114 | 0 | 1 | 16 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,945 | 114 | 21 | 0 | 0 | 59 | 21 | 21 | 24 | 12 | 0 | 32 | 24 | 8 | 1 | 6 | 21 | 21 | 59 | 0 | 1 | 12 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 97 | 15 | 0 | 0 | 53 | 20 | 19 | 21 | 11 | 0 | 28 | 21 | 7 | 1 | 5 | 15 | 15 | 53 | 0 | 1 | 10 | 0 | 0 | 
| leaf | 0 | prover | 476,578,798 | 832 | 388 | 0 | 0 | 234 | 122 | 120 | 71 | 40 | 0 | 208 | 171 | 37 | 20 | 16 | 388 | 388 | 234 | 0 | 3 | 39 | 0 | 0 | 
| leaf | 1 | prover | 240,255,800 | 413 | 146 | 0 | 0 | 142 | 71 | 69 | 45 | 26 | 0 | 123 | 102 | 21 | 10 | 11 | 147 | 146 | 142 | 0 | 3 | 25 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover |  | 0 | 830,158,476 | 1,178 | 358 | 0 | 55 | 511 | 283 | 282 | 123 | 104 | 0 | 308 | 247 | 60 | 36 | 24 | 358 | 358 | 511 | 0 | 1 | 103 | 0 | 0 | 
| app_proof | prover |  | 1 | 830,158,476 | 1,084 | 340 | 0 | 0 | 510 | 282 | 282 | 123 | 105 | 0 | 232 | 172 | 60 | 35 | 24 | 340 | 340 | 510 | 0 | 1 | 104 | 0 | 0 | 
| app_proof | prover |  | 2 | 830,158,476 | 1,075 | 340 | 0 | 0 | 509 | 281 | 281 | 123 | 104 | 0 | 225 | 164 | 60 | 36 | 24 | 341 | 340 | 509 | 0 | 1 | 103 | 0 | 0 | 
| app_proof | prover |  | 3 | 830,158,476 | 1,084 | 344 | 0 | 0 | 511 | 282 | 282 | 123 | 105 | 0 | 228 | 167 | 60 | 36 | 24 | 344 | 344 | 511 | 0 | 1 | 104 | 0 | 0 | 
| app_proof | prover |  | 4 | 830,158,476 | 1,087 | 345 | 0 | 0 | 511 | 283 | 282 | 123 | 104 | 0 | 230 | 168 | 61 | 37 | 24 | 346 | 345 | 511 | 0 | 1 | 103 | 0 | 0 | 
| app_proof | prover |  | 5 | 819,934,860 | 1,067 | 337 | 0 | 0 | 503 | 280 | 279 | 122 | 100 | 0 | 224 | 164 | 60 | 36 | 24 | 338 | 337 | 503 | 0 | 1 | 99 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof |  | 1,206 | 125 | 14,365,133 | 114.24 | 0 | 7,592 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof |  | 0 | 1 | 2 | 17 | 1,353 | 3 | 1 | 0 | 30 | 0 | 3 | 0 | 9,337,486,584 | 624,415,128 | 9,961,901,712 | 2,097,152 | 2 | 0 | 0 | 3 | 14 | 109 | 2,413,000 | 21.94 | 0 | 0 | 
| app_proof |  | 1 | 0 | 2 | 12 | 1,226 | 2 | 0 | 0 | 30 | 0 | 2 | 0 | 9,337,793,604 | 625,029,708 | 9,962,823,312 | 2,097,152 | 2 | 0 | 0 | 2 | 9 | 82 | 2,413,000 | 29.21 | 0 | 0 | 
| app_proof |  | 2 | 0 | 2 | 12 | 1,216 | 2 | 0 | 0 | 29 | 0 | 2 | 0 | 9,337,030,356 | 625,792,956 | 9,962,823,312 | 2,097,152 | 2 | 0 | 0 | 2 | 9 | 82 | 2,413,000 | 29.13 | 0 | 0 | 
| app_proof |  | 3 | 0 | 2 | 12 | 1,223 | 2 | 0 | 0 | 29 | 0 | 2 | 0 | 9,337,792,860 | 625,030,452 | 9,962,823,312 | 2,097,152 | 2 | 0 | 0 | 2 | 9 | 82 | 2,413,000 | 29.29 | 0 | 0 | 
| app_proof |  | 4 | 0 | 2 | 12 | 1,233 | 2 | 0 | 0 | 32 | 0 | 2 | 0 | 9,337,030,236 | 625,793,076 | 9,962,823,312 | 2,097,152 | 2 | 0 | 0 | 2 | 9 | 83 | 2,413,000 | 29.05 | 0 | 0 | 
| app_proof |  | 5 | 0 | 2 | 12 | 1,206 | 2 | 0 | 0 | 30 | 0 | 2 | 0 | 8,903,917,596 | 936,222,324 | 9,840,139,920 | 2,097,152 | 2 | 0 | 0 | 2 | 8 | 80 | 2,300,133 | 28.55 | 0 | 0 | 

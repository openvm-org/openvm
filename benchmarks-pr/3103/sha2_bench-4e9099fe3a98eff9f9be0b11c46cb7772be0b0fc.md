...
|:---|---:|---:|---:|
| Total |  5.14 |  3.95 |  3.95 |
| app_proof |  4.19 |  2.100 |  2.100 |
| leaf |  0.52 |  0.52 |  0.52 |
...
| `total_proof_time_ms ` |  2,065 |  4,130 |  2,803 |  1,327 |
| `compile_metered_time_ms` |  3 |  3 |  3 |  3 |
| `execute_metered_time_ms` |  57 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  193.21 | -          |  193.21 |  193.21 |
| `set_initial_memory_time_ms` |  0 |  0 |  0 |  0 |
| `execute_preflight_insns` |  5,583,980.50 |  11,167,961 |  7,136,000 |  4,031,961 |
| `execute_preflight_time_ms` |  248 |  496 |  358 |  138 |
| `execute_preflight_insn_mi/s` |  22.52 | -          |  29.01 |  19.91 |
| `postflight_time_ms  ` |  72 |  144 |  95 |  49 |
...
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,651 |  3,302 |  2,213 |  1,089 |
| `prover.main_trace_commit_time_ms` |  397 |  794 |  575 |  219 |
| `prover.rap_constraints_time_ms` |  984 |  1,968 |  1,291 |  677 |
| `prover.openings_time_ms` |  269.50 |  539 |  346 |  193 |
| `prover.rap_constraints.logup_gkr_time_ms` |  276.50 |  553 |  356 |  197 |
| `prover.rap_constraints.round0_time_ms` |  526 |  1,052 |  701 |  351 |
| `prover.rap_constraints.mle_rounds_time_ms` |  180.50 |  361 |  233 |  128 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/4e9099fe3a98eff9f9be0b11c46cb7772be0b0fc/sha2_bench-4e9099fe3a98eff9f9be0b11c46cb7772be0b0fc.memory.svg)
...
| leaf | 0 | 118 | 523 | 117 | 36 | 12 | 2 | 10 | 10 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 177 | 46 | 0 | 0 | 80 | 28 | 27 | 37 | 14 | 0 | 50 | 39 | 10 | 2 | 7 | 47 | 46 | 80 | 0 | 1 | 13 | 0 | 0 | 
...
| leaf | 0 | prover | 237,929,272 | 405 | 145 | 0 | 0 | 142 | 71 | 70 | 44 | 26 | 0 | 117 | 95 | 21 | 10 | 11 | 146 | 145 | 142 | 0 | 3 | 25 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover |  | 0 | 1,285,848,458 | 2,213 | 575 | 0 | 0 | 1,291 | 701 | 700 | 233 | 356 | 1 | 346 | 252 | 93 | 57 | 36 | 575 | 575 | 1,291 | 0 | 1 | 354 | 0 | 0 | 
| app_proof | prover |  | 1 | 690,310,084 | 1,089 | 219 | 0 | 0 | 677 | 351 | 350 | 128 | 197 | 0 | 193 | 140 | 52 | 31 | 21 | 219 | 219 | 677 | 0 | 1 | 196 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof |  | 1,327 | 57 | 11,167,961 | 193.21 | 0 | 4,194 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof |  | 0 | 0 | 2 | 93 | 2,803 | 3 | 0 | 0 | 95 | 2 | 10 | 0 | 12,567,738,156 | 2,865,208,140 | 15,432,946,296 | 2,097,152 | 2 | 0 | 0 | 3 | 89 | 358 | 7,136,000 | 19.91 | 0 | 0 | 
| app_proof |  | 1 | 0 | 2 | 24 | 1,327 | 2 | 0 | 0 | 49 | 1 | 4 | 0 | 7,133,254,296 | 1,693,718,849 | 8,826,973,145 | 2,097,152 | 2 | 0 | 0 | 2 | 21 | 138 | 4,031,961 | 29.01 | 0 | 0 | 

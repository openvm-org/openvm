...
| `total_proof_time_ms ` |  2,055.50 |  4,111 |  2,759 |  1,352 |
...
| `execute_preflight_time_ms` |  259.50 |  519 |  347 |  172 |
| `execute_preflight_insn_mi/s` |  21.52 | -          |  23.35 |  20.51 |
| `postflight_time_ms  ` |  72.50 |  145 |  96 |  49 |
| `postflight_memory_chronology_time_ms` |  7 |  14 |  10 |  4 |
| `postflight_program_index_time_ms` |  1.50 |  3 |  2 |  1 |
| `trace_gen_time_ms   ` |  54.50 |  109 |  85 |  24 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,636 |  3,272 |  2,190 |  1,082 |
| `prover.main_trace_commit_time_ms` |  390 |  780 |  563 |  217 |
| `prover.rap_constraints_time_ms` |  977.50 |  1,955 |  1,283 |  672 |
| `prover.openings_time_ms` |  267.50 |  535 |  343 |  192 |
| `prover.rap_constraints.logup_gkr_time_ms` |  274 |  548 |  353 |  195 |
| `prover.rap_constraints.round0_time_ms` |  524.50 |  1,049 |  699 |  350 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/c859c16ab1f136897b48bed539dacf1fb1fffe91/sha2_bench-c859c16ab1f136897b48bed539dacf1fb1fffe91.memory.svg)
...
| leaf | 0 | 110 | 516 | 110 | 35 | 12 | 2 | 9 | 9 | 
...
| leaf | 0 | prover | 237,929,272 | 405 | 145 | 0 | 0 | 143 | 71 | 70 | 44 | 27 | 0 | 116 | 94 | 21 | 10 | 11 | 145 | 145 | 143 | 0 | 3 | 25 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover |  | 0 | 1,283,751,306 | 2,190 | 563 | 0 | 0 | 1,283 | 699 | 698 | 231 | 353 | 0 | 343 | 250 | 93 | 57 | 36 | 563 | 563 | 1,283 | 0 | 1 | 351 | 0 | 0 | 
| app_proof | prover |  | 1 | 689,261,444 | 1,082 | 217 | 0 | 0 | 672 | 350 | 349 | 127 | 195 | 0 | 192 | 140 | 51 | 30 | 21 | 217 | 217 | 672 | 0 | 1 | 194 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof |  | 1,352 | 56 | 11,167,961 | 198.36 | 0 | 4,175 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof |  | 0 | 0 | 2 | 85 | 2,759 | 3 | 0 | 0 | 96 | 2 | 10 | 0 | 12,555,149,448 | 2,852,631,024 | 15,407,780,472 | 2,097,152 | 2 | 0 | 0 | 3 | 82 | 347 | 7,136,000 | 20.51 | 0 | 0 | 
| app_proof |  | 1 | 0 | 2 | 24 | 1,352 | 2 | 0 | 0 | 49 | 1 | 4 | 0 | 7,126,144,008 | 1,696,634,577 | 8,822,778,585 | 2,097,152 | 2 | 0 | 0 | 2 | 21 | 172 | 4,031,961 | 23.35 | 0 | 0 | 

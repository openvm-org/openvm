...
| `execute_metered_insn_mi/s` |  12.64 | -          |  12.64 |  12.64 |
...
| `execute_preflight_insn_mi/s` |  10.05 | -          |  9.90 |  9.90 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/df8c9c2071e88cf5e201cb9ddef3d7f37ed99c79/pairing-df8c9c2071e88cf5e201cb9ddef3d7f37ed99c79.memory.svg)
...
| prover.stacked_commit | 1.09 | leaf.0.prover |
| prover.prove_whir_opening | 1.06 | leaf.0.prover |
| prover.merkle_tree | 1.06 | leaf.0.prover |
| prover.openings | 1.06 | leaf.0.prover |
| prover.rs_code_matrix | 1.06 | leaf.0.prover |
| prover.rap_constraints | 0.80 | internal_for_leaf.0.prover |
| postflight | 0.75 | app_proof..0 |
| tracegen | 0.70 | app_proof..0 |
| generate mem proving ctxs | 0.70 | app_proof..0 |
| set initial memory | 0.63 | app_proof..0 |
| prover.batch_constraints.fold_ple_evals | 0.50 | leaf.0.prover |
| prover.batch_constraints.round0 | 0.50 | leaf.0.prover |
| prover.before_gkr_input_evals | 0.35 | leaf.0.prover |
| tracegen.exp_bits_len | 0.34 | leaf.0 |
| tracegen.whir_final_poly_query_eval | 0.34 | leaf.0 |
| tracegen.pow_checker | 0.34 | leaf.0 |
| tracegen.whir_folding | 0.28 | leaf.0 |
| tracegen.whir_non_initial_opened_values | 0.28 | leaf.0 |
| tracegen.whir_initial_opened_values | 0.28 | leaf.0 |
| tracegen.range_checker | 0.28 | leaf.0 |
| tracegen.proof_shape | 0.28 | leaf.0 |
| tracegen.public_values | 0.28 | leaf.0 |
...
| 12 | VmAirWrapper<IsEqualModU16AdapterAir<2, 4, 16>, ModularIsEqualCoreAir<16, 4, 16> |  | 51 | 107 | 3 | 
| 13 | VmAirWrapper<VecHeapAdapterAir<2, 4, 4>, FieldExpressionCoreAir> |  | 195 | 102 | 3 | 
| 14 | VmAirWrapper<VecHeapAdapterAir<2, 4, 4>, FieldExpressionCoreAir> |  | 131 | 70 | 3 | 
| 15 | VmAirWrapper<MultWAdapterAir, DivRemCoreAir<4, 8> |  | 30 | 62 | 3 | 
| 16 | VmAirWrapper<MultAdapterAir, DivRemCoreAir<8, 8> |  | 41 | 101 | 3 | 
| 17 | VmAirWrapper<MultAdapterAir, MulHCoreAir<8, 8> |  | 40 | 8 | 2 | 
| 18 | VmAirWrapper<MultWAdapterAir, MultiplicationCoreAir<4, 8> |  | 24 | 2 | 2 | 
| 19 | VmAirWrapper<MultAdapterAir, MultiplicationCoreAir<8, 8> |  | 31 | 1 | 2 | 
| 2 | PersistentBoundaryAir<8> |  | 8 | 11 | 2 | 
| 20 | RangeTupleCheckerAir<2> | 1 | 1 | 8 | 3 | 
| 21 | RevealAir |  | 25 | 3 | 2 | 
...
| 4 | EcMulAir<32, 8> | 1 | 2,678 | 1,786 | 3 | 
...
| 7 | VmAirWrapper<VecHeapAdapterAir<2, 8, 8>, FieldExpressionCoreAir> |  | 372 | 167 | 3 | 
| 8 | VmAirWrapper<VecHeapAdapterAir<2, 8, 8>, FieldExpressionCoreAir> |  | 244 | 103 | 3 | 
...
| app_proof | 12 | VmAirWrapper<IsEqualModU16AdapterAir<2, 4, 16>, ModularIsEqualCoreAir<16, 4, 16> | prover |  | 0 | 32 | 105 | 3,360 | 
| app_proof | 13 | VmAirWrapper<VecHeapAdapterAir<2, 4, 4>, FieldExpressionCoreAir> | prover |  | 0 | 1,024 | 253 | 259,072 | 
| app_proof | 14 | VmAirWrapper<VecHeapAdapterAir<2, 4, 4>, FieldExpressionCoreAir> | prover |  | 0 | 64 | 189 | 12,096 | 
| app_proof | 17 | VmAirWrapper<MultAdapterAir, MulHCoreAir<8, 8> | prover |  | 0 | 256 | 52 | 13,312 | 
| app_proof | 19 | VmAirWrapper<MultAdapterAir, MultiplicationCoreAir<8, 8> | prover |  | 0 | 256 | 40 | 10,240 | 
| app_proof | 2 | PersistentBoundaryAir<8> | prover |  | 0 | 8,192 | 38 | 311,296 | 
| app_proof | 20 | RangeTupleCheckerAir<2> | prover |  | 0 | 1,048,576 | 3 | 3,145,728 | 
| app_proof | 22 | HintStoreAir | prover |  | 0 | 128 | 24 | 3,072 | 
| app_proof | 23 | VmAirWrapper<BaseAluImmAdapterAir, BitwiseLogicImmCoreAir<8, 8> | prover |  | 0 | 16,384 | 34 | 557,056 | 
| app_proof | 24 | VmAirWrapper<BaseAluImmU16AdapterAir, LessThanImmCoreAir<4, 16> | prover |  | 0 | 512 | 27 | 13,824 | 
| app_proof | 26 | VmAirWrapper<BaseAluImmU16AdapterAir, ShiftLogicalImmCoreAir<4, 16> | prover |  | 0 | 8,192 | 51 | 417,792 | 
| app_proof | 27 | VmAirWrapper<BaseAluImmU16AdapterAir, AddICoreAir<4, 16, true> | prover |  | 0 | 131,072 | 23 | 3,014,656 | 
| app_proof | 28 | VmAirWrapper<RdWriteAdapterAir, AuipcCoreAir> | prover |  | 0 | 8,192 | 16 | 131,072 | 
| app_proof | 29 | VmAirWrapper<JalrAdapterAir, JalrCoreAir> | prover |  | 0 | 8,192 | 22 | 180,224 | 
| app_proof | 3 | MemoryMerkleAir<8> | prover |  | 0 | 16,384 | 33 | 540,672 | 
| app_proof | 30 | VmAirWrapper<CondRdWriteAdapterAir, JalLuiCoreAir> | prover |  | 0 | 8,192 | 17 | 139,264 | 
| app_proof | 31 | VmAirWrapper<BranchAdapterAir, BranchLessThanCoreAir<4, 16> | prover |  | 0 | 8,192 | 30 | 245,760 | 
| app_proof | 32 | VmAirWrapper<BranchAdapterAir, BranchEqualCoreAir<4> | prover |  | 0 | 32,768 | 24 | 786,432 | 
| app_proof | 33 | VmAirWrapper<StoreMultiByteAdapterAir, StoreCoreAir<8, 4> | prover |  | 0 | 262,144 | 39 | 10,223,616 | 
| app_proof | 34 | VmAirWrapper<LoadMultiByteAdapterAir, LoadCoreAir<8, 5> | prover |  | 0 | 262,144 | 39 | 10,223,616 | 
| app_proof | 35 | VmAirWrapper<StoreMultiByteAdapterAir, StoreCoreAir<4, 2> | prover |  | 0 | 1 | 37 | 37 | 
| app_proof | 37 | VmAirWrapper<LoadMultiByteAdapterAir, LoadSignExtendCoreAir<4, 3> | prover |  | 0 | 2,048 | 38 | 77,824 | 
| app_proof | 41 | VmAirWrapper<StoreByteAdapterAir, StoreByteCoreAir> | prover |  | 0 | 1,024 | 28 | 28,672 | 
| app_proof | 42 | VmAirWrapper<LoadByteAdapterAir, LoadByteCoreAir> | prover |  | 0 | 2,048 | 28 | 57,344 | 
| app_proof | 43 | VmAirWrapper<LoadByteAdapterAir, LoadSignExtendByteCoreAir> | prover |  | 0 | 8 | 29 | 232 | 
| app_proof | 46 | VmAirWrapper<BaseAluWImmU16AdapterAir, AddICoreAir<2, 16, false> | prover |  | 0 | 32 | 22 | 704 | 
| app_proof | 52 | VmAirWrapper<BaseAluWRegU16AdapterAir, AddSubCoreAir<2, 16, false> | prover |  | 0 | 2,048 | 28 | 57,344 | 
| app_proof | 53 | VmAirWrapper<BaseAluRegAdapterAir, BitwiseLogicCoreAir<8, 8> | prover |  | 0 | 1,024 | 42 | 43,008 | 
| app_proof | 54 | VmAirWrapper<BaseAluRegU16AdapterAir, AddSubCoreAir<4, 16, true> | prover |  | 0 | 16,384 | 29 | 475,136 | 
| app_proof | 55 | BitwiseOperationLookupAir<8> | prover |  | 0 | 65,536 | 18 | 1,179,648 | 
| app_proof | 56 | PhantomAir | prover |  | 0 | 1 | 6 | 6 | 
| app_proof | 57 | Poseidon2PeripheryAir<BabyBearParameters>, 1> | prover |  | 0 | 16,384 | 300 | 4,915,200 | 
| app_proof | 58 | VariableRangeCheckerAir | prover |  | 0 | 262,144 | 4 | 1,048,576 | 
| app_proof | 7 | VmAirWrapper<VecHeapAdapterAir<2, 8, 8>, FieldExpressionCoreAir> | prover |  | 0 | 16,384 | 486 | 7,962,624 | 
| app_proof | 8 | VmAirWrapper<VecHeapAdapterAir<2, 8, 8>, FieldExpressionCoreAir> | prover |  | 0 | 8,192 | 358 | 2,932,736 | 
...
| app_proof | 12 | VmAirWrapper<IsEqualModU16AdapterAir<2, 4, 16>, ModularIsEqualCoreAir<16, 4, 16> |  | 0 | 18 | 14 | 4,725 | 3,675 | 7,560 | 5,880 | 1,890 | 1,470 | 33,278 | 25,882 | 918 | 714 | 
| app_proof | 13 | VmAirWrapper<VecHeapAdapterAir<2, 4, 4>, FieldExpressionCoreAir> |  | 0 | 719 | 305 | 454,768 | 192,912 | 727,628 | 308,660 | 181,907 | 77,165 | 5,082,432 | 2,155,968 | 140,205 | 59,475 | 
| app_proof | 14 | VmAirWrapper<VecHeapAdapterAir<2, 4, 4>, FieldExpressionCoreAir> |  | 0 | 37 | 27 | 17,483 | 12,757 | 27,972 | 20,412 | 6,993 | 5,103 | 175,704 | 128,216 | 4,847 | 3,537 | 
| app_proof | 17 | VmAirWrapper<MultAdapterAir, MulHCoreAir<8, 8> |  | 0 | 181 | 75 | 23,530 | 9,750 | 37,648 | 15,600 | 9,412 | 3,900 | 262,450 | 108,750 | 7,240 | 3,000 | 

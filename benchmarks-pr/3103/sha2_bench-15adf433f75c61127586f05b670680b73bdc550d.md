...
| `total_proof_time_ms ` |  2,081.50 |  4,163 |  2,800 |  1,363 |
| `compile_metered_time_ms` |  4 |  4 |  4 |  4 |
| `execute_metered_time_ms` |  57 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  195.48 | -          |  195.48 |  195.48 |
| `set_initial_memory_time_ms` |  1 |  2 |  1 |  1 |
| `execute_preflight_insns` |  5,583,980.50 |  11,167,961 |  7,136,000 |  4,031,961 |
| `execute_preflight_time_ms` |  265.50 |  531 |  357 |  174 |
| `execute_preflight_insn_mi/s` |  21.03 | -          |  23.06 |  19.96 |
| `postflight_time_ms  ` |  73.50 |  147 |  97 |  50 |
...
| `prover.main_trace_commit_time_ms` |  394 |  788 |  569 |  219 |
| `prover.rap_constraints_time_ms` |  987.50 |  1,975 |  1,298 |  677 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/15adf433f75c61127586f05b670680b73bdc550d/sha2_bench-15adf433f75c61127586f05b670680b73bdc550d.memory.svg)
...
| leaf | 0 | 111 | 518 | 111 | 35 | 12 | 2 | 9 | 9 | 
...
| internal_recursive.1 | 1 | prover | 9,750,865 | 97 | 15 | 0 | 0 | 55 | 20 | 19 | 21 | 12 | 0 | 27 | 20 | 7 | 1 | 5 | 15 | 15 | 54 | 0 | 1 | 10 | 0 | 0 | 
| leaf | 0 | prover | 237,929,272 | 406 | 146 | 0 | 0 | 142 | 72 | 70 | 44 | 26 | 0 | 117 | 95 | 22 | 10 | 11 | 146 | 146 | 142 | 0 | 3 | 25 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover |  | 0 | 1,283,751,306 | 2,214 | 569 | 0 | 0 | 1,298 | 703 | 702 | 236 | 359 | 0 | 347 | 252 | 94 | 58 | 36 | 569 | 569 | 1,298 | 0 | 1 | 357 | 0 | 0 | 
| app_proof | prover |  | 1 | 689,261,444 | 1,090 | 219 | 0 | 0 | 677 | 352 | 352 | 128 | 196 | 0 | 193 | 140 | 52 | 31 | 21 | 219 | 219 | 677 | 0 | 1 | 195 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof |  | 1,363 | 57 | 11,167,961 | 195.48 | 0 | 4,228 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof |  | 0 | 1 | 2 | 87 | 2,800 | 3 | 1 | 0 | 97 | 2 | 10 | 0 | 12,555,149,448 | 2,852,631,024 | 15,407,780,472 | 2,097,152 | 2 | 0 | 0 | 3 | 83 | 357 | 7,136,000 | 19.96 | 0 | 0 | 
| app_proof |  | 1 | 1 | 2 | 24 | 1,363 | 2 | 1 | 0 | 50 | 1 | 4 | 0 | 7,126,144,008 | 1,696,634,577 | 8,822,778,585 | 2,097,152 | 2 | 0 | 0 | 2 | 21 | 174 | 4,031,961 | 23.06 | 0 | 0 | 

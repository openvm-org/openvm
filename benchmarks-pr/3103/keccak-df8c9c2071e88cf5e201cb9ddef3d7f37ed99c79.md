...
|:---|---:|---:|---:|
| Total |  9.66 |  3.47 |  3.47 |
| app_proof |  7.57 |  1.88 |  1.88 |
| leaf |  1.52 |  1.02 |  1.02 |
...
| `total_proof_time_ms ` |  1,241.17 |  7,447 |  1,349 |  1,206 |
...
| `execute_preflight_time_ms` |  84.67 |  508 |  106 |  79 |
| `execute_preflight_insn_mi/s` |  28.28 | -          |  29.80 |  22.55 |
| `postflight_time_ms  ` |  28.17 |  169 |  29 |  28 |
| `postflight_memory_chronology_time_ms` |  2.17 |  13 |  3 |  2 |
| `postflight_program_index_time_ms` |  0 |  0 |  0 |  0 |
| `trace_gen_time_ms   ` |  12.83 |  77 |  17 |  12 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,100.33 |  6,602 |  1,180 |  1,074 |
| `prover.main_trace_commit_time_ms` |  343.67 |  2,062 |  357 |  338 |
| `prover.rap_constraints_time_ms` |  513.83 |  3,083 |  517 |  511 |
| `prover.openings_time_ms` |  241.67 |  1,450 |  306 |  224 |
| `prover.rap_constraints.logup_gkr_time_ms` |  105 |  630 |  106 |  104 |
| `prover.rap_constraints.round0_time_ms` |  284.50 |  1,707 |  286 |  284 |
...
| `prover.openings.whir_time_ms` |  180 |  1,080 |  245 |  163 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  762.50 |  1,525 |  1,024 |  501 |
| `execute_preflight_time_ms` |  4 |  8 |  4 |  4 |
| `trace_gen_time_ms   ` |  138.50 |  277 |  185 |  92 |
| `generate_blob_total_time_ms` |  15.50 |  31 |  21 |  10 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  623.50 |  1,247 |  838 |  409 |
| `prover.main_trace_commit_time_ms` |  267.50 |  535 |  388 |  147 |
| `prover.rap_constraints_time_ms` |  187 |  374 |  232 |  142 |
| `prover.openings_time_ms` |  167.50 |  335 |  216 |  119 |
...
| `prover.openings.whir_time_ms` |  138 |  276 |  179 |  97 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/df8c9c2071e88cf5e201cb9ddef3d7f37ed99c79/keccak-df8c9c2071e88cf5e201cb9ddef3d7f37ed99c79.memory.svg)
...
| internal_recursive.0 | 1 | 15 | 131 | 14 | 2 | 0 | 2 | 2 | 2 | 
| internal_recursive.1 | 1 | 9 | 109 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 185 | 1,024 | 184 | 58 | 21 | 4 | 10 | 10 | 
| leaf | 1 | 92 | 501 | 92 | 30 | 10 | 4 | 10 | 10 | 
...
| internal_recursive.0 | 1 | prover | 16,836,945 | 116 | 21 | 0 | 0 | 59 | 21 | 20 | 24 | 13 | 0 | 35 | 27 | 8 | 1 | 6 | 21 | 21 | 59 | 0 | 1 | 12 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 99 | 15 | 0 | 0 | 52 | 20 | 19 | 21 | 10 | 0 | 31 | 23 | 7 | 1 | 5 | 15 | 15 | 52 | 0 | 1 | 10 | 0 | 0 | 
| leaf | 0 | prover | 476,578,798 | 838 | 388 | 0 | 0 | 232 | 120 | 119 | 71 | 40 | 0 | 216 | 179 | 37 | 20 | 17 | 388 | 388 | 232 | 0 | 3 | 39 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover |  | 0 | 830,158,476 | 1,180 | 357 | 0 | 54 | 515 | 285 | 285 | 123 | 106 | 0 | 306 | 245 | 61 | 36 | 24 | 357 | 357 | 515 | 0 | 1 | 104 | 0 | 0 | 
| app_proof | prover |  | 1 | 830,158,476 | 1,088 | 338 | 0 | 0 | 513 | 284 | 284 | 123 | 105 | 0 | 236 | 173 | 62 | 37 | 24 | 338 | 338 | 513 | 0 | 1 | 104 | 0 | 0 | 
| app_proof | prover |  | 2 | 830,158,476 | 1,083 | 339 | 0 | 0 | 517 | 286 | 285 | 124 | 106 | 0 | 226 | 164 | 61 | 36 | 24 | 339 | 339 | 517 | 0 | 1 | 105 | 0 | 0 | 
| app_proof | prover |  | 3 | 830,158,476 | 1,088 | 345 | 0 | 0 | 514 | 284 | 283 | 124 | 105 | 0 | 228 | 167 | 61 | 36 | 24 | 345 | 345 | 514 | 0 | 1 | 105 | 0 | 0 | 
| app_proof | prover |  | 4 | 830,158,476 | 1,089 | 345 | 0 | 0 | 513 | 284 | 283 | 124 | 104 | 0 | 230 | 168 | 62 | 37 | 24 | 345 | 345 | 513 | 0 | 1 | 104 | 0 | 0 | 
| app_proof | prover |  | 5 | 819,934,860 | 1,074 | 337 | 0 | 0 | 511 | 284 | 283 | 123 | 104 | 0 | 224 | 163 | 60 | 36 | 24 | 338 | 337 | 511 | 0 | 1 | 102 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof |  | 1,206 | 126 | 14,365,133 | 113.79 | 0 | 7,584 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof |  | 0 | 1 | 2 | 17 | 1,349 | 3 | 1 | 0 | 29 | 0 | 3 | 0 | 9,337,486,584 | 624,415,128 | 9,961,901,712 | 2,097,152 | 2 | 0 | 0 | 3 | 14 | 106 | 2,413,000 | 22.55 | 0 | 0 | 
| app_proof |  | 1 | 0 | 2 | 12 | 1,224 | 2 | 0 | 0 | 28 | 0 | 2 | 0 | 9,337,793,604 | 625,029,708 | 9,962,823,312 | 2,097,152 | 2 | 0 | 0 | 2 | 9 | 81 | 2,413,000 | 29.49 | 0 | 0 | 
| app_proof |  | 2 | 0 | 2 | 12 | 1,219 | 2 | 0 | 0 | 28 | 0 | 2 | 0 | 9,337,030,356 | 625,792,956 | 9,962,823,312 | 2,097,152 | 2 | 0 | 0 | 2 | 9 | 80 | 2,413,000 | 29.80 | 0 | 0 | 
| app_proof |  | 3 | 0 | 2 | 12 | 1,224 | 2 | 0 | 0 | 28 | 0 | 2 | 0 | 9,337,792,860 | 625,030,452 | 9,962,823,312 | 2,097,152 | 2 | 0 | 0 | 2 | 9 | 81 | 2,413,000 | 29.66 | 0 | 0 | 
| app_proof |  | 4 | 0 | 2 | 12 | 1,225 | 2 | 0 | 0 | 28 | 0 | 2 | 0 | 9,337,030,236 | 625,793,076 | 9,962,823,312 | 2,097,152 | 2 | 0 | 0 | 2 | 9 | 81 | 2,413,000 | 29.63 | 0 | 0 | 
| app_proof |  | 5 | 0 | 2 | 12 | 1,206 | 2 | 0 | 0 | 28 | 0 | 2 | 0 | 8,903,917,596 | 936,222,324 | 9,840,139,920 | 2,097,152 | 2 | 0 | 0 | 2 | 8 | 79 | 2,300,133 | 28.97 | 0 | 0 | 

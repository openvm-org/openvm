...
| `total_proof_time_ms ` |  2,073.50 |  4,147 |  2,798 |  1,349 |
| `compile_metered_time_ms` |  3 |  3 |  3 |  3 |
| `execute_metered_time_ms` |  56 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  196.47 | -          |  196.47 |  196.47 |
| `set_initial_memory_time_ms` |  0 |  0 |  0 |  0 |
| `execute_preflight_insns` |  5,583,980.50 |  11,167,961 |  7,136,000 |  4,031,961 |
| `execute_preflight_time_ms` |  259 |  518 |  356 |  162 |
| `execute_preflight_insn_mi/s` |  21.56 | -          |  24.80 |  19.99 |
| `postflight_time_ms  ` |  71.50 |  143 |  93 |  50 |
| `postflight_memory_chronology_time_ms` |  7.50 |  15 |  10 |  5 |
| `postflight_program_index_time_ms` |  1 |  2 |  1 |  1 |
| `trace_gen_time_ms   ` |  59 |  118 |  94 |  24 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,653 |  3,306 |  2,219 |  1,087 |
| `prover.main_trace_commit_time_ms` |  396 |  792 |  575 |  217 |
| `prover.rap_constraints_time_ms` |  983 |  1,966 |  1,290 |  676 |
| `prover.openings_time_ms` |  273 |  546 |  353 |  193 |
...
| `prover.openings.whir_time_ms` |  200 |  400 |  259 |  141 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/207bfc7ebdc06de74cdf49b1e79ec5a8e875ad23/sha2_bench-207bfc7ebdc06de74cdf49b1e79ec5a8e875ad23.memory.svg)
...
| leaf | 0 | 117 | 524 | 117 | 36 | 12 | 2 | 10 | 10 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 180 | 46 | 0 | 0 | 79 | 29 | 28 | 36 | 13 | 0 | 53 | 43 | 10 | 2 | 7 | 46 | 46 | 79 | 0 | 1 | 12 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover |  | 0 | 1,283,751,306 | 2,219 | 574 | 0 | 0 | 1,290 | 700 | 700 | 234 | 354 | 1 | 353 | 259 | 94 | 57 | 36 | 575 | 574 | 1,290 | 0 | 1 | 352 | 0 | 0 | 
| app_proof | prover |  | 1 | 689,261,444 | 1,087 | 217 | 0 | 0 | 676 | 351 | 350 | 128 | 196 | 0 | 193 | 141 | 52 | 30 | 21 | 217 | 217 | 676 | 0 | 1 | 195 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof |  | 1,349 | 56 | 11,167,961 | 196.47 | 0 | 4,210 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof |  | 0 | 0 | 2 | 94 | 2,798 | 3 | 0 | 0 | 93 | 1 | 10 | 0 | 12,555,149,448 | 2,852,631,024 | 15,407,780,472 | 2,097,152 | 2 | 0 | 0 | 3 | 90 | 356 | 7,136,000 | 19.99 | 0 | 0 | 
| app_proof |  | 1 | 0 | 2 | 24 | 1,349 | 2 | 0 | 0 | 50 | 1 | 5 | 0 | 7,126,144,008 | 1,696,634,577 | 8,822,778,585 | 2,097,152 | 2 | 0 | 0 | 2 | 21 | 162 | 4,031,961 | 24.80 | 0 | 0 | 

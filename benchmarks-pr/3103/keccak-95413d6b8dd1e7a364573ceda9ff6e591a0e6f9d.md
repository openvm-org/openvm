...
| `total_proof_time_ms ` |  1,243.33 |  7,460 |  1,352 |  1,202 |
| `compile_metered_time_ms` |  3 |  3 |  3 |  3 |
| `execute_metered_time_ms` |  125 | -          | -          | -          |
| `execute_metered_insns` |  14,365,133 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  114.41 | -          |  114.41 |  114.41 |
| `set_initial_memory_time_ms` |  0.17 |  1 |  1 |  0 |
| `execute_preflight_insns` |  2,394,188.83 |  14,365,133 |  2,413,000 |  2,300,133 |
| `execute_preflight_time_ms` |  85.67 |  514 |  108 |  78 |
| `execute_preflight_insn_mi/s` |  27.95 | -          |  30.12 |  22.15 |
| `postflight_time_ms  ` |  29.33 |  176 |  31 |  27 |
| `postflight_memory_chronology_time_ms` |  2 |  12 |  2 |  2 |
| `postflight_program_index_time_ms` |  0 |  0 |  0 |  0 |
| `trace_gen_time_ms   ` |  12.67 |  76 |  17 |  11 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,099 |  6,594 |  1,181 |  1,069 |
| `prover.main_trace_commit_time_ms` |  344.83 |  2,069 |  359 |  338 |
| `prover.rap_constraints_time_ms` |  511.67 |  3,070 |  514 |  509 |
| `prover.openings_time_ms` |  241.50 |  1,449 |  307 |  222 |
| `prover.rap_constraints.logup_gkr_time_ms` |  104.33 |  626 |  105 |  103 |
| `prover.rap_constraints.round0_time_ms` |  282.50 |  1,695 |  284 |  282 |
...
| `prover.openings.whir_time_ms` |  179.67 |  1,078 |  246 |  161 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  767.50 |  1,535 |  1,029 |  506 |
| `execute_preflight_time_ms` |  4 |  8 |  4 |  4 |
| `trace_gen_time_ms   ` |  145 |  290 |  194 |  96 |
| `generate_blob_total_time_ms` |  15.50 |  31 |  21 |  10 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  622.50 |  1,245 |  835 |  410 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/95413d6b8dd1e7a364573ceda9ff6e591a0e6f9d/keccak-95413d6b8dd1e7a364573ceda9ff6e591a0e6f9d.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 43 | 330 | 43 | 14 | 3 | 2 | 2 | 2 | 
| internal_recursive.0 | 1 | 14 | 130 | 13 | 2 | 0 | 2 | 2 | 2 | 
| internal_recursive.1 | 1 | 10 | 108 | 10 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 194 | 1,029 | 193 | 59 | 21 | 4 | 11 | 11 | 
| leaf | 1 | 96 | 506 | 95 | 32 | 10 | 4 | 11 | 11 | 
...
| leaf | 0 | prover | 476,578,798 | 835 | 388 | 0 | 0 | 234 | 121 | 120 | 71 | 40 | 0 | 210 | 173 | 37 | 20 | 17 | 389 | 388 | 234 | 0 | 3 | 40 | 0 | 0 | 
| leaf | 1 | prover | 240,255,800 | 410 | 147 | 0 | 0 | 143 | 71 | 70 | 45 | 26 | 0 | 118 | 96 | 22 | 10 | 11 | 148 | 147 | 143 | 0 | 3 | 25 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover |  | 0 | 830,158,476 | 1,181 | 359 | 0 | 54 | 513 | 283 | 282 | 124 | 105 | 0 | 307 | 246 | 61 | 36 | 24 | 359 | 359 | 513 | 0 | 1 | 103 | 0 | 0 | 
| app_proof | prover |  | 1 | 830,158,476 | 1,085 | 338 | 0 | 0 | 511 | 282 | 281 | 124 | 105 | 0 | 234 | 172 | 61 | 36 | 24 | 339 | 339 | 511 | 0 | 1 | 103 | 0 | 0 | 
| app_proof | prover |  | 2 | 830,158,476 | 1,080 | 340 | 0 | 0 | 512 | 282 | 281 | 124 | 104 | 0 | 227 | 164 | 62 | 37 | 24 | 341 | 340 | 512 | 0 | 1 | 103 | 0 | 0 | 
| app_proof | prover |  | 3 | 830,158,476 | 1,090 | 345 | 0 | 0 | 514 | 284 | 283 | 124 | 105 | 0 | 229 | 167 | 61 | 36 | 24 | 346 | 345 | 514 | 0 | 1 | 104 | 0 | 0 | 
| app_proof | prover |  | 4 | 830,158,476 | 1,089 | 346 | 0 | 0 | 511 | 282 | 281 | 124 | 104 | 0 | 230 | 168 | 62 | 37 | 25 | 346 | 346 | 511 | 0 | 1 | 103 | 0 | 0 | 
| app_proof | prover |  | 5 | 819,934,860 | 1,069 | 337 | 0 | 0 | 509 | 282 | 281 | 124 | 103 | 0 | 222 | 161 | 60 | 36 | 24 | 338 | 337 | 509 | 0 | 1 | 101 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof |  | 1,202 | 125 | 14,365,133 | 114.41 | 0 | 7,597 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof |  | 0 | 1 | 2 | 17 | 1,352 | 3 | 1 | 0 | 30 | 0 | 2 | 0 | 9,337,486,584 | 624,415,128 | 9,961,901,712 | 2,097,152 | 2 | 0 | 0 | 3 | 14 | 108 | 2,413,000 | 22.15 | 0 | 0 | 
| app_proof |  | 1 | 0 | 2 | 12 | 1,225 | 2 | 0 | 0 | 30 | 0 | 2 | 0 | 9,337,793,604 | 625,029,708 | 9,962,823,312 | 2,097,152 | 2 | 0 | 0 | 2 | 9 | 80 | 2,413,000 | 30.12 | 0 | 0 | 
| app_proof |  | 2 | 0 | 2 | 12 | 1,219 | 2 | 0 | 0 | 29 | 0 | 2 | 0 | 9,337,030,356 | 625,792,956 | 9,962,823,312 | 2,097,152 | 2 | 0 | 0 | 2 | 9 | 82 | 2,413,000 | 29.14 | 0 | 0 | 
| app_proof |  | 3 | 0 | 2 | 12 | 1,230 | 2 | 0 | 0 | 29 | 0 | 2 | 0 | 9,337,792,860 | 625,030,452 | 9,962,823,312 | 2,097,152 | 2 | 0 | 0 | 2 | 9 | 84 | 2,413,000 | 28.59 | 0 | 0 | 
| app_proof |  | 4 | 0 | 2 | 12 | 1,232 | 2 | 0 | 0 | 31 | 0 | 2 | 0 | 9,337,030,236 | 625,793,076 | 9,962,823,312 | 2,097,152 | 2 | 0 | 0 | 2 | 9 | 82 | 2,413,000 | 29.23 | 0 | 0 | 
| app_proof |  | 5 | 0 | 2 | 11 | 1,202 | 2 | 0 | 0 | 27 | 0 | 2 | 0 | 8,903,917,596 | 936,222,324 | 9,840,139,920 | 2,097,152 | 2 | 0 | 0 | 2 | 8 | 78 | 2,300,133 | 29.13 | 0 | 0 | 

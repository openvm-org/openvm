...
| `total_proof_time_ms ` |  745 |  1,490 |  803 |  687 |
| `execute_metered_time_ms` |  33 | -          | -          | -          |
| `execute_metered_insns` |  4,137,067 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  124.81 | -          |  124.81 |  124.81 |
| `execute_preflight_insns` |  2,068,533.50 |  4,137,067 |  2,208,000 |  1,929,067 |
| `execute_preflight_time_ms` |  75.50 |  151 |  83 |  68 |
| `execute_preflight_insn_mi/s` |  38.34 | -          |  40.63 |  36.04 |
| `trace_gen_time_ms   ` |  145 |  290 |  150 |  140 |
| `memory_finalize_time_ms` |  1 |  2 |  2 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  422.50 |  845 |  427 |  418 |
| `prover.main_trace_commit_time_ms` |  92 |  184 |  96 |  88 |
| `prover.rap_constraints_time_ms` |  233.50 |  467 |  246 |  221 |
| `prover.openings_time_ms` |  96.50 |  193 |  101 |  92 |
| `prover.rap_constraints.logup_gkr_time_ms` |  136.50 |  273 |  138 |  135 |
...
| `prover.rap_constraints_time_ms` |  133 |  133 |  133 |  133 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/9e8b17ef3c5ed4bb7038931ea78a8add8712ebe3/regex-9e8b17ef3c5ed4bb7038931ea78a8add8712ebe3.memory.svg)
...
| app_proof |  |  |  |  |  | 687 |  |  | 33 | 4,137,067 | 124.81 | 0 | 1,538 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 27,256,635 | 255 | 82 | 0 | 0 | 96 | 31 | 31 | 45 | 19 | 0 | 76 | 64 | 11 | 2 | 8 | 82 | 96 | 0 | 3 | 18 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,767 | 169 | 45 | 0 | 0 | 67 | 25 | 24 | 27 | 14 | 0 | 55 | 46 | 8 | 1 | 6 | 45 | 67 | 0 | 3 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 139 | 31 | 0 | 0 | 61 | 23 | 22 | 24 | 14 | 0 | 46 | 38 | 7 | 1 | 5 | 32 | 61 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 79,959,796 | 374 | 126 | 0 | 0 | 133 | 54 | 53 | 37 | 42 | 0 | 113 | 98 | 15 | 6 | 8 | 127 | 133 | 0 | 6 | 41 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 123,384,338 | 418 | 96 | 0 | 0 | 221 | 54 | 53 | 28 | 138 | 0 | 101 | 81 | 19 | 10 | 9 | 96 | 221 | 0 | 3 | 136 | 0 | 0 | 
| app_proof | prover | 1 | 106,568,591 | 427 | 88 | 0 | 0 | 246 | 84 | 83 | 26 | 135 | 0 | 92 | 74 | 18 | 8 | 9 | 88 | 246 | 0 | 3 | 134 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 140 | 803 | 140 | 160 | 2,052,973,566 | 668,936,290 | 2,721,909,856 | 2,097,152 | 2 | 7 | 83 | 2,208,000 | 36.04 | 
| app_proof | 1 | 150 | 687 | 150 | 41 | 1,584,899,101 | 646,500,736 | 2,231,399,837 | 2,097,152 | 0 | 2 | 68 | 1,929,067 | 40.63 | 

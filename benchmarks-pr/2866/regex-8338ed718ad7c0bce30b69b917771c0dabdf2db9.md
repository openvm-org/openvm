...
|:---|---:|---:|---:|
| Total |  2.55 |  1.87 |  1.87 |
| app_proof |  1.52 |  0.84 |  0.84 |
| leaf |  0.43 |  0.43 |  0.43 |
...
| `total_proof_time_ms ` |  745 |  1,490 |  804 |  686 |
| `execute_metered_time_ms` |  33 | -          | -          | -          |
| `execute_metered_insns` |  4,137,067 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  125.05 | -          |  125.05 |  125.05 |
| `execute_preflight_insns` |  2,068,533.50 |  4,137,067 |  2,208,000 |  1,929,067 |
| `execute_preflight_time_ms` |  75 |  150 |  80 |  70 |
| `execute_preflight_insn_mi/s` |  38.57 | -          |  38.91 |  38.24 |
| `trace_gen_time_ms   ` |  144 |  288 |  147 |  141 |
| `memory_finalize_time_ms` |  1.50 |  3 |  3 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  425 |  850 |  427 |  423 |
| `prover.main_trace_commit_time_ms` |  93.50 |  187 |  99 |  88 |
| `prover.rap_constraints_time_ms` |  234.50 |  469 |  247 |  222 |
| `prover.openings_time_ms` |  96 |  192 |  101 |  91 |
| `prover.rap_constraints.logup_gkr_time_ms` |  137.50 |  275 |  139 |  136 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/8338ed718ad7c0bce30b69b917771c0dabdf2db9/regex-8338ed718ad7c0bce30b69b917771c0dabdf2db9.memory.svg)
...
| app_proof |  |  |  |  |  | 686 |  |  | 33 | 4,137,067 | 125.05 | 0 | 1,538 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 15 | 276 | 15 | 4 | 0 | 2 | 1 | 1 | 
| internal_recursive.0 | 1 | 10 | 184 | 9 | 1 | 0 | 2 | 0 | 0 | 
| internal_recursive.1 | 1 | 9 | 145 | 8 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 48 | 426 | 48 | 13 | 2 | 5 | 1 | 1 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 27,256,635 | 260 | 81 | 0 | 0 | 98 | 33 | 33 | 45 | 19 | 0 | 80 | 69 | 11 | 2 | 8 | 82 | 98 | 0 | 3 | 18 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,767 | 174 | 46 | 0 | 0 | 67 | 25 | 24 | 28 | 13 | 0 | 59 | 51 | 8 | 1 | 6 | 47 | 67 | 0 | 2 | 12 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 136 | 31 | 0 | 0 | 60 | 22 | 22 | 24 | 13 | 0 | 43 | 35 | 7 | 1 | 5 | 32 | 60 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 79,959,796 | 378 | 125 | 0 | 0 | 135 | 55 | 54 | 37 | 43 | 0 | 116 | 101 | 15 | 6 | 8 | 126 | 135 | 0 | 6 | 41 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 123,384,338 | 423 | 99 | 0 | 0 | 222 | 54 | 53 | 28 | 139 | 0 | 101 | 81 | 19 | 10 | 9 | 99 | 222 | 0 | 3 | 137 | 0 | 0 | 
| app_proof | prover | 1 | 106,568,591 | 427 | 88 | 0 | 0 | 247 | 84 | 84 | 25 | 136 | 0 | 91 | 73 | 18 | 8 | 9 | 88 | 247 | 0 | 3 | 135 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 141 | 804 | 141 | 158 | 2,052,973,566 | 668,936,290 | 2,721,909,856 | 2,097,152 | 3 | 6 | 80 | 2,208,000 | 38.24 | 
| app_proof | 1 | 147 | 686 | 147 | 41 | 1,584,899,101 | 646,500,736 | 2,231,399,837 | 2,097,152 | 0 | 2 | 70 | 1,929,067 | 38.91 | 

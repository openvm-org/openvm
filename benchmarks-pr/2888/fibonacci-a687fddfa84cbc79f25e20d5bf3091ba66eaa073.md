...
|:---|---:|---:|---:|
| Total |  4.51 |  2.34 |  2.34 |
| app_proof |  3.16 |  0.99 |  0.99 |
| leaf |  0.68 |  0.68 |  0.68 |
...
| `total_proof_time_ms ` |  773.25 |  3,093 |  925 |  556 |
| `execute_metered_time_ms` |  66 | -          | -          | -          |
| `execute_metered_insns` |  12,000,265 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  179.50 | -          |  179.50 |  179.50 |
| `execute_preflight_insns` |  3,000,066.25 |  12,000,265 |  3,495,000 |  1,515,265 |
| `execute_preflight_time_ms` |  82.50 |  330 |  101 |  43 |
| `execute_preflight_insn_mi/s` |  49.02 | -          |  50.09 |  46.10 |
| `trace_gen_time_ms   ` |  144.75 |  579 |  178 |  128 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  475.75 |  1,903 |  539 |  294 |
| `prover.main_trace_commit_time_ms` |  100 |  400 |  114 |  60 |
| `prover.rap_constraints_time_ms` |  273.75 |  1,095 |  311 |  167 |
| `prover.openings_time_ms` |  101.50 |  406 |  117 |  66 |
| `prover.rap_constraints.logup_gkr_time_ms` |  196.25 |  785 |  225 |  119 |
| `prover.rap_constraints.round0_time_ms` |  52 |  208 |  62 |  30 |
...
| `prover.openings.whir_time_ms` |  171 |  171 |  171 |  171 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/a687fddfa84cbc79f25e20d5bf3091ba66eaa073/fibonacci-a687fddfa84cbc79f25e20d5bf3091ba66eaa073.memory.svg)
...
| app_proof |  |  |  |  |  | 556 |  |  | 66 | 12,000,265 | 179.50 | 0 | 3,167 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,747 | 329 | 118 | 0 | 0 | 107 | 35 | 34 | 51 | 20 | 0 | 102 | 88 | 13 | 3 | 9 | 119 | 107 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,767 | 167 | 46 | 0 | 0 | 66 | 24 | 23 | 28 | 13 | 0 | 53 | 45 | 8 | 1 | 6 | 47 | 66 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 136 | 32 | 0 | 0 | 60 | 22 | 22 | 24 | 13 | 0 | 42 | 35 | 7 | 1 | 5 | 33 | 60 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 147,934,246 | 616 | 235 | 0 | 0 | 185 | 85 | 84 | 54 | 45 | 0 | 195 | 171 | 24 | 12 | 12 | 235 | 185 | 0 | 8 | 44 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 136,618,054 | 539 | 113 | 0 | 0 | 308 | 62 | 62 | 27 | 218 | 0 | 117 | 94 | 22 | 12 | 9 | 113 | 308 | 0 | 3 | 217 | 0 | 0 | 
| app_proof | prover | 1 | 136,570,716 | 538 | 113 | 0 | 0 | 311 | 58 | 58 | 26 | 225 | 0 | 113 | 91 | 21 | 12 | 9 | 114 | 311 | 0 | 3 | 225 | 0 | 0 | 
| app_proof | prover | 2 | 136,570,716 | 532 | 112 | 0 | 0 | 309 | 58 | 58 | 27 | 223 | 0 | 110 | 88 | 21 | 12 | 9 | 113 | 309 | 0 | 3 | 222 | 0 | 0 | 
| app_proof | prover | 3 | 70,295,004 | 294 | 60 | 0 | 0 | 167 | 30 | 30 | 17 | 119 | 0 | 66 | 54 | 12 | 6 | 6 | 60 | 167 | 0 | 3 | 117 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 141 | 925 | 141 | 154 | 2,770,197,065 | 323,292,691 | 3,093,489,756 | 2,097,152 | 0 | 3 | 89 | 3,495,000 | 46.10 | 
| app_proof | 1 | 128 | 809 | 128 | 41 | 2,768,862,357 | 322,353,414 | 3,091,215,771 | 2,097,152 | 0 | 1 | 101 | 3,495,000 | 49.100 | 
| app_proof | 2 | 132 | 803 | 132 | 41 | 2,768,862,357 | 322,353,414 | 3,091,215,771 | 2,097,152 | 0 | 1 | 97 | 3,495,000 | 50.09 | 
| app_proof | 3 | 178 | 556 | 178 | 41 | 1,230,956,171 | 342,871,578 | 1,573,827,749 | 2,097,152 | 0 | 2 | 43 | 1,515,265 | 49.91 | 

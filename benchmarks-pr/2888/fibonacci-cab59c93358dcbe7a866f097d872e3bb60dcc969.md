...
|:---|---:|---:|---:|
| Total |  5.98 |  2.19 |  2.19 |
| app_proof |  4.05 |  0.74 |  0.74 |
| leaf |  1.15 |  0.66 |  0.66 |
...
| `total_proof_time_ms ` |  568.86 |  3,982 |  671 |  544 |
...
| `execute_preflight_time_ms` |  51.86 |  363 |  56 |  45 |
| `execute_preflight_insn_mi/s` |  45.80 | -          |  46.14 |  45.30 |
| `trace_gen_time_ms   ` |  166.14 |  1,163 |  172 |  163 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  292.14 |  2,045 |  296 |  285 |
| `prover.main_trace_commit_time_ms` |  58.43 |  409 |  59 |  56 |
| `prover.rap_constraints_time_ms` |  166.71 |  1,167 |  170 |  160 |
| `prover.openings_time_ms` |  66 |  462 |  67 |  65 |
| `prover.rap_constraints.logup_gkr_time_ms` |  116 |  812 |  118 |  110 |
| `prover.rap_constraints.round0_time_ms` |  32.43 |  227 |  35 |  31 |
...
| `prover.openings.whir_time_ms` |  53.43 |  374 |  55 |  52 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  573 |  1,146 |  664 |  482 |
| `execute_preflight_time_ms` |  1 |  2 |  1 |  1 |
| `trace_gen_time_ms   ` |  47.50 |  95 |  57 |  38 |
| `generate_blob_total_time_ms` |  2.50 |  5 |  3 |  2 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  525.50 |  1,051 |  607 |  444 |
| `prover.main_trace_commit_time_ms` |  194.50 |  389 |  232 |  157 |
| `prover.rap_constraints_time_ms` |  163.50 |  327 |  181 |  146 |
| `prover.openings_time_ms` |  166 |  332 |  193 |  139 |
...
| `prover.openings.whir_time_ms` |  144.50 |  289 |  168 |  121 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/cab59c93358dcbe7a866f097d872e3bb60dcc969/fibonacci-cab59c93358dcbe7a866f097d872e3bb60dcc969.memory.svg)

| Module | Max (GB) | Max At |
| --- | ---: | --- |
| generate mem proving ctxs | 4.61 | app_proof.6 |
...
| prover.batch_constraints.before_round0 | 1.58 | app_proof.prover.0 |
| frac_sumcheck.gkr_rounds | 1.58 | app_proof.prover.0 |
| prover.gkr_input_evals | 1.49 | app_proof.prover.0 |
| frac_sumcheck.segment_tree | 1.49 | app_proof.prover.0 |
| prover.rap_constraints | 1.40 | internal_for_leaf.0.prover |
...
| tracegen.whir_folding | 0.50 | leaf.0 |
...
| app_proof |  |  |  |  |  | 555 |  |  | 67 | 12,000,265 | 177.24 | 0 | 4,057 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 28 | 460 | 27 | 9 | 1 | 2 | 1 | 1 | 
| internal_recursive.0 | 1 | 12 | 182 | 12 | 1 | 0 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 10 | 145 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 57 | 664 | 56 | 23 | 3 | 1 | 1 | 1 | 
| leaf | 1 | 38 | 482 | 38 | 17 | 2 | 1 | 1 | 1 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 53,005,300 | 432 | 159 | 0 | 0 | 144 | 42 | 41 | 72 | 29 | 0 | 128 | 110 | 17 | 5 | 12 | 159 | 144 | 0 | 3 | 28 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,767 | 170 | 47 | 0 | 0 | 66 | 24 | 24 | 28 | 13 | 0 | 55 | 47 | 8 | 1 | 6 | 47 | 66 | 0 | 3 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 |
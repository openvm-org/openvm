...
| `total_proof_time_ms ` |  770.75 |  3,083 |  926 |  557 |
| `execute_metered_time_ms` |  66 | -          | -          | -          |
| `execute_metered_insns` |  12,000,265 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  179.10 | -          |  179.10 |  179.10 |
| `execute_preflight_insns` |  3,000,066.25 |  12,000,265 |  3,495,000 |  1,515,265 |
| `execute_preflight_time_ms` |  83.25 |  333 |  103 |  43 |
| `execute_preflight_insn_mi/s` |  49.17 | -          |  50.13 |  46.52 |
| `trace_gen_time_ms   ` |  141.50 |  566 |  175 |  124 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  475.50 |  1,902 |  541 |  297 |
| `prover.main_trace_commit_time_ms` |  99.25 |  397 |  113 |  60 |
| `prover.rap_constraints_time_ms` |  274 |  1,096 |  310 |  170 |
| `prover.openings_time_ms` |  101.25 |  405 |  117 |  66 |
| `prover.rap_constraints.logup_gkr_time_ms` |  197.25 |  789 |  224 |  119 |
| `prover.rap_constraints.round0_time_ms` |  51.50 |  206 |  59 |  33 |
...
| `prover.openings.whir_time_ms` |  81.75 |  327 |  96 |  53 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/4f7677d07d6cf06531aab96fc2fed6e96387f70e/fibonacci-4f7677d07d6cf06531aab96fc2fed6e96387f70e.memory.svg)
...
| app_proof |  |  |  |  |  | 557 |  |  | 66 | 12,000,265 | 179.10 | 0 | 3,158 |  | 
...
| internal_recursive.0 | 1 | prover | 15,378,767 | 169 | 47 | 0 | 0 | 68 | 25 | 24 | 28 | 14 | 0 | 52 | 44 | 8 | 1 | 6 | 47 | 68 | 0 | 3 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 136 | 32 | 0 | 0 | 61 | 22 | 22 | 24 | 13 | 0 | 42 | 35 | 7 | 1 | 5 | 33 | 61 | 0 | 2 | 13 | 0 | 0 | 
| leaf | 0 | prover | 147,934,246 | 612 | 234 | 0 | 0 | 183 | 84 | 83 | 53 | 45 | 0 | 193 | 168 | 24 | 12 | 12 | 235 | 183 | 0 | 8 | 44 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 136,618,054 | 541 | 113 | 0 | 0 | 310 | 59 | 58 | 27 | 224 | 0 | 117 | 96 | 21 | 11 | 9 | 113 | 310 | 0 | 3 | 222 | 0 | 0 | 
| app_proof | prover | 1 | 136,570,716 | 532 | 112 | 0 | 0 | 307 | 57 | 57 | 27 | 222 | 0 | 112 | 90 | 21 | 12 | 9 | 112 | 307 | 0 | 3 | 222 | 0 | 0 | 
| app_proof | prover | 2 | 136,570,716 | 532 | 112 | 0 | 0 | 309 | 57 | 57 | 27 | 224 | 0 | 110 | 88 | 21 | 12 | 9 | 112 | 309 | 0 | 3 | 223 | 0 | 0 | 
| app_proof | prover | 3 | 70,295,004 | 297 | 59 | 0 | 0 | 170 | 33 | 33 | 17 | 119 | 0 | 66 | 53 | 12 | 6 | 6 | 60 | 170 | 0 | 3 | 118 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 140 | 926 | 140 | 154 | 2,770,197,065 | 323,292,691 | 3,093,489,756 | 2,097,152 | 0 | 3 | 89 | 3,495,000 | 46.52 | 
| app_proof | 1 | 124 | 801 | 124 | 41 | 2,768,862,357 | 322,353,414 | 3,091,215,771 | 2,097,152 | 0 | 1 | 103 | 3,495,000 | 50.01 | 
| app_proof | 2 | 127 | 799 | 127 | 41 | 2,768,862,357 | 322,353,414 | 3,091,215,771 | 2,097,152 | 0 | 1 | 98 | 3,495,000 | 50.13 | 
| app_proof | 3 | 175 | 557 | 175 | 41 | 1,230,956,171 | 342,871,578 | 1,573,827,749 | 2,097,152 | 0 | 2 | 43 | 1,515,265 | 50.01 | 

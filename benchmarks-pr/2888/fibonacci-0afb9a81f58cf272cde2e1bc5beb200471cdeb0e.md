...
| `total_proof_time_ms ` |  760 |  3,040 |  914 |  550 |
...
| `execute_preflight_time_ms` |  81.75 |  327 |  101 |  42 |
| `execute_preflight_insn_mi/s` |  49.65 | -          |  50.78 |  46.64 |
| `trace_gen_time_ms   ` |  140.25 |  561 |  173 |  123 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  467.50 |  1,870 |  534 |  293 |
| `prover.main_trace_commit_time_ms` |  97.75 |  391 |  111 |  58 |
| `prover.rap_constraints_time_ms` |  268.75 |  1,075 |  307 |  167 |
| `prover.openings_time_ms` |  99.75 |  399 |  115 |  66 |
| `prover.rap_constraints.logup_gkr_time_ms` |  193.75 |  775 |  220 |  117 |
| `prover.rap_constraints.round0_time_ms` |  50 |  200 |  59 |  32 |
...
| `prover.openings.whir_time_ms` |  81 |  324 |  93 |  54 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/0afb9a81f58cf272cde2e1bc5beb200471cdeb0e/fibonacci-0afb9a81f58cf272cde2e1bc5beb200471cdeb0e.memory.svg)
...
| app_proof |  |  |  |  |  | 550 |  |  | 66 | 12,000,265 | 179.17 | 0 | 3,114 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,747 | 321 | 115 | 0 | 0 | 105 | 34 | 34 | 50 | 20 | 0 | 99 | 85 | 13 | 3 | 9 | 115 | 105 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,767 | 167 | 46 | 0 | 0 | 67 | 25 | 24 | 28 | 13 | 0 | 53 | 44 | 8 | 1 | 6 | 47 | 67 | 0 | 2 | 12 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 134 | 31 | 0 | 0 | 61 | 22 | 22 | 24 | 13 | 0 | 41 | 33 | 7 | 1 | 5 | 32 | 61 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 147,934,246 | 602 | 230 | 0 | 0 | 180 | 82 | 81 | 53 | 44 | 0 | 190 | 166 | 24 | 12 | 12 | 230 | 180 | 0 | 8 | 43 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 136,618,054 | 534 | 110 | 0 | 0 | 307 | 59 | 59 | 27 | 220 | 0 | 115 | 93 | 21 | 12 | 9 | 111 | 307 | 0 | 3 | 219 | 0 | 0 | 
| app_proof | prover | 1 | 136,570,716 | 525 | 111 | 0 | 0 | 302 | 55 | 55 | 26 | 220 | 0 | 111 | 90 | 21 | 11 | 9 | 111 | 302 | 0 | 3 | 219 | 0 | 0 | 
| app_proof | prover | 2 | 136,570,716 | 518 | 111 | 0 | 0 | 299 | 54 | 54 | 26 | 218 | 0 | 107 | 87 | 20 | 11 | 8 | 111 | 299 | 0 | 3 | 217 | 0 | 0 | 
| app_proof | prover | 3 | 70,295,004 | 293 | 58 | 0 | 0 | 167 | 32 | 31 | 17 | 117 | 0 | 66 | 54 | 12 | 6 | 6 | 58 | 167 | 0 | 3 | 116 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 137 | 914 | 137 | 154 | 2,770,197,065 | 323,292,691 | 3,093,489,756 | 2,097,152 | 0 | 3 | 88 | 3,495,000 | 46.64 | 
| app_proof | 1 | 123 | 791 | 123 | 41 | 2,768,862,357 | 322,353,414 | 3,091,215,771 | 2,097,152 | 0 | 1 | 101 | 3,495,000 | 50.53 | 
| app_proof | 2 | 128 | 785 | 128 | 41 | 2,768,862,357 | 322,353,414 | 3,091,215,771 | 2,097,152 | 0 | 1 | 96 | 3,495,000 | 50.78 | 
| app_proof | 3 | 173 | 550 | 173 | 41 | 1,230,956,171 | 342,871,578 | 1,573,827,749 | 2,097,152 | 0 | 2 | 42 | 1,515,265 | 50.63 | 

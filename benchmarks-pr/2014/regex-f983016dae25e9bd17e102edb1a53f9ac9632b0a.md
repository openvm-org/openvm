...
|:---|---:|---:|
| Total |  7.70 |  4.95 |
| regex_program |  7.67 |  4.92 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  3,833.50 |  7,667 |  4,923 |  2,744 |
...
| `execute_metered_insn_mi/s` |  131.33 | -          |  131.33 |  131.33 |
| `execute_preflight_insns` |  2,054,298.50 |  4,108,597 |  2,211,000 |  1,897,597 |
| `execute_preflight_time_ms` |  93 |  186 |  102 |  84 |
| `execute_preflight_insn_mi/s` |  28.38 | -          |  30.76 |  25.100 |
| `trace_gen_time_ms   ` |  378.50 |  757 |  486 |  271 |
| `memory_finalize_time_ms` |  8 |  16 |  14 |  2 |
| `stark_prove_excluding_trace_time_ms` |  3,134.50 |  6,269 |  4,100 |  2,169 |
| `main_trace_commit_time_ms` |  626.50 |  1,253 |  849 |  404 |
| `generate_perm_trace_time_ms` |  243.50 |  487 |  328 |  159 |
| `perm_trace_commit_time_ms` |  650 |  1,300 |  852 |  448 |
| `quotient_poly_compute_time_ms` |  350.50 |  701 |  473 |  228 |
| `quotient_poly_commit_time_ms` |  296 |  592 |  396 |  196 |
| `pcs_opening_time_ms ` |  958.50 |  1,917 |  1,197 |  720 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2,744 | 6 | 1 | 31 | 4,108,597 | 131.33 | 44 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 486 | 4,923 | 211,758,557 | 373,183,036 | 486 | 4,100 | 0 | 473 | 396 | 852 | 1,197 | 7 | 14 | 849 | 91,281,687 | 328 | 102 | 2,211,000 | 25.100 | 
| regex_program | 1 | 271 | 2,744 | 174,326,267 | 196,838,026 | 271 | 2,169 | 50 | 228 | 196 | 448 | 720 | 6 | 2 | 404 | 73,453,305 | 159 | 84 | 1,897,597 | 30.76 | 

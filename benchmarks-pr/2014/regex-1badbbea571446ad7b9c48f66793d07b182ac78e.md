...
| `total_proof_time_ms ` |  3,797.50 |  7,595 |  4,883 |  2,712 |
...
| `execute_preflight_insn_mi/s` |  28.64 | -          |  31.11 |  26.16 |
| `trace_gen_time_ms   ` |  395.50 |  791 |  505 |  286 |
| `memory_finalize_time_ms` |  9.50 |  19 |  17 |  2 |
| `stark_prove_excluding_trace_time_ms` |  3,078 |  6,156 |  4,029 |  2,127 |
| `main_trace_commit_time_ms` |  620.50 |  1,241 |  830 |  411 |
| `generate_perm_trace_time_ms` |  226.50 |  453 |  309 |  144 |
| `perm_trace_commit_time_ms` |  657 |  1,314 |  867 |  447 |
| `quotient_poly_compute_time_ms` |  315 |  630 |  428 |  202 |
| `quotient_poly_commit_time_ms` |  302 |  604 |  400 |  204 |
| `pcs_opening_time_ms ` |  949 |  1,898 |  1,188 |  710 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2,712 | 6 | 1 | 31 | 4,108,597 | 129.23 | 44 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 505 | 4,883 | 211,758,557 | 373,183,036 | 505 | 4,029 | 0 | 428 | 400 | 867 | 1,188 | 8 | 17 | 830 | 91,281,687 | 309 | 104 | 2,211,000 | 26.16 | 
| regex_program | 1 | 286 | 2,712 | 174,326,267 | 196,838,026 | 286 | 2,127 | 54 | 202 | 204 | 447 | 710 | 6 | 2 | 411 | 73,453,305 | 144 | 85 | 1,897,597 | 31.11 | 

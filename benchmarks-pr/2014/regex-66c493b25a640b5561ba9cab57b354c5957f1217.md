...
|:---|---:|---:|
| Total |  7.69 |  4.96 |
| regex_program |  7.66 |  4.93 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  3,828 |  7,656 |  4,931 |  2,725 |
...
| `execute_metered_insn_mi/s` |  131.01 | -          |  131.01 |  131.01 |
| `execute_preflight_insns` |  2,054,298.50 |  4,108,597 |  2,211,000 |  1,897,597 |
| `execute_preflight_time_ms` |  93 |  186 |  101 |  85 |
| `execute_preflight_insn_mi/s` |  28.52 | -          |  30.93 |  26.12 |
| `trace_gen_time_ms   ` |  379.50 |  759 |  488 |  271 |
| `memory_finalize_time_ms` |  7.50 |  15 |  13 |  2 |
| `stark_prove_excluding_trace_time_ms` |  3,123 |  6,246 |  4,100 |  2,146 |
| `main_trace_commit_time_ms` |  629.50 |  1,259 |  837 |  422 |
| `generate_perm_trace_time_ms` |  239 |  478 |  327 |  151 |
| `perm_trace_commit_time_ms` |  650.50 |  1,301 |  852 |  449 |
| `quotient_poly_compute_time_ms` |  317.50 |  635 |  430 |  205 |
| `quotient_poly_commit_time_ms` |  294 |  588 |  393 |  195 |
| `pcs_opening_time_ms ` |  983.50 |  1,967 |  1,252 |  715 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2,725 | 7 | 1 | 31 | 4,108,597 | 131.01 | 45 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 488 | 4,931 | 211,758,557 | 373,183,036 | 488 | 4,100 | 0 | 430 | 393 | 852 | 1,252 | 7 | 13 | 837 | 91,281,687 | 327 | 101 | 2,211,000 | 26.12 | 
| regex_program | 1 | 271 | 2,725 | 174,326,267 | 196,838,026 | 271 | 2,146 | 50 | 205 | 195 | 449 | 715 | 8 | 2 | 422 | 73,453,305 | 151 | 85 | 1,897,597 | 30.93 | 

...
| `total_proof_time_ms ` |  576 |  2,304 |  688 |  526 |
...
| `execute_metered_insn_mi/s` |  110.93 | -          |  110.93 |  110.93 |
| `execute_preflight_insns` |  1,034,378 |  4,137,512 |  1,104,000 |  826,512 |
| `execute_preflight_time_ms` |  53 |  212 |  64 |  45 |
| `execute_preflight_insn_mi/s` |  31.14 | -          |  32.52 |  28.06 |
| `trace_gen_time_ms   ` |  171 |  684 |  184 |  156 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  277.75 |  1,111 |  292 |  263 |
| `main_trace_commit_time_ms` |  51.75 |  207 |  56 |  49 |
| `generate_perm_trace_time_ms` |  27.25 |  109 |  38 |  23 |
| `perm_trace_commit_time_ms` |  65.09 |  260.35 |  72.29 |  54.49 |
| `quotient_poly_compute_time_ms` |  60.48 |  241.91 |  71.52 |  54.37 |
| `quotient_poly_commit_time_ms` |  15.93 |  63.71 |  18.57 |  13.60 |
| `pcs_opening_time_ms ` |  54.25 |  217 |  59 |  49 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 542 | 1 | 37 | 4,137,512 | 110.93 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 180 | 688 | 23,437,436 | 150,778,428 | 180 | 292 | 0 | 61.33 | 18.57 | 5 | 72.29 | 58 | 97 | 57 | 4 | 56 | 10,891,066 | 23 | 46 | 1,103,000 | 28.06 | 22 | 80 | 1 | 57 | 
| regex_program | 1 | 156 | 548 | 11,597,664 | 128,513,066 | 156 | 285 | 1 | 54.37 | 15.40 | 4 | 65.97 | 59 | 104 | 58 | 0 | 51 | 2,195,390 | 38 | 64 | 1,104,000 | 32.52 | 17 | 70 | 0 | 58 | 
| regex_program | 2 | 164 | 526 | 11,579,760 | 128,513,066 | 164 | 263 | 1 | 54.70 | 16.14 | 4 | 67.59 | 49 | 92 | 49 | 0 | 49 | 2,177,774 | 24 | 57 | 1,104,000 | 32.41 | 17 | 71 | 0 | 49 | 
| regex_program | 3 | 184 | 542 | 11,853,280 | 103,456,394 | 184 | 271 | 0 | 71.52 | 13.60 | 5 | 54.49 | 51 | 82 | 51 | 0 | 51 | 2,421,998 | 24 | 45 | 826,512 | 31.56 | 19 | 86 | 1 | 51 | 

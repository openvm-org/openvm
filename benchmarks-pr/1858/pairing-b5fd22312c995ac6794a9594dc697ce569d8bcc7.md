...
|:---|---:|---:|---:|
| Total |  1.52 |  0.93 | 0.93 |
| pairing |  1.52 |  0.93 |  0.93 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  731 |  1,462 |  865 |  597 |
...
| `execute_metered_insn_mi/s` |  27.86 | -          |  27.86 |  27.86 |
| `execute_preflight_insns` |  872,878.50 |  1,745,757 |  1,151,000 |  594,757 |
| `execute_preflight_time_ms` |  84.50 |  169 |  106 |  63 |
| `execute_preflight_insn_mi/s` |  14.79 | -          |  18.32 |  11.26 |
| `trace_gen_time_ms   ` |  183.50 |  367 |  187 |  180 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  357.50 |  715 |  409 |  306 |
| `main_trace_commit_time_ms` |  64 |  128 |  75 |  53 |
| `generate_perm_trace_time_ms` |  44.50 |  89 |  57 |  32 |
| `perm_trace_commit_time_ms` |  76.64 |  153.28 |  88.80 |  64.48 |
| `quotient_poly_compute_time_ms` |  82.32 |  164.64 |  91.59 |  73.05 |
| `quotient_poly_commit_time_ms` |  17.60 |  35.20 |  19.66 |  15.54 |
| `pcs_opening_time_ms ` |  67 |  134 |  72 |  62 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 597 | 1 | 62 | 1,745,757 | 27.86 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 180 | 865 | 32,579,050 | 172,558,444 | 180 | 409 | 0 | 91.59 | 19.66 | 6 | 88.80 | 72 | 149 | 72 | 1 | 75 | 15,992,408 | 57 | 106 | 1,151,000 | 11.26 | 27 | 112 | 1 | 72 | 
| pairing | 1 | 187 | 597 | 22,427,652 | 119,958,502 | 187 | 306 | 1 | 73.05 | 15.54 | 6 | 64.48 | 62 | 100 | 62 | 0 | 53 | 9,471,642 | 32 | 63 | 594,757 | 18.32 | 21 | 89 | 1 | 62 | 

...
| `total_proof_time_ms ` |  578.25 |  2,313 |  688 |  520 |
...
| `execute_preflight_time_ms` |  53.50 |  214 |  66 |  45 |
| `execute_preflight_insn_mi/s` |  31.49 | -          |  32.53 |  28.45 |
| `trace_gen_time_ms   ` |  169 |  676 |  183 |  153 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  282 |  1,128 |  298 |  259 |
| `main_trace_commit_time_ms` |  51.50 |  206 |  58 |  49 |
| `generate_perm_trace_time_ms` |  27.25 |  109 |  39 |  22 |
| `perm_trace_commit_time_ms` |  64.21 |  256.85 |  70.86 |  55.53 |
| `quotient_poly_compute_time_ms` |  59.22 |  236.87 |  69.26 |  52.60 |
| `quotient_poly_commit_time_ms` |  15.82 |  63.27 |  18.25 |  13.69 |
| `pcs_opening_time_ms ` |  60.25 |  241 |  75 |  49 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 546 | 1 | 37 | 4,137,512 | 111.67 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 179 | 688 | 23,437,436 | 150,778,428 | 179 | 294 | 0 | 61.80 | 18.25 | 5 | 70.86 | 60 | 94 | 60 | 4 | 58 | 10,891,066 | 22 | 45 | 1,103,000 | 28.45 | 22 | 80 | 1 | 60 | 
| regex_program | 1 | 153 | 559 | 11,597,664 | 128,513,066 | 153 | 298 | 1 | 53.20 | 15.20 | 4 | 64.32 | 75 | 103 | 75 | 0 | 49 | 2,195,390 | 39 | 66 | 1,104,000 | 32.53 | 16 | 68 | 0 | 75 | 
| regex_program | 2 | 161 | 520 | 11,579,760 | 128,513,066 | 161 | 259 | 1 | 52.60 | 16.13 | 4 | 66.14 | 49 | 90 | 49 | 0 | 49 | 2,177,774 | 23 | 58 | 1,104,000 | 32.50 | 17 | 69 | 0 | 49 | 
| regex_program | 3 | 183 | 546 | 11,853,280 | 103,456,394 | 183 | 277 | 0 | 69.26 | 13.69 | 5 | 55.53 | 57 | 84 | 57 | 0 | 50 | 2,421,998 | 25 | 45 | 826,512 | 32.49 | 19 | 84 | 1 | 57 | 
...
Commit: https://github.com/openvm-org/openvm/commit/d340e1335063163d7158fa1ffc4fd0624d39ec44
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/20545836470)

...
| `total_proof_time_ms ` |  717 |  1,434 |  837 |  597 |
...
| `execute_preflight_insn_mi/s` |  14.67 | -          |  18.11 |  11.23 |
| `trace_gen_time_ms   ` |  185 |  370 |  191 |  179 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  344 |  688 |  383 |  305 |
| `main_trace_commit_time_ms` |  64 |  128 |  74 |  54 |
| `generate_perm_trace_time_ms` |  36.50 |  73 |  37 |  36 |
| `perm_trace_commit_time_ms` |  76.59 |  153.18 |  88.39 |  64.79 |
| `quotient_poly_compute_time_ms` |  82.79 |  165.57 |  91.54 |  74.03 |
| `quotient_poly_commit_time_ms` |  17.04 |  34.08 |  18.92 |  15.16 |
| `pcs_opening_time_ms ` |  62 |  124 |  69 |  55 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 597 | 1 | 63 | 1,745,757 | 27.57 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 179 | 837 | 32,579,050 | 172,558,444 | 179 | 383 | 0 | 91.54 | 18.92 | 6 | 88.39 | 69 | 127 | 69 | 1 | 74 | 15,992,408 | 36 | 106 | 1,151,000 | 11.23 | 26 | 111 | 1 | 69 | 
| pairing | 1 | 191 | 597 | 22,427,652 | 119,958,502 | 191 | 305 | 1 | 74.03 | 15.16 | 6 | 64.79 | 55 | 104 | 55 | 0 | 54 | 9,471,642 | 37 | 60 | 594,757 | 18.11 | 20 | 89 | 1 | 55 | 

...
|:---|---:|---:|---:|
| Total |  1.03 |  0.60 | 0.60 |
| fibonacci_program |  1.03 |  0.60 |  0.60 |


| fibonacci_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  509.50 |  1,019 |  589 |  430 |
...
| `execute_preflight_insn_mi/s` |  37.38 | -          |  40.07 |  34.70 |
| `trace_gen_time_ms   ` |  194 |  388 |  199 |  189 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  181 |  362 |  195 |  167 |
| `main_trace_commit_time_ms` |  31 |  62 |  33 |  29 |
| `generate_perm_trace_time_ms` |  16 |  32 |  18 |  14 |
| `perm_trace_commit_time_ms` |  41.35 |  82.71 |  44.27 |  38.44 |
| `quotient_poly_compute_time_ms` |  32.46 |  64.92 |  33.93 |  30.99 |
| `quotient_poly_commit_time_ms` |  12.75 |  25.49 |  13.12 |  12.37 |
| `pcs_opening_time_ms ` |  46 |  92 |  51 |  41 |
...
| --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 430 | 1 | 13 | 1,500,269 | 110.60 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 199 | 589 | 9,680,746 | 84,399,632 | 199 | 195 | 0 | 33.93 | 13.12 | 4 | 44.27 | 51 | 63 | 51 | 0 | 33 | 1,038,336 | 18 | 26 | 873,000 | 34.70 | 14 | 47 | 0 | 51 | 
| fibonacci_program | 1 | 189 | 430 | 9,708,456 | 74,305,770 | 189 | 167 | 1 | 30.99 | 12.37 | 4 | 38.44 | 41 | 53 | 41 | 0 | 29 | 1,064,414 | 14 | 32 | 627,269 | 40.07 | 11 | 43 | 0 | 41 | 

...
|:---|---:|---:|---:|
| Total |  1.13 |  0.67 | 0.67 |
| fibonacci_program |  1.13 |  0.67 |  0.67 |


| fibonacci_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  558 |  1,116 |  657 |  459 |
...
| `execute_metered_insn_mi/s` |  111.10 | -          |  111.10 |  111.10 |
| `execute_preflight_insns` |  750,134.50 |  1,500,269 |  873,000 |  627,269 |
| `execute_preflight_time_ms` |  29.50 |  59 |  33 |  26 |
| `execute_preflight_insn_mi/s` |  35.96 | -          |  38.16 |  33.75 |
| `trace_gen_time_ms   ` |  192.50 |  385 |  198 |  187 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  229.50 |  459 |  262 |  197 |
| `main_trace_commit_time_ms` |  30.50 |  61 |  33 |  28 |
| `generate_perm_trace_time_ms` |  16.50 |  33 |  20 |  13 |
| `perm_trace_commit_time_ms` |  42.13 |  84.26 |  44.20 |  40.06 |
| `quotient_poly_compute_time_ms` |  33.10 |  66.21 |  36.16 |  30.05 |
| `quotient_poly_commit_time_ms` |  12.47 |  24.94 |  12.93 |  12.01 |
| `pcs_opening_time_ms ` |  92 |  184 |  113 |  71 |
...
| --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 459 | 1 | 13 | 1,500,269 | 111.10 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 198 | 657 | 9,680,746 | 84,399,632 | 198 | 262 | 0 | 36.16 | 12.93 | 4 | 44.20 | 113 | 65 | 113 | 0 | 33 | 1,038,336 | 20 | 26 | 873,000 | 33.75 | 14 | 49 | 0 | 113 | 
| fibonacci_program | 1 | 187 | 459 | 9,708,456 | 74,305,770 | 187 | 197 | 1 | 30.05 | 12.01 | 4 | 40.06 | 71 | 53 | 71 | 0 | 28 | 1,064,414 | 13 | 33 | 627,269 | 38.16 | 11 | 42 | 0 | 71 | 

...
|:---|---:|---:|---:|
| Total |  1.05 |  0.62 | 0.62 |
| fibonacci_program |  1.05 |  0.62 |  0.62 |


| fibonacci_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  517.50 |  1,035 |  611 |  424 |
...
| `execute_metered_insn_mi/s` |  110.31 | -          |  110.31 |  110.31 |
| `execute_preflight_insns` |  750,134.50 |  1,500,269 |  873,000 |  627,269 |
| `execute_preflight_time_ms` |  31 |  62 |  35 |  27 |
| `execute_preflight_insn_mi/s` |  36.70 | -          |  39.85 |  33.55 |
| `trace_gen_time_ms   ` |  188 |  376 |  195 |  181 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  189.50 |  379 |  213 |  166 |
| `main_trace_commit_time_ms` |  30.50 |  61 |  33 |  28 |
| `generate_perm_trace_time_ms` |  15.50 |  31 |  17 |  14 |
| `perm_trace_commit_time_ms` |  41.84 |  83.69 |  45.39 |  38.30 |
| `quotient_poly_compute_time_ms` |  32.55 |  65.10 |  34.87 |  30.23 |
| `quotient_poly_commit_time_ms` |  12.24 |  24.48 |  12.85 |  11.63 |
| `pcs_opening_time_ms ` |  54.50 |  109 |  67 |  42 |
...
| --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 424 | 1 | 13 | 1,500,269 | 110.31 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 195 | 611 | 9,680,746 | 84,399,632 | 195 | 213 | 0 | 34.87 | 12.85 | 5 | 45.39 | 67 | 63 | 67 | 0 | 33 | 1,038,336 | 17 | 27 | 873,000 | 33.55 | 15 | 48 | 0 | 67 | 
| fibonacci_program | 1 | 181 | 424 | 9,708,456 | 74,305,770 | 181 | 166 | 1 | 30.23 | 11.63 | 4 | 38.30 | 42 | 53 | 41 | 0 | 28 | 1,064,414 | 14 | 35 | 627,269 | 39.85 | 11 | 42 | 0 | 41 | 

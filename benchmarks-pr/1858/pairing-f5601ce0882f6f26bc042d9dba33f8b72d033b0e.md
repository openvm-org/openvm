...
|:---|---:|---:|---:|
| Total |  1.58 |  0.95 | 0.95 |
| pairing |  1.58 |  0.95 |  0.95 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  757.50 |  1,515 |  883 |  632 |
...
| `execute_preflight_insn_mi/s` |  14.72 | -          |  18.17 |  11.27 |
| `trace_gen_time_ms   ` |  185.50 |  371 |  190 |  181 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  382.50 |  765 |  427 |  338 |
| `main_trace_commit_time_ms` |  65.50 |  131 |  76 |  55 |
| `generate_perm_trace_time_ms` |  56.50 |  113 |  72 |  41 |
| `perm_trace_commit_time_ms` |  76.58 |  153.15 |  89.01 |  64.14 |
| `quotient_poly_compute_time_ms` |  85.35 |  170.70 |  95.07 |  75.62 |
| `quotient_poly_commit_time_ms` |  17.28 |  34.56 |  19.65 |  14.91 |
| `pcs_opening_time_ms ` |  77 |  154 |  83 |  71 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 632 | 1 | 63 | 1,745,757 | 27.57 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 181 | 883 | 32,579,050 | 172,558,444 | 181 | 427 | 0 | 95.07 | 19.65 | 6 | 89.01 | 71 | 164 | 70 | 1 | 76 | 15,992,408 | 72 | 105 | 1,151,000 | 11.27 | 27 | 115 | 1 | 70 | 
| pairing | 1 | 190 | 632 | 22,427,652 | 119,958,502 | 190 | 338 | 1 | 75.62 | 14.91 | 5 | 64.14 | 83 | 108 | 83 | 0 | 55 | 9,471,642 | 41 | 61 | 594,757 | 18.17 | 21 | 91 | 1 | 83 | 

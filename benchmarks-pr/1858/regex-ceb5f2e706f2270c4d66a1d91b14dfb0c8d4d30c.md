...
| `total_proof_time_ms ` |  581.75 |  2,327 |  698 |  528 |
...
| `execute_metered_insn_mi/s` |  111.91 | -          |  111.91 |  111.91 |
| `execute_preflight_insns` |  1,034,378 |  4,137,512 |  1,104,000 |  826,512 |
| `execute_preflight_time_ms` |  53.50 |  214 |  65 |  45 |
| `execute_preflight_insn_mi/s` |  31.24 | -          |  32.44 |  28.23 |
| `trace_gen_time_ms   ` |  172.75 |  691 |  186 |  158 |
| `memory_finalize_time_ms` |  1.25 |  5 |  5 |  0 |
| `stark_prove_excluding_trace_time_ms` |  281.50 |  1,126 |  300 |  263 |
| `main_trace_commit_time_ms` |  52.25 |  209 |  57 |  50 |
| `generate_perm_trace_time_ms` |  27.50 |  110 |  39 |  23 |
| `perm_trace_commit_time_ms` |  65.26 |  261.05 |  73.03 |  55.21 |
| `quotient_poly_compute_time_ms` |  60.79 |  243.16 |  69.83 |  54.79 |
| `quotient_poly_commit_time_ms` |  16.27 |  65.08 |  18.60 |  13.30 |
| `pcs_opening_time_ms ` |  56.50 |  226 |  61 |  50 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 548 | 1 | 36 | 4,137,512 | 111.91 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 182 | 698 | 23,437,436 | 150,778,428 | 182 | 300 | 0 | 63.71 | 18.60 | 5 | 73.03 | 61 | 97 | 61 | 5 | 57 | 10,891,066 | 23 | 46 | 1,103,000 | 28.23 | 22 | 83 | 1 | 61 | 
| regex_program | 1 | 158 | 553 | 11,597,664 | 128,513,066 | 158 | 288 | 1 | 54.83 | 16.56 | 4 | 66.10 | 59 | 105 | 59 | 0 | 51 | 2,195,390 | 39 | 65 | 1,104,000 | 32.03 | 17 | 71 | 0 | 59 | 
| regex_program | 2 | 165 | 528 | 11,579,760 | 128,513,066 | 165 | 263 | 1 | 54.79 | 16.62 | 4 | 66.71 | 50 | 90 | 50 | 0 | 50 | 2,177,774 | 23 | 58 | 1,104,000 | 32.44 | 17 | 72 | 0 | 50 | 
| regex_program | 3 | 186 | 548 | 11,853,280 | 103,456,394 | 186 | 275 | 0 | 69.83 | 13.30 | 5 | 55.21 | 56 | 83 | 56 | 0 | 51 | 2,421,998 | 25 | 45 | 826,512 | 32.27 | 18 | 84 | 1 | 56 | 
...
Commit: https://github.com/openvm-org/openvm/commit/ceb5f2e706f2270c4d66a1d91b14dfb0c8d4d30c
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/20546886052)

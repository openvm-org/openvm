...
| `total_proof_time_ms ` |  723.50 |  1,447 |  848 |  599 |
...
| `execute_metered_insn_mi/s` |  27.39 | -          |  27.39 |  27.39 |
| `execute_preflight_insns` |  872,878.50 |  1,745,757 |  1,151,000 |  594,757 |
| `execute_preflight_time_ms` |  83.50 |  167 |  106 |  61 |
| `execute_preflight_insn_mi/s` |  14.55 | -          |  17.93 |  11.17 |
| `trace_gen_time_ms   ` |  185 |  370 |  190 |  180 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  349.50 |  699 |  392 |  307 |
| `main_trace_commit_time_ms` |  64 |  128 |  75 |  53 |
| `generate_perm_trace_time_ms` |  36.50 |  73 |  37 |  36 |
| `perm_trace_commit_time_ms` |  77.42 |  154.84 |  90.60 |  64.25 |
| `quotient_poly_compute_time_ms` |  84.66 |  169.32 |  94.55 |  74.78 |
| `quotient_poly_commit_time_ms` |  17.94 |  35.87 |  20.14 |  15.73 |
| `pcs_opening_time_ms ` |  64 |  128 |  71 |  57 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 599 | 1 | 63 | 1,745,757 | 27.39 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 180 | 848 | 32,579,050 | 172,558,444 | 180 | 392 | 0 | 94.55 | 20.14 | 6 | 90.60 | 71 | 129 | 71 | 1 | 75 | 15,992,408 | 36 | 106 | 1,151,000 | 11.17 | 27 | 115 | 1 | 71 | 
| pairing | 1 | 190 | 599 | 22,427,652 | 119,958,502 | 190 | 307 | 1 | 74.78 | 15.73 | 6 | 64.25 | 57 | 104 | 57 | 0 | 53 | 9,471,642 | 37 | 61 | 594,757 | 17.93 | 21 | 91 | 1 | 57 | 
...
Commit: https://github.com/openvm-org/openvm/commit/edd189a665b4d19427e98c0c379b1d4e93cae9cc
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/20546181869)

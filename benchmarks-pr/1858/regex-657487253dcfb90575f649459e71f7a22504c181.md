...
|:---|---:|---:|---:|
| Total |  2.35 |  0.73 | 0.73 |
| regex_program |  2.35 |  0.73 |  0.73 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  577.25 |  2,309 |  692 |  532 |
...
| `execute_preflight_insn_mi/s` |  31.70 | -          |  32.85 |  28.65 |
| `trace_gen_time_ms   ` |  172.25 |  689 |  185 |  156 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  278.25 |  1,113 |  294 |  268 |
| `main_trace_commit_time_ms` |  52.25 |  209 |  57 |  50 |
| `generate_perm_trace_time_ms` |  29.75 |  119 |  39 |  26 |
| `perm_trace_commit_time_ms` |  64.49 |  257.98 |  72.06 |  55.81 |
| `quotient_poly_compute_time_ms` |  58.25 |  233.01 |  69.60 |  48.96 |
| `quotient_poly_commit_time_ms` |  15.81 |  63.23 |  17.69 |  13.82 |
| `pcs_opening_time_ms ` |  54.75 |  219 |  59 |  47 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 547 | 1 | 36 | 4,137,512 | 113.71 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 183 | 692 | 23,437,436 | 150,778,428 | 183 | 294 | 0 | 59.83 | 17.69 | 5 | 72.06 | 57 | 100 | 56 | 4 | 57 | 10,891,066 | 27 | 45 | 1,103,000 | 28.65 | 22 | 78 | 1 | 56 | 
| regex_program | 1 | 156 | 538 | 11,597,664 | 128,513,066 | 156 | 275 | 1 | 54.61 | 15.95 | 4 | 65.81 | 47 | 105 | 47 | 0 | 51 | 2,195,390 | 39 | 65 | 1,104,000 | 32.64 | 17 | 71 | 0 | 47 | 
| regex_program | 2 | 165 | 532 | 11,579,760 | 128,513,066 | 165 | 268 | 1 | 48.96 | 15.77 | 5 | 64.30 | 59 | 92 | 58 | 0 | 51 | 2,177,774 | 27 | 57 | 1,104,000 | 32.85 | 17 | 65 | 0 | 58 | 
| regex_program | 3 | 185 | 547 | 11,853,280 | 103,456,394 | 185 | 276 | 0 | 69.60 | 13.82 | 5 | 55.81 | 56 | 85 | 55 | 0 | 50 | 2,421,998 | 26 | 44 | 826,512 | 32.67 | 19 | 84 | 1 | 55 | 
...
Commit: https://github.com/openvm-org/openvm/commit/657487253dcfb90575f649459e71f7a22504c181
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/20612209580)

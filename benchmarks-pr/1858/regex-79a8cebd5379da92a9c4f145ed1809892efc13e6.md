...
|:---|---:|---:|---:|
| Total |  2.32 |  0.73 | 0.73 |
| regex_program |  2.32 |  0.73 |  0.73 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  572 |  2,288 |  692 |  522 |
...
| `execute_preflight_time_ms` |  53.25 |  213 |  66 |  44 |
| `execute_preflight_insn_mi/s` |  31.75 | -          |  32.91 |  28.67 |
| `trace_gen_time_ms   ` |  171.75 |  687 |  184 |  155 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  273.50 |  1,094 |  295 |  258 |
| `main_trace_commit_time_ms` |  51.75 |  207 |  58 |  49 |
| `generate_perm_trace_time_ms` |  27.75 |  111 |  38 |  21 |
| `perm_trace_commit_time_ms` |  63.92 |  255.70 |  70.51 |  54.76 |
| `quotient_poly_compute_time_ms` |  60.71 |  242.86 |  72.08 |  53.87 |
| `quotient_poly_commit_time_ms` |  15.66 |  62.64 |  18.42 |  13.77 |
| `pcs_opening_time_ms ` |  50.75 |  203 |  56 |  46 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 542 | 1 | 36 | 4,137,512 | 112.44 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 183 | 692 | 23,437,436 | 150,778,428 | 183 | 295 | 0 | 62.81 | 18.42 | 5 | 70.51 | 56 | 98 | 55 | 4 | 58 | 10,891,066 | 27 | 45 | 1,103,000 | 28.67 | 21 | 81 | 1 | 55 | 
| regex_program | 1 | 155 | 532 | 11,597,664 | 128,513,066 | 155 | 270 | 1 | 54.10 | 15.21 | 4 | 64.38 | 46 | 103 | 46 | 0 | 49 | 2,195,390 | 38 | 66 | 1,104,000 | 32.63 | 16 | 69 | 0 | 46 | 
| regex_program | 2 | 165 | 522 | 11,579,760 | 128,513,066 | 165 | 258 | 1 | 53.87 | 15.23 | 4 | 66.05 | 49 | 87 | 49 | 0 | 51 | 2,177,774 | 21 | 58 | 1,104,000 | 32.79 | 17 | 69 | 0 | 49 | 
| regex_program | 3 | 184 | 542 | 11,853,280 | 103,456,394 | 184 | 271 | 0 | 72.08 | 13.77 | 5 | 54.76 | 52 | 83 | 52 | 0 | 49 | 2,421,998 | 25 | 44 | 826,512 | 32.91 | 19 | 86 | 1 | 52 | 

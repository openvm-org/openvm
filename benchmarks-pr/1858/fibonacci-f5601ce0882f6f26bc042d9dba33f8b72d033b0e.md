...
| `total_proof_time_ms ` |  519 |  1,038 |  586 |  452 |
...
| `execute_preflight_time_ms` |  28 |  56 |  31 |  25 |
| `execute_preflight_insn_mi/s` |  38.04 | -          |  40.81 |  35.26 |
| `trace_gen_time_ms   ` |  189.50 |  379 |  194 |  185 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  195.50 |  391 |  198 |  193 |
| `main_trace_commit_time_ms` |  30 |  60 |  32 |  28 |
| `generate_perm_trace_time_ms` |  16 |  32 |  19 |  13 |
| `perm_trace_commit_time_ms` |  40.35 |  80.69 |  43.04 |  37.65 |
| `quotient_poly_compute_time_ms` |  31.86 |  63.71 |  33.70 |  30.01 |
| `quotient_poly_commit_time_ms` |  12.34 |  24.67 |  12.49 |  12.18 |
| `pcs_opening_time_ms ` |  63 |  126 |  71 |  55 |
...
| --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 452 | 1 | 13 | 1,500,269 | 113.66 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 194 | 586 | 9,680,746 | 84,399,632 | 194 | 198 | 0 | 33.70 | 12.49 | 5 | 43.04 | 55 | 63 | 55 | 0 | 32 | 1,038,336 | 19 | 25 | 873,000 | 35.26 | 14 | 46 | 0 | 55 | 
| fibonacci_program | 1 | 185 | 452 | 9,708,456 | 74,305,770 | 185 | 193 | 1 | 30.01 | 12.18 | 4 | 37.65 | 71 | 51 | 71 | 0 | 28 | 1,064,414 | 13 | 31 | 627,269 | 40.81 | 11 | 42 | 0 | 71 | 
...
Commit: https://github.com/openvm-org/openvm/commit/f5601ce0882f6f26bc042d9dba33f8b72d033b0e
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/20612562888)

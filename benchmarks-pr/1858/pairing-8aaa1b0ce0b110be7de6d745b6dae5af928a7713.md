...
|:---|---:|---:|---:|
| Total |  1.53 |  0.91 | 0.91 |
| pairing |  1.53 |  0.91 |  0.91 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  733 |  1,466 |  848 |  618 |
...
| `execute_metered_insn_mi/s` |  27.58 | -          |  27.58 |  27.58 |
| `execute_preflight_insns` |  872,878.50 |  1,745,757 |  1,151,000 |  594,757 |
| `execute_preflight_time_ms` |  83 |  166 |  106 |  60 |
| `execute_preflight_insn_mi/s` |  14.60 | -          |  17.98 |  11.23 |
| `trace_gen_time_ms   ` |  185.50 |  371 |  191 |  180 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  359.50 |  719 |  393 |  326 |
| `main_trace_commit_time_ms` |  64 |  128 |  75 |  53 |
| `generate_perm_trace_time_ms` |  45.50 |  91 |  53 |  38 |
| `perm_trace_commit_time_ms` |  76.72 |  153.44 |  89.15 |  64.29 |
| `quotient_poly_compute_time_ms` |  83.03 |  166.05 |  91.73 |  74.32 |
| `quotient_poly_commit_time_ms` |  17.73 |  35.46 |  19.88 |  15.58 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 618 | 1 | 63 | 1,745,757 | 27.58 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 180 | 848 | 32,579,050 | 172,558,444 | 180 | 393 | 0 | 91.73 | 19.88 | 6 | 89.15 | 74 | 131 | 73 | 1 | 75 | 15,992,408 | 38 | 106 | 1,151,000 | 11.23 | 27 | 112 | 1 | 73 | 
| pairing | 1 | 191 | 618 | 22,427,652 | 119,958,502 | 191 | 326 | 1 | 74.32 | 15.58 | 6 | 64.29 | 60 | 120 | 60 | 0 | 53 | 9,471,642 | 53 | 60 | 594,757 | 17.98 | 21 | 90 | 1 | 60 | 

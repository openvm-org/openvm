...
| `total_proof_time_ms ` |  3,828.50 |  7,657 |  4,914 |  2,743 |
...
| `execute_preflight_insn_mi/s` |  27.61 | -          |  29.78 |  25.44 |
| `trace_gen_time_ms   ` |  391.50 |  783 |  506 |  277 |
| `memory_finalize_time_ms` |  9 |  18 |  16 |  2 |
| `stark_prove_excluding_trace_time_ms` |  3,110.50 |  6,221 |  4,058 |  2,163 |
| `main_trace_commit_time_ms` |  633.50 |  1,267 |  849 |  418 |
| `generate_perm_trace_time_ms` |  236 |  472 |  319 |  153 |
| `perm_trace_commit_time_ms` |  660 |  1,320 |  865 |  455 |
| `quotient_poly_compute_time_ms` |  308.50 |  617 |  421 |  196 |
| `quotient_poly_commit_time_ms` |  302 |  604 |  399 |  205 |
| `pcs_opening_time_ms ` |  960 |  1,920 |  1,199 |  721 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2,743 | 6 | 4,108,597 | 1 | 32 | 127.66 | 43 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 506 | 4,914 | 211,758,557 | 373,183,036 | 506 | 4,058 | 0 | 421 | 399 | 865 | 1,199 | 7 | 16 | 849 | 91,281,687 | 2,211,000 | 319 | 106 | 25.44 | 
| regex_program | 1 | 277 | 2,743 | 174,326,267 | 196,838,026 | 277 | 2,163 | 52 | 196 | 205 | 455 | 721 | 6 | 2 | 418 | 73,453,305 | 1,897,597 | 153 | 90 | 29.78 | 

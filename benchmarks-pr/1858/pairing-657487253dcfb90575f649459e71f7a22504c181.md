...
| `total_proof_time_ms ` |  741.50 |  1,483 |  881 |  602 |
...
| `execute_preflight_insn_mi/s` |  14.67 | -          |  18.05 |  11.28 |
| `trace_gen_time_ms   ` |  184 |  368 |  188 |  180 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  368.50 |  737 |  427 |  310 |
| `main_trace_commit_time_ms` |  63 |  126 |  71 |  55 |
| `generate_perm_trace_time_ms` |  61.50 |  123 |  80 |  43 |
| `perm_trace_commit_time_ms` |  76.46 |  152.92 |  88.34 |  64.58 |
| `quotient_poly_compute_time_ms` |  82.45 |  164.89 |  91.53 |  73.36 |
| `quotient_poly_commit_time_ms` |  16.77 |  33.54 |  18.52 |  15.02 |
| `pcs_opening_time_ms ` |  64 |  128 |  73 |  55 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 602 | 1 | 62 | 1,745,757 | 27.86 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 180 | 881 | 32,579,050 | 172,558,444 | 180 | 427 | 0 | 91.53 | 18.52 | 6 | 88.34 | 73 | 171 | 73 | 1 | 71 | 15,992,408 | 80 | 105 | 1,151,000 | 11.28 | 26 | 110 | 1 | 73 | 
| pairing | 1 | 188 | 602 | 22,427,652 | 119,958,502 | 188 | 310 | 1 | 73.36 | 15.02 | 6 | 64.58 | 55 | 110 | 55 | 0 | 55 | 9,471,642 | 43 | 62 | 594,757 | 18.05 | 21 | 88 | 1 | 55 | 

...
|:---|---:|---:|---:|
| Total |  2.41 |  0.73 | 0.73 |
| regex_program |  2.41 |  0.73 |  0.73 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  592.75 |  2,371 |  692 |  541 |
...
| `execute_preflight_time_ms` |  54.25 |  217 |  68 |  45 |
| `execute_preflight_insn_mi/s` |  31.46 | -          |  32.73 |  28.14 |
| `trace_gen_time_ms   ` |  170.50 |  682 |  185 |  153 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  294 |  1,176 |  303 |  278 |
| `main_trace_commit_time_ms` |  52 |  208 |  58 |  49 |
| `generate_perm_trace_time_ms` |  36 |  144 |  45 |  28 |
| `perm_trace_commit_time_ms` |  64.66 |  258.62 |  72.75 |  54.46 |
| `quotient_poly_compute_time_ms` |  60.33 |  241.33 |  72.62 |  54.52 |
| `quotient_poly_commit_time_ms` |  15.64 |  62.57 |  17.40 |  13.73 |
| `pcs_opening_time_ms ` |  62.25 |  249 |  70 |  57 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 572 | 1 | 36 | 4,137,512 | 113.88 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 181 | 692 | 23,437,436 | 150,778,428 | 181 | 295 | 0 | 59.49 | 17.40 | 5 | 72.75 | 57 | 101 | 57 | 4 | 58 | 10,891,066 | 28 | 46 | 1,103,000 | 28.14 | 22 | 77 | 1 | 57 | 
| regex_program | 1 | 153 | 566 | 11,597,664 | 128,513,066 | 153 | 303 | 1 | 54.69 | 15.08 | 5 | 64.89 | 70 | 111 | 70 | 0 | 51 | 2,195,390 | 45 | 68 | 1,104,000 | 32.73 | 17 | 70 | 0 | 70 | 
| regex_program | 2 | 163 | 541 | 11,579,760 | 128,513,066 | 163 | 278 | 1 | 54.52 | 16.36 | 5 | 66.52 | 58 | 97 | 58 | 0 | 50 | 2,177,774 | 30 | 58 | 1,104,000 | 32.49 | 17 | 71 | 0 | 58 | 
| regex_program | 3 | 185 | 572 | 11,853,280 | 103,456,394 | 185 | 300 | 0 | 72.62 | 13.73 | 5 | 54.46 | 64 | 99 | 63 | 0 | 49 | 2,421,998 | 41 | 45 | 826,512 | 32.50 | 19 | 87 | 1 | 63 | 

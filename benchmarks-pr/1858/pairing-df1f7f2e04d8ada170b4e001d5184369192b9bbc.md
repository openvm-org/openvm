...
| `total_proof_time_ms ` |  728.50 |  1,457 |  851 |  606 |
...
| `execute_preflight_time_ms` |  82.50 |  165 |  106 |  59 |
| `execute_preflight_insn_mi/s` |  14.70 | -          |  18.17 |  11.23 |
| `trace_gen_time_ms   ` |  187 |  374 |  193 |  181 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  354.50 |  709 |  397 |  312 |
| `main_trace_commit_time_ms` |  65 |  130 |  75 |  55 |
| `generate_perm_trace_time_ms` |  45.50 |  91 |  48 |  43 |
| `perm_trace_commit_time_ms` |  75.94 |  151.89 |  88.60 |  63.29 |
| `quotient_poly_compute_time_ms` |  83.84 |  167.68 |  93.31 |  74.37 |
| `quotient_poly_commit_time_ms` |  17.45 |  34.91 |  19.57 |  15.33 |
| `pcs_opening_time_ms ` |  61 |  122 |  66 |  56 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 606 | 1 | 63 | 1,745,757 | 27.56 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 181 | 851 | 32,579,050 | 172,558,444 | 181 | 397 | 0 | 93.31 | 19.57 | 6 | 88.60 | 66 | 140 | 66 | 1 | 75 | 15,992,408 | 48 | 106 | 1,151,000 | 11.23 | 27 | 113 | 1 | 66 | 
| pairing | 1 | 193 | 606 | 22,427,652 | 119,958,502 | 193 | 312 | 1 | 74.37 | 15.33 | 6 | 63.29 | 56 | 110 | 56 | 0 | 55 | 9,471,642 | 43 | 59 | 594,757 | 18.17 | 21 | 90 | 1 | 56 | 

...
|:---|---:|---:|---:|
| Total |  1.56 |  0.94 | 0.94 |
| pairing |  1.56 |  0.94 |  0.94 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  751.50 |  1,503 |  874 |  629 |
...
| `execute_metered_insn_mi/s` |  27.74 | -          |  27.74 |  27.74 |
| `execute_preflight_insns` |  872,878.50 |  1,745,757 |  1,151,000 |  594,757 |
| `execute_preflight_time_ms` |  84 |  168 |  106 |  62 |
| `execute_preflight_insn_mi/s` |  14.71 | -          |  18.16 |  11.26 |
| `trace_gen_time_ms   ` |  182 |  364 |  188 |  176 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  380.50 |  761 |  423 |  338 |
| `main_trace_commit_time_ms` |  64 |  128 |  74 |  54 |
| `generate_perm_trace_time_ms` |  40.50 |  81 |  49 |  32 |
| `perm_trace_commit_time_ms` |  76.68 |  153.35 |  88.62 |  64.73 |
| `quotient_poly_compute_time_ms` |  83.35 |  166.70 |  92.89 |  73.81 |
| `quotient_poly_commit_time_ms` |  17.41 |  34.82 |  19.85 |  14.96 |
| `pcs_opening_time_ms ` |  94.50 |  189 |  95 |  94 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 629 | 1 | 62 | 1,745,757 | 27.74 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 176 | 874 | 32,579,050 | 172,558,444 | 176 | 423 | 0 | 92.89 | 19.85 | 6 | 88.62 | 94 | 141 | 93 | 1 | 74 | 15,992,408 | 49 | 106 | 1,151,000 | 11.26 | 27 | 113 | 1 | 93 | 
| pairing | 1 | 188 | 629 | 22,427,652 | 119,958,502 | 188 | 338 | 1 | 73.81 | 14.96 | 6 | 64.73 | 95 | 99 | 94 | 0 | 54 | 9,471,642 | 32 | 62 | 594,757 | 18.16 | 21 | 89 | 1 | 94 | 

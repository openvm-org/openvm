...
|:---|---:|---:|---:|
| Total |  1.58 |  0.94 | 0.94 |
| pairing |  1.58 |  0.94 |  0.94 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  758.50 |  1,517 |  875 |  642 |
...
| `execute_preflight_time_ms` |  85.50 |  171 |  106 |  65 |
| `execute_preflight_insn_mi/s` |  14.67 | -          |  18.10 |  11.23 |
| `trace_gen_time_ms   ` |  187 |  374 |  191 |  183 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  379.50 |  759 |  415 |  344 |
| `main_trace_commit_time_ms` |  66.50 |  133 |  77 |  56 |
| `generate_perm_trace_time_ms` |  36 |  72 |  40 |  32 |
| `perm_trace_commit_time_ms` |  78 |  156.01 |  89.56 |  66.44 |
| `quotient_poly_compute_time_ms` |  83.70 |  167.39 |  92.74 |  74.65 |
| `quotient_poly_commit_time_ms` |  17.06 |  34.12 |  18.64 |  15.47 |
| `pcs_opening_time_ms ` |  93.50 |  187 |  95 |  92 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 642 | 1 | 63 | 1,745,757 | 27.53 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 183 | 875 | 32,579,050 | 172,558,444 | 183 | 415 | 0 | 92.74 | 18.64 | 6 | 89.56 | 92 | 133 | 92 | 1 | 77 | 15,992,408 | 40 | 106 | 1,151,000 | 11.23 | 27 | 112 | 1 | 92 | 
| pairing | 1 | 191 | 642 | 22,427,652 | 119,958,502 | 191 | 344 | 1 | 74.65 | 15.47 | 6 | 66.44 | 95 | 101 | 95 | 0 | 56 | 9,471,642 | 32 | 65 | 594,757 | 18.10 | 21 | 90 | 1 | 95 | 

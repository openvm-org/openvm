...
| `total_proof_time_ms ` |  739 |  1,478 |  868 |  610 |
...
| `execute_preflight_insn_mi/s` |  14.53 | -          |  17.81 |  11.25 |
| `trace_gen_time_ms   ` |  184.50 |  369 |  191 |  178 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  365.50 |  731 |  414 |  317 |
| `main_trace_commit_time_ms` |  64.50 |  129 |  75 |  54 |
| `generate_perm_trace_time_ms` |  50 |  100 |  53 |  47 |
| `perm_trace_commit_time_ms` |  76.32 |  152.64 |  88.20 |  64.44 |
| `quotient_poly_compute_time_ms` |  83.07 |  166.13 |  92.66 |  73.47 |
| `quotient_poly_commit_time_ms` |  16.81 |  33.61 |  18.58 |  15.03 |
| `pcs_opening_time_ms ` |  70 |  140 |  88 |  52 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 610 | 1 | 63 | 1,745,757 | 27.54 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 178 | 868 | 32,579,050 | 172,558,444 | 178 | 414 | 0 | 92.66 | 18.58 | 6 | 88.20 | 88 | 139 | 87 | 1 | 75 | 15,992,408 | 47 | 106 | 1,151,000 | 11.25 | 27 | 112 | 1 | 87 | 
| pairing | 1 | 191 | 610 | 22,427,652 | 119,958,502 | 191 | 317 | 1 | 73.47 | 15.03 | 5 | 64.44 | 52 | 120 | 52 | 0 | 54 | 9,471,642 | 53 | 60 | 594,757 | 17.81 | 21 | 89 | 1 | 52 | 

...
| `total_proof_time_ms ` |  578.50 |  2,314 |  699 |  525 |
...
| `execute_metered_insn_mi/s` |  91.68 | -          |  91.68 |  91.68 |
| `execute_preflight_insns` |  1,034,378 |  4,137,512 |  1,104,000 |  826,512 |
| `execute_preflight_time_ms` |  61.50 |  246 |  77 |  49 |
| `execute_preflight_insn_mi/s` |  31.01 | -          |  32.59 |  27.01 |
| `trace_gen_time_ms   ` |  163 |  652 |  179 |  144 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  277 |  1,108 |  291 |  261 |
| `main_trace_commit_time_ms` |  51 |  204 |  55 |  49 |
| `generate_perm_trace_time_ms` |  28 |  112 |  38 |  24 |
| `perm_trace_commit_time_ms` |  64.36 |  257.43 |  71.78 |  54.31 |
| `quotient_poly_compute_time_ms` |  58.83 |  235.34 |  69.56 |  52.84 |
| `quotient_poly_commit_time_ms` |  15.66 |  62.66 |  17.58 |  13.19 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 542 | 1 | 45 | 4,137,512 | 91.68 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 179 | 699 | 23,437,436 | 150,778,428 | 179 | 291 | 0 | 59.35 | 17.58 | 6 | 71.78 | 59 | 97 | 59 | 4 | 55 | 10,891,066 | 24 | 49 | 1,103,000 | 27.01 | 22 | 77 | 1 | 59 | 
| regex_program | 1 | 144 | 548 | 11,597,664 | 128,513,066 | 144 | 285 | 1 | 53.58 | 15.77 | 5 | 65.14 | 60 | 104 | 60 | 0 | 50 | 2,195,390 | 38 | 77 | 1,104,000 | 32.07 | 17 | 70 | 0 | 60 | 
| regex_program | 2 | 154 | 525 | 11,579,760 | 128,513,066 | 154 | 261 | 1 | 52.84 | 16.12 | 5 | 66.20 | 51 | 91 | 51 | 0 | 49 | 2,177,774 | 24 | 66 | 1,104,000 | 32.59 | 17 | 69 | 0 | 51 | 
| regex_program | 3 | 175 | 542 | 11,853,280 | 103,456,394 | 175 | 271 | 0 | 69.56 | 13.19 | 5 | 54.31 | 51 | 84 | 51 | 0 | 50 | 2,421,998 | 26 | 54 | 826,512 | 32.37 | 19 | 83 | 1 | 51 | 

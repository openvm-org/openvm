...
|:---|---:|---:|---:|
| Total |  2.39 |  0.73 | 0.73 |
| regex_program |  2.39 |  0.73 |  0.73 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  587.50 |  2,350 |  696 |  526 |
...
| `execute_preflight_insn_mi/s` |  31.40 | -          |  32.76 |  28.23 |
| `trace_gen_time_ms   ` |  173.25 |  693 |  186 |  158 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  287.25 |  1,149 |  315 |  261 |
| `main_trace_commit_time_ms` |  52.50 |  210 |  59 |  49 |
| `generate_perm_trace_time_ms` |  32 |  128 |  40 |  21 |
| `perm_trace_commit_time_ms` |  65.20 |  260.80 |  72.80 |  54.57 |
| `quotient_poly_compute_time_ms` |  60.83 |  243.32 |  73.56 |  54.58 |
| `quotient_poly_commit_time_ms` |  15.64 |  62.55 |  17.58 |  14.02 |
| `pcs_opening_time_ms ` |  58 |  232 |  78 |  47 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 587 | 1 | 37 | 4,137,512 | 111.48 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 184 | 696 | 23,437,436 | 150,778,428 | 184 | 297 | 0 | 60.49 | 17.58 | 5 | 72.80 | 57 | 102 | 56 | 4 | 59 | 10,891,066 | 28 | 45 | 1,103,000 | 28.23 | 22 | 78 | 1 | 56 | 
| regex_program | 1 | 158 | 541 | 11,597,664 | 128,513,066 | 158 | 276 | 1 | 54.69 | 15.92 | 4 | 66.13 | 47 | 106 | 47 | 0 | 51 | 2,195,390 | 39 | 65 | 1,104,000 | 32.33 | 17 | 71 | 0 | 47 | 
| regex_program | 2 | 165 | 526 | 11,579,760 | 128,513,066 | 165 | 261 | 1 | 54.58 | 15.03 | 4 | 67.31 | 50 | 89 | 50 | 0 | 51 | 2,177,774 | 21 | 58 | 1,104,000 | 32.76 | 16 | 70 | 0 | 50 | 
| regex_program | 3 | 186 | 587 | 11,853,280 | 103,456,394 | 186 | 315 | 0 | 73.56 | 14.02 | 5 | 54.57 | 78 | 98 | 77 | 0 | 49 | 2,421,998 | 40 | 44 | 826,512 | 32.28 | 19 | 88 | 1 | 77 | 

...
| `total_proof_time_ms ` |  591.25 |  2,365 |  695 |  527 |
...
| `execute_metered_insn_mi/s` |  110.59 | -          |  110.59 |  110.59 |
| `execute_preflight_insns` |  1,034,378 |  4,137,512 |  1,104,000 |  826,512 |
| `execute_preflight_time_ms` |  53 |  212 |  65 |  44 |
| `execute_preflight_insn_mi/s` |  31.93 | -          |  33.18 |  28.86 |
| `trace_gen_time_ms   ` |  173.75 |  695 |  186 |  159 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  290.75 |  1,163 |  311 |  262 |
| `main_trace_commit_time_ms` |  52 |  208 |  58 |  49 |
| `generate_perm_trace_time_ms` |  33.25 |  133 |  45 |  22 |
| `perm_trace_commit_time_ms` |  65.47 |  261.90 |  72.91 |  55.44 |
| `quotient_poly_compute_time_ms` |  60.60 |  242.42 |  72.25 |  54.71 |
| `quotient_poly_commit_time_ms` |  15.52 |  62.08 |  17.45 |  13.59 |
| `pcs_opening_time_ms ` |  60.50 |  242 |  75 |  50 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 583 | 1 | 37 | 4,137,512 | 110.59 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 185 | 695 | 23,437,436 | 150,778,428 | 185 | 295 | 0 | 60.36 | 17.45 | 5 | 72.91 | 56 | 101 | 56 | 4 | 58 | 10,891,066 | 27 | 45 | 1,103,000 | 28.86 | 22 | 78 | 1 | 56 | 
| regex_program | 1 | 159 | 560 | 11,597,664 | 128,513,066 | 159 | 295 | 1 | 54.71 | 15.38 | 4 | 66.16 | 61 | 111 | 61 | 0 | 51 | 2,195,390 | 45 | 65 | 1,104,000 | 33.18 | 17 | 70 | 0 | 61 | 
| regex_program | 2 | 165 | 527 | 11,579,760 | 128,513,066 | 165 | 262 | 1 | 55.09 | 15.66 | 4 | 67.38 | 50 | 89 | 50 | 0 | 50 | 2,177,774 | 22 | 58 | 1,104,000 | 32.100 | 17 | 71 | 0 | 50 | 
| regex_program | 3 | 186 | 583 | 11,853,280 | 103,456,394 | 186 | 311 | 0 | 72.25 | 13.59 | 5 | 55.44 | 75 | 98 | 75 | 0 | 49 | 2,421,998 | 39 | 44 | 826,512 | 32.70 | 18 | 86 | 1 | 75 | 

...
|:---|---:|---:|---:|
| Total |  2.40 |  0.73 | 0.73 |
| regex_program |  2.40 |  0.73 |  0.73 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  590.75 |  2,363 |  691 |  548 |
...
| `execute_metered_insn_mi/s` |  106.70 | -          |  106.70 |  106.70 |
| `execute_preflight_insns` |  1,034,378 |  4,137,512 |  1,104,000 |  826,512 |
| `execute_preflight_time_ms` |  56.50 |  226 |  70 |  47 |
| `execute_preflight_insn_mi/s` |  31.15 | -          |  32.48 |  28.24 |
| `trace_gen_time_ms   ` |  168.50 |  674 |  182 |  151 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  292 |  1,168 |  308 |  278 |
| `main_trace_commit_time_ms` |  52 |  208 |  58 |  50 |
| `generate_perm_trace_time_ms` |  26.75 |  107 |  37 |  23 |
| `perm_trace_commit_time_ms` |  64.70 |  258.82 |  72.61 |  54.62 |
| `quotient_poly_compute_time_ms` |  59.70 |  238.79 |  72.39 |  52.92 |
| `quotient_poly_commit_time_ms` |  15.81 |  63.25 |  17.39 |  13.70 |
| `pcs_opening_time_ms ` |  69.50 |  278 |  83 |  57 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 548 | 1 | 38 | 4,137,512 | 106.70 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 182 | 691 | 23,437,436 | 150,778,428 | 182 | 292 | 0 | 59.98 | 17.39 | 6 | 72.61 | 58 | 97 | 58 | 4 | 58 | 10,891,066 | 23 | 47 | 1,103,000 | 28.24 | 22 | 78 | 1 | 58 | 
| regex_program | 1 | 151 | 571 | 11,597,664 | 128,513,066 | 151 | 308 | 1 | 53.49 | 16.28 | 4 | 65.58 | 83 | 103 | 83 | 0 | 50 | 2,195,390 | 37 | 70 | 1,104,000 | 32.39 | 17 | 70 | 0 | 83 | 
| regex_program | 2 | 160 | 553 | 11,579,760 | 128,513,066 | 160 | 290 | 1 | 52.92 | 15.88 | 4 | 66 | 80 | 89 | 80 | 0 | 50 | 2,177,774 | 23 | 62 | 1,104,000 | 31.51 | 17 | 69 | 0 | 80 | 
| regex_program | 3 | 181 | 548 | 11,853,280 | 103,456,394 | 181 | 278 | 0 | 72.39 | 13.70 | 5 | 54.62 | 57 | 82 | 57 | 0 | 50 | 2,421,998 | 24 | 47 | 826,512 | 32.48 | 19 | 87 | 1 | 57 | 
...
Commit: https://github.com/openvm-org/openvm/commit/50b38acdbb9f320b1b31283c57bf1cde0a3c297d
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/20584358089)

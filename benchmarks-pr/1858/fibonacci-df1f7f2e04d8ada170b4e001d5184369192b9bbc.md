...
|:---|---:|---:|---:|
| Total |  1.06 |  0.60 | 0.60 |
| fibonacci_program |  1.06 |  0.60 |  0.60 |


| fibonacci_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  523 |  1,046 |  591 |  455 |
...
| `execute_metered_insn_mi/s` |  115.58 | -          |  115.58 |  115.58 |
| `execute_preflight_insns` |  750,134.50 |  1,500,269 |  873,000 |  627,269 |
| `execute_preflight_time_ms` |  28 |  56 |  32 |  24 |
| `execute_preflight_insn_mi/s` |  37.50 | -          |  38.64 |  36.37 |
| `trace_gen_time_ms   ` |  187 |  374 |  192 |  182 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  202.50 |  405 |  206 |  199 |
| `main_trace_commit_time_ms` |  30.50 |  61 |  33 |  28 |
| `generate_perm_trace_time_ms` |  16 |  32 |  20 |  12 |
| `perm_trace_commit_time_ms` |  40.45 |  80.90 |  43.33 |  37.57 |
| `quotient_poly_compute_time_ms` |  31.35 |  62.70 |  32.60 |  30.11 |
| `quotient_poly_commit_time_ms` |  12.59 |  25.18 |  13.04 |  12.15 |
| `pcs_opening_time_ms ` |  69.50 |  139 |  77 |  62 |
...
| --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 455 | 1 | 12 | 1,500,269 | 115.58 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 192 | 591 | 9,680,746 | 84,399,632 | 192 | 206 | 0 | 32.60 | 13.04 | 4 | 43.33 | 62 | 64 | 62 | 0 | 33 | 1,038,336 | 20 | 24 | 873,000 | 36.37 | 15 | 46 | 0 | 62 | 
| fibonacci_program | 1 | 182 | 455 | 9,708,456 | 74,305,770 | 182 | 199 | 1 | 30.11 | 12.15 | 4 | 37.57 | 77 | 50 | 77 | 0 | 28 | 1,064,414 | 12 | 32 | 627,269 | 38.64 | 11 | 42 | 0 | 77 | 
...
Commit: https://github.com/openvm-org/openvm/commit/df1f7f2e04d8ada170b4e001d5184369192b9bbc
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/20612390874)

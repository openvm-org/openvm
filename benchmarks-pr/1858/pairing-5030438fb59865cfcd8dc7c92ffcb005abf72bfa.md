...
| `total_proof_time_ms ` |  733 |  1,466 |  857 |  609 |
...
| `execute_metered_insn_mi/s` |  27.66 | -          |  27.66 |  27.66 |
| `execute_preflight_insns` |  872,878.50 |  1,745,757 |  1,151,000 |  594,757 |
| `execute_preflight_time_ms` |  82.50 |  165 |  105 |  60 |
| `execute_preflight_insn_mi/s` |  14.76 | -          |  18.18 |  11.34 |
| `trace_gen_time_ms   ` |  185 |  370 |  190 |  180 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  359.50 |  719 |  403 |  316 |
| `main_trace_commit_time_ms` |  63.50 |  127 |  74 |  53 |
| `generate_perm_trace_time_ms` |  40.50 |  81 |  45 |  36 |
| `perm_trace_commit_time_ms` |  76.76 |  153.51 |  88.50 |  65.01 |
| `quotient_poly_compute_time_ms` |  83.67 |  167.35 |  90.44 |  76.91 |
| `quotient_poly_commit_time_ms` |  17.08 |  34.16 |  19.26 |  14.89 |
| `pcs_opening_time_ms ` |  74 |  148 |  91 |  57 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 609 | 1 | 63 | 1,745,757 | 27.66 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 180 | 857 | 32,579,050 | 172,558,444 | 180 | 403 | 0 | 90.44 | 19.26 | 6 | 88.50 | 91 | 127 | 91 | 1 | 74 | 15,992,408 | 36 | 105 | 1,151,000 | 11.34 | 26 | 110 | 1 | 91 | 
| pairing | 1 | 190 | 609 | 22,427,652 | 119,958,502 | 190 | 316 | 1 | 76.91 | 14.89 | 6 | 65.01 | 57 | 113 | 57 | 0 | 53 | 9,471,642 | 45 | 60 | 594,757 | 18.18 | 20 | 92 | 1 | 57 | 

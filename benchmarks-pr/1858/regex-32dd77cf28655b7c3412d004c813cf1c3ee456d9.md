...
| `total_proof_time_ms ` |  576 |  2,304 |  696 |  524 |
...
| `execute_preflight_insn_mi/s` |  30.93 | -          |  32.40 |  27.79 |
| `trace_gen_time_ms   ` |  170.50 |  682 |  182 |  155 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  276.75 |  1,107 |  297 |  261 |
| `main_trace_commit_time_ms` |  52.25 |  209 |  58 |  50 |
| `generate_perm_trace_time_ms` |  26.75 |  107 |  38 |  22 |
| `perm_trace_commit_time_ms` |  64.66 |  258.65 |  71.96 |  54.13 |
| `quotient_poly_compute_time_ms` |  60.91 |  243.66 |  71.97 |  53.86 |
| `quotient_poly_commit_time_ms` |  15.89 |  63.56 |  18.09 |  13.67 |
| `pcs_opening_time_ms ` |  53 |  212 |  60 |  49 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 541 | 1 | 38 | 4,137,512 | 108.81 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 182 | 696 | 23,437,436 | 150,778,428 | 182 | 297 | 0 | 63.04 | 18.09 | 5 | 71.96 | 60 | 96 | 60 | 4 | 58 | 10,891,066 | 23 | 47 | 1,103,000 | 27.79 | 21 | 81 | 1 | 60 | 
| regex_program | 1 | 155 | 543 | 11,597,664 | 128,513,066 | 155 | 279 | 1 | 53.86 | 16.40 | 4 | 65.61 | 52 | 105 | 52 | 0 | 50 | 2,195,390 | 38 | 67 | 1,104,000 | 31.63 | 17 | 70 | 0 | 52 | 
| regex_program | 2 | 163 | 524 | 11,579,760 | 128,513,066 | 163 | 261 | 1 | 54.79 | 15.39 | 4 | 66.95 | 49 | 89 | 48 | 0 | 51 | 2,177,774 | 22 | 58 | 1,104,000 | 32.40 | 17 | 70 | 0 | 48 | 
| regex_program | 3 | 182 | 541 | 11,853,280 | 103,456,394 | 182 | 270 | 0 | 71.97 | 13.67 | 5 | 54.13 | 51 | 82 | 51 | 0 | 50 | 2,421,998 | 24 | 46 | 826,512 | 31.90 | 19 | 86 | 1 | 51 | 
...
Commit: https://github.com/openvm-org/openvm/commit/32dd77cf28655b7c3412d004c813cf1c3ee456d9
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/20545947508)

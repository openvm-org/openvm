...
|:---|---:|---:|---:|
| Total |  2.30 |  0.72 | 0.72 |
| regex_program |  2.30 |  0.72 |  0.72 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  566.25 |  2,265 |  682 |  519 |
...
| `execute_metered_insn_mi/s` |  112.03 | -          |  112.03 |  112.03 |
| `execute_preflight_insns` |  1,034,378 |  4,137,512 |  1,104,000 |  826,512 |
| `execute_preflight_time_ms` |  53.25 |  213 |  64 |  45 |
| `execute_preflight_insn_mi/s` |  30.84 | -          |  32.12 |  28.31 |
| `trace_gen_time_ms   ` |  169.50 |  678 |  182 |  154 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  270 |  1,080 |  286 |  259 |
| `main_trace_commit_time_ms` |  51.50 |  206 |  56 |  50 |
| `generate_perm_trace_time_ms` |  23.25 |  93 |  27 |  20 |
| `perm_trace_commit_time_ms` |  64.61 |  258.46 |  69.97 |  54.71 |
| `quotient_poly_compute_time_ms` |  58.31 |  233.26 |  70.98 |  53.39 |
| `quotient_poly_commit_time_ms` |  15.78 |  63.13 |  17.74 |  13.35 |
| `pcs_opening_time_ms ` |  53.25 |  213 |  57 |  50 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 542 | 1 | 36 | 4,137,512 | 112.03 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 182 | 682 | 23,437,436 | 150,778,428 | 182 | 286 | 0 | 55.31 | 17.74 | 5 | 69.97 | 57 | 98 | 57 | 4 | 56 | 10,891,066 | 27 | 45 | 1,103,000 | 28.31 | 22 | 73 | 1 | 57 | 
| regex_program | 1 | 154 | 519 | 11,597,664 | 128,513,066 | 154 | 259 | 1 | 53.39 | 16.20 | 4 | 67.49 | 50 | 88 | 50 | 0 | 50 | 2,195,390 | 20 | 64 | 1,104,000 | 32.12 | 17 | 70 | 0 | 50 | 
| regex_program | 2 | 160 | 522 | 11,579,760 | 128,513,066 | 160 | 261 | 1 | 53.58 | 15.84 | 5 | 66.29 | 51 | 88 | 51 | 0 | 50 | 2,177,774 | 21 | 59 | 1,104,000 | 31.37 | 17 | 70 | 0 | 51 | 
| regex_program | 3 | 182 | 542 | 11,853,280 | 103,456,394 | 182 | 274 | 0 | 70.98 | 13.35 | 5 | 54.71 | 55 | 82 | 55 | 0 | 50 | 2,421,998 | 25 | 45 | 826,512 | 31.55 | 19 | 85 | 1 | 55 | 
...
Commit: https://github.com/openvm-org/openvm/commit/5030438fb59865cfcd8dc7c92ffcb005abf72bfa
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/20613933824)

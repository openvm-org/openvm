...
| `total_proof_time_ms ` |  1,485.50 |  2,971 |  1,719 |  1,252 |
...
| `execute_preflight_insn_mi/s` |  30.96 | -          |  32.83 |  29.08 |
| `trace_gen_time_ms   ` |  312 |  624 |  332 |  292 |
| `memory_finalize_time_ms` |  2 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  987.50 |  1,975 |  1,216 |  759 |
| `main_trace_commit_time_ms` |  142 |  284 |  185 |  99 |
| `generate_perm_trace_time_ms` |  55.50 |  111 |  66 |  45 |
| `perm_trace_commit_time_ms` |  173.47 |  346.94 |  226.16 |  120.78 |
| `quotient_poly_compute_time_ms` |  164.43 |  328.86 |  180.50 |  148.36 |
| `quotient_poly_commit_time_ms` |  37.40 |  74.80 |  49.15 |  25.65 |
| `pcs_opening_time_ms ` |  407 |  814 |  537 |  277 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 1,252 | 41 | 1 | 37 | 4,108,559 | 108.39 | 167 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 292 | 1,719 | 23,389,324 | 373,183,036 | 292 | 1,216 | 0 | 148.36 | 49.15 | 6 | 226.16 | 537 | 293 | 537 | 4 | 185 | 10,857,266 | 66 | 83 | 2,211,000 | 29.08 | 46 | 199 | 2 | 537 | 
| regex_program | 1 | 332 | 1,252 | 11,990,044 | 196,838,026 | 332 | 759 | 2 | 180.50 | 25.65 | 5 | 120.78 | 277 | 170 | 277 | 0 | 99 | 2,543,338 | 45 | 112 | 1,897,559 | 32.83 | 26 | 211 | 2 | 277 | 

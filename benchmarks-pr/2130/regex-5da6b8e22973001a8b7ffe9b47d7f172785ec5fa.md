...
|:---|---:|---:|
| Total |  2.70 |  1.66 |
| regex_program |  2.67 |  1.63 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,333 |  2,666 |  1,626 |  1,040 |
...
| `execute_metered_insn_mi/s` |  121.78 | -          |  121.78 |  121.78 |
| `execute_preflight_insns` |  2,054,279.50 |  4,108,559 |  2,211,000 |  1,897,559 |
| `execute_preflight_time_ms` |  99.50 |  199 |  113 |  86 |
| `execute_preflight_insn_mi/s` |  29.47 | -          |  30.97 |  27.96 |
| `trace_gen_time_ms   ` |  170 |  340 |  197 |  143 |
...
| `perm_trace_commit_time_ms` |  173.57 |  347.14 |  227.74 |  119.40 |
| `quotient_poly_compute_time_ms` |  161.85 |  323.70 |  173.21 |  150.49 |
| `quotient_poly_commit_time_ms` |  37.50 |  75.01 |  48.51 |  26.49 |
| `pcs_opening_time_ms ` |  403 |  806 |  526 |  280 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 1,040 | 65 | 1 | 33 | 4,108,559 | 121.78 | 192 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 197 | 1,626 | 23,389,324 | 373,183,036 | 197 | 1,194 | 0 | 150.49 | 48.51 | 6 | 227.74 | 526 | 281 | 526 | 4 | 185 | 10,857,266 | 53 | 86 | 2,211,000 | 27.96 | 46 | 200 | 2 | 526 | 
| regex_program | 1 | 143 | 1,040 | 11,990,044 | 196,838,026 | 143 | 742 | 2 | 173.21 | 26.49 | 5 | 119.40 | 280 | 160 | 280 | 0 | 100 | 2,543,338 | 38 | 113 | 1,897,559 | 30.97 | 26 | 200 | 2 | 280 | 

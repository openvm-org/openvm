...
|:---|---:|---:|
| Total |  2.67 |  1.65 |
| regex_program |  2.64 |  1.61 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,320.50 |  2,641 |  1,613 |  1,028 |
| `main_cells_used     ` |  6,700,302 |  13,400,604 |  10,857,266 |  2,543,338 |
| `total_cells_used    ` |  17,689,684 |  35,379,368 |  23,389,324 |  11,990,044 |
| `execute_metered_time_ms` |  33 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  122.39 | -          |  122.39 |  122.39 |
| `execute_preflight_insns` |  2,054,279.50 |  4,108,559 |  2,211,000 |  1,897,559 |
| `execute_preflight_time_ms` |  100.50 |  201 |  116 |  85 |
| `execute_preflight_insn_mi/s` |  29.58 | -          |  31 |  28.15 |
| `trace_gen_time_ms   ` |  166 |  332 |  197 |  135 |
| `memory_finalize_time_ms` |  2 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  958.50 |  1,917 |  1,182 |  735 |
| `main_trace_commit_time_ms` |  141.50 |  283 |  184 |  99 |
| `generate_perm_trace_time_ms` |  44 |  88 |  51 |  37 |
| `perm_trace_commit_time_ms` |  170.85 |  341.70 |  224.09 |  117.61 |
| `quotient_poly_compute_time_ms` |  159.81 |  319.61 |  172.54 |  147.07 |
| `quotient_poly_commit_time_ms` |  36.57 |  73.13 |  47.75 |  25.38 |
| `pcs_opening_time_ms ` |  401.50 |  803 |  525 |  278 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 1,028 | 41 | 1 | 33 | 4,108,559 | 122.39 | 168 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 197 | 1,613 | 23,389,324 | 373,183,036 | 197 | 1,182 | 0 | 147.07 | 47.75 | 6 | 224.09 | 525 | 276 | 525 | 4 | 184 | 10,857,266 | 51 | 85 | 2,211,000 | 28.15 | 46 | 196 | 2 | 525 | 
| regex_program | 1 | 135 | 1,028 | 11,990,044 | 196,838,026 | 135 | 735 | 2 | 172.54 | 25.38 | 5 | 117.61 | 278 | 158 | 278 | 0 | 99 | 2,543,338 | 37 | 116 | 1,897,559 | 31 | 26 | 198 | 2 | 278 | 

...
|:---|---:|---:|
| Total |  3.10 |  1.77 |
| regex_program |  3.06 |  1.73 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,531 |  3,062 |  1,732 |  1,330 |
...
| `execute_metered_insn_mi/s` |  115.38 | -          |  115.38 |  115.38 |
| `execute_preflight_insns` |  2,054,279.50 |  4,108,559 |  2,211,000 |  1,897,559 |
| `execute_preflight_time_ms` |  98.50 |  197 |  113 |  84 |
| `execute_preflight_insn_mi/s` |  29.94 | -          |  31.31 |  28.57 |
| `trace_gen_time_ms   ` |  315 |  630 |  335 |  295 |
| `memory_finalize_time_ms` |  2 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  1,028.50 |  2,057 |  1,223 |  834 |
| `main_trace_commit_time_ms` |  143 |  286 |  185 |  101 |
| `generate_perm_trace_time_ms` |  55.50 |  111 |  65 |  46 |
| `perm_trace_commit_time_ms` |  174.50 |  349 |  226.38 |  122.62 |
| `quotient_poly_compute_time_ms` |  164.100 |  329.99 |  181.17 |  148.82 |
| `quotient_poly_commit_time_ms` |  37.08 |  74.16 |  48.57 |  25.60 |
| `pcs_opening_time_ms ` |  447 |  894 |  546 |  348 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 1,330 | 41 | 1 | 35 | 4,108,559 | 115.38 | 167 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 295 | 1,732 | 23,389,324 | 373,183,036 | 295 | 1,223 | 0 | 148.82 | 48.57 | 6 | 226.38 | 546 | 292 | 546 | 4 | 185 | 10,857,266 | 65 | 84 | 2,211,000 | 28.57 | 46 | 199 | 2 | 545 | 
| regex_program | 1 | 335 | 1,330 | 11,990,044 | 196,838,026 | 335 | 834 | 2 | 181.17 | 25.60 | 6 | 122.62 | 348 | 172 | 347 | 0 | 101 | 2,543,338 | 46 | 113 | 1,897,559 | 31.31 | 26 | 211 | 2 | 347 | 

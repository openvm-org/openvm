...
|:---|---:|---:|---:|
| Total | <span style='color: red'>(+1 [+18.0%])</span> 8.27 | <span style='color: red'>(+1 [+19.2%])</span> 4.25 | 4.25 |
| pairing | <span style='color: red'>(+1 [+18.0%])</span> 8.27 | <span style='color: red'>(+1 [+19.2%])</span> 4.25 |  4.25 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+632 [+18.2%])</span> 4,105 | <span style='color: red'>(+1263 [+18.2%])</span> 8,210 | <span style='color: red'>(+685 [+19.6%])</span> 4,182 | <span style='color: red'>(+578 [+16.8%])</span> 4,028 |
...
| `execute_metered_insn_mi/s` | <span style='color: red'>(+0 [+0.2%])</span> 27.66 | -          | <span style='color: red'>(+0 [+0.2%])</span> 27.66 | <span style='color: red'>(+0 [+0.2%])</span> 27.66 |
...
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+0 [+2.8%])</span> 15.07 | -          | <span style='color: red'>(+1 [+2.9%])</span> 18.57 | <span style='color: red'>(+0 [+2.6%])</span> 11.57 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+9 [+5.0%])</span> 187.50 | <span style='color: red'>(+18 [+5.0%])</span> 375 | <span style='color: red'>(+8 [+4.0%])</span> 206 | <span style='color: red'>(+10 [+6.3%])</span> 169 |
...
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+624 [+20.1%])</span> 3,729.50 | <span style='color: red'>(+1249 [+20.1%])</span> 7,459 | <span style='color: red'>(+524 [+16.3%])</span> 3,733 | <span style='color: red'>(+725 [+24.2%])</span> 3,726 |
| `main_trace_commit_time_ms` |  64 |  128 | <span style='color: green'>(-2 [-2.7%])</span> 72 | <span style='color: red'>(+2 [+3.7%])</span> 56 |
| `generate_perm_trace_time_ms` | <span style='color: red'>(+15 [+11.4%])</span> 146.50 | <span style='color: red'>(+30 [+11.4%])</span> 293 | <span style='color: red'>(+66 [+34.7%])</span> 256 | <span style='color: green'>(-36 [-49.3%])</span> 37 |
| `perm_trace_commit_time_ms` | <span style='color: red'>(+1 [+1.7%])</span> 77.37 | <span style='color: red'>(+3 [+1.7%])</span> 154.74 | <span style='color: red'>(+2 [+1.7%])</span> 89.34 | <span style='color: red'>(+1 [+1.8%])</span> 65.39 |
| `quotient_poly_compute_time_ms` | <span style='color: green'>(-0 [-0.4%])</span> 82.38 | <span style='color: green'>(-1 [-0.4%])</span> 164.75 | <span style='color: green'>(-1 [-0.8%])</span> 91.29 | <span style='color: red'>(+0 [+0.2%])</span> 73.46 |
| `quotient_poly_commit_time_ms` | <span style='color: green'>(-0 [-1.2%])</span> 17.19 | <span style='color: green'>(-0 [-1.2%])</span> 34.39 | <span style='color: green'>(-1 [-3.4%])</span> 19.02 | <span style='color: red'>(+0 [+1.8%])</span> 15.37 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+608 [+22.3%])</span> 3,337.50 | <span style='color: red'>(+1217 [+22.3%])</span> 6,675 | <span style='color: red'>(+556 [+19.0%])</span> 3,481 | <span style='color: red'>(+661 [+26.1%])</span> 3,194 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 4,028 | 1 | 63 | 1,745,742 | 27.66 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 169 | 4,182 | 32,480,114 | 172,558,444 | 169 | 3,726 | 0 | 91.29 | 19.02 | 8 | 89.34 | 3,194 | 348 | 3,194 | 1 | 72 | 15,909,408 | 256 | 117 | 1,149,000 | 11.57 | 26 | 111 | 1 | 3,193 | 
| pairing | 1 | 206 | 4,028 | 22,464,232 | 119,958,502 | 206 | 3,733 | 1 | 73.46 | 15.37 | 8 | 65.39 | 3,481 | 105 | 3,481 | 0 | 56 | 9,498,894 | 37 | 47 | 596,742 | 18.57 | 21 | 89 | 1 | 3,481 | 

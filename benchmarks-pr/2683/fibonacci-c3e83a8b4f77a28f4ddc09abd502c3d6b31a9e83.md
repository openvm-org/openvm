...
|:---|---:|---:|---:|
| Total |  5.52 |  2.01 |  2.01 |
| app_proof |  3.86 |  0.76 |  0.76 |
| leaf |  0.95 |  0.55 |  0.55 |
...
| `total_proof_time_ms ` |  540.14 |  3,781 |  681 |  513 |
| `execute_metered_time_ms` |  76 | -          | -          | -          |
| `execute_metered_insns` |  12,000,265 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  157.78 | -          |  157.78 |  157.78 |
| `execute_preflight_insns` |  1,714,323.57 |  12,000,265 |  1,747,000 |  1,518,265 |
| `execute_preflight_time_ms` |  51.71 |  362 |  61 |  45 |
| `execute_preflight_insn_mi/s` |  47.61 | -          |  51.80 |  43.37 |
| `trace_gen_time_ms   ` |  156.71 |  1,097 |  163 |  149 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  268.29 |  1,878 |  277 |  263 |
| `prover.main_trace_commit_time_ms` |  58.14 |  407 |  59 |  58 |
| `prover.rap_constraints_time_ms` |  173 |  1,211 |  177 |  171 |
| `prover.openings_time_ms` |  36 |  252 |  40 |  32 |
| `prover.rap_constraints.logup_gkr_time_ms` |  126.29 |  884 |  128 |  125 |
| `prover.rap_constraints.round0_time_ms` |  27.57 |  193 |  30 |  26 |
| `prover.rap_constraints.mle_rounds_time_ms` |  18.29 |  128 |  19 |  18 |
| `prover.openings.stacked_reduction_time_ms` |  16 |  112 |  18 |  15 |
| `prover.openings.stacked_reduction.round0_time_ms` |  5.57 |  39 |  6 |  5 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  9.71 |  68 |  12 |  9 |
| `prover.openings.whir_time_ms` |  19.57 |  137 |  21 |  17 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  477 |  954 |  550 |  404 |
| `execute_preflight_time_ms` |  1.50 |  3 |  2 |  1 |
| `trace_gen_time_ms   ` |  55 |  110 |  69 |  41 |
| `generate_blob_total_time_ms` |  3.50 |  7 |  4 |  3 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  421.50 |  843 |  480 |  363 |
...
| `prover.rap_constraints.round0_time_ms` |  72.50 |  145 |  79 |  66 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/c3e83a8b4f77a28f4ddc09abd502c3d6b31a9e83/fibonacci-c3e83a8b4f77a28f4ddc09abd502c3d6b31a9e83.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 94 | 9 |  |  | 0 |  | 412 | 9 |  |  |  |  |  |  | 
| app_proof |  |  |  |  |  | 522 |  |  | 76 | 12,000,265 | 157.78 | 0 | 3,867 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 30 | 386 | 29 | 10 | 2 | 3 | 1 | 1 | 
| internal_recursive.0 | 1 | 11 | 174 | 11 | 1 | 0 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 10 | 147 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 69 | 550 | 69 | 26 | 4 | 2 | 1 | 1 | 
| leaf | 1 | 41 | 404 | 40 | 19 | 3 | 1 | 1 | 1 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 75,533,952 | 356 | 157 | 0 | 9 | 143 | 39 | 39 | 71 | 32 | 0 | 55 | 23 | 31 | 4 | 26 | 158 | 143 | 0 | 2 | 31 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 23,651,975 | 162 | 46 | 0 | 3 | 69 | 23 | 22 | 27 | 18 | 0 | 45 | 22 | 23 | 1 | 21 | 47 | 69 | 0 | 2 | 17 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 17,507,975 |
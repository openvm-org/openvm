...
| `execute_metered_insn_mi/s` | <span style='color: red'>(+46 [+68.9%])</span> 113.48 | -          | <span style='color: red'>(+46 [+68.9%])</span> 113.48 | <span style='color: red'>(+46 [+68.9%])</span> 113.48 |
| `execute_e3_time_ms  ` | <span style='color: green'>(-42 [-25.3%])</span> 124 | <span style='color: green'>(-84 [-25.3%])</span> 248 | <span style='color: green'>(-39 [-21.7%])</span> 141 | <span style='color: green'>(-45 [-29.6%])</span> 107 |
| `execute_e3_insn_mi/s` | <span style='color: red'>(+4 [+34.9%])</span> 16.90 | -          | <span style='color: red'>(+5 [+42.1%])</span> 17.93 | <span style='color: red'>(+3 [+27.6%])</span> 15.87 |
...
| `merkle_finalize_time_ms` | <span style='color: green'>(-4 [-2.6%])</span> 151.50 | <span style='color: green'>(-8 [-2.6%])</span> 303 | <span style='color: green'>(-4 [-1.7%])</span> 238 | <span style='color: green'>(-4 [-5.8%])</span> 65 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+605 [+23.1%])</span> 3,220.50 | <span style='color: red'>(+1210 [+23.1%])</span> 6,441 | <span style='color: red'>(+1229 [+44.0%])</span> 4,020 | <span style='color: green'>(-19 [-0.8%])</span> 2,421 |
| `main_trace_commit_time_ms` | <span style='color: red'>(+150 [+29.7%])</span> 657.50 | <span style='color: red'>(+301 [+29.7%])</span> 1,315 | <span style='color: red'>(+273 [+47.8%])</span> 844 | <span style='color: red'>(+28 [+6.3%])</span> 471 |
| `generate_perm_trace_time_ms` | <span style='color: red'>(+38 [+17.2%])</span> 256 | <span style='color: red'>(+75 [+17.2%])</span> 512 | <span style='color: red'>(+73 [+31.7%])</span> 303 | <span style='color: red'>(+2 [+1.0%])</span> 209 |
| `perm_trace_commit_time_ms` | <span style='color: red'>(+130 [+23.4%])</span> 684 | <span style='color: red'>(+259 [+23.4%])</span> 1,368 | <span style='color: red'>(+258 [+43.7%])</span> 849 | <span style='color: red'>(+1 [+0.2%])</span> 519 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+70 [+25.7%])</span> 339.50 | <span style='color: red'>(+139 [+25.7%])</span> 679 | <span style='color: red'>(+142 [+49.5%])</span> 429 | <span style='color: green'>(-3 [-1.2%])</span> 250 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+59 [+24.5%])</span> 300 | <span style='color: red'>(+118 [+24.5%])</span> 600 | <span style='color: red'>(+118 [+42.9%])</span> 393 |  207 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+156 [+19.2%])</span> 972.50 | <span style='color: red'>(+313 [+19.2%])</span> 1,945 | <span style='color: red'>(+360 [+43.4%])</span> 1,190 | <span style='color: green'>(-47 [-5.9%])</span> 755 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `main_cells_used     ` |  117,101,513 |  234,203,026 |  147,206,100 |  86,996,926 |
| `total_cells_used    ` |  292,101,453 |  584,202,906 |  376,102,558 |  208,100,348 |
| `insns               ` |  1,663,280.50 |  3,326,561 |  1,830,014 |  1,496,547 |
| `execute_e3_time_ms  ` |  626 |  1,252 |  699 |  553 |
| `execute_e3_insn_mi/s` |  2.66 | -          |  2.70 |  2.62 |
| `memory_finalize_time_ms` |  9.50 |  19 |  11 |  8 |
| `boundary_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  3,762 |  7,524 |  4,710 |  2,814 |
| `main_trace_commit_time_ms` |  706.50 |  1,413 |  837 |  576 |
| `generate_perm_trace_time_ms` |  323 |  646 |  417 |  229 |
| `perm_trace_commit_time_ms` |  966.50 |  1,933 |  1,260 |  673 |
| `quotient_poly_compute_time_ms` |  416 |  832 |  524 |  308 |
| `quotient_poly_commit_time_ms` |  314 |  628 |  375 |  253 |
| `pcs_opening_time_ms ` |  1,031 |  2,062 |  1,291 |  771 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 7,163 |  | 1 |  |  | 1 |  |  |  | 
| regex_program |  | 4,016 |  | 23 | 4,165,433 | 1 | 36 | 113.48 | 58 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 214 | 208,100,348 | 319,626,730 | 2,814 | 308 | 253 | 673 | 771 | 8 | 576 | 86,996,926 | 1,496,547 | 229 | 553 | 2.70 | 0 | 
| leaf | 1 | 353 | 376,102,558 | 538,660,330 | 4,710 | 524 | 375 | 1,260 | 1,291 | 11 | 837 | 147,206,100 | 1,830,014 | 417 | 699 | 2.62 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 509 | 211,864,680 | 373,166,268 | 4,020 | 429 | 393 | 849 | 1,190 | 238 | 26 | 11 | 844 | 91,153,694 | 2,244,000 | 303 | 141 | 15.87 | 4 | 
| regex_program | 1 | 285 | 176,237,560 | 242,975,370 | 2,421 | 250 | 207 | 519 | 755 | 65 | 23 | 3 | 471 | 74,277,990 | 1,921,433 | 209 | 107 | 17.93 | 0 | 

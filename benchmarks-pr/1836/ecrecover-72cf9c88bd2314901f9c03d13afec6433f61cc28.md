...
| `execute_metered_insn_mi/s` | <span style='color: red'>(+15 [+810.2%])</span> 16.76 | -          | <span style='color: red'>(+15 [+810.2%])</span> 16.76 | <span style='color: red'>(+15 [+810.2%])</span> 16.76 |
...
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+44 [+4.7%])</span> 987 | <span style='color: red'>(+44 [+4.7%])</span> 987 | <span style='color: red'>(+44 [+4.7%])</span> 987 | <span style='color: red'>(+44 [+4.7%])</span> 987 |
...
| `perm_trace_commit_time_ms` | <span style='color: red'>(+35 [+26.3%])</span> 168 | <span style='color: red'>(+35 [+26.3%])</span> 168 | <span style='color: red'>(+35 [+26.3%])</span> 168 | <span style='color: red'>(+35 [+26.3%])</span> 168 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `execute_e3_time_ms  ` |  994 |  994 |  994 |  994 |
| `execute_e3_insn_mi/s` |  2.95 | -          |  2.95 |  2.95 |
| `memory_finalize_time_ms` |  12 |  12 |  12 |  12 |
| `boundary_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  8,648 |  8,648 |  8,648 |  8,648 |
| `main_trace_commit_time_ms` |  1,654 |  1,654 |  1,654 |  1,654 |
| `generate_perm_trace_time_ms` |  790 |  790 |  790 |  790 |
| `perm_trace_commit_time_ms` |  2,317 |  2,317 |  2,317 |  2,317 |
| `quotient_poly_compute_time_ms` |  968 |  968 |  968 |  968 |
| `quotient_poly_commit_time_ms` |  694 |  694 |  694 |  694 |
| `pcs_opening_time_ms ` |  2,221 |  2,221 |  2,221 |  2,221 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program |  | 1,641 |  | 10 | 137,284 | 1 | 8 | 16.76 | 40 | 
| leaf | 11,285 |  | 1 |  |  | 1 |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 595 | 992,054,762 | 8,648 | 968 | 694 | 2,317 | 2,221 | 12 | 1,654 | 2,934,853 | 790 | 994 | 2.95 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 101 | 32,925,330 | 987 | 78 | 131 | 168 | 422 | 61 | 11 | 2 | 140 | 137,284 | 30 | 83 | 1.65 | 0 | 

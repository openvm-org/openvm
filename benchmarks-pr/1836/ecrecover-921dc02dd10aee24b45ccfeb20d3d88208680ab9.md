...
| `execute_metered_insn_mi/s` | <span style='color: red'>(+17 [+918.4%])</span> 18.76 | -          | <span style='color: red'>(+17 [+918.4%])</span> 18.76 | <span style='color: red'>(+17 [+918.4%])</span> 18.76 |
...
| `execute_e3_insn_mi/s` | <span style='color: red'>(+0 [+1.3%])</span> 1.64 | -          | <span style='color: red'>(+0 [+1.3%])</span> 1.64 | <span style='color: red'>(+0 [+1.3%])</span> 1.64 |
...
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+34 [+3.6%])</span> 977 | <span style='color: red'>(+34 [+3.6%])</span> 977 | <span style='color: red'>(+34 [+3.6%])</span> 977 | <span style='color: red'>(+34 [+3.6%])</span> 977 |
...
| `pcs_opening_time_ms ` | <span style='color: red'>(+27 [+6.5%])</span> 441 | <span style='color: red'>(+27 [+6.5%])</span> 441 | <span style='color: red'>(+27 [+6.5%])</span> 441 | <span style='color: red'>(+27 [+6.5%])</span> 441 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `main_cells_used     ` |  246,667,516 |  246,667,516 |  246,667,516 |  246,667,516 |
| `total_cells_used    ` |  645,427,994 |  645,427,994 |  645,427,994 |  645,427,994 |
| `insns               ` |  2,934,913 |  2,934,913 |  2,934,913 |  2,934,913 |
| `execute_e3_time_ms  ` |  982 |  982 |  982 |  982 |
| `execute_e3_insn_mi/s` |  2.99 | -          |  2.99 |  2.99 |
| `memory_finalize_time_ms` |  12 |  12 |  12 |  12 |
| `boundary_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  8,659 |  8,659 |  8,659 |  8,659 |
| `main_trace_commit_time_ms` |  1,680 |  1,680 |  1,680 |  1,680 |
| `generate_perm_trace_time_ms` |  799 |  799 |  799 |  799 |
| `perm_trace_commit_time_ms` |  2,353 |  2,353 |  2,353 |  2,353 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program |  | 1,645 |  | 11 | 137,284 | 1 | 7 | 18.76 | 44 | 
| leaf | 11,298 |  | 1 |  |  | 1 |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 583 | 645,427,994 | 992,054,762 | 8,659 | 898 | 701 | 2,353 | 2,223 | 12 | 1,680 | 246,667,516 | 2,934,913 | 799 | 982 | 2.99 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 97 | 25,968,337 | 32,925,330 | 977 | 79 | 133 | 132 | 441 | 58 | 11 | 4 | 144 | 8,596,011 | 137,284 | 29 | 83 | 1.64 | 0 | 

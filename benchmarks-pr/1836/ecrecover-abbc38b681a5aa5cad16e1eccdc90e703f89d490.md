...
| `execute_metered_time_ms` | <span style='color: green'>(-66 [-89.2%])</span> 8 | -          | -          | -          |
| `execute_metered_insn_mi/s` | <span style='color: red'>(+15 [+805.1%])</span> 16.67 | -          | <span style='color: red'>(+15 [+805.1%])</span> 16.67 | <span style='color: red'>(+15 [+805.1%])</span> 16.67 |
...
| `memory_finalize_time_ms` | <span style='color: green'>(-72 [-94.7%])</span> 4 | <span style='color: green'>(-72 [-94.7%])</span> 4 | <span style='color: green'>(-72 [-94.7%])</span> 4 | <span style='color: green'>(-72 [-94.7%])</span> 4 |
| `boundary_finalize_time_ms` | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `merkle_finalize_time_ms` | <span style='color: red'>(+3 [+4.3%])</span> 73 | <span style='color: red'>(+3 [+4.3%])</span> 73 | <span style='color: red'>(+3 [+4.3%])</span> 73 | <span style='color: red'>(+3 [+4.3%])</span> 73 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: green'>(-9 [-1.0%])</span> 934 | <span style='color: green'>(-9 [-1.0%])</span> 934 | <span style='color: green'>(-9 [-1.0%])</span> 934 | <span style='color: green'>(-9 [-1.0%])</span> 934 |
| `main_trace_commit_time_ms` | <span style='color: red'>(+4 [+2.9%])</span> 142 | <span style='color: red'>(+4 [+2.9%])</span> 142 | <span style='color: red'>(+4 [+2.9%])</span> 142 | <span style='color: red'>(+4 [+2.9%])</span> 142 |
...
| `perm_trace_commit_time_ms` | <span style='color: green'>(-7 [-5.3%])</span> 126 | <span style='color: green'>(-7 [-5.3%])</span> 126 | <span style='color: green'>(-7 [-5.3%])</span> 126 | <span style='color: green'>(-7 [-5.3%])</span> 126 |
...
| `quotient_poly_commit_time_ms` | <span style='color: green'>(-5 [-3.8%])</span> 128 | <span style='color: green'>(-5 [-3.8%])</span> 128 | <span style='color: green'>(-5 [-3.8%])</span> 128 | <span style='color: green'>(-5 [-3.8%])</span> 128 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `execute_e3_time_ms  ` |  983 |  983 |  983 |  983 |
| `execute_e3_insn_mi/s` |  2.98 | -          |  2.98 |  2.98 |
| `memory_finalize_time_ms` |  12 |  12 |  12 |  12 |
| `boundary_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  8,176 |  8,176 |  8,176 |  8,176 |
| `main_trace_commit_time_ms` |  1,489 |  1,489 |  1,489 |  1,489 |
| `generate_perm_trace_time_ms` |  788 |  788 |  788 |  788 |
| `perm_trace_commit_time_ms` |  2,063 |  2,063 |  2,063 |  2,063 |
| `quotient_poly_compute_time_ms` |  982 |  982 |  982 |  982 |
| `quotient_poly_commit_time_ms` |  637 |  637 |  637 |  637 |
| `pcs_opening_time_ms ` |  2,211 |  2,211 |  2,211 |  2,211 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program |  | 2,489 |  | 24 | 137,284 | 1 | 8 | 16.67 | 56 | 
| leaf | 10,855 |  | 1 |  |  | 1 |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 569 | 992,054,762 | 8,176 | 982 | 637 | 2,063 | 2,211 | 12 | 1,489 | 2,934,843 | 788 | 983 | 2.98 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 111 | 32,925,330 | 934 | 82 | 128 | 126 | 412 | 73 | 24 | 4 | 142 | 137,284 | 29 | 83 | 1.65 | 0 | 

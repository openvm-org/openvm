...
| `execute_metered_time_ms` | <span style='color: green'>(-23 [-37.7%])</span> 38 | -          | -          | -          |
| `execute_metered_insn_mi/s` | <span style='color: red'>(+42 [+62.2%])</span> 108.98 | -          | <span style='color: red'>(+42 [+62.2%])</span> 108.98 | <span style='color: red'>(+42 [+62.2%])</span> 108.98 |
| `execute_e3_time_ms  ` | <span style='color: green'>(-42 [-25.6%])</span> 123.50 | <span style='color: green'>(-85 [-25.6%])</span> 247 | <span style='color: green'>(-40 [-22.2%])</span> 140 | <span style='color: green'>(-45 [-29.6%])</span> 107 |
| `execute_e3_insn_mi/s` | <span style='color: red'>(+4 [+34.8%])</span> 16.89 | -          | <span style='color: red'>(+5 [+41.0%])</span> 17.80 | <span style='color: red'>(+4 [+28.6%])</span> 15.99 |
...
| `merkle_finalize_time_ms` | <span style='color: green'>(-2 [-1.0%])</span> 154 | <span style='color: green'>(-3 [-1.0%])</span> 308 | <span style='color: green'>(-3 [-1.2%])</span> 239 |  69 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+416 [+15.9%])</span> 3,031 | <span style='color: red'>(+831 [+15.9%])</span> 6,062 | <span style='color: red'>(+1002 [+35.9%])</span> 3,793 | <span style='color: green'>(-171 [-7.0%])</span> 2,269 |
| `main_trace_commit_time_ms` | <span style='color: red'>(+80 [+15.8%])</span> 587 | <span style='color: red'>(+160 [+15.8%])</span> 1,174 | <span style='color: red'>(+183 [+32.0%])</span> 754 | <span style='color: green'>(-23 [-5.2%])</span> 420 |
| `generate_perm_trace_time_ms` | <span style='color: red'>(+32 [+14.6%])</span> 250.50 | <span style='color: red'>(+64 [+14.6%])</span> 501 | <span style='color: red'>(+72 [+31.3%])</span> 302 | <span style='color: green'>(-8 [-3.9%])</span> 199 |
| `perm_trace_commit_time_ms` | <span style='color: red'>(+52 [+9.4%])</span> 606.50 | <span style='color: red'>(+104 [+9.4%])</span> 1,213 | <span style='color: red'>(+161 [+27.2%])</span> 752 | <span style='color: green'>(-57 [-11.0%])</span> 461 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+66 [+24.4%])</span> 336 | <span style='color: red'>(+132 [+24.4%])</span> 672 | <span style='color: red'>(+148 [+51.6%])</span> 435 | <span style='color: green'>(-16 [-6.3%])</span> 237 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+36 [+14.9%])</span> 277 | <span style='color: red'>(+72 [+14.9%])</span> 554 | <span style='color: red'>(+89 [+32.4%])</span> 364 | <span style='color: green'>(-17 [-8.2%])</span> 190 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+148 [+18.1%])</span> 963.50 | <span style='color: red'>(+295 [+18.1%])</span> 1,927 | <span style='color: red'>(+346 [+41.7%])</span> 1,176 | <span style='color: green'>(-51 [-6.4%])</span> 751 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `main_cells_used     ` |  117,101,327 |  234,202,654 |  147,205,872 |  86,996,782 |
| `total_cells_used    ` |  292,100,833 |  584,201,666 |  376,101,798 |  208,099,868 |
| `insns               ` |  1,663,265 |  3,326,530 |  1,829,995 |  1,496,535 |
| `execute_e3_time_ms  ` |  594.50 |  1,189 |  668 |  521 |
| `execute_e3_insn_mi/s` |  2.80 | -          |  2.87 |  2.74 |
| `memory_finalize_time_ms` |  10 |  20 |  12 |  8 |
| `boundary_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  3,571.50 |  7,143 |  4,478 |  2,665 |
| `main_trace_commit_time_ms` |  635.50 |  1,271 |  751 |  520 |
| `generate_perm_trace_time_ms` |  319.50 |  639 |  419 |  220 |
| `perm_trace_commit_time_ms` |  853 |  1,706 |  1,110 |  596 |
| `quotient_poly_compute_time_ms` |  417.50 |  835 |  537 |  298 |
| `quotient_poly_commit_time_ms` |  288.50 |  577 |  340 |  237 |
| `pcs_opening_time_ms ` |  1,050 |  2,100 |  1,313 |  787 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 6,885 |  | 1 |  |  | 1 |  |  |  | 
| regex_program |  | 3,902 |  | 24 | 4,165,433 | 1 | 38 | 108.98 | 62 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 230 | 208,099,868 | 319,626,730 | 2,665 | 298 | 237 | 596 | 787 | 8 | 520 | 86,996,782 | 1,496,535 | 220 | 521 | 2.87 | 0 | 
| leaf | 1 | 373 | 376,101,798 | 538,660,330 | 4,478 | 537 | 340 | 1,110 | 1,313 | 12 | 751 | 147,205,872 | 1,829,995 | 419 | 668 | 2.74 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 526 | 211,864,680 | 373,166,268 | 3,793 | 435 | 364 | 752 | 1,176 | 239 | 26 | 11 | 754 | 91,153,694 | 2,244,000 | 302 | 140 | 15.99 | 4 | 
| regex_program | 1 | 303 | 176,237,560 | 242,975,370 | 2,269 | 237 | 190 | 461 | 751 | 69 | 25 | 2 | 420 | 74,277,990 | 1,921,433 | 199 | 107 | 17.80 | 0 | 

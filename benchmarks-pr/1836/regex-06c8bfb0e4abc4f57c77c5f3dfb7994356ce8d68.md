...
| `execute_metered_insn_mi/s` | <span style='color: red'>(+44 [+64.8%])</span> 110.72 | -          | <span style='color: red'>(+44 [+64.8%])</span> 110.72 | <span style='color: red'>(+44 [+64.8%])</span> 110.72 |
...
| `execute_e3_insn_mi/s` | <span style='color: red'>(+4 [+35.9%])</span> 17.03 | -          | <span style='color: red'>(+5 [+41.8%])</span> 17.90 | <span style='color: red'>(+4 [+29.9%])</span> 16.16 |
| `memory_finalize_time_ms` | <span style='color: green'>(-162 [-95.6%])</span> 7.50 | <span style='color: green'>(-325 [-95.6%])</span> 15 | <span style='color: green'>(-256 [-95.9%])</span> 11 | <span style='color: green'>(-69 [-94.5%])</span> 4 |
...
| `merkle_finalize_time_ms` |  155.50 |  311 | <span style='color: red'>(+1 [+0.4%])</span> 243 | <span style='color: green'>(-1 [-1.4%])</span> 68 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+438 [+16.7%])</span> 3,053 | <span style='color: red'>(+875 [+16.7%])</span> 6,106 | <span style='color: red'>(+1019 [+36.5%])</span> 3,810 | <span style='color: green'>(-144 [-5.9%])</span> 2,296 |
| `main_trace_commit_time_ms` | <span style='color: red'>(+84 [+16.7%])</span> 591.50 | <span style='color: red'>(+169 [+16.7%])</span> 1,183 | <span style='color: red'>(+187 [+32.7%])</span> 758 | <span style='color: green'>(-18 [-4.1%])</span> 425 |
| `generate_perm_trace_time_ms` | <span style='color: red'>(+31 [+14.2%])</span> 249.50 | <span style='color: red'>(+62 [+14.2%])</span> 499 | <span style='color: red'>(+69 [+30.0%])</span> 299 | <span style='color: green'>(-7 [-3.4%])</span> 200 |
| `perm_trace_commit_time_ms` | <span style='color: red'>(+59 [+10.6%])</span> 613.50 | <span style='color: red'>(+118 [+10.6%])</span> 1,227 | <span style='color: red'>(+173 [+29.3%])</span> 764 | <span style='color: green'>(-55 [-10.6%])</span> 463 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+69 [+25.6%])</span> 339 | <span style='color: red'>(+138 [+25.6%])</span> 678 | <span style='color: red'>(+148 [+51.6%])</span> 435 | <span style='color: green'>(-10 [-4.0%])</span> 243 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+39 [+16.2%])</span> 280 | <span style='color: red'>(+78 [+16.2%])</span> 560 | <span style='color: red'>(+91 [+33.1%])</span> 366 | <span style='color: green'>(-13 [-6.3%])</span> 194 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+156 [+19.1%])</span> 972 | <span style='color: red'>(+312 [+19.1%])</span> 1,944 | <span style='color: red'>(+354 [+42.7%])</span> 1,184 | <span style='color: green'>(-42 [-5.2%])</span> 760 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `execute_e3_time_ms  ` |  598.50 |  1,197 |  673 |  524 |
| `execute_e3_insn_mi/s` |  2.78 | -          |  2.85 |  2.72 |
| `memory_finalize_time_ms` |  10 |  20 |  12 |  8 |
| `boundary_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  3,558.50 |  7,117 |  4,462 |  2,655 |
| `main_trace_commit_time_ms` |  636 |  1,272 |  752 |  520 |
| `generate_perm_trace_time_ms` |  310 |  620 |  398 |  222 |
| `perm_trace_commit_time_ms` |  851.50 |  1,703 |  1,108 |  595 |
| `quotient_poly_compute_time_ms` |  416 |  832 |  534 |  298 |
| `quotient_poly_commit_time_ms` |  291.50 |  583 |  345 |  238 |
| `pcs_opening_time_ms ` |  1,047.50 |  2,095 |  1,318 |  777 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 6,857 |  | 1 |  |  | 1 |  |  |  | 
| regex_program |  | 3,910 |  | 24 | 4,165,433 | 1 | 37 | 110.72 | 62 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 226 | 319,626,730 | 2,655 | 298 | 238 | 595 | 777 | 8 | 520 | 1,496,582 | 222 | 524 | 2.85 | 0 | 
| leaf | 1 | 369 | 538,660,330 | 4,462 | 534 | 345 | 1,108 | 1,318 | 12 | 752 | 1,830,121 | 398 | 673 | 2.72 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 521 | 373,166,268 | 3,810 | 435 | 366 | 764 | 1,184 | 243 | 25 | 11 | 758 | 2,244,000 | 299 | 138 | 16.16 | 4 | 
| regex_program | 1 | 291 | 242,975,370 | 2,296 | 243 | 194 | 463 | 760 | 68 | 24 | 4 | 425 | 1,921,433 | 200 | 107 | 17.90 | 0 | 

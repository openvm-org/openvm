...
| `execute_metered_insn_mi/s` | <span style='color: red'>(+17 [+913.3%])</span> 18.66 | -          | <span style='color: red'>(+17 [+913.3%])</span> 18.66 | <span style='color: red'>(+17 [+913.3%])</span> 18.66 |
| `execute_e3_time_ms  ` |  84 |  84 |  84 |  84 |
| `execute_e3_insn_mi/s` | <span style='color: red'>(+0 [+0.3%])</span> 1.62 | -          | <span style='color: red'>(+0 [+0.3%])</span> 1.62 | <span style='color: red'>(+0 [+0.3%])</span> 1.62 |
...
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+31 [+3.3%])</span> 974 | <span style='color: red'>(+31 [+3.3%])</span> 974 | <span style='color: red'>(+31 [+3.3%])</span> 974 | <span style='color: red'>(+31 [+3.3%])</span> 974 |
...
| `perm_trace_commit_time_ms` | <span style='color: red'>(+5 [+3.8%])</span> 138 | <span style='color: red'>(+5 [+3.8%])</span> 138 | <span style='color: red'>(+5 [+3.8%])</span> 138 | <span style='color: red'>(+5 [+3.8%])</span> 138 |
...
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+8 [+6.0%])</span> 141 | <span style='color: red'>(+8 [+6.0%])</span> 141 | <span style='color: red'>(+8 [+6.0%])</span> 141 | <span style='color: red'>(+8 [+6.0%])</span> 141 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+8 [+1.9%])</span> 422 | <span style='color: red'>(+8 [+1.9%])</span> 422 | <span style='color: red'>(+8 [+1.9%])</span> 422 | <span style='color: red'>(+8 [+1.9%])</span> 422 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `main_cells_used     ` |  246,666,880 |  246,666,880 |  246,666,880 |  246,666,880 |
| `total_cells_used    ` |  645,425,874 |  645,425,874 |  645,425,874 |  645,425,874 |
| `insns               ` |  2,934,860 |  2,934,860 |  2,934,860 |  2,934,860 |
| `execute_e3_time_ms  ` |  993 |  993 |  993 |  993 |
| `execute_e3_insn_mi/s` |  2.95 | -          |  2.95 |  2.95 |
| `memory_finalize_time_ms` |  13 |  13 |  13 |  13 |
| `boundary_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  8,678 |  8,678 |  8,678 |  8,678 |
| `main_trace_commit_time_ms` |  1,679 |  1,679 |  1,679 |  1,679 |
| `generate_perm_trace_time_ms` |  797 |  797 |  797 |  797 |
| `perm_trace_commit_time_ms` |  2,356 |  2,356 |  2,356 |  2,356 |
| `quotient_poly_compute_time_ms` |  901 |  901 |  901 |  901 |
| `quotient_poly_commit_time_ms` |  709 |  709 |  709 |  709 |
| `pcs_opening_time_ms ` |  2,231 |  2,231 |  2,231 |  2,231 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program |  | 1,645 |  | 10 | 137,284 | 1 | 7 | 18.66 | 43 | 
| leaf | 11,330 |  | 1 |  |  | 1 |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 587 | 645,425,874 | 992,054,762 | 8,678 | 901 | 709 | 2,356 | 2,231 | 13 | 1,679 | 246,666,880 | 2,934,860 | 797 | 993 | 2.95 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 98 | 25,968,337 | 32,925,330 | 974 | 82 | 141 | 138 | 422 | 59 | 11 | 2 | 145 | 8,596,011 | 137,284 | 29 | 84 | 1.62 | 0 | 

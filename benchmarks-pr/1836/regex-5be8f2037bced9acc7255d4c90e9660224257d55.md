...
| `execute_metered_insn_mi/s` | <span style='color: green'>(-1 [-2.0%])</span> 67.71 | -          | <span style='color: green'>(-1 [-2.0%])</span> 67.71 | <span style='color: green'>(-1 [-2.0%])</span> 67.71 |
...
| `execute_e3_insn_mi/s` | <span style='color: red'>(+5 [+36.1%])</span> 17.12 | -          | <span style='color: red'>(+5 [+42.9%])</span> 18.07 | <span style='color: red'>(+4 [+29.3%])</span> 16.17 |
...
| `stark_prove_excluding_trace_time_ms` |  2,597.50 |  5,195 | <span style='color: red'>(+26 [+0.9%])</span> 2,827 | <span style='color: green'>(-21 [-0.9%])</span> 2,368 |
| `main_trace_commit_time_ms` | <span style='color: red'>(+2 [+0.3%])</span> 509.50 | <span style='color: red'>(+3 [+0.3%])</span> 1,019 | <span style='color: red'>(+7 [+1.2%])</span> 578 | <span style='color: green'>(-4 [-0.9%])</span> 441 |
| `generate_perm_trace_time_ms` | <span style='color: green'>(-2 [-0.9%])</span> 212.50 | <span style='color: green'>(-4 [-0.9%])</span> 425 | <span style='color: green'>(-1 [-0.4%])</span> 228 | <span style='color: green'>(-3 [-1.5%])</span> 197 |
| `perm_trace_commit_time_ms` |  556.50 |  1,113 | <span style='color: red'>(+10 [+1.7%])</span> 599 | <span style='color: green'>(-11 [-2.1%])</span> 514 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+3 [+1.1%])</span> 271 | <span style='color: red'>(+6 [+1.1%])</span> 542 | <span style='color: red'>(+4 [+1.4%])</span> 300 | <span style='color: red'>(+2 [+0.8%])</span> 242 |
| `quotient_poly_commit_time_ms` | <span style='color: green'>(-4 [-1.8%])</span> 239.50 | <span style='color: green'>(-9 [-1.8%])</span> 479 | <span style='color: green'>(-10 [-3.6%])</span> 270 | <span style='color: red'>(+1 [+0.5%])</span> 209 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+8 [+0.9%])</span> 800 | <span style='color: red'>(+15 [+0.9%])</span> 1,600 | <span style='color: red'>(+18 [+2.2%])</span> 845 | <span style='color: green'>(-3 [-0.4%])</span> 755 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `execute_e3_time_ms  ` |  589.50 |  1,179 |  673 |  506 |
| `execute_e3_insn_mi/s` |  2.82 | -          |  2.93 |  2.72 |
| `memory_finalize_time_ms` |  26 |  52 |  44 |  8 |
| `boundary_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  3,786.50 |  7,573 |  4,728 |  2,845 |
| `main_trace_commit_time_ms` |  722.50 |  1,445 |  857 |  588 |
| `generate_perm_trace_time_ms` |  331.50 |  663 |  430 |  233 |
| `perm_trace_commit_time_ms` |  958.50 |  1,917 |  1,245 |  672 |
| `quotient_poly_compute_time_ms` |  423.50 |  847 |  528 |  319 |
| `quotient_poly_commit_time_ms` |  315 |  630 |  375 |  255 |
| `pcs_opening_time_ms ` |  1,030.50 |  2,061 |  1,288 |  773 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 7,240 |  | 1 |  |  | 1 |  |  | 
| regex_program |  | 3,982 |  | 23 | 4,165,433 | 1 | 61 | 67.71 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 214 | 319,626,730 | 2,845 | 319 | 255 | 672 | 773 | 8 | 588 | 1,481,332 | 233 | 506 | 2.93 | 0 | 
| leaf | 1 | 348 | 538,660,330 | 4,728 | 528 | 375 | 1,245 | 1,288 | 44 | 857 | 1,830,079 | 430 | 673 | 2.72 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 520 | 275,648,700 | 2,827 | 300 | 270 | 599 | 845 | 242 | 23 | 11 | 578 | 2,243,700 | 228 | 138 | 16.17 | 4 | 
| regex_program | 1 | 294 | 242,975,370 | 2,368 | 242 | 209 | 514 | 755 | 66 | 23 | 3 | 441 | 1,921,733 | 197 | 106 | 18.07 | 0 | 

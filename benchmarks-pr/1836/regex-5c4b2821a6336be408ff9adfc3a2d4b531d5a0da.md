...
| `execute_metered_insn_mi/s` | <span style='color: red'>(+0 [+0.7%])</span> 67.63 | -          | <span style='color: red'>(+0 [+0.7%])</span> 67.63 | <span style='color: red'>(+0 [+0.7%])</span> 67.63 |
...
| `execute_e3_insn_mi/s` | <span style='color: red'>(+5 [+36.0%])</span> 17.04 | -          | <span style='color: red'>(+5 [+41.9%])</span> 17.91 | <span style='color: red'>(+4 [+29.9%])</span> 16.16 |
...
| `merkle_finalize_time_ms` | <span style='color: green'>(-4 [-2.6%])</span> 151.50 | <span style='color: green'>(-8 [-2.6%])</span> 303 | <span style='color: green'>(-9 [-3.7%])</span> 233 | <span style='color: red'>(+1 [+1.4%])</span> 70 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: green'>(-104 [-4.0%])</span> 2,511 | <span style='color: green'>(-209 [-4.0%])</span> 5,022 | <span style='color: green'>(-58 [-2.1%])</span> 2,733 | <span style='color: green'>(-151 [-6.2%])</span> 2,289 |
| `main_trace_commit_time_ms` | <span style='color: green'>(-41 [-8.1%])</span> 466 | <span style='color: green'>(-82 [-8.1%])</span> 932 | <span style='color: green'>(-40 [-7.0%])</span> 531 | <span style='color: green'>(-42 [-9.5%])</span> 401 |
| `generate_perm_trace_time_ms` | <span style='color: red'>(+8 [+3.4%])</span> 226 | <span style='color: red'>(+15 [+3.4%])</span> 452 | <span style='color: red'>(+5 [+2.2%])</span> 235 | <span style='color: red'>(+10 [+4.8%])</span> 217 |
| `perm_trace_commit_time_ms` | <span style='color: green'>(-54 [-9.8%])</span> 500 | <span style='color: green'>(-109 [-9.8%])</span> 1,000 | <span style='color: green'>(-53 [-9.0%])</span> 538 | <span style='color: green'>(-56 [-10.8%])</span> 462 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+6 [+2.2%])</span> 276 | <span style='color: red'>(+12 [+2.2%])</span> 552 | <span style='color: red'>(+11 [+3.8%])</span> 298 | <span style='color: red'>(+1 [+0.4%])</span> 254 |
| `quotient_poly_commit_time_ms` | <span style='color: green'>(-2 [-0.8%])</span> 239 | <span style='color: green'>(-4 [-0.8%])</span> 478 | <span style='color: red'>(+11 [+4.0%])</span> 286 | <span style='color: green'>(-15 [-7.2%])</span> 192 |
| `pcs_opening_time_ms ` | <span style='color: green'>(-20 [-2.5%])</span> 796 | <span style='color: green'>(-40 [-2.5%])</span> 1,592 | <span style='color: red'>(+9 [+1.1%])</span> 839 | <span style='color: green'>(-49 [-6.1%])</span> 753 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `execute_e3_time_ms  ` |  585 |  1,170 |  663 |  507 |
| `execute_e3_insn_mi/s` |  2.84 | -          |  2.92 |  2.76 |
| `memory_finalize_time_ms` |  10.50 |  21 |  12 |  9 |
| `boundary_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  3,583.50 |  7,167 |  4,458 |  2,709 |
| `main_trace_commit_time_ms` |  644 |  1,288 |  764 |  524 |
| `generate_perm_trace_time_ms` |  332 |  664 |  424 |  240 |
| `perm_trace_commit_time_ms` |  855 |  1,710 |  1,108 |  602 |
| `quotient_poly_compute_time_ms` |  419.50 |  839 |  526 |  313 |
| `quotient_poly_commit_time_ms` |  293.50 |  587 |  346 |  241 |
| `pcs_opening_time_ms ` |  1,034 |  2,068 |  1,285 |  783 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 6,914 |  | 1 |  |  | 1 |  |  |  | 
| regex_program |  | 3,901 |  | 25 | 4,165,433 | 1 | 61 | 67.63 | 62 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 214 | 319,626,730 | 2,709 | 313 | 241 | 602 | 783 | 9 | 524 | 1,481,457 | 240 | 507 | 2.92 | 0 | 
| leaf | 1 | 347 | 538,660,330 | 4,458 | 526 | 346 | 1,108 | 1,285 | 12 | 764 | 1,830,031 | 424 | 663 | 2.76 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 510 | 275,648,700 | 2,733 | 298 | 286 | 538 | 839 | 233 | 25 | 11 | 531 | 2,243,700 | 235 | 138 | 16.16 | 4 | 
| regex_program | 1 | 297 | 242,975,370 | 2,289 | 254 | 192 | 462 | 753 | 70 | 24 | 3 | 401 | 1,921,733 | 217 | 107 | 17.91 | 0 | 

...
| `execute_metered_insn_mi/s` | <span style='color: red'>(+45 [+66.8%])</span> 112.09 | -          | <span style='color: red'>(+45 [+66.8%])</span> 112.09 | <span style='color: red'>(+45 [+66.8%])</span> 112.09 |
...
| `execute_e3_insn_mi/s` | <span style='color: red'>(+4 [+35.3%])</span> 16.95 | -          | <span style='color: red'>(+5 [+41.5%])</span> 17.86 | <span style='color: red'>(+4 [+28.9%])</span> 16.04 |
...
| `merkle_finalize_time_ms` | <span style='color: green'>(-2 [-1.6%])</span> 153 | <span style='color: green'>(-5 [-1.6%])</span> 306 | <span style='color: green'>(-4 [-1.7%])</span> 238 | <span style='color: green'>(-1 [-1.4%])</span> 68 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+439 [+16.8%])</span> 3,054.50 | <span style='color: red'>(+878 [+16.8%])</span> 6,109 | <span style='color: red'>(+1029 [+36.9%])</span> 3,820 | <span style='color: green'>(-151 [-6.2%])</span> 2,289 |
| `main_trace_commit_time_ms` | <span style='color: red'>(+86 [+16.9%])</span> 592.50 | <span style='color: red'>(+171 [+16.9%])</span> 1,185 | <span style='color: red'>(+192 [+33.6%])</span> 763 | <span style='color: green'>(-21 [-4.7%])</span> 422 |
| `generate_perm_trace_time_ms` | <span style='color: red'>(+38 [+17.6%])</span> 257 | <span style='color: red'>(+77 [+17.6%])</span> 514 | <span style='color: red'>(+73 [+31.7%])</span> 303 | <span style='color: red'>(+4 [+1.9%])</span> 211 |
| `perm_trace_commit_time_ms` | <span style='color: red'>(+55 [+9.9%])</span> 609.50 | <span style='color: red'>(+110 [+9.9%])</span> 1,219 | <span style='color: red'>(+167 [+28.3%])</span> 758 | <span style='color: green'>(-57 [-11.0%])</span> 461 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+68 [+25.0%])</span> 337.50 | <span style='color: red'>(+135 [+25.0%])</span> 675 | <span style='color: red'>(+141 [+49.1%])</span> 428 | <span style='color: green'>(-6 [-2.4%])</span> 247 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+42 [+17.6%])</span> 283.50 | <span style='color: red'>(+85 [+17.6%])</span> 567 | <span style='color: red'>(+101 [+36.7%])</span> 376 | <span style='color: green'>(-16 [-7.7%])</span> 191 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+151 [+18.5%])</span> 967 | <span style='color: red'>(+302 [+18.5%])</span> 1,934 | <span style='color: red'>(+356 [+42.9%])</span> 1,186 | <span style='color: green'>(-54 [-6.7%])</span> 748 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `main_cells_used     ` |  117,101,453 |  234,202,906 |  147,205,944 |  86,996,962 |
| `total_cells_used    ` |  292,101,253 |  584,202,506 |  376,102,038 |  208,100,468 |
| `insns               ` |  1,663,275.50 |  3,326,551 |  1,830,001 |  1,496,550 |
| `execute_e3_time_ms  ` |  592.50 |  1,185 |  666 |  519 |
| `execute_e3_insn_mi/s` |  2.81 | -          |  2.88 |  2.74 |
| `memory_finalize_time_ms` |  10 |  20 |  12 |  8 |
| `boundary_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  3,597 |  7,194 |  4,501 |  2,693 |
| `main_trace_commit_time_ms` |  650.50 |  1,301 |  768 |  533 |
| `generate_perm_trace_time_ms` |  324.50 |  649 |  416 |  233 |
| `perm_trace_commit_time_ms` |  850.50 |  1,701 |  1,105 |  596 |
| `quotient_poly_compute_time_ms` |  429 |  858 |  551 |  307 |
| `quotient_poly_commit_time_ms` |  299 |  598 |  358 |  240 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 6,922 |  | 1 |  |  | 1 |  |  |  | 
| regex_program |  | 3,945 |  | 24 | 4,165,433 | 1 | 37 | 112.09 | 62 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 223 | 208,100,468 | 319,626,730 | 2,693 | 307 | 240 | 596 | 775 | 8 | 533 | 86,996,962 | 1,496,550 | 233 | 519 | 2.88 | 0 | 
| leaf | 1 | 360 | 376,102,038 | 538,660,330 | 4,501 | 551 | 358 | 1,105 | 1,295 | 12 | 768 | 147,205,944 | 1,830,001 | 416 | 666 | 2.74 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 525 | 211,864,680 | 373,166,268 | 3,820 | 428 | 376 | 758 | 1,186 | 238 | 25 | 11 | 763 | 91,153,694 | 2,244,000 | 303 | 139 | 16.04 | 4 | 
| regex_program | 1 | 301 | 176,237,560 | 242,975,370 | 2,289 | 247 | 191 | 461 | 748 | 68 | 24 | 2 | 422 | 74,277,990 | 1,921,433 | 211 | 107 | 17.86 | 0 | 

...
| `execute_metered_insn_mi/s` | <span style='color: red'>(+45 [+67.3%])</span> 112.39 | -          | <span style='color: red'>(+45 [+67.3%])</span> 112.39 | <span style='color: red'>(+45 [+67.3%])</span> 112.39 |
...
| `execute_e3_insn_mi/s` | <span style='color: red'>(+4 [+35.6%])</span> 16.99 | -          | <span style='color: red'>(+5 [+41.4%])</span> 17.84 | <span style='color: red'>(+4 [+29.8%])</span> 16.14 |
...
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+422 [+16.2%])</span> 3,038 | <span style='color: red'>(+845 [+16.2%])</span> 6,076 | <span style='color: red'>(+1008 [+36.1%])</span> 3,799 | <span style='color: green'>(-163 [-6.7%])</span> 2,277 |
| `main_trace_commit_time_ms` | <span style='color: red'>(+82 [+16.1%])</span> 588.50 | <span style='color: red'>(+163 [+16.1%])</span> 1,177 | <span style='color: red'>(+187 [+32.7%])</span> 758 | <span style='color: green'>(-24 [-5.4%])</span> 419 |
| `generate_perm_trace_time_ms` | <span style='color: red'>(+36 [+16.5%])</span> 254.50 | <span style='color: red'>(+72 [+16.5%])</span> 509 | <span style='color: red'>(+70 [+30.4%])</span> 300 | <span style='color: red'>(+2 [+1.0%])</span> 209 |
| `perm_trace_commit_time_ms` | <span style='color: red'>(+54 [+9.8%])</span> 609 | <span style='color: red'>(+109 [+9.8%])</span> 1,218 | <span style='color: red'>(+166 [+28.1%])</span> 757 | <span style='color: green'>(-57 [-11.0%])</span> 461 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+71 [+26.3%])</span> 341 | <span style='color: red'>(+142 [+26.3%])</span> 682 | <span style='color: red'>(+151 [+52.6%])</span> 438 | <span style='color: green'>(-9 [-3.6%])</span> 244 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+38 [+15.6%])</span> 278.50 | <span style='color: red'>(+75 [+15.6%])</span> 557 | <span style='color: red'>(+92 [+33.5%])</span> 367 | <span style='color: green'>(-17 [-8.2%])</span> 190 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+144 [+17.6%])</span> 959.50 | <span style='color: red'>(+287 [+17.6%])</span> 1,919 | <span style='color: red'>(+344 [+41.4%])</span> 1,174 | <span style='color: green'>(-57 [-7.1%])</span> 745 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `main_cells_used     ` |  117,101,555 |  234,203,110 |  147,205,596 |  86,997,514 |
| `total_cells_used    ` |  292,101,593 |  584,203,186 |  376,100,878 |  208,102,308 |
| `insns               ` |  1,663,284 |  3,326,568 |  1,829,972 |  1,496,596 |
| `execute_e3_time_ms  ` |  593.50 |  1,187 |  670 |  517 |
| `execute_e3_insn_mi/s` |  2.81 | -          |  2.89 |  2.73 |
| `memory_finalize_time_ms` |  10 |  20 |  13 |  7 |
| `boundary_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  3,546.50 |  7,093 |  4,414 |  2,679 |
| `main_trace_commit_time_ms` |  640.50 |  1,281 |  751 |  530 |
| `generate_perm_trace_time_ms` |  318 |  636 |  410 |  226 |
| `perm_trace_commit_time_ms` |  850.50 |  1,701 |  1,104 |  597 |
| `quotient_poly_compute_time_ms` |  417.50 |  835 |  526 |  309 |
| `quotient_poly_commit_time_ms` |  291 |  582 |  343 |  239 |
| `pcs_opening_time_ms ` |  1,022 |  2,044 |  1,272 |  772 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 6,820 |  | 1 |  |  | 1 |  |  |  | 
| regex_program |  | 3,902 |  | 23 | 4,165,433 | 1 | 37 | 112.39 | 61 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 221 | 208,102,308 | 319,626,730 | 2,679 | 309 | 239 | 597 | 772 | 7 | 530 | 86,997,514 | 1,496,596 | 226 | 517 | 2.89 | 0 | 
| leaf | 1 | 357 | 376,100,878 | 538,660,330 | 4,414 | 526 | 343 | 1,104 | 1,272 | 13 | 751 | 147,205,596 | 1,829,972 | 410 | 670 | 2.73 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 535 | 211,864,680 | 373,166,268 | 3,799 | 438 | 367 | 757 | 1,174 | 240 | 25 | 11 | 758 | 91,153,694 | 2,244,000 | 300 | 138 | 16.14 | 4 | 
| regex_program | 1 | 310 | 176,237,560 | 242,975,370 | 2,277 | 244 | 190 | 461 | 745 | 68 | 24 | 2 | 419 | 74,277,990 | 1,921,433 | 209 | 107 | 17.84 | 0 | 

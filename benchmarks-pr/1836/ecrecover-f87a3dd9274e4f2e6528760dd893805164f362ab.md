...
| `execute_metered_insn_mi/s` | <span style='color: red'>(+15 [+806.6%])</span> 16.70 | -          | <span style='color: red'>(+15 [+806.6%])</span> 16.70 | <span style='color: red'>(+15 [+806.6%])</span> 16.70 |
...
| `execute_e3_insn_mi/s` | <span style='color: red'>(+0 [+2.0%])</span> 1.65 | -          | <span style='color: red'>(+0 [+2.0%])</span> 1.65 | <span style='color: red'>(+0 [+2.0%])</span> 1.65 |
...
| `merkle_finalize_time_ms` | <span style='color: green'>(-14 [-20.0%])</span> 56 | <span style='color: green'>(-14 [-20.0%])</span> 56 | <span style='color: green'>(-14 [-20.0%])</span> 56 | <span style='color: green'>(-14 [-20.0%])</span> 56 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+125 [+13.3%])</span> 1,068 | <span style='color: red'>(+125 [+13.3%])</span> 1,068 | <span style='color: red'>(+125 [+13.3%])</span> 1,068 | <span style='color: red'>(+125 [+13.3%])</span> 1,068 |
| `main_trace_commit_time_ms` | <span style='color: red'>(+13 [+9.4%])</span> 151 | <span style='color: red'>(+13 [+9.4%])</span> 151 | <span style='color: red'>(+13 [+9.4%])</span> 151 | <span style='color: red'>(+13 [+9.4%])</span> 151 |
| `generate_perm_trace_time_ms` |  30 |  30 |  30 |  30 |
| `perm_trace_commit_time_ms` | <span style='color: red'>(+39 [+29.3%])</span> 172 | <span style='color: red'>(+39 [+29.3%])</span> 172 | <span style='color: red'>(+39 [+29.3%])</span> 172 | <span style='color: red'>(+39 [+29.3%])</span> 172 |
...
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+4 [+3.0%])</span> 137 | <span style='color: red'>(+4 [+3.0%])</span> 137 | <span style='color: red'>(+4 [+3.0%])</span> 137 | <span style='color: red'>(+4 [+3.0%])</span> 137 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+66 [+15.9%])</span> 480 | <span style='color: red'>(+66 [+15.9%])</span> 480 | <span style='color: red'>(+66 [+15.9%])</span> 480 | <span style='color: red'>(+66 [+15.9%])</span> 480 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `execute_e3_time_ms  ` |  1,007 |  1,007 |  1,007 |  1,007 |
| `execute_e3_insn_mi/s` |  2.91 | -          |  2.91 |  2.91 |
| `memory_finalize_time_ms` |  13 |  13 |  13 |  13 |
| `boundary_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  8,674 |  8,674 |  8,674 |  8,674 |
| `main_trace_commit_time_ms` |  1,665 |  1,665 |  1,665 |  1,665 |
| `generate_perm_trace_time_ms` |  808 |  808 |  808 |  808 |
| `perm_trace_commit_time_ms` |  2,358 |  2,358 |  2,358 |  2,358 |
| `quotient_poly_compute_time_ms` |  897 |  897 |  897 |  897 |
| `quotient_poly_commit_time_ms` |  698 |  698 |  698 |  698 |
| `pcs_opening_time_ms ` |  2,242 |  2,242 |  2,242 |  2,242 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program |  | 1,719 |  | 9 | 137,284 | 1 | 8 | 16.70 | 40 | 
| leaf | 11,323 |  | 1 |  |  | 1 |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 584 | 992,054,762 | 8,674 | 897 | 698 | 2,358 | 2,242 | 13 | 1,665 | 2,934,967 | 808 | 1,007 | 2.91 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 94 | 32,925,330 | 1,068 | 82 | 137 | 172 | 480 | 56 | 10 | 1 | 151 | 137,284 | 30 | 83 | 1.65 | 0 | 

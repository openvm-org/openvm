...
| `execute_e3_insn_mi/s` | <span style='color: red'>(+5 [+36.0%])</span> 17.10 | -          | <span style='color: red'>(+5 [+42.5%])</span> 18.02 | <span style='color: red'>(+4 [+29.4%])</span> 16.18 |
| `memory_finalize_time_ms` | <span style='color: green'>(-163 [-96.4%])</span> 6 | <span style='color: green'>(-326 [-96.4%])</span> 12 | <span style='color: green'>(-254 [-96.2%])</span> 10 | <span style='color: green'>(-72 [-97.3%])</span> 2 |
...
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+10 [+0.4%])</span> 2,605 | <span style='color: red'>(+20 [+0.4%])</span> 5,210 | <span style='color: red'>(+23 [+0.8%])</span> 2,824 | <span style='color: green'>(-3 [-0.1%])</span> 2,386 |
| `main_trace_commit_time_ms` | <span style='color: red'>(+1 [+0.2%])</span> 509 | <span style='color: red'>(+2 [+0.2%])</span> 1,018 | <span style='color: green'>(-1 [-0.2%])</span> 570 | <span style='color: red'>(+3 [+0.7%])</span> 448 |
| `generate_perm_trace_time_ms` | <span style='color: red'>(+8 [+3.5%])</span> 222 | <span style='color: red'>(+15 [+3.5%])</span> 444 | <span style='color: red'>(+3 [+1.3%])</span> 232 | <span style='color: red'>(+12 [+6.0%])</span> 212 |
| `perm_trace_commit_time_ms` | <span style='color: red'>(+1 [+0.2%])</span> 558 | <span style='color: red'>(+2 [+0.2%])</span> 1,116 | <span style='color: red'>(+11 [+1.9%])</span> 600 | <span style='color: green'>(-9 [-1.7%])</span> 516 |
| `quotient_poly_compute_time_ms` | <span style='color: green'>(-6 [-2.2%])</span> 262 | <span style='color: green'>(-12 [-2.2%])</span> 524 | <span style='color: green'>(-8 [-2.7%])</span> 288 | <span style='color: green'>(-4 [-1.7%])</span> 236 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+0 [+0.2%])</span> 244.50 | <span style='color: red'>(+1 [+0.2%])</span> 489 | <span style='color: red'>(+3 [+1.1%])</span> 283 | <span style='color: green'>(-2 [-1.0%])</span> 206 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+9 [+1.1%])</span> 801.50 | <span style='color: red'>(+18 [+1.1%])</span> 1,603 | <span style='color: red'>(+18 [+2.2%])</span> 845 |  758 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `execute_e3_time_ms  ` |  587 |  1,174 |  672 |  502 |
| `execute_e3_insn_mi/s` |  2.83 | -          |  2.95 |  2.72 |
| `memory_finalize_time_ms` |  9.50 |  19 |  11 |  8 |
| `boundary_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  3,776.50 |  7,553 |  4,712 |  2,841 |
| `main_trace_commit_time_ms` |  721.50 |  1,443 |  857 |  586 |
| `generate_perm_trace_time_ms` |  321 |  642 |  408 |  234 |
| `perm_trace_commit_time_ms` |  958.50 |  1,917 |  1,246 |  671 |
| `quotient_poly_compute_time_ms` |  421 |  842 |  529 |  313 |
| `quotient_poly_commit_time_ms` |  316 |  632 |  377 |  255 |
| `pcs_opening_time_ms ` |  1,034 |  2,068 |  1,292 |  776 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 7,247 |  | 1 |  |  | 1 |  |  | 
| regex_program |  | 4,010 |  | 23 | 4,165,433 | 1 | 61 | 67.53 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 229 | 319,626,730 | 2,841 | 313 | 255 | 671 | 776 | 8 | 586 | 1,481,412 | 234 | 502 | 2.95 | 0 | 
| leaf | 1 | 372 | 538,660,330 | 4,712 | 529 | 377 | 1,246 | 1,292 | 11 | 857 | 1,830,065 | 408 | 672 | 2.72 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 534 | 275,648,700 | 2,824 | 288 | 283 | 600 | 845 | 245 | 24 | 10 | 570 | 2,243,700 | 232 | 138 | 16.18 | 4 | 
| regex_program | 1 | 304 | 242,975,370 | 2,386 | 236 | 206 | 516 | 758 | 67 | 23 | 2 | 448 | 1,921,733 | 212 | 106 | 18.02 | 0 | 

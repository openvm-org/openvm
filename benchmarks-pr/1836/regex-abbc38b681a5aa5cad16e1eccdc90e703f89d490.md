...
| `execute_metered_time_ms` | <span style='color: red'>(+2 [+3.3%])</span> 63 | -          | -          | -          |
| `execute_metered_insn_mi/s` | <span style='color: green'>(-1 [-2.1%])</span> 65.80 | -          | <span style='color: green'>(-1 [-2.1%])</span> 65.80 | <span style='color: green'>(-1 [-2.1%])</span> 65.80 |
| `execute_e3_time_ms  ` | <span style='color: green'>(-44 [-26.8%])</span> 121.50 | <span style='color: green'>(-89 [-26.8%])</span> 243 | <span style='color: green'>(-43 [-23.9%])</span> 137 | <span style='color: green'>(-46 [-30.3%])</span> 106 |
| `execute_e3_insn_mi/s` | <span style='color: red'>(+5 [+36.8%])</span> 17.14 | -          | <span style='color: red'>(+5 [+42.6%])</span> 17.100 | <span style='color: red'>(+4 [+30.9%])</span> 16.28 |
...
| `merkle_finalize_time_ms` | <span style='color: green'>(-4 [-2.6%])</span> 151.50 | <span style='color: green'>(-8 [-2.6%])</span> 303 | <span style='color: green'>(-6 [-2.5%])</span> 236 | <span style='color: green'>(-2 [-2.9%])</span> 67 |
| `stark_prove_excluding_trace_time_ms` |  2,614 |  5,228 | <span style='color: red'>(+46 [+1.6%])</span> 2,837 | <span style='color: green'>(-49 [-2.0%])</span> 2,391 |
| `main_trace_commit_time_ms` | <span style='color: red'>(+4 [+0.9%])</span> 511.50 | <span style='color: red'>(+9 [+0.9%])</span> 1,023 | <span style='color: red'>(+9 [+1.6%])</span> 580 |  443 |
| `generate_perm_trace_time_ms` | <span style='color: green'>(-6 [-2.7%])</span> 212.50 | <span style='color: green'>(-12 [-2.7%])</span> 425 | <span style='color: green'>(-6 [-2.6%])</span> 224 | <span style='color: green'>(-6 [-2.9%])</span> 201 |
| `perm_trace_commit_time_ms` | <span style='color: red'>(+6 [+1.1%])</span> 560.50 | <span style='color: red'>(+12 [+1.1%])</span> 1,121 | <span style='color: red'>(+14 [+2.4%])</span> 605 | <span style='color: green'>(-2 [-0.4%])</span> 516 |
| `quotient_poly_compute_time_ms` | <span style='color: green'>(-7 [-2.6%])</span> 263 | <span style='color: green'>(-14 [-2.6%])</span> 526 | <span style='color: green'>(-4 [-1.4%])</span> 283 | <span style='color: green'>(-10 [-4.0%])</span> 243 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+12 [+5.2%])</span> 253.50 | <span style='color: red'>(+25 [+5.2%])</span> 507 | <span style='color: red'>(+25 [+9.1%])</span> 300 |  207 |
| `pcs_opening_time_ms ` | <span style='color: green'>(-12 [-1.4%])</span> 804.50 | <span style='color: green'>(-23 [-1.4%])</span> 1,609 | <span style='color: red'>(+9 [+1.1%])</span> 839 | <span style='color: green'>(-32 [-4.0%])</span> 770 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `execute_e3_time_ms  ` |  582 |  1,164 |  663 |  501 |
| `execute_e3_insn_mi/s` |  2.86 | -          |  2.95 |  2.76 |
| `memory_finalize_time_ms` |  9.50 |  19 |  11 |  8 |
| `boundary_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  3,780.50 |  7,561 |  4,725 |  2,836 |
| `main_trace_commit_time_ms` |  716.50 |  1,433 |  844 |  589 |
| `generate_perm_trace_time_ms` |  329 |  658 |  420 |  238 |
| `perm_trace_commit_time_ms` |  958 |  1,916 |  1,244 |  672 |
| `quotient_poly_compute_time_ms` |  412 |  824 |  527 |  297 |
| `quotient_poly_commit_time_ms` |  318.50 |  637 |  381 |  256 |
| `pcs_opening_time_ms ` |  1,038 |  2,076 |  1,297 |  779 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 7,206 |  | 1 |  |  | 1 |  |  |  | 
| regex_program |  | 4,049 |  | 24 | 4,165,433 | 1 | 63 | 65.80 | 62 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 219 | 319,626,730 | 2,836 | 297 | 256 | 672 | 779 | 8 | 589 | 1,481,349 | 238 | 501 | 2.95 | 0 | 
| leaf | 1 | 359 | 538,660,330 | 4,725 | 527 | 381 | 1,244 | 1,297 | 11 | 844 | 1,830,047 | 420 | 663 | 2.76 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 527 | 275,648,700 | 2,837 | 283 | 300 | 605 | 839 | 236 | 25 | 11 | 580 | 2,243,700 | 224 | 137 | 16.28 | 4 | 
| regex_program | 1 | 307 | 242,975,370 | 2,391 | 243 | 207 | 516 | 770 | 67 | 24 | 2 | 443 | 1,921,733 | 201 | 106 | 17.100 | 0 | 

...
|:---|---:|---:|---:|
| Total |  2.41 |  1.77 |  1.77 |
| app_proof |  1.41 |  0.78 |  0.78 |
| leaf |  0.39 |  0.39 |  0.39 |
...
| `total_proof_time_ms ` |  694.50 |  1,389 |  755 |  634 |
| `compile_metered_time_ms` |  3 |  3 |  3 |  3 |
| `execute_metered_time_ms` |  20 | -          | -          | -          |
| `execute_metered_insns` |  4,000,051 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  194.16 | -          |  194.16 |  194.16 |
| `execute_preflight_insns` |  2,000,025.50 |  4,000,051 |  2,621,000 |  1,379,051 |
| `execute_preflight_time_ms` |  65.50 |  131 |  79 |  52 |
| `execute_preflight_insn_mi/s` |  37.84 | -          |  39.80 |  35.88 |
| `trace_gen_time_ms   ` |  23 |  46 |  24 |  22 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  516.50 |  1,033 |  518 |  515 |
| `prover.main_trace_commit_time_ms` |  97.50 |  195 |  98 |  97 |
| `prover.rap_constraints_time_ms` |  318.50 |  637 |  320 |  317 |
| `prover.openings_time_ms` |  99.50 |  199 |  100 |  99 |
| `prover.rap_constraints.logup_gkr_time_ms` |  230.50 |  461 |  231 |  230 |
| `prover.rap_constraints.round0_time_ms` |  64 |  128 |  65 |  63 |
| `prover.rap_constraints.mle_rounds_time_ms` |  23 |  46 |  23 |  23 |
| `prover.openings.stacked_reduction_time_ms` |  19 |  38 |  19 |  19 |
| `prover.openings.stacked_reduction.round0_time_ms` |  10 |  20 |  10 |  10 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  8 |  16 |  8 |  8 |
| `prover.openings.whir_time_ms` |  80.50 |  161 |  81 |  80 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/87700d72e28c8cc758d9d76eada7bf8d5bd322e5/fibonacci-87700d72e28c8cc758d9d76eada7bf8d5bd322e5.memory.svg)

| Module | Max (GB) | Max At |
| --- | ---: | --- |
| prover.batch_constraints.before_round0 | 3.05 | app_proof.prover.0 |
| frac_sumcheck.gkr_rounds | 3.05 | app_proof.prover.0 |
| frac_sumcheck.segment_tree | 2.82 | app_proof.prover.0 |
| prover.gkr_input_evals | 2.82 | app_proof.prover.0 |
...
| prover.batch_constraints.fold_ple_evals | 1.36 | app_proof.prover.0 |
| prover.rap_constraints | 1.36 | app_proof.prover.0 |
| prover.batch_constraints.round0 | 1.36 | app_proof.prover.0 |
...
| app_proof |  |  |  |  |  | 634 |  |  | 20 | 4,000,051 | 194.16 | 0 | 1,415 |  | 
...
| internal_recursive.0 | 1 | 12 | 180 | 11 | 1 | 0 | 2 | 0 | 1 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 27,277,885 | 264 | 82 | 0 | 0 | 98 | 32 | 31 | 45 | 20 | 0 | 83 | 71 | 11 | 2 | 8 | 83 | 98 | 0 | 3 | 18 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 167 | 46 | 0 | 0 | 67 | 25 | 24 | 28 | 14 | 0 | 52 | 44 | 8 | 1 | 6 | 47 | 67 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 138 | 32 | 0 | 0 | 62 | 23 | 23 | 24 | 14 | 0 | 42 | 35 | 7 | 1 | 5 | 32 | 62 | 0 | 3 | 13 | 0 | 0 | 
| leaf | 0 | prover | 74,737,496 | 347 | 122 | 0 | 0 | 114 | 51 | 50 | 34 | 28 | 0 | 109 | 95 | 14 | 6 | 8 | 123 | 114 | 0 | 6 | 27 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 119,796,216 | 518 | 97 | 0 | 0 | 320 | 65 | 65 | 23 | 231 | 0 | 100 | 81 | 19 | 10 | 8 | 97 | 320 | 0 | 3 | 229 | 0 | 0 | 
| app_proof | prover | 1 | 119,795,168 | 515 | 98 | 0 | 0 | 317 | 63 | 62 | 23 | 230 | 0 | 99 | 80 | 19 | 10 | 8 | 98 | 317 | 0 | 3 | 229 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 2 | 22 | 755 | 22 | 135 | 3,176,285,986 | 1,768,942 | 3,178,054,928 | 2,097,152 | 0 | 3 | 79 | 2,621,000 | 35.88 | 
| app_proof | 1 | 1 | 24 | 634 | 24 | 41 | 1,707,679,788 | 1,468,951,987 | 3,176,631,775 | 2,097,152 | 0 | 2 | 52 | 1,379,051 | 39.80 | 

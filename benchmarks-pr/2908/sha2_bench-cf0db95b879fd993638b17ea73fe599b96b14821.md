...
|:---|---:|---:|---:|
| Total |  11.90 |  6.86 |  6.86 |
| app_proof |  10.18 |  5.14 |  5.14 |
| leaf |  1.03 |  1.03 |  1.03 |
...
| `total_proof_time_ms ` |  5,043 |  10,086 |  5,045 |  5,041 |
...
| `execute_preflight_time_ms` |  306.50 |  613 |  417 |  196 |
| `execute_preflight_insn_mi/s` |  34.24 | -          |  36.01 |  32.47 |
| `trace_gen_time_ms   ` |  131 |  262 |  152 |  110 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  4,515.50 |  9,031 |  4,560 |  4,471 |
| `prover.main_trace_commit_time_ms` |  1,268.50 |  2,537 |  1,307 |  1,230 |
| `prover.rap_constraints_time_ms` |  2,375 |  4,750 |  2,378 |  2,372 |
| `prover.openings_time_ms` |  871 |  1,742 |  874 |  868 |
| `prover.rap_constraints.logup_gkr_time_ms` |  604.50 |  1,209 |  605 |  604 |
| `prover.rap_constraints.round0_time_ms` |  1,290.50 |  2,581 |  1,295 |  1,286 |
| `prover.rap_constraints.mle_rounds_time_ms` |  479 |  958 |  481 |  477 |
| `prover.openings.stacked_reduction_time_ms` |  206.50 |  413 |  207 |  206 |
| `prover.openings.stacked_reduction.round0_time_ms` |  129 |  258 |  129 |  129 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  77.50 |  155 |  78 |  77 |
| `prover.openings.whir_time_ms` |  664 |  1,328 |  667 |  661 |
...
| `prover.openings.whir_time_ms` |  266 |  266 |  266 |  266 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/cf0db95b879fd993638b17ea73fe599b96b14821/sha2_bench-cf0db95b879fd993638b17ea73fe599b96b14821.memory.svg)
...
| app_proof |  |  |  |  |  | 5,041 |  |  | 98 | 11,167,961 | 113.69 | 0 | 10,190 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 332 | 117 | 0 | 0 | 108 | 36 | 35 | 51 | 20 | 0 | 106 | 92 | 13 | 3 | 9 | 118 | 108 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 169 | 47 | 0 | 0 | 68 | 25 | 24 | 28 | 14 | 0 | 53 | 45 | 8 | 1 | 6 | 47 | 68 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 140 | 32 | 0 | 0 | 62 | 23 | 22 | 25 | 14 | 0 | 45 | 37 | 7 | 1 | 5 | 33 | 62 | 0 | 2 | 13 | 0 | 0 | 
| leaf | 0 | prover | 237,893,432 | 907 | 374 | 0 | 0 | 229 | 110 | 109 | 67 | 50 | 0 | 303 | 266 | 36 | 19 | 17 | 374 | 229 | 0 | 10 | 49 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,274,446,073 | 4,560 | 1,306 | 0 | 0 | 2,378 | 1,295 | 1,295 | 477 | 605 | 0 | 874 | 667 | 206 | 129 | 77 | 1,307 | 2,378 | 0 | 5 | 604 | 0 | 0 | 
| app_proof | prover | 1 | 1,274,446,068 | 4,471 | 1,229 | 0 | 0 | 2,372 | 1,286 | 1,285 | 481 | 604 | 0 | 868 | 661 | 207 | 129 | 78 | 1,230 | 2,372 | 0 | 5 | 602 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 1 | 152 | 5,045 | 152 | 135 | 10,985,768,556 | 4,322,059,584 | 15,307,828,140 | 2,097,152 | 0 | 3 | 196 | 5,703,000 | 32.47 | 
| app_proof | 1 | 1 | 110 | 5,041 | 110 | 41 | 10,529,881,188 | 4,777,688,844 | 15,307,570,032 | 2,097,152 | 0 | 2 | 417 | 5,464,961 | 36.01 | 

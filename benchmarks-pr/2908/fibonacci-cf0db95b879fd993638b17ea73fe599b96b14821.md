...
| `total_proof_time_ms ` |  698.50 |  1,397 |  764 |  633 |
| `compile_metered_time_ms` |  3 |  3 |  3 |  3 |
| `execute_metered_time_ms` |  20 | -          | -          | -          |
| `execute_metered_insns` |  4,000,051 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  193.66 | -          |  193.66 |  193.66 |
| `execute_preflight_insns` |  2,000,025.50 |  4,000,051 |  2,621,000 |  1,379,051 |
| `execute_preflight_time_ms` |  66 |  132 |  80 |  52 |
| `execute_preflight_insn_mi/s` |  37.51 | -          |  39.42 |  35.59 |
| `trace_gen_time_ms   ` |  23 |  46 |  24 |  22 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  520 |  1,040 |  525 |  515 |
| `prover.main_trace_commit_time_ms` |  98 |  196 |  98 |  98 |
| `prover.rap_constraints_time_ms` |  320.50 |  641 |  325 |  316 |
| `prover.openings_time_ms` |  101 |  202 |  102 |  100 |
| `prover.rap_constraints.logup_gkr_time_ms` |  232 |  464 |  234 |  230 |
| `prover.rap_constraints.round0_time_ms` |  64 |  128 |  66 |  62 |
...
| `prover.openings.whir_time_ms` |  81.50 |  163 |  82 |  81 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/cf0db95b879fd993638b17ea73fe599b96b14821/fibonacci-cf0db95b879fd993638b17ea73fe599b96b14821.memory.svg)
...
| app_proof |  |  |  |  |  | 633 |  |  | 20 | 4,000,051 | 193.66 | 0 | 1,423 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 27,277,885 | 258 | 82 | 0 | 0 | 97 | 31 | 31 | 45 | 19 | 0 | 78 | 67 | 11 | 2 | 8 | 82 | 97 | 0 | 3 | 18 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 174 | 46 | 0 | 0 | 68 | 25 | 24 | 27 | 15 | 0 | 58 | 50 | 8 | 1 | 6 | 47 | 68 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 138 | 32 | 0 | 0 | 63 | 23 | 23 | 24 | 15 | 0 | 41 | 34 | 7 | 1 | 5 | 32 | 63 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 74,737,496 | 353 | 123 | 0 | 0 | 115 | 51 | 50 | 35 | 29 | 0 | 113 | 99 | 14 | 6 | 8 | 123 | 115 | 0 | 6 | 27 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 119,796,216 | 525 | 97 | 0 | 0 | 325 | 66 | 66 | 23 | 234 | 0 | 102 | 82 | 19 | 10 | 8 | 98 | 325 | 0 | 3 | 233 | 0 | 0 | 
| app_proof | prover | 1 | 119,795,168 | 515 | 98 | 0 | 0 | 316 | 62 | 62 | 23 | 230 | 0 | 100 | 81 | 19 | 10 | 8 | 98 | 316 | 0 | 3 | 229 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 2 | 22 | 764 | 22 | 135 | 3,176,285,986 | 1,768,942 | 3,178,054,928 | 2,097,152 | 0 | 4 | 80 | 2,621,000 | 35.59 | 
| app_proof | 1 | 1 | 24 | 633 | 24 | 41 | 1,707,679,788 | 1,468,951,987 | 3,176,631,775 | 2,097,152 | 0 | 2 | 52 | 1,379,051 | 39.42 | 

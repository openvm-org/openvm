...
|:---|---:|---:|
| Total | <span style='color: red'>(+0 [+4.0%])</span> 1.58 | <span style='color: red'>(+0 [+0.4%])</span> 0.90 |
| pairing | <span style='color: red'>(+0 [+4.0%])</span> 1.48 | <span style='color: red'>(+0 [+0.1%])</span> 0.81 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+28 [+4.0%])</span> 741.50 | <span style='color: red'>(+57 [+4.0%])</span> 1,483 | <span style='color: red'>(+1 [+0.1%])</span> 812 | <span style='color: red'>(+56 [+9.1%])</span> 671 |
| `main_cells_used     ` |  12,734,105 |  25,468,210 |  16,059,916 |  9,408,294 |
| `total_cells_used    ` |  27,501,699 |  55,003,398 |  32,689,110 |  22,314,288 |
| `execute_metered_time_ms` | <span style='color: red'>(+3 [+3.4%])</span> 92 | -          | -          | -          |
| `execute_metered_insn_mi/s` | <span style='color: green'>(-1 [-3.3%])</span> 18.77 | -          | <span style='color: green'>(-1 [-3.3%])</span> 18.77 | <span style='color: green'>(-1 [-3.3%])</span> 18.77 |
| `execute_preflight_insns` |  872,871 |  1,745,742 |  1,157,000 |  588,742 |
| `execute_preflight_time_ms` | <span style='color: red'>(+1 [+1.1%])</span> 95 | <span style='color: red'>(+2 [+1.1%])</span> 190 | <span style='color: red'>(+1 [+0.8%])</span> 130 | <span style='color: red'>(+1 [+1.7%])</span> 60 |
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+0 [+0.3%])</span> 13.69 | -          | <span style='color: red'>(+0 [+0.5%])</span> 18.23 | <span style='color: green'>(-0 [-0.1%])</span> 9.15 |
| `trace_gen_time_ms   ` | <span style='color: green'>(-4 [-2.5%])</span> 175.50 | <span style='color: green'>(-9 [-2.5%])</span> 351 | <span style='color: green'>(-5 [-2.5%])</span> 192 | <span style='color: green'>(-4 [-2.5%])</span> 159 |
...
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+33 [+9.6%])</span> 378.50 | <span style='color: red'>(+66 [+9.6%])</span> 757 | <span style='color: red'>(+5 [+1.3%])</span> 379 | <span style='color: red'>(+61 [+19.2%])</span> 378 |
| `main_trace_commit_time_ms` | <span style='color: red'>(+2 [+2.4%])</span> 64 | <span style='color: red'>(+3 [+2.4%])</span> 128 | <span style='color: red'>(+2 [+2.8%])</span> 74 | <span style='color: red'>(+1 [+1.9%])</span> 54 |
...
| `perm_trace_commit_time_ms` | <span style='color: green'>(-2 [-2.1%])</span> 75.69 | <span style='color: green'>(-3 [-2.1%])</span> 151.37 | <span style='color: green'>(-2 [-1.7%])</span> 88.61 | <span style='color: green'>(-2 [-2.6%])</span> 62.76 |
| `quotient_poly_compute_time_ms` | <span style='color: green'>(-1 [-0.8%])</span> 79.08 | <span style='color: green'>(-1 [-0.8%])</span> 158.16 | <span style='color: green'>(-1 [-0.8%])</span> 86.63 | <span style='color: green'>(-1 [-0.8%])</span> 71.53 |
| `quotient_poly_commit_time_ms` | <span style='color: green'>(-1 [-5.2%])</span> 15.89 | <span style='color: green'>(-2 [-5.2%])</span> 31.78 | <span style='color: green'>(-2 [-8.6%])</span> 17.27 | <span style='color: green'>(-0 [-0.8%])</span> 14.51 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+14 [+21.2%])</span> 83 | <span style='color: red'>(+29 [+21.2%])</span> 166 | <span style='color: red'>(+29 [+41.4%])</span> 99 |  67 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 671 | 1 | 92 | 1,745,742 | 18.77 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 159 | 812 | 32,689,110 | 172,558,444 | 159 | 379 | 0 | 86.63 | 17.27 | 6 | 88.61 | 67 | 131 | 67 | 1 | 74 | 16,059,916 | 40 | 130 | 1,157,000 | 9.15 | 26 | 104 | 1 | 67 | 
| pairing | 1 | 192 | 671 | 22,314,288 | 119,958,502 | 192 | 378 | 1 | 71.53 | 14.51 | 6 | 62.76 | 99 | 137 | 98 | 0 | 54 | 9,408,294 | 71 | 60 | 588,742 | 18.23 | 20 | 86 | 1 | 98 | 

...
|:---|---:|---:|
| Total | <span style='color: red'>(+0 [+1.8%])</span> 2.43 | <span style='color: red'>(+0 [+1.9%])</span> 0.79 |
| regex_program | <span style='color: red'>(+0 [+1.7%])</span> 2.39 | <span style='color: red'>(+0 [+1.6%])</span> 0.75 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+10 [+1.7%])</span> 597.50 | <span style='color: red'>(+41 [+1.7%])</span> 2,390 | <span style='color: red'>(+12 [+1.6%])</span> 750 | <span style='color: red'>(+3 [+0.6%])</span> 539 |
| `main_cells_used     ` |  4,423,804 |  17,695,216 |  10,899,170 |  2,177,334 |
| `total_cells_used    ` |  14,619,340 |  58,477,360 |  23,446,148 |  11,579,064 |
| `execute_metered_time_ms` | <span style='color: red'>(+3 [+8.8%])</span> 37 | -          | -          | -          |
| `execute_metered_insn_mi/s` | <span style='color: green'>(-9 [-7.5%])</span> 109.77 | -          | <span style='color: green'>(-9 [-7.5%])</span> 109.77 | <span style='color: green'>(-9 [-7.5%])</span> 109.77 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` | <span style='color: red'>(+1 [+2.3%])</span> 54.75 | <span style='color: red'>(+5 [+2.3%])</span> 219 | <span style='color: red'>(+2 [+3.1%])</span> 67 | <span style='color: red'>(+1 [+2.2%])</span> 46 |
| `execute_preflight_insn_mi/s` | <span style='color: green'>(-1 [-1.8%])</span> 30.42 | -          | <span style='color: green'>(-1 [-2.0%])</span> 31.48 | <span style='color: green'>(-0 [-1.6%])</span> 27.62 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+3 [+1.6%])</span> 180 | <span style='color: red'>(+11 [+1.6%])</span> 720 | <span style='color: red'>(+5 [+2.4%])</span> 215 | <span style='color: red'>(+2 [+1.3%])</span> 156 |
| `memory_finalize_time_ms` |  1 |  4 |  4 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+6 [+2.1%])</span> 294.75 | <span style='color: red'>(+24 [+2.1%])</span> 1,179 | <span style='color: red'>(+6 [+1.8%])</span> 343 | <span style='color: red'>(+5 [+1.9%])</span> 271 |
| `main_trace_commit_time_ms` | <span style='color: red'>(+2 [+3.4%])</span> 52.75 | <span style='color: red'>(+7 [+3.4%])</span> 211 | <span style='color: red'>(+1 [+1.8%])</span> 58 | <span style='color: red'>(+2 [+4.1%])</span> 51 |
| `generate_perm_trace_time_ms` | <span style='color: red'>(+1 [+2.2%])</span> 34.50 | <span style='color: red'>(+3 [+2.2%])</span> 138 | <span style='color: red'>(+1 [+1.9%])</span> 55 | <span style='color: green'>(-1 [-5.3%])</span> 18 |
| `perm_trace_commit_time_ms` | <span style='color: red'>(+2 [+2.8%])</span> 65.31 | <span style='color: red'>(+7 [+2.8%])</span> 261.24 | <span style='color: red'>(+4 [+5.6%])</span> 71.94 | <span style='color: red'>(+2 [+2.9%])</span> 56.26 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+2 [+3.3%])</span> 59.09 | <span style='color: red'>(+8 [+3.3%])</span> 236.38 | <span style='color: green'>(-1 [-0.8%])</span> 69.55 | <span style='color: red'>(+1 [+2.7%])</span> 52.90 |
| `quotient_poly_commit_time_ms` | <span style='color: green'>(-0 [-2.5%])</span> 14.74 | <span style='color: green'>(-2 [-2.5%])</span> 58.94 | <span style='color: green'>(-1 [-3.8%])</span> 17.03 | <span style='color: red'>(+0 [+1.4%])</span> 12.74 |
| `pcs_opening_time_ms ` | <span style='color: green'>(-0 [-0.4%])</span> 64.75 | <span style='color: green'>(-1 [-0.4%])</span> 259 | <span style='color: green'>(-4 [-4.8%])</span> 79 | <span style='color: red'>(+1 [+1.8%])</span> 57 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 545 | 1 | 37 | 4,137,502 | 109.77 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 215 | 750 | 23,446,148 | 150,778,428 | 215 | 343 | 0 | 59.09 | 17.03 | 5 | 71.94 | 79 | 128 | 79 | 4 | 58 | 10,899,170 | 55 | 46 | 1,103,000 | 27.62 | 21 | 76 | 1 | 79 | 
| regex_program | 1 | 156 | 556 | 11,598,276 | 128,513,066 | 156 | 290 | 1 | 54.84 | 14.78 | 4 | 66.97 | 62 | 105 | 62 | 0 | 51 | 2,196,106 | 38 | 67 | 1,104,000 | 31.23 | 16 | 70 | 0 | 62 | 
| regex_program | 2 | 162 | 539 | 11,579,064 | 128,513,066 | 162 | 275 | 1 | 52.90 | 14.40 | 4 | 66.07 | 61 | 94 | 61 | 0 | 51 | 2,177,334 | 27 | 60 | 1,104,000 | 31.48 | 16 | 67 | 0 | 61 | 
| regex_program | 3 | 187 | 545 | 11,853,872 | 103,456,394 | 187 | 271 | 0 | 69.55 | 12.74 | 5 | 56.26 | 57 | 78 | 57 | 0 | 51 | 2,422,606 | 18 | 46 | 826,502 | 31.36 | 19 | 83 | 1 | 57 | 

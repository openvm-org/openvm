...
|:---|---:|---:|---:|
| Total |  18.63 |  5.26 |  5.26 |
| app_proof |  15.61 |  2.100 |  2.100 |
| leaf |  2.18 |  1.41 |  1.41 |
...
| `total_proof_time_ms ` |  2,595 |  15,570 |  2,961 |  2,507 |
| `execute_metered_time_ms` |  37 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  33.02 | -          |  33.02 |  33.02 |
| `execute_preflight_insns` |  205,869.67 |  1,235,218 |  207,000 |  200,218 |
| `execute_preflight_time_ms` |  177.50 |  1,065 |  262 |  15 |
| `execute_preflight_insn_mi/s` |  19.80 | -          |  19.97 |  19.54 |
| `trace_gen_time_ms   ` |  387.17 |  2,323 |  541 |  350 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,967 |  11,802 |  2,233 |  1,909 |
| `prover.main_trace_commit_time_ms` |  685.83 |  4,115 |  845 |  653 |
| `prover.rap_constraints_time_ms` |  1,099.83 |  6,599 |  1,206 |  1,074 |
| `prover.openings_time_ms` |  180 |  1,080 |  184 |  175 |
| `prover.rap_constraints.logup_gkr_time_ms` |  274.67 |  1,648 |  382 |  252 |
| `prover.rap_constraints.round0_time_ms` |  514.17 |  3,085 |  517 |  511 |
| `prover.rap_constraints.mle_rounds_time_ms` |  310 |  1,860 |  311 |  309 |
| `prover.openings.stacked_reduction_time_ms` |  138.33 |  830 |  140 |  137 |
...
| `prover.openings.whir_time_ms` |  41.33 |  248 |  43 |  37 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,089.50 |  2,179 |  1,414 |  765 |
| `execute_preflight_time_ms` |  4.50 |  9 |  5 |  4 |
| `trace_gen_time_ms   ` |  138.50 |  277 |  187 |  90 |
| `generate_blob_total_time_ms` |  25.50 |  51 |  34 |  17 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  950 |  1,900 |  1,226 |  674 |
| `prover.main_trace_commit_time_ms` |  541 |  1,082 |  711 |  371 |
| `prover.rap_constraints_time_ms` |  304.50 |  609 |  391 |  218 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/847e4718751286d3ec3049cbcb1af94693d43d78/keccak-847e4718751286d3ec3049cbcb1af94693d43d78.memory.svg)
...
| app_proof |  |  |  |  |  | 2,518 |  |  | 37 | 1,235,218 | 33.02 | 0 | 15,616 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 39 | 515 | 38 | 13 | 4 | 2 | 2 | 2 | 
| internal_recursive.0 | 1 | 12 | 183 | 12 | 2 | 1 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 9 | 148 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 187 | 1,414 | 187 | 64 | 34 | 5 | 7 | 7 | 
| leaf | 1 | 90 | 765 | 90 | 33 | 17 | 4 | 7 | 7 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 109,497,984 | 476 | 245 | 0 | 14 | 171 | 45 | 44 | 92 | 33 | 0 | 59 | 21 | 38 | 7 | 30 | 245 | 171 | 0 | 2 | 32 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 25,962,119 | 170 | 50 | 0 | 3 | 74 | 23 | 22 | 29 | 21 | 0 | 45 | 21 | 23 | 1 | 21 | 51 | 74 | 0 | 2 | 21 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 17,507,975 | 138 | 33 | 0 | 3 | 62 | 21 | 21 | 24 | 16 | 0 | 41 | 19 | 22 | 1 | 20 | 34 | 62 | 0 | 2 | 16 | 0 | 0 | 
| leaf | 0 | prover | 583,523,386 | 1,226 | 711 | 0 | 47 | 391 | 191 | 190 | 118 | 81 | 0 | 123 | 38 | 85 | 40 | 44 | 711 | 391 | 0 | 6 | 80 | 0 | 0 | 
| leaf | 1 | prover | 300,618,208 | 674 | 370 | 0 | 24 | 218 | 101 | 100 | 66 | 50 | 0 | 84 | 32 | 51 | 19 | 31 | 371 | 218 | 0 | 5 | 49 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,205,061,845 | 2,233 | 845 | 0 | 243 | 1,206 | 512 | 511 | 311 | 382 | 128 | 181 | 41 | 140 | 84 | 56 | 845 | 1,206 | 0 | 3 | 254 | 0 | 0 | 
| app_proof | prover | 1 | 1,205,053,652 | 1,909 | 654 | 0 | 51 | 1,074 | 511 | 511 | 309 | 253 | 0 | 180 | 43 | 137 | 84 | 53 | 654 | 1,074 | 0 | 3 | 252 | 0 | 0 | 
| app_proof | prover | 2 | 1,205,053,652 | 1,913 | 653 | 0 | 51 | 1,079 | 515 | 514 | 311 | 252 | 0 | 179 | 41 | 138 | 84 | 54 | 653 | 1,079 | 0 | 3 | 252 | 0 | 0 | 
| app_proof | prover | 3 | 1,205,053,652 | 1,911 | 654 | 0 | 51 | 1,081 | 516 | 516 | 310 | 254 | 0 | 175 | 37 | 137 | 83 | 53 | 654 | 1,081 | 0 | 3 | 252 | 0 | 0 | 
| app_proof | prover | 4 | 1,205,053,652 | 1,915 | 654 | 0 | 51 | 1,078 | 514 | 514 | 310 | 253 | 0 | 181 | 43 | 138 | 84 | 53 | 654 | 1,078 | 0 | 3 | 252 | 0 | 0 | 
| app_proof | prover | 5 | 1,205,062,652 | 1,921 | 655 | 0 | 52 | 1,081 | 517 | 517 | 309 | 254 | 0 | 184 | 43 | 140 | 84 | 56 | 655 | 1,081 | 0 | 3 | 252 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 541 | 2,961 | 541 | 171 | 0 | 189 | 15 | 207,000 | 19.54 | 
| app_proof | 1 | 350 | 2,563 | 350 | 41 | 0 | 1 | 262 | 207,000 | 19.88 | 
| app_proof | 2 | 351 | 2,509 | 351 | 41 | 0 | 1 | 203 | 207,000 | 19.97 | 
| app_proof | 3 | 351 | 2,507 | 351 | 41 | 0 | 1 | 204 | 207,000 | 19.85 | 
| app_proof | 4 | 352 | 2,512 | 352 | 41 | 0 | 2 | 204 | 207,000 | 19.80 | 
| app_proof | 5 | 378 | 2,518 | 378 | 41 | 0 | 29 | 177 | 200,218 | 19.78 | 

...
|:---|---:|---:|---:|
| Total |  18.96 |  5.34 |  5.34 |
| app_proof |  15.88 |  3.04 |  3.04 |
| leaf |  2.23 |  1.44 |  1.44 |
...
| `total_proof_time_ms ` |  2,640.67 |  15,844 |  3,006 |  2,552 |
...
| `execute_preflight_time_ms` |  178.83 |  1,073 |  269 |  15 |
| `execute_preflight_insn_mi/s` |  19.70 | -          |  19.95 |  19.22 |
| `trace_gen_time_ms   ` |  392.17 |  2,353 |  547 |  350 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  2,005.83 |  12,035 |  2,272 |  1,947 |
| `prover.main_trace_commit_time_ms` |  696.50 |  4,179 |  854 |  664 |
| `prover.rap_constraints_time_ms` |  1,122.67 |  6,736 |  1,229 |  1,097 |
| `prover.openings_time_ms` |  185.33 |  1,112 |  190 |  181 |
| `prover.rap_constraints.logup_gkr_time_ms` |  276 |  1,656 |  383 |  254 |
| `prover.rap_constraints.round0_time_ms` |  525.50 |  3,153 |  528 |  523 |
| `prover.rap_constraints.mle_rounds_time_ms` |  320.17 |  1,921 |  323 |  318 |
| `prover.openings.stacked_reduction_time_ms` |  141.50 |  849 |  145 |  136 |
| `prover.openings.stacked_reduction.round0_time_ms` |  85.67 |  514 |  88 |  79 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  55.33 |  332 |  56 |  54 |
| `prover.openings.whir_time_ms` |  43.33 |  260 |  45 |  41 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,114 |  2,228 |  1,443 |  785 |
| `execute_preflight_time_ms` |  4.50 |  9 |  5 |  4 |
| `trace_gen_time_ms   ` |  137.50 |  275 |  184 |  91 |
| `generate_blob_total_time_ms` |  25.50 |  51 |  34 |  17 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  976 |  1,952 |  1,258 |  694 |
| `prover.main_trace_commit_time_ms` |  551 |  1,102 |  724 |  378 |
| `prover.rap_constraints_time_ms` |  315.50 |  631 |  404 |  227 |
| `prover.openings_time_ms` |  108.50 |  217 |  130 |  87 |
...
| `prover.openings.whir_time_ms` |  38.50 |  77 |  43 |  34 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/9abc53a15677fd8a3500a94e5a6ce81e810b94db/keccak-9abc53a15677fd8a3500a94e5a6ce81e810b94db.memory.svg)
...
| app_proof |  |  |  |  |  | 2,565 |  |  | 37 | 1,235,218 | 32.99 | 0 | 15,889 |  | 
...
| leaf | 0 | 184 | 1,443 | 184 | 64 | 34 | 5 | 7 | 7 | 
| leaf | 1 | 91 | 785 | 91 | 32 | 17 | 4 | 8 | 8 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 109,497,984 | 480 | 250 | 0 | 14 | 174 | 46 | 45 | 94 | 33 | 0 | 56 | 17 | 38 | 7 | 30 | 250 | 173 | 0 | 3 | 32 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 25,962,119 | 172 | 52 | 0 | 3 | 75 | 24 | 23 | 29 | 22 | 0 | 44 | 20 | 23 | 1 | 21 | 52 | 75 | 0 | 2 | 21 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 17,507,975 | 142 | 34 | 0 | 3 | 64 | 22 | 22 | 24 | 17 | 0 | 42 | 20 | 22 | 1 | 20 | 34 | 64 | 0 | 2 | 16 | 0 | 0 | 
| leaf | 0 | prover | 583,523,386 | 1,258 | 723 | 0 | 47 | 404 | 200 | 199 | 121 | 82 | 0 | 130 | 43 | 86 | 41 | 44 | 724 | 404 | 0 | 6 | 81 | 0 | 0 | 
| leaf | 1 | prover | 300,618,208 | 694 | 378 | 0 | 24 | 227 | 106 | 105 | 69 | 51 | 0 | 87 | 34 | 52 | 20 | 32 | 378 | 227 | 0 | 6 | 50 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,205,061,845 | 2,272 | 854 | 0 | 241 | 1,229 | 523 | 523 | 323 | 383 | 128 | 187 | 42 | 145 | 88 | 56 | 854 | 1,229 | 0 | 3 | 253 | 0 | 0 | 
| app_proof | prover | 1 | 1,205,053,652 | 1,947 | 664 | 0 | 51 | 1,097 | 524 | 523 | 318 | 254 | 0 | 184 | 43 | 141 | 85 | 55 | 665 | 1,097 | 0 | 4 | 253 | 0 | 0 | 
| app_proof | prover | 2 | 1,205,053,652 | 1,949 | 664 | 0 | 51 | 1,102 | 526 | 526 | 320 | 254 | 0 | 181 | 45 | 136 | 79 | 56 | 665 | 1,102 | 0 | 4 | 254 | 0 | 0 | 
| app_proof | prover | 3 | 1,205,053,652 | 1,953 | 664 | 0 | 51 | 1,105 | 528 | 528 | 320 | 255 | 0 | 183 | 41 | 141 | 87 | 54 | 664 | 1,104 | 0 | 4 | 254 | 0 | 0 | 
| app_proof | prover | 4 | 1,205,053,652 | 1,952 | 665 | 0 | 51 | 1,099 | 525 | 525 | 319 | 254 | 0 | 187 | 44 | 142 | 87 | 55 | 665 | 1,099 | 0 | 3 | 253 | 0 | 0 | 
| app_proof | prover | 5 | 1,205,062,652 | 1,962 | 666 | 0 | 52 | 1,104 | 527 | 527 | 321 | 256 | 0 | 190 | 45 | 144 | 88 | 56 | 666 | 1,104 | 0 | 3 | 254 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 547 | 3,006 | 547 | 170 | 0 | 195 | 15 | 207,000 | 19.39 | 
| app_proof | 1 | 350 | 2,609 | 350 | 41 | 0 | 1 | 269 | 207,000 | 19.87 | 
| app_proof | 2 | 356 | 2,552 | 356 | 41 | 0 | 6 | 205 | 207,000 | 19.22 | 
| app_proof | 3 | 357 | 2,557 | 357 | 41 | 0 | 8 | 204 | 207,000 | 19.95 | 
| app_proof | 4 | 358 | 2,555 | 358 | 41 | 0 | 8 | 204 | 207,000 | 19.87 | 
| app_proof | 5 | 385 | 2,565 | 385 | 41 | 0 | 36 | 176 | 200,218 | 19.88 | 

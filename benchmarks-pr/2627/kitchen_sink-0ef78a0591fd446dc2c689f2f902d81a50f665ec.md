...
| `total_proof_time_ms ` |  1,185 |  2,370 |  1,413 |  957 |
| `execute_metered_time_ms` |  7 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  19.80 | -          |  19.80 |  19.80 |
| `execute_preflight_insns` |  77,381.50 |  154,763 |  121,000 |  33,763 |
| `execute_preflight_time_ms` |  72 |  144 |  123 |  21 |
| `execute_preflight_insn_mi/s` |  8.42 | -          |  11.14 |  5.71 |
| `trace_gen_time_ms   ` |  158 |  316 |  188 |  128 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  841.50 |  1,683 |  1,019 |  664 |
| `prover.main_trace_commit_time_ms` |  219.50 |  439 |  289 |  150 |
| `prover.rap_constraints_time_ms` |  559.50 |  1,119 |  656 |  463 |
| `prover.openings_time_ms` |  61 |  122 |  72 |  50 |
| `prover.rap_constraints.logup_gkr_time_ms` |  140 |  280 |  154 |  126 |
| `prover.rap_constraints.round0_time_ms` |  287 |  574 |  363 |  211 |
| `prover.rap_constraints.mle_rounds_time_ms` |  131 |  262 |  138 |  124 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/0ef78a0591fd446dc2c689f2f902d81a50f665ec/kitchen_sink-0ef78a0591fd446dc2c689f2f902d81a50f665ec.memory.svg)
...
| app_proof |  |  |  |  |  | 957 |  |  | 7 | 154,763 | 19.80 | 0 | 2,383 |  | 
...
| leaf | 0 | 105 | 415 | 105 | 25 | 11 | 18 | 5 | 5 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 53,472,003 | 138 | 40 | 0 | 4 | 64 | 19 | 18 | 29 | 15 | 0 | 33 | 9 | 23 | 1 | 21 | 41 | 63 | 0 | 1 | 14 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 23,651,975 | 101 | 19 | 0 | 4 | 50 | 16 | 16 | 20 | 13 | 0 | 30 | 9 | 21 | 1 | 20 | 19 | 50 | 0 | 1 | 12 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 17,507,975 | 94 | 14 | 0 | 4 | 48 | 17 | 16 | 18 | 13 | 0 | 30 | 9 | 21 | 0 | 20 | 15 | 48 | 0 | 1 | 12 | 0 | 0 | 
| leaf | 0 | prover | 407,935,872 | 309 | 124 | 0 | 9 | 140 | 45 | 44 | 36 | 59 | 0 | 43 | 12 | 30 | 6 | 23 | 125 | 140 | 0 | 2 | 58 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 816,542,084 | 1,019 | 289 | 0 | 160 | 656 | 363 | 361 | 138 | 154 | 61 | 72 | 12 | 60 | 15 | 44 | 289 | 656 | 0 | 1 | 92 | 0 | 0 | 
| app_proof | prover | 1 | 800,298,548 | 664 | 150 | 0 | 20 | 463 | 211 | 210 | 124 | 126 | 73 | 50 | 13 | 37 | 14 | 22 | 150 | 463 | 0 | 1 | 53 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 188 | 1,413 | 188 | 184 | 0 | 49 | 21 | 121,000 | 11.14 | 
| app_proof | 1 | 128 | 957 | 128 | 40 | 0 | 3 | 123 | 33,763 | 5.71 | 

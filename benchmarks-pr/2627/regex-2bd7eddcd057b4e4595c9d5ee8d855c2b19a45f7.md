...
|:---|---:|---:|---:|
| Total |  2.44 |  1.78 |  1.78 |
| app_proof |  1.49 |  0.82 |  0.82 |
| leaf |  0.38 |  0.38 |  0.38 |
...
| `total_proof_time_ms ` |  724.50 |  1,449 |  787 |  662 |
...
| `execute_preflight_time_ms` |  86 |  172 |  94 |  78 |
| `execute_preflight_insn_mi/s` |  32.57 | -          |  32.97 |  32.17 |
| `trace_gen_time_ms   ` |  145.50 |  291 |  151 |  140 |
| `memory_finalize_time_ms` |  2 |  4 |  4 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  387 |  774 |  392 |  382 |
| `prover.main_trace_commit_time_ms` |  99.50 |  199 |  104 |  95 |
| `prover.rap_constraints_time_ms` |  237.50 |  475 |  248 |  227 |
| `prover.openings_time_ms` |  48.50 |  97 |  49 |  48 |
| `prover.rap_constraints.logup_gkr_time_ms` |  138 |  276 |  138 |  138 |
| `prover.rap_constraints.round0_time_ms` |  67.50 |  135 |  81 |  54 |
| `prover.rap_constraints.mle_rounds_time_ms` |  31.50 |  63 |  35 |  28 |
| `prover.openings.stacked_reduction_time_ms` |  27 |  54 |  28 |  26 |
| `prover.openings.stacked_reduction.round0_time_ms` |  9 |  18 |  10 |  8 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  17.50 |  35 |  18 |  17 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/2bd7eddcd057b4e4595c9d5ee8d855c2b19a45f7/regex-2bd7eddcd057b4e4595c9d5ee8d855c2b19a45f7.memory.svg)
...
| app_proof |  |  |  |  |  | 662 |  |  | 36 | 4,136,694 | 111.100 | 0 | 1,501 |  | 
...
| internal_recursive.0 | 1 | 9 | 178 | 9 | 1 | 0 | 2 | 0 | 0 | 
| internal_recursive.1 | 1 | 8 | 151 | 8 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 46 | 376 | 46 | 13 | 3 | 4 | 1 | 1 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 41,110,275 | 233 | 85 | 0 | 5 | 100 | 30 | 29 | 46 | 24 | 0 | 47 | 20 | 26 | 2 | 23 | 85 | 100 | 0 | 2 | 23 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 23,651,975 | 168 | 49 | 0 | 3 | 70 | 23 | 23 | 28 | 18 | 0 | 48 | 24 | 23 | 1 | 22 | 50 | 70 | 0 | 2 | 17 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 17,507,975 | 142 | 34 | 0 | 4 | 65 | 22 | 22 | 24 | 18 | 0 | 42 | 19 | 22 | 1 | 21 | 34 | 65 | 0 | 2 | 17 | 0 | 0 | 
| leaf | 0 | prover | 113,138,688 | 329 | 131 | 0 | 8 | 138 | 52 | 51 | 37 | 48 | 0 | 59 | 28 | 30 | 6 | 24 | 132 | 138 | 0 | 5 | 47 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 339,711,558 | 382 | 104 | 0 | 2 | 227 | 54 | 53 | 35 | 138 | 0 | 49 | 21 | 28 | 10 | 18 | 104 | 227 | 0 | 3 | 136 | 0 | 0 | 
| app_proof | prover | 1 | 303,309,204 | 392 | 94 | 0 | 14 | 248 | 81 | 81 | 28 | 138 | 0 | 48 | 22 | 26 | 8 | 17 | 95 | 248 | 0 | 3 | 137 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 140 | 787 | 140 | 170 | 4 | 124 | 94 | 2,208,000 | 32.17 | 
| app_proof | 1 | 151 | 662 | 151 | 40 | 0 | 135 | 78 | 1,928,694 | 32.97 | 

...
| `total_proof_time_ms ` |  1,198.50 |  2,397 |  1,431 |  966 |
| `execute_metered_time_ms` |  7 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  19.81 | -          |  19.81 |  19.81 |
| `execute_preflight_insns` |  77,381.50 |  154,763 |  121,000 |  33,763 |
| `execute_preflight_time_ms` |  74.50 |  149 |  129 |  20 |
| `execute_preflight_insn_mi/s` |  8.49 | -          |  11.17 |  5.82 |
| `trace_gen_time_ms   ` |  158.50 |  317 |  189 |  128 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  850 |  1,700 |  1,033 |  667 |
| `prover.main_trace_commit_time_ms` |  222.50 |  445 |  295 |  150 |
| `prover.rap_constraints_time_ms` |  565 |  1,130 |  664 |  466 |
| `prover.openings_time_ms` |  61.50 |  123 |  73 |  50 |
| `prover.rap_constraints.logup_gkr_time_ms` |  142.50 |  285 |  157 |  128 |
| `prover.rap_constraints.round0_time_ms` |  286.50 |  573 |  364 |  209 |
| `prover.rap_constraints.mle_rounds_time_ms` |  135.50 |  271 |  142 |  129 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/9abc53a15677fd8a3500a94e5a6ce81e810b94db/kitchen_sink-9abc53a15677fd8a3500a94e5a6ce81e810b94db.memory.svg)
...
| app_proof |  |  |  |  |  | 966 |  |  | 7 | 154,763 | 19.81 | 0 | 2,410 |  | 
...
| leaf | 0 | 107 | 418 | 106 | 25 | 11 | 17 | 5 | 5 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 53,472,003 | 139 | 40 | 0 | 4 | 64 | 19 | 19 | 29 | 15 | 0 | 33 | 9 | 23 | 1 | 21 | 41 | 64 | 0 | 1 | 14 | 0 | 0 | 
...
| leaf | 0 | prover | 407,935,872 | 311 | 124 | 0 | 9 | 141 | 45 | 44 | 36 | 60 | 0 | 43 | 12 | 31 | 7 | 24 | 125 | 141 | 0 | 2 | 59 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 816,542,084 | 1,033 | 294 | 0 | 164 | 664 | 364 | 363 | 142 | 157 | 64 | 73 | 12 | 60 | 15 | 44 | 295 | 664 | 0 | 1 | 91 | 0 | 0 | 
| app_proof | prover | 1 | 800,298,548 | 667 | 150 | 0 | 20 | 466 | 209 | 208 | 129 | 128 | 74 | 50 | 12 | 37 | 15 | 22 | 150 | 466 | 0 | 1 | 53 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 189 | 1,431 | 189 | 187 | 0 | 50 | 20 | 121,000 | 11.17 | 
| app_proof | 1 | 128 | 966 | 128 | 40 | 0 | 2 | 129 | 33,763 | 5.82 | 

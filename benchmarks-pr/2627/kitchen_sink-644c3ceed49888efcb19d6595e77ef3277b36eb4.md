...
|:---|---:|---:|---:|
| Total |  3.19 |  2.23 |  2.23 |
| app_proof |  2.41 |  1.44 |  1.44 |
| leaf |  0.42 |  0.42 |  0.42 |
...
| `total_proof_time_ms ` |  1,200 |  2,400 |  1,433 |  967 |
| `execute_metered_time_ms` |  7 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  20.03 | -          |  20.03 |  20.03 |
| `execute_preflight_insns` |  77,381.50 |  154,763 |  121,000 |  33,763 |
| `execute_preflight_time_ms` |  71.50 |  143 |  122 |  21 |
| `execute_preflight_insn_mi/s` |  8.50 | -          |  11.33 |  5.67 |
| `trace_gen_time_ms   ` |  159 |  318 |  189 |  129 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  854.50 |  1,709 |  1,035 |  674 |
| `prover.main_trace_commit_time_ms` |  224.50 |  449 |  298 |  151 |
| `prover.rap_constraints_time_ms` |  567 |  1,134 |  663 |  471 |
| `prover.openings_time_ms` |  62 |  124 |  74 |  50 |
| `prover.rap_constraints.logup_gkr_time_ms` |  143.50 |  287 |  156 |  131 |
| `prover.rap_constraints.round0_time_ms` |  287.50 |  575 |  363 |  212 |
| `prover.rap_constraints.mle_rounds_time_ms` |  135 |  270 |  142 |  128 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/644c3ceed49888efcb19d6595e77ef3277b36eb4/kitchen_sink-644c3ceed49888efcb19d6595e77ef3277b36eb4.memory.svg)
...
| app_proof |  |  |  |  |  | 967 |  |  | 7 | 154,763 | 20.03 | 0 | 2,413 |  | 
...
| leaf | 0 | 106 | 417 | 106 | 26 | 11 | 18 | 5 | 5 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 53,472,003 | 138 | 40 | 0 | 4 | 65 | 19 | 19 | 29 | 15 | 0 | 32 | 8 | 23 | 1 | 21 | 41 | 65 | 0 | 1 | 14 | 0 | 0 | 
...
| leaf | 0 | prover | 407,935,872 | 311 | 125 | 0 | 9 | 142 | 45 | 44 | 36 | 60 | 0 | 43 | 12 | 31 | 7 | 24 | 125 | 142 | 0 | 2 | 59 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 816,542,084 | 1,035 | 297 | 0 | 167 | 663 | 363 | 361 | 142 | 156 | 64 | 74 | 13 | 60 | 16 | 44 | 298 | 663 | 0 | 1 | 91 | 0 | 0 | 
| app_proof | prover | 1 | 800,298,548 | 674 | 151 | 0 | 20 | 471 | 212 | 211 | 128 | 131 | 77 | 50 | 13 | 37 | 14 | 22 | 151 | 471 | 0 | 1 | 53 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 189 | 1,433 | 189 | 186 | 0 | 49 | 21 | 121,000 | 11.33 | 
| app_proof | 1 | 129 | 967 | 129 | 40 | 0 | 3 | 122 | 33,763 | 5.67 | 

...
| `total_proof_time_ms ` |  2,610.17 |  15,661 |  2,984 |  2,510 |
...
| `execute_preflight_time_ms` |  185.17 |  1,111 |  277 |  16 |
| `execute_preflight_insn_mi/s` |  19.23 | -          |  19.41 |  18.96 |
| `trace_gen_time_ms   ` |  386.33 |  2,318 |  542 |  350 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,975 |  11,850 |  2,254 |  1,909 |
| `prover.main_trace_commit_time_ms` |  688.83 |  4,133 |  853 |  655 |
| `prover.rap_constraints_time_ms` |  1,104.83 |  6,629 |  1,217 |  1,080 |
| `prover.openings_time_ms` |  180.33 |  1,082 |  185 |  172 |
| `prover.rap_constraints.logup_gkr_time_ms` |  275.83 |  1,655 |  387 |  253 |
| `prover.rap_constraints.round0_time_ms` |  515.50 |  3,093 |  517 |  514 |
| `prover.rap_constraints.mle_rounds_time_ms` |  312.50 |  1,875 |  315 |  310 |
| `prover.openings.stacked_reduction_time_ms` |  137.33 |  824 |  142 |  129 |
| `prover.openings.stacked_reduction.round0_time_ms` |  83 |  498 |  85 |  76 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  53.67 |  322 |  56 |  52 |
| `prover.openings.whir_time_ms` |  43 |  258 |  48 |  41 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,091 |  2,182 |  1,418 |  764 |
| `execute_preflight_time_ms` |  4.50 |  9 |  5 |  4 |
| `trace_gen_time_ms   ` |  136.50 |  273 |  184 |  89 |
| `generate_blob_total_time_ms` |  25.50 |  51 |  34 |  17 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  953.50 |  1,907 |  1,233 |  674 |
| `prover.main_trace_commit_time_ms` |  541 |  1,082 |  711 |  371 |
| `prover.rap_constraints_time_ms` |  306.50 |  613 |  394 |  219 |
| `prover.openings_time_ms` |  105 |  210 |  127 |  83 |
...
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  472 |  472 |  472 |  472 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/0ef78a0591fd446dc2c689f2f902d81a50f665ec/keccak-0ef78a0591fd446dc2c689f2f902d81a50f665ec.memory.svg)
...
| app_proof |  |  |  |  |  | 2,520 |  |  | 36 | 1,235,218 | 33.46 | 0 | 15,706 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 38 | 511 | 38 | 13 | 4 | 2 | 2 | 2 | 
| internal_recursive.0 | 1 | 12 | 186 | 12 | 2 | 1 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 9 | 151 | 8 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 184 | 1,418 | 184 | 64 | 34 | 5 | 7 | 7 | 
| leaf | 1 | 89 | 764 | 89 | 32 | 17 | 4 | 7 | 7 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 109,497,984 | 472 | 244 | 0 | 14 | 170 | 45 | 45 | 91 | 33 | 0 | 57 | 18 | 38 | 7 | 31 | 244 | 170 | 0 | 2 | 32 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 25,962,119 | 173 | 51 | 0 | 4 | 74 | 23 | 22 | 29 | 22 | 0 | 46 | 22 | 24 | 1 | 22 | 51 | 74 | 0 | 2 | 21 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 17,507,975 | 142 | 34 | 0 | 4 | 64 | 22 | 21 | 24 | 17 | 0 | 43 | 20 | 22 | 1 | 21 | 34 | 64 | 0 | 2 | 16 | 0 | 0 | 
| leaf | 0 | prover | 583,523,386 | 1,233 | 711 | 0 | 48 | 394 | 191 | 190 | 121 | 81 | 0 | 127 | 40 | 86 | 41 | 45 | 711 | 394 | 0 | 6 | 80 | 0 | 0 | 
| leaf | 1 | prover | 300,618,208 | 674 | 371 | 0 | 24 | 219 | 102 | 101 | 66 | 50 | 0 | 83 | 31 | 52 | 19 | 32 | 371 | 218 | 0 | 6 | 50 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,205,061,845 | 2,254 | 853 | 0 | 247 | 1,217 | 514 | 514 | 315 | 387 | 131 | 183 | 41 | 142 | 85 | 56 | 853 | 1,217 | 0 | 3 | 254 | 0 | 0 | 
| app_proof | prover | 1 | 1,205,053,652 | 1,922 | 655 | 0 | 51 | 1,081 | 516 | 515 | 311 | 253 | 0 | 185 | 48 | 137 | 83 | 53 | 655 | 1,081 | 0 | 3 | 252 | 0 | 0 | 
| app_proof | prover | 2 | 1,205,053,652 | 1,909 | 655 | 0 | 51 | 1,080 | 515 | 515 | 310 | 254 | 0 | 172 | 43 | 129 | 76 | 53 | 656 | 1,080 | 0 | 3 | 253 | 0 | 0 | 
| app_proof | prover | 3 | 1,205,053,652 | 1,922 | 656 | 0 | 51 | 1,084 | 517 | 516 | 313 | 254 | 0 | 181 | 43 | 138 | 84 | 53 | 656 | 1,084 | 0 | 3 | 253 | 0 | 0 | 
| app_proof | prover | 4 | 1,205,053,652 | 1,919 | 657 | 0 | 51 | 1,082 | 514 | 513 | 313 | 254 | 0 | 179 | 41 | 138 | 85 | 52 | 657 | 1,082 | 0 | 3 | 253 | 0 | 0 | 
| app_proof | prover | 5 | 1,205,062,652 | 1,924 | 656 | 0 | 52 | 1,085 | 517 | 517 | 313 | 253 | 0 | 182 | 42 | 140 | 85 | 55 | 656 | 1,085 | 0 | 3 | 252 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 542 | 2,984 | 542 | 171 | 0 | 189 | 16 | 207,000 | 18.96 | 
| app_proof | 1 | 351 | 2,591 | 351 | 40 | 0 | 1 | 277 | 207,000 | 19.30 | 
| app_proof | 2 | 350 | 2,510 | 350 | 40 | 0 | 1 | 209 | 207,000 | 19.39 | 
| app_proof | 3 | 351 | 2,523 | 351 | 40 | 0 | 1 | 208 | 207,000 | 19.37 | 
| app_proof | 4 | 351 | 2,533 | 351 | 40 | 0 | 2 | 220 | 207,000 | 18.96 | 
| app_proof | 5 | 373 | 2,520 | 373 | 40 | 0 | 24 | 181 | 200,218 | 19.41 | 

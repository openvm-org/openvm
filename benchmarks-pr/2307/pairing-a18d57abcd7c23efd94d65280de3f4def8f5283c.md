...
|:---|---:|---:|
| Total | <span style='color: red'>(+0 [+0.1%])</span> 1.54 | <span style='color: red'>(+0 [+1.9%])</span> 0.93 |
| pairing | <span style='color: red'>(+0 [+0.3%])</span> 1.48 | <span style='color: red'>(+0 [+2.4%])</span> 0.87 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+2 [+0.3%])</span> 738 | <span style='color: red'>(+5 [+0.3%])</span> 1,476 | <span style='color: red'>(+20 [+2.4%])</span> 870 | <span style='color: green'>(-15 [-2.4%])</span> 606 |
...
| `execute_preflight_time_ms` | <span style='color: green'>(-1 [-1.2%])</span> 81.50 | <span style='color: green'>(-2 [-1.2%])</span> 163 | <span style='color: green'>(-1 [-1.0%])</span> 104 | <span style='color: green'>(-1 [-1.7%])</span> 59 |
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+0 [+1.3%])</span> 15.02 | -          | <span style='color: red'>(+0 [+1.5%])</span> 18.68 | <span style='color: red'>(+0 [+1.0%])</span> 11.35 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+1 [+0.5%])</span> 189.50 | <span style='color: red'>(+2 [+0.5%])</span> 379 | <span style='color: red'>(+1 [+0.5%])</span> 194 | <span style='color: red'>(+1 [+0.5%])</span> 185 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+2 [+0.6%])</span> 361 | <span style='color: red'>(+4 [+0.6%])</span> 722 | <span style='color: red'>(+19 [+4.9%])</span> 410 | <span style='color: green'>(-15 [-4.6%])</span> 312 |
...
| `generate_perm_trace_time_ms` | <span style='color: red'>(+12 [+35.8%])</span> 45.50 | <span style='color: red'>(+24 [+35.8%])</span> 91 | <span style='color: red'>(+15 [+39.5%])</span> 53 | <span style='color: red'>(+9 [+31.0%])</span> 38 |
| `perm_trace_commit_time_ms` | <span style='color: green'>(-1 [-1.8%])</span> 76.11 | <span style='color: green'>(-3 [-1.8%])</span> 152.21 | <span style='color: green'>(-1 [-1.4%])</span> 88.36 | <span style='color: green'>(-1 [-2.2%])</span> 63.85 |
| `quotient_poly_compute_time_ms` | <span style='color: green'>(-0 [-0.2%])</span> 83.52 | <span style='color: green'>(-0 [-0.2%])</span> 167.03 | <span style='color: green'>(-2 [-2.0%])</span> 91.75 | <span style='color: red'>(+2 [+2.1%])</span> 75.28 |
| `quotient_poly_commit_time_ms` | <span style='color: green'>(-1 [-3.1%])</span> 16.99 | <span style='color: green'>(-1 [-3.1%])</span> 33.98 | <span style='color: green'>(-2 [-7.7%])</span> 18.46 | <span style='color: red'>(+0 [+3.0%])</span> 15.51 |
| `pcs_opening_time_ms ` | <span style='color: green'>(-8 [-10.3%])</span> 69.50 | <span style='color: green'>(-16 [-10.3%])</span> 139 | <span style='color: green'>(-6 [-7.1%])</span> 79 | <span style='color: green'>(-10 [-14.3%])</span> 60 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 606 | 1 | 63 | 1,745,742 | 27.42 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 185 | 870 | 32,480,114 | 172,558,444 | 185 | 410 | 0 | 91.75 | 18.46 | 6 | 88.36 | 79 | 144 | 78 | 1 | 75 | 15,909,408 | 53 | 104 | 1,149,000 | 11.35 | 27 | 111 | 1 | 78 | 
| pairing | 1 | 194 | 606 | 22,464,232 | 119,958,502 | 194 | 312 | 1 | 75.28 | 15.51 | 6 | 63.85 | 60 | 105 | 59 | 0 | 54 | 9,498,894 | 38 | 59 | 596,742 | 18.68 | 21 | 91 | 1 | 59 | 

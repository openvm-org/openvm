...
| `total_proof_time_ms ` |  510 |  1,020 |  584 |  436 |
| `execute_metered_time_ms` |  8 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  171.44 | -          |  171.44 |  171.44 |
| `execute_preflight_insns` |  750,132.50 |  1,500,265 |  873,000 |  627,265 |
| `execute_preflight_time_ms` |  26.50 |  53 |  32 |  21 |
| `execute_preflight_insn_mi/s` |  39.67 | -          |  40.90 |  38.45 |
| `trace_gen_time_ms   ` |  191.50 |  383 |  196 |  187 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  186 |  372 |  195 |  177 |
| `main_trace_commit_time_ms` |  30.50 |  61 |  33 |  28 |
| `generate_perm_trace_time_ms` |  26.50 |  53 |  28 |  25 |
| `perm_trace_commit_time_ms` |  40.25 |  80.51 |  43.12 |  37.39 |
| `quotient_poly_compute_time_ms` |  32.03 |  64.06 |  34.55 |  29.51 |
| `quotient_poly_commit_time_ms` |  12.27 |  24.53 |  12.57 |  11.96 |
...
| --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 436 | 1 | 8 | 1,500,265 | 171.44 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 187 | 584 | 84,397,584 | 187 | 195 | 0 | 34.55 | 12.57 | 4 | 43.12 | 41 | 71 | 41 | 0 | 33 | 28 | 32 | 873,000 | 38.45 | 14 | 47 | 0 | 41 | 
| fibonacci_program | 1 | 196 | 436 | 74,303,722 | 196 | 177 | 1 | 29.51 | 11.96 | 4 | 37.39 | 44 | 63 | 44 | 0 | 28 | 25 | 21 | 627,265 | 40.90 | 11 | 41 | 0 | 44 | 

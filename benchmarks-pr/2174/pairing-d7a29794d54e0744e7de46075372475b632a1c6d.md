...
| `total_proof_time_ms ` |  725 |  1,450 |  824 |  626 |
...
| `execute_preflight_insn_mi/s` |  13.44 | -          |  17.84 |  9.03 |
| `trace_gen_time_ms   ` |  177 |  354 |  194 |  160 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  358.50 |  717 |  389 |  328 |
| `main_trace_commit_time_ms` |  64 |  128 |  75 |  53 |
| `generate_perm_trace_time_ms` |  52.50 |  105 |  58 |  47 |
| `perm_trace_commit_time_ms` |  76.69 |  153.39 |  89.02 |  64.36 |
| `quotient_poly_compute_time_ms` |  79.74 |  159.47 |  87.39 |  72.09 |
| `quotient_poly_commit_time_ms` |  16.92 |  33.83 |  19.10 |  14.73 |
| `pcs_opening_time_ms ` |  63.50 |  127 |  66 |  61 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 626 | 40 | 1 | 90 | 1,745,742 | 19.32 | 145 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 160 | 824 | 32,689,110 | 172,558,444 | 160 | 389 | 0 | 87.39 | 19.10 | 6 | 89.02 | 66 | 139 | 65 | 1 | 75 | 16,059,916 | 47 | 131 | 1,157,000 | 9.03 | 27 | 107 | 1 | 65 | 
| pairing | 1 | 194 | 626 | 22,314,288 | 119,958,502 | 194 | 328 | 1 | 72.09 | 14.73 | 6 | 64.36 | 61 | 125 | 61 | 0 | 53 | 9,408,294 | 58 | 62 | 588,742 | 17.84 | 20 | 87 | 1 | 61 | 

...
| `total_proof_time_ms ` |  586.50 |  2,346 |  740 |  531 |
...
| `execute_metered_insn_mi/s` |  120.65 | -          |  120.65 |  120.65 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  55.50 |  222 |  68 |  47 |
| `execute_preflight_insn_mi/s` |  30.26 | -          |  31.41 |  27.50 |
| `trace_gen_time_ms   ` |  173.75 |  695 |  206 |  151 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  289.75 |  1,159 |  342 |  263 |
| `main_trace_commit_time_ms` |  50.50 |  202 |  55 |  49 |
| `generate_perm_trace_time_ms` |  34 |  136 |  55 |  18 |
| `perm_trace_commit_time_ms` |  63.49 |  253.94 |  68.54 |  55.19 |
| `quotient_poly_compute_time_ms` |  57.65 |  230.61 |  68.32 |  50.80 |
| `quotient_poly_commit_time_ms` |  14.97 |  59.89 |  17.82 |  12.14 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 532 | 40 | 1 | 34 | 4,137,502 | 120.65 | 170 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 206 | 740 | 23,446,148 | 150,778,428 | 206 | 342 | 0 | 59.08 | 17.82 | 5 | 68.54 | 83 | 124 | 83 | 4 | 55 | 10,899,170 | 55 | 47 | 1,103,000 | 27.50 | 21 | 77 | 1 | 83 | 
| regex_program | 1 | 151 | 543 | 11,598,276 | 128,513,066 | 151 | 283 | 1 | 52.42 | 14.59 | 5 | 64.62 | 62 | 102 | 62 | 0 | 49 | 2,196,106 | 37 | 68 | 1,104,000 | 31.06 | 16 | 67 | 0 | 62 | 
| regex_program | 2 | 158 | 531 | 11,579,064 | 128,513,066 | 158 | 271 | 1 | 50.80 | 15.35 | 4 | 65.60 | 62 | 92 | 62 | 0 | 49 | 2,177,334 | 26 | 60 | 1,104,000 | 31.41 | 17 | 66 | 0 | 62 | 
| regex_program | 3 | 180 | 532 | 11,853,872 | 103,456,394 | 180 | 263 | 0 | 68.32 | 12.14 | 5 | 55.19 | 56 | 76 | 56 | 0 | 49 | 2,422,606 | 18 | 47 | 826,502 | 31.08 | 18 | 81 | 1 | 56 | 

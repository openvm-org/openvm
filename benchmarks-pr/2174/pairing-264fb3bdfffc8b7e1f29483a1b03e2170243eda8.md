...
| `total_proof_time_ms ` |  729 |  1,458 |  826 |  632 |
...
| `execute_preflight_time_ms` |  95.50 |  191 |  132 |  59 |
| `execute_preflight_insn_mi/s` |  13.41 | -          |  17.82 |  8.99 |
| `trace_gen_time_ms   ` |  181 |  362 |  199 |  163 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  359.50 |  719 |  386 |  333 |
| `main_trace_commit_time_ms` |  65.50 |  131 |  76 |  55 |
| `generate_perm_trace_time_ms` |  55.50 |  111 |  69 |  42 |
| `perm_trace_commit_time_ms` |  74.33 |  148.66 |  84.48 |  64.19 |
| `quotient_poly_compute_time_ms` |  79.08 |  158.17 |  86.18 |  71.99 |
| `quotient_poly_commit_time_ms` |  16.64 |  33.28 |  19.13 |  14.14 |
| `pcs_opening_time_ms ` |  63.50 |  127 |  73 |  54 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 632 | 41 | 1 | 90 | 1,745,742 | 19.24 | 150 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 163 | 826 | 32,689,110 | 172,558,444 | 163 | 386 | 0 | 86.18 | 19.13 | 6 | 84.48 | 73 | 129 | 73 | 1 | 76 | 16,059,916 | 42 | 132 | 1,157,000 | 8.99 | 26 | 106 | 1 | 73 | 
| pairing | 1 | 199 | 632 | 22,314,288 | 119,958,502 | 199 | 333 | 1 | 71.99 | 14.14 | 6 | 64.19 | 54 | 136 | 53 | 0 | 55 | 9,408,294 | 69 | 59 | 588,742 | 17.82 | 21 | 86 | 1 | 53 | 

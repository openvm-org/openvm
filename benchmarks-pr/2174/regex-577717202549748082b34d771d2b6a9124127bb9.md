...
| `total_proof_time_ms ` |  575.75 |  2,303 |  703 |  521 |
...
| `execute_metered_insn_mi/s` |  121.07 | -          |  121.07 |  121.07 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  55 |  220 |  67 |  46 |
| `execute_preflight_insn_mi/s` |  30.22 | -          |  31.40 |  27.36 |
| `trace_gen_time_ms   ` |  176 |  704 |  208 |  153 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  277.25 |  1,109 |  303 |  259 |
| `main_trace_commit_time_ms` |  51.75 |  207 |  57 |  49 |
| `generate_perm_trace_time_ms` |  24.75 |  99 |  33 |  20 |
| `perm_trace_commit_time_ms` |  64.22 |  256.89 |  70.55 |  55.02 |
| `quotient_poly_compute_time_ms` |  58.75 |  235.01 |  70.39 |  52.11 |
| `quotient_poly_commit_time_ms` |  14.85 |  59.41 |  17.13 |  12.70 |
| `pcs_opening_time_ms ` |  59.75 |  239 |  71 |  51 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 553 | 40 | 1 | 34 | 4,137,502 | 121.07 | 169 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 208 | 703 | 23,446,148 | 150,778,428 | 208 | 303 | 0 | 59.87 | 17.13 | 5 | 70.55 | 63 | 104 | 62 | 4 | 57 | 10,899,170 | 33 | 47 | 1,103,000 | 27.36 | 21 | 77 | 1 | 62 | 
| regex_program | 1 | 153 | 526 | 11,598,276 | 128,513,066 | 153 | 264 | 1 | 52.65 | 15.47 | 4 | 66.65 | 54 | 89 | 54 | 0 | 50 | 2,196,106 | 22 | 67 | 1,104,000 | 31.05 | 16 | 68 | 0 | 54 | 
| regex_program | 2 | 161 | 521 | 11,579,064 | 128,513,066 | 161 | 259 | 1 | 52.11 | 14.11 | 5 | 64.67 | 51 | 89 | 51 | 0 | 51 | 2,177,334 | 24 | 60 | 1,104,000 | 31.09 | 16 | 66 | 0 | 51 | 
| regex_program | 3 | 182 | 553 | 11,853,872 | 103,456,394 | 182 | 283 | 0 | 70.39 | 12.70 | 5 | 55.02 | 71 | 78 | 70 | 0 | 49 | 2,422,606 | 20 | 46 | 826,502 | 31.40 | 18 | 84 | 1 | 70 | 

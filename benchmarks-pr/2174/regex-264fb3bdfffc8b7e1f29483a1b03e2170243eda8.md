...
|:---|---:|---:|
| Total |  2.44 |  0.76 |
| regex_program |  2.41 |  0.73 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  602.25 |  2,409 |  727 |  541 |
...
| `execute_metered_insn_mi/s` |  121.58 | -          |  121.58 |  121.58 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  54.75 |  219 |  67 |  46 |
| `execute_preflight_insn_mi/s` |  30.33 | -          |  31.42 |  27.51 |
| `trace_gen_time_ms   ` |  183.25 |  733 |  217 |  160 |
| `memory_finalize_time_ms` |  0.75 |  3 |  3 |  0 |
| `stark_prove_excluding_trace_time_ms` |  296.75 |  1,187 |  319 |  274 |
| `main_trace_commit_time_ms` |  53 |  212 |  59 |  51 |
| `generate_perm_trace_time_ms` |  35 |  140 |  56 |  22 |
| `perm_trace_commit_time_ms` |  65.63 |  262.53 |  72.12 |  55.32 |
| `quotient_poly_compute_time_ms` |  59.83 |  239.31 |  72.04 |  54.37 |
| `quotient_poly_commit_time_ms` |  15.87 |  63.48 |  18.45 |  13.36 |
| `pcs_opening_time_ms ` |  64.75 |  259 |  80 |  50 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 580 | 41 | 1 | 34 | 4,137,502 | 121.58 | 168 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 217 | 727 | 23,446,148 | 150,778,428 | 217 | 319 | 0 | 58.06 | 18.45 | 5 | 72.12 | 75 | 107 | 75 | 3 | 59 | 10,899,170 | 34 | 47 | 1,103,000 | 27.51 | 22 | 77 | 1 | 75 | 
| regex_program | 1 | 160 | 561 | 11,598,276 | 128,513,066 | 160 | 292 | 1 | 54.37 | 15.78 | 4 | 66.91 | 80 | 90 | 80 | 0 | 51 | 2,196,106 | 22 | 67 | 1,104,000 | 31.42 | 17 | 70 | 0 | 80 | 
| regex_program | 2 | 166 | 541 | 11,579,064 | 128,513,066 | 166 | 274 | 1 | 54.85 | 15.89 | 4 | 68.19 | 54 | 97 | 54 | 0 | 51 | 2,177,334 | 28 | 59 | 1,104,000 | 31.33 | 17 | 71 | 0 | 54 | 
| regex_program | 3 | 190 | 580 | 11,853,872 | 103,456,394 | 190 | 302 | 0 | 72.04 | 13.36 | 5 | 55.32 | 50 | 114 | 50 | 0 | 51 | 2,422,606 | 56 | 46 | 826,502 | 31.05 | 19 | 86 | 1 | 50 | 

...
| `total_proof_time_ms ` |  709.50 |  1,419 |  809 |  610 |
...
| `execute_preflight_insn_mi/s` |  13.38 | -          |  17.78 |  8.98 |
| `trace_gen_time_ms   ` |  174.50 |  349 |  193 |  156 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  346 |  692 |  376 |  316 |
| `main_trace_commit_time_ms` |  64 |  128 |  75 |  53 |
| `generate_perm_trace_time_ms` |  32.50 |  65 |  38 |  27 |
| `perm_trace_commit_time_ms` |  76.71 |  153.43 |  89 |  64.43 |
| `quotient_poly_compute_time_ms` |  78.08 |  156.16 |  86.22 |  69.94 |
| `quotient_poly_commit_time_ms` |  15.77 |  31.55 |  17.39 |  14.16 |
| `pcs_opening_time_ms ` |  73 |  146 |  82 |  64 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 610 | 41 | 1 | 89 | 1,745,742 | 19.44 | 149 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 156 | 809 | 32,689,110 | 172,558,444 | 156 | 376 | 0 | 86.22 | 17.39 | 6 | 89 | 64 | 131 | 64 | 1 | 75 | 16,059,916 | 38 | 132 | 1,157,000 | 8.98 | 26 | 104 | 1 | 64 | 
| pairing | 1 | 193 | 610 | 22,314,288 | 119,958,502 | 192 | 316 | 1 | 69.94 | 14.16 | 6 | 64.43 | 82 | 95 | 82 | 0 | 53 | 9,408,294 | 27 | 59 | 588,742 | 17.78 | 20 | 84 | 1 | 82 | 

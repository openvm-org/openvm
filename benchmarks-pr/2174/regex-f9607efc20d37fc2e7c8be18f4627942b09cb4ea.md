...
| `total_proof_time_ms ` |  591.50 |  2,366 |  718 |  529 |
...
| `execute_metered_insn_mi/s` |  120.82 | -          |  120.82 |  120.82 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  55.25 |  221 |  67 |  47 |
| `execute_preflight_insn_mi/s` |  29.85 | -          |  31.03 |  27.25 |
| `trace_gen_time_ms   ` |  181.75 |  727 |  216 |  160 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  286.75 |  1,147 |  310 |  261 |
| `main_trace_commit_time_ms` |  52.50 |  210 |  58 |  50 |
| `generate_perm_trace_time_ms` |  32.25 |  129 |  56 |  18 |
| `perm_trace_commit_time_ms` |  66.26 |  265.04 |  72.55 |  55.68 |
| `quotient_poly_compute_time_ms` |  59.85 |  239.41 |  70.72 |  53.97 |
| `quotient_poly_commit_time_ms` |  15.20 |  60.81 |  17.79 |  12.79 |
| `pcs_opening_time_ms ` |  56.75 |  227 |  67 |  46 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 575 | 40 | 1 | 34 | 4,137,502 | 120.82 | 168 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 216 | 718 | 23,446,148 | 150,778,428 | 216 | 310 | 0 | 60.33 | 17.79 | 5 | 72.55 | 65 | 107 | 64 | 4 | 58 | 10,899,170 | 33 | 47 | 1,103,000 | 27.25 | 22 | 78 | 1 | 64 | 
| regex_program | 1 | 160 | 529 | 11,598,276 | 128,513,066 | 160 | 261 | 1 | 54.40 | 15.52 | 4 | 68.61 | 46 | 92 | 46 | 0 | 51 | 2,196,106 | 22 | 67 | 1,104,000 | 31.03 | 16 | 70 | 0 | 46 | 
| regex_program | 2 | 165 | 544 | 11,579,064 | 128,513,066 | 165 | 276 | 1 | 53.97 | 14.71 | 5 | 68.21 | 67 | 87 | 67 | 0 | 51 | 2,177,334 | 18 | 60 | 1,104,000 | 30.76 | 16 | 69 | 0 | 67 | 
| regex_program | 3 | 186 | 575 | 11,853,872 | 103,456,394 | 186 | 300 | 0 | 70.72 | 12.79 | 5 | 55.68 | 49 | 115 | 49 | 0 | 50 | 2,422,606 | 56 | 47 | 826,502 | 30.38 | 18 | 84 | 1 | 49 | 

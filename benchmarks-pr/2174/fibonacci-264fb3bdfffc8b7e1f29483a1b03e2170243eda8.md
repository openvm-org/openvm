...
|:---|---:|---:|
| Total |  1.10 |  0.57 |
| fibonacci_program |  1.09 |  0.56 |


| fibonacci_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  544.50 |  1,089 |  556 |  533 |
...
| `execute_metered_insn_mi/s` |  145.14 | -          |  145.14 |  145.14 |
| `execute_preflight_insns` |  750,104.50 |  1,500,209 |  873,000 |  627,209 |
| `execute_preflight_time_ms` |  29.50 |  59 |  33 |  26 |
| `execute_preflight_insn_mi/s` |  35.97 | -          |  37.61 |  34.32 |
| `trace_gen_time_ms   ` |  189.50 |  379 |  195 |  184 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  232 |  464 |  274 |  190 |
| `main_trace_commit_time_ms` |  30 |  60 |  32 |  28 |
| `generate_perm_trace_time_ms` |  29 |  58 |  33 |  25 |
| `perm_trace_commit_time_ms` |  41.11 |  82.21 |  44.26 |  37.96 |
| `quotient_poly_compute_time_ms` |  30.13 |  60.27 |  33.16 |  27.11 |
| `quotient_poly_commit_time_ms` |  11.96 |  23.92 |  12.21 |  11.71 |
| `pcs_opening_time_ms ` |  87.50 |  175 |  134 |  41 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 533 | 41 | 1 | 10 | 1,500,209 | 145.14 | 142 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 195 | 556 | 9,677,708 | 84,395,212 | 195 | 190 | 0 | 33.16 | 12.21 | 4 | 44.26 | 41 | 70 | 41 | 0 | 32 | 1,035,986 | 25 | 26 | 873,000 | 34.32 | 13 | 45 | 0 | 41 | 
| fibonacci_program | 1 | 184 | 533 | 9,708,170 | 74,305,770 | 184 | 274 | 1 | 27.11 | 11.71 | 4 | 37.96 | 134 | 71 | 134 | 0 | 28 | 1,064,416 | 33 | 33 | 627,209 | 37.61 | 11 | 39 | 0 | 134 | 

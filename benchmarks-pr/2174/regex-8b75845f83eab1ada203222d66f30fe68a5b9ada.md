...
| `total_proof_time_ms ` |  589 |  2,356 |  744 |  531 |
...
| `execute_metered_insn_mi/s` |  109.06 | -          |  109.06 |  109.06 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  54.50 |  218 |  66 |  46 |
| `execute_preflight_insn_mi/s` |  29.70 | -          |  31.07 |  27.08 |
| `trace_gen_time_ms   ` |  174.50 |  698 |  207 |  153 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  291.50 |  1,166 |  343 |  263 |
| `main_trace_commit_time_ms` |  51 |  204 |  57 |  48 |
| `generate_perm_trace_time_ms` |  34.75 |  139 |  55 |  18 |
| `perm_trace_commit_time_ms` |  64.14 |  256.56 |  70.18 |  55.18 |
| `quotient_poly_compute_time_ms` |  57.53 |  230.13 |  68.35 |  51.41 |
| `quotient_poly_commit_time_ms` |  14.93 |  59.71 |  16.82 |  12.20 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 531 | 41 | 1 | 37 | 4,137,502 | 109.06 | 166 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 207 | 744 | 23,446,148 | 150,778,428 | 207 | 343 | 0 | 58.01 | 16.82 | 5 | 70.18 | 84 | 126 | 84 | 4 | 57 | 10,899,170 | 55 | 47 | 1,103,000 | 27.08 | 21 | 75 | 1 | 84 | 
| regex_program | 1 | 153 | 546 | 11,598,276 | 128,513,066 | 153 | 285 | 1 | 52.35 | 15.06 | 4 | 64.94 | 62 | 104 | 61 | 0 | 50 | 2,196,106 | 38 | 66 | 1,104,000 | 31.07 | 16 | 68 | 0 | 61 | 
| regex_program | 2 | 159 | 535 | 11,579,064 | 128,513,066 | 159 | 275 | 1 | 51.41 | 15.63 | 4 | 66.25 | 63 | 94 | 62 | 0 | 49 | 2,177,334 | 28 | 59 | 1,104,000 | 30.58 | 17 | 67 | 0 | 62 | 
| regex_program | 3 | 179 | 531 | 11,853,872 | 103,456,394 | 179 | 263 | 0 | 68.35 | 12.20 | 5 | 55.18 | 57 | 76 | 56 | 0 | 48 | 2,422,606 | 18 | 46 | 826,502 | 30.07 | 18 | 81 | 1 | 56 | 

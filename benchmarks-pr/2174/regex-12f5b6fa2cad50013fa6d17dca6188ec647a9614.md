...
| `total_proof_time_ms ` |  584.50 |  2,338 |  739 |  522 |
...
| `execute_metered_insn_mi/s` |  121.59 | -          |  121.59 |  121.59 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  55.25 |  221 |  68 |  46 |
| `execute_preflight_insn_mi/s` |  30.16 | -          |  31.25 |  27.48 |
| `trace_gen_time_ms   ` |  177.50 |  710 |  211 |  153 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  284.50 |  1,138 |  336 |  258 |
| `main_trace_commit_time_ms` |  52 |  208 |  58 |  49 |
| `generate_perm_trace_time_ms` |  26.50 |  106 |  34 |  19 |
| `perm_trace_commit_time_ms` |  64.87 |  259.49 |  71.18 |  55.48 |
| `quotient_poly_compute_time_ms` |  58.01 |  232.03 |  69.48 |  52.15 |
| `quotient_poly_commit_time_ms` |  14.64 |  58.58 |  16.78 |  12.46 |
| `pcs_opening_time_ms ` |  65.50 |  262 |  98 |  54 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 551 | 45 | 1 | 34 | 4,137,502 | 121.59 | 172 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 211 | 739 | 23,446,148 | 150,778,428 | 211 | 336 | 0 | 57.34 | 16.78 | 5 | 71.18 | 98 | 104 | 98 | 4 | 58 | 10,899,170 | 32 | 47 | 1,103,000 | 27.48 | 21 | 74 | 1 | 98 | 
| regex_program | 1 | 153 | 526 | 11,598,276 | 128,513,066 | 153 | 263 | 1 | 53.06 | 14.93 | 4 | 66.66 | 54 | 88 | 54 | 0 | 51 | 2,196,106 | 21 | 68 | 1,104,000 | 30.97 | 16 | 68 | 0 | 54 | 
| regex_program | 2 | 163 | 522 | 11,579,064 | 128,513,066 | 163 | 258 | 1 | 52.15 | 14.39 | 4 | 66.17 | 55 | 85 | 54 | 0 | 50 | 2,177,334 | 19 | 60 | 1,104,000 | 31.25 | 16 | 67 | 0 | 54 | 
| regex_program | 3 | 183 | 551 | 11,853,872 | 103,456,394 | 183 | 281 | 0 | 69.48 | 12.46 | 5 | 55.48 | 55 | 92 | 55 | 0 | 49 | 2,422,606 | 34 | 46 | 826,502 | 30.94 | 18 | 83 | 1 | 55 | 

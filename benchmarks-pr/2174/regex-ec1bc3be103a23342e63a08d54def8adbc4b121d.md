...
|:---|---:|---:|
| Total |  2.38 |  0.76 |
| regex_program |  2.34 |  0.72 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  585.25 |  2,341 |  724 |  537 |
...
| `execute_preflight_time_ms` |  57.75 |  231 |  67 |  51 |
| `execute_preflight_insn_mi/s` |  30.07 | -          |  31.38 |  27.05 |
| `trace_gen_time_ms   ` |  175.25 |  701 |  219 |  150 |
| `memory_finalize_time_ms` |  1.50 |  6 |  6 |  0 |
| `stark_prove_excluding_trace_time_ms` |  284.25 |  1,137 |  306 |  272 |
| `main_trace_commit_time_ms` |  50.50 |  202 |  56 |  48 |
| `generate_perm_trace_time_ms` |  29 |  116 |  37 |  19 |
| `perm_trace_commit_time_ms` |  63.53 |  254.14 |  70.17 |  54.07 |
| `quotient_poly_compute_time_ms` |  57.21 |  228.84 |  69.41 |  51.06 |
| `quotient_poly_commit_time_ms` |  14.74 |  58.97 |  16.44 |  12.21 |
| `pcs_opening_time_ms ` |  65 |  260 |  72 |  62 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 540 | 41 | 1 | 34 | 4,137,502 | 119.87 | 170 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 219 | 724 | 23,446,148 | 150,778,428 | 219 | 306 | 0 | 56.99 | 16.44 | 5 | 70.17 | 72 | 101 | 72 | 6 | 56 | 10,899,170 | 30 | 51 | 1,103,000 | 27.05 | 21 | 74 | 1 | 72 | 
| regex_program | 1 | 150 | 540 | 11,598,276 | 128,513,066 | 150 | 282 | 1 | 51.37 | 14.75 | 4 | 64.53 | 62 | 103 | 62 | 0 | 49 | 2,196,106 | 37 | 67 | 1,104,000 | 31.07 | 16 | 66 | 0 | 62 | 
| regex_program | 2 | 158 | 537 | 11,579,064 | 128,513,066 | 158 | 277 | 1 | 51.06 | 15.58 | 5 | 65.37 | 63 | 96 | 63 | 0 | 49 | 2,177,334 | 30 | 61 | 1,104,000 | 30.76 | 17 | 67 | 0 | 63 | 
| regex_program | 3 | 174 | 540 | 11,853,872 | 103,456,394 | 174 | 272 | 0 | 69.41 | 12.21 | 6 | 54.07 | 63 | 76 | 63 | 0 | 48 | 2,422,606 | 19 | 52 | 826,502 | 31.38 | 18 | 82 | 1 | 63 | 

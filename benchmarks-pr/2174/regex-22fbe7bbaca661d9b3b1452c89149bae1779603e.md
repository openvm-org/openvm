...
| `total_proof_time_ms ` |  587.25 |  2,349 |  713 |  529 |
...
| `execute_metered_insn_mi/s` |  120.73 | -          |  120.73 |  120.73 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  54.50 |  218 |  66 |  46 |
| `execute_preflight_insn_mi/s` |  29.97 | -          |  31.09 |  27.43 |
| `trace_gen_time_ms   ` |  182.50 |  730 |  215 |  160 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  282.50 |  1,130 |  306 |  261 |
| `main_trace_commit_time_ms` |  52.25 |  209 |  57 |  50 |
| `generate_perm_trace_time_ms` |  22.50 |  90 |  28 |  20 |
| `perm_trace_commit_time_ms` |  65.51 |  262.03 |  70.41 |  55.40 |
| `quotient_poly_compute_time_ms` |  59.16 |  236.65 |  72.90 |  53.19 |
| `quotient_poly_commit_time_ms` |  15.39 |  61.55 |  18.22 |  13.14 |
| `pcs_opening_time_ms ` |  64.25 |  257 |  82 |  49 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 575 | 40 | 1 | 34 | 4,137,502 | 120.73 | 167 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 215 | 713 | 23,446,148 | 150,778,428 | 215 | 306 | 0 | 55.90 | 18.22 | 5 | 70.41 | 72 | 100 | 72 | 4 | 57 | 10,899,170 | 28 | 47 | 1,103,000 | 27.43 | 22 | 74 | 1 | 72 | 
| regex_program | 1 | 160 | 532 | 11,598,276 | 128,513,066 | 160 | 264 | 1 | 53.19 | 14.85 | 4 | 67.37 | 54 | 89 | 54 | 0 | 51 | 2,196,106 | 21 | 66 | 1,104,000 | 31.09 | 16 | 68 | 0 | 54 | 
| regex_program | 2 | 167 | 529 | 11,579,064 | 128,513,066 | 167 | 261 | 1 | 54.66 | 15.34 | 4 | 68.86 | 49 | 89 | 49 | 0 | 51 | 2,177,334 | 20 | 59 | 1,104,000 | 30.96 | 16 | 70 | 0 | 49 | 
| regex_program | 3 | 188 | 575 | 11,853,872 | 103,456,394 | 188 | 299 | 0 | 72.90 | 13.14 | 5 | 55.40 | 82 | 79 | 81 | 0 | 50 | 2,422,606 | 21 | 46 | 826,502 | 30.41 | 18 | 87 | 1 | 81 | 

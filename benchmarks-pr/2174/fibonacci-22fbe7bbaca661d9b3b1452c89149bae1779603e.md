...
| `total_proof_time_ms ` |  497 |  994 |  557 |  437 |
...
| `execute_metered_insn_mi/s` |  147.22 | -          |  147.22 |  147.22 |
| `execute_preflight_insns` |  750,104.50 |  1,500,209 |  873,000 |  627,209 |
| `execute_preflight_time_ms` |  30 |  60 |  34 |  26 |
| `execute_preflight_insn_mi/s` |  36.10 | -          |  37.88 |  34.32 |
| `trace_gen_time_ms   ` |  190 |  380 |  195 |  185 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  184 |  368 |  192 |  176 |
| `main_trace_commit_time_ms` |  30 |  60 |  32 |  28 |
| `generate_perm_trace_time_ms` |  24.50 |  49 |  27 |  22 |
| `perm_trace_commit_time_ms` |  41.15 |  82.30 |  43.69 |  38.61 |
| `quotient_poly_compute_time_ms` |  32.01 |  64.02 |  33.91 |  30.11 |
| `quotient_poly_commit_time_ms` |  11.97 |  23.93 |  12.07 |  11.86 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 437 | 41 | 1 | 10 | 1,500,209 | 147.22 | 139 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 195 | 557 | 9,677,708 | 84,395,212 | 195 | 192 | 0 | 33.91 | 12.07 | 4 | 43.69 | 40 | 71 | 40 | 0 | 32 | 1,035,986 | 27 | 26 | 873,000 | 34.32 | 14 | 46 | 0 | 40 | 
| fibonacci_program | 1 | 185 | 437 | 9,708,170 | 74,305,770 | 185 | 176 | 1 | 30.11 | 11.86 | 4 | 38.61 | 44 | 61 | 44 | 0 | 28 | 1,064,416 | 22 | 34 | 627,209 | 37.88 | 11 | 42 | 0 | 44 | 

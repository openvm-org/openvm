...
| `total_proof_time_ms ` |  589.75 |  2,359 |  739 |  530 |
...
| `execute_metered_insn_mi/s` |  121.20 | -          |  121.20 |  121.20 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  55.50 |  222 |  69 |  46 |
| `execute_preflight_insn_mi/s` |  30.16 | -          |  31.36 |  27.26 |
| `trace_gen_time_ms   ` |  180.50 |  722 |  214 |  157 |
| `memory_finalize_time_ms` |  0.75 |  3 |  3 |  0 |
| `stark_prove_excluding_trace_time_ms` |  286.50 |  1,146 |  334 |  263 |
| `main_trace_commit_time_ms` |  52 |  208 |  58 |  50 |
| `generate_perm_trace_time_ms` |  27 |  108 |  33 |  20 |
| `perm_trace_commit_time_ms` |  66.22 |  264.88 |  73.51 |  56.25 |
| `quotient_poly_compute_time_ms` |  59.63 |  238.51 |  70.37 |  54.03 |
| `quotient_poly_commit_time_ms` |  15.26 |  61.04 |  17.61 |  12.90 |
| `pcs_opening_time_ms ` |  63 |  252 |  93 |  49 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 558 | 41 | 1 | 34 | 4,137,502 | 121.20 | 167 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 214 | 739 | 23,446,148 | 150,778,428 | 214 | 334 | 0 | 60.05 | 17.61 | 5 | 73.51 | 93 | 103 | 92 | 3 | 58 | 10,899,170 | 29 | 47 | 1,103,000 | 27.26 | 22 | 78 | 1 | 92 | 
| regex_program | 1 | 157 | 530 | 11,598,276 | 128,513,066 | 157 | 263 | 1 | 54.03 | 15.12 | 4 | 67.29 | 54 | 88 | 54 | 0 | 50 | 2,196,106 | 20 | 69 | 1,104,000 | 30.93 | 16 | 69 | 0 | 54 | 
| regex_program | 2 | 165 | 532 | 11,579,064 | 128,513,066 | 165 | 265 | 1 | 54.06 | 15.41 | 4 | 67.83 | 49 | 95 | 49 | 0 | 50 | 2,177,334 | 26 | 60 | 1,104,000 | 31.08 | 16 | 70 | 0 | 49 | 
| regex_program | 3 | 186 | 558 | 11,853,872 | 103,456,394 | 186 | 284 | 0 | 70.37 | 12.90 | 5 | 56.25 | 56 | 93 | 56 | 0 | 50 | 2,422,606 | 33 | 46 | 826,502 | 31.36 | 19 | 84 | 1 | 56 | 

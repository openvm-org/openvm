...
| `total_proof_time_ms ` |  501.50 |  1,003 |  566 |  437 |
...
| `execute_metered_insn_mi/s` |  147.77 | -          |  147.77 |  147.77 |
| `execute_preflight_insns` |  750,104.50 |  1,500,209 |  873,000 |  627,209 |
| `execute_preflight_time_ms` |  29.50 |  59 |  33 |  26 |
| `execute_preflight_insn_mi/s` |  35.96 | -          |  37.66 |  34.25 |
| `trace_gen_time_ms   ` |  193 |  386 |  199 |  187 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  186 |  372 |  197 |  175 |
| `main_trace_commit_time_ms` |  30.50 |  61 |  33 |  28 |
| `generate_perm_trace_time_ms` |  24.50 |  49 |  28 |  21 |
| `perm_trace_commit_time_ms` |  41.36 |  82.71 |  43.71 |  38.100 |
| `quotient_poly_compute_time_ms` |  33.25 |  66.49 |  35.56 |  30.93 |
| `quotient_poly_commit_time_ms` |  12.11 |  24.22 |  12.58 |  11.64 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 437 | 40 | 1 | 10 | 1,500,209 | 147.77 | 141 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 199 | 566 | 9,677,708 | 84,395,212 | 199 | 197 | 0 | 35.56 | 12.58 | 4 | 43.71 | 41 | 72 | 41 | 0 | 33 | 1,035,986 | 28 | 26 | 873,000 | 34.25 | 14 | 48 | 0 | 41 | 
| fibonacci_program | 1 | 187 | 437 | 9,708,170 | 74,305,770 | 187 | 175 | 1 | 30.93 | 11.64 | 4 | 38.100 | 42 | 61 | 42 | 0 | 28 | 1,064,416 | 21 | 33 | 627,209 | 37.66 | 11 | 42 | 0 | 42 | 

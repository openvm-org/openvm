...
| `total_proof_time_ms ` |  713.50 |  1,427 |  820 |  607 |
...
| `execute_preflight_insn_mi/s` |  13.54 | -          |  18.02 |  9.05 |
| `trace_gen_time_ms   ` |  173.50 |  347 |  192 |  155 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  350.50 |  701 |  388 |  313 |
| `main_trace_commit_time_ms` |  65 |  130 |  75 |  55 |
| `generate_perm_trace_time_ms` |  44.50 |  89 |  48 |  41 |
| `perm_trace_commit_time_ms` |  76.92 |  153.83 |  89.13 |  64.71 |
| `quotient_poly_compute_time_ms` |  78.37 |  156.74 |  87.37 |  69.36 |
| `quotient_poly_commit_time_ms` |  15.80 |  31.60 |  17.68 |  13.92 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 607 | 41 | 1 | 89 | 1,745,742 | 19.52 | 145 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 155 | 820 | 32,689,110 | 172,558,444 | 155 | 388 | 0 | 87.37 | 17.68 | 6 | 89.13 | 73 | 134 | 73 | 1 | 75 | 16,059,916 | 41 | 132 | 1,157,000 | 9.05 | 26 | 105 | 1 | 73 | 
| pairing | 1 | 192 | 607 | 22,314,288 | 119,958,502 | 192 | 313 | 1 | 69.36 | 13.92 | 6 | 64.71 | 56 | 116 | 56 | 0 | 55 | 9,408,294 | 48 | 60 | 588,742 | 18.02 | 20 | 83 | 1 | 56 | 

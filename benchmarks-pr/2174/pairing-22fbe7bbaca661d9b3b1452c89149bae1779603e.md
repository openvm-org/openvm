...
| `total_proof_time_ms ` |  723 |  1,446 |  817 |  629 |
...
| `execute_preflight_insn_mi/s` |  13.42 | -          |  17.80 |  9.04 |
| `trace_gen_time_ms   ` |  178 |  356 |  195 |  161 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  357 |  714 |  382 |  332 |
| `main_trace_commit_time_ms` |  64.50 |  129 |  74 |  55 |
| `generate_perm_trace_time_ms` |  55 |  110 |  68 |  42 |
| `perm_trace_commit_time_ms` |  74.87 |  149.73 |  85.44 |  64.30 |
| `quotient_poly_compute_time_ms` |  78.42 |  156.83 |  84.91 |  71.93 |
| `quotient_poly_commit_time_ms` |  16.39 |  32.78 |  17.98 |  14.79 |
| `pcs_opening_time_ms ` |  62.50 |  125 |  72 |  53 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 629 | 40 | 1 | 93 | 1,745,742 | 18.74 | 144 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 161 | 817 | 32,689,110 | 172,558,444 | 160 | 382 | 0 | 84.91 | 17.98 | 6 | 85.44 | 72 | 131 | 71 | 1 | 74 | 16,059,916 | 42 | 131 | 1,157,000 | 9.04 | 26 | 103 | 1 | 71 | 
| pairing | 1 | 195 | 629 | 22,314,288 | 119,958,502 | 195 | 332 | 1 | 71.93 | 14.79 | 6 | 64.30 | 53 | 135 | 53 | 0 | 55 | 9,408,294 | 68 | 60 | 588,742 | 17.80 | 21 | 87 | 1 | 53 | 

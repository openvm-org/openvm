...
|:---|---:|---:|
| Total |  1.03 |  0.57 |
| fibonacci_program |  1.02 |  0.56 |


| fibonacci_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  508 |  1,016 |  563 |  453 |
...
| `execute_metered_insn_mi/s` |  148.32 | -          |  148.32 |  148.32 |
| `execute_preflight_insns` |  750,104.50 |  1,500,209 |  873,000 |  627,209 |
| `execute_preflight_time_ms` |  29.50 |  59 |  33 |  26 |
| `execute_preflight_insn_mi/s` |  36.27 | -          |  38.14 |  34.39 |
| `trace_gen_time_ms   ` |  192 |  384 |  198 |  186 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  193 |  386 |  195 |  191 |
| `main_trace_commit_time_ms` |  30.50 |  61 |  33 |  28 |
| `generate_perm_trace_time_ms` |  29 |  58 |  33 |  25 |
| `perm_trace_commit_time_ms` |  41.37 |  82.74 |  44.14 |  38.60 |
| `quotient_poly_compute_time_ms` |  30.56 |  61.13 |  31.91 |  29.22 |
| `quotient_poly_commit_time_ms` |  12.11 |  24.22 |  12.88 |  11.34 |
| `pcs_opening_time_ms ` |  48 |  96 |  50 |  46 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 453 | 40 | 1 | 10 | 1,500,209 | 148.32 | 142 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 198 | 563 | 9,677,708 | 84,395,212 | 198 | 195 | 0 | 31.91 | 12.88 | 4 | 44.14 | 46 | 69 | 46 | 0 | 33 | 1,035,986 | 25 | 26 | 873,000 | 34.39 | 14 | 45 | 0 | 46 | 
| fibonacci_program | 1 | 186 | 453 | 9,708,170 | 74,305,770 | 186 | 191 | 1 | 29.22 | 11.34 | 4 | 38.60 | 50 | 72 | 49 | 0 | 28 | 1,064,416 | 33 | 33 | 627,209 | 38.14 | 11 | 40 | 0 | 49 | 

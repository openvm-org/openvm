...
|:---|---:|---:|
| Total |  1.04 |  0.57 |
| fibonacci_program |  1.03 |  0.56 |


| fibonacci_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  517 |  1,034 |  555 |  479 |
...
| `execute_metered_insn_mi/s` |  147.04 | -          |  147.04 |  147.04 |
| `execute_preflight_insns` |  750,104.50 |  1,500,209 |  873,000 |  627,209 |
| `execute_preflight_time_ms` |  29.50 |  59 |  33 |  26 |
| `execute_preflight_insn_mi/s` |  36.12 | -          |  37.83 |  34.41 |
| `trace_gen_time_ms   ` |  188.50 |  377 |  192 |  185 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  206 |  412 |  219 |  193 |
| `main_trace_commit_time_ms` |  30.50 |  61 |  33 |  28 |
| `generate_perm_trace_time_ms` |  20 |  40 |  28 |  12 |
| `perm_trace_commit_time_ms` |  41.23 |  82.47 |  44.36 |  38.10 |
| `quotient_poly_compute_time_ms` |  30.94 |  61.89 |  31.37 |  30.52 |
| `quotient_poly_commit_time_ms` |  12.34 |  24.68 |  12.69 |  11.99 |
| `pcs_opening_time_ms ` |  68.50 |  137 |  96 |  41 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 479 | 42 | 1 | 10 | 1,500,209 | 147.04 | 142 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 192 | 555 | 9,677,708 | 84,395,212 | 192 | 193 | 0 | 31.37 | 12.69 | 4 | 44.36 | 41 | 73 | 41 | 0 | 33 | 1,035,986 | 28 | 26 | 873,000 | 34.41 | 14 | 44 | 0 | 41 | 
| fibonacci_program | 1 | 185 | 479 | 9,708,170 | 74,305,770 | 185 | 219 | 1 | 30.52 | 11.99 | 4 | 38.10 | 96 | 51 | 95 | 0 | 28 | 1,064,416 | 12 | 33 | 627,209 | 37.83 | 11 | 42 | 0 | 95 | 

...
| `total_proof_time_ms ` |  581.25 |  2,325 |  700 |  532 |
...
| `execute_metered_insn_mi/s` |  114.69 | -          |  114.69 |  114.69 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  55 |  220 |  66 |  47 |
| `execute_preflight_insn_mi/s` |  29.81 | -          |  30.99 |  27.16 |
| `trace_gen_time_ms   ` |  179.25 |  717 |  212 |  159 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  279 |  1,116 |  296 |  265 |
| `main_trace_commit_time_ms` |  52 |  208 |  58 |  49 |
| `generate_perm_trace_time_ms` |  25 |  100 |  30 |  20 |
| `perm_trace_commit_time_ms` |  65.82 |  263.28 |  72.85 |  55.87 |
| `quotient_poly_compute_time_ms` |  59.48 |  237.92 |  71.32 |  53.51 |
| `quotient_poly_commit_time_ms` |  15.08 |  60.32 |  16.87 |  12.82 |
| `pcs_opening_time_ms ` |  58.75 |  235 |  71 |  53 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 557 | 41 | 1 | 36 | 4,137,502 | 114.69 | 166 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 212 | 700 | 23,446,148 | 150,778,428 | 212 | 296 | 0 | 59.03 | 16.87 | 5 | 72.85 | 56 | 103 | 56 | 4 | 58 | 10,899,170 | 30 | 47 | 1,103,000 | 27.16 | 21 | 76 | 1 | 56 | 
| regex_program | 1 | 159 | 532 | 11,598,276 | 128,513,066 | 159 | 265 | 1 | 53.51 | 14.99 | 4 | 67.17 | 55 | 89 | 54 | 0 | 51 | 2,196,106 | 22 | 66 | 1,104,000 | 30.99 | 16 | 69 | 0 | 54 | 
| regex_program | 2 | 163 | 536 | 11,579,064 | 128,513,066 | 163 | 270 | 1 | 54.05 | 15.64 | 4 | 67.40 | 53 | 96 | 53 | 0 | 50 | 2,177,334 | 28 | 60 | 1,104,000 | 30.46 | 16 | 70 | 0 | 53 | 
| regex_program | 3 | 183 | 557 | 11,853,872 | 103,456,394 | 183 | 285 | 0 | 71.32 | 12.82 | 5 | 55.87 | 71 | 79 | 70 | 0 | 49 | 2,422,606 | 20 | 47 | 826,502 | 30.64 | 18 | 85 | 1 | 70 | 

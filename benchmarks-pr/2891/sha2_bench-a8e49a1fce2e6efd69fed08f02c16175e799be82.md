...
| `total_proof_time_ms ` |  2,601 |  10,404 |  2,710 |  2,546 |
| `compile_metered_time_ms` |  3 |  3 |  3 |  3 |
| `execute_metered_time_ms` |  100 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  111.34 | -          |  111.34 |  111.34 |
| `execute_preflight_insns` |  2,791,990.25 |  11,167,961 |  2,851,000 |  2,614,961 |
| `execute_preflight_time_ms` |  162.50 |  650 |  207 |  98 |
| `execute_preflight_insn_mi/s` |  35.28 | -          |  36.34 |  32.87 |
| `trace_gen_time_ms   ` |  58.50 |  234 |  66 |  54 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  2,314.25 |  9,257 |  2,409 |  2,282 |
| `prover.main_trace_commit_time_ms` |  614.50 |  2,458 |  619 |  611 |
| `prover.rap_constraints_time_ms` |  1,226 |  4,904 |  1,232 |  1,214 |
| `prover.openings_time_ms` |  473 |  1,892 |  561 |  440 |
| `prover.rap_constraints.logup_gkr_time_ms` |  308.50 |  1,234 |  309 |  308 |
| `prover.rap_constraints.round0_time_ms` |  672.75 |  2,691 |  676 |  668 |
| `prover.rap_constraints.mle_rounds_time_ms` |  243.50 |  974 |  247 |  237 |
| `prover.openings.stacked_reduction_time_ms` |  97.75 |  391 |  99 |  96 |
| `prover.openings.stacked_reduction.round0_time_ms` |  59 |  236 |  60 |  58 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  38 |  152 |  39 |  37 |
| `prover.openings.whir_time_ms` |  374.75 |  1,499 |  461 |  342 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,924 |  1,924 |  1,924 |  1,924 |
| `execute_preflight_time_ms` |  2 |  2 |  2 |  2 |
| `trace_gen_time_ms   ` |  147 |  147 |  147 |  147 |
| `generate_blob_total_time_ms` |  22 |  22 |  22 |  22 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,776 |  1,776 |  1,776 |  1,776 |
| `prover.main_trace_commit_time_ms` |  801 |  801 |  801 |  801 |
| `prover.rap_constraints_time_ms` |  347 |  347 |  347 |  347 |
| `prover.openings_time_ms` |  627 |  627 |  627 |  627 |
| `prover.rap_constraints.logup_gkr_time_ms` |  74 |  74 |  74 |  74 |
| `prover.rap_constraints.round0_time_ms` |  168 |  168 |  168 |  168 |
| `prover.rap_constraints.mle_rounds_time_ms` |  104 |  104 |  104 |  104 |
...
| `prover.openings.whir_time_ms` |  562 |  562 |  562 |  562 |

| internal_for_leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  493 |  493 |  493 |  493 |
| `execute_preflight_time_ms` |  2 |  2 |  2 |  2 |
...
| `prover.rap_constraints_time_ms` |  131 |  131 |  131 |  131 |
...
| `prover.openings.whir_time_ms` |  132 |  132 |  132 |  132 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/a8e49a1fce2e6efd69fed08f02c16175e799be82/sha2_bench-a8e49a1fce2e6efd69fed08f02c16175e799be82.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 79 | 9 |  |  | 0 |  | 352 | 9 |  |  |  |  |  |  | 
| app_proof |  |  |  |  |  | 2
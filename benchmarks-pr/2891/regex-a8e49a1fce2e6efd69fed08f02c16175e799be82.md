...
|:---|---:|---:|---:|
| Total |  2.60 |  1.95 |  1.95 |
| app_proof |  1.57 |  0.92 |  0.92 |
| leaf |  0.43 |  0.43 |  0.43 |
...
| `total_proof_time_ms ` |  768.50 |  1,537 |  885 |  652 |
| `compile_metered_time_ms` |  8 |  8 |  8 |  8 |
| `execute_metered_time_ms` |  35 | -          | -          | -          |
| `execute_metered_insns` |  4,090,656 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  115.88 | -          |  115.88 |  115.88 |
| `execute_preflight_insns` |  2,045,328 |  4,090,656 |  2,327,000 |  1,763,656 |
| `execute_preflight_time_ms` |  85 |  170 |  94 |  76 |
| `execute_preflight_insn_mi/s` |  33.07 | -          |  34.40 |  31.73 |
| `trace_gen_time_ms   ` |  38 |  76 |  44 |  32 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  555 |  1,110 |  620 |  490 |
| `prover.main_trace_commit_time_ms` |  115 |  230 |  129 |  101 |
| `prover.rap_constraints_time_ms` |  326 |  652 |  365 |  287 |
| `prover.openings_time_ms` |  113 |  226 |  125 |  101 |
| `prover.rap_constraints.logup_gkr_time_ms` |  198.50 |  397 |  242 |  155 |
| `prover.rap_constraints.round0_time_ms` |  92.50 |  185 |  100 |  85 |
| `prover.rap_constraints.mle_rounds_time_ms` |  34 |  68 |  37 |  31 |
| `prover.openings.stacked_reduction_time_ms` |  22 |  44 |  24 |  20 |
...
| `prover.openings.whir_time_ms` |  91 |  182 |  101 |  81 |
...
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  380 |  380 |  380 |  380 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/a8e49a1fce2e6efd69fed08f02c16175e799be82/regex-a8e49a1fce2e6efd69fed08f02c16175e799be82.memory.svg)
...
| app_proof |  |  |  |  |  | 652 |  |  | 35 | 4,090,656 | 115.88 | 0 | 1,587 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 16 | 276 | 15 | 4 | 0 | 2 | 1 | 1 | 
| internal_recursive.0 | 1 | 11 | 176 | 10 | 1 | 0 | 2 | 0 | 0 | 
| internal_recursive.1 | 1 | 9 | 145 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 51 | 432 | 51 | 13 | 3 | 4 | 1 | 1 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 27,289,403 | 260 | 81 | 0 | 0 | 98 | 32 | 32 | 45 | 20 | 0 | 79 | 67 | 11 | 2 | 8 | 82 | 98 | 0 | 2 | 18 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,767 | 165 | 46 | 0 | 0 | 67 | 25 | 24 | 27 | 14 | 0 | 51 | 43 | 8 | 1 | 6 | 46 | 67 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 136 | 32 | 0 | 0 | 60 | 22 | 22 | 24 | 13 | 0 | 42 | 35 | 7 | 1 | 5 | 33 | 60 | 0 | 3 | 12 | 0 | 0 | 
| leaf | 0 | prover | 79,656,756 | 380 | 127 | 0 | 0 | 134 | 55 | 54 | 37 | 42 | 0 | 117 | 102 | 15 | 6 | 8 | 128 | 134 | 0 | 7 | 41 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 161,843,666 | 620 | 129 | 0 | 0 | 365 | 85 | 85 | 37 | 242 | 0 | 125 | 101 | 24 | 13 | 11 | 129 | 365 | 0 | 3 | 241 | 0 | 0 | 
| app_proof | prover | 1 | 123,257,151 | 490 | 101 | 0 | 0 | 287 | 100 | 100 | 31 | 155 | 0 | 101 | 81 | 20 | 9 | 10 | 101 | 287 | 0 | 3 | 154 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 32 | 885 | 32 | 137 | 2,906,597,493 | 888,488,923 | 3,795,086,416 | 2,097,152 | 1 | 4 | 94 | 2,327,000 | 31.73 | 
| app_proof | 1 | 44 | 652 | 44 | 41 | 2,092,069,523 | 674,063,136 | 2,766,132,659 | 2,097,152 | 0 | 2 | 76 | 1,763,656 | 34.40 | 

...
|:---|---:|---:|---:|
| Total |  13.37 |  5.63 |  5.63 |
| app_proof |  10.58 |  2.84 |  2.84 |
| leaf |  1.95 |  1.95 |  1.95 |
...
| `total_proof_time_ms ` |  2,619 |  10,476 |  2,742 |  2,557 |
...
| `execute_preflight_time_ms` |  169.75 |  679 |  217 |  113 |
| `execute_preflight_insn_mi/s` |  33.18 | -          |  36.13 |  27.97 |
| `trace_gen_time_ms   ` |  57.50 |  230 |  63 |  53 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  2,325.75 |  9,303 |  2,428 |  2,291 |
| `prover.main_trace_commit_time_ms` |  619.50 |  2,478 |  623 |  617 |
| `prover.rap_constraints_time_ms` |  1,230.75 |  4,923 |  1,236 |  1,223 |
| `prover.openings_time_ms` |  474 |  1,896 |  568 |  440 |
| `prover.rap_constraints.logup_gkr_time_ms` |  309.50 |  1,238 |  311 |  308 |
| `prover.rap_constraints.round0_time_ms` |  674.75 |  2,699 |  678 |  670 |
| `prover.rap_constraints.mle_rounds_time_ms` |  245.25 |  981 |  248 |  243 |
| `prover.openings.stacked_reduction_time_ms` |  98 |  392 |  99 |  96 |
...
| `prover.openings.whir_time_ms` |  375.50 |  1,502 |  469 |  342 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,954 |  1,954 |  1,954 |  1,954 |
...
| `prover.openings_time_ms` |  644 |  644 |  644 |  644 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/1052660ebf00014204513c7a0274725f1b92867c/sha2_bench-1052660ebf00014204513c7a0274725f1b92867c.memory.svg)
...
| app_proof |  |  |  |  |  | 2,557 |  |  | 100 | 11,167,961 | 110.75 | 0 | 10,583 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 28 | 495 | 28 | 7 | 2 | 2 | 3 | 3 | 
| internal_recursive.0 | 1 | 13 | 198 | 13 | 2 | 0 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 9 | 145 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 144 | 1,954 | 143 | 50 | 22 | 2 | 6 | 6 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 61,220,667 | 466 | 184 | 0 | 0 | 130 | 38 | 37 | 65 | 27 | 0 | 150 | 132 | 18 | 5 | 12 | 184 | 130 | 0 | 4 | 26 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,943 | 184 | 50 | 0 | 0 | 73 | 25 | 24 | 29 | 18 | 0 | 61 | 52 | 8 | 2 | 6 | 50 | 73 | 0 | 3 | 17 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 135 | 31 | 0 | 0 | 62 | 23 | 23 | 24 | 13 | 0 | 40 | 33 | 7 | 1 | 5 | 31 | 62 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 425,192,422 | 1,810 | 812 | 0 | 90 | 353 | 170 | 169 | 106 | 76 | 0 | 644 | 578 | 65 | 37 | 28 | 813 | 353 | 0 | 9 | 75 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 640,057,593 | 2,428 | 623 | 0 | 72 | 1,236 | 678 | 678 | 245 | 311 | 0 | 568 | 469 | 99 | 60 | 39 | 623 | 1,236 | 0 | 4 | 309 | 0 | 0 | 
| app_proof | prover | 1 | 640,057,356 | 2,293 | 618 | 0 | 0 | 1,233 | 676 | 675 | 248 | 308 | 0 | 440 | 343 | 96 | 58 | 38 | 618 | 1,233 | 0 | 4 | 307 | 0 | 0 | 
| app_proof | prover | 2 | 640,057,356 | 2,291 | 617 | 0 | 0 | 1,231 | 675 | 674 | 245 | 310 | 0 | 442 | 342 | 99 | 60 | 38 | 617 | 1,231 | 0 | 5 | 309 | 0 | 0 | 
| app_proof | prover | 3 | 640,057,588 | 2,291 | 620 | 0 | 0 | 1,223 | 670 | 669 | 243 | 309 | 0 | 446 | 348 | 98 | 59 | 38 | 620 | 1,223 | 0 | 5 | 308 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 63 | 2,742 | 63 | 136 | 5,529,436,044 | 2,165,730,336 | 7,695,166,380 | 2,097,152 | 0 | 3 | 113 | 2,851,000 | 27.97 | 
| app_proof | 1 | 57 | 2,608 | 57 | 41 | 5,529,347,520 | 2,165,557,968 | 7,694,905,488 | 2,097,152 | 0 | 1 | 217 | 2,851,000 | 32.76 | 
| app_proof | 2 | 57 | 2,569 | 57 | 41 | 5,529,349,296 | 2,165,556,192 | 7,694,905,488 | 2,097,152 | 0 | 1 | 179 | 2,851,000 | 36.13 | 
| app_proof | 3 | 53 | 2,557 | 53 | 41 | 5,077,435,956 | 2,617,472,316 | 7,694,908,272 | 2,097,152 | 0 | 1 | 170 | 2,614,961 | 35.86 | 

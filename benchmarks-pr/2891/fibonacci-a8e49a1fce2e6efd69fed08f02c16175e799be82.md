...
|:---|---:|---:|---:|
| Total |  2.79 |  1.68 |  1.68 |
| app_proof |  1.67 |  0.56 |  0.56 |
| leaf |  0.52 |  0.52 |  0.52 |
...
| `total_proof_time_ms ` |  411.50 |  1,646 |  539 |  224 |
| `compile_metered_time_ms` |  3 |  3 |  3 |  3 |
| `execute_metered_time_ms` |  21 | -          | -          | -          |
| `execute_metered_insns` |  4,000,051 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  189.23 | -          |  189.23 |  189.23 |
| `execute_preflight_insns` |  1,000,012.75 |  4,000,051 |  1,310,000 |  70,051 |
| `execute_preflight_time_ms` |  35.50 |  142 |  48 |  4 |
| `execute_preflight_insn_mi/s` |  41.30 | -          |  41.48 |  41.03 |
| `trace_gen_time_ms   ` |  75.75 |  303 |  101 |  67 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  234.50 |  938 |  288 |  77 |
| `prover.main_trace_commit_time_ms` |  41.25 |  165 |  50 |  15 |
| `prover.rap_constraints_time_ms` |  136.25 |  545 |  172 |  33 |
| `prover.openings_time_ms` |  55.75 |  223 |  67 |  27 |
| `prover.rap_constraints.logup_gkr_time_ms` |  94.50 |  378 |  122 |  16 |
| `prover.rap_constraints.round0_time_ms` |  27.25 |  109 |  34 |  9 |
| `prover.rap_constraints.mle_rounds_time_ms` |  13 |  52 |  15 |  7 |
| `prover.openings.stacked_reduction_time_ms` |  8.75 |  35 |  11 |  3 |
...
| `prover.openings.whir_time_ms` |  46.50 |  186 |  56 |  24 |
...
| `prover.openings.whir_time_ms` |  121 |  121 |  121 |  121 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/a8e49a1fce2e6efd69fed08f02c16175e799be82/fibonacci-a8e49a1fce2e6efd69fed08f02c16175e799be82.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 68 | 9 |  |  | 0 |  | 341 | 9 |  |  |  |  |  |  | 
| app_proof |  |  |  |  |  | 224 |  |  | 21 | 4,000,051 | 189.23 | 0 | 1,673 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 27,289,403 | 255 | 82 | 0 | 0 | 96 | 31 | 31 | 45 | 19 | 0 | 75 | 64 | 11 | 2 | 8 | 82 | 96 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,767 | 168 | 45 | 0 | 0 | 67 | 24 | 24 | 27 | 14 | 0 | 54 | 46 | 8 | 1 | 6 | 46 | 67 | 0 | 3 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 138 | 31 | 0 | 0 | 61 | 23 | 22 | 24 | 13 | 0 | 44 | 37 | 7 | 1 | 5 | 32 | 60 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 102,779,942 | 466 | 167 | 0 | 0 | 158 | 69 | 68 | 46 | 42 | 0 | 139 | 121 | 18 | 8 | 9 | 167 | 158 | 0 | 7 | 41 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 62,648,824 | 286 | 50 | 0 | 0 | 170 | 33 | 32 | 15 | 120 | 0 | 65 | 53 | 11 | 5 | 5 | 50 | 170 | 0 | 3 | 119 | 0 | 0 | 
| app_proof | prover | 1 | 62,602,932 | 288 | 50 | 0 | 0 | 170 | 34 | 33 | 15 | 120 | 0 | 67 | 56 | 10 | 5 | 5 | 50 | 170 | 0 | 3 | 120 | 0 | 0 | 
| app_proof | prover | 2 | 62,602,932 | 287 | 50 | 0 | 0 | 172 | 33 | 33 | 15 | 122 | 0 | 64 | 53 | 11 | 5 | 5 | 50 | 172 | 0 | 3 | 121 | 0 | 0 | 
| app_proof | prover | 3 | 9,072,096 | 77 | 15 | 0 | 0 | 33 | 9 | 9 | 7 | 16 | 0 | 27 | 24 | 3 | 0 | 2 | 15 | 33 | 0 | 2 | 16 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 67 | 539 | 67 | 136 | 1,626,487,336 | 2,099,944 | 1,628,587,280 | 2,097,152 | 0 | 3 | 48 | 1,310,000 | 41.48 | 
| app_proof | 1 | 67 | 442 | 67 | 40 | 1,625,164,404 | 1,206,055 | 1,626,370,459 | 2,097,152 | 0 | 1 | 45 | 1,310,000 | 41.32 | 
| app_proof | 2 | 68 | 441 | 68 | 41 | 1,625,164,404 | 1,206,055 | 1,626,370,459 | 2,097,152 | 0 | 1 | 45 | 1,310,000 | 41.37 | 
| app_proof | 3 | 101 | 224 | 101 | 40 | 160,245,438 | 14,292,769 | 174,538,207 | 2,097,152 | 0 | 1 | 4 | 70,051 | 41.03 | 

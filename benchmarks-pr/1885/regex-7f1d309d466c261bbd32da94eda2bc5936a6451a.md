...
| `execute_metered_insn_mi/s` |  67.83 | -          |  67.83 |  67.83 |
| `execute_e3_time_ms  ` |  122.50 |  245 |  138 |  107 |
| `execute_e3_insn_mi/s` |  17.06 | -          |  17.95 |  16.17 |
| `memory_finalize_time_ms` |  7 |  14 |  12 |  2 |
| `boundary_finalize_time_ms` |  2.50 |  5 |  5 |  0 |
| `merkle_finalize_time_ms` |  148.50 |  297 |  231 |  66 |
| `stark_prove_excluding_trace_time_ms` |  2,633.50 |  5,267 |  2,868 |  2,399 |
| `main_trace_commit_time_ms` |  527.50 |  1,055 |  583 |  472 |
| `generate_perm_trace_time_ms` |  206 |  412 |  235 |  177 |
| `perm_trace_commit_time_ms` |  559 |  1,118 |  600 |  518 |
| `quotient_poly_compute_time_ms` |  266.50 |  533 |  288 |  245 |
| `quotient_poly_commit_time_ms` |  258 |  516 |  305 |  211 |
| `pcs_opening_time_ms ` |  807.50 |  1,615 |  852 |  763 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 3,995 | 24 | 4,165,433 | 1 | 61 | 67.83 | 62 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 516 | 275,648,700 | 2,868 | 288 | 305 | 600 | 852 | 231 | 25 | 12 | 583 | 2,243,700 | 235 | 138 | 16.17 | 5 | 
| regex_program | 1 | 299 | 242,975,370 | 2,399 | 245 | 211 | 518 | 763 | 66 | 23 | 2 | 472 | 1,921,733 | 177 | 107 | 17.95 | 0 | 

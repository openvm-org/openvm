...
| `total_proof_time_ms ` |  719 |  1,438 |  810 |  628 |
...
| `execute_preflight_time_ms` |  93 |  186 |  125 |  61 |
| `execute_preflight_insn_mi/s` |  13.65 | -          |  17.84 |  9.46 |
| `trace_gen_time_ms   ` |  178 |  356 |  192 |  164 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  355 |  710 |  377 |  333 |
| `main_trace_commit_time_ms` |  63.50 |  127 |  74 |  53 |
| `generate_perm_trace_time_ms` |  55 |  110 |  71 |  39 |
| `perm_trace_commit_time_ms` |  76.32 |  152.65 |  89.08 |  63.57 |
| `quotient_poly_compute_time_ms` |  78.47 |  156.93 |  86.94 |  69.100 |
| `quotient_poly_commit_time_ms` |  15.57 |  31.14 |  17.12 |  14.03 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 628 | 1 | 87 | 1,745,742 | 20.02 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 164 | 810 | 32,689,110 | 172,558,444 | 164 | 377 | 0 | 86.94 | 17.12 | 6 | 89.08 | 66 | 131 | 66 | 1 | 74 | 16,059,916 | 39 | 125 | 1,157,000 | 9.46 | 26 | 104 | 1 | 66 | 
| pairing | 1 | 192 | 628 | 22,314,288 | 119,958,502 | 192 | 333 | 1 | 69.100 | 14.03 | 5 | 63.57 | 57 | 137 | 56 | 0 | 53 | 9,408,294 | 71 | 61 | 588,742 | 17.84 | 20 | 84 | 1 | 56 | 

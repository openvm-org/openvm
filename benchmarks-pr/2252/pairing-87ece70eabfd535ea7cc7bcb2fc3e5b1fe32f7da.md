...
| `total_proof_time_ms ` |  729 |  1,458 |  840 |  618 |
...
| `execute_preflight_insn_mi/s` |  14.14 | -          |  18.70 |  9.58 |
| `trace_gen_time_ms   ` |  182 |  364 |  196 |  168 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  362 |  724 |  402 |  322 |
| `main_trace_commit_time_ms` |  64.50 |  129 |  74 |  55 |
| `generate_perm_trace_time_ms` |  55 |  110 |  62 |  48 |
| `perm_trace_commit_time_ms` |  76.49 |  152.97 |  88.93 |  64.04 |
| `quotient_poly_compute_time_ms` |  78.100 |  157.99 |  87.48 |  70.51 |
| `quotient_poly_commit_time_ms` |  16.14 |  32.29 |  18.14 |  14.15 |
| `pcs_opening_time_ms ` |  67 |  134 |  67 |  67 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 618 | 1 | 87 | 1,745,742 | 19.91 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 168 | 840 | 32,689,110 | 172,558,444 | 168 | 402 | 0 | 87.48 | 18.14 | 6 | 88.93 | 67 | 153 | 67 | 1 | 74 | 16,059,916 | 62 | 124 | 1,157,000 | 9.58 | 26 | 106 | 1 | 67 | 
| pairing | 1 | 196 | 618 | 22,314,288 | 119,958,502 | 196 | 322 | 1 | 70.51 | 14.15 | 6 | 64.04 | 67 | 114 | 66 | 0 | 55 | 9,408,294 | 48 | 58 | 588,742 | 18.70 | 20 | 85 | 1 | 66 | 

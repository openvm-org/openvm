...
| `total_proof_time_ms ` |  744.50 |  1,489 |  815 |  674 |
...
| `execute_preflight_time_ms` |  93.50 |  187 |  126 |  61 |
| `execute_preflight_insn_mi/s` |  13.88 | -          |  18.33 |  9.43 |
| `trace_gen_time_ms   ` |  180.50 |  361 |  195 |  166 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  377 |  754 |  378 |  376 |
| `main_trace_commit_time_ms` |  65.50 |  131 |  76 |  55 |
| `generate_perm_trace_time_ms` |  48.50 |  97 |  62 |  35 |
| `perm_trace_commit_time_ms` |  76.81 |  153.61 |  89.25 |  64.36 |
| `quotient_poly_compute_time_ms` |  79.74 |  159.47 |  87.81 |  71.66 |
| `quotient_poly_commit_time_ms` |  16.74 |  33.47 |  18.94 |  14.54 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 674 | 1 | 87 | 1,745,742 | 19.98 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 166 | 815 | 32,689,110 | 172,558,444 | 166 | 378 | 0 | 87.81 | 18.94 | 6 | 89.25 | 67 | 127 | 66 | 1 | 76 | 16,059,916 | 35 | 126 | 1,157,000 | 9.43 | 27 | 107 | 1 | 66 | 
| pairing | 1 | 195 | 674 | 22,314,288 | 119,958,502 | 195 | 376 | 1 | 71.66 | 14.54 | 6 | 64.36 | 104 | 129 | 104 | 0 | 55 | 9,408,294 | 62 | 61 | 588,742 | 18.33 | 21 | 86 | 1 | 104 | 

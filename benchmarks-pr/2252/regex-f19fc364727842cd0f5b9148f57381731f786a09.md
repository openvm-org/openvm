...
| `total_proof_time_ms ` |  584 |  2,336 |  715 |  537 |
...
| `execute_metered_insn_mi/s` |  109.26 | -          |  109.26 |  109.26 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  54 |  216 |  66 |  45 |
| `execute_preflight_insn_mi/s` |  31.27 | -          |  32.74 |  28.46 |
| `trace_gen_time_ms   ` |  178.50 |  714 |  210 |  156 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  284.25 |  1,137 |  315 |  266 |
| `main_trace_commit_time_ms` |  51.75 |  207 |  57 |  49 |
| `generate_perm_trace_time_ms` |  29.25 |  117 |  37 |  19 |
| `perm_trace_commit_time_ms` |  64.21 |  256.83 |  70.82 |  56.09 |
| `quotient_poly_compute_time_ms` |  58.73 |  234.92 |  69.91 |  52.59 |
| `quotient_poly_commit_time_ms` |  14.79 |  59.15 |  17.18 |  12.94 |
| `pcs_opening_time_ms ` |  62.50 |  250 |  75 |  52 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 537 | 1 | 37 | 4,137,502 | 109.26 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 210 | 715 | 23,446,148 | 150,778,428 | 210 | 315 | 0 | 59.54 | 17.18 | 6 | 70.82 | 75 | 105 | 75 | 4 | 57 | 10,899,170 | 34 | 46 | 1,103,000 | 28.46 | 21 | 77 | 1 | 75 | 
| regex_program | 1 | 156 | 546 | 11,598,276 | 128,513,066 | 156 | 282 | 1 | 52.88 | 14.53 | 4 | 64.37 | 62 | 102 | 62 | 0 | 49 | 2,196,106 | 37 | 66 | 1,104,000 | 32.18 | 16 | 67 | 0 | 62 | 
| regex_program | 2 | 163 | 538 | 11,579,064 | 128,513,066 | 163 | 274 | 1 | 52.59 | 14.50 | 4 | 65.55 | 61 | 93 | 61 | 0 | 51 | 2,177,334 | 27 | 59 | 1,104,000 | 31.68 | 16 | 67 | 0 | 61 | 
| regex_program | 3 | 185 | 537 | 11,853,872 | 103,456,394 | 185 | 266 | 0 | 69.91 | 12.94 | 5 | 56.09 | 52 | 78 | 52 | 0 | 50 | 2,422,606 | 19 | 45 | 826,502 | 32.74 | 18 | 83 | 1 | 52 | 
...
Commit: https://github.com/openvm-org/openvm/commit/f19fc364727842cd0f5b9148f57381731f786a09
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19397926783)

...
|:---|---:|---:|
| Total |  2.44 |  0.75 |
| regex_program |  2.40 |  0.72 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  601 |  2,404 |  715 |  559 |
...
| `execute_preflight_insn_mi/s` |  31.45 | -          |  32.94 |  28.36 |
| `trace_gen_time_ms   ` |  181.50 |  726 |  211 |  158 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  279.25 |  1,117 |  297 |  271 |
| `main_trace_commit_time_ms` |  51.25 |  205 |  56 |  49 |
| `generate_perm_trace_time_ms` |  27.50 |  110 |  34 |  19 |
| `perm_trace_commit_time_ms` |  64.81 |  259.22 |  71.39 |  56.05 |
| `quotient_poly_compute_time_ms` |  58.63 |  234.52 |  69.32 |  52.58 |
| `quotient_poly_commit_time_ms` |  15.28 |  61.12 |  17.71 |  13.42 |
| `pcs_opening_time_ms ` |  58.75 |  235 |  62 |  54 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 563 | 1 | 37 | 4,137,502 | 109.80 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 211 | 715 | 23,446,148 | 150,778,428 | 211 | 297 | 0 | 59.57 | 17.71 | 5 | 71.39 | 61 | 101 | 60 | 4 | 56 | 10,899,170 | 29 | 45 | 1,103,000 | 28.36 | 23 | 78 | 1 | 60 | 
| regex_program | 1 | 158 | 559 | 11,598,276 | 128,513,066 | 158 | 273 | 1 | 53.05 | 15.04 | 4 | 65.50 | 54 | 100 | 54 | 0 | 49 | 2,196,106 | 34 | 66 | 1,104,000 | 31.85 | 17 | 68 | 0 | 54 | 
| regex_program | 2 | 171 | 567 | 11,579,064 | 128,513,066 | 171 | 276 | 1 | 52.58 | 14.95 | 4 | 66.29 | 62 | 95 | 62 | 0 | 50 | 2,177,334 | 28 | 57 | 1,104,000 | 32.94 | 17 | 68 | 0 | 62 | 
| regex_program | 3 | 186 | 563 | 11,853,872 | 103,456,394 | 186 | 271 | 0 | 69.32 | 13.42 | 5 | 56.05 | 58 | 78 | 58 | 0 | 50 | 2,422,606 | 19 | 44 | 826,502 | 32.63 | 19 | 83 | 1 | 58 | 
...
Commit: https://github.com/openvm-org/openvm/commit/ceb75071ee65db1c29bc539cd5179768b5378799
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19417063631)

...
| `total_proof_time_ms ` |  751 |  1,502 |  854 |  648 |
...
| `execute_preflight_time_ms` |  91.50 |  183 |  124 |  59 |
| `execute_preflight_insn_mi/s` |  14.02 | -          |  18.49 |  9.56 |
| `trace_gen_time_ms   ` |  182.50 |  365 |  196 |  169 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  384.50 |  769 |  418 |  351 |
| `main_trace_commit_time_ms` |  65 |  130 |  75 |  55 |
| `generate_perm_trace_time_ms` |  55.50 |  111 |  71 |  40 |
| `perm_trace_commit_time_ms` |  76.83 |  153.67 |  89.54 |  64.12 |
| `quotient_poly_compute_time_ms` |  79 |  158.01 |  87.06 |  70.94 |
| `quotient_poly_commit_time_ms` |  15.99 |  31.97 |  18.06 |  13.91 |
| `pcs_opening_time_ms ` |  87.50 |  175 |  103 |  72 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 648 | 1 | 87 | 1,745,742 | 19.98 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 169 | 854 | 32,689,110 | 172,558,444 | 169 | 418 | 0 | 87.06 | 18.06 | 6 | 89.54 | 103 | 132 | 103 | 1 | 75 | 16,059,916 | 40 | 124 | 1,157,000 | 9.56 | 26 | 105 | 1 | 103 | 
| pairing | 1 | 196 | 648 | 22,314,288 | 119,958,502 | 196 | 351 | 1 | 70.94 | 13.91 | 5 | 64.12 | 72 | 138 | 71 | 0 | 55 | 9,408,294 | 71 | 59 | 588,742 | 18.49 | 20 | 85 | 1 | 71 | 

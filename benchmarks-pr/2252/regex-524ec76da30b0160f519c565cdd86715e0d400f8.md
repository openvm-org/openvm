...
| `total_proof_time_ms ` |  578.75 |  2,315 |  707 |  532 |
...
| `execute_metered_insn_mi/s` |  114.57 | -          |  114.57 |  114.57 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  54.25 |  217 |  66 |  46 |
| `execute_preflight_insn_mi/s` |  31.55 | -          |  32.87 |  28.50 |
| `trace_gen_time_ms   ` |  176.75 |  707 |  211 |  154 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  280.25 |  1,121 |  305 |  264 |
| `main_trace_commit_time_ms` |  51.75 |  207 |  56 |  50 |
| `generate_perm_trace_time_ms` |  29.50 |  118 |  38 |  19 |
| `perm_trace_commit_time_ms` |  64.01 |  256.04 |  69.99 |  55.84 |
| `quotient_poly_compute_time_ms` |  58.73 |  234.93 |  69.93 |  51.70 |
| `quotient_poly_commit_time_ms` |  15.09 |  60.34 |  17.69 |  12.72 |
| `pcs_opening_time_ms ` |  58.25 |  233 |  65 |  51 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 532 | 1 | 36 | 4,137,502 | 114.57 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 211 | 707 | 23,446,148 | 150,778,428 | 211 | 305 | 0 | 60.55 | 17.69 | 5 | 69.99 | 65 | 105 | 65 | 4 | 56 | 10,899,170 | 34 | 46 | 1,103,000 | 28.50 | 21 | 78 | 1 | 64 | 
| regex_program | 1 | 154 | 541 | 11,598,276 | 128,513,066 | 154 | 279 | 1 | 51.70 | 15.28 | 4 | 65.39 | 56 | 104 | 56 | 0 | 50 | 2,196,106 | 38 | 66 | 1,104,000 | 32.32 | 17 | 67 | 0 | 56 | 
| regex_program | 2 | 161 | 535 | 11,579,064 | 128,513,066 | 161 | 273 | 1 | 52.75 | 14.64 | 4 | 64.81 | 61 | 92 | 61 | 0 | 51 | 2,177,334 | 27 | 59 | 1,104,000 | 32.51 | 16 | 67 | 0 | 61 | 
| regex_program | 3 | 181 | 532 | 11,853,872 | 103,456,394 | 181 | 264 | 0 | 69.93 | 12.72 | 5 | 55.84 | 51 | 78 | 51 | 0 | 50 | 2,422,606 | 19 | 46 | 826,502 | 32.87 | 18 | 83 | 1 | 51 | 
...
Commit: https://github.com/openvm-org/openvm/commit/524ec76da30b0160f519c565cdd86715e0d400f8
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19414343653)

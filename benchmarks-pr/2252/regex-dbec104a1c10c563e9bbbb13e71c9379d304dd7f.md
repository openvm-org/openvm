...
|:---|---:|---:|
| Total |  2.43 |  0.79 |
| regex_program |  2.40 |  0.76 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  599.25 |  2,397 |  755 |  542 |
...
| `execute_preflight_insn_mi/s` |  31.17 | -          |  32.24 |  28.47 |
| `trace_gen_time_ms   ` |  183.50 |  734 |  219 |  160 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  295.25 |  1,181 |  345 |  270 |
| `main_trace_commit_time_ms` |  52.50 |  210 |  57 |  51 |
| `generate_perm_trace_time_ms` |  34.50 |  138 |  55 |  19 |
| `perm_trace_commit_time_ms` |  64.73 |  258.91 |  70.59 |  56.10 |
| `quotient_poly_compute_time_ms` |  59.59 |  238.37 |  70.11 |  53.25 |
| `quotient_poly_commit_time_ms` |  14.97 |  59.88 |  17.47 |  12.46 |
| `pcs_opening_time_ms ` |  65.50 |  262 |  82 |  56 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 544 | 1 | 36 | 4,137,502 | 112.38 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 219 | 755 | 23,446,148 | 150,778,428 | 219 | 345 | 0 | 60.98 | 17.47 | 5 | 70.59 | 82 | 126 | 82 | 4 | 57 | 10,899,170 | 55 | 45 | 1,103,000 | 28.47 | 21 | 79 | 1 | 82 | 
| regex_program | 1 | 160 | 556 | 11,598,276 | 128,513,066 | 160 | 290 | 1 | 54.03 | 15.24 | 5 | 66.69 | 63 | 105 | 63 | 0 | 51 | 2,196,106 | 37 | 65 | 1,104,000 | 31.82 | 16 | 69 | 0 | 63 | 
| regex_program | 2 | 167 | 542 | 11,579,064 | 128,513,066 | 167 | 276 | 1 | 53.25 | 14.71 | 4 | 65.53 | 61 | 93 | 61 | 0 | 51 | 2,177,334 | 27 | 58 | 1,104,000 | 32.16 | 16 | 68 | 0 | 61 | 
| regex_program | 3 | 188 | 544 | 11,853,872 | 103,456,394 | 188 | 270 | 0 | 70.11 | 12.46 | 5 | 56.10 | 56 | 78 | 56 | 0 | 51 | 2,422,606 | 19 | 45 | 826,502 | 32.24 | 18 | 83 | 1 | 56 | 
...
Commit: https://github.com/openvm-org/openvm/commit/dbec104a1c10c563e9bbbb13e71c9379d304dd7f
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19413921436)

...
|:---|---:|---:|
| Total |  23.22 |  15.11 |
| regex_program |  23.18 |  15.06 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  11,588.50 |  23,177 |  15,058 |  8,119 |
| `main_cells_used     ` |  82,367,682 |  164,735,364 |  91,281,201 |  73,454,163 |
| `total_cells_used    ` |  193,042,790 |  386,085,580 |  211,757,615 |  174,327,965 |
| `execute_metered_time_ms` |  47 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  86.05 | -          |  86.05 |  86.05 |
| `execute_preflight_insns` |  2,054,306.50 |  4,108,613 |  2,211,000 |  1,897,613 |
| `execute_preflight_time_ms` |  107 |  214 |  119 |  95 |
| `execute_preflight_insn_mi/s` |  27.78 | -          |  30.91 |  24.66 |
| `trace_gen_time_ms   ` |  335.50 |  671 |  404 |  267 |
| `memory_finalize_time_ms` |  2 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  10,798 |  21,596 |  14,178 |  7,418 |
| `main_trace_commit_time_ms` |  1,885 |  3,770 |  2,537 |  1,233 |
| `generate_perm_trace_time_ms` |  2,095 |  4,190 |  2,755 |  1,435 |
| `perm_trace_commit_time_ms` |  2,138.50 |  4,277 |  2,800 |  1,477 |
| `quotient_poly_compute_time_ms` |  1,463 |  2,926 |  1,916 |  1,010 |
| `quotient_poly_commit_time_ms` |  996 |  1,992 |  1,311 |  681 |
| `pcs_opening_time_ms ` |  2,203 |  4,406 |  2,831 |  1,575 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 8,119 | 41 | 1 | 47 | 4,108,613 | 86.05 | 163 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 404 | 15,058 | 211,757,615 | 373,183,036 | 404 | 14,178 | 0 | 1,916 | 1,311 | 2,800 | 2,831 | 42 | 4 | 2,537 | 91,281,201 | 2,755 | 95 | 2,211,000 | 24.66 | 
| regex_program | 1 | 267 | 8,119 | 174,327,965 | 196,838,026 | 267 | 7,418 | 25 | 1,010 | 681 | 1,477 | 1,575 | 40 | 0 | 1,233 | 73,454,163 | 1,435 | 119 | 1,897,613 | 30.91 | 

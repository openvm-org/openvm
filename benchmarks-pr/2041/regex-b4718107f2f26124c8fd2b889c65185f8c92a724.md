...
| `total_proof_time_ms ` |  3,817.50 |  7,635 |  4,865 |  2,770 |
...
| `execute_preflight_time_ms` |  95.50 |  191 |  102 |  89 |
| `execute_preflight_insn_mi/s` |  28.48 | -          |  30.90 |  26.06 |
| `trace_gen_time_ms   ` |  375 |  750 |  481 |  269 |
| `memory_finalize_time_ms` |  8 |  16 |  13 |  3 |
| `stark_prove_excluding_trace_time_ms` |  3,118.50 |  6,237 |  4,041 |  2,196 |
| `main_trace_commit_time_ms` |  624.50 |  1,249 |  836 |  413 |
| `generate_perm_trace_time_ms` |  240.50 |  481 |  311 |  170 |
| `perm_trace_commit_time_ms` |  665.50 |  1,331 |  849 |  482 |
| `quotient_poly_compute_time_ms` |  326.50 |  653 |  449 |  204 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2,770 | 6 | 1 | 31 | 4,108,597 | 130.09 | 44 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 481 | 4,865 | 211,758,557 | 373,183,036 | 481 | 4,041 | 0 | 449 | 396 | 849 | 1,194 | 8 | 13 | 836 | 91,281,687 | 311 | 102 | 2,211,000 | 26.06 | 
| regex_program | 1 | 269 | 2,770 | 174,326,267 | 196,838,026 | 269 | 2,196 | 49 | 204 | 204 | 482 | 712 | 7 | 3 | 413 | 73,453,305 | 170 | 89 | 1,897,597 | 30.90 | 

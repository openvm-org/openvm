...
| `total_proof_time_ms ` |  3,794.50 |  7,589 |  4,863 |  2,726 |
...
| `execute_preflight_insn_mi/s` |  28.22 | -          |  30.67 |  25.77 |
| `trace_gen_time_ms   ` |  393 |  786 |  501 |  285 |
| `memory_finalize_time_ms` |  8 |  16 |  14 |  2 |
| `stark_prove_excluding_trace_time_ms` |  3,075 |  6,150 |  4,010 |  2,140 |
| `main_trace_commit_time_ms` |  624.50 |  1,249 |  838 |  411 |
| `generate_perm_trace_time_ms` |  227.50 |  455 |  305 |  150 |
| `perm_trace_commit_time_ms` |  650 |  1,300 |  854 |  446 |
| `quotient_poly_compute_time_ms` |  314.50 |  629 |  423 |  206 |
| `quotient_poly_commit_time_ms` |  304 |  608 |  405 |  203 |
| `pcs_opening_time_ms ` |  946.50 |  1,893 |  1,180 |  713 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2,726 | 6 | 1 | 31 | 4,108,597 | 129.60 | 44 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 501 | 4,863 | 211,758,557 | 373,183,036 | 500 | 4,010 | 0 | 423 | 405 | 854 | 1,180 | 7 | 14 | 838 | 91,281,687 | 305 | 104 | 2,211,000 | 25.77 | 
| regex_program | 1 | 285 | 2,726 | 174,326,267 | 196,838,026 | 285 | 2,140 | 53 | 206 | 203 | 446 | 713 | 6 | 2 | 411 | 73,453,305 | 150 | 84 | 1,897,597 | 30.67 | 

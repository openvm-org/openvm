...
| `total_proof_time_ms ` |  3,812 |  7,624 |  4,893 |  2,731 |
...
| `execute_preflight_insn_mi/s` |  28.50 | -          |  30.95 |  26.05 |
| `trace_gen_time_ms   ` |  381.50 |  763 |  493 |  270 |
| `memory_finalize_time_ms` |  8 |  16 |  14 |  2 |
| `stark_prove_excluding_trace_time_ms` |  3,108 |  6,216 |  4,053 |  2,163 |
| `main_trace_commit_time_ms` |  624.50 |  1,249 |  838 |  411 |
| `generate_perm_trace_time_ms` |  251 |  502 |  342 |  160 |
| `perm_trace_commit_time_ms` |  648 |  1,296 |  847 |  449 |
| `quotient_poly_compute_time_ms` |  320.50 |  641 |  434 |  207 |
| `quotient_poly_commit_time_ms` |  302.50 |  605 |  396 |  209 |
| `pcs_opening_time_ms ` |  954 |  1,908 |  1,191 |  717 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2,731 | 6 | 1 | 30 | 4,108,597 | 132.73 | 44 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 493 | 4,893 | 211,758,557 | 373,183,036 | 493 | 4,053 | 0 | 434 | 396 | 847 | 1,191 | 8 | 14 | 838 | 91,281,687 | 342 | 102 | 2,211,000 | 26.05 | 
| regex_program | 1 | 270 | 2,731 | 174,326,267 | 196,838,026 | 270 | 2,163 | 50 | 207 | 209 | 449 | 717 | 7 | 2 | 411 | 73,453,305 | 160 | 84 | 1,897,597 | 30.95 | 

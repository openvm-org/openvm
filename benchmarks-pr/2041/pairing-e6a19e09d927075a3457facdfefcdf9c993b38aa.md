...
| `total_proof_time_ms ` |  11,843 |  11,843 |  11,843 |  11,843 |
...
| `execute_preflight_time_ms` |  191 |  191 |  191 |  191 |
| `execute_preflight_insn_mi/s` |  10.02 | -          |  10.02 |  10.02 |
| `trace_gen_time_ms   ` |  422 |  422 |  422 |  422 |
| `memory_finalize_time_ms` |  1 |  1 |  1 |  1 |
| `stark_prove_excluding_trace_time_ms` |  10,847 |  10,847 |  10,847 |  10,847 |
| `main_trace_commit_time_ms` |  2,015 |  2,015 |  2,015 |  2,015 |
| `generate_perm_trace_time_ms` |  2,129 |  2,129 |  2,129 |  2,129 |
| `perm_trace_commit_time_ms` |  2,041 |  2,041 |  2,041 |  2,041 |
| `quotient_poly_compute_time_ms` |  1,580 |  1,580 |  1,580 |  1,580 |
| `quotient_poly_commit_time_ms` |  993 |  993 |  993 |  993 |
| `pcs_opening_time_ms ` |  2,076 |  2,076 |  2,076 |  2,076 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 11,843 | 54 | 1 | 102 | 1,882,939 | 18.35 | 154 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 422 | 11,843 | 219,952,407 | 304,931,516 | 422 | 10,847 | 0 | 1,580 | 993 | 2,041 | 2,076 | 54 | 1 | 2,015 | 98,844,261 | 2,129 | 191 | 1,882,939 | 10.02 | 

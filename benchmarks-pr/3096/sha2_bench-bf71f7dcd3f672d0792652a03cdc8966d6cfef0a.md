...
|:---|---:|---:|---:|
| Total |  5.12 |  3.94 |  3.94 |
| app_proof |  4.17 |  2.99 |  2.99 |
| leaf |  0.52 |  0.52 |  0.52 |
...
| `total_proof_time_ms ` |  2,058.50 |  4,117 |  2,772 |  1,345 |
| `compile_metered_time_ms` |  2 |  2 |  2 |  2 |
| `execute_metered_time_ms` |  57 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  193.88 | -          |  193.88 |  193.88 |
| `set_initial_memory_time_ms` |  0 |  0 |  0 |  0 |
| `execute_preflight_insns` |  5,583,980.50 |  11,167,961 |  7,136,000 |  4,031,961 |
| `execute_preflight_time_ms` |  254.50 |  509 |  344 |  165 |
| `execute_preflight_insn_mi/s` |  21.94 | -          |  24.32 |  20.73 |
| `postflight_time_ms  ` |  68 |  136 |  88 |  48 |
| `postflight_memory_chronology_time_ms` |  7 |  14 |  10 |  4 |
| `postflight_program_index_time_ms` |  1 |  2 |  1 |  1 |
| `trace_gen_time_ms   ` |  59 |  118 |  94 |  24 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,642 |  3,284 |  2,202 |  1,082 |
| `prover.main_trace_commit_time_ms` |  393.50 |  787 |  569 |  218 |
| `prover.rap_constraints_time_ms` |  979 |  1,958 |  1,286 |  672 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  518 |  518 |  518 |  518 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/bf71f7dcd3f672d0792652a03cdc8966d6cfef0a/sha2_bench-bf71f7dcd3f672d0792652a03cdc8966d6cfef0a.memory.svg)
...
| app_proof | Sha2BlockHasherVmAir<Sha256Config> |  | 0 | 56 | 
...
| leaf | 0 | 113 | 518 | 112 | 34 | 12 | 2 | 9 | 9 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 174 | 46 | 0 | 0 | 78 | 27 | 26 | 36 | 13 | 0 | 49 | 38 | 10 | 2 | 7 | 46 | 46 | 78 | 0 | 1 | 12 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 108 | 20 | 0 | 0 | 57 | 20 | 20 | 23 | 12 | 0 | 30 | 22 | 7 | 1 | 6 | 20 | 20 | 57 | 0 | 1 | 10 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 100 | 14 | 0 | 0 | 55 | 22 | 21 | 21 | 11 | 0 | 29 | 22 | 7 | 1 | 5 | 15 | 14 | 55 | 0 | 1 | 10 | 0 | 0 | 
| leaf | 0 | prover | 237,929,272 | 405 | 145 | 0 | 0 | 141 | 71 | 69 | 44 | 26 | 0 | 118 | 96 | 21 | 10 | 11 | 145 | 145 | 141 | 0 | 3 | 25 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover |  | 0 | 1,285,848,458 | 2,202 | 569 | 0 | 0 | 1,286 | 700 | 699 | 232 | 353 | 0 | 346 | 251 | 94 | 57 | 36 | 569 | 569 | 1,286 | 0 | 1 | 351 | 0 | 0 | 
| app_proof | prover |  | 1 | 690,310,084 | 1,082 | 217 | 0 | 0 | 672 | 351 | 351 | 126 | 194 | 0 | 191 | 139 | 52 | 30 | 21 | 218 | 217 | 672 | 0 | 1 | 193 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof |  | 1,345 | 57 | 11,167,961 | 193.88 | 0 | 4,180 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof |  | 0 | 0 | 2 | 94 | 2,772 | 3 | 0 | 0 | 88 | 1 | 10 | 0 | 12,567,738,156 | 2,865,208,140 | 15,432,946,296 | 2,097,152 | 2 | 0 | 0 | 3 | 90 | 344 | 7,136,000 | 20.73 | 0 | 0 | 
| app_proof |  | 1 | 0 | 2 | 24 | 1,345 | 2 | 0 | 0 | 48 | 1 | 4 | 0 | 7,133,254,296 | 1,693,718,849 | 8,826,973,145 | 2,097,152 | 2 | 0 | 0 | 2 | 21 | 165 | 4,031,961 | 24.32 | 0 | 0 | 

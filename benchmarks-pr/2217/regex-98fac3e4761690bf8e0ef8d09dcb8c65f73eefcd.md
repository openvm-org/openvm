...
| `total_proof_time_ms ` |  576.25 |  2,305 |  697 |  531 |
...
| `execute_metered_insn_mi/s` |  113.58 | -          |  113.58 |  113.58 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  56.25 |  225 |  71 |  46 |
| `execute_preflight_insn_mi/s` |  30.50 | -          |  32.71 |  27.80 |
| `trace_gen_time_ms   ` |  171.75 |  687 |  206 |  147 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  280 |  1,120 |  298 |  264 |
| `main_trace_commit_time_ms` |  50.25 |  201 |  55 |  48 |
| `generate_perm_trace_time_ms` |  31.25 |  125 |  41 |  18 |
| `perm_trace_commit_time_ms` |  63.85 |  255.40 |  70.15 |  54.86 |
| `quotient_poly_compute_time_ms` |  56.81 |  227.26 |  67.72 |  50.40 |
| `quotient_poly_commit_time_ms` |  14.70 |  58.81 |  16.64 |  12.09 |
| `pcs_opening_time_ms ` |  59.75 |  239 |  64 |  55 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 531 | 66 | 1 | 36 | 4,137,502 | 113.58 | 197 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 206 | 697 | 23,446,148 | 150,778,428 | 206 | 298 | 0 | 57 | 16.64 | 6 | 70.15 | 55 | 112 | 55 | 4 | 55 | 10,899,170 | 41 | 46 | 1,103,000 | 27.80 | 21 | 74 | 1 | 55 | 
| regex_program | 1 | 147 | 543 | 11,598,276 | 128,513,066 | 147 | 284 | 1 | 52.13 | 14.71 | 5 | 64.59 | 62 | 103 | 62 | 0 | 49 | 2,196,106 | 38 | 71 | 1,104,000 | 29.68 | 16 | 67 | 0 | 62 | 
| regex_program | 2 | 156 | 534 | 11,579,064 | 128,513,066 | 156 | 274 | 1 | 50.40 | 15.37 | 5 | 65.80 | 64 | 94 | 63 | 0 | 49 | 2,177,334 | 28 | 61 | 1,104,000 | 31.79 | 17 | 66 | 0 | 63 | 
| regex_program | 3 | 178 | 531 | 11,853,872 | 103,456,394 | 178 | 264 | 0 | 67.72 | 12.09 | 5 | 54.86 | 58 | 76 | 57 | 0 | 48 | 2,422,606 | 18 | 47 | 826,502 | 32.71 | 18 | 80 | 1 | 57 | 
...
Commit: https://github.com/openvm-org/openvm/commit/98fac3e4761690bf8e0ef8d09dcb8c65f73eefcd
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19280526328)

...
| `total_proof_time_ms ` |  491 |  982 |  560 |  422 |
...
| `execute_metered_insn_mi/s` |  116.48 | -          |  116.48 |  116.48 |
| `execute_preflight_insns` |  750,104.50 |  1,500,209 |  873,000 |  627,209 |
| `execute_preflight_time_ms` |  28.50 |  57 |  32 |  25 |
| `execute_preflight_insn_mi/s` |  37.36 | -          |  39.18 |  35.55 |
| `trace_gen_time_ms   ` |  191 |  382 |  196 |  186 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  177.50 |  355 |  193 |  162 |
| `main_trace_commit_time_ms` |  30.50 |  61 |  33 |  28 |
| `generate_perm_trace_time_ms` |  12 |  24 |  12 |  12 |
| `perm_trace_commit_time_ms` |  41.76 |  83.52 |  44.33 |  39.19 |
| `quotient_poly_compute_time_ms` |  31.90 |  63.79 |  34.05 |  29.74 |
| `quotient_poly_commit_time_ms` |  11.77 |  23.54 |  12.13 |  11.41 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 422 | 66 | 1 | 12 | 1,500,209 | 116.48 | 165 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 196 | 560 | 9,677,708 | 84,395,212 | 196 | 193 | 0 | 34.05 | 12.13 | 4 | 44.33 | 55 | 57 | 55 | 0 | 33 | 1,035,986 | 12 | 25 | 873,000 | 35.55 | 14 | 46 | 0 | 55 | 
| fibonacci_program | 1 | 186 | 422 | 9,708,170 | 74,305,770 | 186 | 162 | 1 | 29.74 | 11.41 | 4 | 39.19 | 41 | 51 | 40 | 0 | 28 | 1,064,416 | 12 | 32 | 627,209 | 39.18 | 11 | 41 | 0 | 40 | 

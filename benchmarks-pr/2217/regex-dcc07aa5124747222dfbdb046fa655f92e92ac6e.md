...
| `total_proof_time_ms ` |  593 |  2,372 |  745 |  538 |
...
| `execute_metered_insn_mi/s` |  112.100 | -          |  112.100 |  112.100 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  53.50 |  214 |  65 |  45 |
| `execute_preflight_insn_mi/s` |  30.95 | -          |  32.31 |  28.46 |
| `trace_gen_time_ms   ` |  179.75 |  719 |  214 |  157 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  291.75 |  1,167 |  341 |  271 |
| `main_trace_commit_time_ms` |  51.75 |  207 |  56 |  49 |
| `generate_perm_trace_time_ms` |  37.25 |  149 |  55 |  19 |
| `perm_trace_commit_time_ms` |  64.34 |  257.38 |  69.79 |  56.47 |
| `quotient_poly_compute_time_ms` |  59.06 |  236.25 |  69.79 |  52.49 |
| `quotient_poly_commit_time_ms` |  15.35 |  61.40 |  18.08 |  13.08 |
| `pcs_opening_time_ms ` |  60.75 |  243 |  78 |  47 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 543 | 66 | 1 | 36 | 4,137,502 | 112.100 | 193 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 214 | 745 | 23,446,148 | 150,778,428 | 214 | 341 | 0 | 60.72 | 18.08 | 5 | 69.79 | 78 | 126 | 78 | 4 | 56 | 10,899,170 | 55 | 45 | 1,103,000 | 28.46 | 21 | 79 | 1 | 78 | 
| regex_program | 1 | 157 | 546 | 11,598,276 | 128,513,066 | 157 | 282 | 1 | 53.25 | 15.76 | 4 | 66.11 | 47 | 115 | 47 | 0 | 49 | 2,196,106 | 48 | 65 | 1,104,000 | 32.31 | 17 | 69 | 0 | 47 | 
| regex_program | 2 | 164 | 538 | 11,579,064 | 128,513,066 | 164 | 273 | 1 | 52.49 | 14.48 | 4 | 65 | 61 | 92 | 61 | 0 | 51 | 2,177,334 | 27 | 58 | 1,104,000 | 32.05 | 16 | 67 | 0 | 61 | 
| regex_program | 3 | 184 | 543 | 11,853,872 | 103,456,394 | 184 | 271 | 0 | 69.79 | 13.08 | 5 | 56.47 | 57 | 79 | 56 | 0 | 51 | 2,422,606 | 19 | 46 | 826,502 | 31.01 | 18 | 83 | 1 | 56 | 

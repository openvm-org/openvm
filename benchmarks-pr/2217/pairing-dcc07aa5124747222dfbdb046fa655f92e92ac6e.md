...
| `total_proof_time_ms ` |  732.50 |  1,465 |  851 |  614 |
...
| `execute_preflight_insn_mi/s` |  13.39 | -          |  17.57 |  9.20 |
| `trace_gen_time_ms   ` |  177 |  354 |  192 |  162 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  367.50 |  735 |  415 |  320 |
| `main_trace_commit_time_ms` |  64 |  128 |  75 |  53 |
| `generate_perm_trace_time_ms` |  43.50 |  87 |  48 |  39 |
| `perm_trace_commit_time_ms` |  76.46 |  152.92 |  88.68 |  64.24 |
| `quotient_poly_compute_time_ms` |  78.46 |  156.92 |  86.65 |  70.27 |
| `quotient_poly_commit_time_ms` |  15.98 |  31.97 |  17.72 |  14.25 |
| `pcs_opening_time_ms ` |  84 |  168 |  103 |  65 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 614 | 40 | 1 | 90 | 1,745,742 | 19.24 | 143 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 162 | 851 | 32,689,110 | 172,558,444 | 162 | 415 | 0 | 86.65 | 17.72 | 6 | 88.68 | 103 | 130 | 103 | 1 | 75 | 16,059,916 | 39 | 129 | 1,157,000 | 9.20 | 26 | 105 | 1 | 103 | 
| pairing | 1 | 192 | 614 | 22,314,288 | 119,958,502 | 191 | 320 | 1 | 70.27 | 14.25 | 5 | 64.24 | 65 | 115 | 64 | 0 | 53 | 9,408,294 | 48 | 61 | 588,742 | 17.57 | 20 | 85 | 1 | 64 | 
...
Commit: https://github.com/openvm-org/openvm/commit/dcc07aa5124747222dfbdb046fa655f92e92ac6e
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19280974712)

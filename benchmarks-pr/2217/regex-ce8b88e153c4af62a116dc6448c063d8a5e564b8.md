...
|:---|---:|---:|
| Total |  2.33 |  0.75 |
| regex_program |  2.29 |  0.72 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  572.50 |  2,290 |  716 |  515 |
...
| `execute_preflight_time_ms` |  53.50 |  214 |  65 |  44 |
| `execute_preflight_insn_mi/s` |  30.99 | -          |  32.62 |  28.49 |
| `trace_gen_time_ms   ` |  174.75 |  699 |  210 |  152 |
| `memory_finalize_time_ms` |  0.75 |  3 |  3 |  0 |
| `stark_prove_excluding_trace_time_ms` |  276.50 |  1,106 |  317 |  255 |
| `main_trace_commit_time_ms` |  51.25 |  205 |  57 |  49 |
| `generate_perm_trace_time_ms` |  34.75 |  139 |  55 |  19 |
| `perm_trace_commit_time_ms` |  63.55 |  254.20 |  70.44 |  55.42 |
| `quotient_poly_compute_time_ms` |  57.39 |  229.56 |  69.06 |  51.64 |
| `quotient_poly_commit_time_ms` |  14.40 |  57.62 |  16.49 |  12.30 |
| `pcs_opening_time_ms ` |  52.50 |  210 |  59 |  46 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 532 | 65 | 1 | 36 | 4,137,502 | 112.29 | 192 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 210 | 716 | 23,446,148 | 150,778,428 | 210 | 317 | 0 | 57.18 | 16.49 | 5 | 70.44 | 59 | 126 | 58 | 3 | 57 | 10,899,170 | 55 | 44 | 1,103,000 | 28.49 | 21 | 74 | 1 | 58 | 
| regex_program | 1 | 152 | 527 | 11,598,276 | 128,513,066 | 152 | 268 | 1 | 51.64 | 14.38 | 4 | 63.94 | 49 | 102 | 49 | 0 | 49 | 2,196,106 | 38 | 65 | 1,104,000 | 32.62 | 16 | 66 | 0 | 49 | 
| regex_program | 2 | 159 | 515 | 11,579,064 | 128,513,066 | 159 | 255 | 1 | 51.68 | 14.45 | 4 | 64.40 | 46 | 91 | 46 | 0 | 50 | 2,177,334 | 27 | 59 | 1,104,000 | 31.58 | 16 | 66 | 0 | 46 | 
| regex_program | 3 | 178 | 532 | 11,853,872 | 103,456,394 | 178 | 266 | 0 | 69.06 | 12.30 | 5 | 55.42 | 56 | 78 | 55 | 0 | 49 | 2,422,606 | 19 | 46 | 826,502 | 31.26 | 18 | 82 | 1 | 55 | 

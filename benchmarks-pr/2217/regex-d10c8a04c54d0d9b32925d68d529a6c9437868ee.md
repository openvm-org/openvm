...
| `total_proof_time_ms ` |  593 |  2,372 |  753 |  537 |
...
| `execute_preflight_insn_mi/s` |  31.32 | -          |  32.49 |  28.56 |
| `trace_gen_time_ms   ` |  180 |  720 |  213 |  157 |
| `memory_finalize_time_ms` |  1.25 |  5 |  5 |  0 |
| `stark_prove_excluding_trace_time_ms` |  291.50 |  1,166 |  348 |  265 |
| `main_trace_commit_time_ms` |  52.25 |  209 |  57 |  50 |
| `generate_perm_trace_time_ms` |  34 |  136 |  55 |  19 |
| `perm_trace_commit_time_ms` |  64.50 |  257.98 |  70.51 |  56.24 |
| `quotient_poly_compute_time_ms` |  58.86 |  235.44 |  69.43 |  51.93 |
| `quotient_poly_commit_time_ms` |  15.06 |  60.26 |  18.14 |  13.07 |
| `pcs_opening_time_ms ` |  63.75 |  255 |  84 |  52 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 537 | 65 | 1 | 37 | 4,137,502 | 111.62 | 192 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 213 | 753 | 23,446,148 | 150,778,428 | 213 | 348 | 0 | 60.28 | 18.14 | 5 | 70.51 | 84 | 126 | 83 | 5 | 57 | 10,899,170 | 55 | 46 | 1,103,000 | 28.56 | 21 | 79 | 1 | 83 | 
| regex_program | 1 | 157 | 541 | 11,598,276 | 128,513,066 | 157 | 277 | 1 | 51.93 | 14.33 | 5 | 64.97 | 58 | 101 | 58 | 0 | 50 | 2,196,106 | 35 | 66 | 1,104,000 | 32.49 | 16 | 66 | 0 | 58 | 
| regex_program | 2 | 165 | 541 | 11,579,064 | 128,513,066 | 165 | 276 | 1 | 53.79 | 14.73 | 4 | 66.27 | 61 | 94 | 61 | 0 | 51 | 2,177,334 | 27 | 58 | 1,104,000 | 32.05 | 16 | 69 | 0 | 61 | 
| regex_program | 3 | 185 | 537 | 11,853,872 | 103,456,394 | 185 | 265 | 0 | 69.43 | 13.07 | 5 | 56.24 | 52 | 78 | 51 | 0 | 51 | 2,422,606 | 19 | 45 | 826,502 | 32.17 | 18 | 83 | 1 | 51 | 
...
Commit: https://github.com/openvm-org/openvm/commit/d10c8a04c54d0d9b32925d68d529a6c9437868ee
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19279458746)

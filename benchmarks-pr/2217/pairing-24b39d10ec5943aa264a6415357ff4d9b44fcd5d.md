...
| `total_proof_time_ms ` |  751 |  1,502 |  825 |  677 |
...
| `execute_preflight_insn_mi/s` |  13.60 | -          |  18.02 |  9.17 |
| `trace_gen_time_ms   ` |  179 |  358 |  194 |  164 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  384 |  768 |  387 |  381 |
| `main_trace_commit_time_ms` |  65 |  130 |  75 |  55 |
| `generate_perm_trace_time_ms` |  57 |  114 |  71 |  43 |
| `perm_trace_commit_time_ms` |  77.31 |  154.62 |  89.62 |  65 |
| `quotient_poly_compute_time_ms` |  79.50 |  159.01 |  88.12 |  70.89 |
| `quotient_poly_commit_time_ms` |  16.74 |  33.48 |  18.64 |  14.83 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 677 | 40 | 1 | 90 | 1,745,742 | 19.19 | 145 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 164 | 825 | 32,689,110 | 172,558,444 | 164 | 387 | 0 | 88.12 | 18.64 | 6 | 89.62 | 68 | 135 | 68 | 1 | 75 | 16,059,916 | 43 | 130 | 1,157,000 | 9.17 | 27 | 107 | 1 | 68 | 
| pairing | 1 | 194 | 677 | 22,314,288 | 119,958,502 | 194 | 381 | 1 | 70.89 | 14.83 | 5 | 65 | 99 | 139 | 98 | 0 | 55 | 9,408,294 | 71 | 61 | 588,742 | 18.02 | 20 | 86 | 1 | 98 | 

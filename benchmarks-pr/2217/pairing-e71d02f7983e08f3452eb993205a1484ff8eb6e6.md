...
| `total_proof_time_ms ` |  753 |  1,506 |  852 |  654 |
...
| `execute_preflight_insn_mi/s` |  13.76 | -          |  18.36 |  9.17 |
| `trace_gen_time_ms   ` |  178.50 |  357 |  195 |  162 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  386.50 |  773 |  416 |  357 |
| `main_trace_commit_time_ms` |  65 |  130 |  75 |  55 |
| `generate_perm_trace_time_ms` |  55 |  110 |  71 |  39 |
| `perm_trace_commit_time_ms` |  77.02 |  154.03 |  88.91 |  65.12 |
| `quotient_poly_compute_time_ms` |  78.69 |  157.39 |  86.87 |  70.52 |
| `quotient_poly_commit_time_ms` |  16.71 |  33.42 |  18.61 |  14.81 |
| `pcs_opening_time_ms ` |  89.50 |  179 |  103 |  76 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 654 | 41 | 1 | 91 | 1,745,742 | 19.05 | 144 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 162 | 852 | 32,689,110 | 172,558,444 | 162 | 416 | 0 | 86.87 | 18.61 | 6 | 88.91 | 103 | 131 | 102 | 1 | 75 | 16,059,916 | 39 | 129 | 1,157,000 | 9.17 | 26 | 106 | 1 | 102 | 
| pairing | 1 | 195 | 654 | 22,314,288 | 119,958,502 | 195 | 357 | 1 | 70.52 | 14.81 | 6 | 65.12 | 76 | 139 | 76 | 0 | 55 | 9,408,294 | 71 | 59 | 588,742 | 18.36 | 20 | 85 | 1 | 76 | 

...
| `total_proof_time_ms ` |  749.50 |  1,499 |  821 |  678 |
...
| `execute_preflight_insn_mi/s` |  13.80 | -          |  18.35 |  9.25 |
| `trace_gen_time_ms   ` |  178.50 |  357 |  196 |  161 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  383.50 |  767 |  386 |  381 |
| `main_trace_commit_time_ms` |  65 |  130 |  76 |  54 |
| `generate_perm_trace_time_ms` |  58 |  116 |  71 |  45 |
| `perm_trace_commit_time_ms` |  76.65 |  153.31 |  89.16 |  64.14 |
| `quotient_poly_compute_time_ms` |  80.11 |  160.22 |  88.14 |  72.08 |
| `quotient_poly_commit_time_ms` |  16.19 |  32.38 |  17.48 |  14.90 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 678 | 40 | 1 | 90 | 1,745,742 | 19.23 | 145 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 161 | 821 | 32,689,110 | 172,558,444 | 161 | 386 | 0 | 88.14 | 17.48 | 6 | 89.16 | 66 | 137 | 66 | 1 | 76 | 16,059,916 | 45 | 128 | 1,157,000 | 9.25 | 26 | 106 | 1 | 66 | 
| pairing | 1 | 196 | 678 | 22,314,288 | 119,958,502 | 196 | 381 | 1 | 72.08 | 14.90 | 6 | 64.14 | 99 | 138 | 99 | 0 | 54 | 9,408,294 | 71 | 59 | 588,742 | 18.35 | 21 | 87 | 1 | 99 | 

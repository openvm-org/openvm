...
| `total_proof_time_ms ` |  593 |  2,372 |  753 |  534 |
...
| `execute_preflight_insn_mi/s` |  31.85 | -          |  32.100 |  28.96 |
| `trace_gen_time_ms   ` |  181 |  724 |  215 |  157 |
| `memory_finalize_time_ms` |  0.75 |  3 |  3 |  0 |
| `stark_prove_excluding_trace_time_ms` |  291.50 |  1,166 |  350 |  269 |
| `main_trace_commit_time_ms` |  52 |  208 |  58 |  50 |
| `generate_perm_trace_time_ms` |  34 |  136 |  55 |  19 |
| `perm_trace_commit_time_ms` |  64.52 |  258.06 |  71.56 |  55.19 |
| `quotient_poly_compute_time_ms` |  59.53 |  238.10 |  72.16 |  52.09 |
| `quotient_poly_commit_time_ms` |  15.36 |  61.45 |  18.17 |  13.18 |
| `pcs_opening_time_ms ` |  62.75 |  251 |  84 |  48 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 545 | 65 | 1 | 36 | 4,137,502 | 112.45 | 192 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 215 | 753 | 23,446,148 | 150,778,428 | 215 | 350 | 0 | 60.62 | 18.17 | 5 | 71.56 | 84 | 127 | 84 | 3 | 58 | 10,899,170 | 55 | 44 | 1,103,000 | 28.96 | 22 | 79 | 1 | 84 | 
| regex_program | 1 | 157 | 534 | 11,598,276 | 128,513,066 | 157 | 269 | 1 | 53.23 | 14.53 | 4 | 65.28 | 48 | 101 | 48 | 0 | 50 | 2,196,106 | 35 | 66 | 1,104,000 | 32.67 | 16 | 68 | 0 | 48 | 
| regex_program | 2 | 165 | 540 | 11,579,064 | 128,513,066 | 164 | 276 | 1 | 52.09 | 15.57 | 4 | 66.04 | 63 | 94 | 62 | 0 | 50 | 2,177,334 | 27 | 58 | 1,104,000 | 32.79 | 17 | 68 | 0 | 62 | 
| regex_program | 3 | 187 | 545 | 11,853,872 | 103,456,394 | 187 | 271 | 0 | 72.16 | 13.18 | 5 | 55.19 | 56 | 78 | 56 | 0 | 50 | 2,422,606 | 19 | 45 | 826,502 | 32.100 | 18 | 86 | 1 | 56 | 
...
Commit: https://github.com/openvm-org/openvm/commit/f316e647a7609cac7f99e361f3fb9e039967986a
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19287009918)

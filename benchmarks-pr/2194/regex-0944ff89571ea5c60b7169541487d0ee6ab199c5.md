...
| `total_proof_time_ms ` |  586.50 |  2,346 |  742 |  530 |
...
| `execute_preflight_time_ms` |  57 |  228 |  69 |  48 |
| `execute_preflight_insn_mi/s` |  28.22 | -          |  29.21 |  26.34 |
| `trace_gen_time_ms   ` |  171.25 |  685 |  206 |  147 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  290.25 |  1,161 |  342 |  263 |
| `main_trace_commit_time_ms` |  50.25 |  201 |  55 |  48 |
| `generate_perm_trace_time_ms` |  34.75 |  139 |  55 |  18 |
| `perm_trace_commit_time_ms` |  63.36 |  253.43 |  69.02 |  54.97 |
| `quotient_poly_compute_time_ms` |  57.89 |  231.58 |  68.33 |  51.47 |
| `quotient_poly_commit_time_ms` |  14.97 |  59.87 |  17.44 |  12.26 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 530 | 40 | 1 | 34 | 4,137,502 | 119.23 | 166 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 206 | 742 | 23,446,148 | 150,778,428 | 206 | 342 | 0 | 60.12 | 17.44 | 5 | 69.02 | 83 | 125 | 83 | 4 | 55 | 10,899,170 | 55 | 48 | 1,103,000 | 26.34 | 21 | 78 | 1 | 83 | 
| regex_program | 1 | 147 | 540 | 11,598,276 | 128,513,066 | 147 | 281 | 1 | 51.66 | 14.52 | 5 | 63.77 | 62 | 102 | 62 | 0 | 49 | 2,196,106 | 38 | 69 | 1,104,000 | 29.21 | 16 | 66 | 0 | 62 | 
| regex_program | 2 | 155 | 534 | 11,579,064 | 128,513,066 | 155 | 275 | 1 | 51.47 | 15.66 | 5 | 65.67 | 63 | 94 | 63 | 0 | 49 | 2,177,334 | 28 | 63 | 1,104,000 | 28.33 | 17 | 67 | 0 | 63 | 
| regex_program | 3 | 177 | 530 | 11,853,872 | 103,456,394 | 177 | 263 | 0 | 68.33 | 12.26 | 5 | 54.97 | 56 | 76 | 56 | 0 | 48 | 2,422,606 | 18 | 48 | 826,502 | 29 | 18 | 81 | 1 | 56 | 

...
|:---|---:|---:|
| Total |  2.39 |  0.78 |
| regex_program |  2.36 |  0.75 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  589 |  2,356 |  748 |  524 |
...
| `execute_metered_insn_mi/s` |  121.81 | -          |  121.81 |  121.81 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  55 |  220 |  67 |  46 |
| `execute_preflight_insn_mi/s` |  30.27 | -          |  31.35 |  27.61 |
| `trace_gen_time_ms   ` |  176.50 |  706 |  210 |  154 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  289.75 |  1,159 |  346 |  262 |
| `main_trace_commit_time_ms` |  51.50 |  206 |  57 |  49 |
| `generate_perm_trace_time_ms` |  34.50 |  138 |  55 |  18 |
| `perm_trace_commit_time_ms` |  64.24 |  256.97 |  70.35 |  55.67 |
| `quotient_poly_compute_time_ms` |  58.16 |  232.64 |  68.77 |  52.29 |
| `quotient_poly_commit_time_ms` |  14.96 |  59.86 |  17.73 |  12.66 |
| `pcs_opening_time_ms ` |  63 |  252 |  84 |  49 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 538 | 40 | 1 | 33 | 4,137,502 | 121.81 | 167 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 210 | 748 | 23,446,148 | 150,778,428 | 210 | 346 | 0 | 58.98 | 17.73 | 5 | 70.35 | 84 | 126 | 84 | 4 | 57 | 10,899,170 | 55 | 47 | 1,103,000 | 27.61 | 22 | 77 | 1 | 84 | 
| regex_program | 1 | 154 | 546 | 11,598,276 | 128,513,066 | 154 | 283 | 1 | 52.29 | 14.47 | 4 | 64.74 | 62 | 103 | 62 | 0 | 49 | 2,196,106 | 38 | 67 | 1,104,000 | 31.35 | 16 | 67 | 0 | 62 | 
| regex_program | 2 | 160 | 524 | 11,579,064 | 128,513,066 | 160 | 262 | 1 | 52.60 | 15 | 4 | 66.21 | 49 | 94 | 49 | 0 | 50 | 2,177,334 | 27 | 60 | 1,104,000 | 31.27 | 16 | 68 | 0 | 49 | 
| regex_program | 3 | 182 | 538 | 11,853,872 | 103,456,394 | 182 | 268 | 0 | 68.77 | 12.66 | 5 | 55.67 | 57 | 77 | 57 | 0 | 50 | 2,422,606 | 18 | 46 | 826,502 | 30.85 | 18 | 82 | 1 | 57 | 

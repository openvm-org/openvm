...
|:---|---:|---:|---:|
| Total |  3.10 |  2.65 |  2.65 |
| app_proof |  2.29 |  1.84 |  1.84 |
| leaf |  0.44 |  0.44 |  0.44 |
...
| `total_proof_time_ms ` |  1,129.50 |  2,259 |  1,801 |  458 |
| `execute_metered_time_ms` |  34 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  75.65 | -          |  75.65 |  75.65 |
| `execute_preflight_insns` |  1,289,951.50 |  2,579,903 |  2,020,000 |  559,903 |
| `execute_preflight_time_ms` |  76 |  152 |  76 |  76 |
| `execute_preflight_insn_mi/s` |  36.11 | -          |  37.21 |  35.01 |
| `trace_gen_time_ms   ` |  57 |  114 |  93 |  21 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  883.50 |  1,767 |  1,448 |  319 |
| `prover.main_trace_commit_time_ms` |  288.50 |  577 |  495 |  82 |
| `prover.rap_constraints_time_ms` |  529.50 |  1,059 |  858 |  201 |
| `prover.openings_time_ms` |  64.50 |  129 |  94 |  35 |
| `prover.rap_constraints.logup_gkr_time_ms` |  156 |  312 |  270 |  42 |
| `prover.rap_constraints.round0_time_ms` |  277.50 |  555 |  444 |  111 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/e3b6d2232ba56b2f0a5c738557af3bdc78063c43/kitchen_sink-e3b6d2232ba56b2f0a5c738557af3bdc78063c43.memory.svg)
...
| app_proof |  |  |  |  |  | 458 |  |  | 34 | 2,579,903 | 75.65 | 0 | 2,298 |  | 
...
| leaf | 0 | 123 | 442 | 123 | 26 | 12 | 22 | 2 | 2 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 53,472,003 | 139 | 40 | 0 | 4 | 65 | 19 | 19 | 29 | 16 | 0 | 32 | 8 | 24 | 1 | 22 | 41 | 65 | 0 | 1 | 15 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 23,651,975 | 100 | 19 | 0 | 3 | 50 | 17 | 16 | 20 | 13 | 0 | 30 | 8 | 21 | 1 | 20 | 19 | 50 | 0 | 1 | 12 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 17,507,975 | 92 | 14 | 0 | 3 | 48 | 16 | 16 | 18 | 13 | 0 | 28 | 7 | 21 | 0 | 20 | 14 | 48 | 0 | 1 | 12 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,221,261,804 | 1,448 | 494 | 0 | 278 | 858 | 444 | 443 | 143 | 270 | 132 | 94 | 16 | 77 | 25 | 51 | 495 | 858 | 0 | 1 | 136 | 0 | 0 | 
| app_proof | prover | 1 | 370,741,140 | 319 | 81 | 0 | 17 | 201 | 111 | 111 | 47 | 42 | 0 | 35 | 9 | 26 | 7 | 18 | 82 | 201 | 0 | 1 | 42 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 93 | 1,801 | 93 | 182 | 0 | 3 | 76 | 2,020,000 | 35.01 | 
| app_proof | 1 | 21 | 458 | 21 | 40 | 0 | 1 | 76 | 559,903 | 37.21 | 

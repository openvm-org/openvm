...
| `total_proof_time_ms ` |  1,151 |  2,302 |  1,839 |  463 |
...
| `execute_preflight_insn_mi/s` |  35.86 | -          |  37.54 |  34.17 |
| `trace_gen_time_ms   ` |  57.50 |  115 |  94 |  21 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  901.50 |  1,803 |  1,481 |  322 |
| `prover.main_trace_commit_time_ms` |  297.50 |  595 |  513 |  82 |
| `prover.rap_constraints_time_ms` |  538.50 |  1,077 |  873 |  204 |
| `prover.openings_time_ms` |  65 |  130 |  94 |  36 |
| `prover.rap_constraints.logup_gkr_time_ms` |  160 |  320 |  276 |  44 |
| `prover.rap_constraints.round0_time_ms` |  281 |  562 |  450 |  112 |
| `prover.rap_constraints.mle_rounds_time_ms` |  96.50 |  193 |  146 |  47 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/32af2f2c9f3c40ffdfef4afda69a38f6c2874729/kitchen_sink-32af2f2c9f3c40ffdfef4afda69a38f6c2874729.memory.svg)
...
| app_proof |  |  |  |  |  | 463 |  |  | 34 | 2,579,903 | 75.41 | 0 | 2,341 |  | 
...
| leaf | 0 | 121 | 441 | 121 | 26 | 12 | 22 | 2 | 2 | 
...
| internal_recursive.1 | 1 | prover | 17,507,975 | 94 | 14 | 0 | 4 | 48 | 16 | 16 | 18 | 13 | 0 | 30 | 9 | 21 | 0 | 20 | 15 | 48 | 0 | 1 | 13 | 0 | 0 | 
| leaf | 0 | prover | 428,317,568 | 319 | 130 | 0 | 10 | 144 | 47 | 46 | 37 | 59 | 0 | 44 | 12 | 31 | 7 | 24 | 131 | 144 | 0 | 2 | 58 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,221,261,804 | 1,481 | 512 | 0 | 293 | 873 | 450 | 448 | 146 | 276 | 138 | 94 | 17 | 77 | 26 | 51 | 513 | 873 | 0 | 1 | 137 | 0 | 0 | 
| app_proof | prover | 1 | 370,741,140 | 322 | 82 | 0 | 17 | 204 | 112 | 111 | 47 | 44 | 0 | 36 | 9 | 26 | 7 | 18 | 82 | 204 | 0 | 1 | 43 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 94 | 1,839 | 94 | 184 | 0 | 4 | 78 | 2,020,000 | 34.17 | 
| app_proof | 1 | 21 | 463 | 21 | 40 | 0 | 2 | 78 | 559,903 | 37.54 | 

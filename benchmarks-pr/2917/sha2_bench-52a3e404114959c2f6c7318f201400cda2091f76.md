...
|:---|---:|---:|---:|
| Total |  10.10 |  7.04 |  7.04 |
| app_proof |  8.41 |  5.35 |  5.35 |
| leaf |  1.01 |  1.01 |  1.01 |
...
| `total_proof_time_ms ` |  4,156 |  8,312 |  5,247 |  3,065 |
...
| `execute_preflight_time_ms` |  267 |  534 |  294 |  240 |
| `execute_preflight_insn_mi/s` |  33.62 | -          |  35.16 |  32.08 |
| `trace_gen_time_ms   ` |  125 |  250 |  175 |  75 |
| `set_initial_memory_time_ms` |  89 |  178 |  137 |  41 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  3,673.50 |  7,347 |  4,693 |  2,654 |
| `prover.main_trace_commit_time_ms` |  967.50 |  1,935 |  1,339 |  596 |
| `prover.rap_constraints_time_ms` |  1,996 |  3,992 |  2,458 |  1,534 |
| `prover.openings_time_ms` |  708.50 |  1,417 |  894 |  523 |
| `prover.rap_constraints.logup_gkr_time_ms` |  562 |  1,124 |  602 |  522 |
| `prover.rap_constraints.round0_time_ms` |  1,048.50 |  2,097 |  1,360 |  737 |
| `prover.rap_constraints.mle_rounds_time_ms` |  384.50 |  769 |  495 |  274 |
...
| `prover.openings.whir_time_ms` |  540 |  1,080 |  678 |  402 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/52a3e404114959c2f6c7318f201400cda2091f76/sha2_bench-52a3e404114959c2f6c7318f201400cda2091f76.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 70 |  |  |  | 340 |  |  |  |  |  |  | 
| app_proof |  |  |  | 3,065 |  | 99 | 11,167,961 | 112.55 | 0 | 8,417 |  | 
...
| leaf | 0 | 108 | 1,013 | 108 | 34 | 17 | 2 | 7 | 7 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 330 | 118 | 0 | 0 | 108 | 36 | 35 | 51 | 20 | 0 | 102 | 88 | 13 | 3 | 9 | 119 | 118 | 108 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 169 | 48 | 0 | 0 | 67 | 25 | 24 | 28 | 13 | 0 | 52 | 44 | 8 | 1 | 6 | 48 | 48 | 67 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 136 | 32 | 0 | 0 | 62 | 23 | 23 | 25 | 13 | 0 | 41 | 34 | 7 | 1 | 5 | 32 | 32 | 62 | 0 | 2 | 13 | 0 | 0 | 
| leaf | 0 | prover | 237,896,248 | 904 | 377 | 0 | 0 | 230 | 111 | 110 | 68 | 51 | 0 | 296 | 258 | 37 | 20 | 17 | 377 | 377 | 230 | 0 | 12 | 50 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,288,077,561 | 4,693 | 1,339 | 0 | 0 | 2,458 | 1,360 | 1,360 | 495 | 602 | 1 | 894 | 678 | 215 | 135 | 80 | 1,339 | 1,339 | 2,458 | 0 | 6 | 600 | 0 | 0 | 
| app_proof | prover | 1 | 751,206,644 | 2,654 | 596 | 0 | 0 | 1,534 | 737 | 737 | 274 | 522 | 0 | 523 | 402 | 120 | 72 | 47 | 596 | 596 | 1,534 | 0 | 6 | 520 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 137 | 1 | 175 | 5,247 | 175 | 137 | 13,329,494,472 | 2,141,911,524 | 15,471,405,996 | 2,097,152 | 0 | 3 | 240 | 7,124,000 | 32.08 | 
| app_proof | 1 | 41 | 1 | 75 | 3,065 | 75 | 41 | 7,598,498,184 | 1,557,865,504 | 9,156,363,688 | 2,097,152 | 0 | 2 | 294 | 4,043,961 | 35.16 | 

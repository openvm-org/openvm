...
| `execute_metered_insn_mi/s` |  76.94 | -          |  76.94 |  76.94 |
| `execute_preflight_insns` |  1,979,971 |  1,979,971 |  1,979,971 |  1,979,971 |
| `execute_preflight_time_ms` |  87 |  87 |  87 |  87 |
| `execute_preflight_insn_mi/s` |  29.88 | -          |  29.88 |  29.88 |
| `trace_gen_time_ms   ` |  72 |  72 |  72 |  72 |
| `set_initial_memory_time_ms` |  136 |  136 |  136 |  136 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  3,541 |  3,541 |  3,541 |  3,541 |
| `prover.main_trace_commit_time_ms` |  1,127 |  1,127 |  1,127 |  1,127 |
| `prover.rap_constraints_time_ms` |  1,640 |  1,640 |  1,640 |  1,640 |
| `prover.openings_time_ms` |  772 |  772 |  772 |  772 |
| `prover.rap_constraints.logup_gkr_time_ms` |  277 |  277 |  277 |  277 |
| `prover.rap_constraints.round0_time_ms` |  994 |  994 |  994 |  994 |
| `prover.rap_constraints.mle_rounds_time_ms` |  369 |  369 |  369 |  369 |
| `prover.openings.stacked_reduction_time_ms` |  177 |  177 |  177 |  177 |
| `prover.openings.stacked_reduction.round0_time_ms` |  100 |  100 |  100 |  100 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  76 |  76 |  76 |  76 |
| `prover.openings.whir_time_ms` |  595 |  595 |  595 |  595 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  848 |  848 |  848 |  848 |
| `execute_preflight_time_ms` |  18 |  18 |  18 |  18 |
| `trace_gen_time_ms   ` |  103 |  103 |  103 |  103 |
| `generate_blob_total_time_ms` |  9 |  9 |  9 |  9 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  744 |  744 |  744 |  744 |
| `prover.main_trace_commit_time_ms` |  249 |  249 |  249 |  249 |
| `prover.rap_constraints_time_ms` |  288 |  288 |  288 |  288 |
| `prover.openings_time_ms` |  205 |  205 |  205 |  205 |
| `prover.rap_constraints.logup_gkr_time_ms` |  129 |  129 |  129 |  129 |
| `prover.rap_constraints.round0_time_ms` |  101 |  101 |  101 |  101 |
...
| `prover.openings.whir_time_ms` |  179 |  179 |  179 |  179 |

| internal_for_leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  340 |  340 |  340 |  340 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/f65d8fc2d0375eb82a31fafd2eb7ffcd58c2ec4e/kitchen_sink-f65d8fc2d0375eb82a31fafd2eb7ffcd58c2ec4e.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 70 |  |  |  | 368 |  |  |  |  |  |  | 
| app_proof |  |  |  | 3,838 |  | 25 | 1,979,971 | 76.94 | 0 | 3,868 |  | 
| internal_for_leaf |  |  | 340 |  |  |  |  |  |  |  | 340 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,577,981 | 322 | 115 | 0 | 0 | 106 | 35 | 34 | 50 | 20 | 0 | 99 | 85 | 13 | 3 | 9 | 115 | 115 | 106 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 164 | 46 | 0 | 0 | 66 | 24 | 23 | 28 | 13 | 0 | 51 | 42 | 8 | 1 | 6 | 47 | 46 | 66 | 0 | 2 | 12 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 135 | 30 | 0 | 0 | 61 | 23 | 22 | 25 | 13 | 0 | 42 | 35 | 7 | 1 | 5 | 31 | 30 | 61 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 167,484,093 | 744 | 249 | 0 | 0 | 288 | 101 | 100 | 57 | 129 | 0 | 205 | 179 | 26 | 13 | 12 | 249 | 249 | 288 | 0 | 7 | 127 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,089,667,964 | 3,541 | 1,126 | 0 | 0 | 1,640 | 994 | 992 | 369 | 277 | 1 | 772 | 595 | 177 | 100 | 76 | 1,127 | 1,126 | 1,640 | 0 | 4 | 275 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 136 | 2 | 72 | 3,838 | 72 | 136 | 10,281,410,592 | 2,838,841,776 | 13,120,252,368 | 2,097,152 | 0 | 4 | 87 | 1,979,971 | 29.88 | 

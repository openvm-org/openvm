...
| `total_proof_time_ms ` |  4,076 |  8,152 |  5,152 |  3,000 |
...
| `execute_preflight_time_ms` |  264.50 |  529 |  289 |  240 |
| `execute_preflight_insn_mi/s` |  33.53 | -          |  35.13 |  31.93 |
| `trace_gen_time_ms   ` |  125 |  250 |  175 |  75 |
| `set_initial_memory_time_ms` |  87.50 |  175 |  134 |  41 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  3,598 |  7,196 |  4,601 |  2,595 |
| `prover.main_trace_commit_time_ms` |  959.50 |  1,919 |  1,329 |  590 |
| `prover.rap_constraints_time_ms` |  1,936 |  3,872 |  2,384 |  1,488 |
| `prover.openings_time_ms` |  700.50 |  1,401 |  886 |  515 |
| `prover.rap_constraints.logup_gkr_time_ms` |  550.50 |  1,101 |  594 |  507 |
| `prover.rap_constraints.round0_time_ms` |  1,007.50 |  2,015 |  1,305 |  710 |
| `prover.rap_constraints.mle_rounds_time_ms` |  377 |  754 |  484 |  270 |
| `prover.openings.stacked_reduction_time_ms` |  164 |  328 |  212 |  116 |
| `prover.openings.stacked_reduction.round0_time_ms` |  101 |  202 |  132 |  70 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  63 |  126 |  80 |  46 |
| `prover.openings.whir_time_ms` |  535.50 |  1,071 |  673 |  398 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/654402dc1168eac20f3078c5c25074c364634dd8/sha2_bench-654402dc1168eac20f3078c5c25074c364634dd8.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 70 |  |  |  | 343 |  |  |  |  |  |  | 
| app_proof |  |  |  | 3,000 |  | 99 | 11,167,961 | 112.59 | 0 | 8,257 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 326 | 117 | 0 | 0 | 107 | 36 | 35 | 51 | 20 | 0 | 100 | 87 | 13 | 3 | 9 | 117 | 117 | 107 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 170 | 47 | 0 | 0 | 67 | 24 | 23 | 28 | 14 | 0 | 55 | 46 | 8 | 1 | 6 | 47 | 47 | 67 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 136 | 31 | 0 | 0 | 61 | 22 | 22 | 24 | 14 | 0 | 42 | 34 | 7 | 1 | 5 | 32 | 31 | 61 | 0 | 3 | 13 | 0 | 0 | 
| leaf | 0 | prover | 237,896,248 | 888 | 371 | 0 | 0 | 227 | 110 | 109 | 67 | 50 | 0 | 288 | 251 | 37 | 19 | 17 | 371 | 371 | 227 | 0 | 9 | 49 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,288,077,561 | 4,601 | 1,329 | 0 | 0 | 2,384 | 1,305 | 1,305 | 484 | 594 | 0 | 886 | 673 | 212 | 132 | 80 | 1,329 | 1,329 | 2,384 | 0 | 4 | 592 | 0 | 0 | 
| app_proof | prover | 1 | 751,206,644 | 2,595 | 590 | 0 | 0 | 1,488 | 710 | 710 | 270 | 507 | 0 | 515 | 398 | 116 | 70 | 46 | 590 | 590 | 1,488 | 0 | 5 | 505 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 134 | 1 | 175 | 5,152 | 175 | 134 | 13,329,494,472 | 2,141,911,524 | 15,471,405,996 | 2,097,152 | 0 | 3 | 240 | 7,124,000 | 31.93 | 
| app_proof | 1 | 41 | 1 | 75 | 3,000 | 75 | 41 | 7,598,498,184 | 1,557,865,504 | 9,156,363,688 | 2,097,152 | 0 | 2 | 289 | 4,043,961 | 35.13 | 

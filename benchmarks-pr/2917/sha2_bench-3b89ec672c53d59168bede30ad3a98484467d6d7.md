...
| `total_proof_time_ms ` |  4,145.50 |  8,291 |  5,236 |  3,055 |
...
| `execute_preflight_time_ms` |  269 |  538 |  296 |  242 |
| `execute_preflight_insn_mi/s` |  33.47 | -          |  35.10 |  31.84 |
| `trace_gen_time_ms   ` |  126 |  252 |  177 |  75 |
| `set_initial_memory_time_ms` |  88 |  176 |  135 |  41 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  3,661.50 |  7,323 |  4,681 |  2,642 |
| `prover.main_trace_commit_time_ms` |  967 |  1,934 |  1,341 |  593 |
| `prover.rap_constraints_time_ms` |  1,988 |  3,976 |  2,447 |  1,529 |
| `prover.openings_time_ms` |  705.50 |  1,411 |  892 |  519 |
| `prover.rap_constraints.logup_gkr_time_ms` |  559 |  1,118 |  599 |  519 |
| `prover.rap_constraints.round0_time_ms` |  1,046.50 |  2,093 |  1,357 |  736 |
| `prover.rap_constraints.mle_rounds_time_ms` |  381.50 |  763 |  490 |  273 |
...
| `prover.openings.whir_time_ms` |  539 |  1,078 |  677 |  401 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/3b89ec672c53d59168bede30ad3a98484467d6d7/sha2_bench-3b89ec672c53d59168bede30ad3a98484467d6d7.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 70 |  |  |  | 337 |  |  |  |  |  |  | 
| app_proof |  |  |  | 3,055 |  | 99 | 11,167,961 | 112.36 | 0 | 8,396 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 22 | 356 | 22 | 5 | 1 | 2 | 2 | 2 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 334 | 117 | 0 | 0 | 109 | 35 | 35 | 52 | 20 | 0 | 106 | 93 | 13 | 3 | 9 | 118 | 117 | 109 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 171 | 47 | 0 | 0 | 68 | 25 | 24 | 28 | 14 | 0 | 55 | 46 | 8 | 1 | 6 | 47 | 47 | 68 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 140 | 32 | 0 | 0 | 62 | 23 | 22 | 25 | 14 | 0 | 44 | 37 | 7 | 1 | 5 | 33 | 32 | 62 | 0 | 3 | 13 | 0 | 0 | 
| leaf | 0 | prover | 237,896,248 | 895 | 372 | 0 | 0 | 228 | 109 | 108 | 68 | 51 | 0 | 294 | 256 | 37 | 19 | 17 | 372 | 372 | 228 | 0 | 12 | 50 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,288,077,561 | 4,681 | 1,341 | 0 | 0 | 2,447 | 1,357 | 1,357 | 490 | 599 | 1 | 892 | 677 | 214 | 134 | 80 | 1,341 | 1,341 | 2,447 | 0 | 7 | 597 | 0 | 0 | 
| app_proof | prover | 1 | 751,206,644 | 2,642 | 592 | 0 | 0 | 1,529 | 736 | 736 | 273 | 519 | 0 | 519 | 401 | 117 | 71 | 46 | 593 | 592 | 1,529 | 0 | 7 | 517 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 135 | 1 | 177 | 5,236 | 177 | 135 | 13,329,494,472 | 2,141,911,524 | 15,471,405,996 | 2,097,152 | 0 | 3 | 242 | 7,124,000 | 31.84 | 
| app_proof | 1 | 41 | 1 | 75 | 3,055 | 75 | 41 | 7,598,498,184 | 1,557,865,504 | 9,156,363,688 | 2,097,152 | 0 | 2 | 296 | 4,043,961 | 35.10 | 

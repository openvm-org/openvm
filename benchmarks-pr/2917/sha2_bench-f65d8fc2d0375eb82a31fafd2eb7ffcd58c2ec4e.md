...
|:---|---:|---:|---:|
| Total |  9.93 |  6.93 |  6.93 |
| app_proof |  8.26 |  5.26 |  5.26 |
| leaf |  0.99 |  0.99 |  0.99 |
...
| `total_proof_time_ms ` |  4,082 |  8,164 |  5,166 |  2,998 |
| `compile_metered_time_ms` |  3 |  3 |  3 |  3 |
| `execute_metered_time_ms` |  98 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  112.83 | -          |  112.83 |  112.83 |
| `execute_preflight_insns` |  5,583,980.50 |  11,167,961 |  7,124,000 |  4,043,961 |
| `execute_preflight_time_ms` |  264.50 |  529 |  288 |  241 |
| `execute_preflight_insn_mi/s` |  33.47 | -          |  35.08 |  31.86 |
| `trace_gen_time_ms   ` |  125.50 |  251 |  176 |  75 |
| `set_initial_memory_time_ms` |  88 |  176 |  135 |  41 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  3,602.50 |  7,205 |  4,612 |  2,593 |
| `prover.main_trace_commit_time_ms` |  959.50 |  1,919 |  1,331 |  588 |
| `prover.rap_constraints_time_ms` |  1,942 |  3,884 |  2,393 |  1,491 |
| `prover.openings_time_ms` |  700 |  1,400 |  887 |  513 |
| `prover.rap_constraints.logup_gkr_time_ms` |  549.50 |  1,099 |  590 |  509 |
| `prover.rap_constraints.round0_time_ms` |  1,016 |  2,032 |  1,319 |  713 |
| `prover.rap_constraints.mle_rounds_time_ms` |  375.50 |  751 |  483 |  268 |
| `prover.openings.stacked_reduction_time_ms` |  163.50 |  327 |  212 |  115 |
| `prover.openings.stacked_reduction.round0_time_ms` |  100.50 |  201 |  132 |  69 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  62.50 |  125 |  79 |  46 |
| `prover.openings.whir_time_ms` |  536 |  1,072 |  674 |  398 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/f65d8fc2d0375eb82a31fafd2eb7ffcd58c2ec4e/sha2_bench-f65d8fc2d0375eb82a31fafd2eb7ffcd58c2ec4e.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 67 |  |  |  | 338 |  |  |  |  |  |  | 
| app_proof |  |  |  | 2,998 |  | 98 | 11,167,961 | 112.83 | 0 | 8,268 |  | 
...
| leaf | 0 | 109 | 994 | 108 | 33 | 17 | 2 | 7 | 7 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 327 | 117 | 0 | 0 | 107 | 35 | 34 | 51 | 20 | 0 | 102 | 88 | 13 | 3 | 9 | 117 | 117 | 107 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 167 | 46 | 0 | 0 | 66 | 24 | 24 | 28 | 13 | 0 | 53 | 44 | 8 | 1 | 6 | 47 | 46 | 66 | 0 | 3 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 134 | 31 | 0 | 0 | 61 | 23 | 22 | 25 | 13 | 0 | 41 | 34 | 7 | 1 | 5 | 31 | 31 | 61 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 237,896,248 | 884 | 372 | 0 | 0 | 227 | 109 | 108 | 67 | 50 | 0 | 285 | 248 | 36 | 19 | 17 | 372 | 372 | 227 | 0 | 9 | 50 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,288,077,561 | 4,612 | 1,331 | 0 | 0 | 2,393 | 1,319 | 1,318 | 483 | 590 | 0 | 887 | 674 | 212 | 132 | 79 | 1,331 | 1,331 | 2,393 | 0 | 4 | 589 | 0 | 0 | 
| app_proof | prover | 1 | 751,206,644 | 2,593 | 587 | 0 | 0 | 1,491 | 713 | 712 | 268 | 509 | 0 | 513 | 398 | 115 | 69 | 46 | 588 | 587 | 1,491 | 0 | 5 | 508 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 135 | 1 | 176 | 5,166 | 176 | 135 | 13,329,494,472 | 2,141,911,524 | 15,471,405,996 | 2,097,152 | 0 | 3 | 241 | 7,124,000 | 31.86 | 
| app_proof | 1 | 41 | 1 | 75 | 2,998 | 75 | 41 | 7,598,498,184 | 1,557,865,504 | 9,156,363,688 | 2,097,152 | 0 | 2 | 288 | 4,043,961 | 35.08 | 

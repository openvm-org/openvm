...
| `total_proof_time_ms ` |  951.50 |  1,903 |  1,217 |  686 |
| `compile_metered_time_ms` |  3 |  3 |  3 |  3 |
| `execute_metered_time_ms` |  34 | -          | -          | -          |
| `execute_metered_insns` |  2,579,903 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  74.19 | -          |  74.19 |  74.19 |
| `execute_preflight_insns` |  1,289,951.50 |  2,579,903 |  1,540,000 |  1,039,903 |
| `execute_preflight_time_ms` |  100.50 |  201 |  138 |  63 |
| `execute_preflight_insn_mi/s` |  35.10 | -          |  36.05 |  34.16 |
| `trace_gen_time_ms   ` |  25.50 |  51 |  35 |  16 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  715.50 |  1,431 |  941 |  490 |
| `prover.main_trace_commit_time_ms` |  215 |  430 |  292 |  138 |
| `prover.rap_constraints_time_ms` |  450 |  900 |  591 |  309 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/607ac6baa1cd20a1c41b462a9f1749dc23b1f65c/kitchen_sink-607ac6baa1cd20a1c41b462a9f1749dc23b1f65c.memory.svg)
...
| app_proof |  |  |  |  |  | 686 |  |  | 34 | 2,579,903 | 74.19 | 0 | 1,942 |  | 
...
| leaf | 0 | 114 | 414 | 114 | 23 | 9 | 21 | 5 | 5 | 
...
| leaf | 0 | prover | 265,006,708 | 300 | 129 | 0 | 1 | 141 | 50 | 49 | 37 | 53 | 0 | 28 | 12 | 15 | 7 | 8 | 130 | 141 | 0 | 2 | 53 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 567,917,156 | 941 | 291 | 0 | 160 | 591 | 350 | 349 | 129 | 111 | 55 | 56 | 13 | 42 | 16 | 26 | 292 | 591 | 0 | 1 | 55 | 0 | 0 | 
| app_proof | prover | 1 | 537,266,124 | 490 | 138 | 0 | 2 | 309 | 177 | 177 | 76 | 55 | 0 | 41 | 13 | 28 | 14 | 13 | 138 | 309 | 0 | 1 | 55 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 35 | 1,217 | 35 | 176 | 0 | 3 | 63 | 1,540,000 | 34.16 | 
| app_proof | 1 | 16 | 686 | 16 | 40 | 0 | 1 | 138 | 1,039,903 | 36.05 | 

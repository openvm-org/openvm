...
|:---|---:|---:|---:|
| Total |  5.52 |  3.85 |  3.85 |
| app_proof |  3.99 |  2.32 |  2.32 |
| leaf |  0.96 |  0.96 |  0.96 |
...
| `total_proof_time_ms ` |  1,979.50 |  3,959 |  2,291 |  1,668 |
...
| `execute_preflight_insn_mi/s` |  35.28 | -          |  36.58 |  33.98 |
| `trace_gen_time_ms   ` |  141.50 |  283 |  185 |  98 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,628 |  3,256 |  1,862 |  1,394 |
| `prover.main_trace_commit_time_ms` |  512.50 |  1,025 |  595 |  430 |
| `prover.rap_constraints_time_ms` |  983.50 |  1,967 |  1,131 |  836 |
| `prover.openings_time_ms` |  130.50 |  261 |  134 |  127 |
| `prover.rap_constraints.logup_gkr_time_ms` |  167.50 |  335 |  198 |  137 |
| `prover.rap_constraints.round0_time_ms` |  569 |  1,138 |  672 |  466 |
| `prover.rap_constraints.mle_rounds_time_ms` |  245.50 |  491 |  260 |  231 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  958 |  958 |  958 |  958 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/5d2277b0e24eab600bef75692cf25818761b5992/kitchen_sink-5d2277b0e24eab600bef75692cf25818761b5992.memory.svg)
...
| app_proof |  |  |  |  |  | 1,668 |  |  | 34 | 2,579,903 | 74.44 | 0 | 3,999 |  | 
...
| leaf | 0 | 123 | 958 | 123 | 23 | 9 | 21 | 5 | 5 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,577,979 | 262 | 117 | 0 | 0 | 108 | 35 | 35 | 52 | 20 | 0 | 35 | 21 | 13 | 3 | 9 | 118 | 108 | 0 | 2 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,767 | 144 | 45 | 0 | 0 | 67 | 24 | 24 | 28 | 14 | 0 | 30 | 21 | 8 | 1 | 6 | 46 | 67 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 120 | 32 | 0 | 0 | 63 | 24 | 23 | 24 | 14 | 0 | 24 | 17 | 7 | 1 | 5 | 32 | 63 | 0 | 2 | 13 | 0 | 0 | 
| leaf | 0 | prover | 265,006,964 | 835 | 403 | 0 | 1 | 352 | 137 | 136 | 79 | 136 | 0 | 78 | 37 | 40 | 22 | 18 | 404 | 352 | 0 | 6 | 135 | 0 | 0 | 
...
| leaf | 0 | prover | 0 | 40,827,971 | 2,013,265,921 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 567,917,156 | 1,862 | 595 | 0 | 184 | 1,131 | 672 | 671 | 260 | 198 | 55 | 134 | 32 | 101 | 51 | 50 | 595 | 1,131 | 0 | 3 | 141 | 0 | 0 | 
| app_proof | prover | 1 | 537,266,124 | 1,394 | 430 | 0 | 1 | 836 | 466 | 465 | 231 | 137 | 0 | 127 | 40 | 86 | 49 | 37 | 430 | 836 | 0 | 4 | 136 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 185 | 2,291 | 185 | 178 | 0 | 3 | 65 | 1,540,000 | 33.98 | 
| app_proof | 1 | 98 | 1,668 | 98 | 41 | 0 | 2 | 134 | 1,039,903 | 36.58 | 

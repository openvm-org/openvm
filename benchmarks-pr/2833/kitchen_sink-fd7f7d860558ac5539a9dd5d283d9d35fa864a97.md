...
| `total_proof_time_ms ` |  956 |  1,912 |  1,234 |  678 |
| `compile_metered_time_ms` |  3 |  3 |  3 |  3 |
| `execute_metered_time_ms` |  35 | -          | -          | -          |
| `execute_metered_insns` |  2,579,903 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  72.93 | -          |  72.93 |  72.93 |
| `execute_preflight_insns` |  1,289,951.50 |  2,579,903 |  1,540,000 |  1,039,903 |
| `execute_preflight_time_ms` |  97.50 |  195 |  132 |  63 |
| `execute_preflight_insn_mi/s` |  34.85 | -          |  35.91 |  33.79 |
| `trace_gen_time_ms   ` |  26 |  52 |  36 |  16 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  721.50 |  1,443 |  954 |  489 |
| `prover.main_trace_commit_time_ms` |  217 |  434 |  295 |  139 |
| `prover.rap_constraints_time_ms` |  454 |  908 |  601 |  307 |
| `prover.openings_time_ms` |  50 |  100 |  57 |  43 |
| `prover.rap_constraints.logup_gkr_time_ms` |  85.50 |  171 |  115 |  56 |
| `prover.rap_constraints.round0_time_ms` |  264 |  528 |  354 |  174 |
| `prover.rap_constraints.mle_rounds_time_ms` |  104 |  208 |  132 |  76 |
| `prover.openings.stacked_reduction_time_ms` |  35.50 |  71 |  43 |  28 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  417 |  417 |  417 |  417 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/fd7f7d860558ac5539a9dd5d283d9d35fa864a97/kitchen_sink-fd7f7d860558ac5539a9dd5d283d9d35fa864a97.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 70 | 3 |  |  | 0 |  | 335 | 3 |  |  |  |  |  |  | 
| app_proof |  |  |  |  |  | 678 |  |  | 35 | 2,579,903 | 72.93 | 0 | 1,953 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,577,915 | 120 | 38 | 0 | 0 | 63 | 21 | 20 | 29 | 12 | 0 | 17 | 10 | 7 | 1 | 6 | 39 | 63 | 0 | 1 | 11 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,703 | 79 | 16 | 0 | 0 | 48 | 17 | 17 | 20 | 9 | 0 | 14 | 8 | 5 | 1 | 4 | 16 | 48 | 0 | 1 | 9 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 77 | 11 | 0 | 0 | 48 | 19 | 18 | 18 | 10 | 0 | 16 | 11 | 5 | 0 | 4 | 11 | 48 | 0 | 1 | 9 | 0 | 0 | 
| leaf | 0 | prover | 265,006,708 | 301 | 130 | 0 | 1 | 141 | 49 | 48 | 37 | 54 | 0 | 29 | 12 | 16 | 7 | 8 | 131 | 141 | 0 | 2 | 54 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 567,917,156 | 954 | 295 | 0 | 163 | 601 | 354 | 352 | 132 | 115 | 57 | 57 | 14 | 43 | 16 | 26 | 295 | 601 | 0 | 1 | 56 | 0 | 0 | 
| app_proof | prover | 1 | 537,266,124 | 489 | 138 | 0 | 2 | 307 | 174 | 173 | 76 | 56 | 0 | 43 | 14 | 28 | 14 | 13 | 139 | 307 | 0 | 1 | 55 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 36 | 1,234 | 36 | 179 | 0 | 3 | 63 | 1,540,000 | 33.79 | 
| app_proof | 1 | 16 | 678 | 16 | 40 | 0 | 1 | 132 | 1,039,903 | 35.91 | 

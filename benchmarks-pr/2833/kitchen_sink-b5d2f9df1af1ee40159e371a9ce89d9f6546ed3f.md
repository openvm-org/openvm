...
|:---|---:|---:|---:|
| Total |  5.53 |  5.53 |  5.53 |
| app_proof |  3.96 |  3.96 |  3.96 |
| leaf |  0.88 |  0.88 |  0.88 |
...
| `prover.main_trace_commit_time_ms` |  1,153 |  1,153 |  1,153 |  1,153 |
| `prover.rap_constraints_time_ms` |  1,700 |  1,700 |  1,700 |  1,700 |
| `prover.openings_time_ms` |  793 |  793 |  793 |  793 |
| `prover.rap_constraints.logup_gkr_time_ms` |  286 |  286 |  286 |  286 |
| `prover.rap_constraints.round0_time_ms` |  1,026 |  1,026 |  1,026 |  1,026 |
...
| `prover.openings.whir_time_ms` |  602 |  602 |  602 |  602 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  879 |  879 |  879 |  879 |
| `execute_preflight_time_ms` |  18 |  18 |  18 |  18 |
| `trace_gen_time_ms   ` |  104 |  104 |  104 |  104 |
| `generate_blob_total_time_ms` |  9 |  9 |  9 |  9 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  775 |  775 |  775 |  775 |
| `prover.main_trace_commit_time_ms` |  258 |  258 |  258 |  258 |
...
| `prover.rap_constraints.round0_time_ms` |  107 |  107 |  107 |  107 |
...
| `prover.openings.whir_time_ms` |  190 |  190 |  190 |  190 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/b5d2f9df1af1ee40159e371a9ce89d9f6546ed3f/kitchen_sink-b5d2f9df1af1ee40159e371a9ce89d9f6546ed3f.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 73 | 9 |  |  | 0 |  | 376 | 9 |  |  |  |  |  |  | 
| app_proof |  |  |  |  |  | 3,938 |  |  | 25 | 1,979,971 | 77.33 | 0 | 3,968 |  | 
...
| app_proof | VmAirWrapper<Rv64BaseAluAdapterAir, BitwiseLogicCoreAir<8, 8> | 0 | 2 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,577,981 | 328 | 119 | 0 | 0 | 108 | 36 | 35 | 51 | 20 | 0 | 100 | 86 | 13 | 3 | 9 | 119 | 108 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 170 | 48 | 0 | 0 | 68 | 25 | 25 | 28 | 13 | 0 | 53 | 44 | 8 | 1 | 6 | 48 | 68 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 145 | 32 | 0 | 0 | 63 | 24 | 23 | 25 | 14 | 0 | 49 | 41 | 7 | 1 | 5 | 32 | 63 | 0 | 3 | 13 | 0 | 0 | 
| leaf | 0 | prover | 167,484,093 | 775 | 258 | 0 | 0 | 298 | 107 | 106 | 59 | 131 | 0 | 217 | 190 | 27 | 14 | 13 | 258 | 298 | 0 | 8 | 130 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,089,667,964 | 3,647 | 1,153 | 0 | 0 | 1,700 | 1,026 | 1,025 | 388 | 286 | 1 | 793 | 602 | 190 | 110 | 80 | 1,153 | 1,700 | 0 | 5 | 283 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 2 | 72 | 3,938 | 72 | 135 | 10,281,410,592 | 2,838,841,776 | 13,120,252,368 | 2,097,152 | 0 | 4 | 82 | 1,979,971 | 32.17 | 

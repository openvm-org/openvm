...
|:---|---:|---:|---:|
| Total |  9.98 |  6.96 |  6.96 |
| app_proof |  8.30 |  5.28 |  5.28 |
| leaf |  1 |  1 |  1 |
...
| `total_proof_time_ms ` |  4,102 |  8,204 |  5,185 |  3,019 |
| `compile_metered_time_ms` |  3 |  3 |  3 |  3 |
| `execute_metered_time_ms` |  98 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  113.26 | -          |  113.26 |  113.26 |
| `execute_preflight_insns` |  5,583,980.50 |  11,167,961 |  7,124,000 |  4,043,961 |
| `execute_preflight_time_ms` |  250 |  500 |  279 |  221 |
| `execute_preflight_insn_mi/s` |  36.75 | -          |  38.61 |  34.90 |
| `trace_gen_time_ms   ` |  125.50 |  251 |  176 |  75 |
| `set_initial_memory_time_ms` |  88 |  176 |  135 |  41 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  3,637 |  7,274 |  4,651 |  2,623 |
| `prover.main_trace_commit_time_ms` |  962 |  1,924 |  1,333 |  591 |
| `prover.rap_constraints_time_ms` |  1,973.50 |  3,947 |  2,434 |  1,513 |
| `prover.openings_time_ms` |  700.50 |  1,401 |  883 |  518 |
| `prover.rap_constraints.logup_gkr_time_ms` |  555 |  1,110 |  594 |  516 |
| `prover.rap_constraints.round0_time_ms` |  1,037 |  2,074 |  1,348 |  726 |
| `prover.rap_constraints.mle_rounds_time_ms` |  380.50 |  761 |  491 |  270 |
...
| `prover.openings.whir_time_ms` |  535.50 |  1,071 |  671 |  400 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,000 |  1,000 |  1,000 |  1,000 |
| `execute_preflight_time_ms` |  2 |  2 |  2 |  2 |
| `trace_gen_time_ms   ` |  106 |  106 |  106 |  106 |
| `generate_blob_total_time_ms` |  17 |  17 |  17 |  17 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  893 |  893 |  893 |  893 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/b5d2f9df1af1ee40159e371a9ce89d9f6546ed3f/sha2_bench-b5d2f9df1af1ee40159e371a9ce89d9f6546ed3f.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 73 | 9 |  |  | 0 |  | 355 | 9 |  |  |  |  |  |  | 
| app_proof |  |  |  |  |  | 3,019 |  |  | 98 | 11,167,961 | 113.26 | 0 | 8,308 |  | 
| internal_for_leaf |  |  |  | 347 |  |  |  |  |  |  |  |  |  | 348 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 325 | 117 | 0 | 0 | 108 | 36 | 35 | 51 | 20 | 0 | 99 | 86 | 13 | 3 | 9 | 117 | 108 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 171 | 47 | 0 | 0 | 68 | 24 | 24 | 28 | 15 | 0 | 54 | 46 | 8 | 1 | 6 | 47 | 68 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 141 | 32 | 0 | 0 | 62 | 23 | 22 | 25 | 14 | 0 | 46 | 39 | 7 | 1 | 5 | 32 | 62 | 0 | 3 | 13 | 0 | 0 | 
| leaf | 0 | prover | 237,896,248 | 893 | 372 | 0 | 0 | 231 | 110 | 109 | 67 | 52 | 0 | 288 | 251 | 37 | 20 | 17 | 373 | 231 | 0 | 10 | 50 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,288,077,561 | 4,651 | 1,333 | 0 | 0 | 2,434 | 1,348 | 1,348 | 491 | 594 | 0 | 883 | 671 | 212 | 133 | 79 | 1,333 | 2,434 | 0 | 5 | 592 | 0 | 0 | 
| app_proof | prover | 1 | 751,206,644 | 2,623 | 590 | 0 | 0 | 1,513 | 726 | 725 | 270 | 516 | 0 | 518 | 400 | 118 | 71 | 46 | 591 | 1,513 | 0 | 5 | 514 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 1 | 176 | 5,185 | 176 | 135 | 13,329,494,472 | 2,141,911,524 | 15,471,405,996 | 2,097,152 | 0 | 3 | 221 | 7,124,000 | 34.90 | 
| app_proof | 1 | 1 | 75 | 3,019 | 75 | 41 | 7,598,498,184 | 1,557,865,504 | 9,156,363,688 | 2,097,152 | 0 | 2 | 279 | 4,043,961 | 38.61 | 

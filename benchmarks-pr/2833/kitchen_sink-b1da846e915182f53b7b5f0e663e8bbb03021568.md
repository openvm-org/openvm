...
| `total_proof_time_ms ` |  955.50 |  1,911 |  1,239 |  672 |
| `compile_metered_time_ms` |  3 |  3 |  3 |  3 |
| `execute_metered_time_ms` |  35 | -          | -          | -          |
| `execute_metered_insns` |  2,579,903 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  73.66 | -          |  73.66 |  73.66 |
| `execute_preflight_insns` |  1,289,951.50 |  2,579,903 |  1,540,000 |  1,039,903 |
| `execute_preflight_time_ms` |  97.50 |  195 |  132 |  63 |
| `execute_preflight_insn_mi/s` |  35.06 | -          |  36.17 |  33.95 |
| `trace_gen_time_ms   ` |  26 |  52 |  36 |  16 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  720.50 |  1,441 |  959 |  482 |
| `prover.main_trace_commit_time_ms` |  218.50 |  437 |  300 |  137 |
| `prover.rap_constraints_time_ms` |  452.50 |  905 |  602 |  303 |
| `prover.openings_time_ms` |  48.50 |  97 |  56 |  41 |
| `prover.rap_constraints.logup_gkr_time_ms` |  85.50 |  171 |  116 |  55 |
| `prover.rap_constraints.round0_time_ms` |  263 |  526 |  354 |  172 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/b1da846e915182f53b7b5f0e663e8bbb03021568/kitchen_sink-b1da846e915182f53b7b5f0e663e8bbb03021568.memory.svg)
...
| app_proof |  |  |  |  |  | 672 |  |  | 35 | 2,579,903 | 73.66 | 0 | 1,951 |  | 
...
| leaf | 0 | 113 | 408 | 113 | 23 | 9 | 21 | 4 | 4 | 
...
| internal_recursive.0 | 1 | prover | 15,378,703 | 80 | 16 | 0 | 0 | 47 | 17 | 16 | 20 | 9 | 0 | 15 | 9 | 6 | 1 | 5 | 16 | 47 | 0 | 1 | 9 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 75 | 11 | 0 | 0 | 49 | 20 | 19 | 18 | 10 | 0 | 14 | 8 | 5 | 0 | 4 | 11 | 49 | 0 | 1 | 9 | 0 | 0 | 
| leaf | 0 | prover | 265,006,708 | 294 | 127 | 0 | 1 | 138 | 48 | 47 | 37 | 52 | 0 | 27 | 11 | 15 | 7 | 8 | 128 | 138 | 0 | 2 | 52 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 567,917,156 | 959 | 299 | 0 | 169 | 602 | 354 | 352 | 132 | 116 | 59 | 56 | 13 | 42 | 15 | 26 | 300 | 602 | 0 | 1 | 55 | 0 | 0 | 
| app_proof | prover | 1 | 537,266,124 | 482 | 137 | 0 | 1 | 303 | 172 | 172 | 75 | 55 | 0 | 41 | 13 | 27 | 14 | 13 | 137 | 303 | 0 | 1 | 54 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 36 | 1,239 | 36 | 179 | 0 | 4 | 63 | 1,540,000 | 33.95 | 
| app_proof | 1 | 16 | 672 | 16 | 40 | 0 | 1 | 132 | 1,039,903 | 36.17 | 

...
|:---|---:|---:|---:|
| Total |  2.28 |  1.64 |  1.64 |
| app_proof |  1.42 |  0.78 |  0.78 |
| leaf |  0.35 |  0.35 |  0.35 |
...
| `total_proof_time_ms ` |  693.50 |  1,387 |  751 |  636 |
| `compile_metered_time_ms` |  8 |  8 |  8 |  8 |
| `execute_metered_time_ms` |  31 | -          | -          | -          |
| `execute_metered_insns` |  4,137,067 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  130.14 | -          |  130.14 |  130.14 |
| `execute_preflight_insns` |  2,068,533.50 |  4,137,067 |  2,208,000 |  1,929,067 |
| `execute_preflight_time_ms` |  78.50 |  157 |  88 |  69 |
| `execute_preflight_insn_mi/s` |  36.48 | -          |  40.27 |  32.69 |
| `trace_gen_time_ms   ` |  142.50 |  285 |  150 |  135 |
| `memory_finalize_time_ms` |  1 |  2 |  2 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  369 |  738 |  375 |  363 |
| `prover.main_trace_commit_time_ms` |  91.50 |  183 |  95 |  88 |
| `prover.rap_constraints_time_ms` |  239 |  478 |  250 |  228 |
...
| `prover.openings.whir_time_ms` |  18.50 |  37 |  20 |  17 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/ace6d50ba49cadf70c8199e069ee67a9601b7cd9/regex-ace6d50ba49cadf70c8199e069ee67a9601b7cd9.memory.svg)
...
| app_proof |  |  |  |  |  | 636 |  |  | 31 | 4,137,067 | 130.14 | 0 | 1,432 |  | 
...
| internal_recursive.0 | 1 | 9 | 157 | 9 | 1 | 0 | 2 | 0 | 0 | 
| internal_recursive.1 | 1 | 9 | 126 | 8 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 46 | 352 | 46 | 13 | 2 | 5 | 1 | 1 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 27,256,571 | 210 | 81 | 0 | 0 | 97 | 32 | 31 | 45 | 20 | 0 | 30 | 19 | 11 | 2 | 8 | 81 | 97 | 0 | 2 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,703 | 147 | 46 | 0 | 0 | 66 | 25 | 24 | 28 | 13 | 0 | 33 | 25 | 8 | 1 | 6 | 46 | 66 | 0 | 2 | 12 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 117 | 31 | 0 | 0 | 61 | 23 | 22 | 24 | 13 | 0 | 24 | 17 | 7 | 1 | 5 | 31 | 61 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 79,962,804 | 306 | 127 | 0 | 0 | 136 | 54 | 53 | 37 | 44 | 0 | 42 | 27 | 15 | 6 | 8 | 127 | 136 | 0 | 5 | 41 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 123,384,338 | 363 | 94 | 0 | 0 | 228 | 55 | 54 | 34 | 138 | 0 | 40 | 20 | 19 | 10 | 9 | 95 | 228 | 0 | 3 | 136 | 0 | 0 | 
| app_proof | prover | 1 | 106,568,591 | 375 | 88 | 0 | 8 | 250 | 85 | 85 | 29 | 135 | 0 | 36 | 17 | 19 | 8 | 10 | 88 | 250 | 0 | 2 | 134 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 135 | 751 | 135 | 163 | 2 | 6 | 88 | 2,208,000 | 32.69 | 
| app_proof | 1 | 150 | 636 | 150 | 40 | 0 | 2 | 69 | 1,929,067 | 40.27 | 

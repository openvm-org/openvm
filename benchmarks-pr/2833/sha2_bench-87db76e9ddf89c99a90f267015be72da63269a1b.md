...
|:---|---:|---:|---:|
| Total |  12.74 |  3.66 |  3.66 |
| app_proof |  10.48 |  1.89 |  1.89 |
| leaf |  1.49 |  0.99 |  0.99 |
...
| `total_proof_time_ms ` |  1,723.83 |  10,343 |  1,756 |  1,676 |
...
| `execute_preflight_insn_mi/s` |  40.94 | -          |  41.51 |  38.76 |
| `trace_gen_time_ms   ` |  168.50 |  1,011 |  199 |  147 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,296.17 |  7,777 |  1,323 |  1,258 |
| `prover.main_trace_commit_time_ms` |  290.17 |  1,741 |  291 |  289 |
| `prover.rap_constraints_time_ms` |  917 |  5,502 |  942 |  879 |
| `prover.openings_time_ms` |  88 |  528 |  93 |  85 |
| `prover.rap_constraints.logup_gkr_time_ms` |  295.17 |  1,771 |  310 |  246 |
| `prover.rap_constraints.round0_time_ms` |  447.83 |  2,687 |  462 |  394 |
| `prover.rap_constraints.mle_rounds_time_ms` |  172.83 |  1,037 |  174 |  169 |
| `prover.openings.stacked_reduction_time_ms` |  55.67 |  334 |  56 |  55 |
| `prover.openings.stacked_reduction.round0_time_ms` |  32.67 |  196 |  33 |  32 |
...
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  666.50 |  1,333 |  883 |  450 |
| `prover.main_trace_commit_time_ms` |  367 |  734 |  508 |  226 |
| `prover.rap_constraints_time_ms` |  230.50 |  461 |  291 |  170 |
| `prover.openings_time_ms` |  67.50 |  135 |  83 |  52 |
| `prover.rap_constraints.logup_gkr_time_ms` |  60 |  120 |  74 |  46 |
| `prover.rap_constraints.round0_time_ms` |  105.50 |  211 |  136 |  75 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/87db76e9ddf89c99a90f267015be72da63269a1b/sha2_bench-87db76e9ddf89c99a90f267015be72da63269a1b.memory.svg)
...
| app_proof |  |  |  |  |  | 1,716 |  |  | 138 | 14,793,960 | 107.01 | 0 | 10,488 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 30 | 470 | 30 | 10 | 2 | 2 | 1 | 1 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 75,647,860 | 439 | 228 | 0 | 1 | 166 | 47 | 47 | 88 | 30 | 0 | 44 | 21 | 22 | 7 | 15 | 228 | 166 | 0 | 2 | 29 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,879 | 154 | 50 | 0 | 0 | 75 | 26 | 25 | 29 | 18 | 0 | 29 | 20 | 8 | 2 | 6 | 50 | 75 | 0 | 2 | 17 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 130 | 32 | 0 | 0 | 61 | 23 | 22 | 24 | 13 | 0 | 35 | 27 | 7 | 1 | 5 | 32 | 61 | 0 | 3 | 12 | 0 | 0 | 
| leaf | 0 | prover | 266,560,230 | 883 | 508 | 0 | 93 | 291 | 136 | 135 | 81 | 74 | 0 | 83 | 41 | 42 | 22 | 19 | 508 | 291 | 0 | 7 | 73 | 0 | 0 | 
| leaf | 1 | prover | 135,246,516 | 450 | 226 | 0 | 1 | 170 | 75 | 74 | 48 | 46 | 0 | 52 | 29 | 23 | 11 | 11 | 226 | 170 | 0 | 6 | 45 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 353,899,717 | 1,258 | 290 | 0 | 1 | 879 | 394 | 393 | 173 | 310 | 75 | 88 | 31 | 56 | 33 | 23 | 290 | 879 | 0 | 3 | 234 | 0 | 0 | 
| app_proof | prover | 1 | 353,899,532 | 1,320 | 291 | 0 | 1 | 941 | 462 | 462 | 174 | 304 | 75 | 87 | 31 | 56 | 32 | 23 | 291 | 941 | 0 | 4 | 228 | 0 | 0 | 
| app_proof | prover | 2 | 353,899,532 | 1,320 | 289 | 0 | 1 | 937 | 458 | 458 | 173 | 305 | 74 | 93 | 37 | 55 | 33 | 22 | 289 | 937 | 0 | 3 | 230 | 0 | 0 | 
| app_proof | prover | 3 | 353,899,532 | 1,259 | 290 | 0 | 1 | 883 | 462 | 461 | 174 | 246 | 0 | 85 | 29 | 56 | 33 | 22 | 290 | 883 | 0 | 3 | 245 | 0 | 0 | 
| app_proof | prover | 4 | 353,899,532 | 1,323 | 291 | 0 | 1 | 942 | 462 | 462 | 174 | 304 | 75 | 90 | 33 | 56 | 33 | 23 | 291 | 942 | 0 | 4 | 229 | 0 | 0 | 
| app_proof | prover | 5 | 353,980,012 | 1,297 | 290 | 0 | 1 | 920 | 449 | 449 | 169 | 302 | 74 | 85 | 29 | 55 | 32 | 23 | 290 | 920 | 0 | 4 | 226 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 171 | 1,676 | 171 | 161 | 0 | 3 | 84 | 2,623,000 | 38.76 | 
| app_proof | 1 | 147 | 1,756 | 147 | 136 | 0 | 2 | 152 | 2,625,000 | 41.51 | 
| app_proof | 2 | 165 | 1,751 | 165 | 130 | 0 | 2 | 135 | 2,625,000 | 41.04 | 
| app_proof | 3 | 164 | 1,690 | 164 | 130 | 0 | 2 | 135 | 2,625,000 | 41.48 | 
| app_proof | 4 | 165 | 1,754 | 165 | 130 | 0 | 2 | 134 | 2,625,000 | 41.40 | 
| app_proof | 5 | 199 | 1,716 | 199 | 129 | 0 | 2 | 90 | 1,670,960 | 41.42 | 

...
|:---|---:|---:|---:|
| Total |  2.66 |  1.98 |  1.98 |
| app_proof |  1.94 |  1.26 |  1.26 |
| leaf |  0.42 |  0.42 |  0.42 |
...
| `total_proof_time_ms ` |  953 |  1,906 |  1,226 |  680 |
| `compile_metered_time_ms` |  3 |  3 |  3 |  3 |
| `execute_metered_time_ms` |  34 | -          | -          | -          |
| `execute_metered_insns` |  2,579,903 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  73.100 | -          |  73.100 |  73.100 |
| `execute_preflight_insns` |  1,289,951.50 |  2,579,903 |  1,540,000 |  1,039,903 |
| `execute_preflight_time_ms` |  99.50 |  199 |  135 |  64 |
| `execute_preflight_insn_mi/s` |  34.93 | -          |  36.32 |  33.54 |
| `trace_gen_time_ms   ` |  25 |  50 |  34 |  16 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  717.50 |  1,435 |  948 |  487 |
| `prover.main_trace_commit_time_ms` |  217 |  434 |  296 |  138 |
| `prover.rap_constraints_time_ms` |  451.50 |  903 |  595 |  308 |
| `prover.openings_time_ms` |  48 |  96 |  56 |  40 |
| `prover.rap_constraints.logup_gkr_time_ms` |  83.50 |  167 |  113 |  54 |
| `prover.rap_constraints.round0_time_ms` |  264.50 |  529 |  352 |  177 |
| `prover.rap_constraints.mle_rounds_time_ms` |  102 |  204 |  129 |  75 |
| `prover.openings.stacked_reduction_time_ms` |  35 |  70 |  42 |  28 |
| `prover.openings.stacked_reduction.round0_time_ms` |  15 |  30 |  16 |  14 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  19.50 |  39 |  26 |  13 |
| `prover.openings.whir_time_ms` |  12.50 |  25 |  13 |  12 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  416 |  416 |  416 |  416 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/fbb235226df4003e104cc696129add5f09de257e/kitchen_sink-fbb235226df4003e104cc696129add5f09de257e.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 75 | 3 |  |  | 0 |  | 337 | 3 |  |  |  |  |  |  | 
| app_proof |  |  |  |  |  | 680 |  |  | 34 | 2,579,903 | 73.100 | 0 | 1,946 |  | 
...
| internal_recursive.0 | 1 | 9 | 90 | 9 | 1 | 0 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 8 | 81 | 8 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 116 | 416 | 116 | 24 | 10 | 21 | 5 | 5 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,577,915 | 118 | 38 | 0 | 0 | 63 | 21 | 20 | 29 | 12 | 0 | 16 | 8 | 7 | 1 | 6 | 38 | 62 | 0 | 1 | 11 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,703 | 80 | 16 | 0 | 0 | 47 | 17 | 16 | 20 | 9 | 0 | 15 | 9 | 5 | 1 | 4 | 16 | 47 | 0 | 1 | 9 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 72 | 11 | 0 | 0 | 47 | 19 | 18 | 18 | 10 | 0 | 13 | 7 | 5 | 0 | 4 | 11 | 47 | 0 | 1 | 9 | 0 | 0 | 
| leaf | 0 | prover | 265,006,708 | 300 | 129 | 0 | 1 | 141 | 49 | 48 | 37 | 55 | 0 | 28 | 12 | 15 | 7 | 8 | 129 | 141 | 0 | 2 | 54 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 567,917,156 | 948 | 296 | 0 | 164 | 595 | 352 | 351 | 129 | 113 | 56 | 56 | 13 | 42 | 16 | 26 | 296 | 595 | 0 | 1 | 55 | 0 | 0 | 
| app_proof | prover | 1 | 537,266,124 | 487 | 138 | 0 | 1 | 308 | 177 | 177 | 75 | 54 | 0 | 40 | 12 | 28 | 14 | 13 | 138 | 308 | 0 | 1 | 53 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 34 | 1,226 | 34 | 177 | 0 | 3 | 64 | 1,540,000 | 33.54 | 
| app_proof | 1 | 16 | 680 | 16 | 40 | 0 | 1 | 135 | 1,039,903 | 36.32 | 

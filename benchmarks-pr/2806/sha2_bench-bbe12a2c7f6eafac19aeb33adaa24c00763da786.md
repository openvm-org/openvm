...
| `total_proof_time_ms ` |  1,685.17 |  10,111 |  1,717 |  1,635 |
| `execute_metered_time_ms` |  137 | -          | -          | -          |
| `execute_metered_insns` |  14,793,960 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  107.81 | -          |  107.81 |  107.81 |
| `execute_preflight_insns` |  2,465,660 |  14,793,960 |  2,625,000 |  1,670,960 |
| `execute_preflight_time_ms` |  124.67 |  748 |  156 |  85 |
| `execute_preflight_insn_mi/s` |  41.37 | -          |  42.07 |  39.19 |
| `trace_gen_time_ms   ` |  157 |  942 |  190 |  132 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,263.83 |  7,583 |  1,292 |  1,225 |
| `prover.main_trace_commit_time_ms` |  282.83 |  1,697 |  284 |  282 |
| `prover.rap_constraints_time_ms` |  895.17 |  5,371 |  921 |  856 |
| `prover.openings_time_ms` |  85.17 |  511 |  89 |  80 |
| `prover.rap_constraints.logup_gkr_time_ms` |  289.17 |  1,735 |  305 |  239 |
| `prover.rap_constraints.round0_time_ms` |  439.17 |  2,635 |  453 |  382 |
| `prover.rap_constraints.mle_rounds_time_ms` |  165.33 |  992 |  168 |  160 |
| `prover.openings.stacked_reduction_time_ms` |  53.83 |  323 |  55 |  52 |
...
| `prover.openings.whir_time_ms` |  30.67 |  184 |  35 |  27 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  724 |  1,448 |  961 |  487 |
| `execute_preflight_time_ms` |  2 |  4 |  2 |  2 |
| `trace_gen_time_ms   ` |  76.50 |  153 |  102 |  51 |
| `generate_blob_total_time_ms` |  9.50 |  19 |  13 |  6 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  647.50 |  1,295 |  859 |  436 |
| `prover.main_trace_commit_time_ms` |  358.50 |  717 |  498 |  219 |
| `prover.rap_constraints_time_ms` |  222 |  444 |  280 |  164 |
| `prover.openings_time_ms` |  65.50 |  131 |  79 |  52 |
| `prover.rap_constraints.logup_gkr_time_ms` |  59 |  118 |  73 |  45 |
| `prover.rap_constraints.round0_time_ms` |  99.50 |  199 |  128 |  71 |
...
| `prover.openings.whir_time_ms` |  33.50 |  67 |  38 |  29 |
...
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  427 |  427 |  427 |  427 |
...
| `prover.rap_constraints.mle_rounds_time_ms` |  84 |  84 |  84 |  84 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/bbe12a2c7f6eafac19aeb33adaa24c00763da786/sha2_bench-bbe12a2c7f6eafac19aeb33adaa24c00763da786.memory.svg)
...
| app_proof |  |  |  |  |  | 1,680 |  |  | 137 | 14,793,960 | 107.81 | 0 | 10,256 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 32 | 460 | 32 | 12 | 3 | 2 | 1 | 1 | 
| internal_recursive.0 | 1 | 13 | 164 | 13 | 2 | 1 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 9 | 131 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 102 | 961 | 102 | 37 | 13 | 2 | 3 | 3 | 
| leaf | 1 | 51 | 487 | 50 | 18 | 6 | 2 | 3 | 3 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 75,647,860 | 427 | 222 | 0 | 1 | 161 | 46 | 45 | 84 | 30 | 0 | 43 | 21 | 22 | 6 | 15 | 223 | 161 | 0 | 3 | 29 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,879 | 151 | 49 | 0 | 0 | 72 | 26 | 25 | 29 | 17 | 0 | 28 | 20 | 8 | 1 | 6 | 49 | 72 | 0 | 2 | 16 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 122 | 31 | 0 | 0 | 62 | 23 | 22 | 24 | 14 | 0 | 28 | 21 | 7 | 1 | 5 | 31 | 62 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 266,560,230 | 859 | 498 | 0 | 95 | 280 | 128 | 127 | 78 | 73 | 0 | 79 | 38 | 40 | 21 | 18 | 498 | 280 | 0 | 6 | 73 | 0 | 0 | 
| leaf | 1 | prover | 135,246,516 | 436 | 218 | 0 | 1 | 164 | 71 | 71 | 47 | 45 | 0 | 52 | 29 | 22 | 11 | 11 | 219 | 164 | 0 | 6 | 44 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 353,899,717 | 1,227 | 283 | 0 | 1 | 856 | 382 | 382 | 167 | 305 | 77 | 87 | 32 | 54 | 32 | 22 | 283 | 856 | 0 | 3 | 228 | 0 | 0 | 
| app_proof | prover | 1 | 353,899,532 | 1,285 | 282 | 0 | 1 | 918 | 451 | 451 | 168 | 298 | 76 | 84 | 29 | 54 | 32 | 21 | 282 | 918 | 0 | 3 | 221 | 0 | 0 | 
| app_proof | prover | 2 | 353,899,532 | 1,292 | 283 | 0 | 1 | 919 | 453 | 453 | 165 | 300 | 76 | 89 | 35 | 54 | 32 | 22 | 283 | 919 | 0 | 3 | 222 | 0 | 0 | 
| app_proof | prover | 3 | 353,899,532 | 1,225 | 283 | 0 | 1 | 857 | 453 | 453 | 164 | 239 | 0 | 84 | 29 | 54 | 31 | 22 | 283 | 857 | 0 | 4 | 238 | 0 | 0 | 
| app_proof | prover | 4 | 353,899,532 | 1,290 | 282 | 0 | 1 | 921 | 453 | 453 | 168 | 298 | 76 | 87 | 32 | 55 | 32 | 22 | 282 | 921 | 0 | 4 | 221 | 0 | 0 | 
| app_proof | prover | 5 | 353,980,012 | 1,264 | 283 | 0 | 1 | 900 | 443 | 443 | 160 | 295 | 76 | 80 | 27 | 52 | 30 | 21 | 284 | 900 | 0 | 3 | 218 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 160 | 1,635 | 160 | 161 | 0 | 3 | 85 | 2,623,000 | 39.19 | 
| app_proof | 1 | 132 | 1,713 | 132 | 138 | 0 | 2 | 156 | 2,625,000 | 41.77 | 
| app_proof | 2 | 153 | 1,717 | 153 | 132 | 0 | 2 | 139 | 2,625,000 | 41.09 | 
| app_proof | 3 | 153 | 1,650 | 153 | 132 | 0 | 2 | 138 | 2,625,000 | 42.07 | 
| app_proof | 4 | 154 | 1,716 | 154 | 132 | 0 | 2 | 138 | 2,625,000 | 42.05 | 
| app_proof | 5 | 190 | 1,680 | 190 | 132 | 0 | 2 | 92 | 1,670,960 | 42.05 | 

...
| `total_proof_time_ms ` |  710 |  1,420 |  807 |  613 |
...
| `execute_metered_insn_mi/s` |  19.07 | -          |  19.07 |  19.07 |
| `execute_preflight_insns` |  872,871 |  1,745,742 |  1,157,000 |  588,742 |
| `execute_preflight_time_ms` |  92.50 |  185 |  127 |  58 |
| `execute_preflight_insn_mi/s` |  13.96 | -          |  18.61 |  9.30 |
| `trace_gen_time_ms   ` |  178.50 |  357 |  195 |  162 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  345.50 |  691 |  373 |  318 |
| `main_trace_commit_time_ms` |  63 |  126 |  72 |  54 |
| `generate_perm_trace_time_ms` |  35 |  70 |  38 |  32 |
| `perm_trace_commit_time_ms` |  76.49 |  152.99 |  87.96 |  65.03 |
| `quotient_poly_compute_time_ms` |  78.96 |  157.91 |  86.94 |  70.98 |
| `quotient_poly_commit_time_ms` |  16.57 |  33.14 |  18.45 |  14.69 |
| `pcs_opening_time_ms ` |  70.50 |  141 |  76 |  65 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 613 | 41 | 1 | 91 | 1,745,742 | 19.07 | 144 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 162 | 807 | 32,689,110 | 172,558,444 | 162 | 373 | 0 | 86.94 | 18.45 | 6 | 87.96 | 65 | 128 | 65 | 1 | 72 | 16,059,916 | 38 | 127 | 1,157,000 | 9.30 | 26 | 106 | 1 | 65 | 
| pairing | 1 | 195 | 613 | 22,314,288 | 119,958,502 | 195 | 318 | 1 | 70.98 | 14.69 | 5 | 65.03 | 76 | 100 | 76 | 0 | 54 | 9,408,294 | 32 | 58 | 588,742 | 18.61 | 20 | 86 | 1 | 76 | 
...
Commit: https://github.com/openvm-org/openvm/commit/68d8e3e92d5dbf0ca7703d4e7a37fa2b67b71b85
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19314019626)

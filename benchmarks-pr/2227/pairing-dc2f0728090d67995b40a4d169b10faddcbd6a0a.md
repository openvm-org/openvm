...
| `total_proof_time_ms ` |  714 |  1,428 |  811 |  617 |
...
| `execute_preflight_insn_mi/s` |  13.92 | -          |  18.55 |  9.29 |
| `trace_gen_time_ms   ` |  178.50 |  357 |  194 |  163 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  348 |  696 |  375 |  321 |
| `main_trace_commit_time_ms` |  64.50 |  129 |  75 |  54 |
| `generate_perm_trace_time_ms` |  44 |  88 |  48 |  40 |
| `perm_trace_commit_time_ms` |  74.97 |  149.94 |  85.71 |  64.23 |
| `quotient_poly_compute_time_ms` |  77.62 |  155.24 |  84.88 |  70.35 |
| `quotient_poly_commit_time_ms` |  15.60 |  31.21 |  17.12 |  14.09 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 617 | 41 | 1 | 91 | 1,745,742 | 19.16 | 148 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 163 | 811 | 32,689,110 | 172,558,444 | 163 | 375 | 0 | 84.88 | 17.12 | 6 | 85.71 | 67 | 129 | 67 | 1 | 75 | 16,059,916 | 40 | 128 | 1,157,000 | 9.29 | 26 | 102 | 1 | 67 | 
| pairing | 1 | 194 | 617 | 22,314,288 | 119,958,502 | 194 | 321 | 1 | 70.35 | 14.09 | 6 | 64.23 | 65 | 115 | 65 | 0 | 54 | 9,408,294 | 48 | 60 | 588,742 | 18.55 | 20 | 85 | 1 | 65 | 
...
Commit: https://github.com/openvm-org/openvm/commit/dc2f0728090d67995b40a4d169b10faddcbd6a0a
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19313602269)

...
| `total_proof_time_ms ` |  589.25 |  2,357 |  730 |  538 |
...
| `execute_metered_insn_mi/s` |  104.55 | -          |  104.55 |  104.55 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  53.50 |  214 |  66 |  44 |
| `execute_preflight_insn_mi/s` |  31.40 | -          |  32.81 |  28.89 |
| `trace_gen_time_ms   ` |  179.25 |  717 |  215 |  156 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  289.25 |  1,157 |  328 |  268 |
| `main_trace_commit_time_ms` |  52 |  208 |  57 |  50 |
| `generate_perm_trace_time_ms` |  34.50 |  138 |  55 |  18 |
| `perm_trace_commit_time_ms` |  64.28 |  257.10 |  70.47 |  56.02 |
| `quotient_poly_compute_time_ms` |  58.75 |  234.100 |  69.31 |  52.26 |
| `quotient_poly_commit_time_ms` |  15.24 |  60.95 |  18.05 |  12.75 |
| `pcs_opening_time_ms ` |  61.50 |  246 |  64 |  57 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 538 | 66 | 1 | 39 | 4,137,502 | 104.55 | 193 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 215 | 730 | 23,446,148 | 150,778,428 | 215 | 328 | 0 | 60.75 | 18.05 | 5 | 70.47 | 64 | 126 | 64 | 4 | 57 | 10,899,170 | 55 | 44 | 1,103,000 | 28.89 | 22 | 79 | 1 | 64 | 
| regex_program | 1 | 156 | 549 | 11,598,276 | 128,513,066 | 156 | 286 | 1 | 52.68 | 15.02 | 5 | 65.25 | 63 | 104 | 62 | 0 | 50 | 2,196,106 | 38 | 66 | 1,104,000 | 32.81 | 17 | 68 | 0 | 62 | 
| regex_program | 2 | 164 | 540 | 11,579,064 | 128,513,066 | 164 | 275 | 1 | 52.26 | 15.14 | 4 | 65.37 | 62 | 93 | 62 | 0 | 51 | 2,177,334 | 27 | 58 | 1,104,000 | 31.99 | 17 | 67 | 0 | 62 | 
| regex_program | 3 | 182 | 538 | 11,853,872 | 103,456,394 | 182 | 268 | 0 | 69.31 | 12.75 | 5 | 56.02 | 57 | 77 | 57 | 0 | 50 | 2,422,606 | 18 | 46 | 826,502 | 31.89 | 19 | 83 | 1 | 57 | 

...
| `total_proof_time_ms ` |  502.50 |  1,005 |  571 |  434 |
...
| `execute_metered_insn_mi/s` |  118.48 | -          |  118.48 |  118.48 |
| `execute_preflight_insns` |  750,104.50 |  1,500,209 |  873,000 |  627,209 |
| `execute_preflight_time_ms` |  30.50 |  61 |  36 |  25 |
| `execute_preflight_insn_mi/s` |  37.96 | -          |  39.74 |  36.17 |
| `trace_gen_time_ms   ` |  195.50 |  391 |  203 |  188 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  181.50 |  363 |  194 |  169 |
| `main_trace_commit_time_ms` |  31 |  62 |  34 |  28 |
| `generate_perm_trace_time_ms` |  16 |  32 |  18 |  14 |
| `perm_trace_commit_time_ms` |  43.48 |  86.95 |  46.52 |  40.43 |
| `quotient_poly_compute_time_ms` |  32.65 |  65.31 |  35.17 |  30.13 |
| `quotient_poly_commit_time_ms` |  12.97 |  25.93 |  13.39 |  12.55 |
| `pcs_opening_time_ms ` |  43 |  86 |  45 |  41 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 434 | 41 | 1 | 12 | 1,500,209 | 118.48 | 142 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 203 | 571 | 9,677,708 | 84,395,212 | 203 | 194 | 0 | 35.17 | 13.39 | 4 | 46.52 | 45 | 65 | 45 | 0 | 34 | 1,035,986 | 18 | 25 | 873,000 | 36.17 | 14 | 49 | 0 | 45 | 
| fibonacci_program | 1 | 188 | 434 | 9,708,170 | 74,305,770 | 188 | 169 | 1 | 30.13 | 12.55 | 4 | 40.43 | 41 | 55 | 41 | 0 | 28 | 1,064,416 | 14 | 36 | 627,209 | 39.74 | 11 | 43 | 0 | 41 | 
...
Commit: https://github.com/openvm-org/openvm/commit/7df199faec41d34525b1e239c7d6ea851747e9cc
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19322388985)

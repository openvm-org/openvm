...
| `total_proof_time_ms ` |  749 |  1,498 |  850 |  648 |
...
| `execute_preflight_insn_mi/s` |  13.90 | -          |  18.51 |  9.29 |
| `trace_gen_time_ms   ` |  181 |  362 |  196 |  166 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  382 |  764 |  412 |  352 |
| `main_trace_commit_time_ms` |  64 |  128 |  74 |  54 |
| `generate_perm_trace_time_ms` |  40 |  80 |  41 |  39 |
| `perm_trace_commit_time_ms` |  75.87 |  151.74 |  88.18 |  63.56 |
| `quotient_poly_compute_time_ms` |  79.40 |  158.80 |  86.82 |  71.97 |
| `quotient_poly_commit_time_ms` |  16.33 |  32.66 |  17.94 |  14.72 |
| `pcs_opening_time_ms ` |  102 |  204 |  102 |  102 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 648 | 40 | 1 | 91 | 1,745,742 | 19.16 | 145 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 166 | 850 | 32,689,110 | 172,558,444 | 166 | 412 | 0 | 86.82 | 17.94 | 6 | 88.18 | 102 | 129 | 102 | 1 | 74 | 16,059,916 | 39 | 128 | 1,157,000 | 9.29 | 26 | 105 | 1 | 102 | 
| pairing | 1 | 196 | 648 | 22,314,288 | 119,958,502 | 196 | 352 | 1 | 71.97 | 14.72 | 6 | 63.56 | 102 | 107 | 102 | 0 | 54 | 9,408,294 | 41 | 58 | 588,742 | 18.51 | 20 | 87 | 1 | 102 | 

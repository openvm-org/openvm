...
| `total_proof_time_ms ` |  575.50 |  2,302 |  703 |  527 |
...
| `execute_metered_insn_mi/s` |  117.27 | -          |  117.27 |  117.27 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  53.25 |  213 |  66 |  44 |
| `execute_preflight_insn_mi/s` |  31.67 | -          |  32.77 |  28.93 |
| `trace_gen_time_ms   ` |  177.50 |  710 |  212 |  153 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  277.75 |  1,111 |  303 |  258 |
| `main_trace_commit_time_ms` |  50.50 |  202 |  56 |  48 |
| `generate_perm_trace_time_ms` |  28.25 |  113 |  35 |  19 |
| `perm_trace_commit_time_ms` |  63.70 |  254.81 |  69.80 |  54.77 |
| `quotient_poly_compute_time_ms` |  57.85 |  231.40 |  69.16 |  51.47 |
| `quotient_poly_commit_time_ms` |  14.93 |  59.71 |  17.71 |  12.14 |
| `pcs_opening_time_ms ` |  59.75 |  239 |  68 |  51 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 527 | 66 | 1 | 35 | 4,137,502 | 117.27 | 192 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 212 | 703 | 23,446,148 | 150,778,428 | 212 | 303 | 0 | 58.83 | 17.71 | 5 | 69.80 | 68 | 102 | 67 | 4 | 56 | 10,899,170 | 31 | 44 | 1,103,000 | 28.93 | 21 | 77 | 1 | 67 | 
| regex_program | 1 | 153 | 535 | 11,598,276 | 128,513,066 | 153 | 275 | 1 | 51.47 | 14.33 | 4 | 64.01 | 58 | 100 | 58 | 0 | 49 | 2,196,106 | 35 | 66 | 1,104,000 | 32.31 | 16 | 66 | 0 | 58 | 
| regex_program | 2 | 163 | 537 | 11,579,064 | 128,513,066 | 163 | 275 | 1 | 51.94 | 15.53 | 4 | 66.23 | 62 | 94 | 62 | 0 | 49 | 2,177,334 | 28 | 58 | 1,104,000 | 32.77 | 16 | 68 | 0 | 62 | 
| regex_program | 3 | 182 | 527 | 11,853,872 | 103,456,394 | 182 | 258 | 0 | 69.16 | 12.14 | 5 | 54.77 | 51 | 76 | 50 | 0 | 48 | 2,422,606 | 19 | 45 | 826,502 | 32.68 | 18 | 82 | 1 | 50 | 

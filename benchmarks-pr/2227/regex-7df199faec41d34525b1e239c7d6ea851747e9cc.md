...
| `total_proof_time_ms ` |  600.75 |  2,403 |  755 |  546 |
...
| `execute_metered_insn_mi/s` |  116.98 | -          |  116.98 |  116.98 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  53.50 |  214 |  65 |  45 |
| `execute_preflight_insn_mi/s` |  31.69 | -          |  32.80 |  28.59 |
| `trace_gen_time_ms   ` |  182.75 |  731 |  216 |  160 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  297.25 |  1,189 |  349 |  272 |
| `main_trace_commit_time_ms` |  52.25 |  209 |  58 |  50 |
| `generate_perm_trace_time_ms` |  35 |  140 |  55 |  19 |
| `perm_trace_commit_time_ms` |  65.43 |  261.73 |  71.67 |  56.68 |
| `quotient_poly_compute_time_ms` |  59.30 |  237.22 |  70.37 |  53.55 |
| `quotient_poly_commit_time_ms` |  15.34 |  61.36 |  17.71 |  12.79 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 547 | 66 | 1 | 35 | 4,137,502 | 116.98 | 192 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 216 | 755 | 23,446,148 | 150,778,428 | 216 | 349 | 0 | 59.68 | 17.71 | 5 | 71.67 | 84 | 128 | 84 | 4 | 58 | 10,899,170 | 55 | 45 | 1,103,000 | 28.59 | 22 | 78 | 1 | 84 | 
| regex_program | 1 | 160 | 555 | 11,598,276 | 128,513,066 | 160 | 289 | 1 | 53.62 | 15.36 | 4 | 65.68 | 64 | 104 | 63 | 0 | 50 | 2,196,106 | 38 | 65 | 1,104,000 | 32.63 | 17 | 69 | 0 | 63 | 
| regex_program | 2 | 167 | 546 | 11,579,064 | 128,513,066 | 167 | 279 | 1 | 53.55 | 15.49 | 4 | 67.70 | 62 | 96 | 62 | 0 | 50 | 2,177,334 | 28 | 59 | 1,104,000 | 32.72 | 16 | 69 | 0 | 62 | 
| regex_program | 3 | 188 | 547 | 11,853,872 | 103,456,394 | 188 | 272 | 0 | 70.37 | 12.79 | 5 | 56.68 | 57 | 79 | 57 | 0 | 51 | 2,422,606 | 19 | 45 | 826,502 | 32.80 | 18 | 84 | 1 | 57 | 

...
| `total_proof_time_ms ` |  590 |  2,360 |  746 |  532 |
...
| `execute_preflight_insn_mi/s` |  31.58 | -          |  32.83 |  28.52 |
| `trace_gen_time_ms   ` |  176.50 |  706 |  212 |  153 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  291 |  1,164 |  343 |  263 |
| `main_trace_commit_time_ms` |  51.50 |  206 |  56 |  50 |
| `generate_perm_trace_time_ms` |  34.75 |  139 |  55 |  19 |
| `perm_trace_commit_time_ms` |  63.86 |  255.43 |  70.03 |  55.76 |
| `quotient_poly_compute_time_ms` |  57.66 |  230.64 |  68.65 |  51.07 |
| `quotient_poly_commit_time_ms` |  14.85 |  59.40 |  17.07 |  12.82 |
| `pcs_opening_time_ms ` |  64.75 |  259 |  82 |  52 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 532 | 66 | 1 | 35 | 4,137,502 | 116.45 | 194 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 212 | 746 | 23,446,148 | 150,778,428 | 212 | 343 | 0 | 59.26 | 17.07 | 5 | 70.03 | 82 | 126 | 82 | 4 | 56 | 10,899,170 | 55 | 45 | 1,103,000 | 28.52 | 21 | 77 | 1 | 82 | 
| regex_program | 1 | 153 | 547 | 11,598,276 | 128,513,066 | 153 | 285 | 1 | 51.07 | 15.01 | 5 | 65.04 | 63 | 104 | 63 | 0 | 50 | 2,196,106 | 38 | 67 | 1,104,000 | 32.60 | 17 | 66 | 0 | 63 | 
| regex_program | 2 | 161 | 535 | 11,579,064 | 128,513,066 | 161 | 273 | 1 | 51.66 | 14.49 | 5 | 64.60 | 62 | 92 | 62 | 0 | 50 | 2,177,334 | 27 | 59 | 1,104,000 | 32.83 | 16 | 66 | 0 | 62 | 
| regex_program | 3 | 180 | 532 | 11,853,872 | 103,456,394 | 180 | 263 | 0 | 68.65 | 12.82 | 5 | 55.76 | 52 | 77 | 51 | 0 | 50 | 2,422,606 | 19 | 46 | 826,502 | 32.36 | 18 | 82 | 1 | 51 | 
...
Commit: https://github.com/openvm-org/openvm/commit/719996cf25303fcec1c22cd7201361ea4fc96144
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19337109399)

...
|:---|---:|---:|
| Total |  2.39 |  0.78 |
| regex_program |  2.35 |  0.75 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  588.50 |  2,354 |  747 |  530 |
...
| `execute_preflight_insn_mi/s` |  29.41 | -          |  30.61 |  26.60 |
| `trace_gen_time_ms   ` |  175.50 |  702 |  211 |  153 |
| `memory_finalize_time_ms` |  0.75 |  3 |  3 |  0 |
| `stark_prove_excluding_trace_time_ms` |  290.50 |  1,162 |  345 |  261 |
| `main_trace_commit_time_ms` |  50.75 |  203 |  56 |  49 |
| `generate_perm_trace_time_ms` |  35.25 |  141 |  56 |  19 |
| `perm_trace_commit_time_ms` |  63.39 |  253.57 |  69.10 |  54.45 |
| `quotient_poly_compute_time_ms` |  58.61 |  234.45 |  70.39 |  52.03 |
| `quotient_poly_commit_time_ms` |  15.15 |  60.61 |  18.07 |  12.52 |
| `pcs_opening_time_ms ` |  64.50 |  258 |  83 |  51 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 530 | 66 | 1 | 36 | 4,137,502 | 114.47 | 192 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 211 | 747 | 23,446,148 | 150,778,428 | 211 | 345 | 0 | 59.87 | 18.07 | 5 | 69.10 | 83 | 126 | 83 | 3 | 56 | 10,899,170 | 56 | 46 | 1,103,000 | 26.60 | 21 | 78 | 1 | 83 | 
| regex_program | 1 | 153 | 543 | 11,598,276 | 128,513,066 | 153 | 281 | 1 | 52.03 | 14.40 | 4 | 63.90 | 62 | 102 | 62 | 0 | 49 | 2,196,106 | 38 | 66 | 1,104,000 | 30.56 | 16 | 66 | 0 | 62 | 
| regex_program | 2 | 157 | 534 | 11,579,064 | 128,513,066 | 157 | 275 | 1 | 52.16 | 15.63 | 4 | 66.12 | 62 | 94 | 62 | 0 | 49 | 2,177,334 | 28 | 60 | 1,104,000 | 29.89 | 16 | 68 | 0 | 62 | 
| regex_program | 3 | 181 | 530 | 11,853,872 | 103,456,394 | 181 | 261 | 0 | 70.39 | 12.52 | 5 | 54.45 | 51 | 76 | 51 | 0 | 49 | 2,422,606 | 19 | 47 | 826,502 | 30.61 | 18 | 83 | 1 | 51 | 
...
Commit: https://github.com/openvm-org/openvm/commit/3bc489fd9d401cd31c3378701303287c5015b9f6
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19323964079)

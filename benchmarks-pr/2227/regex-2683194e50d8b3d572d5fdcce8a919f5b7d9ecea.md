...
|:---|---:|---:|
| Total |  2.41 |  0.75 |
| regex_program |  2.37 |  0.71 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  593 |  2,372 |  714 |  546 |
...
| `execute_metered_insn_mi/s` |  112.88 | -          |  112.88 |  112.88 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  55.25 |  221 |  68 |  46 |
| `execute_preflight_insn_mi/s` |  30.32 | -          |  31.77 |  27.60 |
| `trace_gen_time_ms   ` |  181.50 |  726 |  215 |  159 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  288.75 |  1,155 |  308 |  274 |
| `main_trace_commit_time_ms` |  53 |  212 |  58 |  50 |
| `generate_perm_trace_time_ms` |  31.50 |  126 |  41 |  20 |
| `perm_trace_commit_time_ms` |  65.25 |  261.01 |  71.81 |  55.83 |
| `quotient_poly_compute_time_ms` |  60.88 |  243.53 |  73.01 |  54.17 |
| `quotient_poly_commit_time_ms` |  15.48 |  61.91 |  17.55 |  13.20 |
| `pcs_opening_time_ms ` |  59.25 |  237 |  63 |  55 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 550 | 66 | 1 | 36 | 4,137,502 | 112.88 | 194 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 215 | 714 | 23,446,148 | 150,778,428 | 215 | 308 | 0 | 61.72 | 17.55 | 5 | 71.81 | 55 | 114 | 55 | 4 | 58 | 10,899,170 | 41 | 46 | 1,103,000 | 27.60 | 21 | 79 | 1 | 55 | 
| regex_program | 1 | 159 | 562 | 11,598,276 | 128,513,066 | 159 | 294 | 1 | 54.62 | 15.95 | 5 | 67.31 | 63 | 106 | 63 | 0 | 52 | 2,196,106 | 38 | 68 | 1,104,000 | 31.73 | 17 | 71 | 0 | 63 | 
| regex_program | 2 | 166 | 546 | 11,579,064 | 128,513,066 | 166 | 279 | 1 | 54.17 | 15.22 | 4 | 66.06 | 62 | 94 | 62 | 0 | 52 | 2,177,334 | 27 | 59 | 1,104,000 | 31.77 | 17 | 69 | 0 | 62 | 
| regex_program | 3 | 186 | 550 | 11,853,872 | 103,456,394 | 186 | 274 | 0 | 73.01 | 13.20 | 5 | 55.83 | 57 | 79 | 56 | 0 | 50 | 2,422,606 | 20 | 48 | 826,502 | 30.19 | 18 | 87 | 1 | 56 | 
...
Commit: https://github.com/openvm-org/openvm/commit/2683194e50d8b3d572d5fdcce8a919f5b7d9ecea
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19312776619)

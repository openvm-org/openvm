...
| `total_proof_time_ms ` |  588 |  2,352 |  743 |  523 |
...
| `execute_metered_insn_mi/s` |  115.82 | -          |  115.82 |  115.82 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  52.75 |  211 |  64 |  44 |
| `execute_preflight_insn_mi/s` |  31.08 | -          |  32.28 |  28.31 |
| `trace_gen_time_ms   ` |  178.75 |  715 |  210 |  157 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  288.50 |  1,154 |  343 |  260 |
| `main_trace_commit_time_ms` |  51.50 |  206 |  56 |  49 |
| `generate_perm_trace_time_ms` |  34.75 |  139 |  55 |  19 |
| `perm_trace_commit_time_ms` |  64.49 |  257.97 |  70.37 |  55.67 |
| `quotient_poly_compute_time_ms` |  58.14 |  232.56 |  69.54 |  51.89 |
| `quotient_poly_commit_time_ms` |  15.32 |  61.29 |  16.96 |  12.90 |
| `pcs_opening_time_ms ` |  60.75 |  243 |  82 |  47 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 535 | 66 | 1 | 35 | 4,137,502 | 115.82 | 194 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 210 | 743 | 23,446,148 | 150,778,428 | 209 | 343 | 0 | 58.99 | 16.96 | 5 | 70.37 | 82 | 126 | 82 | 4 | 56 | 10,899,170 | 55 | 44 | 1,103,000 | 28.31 | 21 | 76 | 1 | 82 | 
| regex_program | 1 | 157 | 551 | 11,598,276 | 128,513,066 | 157 | 288 | 1 | 51.89 | 15.66 | 4 | 65.88 | 63 | 104 | 63 | 0 | 51 | 2,196,106 | 38 | 64 | 1,104,000 | 32.28 | 17 | 68 | 0 | 63 | 
| regex_program | 2 | 163 | 523 | 11,579,064 | 128,513,066 | 163 | 260 | 1 | 52.14 | 15.76 | 4 | 66.05 | 47 | 94 | 47 | 0 | 49 | 2,177,334 | 27 | 58 | 1,104,000 | 31.58 | 17 | 68 | 0 | 47 | 
| regex_program | 3 | 185 | 535 | 11,853,872 | 103,456,394 | 185 | 263 | 0 | 69.54 | 12.90 | 5 | 55.67 | 51 | 78 | 51 | 0 | 50 | 2,422,606 | 19 | 45 | 826,502 | 32.16 | 18 | 83 | 1 | 51 | 

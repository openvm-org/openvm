...
|:---|---:|---:|
| Total |  2.43 |  0.79 |
| regex_program |  2.39 |  0.75 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  598.50 |  2,394 |  754 |  543 |
...
| `execute_metered_insn_mi/s` |  108.22 | -          |  108.22 |  108.22 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  57.25 |  229 |  73 |  46 |
| `execute_preflight_insn_mi/s` |  31.10 | -          |  32.62 |  27.76 |
| `trace_gen_time_ms   ` |  176.25 |  705 |  211 |  150 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  297 |  1,188 |  349 |  272 |
| `main_trace_commit_time_ms` |  51.75 |  207 |  57 |  50 |
| `generate_perm_trace_time_ms` |  35.50 |  142 |  56 |  20 |
| `perm_trace_commit_time_ms` |  64.83 |  259.34 |  70.43 |  56.26 |
| `quotient_poly_compute_time_ms` |  59.16 |  236.65 |  70.04 |  52.18 |
| `quotient_poly_commit_time_ms` |  15.68 |  62.71 |  18.13 |  13.22 |
| `pcs_opening_time_ms ` |  66.75 |  267 |  84 |  57 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 543 | 1 | 38 | 4,137,502 | 108.22 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 211 | 754 | 23,446,148 | 150,778,428 | 211 | 349 | 0 | 61.08 | 18.13 | 5 | 70.43 | 84 | 127 | 83 | 4 | 57 | 10,899,170 | 56 | 48 | 1,103,000 | 27.76 | 21 | 79 | 1 | 83 | 
| regex_program | 1 | 150 | 554 | 11,598,276 | 128,513,066 | 150 | 289 | 1 | 52.18 | 15.67 | 5 | 65.72 | 64 | 105 | 64 | 0 | 50 | 2,196,106 | 38 | 73 | 1,104,000 | 31.94 | 17 | 68 | 0 | 64 | 
| regex_program | 2 | 161 | 543 | 11,579,064 | 128,513,066 | 161 | 278 | 1 | 53.35 | 15.70 | 4 | 66.94 | 62 | 95 | 62 | 0 | 50 | 2,177,334 | 28 | 62 | 1,104,000 | 32.62 | 16 | 69 | 0 | 62 | 
| regex_program | 3 | 183 | 543 | 11,853,872 | 103,456,394 | 183 | 272 | 0 | 70.04 | 13.22 | 5 | 56.26 | 57 | 79 | 57 | 0 | 50 | 2,422,606 | 20 | 46 | 826,502 | 32.09 | 18 | 84 | 1 | 57 | 

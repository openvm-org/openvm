...
|:---|---:|---:|---:|
| Total |  1.11 |  0.66 | 0.66 |
| fibonacci_program |  1.11 |  0.66 |  0.66 |


| fibonacci_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  549.50 |  1,099 |  647 |  452 |
...
| `execute_metered_insn_mi/s` |  110.82 | -          |  110.82 |  110.82 |
| `execute_preflight_insns` |  750,104.50 |  1,500,209 |  873,000 |  627,209 |
| `execute_preflight_time_ms` |  28.50 |  57 |  32 |  25 |
| `execute_preflight_insn_mi/s` |  38.25 | -          |  40.59 |  35.91 |
| `trace_gen_time_ms   ` |  195.50 |  391 |  202 |  189 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  220 |  440 |  250 |  190 |
| `main_trace_commit_time_ms` |  30.50 |  61 |  33 |  28 |
| `generate_perm_trace_time_ms` |  32 |  64 |  39 |  25 |
| `perm_trace_commit_time_ms` |  40.76 |  81.52 |  43.29 |  38.22 |
| `quotient_poly_compute_time_ms` |  33.03 |  66.07 |  35.42 |  30.65 |
| `quotient_poly_commit_time_ms` |  12.53 |  25.07 |  12.56 |  12.51 |
| `pcs_opening_time_ms ` |  69.50 |  139 |  99 |  40 |
...
| --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 452 | 1 | 13 | 1,500,209 | 110.82 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 202 | 647 | 9,677,708 | 84,395,212 | 202 | 250 | 0 | 35.42 | 12.56 | 4 | 43.29 | 99 | 69 | 99 | 0 | 33 | 1,035,986 | 25 | 25 | 873,000 | 35.91 | 14 | 48 | 0 | 99 | 
| fibonacci_program | 1 | 189 | 452 | 9,708,170 | 74,305,770 | 189 | 190 | 1 | 30.65 | 12.51 | 4 | 38.22 | 40 | 78 | 39 | 0 | 28 | 1,064,416 | 39 | 32 | 627,209 | 40.59 | 11 | 43 | 0 | 39 | 

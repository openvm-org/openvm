...
|:---|---:|---:|
| Total | <span style='color: red'>(+0 [+2.2%])</span> 2.44 | <span style='color: red'>(+0 [+4.0%])</span> 0.79 |
| regex_program | <span style='color: red'>(+0 [+2.3%])</span> 2.40 | <span style='color: red'>(+0 [+4.5%])</span> 0.75 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+14 [+2.3%])</span> 600.75 | <span style='color: red'>(+54 [+2.3%])</span> 2,403 | <span style='color: red'>(+32 [+4.5%])</span> 749 | <span style='color: green'>(-14 [-2.6%])</span> 528 |
...
| `execute_metered_insn_mi/s` | <span style='color: red'>(+6 [+5.5%])</span> 113.53 | -          | <span style='color: red'>(+6 [+5.5%])</span> 113.53 | <span style='color: red'>(+6 [+5.5%])</span> 113.53 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` | <span style='color: red'>(+1 [+1.9%])</span> 53.75 | <span style='color: red'>(+4 [+1.9%])</span> 215 |  65 | <span style='color: red'>(+1 [+2.3%])</span> 45 |
| `execute_preflight_insn_mi/s` | <span style='color: green'>(-1 [-4.2%])</span> 30.96 | -          | <span style='color: green'>(-2 [-5.0%])</span> 32.07 | <span style='color: green'>(-1 [-3.4%])</span> 28.17 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+2 [+1.0%])</span> 179 | <span style='color: red'>(+7 [+1.0%])</span> 716 | <span style='color: red'>(+2 [+0.9%])</span> 214 | <span style='color: red'>(+2 [+1.3%])</span> 156 |
| `memory_finalize_time_ms` |  1 |  4 |  4 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+10 [+3.5%])</span> 293.50 | <span style='color: red'>(+40 [+3.5%])</span> 1,174 | <span style='color: red'>(+27 [+9.3%])</span> 318 | <span style='color: green'>(-9 [-3.3%])</span> 265 |
...
| `generate_perm_trace_time_ms` | <span style='color: red'>(+5 [+20.2%])</span> 28.25 | <span style='color: red'>(+19 [+20.2%])</span> 113 | <span style='color: red'>(+10 [+34.5%])</span> 39 | <span style='color: red'>(+2 [+10.0%])</span> 22 |
| `perm_trace_commit_time_ms` | <span style='color: red'>(+1 [+2.0%])</span> 64.83 | <span style='color: red'>(+5 [+2.0%])</span> 259.32 | <span style='color: red'>(+3 [+4.2%])</span> 71.42 | <span style='color: red'>(+0 [+0.7%])</span> 55.28 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+4 [+6.2%])</span> 60.73 | <span style='color: red'>(+14 [+6.2%])</span> 242.91 | <span style='color: red'>(+3 [+4.3%])</span> 71.35 | <span style='color: red'>(+2 [+3.6%])</span> 54.15 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+0 [+0.9%])</span> 15.75 | <span style='color: red'>(+1 [+0.9%])</span> 63.01 | <span style='color: green'>(-1 [-4.5%])</span> 17.72 | <span style='color: red'>(+0 [+2.4%])</span> 13.30 |
| `pcs_opening_time_ms ` | <span style='color: green'>(-1 [-1.1%])</span> 68.75 | <span style='color: green'>(-3 [-1.1%])</span> 275 | <span style='color: red'>(+6 [+7.9%])</span> 82 | <span style='color: green'>(-10 [-15.9%])</span> 53 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 568 | 1 | 36 | 4,137,502 | 113.53 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 214 | 749 | 23,446,148 | 150,778,428 | 214 | 318 | 0 | 62.92 | 17.72 | 5 | 71.42 | 82 | 96 | 82 | 4 | 58 | 10,899,170 | 23 | 46 | 1,103,000 | 28.17 | 21 | 81 | 0 | 82 | 
| regex_program | 1 | 156 | 528 | 11,598,276 | 128,513,066 | 156 | 265 | 1 | 54.49 | 15.61 | 4 | 66.33 | 53 | 89 | 53 | 0 | 51 | 2,196,106 | 22 | 65 | 1,104,000 | 32.07 | 17 | 70 | 0 | 53 | 
| regex_program | 2 | 163 | 558 | 11,579,064 | 128,513,066 | 163 | 294 | 1 | 54.15 | 16.39 | 4 | 66.29 | 76 | 96 | 75 | 0 | 50 | 2,177,334 | 29 | 59 | 1,104,000 | 31.62 | 17 | 71 | 0 | 75 | 
| regex_program | 3 | 183 | 568 | 11,853,872 | 103,456,394 | 183 | 297 | 0 | 71.35 | 13.30 | 5 | 55.28 | 64 | 97 | 64 | 0 | 49 | 2,422,606 | 39 | 45 | 826,502 | 31.99 | 18 | 85 | 0 | 64 | 

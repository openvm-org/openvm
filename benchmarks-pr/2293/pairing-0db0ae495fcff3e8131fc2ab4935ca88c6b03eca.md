...
|:---|---:|---:|
| Total | <span style='color: red'>(+0 [+1.4%])</span> 1.53 | <span style='color: red'>(+0 [+1.0%])</span> 0.92 |
| pairing | <span style='color: red'>(+0 [+1.5%])</span> 1.47 | <span style='color: red'>(+0 [+1.2%])</span> 0.85 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+11 [+1.5%])</span> 733 | <span style='color: red'>(+22 [+1.5%])</span> 1,466 | <span style='color: red'>(+10 [+1.2%])</span> 854 | <span style='color: red'>(+12 [+2.0%])</span> 612 |
| `main_cells_used     ` |  12,704,151 |  25,408,302 |  15,909,408 |  9,498,894 |
| `total_cells_used    ` |  27,472,173 |  54,944,346 |  32,480,114 |  22,464,232 |
| `execute_metered_time_ms` | <span style='color: green'>(-1 [-1.4%])</span> 68 | -          | -          | -          |
| `execute_metered_insn_mi/s` | <span style='color: red'>(+0 [+1.4%])</span> 25.56 | -          | <span style='color: red'>(+0 [+1.4%])</span> 25.56 | <span style='color: red'>(+0 [+1.4%])</span> 25.56 |
...
| `execute_preflight_insn_mi/s` | <span style='color: green'>(-0 [-2.0%])</span> 14.35 | -          | <span style='color: green'>(-1 [-3.3%])</span> 17.80 | <span style='color: red'>(+0 [+0.1%])</span> 10.91 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+1 [+0.5%])</span> 187 | <span style='color: red'>(+2 [+0.5%])</span> 374 | <span style='color: green'>(-1 [-0.5%])</span> 191 | <span style='color: red'>(+3 [+1.7%])</span> 183 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+8 [+2.2%])</span> 354 | <span style='color: red'>(+15 [+2.2%])</span> 708 | <span style='color: red'>(+5 [+1.3%])</span> 391 | <span style='color: red'>(+10 [+3.3%])</span> 317 |
| `main_trace_commit_time_ms` | <span style='color: red'>(+0 [+0.8%])</span> 64.50 | <span style='color: red'>(+1 [+0.8%])</span> 129 | <span style='color: green'>(-1 [-1.3%])</span> 74 | <span style='color: red'>(+2 [+3.8%])</span> 55 |
| `generate_perm_trace_time_ms` | <span style='color: red'>(+4 [+12.3%])</span> 36.50 | <span style='color: red'>(+8 [+12.3%])</span> 73 | <span style='color: red'>(+3 [+8.3%])</span> 39 | <span style='color: red'>(+5 [+17.2%])</span> 34 |
| `perm_trace_commit_time_ms` | <span style='color: green'>(-3 [-3.5%])</span> 74.34 | <span style='color: green'>(-5 [-3.5%])</span> 148.69 | <span style='color: green'>(-6 [-6.4%])</span> 83.62 | <span style='color: red'>(+0 [+0.5%])</span> 65.07 |
| `quotient_poly_compute_time_ms` | <span style='color: green'>(-1 [-0.9%])</span> 82.09 | <span style='color: green'>(-1 [-0.9%])</span> 164.18 | <span style='color: green'>(-2 [-2.1%])</span> 89.91 | <span style='color: red'>(+1 [+0.7%])</span> 74.27 |
| `quotient_poly_commit_time_ms` | <span style='color: green'>(-0 [-0.7%])</span> 17.51 | <span style='color: green'>(-0 [-0.7%])</span> 35.02 | <span style='color: green'>(-0 [-0.3%])</span> 19.76 | <span style='color: green'>(-0 [-1.4%])</span> 15.26 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+6 [+9.6%])</span> 74 | <span style='color: red'>(+13 [+9.6%])</span> 148 | <span style='color: red'>(+10 [+14.5%])</span> 79 | <span style='color: red'>(+3 [+4.5%])</span> 69 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 612 | 1 | 68 | 1,745,742 | 25.56 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 183 | 854 | 32,480,114 | 172,558,444 | 183 | 391 | 0 | 89.91 | 19.76 | 6 | 83.62 | 79 | 126 | 79 | 1 | 74 | 15,909,408 | 39 | 109 | 1,149,000 | 10.91 | 27 | 110 | 1 | 79 | 
| pairing | 1 | 191 | 612 | 22,464,232 | 119,958,502 | 191 | 317 | 1 | 74.27 | 15.26 | 6 | 65.07 | 69 | 101 | 69 | 0 | 55 | 9,498,894 | 34 | 62 | 596,742 | 17.80 | 20 | 90 | 1 | 69 | 

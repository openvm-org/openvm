...
|:---|---:|---:|
| Total | <span style='color: red'>(+0 [+2.7%])</span> 2.44 | <span style='color: red'>(+0 [+3.1%])</span> 0.77 |
| regex_program | <span style='color: red'>(+0 [+2.7%])</span> 2.40 | <span style='color: red'>(+0 [+3.1%])</span> 0.74 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+16 [+2.7%])</span> 599.75 | <span style='color: red'>(+62 [+2.7%])</span> 2,399 | <span style='color: red'>(+22 [+3.1%])</span> 737 | <span style='color: green'>(-2 [-0.4%])</span> 538 |
...
| `execute_metered_insn_mi/s` | <span style='color: green'>(-4 [-3.4%])</span> 109.26 | -          | <span style='color: green'>(-4 [-3.4%])</span> 109.26 | <span style='color: green'>(-4 [-3.4%])</span> 109.26 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` | <span style='color: red'>(+3 [+6.2%])</span> 55.50 | <span style='color: red'>(+13 [+6.2%])</span> 222 | <span style='color: red'>(+5 [+7.9%])</span> 68 | <span style='color: red'>(+2 [+4.5%])</span> 46 |
| `execute_preflight_insn_mi/s` | <span style='color: green'>(-2 [-4.8%])</span> 30.64 | -          | <span style='color: green'>(-1 [-4.3%])</span> 31.87 | <span style='color: green'>(-1 [-3.9%])</span> 27.96 |
| `trace_gen_time_ms   ` | <span style='color: green'>(-0 [-0.1%])</span> 179 | <span style='color: green'>(-1 [-0.1%])</span> 716 | <span style='color: red'>(+4 [+1.9%])</span> 214 | <span style='color: green'>(-3 [-1.9%])</span> 155 |
| `memory_finalize_time_ms` |  1 |  4 |  4 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+12 [+4.4%])</span> 291.50 | <span style='color: red'>(+49 [+4.4%])</span> 1,166 | <span style='color: red'>(+15 [+5.2%])</span> 306 | <span style='color: red'>(+5 [+1.9%])</span> 274 |
| `main_trace_commit_time_ms` | <span style='color: red'>(+0 [+0.5%])</span> 52 | <span style='color: red'>(+1 [+0.5%])</span> 208 | <span style='color: red'>(+1 [+1.8%])</span> 57 |  49 |
| `generate_perm_trace_time_ms` | <span style='color: red'>(+9 [+34.3%])</span> 35.25 | <span style='color: red'>(+36 [+34.3%])</span> 141 | <span style='color: red'>(+16 [+44.4%])</span> 52 | <span style='color: red'>(+8 [+42.1%])</span> 27 |
| `perm_trace_commit_time_ms` | <span style='color: red'>(+0 [+0.1%])</span> 64.58 | <span style='color: red'>(+0 [+0.1%])</span> 258.32 | <span style='color: green'>(-1 [-0.9%])</span> 71.13 | <span style='color: red'>(+1 [+1.0%])</span> 55.67 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+1 [+2.4%])</span> 60.73 | <span style='color: red'>(+6 [+2.4%])</span> 242.91 | <span style='color: red'>(+1 [+0.8%])</span> 70.67 | <span style='color: red'>(+1 [+1.5%])</span> 53.89 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+1 [+3.5%])</span> 16.28 | <span style='color: red'>(+2 [+3.5%])</span> 65.11 | <span style='color: red'>(+1 [+4.2%])</span> 18.26 | <span style='color: red'>(+1 [+5.8%])</span> 13.85 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+1 [+1.3%])</span> 59.25 | <span style='color: red'>(+3 [+1.3%])</span> 237 | <span style='color: red'>(+4 [+6.5%])</span> 66 | <span style='color: green'>(-2 [-3.7%])</span> 52 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 564 | 1 | 37 | 4,137,502 | 109.26 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 214 | 737 | 23,446,148 | 150,778,428 | 214 | 306 | 0 | 63.62 | 18.26 | 5 | 71.13 | 66 | 99 | 65 | 4 | 57 | 10,899,170 | 27 | 46 | 1,103,000 | 27.96 | 22 | 82 | 0 | 65 | 
| regex_program | 1 | 155 | 560 | 11,598,276 | 128,513,066 | 155 | 295 | 1 | 54.73 | 16.42 | 4 | 66.09 | 52 | 118 | 52 | 0 | 51 | 2,196,106 | 52 | 68 | 1,104,000 | 31.87 | 17 | 71 | 0 | 52 | 
| regex_program | 2 | 162 | 538 | 11,579,064 | 128,513,066 | 162 | 274 | 1 | 53.89 | 16.58 | 5 | 65.43 | 56 | 95 | 56 | 0 | 51 | 2,177,334 | 29 | 61 | 1,104,000 | 30.95 | 17 | 71 | 0 | 56 | 
| regex_program | 3 | 185 | 564 | 11,853,872 | 103,456,394 | 185 | 291 | 0 | 70.67 | 13.85 | 5 | 55.67 | 63 | 92 | 63 | 0 | 49 | 2,422,606 | 33 | 47 | 826,502 | 31.76 | 19 | 85 | 0 | 63 | 

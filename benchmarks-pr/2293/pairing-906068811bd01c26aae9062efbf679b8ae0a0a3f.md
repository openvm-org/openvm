...
|:---|---:|---:|
| Total | <span style='color: green'>(-0 [-0.5%])</span> 1.55 | <span style='color: green'>(-0 [-0.1%])</span> 0.94 |
| pairing | <span style='color: green'>(-0 [-0.4%])</span> 1.48 |  0.88 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: green'>(-3 [-0.4%])</span> 742 | <span style='color: green'>(-6 [-0.4%])</span> 1,484 |  880 | <span style='color: green'>(-6 [-1.0%])</span> 604 |
...
| `execute_metered_insn_mi/s` | <span style='color: red'>(+1 [+1.9%])</span> 27.88 | -          | <span style='color: red'>(+1 [+1.9%])</span> 27.88 | <span style='color: red'>(+1 [+1.9%])</span> 27.88 |
| `execute_preflight_insns` |  872,871 |  1,745,742 |  1,149,000 |  596,742 |
| `execute_preflight_time_ms` |  82.50 |  165 |  105 |  60 |
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+0 [+1.1%])</span> 14.84 | -          | <span style='color: red'>(+0 [+1.9%])</span> 18.40 | <span style='color: green'>(-0 [-0.3%])</span> 11.29 |
| `trace_gen_time_ms   ` |  193 |  386 |  197 |  189 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: green'>(-4 [-1.2%])</span> 360 | <span style='color: green'>(-9 [-1.2%])</span> 720 | <span style='color: green'>(-3 [-0.7%])</span> 415 | <span style='color: green'>(-6 [-1.9%])</span> 305 |
| `main_trace_commit_time_ms` | <span style='color: green'>(-0 [-0.8%])</span> 65.50 | <span style='color: green'>(-1 [-0.8%])</span> 131 | <span style='color: green'>(-1 [-1.3%])</span> 76 |  55 |
| `generate_perm_trace_time_ms` | <span style='color: green'>(-6 [-12.9%])</span> 40.50 | <span style='color: green'>(-12 [-12.9%])</span> 81 | <span style='color: green'>(-7 [-13.0%])</span> 47 | <span style='color: green'>(-5 [-12.8%])</span> 34 |
| `perm_trace_commit_time_ms` |  77.31 |  154.63 | <span style='color: green'>(-1 [-0.8%])</span> 89.51 | <span style='color: red'>(+1 [+0.9%])</span> 65.12 |
| `quotient_poly_compute_time_ms` | <span style='color: green'>(-0 [-0.1%])</span> 84.50 | <span style='color: green'>(-0 [-0.1%])</span> 168.99 | <span style='color: red'>(+2 [+2.5%])</span> 95.39 | <span style='color: green'>(-3 [-3.4%])</span> 73.61 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+0 [+1.0%])</span> 17.78 | <span style='color: red'>(+0 [+1.0%])</span> 35.56 | <span style='color: red'>(+0 [+0.4%])</span> 20.23 | <span style='color: red'>(+0 [+1.9%])</span> 15.33 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+2 [+2.9%])</span> 70 | <span style='color: red'>(+4 [+2.9%])</span> 140 | <span style='color: red'>(+4 [+5.1%])</span> 83 |  57 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 604 | 1 | 62 | 1,745,742 | 27.88 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 189 | 880 | 32,480,114 | 172,558,444 | 189 | 415 | 0 | 95.39 | 20.23 | 7 | 89.51 | 83 | 139 | 82 | 1 | 76 | 15,909,408 | 47 | 105 | 1,149,000 | 11.29 | 27 | 116 | 1 | 82 | 
| pairing | 1 | 197 | 604 | 22,464,232 | 119,958,502 | 197 | 305 | 1 | 73.61 | 15.33 | 6 | 65.12 | 57 | 102 | 57 | 0 | 55 | 9,498,894 | 34 | 60 | 596,742 | 18.40 | 21 | 89 | 1 | 57 | 

...
|:---|---:|---:|
| Total | <span style='color: green'>(-0 [-0.3%])</span> 1.51 | <span style='color: red'>(+0 [+0.4%])</span> 0.92 |
| pairing | <span style='color: green'>(-0 [-0.3%])</span> 1.44 | <span style='color: red'>(+0 [+0.5%])</span> 0.85 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: green'>(-2 [-0.3%])</span> 719.50 | <span style='color: green'>(-5 [-0.3%])</span> 1,439 | <span style='color: red'>(+4 [+0.5%])</span> 848 | <span style='color: green'>(-9 [-1.5%])</span> 591 |
...
| `execute_preflight_time_ms` | <span style='color: red'>(+2 [+3.0%])</span> 86 | <span style='color: red'>(+5 [+3.0%])</span> 172 | <span style='color: red'>(+3 [+2.8%])</span> 111 | <span style='color: red'>(+2 [+3.4%])</span> 61 |
| `execute_preflight_insn_mi/s` | <span style='color: green'>(-0 [-1.7%])</span> 14.40 | -          | <span style='color: green'>(-0 [-1.9%])</span> 18.06 | <span style='color: green'>(-0 [-1.4%])</span> 10.75 |
| `trace_gen_time_ms   ` | <span style='color: green'>(-5 [-2.7%])</span> 181 | <span style='color: green'>(-10 [-2.7%])</span> 362 | <span style='color: green'>(-5 [-2.6%])</span> 187 | <span style='color: green'>(-5 [-2.8%])</span> 175 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: green'>(-0 [-0.1%])</span> 346 | <span style='color: green'>(-1 [-0.1%])</span> 692 | <span style='color: red'>(+6 [+1.6%])</span> 392 | <span style='color: green'>(-7 [-2.3%])</span> 300 |
| `main_trace_commit_time_ms` | <span style='color: green'>(-0 [-0.8%])</span> 63.50 | <span style='color: green'>(-1 [-0.8%])</span> 127 | <span style='color: green'>(-2 [-2.7%])</span> 73 | <span style='color: red'>(+1 [+1.9%])</span> 54 |
...
| `perm_trace_commit_time_ms` | <span style='color: green'>(-1 [-1.5%])</span> 75.86 | <span style='color: green'>(-2 [-1.5%])</span> 151.71 | <span style='color: green'>(-2 [-2.0%])</span> 87.50 | <span style='color: green'>(-1 [-0.9%])</span> 64.21 |
| `quotient_poly_compute_time_ms` | <span style='color: green'>(-1 [-1.5%])</span> 81.55 | <span style='color: green'>(-3 [-1.5%])</span> 163.09 | <span style='color: green'>(-2 [-1.7%])</span> 90.33 | <span style='color: green'>(-1 [-1.3%])</span> 72.76 |
| `quotient_poly_commit_time_ms` | <span style='color: green'>(-1 [-6.8%])</span> 16.43 | <span style='color: green'>(-2 [-6.8%])</span> 32.87 | <span style='color: green'>(-2 [-10.2%])</span> 17.79 | <span style='color: green'>(-0 [-2.5%])</span> 15.08 |
| `pcs_opening_time_ms ` | <span style='color: green'>(-0 [-0.7%])</span> 67 | <span style='color: green'>(-1 [-0.7%])</span> 134 | <span style='color: red'>(+10 [+14.5%])</span> 79 | <span style='color: green'>(-11 [-16.7%])</span> 55 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 591 | 1 | 69 | 1,745,742 | 25.23 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 175 | 848 | 32,480,114 | 172,558,444 | 175 | 392 | 0 | 90.33 | 17.79 | 6 | 87.50 | 79 | 130 | 78 | 1 | 73 | 15,909,408 | 39 | 111 | 1,149,000 | 10.75 | 26 | 109 | 1 | 78 | 
| pairing | 1 | 187 | 591 | 22,464,232 | 119,958,502 | 187 | 300 | 1 | 72.76 | 15.08 | 6 | 64.21 | 55 | 101 | 54 | 0 | 54 | 9,498,894 | 34 | 61 | 596,742 | 18.06 | 20 | 88 | 1 | 54 | 

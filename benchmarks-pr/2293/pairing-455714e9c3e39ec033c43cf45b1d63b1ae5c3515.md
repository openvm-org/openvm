...
| `total_proof_time_ms ` |  748.50 |  1,497 |  875 |  622 |
...
| `execute_preflight_time_ms` |  86 |  172 |  109 |  63 |
| `execute_preflight_insn_mi/s` |  13.95 | -          |  17.07 |  10.82 |
| `trace_gen_time_ms   ` |  188.50 |  377 |  191 |  186 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  369 |  738 |  412 |  326 |
| `main_trace_commit_time_ms` |  64 |  128 |  75 |  53 |
| `generate_perm_trace_time_ms` |  42.50 |  85 |  44 |  41 |
| `perm_trace_commit_time_ms` |  77.39 |  154.77 |  89.87 |  64.91 |
| `quotient_poly_compute_time_ms` |  82.89 |  165.79 |  91.46 |  74.33 |
| `quotient_poly_commit_time_ms` |  17.60 |  35.21 |  19.80 |  15.41 |
| `pcs_opening_time_ms ` |  79.50 |  159 |  86 |  73 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 622 | 1 | 63 | 1,745,742 | 27.60 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 186 | 875 | 32,480,114 | 172,558,444 | 186 | 412 | 0 | 91.46 | 19.80 | 6 | 89.87 | 86 | 137 | 86 | 1 | 75 | 15,909,408 | 44 | 109 | 1,149,000 | 10.82 | 26 | 112 | 1 | 86 | 
| pairing | 1 | 191 | 622 | 22,464,232 | 119,958,502 | 191 | 326 | 1 | 74.33 | 15.41 | 6 | 64.91 | 73 | 108 | 73 | 0 | 53 | 9,498,894 | 41 | 63 | 596,742 | 17.07 | 21 | 90 | 1 | 73 | 

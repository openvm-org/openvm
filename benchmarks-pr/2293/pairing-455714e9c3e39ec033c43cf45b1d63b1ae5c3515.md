...
|:---|---:|---:|---:|
| Total |  4.52 |  2.65 | 2.65 |
| pairing |  1.60 |  0.91 |  0.91 |
| leaf |  2.92 |  1.74 |  1.74 |
...
| `total_proof_time_ms ` |  766.50 |  1,533 |  851 |  682 |
...
| `execute_preflight_insn_mi/s` |  14.58 | -          |  18.01 |  11.15 |
| `trace_gen_time_ms   ` |  186.50 |  373 |  191 |  182 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  390.50 |  781 |  393 |  388 |
| `main_trace_commit_time_ms` |  64.50 |  129 |  74 |  55 |
| `generate_perm_trace_time_ms` |  70 |  140 |  97 |  43 |
| `perm_trace_commit_time_ms` |  75.88 |  151.76 |  87.42 |  64.34 |
| `quotient_poly_compute_time_ms` |  81.82 |  163.65 |  90.54 |  73.11 |
| `quotient_poly_commit_time_ms` |  16.42 |  32.84 |  18 |  14.84 |
| `pcs_opening_time_ms ` |  76.50 |  153 |  79 |  74 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,462.50 |  2,925 |  1,735 |  1,190 |
| `main_cells_used     ` |  16,201,092 |  32,402,184 |  16,333,366 |  16,068,818 |
| `total_cells_used    ` |  39,334,296 |  78,668,592 |  39,652,244 |  39,016,348 |
| `execute_preflight_insns` |  1,952,590 |  3,905,180 |  1,992,123 |  1,913,057 |
| `execute_preflight_time_ms` |  601.50 |  1,203 |  896 |  307 |
| `execute_preflight_insn_mi/s` |  7.44 | -          |  7.46 |  7.41 |
| `trace_gen_time_ms   ` |  118 |  236 |  127 |  109 |
| `memory_finalize_time_ms` |  12.50 |  25 |  14 |  11 |
| `stark_prove_excluding_trace_time_ms` |  741.50 |  1,483 |  755 |  728 |
| `main_trace_commit_time_ms` |  144.50 |  289 |  148 |  141 |
| `generate_perm_trace_time_ms` |  54.50 |  109 |  58 |  51 |
| `perm_trace_commit_time_ms` |  225.32 |  450.64 |  230.41 |  220.23 |
| `quotient_poly_compute_time_ms` |  170.26 |  340.52 |  171.55 |  168.97 |
| `quotient_poly_commit_time_ms` |  32.92 |  65.84 |  33.87 |  31.96 |
| `pcs_opening_time_ms ` |  110 |  220 |  111 |  109 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 1,737 |  | 1 | 1 |  |  |  |  | 
| pairing |  | 682 |  | 1 | 63 | 1,745,742 | 27.53 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 127 | 1,190 | 39,652,244 | 410,701,290 | 127 | 755 | 0 | 171.55 | 33.87 | 5 | 230.41 | 109 | 290 | 109 | 14 | 148 | 16,333,366 | 58 | 307 | 1,992,123 | 7.41 | 39 | 206 | 0 | 109 | 
| leaf | 1 | 109 | 1,735 | 39,016,348 | 396,840,426 | 109 | 728 | 0 | 168.97 | 31.96 | 4 | 220.23 | 111 | 272 | 111 | 11 | 141 | 16,068,818 | 51 | 896 | 1,913,057 | 7.46 | 37 | 202 | 0 | 111 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 182 | 851 | 32,480,114 | 172,558,444 | 182 | 393 | 0 | 90.54 | 18 | 6 | 87.42 | 74 | 134 | 74 | 1 | 74 | 15,909,408 | 43 | 106 | 1,149,000 | 11.15 | 26 | 109 | 1 | 74 | 
| pairing | 1 | 191 | 682 | 22,464,232 | 119,958,502 | 191 | 388 | 1 | 73.11 | 14.84 | 5 | 64.34 | 79 | 165 | 79 | 0 | 55 | 9,498,894 | 97 | 61 | 596,742 | 18.01 | 20 | 88 | 1 | 79 | 

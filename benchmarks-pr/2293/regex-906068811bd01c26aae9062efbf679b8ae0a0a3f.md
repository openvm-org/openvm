...
|:---|---:|---:|
| Total | <span style='color: red'>(+0 [+2.3%])</span> 2.46 | <span style='color: red'>(+0 [+1.4%])</span> 0.77 |
| regex_program | <span style='color: red'>(+0 [+2.4%])</span> 2.42 | <span style='color: red'>(+0 [+1.8%])</span> 0.74 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+14 [+2.4%])</span> 605.50 | <span style='color: red'>(+57 [+2.4%])</span> 2,422 | <span style='color: red'>(+13 [+1.8%])</span> 738 | <span style='color: red'>(+7 [+1.3%])</span> 551 |
...
| `execute_metered_insn_mi/s` | <span style='color: red'>(+7 [+6.3%])</span> 115.87 | -          | <span style='color: red'>(+7 [+6.3%])</span> 115.87 | <span style='color: red'>(+7 [+6.3%])</span> 115.87 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` | <span style='color: red'>(+1 [+2.4%])</span> 54.25 | <span style='color: red'>(+5 [+2.4%])</span> 217 | <span style='color: red'>(+1 [+1.5%])</span> 66 | <span style='color: red'>(+1 [+2.2%])</span> 46 |
| `execute_preflight_insn_mi/s` | <span style='color: green'>(-1 [-2.2%])</span> 31.22 | -          | <span style='color: green'>(-1 [-2.0%])</span> 32.46 | <span style='color: green'>(-1 [-1.8%])</span> 28.38 |
| `trace_gen_time_ms   ` |  178.50 |  714 | <span style='color: red'>(+1 [+0.5%])</span> 212 |  155 |
| `memory_finalize_time_ms` |  1 |  4 |  4 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+14 [+4.7%])</span> 299.25 | <span style='color: red'>(+54 [+4.7%])</span> 1,197 | <span style='color: red'>(+13 [+4.3%])</span> 312 | <span style='color: red'>(+15 [+5.5%])</span> 288 |
...
| `generate_perm_trace_time_ms` | <span style='color: red'>(+9 [+36.5%])</span> 32.75 | <span style='color: red'>(+35 [+36.5%])</span> 131 | <span style='color: red'>(+9 [+32.1%])</span> 37 | <span style='color: red'>(+2 [+9.1%])</span> 24 |
| `perm_trace_commit_time_ms` | <span style='color: green'>(-0 [-0.1%])</span> 64.59 | <span style='color: green'>(-0 [-0.1%])</span> 258.35 | <span style='color: red'>(+1 [+1.8%])</span> 73.06 | <span style='color: green'>(-1 [-1.7%])</span> 54.75 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+1 [+1.6%])</span> 59.90 | <span style='color: red'>(+4 [+1.6%])</span> 239.60 | <span style='color: red'>(+1 [+2.1%])</span> 72.18 | <span style='color: green'>(-0 [-0.4%])</span> 53.16 |
| `quotient_poly_commit_time_ms` | <span style='color: green'>(-0 [-2.0%])</span> 15.68 | <span style='color: green'>(-1 [-2.0%])</span> 62.73 | <span style='color: green'>(-1 [-5.4%])</span> 17.59 | <span style='color: green'>(-0 [-1.4%])</span> 13.63 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+4 [+5.2%])</span> 71.25 | <span style='color: red'>(+14 [+5.2%])</span> 285 | <span style='color: red'>(+3 [+4.1%])</span> 77 | <span style='color: red'>(+8 [+14.0%])</span> 65 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 570 | 1 | 35 | 4,137,502 | 115.87 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 212 | 738 | 23,446,148 | 150,778,428 | 212 | 312 | 0 | 59.100 | 17.59 | 5 | 73.06 | 77 | 98 | 77 | 4 | 57 | 10,899,170 | 24 | 46 | 1,103,000 | 28.38 | 22 | 78 | 0 | 77 | 
| regex_program | 1 | 155 | 551 | 11,598,276 | 128,513,066 | 155 | 288 | 1 | 53.16 | 16.23 | 4 | 65.22 | 65 | 101 | 64 | 0 | 51 | 2,196,106 | 35 | 66 | 1,104,000 | 32.46 | 17 | 70 | 0 | 64 | 
| regex_program | 2 | 163 | 563 | 11,579,064 | 128,513,066 | 163 | 298 | 1 | 54.26 | 15.29 | 4 | 65.32 | 77 | 101 | 76 | 0 | 49 | 2,177,334 | 35 | 59 | 1,104,000 | 32.05 | 17 | 70 | 0 | 76 | 
| regex_program | 3 | 184 | 570 | 11,853,872 | 103,456,394 | 184 | 299 | 0 | 72.18 | 13.63 | 5 | 54.75 | 66 | 95 | 65 | 0 | 50 | 2,422,606 | 37 | 46 | 826,502 | 32 | 19 | 86 | 0 | 65 | 

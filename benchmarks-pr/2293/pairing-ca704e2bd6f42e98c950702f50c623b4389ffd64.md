...
|:---|---:|---:|
| Total |  1.53 | <span style='color: red'>(+0 [+1.8%])</span> 0.92 |
| pairing |  1.47 | <span style='color: red'>(+0 [+1.9%])</span> 0.86 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  734.50 |  1,469 | <span style='color: red'>(+16 [+1.9%])</span> 861 | <span style='color: green'>(-15 [-2.4%])</span> 608 |
...
| `execute_metered_insn_mi/s` | <span style='color: red'>(+0 [+0.7%])</span> 27.67 | -          | <span style='color: red'>(+0 [+0.7%])</span> 27.67 | <span style='color: red'>(+0 [+0.7%])</span> 27.67 |
| `execute_preflight_insns` |  872,871 |  1,745,742 |  1,149,000 |  596,742 |
| `execute_preflight_time_ms` | <span style='color: green'>(-4 [-4.0%])</span> 83 | <span style='color: green'>(-7 [-4.0%])</span> 166 | <span style='color: green'>(-5 [-4.5%])</span> 105 | <span style='color: green'>(-2 [-3.2%])</span> 61 |
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+1 [+6.8%])</span> 14.79 | -          | <span style='color: red'>(+1 [+8.3%])</span> 18.35 | <span style='color: red'>(+0 [+4.4%])</span> 11.24 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+7 [+3.8%])</span> 191 | <span style='color: red'>(+14 [+3.8%])</span> 382 | <span style='color: red'>(+5 [+2.6%])</span> 195 | <span style='color: red'>(+9 [+5.1%])</span> 187 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: green'>(-3 [-0.8%])</span> 354.50 | <span style='color: green'>(-6 [-0.8%])</span> 709 | <span style='color: red'>(+12 [+3.1%])</span> 399 | <span style='color: green'>(-18 [-5.5%])</span> 310 |
| `main_trace_commit_time_ms` |  64.50 |  129 | <span style='color: red'>(+1 [+1.3%])</span> 76 | <span style='color: green'>(-1 [-1.9%])</span> 53 |
| `generate_perm_trace_time_ms` | <span style='color: red'>(+4 [+12.3%])</span> 36.50 | <span style='color: red'>(+8 [+12.3%])</span> 73 | <span style='color: red'>(+2 [+5.6%])</span> 38 | <span style='color: red'>(+6 [+20.7%])</span> 35 |
| `perm_trace_commit_time_ms` |  77.25 |  154.50 | <span style='color: green'>(-1 [-0.7%])</span> 89.13 | <span style='color: red'>(+1 [+1.0%])</span> 65.37 |
| `quotient_poly_compute_time_ms` |  83.68 |  167.37 | <span style='color: green'>(-1 [-1.1%])</span> 91.97 | <span style='color: red'>(+1 [+1.5%])</span> 75.40 |
| `quotient_poly_commit_time_ms` | <span style='color: green'>(-0 [-1.0%])</span> 17.35 | <span style='color: green'>(-0 [-1.0%])</span> 34.71 | <span style='color: green'>(-1 [-4.4%])</span> 18.85 | <span style='color: red'>(+1 [+3.4%])</span> 15.86 |
| `pcs_opening_time_ms ` | <span style='color: green'>(-7 [-9.0%])</span> 70.50 | <span style='color: green'>(-14 [-9.0%])</span> 141 | <span style='color: green'>(-6 [-7.0%])</span> 80 | <span style='color: green'>(-8 [-11.6%])</span> 61 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 608 | 1 | 63 | 1,745,742 | 27.67 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 187 | 861 | 32,480,114 | 172,558,444 | 187 | 399 | 0 | 91.97 | 18.85 | 6 | 89.13 | 80 | 131 | 79 | 1 | 76 | 15,909,408 | 38 | 105 | 1,149,000 | 11.24 | 26 | 111 | 1 | 79 | 
| pairing | 1 | 195 | 608 | 22,464,232 | 119,958,502 | 195 | 310 | 1 | 75.40 | 15.86 | 6 | 65.37 | 61 | 103 | 61 | 0 | 53 | 9,498,894 | 35 | 61 | 596,742 | 18.35 | 21 | 91 | 1 | 61 | 

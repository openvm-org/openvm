...
| `total_proof_time_ms ` |  736 |  1,472 |  875 |  597 |
...
| `execute_preflight_time_ms` |  87 |  174 |  109 |  65 |
| `execute_preflight_insn_mi/s` |  13.97 | -          |  17.07 |  10.87 |
| `trace_gen_time_ms   ` |  186 |  372 |  189 |  183 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  358 |  716 |  414 |  302 |
| `main_trace_commit_time_ms` |  65 |  130 |  75 |  55 |
| `generate_perm_trace_time_ms` |  37.50 |  75 |  44 |  31 |
| `perm_trace_commit_time_ms` |  77.35 |  154.71 |  89.32 |  65.39 |
| `quotient_poly_compute_time_ms` |  84.71 |  169.43 |  94.90 |  74.53 |
| `quotient_poly_commit_time_ms` |  17.61 |  35.22 |  19.98 |  15.24 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 597 | 1 | 63 | 1,745,742 | 27.32 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 183 | 875 | 32,480,114 | 172,558,444 | 183 | 414 | 0 | 94.90 | 19.98 | 6 | 89.32 | 86 | 136 | 86 | 1 | 75 | 15,909,408 | 44 | 109 | 1,149,000 | 10.87 | 27 | 115 | 1 | 86 | 
| pairing | 1 | 189 | 597 | 22,464,232 | 119,958,502 | 189 | 302 | 1 | 74.53 | 15.24 | 6 | 65.39 | 56 | 99 | 56 | 0 | 55 | 9,498,894 | 31 | 65 | 596,742 | 17.07 | 20 | 90 | 1 | 56 | 

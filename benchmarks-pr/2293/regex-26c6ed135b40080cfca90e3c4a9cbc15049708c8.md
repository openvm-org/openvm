...
|:---|---:|---:|
| Total | <span style='color: red'>(+0 [+0.7%])</span> 2.39 | <span style='color: red'>(+0 [+1.7%])</span> 0.76 |
| regex_program | <span style='color: red'>(+0 [+0.6%])</span> 2.35 | <span style='color: red'>(+0 [+1.4%])</span> 0.73 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+3 [+0.6%])</span> 587.50 | <span style='color: red'>(+13 [+0.6%])</span> 2,350 | <span style='color: red'>(+10 [+1.4%])</span> 725 | <span style='color: green'>(-14 [-2.6%])</span> 526 |
...
| `execute_metered_insn_mi/s` | <span style='color: green'>(-9 [-8.4%])</span> 103.59 | -          | <span style='color: green'>(-9 [-8.4%])</span> 103.59 | <span style='color: green'>(-9 [-8.4%])</span> 103.59 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` | <span style='color: red'>(+4 [+7.7%])</span> 56.25 | <span style='color: red'>(+16 [+7.7%])</span> 225 | <span style='color: red'>(+6 [+9.5%])</span> 69 | <span style='color: red'>(+3 [+6.8%])</span> 47 |
| `execute_preflight_insn_mi/s` | <span style='color: green'>(-2 [-4.7%])</span> 30.66 | -          | <span style='color: green'>(-2 [-4.9%])</span> 31.66 | <span style='color: green'>(-1 [-4.7%])</span> 27.74 |
| `trace_gen_time_ms   ` | <span style='color: green'>(-6 [-3.3%])</span> 173.25 | <span style='color: green'>(-24 [-3.3%])</span> 693 | <span style='color: green'>(-3 [-1.4%])</span> 207 | <span style='color: green'>(-9 [-5.7%])</span> 149 |
| `memory_finalize_time_ms` |  1 |  4 |  4 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+4 [+1.6%])</span> 283.75 | <span style='color: red'>(+18 [+1.6%])</span> 1,135 | <span style='color: red'>(+9 [+3.1%])</span> 300 | <span style='color: green'>(-4 [-1.5%])</span> 265 |
| `main_trace_commit_time_ms` | <span style='color: green'>(-0 [-0.5%])</span> 51.50 | <span style='color: green'>(-1 [-0.5%])</span> 206 | <span style='color: red'>(+1 [+1.8%])</span> 57 |  49 |
| `generate_perm_trace_time_ms` | <span style='color: red'>(+6 [+21.0%])</span> 31.75 | <span style='color: red'>(+22 [+21.0%])</span> 127 | <span style='color: red'>(+1 [+2.8%])</span> 37 | <span style='color: red'>(+8 [+42.1%])</span> 27 |
| `perm_trace_commit_time_ms` | <span style='color: green'>(-1 [-1.0%])</span> 63.86 | <span style='color: green'>(-3 [-1.0%])</span> 255.43 | <span style='color: green'>(-1 [-0.9%])</span> 71.09 |  55.09 |
| `quotient_poly_compute_time_ms` | <span style='color: green'>(-1 [-1.9%])</span> 58.17 | <span style='color: green'>(-5 [-1.9%])</span> 232.69 | <span style='color: green'>(-0 [-0.6%])</span> 69.68 | <span style='color: green'>(-1 [-2.8%])</span> 51.61 |
| `quotient_poly_commit_time_ms` | <span style='color: green'>(-0 [-1.4%])</span> 15.51 | <span style='color: green'>(-1 [-1.4%])</span> 62.02 | <span style='color: green'>(-0 [-0.7%])</span> 17.41 | <span style='color: red'>(+0 [+2.2%])</span> 13.38 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+1 [+1.7%])</span> 59.50 | <span style='color: red'>(+4 [+1.7%])</span> 238 | <span style='color: red'>(+3 [+4.8%])</span> 65 | <span style='color: green'>(-3 [-5.6%])</span> 51 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 558 | 1 | 39 | 4,137,502 | 103.59 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 207 | 725 | 23,446,148 | 150,778,428 | 207 | 300 | 0 | 59.25 | 17.41 | 5 | 71.09 | 65 | 99 | 65 | 4 | 57 | 10,899,170 | 27 | 47 | 1,103,000 | 27.74 | 21 | 77 | 0 | 65 | 
| regex_program | 1 | 149 | 541 | 11,598,276 | 128,513,066 | 149 | 281 | 1 | 51.61 | 15.98 | 5 | 65.09 | 59 | 102 | 59 | 0 | 50 | 2,196,106 | 37 | 69 | 1,104,000 | 31.63 | 17 | 68 | 0 | 59 | 
| regex_program | 2 | 157 | 526 | 11,579,064 | 128,513,066 | 157 | 265 | 1 | 52.14 | 15.26 | 5 | 64.16 | 51 | 95 | 50 | 0 | 50 | 2,177,334 | 30 | 61 | 1,104,000 | 31.63 | 17 | 68 | 0 | 50 | 
| regex_program | 3 | 180 | 558 | 11,853,872 | 103,456,394 | 180 | 289 | 1 | 69.68 | 13.38 | 5 | 55.09 | 63 | 92 | 62 | 0 | 49 | 2,422,606 | 33 | 48 | 826,502 | 31.66 | 19 | 84 | 0 | 62 | 

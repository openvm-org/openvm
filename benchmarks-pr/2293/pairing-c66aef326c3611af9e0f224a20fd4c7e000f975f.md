...
|:---|---:|---:|
| Total | <span style='color: red'>(+0 [+5.4%])</span> 1.64 | <span style='color: red'>(+0 [+1.6%])</span> 0.96 |
| pairing | <span style='color: red'>(+0 [+5.6%])</span> 1.57 | <span style='color: red'>(+0 [+1.7%])</span> 0.90 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+42 [+5.6%])</span> 787 | <span style='color: red'>(+84 [+5.6%])</span> 1,574 | <span style='color: red'>(+15 [+1.7%])</span> 895 | <span style='color: red'>(+69 [+11.3%])</span> 679 |
...
| `execute_preflight_time_ms` | <span style='color: red'>(+3 [+3.6%])</span> 85.50 | <span style='color: red'>(+6 [+3.6%])</span> 171 | <span style='color: red'>(+4 [+3.8%])</span> 109 | <span style='color: red'>(+2 [+3.3%])</span> 62 |
| `execute_preflight_insn_mi/s` | <span style='color: green'>(-1 [-4.6%])</span> 14.02 | -          | <span style='color: green'>(-1 [-4.9%])</span> 17.17 | <span style='color: green'>(-0 [-4.0%])</span> 10.87 |
...
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+40 [+11.1%])</span> 405 | <span style='color: red'>(+81 [+11.1%])</span> 810 | <span style='color: red'>(+13 [+3.1%])</span> 431 | <span style='color: red'>(+68 [+21.9%])</span> 379 |
| `main_trace_commit_time_ms` |  66 |  132 | <span style='color: green'>(-1 [-1.3%])</span> 76 | <span style='color: red'>(+1 [+1.8%])</span> 56 |
| `generate_perm_trace_time_ms` | <span style='color: red'>(+34 [+72.0%])</span> 80 | <span style='color: red'>(+67 [+72.0%])</span> 160 | <span style='color: red'>(+50 [+92.6%])</span> 104 | <span style='color: red'>(+17 [+43.6%])</span> 56 |
| `perm_trace_commit_time_ms` | <span style='color: red'>(+0 [+0.1%])</span> 77.46 | <span style='color: red'>(+0 [+0.1%])</span> 154.92 | <span style='color: red'>(+0 [+0.4%])</span> 90.64 | <span style='color: green'>(-0 [-0.4%])</span> 64.28 |
| `quotient_poly_compute_time_ms` | <span style='color: green'>(-1 [-1.1%])</span> 83.70 | <span style='color: green'>(-2 [-1.1%])</span> 167.41 | <span style='color: green'>(-2 [-1.7%])</span> 91.44 | <span style='color: green'>(-0 [-0.2%])</span> 75.97 |
| `quotient_poly_commit_time_ms` | <span style='color: green'>(-0 [-2.6%])</span> 17.13 | <span style='color: green'>(-1 [-2.6%])</span> 34.27 | <span style='color: green'>(-1 [-4.3%])</span> 19.28 | <span style='color: green'>(-0 [-0.3%])</span> 14.99 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+8 [+11.8%])</span> 76 | <span style='color: red'>(+16 [+11.8%])</span> 152 | <span style='color: red'>(+13 [+16.5%])</span> 92 | <span style='color: red'>(+3 [+5.3%])</span> 60 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 679 | 1 | 63 | 1,745,742 | 27.36 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 186 | 895 | 32,480,114 | 172,558,444 | 185 | 431 | 0 | 91.44 | 19.28 | 6 | 90.64 | 92 | 150 | 92 | 1 | 76 | 15,909,408 | 56 | 109 | 1,149,000 | 10.87 | 26 | 111 | 1 | 92 | 
| pairing | 1 | 195 | 679 | 22,464,232 | 119,958,502 | 195 | 379 | 1 | 75.97 | 14.99 | 6 | 64.28 | 60 | 171 | 60 | 0 | 56 | 9,498,894 | 104 | 62 | 596,742 | 17.17 | 21 | 91 | 1 | 60 | 

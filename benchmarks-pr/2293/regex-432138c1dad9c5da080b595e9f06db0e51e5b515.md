...
| `total_proof_time_ms ` |  586 |  2,344 |  721 |  530 |
...
| `execute_metered_insn_mi/s` |  108.13 | -          |  108.13 |  108.13 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  54.75 |  219 |  67 |  46 |
| `execute_preflight_insn_mi/s` |  30.46 | -          |  31.48 |  27.67 |
| `trace_gen_time_ms   ` |  177.75 |  711 |  211 |  154 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  280.25 |  1,121 |  296 |  267 |
| `main_trace_commit_time_ms` |  51.50 |  206 |  56 |  50 |
| `generate_perm_trace_time_ms` |  27 |  108 |  32 |  21 |
| `perm_trace_commit_time_ms` |  64.62 |  258.50 |  72.55 |  55.89 |
| `quotient_poly_compute_time_ms` |  59.35 |  237.41 |  70.29 |  53.03 |
| `quotient_poly_commit_time_ms` |  15.86 |  63.45 |  18.23 |  13.44 |
| `pcs_opening_time_ms ` |  58.75 |  235 |  67 |  51 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 555 | 1 | 38 | 4,137,502 | 108.13 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 211 | 721 | 23,446,148 | 150,778,428 | 211 | 296 | 0 | 60.08 | 18.23 | 6 | 72.55 | 61 | 99 | 61 | 4 | 56 | 10,899,170 | 26 | 47 | 1,103,000 | 27.67 | 22 | 79 | 0 | 61 | 
| regex_program | 1 | 154 | 530 | 11,598,276 | 128,513,066 | 154 | 267 | 1 | 53.03 | 16.21 | 4 | 65.76 | 51 | 95 | 50 | 0 | 50 | 2,196,106 | 29 | 67 | 1,104,000 | 31.34 | 17 | 69 | 0 | 50 | 
| regex_program | 2 | 162 | 538 | 11,579,064 | 128,513,066 | 162 | 274 | 1 | 54.01 | 15.56 | 4 | 64.29 | 56 | 97 | 55 | 0 | 50 | 2,177,334 | 32 | 59 | 1,104,000 | 31.48 | 17 | 70 | 0 | 55 | 
| regex_program | 3 | 184 | 555 | 11,853,872 | 103,456,394 | 184 | 284 | 0 | 70.29 | 13.44 | 5 | 55.89 | 67 | 80 | 66 | 0 | 50 | 2,422,606 | 21 | 46 | 826,502 | 31.35 | 19 | 84 | 0 | 66 | 

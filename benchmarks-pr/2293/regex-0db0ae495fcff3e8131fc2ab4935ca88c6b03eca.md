...
|:---|---:|---:|
| Total | <span style='color: red'>(+0 [+2.0%])</span> 2.42 | <span style='color: red'>(+0 [+2.7%])</span> 0.77 |
| regex_program | <span style='color: red'>(+0 [+2.0%])</span> 2.38 | <span style='color: red'>(+0 [+2.7%])</span> 0.73 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+12 [+2.0%])</span> 595.75 | <span style='color: red'>(+46 [+2.0%])</span> 2,383 | <span style='color: red'>(+19 [+2.7%])</span> 734 | <span style='color: green'>(-8 [-1.5%])</span> 532 |
...
| `execute_metered_insn_mi/s` | <span style='color: green'>(-2 [-1.8%])</span> 111.09 | -          | <span style='color: green'>(-2 [-1.8%])</span> 111.09 | <span style='color: green'>(-2 [-1.8%])</span> 111.09 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` | <span style='color: red'>(+4 [+8.6%])</span> 56.75 | <span style='color: red'>(+18 [+8.6%])</span> 227 | <span style='color: red'>(+7 [+11.1%])</span> 70 | <span style='color: red'>(+3 [+6.8%])</span> 47 |
| `execute_preflight_insn_mi/s` | <span style='color: green'>(-1 [-3.9%])</span> 30.93 | -          | <span style='color: green'>(-1 [-3.9%])</span> 31.98 | <span style='color: green'>(-1 [-3.8%])</span> 27.98 |
| `trace_gen_time_ms   ` | <span style='color: green'>(-3 [-1.8%])</span> 176 | <span style='color: green'>(-13 [-1.8%])</span> 704 | <span style='color: red'>(+1 [+0.5%])</span> 211 | <span style='color: green'>(-6 [-3.8%])</span> 152 |
| `memory_finalize_time_ms` |  1 |  4 |  4 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+9 [+3.3%])</span> 288.50 | <span style='color: red'>(+37 [+3.3%])</span> 1,154 | <span style='color: red'>(+11 [+3.8%])</span> 302 |  269 |
| `main_trace_commit_time_ms` | <span style='color: red'>(+1 [+1.4%])</span> 52.50 | <span style='color: red'>(+3 [+1.4%])</span> 210 | <span style='color: red'>(+2 [+3.6%])</span> 58 | <span style='color: red'>(+1 [+2.0%])</span> 50 |
| `generate_perm_trace_time_ms` | <span style='color: red'>(+10 [+36.2%])</span> 35.75 | <span style='color: red'>(+38 [+36.2%])</span> 143 | <span style='color: red'>(+16 [+44.4%])</span> 52 | <span style='color: red'>(+8 [+42.1%])</span> 27 |
| `perm_trace_commit_time_ms` | <span style='color: green'>(-1 [-0.8%])</span> 63.99 | <span style='color: green'>(-2 [-0.8%])</span> 255.96 | <span style='color: green'>(-1 [-1.2%])</span> 70.88 | <span style='color: green'>(-1 [-1.0%])</span> 54.55 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+1 [+1.6%])</span> 60.22 | <span style='color: red'>(+4 [+1.6%])</span> 240.90 | <span style='color: red'>(+2 [+2.6%])</span> 71.95 | <span style='color: red'>(+1 [+1.0%])</span> 53.62 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+0 [+1.6%])</span> 15.98 | <span style='color: red'>(+1 [+1.6%])</span> 63.92 | <span style='color: red'>(+0 [+2.3%])</span> 17.94 | <span style='color: red'>(+1 [+4.4%])</span> 13.67 |
| `pcs_opening_time_ms ` | <span style='color: green'>(-1 [-1.7%])</span> 57.50 | <span style='color: green'>(-4 [-1.7%])</span> 230 | <span style='color: red'>(+3 [+4.8%])</span> 65 | <span style='color: green'>(-3 [-5.6%])</span> 51 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 561 | 1 | 37 | 4,137,502 | 111.09 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 211 | 734 | 23,446,148 | 150,778,428 | 211 | 302 | 0 | 61.35 | 17.94 | 5 | 70.88 | 65 | 98 | 65 | 4 | 58 | 10,899,170 | 27 | 47 | 1,103,000 | 27.98 | 21 | 80 | 0 | 65 | 
| regex_program | 1 | 152 | 556 | 11,598,276 | 128,513,066 | 152 | 293 | 1 | 53.98 | 16.48 | 4 | 65.56 | 52 | 118 | 52 | 0 | 51 | 2,196,106 | 52 | 70 | 1,104,000 | 31.98 | 17 | 71 | 0 | 52 | 
| regex_program | 2 | 160 | 532 | 11,579,064 | 128,513,066 | 160 | 269 | 1 | 53.62 | 15.83 | 4 | 64.96 | 51 | 96 | 51 | 0 | 51 | 2,177,334 | 31 | 62 | 1,104,000 | 31.92 | 17 | 70 | 0 | 51 | 
| regex_program | 3 | 181 | 561 | 11,853,872 | 103,456,394 | 181 | 290 | 0 | 71.95 | 13.67 | 5 | 54.55 | 62 | 91 | 62 | 0 | 50 | 2,422,606 | 33 | 48 | 826,502 | 31.82 | 19 | 86 | 0 | 62 | 
...
Commit: https://github.com/openvm-org/openvm/commit/0db0ae495fcff3e8131fc2ab4935ca88c6b03eca
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19947436909)

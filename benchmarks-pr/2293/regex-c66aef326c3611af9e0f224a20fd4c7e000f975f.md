...
|:---|---:|---:|
| Total |  2.40 | <span style='color: red'>(+0 [+0.4%])</span> 0.77 |
| regex_program |  2.37 | <span style='color: red'>(+0 [+0.6%])</span> 0.73 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  591.25 |  2,365 | <span style='color: red'>(+4 [+0.6%])</span> 729 | <span style='color: green'>(-5 [-0.9%])</span> 539 |
...
| `execute_metered_insn_mi/s` | <span style='color: red'>(+3 [+3.1%])</span> 112.37 | -          | <span style='color: red'>(+3 [+3.1%])</span> 112.37 | <span style='color: red'>(+3 [+3.1%])</span> 112.37 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` | <span style='color: red'>(+0 [+0.9%])</span> 53.50 | <span style='color: red'>(+2 [+0.9%])</span> 214 |  65 | <span style='color: red'>(+1 [+2.2%])</span> 46 |
| `execute_preflight_insn_mi/s` | <span style='color: green'>(-1 [-1.9%])</span> 31.31 | -          | <span style='color: green'>(-1 [-2.3%])</span> 32.37 | <span style='color: green'>(-0 [-0.3%])</span> 28.80 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+0 [+0.1%])</span> 178.75 | <span style='color: red'>(+1 [+0.1%])</span> 715 | <span style='color: red'>(+1 [+0.5%])</span> 212 |  155 |
| `memory_finalize_time_ms` |  1 |  4 |  4 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: green'>(-0 [-0.2%])</span> 285.25 | <span style='color: green'>(-2 [-0.2%])</span> 1,141 | <span style='color: red'>(+3 [+1.0%])</span> 302 | <span style='color: red'>(+3 [+1.1%])</span> 276 |
| `main_trace_commit_time_ms` | <span style='color: red'>(+0 [+1.0%])</span> 51.75 | <span style='color: red'>(+2 [+1.0%])</span> 207 |  56 | <span style='color: red'>(+1 [+2.0%])</span> 50 |
| `generate_perm_trace_time_ms` | <span style='color: red'>(+1 [+5.2%])</span> 25.25 | <span style='color: red'>(+5 [+5.2%])</span> 101 | <span style='color: red'>(+4 [+14.3%])</span> 32 | <span style='color: green'>(-1 [-4.5%])</span> 21 |
| `perm_trace_commit_time_ms` | <span style='color: red'>(+1 [+0.8%])</span> 65.21 | <span style='color: red'>(+2 [+0.8%])</span> 260.85 | <span style='color: red'>(+0 [+0.6%])</span> 72.18 | <span style='color: red'>(+0 [+0.4%])</span> 55.90 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+0 [+0.7%])</span> 59.42 | <span style='color: red'>(+2 [+0.7%])</span> 237.67 | <span style='color: green'>(-0 [-0.2%])</span> 70.54 | <span style='color: green'>(-0 [-0.2%])</span> 53.28 |
| `quotient_poly_commit_time_ms` | <span style='color: green'>(-0 [-0.8%])</span> 15.87 | <span style='color: green'>(-1 [-0.8%])</span> 63.48 | <span style='color: green'>(-0 [-1.0%])</span> 18.41 | <span style='color: green'>(-0 [-1.6%])</span> 13.61 |
| `pcs_opening_time_ms ` | <span style='color: green'>(-4 [-5.2%])</span> 64.25 | <span style='color: green'>(-14 [-5.2%])</span> 257 | <span style='color: green'>(-6 [-8.1%])</span> 68 | <span style='color: red'>(+1 [+1.8%])</span> 58 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 555 | 1 | 36 | 4,137,502 | 112.37 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 212 | 729 | 23,446,148 | 150,778,428 | 212 | 302 | 0 | 59 | 18.41 | 6 | 72.18 | 68 | 98 | 68 | 4 | 56 | 10,899,170 | 25 | 46 | 1,103,000 | 28.80 | 22 | 78 | 0 | 68 | 
| regex_program | 1 | 155 | 542 | 11,598,276 | 128,513,066 | 155 | 280 | 1 | 54.85 | 16.27 | 4 | 68.14 | 65 | 92 | 65 | 0 | 50 | 2,196,106 | 23 | 65 | 1,104,000 | 32.37 | 17 | 71 | 0 | 65 | 
| regex_program | 2 | 164 | 539 | 11,579,064 | 128,513,066 | 164 | 276 | 1 | 53.28 | 15.20 | 4 | 64.64 | 58 | 98 | 58 | 0 | 51 | 2,177,334 | 32 | 57 | 1,104,000 | 32.32 | 17 | 69 | 0 | 58 | 
| regex_program | 3 | 184 | 555 | 11,853,872 | 103,456,394 | 184 | 283 | 0 | 70.54 | 13.61 | 5 | 55.90 | 66 | 80 | 66 | 0 | 50 | 2,422,606 | 21 | 46 | 826,502 | 31.77 | 19 | 85 | 0 | 66 | 

...
|:---|---:|---:|
| Total | <span style='color: red'>(+0 [+2.1%])</span> 1.55 | <span style='color: red'>(+0 [+1.4%])</span> 0.93 |
| pairing | <span style='color: red'>(+0 [+2.3%])</span> 1.49 | <span style='color: red'>(+0 [+1.6%])</span> 0.87 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+16 [+2.3%])</span> 744 | <span style='color: red'>(+33 [+2.3%])</span> 1,488 | <span style='color: red'>(+14 [+1.6%])</span> 866 | <span style='color: red'>(+19 [+3.2%])</span> 622 |
...
| `execute_metered_insn_mi/s` | <span style='color: red'>(+1 [+1.9%])</span> 27.85 | -          | <span style='color: red'>(+1 [+1.9%])</span> 27.85 | <span style='color: red'>(+1 [+1.9%])</span> 27.85 |
| `execute_preflight_insns` |  872,871 |  1,745,742 |  1,149,000 |  596,742 |
| `execute_preflight_time_ms` | <span style='color: red'>(+0 [+0.6%])</span> 83 | <span style='color: red'>(+1 [+0.6%])</span> 166 | <span style='color: red'>(+2 [+1.9%])</span> 106 | <span style='color: green'>(-1 [-1.6%])</span> 60 |
| `execute_preflight_insn_mi/s` | <span style='color: green'>(-0 [-1.5%])</span> 14.66 | -          | <span style='color: green'>(-0 [-1.5%])</span> 18.10 | <span style='color: green'>(-0 [-1.4%])</span> 11.22 |
...
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+17 [+4.9%])</span> 365.50 | <span style='color: red'>(+34 [+4.9%])</span> 731 | <span style='color: red'>(+13 [+3.3%])</span> 405 | <span style='color: red'>(+21 [+6.9%])</span> 326 |
| `main_trace_commit_time_ms` | <span style='color: red'>(+1 [+1.6%])</span> 64.50 | <span style='color: red'>(+2 [+1.6%])</span> 129 |  75 | <span style='color: red'>(+2 [+3.8%])</span> 54 |
| `generate_perm_trace_time_ms` | <span style='color: green'>(-4 [-10.1%])</span> 35.50 | <span style='color: green'>(-8 [-10.1%])</span> 71 | <span style='color: green'>(-3 [-7.3%])</span> 38 | <span style='color: green'>(-5 [-13.2%])</span> 33 |
| `perm_trace_commit_time_ms` | <span style='color: green'>(-1 [-0.8%])</span> 77.08 | <span style='color: green'>(-1 [-0.8%])</span> 154.16 | <span style='color: green'>(-1 [-1.3%])</span> 89.29 |  64.87 |
| `quotient_poly_compute_time_ms` | <span style='color: green'>(-1 [-1.6%])</span> 82.64 | <span style='color: green'>(-3 [-1.6%])</span> 165.29 | <span style='color: green'>(-1 [-1.0%])</span> 92.19 | <span style='color: green'>(-2 [-2.3%])</span> 73.10 |
| `quotient_poly_commit_time_ms` | <span style='color: green'>(-0 [-1.0%])</span> 17.56 | <span style='color: green'>(-0 [-1.0%])</span> 35.12 | <span style='color: red'>(+0 [+0.3%])</span> 20.07 | <span style='color: green'>(-0 [-2.6%])</span> 15.05 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+22 [+37.2%])</span> 83 | <span style='color: red'>(+45 [+37.2%])</span> 166 | <span style='color: red'>(+18 [+26.9%])</span> 85 | <span style='color: red'>(+27 [+50.0%])</span> 81 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 622 | 1 | 62 | 1,745,742 | 27.85 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 185 | 866 | 32,480,114 | 172,558,444 | 185 | 405 | 0 | 92.19 | 20.07 | 7 | 89.29 | 85 | 130 | 84 | 1 | 75 | 15,909,408 | 38 | 106 | 1,149,000 | 11.22 | 27 | 113 | 1 | 84 | 
| pairing | 1 | 195 | 622 | 22,464,232 | 119,958,502 | 195 | 326 | 1 | 73.10 | 15.05 | 5 | 64.87 | 81 | 101 | 81 | 0 | 54 | 9,498,894 | 33 | 60 | 596,742 | 18.10 | 20 | 88 | 0 | 81 | 

...
|:---|---:|---:|
| Total | <span style='color: red'>(+0 [+2.2%])</span> 1.55 | <span style='color: red'>(+0 [+2.3%])</span> 0.94 |
| pairing | <span style='color: red'>(+0 [+2.4%])</span> 1.49 | <span style='color: red'>(+0 [+2.6%])</span> 0.87 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+18 [+2.4%])</span> 745 | <span style='color: red'>(+35 [+2.4%])</span> 1,490 | <span style='color: red'>(+22 [+2.6%])</span> 874 | <span style='color: red'>(+13 [+2.2%])</span> 616 |
...
| `execute_metered_insn_mi/s` | <span style='color: red'>(+1 [+2.0%])</span> 27.88 | -          | <span style='color: red'>(+1 [+2.0%])</span> 27.88 | <span style='color: red'>(+1 [+2.0%])</span> 27.88 |
| `execute_preflight_insns` |  872,871 |  1,745,742 |  1,149,000 |  596,742 |
| `execute_preflight_time_ms` | <span style='color: green'>(-0 [-0.6%])</span> 82 | <span style='color: green'>(-1 [-0.6%])</span> 164 | <span style='color: red'>(+1 [+1.0%])</span> 105 | <span style='color: green'>(-2 [-3.3%])</span> 59 |
| `execute_preflight_insn_mi/s` | <span style='color: green'>(-0 [-0.3%])</span> 14.83 | -          | <span style='color: green'>(-0 [-0.2%])</span> 18.34 | <span style='color: green'>(-0 [-0.5%])</span> 11.32 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+2 [+1.3%])</span> 193.50 | <span style='color: red'>(+5 [+1.3%])</span> 387 | <span style='color: red'>(+2 [+1.0%])</span> 197 | <span style='color: red'>(+3 [+1.6%])</span> 190 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+16 [+4.4%])</span> 364 | <span style='color: red'>(+31 [+4.4%])</span> 728 | <span style='color: red'>(+18 [+4.6%])</span> 410 | <span style='color: red'>(+13 [+4.3%])</span> 318 |
| `main_trace_commit_time_ms` | <span style='color: red'>(+0 [+0.8%])</span> 64 | <span style='color: red'>(+1 [+0.8%])</span> 128 | <span style='color: green'>(-1 [-1.3%])</span> 74 | <span style='color: red'>(+2 [+3.8%])</span> 54 |
| `generate_perm_trace_time_ms` | <span style='color: red'>(+2 [+6.3%])</span> 42 | <span style='color: red'>(+5 [+6.3%])</span> 84 | <span style='color: red'>(+8 [+19.5%])</span> 49 | <span style='color: green'>(-3 [-7.9%])</span> 35 |
| `perm_trace_commit_time_ms` | <span style='color: green'>(-0 [-0.2%])</span> 77.53 | <span style='color: green'>(-0 [-0.2%])</span> 155.06 |  90.54 | <span style='color: green'>(-0 [-0.6%])</span> 64.52 |
| `quotient_poly_compute_time_ms` | <span style='color: green'>(-1 [-1.6%])</span> 82.64 | <span style='color: green'>(-3 [-1.6%])</span> 165.27 | <span style='color: green'>(-2 [-2.0%])</span> 91.20 | <span style='color: green'>(-1 [-1.0%])</span> 74.07 |
| `quotient_poly_commit_time_ms` |  17.73 |  35.47 | <span style='color: green'>(-0 [-2.3%])</span> 19.53 | <span style='color: red'>(+0 [+3.1%])</span> 15.93 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+14 [+23.1%])</span> 74.50 | <span style='color: red'>(+28 [+23.1%])</span> 149 | <span style='color: red'>(+13 [+19.4%])</span> 80 | <span style='color: red'>(+15 [+27.8%])</span> 69 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 616 | 1 | 62 | 1,745,742 | 27.88 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 190 | 874 | 32,480,114 | 172,558,444 | 190 | 410 | 0 | 91.20 | 19.53 | 6 | 90.54 | 80 | 142 | 80 | 1 | 74 | 15,909,408 | 49 | 105 | 1,149,000 | 11.32 | 27 | 111 | 1 | 80 | 
| pairing | 1 | 197 | 616 | 22,464,232 | 119,958,502 | 197 | 318 | 1 | 74.07 | 15.93 | 6 | 64.52 | 69 | 103 | 69 | 0 | 54 | 9,498,894 | 35 | 59 | 596,742 | 18.34 | 21 | 90 | 1 | 69 | 
...
Commit: https://github.com/openvm-org/openvm/commit/3b1dfed198f541e595f337cfb4d495e45ae49eb0
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/20076499047)

...
|:---|---:|---:|---:|
| Total |  1.57 |  0.93 | 0.93 |
| pairing |  1.57 |  0.93 |  0.93 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  755 |  1,510 |  872 |  638 |
...
| `execute_preflight_insn_mi/s` |  14.62 | -          |  17.99 |  11.24 |
| `trace_gen_time_ms   ` |  187.50 |  375 |  191 |  184 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  377.50 |  755 |  412 |  343 |
| `main_trace_commit_time_ms` |  63.50 |  127 |  74 |  53 |
| `generate_perm_trace_time_ms` |  62 |  124 |  68 |  56 |
| `perm_trace_commit_time_ms` |  76.31 |  152.62 |  87.93 |  64.69 |
| `quotient_poly_compute_time_ms` |  82.97 |  165.94 |  91.73 |  74.21 |
| `quotient_poly_commit_time_ms` |  16.65 |  33.29 |  18.05 |  15.25 |
| `pcs_opening_time_ms ` |  71.50 |  143 |  80 |  63 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 638 | 1 | 62 | 1,745,742 | 27.74 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 184 | 872 | 32,480,114 | 172,558,444 | 184 | 412 | 0 | 91.73 | 18.05 | 6 | 87.93 | 80 | 146 | 80 | 1 | 74 | 15,909,408 | 56 | 105 | 1,149,000 | 11.24 | 26 | 110 | 1 | 80 | 
| pairing | 1 | 191 | 638 | 22,464,232 | 119,958,502 | 191 | 343 | 1 | 74.21 | 15.25 | 6 | 64.69 | 63 | 136 | 63 | 0 | 53 | 9,498,894 | 68 | 62 | 596,742 | 17.99 | 20 | 90 | 1 | 63 | 

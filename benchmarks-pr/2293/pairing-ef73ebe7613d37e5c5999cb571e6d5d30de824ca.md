...
|:---|---:|---:|
| Total |  1.51 | <span style='color: red'>(+0 [+1.0%])</span> 0.92 |
| pairing |  1.44 | <span style='color: red'>(+0 [+0.9%])</span> 0.85 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  722 |  1,444 | <span style='color: red'>(+8 [+0.9%])</span> 852 | <span style='color: green'>(-8 [-1.3%])</span> 592 |
| `main_cells_used     ` |  12,704,151 |  25,408,302 |  15,909,408 |  9,498,894 |
| `total_cells_used    ` |  27,472,173 |  54,944,346 |  32,480,114 |  22,464,232 |
| `execute_metered_time_ms` | <span style='color: red'>(+1 [+1.4%])</span> 70 | -          | -          | -          |
| `execute_metered_insn_mi/s` | <span style='color: green'>(-0 [-1.1%])</span> 24.93 | -          | <span style='color: green'>(-0 [-1.1%])</span> 24.93 | <span style='color: green'>(-0 [-1.1%])</span> 24.93 |
| `execute_preflight_insns` |  872,871 |  1,745,742 |  1,149,000 |  596,742 |
| `execute_preflight_time_ms` | <span style='color: red'>(+2 [+2.4%])</span> 85.50 | <span style='color: red'>(+4 [+2.4%])</span> 171 | <span style='color: red'>(+3 [+2.8%])</span> 111 | <span style='color: red'>(+1 [+1.7%])</span> 60 |
| `execute_preflight_insn_mi/s` | <span style='color: green'>(-0 [-1.8%])</span> 14.38 | -          | <span style='color: green'>(-0 [-1.7%])</span> 18.08 | <span style='color: green'>(-0 [-2.0%])</span> 10.68 |
| `trace_gen_time_ms   ` | <span style='color: green'>(-4 [-1.9%])</span> 182.50 | <span style='color: green'>(-7 [-1.9%])</span> 365 | <span style='color: green'>(-2 [-1.0%])</span> 190 | <span style='color: green'>(-5 [-2.8%])</span> 175 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+2 [+0.4%])</span> 348 | <span style='color: red'>(+3 [+0.4%])</span> 696 | <span style='color: red'>(+10 [+2.6%])</span> 396 | <span style='color: green'>(-7 [-2.3%])</span> 300 |
| `main_trace_commit_time_ms` | <span style='color: green'>(-2 [-2.3%])</span> 62.50 | <span style='color: green'>(-3 [-2.3%])</span> 125 | <span style='color: green'>(-2 [-2.7%])</span> 73 | <span style='color: green'>(-1 [-1.9%])</span> 52 |
...
| `perm_trace_commit_time_ms` | <span style='color: green'>(-1 [-1.7%])</span> 75.76 | <span style='color: green'>(-3 [-1.7%])</span> 151.51 | <span style='color: green'>(-1 [-1.6%])</span> 87.87 | <span style='color: green'>(-1 [-1.7%])</span> 63.64 |
| `quotient_poly_compute_time_ms` | <span style='color: green'>(-1 [-1.5%])</span> 81.56 | <span style='color: green'>(-2 [-1.5%])</span> 163.13 | <span style='color: green'>(-1 [-0.6%])</span> 91.35 | <span style='color: green'>(-2 [-2.7%])</span> 71.78 |
| `quotient_poly_commit_time_ms` | <span style='color: green'>(-1 [-6.0%])</span> 16.58 | <span style='color: green'>(-2 [-6.0%])</span> 33.16 | <span style='color: green'>(-1 [-6.2%])</span> 18.57 | <span style='color: green'>(-1 [-5.7%])</span> 14.59 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+2 [+3.0%])</span> 69.50 | <span style='color: red'>(+4 [+3.0%])</span> 139 | <span style='color: red'>(+11 [+15.9%])</span> 80 | <span style='color: green'>(-7 [-10.6%])</span> 59 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 592 | 1 | 70 | 1,745,742 | 24.93 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 175 | 852 | 32,480,114 | 172,558,444 | 175 | 396 | 0 | 91.35 | 18.57 | 7 | 87.87 | 80 | 131 | 80 | 1 | 73 | 15,909,408 | 39 | 111 | 1,149,000 | 10.68 | 27 | 110 | 1 | 80 | 
| pairing | 1 | 190 | 592 | 22,464,232 | 119,958,502 | 190 | 300 | 1 | 71.78 | 14.59 | 6 | 63.64 | 59 | 100 | 59 | 0 | 52 | 9,498,894 | 34 | 60 | 596,742 | 18.08 | 20 | 86 | 1 | 59 | 
...
Commit: https://github.com/openvm-org/openvm/commit/ef73ebe7613d37e5c5999cb571e6d5d30de824ca
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19942518592)

...
|:---|---:|---:|
| Total | <span style='color: red'>(+0 [+1.2%])</span> 1.57 |  0.94 |
| pairing | <span style='color: red'>(+0 [+1.1%])</span> 1.51 | <span style='color: green'>(-0 [-0.1%])</span> 0.88 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+8 [+1.1%])</span> 753.50 | <span style='color: red'>(+17 [+1.1%])</span> 1,507 | <span style='color: green'>(-1 [-0.1%])</span> 879 | <span style='color: red'>(+18 [+3.0%])</span> 628 |
...
| `execute_metered_insn_mi/s` | <span style='color: green'>(-0 [-0.4%])</span> 27.27 | -          | <span style='color: green'>(-0 [-0.4%])</span> 27.27 | <span style='color: green'>(-0 [-0.4%])</span> 27.27 |
| `execute_preflight_insns` |  872,871 |  1,745,742 |  1,149,000 |  596,742 |
| `execute_preflight_time_ms` |  82.50 |  165 |  105 |  60 |
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+0 [+1.4%])</span> 14.89 | -          | <span style='color: red'>(+0 [+2.3%])</span> 18.47 |  11.31 |
| `trace_gen_time_ms   ` |  193 |  386 |  197 |  189 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+7 [+1.9%])</span> 371.50 | <span style='color: red'>(+14 [+1.9%])</span> 743 | <span style='color: green'>(-4 [-1.0%])</span> 414 | <span style='color: red'>(+18 [+5.8%])</span> 329 |
| `main_trace_commit_time_ms` | <span style='color: green'>(-2 [-2.3%])</span> 64.50 | <span style='color: green'>(-3 [-2.3%])</span> 129 | <span style='color: green'>(-2 [-2.6%])</span> 75 | <span style='color: green'>(-1 [-1.8%])</span> 54 |
| `generate_perm_trace_time_ms` | <span style='color: green'>(-11 [-23.7%])</span> 35.50 | <span style='color: green'>(-22 [-23.7%])</span> 71 | <span style='color: green'>(-16 [-29.6%])</span> 38 | <span style='color: green'>(-6 [-15.4%])</span> 33 |
| `perm_trace_commit_time_ms` | <span style='color: green'>(-2 [-2.7%])</span> 75.27 | <span style='color: green'>(-4 [-2.7%])</span> 150.54 | <span style='color: green'>(-5 [-5.1%])</span> 85.60 | <span style='color: red'>(+0 [+0.7%])</span> 64.94 |
| `quotient_poly_compute_time_ms` | <span style='color: green'>(-3 [-3.9%])</span> 81.31 | <span style='color: green'>(-7 [-3.9%])</span> 162.61 | <span style='color: green'>(-5 [-4.9%])</span> 88.50 | <span style='color: green'>(-2 [-2.7%])</span> 74.11 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+0 [+1.1%])</span> 17.79 | <span style='color: red'>(+0 [+1.1%])</span> 35.57 | <span style='color: green'>(-0 [-2.5%])</span> 19.65 | <span style='color: red'>(+1 [+5.8%])</span> 15.92 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+24 [+36.0%])</span> 92.50 | <span style='color: red'>(+49 [+36.0%])</span> 185 | <span style='color: red'>(+24 [+30.4%])</span> 103 | <span style='color: red'>(+25 [+43.9%])</span> 82 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 628 | 1 | 64 | 1,745,742 | 27.27 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 189 | 879 | 32,480,114 | 172,558,444 | 189 | 414 | 0 | 88.50 | 19.65 | 6 | 85.60 | 103 | 126 | 103 | 1 | 75 | 15,909,408 | 38 | 105 | 1,149,000 | 11.31 | 27 | 108 | 1 | 103 | 
| pairing | 1 | 197 | 628 | 22,464,232 | 119,958,502 | 197 | 329 | 1 | 74.11 | 15.92 | 5 | 64.94 | 82 | 101 | 82 | 0 | 54 | 9,498,894 | 33 | 60 | 596,742 | 18.47 | 21 | 90 | 1 | 82 | 

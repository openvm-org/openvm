...
|:---|---:|---:|
| Total | <span style='color: red'>(+0 [+1.2%])</span> 2.43 | <span style='color: red'>(+0 [+2.2%])</span> 0.78 |
| regex_program | <span style='color: red'>(+0 [+1.3%])</span> 2.40 | <span style='color: red'>(+0 [+2.5%])</span> 0.74 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+8 [+1.3%])</span> 598.75 | <span style='color: red'>(+30 [+1.3%])</span> 2,395 | <span style='color: red'>(+18 [+2.5%])</span> 743 | <span style='color: green'>(-15 [-2.8%])</span> 529 |
...
| `execute_metered_insn_mi/s` | <span style='color: red'>(+5 [+4.6%])</span> 113.99 | -          | <span style='color: red'>(+5 [+4.6%])</span> 113.99 | <span style='color: red'>(+5 [+4.6%])</span> 113.99 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` | <span style='color: red'>(+1 [+1.4%])</span> 53.75 | <span style='color: red'>(+3 [+1.4%])</span> 215 | <span style='color: red'>(+1 [+1.5%])</span> 66 |  45 |
| `execute_preflight_insn_mi/s` | <span style='color: green'>(-1 [-3.1%])</span> 30.94 | -          | <span style='color: green'>(-1 [-3.2%])</span> 32.08 | <span style='color: green'>(-0 [-0.9%])</span> 28.61 |
| `trace_gen_time_ms   ` | <span style='color: green'>(-2 [-1.0%])</span> 176.75 | <span style='color: green'>(-7 [-1.0%])</span> 707 | <span style='color: green'>(-1 [-0.5%])</span> 210 | <span style='color: green'>(-1 [-0.6%])</span> 154 |
| `memory_finalize_time_ms` |  1 |  4 |  4 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+8 [+3.0%])</span> 294.25 | <span style='color: red'>(+34 [+3.0%])</span> 1,177 | <span style='color: red'>(+19 [+6.4%])</span> 318 | <span style='color: green'>(-6 [-2.2%])</span> 267 |
| `main_trace_commit_time_ms` | <span style='color: red'>(+1 [+2.0%])</span> 52.25 | <span style='color: red'>(+4 [+2.0%])</span> 209 | <span style='color: red'>(+2 [+3.6%])</span> 58 | <span style='color: red'>(+1 [+2.0%])</span> 50 |
| `generate_perm_trace_time_ms` | <span style='color: red'>(+8 [+31.2%])</span> 31.50 | <span style='color: red'>(+30 [+31.2%])</span> 126 | <span style='color: red'>(+11 [+39.3%])</span> 39 | <span style='color: red'>(+1 [+4.5%])</span> 23 |
| `perm_trace_commit_time_ms` | <span style='color: green'>(-0 [-0.4%])</span> 64.40 | <span style='color: green'>(-1 [-0.4%])</span> 257.60 | <span style='color: green'>(-1 [-0.8%])</span> 71.20 | <span style='color: green'>(-0 [-0.5%])</span> 55.39 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+1 [+1.6%])</span> 59.92 | <span style='color: red'>(+4 [+1.6%])</span> 239.67 | <span style='color: green'>(-0 [-0.2%])</span> 70.52 | <span style='color: red'>(+0 [+0.4%])</span> 53.60 |
| `quotient_poly_commit_time_ms` | <span style='color: green'>(-1 [-3.9%])</span> 15.37 | <span style='color: green'>(-3 [-3.9%])</span> 61.50 | <span style='color: green'>(-1 [-3.6%])</span> 17.92 | <span style='color: green'>(-0 [-3.5%])</span> 13.34 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+0 [+0.4%])</span> 68 | <span style='color: red'>(+1 [+0.4%])</span> 272 | <span style='color: red'>(+9 [+12.2%])</span> 83 | <span style='color: green'>(-5 [-8.8%])</span> 52 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 566 | 1 | 36 | 4,137,502 | 113.99 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 210 | 743 | 23,446,148 | 150,778,428 | 210 | 318 | 0 | 61.74 | 17.92 | 5 | 71.20 | 83 | 96 | 83 | 4 | 58 | 10,899,170 | 23 | 45 | 1,103,000 | 28.61 | 21 | 80 | 0 | 83 | 
| regex_program | 1 | 154 | 529 | 11,598,276 | 128,513,066 | 154 | 267 | 1 | 53.60 | 14.77 | 4 | 65.27 | 52 | 95 | 51 | 0 | 51 | 2,196,106 | 29 | 66 | 1,104,000 | 31.23 | 16 | 68 | 0 | 51 | 
| regex_program | 2 | 162 | 557 | 11,579,064 | 128,513,066 | 162 | 295 | 1 | 53.80 | 15.47 | 4 | 65.74 | 73 | 101 | 72 | 0 | 50 | 2,177,334 | 35 | 58 | 1,104,000 | 32.08 | 16 | 69 | 0 | 72 | 
| regex_program | 3 | 181 | 566 | 11,853,872 | 103,456,394 | 181 | 297 | 0 | 70.52 | 13.34 | 5 | 55.39 | 64 | 97 | 64 | 0 | 50 | 2,422,606 | 39 | 46 | 826,502 | 31.84 | 18 | 84 | 0 | 64 | 

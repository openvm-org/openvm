...
| `total_proof_time_ms ` |  589.25 |  2,357 |  725 |  536 |
...
| `execute_preflight_insn_mi/s` |  31.16 | -          |  32.45 |  29.02 |
| `trace_gen_time_ms   ` |  175.75 |  703 |  210 |  154 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  286 |  1,144 |  300 |  276 |
| `main_trace_commit_time_ms` |  51.75 |  207 |  57 |  50 |
| `generate_perm_trace_time_ms` |  27 |  108 |  32 |  21 |
| `perm_trace_commit_time_ms` |  63.73 |  254.90 |  69.89 |  55.36 |
| `quotient_poly_compute_time_ms` |  58.21 |  232.82 |  69.81 |  52.11 |
| `quotient_poly_commit_time_ms` |  15.57 |  62.29 |  18.19 |  13.29 |
| `pcs_opening_time_ms ` |  66.75 |  267 |  72 |  59 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 548 | 1 | 36 | 4,137,502 | 112.47 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 210 | 725 | 23,446,148 | 150,778,428 | 210 | 300 | 0 | 58.32 | 18.19 | 5 | 69.89 | 70 | 95 | 70 | 4 | 57 | 10,899,170 | 24 | 45 | 1,103,000 | 29.02 | 22 | 77 | 0 | 70 | 
| regex_program | 1 | 154 | 548 | 11,598,276 | 128,513,066 | 154 | 287 | 1 | 52.58 | 14.70 | 5 | 64.27 | 72 | 96 | 72 | 0 | 50 | 2,196,106 | 31 | 65 | 1,104,000 | 32.45 | 16 | 67 | 0 | 72 | 
| regex_program | 2 | 160 | 536 | 11,579,064 | 128,513,066 | 160 | 276 | 1 | 52.11 | 16.10 | 4 | 65.38 | 59 | 98 | 58 | 0 | 50 | 2,177,334 | 32 | 58 | 1,104,000 | 32.24 | 17 | 68 | 0 | 58 | 
| regex_program | 3 | 179 | 548 | 11,853,872 | 103,456,394 | 179 | 281 | 0 | 69.81 | 13.29 | 5 | 55.36 | 66 | 80 | 66 | 0 | 50 | 2,422,606 | 21 | 46 | 826,502 | 30.93 | 19 | 84 | 0 | 66 | 
...
Commit: https://github.com/openvm-org/openvm/commit/2920dae99f5a9f4b5441619b017c859265a31693
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/20309626210)

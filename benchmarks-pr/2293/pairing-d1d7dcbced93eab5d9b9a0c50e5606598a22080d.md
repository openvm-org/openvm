...
|:---|---:|---:|
| Total | <span style='color: red'>(+0 [+2.2%])</span> 1.55 | <span style='color: red'>(+0 [+2.0%])</span> 0.93 |
| pairing | <span style='color: red'>(+0 [+2.4%])</span> 1.48 | <span style='color: red'>(+0 [+2.3%])</span> 0.86 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+17 [+2.4%])</span> 739 | <span style='color: red'>(+34 [+2.4%])</span> 1,478 | <span style='color: red'>(+19 [+2.3%])</span> 863 | <span style='color: red'>(+15 [+2.5%])</span> 615 |
...
| `execute_metered_insn_mi/s` | <span style='color: red'>(+0 [+0.9%])</span> 25.44 | -          | <span style='color: red'>(+0 [+0.9%])</span> 25.44 | <span style='color: red'>(+0 [+0.9%])</span> 25.44 |
| `execute_preflight_insns` |  872,871 |  1,745,742 |  1,149,000 |  596,742 |
| `execute_preflight_time_ms` | <span style='color: red'>(+2 [+2.4%])</span> 85.50 | <span style='color: red'>(+4 [+2.4%])</span> 171 |  108 | <span style='color: red'>(+4 [+6.8%])</span> 63 |
| `execute_preflight_insn_mi/s` | <span style='color: green'>(-0 [-1.0%])</span> 14.50 | -          | <span style='color: green'>(-0 [-1.9%])</span> 18.06 | <span style='color: red'>(+0 [+0.4%])</span> 10.94 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+1 [+0.5%])</span> 187 | <span style='color: red'>(+2 [+0.5%])</span> 374 |  192 | <span style='color: red'>(+2 [+1.1%])</span> 182 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+14 [+3.9%])</span> 360 | <span style='color: red'>(+27 [+3.9%])</span> 720 | <span style='color: red'>(+16 [+4.1%])</span> 402 | <span style='color: red'>(+11 [+3.6%])</span> 318 |
...
| `perm_trace_commit_time_ms` | <span style='color: red'>(+0 [+0.6%])</span> 77.51 | <span style='color: red'>(+1 [+0.6%])</span> 155.02 | <span style='color: red'>(+0 [+0.5%])</span> 89.79 | <span style='color: red'>(+0 [+0.7%])</span> 65.23 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+1 [+0.9%])</span> 83.51 | <span style='color: red'>(+1 [+0.9%])</span> 167.02 | <span style='color: red'>(+1 [+1.3%])</span> 93.04 | <span style='color: red'>(+0 [+0.3%])</span> 73.99 |
| `quotient_poly_commit_time_ms` | <span style='color: green'>(-0 [-0.5%])</span> 17.55 | <span style='color: green'>(-0 [-0.5%])</span> 35.11 | <span style='color: red'>(+0 [+1.3%])</span> 20.06 | <span style='color: green'>(-0 [-2.8%])</span> 15.04 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+7 [+10.4%])</span> 74.50 | <span style='color: red'>(+14 [+10.4%])</span> 149 | <span style='color: red'>(+10 [+14.5%])</span> 79 | <span style='color: red'>(+4 [+6.1%])</span> 70 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 615 | 1 | 68 | 1,745,742 | 25.44 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 182 | 863 | 32,480,114 | 172,558,444 | 182 | 402 | 0 | 93.04 | 20.06 | 6 | 89.79 | 79 | 133 | 79 | 1 | 75 | 15,909,408 | 39 | 108 | 1,149,000 | 10.94 | 27 | 113 | 1 | 79 | 
| pairing | 1 | 192 | 615 | 22,464,232 | 119,958,502 | 192 | 318 | 1 | 73.99 | 15.04 | 6 | 65.23 | 70 | 102 | 69 | 0 | 55 | 9,498,894 | 34 | 63 | 596,742 | 18.06 | 20 | 89 | 1 | 69 | 

...
| `total_proof_time_ms ` |  590.50 |  2,362 |  721 |  535 |
...
| `execute_metered_insn_mi/s` |  112.18 | -          |  112.18 |  112.18 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  53.75 |  215 |  65 |  45 |
| `execute_preflight_insn_mi/s` |  30.60 | -          |  31.98 |  27.36 |
| `trace_gen_time_ms   ` |  178.50 |  714 |  212 |  156 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  285 |  1,140 |  295 |  272 |
| `main_trace_commit_time_ms` |  51.50 |  206 |  56 |  49 |
| `generate_perm_trace_time_ms` |  26.75 |  107 |  32 |  21 |
| `perm_trace_commit_time_ms` |  64.30 |  257.21 |  71.73 |  54.59 |
| `quotient_poly_compute_time_ms` |  60.03 |  240.11 |  72.28 |  53.44 |
| `quotient_poly_commit_time_ms` |  16.21 |  64.84 |  18.48 |  13.66 |
| `pcs_opening_time_ms ` |  63.25 |  253 |  77 |  56 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 562 | 1 | 36 | 4,137,502 | 112.18 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 212 | 721 | 23,446,148 | 150,778,428 | 212 | 295 | 0 | 60.45 | 18.48 | 5 | 71.73 | 60 | 98 | 60 | 4 | 56 | 10,899,170 | 25 | 46 | 1,103,000 | 27.36 | 22 | 79 | 0 | 60 | 
| regex_program | 1 | 156 | 535 | 11,598,276 | 128,513,066 | 156 | 272 | 1 | 53.44 | 16.30 | 4 | 65.49 | 56 | 95 | 56 | 0 | 50 | 2,196,106 | 29 | 65 | 1,104,000 | 31.64 | 17 | 70 | 0 | 56 | 
| regex_program | 2 | 163 | 544 | 11,579,064 | 128,513,066 | 163 | 281 | 1 | 53.93 | 16.40 | 5 | 65.40 | 60 | 98 | 59 | 0 | 51 | 2,177,334 | 32 | 59 | 1,104,000 | 31.44 | 17 | 70 | 0 | 59 | 
| regex_program | 3 | 183 | 562 | 11,853,872 | 103,456,394 | 183 | 292 | 0 | 72.28 | 13.66 | 5 | 54.59 | 77 | 79 | 77 | 0 | 49 | 2,422,606 | 21 | 45 | 826,502 | 31.98 | 19 | 87 | 0 | 77 | 
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/20322446961)

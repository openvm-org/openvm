...
| `total_proof_time_ms ` |  739.50 |  1,479 |  860 |  619 |
...
| `execute_preflight_insn_mi/s` |  14.80 | -          |  18.39 |  11.22 |
| `trace_gen_time_ms   ` |  190.50 |  381 |  196 |  185 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  360.50 |  721 |  400 |  321 |
| `main_trace_commit_time_ms` |  63.50 |  127 |  74 |  53 |
| `generate_perm_trace_time_ms` |  42 |  84 |  44 |  40 |
| `perm_trace_commit_time_ms` |  76.74 |  153.47 |  88.30 |  65.17 |
| `quotient_poly_compute_time_ms` |  82.93 |  165.85 |  92.10 |  73.75 |
| `quotient_poly_commit_time_ms` |  17.01 |  34.02 |  18.70 |  15.32 |
| `pcs_opening_time_ms ` |  73 |  146 |  78 |  68 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 619 | 1 | 62 | 1,745,742 | 27.77 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 185 | 860 | 32,480,114 | 172,558,444 | 185 | 400 | 0 | 92.10 | 18.70 | 6 | 88.30 | 78 | 135 | 78 | 1 | 74 | 15,909,408 | 44 | 105 | 1,149,000 | 11.22 | 27 | 111 | 1 | 78 | 
| pairing | 1 | 196 | 619 | 22,464,232 | 119,958,502 | 196 | 321 | 1 | 73.75 | 15.32 | 6 | 65.17 | 68 | 108 | 68 | 0 | 53 | 9,498,894 | 40 | 60 | 596,742 | 18.39 | 20 | 89 | 1 | 68 | 

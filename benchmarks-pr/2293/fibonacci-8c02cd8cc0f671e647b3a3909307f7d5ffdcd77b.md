...
|:---|---:|---:|
| Total | <span style='color: red'>(+0 [+4.8%])</span> 1.07 | <span style='color: red'>(+0 [+1.9%])</span> 0.60 |
| fibonacci_program | <span style='color: red'>(+0 [+4.2%])</span> 1.05 | <span style='color: red'>(+0 [+0.9%])</span> 0.59 |


| fibonacci_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+22 [+4.2%])</span> 527.50 | <span style='color: red'>(+43 [+4.2%])</span> 1,055 | <span style='color: red'>(+5 [+0.9%])</span> 585 | <span style='color: red'>(+38 [+8.8%])</span> 470 |
| `main_cells_used     ` |  1,050,201 |  2,100,402 |  1,064,416 |  1,035,986 |
| `total_cells_used    ` |  9,692,939 |  19,385,878 |  9,708,170 |  9,677,708 |
| `execute_metered_time_ms` | <span style='color: red'>(+6 [+60.0%])</span> 16 | -          | -          | -          |
| `execute_metered_insn_mi/s` | <span style='color: green'>(-59 [-39.6%])</span> 89.67 | -          | <span style='color: green'>(-59 [-39.6%])</span> 89.67 | <span style='color: green'>(-59 [-39.6%])</span> 89.67 |
| `execute_preflight_insns` |  750,104.50 |  1,500,209 |  873,000 |  627,209 |
| `execute_preflight_time_ms` |  29 |  58 |  33 |  25 |
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+1 [+3.3%])</span> 38 | -          | <span style='color: red'>(+1 [+3.7%])</span> 40.13 | <span style='color: red'>(+1 [+2.9%])</span> 35.88 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+4 [+2.1%])</span> 191.50 | <span style='color: red'>(+8 [+2.1%])</span> 383 | <span style='color: red'>(+5 [+2.6%])</span> 198 | <span style='color: red'>(+3 [+1.6%])</span> 185 |
| `memory_finalize_time_ms` | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+17 [+9.2%])</span> 201 | <span style='color: red'>(+34 [+9.2%])</span> 402 | <span style='color: red'>(+18 [+9.4%])</span> 210 | <span style='color: red'>(+16 [+9.1%])</span> 192 |
...
| `generate_perm_trace_time_ms` | <span style='color: green'>(-12 [-46.0%])</span> 13.50 | <span style='color: green'>(-23 [-46.0%])</span> 27 | <span style='color: green'>(-14 [-50.0%])</span> 14 | <span style='color: green'>(-9 [-40.9%])</span> 13 |
| `perm_trace_commit_time_ms` | <span style='color: red'>(+1 [+3.4%])</span> 42.13 | <span style='color: red'>(+3 [+3.4%])</span> 84.27 | <span style='color: red'>(+1 [+2.5%])</span> 44.81 | <span style='color: red'>(+2 [+4.5%])</span> 39.46 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+0 [+0.3%])</span> 31.85 | <span style='color: red'>(+0 [+0.3%])</span> 63.71 | <span style='color: red'>(+1 [+2.3%])</span> 33.90 | <span style='color: green'>(-1 [-2.0%])</span> 29.80 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+0 [+2.4%])</span> 12.57 | <span style='color: red'>(+1 [+2.4%])</span> 25.15 | <span style='color: red'>(+1 [+6.7%])</span> 13.37 | <span style='color: green'>(-0 [-2.1%])</span> 11.78 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+26 [+61.2%])</span> 68.50 | <span style='color: red'>(+52 [+61.2%])</span> 137 | <span style='color: red'>(+43 [+97.7%])</span> 87 | <span style='color: red'>(+9 [+22.0%])</span> 50 |
...
| --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 470 | 1 | 16 | 1,500,209 | 89.67 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 198 | 585 | 9,677,708 | 84,395,212 | 198 | 192 | 0 | 33.90 | 13.37 | 5 | 44.81 | 50 | 60 | 50 | 0 | 33 | 1,035,986 | 14 | 25 | 873,000 | 35.88 | 14 | 47 | 0 | 50 | 
| fibonacci_program | 1 | 185 | 470 | 9,708,170 | 74,305,770 | 185 | 210 | 1 | 29.80 | 11.78 | 4 | 39.46 | 87 | 53 | 86 | 0 | 28 | 1,064,416 | 13 | 33 | 627,209 | 40.13 | 11 | 41 | 0 | 86 | 

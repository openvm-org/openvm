...
|:---|---:|---:|
| Total | <span style='color: red'>(+0 [+3.1%])</span> 2.45 | <span style='color: red'>(+0 [+3.2%])</span> 0.78 |
| regex_program | <span style='color: red'>(+0 [+3.1%])</span> 2.41 | <span style='color: red'>(+0 [+3.2%])</span> 0.74 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+18 [+3.1%])</span> 602.25 | <span style='color: red'>(+72 [+3.1%])</span> 2,409 | <span style='color: red'>(+23 [+3.2%])</span> 738 |  540 |
...
| `execute_metered_insn_mi/s` | <span style='color: green'>(-4 [-3.1%])</span> 109.54 | -          | <span style='color: green'>(-4 [-3.1%])</span> 109.54 | <span style='color: green'>(-4 [-3.1%])</span> 109.54 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` | <span style='color: red'>(+2 [+4.8%])</span> 54.75 | <span style='color: red'>(+10 [+4.8%])</span> 219 | <span style='color: red'>(+3 [+4.8%])</span> 66 | <span style='color: red'>(+2 [+4.5%])</span> 46 |
| `execute_preflight_insn_mi/s` | <span style='color: green'>(-2 [-6.5%])</span> 30.06 | -          | <span style='color: green'>(-2 [-4.9%])</span> 31.65 | <span style='color: green'>(-2 [-8.0%])</span> 26.77 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+2 [+1.3%])</span> 181.50 | <span style='color: red'>(+9 [+1.3%])</span> 726 | <span style='color: red'>(+5 [+2.4%])</span> 215 | <span style='color: red'>(+2 [+1.3%])</span> 160 |
| `memory_finalize_time_ms` |  1 |  4 |  4 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+12 [+4.5%])</span> 291.75 | <span style='color: red'>(+50 [+4.5%])</span> 1,167 | <span style='color: red'>(+14 [+4.8%])</span> 305 | <span style='color: red'>(+4 [+1.5%])</span> 273 |
...
| `generate_perm_trace_time_ms` | <span style='color: red'>(+8 [+32.4%])</span> 34.75 | <span style='color: red'>(+34 [+32.4%])</span> 139 | <span style='color: red'>(+15 [+41.7%])</span> 51 | <span style='color: red'>(+8 [+42.1%])</span> 27 |
| `perm_trace_commit_time_ms` | <span style='color: red'>(+1 [+1.2%])</span> 65.25 | <span style='color: red'>(+3 [+1.2%])</span> 261 |  71.82 | <span style='color: red'>(+1 [+1.5%])</span> 55.94 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+2 [+2.9%])</span> 61.02 | <span style='color: red'>(+7 [+2.9%])</span> 244.07 | <span style='color: red'>(+1 [+2.1%])</span> 71.57 | <span style='color: red'>(+2 [+4.3%])</span> 55.35 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+0 [+1.9%])</span> 16.02 | <span style='color: red'>(+1 [+1.9%])</span> 64.07 | <span style='color: red'>(+0 [+2.6%])</span> 17.100 | <span style='color: red'>(+1 [+7.7%])</span> 14.10 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+1 [+1.3%])</span> 59.25 | <span style='color: red'>(+3 [+1.3%])</span> 237 | <span style='color: red'>(+11 [+17.7%])</span> 73 | <span style='color: green'>(-6 [-11.1%])</span> 48 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 574 | 1 | 37 | 4,137,502 | 109.54 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 215 | 738 | 23,446,148 | 150,778,428 | 215 | 305 | 0 | 61.75 | 17.100 | 5 | 71.82 | 66 | 100 | 65 | 4 | 58 | 10,899,170 | 27 | 48 | 1,103,000 | 26.77 | 22 | 80 | 0 | 65 | 
| regex_program | 1 | 160 | 557 | 11,598,276 | 128,513,066 | 160 | 289 | 1 | 55.41 | 15.77 | 4 | 66.27 | 48 | 118 | 48 | 0 | 50 | 2,196,106 | 51 | 66 | 1,104,000 | 31.65 | 17 | 71 | 0 | 48 | 
| regex_program | 2 | 166 | 540 | 11,579,064 | 128,513,066 | 166 | 273 | 1 | 55.35 | 16.21 | 4 | 66.98 | 50 | 99 | 50 | 0 | 51 | 2,177,334 | 31 | 59 | 1,104,000 | 31.64 | 17 | 72 | 0 | 50 | 
| regex_program | 3 | 185 | 574 | 11,853,872 | 103,456,394 | 185 | 300 | 0 | 71.57 | 14.10 | 5 | 55.94 | 73 | 90 | 73 | 0 | 49 | 2,422,606 | 30 | 46 | 826,502 | 30.20 | 19 | 86 | 0 | 73 | 

...
|:---|---:|---:|
| Total | <span style='color: green'>(-0 [-0.6%])</span> 2.39 | <span style='color: red'>(+0 [+0.3%])</span> 0.76 |
| regex_program | <span style='color: green'>(-0 [-0.6%])</span> 2.35 | <span style='color: red'>(+0 [+0.3%])</span> 0.73 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: green'>(-4 [-0.6%])</span> 587.50 | <span style='color: green'>(-15 [-0.6%])</span> 2,350 | <span style='color: red'>(+2 [+0.3%])</span> 727 | <span style='color: green'>(-18 [-3.3%])</span> 526 |
...
| `execute_metered_insn_mi/s` | <span style='color: red'>(+1 [+0.6%])</span> 109.65 | -          | <span style='color: red'>(+1 [+0.6%])</span> 109.65 | <span style='color: red'>(+1 [+0.6%])</span> 109.65 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` | <span style='color: red'>(+1 [+1.4%])</span> 53.75 | <span style='color: red'>(+3 [+1.4%])</span> 215 |  65 |  45 |
| `execute_preflight_insn_mi/s` | <span style='color: green'>(-1 [-2.9%])</span> 30.100 | -          | <span style='color: green'>(-1 [-1.9%])</span> 32.50 | <span style='color: green'>(-0 [-1.1%])</span> 28.56 |
| `trace_gen_time_ms   ` | <span style='color: green'>(-2 [-1.0%])</span> 176.75 | <span style='color: green'>(-7 [-1.0%])</span> 707 | <span style='color: green'>(-1 [-0.5%])</span> 210 |  155 |
| `memory_finalize_time_ms` |  1 |  4 |  4 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: green'>(-3 [-1.0%])</span> 283 | <span style='color: green'>(-11 [-1.0%])</span> 1,132 | <span style='color: red'>(+2 [+0.7%])</span> 301 | <span style='color: green'>(-9 [-3.3%])</span> 264 |
| `main_trace_commit_time_ms` | <span style='color: green'>(-0 [-1.0%])</span> 50.75 | <span style='color: green'>(-2 [-1.0%])</span> 203 |  56 |  49 |
| `generate_perm_trace_time_ms` | <span style='color: red'>(+3 [+12.5%])</span> 27 | <span style='color: red'>(+12 [+12.5%])</span> 108 | <span style='color: red'>(+5 [+17.9%])</span> 33 |  22 |
| `perm_trace_commit_time_ms` |  64.62 |  258.47 | <span style='color: red'>(+1 [+1.3%])</span> 72.72 | <span style='color: green'>(-0 [-0.2%])</span> 55.55 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+0 [+0.5%])</span> 59.28 | <span style='color: red'>(+1 [+0.5%])</span> 237.13 | <span style='color: green'>(-0 [-0.6%])</span> 70.30 | <span style='color: green'>(-0 [-0.4%])</span> 53.18 |
| `quotient_poly_commit_time_ms` | <span style='color: green'>(-0 [-2.5%])</span> 15.60 | <span style='color: green'>(-2 [-2.5%])</span> 62.41 | <span style='color: green'>(-1 [-6.2%])</span> 17.45 |  13.83 |
| `pcs_opening_time_ms ` | <span style='color: green'>(-6 [-8.1%])</span> 62.25 | <span style='color: green'>(-22 [-8.1%])</span> 249 |  74 | <span style='color: green'>(-7 [-12.3%])</span> 50 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 559 | 1 | 37 | 4,137,502 | 109.65 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 210 | 727 | 23,446,148 | 150,778,428 | 210 | 301 | 0 | 59.42 | 17.45 | 5 | 72.72 | 67 | 99 | 67 | 4 | 56 | 10,899,170 | 25 | 46 | 1,103,000 | 28.56 | 22 | 77 | 0 | 67 | 
| regex_program | 1 | 155 | 526 | 11,598,276 | 128,513,066 | 155 | 264 | 1 | 53.18 | 16.09 | 5 | 65.14 | 50 | 94 | 50 | 0 | 49 | 2,196,106 | 28 | 65 | 1,104,000 | 32.05 | 17 | 69 | 0 | 50 | 
| regex_program | 2 | 160 | 538 | 11,579,064 | 128,513,066 | 160 | 277 | 1 | 54.23 | 15.05 | 5 | 65.06 | 58 | 99 | 58 | 0 | 49 | 2,177,334 | 33 | 59 | 1,104,000 | 30.88 | 16 | 69 | 0 | 58 | 
| regex_program | 3 | 182 | 559 | 11,853,872 | 103,456,394 | 182 | 290 | 0 | 70.30 | 13.83 | 5 | 55.55 | 74 | 81 | 74 | 0 | 49 | 2,422,606 | 22 | 45 | 826,502 | 32.50 | 19 | 85 | 0 | 74 | 

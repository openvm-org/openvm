...
|:---|---:|---:|---:|
| Total |  2.44 |  0.77 | 0.77 |
| regex_program |  2.44 |  0.77 |  0.77 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  600.25 |  2,401 |  729 |  548 |
...
| `execute_metered_insn_mi/s` |  109.55 | -          |  109.55 |  109.55 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  53.50 |  214 |  66 |  45 |
| `execute_preflight_insn_mi/s` |  31.16 | -          |  32.48 |  28.39 |
| `trace_gen_time_ms   ` |  182 |  728 |  218 |  158 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  290.50 |  1,162 |  301 |  283 |
| `main_trace_commit_time_ms` |  52 |  208 |  57 |  50 |
| `generate_perm_trace_time_ms` |  28.50 |  114 |  35 |  22 |
| `perm_trace_commit_time_ms` |  64.55 |  258.19 |  70.69 |  55.81 |
| `quotient_poly_compute_time_ms` |  59.80 |  239.19 |  71.86 |  55.04 |
| `quotient_poly_commit_time_ms` |  16.50 |  65.99 |  19.29 |  14.18 |
| `pcs_opening_time_ms ` |  66 |  264 |  77 |  59 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 558 | 1 | 37 | 4,137,502 | 109.55 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 218 | 729 | 23,446,148 | 150,778,428 | 218 | 293 | 0 | 56.89 | 19.29 | 5 | 70.69 | 61 | 96 | 61 | 4 | 57 | 10,899,170 | 25 | 45 | 1,103,000 | 28.39 | 22 | 76 | 0 | 61 | 
| regex_program | 1 | 158 | 566 | 11,598,276 | 128,513,066 | 158 | 301 | 1 | 55.04 | 15.86 | 4 | 65.61 | 77 | 101 | 77 | 0 | 50 | 2,196,106 | 35 | 66 | 1,104,000 | 31.62 | 17 | 71 | 0 | 77 | 
| regex_program | 2 | 166 | 548 | 11,579,064 | 128,513,066 | 166 | 283 | 1 | 55.39 | 16.65 | 5 | 66.08 | 59 | 99 | 59 | 0 | 51 | 2,177,334 | 32 | 58 | 1,104,000 | 32.14 | 17 | 72 | 0 | 59 | 
| regex_program | 3 | 186 | 558 | 11,853,872 | 103,456,394 | 186 | 285 | 0 | 71.86 | 14.18 | 5 | 55.81 | 67 | 80 | 66 | 0 | 50 | 2,422,606 | 22 | 45 | 826,502 | 32.48 | 19 | 87 | 0 | 66 | 
...
Commit: https://github.com/openvm-org/openvm/commit/1449e8655ccf36f751b86c0544274ab959a65b7f
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/20308841711)

...
|:---|---:|---:|
| Total |  25.30 |  16.36 |
| regex_program |  25.25 |  16.31 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  12,627 |  25,254 |  16,312 |  8,942 |
...
| `execute_metered_insn_mi/s` |  91.60 | -          |  91.60 |  91.60 |
| `execute_preflight_insns` |  2,054,306.50 |  4,108,613 |  2,211,000 |  1,897,613 |
| `execute_preflight_time_ms` |  111 |  222 |  123 |  99 |
| `execute_preflight_insn_mi/s` |  27.86 | -          |  31.63 |  24.10 |
| `trace_gen_time_ms   ` |  349 |  698 |  422 |  276 |
| `memory_finalize_time_ms` |  2 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  11,821 |  23,642 |  15,412 |  8,230 |
| `main_trace_commit_time_ms` |  1,922 |  3,844 |  2,557 |  1,287 |
| `generate_perm_trace_time_ms` |  2,418 |  4,836 |  3,136 |  1,700 |
| `perm_trace_commit_time_ms` |  2,151.50 |  4,303 |  2,816 |  1,487 |
| `quotient_poly_compute_time_ms` |  1,577 |  3,154 |  2,062 |  1,092 |
| `quotient_poly_commit_time_ms` |  999.50 |  1,999 |  1,313 |  686 |
| `pcs_opening_time_ms ` |  2,742.50 |  5,485 |  3,513 |  1,972 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 8,942 | 40 | 1 | 44 | 4,108,613 | 91.60 | 170 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 422 | 16,312 | 211,757,615 | 373,183,036 | 422 | 15,412 | 0 | 2,062 | 1,313 | 2,816 | 3,513 | 41 | 4 | 2,557 | 91,281,201 | 3,136 | 99 | 2,211,000 | 24.10 | 
| regex_program | 1 | 276 | 8,942 | 174,327,965 | 196,838,026 | 276 | 8,230 | 25 | 1,092 | 686 | 1,487 | 1,972 | 40 | 0 | 1,287 | 73,454,163 | 1,700 | 123 | 1,897,613 | 31.63 | 

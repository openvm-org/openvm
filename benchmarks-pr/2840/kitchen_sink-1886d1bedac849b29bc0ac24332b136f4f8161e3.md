...
|:---|---:|---:|---:|
| Total |  5.20 |  4.31 |  4.31 |
| app_proof |  3.71 |  2.83 |  2.83 |
| leaf |  0.93 |  0.93 |  0.93 |
...
| `total_proof_time_ms ` |  1,845.50 |  3,691 |  2,802 |  889 |
| `execute_metered_time_ms` |  24 | -          | -          | -          |
| `execute_metered_insns` |  1,979,971 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  81.29 | -          |  81.29 |  81.29 |
| `execute_preflight_insns` |  989,985.50 |  1,979,971 |  1,445,000 |  534,971 |
| `execute_preflight_time_ms` |  77 |  154 |  86 |  68 |
| `execute_preflight_insn_mi/s` |  28.47 | -          |  29.23 |  27.71 |
| `trace_gen_time_ms   ` |  38.50 |  77 |  61 |  16 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,640.50 |  3,281 |  2,537 |  744 |
| `prover.main_trace_commit_time_ms` |  587 |  1,174 |  950 |  224 |
| `prover.rap_constraints_time_ms` |  916.50 |  1,833 |  1,387 |  446 |
| `prover.openings_time_ms` |  135.50 |  271 |  199 |  72 |
| `prover.rap_constraints.logup_gkr_time_ms` |  148.50 |  297 |  211 |  86 |
| `prover.rap_constraints.round0_time_ms` |  552.50 |  1,105 |  850 |  255 |
| `prover.rap_constraints.mle_rounds_time_ms` |  215 |  430 |  325 |  105 |
...
| `prover.openings.whir_time_ms` |  35 |  70 |  43 |  27 |
...
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  814 |  814 |  814 |  814 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/1886d1bedac849b29bc0ac24332b136f4f8161e3/kitchen_sink-1886d1bedac849b29bc0ac24332b136f4f8161e3.memory.svg)
...
| generate mem proving ctxs | 1.57 | app_proof.0 |
| set initial memory | 1.57 | app_proof.1 |
...
| app_proof |  |  |  |  |  | 889 |  |  | 24 | 1,979,971 | 81.29 | 0 | 3,720 |  | 
...
| app_proof | VmAirWrapper<Rv64RdWriteAdapterAir, Rv64AuipcCoreAir> | 1 | 4 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 20 | 277 | 20 | 6 | 1 | 2 | 2 | 2 | 
| internal_recursive.0 | 1 | 10 | 151 | 10 | 1 | 0 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 9 | 128 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 115 | 930 | 115 | 24 | 10 | 18 | 2 | 2 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,577,979 | 256 | 116 | 0 | 0 | 107 | 35 | 34 | 51 | 20 | 0 | 32 | 18 | 14 | 3 | 10 | 116 | 107 | 0 | 2 | 20 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,767 | 141 | 45 | 0 | 0 | 67 | 25 | 24 | 27 | 14 | 0 | 27 | 19 | 8 | 1 | 6 | 46 | 67 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 118 | 31 | 0 | 0 | 62 | 23 | 23 | 24 | 14 | 0 | 23 | 16 | 7 | 1 | 5 | 32 | 62 | 0 | 2 | 13 | 0 | 0 | 
| leaf | 0 | prover | 260,613,236 | 814 | 396 | 0 | 1 | 344 | 134 | 133 | 75 | 134 | 0 | 73 | 33 | 39 | 21 | 18 | 397 | 344 | 0 | 6 | 133 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 902,782,844 | 2,537 | 950 | 0 | 306 | 1,387 | 850 | 849 | 325 | 211 | 62 | 199 | 43 | 155 | 87 | 68 | 950 | 1,387 | 0 | 3 | 146 | 0 | 0 | 
| app_proof | prover | 1 | 279,963,980 | 744 | 224 | 0 | 1 | 446 | 255 | 254 | 105 | 86 | 0 | 72 | 27 | 45 | 24 | 20 | 224 | 446 | 0 | 3 | 85 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 61 | 2,802 | 61 | 135 | 0 | 4 | 68 | 1,445,000 | 27.71 | 
| app_proof | 1 | 16 | 889 | 16 | 41 | 0 | 2 | 86 | 534,971 | 29.23 | 

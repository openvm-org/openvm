...
|:---|---:|---:|---:|
| Total |  5.24 |  4.35 |  4.35 |
| app_proof |  3.73 |  2.85 |  2.85 |
| leaf |  0.94 |  0.94 |  0.94 |
...
| `total_proof_time_ms ` |  1,854.50 |  3,709 |  2,823 |  886 |
| `compile_metered_time_ms` |  3 |  3 |  3 |  3 |
| `execute_metered_time_ms` |  24 | -          | -          | -          |
| `execute_metered_insns` |  1,979,971 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  80.33 | -          |  80.33 |  80.33 |
| `execute_preflight_insns` |  989,985.50 |  1,979,971 |  1,445,000 |  534,971 |
| `execute_preflight_time_ms` |  75.50 |  151 |  83 |  68 |
| `execute_preflight_insn_mi/s` |  31.100 | -          |  32.46 |  31.54 |
| `trace_gen_time_ms   ` |  37.50 |  75 |  59 |  16 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,652 |  3,304 |  2,559 |  745 |
| `prover.main_trace_commit_time_ms` |  593.50 |  1,187 |  962 |  225 |
| `prover.rap_constraints_time_ms` |  922 |  1,844 |  1,398 |  446 |
| `prover.openings_time_ms` |  136 |  272 |  199 |  73 |
| `prover.rap_constraints.logup_gkr_time_ms` |  148.50 |  297 |  211 |  86 |
| `prover.rap_constraints.round0_time_ms` |  554 |  1,108 |  854 |  254 |
| `prover.rap_constraints.mle_rounds_time_ms` |  218.50 |  437 |  332 |  105 |
...
| `prover.openings.whir_time_ms` |  34 |  68 |  41 |  27 |
...
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  826 |  826 |  826 |  826 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/814c620cb787f91e51e46c2efc1eb0c72a2f89a8/kitchen_sink-814c620cb787f91e51e46c2efc1eb0c72a2f89a8.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 73 | 9 |  |  | 0 |  | 372 | 9 |  |  |  |  |  |  | 
| app_proof |  |  |  |  |  | 886 |  |  | 24 | 1,979,971 | 80.33 | 0 | 3,739 |  | 
| internal_for_leaf |  |  |  | 282 |  |  |  |  |  |  |  |  |  | 282 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,577,979 | 261 | 117 | 0 | 0 | 109 | 35 | 34 | 52 | 21 | 0 | 34 | 20 | 14 | 4 | 10 | 117 | 109 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,767 | 142 | 45 | 0 | 0 | 68 | 25 | 24 | 27 | 14 | 0 | 28 | 19 | 8 | 1 | 6 | 45 | 68 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 121 | 31 | 0 | 0 | 63 | 24 | 23 | 24 | 14 | 0 | 25 | 18 | 7 | 1 | 5 | 32 | 63 | 0 | 2 | 13 | 0 | 0 | 
| leaf | 0 | prover | 260,613,236 | 826 | 399 | 0 | 1 | 348 | 134 | 133 | 76 | 137 | 0 | 77 | 37 | 40 | 21 | 18 | 400 | 348 | 0 | 6 | 135 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 902,782,844 | 2,559 | 961 | 0 | 310 | 1,398 | 854 | 853 | 332 | 211 | 63 | 199 | 41 | 157 | 88 | 69 | 962 | 1,398 | 0 | 3 | 146 | 0 | 0 | 
| app_proof | prover | 1 | 279,963,980 | 745 | 225 | 0 | 1 | 446 | 254 | 254 | 105 | 86 | 0 | 73 | 27 | 45 | 25 | 20 | 225 | 446 | 0 | 3 | 85 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 2 | 59 | 2,823 | 59 | 136 | 0 | 3 | 68 | 1,445,000 | 31.54 | 
| app_proof | 1 | 1 | 16 | 886 | 16 | 41 | 0 | 2 | 83 | 534,971 | 32.46 | 

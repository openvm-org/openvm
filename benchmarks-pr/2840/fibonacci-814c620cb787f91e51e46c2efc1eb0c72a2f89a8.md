...
|:---|---:|---:|---:|
| Total |  2.38 |  1.45 |  1.45 |
| app_proof |  1.43 |  0.50 |  0.50 |
| leaf |  0.43 |  0.43 |  0.43 |
...
| `total_proof_time_ms ` |  353 |  1,412 |  480 |  183 |
...
| `execute_preflight_insn_mi/s` |  37.88 | -          |  38.20 |  37.59 |
| `trace_gen_time_ms   ` |  35 |  140 |  63 |  25 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  213.25 |  853 |  264 |  73 |
| `prover.main_trace_commit_time_ms` |  42.25 |  169 |  51 |  16 |
| `prover.rap_constraints_time_ms` |  139 |  556 |  177 |  34 |
| `prover.openings_time_ms` |  31.25 |  125 |  35 |  22 |
| `prover.rap_constraints.logup_gkr_time_ms` |  96.50 |  386 |  123 |  17 |
| `prover.rap_constraints.round0_time_ms` |  28 |  112 |  37 |  9 |
| `prover.rap_constraints.mle_rounds_time_ms` |  13.25 |  53 |  16 |  7 |
| `prover.openings.stacked_reduction_time_ms` |  9 |  36 |  12 |  3 |
| `prover.openings.stacked_reduction.round0_time_ms` |  4 |  16 |  6 |  0 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  4.50 |  18 |  6 |  2 |
| `prover.openings.whir_time_ms` |  22 |  88 |  24 |  19 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/814c620cb787f91e51e46c2efc1eb0c72a2f89a8/fibonacci-814c620cb787f91e51e46c2efc1eb0c72a2f89a8.memory.svg)
...
| generate mem proving ctxs | 1.08 | app_proof.0 |
| set initial memory | 1.08 | app_proof.1 |
...
| app_proof |  |  |  |  |  | 183 |  |  | 20 | 4,000,051 | 199.84 | 0 | 1,438 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 18 | 230 | 18 | 5 | 0 | 2 | 1 | 1 | 
| internal_recursive.0 | 1 | 11 | 154 | 11 | 1 | 0 | 2 | 0 | 0 | 
| internal_recursive.1 | 1 | 9 | 129 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 56 | 434 | 56 | 22 | 2 | 1 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 27,289,403 | 211 | 81 | 0 | 0 | 97 | 31 | 31 | 45 | 20 | 0 | 32 | 21 | 11 | 2 | 8 | 81 | 97 | 0 | 2 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,767 | 142 | 45 | 0 | 0 | 67 | 24 | 24 | 28 | 14 | 0 | 29 | 20 | 8 | 1 | 6 | 46 | 67 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 119 | 31 | 0 | 0 | 59 | 22 | 21 | 24 | 13 | 0 | 27 | 20 | 7 | 1 | 5 | 32 | 59 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 102,779,942 | 377 | 168 | 0 | 0 | 160 | 70 | 69 | 46 | 43 | 0 | 48 | 29 | 18 | 8 | 9 | 169 | 160 | 0 | 5 | 42 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 62,648,824 | 264 | 51 | 0 | 0 | 177 | 37 | 37 | 16 | 123 | 0 | 35 | 23 | 12 | 6 | 6 | 51 | 177 | 0 | 3 | 122 | 0 | 0 | 
| app_proof | prover | 1 | 62,602,932 | 259 | 51 | 0 | 0 | 172 | 33 | 33 | 15 | 123 | 0 | 35 | 24 | 10 | 5 | 5 | 51 | 172 | 0 | 3 | 122 | 0 | 0 | 
| app_proof | prover | 2 | 62,602,932 | 257 | 51 | 0 | 0 | 173 | 33 | 33 | 15 | 123 | 0 | 33 | 22 | 11 | 5 | 5 | 51 | 172 | 0 | 3 | 122 | 0 | 0 | 
| app_proof | prover | 3 | 9,072,096 | 73 | 16 | 0 | 0 | 34 | 9 | 9 | 7 | 17 | 0 | 22 | 19 | 3 | 0 | 2 | 16 | 34 | 0 | 2 | 16 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 2 | 25 | 480 | 25 | 137 | 0 | 4 | 52 | 1,310,000 | 38.20 | 
| app_proof | 1 | 1 | 26 | 375 | 26 | 41 | 0 | 2 | 48 | 1,310,000 | 38.13 | 
| app_proof | 2 | 1 | 26 | 374 | 26 | 41 | 0 | 2 | 48 | 1,310,000 | 37.59 | 
| app_proof | 3 | 1 | 63 | 183 | 63 | 41 | 0 | 2 | 4 | 70,051 | 37.60 | 

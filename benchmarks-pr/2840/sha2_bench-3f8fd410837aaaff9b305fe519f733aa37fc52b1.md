...
|:---|---:|---:|---:|
| Total |  11.12 |  4.61 |  4.61 |
| app_proof |  9.03 |  2.52 |  2.52 |
| leaf |  1.41 |  1.41 |  1.41 |
...
| `total_proof_time_ms ` |  2,232.50 |  8,930 |  2,422 |  2,148 |
| `execute_metered_time_ms` |  97 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  113.99 | -          |  113.99 |  113.99 |
| `execute_preflight_insns` |  2,791,990.25 |  11,167,961 |  2,851,000 |  2,614,961 |
| `execute_preflight_time_ms` |  165.50 |  662 |  211 |  101 |
| `execute_preflight_insn_mi/s` |  33.69 | -          |  34.66 |  31.52 |
| `trace_gen_time_ms   ` |  57.75 |  231 |  63 |  54 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,942.75 |  7,771 |  2,120 |  1,881 |
| `prover.main_trace_commit_time_ms` |  536.50 |  2,146 |  626 |  506 |
| `prover.rap_constraints_time_ms` |  1,267.50 |  5,070 |  1,355 |  1,233 |
| `prover.openings_time_ms` |  138 |  552 |  141 |  136 |
| `prover.rap_constraints.logup_gkr_time_ms` |  356.50 |  1,426 |  445 |  327 |
| `prover.rap_constraints.round0_time_ms` |  664 |  2,656 |  669 |  660 |
| `prover.rap_constraints.mle_rounds_time_ms` |  246.50 |  986 |  249 |  243 |
| `prover.openings.stacked_reduction_time_ms` |  98 |  392 |  99 |  97 |
| `prover.openings.stacked_reduction.round0_time_ms` |  59.25 |  237 |  60 |  59 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  38.50 |  154 |  39 |  38 |
| `prover.openings.whir_time_ms` |  39.25 |  157 |  41 |  37 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,411 |  1,411 |  1,411 |  1,411 |
| `execute_preflight_time_ms` |  3 |  3 |  3 |  3 |
| `trace_gen_time_ms   ` |  144 |  144 |  144 |  144 |
| `generate_blob_total_time_ms` |  22 |  22 |  22 |  22 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,266 |  1,266 |  1,266 |  1,266 |
| `prover.main_trace_commit_time_ms` |  805 |  805 |  805 |  805 |
| `prover.rap_constraints_time_ms` |  350 |  350 |  350 |  350 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/3f8fd410837aaaff9b305fe519f733aa37fc52b1/sha2_bench-3f8fd410837aaaff9b305fe519f733aa37fc52b1.memory.svg)

| Module | Max (GB) | Max At |
| --- | ---: | --- |
| frac_sumcheck.gkr_rounds | 11.55 | app_proof.prover.3 |
| prover.batch_constraints.before_round0 | 11.55 | app_proof.prover.3 |
| frac_sumcheck.segment_tree | 11.45 | app_proof.prover.0 |
| prover.gkr_input_evals | 11.45 | app_proof.prover.0 |
| prover.batch_constraints.round0 | 10.40 | app_proof.prover.0 |
| prover.rap_constraints | 10.40 | app_proof.prover.0 |
| prover.batch_constraints.fold_ple_evals | 10.40 | app_proof.prover.0 |
| prover.prove_whir_opening | 9.79 | leaf.0.prover |
| prover.openings | 9.79 | leaf.0.prover |
| prover.merkle_tree | 9.79 | leaf.0.prover |
...
| generate mem proving ctxs | 1.09 | app_proof.3 |
| set initial memory | 1.09 | app_proof.1 |
...
| 20 | VmAirWrapper<Rv64LoadStoreAdapterAir, LoadSignExtendCoreAir<8, 8> | 26 | 22 | 3 | 
| 21 | VmAirWrapper<Rv64LoadStoreAdapterAir, LoadStoreCoreAir<8> | 33 | 31 | 3 | 
...
| app_proof |  |  |  |  |  | 2,148 |  |  | 97 | 11,167,961 | 113.99 | 0 | 9,034 |  | 
| internal_for_leaf |  |  |  | 379 |  |  |  |  |  |  |  |  |  | 379 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 25 | 379 | 25 | 7 | 2 | 2 | 3 | 3 | 
| internal_recursive.0 | 1 | 12 | 172 | 12 | 2 | 0 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 9 | 133 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 144 | 1,411 | 144 | 50 | 22 | 3 | 6 | 6 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 61,220,667 | 353 | 183 | 0 | 0 | 130 | 38 | 37 | 64 | 27 | 0 | 39 | 20 | 18 | 5 | 12 | 184 | 130 | 0 | 2 | 26 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,943 | 160 | 49 | 0 | 0 | 73 | 25 | 25 | 29 | 17 | 0 | 36 | 28 | 8 | 1 | 6 | 49 | 73 | 0 | 3 | 17 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 123 | 31 | 0 | 0 | 62 | 23 | 22 | 24 | 14 | 0 | 29 | 21 | 7 | 1 | 5 | 32 | 62 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 425,192,422 | 1,266 | 805 | 0 | 160 | 350 | 170 | 169 | 104 | 75 | 0 | 110 | 45 | 64 | 35 | 28 | 805 | 350 | 0 | 7 | 74 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 640,057,593 | 2,120 | 626 | 0 | 119 | 1,355 | 660 | 659 | 249 | 445 | 133 | 139 | 41 | 98 | 59 | 39 | 626 | 1,355 | 0 | 3 | 310 | 0 | 0 | 
| app_proof | prover | 1 | 640,057,356 | 1,885 | 507 | 0 | 2 | 1,241 | 665 | 664 | 249 | 327 | 0 | 136 | 38 | 97 | 59 | 38 | 507 | 1,241 | 0 | 3 | 325 | 0 | 0 | 
| app_proof | prover | 2 | 640,057,356 | 1,885 | 507 | 0 | 2 | 1,241 | 669 | 668 | 245 | 327 | 0 | 136 | 37 | 98 | 59 | 38 | 507 | 1,241 | 0 | 3 | 325 | 0 | 0 | 
| app_proof | prover | 3 | 640,057,588 | 1,881 | 506 | 0 | 2 | 1,233 | 662 | 662 | 243 | 327 | 0 | 141 | 41 | 99 | 60 | 39 | 506 | 1,233 | 0 | 4 | 326 | 0 | 0 | 

| group | phase | segment | trace_height_constraint | weighted_sum | threshold |
| --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 0 | 126,509,457 | 2,013,265,921 | 
| app_proof | prover | 1 | 0 | 126,509,322 | 2,013,265,921 | 
| app_proof | prover | 2 | 0 | 126,509,322 | 2,013,265,921 | 
| app_proof | prover | 3 | 0 | 126,509,438 | 2,013,265,921 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 63 | 2,422 | 63 | 135 | 0 | 4 | 101 | 2,851,000 | 31.52 | 
| app_proof | 1 | 57 | 2,196 | 57 | 41 | 0 | 2 | 211 | 2,851,000 | 34.66 | 
| app_proof | 2 | 57 | 2,164 | 57 | 41 | 0 | 2 | 179 | 2,851,000 | 34.42 | 
| app_proof | 3 | 54 | 2,148 | 54 | 41 | 0 | 2 | 171 | 2,614,961 | 34.17 | 

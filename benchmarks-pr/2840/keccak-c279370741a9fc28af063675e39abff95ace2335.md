...
|:---|---:|---:|---:|
| Total |  17.33 |  4.83 |  4.83 |
| app_proof |  14.37 |  2.63 |  2.63 |
| leaf |  2.18 |  1.42 |  1.42 |
...
| `total_proof_time_ms ` |  2,371.67 |  14,230 |  2,490 |  2,323 |
| `execute_metered_time_ms` |  140 | -          | -          | -          |
| `execute_metered_insns` |  14,365,133 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  101.87 | -          |  101.87 |  101.87 |
| `execute_preflight_insns` |  2,394,188.83 |  14,365,133 |  2,413,000 |  2,300,133 |
| `execute_preflight_time_ms` |  243.33 |  1,460 |  338 |  90 |
| `execute_preflight_insn_mi/s` |  32.61 | -          |  33.55 |  30.31 |
| `trace_gen_time_ms   ` |  35.67 |  214 |  40 |  34 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  2,034.50 |  12,207 |  2,224 |  1,933 |
| `prover.main_trace_commit_time_ms` |  691.50 |  4,149 |  853 |  658 |
| `prover.rap_constraints_time_ms` |  1,163.83 |  6,983 |  1,188 |  1,096 |
| `prover.openings_time_ms` |  178 |  1,068 |  181 |  177 |
| `prover.rap_constraints.logup_gkr_time_ms` |  330.50 |  1,983 |  352 |  259 |
| `prover.rap_constraints.round0_time_ms` |  506.17 |  3,037 |  509 |  502 |
| `prover.rap_constraints.mle_rounds_time_ms` |  326.50 |  1,959 |  329 |  325 |
| `prover.openings.stacked_reduction_time_ms` |  134.17 |  805 |  136 |  132 |
...
| `prover.openings.whir_time_ms` |  43.33 |  260 |  48 |  41 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,090 |  2,180 |  1,418 |  762 |
| `execute_preflight_time_ms` |  5.50 |  11 |  6 |  5 |
| `trace_gen_time_ms   ` |  134 |  268 |  179 |  89 |
| `generate_blob_total_time_ms` |  24.50 |  49 |  33 |  16 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  955.50 |  1,911 |  1,239 |  672 |
| `prover.main_trace_commit_time_ms` |  542.50 |  1,085 |  714 |  371 |
| `prover.rap_constraints_time_ms` |  314.50 |  629 |  406 |  223 |
| `prover.openings_time_ms` |  98 |  196 |  119 |  77 |
...
| `prover.openings.whir_time_ms` |  43 |  86 |  46 |  40 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/c279370741a9fc28af063675e39abff95ace2335/keccak-c279370741a9fc28af063675e39abff95ace2335.memory.svg)
...
| app_proof |  |  |  |  |  | 2,323 |  |  | 140 | 14,365,133 | 101.87 | 0 | 14,378 |  | 
| internal_for_leaf |  |  |  | 496 |  |  |  |  |  |  |  |  |  | 497 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 42 | 496 | 42 | 13 | 4 | 2 | 2 | 2 | 
| internal_recursive.0 | 1 | 13 | 159 | 13 | 2 | 1 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 9 | 127 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 179 | 1,418 | 179 | 64 | 33 | 6 | 7 | 7 | 
| leaf | 1 | 89 | 762 | 89 | 32 | 16 | 5 | 7 | 7 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 81,415,028 | 454 | 239 | 0 | 1 | 171 | 49 | 48 | 91 | 31 | 0 | 42 | 18 | 23 | 7 | 15 | 240 | 171 | 0 | 3 | 29 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,879 | 146 | 47 | 0 | 0 | 72 | 24 | 23 | 29 | 18 | 0 | 26 | 17 | 8 | 2 | 6 | 47 | 72 | 0 | 2 | 17 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 118 | 31 | 0 | 0 | 62 | 23 | 23 | 24 | 14 | 0 | 23 | 16 | 7 | 1 | 5 | 31 | 62 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 476,578,662 | 1,239 | 713 | 0 | 2 | 406 | 199 | 198 | 121 | 84 | 0 | 119 | 46 | 72 | 41 | 31 | 714 | 406 | 0 | 6 | 84 | 0 | 0 | 
| leaf | 1 | prover | 240,255,732 | 672 | 371 | 0 | 1 | 223 | 106 | 105 | 66 | 51 | 0 | 77 | 40 | 36 | 19 | 16 | 371 | 223 | 0 | 6 | 50 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 847,541,900 | 2,224 | 853 | 0 | 198 | 1,188 | 506 | 505 | 329 | 352 | 98 | 181 | 48 | 132 | 80 | 51 | 853 | 1,188 | 0 | 3 | 253 | 0 | 0 | 
| app_proof | prover | 1 | 847,541,900 | 1,933 | 659 | 0 | 3 | 1,096 | 509 | 508 | 327 | 259 | 0 | 177 | 43 | 134 | 81 | 52 | 659 | 1,096 | 0 | 3 | 257 | 0 | 0 | 
| app_proof | prover | 2 | 847,541,900 | 2,008 | 659 | 0 | 3 | 1,171 | 502 | 501 | 326 | 343 | 102 | 177 | 41 | 135 | 82 | 52 | 659 | 1,171 | 0 | 4 | 239 | 0 | 0 | 
| app_proof | prover | 3 | 847,541,900 | 2,011 | 659 | 0 | 2 | 1,174 | 507 | 506 | 325 | 341 | 101 | 177 | 42 | 134 | 81 | 52 | 660 | 1,174 | 0 | 3 | 239 | 0 | 0 | 
| app_proof | prover | 4 | 847,541,900 | 2,019 | 660 | 0 | 3 | 1,178 | 507 | 506 | 327 | 343 | 102 | 179 | 43 | 136 | 81 | 54 | 660 | 1,178 | 0 | 3 | 239 | 0 | 0 | 
| app_proof | prover | 5 | 847,541,900 | 2,012 | 658 | 0 | 3 | 1,176 | 506 | 505 | 325 | 345 | 103 | 177 | 43 | 134 | 81 | 52 | 658 | 1,176 | 0 | 4 | 240 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 40 | 2,490 | 40 | 135 | 0 | 4 | 90 | 2,413,000 | 30.31 | 
| app_proof | 1 | 35 | 2,350 | 35 | 43 | 0 | 2 | 338 | 2,413,000 | 32.45 | 
| app_proof | 2 | 35 | 2,353 | 35 | 41 | 0 | 2 | 267 | 2,413,000 | 33.24 | 
| app_proof | 3 | 35 | 2,353 | 35 | 41 | 0 | 2 | 265 | 2,413,000 | 33.55 | 
| app_proof | 4 | 35 | 2,361 | 35 | 41 | 0 | 2 | 266 | 2,413,000 | 33.26 | 
| app_proof | 5 | 34 | 2,323 | 34 | 41 | 0 | 2 | 234 | 2,300,133 | 32.83 | 

...
|:---|---:|---:|---:|
| Total |  17.01 |  4.98 |  4.98 |
| app_proof |  13.83 |  2.57 |  2.57 |
| leaf |  2.38 |  1.61 |  1.61 |
...
| `total_proof_time_ms ` |  2,281 |  13,686 |  2,429 |  2,190 |
| `execute_metered_time_ms` |  143 | -          | -          | -          |
| `execute_metered_insns` |  14,365,133 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  99.77 | -          |  99.77 |  99.77 |
| `execute_preflight_insns` |  2,394,188.83 |  14,365,133 |  2,413,000 |  2,300,133 |
| `execute_preflight_time_ms` |  257.83 |  1,547 |  332 |  93 |
| `execute_preflight_insn_mi/s` |  31.66 | -          |  32.54 |  28.75 |
| `trace_gen_time_ms   ` |  35.67 |  214 |  40 |  34 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,929.17 |  11,575 |  2,158 |  1,862 |
| `prover.main_trace_commit_time_ms` |  693.67 |  4,162 |  855 |  660 |
| `prover.rap_constraints_time_ms` |  1,054.83 |  6,329 |  1,122 |  1,020 |
| `prover.openings_time_ms` |  179.67 |  1,078 |  185 |  175 |
| `prover.rap_constraints.logup_gkr_time_ms` |  287.50 |  1,725 |  350 |  257 |
| `prover.rap_constraints.round0_time_ms` |  509.83 |  3,059 |  515 |  504 |
| `prover.rap_constraints.mle_rounds_time_ms` |  256.50 |  1,539 |  267 |  245 |
...
| `prover.openings.whir_time_ms` |  45.33 |  272 |  52 |  42 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,190.50 |  2,381 |  1,614 |  767 |
| `execute_preflight_time_ms` |  5.50 |  11 |  6 |  5 |
| `trace_gen_time_ms   ` |  137.50 |  275 |  185 |  90 |
| `generate_blob_total_time_ms` |  21 |  42 |  28 |  14 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,052.50 |  2,105 |  1,429 |  676 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/c70a3434c6cb767f82a607653ef65b9ff9d37f4d/keccak-c70a3434c6cb767f82a607653ef65b9ff9d37f4d.memory.svg)
...
| app_proof |  |  |  |  |  | 2,190 |  |  | 143 | 14,365,133 | 99.77 | 0 | 13,837 |  | 
...
| internal_recursive.0 | 1 | 13 | 168 | 13 | 2 | 1 | 2 | 2 | 2 | 
| internal_recursive.1 | 1 | 9 | 125 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 185 | 1,614 | 184 | 61 | 28 | 6 | 8 | 8 | 
| leaf | 1 | 90 | 767 | 90 | 30 | 14 | 5 | 7 | 7 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 81,415,156 | 464 | 243 | 0 | 1 | 172 | 49 | 48 | 92 | 31 | 0 | 48 | 25 | 23 | 7 | 15 | 243 | 172 | 0 | 3 | 29 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,943 | 154 | 49 | 0 | 0 | 72 | 25 | 24 | 29 | 17 | 0 | 32 | 23 | 8 | 2 | 6 | 49 | 72 | 0 | 2 | 17 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 115 | 32 | 0 | 0 | 61 | 22 | 22 | 24 | 13 | 0 | 21 | 14 | 7 | 1 | 5 | 32 | 61 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 476,572,646 | 1,429 | 896 | 0 | 177 | 414 | 205 | 204 | 121 | 88 | 0 | 117 | 45 | 72 | 41 | 31 | 896 | 414 | 0 | 7 | 85 | 0 | 0 | 
| leaf | 1 | prover | 240,252,724 | 676 | 375 | 0 | 1 | 229 | 109 | 108 | 68 | 51 | 0 | 71 | 34 | 37 | 20 | 17 | 375 | 229 | 0 | 6 | 50 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 840,496,780 | 2,158 | 855 | 0 | 197 | 1,122 | 504 | 504 | 267 | 350 | 98 | 180 | 44 | 135 | 82 | 52 | 855 | 1,122 | 0 | 4 | 250 | 0 | 0 | 
| app_proof | prover | 1 | 840,496,780 | 1,953 | 662 | 0 | 3 | 1,114 | 505 | 505 | 265 | 343 | 103 | 175 | 42 | 133 | 81 | 51 | 662 | 1,114 | 0 | 3 | 238 | 0 | 0 | 
| app_proof | prover | 2 | 840,496,780 | 1,869 | 661 | 0 | 3 | 1,022 | 510 | 510 | 254 | 257 | 0 | 185 | 52 | 133 | 81 | 51 | 661 | 1,022 | 0 | 3 | 256 | 0 | 0 | 
| app_proof | prover | 3 | 840,496,780 | 1,867 | 660 | 0 | 3 | 1,023 | 511 | 510 | 253 | 258 | 0 | 182 | 47 | 135 | 82 | 52 | 661 | 1,023 | 0 | 4 | 257 | 0 | 0 | 
| app_proof | prover | 4 | 840,496,780 | 1,862 | 660 | 0 | 3 | 1,020 | 515 | 514 | 245 | 259 | 0 | 181 | 44 | 137 | 83 | 53 | 660 | 1,020 | 0 | 4 | 257 | 0 | 0 | 
| app_proof | prover | 5 | 840,496,780 | 1,866 | 662 | 0 | 3 | 1,028 | 514 | 514 | 255 | 258 | 0 | 175 | 43 | 131 | 80 | 50 | 663 | 1,028 | 0 | 3 | 257 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 40 | 2,429 | 40 | 136 | 0 | 4 | 93 | 2,413,000 | 28.75 | 
| app_proof | 1 | 35 | 2,362 | 35 | 41 | 0 | 2 | 332 | 2,413,000 | 32.26 | 
| app_proof | 2 | 35 | 2,247 | 35 | 42 | 0 | 2 | 300 | 2,413,000 | 31.78 | 
| app_proof | 3 | 35 | 2,232 | 35 | 41 | 0 | 2 | 287 | 2,413,000 | 32.32 | 
| app_proof | 4 | 35 | 2,226 | 35 | 41 | 0 | 2 | 287 | 2,413,000 | 32.32 | 
| app_proof | 5 | 34 | 2,190 | 34 | 41 | 0 | 2 | 248 | 2,300,133 | 32.54 | 

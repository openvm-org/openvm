...
|:---|---:|---:|---:|
| Total |  16.83 |  4.94 |  4.94 |
| app_proof |  13.68 |  2.55 |  2.55 |
| leaf |  2.36 |  1.60 |  1.60 |
...
| `total_proof_time_ms ` |  2,255.67 |  13,534 |  2,408 |  2,172 |
| `execute_metered_time_ms` |  143 | -          | -          | -          |
| `execute_metered_insns` |  14,365,133 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  100.24 | -          |  100.24 |  100.24 |
| `execute_preflight_insns` |  2,394,188.83 |  14,365,133 |  2,413,000 |  2,300,133 |
| `execute_preflight_time_ms` |  238.17 |  1,429 |  316 |  90 |
| `execute_preflight_insn_mi/s` |  32.16 | -          |  32.85 |  29.43 |
| `trace_gen_time_ms   ` |  35.67 |  214 |  40 |  34 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,924.17 |  11,545 |  2,142 |  1,861 |
| `prover.main_trace_commit_time_ms` |  692 |  4,152 |  850 |  658 |
| `prover.rap_constraints_time_ms` |  1,053.17 |  6,319 |  1,115 |  1,016 |
| `prover.openings_time_ms` |  178.17 |  1,069 |  186 |  174 |
| `prover.rap_constraints.logup_gkr_time_ms` |  285.50 |  1,713 |  346 |  256 |
| `prover.rap_constraints.round0_time_ms` |  510.17 |  3,061 |  520 |  502 |
| `prover.rap_constraints.mle_rounds_time_ms` |  256.50 |  1,539 |  266 |  251 |
| `prover.openings.stacked_reduction_time_ms` |  133.50 |  801 |  134 |  133 |
| `prover.openings.stacked_reduction.round0_time_ms` |  80.83 |  485 |  82 |  79 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  52 |  312 |  54 |  51 |
| `prover.openings.whir_time_ms` |  44.17 |  265 |  52 |  40 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,178.50 |  2,357 |  1,595 |  762 |
| `execute_preflight_time_ms` |  5.50 |  11 |  6 |  5 |
| `trace_gen_time_ms   ` |  132 |  264 |  176 |  88 |
| `generate_blob_total_time_ms` |  21 |  42 |  28 |  14 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,046.50 |  2,093 |  1,419 |  674 |
| `prover.main_trace_commit_time_ms` |  635 |  1,270 |  896 |  374 |
| `prover.rap_constraints_time_ms` |  319 |  638 |  409 |  229 |
| `prover.openings_time_ms` |  91.50 |  183 |  113 |  70 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/c0b116528167e733e548394631e32480875a97e1/keccak-c0b116528167e733e548394631e32480875a97e1.memory.svg)
...
| app_proof |  |  |  |  |  | 2,172 |  |  | 143 | 14,365,133 | 100.24 | 0 | 13,684 |  | 
| internal_for_leaf |  |  |  | 502 |  |  |  |  |  |  |  |  |  | 503 | 
...
| internal_recursive.0 | 1 | 14 | 166 | 13 | 2 | 1 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 9 | 128 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 176 | 1,595 | 175 | 60 | 28 | 6 | 7 | 7 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 81,415,156 | 462 | 242 | 0 | 1 | 173 | 49 | 49 | 92 | 30 | 0 | 45 | 22 | 23 | 7 | 15 | 243 | 173 | 0 | 3 | 30 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,943 | 152 | 49 | 0 | 0 | 73 | 25 | 25 | 29 | 17 | 0 | 29 | 20 | 8 | 2 | 6 | 49 | 73 | 0 | 2 | 17 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 |
...
|:---|---:|---:|---:|
| Total |  2.93 |  2.32 |  2.32 |
| app_proof |  2.21 |  1.60 |  1.60 |
| leaf |  0.41 |  0.41 |  0.41 |
...
| `total_proof_time_ms ` |  1,091 |  2,182 |  1,570 |  612 |
| `execute_metered_time_ms` |  25 | -          | -          | -          |
| `execute_metered_insns` |  1,979,971 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  78.41 | -          |  78.41 |  78.41 |
| `execute_preflight_insns` |  989,985.50 |  1,979,971 |  1,278,000 |  701,971 |
| `execute_preflight_time_ms` |  86.50 |  173 |  115 |  58 |
| `execute_preflight_insn_mi/s` |  30.99 | -          |  31.98 |  29.99 |
| `trace_gen_time_ms   ` |  29 |  58 |  44 |  14 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  886.50 |  1,773 |  1,332 |  441 |
| `prover.main_trace_commit_time_ms` |  299 |  598 |  481 |  117 |
| `prover.rap_constraints_time_ms` |  535 |  1,070 |  783 |  287 |
| `prover.openings_time_ms` |  52 |  104 |  68 |  36 |
| `prover.rap_constraints.logup_gkr_time_ms` |  85.50 |  171 |  131 |  40 |
| `prover.rap_constraints.round0_time_ms` |  307.50 |  615 |  434 |  181 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/c279370741a9fc28af063675e39abff95ace2335/kitchen_sink-c279370741a9fc28af063675e39abff95ace2335.memory.svg)
...
| app_proof |  |  |  |  |  | 612 |  |  | 25 | 1,979,971 | 78.41 | 0 | 2,212 |  | 
...
| leaf | 0 | prover | 263,565,172 | 298 | 128 | 0 | 1 | 141 | 49 | 48 | 37 | 54 | 0 | 27 | 11 | 15 | 7 | 8 | 128 | 141 | 0 | 2 | 54 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 904,012,452 | 1,332 | 480 | 0 | 273 | 783 | 434 | 433 | 216 | 131 | 66 | 68 | 15 | 52 | 24 | 27 | 481 | 783 | 0 | 1 | 64 | 0 | 0 | 
| app_proof | prover | 1 | 458,298,508 | 441 | 117 | 0 | 1 | 287 | 181 | 180 | 65 | 40 | 0 | 36 | 11 | 24 | 12 | 12 | 117 | 287 | 0 | 1 | 39 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 44 | 1,570 | 44 | 135 | 0 | 3 | 58 | 1,278,000 | 29.99 | 
| app_proof | 1 | 14 | 612 | 14 | 40 | 0 | 2 | 115 | 701,971 | 31.98 | 

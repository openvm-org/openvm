...
|:---|---:|---:|---:|
| Total |  2.61 |  1.98 |  1.98 |
| app_proof |  1.55 |  0.93 |  0.93 |
| leaf |  0.44 |  0.44 |  0.44 |
...
| `total_proof_time_ms ` |  760 |  1,520 |  890 |  630 |
| `compile_metered_time_ms` |  8 |  8 |  8 |  8 |
| `execute_metered_time_ms` |  35 | -          | -          | -          |
| `execute_metered_insns` |  4,090,656 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  116 | -          |  116 |  116 |
| `execute_preflight_insns` |  2,045,328 |  4,090,656 |  2,327,000 |  1,763,656 |
| `execute_preflight_time_ms` |  82.50 |  165 |  92 |  73 |
| `execute_preflight_insn_mi/s` |  34.64 | -          |  36.04 |  33.24 |
...
| `prover.rap_constraints_time_ms` |  333 |  666 |  376 |  290 |
| `prover.openings_time_ms` |  115 |  230 |  127 |  103 |
| `prover.rap_constraints.logup_gkr_time_ms` |  201 |  402 |  246 |  156 |
| `prover.rap_constraints.round0_time_ms` |  96 |  192 |  102 |  90 |
...
| `prover.openings.whir_time_ms` |  91.50 |  183 |  101 |  82 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/0e6d6a6391038955d1371c8fa551e426de5782c4/regex-0e6d6a6391038955d1371c8fa551e426de5782c4.memory.svg)
...
| app_proof |  |  |  |  |  | 630 |  |  | 35 | 4,090,656 | 116 | 0 | 1,569 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 27,289,403 | 265 | 83 | 0 | 0 | 99 | 33 | 32 | 46 | 20 | 0 | 81 | 70 | 11 | 2 | 8 | 84 | 99 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,767 | 173 | 46 | 0 | 0 | 68 | 25 | 24 | 28 | 14 | 0 | 58 | 49 | 8 | 1 | 6 | 46 | 68 | 0 | 3 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 141 | 32 | 0 | 0 | 63 | 24 | 24 | 24 | 13 | 0 | 44 | 37 | 7 | 1 | 5 | 33 | 63 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 79,656,756 | 386 | 129 | 0 | 0 | 137 | 55 | 54 | 38 | 43 | 0 | 118 | 103 | 15 | 6 | 8 | 130 | 137 | 0 | 7 | 42 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 161,843,666 | 635 | 132 | 0 | 0 | 376 | 90 | 90 | 38 | 246 | 0 | 127 | 101 | 25 | 14 | 11 | 132 | 376 | 0 | 3 | 245 | 0 | 0 | 
| app_proof | prover | 1 | 123,257,151 | 498 | 103 | 0 | 0 | 290 | 102 | 102 | 31 | 156 | 0 | 103 | 82 | 20 | 9 | 10 | 103 | 290 | 0 | 3 | 156 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 2 | 25 | 890 | 25 | 136 | 2,906,597,493 | 888,488,923 | 3,795,086,416 | 2,097,152 | 1 | 5 | 92 | 2,327,000 | 33.24 | 
| app_proof | 1 | 1 | 17 | 630 | 17 | 41 | 2,092,069,523 | 674,063,136 | 2,766,132,659 | 2,097,152 | 0 | 2 | 73 | 1,763,656 | 36.04 | 

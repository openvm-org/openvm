...
|:---|---:|---:|---:|
| Total |  10.98 |  4.54 |  4.54 |
| app_proof |  8.92 |  2.48 |  2.48 |
| leaf |  1.39 |  1.39 |  1.39 |
...
| `total_proof_time_ms ` |  2,206 |  8,824 |  2,382 |  2,125 |
...
| `execute_preflight_time_ms` |  164.25 |  657 |  209 |  100 |
| `execute_preflight_insn_mi/s` |  34.36 | -          |  35.32 |  32.03 |
| `trace_gen_time_ms   ` |  57.75 |  231 |  63 |  54 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,918.25 |  7,673 |  2,083 |  1,859 |
| `prover.main_trace_commit_time_ms` |  531.75 |  2,127 |  617 |  503 |
| `prover.rap_constraints_time_ms` |  1,252 |  5,008 |  1,329 |  1,218 |
| `prover.openings_time_ms` |  133.25 |  533 |  136 |  129 |
| `prover.rap_constraints.logup_gkr_time_ms` |  344.25 |  1,377 |  427 |  316 |
| `prover.rap_constraints.round0_time_ms` |  663.25 |  2,653 |  671 |  655 |
| `prover.rap_constraints.mle_rounds_time_ms` |  243.25 |  973 |  246 |  241 |
| `prover.openings.stacked_reduction_time_ms` |  95.75 |  383 |  97 |  92 |
| `prover.openings.stacked_reduction.round0_time_ms` |  58 |  232 |  59 |  56 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  37.50 |  150 |  38 |  36 |
| `prover.openings.whir_time_ms` |  37.25 |  149 |  38 |  36 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/4c9cea5e937a64251c2716689f93f463132b5768/sha2_bench-4c9cea5e937a64251c2716689f93f463132b5768.memory.svg)
...
| app_proof |  |  |  |  |  | 2,125 |  |  | 97 | 11,167,961 | 114.26 | 0 | 8,929 |  | 
...
| leaf | 0 | 143 | 1,392 | 142 | 49 | 22 | 2 | 6 | 6 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 61,220,667 | 354 | 183 | 0 | 0 | 129 | 37 | 36 | 64 | 27 | 0 | 41 | 22 | 18 | 5 | 12 | 183 | 129 | 0 | 3 | 26 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,943 | 145 | 47 | 0 | 0 | 68 | 22 | 22 | 29 | 16 | 0 | 29 | 20 | 8 | 1 | 6 | 47 | 68 | 0 | 2 | 15 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 121 | 31 | 0 | 0 | 61 | 23 | 22 | 24 | 13 | 0 | 27 | 20 | 7 | 1 | 5 | 32 | 61 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 425,192,422 | 1,249 | 797 | 0 | 156 | 346 | 167 | 166 | 103 | 74 | 0 | 105 | 41 | 64 | 36 | 27 | 797 | 346 | 0 | 7 | 73 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 640,057,593 | 2,083 | 616 | 0 | 116 | 1,329 | 655 | 655 | 246 | 427 | 123 | 136 | 38 | 97 | 59 | 38 | 617 | 1,329 | 0 | 3 | 302 | 0 | 0 | 
| app_proof | prover | 1 | 640,057,356 | 1,868 | 503 | 0 | 2 | 1,230 | 668 | 667 | 245 | 316 | 0 | 133 | 36 | 97 | 59 | 38 | 503 | 1,230 | 0 | 3 | 315 | 0 | 0 | 
| app_proof | prover | 2 | 640,057,356 | 1,863 | 502 | 0 | 2 | 1,231 | 671 | 671 | 241 | 317 | 0 | 129 | 37 | 92 | 56 | 36 | 503 | 1,231 | 0 | 3 | 316 | 0 | 0 | 
| app_proof | prover | 3 | 640,057,588 | 1,859 | 504 | 0 | 2 | 1,218 | 659 | 659 | 241 | 317 | 0 | 135 | 38 | 97 | 58 | 38 | 504 | 1,218 | 0 | 3 | 316 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 63 | 2,382 | 63 | 135 | 0 | 3 | 100 | 2,851,000 | 32.03 | 
| app_proof | 1 | 57 | 2,176 | 57 | 41 | 0 | 2 | 209 | 2,851,000 | 35.10 | 
| app_proof | 2 | 57 | 2,141 | 57 | 41 | 0 | 2 | 178 | 2,851,000 | 35.02 | 
| app_proof | 3 | 54 | 2,125 | 54 | 41 | 0 | 2 | 170 | 2,614,961 | 35.32 | 

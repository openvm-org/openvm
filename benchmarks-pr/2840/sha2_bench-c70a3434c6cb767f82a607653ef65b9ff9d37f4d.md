...
|:---|---:|---:|---:|
| Total |  10.99 |  4.54 |  4.54 |
| app_proof |  8.93 |  2.49 |  2.49 |
| leaf |  1.39 |  1.39 |  1.39 |
...
| `total_proof_time_ms ` |  2,208.75 |  8,835 |  2,394 |  2,124 |
...
| `execute_preflight_time_ms` |  165 |  660 |  208 |  102 |
| `execute_preflight_insn_mi/s` |  33.72 | -          |  34.52 |  31.41 |
| `trace_gen_time_ms   ` |  57.75 |  231 |  63 |  54 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,919.50 |  7,678 |  2,092 |  1,856 |
| `prover.main_trace_commit_time_ms` |  529.75 |  2,119 |  615 |  501 |
| `prover.rap_constraints_time_ms` |  1,253 |  5,012 |  1,338 |  1,217 |
| `prover.openings_time_ms` |  135.50 |  542 |  137 |  133 |
| `prover.rap_constraints.logup_gkr_time_ms` |  353.50 |  1,414 |  440 |  324 |
| `prover.rap_constraints.round0_time_ms` |  656.25 |  2,625 |  662 |  652 |
| `prover.rap_constraints.mle_rounds_time_ms` |  242.50 |  970 |  246 |  239 |
...
| `prover.openings.whir_time_ms` |  38.25 |  153 |  40 |  37 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/c70a3434c6cb767f82a607653ef65b9ff9d37f4d/sha2_bench-c70a3434c6cb767f82a607653ef65b9ff9d37f4d.memory.svg)
...
| app_proof |  |  |  |  |  | 2,124 |  |  | 98 | 11,167,961 | 112.91 | 0 | 8,940 |  | 
...
| leaf | 0 | 144 | 1,387 | 144 | 50 | 22 | 2 | 6 | 6 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 61,220,667 | 348 | 181 | 0 | 0 | 129 | 37 | 37 | 64 | 26 | 0 | 36 | 18 | 18 | 5 | 12 | 182 | 129 | 0 | 2 | 26 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,943 | 149 | 48 | 0 | 0 | 72 | 24 | 24 | 29 | 18 | 0 | 27 | 18 | 8 | 1 | 6 | 49 | 72 | 0 | 2 | 16 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 123 | 31 | 0 | 0 | 62 | 24 | 23 | 24 | 13 | 0 | 28 | 21 | 7 | 1 | 5 | 31 | 62 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 425,192,422 | 1,242 | 793 | 0 | 155 | 344 | 167 | 166 | 102 | 74 | 0 | 104 | 40 | 63 | 36 | 27 | 793 | 344 | 0 | 6 | 73 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 640,057,593 | 2,092 | 615 | 0 | 116 | 1,338 | 652 | 651 | 246 | 440 | 131 | 137 | 39 | 98 | 59 | 39 | 615 | 1,338 | 0 | 3 | 308 | 0 | 0 | 
| app_proof | prover | 1 | 640,057,356 | 1,862 | 501 | 0 | 2 | 1,225 | 658 | 657 | 242 | 324 | 0 | 136 | 37 | 98 | 59 | 38 | 501 | 1,225 | 0 | 3 | 322 | 0 | 0 | 
| app_proof | prover | 2 | 640,057,356 | 1,868 | 501 | 0 | 2 | 1,232 | 662 | 662 | 243 | 326 | 0 | 133 | 37 | 96 | 58 | 37 | 501 | 1,232 | 0 | 3 | 324 | 0 | 0 | 
| app_proof | prover | 3 | 640,057,588 | 1,856 | 502 | 0 | 2 | 1,217 | 653 | 652 | 239 | 324 | 0 | 136 | 40 | 95 | 57 | 38 | 502 | 1,217 | 0 | 3 | 323 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 63 | 2,394 | 63 | 137 | 0 | 3 | 102 | 2,851,000 | 31.41 | 
| app_proof | 1 | 57 | 2,170 | 57 | 41 | 0 | 2 | 208 | 2,851,000 | 34.47 | 
| app_proof | 2 | 57 | 2,147 | 57 | 41 | 0 | 2 | 179 | 2,851,000 | 34.48 | 
| app_proof | 3 | 54 | 2,124 | 54 | 41 | 0 | 2 | 171 | 2,614,961 | 34.52 | 

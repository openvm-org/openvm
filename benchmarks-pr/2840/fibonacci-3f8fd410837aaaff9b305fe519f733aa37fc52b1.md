...
|:---|---:|---:|---:|
| Total |  2.34 |  1.43 |  1.43 |
| app_proof |  1.41 |  0.49 |  0.49 |
| leaf |  0.43 |  0.43 |  0.43 |
...
| `total_proof_time_ms ` |  346.75 |  1,387 |  472 |  180 |
| `execute_metered_time_ms` |  19 | -          | -          | -          |
| `execute_metered_insns` |  4,000,051 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  200.83 | -          |  200.83 |  200.83 |
| `execute_preflight_insns` |  1,000,012.75 |  4,000,051 |  1,310,000 |  70,051 |
| `execute_preflight_time_ms` |  37.50 |  150 |  51 |  4 |
| `execute_preflight_insn_mi/s` |  37.60 | -          |  37.79 |  37.48 |
| `trace_gen_time_ms   ` |  34.75 |  139 |  63 |  25 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  209.25 |  837 |  259 |  71 |
| `prover.main_trace_commit_time_ms` |  41.75 |  167 |  51 |  16 |
| `prover.rap_constraints_time_ms` |  138 |  552 |  178 |  33 |
| `prover.openings_time_ms` |  28.50 |  114 |  32 |  21 |
| `prover.rap_constraints.logup_gkr_time_ms` |  96 |  384 |  124 |  17 |
| `prover.rap_constraints.round0_time_ms` |  28 |  112 |  38 |  9 |
...
| `prover.openings.whir_time_ms` |  19 |  76 |  21 |  17 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/3f8fd410837aaaff9b305fe519f733aa37fc52b1/fibonacci-3f8fd410837aaaff9b305fe519f733aa37fc52b1.memory.svg)
...
| app_proof |  |  |  |  |  | 180 |  |  | 19 | 4,000,051 | 200.83 | 0 | 1,414 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 17 | 224 | 17 | 5 | 0 | 2 | 1 | 1 | 
| internal_recursive.0 | 1 | 11 | 149 | 11 | 1 | 0 | 2 | 0 | 0 | 
| internal_recursive.1 | 1 | 10 | 133 | 10 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 54 | 428 | 53 | 21 | 2 | 1 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 27,289,403 | 206 | 81 | 0 | 0 | 97 | 32 | 31 | 45 | 19 | 0 | 28 | 17 | 11 | 2 | 8 | 81 | 97 | 0 | 2 | 18 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,767 | 138 | 45 | 0 | 0 | 66 | 24 | 24 | 27 | 13 | 0 | 25 | 17 | 8 | 1 | 6 | 46 | 66 | 0 | 2 | 12 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 122 | 31 | 0 | 0 | 60 | 22 | 22 | 24 | 13 | 0 | 30 | 23 | 7 | 1 | 5 | 31 | 60 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 102,779,942 | 374 | 166 | 0 | 0 | 160 | 70 | 69 | 46 | 43 | 0 | 47 | 28 | 18 | 8 | 9 | 166 | 160 | 0 | 5 | 42 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 62,648,824 | 259 | 50 | 0 | 0 | 178 | 38 | 37 | 15 | 124 | 0 | 30 | 18 | 11 | 5 | 5 | 50 | 178 | 0 | 3 | 122 | 0 | 0 | 
| app_proof | prover | 1 | 62,602,932 | 254 | 51 | 0 | 0 | 170 | 32 | 32 | 15 | 121 | 0 | 32 | 21 | 10 | 5 | 5 | 51 | 170 | 0 | 3 | 121 | 0 | 0 | 
| app_proof | prover | 2 | 62,602,932 | 253 | 50 | 0 | 0 | 171 | 33 | 33 | 15 | 122 | 0 | 31 | 20 | 10 | 5 | 5 | 50 | 171 | 0 | 3 | 121 | 0 | 0 | 
| app_proof | prover | 3 | 9,072,096 | 71 | 16 | 0 | 0 | 33 | 9 | 9 | 7 | 17 | 0 | 21 | 17 | 3 | 0 | 2 | 16 | 33 | 0 | 2 | 16 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 26 | 472 | 26 | 135 | 0 | 4 | 51 | 1,310,000 | 37.62 | 
| app_proof | 1 | 25 | 368 | 25 | 41 | 0 | 2 | 48 | 1,310,000 | 37.49 | 
| app_proof | 2 | 25 | 367 | 25 | 41 | 0 | 2 | 47 | 1,310,000 | 37.79 | 
| app_proof | 3 | 63 | 180 | 63 | 41 | 0 | 2 | 4 | 70,051 | 37.48 | 

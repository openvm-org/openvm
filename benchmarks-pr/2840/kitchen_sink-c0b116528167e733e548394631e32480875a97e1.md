...
|:---|---:|---:|---:|
| Total |  5.30 |  4.40 |  4.40 |
| app_proof |  3.78 |  2.88 |  2.88 |
| leaf |  0.95 |  0.95 |  0.95 |
...
| `total_proof_time_ms ` |  1,876.50 |  3,753 |  2,853 |  900 |
| `execute_metered_time_ms` |  24 | -          | -          | -          |
| `execute_metered_insns` |  1,979,971 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  80.18 | -          |  80.18 |  80.18 |
| `execute_preflight_insns` |  989,985.50 |  1,979,971 |  1,445,000 |  534,971 |
| `execute_preflight_time_ms` |  77 |  154 |  83 |  71 |
| `execute_preflight_insn_mi/s` |  29.60 | -          |  30.01 |  29.18 |
| `trace_gen_time_ms   ` |  38.50 |  77 |  61 |  16 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,671.50 |  3,343 |  2,584 |  759 |
| `prover.main_trace_commit_time_ms` |  599 |  1,198 |  968 |  230 |
| `prover.rap_constraints_time_ms` |  936 |  1,872 |  1,418 |  454 |
| `prover.openings_time_ms` |  136 |  272 |  198 |  74 |
| `prover.rap_constraints.logup_gkr_time_ms` |  155 |  310 |  221 |  89 |
| `prover.rap_constraints.round0_time_ms` |  559 |  1,118 |  861 |  257 |
| `prover.rap_constraints.mle_rounds_time_ms` |  220.50 |  441 |  335 |  106 |
...
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  45 |  90 |  69 |  21 |
| `prover.openings.whir_time_ms` |  34.50 |  69 |  41 |  28 |
...
| `prover.rap_constraints.round0_time_ms` |  138 |  138 |  138 |  138 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/c0b116528167e733e548394631e32480875a97e1/kitchen_sink-c0b116528167e733e548394631e32480875a97e1.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 74 | 9 |  |  | 0 |  | 372 | 9 |  |  |  |  |  |  | 
| app_proof |  |  |  |  |  | 900 |  |  | 24 | 1,979,971 | 80.18 | 0 | 3,782 |  | 
...
| internal_recursive.0 | 1 | 10 | 157 | 10 | 1 | 0 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 9 | 133 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 116 | 953 | 115 | 24 | 10 | 18 | 2 | 2 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,577,979 | 262 | 119 | 0 | 0 | 109 | 36 | 35 | 52 | 20 | 0 | 33 | 18 | 14 | 4 | 10 | 119 | 109 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,767 | 146 | 46 | 0 | 0 | 69 | 26 | 25 | 28 | 14 | 0 | 30 | 22 | 8 | 1 | 6 | 46 | 69 | 0 | 3 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 124 | 32 | 0 | 0 | 63 | 24 | 23 | 24 | 13 | 0 | 27 | 20 | 7 | 1 | 5 | 33 | 63 | 0 | 2 | 13 | 0 | 0 | 
| leaf | 0 | prover | 260,613,236 | 836 | 404 | 0 | 1 | 353 | 138 | 138 | 78 | 136 | 0 | 78 | 37 | 40 | 22 | 18 | 404 | 353 | 0 | 7 | 135 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 902,782,844 | 2,584 | 967 | 0 | 308 | 1,418 | 861 | 860 | 335 | 221 | 66 | 198 | 41 | 156 | 87 | 69 | 968 | 1,418 | 0 | 3 | 153 | 0 | 0 | 
| app_proof | prover | 1 | 279,963,980 | 759 | 229 | 0 | 1 | 454 | 257 | 257 | 106 | 89 | 0 | 74 | 28 | 45 | 24 | 21 | 230 | 454 | 0 | 4 | 88 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 61 | 2,853 | 61 | 136 | 0 | 4 | 71 | 1,445,000 | 29.18 | 
| app_proof | 1 | 16 | 900 | 16 | 41 | 0 | 2 | 83 | 534,971 | 30.01 | 

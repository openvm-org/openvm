...
|:---|---:|---:|---:|
| Total |  5.22 |  4.33 |  4.33 |
| app_proof |  3.72 |  2.84 |  2.84 |
| leaf |  0.94 |  0.94 |  0.94 |
...
| `total_proof_time_ms ` |  1,849.50 |  3,699 |  2,812 |  887 |
...
| `execute_preflight_insn_mi/s` |  30.73 | -          |  31.40 |  30.05 |
| `trace_gen_time_ms   ` |  38.50 |  77 |  61 |  16 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,645.50 |  3,291 |  2,543 |  748 |
| `prover.main_trace_commit_time_ms` |  588 |  1,176 |  951 |  225 |
| `prover.rap_constraints_time_ms` |  923 |  1,846 |  1,397 |  449 |
| `prover.openings_time_ms` |  133.50 |  267 |  195 |  72 |
| `prover.rap_constraints.logup_gkr_time_ms` |  153 |  306 |  218 |  88 |
| `prover.rap_constraints.round0_time_ms` |  553 |  1,106 |  849 |  257 |
| `prover.rap_constraints.mle_rounds_time_ms` |  216.50 |  433 |  329 |  104 |
| `prover.openings.stacked_reduction_time_ms` |  99.50 |  199 |  154 |  45 |
| `prover.openings.stacked_reduction.round0_time_ms` |  55.50 |  111 |  87 |  24 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  44 |  88 |  67 |  21 |
| `prover.openings.whir_time_ms` |  33.50 |  67 |  40 |  27 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/3f8fd410837aaaff9b305fe519f733aa37fc52b1/kitchen_sink-3f8fd410837aaaff9b305fe519f733aa37fc52b1.memory.svg)
...
| app_proof |  |  |  |  |  | 887 |  |  | 24 | 1,979,971 | 80.33 | 0 | 3,728 |  | 
...
| internal_recursive.0 | 1 | 10 | 150 | 10 | 1 | 0 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 9 | 130 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 114 | 936 | 114 | 24 | 10 | 18 | 2 | 2 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,577,979 | 261 | 117 | 0 | 0 | 107 | 34 | 34 | 52 | 20 | 0 | 36 | 22 | 14 | 4 | 10 | 118 | 107 | 0 | 2 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,767 | 139 | 45 | 0 | 0 | 68 | 25 | 25 | 27 | 14 | 0 | 25 | 17 | 8 | 1 | 6 | 45 | 68 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 120 | 31 | 0 | 0 | 63 | 24 | 23 | 24 | 14 | 0 | 26 | 18 | 7 | 1 | 5 | 31 | 63 | 0 | 2 | 13 | 0 | 0 | 
| leaf | 0 | prover | 260,613,236 | 822 | 399 | 0 | 1 | 346 | 132 | 131 | 76 | 136 | 0 | 76 | 35 | 40 | 21 | 18 | 399 | 346 | 0 | 6 | 135 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 902,782,844 | 2,543 | 951 | 0 | 305 | 1,397 | 849 | 848 | 329 | 218 | 66 | 195 | 40 | 154 | 87 | 67 | 951 | 1,397 | 0 | 3 | 150 | 0 | 0 | 
| app_proof | prover | 1 | 279,963,980 | 748 | 225 | 0 | 1 | 449 | 257 | 256 | 104 | 88 | 0 | 72 | 27 | 45 | 24 | 21 | 225 | 449 | 0 | 3 | 87 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 61 | 2,812 | 61 | 137 | 0 | 4 | 69 | 1,445,000 | 30.05 | 
| app_proof | 1 | 16 | 887 | 16 | 41 | 0 | 2 | 82 | 534,971 | 31.40 | 

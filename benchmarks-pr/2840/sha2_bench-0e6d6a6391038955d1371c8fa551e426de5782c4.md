...
|:---|---:|---:|---:|
| Total |  13.42 |  5.63 |  5.63 |
| app_proof |  10.62 |  2.83 |  2.83 |
| leaf |  1.96 |  1.96 |  1.96 |
...
| `total_proof_time_ms ` |  2,629.50 |  10,518 |  2,726 |  2,579 |
| `compile_metered_time_ms` |  4 |  4 |  4 |  4 |
| `execute_metered_time_ms` |  100 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  111.54 | -          |  111.54 |  111.54 |
| `execute_preflight_insns` |  2,791,990.25 |  11,167,961 |  2,851,000 |  2,614,961 |
| `execute_preflight_time_ms` |  177.25 |  709 |  228 |  101 |
| `execute_preflight_insn_mi/s` |  35.13 | -          |  36.10 |  32.37 |
| `trace_gen_time_ms   ` |  59.75 |  239 |  66 |  56 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  2,324 |  9,296 |  2,419 |  2,290 |
| `prover.main_trace_commit_time_ms` |  618 |  2,472 |  622 |  615 |
| `prover.rap_constraints_time_ms` |  1,231.25 |  4,925 |  1,235 |  1,229 |
| `prover.openings_time_ms` |  473.50 |  1,894 |  564 |  442 |
| `prover.rap_constraints.logup_gkr_time_ms` |  310.25 |  1,241 |  311 |  310 |
| `prover.rap_constraints.round0_time_ms` |  675.25 |  2,701 |  679 |  671 |
| `prover.rap_constraints.mle_rounds_time_ms` |  244.75 |  979 |  247 |  242 |
| `prover.openings.stacked_reduction_time_ms` |  97.75 |  391 |  100 |  94 |
| `prover.openings.stacked_reduction.round0_time_ms` |  59 |  236 |  61 |  56 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  38 |  152 |  39 |  37 |
| `prover.openings.whir_time_ms` |  375 |  1,500 |  465 |  343 |
...
| `prover.main_trace_commit_time_ms` |  816 |  816 |  816 |  816 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/0e6d6a6391038955d1371c8fa551e426de5782c4/sha2_bench-0e6d6a6391038955d1371c8fa551e426de5782c4.memory.svg)
...
| generate mem proving ctxs | 0.99 | app_proof.3 |
...
| app_proof |  |  |  |  |  | 2,579 |  |  | 100 | 11,167,961 | 111.54 | 0 | 10,626 |  | 
...
| app_proof | VmAirWrapper<Rv64JalrAdapterAir, Rv64JalrCoreAir> | 0 | 27 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 29 | 497 | 29 | 8 | 2 | 2 | 4 | 4 | 
| internal_recursive.0 | 1 | 13 | 195 | 13 | 2 | 0 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 9 | 151 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 150 | 1,958 | 150 | 51 | 22 | 2 | 6 | 6 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 61,220,667 | 467 | 183 | 0 | 0 | 131 | 37 | 37 | 65 | 28 | 0 | 151 | 132 | 18 | 5 | 13 | 184 | 131 | 0 | 4 | 26 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,943 | 181 | 49 | 0 | 0 | 72 | 24 | 23 | 29 | 18 | 0 | 59 | 50 | 8 | 1 | 6 | 49 | 72 | 0 | 3 | 17 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 142 | 31 | 0 | 0 | 64 | 24 | 23 | 24 | 14 | 0 | 46 | 39 | 7 | 1 | 5 | 31 | 64 | 0 | 3 | 13 | 0 | 0 | 
| leaf | 0 | prover | 425,192,422 | 1,807 | 816 | 0 | 92 | 350 | 171 | 170 | 103 | 75 | 0 | 639 | 574 | 64 | 36 | 28 | 816 | 350 | 0 | 9 | 74 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 640,057,593 | 2,419 | 622 | 0 | 71 | 1,231 | 677 | 677 | 242 | 311 | 0 | 564 | 465 | 99 | 59 | 39 | 622 | 1,231 | 0 | 4 | 309 | 0 | 0 | 
| app_proof | prover | 1 | 640,057,356 | 2,290 | 615 | 0 | 0 | 1,230 | 674 | 674 | 244 | 310 | 0 | 444 | 343 | 100 | 61 | 38 | 615 | 1,230 | 0 | 4 | 309 | 0 | 0 | 
| app_proof | prover | 2 | 640,057,356 | 2,294 | 615 | 0 | 0 | 1,235 | 679 | 678 | 246 | 310 | 0 | 442 | 343 | 98 | 60 | 38 | 615 | 1,235 | 0 | 4 | 309 | 0 | 0 | 
| app_proof | prover | 3 | 640,057,588 | 2,293 | 619 | 0 | 0 | 1,229 | 671 | 671 | 247 | 310 | 0 | 444 | 349 | 94 | 56 | 37 | 620 | 1,229 | 0 | 5 | 309 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 2 | 66 | 2,726 | 66 | 139 | 5,529,436,044 | 2,165,730,336 | 7,695,166,380 | 2,097,152 | 0 | 4 | 101 | 2,851,000 | 32.37 | 
| app_proof | 1 | 1 | 59 | 2,621 | 59 | 43 | 5,529,347,520 | 2,165,557,968 | 7,694,905,488 | 2,097,152 | 0 | 2 | 228 | 2,851,000 | 36.02 | 
| app_proof | 2 | 1 | 58 | 2,592 | 58 | 44 | 5,529,349,296 | 2,165,556,192 | 7,694,905,488 | 2,097,152 | 0 | 2 | 194 | 2,851,000 | 36.03 | 
| app_proof | 3 | 1 | 56 | 2,579 | 56 | 43 | 5,077,435,956 | 2,617,472,316 | 7,694,908,272 | 2,097,152 | 0 | 2 | 186 | 2,614,961 | 36.10 | 

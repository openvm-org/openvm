...
|:---|---:|---:|---:|
| Total |  5.25 |  4.35 |  4.35 |
| app_proof |  3.74 |  2.84 |  2.84 |
| leaf |  0.94 |  0.94 |  0.94 |
...
| `total_proof_time_ms ` |  1,858.50 |  3,717 |  2,820 |  897 |
| `execute_metered_time_ms` |  24 | -          | -          | -          |
| `execute_metered_insns` |  1,979,971 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  80.83 | -          |  80.83 |  80.83 |
| `execute_preflight_insns` |  989,985.50 |  1,979,971 |  1,445,000 |  534,971 |
| `execute_preflight_time_ms` |  78.50 |  157 |  86 |  71 |
| `execute_preflight_insn_mi/s` |  30.90 | -          |  31.42 |  30.38 |
| `trace_gen_time_ms   ` |  38.50 |  77 |  61 |  16 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,652 |  3,304 |  2,551 |  753 |
| `prover.main_trace_commit_time_ms` |  592.50 |  1,185 |  957 |  228 |
| `prover.rap_constraints_time_ms` |  925.50 |  1,851 |  1,398 |  453 |
| `prover.openings_time_ms` |  133.50 |  267 |  196 |  71 |
| `prover.rap_constraints.logup_gkr_time_ms` |  153 |  306 |  218 |  88 |
| `prover.rap_constraints.round0_time_ms` |  553 |  1,106 |  848 |  258 |
| `prover.rap_constraints.mle_rounds_time_ms` |  217.50 |  435 |  330 |  105 |
...
| `prover.openings.whir_time_ms` |  32.50 |  65 |  40 |  25 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/c70a3434c6cb767f82a607653ef65b9ff9d37f4d/kitchen_sink-c70a3434c6cb767f82a607653ef65b9ff9d37f4d.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 72 | 9 |  |  | 0 |  | 373 | 9 |  |  |  |  |  |  | 
| app_proof |  |  |  |  |  | 897 |  |  | 24 | 1,979,971 | 80.83 | 0 | 3,745 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,577,979 | 259 | 117 | 0 | 0 | 107 | 34 | 34 | 52 | 20 | 0 | 34 | 20 | 14 | 3 | 9 | 118 | 107 | 0 | 2 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,767 | 141 | 45 | 0 | 0 | 68 | 26 | 25 | 27 | 14 | 0 | 26 | 18 | 8 | 1 | 6 | 46 | 68 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 126 | 31 | 0 | 0 | 64 | 25 | 24 | 24 | 15 | 0 | 29 | 22 | 7 | 1 | 5 | 31 | 64 | 0 | 2 | 13 | 0 | 0 | 
| leaf | 0 | prover | 260,613,236 | 825 | 400 | 0 | 1 | 347 | 133 | 132 | 77 | 135 | 0 | 78 | 37 | 40 | 22 | 18 | 400 | 347 | 0 | 7 | 134 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 902,782,844 | 2,551 | 956 | 0 | 308 | 1,398 | 848 | 847 | 330 | 218 | 67 | 196 | 40 | 155 | 87 | 68 | 957 | 1,398 | 0 | 3 | 150 | 0 | 0 | 
| app_proof | prover | 1 | 279,963,980 | 753 | 227 | 0 | 1 | 453 | 258 | 258 | 105 | 88 | 0 | 71 | 25 | 45 | 25 | 20 | 228 | 453 | 0 | 3 | 87 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 61 | 2,820 | 61 | 136 | 0 | 4 | 71 | 1,445,000 | 30.38 | 
| app_proof | 1 | 16 | 897 | 16 | 41 | 0 | 2 | 86 | 534,971 | 31.42 | 

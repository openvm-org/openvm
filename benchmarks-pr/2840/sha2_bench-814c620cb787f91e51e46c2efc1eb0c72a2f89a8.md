...
|:---|---:|---:|---:|
| Total |  10.97 |  4.54 |  4.54 |
| app_proof |  8.90 |  2.47 |  2.47 |
| leaf |  1.40 |  1.40 |  1.40 |
...
| `total_proof_time_ms ` |  2,200.75 |  8,803 |  2,374 |  2,123 |
...
| `execute_preflight_time_ms` |  161.75 |  647 |  204 |  98 |
| `execute_preflight_insn_mi/s` |  34.87 | -          |  35.84 |  32.37 |
| `trace_gen_time_ms   ` |  57.75 |  231 |  63 |  54 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,915.25 |  7,661 |  2,076 |  1,859 |
| `prover.main_trace_commit_time_ms` |  530.50 |  2,122 |  616 |  501 |
| `prover.rap_constraints_time_ms` |  1,249.25 |  4,997 |  1,321 |  1,221 |
| `prover.openings_time_ms` |  134.75 |  539 |  138 |  133 |
| `prover.rap_constraints.logup_gkr_time_ms` |  343.25 |  1,373 |  420 |  317 |
| `prover.rap_constraints.round0_time_ms` |  661.50 |  2,646 |  665 |  656 |
| `prover.rap_constraints.mle_rounds_time_ms` |  243.50 |  974 |  245 |  241 |
| `prover.openings.stacked_reduction_time_ms` |  97 |  388 |  99 |  96 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,400 |  1,400 |  1,400 |  1,400 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/814c620cb787f91e51e46c2efc1eb0c72a2f89a8/sha2_bench-814c620cb787f91e51e46c2efc1eb0c72a2f89a8.memory.svg)
...
| app_proof |  |  |  |  |  | 2,123 |  |  | 96 | 11,167,961 | 115.27 | 0 | 8,908 |  | 
...
| leaf | 0 | 148 | 1,400 | 147 | 55 | 22 | 2 | 6 | 6 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 61,220,667 | 353 | 182 | 0 | 0 | 129 | 37 | 37 | 63 | 28 | 0 | 40 | 22 | 18 | 5 | 12 | 183 | 129 | 0 | 3 | 26 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,943 | 151 | 49 | 0 | 0 | 72 | 25 | 24 | 29 | 17 | 0 | 28 | 19 | 8 | 1 | 6 | 49 | 72 | 0 | 2 | 16 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 122 | 31 | 0 | 0 | 62 | 24 | 23 | 24 | 13 | 0 | 27 | 20 | 7 | 1 | 5 | 31 | 62 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 425,192,422 | 1,252 | 796 | 0 | 156 | 348 | 167 | 166 | 105 | 75 | 0 | 107 | 42 | 64 | 36 | 28 | 796 | 348 | 0 | 7 | 74 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 640,057,593 | 2,076 | 616 | 0 | 115 | 1,321 | 656 | 656 | 243 | 420 | 120 | 138 | 39 | 99 | 60 | 39 | 616 | 1,321 | 0 | 3 | 298 | 0 | 0 | 
| app_proof | prover | 1 | 640,057,356 | 1,863 | 501 | 0 | 2 | 1,228 | 665 | 665 | 245 | 317 | 0 | 133 | 37 | 96 | 58 | 38 | 502 | 1,228 | 0 | 3 | 316 | 0 | 0 | 
| app_proof | prover | 2 | 640,057,356 | 1,863 | 501 | 0 | 2 | 1,227 | 665 | 664 | 245 | 317 | 0 | 134 | 37 | 97 | 59 | 38 | 501 | 1,227 | 0 | 3 | 315 | 0 | 0 | 
| app_proof | prover | 3 | 640,057,588 | 1,859 | 503 | 0 | 2 | 1,221 | 660 | 659 | 241 | 319 | 0 | 134 | 38 | 96 | 58 | 38 | 503 | 1,221 | 0 | 3 | 318 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 1 | 63 | 2,374 | 63 | 135 | 0 | 3 | 98 | 2,851,000 | 32.37 | 
| app_proof | 1 | 1 | 57 | 2,167 | 57 | 41 | 0 | 2 | 204 | 2,851,000 | 35.69 | 
| app_proof | 2 | 1 | 57 | 2,139 | 57 | 41 | 0 | 2 | 177 | 2,851,000 | 35.60 | 
| app_proof | 3 | 1 | 54 | 2,123 | 54 | 41 | 0 | 2 | 168 | 2,614,961 | 35.84 | 

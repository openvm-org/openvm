...
|:---|---:|---:|---:|
| Total |  11.22 |  4.64 |  4.64 |
| app_proof |  9.13 |  2.54 |  2.54 |
| leaf |  1.42 |  1.42 |  1.42 |
...
| `total_proof_time_ms ` |  2,257.25 |  9,029 |  2,444 |  2,170 |
...
| `execute_preflight_time_ms` |  168 |  672 |  216 |  104 |
| `execute_preflight_insn_mi/s` |  33.64 | -          |  34.60 |  30.93 |
| `trace_gen_time_ms   ` |  58 |  232 |  64 |  54 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,965.25 |  7,861 |  2,140 |  1,903 |
| `prover.main_trace_commit_time_ms` |  541 |  2,164 |  630 |  511 |
| `prover.rap_constraints_time_ms` |  1,282.50 |  5,130 |  1,365 |  1,249 |
| `prover.openings_time_ms` |  140.75 |  563 |  144 |  138 |
| `prover.rap_constraints.logup_gkr_time_ms` |  359.25 |  1,437 |  446 |  330 |
| `prover.rap_constraints.round0_time_ms` |  671.50 |  2,686 |  677 |  666 |
| `prover.rap_constraints.mle_rounds_time_ms` |  250.25 |  1,001 |  251 |  249 |
| `prover.openings.stacked_reduction_time_ms` |  100.25 |  401 |  102 |  99 |
...
| `prover.openings.whir_time_ms` |  39.75 |  159 |  41 |  38 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/c0b116528167e733e548394631e32480875a97e1/sha2_bench-c0b116528167e733e548394631e32480875a97e1.memory.svg)
...
| app_proof |  |  |  |  |  | 2,170 |  |  | 97 | 11,167,961 | 114.79 | 0 | 9,132 |  | 
...
| leaf | 0 | 146 | 1,422 | 145 | 50 | 22 | 2 | 6 | 6 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 61,220,667 | 357 | 185 | 0 | 0 | 133 | 39 | 38 | 66 | 27 | 0 | 38 | 19 | 18 | 5 | 13 | 185 | 133 | 0 | 3 | 26 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,943 | 150 | 48 | 0 | 0 | 73 | 25 | 25 | 29 | 18 | 0 | 27 | 18 | 8 | 2 | 6 | 49 | 73 | 0 | 2 | 17 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 121 | 32 | 0 | 0 | 62 | 24 | 23 | 24 | 13 | 0 | 26 | 18 | 7 | 1 | 5 | 32 | 62 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 425,192,422 | 1,276 | 808 | 0 | 155 | 357 | 174 | 173 | 106 | 75 | 0 | 110 | 45 | 64 | 36 | 28 | 808 | 357 | 0 | 7 | 75 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 640,057,593 | 2,140 | 630 | 0 | 122 | 1,365 | 666 | 666 | 251 | 446 | 131 | 144 | 41 | 102 | 62 | 40 | 630 | 1,365 | 0 | 4 | 314 | 0 | 0 | 
| app_proof | prover | 1 | 640,057,356 | 1,908 | 511 | 0 | 2 | 1,259 | 675 | 675 | 251 | 331 | 0 | 138 | 38 | 99 | 60 | 38 | 511 | 1,259 | 0 | 3 | 329 | 0 | 0 | 
| app_proof | prover | 2 | 640,057,356 | 1,910 | 511 | 0 | 2 | 1,257 | 677 | 676 | 249 | 330 | 0 | 141 | 39 | 101 | 62 | 39 | 511 | 1,257 | 0 | 4 | 328 | 0 | 0 | 
| app_proof | prover | 3 | 640,057,588 | 1,903 | 512 | 0 | 2 | 1,249 | 668 | 668 | 250 | 330 | 0 | 140 | 41 | 99 | 60 | 38 | 512 | 1,249 | 0 | 3 | 329 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 64 | 2,444 | 64 | 134 | 0 | 3 | 104 | 2,851,000 | 30.93 | 
| app_proof | 1 | 57 | 2,224 | 57 | 41 | 0 | 2 | 216 | 2,851,000 | 34.51 | 
| app_proof | 2 | 57 | 2,191 | 57 | 41 | 0 | 2 | 181 | 2,851,000 | 34.60 | 
| app_proof | 3 | 54 | 2,170 | 54 | 41 | 0 | 2 | 171 | 2,614,961 | 34.52 | 

...
|:---|---:|---:|---:|
| Total | <span style='color: green'>(-0 [-2.1%])</span> 1.50 | <span style='color: green'>(-0 [-3.1%])</span> 0.91 | 0.91 |
| pairing | <span style='color: green'>(-0 [-2.1%])</span> 1.50 | <span style='color: green'>(-0 [-3.1%])</span> 0.91 |  0.91 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: green'>(-16 [-2.2%])</span> 721 | <span style='color: green'>(-32 [-2.2%])</span> 1,442 | <span style='color: green'>(-29 [-3.3%])</span> 842 | <span style='color: green'>(-3 [-0.5%])</span> 600 |
...
| `execute_metered_insn_mi/s` | <span style='color: green'>(-0 [-0.2%])</span> 27.38 | -          | <span style='color: green'>(-0 [-0.2%])</span> 27.38 | <span style='color: green'>(-0 [-0.2%])</span> 27.38 |
| `execute_preflight_insns` |  872,871 |  1,745,742 |  1,149,000 |  596,742 |
| `execute_preflight_time_ms` | <span style='color: green'>(-0 [-0.6%])</span> 83 | <span style='color: green'>(-1 [-0.6%])</span> 166 |  106 | <span style='color: green'>(-1 [-1.6%])</span> 60 |
| `execute_preflight_insn_mi/s` | <span style='color: green'>(-0 [-0.3%])</span> 14.69 | -          |  18.22 | <span style='color: green'>(-0 [-0.9%])</span> 11.16 |
| `trace_gen_time_ms   ` | <span style='color: green'>(-3 [-1.6%])</span> 183 | <span style='color: green'>(-6 [-1.6%])</span> 366 | <span style='color: green'>(-2 [-1.0%])</span> 190 | <span style='color: green'>(-4 [-2.2%])</span> 176 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: green'>(-11 [-3.1%])</span> 349.50 | <span style='color: green'>(-22 [-3.1%])</span> 699 | <span style='color: green'>(-23 [-5.6%])</span> 390 | <span style='color: red'>(+1 [+0.3%])</span> 309 |
| `main_trace_commit_time_ms` | <span style='color: green'>(-0 [-0.8%])</span> 64 | <span style='color: green'>(-1 [-0.8%])</span> 128 |  75 | <span style='color: green'>(-1 [-1.9%])</span> 53 |
| `generate_perm_trace_time_ms` | <span style='color: green'>(-11 [-24.4%])</span> 34 | <span style='color: green'>(-22 [-24.4%])</span> 68 | <span style='color: green'>(-14 [-26.4%])</span> 39 | <span style='color: green'>(-8 [-21.6%])</span> 29 |
| `perm_trace_commit_time_ms` | <span style='color: red'>(+0 [+0.3%])</span> 77.19 | <span style='color: red'>(+0 [+0.3%])</span> 154.39 | <span style='color: green'>(-0 [-0.3%])</span> 89.29 | <span style='color: red'>(+1 [+1.0%])</span> 65.10 |
| `quotient_poly_compute_time_ms` | <span style='color: green'>(-1 [-1.4%])</span> 82.96 | <span style='color: green'>(-2 [-1.4%])</span> 165.92 | <span style='color: green'>(-0 [-0.5%])</span> 91.94 | <span style='color: green'>(-2 [-2.6%])</span> 73.98 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+1 [+4.3%])</span> 17.62 | <span style='color: red'>(+1 [+4.3%])</span> 35.24 | <span style='color: red'>(+1 [+7.0%])</span> 19.90 | <span style='color: red'>(+0 [+0.9%])</span> 15.34 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+1 [+1.5%])</span> 68.50 | <span style='color: red'>(+2 [+1.5%])</span> 137 | <span style='color: green'>(-9 [-11.4%])</span> 70 | <span style='color: red'>(+11 [+19.6%])</span> 67 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 600 | 1 | 63 | 1,745,742 | 27.38 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 176 | 842 | 32,480,114 | 172,558,444 | 176 | 390 | 0 | 91.94 | 19.90 | 6 | 89.29 | 70 | 131 | 69 | 1 | 75 | 15,909,408 | 39 | 106 | 1,149,000 | 11.16 | 27 | 112 | 1 | 69 | 
| pairing | 1 | 190 | 600 | 22,464,232 | 119,958,502 | 190 | 309 | 1 | 73.98 | 15.34 | 6 | 65.10 | 67 | 97 | 67 | 0 | 53 | 9,498,894 | 29 | 60 | 596,742 | 18.22 | 21 | 89 | 1 | 67 | 

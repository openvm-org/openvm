...
|:---|---:|---:|---:|
| Total |  3.25 |  2.27 |  2.27 |
| app_proof |  2.44 |  1.46 |  1.46 |
| leaf |  0.43 |  0.43 |  0.43 |
...
| `total_proof_time_ms ` |  1,215.50 |  2,431 |  1,454 |  977 |
| `execute_metered_time_ms` |  7 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  20.29 | -          |  20.29 |  20.29 |
| `execute_preflight_insns` |  77,381.50 |  154,763 |  121,000 |  33,763 |
| `execute_preflight_time_ms` |  77.50 |  155 |  132 |  23 |
| `execute_preflight_insn_mi/s` |  8.30 | -          |  10.85 |  5.74 |
| `trace_gen_time_ms   ` |  158 |  316 |  188 |  128 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  864 |  1,728 |  1,053 |  675 |
| `prover.main_trace_commit_time_ms` |  225 |  450 |  300 |  150 |
| `prover.rap_constraints_time_ms` |  575.50 |  1,151 |  677 |  474 |
| `prover.openings_time_ms` |  62.50 |  125 |  75 |  50 |
| `prover.rap_constraints.logup_gkr_time_ms` |  145 |  290 |  159 |  131 |
| `prover.rap_constraints.round0_time_ms` |  293 |  586 |  372 |  214 |
| `prover.rap_constraints.mle_rounds_time_ms` |  136.50 |  273 |  145 |  128 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/b356a2202089a19d345c8160e2ec7bad4d6e68bd/kitchen_sink-b356a2202089a19d345c8160e2ec7bad4d6e68bd.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 76 | 3 |  |  | 0 |  | 345 | 3 |  |  |  |  |  |  | 
| app_proof |  |  |  |  |  | 977 |  |  | 7 | 154,763 | 20.29 | 0 | 2,444 |  | 
...
| app_proof | VmAirWrapper<Rv32HeapAdapterAir<2, 32, 32>, MultiplicationCoreAir<32, 8> | 0 | 1 | 
...
| internal_recursive.0 | 1 | 10 | 114 | 10 | 1 | 0 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 9 | 106 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 124 | 434 | 124 | 27 | 11 | 17 | 6 | 6 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 53,472,003 | 140 | 40 | 0 | 4 | 65 | 20 | 19 | 29 | 15 | 0 | 33 | 9 | 24 | 1 | 22 | 41 | 65 | 0 | 1 | 14 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 23,651,975 | 104 | 19 | 0 | 4 | 51 | 17 | 17 | 20 | 13 | 0 | 32 | 9 | 22 | 1 | 21 | 19 | 51 | 0 | 1 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 17,507,975 | 97 | 14 | 0 | 4 | 52 | 17 | 17 | 20 | 13 | 0 | 30 | 8 | 21 | 0 | 20 | 14 | 52 | 0 | 1 | 13 | 0 | 0 | 
| leaf | 0 | prover | 407,935,872 | 309 | 123 | 0 | 9 | 142 | 46 | 45 | 36 | 59 | 0 | 43 | 11 | 31 | 6 | 24 | 124 | 142 | 0 | 2 | 58 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 816,542,084 | 1,053 | 300 | 0 | 171 | 677 | 372 | 371 | 145 | 159 | 65 | 75 | 13 | 62 | 16 | 46 | 300 | 677 | 0 | 1 | 92 | 0 | 0 | 
| app_proof | prover | 1 | 800,298,548 | 675 | 150 | 0 | 20 | 474 | 214 | 214 | 128 | 131 | 78 | 50 | 13 | 37 | 14 | 22 | 150 | 474 | 0 | 1 | 52 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 188 | 1,454 | 188 | 188 | 0 | 5 | 23 | 121,000 | 10.85 | 
| app_proof | 1 | 128 | 977 | 128 | 41 | 0 | 3 | 132 | 33,763 | 5.74 | 

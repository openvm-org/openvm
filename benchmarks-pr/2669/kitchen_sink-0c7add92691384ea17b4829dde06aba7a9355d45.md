...
|:---|---:|---:|---:|
| Total |  2.99 |  2.19 |  2.19 |
| app_proof |  2.18 |  1.39 |  1.39 |
| leaf |  0.44 |  0.44 |  0.44 |
...
| `total_proof_time_ms ` |  1,075.50 |  2,151 |  1,351 |  800 |
| `execute_metered_time_ms` |  34 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  74.79 | -          |  74.79 |  74.79 |
| `execute_preflight_insns` |  1,289,951.50 |  2,579,903 |  1,540,000 |  1,039,903 |
| `execute_preflight_time_ms` |  96.50 |  193 |  131 |  62 |
| `execute_preflight_insn_mi/s` |  36.19 | -          |  37.34 |  35.04 |
| `trace_gen_time_ms   ` |  61.50 |  123 |  79 |  44 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  803.50 |  1,607 |  1,025 |  582 |
| `prover.main_trace_commit_time_ms` |  227 |  454 |  305 |  149 |
| `prover.rap_constraints_time_ms` |  513.50 |  1,027 |  644 |  383 |
| `prover.openings_time_ms` |  62 |  124 |  75 |  49 |
| `prover.rap_constraints.logup_gkr_time_ms` |  150 |  300 |  165 |  135 |
| `prover.rap_constraints.round0_time_ms` |  261 |  522 |  350 |  172 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/0c7add92691384ea17b4829dde06aba7a9355d45/kitchen_sink-0c7add92691384ea17b4829dde06aba7a9355d45.memory.svg)
...
| app_proof |  |  |  |  |  | 800 |  |  | 34 | 2,579,903 | 74.79 | 0 | 2,190 |  | 
...
| app_proof | VmAirWrapper<Rv32JalrAdapterAir, Rv32JalrCoreAir> | 0 | 1 | 
...
| internal_recursive.1 | 1 | prover | 17,507,975 | 94 | 14 | 0 | 4 | 49 | 17 | 16 | 18 | 13 | 0 | 29 | 8 | 21 | 0 | 20 | 14 | 49 | 0 | 1 | 12 | 0 | 0 | 
| leaf | 0 | prover | 428,317,568 | 321 | 131 | 0 | 10 | 145 | 48 | 47 | 37 | 59 | 0 | 44 | 12 | 31 | 7 | 24 | 132 | 145 | 0 | 2 | 59 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 787,664,364 | 1,025 | 304 | 0 | 174 | 644 | 350 | 348 | 129 | 165 | 64 | 75 | 12 | 62 | 15 | 46 | 305 | 644 | 0 | 1 | 99 | 0 | 0 | 
| app_proof | prover | 1 | 700,866,292 | 582 | 149 | 0 | 23 | 383 | 172 | 172 | 75 | 135 | 73 | 49 | 12 | 37 | 14 | 22 | 149 | 383 | 0 | 1 | 61 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 79 | 1,351 | 79 | 184 | 0 | 3 | 62 | 1,540,000 | 35.04 | 
| app_proof | 1 | 44 | 800 | 44 | 40 | 0 | 1 | 131 | 1,039,903 | 37.34 | 

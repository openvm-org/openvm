...
|:---|---:|---:|
| Total |  245.74 |  229.33 |
| kitchen_sink |  21.12 |  13.93 |
| leaf |  41.59 |  32.37 |
| internal.0 |  10.36 |  10.36 |
| root |  39.19 |  39.19 |
| halo2_outer |  89.50 |  89.50 |
| halo2_wrapper |  43.98 |  43.98 |


| kitchen_sink |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  10,561 |  21,122 |  13,934 |  7,188 |
...
| `trace_gen_time_ms   ` |  365 |  730 |  466 |  264 |
| `stark_prove_excluding_trace_time_ms` |  10,176 |  20,352 |  13,437 |  6,915 |
| `main_trace_commit_time_ms` |  3,200 |  6,400 |  4,390 |  2,010 |
| `generate_perm_trace_time_ms` |  289 |  578 |  382 |  196 |
| `perm_trace_commit_time_ms` |  1,250 |  2,500 |  1,660 |  840 |
| `quotient_poly_compute_time_ms` |  4,272.50 |  8,545 |  5,671 |  2,874 |
| `quotient_poly_commit_time_ms` |  237 |  474 |  271 |  203 |
| `pcs_opening_time_ms ` |  897 |  1,794 |  1,015 |  779 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  20,794 |  41,588 |  32,367 |  9,221 |
| `main_cells_used     ` |  463,782,314 |  927,564,628 |  739,553,744 |  188,010,884 |
| `total_cycles        ` |  5,251,159.50 |  10,502,319 |  8,097,569 |  2,404,750 |
| `execute_time_ms     ` |  1,878.50 |  3,757 |  2,838 |  919 |
| `trace_gen_time_ms   ` |  4,115.50 |  8,231 |  6,392 |  1,839 |
| `stark_prove_excluding_trace_time_ms` |  14,800 |  29,600 |  23,137 |  6,463 |
| `main_trace_commit_time_ms` |  2,728.50 |  5,457 |  4,321 |  1,136 |
| `generate_perm_trace_time_ms` |  1,093.50 |  2,187 |  1,732 |  455 |
| `perm_trace_commit_time_ms` |  4,757.50 |  9,515 |  7,600 |  1,915 |
| `quotient_poly_compute_time_ms` |  2,223.50 |  4,447 |  3,440 |  1,007 |
| `quotient_poly_commit_time_ms` |  1,281 |  2,562 |  1,941 |  621 |
| `pcs_opening_time_ms ` |  2,710.50 |  5,421 |  4,098 |  1,323 |

| internal.0 |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  10,360 |  10,360 |  10,360 |  10,360 |
| `main_cells_used     ` |  143,863,646 |  143,863,646 |  143,863,646 |  143,863,646 |
| `total_cycles        ` |  2,397,971 |  2,397,971 |  2,397,971 |  2,397,971 |
| `execute_time_ms     ` |  1,066 |  1,066 |  1,066 |  1,066 |
| `trace_gen_time_ms   ` |  1,306 |  1,306 |  1,306 |  1,306 |
| `stark_prove_excluding_trace_time_ms` |  7,988 |  7,988 |  7,988 |  7,988 |
| `main_trace_commit_time_ms` |  1,759 |  1,759 |  1,759 |  1,759 |
| `generate_perm_trace_time_ms` |  343 |  343 |  343 |  343 |
| `perm_trace_commit_time_ms` |  1,452 |  1,452 |  1,452 |  1,452 |
| `quotient_poly_compute_time_ms` |  1,471 |  1,471 |  1,471 |  1,471 |
| `quotient_poly_commit_time_ms` |  1,279 |  1,279 |  1,279 |  1,279 |
| `pcs_opening_time_ms ` |  1,678 |  1,678 |  1,678 |  1,678 |

| root |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  39,188 |  39,188 |  39,188 |  39,188 |
| `main_cells_used     ` |  38,197,006 |  38,197,006 |  38,197,006 |  38,197,006 |
| `total_cycles        ` |  766,835 |  766,835 |  766,835 |  766,835 |
| `execute_time_ms     ` |  252 |  252 |  252 |  252 |
| `trace_gen_time_ms   ` |  396 |  396 |  396 |  396 |
| `stark_prove_excluding_trace_time_ms` |  38,540 |  38,540 |  38,540 |  38,540 |
| `main_trace_commit_time_ms` |  12,347 |  12,347 |  12,347 |  12,347 |
...
| `quotient_poly_commit_time_ms` |  13,863 |  13,863 |  13,863 |  13,863 |
| `pcs_opening_time_ms ` |  3,754 |  3,754 |  3,754 |  3,754 |

| halo2_outer |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  89,497 |  89,497 |  89,497 |  89,497 |
| `main_cells_used     ` |  62,297,054 |  62,297,054 |  62,297,054 |  62,297,054 |

| halo2_wrapper |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  43,985 |  43,985 |  43,985 |  43,985 |
...
| --- | --- | --- | --- |
| halo2_outer | 89,497 |  | 62,297,054 | 
| halo2_wrapper | 43,985 |  |  | 
| kitchen_sink |  | 2 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal.0 | 0 | 1,306 | 10,360 | 2,397,971 | 420,325,858 | 7,988 | 1,471 | 1,279 | 1,452 | 1,678 | 1,759 | 143,863,646 | 343 | 1,066 | 
| leaf | 0 | 6,392 | 32,367 | 8,097,569 | 2,772,897,258 | 23,137 | 3,440 | 1,941 | 7,600 | 4,098 | 4,321 | 739,553,744 | 1,732 | 2,838 | 
| leaf | 1 | 1,839 | 9,221 | 2,404,750 | 746,278,378 | 6,463 | 1,007 | 621 | 1,915 | 1,323 | 1,136 | 188,010,884 | 455 | 919 | 
| root | 0 | 396 | 39,188 | 766,835 | 80,435,354 | 38,540 | 864 | 13,863 | 7,629 | 3,754 | 12,347 | 38,197,006 | 75 | 252 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| kitchen_sink | 0 | 466 | 13,934 | 85,850 | 1,307,172,505 | 13,437 | 5,671 | 271 | 1,660 | 1,015 | 4,390 | 632,432,647 | 382 | 31 | 
| kitchen_sink | 1 | 264 | 7,188 | 13,666 | 661,752,828 | 6,915 | 2,874 | 203 | 840 | 779 | 2,010 | 264,431,162 | 196 | 9 | 

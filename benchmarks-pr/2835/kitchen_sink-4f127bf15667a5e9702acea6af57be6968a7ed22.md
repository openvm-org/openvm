...
| `total_proof_time_ms ` |  1,951.50 |  3,903 |  2,259 |  1,644 |
...
| `execute_preflight_time_ms` |  101.50 |  203 |  138 |  65 |
| `execute_preflight_insn_mi/s` |  33.61 | -          |  34.70 |  32.53 |
| `trace_gen_time_ms   ` |  145.50 |  291 |  190 |  101 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,595 |  3,190 |  1,827 |  1,363 |
| `prover.main_trace_commit_time_ms` |  518 |  1,036 |  603 |  433 |
| `prover.rap_constraints_time_ms` |  948 |  1,896 |  1,092 |  804 |
| `prover.openings_time_ms` |  128 |  256 |  131 |  125 |
| `prover.rap_constraints.logup_gkr_time_ms` |  169 |  338 |  200 |  138 |
| `prover.rap_constraints.round0_time_ms` |  574 |  1,148 |  677 |  471 |
| `prover.rap_constraints.mle_rounds_time_ms` |  203.50 |  407 |  214 |  193 |
| `prover.openings.stacked_reduction_time_ms` |  94 |  188 |  101 |  87 |
| `prover.openings.stacked_reduction.round0_time_ms` |  50 |  100 |  51 |  49 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  43 |  86 |  49 |  37 |
...
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  845 |  845 |  845 |  845 |
| `prover.main_trace_commit_time_ms` |  406 |  406 |  406 |  406 |
| `prover.rap_constraints_time_ms` |  359 |  359 |  359 |  359 |
| `prover.openings_time_ms` |  79 |  79 |  79 |  79 |
| `prover.rap_constraints.logup_gkr_time_ms` |  139 |  139 |  139 |  139 |
| `prover.rap_constraints.round0_time_ms` |  140 |  140 |  140 |  140 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/4f127bf15667a5e9702acea6af57be6968a7ed22/kitchen_sink-4f127bf15667a5e9702acea6af57be6968a7ed22.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 77 | 9 |  |  | 0 |  | 379 | 9 |  |  |  |  |  |  | 
| app_proof |  |  |  |  |  | 1,644 |  |  | 34 | 2,579,903 | 73.98 | 0 | 3,942 |  | 
...
| leaf | 0 | 124 | 969 | 124 | 23 | 9 | 21 | 5 | 5 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,577,979 | 260 | 118 | 0 | 0 | 108 | 36 | 35 | 51 | 20 | 0 | 32 | 18 | 13 | 3 | 9 | 119 | 108 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,767 | 141 | 46 | 0 | 0 | 66 | 24 | 24 | 28 | 13 | 0 | 27 | 19 | 8 | 1 | 6 | 46 | 66 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 124 | 32 | 0 | 0 | 64 | 25 | 24 | 24 | 14 | 0 | 27 | 20 | 7 | 1 | 5 | 32 | 64 | 0 | 2 | 13 | 0 | 0 | 
| leaf | 0 | prover | 265,003,892 | 845 | 405 | 0 | 1 | 359 | 140 | 139 | 79 | 139 | 0 | 79 | 38 | 41 | 22 | 19 | 406 | 359 | 0 | 6 | 138 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 567,917,156 | 1,827 | 602 | 0 | 187 | 1,092 | 677 | 676 | 214 | 200 | 56 | 131 | 30 | 101 | 51 | 49 | 603 | 1,092 | 0 | 3 | 141 | 0 | 0 | 
| app_proof | prover | 1 | 537,266,124 | 1,363 | 432 | 0 | 1 | 804 | 471 | 471 | 193 | 138 | 0 | 125 | 38 | 87 | 49 | 37 | 433 | 804 | 0 | 4 | 137 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 190 | 2,259 | 190 | 176 | 0 | 4 | 65 | 1,540,000 | 32.53 | 
| app_proof | 1 | 101 | 1,644 | 101 | 41 | 0 | 2 | 138 | 1,039,903 | 34.70 | 

...
| `total_proof_time_ms ` |  716 |  1,432 |  828 |  604 |
| `execute_metered_time_ms` |  71 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  24.32 | -          |  24.32 |  24.32 |
| `execute_preflight_insns` |  872,878.50 |  1,745,757 |  1,151,000 |  594,757 |
| `execute_preflight_time_ms` |  84 |  168 |  121 |  47 |
| `execute_preflight_insn_mi/s` |  14.81 | -          |  18.44 |  11.18 |
| `trace_gen_time_ms   ` |  183 |  366 |  204 |  162 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  343 |  686 |  375 |  311 |
| `main_trace_commit_time_ms` |  64 |  128 |  75 |  53 |
| `generate_perm_trace_time_ms` |  40 |  80 |  44 |  36 |
| `perm_trace_commit_time_ms` |  74.75 |  149.51 |  84.39 |  65.12 |
| `quotient_poly_compute_time_ms` |  81.34 |  162.67 |  88.43 |  74.24 |
| `quotient_poly_commit_time_ms` |  16.95 |  33.89 |  18.60 |  15.29 |
| `pcs_opening_time_ms ` |  61 |  122 |  68 |  54 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 604 | 1 | 71 | 1,745,757 | 24.32 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 162 | 828 | 172,558,444 | 162 | 375 | 0 | 88.43 | 18.60 | 6 | 84.39 | 68 | 123 | 68 | 1 | 75 | 36 | 121 | 1,151,000 | 11.18 | 26 | 107 | 1 | 68 | 
| pairing | 1 | 204 | 604 | 119,958,502 | 204 | 311 | 1 | 74.24 | 15.29 | 6 | 65.12 | 54 | 112 | 54 | 0 | 53 | 44 | 47 | 594,757 | 18.44 | 20 | 90 | 1 | 54 | 

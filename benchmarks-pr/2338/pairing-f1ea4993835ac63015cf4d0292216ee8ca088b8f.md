...
|:---|---:|---:|---:|
| Total |  1.54 |  0.90 | 0.90 |
| pairing |  1.54 |  0.90 |  0.90 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  739 |  1,478 |  834 |  644 |
...
| `execute_preflight_insn_mi/s` |  14.66 | -          |  18.19 |  11.14 |
| `trace_gen_time_ms   ` |  182.50 |  365 |  204 |  161 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  366.50 |  733 |  381 |  352 |
| `main_trace_commit_time_ms` |  63.50 |  127 |  74 |  53 |
| `generate_perm_trace_time_ms` |  40 |  80 |  45 |  35 |
| `perm_trace_commit_time_ms` |  76.54 |  153.09 |  88.11 |  64.97 |
| `quotient_poly_compute_time_ms` |  81.97 |  163.95 |  90.35 |  73.60 |
| `quotient_poly_commit_time_ms` |  17.31 |  34.63 |  19.27 |  15.36 |
| `pcs_opening_time_ms ` |  82 |  164 |  95 |  69 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 644 | 1 | 67 | 1,745,757 | 26.03 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 161 | 834 | 172,558,444 | 161 | 381 | 0 | 90.35 | 19.27 | 6 | 88.11 | 69 | 126 | 69 | 1 | 74 | 35 | 122 | 1,151,000 | 11.14 | 27 | 110 | 1 | 69 | 
| pairing | 1 | 204 | 644 | 119,958,502 | 204 | 352 | 1 | 73.60 | 15.36 | 6 | 64.97 | 95 | 112 | 95 | 0 | 53 | 45 | 47 | 594,757 | 18.19 | 21 | 89 | 1 | 95 | 

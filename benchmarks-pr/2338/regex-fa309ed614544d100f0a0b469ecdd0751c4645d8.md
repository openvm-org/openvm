...
|:---|---:|---:|---:|
| Total | <span style='color: red'>(+0 [+1.0%])</span> 2.36 | <span style='color: red'>(+0 [+2.5%])</span> 0.75 | 0.75 |
| regex_program | <span style='color: red'>(+0 [+1.0%])</span> 2.36 | <span style='color: red'>(+0 [+2.5%])</span> 0.75 |  0.75 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+6 [+1.0%])</span> 581.50 | <span style='color: red'>(+24 [+1.0%])</span> 2,326 | <span style='color: red'>(+18 [+2.6%])</span> 711 | <span style='color: red'>(+2 [+0.4%])</span> 533 |
...
| `execute_metered_insn_mi/s` | <span style='color: red'>(+0 [+0.2%])</span> 114.15 | -          | <span style='color: red'>(+0 [+0.2%])</span> 114.15 | <span style='color: red'>(+0 [+0.2%])</span> 114.15 |
...
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+1 [+2.9%])</span> 32.85 | -          | <span style='color: red'>(+1 [+2.6%])</span> 33.42 | <span style='color: red'>(+1 [+3.8%])</span> 31.82 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+3 [+1.8%])</span> 182.50 | <span style='color: red'>(+13 [+1.8%])</span> 730 | <span style='color: red'>(+3 [+1.5%])</span> 198 | <span style='color: red'>(+7 [+4.1%])</span> 176 |
| `memory_finalize_time_ms` |  1 |  4 |  4 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+3 [+1.0%])</span> 280.25 | <span style='color: red'>(+11 [+1.0%])</span> 1,121 | <span style='color: red'>(+13 [+4.4%])</span> 310 |  269 |
...
| `generate_perm_trace_time_ms` | <span style='color: red'>(+2 [+8.6%])</span> 25.25 | <span style='color: red'>(+8 [+8.6%])</span> 101 | <span style='color: red'>(+5 [+17.2%])</span> 34 | <span style='color: red'>(+2 [+10.5%])</span> 21 |
| `perm_trace_commit_time_ms` | <span style='color: red'>(+1 [+1.2%])</span> 65.50 | <span style='color: red'>(+3 [+1.2%])</span> 262 | <span style='color: red'>(+2 [+2.3%])</span> 71.97 | <span style='color: green'>(-0 [-0.3%])</span> 54.98 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+0 [+0.6%])</span> 61.06 | <span style='color: red'>(+1 [+0.6%])</span> 244.25 | <span style='color: red'>(+2 [+2.8%])</span> 72.96 | <span style='color: red'>(+0 [+0.1%])</span> 54.30 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+0 [+2.7%])</span> 16.22 | <span style='color: red'>(+2 [+2.7%])</span> 64.86 | <span style='color: red'>(+0 [+2.4%])</span> 18.70 | <span style='color: red'>(+0 [+3.0%])</span> 13.82 |
| `pcs_opening_time_ms ` | <span style='color: green'>(-0 [-0.9%])</span> 57.50 | <span style='color: green'>(-2 [-0.9%])</span> 230 | <span style='color: green'>(-2 [-3.0%])</span> 65 | <span style='color: green'>(-3 [-5.6%])</span> 51 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 544 | 1 | 36 | 4,137,502 | 114.15 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 176 | 711 | 23,446,148 | 150,778,428 | 176 | 310 | 0 | 61.39 | 18.70 | 5 | 71.97 | 65 | 107 | 65 | 4 | 56 | 10,899,170 | 34 | 55 | 1,103,000 | 31.82 | 22 | 80 | 1 | 65 | 
| regex_program | 1 | 180 | 538 | 11,598,276 | 128,513,066 | 180 | 272 | 1 | 55.59 | 15.80 | 5 | 67.80 | 56 | 92 | 56 | 0 | 50 | 2,196,106 | 24 | 44 | 1,104,000 | 33.02 | 17 | 72 | 0 | 56 | 
| regex_program | 2 | 176 | 533 | 11,579,064 | 128,513,066 | 176 | 269 | 1 | 54.30 | 16.55 | 4 | 67.25 | 58 | 89 | 58 | 0 | 50 | 2,177,334 | 21 | 46 | 1,104,000 | 33.42 | 17 | 71 | 0 | 58 | 
| regex_program | 3 | 198 | 544 | 11,853,872 | 103,456,394 | 198 | 270 | 0 | 72.96 | 13.82 | 5 | 54.98 | 51 | 81 | 51 | 0 | 49 | 2,422,606 | 22 | 34 | 826,502 | 33.16 | 19 | 87 | 1 | 51 | 
...
Commit: https://github.com/openvm-org/openvm/commit/fa309ed614544d100f0a0b469ecdd0751c4645d8
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/20706343944)

...
|:---|---:|---:|---:|
| Total | <span style='color: green'>(-0 [-0.6%])</span> 2.38 | <span style='color: red'>(+0 [+1.6%])</span> 0.75 | 0.75 |
| regex_program | <span style='color: green'>(-0 [-0.5%])</span> 2.38 | <span style='color: red'>(+0 [+2.0%])</span> 0.75 |  0.75 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: green'>(-3 [-0.5%])</span> 586.25 | <span style='color: green'>(-11 [-0.5%])</span> 2,345 | <span style='color: red'>(+15 [+2.1%])</span> 715 | <span style='color: green'>(-3 [-0.6%])</span> 532 |
| `main_cells_used     ` |  4,423,804 |  17,695,216 |  10,899,170 |  2,177,334 |
| `total_cells_used    ` |  14,619,340 |  58,477,360 |  23,446,148 |  11,579,064 |
| `execute_metered_time_ms` | <span style='color: green'>(-3 [-7.9%])</span> 35 | -          | -          | -          |
| `execute_metered_insn_mi/s` | <span style='color: red'>(+7 [+6.6%])</span> 115.59 | -          | <span style='color: red'>(+7 [+6.6%])</span> 115.59 | <span style='color: red'>(+7 [+6.6%])</span> 115.59 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` | <span style='color: red'>(+1 [+1.9%])</span> 53.75 | <span style='color: red'>(+4 [+1.9%])</span> 215 | <span style='color: red'>(+2 [+3.1%])</span> 66 | <span style='color: red'>(+1 [+2.3%])</span> 45 |
| `execute_preflight_insn_mi/s` | <span style='color: green'>(-1 [-2.8%])</span> 31.24 | -          | <span style='color: green'>(-1 [-4.3%])</span> 32.32 | <span style='color: green'>(-1 [-2.3%])</span> 28.41 |
| `trace_gen_time_ms   ` | <span style='color: green'>(-3 [-1.6%])</span> 170.50 | <span style='color: green'>(-11 [-1.6%])</span> 682 | <span style='color: red'>(+1 [+0.5%])</span> 185 | <span style='color: green'>(-4 [-2.5%])</span> 155 |
| `memory_finalize_time_ms` |  1 |  4 |  4 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: green'>(-1 [-0.3%])</span> 287.50 | <span style='color: green'>(-3 [-0.3%])</span> 1,150 | <span style='color: red'>(+20 [+6.7%])</span> 319 | <span style='color: green'>(-1 [-0.4%])</span> 269 |
| `main_trace_commit_time_ms` | <span style='color: green'>(-0 [-0.5%])</span> 52 | <span style='color: green'>(-1 [-0.5%])</span> 208 |  57 | <span style='color: green'>(-1 [-2.0%])</span> 49 |
| `generate_perm_trace_time_ms` | <span style='color: green'>(-7 [-20.1%])</span> 28.75 | <span style='color: green'>(-29 [-20.1%])</span> 115 | <span style='color: green'>(-15 [-30.6%])</span> 34 | <span style='color: green'>(-5 [-17.2%])</span> 24 |
| `perm_trace_commit_time_ms` | <span style='color: red'>(+1 [+1.0%])</span> 64.39 | <span style='color: red'>(+2 [+1.0%])</span> 257.55 | <span style='color: green'>(-0 [-0.5%])</span> 70.52 | <span style='color: red'>(+0 [+0.6%])</span> 54.52 |
| `quotient_poly_compute_time_ms` | <span style='color: green'>(-0 [-0.5%])</span> 60.69 | <span style='color: green'>(-1 [-0.5%])</span> 242.74 | <span style='color: green'>(-1 [-0.8%])</span> 72.75 | <span style='color: green'>(-1 [-1.0%])</span> 53.20 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+1 [+3.7%])</span> 16.13 | <span style='color: red'>(+2 [+3.7%])</span> 64.51 | <span style='color: red'>(+0 [+1.1%])</span> 18.17 | <span style='color: green'>(-0 [-2.9%])</span> 13.52 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+6 [+11.6%])</span> 62.50 | <span style='color: red'>(+26 [+11.6%])</span> 250 | <span style='color: red'>(+16 [+27.6%])</span> 74 | <span style='color: red'>(+1 [+1.9%])</span> 54 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 563 | 1 | 35 | 4,137,502 | 115.59 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 179 | 715 | 23,446,148 | 150,778,428 | 179 | 319 | 0 | 62.68 | 18.17 | 5 | 70.52 | 74 | 106 | 73 | 4 | 57 | 10,899,170 | 34 | 46 | 1,103,000 | 28.41 | 22 | 81 | 1 | 73 | 
| regex_program | 1 | 155 | 532 | 11,598,276 | 128,513,066 | 155 | 269 | 1 | 54.11 | 16.52 | 4 | 66.95 | 56 | 91 | 56 | 0 | 49 | 2,196,106 | 24 | 66 | 1,104,000 | 32.16 | 17 | 71 | 0 | 56 | 
| regex_program | 2 | 163 | 535 | 11,579,064 | 128,513,066 | 163 | 271 | 1 | 53.20 | 16.30 | 4 | 65.56 | 54 | 95 | 54 | 0 | 51 | 2,177,334 | 29 | 58 | 1,104,000 | 32.09 | 17 | 70 | 0 | 54 | 
| regex_program | 3 | 185 | 563 | 11,853,872 | 103,456,394 | 185 | 291 | 0 | 72.75 | 13.52 | 5 | 54.52 | 66 | 86 | 66 | 0 | 51 | 2,422,606 | 28 | 45 | 826,502 | 32.32 | 19 | 87 | 1 | 66 | 

...
|:---|---:|---:|---:|
| Total |  2.48 |  0.79 | 0.79 |
| regex_program |  2.48 |  0.79 |  0.79 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  610.25 |  2,441 |  755 |  551 |
...
| `execute_preflight_insn_mi/s` |  31.75 | -          |  32.29 |  30.71 |
| `trace_gen_time_ms   ` |  183 |  732 |  200 |  175 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  308.25 |  1,233 |  356 |  282 |
| `main_trace_commit_time_ms` |  52.25 |  209 |  58 |  50 |
| `generate_perm_trace_time_ms` |  29.25 |  117 |  45 |  21 |
| `perm_trace_commit_time_ms` |  65.50 |  261.99 |  71.47 |  55.29 |
| `quotient_poly_compute_time_ms` |  62.19 |  248.75 |  73.23 |  54.83 |
| `quotient_poly_commit_time_ms` |  16.43 |  65.74 |  18.95 |  13.100 |
| `pcs_opening_time_ms ` |  78.75 |  315 |  95 |  59 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 564 | 1 | 36 | 4,137,512 | 112.51 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 175 | 755 | 23,437,436 | 150,778,428 | 175 | 356 | 0 | 64.41 | 18.95 | 5 | 71.47 | 95 | 117 | 95 | 4 | 58 | 10,891,066 | 45 | 56 | 1,103,000 | 30.71 | 22 | 84 | 1 | 95 | 
| regex_program | 1 | 176 | 571 | 11,597,664 | 128,513,066 | 176 | 307 | 1 | 56.28 | 16.51 | 4 | 68.66 | 91 | 91 | 90 | 0 | 50 | 2,195,390 | 22 | 46 | 1,104,000 | 32.21 | 17 | 73 | 0 | 90 | 
| regex_program | 2 | 181 | 551 | 11,579,760 | 128,513,066 | 181 | 282 | 1 | 54.83 | 16.27 | 4 | 66.57 | 70 | 88 | 70 | 0 | 50 | 2,177,774 | 21 | 46 | 1,104,000 | 31.77 | 17 | 71 | 0 | 70 | 
| regex_program | 3 | 200 | 564 | 11,853,280 | 103,456,394 | 200 | 288 | 0 | 73.23 | 13.100 | 5 | 55.29 | 59 | 87 | 59 | 0 | 51 | 2,421,998 | 29 | 34 | 826,512 | 32.29 | 19 | 88 | 1 | 59 | 

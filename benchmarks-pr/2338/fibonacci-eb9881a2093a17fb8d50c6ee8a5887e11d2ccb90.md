...
| `total_proof_time_ms ` |  512.50 |  1,025 |  579 |  446 |
| `execute_metered_time_ms` |  9 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  159.38 | -          |  159.38 |  159.38 |
| `execute_preflight_insns` |  750,132.50 |  1,500,265 |  873,000 |  627,265 |
| `execute_preflight_time_ms` |  28 |  56 |  34 |  22 |
| `execute_preflight_insn_mi/s` |  37.77 | -          |  38.98 |  36.55 |
| `trace_gen_time_ms   ` |  193 |  386 |  197 |  189 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  186 |  372 |  187 |  185 |
| `main_trace_commit_time_ms` |  30.50 |  61 |  33 |  28 |
| `generate_perm_trace_time_ms` |  21 |  42 |  28 |  14 |
| `perm_trace_commit_time_ms` |  41.08 |  82.15 |  44.08 |  38.08 |
| `quotient_poly_compute_time_ms` |  31.59 |  63.19 |  35.50 |  27.69 |
| `quotient_poly_commit_time_ms` |  12.50 |  24.99 |  12.51 |  12.48 |
...
| --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 446 | 1 | 9 | 1,500,265 | 159.38 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 189 | 579 | 84,399,632 | 189 | 187 | 0 | 35.50 | 12.51 | 4 | 44.08 | 46 | 58 | 46 | 0 | 33 | 14 | 34 | 873,000 | 36.55 | 14 | 48 | 0 | 46 | 
| fibonacci_program | 1 | 197 | 446 | 74,305,770 | 197 | 185 | 1 | 27.69 | 12.48 | 4 | 38.08 | 49 | 66 | 48 | 0 | 28 | 28 | 22 | 627,265 | 38.98 | 11 | 40 | 0 | 48 | 

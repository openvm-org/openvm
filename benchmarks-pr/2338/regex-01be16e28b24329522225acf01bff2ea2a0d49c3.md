...
|:---|---:|---:|---:|
| Total | <span style='color: green'>(-0 [-0.7%])</span> 2.40 | <span style='color: red'>(+0 [+0.5%])</span> 0.76 | 0.76 |
| regex_program | <span style='color: green'>(-0 [-0.7%])</span> 2.40 | <span style='color: red'>(+0 [+0.8%])</span> 0.76 |  0.76 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: green'>(-4 [-0.7%])</span> 591.75 | <span style='color: green'>(-16 [-0.7%])</span> 2,367 | <span style='color: red'>(+6 [+0.8%])</span> 721 | <span style='color: green'>(-6 [-1.1%])</span> 533 |
...
| `execute_metered_insn_mi/s` | <span style='color: red'>(+5 [+4.9%])</span> 115.100 | -          | <span style='color: red'>(+5 [+4.9%])</span> 115.100 | <span style='color: red'>(+5 [+4.9%])</span> 115.100 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` | <span style='color: green'>(-0 [-0.5%])</span> 52.75 | <span style='color: green'>(-1 [-0.5%])</span> 211 |  64 |  44 |
| `execute_preflight_insn_mi/s` | <span style='color: green'>(-1 [-1.7%])</span> 31.56 | -          | <span style='color: green'>(-1 [-2.3%])</span> 32.69 | <span style='color: red'>(+0 [+0.3%])</span> 28.96 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+2 [+1.4%])</span> 175.50 | <span style='color: red'>(+10 [+1.4%])</span> 702 | <span style='color: red'>(+2 [+1.1%])</span> 188 | <span style='color: red'>(+2 [+1.3%])</span> 160 |
| `memory_finalize_time_ms` |  1 |  4 |  4 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: green'>(-7 [-2.3%])</span> 289.50 | <span style='color: green'>(-27 [-2.3%])</span> 1,158 | <span style='color: red'>(+2 [+0.6%])</span> 318 | <span style='color: green'>(-10 [-3.6%])</span> 266 |
| `main_trace_commit_time_ms` |  52.50 |  210 | <span style='color: green'>(-1 [-1.7%])</span> 57 |  50 |
| `generate_perm_trace_time_ms` | <span style='color: green'>(-8 [-22.2%])</span> 26.25 | <span style='color: green'>(-30 [-22.2%])</span> 105 | <span style='color: green'>(-20 [-39.2%])</span> 31 | <span style='color: green'>(-3 [-12.5%])</span> 21 |
| `perm_trace_commit_time_ms` | <span style='color: red'>(+2 [+2.7%])</span> 66.20 | <span style='color: red'>(+7 [+2.7%])</span> 264.82 | <span style='color: red'>(+1 [+1.6%])</span> 73.01 | <span style='color: red'>(+1 [+1.1%])</span> 55.85 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+3 [+4.8%])</span> 62.53 | <span style='color: red'>(+11 [+4.8%])</span> 250.13 | <span style='color: red'>(+3 [+4.0%])</span> 73.31 | <span style='color: red'>(+3 [+4.9%])</span> 55.98 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+0 [+2.7%])</span> 16.11 | <span style='color: red'>(+2 [+2.7%])</span> 64.46 | <span style='color: red'>(+1 [+4.2%])</span> 18.83 | <span style='color: red'>(+1 [+4.7%])</span> 13.95 |
| `pcs_opening_time_ms ` | <span style='color: green'>(-4 [-6.3%])</span> 62.75 | <span style='color: green'>(-17 [-6.3%])</span> 251 | <span style='color: green'>(-3 [-3.9%])</span> 73 | <span style='color: green'>(-8 [-13.1%])</span> 53 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 565 | 1 | 35 | 4,137,502 | 115.100 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 188 | 721 | 23,446,148 | 150,778,428 | 188 | 318 | 0 | 64.50 | 18.83 | 5 | 73.01 | 73 | 102 | 73 | 4 | 57 | 10,899,170 | 28 | 45 | 1,103,000 | 28.96 | 22 | 84 | 1 | 73 | 
| regex_program | 1 | 160 | 548 | 11,598,276 | 128,513,066 | 160 | 282 | 1 | 56.35 | 16.18 | 4 | 68.32 | 63 | 94 | 63 | 0 | 50 | 2,196,106 | 25 | 64 | 1,104,000 | 32.69 | 17 | 73 | 0 | 63 | 
| regex_program | 2 | 167 | 533 | 11,579,064 | 128,513,066 | 167 | 266 | 1 | 55.98 | 15.50 | 4 | 67.64 | 53 | 89 | 53 | 0 | 52 | 2,177,334 | 21 | 58 | 1,104,000 | 32.20 | 17 | 72 | 0 | 53 | 
| regex_program | 3 | 187 | 565 | 11,853,872 | 103,456,394 | 187 | 292 | 0 | 73.31 | 13.95 | 5 | 55.85 | 62 | 90 | 62 | 0 | 51 | 2,422,606 | 31 | 44 | 826,502 | 32.37 | 19 | 88 | 1 | 62 | 

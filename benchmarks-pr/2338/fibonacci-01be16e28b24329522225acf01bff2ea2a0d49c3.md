...
|:---|---:|---:|---:|
| Total | <span style='color: green'>(-0 [-0.8%])</span> 1.05 | <span style='color: green'>(-0 [-1.5%])</span> 0.59 | 0.59 |
| fibonacci_program | <span style='color: green'>(-0 [-0.8%])</span> 1.05 | <span style='color: green'>(-0 [-1.5%])</span> 0.59 |  0.59 |


| fibonacci_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: green'>(-4 [-0.8%])</span> 516.50 | <span style='color: green'>(-8 [-0.8%])</span> 1,033 | <span style='color: green'>(-9 [-1.5%])</span> 580 | <span style='color: red'>(+1 [+0.2%])</span> 453 |
...
| `execute_metered_insn_mi/s` | <span style='color: green'>(-0 [-0.2%])</span> 112.65 | -          | <span style='color: green'>(-0 [-0.2%])</span> 112.65 | <span style='color: green'>(-0 [-0.2%])</span> 112.65 |
...
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+2 [+4.5%])</span> 37.38 | -          | <span style='color: red'>(+3 [+7.5%])</span> 40.27 | <span style='color: red'>(+0 [+1.1%])</span> 34.48 |
...
| `stark_prove_excluding_trace_time_ms` | <span style='color: green'>(-3 [-1.6%])</span> 190.50 | <span style='color: green'>(-6 [-1.6%])</span> 381 | <span style='color: green'>(-4 [-2.0%])</span> 193 | <span style='color: green'>(-2 [-1.1%])</span> 188 |
| `main_trace_commit_time_ms` |  30.50 |  61 |  33 |  28 |
| `generate_perm_trace_time_ms` | <span style='color: green'>(-4 [-15.1%])</span> 22.50 | <span style='color: green'>(-8 [-15.1%])</span> 45 | <span style='color: red'>(+3 [+10.7%])</span> 31 | <span style='color: green'>(-11 [-44.0%])</span> 14 |
| `perm_trace_commit_time_ms` | <span style='color: green'>(-0 [-0.7%])</span> 41.15 | <span style='color: green'>(-1 [-0.7%])</span> 82.30 | <span style='color: red'>(+0 [+0.4%])</span> 44.36 | <span style='color: green'>(-1 [-1.9%])</span> 37.94 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+1 [+1.8%])</span> 32.06 | <span style='color: red'>(+1 [+1.8%])</span> 64.13 | <span style='color: green'>(-1 [-3.1%])</span> 33.77 | <span style='color: red'>(+2 [+7.7%])</span> 30.35 |
| `quotient_poly_commit_time_ms` | <span style='color: green'>(-0 [-2.8%])</span> 12.53 | <span style='color: green'>(-1 [-2.8%])</span> 25.07 |  13.25 | <span style='color: green'>(-1 [-5.8%])</span> 11.82 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+2 [+3.1%])</span> 50 | <span style='color: red'>(+3 [+3.1%])</span> 100 | <span style='color: green'>(-3 [-5.5%])</span> 52 | <span style='color: red'>(+6 [+14.3%])</span> 48 |
...
| --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 453 | 1 | 13 | 1,500,209 | 112.65 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 196 | 580 | 9,677,708 | 84,395,212 | 196 | 188 | 0 | 33.77 | 13.25 | 4 | 44.36 | 48 | 59 | 47 | 0 | 33 | 1,035,986 | 14 | 26 | 873,000 | 34.48 | 14 | 47 | 0 | 47 | 
| fibonacci_program | 1 | 185 | 453 | 9,708,170 | 74,305,770 | 185 | 193 | 1 | 30.35 | 11.82 | 4 | 37.94 | 52 | 69 | 52 | 0 | 28 | 1,064,416 | 31 | 32 | 627,209 | 40.27 | 11 | 42 | 0 | 52 | 

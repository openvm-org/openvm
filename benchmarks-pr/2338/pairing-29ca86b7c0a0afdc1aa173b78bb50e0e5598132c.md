...
|:---|---:|---:|---:|
| Total | <span style='color: green'>(-0 [-3.6%])</span> 1.55 | <span style='color: green'>(-0 [-5.6%])</span> 0.91 | 0.91 |
| pairing | <span style='color: green'>(-0 [-3.6%])</span> 1.55 | <span style='color: green'>(-0 [-5.6%])</span> 0.91 |  0.91 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: green'>(-29 [-3.8%])</span> 743 | <span style='color: green'>(-58 [-3.8%])</span> 1,486 | <span style='color: green'>(-54 [-6.0%])</span> 848 | <span style='color: green'>(-4 [-0.6%])</span> 638 |
...
| `execute_metered_insn_mi/s` |  27.48 | -          |  27.48 |  27.48 |
| `execute_preflight_insns` |  872,871 |  1,745,742 |  1,149,000 |  596,742 |
| `execute_preflight_time_ms` | <span style='color: green'>(-1 [-1.2%])</span> 82.50 | <span style='color: green'>(-2 [-1.2%])</span> 165 | <span style='color: green'>(-1 [-0.9%])</span> 105 | <span style='color: green'>(-1 [-1.6%])</span> 60 |
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+0 [+1.3%])</span> 14.79 | -          | <span style='color: red'>(+0 [+1.7%])</span> 18.29 | <span style='color: red'>(+0 [+0.6%])</span> 11.28 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+2 [+1.1%])</span> 189.50 | <span style='color: red'>(+4 [+1.1%])</span> 379 |  193 | <span style='color: red'>(+4 [+2.2%])</span> 186 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: green'>(-30 [-7.5%])</span> 365 | <span style='color: green'>(-59 [-7.5%])</span> 730 | <span style='color: green'>(-56 [-12.6%])</span> 388 | <span style='color: green'>(-3 [-0.9%])</span> 342 |
| `main_trace_commit_time_ms` | <span style='color: red'>(+0 [+0.8%])</span> 65.50 | <span style='color: red'>(+1 [+0.8%])</span> 131 | <span style='color: red'>(+1 [+1.3%])</span> 77 |  54 |
| `generate_perm_trace_time_ms` | <span style='color: red'>(+0 [+1.3%])</span> 39.50 | <span style='color: red'>(+1 [+1.3%])</span> 79 |  40 | <span style='color: red'>(+1 [+2.6%])</span> 39 |
| `perm_trace_commit_time_ms` | <span style='color: green'>(-2 [-3.1%])</span> 76.18 | <span style='color: green'>(-5 [-3.1%])</span> 152.37 | <span style='color: green'>(-4 [-4.8%])</span> 86.67 | <span style='color: green'>(-1 [-0.8%])</span> 65.70 |
| `quotient_poly_compute_time_ms` |  84.05 |  168.09 | <span style='color: red'>(+0 [+0.2%])</span> 92.57 | <span style='color: green'>(-0 [-0.2%])</span> 75.52 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+0 [+2.7%])</span> 18.03 | <span style='color: red'>(+1 [+2.7%])</span> 36.06 | <span style='color: red'>(+1 [+5.3%])</span> 20.22 | <span style='color: green'>(-0 [-0.5%])</span> 15.84 |
| `pcs_opening_time_ms ` | <span style='color: green'>(-27 [-25.8%])</span> 77.50 | <span style='color: green'>(-54 [-25.8%])</span> 155 | <span style='color: green'>(-35 [-28.7%])</span> 87 | <span style='color: green'>(-19 [-21.8%])</span> 68 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 638 | 1 | 63 | 1,745,742 | 27.48 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 186 | 848 | 32,480,114 | 172,558,444 | 186 | 388 | 0 | 92.57 | 20.22 | 6 | 86.67 | 68 | 129 | 67 | 1 | 77 | 15,909,408 | 39 | 105 | 1,149,000 | 11.28 | 27 | 113 | 1 | 67 | 
| pairing | 1 | 193 | 638 | 22,464,232 | 119,958,502 | 193 | 342 | 1 | 75.52 | 15.84 | 6 | 65.70 | 87 | 108 | 87 | 0 | 54 | 9,498,894 | 40 | 60 | 596,742 | 18.29 | 21 | 91 | 1 | 87 | 

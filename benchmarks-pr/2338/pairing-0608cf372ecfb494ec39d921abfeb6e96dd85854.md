...
|:---|---:|---:|---:|
| Total |  1.55 |  0.92 | 0.92 |
| pairing |  1.55 |  0.92 |  0.92 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  742 |  1,484 |  853 |  631 |
...
| `execute_metered_insn_mi/s` |  27.65 | -          |  27.65 |  27.65 |
| `execute_preflight_insns` |  872,878.50 |  1,745,757 |  1,151,000 |  594,757 |
| `execute_preflight_time_ms` |  83 |  166 |  119 |  47 |
| `execute_preflight_insn_mi/s` |  14.83 | -          |  18.19 |  11.48 |
| `trace_gen_time_ms   ` |  182 |  364 |  201 |  163 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  371 |  742 |  402 |  340 |
| `main_trace_commit_time_ms` |  64.50 |  129 |  75 |  54 |
| `generate_perm_trace_time_ms` |  40.50 |  81 |  43 |  38 |
| `perm_trace_commit_time_ms` |  76.25 |  152.49 |  88.60 |  63.89 |
| `quotient_poly_compute_time_ms` |  82.02 |  164.04 |  90.14 |  73.89 |
| `quotient_poly_commit_time_ms` |  16.80 |  33.60 |  18.100 |  14.60 |
| `pcs_opening_time_ms ` |  85.50 |  171 |  86 |  85 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 631 | 1 | 63 | 1,745,757 | 27.65 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 163 | 853 | 32,579,050 | 172,558,444 | 163 | 402 | 0 | 90.14 | 18.100 | 6 | 88.60 | 86 | 130 | 86 | 1 | 75 | 15,992,408 | 38 | 119 | 1,151,000 | 11.48 | 26 | 109 | 1 | 86 | 
| pairing | 1 | 201 | 631 | 22,427,652 | 119,958,502 | 201 | 340 | 1 | 73.89 | 14.60 | 6 | 63.89 | 85 | 110 | 85 | 0 | 54 | 9,471,642 | 43 | 47 | 594,757 | 18.19 | 21 | 89 | 1 | 85 | 
...
Commit: https://github.com/openvm-org/openvm/commit/0608cf372ecfb494ec39d921abfeb6e96dd85854
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/20710552856)

...
|:---|---:|---:|---:|
| Total | <span style='color: green'>(-0 [-0.5%])</span> 1.54 | <span style='color: green'>(-0 [-0.2%])</span> 0.91 | 0.91 |
| pairing | <span style='color: green'>(-0 [-0.5%])</span> 1.54 | <span style='color: green'>(-0 [-0.2%])</span> 0.91 |  0.91 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: green'>(-4 [-0.5%])</span> 737 | <span style='color: green'>(-8 [-0.5%])</span> 1,474 | <span style='color: green'>(-2 [-0.2%])</span> 849 | <span style='color: green'>(-6 [-1.0%])</span> 625 |
...
| `execute_metered_insn_mi/s` | <span style='color: green'>(-0 [-0.2%])</span> 27.32 | -          | <span style='color: green'>(-0 [-0.2%])</span> 27.32 | <span style='color: green'>(-0 [-0.2%])</span> 27.32 |
| `execute_preflight_insns` |  872,871 |  1,745,742 |  1,149,000 |  596,742 |
| `execute_preflight_time_ms` | <span style='color: green'>(-3 [-3.5%])</span> 82 | <span style='color: green'>(-6 [-3.5%])</span> 164 | <span style='color: green'>(-1 [-0.9%])</span> 105 | <span style='color: green'>(-5 [-7.8%])</span> 59 |
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+0 [+1.2%])</span> 14.80 | -          | <span style='color: red'>(+0 [+1.6%])</span> 18.33 | <span style='color: red'>(+0 [+0.6%])</span> 11.28 |
| `trace_gen_time_ms   ` | <span style='color: green'>(-1 [-0.5%])</span> 181.50 | <span style='color: green'>(-2 [-0.5%])</span> 363 | <span style='color: red'>(+1 [+0.5%])</span> 187 | <span style='color: green'>(-3 [-1.7%])</span> 176 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+0 [+0.1%])</span> 368.50 | <span style='color: red'>(+1 [+0.1%])</span> 737 | <span style='color: red'>(+3 [+0.8%])</span> 400 | <span style='color: green'>(-2 [-0.6%])</span> 337 |
| `main_trace_commit_time_ms` | <span style='color: red'>(+0 [+0.8%])</span> 65 | <span style='color: red'>(+1 [+0.8%])</span> 130 | <span style='color: red'>(+1 [+1.4%])</span> 75 |  55 |
| `generate_perm_trace_time_ms` | <span style='color: green'>(-0 [-1.3%])</span> 38 | <span style='color: green'>(-1 [-1.3%])</span> 76 |  39 | <span style='color: green'>(-1 [-2.6%])</span> 37 |
| `perm_trace_commit_time_ms` | <span style='color: red'>(+1 [+0.8%])</span> 76.61 | <span style='color: red'>(+1 [+0.8%])</span> 153.22 | <span style='color: red'>(+0 [+0.2%])</span> 88.47 | <span style='color: red'>(+1 [+1.6%])</span> 64.74 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+1 [+1.2%])</span> 82.47 | <span style='color: red'>(+2 [+1.2%])</span> 164.94 | <span style='color: red'>(+2 [+2.0%])</span> 91.56 | <span style='color: red'>(+0 [+0.2%])</span> 73.38 |
| `quotient_poly_commit_time_ms` | <span style='color: green'>(-0 [-0.9%])</span> 17.23 | <span style='color: green'>(-0 [-0.9%])</span> 34.47 | <span style='color: red'>(+0 [+1.7%])</span> 19.45 | <span style='color: green'>(-1 [-4.0%])</span> 15.02 |
| `pcs_opening_time_ms ` | <span style='color: green'>(-2 [-1.8%])</span> 84 | <span style='color: green'>(-3 [-1.8%])</span> 168 | <span style='color: green'>(-3 [-3.4%])</span> 85 |  83 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 625 | 1 | 63 | 1,745,742 | 27.32 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 176 | 849 | 32,480,114 | 172,558,444 | 176 | 400 | 0 | 91.56 | 19.45 | 6 | 88.47 | 83 | 128 | 83 | 1 | 75 | 15,909,408 | 37 | 105 | 1,149,000 | 11.28 | 27 | 111 | 1 | 83 | 
| pairing | 1 | 187 | 625 | 22,464,232 | 119,958,502 | 187 | 337 | 1 | 73.38 | 15.02 | 5 | 64.74 | 85 | 107 | 85 | 0 | 55 | 9,498,894 | 39 | 59 | 596,742 | 18.33 | 20 | 89 | 1 | 85 | 

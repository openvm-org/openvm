...
|:---|---:|---:|---:|
| Total | <span style='color: green'>(-0 [-0.2%])</span> 2.42 | <span style='color: green'>(-0 [-1.3%])</span> 0.74 | 0.74 |
| regex_program | <span style='color: green'>(-0 [-0.1%])</span> 2.42 | <span style='color: green'>(-0 [-1.1%])</span> 0.74 |  0.74 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: green'>(-1 [-0.1%])</span> 595 | <span style='color: green'>(-3 [-0.1%])</span> 2,380 | <span style='color: green'>(-8 [-1.1%])</span> 707 |  539 |
...
| `execute_metered_insn_mi/s` | <span style='color: red'>(+6 [+5.3%])</span> 116.45 | -          | <span style='color: red'>(+6 [+5.3%])</span> 116.45 | <span style='color: red'>(+6 [+5.3%])</span> 116.45 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` | <span style='color: red'>(+1 [+2.4%])</span> 54.25 | <span style='color: red'>(+5 [+2.4%])</span> 217 | <span style='color: red'>(+2 [+3.1%])</span> 66 | <span style='color: red'>(+1 [+2.3%])</span> 45 |
| `execute_preflight_insn_mi/s` | <span style='color: green'>(-2 [-5.3%])</span> 30.40 | -          | <span style='color: green'>(-1 [-2.5%])</span> 32.63 | <span style='color: red'>(+0 [+0.2%])</span> 28.93 |
| `trace_gen_time_ms   ` | <span style='color: green'>(-4 [-2.0%])</span> 169.50 | <span style='color: green'>(-14 [-2.0%])</span> 678 | <span style='color: green'>(-5 [-2.7%])</span> 181 | <span style='color: green'>(-2 [-1.3%])</span> 156 |
| `memory_finalize_time_ms` |  1 |  4 |  4 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+1 [+0.4%])</span> 297.50 | <span style='color: red'>(+5 [+0.4%])</span> 1,190 | <span style='color: green'>(-5 [-1.6%])</span> 311 | <span style='color: red'>(+1 [+0.4%])</span> 277 |
| `main_trace_commit_time_ms` | <span style='color: green'>(-0 [-1.0%])</span> 52 | <span style='color: green'>(-2 [-1.0%])</span> 208 |  58 | <span style='color: green'>(-1 [-2.0%])</span> 49 |
| `generate_perm_trace_time_ms` |  33.75 |  135 | <span style='color: red'>(+1 [+2.0%])</span> 52 | <span style='color: red'>(+1 [+4.2%])</span> 25 |
| `perm_trace_commit_time_ms` | <span style='color: red'>(+0 [+0.4%])</span> 64.70 | <span style='color: red'>(+1 [+0.4%])</span> 258.82 | <span style='color: green'>(-0 [-0.5%])</span> 71.49 | <span style='color: green'>(-1 [-1.4%])</span> 54.51 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+0 [+0.4%])</span> 59.91 | <span style='color: red'>(+1 [+0.4%])</span> 239.65 | <span style='color: red'>(+2 [+3.1%])</span> 72.67 |  53.36 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+0 [+0.7%])</span> 15.80 | <span style='color: red'>(+0 [+0.7%])</span> 63.19 | <span style='color: green'>(-1 [-3.7%])</span> 17.40 | <span style='color: red'>(+0 [+2.5%])</span> 13.65 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+1 [+1.5%])</span> 68 | <span style='color: red'>(+4 [+1.5%])</span> 272 | <span style='color: green'>(-3 [-3.9%])</span> 73 | <span style='color: red'>(+2 [+3.3%])</span> 63 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 566 | 1 | 35 | 4,137,502 | 116.45 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 181 | 707 | 23,446,148 | 150,778,428 | 181 | 311 | 0 | 59.34 | 17.40 | 5 | 71.49 | 73 | 101 | 73 | 4 | 58 | 10,899,170 | 28 | 45 | 1,103,000 | 28.93 | 21 | 77 | 1 | 73 | 
| regex_program | 1 | 156 | 539 | 11,598,276 | 128,513,066 | 156 | 277 | 1 | 53.36 | 16.32 | 4 | 66.85 | 63 | 92 | 63 | 0 | 50 | 2,196,106 | 25 | 66 | 1,104,000 | 32.63 | 17 | 70 | 0 | 63 | 
| regex_program | 2 | 160 | 568 | 11,579,064 | 128,513,066 | 160 | 306 | 1 | 54.28 | 15.82 | 5 | 65.96 | 67 | 118 | 66 | 0 | 49 | 2,177,334 | 52 | 60 | 1,104,000 | 30.41 | 17 | 70 | 0 | 66 | 
| regex_program | 3 | 181 | 566 | 11,853,872 | 103,456,394 | 181 | 296 | 0 | 72.67 | 13.65 | 5 | 54.51 | 69 | 88 | 69 | 0 | 51 | 2,422,606 | 30 | 46 | 826,502 | 29.65 | 19 | 87 | 1 | 69 | 

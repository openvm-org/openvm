...
| `total_proof_time_ms ` |  739 |  1,478 |  877 |  601 |
...
| `execute_metered_insn_mi/s` |  27.28 | -          |  27.28 |  27.28 |
| `execute_preflight_insns` |  872,878.50 |  1,745,757 |  1,151,000 |  594,757 |
| `execute_preflight_time_ms` |  83 |  166 |  118 |  48 |
| `execute_preflight_insn_mi/s` |  14.75 | -          |  18 |  11.49 |
| `trace_gen_time_ms   ` |  181.50 |  363 |  199 |  164 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  368.50 |  737 |  425 |  312 |
| `main_trace_commit_time_ms` |  64 |  128 |  74 |  54 |
| `generate_perm_trace_time_ms` |  41 |  82 |  43 |  39 |
| `perm_trace_commit_time_ms` |  75.64 |  151.29 |  88.68 |  62.61 |
| `quotient_poly_compute_time_ms` |  81.64 |  163.29 |  90.65 |  72.63 |
| `quotient_poly_commit_time_ms` |  17.33 |  34.66 |  19.47 |  15.19 |
| `pcs_opening_time_ms ` |  84 |  168 |  108 |  60 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 601 | 1 | 63 | 1,745,757 | 27.28 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 164 | 877 | 32,579,050 | 172,558,444 | 164 | 425 | 0 | 90.65 | 19.47 | 6 | 88.68 | 108 | 130 | 108 | 1 | 74 | 15,992,408 | 39 | 118 | 1,151,000 | 11.49 | 27 | 110 | 1 | 108 | 
| pairing | 1 | 199 | 601 | 22,427,652 | 119,958,502 | 199 | 312 | 1 | 72.63 | 15.19 | 6 | 62.61 | 60 | 108 | 60 | 0 | 54 | 9,471,642 | 43 | 48 | 594,757 | 18 | 21 | 88 | 1 | 60 | 

...
|:---|---:|---:|---:|
| Total | <span style='color: red'>(+0 [+0.9%])</span> 1.51 | <span style='color: red'>(+0 [+1.0%])</span> 0.91 | 0.91 |
| pairing | <span style='color: red'>(+0 [+0.9%])</span> 1.51 | <span style='color: red'>(+0 [+1.0%])</span> 0.91 |  0.91 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+7 [+1.0%])</span> 724.50 | <span style='color: red'>(+14 [+1.0%])</span> 1,449 | <span style='color: red'>(+9 [+1.1%])</span> 845 | <span style='color: red'>(+5 [+0.8%])</span> 604 |
...
| `execute_metered_insn_mi/s` | <span style='color: red'>(+0 [+0.2%])</span> 27.54 | -          | <span style='color: red'>(+0 [+0.2%])</span> 27.54 | <span style='color: red'>(+0 [+0.2%])</span> 27.54 |
| `execute_preflight_insns` |  872,871 |  1,745,742 |  1,149,000 |  596,742 |
| `execute_preflight_time_ms` |  84 |  168 |  106 |  62 |
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+0 [+0.6%])</span> 14.82 | -          | <span style='color: red'>(+0 [+0.5%])</span> 18.39 | <span style='color: red'>(+0 [+0.7%])</span> 11.25 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+3 [+1.7%])</span> 184 | <span style='color: red'>(+6 [+1.7%])</span> 368 | <span style='color: red'>(+2 [+1.1%])</span> 189 | <span style='color: red'>(+4 [+2.3%])</span> 179 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+4 [+1.0%])</span> 350 | <span style='color: red'>(+7 [+1.0%])</span> 700 | <span style='color: red'>(+5 [+1.3%])</span> 389 | <span style='color: red'>(+2 [+0.6%])</span> 311 |
...
| `perm_trace_commit_time_ms` | <span style='color: red'>(+0 [+0.3%])</span> 76.75 | <span style='color: red'>(+1 [+0.3%])</span> 153.51 | <span style='color: red'>(+1 [+0.9%])</span> 88.62 | <span style='color: green'>(-0 [-0.4%])</span> 64.88 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+1 [+1.2%])</span> 83.13 | <span style='color: red'>(+2 [+1.2%])</span> 166.26 | <span style='color: red'>(+2 [+2.6%])</span> 92.32 | <span style='color: green'>(-0 [-0.4%])</span> 73.94 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+0 [+1.5%])</span> 17.30 | <span style='color: red'>(+1 [+1.5%])</span> 34.60 | <span style='color: green'>(-0 [-1.2%])</span> 18.65 | <span style='color: red'>(+1 [+4.8%])</span> 15.94 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+0 [+0.7%])</span> 68.50 | <span style='color: red'>(+1 [+0.7%])</span> 137 |  69 | <span style='color: red'>(+1 [+1.5%])</span> 68 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 604 | 1 | 63 | 1,745,742 | 27.54 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 179 | 845 | 32,480,114 | 172,558,444 | 179 | 389 | 0 | 92.32 | 18.65 | 7 | 88.62 | 69 | 132 | 69 | 1 | 75 | 15,909,408 | 40 | 106 | 1,149,000 | 11.25 | 26 | 111 | 1 | 69 | 
| pairing | 1 | 189 | 604 | 22,464,232 | 119,958,502 | 189 | 311 | 1 | 73.94 | 15.94 | 6 | 64.88 | 68 | 97 | 68 | 0 | 53 | 9,498,894 | 30 | 62 | 596,742 | 18.39 | 21 | 90 | 1 | 68 | 

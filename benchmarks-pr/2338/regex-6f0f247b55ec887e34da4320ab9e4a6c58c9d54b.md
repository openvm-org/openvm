...
| `total_proof_time_ms ` |  585.50 |  2,342 |  699 |  525 |
...
| `execute_preflight_time_ms` |  45.50 |  182 |  57 |  34 |
| `execute_preflight_insn_mi/s` |  31.59 | -          |  32.55 |  30.74 |
| `trace_gen_time_ms   ` |  178 |  712 |  198 |  168 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  285.50 |  1,142 |  312 |  264 |
| `main_trace_commit_time_ms` |  51 |  204 |  56 |  48 |
| `generate_perm_trace_time_ms` |  27.50 |  110 |  38 |  20 |
| `perm_trace_commit_time_ms` |  64.40 |  257.62 |  72.45 |  53.23 |
| `quotient_poly_compute_time_ms` |  57.95 |  231.79 |  65.29 |  52.84 |
| `quotient_poly_commit_time_ms` |  15.76 |  63.06 |  17.76 |  13.92 |
| `pcs_opening_time_ms ` |  65.75 |  263 |  89 |  54 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 586 | 1 | 36 | 4,137,877 | 114.72 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 168 | 699 | 150,778,428 | 168 | 295 | 0 | 59.66 | 17.76 | 5 | 72.45 | 63 | 97 | 62 | 4 | 56 | 24 | 57 | 1,103,000 | 30.74 | 22 | 78 | 1 | 62 | 
| regex_program | 1 | 172 | 532 | 128,513,066 | 172 | 271 | 1 | 52.84 | 15.40 | 4 | 64.58 | 57 | 93 | 57 | 0 | 50 | 28 | 46 | 1,104,000 | 31.15 | 17 | 68 | 0 | 57 | 
| regex_program | 2 | 174 | 525 | 128,513,066 | 174 | 264 | 1 | 53.100 | 15.98 | 4 | 67.35 | 54 | 88 | 54 | 0 | 50 | 20 | 45 | 1,104,000 | 32.55 | 17 | 70 | 0 | 54 | 
| regex_program | 3 | 198 | 586 | 103,473,675 | 198 | 312 | 0 | 65.29 | 13.92 | 5 | 53.23 | 89 | 94 | 89 | 0 | 48 | 38 | 34 | 826,877 | 31.94 | 19 | 80 | 1 | 89 | 

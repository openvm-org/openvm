...
|:---|---:|---:|---:|
| Total | <span style='color: red'>(+0 [+1.5%])</span> 2.36 | <span style='color: red'>(+0 [+2.1%])</span> 0.74 | 0.74 |
| regex_program | <span style='color: red'>(+0 [+1.5%])</span> 2.36 | <span style='color: red'>(+0 [+2.3%])</span> 0.74 |  0.74 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+9 [+1.6%])</span> 581.25 | <span style='color: red'>(+36 [+1.6%])</span> 2,325 | <span style='color: red'>(+17 [+2.5%])</span> 706 | <span style='color: red'>(+7 [+1.3%])</span> 529 |
| `main_cells_used     ` |  4,423,804 |  17,695,216 |  10,899,170 |  2,177,334 |
| `total_cells_used    ` |  14,619,340 |  58,477,360 |  23,446,148 |  11,579,064 |
| `execute_metered_time_ms` | <span style='color: green'>(-2 [-5.4%])</span> 35 | -          | -          | -          |
| `execute_metered_insn_mi/s` | <span style='color: red'>(+6 [+5.5%])</span> 115.88 | -          | <span style='color: red'>(+6 [+5.5%])</span> 115.88 | <span style='color: red'>(+6 [+5.5%])</span> 115.88 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` | <span style='color: green'>(-0 [-0.9%])</span> 53.25 | <span style='color: green'>(-2 [-0.9%])</span> 213 | <span style='color: red'>(+1 [+1.6%])</span> 65 |  45 |
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+1 [+1.9%])</span> 31.41 | -          | <span style='color: green'>(-1 [-3.7%])</span> 32.38 | <span style='color: red'>(+1 [+3.6%])</span> 28.71 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+1 [+0.6%])</span> 169.50 | <span style='color: red'>(+4 [+0.6%])</span> 678 | <span style='color: red'>(+1 [+0.6%])</span> 181 |  155 |
| `memory_finalize_time_ms` |  1 |  4 |  4 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+8 [+2.8%])</span> 284 | <span style='color: red'>(+31 [+2.8%])</span> 1,136 | <span style='color: red'>(+15 [+5.1%])</span> 309 | <span style='color: red'>(+6 [+2.3%])</span> 267 |
| `main_trace_commit_time_ms` | <span style='color: red'>(+0 [+1.0%])</span> 51.50 | <span style='color: red'>(+2 [+1.0%])</span> 206 | <span style='color: red'>(+2 [+3.6%])</span> 58 |  49 |
| `generate_perm_trace_time_ms` |  26.75 |  107 | <span style='color: red'>(+4 [+13.3%])</span> 34 |  22 |
| `perm_trace_commit_time_ms` | <span style='color: red'>(+0 [+0.5%])</span> 63.96 | <span style='color: red'>(+1 [+0.5%])</span> 255.86 | <span style='color: red'>(+1 [+1.5%])</span> 70.78 | <span style='color: red'>(+0 [+0.3%])</span> 55.28 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+0 [+0.1%])</span> 59.04 | <span style='color: red'>(+0 [+0.1%])</span> 236.18 | <span style='color: red'>(+1 [+1.3%])</span> 69.98 | <span style='color: red'>(+1 [+1.0%])</span> 52.61 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+0 [+1.3%])</span> 15.88 | <span style='color: red'>(+1 [+1.3%])</span> 63.52 | <span style='color: green'>(-0 [-0.7%])</span> 18.35 | <span style='color: red'>(+0 [+0.9%])</span> 13.92 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+6 [+10.1%])</span> 62.75 | <span style='color: red'>(+23 [+10.1%])</span> 251 | <span style='color: red'>(+6 [+9.1%])</span> 72 | <span style='color: red'>(+2 [+3.9%])</span> 53 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 557 | 1 | 35 | 4,137,502 | 115.88 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 181 | 706 | 23,446,148 | 150,778,428 | 181 | 309 | 0 | 60.48 | 18.35 | 5 | 70.78 | 64 | 106 | 64 | 4 | 58 | 10,899,170 | 34 | 45 | 1,103,000 | 28.71 | 22 | 79 | 1 | 64 | 
| regex_program | 1 | 155 | 533 | 11,598,276 | 128,513,066 | 155 | 272 | 1 | 53.11 | 15.86 | 4 | 65.42 | 62 | 89 | 62 | 0 | 49 | 2,196,106 | 23 | 65 | 1,104,000 | 32.35 | 17 | 69 | 0 | 62 | 
| regex_program | 2 | 161 | 529 | 11,579,064 | 128,513,066 | 161 | 267 | 1 | 52.61 | 15.39 | 4 | 64.38 | 53 | 93 | 53 | 0 | 50 | 2,177,334 | 28 | 58 | 1,104,000 | 32.38 | 17 | 68 | 0 | 53 | 
| regex_program | 3 | 181 | 557 | 11,853,872 | 103,456,394 | 181 | 288 | 0 | 69.98 | 13.92 | 5 | 55.28 | 72 | 80 | 72 | 0 | 49 | 2,422,606 | 22 | 45 | 826,502 | 32.20 | 19 | 84 | 1 | 72 | 
...
Commit: https://github.com/openvm-org/openvm/commit/be4d2d8b3ee6b98fcad3ed12028fbd26108d420e
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/20652108985)

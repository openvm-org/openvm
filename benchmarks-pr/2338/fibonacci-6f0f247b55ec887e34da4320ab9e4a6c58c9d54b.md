...
| `total_proof_time_ms ` |  517 |  1,034 |  577 |  457 |
| `execute_metered_time_ms` |  9 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  161.77 | -          |  161.77 |  161.77 |
| `execute_preflight_insns` |  750,132.50 |  1,500,265 |  873,000 |  627,265 |
| `execute_preflight_time_ms` |  26 |  52 |  31 |  21 |
| `execute_preflight_insn_mi/s` |  39.71 | -          |  39.96 |  39.45 |
| `trace_gen_time_ms   ` |  194 |  388 |  197 |  191 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  191 |  382 |  197 |  185 |
| `main_trace_commit_time_ms` |  30.50 |  61 |  33 |  28 |
| `generate_perm_trace_time_ms` |  20.50 |  41 |  28 |  13 |
| `perm_trace_commit_time_ms` |  41.23 |  82.46 |  44.83 |  37.63 |
| `quotient_poly_compute_time_ms` |  32.09 |  64.18 |  33.70 |  30.48 |
| `quotient_poly_commit_time_ms` |  12.25 |  24.51 |  12.29 |  12.22 |
| `pcs_opening_time_ms ` |  52.50 |  105 |  59 |  46 |
...
| --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 457 | 1 | 9 | 1,500,265 | 161.77 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 191 | 577 | 84,399,632 | 191 | 185 | 0 | 33.70 | 12.29 | 4 | 44.83 | 46 | 59 | 46 | 0 | 33 | 13 | 31 | 873,000 | 39.45 | 14 | 46 | 0 | 46 | 
| fibonacci_program | 1 | 197 | 457 | 74,305,770 | 197 | 197 | 1 | 30.48 | 12.22 | 4 | 37.63 | 59 | 66 | 59 | 0 | 28 | 28 | 21 | 627,265 | 39.96 | 11 | 43 | 0 | 59 | 

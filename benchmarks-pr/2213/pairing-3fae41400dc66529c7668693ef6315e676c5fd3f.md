...
| `total_proof_time_ms ` |  731 |  1,462 |  842 |  620 |
...
| `execute_preflight_insn_mi/s` |  13.84 | -          |  18.41 |  9.26 |
| `trace_gen_time_ms   ` |  174 |  348 |  191 |  157 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  369.50 |  739 |  412 |  327 |
| `main_trace_commit_time_ms` |  64 |  128 |  74 |  54 |
| `generate_perm_trace_time_ms` |  50.50 |  101 |  62 |  39 |
| `perm_trace_commit_time_ms` |  76.65 |  153.31 |  89.11 |  64.20 |
| `quotient_poly_compute_time_ms` |  77.94 |  155.88 |  86.40 |  69.48 |
| `quotient_poly_commit_time_ms` |  16.67 |  33.33 |  18.93 |  14.40 |
| `pcs_opening_time_ms ` |  79.50 |  159 |  100 |  59 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 620 | 65 | 1 | 91 | 1,745,742 | 19.17 | 169 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 157 | 842 | 32,689,110 | 172,558,444 | 157 | 412 | 0 | 86.40 | 18.93 | 6 | 89.11 | 100 | 130 | 100 | 1 | 74 | 16,059,916 | 39 | 128 | 1,157,000 | 9.26 | 26 | 106 | 1 | 100 | 
| pairing | 1 | 191 | 620 | 22,314,288 | 119,958,502 | 191 | 327 | 1 | 69.48 | 14.40 | 6 | 64.20 | 59 | 129 | 59 | 0 | 54 | 9,408,294 | 62 | 60 | 588,742 | 18.41 | 20 | 84 | 1 | 59 | 

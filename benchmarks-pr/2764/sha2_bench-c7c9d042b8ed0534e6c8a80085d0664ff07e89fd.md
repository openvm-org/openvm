...
|:---|---:|---:|---:|
| Total |  11.34 |  3.48 |  3.48 |
| app_proof |  9.13 |  1.78 |  1.78 |
| leaf |  1.38 |  0.88 |  0.88 |
...
| `total_proof_time_ms ` |  1,499.33 |  8,996 |  1,641 |  1,413 |
...
| `execute_preflight_time_ms` |  121.67 |  730 |  155 |  84 |
| `execute_preflight_insn_mi/s` |  42.18 | -          |  42.90 |  39.68 |
| `trace_gen_time_ms   ` |  128.83 |  773 |  164 |  109 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,170.33 |  7,022 |  1,217 |  1,137 |
| `prover.main_trace_commit_time_ms` |  284.50 |  1,707 |  286 |  284 |
| `prover.rap_constraints_time_ms` |  796 |  4,776 |  838 |  766 |
| `prover.openings_time_ms` |  88.83 |  533 |  92 |  86 |
| `prover.rap_constraints.logup_gkr_time_ms` |  270.33 |  1,622 |  312 |  250 |
| `prover.rap_constraints.round0_time_ms` |  359.83 |  2,159 |  362 |  355 |
| `prover.rap_constraints.mle_rounds_time_ms` |  165 |  990 |  166 |  161 |
...
| `prover.openings.whir_time_ms` |  27.83 |  167 |  29 |  25 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  692 |  1,384 |  877 |  507 |
| `execute_preflight_time_ms` |  2 |  4 |  2 |  2 |
| `trace_gen_time_ms   ` |  76.50 |  153 |  103 |  50 |
| `generate_blob_total_time_ms` |  10.50 |  21 |  14 |  7 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  615 |  1,230 |  773 |  457 |
| `prover.main_trace_commit_time_ms` |  313.50 |  627 |  407 |  220 |
| `prover.rap_constraints_time_ms` |  224 |  448 |  280 |  168 |
| `prover.openings_time_ms` |  77 |  154 |  86 |  68 |
| `prover.rap_constraints.logup_gkr_time_ms` |  62 |  124 |  74 |  50 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/c7c9d042b8ed0534e6c8a80085d0664ff07e89fd/sha2_bench-c7c9d042b8ed0534e6c8a80085d0664ff07e89fd.memory.svg)
...
| app_proof |  |  |  |  |  | 1,413 |  |  | 138 | 14,793,960 | 107.15 | 0 | 9,141 |  | 
...
| leaf | 0 | 103 | 877 | 103 | 38 | 14 | 2 | 3 | 3 | 
| leaf | 1 | 50 | 507 | 50 | 19 | 7 | 2 | 3 | 3 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 100,404,864 | 454 | 224 | 0 | 13 | 166 | 44 | 43 | 85 | 35 | 0 | 62 | 25 | 37 | 7 | 29 | 225 | 166 | 0 | 2 | 34 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 25,962,119 | 171 | 51 | 0 | 4 | 78 | 25 | 24 | 29 | 23 | 0 | 41 | 17 | 24 | 2 | 22 | 51 | 78 | 0 | 2 | 22 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 17,507,975 | 144 | 34 | 0 | 4 | 65 | 22 | 21 | 24 | 18 | 0 | 43 | 20 | 22 | 1 | 21 | 35 | 65 | 0 | 2 | 17 | 0 | 0 | 
| leaf | 0 | prover | 341,718,010 | 773 | 406 | 0 | 26 | 280 | 127 | 126 | 78 | 74 | 0 | 86 | 31 | 55 | 22 | 33 | 407 | 280 | 0 | 5 | 73 | 0 | 0 | 
| leaf | 1 | prover | 179,641,792 | 457 | 219 | 0 | 13 | 168 | 70 | 69 | 47 | 50 | 0 | 68 | 31 | 37 | 11 | 26 | 220 | 168 | 0 | 5 | 49 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 630,037,121 | 1,217 | 286 | 0 | 21 | 838 | 362 | 361 | 166 | 308 | 74 | 92 | 29 | 62 | 31 | 30 | 286 | 838 | 0 | 3 | 233 | 0 | 0 | 
| app_proof | prover | 1 | 630,036,532 | 1,211 | 284 | 0 | 19 | 838 | 359 | 359 | 166 | 312 | 75 | 88 | 27 | 60 | 32 | 27 | 284 | 838 | 0 | 3 | 236 | 0 | 0 | 
| app_proof | prover | 2 | 630,036,532 | 1,152 | 284 | 0 | 19 | 778 | 361 | 360 | 166 | 250 | 0 | 89 | 28 | 60 | 32 | 28 | 284 | 778 | 0 | 3 | 249 | 0 | 0 | 
| app_proof | prover | 3 | 630,036,532 | 1,151 | 284 | 0 | 19 | 777 | 360 | 360 | 165 | 251 | 0 | 89 | 29 | 60 | 31 | 28 | 284 | 777 | 0 | 3 | 250 | 0 | 0 | 
| app_proof | prover | 4 | 630,036,532 | 1,154 | 284 | 0 | 19 | 779 | 362 | 361 | 166 | 251 | 0 | 89 | 29 | 60 | 31 | 28 | 285 | 779 | 0 | 3 | 250 | 0 | 0 | 
| app_proof | prover | 5 | 630,124,756 | 1,137 | 284 | 0 | 20 | 766 | 355 | 354 | 161 | 250 | 0 | 86 | 25 | 60 | 30 | 29 | 284 | 766 | 0 | 3 | 249 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 164 | 1,627 | 164 | 160 | 0 | 3 | 84 | 2,623,000 | 39.68 | 
| app_proof | 1 | 135 | 1,641 | 135 | 138 | 0 | 2 | 155 | 2,625,000 | 42.64 | 
| app_proof | 2 | 111 | 1,439 | 111 | 41 | 0 | 3 | 134 | 2,625,000 | 42.50 | 
| app_proof | 3 | 109 | 1,437 | 109 | 41 | 0 | 2 | 134 | 2,625,000 | 42.57 | 
| app_proof | 4 | 109 | 1,439 | 109 | 41 | 0 | 2 | 134 | 2,625,000 | 42.78 | 
| app_proof | 5 | 145 | 1,413 | 145 | 41 | 0 | 2 | 89 | 1,670,960 | 42.90 | 

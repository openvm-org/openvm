...
| `total_proof_time_ms ` |  1,019.50 |  2,039 |  1,299 |  740 |
| `execute_metered_time_ms` |  35 | -          | -          | -          |
| `execute_metered_insns` |  2,579,903 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  72.67 | -          |  72.67 |  72.67 |
| `execute_preflight_insns` |  1,289,951.50 |  2,579,903 |  1,540,000 |  1,039,903 |
| `execute_preflight_time_ms` |  96.50 |  193 |  132 |  61 |
| `execute_preflight_insn_mi/s` |  35.34 | -          |  35.52 |  35.16 |
| `trace_gen_time_ms   ` |  27 |  54 |  38 |  16 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  786 |  1,572 |  1,022 |  550 |
| `prover.main_trace_commit_time_ms` |  229 |  458 |  310 |  148 |
| `prover.rap_constraints_time_ms` |  493.50 |  987 |  636 |  351 |
| `prover.openings_time_ms` |  62.50 |  125 |  75 |  50 |
| `prover.rap_constraints.logup_gkr_time_ms` |  110 |  220 |  155 |  65 |
| `prover.rap_constraints.round0_time_ms` |  281 |  562 |  351 |  211 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/c7c9d042b8ed0534e6c8a80085d0664ff07e89fd/kitchen_sink-c7c9d042b8ed0534e6c8a80085d0664ff07e89fd.memory.svg)
...
| app_proof |  |  |  |  |  | 740 |  |  | 35 | 2,579,903 | 72.67 | 0 | 2,080 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 19 | 160 | 19 | 6 | 1 | 2 | 2 | 2 | 
| internal_recursive.0 | 1 | 10 | 115 | 10 | 1 | 0 | 2 | 0 | 1 | 
| internal_recursive.1 | 1 | 9 | 107 | 8 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 115 | 437 | 115 | 24 | 11 | 21 | 5 | 5 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 53,472,003 | 141 | 40 | 0 | 4 | 66 | 20 | 19 | 29 | 16 | 0 | 33 | 9 | 23 | 1 | 22 | 41 | 66 | 0 | 1 | 15 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 23,651,975 | 104 | 19 | 0 | 4 | 54 | 19 | 18 | 20 | 13 | 0 | 30 | 8 | 22 | 1 | 20 | 19 | 54 | 0 | 1 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 17,507,975 | 98 | 14 | 0 | 4 | 51 | 19 | 18 | 18 | 13 | 0 | 31 | 9 | 21 | 0 | 20 | 15 | 51 | 0 | 1 | 13 | 0 | 0 | 
| leaf | 0 | prover | 428,317,568 | 321 | 131 | 0 | 10 | 146 | 49 | 48 | 37 | 59 | 0 | 43 | 11 | 31 | 7 | 24 | 132 | 146 | 0 | 2 | 58 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 787,664,364 | 1,022 | 309 | 0 | 179 | 636 | 351 | 349 | 129 | 155 | 55 | 75 | 13 | 62 | 16 | 46 | 310 | 636 | 0 | 1 | 99 | 0 | 0 | 
| app_proof | prover | 1 | 700,866,292 | 550 | 148 | 0 | 23 | 351 | 211 | 210 | 75 | 65 | 0 | 50 | 12 | 37 | 14 | 22 | 148 | 351 | 0 | 1 | 64 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 38 | 1,299 | 38 | 176 | 0 | 4 | 61 | 1,540,000 | 35.16 | 
| app_proof | 1 | 16 | 740 | 16 | 40 | 0 | 1 | 132 | 1,039,903 | 35.52 | 

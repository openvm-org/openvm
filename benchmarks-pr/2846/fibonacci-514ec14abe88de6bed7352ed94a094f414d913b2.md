...
|:---|---:|---:|---:|
| Total | <span style='color: green'>(-4 [-46.4%])</span> 4.42 | <span style='color: green'>(-2 [-45.1%])</span> 2.31 | <span style='color: green'>(-2 [-45.1%])</span> 2.31 |
| app_proof |  3.08 |  0.97 |  0.97 |
| leaf | <span style='color: green'>(-4 [-85.1%])</span> 0.67 | <span style='color: green'>(-2 [-73.9%])</span> 0.67 | <span style='color: green'>(-2 [-73.9%])</span> 0.67 |
...
| `total_proof_time_ms ` |  753 |  3,012 |  904 |  541 |
| `execute_metered_time_ms` |  70 | -          | -          | -          |
| `execute_metered_insns` |  12,000,265 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  170.98 | -          |  170.98 |  170.98 |
| `execute_preflight_insns` |  3,000,066.25 |  12,000,265 |  3,495,000 |  1,515,265 |
| `execute_preflight_time_ms` |  85.25 |  341 |  105 |  44 |
| `execute_preflight_insn_mi/s` |  47.47 | -          |  48.46 |  44.71 |
| `trace_gen_time_ms   ` |  133.25 |  533 |  168 |  115 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  464.25 |  1,857 |  526 |  288 |
| `prover.main_trace_commit_time_ms` |  96.50 |  386 |  110 |  58 |
| `prover.rap_constraints_time_ms` |  266.75 |  1,067 |  302 |  164 |
| `prover.openings_time_ms` |  100 |  400 |  115 |  65 |
| `prover.rap_constraints.logup_gkr_time_ms` |  191.50 |  766 |  220 |  115 |
| `prover.rap_constraints.round0_time_ms` |  50 |  200 |  59 |  31 |
...
| `prover.openings.whir_time_ms` |  80.75 |  323 |  93 |  53 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: green'>(-1574 [-70.2%])</span> 669 | <span style='color: green'>(-3817 [-85.1%])</span> 669 | <span style='color: green'>(-1898 [-73.9%])</span> 669 | <span style='color: green'>(-1250 [-65.1%])</span> 669 |
...
| `trace_gen_time_ms   ` | <span style='color: green'>(-29 [-31.2%])</span> 64 | <span style='color: green'>(-122 [-65.6%])</span> 64 | <span style='color: green'>(-32 [-33.3%])</span> 64 | <span style='color: green'>(-26 [-28.9%])</span> 64 |
| `generate_blob_total_time_ms` |  5 |  5 |  5 |  5 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` | <span style='color: green'>(-691 [-53.4%])</span> 604 | <span style='color: green'>(-1986 [-76.7%])</span> 604 | <span style='color: green'>(-887 [-59.5%])</span> 604 | <span style='color: green'>(-495 [-45.0%])</span> 604 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/514ec14abe88de6bed7352ed94a094f414d913b2/fibonacci-514ec14abe88de6bed7352ed94a094f414d913b2.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 80 | 9 |  |  | 0 |  | 374 | 9 |  |  |  |  |  |  | 
| app_proof |  |  |  |  |  | 541 |  |  | 70 | 12,000,265 | 170.98 | 0 | 3,089 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 325 | 115 | 0 | 0 | 106 | 34 | 33 | 50 | 20 | 0 | 103 | 89 | 13 | 3 | 9 | 116 | 106 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 167 | 46 | 0 | 0 | 67 | 24 | 24 | 28 | 14 | 0 | 53 | 44 | 8 | 1 | 6 | 47 | 67 | 0 | 3 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 133 | 31 | 0 | 0 | 60 | 23 | 22 | 24 | 13 | 0 | 40 | 33 | 7 | 1 | 5 | 31 | 60 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 147,934,254 | 604 | 230 | 0 | 0 | 181 | 83 | 82 | 52 | 45 | 0 | 192 | 168 | 24 | 12 | 11 | 230 | 181 | 0 | 7 | 43 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 136,618,054 | 526 | 110 | 0 | 0 | 300 | 59 | 58 | 27 | 213 | 0 | 115 | 93 | 21 | 12 | 9 | 110 | 300 | 0 | 3 | 212 | 0 | 0 | 
| app_proof | prover | 1 | 136,570,716 | 522 | 109 | 0 | 0 | 301 | 55 | 55 | 26 | 218 | 0 | 111 | 90 | 20 | 11 | 9 | 109 | 301 | 0 | 3 | 218 | 0 | 0 | 
| app_proof | prover | 2 | 136,570,716 | 521 | 109 | 0 | 0 | 302 | 55 | 54 | 26 | 220 | 0 | 109 | 87 | 21 | 11 | 9 | 109 | 302 | 0 | 3 | 219 | 0 | 0 | 
| app_proof | prover | 3 | 70,295,004 | 288 | 58 | 0 | 0 | 164 | 31 | 31 | 17 | 115 | 0 | 65 | 53 | 12 | 6 | 6 | 58 | 164 | 0 | 3 | 113 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 130 | 904 | 130 | 155 | 2,770,197,065 | 323,292,691 | 3,093,489,756 | 2,097,152 | 0 | 3 | 92 | 3,495,000 | 44.71 | 
| app_proof | 1 | 115 | 784 | 115 | 41 | 2,768,862,357 | 322,353,414 | 3,091,215,771 | 2,097,152 | 0 | 1 | 105 | 3,495,000 | 48.46 | 
| app_proof | 2 | 120 | 783 | 120 | 41 | 2,768,862,357 | 322,353,414 | 3,091,215,771 | 2,097,152 | 0 | 1 | 100 | 3,495,000 | 48.42 | 
| app_proof | 3 | 168 | 541 | 168 | 41 | 1,230,956,171 | 342,871,578 | 1,573,827,749 | 2,097,152 | 0 | 1 | 44 | 1,515,265 | 48.31 | 

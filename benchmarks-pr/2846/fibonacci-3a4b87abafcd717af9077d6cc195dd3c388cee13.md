...
|:---|---:|---:|---:|
| Total | <span style='color: green'>(-3 [-36.3%])</span> 5.88 | <span style='color: green'>(-2 [-46.9%])</span> 2.17 | <span style='color: green'>(-2 [-46.9%])</span> 2.17 |
| app_proof |  3.96 |  0.73 |  0.73 |
| leaf | <span style='color: green'>(-3 [-74.8%])</span> 1.13 | <span style='color: green'>(-2 [-74.6%])</span> 0.65 | <span style='color: green'>(-2 [-74.6%])</span> 0.65 |
...
| `total_proof_time_ms ` |  556.43 |  3,895 |  661 |  537 |
| `execute_metered_time_ms` |  68 | -          | -          | -          |
| `execute_metered_insns` |  12,000,265 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  174.44 | -          |  174.44 |  174.44 |
| `execute_preflight_insns` |  1,714,323.57 |  12,000,265 |  1,747,000 |  1,518,265 |
| `execute_preflight_time_ms` |  48.29 |  338 |  52 |  42 |
| `execute_preflight_insn_mi/s` |  50.50 | -          |  51.17 |  47.35 |
| `trace_gen_time_ms   ` |  163.43 |  1,144 |  170 |  160 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  285.57 |  1,999 |  288 |  283 |
| `prover.main_trace_commit_time_ms` |  57.71 |  404 |  58 |  57 |
| `prover.rap_constraints_time_ms` |  161.86 |  1,133 |  165 |  161 |
| `prover.openings_time_ms` |  65.14 |  456 |  68 |  64 |
| `prover.rap_constraints.logup_gkr_time_ms` |  113.43 |  794 |  114 |  113 |
| `prover.rap_constraints.round0_time_ms` |  30.71 |  215 |  34 |  30 |
| `prover.rap_constraints.mle_rounds_time_ms` |  16.86 |  118 |  17 |  16 |
...
| `prover.openings.whir_time_ms` |  53 |  371 |  56 |  52 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: green'>(-1678 [-74.8%])</span> 565.50 | <span style='color: green'>(-3355 [-74.8%])</span> 1,131 | <span style='color: green'>(-1914 [-74.6%])</span> 653 | <span style='color: green'>(-1441 [-75.1%])</span> 478 |
...
| `trace_gen_time_ms   ` | <span style='color: green'>(-46 [-48.9%])</span> 47.50 | <span style='color: green'>(-91 [-48.9%])</span> 95 | <span style='color: green'>(-38 [-39.6%])</span> 58 | <span style='color: green'>(-53 [-58.9%])</span> 37 |
| `generate_blob_total_time_ms` |  2.50 |  5 |  3 |  2 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` | <span style='color: green'>(-778 [-60.1%])</span> 517 | <span style='color: green'>(-1556 [-60.1%])</span> 1,034 | <span style='color: green'>(-897 [-60.2%])</span> 594 | <span style='color: green'>(-659 [-60.0%])</span> 440 |
| `prover.main_trace_commit_time_ms` |  192 |  384 |  228 |  156 |
| `prover.rap_constraints_time_ms` |  160.50 |  321 |  178 |  143 |
| `prover.openings_time_ms` |  163.50 |  327 |  188 |  139 |
| `prover.rap_constraints.logup_gkr_time_ms` |  38 |  76 |  44 |  32 |
| `prover.rap_constraints.round0_time_ms` |  74 |  148 |  81 |  67 |
...
| `prover.openings.whir_time_ms` |  143 |  286 |  164 |  122 |
...
| `prover.openings_time_ms` |  136 |  136 |  136 |  136 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/3a4b87abafcd717af9077d6cc195dd3c388cee13/fibonacci-3a4b87abafcd717af9077d6cc195dd3c388cee13.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 65 | 9 |  |  | 0 |  | 331 | 9 |  |  |  |  |  |  | 
| app_proof |  |  |  |  |  | 540 |  |  | 68 | 12,000,265 | 174.44 | 0 | 3,972 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 28 | 461 | 28 | 10 | 1 | 2 | 1 | 1 | 
| internal_recursive.0 | 1 | 12 |
...
|:---|---:|---:|---:|
| Total |  5.43 |  3.81 |  3.81 |
| app_proof |  3.90 |  2.28 |  2.28 |
| leaf |  0.96 |  0.96 |  0.96 |
...
| `total_proof_time_ms ` |  1,935 |  3,870 |  2,250 |  1,620 |
| `execute_metered_time_ms` |  34 | -          | -          | -          |
| `execute_metered_insns` |  2,579,903 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  74.47 | -          |  74.47 |  74.47 |
| `execute_preflight_insns` |  1,289,951.50 |  2,579,903 |  1,540,000 |  1,039,903 |
| `execute_preflight_time_ms` |  101.50 |  203 |  140 |  63 |
| `execute_preflight_insn_mi/s` |  35.43 | -          |  36.47 |  34.38 |
| `trace_gen_time_ms   ` |  140 |  280 |  187 |  93 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,584 |  3,168 |  1,823 |  1,345 |
| `prover.main_trace_commit_time_ms` |  514 |  1,028 |  598 |  430 |
| `prover.rap_constraints_time_ms` |  939.50 |  1,879 |  1,087 |  792 |
| `prover.openings_time_ms` |  129.50 |  259 |  137 |  122 |
| `prover.rap_constraints.logup_gkr_time_ms` |  168 |  336 |  198 |  138 |
| `prover.rap_constraints.round0_time_ms` |  567 |  1,134 |  673 |  461 |
| `prover.rap_constraints.mle_rounds_time_ms` |  203.50 |  407 |  215 |  192 |
| `prover.openings.stacked_reduction_time_ms` |  94.50 |  189 |  103 |  86 |
| `prover.openings.stacked_reduction.round0_time_ms` |  50.50 |  101 |  52 |  49 |
...
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  832 |  832 |  832 |  832 |
...
| `prover.rap_constraints.round0_time_ms` |  137 |  137 |  137 |  137 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/bf4cfbf42eaa9c1c0a1298a8a93915089aa07f42/kitchen_sink-bf4cfbf42eaa9c1c0a1298a8a93915089aa07f42.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 79 | 9 |  |  | 0 |  | 389 | 9 |  |  |  |  |  |  | 
| app_proof |  |  |  |  |  | 1,620 |  |  | 34 | 2,579,903 | 74.47 | 0 | 3,910 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 20 | 279 | 19 | 6 | 1 | 2 | 2 | 2 | 
| internal_recursive.0 | 1 | 10 | 153 | 10 | 1 | 0 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 10 | 135 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 123 | 955 | 122 | 23 | 10 | 21 | 5 | 5 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,577,979 | 259 | 117 | 0 | 0 | 108 | 36 | 36 | 51 | 20 | 0 | 32 | 19 | 13 | 3 | 9 | 118 | 108 | 0 | 2 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,767 | 142 | 46 | 0 | 0 | 67 | 24 | 24 | 28 | 13 | 0 | 28 | 19 | 8 | 1 | 6 | 46 | 67 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 125 | 32 | 0 | 0 | 62 | 24 | 23 | 24 | 13 | 0 | 29 | 22 | 7 | 1 | 5 | 32 | 62 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 265,003,892 | 832 | 401 | 0 | 1 | 354 | 137 | 136 | 79 | 137 | 0 | 76 | 35 | 40 | 22 | 18 | 401 | 354 | 0 | 6 | 137 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 567,917,156 | 1,823 | 597 | 0 | 186 | 1,087 | 673 | 672 | 215 | 198 | 56 | 137 | 33 | 103 | 52 | 51 | 598 | 1,087 | 0 | 3 | 141 | 0 | 0 | 
| app_proof | prover | 1 | 537,266,124 | 1,345 | 430 | 0 | 1 | 792 | 461 | 460 | 192 | 138 | 0 | 122 | 35 | 86 | 49 | 37 | 430 | 792 | 0 | 3 | 137 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 187 | 2,250 | 187 | 176 | 0 | 3 | 63 | 1,540,000 | 34.38 | 
| app_proof | 1 | 93 | 1,620 | 93 | 41 | 0 | 2 | 140 | 1,039,903 | 36.47 | 

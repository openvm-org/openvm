...
|:---|---:|---:|---:|
| Total | <span style='color: green'>(-4 [-39.8%])</span> 5.38 | <span style='color: green'>(-2 [-51.8%])</span> 1.89 | <span style='color: green'>(-2 [-51.8%])</span> 1.89 |
| app_proof |  3.81 |  0.71 |  0.71 |
| leaf | <span style='color: green'>(-4 [-79.4%])</span> 0.92 | <span style='color: green'>(-2 [-79.3%])</span> 0.53 | <span style='color: green'>(-2 [-79.3%])</span> 0.53 |
...
| `total_proof_time_ms ` |  534.71 |  3,743 |  644 |  515 |
| `execute_metered_time_ms` |  65 | -          | -          | -          |
| `execute_metered_insns` |  12,000,265 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  182.72 | -          |  182.72 |  182.72 |
| `execute_preflight_insns` |  1,714,323.57 |  12,000,265 |  1,747,000 |  1,518,265 |
| `execute_preflight_time_ms` |  49.43 |  346 |  53 |  43 |
| `execute_preflight_insn_mi/s` |  49.19 | -          |  49.80 |  47.64 |
| `trace_gen_time_ms   ` |  167.29 |  1,171 |  173 |  165 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  258.71 |  1,811 |  263 |  257 |
| `prover.main_trace_commit_time_ms` |  58.86 |  412 |  59 |  58 |
| `prover.rap_constraints_time_ms` |  166.86 |  1,168 |  170 |  164 |
| `prover.openings_time_ms` |  31.71 |  222 |  33 |  31 |
| `prover.rap_constraints.logup_gkr_time_ms` |  116.71 |  817 |  118 |  115 |
| `prover.rap_constraints.round0_time_ms` |  32 |  224 |  35 |  31 |
...
| `prover.openings.whir_time_ms` |  19.43 |  136 |  21 |  19 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: green'>(-1781 [-79.4%])</span> 462 | <span style='color: green'>(-3562 [-79.4%])</span> 924 | <span style='color: green'>(-2035 [-79.3%])</span> 532 | <span style='color: green'>(-1527 [-79.6%])</span> 392 |
...
| `trace_gen_time_ms   ` | <span style='color: green'>(-44 [-47.8%])</span> 48.50 | <span style='color: green'>(-89 [-47.8%])</span> 97 | <span style='color: green'>(-37 [-38.5%])</span> 59 | <span style='color: green'>(-52 [-57.8%])</span> 38 |
| `generate_blob_total_time_ms` |  2.50 |  5 |  3 |  2 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` | <span style='color: green'>(-882 [-68.1%])</span> 413 | <span style='color: green'>(-1764 [-68.1%])</span> 826 | <span style='color: green'>(-1019 [-68.3%])</span> 472 | <span style='color: green'>(-745 [-67.8%])</span> 354 |
| `prover.main_trace_commit_time_ms` |  195.50 |  391 |  233 |  158 |
| `prover.rap_constraints_time_ms` |  163 |  326 |  181 |  145 |
| `prover.openings_time_ms` |  53.50 |  107 |  57 |  50 |
| `prover.rap_constraints.logup_gkr_time_ms` |  38.50 |  77 |  45 |  32 |
| `prover.rap_constraints.round0_time_ms` |  75 |  150 |  83 |  67 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/bf4cfbf42eaa9c1c0a1298a8a93915089aa07f42/fibonacci-bf4cfbf42eaa9c1c0a1298a8a93915089aa07f42.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 75 | 9 |  |  | 0 |  | 365 | 9 |  |  |  |  |  |  | 
| app_proof |  |  |  |  |  |
...
|:---|---:|---:|---:|
| Total | <span style='color: green'>(-4 [-44.5%])</span> 4.72 | <span style='color: green'>(-2 [-43.2%])</span> 2.45 | <span style='color: green'>(-2 [-43.2%])</span> 2.45 |
| app_proof |  3.31 |  1.03 |  1.03 |
| leaf | <span style='color: green'>(-4 [-84.3%])</span> 0.71 | <span style='color: green'>(-2 [-72.5%])</span> 0.71 | <span style='color: green'>(-2 [-72.5%])</span> 0.71 |
...
| `total_proof_time_ms ` |  810.25 |  3,241 |  966 |  583 |
| `execute_metered_time_ms` |  67 | -          | -          | -          |
| `execute_metered_insns` |  12,000,265 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  178.10 | -          |  178.10 |  178.10 |
| `execute_preflight_insns` |  3,000,066.25 |  12,000,265 |  3,495,000 |  1,515,265 |
| `execute_preflight_time_ms` |  82.25 |  329 |  101 |  43 |
| `execute_preflight_insn_mi/s` |  49.61 | -          |  50.66 |  46.64 |
| `trace_gen_time_ms   ` |  160.25 |  641 |  192 |  144 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  497.25 |  1,989 |  565 |  306 |
| `prover.main_trace_commit_time_ms` |  103 |  412 |  118 |  59 |
| `prover.rap_constraints_time_ms` |  288 |  1,152 |  327 |  176 |
| `prover.openings_time_ms` |  105.25 |  421 |  122 |  70 |
| `prover.rap_constraints.logup_gkr_time_ms` |  204.50 |  818 |  236 |  117 |
| `prover.rap_constraints.round0_time_ms` |  56.25 |  225 |  64 |  38 |
| `prover.rap_constraints.mle_rounds_time_ms` |  25.75 |  103 |  28 |  19 |
| `prover.openings.stacked_reduction_time_ms` |  20 |  80 |  23 |  13 |
| `prover.openings.stacked_reduction.round0_time_ms` |  10.75 |  43 |  12 |  7 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  8.50 |  34 |  10 |  6 |
| `prover.openings.whir_time_ms` |  85 |  340 |  99 |  56 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: green'>(-1538 [-68.6%])</span> 705 | <span style='color: green'>(-3781 [-84.3%])</span> 705 | <span style='color: green'>(-1862 [-72.5%])</span> 705 | <span style='color: green'>(-1214 [-63.3%])</span> 705 |
| `execute_preflight_time_ms` | <span style='color: green'>(-853 [-99.9%])</span> 1 | <span style='color: green'>(-1707 [-99.9%])</span> 1 | <span style='color: green'>(-1376 [-99.9%])</span> 1 | <span style='color: green'>(-330 [-99.7%])</span> 1 |
| `trace_gen_time_ms   ` | <span style='color: green'>(-27 [-29.0%])</span> 66 | <span style='color: green'>(-120 [-64.5%])</span> 66 | <span style='color: green'>(-30 [-31.2%])</span> 66 | <span style='color: green'>(-24 [-26.7%])</span> 66 |
| `generate_blob_total_time_ms` |  5 |  5 |  5 |  5 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` | <span style='color: green'>(-656 [-50.7%])</span> 639 | <span style='color: green'>(-1951 [-75.3%])</span> 639 | <span style='color: green'>(-852 [-57.1%])</span> 639 | <span style='color: green'>(-460 [-41.9%])</span> 639 |
| `prover.main_trace_commit_time_ms` |  247 |  247 |  247 |  247 |
| `prover.rap_constraints_time_ms` |  196 |  196 |  196 |  196 |
| `prover.openings_time_ms` |  195 |  195 |  195 |  195 |
| `prover.rap_constraints.logup_gkr_time_ms` |  46 |  46 |  46 |  46 |
| `prover.rap_constraints.round0_time_ms` |  92 |  92 |  92 |  92 |
...
| `prover.openings.whir_time_ms` |  169 |  169 |  169 |  169 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/b9d416af1fc0ce10b7cec747a5147c3a9edcec4b/fibonacci-b9d416af1fc0ce10b7cec747a5147c3a9edcec4b.memory.svg)
...
| app_proof |  |  |  |  |  | 583 |  |  | 67 | 12,000,265 | 178.10 | 0 | 3,315 |  | 
| internal_for_leaf |  |  |  | 362 |  |  |  |  |  |  |  |  |  | 363 | 
...
| app_proof | VmAirWrapper<Rv32BaseAluAdapterAir, BaseAluCoreAir<4, 8> | 0 | 10 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 19 | 362 | 19 | 5 | 1 | 2 | 1 | 1 | 
| internal_recursive.0 | 1 | 11 | 189 | 11 | 1 | 0 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 10 | 157 | 10 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 66 | 705 | 65 | 25 | 5 | 1 | 1 | 1 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 343 | 123 | 0 | 0 | 113 | 37 | 37 | 53 | 21 | 0 | 106 | 91 | 14 | 3 | 10 | 123 | 113 | 0 | 3 | 20 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 177 | 49 | 0 | 0 | 71 | 26 | 26 | 29 | 14 | 0 | 56 | 47 | 8 | 1 | 6 | 50 | 71 | 0 | 3 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 146 | 33 | 0 | 0 | 64 | 25 | 24 | 25 | 14 | 0 | 48 | 40 | 7 | 1 | 5 | 33 | 64 | 0 | 3 | 13 | 0 | 0 | 
| leaf | 0 | prover | 147,934,254 | 639 | 247 | 0 | 0 | 196 | 92 | 91 | 56 | 46 | 0 | 195 | 169 | 25 | 13 | 12 | 247 | 195 | 0 | 9 | 45 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 136,618,054 | 565 | 117 | 0 | 0 | 325 | 64 | 64 | 28 | 231 | 0 | 122 | 99 | 23 | 12 | 10 | 117 | 324 | 0 | 4 | 229 | 0 | 0 | 
| app_proof | prover | 1 | 136,570,716 | 561 | 117 | 0 | 0 | 327 | 62 | 62 | 28 | 236 | 0 | 116 | 94 | 22 | 12 | 9 | 118 | 327 | 0 | 4 | 235 | 0 | 0 | 
| app_proof | prover | 2 | 136,570,716 | 557 | 118 | 0 | 0 | 324 | 61 | 61 | 28 | 234 | 0 | 113 | 91 | 22 | 12 | 9 | 118 | 324 | 0 | 4 | 234 | 0 | 0 | 
| app_proof | prover | 3 | 70,295,004 | 306 | 59 | 0 | 0 | 176 | 38 | 38 | 19 | 117 | 0 | 70 | 56 | 13 | 7 | 6 | 59 | 176 | 0 | 3 | 116 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 157 | 966 | 157 | 154 | 2,770,197,065 | 323,292,691 | 3,093,489,756 | 2,097,152 | 0 | 3 | 89 | 3,495,000 | 46.64 | 
| app_proof | 1 | 144 | 849 | 144 | 41 | 2,768,862,357 | 322,353,414 | 3,091,215,771 | 2,097,152 | 0 | 2 | 101 | 3,495,000 | 50.66 | 
| app_proof | 2 | 148 | 843 | 148 | 41 | 2,768,862,357 | 322,353,414 | 3,091,215,771 | 2,097,152 | 0 | 2 | 96 | 3,495,000 | 50.66 | 
| app_proof | 3 | 192 | 583 | 192 | 41 | 1,230,956,171 | 342,871,578 | 1,573,827,749 | 2,097,152 | 0 | 2 | 43 | 1,515,265 | 50.46 | 

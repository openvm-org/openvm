...
|:---|---:|---:|---:|
| Total | <span style='color: green'>(-3 [-35.8%])</span> 5.98 | <span style='color: green'>(-2 [-46.4%])</span> 2.20 | <span style='color: green'>(-2 [-46.4%])</span> 2.20 |
| app_proof |  4.04 |  0.74 |  0.74 |
| leaf | <span style='color: green'>(-3 [-74.5%])</span> 1.14 | <span style='color: green'>(-2 [-74.2%])</span> 0.66 | <span style='color: green'>(-2 [-74.2%])</span> 0.66 |
...
| `total_proof_time_ms ` |  568.29 |  3,978 |  674 |  547 |
| `execute_metered_time_ms` |  67 | -          | -          | -          |
| `execute_metered_insns` |  12,000,265 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  178.91 | -          |  178.91 |  178.91 |
| `execute_preflight_insns` |  1,714,323.57 |  12,000,265 |  1,747,000 |  1,518,265 |
| `execute_preflight_time_ms` |  49.29 |  345 |  54 |  43 |
| `execute_preflight_insn_mi/s` |  49.26 | -          |  49.89 |  47.55 |
| `trace_gen_time_ms   ` |  167.86 |  1,175 |  174 |  166 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  291.86 |  2,043 |  294 |  287 |
| `prover.main_trace_commit_time_ms` |  58.43 |  409 |  59 |  56 |
| `prover.rap_constraints_time_ms` |  166.14 |  1,163 |  168 |  163 |
| `prover.openings_time_ms` |  66.14 |  463 |  67 |  65 |
| `prover.rap_constraints.logup_gkr_time_ms` |  115.57 |  809 |  118 |  111 |
| `prover.rap_constraints.round0_time_ms` |  32.57 |  228 |  35 |  31 |
...
| `prover.openings.whir_time_ms` |  53.86 |  377 |  55 |  53 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: green'>(-1671 [-74.5%])</span> 572 | <span style='color: green'>(-3342 [-74.5%])</span> 1,144 | <span style='color: green'>(-1904 [-74.2%])</span> 663 | <span style='color: green'>(-1438 [-74.9%])</span> 481 |
...
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` | <span style='color: green'>(-772 [-59.6%])</span> 523.50 | <span style='color: green'>(-1543 [-59.6%])</span> 1,047 | <span style='color: green'>(-887 [-59.5%])</span> 604 | <span style='color: green'>(-656 [-59.7%])</span> 443 |
| `prover.main_trace_commit_time_ms` |  196 |  392 |  234 |  158 |
| `prover.rap_constraints_time_ms` |  163.50 |  327 |  182 |  145 |
| `prover.openings_time_ms` |  163 |  326 |  187 |  139 |
...
| `prover.openings.whir_time_ms` |  141.50 |  283 |  162 |  121 |
...
| `prover.openings_time_ms` |  129 |  129 |  129 |  129 |
...
| `prover.openings.whir_time_ms` |  111 |  111 |  111 |  111 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/3784813f5068dfbeee8c5ff8f3a7f78561ce2bd0/fibonacci-3784813f5068dfbeee8c5ff8f3a7f78561ce2bd0.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 66 | 9 |  |  | 0 |  | 331 | 9 |  |  |  |  |  |  | 
| app_proof |  |  |  |  |  | 552 |  |  | 67 | 12,000,265 | 178.91 | 0 | 4,053 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 28 | 463 | 27 | 9 | 1 | 2 | 1 | 1 | 
| internal_recursive.0 | 1 | 12 | 183 | 11 | 1 | 0 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 10 | 147 | 10 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 59 | 663 | 58 | 24 | 4 | 1 | 1 | 1 | 
| leaf | 1 | 38 | 481 | 38 | 17 | 2 | 1 | 1 | 1 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 53,005,300 |
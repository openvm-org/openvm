...
|:---|---:|---:|---:|
| Total | <span style='color: green'>(-4 [-39.9%])</span> 5.37 | <span style='color: green'>(-2 [-51.8%])</span> 1.89 | <span style='color: green'>(-2 [-51.8%])</span> 1.89 |
| app_proof |  3.80 |  0.71 |  0.71 |
| leaf | <span style='color: green'>(-4 [-79.5%])</span> 0.92 | <span style='color: green'>(-2 [-79.3%])</span> 0.53 | <span style='color: green'>(-2 [-79.3%])</span> 0.53 |
...
| `total_proof_time_ms ` |  533.43 |  3,734 |  643 |  512 |
| `execute_metered_time_ms` |  65 | -          | -          | -          |
| `execute_metered_insns` |  12,000,265 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  183.99 | -          |  183.99 |  183.99 |
| `execute_preflight_insns` |  1,714,323.57 |  12,000,265 |  1,747,000 |  1,518,265 |
| `execute_preflight_time_ms` |  51.86 |  363 |  57 |  45 |
| `execute_preflight_insn_mi/s` |  46.43 | -          |  46.67 |  45.99 |
| `trace_gen_time_ms   ` |  162.43 |  1,137 |  168 |  159 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  259.57 |  1,817 |  263 |  256 |
| `prover.main_trace_commit_time_ms` |  58.57 |  410 |  59 |  58 |
| `prover.rap_constraints_time_ms` |  165.14 |  1,156 |  168 |  163 |
| `prover.openings_time_ms` |  34.57 |  242 |  37 |  33 |
| `prover.rap_constraints.logup_gkr_time_ms` |  115.57 |  809 |  116 |  114 |
| `prover.rap_constraints.round0_time_ms` |  31.57 |  221 |  35 |  30 |
...
| `prover.openings.whir_time_ms` |  22.29 |  156 |  25 |  21 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: green'>(-1784 [-79.5%])</span> 459.50 | <span style='color: green'>(-3567 [-79.5%])</span> 919 | <span style='color: green'>(-2036 [-79.3%])</span> 531 | <span style='color: green'>(-1531 [-79.8%])</span> 388 |
...
| `trace_gen_time_ms   ` | <span style='color: green'>(-44 [-46.8%])</span> 49.50 | <span style='color: green'>(-87 [-46.8%])</span> 99 | <span style='color: green'>(-35 [-36.5%])</span> 61 | <span style='color: green'>(-52 [-57.8%])</span> 38 |
| `generate_blob_total_time_ms` |  2.50 |  5 |  3 |  2 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` | <span style='color: green'>(-885 [-68.3%])</span> 410 | <span style='color: green'>(-1770 [-68.3%])</span> 820 | <span style='color: green'>(-1021 [-68.5%])</span> 470 | <span style='color: green'>(-749 [-68.2%])</span> 350 |
| `prover.main_trace_commit_time_ms` |  194.50 |  389 |  231 |  158 |
| `prover.rap_constraints_time_ms` |  164 |  328 |  182 |  146 |
| `prover.openings_time_ms` |  50 |  100 |  55 |  45 |
| `prover.rap_constraints.logup_gkr_time_ms` |  38.50 |  77 |  45 |  32 |
| `prover.rap_constraints.round0_time_ms` |  76 |  152 |  83 |  69 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/e823766aa7d6aac1a6fce90c7137cee53fcab9d9/fibonacci-e823766aa7d6aac1a6fce90c7137cee53fcab9d9.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 78 | 9 |  |  | 0 |  | 378 | 9 |  |  |  |  |  |  | 
| app_proof |  |  |  |  |  |
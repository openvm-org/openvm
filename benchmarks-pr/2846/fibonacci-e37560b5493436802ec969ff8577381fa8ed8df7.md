...
|:---|---:|---:|---:|
| Total | <span style='color: green'>(-3 [-36.1%])</span> 5.92 | <span style='color: green'>(-2 [-46.7%])</span> 2.18 | <span style='color: green'>(-2 [-46.7%])</span> 2.18 |
| app_proof |  3.99 |  0.73 |  0.73 |
| leaf | <span style='color: green'>(-3 [-74.6%])</span> 1.14 | <span style='color: green'>(-2 [-74.3%])</span> 0.66 | <span style='color: green'>(-2 [-74.3%])</span> 0.66 |
...
| `total_proof_time_ms ` |  561 |  3,927 |  664 |  541 |
| `execute_metered_time_ms` |  67 | -          | -          | -          |
| `execute_metered_insns` |  12,000,265 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  176.100 | -          |  176.100 |  176.100 |
| `execute_preflight_insns` |  1,714,323.57 |  12,000,265 |  1,747,000 |  1,518,265 |
| `execute_preflight_time_ms` |  49 |  343 |  53 |  42 |
| `execute_preflight_insn_mi/s` |  50.04 | -          |  50.82 |  46.84 |
| `trace_gen_time_ms   ` |  164.71 |  1,153 |  171 |  162 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  288.14 |  2,017 |  291 |  285 |
| `prover.main_trace_commit_time_ms` |  58 |  406 |  59 |  57 |
| `prover.rap_constraints_time_ms` |  163.43 |  1,144 |  166 |  161 |
| `prover.openings_time_ms` |  65.71 |  460 |  67 |  64 |
| `prover.rap_constraints.logup_gkr_time_ms` |  114 |  798 |  117 |  110 |
...
| `prover.openings.whir_time_ms` |  53.57 |  375 |  55 |  52 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: green'>(-1674 [-74.6%])</span> 569 | <span style='color: green'>(-3348 [-74.6%])</span> 1,138 | <span style='color: green'>(-1907 [-74.3%])</span> 660 | <span style='color: green'>(-1441 [-75.1%])</span> 478 |
...
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` | <span style='color: green'>(-775 [-59.8%])</span> 520 | <span style='color: green'>(-1550 [-59.8%])</span> 1,040 | <span style='color: green'>(-891 [-59.8%])</span> 600 | <span style='color: green'>(-659 [-60.0%])</span> 440 |
| `prover.main_trace_commit_time_ms` |  193 |  386 |  230 |  156 |
| `prover.rap_constraints_time_ms` |  162 |  324 |  179 |  145 |
| `prover.openings_time_ms` |  164 |  328 |  190 |  138 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/e37560b5493436802ec969ff8577381fa8ed8df7/fibonacci-e37560b5493436802ec969ff8577381fa8ed8df7.memory.svg)
...
| app_proof |  |  |  |  |  | 545 |  |  | 67 | 12,000,265 | 176.100 | 0 | 4,003 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 28 | 457 | 28 | 9 | 1 | 2 | 1 | 1 | 
| internal_recursive.0 | 1 | 12 | 181 | 11 | 1 | 0 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 9 | 148 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 59 | 660 | 59 | 24 | 4 | 1 | 1 | 1 | 
| leaf | 1 | 37 | 478 | 37 | 17 | 2 | 1 | 1 | 1 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 53,005,300 | 428 | 156 | 0 | 0 | 142 | 41 | 41 | 71 | 28 | 0 | 129 | 112 | 16 | 5 | 11 | 156 | 142 | 0 | 3 | 28 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,767 | 169 | 46 | 0 | 0 | 66 | 24 | 23 | 27 | 14 | 0 | 56 | 47 | 8 | 1 | 6 | 46 | 66 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 138 | 32 | 0 | 0 | 61 | 23 | 22 | 24 | 13 | 0 | 44 | 37 | 7 | 1 | 5 | 32 | 61 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 147,934,246 | 600 | 229 | 0 | 0 | 179 | 83 | 82 | 52 | 44 | 0 | 190 | 166 | 23 | 11 | 11 | 230 | 179 | 0 | 7 | 43 | 0 | 0 | 
| leaf | 1 | prover | 98,728,630 | 440 | 156 | 0 | 0 | 145 | 67 | 66 | 45 | 32 | 0 | 138 | 120 | 17 | 8 | 9 | 156 | 145 | 0 | 6 | 31 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 70,295,622 | 285 | 56 | 0 | 0 | 163 | 35 | 34 | 17 | 110 | 0 | 65 | 52 | 12 | 6 | 6 | 57 | 163 | 0 | 3 | 110 | 0 | 0 | 
| app_proof | prover | 1 | 70,248,284 | 286 | 58 | 0 | 0 | 163 | 31 | 31 | 17 | 114 | 0 | 64 | 52 | 11 | 6 | 5 | 58 | 163 | 0 | 3 | 113 | 0 | 0 | 
| app_proof | prover | 2 | 70,248,284 | 290 | 58 | 0 | 0 | 164 | 31 | 31 | 17 | 115 | 0 | 67 | 55 | 12 | 6 | 5 | 58 | 164 | 0 | 3 | 114 | 0 | 0 | 
| app_proof | prover | 3 | 70,248,284 | 291 | 58 | 0 | 0 | 166 | 30 | 30 | 17 | 117 | 0 | 66 | 54 | 12 | 6 | 5 | 58 | 166 | 0 | 3 | 116 | 0 | 0 | 
| app_proof | prover | 4 | 70,248,284 | 289 | 59 | 0 | 0 | 162 | 30 | 30 | 17 | 114 | 0 | 67 | 55 | 12 | 6 | 5 | 59 | 162 | 0 | 3 | 114 | 0 | 0 | 
| app_proof | prover | 5 | 70,248,284 | 286 | 58 | 0 | 0 | 161 | 30 | 30 | 17 | 114 | 0 | 66 | 54 | 11 | 6 | 5 | 58 | 161 | 0 | 3 | 113 | 0 | 0 | 
| app_proof | prover | 6 | 70,295,004 | 290 | 58 | 0 | 0 | 165 | 33 | 33 | 17 | 114 | 0 | 65 | 53 | 12 | 6 | 6 | 58 | 165 | 0 | 3 | 113 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 164 | 664 | 164 | 160 | 1,411,127,546 | 162,713,442 | 1,573,840,988 | 2,097,152 | 0 | 3 | 53 | 1,747,000 | 50.19 | 
| app_proof | 1 | 162 | 542 | 162 | 40 | 1,409,791,968 | 161,775,035 | 1,571,567,003 | 2,097,152 | 0 | 1 | 52 | 1,747,000 | 46.84 | 
| app_proof | 2 | 164 | 545 | 164 | 40 | 1,409,792,265 | 161,774,738 | 1,571,567,003 | 2,097,152 | 0 | 1 | 49 | 1,747,000 | 50.77 | 
| app_proof | 3 | 164 | 546 | 164 | 41 | 1,409,792,837 | 161,774,166 | 1,571,567,003 | 2,097,152 | 0 | 1 | 49 | 1,747,000 | 50.82 | 
| app_proof | 4 | 164 | 544 | 164 | 41 | 1,409,791,968 | 161,775,035 | 1,571,567,003 | 2,097,152 | 0 | 1 | 49 | 1,747,000 | 50.42 | 
| app_proof | 5 | 164 | 541 | 164 | 40 | 1,409,792,265 | 161,774,738 | 1,571,567,003 | 2,097,152 | 0 | 1 | 49 | 1,747,000 | 50.67 | 
| app_proof | 6 | 171 | 545 | 171 | 40 | 1,233,288,671 | 340,539,078 | 1,573,827,749 | 2,097,152 | 0 | 1 | 42 | 1,518,265 | 50.54 | 

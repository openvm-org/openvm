...
| `total_proof_time_ms ` |  1,924.50 |  3,849 |  2,239 |  1,610 |
| `execute_metered_time_ms` |  38 | -          | -          | -          |
| `execute_metered_insns` |  2,579,903 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  67.37 | -          |  67.37 |  67.37 |
| `execute_preflight_insns` |  1,289,951.50 |  2,579,903 |  1,540,000 |  1,039,903 |
| `execute_preflight_time_ms` |  100 |  200 |  137 |  63 |
| `execute_preflight_insn_mi/s` |  35.55 | -          |  36.53 |  34.56 |
| `trace_gen_time_ms   ` |  139 |  278 |  185 |  93 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,575.50 |  3,151 |  1,813 |  1,338 |
| `prover.main_trace_commit_time_ms` |  512 |  1,024 |  596 |  428 |
| `prover.rap_constraints_time_ms` |  934 |  1,868 |  1,080 |  788 |
| `prover.openings_time_ms` |  128.50 |  257 |  136 |  121 |
| `prover.rap_constraints.logup_gkr_time_ms` |  167 |  334 |  197 |  137 |
| `prover.rap_constraints.round0_time_ms` |  565 |  1,130 |  670 |  460 |
...
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  43 |  86 |  50 |  36 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/032522d5c31aaa70ffe0032b1cc5f2b07f6a67e6/kitchen_sink-032522d5c31aaa70ffe0032b1cc5f2b07f6a67e6.memory.svg)
...
| app_proof |  |  |  |  |  | 1,610 |  |  | 38 | 2,579,903 | 67.37 | 0 | 3,893 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,577,979 | 264 | 116 | 0 | 0 | 108 | 35 | 35 | 51 | 20 | 0 | 38 | 25 | 13 | 3 | 9 | 117 | 108 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,767 | 141 | 46 | 0 | 0 | 66 | 24 | 24 | 28 | 13 | 0 | 28 | 19 | 8 | 1 | 6 | 46 | 66 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 119 | 32 | 0 | 0 | 64 | 24 | 23 | 24 | 15 | 0 | 22 | 15 | 7 | 1 | 5 | 32 | 63 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 265,003,892 | 826 | 399 | 0 | 1 | 351 | 135 | 134 | 78 | 137 | 0 | 74 | 34 | 40 | 22 | 18 | 399 | 351 | 0 | 6 | 137 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 567,917,156 | 1,813 | 596 | 0 | 188 | 1,080 | 670 | 669 | 212 | 197 | 55 | 136 | 34 | 102 | 51 | 50 | 596 | 1,080 | 0 | 3 | 139 | 0 | 0 | 
| app_proof | prover | 1 | 537,266,124 | 1,338 | 428 | 0 | 1 | 788 | 460 | 459 | 190 | 137 | 0 | 121 | 35 | 85 | 48 | 36 | 428 | 787 | 0 | 4 | 136 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 185 | 2,239 | 185 | 176 | 9,069,025,194 | 1,018,123,350 | 10,087,148,544 | 2,097,152 | 2,097,152 | 0 | 4 | 63 | 1,540,000 | 34.56 | 
| app_proof | 1 | 93 | 1,610 | 93 | 41 | 6,675,792,954 | 2,876,399,838 | 9,552,192,792 | 2,097,152 | 2,097,152 | 0 | 2 | 137 | 1,039,903 | 36.53 | 

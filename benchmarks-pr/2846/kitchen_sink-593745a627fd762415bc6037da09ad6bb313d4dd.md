...
| `total_proof_time_ms ` |  1,914 |  3,828 |  2,228 |  1,600 |
...
| `execute_preflight_insn_mi/s` |  35.58 | -          |  36.56 |  34.61 |
| `trace_gen_time_ms   ` |  137.50 |  275 |  184 |  91 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,566 |  3,132 |  1,804 |  1,328 |
| `prover.main_trace_commit_time_ms` |  508.50 |  1,017 |  592 |  425 |
| `prover.rap_constraints_time_ms` |  929.50 |  1,859 |  1,076 |  783 |
| `prover.openings_time_ms` |  127 |  254 |  135 |  119 |
| `prover.rap_constraints.logup_gkr_time_ms` |  166 |  332 |  197 |  135 |
| `prover.rap_constraints.round0_time_ms` |  564.50 |  1,129 |  668 |  461 |
| `prover.rap_constraints.mle_rounds_time_ms` |  198 |  396 |  210 |  186 |
| `prover.openings.stacked_reduction_time_ms` |  91.50 |  183 |  100 |  83 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/593745a627fd762415bc6037da09ad6bb313d4dd/kitchen_sink-593745a627fd762415bc6037da09ad6bb313d4dd.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 74 | 9 |  |  | 0 |  | 376 | 9 |  |  |  |  |  |  | 
| app_proof |  |  |  |  |  | 1,600 |  |  | 34 | 2,579,903 | 73.88 | 0 | 3,867 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,577,979 | 261 | 116 | 0 | 0 | 107 | 35 | 35 | 51 | 20 | 0 | 36 | 23 | 13 | 3 | 9 | 117 | 107 | 0 | 2 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,767 | 143 | 46 | 0 | 0 | 66 | 24 | 23 | 28 | 14 | 0 | 29 | 21 | 8 | 1 | 6 | 46 | 66 | 0 | 2 | 12 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 119 | 31 | 0 | 0 | 62 | 24 | 23 | 24 | 13 | 0 | 25 | 18 | 7 | 1 | 5 | 32 | 62 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 265,003,892 | 822 | 396 | 0 | 1 | 348 | 133 | 132 | 77 | 137 | 0 | 76 | 36 | 40 | 21 | 18 | 397 | 348 | 0 | 6 | 136 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 567,917,156 | 1,804 | 592 | 0 | 186 | 1,076 | 668 | 667 | 210 | 197 | 56 | 135 | 34 | 100 | 50 | 50 | 592 | 1,076 | 0 | 3 | 139 | 0 | 0 | 
| app_proof | prover | 1 | 537,266,124 | 1,328 | 425 | 0 | 1 | 783 | 461 | 461 | 186 | 135 | 0 | 119 | 35 | 83 | 48 | 35 | 425 | 783 | 0 | 3 | 134 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 184 | 2,228 | 184 | 176 | 0 | 4 | 63 | 1,540,000 | 34.61 | 
| app_proof | 1 | 91 | 1,600 | 91 | 41 | 0 | 2 | 138 | 1,039,903 | 36.56 | 

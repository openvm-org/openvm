...
| `total_proof_time_ms ` |  1,936 |  3,872 |  2,252 |  1,620 |
| `execute_metered_time_ms` |  34 | -          | -          | -          |
| `execute_metered_insns` |  2,579,903 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  74.26 | -          |  74.26 |  74.26 |
| `execute_preflight_insns` |  1,289,951.50 |  2,579,903 |  1,540,000 |  1,039,903 |
| `execute_preflight_time_ms` |  102 |  204 |  138 |  66 |
| `execute_preflight_insn_mi/s` |  33.73 | -          |  34.40 |  33.07 |
| `trace_gen_time_ms   ` |  138.50 |  277 |  183 |  94 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,585 |  3,170 |  1,823 |  1,347 |
| `prover.main_trace_commit_time_ms` |  511.50 |  1,023 |  597 |  426 |
| `prover.rap_constraints_time_ms` |  943 |  1,886 |  1,091 |  795 |
| `prover.openings_time_ms` |  129 |  258 |  134 |  124 |
| `prover.rap_constraints.logup_gkr_time_ms` |  169 |  338 |  201 |  137 |
| `prover.rap_constraints.round0_time_ms` |  572 |  1,144 |  677 |  467 |
| `prover.rap_constraints.mle_rounds_time_ms` |  201 |  402 |  212 |  190 |
| `prover.openings.stacked_reduction_time_ms` |  94.50 |  189 |  103 |  86 |
| `prover.openings.stacked_reduction.round0_time_ms` |  49 |  98 |  50 |  48 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  44.50 |  89 |  52 |  37 |
...
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  831 |  831 |  831 |  831 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/e823766aa7d6aac1a6fce90c7137cee53fcab9d9/kitchen_sink-e823766aa7d6aac1a6fce90c7137cee53fcab9d9.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 74 | 9 |  |  | 0 |  | 379 | 9 |  |  |  |  |  |  | 
| app_proof |  |  |  |  |  | 1,620 |  |  | 34 | 2,579,903 | 74.26 | 0 | 3,913 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 19 | 282 | 19 | 6 | 1 | 2 | 2 | 2 | 
| internal_recursive.0 | 1 | 10 | 155 | 10 | 1 | 0 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 9 | 136 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 122 | 954 | 122 | 23 | 9 | 21 | 5 | 5 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,577,979 | 262 | 117 | 0 | 0 | 107 | 35 | 34 | 51 | 20 | 0 | 37 | 23 | 13 | 3 | 9 | 117 | 107 | 0 | 2 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,767 | 145 | 46 | 0 | 0 | 67 | 24 | 24 | 28 | 13 | 0 | 30 | 21 | 8 | 1 | 6 | 47 | 67 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 127 | 31 | 0 | 0 | 64 | 25 | 24 | 24 | 14 | 0 | 31 | 24 | 7 | 1 | 5 | 31 | 63 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 265,003,892 | 831 | 400 | 0 | 1 | 351 | 135 | 134 | 77 | 138 | 0 | 78 | 38 | 40 | 21 | 18 | 401 | 351 | 0 | 6 | 137 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 567,917,156 | 1,823 | 597 | 0 | 189 | 1,091 | 677 | 676 | 212 | 201 | 57 | 134 | 30 | 103 | 50 | 52 | 597 | 1,091 | 0 | 3 | 141 | 0 | 0 | 
| app_proof | prover | 1 | 537,266,124 | 1,347 | 426 | 0 | 1 | 795 | 467 | 467 | 190 | 137 | 0 | 124 | 38 | 86 | 48 | 37 | 426 | 795 | 0 | 4 | 136 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 183 | 2,252 | 183 | 179 | 0 | 4 | 66 | 1,540,000 | 33.07 | 
| app_proof | 1 | 94 | 1,620 | 94 | 41 | 0 | 2 | 138 | 1,039,903 | 34.40 | 

...
|:---|---:|---:|---:|
| Total | <span style='color: green'>(-3 [-35.3%])</span> 6.07 | <span style='color: green'>(-2 [-45.9%])</span> 2.23 | <span style='color: green'>(-2 [-45.9%])</span> 2.23 |
| app_proof |  4.11 |  0.75 |  0.75 |
| leaf | <span style='color: green'>(-3 [-74.0%])</span> 1.17 | <span style='color: green'>(-2 [-73.5%])</span> 0.68 | <span style='color: green'>(-2 [-73.5%])</span> 0.68 |
...
| `total_proof_time_ms ` |  577 |  4,039 |  682 |  558 |
| `execute_metered_time_ms` |  68 | -          | -          | -          |
| `execute_metered_insns` |  12,000,265 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  175 | -          |  175 |  175 |
| `execute_preflight_insns` |  1,714,323.57 |  12,000,265 |  1,747,000 |  1,518,265 |
| `execute_preflight_time_ms` |  49.71 |  348 |  55 |  43 |
| `execute_preflight_insn_mi/s` |  49.99 | -          |  50.37 |  48.30 |
| `trace_gen_time_ms   ` |  171.14 |  1,198 |  177 |  168 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  297 |  2,079 |  300 |  295 |
| `prover.main_trace_commit_time_ms` |  60 |  420 |  60 |  60 |
| `prover.rap_constraints_time_ms` |  170 |  1,190 |  172 |  168 |
| `prover.openings_time_ms` |  66.14 |  463 |  68 |  65 |
| `prover.rap_constraints.logup_gkr_time_ms` |  118.71 |  831 |  120 |  116 |
| `prover.rap_constraints.round0_time_ms` |  32.86 |  230 |  37 |  32 |
...
| `prover.openings.whir_time_ms` |  54 |  378 |  56 |  53 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: green'>(-1659 [-74.0%])</span> 584 | <span style='color: green'>(-3318 [-74.0%])</span> 1,168 | <span style='color: green'>(-1888 [-73.5%])</span> 679 | <span style='color: green'>(-1430 [-74.5%])</span> 489 |
...
| `trace_gen_time_ms   ` | <span style='color: green'>(-42 [-44.6%])</span> 51.50 | <span style='color: green'>(-83 [-44.6%])</span> 103 | <span style='color: green'>(-34 [-35.4%])</span> 62 | <span style='color: green'>(-49 [-54.4%])</span> 41 |
| `generate_blob_total_time_ms` |  2.50 |  5 |  3 |  2 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` | <span style='color: green'>(-763 [-58.9%])</span> 532 | <span style='color: green'>(-1526 [-58.9%])</span> 1,064 | <span style='color: green'>(-875 [-58.7%])</span> 616 | <span style='color: green'>(-651 [-59.2%])</span> 448 |
| `prover.main_trace_commit_time_ms` |  197.50 |  395 |  235 |  160 |
| `prover.rap_constraints_time_ms` |  167 |  334 |  186 |  148 |
| `prover.openings_time_ms` |  166.50 |  333 |  194 |  139 |
...
| `prover.openings.whir_time_ms` |  145.50 |  291 |  170 |  121 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/a3c4230087d6f7bcf23228398bca034cc58250da/fibonacci-a3c4230087d6f7bcf23228398bca034cc58250da.memory.svg)
...
| app_proof |  |  |  |  |  | 559 |  |  | 68 | 12,000,265 | 175 | 0 | 4,116 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 28 | 469 | 28 | 9 | 1 | 2 | 1 | 1 | 
| internal_recursive.0 | 1 | 12 | 179 | 12 | 1 | 0 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 10 | 150 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 62 | 679 | 61 | 25 | 3 | 1 | 1 | 1 | 
| leaf | 1 | 41 | 489 | 40 | 18 | 2 | 1 | 1 | 1 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 53,005,300 |
...
|:---|---:|---:|---:|
| Total |  12.27 |  3.54 |  3.54 |
| app_proof |  10.06 |  1.82 |  1.82 |
| leaf |  1.46 |  0.97 |  0.97 |
...
| `total_proof_time_ms ` |  1,654 |  9,924 |  1,684 |  1,605 |
...
| `execute_preflight_time_ms` |  128 |  768 |  171 |  87 |
| `execute_preflight_insn_mi/s` |  37.71 | -          |  39.38 |  32.29 |
| `trace_gen_time_ms   ` |  154.67 |  928 |  191 |  120 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,232.83 |  7,397 |  1,258 |  1,194 |
| `prover.main_trace_commit_time_ms` |  283.50 |  1,701 |  285 |  282 |
| `prover.rap_constraints_time_ms` |  864.50 |  5,187 |  889 |  825 |
| `prover.openings_time_ms` |  83.67 |  502 |  86 |  79 |
| `prover.rap_constraints.logup_gkr_time_ms` |  290.67 |  1,744 |  309 |  239 |
| `prover.rap_constraints.round0_time_ms` |  437.83 |  2,627 |  452 |  381 |
| `prover.rap_constraints.mle_rounds_time_ms` |  134.67 |  808 |  136 |  131 |
| `prover.openings.stacked_reduction_time_ms` |  53.50 |  321 |  54 |  53 |
| `prover.openings.stacked_reduction.round0_time_ms` |  31.33 |  188 |  32 |  31 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  21.50 |  129 |  22 |  21 |
| `prover.openings.whir_time_ms` |  29.83 |  179 |  32 |  26 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  728 |  1,456 |  969 |  487 |
| `execute_preflight_time_ms` |  2 |  4 |  2 |  2 |
| `trace_gen_time_ms   ` |  74.50 |  149 |  101 |  48 |
| `generate_blob_total_time_ms` |  9.50 |  19 |  13 |  6 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  652.50 |  1,305 |  867 |  438 |
| `prover.main_trace_commit_time_ms` |  359 |  718 |  499 |  219 |
| `prover.rap_constraints_time_ms` |  225 |  450 |  284 |  166 |
| `prover.openings_time_ms` |  67 |  134 |  83 |  51 |
| `prover.rap_constraints.logup_gkr_time_ms` |  59.50 |  119 |  74 |  45 |
| `prover.rap_constraints.round0_time_ms` |  101.50 |  203 |  130 |  73 |
...
| `prover.openings.whir_time_ms` |  35.50 |  71 |  42 |  29 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/e823766aa7d6aac1a6fce90c7137cee53fcab9d9/sha2_bench-e823766aa7d6aac1a6fce90c7137cee53fcab9d9.memory.svg)
...
| app_proof |  |  |  |  |  | 1,655 |  |  | 137 | 14,793,960 | 107.31 | 0 | 10,070 |  | 
| internal_for_leaf |  |  |  | 458 |  |  |  |  |  |  |  |  |  | 458 | 
| internal_recursive.0 |  |  |  | 163 |  |  |  |  |  |  |  |  |  | 163 | 
| internal_recursive.1 |  |  |  | 134 |  |  |  |  |  |  |  |  |  | 135 | 
| leaf |  |  | 487 |  |  |  |  |  |  |  |  |  |  | 1,456 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 29 | 458 | 29 | 10 | 2 | 2 | 1 | 1 | 
| internal_recursive.0 | 1 | 12 | 163 | 12 | 2 | 0 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 9 | 134 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 101 | 969 | 100 | 36 | 13 | 2 | 3 | 3 | 
| leaf | 1 | 48 | 487 | 48 | 18 | 6 | 2 | 3 | 3 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 75,647,988 | 428 | 224 | 0 | 1 | 163 | 45 | 44 | 87 | 30 | 0 | 40 | 18 | 22 | 7 | 15 | 224 | 163 | 0 | 2 | 29 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,943 | 151 | 48 | 0 | 0 | 72 | 25 | 24 | 29 | 17 | 0 | 29 | 21 | 8 | 1 | 6 | 49 | 72 | 0 | 2 | 16 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 125 | 31 | 0 | 0 | 61 | 23 | 22 | 24 | 13 | 0 | 31 | 24 | 7 | 1 | 5 | 31 | 61 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 266,554,214 | 867 | 499 | 0 | 95 | 284 | 130 | 129 | 79 | 74 | 0 | 83 | 42 | 40 | 22 | 18 | 499 | 284 | 0 | 6 | 72 | 0 | 0 | 
| leaf | 1 | prover | 135,243,508 | 438 | 219 | 0 | 1 | 166 | 73 | 72 | 48 | 45 | 0 | 51 | 29 | 22 | 11 | 11 | 219 | 166 | 0 | 5 | 44 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 353,899,717 | 1,196 | 283 | 0 | 1 | 825 | 381 | 381 | 134 | 309 | 77 | 86 | 32 | 54 | 31 | 22 | 283 | 825 | 0 | 3 | 230 | 0 | 0 | 
| app_proof | prover | 1 | 353,899,532 | 1,254 | 283 | 0 | 1 | 884 | 450 | 450 | 135 | 298 | 77 | 85 | 31 | 53 | 31 | 22 | 283 | 884 | 0 | 4 | 220 | 0 | 0 | 
| app_proof | prover | 2 | 353,899,532 | 1,258 | 282 | 0 | 1 | 889 | 452 | 452 | 136 | 299 | 76 | 86 | 32 | 54 | 31 | 22 | 282 | 889 | 0 | 4 | 222 | 0 | 0 | 
| app_proof | prover | 3 | 353,899,532 | 1,194 | 284 | 0 | 1 | 827 | 451 | 450 | 136 | 239 | 0 | 82 | 28 | 53 | 32 | 21 | 284 | 827 | 0 | 3 | 238 | 0 | 0 | 
| app_proof | prover | 4 | 353,899,532 | 1,257 | 284 | 0 | 1 | 888 | 450 | 449 | 136 | 301 | 78 | 84 | 30 | 54 | 32 | 21 | 284 | 888 | 0 | 3 | 222 | 0 | 0 | 
| app_proof | prover | 5 | 353,980,012 | 1,238 | 284 | 0 | 1 | 874 | 443 | 443 | 131 | 298 | 76 | 79 | 26 | 53 | 31 | 21 | 285 | 874 | 0 | 3 | 221 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 159 | 1,605 | 159 | 161 | 0 | 4 | 87 | 2,623,000 | 37.15 | 
| app_proof | 1 | 120 | 1,684 | 120 | 138 | 0 | 2 | 171 | 2,625,000 | 32.29 | 
| app_proof | 2 | 153 | 1,682 | 153 | 130 | 0 | 2 | 140 | 2,625,000 | 38.97 | 
| app_proof | 3 | 153 | 1,618 | 153 | 131 | 0 | 2 | 139 | 2,625,000 | 39.38 | 
| app_proof | 4 | 152 | 1,680 | 152 | 131 | 0 | 2 | 139 | 2,625,000 | 39.28 | 
| app_proof | 5 | 191 | 1,655 | 191 | 132 | 0 | 2 | 92 | 1,670,960 | 39.21 | 

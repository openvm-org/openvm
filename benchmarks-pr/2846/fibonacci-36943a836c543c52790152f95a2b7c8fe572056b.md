...
|:---|---:|---:|---:|
| Total | <span style='color: green'>(-4 [-46.2%])</span> 4.45 | <span style='color: green'>(-2 [-44.9%])</span> 2.32 | <span style='color: green'>(-2 [-44.9%])</span> 2.32 |
...
| `total_proof_time_ms ` |  757.75 |  3,031 |  907 |  546 |
| `execute_metered_time_ms` |  67 | -          | -          | -          |
| `execute_metered_insns` |  12,000,265 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  178.18 | -          |  178.18 |  178.18 |
| `execute_preflight_insns` |  3,000,066.25 |  12,000,265 |  3,495,000 |  1,515,265 |
| `execute_preflight_time_ms` |  84.50 |  338 |  106 |  43 |
| `execute_preflight_insn_mi/s` |  48.78 | -          |  50.14 |  46.36 |
| `trace_gen_time_ms   ` |  136.75 |  547 |  171 |  118 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  466.25 |  1,865 |  529 |  290 |
| `prover.main_trace_commit_time_ms` |  97.75 |  391 |  111 |  58 |
| `prover.rap_constraints_time_ms` |  267 |  1,068 |  303 |  165 |
| `prover.openings_time_ms` |  100 |  400 |  116 |  65 |
| `prover.rap_constraints.logup_gkr_time_ms` |  192 |  768 |  219 |  115 |
| `prover.rap_constraints.round0_time_ms` |  50 |  200 |  57 |  32 |
...
| `prover.openings.whir_time_ms` |  81.25 |  325 |  95 |  53 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/36943a836c543c52790152f95a2b7c8fe572056b/fibonacci-36943a836c543c52790152f95a2b7c8fe572056b.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 66 |  |  |  | 336 |  |  |  |  |  |  | 
| app_proof |  |  |  | 546 |  | 67 | 12,000,265 | 178.18 | 0 | 3,105 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 327 | 116 | 0 | 0 | 107 | 34 | 34 | 50 | 21 | 0 | 103 | 89 | 13 | 3 | 9 | 116 | 116 | 107 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 167 | 45 | 0 | 0 | 66 | 24 | 24 | 28 | 13 | 0 | 54 | 45 | 8 | 1 | 6 | 46 | 46 | 66 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 139 | 32 | 0 | 0 | 63 | 23 | 22 | 24 | 15 | 0 | 43 | 35 | 7 | 1 | 5 | 33 | 32 | 63 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 147,934,254 | 607 | 232 | 0 | 0 | 183 | 83 | 82 | 53 | 46 | 0 | 191 | 166 | 24 | 12 | 12 | 232 | 232 | 183 | 0 | 8 | 44 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 136,618,054 | 529 | 111 | 0 | 0 | 300 | 57 | 57 | 27 | 216 | 0 | 116 | 95 | 21 | 11 | 9 | 111 | 111 | 300 | 0 | 3 | 214 | 0 | 0 | 
| app_proof | prover | 1 | 136,570,716 | 522 | 111 | 0 | 0 | 300 | 54 | 54 | 27 | 218 | 0 | 110 | 89 | 20 | 12 | 8 | 111 | 111 | 300 | 0 | 3 | 218 | 0 | 0 | 
| app_proof | prover | 2 | 136,570,716 | 524 | 111 | 0 | 0 | 303 | 57 | 56 | 26 | 219 | 0 | 109 | 88 | 21 | 12 | 9 | 111 | 111 | 303 | 0 | 3 | 219 | 0 | 0 | 
| app_proof | prover | 3 | 70,295,004 | 290 | 58 | 0 | 0 | 165 | 32 | 32 | 17 | 115 | 0 | 65 | 53 | 12 | 6 | 5 | 58 | 58 | 165 | 0 | 3 | 114 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 153 | 134 | 907 | 134 | 153 | 2,770,197,065 | 323,292,691 | 3,093,489,756 | 2,097,152 | 0 | 3 | 90 | 3,495,000 | 46.36 | 
| app_proof | 1 | 41 | 118 | 788 | 118 | 41 | 2,768,862,357 | 322,353,414 | 3,091,215,771 | 2,097,152 | 0 | 1 | 106 | 3,495,000 | 48.73 | 
| app_proof | 2 | 41 | 124 | 790 | 124 | 41 | 2,768,862,357 | 322,353,414 | 3,091,215,771 | 2,097,152 | 0 | 1 | 99 | 3,495,000 | 49.89 | 
| app_proof | 3 | 41 | 171 | 546 | 171 | 41 | 1,230,956,171 | 342,871,578 | 1,573,827,749 | 2,097,152 | 0 | 2 | 43 | 1,515,265 | 50.14 | 

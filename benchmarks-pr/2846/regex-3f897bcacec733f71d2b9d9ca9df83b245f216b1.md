...
|:---|---:|---:|---:|
| Total | <span style='color: green'>(-12 [-81.9%])</span> 2.55 | <span style='color: green'>(-4 [-68.2%])</span> 1.86 | <span style='color: green'>(-4 [-68.2%])</span> 1.86 |
| app_proof |  1.53 |  0.84 |  0.84 |
| leaf | <span style='color: green'>(-12 [-96.4%])</span> 0.43 | <span style='color: green'>(-4 [-90.4%])</span> 0.43 | <span style='color: green'>(-4 [-90.4%])</span> 0.43 |
...
| `total_proof_time_ms ` |  746.50 |  1,493 |  807 |  686 |
...
| `execute_preflight_time_ms` |  75.50 |  151 |  80 |  71 |
| `execute_preflight_insn_mi/s` |  38.74 | -          |  38.79 |  38.70 |
| `trace_gen_time_ms   ` |  144.50 |  289 |  146 |  143 |
| `memory_finalize_time_ms` |  1 |  2 |  2 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  424.50 |  849 |  427 |  422 |
| `prover.main_trace_commit_time_ms` |  93.50 |  187 |  99 |  88 |
| `prover.rap_constraints_time_ms` |  233.50 |  467 |  245 |  222 |
| `prover.openings_time_ms` |  96.50 |  193 |  101 |  92 |
| `prover.rap_constraints.logup_gkr_time_ms` |  137 |  274 |  139 |  135 |
| `prover.rap_constraints.round0_time_ms` |  69 |  138 |  84 |  54 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: green'>(-2573 [-85.8%])</span> 426 | <span style='color: green'>(-11571 [-96.4%])</span> 426 | <span style='color: green'>(-4002 [-90.4%])</span> 426 | <span style='color: green'>(-1570 [-78.7%])</span> 426 |
...
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` | <span style='color: green'>(-1447 [-79.3%])</span> 377 | <span style='color: green'>(-6918 [-94.8%])</span> 377 | <span style='color: green'>(-2542 [-87.1%])</span> 377 | <span style='color: green'>(-964 [-71.9%])</span> 377 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/3f897bcacec733f71d2b9d9ca9df83b245f216b1/regex-3f897bcacec733f71d2b9d9ca9df83b245f216b1.memory.svg)
...
| app_proof |  |  |  |  |  | 686 |  |  | 33 | 4,137,067 | 124.83 | 0 | 1,540 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 27,256,635 | 258 | 81 | 0 | 0 | 96 | 31 | 30 | 45 | 19 | 0 | 80 | 69 | 11 | 2 | 8 | 81 | 96 | 0 | 3 | 18 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,767 | 168 | 46 | 0 | 0 | 66 | 25 | 24 | 27 | 13 | 0 | 54 | 46 | 8 | 1 | 6 | 47 | 66 | 0 | 2 | 12 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 136 | 31 | 0 | 0 | 61 | 23 | 22 | 24 | 13 | 0 | 43 | 36 | 7 | 1 | 5 | 31 | 61 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 79,959,796 | 377 | 126 | 0 | 0 | 132 | 53 | 52 | 37 | 41 | 0 | 117 | 102 | 15 | 6 | 8 | 127 | 132 | 0 | 6 | 40 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 123,384,338 | 422 | 98 | 0 | 0 | 222 | 54 | 53 | 28 | 139 | 0 | 101 | 81 | 19 | 10 | 9 | 99 | 222 | 0 | 3 | 136 | 0 | 0 | 
| app_proof | prover | 1 | 106,568,591 | 427 | 88 | 0 | 0 | 245 | 84 | 83 | 25 | 135 | 0 | 92 | 74 | 18 | 8 | 9 | 88 | 245 | 0 | 3 | 134 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 143 | 807 | 143 | 160 | 2,052,973,566 | 668,936,290 | 2,721,909,856 | 2,097,152 | 2 | 7 | 80 | 2,208,000 | 38.70 | 
| app_proof | 1 | 146 | 686 | 146 | 41 | 1,584,899,101 | 646,500,736 | 2,231,399,837 | 2,097,152 | 0 | 2 | 71 | 1,929,067 | 38.79 | 

...
|:---|---:|---:|---:|
| Total | <span style='color: green'>(-3 [-35.9%])</span> 5.95 | <span style='color: green'>(-2 [-46.5%])</span> 2.19 | <span style='color: green'>(-2 [-46.5%])</span> 2.19 |
| app_proof |  4.02 |  0.74 |  0.74 |
| leaf | <span style='color: green'>(-3 [-74.4%])</span> 1.15 | <span style='color: green'>(-2 [-74.1%])</span> 0.66 | <span style='color: green'>(-2 [-74.1%])</span> 0.66 |
...
| `total_proof_time_ms ` |  564 |  3,948 |  670 |  543 |
| `execute_metered_time_ms` |  69 | -          | -          | -          |
| `execute_metered_insns` |  12,000,265 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  173.55 | -          |  173.55 |  173.55 |
| `execute_preflight_insns` |  1,714,323.57 |  12,000,265 |  1,747,000 |  1,518,265 |
| `execute_preflight_time_ms` |  49.86 |  349 |  54 |  43 |
| `execute_preflight_insn_mi/s` |  50.08 | -          |  50.60 |  49.36 |
| `trace_gen_time_ms   ` |  164.86 |  1,154 |  170 |  163 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  290.14 |  2,031 |  293 |  287 |
| `prover.main_trace_commit_time_ms` |  58.43 |  409 |  59 |  58 |
| `prover.rap_constraints_time_ms` |  165 |  1,155 |  168 |  164 |
| `prover.openings_time_ms` |  65.57 |  459 |  68 |  64 |
| `prover.rap_constraints.logup_gkr_time_ms` |  115.29 |  807 |  117 |  114 |
| `prover.rap_constraints.round0_time_ms` |  31.86 |  223 |  35 |  30 |
...
| `prover.openings.whir_time_ms` |  53.57 |  375 |  56 |  52 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: green'>(-1669 [-74.4%])</span> 574 | <span style='color: green'>(-3338 [-74.4%])</span> 1,148 | <span style='color: green'>(-1903 [-74.1%])</span> 664 | <span style='color: green'>(-1435 [-74.8%])</span> 484 |
...
| `trace_gen_time_ms   ` | <span style='color: green'>(-44 [-47.3%])</span> 49 | <span style='color: green'>(-88 [-47.3%])</span> 98 | <span style='color: green'>(-36 [-37.5%])</span> 60 | <span style='color: green'>(-52 [-57.8%])</span> 38 |
| `generate_blob_total_time_ms` |  2.50 |  5 |  3 |  2 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` | <span style='color: green'>(-770 [-59.5%])</span> 524.50 | <span style='color: green'>(-1541 [-59.5%])</span> 1,049 | <span style='color: green'>(-888 [-59.6%])</span> 603 | <span style='color: green'>(-653 [-59.4%])</span> 446 |
| `prover.main_trace_commit_time_ms` |  194 |  388 |  231 |  157 |
| `prover.rap_constraints_time_ms` |  163.50 |  327 |  181 |  146 |
| `prover.openings_time_ms` |  165.50 |  331 |  190 |  141 |
| `prover.rap_constraints.logup_gkr_time_ms` |  38 |  76 |  44 |  32 |
| `prover.rap_constraints.round0_time_ms` |  76 |  152 |  84 |  68 |
...
| `prover.openings.whir_time_ms` |  145 |  290 |  166 |  124 |
...
| `prover.openings_time_ms` |  128 |  128 |  128 |  128 |
...
| `prover.openings.whir_time_ms` |  110 |  110 |  110 |  110 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/750c383cbb28063aa31b4c589af88ffc25f0ae2f/fibonacci-750c383cbb28063aa31b4c589af88ffc25f0ae2f.memory.svg)
...
| app_proof |  |  |  |  |  | 545 |  |  | 69 | 12,000,265 | 173.55 | 0 | 4,027 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 |
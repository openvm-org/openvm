...
|:---|---:|---:|---:|
| Total | <span style='color: green'>(-4 [-45.8%])</span> 4.50 | <span style='color: green'>(-2 [-44.6%])</span> 2.34 | <span style='color: green'>(-2 [-44.6%])</span> 2.34 |
| app_proof |  3.15 |  0.99 |  0.99 |
| leaf | <span style='color: green'>(-4 [-84.9%])</span> 0.68 | <span style='color: green'>(-2 [-73.5%])</span> 0.68 | <span style='color: green'>(-2 [-73.5%])</span> 0.68 |
...
| `total_proof_time_ms ` |  771.50 |  3,086 |  924 |  556 |
...
| `execute_preflight_time_ms` |  83.25 |  333 |  102 |  44 |
| `execute_preflight_insn_mi/s` |  49.25 | -          |  50.79 |  46.70 |
| `trace_gen_time_ms   ` |  143 |  572 |  175 |  126 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  475 |  1,900 |  540 |  295 |
| `prover.main_trace_commit_time_ms` |  98.75 |  395 |  112 |  60 |
| `prover.rap_constraints_time_ms` |  274.50 |  1,098 |  311 |  170 |
| `prover.openings_time_ms` |  101 |  404 |  117 |  65 |
| `prover.rap_constraints.logup_gkr_time_ms` |  197 |  788 |  224 |  118 |
| `prover.rap_constraints.round0_time_ms` |  51.75 |  207 |  60 |  33 |
| `prover.rap_constraints.mle_rounds_time_ms` |  24.50 |  98 |  27 |  17 |
...
| `prover.openings.whir_time_ms` |  82 |  328 |  96 |  53 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: green'>(-1564 [-69.7%])</span> 679 | <span style='color: green'>(-3807 [-84.9%])</span> 679 | <span style='color: green'>(-1888 [-73.5%])</span> 679 | <span style='color: green'>(-1240 [-64.6%])</span> 679 |
...
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` | <span style='color: green'>(-682 [-52.7%])</span> 613 | <span style='color: green'>(-1977 [-76.3%])</span> 613 | <span style='color: green'>(-878 [-58.9%])</span> 613 | <span style='color: green'>(-486 [-44.2%])</span> 613 |
| `prover.main_trace_commit_time_ms` |  235 |  235 |  235 |  235 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/191cfb8de2e6cee00f440f6490082f62ac3099bf/fibonacci-191cfb8de2e6cee00f440f6490082f62ac3099bf.memory.svg)
...
| app_proof |  |  |  |  |  | 556 |  |  | 66 | 12,000,265 | 180.02 | 0 | 3,159 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,747 | 325 | 118 | 0 | 0 | 107 | 35 | 34 | 51 | 20 | 0 | 99 | 85 | 13 | 3 | 9 | 118 | 107 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,767 | 169 | 46 | 0 | 0 | 67 | 25 | 24 | 28 | 14 | 0 | 54 | 45 | 8 | 1 | 6 | 47 | 67 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 140 | 33 | 0 | 0 | 62 | 23 | 22 | 24 | 13 | 0 | 44 | 37 | 7 | 1 | 5 | 33 | 62 | 0 | 2 | 13 | 0 | 0 | 
| leaf | 0 | prover | 147,934,246 | 613 | 235 | 0 | 0 | 183 | 84 | 83 | 53 | 45 | 0 | 193 | 168 | 24 | 12 | 12 | 235 | 183 | 0 | 8 | 44 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 136,618,054 | 540 | 111 | 0 | 0 | 311 | 60 | 59 | 27 | 223 | 0 | 117 | 96 | 21 | 11 | 9 | 111 | 311 | 0 | 3 | 222 | 0 | 0 | 
| app_proof | prover | 1 | 136,570,716 | 534 | 112 | 0 | 0 | 308 | 57 | 57 | 27 | 223 | 0 | 113 | 91 | 21 | 12 | 9 | 112 | 308 | 0 | 3 | 222 | 0 | 0 | 
| app_proof | prover | 2 | 136,570,716 | 531 | 112 | 0 | 0 | 309 | 57 | 56 | 27 | 224 | 0 | 109 | 88 | 21 | 12 | 9 | 112 | 309 | 0 | 3 | 224 | 0 | 0 | 
| app_proof | prover | 3 | 70,295,004 | 295 | 59 | 0 | 0 | 170 | 33 | 33 | 17 | 118 | 0 | 65 | 53 | 12 | 6 | 6 | 60 | 170 | 0 | 3 | 117 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 139 | 924 | 139 | 153 | 2,770,197,065 | 323,292,691 | 3,093,489,756 | 2,097,152 | 0 | 3 | 90 | 3,495,000 | 46.70 | 
| app_proof | 1 | 126 | 804 | 126 | 41 | 2,768,862,357 | 322,353,414 | 3,091,215,771 | 2,097,152 | 0 | 1 | 102 | 3,495,000 | 50.79 | 
| app_proof | 2 | 132 | 802 | 132 | 41 | 2,768,862,357 | 322,353,414 | 3,091,215,771 | 2,097,152 | 0 | 1 | 97 | 3,495,000 | 50.69 | 
| app_proof | 3 | 175 | 556 | 175 | 41 | 1,230,956,171 | 342,871,578 | 1,573,827,749 | 2,097,152 | 0 | 2 | 44 | 1,515,265 | 48.81 | 

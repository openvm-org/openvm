...
|:---|---:|---:|---:|
| Total |  5.34 |  3.76 |  3.76 |
| app_proof |  3.84 |  2.26 |  2.26 |
| leaf |  0.94 |  0.94 |  0.94 |
...
| `total_proof_time_ms ` |  1,902 |  3,804 |  2,220 |  1,584 |
...
| `execute_preflight_insn_mi/s` |  35.76 | -          |  36.72 |  34.80 |
| `trace_gen_time_ms   ` |  135 |  270 |  180 |  90 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,556.50 |  3,113 |  1,798 |  1,315 |
| `prover.main_trace_commit_time_ms` |  508.50 |  1,017 |  592 |  425 |
| `prover.rap_constraints_time_ms` |  922 |  1,844 |  1,071 |  773 |
| `prover.openings_time_ms` |  125 |  250 |  133 |  117 |
| `prover.rap_constraints.logup_gkr_time_ms` |  166.50 |  333 |  197 |  136 |
| `prover.rap_constraints.round0_time_ms` |  557 |  1,114 |  664 |  450 |
| `prover.rap_constraints.mle_rounds_time_ms` |  197 |  394 |  208 |  186 |
| `prover.openings.stacked_reduction_time_ms` |  91 |  182 |  99 |  83 |
| `prover.openings.stacked_reduction.round0_time_ms` |  48 |  96 |  49 |  47 |
...
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  815 |  815 |  815 |  815 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/6b3e714e0a4a3091f20ba3a47d8fb53c9b60093d/kitchen_sink-6b3e714e0a4a3091f20ba3a47d8fb53c9b60093d.memory.svg)
...
| app_proof |  |  |  |  |  | 1,584 |  |  | 36 | 2,579,903 | 70.72 | 0 | 3,846 |  | 
...
| internal_recursive.0 | 1 | 10 | 154 | 10 | 1 | 0 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 9 | 129 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 120 | 936 | 120 | 23 | 9 | 20 | 5 | 5 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,577,979 | 262 | 115 | 0 | 0 | 107 | 35 | 34 | 51 | 20 | 0 | 39 | 25 | 13 | 3 | 9 | 115 | 107 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,767 | 143 | 44 | 0 | 0 | 64 | 22 | 21 | 28 | 13 | 0 | 34 | 25 | 8 | 1 | 6 | 44 | 64 | 0 | 2 | 12 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 120 | 31 | 0 | 0 | 62 | 23 | 23 | 24 | 14 | 0 | 25 | 18 | 7 | 1 | 5 | 32 | 62 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 265,003,892 | 815 | 397 | 0 | 1 | 344 | 131 | 130 | 76 | 135 | 0 | 72 | 32 | 40 | 21 | 18 | 398 | 344 | 0 | 6 | 134 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 567,917,156 | 1,798 | 592 | 0 | 187 | 1,071 | 664 | 663 | 208 | 197 | 56 | 133 | 34 | 99 | 49 | 49 | 592 | 1,071 | 0 | 3 | 140 | 0 | 0 | 
| app_proof | prover | 1 | 537,266,124 | 1,315 | 425 | 0 | 2 | 773 | 450 | 450 | 186 | 136 | 0 | 117 | 33 | 83 | 47 | 35 | 425 | 773 | 0 | 3 | 135 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 180 | 2,220 | 180 | 178 | 9,069,025,194 | 1,018,123,350 | 10,087,148,544 | 2,097,152 | 2,097,152 | 0 | 4 | 63 | 1,540,000 | 34.80 | 
| app_proof | 1 | 90 | 1,584 | 90 | 41 | 6,675,792,954 | 2,876,399,838 | 9,552,192,792 | 2,097,152 | 2,097,152 | 0 | 2 | 136 | 1,039,903 | 36.72 | 

...
|:---|---:|---:|---:|
| Total | <span style='color: green'>(-3 [-35.7%])</span> 5.100 | <span style='color: green'>(-2 [-46.3%])</span> 2.20 | <span style='color: green'>(-2 [-46.3%])</span> 2.20 |
| app_proof |  4.05 |  0.73 |  0.73 |
| leaf | <span style='color: green'>(-3 [-74.3%])</span> 1.16 | <span style='color: green'>(-2 [-73.8%])</span> 0.67 | <span style='color: green'>(-2 [-73.8%])</span> 0.67 |
...
| `total_proof_time_ms ` |  568.57 |  3,980 |  666 |  549 |
| `execute_metered_time_ms` |  67 | -          | -          | -          |
| `execute_metered_insns` |  12,000,265 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  177.27 | -          |  177.27 |  177.27 |
| `execute_preflight_insns` |  1,714,323.57 |  12,000,265 |  1,747,000 |  1,518,265 |
| `execute_preflight_time_ms` |  48.57 |  340 |  53 |  43 |
| `execute_preflight_insn_mi/s` |  50.61 | -          |  51.05 |  50.01 |
| `trace_gen_time_ms   ` |  169.14 |  1,184 |  174 |  167 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  292.71 |  2,049 |  296 |  291 |
| `prover.main_trace_commit_time_ms` |  59 |  413 |  59 |  59 |
| `prover.rap_constraints_time_ms` |  166.29 |  1,164 |  168 |  165 |
| `prover.openings_time_ms` |  66.14 |  463 |  69 |  65 |
| `prover.rap_constraints.logup_gkr_time_ms` |  116.43 |  815 |  118 |  115 |
| `prover.rap_constraints.round0_time_ms` |  31.86 |  223 |  33 |  31 |
...
| `prover.openings.whir_time_ms` |  53.71 |  376 |  57 |  52 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: green'>(-1666 [-74.3%])</span> 577.50 | <span style='color: green'>(-3331 [-74.3%])</span> 1,155 | <span style='color: green'>(-1895 [-73.8%])</span> 672 | <span style='color: green'>(-1436 [-74.8%])</span> 483 |
...
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` | <span style='color: green'>(-766 [-59.2%])</span> 529 | <span style='color: green'>(-1532 [-59.2%])</span> 1,058 | <span style='color: green'>(-878 [-58.9%])</span> 613 | <span style='color: green'>(-654 [-59.5%])</span> 445 |
...
| `prover.rap_constraints.round0_time_ms` |  77 |  154 |  86 |  68 |
...
| `prover.openings.whir_time_ms` |  145 |  290 |  170 |  120 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/a35d1304f65035c9606d1d2065145a46deb3d914/fibonacci-a35d1304f65035c9606d1d2065145a46deb3d914.memory.svg)
...
| app_proof |  |  |  |  |  | 553 |  |  | 67 | 12,000,265 | 177.27 | 0 | 4,057 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 53,005,300 | 436 | 160 | 0 | 0 | 146 | 43 | 42 | 74 | 29 | 0 | 129 | 111 | 17 | 5 | 12 | 160 | 146 | 0 | 3 | 28 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,767 | 168 | 46 | 0 | 0 | 67 | 25 | 24 | 28 | 13 | 0 | 54 | 45 | 8 | 1 | 6 | 47 | 67 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 137 | 32 | 0 | 0 | 61 | 22 | 22 | 24 | 14 | 0 | 43 | 35 | 7 | 1 | 5 | 33 | 61 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 147,934,246 | 613 | 232 | 0 | 0 | 184 | 86 | 85 | 52 | 45 | 0 | 195 | 170 | 24 | 12 | 12 | 233 | 184 | 0 | 8 | 44 | 0 | 0 | 
| leaf | 1 | prover | 98,728,630 | 445 | 158 | 0 | 0 | 147 | 68 | 67 | 44 | 33 | 0 | 138 | 120 | 18 | 8 | 9 | 159 | 147 | 0 | 7 | 32 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 70,295,622 | 291 | 58 | 0 | 0 | 166 | 32 | 32 | 16 | 117 | 0 | 65 | 52 | 12 | 6 | 6 | 59 | 166 | 0 | 3 | 116 | 0 | 0 | 
| app_proof | prover | 1 | 70,248,284 | 292 | 59 | 0 | 0 | 166 | 31 | 30 | 17 | 117 | 0 | 66 | 54 | 12 | 6 | 5 | 59 | 166 | 0 | 3 | 117 | 0 | 0 | 
| app_proof | prover | 2 | 70,248,284 | 291 | 59 | 0 | 0 | 165 | 32 | 31 | 17 | 116 | 0 | 65 | 53 | 12 | 6 | 5 | 59 | 165 | 0 | 3 | 115 | 0 | 0 | 
| app_proof | prover | 3 | 70,248,284 | 292 | 59 | 0 | 0 | 166 | 31 | 31 | 17 | 116 | 0 | 66 | 54 | 12 | 6 | 5 | 59 | 166 | 0 | 3 | 115 | 0 | 0 | 
| app_proof | prover | 4 | 70,248,284 | 296 | 59 | 0 | 0 | 167 | 33 | 32 | 17 | 116 | 0 | 69 | 57 | 12 | 6 | 5 | 59 | 167 | 0 | 3 | 115 | 0 | 0 | 
| app_proof | prover | 5 | 70,248,284 | 293 | 59 | 0 | 0 | 166 | 32 | 32 | 17 | 115 | 0 | 67 | 54 | 12 | 6 | 5 | 59 | 166 | 0 | 3 | 115 | 0 | 0 | 
| app_proof | prover | 6 | 70,295,004 | 294 | 59 | 0 | 0 | 168 | 32 | 32 | 17 | 118 | 0 | 65 | 52 | 12 | 6 | 6 | 59 | 168 | 0 | 3 | 117 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 167 | 666 | 167 | 154 | 1,411,127,546 | 162,713,442 | 1,573,840,988 | 2,097,152 | 0 | 3 | 53 | 1,747,000 | 50.01 | 
| app_proof | 1 | 168 | 551 | 168 | 40 | 1,409,791,968 | 161,775,035 | 1,571,567,003 | 2,097,152 | 0 | 1 | 49 | 1,747,000 | 51.05 | 
| app_proof | 2 | 168 | 549 | 168 | 41 | 1,409,792,265 | 161,774,738 | 1,571,567,003 | 2,097,152 | 0 | 1 | 48 | 1,747,000 | 51.02 | 
| app_proof | 3 | 169 | 552 | 169 | 41 | 1,409,792,837 | 161,774,166 | 1,571,567,003 | 2,097,152 | 0 | 1 | 49 | 1,747,000 | 51.01 | 
| app_proof | 4 | 169 | 556 | 169 | 41 | 1,409,791,968 | 161,775,035 | 1,571,567,003 | 2,097,152 | 0 | 1 | 49 | 1,747,000 | 50.20 | 
| app_proof | 5 | 169 | 553 | 169 | 41 | 1,409,792,265 | 161,774,738 | 1,571,567,003 | 2,097,152 | 0 | 1 | 49 | 1,747,000 | 50.52 | 
| app_proof | 6 | 174 | 553 | 174 | 41 | 1,233,288,671 | 340,539,078 | 1,573,827,749 | 2,097,152 | 0 | 2 | 43 | 1,518,265 | 50.43 | 

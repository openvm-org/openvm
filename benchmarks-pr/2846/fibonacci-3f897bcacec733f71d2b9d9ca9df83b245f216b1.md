...
|:---|---:|---:|---:|
| Total | <span style='color: green'>(-3 [-35.8%])</span> 5.98 | <span style='color: green'>(-2 [-46.3%])</span> 2.20 | <span style='color: green'>(-2 [-46.3%])</span> 2.20 |
| app_proof |  4.04 |  0.74 |  0.74 |
| leaf | <span style='color: green'>(-3 [-74.5%])</span> 1.14 | <span style='color: green'>(-2 [-74.1%])</span> 0.67 | <span style='color: green'>(-2 [-74.1%])</span> 0.67 |
...
| `total_proof_time_ms ` |  568.14 |  3,977 |  672 |  548 |
| `execute_metered_time_ms` |  67 | -          | -          | -          |
| `execute_metered_insns` |  12,000,265 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  176.61 | -          |  176.61 |  176.61 |
| `execute_preflight_insns` |  1,714,323.57 |  12,000,265 |  1,747,000 |  1,518,265 |
| `execute_preflight_time_ms` |  49.29 |  345 |  54 |  43 |
| `execute_preflight_insn_mi/s` |  50.47 | -          |  50.76 |  49.99 |
| `trace_gen_time_ms   ` |  168 |  1,176 |  173 |  165 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  292.29 |  2,046 |  295 |  289 |
| `prover.main_trace_commit_time_ms` |  59 |  413 |  59 |  59 |
| `prover.rap_constraints_time_ms` |  165.86 |  1,161 |  168 |  163 |
| `prover.openings_time_ms` |  66.29 |  464 |  68 |  64 |
| `prover.rap_constraints.logup_gkr_time_ms` |  116 |  812 |  118 |  115 |
| `prover.rap_constraints.round0_time_ms` |  31.86 |  223 |  34 |  31 |
...
| `prover.openings.whir_time_ms` |  54 |  378 |  56 |  52 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: green'>(-1671 [-74.5%])</span> 572 | <span style='color: green'>(-3342 [-74.5%])</span> 1,144 | <span style='color: green'>(-1901 [-74.1%])</span> 666 | <span style='color: green'>(-1441 [-75.1%])</span> 478 |
...
| `trace_gen_time_ms   ` | <span style='color: green'>(-44 [-47.3%])</span> 49 | <span style='color: green'>(-88 [-47.3%])</span> 98 | <span style='color: green'>(-37 [-38.5%])</span> 59 | <span style='color: green'>(-51 [-56.7%])</span> 39 |
| `generate_blob_total_time_ms` |  2.50 |  5 |  3 |  2 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` | <span style='color: green'>(-772 [-59.7%])</span> 522.50 | <span style='color: green'>(-1545 [-59.7%])</span> 1,045 | <span style='color: green'>(-884 [-59.3%])</span> 607 | <span style='color: green'>(-661 [-60.1%])</span> 438 |
| `prover.main_trace_commit_time_ms` |  196 |  392 |  234 |  158 |
| `prover.rap_constraints_time_ms` |  163.50 |  327 |  183 |  144 |
| `prover.openings_time_ms` |  162.50 |  325 |  190 |  135 |
| `prover.rap_constraints.logup_gkr_time_ms` |  38 |  76 |  44 |  32 |
| `prover.rap_constraints.round0_time_ms` |  75.50 |  151 |  84 |  67 |
...
| `prover.openings.whir_time_ms` |  141 |  282 |  165 |  117 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/3f897bcacec733f71d2b9d9ca9df83b245f216b1/fibonacci-3f897bcacec733f71d2b9d9ca9df83b245f216b1.memory.svg)
...
| app_proof |  |  |  |  |  | 552 |  |  | 67 | 12,000,265 | 176.61 | 0 | 4,055 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 |
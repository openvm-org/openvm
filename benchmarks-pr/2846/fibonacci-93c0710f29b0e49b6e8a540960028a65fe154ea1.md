...
|:---|---:|---:|---:|
| Total | <span style='color: green'>(-3 [-35.7%])</span> 6.01 | <span style='color: green'>(-2 [-46.3%])</span> 2.21 | <span style='color: green'>(-2 [-46.3%])</span> 2.21 |
| app_proof |  4.07 |  0.75 |  0.75 |
| leaf | <span style='color: green'>(-3 [-74.4%])</span> 1.15 | <span style='color: green'>(-2 [-74.0%])</span> 0.67 | <span style='color: green'>(-2 [-74.0%])</span> 0.67 |
...
| `total_proof_time_ms ` |  571.57 |  4,001 |  680 |  548 |
| `execute_metered_time_ms` |  68 | -          | -          | -          |
| `execute_metered_insns` |  12,000,265 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  175.76 | -          |  175.76 |  175.76 |
| `execute_preflight_insns` |  1,714,323.57 |  12,000,265 |  1,747,000 |  1,518,265 |
| `execute_preflight_time_ms` |  50 |  350 |  55 |  43 |
| `execute_preflight_insn_mi/s` |  49.99 | -          |  50.33 |  49.61 |
| `trace_gen_time_ms   ` |  168.57 |  1,180 |  175 |  165 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  294 |  2,058 |  300 |  289 |
| `prover.main_trace_commit_time_ms` |  59.29 |  415 |  60 |  59 |
| `prover.rap_constraints_time_ms` |  167.29 |  1,171 |  172 |  165 |
| `prover.openings_time_ms` |  66.57 |  466 |  68 |  64 |
...
| `prover.openings.whir_time_ms` |  53.86 |  377 |  55 |  52 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: green'>(-1668 [-74.4%])</span> 575 | <span style='color: green'>(-3336 [-74.4%])</span> 1,150 | <span style='color: green'>(-1900 [-74.0%])</span> 667 | <span style='color: green'>(-1436 [-74.8%])</span> 483 |
...
| `trace_gen_time_ms   ` | <span style='color: green'>(-45 [-48.4%])</span> 48 | <span style='color: green'>(-90 [-48.4%])</span> 96 | <span style='color: green'>(-38 [-39.6%])</span> 58 | <span style='color: green'>(-52 [-57.8%])</span> 38 |
| `generate_blob_total_time_ms` |  2.50 |  5 |  3 |  2 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` | <span style='color: green'>(-769 [-59.4%])</span> 526 | <span style='color: green'>(-1538 [-59.4%])</span> 1,052 | <span style='color: green'>(-883 [-59.2%])</span> 608 | <span style='color: green'>(-655 [-59.6%])</span> 444 |
| `prover.main_trace_commit_time_ms` |  196 |  392 |  233 |  159 |
| `prover.rap_constraints_time_ms` |  165 |  330 |  183 |  147 |
| `prover.openings_time_ms` |  164 |  328 |  191 |  137 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/93c0710f29b0e49b6e8a540960028a65fe154ea1/fibonacci-93c0710f29b0e49b6e8a540960028a65fe154ea1.memory.svg)
...
| app_proof |  |  |  |  |  | 557 |  |  | 68 | 12,000,265 | 175.76 | 0 | 4,080 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 53,005,300 | 432 | 159 | 0 | 0 | 145 | 42 | 41 | 73 | 29 | 0 | 127 | 110 | 17 | 5 | 12 | 159 | 145 | 0 | 4 | 28 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,767 | 173 | 47 | 0 | 0 | 68 | 25 | 24 | 28 | 14 | 0 | 57 | 48 | 8 | 1 | 6 | 47 | 68 | 0 | 3 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 134 | 32 | 0 | 0 | 63 | 24 | 23 | 24 | 14 | 0 | 39 | 32 | 7 | 1 | 5 | 32 | 63 | 0 | 2 | 13 | 0 | 0 | 
| leaf | 0 | prover | 147,934,246 | 608 | 233 | 0 | 0 | 183 | 84 | 83 | 54 | 44 | 0 | 191 | 166 | 24 | 12 | 12 | 233 | 183 | 0 | 8 | 44 | 0 | 0 | 
| leaf | 1 | prover | 98,728,630 | 444 | 159 | 0 | 0 | 147 | 69 | 68 | 44 | 32 | 0 | 137 | 119 | 18 | 8 | 9 | 159 | 147 | 0 | 7 | 31 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 70,295,622 | 300 | 59 | 0 | 0 | 172 | 37 | 36 | 18 | 117 | 0 | 67 | 54 | 13 | 6 | 6 | 59 | 172 | 0 | 3 | 116 | 0 | 0 | 
| app_proof | prover | 1 | 70,248,284 | 289 | 59 | 0 | 0 | 165 | 32 | 31 | 17 | 116 | 0 | 64 | 52 | 12 | 6 | 5 | 59 | 165 | 0 | 3 | 115 | 0 | 0 | 
| app_proof | prover | 2 | 70,248,284 | 293 | 59 | 0 | 0 | 165 | 31 | 31 | 17 | 116 | 0 | 68 | 55 | 12 | 6 | 5 | 59 | 165 | 0 | 3 | 115 | 0 | 0 | 
| app_proof | prover | 3 | 70,248,284 | 294 | 59 | 0 | 0 | 167 | 32 | 32 | 17 | 117 | 0 | 67 | 54 | 12 | 6 | 5 | 59 | 167 | 0 | 3 | 115 | 0 | 0 | 
| app_proof | prover | 4 | 70,248,284 | 293 | 59 | 0 | 0 | 166 | 32 | 32 | 17 | 115 | 0 | 67 | 55 | 12 | 6 | 5 | 59 | 166 | 0 | 3 | 115 | 0 | 0 | 
| app_proof | prover | 5 | 70,248,284 | 293 | 59 | 0 | 0 | 166 | 31 | 31 | 17 | 116 | 0 | 67 | 54 | 12 | 6 | 5 | 60 | 166 | 0 | 3 | 115 | 0 | 0 | 
| app_proof | prover | 6 | 70,295,004 | 296 | 59 | 0 | 0 | 170 | 33 | 33 | 17 | 119 | 0 | 66 | 53 | 12 | 6 | 6 | 60 | 170 | 0 | 3 | 118 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 165 | 680 | 165 | 159 | 1,411,127,546 | 162,713,442 | 1,573,840,988 | 2,097,152 | 0 | 3 | 55 | 1,747,000 | 49.61 | 
| app_proof | 1 | 166 | 548 | 166 | 41 | 1,409,791,968 | 161,775,035 | 1,571,567,003 | 2,097,152 | 0 | 1 | 51 | 1,747,000 | 50.04 | 
| app_proof | 2 | 168 | 553 | 168 | 41 | 1,409,792,265 | 161,774,738 | 1,571,567,003 | 2,097,152 | 0 | 1 | 50 | 1,747,000 | 49.94 | 
| app_proof | 3 | 168 | 554 | 168 | 41 | 1,409,792,837 | 161,774,166 | 1,571,567,003 | 2,097,152 | 0 | 1 | 50 | 1,747,000 | 50.28 | 
| app_proof | 4 | 169 | 555 | 169 | 41 | 1,409,791,968 | 161,775,035 | 1,571,567,003 | 2,097,152 | 0 | 1 | 51 | 1,747,000 | 49.81 | 
| app_proof | 5 | 169 | 554 | 169 | 41 | 1,409,792,265 | 161,774,738 | 1,571,567,003 | 2,097,152 | 0 | 2 | 50 | 1,747,000 | 50.33 | 
| app_proof | 6 | 175 | 557 | 175 | 41 | 1,233,288,671 | 340,539,078 | 1,573,827,749 | 2,097,152 | 0 | 2 | 43 | 1,518,265 | 49.92 | 

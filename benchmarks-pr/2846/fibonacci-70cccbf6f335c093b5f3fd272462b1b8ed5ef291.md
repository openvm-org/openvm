...
|:---|---:|---:|---:|
| Total | <span style='color: green'>(-3 [-35.2%])</span> 6.10 | <span style='color: green'>(-2 [-45.8%])</span> 2.24 | <span style='color: green'>(-2 [-45.8%])</span> 2.24 |
| app_proof |  4.12 |  0.75 |  0.75 |
| leaf | <span style='color: green'>(-3 [-74.0%])</span> 1.17 | <span style='color: green'>(-2 [-73.7%])</span> 0.68 | <span style='color: green'>(-2 [-73.7%])</span> 0.68 |
...
| `total_proof_time_ms ` |  578.29 |  4,048 |  685 |  559 |
| `execute_metered_time_ms` |  68 | -          | -          | -          |
| `execute_metered_insns` |  12,000,265 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  175.49 | -          |  175.49 |  175.49 |
| `execute_preflight_insns` |  1,714,323.57 |  12,000,265 |  1,747,000 |  1,518,265 |
| `execute_preflight_time_ms` |  49.71 |  348 |  54 |  43 |
| `execute_preflight_insn_mi/s` |  50.11 | -          |  50.39 |  49.53 |
| `trace_gen_time_ms   ` |  171.57 |  1,201 |  178 |  169 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  298.43 |  2,089 |  301 |  297 |
| `prover.main_trace_commit_time_ms` |  59.86 |  419 |  60 |  59 |
| `prover.rap_constraints_time_ms` |  170.71 |  1,195 |  173 |  170 |
| `prover.openings_time_ms` |  66.29 |  464 |  68 |  65 |
| `prover.rap_constraints.logup_gkr_time_ms` |  119.43 |  836 |  121 |  118 |
| `prover.rap_constraints.round0_time_ms` |  32.86 |  230 |  35 |  32 |
| `prover.rap_constraints.mle_rounds_time_ms` |  17.14 |  120 |  18 |  17 |
| `prover.openings.stacked_reduction_time_ms` |  12.14 |  85 |  13 |  12 |
...
| `prover.openings.whir_time_ms` |  54.14 |  379 |  56 |  53 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: green'>(-1659 [-74.0%])</span> 584 | <span style='color: green'>(-3318 [-74.0%])</span> 1,168 | <span style='color: green'>(-1892 [-73.7%])</span> 675 | <span style='color: green'>(-1426 [-74.3%])</span> 493 |
...
| `trace_gen_time_ms   ` | <span style='color: green'>(-43 [-46.2%])</span> 50 | <span style='color: green'>(-86 [-46.2%])</span> 100 | <span style='color: green'>(-36 [-37.5%])</span> 60 | <span style='color: green'>(-50 [-55.6%])</span> 40 |
| `generate_blob_total_time_ms` |  2.50 |  5 |  3 |  2 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` | <span style='color: green'>(-762 [-58.8%])</span> 533.50 | <span style='color: green'>(-1523 [-58.8%])</span> 1,067 | <span style='color: green'>(-877 [-58.8%])</span> 614 | <span style='color: green'>(-646 [-58.8%])</span> 453 |
| `prover.main_trace_commit_time_ms` |  199.50 |  399 |  238 |  161 |
| `prover.rap_constraints_time_ms` |  167.50 |  335 |  186 |  149 |
| `prover.openings_time_ms` |  165 |  330 |  189 |  141 |
| `prover.rap_constraints.logup_gkr_time_ms` |  39 |  78 |  45 |  33 |
| `prover.rap_constraints.round0_time_ms` |  78 |  156 |  85 |  71 |
| `prover.rap_constraints.mle_rounds_time_ms` |  50 |  100 |  55 |  45 |
| `prover.openings.stacked_reduction_time_ms` |  21 |  42 |  24 |  18 |
...
| `prover.openings.whir_time_ms` |  143.50 |  287 |  164 |  123 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/70cccbf6f335c093b5f3fd272462b1b8ed5ef291/fibonacci-70cccbf6f335c093b5f3fd272462b1b8ed5ef291.memory.svg)
...
| app_proof |  |  |  |  |  | 562 |  |  | 68 | 12,000,265 | 175.49 | 0 | 4,126 |  | 
| internal_for_leaf |  |  |  | 480 |  |  |  |  |  |  |  |  |  | 480 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 |
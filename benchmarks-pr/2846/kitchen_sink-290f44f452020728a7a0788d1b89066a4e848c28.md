...
| `total_proof_time_ms ` |  1,918.50 |  3,837 |  2,233 |  1,604 |
| `execute_metered_time_ms` |  36 | -          | -          | -          |
| `execute_metered_insns` |  2,579,903 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  70.25 | -          |  70.25 |  70.25 |
| `execute_preflight_insns` |  1,289,951.50 |  2,579,903 |  1,540,000 |  1,039,903 |
| `execute_preflight_time_ms` |  101 |  202 |  138 |  64 |
| `execute_preflight_insn_mi/s` |  35.83 | -          |  36.87 |  34.79 |
| `trace_gen_time_ms   ` |  137.50 |  275 |  183 |  92 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,569.50 |  3,139 |  1,807 |  1,332 |
| `prover.main_trace_commit_time_ms` |  512.50 |  1,025 |  596 |  429 |
| `prover.rap_constraints_time_ms` |  929 |  1,858 |  1,076 |  782 |
| `prover.openings_time_ms` |  127.50 |  255 |  135 |  120 |
| `prover.rap_constraints.logup_gkr_time_ms` |  167 |  334 |  198 |  136 |
| `prover.rap_constraints.round0_time_ms` |  561.50 |  1,123 |  667 |  456 |
| `prover.rap_constraints.mle_rounds_time_ms` |  199.50 |  399 |  210 |  189 |
| `prover.openings.stacked_reduction_time_ms` |  92.50 |  185 |  101 |  84 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/290f44f452020728a7a0788d1b89066a4e848c28/kitchen_sink-290f44f452020728a7a0788d1b89066a4e848c28.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 73 | 9 |  |  | 0 |  | 373 | 9 |  |  |  |  |  |  | 
| app_proof |  |  |  |  |  | 1,604 |  |  | 36 | 2,579,903 | 70.25 | 0 | 3,878 |  | 
...
| leaf | 0 | 120 | 947 | 119 | 23 | 9 | 20 | 5 | 5 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,577,979 | 259 | 116 | 0 | 0 | 108 | 35 | 35 | 51 | 20 | 0 | 34 | 20 | 13 | 3 | 9 | 117 | 108 | 0 | 2 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,767 | 142 | 45 | 0 | 0 | 66 | 24 | 23 | 28 | 14 | 0 | 29 | 21 | 8 | 1 | 6 | 45 | 66 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 120 | 31 | 0 | 0 | 63 | 24 | 23 | 24 | 14 | 0 | 25 | 18 | 7 | 1 | 5 | 31 | 63 | 0 | 2 | 13 | 0 | 0 | 
| leaf | 0 | prover | 265,003,892 | 827 | 399 | 0 | 1 | 348 | 134 | 133 | 76 | 136 | 0 | 78 | 38 | 40 | 21 | 18 | 400 | 348 | 0 | 6 | 135 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 567,917,156 | 1,807 | 595 | 0 | 186 | 1,076 | 667 | 666 | 210 | 198 | 56 | 135 | 33 | 101 | 50 | 50 | 596 | 1,076 | 0 | 3 | 140 | 0 | 0 | 
| app_proof | prover | 1 | 537,266,124 | 1,332 | 428 | 0 | 1 | 782 | 456 | 455 | 189 | 136 | 0 | 120 | 35 | 84 | 48 | 36 | 429 | 782 | 0 | 4 | 134 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 183 | 2,233 | 183 | 176 | 9,069,025,194 | 1,018,123,350 | 10,087,148,544 | 2,097,152 | 2,097,152 | 1 | 4 | 64 | 1,540,000 | 34.79 | 
| app_proof | 1 | 92 | 1,604 | 92 | 41 | 6,675,792,954 | 2,876,399,838 | 9,552,192,792 | 2,097,152 | 2,097,152 | 0 | 2 | 138 | 1,039,903 | 36.87 | 

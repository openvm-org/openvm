...
|:---|---:|---:|
| Total | <span style='color: red'>(+0 [+1.8%])</span> 1.49 | <span style='color: red'>(+0 [+1.7%])</span> 0.90 |
| pairing | <span style='color: red'>(+0 [+1.9%])</span> 1.43 | <span style='color: red'>(+0 [+1.8%])</span> 0.83 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+13 [+1.9%])</span> 714.50 | <span style='color: red'>(+26 [+1.9%])</span> 1,429 | <span style='color: red'>(+15 [+1.8%])</span> 832 | <span style='color: red'>(+11 [+1.9%])</span> 597 |
...
| `execute_metered_insn_mi/s` | <span style='color: red'>(+0 [+0.7%])</span> 27.48 | -          | <span style='color: red'>(+0 [+0.7%])</span> 27.48 | <span style='color: red'>(+0 [+0.7%])</span> 27.48 |
| `execute_preflight_insns` |  872,871 |  1,745,742 |  1,157,000 |  588,742 |
| `execute_preflight_time_ms` | <span style='color: green'>(-1 [-1.2%])</span> 82.50 | <span style='color: green'>(-2 [-1.2%])</span> 165 |  106 | <span style='color: green'>(-2 [-3.3%])</span> 59 |
| `execute_preflight_insn_mi/s` | <span style='color: green'>(-0 [-1.3%])</span> 14.60 | -          | <span style='color: green'>(-0 [-2.1%])</span> 17.89 |  11.30 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+4 [+2.4%])</span> 191.50 | <span style='color: red'>(+9 [+2.4%])</span> 383 | <span style='color: red'>(+7 [+3.7%])</span> 198 | <span style='color: red'>(+2 [+1.1%])</span> 185 |
...
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+10 [+3.1%])</span> 348 | <span style='color: red'>(+21 [+3.1%])</span> 696 | <span style='color: red'>(+14 [+3.6%])</span> 398 | <span style='color: red'>(+7 [+2.4%])</span> 298 |
| `main_trace_commit_time_ms` | <span style='color: red'>(+2 [+2.3%])</span> 65.50 | <span style='color: red'>(+3 [+2.3%])</span> 131 |  75 | <span style='color: red'>(+3 [+5.7%])</span> 56 |
| `generate_perm_trace_time_ms` |  37 |  74 |  41 |  33 |
| `perm_trace_commit_time_ms` | <span style='color: red'>(+4 [+5.1%])</span> 78.26 | <span style='color: red'>(+8 [+5.1%])</span> 156.51 | <span style='color: red'>(+6 [+7.1%])</span> 90.35 | <span style='color: red'>(+2 [+2.6%])</span> 66.16 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+3 [+3.4%])</span> 79.93 | <span style='color: red'>(+5 [+3.4%])</span> 159.86 | <span style='color: red'>(+4 [+4.9%])</span> 88.41 | <span style='color: red'>(+1 [+1.6%])</span> 71.45 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+1 [+3.4%])</span> 16.70 | <span style='color: red'>(+1 [+3.4%])</span> 33.39 | <span style='color: red'>(+0 [+2.0%])</span> 18.65 | <span style='color: red'>(+1 [+5.2%])</span> 14.74 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+2 [+2.3%])</span> 65.50 | <span style='color: red'>(+3 [+2.3%])</span> 131 | <span style='color: red'>(+2 [+2.6%])</span> 78 | <span style='color: red'>(+1 [+1.9%])</span> 53 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 597 | 1 | 63 | 1,745,742 | 27.48 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 185 | 832 | 32,689,110 | 172,558,444 | 185 | 398 | 0 | 88.41 | 18.65 | 6 | 90.35 | 78 | 135 | 78 | 0 | 75 | 16,059,916 | 41 | 106 | 1,157,000 | 11.30 | 26 | 107 | 1 | 78 | 
| pairing | 1 | 198 | 597 | 22,314,288 | 119,958,502 | 198 | 298 | 1 | 71.45 | 14.74 | 6 | 66.16 | 53 | 102 | 53 | 0 | 56 | 9,408,294 | 33 | 59 | 588,742 | 17.89 | 20 | 86 | 1 | 52 | 

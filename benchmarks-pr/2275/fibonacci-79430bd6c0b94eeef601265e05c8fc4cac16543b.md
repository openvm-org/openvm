...
|:---|---:|---:|
| Total | <span style='color: red'>(+0 [+0.4%])</span> 0.99 |  0.57 |
| fibonacci_program | <span style='color: red'>(+0 [+0.7%])</span> 0.98 | <span style='color: red'>(+0 [+0.5%])</span> 0.56 |


| fibonacci_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+4 [+0.7%])</span> 490 | <span style='color: red'>(+7 [+0.7%])</span> 980 | <span style='color: red'>(+3 [+0.5%])</span> 555 | <span style='color: red'>(+4 [+1.0%])</span> 425 |
| `main_cells_used     ` |  1,050,201 |  2,100,402 |  1,064,416 |  1,035,986 |
| `total_cells_used    ` |  9,692,939 |  19,385,878 |  9,708,170 |  9,677,708 |
| `execute_metered_time_ms` | <span style='color: green'>(-3 [-23.1%])</span> 10 | -          | -          | -          |
| `execute_metered_insn_mi/s` | <span style='color: red'>(+30 [+26.2%])</span> 142.40 | -          | <span style='color: red'>(+30 [+26.2%])</span> 142.40 | <span style='color: red'>(+30 [+26.2%])</span> 142.40 |
...
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+0 [+1.3%])</span> 37.04 | -          | <span style='color: red'>(+0 [+1.1%])</span> 39.07 | <span style='color: red'>(+1 [+1.6%])</span> 35.02 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+4 [+2.1%])</span> 193 | <span style='color: red'>(+8 [+2.1%])</span> 386 | <span style='color: red'>(+3 [+1.5%])</span> 198 | <span style='color: red'>(+5 [+2.7%])</span> 188 |
| `memory_finalize_time_ms` | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+2 [+1.4%])</span> 176.50 | <span style='color: red'>(+5 [+1.4%])</span> 353 | <span style='color: red'>(+5 [+2.7%])</span> 190 |  163 |
...
| `generate_perm_trace_time_ms` | <span style='color: green'>(-0 [-3.4%])</span> 14 | <span style='color: green'>(-1 [-3.4%])</span> 28 |  17 | <span style='color: green'>(-1 [-8.3%])</span> 11 |
| `perm_trace_commit_time_ms` | <span style='color: red'>(+1 [+1.6%])</span> 42.30 | <span style='color: red'>(+1 [+1.6%])</span> 84.59 | <span style='color: red'>(+1 [+3.2%])</span> 45.04 | <span style='color: green'>(-0 [-0.2%])</span> 39.55 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+1 [+2.3%])</span> 32.31 | <span style='color: red'>(+1 [+2.3%])</span> 64.62 | <span style='color: green'>(-1 [-1.7%])</span> 33.81 | <span style='color: red'>(+2 [+7.1%])</span> 30.81 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+1 [+5.6%])</span> 12.35 | <span style='color: red'>(+1 [+5.6%])</span> 24.70 | <span style='color: red'>(+1 [+7.0%])</span> 13.10 | <span style='color: red'>(+0 [+3.9%])</span> 11.60 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+0 [+1.2%])</span> 43 | <span style='color: red'>(+1 [+1.2%])</span> 86 | <span style='color: red'>(+2 [+4.5%])</span> 46 | <span style='color: green'>(-1 [-2.4%])</span> 40 |
...
| --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 425 | 1 | 10 | 1,500,209 | 142.40 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 198 | 555 | 9,677,708 | 84,395,212 | 198 | 190 | 0 | 33.81 | 13.10 | 5 | 45.04 | 46 | 62 | 46 | 0 | 33 | 1,035,986 | 17 | 25 | 873,000 | 35.02 | 14 | 47 | 0 | 46 | 
| fibonacci_program | 1 | 188 | 425 | 9,708,170 | 74,305,770 | 188 | 163 | 1 | 30.81 | 11.60 | 4 | 39.55 | 40 | 51 | 39 | 0 | 28 | 1,064,416 | 11 | 32 | 627,209 | 39.07 | 11 | 42 | 0 | 39 | 
...
Commit: https://github.com/openvm-org/openvm/commit/79430bd6c0b94eeef601265e05c8fc4cac16543b
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19583878371)

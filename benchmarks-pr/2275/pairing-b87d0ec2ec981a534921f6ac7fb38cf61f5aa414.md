...
|:---|---:|---:|
| Total | <span style='color: green'>(-0 [-0.3%])</span> 1.48 | <span style='color: red'>(+0 [+0.1%])</span> 0.90 |
| pairing |  1.42 | <span style='color: red'>(+0 [+0.7%])</span> 0.83 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  711 |  1,422 | <span style='color: red'>(+6 [+0.7%])</span> 833 | <span style='color: green'>(-6 [-1.0%])</span> 589 |
| `main_cells_used     ` |  12,734,105 |  25,468,210 |  16,059,916 |  9,408,294 |
| `total_cells_used    ` |  27,501,699 |  55,003,398 |  32,689,110 |  22,314,288 |
| `execute_metered_time_ms` | <span style='color: green'>(-5 [-7.4%])</span> 63 | -          | -          | -          |
| `execute_metered_insn_mi/s` | <span style='color: red'>(+2 [+7.1%])</span> 27.46 | -          | <span style='color: red'>(+2 [+7.1%])</span> 27.46 | <span style='color: red'>(+2 [+7.1%])</span> 27.46 |
| `execute_preflight_insns` |  872,871 |  1,745,742 |  1,157,000 |  588,742 |
| `execute_preflight_time_ms` | <span style='color: green'>(-0 [-0.6%])</span> 84 | <span style='color: green'>(-1 [-0.6%])</span> 168 | <span style='color: green'>(-3 [-2.7%])</span> 107 | <span style='color: red'>(+2 [+3.4%])</span> 61 |
| `execute_preflight_insn_mi/s` | <span style='color: green'>(-0 [-0.4%])</span> 14.67 | -          | <span style='color: green'>(-0 [-1.9%])</span> 18.18 | <span style='color: red'>(+0 [+2.2%])</span> 11.16 |
| `trace_gen_time_ms   ` |  187.50 |  375 | <span style='color: green'>(-1 [-0.5%])</span> 192 | <span style='color: red'>(+1 [+0.5%])</span> 183 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+3 [+0.9%])</span> 346.50 | <span style='color: red'>(+6 [+0.9%])</span> 693 | <span style='color: red'>(+10 [+2.6%])</span> 398 | <span style='color: green'>(-4 [-1.3%])</span> 295 |
| `main_trace_commit_time_ms` |  64.50 |  129 | <span style='color: red'>(+1 [+1.4%])</span> 75 | <span style='color: green'>(-1 [-1.8%])</span> 54 |
| `generate_perm_trace_time_ms` | <span style='color: green'>(-1 [-2.6%])</span> 37 | <span style='color: green'>(-2 [-2.6%])</span> 74 |  41 | <span style='color: green'>(-2 [-5.7%])</span> 33 |
| `perm_trace_commit_time_ms` | <span style='color: red'>(+3 [+3.6%])</span> 76.87 | <span style='color: red'>(+5 [+3.6%])</span> 153.75 | <span style='color: red'>(+6 [+7.4%])</span> 89.59 | <span style='color: green'>(-1 [-1.1%])</span> 64.16 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+1 [+1.9%])</span> 79.58 | <span style='color: red'>(+3 [+1.9%])</span> 159.16 | <span style='color: red'>(+2 [+2.6%])</span> 87.73 | <span style='color: red'>(+1 [+1.1%])</span> 71.42 |
| `quotient_poly_commit_time_ms` | <span style='color: green'>(-0 [-2.1%])</span> 16.55 | <span style='color: green'>(-1 [-2.1%])</span> 33.09 | <span style='color: green'>(-0 [-1.2%])</span> 18.85 | <span style='color: green'>(-0 [-3.3%])</span> 14.25 |
| `pcs_opening_time_ms ` |  66.50 |  133 |  80 |  53 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 589 | 1 | 63 | 1,745,742 | 27.46 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 183 | 833 | 32,689,110 | 172,558,444 | 183 | 398 | 0 | 87.73 | 18.85 | 6 | 89.59 | 80 | 134 | 80 | 1 | 75 | 16,059,916 | 41 | 107 | 1,157,000 | 11.16 | 26 | 107 | 1 | 80 | 
| pairing | 1 | 192 | 589 | 22,314,288 | 119,958,502 | 192 | 295 | 1 | 71.42 | 14.25 | 5 | 64.16 | 53 | 100 | 53 | 0 | 54 | 9,408,294 | 33 | 61 | 588,742 | 18.18 | 20 | 86 | 1 | 53 | 
...
Commit: https://github.com/openvm-org/openvm/commit/b87d0ec2ec981a534921f6ac7fb38cf61f5aa414
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19583168364)

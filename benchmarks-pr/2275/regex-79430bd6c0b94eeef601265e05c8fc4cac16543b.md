...
|:---|---:|---:|
| Total | <span style='color: red'>(+0 [+0.3%])</span> 2.40 | <span style='color: red'>(+0 [+3.3%])</span> 0.78 |
| regex_program | <span style='color: red'>(+0 [+0.3%])</span> 2.36 | <span style='color: red'>(+0 [+3.5%])</span> 0.74 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+2 [+0.3%])</span> 590 | <span style='color: red'>(+6 [+0.3%])</span> 2,360 | <span style='color: red'>(+25 [+3.5%])</span> 744 | <span style='color: green'>(-15 [-2.8%])</span> 524 |
...
| `execute_metered_insn_mi/s` | <span style='color: green'>(-1 [-1.2%])</span> 109.58 | -          | <span style='color: green'>(-1 [-1.2%])</span> 109.58 | <span style='color: green'>(-1 [-1.2%])</span> 109.58 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` | <span style='color: red'>(+0 [+1.0%])</span> 53 | <span style='color: red'>(+2 [+1.0%])</span> 212 | <span style='color: red'>(+1 [+1.6%])</span> 65 |  44 |
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+0 [+1.4%])</span> 32.63 | -          | <span style='color: red'>(+0 [+0.8%])</span> 33.76 | <span style='color: red'>(+1 [+2.1%])</span> 29.60 |
| `trace_gen_time_ms   ` | <span style='color: green'>(-2 [-1.2%])</span> 179.50 | <span style='color: green'>(-9 [-1.2%])</span> 718 |  214 | <span style='color: green'>(-2 [-1.3%])</span> 156 |
| `memory_finalize_time_ms` |  1 |  4 |  4 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+4 [+1.2%])</span> 290.25 | <span style='color: red'>(+14 [+1.2%])</span> 1,161 | <span style='color: red'>(+27 [+8.6%])</span> 342 | <span style='color: green'>(-5 [-1.9%])</span> 261 |
| `main_trace_commit_time_ms` | <span style='color: green'>(-1 [-1.9%])</span> 51.75 | <span style='color: green'>(-4 [-1.9%])</span> 207 | <span style='color: green'>(-2 [-3.4%])</span> 56 | <span style='color: green'>(-1 [-2.0%])</span> 50 |
| `generate_perm_trace_time_ms` | <span style='color: red'>(+3 [+8.7%])</span> 34.50 | <span style='color: red'>(+11 [+8.7%])</span> 138 | <span style='color: red'>(+10 [+22.7%])</span> 54 |  19 |
| `perm_trace_commit_time_ms` | <span style='color: green'>(-0 [-0.7%])</span> 64.86 | <span style='color: green'>(-2 [-0.7%])</span> 259.45 | <span style='color: green'>(-1 [-1.0%])</span> 70.50 | <span style='color: green'>(-0 [-0.8%])</span> 56.15 |
| `quotient_poly_compute_time_ms` | <span style='color: green'>(-1 [-0.9%])</span> 58.42 | <span style='color: green'>(-2 [-0.9%])</span> 233.67 | <span style='color: red'>(+0 [+0.7%])</span> 70.34 | <span style='color: green'>(-1 [-1.0%])</span> 51.91 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+0 [+1.8%])</span> 15.53 | <span style='color: red'>(+1 [+1.8%])</span> 62.11 | <span style='color: green'>(-0 [-0.9%])</span> 17.11 | <span style='color: red'>(+0 [+3.5%])</span> 13.43 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+3 [+4.6%])</span> 62.25 | <span style='color: red'>(+11 [+4.6%])</span> 249 | <span style='color: red'>(+19 [+30.2%])</span> 82 | <span style='color: green'>(-5 [-9.6%])</span> 47 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 542 | 1 | 37 | 4,137,502 | 109.58 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 214 | 744 | 23,446,148 | 150,778,428 | 214 | 342 | 0 | 59.33 | 17.11 | 5 | 70.50 | 82 | 126 | 82 | 4 | 56 | 10,899,170 | 54 | 44 | 1,103,000 | 29.60 | 21 | 77 | 1 | 82 | 
| regex_program | 1 | 156 | 550 | 11,598,276 | 128,513,066 | 156 | 287 | 1 | 51.91 | 15.78 | 4 | 66.23 | 63 | 104 | 62 | 0 | 51 | 2,196,106 | 38 | 65 | 1,104,000 | 33.44 | 17 | 68 | 0 | 62 | 
| regex_program | 2 | 164 | 524 | 11,579,064 | 128,513,066 | 164 | 261 | 1 | 52.08 | 15.78 | 4 | 66.57 | 47 | 95 | 47 | 0 | 50 | 2,177,334 | 27 | 58 | 1,104,000 | 33.76 | 17 | 68 | 0 | 47 | 
| regex_program | 3 | 184 | 542 | 11,853,872 | 103,456,394 | 184 | 271 | 0 | 70.34 | 13.43 | 5 | 56.15 | 57 | 79 | 56 | 0 | 50 | 2,422,606 | 19 | 45 | 826,502 | 33.71 | 18 | 84 | 1 | 56 | 

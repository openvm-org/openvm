...
|:---|---:|---:|
| Total |  1.49 | <span style='color: red'>(+0 [+0.1%])</span> 0.90 |
| pairing |  1.42 | <span style='color: red'>(+0 [+0.1%])</span> 0.83 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  710.50 |  1,421 | <span style='color: red'>(+1 [+0.1%])</span> 831 |  590 |
...
| `execute_metered_insn_mi/s` |  25.79 | -          |  25.79 |  25.79 |
| `execute_preflight_insns` |  872,871 |  1,745,742 |  1,157,000 |  588,742 |
| `execute_preflight_time_ms` | <span style='color: red'>(+6 [+6.6%])</span> 88.50 | <span style='color: red'>(+11 [+6.6%])</span> 177 | <span style='color: red'>(+2 [+1.9%])</span> 110 | <span style='color: red'>(+9 [+15.5%])</span> 67 |
| `execute_preflight_insn_mi/s` | <span style='color: green'>(-2 [-12.7%])</span> 12.90 | -          | <span style='color: green'>(-4 [-19.5%])</span> 14.94 | <span style='color: green'>(-0 [-1.2%])</span> 10.85 |
| `trace_gen_time_ms   ` | <span style='color: green'>(-7 [-3.7%])</span> 183 | <span style='color: green'>(-14 [-3.7%])</span> 366 | <span style='color: green'>(-10 [-5.1%])</span> 186 | <span style='color: green'>(-4 [-2.2%])</span> 180 |
...
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+2 [+0.7%])</span> 345.50 | <span style='color: red'>(+5 [+0.7%])</span> 691 | <span style='color: red'>(+4 [+1.0%])</span> 397 | <span style='color: red'>(+1 [+0.3%])</span> 294 |
| `main_trace_commit_time_ms` | <span style='color: red'>(+2 [+2.4%])</span> 65 | <span style='color: red'>(+3 [+2.4%])</span> 130 | <span style='color: red'>(+1 [+1.4%])</span> 75 | <span style='color: red'>(+2 [+3.8%])</span> 55 |
| `generate_perm_trace_time_ms` | <span style='color: red'>(+0 [+1.4%])</span> 37 | <span style='color: red'>(+1 [+1.4%])</span> 74 | <span style='color: red'>(+1 [+2.4%])</span> 42 |  32 |
| `perm_trace_commit_time_ms` | <span style='color: red'>(+0 [+0.3%])</span> 77.36 | <span style='color: red'>(+0 [+0.3%])</span> 154.71 | <span style='color: red'>(+1 [+0.8%])</span> 89.82 | <span style='color: green'>(-0 [-0.3%])</span> 64.89 |
| `quotient_poly_compute_time_ms` | <span style='color: green'>(-1 [-0.9%])</span> 78.21 | <span style='color: green'>(-1 [-0.9%])</span> 156.42 | <span style='color: green'>(-0 [-0.3%])</span> 86.94 | <span style='color: green'>(-1 [-1.7%])</span> 69.48 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+1 [+4.2%])</span> 16.48 | <span style='color: red'>(+1 [+4.2%])</span> 32.96 | <span style='color: red'>(+2 [+11.1%])</span> 19.08 | <span style='color: green'>(-1 [-4.0%])</span> 13.88 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+1 [+1.5%])</span> 66.50 | <span style='color: red'>(+2 [+1.5%])</span> 133 | <span style='color: red'>(+1 [+1.3%])</span> 80 | <span style='color: red'>(+1 [+1.9%])</span> 53 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 590 | 1 | 67 | 1,745,742 | 25.79 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 180 | 831 | 32,689,110 | 172,558,444 | 180 | 397 | 0 | 86.94 | 19.08 | 6 | 89.82 | 80 | 134 | 80 | 0 | 75 | 16,059,916 | 42 | 110 | 1,157,000 | 10.85 | 26 | 106 | 1 | 80 | 
| pairing | 1 | 186 | 590 | 22,314,288 | 119,958,502 | 186 | 294 | 1 | 69.48 | 13.88 | 6 | 64.89 | 53 | 100 | 53 | 0 | 55 | 9,408,294 | 32 | 67 | 588,742 | 14.94 | 20 | 83 | 1 | 53 | 

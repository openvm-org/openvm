...
|:---|---:|---:|
| Total | <span style='color: red'>(+0 [+1.3%])</span> 0.99 | <span style='color: red'>(+0 [+0.5%])</span> 0.56 |
| fibonacci_program | <span style='color: red'>(+0 [+1.4%])</span> 0.98 | <span style='color: red'>(+0 [+0.7%])</span> 0.55 |


| fibonacci_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+7 [+1.4%])</span> 490 | <span style='color: red'>(+14 [+1.4%])</span> 980 | <span style='color: red'>(+4 [+0.7%])</span> 552 | <span style='color: red'>(+10 [+2.4%])</span> 428 |
...
| `execute_metered_insn_mi/s` | <span style='color: red'>(+9 [+7.7%])</span> 123.77 | -          | <span style='color: red'>(+9 [+7.7%])</span> 123.77 | <span style='color: red'>(+9 [+7.7%])</span> 123.77 |
| `execute_preflight_insns` |  750,104.50 |  1,500,209 |  873,000 |  627,209 |
| `execute_preflight_time_ms` |  29.50 |  59 |  34 |  25 |
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+0 [+0.4%])</span> 36.86 | -          | <span style='color: red'>(+0 [+0.6%])</span> 38.98 | <span style='color: red'>(+0 [+0.2%])</span> 34.75 |
...
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+3 [+1.7%])</span> 175 | <span style='color: red'>(+6 [+1.7%])</span> 350 | <span style='color: red'>(+1 [+0.5%])</span> 185 | <span style='color: red'>(+5 [+3.1%])</span> 165 |
...
| `perm_trace_commit_time_ms` |  42.12 |  84.24 | <span style='color: red'>(+0 [+1.1%])</span> 44.89 | <span style='color: green'>(-1 [-1.3%])</span> 39.34 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+1 [+3.4%])</span> 30.86 | <span style='color: red'>(+2 [+3.4%])</span> 61.72 | <span style='color: red'>(+1 [+1.8%])</span> 30.87 | <span style='color: red'>(+1 [+5.0%])</span> 30.84 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+1 [+6.0%])</span> 12.01 | <span style='color: red'>(+1 [+6.0%])</span> 24.02 | <span style='color: red'>(+1 [+7.7%])</span> 12.23 | <span style='color: red'>(+0 [+4.3%])</span> 11.79 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+0 [+1.2%])</span> 41.50 | <span style='color: red'>(+1 [+1.2%])</span> 83 | <span style='color: green'>(-1 [-2.2%])</span> 44 | <span style='color: red'>(+2 [+5.4%])</span> 39 |
...
| --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 428 | 1 | 12 | 1,500,209 | 123.77 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 197 | 552 | 9,677,708 | 84,395,212 | 197 | 185 | 0 | 30.87 | 11.79 | 4 | 44.89 | 44 | 63 | 44 | 0 | 33 | 1,035,986 | 18 | 25 | 873,000 | 34.75 | 13 | 43 | 0 | 44 | 
| fibonacci_program | 1 | 187 | 428 | 9,708,170 | 74,305,770 | 187 | 165 | 1 | 30.84 | 12.23 | 4 | 39.34 | 39 | 52 | 39 | 0 | 29 | 1,064,416 | 12 | 34 | 627,209 | 38.98 | 11 | 43 | 0 | 39 | 

...
|:---|---:|---:|
| Total | <span style='color: red'>(+0 [+1.4%])</span> 2.43 | <span style='color: red'>(+0 [+0.9%])</span> 0.79 |
| regex_program | <span style='color: red'>(+0 [+1.5%])</span> 2.39 | <span style='color: red'>(+0 [+1.1%])</span> 0.75 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+9 [+1.5%])</span> 598.50 | <span style='color: red'>(+35 [+1.5%])</span> 2,394 | <span style='color: red'>(+8 [+1.1%])</span> 751 | <span style='color: red'>(+15 [+2.8%])</span> 542 |
...
| `execute_metered_insn_mi/s` | <span style='color: red'>(+1 [+0.6%])</span> 112.25 | -          | <span style='color: red'>(+1 [+0.6%])</span> 112.25 | <span style='color: red'>(+1 [+0.6%])</span> 112.25 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` | <span style='color: green'>(-2 [-3.9%])</span> 55 | <span style='color: green'>(-9 [-3.9%])</span> 220 | <span style='color: green'>(-4 [-5.6%])</span> 67 | <span style='color: green'>(-1 [-2.1%])</span> 46 |
| `execute_preflight_insn_mi/s` | <span style='color: green'>(-1 [-4.4%])</span> 29.78 | -          | <span style='color: green'>(-2 [-5.0%])</span> 30.90 | <span style='color: green'>(-0 [-1.2%])</span> 27.37 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+6 [+3.4%])</span> 182 | <span style='color: red'>(+24 [+3.4%])</span> 728 | <span style='color: red'>(+5 [+2.4%])</span> 217 | <span style='color: red'>(+8 [+5.3%])</span> 158 |
| `memory_finalize_time_ms` | <span style='color: red'>(+0 [+66.7%])</span> 1.25 | <span style='color: red'>(+2 [+66.7%])</span> 5 | <span style='color: red'>(+1 [+33.3%])</span> 4 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+5 [+1.7%])</span> 293.75 | <span style='color: red'>(+20 [+1.7%])</span> 1,175 | <span style='color: red'>(+4 [+1.2%])</span> 342 | <span style='color: red'>(+4 [+1.5%])</span> 267 |
| `main_trace_commit_time_ms` | <span style='color: red'>(+0 [+1.0%])</span> 52.50 | <span style='color: red'>(+2 [+1.0%])</span> 210 | <span style='color: red'>(+1 [+1.8%])</span> 58 |  50 |
| `generate_perm_trace_time_ms` | <span style='color: red'>(+1 [+2.9%])</span> 35 | <span style='color: red'>(+4 [+2.9%])</span> 140 | <span style='color: red'>(+1 [+1.9%])</span> 55 | <span style='color: red'>(+1 [+5.3%])</span> 20 |
| `perm_trace_commit_time_ms` | <span style='color: red'>(+0 [+0.2%])</span> 64.45 | <span style='color: red'>(+1 [+0.2%])</span> 257.81 | <span style='color: green'>(-1 [-1.8%])</span> 70.11 | <span style='color: green'>(-0 [-0.4%])</span> 55.74 |
| `quotient_poly_compute_time_ms` | <span style='color: green'>(-0 [-0.6%])</span> 58.42 | <span style='color: green'>(-1 [-0.6%])</span> 233.70 | <span style='color: red'>(+2 [+2.2%])</span> 72.08 | <span style='color: red'>(+0 [+0.5%])</span> 52.98 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+0 [+1.4%])</span> 15.02 | <span style='color: red'>(+1 [+1.4%])</span> 60.09 | <span style='color: red'>(+0 [+1.2%])</span> 16.78 | <span style='color: red'>(+0 [+1.3%])</span> 13.03 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+4 [+5.7%])</span> 64.75 | <span style='color: red'>(+14 [+5.7%])</span> 259 | <span style='color: red'>(+6 [+7.8%])</span> 83 | <span style='color: red'>(+1 [+2.0%])</span> 51 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 542 | 1 | 36 | 4,137,502 | 112.25 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 217 | 751 | 23,446,148 | 150,778,428 | 217 | 342 | 0 | 55.07 | 16.78 | 5 | 70.11 | 83 | 126 | 83 | 4 | 58 | 10,899,170 | 55 | 47 | 1,103,000 | 27.37 | 21 | 72 | 1 | 83 | 
| regex_program | 1 | 158 | 555 | 11,598,276 | 128,513,066 | 158 | 288 | 1 | 53.57 | 14.70 | 4 | 65.96 | 63 | 105 | 62 | 1 | 51 | 2,196,106 | 38 | 67 | 1,104,000 | 30.30 | 16 | 68 | 0 | 62 | 
| regex_program | 2 | 166 | 546 | 11,579,064 | 128,513,066 | 166 | 278 | 1 | 52.98 | 15.58 | 4 | 66 | 62 | 94 | 62 | 0 | 51 | 2,177,334 | 27 | 60 | 1,104,000 | 30.55 | 17 | 69 | 0 | 62 | 
| regex_program | 3 | 187 | 542 | 11,853,872 | 103,456,394 | 187 | 267 | 0 | 72.08 | 13.03 | 5 | 55.74 | 51 | 78 | 51 | 0 | 50 | 2,422,606 | 20 | 46 | 826,502 | 30.90 | 18 | 86 | 1 | 51 | 
...
Commit: https://github.com/openvm-org/openvm/commit/d1eb7144db865eee50e0eab9c4d840d6581bf73a
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19580656306)

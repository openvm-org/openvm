...
| `total_proof_time_ms ` |  4,155.50 |  8,311 |  5,252 |  3,059 |
...
| `execute_preflight_time_ms` |  262.50 |  525 |  286 |  239 |
| `execute_preflight_insn_mi/s` |  33.96 | -          |  35.63 |  32.30 |
| `trace_gen_time_ms   ` |  125 |  250 |  175 |  75 |
| `set_initial_memory_time_ms` |  89.50 |  179 |  138 |  41 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  3,677 |  7,354 |  4,698 |  2,656 |
| `prover.main_trace_commit_time_ms` |  962.50 |  1,925 |  1,332 |  593 |
| `prover.rap_constraints_time_ms` |  2,004 |  4,008 |  2,468 |  1,540 |
| `prover.openings_time_ms` |  709 |  1,418 |  896 |  522 |
| `prover.rap_constraints.logup_gkr_time_ms` |  559.50 |  1,119 |  598 |  521 |
| `prover.rap_constraints.round0_time_ms` |  1,060 |  2,120 |  1,373 |  747 |
| `prover.rap_constraints.mle_rounds_time_ms` |  383 |  766 |  495 |  271 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/980a3df1485d881319749b9443aad8401b6c964f/sha2_bench-980a3df1485d881319749b9443aad8401b6c964f.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 71 |  |  |  | 345 |  |  |  |  |  |  | 
| app_proof |  |  |  | 3,059 |  | 99 | 11,167,961 | 112.65 | 0 | 8,416 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 326 | 118 | 0 | 0 | 108 | 35 | 35 | 52 | 20 | 0 | 98 | 85 | 13 | 3 | 9 | 118 | 118 | 108 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 172 | 47 | 0 | 0 | 67 | 25 | 24 | 28 | 13 | 0 | 55 | 47 | 8 | 1 | 6 | 48 | 47 | 67 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 141 | 32 | 0 | 0 | 63 | 24 | 23 | 24 | 14 | 0 | 45 | 38 | 7 | 1 | 5 | 32 | 32 | 63 | 0 | 3 | 13 | 0 | 0 | 
| leaf | 0 | prover | 237,929,016 | 895 | 375 | 0 | 0 | 228 | 109 | 108 | 67 | 51 | 0 | 290 | 252 | 37 | 20 | 17 | 375 | 375 | 228 | 0 | 11 | 50 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,286,242,554 | 4,698 | 1,332 | 0 | 0 | 2,468 | 1,373 | 1,373 | 495 | 598 | 1 | 896 | 679 | 217 | 136 | 80 | 1,332 | 1,332 | 2,468 | 0 | 6 | 597 | 0 | 0 | 
| app_proof | prover | 1 | 750,289,144 | 2,656 | 593 | 0 | 0 | 1,540 | 747 | 747 | 271 | 521 | 0 | 522 | 403 | 118 | 70 | 47 | 593 | 593 | 1,540 | 0 | 7 | 519 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 138 | 1 | 175 | 5,252 | 175 | 138 | 13,311,936,132 | 2,137,449,780 | 15,449,385,912 | 2,097,152 | 0 | 3 | 239 | 7,124,000 | 32.30 | 
| app_proof | 1 | 41 | 1 | 75 | 3,059 | 75 | 41 | 7,588,526,580 | 1,502,398,413 | 9,090,924,993 | 2,097,152 | 0 | 2 | 286 | 4,043,961 | 35.63 | 

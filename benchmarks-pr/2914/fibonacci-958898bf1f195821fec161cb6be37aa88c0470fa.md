...
| `total_proof_time_ms ` |  764.50 |  3,058 |  919 |  553 |
| `execute_metered_time_ms` |  84 | -          | -          | -          |
| `execute_metered_insns` |  12,000,265 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  142.71 | -          |  142.71 |  142.71 |
| `execute_preflight_insns` |  3,000,066.25 |  12,000,265 |  3,495,000 |  1,515,265 |
| `execute_preflight_time_ms` |  87 |  348 |  107 |  45 |
| `execute_preflight_insn_mi/s` |  47.11 | -          |  48.26 |  43.86 |
| `record_arena.alloc_time_ms` |  22 |  88 |  34 |  12 |
| `trace_gen_time_ms   ` |  136.50 |  546 |  172 |  118 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  469.75 |  1,879 |  534 |  293 |
| `prover.main_trace_commit_time_ms` |  98.75 |  395 |  112 |  59 |
| `prover.rap_constraints_time_ms` |  269.25 |  1,077 |  306 |  166 |
| `prover.openings_time_ms` |  100.25 |  401 |  115 |  67 |
| `prover.rap_constraints.logup_gkr_time_ms` |  194 |  776 |  222 |  115 |
| `prover.rap_constraints.round0_time_ms` |  49.75 |  199 |  57 |  32 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/958898bf1f195821fec161cb6be37aa88c0470fa/fibonacci-958898bf1f195821fec161cb6be37aa88c0470fa.memory.svg)
...
| app_proof |  |  |  |  |  | 553 |  |  | 84 | 12,000,265 | 142.71 | 0 | 3,149 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 324 | 118 | 0 | 0 | 108 | 36 | 35 | 51 | 20 | 0 | 97 | 84 | 13 | 3 | 9 | 118 | 108 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 168 | 47 | 0 | 0 | 69 | 25 | 25 | 28 | 15 | 0 | 50 | 41 | 8 | 1 | 6 | 48 | 69 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 135 | 31 | 0 | 0 | 62 | 24 | 23 | 24 | 13 | 0 | 41 | 33 | 7 | 1 | 5 | 31 | 62 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 147,934,254 | 606 | 232 | 0 | 0 | 181 | 84 | 83 | 52 | 44 | 0 | 191 | 167 | 24 | 12 | 11 | 232 | 181 | 0 | 8 | 43 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 136,618,054 | 534 | 112 | 0 | 0 | 305 | 57 | 57 | 27 | 220 | 0 | 115 | 94 | 21 | 11 | 9 | 112 | 305 | 0 | 3 | 219 | 0 | 0 | 
| app_proof | prover | 1 | 136,570,716 | 524 | 112 | 0 | 0 | 300 | 54 | 53 | 27 | 219 | 0 | 110 | 89 | 21 | 12 | 9 | 112 | 300 | 0 | 3 | 218 | 0 | 0 | 
| app_proof | prover | 2 | 136,570,716 | 528 | 112 | 0 | 0 | 306 | 56 | 56 | 27 | 222 | 0 | 109 | 87 | 21 | 12 | 9 | 112 | 306 | 0 | 3 | 221 | 0 | 0 | 
| app_proof | prover | 3 | 70,295,004 | 293 | 59 | 0 | 0 | 166 | 32 | 32 | 17 | 115 | 0 | 67 | 54 | 12 | 6 | 6 | 59 | 166 | 0 | 3 | 114 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 157 | 133 | 919 | 133 | 157 | 13 | 2,770,197,065 | 323,292,691 | 3,093,489,756 | 2,097,152 | 0 | 3 | 94 | 3,495,000 | 43.86 | 
| app_proof | 1 | 41 | 118 | 791 | 118 | 41 | 34 | 2,768,862,357 | 322,353,414 | 3,091,215,771 | 2,097,152 | 0 | 1 | 107 | 3,495,000 | 48.26 | 
| app_proof | 2 | 41 | 123 | 795 | 123 | 41 | 29 | 2,768,862,357 | 322,353,414 | 3,091,215,771 | 2,097,152 | 0 | 1 | 102 | 3,495,000 | 48.12 | 
| app_proof | 3 | 41 | 172 | 553 | 172 | 41 | 12 | 1,230,956,171 | 342,871,578 | 1,573,827,749 | 2,097,152 | 0 | 2 | 45 | 1,515,265 | 48.21 | 

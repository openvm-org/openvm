...
|:---|---:|---:|
| Total | <span style='color: green'>(-0 [-0.1%])</span> 11.13 | <span style='color: green'>(-0 [-0.1%])</span> 11.13 |
| ecrecover_program | <span style='color: green'>(-0 [-1.3%])</span> 1.13 | <span style='color: green'>(-0 [-1.3%])</span> 1.13 |
| leaf |  9.99 |  9.99 |
...
| `total_proof_time_ms ` | <span style='color: green'>(-15 [-1.3%])</span> 1,128 | <span style='color: green'>(-15 [-1.3%])</span> 1,128 | <span style='color: green'>(-15 [-1.3%])</span> 1,128 | <span style='color: green'>(-15 [-1.3%])</span> 1,128 |
...
| `execute_e3_insn_mi/s` | <span style='color: red'>(+0 [+0.5%])</span> 1.75 | -          | <span style='color: red'>(+0 [+0.5%])</span> 1.75 | <span style='color: red'>(+0 [+0.5%])</span> 1.75 |
...
| `merkle_finalize_time_ms` | <span style='color: red'>(+3 [+5.4%])</span> 59 | <span style='color: red'>(+3 [+5.4%])</span> 59 | <span style='color: red'>(+3 [+5.4%])</span> 59 | <span style='color: red'>(+3 [+5.4%])</span> 59 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: green'>(-16 [-1.6%])</span> 954 | <span style='color: green'>(-16 [-1.6%])</span> 954 | <span style='color: green'>(-16 [-1.6%])</span> 954 | <span style='color: green'>(-16 [-1.6%])</span> 954 |
...
| `perm_trace_commit_time_ms` | <span style='color: green'>(-19 [-12.2%])</span> 137 | <span style='color: green'>(-19 [-12.2%])</span> 137 | <span style='color: green'>(-19 [-12.2%])</span> 137 | <span style='color: green'>(-19 [-12.2%])</span> 137 |
...
| `pcs_opening_time_ms ` | <span style='color: green'>(-3 [-0.7%])</span> 423 | <span style='color: green'>(-3 [-0.7%])</span> 423 | <span style='color: green'>(-3 [-0.7%])</span> 423 | <span style='color: green'>(-3 [-0.7%])</span> 423 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  9,991 |  9,991 |  9,991 |  9,991 |
| `main_cells_used     ` |  246,666,712 |  246,666,712 |  246,666,712 |  246,666,712 |
| `total_cells_used    ` |  645,425,314 |  645,425,314 |  645,425,314 |  645,425,314 |
| `insns               ` |  2,934,846 |  2,934,846 |  2,934,846 |  2,934,846 |
| `execute_e3_time_ms  ` |  695 |  695 |  695 |  695 |
| `execute_e3_insn_mi/s` |  4.22 | -          |  4.22 |  4.22 |
| `trace_gen_time_ms   ` |  599 |  599 |  599 |  599 |
| `memory_finalize_time_ms` |  12 |  12 |  12 |  12 |
| `boundary_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  8,697 |  8,697 |  8,697 |  8,697 |
| `main_trace_commit_time_ms` |  1,665 |  1,665 |  1,665 |  1,665 |
| `generate_perm_trace_time_ms` |  789 |  789 |  789 |  789 |
| `perm_trace_commit_time_ms` |  2,314 |  2,314 |  2,314 |  2,314 |
| `quotient_poly_compute_time_ms` |  962 |  962 |  962 |  962 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program |  | 1,634 |  | 10 | 137,284 | 1 | 6 | 19.58 | 43 | 
| leaf | 11,106 |  | 1 |  |  | 1 |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 599 | 9,991 | 645,425,314 | 992,054,762 | 8,697 | 962 | 696 | 2,314 | 2,267 | 12 | 1,665 | 246,666,712 | 2,934,846 | 789 | 695 | 4.22 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 96 | 1,128 | 25,968,337 | 32,925,330 | 954 | 78 | 132 | 137 | 423 | 59 | 11 | 2 | 140 | 8,596,011 | 137,284 | 28 | 78 | 1.75 | 0 | 

...
|:---|---:|---:|
| Total |  220.39 |  220.39 |
| kitchen_sink |  15.07 |  15.07 |
| leaf |  22.86 |  22.86 |
| internal.0 |  5.15 |  5.15 |
| root |  38.54 |  38.54 |
| halo2_outer |  94.61 |  94.61 |
...
| `execute_metered_insn_mi/s` |  14.15 | -          |  14.15 |  14.15 |
...
| `stark_prove_excluding_trace_time_ms` |  14,811 |  14,811 |  14,811 |  14,811 |
| `main_trace_commit_time_ms` |  4,969 |  4,969 |  4,969 |  4,969 |
| `generate_perm_trace_time_ms` |  454 |  454 |  454 |  454 |
| `perm_trace_commit_time_ms` |  1,528 |  1,528 |  1,528 |  1,528 |
...
| `main_cells_used     ` |  748,994,022 |  748,994,022 |  748,994,022 |  748,994,022 |
| `total_cells_used    ` |  2,003,005,344 |  2,003,005,344 |  2,003,005,344 |  2,003,005,344 |
| `insns               ` |  7,952,475 |  7,952,475 |  7,952,475 |  7,952,475 |
| `execute_e3_time_ms  ` |  1,604 |  1,604 |  1,604 |  1,604 |
| `execute_e3_insn_mi/s` |  4.96 | -          |  4.96 |  4.96 |
| `trace_gen_time_ms   ` |  1,647 |  1,647 |  1,647 |  1,647 |
...
| `generate_perm_trace_time_ms` |  1,630 |  1,630 |  1,630 |  1,630 |
...
| `pcs_opening_time_ms ` |  4,660 |  4,660 |  4,660 |  4,660 |

| internal.0 |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  5,154 |  5,154 |  5,154 |  5,154 |
...
| `execute_e3_time_ms  ` |  395 |  395 |  395 |  395 |
| `execute_e3_insn_mi/s` |  3.03 | -          |  3.03 |  3.03 |
| `trace_gen_time_ms   ` |  189 |  189 |  189 |  189 |
| `memory_finalize_time_ms` |  8 |  8 |  8 |  8 |
| `boundary_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  4,570 |  4,570 |  4,570 |  4,570 |
...
| `main_cells_used     ` |  40,016,314 |  40,016,314 |  40,016,314 |  40,016,314 |
| `total_cells_used    ` |  61,675,064 |  61,675,064 |  61,675,064 |  61,675,064 |
| `insns               ` |  772,521 |  772,521 |  772,521 |  772,521 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  94,612 |  94,612 |  94,612 |  94,612 |
| `main_cells_used     ` |  65,627,358 |  65,627,358 |  65,627,358 |  65,627,358 |

| halo2_wrapper |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  44,151 |  44,151 |  44,151 |  44,151 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
|  | 111 | 61,675,064 | 94,624 | 44,151 | 7 | 40,016,314 | 772,521 | 176 | 4.39 | 0 | 16,637 | 39,618 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| halo2_outer | 94,612 |  |  |  |  |  | 65,627,358 |  |  |  |  |  | 
| halo2_wrapper | 44,151 |  |  |  |  |  |  |  |  |  |  |  | 
| internal.0 |  |  | 6,371 |  | 3 |  |  |  | 2 |  |  |  | 
| kitchen_sink |  |  |  | 16,559 |  | 23 |  | 154,596 | 1 | 10 | 14.15 | 54 | 
| leaf |  | 24,116 |  |  | 1 |  |  |  | 1 |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal.0 | 0 | 189 | 5,154 | 134,681,445 | 224,975,330 | 4,570 | 612 | 737 | 748 | 1,229 | 8 | 1,041 | 75,193,503 | 1,197,776 | 196 |  | 395 | 3.03 | 0 | 
| leaf | 0 | 1,647 | 22,864 | 2,003,005,344 | 2,500,267,498 | 19,613 | 2,137 | 1,448 | 5,505 | 4,660 | 15 | 4,228 | 748,994,022 | 7,952,475 | 1,630 |  | 1,604 | 4.96 | 0 | 
| root | 0 | 111 | 38,537 | 61,675,064 | 80,435,354 | 38,249 | 711 | 13,608 | 7,574 | 3,885 | 7 | 12,312 | 40,016,314 | 772,521 | 88 | 3 | 177 | 4.36 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| kitchen_sink | 0 | 219 | 15,066 | 1,217,690,534 | 1,481,195,122 | 14,811 | 6,276 | 306 | 1,528 | 1,233 | 78 | 23 | 2 | 4,969 | 899,579,940 | 154,596 | 454 | 36 | 4.20 | 0 | 

...
|:---|---:|---:|---:|
| Total | <span style='color: green'>(-4 [-44.0%])</span> 4.48 | <span style='color: green'>(-2 [-46.6%])</span> 2.34 | <span style='color: green'>(-2 [-46.6%])</span> 2.34 |
| app_proof |  3.12 |  0.98 |  0.98 |
| leaf | <span style='color: green'>(-4 [-83.7%])</span> 0.68 | <span style='color: green'>(-2 [-74.9%])</span> 0.68 | <span style='color: green'>(-2 [-74.9%])</span> 0.68 |
...
| `total_proof_time_ms ` |  762.50 |  3,050 |  912 |  553 |
| `execute_metered_time_ms` |  67 | -          | -          | -          |
| `execute_metered_insns` |  12,000,265 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  176.55 | -          |  176.55 |  176.55 |
| `execute_preflight_insns` |  3,000,066.25 |  12,000,265 |  3,495,000 |  1,515,265 |
| `execute_preflight_time_ms` |  84.75 |  339 |  106 |  43 |
| `execute_preflight_insn_mi/s` |  48.66 | -          |  50.18 |  45.82 |
| `trace_gen_time_ms   ` |  138.25 |  553 |  173 |  119 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  469 |  1,876 |  531 |  295 |
| `prover.main_trace_commit_time_ms` |  98.25 |  393 |  112 |  59 |
| `prover.rap_constraints_time_ms` |  269.50 |  1,078 |  306 |  168 |
| `prover.openings_time_ms` |  100 |  400 |  115 |  67 |
| `prover.rap_constraints.logup_gkr_time_ms` |  193.75 |  775 |  221 |  118 |
| `prover.rap_constraints.round0_time_ms` |  51 |  204 |  59 |  32 |
...
| `prover.openings.whir_time_ms` |  80.50 |  322 |  93 |  54 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: green'>(-1416 [-67.4%])</span> 684 | <span style='color: green'>(-3515 [-83.7%])</span> 684 | <span style='color: green'>(-2043 [-74.9%])</span> 684 | <span style='color: green'>(-788 [-53.5%])</span> 684 |
| `execute_preflight_time_ms` | <span style='color: green'>(-890 [-99.9%])</span> 1 | <span style='color: green'>(-1782 [-99.9%])</span> 1 | <span style='color: green'>(-1460 [-99.9%])</span> 1 | <span style='color: green'>(-321 [-99.7%])</span> 1 |
| `trace_gen_time_ms   ` | <span style='color: green'>(-30 [-30.9%])</span> 66 | <span style='color: green'>(-125 [-65.4%])</span> 66 | <span style='color: green'>(-32 [-32.7%])</span> 66 | <span style='color: green'>(-27 [-29.0%])</span> 66 |
| `generate_blob_total_time_ms` |  5 |  5 |  5 |  5 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` | <span style='color: green'>(-494 [-44.5%])</span> 617 | <span style='color: green'>(-1606 [-72.2%])</span> 617 | <span style='color: green'>(-555 [-47.4%])</span> 617 | <span style='color: green'>(-434 [-41.3%])</span> 617 |
| `prover.main_trace_commit_time_ms` |  233 |  233 |  233 |  233 |
| `prover.rap_constraints_time_ms` |  182 |  182 |  182 |  182 |
| `prover.openings_time_ms` |  202 |  202 |  202 |  202 |
...
| `prover.openings.whir_time_ms` |  177 |  177 |  177 |  177 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/3ee99e5002e123a6ca50c815c3e40ab0bd96b0e3/fibonacci-3ee99e5002e123a6ca50c815c3e40ab0bd96b0e3.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 72 |  |  |  | 358 |  |  |  |  |  |  | 
| app_proof |  |  |  | 553 |  | 67 | 12,000,265 | 176.55 | 0 | 3,125 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 328 | 117 | 0 | 0 | 107 | 34 | 34 | 51 | 21 | 0 | 103 | 89 | 13 | 3 | 9 | 118 | 117 | 107 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 172 | 47 | 0 | 0 | 68 | 26 | 25 | 28 | 13 | 0 | 56 | 48 | 8 | 1 | 6 | 47 | 47 | 68 | 0 | 3 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 139 | 31 | 0 | 0 | 63 | 24 | 23 | 24 | 14 | 0 | 43 | 36 | 7 | 1 | 5 | 32 | 31 | 63 | 0 | 2 | 13 | 0 | 0 | 
| leaf | 0 | prover | 147,934,254 | 617 | 232 | 0 | 0 | 182 | 83 | 82 | 52 | 45 | 0 | 202 | 177 | 24 | 12 | 12 | 233 | 233 | 182 | 0 | 8 | 44 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 136,618,310 | 531 | 112 | 0 | 0 | 302 | 59 | 58 | 27 | 216 | 0 | 115 | 93 | 21 | 11 | 9 | 112 | 112 | 302 | 0 | 3 | 215 | 0 | 0 | 
| app_proof | prover | 1 | 136,570,844 | 528 | 111 | 0 | 0 | 306 | 58 | 58 | 26 | 221 | 0 | 110 | 88 | 21 | 12 | 9 | 111 | 111 | 306 | 0 | 3 | 220 | 0 | 0 | 
| app_proof | prover | 2 | 136,570,844 | 522 | 111 | 0 | 0 | 302 | 55 | 55 | 27 | 220 | 0 | 108 | 87 | 20 | 11 | 8 | 111 | 111 | 302 | 0 | 3 | 219 | 0 | 0 | 
| app_proof | prover | 3 | 70,295,260 | 295 | 59 | 0 | 0 | 168 | 32 | 32 | 17 | 118 | 0 | 67 | 54 | 12 | 6 | 6 | 59 | 59 | 168 | 0 | 3 | 117 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 153 | 135 | 912 | 135 | 153 | 2,770,199,817 | 323,294,035 | 3,093,493,852 | 2,097,152 | 0 | 3 | 92 | 3,495,000 | 45.82 | 
| app_proof | 1 | 41 | 119 | 796 | 119 | 41 | 2,768,863,045 | 322,353,750 | 3,091,216,795 | 2,097,152 | 0 | 2 | 106 | 3,495,000 | 48.92 | 
| app_proof | 2 | 41 | 126 | 789 | 126 | 41 | 2,768,863,045 | 322,353,750 | 3,091,216,795 | 2,097,152 | 0 | 2 | 98 | 3,495,000 | 50.18 | 
| app_proof | 3 | 41 | 173 | 553 | 173 | 41 | 1,230,958,923 | 342,872,922 | 1,573,831,845 | 2,097,152 | 0 | 2 | 43 | 1,515,265 | 49.72 | 

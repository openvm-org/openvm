...
|:---|---:|---:|---:|
| Total | <span style='color: green'>(-4 [-43.9%])</span> 4.49 | <span style='color: green'>(-2 [-46.6%])</span> 2.34 | <span style='color: green'>(-2 [-46.6%])</span> 2.34 |
| app_proof |  3.14 |  0.99 |  0.99 |
| leaf | <span style='color: green'>(-4 [-83.8%])</span> 0.68 | <span style='color: green'>(-2 [-75.0%])</span> 0.68 | <span style='color: green'>(-2 [-75.0%])</span> 0.68 |
...
| `total_proof_time_ms ` |  767.25 |  3,069 |  919 |  555 |
| `execute_metered_time_ms` |  67 | -          | -          | -          |
| `execute_metered_insns` |  12,000,265 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  177.31 | -          |  177.31 |  177.31 |
| `execute_preflight_insns` |  3,000,066.25 |  12,000,265 |  3,495,000 |  1,515,265 |
| `execute_preflight_time_ms` |  83.50 |  334 |  103 |  43 |
| `execute_preflight_insn_mi/s` |  48.92 | -          |  50.25 |  45.56 |
| `trace_gen_time_ms   ` |  140.50 |  562 |  174 |  123 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  472.50 |  1,890 |  535 |  296 |
| `prover.main_trace_commit_time_ms` |  98.50 |  394 |  112 |  59 |
| `prover.rap_constraints_time_ms` |  273.25 |  1,093 |  308 |  169 |
| `prover.openings_time_ms` |  99.75 |  399 |  114 |  67 |
| `prover.rap_constraints.logup_gkr_time_ms` |  196.25 |  785 |  224 |  118 |
| `prover.rap_constraints.round0_time_ms` |  51.25 |  205 |  61 |  32 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: green'>(-1418 [-67.5%])</span> 682 | <span style='color: green'>(-3517 [-83.8%])</span> 682 | <span style='color: green'>(-2045 [-75.0%])</span> 682 | <span style='color: green'>(-790 [-53.7%])</span> 682 |
...
| `trace_gen_time_ms   ` | <span style='color: green'>(-32 [-34.0%])</span> 63 | <span style='color: green'>(-128 [-67.0%])</span> 63 | <span style='color: green'>(-35 [-35.7%])</span> 63 | <span style='color: green'>(-30 [-32.3%])</span> 63 |
| `generate_blob_total_time_ms` |  5 |  5 |  5 |  5 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` | <span style='color: green'>(-494 [-44.4%])</span> 618 | <span style='color: green'>(-1605 [-72.2%])</span> 618 | <span style='color: green'>(-554 [-47.3%])</span> 618 | <span style='color: green'>(-433 [-41.2%])</span> 618 |
| `prover.main_trace_commit_time_ms` |  233 |  233 |  233 |  233 |
| `prover.rap_constraints_time_ms` |  184 |  184 |  184 |  184 |
| `prover.openings_time_ms` |  200 |  200 |  200 |  200 |
...
| `prover.openings.whir_time_ms` |  175 |  175 |  175 |  175 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/35775c9791e1b9cace32914551613b6cf9ba4a8e/fibonacci-35775c9791e1b9cace32914551613b6cf9ba4a8e.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 71 |  |  |  | 350 |  |  |  |  |  |  | 
| app_proof |  |  |  | 555 |  | 67 | 12,000,265 | 177.31 | 0 | 3,144 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 328 | 117 | 0 | 0 | 107 | 35 | 34 | 51 | 20 | 0 | 103 | 89 | 13 | 3 | 9 | 118 | 117 | 107 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 168 | 46 | 0 | 0 | 68 | 25 | 25 | 27 | 14 | 0 | 52 | 44 | 8 | 1 | 6 | 46 | 46 | 68 | 0 | 3 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 136 | 32 | 0 | 0 | 61 | 23 | 23 | 24 | 13 | 0 | 41 | 34 | 7 | 1 | 5 | 32 | 32 | 61 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 147,934,254 | 618 | 233 | 0 | 0 | 184 | 86 | 85 | 53 | 44 | 0 | 200 | 175 | 24 | 12 | 12 | 233 | 233 | 184 | 0 | 8 | 44 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 136,618,310 | 535 | 112 | 0 | 0 | 308 | 61 | 61 | 27 | 219 | 0 | 114 | 92 | 22 | 12 | 9 | 112 | 112 | 308 | 0 | 3 | 218 | 0 | 0 | 
| app_proof | prover | 1 | 136,570,844 | 529 | 112 | 0 | 0 | 308 | 56 | 56 | 27 | 224 | 0 | 108 | 87 | 21 | 12 | 9 | 112 | 112 | 308 | 0 | 3 | 223 | 0 | 0 | 
| app_proof | prover | 2 | 136,570,844 | 530 | 111 | 0 | 0 | 308 | 56 | 56 | 27 | 224 | 0 | 110 | 88 | 21 | 12 | 9 | 111 | 111 | 308 | 0 | 3 | 223 | 0 | 0 | 
| app_proof | prover | 3 | 70,295,260 | 296 | 59 | 0 | 0 | 169 | 32 | 32 | 17 | 118 | 0 | 67 | 55 | 12 | 6 | 6 | 59 | 59 | 169 | 0 | 3 | 117 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 155 | 137 | 919 | 137 | 155 | 2,770,199,817 | 323,294,035 | 3,093,493,852 | 2,097,152 | 0 | 3 | 90 | 3,495,000 | 45.56 | 
| app_proof | 1 | 41 | 123 | 797 | 123 | 41 | 2,768,863,045 | 322,353,750 | 3,091,216,795 | 2,097,152 | 0 | 1 | 103 | 3,495,000 | 50.25 | 
| app_proof | 2 | 41 | 128 | 798 | 128 | 41 | 2,768,863,045 | 322,353,750 | 3,091,216,795 | 2,097,152 | 0 | 1 | 98 | 3,495,000 | 49.94 | 
| app_proof | 3 | 41 | 174 | 555 | 174 | 41 | 1,230,958,923 | 342,872,922 | 1,573,831,845 | 2,097,152 | 0 | 2 | 43 | 1,515,265 | 49.91 | 

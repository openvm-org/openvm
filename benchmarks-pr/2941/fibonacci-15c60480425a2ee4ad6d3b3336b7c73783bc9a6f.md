...
|:---|---:|---:|---:|
| Total | <span style='color: green'>(-4 [-43.8%])</span> 4.51 | <span style='color: green'>(-2 [-46.6%])</span> 2.35 | <span style='color: green'>(-2 [-46.6%])</span> 2.35 |
| app_proof |  3.16 |  0.99 |  0.99 |
| leaf | <span style='color: green'>(-4 [-83.9%])</span> 0.68 | <span style='color: green'>(-2 [-75.2%])</span> 0.68 | <span style='color: green'>(-2 [-75.2%])</span> 0.68 |
...
| `total_proof_time_ms ` |  772.50 |  3,090 |  925 |  560 |
| `execute_metered_time_ms` |  67 | -          | -          | -          |
| `execute_metered_insns` |  12,000,265 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  177.72 | -          |  177.72 |  177.72 |
| `execute_preflight_insns` |  3,000,066.25 |  12,000,265 |  3,495,000 |  1,515,265 |
| `execute_preflight_time_ms` |  82.25 |  329 |  101 |  42 |
| `execute_preflight_insn_mi/s` |  49.73 | -          |  50.84 |  46.63 |
| `trace_gen_time_ms   ` |  143.50 |  574 |  176 |  127 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  475.25 |  1,901 |  540 |  299 |
| `prover.main_trace_commit_time_ms` |  97.50 |  390 |  113 |  59 |
| `prover.rap_constraints_time_ms` |  276 |  1,104 |  313 |  171 |
| `prover.openings_time_ms` |  101 |  404 |  114 |  68 |
| `prover.rap_constraints.logup_gkr_time_ms` |  198 |  792 |  224 |  120 |
| `prover.rap_constraints.round0_time_ms` |  52.25 |  209 |  60 |  33 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: green'>(-1422 [-67.8%])</span> 677 | <span style='color: green'>(-3522 [-83.9%])</span> 677 | <span style='color: green'>(-2050 [-75.2%])</span> 677 | <span style='color: green'>(-795 [-54.0%])</span> 677 |
...
| `trace_gen_time_ms   ` | <span style='color: green'>(-30 [-31.9%])</span> 65 | <span style='color: green'>(-126 [-66.0%])</span> 65 | <span style='color: green'>(-33 [-33.7%])</span> 65 | <span style='color: green'>(-28 [-30.1%])</span> 65 |
| `generate_blob_total_time_ms` |  5 |  5 |  5 |  5 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` | <span style='color: green'>(-500 [-44.9%])</span> 612 | <span style='color: green'>(-1611 [-72.5%])</span> 612 | <span style='color: green'>(-560 [-47.8%])</span> 612 | <span style='color: green'>(-439 [-41.8%])</span> 612 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/15c60480425a2ee4ad6d3b3336b7c73783bc9a6f/fibonacci-15c60480425a2ee4ad6d3b3336b7c73783bc9a6f.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 70 |  |  |  | 352 |  |  |  |  |  |  | 
| app_proof |  |  |  | 560 |  | 67 | 12,000,265 | 177.72 | 0 | 3,164 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 328 | 118 | 0 | 0 | 108 | 35 | 34 | 51 | 20 | 0 | 101 | 87 | 13 | 3 | 9 | 118 | 118 | 108 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 172 | 46 | 0 | 0 | 68 | 25 | 25 | 27 | 14 | 0 | 56 | 47 | 8 | 1 | 6 | 47 | 46 | 68 | 0 | 3 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 138 | 32 | 0 | 0 | 62 | 24 | 23 | 24 | 13 | 0 | 42 | 35 | 7 | 1 | 5 | 32 | 32 | 62 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 147,934,254 | 612 | 235 | 0 | 0 | 186 | 86 | 85 | 54 | 45 | 0 | 190 | 166 | 24 | 12 | 12 | 235 | 235 | 186 | 0 | 8 | 44 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 136,618,310 | 540 | 112 | 0 | 0 | 313 | 60 | 60 | 27 | 224 | 0 | 114 | 93 | 21 | 11 | 9 | 112 | 112 | 313 | 0 | 3 | 223 | 0 | 0 | 
| app_proof | prover | 1 | 136,570,844 | 534 | 113 | 0 | 0 | 310 | 58 | 58 | 27 | 224 | 0 | 111 | 89 | 21 | 12 | 9 | 113 | 113 | 310 | 0 | 3 | 224 | 0 | 0 | 
| app_proof | prover | 2 | 136,570,844 | 528 | 106 | 0 | 0 | 310 | 58 | 58 | 27 | 224 | 0 | 111 | 89 | 21 | 12 | 9 | 106 | 106 | 310 | 0 | 3 | 223 | 0 | 0 | 
| app_proof | prover | 3 | 70,295,260 | 299 | 59 | 0 | 0 | 171 | 33 | 33 | 17 | 120 | 0 | 68 | 55 | 12 | 6 | 6 | 59 | 59 | 171 | 0 | 3 | 119 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 155 | 140 | 925 | 140 | 155 | 2,770,199,817 | 323,294,035 | 3,093,493,852 | 2,097,152 | 0 | 3 | 89 | 3,495,000 | 46.63 | 
| app_proof | 1 | 41 | 127 | 805 | 127 | 41 | 2,768,863,045 | 322,353,750 | 3,091,216,795 | 2,097,152 | 0 | 1 | 101 | 3,495,000 | 50.84 | 
| app_proof | 2 | 42 | 131 | 800 | 131 | 42 | 2,768,863,045 | 322,353,750 | 3,091,216,795 | 2,097,152 | 0 | 1 | 97 | 3,495,000 | 50.79 | 
| app_proof | 3 | 41 | 176 | 560 | 176 | 41 | 1,230,958,923 | 342,872,922 | 1,573,831,845 | 2,097,152 | 0 | 2 | 42 | 1,515,265 | 50.68 | 

...
| `total_proof_time_ms ` |  3,831 |  7,662 |  4,925 |  2,737 |
...
| `execute_preflight_insn_mi/s` |  28.80 | -          |  31.25 |  26.35 |
| `trace_gen_time_ms   ` |  392.50 |  785 |  506 |  279 |
| `memory_finalize_time_ms` |  7 |  14 |  12 |  2 |
| `stark_prove_excluding_trace_time_ms` |  3,109.50 |  6,219 |  4,072 |  2,147 |
| `main_trace_commit_time_ms` |  623 |  1,246 |  836 |  410 |
| `generate_perm_trace_time_ms` |  241 |  482 |  335 |  147 |
| `perm_trace_commit_time_ms` |  651 |  1,302 |  855 |  447 |
| `quotient_poly_compute_time_ms` |  320 |  640 |  434 |  206 |
| `quotient_poly_commit_time_ms` |  302 |  604 |  400 |  204 |
| `pcs_opening_time_ms ` |  964 |  1,928 |  1,206 |  722 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2 | 2,737 | 6 | 1 | 31 | 4,108,597 | 129.23 | 45 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 506 | 4,925 | 211,758,557 | 373,183,036 | 506 | 4,072 | 0 | 434 | 400 | 855 | 1,206 | 7 | 12 | 836 | 91,281,687 | 335 | 99 | 2,211,000 | 26.35 | 
| regex_program | 1 | 279 | 2,737 | 174,326,267 | 196,838,026 | 279 | 2,147 | 52 | 206 | 204 | 447 | 722 | 6 | 2 | 410 | 73,453,305 | 147 | 86 | 1,897,597 | 31.25 | 

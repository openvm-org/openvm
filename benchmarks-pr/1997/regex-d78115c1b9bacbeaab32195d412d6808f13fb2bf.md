...
| `total_proof_time_ms ` |  3,807.50 |  7,615 |  4,887 |  2,728 |
...
| `execute_metered_insn_mi/s` |  126.93 | -          |  126.93 |  126.93 |
| `execute_preflight_insns` |  2,054,298.50 |  4,108,597 |  2,211,000 |  1,897,597 |
| `execute_preflight_time_ms` |  94 |  188 |  101 |  87 |
| `execute_preflight_insn_mi/s` |  28.49 | -          |  30.83 |  26.14 |
| `trace_gen_time_ms   ` |  381.50 |  763 |  494 |  269 |
| `memory_finalize_time_ms` |  7.50 |  15 |  13 |  2 |
| `stark_prove_excluding_trace_time_ms` |  3,104.50 |  6,209 |  4,052 |  2,157 |
| `main_trace_commit_time_ms` |  617 |  1,234 |  838 |  396 |
| `generate_perm_trace_time_ms` |  227 |  454 |  299 |  155 |
| `perm_trace_commit_time_ms` |  662.50 |  1,325 |  876 |  449 |
| `quotient_poly_compute_time_ms` |  312.50 |  625 |  423 |  202 |
| `quotient_poly_commit_time_ms` |  311.50 |  623 |  397 |  226 |
| `pcs_opening_time_ms ` |  966 |  1,932 |  1,215 |  717 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 1 | 2,728 | 7 | 1 | 32 | 4,108,597 | 126.93 | 45 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 494 | 4,887 | 211,758,557 | 373,183,036 | 494 | 4,052 | 0 | 423 | 397 | 876 | 1,215 | 9 | 13 | 838 | 91,281,687 | 299 | 101 | 2,211,000 | 26.14 | 
| regex_program | 1 | 269 | 2,728 | 174,326,267 | 196,838,026 | 269 | 2,157 | 50 | 202 | 226 | 449 | 717 | 6 | 2 | 396 | 73,453,305 | 155 | 87 | 1,897,597 | 30.83 | 

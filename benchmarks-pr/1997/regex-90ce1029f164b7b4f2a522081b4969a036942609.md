...
|:---|---:|---:|
| Total |  7.54 |  4.87 |
| regex_program |  7.50 |  4.84 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  3,752 |  7,504 |  4,842 |  2,662 |
...
| `execute_metered_insn_mi/s` |  125.81 | -          |  125.81 |  125.81 |
| `execute_preflight_insns` |  2,054,298.50 |  4,108,597 |  2,211,000 |  1,897,597 |
| `execute_preflight_time_ms` |  92.50 |  185 |  99 |  86 |
| `execute_preflight_insn_mi/s` |  28.78 | -          |  31.27 |  26.29 |
| `trace_gen_time_ms   ` |  379.50 |  759 |  490 |  269 |
| `memory_finalize_time_ms` |  7.50 |  15 |  13 |  2 |
| `stark_prove_excluding_trace_time_ms` |  3,050.50 |  6,101 |  4,009 |  2,092 |
| `main_trace_commit_time_ms` |  611 |  1,222 |  836 |  386 |
| `generate_perm_trace_time_ms` |  227 |  454 |  303 |  151 |
| `perm_trace_commit_time_ms` |  646 |  1,292 |  847 |  445 |
| `quotient_poly_compute_time_ms` |  310.50 |  621 |  423 |  198 |
| `quotient_poly_commit_time_ms` |  298 |  596 |  397 |  199 |
| `pcs_opening_time_ms ` |  950.50 |  1,901 |  1,199 |  702 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 1 | 2,662 | 6 | 1 | 32 | 4,108,597 | 125.81 | 45 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 490 | 4,842 | 211,758,557 | 373,183,036 | 490 | 4,009 | 0 | 423 | 397 | 847 | 1,199 | 9 | 13 | 836 | 91,281,687 | 303 | 99 | 2,211,000 | 26.29 | 
| regex_program | 1 | 269 | 2,662 | 174,326,267 | 196,838,026 | 268 | 2,092 | 50 | 198 | 199 | 445 | 702 | 6 | 2 | 386 | 73,453,305 | 151 | 86 | 1,897,597 | 31.27 | 

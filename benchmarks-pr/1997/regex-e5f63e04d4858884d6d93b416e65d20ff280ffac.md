...
| `total_proof_time_ms ` |  3,818 |  7,636 |  4,875 |  2,761 |
...
| `execute_metered_insn_mi/s` |  124.44 | -          |  124.44 |  124.44 |
| `execute_preflight_insns` |  2,054,298.50 |  4,108,597 |  2,211,000 |  1,897,597 |
| `execute_preflight_time_ms` |  93 |  186 |  100 |  86 |
| `execute_preflight_insn_mi/s` |  28.61 | -          |  30.96 |  26.25 |
| `trace_gen_time_ms   ` |  377 |  754 |  489 |  265 |
| `memory_finalize_time_ms` |  7.50 |  15 |  13 |  2 |
| `stark_prove_excluding_trace_time_ms` |  3,117 |  6,234 |  4,040 |  2,194 |
| `main_trace_commit_time_ms` |  629 |  1,258 |  841 |  417 |
| `generate_perm_trace_time_ms` |  229.50 |  459 |  306 |  153 |
| `perm_trace_commit_time_ms` |  649 |  1,298 |  850 |  448 |
| `quotient_poly_compute_time_ms` |  317 |  634 |  436 |  198 |
| `quotient_poly_commit_time_ms` |  303 |  606 |  397 |  209 |
| `pcs_opening_time_ms ` |  983 |  1,966 |  1,206 |  760 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 1 | 2,761 | 7 | 1 | 33 | 4,108,597 | 124.44 | 45 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 489 | 4,875 | 211,758,557 | 373,183,036 | 489 | 4,040 | 0 | 436 | 397 | 850 | 1,206 | 7 | 13 | 841 | 91,281,687 | 306 | 100 | 2,211,000 | 26.25 | 
| regex_program | 1 | 265 | 2,761 | 174,326,267 | 196,838,026 | 265 | 2,194 | 49 | 198 | 209 | 448 | 760 | 6 | 2 | 417 | 73,453,305 | 153 | 86 | 1,897,597 | 30.96 | 

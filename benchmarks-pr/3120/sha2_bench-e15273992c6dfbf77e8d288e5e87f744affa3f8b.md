...
| `total_proof_time_ms ` |  2,137.50 |  4,275 |  2,804 |  1,471 |
| `compile_metered_time_ms` |  0 |  0 |  0 |  0 |
| `execute_metered_time_ms` |  62 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  180.02 | -          |  180.02 |  180.02 |
| `set_initial_memory_time_ms` |  3.50 |  7 |  4 |  3 |
| `execute_preflight_insns` |  5,583,980.50 |  11,167,961 |  7,136,000 |  4,031,961 |
| `execute_preflight_time_ms` |  247 |  494 |  328 |  166 |
| `execute_preflight_insn_mi/s` |  22.61 | -          |  24.21 |  21.69 |
| `postflight_time_ms  ` |  89 |  178 |  123 |  55 |
| `postflight_memory_chronology_time_ms` |  12 |  24 |  20 |  4 |
| `postflight_program_index_time_ms` |  1.50 |  3 |  2 |  1 |
| `trace_gen_time_ms   ` |  53.50 |  107 |  74 |  33 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,713.50 |  3,427 |  2,236 |  1,191 |
| `prover.main_trace_commit_time_ms` |  376.50 |  753 |  546 |  207 |
| `prover.rap_constraints_time_ms` |  1,072 |  2,144 |  1,354 |  790 |
| `prover.openings_time_ms` |  263.50 |  527 |  335 |  192 |
| `prover.rap_constraints.logup_gkr_time_ms` |  247.50 |  495 |  271 |  224 |
| `prover.rap_constraints.round0_time_ms` |  644.50 |  1,289 |  848 |  441 |
| `prover.rap_constraints.mle_rounds_time_ms` |  179.50 |  359 |  234 |  125 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/e15273992c6dfbf77e8d288e5e87f744affa3f8b/sha2_bench-e15273992c6dfbf77e8d288e5e87f744affa3f8b.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 173 | 45 | 0 | 0 | 81 | 29 | 28 | 37 | 14 | 0 | 45 | 34 | 10 | 2 | 7 | 45 | 45 | 81 | 0 | 1 | 13 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 111 | 19 | 0 | 0 | 56 | 21 | 20 | 23 | 11 | 0 | 34 | 26 | 7 | 1 | 6 | 20 | 19 | 56 | 0 | 1 | 10 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 96 | 14 | 0 | 0 | 53 | 20 | 19 | 21 | 11 | 0 | 27 | 19 | 7 | 1 | 5 | 15 | 14 | 53 | 0 | 1 | 10 | 0 | 0 | 
| leaf | 0 | prover | 237,929,272 | 414 | 141 | 0 | 0 | 156 | 83 | 82 | 44 | 28 | 0 | 116 | 94 | 21 | 10 | 11 | 142 | 141 | 156 | 0 | 3 | 27 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover |  | 0 | 1,281,523,083 | 2,236 | 546 | 0 | 0 | 1,354 | 848 | 847 | 234 | 271 | 1 | 335 | 243 | 92 | 56 | 35 | 546 | 546 | 1,354 | 0 | 1 | 270 | 0 | 0 | 
| app_proof | prover |  | 1 | 687,699,844 | 1,191 | 207 | 0 | 0 | 790 | 441 | 440 | 125 | 224 | 0 | 192 | 142 | 50 | 29 | 20 | 207 | 207 | 790 | 0 | 1 | 223 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof |  | 1,471 | 62 | 11,167,961 | 180.02 | 0 | 4,342 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof |  | 0 | 4 | 2 | 74 | 2,804 | 5 | 4 | 0 | 123 | 2 | 20 | 0 | 12,537,603,360 | 2,843,438,436 | 15,381,041,796 | 2,097,152 | 2 | 0 | 2 | 5 | 68 | 328 | 7,136,000 | 21.69 | 0 | 0 | 
| app_proof |  | 1 | 3 | 2 | 33 | 1,471 | 3 | 3 | 0 | 55 | 1 | 4 | 0 | 7,116,253,404 | 1,550,303,741 | 8,666,557,145 | 2,097,152 | 2 | 0 | 0 | 2 | 29 | 166 | 4,031,961 | 24.21 | 0 | 0 | 

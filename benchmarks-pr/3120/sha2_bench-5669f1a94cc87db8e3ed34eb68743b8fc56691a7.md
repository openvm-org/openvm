...
|:---|---:|---:|---:|
| Total |  5.37 |  4.06 |  4.06 |
| app_proof |  4.41 |  3.10 |  3.10 |
| leaf |  0.53 |  0.53 |  0.53 |
...
| `total_proof_time_ms ` |  2,175 |  4,350 |  2,866 |  1,484 |
| `compile_metered_time_ms` |  0 |  0 |  0 |  0 |
| `execute_metered_time_ms` |  62 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  179.93 | -          |  179.93 |  179.93 |
| `set_initial_memory_time_ms` |  4 |  8 |  5 |  3 |
| `execute_preflight_insns` |  5,583,980.50 |  11,167,961 |  7,136,000 |  4,031,961 |
| `execute_preflight_time_ms` |  256 |  512 |  343 |  169 |
| `execute_preflight_insn_mi/s` |  21.81 | -          |  23.83 |  20.80 |
| `postflight_time_ms  ` |  98 |  196 |  139 |  57 |
| `postflight_memory_chronology_time_ms` |  12 |  24 |  20 |  4 |
| `postflight_program_index_time_ms` |  1.50 |  3 |  2 |  1 |
| `trace_gen_time_ms   ` |  54 |  108 |  76 |  32 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,732 |  3,464 |  2,264 |  1,200 |
| `prover.main_trace_commit_time_ms` |  385 |  770 |  559 |  211 |
| `prover.rap_constraints_time_ms` |  1,080 |  2,160 |  1,365 |  795 |
| `prover.openings_time_ms` |  266.50 |  533 |  339 |  194 |
| `prover.rap_constraints.logup_gkr_time_ms` |  251 |  502 |  276 |  226 |
| `prover.rap_constraints.round0_time_ms` |  645 |  1,290 |  849 |  441 |
| `prover.rap_constraints.mle_rounds_time_ms` |  182.50 |  365 |  239 |  126 |
| `prover.openings.stacked_reduction_time_ms` |  73 |  146 |  95 |  51 |
...
| `prover.openings.whir_time_ms` |  193.50 |  387 |  244 |  143 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/5669f1a94cc87db8e3ed34eb68743b8fc56691a7/sha2_bench-5669f1a94cc87db8e3ed34eb68743b8fc56691a7.memory.svg)
...
| leaf | 0 | 114 | 530 | 114 | 32 | 12 | 2 | 9 | 9 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 174 | 45 | 0 | 0 | 80 | 28 | 28 | 37 | 14 | 0 | 47 | 37 | 10 | 2 | 7 | 45 | 45 | 80 | 0 | 1 | 13 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 114 | 19 | 0 | 0 | 57 | 22 | 21 | 23 | 11 | 0 | 36 | 28 | 7 | 1 | 6 | 20 | 20 | 57 | 0 | 1 | 10 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 99 | 14 | 0 | 0 | 54 | 20 | 19 | 21 | 11 | 0 | 30 | 23 | 7 | 1 | 5 | 15 | 14 | 54 | 0 | 1 | 10 | 0 | 0 | 
| leaf | 0 | prover | 237,929,272 | 415 | 143 | 0 | 0 | 156 | 83 | 81 | 44 | 28 | 0 | 115 | 93 | 21 | 10 | 11 | 143 | 143 | 156 | 0 | 3 | 27 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover |  | 0 | 1,281,523,083 | 2,264 | 559 | 0 | 0 | 1,365 | 849 | 848 | 239 | 276 | 1 | 339 | 244 | 95 | 58 | 36 | 559 | 559 | 1,365 | 0 | 1 | 274 | 0 | 0 | 
| app_proof | prover |  | 1 | 687,699,844 | 1,200 | 211 | 0 | 0 | 795 | 441 | 441 | 126 | 226 | 0 | 194 | 143 | 51 | 30 | 20 | 211 | 211 | 795 | 0 | 1 | 225 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof |  | 1,484 | 62 | 11,167,961 | 179.93 | 0 | 4,416 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof |  | 0 | 5 | 2 | 76 | 2,866 | 6 | 5 | 0 | 139 | 2 | 20 | 0 | 12,537,603,360 | 2,843,438,436 | 15,381,041,796 | 2,097,152 | 2 | 0 | 2 | 5 | 69 | 343 | 7,136,000 | 20.80 | 0 | 0 | 
| app_proof |  | 1 | 3 | 2 | 32 | 1,484 | 3 | 3 | 0 | 57 | 1 | 4 | 0 | 7,116,253,404 | 1,550,303,741 | 8,666,557,145 | 2,097,152 | 2 | 0 | 0 | 2 | 29 | 169 | 4,031,961 | 23.83 | 0 | 0 | 

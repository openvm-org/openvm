...
| `execute_metered_insn_mi/s` |  100.04 | -          |  100.04 |  100.04 |
...
| `execute_preflight_insn_mi/s` |  22.96 | -          |  22.79 |  22.79 |
| `postflight_time_ms  ` |  32 |  32 |  32 |  32 |
| `postflight_memory_chronology_time_ms` |  3 |  3 |  3 |  3 |
| `postflight_program_index_time_ms` |  0 |  0 |  0 |  0 |
| `trace_gen_time_ms   ` |  117 |  117 |  117 |  117 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  2,068 |  2,068 |  2,068 |  2,068 |
| `prover.main_trace_commit_time_ms` |  558 |  558 |  558 |  558 |
| `prover.rap_constraints_time_ms` |  1,126 |  1,126 |  1,126 |  1,126 |
| `prover.openings_time_ms` |  383 |  383 |  383 |  383 |
| `prover.rap_constraints.logup_gkr_time_ms` |  122 |  122 |  122 |  122 |
| `prover.rap_constraints.round0_time_ms` |  804 |  804 |  804 |  804 |
...
| `prover.openings.whir_time_ms` |  293 |  293 |  293 |  293 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  556 |  556 |  556 |  556 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/c73d0f8c884a5c10f68850b3d4d68762348e3593/kitchen_sink-c73d0f8c884a5c10f68850b3d4d68762348e3593.memory.svg)

| Module | Max (GB) | Max At |
| --- | ---: | --- |
| prover.stacked_commit | 12.14 | app_proof.prover..0 |
| prover.rap_constraints | 9.07 | app_proof.prover..0 |
| prover.openings | 8.23 | app_proof.prover..0 |
| prover.merkle_tree | 8.23 | app_proof.prover..0 |
| prover.prove_whir_opening | 8.23 | app_proof.prover..0 |
| prover.rs_code_matrix | 8.23 | app_proof.prover..0 |
...
| --- | --- | --- | --- |
| 900 | 267,239 | 228,695 | 24 | 

| air_id | air_name | need_rot | interactions | constraints | constraint_deg |
| --- | --- | --- | --- | --- | --- |
| 0 | ProgramAir |  | 1 |  | 1 | 
| 1 | VmConnectorAir | 1 | 5 | 9 | 3 | 
| 10 | VmAirWrapper<VecHeapAdapterAir<1, 12, 12>, FieldExpressionCoreAir> |  | 1,238 | 684 | 2 | 
| 100 | VariableRangeCheckerAir | 1 | 1 | 10 | 3 | 
| 11 | VmAirWrapper<VecHeapAdapterAir<2, 12, 12>, FieldExpressionCoreAir> |  | 1,580 | 845 | 2 | 
...
| 4 | VmAirWrapper<VecHeapAdapterAir<1, 18, 18>, FieldExpressionCoreAir> |  | 1,943 | 1,069 | 2 | 
...
| 5 | VmAirWrapper<VecHeapAdapterAir<2, 18, 18>, FieldExpressionCoreAir> |  | 2,549 | 1,358 | 2 | 
...
| 6 | VmAirWrapper<VecHeapAdapterAir<1, 12, 12>, FieldExpressionCoreAir> |  | 1,238 | 684 | 2 | 
...
| 7 | VmAirWrapper<VecHeapAdapterAir<2, 12, 12>, FieldExpressionCoreAir> |  | 1,580 | 845 | 2 | 
...
| 8 | VmAirWrapper<VecHeapAdapterAir<1, 12, 12>, FieldExpressionCoreAir> |  | 1,913 | 1,008 | 2 | 
...
| 9 | VmAirWrapper<VecHeapAdapterAir<2, 12, 12>, FieldExpressionCoreAir> |  | 1,900 | 975 | 2 | 
...
| app_proof | VmAirWrapper<LoadMultiByteAdapterAir, LoadSignExtendCoreAir<4, 3> |  | 0 | 1 | 
...
| app_proof | VmAirWrapper<StoreMultiByteAdapterAir, StoreCoreAir<4, 2> |  | 0 | 1 | 
| app_proof | VmAirWrapper<StoreMultiByteAdapterAir, StoreCoreAir<8, 4> |  | 0 | 0 | 
| app_proof | VmAirWrapper<VecHeapAdapterAir<1, 12, 12>, FieldExpressionCoreAir> |  | 0 | 1 | 
| app_proof | VmAirWrapper<VecHeapAdapterAir<1, 18, 18>, FieldExpressionCoreAir> |  | 0 | 2 | 
| app_proof | VmAirWrapper<VecHeapAdapterAir<2, 12, 12>, FieldExpressionCoreAir> |  | 0 | 0 | 
| app_proof | VmAirWrapper<VecHeapAdapterAir<2, 18, 18>, FieldExpressionCoreAir> |  | 0 | 2 | 
...
| app_proof | 10 | VmAirWrapper<VecHeapAdapterAir<1, 12, 12>, FieldExpressionCoreAir> | prover |  | 0 | 2 | 1,335 | 2,670 | 
| app_proof | 100 | VariableRangeCheckerAir | prover |  | 0 | 262,144 | 4 | 1,048,576 | 
| app_proof | 11 | VmAirWrapper<VecHeapAdapterAir<2, 12, 12>, FieldExpressionCoreAir> | prover |  | 0 | 2 | 1,749 | 3,498 | 
...
| app_proof | 22 | VmAirWrapper<IsEqualModU16AdapterAir<2, 6, 24>, ModularIsEqualCoreAir<24, 4, 16> | prover |  | 0 | 2 | 145 | 290 | 
| app_proof | 23 | VmAirWrapper<VecHeapAdapterAir<2, 6, 6>, FieldExpressionCoreAir> | prover |  | 0 | 2 | 369 | 738 | 
| app_proof | 24 | VmAirWrapper<VecHeapAdapterAir<2, 6, 6>, FieldExpressionCoreAir> | prover |  | 0 | 2 | 273 | 546 | 
...
| app_proof | 28 | VmAirWrapper<IsEqualModU16AdapterAir<2, 4, 16>, ModularIsEqualCoreAir<16, 4, 16> | prover |  | 0 | 2 | 105 | 210 | 
...
| app_proof | 30 | VmAirWrapper<VecHeapAdapterAir<2, 4, 4>, FieldExpressionCoreAir> | prover |  | 0 | 2 | 189 | 378 | 
...
| app_proof | 34 | VmAirWrapper<IsEqualModU16AdapterAir<2, 4, 16>, ModularIsEqualCoreAir<16, 4, 16> | prover |  | 0 | 2 | 105 | 210 | 
| app_proof | 35 | VmAirWrapper<VecHeapAdapterAir<2, 4, 4>, FieldExpressionCoreAir> | prover |  | 0 | 2 | 253 | 506 | 
| app_proof | 36 | VmAirWrapper<VecHeapAdapterAir<2, 4, 4>, FieldExpressionCoreAir> | prover |  | 0 | 2 | 189 | 378 | 
...
| app_proof | 4 | VmAirWrapper<VecHeapAdapterAir<1, 18, 18>, FieldExpressionCoreAir> | prover |  | 0 | 2 | 2,088 | 4,176 | 
| app_proof | 40 | VmAirWrapper<IsEqualModU16AdapterAir<2, 4, 16>, ModularIsEqualCoreAir<16, 4, 16> | prover |  | 0 | 2 | 105 | 210 | 
| app_proof | 41 | VmAirWrapper<VecHeapAdapterAir<2, 4, 4>, FieldExpressionCoreAir> | prover |  | 0 | 2 | 253 | 506 | 
| app_proof | 42 | VmAirWrapper<VecHeapAdapterAir<2, 4, 4>, FieldExpressionCoreAir> | prover |  | 0 | 2 | 189 | 378 | 
...
| app_proof | 5 | VmAirWrapper<VecHeapAdapterAir<2, 18, 18>, FieldExpressionCoreAir> | prover |  | 0 | 2 | 2,802 | 5,604 | 
| app_proof | 50 | VmAirWrapper<VecHeapU16AdapterAir<2, 4, 4>, 2, 4, 4, 4, 16, 16>, AddSubCoreAir<16, 16, true> | prover |  | 0 | 512 | 107 | 54,784 | 
| app_proof | 53 | VmAirWrapper<MultAdapterAir, MulHCoreAir<8, 8> | prover |  | 0 | 256 | 52 | 13,312 | 
...
| app_proof | 6 | VmAirWrapper<VecHeapAdapterAir<1, 12, 12>, FieldExpressionCoreAir> | prover |  | 0 | 2 | 1,335 | 2,670 | 
...
| app_proof | 65 | VmAirWrapper<BaseAluImmAdapterAir, BitwiseLogicImmCoreAir<8, 8> | prover |  | 0 | 262,144 | 34 | 8,912,896 | 
| app_proof | 66 | VmAirWrapper<BaseAluImmU16AdapterAir, LessThanImmCoreAir<4, 16> | prover |  | 0 | 256 | 27 | 6,912 | 
| app_proof | 68 | VmAirWrapper<BaseAluImmU16AdapterAir, ShiftLogicalImmCoreAir<4, 16> | prover |  | 0 | 8,192 | 51 | 417,792 | 
| app_proof | 69 | VmAirWrapper<BaseAluImmU16AdapterAir, AddICoreAir<4, 16, true> | prover |  | 0 | 524,288 | 23 | 12,058,624 | 
| app_proof | 7 | VmAirWrapper<VecHeapAdapterAir<2, 12, 12>, FieldExpressionCoreAir> | prover |  | 0 | 2 | 1,749 | 3,498 | 
| app_proof | 70 | VmAirWrapper<RdWriteAdapterAir, AuipcCoreAir> | prover |  | 0 | 16,384 | 16 | 262,144 | 
| app_proof | 71 | VmAirWrapper<JalrAdapterAir, JalrCoreAir> | prover |  | 0 | 32,768 | 22 | 720,896 | 
| app_proof | 72 | VmAirWrapper<CondRdWriteAdapterAir, JalLuiCoreAir> | prover |  | 0 | 131,072 | 17 | 2,228,224 | 
| app_proof | 73 | VmAirWrapper<BranchAdapterAir, BranchLessThanCoreAir<4, 16> | prover |  | 0 | 262,144 | 30 | 7,864,320 | 
| app_proof | 74 | VmAirWrapper<BranchAdapterAir, BranchEqualCoreAir<4> | prover |  | 0 | 262,144 | 24 | 6,291,456 | 
| app_proof | 75 | VmAirWrapper<StoreMultiByteAdapterAir, StoreCoreAir<8, 4> | prover |  | 0 | 262,144 | 40 | 10,485,760 | 
| app_proof | 76 | VmAirWrapper<LoadMultiByteAdapterAir, LoadCoreAir<8, 5> | prover |  | 0 | 262,144 | 39 | 10,223,616 | 
| app_proof | 77 | VmAirWrapper<StoreMultiByteAdapterAir, StoreCoreAir<4, 2> | prover |  | 0 | 524,288 | 38 | 19,922,944 | 
| app_proof | 79 | VmAirWrapper<LoadMultiByteAdapterAir, LoadSignExtendCoreAir<4, 3> | prover |  | 0 | 524,288 | 38 | 19,922,944 | 
| app_proof | 8 | VmAirWrapper<VecHeapAdapterAir<1, 12, 12>, FieldExpressionCoreAir> | prover |  | 0 | 2 | 2,010 | 4,020 | 
| app_proof | 83 | VmAirWrapper<StoreByteAdapterAir, StoreByteCoreAir> | prover |  | 0 | 4,096 | 29 | 118,784 | 
| app_proof | 84 | VmAirWrapper<LoadByteAdapterAir, LoadByteCoreAir> | prover |  | 0 | 1,024 | 28 | 28,672 | 
| app_proof | 87 | VmAirWrapper<BaseAluWImmU16AdapterAir, ShiftLogicalImmCoreAir<2, 16> | prover |  | 0 | 2,048 | 44 | 90,112 | 
| app_proof | 88 | VmAirWrapper<BaseAluWImmU16AdapterAir, AddICoreAir<2, 16, false> | prover |  | 0 | 1,024 | 22 | 22,528 | 
| app_proof | 9 | VmAirWrapper<VecHeapAdapterAir<2, 12, 12>, FieldExpressionCoreAir> | prover |  | 0 | 2 | 2,069 | 4,138 | 
...
| app_proof | 10 | VmAirWrapper<VecHeapAdapterAir<1, 12, 12>, FieldExpressionCoreAir> |  | 0 | 2 |  | 6,675 |  | 10,680 |  | 2,670 |  | 89,755 |  | 2,476 |  | 
| app_proof | 100 | VariableRangeCheckerAir |  | 0 | 262,144 |  | 5,242,880 |  | 4,194,304 |  | 1,048,576 |  | 9,502,720 |  | 262,144 |  | 
| app_proof | 11 | VmAirWrapper<VecHeapAdapterAir<2, 12, 12>, FieldExpressionCoreAir> |  | 0 | 2 |  | 8,745 |  | 13,992 |  | 3,498 |  | 114,550 |  | 3,160 |  | 
...
| app_proof | 22 | VmAirWrapper<IsEqualModU16AdapterAir<2, 6, 24>, ModularIsEqualCoreAir<24, 4, 16> |  | 0 | 2 |  | 725 |  | 1,160 |  | 290 |  | 4,858 |  | 134 |  | 
| app_proof | 23 | VmAirWrapper<VecHeapAdapterAir<2, 6, 6>, FieldExpressionCoreAir> |  | 0 | 2 |  | 1,845 |  | 2,952 |  | 738 |  | 20,518 |  | 566 |  | 
| app_proof | 24 | VmAirWrapper<VecHeapAdapterAir<2, 6, 6>, FieldExpressionCoreAir> |  | 0 | 2 |  | 1,365 |  | 2,184 |  | 546 |  | 13,558 |  | 374 |  | 
...
| app_proof | 28 | VmAirWrapper<IsEqualModU16AdapterAir<2, 4, 16>, ModularIsEqualCoreAir<16, 4, 16> |  | 0 | 2 |  | 525 |  | 840 |  | 210 |  | 3,698 |  | 102 |  | 
...
| app_proof | 30 | VmAirWrapper<VecHeapAdapterAir<2, 4, 4>, FieldExpressionCoreAir> |  | 0 | 2 |  | 945 |  | 1,512 |  | 378 |  | 9,498 |  | 262 |  | 
...
| app_proof | 34 | VmAirWrapper<IsEqualModU16AdapterAir<2, 4, 16>, ModularIsEqualCoreAir<16, 4, 16> |  | 0 | 2 |  | 525 |  | 840 |  | 210 |  | 3,698 |  | 102 |  | 
| app_proof | 35 | VmAirWrapper<VecHeapAdapterAir<2, 4, 4>, FieldExpressionCoreAir> |  | 0 | 2 |  | 1,265 |  | 2,024 |  | 506 |  | 14,138 |  | 390 |  | 
| app_proof | 36 | VmAirWrapper<VecHeapAdapterAir<2, 4, 4>, FieldExpressionCoreAir> |  | 0 | 2 |  | 945 |  | 1,512 |  | 378 |  | 9,498 |  | 262 |  | 
...
| app_proof | 4 | VmAirWrapper<VecHeapAdapterAir<1, 18, 18>, FieldExpressionCoreAir> |  | 0 | 2 |  | 10,440 |  | 16,704 |  | 4,176 |  | 140,868 |  | 3,886 |  | 
| app_proof | 40 | VmAirWrapper<IsEqualModU16AdapterAir<2, 4, 16>, ModularIsEqualCoreAir<16, 4, 16> |  |
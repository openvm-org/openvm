...
| `total_proof_time_ms ` |  595 |  2,380 |  746 |  518 |
...
| `execute_preflight_time_ms` |  56.75 |  227 |  68 |  47 |
| `execute_preflight_insn_mi/s` |  31.05 | -          |  32.28 |  27.94 |
| `trace_gen_time_ms   ` |  173.25 |  693 |  208 |  149 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  289 |  1,156 |  314 |  259 |
| `main_trace_commit_time_ms` |  51 |  204 |  57 |  49 |
| `generate_perm_trace_time_ms` |  37.25 |  149 |  47 |  21 |
| `perm_trace_commit_time_ms` |  63.29 |  253.17 |  69.90 |  54.92 |
| `quotient_poly_compute_time_ms` |  58.73 |  234.93 |  68.63 |  52.59 |
| `quotient_poly_commit_time_ms` |  15.52 |  62.08 |  18.45 |  13.58 |
| `pcs_opening_time_ms ` |  59.50 |  238 |  66 |  53 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 576 | 1 | 37 | 4,137,512 | 110.51 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 208 | 746 | 23,437,436 | 150,778,428 | 208 | 314 | 0 | 60.92 | 18.45 | 5 | 69.90 | 65 | 111 | 64 | 4 | 57 | 10,891,066 | 40 | 47 | 1,103,000 | 27.94 | 22 | 80 | 1 | 64 | 
| regex_program | 1 | 149 | 518 | 11,597,664 | 128,513,066 | 149 | 259 | 1 | 52.79 | 14.90 | 5 | 64.60 | 54 | 86 | 54 | 0 | 49 | 2,195,390 | 21 | 68 | 1,104,000 | 32.28 | 17 | 68 | 0 | 54 | 
| regex_program | 2 | 155 | 540 | 11,579,760 | 128,513,066 | 155 | 277 | 1 | 52.59 | 15.15 | 5 | 63.74 | 53 | 106 | 53 | 0 | 49 | 2,177,774 | 41 | 65 | 1,104,000 | 31.72 | 17 | 68 | 1 | 53 | 
| regex_program | 3 | 181 | 576 | 11,853,280 | 103,456,394 | 181 | 306 | 1 | 68.63 | 13.58 | 5 | 54.92 | 66 | 106 | 66 | 0 | 49 | 2,421,998 | 47 | 47 | 826,512 | 32.28 | 19 | 83 | 1 | 66 | 
...
Commit: https://github.com/openvm-org/openvm/commit/39970a08dd80151f23a13498f9e42649d801ced6
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/20285825771)

...
|:---|---:|---:|---:|
| Total |  2.42 |  0.78 | 0.78 |
| regex_program |  2.42 |  0.78 |  0.78 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  596.50 |  2,386 |  745 |  532 |
...
| `execute_metered_insn_mi/s` |  111.28 | -          |  111.28 |  111.28 |
| `execute_preflight_insns` |  1,034,378 |  4,137,512 |  1,104,000 |  826,512 |
| `execute_preflight_time_ms` |  54 |  216 |  65 |  46 |
| `execute_preflight_insn_mi/s` |  31.28 | -          |  32.55 |  28.52 |
| `trace_gen_time_ms   ` |  179.50 |  718 |  214 |  157 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  287.75 |  1,151 |  313 |  266 |
| `main_trace_commit_time_ms` |  51 |  204 |  55 |  49 |
| `generate_perm_trace_time_ms` |  34.25 |  137 |  57 |  21 |
| `perm_trace_commit_time_ms` |  64.84 |  259.34 |  71.32 |  54.90 |
| `quotient_poly_compute_time_ms` |  60.57 |  242.30 |  71.53 |  54.82 |
| `quotient_poly_commit_time_ms` |  15.86 |  63.42 |  18.63 |  13.58 |
| `pcs_opening_time_ms ` |  57.75 |  231 |  65 |  53 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 547 | 1 | 37 | 4,137,512 | 111.28 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 214 | 745 | 23,437,436 | 150,778,428 | 214 | 313 | 0 | 61.03 | 18.63 | 5 | 71.32 | 65 | 110 | 65 | 4 | 55 | 10,891,066 | 38 | 46 | 1,103,000 | 28.52 | 22 | 80 | 1 | 65 | 
| regex_program | 1 | 157 | 532 | 11,597,664 | 128,513,066 | 157 | 266 | 1 | 54.92 | 16 | 4 | 68.01 | 54 | 90 | 54 | 0 | 50 | 2,195,390 | 21 | 65 | 1,104,000 | 32.55 | 17 | 71 | 0 | 54 | 
| regex_program | 2 | 163 | 562 | 11,579,760 | 128,513,066 | 163 | 297 | 1 | 54.82 | 15.21 | 5 | 65.11 | 53 | 122 | 53 | 0 | 50 | 2,177,774 | 57 | 59 | 1,104,000 | 32.04 | 16 | 70 | 0 | 53 | 
| regex_program | 3 | 184 | 547 | 11,853,280 | 103,456,394 | 184 | 275 | 0 | 71.53 | 13.58 | 5 | 54.90 | 59 | 79 | 59 | 0 | 49 | 2,421,998 | 21 | 46 | 826,512 | 32.02 | 19 | 86 | 1 | 59 | 
...
Commit: https://github.com/openvm-org/openvm/commit/fd6aee6f06da97004a3e70dbd4db82a5ecfb8c64
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/20285445108)

...
| `total_proof_time_ms ` |  723.50 |  1,447 |  853 |  594 |
...
| `execute_metered_insn_mi/s` |  27.22 | -          |  27.22 |  27.22 |
| `execute_preflight_insns` |  872,878.50 |  1,745,757 |  1,151,000 |  594,757 |
| `execute_preflight_time_ms` |  83 |  166 |  105 |  61 |
| `execute_preflight_insn_mi/s` |  14.71 | -          |  18.08 |  11.35 |
| `trace_gen_time_ms   ` |  190.50 |  381 |  194 |  187 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  344 |  688 |  391 |  297 |
| `main_trace_commit_time_ms` |  64 |  128 |  75 |  53 |
| `generate_perm_trace_time_ms` |  36.50 |  73 |  43 |  30 |
| `perm_trace_commit_time_ms` |  77.44 |  154.88 |  89.97 |  64.91 |
| `quotient_poly_compute_time_ms` |  82.36 |  164.72 |  91.24 |  73.47 |
| `quotient_poly_commit_time_ms` |  17.47 |  34.95 |  19.46 |  15.48 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 594 | 1 | 64 | 1,745,757 | 27.22 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 187 | 853 | 32,579,050 | 172,558,444 | 187 | 391 | 0 | 91.24 | 19.46 | 6 | 89.97 | 67 | 136 | 67 | 1 | 75 | 15,992,408 | 43 | 105 | 1,151,000 | 11.35 | 27 | 111 | 1 | 67 | 
| pairing | 1 | 194 | 594 | 22,427,652 | 119,958,502 | 194 | 297 | 1 | 73.47 | 15.48 | 6 | 64.91 | 56 | 97 | 55 | 0 | 53 | 9,471,642 | 30 | 61 | 594,757 | 18.08 | 21 | 89 | 1 | 55 | 

...
|:---|---:|---:|---:|
| Total |  1.12 |  0.66 | 0.66 |
| fibonacci_program |  1.12 |  0.66 |  0.66 |


| fibonacci_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  554.50 |  1,109 |  650 |  459 |
...
| `execute_metered_insn_mi/s` |  113.48 | -          |  113.48 |  113.48 |
| `execute_preflight_insns` |  750,134.50 |  1,500,269 |  873,000 |  627,269 |
| `execute_preflight_time_ms` |  29 |  58 |  33 |  25 |
| `execute_preflight_insn_mi/s` |  37.78 | -          |  39.60 |  35.96 |
| `trace_gen_time_ms   ` |  191 |  382 |  198 |  184 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  229 |  458 |  257 |  201 |
| `main_trace_commit_time_ms` |  30.50 |  61 |  33 |  28 |
| `generate_perm_trace_time_ms` |  17 |  34 |  21 |  13 |
| `perm_trace_commit_time_ms` |  41.25 |  82.49 |  44.59 |  37.91 |
| `quotient_poly_compute_time_ms` |  32.88 |  65.76 |  35.22 |  30.53 |
| `quotient_poly_commit_time_ms` |  12.37 |  24.74 |  12.49 |  12.24 |
| `pcs_opening_time_ms ` |  92.50 |  185 |  108 |  77 |
...
| --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 459 | 1 | 13 | 1,500,269 | 113.48 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 198 | 650 | 9,680,746 | 84,399,632 | 198 | 257 | 0 | 35.22 | 12.49 | 4 | 44.59 | 108 | 66 | 108 | 0 | 33 | 1,038,336 | 21 | 25 | 873,000 | 35.96 | 14 | 48 | 0 | 108 | 
| fibonacci_program | 1 | 184 | 459 | 9,708,456 | 74,305,770 | 184 | 201 | 1 | 30.53 | 12.24 | 4 | 37.91 | 77 | 51 | 77 | 0 | 28 | 1,064,414 | 13 | 33 | 627,269 | 39.60 | 11 | 43 | 0 | 77 | 

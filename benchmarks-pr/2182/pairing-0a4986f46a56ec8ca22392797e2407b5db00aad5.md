...
| `total_proof_time_ms ` |  729 |  1,458 |  862 |  596 |
...
| `execute_preflight_time_ms` |  85.50 |  171 |  107 |  64 |
| `execute_preflight_insn_mi/s` |  14.32 | -          |  17.56 |  11.07 |
| `trace_gen_time_ms   ` |  189.50 |  379 |  191 |  188 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  348 |  696 |  397 |  299 |
| `main_trace_commit_time_ms` |  65.50 |  131 |  76 |  55 |
| `generate_perm_trace_time_ms` |  32.50 |  65 |  37 |  28 |
| `perm_trace_commit_time_ms` |  77.72 |  155.43 |  89.85 |  65.58 |
| `quotient_poly_compute_time_ms` |  83.21 |  166.42 |  92.38 |  74.04 |
| `quotient_poly_commit_time_ms` |  17.82 |  35.63 |  20.14 |  15.50 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 596 | 1 | 63 | 1,745,757 | 27.50 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 188 | 862 | 32,579,050 | 172,558,444 | 188 | 397 | 0 | 92.38 | 20.14 | 6 | 89.85 | 77 | 130 | 77 | 1 | 76 | 15,992,408 | 37 | 107 | 1,151,000 | 11.07 | 27 | 113 | 1 | 77 | 
| pairing | 1 | 191 | 596 | 22,427,652 | 119,958,502 | 191 | 299 | 1 | 74.04 | 15.50 | 6 | 65.58 | 55 | 97 | 55 | 0 | 55 | 9,471,642 | 28 | 64 | 594,757 | 17.56 | 21 | 90 | 1 | 55 | 

...
|:---|---:|---:|---:|
| Total |  1.51 |  0.92 | 0.92 |
| pairing |  1.51 |  0.92 |  0.92 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  723 |  1,446 |  852 |  594 |
...
| `execute_preflight_insn_mi/s` |  14.78 | -          |  18.29 |  11.27 |
| `trace_gen_time_ms   ` |  191 |  382 |  196 |  186 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  343.50 |  687 |  390 |  297 |
| `main_trace_commit_time_ms` |  63.50 |  127 |  74 |  53 |
| `generate_perm_trace_time_ms` |  32.50 |  65 |  36 |  29 |
| `perm_trace_commit_time_ms` |  77.04 |  154.09 |  88.76 |  65.32 |
| `quotient_poly_compute_time_ms` |  83.11 |  166.23 |  91.85 |  74.37 |
| `quotient_poly_commit_time_ms` |  16.82 |  33.64 |  18.19 |  15.45 |
| `pcs_opening_time_ms ` |  66 |  132 |  77 |  55 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 594 | 1 | 63 | 1,745,757 | 27.46 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 186 | 852 | 32,579,050 | 172,558,444 | 186 | 390 | 0 | 91.85 | 18.19 | 6 | 88.76 | 77 | 127 | 76 | 1 | 74 | 15,992,408 | 36 | 105 | 1,151,000 | 11.27 | 26 | 110 | 1 | 76 | 
| pairing | 1 | 196 | 594 | 22,427,652 | 119,958,502 | 196 | 297 | 1 | 74.37 | 15.45 | 5 | 65.32 | 55 | 97 | 55 | 0 | 53 | 9,471,642 | 29 | 60 | 594,757 | 18.29 | 21 | 90 | 1 | 55 | 

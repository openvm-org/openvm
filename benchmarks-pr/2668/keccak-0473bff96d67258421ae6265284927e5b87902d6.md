...
|:---|---:|---:|---:|
| Total |  19.25 |  5.41 |  5.41 |
| app_proof |  16.13 |  3.07 |  3.07 |
| leaf |  2.25 |  1.46 |  1.46 |
...
| `total_proof_time_ms ` |  2,681.67 |  16,090 |  3,031 |  2,562 |
| `execute_metered_time_ms` |  37 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  32.91 | -          |  32.91 |  32.91 |
| `execute_preflight_insns` |  205,869.67 |  1,235,218 |  207,000 |  200,218 |
| `execute_preflight_time_ms` |  231.17 |  1,387 |  387 |  17 |
| `execute_preflight_insn_mi/s` |  18.97 | -          |  19.20 |  18.55 |
| `trace_gen_time_ms   ` |  382.83 |  2,297 |  543 |  350 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  2,002.67 |  12,016 |  2,293 |  1,938 |
| `prover.main_trace_commit_time_ms` |  695.17 |  4,171 |  865 |  660 |
| `prover.rap_constraints_time_ms` |  1,123.83 |  6,743 |  1,243 |  1,095 |
| `prover.openings_time_ms` |  182.83 |  1,097 |  186 |  178 |
| `prover.rap_constraints.logup_gkr_time_ms` |  278.83 |  1,673 |  400 |  254 |
| `prover.rap_constraints.round0_time_ms` |  530.33 |  3,182 |  535 |  527 |
| `prover.rap_constraints.mle_rounds_time_ms` |  313.33 |  1,880 |  314 |  312 |
| `prover.openings.stacked_reduction_time_ms` |  140.33 |  842 |  143 |  138 |
| `prover.openings.stacked_reduction.round0_time_ms` |  84.33 |  506 |  86 |  83 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  55.17 |  331 |  58 |  54 |
| `prover.openings.whir_time_ms` |  42.33 |  254 |  45 |  40 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,126.50 |  2,253 |  1,464 |  789 |
| `execute_preflight_time_ms` |  4.50 |  9 |  5 |  4 |
| `trace_gen_time_ms   ` |  157.50 |  315 |  208 |  107 |
| `generate_blob_total_time_ms` |  25.50 |  51 |  34 |  17 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  968 |  1,936 |  1,255 |  681 |
| `prover.main_trace_commit_time_ms` |  546 |  1,092 |  720 |  372 |
| `prover.rap_constraints_time_ms` |  315.50 |  631 |  406 |  225 |
| `prover.openings_time_ms` |  105.50 |  211 |  128 |  83 |
...
| `prover.openings.whir_time_ms` |  37 |  74 |  42 |  32 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/0473bff96d67258421ae6265284927e5b87902d6/keccak-0473bff96d67258421ae6265284927e5b87902d6.memory.svg)
...
| app_proof |  |  |  |  |  | 2,562 |  |  | 37 | 1,235,218 | 32.91 | 0 | 16,136 |  | 
| internal_for_leaf |  |  |  | 531 |  |  |  |  |  |  |  |  |  | 532 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 43 | 531 | 42 | 15 | 5 | 2 | 2 | 2 | 
| internal_recursive.0 | 1 | 15 | 190 | 15 | 2 | 1 | 2 | 2 | 2 | 
| internal_recursive.1 | 1 | 10 | 154 | 10 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 208 | 1,464 | 207 | 70 | 34 | 5 | 9 | 9 | 
| leaf | 1 | 107 | 789 | 107 | 37 | 17 | 4 | 10 | 10 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 109,497,984 | 488 | 245 | 0 | 14 | 177 | 48 | 48 | 95 | 33 | 0 | 65 | 25 | 39 | 7 | 31 | 245 | 177 | 0 | 2 | 32 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 25,962,119 | 174 | 50 | 0 | 4 | 78 | 24 | 24 | 30 | 22 | 0 | 45 | 20 | 24 | 2 | 22 | 51 | 78 | 0 | 2 | 22 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 17,507,975 | 143 | 33 | 0 | 4 | 66 | 23 | 22 | 25 | 17 | 0 | 43 | 19 | 23 | 1 | 21 | 34 | 66 | 0 | 2 | 16 | 0 | 0 | 
| leaf | 0 | prover | 583,523,386 | 1,255 | 719 | 0 | 47 | 406 | 201 | 200 | 121 | 83 | 0 | 128 | 42 | 86 | 40 | 45 | 720 | 406 | 0 | 6 | 81 | 0 | 0 | 
| leaf | 1 | prover | 300,618,208 | 681 | 371 | 0 | 24 | 225 | 106 | 105 | 67 | 51 | 0 | 83 | 32 | 51 | 19 | 31 | 372 | 225 | 0 | 5 | 50 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,205,061,845 | 2,293 | 864 | 0 | 257 | 1,243 | 528 | 527 | 314 | 400 | 142 | 184 | 41 | 143 | 84 | 58 | 865 | 1,243 | 0 | 3 | 256 | 0 | 0 | 
| app_proof | prover | 1 | 1,205,053,652 | 1,941 | 659 | 0 | 52 | 1,096 | 528 | 528 | 313 | 254 | 0 | 184 | 44 | 140 | 85 | 54 | 660 | 1,096 | 0 | 3 | 253 | 0 | 0 | 
| app_proof | prover | 2 | 1,205,053,652 | 1,938 | 661 | 0 | 51 | 1,095 | 527 | 527 | 313 | 254 | 0 | 180 | 41 | 139 | 84 | 54 | 662 | 1,095 | 0 | 4 | 253 | 0 | 0 | 
| app_proof | prover | 3 | 1,205,053,652 | 1,943 | 661 | 0 | 51 | 1,103 | 533 | 533 | 314 | 255 | 0 | 178 | 40 | 138 | 83 | 54 | 661 | 1,103 | 0 | 3 | 253 | 0 | 0 | 
| app_proof | prover | 4 | 1,205,053,652 | 1,952 | 662 | 0 | 51 | 1,104 | 535 | 534 | 312 | 255 | 0 | 185 | 43 | 141 | 86 | 55 | 662 | 1,104 | 0 | 3 | 253 | 0 | 0 | 
| app_proof | prover | 5 | 1,205,062,652 | 1,949 | 660 | 0 | 52 | 1,102 | 531 | 531 | 314 | 255 | 0 | 186 | 45 | 141 | 84 | 56 | 661 | 1,102 | 0 | 3 | 254 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 543 | 3,031 | 543 | 176 | 0 | 4 | 17 | 207,000 | 18.55 | 
| app_proof | 1 | 351 | 2,722 | 351 | 41 | 0 | 1 | 387 | 207,000 | 18.94 | 
| app_proof | 2 | 351 | 2,590 | 351 | 41 | 0 | 1 | 259 | 207,000 | 19.17 | 
| app_proof | 3 | 351 | 2,590 | 351 | 41 | 0 | 1 | 254 | 207,000 | 18.92 | 
| app_proof | 4 | 351 | 2,595 | 351 | 41 | 0 | 1 | 250 | 207,000 | 19.07 | 
| app_proof | 5 | 350 | 2,562 | 350 | 41 | 0 | 1 | 220 | 200,218 | 19.20 | 

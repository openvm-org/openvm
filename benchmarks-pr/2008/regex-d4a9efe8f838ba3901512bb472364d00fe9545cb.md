...
| `total_proof_time_ms ` |  3,818.50 |  7,637 |  4,894 |  2,743 |
...
| `execute_preflight_insn_mi/s` |  28.64 | -          |  31.03 |  26.25 |
| `trace_gen_time_ms   ` |  402 |  804 |  515 |  289 |
| `memory_finalize_time_ms` |  7.50 |  15 |  13 |  2 |
| `stark_prove_excluding_trace_time_ms` |  3,097.50 |  6,195 |  4,039 |  2,156 |
| `main_trace_commit_time_ms` |  622 |  1,244 |  833 |  411 |
| `generate_perm_trace_time_ms` |  241.50 |  483 |  316 |  167 |
| `perm_trace_commit_time_ms` |  655.50 |  1,311 |  852 |  459 |
| `quotient_poly_compute_time_ms` |  326 |  652 |  454 |  198 |
| `quotient_poly_commit_time_ms` |  297.50 |  595 |  389 |  206 |
| `pcs_opening_time_ms ` |  948 |  1,896 |  1,190 |  706 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2,743 | 8 | 1 | 31 | 4,108,597 | 129.16 | 45 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 515 | 4,894 | 211,758,557 | 373,183,036 | 515 | 4,039 | 0 | 454 | 389 | 852 | 1,190 | 7 | 13 | 833 | 91,281,687 | 316 | 101 | 2,211,000 | 26.25 | 
| regex_program | 1 | 289 | 2,743 | 174,326,267 | 196,838,026 | 289 | 2,156 | 55 | 198 | 206 | 459 | 706 | 6 | 2 | 411 | 73,453,305 | 167 | 85 | 1,897,597 | 31.03 | 

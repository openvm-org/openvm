...
| `total_proof_time_ms ` |  3,808 |  7,616 |  4,876 |  2,740 |
...
| `execute_preflight_insn_mi/s` |  28.46 | -          |  30.94 |  25.98 |
| `trace_gen_time_ms   ` |  402 |  804 |  512 |  292 |
| `memory_finalize_time_ms` |  8 |  16 |  13 |  3 |
| `stark_prove_excluding_trace_time_ms` |  3,081.50 |  6,163 |  4,017 |  2,146 |
| `main_trace_commit_time_ms` |  627 |  1,254 |  839 |  415 |
| `generate_perm_trace_time_ms` |  224 |  448 |  297 |  151 |
| `perm_trace_commit_time_ms` |  648 |  1,296 |  847 |  449 |
| `quotient_poly_compute_time_ms` |  318.50 |  637 |  438 |  199 |
| `quotient_poly_commit_time_ms` |  302.50 |  605 |  400 |  205 |
| `pcs_opening_time_ms ` |  954.50 |  1,909 |  1,191 |  718 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2,740 | 6 | 1 | 31 | 4,108,597 | 129.77 | 45 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 512 | 4,876 | 211,758,557 | 373,183,036 | 511 | 4,017 | 0 | 438 | 400 | 847 | 1,191 | 8 | 13 | 839 | 91,281,687 | 297 | 104 | 2,211,000 | 25.98 | 
| regex_program | 1 | 292 | 2,740 | 174,326,267 | 196,838,026 | 292 | 2,146 | 56 | 199 | 205 | 449 | 718 | 6 | 3 | 415 | 73,453,305 | 151 | 85 | 1,897,597 | 30.94 | 

...
| `total_proof_time_ms ` |  3,805.50 |  7,611 |  4,890 |  2,721 |
...
| `execute_preflight_insn_mi/s` |  28.74 | -          |  31.18 |  26.31 |
| `trace_gen_time_ms   ` |  387.50 |  775 |  499 |  276 |
| `memory_finalize_time_ms` |  7.50 |  15 |  13 |  2 |
| `stark_prove_excluding_trace_time_ms` |  3,097 |  6,194 |  4,046 |  2,148 |
| `main_trace_commit_time_ms` |  632 |  1,264 |  850 |  414 |
| `generate_perm_trace_time_ms` |  238 |  476 |  323 |  153 |
| `perm_trace_commit_time_ms` |  648 |  1,296 |  846 |  450 |
| `quotient_poly_compute_time_ms` |  320.50 |  641 |  438 |  203 |
| `quotient_poly_commit_time_ms` |  301 |  602 |  397 |  205 |
| `pcs_opening_time_ms ` |  950.50 |  1,901 |  1,188 |  713 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2,721 | 6 | 1 | 31 | 4,108,597 | 129.37 | 45 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 499 | 4,890 | 211,758,557 | 373,183,036 | 499 | 4,046 | 0 | 438 | 397 | 846 | 1,188 | 7 | 13 | 850 | 91,281,687 | 323 | 103 | 2,211,000 | 26.31 | 
| regex_program | 1 | 276 | 2,721 | 174,326,267 | 196,838,026 | 276 | 2,148 | 52 | 203 | 205 | 450 | 713 | 8 | 2 | 414 | 73,453,305 | 153 | 84 | 1,897,597 | 31.18 | 

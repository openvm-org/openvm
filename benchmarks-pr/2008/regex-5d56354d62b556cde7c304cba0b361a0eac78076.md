...
| `total_proof_time_ms ` |  3,782.50 |  7,565 |  4,835 |  2,730 |
...
| `execute_preflight_time_ms` |  91.50 |  183 |  99 |  84 |
| `execute_preflight_insn_mi/s` |  28.61 | -          |  31.04 |  26.17 |
| `trace_gen_time_ms   ` |  381 |  762 |  488 |  274 |
| `memory_finalize_time_ms` |  7 |  14 |  12 |  2 |
| `stark_prove_excluding_trace_time_ms` |  3,083 |  6,166 |  4,006 |  2,160 |
| `main_trace_commit_time_ms` |  626 |  1,252 |  839 |  413 |
| `generate_perm_trace_time_ms` |  228 |  456 |  293 |  163 |
| `perm_trace_commit_time_ms` |  648.50 |  1,297 |  850 |  447 |
| `quotient_poly_compute_time_ms` |  317.50 |  635 |  431 |  204 |
| `quotient_poly_commit_time_ms` |  301.50 |  603 |  398 |  205 |
| `pcs_opening_time_ms ` |  953.50 |  1,907 |  1,189 |  718 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2,730 | 6 | 1 | 32 | 4,108,597 | 128.09 | 44 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 488 | 4,835 | 211,758,557 | 373,183,036 | 488 | 4,006 | 0 | 431 | 398 | 850 | 1,189 | 7 | 12 | 839 | 91,281,687 | 293 | 99 | 2,211,000 | 26.17 | 
| regex_program | 1 | 274 | 2,730 | 174,326,267 | 196,838,026 | 274 | 2,160 | 50 | 204 | 205 | 447 | 718 | 6 | 2 | 413 | 73,453,305 | 163 | 84 | 1,897,597 | 31.04 | 

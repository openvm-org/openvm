...
| `total_proof_time_ms ` |  3,815 |  7,630 |  4,881 |  2,749 |
...
| `execute_metered_insn_mi/s` |  129.01 | -          |  129.01 |  129.01 |
| `execute_preflight_insns` |  2,054,298.50 |  4,108,597 |  2,211,000 |  1,897,597 |
| `execute_preflight_time_ms` |  92 |  184 |  101 |  83 |
| `execute_preflight_insn_mi/s` |  28.64 | -          |  31.13 |  26.14 |
| `trace_gen_time_ms   ` |  389.50 |  779 |  500 |  279 |
| `memory_finalize_time_ms` |  7.50 |  15 |  13 |  2 |
| `stark_prove_excluding_trace_time_ms` |  3,102 |  6,204 |  4,034 |  2,170 |
| `main_trace_commit_time_ms` |  638.50 |  1,277 |  847 |  430 |
| `generate_perm_trace_time_ms` |  227 |  454 |  301 |  153 |
| `perm_trace_commit_time_ms` |  650.50 |  1,301 |  851 |  450 |
| `quotient_poly_compute_time_ms` |  316.50 |  633 |  431 |  202 |
| `quotient_poly_commit_time_ms` |  302.50 |  605 |  398 |  207 |
| `pcs_opening_time_ms ` |  958.50 |  1,917 |  1,199 |  718 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2,749 | 6 | 1 | 31 | 4,108,597 | 129.01 | 44 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 500 | 4,881 | 211,758,557 | 373,183,036 | 500 | 4,034 | 0 | 431 | 398 | 851 | 1,199 | 7 | 13 | 847 | 91,281,687 | 301 | 101 | 2,211,000 | 26.14 | 
| regex_program | 1 | 279 | 2,749 | 174,326,267 | 196,838,026 | 279 | 2,170 | 52 | 202 | 207 | 450 | 718 | 6 | 2 | 430 | 73,453,305 | 153 | 83 | 1,897,597 | 31.13 | 
...
Commit: https://github.com/openvm-org/openvm/commit/54fecf028ff5f486a9bc02fc2dda54194c4d7a25
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/17109532600)

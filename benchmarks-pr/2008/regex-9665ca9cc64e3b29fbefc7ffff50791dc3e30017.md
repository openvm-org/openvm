...
|:---|---:|---:|
| Total |  7.62 |  4.90 |
| regex_program |  7.59 |  4.87 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  3,792.50 |  7,585 |  4,874 |  2,711 |
...
| `execute_metered_insn_mi/s` |  131.10 | -          |  131.10 |  131.10 |
| `execute_preflight_insns` |  2,054,298.50 |  4,108,597 |  2,211,000 |  1,897,597 |
| `execute_preflight_time_ms` |  93 |  186 |  103 |  83 |
| `execute_preflight_insn_mi/s` |  28.36 | -          |  31.20 |  25.53 |
| `trace_gen_time_ms   ` |  377.50 |  755 |  485 |  270 |
| `memory_finalize_time_ms` |  7.50 |  15 |  13 |  2 |
| `stark_prove_excluding_trace_time_ms` |  3,091 |  6,182 |  4,041 |  2,141 |
| `main_trace_commit_time_ms` |  619 |  1,238 |  836 |  402 |
| `generate_perm_trace_time_ms` |  239.50 |  479 |  323 |  156 |
| `perm_trace_commit_time_ms` |  647 |  1,294 |  848 |  446 |
| `quotient_poly_compute_time_ms` |  317 |  634 |  430 |  204 |
| `quotient_poly_commit_time_ms` |  308 |  616 |  406 |  210 |
| `pcs_opening_time_ms ` |  952.50 |  1,905 |  1,193 |  712 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2,711 | 6 | 1 | 31 | 4,108,597 | 131.10 | 45 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 485 | 4,874 | 211,758,557 | 373,183,036 | 485 | 4,041 | 0 | 430 | 406 | 848 | 1,193 | 7 | 13 | 836 | 91,281,687 | 323 | 103 | 2,211,000 | 25.53 | 
| regex_program | 1 | 270 | 2,711 | 174,326,267 | 196,838,026 | 270 | 2,141 | 50 | 204 | 210 | 446 | 712 | 7 | 2 | 402 | 73,453,305 | 156 | 83 | 1,897,597 | 31.20 | 

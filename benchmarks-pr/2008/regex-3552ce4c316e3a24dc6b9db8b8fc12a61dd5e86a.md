...
|:---|---:|---:|
| Total |  7.64 |  4.90 |
| regex_program |  7.61 |  4.87 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  3,806.50 |  7,613 |  4,868 |  2,745 |
...
| `execute_preflight_insn_mi/s` |  28.61 | -          |  31.10 |  26.13 |
| `trace_gen_time_ms   ` |  389 |  778 |  497 |  281 |
| `memory_finalize_time_ms` |  7.50 |  15 |  13 |  2 |
| `stark_prove_excluding_trace_time_ms` |  3,094.50 |  6,189 |  4,026 |  2,163 |
| `main_trace_commit_time_ms` |  611.50 |  1,223 |  836 |  387 |
| `generate_perm_trace_time_ms` |  225.50 |  451 |  301 |  150 |
| `perm_trace_commit_time_ms` |  673.50 |  1,347 |  855 |  492 |
| `quotient_poly_compute_time_ms` |  319 |  638 |  424 |  214 |
| `quotient_poly_commit_time_ms` |  299.50 |  599 |  405 |  194 |
| `pcs_opening_time_ms ` |  956.50 |  1,913 |  1,197 |  716 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2,745 | 6 | 1 | 31 | 4,108,597 | 129.05 | 45 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 497 | 4,868 | 211,758,557 | 373,183,036 | 497 | 4,026 | 0 | 424 | 405 | 855 | 1,197 | 7 | 13 | 836 | 91,281,687 | 301 | 102 | 2,211,000 | 26.13 | 
| regex_program | 1 | 281 | 2,745 | 174,326,267 | 196,838,026 | 281 | 2,163 | 53 | 214 | 194 | 492 | 716 | 6 | 2 | 387 | 73,453,305 | 150 | 84 | 1,897,597 | 31.10 | 

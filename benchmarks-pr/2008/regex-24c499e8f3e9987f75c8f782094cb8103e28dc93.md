...
|:---|---:|---:|
| Total |  7.69 |  4.92 |
| regex_program |  7.66 |  4.89 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  3,828 |  7,656 |  4,887 |  2,769 |
...
| `execute_preflight_insn_mi/s` |  28.82 | -          |  31.26 |  26.38 |
| `trace_gen_time_ms   ` |  403.50 |  807 |  514 |  293 |
| `memory_finalize_time_ms` |  7.50 |  15 |  13 |  2 |
| `stark_prove_excluding_trace_time_ms` |  3,105 |  6,210 |  4,031 |  2,179 |
| `main_trace_commit_time_ms` |  635 |  1,270 |  854 |  416 |
| `generate_perm_trace_time_ms` |  232 |  464 |  300 |  164 |
| `perm_trace_commit_time_ms` |  649 |  1,298 |  849 |  449 |
| `quotient_poly_compute_time_ms` |  314.50 |  629 |  429 |  200 |
| `quotient_poly_commit_time_ms` |  307.50 |  615 |  399 |  216 |
| `pcs_opening_time_ms ` |  959 |  1,918 |  1,195 |  723 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2,769 | 6 | 1 | 31 | 4,108,597 | 128.83 | 44 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 514 | 4,887 | 211,758,557 | 373,183,036 | 513 | 4,031 | 0 | 429 | 399 | 849 | 1,195 | 8 | 13 | 854 | 91,281,687 | 300 | 100 | 2,211,000 | 26.38 | 
| regex_program | 1 | 293 | 2,769 | 174,326,267 | 196,838,026 | 293 | 2,179 | 56 | 200 | 216 | 449 | 723 | 6 | 2 | 416 | 73,453,305 | 164 | 83 | 1,897,597 | 31.26 | 

...
| `total_proof_time_ms ` |  3,798.50 |  7,597 |  4,861 |  2,736 |
...
| `execute_preflight_insn_mi/s` |  28.49 | -          |  30.99 |  25.99 |
| `trace_gen_time_ms   ` |  392 |  784 |  501 |  283 |
| `memory_finalize_time_ms` |  8 |  16 |  14 |  2 |
| `stark_prove_excluding_trace_time_ms` |  3,084 |  6,168 |  4,014 |  2,154 |
| `main_trace_commit_time_ms` |  611 |  1,222 |  834 |  388 |
| `generate_perm_trace_time_ms` |  221.50 |  443 |  293 |  150 |
| `perm_trace_commit_time_ms` |  650 |  1,300 |  851 |  449 |
| `quotient_poly_compute_time_ms` |  318 |  636 |  430 |  206 |
| `quotient_poly_commit_time_ms` |  299 |  598 |  403 |  195 |
| `pcs_opening_time_ms ` |  974.50 |  1,949 |  1,197 |  752 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2,736 | 6 | 1 | 31 | 4,108,597 | 129.35 | 44 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 501 | 4,861 | 211,758,557 | 373,183,036 | 501 | 4,014 | 0 | 430 | 403 | 851 | 1,197 | 8 | 14 | 834 | 91,281,687 | 293 | 104 | 2,211,000 | 25.99 | 
| regex_program | 1 | 283 | 2,736 | 174,326,267 | 196,838,026 | 283 | 2,154 | 53 | 206 | 195 | 449 | 752 | 6 | 2 | 388 | 73,453,305 | 150 | 84 | 1,897,597 | 30.99 | 

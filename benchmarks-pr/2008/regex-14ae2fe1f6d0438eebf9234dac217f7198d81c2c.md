...
|:---|---:|---:|
| Total |  7.63 |  4.87 |
| regex_program |  7.60 |  4.84 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  3,798.50 |  7,597 |  4,839 |  2,758 |
...
| `execute_preflight_insn_mi/s` |  28.57 | -          |  31.16 |  25.99 |
| `trace_gen_time_ms   ` |  382.50 |  765 |  491 |  274 |
| `memory_finalize_time_ms` |  7.50 |  15 |  13 |  2 |
| `stark_prove_excluding_trace_time_ms` |  3,094.50 |  6,189 |  4,004 |  2,185 |
| `main_trace_commit_time_ms` |  621.50 |  1,243 |  843 |  400 |
| `generate_perm_trace_time_ms` |  230 |  460 |  295 |  165 |
| `perm_trace_commit_time_ms` |  665 |  1,330 |  849 |  481 |
| `quotient_poly_compute_time_ms` |  317 |  634 |  426 |  208 |
| `quotient_poly_commit_time_ms` |  301.50 |  603 |  397 |  206 |
| `pcs_opening_time_ms ` |  952 |  1,904 |  1,189 |  715 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2,758 | 6 | 1 | 31 | 4,108,597 | 130.41 | 44 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 491 | 4,839 | 211,758,557 | 373,183,036 | 491 | 4,004 | 0 | 426 | 397 | 849 | 1,189 | 7 | 13 | 843 | 91,281,687 | 295 | 101 | 2,211,000 | 25.99 | 
| regex_program | 1 | 274 | 2,758 | 174,326,267 | 196,838,026 | 274 | 2,185 | 51 | 208 | 206 | 481 | 715 | 6 | 2 | 400 | 73,453,305 | 165 | 83 | 1,897,597 | 31.16 | 

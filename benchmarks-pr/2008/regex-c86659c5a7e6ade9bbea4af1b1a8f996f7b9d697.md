...
|:---|---:|---:|
| Total |  7.56 |  4.87 |
| regex_program |  7.53 |  4.84 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  3,766.50 |  7,533 |  4,838 |  2,695 |
...
| `execute_metered_insn_mi/s` |  132.02 | -          |  132.02 |  132.02 |
| `execute_preflight_insns` |  2,054,298.50 |  4,108,597 |  2,211,000 |  1,897,597 |
| `execute_preflight_time_ms` |  92 |  184 |  100 |  84 |
| `execute_preflight_insn_mi/s` |  28.53 | -          |  30.97 |  26.09 |
| `trace_gen_time_ms   ` |  382.50 |  765 |  490 |  275 |
| `memory_finalize_time_ms` |  7.50 |  15 |  13 |  2 |
| `stark_prove_excluding_trace_time_ms` |  3,070 |  6,140 |  4,011 |  2,129 |
| `main_trace_commit_time_ms` |  616.50 |  1,233 |  837 |  396 |
| `generate_perm_trace_time_ms` |  225 |  450 |  299 |  151 |
| `perm_trace_commit_time_ms` |  648 |  1,296 |  847 |  449 |
| `quotient_poly_compute_time_ms` |  325 |  650 |  440 |  210 |
| `quotient_poly_commit_time_ms` |  299 |  598 |  394 |  204 |
| `pcs_opening_time_ms ` |  948 |  1,896 |  1,188 |  708 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2,695 | 6 | 1 | 31 | 4,108,597 | 132.02 | 44 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 490 | 4,838 | 211,758,557 | 373,183,036 | 490 | 4,011 | 0 | 440 | 394 | 847 | 1,188 | 7 | 13 | 837 | 91,281,687 | 299 | 100 | 2,211,000 | 26.09 | 
| regex_program | 1 | 275 | 2,695 | 174,326,267 | 196,838,026 | 275 | 2,129 | 51 | 210 | 204 | 449 | 708 | 8 | 2 | 396 | 73,453,305 | 151 | 84 | 1,897,597 | 30.97 | 

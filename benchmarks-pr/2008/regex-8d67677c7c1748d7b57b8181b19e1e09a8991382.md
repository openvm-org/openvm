...
| `total_proof_time_ms ` |  3,836.50 |  7,673 |  4,882 |  2,791 |
...
| `execute_preflight_insn_mi/s` |  28.61 | -          |  31.02 |  26.20 |
| `trace_gen_time_ms   ` |  394 |  788 |  503 |  285 |
| `memory_finalize_time_ms` |  8.50 |  17 |  15 |  2 |
| `stark_prove_excluding_trace_time_ms` |  3,123.50 |  6,247 |  4,039 |  2,208 |
| `main_trace_commit_time_ms` |  630.50 |  1,261 |  847 |  414 |
| `generate_perm_trace_time_ms` |  223.50 |  447 |  297 |  150 |
| `perm_trace_commit_time_ms` |  673.50 |  1,347 |  851 |  496 |
| `quotient_poly_compute_time_ms` |  319 |  638 |  436 |  202 |
| `quotient_poly_commit_time_ms` |  306 |  612 |  404 |  208 |
| `pcs_opening_time_ms ` |  962 |  1,924 |  1,198 |  726 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2,791 | 6 | 1 | 31 | 4,108,597 | 130.66 | 44 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 503 | 4,882 | 211,758,557 | 373,183,036 | 503 | 4,039 | 0 | 436 | 404 | 851 | 1,198 | 8 | 15 | 847 | 91,281,687 | 297 | 103 | 2,211,000 | 26.20 | 
| regex_program | 1 | 285 | 2,791 | 174,326,267 | 196,838,026 | 285 | 2,208 | 53 | 202 | 208 | 496 | 726 | 6 | 2 | 414 | 73,453,305 | 150 | 85 | 1,897,597 | 31.02 | 

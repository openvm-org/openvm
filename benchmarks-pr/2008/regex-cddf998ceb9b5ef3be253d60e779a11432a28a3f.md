...
|:---|---:|---:|
| Total |  7.56 |  4.85 |
| regex_program |  7.53 |  4.82 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  3,763.50 |  7,527 |  4,820 |  2,707 |
...
| `execute_metered_insn_mi/s` |  130.100 | -          |  130.100 |  130.100 |
| `execute_preflight_insns` |  2,054,298.50 |  4,108,597 |  2,211,000 |  1,897,597 |
| `execute_preflight_time_ms` |  93 |  186 |  99 |  87 |
| `execute_preflight_insn_mi/s` |  28.78 | -          |  31.28 |  26.28 |
| `trace_gen_time_ms   ` |  381.50 |  763 |  492 |  271 |
| `memory_finalize_time_ms` |  7 |  14 |  12 |  2 |
| `stark_prove_excluding_trace_time_ms` |  3,060 |  6,120 |  3,988 |  2,132 |
| `main_trace_commit_time_ms` |  621 |  1,242 |  834 |  408 |
| `generate_perm_trace_time_ms` |  223.50 |  447 |  297 |  150 |
| `perm_trace_commit_time_ms` |  649 |  1,298 |  849 |  449 |
| `quotient_poly_compute_time_ms` |  316 |  632 |  428 |  204 |
| `quotient_poly_commit_time_ms` |  300 |  600 |  398 |  202 |
| `pcs_opening_time_ms ` |  943.50 |  1,887 |  1,177 |  710 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2,707 | 6 | 1 | 31 | 4,108,597 | 130.100 | 44 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 492 | 4,820 | 211,758,557 | 373,183,036 | 492 | 3,988 | 0 | 428 | 398 | 849 | 1,177 | 7 | 12 | 834 | 91,281,687 | 297 | 99 | 2,211,000 | 26.28 | 
| regex_program | 1 | 271 | 2,707 | 174,326,267 | 196,838,026 | 271 | 2,132 | 50 | 204 | 202 | 449 | 710 | 6 | 2 | 408 | 73,453,305 | 150 | 87 | 1,897,597 | 31.28 | 
...
Commit: https://github.com/openvm-org/openvm/commit/cddf998ceb9b5ef3be253d60e779a11432a28a3f
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/17104860211)

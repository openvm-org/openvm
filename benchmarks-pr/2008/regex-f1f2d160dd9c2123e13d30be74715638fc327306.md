...
| `execute_preflight_insn_mi/s` |  28.71 | -          |  31.28 |  26.15 |
| `trace_gen_time_ms   ` |  387 |  774 |  501 |  273 |
| `memory_finalize_time_ms` |  7.50 |  15 |  13 |  2 |
| `stark_prove_excluding_trace_time_ms` |  3,108.50 |  6,217 |  4,052 |  2,165 |
| `main_trace_commit_time_ms` |  635 |  1,270 |  852 |  418 |
| `generate_perm_trace_time_ms` |  229 |  458 |  303 |  155 |
| `perm_trace_commit_time_ms` |  651.50 |  1,303 |  851 |  452 |
| `quotient_poly_compute_time_ms` |  316 |  632 |  428 |  204 |
| `quotient_poly_commit_time_ms` |  305.50 |  611 |  406 |  205 |
| `pcs_opening_time_ms ` |  965 |  1,930 |  1,207 |  723 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2,739 | 6 | 1 | 31 | 4,108,597 | 130.08 | 46 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 501 | 4,899 | 211,758,557 | 373,183,036 | 501 | 4,052 | 0 | 428 | 406 | 851 | 1,207 | 7 | 13 | 852 | 91,281,687 | 303 | 100 | 2,211,000 | 26.15 | 
| regex_program | 1 | 273 | 2,739 | 174,326,267 | 196,838,026 | 273 | 2,165 | 51 | 204 | 205 | 452 | 723 | 8 | 2 | 418 | 73,453,305 | 155 | 83 | 1,897,597 | 31.28 | 

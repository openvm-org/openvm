...
|:---|---:|---:|
| Total |  7.68 |  4.96 |
| regex_program |  7.65 |  4.93 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  3,826 |  7,652 |  4,927 |  2,725 |
...
| `execute_preflight_insn_mi/s` |  28.15 | -          |  30.89 |  25.41 |
| `trace_gen_time_ms   ` |  392.50 |  785 |  503 |  282 |
| `memory_finalize_time_ms` |  7.50 |  15 |  13 |  2 |
| `stark_prove_excluding_trace_time_ms` |  3,110.50 |  6,221 |  4,076 |  2,145 |
| `main_trace_commit_time_ms` |  629.50 |  1,259 |  843 |  416 |
| `generate_perm_trace_time_ms` |  241 |  482 |  337 |  145 |
| `perm_trace_commit_time_ms` |  651.50 |  1,303 |  853 |  450 |
| `quotient_poly_compute_time_ms` |  316.50 |  633 |  427 |  206 |
| `quotient_poly_commit_time_ms` |  301 |  602 |  401 |  201 |
| `pcs_opening_time_ms ` |  962.50 |  1,925 |  1,207 |  718 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2,725 | 6 | 1 | 32 | 4,108,597 | 128.14 | 44 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 503 | 4,927 | 211,758,557 | 373,183,036 | 503 | 4,076 | 0 | 427 | 401 | 853 | 1,207 | 7 | 13 | 843 | 91,281,687 | 337 | 104 | 2,211,000 | 25.41 | 
| regex_program | 1 | 282 | 2,725 | 174,326,267 | 196,838,026 | 282 | 2,145 | 53 | 206 | 201 | 450 | 718 | 8 | 2 | 416 | 73,453,305 | 145 | 84 | 1,897,597 | 30.89 | 

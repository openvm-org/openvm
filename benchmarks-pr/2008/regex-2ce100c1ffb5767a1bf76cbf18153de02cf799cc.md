...
| `total_proof_time_ms ` |  3,837 |  7,674 |  4,897 |  2,777 |
...
| `execute_preflight_time_ms` |  96 |  192 |  105 |  87 |
| `execute_preflight_insn_mi/s` |  28.39 | -          |  30.92 |  25.85 |
| `trace_gen_time_ms   ` |  394.50 |  789 |  504 |  285 |
| `memory_finalize_time_ms` |  8 |  16 |  14 |  2 |
| `stark_prove_excluding_trace_time_ms` |  3,112.50 |  6,225 |  4,041 |  2,184 |
| `main_trace_commit_time_ms` |  627 |  1,254 |  844 |  410 |
| `generate_perm_trace_time_ms` |  231 |  462 |  309 |  153 |
| `perm_trace_commit_time_ms` |  662.50 |  1,325 |  851 |  474 |
| `quotient_poly_compute_time_ms` |  312 |  624 |  426 |  198 |
| `quotient_poly_commit_time_ms` |  307 |  614 |  404 |  210 |
| `pcs_opening_time_ms ` |  964.50 |  1,929 |  1,202 |  727 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2,777 | 6 | 1 | 31 | 4,108,597 | 128.43 | 45 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 504 | 4,897 | 211,758,557 | 373,183,036 | 504 | 4,041 | 0 | 426 | 404 | 851 | 1,202 | 7 | 14 | 844 | 91,281,687 | 309 | 105 | 2,211,000 | 25.85 | 
| regex_program | 1 | 285 | 2,777 | 174,326,267 | 196,838,026 | 285 | 2,184 | 53 | 198 | 210 | 474 | 727 | 6 | 2 | 410 | 73,453,305 | 153 | 87 | 1,897,597 | 30.92 | 

...
|:---|---:|---:|
| Total |  7.61 |  4.88 |
| regex_program |  7.58 |  4.85 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  3,791.50 |  7,583 |  4,849 |  2,734 |
...
| `execute_preflight_insn_mi/s` |  28.43 | -          |  30.90 |  25.96 |
| `trace_gen_time_ms   ` |  378.50 |  757 |  486 |  271 |
| `memory_finalize_time_ms` |  7.50 |  15 |  13 |  2 |
| `stark_prove_excluding_trace_time_ms` |  3,090 |  6,180 |  4,018 |  2,162 |
| `main_trace_commit_time_ms` |  627 |  1,254 |  838 |  416 |
| `generate_perm_trace_time_ms` |  231.50 |  463 |  303 |  160 |
| `perm_trace_commit_time_ms` |  648.50 |  1,297 |  848 |  449 |
| `quotient_poly_compute_time_ms` |  316 |  632 |  432 |  200 |
| `quotient_poly_commit_time_ms` |  302 |  604 |  397 |  207 |
| `pcs_opening_time_ms ` |  957.50 |  1,915 |  1,195 |  720 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2,734 | 6 | 1 | 31 | 4,108,597 | 129.18 | 45 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 486 | 4,849 | 211,758,557 | 373,183,036 | 486 | 4,018 | 0 | 432 | 397 | 848 | 1,195 | 7 | 13 | 838 | 91,281,687 | 303 | 103 | 2,211,000 | 25.96 | 
| regex_program | 1 | 271 | 2,734 | 174,326,267 | 196,838,026 | 271 | 2,162 | 50 | 200 | 207 | 449 | 720 | 6 | 2 | 416 | 73,453,305 | 160 | 85 | 1,897,597 | 30.90 | 

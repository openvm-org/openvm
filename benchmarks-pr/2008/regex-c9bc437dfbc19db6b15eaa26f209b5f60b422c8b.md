...
|:---|---:|---:|
| Total |  7.74 |  4.91 |
| regex_program |  7.71 |  4.88 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  3,853.50 |  7,707 |  4,877 |  2,830 |
...
| `execute_preflight_insn_mi/s` |  28.69 | -          |  31.19 |  26.19 |
| `trace_gen_time_ms   ` |  394 |  788 |  503 |  285 |
| `memory_finalize_time_ms` |  8.50 |  17 |  15 |  2 |
| `stark_prove_excluding_trace_time_ms` |  3,135 |  6,270 |  4,032 |  2,238 |
| `main_trace_commit_time_ms` |  620.50 |  1,241 |  835 |  406 |
| `generate_perm_trace_time_ms` |  237.50 |  475 |  305 |  170 |
| `perm_trace_commit_time_ms` |  678 |  1,356 |  874 |  482 |
| `quotient_poly_compute_time_ms` |  322 |  644 |  428 |  216 |
| `quotient_poly_commit_time_ms` |  298 |  596 |  396 |  200 |
| `pcs_opening_time_ms ` |  970 |  1,940 |  1,188 |  752 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2,830 | 6 | 1 | 31 | 4,108,597 | 130.05 | 44 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 503 | 4,877 | 211,758,557 | 373,183,036 | 503 | 4,032 | 0 | 428 | 396 | 874 | 1,188 | 7 | 15 | 835 | 91,281,687 | 305 | 102 | 2,211,000 | 26.19 | 
| regex_program | 1 | 285 | 2,830 | 174,326,267 | 196,838,026 | 285 | 2,238 | 53 | 216 | 200 | 482 | 752 | 7 | 2 | 406 | 73,453,305 | 170 | 84 | 1,897,597 | 31.19 | 

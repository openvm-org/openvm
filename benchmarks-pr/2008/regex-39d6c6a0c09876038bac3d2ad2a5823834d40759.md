...
| `total_proof_time_ms ` |  3,811 |  7,622 |  4,889 |  2,733 |
...
| `execute_preflight_insn_mi/s` |  28.66 | -          |  31.08 |  26.24 |
| `trace_gen_time_ms   ` |  404 |  808 |  513 |  295 |
| `memory_finalize_time_ms` |  8 |  16 |  14 |  2 |
| `stark_prove_excluding_trace_time_ms` |  3,084 |  6,168 |  4,030 |  2,138 |
| `main_trace_commit_time_ms` |  627 |  1,254 |  842 |  412 |
| `generate_perm_trace_time_ms` |  229 |  458 |  305 |  153 |
| `perm_trace_commit_time_ms` |  657 |  1,314 |  868 |  446 |
| `quotient_poly_compute_time_ms` |  318 |  636 |  426 |  210 |
| `quotient_poly_commit_time_ms` |  295 |  590 |  395 |  195 |
| `pcs_opening_time_ms ` |  950.50 |  1,901 |  1,189 |  712 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2,733 | 7 | 1 | 31 | 4,108,597 | 131.60 | 44 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 513 | 4,889 | 211,758,557 | 373,183,036 | 513 | 4,030 | 0 | 426 | 395 | 868 | 1,189 | 8 | 14 | 842 | 91,281,687 | 305 | 101 | 2,211,000 | 26.24 | 
| regex_program | 1 | 295 | 2,733 | 174,326,267 | 196,838,026 | 295 | 2,138 | 56 | 210 | 195 | 446 | 712 | 6 | 2 | 412 | 73,453,305 | 153 | 85 | 1,897,597 | 31.08 | 

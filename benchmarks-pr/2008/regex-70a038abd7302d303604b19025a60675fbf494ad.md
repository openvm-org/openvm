...
| `total_proof_time_ms ` |  3,796 |  7,592 |  4,882 |  2,710 |
...
| `execute_metered_insn_mi/s` |  131.40 | -          |  131.40 |  131.40 |
| `execute_preflight_insns` |  2,054,298.50 |  4,108,597 |  2,211,000 |  1,897,597 |
| `execute_preflight_time_ms` |  92.50 |  185 |  101 |  84 |
| `execute_preflight_insn_mi/s` |  28.49 | -          |  30.92 |  26.07 |
| `trace_gen_time_ms   ` |  393.50 |  787 |  503 |  284 |
| `memory_finalize_time_ms` |  7.50 |  15 |  13 |  2 |
| `stark_prove_excluding_trace_time_ms` |  3,079 |  6,158 |  4,034 |  2,124 |
| `main_trace_commit_time_ms` |  618 |  1,236 |  841 |  395 |
| `generate_perm_trace_time_ms` |  230 |  460 |  308 |  152 |
| `perm_trace_commit_time_ms` |  646.50 |  1,293 |  848 |  445 |
| `quotient_poly_compute_time_ms` |  321.50 |  643 |  435 |  208 |
| `quotient_poly_commit_time_ms` |  299.50 |  599 |  395 |  204 |
| `pcs_opening_time_ms ` |  955 |  1,910 |  1,202 |  708 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2,710 | 6 | 1 | 31 | 4,108,597 | 131.40 | 44 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 503 | 4,882 | 211,758,557 | 373,183,036 | 503 | 4,034 | 0 | 435 | 395 | 848 | 1,202 | 7 | 13 | 841 | 91,281,687 | 308 | 101 | 2,211,000 | 26.07 | 
| regex_program | 1 | 284 | 2,710 | 174,326,267 | 196,838,026 | 284 | 2,124 | 53 | 208 | 204 | 445 | 708 | 6 | 2 | 395 | 73,453,305 | 152 | 84 | 1,897,597 | 30.92 | 

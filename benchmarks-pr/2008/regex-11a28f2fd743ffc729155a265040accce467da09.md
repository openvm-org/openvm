...
|:---|---:|---:|
| Total |  7.58 |  4.87 |
| regex_program |  7.54 |  4.84 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  3,772.50 |  7,545 |  4,843 |  2,702 |
...
| `execute_preflight_insn_mi/s` |  28.44 | -          |  30.92 |  25.97 |
| `trace_gen_time_ms   ` |  376.50 |  753 |  481 |  272 |
| `memory_finalize_time_ms` |  7.50 |  15 |  13 |  2 |
| `stark_prove_excluding_trace_time_ms` |  3,073 |  6,146 |  4,021 |  2,125 |
| `main_trace_commit_time_ms` |  617 |  1,234 |  845 |  389 |
| `generate_perm_trace_time_ms` |  230.50 |  461 |  303 |  158 |
| `perm_trace_commit_time_ms` |  653.50 |  1,307 |  860 |  447 |
| `quotient_poly_compute_time_ms` |  325 |  650 |  437 |  213 |
| `quotient_poly_commit_time_ms` |  296.50 |  593 |  393 |  200 |
| `pcs_opening_time_ms ` |  944 |  1,888 |  1,179 |  709 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2,702 | 6 | 1 | 31 | 4,108,597 | 130.72 | 44 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 481 | 4,843 | 211,758,557 | 373,183,036 | 481 | 4,021 | 0 | 437 | 393 | 860 | 1,179 | 7 | 13 | 845 | 91,281,687 | 303 | 101 | 2,211,000 | 25.97 | 
| regex_program | 1 | 272 | 2,702 | 174,326,267 | 196,838,026 | 272 | 2,125 | 50 | 213 | 200 | 447 | 709 | 7 | 2 | 389 | 73,453,305 | 158 | 85 | 1,897,597 | 30.92 | 

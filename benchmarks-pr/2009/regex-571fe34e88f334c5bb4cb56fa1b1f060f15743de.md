...
|:---|---:|---:|
| Total |  7.55 |  4.86 |
| regex_program |  7.52 |  4.83 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  3,762 |  7,524 |  4,832 |  2,692 |
...
| `execute_preflight_insn_mi/s` |  28.75 | -          |  31.19 |  26.30 |
| `trace_gen_time_ms   ` |  380.50 |  761 |  489 |  272 |
| `memory_finalize_time_ms` |  7.50 |  15 |  13 |  2 |
| `stark_prove_excluding_trace_time_ms` |  3,054.50 |  6,109 |  3,997 |  2,112 |
| `main_trace_commit_time_ms` |  611 |  1,222 |  834 |  388 |
| `generate_perm_trace_time_ms` |  223.50 |  447 |  299 |  148 |
| `perm_trace_commit_time_ms` |  648.50 |  1,297 |  848 |  449 |
| `quotient_poly_compute_time_ms` |  312 |  624 |  425 |  199 |
| `quotient_poly_commit_time_ms` |  302.50 |  605 |  397 |  208 |
| `pcs_opening_time_ms ` |  949.50 |  1,899 |  1,188 |  711 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2,692 | 6 | 1 | 31 | 4,108,597 | 129.56 | 44 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 489 | 4,832 | 211,758,557 | 373,183,036 | 489 | 3,997 | 0 | 425 | 397 | 848 | 1,188 | 8 | 13 | 834 | 91,281,687 | 299 | 100 | 2,211,000 | 26.30 | 
| regex_program | 1 | 272 | 2,692 | 174,326,267 | 196,838,026 | 272 | 2,112 | 50 | 199 | 208 | 449 | 711 | 6 | 2 | 388 | 73,453,305 | 148 | 83 | 1,897,597 | 31.19 | 

...
| `total_proof_time_ms ` |  3,806.50 |  7,613 |  4,873 |  2,740 |
...
| `execute_preflight_insn_mi/s` |  28.69 | -          |  31.14 |  26.25 |
| `trace_gen_time_ms   ` |  379.50 |  759 |  487 |  272 |
| `memory_finalize_time_ms` |  8.50 |  17 |  15 |  2 |
| `stark_prove_excluding_trace_time_ms` |  3,108.50 |  6,217 |  4,044 |  2,173 |
| `main_trace_commit_time_ms` |  616 |  1,232 |  844 |  388 |
| `generate_perm_trace_time_ms` |  239.50 |  479 |  305 |  174 |
| `perm_trace_commit_time_ms` |  664 |  1,328 |  851 |  477 |
| `quotient_poly_compute_time_ms` |  310 |  620 |  424 |  196 |
| `quotient_poly_commit_time_ms` |  305.50 |  611 |  403 |  208 |
| `pcs_opening_time_ms ` |  965.50 |  1,931 |  1,212 |  719 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2,740 | 6 | 1 | 32 | 4,108,597 | 128.04 | 44 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 487 | 4,873 | 211,758,557 | 373,183,036 | 486 | 4,044 | 0 | 424 | 403 | 851 | 1,212 | 8 | 15 | 844 | 91,281,687 | 305 | 103 | 2,211,000 | 26.25 | 
| regex_program | 1 | 272 | 2,740 | 174,326,267 | 196,838,026 | 272 | 2,173 | 50 | 196 | 208 | 477 | 719 | 6 | 2 | 388 | 73,453,305 | 174 | 84 | 1,897,597 | 31.14 | 

...
| `total_proof_time_ms ` |  3,818.50 |  7,637 |  4,907 |  2,730 |
...
| `execute_preflight_insn_mi/s` |  28.61 | -          |  31.05 |  26.17 |
| `trace_gen_time_ms   ` |  385.50 |  771 |  494 |  277 |
| `memory_finalize_time_ms` |  7.50 |  15 |  13 |  2 |
| `stark_prove_excluding_trace_time_ms` |  3,114.50 |  6,229 |  4,074 |  2,155 |
| `main_trace_commit_time_ms` |  618 |  1,236 |  850 |  386 |
| `generate_perm_trace_time_ms` |  244 |  488 |  330 |  158 |
| `perm_trace_commit_time_ms` |  650.50 |  1,301 |  848 |  453 |
| `quotient_poly_compute_time_ms` |  312 |  624 |  426 |  198 |
| `quotient_poly_commit_time_ms` |  302 |  604 |  399 |  205 |
| `pcs_opening_time_ms ` |  978.50 |  1,957 |  1,216 |  741 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2,730 | 6 | 1 | 31 | 4,108,597 | 130.54 | 44 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 494 | 4,907 | 211,758,557 | 373,183,036 | 494 | 4,074 | 0 | 426 | 399 | 848 | 1,216 | 7 | 13 | 850 | 91,281,687 | 330 | 101 | 2,211,000 | 26.17 | 
| regex_program | 1 | 277 | 2,730 | 174,326,267 | 196,838,026 | 277 | 2,155 | 52 | 198 | 205 | 453 | 741 | 6 | 2 | 386 | 73,453,305 | 158 | 84 | 1,897,597 | 31.05 | 

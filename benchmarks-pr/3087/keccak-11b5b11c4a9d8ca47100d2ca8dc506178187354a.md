...
|:---|---:|---:|---:|
| Total |  9.47 |  3.60 |  3.60 |
| app_proof |  7.36 |  1.100 |  1.100 |
| leaf |  1.54 |  1.04 |  1.04 |
...
| `total_proof_time_ms ` |  1,205.83 |  7,235 |  1,870 |  1,062 |
...
| `execute_preflight_time_ms` |  63.67 |  382 |  85 |  57 |
| `execute_preflight_insn_mi/s` |  39.35 | -          |  41.86 |  32.76 |
| `trace_gen_time_ms   ` |  15.50 |  93 |  28 |  13 |
| `set_initial_memory_time_ms` |  0 |  0 |  0 |  0 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,125.33 |  6,752 |  1,756 |  991 |
| `prover.main_trace_commit_time_ms` |  276.67 |  1,660 |  354 |  259 |
| `prover.rap_constraints_time_ms` |  607.83 |  3,647 |  1,091 |  509 |
| `prover.openings_time_ms` |  240.17 |  1,441 |  310 |  223 |
| `prover.rap_constraints.logup_gkr_time_ms` |  201 |  1,206 |  686 |  103 |
...
| `prover.openings.whir_time_ms` |  179.17 |  1,075 |  249 |  162 |
...
| `trace_gen_time_ms   ` |  150.50 |  301 |  206 |  95 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/11b5b11c4a9d8ca47100d2ca8dc506178187354a/keccak-11b5b11c4a9d8ca47100d2ca8dc506178187354a.memory.svg)
...
| prover.rap_constraints | 6.96 | app_proof.prover.0 |
| prover.batch_constraints.before_round0 | 6.24 | app_proof.prover.0 |
| frac_sumcheck.gkr_rounds | 6.24 | app_proof.prover.0 |
| prover.gkr_input_evals | 6.18 | app_proof.prover.0 |
| frac_sumcheck.segment_tree | 6.18 | app_proof.prover.0 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 59 |  |  |  | 292 |  |  |  |  |  |  | 
| app_proof |  |  |  | 1,062 |  | 128 | 14,365,133 | 111.82 | 0 | 7,374 |  | 
...
| app_proof | XorinVmAir | 41 | XorinVmAir | 0 | 5,677,360 | 
...
| app_proof | XorinVmAir | 41 | XorinVmAir | 1 | 5,677,880 | 
...
| app_proof | XorinVmAir | 41 | XorinVmAir | 2 | 5,677,360 | 
...
| app_proof | XorinVmAir | 41 | XorinVmAir | 3 | 5,677,880 | 
...
| app_proof | XorinVmAir | 41 | XorinVmAir | 4 | 5,677,360 | 
...
| app_proof | XorinVmAir | 41 | XorinVmAir | 5 | 5,412,160 | 
...
| leaf | 0 | 206 | 1,036 | 206 | 67 | 21 | 4 | 12 | 12 | 
| leaf | 1 | 95 | 504 | 94 | 30 | 10 | 5 | 11 | 11 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 81,415,160 | 286 | 93 | 0 | 0 | 114 | 38 | 37 | 57 | 18 | 0 | 78 | 63 | 15 | 5 | 10 | 93 | 93 | 113 | 0 | 1 | 17 | 0 | 0 | 
...
| leaf | 0 | prover | 476,578,798 | 829 | 386 | 0 | 0 | 231 | 118 | 117 | 71 | 40 | 0 | 209 | 172 | 37 | 20 | 17 | 387 | 386 | 231 | 0 | 3 | 39 | 0 | 0 | 
| leaf | 1 | prover | 240,255,800 |
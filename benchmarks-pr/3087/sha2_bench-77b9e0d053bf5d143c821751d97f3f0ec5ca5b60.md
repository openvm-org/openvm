...
|:---|---:|---:|---:|
| Total |  5.64 |  4.16 |  4.16 |
| app_proof |  4.69 |  3.21 |  3.21 |
| leaf |  0.52 |  0.52 |  0.52 |
...
| `total_proof_time_ms ` |  2,315 |  4,630 |  3,154 |  1,476 |
...
| `execute_preflight_time_ms` |  166.50 |  333 |  220 |  113 |
| `execute_preflight_insn_mi/s` |  35.06 | -          |  36.02 |  34.11 |
| `trace_gen_time_ms   ` |  61.50 |  123 |  95 |  28 |
| `set_initial_memory_time_ms` |  0 |  0 |  0 |  0 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  2,085 |  4,170 |  2,837 |  1,333 |
| `prover.main_trace_commit_time_ms` |  711.50 |  1,423 |  1,207 |  216 |
| `prover.rap_constraints_time_ms` |  1,107 |  2,214 |  1,289 |  925 |
| `prover.openings_time_ms` |  265 |  530 |  340 |  190 |
| `prover.rap_constraints.logup_gkr_time_ms` |  403.50 |  807 |  452 |  355 |
| `prover.rap_constraints.round0_time_ms` |  524 |  1,048 |  701 |  347 |
| `prover.rap_constraints.mle_rounds_time_ms` |  178.50 |  357 |  232 |  125 |
...
| `prover.openings.whir_time_ms` |  192 |  384 |  247 |  137 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/77b9e0d053bf5d143c821751d97f3f0ec5ca5b60/sha2_bench-77b9e0d053bf5d143c821751d97f3f0ec5ca5b60.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 59 |  |  |  | 293 |  |  |  |  |  |  | 
| app_proof |  |  |  | 1,476 |  | 57 | 11,167,961 | 194.16 | 0 | 4,697 |  | 
...
| app_proof | VmAirWrapper<Rv64BaseAluImmU16AdapterAir, AddICoreAir<4, 16, true> | 0 |  | 5 | 
...
| app_proof | VmAirWrapper<Rv64StoreMultiByteAdapterAir, StoreCoreAir<8, 4> | 0 | 6 | 11 | 
...
| leaf | 0 | 119 | 523 | 118 | 32 | 12 | 2 | 9 | 9 | 
...
| leaf | 0 | prover | 237,929,272 | 404 | 145 | 0 | 0 | 142 | 71 | 69 | 44 | 26 | 0 | 116 | 94 | 21 | 10 | 11 | 145 | 145 | 142 | 0 | 3 | 25 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,285,848,458 | 2,837 | 1,207 | 0 | 0 | 1,289 | 701 | 700 | 232 | 355 | 1 | 340 | 247 | 93 | 57 | 35 | 1,207 | 1,207 | 1,289 | 0 | 1 | 354 | 0 | 0 | 
| app_proof | prover | 1 | 690,310,084 | 1,333 | 216 | 0 | 0 | 925 | 347 | 346 | 125 | 452 | 0 | 190 | 137 | 52 | 31 | 21 | 216 | 216 | 925 | 0 | 1 | 191 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 0 | 2 | 95 | 3,154 | 3 | 0 | 0 | 0 | 12,567,738,156 | 2,865,208,140 | 15,432,946,296 | 2,097,152 | 2 | 0 | 0 | 0 | 3 | 92 | 220 | 7,136,000 | 34.11 | 0 | 0 | 
| app_proof | 1 | 0 | 1 | 28 | 1,476 | 2 | 0 | 0 | 0 | 7,133,254,296 | 1,693,718,849 | 8,826,973,145 | 2,097,152 | 2 | 0 | 0 | 0 | 2 | 26 | 113 | 4,031,961 | 36.02 | 0 | 0 | 

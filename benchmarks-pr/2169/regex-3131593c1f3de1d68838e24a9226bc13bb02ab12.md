...
|:---|---:|---:|
| Total | <span style='color: red'>(+0 [+0.3%])</span> 2.33 | <span style='color: red'>(+0 [+0.8%])</span> 0.74 |
| regex_program | <span style='color: red'>(+0 [+0.3%])</span> 2.30 | <span style='color: red'>(+0 [+1.0%])</span> 0.70 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+2 [+0.3%])</span> 574 | <span style='color: red'>(+8 [+0.3%])</span> 2,296 | <span style='color: red'>(+7 [+1.0%])</span> 700 | <span style='color: red'>(+1 [+0.2%])</span> 517 |
...
| `execute_metered_insn_mi/s` | <span style='color: red'>(+5 [+4.4%])</span> 117.45 | -          | <span style='color: red'>(+5 [+4.4%])</span> 117.45 | <span style='color: red'>(+5 [+4.4%])</span> 117.45 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` | <span style='color: red'>(+1 [+2.3%])</span> 55.50 | <span style='color: red'>(+5 [+2.3%])</span> 222 | <span style='color: red'>(+3 [+4.6%])</span> 68 | <span style='color: red'>(+1 [+2.2%])</span> 46 |
| `execute_preflight_insn_mi/s` | <span style='color: green'>(-0 [-0.5%])</span> 29.94 | -          | <span style='color: red'>(+0 [+0.5%])</span> 31.54 | <span style='color: red'>(+0 [+1.5%])</span> 27.05 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+1 [+0.7%])</span> 176.75 | <span style='color: red'>(+5 [+0.7%])</span> 707 | <span style='color: red'>(+4 [+1.9%])</span> 211 | <span style='color: green'>(-1 [-0.6%])</span> 153 |
| `memory_finalize_time_ms` |  1 |  4 |  4 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  273.75 |  1,095 | <span style='color: red'>(+5 [+1.7%])</span> 297 |  254 |
| `main_trace_commit_time_ms` | <span style='color: red'>(+0 [+0.5%])</span> 51.25 | <span style='color: red'>(+1 [+0.5%])</span> 205 | <span style='color: red'>(+1 [+1.8%])</span> 56 |  49 |
| `generate_perm_trace_time_ms` | <span style='color: red'>(+0 [+1.1%])</span> 23.75 | <span style='color: red'>(+1 [+1.1%])</span> 95 | <span style='color: red'>(+1 [+3.8%])</span> 27 |  20 |
| `perm_trace_commit_time_ms` | <span style='color: red'>(+1 [+1.7%])</span> 65.15 | <span style='color: red'>(+4 [+1.7%])</span> 260.62 | <span style='color: red'>(+1 [+1.1%])</span> 72.61 | <span style='color: red'>(+2 [+2.9%])</span> 55.52 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+1 [+1.2%])</span> 58.19 | <span style='color: red'>(+3 [+1.2%])</span> 232.77 | <span style='color: red'>(+2 [+3.6%])</span> 70.49 | <span style='color: green'>(-1 [-1.1%])</span> 51.35 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+0 [+2.1%])</span> 14.96 | <span style='color: red'>(+1 [+2.1%])</span> 59.83 | <span style='color: red'>(+0 [+2.7%])</span> 17.02 | <span style='color: red'>(+0 [+0.4%])</span> 12.66 |
| `pcs_opening_time_ms ` | <span style='color: green'>(-3 [-5.0%])</span> 57.25 | <span style='color: green'>(-12 [-5.0%])</span> 229 | <span style='color: green'>(-15 [-18.8%])</span> 65 |  49 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 538 | 67 | 1 | 35 | 4,137,502 | 117.45 | 196 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 211 | 700 | 23,446,148 | 150,778,428 | 211 | 297 | 0 | 58.87 | 17.02 | 5 | 72.61 | 65 | 98 | 65 | 4 | 56 | 10,899,170 | 24 | 47 | 1,103,000 | 27.05 | 22 | 76 | 1 | 65 | 
| regex_program | 1 | 153 | 541 | 11,598,276 | 128,513,066 | 153 | 277 | 1 | 51.35 | 15.39 | 4 | 66.12 | 65 | 93 | 65 | 0 | 50 | 2,196,106 | 27 | 68 | 1,104,000 | 30.53 | 17 | 67 | 0 | 65 | 
| regex_program | 2 | 160 | 517 | 11,579,064 | 128,513,066 | 160 | 254 | 1 | 52.07 | 14.77 | 4 | 66.37 | 49 | 87 | 49 | 0 | 50 | 2,177,334 | 20 | 61 | 1,104,000 | 30.66 | 16 | 67 | 0 | 49 | 
| regex_program | 3 | 183 | 538 | 11,853,872 | 103,456,394 | 183 | 267 | 0 | 70.49 | 12.66 | 5 | 55.52 | 50 | 83 | 49 | 0 | 49 | 2,422,606 | 24 | 46 | 826,502 | 31.54 | 18 | 84 | 1 | 49 | 

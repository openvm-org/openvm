...
|:---|---:|---:|
| Total | <span style='color: red'>(+0 [+0.3%])</span> 2.33 | <span style='color: red'>(+0 [+1.6%])</span> 0.74 |
| regex_program | <span style='color: red'>(+0 [+0.3%])</span> 2.30 | <span style='color: red'>(+0 [+2.0%])</span> 0.71 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+2 [+0.3%])</span> 574 | <span style='color: red'>(+8 [+0.3%])</span> 2,296 | <span style='color: red'>(+14 [+2.0%])</span> 707 | <span style='color: red'>(+5 [+1.0%])</span> 521 |
...
| `execute_metered_insn_mi/s` | <span style='color: red'>(+8 [+6.7%])</span> 120.04 | -          | <span style='color: red'>(+8 [+6.7%])</span> 120.04 | <span style='color: red'>(+8 [+6.7%])</span> 120.04 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` | <span style='color: red'>(+4 [+8.3%])</span> 58.75 | <span style='color: red'>(+18 [+8.3%])</span> 235 | <span style='color: red'>(+2 [+3.1%])</span> 67 | <span style='color: red'>(+2 [+4.4%])</span> 47 |
| `execute_preflight_insn_mi/s` | <span style='color: green'>(-3 [-8.4%])</span> 27.58 | -          | <span style='color: green'>(-0 [-0.3%])</span> 31.29 | <span style='color: green'>(-6 [-23.3%])</span> 20.45 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+1 [+0.4%])</span> 176.25 | <span style='color: red'>(+3 [+0.4%])</span> 705 | <span style='color: red'>(+8 [+3.9%])</span> 215 | <span style='color: red'>(+2 [+1.3%])</span> 156 |
| `memory_finalize_time_ms` |  1 |  4 |  4 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: green'>(-3 [-1.0%])</span> 271.25 | <span style='color: green'>(-11 [-1.0%])</span> 1,085 | <span style='color: red'>(+7 [+2.4%])</span> 299 | <span style='color: red'>(+2 [+0.8%])</span> 256 |
| `main_trace_commit_time_ms` | <span style='color: red'>(+0 [+1.0%])</span> 51.50 | <span style='color: red'>(+2 [+1.0%])</span> 206 | <span style='color: red'>(+2 [+3.6%])</span> 57 |  49 |
| `generate_perm_trace_time_ms` | <span style='color: green'>(-1 [-3.2%])</span> 22.75 | <span style='color: green'>(-3 [-3.2%])</span> 91 | <span style='color: red'>(+1 [+3.8%])</span> 27 | <span style='color: green'>(-3 [-15.0%])</span> 17 |
| `perm_trace_commit_time_ms` | <span style='color: red'>(+2 [+2.5%])</span> 65.64 | <span style='color: red'>(+6 [+2.5%])</span> 262.55 | <span style='color: red'>(+1 [+1.6%])</span> 72.99 | <span style='color: red'>(+1 [+1.7%])</span> 54.86 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+3 [+4.5%])</span> 60.05 | <span style='color: red'>(+10 [+4.5%])</span> 240.19 | <span style='color: red'>(+4 [+5.7%])</span> 71.89 | <span style='color: red'>(+2 [+3.6%])</span> 53.75 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+1 [+5.9%])</span> 15.52 | <span style='color: red'>(+3 [+5.9%])</span> 62.07 | <span style='color: red'>(+2 [+9.5%])</span> 18.16 | <span style='color: red'>(+0 [+3.7%])</span> 13.07 |
| `pcs_opening_time_ms ` | <span style='color: green'>(-8 [-12.9%])</span> 52.50 | <span style='color: green'>(-31 [-12.9%])</span> 210 | <span style='color: green'>(-16 [-20.0%])</span> 64 | <span style='color: green'>(-2 [-4.1%])</span> 47 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 541 | 66 | 1 | 34 | 4,137,502 | 120.04 | 195 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 215 | 707 | 23,446,148 | 150,778,428 | 215 | 299 | 0 | 60.32 | 18.16 | 5 | 72.99 | 64 | 98 | 64 | 4 | 57 | 10,899,170 | 24 | 47 | 1,103,000 | 27.61 | 21 | 79 | 1 | 64 | 
| regex_program | 1 | 156 | 527 | 11,598,276 | 128,513,066 | 156 | 262 | 1 | 53.75 | 15.39 | 4 | 66.71 | 47 | 94 | 47 | 0 | 50 | 2,196,106 | 27 | 67 | 1,104,000 | 31.29 | 16 | 69 | 0 | 47 | 
| regex_program | 2 | 163 | 521 | 11,579,064 | 128,513,066 | 163 | 256 | 1 | 54.23 | 15.45 | 4 | 67.98 | 49 | 86 | 49 | 0 | 49 | 2,177,334 | 17 | 60 | 1,104,000 | 30.98 | 16 | 70 | 0 | 49 | 
| regex_program | 3 | 171 | 541 | 11,853,872 | 103,456,394 | 171 | 268 | 0 | 71.89 | 13.07 | 5 | 54.86 | 50 | 81 | 50 | 0 | 50 | 2,422,606 | 23 | 61 | 826,502 | 20.45 | 18 | 86 | 1 | 50 | 

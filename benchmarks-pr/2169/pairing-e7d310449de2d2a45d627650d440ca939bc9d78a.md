...
|:---|---:|---:|
| Total | <span style='color: red'>(+0 [+3.6%])</span> 1.55 | <span style='color: red'>(+0 [+0.9%])</span> 0.93 |
| pairing | <span style='color: red'>(+0 [+3.8%])</span> 1.46 | <span style='color: red'>(+0 [+1.0%])</span> 0.84 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+27 [+3.8%])</span> 731.50 | <span style='color: red'>(+54 [+3.8%])</span> 1,463 | <span style='color: red'>(+8 [+1.0%])</span> 839 | <span style='color: red'>(+46 [+8.0%])</span> 624 |
...
| `execute_metered_insn_mi/s` | <span style='color: red'>(+0 [+0.1%])</span> 19.30 | -          | <span style='color: red'>(+0 [+0.1%])</span> 19.30 | <span style='color: red'>(+0 [+0.1%])</span> 19.30 |
| `execute_preflight_insns` |  872,871 |  1,745,742 |  1,157,000 |  588,742 |
| `execute_preflight_time_ms` | <span style='color: red'>(+0 [+0.5%])</span> 96 | <span style='color: red'>(+1 [+0.5%])</span> 192 | <span style='color: red'>(+2 [+1.5%])</span> 132 | <span style='color: green'>(-1 [-1.6%])</span> 60 |
| `execute_preflight_insn_mi/s` | <span style='color: green'>(-0 [-1.1%])</span> 13.33 | -          | <span style='color: green'>(-0 [-0.8%])</span> 17.71 | <span style='color: green'>(-0 [-1.7%])</span> 8.95 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+5 [+2.9%])</span> 178 | <span style='color: red'>(+10 [+2.9%])</span> 356 | <span style='color: red'>(+7 [+3.7%])</span> 196 | <span style='color: red'>(+3 [+1.9%])</span> 160 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+22 [+6.4%])</span> 365 | <span style='color: red'>(+44 [+6.4%])</span> 730 | <span style='color: red'>(+4 [+1.0%])</span> 403 | <span style='color: red'>(+40 [+13.9%])</span> 327 |
| `main_trace_commit_time_ms` | <span style='color: red'>(+3 [+4.8%])</span> 65.50 | <span style='color: red'>(+6 [+4.8%])</span> 131 | <span style='color: red'>(+3 [+4.1%])</span> 76 | <span style='color: red'>(+3 [+5.8%])</span> 55 |
| `generate_perm_trace_time_ms` | <span style='color: red'>(+16 [+43.2%])</span> 53 | <span style='color: red'>(+32 [+43.2%])</span> 106 | <span style='color: red'>(+16 [+33.3%])</span> 64 | <span style='color: red'>(+16 [+61.5%])</span> 42 |
| `perm_trace_commit_time_ms` | <span style='color: red'>(+1 [+1.8%])</span> 77.34 | <span style='color: red'>(+3 [+1.8%])</span> 154.68 | <span style='color: red'>(+1 [+1.5%])</span> 89.33 | <span style='color: red'>(+1 [+2.2%])</span> 65.35 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+1 [+1.7%])</span> 78.65 | <span style='color: red'>(+3 [+1.7%])</span> 157.30 | <span style='color: red'>(+1 [+1.3%])</span> 87.42 | <span style='color: red'>(+2 [+2.3%])</span> 69.88 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+0 [+3.1%])</span> 16.36 | <span style='color: red'>(+1 [+3.1%])</span> 32.72 | <span style='color: red'>(+1 [+4.7%])</span> 18.86 | <span style='color: red'>(+0 [+0.9%])</span> 13.85 |
| `pcs_opening_time_ms ` | <span style='color: green'>(-1 [-1.4%])</span> 69 | <span style='color: green'>(-2 [-1.4%])</span> 138 | <span style='color: red'>(+3 [+3.7%])</span> 84 | <span style='color: green'>(-5 [-8.5%])</span> 54 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 624 | 40 | 1 | 90 | 1,745,742 | 19.30 | 147 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 160 | 839 | 32,689,110 | 172,558,444 | 160 | 403 | 0 | 87.42 | 18.86 | 6 | 89.33 | 84 | 135 | 84 | 1 | 76 | 16,059,916 | 42 | 132 | 1,157,000 | 8.95 | 26 | 107 | 1 | 84 | 
| pairing | 1 | 196 | 624 | 22,314,288 | 119,958,502 | 196 | 327 | 1 | 69.88 | 13.85 | 6 | 65.35 | 54 | 133 | 54 | 0 | 55 | 9,408,294 | 64 | 60 | 588,742 | 17.71 | 21 | 84 | 1 | 54 | 

...
|:---|---:|---:|
| Total | <span style='color: red'>(+0 [+0.4%])</span> 2.33 | <span style='color: red'>(+0 [+0.3%])</span> 0.73 |
| regex_program | <span style='color: red'>(+0 [+0.5%])</span> 2.30 | <span style='color: red'>(+0 [+0.6%])</span> 0.70 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+3 [+0.5%])</span> 575 | <span style='color: red'>(+12 [+0.5%])</span> 2,300 | <span style='color: red'>(+4 [+0.6%])</span> 697 | <span style='color: red'>(+1 [+0.2%])</span> 517 |
...
| `execute_metered_insn_mi/s` | <span style='color: red'>(+8 [+7.5%])</span> 120.92 | -          | <span style='color: red'>(+8 [+7.5%])</span> 120.92 | <span style='color: red'>(+8 [+7.5%])</span> 120.92 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` | <span style='color: red'>(+1 [+1.8%])</span> 55.25 | <span style='color: red'>(+4 [+1.8%])</span> 221 | <span style='color: red'>(+2 [+3.1%])</span> 67 | <span style='color: red'>(+1 [+2.2%])</span> 46 |
| `execute_preflight_insn_mi/s` | <span style='color: green'>(-0 [-1.4%])</span> 29.69 | -          | <span style='color: green'>(-0 [-1.3%])</span> 30.97 | <span style='color: red'>(+1 [+3.7%])</span> 27.65 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+2 [+1.3%])</span> 177.75 | <span style='color: red'>(+9 [+1.3%])</span> 711 | <span style='color: red'>(+3 [+1.4%])</span> 210 | <span style='color: red'>(+1 [+0.6%])</span> 155 |
| `memory_finalize_time_ms` |  1 |  4 |  4 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  274.25 |  1,097 | <span style='color: red'>(+4 [+1.4%])</span> 296 | <span style='color: green'>(-2 [-0.8%])</span> 252 |
| `main_trace_commit_time_ms` | <span style='color: red'>(+1 [+1.5%])</span> 51.75 | <span style='color: red'>(+3 [+1.5%])</span> 207 | <span style='color: red'>(+2 [+3.6%])</span> 57 |  49 |
| `generate_perm_trace_time_ms` | <span style='color: red'>(+0 [+2.1%])</span> 24 | <span style='color: red'>(+2 [+2.1%])</span> 96 | <span style='color: red'>(+1 [+3.8%])</span> 27 | <span style='color: green'>(-1 [-5.0%])</span> 19 |
| `perm_trace_commit_time_ms` | <span style='color: red'>(+1 [+1.4%])</span> 64.92 | <span style='color: red'>(+4 [+1.4%])</span> 259.70 | <span style='color: red'>(+2 [+2.4%])</span> 73.56 | <span style='color: red'>(+1 [+2.3%])</span> 55.19 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+1 [+2.3%])</span> 58.81 | <span style='color: red'>(+5 [+2.3%])</span> 235.24 | <span style='color: red'>(+3 [+3.8%])</span> 70.57 | <span style='color: red'>(+1 [+1.2%])</span> 52.54 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+0 [+0.5%])</span> 14.73 | <span style='color: red'>(+0 [+0.5%])</span> 58.93 | <span style='color: red'>(+0 [+1.2%])</span> 16.78 | <span style='color: red'>(+0 [+1.1%])</span> 12.74 |
| `pcs_opening_time_ms ` | <span style='color: green'>(-3 [-5.4%])</span> 57 | <span style='color: green'>(-13 [-5.4%])</span> 228 | <span style='color: green'>(-9 [-11.2%])</span> 71 | <span style='color: green'>(-3 [-6.1%])</span> 46 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 564 | 41 | 1 | 34 | 4,137,502 | 120.92 | 168 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 210 | 697 | 23,446,148 | 150,778,428 | 210 | 296 | 0 | 58.90 | 16.78 | 5 | 73.56 | 63 | 99 | 63 | 4 | 57 | 10,899,170 | 24 | 46 | 1,103,000 | 27.65 | 21 | 76 | 1 | 63 | 
| regex_program | 1 | 155 | 522 | 11,598,276 | 128,513,066 | 155 | 258 | 1 | 53.23 | 14.93 | 4 | 64.78 | 46 | 91 | 46 | 0 | 51 | 2,196,106 | 26 | 67 | 1,104,000 | 30.97 | 16 | 68 | 0 | 46 | 
| regex_program | 2 | 161 | 517 | 11,579,064 | 128,513,066 | 161 | 252 | 1 | 52.54 | 14.48 | 4 | 66.18 | 48 | 85 | 48 | 0 | 50 | 2,177,334 | 19 | 62 | 1,104,000 | 29.44 | 16 | 67 | 0 | 48 | 
| regex_program | 3 | 185 | 564 | 11,853,872 | 103,456,394 | 185 | 291 | 0 | 70.57 | 12.74 | 5 | 55.19 | 71 | 85 | 71 | 0 | 49 | 2,422,606 | 27 | 46 | 826,502 | 30.68 | 18 | 84 | 1 | 71 | 

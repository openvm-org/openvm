...
|:---|---:|---:|
| Total | <span style='color: red'>(+0 [+2.0%])</span> 1.54 | <span style='color: red'>(+0 [+1.7%])</span> 0.93 |
| pairing | <span style='color: red'>(+0 [+2.0%])</span> 1.45 | <span style='color: red'>(+0 [+1.8%])</span> 0.84 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+14 [+2.0%])</span> 726 | <span style='color: red'>(+29 [+2.0%])</span> 1,452 | <span style='color: red'>(+15 [+1.8%])</span> 843 | <span style='color: red'>(+14 [+2.4%])</span> 609 |
...
| `execute_metered_insn_mi/s` | <span style='color: green'>(-0 [-0.7%])</span> 19.29 | -          | <span style='color: green'>(-0 [-0.7%])</span> 19.29 | <span style='color: green'>(-0 [-0.7%])</span> 19.29 |
| `execute_preflight_insns` |  872,871 |  1,745,742 |  1,157,000 |  588,742 |
| `execute_preflight_time_ms` | <span style='color: red'>(+10 [+10.4%])</span> 106 | <span style='color: red'>(+20 [+10.4%])</span> 212 | <span style='color: red'>(+4 [+3.0%])</span> 136 | <span style='color: red'>(+16 [+26.7%])</span> 76 |
| `execute_preflight_insn_mi/s` | <span style='color: green'>(-0 [-1.8%])</span> 13.02 | -          | <span style='color: green'>(-0 [-1.6%])</span> 17.22 | <span style='color: green'>(-0 [-2.3%])</span> 8.81 |
| `trace_gen_time_ms   ` | <span style='color: green'>(-6 [-3.3%])</span> 174 | <span style='color: green'>(-12 [-3.3%])</span> 348 | <span style='color: green'>(-13 [-6.6%])</span> 184 | <span style='color: red'>(+1 [+0.6%])</span> 164 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+3 [+0.9%])</span> 346 | <span style='color: red'>(+6 [+0.9%])</span> 692 | <span style='color: green'>(-3 [-0.8%])</span> 387 | <span style='color: red'>(+9 [+3.0%])</span> 305 |
| `main_trace_commit_time_ms` |  64.50 |  129 | <span style='color: green'>(-1 [-1.3%])</span> 74 | <span style='color: red'>(+1 [+1.9%])</span> 55 |
| `generate_perm_trace_time_ms` | <span style='color: red'>(+4 [+12.3%])</span> 36.50 | <span style='color: red'>(+8 [+12.3%])</span> 73 | <span style='color: red'>(+8 [+22.2%])</span> 44 |  29 |
| `perm_trace_commit_time_ms` |  78.16 |  156.32 | <span style='color: green'>(-1 [-1.0%])</span> 89.99 | <span style='color: red'>(+1 [+1.5%])</span> 66.33 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+1 [+0.8%])</span> 81.13 | <span style='color: red'>(+1 [+0.8%])</span> 162.27 | <span style='color: red'>(+0 [+0.5%])</span> 89.96 | <span style='color: red'>(+1 [+1.3%])</span> 72.31 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+0 [+0.3%])</span> 16.61 | <span style='color: red'>(+0 [+0.3%])</span> 33.22 | <span style='color: green'>(-1 [-3.9%])</span> 18.02 | <span style='color: red'>(+1 [+5.7%])</span> 15.20 |
| `pcs_opening_time_ms ` | <span style='color: green'>(-2 [-2.3%])</span> 64.50 | <span style='color: green'>(-3 [-2.3%])</span> 129 | <span style='color: green'>(-8 [-10.8%])</span> 66 | <span style='color: red'>(+5 [+8.6%])</span> 63 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 609 | 40 | 1 | 90 | 1,745,742 | 19.29 | 155 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 164 | 843 | 32,689,110 | 172,558,444 | 164 | 387 | 0 | 89.96 | 18.02 | 7 | 89.99 | 66 | 137 | 66 | 1 | 74 | 16,059,916 | 44 | 136 | 1,157,000 | 8.81 | 27 | 108 | 1 | 66 | 
| pairing | 1 | 184 | 609 | 22,314,288 | 119,958,502 | 184 | 305 | 1 | 72.31 | 15.20 | 6 | 66.33 | 63 | 98 | 63 | 0 | 55 | 9,408,294 | 29 | 76 | 588,742 | 17.22 | 21 | 88 | 1 | 63 | 

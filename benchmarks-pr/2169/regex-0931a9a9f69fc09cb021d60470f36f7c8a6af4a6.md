...
|:---|---:|---:|
| Total | <span style='color: red'>(+0 [+0.3%])</span> 2.33 | <span style='color: red'>(+0 [+0.4%])</span> 0.73 |
| regex_program | <span style='color: red'>(+0 [+0.5%])</span> 2.30 | <span style='color: red'>(+0 [+0.9%])</span> 0.70 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+3 [+0.5%])</span> 574.75 | <span style='color: red'>(+11 [+0.5%])</span> 2,299 | <span style='color: red'>(+6 [+0.9%])</span> 699 | <span style='color: green'>(-4 [-0.8%])</span> 512 |
| `main_cells_used     ` |  4,423,804 |  17,695,216 |  10,899,170 |  2,177,334 |
| `total_cells_used    ` |  14,619,340 |  58,477,360 |  23,446,148 |  11,579,064 |
| `execute_metered_time_ms` | <span style='color: green'>(-3 [-8.3%])</span> 33 | -          | -          | -          |
| `execute_metered_insn_mi/s` | <span style='color: red'>(+11 [+9.9%])</span> 123.57 | -          | <span style='color: red'>(+11 [+9.9%])</span> 123.57 | <span style='color: red'>(+11 [+9.9%])</span> 123.57 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` | <span style='color: red'>(+2 [+4.6%])</span> 56.75 | <span style='color: red'>(+10 [+4.6%])</span> 227 | <span style='color: red'>(+4 [+6.2%])</span> 69 | <span style='color: red'>(+2 [+4.4%])</span> 47 |
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+0 [+0.3%])</span> 30.18 | -          | <span style='color: green'>(-0 [-0.1%])</span> 31.33 | <span style='color: red'>(+1 [+2.7%])</span> 27.36 |
| `trace_gen_time_ms   ` | <span style='color: green'>(-2 [-1.0%])</span> 173.75 | <span style='color: green'>(-7 [-1.0%])</span> 695 | <span style='color: red'>(+3 [+1.4%])</span> 210 | <span style='color: green'>(-4 [-2.6%])</span> 150 |
| `memory_finalize_time_ms` |  1 |  4 |  4 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+2 [+0.8%])</span> 276.25 | <span style='color: red'>(+9 [+0.8%])</span> 1,105 | <span style='color: red'>(+4 [+1.4%])</span> 296 | <span style='color: green'>(-3 [-1.2%])</span> 251 |
| `main_trace_commit_time_ms` | <span style='color: red'>(+0 [+0.5%])</span> 51.25 | <span style='color: red'>(+1 [+0.5%])</span> 205 | <span style='color: red'>(+2 [+3.6%])</span> 57 |  49 |
| `generate_perm_trace_time_ms` | <span style='color: green'>(-1 [-3.2%])</span> 22.75 | <span style='color: green'>(-3 [-3.2%])</span> 91 | <span style='color: red'>(+1 [+3.8%])</span> 27 | <span style='color: green'>(-2 [-10.0%])</span> 18 |
| `perm_trace_commit_time_ms` | <span style='color: red'>(+0 [+0.5%])</span> 64.40 | <span style='color: red'>(+1 [+0.5%])</span> 257.60 | <span style='color: green'>(-1 [-1.0%])</span> 71.08 | <span style='color: red'>(+1 [+1.6%])</span> 54.81 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+1 [+1.3%])</span> 58.23 | <span style='color: red'>(+3 [+1.3%])</span> 232.91 | <span style='color: red'>(+1 [+1.3%])</span> 68.86 | <span style='color: green'>(-0 [-0.8%])</span> 51.47 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+0 [+2.7%])</span> 15.06 | <span style='color: red'>(+2 [+2.7%])</span> 60.22 | <span style='color: red'>(+1 [+7.8%])</span> 17.86 | <span style='color: green'>(-0 [-3.1%])</span> 12.21 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+1 [+1.2%])</span> 61 | <span style='color: red'>(+3 [+1.2%])</span> 244 | <span style='color: red'>(+3 [+3.8%])</span> 83 | <span style='color: green'>(-1 [-2.0%])</span> 48 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 532 | 41 | 1 | 33 | 4,137,502 | 123.57 | 169 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 210 | 699 | 23,446,148 | 150,778,428 | 210 | 296 | 0 | 59.85 | 17.86 | 5 | 71.08 | 64 | 95 | 64 | 4 | 57 | 10,899,170 | 23 | 47 | 1,103,000 | 27.36 | 21 | 78 | 1 | 64 | 
| regex_program | 1 | 150 | 556 | 11,598,276 | 128,513,066 | 150 | 295 | 1 | 51.47 | 15.59 | 4 | 66.18 | 83 | 94 | 83 | 0 | 49 | 2,196,106 | 27 | 69 | 1,104,000 | 31.33 | 17 | 67 | 0 | 83 | 
| regex_program | 2 | 157 | 512 | 11,579,064 | 128,513,066 | 157 | 251 | 1 | 52.72 | 14.55 | 4 | 65.54 | 48 | 84 | 48 | 0 | 49 | 2,177,334 | 18 | 62 | 1,104,000 | 31.03 | 16 | 67 | 0 | 48 | 
| regex_program | 3 | 178 | 532 | 11,853,872 | 103,456,394 | 178 | 263 | 0 | 68.86 | 12.21 | 5 | 54.81 | 49 | 81 | 49 | 0 | 50 | 2,422,606 | 23 | 49 | 826,502 | 31.01 | 18 | 82 | 1 | 49 | 

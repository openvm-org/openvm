...
|:---|---:|---:|---:|
| Total |  9.85 |  6.88 |  6.88 |
| app_proof |  8.19 |  5.21 |  5.21 |
| leaf |  0.99 |  0.99 |  0.99 |
...
| `total_proof_time_ms ` |  4,044.50 |  8,089 |  5,117 |  2,972 |
...
| `execute_preflight_time_ms` |  247.50 |  495 |  274 |  221 |
| `execute_preflight_insn_mi/s` |  36.96 | -          |  38.97 |  34.96 |
| `trace_gen_time_ms   ` |  125 |  250 |  175 |  75 |
| `set_initial_memory_time_ms` |  88 |  176 |  135 |  41 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  3,582 |  7,164 |  4,584 |  2,580 |
| `prover.main_trace_commit_time_ms` |  948.50 |  1,897 |  1,314 |  583 |
| `prover.rap_constraints_time_ms` |  1,929.50 |  3,859 |  2,381 |  1,478 |
| `prover.openings_time_ms` |  703 |  1,406 |  888 |  518 |
| `prover.rap_constraints.logup_gkr_time_ms` |  546 |  1,092 |  586 |  506 |
| `prover.rap_constraints.round0_time_ms` |  1,008.50 |  2,017 |  1,312 |  705 |
...
| `prover.openings.whir_time_ms` |  539.50 |  1,079 |  677 |  402 |
...
| `prover.openings_time_ms` |  283 |  283 |  283 |  283 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/8fa2c50c1963680628e40dadf029542bce5d0b65/sha2_bench-8fa2c50c1963680628e40dadf029542bce5d0b65.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 67 |  |  |  | 339 |  |  |  |  |  |  | 
| app_proof |  |  |  | 2,972 |  | 98 | 11,167,961 | 113.64 | 0 | 8,193 |  | 
...
| leaf | 0 | 112 | 990 | 112 | 34 | 17 | 2 | 7 | 7 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 325 | 115 | 0 | 0 | 106 | 34 | 34 | 51 | 20 | 0 | 102 | 89 | 13 | 3 | 9 | 116 | 115 | 106 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 169 | 45 | 0 | 0 | 64 | 22 | 22 | 27 | 14 | 0 | 58 | 50 | 8 | 1 | 6 | 45 | 45 | 64 | 0 | 3 | 12 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 137 | 31 | 0 | 0 | 61 | 23 | 22 | 25 | 13 | 0 | 43 | 36 | 7 | 1 | 5 | 32 | 31 | 61 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 237,896,248 | 878 | 370 | 0 | 0 | 224 | 107 | 106 | 65 | 50 | 0 | 283 | 247 | 36 | 19 | 16 | 370 | 370 | 224 | 0 | 8 | 50 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,288,077,561 | 4,584 | 1,314 | 0 | 0 | 2,381 | 1,312 | 1,311 | 482 | 586 | 0 | 888 | 677 | 210 | 131 | 79 | 1,314 | 1,314 | 2,381 | 0 | 4 | 584 | 0 | 0 | 
| app_proof | prover | 1 | 751,206,644 | 2,580 | 583 | 0 | 0 | 1,478 | 705 | 704 | 266 | 506 | 0 | 518 | 402 | 115 | 69 | 46 | 583 | 583 | 1,478 | 0 | 5 | 505 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 135 | 1 | 175 | 5,117 | 175 | 135 | 13,329,494,472 | 2,141,911,524 | 15,471,405,996 | 2,097,152 | 0 | 3 | 221 | 7,124,000 | 34.96 | 
| app_proof | 1 | 41 | 1 | 75 | 2,972 | 75 | 41 | 7,598,498,184 | 1,557,865,504 | 9,156,363,688 | 2,097,152 | 0 | 2 | 274 | 4,043,961 | 38.97 | 

...
| `total_proof_time_ms ` |  4,131.50 |  8,263 |  5,216 |  3,047 |
| `compile_metered_time_ms` |  3 |  3 |  3 |  3 |
| `execute_metered_time_ms` |  97 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  114.33 | -          |  114.33 |  114.33 |
| `execute_preflight_insns` |  5,583,980.50 |  11,167,961 |  7,124,000 |  4,043,961 |
| `execute_preflight_time_ms` |  254 |  508 |  286 |  222 |
| `execute_preflight_insn_mi/s` |  36.91 | -          |  38.89 |  34.93 |
| `trace_gen_time_ms   ` |  125 |  250 |  175 |  75 |
| `set_initial_memory_time_ms` |  88 |  176 |  135 |  41 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  3,663 |  7,326 |  4,682 |  2,644 |
| `prover.main_trace_commit_time_ms` |  960 |  1,920 |  1,330 |  590 |
| `prover.rap_constraints_time_ms` |  1,995 |  3,990 |  2,461 |  1,529 |
| `prover.openings_time_ms` |  706.50 |  1,413 |  890 |  523 |
| `prover.rap_constraints.logup_gkr_time_ms` |  558 |  1,116 |  597 |  519 |
| `prover.rap_constraints.round0_time_ms` |  1,056.50 |  2,113 |  1,372 |  741 |
| `prover.rap_constraints.mle_rounds_time_ms` |  379.50 |  759 |  491 |  268 |
...
| `prover.openings.whir_time_ms` |  541.50 |  1,083 |  676 |  407 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/8c00127cc8cc8ba4845a4da05a3011885020dbeb/sha2_bench-8c00127cc8cc8ba4845a4da05a3011885020dbeb.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 70 |  |  |  | 345 |  |  |  |  |  |  | 
| app_proof |  |  |  | 3,047 |  | 97 | 11,167,961 | 114.33 | 0 | 8,367 |  | 
...
| leaf | 0 | 108 | 1,003 | 107 | 34 | 17 | 2 | 7 | 7 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 325 | 117 | 0 | 0 | 109 | 36 | 35 | 51 | 21 | 0 | 97 | 84 | 13 | 3 | 9 | 117 | 117 | 109 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 176 | 47 | 0 | 0 | 69 | 25 | 24 | 28 | 15 | 0 | 59 | 50 | 8 | 1 | 6 | 47 | 47 | 69 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 136 | 32 | 0 | 0 | 61 | 22 | 22 | 24 | 13 | 0 | 41 | 34 | 7 | 1 | 5 | 32 | 32 | 61 | 0 | 3 | 13 | 0 | 0 | 
| leaf | 0 | prover | 237,896,248 | 895 | 374 | 0 | 0 | 226 | 108 | 107 | 66 | 51 | 0 | 294 | 256 | 37 | 20 | 17 | 374 | 374 | 226 | 0 | 12 | 49 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,288,077,561 | 4,682 | 1,330 | 0 | 0 | 2,461 | 1,372 | 1,371 | 491 | 597 | 1 | 890 | 676 | 213 | 133 | 80 | 1,330 | 1,330 | 2,461 | 0 | 6 | 595 | 0 | 0 | 
| app_proof | prover | 1 | 751,206,644 | 2,644 | 590 | 0 | 0 | 1,529 | 741 | 741 | 268 | 519 | 0 | 523 | 407 | 116 | 70 | 46 | 590 | 590 | 1,529 | 0 | 7 | 517 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 135 | 2 | 175 | 5,216 | 175 | 135 | 13,329,494,472 | 2,141,911,524 | 15,471,405,996 | 2,097,152 | 0 | 3 | 222 | 7,124,000 | 34.93 | 
| app_proof | 1 | 41 | 1 | 75 | 3,047 | 75 | 41 | 7,598,498,184 | 1,557,865,504 | 9,156,363,688 | 2,097,152 | 0 | 2 | 286 | 4,043,961 | 38.89 | 

...
|:---|---:|---:|---:|
| Total |  10.06 |  6.100 |  6.100 |
| app_proof |  8.35 |  5.29 |  5.29 |
| leaf |  1.01 |  1.01 |  1.01 |
...
| `total_proof_time_ms ` |  4,126 |  8,252 |  5,188 |  3,064 |
...
| `execute_preflight_time_ms` |  249.50 |  499 |  289 |  210 |
| `execute_preflight_insn_mi/s` |  39.25 | -          |  41.19 |  37.31 |
| `trace_gen_time_ms   ` |  121.50 |  243 |  171 |  72 |
| `set_initial_memory_time_ms` |  87.50 |  175 |  134 |  41 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  3,665.50 |  7,331 |  4,671 |  2,660 |
| `prover.main_trace_commit_time_ms` |  963 |  1,926 |  1,331 |  595 |
| `prover.rap_constraints_time_ms` |  1,991 |  3,982 |  2,449 |  1,533 |
| `prover.openings_time_ms` |  711 |  1,422 |  891 |  531 |
| `prover.rap_constraints.logup_gkr_time_ms` |  559 |  1,118 |  598 |  520 |
| `prover.rap_constraints.round0_time_ms` |  1,048.50 |  2,097 |  1,358 |  739 |
| `prover.rap_constraints.mle_rounds_time_ms` |  382.50 |  765 |  492 |  273 |
...
| `prover.openings.whir_time_ms` |  545 |  1,090 |  677 |  413 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/586f6e427dc13030bf0504f5a491313db8345f70/sha2_bench-586f6e427dc13030bf0504f5a491313db8345f70.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 71 |  |  |  | 345 |  |  |  |  |  |  | 
| app_proof |  |  |  | 3,064 |  | 100 | 11,167,961 | 110.62 | 0 | 8,359 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 337 | 118 | 0 | 0 | 107 | 34 | 33 | 52 | 20 | 0 | 110 | 97 | 13 | 3 | 9 | 118 | 118 | 107 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 172 | 47 | 0 | 0 | 67 | 25 | 24 | 28 | 14 | 0 | 57 | 48 | 8 | 1 | 6 | 47 | 47 | 67 | 0 | 3 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 142 | 33 | 0 | 0 | 66 | 24 | 23 | 24 | 17 | 0 | 42 | 35 | 7 | 1 | 5 | 33 | 33 | 66 | 0 | 2 | 13 | 0 | 0 | 
| leaf | 0 | prover | 237,929,016 | 905 | 377 | 0 | 0 | 232 | 112 | 112 | 68 | 50 | 0 | 296 | 258 | 37 | 20 | 17 | 377 | 377 | 231 | 0 | 12 | 50 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,286,242,554 | 4,671 | 1,331 | 0 | 0 | 2,449 | 1,358 | 1,357 | 492 | 598 | 1 | 891 | 677 | 213 | 133 | 80 | 1,331 | 1,331 | 2,449 | 0 | 8 | 597 | 0 | 0 | 
| app_proof | prover | 1 | 750,289,144 | 2,660 | 595 | 0 | 0 | 1,533 | 739 | 739 | 273 | 520 | 0 | 531 | 413 | 118 | 70 | 47 | 595 | 595 | 1,533 | 0 | 7 | 519 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 134 | 1 | 171 | 5,188 | 171 | 134 | 13,311,936,132 | 2,137,449,780 | 15,449,385,912 | 2,097,152 | 0 | 4 | 210 | 7,124,000 | 37.31 | 
| app_proof | 1 | 41 | 1 | 72 | 3,064 | 72 | 41 | 7,588,526,580 | 1,502,398,413 | 9,090,924,993 | 2,097,152 | 0 | 2 | 289 | 4,043,961 | 41.19 | 

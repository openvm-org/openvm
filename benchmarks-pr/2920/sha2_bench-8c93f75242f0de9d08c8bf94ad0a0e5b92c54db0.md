...
|:---|---:|---:|---:|
| Total |  9.83 |  6.85 |  6.86 |
| app_proof |  8.18 |  5.20 |  5.20 |
| leaf |  0.99 |  0.99 |  0.99 |
...
| `total_proof_time_ms ` |  4,040.50 |  8,081 |  5,101 |  2,980 |
| `compile_metered_time_ms` |  4 |  4 |  4 |  4 |
| `execute_metered_time_ms` |  97 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  114.06 | -          |  114.06 |  114.06 |
| `execute_preflight_insns` |  5,583,980.50 |  11,167,961 |  7,124,000 |  4,043,961 |
| `execute_preflight_time_ms` |  241 |  482 |  274 |  208 |
| `execute_preflight_insn_mi/s` |  39.32 | -          |  41.24 |  37.41 |
| `trace_gen_time_ms   ` |  121 |  242 |  170 |  72 |
| `set_initial_memory_time_ms` |  87.50 |  175 |  134 |  41 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  3,589 |  7,178 |  4,587 |  2,591 |
| `prover.main_trace_commit_time_ms` |  950.50 |  1,901 |  1,316 |  585 |
| `prover.rap_constraints_time_ms` |  1,934.50 |  3,869 |  2,387 |  1,482 |
| `prover.openings_time_ms` |  703 |  1,406 |  884 |  522 |
| `prover.rap_constraints.logup_gkr_time_ms` |  546 |  1,092 |  588 |  504 |
| `prover.rap_constraints.round0_time_ms` |  1,012 |  2,024 |  1,315 |  709 |
| `prover.rap_constraints.mle_rounds_time_ms` |  376 |  752 |  483 |  269 |
| `prover.openings.stacked_reduction_time_ms` |  163.50 |  327 |  211 |  116 |
| `prover.openings.stacked_reduction.round0_time_ms` |  100.50 |  201 |  131 |  70 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  62 |  124 |  79 |  45 |
| `prover.openings.whir_time_ms` |  538.50 |  1,077 |  672 |  405 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  991 |  991 |  991 |  991 |
...
| `prover.openings_time_ms` |  286 |  286 |  286 |  286 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/8c93f75242f0de9d08c8bf94ad0a0e5b92c54db0/sha2_bench-8c93f75242f0de9d08c8bf94ad0a0e5b92c54db0.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 70 |  |  |  | 342 |  |  |  |  |  |  | 
| app_proof |  |  |  | 2,980 |  | 97 | 11,167,961 | 114.06 | 0 | 8,185 |  | 
...
| leaf | 0 | 107 | 991 | 107 | 34 | 17 | 2 | 7 | 7 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 324 | 116 | 0 | 0 | 107 | 34 | 34 | 52 | 20 | 0 | 99 | 86 | 13 | 3 | 9 | 117 | 116 | 107 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 164 | 45 | 0 | 0 | 64 | 23 | 22 | 27 | 13 | 0 | 54 | 45 | 8 | 1 | 6 | 45 | 45 | 64 | 0 | 3 | 12 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 137 | 31 | 0 | 0 | 62 | 23 | 22 | 24 | 14 | 0 | 42 | 35 | 7 | 1 | 5 | 32 | 31 | 62 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 237,929,016 | 884 | 370 | 0 | 0 | 227 | 108 | 108 | 66 | 51 | 0 | 286 | 249 | 36 | 19 | 16 | 370 | 370 | 227 | 0 | 9 | 49 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,286,242,554 | 4,587 | 1,315 | 0 | 0 | 2,387 | 1,315 | 1,314 | 483 | 588 | 0 | 884 | 672 | 211 | 131 | 79 | 1,316 | 1,315 | 2,387 | 0 | 5 | 587 | 0 | 0 | 
| app_proof | prover | 1 | 750,289,144 | 2,591 | 585 | 0 | 0 | 1,482 | 709 | 709 | 269 | 504 | 0 | 522 | 405 | 116 | 70 | 45 | 585 | 585 | 1,482 | 0 | 5 | 503 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 134 | 1 | 170 | 5,101 | 170 | 134 | 13,311,936,132 | 2,137,449,780 | 15,449,385,912 | 2,097,152 | 0 | 3 | 208 | 7,124,000 | 37.41 | 
| app_proof | 1 | 41 | 1 | 72 | 2,980 | 72 | 41 | 7,588,526,580 | 1,502,398,413 | 9,090,924,993 | 2,097,152 | 0 | 2 | 274 | 4,043,961 | 41.24 | 

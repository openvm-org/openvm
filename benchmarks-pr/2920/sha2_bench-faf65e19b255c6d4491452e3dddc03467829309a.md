...
| `total_proof_time_ms ` |  4,093 |  8,186 |  5,166 |  3,020 |
| `compile_metered_time_ms` |  3 |  3 |  3 |  3 |
| `execute_metered_time_ms` |  98 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  113.63 | -          |  113.63 |  113.63 |
| `execute_preflight_insns` |  5,583,980.50 |  11,167,961 |  7,124,000 |  4,043,961 |
| `execute_preflight_time_ms` |  273.50 |  547 |  302 |  245 |
| `execute_preflight_insn_mi/s` |  33.08 | -          |  34.69 |  31.47 |
| `trace_gen_time_ms   ` |  125 |  250 |  175 |  75 |
| `set_initial_memory_time_ms` |  88.50 |  177 |  136 |  41 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  3,604.50 |  7,209 |  4,608 |  2,601 |
| `prover.main_trace_commit_time_ms` |  953.50 |  1,907 |  1,322 |  585 |
| `prover.rap_constraints_time_ms` |  1,948 |  3,896 |  2,403 |  1,493 |
| `prover.openings_time_ms` |  701.50 |  1,403 |  882 |  521 |
| `prover.rap_constraints.logup_gkr_time_ms` |  549 |  1,098 |  590 |  508 |
| `prover.rap_constraints.round0_time_ms` |  1,022.50 |  2,045 |  1,326 |  719 |
| `prover.rap_constraints.mle_rounds_time_ms` |  375.50 |  751 |  486 |  265 |
| `prover.openings.stacked_reduction_time_ms` |  162 |  324 |  208 |  116 |
...
| `prover.openings.whir_time_ms` |  539 |  1,078 |  673 |  405 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/faf65e19b255c6d4491452e3dddc03467829309a/sha2_bench-faf65e19b255c6d4491452e3dddc03467829309a.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 67 |  |  |  | 341 |  |  |  |  |  |  | 
| app_proof |  |  |  | 3,020 |  | 98 | 11,167,961 | 113.63 | 0 | 8,290 |  | 
...
| leaf | 0 | 107 | 991 | 106 | 34 | 17 | 2 | 7 | 7 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 322 | 115 | 0 | 0 | 106 | 35 | 34 | 51 | 19 | 0 | 99 | 85 | 13 | 3 | 9 | 116 | 115 | 106 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 169 | 46 | 0 | 0 | 67 | 24 | 24 | 28 | 14 | 0 | 55 | 46 | 8 | 1 | 6 | 47 | 46 | 67 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 141 | 32 | 0 | 0 | 62 | 22 | 21 | 24 | 14 | 0 | 46 | 39 | 7 | 1 | 5 | 32 | 32 | 62 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 237,896,248 | 883 | 369 | 0 | 0 | 225 | 106 | 105 | 67 | 50 | 0 | 288 | 251 | 36 | 19 | 16 | 370 | 369 | 224 | 0 | 10 | 49 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,288,077,561 | 4,608 | 1,322 | 0 | 0 | 2,403 | 1,326 | 1,326 | 486 | 590 | 1 | 882 | 673 | 208 | 130 | 77 | 1,322 | 1,322 | 2,403 | 0 | 4 | 588 | 0 | 0 | 
| app_proof | prover | 1 | 751,206,644 | 2,601 | 585 | 0 | 0 | 1,493 | 719 | 719 | 265 | 508 | 0 | 521 | 405 | 116 | 70 | 45 | 585 | 585 | 1,493 | 0 | 5 | 506 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 136 | 1 | 175 | 5,166 | 175 | 136 | 13,329,494,472 | 2,141,911,524 | 15,471,405,996 | 2,097,152 | 0 | 3 | 245 | 7,124,000 | 31.47 | 
| app_proof | 1 | 41 | 1 | 75 | 3,020 | 75 | 41 | 7,598,498,184 | 1,557,865,504 | 9,156,363,688 | 2,097,152 | 0 | 2 | 302 | 4,043,961 | 34.69 | 

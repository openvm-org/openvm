...
| `total_proof_time_ms ` |  3,849 |  3,849 |  3,849 |  3,849 |
| `compile_metered_time_ms` |  3 |  3 |  3 |  3 |
| `execute_metered_time_ms` |  25 | -          | -          | -          |
| `execute_metered_insns` |  1,979,971 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  76.59 | -          |  76.59 |  76.59 |
| `execute_preflight_insns` |  1,979,971 |  1,979,971 |  1,979,971 |  1,979,971 |
| `execute_preflight_time_ms` |  80 |  80 |  80 |  80 |
| `execute_preflight_insn_mi/s` |  32.67 | -          |  32.67 |  32.67 |
| `trace_gen_time_ms   ` |  72 |  72 |  72 |  72 |
| `set_initial_memory_time_ms` |  134 |  134 |  134 |  134 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  3,561 |  3,561 |  3,561 |  3,561 |
| `prover.main_trace_commit_time_ms` |  1,129 |  1,129 |  1,129 |  1,129 |
| `prover.rap_constraints_time_ms` |  1,656 |  1,656 |  1,656 |  1,656 |
| `prover.openings_time_ms` |  775 |  775 |  775 |  775 |
| `prover.rap_constraints.logup_gkr_time_ms` |  279 |  279 |  279 |  279 |
| `prover.rap_constraints.round0_time_ms` |  1,005 |  1,005 |  1,005 |  1,005 |
| `prover.rap_constraints.mle_rounds_time_ms` |  371 |  371 |  371 |  371 |
| `prover.openings.stacked_reduction_time_ms` |  181 |  181 |  181 |  181 |
| `prover.openings.stacked_reduction.round0_time_ms` |  103 |  103 |  103 |  103 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  854 |  854 |  854 |  854 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/8c00127cc8cc8ba4845a4da05a3011885020dbeb/kitchen_sink-8c00127cc8cc8ba4845a4da05a3011885020dbeb.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 70 |  |  |  | 363 |  |  |  |  |  |  | 
| app_proof |  |  |  | 3,849 |  | 25 | 1,979,971 | 76.59 | 0 | 3,879 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,577,981 | 325 | 116 | 0 | 0 | 106 | 35 | 35 | 50 | 20 | 0 | 102 | 88 | 13 | 3 | 9 | 116 | 116 | 106 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 168 | 47 | 0 | 0 | 66 | 24 | 24 | 28 | 13 | 0 | 54 | 46 | 8 | 1 | 6 | 47 | 47 | 66 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 140 | 31 | 0 | 0 | 61 | 22 | 22 | 24 | 13 | 0 | 46 | 39 | 7 | 1 | 5 | 32 | 31 | 61 | 0 | 3 | 12 | 0 | 0 | 
| leaf | 0 | prover | 167,484,093 | 750 | 250 | 0 | 0 | 289 | 103 | 102 | 56 | 128 | 0 | 210 | 183 | 26 | 13 | 13 | 251 | 250 | 289 | 0 | 7 | 127 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,089,667,964 | 3,561 | 1,128 | 0 | 0 | 1,656 | 1,005 | 1,004 | 371 | 279 | 1 | 775 | 594 | 181 | 103 | 77 | 1,129 | 1,128 | 1,656 | 0 | 5 | 277 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 134 | 2 | 72 | 3,849 | 72 | 134 | 10,281,410,592 | 2,838,841,776 | 13,120,252,368 | 2,097,152 | 0 | 4 | 80 | 1,979,971 | 32.67 | 

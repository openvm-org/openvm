...
|:---|---:|---:|---:|
| Total |  11.02 |  4.57 |  4.57 |
| app_proof |  8.95 |  2.49 |  2.49 |
| leaf |  1.41 |  1.41 |  1.41 |
...
| `total_proof_time_ms ` |  2,212 |  8,848 |  2,394 |  2,129 |
...
| `execute_preflight_time_ms` |  166.50 |  666 |  208 |  101 |
| `execute_preflight_insn_mi/s` |  33.74 | -          |  34.54 |  31.46 |
| `trace_gen_time_ms   ` |  58 |  232 |  64 |  54 |
| `set_initial_memory_time_ms` |  64.50 |  258 |  135 |  41 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,921.25 |  7,685 |  2,091 |  1,861 |
| `prover.main_trace_commit_time_ms` |  533.50 |  2,134 |  622 |  503 |
| `prover.rap_constraints_time_ms` |  1,254.25 |  5,017 |  1,333 |  1,222 |
| `prover.openings_time_ms` |  132.25 |  529 |  135 |  130 |
| `prover.rap_constraints.logup_gkr_time_ms` |  345.75 |  1,383 |  429 |  318 |
| `prover.rap_constraints.round0_time_ms` |  663 |  2,652 |  667 |  658 |
| `prover.rap_constraints.mle_rounds_time_ms` |  244.75 |  979 |  247 |  242 |
| `prover.openings.stacked_reduction_time_ms` |  95.75 |  383 |  98 |  93 |
| `prover.openings.stacked_reduction.round0_time_ms` |  58 |  232 |  59 |  57 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  37.50 |  150 |  39 |  36 |
| `prover.openings.whir_time_ms` |  36.25 |  145 |  38 |  35 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/36054f43cde087bddf5f720102b9130be924236c/sha2_bench-36054f43cde087bddf5f720102b9130be924236c.memory.svg)
...
| app_proof |  |  |  |  |  | 2,129 |  |  | 97 | 11,167,961 | 114.69 | 0 | 8,952 |  | 
...
| leaf | 0 | 145 | 1,407 | 144 | 50 | 22 | 2 | 6 | 6 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 61,220,667 | 352 | 182 | 0 | 0 | 131 | 38 | 37 | 66 | 27 | 0 | 38 | 19 | 18 | 5 | 13 | 183 | 131 | 0 | 2 | 26 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,943 | 149 | 48 | 0 | 0 | 73 | 25 | 24 | 30 | 18 | 0 | 26 | 17 | 8 | 2 | 6 | 49 | 73 | 0 | 2 | 17 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 122 | 31 | 0 | 0 | 61 | 23 | 22 | 24 | 13 | 0 | 29 | 21 | 7 | 1 | 5 | 31 | 61 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 425,192,422 | 1,262 | 800 | 0 | 159 | 351 | 168 | 167 | 106 | 76 | 0 | 109 | 45 | 63 | 35 | 27 | 801 | 351 | 0 | 6 | 75 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 640,057,593 | 2,091 | 622 | 0 | 120 | 1,333 | 658 | 657 | 245 | 429 | 125 | 135 | 37 | 98 | 59 | 39 | 622 | 1,333 | 0 | 3 | 302 | 0 | 0 | 
| app_proof | prover | 1 | 640,057,356 | 1,865 | 503 | 0 | 2 | 1,230 | 666 | 666 | 245 | 318 | 0 | 130 | 35 | 95 | 57 | 37 | 503 | 1,230 | 0 | 3 | 316 | 0 | 0 | 
| app_proof | prover | 2 | 640,057,356 | 1,868 | 503 | 0 | 2 | 1,232 | 667 | 666 | 247 | 318 | 0 | 131 | 38 | 93 | 57 | 36 | 504 | 1,232 | 0 | 4 | 317 | 0 | 0 | 
| app_proof | prover | 3 | 640,057,588 | 1,861 | 505 | 0 | 2 | 1,222 | 661 | 660 | 242 | 318 | 0 | 133 | 35 | 97 | 59 | 38 | 505 | 1,222 | 0 | 3 | 316 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 64 | 2,394 | 64 | 135 | 0 | 4 | 101 | 2,851,000 | 31.46 | 
| app_proof | 1 | 57 | 2,172 | 57 | 41 | 0 | 1 | 208 | 2,851,000 | 34.46 | 
| app_proof | 2 | 57 | 2,153 | 57 | 41 | 0 | 1 | 185 | 2,851,000 | 34.54 | 
| app_proof | 3 | 54 | 2,129 | 54 | 41 | 0 | 1 | 172 | 2,614,961 | 34.51 | 

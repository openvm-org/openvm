...
|:---|---:|---:|---:|
| Total |  17.39 |  5.05 |  5.05 |
| app_proof |  14.17 |  2.61 |  2.61 |
| leaf |  2.41 |  1.63 |  1.63 |
...
| `total_proof_time_ms ` |  2,337.67 |  14,026 |  2,465 |  2,221 |
| `execute_metered_time_ms` |  143 | -          | -          | -          |
| `execute_metered_insns` |  14,365,133 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  100.34 | -          |  100.34 |  100.34 |
| `execute_preflight_insns` |  2,394,188.83 |  14,365,133 |  2,413,000 |  2,300,133 |
| `execute_preflight_time_ms` |  240.50 |  1,443 |  315 |  89 |
| `execute_preflight_insn_mi/s` |  30.90 | -          |  32.61 |  29.23 |
| `trace_gen_time_ms   ` |  36.50 |  219 |  54 |  33 |
| `set_initial_memory_time_ms` |  56.67 |  340 |  135 |  41 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  2,002.67 |  12,016 |  2,186 |  1,907 |
| `prover.main_trace_commit_time_ms` |  706.50 |  4,239 |  865 |  672 |
| `prover.rap_constraints_time_ms` |  1,109 |  6,654 |  1,195 |  1,045 |
| `prover.openings_time_ms` |  185.83 |  1,115 |  189 |  183 |
| `prover.rap_constraints.logup_gkr_time_ms` |  292.33 |  1,754 |  334 |  256 |
| `prover.rap_constraints.round0_time_ms` |  551.17 |  3,307 |  604 |  519 |
| `prover.rap_constraints.mle_rounds_time_ms` |  264.33 |  1,586 |  275 |  261 |
...
| `prover.openings.whir_time_ms` |  46.33 |  278 |  50 |  45 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,203.50 |  2,407 |  1,628 |  779 |
| `execute_preflight_time_ms` |  5 |  10 |  5 |  5 |
| `trace_gen_time_ms   ` |  131 |  262 |  174 |  88 |
| `generate_blob_total_time_ms` |  21.50 |  43 |  29 |  14 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,072 |  2,144 |  1,454 |  690 |
| `prover.main_trace_commit_time_ms` |  648 |  1,296 |  912 |  384 |
| `prover.rap_constraints_time_ms` |  325 |  650 |  423 |  227 |
| `prover.openings_time_ms` |  98 |  196 |  117 |  79 |
| `prover.rap_constraints.logup_gkr_time_ms` |  70 |  140 |  87 |  53 |
| `prover.rap_constraints.round0_time_ms` |  158 |  316 |  212 |  104 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/36054f43cde087bddf5f720102b9130be924236c/keccak-36054f43cde087bddf5f720102b9130be924236c.memory.svg)
...
| app_proof |  |  |  |  |  | 2,221 |  |  | 143 | 14,365,133 | 100.34 | 0 | 14,176 |  | 
...
| internal_recursive.0 | 1 | 14 | 165 | 13 | 2 | 1 | 2 | 2 | 2 | 
| internal_recursive.1 | 1 | 9 | 134 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 174 | 1,628 | 173 | 60 | 29 | 5 | 7 | 7 | 
| leaf | 1 | 88 | 779 | 88 | 30 | 14 | 5 | 7 | 7 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 81,415,156 | 477 | 254 | 0 | 1 | 178 | 51 | 51 | 94 | 31 | 0 | 45 | 21 | 23 | 7 | 16 | 254 | 178 | 0 | 3 | 30 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,943 | 151 | 49 | 0 | 0 | 74 | 25 | 25 | 30 | 17 | 0 | 26 | 17 | 8 | 2 | 6 | 50 | 74 | 0 | 2 | 17 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 |
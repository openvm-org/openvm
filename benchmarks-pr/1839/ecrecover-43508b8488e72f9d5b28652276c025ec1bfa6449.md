...
|:---|---:|---:|
| Total | <span style='color: red'>(+0 [+0.3%])</span> 11.98 | <span style='color: red'>(+0 [+0.3%])</span> 11.98 |
| ecrecover_program | <span style='color: red'>(+0 [+2.7%])</span> 1.38 | <span style='color: red'>(+0 [+2.7%])</span> 1.38 |
| leaf |  10.49 |  10.49 |
...
| `total_proof_time_ms ` | <span style='color: red'>(+36 [+2.7%])</span> 1,378 | <span style='color: red'>(+36 [+2.7%])</span> 1,378 | <span style='color: red'>(+36 [+2.7%])</span> 1,378 | <span style='color: red'>(+36 [+2.7%])</span> 1,378 |
| `main_cells_used     ` |  8,179,549 |  8,179,549 |  8,179,549 |  8,179,549 |
| `total_cycles        ` |  137,283 |  137,283 |  137,283 |  137,283 |
| `execute_metered_time_ms` | <span style='color: red'>(+3 [+2.7%])</span> 113 | -          | -          | -          |
| `execute_metered_insn_mi/s` | <span style='color: green'>(-0 [-1.6%])</span> 1.66 | -          | <span style='color: green'>(-0 [-1.6%])</span> 1.66 | <span style='color: green'>(-0 [-1.6%])</span> 1.66 |
...
| `trace_gen_time_ms   ` | <span style='color: red'>(+5 [+1.4%])</span> 354 | <span style='color: red'>(+5 [+1.4%])</span> 354 | <span style='color: red'>(+5 [+1.4%])</span> 354 | <span style='color: red'>(+5 [+1.4%])</span> 354 |
...
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+29 [+3.2%])</span> 938 | <span style='color: red'>(+29 [+3.2%])</span> 938 | <span style='color: red'>(+29 [+3.2%])</span> 938 | <span style='color: red'>(+29 [+3.2%])</span> 938 |
...
| `perm_trace_commit_time_ms` | <span style='color: red'>(+7 [+5.6%])</span> 132 | <span style='color: red'>(+7 [+5.6%])</span> 132 | <span style='color: red'>(+7 [+5.6%])</span> 132 | <span style='color: red'>(+7 [+5.6%])</span> 132 |
...
| `pcs_opening_time_ms ` | <span style='color: red'>(+11 [+2.7%])</span> 420 | <span style='color: red'>(+11 [+2.7%])</span> 420 | <span style='color: red'>(+11 [+2.7%])</span> 420 | <span style='color: red'>(+11 [+2.7%])</span> 420 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  10,491 |  10,491 |  10,491 |  10,491 |
| `main_cells_used     ` |  242,450,312 |  242,450,312 |  242,450,312 |  242,450,312 |
| `total_cycles        ` |  2,934,811 |  2,934,811 |  2,934,811 |  2,934,811 |
| `execute_metered_time_ms` |  839 |  839 |  839 |  839 |
| `execute_metered_insn_mi/s` |  3.50 | -          |  3.50 |  3.50 |
| `execute_e3_time_ms  ` |  1,011 |  1,011 |  1,011 |  1,011 |
| `execute_e3_insn_mi/s` |  2.90 | -          |  2.90 |  2.90 |
| `trace_gen_time_ms   ` |  590 |  590 |  590 |  590 |
| `memory_finalize_time_ms` |  16 |  16 |  16 |  16 |
| `boundary_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  8,051 |  8,051 |  8,051 |  8,051 |
| `main_trace_commit_time_ms` |  1,493 |  1,493 |  1,493 |  1,493 |
| `generate_perm_trace_time_ms` |  787 |  787 |  787 |  787 |
| `perm_trace_commit_time_ms` |  2,072 |  2,072 |  2,072 |  2,072 |
| `quotient_poly_compute_time_ms` |  886 |  886 |  886 |  886 |
| `quotient_poly_commit_time_ms` |  623 |  623 |  623 |  623 |
| `pcs_opening_time_ms ` |  2,184 |  2,184 |  2,184 |  2,184 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program |  | 1 |  | 23 | 137,284 | 1 | 5,957 | 113 | 1.66 | 
| leaf | 10,634 |  | 1 |  |  | 1 |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 590 | 10,491 | 2,934,811 | 992,054,762 | 8,051 | 886 | 623 | 2,072 | 2,184 | 16 | 1,493 | 242,450,312 | 2,934,812 | 787 | 839 | 3.50 | 1,011 | 2.90 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 354 | 1,378 | 137,283 | 32,925,330 | 938 | 79 | 132 | 2,063 | 132 | 420 | 69 | 23 | 76 | 130 | 8,179,549 | 137,284 | 29 | 86 | 1.59 | 0 | 

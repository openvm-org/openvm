...
| `total_proof_time_ms ` |  4,115 |  8,230 |  5,193 |  3,037 |
...
| `execute_preflight_time_ms` |  254.50 |  509 |  281 |  228 |
| `execute_preflight_insn_mi/s` |  35.12 | -          |  36.53 |  33.70 |
| `trace_gen_time_ms   ` |  125 |  250 |  175 |  75 |
| `set_initial_memory_time_ms` |  88.50 |  177 |  136 |  41 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  3,645 |  7,290 |  4,652 |  2,638 |
| `prover.main_trace_commit_time_ms` |  964.50 |  1,929 |  1,334 |  595 |
| `prover.rap_constraints_time_ms` |  1,970.50 |  3,941 |  2,423 |  1,518 |
| `prover.openings_time_ms` |  708.50 |  1,417 |  894 |  523 |
| `prover.rap_constraints.logup_gkr_time_ms` |  558 |  1,116 |  599 |  517 |
| `prover.rap_constraints.round0_time_ms` |  1,026.50 |  2,053 |  1,327 |  726 |
| `prover.rap_constraints.mle_rounds_time_ms` |  385 |  770 |  496 |  274 |
| `prover.openings.stacked_reduction_time_ms` |  167.50 |  335 |  217 |  118 |
...
| `prover.openings.whir_time_ms` |  540.50 |  1,081 |  677 |  404 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/b280f9cc59602c7ee6e5a26b3f4dd4200b66d462/sha2_bench-b280f9cc59602c7ee6e5a26b3f4dd4200b66d462.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 69 |  |  |  | 341 |  |  |  |  |  |  | 
| app_proof |  |  |  | 3,037 |  | 98 | 11,167,961 | 112.85 | 0 | 8,334 |  | 
...
| leaf | 0 | 112 | 1,005 | 112 | 38 | 17 | 2 | 7 | 7 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 327 | 117 | 0 | 0 | 108 | 35 | 34 | 52 | 20 | 0 | 100 | 87 | 13 | 3 | 9 | 118 | 117 | 108 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 169 | 47 | 0 | 0 | 67 | 25 | 24 | 28 | 13 | 0 | 54 | 45 | 8 | 1 | 6 | 47 | 47 | 67 | 0 | 3 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 139 | 31 | 0 | 0 | 63 | 23 | 23 | 25 | 14 | 0 | 44 | 36 | 7 | 1 | 5 | 32 | 31 | 63 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 237,896,248 | 892 | 375 | 0 | 0 | 228 | 109 | 109 | 67 | 51 | 0 | 288 | 251 | 37 | 20 | 17 | 376 | 375 | 228 | 0 | 10 | 50 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,288,077,561 | 4,652 | 1,333 | 0 | 0 | 2,423 | 1,327 | 1,326 | 496 | 599 | 0 | 894 | 677 | 217 | 135 | 81 | 1,334 | 1,333 | 2,423 | 0 | 5 | 598 | 0 | 0 | 
| app_proof | prover | 1 | 751,206,644 | 2,638 | 595 | 0 | 0 | 1,518 | 726 | 726 | 274 | 517 | 0 | 523 | 404 | 118 | 72 | 46 | 595 | 595 | 1,518 | 0 | 6 | 515 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 136 | 2 | 175 | 5,193 | 175 | 136 | 13,329,494,472 | 2,141,911,524 | 15,471,405,996 | 2,097,152 | 0 | 3 | 228 | 7,124,000 | 33.70 | 
| app_proof | 1 | 41 | 1 | 75 | 3,037 | 75 | 41 | 7,598,498,184 | 1,557,865,504 | 9,156,363,688 | 2,097,152 | 0 | 2 | 281 | 4,043,961 | 36.53 | 

...
|:---|---:|---:|---:|
| Total |  9.92 |  6.91 |  6.91 |
| app_proof |  8.24 |  5.24 |  5.24 |
...
| `total_proof_time_ms ` |  4,070.50 |  8,141 |  5,137 |  3,004 |
...
| `execute_preflight_insn_mi/s` |  39.84 | -          |  41.83 |  37.86 |
| `trace_gen_time_ms   ` |  121.50 |  243 |  171 |  72 |
| `set_initial_memory_time_ms` |  88 |  176 |  135 |  41 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  3,619 |  7,238 |  4,624 |  2,614 |
| `prover.main_trace_commit_time_ms` |  958.50 |  1,917 |  1,327 |  590 |
| `prover.rap_constraints_time_ms` |  1,952.50 |  3,905 |  2,408 |  1,497 |
| `prover.openings_time_ms` |  707 |  1,414 |  888 |  526 |
| `prover.rap_constraints.logup_gkr_time_ms` |  550.50 |  1,101 |  590 |  511 |
| `prover.rap_constraints.round0_time_ms` |  1,022.50 |  2,045 |  1,329 |  716 |
| `prover.rap_constraints.mle_rounds_time_ms` |  378 |  756 |  487 |  269 |
...
| `prover.openings.whir_time_ms` |  542 |  1,084 |  675 |  409 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/d4891d7b5a1c6895f076030261807dd27b180230/sha2_bench-d4891d7b5a1c6895f076030261807dd27b180230.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 78 |  |  |  | 370 |  |  |  |  |  |  | 
| app_proof |  |  |  | 3,004 |  | 100 | 11,167,961 | 110.75 | 0 | 8,248 |  | 
...
| leaf | 0 | 106 | 997 | 106 | 34 | 17 | 2 | 7 | 7 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 326 | 117 | 0 | 0 | 107 | 34 | 33 | 52 | 20 | 0 | 101 | 87 | 13 | 3 | 9 | 117 | 117 | 107 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 173 | 47 | 0 | 0 | 67 | 25 | 24 | 28 | 14 | 0 | 57 | 49 | 8 | 1 | 6 | 47 | 47 | 67 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 137 | 32 | 0 | 0 | 63 | 23 | 22 | 24 | 15 | 0 | 41 | 34 | 7 | 1 | 5 | 32 | 32 | 63 | 0 | 3 | 13 | 0 | 0 | 
| leaf | 0 | prover | 237,929,016 | 890 | 375 | 0 | 0 | 228 | 109 | 108 | 67 | 50 | 0 | 286 | 248 | 37 | 20 | 17 | 376 | 375 | 228 | 0 | 10 | 49 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,286,242,554 | 4,624 | 1,327 | 0 | 0 | 2,408 | 1,329 | 1,328 | 487 | 590 | 0 | 888 | 675 | 213 | 132 | 80 | 1,327 | 1,327 | 2,408 | 0 | 5 | 589 | 0 | 0 | 
| app_proof | prover | 1 | 750,289,144 | 2,614 | 590 | 0 | 0 | 1,497 | 716 | 716 | 269 | 511 | 0 | 526 | 409 | 117 | 71 | 46 | 590 | 590 | 1,497 | 0 | 5 | 510 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 135 | 1 | 171 | 5,137 | 171 | 135 | 13,311,936,132 | 2,137,449,780 | 15,449,385,912 | 2,097,152 | 0 | 3 | 207 | 7,124,000 | 37.86 | 
| app_proof | 1 | 41 | 1 | 72 | 3,004 | 72 | 41 | 7,588,526,580 | 1,502,398,413 | 9,090,924,993 | 2,097,152 | 0 | 2 | 275 | 4,043,961 | 41.83 | 

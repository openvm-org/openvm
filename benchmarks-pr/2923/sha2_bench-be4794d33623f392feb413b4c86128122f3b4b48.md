...
|:---|---:|---:|---:|
| Total |  10.06 |  7.01 |  7.01 |
| app_proof |  8.36 |  5.31 |  5.31 |
| leaf |  1.01 |  1.01 |  1.01 |
...
| `total_proof_time_ms ` |  4,117 |  8,234 |  5,183 |  3,051 |
| `compile_metered_time_ms` |  4 |  4 |  4 |  4 |
| `execute_metered_time_ms` |  128 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  86.83 | -          |  86.83 |  86.83 |
| `execute_preflight_insns` |  5,583,980.50 |  11,167,961 |  7,124,000 |  4,043,961 |
| `execute_preflight_time_ms` |  286.50 |  573 |  337 |  236 |
| `execute_preflight_insn_mi/s` |  35.04 | -          |  36.88 |  33.19 |
| `trace_gen_time_ms   ` |  131 |  262 |  185 |  77 |
| `set_initial_memory_time_ms` |  90.50 |  181 |  140 |  41 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  3,607 |  7,214 |  4,620 |  2,594 |
| `prover.main_trace_commit_time_ms` |  959 |  1,918 |  1,335 |  583 |
| `prover.rap_constraints_time_ms` |  1,947 |  3,894 |  2,399 |  1,495 |
| `prover.openings_time_ms` |  699.50 |  1,399 |  885 |  514 |
| `prover.rap_constraints.logup_gkr_time_ms` |  547.50 |  1,095 |  589 |  506 |
| `prover.rap_constraints.round0_time_ms` |  1,024 |  2,048 |  1,327 |  721 |
| `prover.rap_constraints.mle_rounds_time_ms` |  374 |  748 |  481 |  267 |
| `prover.openings.stacked_reduction_time_ms` |  159 |  318 |  209 |  109 |
| `prover.openings.stacked_reduction.round0_time_ms` |  97.50 |  195 |  130 |  65 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  60.50 |  121 |  78 |  43 |
| `prover.openings.whir_time_ms` |  540.50 |  1,081 |  676 |  405 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/be4794d33623f392feb413b4c86128122f3b4b48/sha2_bench-be4794d33623f392feb413b4c86128122f3b4b48.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 80 |  |  |  | 370 |  |  |  |  |  |  | 
| app_proof |  |  |  | 3,051 |  | 128 | 11,167,961 | 86.83 | 0 | 8,369 |  | 
...
| app_proof | VmAirWrapper<Rv64BaseAluU16AdapterAir, AddSubCoreAir<4, 16> | 0 |  | 27 | 
...
| app_proof | VmAirWrapper<Rv64LoadStoreAdapterAir, LoadStoreCoreAir<8> | 0 | 19 | 34 | 
...
| app_proof | VmAirWrapper<Rv64JalrAdapterAir, Rv64JalrCoreAir> | 1 | 45 | 46 | 
| app_proof | VmAirWrapper<Rv64LoadStoreAdapterAir, LoadSignExtendCoreAir<8, 8> | 1 | 0 | 0 | 
| app_proof | VmAirWrapper<Rv64LoadStoreAdapterAir, LoadStoreCoreAir<8> | 1 | 8 | 8 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 26 | 355 | 26 | 8 | 1 | 2 | 4 | 4 | 
| internal_recursive.0 | 1 | 14 | 185 | 14 | 2 | 0 | 2 | 1 | 2 | 
| internal_recursive.1 | 1 | 11 | 151 | 11 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 118 | 1,006 | 118 | 36 | 17 | 2 | 8 | 8 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 329 | 115 | 0 | 0 | 110 | 36 | 35 | 53 | 20 | 0 | 102 | 88 | 14 | 3 | 10 | 116 | 115 | 110 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 171 | 46 | 0 | 0 | 68 | 24 | 24 | 28 | 14 | 0 | 55 | 46 | 8 | 1 | 6 | 46 | 46 | 68 | 0 | 3 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 139 | 31 | 0 | 0 | 64 | 24 | 23 | 25 | 14 | 0 | 43 | 36 | 7 | 1 | 5 | 31 | 31 | 64 | 0 | 2 | 13 | 0 | 0 | 
| leaf | 0 | prover | 237,896,248 | 887 | 368 | 0 | 0 | 226 | 108 | 107 | 67 | 50 | 0 | 293 | 256 | 36 | 19 | 17 | 368 | 368 | 225 | 0 | 9 | 49 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,288,077,561 | 4,620 | 1,335 | 0 | 0 | 2,399 | 1,327 | 1,327 | 481 | 589 | 1 | 885 | 676 | 209 | 130 | 78 | 1,335 | 1,335 | 2,399 | 0 | 4 | 587 | 0 | 0 | 
| app_proof | prover | 1 | 751,206,644 | 2,594 | 583 | 0 | 0 | 1,495 | 721 | 721 | 267 | 506 | 0 | 514 | 405 | 109 | 65 | 43 | 583 | 583 | 1,495 | 0 | 6 | 504 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 140 | 1 | 185 | 5,183 | 185 | 140 | 13,329,494,472 | 2,141,911,524 | 15,471,405,996 | 2,097,152 | 0 | 4 | 236 | 7,124,000 | 33.19 | 
| app_proof | 1 | 41 | 1 | 77 | 3,051 | 77 | 41 | 7,598,498,184 | 1,557,865,504 | 9,156,363,688 | 2,097,152 | 0 | 2 | 337 | 4,043,961 | 36.88 | 

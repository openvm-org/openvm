...
| `total_proof_time_ms ` |  3,859 |  3,859 |  3,859 |  3,859 |
| `compile_metered_time_ms` |  3 |  3 |  3 |  3 |
| `execute_metered_time_ms` |  26 | -          | -          | -          |
| `execute_metered_insns` |  1,979,971 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  75.95 | -          |  75.95 |  75.95 |
| `execute_preflight_insns` |  1,979,971 |  1,979,971 |  1,979,971 |  1,979,971 |
| `execute_preflight_time_ms` |  89 |  89 |  89 |  89 |
| `execute_preflight_insn_mi/s` |  30.46 | -          |  30.46 |  30.46 |
| `trace_gen_time_ms   ` |  73 |  73 |  73 |  73 |
| `set_initial_memory_time_ms` |  136 |  136 |  136 |  136 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  3,559 |  3,559 |  3,559 |  3,559 |
| `prover.main_trace_commit_time_ms` |  1,134 |  1,134 |  1,134 |  1,134 |
| `prover.rap_constraints_time_ms` |  1,647 |  1,647 |  1,647 |  1,647 |
| `prover.openings_time_ms` |  778 |  778 |  778 |  778 |
| `prover.rap_constraints.logup_gkr_time_ms` |  275 |  275 |  275 |  275 |
| `prover.rap_constraints.round0_time_ms` |  998 |  998 |  998 |  998 |
| `prover.rap_constraints.mle_rounds_time_ms` |  373 |  373 |  373 |  373 |
| `prover.openings.stacked_reduction_time_ms` |  182 |  182 |  182 |  182 |
| `prover.openings.stacked_reduction.round0_time_ms` |  104 |  104 |  104 |  104 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  849 |  849 |  849 |  849 |
...
| `prover.openings_time_ms` |  207 |  207 |  207 |  207 |
...
| `prover.openings.whir_time_ms` |  180 |  180 |  180 |  180 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/90cdb88711e40f0fbbb4f199c3771d4f1c34d0c3/kitchen_sink-90cdb88711e40f0fbbb4f199c3771d4f1c34d0c3.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 72 |  |  |  | 368 |  |  |  |  |  |  | 
| app_proof |  |  |  | 3,859 |  | 26 | 1,979,971 | 75.95 | 0 | 3,889 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,577,981 | 317 | 115 | 0 | 0 | 105 | 34 | 34 | 50 | 20 | 0 | 95 | 82 | 13 | 3 | 9 | 116 | 115 | 105 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 167 | 47 | 0 | 0 | 66 | 24 | 24 | 28 | 13 | 0 | 53 | 45 | 8 | 1 | 6 | 47 | 47 | 66 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 135 | 31 | 0 | 0 | 63 | 23 | 22 | 25 | 15 | 0 | 40 | 33 | 7 | 1 | 5 | 31 | 31 | 63 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 167,484,093 | 744 | 249 | 0 | 0 | 287 | 101 | 100 | 57 | 128 | 0 | 207 | 180 | 26 | 13 | 12 | 250 | 249 | 287 | 0 | 8 | 128 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,089,667,964 | 3,559 | 1,133 | 0 | 0 | 1,647 | 998 | 997 | 373 | 275 | 1 | 778 | 596 | 182 | 104 | 77 | 1,134 | 1,133 | 1,647 | 0 | 4 | 273 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 136 | 2 | 73 | 3,859 | 73 | 136 | 10,281,410,592 | 2,838,841,776 | 13,120,252,368 | 2,097,152 | 0 | 4 | 89 | 1,979,971 | 30.46 | 

...
| `total_proof_time_ms ` |  514.50 |  1,029 |  568 |  461 |
| `compile_metered_time_ms` |  4 |  4 |  4 |  4 |
| `execute_metered_time_ms` |  20 | -          | -          | -          |
| `execute_metered_insns` |  4,000,051 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  190.90 | -          |  190.90 |  190.90 |
| `execute_preflight_insns` |  2,000,025.50 |  4,000,051 |  2,621,000 |  1,379,051 |
| `execute_preflight_time_ms` |  53 |  106 |  64 |  42 |
| `execute_preflight_insn_mi/s` |  47.80 | -          |  51.05 |  44.56 |
| `trace_gen_time_ms   ` |  28 |  56 |  34 |  22 |
| `set_initial_memory_time_ms` |  88.50 |  177 |  136 |  41 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  344 |  688 |  345 |  343 |
| `prover.main_trace_commit_time_ms` |  73 |  146 |  74 |  72 |
| `prover.rap_constraints_time_ms` |  189 |  378 |  190 |  188 |
| `prover.openings_time_ms` |  81 |  162 |  82 |  80 |
| `prover.rap_constraints.logup_gkr_time_ms` |  129 |  258 |  130 |  128 |
| `prover.rap_constraints.round0_time_ms` |  38.50 |  77 |  40 |  37 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  396 |  396 |  396 |  396 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/42afe481ecd5e1577d8eb4d9dfa8312a2307a45e/fibonacci-42afe481ecd5e1577d8eb4d9dfa8312a2307a45e.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 69 |  |  |  | 344 |  |  |  |  |  |  | 
| app_proof |  |  |  | 461 |  | 20 | 4,000,051 | 190.90 | 0 | 1,055 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 27,277,885 | 261 | 82 | 0 | 0 | 97 | 32 | 31 | 45 | 20 | 0 | 80 | 69 | 11 | 2 | 8 | 82 | 82 | 97 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 169 | 46 | 0 | 0 | 67 | 24 | 24 | 27 | 14 | 0 | 55 | 47 | 8 | 1 | 6 | 46 | 46 | 67 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 134 | 32 | 0 | 0 | 62 | 23 | 22 | 24 | 14 | 0 | 38 | 31 | 7 | 1 | 5 | 33 | 32 | 62 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 74,737,560 | 356 | 124 | 0 | 0 | 117 | 52 | 51 | 35 | 29 | 0 | 114 | 99 | 14 | 6 | 8 | 124 | 124 | 117 | 0 | 6 | 28 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 90,436,180 | 345 | 72 | 0 | 0 | 190 | 40 | 40 | 20 | 128 | 0 | 82 | 66 | 15 | 8 | 7 | 72 | 72 | 190 | 0 | 3 | 127 | 0 | 0 | 
| app_proof | prover | 1 | 90,435,040 | 343 | 74 | 0 | 0 | 188 | 37 | 36 | 20 | 130 | 0 | 80 | 65 | 14 | 8 | 6 | 74 | 74 | 188 | 0 | 3 | 130 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 136 | 2 | 22 | 568 | 22 | 136 | 2,146,766,901 | 1,588,503 | 2,148,355,404 | 2,097,152 | 0 | 4 | 64 | 2,621,000 | 44.56 | 
| app_proof | 1 | 41 | 1 | 34 | 461 | 34 | 41 | 1,165,989,930 | 980,940,213 | 2,146,930,143 | 2,097,152 | 0 | 2 | 42 | 1,379,051 | 51.05 | 

...
| `total_proof_time_ms ` |  4,141.50 |  8,283 |  5,226 |  3,057 |
...
| `execute_preflight_time_ms` |  255.50 |  511 |  286 |  225 |
| `execute_preflight_insn_mi/s` |  36.74 | -          |  39.01 |  34.46 |
| `trace_gen_time_ms   ` |  125.50 |  251 |  176 |  75 |
| `set_initial_memory_time_ms` |  89 |  178 |  137 |  41 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  3,670.50 |  7,341 |  4,687 |  2,654 |
| `prover.main_trace_commit_time_ms` |  961.50 |  1,923 |  1,331 |  592 |
| `prover.rap_constraints_time_ms` |  1,996.50 |  3,993 |  2,458 |  1,535 |
| `prover.openings_time_ms` |  711.50 |  1,423 |  897 |  526 |
| `prover.rap_constraints.logup_gkr_time_ms` |  560.50 |  1,121 |  599 |  522 |
| `prover.rap_constraints.round0_time_ms` |  1,052.50 |  2,105 |  1,365 |  740 |
...
| `prover.openings.whir_time_ms` |  545 |  1,090 |  683 |  407 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/90cdb88711e40f0fbbb4f199c3771d4f1c34d0c3/sha2_bench-90cdb88711e40f0fbbb4f199c3771d4f1c34d0c3.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 69 |  |  |  | 339 |  |  |  |  |  |  | 
| app_proof |  |  |  | 3,057 |  | 97 | 11,167,961 | 114.75 | 0 | 8,386 |  | 
...
| leaf | 0 | 108 | 1,007 | 108 | 34 | 17 | 2 | 7 | 7 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 325 | 117 | 0 | 0 | 108 | 35 | 35 | 52 | 20 | 0 | 98 | 84 | 13 | 3 | 9 | 117 | 117 | 108 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 168 | 47 | 0 | 0 | 67 | 25 | 24 | 28 | 13 | 0 | 52 | 44 | 8 | 1 | 6 | 47 | 47 | 67 | 0 | 3 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 138 | 31 | 0 | 0 | 61 | 23 | 22 | 25 | 13 | 0 | 44 | 37 | 7 | 1 | 5 | 32 | 31 | 61 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 237,896,248 | 898 | 374 | 0 | 0 | 228 | 109 | 109 | 67 | 50 | 0 | 295 | 257 | 37 | 20 | 17 | 374 | 374 | 228 | 0 | 12 | 50 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,288,077,561 | 4,687 | 1,330 | 0 | 0 | 2,458 | 1,365 | 1,364 | 493 | 599 | 0 | 897 | 683 | 214 | 134 | 80 | 1,331 | 1,331 | 2,458 | 0 | 6 | 598 | 0 | 0 | 
| app_proof | prover | 1 | 751,206,644 | 2,654 | 592 | 0 | 0 | 1,535 | 740 | 740 | 271 | 522 | 0 | 526 | 407 | 119 | 72 | 46 | 592 | 592 | 1,535 | 0 | 7 | 521 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 137 | 1 | 176 | 5,226 | 176 | 137 | 13,329,494,472 | 2,141,911,524 | 15,471,405,996 | 2,097,152 | 0 | 3 | 225 | 7,124,000 | 34.46 | 
| app_proof | 1 | 41 | 1 | 75 | 3,057 | 75 | 41 | 7,598,498,184 | 1,557,865,504 | 9,156,363,688 | 2,097,152 | 0 | 2 | 286 | 4,043,961 | 39.01 | 

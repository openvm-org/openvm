...
|:---|---:|---:|---:|
| Total |  9.90 |  6.91 |  6.91 |
| app_proof |  8.23 |  5.24 |  5.24 |
...
| `total_proof_time_ms ` |  4,064.50 |  8,129 |  5,139 |  2,990 |
...
| `execute_preflight_time_ms` |  248.50 |  497 |  276 |  221 |
| `execute_preflight_insn_mi/s` |  37.13 | -          |  39.23 |  35.02 |
| `trace_gen_time_ms   ` |  125 |  250 |  175 |  75 |
| `set_initial_memory_time_ms` |  88.50 |  177 |  136 |  41 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  3,601.50 |  7,203 |  4,606 |  2,597 |
| `prover.main_trace_commit_time_ms` |  953 |  1,906 |  1,321 |  585 |
| `prover.rap_constraints_time_ms` |  1,943.50 |  3,887 |  2,396 |  1,491 |
| `prover.openings_time_ms` |  703.50 |  1,407 |  888 |  519 |
| `prover.rap_constraints.logup_gkr_time_ms` |  550 |  1,100 |  592 |  508 |
| `prover.rap_constraints.round0_time_ms` |  1,018.50 |  2,037 |  1,322 |  715 |
| `prover.rap_constraints.mle_rounds_time_ms` |  374.50 |  749 |  481 |  268 |
| `prover.openings.stacked_reduction_time_ms` |  161.50 |  323 |  208 |  115 |
| `prover.openings.stacked_reduction.round0_time_ms` |  99.50 |  199 |  130 |  69 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  62 |  124 |  78 |  46 |
| `prover.openings.whir_time_ms` |  541 |  1,082 |  679 |  403 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/bd9a7b6040e5bb45775a15e3a56686a720239296/sha2_bench-bd9a7b6040e5bb45775a15e3a56686a720239296.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 78 |  |  |  | 361 |  |  |  |  |  |  | 
| app_proof |  |  |  | 2,990 |  | 98 | 11,167,961 | 113.83 | 0 | 8,233 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 324 | 115 | 0 | 0 | 107 | 35 | 34 | 51 | 20 | 0 | 101 | 87 | 13 | 3 | 9 | 116 | 115 | 107 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 170 | 46 | 0 | 0 | 66 | 24 | 23 | 28 | 14 | 0 | 57 | 48 | 8 | 1 | 6 | 47 | 46 | 66 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 136 | 32 | 0 | 0 | 61 | 22 | 22 | 24 | 14 | 0 | 41 | 34 | 7 | 1 | 5 | 33 | 32 | 61 | 0 | 2 | 13 | 0 | 0 | 
| leaf | 0 | prover | 237,896,248 | 891 | 368 | 0 | 0 | 226 | 109 | 108 | 66 | 50 | 0 | 295 | 258 | 36 | 19 | 17 | 369 | 368 | 226 | 0 | 9 | 50 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,288,077,561 | 4,606 | 1,320 | 0 | 0 | 2,396 | 1,322 | 1,321 | 481 | 592 | 1 | 888 | 679 | 208 | 130 | 78 | 1,321 | 1,320 | 2,396 | 0 | 5 | 590 | 0 | 0 | 
| app_proof | prover | 1 | 751,206,644 | 2,597 | 585 | 0 | 0 | 1,491 | 715 | 714 | 268 | 508 | 0 | 519 | 403 | 115 | 69 | 46 | 585 | 585 | 1,491 | 0 | 6 | 506 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 136 | 1 | 175 | 5,139 | 175 | 136 | 13,329,494,472 | 2,141,911,524 | 15,471,405,996 | 2,097,152 | 0 | 3 | 221 | 7,124,000 | 35.02 | 
| app_proof | 1 | 41 | 1 | 75 | 2,990 | 75 | 41 | 7,598,498,184 | 1,557,865,504 | 9,156,363,688 | 2,097,152 | 0 | 2 | 276 | 4,043,961 | 39.23 | 

...
|:---|---:|---:|---:|
| Total |  10.15 |  7.07 |  7.07 |
| app_proof |  8.44 |  5.37 |  5.37 |
| leaf |  1.01 |  1.01 |  1.01 |
...
| `total_proof_time_ms ` |  4,174 |  8,348 |  5,271 |  3,077 |
| `compile_metered_time_ms` |  3 |  3 |  3 |  3 |
| `execute_metered_time_ms` |  96 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  115.28 | -          |  115.28 |  115.28 |
| `execute_preflight_insns` |  5,583,980.50 |  11,167,961 |  7,124,000 |  4,043,961 |
| `execute_preflight_time_ms` |  248 |  496 |  275 |  221 |
| `execute_preflight_insn_mi/s` |  36.94 | -          |  38.90 |  34.97 |
| `trace_gen_time_ms   ` |  125.50 |  251 |  176 |  75 |
| `set_initial_memory_time_ms` |  88.50 |  177 |  136 |  41 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  3,711 |  7,422 |  4,737 |  2,685 |
| `prover.main_trace_commit_time_ms` |  973.50 |  1,947 |  1,348 |  599 |
| `prover.rap_constraints_time_ms` |  2,020.50 |  4,041 |  2,486 |  1,555 |
| `prover.openings_time_ms` |  716 |  1,432 |  902 |  530 |
| `prover.rap_constraints.logup_gkr_time_ms` |  566 |  1,132 |  606 |  526 |
| `prover.rap_constraints.round0_time_ms` |  1,066 |  2,132 |  1,380 |  752 |
| `prover.rap_constraints.mle_rounds_time_ms` |  387 |  774 |  498 |  276 |
| `prover.openings.stacked_reduction_time_ms` |  169 |  338 |  217 |  121 |
| `prover.openings.stacked_reduction.round0_time_ms` |  105 |  210 |  137 |  73 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  63.50 |  127 |  80 |  47 |
| `prover.openings.whir_time_ms` |  546.50 |  1,093 |  684 |  409 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,015 |  1,015 |  1,015 |  1,015 |
...
| `prover.rap_constraints_time_ms` |  234 |  234 |  234 |  234 |
| `prover.openings_time_ms` |  293 |  293 |  293 |  293 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/42afe481ecd5e1577d8eb4d9dfa8312a2307a45e/sha2_bench-42afe481ecd5e1577d8eb4d9dfa8312a2307a45e.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 69 |  |  |  | 343 |  |  |  |  |  |  | 
| app_proof |  |  |  | 3,077 |  | 96 | 11,167,961 | 115.28 | 0 | 8,450 |  | 
...
| app_proof | VmAirWrapper<Rv64BaseAluU16AdapterAir, AddSubCoreAir<4, 16> | 0 |  | 24 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 326 | 119 | 0 | 0 | 108 | 35 | 34 | 51 | 20 | 0 | 98 | 84 | 13 | 3 | 9 | 120 | 119 | 108 | 0 | 3 | 20 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 174 | 47 | 0 | 0 | 67 | 24 | 24 | 28 | 14 | 0 | 59 | 50 | 8 | 1 | 6 | 47 | 47 | 67 | 0 | 3 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 141 | 32 | 0 | 0 | 64 | 23 | 23 | 25 | 14 | 0 | 44 | 37 | 7 | 1 | 5 | 33 | 32 | 64 | 0 | 2 | 13 | 0 | 0 | 
| leaf | 0 | prover | 237,896,248 | 907 | 379 | 0 | 0 | 234 | 113 | 112 | 68 | 52 | 0 | 293 | 255 | 37 | 20 | 17 | 379 | 379 | 234 | 0 | 12 | 50 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,288,077,561 | 4,737 | 1,347 | 0 | 0 | 2,486 | 1,380 | 1,380 | 498 | 606 | 1 | 902 | 684 | 217 | 137 | 80 | 1,348 | 1,347 | 2,486 | 0 | 6 | 604 | 0 | 0 | 
| app_proof | prover | 1 | 751,206,644 | 2,685 | 599 | 0 | 0 | 1,555 | 752 | 752 | 276 | 526 | 0 | 530 | 409 | 121 | 73 | 47 | 599 | 599 | 1,555 | 0 | 8 | 524 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 136 | 1 | 176 | 5,271 | 176 | 136 | 13,329,494,472 | 2,141,911,524 | 15,471,405,996 | 2,097,152 | 0 | 4 | 221 | 7,124,000 | 34.97 | 
| app_proof | 1 | 41 | 1 | 75 | 3,077 | 75 | 41 | 7,598,498,184 | 1,557,865,504 | 9,156,363,688 | 2,097,152 | 0 | 2 | 275 | 4,043,961 | 38.90 | 

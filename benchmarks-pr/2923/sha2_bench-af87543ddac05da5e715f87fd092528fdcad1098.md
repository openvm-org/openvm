...
|:---|---:|---:|---:|
| Total |  10.29 |  7.15 |  7.15 |
| app_proof |  8.57 |  5.43 |  5.43 |
| leaf |  1.02 |  1.02 |  1.02 |
...
| `total_proof_time_ms ` |  4,237 |  8,474 |  5,337 |  3,137 |
...
| `execute_preflight_time_ms` |  253 |  506 |  283 |  223 |
| `execute_preflight_insn_mi/s` |  36.56 | -          |  38.54 |  34.59 |
| `trace_gen_time_ms   ` |  125.50 |  251 |  176 |  75 |
| `set_initial_memory_time_ms` |  88.50 |  177 |  136 |  41 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  3,768 |  7,536 |  4,800 |  2,736 |
| `prover.main_trace_commit_time_ms` |  976.50 |  1,953 |  1,352 |  601 |
| `prover.rap_constraints_time_ms` |  2,068 |  4,136 |  2,537 |  1,599 |
| `prover.openings_time_ms` |  722.50 |  1,445 |  910 |  535 |
| `prover.rap_constraints.logup_gkr_time_ms` |  571 |  1,142 |  610 |  532 |
| `prover.rap_constraints.round0_time_ms` |  1,105.50 |  2,211 |  1,421 |  790 |
| `prover.rap_constraints.mle_rounds_time_ms` |  390 |  780 |  505 |  275 |
| `prover.openings.stacked_reduction_time_ms` |  168 |  336 |  215 |  121 |
| `prover.openings.stacked_reduction.round0_time_ms` |  104 |  208 |  135 |  73 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  63 |  126 |  79 |  47 |
| `prover.openings.whir_time_ms` |  554 |  1,108 |  694 |  414 |
...
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  914 |  914 |  914 |  914 |
| `prover.main_trace_commit_time_ms` |  382 |  382 |  382 |  382 |
| `prover.rap_constraints_time_ms` |  233 |  233 |  233 |  233 |
...
| `prover.rap_constraints.mle_rounds_time_ms` |  69 |  69 |  69 |  69 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/af87543ddac05da5e715f87fd092528fdcad1098/sha2_bench-af87543ddac05da5e715f87fd092528fdcad1098.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 71 |  |  |  | 344 |  |  |  |  |  |  | 
| app_proof |  |  |  | 3,137 |  | 98 | 11,167,961 | 113.69 | 0 | 8,577 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 330 | 119 | 0 | 0 | 109 | 36 | 35 | 52 | 20 | 0 | 101 | 87 | 13 | 3 | 9 | 120 | 119 | 109 | 0 | 3 | 20 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 176 | 47 | 0 | 0 | 69 | 25 | 24 | 28 | 15 | 0 | 58 | 50 | 8 | 1 | 6 | 48 | 47 | 69 | 0 | 3 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 139 | 33 | 0 | 0 | 64 | 24 | 23 | 25 | 14 | 0 | 41 | 34 | 7 | 1 | 5 | 34 | 33 | 64 | 0 | 2 | 13 | 0 | 0 | 
| leaf | 0 | prover | 237,896,248 | 914 | 382 | 0 | 0 | 233 | 113 | 112 | 69 | 51 | 0 | 298 | 260 | 38 | 20 | 17 | 382 | 382 | 233 | 0 | 14 | 50 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,288,077,561 | 4,800 | 1,352 | 0 | 0 | 2,537 | 1,421 | 1,421 | 505 | 610 | 0 | 910 | 694 | 215 | 135 | 79 | 1,352 | 1,352 | 2,537 | 0 | 10 | 608 | 0 | 0 | 
| app_proof | prover | 1 | 751,206,644 | 2,736 | 601 | 0 | 0 | 1,599 | 790 | 790 | 275 | 532 | 0 | 535 | 414 | 121 | 73 | 47 | 601 | 601 | 1,599 | 0 | 12 | 531 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 136 | 1 | 176 | 5,337 | 176 | 136 | 13,329,494,472 | 2,141,911,524 | 15,471,405,996 | 2,097,152 | 0 | 3 | 223 | 7,124,000 | 34.59 | 
| app_proof | 1 | 41 | 1 | 75 | 3,137 | 75 | 41 | 7,598,498,184 | 1,557,865,504 | 9,156,363,688 | 2,097,152 | 0 | 2 | 283 | 4,043,961 | 38.54 | 

...
|:---|---:|---:|
| Total |  3.03 |  1.78 |
| regex_program |  2.98 |  1.74 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,491 |  2,982 |  1,738 |  1,244 |
...
| `execute_preflight_time_ms` |  93 |  186 |  106 |  80 |
| `execute_preflight_insn_mi/s` |  32.35 | -          |  34.09 |  30.60 |
| `trace_gen_time_ms   ` |  316 |  632 |  338 |  294 |
| `memory_finalize_time_ms` |  2 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  993.50 |  1,987 |  1,236 |  751 |
| `main_trace_commit_time_ms` |  141.50 |  283 |  184 |  99 |
| `generate_perm_trace_time_ms` |  63 |  126 |  78 |  48 |
| `perm_trace_commit_time_ms` |  172.25 |  344.50 |  223.92 |  120.58 |
| `quotient_poly_compute_time_ms` |  164.49 |  328.98 |  182.06 |  146.92 |
| `quotient_poly_commit_time_ms` |  35.78 |  71.56 |  47.65 |  23.91 |
| `pcs_opening_time_ms ` |  410 |  820 |  551 |  269 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 1,244 | 41 | 1 | 44 | 4,108,483 | 92.75 | 248 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 294 | 1,738 | 23,397,108 | 373,183,036 | 294 | 1,236 | 0 | 146.92 | 47.65 | 6 | 223.92 | 551 | 303 | 551 | 4 | 184 | 10,866,434 | 78 | 80 | 2,211,000 | 30.60 | 47 | 196 | 2 | 551 | 
| regex_program | 1 | 338 | 1,244 | 11,981,356 | 196,739,722 | 338 | 751 | 2 | 182.06 | 23.91 | 5 | 120.58 | 269 | 171 | 269 | 0 | 99 | 2,537,170 | 48 | 106 | 1,897,483 | 34.09 | 28 | 211 | 2 | 269 | 

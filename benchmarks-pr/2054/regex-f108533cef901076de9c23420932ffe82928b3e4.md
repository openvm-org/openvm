...
| `total_proof_time_ms ` |  1,477 |  2,954 |  1,713 |  1,241 |
...
| `execute_preflight_time_ms` |  94.50 |  189 |  108 |  81 |
| `execute_preflight_insn_mi/s` |  31.16 | -          |  32.48 |  29.84 |
| `trace_gen_time_ms   ` |  313.50 |  627 |  335 |  292 |
| `memory_finalize_time_ms` |  1.50 |  3 |  3 |  0 |
| `stark_prove_excluding_trace_time_ms` |  981.50 |  1,963 |  1,213 |  750 |
| `main_trace_commit_time_ms` |  141.50 |  283 |  184 |  99 |
| `generate_perm_trace_time_ms` |  55 |  110 |  63 |  47 |
| `perm_trace_commit_time_ms` |  170.47 |  340.94 |  222.74 |  118.20 |
| `quotient_poly_compute_time_ms` |  164.59 |  329.18 |  182.91 |  146.27 |
| `quotient_poly_commit_time_ms` |  36.51 |  73.02 |  47.97 |  25.05 |
| `pcs_opening_time_ms ` |  407 |  814 |  545 |  269 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 1,241 | 40 | 1 | 45 | 4,108,483 | 89.28 | 248 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 292 | 1,713 | 23,397,108 | 373,183,036 | 292 | 1,213 | 0 | 146.27 | 47.97 | 6 | 222.74 | 545 | 286 | 545 | 3 | 184 | 10,866,434 | 63 | 81 | 2,211,000 | 29.84 | 47 | 196 | 2 | 545 | 
| regex_program | 1 | 335 | 1,241 | 11,981,356 | 196,739,722 | 335 | 750 | 2 | 182.91 | 25.05 | 5 | 118.20 | 269 | 168 | 269 | 0 | 99 | 2,537,170 | 47 | 108 | 1,897,483 | 32.48 | 28 | 213 | 2 | 269 | 

...
|:---|---:|---:|
| Total |  249.41 |  233.06 |
| kitchen_sink |  21.16 |  13.96 |
| leaf |  41.44 |  32.29 |
| internal.0 |  10.29 |  10.29 |
| root |  39.11 |  39.11 |
| halo2_outer |  93.35 |  93.35 |
...
| `total_proof_time_ms ` |  10,578 |  21,156 |  13,955 |  7,201 |
...
| `trace_gen_time_ms   ` |  363.50 |  727 |  462 |  265 |
| `stark_prove_excluding_trace_time_ms` |  10,194.50 |  20,389 |  13,462 |  6,927 |
| `main_trace_commit_time_ms` |  3,194 |  6,388 |  4,379 |  2,009 |
| `generate_perm_trace_time_ms` |  290.50 |  581 |  385 |  196 |
| `perm_trace_commit_time_ms` |  1,251.50 |  2,503 |  1,666 |  837 |
| `quotient_poly_compute_time_ms` |  4,311 |  8,622 |  5,723 |  2,899 |
| `quotient_poly_commit_time_ms` |  235.50 |  471 |  273 |  198 |
| `pcs_opening_time_ms ` |  881.50 |  1,763 |  988 |  775 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  20,717.50 |  41,435 |  32,288 |  9,147 |
| `main_cells_used     ` |  463,781,810 |  927,563,620 |  739,553,252 |  188,010,368 |
| `total_cycles        ` |  5,251,117.50 |  10,502,235 |  8,097,528 |  2,404,707 |
| `execute_time_ms     ` |  1,874.50 |  3,749 |  2,835 |  914 |
| `trace_gen_time_ms   ` |  4,107.50 |  8,215 |  6,449 |  1,766 |
| `stark_prove_excluding_trace_time_ms` |  14,735.50 |  29,471 |  23,004 |  6,467 |
| `main_trace_commit_time_ms` |  2,721.50 |  5,443 |  4,304 |  1,139 |
| `generate_perm_trace_time_ms` |  1,096 |  2,192 |  1,738 |  454 |
| `perm_trace_commit_time_ms` |  4,732 |  9,464 |  7,554 |  1,910 |
| `quotient_poly_compute_time_ms` |  2,230 |  4,460 |  3,452 |  1,008 |
| `quotient_poly_commit_time_ms` |  1,287 |  2,574 |  1,943 |  631 |
| `pcs_opening_time_ms ` |  2,663.50 |  5,327 |  4,007 |  1,320 |

| internal.0 |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  10,292 |  10,292 |  10,292 |  10,292 |
| `main_cells_used     ` |  143,862,806 |  143,862,806 |  143,862,806 |  143,862,806 |
| `total_cycles        ` |  2,397,901 |  2,397,901 |  2,397,901 |  2,397,901 |
...
| `main_trace_commit_time_ms` |  1,755 |  1,755 |  1,755 |  1,755 |
| `generate_perm_trace_time_ms` |  342 |  342 |  342 |  342 |
| `perm_trace_commit_time_ms` |  1,462 |  1,462 |  1,462 |  1,462 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  39,107 |  39,107 |  39,107 |  39,107 |
| `main_cells_used     ` |  38,196,646 |  38,196,646 |  38,196,646 |  38,196,646 |
| `total_cycles        ` |  766,805 |  766,805 |  766,805 |  766,805 |
| `execute_time_ms     ` |  251 |  251 |  251 |  251 |
| `trace_gen_time_ms   ` |  389 |  389 |  389 |  389 |
| `stark_prove_excluding_trace_time_ms` |  38,467 |  38,467 |  38,467 |  38,467 |
| `main_trace_commit_time_ms` |  12,336 |  12,336 |  12,336 |  12,336 |
...
| `quotient_poly_commit_time_ms` |  13,866 |  13,866 |  13,866 |  13,866 |
| `pcs_opening_time_ms ` |  3,688 |  3,688 |  3,688 |  3,688 |

| halo2_outer |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  93,354 |  93,354 |  93,354 |  93,354 |
| `main_cells_used     ` |  62,297,054 |  62,297,054 |  62,297,054 |  62,297,054 |

| halo2_wrapper |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  44,063 |  44,063 |  44,063 |  44,063 |
...
| --- | --- | --- | --- |
| halo2_outer | 93,354 |  | 62,297,054 | 
| halo2_wrapper | 44,063 |  |  | 
| kitchen_sink |  | 2 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal.0 | 0 | 1,294 | 10,292 | 2,397,901 | 420,325,858 | 7,949 | 1,473 | 1,276 | 1,462 | 1,636 | 1,755 | 143,862,806 | 342 | 1,049 | 
| leaf | 0 | 6,449 | 32,288 | 8,097,528 | 2,772,897,258 | 23,004 | 3,452 | 1,943 | 7,554 | 4,007 | 4,304 | 739,553,252 | 1,738 | 2,835 | 
| leaf | 1 | 1,766 | 9,147 | 2,404,707 | 746,278,378 | 6,467 | 1,008 | 631 | 1,910 | 1,320 | 1,139 | 188,010,368 | 454 | 914 | 
| root | 0 | 389 | 39,107 | 766,805 | 80,435,354 | 38,467 | 862 | 13,866 | 7,624 | 3,688 | 12,336 | 38,196,646 | 76 | 251 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| kitchen_sink | 0 | 462 | 13,955 | 85,850 | 1,307,172,505 | 13,462 | 5,723 | 273 | 1,666 | 988 | 4,379 | 632,432,647 | 385 | 31 | 
| kitchen_sink | 1 | 265 | 7,201 | 13,666 | 661,752,828 | 6,927 | 2,899 | 198 | 837 | 775 | 2,009 | 264,431,162 | 196 | 9 | 

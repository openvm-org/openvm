...
|:---|---:|---:|
| Total |  246.62 |  230.31 |
| kitchen_sink |  21.03 |  13.86 |
| leaf |  41.45 |  32.31 |
| internal.0 |  10.31 |  10.31 |
| root |  39.09 |  39.09 |
| halo2_outer |  90.78 |  90.78 |
...
| `total_proof_time_ms ` |  10,516.50 |  21,033 |  13,860 |  7,173 |
...
| `trace_gen_time_ms   ` |  358.50 |  717 |  454 |  263 |
| `stark_prove_excluding_trace_time_ms` |  10,138 |  20,276 |  13,375 |  6,901 |
| `main_trace_commit_time_ms` |  3,192 |  6,384 |  4,371 |  2,013 |
| `generate_perm_trace_time_ms` |  291.50 |  583 |  385 |  198 |
| `perm_trace_commit_time_ms` |  1,246.50 |  2,493 |  1,657 |  836 |
| `quotient_poly_compute_time_ms` |  4,264.50 |  8,529 |  5,657 |  2,872 |
| `quotient_poly_commit_time_ms` |  235.50 |  471 |  272 |  199 |
| `pcs_opening_time_ms ` |  878.50 |  1,757 |  987 |  770 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  20,723 |  41,446 |  32,307 |  9,139 |
| `main_cells_used     ` |  463,782,290 |  927,564,580 |  739,553,864 |  188,010,716 |
| `total_cycles        ` |  5,251,157.50 |  10,502,315 |  8,097,579 |  2,404,736 |
| `execute_time_ms     ` |  1,877.50 |  3,755 |  2,835 |  920 |
| `trace_gen_time_ms   ` |  4,144.50 |  8,289 |  6,509 |  1,780 |
| `stark_prove_excluding_trace_time_ms` |  14,701 |  29,402 |  22,963 |  6,439 |
| `main_trace_commit_time_ms` |  2,733.50 |  5,467 |  4,318 |  1,149 |
| `generate_perm_trace_time_ms` |  1,099 |  2,198 |  1,742 |  456 |
| `perm_trace_commit_time_ms` |  4,675 |  9,350 |  7,458 |  1,892 |
| `quotient_poly_compute_time_ms` |  2,224 |  4,448 |  3,433 |  1,015 |
| `quotient_poly_commit_time_ms` |  1,270.50 |  2,541 |  1,922 |  619 |
| `pcs_opening_time_ms ` |  2,694.50 |  5,389 |  4,086 |  1,303 |

| internal.0 |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  10,311 |  10,311 |  10,311 |  10,311 |
| `main_cells_used     ` |  143,862,698 |  143,862,698 |  143,862,698 |  143,862,698 |
...
| `stark_prove_excluding_trace_time_ms` |  7,955 |  7,955 |  7,955 |  7,955 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  39,089 |  39,089 |  39,089 |  39,089 |
| `main_cells_used     ` |  38,196,322 |  38,196,322 |  38,196,322 |  38,196,322 |
| `total_cycles        ` |  766,778 |  766,778 |  766,778 |  766,778 |
| `execute_time_ms     ` |  250 |  250 |  250 |  250 |
| `trace_gen_time_ms   ` |  395 |  395 |  395 |  395 |
| `stark_prove_excluding_trace_time_ms` |  38,444 |  38,444 |  38,444 |  38,444 |
| `main_trace_commit_time_ms` |  12,330 |  12,330 |  12,330 |  12,330 |
| `generate_perm_trace_time_ms` |  75 |  75 |  75 |  75 |
| `perm_trace_commit_time_ms` |  7,644 |  7,644 |  7,644 |  7,644 |
| `quotient_poly_compute_time_ms` |  864 |  864 |  864 |  864 |
| `quotient_poly_commit_time_ms` |  13,823 |  13,823 |  13,823 |  13,823 |
| `pcs_opening_time_ms ` |  3,701 |  3,701 |  3,701 |  3,701 |

| halo2_outer |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  90,779 |  90,779 |  90,779 |  90,779 |
| `main_cells_used     ` |  62,297,054 |  62,297,054 |  62,297,054 |  62,297,054 |

| halo2_wrapper |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  43,966 |  43,966 |  43,966 |  43,966 |
...
| --- | --- | --- | --- |
| halo2_outer | 90,779 |  | 62,297,054 | 
| halo2_wrapper | 43,966 |  |  | 
| kitchen_sink |  | 2 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal.0 | 0 | 1,301 | 10,311 | 2,397,892 | 420,325,858 | 7,955 | 1,468 | 1,289 | 1,470 | 1,631 | 1,751 | 143,862,698 | 342 | 1,055 | 
| leaf | 0 | 6,509 | 32,307 | 8,097,579 | 2,772,897,258 | 22,963 | 3,433 | 1,922 | 7,458 | 4,086 | 4,318 | 739,553,864 | 1,742 | 2,835 | 
| leaf | 1 | 1,780 | 9,139 | 2,404,736 | 746,278,378 | 6,439 | 1,015 | 619 | 1,892 | 1,303 | 1,149 | 188,010,716 | 456 | 920 | 
| root | 0 | 395 | 39,089 | 766,778 | 80,435,354 | 38,444 | 864 | 13,823 | 7,644 | 3,701 | 12,330 | 38,196,322 | 75 | 250 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| kitchen_sink | 0 | 454 | 13,860 | 85,850 | 1,307,172,505 | 13,375 | 5,657 | 272 | 1,657 | 987 | 4,371 | 632,432,647 | 385 | 31 | 
| kitchen_sink | 1 | 263 | 7,173 | 13,666 | 661,752,828 | 6,901 | 2,872 | 199 | 836 | 770 | 2,013 | 264,431,162 | 198 | 9 | 

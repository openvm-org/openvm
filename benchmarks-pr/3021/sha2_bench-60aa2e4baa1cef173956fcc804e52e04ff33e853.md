...
|:---|---:|---:|---:|
| Total |  4.99 |  3.38 |  3.38 |
| app_proof |  4.04 |  2.43 |  2.43 |
| leaf |  0.53 |  0.53 |  0.53 |
...
| `total_proof_time_ms ` |  1,991.50 |  3,983 |  2,372 |  1,611 |
| `compile_metered_time_ms` |  6 |  6 |  6 |  6 |
| `execute_metered_time_ms` |  56 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  197.48 | -          |  197.48 |  197.48 |
| `execute_preflight_insns` |  5,583,980.50 |  11,167,961 |  7,136,000 |  4,031,961 |
| `execute_preflight_time_ms` |  351 |  702 |  495 |  207 |
| `execute_preflight_insn_mi/s` |  37.36 | -          |  39.04 |  35.68 |
| `trace_gen_time_ms   ` |  75.50 |  151 |  105 |  46 |
| `set_initial_memory_time_ms` |  0 |  0 |  0 |  0 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,563 |  3,126 |  2,058 |  1,068 |
| `prover.main_trace_commit_time_ms` |  394.50 |  789 |  573 |  216 |
| `prover.rap_constraints_time_ms` |  899.50 |  1,799 |  1,139 |  660 |
| `prover.openings_time_ms` |  268 |  536 |  345 |  191 |
| `prover.rap_constraints.logup_gkr_time_ms` |  209 |  418 |  233 |  185 |
| `prover.rap_constraints.round0_time_ms` |  509 |  1,018 |  670 |  348 |
| `prover.rap_constraints.mle_rounds_time_ms` |  180 |  360 |  234 |  126 |
| `prover.openings.stacked_reduction_time_ms` |  72 |  144 |  92 |  52 |
...
| `prover.openings.whir_time_ms` |  195 |  390 |  252 |  138 |
...
| `prover.main_trace_commit_time_ms` |  148 |  148 |  148 |  148 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/60aa2e4baa1cef173956fcc804e52e04ff33e853/sha2_bench-60aa2e4baa1cef173956fcc804e52e04ff33e853.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 58 |  |  |  | 295 |  |  |  |  |  |  | 
| app_proof |  |  |  | 1,611 |  | 56 | 11,167,961 | 197.48 | 0 | 4,048 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 173 | 47 | 0 | 0 | 79 | 28 | 27 | 37 | 13 | 0 | 46 | 36 | 10 | 2 | 7 | 47 | 47 | 79 | 0 | 1 | 12 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 109 | 20 | 0 | 0 | 57 | 21 | 20 | 23 | 12 | 0 | 30 | 23 | 7 | 1 | 6 | 21 | 20 | 57 | 0 | 1 | 10 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 97 | 15 | 0 | 0 | 54 | 20 | 19 | 22 | 10 | 0 | 27 | 20 | 7 | 1 | 5 | 15 | 15 | 54 | 0 | 1 | 10 | 0 | 0 | 
| leaf | 0 | prover | 237,929,144 | 406 | 147 | 0 | 0 | 142 | 71 | 69 | 44 | 26 | 0 | 116 | 93 | 22 | 10 | 11 | 148 | 147 | 142 | 0 | 3 | 25 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,280,083,194 | 2,058 | 573 | 0 | 0 | 1,139 | 670 | 670 | 234 | 233 | 1 | 345 | 252 | 92 | 57 | 35 | 573 | 573 | 1,139 | 0 | 1 | 231 | 0 | 0 | 
| app_proof | prover | 1 | 687,443,728 | 1,068 | 216 | 0 | 0 | 660 | 348 | 347 | 126 | 185 | 0 | 191 | 138 | 52 | 31 | 21 | 216 | 216 | 660 | 0 | 1 | 184 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 0 | 2 | 105 | 2,372 | 105 | 0 | 12,567,225,180 | 2,800,224,348 | 15,367,449,528 | 2,097,152 | 0 | 4 | 207 | 7,136,000 | 35.68 | 
| app_proof | 1 | 0 | 1 | 46 | 1,611 | 46 | 0 | 7,131,913,452 | 1,123,862,484 | 8,255,775,936 | 2,097,152 | 0 | 2 | 495 | 4,031,961 | 39.04 | 

...
| `total_proof_time_ms ` |  484 |  968 |  549 |  419 |
...
| `execute_metered_insn_mi/s` |  116.40 | -          |  116.40 |  116.40 |
| `execute_preflight_insns` |  750,104.50 |  1,500,209 |  873,000 |  627,209 |
| `execute_preflight_time_ms` |  28.50 |  57 |  32 |  25 |
| `execute_preflight_insn_mi/s` |  37.74 | -          |  39.84 |  35.64 |
| `trace_gen_time_ms   ` |  189.50 |  379 |  195 |  184 |
...
| `perm_trace_commit_time_ms` |  42.05 |  84.09 |  44.07 |  40.02 |
| `quotient_poly_compute_time_ms` |  31.64 |  63.28 |  34.43 |  28.84 |
| `quotient_poly_commit_time_ms` |  11.71 |  23.43 |  12.03 |  11.40 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 419 | 65 | 1 | 12 | 1,500,209 | 116.40 | 163 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 195 | 549 | 9,677,708 | 84,395,212 | 195 | 186 | 0 | 34.43 | 12.03 | 4 | 44.07 | 43 | 62 | 43 | 0 | 32 | 1,035,986 | 17 | 25 | 873,000 | 35.64 | 13 | 46 | 0 | 43 | 
| fibonacci_program | 1 | 184 | 419 | 9,708,170 | 74,305,770 | 184 | 161 | 1 | 28.84 | 11.40 | 4 | 40.02 | 39 | 53 | 39 | 0 | 28 | 1,064,416 | 13 | 32 | 627,209 | 39.84 | 11 | 40 | 0 | 39 | 

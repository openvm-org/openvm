...
|:---|---:|---:|---:|
| Total | <span style='color: green'>(-1 [-12.8%])</span> 7.90 | <span style='color: green'>(-1 [-20.0%])</span> 4 | 4.00 |
| fibonacci_program | <span style='color: green'>(-1 [-12.8%])</span> 7.90 | <span style='color: green'>(-1 [-20.0%])</span> 4 |  4 |


| fibonacci_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: green'>(-579 [-12.8%])</span> 3,946 | <span style='color: green'>(-1158 [-12.8%])</span> 7,892 | <span style='color: green'>(-1002 [-20.1%])</span> 3,992 | <span style='color: green'>(-156 [-3.8%])</span> 3,900 |
...
| `execute_metered_insn_mi/s` | <span style='color: green'>(-0 [-0.2%])</span> 160.52 | -          | <span style='color: green'>(-0 [-0.2%])</span> 160.52 | <span style='color: green'>(-0 [-0.2%])</span> 160.52 |
| `execute_preflight_insns` |  750,104.50 |  1,500,209 |  873,000 |  627,209 |
| `execute_preflight_time_ms` |  27.50 |  55 |  33 |  22 |
| `execute_preflight_insn_mi/s` | <span style='color: green'>(-1 [-2.5%])</span> 37.15 | -          | <span style='color: green'>(-1 [-2.7%])</span> 37.41 | <span style='color: green'>(-1 [-2.4%])</span> 36.89 |
| `trace_gen_time_ms   ` | <span style='color: green'>(-2 [-0.8%])</span> 191.50 | <span style='color: green'>(-3 [-0.8%])</span> 383 |  196 | <span style='color: green'>(-3 [-1.6%])</span> 187 |
| `memory_finalize_time_ms` | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: green'>(-578 [-13.8%])</span> 3,622 | <span style='color: green'>(-1156 [-13.8%])</span> 7,244 | <span style='color: green'>(-870 [-18.9%])</span> 3,733 | <span style='color: green'>(-286 [-7.5%])</span> 3,511 |
| `main_trace_commit_time_ms` |  30.50 |  61 |  33 |  28 |
| `generate_perm_trace_time_ms` | <span style='color: green'>(-44 [-49.2%])</span> 45 | <span style='color: green'>(-87 [-49.2%])</span> 90 | <span style='color: green'>(-87 [-61.3%])</span> 55 |  35 |
| `perm_trace_commit_time_ms` | <span style='color: red'>(+0 [+0.2%])</span> 40.66 | <span style='color: red'>(+0 [+0.2%])</span> 81.31 | <span style='color: green'>(-0 [-0.7%])</span> 43.05 | <span style='color: red'>(+0 [+1.2%])</span> 38.27 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+2 [+5.1%])</span> 32.75 | <span style='color: red'>(+3 [+5.1%])</span> 65.51 | <span style='color: red'>(+3 [+9.0%])</span> 35.17 | <span style='color: red'>(+0 [+1.0%])</span> 30.34 |
| `quotient_poly_commit_time_ms` | <span style='color: green'>(-1 [-4.1%])</span> 11.99 | <span style='color: green'>(-1 [-4.1%])</span> 23.99 | <span style='color: green'>(-1 [-5.9%])</span> 12.32 | <span style='color: green'>(-0 [-2.0%])</span> 11.66 |
| `pcs_opening_time_ms ` | <span style='color: green'>(-535 [-13.4%])</span> 3,459 | <span style='color: green'>(-1070 [-13.4%])</span> 6,918 | <span style='color: green'>(-750 [-17.3%])</span> 3,587 | <span style='color: green'>(-320 [-8.8%])</span> 3,331 |
...
| --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 3,992 | 1 | 9 | 1,500,209 | 160.52 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 187 | 3,900 | 9,677,708 | 84,395,212 | 187 | 3,511 | 0 | 35.17 | 12.32 | 6 | 43.05 | 3,331 | 98 | 3,331 | 0 | 33 | 1,035,986 | 55 | 33 | 873,000 | 36.89 | 14 | 47 | 0 | 3,330 | 
| fibonacci_program | 1 | 196 | 3,992 | 9,708,170 | 74,305,770 | 196 | 3,733 | 1 | 30.34 | 11.66 | 5 | 38.27 | 3,587 | 74 | 3,587 | 0 | 28 | 1,064,416 | 35 | 22 | 627,209 | 37.41 | 11 | 42 | 0 | 3,587 | 

...
| `total_proof_time_ms ` |  4,114 |  8,228 |  5,197 |  3,031 |
...
| `execute_preflight_time_ms` |  267 |  534 |  293 |  241 |
| `execute_preflight_insn_mi/s` |  33.53 | -          |  35.14 |  31.93 |
| `trace_gen_time_ms   ` |  125.50 |  251 |  176 |  75 |
| `set_initial_memory_time_ms` |  88.50 |  177 |  136 |  41 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  3,631.50 |  7,263 |  4,642 |  2,621 |
| `prover.main_trace_commit_time_ms` |  960.50 |  1,921 |  1,330 |  591 |
| `prover.rap_constraints_time_ms` |  1,964 |  3,928 |  2,416 |  1,512 |
| `prover.openings_time_ms` |  706 |  1,412 |  895 |  517 |
| `prover.rap_constraints.logup_gkr_time_ms` |  553.50 |  1,107 |  593 |  514 |
| `prover.rap_constraints.round0_time_ms` |  1,028 |  2,056 |  1,332 |  724 |
| `prover.rap_constraints.mle_rounds_time_ms` |  381 |  762 |  490 |  272 |
| `prover.openings.stacked_reduction_time_ms` |  165.50 |  331 |  215 |  116 |
...
| `prover.openings.whir_time_ms` |  540 |  1,080 |  680 |  400 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/76a6901f7b46a8ddf81359e7a39182749bd6e467/sha2_bench-76a6901f7b46a8ddf81359e7a39182749bd6e467.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 68 |  |  |  | 339 |  |  |  |  |  |  | 
| app_proof |  |  |  | 3,031 |  | 98 | 11,167,961 | 112.92 | 0 | 8,333 |  | 
...
| leaf | 0 | 111 | 1,010 | 110 | 34 | 17 | 2 | 7 | 7 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 329 | 118 | 0 | 0 | 108 | 35 | 34 | 52 | 20 | 0 | 102 | 88 | 13 | 3 | 9 | 118 | 118 | 108 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 169 | 48 | 0 | 0 | 67 | 25 | 24 | 28 | 14 | 0 | 53 | 45 | 8 | 1 | 6 | 48 | 48 | 67 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 138 | 31 | 0 | 0 | 65 | 26 | 25 | 25 | 13 | 0 | 40 | 33 | 7 | 1 | 5 | 32 | 31 | 65 | 0 | 2 | 13 | 0 | 0 | 
| leaf | 0 | prover | 237,929,016 | 899 | 374 | 0 | 0 | 228 | 109 | 108 | 67 | 51 | 0 | 295 | 257 | 37 | 20 | 17 | 375 | 374 | 228 | 0 | 10 | 50 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,286,242,554 | 4,642 | 1,330 | 0 | 0 | 2,416 | 1,332 | 1,331 | 490 | 593 | 0 | 895 | 680 | 215 | 134 | 80 | 1,330 | 1,330 | 2,416 | 0 | 5 | 592 | 0 | 0 | 
| app_proof | prover | 1 | 750,289,144 | 2,621 | 591 | 0 | 0 | 1,512 | 724 | 724 | 272 | 514 | 0 | 517 | 400 | 116 | 70 | 46 | 591 | 591 | 1,512 | 0 | 6 | 513 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 136 | 2 | 176 | 5,197 | 176 | 136 | 13,311,936,132 | 2,137,449,780 | 15,449,385,912 | 2,097,152 | 0 | 4 | 241 | 7,124,000 | 31.93 | 
| app_proof | 1 | 41 | 1 | 75 | 3,031 | 75 | 41 | 7,588,526,580 | 1,502,398,413 | 9,090,924,993 | 2,097,152 | 0 | 2 | 293 | 4,043,961 | 35.14 | 

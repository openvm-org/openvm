...
| `total_proof_time_ms ` |  4,146.50 |  8,293 |  5,237 |  3,056 |
...
| `execute_preflight_time_ms` |  261 |  522 |  284 |  238 |
| `execute_preflight_insn_mi/s` |  33.88 | -          |  35.52 |  32.23 |
| `trace_gen_time_ms   ` |  125.50 |  251 |  176 |  75 |
| `set_initial_memory_time_ms` |  88 |  176 |  135 |  41 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  3,670 |  7,340 |  4,686 |  2,654 |
| `prover.main_trace_commit_time_ms` |  958.50 |  1,917 |  1,324 |  593 |
| `prover.rap_constraints_time_ms` |  2,003.50 |  4,007 |  2,468 |  1,539 |
| `prover.openings_time_ms` |  707 |  1,414 |  893 |  521 |
| `prover.rap_constraints.logup_gkr_time_ms` |  558 |  1,116 |  596 |  520 |
| `prover.rap_constraints.round0_time_ms` |  1,063 |  2,126 |  1,379 |  747 |
| `prover.rap_constraints.mle_rounds_time_ms` |  382 |  764 |  492 |  272 |
...
| `prover.openings.whir_time_ms` |  540 |  1,080 |  679 |  401 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/b584d308cd3c3498bf5e14a36257b679c890d5d9/sha2_bench-b584d308cd3c3498bf5e14a36257b679c890d5d9.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 67 |  |  |  | 337 |  |  |  |  |  |  | 
| app_proof |  |  |  | 3,056 |  | 98 | 11,167,961 | 113.07 | 0 | 8,397 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 21 | 356 | 21 | 5 | 1 | 2 | 2 | 2 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 334 | 118 | 0 | 0 | 106 | 34 | 33 | 52 | 20 | 0 | 108 | 95 | 13 | 3 | 9 | 119 | 118 | 106 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 168 | 47 | 0 | 0 | 67 | 25 | 24 | 28 | 14 | 0 | 53 | 45 | 8 | 1 | 6 | 47 | 47 | 67 | 0 | 3 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 139 | 32 | 0 | 0 | 62 | 24 | 23 | 24 | 14 | 0 | 43 | 36 | 7 | 1 | 5 | 32 | 32 | 62 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 237,929,016 | 898 | 376 | 0 | 0 | 230 | 112 | 111 | 67 | 51 | 0 | 290 | 253 | 36 | 19 | 16 | 376 | 376 | 230 | 0 | 11 | 49 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,286,242,554 | 4,686 | 1,323 | 0 | 0 | 2,468 | 1,379 | 1,378 | 492 | 596 | 0 | 893 | 679 | 214 | 133 | 80 | 1,324 | 1,323 | 2,468 | 0 | 6 | 595 | 0 | 0 | 
| app_proof | prover | 1 | 750,289,144 | 2,654 | 593 | 0 | 0 | 1,539 | 747 | 746 | 272 | 520 | 0 | 521 | 401 | 119 | 72 | 47 | 593 | 593 | 1,539 | 0 | 6 | 519 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 135 | 1 | 176 | 5,237 | 176 | 135 | 13,311,936,132 | 2,137,449,780 | 15,449,385,912 | 2,097,152 | 0 | 3 | 238 | 7,124,000 | 32.23 | 
| app_proof | 1 | 41 | 1 | 75 | 3,056 | 75 | 41 | 7,588,526,580 | 1,502,398,413 | 9,090,924,993 | 2,097,152 | 0 | 2 | 284 | 4,043,961 | 35.52 | 

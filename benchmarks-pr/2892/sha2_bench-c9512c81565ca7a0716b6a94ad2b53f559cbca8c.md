...
| `total_proof_time_ms ` |  2,599.25 |  10,397 |  2,711 |  2,550 |
...
| `execute_preflight_time_ms` |  161.75 |  647 |  203 |  97 |
| `execute_preflight_insn_mi/s` |  35.39 | -          |  36.27 |  32.91 |
| `trace_gen_time_ms   ` |  58.50 |  234 |  67 |  53 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  2,312.75 |  9,251 |  2,410 |  2,271 |
| `prover.main_trace_commit_time_ms` |  616.75 |  2,467 |  621 |  613 |
| `prover.rap_constraints_time_ms` |  1,223.75 |  4,895 |  1,230 |  1,219 |
| `prover.openings_time_ms` |  471.50 |  1,886 |  561 |  437 |
| `prover.rap_constraints.logup_gkr_time_ms` |  309.25 |  1,237 |  310 |  308 |
| `prover.rap_constraints.round0_time_ms` |  667.50 |  2,670 |  671 |  664 |
| `prover.rap_constraints.mle_rounds_time_ms` |  245.75 |  983 |  249 |  244 |
| `prover.openings.stacked_reduction_time_ms` |  96.50 |  386 |  100 |  91 |
| `prover.openings.stacked_reduction.round0_time_ms` |  58 |  232 |  60 |  55 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  38 |  152 |  39 |  36 |
| `prover.openings.whir_time_ms` |  374.50 |  1,498 |  463 |  344 |
...
| `prover.openings.whir_time_ms` |  563 |  563 |  563 |  563 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/c9512c81565ca7a0716b6a94ad2b53f559cbca8c/sha2_bench-c9512c81565ca7a0716b6a94ad2b53f559cbca8c.memory.svg)
...
| app_proof |  |  |  |  |  | 2,550 |  |  | 100 | 11,167,961 | 111.57 | 0 | 10,503 |  | 
| internal_for_leaf |  |  |  | 487 |  |  |  |  |  |  |  |  |  | 488 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 27 | 487 | 27 | 7 | 2 | 2 | 3 | 3 | 
| internal_recursive.0 | 1 | 13 | 197 | 12 | 1 | 0 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 9 | 150 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 141 | 1,930 | 141 | 50 | 22 | 3 | 6 | 6 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 61,220,667 | 460 | 184 | 0 | 0 | 130 | 38 | 37 | 65 | 27 | 0 | 144 | 125 | 18 | 5 | 12 | 184 | 130 | 0 | 4 | 26 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,943 | 184 | 50 | 0 | 0 | 72 | 25 | 24 | 29 | 17 | 0 | 60 | 51 | 8 | 1 | 6 | 50 | 72 | 0 | 3 | 17 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 140 | 32 | 0 | 0 | 61 | 22 | 22 | 24 | 13 | 0 | 46 | 38 | 7 | 1 | 5 | 33 | 60 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 425,192,422 | 1,788 | 807 | 0 | 89 | 352 | 170 | 169 | 104 | 76 | 0 | 628 | 563 | 64 | 36 | 28 | 807 | 352 | 0 | 9 | 75 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 640,057,593 | 2,410 | 621 | 0 | 71 | 1,226 | 669 | 668 | 246 | 310 | 0 | 561 | 463 | 98 | 59 | 39 | 621 | 1,226 | 0 | 4 | 309 | 0 | 0 | 
| app_proof | prover | 1 | 640,057,356 | 2,271 | 613 | 0 | 0 | 1,220 | 666 | 666 | 244 | 309 | 0 | 437 | 345 | 91 | 55 | 36 | 614 | 1,220 | 0 | 5 | 308 | 0 | 0 | 
| app_proof | prover | 2 | 640,057,356 | 2,285 | 613 | 0 | 0 | 1,230 | 671 | 670 | 249 | 308 | 0 | 441 | 344 | 97 | 58 | 38 | 613 | 1,230 | 0 | 4 | 308 | 0 | 0 | 
| app_proof | prover | 3 | 640,057,588 | 2,285 | 618 | 0 | 0 | 1,219 | 664 | 664 | 244 | 310 | 0 | 447 | 346 | 100 | 60 | 39 | 619 | 1,219 | 0 | 4 | 309 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 67 | 2,711 | 67 | 135 | 5,529,436,044 | 2,165,730,336 | 7,695,166,380 | 2,097,152 | 0 | 3 | 97 | 2,851,000 | 32.91 | 
| app_proof | 1 | 57 | 2,574 | 57 | 41 | 5,529,347,520 | 2,165,557,968 | 7,694,905,488 | 2,097,152 | 0 | 1 | 203 | 2,851,000 | 36.21 | 
| app_proof | 2 | 57 | 2,562 | 57 | 41 | 5,529,349,296 | 2,165,556,192 | 7,694,905,488 | 2,097,152 | 0 | 1 | 178 | 2,851,000 | 36.27 | 
| app_proof | 3 | 53 | 2,550 | 53 | 41 | 5,077,435,956 | 2,617,472,316 | 7,694,908,272 | 2,097,152 | 0 | 1 | 169 | 2,614,961 | 36.15 | 

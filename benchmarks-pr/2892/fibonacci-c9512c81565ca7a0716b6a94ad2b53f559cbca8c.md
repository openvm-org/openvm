...
|:---|---:|---:|---:|
| Total |  2.88 |  1.74 |  1.74 |
| app_proof |  1.72 |  0.58 |  0.58 |
| leaf |  0.55 |  0.55 |  0.55 |
...
| `total_proof_time_ms ` |  424.75 |  1,699 |  557 |  230 |
| `compile_metered_time_ms` |  4 |  4 |  4 |  4 |
| `execute_metered_time_ms` |  21 | -          | -          | -          |
| `execute_metered_insns` |  4,000,051 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  188.66 | -          |  188.66 |  188.66 |
| `execute_preflight_insns` |  1,000,012.75 |  4,000,051 |  1,310,000 |  70,051 |
| `execute_preflight_time_ms` |  36.50 |  146 |  50 |  4 |
| `execute_preflight_insn_mi/s` |  40.51 | -          |  40.82 |  40.07 |
| `trace_gen_time_ms   ` |  79.50 |  318 |  106 |  69 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  243.50 |  974 |  302 |  78 |
| `prover.main_trace_commit_time_ms` |  43 |  172 |  52 |  16 |
| `prover.rap_constraints_time_ms` |  143.50 |  574 |  183 |  33 |
| `prover.openings_time_ms` |  56 |  224 |  67 |  27 |
| `prover.rap_constraints.logup_gkr_time_ms` |  99.25 |  397 |  127 |  17 |
| `prover.rap_constraints.round0_time_ms` |  29.75 |  119 |  39 |  9 |
| `prover.rap_constraints.mle_rounds_time_ms` |  13.75 |  55 |  16 |  7 |
| `prover.openings.stacked_reduction_time_ms` |  9.25 |  37 |  12 |  3 |
| `prover.openings.stacked_reduction.round0_time_ms` |  4.25 |  17 |  6 |  0 |
...
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  489 |  489 |  489 |  489 |
...
| `prover.openings.whir_time_ms` |  131 |  131 |  131 |  131 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/c9512c81565ca7a0716b6a94ad2b53f559cbca8c/fibonacci-c9512c81565ca7a0716b6a94ad2b53f559cbca8c.memory.svg)
...
| app_proof |  |  |  |  |  | 230 |  |  | 21 | 4,000,051 | 188.66 | 0 | 1,727 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 27,289,403 | 263 | 84 | 0 | 0 | 99 | 32 | 31 | 46 | 20 | 0 | 78 | 67 | 11 | 2 | 8 | 85 | 99 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,767 | 171 | 48 | 0 | 0 | 69 | 26 | 25 | 28 | 14 | 0 | 53 | 44 | 8 | 1 | 6 | 48 | 69 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 139 | 32 | 0 | 0 | 63 | 23 | 23 | 24 | 14 | 0 | 42 | 35 | 7 | 1 | 5 | 33 | 63 | 0 | 2 | 13 | 0 | 0 | 
| leaf | 0 | prover | 102,779,942 | 489 | 174 | 0 | 0 | 164 | 72 | 71 | 47 | 44 | 0 | 150 | 131 | 18 | 8 | 10 | 174 | 164 | 0 | 8 | 43 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 62,648,824 | 302 | 52 | 0 | 0 | 183 | 39 | 39 | 16 | 126 | 0 | 66 | 54 | 12 | 5 | 5 | 52 | 183 | 0 | 3 | 125 | 0 | 0 | 
| app_proof | prover | 1 | 62,602,932 | 299 | 52 | 0 | 0 | 179 | 36 | 35 | 16 | 127 | 0 | 67 | 56 | 11 | 6 | 5 | 52 | 179 | 0 | 3 | 126 | 0 | 0 | 
| app_proof | prover | 2 | 62,602,932 | 295 | 52 | 0 | 0 | 179 | 35 | 35 | 16 | 127 | 0 | 64 | 52 | 11 | 6 | 5 | 52 | 179 | 0 | 3 | 126 | 0 | 0 | 
| app_proof | prover | 3 | 9,072,096 | 78 | 16 | 0 | 0 | 33 | 9 | 8 | 7 | 17 | 0 | 27 | 24 | 3 | 0 | 2 | 16 | 33 | 0 | 2 | 16 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 69 | 557 | 69 | 135 | 1,626,487,336 | 2,099,944 | 1,628,587,280 | 2,097,152 | 0 | 3 | 50 | 1,310,000 | 40.63 | 
| app_proof | 1 | 72 | 458 | 72 | 41 | 1,625,164,404 | 1,206,055 | 1,626,370,459 | 2,097,152 | 0 | 1 | 46 | 1,310,000 | 40.82 | 
| app_proof | 2 | 71 | 454 | 71 | 41 | 1,625,164,404 | 1,206,055 | 1,626,370,459 | 2,097,152 | 0 | 1 | 46 | 1,310,000 | 40.50 | 
| app_proof | 3 | 106 | 230 | 106 | 41 | 160,245,438 | 14,292,769 | 174,538,207 | 2,097,152 | 0 | 1 | 4 | 70,051 | 40.07 | 

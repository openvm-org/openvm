...
| `execute_preflight_insn_mi/s` |  12.80 | -          |  12.80 |  12.80 |
...
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  276 |  276 |  276 |  276 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/c9512c81565ca7a0716b6a94ad2b53f559cbca8c/ecrecover-c9512c81565ca7a0716b6a94ad2b53f559cbca8c.memory.svg)
...
| prover.batch_constraints.before_round0 | 0.88 | leaf.0.prover |
| frac_sumcheck.gkr_rounds | 0.88 | leaf.0.prover |
| frac_sumcheck.segment_tree | 0.86 | leaf.0.prover |
| prover.gkr_input_evals | 0.86 | leaf.0.prover |
| prover.batch_constraints.round0 | 0.58 | leaf.0.prover |
| prover.batch_constraints.fold_ple_evals | 0.58 | leaf.0.prover |
| prover.before_gkr_input_evals | 0.46 | leaf.0.prover |
| tracegen.whir_final_poly_query_eval | 0.45 | leaf.0 |
| tracegen.pow_checker | 0.45 | leaf.0 |
| tracegen.exp_bits_len | 0.45 | leaf.0 |
| tracegen.whir_folding | 0.38 | leaf.0 |
| tracegen.whir_non_initial_opened_values | 0.38 | leaf.0 |
| tracegen.whir_initial_opened_values | 0.38 | leaf.0 |
| tracegen.range_checker | 0.38 | leaf.0 |
| tracegen.proof_shape | 0.38 | leaf.0 |
| tracegen.public_values | 0.38 | leaf.0 |
...
| 33 | VmAirWrapper<Rv64BaseAluAdapterAir, BaseAluCoreAir<8, 8> |  | 32 | 34 | 3 | 
...
| app_proof |  |  |  |  |  | 478 |  |  | 6 | 112,210 | 16.73 | 0 | 491 |  | 
...
| app_proof | 33 | VmAirWrapper<Rv64BaseAluAdapterAir, BaseAluCoreAir<8, 8> | ADD | 0 | 20,309 | 
| app_proof | 33 | VmAirWrapper<Rv64BaseAluAdapterAir, BaseAluCoreAir<8, 8> | AND | 0 | 3,773 | 
| app_proof | 33 | VmAirWrapper<Rv64BaseAluAdapterAir, BaseAluCoreAir<8, 8> | OR | 0 | 9,891 | 
| app_proof | 33 | VmAirWrapper<Rv64BaseAluAdapterAir, BaseAluCoreAir<8, 8> | SUB | 0 | 761 | 
| app_proof | 33 | VmAirWrapper<Rv64BaseAluAdapterAir, BaseAluCoreAir<8, 8> | XOR | 0 | 1,003 | 
| app_proof | 35 | PhantomAir | PHANTOM | 0 | 11 | 
...
| app_proof | 33 | VmAirWrapper<Rv64BaseAluAdapterAir, BaseAluCoreAir<8, 8> | 0 | 35,737 | 29,799 | 4,288,440 | 3,575,880 | 6,861,504 | 5,721,408 | 1,715,376 | 1,430,352 | 41,454,920 | 34,566,840 | 1,143,584 | 953,568 | 
| app_proof | 34 | BitwiseOperationLookupAir<8> | 0 | 65,536 |  | 5,898,240 |  | 4,718,592 |  | 1,179,648 |  | 4,751,360 |  | 131,072 |  | 
| app_proof | 35 | PhantomAir | 0 | 11 | 5 | 165 | 75 | 264 | 120 | 66 | 30 | 1,197 | 543 | 33 | 15 | 
| app_proof | 36 | Poseidon2PeripheryAir<BabyBearParameters>, 1> | 0 | 6,556 | 1,636 | 4,917,000 | 1,227,000 | 7,867,200 | 1,963,200 | 1,966,800 | 490,800 | 237,655 | 59,305 | 6,556 | 1,636 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 26,560,315 | 252 | 80 | 0 | 0 | 96 | 31 | 30 | 44 | 19 | 0 | 75 | 64 | 11 | 2 | 8 | 80 | 96 | 0 | 3 | 18 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,767 | 165 | 45 | 0 | 0 | 66 | 24 | 24 | 28 | 14 | 0 | 52 | 44 | 8 | 1 | 6 | 46 | 66 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 136 | 32 | 0 | 0 | 61 | 23 | 22 | 24 | 13 | 0 | 41 | 34 | 7 | 1 | 5 | 33 | 61 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 46,795,067 | 276 | 75 | 0 | 0 | 117 | 43 | 42 | 29 | 44 | 0 | 83 | 72 | 10 | 4 | 6 | 75 | 117 | 0 | 5 | 43 | 0 | 0 | 
...
| leaf | 0 | prover | 0 | 9,850,690 | 2,013,265,921 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 17,914,788 | 183 | 22 | 0 | 0 | 123 | 76 | 76 | 17 | 29 | 0 | 37 | 27 | 9 | 1 | 7 | 22 | 123 | 0 | 2 | 28 | 0 | 0 | 

| group | phase | segment | trace_height_constraint | weighted_sum | threshold |
| --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 0 | 8,037,010 | 2,013,265,921 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 147 | 478 | 147 | 135 | 259,570,185 | 113,592,244 | 373,162,429 | 2,097,152 | 0 | 3 | 11 | 112,210 | 12.80 | 

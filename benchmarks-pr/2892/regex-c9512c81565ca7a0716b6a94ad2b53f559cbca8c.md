...
|:---|---:|---:|---:|
| Total |  2.63 |  1.98 |  1.98 |
| app_proof |  1.59 |  0.93 |  0.93 |
| leaf |  0.44 |  0.44 |  0.44 |
...
| `total_proof_time_ms ` |  776 |  1,552 |  894 |  658 |
| `compile_metered_time_ms` |  8 |  8 |  8 |  8 |
| `execute_metered_time_ms` |  35 | -          | -          | -          |
| `execute_metered_insns` |  4,090,656 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  116.44 | -          |  116.44 |  116.44 |
| `execute_preflight_insns` |  2,045,328 |  4,090,656 |  2,327,000 |  1,763,656 |
| `execute_preflight_time_ms` |  86 |  172 |  95 |  77 |
| `execute_preflight_insn_mi/s` |  32.65 | -          |  33.76 |  31.55 |
| `trace_gen_time_ms   ` |  39 |  78 |  45 |  33 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  561.50 |  1,123 |  629 |  494 |
| `prover.main_trace_commit_time_ms` |  116.50 |  233 |  131 |  102 |
| `prover.rap_constraints_time_ms` |  330 |  660 |  370 |  290 |
| `prover.openings_time_ms` |  114 |  228 |  127 |  101 |
| `prover.rap_constraints.logup_gkr_time_ms` |  200.50 |  401 |  245 |  156 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/c9512c81565ca7a0716b6a94ad2b53f559cbca8c/regex-c9512c81565ca7a0716b6a94ad2b53f559cbca8c.memory.svg)
...
| app_proof |  |  |  |  |  | 658 |  |  | 35 | 4,090,656 | 116.44 | 0 | 1,601 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 27,289,403 | 266 | 83 | 0 | 0 | 99 | 33 | 32 | 46 | 19 | 0 | 83 | 72 | 11 | 2 | 8 | 84 | 99 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,767 | 170 | 47 | 0 | 0 | 68 | 25 | 25 | 28 | 14 | 0 | 54 | 45 | 8 | 1 | 6 | 47 | 68 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 139 | 32 | 0 | 0 | 62 | 23 | 22 | 24 | 13 | 0 | 44 | 36 | 7 | 1 | 5 | 33 | 62 | 0 | 3 | 13 | 0 | 0 | 
| leaf | 0 | prover | 79,656,756 | 385 | 129 | 0 | 0 | 137 | 56 | 55 | 37 | 43 | 0 | 118 | 102 | 15 | 6 | 8 | 129 | 137 | 0 | 7 | 42 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 161,843,666 | 629 | 130 | 0 | 0 | 370 | 87 | 87 | 37 | 245 | 0 | 127 | 101 | 25 | 14 | 11 | 131 | 370 | 0 | 3 | 244 | 0 | 0 | 
| app_proof | prover | 1 | 123,257,151 | 494 | 102 | 0 | 0 | 290 | 102 | 101 | 31 | 156 | 0 | 101 | 81 | 20 | 9 | 10 | 102 | 290 | 0 | 3 | 155 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 33 | 894 | 33 | 136 | 2,906,597,493 | 888,488,923 | 3,795,086,416 | 2,097,152 | 1 | 4 | 95 | 2,327,000 | 31.55 | 
| app_proof | 1 | 45 | 658 | 45 | 41 | 2,092,069,523 | 674,063,136 | 2,766,132,659 | 2,097,152 | 0 | 2 | 77 | 1,763,656 | 33.76 | 

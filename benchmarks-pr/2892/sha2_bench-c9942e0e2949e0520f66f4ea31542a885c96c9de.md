...
|:---|---:|---:|---:|
| Total |  13.40 |  5.63 |  5.63 |
| app_proof |  10.62 |  2.84 |  2.84 |
| leaf |  1.96 |  1.96 |  1.96 |
...
| `total_proof_time_ms ` |  2,629.25 |  10,517 |  2,737 |  2,577 |
...
| `execute_preflight_time_ms` |  162.50 |  650 |  206 |  98 |
| `execute_preflight_insn_mi/s` |  35.22 | -          |  36.15 |  32.74 |
| `trace_gen_time_ms   ` |  59 |  236 |  68 |  54 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  2,341.50 |  9,366 |  2,434 |  2,308 |
| `prover.main_trace_commit_time_ms` |  621.50 |  2,486 |  624 |  618 |
| `prover.rap_constraints_time_ms` |  1,242.75 |  4,971 |  1,245 |  1,238 |
| `prover.openings_time_ms` |  476.50 |  1,906 |  567 |  444 |
| `prover.rap_constraints.logup_gkr_time_ms` |  312 |  1,248 |  312 |  312 |
| `prover.rap_constraints.round0_time_ms` |  682.75 |  2,731 |  685 |  680 |
| `prover.rap_constraints.mle_rounds_time_ms` |  247 |  988 |  252 |  244 |
...
| `prover.openings.whir_time_ms` |  376.25 |  1,505 |  465 |  345 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,956 |  1,956 |  1,956 |  1,956 |
...
| `prover.openings.whir_time_ms` |  129 |  129 |  129 |  129 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/c9942e0e2949e0520f66f4ea31542a885c96c9de/sha2_bench-c9942e0e2949e0520f66f4ea31542a885c96c9de.memory.svg)
...
| app_proof |  |  |  |  |  | 2,577 |  |  | 100 | 11,167,961 | 111.05 | 0 | 10,623 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 27 | 492 | 26 | 7 | 2 | 2 | 3 | 3 | 
| internal_recursive.0 | 1 | 13 | 193 | 12 | 2 | 0 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 9 | 147 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 145 | 1,956 | 145 | 51 | 22 | 2 | 6 | 6 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 61,220,667 | 465 | 186 | 0 | 0 | 130 | 38 | 37 | 64 | 27 | 0 | 148 | 129 | 19 | 5 | 13 | 186 | 130 | 0 | 4 | 26 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,943 | 180 | 49 | 0 | 0 | 72 | 24 | 24 | 29 | 18 | 0 | 58 | 49 | 8 | 2 | 6 | 50 | 72 | 0 | 3 | 17 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 138 | 31 | 0 | 0 | 63 | 24 | 23 | 24 | 13 | 0 | 42 | 35 | 7 | 1 | 5 | 32 | 63 | 0 | 2 | 13 | 0 | 0 | 
| leaf | 0 | prover | 425,192,422 | 1,810 | 815 | 0 | 90 | 353 | 172 | 171 | 105 | 75 | 0 | 640 | 576 | 64 | 36 | 28 | 816 | 353 | 0 | 10 | 74 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 640,057,593 | 2,434 | 623 | 0 | 71 | 1,243 | 685 | 684 | 245 | 312 | 0 | 567 | 465 | 101 | 61 | 40 | 624 | 1,243 | 0 | 5 | 310 | 0 | 0 | 
| app_proof | prover | 1 | 640,057,356 | 2,308 | 618 | 0 | 0 | 1,245 | 680 | 680 | 252 | 312 | 0 | 444 | 345 | 98 | 59 | 39 | 618 | 1,245 | 0 | 5 | 311 | 0 | 0 | 
| app_proof | prover | 2 | 640,057,356 | 2,313 | 620 | 0 | 0 | 1,245 | 685 | 685 | 247 | 312 | 0 | 447 | 346 | 100 | 61 | 39 | 620 | 1,245 | 0 | 6 | 311 | 0 | 0 | 
| app_proof | prover | 3 | 640,057,588 | 2,311 | 623 | 0 | 0 | 1,238 | 681 | 681 | 244 | 312 | 0 | 448 | 349 | 99 | 60 | 38 | 624 | 1,238 | 0 | 5 | 310 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 68 | 2,737 | 68 | 136 | 5,529,436,044 | 2,165,730,336 | 7,695,166,380 | 2,097,152 | 0 | 3 | 98 | 2,851,000 | 32.74 | 
| app_proof | 1 | 57 | 2,613 | 57 | 41 | 5,529,347,520 | 2,165,557,968 | 7,694,905,488 | 2,097,152 | 0 | 1 | 206 | 2,851,000 | 35.91 | 
| app_proof | 2 | 57 | 2,590 | 57 | 41 | 5,529,349,296 | 2,165,556,192 | 7,694,905,488 | 2,097,152 | 0 | 1 | 177 | 2,851,000 | 36.15 | 
| app_proof | 3 | 54 | 2,577 | 54 | 41 | 5,077,435,956 | 2,617,472,316 | 7,694,908,272 | 2,097,152 | 0 | 1 | 169 | 2,614,961 | 36.10 | 

...
|:---|---:|---:|
| Total | <span style='color: red'>(+0 [+1.5%])</span> 0.100 | <span style='color: red'>(+0 [+1.6%])</span> 0.57 |
| fibonacci_program | <span style='color: red'>(+0 [+1.2%])</span> 0.98 | <span style='color: red'>(+0 [+1.1%])</span> 0.56 |


| fibonacci_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+6 [+1.2%])</span> 492 | <span style='color: red'>(+12 [+1.2%])</span> 984 | <span style='color: red'>(+6 [+1.1%])</span> 558 | <span style='color: red'>(+6 [+1.4%])</span> 426 |
...
| `execute_metered_insn_mi/s` | <span style='color: green'>(-37 [-25.2%])</span> 110.65 | -          | <span style='color: green'>(-37 [-25.2%])</span> 110.65 | <span style='color: green'>(-37 [-25.2%])</span> 110.65 |
| `execute_preflight_insns` |  750,104.50 |  1,500,209 |  873,000 |  627,209 |
| `execute_preflight_time_ms` |  29.50 |  59 |  33 |  26 |
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+0 [+0.8%])</span> 36.44 | -          | <span style='color: red'>(+1 [+2.3%])</span> 38.42 | <span style='color: green'>(-0 [-0.9%])</span> 34.47 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+4 [+2.4%])</span> 192 | <span style='color: red'>(+9 [+2.4%])</span> 384 | <span style='color: red'>(+3 [+1.5%])</span> 198 | <span style='color: red'>(+6 [+3.3%])</span> 186 |
| `memory_finalize_time_ms` | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+2 [+1.4%])</span> 177.50 | <span style='color: red'>(+5 [+1.4%])</span> 355 | <span style='color: red'>(+4 [+2.2%])</span> 190 | <span style='color: red'>(+1 [+0.6%])</span> 165 |
| `main_trace_commit_time_ms` |  30.50 |  61 |  33 |  28 |
| `generate_perm_trace_time_ms` |  15 |  30 | <span style='color: red'>(+1 [+5.9%])</span> 18 | <span style='color: green'>(-1 [-7.7%])</span> 12 |
| `perm_trace_commit_time_ms` | <span style='color: green'>(-0 [-0.8%])</span> 41.79 | <span style='color: green'>(-1 [-0.8%])</span> 83.58 | <span style='color: red'>(+1 [+1.4%])</span> 45.43 | <span style='color: green'>(-1 [-3.3%])</span> 38.15 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+2 [+5.5%])</span> 32.62 | <span style='color: red'>(+3 [+5.5%])</span> 65.23 | <span style='color: red'>(+1 [+4.1%])</span> 34.50 | <span style='color: red'>(+2 [+7.2%])</span> 30.74 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+0 [+2.8%])</span> 12.26 | <span style='color: red'>(+1 [+2.8%])</span> 24.52 | <span style='color: red'>(+0 [+0.6%])</span> 12.33 | <span style='color: red'>(+1 [+5.2%])</span> 12.20 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+0 [+1.2%])</span> 43.50 | <span style='color: red'>(+1 [+1.2%])</span> 87 | <span style='color: red'>(+1 [+2.3%])</span> 45 |  42 |
...
| --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 426 | 1 | 13 | 1,500,209 | 110.65 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 198 | 558 | 9,677,708 | 84,395,212 | 198 | 190 | 0 | 34.50 | 12.33 | 4 | 45.43 | 45 | 64 | 45 | 0 | 33 | 1,035,986 | 18 | 26 | 873,000 | 34.47 | 14 | 47 | 0 | 44 | 
| fibonacci_program | 1 | 186 | 426 | 9,708,170 | 74,305,770 | 186 | 165 | 1 | 30.74 | 12.20 | 5 | 38.15 | 42 | 51 | 42 | 0 | 28 | 1,064,416 | 12 | 33 | 627,209 | 38.42 | 11 | 43 | 0 | 42 | 
...
Commit: https://github.com/openvm-org/openvm/commit/cf5f7a7bf28a6ae33ba61580a25b005c387f53d8
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19343042876)

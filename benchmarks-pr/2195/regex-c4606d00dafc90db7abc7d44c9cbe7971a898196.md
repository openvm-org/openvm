...
|:---|---:|---:|
| Total | <span style='color: red'>(+0 [+1.5%])</span> 2.42 | <span style='color: red'>(+0 [+1.8%])</span> 0.79 |
| regex_program | <span style='color: red'>(+0 [+1.4%])</span> 2.38 | <span style='color: red'>(+0 [+1.6%])</span> 0.75 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+8 [+1.4%])</span> 595.50 | <span style='color: red'>(+33 [+1.4%])</span> 2,382 | <span style='color: red'>(+12 [+1.6%])</span> 750 | <span style='color: red'>(+1 [+0.2%])</span> 537 |
...
| `execute_metered_insn_mi/s` | <span style='color: green'>(-7 [-5.8%])</span> 111.87 | -          | <span style='color: green'>(-7 [-5.8%])</span> 111.87 | <span style='color: green'>(-7 [-5.8%])</span> 111.87 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` | <span style='color: red'>(+7 [+13.6%])</span> 60.75 | <span style='color: red'>(+29 [+13.6%])</span> 243 | <span style='color: red'>(+8 [+12.3%])</span> 73 | <span style='color: red'>(+5 [+11.1%])</span> 50 |
| `execute_preflight_insn_mi/s` | <span style='color: green'>(-1 [-4.1%])</span> 29.70 | -          | <span style='color: green'>(-1 [-3.6%])</span> 30.97 | <span style='color: green'>(-2 [-6.6%])</span> 26.22 |
| `trace_gen_time_ms   ` | <span style='color: green'>(-6 [-3.4%])</span> 171.25 | <span style='color: green'>(-24 [-3.4%])</span> 685 | <span style='color: green'>(-1 [-0.5%])</span> 209 | <span style='color: green'>(-6 [-3.9%])</span> 148 |
| `memory_finalize_time_ms` |  1 |  4 |  4 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+5 [+1.6%])</span> 293.50 | <span style='color: red'>(+19 [+1.6%])</span> 1,174 | <span style='color: red'>(+1 [+0.3%])</span> 338 |  266 |
| `main_trace_commit_time_ms` | <span style='color: green'>(-0 [-0.5%])</span> 50.75 | <span style='color: green'>(-1 [-0.5%])</span> 203 | <span style='color: green'>(-1 [-1.8%])</span> 56 |  49 |
| `generate_perm_trace_time_ms` | <span style='color: green'>(-0 [-0.7%])</span> 33.50 | <span style='color: green'>(-1 [-0.7%])</span> 134 |  54 | <span style='color: green'>(-1 [-5.3%])</span> 18 |
| `perm_trace_commit_time_ms` | <span style='color: red'>(+0 [+0.3%])</span> 63.77 | <span style='color: red'>(+1 [+0.3%])</span> 255.06 | <span style='color: red'>(+1 [+1.3%])</span> 69.07 | <span style='color: red'>(+0 [+0.8%])</span> 55.13 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+1 [+1.9%])</span> 58.32 | <span style='color: red'>(+4 [+1.9%])</span> 233.28 | <span style='color: green'>(-1 [-1.9%])</span> 68.78 | <span style='color: green'>(-0 [-0.2%])</span> 51.42 |
| `quotient_poly_commit_time_ms` | <span style='color: green'>(-0 [-0.8%])</span> 14.99 | <span style='color: green'>(-0 [-0.8%])</span> 59.97 | <span style='color: red'>(+0 [+0.8%])</span> 17.84 | <span style='color: green'>(-0 [-2.2%])</span> 12.28 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+4 [+5.8%])</span> 68.75 | <span style='color: red'>(+15 [+5.8%])</span> 275 | <span style='color: green'>(-4 [-4.8%])</span> 79 | <span style='color: red'>(+2 [+3.6%])</span> 58 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 537 | 1 | 36 | 4,137,502 | 111.87 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 209 | 750 | 23,446,148 | 150,778,428 | 209 | 338 | 0 | 59.73 | 17.84 | 6 | 69.07 | 79 | 124 | 79 | 4 | 56 | 10,899,170 | 54 | 50 | 1,103,000 | 26.22 | 22 | 78 | 1 | 79 | 
| regex_program | 1 | 148 | 558 | 11,598,276 | 128,513,066 | 148 | 295 | 1 | 53.34 | 14.56 | 5 | 65.41 | 75 | 101 | 74 | 0 | 49 | 2,196,106 | 35 | 73 | 1,104,000 | 30.97 | 16 | 68 | 0 | 74 | 
| regex_program | 2 | 157 | 537 | 11,579,064 | 128,513,066 | 157 | 275 | 1 | 51.42 | 15.28 | 5 | 65.45 | 63 | 93 | 63 | 0 | 49 | 2,177,334 | 27 | 63 | 1,104,000 | 30.81 | 17 | 67 | 0 | 63 | 
| regex_program | 3 | 171 | 537 | 11,853,872 | 103,456,394 | 171 | 266 | 0 | 68.78 | 12.28 | 5 | 55.13 | 58 | 77 | 57 | 0 | 49 | 2,422,606 | 18 | 57 | 826,502 | 30.79 | 19 | 82 | 1 | 57 | 

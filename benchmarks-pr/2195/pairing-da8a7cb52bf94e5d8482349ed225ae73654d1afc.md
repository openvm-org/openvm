...
|:---|---:|---:|
| Total | <span style='color: red'>(+0 [+5.0%])</span> 1.60 | <span style='color: red'>(+0 [+1.3%])</span> 0.92 |
| pairing | <span style='color: red'>(+0 [+5.3%])</span> 1.51 | <span style='color: red'>(+0 [+1.5%])</span> 0.83 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+38 [+5.3%])</span> 753.50 | <span style='color: red'>(+76 [+5.3%])</span> 1,507 | <span style='color: red'>(+12 [+1.5%])</span> 830 | <span style='color: red'>(+64 [+10.4%])</span> 677 |
...
| `execute_metered_insn_mi/s` | <span style='color: green'>(-0 [-0.6%])</span> 19.22 | -          | <span style='color: green'>(-0 [-0.6%])</span> 19.22 | <span style='color: green'>(-0 [-0.6%])</span> 19.22 |
...
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+1 [+5.5%])</span> 13.70 | -          | <span style='color: red'>(+1 [+7.5%])</span> 18.16 | <span style='color: red'>(+0 [+1.8%])</span> 9.24 |
| `trace_gen_time_ms   ` | <span style='color: green'>(-1 [-0.6%])</span> 177.50 | <span style='color: green'>(-2 [-0.6%])</span> 355 |  195 | <span style='color: green'>(-2 [-1.2%])</span> 160 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+40 [+11.6%])</span> 389 | <span style='color: red'>(+81 [+11.6%])</span> 778 | <span style='color: red'>(+16 [+4.2%])</span> 398 | <span style='color: red'>(+65 [+20.6%])</span> 380 |
...
| `generate_perm_trace_time_ms` | <span style='color: red'>(+30 [+83.3%])</span> 66 | <span style='color: red'>(+60 [+83.3%])</span> 132 | <span style='color: red'>(+31 [+77.5%])</span> 71 | <span style='color: red'>(+29 [+90.6%])</span> 61 |
| `perm_trace_commit_time_ms` | <span style='color: green'>(-2 [-2.1%])</span> 76.46 | <span style='color: green'>(-3 [-2.1%])</span> 152.92 | <span style='color: green'>(-2 [-2.4%])</span> 88 | <span style='color: green'>(-1 [-1.7%])</span> 64.92 |
| `quotient_poly_compute_time_ms` | <span style='color: green'>(-2 [-2.4%])</span> 78.30 | <span style='color: green'>(-4 [-2.4%])</span> 156.59 | <span style='color: green'>(-3 [-3.3%])</span> 86.06 | <span style='color: green'>(-1 [-1.4%])</span> 70.54 |
| `quotient_poly_commit_time_ms` | <span style='color: green'>(-1 [-3.7%])</span> 15.89 | <span style='color: green'>(-1 [-3.7%])</span> 31.79 | <span style='color: green'>(-1 [-5.7%])</span> 16.98 | <span style='color: green'>(-0 [-1.4%])</span> 14.80 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+16 [+23.9%])</span> 83 | <span style='color: red'>(+32 [+23.9%])</span> 166 | <span style='color: red'>(+30 [+42.9%])</span> 100 | <span style='color: red'>(+2 [+3.1%])</span> 66 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 677 | 40 | 1 | 90 | 1,745,742 | 19.22 | 145 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 160 | 830 | 32,689,110 | 172,558,444 | 160 | 398 | 0 | 86.06 | 16.98 | 6 | 88 | 66 | 152 | 65 | 1 | 75 | 16,059,916 | 61 | 128 | 1,157,000 | 9.24 | 26 | 103 | 1 | 65 | 
| pairing | 1 | 195 | 677 | 22,314,288 | 119,958,502 | 195 | 380 | 1 | 70.54 | 14.80 | 6 | 64.92 | 100 | 139 | 100 | 0 | 54 | 9,408,294 | 71 | 59 | 588,742 | 18.16 | 20 | 85 | 1 | 100 | 
...
Commit: https://github.com/openvm-org/openvm/commit/da8a7cb52bf94e5d8482349ed225ae73654d1afc
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19221791622)

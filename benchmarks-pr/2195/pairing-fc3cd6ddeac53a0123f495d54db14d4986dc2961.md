...
|:---|---:|---:|
| Total | <span style='color: red'>(+0 [+6.1%])</span> 1.61 | <span style='color: red'>(+0 [+3.3%])</span> 0.93 |
| pairing | <span style='color: red'>(+0 [+6.3%])</span> 1.52 | <span style='color: red'>(+0 [+3.3%])</span> 0.84 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+45 [+6.3%])</span> 758 | <span style='color: red'>(+90 [+6.3%])</span> 1,516 | <span style='color: red'>(+27 [+3.3%])</span> 838 | <span style='color: red'>(+63 [+10.2%])</span> 678 |
...
| `execute_metered_insn_mi/s` | <span style='color: green'>(-1 [-2.9%])</span> 18.85 | -          | <span style='color: green'>(-1 [-2.9%])</span> 18.85 | <span style='color: green'>(-1 [-2.9%])</span> 18.85 |
| `execute_preflight_insns` |  872,871 |  1,745,742 |  1,157,000 |  588,742 |
| `execute_preflight_time_ms` | <span style='color: red'>(+1 [+1.1%])</span> 95 | <span style='color: red'>(+2 [+1.1%])</span> 190 |  129 | <span style='color: red'>(+2 [+3.4%])</span> 61 |
| `execute_preflight_insn_mi/s` |  13.65 | -          |  18.12 |  9.17 |
| `trace_gen_time_ms   ` | <span style='color: green'>(-2 [-1.1%])</span> 178 | <span style='color: green'>(-4 [-1.1%])</span> 356 | <span style='color: green'>(-3 [-1.5%])</span> 194 | <span style='color: green'>(-1 [-0.6%])</span> 162 |
...
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+46 [+13.2%])</span> 391 | <span style='color: red'>(+91 [+13.2%])</span> 782 | <span style='color: red'>(+27 [+7.2%])</span> 401 | <span style='color: red'>(+64 [+20.2%])</span> 381 |
...
| `generate_perm_trace_time_ms` | <span style='color: red'>(+21 [+60.0%])</span> 56 | <span style='color: red'>(+42 [+60.0%])</span> 112 | <span style='color: red'>(+34 [+89.5%])</span> 72 | <span style='color: red'>(+8 [+25.0%])</span> 40 |
| `perm_trace_commit_time_ms` |  77.23 |  154.46 | <span style='color: green'>(-1 [-0.9%])</span> 89.38 | <span style='color: red'>(+1 [+1.0%])</span> 65.08 |
| `quotient_poly_compute_time_ms` | <span style='color: green'>(-1 [-0.8%])</span> 79.10 | <span style='color: green'>(-1 [-0.8%])</span> 158.20 | <span style='color: red'>(+0 [+0.3%])</span> 87.57 | <span style='color: green'>(-1 [-2.1%])</span> 70.64 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+0 [+0.5%])</span> 16.84 | <span style='color: red'>(+0 [+0.5%])</span> 33.69 | <span style='color: red'>(+0 [+0.2%])</span> 18.93 | <span style='color: red'>(+0 [+1.0%])</span> 14.76 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+23 [+33.6%])</span> 91.50 | <span style='color: red'>(+46 [+33.6%])</span> 183 | <span style='color: red'>(+29 [+41.4%])</span> 99 | <span style='color: red'>(+17 [+25.4%])</span> 84 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 678 | 1 | 92 | 1,745,742 | 18.85 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 162 | 838 | 32,689,110 | 172,558,444 | 162 | 401 | 0 | 87.57 | 18.93 | 6 | 89.38 | 84 | 132 | 84 | 1 | 76 | 16,059,916 | 40 | 129 | 1,157,000 | 9.17 | 27 | 107 | 1 | 84 | 
| pairing | 1 | 194 | 678 | 22,314,288 | 119,958,502 | 194 | 381 | 1 | 70.64 | 14.76 | 6 | 65.08 | 99 | 140 | 98 | 0 | 55 | 9,408,294 | 72 | 61 | 588,742 | 18.12 | 20 | 86 | 1 | 98 | 
...
Commit: https://github.com/openvm-org/openvm/commit/fc3cd6ddeac53a0123f495d54db14d4986dc2961
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19350095788)

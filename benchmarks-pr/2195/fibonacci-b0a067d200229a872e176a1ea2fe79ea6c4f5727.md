...
|:---|---:|---:|
| Total | <span style='color: red'>(+0 [+0.2%])</span> 0.98 | <span style='color: red'>(+0 [+0.7%])</span> 0.57 |
| fibonacci_program | <span style='color: green'>(-0 [-0.1%])</span> 0.97 | <span style='color: red'>(+0 [+0.2%])</span> 0.55 |


| fibonacci_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: green'>(-0 [-0.1%])</span> 485.50 | <span style='color: green'>(-1 [-0.1%])</span> 971 | <span style='color: red'>(+1 [+0.2%])</span> 553 | <span style='color: green'>(-2 [-0.5%])</span> 418 |
...
| `execute_metered_insn_mi/s` | <span style='color: green'>(-37 [-24.8%])</span> 111.15 | -          | <span style='color: green'>(-37 [-24.8%])</span> 111.15 | <span style='color: green'>(-37 [-24.8%])</span> 111.15 |
| `execute_preflight_insns` |  750,104.50 |  1,500,209 |  873,000 |  627,209 |
| `execute_preflight_time_ms` |  29.50 |  59 |  33 |  26 |
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+0 [+0.4%])</span> 36.33 | -          | <span style='color: red'>(+1 [+1.7%])</span> 38.22 | <span style='color: green'>(-0 [-1.0%])</span> 34.43 |
...
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+0 [+0.3%])</span> 175.50 | <span style='color: red'>(+1 [+0.3%])</span> 351 | <span style='color: red'>(+4 [+2.2%])</span> 190 | <span style='color: green'>(-3 [-1.8%])</span> 161 |
...
| `generate_perm_trace_time_ms` | <span style='color: green'>(-2 [-16.7%])</span> 12.50 | <span style='color: green'>(-5 [-16.7%])</span> 25 | <span style='color: green'>(-4 [-23.5%])</span> 13 | <span style='color: green'>(-1 [-7.7%])</span> 12 |
| `perm_trace_commit_time_ms` | <span style='color: green'>(-0 [-0.7%])</span> 41.83 | <span style='color: green'>(-1 [-0.7%])</span> 83.66 | <span style='color: green'>(-0 [-0.2%])</span> 44.72 | <span style='color: green'>(-1 [-1.3%])</span> 38.94 |
| `quotient_poly_compute_time_ms` | <span style='color: green'>(-1 [-4.8%])</span> 29.42 | <span style='color: green'>(-3 [-4.8%])</span> 58.83 | <span style='color: green'>(-3 [-8.1%])</span> 30.45 | <span style='color: green'>(-0 [-1.1%])</span> 28.38 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+0 [+0.4%])</span> 11.98 | <span style='color: red'>(+0 [+0.4%])</span> 23.96 | <span style='color: green'>(-0 [-2.2%])</span> 11.99 | <span style='color: red'>(+0 [+3.2%])</span> 11.97 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+4 [+10.5%])</span> 47.50 | <span style='color: red'>(+9 [+10.5%])</span> 95 | <span style='color: red'>(+11 [+25.0%])</span> 55 | <span style='color: green'>(-2 [-4.8%])</span> 40 |
...
| --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 418 | 1 | 13 | 1,500,209 | 111.15 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 193 | 553 | 9,677,708 | 84,395,212 | 193 | 190 | 0 | 30.45 | 11.97 | 4 | 44.72 | 55 | 58 | 55 | 0 | 32 | 1,035,986 | 13 | 26 | 873,000 | 34.43 | 13 | 42 | 0 | 55 | 
| fibonacci_program | 1 | 182 | 418 | 9,708,170 | 74,305,770 | 182 | 161 | 1 | 28.38 | 11.99 | 4 | 38.94 | 40 | 52 | 40 | 0 | 28 | 1,064,416 | 12 | 33 | 627,209 | 38.22 | 11 | 40 | 0 | 40 | 

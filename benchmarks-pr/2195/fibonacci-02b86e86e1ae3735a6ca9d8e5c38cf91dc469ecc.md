...
|:---|---:|---:|
| Total | <span style='color: green'>(-0 [-1.3%])</span> 1 | <span style='color: green'>(-0 [-2.9%])</span> 0.57 |
| fibonacci_program | <span style='color: green'>(-0 [-1.2%])</span> 0.99 | <span style='color: green'>(-0 [-2.8%])</span> 0.56 |


| fibonacci_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: green'>(-6 [-1.2%])</span> 497 | <span style='color: green'>(-12 [-1.2%])</span> 994 | <span style='color: green'>(-16 [-2.8%])</span> 561 | <span style='color: red'>(+4 [+0.9%])</span> 433 |
...
| `execute_metered_insn_mi/s` | <span style='color: red'>(+11 [+7.7%])</span> 157.93 | -          | <span style='color: red'>(+11 [+7.7%])</span> 157.93 | <span style='color: red'>(+11 [+7.7%])</span> 157.93 |
| `execute_preflight_insns` |  750,104.50 |  1,500,209 |  873,000 |  627,209 |
| `execute_preflight_time_ms` | <span style='color: green'>(-2 [-5.2%])</span> 27.50 | <span style='color: green'>(-3 [-5.2%])</span> 55 | <span style='color: green'>(-2 [-6.1%])</span> 31 | <span style='color: green'>(-1 [-4.0%])</span> 24 |
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+1 [+1.5%])</span> 38.13 | -          | <span style='color: red'>(+1 [+1.8%])</span> 40.24 | <span style='color: red'>(+0 [+1.2%])</span> 36.02 |
...
| `stark_prove_excluding_trace_time_ms` | <span style='color: green'>(-10 [-5.2%])</span> 183.50 | <span style='color: green'>(-20 [-5.2%])</span> 367 | <span style='color: green'>(-20 [-9.3%])</span> 194 |  173 |
...
| `perm_trace_commit_time_ms` | <span style='color: green'>(-0 [-0.9%])</span> 40.76 | <span style='color: green'>(-1 [-0.9%])</span> 81.51 | <span style='color: green'>(-0 [-1.0%])</span> 43.31 | <span style='color: green'>(-0 [-0.7%])</span> 38.20 |
| `quotient_poly_compute_time_ms` | <span style='color: green'>(-1 [-2.8%])</span> 31.01 | <span style='color: green'>(-2 [-2.8%])</span> 62.02 | <span style='color: green'>(-0 [-0.7%])</span> 34.05 | <span style='color: green'>(-2 [-5.1%])</span> 27.97 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+1 [+5.4%])</span> 12.26 | <span style='color: red'>(+1 [+5.4%])</span> 24.51 | <span style='color: red'>(+1 [+4.4%])</span> 12.51 | <span style='color: red'>(+1 [+6.5%])</span> 12 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 433 | 40 | 1 | 9 | 1,500,209 | 157.93 | 138 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 198 | 561 | 9,677,708 | 84,395,212 | 198 | 194 | 0 | 34.05 | 12.51 | 4 | 43.31 | 41 | 72 | 40 | 0 | 33 | 1,035,986 | 28 | 24 | 873,000 | 36.02 | 13 | 47 | 0 | 40 | 
| fibonacci_program | 1 | 187 | 433 | 9,708,170 | 74,305,770 | 187 | 173 | 1 | 27.97 | 12 | 4 | 38.20 | 44 | 59 | 44 | 0 | 28 | 1,064,416 | 21 | 31 | 627,209 | 40.24 | 11 | 40 | 0 | 44 | 

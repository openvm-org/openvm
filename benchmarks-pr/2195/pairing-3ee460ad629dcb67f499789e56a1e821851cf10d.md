...
|:---|---:|---:|
| Total | <span style='color: red'>(+0 [+0.7%])</span> 1.52 | <span style='color: red'>(+0 [+0.9%])</span> 0.91 |
| pairing | <span style='color: red'>(+0 [+0.6%])</span> 1.43 | <span style='color: red'>(+0 [+0.7%])</span> 0.82 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+4 [+0.6%])</span> 717 | <span style='color: red'>(+8 [+0.6%])</span> 1,434 | <span style='color: red'>(+6 [+0.7%])</span> 817 | <span style='color: red'>(+2 [+0.3%])</span> 617 |
...
| `execute_metered_insn_mi/s` | <span style='color: green'>(-0 [-1.8%])</span> 19.06 | -          | <span style='color: green'>(-0 [-1.8%])</span> 19.06 | <span style='color: green'>(-0 [-1.8%])</span> 19.06 |
| `execute_preflight_insns` |  872,871 |  1,745,742 |  1,157,000 |  588,742 |
| `execute_preflight_time_ms` |  94 |  188 |  129 |  59 |
| `execute_preflight_insn_mi/s` | <span style='color: green'>(-0 [-0.4%])</span> 13.59 | -          | <span style='color: green'>(-0 [-0.7%])</span> 18 |  9.17 |
| `trace_gen_time_ms   ` | <span style='color: green'>(-2 [-1.4%])</span> 177.50 | <span style='color: green'>(-5 [-1.4%])</span> 355 | <span style='color: green'>(-3 [-1.5%])</span> 194 | <span style='color: green'>(-2 [-1.2%])</span> 161 |
...
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+7 [+2.0%])</span> 352.50 | <span style='color: red'>(+14 [+2.0%])</span> 705 | <span style='color: red'>(+9 [+2.4%])</span> 383 | <span style='color: red'>(+5 [+1.6%])</span> 322 |
...
| `generate_perm_trace_time_ms` | <span style='color: red'>(+8 [+24.3%])</span> 43.50 | <span style='color: red'>(+17 [+24.3%])</span> 87 | <span style='color: red'>(+9 [+23.7%])</span> 47 | <span style='color: red'>(+8 [+25.0%])</span> 40 |
| `perm_trace_commit_time_ms` |  77.25 |  154.51 | <span style='color: green'>(-0 [-0.4%])</span> 89.79 | <span style='color: red'>(+0 [+0.5%])</span> 64.72 |
| `quotient_poly_compute_time_ms` | <span style='color: green'>(-1 [-1.4%])</span> 78.61 | <span style='color: green'>(-2 [-1.4%])</span> 157.21 |  87.26 | <span style='color: green'>(-2 [-3.0%])</span> 69.95 |
| `quotient_poly_commit_time_ms` | <span style='color: green'>(-1 [-3.9%])</span> 16.11 | <span style='color: green'>(-1 [-3.9%])</span> 32.22 | <span style='color: green'>(-1 [-3.1%])</span> 18.31 | <span style='color: green'>(-1 [-4.8%])</span> 13.91 |
| `pcs_opening_time_ms ` | <span style='color: green'>(-2 [-2.2%])</span> 67 | <span style='color: green'>(-3 [-2.2%])</span> 134 | <span style='color: green'>(-2 [-2.9%])</span> 68 | <span style='color: green'>(-1 [-1.5%])</span> 66 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 617 | 1 | 91 | 1,745,742 | 19.06 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 161 | 817 | 32,689,110 | 172,558,444 | 161 | 383 | 0 | 87.26 | 18.31 | 6 | 89.79 | 68 | 132 | 68 | 1 | 75 | 16,059,916 | 40 | 129 | 1,157,000 | 9.17 | 26 | 106 | 1 | 68 | 
| pairing | 1 | 194 | 617 | 22,314,288 | 119,958,502 | 194 | 322 | 1 | 69.95 | 13.91 | 6 | 64.72 | 66 | 115 | 66 | 0 | 55 | 9,408,294 | 47 | 59 | 588,742 | 18 | 20 | 84 | 1 | 66 | 

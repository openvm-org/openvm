...
|:---|---:|---:|
| Total | <span style='color: red'>(+0 [+1.6%])</span> 2.34 | <span style='color: red'>(+0 [+0.7%])</span> 0.74 |
| regex_program | <span style='color: red'>(+0 [+1.2%])</span> 2.30 | <span style='color: green'>(-0 [-0.4%])</span> 0.69 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+7 [+1.2%])</span> 574.75 | <span style='color: red'>(+28 [+1.2%])</span> 2,299 | <span style='color: green'>(-3 [-0.4%])</span> 694 | <span style='color: red'>(+20 [+3.9%])</span> 532 |
...
| `execute_metered_insn_mi/s` | <span style='color: green'>(-24 [-19.6%])</span> 99.28 | -          | <span style='color: green'>(-24 [-19.6%])</span> 99.28 | <span style='color: green'>(-24 [-19.6%])</span> 99.28 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` | <span style='color: red'>(+1 [+1.4%])</span> 54.75 | <span style='color: red'>(+3 [+1.4%])</span> 219 | <span style='color: red'>(+1 [+1.5%])</span> 66 | <span style='color: red'>(+1 [+2.2%])</span> 46 |
| `execute_preflight_insn_mi/s` | <span style='color: green'>(-1 [-2.0%])</span> 30.02 | -          | <span style='color: green'>(-0 [-0.8%])</span> 31.69 | <span style='color: green'>(-1 [-3.7%])</span> 26.21 |
| `trace_gen_time_ms   ` | <span style='color: green'>(-1 [-0.6%])</span> 173 | <span style='color: green'>(-4 [-0.6%])</span> 692 | <span style='color: green'>(-2 [-1.0%])</span> 204 | <span style='color: red'>(+1 [+0.7%])</span> 151 |
...
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+7 [+2.7%])</span> 279.75 | <span style='color: red'>(+29 [+2.7%])</span> 1,119 | <span style='color: green'>(-1 [-0.3%])</span> 298 | <span style='color: red'>(+14 [+5.5%])</span> 267 |
| `main_trace_commit_time_ms` |  51.25 |  205 | <span style='color: green'>(-1 [-1.8%])</span> 55 | <span style='color: red'>(+1 [+2.0%])</span> 50 |
| `generate_perm_trace_time_ms` |  22.75 |  91 | <span style='color: green'>(-5 [-15.6%])</span> 27 |  18 |
| `perm_trace_commit_time_ms` | <span style='color: red'>(+0 [+0.4%])</span> 63.74 | <span style='color: red'>(+1 [+0.4%])</span> 254.94 | <span style='color: red'>(+1 [+2.0%])</span> 70.44 | <span style='color: green'>(-0 [-0.1%])</span> 54.99 |
| `quotient_poly_compute_time_ms` | <span style='color: green'>(-1 [-1.1%])</span> 57 | <span style='color: green'>(-2 [-1.1%])</span> 228.02 | <span style='color: green'>(-0 [-0.4%])</span> 67.85 | <span style='color: red'>(+1 [+1.2%])</span> 51.48 |
| `quotient_poly_commit_time_ms` | <span style='color: green'>(-0 [-2.4%])</span> 14.61 | <span style='color: green'>(-1 [-2.4%])</span> 58.43 | <span style='color: green'>(-1 [-7.5%])</span> 16.04 | <span style='color: green'>(-0 [-1.7%])</span> 12.80 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+8 [+14.4%])</span> 67.50 | <span style='color: red'>(+34 [+14.4%])</span> 270 | <span style='color: red'>(+1 [+1.4%])</span> 72 | <span style='color: red'>(+7 [+14.0%])</span> 57 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 533 | 40 | 1 | 41 | 4,137,502 | 99.28 | 166 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 204 | 694 | 23,446,148 | 150,778,428 | 204 | 298 | 0 | 56.85 | 16.04 | 5 | 70.44 | 70 | 99 | 70 | 4 | 55 | 10,899,170 | 27 | 48 | 1,103,000 | 26.21 | 21 | 73 | 1 | 70 | 
| regex_program | 1 | 151 | 532 | 11,598,276 | 128,513,066 | 151 | 273 | 1 | 51.48 | 14.86 | 4 | 65.21 | 71 | 84 | 71 | 0 | 50 | 2,196,106 | 18 | 66 | 1,104,000 | 30.83 | 16 | 66 | 0 | 71 | 
| regex_program | 2 | 158 | 540 | 11,579,064 | 128,513,066 | 158 | 281 | 1 | 51.83 | 14.73 | 4 | 64.30 | 72 | 91 | 72 | 0 | 50 | 2,177,334 | 27 | 59 | 1,104,000 | 31.33 | 16 | 67 | 0 | 72 | 
| regex_program | 3 | 179 | 533 | 11,853,872 | 103,456,394 | 179 | 267 | 0 | 67.85 | 12.80 | 5 | 54.99 | 57 | 77 | 57 | 0 | 50 | 2,422,606 | 19 | 46 | 826,502 | 31.69 | 18 | 81 | 1 | 57 | 

...
|:---|---:|---:|
| Total | <span style='color: red'>(+0 [+2.8%])</span> 1.56 | <span style='color: red'>(+0 [+1.4%])</span> 0.92 |
| pairing | <span style='color: red'>(+0 [+2.9%])</span> 1.47 | <span style='color: red'>(+0 [+1.6%])</span> 0.83 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+21 [+2.9%])</span> 736.50 | <span style='color: red'>(+42 [+2.9%])</span> 1,473 | <span style='color: red'>(+13 [+1.6%])</span> 831 | <span style='color: red'>(+29 [+4.7%])</span> 642 |
...
| `execute_metered_insn_mi/s` | <span style='color: red'>(+0 [+0.2%])</span> 19.37 | -          | <span style='color: red'>(+0 [+0.2%])</span> 19.37 | <span style='color: red'>(+0 [+0.2%])</span> 19.37 |
...
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+1 [+6.2%])</span> 13.79 | -          | <span style='color: red'>(+1 [+8.3%])</span> 18.29 | <span style='color: red'>(+0 [+2.3%])</span> 9.28 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+4 [+2.0%])</span> 182 | <span style='color: red'>(+7 [+2.0%])</span> 364 | <span style='color: red'>(+3 [+1.5%])</span> 198 | <span style='color: red'>(+4 [+2.5%])</span> 166 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+20 [+5.6%])</span> 368 | <span style='color: red'>(+39 [+5.6%])</span> 736 | <span style='color: red'>(+11 [+2.9%])</span> 393 | <span style='color: red'>(+28 [+8.9%])</span> 343 |
| `main_trace_commit_time_ms` |  65.50 |  131 | <span style='color: red'>(+1 [+1.3%])</span> 76 | <span style='color: green'>(-1 [-1.8%])</span> 55 |
| `generate_perm_trace_time_ms` | <span style='color: red'>(+10 [+26.4%])</span> 45.50 | <span style='color: red'>(+19 [+26.4%])</span> 91 | <span style='color: red'>(+8 [+20.0%])</span> 48 | <span style='color: red'>(+11 [+34.4%])</span> 43 |
| `perm_trace_commit_time_ms` |  78.09 |  156.18 | <span style='color: red'>(+1 [+0.8%])</span> 90.89 | <span style='color: green'>(-1 [-1.1%])</span> 65.29 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+0 [+0.3%])</span> 80.50 | <span style='color: red'>(+1 [+0.3%])</span> 161 | <span style='color: green'>(-0 [-0.5%])</span> 88.55 | <span style='color: red'>(+1 [+1.3%])</span> 72.45 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+1 [+4.5%])</span> 17.25 | <span style='color: red'>(+1 [+4.5%])</span> 34.50 | <span style='color: red'>(+1 [+6.9%])</span> 19.24 | <span style='color: red'>(+0 [+1.7%])</span> 15.26 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+10 [+14.2%])</span> 76.50 | <span style='color: red'>(+19 [+14.2%])</span> 153 | <span style='color: red'>(+12 [+17.1%])</span> 82 | <span style='color: red'>(+7 [+10.9%])</span> 71 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 642 | 40 | 1 | 90 | 1,745,742 | 19.37 | 144 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 166 | 831 | 32,689,110 | 172,558,444 | 166 | 393 | 0 | 88.55 | 19.24 | 6 | 90.89 | 71 | 136 | 71 | 1 | 76 | 16,059,916 | 43 | 128 | 1,157,000 | 9.28 | 26 | 108 | 1 | 71 | 
| pairing | 1 | 198 | 642 | 22,314,288 | 119,958,502 | 198 | 343 | 1 | 72.45 | 15.26 | 6 | 65.29 | 82 | 117 | 82 | 0 | 55 | 9,408,294 | 48 | 59 | 588,742 | 18.29 | 21 | 88 | 1 | 82 | 

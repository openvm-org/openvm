...
|:---|---:|---:|
| Total | <span style='color: red'>(+0 [+0.9%])</span> 1.54 | <span style='color: red'>(+0 [+2.0%])</span> 0.93 |
| pairing | <span style='color: red'>(+0 [+1.0%])</span> 1.45 | <span style='color: red'>(+0 [+2.2%])</span> 0.84 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+7 [+1.0%])</span> 722.50 | <span style='color: red'>(+14 [+1.0%])</span> 1,445 | <span style='color: red'>(+18 [+2.2%])</span> 836 | <span style='color: green'>(-4 [-0.7%])</span> 609 |
...
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+1 [+6.4%])</span> 13.82 | -          | <span style='color: red'>(+2 [+9.1%])</span> 18.43 | <span style='color: red'>(+0 [+1.4%])</span> 9.20 |
| `trace_gen_time_ms   ` | <span style='color: green'>(-0 [-0.3%])</span> 178 | <span style='color: green'>(-1 [-0.3%])</span> 356 |  195 | <span style='color: green'>(-1 [-0.6%])</span> 161 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+8 [+2.3%])</span> 356.50 | <span style='color: red'>(+16 [+2.3%])</span> 713 | <span style='color: red'>(+19 [+5.0%])</span> 401 | <span style='color: green'>(-3 [-1.0%])</span> 312 |
...
| `generate_perm_trace_time_ms` | <span style='color: red'>(+6 [+16.7%])</span> 42 | <span style='color: red'>(+12 [+16.7%])</span> 84 | <span style='color: red'>(+8 [+20.0%])</span> 48 | <span style='color: red'>(+4 [+12.5%])</span> 36 |
| `perm_trace_commit_time_ms` | <span style='color: green'>(-2 [-2.2%])</span> 76.40 | <span style='color: green'>(-3 [-2.2%])</span> 152.80 | <span style='color: green'>(-1 [-1.2%])</span> 89.04 | <span style='color: green'>(-2 [-3.4%])</span> 63.75 |
| `quotient_poly_compute_time_ms` | <span style='color: green'>(-1 [-1.2%])</span> 79.28 | <span style='color: green'>(-2 [-1.2%])</span> 158.56 | <span style='color: green'>(-2 [-1.8%])</span> 87.40 | <span style='color: green'>(-0 [-0.5%])</span> 71.16 |
| `quotient_poly_commit_time_ms` | <span style='color: green'>(-0 [-2.7%])</span> 16.07 | <span style='color: green'>(-1 [-2.7%])</span> 32.13 | <span style='color: green'>(-1 [-3.1%])</span> 17.44 | <span style='color: green'>(-0 [-2.1%])</span> 14.69 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+8 [+11.2%])</span> 74.50 | <span style='color: red'>(+15 [+11.2%])</span> 149 | <span style='color: red'>(+10 [+14.3%])</span> 80 | <span style='color: red'>(+5 [+7.8%])</span> 69 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 609 | 40 | 1 | 90 | 1,745,742 | 19.35 | 145 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 161 | 836 | 32,689,110 | 172,558,444 | 161 | 401 | 0 | 87.40 | 17.44 | 6 | 89.04 | 80 | 140 | 79 | 1 | 75 | 16,059,916 | 48 | 129 | 1,157,000 | 9.20 | 26 | 105 | 1 | 79 | 
| pairing | 1 | 195 | 609 | 22,314,288 | 119,958,502 | 195 | 312 | 1 | 71.16 | 14.69 | 6 | 63.75 | 69 | 103 | 68 | 0 | 53 | 9,408,294 | 36 | 60 | 588,742 | 18.43 | 21 | 86 | 1 | 68 | 

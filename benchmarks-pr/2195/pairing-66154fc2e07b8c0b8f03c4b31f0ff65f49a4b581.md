...
|:---|---:|---:|
| Total | <span style='color: red'>(+0 [+3.2%])</span> 1.57 | <span style='color: green'>(-0 [-0.6%])</span> 0.90 |
| pairing | <span style='color: red'>(+0 [+3.4%])</span> 1.48 | <span style='color: green'>(-0 [-0.7%])</span> 0.81 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+24 [+3.4%])</span> 739.50 | <span style='color: red'>(+48 [+3.4%])</span> 1,479 | <span style='color: green'>(-6 [-0.7%])</span> 812 | <span style='color: red'>(+54 [+8.8%])</span> 667 |
...
| `execute_metered_insn_mi/s` | <span style='color: green'>(-0 [-1.5%])</span> 19.05 | -          | <span style='color: green'>(-0 [-1.5%])</span> 19.05 | <span style='color: green'>(-0 [-1.5%])</span> 19.05 |
...
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+1 [+7.0%])</span> 13.89 | -          | <span style='color: red'>(+2 [+9.5%])</span> 18.50 | <span style='color: red'>(+0 [+2.3%])</span> 9.28 |
| `trace_gen_time_ms   ` | <span style='color: green'>(-0 [-0.3%])</span> 178 | <span style='color: green'>(-1 [-0.3%])</span> 356 | <span style='color: green'>(-2 [-1.0%])</span> 193 | <span style='color: red'>(+1 [+0.6%])</span> 163 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+26 [+7.6%])</span> 375 | <span style='color: red'>(+53 [+7.6%])</span> 750 | <span style='color: green'>(-6 [-1.6%])</span> 376 | <span style='color: red'>(+59 [+18.7%])</span> 374 |
...
| `generate_perm_trace_time_ms` | <span style='color: red'>(+19 [+52.8%])</span> 55 | <span style='color: red'>(+38 [+52.8%])</span> 110 | <span style='color: red'>(+31 [+77.5%])</span> 71 | <span style='color: red'>(+7 [+21.9%])</span> 39 |
| `perm_trace_commit_time_ms` | <span style='color: green'>(-2 [-2.6%])</span> 76.02 | <span style='color: green'>(-4 [-2.6%])</span> 152.04 | <span style='color: green'>(-2 [-2.3%])</span> 88.11 | <span style='color: green'>(-2 [-3.2%])</span> 63.93 |
| `quotient_poly_compute_time_ms` | <span style='color: green'>(-2 [-2.6%])</span> 78.14 | <span style='color: green'>(-4 [-2.6%])</span> 156.27 | <span style='color: green'>(-2 [-2.3%])</span> 86.90 | <span style='color: green'>(-2 [-3.0%])</span> 69.37 |
| `quotient_poly_commit_time_ms` | <span style='color: green'>(-1 [-3.4%])</span> 15.94 | <span style='color: green'>(-1 [-3.4%])</span> 31.88 | <span style='color: green'>(-1 [-3.4%])</span> 17.40 | <span style='color: green'>(-1 [-3.5%])</span> 14.49 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+15 [+22.4%])</span> 82 | <span style='color: red'>(+30 [+22.4%])</span> 164 | <span style='color: red'>(+28 [+40.0%])</span> 98 | <span style='color: red'>(+2 [+3.1%])</span> 66 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 667 | 66 | 1 | 91 | 1,745,742 | 19.05 | 171 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 163 | 812 | 32,689,110 | 172,558,444 | 163 | 376 | 0 | 86.90 | 17.40 | 6 | 88.11 | 66 | 130 | 66 | 1 | 74 | 16,059,916 | 39 | 128 | 1,157,000 | 9.28 | 26 | 105 | 1 | 66 | 
| pairing | 1 | 193 | 667 | 22,314,288 | 119,958,502 | 193 | 374 | 1 | 69.37 | 14.49 | 5 | 63.93 | 98 | 137 | 98 | 0 | 53 | 9,408,294 | 71 | 59 | 588,742 | 18.50 | 20 | 84 | 1 | 98 | 

...
|:---|---:|---:|
| Total | <span style='color: green'>(-0 [-2.6%])</span> 0.99 | <span style='color: green'>(-0 [-3.9%])</span> 0.56 |
| fibonacci_program | <span style='color: green'>(-0 [-2.6%])</span> 0.98 | <span style='color: green'>(-0 [-4.0%])</span> 0.55 |


| fibonacci_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: green'>(-13 [-2.6%])</span> 490 | <span style='color: green'>(-26 [-2.6%])</span> 980 | <span style='color: green'>(-23 [-4.0%])</span> 554 | <span style='color: green'>(-3 [-0.7%])</span> 426 |
...
| `execute_metered_insn_mi/s` | <span style='color: red'>(+1 [+0.7%])</span> 147.79 | -          | <span style='color: red'>(+1 [+0.7%])</span> 147.79 | <span style='color: red'>(+1 [+0.7%])</span> 147.79 |
...
| `execute_preflight_insn_mi/s` | <span style='color: green'>(-0 [-1.2%])</span> 37.09 | -          | <span style='color: green'>(-1 [-1.4%])</span> 38.98 | <span style='color: green'>(-0 [-1.0%])</span> 35.20 |
...
| `stark_prove_excluding_trace_time_ms` | <span style='color: green'>(-18 [-9.6%])</span> 175 | <span style='color: green'>(-37 [-9.6%])</span> 350 | <span style='color: green'>(-29 [-13.6%])</span> 185 | <span style='color: green'>(-8 [-4.6%])</span> 165 |
...
| `generate_perm_trace_time_ms` | <span style='color: green'>(-5 [-25.6%])</span> 14.50 | <span style='color: green'>(-10 [-25.6%])</span> 29 | <span style='color: green'>(-4 [-19.0%])</span> 17 | <span style='color: green'>(-6 [-33.3%])</span> 12 |
| `perm_trace_commit_time_ms` | <span style='color: red'>(+0 [+0.6%])</span> 41.37 | <span style='color: red'>(+1 [+0.6%])</span> 82.73 | <span style='color: red'>(+1 [+2.1%])</span> 44.67 | <span style='color: green'>(-0 [-1.0%])</span> 38.07 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+0 [+0.6%])</span> 32.07 | <span style='color: red'>(+0 [+0.6%])</span> 64.15 | <span style='color: green'>(-1 [-1.9%])</span> 33.66 | <span style='color: red'>(+1 [+3.4%])</span> 30.49 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+1 [+8.2%])</span> 12.57 | <span style='color: red'>(+2 [+8.2%])</span> 25.15 | <span style='color: red'>(+1 [+7.5%])</span> 12.88 | <span style='color: red'>(+1 [+8.9%])</span> 12.27 |
| `pcs_opening_time_ms ` | <span style='color: green'>(-15 [-26.3%])</span> 42 | <span style='color: green'>(-30 [-26.3%])</span> 84 | <span style='color: green'>(-29 [-40.8%])</span> 42 | <span style='color: green'>(-1 [-2.3%])</span> 42 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 426 | 68 | 1 | 10 | 1,500,209 | 147.79 | 168 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 197 | 554 | 9,677,708 | 84,395,212 | 197 | 185 | 0 | 33.66 | 12.88 | 4 | 44.67 | 42 | 62 | 42 | 0 | 33 | 1,035,986 | 17 | 25 | 873,000 | 35.20 | 14 | 47 | 0 | 42 | 
| fibonacci_program | 1 | 187 | 426 | 9,708,170 | 74,305,770 | 187 | 165 | 1 | 30.49 | 12.27 | 5 | 38.07 | 42 | 50 | 42 | 0 | 28 | 1,064,416 | 12 | 32 | 627,209 | 38.98 | 11 | 43 | 0 | 42 | 

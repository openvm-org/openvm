...
|:---|---:|---:|
| Total | <span style='color: green'>(-0 [-0.2%])</span> 2.38 | <span style='color: green'>(-0 [-1.6%])</span> 0.76 |
| regex_program | <span style='color: green'>(-0 [-0.3%])</span> 2.34 | <span style='color: green'>(-0 [-2.2%])</span> 0.72 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: green'>(-2 [-0.3%])</span> 585.25 | <span style='color: green'>(-8 [-0.3%])</span> 2,341 | <span style='color: green'>(-16 [-2.2%])</span> 722 | <span style='color: green'>(-1 [-0.2%])</span> 535 |
...
| `execute_metered_insn_mi/s` | <span style='color: green'>(-11 [-9.5%])</span> 107.40 | -          | <span style='color: green'>(-11 [-9.5%])</span> 107.40 | <span style='color: green'>(-11 [-9.5%])</span> 107.40 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` | <span style='color: green'>(-0 [-0.5%])</span> 53.25 | <span style='color: green'>(-1 [-0.5%])</span> 213 |  65 | <span style='color: green'>(-1 [-2.2%])</span> 44 |
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+1 [+2.5%])</span> 31.76 | -          | <span style='color: red'>(+1 [+3.0%])</span> 33.09 | <span style='color: red'>(+1 [+1.8%])</span> 28.59 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+0 [+0.1%])</span> 177.50 | <span style='color: red'>(+1 [+0.1%])</span> 710 |  210 | <span style='color: red'>(+1 [+0.6%])</span> 155 |
| `memory_finalize_time_ms` |  1 |  4 |  4 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: green'>(-2 [-0.6%])</span> 287 | <span style='color: green'>(-7 [-0.6%])</span> 1,148 | <span style='color: green'>(-15 [-4.5%])</span> 322 | <span style='color: red'>(+3 [+1.1%])</span> 269 |
...
| `generate_perm_trace_time_ms` | <span style='color: red'>(+1 [+2.2%])</span> 34.50 | <span style='color: red'>(+3 [+2.2%])</span> 138 |  54 |  19 |
| `perm_trace_commit_time_ms` | <span style='color: red'>(+0 [+0.7%])</span> 63.97 | <span style='color: red'>(+2 [+0.7%])</span> 255.87 | <span style='color: red'>(+2 [+3.1%])</span> 70.30 | <span style='color: red'>(+1 [+2.1%])</span> 55.86 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+1 [+2.0%])</span> 58.36 | <span style='color: red'>(+5 [+2.0%])</span> 233.44 | <span style='color: green'>(-1 [-0.7%])</span> 69.60 | <span style='color: red'>(+0 [+0.3%])</span> 51.67 |
| `quotient_poly_commit_time_ms` | <span style='color: green'>(-0 [-1.8%])</span> 14.84 | <span style='color: green'>(-1 [-1.8%])</span> 59.36 | <span style='color: green'>(-1 [-3.6%])</span> 17.06 | <span style='color: red'>(+0 [+3.6%])</span> 13.02 |
| `pcs_opening_time_ms ` | <span style='color: green'>(-5 [-7.3%])</span> 60.25 | <span style='color: green'>(-19 [-7.3%])</span> 241 | <span style='color: green'>(-21 [-25.3%])</span> 62 |  56 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 538 | 1 | 38 | 4,137,502 | 107.40 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 210 | 722 | 23,446,148 | 150,778,428 | 210 | 322 | 0 | 59.64 | 17.06 | 5 | 70.30 | 61 | 125 | 61 | 4 | 56 | 10,899,170 | 54 | 46 | 1,103,000 | 28.59 | 21 | 77 | 1 | 61 | 
| regex_program | 1 | 155 | 546 | 11,598,276 | 128,513,066 | 155 | 284 | 1 | 51.67 | 14.74 | 4 | 65.08 | 62 | 104 | 62 | 0 | 50 | 2,196,106 | 38 | 65 | 1,104,000 | 32.59 | 16 | 66 | 0 | 62 | 
| regex_program | 2 | 163 | 535 | 11,579,064 | 128,513,066 | 162 | 273 | 1 | 52.53 | 14.54 | 4 | 64.63 | 62 | 92 | 61 | 0 | 51 | 2,177,334 | 27 | 58 | 1,104,000 | 32.78 | 16 | 67 | 0 | 61 | 
| regex_program | 3 | 182 | 538 | 11,853,872 | 103,456,394 | 182 | 269 | 0 | 69.60 | 13.02 | 5 | 55.86 | 56 | 78 | 56 | 0 | 50 | 2,422,606 | 19 | 44 | 826,502 | 33.09 | 18 | 83 | 1 | 56 | 
...
Commit: https://github.com/openvm-org/openvm/commit/2f2bcf080bbe55f12039b333564332d156984784
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19345285097)

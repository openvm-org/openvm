...
|:---|---:|---:|
| Total | <span style='color: green'>(-0 [-1.5%])</span> 2.35 | <span style='color: green'>(-0 [-6.3%])</span> 0.72 |
| regex_program | <span style='color: green'>(-0 [-1.6%])</span> 2.31 | <span style='color: green'>(-0 [-6.9%])</span> 0.69 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: green'>(-9 [-1.6%])</span> 578 | <span style='color: green'>(-37 [-1.6%])</span> 2,312 | <span style='color: green'>(-51 [-6.9%])</span> 687 |  536 |
...
| `execute_metered_insn_mi/s` | <span style='color: green'>(-5 [-4.5%])</span> 113.37 | -          | <span style='color: green'>(-5 [-4.5%])</span> 113.37 | <span style='color: green'>(-5 [-4.5%])</span> 113.37 |
...
| `execute_preflight_insn_mi/s` | <span style='color: green'>(-0 [-0.3%])</span> 30.89 | -          | <span style='color: green'>(-0 [-0.6%])</span> 31.93 | <span style='color: green'>(-0 [-0.6%])</span> 27.92 |
| `trace_gen_time_ms   ` | <span style='color: green'>(-1 [-0.4%])</span> 176.50 | <span style='color: green'>(-3 [-0.4%])</span> 706 | <span style='color: green'>(-2 [-1.0%])</span> 208 | <span style='color: red'>(+1 [+0.6%])</span> 155 |
| `memory_finalize_time_ms` |  1 |  4 |  4 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: green'>(-9 [-3.1%])</span> 279.75 | <span style='color: green'>(-36 [-3.1%])</span> 1,119 | <span style='color: green'>(-49 [-14.5%])</span> 288 | <span style='color: red'>(+4 [+1.5%])</span> 270 |
| `main_trace_commit_time_ms` | <span style='color: red'>(+0 [+1.0%])</span> 51.50 | <span style='color: red'>(+2 [+1.0%])</span> 206 |  57 |  49 |
| `generate_perm_trace_time_ms` | <span style='color: green'>(-7 [-20.7%])</span> 26.75 | <span style='color: green'>(-28 [-20.7%])</span> 107 | <span style='color: green'>(-17 [-31.5%])</span> 37 | <span style='color: red'>(+1 [+5.3%])</span> 20 |
| `perm_trace_commit_time_ms` | <span style='color: red'>(+1 [+1.6%])</span> 64.57 | <span style='color: red'>(+4 [+1.6%])</span> 258.27 | <span style='color: red'>(+4 [+5.2%])</span> 71.67 | <span style='color: green'>(-0 [-0.2%])</span> 54.59 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+1 [+1.6%])</span> 58.13 | <span style='color: red'>(+4 [+1.6%])</span> 232.54 | <span style='color: red'>(+2 [+2.2%])</span> 71.63 | <span style='color: red'>(+1 [+1.9%])</span> 52.49 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+0 [+0.2%])</span> 15.14 | <span style='color: red'>(+0 [+0.2%])</span> 60.55 | <span style='color: green'>(-1 [-4.8%])</span> 16.85 | <span style='color: red'>(+0 [+2.1%])</span> 12.82 |
| `pcs_opening_time_ms ` | <span style='color: green'>(-5 [-7.3%])</span> 60.25 | <span style='color: green'>(-19 [-7.3%])</span> 241 | <span style='color: green'>(-21 [-25.3%])</span> 62 | <span style='color: red'>(+1 [+1.8%])</span> 57 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 540 | 1 | 36 | 4,137,502 | 113.37 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 208 | 687 | 23,446,148 | 150,778,428 | 208 | 288 | 0 | 55.59 | 16.85 | 5 | 71.67 | 61 | 95 | 61 | 4 | 57 | 10,899,170 | 22 | 46 | 1,103,000 | 27.92 | 21 | 73 | 1 | 61 | 
| regex_program | 1 | 155 | 549 | 11,598,276 | 128,513,066 | 155 | 286 | 1 | 52.83 | 15.32 | 4 | 65.59 | 62 | 103 | 62 | 0 | 51 | 2,196,106 | 37 | 65 | 1,104,000 | 31.83 | 16 | 68 | 0 | 62 | 
| regex_program | 2 | 161 | 536 | 11,579,064 | 128,513,066 | 161 | 275 | 1 | 52.49 | 15.56 | 4 | 66.41 | 61 | 95 | 61 | 0 | 49 | 2,177,334 | 28 | 59 | 1,104,000 | 31.88 | 16 | 68 | 0 | 61 | 
| regex_program | 3 | 182 | 540 | 11,853,872 | 103,456,394 | 182 | 270 | 0 | 71.63 | 12.82 | 5 | 54.59 | 57 | 78 | 56 | 0 | 49 | 2,422,606 | 20 | 45 | 826,502 | 31.93 | 18 | 85 | 1 | 56 | 

...
|:---|---:|---:|
| Total | <span style='color: red'>(+0 [+1.1%])</span> 2.41 | <span style='color: red'>(+0 [+0.5%])</span> 0.78 |
| regex_program | <span style='color: red'>(+0 [+1.1%])</span> 2.37 | <span style='color: red'>(+0 [+0.3%])</span> 0.74 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+6 [+1.1%])</span> 593.50 | <span style='color: red'>(+25 [+1.1%])</span> 2,374 | <span style='color: red'>(+2 [+0.3%])</span> 740 | <span style='color: red'>(+4 [+0.7%])</span> 540 |
...
| `execute_metered_insn_mi/s` | <span style='color: green'>(-7 [-5.6%])</span> 112.05 | -          | <span style='color: green'>(-7 [-5.6%])</span> 112.05 | <span style='color: green'>(-7 [-5.6%])</span> 112.05 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` | <span style='color: red'>(+2 [+3.3%])</span> 55.25 | <span style='color: red'>(+7 [+3.3%])</span> 221 | <span style='color: red'>(+4 [+6.2%])</span> 69 |  45 |
| `execute_preflight_insn_mi/s` |  30.97 | -          | <span style='color: red'>(+0 [+0.1%])</span> 32.16 | <span style='color: green'>(-0 [-1.0%])</span> 27.80 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+0 [+0.3%])</span> 177.75 | <span style='color: red'>(+2 [+0.3%])</span> 711 |  210 |  154 |
| `memory_finalize_time_ms` |  1 |  4 |  4 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+4 [+1.3%])</span> 292.50 | <span style='color: red'>(+15 [+1.3%])</span> 1,170 | <span style='color: red'>(+1 [+0.3%])</span> 338 | <span style='color: red'>(+4 [+1.5%])</span> 270 |
| `main_trace_commit_time_ms` | <span style='color: red'>(+1 [+2.0%])</span> 52 | <span style='color: red'>(+4 [+2.0%])</span> 208 | <span style='color: green'>(-2 [-3.5%])</span> 55 | <span style='color: red'>(+2 [+4.1%])</span> 51 |
| `generate_perm_trace_time_ms` | <span style='color: red'>(+0 [+1.5%])</span> 34.25 | <span style='color: red'>(+2 [+1.5%])</span> 137 |  54 |  19 |
| `perm_trace_commit_time_ms` | <span style='color: red'>(+1 [+1.7%])</span> 64.65 | <span style='color: red'>(+4 [+1.7%])</span> 258.62 | <span style='color: red'>(+3 [+4.0%])</span> 70.88 | <span style='color: red'>(+1 [+2.7%])</span> 56.16 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+2 [+3.2%])</span> 59.07 | <span style='color: red'>(+7 [+3.2%])</span> 236.29 | <span style='color: green'>(-1 [-1.3%])</span> 69.21 | <span style='color: red'>(+2 [+4.4%])</span> 53.77 |
| `quotient_poly_commit_time_ms` | <span style='color: green'>(-0 [-0.6%])</span> 15.02 | <span style='color: green'>(-0 [-0.6%])</span> 60.09 | <span style='color: green'>(-0 [-2.4%])</span> 17.28 | <span style='color: red'>(+0 [+3.1%])</span> 12.94 |
| `pcs_opening_time_ms ` | <span style='color: green'>(-1 [-1.2%])</span> 64.25 | <span style='color: green'>(-3 [-1.2%])</span> 257 | <span style='color: green'>(-5 [-6.0%])</span> 78 |  56 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 542 | 1 | 36 | 4,137,502 | 112.05 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 210 | 740 | 23,446,148 | 150,778,428 | 210 | 338 | 0 | 59.49 | 17.28 | 5 | 70.88 | 78 | 126 | 78 | 4 | 55 | 10,899,170 | 54 | 47 | 1,103,000 | 27.80 | 22 | 77 | 1 | 78 | 
| regex_program | 1 | 154 | 552 | 11,598,276 | 128,513,066 | 154 | 287 | 1 | 53.82 | 15.17 | 4 | 66.12 | 62 | 104 | 62 | 0 | 51 | 2,196,106 | 37 | 69 | 1,104,000 | 31.82 | 16 | 69 | 0 | 62 | 
| regex_program | 2 | 162 | 540 | 11,579,064 | 128,513,066 | 162 | 275 | 1 | 53.77 | 14.70 | 4 | 65.46 | 61 | 93 | 61 | 0 | 51 | 2,177,334 | 27 | 60 | 1,104,000 | 32.10 | 16 | 69 | 0 | 61 | 
| regex_program | 3 | 185 | 542 | 11,853,872 | 103,456,394 | 185 | 270 | 0 | 69.21 | 12.94 | 5 | 56.16 | 56 | 78 | 56 | 0 | 51 | 2,422,606 | 19 | 45 | 826,502 | 32.16 | 18 | 83 | 1 | 56 | 

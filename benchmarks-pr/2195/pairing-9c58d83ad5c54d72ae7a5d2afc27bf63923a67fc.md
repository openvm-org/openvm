...
|:---|---:|---:|
| Total | <span style='color: red'>(+0 [+1.9%])</span> 1.55 | <span style='color: red'>(+0 [+3.2%])</span> 0.94 |
| pairing | <span style='color: red'>(+0 [+2.0%])</span> 1.46 | <span style='color: red'>(+0 [+3.5%])</span> 0.85 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+14 [+2.0%])</span> 730 | <span style='color: red'>(+29 [+2.0%])</span> 1,460 | <span style='color: red'>(+29 [+3.5%])</span> 847 |  613 |
...
| `execute_metered_insn_mi/s` | <span style='color: green'>(-0 [-0.5%])</span> 19.24 | -          | <span style='color: green'>(-0 [-0.5%])</span> 19.24 | <span style='color: green'>(-0 [-0.5%])</span> 19.24 |
| `execute_preflight_insns` |  872,871 |  1,745,742 |  1,157,000 |  588,742 |
| `execute_preflight_time_ms` | <span style='color: green'>(-2 [-2.1%])</span> 94.50 | <span style='color: green'>(-4 [-2.1%])</span> 189 | <span style='color: green'>(-2 [-1.5%])</span> 129 | <span style='color: green'>(-2 [-3.2%])</span> 60 |
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+1 [+4.3%])</span> 13.55 | -          | <span style='color: red'>(+1 [+5.9%])</span> 17.89 | <span style='color: red'>(+0 [+1.4%])</span> 9.20 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+0 [+0.3%])</span> 179 | <span style='color: red'>(+1 [+0.3%])</span> 358 |  195 | <span style='color: red'>(+1 [+0.6%])</span> 163 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+14 [+4.2%])</span> 363 | <span style='color: red'>(+29 [+4.2%])</span> 726 | <span style='color: red'>(+28 [+7.3%])</span> 410 | <span style='color: red'>(+1 [+0.3%])</span> 316 |
| `main_trace_commit_time_ms` | <span style='color: green'>(-4 [-5.3%])</span> 62 | <span style='color: green'>(-7 [-5.3%])</span> 124 | <span style='color: green'>(-4 [-5.3%])</span> 71 | <span style='color: green'>(-3 [-5.4%])</span> 53 |
| `generate_perm_trace_time_ms` | <span style='color: green'>(-1 [-2.8%])</span> 35 | <span style='color: green'>(-2 [-2.8%])</span> 70 | <span style='color: green'>(-3 [-7.5%])</span> 37 | <span style='color: red'>(+1 [+3.1%])</span> 33 |
| `perm_trace_commit_time_ms` | <span style='color: green'>(-1 [-1.7%])</span> 76.73 | <span style='color: green'>(-3 [-1.7%])</span> 153.45 | <span style='color: green'>(-1 [-1.3%])</span> 88.93 | <span style='color: green'>(-1 [-2.3%])</span> 64.52 |
| `quotient_poly_compute_time_ms` | <span style='color: green'>(-1 [-1.0%])</span> 79.45 | <span style='color: green'>(-2 [-1.0%])</span> 158.90 | <span style='color: green'>(-1 [-1.1%])</span> 88.03 | <span style='color: green'>(-1 [-0.9%])</span> 70.88 |
| `quotient_poly_commit_time_ms` | <span style='color: green'>(-1 [-4.4%])</span> 15.77 | <span style='color: green'>(-1 [-4.4%])</span> 31.55 | <span style='color: green'>(-1 [-3.2%])</span> 17.44 | <span style='color: green'>(-1 [-6.0%])</span> 14.11 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+22 [+33.6%])</span> 89.50 | <span style='color: red'>(+45 [+33.6%])</span> 179 | <span style='color: red'>(+33 [+47.1%])</span> 103 | <span style='color: red'>(+12 [+18.8%])</span> 76 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 613 | 66 | 1 | 90 | 1,745,742 | 19.24 | 171 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 163 | 847 | 32,689,110 | 172,558,444 | 163 | 410 | 0 | 88.03 | 17.44 | 6 | 88.93 | 103 | 129 | 103 | 1 | 71 | 16,059,916 | 37 | 129 | 1,157,000 | 9.20 | 26 | 106 | 1 | 103 | 
| pairing | 1 | 195 | 613 | 22,314,288 | 119,958,502 | 195 | 316 | 1 | 70.88 | 14.11 | 6 | 64.52 | 76 | 101 | 75 | 0 | 53 | 9,408,294 | 33 | 60 | 588,742 | 17.89 | 20 | 85 | 1 | 75 | 

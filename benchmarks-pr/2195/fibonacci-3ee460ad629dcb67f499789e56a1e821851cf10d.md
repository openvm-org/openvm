...
|:---|---:|---:|
| Total | <span style='color: red'>(+0 [+0.1%])</span> 0.98 |  0.56 |
| fibonacci_program | <span style='color: green'>(-0 [-0.3%])</span> 0.97 | <span style='color: green'>(-0 [-0.7%])</span> 0.55 |


| fibonacci_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: green'>(-2 [-0.3%])</span> 484.50 | <span style='color: green'>(-3 [-0.3%])</span> 969 | <span style='color: green'>(-4 [-0.7%])</span> 548 | <span style='color: red'>(+1 [+0.2%])</span> 421 |
...
| `execute_metered_insn_mi/s` | <span style='color: green'>(-42 [-28.7%])</span> 105.52 | -          | <span style='color: green'>(-42 [-28.7%])</span> 105.52 | <span style='color: green'>(-42 [-28.7%])</span> 105.52 |
...
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+1 [+1.4%])</span> 36.69 | -          | <span style='color: red'>(+1 [+1.7%])</span> 38.19 | <span style='color: red'>(+0 [+1.2%])</span> 35.19 |
...
| `stark_prove_excluding_trace_time_ms` | <span style='color: green'>(-1 [-0.6%])</span> 174 | <span style='color: green'>(-2 [-0.6%])</span> 348 |  186 | <span style='color: green'>(-2 [-1.2%])</span> 162 |
...
| `perm_trace_commit_time_ms` | <span style='color: green'>(-1 [-1.5%])</span> 41.49 | <span style='color: green'>(-1 [-1.5%])</span> 82.99 | <span style='color: green'>(-1 [-2.7%])</span> 43.59 | <span style='color: green'>(-0 [-0.1%])</span> 39.40 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+1 [+1.8%])</span> 31.47 | <span style='color: red'>(+1 [+1.8%])</span> 62.94 | <span style='color: green'>(-0 [-0.5%])</span> 32.97 | <span style='color: red'>(+1 [+4.5%])</span> 29.97 |
| `quotient_poly_commit_time_ms` |  11.93 |  23.85 | <span style='color: red'>(+0 [+1.8%])</span> 12.47 | <span style='color: green'>(-0 [-1.9%])</span> 11.38 |
...
| --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 421 | 1 | 14 | 1,500,209 | 105.52 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 195 | 548 | 9,677,708 | 84,395,212 | 195 | 186 | 0 | 32.97 | 12.47 | 5 | 43.59 | 45 | 61 | 45 | 0 | 32 | 1,035,986 | 17 | 25 | 873,000 | 35.19 | 14 | 45 | 0 | 45 | 
| fibonacci_program | 1 | 184 | 421 | 9,708,170 | 74,305,770 | 184 | 162 | 1 | 29.97 | 11.38 | 4 | 39.40 | 39 | 52 | 39 | 0 | 28 | 1,064,416 | 12 | 33 | 627,209 | 38.19 | 11 | 41 | 0 | 39 | 

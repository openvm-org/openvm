...
|:---|---:|---:|
| Total | <span style='color: red'>(+0 [+0.8%])</span> 2.40 | <span style='color: red'>(+0 [+1.2%])</span> 0.78 |
| regex_program | <span style='color: red'>(+0 [+0.7%])</span> 2.37 | <span style='color: red'>(+0 [+0.8%])</span> 0.74 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+4 [+0.7%])</span> 591.50 | <span style='color: red'>(+17 [+0.7%])</span> 2,366 | <span style='color: red'>(+6 [+0.8%])</span> 744 | <span style='color: green'>(-9 [-1.7%])</span> 527 |
...
| `execute_metered_insn_mi/s` | <span style='color: green'>(-8 [-6.8%])</span> 110.65 | -          | <span style='color: green'>(-8 [-6.8%])</span> 110.65 | <span style='color: green'>(-8 [-6.8%])</span> 110.65 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` | <span style='color: red'>(+2 [+3.3%])</span> 55.25 | <span style='color: red'>(+7 [+3.3%])</span> 221 | <span style='color: red'>(+3 [+4.6%])</span> 68 | <span style='color: red'>(+1 [+2.2%])</span> 46 |
| `execute_preflight_insn_mi/s` | <span style='color: green'>(-1 [-2.6%])</span> 30.19 | -          | <span style='color: green'>(-1 [-2.4%])</span> 31.36 | <span style='color: green'>(-1 [-3.0%])</span> 27.23 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+2 [+0.8%])</span> 178.75 | <span style='color: red'>(+6 [+0.8%])</span> 715 | <span style='color: red'>(+3 [+1.4%])</span> 213 | <span style='color: red'>(+1 [+0.6%])</span> 155 |
| `memory_finalize_time_ms` |  1 |  4 |  4 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+1 [+0.3%])</span> 289.75 | <span style='color: red'>(+4 [+0.3%])</span> 1,159 | <span style='color: red'>(+1 [+0.3%])</span> 338 | <span style='color: green'>(-4 [-1.5%])</span> 262 |
| `main_trace_commit_time_ms` | <span style='color: red'>(+1 [+2.5%])</span> 52.25 | <span style='color: red'>(+5 [+2.5%])</span> 209 | <span style='color: red'>(+1 [+1.8%])</span> 58 | <span style='color: red'>(+1 [+2.0%])</span> 50 |
...
| `perm_trace_commit_time_ms` | <span style='color: red'>(+2 [+2.4%])</span> 65.08 | <span style='color: red'>(+6 [+2.4%])</span> 260.32 | <span style='color: red'>(+3 [+4.3%])</span> 71.11 | <span style='color: red'>(+1 [+2.6%])</span> 56.12 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+1 [+2.0%])</span> 58.36 | <span style='color: red'>(+5 [+2.0%])</span> 233.44 | <span style='color: green'>(-0 [-0.7%])</span> 69.64 | <span style='color: red'>(+2 [+3.6%])</span> 53.37 |
| `quotient_poly_commit_time_ms` | <span style='color: green'>(-0 [-0.6%])</span> 15.02 | <span style='color: green'>(-0 [-0.6%])</span> 60.06 | <span style='color: green'>(-1 [-5.9%])</span> 16.67 | <span style='color: red'>(+0 [+0.7%])</span> 12.64 |
| `pcs_opening_time_ms ` | <span style='color: green'>(-4 [-6.2%])</span> 61 | <span style='color: green'>(-16 [-6.2%])</span> 244 | <span style='color: green'>(-5 [-6.0%])</span> 78 | <span style='color: green'>(-10 [-17.9%])</span> 46 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 541 | 1 | 37 | 4,137,502 | 110.65 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 213 | 744 | 23,446,148 | 150,778,428 | 213 | 338 | 0 | 56.83 | 16.67 | 5 | 71.11 | 78 | 127 | 77 | 4 | 58 | 10,899,170 | 55 | 47 | 1,103,000 | 27.23 | 21 | 74 | 1 | 77 | 
| regex_program | 1 | 155 | 554 | 11,598,276 | 128,513,066 | 155 | 290 | 1 | 53.37 | 15.80 | 4 | 66.48 | 63 | 105 | 63 | 0 | 51 | 2,196,106 | 38 | 68 | 1,104,000 | 31.36 | 17 | 69 | 0 | 63 | 
| regex_program | 2 | 163 | 527 | 11,579,064 | 128,513,066 | 163 | 262 | 1 | 53.60 | 14.95 | 4 | 66.62 | 46 | 95 | 46 | 0 | 50 | 2,177,334 | 28 | 60 | 1,104,000 | 31.26 | 16 | 69 | 0 | 46 | 
| regex_program | 3 | 184 | 541 | 11,853,872 | 103,456,394 | 184 | 269 | 0 | 69.64 | 12.64 | 5 | 56.12 | 57 | 77 | 57 | 0 | 50 | 2,422,606 | 18 | 46 | 826,502 | 30.91 | 18 | 83 | 1 | 57 | 

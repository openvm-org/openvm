...
|:---|---:|---:|
| Total | <span style='color: red'>(+0 [+1.5%])</span> 1.54 | <span style='color: red'>(+0 [+2.6%])</span> 0.93 |
| pairing | <span style='color: red'>(+0 [+1.7%])</span> 1.46 | <span style='color: red'>(+0 [+3.1%])</span> 0.84 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+12 [+1.7%])</span> 727.50 | <span style='color: red'>(+24 [+1.7%])</span> 1,455 | <span style='color: red'>(+25 [+3.1%])</span> 843 | <span style='color: green'>(-1 [-0.2%])</span> 612 |
...
| `execute_metered_insn_mi/s` | <span style='color: red'>(+0 [+1.2%])</span> 19.57 | -          | <span style='color: red'>(+0 [+1.2%])</span> 19.57 | <span style='color: red'>(+0 [+1.2%])</span> 19.57 |
| `execute_preflight_insns` |  872,871 |  1,745,742 |  1,157,000 |  588,742 |
| `execute_preflight_time_ms` | <span style='color: red'>(+4 [+3.6%])</span> 100 | <span style='color: red'>(+7 [+3.6%])</span> 200 | <span style='color: red'>(+2 [+1.5%])</span> 133 | <span style='color: red'>(+5 [+8.1%])</span> 67 |
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+1 [+4.0%])</span> 13.50 | -          | <span style='color: red'>(+1 [+6.2%])</span> 17.95 | <span style='color: green'>(-0 [-0.2%])</span> 9.05 |
| `trace_gen_time_ms   ` | <span style='color: green'>(-6 [-3.1%])</span> 173 | <span style='color: green'>(-11 [-3.1%])</span> 346 | <span style='color: green'>(-8 [-4.1%])</span> 187 | <span style='color: green'>(-3 [-1.9%])</span> 159 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+11 [+3.2%])</span> 359.50 | <span style='color: red'>(+22 [+3.2%])</span> 719 | <span style='color: red'>(+21 [+5.5%])</span> 403 | <span style='color: red'>(+1 [+0.3%])</span> 316 |
...
| `generate_perm_trace_time_ms` | <span style='color: red'>(+7 [+19.4%])</span> 43 | <span style='color: red'>(+14 [+19.4%])</span> 86 | <span style='color: red'>(+10 [+25.0%])</span> 50 | <span style='color: red'>(+4 [+12.5%])</span> 36 |
| `perm_trace_commit_time_ms` | <span style='color: green'>(-1 [-1.7%])</span> 76.72 | <span style='color: green'>(-3 [-1.7%])</span> 153.43 | <span style='color: green'>(-2 [-1.9%])</span> 88.42 | <span style='color: green'>(-1 [-1.5%])</span> 65.02 |
| `quotient_poly_compute_time_ms` | <span style='color: green'>(-1 [-1.7%])</span> 78.87 | <span style='color: green'>(-3 [-1.7%])</span> 157.74 | <span style='color: green'>(-2 [-2.5%])</span> 86.71 | <span style='color: green'>(-0 [-0.7%])</span> 71.03 |
| `quotient_poly_commit_time_ms` | <span style='color: green'>(-0 [-1.6%])</span> 16.24 | <span style='color: green'>(-1 [-1.6%])</span> 32.47 | <span style='color: red'>(+0 [+0.3%])</span> 18.06 | <span style='color: green'>(-1 [-4.0%])</span> 14.41 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+7 [+10.4%])</span> 74 | <span style='color: red'>(+14 [+10.4%])</span> 148 | <span style='color: red'>(+9 [+12.9%])</span> 79 | <span style='color: red'>(+5 [+7.8%])</span> 69 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 612 | 66 | 1 | 89 | 1,745,742 | 19.57 | 176 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 159 | 843 | 32,689,110 | 172,558,444 | 159 | 403 | 0 | 86.71 | 18.06 | 6 | 88.42 | 79 | 142 | 79 | 1 | 75 | 16,059,916 | 50 | 133 | 1,157,000 | 9.05 | 26 | 105 | 1 | 79 | 
| pairing | 1 | 187 | 612 | 22,314,288 | 119,958,502 | 187 | 316 | 1 | 71.03 | 14.41 | 6 | 65.02 | 69 | 105 | 68 | 0 | 55 | 9,408,294 | 36 | 67 | 588,742 | 17.95 | 20 | 86 | 1 | 68 | 

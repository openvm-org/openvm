...
|:---|---:|---:|
| Total | <span style='color: red'>(+0 [+1.4%])</span> 0.100 | <span style='color: red'>(+0 [+2.3%])</span> 0.58 |
| fibonacci_program | <span style='color: red'>(+0 [+0.6%])</span> 0.98 | <span style='color: red'>(+0 [+0.9%])</span> 0.56 |


| fibonacci_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+3 [+0.6%])</span> 489 | <span style='color: red'>(+6 [+0.6%])</span> 978 | <span style='color: red'>(+5 [+0.9%])</span> 557 | <span style='color: red'>(+1 [+0.2%])</span> 421 |
| `main_cells_used     ` |  1,050,201 |  2,100,402 |  1,064,416 |  1,035,986 |
| `total_cells_used    ` |  9,692,939 |  19,385,878 |  9,708,170 |  9,677,708 |
| `execute_metered_time_ms` | <span style='color: red'>(+8 [+80.0%])</span> 18 | -          | -          | -          |
| `execute_metered_insn_mi/s` | <span style='color: green'>(-67 [-45.0%])</span> 81.28 | -          | <span style='color: green'>(-67 [-45.0%])</span> 81.28 | <span style='color: green'>(-67 [-45.0%])</span> 81.28 |
...
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+1 [+2.4%])</span> 37.04 | -          | <span style='color: red'>(+2 [+4.3%])</span> 39.17 | <span style='color: red'>(+0 [+0.4%])</span> 34.92 |
...
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+2 [+1.1%])</span> 177 | <span style='color: red'>(+4 [+1.1%])</span> 354 | <span style='color: red'>(+6 [+3.2%])</span> 192 | <span style='color: green'>(-2 [-1.2%])</span> 162 |
...
| `perm_trace_commit_time_ms` | <span style='color: green'>(-1 [-3.2%])</span> 40.77 | <span style='color: green'>(-3 [-3.2%])</span> 81.54 | <span style='color: green'>(-1 [-2.4%])</span> 43.73 | <span style='color: green'>(-2 [-4.2%])</span> 37.81 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+1 [+4.8%])</span> 32.39 | <span style='color: red'>(+3 [+4.8%])</span> 64.78 | <span style='color: red'>(+1 [+4.4%])</span> 34.60 | <span style='color: red'>(+1 [+5.2%])</span> 30.18 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+0 [+0.7%])</span> 12.01 | <span style='color: red'>(+0 [+0.7%])</span> 24.01 | <span style='color: green'>(-0 [-0.9%])</span> 12.15 | <span style='color: red'>(+0 [+2.3%])</span> 11.86 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+5 [+11.6%])</span> 48 | <span style='color: red'>(+10 [+11.6%])</span> 96 | <span style='color: red'>(+11 [+25.0%])</span> 55 | <span style='color: green'>(-1 [-2.4%])</span> 41 |
...
| --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 421 | 1 | 18 | 1,500,209 | 81.28 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 195 | 557 | 9,677,708 | 84,395,212 | 195 | 192 | 0 | 34.60 | 12.15 | 4 | 43.73 | 55 | 56 | 55 | 0 | 33 | 1,035,986 | 12 | 25 | 873,000 | 34.92 | 13 | 47 | 0 | 55 | 
| fibonacci_program | 1 | 184 | 421 | 9,708,170 | 74,305,770 | 184 | 162 | 1 | 30.18 | 11.86 | 4 | 37.81 | 41 | 50 | 41 | 0 | 28 | 1,064,416 | 11 | 34 | 627,209 | 39.17 | 11 | 42 | 0 | 41 | 

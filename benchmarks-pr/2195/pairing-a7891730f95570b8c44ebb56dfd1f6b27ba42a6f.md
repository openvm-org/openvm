...
|:---|---:|---:|
| Total | <span style='color: red'>(+0 [+0.2%])</span> 1.52 | <span style='color: green'>(-0 [-0.1%])</span> 0.91 |
| pairing |  1.43 | <span style='color: green'>(-0 [-0.4%])</span> 0.82 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  716 |  1,432 | <span style='color: green'>(-3 [-0.4%])</span> 815 | <span style='color: red'>(+4 [+0.7%])</span> 617 |
...
| `execute_metered_insn_mi/s` | <span style='color: green'>(-0 [-2.0%])</span> 18.96 | -          | <span style='color: green'>(-0 [-2.0%])</span> 18.96 | <span style='color: green'>(-0 [-2.0%])</span> 18.96 |
...
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+1 [+6.8%])</span> 13.87 | -          | <span style='color: red'>(+2 [+9.4%])</span> 18.48 | <span style='color: red'>(+0 [+2.1%])</span> 9.26 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+1 [+0.6%])</span> 179.50 | <span style='color: red'>(+2 [+0.6%])</span> 359 | <span style='color: red'>(+1 [+0.5%])</span> 196 | <span style='color: red'>(+1 [+0.6%])</span> 163 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+2 [+0.7%])</span> 351 | <span style='color: red'>(+5 [+0.7%])</span> 702 | <span style='color: green'>(-1 [-0.3%])</span> 381 | <span style='color: red'>(+6 [+1.9%])</span> 321 |
...
| `generate_perm_trace_time_ms` | <span style='color: red'>(+6 [+18.1%])</span> 42.50 | <span style='color: red'>(+13 [+18.1%])</span> 85 | <span style='color: red'>(+7 [+17.5%])</span> 47 | <span style='color: red'>(+6 [+18.8%])</span> 38 |
| `perm_trace_commit_time_ms` | <span style='color: green'>(-1 [-1.3%])</span> 77.03 | <span style='color: green'>(-2 [-1.3%])</span> 154.06 | <span style='color: green'>(-1 [-1.0%])</span> 89.26 | <span style='color: green'>(-1 [-1.8%])</span> 64.80 |
| `quotient_poly_compute_time_ms` | <span style='color: green'>(-2 [-2.7%])</span> 78.12 | <span style='color: green'>(-4 [-2.7%])</span> 156.23 | <span style='color: green'>(-2 [-2.4%])</span> 86.82 | <span style='color: green'>(-2 [-2.9%])</span> 69.41 |
| `quotient_poly_commit_time_ms` | <span style='color: green'>(-0 [-1.8%])</span> 16.22 | <span style='color: green'>(-1 [-1.8%])</span> 32.44 | <span style='color: red'>(+1 [+3.3%])</span> 18.60 | <span style='color: green'>(-1 [-7.8%])</span> 13.84 |
| `pcs_opening_time_ms ` |  67 |  134 | <span style='color: green'>(-2 [-2.9%])</span> 68 | <span style='color: red'>(+2 [+3.1%])</span> 66 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 617 | 40 | 1 | 92 | 1,745,742 | 18.96 | 144 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 163 | 815 | 32,689,110 | 172,558,444 | 163 | 381 | 0 | 86.82 | 18.60 | 6 | 89.26 | 68 | 130 | 67 | 1 | 75 | 16,059,916 | 38 | 128 | 1,157,000 | 9.26 | 27 | 106 | 1 | 67 | 
| pairing | 1 | 196 | 617 | 22,314,288 | 119,958,502 | 196 | 321 | 1 | 69.41 | 13.84 | 5 | 64.80 | 66 | 115 | 66 | 0 | 55 | 9,408,294 | 47 | 58 | 588,742 | 18.48 | 20 | 83 | 1 | 66 | 

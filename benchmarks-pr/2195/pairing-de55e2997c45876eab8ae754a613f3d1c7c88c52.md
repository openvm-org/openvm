...
|:---|---:|---:|
| Total | <span style='color: red'>(+0 [+2.6%])</span> 1.56 | <span style='color: red'>(+0 [+1.2%])</span> 0.91 |
| pairing | <span style='color: red'>(+0 [+2.2%])</span> 1.46 | <span style='color: red'>(+0 [+0.2%])</span> 0.81 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+16 [+2.2%])</span> 728.50 | <span style='color: red'>(+31 [+2.2%])</span> 1,457 | <span style='color: red'>(+2 [+0.2%])</span> 813 | <span style='color: red'>(+29 [+4.7%])</span> 644 |
| `main_cells_used     ` |  12,734,105 |  25,468,210 |  16,059,916 |  9,408,294 |
| `total_cells_used    ` |  27,501,699 |  55,003,398 |  32,689,110 |  22,314,288 |
| `execute_metered_time_ms` | <span style='color: red'>(+9 [+10.1%])</span> 98 | -          | -          | -          |
| `execute_metered_insn_mi/s` | <span style='color: green'>(-2 [-8.4%])</span> 17.78 | -          | <span style='color: green'>(-2 [-8.4%])</span> 17.78 | <span style='color: green'>(-2 [-8.4%])</span> 17.78 |
| `execute_preflight_insns` |  872,871 |  1,745,742 |  1,157,000 |  588,742 |
| `execute_preflight_time_ms` | <span style='color: red'>(+4 [+4.3%])</span> 98 | <span style='color: red'>(+8 [+4.3%])</span> 196 | <span style='color: red'>(+6 [+4.7%])</span> 135 | <span style='color: red'>(+2 [+3.4%])</span> 61 |
| `execute_preflight_insn_mi/s` | <span style='color: green'>(-0 [-1.3%])</span> 13.46 | -          |  18.14 | <span style='color: green'>(-0 [-4.1%])</span> 8.79 |
| `trace_gen_time_ms   ` | <span style='color: green'>(-10 [-5.6%])</span> 170 | <span style='color: green'>(-20 [-5.6%])</span> 340 | <span style='color: green'>(-7 [-3.6%])</span> 190 | <span style='color: green'>(-13 [-8.0%])</span> 150 |
| `memory_finalize_time_ms` | <span style='color: red'>(+1 [+inf%])</span> 1 | <span style='color: red'>(+2 [+inf%])</span> 2 | <span style='color: red'>(+1 [+inf%])</span> 1 | <span style='color: red'>(+1 [+inf%])</span> 1 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+21 [+6.1%])</span> 366.50 | <span style='color: red'>(+42 [+6.1%])</span> 733 | <span style='color: red'>(+8 [+2.1%])</span> 382 | <span style='color: red'>(+34 [+10.7%])</span> 351 |
...
| `perm_trace_commit_time_ms` | <span style='color: green'>(-1 [-0.8%])</span> 76.63 | <span style='color: green'>(-1 [-0.8%])</span> 153.26 | <span style='color: green'>(-1 [-1.5%])</span> 88.80 |  64.46 |
| `quotient_poly_compute_time_ms` | <span style='color: green'>(-2 [-2.0%])</span> 78.08 | <span style='color: green'>(-3 [-2.0%])</span> 156.17 | <span style='color: green'>(-1 [-0.8%])</span> 86.65 | <span style='color: green'>(-3 [-3.6%])</span> 69.52 |
| `quotient_poly_commit_time_ms` | <span style='color: green'>(-1 [-4.8%])</span> 15.95 | <span style='color: green'>(-2 [-4.8%])</span> 31.90 | <span style='color: green'>(-1 [-3.4%])</span> 18.25 | <span style='color: green'>(-1 [-6.6%])</span> 13.65 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+1 [+1.5%])</span> 69.50 | <span style='color: red'>(+2 [+1.5%])</span> 139 | <span style='color: red'>(+2 [+2.9%])</span> 72 |  67 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 644 | 1 | 98 | 1,745,742 | 17.78 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 150 | 813 | 32,689,110 | 172,558,444 | 150 | 382 | 0 | 86.65 | 18.25 | 6 | 88.80 | 67 | 132 | 67 | 1 | 75 | 16,059,916 | 40 | 135 | 1,157,000 | 8.79 | 26 | 105 | 1 | 67 | 
| pairing | 1 | 190 | 644 | 22,314,288 | 119,958,502 | 190 | 351 | 1 | 69.52 | 13.65 | 6 | 64.46 | 72 | 139 | 71 | 1 | 55 | 9,408,294 | 71 | 61 | 588,742 | 18.14 | 20 | 83 | 1 | 71 | 

...
|:---|---:|---:|
| Total | <span style='color: red'>(+0 [+0.8%])</span> 0.99 | <span style='color: red'>(+0 [+0.5%])</span> 0.57 |
| fibonacci_program | <span style='color: red'>(+0 [+0.7%])</span> 0.98 | <span style='color: red'>(+0 [+0.4%])</span> 0.55 |


| fibonacci_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+4 [+0.7%])</span> 489.50 | <span style='color: red'>(+7 [+0.7%])</span> 979 | <span style='color: red'>(+2 [+0.4%])</span> 554 | <span style='color: red'>(+5 [+1.2%])</span> 425 |
...
| `execute_metered_insn_mi/s` | <span style='color: green'>(-18 [-12.4%])</span> 129.62 | -          | <span style='color: green'>(-18 [-12.4%])</span> 129.62 | <span style='color: green'>(-18 [-12.4%])</span> 129.62 |
...
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+1 [+1.6%])</span> 36.73 | -          | <span style='color: red'>(+1 [+2.9%])</span> 38.67 |  34.79 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+6 [+3.2%])</span> 193.50 | <span style='color: red'>(+12 [+3.2%])</span> 387 | <span style='color: red'>(+3 [+1.5%])</span> 198 | <span style='color: red'>(+9 [+5.0%])</span> 189 |
...
| `perm_trace_commit_time_ms` | <span style='color: red'>(+0 [+0.2%])</span> 42.22 | <span style='color: red'>(+0 [+0.2%])</span> 84.45 | <span style='color: green'>(-0 [-0.2%])</span> 44.75 | <span style='color: red'>(+0 [+0.6%])</span> 39.70 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+0 [+0.2%])</span> 30.98 | <span style='color: red'>(+0 [+0.2%])</span> 61.96 | <span style='color: green'>(-1 [-2.3%])</span> 32.38 | <span style='color: red'>(+1 [+3.1%])</span> 29.58 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+0 [+1.2%])</span> 12.07 | <span style='color: red'>(+0 [+1.2%])</span> 24.14 | <span style='color: red'>(+1 [+4.1%])</span> 12.76 | <span style='color: green'>(-0 [-1.9%])</span> 11.38 |
...
| --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 425 | 1 | 11 | 1,500,209 | 129.62 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 198 | 554 | 9,677,708 | 84,395,212 | 198 | 186 | 0 | 32.38 | 12.76 | 4 | 44.75 | 45 | 61 | 45 | 0 | 33 | 1,035,986 | 16 | 25 | 873,000 | 34.79 | 14 | 45 | 0 | 45 | 
| fibonacci_program | 1 | 189 | 425 | 9,708,170 | 74,305,770 | 189 | 162 | 1 | 29.58 | 11.38 | 4 | 39.70 | 39 | 52 | 39 | 0 | 28 | 1,064,416 | 12 | 32 | 627,209 | 38.67 | 11 | 41 | 0 | 38 | 

...
|:---|---:|---:|
| Total | <span style='color: green'>(-0 [-1.5%])</span> 2.35 | <span style='color: green'>(-0 [-3.0%])</span> 0.75 |
| regex_program | <span style='color: green'>(-0 [-1.6%])</span> 2.31 | <span style='color: green'>(-0 [-3.4%])</span> 0.71 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: green'>(-9 [-1.6%])</span> 578 | <span style='color: green'>(-37 [-1.6%])</span> 2,312 | <span style='color: green'>(-25 [-3.4%])</span> 713 | <span style='color: green'>(-7 [-1.3%])</span> 529 |
...
| `execute_metered_insn_mi/s` | <span style='color: green'>(-5 [-4.6%])</span> 113.22 | -          | <span style='color: green'>(-5 [-4.6%])</span> 113.22 | <span style='color: green'>(-5 [-4.6%])</span> 113.22 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` | <span style='color: red'>(+1 [+1.4%])</span> 54.25 | <span style='color: red'>(+3 [+1.4%])</span> 217 |  65 |  45 |
| `execute_preflight_insn_mi/s` | <span style='color: green'>(-1 [-2.2%])</span> 30.32 | -          | <span style='color: green'>(-0 [-0.6%])</span> 31.91 | <span style='color: green'>(-0 [-0.2%])</span> 28.02 |
| `trace_gen_time_ms   ` | <span style='color: green'>(-4 [-2.0%])</span> 173.75 | <span style='color: green'>(-14 [-2.0%])</span> 695 | <span style='color: green'>(-4 [-1.9%])</span> 206 | <span style='color: green'>(-1 [-0.6%])</span> 153 |
| `memory_finalize_time_ms` |  1 |  4 |  4 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: green'>(-6 [-2.3%])</span> 282.25 | <span style='color: green'>(-26 [-2.3%])</span> 1,129 | <span style='color: green'>(-21 [-6.2%])</span> 316 | <span style='color: red'>(+1 [+0.4%])</span> 267 |
| `main_trace_commit_time_ms` |  51 |  204 | <span style='color: green'>(-2 [-3.5%])</span> 55 |  49 |
| `generate_perm_trace_time_ms` | <span style='color: red'>(+0 [+0.7%])</span> 34 | <span style='color: red'>(+1 [+0.7%])</span> 136 |  54 |  19 |
| `perm_trace_commit_time_ms` | <span style='color: green'>(-1 [-1.2%])</span> 62.76 | <span style='color: green'>(-3 [-1.2%])</span> 251.04 | <span style='color: red'>(+0 [+0.6%])</span> 68.57 | <span style='color: green'>(-1 [-1.6%])</span> 53.82 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+1 [+1.7%])</span> 58.17 | <span style='color: red'>(+4 [+1.7%])</span> 232.69 | <span style='color: red'>(+1 [+0.8%])</span> 70.69 | <span style='color: green'>(-0 [-0.2%])</span> 51.40 |
| `quotient_poly_commit_time_ms` | <span style='color: green'>(-0 [-0.4%])</span> 15.06 | <span style='color: green'>(-0 [-0.4%])</span> 60.24 | <span style='color: red'>(+0 [+0.3%])</span> 17.76 | <span style='color: red'>(+0 [+0.8%])</span> 12.66 |
| `pcs_opening_time_ms ` | <span style='color: green'>(-7 [-10.8%])</span> 58 | <span style='color: green'>(-28 [-10.8%])</span> 232 | <span style='color: green'>(-21 [-25.3%])</span> 62 | <span style='color: green'>(-1 [-1.8%])</span> 55 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 534 | 1 | 36 | 4,137,502 | 113.22 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 206 | 713 | 23,446,148 | 150,778,428 | 206 | 316 | 0 | 58.79 | 17.76 | 5 | 68.57 | 59 | 124 | 59 | 4 | 55 | 10,899,170 | 54 | 47 | 1,103,000 | 28.02 | 21 | 77 | 1 | 59 | 
| regex_program | 1 | 153 | 536 | 11,598,276 | 128,513,066 | 153 | 276 | 1 | 51.40 | 15.34 | 4 | 65.03 | 55 | 102 | 55 | 0 | 50 | 2,196,106 | 37 | 65 | 1,104,000 | 31.91 | 16 | 67 | 0 | 55 | 
| regex_program | 2 | 157 | 529 | 11,579,064 | 128,513,066 | 157 | 270 | 1 | 51.82 | 14.48 | 5 | 63.61 | 62 | 90 | 61 | 0 | 50 | 2,177,334 | 26 | 60 | 1,104,000 | 30.22 | 16 | 66 | 0 | 61 | 
| regex_program | 3 | 179 | 534 | 11,853,872 | 103,456,394 | 179 | 267 | 0 | 70.69 | 12.66 | 5 | 53.82 | 56 | 76 | 56 | 0 | 49 | 2,422,606 | 19 | 45 | 826,502 | 31.12 | 18 | 84 | 1 | 56 | 

...
|:---|---:|---:|
| Total | <span style='color: green'>(-0 [-0.7%])</span> 2.37 | <span style='color: green'>(-0 [-3.4%])</span> 0.75 |
| regex_program | <span style='color: green'>(-0 [-0.9%])</span> 2.33 | <span style='color: green'>(-0 [-4.1%])</span> 0.71 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: green'>(-5 [-0.9%])</span> 582.25 | <span style='color: green'>(-20 [-0.9%])</span> 2,329 | <span style='color: green'>(-30 [-4.1%])</span> 708 | <span style='color: green'>(-1 [-0.2%])</span> 535 |
...
| `execute_metered_insn_mi/s` | <span style='color: green'>(-11 [-9.4%])</span> 107.50 | -          | <span style='color: green'>(-11 [-9.4%])</span> 107.50 | <span style='color: green'>(-11 [-9.4%])</span> 107.50 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` | <span style='color: green'>(-2 [-2.8%])</span> 52 | <span style='color: green'>(-6 [-2.8%])</span> 208 | <span style='color: green'>(-1 [-1.5%])</span> 64 | <span style='color: green'>(-2 [-4.4%])</span> 43 |
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+2 [+5.3%])</span> 32.63 | -          | <span style='color: red'>(+2 [+6.0%])</span> 34.06 | <span style='color: red'>(+1 [+4.9%])</span> 29.44 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+2 [+1.3%])</span> 179.50 | <span style='color: red'>(+9 [+1.3%])</span> 718 | <span style='color: red'>(+3 [+1.4%])</span> 213 | <span style='color: red'>(+3 [+1.9%])</span> 157 |
| `memory_finalize_time_ms` |  1 |  4 |  4 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: green'>(-6 [-2.0%])</span> 283 | <span style='color: green'>(-23 [-2.0%])</span> 1,132 | <span style='color: green'>(-31 [-9.2%])</span> 306 | <span style='color: red'>(+3 [+1.1%])</span> 269 |
| `main_trace_commit_time_ms` | <span style='color: red'>(+1 [+1.5%])</span> 51.75 | <span style='color: red'>(+3 [+1.5%])</span> 207 | <span style='color: green'>(-1 [-1.8%])</span> 56 | <span style='color: red'>(+1 [+2.0%])</span> 50 |
| `generate_perm_trace_time_ms` | <span style='color: green'>(-4 [-12.6%])</span> 29.50 | <span style='color: green'>(-17 [-12.6%])</span> 118 | <span style='color: green'>(-16 [-29.6%])</span> 38 |  19 |
| `perm_trace_commit_time_ms` | <span style='color: red'>(+0 [+0.3%])</span> 63.75 | <span style='color: red'>(+1 [+0.3%])</span> 255.01 | <span style='color: red'>(+2 [+2.3%])</span> 69.75 | <span style='color: red'>(+1 [+1.8%])</span> 55.68 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+1 [+1.5%])</span> 58.08 | <span style='color: red'>(+3 [+1.5%])</span> 232.32 | <span style='color: green'>(-1 [-1.7%])</span> 68.95 | <span style='color: green'>(-0 [-0.2%])</span> 51.42 |
| `quotient_poly_commit_time_ms` |  15.10 |  60.40 | <span style='color: red'>(+0 [+2.4%])</span> 18.13 | <span style='color: red'>(+0 [+2.8%])</span> 12.91 |
| `pcs_opening_time_ms ` | <span style='color: green'>(-3 [-5.0%])</span> 61.75 | <span style='color: green'>(-13 [-5.0%])</span> 247 | <span style='color: green'>(-17 [-20.5%])</span> 66 | <span style='color: red'>(+1 [+1.8%])</span> 57 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 538 | 1 | 38 | 4,137,502 | 107.50 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 213 | 708 | 23,446,148 | 150,778,428 | 213 | 306 | 0 | 60.08 | 18.13 | 5 | 69.75 | 66 | 104 | 66 | 4 | 56 | 10,899,170 | 34 | 44 | 1,103,000 | 29.44 | 22 | 78 | 1 | 65 | 
| regex_program | 1 | 157 | 548 | 11,598,276 | 128,513,066 | 157 | 285 | 1 | 51.42 | 14.88 | 5 | 65.10 | 63 | 104 | 63 | 0 | 50 | 2,196,106 | 38 | 64 | 1,104,000 | 34.06 | 16 | 66 | 0 | 63 | 
| regex_program | 2 | 164 | 535 | 11,579,064 | 128,513,066 | 164 | 272 | 1 | 51.87 | 14.48 | 4 | 64.48 | 61 | 92 | 61 | 0 | 51 | 2,177,334 | 27 | 57 | 1,104,000 | 33.37 | 16 | 66 | 0 | 61 | 
| regex_program | 3 | 184 | 538 | 11,853,872 | 103,456,394 | 184 | 269 | 0 | 68.95 | 12.91 | 5 | 55.68 | 57 | 77 | 57 | 0 | 50 | 2,422,606 | 19 | 43 | 826,502 | 33.66 | 18 | 82 | 1 | 57 | 

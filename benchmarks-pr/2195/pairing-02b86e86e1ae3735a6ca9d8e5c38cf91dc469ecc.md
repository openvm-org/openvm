...
|:---|---:|---:|
| Total | <span style='color: green'>(-0 [-0.9%])</span> 1.51 | <span style='color: red'>(+0 [+0.2%])</span> 0.91 |
| pairing | <span style='color: green'>(-0 [-1.0%])</span> 1.42 | <span style='color: red'>(+0 [+0.1%])</span> 0.82 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: green'>(-7 [-1.0%])</span> 708.50 | <span style='color: green'>(-14 [-1.0%])</span> 1,417 | <span style='color: red'>(+1 [+0.1%])</span> 819 | <span style='color: green'>(-15 [-2.4%])</span> 598 |
...
| `execute_metered_insn_mi/s` | <span style='color: green'>(-0 [-1.1%])</span> 19.13 | -          | <span style='color: green'>(-0 [-1.1%])</span> 19.13 | <span style='color: green'>(-0 [-1.1%])</span> 19.13 |
| `execute_preflight_insns` |  872,871 |  1,745,742 |  1,157,000 |  588,742 |
| `execute_preflight_time_ms` | <span style='color: green'>(-2 [-2.6%])</span> 94 | <span style='color: green'>(-5 [-2.6%])</span> 188 | <span style='color: green'>(-3 [-2.3%])</span> 128 | <span style='color: green'>(-2 [-3.2%])</span> 60 |
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+1 [+6.3%])</span> 13.80 | -          | <span style='color: red'>(+1 [+8.3%])</span> 18.30 | <span style='color: red'>(+0 [+2.6%])</span> 9.30 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+5 [+2.8%])</span> 183.50 | <span style='color: red'>(+10 [+2.8%])</span> 367 | <span style='color: red'>(+3 [+1.5%])</span> 198 | <span style='color: red'>(+7 [+4.3%])</span> 169 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: green'>(-10 [-2.7%])</span> 339 | <span style='color: green'>(-19 [-2.7%])</span> 678 | <span style='color: green'>(-3 [-0.8%])</span> 379 | <span style='color: green'>(-16 [-5.1%])</span> 299 |
| `main_trace_commit_time_ms` | <span style='color: green'>(-1 [-1.5%])</span> 64.50 | <span style='color: green'>(-2 [-1.5%])</span> 129 |  75 | <span style='color: green'>(-2 [-3.6%])</span> 54 |
| `generate_perm_trace_time_ms` | <span style='color: green'>(-0 [-1.4%])</span> 35.50 | <span style='color: green'>(-1 [-1.4%])</span> 71 | <span style='color: green'>(-3 [-7.5%])</span> 37 | <span style='color: red'>(+2 [+6.2%])</span> 34 |
| `perm_trace_commit_time_ms` | <span style='color: green'>(-0 [-0.3%])</span> 77.84 | <span style='color: green'>(-0 [-0.3%])</span> 155.68 | <span style='color: red'>(+1 [+0.7%])</span> 90.75 | <span style='color: green'>(-1 [-1.6%])</span> 64.93 |
| `quotient_poly_compute_time_ms` | <span style='color: green'>(-1 [-1.1%])</span> 79.40 | <span style='color: green'>(-2 [-1.1%])</span> 158.80 | <span style='color: green'>(-1 [-1.2%])</span> 87.94 | <span style='color: green'>(-1 [-0.9%])</span> 70.86 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+0 [+2.0%])</span> 16.84 | <span style='color: red'>(+1 [+2.0%])</span> 33.69 | <span style='color: red'>(+1 [+7.0%])</span> 19.26 | <span style='color: green'>(-1 [-3.9%])</span> 14.42 |
| `pcs_opening_time_ms ` | <span style='color: green'>(-7 [-10.4%])</span> 60 | <span style='color: green'>(-14 [-10.4%])</span> 120 | <span style='color: green'>(-5 [-7.1%])</span> 65 | <span style='color: green'>(-9 [-14.1%])</span> 55 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 598 | 40 | 1 | 91 | 1,745,742 | 19.13 | 144 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 169 | 819 | 32,689,110 | 172,558,444 | 169 | 379 | 0 | 87.94 | 19.26 | 6 | 90.75 | 65 | 130 | 65 | 1 | 75 | 16,059,916 | 37 | 128 | 1,157,000 | 9.30 | 27 | 108 | 1 | 65 | 
| pairing | 1 | 198 | 598 | 22,314,288 | 119,958,502 | 198 | 299 | 1 | 70.86 | 14.42 | 6 | 64.93 | 55 | 102 | 55 | 0 | 54 | 9,408,294 | 34 | 60 | 588,742 | 18.30 | 20 | 85 | 1 | 55 | 

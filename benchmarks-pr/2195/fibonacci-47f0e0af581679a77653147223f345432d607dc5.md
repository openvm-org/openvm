...
|:---|---:|---:|
| Total | <span style='color: red'>(+0 [+0.9%])</span> 0.99 | <span style='color: red'>(+0 [+0.9%])</span> 0.57 |
| fibonacci_program | <span style='color: red'>(+0 [+0.6%])</span> 0.98 | <span style='color: red'>(+0 [+0.4%])</span> 0.55 |


| fibonacci_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+3 [+0.6%])</span> 489 | <span style='color: red'>(+6 [+0.6%])</span> 978 | <span style='color: red'>(+2 [+0.4%])</span> 554 | <span style='color: red'>(+4 [+1.0%])</span> 424 |
...
| `execute_metered_insn_mi/s` | <span style='color: green'>(-34 [-23.0%])</span> 113.93 | -          | <span style='color: green'>(-34 [-23.0%])</span> 113.93 | <span style='color: green'>(-34 [-23.0%])</span> 113.93 |
...
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+1 [+2.6%])</span> 37.10 | -          | <span style='color: red'>(+2 [+4.0%])</span> 39.08 | <span style='color: red'>(+0 [+1.0%])</span> 35.13 |
...
| `stark_prove_excluding_trace_time_ms` |  175 |  350 | <span style='color: red'>(+1 [+0.5%])</span> 187 | <span style='color: green'>(-1 [-0.6%])</span> 163 |
...
| `perm_trace_commit_time_ms` | <span style='color: green'>(-0 [-0.9%])</span> 41.77 | <span style='color: green'>(-1 [-0.9%])</span> 83.54 | <span style='color: green'>(-0 [-0.5%])</span> 44.61 | <span style='color: green'>(-1 [-1.3%])</span> 38.93 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+1 [+2.4%])</span> 31.64 | <span style='color: red'>(+1 [+2.4%])</span> 63.27 | <span style='color: green'>(-0 [-0.9%])</span> 32.84 | <span style='color: red'>(+2 [+6.1%])</span> 30.43 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+0 [+2.4%])</span> 12.21 | <span style='color: red'>(+1 [+2.4%])</span> 24.43 | <span style='color: red'>(+1 [+5.0%])</span> 12.87 | <span style='color: green'>(-0 [-0.3%])</span> 11.56 |
...
| --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 424 | 1 | 13 | 1,500,209 | 113.93 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 196 | 554 | 9,677,708 | 84,395,212 | 196 | 187 | 0 | 32.84 | 12.87 | 4 | 44.61 | 45 | 61 | 45 | 0 | 33 | 1,035,986 | 16 | 25 | 873,000 | 35.13 | 14 | 46 | 0 | 45 | 
| fibonacci_program | 1 | 187 | 424 | 9,708,170 | 74,305,770 | 187 | 163 | 1 | 30.43 | 11.56 | 4 | 38.93 | 41 | 51 | 41 | 0 | 28 | 1,064,416 | 11 | 32 | 627,209 | 39.08 | 11 | 42 | 0 | 41 | 

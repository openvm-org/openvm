...
|:---|---:|---:|
| Total | <span style='color: green'>(-0 [-0.5%])</span> 1.51 | <span style='color: green'>(-0 [-0.1%])</span> 0.91 |
| pairing | <span style='color: green'>(-0 [-0.5%])</span> 1.42 | <span style='color: green'>(-0 [-0.1%])</span> 0.82 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: green'>(-4 [-0.5%])</span> 712 | <span style='color: green'>(-7 [-0.5%])</span> 1,424 | <span style='color: green'>(-1 [-0.1%])</span> 817 | <span style='color: green'>(-6 [-1.0%])</span> 607 |
...
| `execute_preflight_time_ms` | <span style='color: green'>(-1 [-1.0%])</span> 95.50 | <span style='color: green'>(-2 [-1.0%])</span> 191 | <span style='color: red'>(+1 [+0.8%])</span> 132 | <span style='color: green'>(-3 [-4.8%])</span> 59 |
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+1 [+4.0%])</span> 13.50 | -          | <span style='color: red'>(+1 [+6.3%])</span> 17.96 | <span style='color: green'>(-0 [-0.4%])</span> 9.04 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+2 [+1.1%])</span> 180.50 | <span style='color: red'>(+4 [+1.1%])</span> 361 | <span style='color: red'>(+3 [+1.5%])</span> 198 | <span style='color: red'>(+1 [+0.6%])</span> 163 |
| `memory_finalize_time_ms` | <span style='color: red'>(+0 [+100.0%])</span> 1 | <span style='color: red'>(+1 [+100.0%])</span> 2 | <span style='color: red'>(+1 [+100.0%])</span> 2 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: green'>(-6 [-1.6%])</span> 343 | <span style='color: green'>(-11 [-1.6%])</span> 686 | <span style='color: green'>(-4 [-1.0%])</span> 378 | <span style='color: green'>(-7 [-2.2%])</span> 308 |
| `main_trace_commit_time_ms` | <span style='color: green'>(-0 [-0.8%])</span> 65 | <span style='color: green'>(-1 [-0.8%])</span> 130 | <span style='color: red'>(+1 [+1.3%])</span> 76 | <span style='color: green'>(-2 [-3.6%])</span> 54 |
| `generate_perm_trace_time_ms` | <span style='color: green'>(-4 [-11.1%])</span> 32 | <span style='color: green'>(-8 [-11.1%])</span> 64 | <span style='color: green'>(-5 [-12.5%])</span> 35 | <span style='color: green'>(-3 [-9.4%])</span> 29 |
| `perm_trace_commit_time_ms` | <span style='color: green'>(-0 [-0.1%])</span> 77.98 | <span style='color: green'>(-0 [-0.1%])</span> 155.96 | <span style='color: red'>(+0 [+0.2%])</span> 90.30 | <span style='color: green'>(-0 [-0.5%])</span> 65.66 |
| `quotient_poly_compute_time_ms` | <span style='color: green'>(-1 [-0.7%])</span> 79.68 | <span style='color: green'>(-1 [-0.7%])</span> 159.37 | <span style='color: green'>(-1 [-1.1%])</span> 88.01 | <span style='color: green'>(-0 [-0.2%])</span> 71.36 |
| `quotient_poly_commit_time_ms` | <span style='color: green'>(-0 [-1.2%])</span> 16.30 | <span style='color: green'>(-0 [-1.2%])</span> 32.61 | <span style='color: red'>(+0 [+1.6%])</span> 18.29 | <span style='color: green'>(-1 [-4.6%])</span> 14.32 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 607 | 41 | 1 | 90 | 1,745,742 | 19.35 | 145 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 163 | 817 | 32,689,110 | 172,558,444 | 163 | 378 | 0 | 88.01 | 18.29 | 6 | 90.30 | 65 | 129 | 65 | 2 | 76 | 16,059,916 | 35 | 132 | 1,157,000 | 9.04 | 26 | 107 | 1 | 65 | 
| pairing | 1 | 198 | 607 | 22,314,288 | 119,958,502 | 198 | 308 | 1 | 71.36 | 14.32 | 5 | 65.66 | 70 | 97 | 69 | 0 | 54 | 9,408,294 | 29 | 59 | 588,742 | 17.96 | 20 | 86 | 1 | 69 | 

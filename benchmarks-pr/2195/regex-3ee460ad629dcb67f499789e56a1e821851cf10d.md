...
|:---|---:|---:|
| Total | <span style='color: red'>(+0 [+0.8%])</span> 2.40 | <span style='color: red'>(+0 [+1.3%])</span> 0.78 |
...
| `total_proof_time_ms ` | <span style='color: red'>(+4 [+0.7%])</span> 591.25 | <span style='color: red'>(+16 [+0.7%])</span> 2,365 | <span style='color: red'>(+6 [+0.8%])</span> 744 |  536 |
...
| `execute_metered_insn_mi/s` | <span style='color: green'>(-11 [-9.0%])</span> 107.98 | -          | <span style='color: green'>(-11 [-9.0%])</span> 107.98 | <span style='color: green'>(-11 [-9.0%])</span> 107.98 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` | <span style='color: red'>(+0 [+0.9%])</span> 54 | <span style='color: red'>(+2 [+0.9%])</span> 216 |  65 |  45 |
| `execute_preflight_insn_mi/s` | <span style='color: green'>(-0 [-0.9%])</span> 30.70 | -          | <span style='color: green'>(-0 [-0.4%])</span> 31.98 | <span style='color: green'>(-0 [-1.4%])</span> 27.69 |
| `trace_gen_time_ms   ` |  177.25 |  709 |  210 | <span style='color: red'>(+1 [+0.6%])</span> 155 |
| `memory_finalize_time_ms` |  1 |  4 |  4 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+4 [+1.4%])</span> 292.75 | <span style='color: red'>(+16 [+1.4%])</span> 1,171 | <span style='color: red'>(+6 [+1.8%])</span> 343 |  266 |
| `main_trace_commit_time_ms` | <span style='color: red'>(+0 [+1.0%])</span> 51.50 | <span style='color: red'>(+2 [+1.0%])</span> 206 |  57 |  49 |
| `generate_perm_trace_time_ms` | <span style='color: red'>(+1 [+3.7%])</span> 35 | <span style='color: red'>(+5 [+3.7%])</span> 140 | <span style='color: red'>(+1 [+1.9%])</span> 55 |  19 |
| `perm_trace_commit_time_ms` | <span style='color: red'>(+1 [+0.8%])</span> 64.06 | <span style='color: red'>(+2 [+0.8%])</span> 256.25 | <span style='color: red'>(+2 [+3.1%])</span> 70.26 | <span style='color: green'>(-0 [-0.5%])</span> 54.38 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+1 [+1.3%])</span> 57.96 | <span style='color: red'>(+3 [+1.3%])</span> 231.82 | <span style='color: red'>(+1 [+0.8%])</span> 70.67 | <span style='color: red'>(+0 [+0.3%])</span> 51.69 |
| `quotient_poly_commit_time_ms` | <span style='color: green'>(-0 [-0.4%])</span> 15.05 | <span style='color: green'>(-0 [-0.4%])</span> 60.21 | <span style='color: green'>(-1 [-6.7%])</span> 16.51 | <span style='color: red'>(+0 [+0.3%])</span> 12.60 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+1 [+1.5%])</span> 66 | <span style='color: red'>(+4 [+1.5%])</span> 264 |  83 |  56 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 536 | 1 | 38 | 4,137,502 | 107.98 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 210 | 744 | 23,446,148 | 150,778,428 | 210 | 343 | 0 | 57.70 | 16.51 | 5 | 70.26 | 83 | 126 | 83 | 4 | 57 | 10,899,170 | 55 | 47 | 1,103,000 | 27.69 | 21 | 74 | 1 | 83 | 
| regex_program | 1 | 155 | 548 | 11,598,276 | 128,513,066 | 155 | 286 | 1 | 51.76 | 15.41 | 4 | 65.31 | 63 | 103 | 62 | 0 | 51 | 2,196,106 | 38 | 65 | 1,104,000 | 31.66 | 16 | 67 | 0 | 62 | 
| regex_program | 2 | 161 | 537 | 11,579,064 | 128,513,066 | 161 | 276 | 1 | 51.69 | 15.69 | 4 | 66.29 | 62 | 95 | 62 | 0 | 49 | 2,177,334 | 28 | 59 | 1,104,000 | 31.48 | 16 | 67 | 0 | 62 | 
| regex_program | 3 | 183 | 536 | 11,853,872 | 103,456,394 | 183 | 266 | 0 | 70.67 | 12.60 | 5 | 54.38 | 56 | 76 | 55 | 0 | 49 | 2,422,606 | 19 | 45 | 826,502 | 31.98 | 18 | 84 | 1 | 55 | 
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19346465425)

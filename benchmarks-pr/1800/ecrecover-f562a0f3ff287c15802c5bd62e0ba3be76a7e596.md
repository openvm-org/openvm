...
|:---|---:|---:|
| Total |  12.77 |  12.77 |
| ecrecover_program | <span style='color: red'>(+0 [+0.5%])</span> 1.42 | <span style='color: red'>(+0 [+0.5%])</span> 1.42 |
| leaf |  11.24 |  11.24 |
...
| `total_proof_time_ms ` | <span style='color: red'>(+7 [+0.5%])</span> 1,419 | <span style='color: red'>(+7 [+0.5%])</span> 1,419 | <span style='color: red'>(+7 [+0.5%])</span> 1,419 | <span style='color: red'>(+7 [+0.5%])</span> 1,419 |
| `main_cells_used     ` |  8,151,353 |  8,151,353 |  8,151,353 |  8,151,353 |
| `total_cycles        ` |  137,260 |  137,260 |  137,260 |  137,260 |
| `execute_metered_time_ms` | <span style='color: red'>(+3 [+2.7%])</span> 115 | -          | -          | -          |
| `execute_metered_insn_mi/s` | <span style='color: green'>(-0 [-2.5%])</span> 1.61 | -          | -          | -          |
| `execute_e3_time_ms  ` | <span style='color: red'>(+1 [+1.1%])</span> 91 | <span style='color: red'>(+1 [+1.1%])</span> 91 | <span style='color: red'>(+1 [+1.1%])</span> 91 | <span style='color: red'>(+1 [+1.1%])</span> 91 |
| `execute_e3_insn_mi/s` | <span style='color: green'>(-0 [-1.5%])</span> 1.50 | -          | <span style='color: green'>(-0 [-1.5%])</span> 1.50 | <span style='color: green'>(-0 [-1.5%])</span> 1.50 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+4 [+1.1%])</span> 357 | <span style='color: red'>(+4 [+1.1%])</span> 357 | <span style='color: red'>(+4 [+1.1%])</span> 357 | <span style='color: red'>(+4 [+1.1%])</span> 357 |
| `memory_finalize_time_ms` |  79 |  79 |  79 |  79 |
...
| `merkle_finalize_time_ms` | <span style='color: red'>(+3 [+4.2%])</span> 74 | <span style='color: red'>(+3 [+4.2%])</span> 74 | <span style='color: red'>(+3 [+4.2%])</span> 74 | <span style='color: red'>(+3 [+4.2%])</span> 74 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+2 [+0.2%])</span> 971 | <span style='color: red'>(+2 [+0.2%])</span> 971 | <span style='color: red'>(+2 [+0.2%])</span> 971 | <span style='color: red'>(+2 [+0.2%])</span> 971 |
| `main_trace_commit_time_ms` |  139 |  139 |  139 |  139 |
| `perm_trace_commit_time_ms` | <span style='color: red'>(+4 [+2.9%])</span> 141 | <span style='color: red'>(+4 [+2.9%])</span> 141 | <span style='color: red'>(+4 [+2.9%])</span> 141 | <span style='color: red'>(+4 [+2.9%])</span> 141 |
...
| `quotient_poly_commit_time_ms` |  139 |  139 |  139 |  139 |
| `pcs_opening_time_ms ` | <span style='color: green'>(-4 [-0.9%])</span> 419 | <span style='color: green'>(-4 [-0.9%])</span> 419 | <span style='color: green'>(-4 [-0.9%])</span> 419 | <span style='color: green'>(-4 [-0.9%])</span> 419 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  11,237 |  11,237 |  11,237 |  11,237 |
| `main_cells_used     ` |  241,888,502 |  241,888,502 |  241,888,502 |  241,888,502 |
| `total_cycles        ` |  2,934,895 |  2,934,895 |  2,934,895 |  2,934,895 |
| `execute_metered_time_ms` |  835 |  835 |  835 |  835 |
| `execute_metered_insn_mi/s` |  3.51 | -          | -          | -          |
| `execute_e3_time_ms  ` |  1,190 |  1,190 |  1,190 |  1,190 |
| `execute_e3_insn_mi/s` |  2.47 | -          |  2.47 |  2.47 |
| `trace_gen_time_ms   ` |  601 |  601 |  601 |  601 |
| `memory_finalize_time_ms` |  72 |  72 |  72 |  72 |
| `boundary_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  8,611 |  8,611 |  8,611 |  8,611 |
| `main_trace_commit_time_ms` |  1,682 |  1,682 |  1,682 |  1,682 |
| `perm_trace_commit_time_ms` |  2,340 |  2,340 |  2,340 |  2,340 |
| `quotient_poly_compute_time_ms` |  890 |  890 |  890 |  890 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program |  | 1 |  | 24 | 137,261 | 1 | 6,068 | 115 | 1.61 | 
| leaf | 11,385 |  | 1 |  |  | 1 |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 601 | 11,237 | 2,934,895 | 992,054,762 | 8,611 | 890 | 686 | 2,340 | 2,220 | 72 | 1,682 | 241,888,502 | 2,934,896 | 784 | 835 | 3.51 | 1,190 | 2.47 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 357 | 1,419 | 137,260 | 32,925,330 | 971 | 81 | 139 | 2,095 | 141 | 419 | 74 | 26 | 79 | 139 | 8,151,353 | 137,261 | 33 | 91 | 1.50 | 1 | 

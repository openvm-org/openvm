...
|:---|---:|---:|
| Total |  220.58 |  220.58 |
| kitchen_sink |  15.49 |  15.49 |
| leaf |  26.26 |  26.26 |
| internal_wrapper.1 |  5.82 |  5.82 |
| root |  38.68 |  38.68 |
| halo2_outer |  89.70 |  89.70 |
...
| `total_proof_time_ms ` |  15,487 |  15,487 |  15,487 |  15,487 |
...
| `memory_finalize_time_ms` |  83 |  83 |  83 |  83 |
| `boundary_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `merkle_finalize_time_ms` |  78 |  78 |  78 |  78 |
| `stark_prove_excluding_trace_time_ms` |  14,930 |  14,930 |  14,930 |  14,930 |
| `main_trace_commit_time_ms` |  5,044 |  5,044 |  5,044 |  5,044 |
| `perm_trace_commit_time_ms` |  1,503 |  1,503 |  1,503 |  1,503 |
| `quotient_poly_compute_time_ms` |  6,259 |  6,259 |  6,259 |  6,259 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  26,262 |  26,262 |  26,262 |  26,262 |
| `main_cells_used     ` |  732,640,597 |  732,640,597 |  732,640,597 |  732,640,597 |
| `total_cycles        ` |  7,991,153 |  7,991,153 |  7,991,153 |  7,991,153 |
| `execute_metered_time_ms` |  2,106 |  2,106 |  2,106 |  2,106 |
| `execute_metered_insn_mi/s` |  3.79 | -          | -          | -          |
| `execute_e3_time_ms  ` |  3,086 |  3,086 |  3,086 |  3,086 |
| `execute_e3_insn_mi/s` |  2.59 | -          |  2.59 |  2.59 |
| `trace_gen_time_ms   ` |  1,633 |  1,633 |  1,633 |  1,633 |
| `memory_finalize_time_ms` |  113 |  113 |  113 |  113 |
| `boundary_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  19,437 |  19,437 |  19,437 |  19,437 |
| `main_trace_commit_time_ms` |  4,181 |  4,181 |  4,181 |  4,181 |
| `perm_trace_commit_time_ms` |  5,413 |  5,413 |  5,413 |  5,413 |
| `quotient_poly_compute_time_ms` |  2,107 |  2,107 |  2,107 |  2,107 |
| `quotient_poly_commit_time_ms` |  1,441 |  1,441 |  1,441 |  1,441 |
| `pcs_opening_time_ms ` |  4,690 |  4,690 |  4,690 |  4,690 |

| internal_wrapper.1 |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  5,819 |  5,819 |  5,819 |  5,819 |
| `main_cells_used     ` |  73,687,213 |  73,687,213 |  73,687,213 |  73,687,213 |
| `total_cycles        ` |  1,197,812 |  1,197,812 |  1,197,812 |  1,197,812 |
| `execute_metered_time_ms` |  474 |  474 |  474 |  474 |
| `execute_metered_insn_mi/s` |  2.53 | -          | -          | -          |
| `execute_e3_time_ms  ` |  569 |  569 |  569 |  569 |
| `execute_e3_insn_mi/s` |  2.10 | -          |  2.10 |  2.10 |
| `trace_gen_time_ms   ` |  205 |  205 |  205 |  205 |
| `memory_finalize_time_ms` |  22 |  22 |  22 |  22 |
| `boundary_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  4,571 |  4,571 |  4,571 |  4,571 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  38,678 |  38,678 |  38,678 |  38,678 |
| `main_cells_used     ` |  38,506,280 |  38,506,280 |  38,506,280 |  38,506,280 |
| `total_cycles        ` |  772,560 |  772,560 |  772,560 |  772,560 |
| `execute_e3_time_ms  ` |  259 |  259 |  259 |  259 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  89,696 |  89,696 |  89,696 |  89,696 |
| `main_cells_used     ` |  65,626,678 |  65,626,678 |  65,626,678 |  65,626,678 |

| halo2_wrapper |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  44,493 |  44,493 |  44,493 |  44,493 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
|  | 5,858 | 89,712 | 44,493 | 17 | 1,198,285 | 200 | 3.86 | 256 | 3.02 | 0 | 23,365 | 38,694 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| halo2_outer |  | 89,696 |  |  |  |  |  |  |  |  |  |  |  |  |  | 65,626,678 |  |  |  |  |  |  |  |  |  | 
| halo2_wrapper |  | 44,493 |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  | 
| internal_wrapper.1 | 205 | 5,819 | 1,197,812 | 224,975,330 | 4,571 |  | 613 | 745 | 737 | 1,245 |  |  |  | 22 | 1,029 | 73,687,213 | 1,197,813 | 196 | 2 |  | 474 | 2.53 | 569 | 2.10 | 0 | 
| kitchen_sink |  |  |  |  |  |  |  |  |  |  | 1 |  | 23 |  |  |  | 154,596 |  | 1 | 22,785 | 144 | 5.55 |  |  |  | 
| leaf |  |  |  |  |  | 26,632 |  |  |  |  |  | 1 |  |  |  |  |  |  | 1 |  |  |  |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,633 | 26,262 | 7,991,153 | 2,500,267,498 | 19,437 | 2,107 | 1,441 | 5,413 | 4,690 | 113 | 4,181 | 732,640,597 | 7,991,154 | 1,597 |  | 2,106 | 3.79 | 3,086 | 2.59 | 0 | 
| root | 0 | 120 | 38,678 | 772,560 | 80,435,354 | 38,299 | 684 | 13,721 | 7,584 | 3,893 | 17 | 12,317 | 38,506,280 | 772,561 | 90 | 3 |  |  | 259 | 2.98 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| kitchen_sink | 0 | 490 | 15,487 | 154,595 | 1,481,195,140 | 14,930 | 6,259 | 307 | 18,823 | 1,503 | 1,231 | 78 | 24 | 83 | 5,044 | 898,132,732 | 154,596 | 542 | 67 | 2.28 | 0 | 

...
|:---|---:|---:|
| Total | <span style='color: red'>(+0 [+8.5%])</span> 1.61 | <span style='color: red'>(+0 [+13.4%])</span> 1.02 |
| pairing | <span style='color: red'>(+0 [+8.8%])</span> 1.54 | <span style='color: red'>(+0 [+14.3%])</span> 0.95 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+62 [+8.8%])</span> 771.50 | <span style='color: red'>(+125 [+8.8%])</span> 1,543 | <span style='color: red'>(+118 [+14.3%])</span> 946 | <span style='color: red'>(+7 [+1.2%])</span> 597 |
| `main_cells_used     ` |  12,734,105 |  25,468,210 |  16,059,916 |  9,408,294 |
| `total_cells_used    ` |  27,501,699 |  55,003,398 |  32,689,110 |  22,314,288 |
| `execute_metered_time_ms` | <span style='color: red'>(+2 [+2.9%])</span> 70 | -          | -          | -          |
| `execute_metered_insn_mi/s` | <span style='color: green'>(-1 [-3.9%])</span> 24.64 | -          | <span style='color: green'>(-1 [-3.9%])</span> 24.64 | <span style='color: green'>(-1 [-3.9%])</span> 24.64 |
...
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+0 [+1.8%])</span> 14.75 | -          | <span style='color: red'>(+0 [+2.3%])</span> 18.51 | <span style='color: red'>(+0 [+0.9%])</span> 10.100 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+1 [+0.5%])</span> 187 | <span style='color: red'>(+2 [+0.5%])</span> 374 | <span style='color: red'>(+4 [+2.1%])</span> 194 | <span style='color: green'>(-2 [-1.1%])</span> 180 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+11 [+3.2%])</span> 352.50 | <span style='color: red'>(+22 [+3.2%])</span> 705 | <span style='color: red'>(+13 [+3.3%])</span> 402 | <span style='color: red'>(+9 [+3.1%])</span> 303 |
| `main_trace_commit_time_ms` | <span style='color: red'>(+1 [+1.6%])</span> 63.50 | <span style='color: red'>(+2 [+1.6%])</span> 127 | <span style='color: red'>(+3 [+4.2%])</span> 74 | <span style='color: green'>(-1 [-1.9%])</span> 53 |
| `generate_perm_trace_time_ms` | <span style='color: red'>(+14 [+38.9%])</span> 50 | <span style='color: red'>(+28 [+38.9%])</span> 100 | <span style='color: red'>(+16 [+40.0%])</span> 56 | <span style='color: red'>(+12 [+37.5%])</span> 44 |
| `perm_trace_commit_time_ms` | <span style='color: green'>(-1 [-0.9%])</span> 76.35 | <span style='color: green'>(-1 [-0.9%])</span> 152.71 | <span style='color: green'>(-2 [-1.9%])</span> 87.63 | <span style='color: red'>(+0 [+0.4%])</span> 65.08 |
| `quotient_poly_compute_time_ms` | <span style='color: green'>(-1 [-0.8%])</span> 78.52 | <span style='color: green'>(-1 [-0.8%])</span> 157.04 | <span style='color: green'>(-1 [-0.9%])</span> 86.80 | <span style='color: green'>(-1 [-0.7%])</span> 70.23 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+1 [+4.9%])</span> 16.72 | <span style='color: red'>(+2 [+4.9%])</span> 33.44 | <span style='color: red'>(+2 [+8.9%])</span> 19.02 | <span style='color: red'>(+0 [+0.1%])</span> 14.43 |
| `pcs_opening_time_ms ` | <span style='color: green'>(-4 [-5.3%])</span> 62.50 | <span style='color: green'>(-7 [-5.3%])</span> 125 | <span style='color: green'>(-5 [-6.3%])</span> 74 | <span style='color: green'>(-2 [-3.8%])</span> 51 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 597 | 1 | 70 | 1,745,742 | 24.64 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 180 | 946 | 32,689,110 | 172,558,444 | 180 | 402 | 0 | 86.80 | 19.02 | 7 | 87.63 | 74 | 147 | 74 | 1 | 74 | 16,059,916 | 56 | 108 | 1,157,000 | 10.100 | 26 | 106 | 1 | 74 | 
| pairing | 1 | 194 | 597 | 22,314,288 | 119,958,502 | 194 | 303 | 1 | 70.23 | 14.43 | 5 | 65.08 | 51 | 111 | 51 | 0 | 53 | 9,408,294 | 44 | 59 | 588,742 | 18.51 | 20 | 85 | 1 | 51 | 

...
|:---|---:|---:|
| Total | <span style='color: red'>(+0 [+0.8%])</span> 1.52 | <span style='color: red'>(+0 [+0.7%])</span> 0.89 |
| pairing | <span style='color: red'>(+0 [+0.7%])</span> 1.45 | <span style='color: red'>(+0 [+0.5%])</span> 0.82 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+5 [+0.7%])</span> 725.50 | <span style='color: red'>(+10 [+0.7%])</span> 1,451 | <span style='color: red'>(+4 [+0.5%])</span> 821 | <span style='color: red'>(+6 [+1.0%])</span> 630 |
...
| `execute_metered_insn_mi/s` | <span style='color: green'>(-1 [-2.9%])</span> 24.89 | -          | <span style='color: green'>(-1 [-2.9%])</span> 24.89 | <span style='color: green'>(-1 [-2.9%])</span> 24.89 |
| `execute_preflight_insns` |  872,871 |  1,745,742 |  1,149,000 |  596,742 |
| `execute_preflight_time_ms` | <span style='color: red'>(+4 [+4.2%])</span> 87.50 | <span style='color: red'>(+7 [+4.2%])</span> 175 | <span style='color: red'>(+2 [+1.9%])</span> 110 | <span style='color: red'>(+5 [+8.3%])</span> 65 |
| `execute_preflight_insn_mi/s` |  14.64 | -          | <span style='color: red'>(+0 [+1.2%])</span> 18.48 | <span style='color: green'>(-0 [-1.9%])</span> 10.79 |
| `trace_gen_time_ms   ` | <span style='color: green'>(-3 [-1.6%])</span> 184 | <span style='color: green'>(-6 [-1.6%])</span> 368 | <span style='color: green'>(-3 [-1.6%])</span> 190 | <span style='color: green'>(-3 [-1.7%])</span> 178 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+6 [+1.7%])</span> 362 | <span style='color: red'>(+12 [+1.7%])</span> 724 | <span style='color: red'>(+7 [+1.8%])</span> 390 | <span style='color: red'>(+5 [+1.5%])</span> 334 |
| `main_trace_commit_time_ms` |  64 |  128 |  74 |  54 |
| `generate_perm_trace_time_ms` |  37 |  74 |  38 |  36 |
| `perm_trace_commit_time_ms` | <span style='color: green'>(-0 [-0.4%])</span> 76.24 | <span style='color: green'>(-1 [-0.4%])</span> 152.48 | <span style='color: red'>(+0 [+0.3%])</span> 88.49 | <span style='color: green'>(-1 [-1.3%])</span> 63.99 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+1 [+1.1%])</span> 78.92 | <span style='color: red'>(+2 [+1.1%])</span> 157.84 | <span style='color: red'>(+1 [+0.7%])</span> 87.01 | <span style='color: red'>(+1 [+1.6%])</span> 70.84 |
| `quotient_poly_commit_time_ms` |  16.28 |  32.56 | <span style='color: green'>(-1 [-4.4%])</span> 17.99 | <span style='color: red'>(+1 [+6.0%])</span> 14.57 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+5 [+6.3%])</span> 84.50 | <span style='color: red'>(+10 [+6.3%])</span> 169 | <span style='color: red'>(+3 [+3.6%])</span> 87 | <span style='color: red'>(+7 [+9.3%])</span> 82 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 630 | 1 | 70 | 1,745,742 | 24.89 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 178 | 821 | 32,480,114 | 172,558,444 | 178 | 390 | 0 | 87.01 | 17.99 | 6 | 88.49 | 82 | 127 | 82 | 1 | 74 | 15,909,408 | 36 | 110 | 1,149,000 | 10.79 | 26 | 105 | 1 | 82 | 
| pairing | 1 | 190 | 630 | 22,464,232 | 119,958,502 | 190 | 334 | 1 | 70.84 | 14.57 | 6 | 63.99 | 87 | 106 | 86 | 0 | 54 | 9,498,894 | 38 | 65 | 596,742 | 18.48 | 20 | 86 | 1 | 86 | 

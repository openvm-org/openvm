...
| `total_proof_time_ms ` |  720 |  1,440 |  817 | <span style='color: green'>(-1 [-0.2%])</span> 623 |
...
| `execute_metered_insn_mi/s` | <span style='color: green'>(-0 [-0.2%])</span> 25.59 | -          | <span style='color: green'>(-0 [-0.2%])</span> 25.59 | <span style='color: green'>(-0 [-0.2%])</span> 25.59 |
...
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+0 [+1.9%])</span> 14.91 | -          | <span style='color: red'>(+1 [+2.9%])</span> 18.79 | <span style='color: red'>(+0 [+0.4%])</span> 11.03 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+4 [+1.9%])</span> 190.50 | <span style='color: red'>(+7 [+1.9%])</span> 381 | <span style='color: red'>(+2 [+1.0%])</span> 195 | <span style='color: red'>(+5 [+2.8%])</span> 186 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: green'>(-3 [-0.8%])</span> 353 | <span style='color: green'>(-6 [-0.8%])</span> 706 | <span style='color: green'>(-3 [-0.8%])</span> 380 | <span style='color: green'>(-3 [-0.9%])</span> 326 |
...
| `generate_perm_trace_time_ms` | <span style='color: red'>(+1 [+2.7%])</span> 38 | <span style='color: red'>(+2 [+2.7%])</span> 76 | <span style='color: red'>(+2 [+5.3%])</span> 40 |  36 |
| `perm_trace_commit_time_ms` | <span style='color: red'>(+2 [+2.1%])</span> 78.11 | <span style='color: red'>(+3 [+2.1%])</span> 156.23 | <span style='color: red'>(+2 [+2.7%])</span> 90.59 | <span style='color: red'>(+1 [+1.3%])</span> 65.64 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+1 [+1.5%])</span> 79.23 | <span style='color: red'>(+2 [+1.5%])</span> 158.46 | <span style='color: red'>(+1 [+1.0%])</span> 87.31 | <span style='color: red'>(+1 [+2.0%])</span> 71.15 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+0 [+0.7%])</span> 16.39 | <span style='color: red'>(+0 [+0.7%])</span> 32.79 | <span style='color: green'>(-1 [-5.1%])</span> 17.86 | <span style='color: red'>(+1 [+8.7%])</span> 14.93 |
| `pcs_opening_time_ms ` | <span style='color: green'>(-8 [-9.4%])</span> 72 | <span style='color: green'>(-15 [-9.4%])</span> 144 | <span style='color: green'>(-6 [-7.1%])</span> 78 | <span style='color: green'>(-9 [-12.0%])</span> 66 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 623 | 1 | 68 | 1,745,742 | 25.59 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 186 | 817 | 32,480,114 | 172,558,444 | 186 | 380 | 0 | 87.31 | 17.86 | 6 | 90.59 | 66 | 133 | 65 | 1 | 74 | 15,909,408 | 40 | 107 | 1,149,000 | 11.03 | 26 | 106 | 1 | 65 | 
| pairing | 1 | 195 | 623 | 22,464,232 | 119,958,502 | 195 | 326 | 1 | 71.15 | 14.93 | 6 | 65.64 | 78 | 105 | 77 | 0 | 55 | 9,498,894 | 36 | 60 | 596,742 | 18.79 | 20 | 86 | 1 | 77 | 

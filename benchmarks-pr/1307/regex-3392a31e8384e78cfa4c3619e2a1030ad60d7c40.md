...
|:---|---:|---:|
| Total | <span style='color: green'>(-0 [-0.5%])</span> 15.21 | <span style='color: green'>(-0 [-0.1%])</span> 8.56 |
| regex_program | <span style='color: green'>(-0 [-0.5%])</span> 15.21 | <span style='color: green'>(-0 [-0.1%])</span> 8.56 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: green'>(-36 [-0.5%])</span> 7,607.50 | <span style='color: green'>(-72 [-0.5%])</span> 15,215 | <span style='color: green'>(-12 [-0.1%])</span> 8,560 | <span style='color: green'>(-60 [-0.9%])</span> 6,655 |
| `main_cells_used     ` |  82,727,686.50 |  165,455,373 |  92,686,348 |  72,769,025 |
| `total_cycles        ` |  1,914,103 |  1,914,103 |  1,914,103 |  1,914,103 |
| `execute_time_ms     ` | <span style='color: red'>(+2 [+0.3%])</span> 452 | <span style='color: red'>(+3 [+0.3%])</span> 904 | <span style='color: red'>(+1 [+0.2%])</span> 486 | <span style='color: red'>(+2 [+0.5%])</span> 418 |
| `trace_gen_time_ms   ` | <span style='color: green'>(-4 [-0.3%])</span> 1,682 | <span style='color: green'>(-9 [-0.3%])</span> 3,364 | <span style='color: green'>(-6 [-0.3%])</span> 1,861 | <span style='color: green'>(-3 [-0.2%])</span> 1,503 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: green'>(-33 [-0.6%])</span> 5,473.50 | <span style='color: green'>(-66 [-0.6%])</span> 10,947 | <span style='color: green'>(-7 [-0.1%])</span> 6,213 | <span style='color: green'>(-59 [-1.2%])</span> 4,734 |
| `main_trace_commit_time_ms` | <span style='color: green'>(-4 [-0.4%])</span> 1,090 | <span style='color: green'>(-8 [-0.4%])</span> 2,180 |  1,340 | <span style='color: green'>(-7 [-0.8%])</span> 840 |
| `generate_perm_trace_time_ms` | <span style='color: red'>(+2 [+1.1%])</span> 176.50 | <span style='color: red'>(+4 [+1.1%])</span> 353 | <span style='color: red'>(+7 [+3.8%])</span> 193 | <span style='color: green'>(-3 [-1.8%])</span> 160 |
| `perm_trace_commit_time_ms` | <span style='color: green'>(-4 [-0.3%])</span> 1,174.50 | <span style='color: green'>(-8 [-0.3%])</span> 2,349 | <span style='color: green'>(-4 [-0.3%])</span> 1,241 | <span style='color: green'>(-4 [-0.4%])</span> 1,108 |
| `quotient_poly_compute_time_ms` | <span style='color: green'>(-12 [-1.6%])</span> 728.50 | <span style='color: green'>(-23 [-1.6%])</span> 1,457 | <span style='color: green'>(-17 [-2.0%])</span> 850 | <span style='color: green'>(-6 [-1.0%])</span> 607 |
| `quotient_poly_commit_time_ms` | <span style='color: green'>(-4 [-0.5%])</span> 980 | <span style='color: green'>(-9 [-0.5%])</span> 1,960 | <span style='color: red'>(+6 [+0.5%])</span> 1,145 | <span style='color: green'>(-15 [-1.8%])</span> 815 |
| `pcs_opening_time_ms ` | <span style='color: green'>(-12 [-0.9%])</span> 1,312 | <span style='color: green'>(-23 [-0.9%])</span> 2,624 |  1,435 | <span style='color: green'>(-23 [-1.9%])</span> 1,189 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,861 | 8,560 |  | 209,921,543 | 6,213 | 850 | 1,145 | 1,241 | 1,435 | 1,340 | 92,686,348 | 193 | 486 | 
| regex_program | 1 | 1,503 | 6,655 | 1,914,103 | 149,454,692 | 4,734 | 607 | 815 | 1,108 | 1,189 | 840 | 72,769,025 | 160 | 418 | 

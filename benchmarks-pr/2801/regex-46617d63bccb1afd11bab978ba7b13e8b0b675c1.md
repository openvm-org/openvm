...
|:---|---:|---:|---:|
| Total |  2.35 |  1.76 |  1.76 |
| app_proof |  1.49 |  0.90 |  0.90 |
| leaf |  0.36 |  0.36 |  0.36 |
...
| `total_proof_time_ms ` |  729 |  1,458 |  866 |  592 |
| `execute_metered_time_ms` |  33 | -          | -          | -          |
| `execute_metered_insns` |  4,090,656 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  122.31 | -          |  122.31 |  122.31 |
| `execute_preflight_insns` |  2,045,328 |  4,090,656 |  2,327,000 |  1,763,656 |
| `execute_preflight_time_ms` |  89.50 |  179 |  100 |  79 |
| `execute_preflight_insn_mi/s` |  30.77 | -          |  32.33 |  29.20 |
| `trace_gen_time_ms   ` |  34.50 |  69 |  41 |  28 |
| `memory_finalize_time_ms` |  1 |  2 |  2 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  516 |  1,032 |  602 |  430 |
| `prover.main_trace_commit_time_ms` |  116.50 |  233 |  131 |  102 |
| `prover.rap_constraints_time_ms` |  353 |  706 |  421 |  285 |
| `prover.openings_time_ms` |  46 |  92 |  50 |  42 |
| `prover.rap_constraints.logup_gkr_time_ms` |  217 |  434 |  288 |  146 |
| `prover.rap_constraints.round0_time_ms` |  95 |  190 |  103 |  87 |
...
| `prover.openings.whir_time_ms` |  22.50 |  45 |  24 |  21 |
...
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  308 |  308 |  308 |  308 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/46617d63bccb1afd11bab978ba7b13e8b0b675c1/regex-46617d63bccb1afd11bab978ba7b13e8b0b675c1.memory.svg)

| Module | Max (GB) | Max At |
| --- | ---: | --- |
| prover.batch_constraints.before_round0 | 4.65 | app_proof.prover.0 |
| frac_sumcheck.gkr_rounds | 4.65 | app_proof.prover.0 |
...
| app_proof |  |  |  |  |  | 592 |  |  | 33 | 4,090,656 | 122.31 | 0 | 1,506 |  | 
| internal_for_leaf |  |  |  | 223 |  |  |  |  |  |  |  |  |  | 223 | 
| internal_recursive.0 |  |  |  | 147 |  |  |  |  |  |  |  |  |  | 147 | 
...
| app_proof | 12 | XorinVmAir | prover | 1 | 1 | 673 | 673 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 15 | 223 | 15 | 4 | 0 | 2 | 1 | 1 | 
| internal_recursive.0 | 1 | 9 | 147 | 9 | 1 | 0 | 2 | 0 | 0 | 
| internal_recursive.1 | 1 | 9 | 129 | 8 | 1 | 0 | 1 | 0 | 0 | 
| leaf | 0 | 50 | 358 | 49 | 14 | 3 | 4 | 1 | 1 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 27,289,339 | 207 | 82 | 0 | 0 | 97 | 31 | 30 | 45 | 19 | 0 | 28 | 16 | 11 | 2 | 8 | 82 | 97 | 0 | 2 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,703 | 137 | 46 | 0 | 0 | 67 | 25 | 24 | 28 | 13 | 0 | 23 | 15 | 8 | 1 | 6 | 46 | 67 | 0 | 2 | 12 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 120 | 31 | 0 | 0 | 62 | 24 | 24 | 24 | 13 | 0 | 26 | 18 | 7 | 1 | 5 | 32 | 62 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 79,659,764 | 308 | 128 | 0 | 0 | 136 | 56 | 55 | 37 | 43 | 0 | 42 | 26 | 15 | 6 | 8 | 128 | 136 | 0 | 5 | 41 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 164,023,250 | 602 | 130 | 0 | 0 | 421 | 87 | 86 | 45 | 288 | 67 | 50 | 24 | 25 | 14 | 11 | 131 | 421 | 0 | 3 | 219 | 0 | 0 | 
| app_proof | prover | 1 | 125,436,433 | 430 | 102 | 0 | 8 | 285 | 103 | 102 | 35 | 146 | 0 | 42 | 21 | 20 | 10 | 10 | 102 | 285 | 0 | 2 | 145 | 0 | 0 | 

| group | phase | segment | trace_height_constraint | weighted_sum | threshold |
| --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 0 | 73,851,085 | 2,013,265,921 | 
| app_proof | prover | 1 | 0 | 53,443,131 | 2,013,265,921 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 28 | 866 | 28 | 135 | 2 | 4 | 100 | 2,327,000 | 29.20 | 
| app_proof | 1 | 41 | 592 | 41 | 40 | 0 | 2 | 79 | 1,763,656 | 32.33 | 

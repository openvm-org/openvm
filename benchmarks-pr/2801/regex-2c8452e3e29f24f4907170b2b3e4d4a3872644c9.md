...
| `total_proof_time_ms ` |  785.50 |  1,571 |  901 |  670 |
| `execute_metered_time_ms` |  34 | -          | -          | -          |
| `execute_metered_insns` |  4,090,656 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  117.99 | -          |  117.99 |  117.99 |
| `execute_preflight_insns` |  2,045,328 |  4,090,656 |  2,327,000 |  1,763,656 |
| `execute_preflight_time_ms` |  88 |  176 |  96 |  80 |
| `execute_preflight_insn_mi/s` |  30.77 | -          |  31.09 |  30.45 |
| `trace_gen_time_ms   ` |  34 |  68 |  38 |  30 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  573.50 |  1,147 |  637 |  510 |
| `prover.main_trace_commit_time_ms` |  114.50 |  229 |  128 |  101 |
| `prover.rap_constraints_time_ms` |  409.50 |  819 |  455 |  364 |
| `prover.openings_time_ms` |  48.50 |  97 |  53 |  44 |
| `prover.rap_constraints.logup_gkr_time_ms` |  274.50 |  549 |  323 |  226 |
| `prover.rap_constraints.round0_time_ms` |  93.50 |  187 |  101 |  86 |
...
| `prover.openings.whir_time_ms` |  25 |  50 |  27 |  23 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/2c8452e3e29f24f4907170b2b3e4d4a3872644c9/regex-2c8452e3e29f24f4907170b2b3e4d4a3872644c9.memory.svg)
...
| app_proof |  |  |  |  |  | 670 |  |  | 34 | 4,090,656 | 117.99 | 0 | 1,619 |  | 
| internal_for_leaf |  |  |  | 226 |  |  |  |  |  |  |  |  |  | 227 | 
| internal_recursive.0 |  |  |  | 149 |  |  |  |  |  |  |  |  |  | 149 | 
| internal_recursive.1 |  |  |  | 123 |  |  |  |  |  |  |  |  |  | 123 | 
| leaf |  |  | 352 |  |  |  |  |  |  |  |  |  |  | 352 | 
...
| internal_recursive.1 | 1 | 9 | 123 | 9 | 1 | 0 | 2 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 27,289,339 | 211 | 80 | 0 | 0 | 97 | 31 | 31 | 45 | 19 | 0 | 33 | 21 | 11 | 2 | 8 | 81 | 97 | 0 | 2 | 18 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,703 | 139 | 46 | 0 | 0 | 67 | 24 | 24 | 28 | 14 | 0 | 25 | 16 | 8 | 1 | 6 | 46 | 67 | 0 | 2 | 12 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 114 | 31 | 0 | 0 | 59 | 22 | 21 | 24 | 13 | 0 | 23 | 15 | 7 | 1 | 5 | 32 | 59 | 0 | 2 | 12 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 164,023,250 | 637 | 128 | 0 | 0 | 455 | 86 | 86 | 44 | 323 | 84 | 53 | 27 | 25 | 13 | 11 | 128 | 454 | 0 | 3 | 239 | 0 | 0 | 
| app_proof | prover | 1 | 125,436,227 | 510 | 101 | 0 | 8 | 364 | 101 | 101 | 35 | 226 | 0 | 44 | 23 | 20 | 10 | 10 | 101 | 364 | 0 | 3 | 224 | 0 | 0 | 

| group | phase | segment | trace_height_constraint | weighted_sum | threshold |
| --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 0 | 91,152,589 | 2,013,265,921 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 30 | 901 | 30 | 136 | 1 | 5 | 96 | 2,327,000 | 30.45 | 
| app_proof | 1 | 38 | 670 | 38 | 40 | 0 | 2 | 80 | 1,763,656 | 31.09 | 

...
|:---|---:|---:|---:|
| Total |  11.48 |  4.66 |  4.66 |
| app_proof |  9.40 |  2.57 |  2.57 |
| leaf |  1.41 |  1.41 |  1.41 |
...
| `total_proof_time_ms ` |  2,325.25 |  9,301 |  2,476 |  2,221 |
| `execute_metered_time_ms` |  97 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  114.38 | -          |  114.38 |  114.38 |
| `execute_preflight_insns` |  2,791,990.25 |  11,167,961 |  2,851,000 |  2,614,961 |
| `execute_preflight_time_ms` |  176.75 |  707 |  222 |  109 |
| `execute_preflight_insn_mi/s` |  31.80 | -          |  32.62 |  29.62 |
| `trace_gen_time_ms   ` |  57.75 |  231 |  63 |  54 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  2,024.50 |  8,098 |  2,164 |  1,942 |
| `prover.main_trace_commit_time_ms` |  539 |  2,156 |  629 |  508 |
| `prover.rap_constraints_time_ms` |  1,347 |  5,388 |  1,395 |  1,295 |
| `prover.openings_time_ms` |  137.25 |  549 |  141 |  135 |
| `prover.rap_constraints.logup_gkr_time_ms` |  365.75 |  1,463 |  420 |  313 |
| `prover.rap_constraints.round0_time_ms` |  665.25 |  2,661 |  675 |  659 |
| `prover.rap_constraints.mle_rounds_time_ms` |  314.75 |  1,259 |  317 |  312 |
| `prover.openings.stacked_reduction_time_ms` |  99.50 |  398 |  101 |  99 |
| `prover.openings.stacked_reduction.round0_time_ms` |  60 |  240 |  61 |  59 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  38.75 |  155 |  40 |  38 |
| `prover.openings.whir_time_ms` |  37.25 |  149 |  39 |  36 |
...
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,263 |  1,263 |  1,263 |  1,263 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/46617d63bccb1afd11bab978ba7b13e8b0b675c1/sha2_bench-46617d63bccb1afd11bab978ba7b13e8b0b675c1.memory.svg)

| Module | Max (GB) | Max At |
| --- | ---: | --- |
| prover.batch_constraints.before_round0 | 11.11 | app_proof.prover.3 |
| frac_sumcheck.gkr_rounds | 11.11 | app_proof.prover.3 |
| prover.rap_constraints | 11.05 | app_proof.prover.0 |
| prover.gkr_input_evals | 11.02 | app_proof.prover.0 |
| frac_sumcheck.segment_tree | 11.02 | app_proof.prover.0 |
| prover.batch_constraints.round0 | 10.47 | app_proof.prover.0 |
| prover.batch_constraints.fold_ple_evals | 10.47 | app_proof.prover.0 |
| prover.openings | 9.85 | app_proof.prover.0 |
| prover.merkle_tree | 9.85 | app_proof.prover.0 |
| prover.prove_whir_opening | 9.85 | app_proof.prover.0 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 74 | 9 |  |  | 0 |  | 351 | 9 |  |  |  |  |  |  | 
| app_proof |  |  |  |  |  | 2,221 |  |  | 97 | 11,167,961 | 114.38 | 0 | 9,407 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 61,220,603 | 354 | 184 | 0 | 0 | 130 | 38 | 37 | 65 | 27 | 0 | 39 | 20 | 18 | 5 | 12 | 184 | 130 | 0 | 3 | 26 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,879 | 150 | 48 | 0 | 0 | 73 | 26 | 25 | 29 | 17 | 0 | 27 | 19 | 8 | 1 | 6 | 49 | 73 | 0 | 2 | 16 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 119 | 31 | 0 | 0 | 61 | 23 | 22 | 24 | 13 | 0 | 26 | 18 | 7 | 1 | 5 | 31 | 61 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 425,198,438 | 1,263 | 805 | 0 | 161 | 350 | 171 | 170 | 103 | 75 | 0 | 106 | 42 | 64 | 36 | 27 | 805 | 350 | 0 | 7 | 74 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 647,069,949 | 2,164 | 629 | 0 | 124 | 1,393 | 659 | 658 | 317 | 416 | 117 | 141 | 39 | 101 | 61 | 40 | 629 | 1,393 | 0 | 4 | 298 | 0 | 0 | 
| app_proof | prover | 1 | 647,069,708 | 2,042 | 508 | 0 | 2 | 1,395 | 659 | 658 | 316 | 420 | 127 | 137 | 37 | 99 | 60 | 38 | 508 | 1,395 | 0 | 3 | 291 | 0 | 0 | 
| app_proof | prover | 2 | 647,069,708 | 1,950 | 508 | 0 | 2 | 1,305 | 675 | 674 | 314 | 314 | 0 | 135 | 36 | 99 | 60 | 38 | 509 | 1,305 | 0 | 3 | 313 | 0 | 0 | 
| app_proof | prover | 3 | 647,069,956 | 1,942 | 509 | 0 | 2 | 1,295 | 668 | 668 | 312 | 313 | 0 | 136 | 37 | 99 | 59 | 39 | 510 | 1,295 | 0 | 3 | 312 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 63 | 2,476 | 63 | 138 | 0 | 3 | 109 | 2,851,000 | 29.62 | 
| app_proof | 1 | 57 | 2,363 | 57 | 41 | 0 | 1 | 222 | 2,851,000 | 32.57 | 
| app_proof | 2 | 57 | 2,241 | 57 | 41 | 0 | 1 | 192 | 2,851,000 | 32.39 | 
| app_proof | 3 | 54 | 2,221 | 54 | 41 | 0 | 1 | 184 | 2,614,961 | 32.62 | 

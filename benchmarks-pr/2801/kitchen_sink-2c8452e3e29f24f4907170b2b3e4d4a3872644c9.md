...
| `total_proof_time_ms ` |  999.50 |  1,999 |  1,560 |  439 |
| `execute_metered_time_ms` |  24 | -          | -          | -          |
| `execute_metered_insns` |  1,979,971 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  81.65 | -          |  81.65 |  81.65 |
| `execute_preflight_insns` |  989,985.50 |  1,979,971 |  1,445,000 |  534,971 |
| `execute_preflight_time_ms` |  75 |  150 |  84 |  66 |
| `execute_preflight_insn_mi/s` |  30.44 | -          |  31.53 |  29.36 |
| `trace_gen_time_ms   ` |  28.50 |  57 |  46 |  11 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  807 |  1,614 |  1,312 |  302 |
| `prover.main_trace_commit_time_ms` |  274 |  548 |  476 |  72 |
| `prover.rap_constraints_time_ms` |  485 |  970 |  767 |  203 |
| `prover.openings_time_ms` |  47.50 |  95 |  68 |  27 |
| `prover.rap_constraints.logup_gkr_time_ms` |  81 |  162 |  125 |  37 |
| `prover.rap_constraints.round0_time_ms` |  275 |  550 |  432 |  118 |
| `prover.rap_constraints.mle_rounds_time_ms` |  128 |  256 |  209 |  47 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/2c8452e3e29f24f4907170b2b3e4d4a3872644c9/kitchen_sink-2c8452e3e29f24f4907170b2b3e4d4a3872644c9.memory.svg)
...
| app_proof |  |  |  |  |  | 439 |  |  | 24 | 1,979,971 | 81.65 | 0 | 2,027 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,577,915 | 121 | 38 | 0 | 1 | 62 | 21 | 20 | 29 | 12 | 0 | 19 | 11 | 7 | 1 | 5 | 38 | 62 | 0 | 1 | 11 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,703 | 78 | 16 | 0 | 0 | 47 | 17 | 16 | 20 | 9 | 0 | 14 | 8 | 5 | 1 | 4 | 16 | 47 | 0 | 1 | 9 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 75 | 11 | 0 | 0 | 48 | 20 | 19 | 18 | 10 | 0 | 14 | 9 | 5 | 0 | 4 | 11 | 48 | 0 | 1 | 9 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 903,946,916 | 1,312 | 475 | 0 | 269 | 767 | 432 | 431 | 209 | 125 | 66 | 68 | 16 | 52 | 24 | 27 | 476 | 767 | 0 | 1 | 59 | 0 | 0 | 
| app_proof | prover | 1 | 280,522,636 | 302 | 72 | 0 | 1 | 203 | 118 | 118 | 47 | 37 | 0 | 27 | 10 | 16 | 7 | 9 | 72 | 203 | 0 | 1 | 36 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 46 | 1,560 | 46 | 135 | 0 | 3 | 66 | 1,445,000 | 29.36 | 
| app_proof | 1 | 11 | 439 | 11 | 40 | 0 | 1 | 84 | 534,971 | 31.53 | 

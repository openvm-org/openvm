...
|:---|---:|---:|---:|
| Total |  2.76 |  2.32 |  2.32 |
| app_proof |  2.04 |  1.60 |  1.60 |
| leaf |  0.41 |  0.41 |  0.41 |
...
| `total_proof_time_ms ` |  1,008.50 |  2,017 |  1,577 |  440 |
| `execute_metered_time_ms` |  24 | -          | -          | -          |
| `execute_metered_insns` |  1,979,971 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  80.98 | -          |  80.98 |  80.98 |
| `execute_preflight_insns` |  989,985.50 |  1,979,971 |  1,445,000 |  534,971 |
| `execute_preflight_time_ms` |  75.50 |  151 |  85 |  66 |
| `execute_preflight_insn_mi/s` |  30.25 | -          |  31.23 |  29.28 |
| `trace_gen_time_ms   ` |  28.50 |  57 |  46 |  11 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  815.50 |  1,631 |  1,329 |  302 |
| `prover.main_trace_commit_time_ms` |  277 |  554 |  482 |  72 |
| `prover.rap_constraints_time_ms` |  490 |  980 |  777 |  203 |
| `prover.openings_time_ms` |  48 |  96 |  69 |  27 |
| `prover.rap_constraints.logup_gkr_time_ms` |  82.50 |  165 |  128 |  37 |
| `prover.rap_constraints.round0_time_ms` |  277 |  554 |  436 |  118 |
| `prover.rap_constraints.mle_rounds_time_ms` |  129.50 |  259 |  212 |  47 |
| `prover.openings.stacked_reduction_time_ms` |  33.50 |  67 |  51 |  16 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/d7316468a192f0f04a55f6942665a1326f73ddc3/kitchen_sink-d7316468a192f0f04a55f6942665a1326f73ddc3.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 70 | 3 |  |  | 0 |  | 343 | 3 |  |  |  |  |  |  | 
| app_proof |  |  |  |  |  | 440 |  |  | 24 | 1,979,971 | 80.98 | 0 | 2,046 |  | 
...
| leaf | 0 | 111 | 410 | 111 | 25 | 11 | 18 | 2 | 2 | 
...
| leaf | 0 | prover | 263,565,172 | 299 | 128 | 0 | 1 | 141 | 49 | 48 | 37 | 54 | 0 | 28 | 12 | 15 | 7 | 8 | 128 | 141 | 0 | 2 | 53 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 903,946,916 | 1,329 | 482 | 0 | 273 | 777 | 436 | 435 | 212 | 128 | 68 | 69 | 17 | 51 | 24 | 27 | 482 | 777 | 0 | 1 | 59 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 46 | 1,577 | 46 | 135 | 0 | 3 | 66 | 1,445,000 | 29.28 | 
| app_proof | 1 | 11 | 440 | 11 | 40 | 0 | 1 | 85 | 534,971 | 31.23 | 

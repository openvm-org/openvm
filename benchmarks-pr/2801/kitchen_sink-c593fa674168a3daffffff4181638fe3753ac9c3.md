...
|:---|---:|---:|---:|
| Total |  2.74 |  2.30 |  2.30 |
| app_proof |  2.03 |  1.59 |  1.59 |
| leaf |  0.41 |  0.41 |  0.41 |
...
| `total_proof_time_ms ` |  1,001 |  2,002 |  1,565 |  437 |
| `execute_metered_time_ms` |  24 | -          | -          | -          |
| `execute_metered_insns` |  1,979,971 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  81.57 | -          |  81.57 |  81.57 |
| `execute_preflight_insns` |  989,985.50 |  1,979,971 |  1,445,000 |  534,971 |
| `execute_preflight_time_ms` |  74 |  148 |  83 |  65 |
| `execute_preflight_insn_mi/s` |  30.51 | -          |  31.34 |  29.68 |
| `trace_gen_time_ms   ` |  28.50 |  57 |  46 |  11 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  809.50 |  1,619 |  1,318 |  301 |
| `prover.main_trace_commit_time_ms` |  275.50 |  551 |  479 |  72 |
| `prover.rap_constraints_time_ms` |  486 |  972 |  771 |  201 |
| `prover.openings_time_ms` |  47.50 |  95 |  68 |  27 |
| `prover.rap_constraints.logup_gkr_time_ms` |  81.50 |  163 |  126 |  37 |
| `prover.rap_constraints.round0_time_ms` |  275 |  550 |  433 |  117 |
| `prover.rap_constraints.mle_rounds_time_ms` |  128.50 |  257 |  210 |  47 |
| `prover.openings.stacked_reduction_time_ms` |  34 |  68 |  51 |  17 |
| `prover.openings.stacked_reduction.round0_time_ms` |  15.50 |  31 |  24 |  7 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  18 |  36 |  27 |  9 |
| `prover.openings.whir_time_ms` |  13 |  26 |  16 |  10 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/c593fa674168a3daffffff4181638fe3753ac9c3/kitchen_sink-c593fa674168a3daffffff4181638fe3753ac9c3.memory.svg)
...
| 43 | VmAirWrapper<Rv64VecHeapAdapterAir<2, 4, 4>, 2, 4, 4, 8, 32, 32>, ShiftCoreAir<32, 8> | 153 | 2,127 | 3 | 
| 44 | VmAirWrapper<Rv64VecHeapAdapterAir<2, 4, 4>, 2, 4, 4, 8, 32, 32>, MultiplicationCoreAir<32, 8> | 135 | 16 | 2 | 
...
| 48 | VmAirWrapper<Rv64VecHeapAdapterAir<2, 4, 4>, 2, 4, 4, 8, 32, 32>, BaseAluCoreAir<32, 8> | 135 | 85 | 3 | 
...
| app_proof |  |  |  |  |  | 437 |  |  | 24 | 1,979,971 | 81.57 | 0 | 2,031 |  | 
...
| app_proof | 68 | VmAirWrapper<Rv64LoadStoreAdapterAir, LoadSignExtendCoreAir<8, 8> | prover | 0 | 32,768 | 48 | 1,572,864 | 
...
| app_proof | 43 | VmAirWrapper<Rv64VecHeapAdapterAir<2, 4, 4>, 2, 4, 4, 8, 32, 32>, ShiftCoreAir<32, 8> | prover | 1 | 64 | 252 | 16,128 | 
| app_proof | 44 | VmAirWrapper<Rv64VecHeapAdapterAir<2, 4, 4>, 2, 4, 4, 8, 32, 32>, MultiplicationCoreAir<32, 8> | prover | 1 | 32 | 175 | 5,600 | 
...
| app_proof | 48 | VmAirWrapper<Rv64VecHeapAdapterAir<2, 4, 4>, 2, 4, 4, 8, 32, 32>, BaseAluCoreAir<32, 8> | prover | 1 | 128 | 179 | 22,912 | 
...
| app_proof | 68 | VmAirWrapper<Rv64LoadStoreAdapterAir, LoadSignExtendCoreAir<8, 8> | prover | 1 | 8,192 | 48 | 393,216 | 
| app_proof | 69 | VmAirWrapper<Rv64LoadStoreAdapterAir, LoadStoreCoreAir<8> | prover | 1 | 262,144 | 56 | 14,680,064 | 
| app_proof | 70 | VmAirWrapper<Rv64BaseAluWAdapterAir, ShiftCoreAir<4, 8> | prover | 1 | 64 | 62 | 3,968 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,577,915 | 117 | 38 | 0 | 0 | 62 | 21 | 20 | 29 | 12 | 0 | 16 | 8 | 7 | 1 | 5 | 39 | 62 | 0 | 1 | 11 | 0 | 0 | 
...
| leaf | 0 | prover | 263,565,172 | 298 | 129 | 0 | 1 | 140 | 48 | 47 | 37 | 54 | 0 | 28 | 12 | 15 | 7 | 8 | 129 | 140 | 0 | 2 | 53 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 903,946,916 | 1,318 | 478 | 0 | 270 | 771 | 433 | 432 | 210 | 126 | 66 | 68 | 16 | 51 | 24 | 27 | 479 | 771 | 0 | 1 | 59 | 0 | 0 | 
| app_proof | prover | 1 | 280,522,636 | 301 | 72 | 0 | 1 | 201 | 117 | 116 | 47 | 37 | 0 | 27 | 10 | 17 | 7 | 9 | 72 | 201 | 0 | 1 | 36 | 0 | 0 | 

| group | phase | segment | trace_height_constraint | weighted_sum | threshold |
| --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 0 | 60,428,554 | 2,013,265,921 | 
| app_proof | prover | 1 | 0 | 29,505,898 | 2,013,265,921 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 46 | 1,565 | 46 | 135 | 0 | 3 | 65 | 1,445,000 | 29.68 | 
| app_proof | 1 | 11 | 437 | 11 | 40 | 0 | 1 | 83 | 534,971 | 31.34 | 

...
|:---|---:|---:|---:|
| Total |  17.20 |  5.02 |  5.02 |
| app_proof |  14.04 |  2.63 |  2.63 |
| leaf |  2.37 |  1.60 |  1.60 |
...
| `total_proof_time_ms ` |  2,316.17 |  13,897 |  2,489 |  2,229 |
...
| `execute_preflight_time_ms` |  238.83 |  1,433 |  317 |  91 |
| `execute_preflight_insn_mi/s` |  31.92 | -          |  32.59 |  29.11 |
| `trace_gen_time_ms   ` |  36 |  216 |  47 |  33 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,983.50 |  11,901 |  2,215 |  1,917 |
| `prover.main_trace_commit_time_ms` |  694.83 |  4,169 |  854 |  662 |
| `prover.rap_constraints_time_ms` |  1,109 |  6,654 |  1,185 |  1,074 |
| `prover.openings_time_ms` |  178.67 |  1,072 |  181 |  175 |
| `prover.rap_constraints.logup_gkr_time_ms` |  284.83 |  1,709 |  346 |  256 |
| `prover.rap_constraints.round0_time_ms` |  509.50 |  3,057 |  513 |  504 |
| `prover.rap_constraints.mle_rounds_time_ms` |  313.83 |  1,883 |  331 |  304 |
...
| `prover.openings.whir_time_ms` |  43.33 |  260 |  46 |  41 |
...
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,049.50 |  2,099 |  1,422 |  677 |
...
| `prover.rap_constraints.mle_rounds_time_ms` |  91.50 |  183 |  115 |  68 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/2c8452e3e29f24f4907170b2b3e4d4a3872644c9/keccak-2c8452e3e29f24f4907170b2b3e4d4a3872644c9.memory.svg)
...
| app_proof |  |  |  |  |  | 2,229 |  |  | 142 | 14,365,133 | 100.98 | 0 | 14,047 |  | 
| internal_for_leaf |  |  |  | 497 |  |  |  |  |  |  |  |  |  | 498 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 37 | 497 | 37 | 13 | 4 | 2 | 2 | 2 | 
| internal_recursive.0 | 1 | 13 | 164 | 13 | 2 | 1 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 9 | 128 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 180 | 1,602 | 180 | 64 | 32 | 6 | 7 | 7 | 
| leaf | 1 | 89 | 766 | 89 | 32 | 16 | 5 | 7 | 7 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 81,415,028 | 459 | 243 | 0 | 1 | 170 | 48 | 48 | 91 | 30 | 0 | 46 | 22 | 23 | 7 | 15 | 243 | 170 | 0 | 3 | 29 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,879 | 151 | 49 | 0 | 0 | 71 | 24 | 24 | 29 | 17 | 0 | 29 | 20 | 8 | 1 | 6 | 49 | 71 | 0 | 2 | 16 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 119 | 31 | 0 | 0 | 61 | 23 | 22 | 24 | 13 | 0 | 26 | 19 | 7 | 1 | 5 | 31 | 61 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 476,578,662 | 1,422 | 897 | 0 | 177 | 403 | 201 | 201 | 115 | 86 | 0 | 119 | 48 | 71 | 40 | 31 | 898 | 403 | 0 | 7 | 85 | 0 | 0 | 
| leaf | 1 | prover | 240,255,732 | 677 | 373 | 0 | 1 | 228 | 108 | 108 | 68 | 51 | 0 | 74 | 37 | 37 | 20 | 17 | 374 | 228 | 0 | 6 | 50 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 842,692,236 | 2,215 | 854 | 0 | 195 | 1,185 | 507 | 506 | 331 | 346 | 95 | 175 | 41 | 134 | 82 | 51 | 854 | 1,185 | 0 | 3 | 249 | 0 | 0 | 
| app_proof | prover | 1 | 842,692,236 | 1,941 | 662 | 0 | 3 | 1,098 | 512 | 511 | 329 | 256 | 0 | 179 | 44 | 135 | 81 | 53 | 662 | 1,098 | 0 | 4 | 255 | 0 | 0 | 
| app_proof | prover | 2 | 842,692,236 | 1,989 | 663 | 0 | 2 | 1,149 | 504 | 504 | 308 | 336 | 97 | 176 | 42 | 134 | 81 | 52 | 663 | 1,149 | 0 | 3 | 237 | 0 | 0 | 
| app_proof | prover | 3 | 842,692,236 | 1,917 | 663 | 0 | 3 | 1,074 | 511 | 510 | 305 | 257 | 0 | 180 | 43 | 136 | 83 | 53 | 663 | 1,074 | 0 | 3 | 256 | 0 | 0 | 
| app_proof | prover | 4 | 842,692,236 | 1,918 | 662 | 0 | 2 | 1,074 | 513 | 512 | 304 | 256 | 0 | 181 | 46 | 134 | 81 | 52 | 662 | 1,074 | 0 | 3 | 254 | 0 | 0 | 
| app_proof | prover | 5 | 842,692,236 | 1,921 | 665 | 0 | 2 | 1,074 | 510 | 509 | 306 | 258 | 0 | 181 | 44 | 136 | 82 | 53 | 665 | 1,074 | 0 | 4 | 256 | 0 | 0 | 

| group | phase | segment | trace_height_constraint | weighted_sum | threshold |
| --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 0 | 89,626,378 | 2,013,265,921 | 
| app_proof | prover | 1 | 0 | 89,626,378 | 2,013,265,921 | 
| app_proof | prover | 2 | 0 | 89,626,378 | 2,013,265,921 | 
| app_proof | prover | 3 | 0 | 89,626,378 | 2,013,265,921 | 
| app_proof | prover | 4 | 0 | 89,626,378 | 2,013,265,921 | 
| app_proof | prover | 5 | 0 | 89,626,378 | 2,013,265,921 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 47 | 2,489 | 47 | 135 | 0 | 3 | 91 | 2,413,000 | 29.11 | 
| app_proof | 1 | 34 | 2,334 | 34 | 41 | 0 | 1 | 317 | 2,413,000 | 32.41 | 
| app_proof | 2 | 34 | 2,326 | 34 | 41 | 0 | 1 | 261 | 2,413,000 | 32.59 | 
| app_proof | 3 | 34 | 2,259 | 34 | 41 | 0 | 1 | 266 | 2,413,000 | 32.36 | 
| app_proof | 4 | 34 | 2,260 | 34 | 41 | 0 | 1 | 266 | 2,413,000 | 32.56 | 
| app_proof | 5 | 33 | 2,229 | 33 | 41 | 0 | 1 | 232 | 2,300,133 | 32.50 | 

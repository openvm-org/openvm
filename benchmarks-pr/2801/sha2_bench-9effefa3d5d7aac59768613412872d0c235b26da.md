...
|:---|---:|---:|---:|
| Total |  11.66 |  4.71 |  4.71 |
| app_proof |  9.55 |  2.60 |  2.60 |
| leaf |  1.43 |  1.43 |  1.43 |
...
| `total_proof_time_ms ` |  2,362.50 |  9,450 |  2,507 |  2,266 |
| `execute_metered_time_ms` |  96 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  116.16 | -          |  116.16 |  116.16 |
| `execute_preflight_insns` |  2,791,990.25 |  11,167,961 |  2,851,000 |  2,614,961 |
| `execute_preflight_time_ms` |  167.25 |  669 |  210 |  104 |
| `execute_preflight_insn_mi/s` |  33.14 | -          |  33.91 |  30.93 |
| `trace_gen_time_ms   ` |  58 |  232 |  64 |  54 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  2,070.75 |  8,283 |  2,201 |  1,996 |
| `prover.main_trace_commit_time_ms` |  547.50 |  2,190 |  636 |  518 |
| `prover.rap_constraints_time_ms` |  1,381.25 |  5,525 |  1,427 |  1,334 |
| `prover.openings_time_ms` |  141 |  564 |  143 |  139 |
| `prover.rap_constraints.logup_gkr_time_ms` |  371 |  1,484 |  424 |  321 |
| `prover.rap_constraints.round0_time_ms` |  689 |  2,756 |  701 |  680 |
| `prover.rap_constraints.mle_rounds_time_ms` |  321 |  1,284 |  322 |  320 |
| `prover.openings.stacked_reduction_time_ms` |  102 |  408 |  103 |  101 |
| `prover.openings.stacked_reduction.round0_time_ms` |  61.50 |  246 |  63 |  61 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  40 |  160 |  40 |  40 |
| `prover.openings.whir_time_ms` |  38.50 |  154 |  40 |  37 |
...
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,286 |  1,286 |  1,286 |  1,286 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/9effefa3d5d7aac59768613412872d0c235b26da/sha2_bench-9effefa3d5d7aac59768613412872d0c235b26da.memory.svg)
...
| app_proof |  |  |  |  |  | 2,266 |  |  | 96 | 11,167,961 | 116.16 | 0 | 9,552 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 61,220,603 | 364 | 188 | 0 | 0 | 134 | 39 | 39 | 67 | 27 | 0 | 42 | 23 | 18 | 5 | 13 | 188 | 134 | 0 | 3 | 26 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,879 | 150 | 49 | 0 | 0 | 73 | 25 | 24 | 29 | 17 | 0 | 27 | 18 | 8 | 1 | 6 | 50 | 73 | 0 | 2 | 16 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 117 | 31 | 0 | 0 | 62 | 23 | 23 | 24 | 13 | 0 | 23 | 15 | 7 | 1 | 5 | 32 | 62 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 425,198,438 | 1,286 | 817 | 0 | 153 | 357 | 175 | 174 | 106 | 75 | 0 | 110 | 45 | 65 | 36 | 28 | 818 | 357 | 0 | 7 | 75 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 647,069,949 | 2,201 | 636 | 0 | 121 | 1,421 | 682 | 681 | 321 | 418 | 116 | 142 | 40 | 102 | 61 | 40 | 636 | 1,421 | 0 | 4 | 301 | 0 | 0 | 
| app_proof | prover | 1 | 647,069,708 | 2,085 | 518 | 0 | 2 | 1,427 | 680 | 680 | 322 | 424 | 126 | 139 | 38 | 101 | 61 | 40 | 518 | 1,427 | 0 | 4 | 297 | 0 | 0 | 
| app_proof | prover | 2 | 647,069,708 | 2,001 | 517 | 0 | 2 | 1,343 | 701 | 700 | 321 | 321 | 0 | 140 | 37 | 102 | 61 | 40 | 518 | 1,343 | 0 | 4 | 319 | 0 | 0 | 
| app_proof | prover | 3 | 647,069,956 | 1,996 | 518 | 0 | 2 | 1,334 | 693 | 692 | 320 | 321 | 0 | 143 | 39 | 103 | 63 | 40 | 518 | 1,334 | 0 | 4 | 319 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 64 | 2,507 | 64 | 136 | 0 | 4 | 104 | 2,851,000 | 30.93 | 
| app_proof | 1 | 57 | 2,395 | 57 | 41 | 0 | 1 | 210 | 2,851,000 | 33.83 | 
| app_proof | 2 | 57 | 2,282 | 57 | 41 | 0 | 1 | 181 | 2,851,000 | 33.91 | 
| app_proof | 3 | 54 | 2,266 | 54 | 41 | 0 | 1 | 174 | 2,614,961 | 33.89 | 

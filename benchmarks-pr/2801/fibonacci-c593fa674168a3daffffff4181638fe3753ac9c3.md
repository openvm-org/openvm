...
| `total_proof_time_ms ` |  389.50 |  1,558 |  515 |  223 |
| `execute_metered_time_ms` |  19 | -          | -          | -          |
| `execute_metered_insns` |  4,000,051 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  200.22 | -          |  200.22 |  200.22 |
| `execute_preflight_insns` |  1,000,012.75 |  4,000,051 |  1,310,000 |  70,051 |
| `execute_preflight_time_ms` |  38 |  152 |  52 |  4 |
| `execute_preflight_insn_mi/s` |  37.37 | -          |  37.55 |  36.99 |
| `trace_gen_time_ms   ` |  72.75 |  291 |  101 |  63 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  212.75 |  851 |  262 |  76 |
| `prover.main_trace_commit_time_ms` |  41 |  164 |  50 |  15 |
| `prover.rap_constraints_time_ms` |  140.25 |  561 |  180 |  34 |
| `prover.openings_time_ms` |  30.25 |  121 |  34 |  25 |
| `prover.rap_constraints.logup_gkr_time_ms` |  96 |  384 |  123 |  17 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  436 |  436 |  436 |  436 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/c593fa674168a3daffffff4181638fe3753ac9c3/fibonacci-c593fa674168a3daffffff4181638fe3753ac9c3.memory.svg)
...
| app_proof |  |  |  |  |  | 223 |  |  | 19 | 4,000,051 | 200.22 | 0 | 1,585 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 27,289,339 | 207 | 81 | 0 | 0 | 97 | 31 | 31 | 45 | 19 | 0 | 28 | 17 | 11 | 2 | 8 | 82 | 97 | 0 | 2 | 18 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,703 | 142 | 44 | 0 | 0 | 66 | 25 | 24 | 27 | 13 | 0 | 30 | 22 | 8 | 1 | 6 | 45 | 66 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 115 | 31 | 0 | 0 | 61 | 23 | 22 | 24 | 13 | 0 | 22 | 15 | 7 | 1 | 5 | 31 | 61 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 103,146,406 | 378 | 168 | 0 | 0 | 159 | 70 | 69 | 46 | 43 | 0 | 49 | 30 | 18 | 8 | 9 | 169 | 159 | 0 | 5 | 42 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 62,648,832 | 262 | 49 | 0 | 0 | 180 | 39 | 38 | 18 | 123 | 0 | 31 | 19 | 12 | 5 | 6 | 49 | 180 | 0 | 3 | 122 | 0 | 0 | 
| app_proof | prover | 1 | 62,602,932 | 256 | 50 | 0 | 0 | 174 | 33 | 33 | 17 | 123 | 0 | 31 | 21 | 10 | 5 | 5 | 50 | 174 | 0 | 3 | 122 | 0 | 0 | 
| app_proof | prover | 2 | 62,602,932 | 257 | 50 | 0 | 0 | 173 | 33 | 33 | 17 | 121 | 0 | 34 | 22 | 11 | 5 | 5 | 50 | 173 | 0 | 3 | 120 | 0 | 0 | 
| app_proof | prover | 3 | 9,072,100 | 76 | 15 | 0 | 0 | 34 | 9 | 9 | 8 | 17 | 0 | 25 | 21 | 3 | 0 | 2 | 15 | 34 | 0 | 2 | 16 | 0 | 0 | 

| group | phase | segment | trace_height_constraint | weighted_sum | threshold |
| --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 0 | 37,885,846 | 2,013,265,921 | 
| app_proof | prover | 1 | 0 | 37,884,330 | 2,013,265,921 | 
| app_proof | prover | 2 | 0 | 37,884,330 | 2,013,265,921 | 
| app_proof | prover | 3 | 0 | 3,724,701 | 2,013,265,921 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 63 | 515 | 63 | 137 | 0 | 3 | 52 | 1,310,000 | 37.41 | 
| app_proof | 1 | 63 | 409 | 63 | 40 | 0 | 1 | 48 | 1,310,000 | 37.55 | 
| app_proof | 2 | 64 | 411 | 64 | 40 | 0 | 1 | 48 | 1,310,000 | 37.54 | 
| app_proof | 3 | 101 | 223 | 101 | 41 | 0 | 1 | 4 | 70,051 | 36.99 | 

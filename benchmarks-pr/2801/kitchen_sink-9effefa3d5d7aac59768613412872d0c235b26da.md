...
| `execute_metered_insn_mi/s` |  78.18 | -          |  78.18 |  78.18 |
| `execute_preflight_insns` |  989,985.50 |  1,979,971 |  1,278,000 |  701,971 |
| `execute_preflight_time_ms` |  85.50 |  171 |  110 |  61 |
| `execute_preflight_insn_mi/s` |  28.61 | -          |  29.27 |  27.95 |
| `trace_gen_time_ms   ` |  28.50 |  57 |  43 |  14 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  882.50 |  1,765 |  1,327 |  438 |
| `prover.main_trace_commit_time_ms` |  301.50 |  603 |  485 |  118 |
| `prover.rap_constraints_time_ms` |  527.50 |  1,055 |  772 |  283 |
| `prover.openings_time_ms` |  52.50 |  105 |  69 |  36 |
| `prover.rap_constraints.logup_gkr_time_ms` |  75 |  150 |  114 |  36 |
| `prover.rap_constraints.round0_time_ms` |  308 |  616 |  436 |  180 |
| `prover.rap_constraints.mle_rounds_time_ms` |  143.50 |  287 |  221 |  66 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/9effefa3d5d7aac59768613412872d0c235b26da/kitchen_sink-9effefa3d5d7aac59768613412872d0c235b26da.memory.svg)
...
| prover.batch_constraints.before_round0 | 12.63 | app_proof.prover.0 |
| frac_sumcheck.gkr_rounds | 12.63 | app_proof.prover.0 |
| frac_sumcheck.segment_tree | 12.63 | app_proof.prover.0 |
| prover.gkr_input_evals | 12.63 | app_proof.prover.0 |
...
| 43 | VmAirWrapper<Rv64VecHeapAdapterAir<2, 4, 4>, 2, 4, 4, 8, 32, 32>, ShiftCoreAir<32, 8> | 147 | 2,127 | 3 | 
| 44 | VmAirWrapper<Rv64VecHeapAdapterAir<2, 4, 4>, 2, 4, 4, 8, 32, 32>, MultiplicationCoreAir<32, 8> | 129 | 16 | 2 | 
...
| 48 | VmAirWrapper<Rv64VecHeapAdapterAir<2, 4, 4>, 2, 4, 4, 8, 32, 32>, BaseAluCoreAir<32, 8> | 129 | 85 | 3 | 
...
| app_proof |  |  |  |  |  | 603 |  |  | 25 | 1,979,971 | 78.18 | 0 | 2,201 |  | 
| internal_for_leaf |  |  |  | 137 |  |  |  |  |  |  |  |  |  | 137 | 
| internal_recursive.0 |  |  |  | 90 |  |  |  |  |  |  |  |  |  | 91 | 
...
| app_proof | 43 | VmAirWrapper<Rv64VecHeapAdapterAir<2, 4, 4>, 2, 4, 4, 8, 32, 32>, ShiftCoreAir<32, 8> | prover | 0 | 512 | 252 | 129,024 | 
| app_proof | 44 | VmAirWrapper<Rv64VecHeapAdapterAir<2, 4, 4>, 2, 4, 4, 8, 32, 32>, MultiplicationCoreAir<32, 8> | prover | 0 | 256 | 175 | 44,800 | 
...
| app_proof | 48 | VmAirWrapper<Rv64VecHeapAdapterAir<2, 4, 4>, 2, 4, 4, 8, 32, 32>, BaseAluCoreAir<32, 8> | prover | 0 | 1,024 | 179 | 183,296 | 
...
| app_proof | 43 | VmAirWrapper<Rv64VecHeapAdapterAir<2, 4, 4>, 2, 4, 4, 8, 32, 32>, ShiftCoreAir<32, 8> | prover | 1 | 128 | 252 | 32,256 | 
| app_proof | 44 | VmAirWrapper<Rv64VecHeapAdapterAir<2, 4, 4>, 2, 4, 4, 8, 32, 32>, MultiplicationCoreAir<32, 8> | prover | 1 | 64 | 175 | 11,200 | 
| app_proof | 46 | VmAirWrapper<Rv64VecHeapBranchU16AdapterAir<2, 4>, 2, 4, 4, 16>, BranchEqualCoreAir<16> | prover | 1 | 64 | 90 | 5,760 | 
| app_proof | 47 | VmAirWrapper<Rv64VecHeapU16AdapterAir<2, 4, 4>, 2, 4, 4, 4, 16, 16>, LessThanCoreAir<16, 16> | prover | 1 | 128 | 126 | 16,128 | 
| app_proof | 48 | VmAirWrapper<Rv64VecHeapAdapterAir<2, 4, 4>, 2, 4, 4, 8, 32, 32>, BaseAluCoreAir<32, 8> | prover | 1 | 256 | 179 | 45,824 | 
...
| app_proof | 57 | Sha2MainAir<Sha256Config> | prover | 1 | 8,192 | 220 | 1,802,240 | 
...
| internal_recursive.0 | 1 | 10 | 90 | 9 | 1 | 0 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 8 | 84 | 8 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 114 | 408 | 114 | 28 | 13 | 18 | 3 | 3 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,577,915 | 118 | 38 | 0 | 0 | 63 | 21 | 20 | 29 | 12 | 0 | 16 | 8 | 7 | 1 | 6 | 39 | 63 | 0 | 1 | 11 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,703 | 80 | 16 | 0 | 0 | 48 | 18 | 17 | 20 | 10 | 0 | 14 | 8 | 5 | 1 | 4 | 17 | 48 | 0 | 1 | 9 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 75 | 11 | 0 | 0 | 48 | 19 | 18 | 18 | 10 | 0 | 15 | 9 | 5 | 0 | 4 | 11 | 48 | 0 | 1 | 9 | 0 | 0 | 
| leaf | 0 | prover | 261,140,340 | 293 | 126 | 0 | 1 | 137 | 48 | 47 | 37 | 52 | 0 | 28 | 12 | 15 | 7 | 8 | 127 | 137 | 0 | 2 | 51 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 903,897,764 | 1,327 | 485 | 0 | 275 | 772 | 436 | 435 | 221 | 114 | 58 | 69 | 16 | 52 | 24 | 27 | 485 | 772 | 0 | 1 | 55 | 0 | 0 | 
| app_proof | prover | 1 | 457,852,684 | 438 | 117 | 0 | 1 | 283 | 180 | 180 | 66 | 36 | 0 | 36 | 11 | 24 | 12 | 12 | 118 | 283 | 0 | 1 | 35 | 0 | 0 | 

| group | phase | segment | trace_height_constraint | weighted_sum | threshold |
| --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 0 | 50,543,586 | 2,013,265,921 | 
| app_proof | prover | 1 | 0 | 27,033,674 | 2,013,265,921 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 43 | 1,568 | 43 | 135 | 0 | 3 | 61 | 1,278,000 | 27.95 | 
| app_proof | 1 | 14 | 603 | 14 | 40 | 0 | 1 | 110 | 701,971 | 29.27 | 

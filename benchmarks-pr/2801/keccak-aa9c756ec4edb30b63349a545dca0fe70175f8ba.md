...
|:---|---:|---:|---:|
| Total |  17.16 |  5.02 |  5.02 |
| app_proof |  14.01 |  2.63 |  2.63 |
| leaf |  2.36 |  1.60 |  1.60 |
...
| `total_proof_time_ms ` |  2,311.17 |  13,867 |  2,492 |  2,222 |
| `execute_metered_time_ms` |  141 | -          | -          | -          |
| `execute_metered_insns` |  14,365,133 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  101.67 | -          |  101.67 |  101.67 |
| `execute_preflight_insns` |  2,394,188.83 |  14,365,133 |  2,413,000 |  2,300,133 |
| `execute_preflight_time_ms` |  241.67 |  1,450 |  324 |  91 |
| `execute_preflight_insn_mi/s` |  31.38 | -          |  32.02 |  29.17 |
| `trace_gen_time_ms   ` |  36.50 |  219 |  50 |  33 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,975.17 |  11,851 |  2,215 |  1,904 |
| `prover.main_trace_commit_time_ms` |  691.17 |  4,147 |  854 |  657 |
| `prover.rap_constraints_time_ms` |  1,105 |  6,630 |  1,179 |  1,067 |
| `prover.openings_time_ms` |  177.67 |  1,066 |  184 |  174 |
| `prover.rap_constraints.logup_gkr_time_ms` |  284.33 |  1,706 |  345 |  255 |
| `prover.rap_constraints.round0_time_ms` |  507.17 |  3,043 |  511 |  502 |
| `prover.rap_constraints.mle_rounds_time_ms` |  312 |  1,872 |  330 |  302 |
| `prover.openings.stacked_reduction_time_ms` |  134 |  804 |  135 |  133 |
| `prover.openings.stacked_reduction.round0_time_ms` |  81.50 |  489 |  82 |  81 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  51.67 |  310 |  53 |  51 |
| `prover.openings.whir_time_ms` |  43.50 |  261 |  49 |  41 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,178.50 |  2,357 |  1,596 |  761 |
| `execute_preflight_time_ms` |  5.50 |  11 |  6 |  5 |
| `trace_gen_time_ms   ` |  134 |  268 |  179 |  89 |
| `generate_blob_total_time_ms` |  24 |  48 |  32 |  16 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,044 |  2,088 |  1,416 |  672 |
| `prover.main_trace_commit_time_ms` |  631.50 |  1,263 |  890 |  373 |
| `prover.rap_constraints_time_ms` |  317.50 |  635 |  410 |  225 |
| `prover.openings_time_ms` |  94 |  188 |  116 |  72 |
| `prover.rap_constraints.logup_gkr_time_ms` |  67.50 |  135 |  85 |  50 |
| `prover.rap_constraints.round0_time_ms` |  154.50 |  309 |  202 |  107 |
| `prover.rap_constraints.mle_rounds_time_ms` |  94 |  188 |  122 |  66 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/aa9c756ec4edb30b63349a545dca0fe70175f8ba/keccak-aa9c756ec4edb30b63349a545dca0fe70175f8ba.memory.svg)
...
| prover.batch_constraints.before_round0 | 12.71 | app_proof.prover.0 |
| frac_sumcheck.gkr_rounds | 12.71 | app_proof.prover.0 |
| frac_sumcheck.segment_tree | 12.58 | app_proof.prover.0 |
| prover.gkr_input_evals | 12.58 | app_proof.prover.0 |
...
| app_proof |  |  |  |  |  | 2,222 |  |  | 141 | 14,365,133 | 101.67 | 0 | 14,014 |  | 
...
| internal_recursive.0 | 1 | 13 | 162 | 13 | 2 | 1 | 2 | 2 | 2 | 
| internal_recursive.1 | 1 | 9 | 127 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 179 | 1,596 | 178 | 64 | 32 | 6 | 7 | 7 | 
| leaf | 1 | 89 | 761 | 89 | 32 | 16 | 5 | 7 | 7 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 81,415,028 |
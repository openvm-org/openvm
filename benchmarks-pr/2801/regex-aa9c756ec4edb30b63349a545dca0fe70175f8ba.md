...
|:---|---:|---:|---:|
| Total |  2.46 |  1.79 |  1.79 |
| app_proof |  1.60 |  0.93 |  0.93 |
| leaf |  0.36 |  0.36 |  0.36 |
...
| `total_proof_time_ms ` |  784 |  1,568 |  897 |  671 |
| `execute_metered_time_ms` |  33 | -          | -          | -          |
| `execute_metered_insns` |  4,090,656 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  122.37 | -          |  122.37 |  122.37 |
| `execute_preflight_insns` |  2,045,328 |  4,090,656 |  2,327,000 |  1,763,656 |
| `execute_preflight_time_ms` |  88 |  176 |  98 |  78 |
| `execute_preflight_insn_mi/s` |  31.75 | -          |  33.11 |  30.39 |
| `trace_gen_time_ms   ` |  35 |  70 |  41 |  29 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  572.50 |  1,145 |  635 |  510 |
| `prover.main_trace_commit_time_ms` |  115 |  230 |  129 |  101 |
| `prover.rap_constraints_time_ms` |  411.50 |  823 |  459 |  364 |
| `prover.openings_time_ms` |  45.50 |  91 |  47 |  44 |
| `prover.rap_constraints.logup_gkr_time_ms` |  276 |  552 |  326 |  226 |
| `prover.rap_constraints.round0_time_ms` |  94.50 |  189 |  102 |  87 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/aa9c756ec4edb30b63349a545dca0fe70175f8ba/regex-aa9c756ec4edb30b63349a545dca0fe70175f8ba.memory.svg)

| Module | Max (GB) | Max At |
| --- | ---: | --- |
| frac_sumcheck.gkr_rounds | 5.17 | app_proof.prover.0 |
| prover.batch_constraints.before_round0 | 5.17 | app_proof.prover.0 |
| frac_sumcheck.segment_tree | 5.03 | app_proof.prover.0 |
| prover.gkr_input_evals | 5.03 | app_proof.prover.0 |
...
| prover.rap_constraints | 2.86 | app_proof.prover.0 |
...
| app_proof |  |  |  |  |  | 671 |  |  | 33 | 4,090,656 | 122.37 | 0 | 1,615 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 27,289,339 | 210 | 81 | 0 | 0 | 97 | 32 | 31 | 45 | 19 | 0 | 31 | 19 | 11 | 2 | 8 | 81 | 97 | 0 | 2 | 18 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,703 | 139 | 46 | 0 | 0 | 66 | 24 | 24 | 28 | 13 | 0 | 25 | 17 | 8 | 1 | 6 | 46 | 66 | 0 | 2 | 12 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 121 | 31 | 0 | 0 | 60 | 22 | 21 | 24 | 13 | 0 | 28 | 21 | 7 | 1 | 5 | 32 | 60 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 79,659,764 | 306 | 126 | 0 | 0 | 132 | 54 | 53 | 37 | 41 | 0 | 46 | 30 | 15 | 6 | 8 | 127 | 132 | 0 | 5 | 40 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 164,088,786 | 635 | 129 | 0 | 0 | 459 | 87 | 86 | 44 | 326 | 87 | 47 | 22 | 24 | 13 | 11 | 129 | 459 | 0 | 3 | 239 | 0 | 0 | 
| app_proof | prover | 1 | 125,501,763 | 510 | 101 | 0 | 8 | 364 | 102 | 101 | 35 | 226 | 0 | 44 | 23 | 21 | 10 | 10 | 101 | 364 | 0 | 3 | 225 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 29 | 897 | 29 | 133 | 1 | 5 | 98 | 2,327,000 | 30.39 | 
| app_proof | 1 | 41 | 671 | 41 | 40 | 0 | 2 | 78 | 1,763,656 | 33.11 | 

...
|:---|---:|---:|---:|
| Total |  11.25 |  4.61 |  4.61 |
| app_proof |  9.18 |  2.55 |  2.55 |
| leaf |  1.40 |  1.40 |  1.40 |
...
| `total_proof_time_ms ` |  2,271.50 |  9,086 |  2,452 |  2,192 |
| `execute_metered_time_ms` |  96 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  115.19 | -          |  115.19 |  115.19 |
| `execute_preflight_insns` |  2,791,990.25 |  11,167,961 |  2,851,000 |  2,614,961 |
| `execute_preflight_time_ms` |  165.50 |  662 |  207 |  102 |
| `execute_preflight_insn_mi/s` |  33.41 | -          |  34.14 |  31.24 |
| `trace_gen_time_ms   ` |  57.75 |  231 |  63 |  54 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,982.25 |  7,929 |  2,149 |  1,923 |
| `prover.main_trace_commit_time_ms` |  532.25 |  2,129 |  620 |  502 |
| `prover.rap_constraints_time_ms` |  1,313.50 |  5,254 |  1,391 |  1,283 |
| `prover.openings_time_ms` |  135.75 |  543 |  137 |  135 |
| `prover.rap_constraints.logup_gkr_time_ms` |  352.25 |  1,409 |  434 |  325 |
| `prover.rap_constraints.round0_time_ms` |  661 |  2,644 |  668 |  656 |
| `prover.rap_constraints.mle_rounds_time_ms` |  299.25 |  1,197 |  303 |  296 |
| `prover.openings.stacked_reduction_time_ms` |  98.25 |  393 |  99 |  97 |
| `prover.openings.stacked_reduction.round0_time_ms` |  59.50 |  238 |  60 |  59 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  38.25 |  153 |  39 |  38 |
| `prover.openings.whir_time_ms` |  36.75 |  147 |  38 |  36 |
...
| `prover.main_trace_commit_time_ms` |  796 |  796 |  796 |  796 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/aa9c756ec4edb30b63349a545dca0fe70175f8ba/sha2_bench-aa9c756ec4edb30b63349a545dca0fe70175f8ba.memory.svg)

| Module | Max (GB) | Max At |
| --- | ---: | --- |
| prover.batch_constraints.before_round0 | 11.58 | app_proof.prover.3 |
| frac_sumcheck.gkr_rounds | 11.58 | app_proof.prover.3 |
| frac_sumcheck.segment_tree | 11.48 | app_proof.prover.0 |
| prover.gkr_input_evals | 11.48 | app_proof.prover.0 |
| prover.rap_constraints | 10.95 | app_proof.prover.0 |
| prover.batch_constraints.fold_ple_evals | 10.42 | app_proof.prover.0 |
| prover.batch_constraints.round0 | 10.42 | app_proof.prover.0 |
| prover.prove_whir_opening | 9.79 | app_proof.prover.0 |
| prover.merkle_tree | 9.79 | app_proof.prover.0 |
| prover.openings | 9.79 | app_proof.prover.0 |
...
| app_proof |  |  |  |  |  | 2,192 |  |  | 96 | 11,167,961 | 115.19 | 0 | 9,190 |  | 
| internal_for_leaf |  |  |  | 375 |  |  |  |  |  |  |  |  |  | 375 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 24 | 375 | 24 | 7 | 2 | 2 | 3 | 3 | 
| internal_recursive.0 | 1 | 11 | 159 | 11 | 2 | 0 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 9 | 128 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 152 | 1,404 | 152 | 57 | 25 | 2 | 6 | 6 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 61,220,603 | 351 | 183 | 0 | 0 | 129 | 37 | 37 | 64 | 26 | 0 | 37 | 19 | 18 | 5 | 12 | 183 | 129 | 0 | 3 | 25 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,879 | 147 | 47 | 0 | 0 | 72 | 24 | 23 | 29 | 18 | 0 | 26 | 17 | 8 | 1 | 6 | 47 | 72 | 0 | 2 | 16 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 118 | 31 | 0 | 0 | 61 | 23 | 22 | 24 | 13 | 0 | 25 | 18 | 7 | 1 | 5 | 31 | 61 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 425,198,438 | 1,251 | 796 | 0 | 156 | 345 | 168 | 167 | 102 | 74 | 0 | 109 | 45 | 63 | 36 | 27 | 796 | 345 | 0 | 7 | 73 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 642,547,965 | 2,149 | 619 | 0 | 118 | 1,391 | 656 | 655 | 300 | 434 | 131 | 137 | 38 | 99 | 60 | 39 | 620 | 1,391 | 0 | 3 | 303 | 0 | 0 | 
| app_proof | prover | 1 | 642,547,724 | 1,927 | 502 | 0 | 2 | 1,288 | 659 | 659 | 303 | 325 | 0 | 136 | 36 | 99 | 60 | 38 | 502 | 1,288 | 0 | 4 | 323 | 0 | 0 | 
| app_proof | prover | 2 | 642,547,724 | 1,930 | 502 | 0 | 2 | 1,292 | 668 | 667 | 298 | 325 | 0 | 135 | 37 | 97 | 59 | 38 | 502 | 1,292 | 0 | 3 | 324 | 0 | 0 | 
| app_proof | prover | 3 | 642,547,972 | 1,923 | 504 | 0 | 2 | 1,283 | 661 | 661 | 296 | 325 | 0 | 135 | 36 | 98 | 59 | 38 | 505 | 1,283 | 0 | 4 | 324 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 63 | 2,452 | 63 | 135 | 0 | 3 | 102 | 2,851,000 | 31.24 | 
| app_proof | 1 | 57 | 2,233 | 57 | 41 | 0 | 1 | 207 | 2,851,000 | 34.12 | 
| app_proof | 2 | 57 | 2,209 | 57 | 41 | 0 | 1 | 180 | 2,851,000 | 34.14 | 
| app_proof | 3 | 54 | 2,192 | 54 | 41 | 0 | 1 | 173 | 2,614,961 | 34.13 | 

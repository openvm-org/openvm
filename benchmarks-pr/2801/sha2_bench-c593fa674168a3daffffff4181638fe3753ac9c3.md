...
|:---|---:|---:|---:|
| Total |  11.22 |  4.60 |  4.60 |
| app_proof |  9.16 |  2.54 |  2.54 |
| leaf |  1.40 |  1.40 |  1.40 |
...
| `total_proof_time_ms ` |  2,266.75 |  9,067 |  2,449 |  2,180 |
| `execute_metered_time_ms` |  96 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  115.42 | -          |  115.42 |  115.42 |
| `execute_preflight_insns` |  2,791,990.25 |  11,167,961 |  2,851,000 |  2,614,961 |
| `execute_preflight_time_ms` |  167 |  668 |  213 |  101 |
| `execute_preflight_insn_mi/s` |  34.01 | -          |  34.84 |  31.84 |
| `trace_gen_time_ms   ` |  57.75 |  231 |  63 |  54 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,976 |  7,904 |  2,149 |  1,910 |
| `prover.main_trace_commit_time_ms` |  531.50 |  2,126 |  619 |  502 |
| `prover.rap_constraints_time_ms` |  1,307.75 |  5,231 |  1,392 |  1,275 |
| `prover.openings_time_ms` |  136 |  544 |  140 |  132 |
| `prover.rap_constraints.logup_gkr_time_ms` |  353.75 |  1,415 |  437 |  323 |
| `prover.rap_constraints.round0_time_ms` |  655 |  2,620 |  657 |  654 |
| `prover.rap_constraints.mle_rounds_time_ms` |  298 |  1,192 |  300 |  296 |
| `prover.openings.stacked_reduction_time_ms` |  97.25 |  389 |  100 |  96 |
| `prover.openings.stacked_reduction.round0_time_ms` |  58.75 |  235 |  60 |  58 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  37.50 |  150 |  39 |  37 |
| `prover.openings.whir_time_ms` |  38.50 |  154 |  43 |  35 |
...
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,247 |  1,247 |  1,247 |  1,247 |
| `prover.main_trace_commit_time_ms` |  795 |  795 |  795 |  795 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/c593fa674168a3daffffff4181638fe3753ac9c3/sha2_bench-c593fa674168a3daffffff4181638fe3753ac9c3.memory.svg)
...
| app_proof |  |  |  |  |  | 2,180 |  |  | 96 | 11,167,961 | 115.42 | 0 | 9,170 |  | 
| internal_for_leaf |  |  |  | 372 |  |  |  |  |  |  |  |  |  | 372 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 24 | 372 | 24 | 7 | 2 | 2 | 3 | 3 | 
| internal_recursive.0 | 1 | 12 | 160 | 12 | 2 | 1 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 10 | 130 | 10 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 148 | 1,395 | 148 | 53 | 25 | 2 | 6 | 6 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 61,220,603 | 347 | 181 | 0 | 0 | 127 | 37 | 36 | 63 | 26 | 0 | 38 | 19 | 18 | 5 | 12 | 181 | 127 | 0 | 2 | 25 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,879 | 148 | 49 | 0 | 0 | 72 | 25 | 24 | 29 | 17 | 0 | 26 | 17 | 8 | 1 | 6 | 49 | 72 | 0 | 2 | 16 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 120 | 31 | 0 | 0 | 61 | 23 | 22 | 24 | 13 | 0 | 27 | 19 | 7 | 1 | 5 | 31 | 61 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 425,198,438 | 1,247 | 794 | 0 | 158 | 346 | 166 | 165 | 105 | 74 | 0 | 105 | 42 | 63 | 35 | 27 | 795 | 346 | 0 | 6 | 73 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 642,482,429 | 2,149 | 619 | 0 | 119 | 1,392 | 654 | 654 | 300 | 437 | 132 | 136 | 36 | 100 | 60 | 39 | 619 | 1,392 | 0 | 3 | 303 | 0 | 0 | 
| app_proof | prover | 1 | 642,482,188 | 1,921 | 502 | 0 | 2 | 1,278 | 657 | 656 | 297 | 324 | 0 | 140 | 43 | 96 | 58 | 37 | 502 | 1,278 | 0 | 3 | 322 | 0 | 0 | 
| app_proof | prover | 2 | 642,482,188 | 1,924 | 501 | 0 | 2 | 1,286 | 655 | 654 | 299 | 331 | 0 | 136 | 40 | 96 | 58 | 37 | 502 | 1,286 | 0 | 3 | 330 | 0 | 0 | 
| app_proof | prover | 3 | 642,482,436 | 1,910 | 502 | 0 | 2 | 1,275 | 654 | 654 | 296 | 323 | 0 | 132 | 35 | 97 | 59 | 37 | 503 | 1,275 | 0 | 3 | 322 | 0 | 0 | 

| group | phase | segment | trace_height_constraint | weighted_sum | threshold |
| --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 0 | 126,640,529 | 2,013,265,921 | 
| app_proof | prover | 1 | 0 | 126,640,394 | 2,013,265,921 | 
| app_proof | prover | 2 | 0 | 126,640,394 | 2,013,265,921 | 
| app_proof | prover | 3 | 0 | 126,640,510 | 2,013,265,921 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 63 | 2,449 | 63 | 135 | 0 | 3 | 101 | 2,851,000 | 31.84 | 
| app_proof | 1 | 57 | 2,234 | 57 | 41 | 0 | 1 | 213 | 2,851,000 | 34.84 | 
| app_proof | 2 | 57 | 2,204 | 57 | 41 | 0 | 1 | 180 | 2,851,000 | 34.76 | 
| app_proof | 3 | 54 | 2,180 | 54 | 41 | 0 | 1 | 174 | 2,614,961 | 34.60 | 

...
|:---|---:|---:|---:|
| Total |  17.35 |  5.13 |  5.13 |
| app_proof |  14.15 |  2.70 |  2.70 |
| leaf |  2.40 |  1.63 |  1.63 |
...
| `total_proof_time_ms ` |  2,334.67 |  14,008 |  2,561 |  2,251 |
...
| `execute_preflight_time_ms` |  246.17 |  1,477 |  335 |  93 |
| `execute_preflight_insn_mi/s` |  31.16 | -          |  32.23 |  28.87 |
| `trace_gen_time_ms   ` |  36.17 |  217 |  48 |  33 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,994.50 |  11,967 |  2,283 |  1,929 |
| `prover.main_trace_commit_time_ms` |  705 |  4,230 |  868 |  670 |
| `prover.rap_constraints_time_ms` |  1,103.67 |  6,622 |  1,231 |  1,070 |
| `prover.openings_time_ms` |  184.83 |  1,109 |  190 |  180 |
| `prover.rap_constraints.logup_gkr_time_ms` |  254.17 |  1,525 |  312 |  240 |
| `prover.rap_constraints.round0_time_ms` |  534.17 |  3,205 |  607 |  517 |
| `prover.rap_constraints.mle_rounds_time_ms` |  314.50 |  1,887 |  335 |  310 |
| `prover.openings.stacked_reduction_time_ms` |  140 |  840 |  142 |  139 |
| `prover.openings.stacked_reduction.round0_time_ms` |  84.33 |  506 |  85 |  83 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  55.33 |  332 |  57 |  54 |
| `prover.openings.whir_time_ms` |  44.17 |  265 |  47 |  41 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,200.50 |  2,401 |  1,625 |  776 |
| `execute_preflight_time_ms` |  5.50 |  11 |  6 |  5 |
| `trace_gen_time_ms   ` |  136 |  272 |  181 |  91 |
| `generate_blob_total_time_ms` |  24.50 |  49 |  33 |  16 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,064.50 |  2,129 |  1,444 |  685 |
| `prover.main_trace_commit_time_ms` |  643 |  1,286 |  906 |  380 |
| `prover.rap_constraints_time_ms` |  325.50 |  651 |  418 |  233 |
| `prover.openings_time_ms` |  95 |  190 |  119 |  71 |
| `prover.rap_constraints.logup_gkr_time_ms` |  69.50 |  139 |  87 |  52 |
| `prover.rap_constraints.round0_time_ms` |  160 |  320 |  209 |  111 |
...
| `prover.openings.whir_time_ms` |  38.50 |  77 |  44 |  33 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/46617d63bccb1afd11bab978ba7b13e8b0b675c1/keccak-46617d63bccb1afd11bab978ba7b13e8b0b675c1.memory.svg)

| Module | Max (GB) | Max At |
| --- | ---: | --- |
| prover.rap_constraints | 14.30 | app_proof.prover.0 |
| prover.merkle_tree | 12.95 | app_proof.prover.0 |
| prover.prove_whir_opening | 12.95 | app_proof.prover.0 |
| prover.openings | 12.95 | app_proof.prover.0 |
| prover.batch_constraints.round0 | 12.44 | app_proof.prover.0 |
| prover.batch_constraints.fold_ple_evals | 12.44 | app_proof.prover.0 |
| frac_sumcheck.gkr_rounds | 12.25 | app_proof.prover.0 |
| prover.batch_constraints.before_round0 | 12.25 | app_proof.prover.0 |
| prover.gkr_input_evals | 12.12 | app_proof.prover.0 |
| frac_sumcheck.segment_tree | 12.12 | app_proof.prover.0 |
| prover.before_gkr_input_evals | 9.83 | app_proof.prover.0 |
| prover.stacked_commit | 9.83 | app_proof.prover.0 |
...
| app_proof |  |  |  |  |  | 2,251 |  |  | 141 | 14,365,133 | 101.39 | 0 | 14,157 |  | 
| internal_for_leaf |  |  |  | 505 |  |  |  |  |  |  |  |  |  | 505 | 
...
| app_proof | 12 | XorinVmAir | prover | 0 | 16,384 | 673 | 11,026,432 | 
...
| app_proof | 12 | XorinVmAir | prover | 1 | 16,384 | 673 | 11,026,432 | 
...
| app_proof | 12 | XorinVmAir | prover | 2 | 16,384 | 673 | 11,026,432 | 
...
| app_proof | 12 | XorinVmAir | prover | 3 | 16,384 | 673 | 11,026,432 | 
...
| app_proof | 12 | XorinVmAir | prover | 4 | 16,384 | 673 | 11,026,432 | 
...
| app_proof | 12 | XorinVmAir | prover | 5 | 16,384 | 673 | 11,026,432 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 39 | 505 | 38 | 13 | 4 | 2 | 2 | 2 | 
| internal_recursive.0 | 1 | 13 | 165 | 13 | 2 | 1 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 9 | 129 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 181 | 1,625 | 181 | 64 | 33 | 6 | 7 | 7 | 
| leaf | 1 | 91 | 776 | 91 | 32 | 16 | 5 | 8 | 8 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 81,415,028 | 466 | 247 | 0 | 1 | 174 | 50 | 49 | 93 | 31 | 0 | 43 | 19 | 24 | 8 | 15 | 247 | 174 | 0 | 3 | 30 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,879 | 151 | 48 | 0 | 0 | 72 | 25 | 24 | 29 | 17 | 0 | 29 | 20 | 8 | 1 | 6 | 49 | 72 | 0 | 2 | 17 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 120 | 32 | 0 | 0 | 61 | 23 | 22 | 24 | 13 | 0 | 25 | 18 | 7 | 1 | 5 | 32 | 61 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 476,578,662 | 1,444 | 905 | 0 | 176 | 418 | 209 | 209 | 121 | 87 | 0 | 119 | 44 | 74 | 41 | 32 | 906 | 418 | 0 | 7 | 86 | 0 | 0 | 
| leaf | 1 | prover | 240,255,732 | 685 | 380 | 0 | 1 | 233 | 111 | 110 | 69 | 52 | 0 | 71 | 33 | 37 | 20 | 17 | 380 | 233 | 0 | 6 | 51 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 846,067,340 | 2,283 | 868 | 0 | 198 | 1,231 | 607 | 607 | 311 | 312 | 78 | 183 | 43 | 139 | 85 | 54 | 868 | 1,231 | 0 | 4 | 233 | 0 | 0 | 
| app_proof | prover | 1 | 846,067,340 | 1,948 | 670 | 0 | 3 | 1,096 | 520 | 519 | 335 | 240 | 0 | 181 | 42 | 139 | 84 | 54 | 670 | 1,096 | 0 | 4 | 239 | 0 | 0 | 
| app_proof | prover | 2 | 846,067,340 | 1,932 | 672 | 0 | 3 | 1,070 | 517 | 516 | 310 | 242 | 0 | 189 | 47 | 141 | 85 | 56 | 672 | 1,070 | 0 | 4 | 241 | 0 | 0 | 
| app_proof | prover | 3 | 846,067,340 | 1,937 | 672 | 0 | 3 | 1,078 | 522 | 521 | 311 | 244 | 0 | 186 | 45 | 140 | 84 | 56 | 672 | 1,078 | 0 | 4 | 243 | 0 | 0 | 
| app_proof | prover | 4 | 846,067,340 | 1,929 | 672 | 0 | 3 | 1,075 | 520 | 519 | 310 | 245 | 0 | 180 | 41 | 139 | 83 | 55 | 673 | 1,075 | 0 | 4 | 243 | 0 | 0 | 
| app_proof | prover | 5 | 846,067,340 | 1,938 | 675 | 0 | 3 | 1,072 | 519 | 518 | 310 | 242 | 0 | 190 | 47 | 142 | 85 | 57 | 675 | 1,072 | 0 | 4 | 241 | 0 | 0 | 

| group | phase | segment | trace_height_constraint | weighted_sum | threshold |
| --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 0 | 72,734,474 | 2,013,265,921 | 
| app_proof | prover | 1 | 0 | 72,734,474 | 2,013,265,921 | 
| app_proof | prover | 2 | 0 | 72,734,474 | 2,013,265,921 | 
| app_proof | prover | 3 | 0 | 72,734,474 | 2,013,265,921 | 
| app_proof | prover | 4 | 0 | 72,734,474 | 2,013,265,921 | 
| app_proof | prover | 5 | 0 | 72,734,474 | 2,013,265,921 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 48 | 2,561 | 48 | 134 | 0 | 3 | 93 | 2,413,000 | 28.87 | 
| app_proof | 1 | 34 | 2,358 | 34 | 41 | 0 | 1 | 335 | 2,413,000 | 32.01 | 
| app_proof | 2 | 34 | 2,276 | 34 | 41 | 0 | 1 | 268 | 2,413,000 | 32.17 | 
| app_proof | 3 | 34 | 2,287 | 34 | 41 | 0 | 1 | 273 | 2,413,000 | 30.05 | 
| app_proof | 4 | 34 | 2,275 | 34 | 41 | 0 | 1 | 270 | 2,413,000 | 31.66 | 
| app_proof | 5 | 33 | 2,251 | 33 | 41 | 0 | 1 | 238 | 2,300,133 | 32.23 | 

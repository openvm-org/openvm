...
|:---|---:|---:|
| Total | <span style='color: green'>(-0 [-2.3%])</span> 2.34 | <span style='color: green'>(-0 [-6.0%])</span> 0.73 |
| regex_program | <span style='color: green'>(-0 [-2.4%])</span> 2.30 | <span style='color: green'>(-0 [-6.6%])</span> 0.70 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: green'>(-14 [-2.4%])</span> 575.50 | <span style='color: green'>(-57 [-2.4%])</span> 2,302 | <span style='color: green'>(-49 [-6.6%])</span> 696 | <span style='color: green'>(-4 [-0.7%])</span> 533 |
...
| `execute_metered_insn_mi/s` | <span style='color: green'>(-6 [-5.2%])</span> 108.05 | -          | <span style='color: green'>(-6 [-5.2%])</span> 108.05 | <span style='color: green'>(-6 [-5.2%])</span> 108.05 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` | <span style='color: red'>(+1 [+1.9%])</span> 54.75 | <span style='color: red'>(+4 [+1.9%])</span> 219 | <span style='color: red'>(+3 [+4.6%])</span> 68 |  45 |
| `execute_preflight_insn_mi/s` | <span style='color: green'>(-0 [-0.7%])</span> 30.47 | -          | <span style='color: red'>(+0 [+0.2%])</span> 31.98 | <span style='color: green'>(-0 [-1.0%])</span> 27.35 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+2 [+1.0%])</span> 179.25 | <span style='color: red'>(+7 [+1.0%])</span> 717 | <span style='color: red'>(+2 [+0.9%])</span> 213 | <span style='color: red'>(+1 [+0.7%])</span> 154 |
| `memory_finalize_time_ms` |  1 |  4 |  4 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: green'>(-16 [-5.7%])</span> 274.50 | <span style='color: green'>(-66 [-5.7%])</span> 1,098 | <span style='color: green'>(-50 [-14.6%])</span> 292 | <span style='color: green'>(-2 [-0.7%])</span> 268 |
| `main_trace_commit_time_ms` | <span style='color: green'>(-0 [-1.0%])</span> 51.25 | <span style='color: green'>(-2 [-1.0%])</span> 205 | <span style='color: green'>(-2 [-3.5%])</span> 55 | <span style='color: green'>(-1 [-2.0%])</span> 49 |
| `generate_perm_trace_time_ms` | <span style='color: green'>(-9 [-27.1%])</span> 24.25 | <span style='color: green'>(-36 [-27.1%])</span> 97 | <span style='color: green'>(-27 [-50.0%])</span> 27 | <span style='color: green'>(-1 [-5.0%])</span> 19 |
| `perm_trace_commit_time_ms` | <span style='color: red'>(+1 [+1.2%])</span> 65.20 | <span style='color: red'>(+3 [+1.2%])</span> 260.81 | <span style='color: red'>(+1 [+1.7%])</span> 72.06 | <span style='color: green'>(-0 [-0.6%])</span> 55.46 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+1 [+1.2%])</span> 59.11 | <span style='color: red'>(+3 [+1.2%])</span> 236.46 | <span style='color: red'>(+1 [+1.7%])</span> 70.88 | <span style='color: red'>(+0 [+0.3%])</span> 53.09 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+0 [+1.3%])</span> 14.86 | <span style='color: red'>(+1 [+1.3%])</span> 59.43 |  16.72 | <span style='color: green'>(-0 [-1.4%])</span> 12.68 |
| `pcs_opening_time_ms ` | <span style='color: green'>(-8 [-13.1%])</span> 56.50 | <span style='color: green'>(-34 [-13.1%])</span> 226 | <span style='color: green'>(-23 [-28.0%])</span> 59 | <span style='color: green'>(-2 [-3.6%])</span> 54 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 539 | 1 | 38 | 4,137,502 | 108.05 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 213 | 696 | 23,446,148 | 150,778,428 | 213 | 292 | 0 | 58.73 | 16.72 | 5 | 72.06 | 59 | 100 | 59 | 4 | 55 | 10,899,170 | 27 | 47 | 1,103,000 | 27.35 | 21 | 76 | 1 | 59 | 
| regex_program | 1 | 154 | 533 | 11,598,276 | 128,513,066 | 154 | 269 | 1 | 53.76 | 14.70 | 4 | 66.67 | 57 | 91 | 56 | 0 | 51 | 2,196,106 | 24 | 68 | 1,104,000 | 30.72 | 16 | 69 | 0 | 56 | 
| regex_program | 2 | 165 | 534 | 11,579,064 | 128,513,066 | 165 | 269 | 1 | 53.09 | 15.33 | 4 | 66.62 | 54 | 94 | 54 | 0 | 50 | 2,177,334 | 27 | 59 | 1,104,000 | 31.98 | 16 | 69 | 0 | 54 | 
| regex_program | 3 | 185 | 539 | 11,853,872 | 103,456,394 | 185 | 268 | 0 | 70.88 | 12.68 | 5 | 55.46 | 56 | 77 | 56 | 0 | 49 | 2,422,606 | 19 | 45 | 826,502 | 31.83 | 18 | 84 | 1 | 56 | 

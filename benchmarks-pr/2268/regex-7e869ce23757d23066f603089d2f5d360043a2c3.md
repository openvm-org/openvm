...
|:---|---:|---:|
| Total | <span style='color: green'>(-0 [-0.8%])</span> 2.38 | <span style='color: green'>(-0 [-5.8%])</span> 0.74 |
| regex_program | <span style='color: green'>(-0 [-0.9%])</span> 2.34 | <span style='color: green'>(-0 [-6.2%])</span> 0.70 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: green'>(-5 [-0.9%])</span> 584.50 | <span style='color: green'>(-21 [-0.9%])</span> 2,338 | <span style='color: green'>(-46 [-6.2%])</span> 699 | <span style='color: red'>(+3 [+0.6%])</span> 540 |
...
| `execute_metered_insn_mi/s` | <span style='color: green'>(-4 [-3.3%])</span> 110.23 | -          | <span style='color: green'>(-4 [-3.3%])</span> 110.23 | <span style='color: green'>(-4 [-3.3%])</span> 110.23 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` | <span style='color: green'>(-0 [-0.5%])</span> 53.50 | <span style='color: green'>(-1 [-0.5%])</span> 214 | <span style='color: green'>(-1 [-1.5%])</span> 64 | <span style='color: green'>(-1 [-2.2%])</span> 44 |
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+0 [+0.6%])</span> 30.86 | -          | <span style='color: red'>(+1 [+1.7%])</span> 32.46 | <span style='color: green'>(-1 [-3.2%])</span> 26.75 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+2 [+1.1%])</span> 179.50 | <span style='color: red'>(+8 [+1.1%])</span> 718 | <span style='color: green'>(-3 [-1.4%])</span> 208 | <span style='color: red'>(+6 [+3.9%])</span> 159 |
| `memory_finalize_time_ms` |  1 |  4 |  4 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: green'>(-8 [-2.6%])</span> 283.50 | <span style='color: green'>(-30 [-2.6%])</span> 1,134 | <span style='color: green'>(-44 [-12.9%])</span> 298 | <span style='color: red'>(+2 [+0.7%])</span> 272 |
| `main_trace_commit_time_ms` | <span style='color: red'>(+1 [+1.9%])</span> 52.75 | <span style='color: red'>(+4 [+1.9%])</span> 211 | <span style='color: red'>(+1 [+1.8%])</span> 58 | <span style='color: red'>(+1 [+2.0%])</span> 51 |
| `generate_perm_trace_time_ms` | <span style='color: green'>(-5 [-15.0%])</span> 28.25 | <span style='color: green'>(-20 [-15.0%])</span> 113 | <span style='color: green'>(-16 [-29.6%])</span> 38 | <span style='color: green'>(-1 [-5.0%])</span> 19 |
| `perm_trace_commit_time_ms` | <span style='color: red'>(+1 [+1.9%])</span> 65.67 | <span style='color: red'>(+5 [+1.9%])</span> 262.67 | <span style='color: red'>(+2 [+3.5%])</span> 73.35 | <span style='color: red'>(+1 [+1.0%])</span> 56.34 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+1 [+0.9%])</span> 58.96 | <span style='color: red'>(+2 [+0.9%])</span> 235.83 | <span style='color: red'>(+0 [+0.4%])</span> 70.01 | <span style='color: red'>(+0 [+0.4%])</span> 53.13 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+0 [+0.7%])</span> 14.76 | <span style='color: red'>(+0 [+0.7%])</span> 59.05 | <span style='color: red'>(+0 [+0.5%])</span> 16.81 | <span style='color: green'>(-0 [-0.8%])</span> 12.76 |
| `pcs_opening_time_ms ` | <span style='color: green'>(-4 [-6.9%])</span> 60.50 | <span style='color: green'>(-18 [-6.9%])</span> 242 | <span style='color: green'>(-19 [-23.2%])</span> 63 | <span style='color: red'>(+2 [+3.6%])</span> 58 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 544 | 1 | 37 | 4,137,502 | 110.23 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 208 | 699 | 23,446,148 | 150,778,428 | 208 | 298 | 0 | 58.92 | 16.81 | 5 | 73.35 | 60 | 103 | 60 | 4 | 58 | 10,899,170 | 29 | 48 | 1,103,000 | 26.75 | 21 | 76 | 1 | 60 | 
| regex_program | 1 | 159 | 555 | 11,598,276 | 128,513,066 | 159 | 289 | 1 | 53.76 | 14.95 | 5 | 66.64 | 63 | 105 | 63 | 0 | 51 | 2,196,106 | 38 | 64 | 1,104,000 | 32.24 | 16 | 69 | 0 | 63 | 
| regex_program | 2 | 165 | 540 | 11,579,064 | 128,513,066 | 165 | 275 | 1 | 53.13 | 14.54 | 4 | 66.34 | 61 | 94 | 61 | 0 | 51 | 2,177,334 | 27 | 58 | 1,104,000 | 31.98 | 16 | 68 | 0 | 61 | 
| regex_program | 3 | 186 | 544 | 11,853,872 | 103,456,394 | 186 | 272 | 0 | 70.01 | 12.76 | 6 | 56.34 | 58 | 78 | 58 | 0 | 51 | 2,422,606 | 19 | 44 | 826,502 | 32.46 | 18 | 83 | 1 | 58 | 
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19519239361)

...
|:---|---:|---:|
| Total | <span style='color: red'>(+0 [+0.8%])</span> 0.100 | <span style='color: red'>(+0 [+0.7%])</span> 0.57 |
| fibonacci_program | <span style='color: red'>(+0 [+0.9%])</span> 0.99 | <span style='color: red'>(+0 [+0.9%])</span> 0.56 |


| fibonacci_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+4 [+0.9%])</span> 494 | <span style='color: red'>(+9 [+0.9%])</span> 988 | <span style='color: red'>(+5 [+0.9%])</span> 558 | <span style='color: red'>(+4 [+0.9%])</span> 430 |
...
| `execute_metered_insn_mi/s` | <span style='color: red'>(+15 [+13.1%])</span> 130.46 | -          | <span style='color: red'>(+15 [+13.1%])</span> 130.46 | <span style='color: red'>(+15 [+13.1%])</span> 130.46 |
| `execute_preflight_insns` |  750,104.50 |  1,500,209 |  873,000 |  627,209 |
| `execute_preflight_time_ms` |  28.50 |  57 |  32 |  25 |
| `execute_preflight_insn_mi/s` | <span style='color: green'>(-0 [-1.2%])</span> 36.26 | -          | <span style='color: green'>(-1 [-2.3%])</span> 37.75 |  34.77 |
...
| `generate_perm_trace_time_ms` | <span style='color: red'>(+0 [+3.6%])</span> 14.50 | <span style='color: red'>(+1 [+3.6%])</span> 29 |  16 | <span style='color: red'>(+1 [+8.3%])</span> 13 |
| `perm_trace_commit_time_ms` | <span style='color: red'>(+1 [+1.5%])</span> 42.91 | <span style='color: red'>(+1 [+1.5%])</span> 85.82 | <span style='color: green'>(-1 [-1.1%])</span> 45.02 | <span style='color: red'>(+2 [+4.6%])</span> 40.79 |
| `quotient_poly_compute_time_ms` | <span style='color: green'>(-2 [-5.1%])</span> 30.94 | <span style='color: green'>(-3 [-5.1%])</span> 61.88 | <span style='color: green'>(-2 [-5.6%])</span> 32.61 | <span style='color: green'>(-1 [-4.5%])</span> 29.26 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+0 [+1.6%])</span> 12.40 | <span style='color: red'>(+0 [+1.6%])</span> 24.79 | <span style='color: red'>(+1 [+5.0%])</span> 12.93 | <span style='color: green'>(-0 [-1.8%])</span> 11.86 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+1 [+2.4%])</span> 43.50 | <span style='color: red'>(+2 [+2.4%])</span> 87 | <span style='color: red'>(+2 [+4.5%])</span> 46 |  41 |
...
| --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 430 | 1 | 11 | 1,500,209 | 130.46 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 200 | 558 | 9,677,708 | 84,395,212 | 200 | 188 | 0 | 32.61 | 12.93 | 5 | 45.02 | 46 | 62 | 45 | 0 | 33 | 1,035,986 | 16 | 25 | 873,000 | 34.77 | 14 | 46 | 0 | 45 | 
| fibonacci_program | 1 | 190 | 430 | 9,708,170 | 74,305,770 | 190 | 166 | 1 | 29.26 | 11.86 | 4 | 40.79 | 41 | 54 | 41 | 0 | 28 | 1,064,416 | 13 | 32 | 627,209 | 37.75 | 11 | 41 | 0 | 41 | 

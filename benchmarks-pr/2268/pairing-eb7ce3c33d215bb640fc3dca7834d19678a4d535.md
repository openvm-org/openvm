...
|:---|---:|---:|
| Total | <span style='color: red'>(+0 [+2.8%])</span> 1.58 | <span style='color: red'>(+0 [+0.4%])</span> 0.92 |
| pairing | <span style='color: red'>(+0 [+2.1%])</span> 1.47 | <span style='color: green'>(-0 [-1.1%])</span> 0.82 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+15 [+2.1%])</span> 737 | <span style='color: red'>(+30 [+2.1%])</span> 1,474 | <span style='color: green'>(-9 [-1.1%])</span> 815 | <span style='color: red'>(+39 [+6.3%])</span> 659 |
| `main_cells_used     ` |  12,734,105 |  25,468,210 |  16,059,916 |  9,408,294 |
| `total_cells_used    ` |  27,501,699 |  55,003,398 |  32,689,110 |  22,314,288 |
| `execute_metered_time_ms` | <span style='color: red'>(+13 [+14.4%])</span> 103 | -          | -          | -          |
| `execute_metered_insn_mi/s` | <span style='color: green'>(-2 [-11.9%])</span> 16.91 | -          | <span style='color: green'>(-2 [-11.9%])</span> 16.91 | <span style='color: green'>(-2 [-11.9%])</span> 16.91 |
| `execute_preflight_insns` |  872,871 |  1,745,742 |  1,157,000 |  588,742 |
| `execute_preflight_time_ms` | <span style='color: red'>(+4 [+4.8%])</span> 99 | <span style='color: red'>(+9 [+4.8%])</span> 198 | <span style='color: red'>(+7 [+5.4%])</span> 137 | <span style='color: red'>(+2 [+3.4%])</span> 61 |
| `execute_preflight_insn_mi/s` | <span style='color: green'>(-0 [-1.6%])</span> 13.22 | -          | <span style='color: red'>(+0 [+0.3%])</span> 17.79 | <span style='color: green'>(-0 [-5.3%])</span> 8.64 |
| `trace_gen_time_ms   ` | <span style='color: green'>(-10 [-5.8%])</span> 171.50 | <span style='color: green'>(-21 [-5.8%])</span> 343 | <span style='color: green'>(-8 [-4.0%])</span> 191 | <span style='color: green'>(-13 [-7.9%])</span> 152 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+22 [+6.2%])</span> 374 | <span style='color: red'>(+44 [+6.2%])</span> 748 | <span style='color: green'>(-2 [-0.5%])</span> 382 | <span style='color: red'>(+46 [+14.4%])</span> 366 |
...
| `generate_perm_trace_time_ms` | <span style='color: green'>(-3 [-6.8%])</span> 41 | <span style='color: green'>(-6 [-6.8%])</span> 82 | <span style='color: green'>(-6 [-12.5%])</span> 42 |  40 |
| `perm_trace_commit_time_ms` | <span style='color: red'>(+0 [+0.2%])</span> 76.72 | <span style='color: red'>(+0 [+0.2%])</span> 153.43 | <span style='color: green'>(-0 [-0.5%])</span> 89.20 | <span style='color: red'>(+1 [+1.2%])</span> 64.23 |
| `quotient_poly_compute_time_ms` | <span style='color: green'>(-0 [-0.2%])</span> 78.19 | <span style='color: green'>(-0 [-0.2%])</span> 156.37 | <span style='color: green'>(-2 [-1.7%])</span> 86.66 | <span style='color: red'>(+1 [+1.8%])</span> 69.71 |
| `quotient_poly_commit_time_ms` | <span style='color: green'>(-0 [-2.0%])</span> 15.97 | <span style='color: green'>(-1 [-2.0%])</span> 31.95 | <span style='color: green'>(-0 [-1.7%])</span> 17.100 | <span style='color: green'>(-0 [-2.3%])</span> 13.95 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+26 [+39.4%])</span> 92 | <span style='color: red'>(+52 [+39.4%])</span> 184 | <span style='color: red'>(+49 [+73.1%])</span> 116 | <span style='color: red'>(+3 [+4.6%])</span> 68 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 659 | 1 | 103 | 1,745,742 | 16.91 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 152 | 815 | 32,689,110 | 172,558,444 | 152 | 382 | 0 | 86.66 | 17.100 | 6 | 89.20 | 68 | 132 | 68 | 1 | 74 | 16,059,916 | 40 | 137 | 1,157,000 | 8.64 | 26 | 105 | 1 | 68 | 
| pairing | 1 | 191 | 659 | 22,314,288 | 119,958,502 | 191 | 366 | 1 | 69.71 | 13.95 | 6 | 64.23 | 116 | 109 | 116 | 0 | 55 | 9,408,294 | 42 | 61 | 588,742 | 17.79 | 20 | 84 | 1 | 116 | 

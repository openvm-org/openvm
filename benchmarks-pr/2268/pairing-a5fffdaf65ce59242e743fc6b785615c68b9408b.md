...
|:---|---:|---:|
| Total | <span style='color: red'>(+0 [+2.3%])</span> 1.57 | <span style='color: green'>(-0 [-1.1%])</span> 0.90 |
| pairing | <span style='color: red'>(+0 [+2.0%])</span> 1.47 | <span style='color: green'>(-0 [-2.1%])</span> 0.81 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+14 [+2.0%])</span> 736.50 | <span style='color: red'>(+29 [+2.0%])</span> 1,473 | <span style='color: green'>(-17 [-2.1%])</span> 807 | <span style='color: red'>(+46 [+7.4%])</span> 666 |
| `main_cells_used     ` |  12,734,105 |  25,468,210 |  16,059,916 |  9,408,294 |
| `total_cells_used    ` |  27,501,699 |  55,003,398 |  32,689,110 |  22,314,288 |
| `execute_metered_time_ms` | <span style='color: red'>(+7 [+7.8%])</span> 97 | -          | -          | -          |
| `execute_metered_insn_mi/s` | <span style='color: green'>(-1 [-7.2%])</span> 17.82 | -          | <span style='color: green'>(-1 [-7.2%])</span> 17.82 | <span style='color: green'>(-1 [-7.2%])</span> 17.82 |
| `execute_preflight_insns` |  872,871 |  1,745,742 |  1,157,000 |  588,742 |
| `execute_preflight_time_ms` | <span style='color: red'>(+2 [+2.6%])</span> 97 | <span style='color: red'>(+5 [+2.6%])</span> 194 | <span style='color: red'>(+5 [+3.8%])</span> 135 |  59 |
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+0 [+0.7%])</span> 13.53 | -          | <span style='color: red'>(+1 [+3.1%])</span> 18.29 | <span style='color: green'>(-0 [-4.1%])</span> 8.76 |
| `trace_gen_time_ms   ` | <span style='color: green'>(-10 [-5.5%])</span> 172 | <span style='color: green'>(-20 [-5.5%])</span> 344 | <span style='color: green'>(-8 [-4.0%])</span> 191 | <span style='color: green'>(-12 [-7.3%])</span> 153 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+23 [+6.5%])</span> 375 | <span style='color: red'>(+46 [+6.5%])</span> 750 | <span style='color: green'>(-9 [-2.3%])</span> 375 | <span style='color: red'>(+55 [+17.2%])</span> 375 |
| `main_trace_commit_time_ms` | <span style='color: green'>(-2 [-2.3%])</span> 63.50 | <span style='color: green'>(-3 [-2.3%])</span> 127 | <span style='color: green'>(-2 [-2.7%])</span> 73 | <span style='color: green'>(-1 [-1.8%])</span> 54 |
...
| `perm_trace_commit_time_ms` | <span style='color: green'>(-1 [-1.0%])</span> 75.79 | <span style='color: green'>(-1 [-1.0%])</span> 151.59 | <span style='color: green'>(-2 [-2.7%])</span> 87.23 | <span style='color: red'>(+1 [+1.5%])</span> 64.36 |
| `quotient_poly_compute_time_ms` | <span style='color: green'>(-1 [-1.2%])</span> 77.36 | <span style='color: green'>(-2 [-1.2%])</span> 154.71 | <span style='color: green'>(-3 [-3.1%])</span> 85.46 | <span style='color: red'>(+1 [+1.1%])</span> 69.25 |
| `quotient_poly_commit_time_ms` | <span style='color: green'>(-0 [-1.9%])</span> 15.99 | <span style='color: green'>(-1 [-1.9%])</span> 31.97 | <span style='color: green'>(-0 [-0.8%])</span> 18.15 | <span style='color: green'>(-0 [-3.2%])</span> 13.82 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+16 [+24.2%])</span> 82 | <span style='color: red'>(+32 [+24.2%])</span> 164 | <span style='color: red'>(+30 [+44.8%])</span> 97 | <span style='color: red'>(+2 [+3.1%])</span> 67 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 666 | 1 | 97 | 1,745,742 | 17.82 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 153 | 807 | 32,689,110 | 172,558,444 | 153 | 375 | 0 | 85.46 | 18.15 | 6 | 87.23 | 67 | 129 | 67 | 1 | 73 | 16,059,916 | 39 | 135 | 1,157,000 | 8.76 | 26 | 104 | 1 | 67 | 
| pairing | 1 | 191 | 666 | 22,314,288 | 119,958,502 | 191 | 375 | 1 | 69.25 | 13.82 | 5 | 64.36 | 97 | 139 | 97 | 0 | 54 | 9,408,294 | 71 | 59 | 588,742 | 18.29 | 20 | 83 | 1 | 97 | 

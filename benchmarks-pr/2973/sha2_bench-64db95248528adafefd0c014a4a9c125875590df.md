...
| `total_proof_time_ms ` |  2,049.50 |  4,099 |  2,528 |  1,571 |
...
| `execute_preflight_time_ms` |  335.50 |  671 |  474 |  197 |
| `execute_preflight_insn_mi/s` |  38.05 | -          |  38.72 |  37.39 |
| `trace_gen_time_ms   ` |  72 |  144 |  101 |  43 |
| `set_initial_memory_time_ms` |  0 |  0 |  0 |  0 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,640.50 |  3,281 |  2,228 |  1,053 |
| `prover.main_trace_commit_time_ms` |  404 |  808 |  595 |  213 |
| `prover.rap_constraints_time_ms` |  962 |  1,924 |  1,273 |  651 |
| `prover.openings_time_ms` |  273 |  546 |  358 |  188 |
| `prover.rap_constraints.logup_gkr_time_ms` |  263 |  526 |  344 |  182 |
| `prover.rap_constraints.round0_time_ms` |  519 |  1,038 |  694 |  344 |
...
| `prover.openings.whir_time_ms` |  199 |  398 |  261 |  137 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/64db95248528adafefd0c014a4a9c125875590df/sha2_bench-64db95248528adafefd0c014a4a9c125875590df.memory.svg)
...
| prover.batch_constraints.before_round0 | 14.29 | app_proof.prover.0 |
| frac_sumcheck.gkr_rounds | 14.29 | app_proof.prover.0 |
...
| 17 | VmAirWrapper<Rv64BaseAluImmU16AdapterAir, ShiftRightArithmeticImmCoreAir<4, 16> |  | 20 | 78 | 3 | 
...
| 38 | VmAirWrapper<Rv64BaseAluRegU16AdapterAir, ShiftRightArithmeticCoreAir<4, 16> |  | 25 | 79 | 3 | 
...
| 43 | VmAirWrapper<Rv64BaseAluRegU16AdapterAir, AddSubCoreAir<4, 16> |  | 19 | 14 | 3 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 56 |  |  |  | 290 |  |  |  |  |  |  | 
| app_proof |  |  |  | 1,571 |  | 56 | 11,167,961 | 196.38 | 0 | 4,164 |  | 
...
| app_proof | VmAirWrapper<Rv64BaseAluRegU16AdapterAir, AddSubCoreAir<4, 16> | 0 |  | 11 | 
...
| app_proof | 43 | VmAirWrapper<Rv64BaseAluRegU16AdapterAir, AddSubCoreAir<4, 16> | ADD | 0 | 735,588 | 
| app_proof | 43 | VmAirWrapper<Rv64BaseAluRegU16AdapterAir, AddSubCoreAir<4, 16> | SUB | 0 | 314,551 | 
...
| app_proof | 43 | VmAirWrapper<Rv64BaseAluRegU16AdapterAir, AddSubCoreAir<4, 16> | ADD | 1 | 413,869 | 
| app_proof | 43 | VmAirWrapper<Rv64BaseAluRegU16AdapterAir, AddSubCoreAir<4, 16> | SUB | 1 | 176,979 | 
...
| app_proof | 43 | VmAirWrapper<Rv64BaseAluRegU16AdapterAir, AddSubCoreAir<4, 16> | prover | 0 | 2,097,152 | 32 | 67,108,864 | 
...
| app_proof | 43 | VmAirWrapper<Rv64BaseAluRegU16AdapterAir, AddSubCoreAir<4, 16> | prover | 1 | 1,048,576 | 32 | 33,554,432 | 
...
| app_proof | 43 | VmAirWrapper<Rv64BaseAluRegU16AdapterAir, AddSubCoreAir<4, 16> | 0 | 1,050,139 | 1,047,013 | 84,011,120 | 83,761,040 | 134,417,792 | 134,017,664 | 33,604,448 | 33,504,416 | 723,283,237 | 721,130,203 | 19,952,641 | 19,893,247 | 
...
| app_proof | 43 | VmAirWrapper<Rv64BaseAluRegU16AdapterAir, AddSubCoreAir<4, 16> | 1 | 590,848 | 457,728 | 47,267,840 | 36,618,240 | 75,628,544 | 58,589,184 | 18,907,136 | 14,647,296 | 406,946,560 | 315,260,160 | 11,226,112 | 8,696,832 | 
...
| leaf | 0 | 117 | 524 | 117 | 35 | 13 | 2 | 9 | 9 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 181 | 46 | 0 | 0 | 80 | 29 | 28 | 36 | 13 | 0 | 53 | 43 | 10 | 2 | 7 | 47 | 46 | 80 | 0 | 1 | 12 | 0 | 0 | 
...
| leaf | 0 | prover | 237,929,272 | 407 | 145 | 0 | 0 | 141 | 71 | 69 | 44 | 26 | 0 | 119 | 96 | 22 | 10 | 11 | 146 | 145 | 141 | 0 | 3 | 25 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,336,706,462 | 2,228 | 595 | 0 | 0 | 1,273 | 694 | 693 | 234 | 344 | 1 | 358 | 261 | 97 | 59 | 37 | 595 | 595 | 1,273 | 0 | 1 | 342 | 0 | 0 | 
| app_proof | prover | 1 | 680,630,448 | 1,053 | 212 | 0 | 0 | 651 | 344 | 343 | 124 | 182 | 0 | 188 | 137 | 51 | 30 | 21 | 213 | 212 | 651 | 0 | 1 | 181 | 0 | 0 | 

| group | phase | segment | trace_height_constraint | weighted_sum | threshold |
| --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 0 | 273,310,172 | 2,013,265,921 | 
| app_proof | prover | 1 | 0 | 142,633,754 | 2,013,265,921 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 0 | 2 | 101 | 2,528 | 101 | 0 | 12,493,343,784 | 3,553,584,960 | 16,046,928,744 | 2,097,152 | 0 | 3 | 197 | 7,147,000 | 37.39 | 
| app_proof | 1 | 0 | 1 | 43 | 1,571 | 43 | 0 | 7,060,295,532 | 1,113,721,044 | 8,174,016,576 | 2,097,152 | 0 | 2 | 474 | 4,020,961 | 38.72 | 

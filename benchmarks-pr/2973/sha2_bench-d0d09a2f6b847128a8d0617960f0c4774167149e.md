...
|:---|---:|---:|---:|
| Total |  5.17 |  3.58 |  3.58 |
| app_proof |  4.21 |  2.62 |  2.62 |
| leaf |  0.53 |  0.53 |  0.53 |
...
| `total_proof_time_ms ` |  2,078 |  4,156 |  2,566 |  1,590 |
| `compile_metered_time_ms` |  6 |  6 |  6 |  6 |
| `execute_metered_time_ms` |  57 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  194.24 | -          |  194.24 |  194.24 |
| `execute_preflight_insns` |  5,583,980.50 |  11,167,961 |  7,147,000 |  4,020,961 |
| `execute_preflight_time_ms` |  344.50 |  689 |  480 |  209 |
| `execute_preflight_insn_mi/s` |  36.76 | -          |  38.25 |  35.28 |
| `trace_gen_time_ms   ` |  74 |  148 |  105 |  43 |
| `set_initial_memory_time_ms` |  0 |  0 |  0 |  0 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,658 |  3,316 |  2,251 |  1,065 |
| `prover.main_trace_commit_time_ms` |  408.50 |  817 |  603 |  214 |
| `prover.rap_constraints_time_ms` |  974 |  1,948 |  1,290 |  658 |
| `prover.openings_time_ms` |  274.50 |  549 |  358 |  191 |
| `prover.rap_constraints.logup_gkr_time_ms` |  267.50 |  535 |  351 |  184 |
| `prover.rap_constraints.round0_time_ms` |  523 |  1,046 |  699 |  347 |
| `prover.rap_constraints.mle_rounds_time_ms` |  182 |  364 |  238 |  126 |
| `prover.openings.stacked_reduction_time_ms` |  75 |  150 |  98 |  52 |
...
| `prover.openings.whir_time_ms` |  199 |  398 |  259 |  139 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/d0d09a2f6b847128a8d0617960f0c4774167149e/sha2_bench-d0d09a2f6b847128a8d0617960f0c4774167149e.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 57 |  |  |  | 298 |  |  |  |  |  |  | 
| app_proof |  |  |  | 1,590 |  | 57 | 11,167,961 | 194.24 | 0 | 4,223 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 175 | 46 | 0 | 0 | 80 | 29 | 28 | 37 | 13 | 0 | 48 | 37 | 10 | 2 | 7 | 47 | 46 | 80 | 0 | 1 | 13 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 109 | 20 | 0 | 0 | 55 | 20 | 20 | 23 | 10 | 0 | 33 | 25 | 7 | 1 | 6 | 20 | 20 | 55 | 0 | 1 | 10 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 102 | 15 | 0 | 0 | 55 | 20 | 19 | 21 | 12 | 0 | 32 | 24 | 7 | 1 | 5 | 15 | 15 | 55 | 0 | 1 | 10 | 0 | 0 | 
| leaf | 0 | prover | 237,929,272 | 405 | 146 | 0 | 0 | 141 | 71 | 70 | 44 | 25 | 0 | 116 | 94 | 22 | 10 | 11 | 146 | 146 | 141 | 0 | 3 | 25 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,336,444,315 | 2,251 | 603 | 0 | 0 | 1,290 | 699 | 698 | 238 | 351 | 1 | 358 | 259 | 98 | 60 | 37 | 603 | 603 | 1,290 | 0 | 1 | 349 | 0 | 0 | 
| app_proof | prover | 1 | 680,499,316 | 1,065 | 214 | 0 | 0 | 658 | 347 | 346 | 126 | 184 | 0 | 191 | 139 | 52 | 31 | 21 | 214 | 214 | 658 | 0 | 1 | 183 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 0 | 2 | 105 | 2,566 | 105 | 0 | 12,490,827,300 | 3,552,955,680 | 16,043,782,980 | 2,097,152 | 0 | 3 | 209 | 7,147,000 | 35.28 | 
| app_proof | 1 | 0 | 1 | 43 | 1,590 | 43 | 0 | 7,058,878,680 | 1,113,564,312 | 8,172,442,992 | 2,097,152 | 0 | 2 | 480 | 4,020,961 | 38.25 | 

...
|:---|---:|---:|---:|
| Total |  5.14 |  3.56 |  3.56 |
| app_proof |  4.19 |  2.61 |  2.61 |
| leaf |  0.52 |  0.52 |  0.52 |
...
| `total_proof_time_ms ` |  2,065 |  4,130 |  2,549 |  1,581 |
...
| `execute_preflight_time_ms` |  346.50 |  693 |  478 |  215 |
| `execute_preflight_insn_mi/s` |  35.80 | -          |  37.23 |  34.37 |
| `trace_gen_time_ms   ` |  71.50 |  143 |  100 |  43 |
| `set_initial_memory_time_ms` |  0 |  0 |  0 |  0 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,645.50 |  3,291 |  2,233 |  1,058 |
| `prover.main_trace_commit_time_ms` |  404.50 |  809 |  595 |  214 |
| `prover.rap_constraints_time_ms` |  968 |  1,936 |  1,281 |  655 |
| `prover.openings_time_ms` |  272.50 |  545 |  356 |  189 |
| `prover.rap_constraints.logup_gkr_time_ms` |  265 |  530 |  347 |  183 |
| `prover.rap_constraints.round0_time_ms` |  521 |  1,042 |  697 |  345 |
...
| `prover.openings.whir_time_ms` |  197.50 |  395 |  259 |  136 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/0d0a67712fc6d9c62f3240e4f47cea8a9bfc4a7d/sha2_bench-0d0a67712fc6d9c62f3240e4f47cea8a9bfc4a7d.memory.svg)
...
| 37 | VmAirWrapper<Rv64BaseAluWU16AdapterAir, ShiftLogicalCoreAir<2, 16> |  | 22 | 108 | 3 | 
| 38 | VmAirWrapper<Rv64BaseAluRegU16AdapterAir, ShiftRightArithmeticCoreAir<4, 16> |  | 25 | 46 | 3 | 
| 39 | VmAirWrapper<Rv64BaseAluRegU16AdapterAir, ShiftLogicalCoreAir<4, 16> |  | 24 | 132 | 3 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 57 |  |  |  | 286 |  |  |  |  |  |  | 
| app_proof |  |  |  | 1,581 |  | 56 | 11,167,961 | 199.23 | 0 | 4,195 |  | 
...
| app_proof | VmAirWrapper<Rv64BaseAluImmU16AdapterAir, LessThanImmCoreAir<4, 16> | 35 | VmAirWrapper<Rv64BaseAluImmU16AdapterAir, LessThanImmCoreAir<4, 16> | 0 | 96 | 
...
| app_proof | VmAirWrapper<Rv64LoadAdapterAir, LoadCoreAir<8, 1> | 0 | 5 | 9 | 
...
| app_proof | 37 | VmAirWrapper<Rv64BaseAluWU16AdapterAir, ShiftLogicalCoreAir<2, 16> | prover | 0 | 1 | 59 | 59 | 
...
| app_proof | 37 | VmAirWrapper<Rv64BaseAluWU16AdapterAir, ShiftLogicalCoreAir<2, 16> | prover | 1 | 4 | 59 | 236 | 
| app_proof | 39 | VmAirWrapper<Rv64BaseAluRegU16AdapterAir, ShiftLogicalCoreAir<4, 16> | prover | 1 | 16 | 64 | 1,024 | 
...
| app_proof | 37 | VmAirWrapper<Rv64BaseAluWU16AdapterAir, ShiftLogicalCoreAir<2, 16> | 0 | 1 |  | 148 |  | 236 |  | 59 |  | 798 |  | 22 |  | 
...
| app_proof | 46 | Poseidon2PeripheryAir<BabyBearParameters>, 1> | 0 | 1,336 | 712 | 1,002,000 | 534,000 | 1,603,200 | 854,400 | 400,800 | 213,600 | 48,430 | 25,810 | 1,336 | 712 | 
...
| app_proof | 37 | VmAirWrapper<Rv64BaseAluWU16AdapterAir, ShiftLogicalCoreAir<2, 16> | 1 | 3 | 1 | 443 | 147 | 708 | 236 | 177 | 59 | 2,393 | 797 | 66 | 22 | 
| app_proof | 39 | VmAirWrapper<Rv64BaseAluRegU16AdapterAir, ShiftLogicalCoreAir<4, 16> | 1 | 14 | 2 | 2,240 | 320 | 3,584 | 512 | 896 | 128 | 12,180 | 1,740 | 336 | 48 | 
...
| app_proof | 46 | Poseidon2PeripheryAir<BabyBearParameters>, 1> | 1 | 1,370 | 678 | 1,027,500 | 508,500 | 1,644,000 | 813,600 | 411,000 | 203,400 | 49,663 | 24,577 | 1,370 | 678 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 178 | 46 | 0 | 0 | 79 | 29 | 28 | 37 | 13 | 0 | 51 | 40 | 10 | 2 | 7 | 47 | 46 | 79 | 0 | 1 | 12 | 0 | 0 | 
...
| leaf | 0 | prover | 237,929,272 | 406 | 146 | 0 | 0 | 141 | 71 | 69 | 44 | 26 | 0 | 118 | 96 | 22 | 10 | 11 | 146 | 146 | 141 | 0 | 3 | 25 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,336,706,462 | 2,233 | 594 | 0 | 0 | 1,281 | 697 | 696 | 236 | 347 | 1 | 356 | 259 | 97 | 59 | 37 | 595 | 594 | 1,281 | 0 | 1 | 345 | 0 | 0 | 
| app_proof | prover | 1 | 680,630,448 | 1,058 | 214 | 0 | 0 | 655 | 345 | 345 | 125 | 183 | 0 | 189 | 136 | 52 | 30 | 21 | 214 | 214 | 655 | 0 | 1 | 182 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 0 | 2 | 100 | 2,549 | 100 | 0 | 12,493,343,784 | 3,553,584,960 | 16,046,928,744 | 2,097,152 | 0 | 3 | 215 | 7,147,000 | 34.37 | 
| app_proof | 1 | 0 | 1 | 43 | 1,581 | 43 | 0 | 7,060,295,532 | 1,113,721,044 | 8,174,016,576 | 2,097,152 | 0 | 2 | 478 | 4,020,961 | 37.23 | 

...
| `total_proof_time_ms ` |  2,066 |  4,132 |  2,543 |  1,589 |
...
| `execute_preflight_time_ms` |  346.50 |  693 |  485 |  208 |
| `execute_preflight_insn_mi/s` |  35.29 | -          |  35.46 |  35.12 |
| `trace_gen_time_ms   ` |  71.50 |  143 |  100 |  43 |
| `set_initial_memory_time_ms` |  0 |  0 |  0 |  0 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,646.50 |  3,293 |  2,234 |  1,059 |
| `prover.main_trace_commit_time_ms` |  403 |  806 |  593 |  213 |
| `prover.rap_constraints_time_ms` |  967.50 |  1,935 |  1,280 |  655 |
| `prover.openings_time_ms` |  275.50 |  551 |  360 |  191 |
| `prover.rap_constraints.logup_gkr_time_ms` |  264.50 |  529 |  346 |  183 |
| `prover.rap_constraints.round0_time_ms` |  521.50 |  1,043 |  697 |  346 |
| `prover.rap_constraints.mle_rounds_time_ms` |  180 |  360 |  236 |  124 |
...
| `prover.openings.whir_time_ms` |  200 |  400 |  262 |  138 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/919347b77e6f398460527acf891dd1a7c07e2d56/sha2_bench-919347b77e6f398460527acf891dd1a7c07e2d56.memory.svg)
...
| 37 | VmAirWrapper<Rv64BaseAluWU16AdapterAir, ShiftLogicalCoreAir<2, 16> |  | 22 | 76 | 3 | 
| 38 | VmAirWrapper<Rv64BaseAluRegU16AdapterAir, ShiftRightArithmeticCoreAir<4, 16> |  | 25 | 46 | 3 | 
| 39 | VmAirWrapper<Rv64BaseAluRegU16AdapterAir, ShiftLogicalCoreAir<4, 16> |  | 24 | 100 | 3 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 58 |  |  |  | 288 |  |  |  |  |  |  | 
| app_proof |  |  |  | 1,589 |  | 57 | 11,167,961 | 195.88 | 0 | 4,197 |  | 
...
| app_proof | 37 | VmAirWrapper<Rv64BaseAluWU16AdapterAir, ShiftLogicalCoreAir<2, 16> | prover | 0 | 1 | 57 | 57 | 
...
| app_proof | 37 | VmAirWrapper<Rv64BaseAluWU16AdapterAir, ShiftLogicalCoreAir<2, 16> | prover | 1 | 4 | 57 | 228 | 
| app_proof | 39 | VmAirWrapper<Rv64BaseAluRegU16AdapterAir, ShiftLogicalCoreAir<4, 16> | prover | 1 | 16 | 62 | 992 | 
...
| app_proof | 37 | VmAirWrapper<Rv64BaseAluWU16AdapterAir, ShiftLogicalCoreAir<2, 16> | 0 | 1 |  | 143 |  | 228 |  | 57 |  | 798 |  | 22 |  | 
...
| app_proof | 37 | VmAirWrapper<Rv64BaseAluWU16AdapterAir, ShiftLogicalCoreAir<2, 16> | 1 | 3 | 1 | 428 | 142 | 684 | 228 | 171 | 57 | 2,393 | 797 | 66 | 22 | 
| app_proof | 39 | VmAirWrapper<Rv64BaseAluRegU16AdapterAir, ShiftLogicalCoreAir<4, 16> | 1 | 14 | 2 | 2,170 | 310 | 3,472 | 496 | 868 | 124 | 12,180 | 1,740 | 336 | 48 | 
...
| leaf | 0 | 118 | 523 | 117 | 34 | 12 | 2 | 9 | 9 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,336,706,460 | 2,234 | 593 | 0 | 0 | 1,280 | 697 | 696 | 236 | 346 | 1 | 360 | 262 | 98 | 60 | 37 | 593 | 593 | 1,280 | 0 | 1 | 345 | 0 | 0 | 
| app_proof | prover | 1 | 680,630,408 | 1,059 | 213 | 0 | 0 | 655 | 346 | 346 | 124 | 183 | 0 | 191 | 138 | 52 | 31 | 21 | 213 | 213 | 655 | 0 | 1 | 182 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 0 | 2 | 100 | 2,543 | 100 | 0 | 12,493,343,760 | 3,553,584,960 | 16,046,928,720 | 2,097,152 | 0 | 4 | 208 | 7,147,000 | 35.46 | 
| app_proof | 1 | 0 | 1 | 43 | 1,589 | 43 | 0 | 7,060,295,124 | 1,113,720,972 | 8,174,016,096 | 2,097,152 | 0 | 2 | 485 | 4,020,961 | 35.12 | 

...
| `total_proof_time_ms ` |  2,105 |  4,210 |  2,563 |  1,647 |
| `compile_metered_time_ms` |  6 |  6 |  6 |  6 |
| `execute_metered_time_ms` |  57 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  195.43 | -          |  195.43 |  195.43 |
| `execute_preflight_insns` |  5,583,980.50 |  11,167,961 |  7,136,000 |  4,031,961 |
| `execute_preflight_time_ms` |  356.50 |  713 |  496 |  217 |
| `execute_preflight_insn_mi/s` |  36.86 | -          |  38.94 |  34.78 |
| `trace_gen_time_ms   ` |  76 |  152 |  106 |  46 |
| `set_initial_memory_time_ms` |  0 |  0 |  0 |  0 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,672 |  3,344 |  2,239 |  1,105 |
| `prover.main_trace_commit_time_ms` |  405 |  810 |  587 |  223 |
| `prover.rap_constraints_time_ms` |  988 |  1,976 |  1,297 |  679 |
| `prover.openings_time_ms` |  277 |  554 |  353 |  201 |
| `prover.rap_constraints.logup_gkr_time_ms` |  275 |  550 |  356 |  194 |
| `prover.rap_constraints.round0_time_ms` |  529 |  1,058 |  703 |  355 |
| `prover.rap_constraints.mle_rounds_time_ms` |  183 |  366 |  237 |  129 |
| `prover.openings.stacked_reduction_time_ms` |  74.50 |  149 |  96 |  53 |
| `prover.openings.stacked_reduction.round0_time_ms` |  45 |  90 |  59 |  31 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  29 |  58 |  37 |  21 |
| `prover.openings.whir_time_ms` |  202 |  404 |  257 |  147 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/c9acdfc8756fb9ed314fb6495f44f4df233270d5/sha2_bench-c9acdfc8756fb9ed314fb6495f44f4df233270d5.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 60 |  |  |  | 301 |  |  |  |  |  |  | 
| app_proof |  |  |  | 1,647 |  | 57 | 11,167,961 | 195.43 | 0 | 4,277 |  | 
...
| app_proof | Sha2MainAir<Sha256Config> | 0 |  | 8 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 175 | 46 | 0 | 0 | 80 | 29 | 28 | 37 | 13 | 0 | 48 | 37 | 10 | 2 | 7 | 47 | 46 | 80 | 0 | 1 | 12 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 108 | 20 | 0 | 0 | 55 | 21 | 20 | 23 | 11 | 0 | 32 | 24 | 7 | 1 | 6 | 20 | 20 | 55 | 0 | 1 | 10 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 101 | 15 | 0 | 0 | 54 | 21 | 20 | 21 | 11 | 0 | 31 | 23 | 7 | 1 | 5 | 15 | 15 | 54 | 0 | 1 | 10 | 0 | 0 | 
| leaf | 0 | prover | 237,929,272 | 406 | 145 | 0 | 0 | 142 | 71 | 69 | 44 | 26 | 0 | 117 | 95 | 21 | 10 | 11 | 146 | 145 | 142 | 0 | 3 | 25 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,315,866,009 | 2,239 | 587 | 0 | 0 | 1,297 | 703 | 702 | 237 | 356 | 1 | 353 | 257 | 96 | 59 | 37 | 587 | 587 | 1,297 | 0 | 1 | 353 | 0 | 0 | 
| app_proof | prover | 1 | 709,531,484 | 1,105 | 223 | 0 | 0 | 679 | 355 | 355 | 129 | 194 | 0 | 201 | 147 | 53 | 31 | 21 | 223 | 223 | 679 | 0 | 1 | 193 | 0 | 0 | 

| group | phase | segment | trace_height_constraint | weighted_sum | threshold |
| --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 0 | 273,310,172 | 2,013,265,921 | 
| app_proof | prover | 1 | 0 | 167,275,290 | 2,013,265,921 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 0 | 2 | 106 | 2,563 | 106 | 0 | 12,823,257,804 | 2,969,899,104 | 15,793,156,908 | 2,097,152 | 0 | 4 | 217 | 7,136,000 | 34.78 | 
| app_proof | 1 | 0 | 1 | 46 | 1,647 | 45 | 0 | 7,277,631,780 | 1,628,535,931 | 8,906,167,711 | 2,097,152 | 0 | 2 | 496 | 4,031,961 | 38.94 | 

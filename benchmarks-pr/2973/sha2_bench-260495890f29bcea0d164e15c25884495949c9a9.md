...
| `total_proof_time_ms ` |  2,067.50 |  4,135 |  2,550 |  1,585 |
| `compile_metered_time_ms` |  6 |  6 |  6 |  6 |
| `execute_metered_time_ms` |  56 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  196.97 | -          |  196.97 |  196.97 |
| `execute_preflight_insns` |  5,583,980.50 |  11,167,961 |  7,147,000 |  4,020,961 |
| `execute_preflight_time_ms` |  343 |  686 |  478 |  208 |
| `execute_preflight_insn_mi/s` |  35.66 | -          |  35.95 |  35.37 |
| `trace_gen_time_ms   ` |  70 |  140 |  98 |  42 |
| `set_initial_memory_time_ms` |  0 |  0 |  0 |  0 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,652.50 |  3,305 |  2,242 |  1,063 |
| `prover.main_trace_commit_time_ms` |  405 |  810 |  595 |  215 |
| `prover.rap_constraints_time_ms` |  972.50 |  1,945 |  1,287 |  658 |
| `prover.openings_time_ms` |  274 |  548 |  359 |  189 |
| `prover.rap_constraints.logup_gkr_time_ms` |  267 |  534 |  350 |  184 |
| `prover.rap_constraints.round0_time_ms` |  522.50 |  1,045 |  698 |  347 |
| `prover.rap_constraints.mle_rounds_time_ms` |  181.50 |  363 |  237 |  126 |
| `prover.openings.stacked_reduction_time_ms` |  75.50 |  151 |  99 |  52 |
| `prover.openings.stacked_reduction.round0_time_ms` |  45.50 |  91 |  61 |  30 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  29.50 |  59 |  38 |  21 |
| `prover.openings.whir_time_ms` |  198 |  396 |  259 |  137 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/260495890f29bcea0d164e15c25884495949c9a9/sha2_bench-260495890f29bcea0d164e15c25884495949c9a9.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 58 |  |  |  | 291 |  |  |  |  |  |  | 
| app_proof |  |  |  | 1,585 |  | 56 | 11,167,961 | 196.97 | 0 | 4,200 |  | 
...
| leaf | 0 | 116 | 522 | 115 | 34 | 13 | 2 | 8 | 8 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 173 | 46 | 0 | 0 | 79 | 29 | 28 | 36 | 13 | 0 | 46 | 35 | 10 | 2 | 7 | 47 | 46 | 79 | 0 | 1 | 12 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 107 | 20 | 0 | 0 | 55 | 20 | 20 | 23 | 11 | 0 | 31 | 23 | 7 | 1 | 6 | 21 | 20 | 55 | 0 | 1 | 10 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,336,706,462 | 2,242 | 595 | 0 | 0 | 1,287 | 698 | 698 | 237 | 350 | 1 | 359 | 259 | 99 | 61 | 38 | 595 | 595 | 1,287 | 0 | 1 | 349 | 0 | 0 | 
| app_proof | prover | 1 | 680,630,448 | 1,063 | 215 | 0 | 0 | 658 | 347 | 346 | 126 | 184 | 0 | 189 | 137 | 52 | 30 | 21 | 215 | 215 | 658 | 0 | 1 | 183 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 0 | 2 | 98 | 2,550 | 98 | 0 | 12,493,343,784 | 3,553,584,960 | 16,046,928,744 | 2,097,152 | 0 | 3 | 208 | 7,147,000 | 35.37 | 
| app_proof | 1 | 0 | 1 | 42 | 1,585 | 42 | 0 | 7,060,295,532 | 1,113,721,044 | 8,174,016,576 | 2,097,152 | 0 | 2 | 478 | 4,020,961 | 35.95 | 

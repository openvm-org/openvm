...
| `total_proof_time_ms ` |  1,974 |  3,948 |  2,356 |  1,592 |
...
| `execute_preflight_time_ms` |  341 |  682 |  480 |  202 |
| `execute_preflight_insn_mi/s` |  36.58 | -          |  36.80 |  36.37 |
| `trace_gen_time_ms   ` |  73.50 |  147 |  103 |  44 |
| `set_initial_memory_time_ms` |  0 |  0 |  0 |  0 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,557.50 |  3,115 |  2,049 |  1,066 |
| `prover.main_trace_commit_time_ms` |  392.50 |  785 |  570 |  215 |
| `prover.rap_constraints_time_ms` |  896 |  1,792 |  1,134 |  658 |
| `prover.openings_time_ms` |  267.50 |  535 |  343 |  192 |
| `prover.rap_constraints.logup_gkr_time_ms` |  207 |  414 |  231 |  183 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/49bedd12f77df4d6cc9d75329508428a8e0dab84/sha2_bench-49bedd12f77df4d6cc9d75329508428a8e0dab84.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 56 |  |  |  | 289 |  |  |  |  |  |  | 
| app_proof |  |  |  | 1,592 |  | 56 | 11,167,961 | 197.20 | 0 | 4,012 |  | 
...
| leaf | 0 | 115 | 520 | 115 | 33 | 12 | 2 | 9 | 9 | 
...
| leaf | 0 | prover | 237,929,144 | 405 | 145 | 0 | 0 | 142 | 70 | 69 | 44 | 26 | 0 | 116 | 94 | 22 | 10 | 11 | 146 | 145 | 142 | 0 | 3 | 25 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,280,083,194 | 2,049 | 570 | 0 | 0 | 1,134 | 671 | 670 | 232 | 231 | 1 | 343 | 249 | 94 | 57 | 36 | 570 | 570 | 1,134 | 0 | 1 | 229 | 0 | 0 | 
| app_proof | prover | 1 | 687,443,728 | 1,066 | 215 | 0 | 0 | 658 | 348 | 348 | 126 | 183 | 0 | 192 | 140 | 51 | 30 | 21 | 215 | 215 | 658 | 0 | 1 | 182 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 0 | 2 | 103 | 2,356 | 103 | 0 | 12,567,225,180 | 2,800,224,348 | 15,367,449,528 | 2,097,152 | 0 | 4 | 202 | 7,136,000 | 36.37 | 
| app_proof | 1 | 0 | 1 | 44 | 1,592 | 44 | 0 | 7,131,913,452 | 1,123,862,484 | 8,255,775,936 | 2,097,152 | 0 | 2 | 480 | 4,031,961 | 36.80 | 

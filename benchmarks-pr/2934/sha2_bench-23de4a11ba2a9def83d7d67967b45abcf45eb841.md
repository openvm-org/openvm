...
|:---|---:|---:|---:|
| Total |  10.14 |  7.04 |  7.04 |
| app_proof |  8.43 |  5.33 |  5.33 |
| leaf |  1.03 |  1.03 |  1.03 |
...
| `total_proof_time_ms ` |  4,167.50 |  8,335 |  5,242 |  3,093 |
| `compile_metered_time_ms` |  4 |  4 |  4 |  4 |
| `execute_metered_time_ms` |  91 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  121.51 | -          |  121.51 |  121.51 |
| `execute_preflight_insns` |  5,583,980.50 |  11,167,961 |  7,124,000 |  4,043,961 |
| `execute_preflight_time_ms` |  255 |  510 |  301 |  209 |
| `execute_preflight_insn_mi/s` |  37.44 | -          |  40.06 |  34.83 |
| `trace_gen_time_ms   ` |  124 |  248 |  175 |  73 |
| `set_initial_memory_time_ms` |  88 |  176 |  135 |  41 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  3,699.50 |  7,399 |  4,722 |  2,677 |
| `prover.main_trace_commit_time_ms` |  974 |  1,948 |  1,349 |  599 |
| `prover.rap_constraints_time_ms` |  2,005 |  4,010 |  2,470 |  1,540 |
| `prover.openings_time_ms` |  719.50 |  1,439 |  901 |  538 |
| `prover.rap_constraints.logup_gkr_time_ms` |  563 |  1,126 |  604 |  522 |
| `prover.rap_constraints.round0_time_ms` |  1,054.50 |  2,109 |  1,368 |  741 |
| `prover.rap_constraints.mle_rounds_time_ms` |  386 |  772 |  496 |  276 |
| `prover.openings.stacked_reduction_time_ms` |  169 |  338 |  217 |  121 |
| `prover.openings.stacked_reduction.round0_time_ms` |  104.50 |  209 |  136 |  73 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  64 |  128 |  81 |  47 |
| `prover.openings.whir_time_ms` |  549.50 |  1,099 |  683 |  416 |
...
| `prover.openings_time_ms` |  302 |  302 |  302 |  302 |
...
| `prover.openings.whir_time_ms` |  264 |  264 |  264 |  264 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/23de4a11ba2a9def83d7d67967b45abcf45eb841/sha2_bench-23de4a11ba2a9def83d7d67967b45abcf45eb841.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 71 |  |  |  | 348 |  |  |  |  |  |  | 
| app_proof |  |  |  | 3,093 |  | 91 | 11,167,961 | 121.51 | 0 | 8,434 |  | 
...
| app_proof | VmAirWrapper<Rv64BaseAluAdapterAir, BitwiseLogicCoreAir<8, 8> | 0 | 3 | 7 | 
...
| app_proof | VmAirWrapper<Rv64LoadStoreAdapterAir, LoadStoreCoreAir<8> | 0 | 12 | 27 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 22 | 352 | 21 | 6 | 1 | 2 | 2 | 2 | 
| internal_recursive.0 | 1 | 12 | 181 | 11 | 1 | 0 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 10 | 151 | 10 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 112 | 1,027 | 112 | 35 | 17 | 2 | 8 | 8 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 330 | 119 | 0 | 0 | 109 | 35 | 34 | 53 | 21 | 0 | 101 | 87 | 13 | 3 | 9 | 119 | 119 | 109 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 169 | 46 | 0 | 0 | 66 | 24 | 23 | 28 | 13 | 0 | 55 | 47 | 8 | 1 | 6 | 47 | 46 | 66 | 0 | 3 | 12 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 140 | 32 | 0 | 0 | 64 | 24 | 23 | 25 | 14 | 0 | 43 | 35 | 7 | 1 | 5 | 33 | 32 | 64 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 237,929,016 | 915 | 379 | 0 | 0 | 232 | 111 | 110 | 68 | 52 | 0 | 302 | 264 | 38 | 20 | 17 | 379 | 379 | 232 | 0 | 11 | 50 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,286,242,554 | 4,722 | 1,349 | 0 | 0 | 2,470 | 1,368 | 1,368 | 496 | 604 | 1 | 901 | 683 | 217 | 136 | 81 | 1,349 | 1,349 | 2,470 | 0 | 5 | 602 | 0 | 0 | 
| app_proof | prover | 1 | 750,289,144 | 2,677 | 598 | 0 | 0 | 1,540 | 741 | 740 | 276 | 522 | 0 | 538 | 416 | 121 | 73 | 47 | 599 | 598 | 1,540 | 0 | 8 | 521 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 135 | 1 | 175 | 5,242 | 175 | 135 | 13,306,647,852 | 2,134,713,996 | 15,441,361,848 | 2,097,152 | 0 | 4 | 209 | 7,124,000 | 34.83 | 
| app_proof | 1 | 41 | 1 | 73 | 3,093 | 73 | 41 | 7,584,540,132 | 1,503,573,469 | 9,088,113,601 | 2,097,152 | 0 | 2 | 301 | 4,043,961 | 40.06 | 

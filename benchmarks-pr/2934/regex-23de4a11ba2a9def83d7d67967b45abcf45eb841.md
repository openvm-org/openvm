...
| `execute_metered_insn_mi/s` |  135.35 | -          |  135.35 |  135.35 |
| `execute_preflight_insns` |  4,090,656 |  4,090,656 |  4,090,656 |  4,090,656 |
| `execute_preflight_time_ms` |  122 |  122 |  122 |  122 |
| `execute_preflight_insn_mi/s` |  35.09 | -          |  35.09 |  35.09 |
| `trace_gen_time_ms   ` |  34 |  34 |  34 |  34 |
| `set_initial_memory_time_ms` |  135 |  135 |  135 |  135 |
| `memory_finalize_time_ms` |  1 |  1 |  1 |  1 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  862 |  862 |  862 |  862 |
| `prover.main_trace_commit_time_ms` |  192 |  192 |  192 |  192 |
| `prover.rap_constraints_time_ms` |  490 |  490 |  490 |  490 |
| `prover.openings_time_ms` |  178 |  178 |  178 |  178 |
| `prover.rap_constraints.logup_gkr_time_ms` |  293 |  293 |  293 |  293 |
| `prover.rap_constraints.round0_time_ms` |  146 |  146 |  146 |  146 |
...
| `prover.openings.whir_time_ms` |  142 |  142 |  142 |  142 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/23de4a11ba2a9def83d7d67967b45abcf45eb841/regex-23de4a11ba2a9def83d7d67967b45abcf45eb841.memory.svg)
...
| prover.stacked_commit | 2.81 | app_proof.prover.0 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 70 |  |  |  | 342 |  |  |  |  |  |  | 
| app_proof |  |  |  | 1,155 |  | 30 | 4,090,656 | 135.35 | 0 | 1,199 |  | 
...
| app_proof | VmAirWrapper<Rv64LoadStoreAdapterAir, LoadStoreCoreAir<8> | 0 | 7 | 8 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 27,277,885 | 255 | 81 | 0 | 0 | 97 | 30 | 30 | 45 | 20 | 0 | 76 | 65 | 11 | 2 | 8 | 81 | 81 | 97 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 166 | 45 | 0 | 0 | 65 | 23 | 23 | 28 | 13 | 0 | 54 | 46 | 8 | 1 | 6 | 45 | 45 | 65 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 136 | 32 | 0 | 0 | 61 | 23 | 22 | 24 | 13 | 0 | 42 | 35 | 7 | 1 | 5 | 32 | 32 | 61 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 65,360,477 | 309 | 102 | 0 | 0 | 107 | 45 | 44 | 31 | 29 | 0 | 98 | 85 | 13 | 5 | 7 | 103 | 102 | 107 | 0 | 6 | 29 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 238,925,643 | 862 | 191 | 0 | 0 | 490 | 146 | 146 | 50 | 293 | 20 | 178 | 142 | 36 | 18 | 17 | 192 | 191 | 490 | 0 | 3 | 272 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 135 | 2 | 34 | 1,154 | 34 | 135 | 4,179,589,434 | 897,887,370 | 5,077,476,804 | 2,097,152 | 1 | 5 | 122 | 4,090,656 | 35.09 | 

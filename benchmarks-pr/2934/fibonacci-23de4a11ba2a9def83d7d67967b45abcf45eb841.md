...
|:---|---:|---:|---:|
| Total |  2.10 |  1.63 |  1.63 |
| app_proof |  1.07 |  0.61 |  0.61 |
| leaf |  0.40 |  0.40 |  0.40 |
...
| `total_proof_time_ms ` |  527.50 |  1,055 |  589 |  466 |
...
| `execute_preflight_time_ms` |  54 |  108 |  65 |  43 |
| `execute_preflight_insn_mi/s` |  45.52 | -          |  49.26 |  41.78 |
| `trace_gen_time_ms   ` |  25 |  50 |  28 |  22 |
| `set_initial_memory_time_ms` |  91.50 |  183 |  142 |  41 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  355.50 |  711 |  358 |  353 |
| `prover.main_trace_commit_time_ms` |  75.50 |  151 |  76 |  75 |
| `prover.rap_constraints_time_ms` |  195 |  390 |  198 |  192 |
| `prover.openings_time_ms` |  84 |  168 |  85 |  83 |
| `prover.rap_constraints.logup_gkr_time_ms` |  132.50 |  265 |  133 |  132 |
| `prover.rap_constraints.round0_time_ms` |  40.50 |  81 |  43 |  38 |
| `prover.rap_constraints.mle_rounds_time_ms` |  21 |  42 |  21 |  21 |
...
| `prover.openings.whir_time_ms` |  68 |  136 |  69 |  67 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  402 |  402 |  402 |  402 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/23de4a11ba2a9def83d7d67967b45abcf45eb841/fibonacci-23de4a11ba2a9def83d7d67967b45abcf45eb841.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 72 |  |  |  | 371 |  |  |  |  |  |  | 
| app_proof |  |  |  | 466 |  | 20 | 4,000,051 | 191.08 | 0 | 1,083 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 17 | 283 | 16 | 5 | 0 | 2 | 1 | 1 | 
| internal_recursive.0 | 1 | 12 | 181 | 12 | 1 | 0 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 11 | 155 | 11 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 42 | 402 | 42 | 13 | 2 | 1 | 1 | 1 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 27,277,885 | 266 | 84 | 0 | 0 | 101 | 33 | 32 | 46 | 21 | 0 | 80 | 68 | 11 | 3 | 8 | 84 | 84 | 101 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 169 | 46 | 0 | 0 | 69 | 25 | 25 | 29 | 14 | 0 | 53 | 44 | 8 | 1 | 6 | 46 | 46 | 69 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 144 | 33 | 0 | 0 | 63 | 24 | 23 | 25 | 13 | 0 | 46 | 39 | 7 | 1 | 5 | 33 | 33 | 63 | 0 | 3 | 13 | 0 | 0 | 
| leaf | 0 | prover | 74,737,560 | 360 | 127 | 0 | 0 | 120 | 54 | 53 | 35 | 30 | 0 | 111 | 96 | 15 | 6 | 8 | 127 | 127 | 120 | 0 | 7 | 28 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 90,436,180 | 358 | 76 | 0 | 0 | 198 | 43 | 43 | 21 | 133 | 0 | 83 | 67 | 16 | 8 | 7 | 76 | 76 | 198 | 0 | 3 | 131 | 0 | 0 | 
| app_proof | prover | 1 | 90,435,040 | 353 | 75 | 0 | 0 | 192 | 38 | 38 | 21 | 132 | 0 | 85 | 69 | 15 | 8 | 6 | 75 | 75 | 192 | 0 | 3 | 132 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 142 | 2 | 22 | 589 | 22 | 142 | 2,145,305,497 | 522,291 | 2,145,827,788 | 2,097,152 | 0 | 4 | 65 | 2,621,000 | 41.78 | 
| app_proof | 1 | 41 | 1 | 28 | 466 | 28 | 41 | 1,164,981,971 | 980,826,252 | 2,145,808,223 | 2,097,152 | 0 | 2 | 43 | 1,379,051 | 49.26 | 

...
|:---|---:|---:|---:|
| Total |  5.40 |  3.79 |  3.79 |
| app_proof |  3.88 |  2.27 |  2.27 |
| leaf |  0.95 |  0.95 |  0.95 |
...
| `total_proof_time_ms ` |  1,924 |  3,848 |  2,237 |  1,611 |
| `execute_metered_time_ms` |  35 | -          | -          | -          |
| `execute_metered_insns` |  2,579,903 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  72.38 | -          |  72.38 |  72.38 |
| `execute_preflight_insns` |  1,289,951.50 |  2,579,903 |  1,540,000 |  1,039,903 |
| `execute_preflight_time_ms` |  102 |  204 |  141 |  63 |
| `execute_preflight_insn_mi/s` |  35.28 | -          |  35.81 |  34.74 |
| `trace_gen_time_ms   ` |  136.50 |  273 |  185 |  88 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,575 |  3,150 |  1,810 |  1,340 |
| `prover.main_trace_commit_time_ms` |  510.50 |  1,021 |  595 |  426 |
| `prover.rap_constraints_time_ms` |  935 |  1,870 |  1,080 |  790 |
| `prover.openings_time_ms` |  128 |  256 |  134 |  122 |
| `prover.rap_constraints.logup_gkr_time_ms` |  167 |  334 |  197 |  137 |
| `prover.rap_constraints.round0_time_ms` |  567 |  1,134 |  670 |  464 |
| `prover.rap_constraints.mle_rounds_time_ms` |  200 |  400 |  211 |  189 |
| `prover.openings.stacked_reduction_time_ms` |  94 |  188 |  103 |  85 |
| `prover.openings.stacked_reduction.round0_time_ms` |  49.50 |  99 |  51 |  48 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  44 |  88 |  52 |  36 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/ecda825de8a2f44e1774381c910af2c1723099bc/kitchen_sink-ecda825de8a2f44e1774381c910af2c1723099bc.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 74 | 9 |  |  | 0 |  | 377 | 9 |  |  |  |  |  |  | 
| app_proof |  |  |  |  |  | 1,611 |  |  | 35 | 2,579,903 | 72.38 | 0 | 3,889 |  | 
...
| leaf | 0 | 123 | 952 | 123 | 23 | 9 | 21 | 5 | 5 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,577,979 | 257 | 117 | 0 | 0 | 108 | 35 | 34 | 52 | 20 | 0 | 31 | 17 | 13 | 3 | 9 | 117 | 108 | 0 | 2 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,767 | 144 | 45 | 0 | 0 | 68 | 24 | 24 | 28 | 15 | 0 | 29 | 21 | 8 | 1 | 6 | 45 | 68 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 119 | 31 | 0 | 0 | 65 | 25 | 24 | 24 | 15 | 0 | 23 | 15 | 7 | 1 | 5 | 31 | 65 | 0 | 2 | 13 | 0 | 0 | 
| leaf | 0 | prover | 265,003,892 | 828 | 399 | 0 | 1 | 350 | 135 | 134 | 78 | 136 | 0 | 78 | 38 | 40 | 21 | 18 | 400 | 350 | 0 | 6 | 135 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 567,917,156 | 1,810 | 594 | 0 | 185 | 1,080 | 670 | 669 | 211 | 197 | 56 | 134 | 30 | 103 | 51 | 52 | 595 | 1,080 | 0 | 3 | 139 | 0 | 0 | 
| app_proof | prover | 1 | 537,266,124 | 1,340 | 426 | 0 | 1 | 790 | 464 | 463 | 189 | 137 | 0 | 122 | 37 | 85 | 48 | 36 | 426 | 790 | 0 | 3 | 136 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 185 | 2,237 | 185 | 178 | 0 | 5 | 63 | 1,540,000 | 34.74 | 
| app_proof | 1 | 88 | 1,611 | 88 | 41 | 1 | 2 | 141 | 1,039,903 | 35.81 | 

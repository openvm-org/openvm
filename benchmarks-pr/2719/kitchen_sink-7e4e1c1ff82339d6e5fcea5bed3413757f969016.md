...
|:---|---:|---:|---:|
| Total |  5.38 |  4.45 |  4.45 |
| app_proof |  3.85 |  2.92 |  2.92 |
| leaf |  0.96 |  0.96 |  0.96 |
...
| `total_proof_time_ms ` |  1,914.50 |  3,829 |  2,901 |  928 |
| `execute_metered_time_ms` |  24 | -          | -          | -          |
| `execute_metered_insns` |  1,979,971 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  79.29 | -          |  79.29 |  79.29 |
| `execute_preflight_insns` |  989,985.50 |  1,979,971 |  1,445,000 |  534,971 |
| `execute_preflight_time_ms` |  76.50 |  153 |  87 |  66 |
| `execute_preflight_insn_mi/s` |  30.28 | -          |  31.07 |  29.48 |
| `trace_gen_time_ms   ` |  66.50 |  133 |  98 |  35 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,681.50 |  3,363 |  2,600 |  763 |
| `prover.main_trace_commit_time_ms` |  598 |  1,196 |  967 |  229 |
| `prover.rap_constraints_time_ms` |  943 |  1,886 |  1,427 |  459 |
| `prover.openings_time_ms` |  139.50 |  279 |  205 |  74 |
| `prover.rap_constraints.logup_gkr_time_ms` |  151 |  302 |  215 |  87 |
| `prover.rap_constraints.round0_time_ms` |  567.50 |  1,135 |  872 |  263 |
| `prover.rap_constraints.mle_rounds_time_ms` |  224 |  448 |  340 |  108 |
| `prover.openings.stacked_reduction_time_ms` |  102.50 |  205 |  159 |  46 |
| `prover.openings.stacked_reduction.round0_time_ms` |  57 |  114 |  88 |  26 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  45 |  90 |  70 |  20 |
| `prover.openings.whir_time_ms` |  36 |  72 |  45 |  27 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  957 |  957 |  957 |  957 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/7e4e1c1ff82339d6e5fcea5bed3413757f969016/kitchen_sink-7e4e1c1ff82339d6e5fcea5bed3413757f969016.memory.svg)
...
| app_proof |  |  |  |  |  | 928 |  |  | 24 | 1,979,971 | 79.29 | 0 | 3,859 |  | 
...
| leaf | 0 | 116 | 957 | 116 | 24 | 10 | 18 | 2 | 2 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,577,979 | 262 | 120 | 0 | 0 | 109 | 35 | 34 | 53 | 20 | 0 | 33 | 19 | 13 | 3 | 10 | 120 | 109 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,767 | 142 | 45 | 0 | 0 | 70 | 26 | 25 | 28 | 14 | 0 | 26 | 17 | 8 | 1 | 6 | 46 | 70 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 123 | 31 | 0 | 0 | 66 | 25 | 24 | 25 | 15 | 0 | 24 | 16 | 7 | 1 | 5 | 32 | 66 | 0 | 2 | 13 | 0 | 0 | 
| leaf | 0 | prover | 260,613,236 | 841 | 406 | 0 | 1 | 353 | 137 | 137 | 76 | 138 | 0 | 80 | 40 | 40 | 21 | 18 | 407 | 353 | 0 | 6 | 137 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 902,782,844 | 2,600 | 966 | 0 | 306 | 1,427 | 872 | 871 | 340 | 215 | 64 | 205 | 45 | 159 | 88 | 70 | 967 | 1,427 | 0 | 3 | 148 | 0 | 0 | 
| app_proof | prover | 1 | 279,963,980 | 763 | 229 | 0 | 1 | 459 | 263 | 263 | 108 | 87 | 0 | 74 | 27 | 46 | 26 | 20 | 229 | 459 | 0 | 3 | 85 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 98 | 2,901 | 98 | 135 | 0 | 3 | 66 | 1,445,000 | 29.48 | 
| app_proof | 1 | 35 | 928 | 35 | 41 | 0 | 2 | 87 | 534,971 | 31.07 | 

...
|:---|---:|---:|---:|
| Total |  11.64 |  4.79 |  4.79 |
| app_proof |  9.55 |  2.71 |  2.71 |
| leaf |  1.41 |  1.41 |  1.41 |
...
| `total_proof_time_ms ` |  2,365 |  9,460 |  2,619 |  2,249 |
| `execute_metered_time_ms` |  93 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  119.50 | -          |  119.50 |  119.50 |
| `execute_preflight_insns` |  2,791,990.25 |  11,167,961 |  2,851,000 |  2,614,961 |
| `execute_preflight_time_ms` |  161.25 |  645 |  204 |  95 |
| `execute_preflight_insn_mi/s` |  38.85 | -          |  39.94 |  35.74 |
| `trace_gen_time_ms   ` |  103.75 |  415 |  172 |  61 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  2,027.75 |  8,111 |  2,189 |  1,943 |
| `prover.main_trace_commit_time_ms` |  560.25 |  2,241 |  673 |  522 |
| `prover.rap_constraints_time_ms` |  1,324.25 |  5,297 |  1,372 |  1,278 |
| `prover.openings_time_ms` |  142.50 |  570 |  144 |  141 |
| `prover.rap_constraints.logup_gkr_time_ms` |  347 |  1,388 |  395 |  296 |
| `prover.rap_constraints.round0_time_ms` |  657.75 |  2,631 |  662 |  653 |
| `prover.rap_constraints.mle_rounds_time_ms` |  318.25 |  1,273 |  320 |  314 |
| `prover.openings.stacked_reduction_time_ms` |  102 |  408 |  103 |  100 |
...
| `prover.openings.whir_time_ms` |  39.75 |  159 |  42 |  37 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/723e24c1565612abc6c5dd7ad7dcb38a58a05f78/sha2_bench-723e24c1565612abc6c5dd7ad7dcb38a58a05f78.memory.svg)
...
| app_proof |  |  |  |  |  | 2,249 |  |  | 93 | 11,167,961 | 119.50 | 0 | 9,561 |  | 
...
| app_proof | VmAirWrapper<Rv64LoadStoreAdapterAir, LoadStoreCoreAir<8> | 2 | 11 | 
...
| leaf | 0 | 152 | 1,405 | 151 | 54 | 26 | 3 | 6 | 6 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 61,220,603 | 358 | 183 | 0 | 0 | 131 | 38 | 38 | 65 | 27 | 0 | 42 | 23 | 18 | 5 | 12 | 184 | 131 | 0 | 3 | 26 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,879 | 152 | 48 | 0 | 0 | 71 | 24 | 23 | 29 | 17 | 0 | 31 | 22 | 8 | 1 | 6 | 49 | 71 | 0 | 2 | 16 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 121 | 31 | 0 | 0 | 61 | 23 | 22 | 25 | 12 | 0 | 27 | 20 | 7 | 1 | 5 | 31 | 61 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 424,379,238 | 1,253 | 796 | 0 | 153 | 348 | 170 | 169 | 102 | 75 | 0 | 107 | 42 | 64 | 36 | 27 | 797 | 348 | 0 | 7 | 74 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 662,392,121 | 2,189 | 672 | 0 | 154 | 1,372 | 656 | 655 | 320 | 395 | 107 | 144 | 40 | 103 | 63 | 40 | 673 | 1,372 | 0 | 3 | 287 | 0 | 0 | 
| app_proof | prover | 1 | 662,391,820 | 2,032 | 522 | 0 | 2 | 1,367 | 653 | 653 | 320 | 392 | 116 | 142 | 40 | 102 | 62 | 39 | 522 | 1,367 | 0 | 3 | 276 | 0 | 0 | 
| app_proof | prover | 2 | 662,391,820 | 1,943 | 523 | 0 | 2 | 1,278 | 662 | 661 | 319 | 296 | 0 | 141 | 37 | 103 | 63 | 39 | 523 | 1,278 | 0 | 3 | 295 | 0 | 0 | 
| app_proof | prover | 3 | 662,468,884 | 1,947 | 523 | 0 | 2 | 1,280 | 660 | 660 | 314 | 305 | 0 | 143 | 42 | 100 | 61 | 39 | 523 | 1,280 | 0 | 3 | 304 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 172 | 2,619 | 172 | 162 | 0 | 3 | 95 | 2,851,000 | 35.74 | 
| app_proof | 1 | 61 | 2,338 | 61 | 41 | 0 | 2 | 204 | 2,851,000 | 39.94 | 
| app_proof | 2 | 90 | 2,254 | 90 | 41 | 0 | 2 | 179 | 2,851,000 | 39.89 | 
| app_proof | 3 | 92 | 2,249 | 92 | 41 | 0 | 2 | 167 | 2,614,961 | 39.82 | 

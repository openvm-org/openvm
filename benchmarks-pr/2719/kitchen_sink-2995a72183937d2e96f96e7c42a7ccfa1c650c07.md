...
|:---|---:|---:|---:|
| Total |  5.31 |  4.40 |  4.40 |
| app_proof |  3.80 |  2.89 |  2.89 |
| leaf |  0.94 |  0.94 |  0.94 |
...
| `total_proof_time_ms ` |  1,888.50 |  3,777 |  2,866 |  911 |
| `compile_metered_time_ms` |  2 |  2 |  2 |  2 |
| `execute_metered_time_ms` |  24 | -          | -          | -          |
| `execute_metered_insns` |  1,979,971 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  81.13 | -          |  81.13 |  81.13 |
| `execute_preflight_insns` |  989,985.50 |  1,979,971 |  1,445,000 |  534,971 |
| `execute_preflight_time_ms` |  75 |  150 |  81 |  69 |
| `execute_preflight_insn_mi/s` |  30.72 | -          |  31.08 |  30.37 |
| `trace_gen_time_ms   ` |  66.50 |  133 |  94 |  39 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,657.50 |  3,315 |  2,566 |  749 |
| `prover.main_trace_commit_time_ms` |  593 |  1,186 |  960 |  226 |
| `prover.rap_constraints_time_ms` |  928.50 |  1,857 |  1,408 |  449 |
| `prover.openings_time_ms` |  135 |  270 |  197 |  73 |
| `prover.rap_constraints.logup_gkr_time_ms` |  155 |  310 |  222 |  88 |
| `prover.rap_constraints.round0_time_ms` |  555.50 |  1,111 |  856 |  255 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/2995a72183937d2e96f96e7c42a7ccfa1c650c07/kitchen_sink-2995a72183937d2e96f96e7c42a7ccfa1c650c07.memory.svg)
...
| app_proof |  |  |  |  |  | 911 |  |  | 24 | 1,979,971 | 81.13 | 0 | 3,806 |  | 
...
| internal_recursive.0 | 1 | 11 | 159 | 10 | 1 | 0 | 2 | 1 | 1 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,577,979 | 260 | 117 | 0 | 0 | 107 | 35 | 34 | 52 | 20 | 0 | 34 | 20 | 13 | 3 | 9 | 117 | 107 | 0 | 2 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,767 | 148 | 46 | 0 | 0 | 69 | 26 | 25 | 28 | 14 | 0 | 31 | 23 | 8 | 1 | 6 | 46 | 69 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 124 | 31 | 0 | 0 | 63 | 24 | 24 | 24 | 14 | 0 | 29 | 21 | 7 | 1 | 5 | 31 | 63 | 0 | 2 | 13 | 0 | 0 | 
| leaf | 0 | prover | 260,613,236 | 821 | 399 | 0 | 1 | 346 | 134 | 134 | 76 | 135 | 0 | 75 | 34 | 40 | 21 | 18 | 399 | 346 | 0 | 6 | 134 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 902,782,844 | 2,566 | 960 | 0 | 310 | 1,408 | 856 | 855 | 329 | 222 | 69 | 197 | 41 | 156 | 87 | 68 | 960 | 1,408 | 0 | 3 | 152 | 0 | 0 | 
| app_proof | prover | 1 | 279,963,980 | 749 | 226 | 0 | 1 | 449 | 255 | 255 | 105 | 88 | 0 | 73 | 27 | 46 | 25 | 20 | 226 | 449 | 0 | 3 | 87 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 94 | 2,866 | 94 | 136 | 0 | 3 | 69 | 1,445,000 | 30.37 | 
| app_proof | 1 | 39 | 911 | 39 | 41 | 0 | 2 | 81 | 534,971 | 31.08 | 

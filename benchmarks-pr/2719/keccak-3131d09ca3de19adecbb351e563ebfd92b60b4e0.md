...
|:---|---:|---:|---:|
| Total |  17.01 |  5.01 |  5.01 |
| app_proof |  13.81 |  2.59 |  2.59 |
| leaf |  2.40 |  1.62 |  1.62 |
...
| `total_proof_time_ms ` |  2,277.83 |  13,667 |  2,452 |  2,185 |
...
| `execute_preflight_time_ms` |  237.67 |  1,426 |  317 |  89 |
| `execute_preflight_insn_mi/s` |  32.39 | -          |  33.09 |  29.79 |
| `trace_gen_time_ms   ` |  37.17 |  223 |  53 |  34 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,944.67 |  11,668 |  2,170 |  1,879 |
| `prover.main_trace_commit_time_ms` |  698.50 |  4,191 |  856 |  666 |
| `prover.rap_constraints_time_ms` |  1,062.33 |  6,374 |  1,132 |  1,030 |
| `prover.openings_time_ms` |  182.67 |  1,096 |  189 |  180 |
| `prover.rap_constraints.logup_gkr_time_ms` |  287.83 |  1,727 |  349 |  259 |
| `prover.rap_constraints.round0_time_ms` |  513.17 |  3,079 |  516 |  510 |
| `prover.rap_constraints.mle_rounds_time_ms` |  260.50 |  1,563 |  270 |  256 |
| `prover.openings.stacked_reduction_time_ms` |  136.33 |  818 |  137 |  135 |
| `prover.openings.stacked_reduction.round0_time_ms` |  83.33 |  500 |  84 |  82 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  52.50 |  315 |  53 |  52 |
| `prover.openings.whir_time_ms` |  46.17 |  277 |  54 |  44 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,199 |  2,398 |  1,617 |  781 |
| `execute_preflight_time_ms` |  5.50 |  11 |  6 |  5 |
| `trace_gen_time_ms   ` |  132.50 |  265 |  176 |  89 |
| `generate_blob_total_time_ms` |  21 |  42 |  28 |  14 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,066 |  2,132 |  1,441 |  691 |
| `prover.main_trace_commit_time_ms` |  640 |  1,280 |  902 |  378 |
| `prover.rap_constraints_time_ms` |  324.50 |  649 |  418 |  231 |
| `prover.openings_time_ms` |  100 |  200 |  120 |  80 |
...
| `prover.openings.whir_time_ms` |  45 |  90 |  47 |  43 |
...
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  464 |  464 |  464 |  464 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/3131d09ca3de19adecbb351e563ebfd92b60b4e0/keccak-3131d09ca3de19adecbb351e563ebfd92b60b4e0.memory.svg)

| Module | Max (GB) | Max At |
| --- | ---: | --- |
| prover.rap_constraints | 13.47 | app_proof.prover.0 |
...
| prover.batch_constraints.before_round0 | 12.68 | app_proof.prover.0 |
| frac_sumcheck.gkr_rounds | 12.68 | app_proof.prover.0 |
| frac_sumcheck.segment_tree | 12.55 | app_proof.prover.0 |
| prover.gkr_input_evals | 12.55 | app_proof.prover.0 |
| prover.batch_constraints.round0 | 12.38 | app_proof.prover.0 |
| prover.batch_constraints.fold_ple_evals | 12.38 | app_proof.prover.0 |
...
| app_proof |  |  |  |  |  | 2,185 |  |  | 142 | 14,365,133 | 100.67 | 0 | 13,817 |  | 
| internal_for_leaf |  |  |  | 503 |  |  |  |  |  |  |  |  |  | 503 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 38 | 503 | 38 | 13 | 4 | 2 | 2 | 2 | 
| internal_recursive.0 | 1 | 13 | 163 | 13 | 2 | 1 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 9 | 133 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 176 | 1,617 | 175 | 60 | 28 | 6 | 7 | 7 | 
| leaf | 1 | 89 | 781 | 89 | 30 | 14 | 5 | 7 | 7 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 81,415,156 | 464 | 246 | 0 | 1 | 174 | 50 | 49 | 93 | 31 | 0 | 42 | 19 | 23 | 7 | 15 | 246 | 174 | 0 | 2 | 29 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,943 |
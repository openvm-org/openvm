...
| `total_proof_time_ms ` |  697 |  1,394 |  758 |  636 |
| `compile_metered_time_ms` |  3 |  3 |  3 |  3 |
| `execute_metered_time_ms` |  20 | -          | -          | -          |
| `execute_metered_insns` |  4,000,051 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  194.60 | -          |  194.60 |  194.60 |
| `execute_preflight_insns` |  2,000,025.50 |  4,000,051 |  2,621,000 |  1,379,051 |
| `execute_preflight_time_ms` |  65.50 |  131 |  79 |  52 |
| `execute_preflight_insn_mi/s` |  37.44 | -          |  39.32 |  35.55 |
| `trace_gen_time_ms   ` |  23 |  46 |  24 |  22 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  519.50 |  1,039 |  521 |  518 |
| `prover.main_trace_commit_time_ms` |  98.50 |  197 |  99 |  98 |
| `prover.rap_constraints_time_ms` |  320 |  640 |  321 |  319 |
| `prover.openings_time_ms` |  100 |  200 |  101 |  99 |
| `prover.rap_constraints.logup_gkr_time_ms` |  232.50 |  465 |  233 |  232 |
| `prover.rap_constraints.round0_time_ms` |  63.50 |  127 |  65 |  62 |
...
| `prover.openings.whir_time_ms` |  81 |  162 |  81 |  81 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/0b8d705e9d75b834e33ea98311d18879ee60e3ac/fibonacci-0b8d705e9d75b834e33ea98311d18879ee60e3ac.memory.svg)
...
| app_proof |  |  |  |  |  | 636 |  |  | 20 | 4,000,051 | 194.60 | 0 | 1,419 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 27,277,885 | 255 | 82 | 0 | 0 | 98 | 32 | 32 | 45 | 19 | 0 | 74 | 62 | 11 | 2 | 8 | 83 | 98 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 168 | 47 | 0 | 0 | 68 | 25 | 25 | 28 | 14 | 0 | 52 | 44 | 8 | 1 | 6 | 47 | 68 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 141 | 31 | 0 | 0 | 63 | 24 | 23 | 24 | 14 | 0 | 45 | 38 | 7 | 1 | 5 | 32 | 63 | 0 | 3 | 13 | 0 | 0 | 
| leaf | 0 | prover | 74,737,496 | 352 | 123 | 0 | 0 | 117 | 52 | 51 | 35 | 29 | 0 | 111 | 96 | 14 | 6 | 8 | 124 | 117 | 0 | 6 | 28 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 119,796,216 | 521 | 98 | 0 | 0 | 321 | 65 | 65 | 23 | 232 | 0 | 101 | 81 | 19 | 10 | 8 | 98 | 321 | 0 | 3 | 230 | 0 | 0 | 
| app_proof | prover | 1 | 119,795,168 | 518 | 99 | 0 | 0 | 319 | 62 | 62 | 23 | 233 | 0 | 99 | 81 | 18 | 10 | 8 | 99 | 319 | 0 | 3 | 232 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 2 | 22 | 758 | 22 | 134 | 3,176,285,986 | 1,768,942 | 3,178,054,928 | 2,097,152 | 0 | 3 | 79 | 2,621,000 | 35.55 | 
| app_proof | 1 | 1 | 24 | 636 | 24 | 41 | 1,707,679,788 | 1,468,951,987 | 3,176,631,775 | 2,097,152 | 0 | 2 | 52 | 1,379,051 | 39.32 | 

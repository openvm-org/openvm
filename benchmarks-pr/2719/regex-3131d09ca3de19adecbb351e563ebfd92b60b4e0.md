...
| `total_proof_time_ms ` |  772 |  1,544 |  888 |  656 |
| `execute_metered_time_ms` |  34 | -          | -          | -          |
| `execute_metered_insns` |  4,090,656 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  119.34 | -          |  119.34 |  119.34 |
| `execute_preflight_insns` |  2,045,328 |  4,090,656 |  2,327,000 |  1,763,656 |
| `execute_preflight_time_ms` |  93 |  186 |  104 |  82 |
| `execute_preflight_insn_mi/s` |  31.15 | -          |  33.08 |  29.21 |
| `trace_gen_time_ms   ` |  30.50 |  61 |  34 |  27 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  558.50 |  1,117 |  620 |  497 |
| `prover.main_trace_commit_time_ms` |  113 |  226 |  127 |  99 |
| `prover.rap_constraints_time_ms` |  403 |  806 |  447 |  359 |
| `prover.openings_time_ms` |  41 |  82 |  45 |  37 |
| `prover.rap_constraints.logup_gkr_time_ms` |  277 |  554 |  328 |  226 |
| `prover.rap_constraints.round0_time_ms` |  92 |  184 |  102 |  82 |
...
| `prover.openings.whir_time_ms` |  19 |  38 |  21 |  17 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/3131d09ca3de19adecbb351e563ebfd92b60b4e0/regex-3131d09ca3de19adecbb351e563ebfd92b60b4e0.memory.svg)
...
| app_proof |  |  |  |  |  | 656 |  |  | 34 | 4,090,656 | 119.34 | 0 | 1,592 |  | 
| internal_for_leaf |  |  |  | 224 |  |  |  |  |  |  |  |  |  | 225 | 
...
| app_proof | VmAirWrapper<Rv64LoadStoreAdapterAir, LoadStoreCoreAir<8> | 0 | 7 | 
...
| internal_recursive.0 | 1 | 10 | 148 | 10 | 1 | 0 | 2 | 0 | 0 | 
| internal_recursive.1 | 1 | 9 | 132 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 48 | 348 | 48 | 13 | 3 | 4 | 1 | 1 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 27,289,403 | 209 | 79 | 0 | 0 | 96 | 30 | 30 | 45 | 19 | 0 | 32 | 21 | 11 | 2 | 8 | 80 | 96 | 0 | 2 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,767 | 137 | 45 | 0 | 0 | 67 | 25 | 24 | 27 | 14 | 0 | 24 | 16 | 8 | 1 | 6 | 45 | 67 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 122 | 31 | 0 | 0 | 63 | 24 | 23 | 24 | 14 | 0 | 27 | 19 | 7 | 1 | 5 | 31 | 63 | 0 | 2 | 13 | 0 | 0 | 
| leaf | 0 | prover | 79,656,756 | 299 | 125 | 0 | 0 | 131 | 52 | 51 | 37 | 41 | 0 | 41 | 26 | 15 | 6 | 8 | 126 | 131 | 0 | 5 | 40 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 161,843,666 | 620 | 126 | 0 | 0 | 447 | 82 | 81 | 37 | 328 | 87 | 45 | 21 | 24 | 13 | 11 | 127 | 447 | 0 | 3 | 238 | 0 | 0 | 
| app_proof | prover | 1 | 123,257,151 | 497 | 99 | 0 | 8 | 359 | 102 | 101 | 31 | 226 | 0 | 37 | 17 | 20 | 9 | 10 | 99 | 359 | 0 | 2 | 225 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 27 | 888 | 27 | 136 | 1 | 5 | 104 | 2,327,000 | 29.21 | 
| app_proof | 1 | 34 | 656 | 34 | 41 | 0 | 2 | 82 | 1,763,656 | 33.08 | 

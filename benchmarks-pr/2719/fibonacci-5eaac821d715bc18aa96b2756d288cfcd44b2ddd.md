...
| `total_proof_time_ms ` |  475 |  1,900 |  609 |  331 |
| `execute_metered_time_ms` |  20 | -          | -          | -          |
| `execute_metered_insns` |  4,000,051 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  199.29 | -          |  199.29 |  199.29 |
| `execute_preflight_insns` |  1,000,012.75 |  4,000,051 |  1,310,000 |  70,051 |
| `execute_preflight_time_ms` |  35.75 |  143 |  51 |  4 |
| `execute_preflight_insn_mi/s` |  38.75 | -          |  39.85 |  36.86 |
| `trace_gen_time_ms   ` |  179.75 |  719 |  207 |  165 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  187.50 |  750 |  230 |  78 |
| `prover.main_trace_commit_time_ms` |  48 |  192 |  59 |  16 |
| `prover.rap_constraints_time_ms` |  105.50 |  422 |  133 |  35 |
| `prover.openings_time_ms` |  33 |  132 |  38 |  26 |
| `prover.rap_constraints.logup_gkr_time_ms` |  65.50 |  262 |  82 |  18 |
| `prover.rap_constraints.round0_time_ms` |  24.50 |  98 |  34 |  9 |
| `prover.rap_constraints.mle_rounds_time_ms` |  14.25 |  57 |  17 |  8 |
...
| `prover.openings.whir_time_ms` |  18.75 |  75 |  19 |  18 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/5eaac821d715bc18aa96b2756d288cfcd44b2ddd/fibonacci-5eaac821d715bc18aa96b2756d288cfcd44b2ddd.memory.svg)
...
| app_proof |  |  |  |  |  | 331 |  |  | 20 | 4,000,051 | 199.29 | 0 | 1,926 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,683 | 280 | 119 | 0 | 7 | 112 | 34 | 33 | 51 | 26 | 0 | 48 | 19 | 28 | 3 | 24 | 119 | 111 | 0 | 2 | 25 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,703 | 164 | 47 | 0 | 4 | 71 | 23 | 23 | 27 | 20 | 0 | 44 | 20 | 23 | 1 | 21 | 48 | 71 | 0 | 2 | 19 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 144 | 34 | 0 | 4 | 65 | 22 | 21 | 24 | 18 | 0 | 43 | 21 | 22 | 1 | 20 | 34 | 65 | 0 | 2 | 18 | 0 | 0 | 
| leaf | 0 | prover | 142,033,830 | 480 | 227 | 0 | 14 | 182 | 80 | 79 | 52 | 49 | 0 | 70 | 31 | 38 | 11 | 26 | 227 | 182 | 0 | 5 | 48 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 69,989,002 | 230 | 57 | 0 | 1 | 133 | 34 | 33 | 17 | 81 | 0 | 38 | 19 | 18 | 6 | 12 | 58 | 133 | 0 | 3 | 80 | 0 | 0 | 
| app_proof | prover | 1 | 69,945,164 | 222 | 59 | 0 | 1 | 128 | 28 | 28 | 16 | 82 | 0 | 34 | 19 | 14 | 6 | 8 | 59 | 128 | 0 | 3 | 81 | 0 | 0 | 
| app_proof | prover | 2 | 69,945,164 | 220 | 59 | 0 | 1 | 126 | 27 | 27 | 16 | 81 | 0 | 34 | 19 | 14 | 6 | 8 | 59 | 126 | 0 | 3 | 81 | 0 | 0 | 
| app_proof | prover | 3 | 9,531,164 | 78 | 16 | 0 | 1 | 35 | 9 | 9 | 8 | 18 | 0 | 26 | 18 | 8 | 1 | 6 | 16 | 35 | 0 | 2 | 16 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 178 | 609 | 178 | 161 | 0 | 3 | 40 | 1,310,000 | 36.86 | 
| app_proof | 1 | 165 | 481 | 165 | 41 | 0 | 1 | 51 | 1,310,000 | 39.49 | 
| app_proof | 2 | 169 | 479 | 169 | 40 | 0 | 1 | 48 | 1,310,000 | 39.85 | 
| app_proof | 3 | 207 | 331 | 207 | 40 | 0 | 1 | 4 | 70,051 | 38.81 | 

...
| `total_proof_time_ms ` |  5,053 |  10,106 |  5,062 |  5,044 |
...
| `execute_preflight_time_ms` |  297.50 |  595 |  400 |  195 |
| `execute_preflight_insn_mi/s` |  33.69 | -          |  35.12 |  32.27 |
| `trace_gen_time_ms   ` |  130.50 |  261 |  152 |  109 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  4,535.50 |  9,071 |  4,578 |  4,493 |
| `prover.main_trace_commit_time_ms` |  1,274 |  2,548 |  1,316 |  1,232 |
| `prover.rap_constraints_time_ms` |  2,388.50 |  4,777 |  2,391 |  2,386 |
| `prover.openings_time_ms` |  872.50 |  1,745 |  876 |  869 |
| `prover.rap_constraints.logup_gkr_time_ms` |  604.50 |  1,209 |  606 |  603 |
| `prover.rap_constraints.round0_time_ms` |  1,305 |  2,610 |  1,305 |  1,305 |
| `prover.rap_constraints.mle_rounds_time_ms` |  478 |  956 |  479 |  477 |
| `prover.openings.stacked_reduction_time_ms` |  205.50 |  411 |  206 |  205 |
| `prover.openings.stacked_reduction.round0_time_ms` |  128 |  256 |  128 |  128 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  77 |  154 |  77 |  77 |
| `prover.openings.whir_time_ms` |  666 |  1,332 |  670 |  662 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/512f949f05f145b4f19a060d1477b59d0c6a0e9b/sha2_bench-512f949f05f145b4f19a060d1477b59d0c6a0e9b.memory.svg)
...
| app_proof |  |  |  |  |  | 5,044 |  |  | 98 | 11,167,961 | 113.68 | 0 | 10,210 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 331 | 119 | 0 | 0 | 107 | 35 | 34 | 51 | 20 | 0 | 104 | 91 | 13 | 3 | 9 | 119 | 107 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 169 | 46 | 0 | 0 | 67 | 24 | 23 | 28 | 14 | 0 | 55 | 47 | 8 | 1 | 6 | 46 | 67 | 0 | 3 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 139 | 32 | 0 | 0 | 61 | 23 | 22 | 25 | 13 | 0 | 45 | 38 | 7 | 1 | 5 | 32 | 61 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 237,893,432 | 889 | 370 | 0 | 0 | 228 | 110 | 109 | 67 | 50 | 0 | 290 | 253 | 36 | 19 | 16 | 371 | 228 | 0 | 11 | 49 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,274,446,073 | 4,578 | 1,315 | 0 | 0 | 2,386 | 1,305 | 1,305 | 477 | 603 | 0 | 876 | 670 | 205 | 128 | 77 | 1,316 | 2,386 | 0 | 5 | 601 | 0 | 0 | 
| app_proof | prover | 1 | 1,274,446,068 | 4,493 | 1,232 | 0 | 0 | 2,391 | 1,305 | 1,305 | 479 | 606 | 0 | 869 | 662 | 206 | 128 | 77 | 1,232 | 2,391 | 0 | 5 | 604 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 1 | 152 | 5,062 | 152 | 135 | 10,985,768,556 | 4,322,059,584 | 15,307,828,140 | 2,097,152 | 0 | 3 | 195 | 5,703,000 | 32.27 | 
| app_proof | 1 | 1 | 109 | 5,044 | 109 | 41 | 10,529,881,188 | 4,777,688,844 | 15,307,570,032 | 2,097,152 | 0 | 2 | 400 | 5,464,961 | 35.12 | 

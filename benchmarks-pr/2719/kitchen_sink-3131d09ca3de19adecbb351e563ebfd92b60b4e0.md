...
|:---|---:|---:|---:|
| Total |  5.34 |  4.42 |  4.42 |
| app_proof |  3.82 |  2.90 |  2.90 |
| leaf |  0.95 |  0.95 |  0.95 |
...
| `total_proof_time_ms ` |  1,897.50 |  3,795 |  2,874 |  921 |
| `execute_metered_time_ms` |  25 | -          | -          | -          |
| `execute_metered_insns` |  1,979,971 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  78.60 | -          |  78.60 |  78.60 |
| `execute_preflight_insns` |  989,985.50 |  1,979,971 |  1,445,000 |  534,971 |
| `execute_preflight_time_ms` |  74.50 |  149 |  81 |  68 |
| `execute_preflight_insn_mi/s` |  30.80 | -          |  31.06 |  30.54 |
| `trace_gen_time_ms   ` |  68 |  136 |  96 |  40 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,665 |  3,330 |  2,572 |  758 |
| `prover.main_trace_commit_time_ms` |  592 |  1,184 |  957 |  227 |
| `prover.rap_constraints_time_ms` |  934.50 |  1,869 |  1,414 |  455 |
| `prover.openings_time_ms` |  137.50 |  275 |  200 |  75 |
| `prover.rap_constraints.logup_gkr_time_ms` |  154 |  308 |  219 |  89 |
| `prover.rap_constraints.round0_time_ms` |  560.50 |  1,121 |  862 |  259 |
| `prover.rap_constraints.mle_rounds_time_ms` |  219 |  438 |  332 |  106 |
| `prover.openings.stacked_reduction_time_ms` |  103 |  206 |  160 |  46 |
| `prover.openings.stacked_reduction.round0_time_ms` |  57 |  114 |  90 |  24 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  45.50 |  91 |  70 |  21 |
| `prover.openings.whir_time_ms` |  34.50 |  69 |  40 |  29 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/3131d09ca3de19adecbb351e563ebfd92b60b4e0/kitchen_sink-3131d09ca3de19adecbb351e563ebfd92b60b4e0.memory.svg)
...
| app_proof |  |  |  |  |  | 921 |  |  | 25 | 1,979,971 | 78.60 | 0 | 3,825 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,577,979 | 262 | 117 | 0 | 0 | 108 | 35 | 34 | 52 | 20 | 0 | 35 | 21 | 13 | 3 | 9 | 118 | 108 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,767 | 143 | 46 | 0 | 0 | 67 | 25 | 24 | 27 | 14 | 0 | 29 | 21 | 8 | 1 | 6 | 46 | 67 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 121 | 32 | 0 | 0 | 62 | 24 | 23 | 24 | 14 | 0 | 25 | 18 | 7 | 1 | 5 | 32 | 62 | 0 | 2 | 13 | 0 | 0 | 
| leaf | 0 | prover | 260,613,236 | 831 | 402 | 0 | 1 | 349 | 134 | 134 | 78 | 136 | 0 | 79 | 38 | 40 | 21 | 18 | 403 | 349 | 0 | 7 | 135 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 902,782,844 | 2,572 | 956 | 0 | 304 | 1,414 | 862 | 860 | 332 | 219 | 67 | 200 | 40 | 160 | 90 | 70 | 957 | 1,414 | 0 | 3 | 151 | 0 | 0 | 
| app_proof | prover | 1 | 279,963,980 | 758 | 227 | 0 | 1 | 455 | 259 | 259 | 106 | 89 | 0 | 75 | 29 | 46 | 24 | 21 | 227 | 455 | 0 | 4 | 88 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 96 | 2,874 | 96 | 137 | 0 | 3 | 68 | 1,445,000 | 30.54 | 
| app_proof | 1 | 40 | 921 | 40 | 41 | 0 | 2 | 81 | 534,971 | 31.06 | 

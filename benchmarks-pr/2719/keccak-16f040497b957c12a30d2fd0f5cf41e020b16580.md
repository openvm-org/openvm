...
|:---|---:|---:|---:|
| Total |  16.79 |  4.96 |  4.96 |
| app_proof |  13.76 |  2.70 |  2.70 |
| leaf |  2.23 |  1.45 |  1.45 |
...
| `total_proof_time_ms ` |  2,269.67 |  13,618 |  2,564 |  2,172 |
...
| `execute_preflight_time_ms` |  234.67 |  1,408 |  316 |  85 |
| `execute_preflight_insn_mi/s` |  35.40 | -          |  36.25 |  32.46 |
| `trace_gen_time_ms   ` |  55.17 |  331 |  162 |  33 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,917.83 |  11,507 |  2,154 |  1,868 |
| `prover.main_trace_commit_time_ms` |  717.67 |  4,306 |  886 |  682 |
| `prover.rap_constraints_time_ms` |  1,015 |  6,090 |  1,081 |  1,000 |
| `prover.openings_time_ms` |  184 |  1,104 |  186 |  182 |
| `prover.rap_constraints.logup_gkr_time_ms` |  175.17 |  1,051 |  227 |  164 |
| `prover.rap_constraints.round0_time_ms` |  522.33 |  3,134 |  526 |  517 |
| `prover.rap_constraints.mle_rounds_time_ms` |  316.50 |  1,899 |  336 |  311 |
| `prover.openings.stacked_reduction_time_ms` |  139.33 |  836 |  140 |  139 |
...
| `prover.openings.whir_time_ms` |  44.17 |  265 |  46 |  43 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,113.50 |  2,227 |  1,453 |  774 |
| `execute_preflight_time_ms` |  5.50 |  11 |  6 |  5 |
| `trace_gen_time_ms   ` |  138.50 |  277 |  185 |  92 |
| `generate_blob_total_time_ms` |  24.50 |  49 |  33 |  16 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  975 |  1,950 |  1,268 |  682 |
| `prover.main_trace_commit_time_ms` |  555.50 |  1,111 |  732 |  379 |
| `prover.rap_constraints_time_ms` |  323.50 |  647 |  418 |  229 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/16f040497b957c12a30d2fd0f5cf41e020b16580/keccak-16f040497b957c12a30d2fd0f5cf41e020b16580.memory.svg)
...
| app_proof |  |  |  |  |  | 2,172 |  |  | 140 | 14,365,133 | 102.15 | 0 | 13,765 |  | 
...
| leaf | 0 | 185 | 1,453 | 185 | 65 | 33 | 6 | 7 | 7 | 
| leaf | 1 | 92 | 774 | 91 | 32 | 16 | 5 | 7 | 7 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 81,415,028 | 467 | 247 | 0 | 1 | 173 | 48 | 48 | 93 | 30 | 0 | 46 | 22 | 23 | 7 | 16 | 247 | 173 | 0 | 3 | 30 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,879 | 152 | 49 | 0 | 0 | 72 | 25 | 24 | 29 | 18 | 0 | 28 | 20 | 8 | 2 | 6 | 50 | 72 | 0 | 2 | 16 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 119 | 31 | 0 | 0 | 63 | 25 | 24 | 24 | 13 | 0 | 24 | 16 | 7 | 1 | 5 | 32 | 63 | 0 | 2 | 13 | 0 | 0 | 
| leaf | 0 | prover | 476,578,662 | 1,268 | 731 | 0 | 2 | 418 | 209 | 209 | 121 | 86 | 0 | 117 | 45 | 72 | 41 | 31 | 732 | 418 | 0 | 7 | 85 | 0 | 0 | 
| leaf | 1 | prover | 240,255,732 | 682 | 379 | 0 | 1 | 229 | 110 | 109 | 67 | 51 | 0 | 72 | 34 | 37 | 20 | 17 | 379 | 229 | 0 | 7 | 51 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 857,743,372 | 2,154 | 886 | 0 | 206 | 1,081 | 517 | 516 | 336 | 227 | 68 | 186 | 45 | 140 | 87 | 53 | 886 | 1,081 | 0 | 4 | 158 | 0 | 0 | 
| app_proof | prover | 1 | 857,820,172 | 1,872 | 685 | 0 | 3 | 1,000 | 521 | 520 | 313 | 165 | 0 | 186 | 46 | 139 | 85 | 54 | 685 | 1,000 | 0 | 4 | 164 | 0 | 0 | 
| app_proof | prover | 2 | 857,820,172 | 1,869 | 683 | 0 | 3 | 1,001 | 524 | 523 | 311 | 165 | 0 | 184 | 45 | 139 | 84 | 54 | 683 | 1,001 | 0 | 4 | 164 | 0 | 0 | 
| app_proof | prover | 3 | 857,820,172 | 1,875 | 685 | 0 | 3 | 1,006 | 526 | 526 | 314 | 165 | 0 | 183 | 43 | 140 | 85 | 54 | 685 | 1,006 | 0 | 4 | 164 | 0 | 0 | 
| app_proof | prover | 4 | 857,820,172 | 1,868 | 682 | 0 | 3 | 1,002 | 524 | 524 | 312 | 165 | 0 | 182 | 43 | 139 | 85 | 54 | 682 | 1,002 | 0 | 4 | 163 | 0 | 0 | 
| app_proof | prover | 5 | 857,743,372 | 1,869 | 685 | 0 | 3 | 1,000 | 522 | 521 | 313 | 164 | 0 | 183 | 43 | 139 | 86 | 53 | 685 | 1,000 | 0 | 4 | 163 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 162 | 2,564 | 161 | 162 | 0 | 3 | 85 | 2,413,000 | 32.46 | 
| app_proof | 1 | 34 | 2,263 | 34 | 41 | 0 | 1 | 316 | 2,413,000 | 35.90 | 
| app_proof | 2 | 34 | 2,205 | 34 | 41 | 0 | 1 | 260 | 2,413,000 | 35.93 | 
| app_proof | 3 | 34 | 2,209 | 34 | 41 | 0 | 1 | 258 | 2,413,000 | 36.25 | 
| app_proof | 4 | 34 | 2,205 | 34 | 41 | 0 | 1 | 261 | 2,413,000 | 35.96 | 
| app_proof | 5 | 33 | 2,172 | 33 | 41 | 0 | 1 | 228 | 2,300,133 | 35.89 | 

...
|:---|---:|---:|---:|
| Total |  11.90 |  6.85 |  6.85 |
| app_proof |  10.21 |  5.16 |  5.16 |
| leaf |  1.01 |  1.01 |  1.01 |
...
| `total_proof_time_ms ` |  5,057.50 |  10,115 |  5,066 |  5,049 |
| `compile_metered_time_ms` |  3 |  3 |  3 |  3 |
| `execute_metered_time_ms` |  97 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  114.16 | -          |  114.16 |  114.16 |
| `execute_preflight_insns` |  5,583,980.50 |  11,167,961 |  5,703,000 |  5,464,961 |
| `execute_preflight_time_ms` |  305 |  610 |  416 |  194 |
| `execute_preflight_insn_mi/s` |  34.47 | -          |  36.07 |  32.88 |
| `trace_gen_time_ms   ` |  131.50 |  263 |  153 |  110 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  4,531.50 |  9,063 |  4,582 |  4,481 |
| `prover.main_trace_commit_time_ms` |  1,280 |  2,560 |  1,324 |  1,236 |
| `prover.rap_constraints_time_ms` |  2,379.50 |  4,759 |  2,382 |  2,377 |
| `prover.openings_time_ms` |  871 |  1,742 |  875 |  867 |
| `prover.rap_constraints.logup_gkr_time_ms` |  603 |  1,206 |  603 |  603 |
| `prover.rap_constraints.round0_time_ms` |  1,298.50 |  2,597 |  1,301 |  1,296 |
| `prover.rap_constraints.mle_rounds_time_ms` |  476.50 |  953 |  477 |  476 |
| `prover.openings.stacked_reduction_time_ms` |  204 |  408 |  205 |  203 |
| `prover.openings.stacked_reduction.round0_time_ms` |  127.50 |  255 |  128 |  127 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  76.50 |  153 |  77 |  76 |
| `prover.openings.whir_time_ms` |  666 |  1,332 |  669 |  663 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/0b8d705e9d75b834e33ea98311d18879ee60e3ac/sha2_bench-0b8d705e9d75b834e33ea98311d18879ee60e3ac.memory.svg)
...
| app_proof |  |  |  |  |  | 5,049 |  |  | 97 | 11,167,961 | 114.16 | 0 | 10,218 |  | 
...
| app_proof | VmAirWrapper<Rv64BaseAluAdapterAir, BaseAluCoreAir<8, 8> | 0 | 27 | 
...
| app_proof | VmAirWrapper<Rv64LoadStoreAdapterAir, LoadStoreCoreAir<8> | 0 | 29 | 
...
| leaf | 0 | 125 | 1,010 | 124 | 40 | 21 | 2 | 11 | 11 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 331 | 119 | 0 | 0 | 108 | 36 | 35 | 51 | 20 | 0 | 102 | 89 | 13 | 3 | 9 | 120 | 108 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 167 | 47 | 0 | 0 | 67 | 24 | 24 | 28 | 14 | 0 | 52 | 43 | 8 | 1 | 6 | 47 | 67 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 134 | 31 | 0 | 0 | 61 | 22 | 21 | 25 | 14 | 0 | 40 | 33 | 7 | 1 | 5 | 32 | 61 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 237,893,432 | 885 | 369 | 0 | 0 | 228 | 109 | 108 | 68 | 50 | 0 | 287 | 249 | 37 | 20 | 17 | 369 | 228 | 0 | 10 | 49 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,274,446,073 | 4,582 | 1,324 | 0 | 0 | 2,382 | 1,301 | 1,300 | 477 | 603 | 1 | 875 | 669 | 205 | 128 | 77 | 1,324 | 2,381 | 0 | 5 | 601 | 0 | 0 | 
| app_proof | prover | 1 | 1,274,446,068 | 4,481 | 1,236 | 0 | 0 | 2,377 | 1,296 | 1,296 | 476 | 603 | 0 | 867 | 663 | 203 | 127 | 76 | 1,236 | 2,377 | 0 | 5 | 601 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 1 | 153 | 5,066 | 153 | 135 | 10,985,768,556 | 4,322,059,584 | 15,307,828,140 | 2,097,152 | 0 | 3 | 194 | 5,703,000 | 32.88 | 
| app_proof | 1 | 1 | 110 | 5,049 | 110 | 41 | 10,529,881,188 | 4,777,688,844 | 15,307,570,032 | 2,097,152 | 0 | 2 | 416 | 5,464,961 | 36.07 | 

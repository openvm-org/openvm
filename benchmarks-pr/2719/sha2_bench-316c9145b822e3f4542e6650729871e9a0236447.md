...
|:---|---:|---:|---:|
| Total |  11.80 |  6.79 |  6.79 |
| app_proof |  10.12 |  5.11 |  5.11 |
| leaf |  1.01 |  1.01 |  1.01 |
...
| `total_proof_time_ms ` |  5,010.50 |  10,021 |  5,014 |  5,007 |
...
| `execute_preflight_time_ms` |  298.50 |  597 |  400 |  197 |
| `execute_preflight_insn_mi/s` |  33.40 | -          |  34.94 |  31.86 |
| `trace_gen_time_ms   ` |  131 |  262 |  152 |  110 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  4,492 |  8,984 |  4,528 |  4,456 |
| `prover.main_trace_commit_time_ms` |  1,264 |  2,528 |  1,302 |  1,226 |
| `prover.rap_constraints_time_ms` |  2,358.50 |  4,717 |  2,365 |  2,352 |
| `prover.openings_time_ms` |  868.50 |  1,737 |  873 |  864 |
| `prover.rap_constraints.logup_gkr_time_ms` |  600.50 |  1,201 |  603 |  598 |
| `prover.rap_constraints.round0_time_ms` |  1,281.50 |  2,563 |  1,284 |  1,279 |
| `prover.rap_constraints.mle_rounds_time_ms` |  475.50 |  951 |  477 |  474 |
| `prover.openings.stacked_reduction_time_ms` |  205 |  410 |  206 |  204 |
| `prover.openings.stacked_reduction.round0_time_ms` |  128.50 |  257 |  129 |  128 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  76.50 |  153 |  77 |  76 |
| `prover.openings.whir_time_ms` |  663 |  1,326 |  666 |  660 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/316c9145b822e3f4542e6650729871e9a0236447/sha2_bench-316c9145b822e3f4542e6650729871e9a0236447.memory.svg)
...
| app_proof |  |  |  |  |  | 5,007 |  |  | 98 | 11,167,961 | 112.90 | 0 | 10,126 |  | 
...
| leaf | 0 | 121 | 1,007 | 121 | 40 | 21 | 2 | 11 | 11 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 325 | 117 | 0 | 0 | 107 | 34 | 34 | 51 | 21 | 0 | 101 | 87 | 13 | 3 | 9 | 117 | 107 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 169 | 46 | 0 | 0 | 67 | 24 | 24 | 28 | 13 | 0 | 55 | 47 | 8 | 1 | 6 | 46 | 67 | 0 | 3 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 134 | 32 | 0 | 0 | 60 | 22 | 22 | 24 | 13 | 0 | 41 | 33 | 7 | 1 | 5 | 32 | 60 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 237,893,432 | 885 | 372 | 0 | 0 | 225 | 107 | 106 | 66 | 51 | 0 | 287 | 250 | 36 | 20 | 16 | 372 | 225 | 0 | 10 | 50 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,274,446,073 | 4,528 | 1,302 | 0 | 0 | 2,352 | 1,279 | 1,278 | 474 | 598 | 0 | 873 | 666 | 206 | 129 | 77 | 1,302 | 2,352 | 0 | 4 | 597 | 0 | 0 | 
| app_proof | prover | 1 | 1,274,446,068 | 4,456 | 1,226 | 0 | 0 | 2,365 | 1,284 | 1,284 | 477 | 603 | 0 | 864 | 660 | 204 | 128 | 76 | 1,226 | 2,365 | 0 | 5 | 601 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 1 | 152 | 5,014 | 152 | 135 | 10,985,768,556 | 4,322,059,584 | 15,307,828,140 | 2,097,152 | 0 | 3 | 197 | 5,703,000 | 31.86 | 
| app_proof | 1 | 1 | 110 | 5,007 | 110 | 41 | 10,529,881,188 | 4,777,688,844 | 15,307,570,032 | 2,097,152 | 0 | 2 | 400 | 5,464,961 | 34.94 | 

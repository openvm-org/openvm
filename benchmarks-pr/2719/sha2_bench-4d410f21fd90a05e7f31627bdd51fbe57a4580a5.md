...
|:---|---:|---:|---:|
| Total |  13.48 |  5.66 |  5.66 |
| app_proof |  10.68 |  2.85 |  2.85 |
| leaf |  1.96 |  1.96 |  1.96 |
...
| `total_proof_time_ms ` |  2,644.75 |  10,579 |  2,751 |  2,592 |
...
| `execute_preflight_time_ms` |  165.75 |  663 |  209 |  99 |
| `execute_preflight_insn_mi/s` |  35.28 | -          |  36.31 |  32.77 |
| `trace_gen_time_ms   ` |  58.50 |  234 |  67 |  53 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  2,353.50 |  9,414 |  2,444 |  2,319 |
| `prover.main_trace_commit_time_ms` |  623.75 |  2,495 |  626 |  621 |
| `prover.rap_constraints_time_ms` |  1,250.50 |  5,002 |  1,253 |  1,247 |
| `prover.openings_time_ms` |  478.25 |  1,913 |  567 |  446 |
| `prover.rap_constraints.logup_gkr_time_ms` |  313.25 |  1,253 |  314 |  313 |
| `prover.rap_constraints.round0_time_ms` |  685.50 |  2,742 |  687 |  683 |
| `prover.rap_constraints.mle_rounds_time_ms` |  250.75 |  1,003 |  252 |  249 |
| `prover.openings.stacked_reduction_time_ms` |  100.75 |  403 |  102 |  99 |
| `prover.openings.stacked_reduction.round0_time_ms` |  61 |  244 |  62 |  60 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  39 |  156 |  40 |  38 |
| `prover.openings.whir_time_ms` |  376.75 |  1,507 |  464 |  346 |
...
| `prover.main_trace_commit_time_ms` |  818 |  818 |  818 |  818 |
| `prover.rap_constraints_time_ms` |  358 |  358 |  358 |  358 |
| `prover.openings_time_ms` |  635 |  635 |  635 |  635 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/4d410f21fd90a05e7f31627bdd51fbe57a4580a5/sha2_bench-4d410f21fd90a05e7f31627bdd51fbe57a4580a5.memory.svg)
...
| app_proof |  |  |  |  |  | 2,592 |  |  | 100 | 11,167,961 | 110.69 | 0 | 10,686 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 61,220,667 | 470 | 186 | 0 | 0 | 131 | 38 | 38 | 64 | 28 | 0 | 151 | 131 | 19 | 5 | 13 | 187 | 131 | 0 | 4 | 26 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,943 | 182 | 50 | 0 | 0 | 73 | 25 | 24 | 29 | 18 | 0 | 58 | 49 | 8 | 2 | 6 | 50 | 73 | 0 | 2 | 17 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 142 | 32 | 0 | 0 | 63 | 24 | 23 | 24 | 14 | 0 | 47 | 40 | 7 | 1 | 5 | 32 | 63 | 0 | 3 | 13 | 0 | 0 | 
| leaf | 0 | prover | 425,192,422 | 1,813 | 818 | 0 | 89 | 358 | 176 | 175 | 105 | 76 | 0 | 635 | 569 | 65 | 36 | 29 | 818 | 358 | 0 | 10 | 75 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 640,057,593 | 2,444 | 625 | 0 | 71 | 1,251 | 686 | 685 | 249 | 314 | 0 | 567 | 464 | 102 | 62 | 40 | 626 | 1,250 | 0 | 4 | 312 | 0 | 0 | 
| app_proof | prover | 1 | 640,057,356 | 2,319 | 620 | 0 | 0 | 1,251 | 686 | 685 | 252 | 313 | 0 | 446 | 346 | 99 | 60 | 38 | 621 | 1,251 | 0 | 5 | 312 | 0 | 0 | 
| app_proof | prover | 2 | 640,057,356 | 2,327 | 624 | 0 | 0 | 1,253 | 687 | 687 | 252 | 313 | 0 | 448 | 346 | 102 | 62 | 39 | 624 | 1,253 | 0 | 5 | 312 | 0 | 0 | 
| app_proof | prover | 3 | 640,057,588 | 2,324 | 624 | 0 | 0 | 1,247 | 683 | 682 | 250 | 313 | 0 | 452 | 351 | 100 | 60 | 39 | 624 | 1,247 | 0 | 5 | 312 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 67 | 2,751 | 67 | 138 | 5,529,436,044 | 2,165,730,336 | 7,695,166,380 | 2,097,152 | 0 | 3 | 99 | 2,851,000 | 32.77 | 
| app_proof | 1 | 57 | 2,627 | 57 | 41 | 5,529,347,520 | 2,165,557,968 | 7,694,905,488 | 2,097,152 | 0 | 1 | 209 | 2,851,000 | 36.31 | 
| app_proof | 2 | 57 | 2,609 | 57 | 41 | 5,529,349,296 | 2,165,556,192 | 7,694,905,488 | 2,097,152 | 0 | 1 | 183 | 2,851,000 | 35.94 | 
| app_proof | 3 | 53 | 2,592 | 53 | 41 | 5,077,435,956 | 2,617,472,316 | 7,694,908,272 | 2,097,152 | 0 | 1 | 172 | 2,614,961 | 36.09 | 

...
| `total_proof_time_ms ` |  699.50 |  1,399 |  769 |  630 |
...
| `execute_preflight_time_ms` |  66.50 |  133 |  81 |  52 |
| `execute_preflight_insn_mi/s` |  36.99 | -          |  39.01 |  34.96 |
| `trace_gen_time_ms   ` |  23.50 |  47 |  25 |  22 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  520 |  1,040 |  529 |  511 |
| `prover.main_trace_commit_time_ms` |  96.50 |  193 |  99 |  94 |
| `prover.rap_constraints_time_ms` |  321.50 |  643 |  327 |  316 |
| `prover.openings_time_ms` |  101.50 |  203 |  103 |  100 |
| `prover.rap_constraints.logup_gkr_time_ms` |  233 |  466 |  236 |  230 |
| `prover.rap_constraints.round0_time_ms` |  64.50 |  129 |  67 |  62 |
| `prover.rap_constraints.mle_rounds_time_ms` |  23 |  46 |  23 |  23 |
| `prover.openings.stacked_reduction_time_ms` |  19.50 |  39 |  20 |  19 |
| `prover.openings.stacked_reduction.round0_time_ms` |  10.50 |  21 |  11 |  10 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  8 |  16 |  8 |  8 |
| `prover.openings.whir_time_ms` |  82 |  164 |  83 |  81 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/316c9145b822e3f4542e6650729871e9a0236447/fibonacci-316c9145b822e3f4542e6650729871e9a0236447.memory.svg)
...
| app_proof |  |  |  |  |  | 630 |  |  | 20 | 4,000,051 | 192.54 | 0 | 1,426 |  | 
...
| internal_recursive.0 | 1 | 12 | 182 | 11 | 1 | 0 | 2 | 0 | 1 | 
| internal_recursive.1 | 1 | 9 | 149 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 42 | 395 | 42 | 13 | 2 | 1 | 1 | 1 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 27,277,885 | 258 | 82 | 0 | 0 | 98 | 31 | 31 | 45 | 20 | 0 | 76 | 65 | 11 | 2 | 8 | 83 | 98 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 169 | 47 | 0 | 0 | 67 | 25 | 24 | 28 | 13 | 0 | 54 | 46 | 8 | 1 | 6 | 47 | 67 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 139 | 31 | 0 | 0 | 62 | 24 | 23 | 24 | 13 | 0 | 45 | 37 | 7 | 1 | 5 | 32 | 62 | 0 | 3 | 13 | 0 | 0 | 
| leaf | 0 | prover | 74,737,496 | 352 | 124 | 0 | 0 | 117 | 52 | 51 | 35 | 29 | 0 | 110 | 95 | 14 | 6 | 8 | 124 | 117 | 0 | 6 | 28 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 119,796,216 | 529 | 98 | 0 | 0 | 327 | 67 | 67 | 23 | 236 | 0 | 103 | 83 | 20 | 11 | 8 | 99 | 327 | 0 | 3 | 234 | 0 | 0 | 
| app_proof | prover | 1 | 119,795,168 | 511 | 93 | 0 | 0 | 316 | 62 | 62 | 23 | 230 | 0 | 100 | 81 | 19 | 10 | 8 | 94 | 316 | 0 | 3 | 229 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 2 | 22 | 769 | 22 | 136 | 3,176,285,986 | 1,768,942 | 3,178,054,928 | 2,097,152 | 0 | 3 | 81 | 2,621,000 | 34.96 | 
| app_proof | 1 | 1 | 25 | 630 | 25 | 41 | 1,707,679,788 | 1,468,951,987 | 3,176,631,775 | 2,097,152 | 0 | 2 | 52 | 1,379,051 | 39.01 | 

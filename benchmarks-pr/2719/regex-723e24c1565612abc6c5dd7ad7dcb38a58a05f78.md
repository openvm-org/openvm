...
| `total_proof_time_ms ` |  777 |  1,554 |  868 |  686 |
...
| `execute_preflight_insn_mi/s` |  36.21 | -          |  37.85 |  34.58 |
| `trace_gen_time_ms   ` |  146 |  292 |  146 |  146 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  450.50 |  901 |  477 |  424 |
| `prover.main_trace_commit_time_ms` |  124.50 |  249 |  143 |  106 |
| `prover.rap_constraints_time_ms` |  277.50 |  555 |  282 |  273 |
| `prover.openings_time_ms` |  47 |  94 |  50 |  44 |
| `prover.rap_constraints.logup_gkr_time_ms` |  146.50 |  293 |  156 |  137 |
| `prover.rap_constraints.round0_time_ms` |  90 |  180 |  99 |  81 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/723e24c1565612abc6c5dd7ad7dcb38a58a05f78/regex-723e24c1565612abc6c5dd7ad7dcb38a58a05f78.memory.svg)
...
| app_proof |  |  |  |  |  | 686 |  |  | 31 | 4,090,656 | 128.62 | 0 | 1,599 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 27,256,571 | 208 | 80 | 0 | 0 | 97 | 32 | 31 | 45 | 19 | 0 | 30 | 19 | 11 | 2 | 8 | 81 | 97 | 0 | 2 | 18 | 0 | 0 | 
...
| leaf | 0 | prover | 79,962,868 | 305 | 127 | 0 | 0 | 134 | 54 | 53 | 37 | 42 | 0 | 43 | 28 | 15 | 6 | 8 | 127 | 134 | 0 | 5 | 41 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 179,663,570 | 477 | 142 | 0 | 0 | 282 | 81 | 80 | 45 | 156 | 0 | 50 | 23 | 27 | 15 | 12 | 143 | 282 | 0 | 3 | 154 | 0 | 0 | 
| app_proof | prover | 1 | 133,369,433 | 424 | 106 | 0 | 9 | 273 | 99 | 99 | 35 | 137 | 0 | 44 | 22 | 22 | 10 | 11 | 106 | 273 | 0 | 3 | 136 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 146 | 868 | 146 | 161 | 1 | 6 | 83 | 2,327,000 | 34.58 | 
| app_proof | 1 | 146 | 686 | 146 | 41 | 0 | 2 | 73 | 1,763,656 | 37.85 | 

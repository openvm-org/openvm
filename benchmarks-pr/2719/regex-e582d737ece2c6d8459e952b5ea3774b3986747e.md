...
| `total_proof_time_ms ` |  781 |  1,562 |  894 |  668 |
| `compile_metered_time_ms` |  8 |  8 |  8 |  8 |
| `execute_metered_time_ms` |  33 | -          | -          | -          |
| `execute_metered_insns` |  4,090,656 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  122.27 | -          |  122.27 |  122.27 |
| `execute_preflight_insns` |  2,045,328 |  4,090,656 |  2,327,000 |  1,763,656 |
| `execute_preflight_time_ms` |  87.50 |  175 |  98 |  77 |
| `execute_preflight_insn_mi/s` |  31.50 | -          |  33.05 |  29.94 |
| `trace_gen_time_ms   ` |  35.50 |  71 |  43 |  28 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  568.50 |  1,137 |  631 |  506 |
| `prover.main_trace_commit_time_ms` |  115.50 |  231 |  129 |  102 |
| `prover.rap_constraints_time_ms` |  408 |  816 |  453 |  363 |
| `prover.openings_time_ms` |  44 |  88 |  48 |  40 |
| `prover.rap_constraints.logup_gkr_time_ms` |  278 |  556 |  327 |  229 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/e582d737ece2c6d8459e952b5ea3774b3986747e/regex-e582d737ece2c6d8459e952b5ea3774b3986747e.memory.svg)
...
| app_proof |  |  |  |  |  | 668 |  |  | 33 | 4,090,656 | 122.27 | 0 | 1,609 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 27,289,403 | 210 | 81 | 0 | 0 | 98 | 31 | 31 | 46 | 19 | 0 | 29 | 18 | 11 | 2 | 8 | 82 | 98 | 0 | 2 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,767 | 143 | 45 | 0 | 0 | 67 | 25 | 24 | 28 | 13 | 0 | 30 | 21 | 8 | 1 | 6 | 46 | 67 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 129 | 31 | 0 | 0 | 62 | 23 | 23 | 24 | 14 | 0 | 34 | 27 | 7 | 1 | 5 | 32 | 62 | 0 | 2 | 13 | 0 | 0 | 
| leaf | 0 | prover | 79,656,756 | 307 | 127 | 0 | 0 | 137 | 56 | 55 | 37 | 43 | 0 | 41 | 25 | 15 | 6 | 8 | 128 | 137 | 0 | 5 | 41 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 161,843,666 | 631 | 128 | 0 | 0 | 453 | 88 | 87 | 38 | 327 | 83 | 48 | 23 | 25 | 14 | 11 | 129 | 453 | 0 | 3 | 242 | 0 | 0 | 
| app_proof | prover | 1 | 123,257,151 | 506 | 101 | 0 | 8 | 363 | 103 | 102 | 31 | 229 | 0 | 40 | 19 | 20 | 9 | 10 | 102 | 363 | 0 | 3 | 227 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 28 | 894 | 28 | 135 | 1 | 4 | 98 | 2,327,000 | 29.94 | 
| app_proof | 1 | 43 | 668 | 43 | 40 | 0 | 2 | 77 | 1,763,656 | 33.05 | 

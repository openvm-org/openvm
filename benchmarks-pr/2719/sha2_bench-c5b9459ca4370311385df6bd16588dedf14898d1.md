...
|:---|---:|---:|---:|
| Total |  11.60 |  4.78 |  4.78 |
| app_proof |  9.58 |  2.76 |  2.76 |
| leaf |  1.28 |  1.28 |  1.28 |
...
| `total_proof_time_ms ` |  2,372.25 |  9,489 |  2,670 |  2,261 |
| `execute_metered_time_ms` |  93 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  118.97 | -          |  118.97 |  118.97 |
| `execute_preflight_insns` |  2,791,990.25 |  11,167,961 |  2,851,000 |  2,614,961 |
| `execute_preflight_time_ms` |  167.75 |  671 |  212 |  100 |
| `execute_preflight_insn_mi/s` |  36.17 | -          |  37.11 |  33.60 |
| `trace_gen_time_ms   ` |  98.50 |  394 |  168 |  58 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  2,033.50 |  8,134 |  2,238 |  1,957 |
| `prover.main_trace_commit_time_ms` |  562 |  2,248 |  670 |  525 |
| `prover.rap_constraints_time_ms` |  1,321.25 |  5,285 |  1,415 |  1,285 |
| `prover.openings_time_ms` |  149 |  596 |  152 |  144 |
| `prover.rap_constraints.logup_gkr_time_ms` |  335.50 |  1,342 |  432 |  303 |
| `prover.rap_constraints.round0_time_ms` |  665.75 |  2,663 |  670 |  661 |
| `prover.rap_constraints.mle_rounds_time_ms` |  319 |  1,276 |  321 |  315 |
| `prover.openings.stacked_reduction_time_ms` |  111 |  444 |  113 |  109 |
| `prover.openings.stacked_reduction.round0_time_ms` |  63.25 |  253 |  64 |  62 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  47 |  188 |  49 |  46 |
| `prover.openings.whir_time_ms` |  37.50 |  150 |  40 |  35 |
...
| `prover.main_trace_commit_time_ms` |  652 |  652 |  652 |  652 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/c5b9459ca4370311385df6bd16588dedf14898d1/sha2_bench-c5b9459ca4370311385df6bd16588dedf14898d1.memory.svg)
...
| app_proof |  |  |  |  |  | 2,261 |  |  | 93 | 11,167,961 | 118.97 | 0 | 9,590 |  | 
| internal_for_leaf |  |  |  | 400 |  |  |  |  |  |  |  |  |  | 400 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 78,342,915 | 375 | 187 | 0 | 11 | 135 | 37 | 37 | 65 | 32 | 0 | 52 | 18 | 33 | 5 | 28 | 188 | 135 | 0 | 2 | 31 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 25,962,119 | 172 | 50 | 0 | 4 | 77 | 24 | 24 | 29 | 22 | 0 | 44 | 20 | 24 | 1 | 22 | 50 | 77 | 0 | 2 | 22 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 17,507,975 | 143 | 34 | 0 | 4 | 64 | 22 | 21 | 24 | 17 | 0 | 44 | 21 | 22 | 1 | 21 | 34 | 64 | 0 | 2 | 16 | 0 | 0 | 
| leaf | 0 | prover | 503,738,490 | 1,130 | 652 | 0 | 42 | 356 | 172 | 171 | 103 | 80 | 0 | 120 | 39 | 80 | 37 | 43 | 652 | 356 | 0 | 6 | 79 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,057,043,293 | 2,238 | 670 | 0 | 187 | 1,415 | 661 | 660 | 321 | 432 | 133 | 152 | 38 | 113 | 63 | 49 | 670 | 1,415 | 0 | 3 | 298 | 0 | 0 | 
| app_proof | prover | 1 | 1,057,042,484 | 1,967 | 525 | 0 | 39 | 1,292 | 666 | 666 | 321 | 304 | 0 | 148 | 37 | 111 | 64 | 46 | 525 | 1,292 | 0 | 3 | 303 | 0 | 0 | 
| app_proof | prover | 2 | 1,057,042,484 | 1,972 | 526 | 0 | 39 | 1,293 | 670 | 669 | 319 | 303 | 0 | 152 | 40 | 111 | 64 | 47 | 526 | 1,293 | 0 | 3 | 302 | 0 | 0 | 
| app_proof | prover | 3 | 1,057,120,972 | 1,957 | 526 | 0 | 41 | 1,285 | 666 | 665 | 315 | 303 | 0 | 144 | 35 | 109 | 62 | 46 | 527 | 1,285 | 0 | 3 | 303 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 168 | 2,670 | 168 | 163 | 0 | 3 | 100 | 2,851,000 | 33.60 | 
| app_proof | 1 | 58 | 2,279 | 58 | 41 | 0 | 2 | 212 | 2,851,000 | 37.11 | 
| app_proof | 2 | 81 | 2,279 | 81 | 41 | 0 | 2 | 184 | 2,851,000 | 37.04 | 
| app_proof | 3 | 87 | 2,261 | 87 | 41 | 0 | 2 | 175 | 2,614,961 | 36.93 | 

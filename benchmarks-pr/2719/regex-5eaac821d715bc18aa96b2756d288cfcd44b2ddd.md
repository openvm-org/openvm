...
| `total_proof_time_ms ` |  801 |  1,602 |  887 |  715 |
| `execute_metered_time_ms` |  31 | -          | -          | -          |
| `execute_metered_insns` |  4,090,656 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  130.24 | -          |  130.24 |  130.24 |
| `execute_preflight_insns` |  2,045,328 |  4,090,656 |  2,327,000 |  1,763,656 |
| `execute_preflight_time_ms` |  81.50 |  163 |  87 |  76 |
| `execute_preflight_insn_mi/s` |  34.52 | -          |  36.25 |  32.79 |
| `trace_gen_time_ms   ` |  145.50 |  291 |  146 |  145 |
| `memory_finalize_time_ms` |  1 |  2 |  2 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  471 |  942 |  490 |  452 |
| `prover.main_trace_commit_time_ms` |  126.50 |  253 |  140 |  113 |
| `prover.rap_constraints_time_ms` |  288 |  576 |  291 |  285 |
| `prover.openings_time_ms` |  55.50 |  111 |  58 |  53 |
| `prover.rap_constraints.logup_gkr_time_ms` |  155.50 |  311 |  165 |  146 |
| `prover.rap_constraints.round0_time_ms` |  91.50 |  183 |  102 |  81 |
| `prover.rap_constraints.mle_rounds_time_ms` |  40.50 |  81 |  45 |  36 |
| `prover.openings.stacked_reduction_time_ms` |  32.50 |  65 |  35 |  30 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  378 |  378 |  378 |  378 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/5eaac821d715bc18aa96b2756d288cfcd44b2ddd/regex-5eaac821d715bc18aa96b2756d288cfcd44b2ddd.memory.svg)
...
| app_proof |  |  |  |  |  | 715 |  |  | 31 | 4,090,656 | 130.24 | 0 | 1,648 |  | 
| internal_for_leaf |  |  |  | 249 |  |  |  |  |  |  |  |  |  | 249 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 27,256,571 | 233 | 84 | 0 | 5 | 102 | 31 | 30 | 45 | 25 | 0 | 46 | 19 | 26 | 2 | 23 | 84 | 102 | 0 | 2 | 24 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,703 | 164 | 48 | 0 | 4 | 71 | 24 | 23 | 27 | 19 | 0 | 44 | 21 | 23 | 1 | 21 | 48 | 71 | 0 | 2 | 18 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 143 | 34 | 0 | 4 | 68 | 23 | 22 | 24 | 20 | 0 | 41 | 18 | 22 | 1 | 21 | 34 | 68 | 0 | 2 | 18 | 0 | 0 | 
| leaf | 0 | prover | 79,962,868 | 327 | 130 | 0 | 8 | 138 | 53 | 52 | 37 | 47 | 0 | 58 | 27 | 31 | 6 | 24 | 130 | 138 | 0 | 5 | 46 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 179,663,570 | 490 | 140 | 0 | 10 | 291 | 81 | 80 | 45 | 165 | 0 | 58 | 22 | 35 | 14 | 21 | 140 | 291 | 0 | 3 | 163 | 0 | 0 | 
| app_proof | prover | 1 | 133,369,433 | 452 | 113 | 0 | 17 | 285 | 102 | 102 | 36 | 146 | 0 | 53 | 22 | 30 | 10 | 19 | 113 | 285 | 0 | 3 | 145 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 146 | 887 | 146 | 163 | 2 | 6 | 87 | 2,327,000 | 32.79 | 
| app_proof | 1 | 145 | 715 | 145 | 40 | 0 | 2 | 76 | 1,763,656 | 36.25 | 

...
| `total_proof_time_ms ` |  935.50 |  1,871 |  1,194 |  677 |
| `execute_metered_time_ms` |  24 | -          | -          | -          |
| `execute_metered_insns` |  1,979,971 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  82.25 | -          |  82.25 |  82.25 |
| `execute_preflight_insns` |  989,985.50 |  1,979,971 |  1,168,000 |  811,971 |
| `execute_preflight_time_ms` |  90 |  180 |  128 |  52 |
| `execute_preflight_insn_mi/s` |  34.07 | -          |  35.19 |  32.96 |
| `trace_gen_time_ms   ` |  30.50 |  61 |  45 |  16 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  705 |  1,410 |  919 |  491 |
| `prover.main_trace_commit_time_ms` |  213.50 |  427 |  289 |  138 |
| `prover.rap_constraints_time_ms` |  444.50 |  889 |  578 |  311 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/723e24c1565612abc6c5dd7ad7dcb38a58a05f78/kitchen_sink-723e24c1565612abc6c5dd7ad7dcb38a58a05f78.memory.svg)
...
| app_proof |  |  |  |  |  | 677 |  |  | 24 | 1,979,971 | 82.25 | 0 | 1,900 |  | 
...
| leaf | 0 | 111 | 406 | 110 | 25 | 11 | 20 | 5 | 5 | 
...
| leaf | 0 | prover | 263,565,172 | 295 | 126 | 0 | 1 | 138 | 48 | 47 | 37 | 52 | 0 | 29 | 14 | 15 | 7 | 8 | 126 | 138 | 0 | 2 | 51 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 565,122,580 | 919 | 288 | 0 | 159 | 578 | 344 | 343 | 131 | 102 | 47 | 51 | 13 | 38 | 15 | 22 | 289 | 578 | 0 | 1 | 53 | 0 | 0 | 
| app_proof | prover | 1 | 541,799,820 | 491 | 138 | 0 | 2 | 311 | 180 | 179 | 76 | 53 | 0 | 41 | 14 | 27 | 14 | 13 | 138 | 311 | 0 | 1 | 53 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 45 | 1,194 | 45 | 177 | 0 | 3 | 52 | 1,168,000 | 32.96 | 
| app_proof | 1 | 16 | 677 | 16 | 41 | 0 | 1 | 128 | 811,971 | 35.19 | 

...
| `total_proof_time_ms ` |  2,328 |  13,968 |  2,462 |  2,201 |
...
| `execute_preflight_time_ms` |  247.67 |  1,486 |  340 |  91 |
| `execute_preflight_insn_mi/s` |  31.88 | -          |  32.51 |  29.52 |
| `trace_gen_time_ms   ` |  36.83 |  221 |  52 |  33 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,986 |  11,916 |  2,168 |  1,884 |
| `prover.main_trace_commit_time_ms` |  702.17 |  4,213 |  860 |  669 |
| `prover.rap_constraints_time_ms` |  1,098.17 |  6,589 |  1,193 |  1,027 |
| `prover.openings_time_ms` |  184.33 |  1,106 |  187 |  178 |
| `prover.rap_constraints.logup_gkr_time_ms` |  289.50 |  1,737 |  331 |  252 |
| `prover.rap_constraints.round0_time_ms` |  545.83 |  3,275 |  602 |  515 |
| `prover.rap_constraints.mle_rounds_time_ms` |  261.83 |  1,571 |  273 |  253 |
| `prover.openings.stacked_reduction_time_ms` |  137.33 |  824 |  138 |  135 |
| `prover.openings.stacked_reduction.round0_time_ms` |  83.50 |  501 |  84 |  82 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  53.17 |  319 |  54 |  53 |
| `prover.openings.whir_time_ms` |  46.50 |  279 |  49 |  43 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,201 |  2,402 |  1,622 |  780 |
| `execute_preflight_time_ms` |  5.50 |  11 |  6 |  5 |
| `trace_gen_time_ms   ` |  132.50 |  265 |  176 |  89 |
| `generate_blob_total_time_ms` |  21.50 |  43 |  29 |  14 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,068 |  2,136 |  1,446 |  690 |
| `prover.main_trace_commit_time_ms` |  641 |  1,282 |  902 |  380 |
| `prover.rap_constraints_time_ms` |  327 |  654 |  421 |  233 |
| `prover.openings_time_ms` |  99 |  198 |  122 |  76 |
...
| `prover.openings.stacked_reduction.round0_time_ms` |  30.50 |  61 |  42 |  19 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  24.50 |  49 |  32 |  17 |
| `prover.openings.whir_time_ms` |  42.50 |  85 |  47 |  38 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/7e4e1c1ff82339d6e5fcea5bed3413757f969016/keccak-7e4e1c1ff82339d6e5fcea5bed3413757f969016.memory.svg)
...
| prover.batch_constraints.before_round0 | 12.43 | app_proof.prover.0 |
| frac_sumcheck.gkr_rounds | 12.43 | app_proof.prover.0 |
| prover.batch_constraints.round0 | 12.38 | app_proof.prover.0 |
| prover.batch_constraints.fold_ple_evals | 12.38 | app_proof.prover.0 |
| frac_sumcheck.segment_tree | 12.30 | app_proof.prover.0 |
| prover.gkr_input_evals | 12.30 | app_proof.prover.0 |
...
| app_proof |  |  |  |  |  | 2,201 |  |  | 143 | 14,365,133 | 100.01 | 0 | 14,119 |  | 
| internal_for_leaf |  |  |  | 510 |  |  |  |  |  |  |  |  |  | 511 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 39 | 510 | 39 | 13 | 4 | 2 | 2 | 2 | 
| internal_recursive.0 | 1 | 14 | 170 | 13 | 2 | 1 | 2 | 2 | 2 | 
| internal_recursive.1 | 1 | 10 | 128 | 10 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 176 | 1,622 | 175 | 59 | 29 | 6 | 7 | 7 | 
| leaf | 1 | 89 | 780 | 89 | 30 | 14 | 5 | 8 | 8 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 81,415,156 | 471 | 249 | 0 | 1 | 176 | 50 | 49 | 94 | 31 | 0 | 45 | 21 | 23 | 7 | 16 | 249 | 176 | 0 | 3 | 30 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,943 | 156 | 50 | 0 | 0 | 74 | 25 | 25 | 29 | 18 | 0 | 31 | 22 | 8 | 2 | 6 | 50 | 74 | 0 | 2 | 17 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 |
...
|:---|---:|---:|---:|
| Total |  5.35 |  4.43 |  4.43 |
| app_proof |  3.83 |  2.91 |  2.91 |
| leaf |  0.95 |  0.95 |  0.95 |
...
| `total_proof_time_ms ` |  1,902.50 |  3,805 |  2,882 |  923 |
...
| `execute_preflight_insn_mi/s` |  30.63 | -          |  30.88 |  30.38 |
| `trace_gen_time_ms   ` |  64 |  128 |  93 |  35 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,670 |  3,340 |  2,581 |  759 |
| `prover.main_trace_commit_time_ms` |  596.50 |  1,193 |  964 |  229 |
| `prover.rap_constraints_time_ms` |  935.50 |  1,871 |  1,416 |  455 |
| `prover.openings_time_ms` |  137 |  274 |  200 |  74 |
| `prover.rap_constraints.logup_gkr_time_ms` |  155 |  310 |  222 |  88 |
| `prover.rap_constraints.round0_time_ms` |  558 |  1,116 |  859 |  257 |
| `prover.rap_constraints.mle_rounds_time_ms` |  221.50 |  443 |  335 |  108 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/e582d737ece2c6d8459e952b5ea3774b3986747e/kitchen_sink-e582d737ece2c6d8459e952b5ea3774b3986747e.memory.svg)
...
| app_proof |  |  |  |  |  | 923 |  |  | 24 | 1,979,971 | 81.19 | 0 | 3,834 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 19 | 281 | 19 | 6 | 1 | 2 | 2 | 2 | 
| internal_recursive.0 | 1 | 10 | 158 | 10 | 1 | 0 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 9 | 132 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 117 | 950 | 117 | 24 | 10 | 18 | 2 | 2 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,577,979 | 261 | 119 | 0 | 0 | 108 | 35 | 34 | 52 | 20 | 0 | 33 | 19 | 13 | 3 | 9 | 119 | 108 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,767 | 147 | 47 | 0 | 0 | 69 | 26 | 25 | 28 | 14 | 0 | 30 | 21 | 8 | 1 | 6 | 47 | 69 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 122 | 31 | 0 | 0 | 63 | 25 | 24 | 24 | 13 | 0 | 26 | 19 | 7 | 1 | 5 | 32 | 63 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 260,613,236 | 833 | 402 | 0 | 1 | 352 | 136 | 135 | 78 | 137 | 0 | 77 | 36 | 40 | 21 | 18 | 403 | 352 | 0 | 6 | 137 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 902,782,844 | 2,581 | 964 | 0 | 305 | 1,416 | 859 | 858 | 335 | 222 | 67 | 200 | 40 | 159 | 88 | 70 | 964 | 1,416 | 0 | 4 | 153 | 0 | 0 | 
| app_proof | prover | 1 | 279,963,980 | 759 | 229 | 0 | 1 | 455 | 257 | 257 | 108 | 88 | 0 | 74 | 28 | 46 | 26 | 20 | 229 | 455 | 0 | 3 | 88 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 93 | 2,882 | 93 | 136 | 0 | 4 | 70 | 1,445,000 | 30.38 | 
| app_proof | 1 | 35 | 923 | 35 | 41 | 0 | 2 | 87 | 534,971 | 30.88 | 

...
|:---|---:|---:|---:|
| Total |  11.07 |  4.57 |  4.56 |
| app_proof |  8.99 |  2.49 |  2.49 |
| leaf |  1.40 |  1.40 |  1.40 |
...
| `total_proof_time_ms ` |  2,223.25 |  8,893 |  2,392 |  2,142 |
...
| `execute_preflight_time_ms` |  166.50 |  666 |  212 |  101 |
| `execute_preflight_insn_mi/s` |  33.47 | -          |  34.59 |  31.55 |
| `trace_gen_time_ms   ` |  57.75 |  231 |  63 |  54 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,933.25 |  7,733 |  2,091 |  1,873 |
| `prover.main_trace_commit_time_ms` |  532.25 |  2,129 |  618 |  502 |
| `prover.rap_constraints_time_ms` |  1,262.75 |  5,051 |  1,333 |  1,232 |
| `prover.openings_time_ms` |  137.25 |  549 |  139 |  134 |
| `prover.rap_constraints.logup_gkr_time_ms` |  354.75 |  1,419 |  441 |  325 |
| `prover.rap_constraints.round0_time_ms` |  664.75 |  2,659 |  673 |  651 |
| `prover.rap_constraints.mle_rounds_time_ms` |  242 |  968 |  245 |  240 |
| `prover.openings.stacked_reduction_time_ms` |  97.75 |  391 |  100 |  96 |
...
| `prover.openings.whir_time_ms` |  39.25 |  157 |  40 |  38 |
...
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,253 |  1,253 |  1,253 |  1,253 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/e582d737ece2c6d8459e952b5ea3774b3986747e/sha2_bench-e582d737ece2c6d8459e952b5ea3774b3986747e.memory.svg)
...
| app_proof |  |  |  |  |  | 2,142 |  |  | 96 | 11,167,961 | 115.93 | 0 | 8,995 |  | 
...
| leaf | 0 | 146 | 1,399 | 145 | 51 | 22 | 2 | 6 | 6 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 61,220,667 | 354 | 183 | 0 | 0 | 129 | 37 | 37 | 63 | 27 | 0 | 40 | 22 | 18 | 5 | 12 | 184 | 129 | 0 | 3 | 26 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,943 | 151 | 49 | 0 | 0 | 73 | 26 | 26 | 29 | 17 | 0 | 27 | 18 | 8 | 1 | 6 | 49 | 73 | 0 | 2 | 16 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 127 | 31 | 0 | 0 | 63 | 24 | 23 | 24 | 13 | 0 | 32 | 24 | 7 | 1 | 5 | 31 | 63 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 425,192,422 | 1,253 | 793 | 0 | 154 | 348 | 170 | 169 | 103 | 74 | 0 | 111 | 47 | 64 | 36 | 27 | 793 | 348 | 0 | 6 | 73 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 640,057,593 | 2,091 | 618 | 0 | 117 | 1,333 | 651 | 651 | 240 | 441 | 130 | 139 | 39 | 100 | 61 | 39 | 618 | 1,333 | 0 | 3 | 309 | 0 | 0 | 
| app_proof | prover | 1 | 640,057,356 | 1,882 | 503 | 0 | 2 | 1,239 | 671 | 670 | 241 | 326 | 0 | 139 | 40 | 98 | 59 | 38 | 503 | 1,239 | 0 | 3 | 325 | 0 | 0 | 
| app_proof | prover | 2 | 640,057,356 | 1,887 | 502 | 0 | 2 | 1,247 | 673 | 673 | 245 | 327 | 0 | 137 | 40 | 97 | 59 | 38 | 502 | 1,247 | 0 | 4 | 324 | 0 | 0 | 
| app_proof | prover | 3 | 640,057,588 | 1,873 | 505 | 0 | 2 | 1,232 | 664 | 663 | 242 | 325 | 0 | 134 | 38 | 96 | 58 | 38 | 506 | 1,232 | 0 | 3 | 324 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 63 | 2,392 | 63 | 135 | 0 | 3 | 101 | 2,851,000 | 31.55 | 
| app_proof | 1 | 57 | 2,193 | 57 | 41 | 0 | 1 | 212 | 2,851,000 | 34.51 | 
| app_proof | 2 | 57 | 2,166 | 57 | 41 | 0 | 1 | 180 | 2,851,000 | 34.59 | 
| app_proof | 3 | 54 | 2,142 | 54 | 41 | 0 | 1 | 173 | 2,614,961 | 33.23 | 

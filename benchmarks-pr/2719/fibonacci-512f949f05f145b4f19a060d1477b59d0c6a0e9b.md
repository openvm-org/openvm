...
|:---|---:|---:|---:|
| Total |  2.37 |  1.75 |  1.75 |
| app_proof |  1.39 |  0.77 |  0.77 |
| leaf |  0.39 |  0.39 |  0.39 |
...
| `total_proof_time_ms ` |  687 |  1,374 |  753 |  621 |
...
| `execute_preflight_time_ms` |  67 |  134 |  81 |  53 |
| `execute_preflight_insn_mi/s` |  36.84 | -          |  38.70 |  34.97 |
| `trace_gen_time_ms   ` |  21.50 |  43 |  22 |  21 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  509.50 |  1,019 |  514 |  505 |
| `prover.main_trace_commit_time_ms` |  96.50 |  193 |  97 |  96 |
| `prover.rap_constraints_time_ms` |  312.50 |  625 |  316 |  309 |
| `prover.openings_time_ms` |  99.50 |  199 |  101 |  98 |
| `prover.rap_constraints.logup_gkr_time_ms` |  227.50 |  455 |  228 |  227 |
| `prover.rap_constraints.round0_time_ms` |  61.50 |  123 |  64 |  59 |
| `prover.rap_constraints.mle_rounds_time_ms` |  22.50 |  45 |  23 |  22 |
...
| `prover.openings.whir_time_ms` |  80.50 |  161 |  82 |  79 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/512f949f05f145b4f19a060d1477b59d0c6a0e9b/fibonacci-512f949f05f145b4f19a060d1477b59d0c6a0e9b.memory.svg)
...
| app_proof |  |  |  |  |  | 621 |  |  | 20 | 4,000,051 | 192.94 | 0 | 1,401 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 27,277,885 | 256 | 81 | 0 | 0 | 96 | 31 | 30 | 45 | 19 | 0 | 77 | 66 | 11 | 2 | 8 | 82 | 96 | 0 | 3 | 18 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 166 | 46 | 0 | 0 | 66 | 24 | 24 | 27 | 13 | 0 | 54 | 45 | 8 | 1 | 6 | 46 | 66 | 0 | 3 | 12 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 134 | 31 | 0 | 0 | 61 | 23 | 22 | 24 | 13 | 0 | 41 | 34 | 7 | 1 | 5 | 31 | 61 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 74,737,496 | 347 | 121 | 0 | 0 | 114 | 51 | 50 | 34 | 28 | 0 | 110 | 96 | 14 | 6 | 8 | 122 | 114 | 0 | 6 | 27 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 119,796,216 | 514 | 96 | 0 | 0 | 316 | 64 | 64 | 23 | 228 | 0 | 101 | 82 | 19 | 10 | 8 | 96 | 316 | 0 | 3 | 226 | 0 | 0 | 
| app_proof | prover | 1 | 119,795,168 | 505 | 97 | 0 | 0 | 309 | 59 | 58 | 22 | 227 | 0 | 98 | 79 | 18 | 10 | 7 | 97 | 309 | 0 | 3 | 226 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 2 | 22 | 753 | 22 | 135 | 3,176,285,986 | 1,768,942 | 3,178,054,928 | 2,097,152 | 0 | 3 | 81 | 2,621,000 | 34.97 | 
| app_proof | 1 | 1 | 21 | 621 | 21 | 41 | 1,707,679,788 | 1,468,951,987 | 3,176,631,775 | 2,097,152 | 0 | 2 | 53 | 1,379,051 | 38.70 | 

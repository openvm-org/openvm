...
| `total_proof_time_ms ` |  2,281.83 |  13,691 |  2,449 |  2,191 |
| `compile_metered_time_ms` |  3 |  3 |  3 |  3 |
| `execute_metered_time_ms` |  141 | -          | -          | -          |
| `execute_metered_insns` |  14,365,133 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  101.41 | -          |  101.41 |  101.41 |
| `execute_preflight_insns` |  2,394,188.83 |  14,365,133 |  2,413,000 |  2,300,133 |
| `execute_preflight_time_ms` |  245.33 |  1,472 |  336 |  90 |
| `execute_preflight_insn_mi/s` |  32.03 | -          |  32.74 |  29.34 |
| `trace_gen_time_ms   ` |  36.83 |  221 |  52 |  33 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,941 |  11,646 |  2,168 |  1,877 |
| `prover.main_trace_commit_time_ms` |  697.50 |  4,185 |  858 |  662 |
| `prover.rap_constraints_time_ms` |  1,061.33 |  6,368 |  1,130 |  1,028 |
| `prover.openings_time_ms` |  181 |  1,086 |  188 |  178 |
| `prover.rap_constraints.logup_gkr_time_ms` |  288.50 |  1,731 |  350 |  258 |
| `prover.rap_constraints.round0_time_ms` |  512.17 |  3,073 |  516 |  507 |
| `prover.rap_constraints.mle_rounds_time_ms` |  260 |  1,560 |  268 |  256 |
...
| `prover.openings.whir_time_ms` |  45.33 |  272 |  53 |  43 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,194 |  2,388 |  1,618 |  770 |
| `execute_preflight_time_ms` |  5.50 |  11 |  6 |  5 |
| `trace_gen_time_ms   ` |  132 |  264 |  176 |  88 |
| `generate_blob_total_time_ms` |  21.50 |  43 |  29 |  14 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,061 |  2,122 |  1,441 |  681 |
| `prover.main_trace_commit_time_ms` |  640.50 |  1,281 |  904 |  377 |
| `prover.rap_constraints_time_ms` |  322.50 |  645 |  414 |  231 |
| `prover.openings_time_ms` |  97.50 |  195 |  123 |  72 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/2995a72183937d2e96f96e7c42a7ccfa1c650c07/keccak-2995a72183937d2e96f96e7c42a7ccfa1c650c07.memory.svg)
...
| app_proof |  |  |  |  |  | 2,191 |  |  | 141 | 14,365,133 | 101.41 | 0 | 13,838 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 38 | 505 | 38 | 13 | 4 | 2 | 2 | 2 | 
| internal_recursive.0 | 1 | 14 | 162 | 13 | 2 | 1 | 2 | 2 | 2 | 
| internal_recursive.1 | 1 | 10 | 129 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 176 | 1,618 | 175 | 60 | 29 | 6 | 7 | 7 | 
| leaf | 1 | 88 | 770 | 88 | 30 | 14 | 5 | 7 | 7 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 81,415,156 | 466 | 245 | 0 | 1 | 174 | 50 | 49 | 92 | 31 | 0 | 45 | 21 | 24 | 8 | 16 | 245 | 174 | 0 | 3 | 30 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,943 | 148 | 48 | 0 | 0 | 74 | 25 | 24 | 29 | 18 | 0 | 25 | 16 | 8 | 2 | 6 | 48 | 74 | 0 | 2 | 17 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 119 | 32 | 0 | 0 | 60 | 22 | 22 | 24 | 13 | 0 | 26 | 19 | 7 | 1 | 5 | 32 | 60 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 476,572,646 | 1,441 | 903 | 0 | 179 | 414 | 205 | 204 | 122 | 86 | 0 | 123 | 49 | 73 | 41 | 32 | 904 | 414 | 0 | 7 | 85 | 0 | 0 | 
| leaf | 1 | prover | 240,252,724 | 681 | 376 | 0 | 1 | 231 | 111 | 110 | 68 | 51 | 0 | 72 | 35 | 37 | 20 | 17 | 377 | 231 | 0 | 6 | 50 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 840,496,780 | 2,168 | 858 | 0 | 197 | 1,130 | 511 | 511 | 268 | 350 | 97 | 179 | 43 | 136 | 82 | 53 | 858 | 1,130 | 0 | 4 | 251 | 0 | 0 | 
| app_proof | prover | 1 | 840,496,780 | 1,959 | 662 | 0 | 3 | 1,117 | 507 | 506 | 266 | 343 | 103 | 178 | 43 | 135 | 83 | 52 | 662 | 1,117 | 0 | 4 | 239 | 0 | 0 | 
| app_proof | prover | 2 | 840,496,780 | 1,884 | 665 | 0 | 3 | 1,030 | 515 | 514 | 257 | 258 | 0 | 188 | 53 | 134 | 82 | 52 | 665 | 1,030 | 0 | 4 | 257 | 0 | 0 | 
| app_proof | prover | 3 | 840,496,780 | 1,877 | 666 | 0 | 3 | 1,029 | 513 | 512 | 256 | 259 | 0 | 181 | 45 | 136 | 83 | 53 | 666 | 1,029 | 0 | 4 | 258 | 0 | 0 | 
| app_proof | prover | 4 | 840,496,780 | 1,880 | 666 | 0 | 3 | 1,034 | 516 | 515 | 257 | 261 | 0 | 178 | 43 | 135 | 82 | 52 | 667 | 1,034 | 0 | 4 | 258 | 0 | 0 | 
| app_proof | prover | 5 | 840,496,780 | 1,878 | 667 | 0 | 3 | 1,028 | 511 | 510 | 256 | 260 | 0 | 182 | 45 | 137 | 83 | 53 | 667 | 1,028 | 0 | 4 | 259 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 52 | 2,449 | 52 | 137 | 0 | 3 | 90 | 2,413,000 | 29.34 | 
| app_proof | 1 | 34 | 2,371 | 34 | 41 | 0 | 1 | 336 | 2,413,000 | 32.52 | 
| app_proof | 2 | 34 | 2,230 | 34 | 41 | 0 | 1 | 269 | 2,413,000 | 32.74 | 
| app_proof | 3 | 34 | 2,223 | 34 | 41 | 0 | 1 | 269 | 2,413,000 | 32.59 | 
| app_proof | 4 | 34 | 2,227 | 34 | 41 | 0 | 1 | 271 | 2,413,000 | 32.31 | 
| app_proof | 5 | 33 | 2,191 | 33 | 41 | 0 | 1 | 237 | 2,300,133 | 32.65 | 

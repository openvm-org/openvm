...
|:---|---:|---:|---:|
| Total |  16.99 |  5.05 |  5.05 |
| app_proof |  13.85 |  2.71 |  2.71 |
| leaf |  2.27 |  1.47 |  1.47 |
...
| `total_proof_time_ms ` |  2,285.50 |  13,713 |  2,575 |  2,192 |
...
| `execute_preflight_time_ms` |  236.83 |  1,421 |  318 |  90 |
| `execute_preflight_insn_mi/s` |  33.27 | -          |  34.01 |  30.51 |
| `trace_gen_time_ms   ` |  54.33 |  326 |  156 |  34 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,932.50 |  11,595 |  2,166 |  1,883 |
| `prover.main_trace_commit_time_ms` |  719.83 |  4,319 |  885 |  685 |
| `prover.rap_constraints_time_ms` |  1,023.50 |  6,141 |  1,091 |  1,006 |
| `prover.openings_time_ms` |  188.33 |  1,130 |  191 |  185 |
| `prover.rap_constraints.logup_gkr_time_ms` |  182 |  1,092 |  235 |  171 |
| `prover.rap_constraints.round0_time_ms` |  523.50 |  3,141 |  527 |  519 |
| `prover.rap_constraints.mle_rounds_time_ms` |  317 |  1,902 |  336 |  312 |
| `prover.openings.stacked_reduction_time_ms` |  146.50 |  879 |  148 |  144 |
| `prover.openings.stacked_reduction.round0_time_ms` |  84.83 |  509 |  87 |  82 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  61.33 |  368 |  62 |  61 |
| `prover.openings.whir_time_ms` |  41.17 |  247 |  44 |  40 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,136 |  2,272 |  1,470 |  802 |
| `execute_preflight_time_ms` |  5.50 |  11 |  6 |  5 |
| `trace_gen_time_ms   ` |  137.50 |  275 |  183 |  92 |
| `generate_blob_total_time_ms` |  24.50 |  49 |  33 |  16 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  997.50 |  1,995 |  1,286 |  709 |
| `prover.main_trace_commit_time_ms` |  558 |  1,116 |  735 |  381 |
| `prover.rap_constraints_time_ms` |  331 |  662 |  424 |  238 |
| `prover.openings_time_ms` |  107.50 |  215 |  126 |  89 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/d6e8a8d3600be21da1af37598f2ca06930c7186b/keccak-d6e8a8d3600be21da1af37598f2ca06930c7186b.memory.svg)
...
| app_proof |  |  |  |  |  | 2,192 |  |  | 139 | 14,365,133 | 103.28 | 0 | 13,860 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 81,415,028 | 491 | 251 | 0 | 14 | 180 | 49 | 49 | 92 | 37 | 0 | 59 | 20 | 39 | 7 | 31 | 252 | 180 | 0 | 2 | 36 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,879 | 171 | 52 | 0 | 4 | 78 | 24 | 24 | 29 | 24 | 0 | 40 | 16 | 24 | 1 | 22 | 52 | 78 | 0 | 2 | 23 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 142 | 34 | 0 | 4 | 68 | 24 | 23 | 24 | 19 | 0 | 39 | 16 | 22 | 1 | 21 | 34 | 68 | 0 | 2 | 18 | 0 | 0 | 
| leaf | 0 | prover | 476,578,662 | 1,286 | 735 | 0 | 47 | 424 | 206 | 206 | 126 | 90 | 0 | 126 | 39 | 87 | 41 | 46 | 735 | 424 | 0 | 6 | 89 | 0 | 0 | 
| leaf | 1 | prover | 240,255,732 | 709 | 380 | 0 | 24 | 238 | 111 | 110 | 70 | 56 | 0 | 89 | 36 | 53 | 20 | 32 | 381 | 238 | 0 | 6 | 56 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 857,743,372 | 2,166 | 885 | 0 | 259 | 1,091 | 519 | 518 | 336 | 235 | 65 | 190 | 41 | 148 | 87 | 61 | 885 | 1,091 | 0 | 3 | 169 | 0 | 0 | 
| app_proof | prover | 1 | 857,820,172 | 1,884 | 685 | 0 | 59 | 1,006 | 521 | 521 | 312 | 172 | 0 | 191 | 44 | 147 | 85 | 62 | 685 | 1,006 | 0 | 3 | 171 | 0 | 0 | 
| app_proof | prover | 2 | 857,820,172 | 1,885 | 684 | 0 | 59 | 1,011 | 523 | 522 | 315 | 172 | 0 | 188 | 40 | 147 | 86 | 61 | 685 | 1,011 | 0 | 3 | 171 | 0 | 0 | 
| app_proof | prover | 3 | 857,820,172 | 1,883 | 687 | 0 | 59 | 1,010 | 525 | 525 | 313 | 171 | 0 | 185 | 41 | 144 | 82 | 61 | 688 | 1,010 | 0 | 4 | 170 | 0 | 0 | 
| app_proof | prover | 4 | 857,820,172 | 1,890 | 688 | 0 | 59 | 1,012 | 527 | 527 | 313 | 171 | 0 | 189 | 41 | 147 | 84 | 62 | 688 | 1,012 | 0 | 3 | 170 | 0 | 0 | 
| app_proof | prover | 5 | 857,743,372 | 1,887 | 688 | 0 | 58 | 1,011 | 526 | 525 | 313 | 171 | 0 | 187 | 40 | 146 | 85 | 61 | 688 | 1,011 | 0 | 3 | 171 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 156 | 2,575 | 156 | 161 | 0 | 3 | 90 | 2,413,000 | 30.51 | 
| app_proof | 1 | 34 | 2,277 | 34 | 41 | 0 | 1 | 318 | 2,413,000 | 33.69 | 
| app_proof | 2 | 34 | 2,222 | 34 | 41 | 0 | 1 | 262 | 2,413,000 | 33.78 | 
| app_proof | 3 | 34 | 2,220 | 34 | 41 | 0 | 1 | 261 | 2,413,000 | 34.01 | 
| app_proof | 4 | 34 | 2,227 | 34 | 41 | 0 | 1 | 261 | 2,413,000 | 33.71 | 
| app_proof | 5 | 34 | 2,192 | 34 | 41 | 0 | 2 | 229 | 2,300,133 | 33.93 | 

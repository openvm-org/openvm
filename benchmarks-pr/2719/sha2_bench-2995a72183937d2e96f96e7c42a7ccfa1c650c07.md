...
|:---|---:|---:|---:|
| Total |  11.17 |  4.63 |  4.63 |
| app_proof |  9.07 |  2.53 |  2.53 |
| leaf |  1.42 |  1.42 |  1.42 |
...
| `total_proof_time_ms ` |  2,243.50 |  8,974 |  2,429 |  2,160 |
...
| `execute_preflight_time_ms` |  166 |  664 |  208 |  102 |
| `execute_preflight_insn_mi/s` |  33.90 | -          |  34.86 |  31.31 |
| `trace_gen_time_ms   ` |  58.25 |  233 |  65 |  54 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,953.25 |  7,813 |  2,126 |  1,890 |
| `prover.main_trace_commit_time_ms` |  538.50 |  2,154 |  626 |  509 |
| `prover.rap_constraints_time_ms` |  1,274.75 |  5,099 |  1,357 |  1,238 |
| `prover.openings_time_ms` |  139 |  556 |  142 |  136 |
| `prover.rap_constraints.logup_gkr_time_ms` |  357.75 |  1,431 |  445 |  328 |
| `prover.rap_constraints.round0_time_ms` |  667.50 |  2,670 |  672 |  662 |
| `prover.rap_constraints.mle_rounds_time_ms` |  248.25 |  993 |  252 |  243 |
| `prover.openings.stacked_reduction_time_ms` |  99 |  396 |  101 |  98 |
| `prover.openings.stacked_reduction.round0_time_ms` |  59.50 |  238 |  61 |  59 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  38.50 |  154 |  39 |  38 |
| `prover.openings.whir_time_ms` |  39.75 |  159 |  42 |  38 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/2995a72183937d2e96f96e7c42a7ccfa1c650c07/sha2_bench-2995a72183937d2e96f96e7c42a7ccfa1c650c07.memory.svg)
...
| app_proof |  |  |  |  |  | 2,160 |  |  | 98 | 11,167,961 | 112.93 | 0 | 9,079 |  | 
...
| leaf | 0 | 145 | 1,418 | 145 | 51 | 22 | 2 | 6 | 6 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 61,220,667 | 355 | 185 | 0 | 0 | 131 | 38 | 38 | 64 | 27 | 0 | 38 | 19 | 18 | 5 | 12 | 185 | 131 | 0 | 2 | 26 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,943 | 157 | 49 | 0 | 0 | 73 | 25 | 24 | 29 | 18 | 0 | 33 | 25 | 8 | 2 | 6 | 50 | 73 | 0 | 2 | 16 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 123 | 32 | 0 | 0 | 61 | 23 | 22 | 24 | 13 | 0 | 29 | 22 | 7 | 1 | 5 | 32 | 61 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 425,192,422 | 1,272 | 806 | 0 | 156 | 355 | 174 | 173 | 104 | 76 | 0 | 110 | 44 | 65 | 36 | 29 | 806 | 355 | 0 | 7 | 75 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 640,057,593 | 2,126 | 626 | 0 | 118 | 1,357 | 662 | 662 | 248 | 445 | 132 | 142 | 41 | 101 | 61 | 39 | 626 | 1,357 | 0 | 4 | 312 | 0 | 0 | 
| app_proof | prover | 1 | 640,057,356 | 1,897 | 509 | 0 | 2 | 1,250 | 670 | 670 | 250 | 329 | 0 | 137 | 38 | 98 | 59 | 38 | 509 | 1,250 | 0 | 3 | 327 | 0 | 0 | 
| app_proof | prover | 2 | 640,057,356 | 1,900 | 509 | 0 | 2 | 1,254 | 672 | 671 | 252 | 329 | 0 | 136 | 38 | 98 | 59 | 38 | 509 | 1,254 | 0 | 3 | 328 | 0 | 0 | 
| app_proof | prover | 3 | 640,057,588 | 1,890 | 510 | 0 | 2 | 1,238 | 666 | 666 | 243 | 328 | 0 | 141 | 42 | 99 | 59 | 39 | 510 | 1,238 | 0 | 3 | 327 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 65 | 2,429 | 65 | 135 | 0 | 4 | 102 | 2,851,000 | 31.31 | 
| app_proof | 1 | 57 | 2,204 | 57 | 41 | 0 | 1 | 208 | 2,851,000 | 34.72 | 
| app_proof | 2 | 57 | 2,181 | 57 | 41 | 0 | 1 | 181 | 2,851,000 | 34.86 | 
| app_proof | 3 | 54 | 2,160 | 54 | 41 | 0 | 1 | 173 | 2,614,961 | 34.68 | 

...
|:---|---:|---:|---:|
| Total |  13.32 |  5.60 |  5.60 |
| app_proof |  10.56 |  2.84 |  2.84 |
| leaf |  1.93 |  1.93 |  1.93 |
...
| `total_proof_time_ms ` |  2,609.25 |  10,437 |  2,716 |  2,555 |
...
| `execute_preflight_time_ms` |  168 |  672 |  213 |  100 |
| `execute_preflight_insn_mi/s` |  35.20 | -          |  36.26 |  32.55 |
| `trace_gen_time_ms   ` |  59.25 |  237 |  65 |  55 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  2,313.50 |  9,254 |  2,409 |  2,281 |
| `prover.main_trace_commit_time_ms` |  616.75 |  2,467 |  621 |  614 |
| `prover.rap_constraints_time_ms` |  1,224 |  4,896 |  1,227 |  1,218 |
| `prover.openings_time_ms` |  471.75 |  1,887 |  562 |  440 |
| `prover.rap_constraints.logup_gkr_time_ms` |  308.50 |  1,234 |  309 |  308 |
| `prover.rap_constraints.round0_time_ms` |  668.75 |  2,675 |  671 |  662 |
| `prover.rap_constraints.mle_rounds_time_ms` |  245.50 |  982 |  247 |  244 |
| `prover.openings.stacked_reduction_time_ms` |  97.75 |  391 |  98 |  97 |
| `prover.openings.stacked_reduction.round0_time_ms` |  58.50 |  234 |  59 |  58 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  38.25 |  153 |  39 |  38 |
| `prover.openings.whir_time_ms` |  373.50 |  1,494 |  463 |  342 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/53784108cf93718b7acd062c0b5a910a82f40156/sha2_bench-53784108cf93718b7acd062c0b5a910a82f40156.memory.svg)
...
| app_proof |  |  |  |  |  | 2,555 |  |  | 126 | 11,167,961 | 88.07 | 0 | 10,570 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 61,220,667 | 456 | 183 | 0 | 0 | 128 | 37 | 37 | 63 | 27 | 0 | 143 | 124 | 18 | 5 | 13 | 183 | 128 | 0 | 4 | 26 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,943 | 181 | 50 | 0 | 0 | 73 | 25 | 24 | 29 | 18 | 0 | 57 | 48 | 8 | 2 | 6 | 50 | 73 | 0 | 3 | 17 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 139 | 31 | 0 | 0 | 62 | 23 | 22 | 25 | 13 | 0 | 45 | 37 | 7 | 1 | 5 | 31 | 62 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 425,192,422 | 1,783 | 804 | 0 | 89 | 347 | 169 | 168 | 102 | 74 | 0 | 631 | 566 | 64 | 36 | 27 | 804 | 347 | 0 | 9 | 73 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 640,057,593 | 2,409 | 621 | 0 | 71 | 1,226 | 671 | 670 | 245 | 308 | 0 | 562 | 463 | 98 | 58 | 39 | 621 | 1,226 | 0 | 4 | 306 | 0 | 0 | 
| app_proof | prover | 1 | 640,057,356 | 2,282 | 614 | 0 | 0 | 1,227 | 671 | 671 | 247 | 308 | 0 | 441 | 342 | 98 | 59 | 38 | 614 | 1,227 | 0 | 5 | 307 | 0 | 0 | 
| app_proof | prover | 2 | 640,057,356 | 2,281 | 614 | 0 | 0 | 1,225 | 671 | 671 | 244 | 309 | 0 | 440 | 343 | 97 | 58 | 38 | 614 | 1,225 | 0 | 4 | 308 | 0 | 0 | 
| app_proof | prover | 3 | 640,057,588 | 2,282 | 618 | 0 | 0 | 1,218 | 662 | 661 | 246 | 309 | 0 | 444 | 346 | 98 | 59 | 38 | 618 | 1,218 | 0 | 5 | 308 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 65 | 2,716 | 65 | 140 | 5,529,436,044 | 2,165,730,336 | 7,695,166,380 | 2,097,152 | 0 | 3 | 100 | 2,851,000 | 32.55 | 
| app_proof | 1 | 58 | 2,597 | 58 | 43 | 5,529,347,520 | 2,165,557,968 | 7,694,905,488 | 2,097,152 | 0 | 1 | 213 | 2,851,000 | 36.26 | 
| app_proof | 2 | 59 | 2,569 | 59 | 43 | 5,529,349,296 | 2,165,556,192 | 7,694,905,488 | 2,097,152 | 0 | 1 | 185 | 2,851,000 | 35.77 | 
| app_proof | 3 | 55 | 2,555 | 55 | 43 | 5,077,435,956 | 2,617,472,316 | 7,694,908,272 | 2,097,152 | 0 | 1 | 174 | 2,614,961 | 36.22 | 

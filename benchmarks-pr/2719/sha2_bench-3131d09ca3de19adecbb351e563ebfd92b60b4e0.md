...
|:---|---:|---:|---:|
| Total |  11.23 |  4.65 |  4.65 |
| app_proof |  9.12 |  2.54 |  2.54 |
| leaf |  1.43 |  1.43 |  1.43 |
...
| `total_proof_time_ms ` |  2,255.75 |  9,023 |  2,438 |  2,172 |
| `execute_metered_time_ms` |  98 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  113.74 | -          |  113.74 |  113.74 |
| `execute_preflight_insns` |  2,791,990.25 |  11,167,961 |  2,851,000 |  2,614,961 |
| `execute_preflight_time_ms` |  165.25 |  661 |  209 |  101 |
| `execute_preflight_insn_mi/s` |  33.79 | -          |  34.63 |  31.58 |
| `trace_gen_time_ms   ` |  58.25 |  233 |  65 |  54 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,966.25 |  7,865 |  2,135 |  1,905 |
| `prover.main_trace_commit_time_ms` |  541 |  2,164 |  628 |  512 |
| `prover.rap_constraints_time_ms` |  1,284.50 |  5,138 |  1,367 |  1,252 |
| `prover.openings_time_ms` |  139.50 |  558 |  141 |  139 |
| `prover.rap_constraints.logup_gkr_time_ms` |  359.50 |  1,438 |  446 |  330 |
| `prover.rap_constraints.round0_time_ms` |  671.75 |  2,687 |  675 |  666 |
| `prover.rap_constraints.mle_rounds_time_ms` |  252 |  1,008 |  254 |  250 |
| `prover.openings.stacked_reduction_time_ms` |  99 |  396 |  102 |  97 |
| `prover.openings.stacked_reduction.round0_time_ms` |  59.50 |  238 |  62 |  57 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  38.75 |  155 |  39 |  38 |
| `prover.openings.whir_time_ms` |  40.25 |  161 |  42 |  39 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,426 |  1,426 |  1,426 |  1,426 |
...
| `prover.main_trace_commit_time_ms` |  809 |  809 |  809 |  809 |
| `prover.rap_constraints_time_ms` |  360 |  360 |  360 |  360 |
| `prover.openings_time_ms` |  110 |  110 |  110 |  110 |
| `prover.rap_constraints.logup_gkr_time_ms` |  76 |  76 |  76 |  76 |
| `prover.rap_constraints.round0_time_ms` |  176 |  176 |  176 |  176 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/3131d09ca3de19adecbb351e563ebfd92b60b4e0/sha2_bench-3131d09ca3de19adecbb351e563ebfd92b60b4e0.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 76 | 9 |  |  | 0 |  | 364 | 9 |  |  |  |  |  |  | 
| app_proof |  |  |  |  |  | 2,172 |  |  | 98 | 11,167,961 | 113.74 | 0 | 9,127 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 24 | 384 | 24 | 7 | 2 | 2 | 3 | 3 | 
| internal_recursive.0 | 1 | 12 | 163 | 12 | 1 | 0 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 9 | 137 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 145 | 1,426 | 145 | 51 | 22 | 2 | 6 | 6 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 61,220,667 | 359 | 185 | 0 | 0 | 134 | 39 | 39 | 67 | 27 | 0 | 38 | 19 | 19 | 5 | 13 | 186 | 134 | 0 | 3 | 26 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,943 | 150 | 48 | 0 | 0 | 74 | 25 | 24 | 30 | 18 | 0 | 27 | 19 | 8 | 2 | 6 | 48 | 74 | 0 | 2 | 17 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 127 | 32 | 0 | 0 | 61 | 23 | 22 | 24 | 13 | 0 | 32 | 25 | 7 | 1 | 5 | 32 | 61 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 425,192,422 | 1,280 | 809 | 0 | 157 | 360 | 176 | 175 | 107 | 76 | 0 | 110 | 44 | 65 | 36 | 29 | 809 | 360 | 0 | 7 | 75 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 640,057,593 | 2,135 | 627 | 0 | 117 | 1,367 | 666 | 666 | 253 | 446 | 131 | 139 | 42 | 97 | 57 | 39 | 628 | 1,367 | 0 | 4 | 314 | 0 | 0 | 
| app_proof | prover | 1 | 640,057,356 | 1,912 | 512 | 0 | 2 | 1,258 | 675 | 675 | 251 | 331 | 0 | 141 | 39 | 102 | 62 | 39 | 512 | 1,258 | 0 | 4 | 329 | 0 | 0 | 
| app_proof | prover | 2 | 640,057,356 | 1,913 | 512 | 0 | 2 | 1,261 | 675 | 675 | 254 | 331 | 0 | 139 | 39 | 99 | 60 | 39 | 512 | 1,261 | 0 | 4 | 329 | 0 | 0 | 
| app_proof | prover | 3 | 640,057,588 | 1,905 | 512 | 0 | 2 | 1,252 | 671 | 670 | 250 | 330 | 0 | 139 | 41 | 98 | 59 | 38 | 512 | 1,252 | 0 | 3 | 329 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 65 | 2,438 | 65 | 135 | 0 | 3 | 101 | 2,851,000 | 31.58 | 
| app_proof | 1 | 57 | 2,220 | 57 | 41 | 0 | 1 | 209 | 2,851,000 | 34.37 | 
| app_proof | 2 | 57 | 2,193 | 57 | 41 | 0 | 1 | 180 | 2,851,000 | 34.58 | 
| app_proof | 3 | 54 | 2,172 | 54 | 41 | 0 | 1 | 171 | 2,614,961 | 34.63 | 

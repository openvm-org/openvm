...
|:---|---:|---:|---:|
| Total |  11.18 |  4.64 |  4.64 |
| app_proof |  9.08 |  2.54 |  2.54 |
| leaf |  1.42 |  1.42 |  1.42 |
...
| `total_proof_time_ms ` |  2,246.25 |  8,985 |  2,440 |  2,155 |
| `execute_metered_time_ms` |  97 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  114.67 | -          |  114.67 |  114.67 |
| `execute_preflight_insns` |  2,791,990.25 |  11,167,961 |  2,851,000 |  2,614,961 |
| `execute_preflight_time_ms` |  169.50 |  678 |  219 |  103 |
| `execute_preflight_insn_mi/s` |  33.59 | -          |  34.50 |  31.13 |
| `trace_gen_time_ms   ` |  57.75 |  231 |  63 |  54 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,952.75 |  7,811 |  2,135 |  1,886 |
| `prover.main_trace_commit_time_ms` |  538.75 |  2,155 |  630 |  508 |
| `prover.rap_constraints_time_ms` |  1,275 |  5,100 |  1,365 |  1,238 |
| `prover.openings_time_ms` |  138 |  552 |  139 |  137 |
| `prover.rap_constraints.logup_gkr_time_ms` |  359.50 |  1,438 |  451 |  328 |
| `prover.rap_constraints.round0_time_ms` |  667.25 |  2,669 |  673 |  663 |
| `prover.rap_constraints.mle_rounds_time_ms` |  247.25 |  989 |  250 |  245 |
| `prover.openings.stacked_reduction_time_ms` |  98 |  392 |  100 |  95 |
| `prover.openings.stacked_reduction.round0_time_ms` |  59.25 |  237 |  61 |  57 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  38.25 |  153 |  39 |  38 |
| `prover.openings.whir_time_ms` |  39.50 |  158 |  42 |  38 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,422 |  1,422 |  1,422 |  1,422 |
...
| `prover.main_trace_commit_time_ms` |  812 |  812 |  812 |  812 |
| `prover.rap_constraints_time_ms` |  354 |  354 |  354 |  354 |
...
| `prover.openings.stacked_reduction.round0_time_ms` |  37 |  37 |  37 |  37 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/1f998065deae7e89b008df7fa4287b0acbd7bf6b/sha2_bench-1f998065deae7e89b008df7fa4287b0acbd7bf6b.memory.svg)
...
| app_proof |  |  |  |  |  | 2,155 |  |  | 97 | 11,167,961 | 114.67 | 0 | 9,089 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 61,220,667 | 361 | 185 | 0 | 1 | 131 | 37 | 37 | 65 | 27 | 0 | 44 | 25 | 18 | 5 | 13 | 185 | 131 | 0 | 3 | 26 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,943 | 150 | 49 | 0 | 0 | 73 | 25 | 24 | 30 | 17 | 0 | 27 | 18 | 8 | 2 | 6 | 50 | 73 | 0 | 2 | 16 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 121 | 31 | 0 | 0 | 63 | 24 | 23 | 25 | 14 | 0 | 26 | 18 | 7 | 1 | 5 | 31 | 63 | 0 | 2 | 13 | 0 | 0 | 
| leaf | 0 | prover | 425,192,422 | 1,274 | 811 | 0 | 163 | 354 | 172 | 171 | 105 | 76 | 0 | 107 | 42 | 65 | 37 | 28 | 812 | 354 | 0 | 7 | 75 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 640,057,593 | 2,135 | 629 | 0 | 124 | 1,365 | 663 | 662 | 250 | 451 | 138 | 139 | 40 | 98 | 59 | 39 | 630 | 1,365 | 0 | 3 | 312 | 0 | 0 | 
| app_proof | prover | 1 | 640,057,356 | 1,894 | 508 | 0 | 2 | 1,248 | 670 | 670 | 247 | 330 | 0 | 137 | 38 | 99 | 60 | 38 | 508 | 1,248 | 0 | 4 | 328 | 0 | 0 | 
| app_proof | prover | 2 | 640,057,356 | 1,896 | 507 | 0 | 2 | 1,249 | 673 | 672 | 247 | 329 | 0 | 138 | 38 | 100 | 61 | 38 | 508 | 1,249 | 0 | 4 | 327 | 0 | 0 | 
| app_proof | prover | 3 | 640,057,588 | 1,886 | 509 | 0 | 2 | 1,238 | 663 | 663 | 245 | 328 | 0 | 138 | 42 | 95 | 57 | 38 | 509 | 1,238 | 0 | 4 | 327 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 63 | 2,440 | 63 | 137 | 0 | 3 | 103 | 2,851,000 | 31.13 | 
| app_proof | 1 | 57 | 2,211 | 57 | 41 | 0 | 1 | 219 | 2,851,000 | 34.37 | 
| app_proof | 2 | 57 | 2,179 | 57 | 41 | 0 | 1 | 183 | 2,851,000 | 34.50 | 
| app_proof | 3 | 54 | 2,155 | 54 | 41 | 0 | 1 | 173 | 2,614,961 | 34.37 | 

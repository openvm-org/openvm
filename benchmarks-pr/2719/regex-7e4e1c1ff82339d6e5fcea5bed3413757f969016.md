...
| `total_proof_time_ms ` |  733 |  1,466 |  874 |  592 |
| `execute_metered_time_ms` |  33 | -          | -          | -          |
| `execute_metered_insns` |  4,090,656 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  120.35 | -          |  120.35 |  120.35 |
| `execute_preflight_insns` |  2,045,328 |  4,090,656 |  2,327,000 |  1,763,656 |
| `execute_preflight_time_ms` |  86.50 |  173 |  96 |  77 |
| `execute_preflight_insn_mi/s` |  31.62 | -          |  32.78 |  30.46 |
| `trace_gen_time_ms   ` |  38.50 |  77 |  47 |  30 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  518 |  1,036 |  611 |  425 |
| `prover.main_trace_commit_time_ms` |  114 |  228 |  128 |  100 |
| `prover.rap_constraints_time_ms` |  357 |  714 |  432 |  282 |
| `prover.openings_time_ms` |  46.50 |  93 |  51 |  42 |
| `prover.rap_constraints.logup_gkr_time_ms` |  231.50 |  463 |  308 |  155 |
| `prover.rap_constraints.round0_time_ms` |  91 |  182 |  96 |  86 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/7e4e1c1ff82339d6e5fcea5bed3413757f969016/regex-7e4e1c1ff82339d6e5fcea5bed3413757f969016.memory.svg)
...
| app_proof |  |  |  |  |  | 592 |  |  | 33 | 4,090,656 | 120.35 | 0 | 1,513 |  | 
...
| app_proof | VmAirWrapper<Rv64LoadStoreAdapterAir, LoadStoreCoreAir<8> | 1 | 11 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 27,289,403 | 205 | 81 | 0 | 0 | 95 | 30 | 30 | 45 | 19 | 0 | 27 | 16 | 11 | 2 | 8 | 82 | 95 | 0 | 2 | 18 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,767 | 141 | 46 | 0 | 0 | 66 | 24 | 24 | 27 | 13 | 0 | 27 | 19 | 8 | 1 | 6 | 46 | 66 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 122 | 31 | 0 | 0 | 61 | 24 | 23 | 24 | 13 | 0 | 29 | 22 | 7 | 1 | 5 | 31 | 61 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 79,656,756 | 303 | 126 | 0 | 0 | 135 | 54 | 53 | 37 | 43 | 0 | 41 | 26 | 15 | 6 | 8 | 126 | 135 | 0 | 5 | 41 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 161,843,666 | 611 | 127 | 0 | 0 | 432 | 86 | 86 | 37 | 308 | 76 | 51 | 26 | 24 | 13 | 11 | 128 | 432 | 0 | 3 | 230 | 0 | 0 | 
| app_proof | prover | 1 | 123,257,151 | 425 | 100 | 0 | 8 | 282 | 96 | 96 | 30 | 155 | 0 | 42 | 21 | 20 | 9 | 10 | 100 | 282 | 0 | 3 | 154 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 30 | 874 | 30 | 136 | 1 | 5 | 96 | 2,327,000 | 30.46 | 
| app_proof | 1 | 47 | 592 | 47 | 40 | 0 | 2 | 77 | 1,763,656 | 32.78 | 

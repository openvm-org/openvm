...
| `total_proof_time_ms ` |  1,865 |  3,730 |  2,831 |  899 |
...
| `execute_preflight_insn_mi/s` |  31.64 | -          |  32.03 |  31.25 |
| `trace_gen_time_ms   ` |  64 |  128 |  94 |  34 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,635.50 |  3,271 |  2,532 |  739 |
| `prover.main_trace_commit_time_ms` |  588 |  1,176 |  954 |  222 |
| `prover.rap_constraints_time_ms` |  913 |  1,826 |  1,385 |  441 |
| `prover.openings_time_ms` |  133 |  266 |  192 |  74 |
| `prover.rap_constraints.logup_gkr_time_ms` |  148 |  296 |  210 |  86 |
| `prover.rap_constraints.round0_time_ms` |  548.50 |  1,097 |  846 |  251 |
| `prover.rap_constraints.mle_rounds_time_ms` |  216 |  432 |  328 |  104 |
| `prover.openings.stacked_reduction_time_ms` |  98 |  196 |  151 |  45 |
| `prover.openings.stacked_reduction.round0_time_ms` |  54 |  108 |  84 |  24 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  43.50 |  87 |  67 |  20 |
...
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  811 |  811 |  811 |  811 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/dac2c10a6c4338056c88144c3c00104254aad91e/kitchen_sink-dac2c10a6c4338056c88144c3c00104254aad91e.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 81 | 9 |  |  | 0 |  | 390 | 9 |  |  |  |  |  |  | 
| app_proof |  |  |  |  |  | 899 |  |  | 24 | 1,979,971 | 81.42 | 0 | 3,760 |  | 
...
| internal_recursive.0 | 1 | 11 | 151 | 11 | 1 | 0 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 9 | 140 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 115 | 927 | 115 | 24 | 10 | 18 | 2 | 2 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,577,979 | 255 | 115 | 0 | 0 | 107 | 34 | 34 | 52 | 20 | 0 | 32 | 19 | 13 | 3 | 9 | 115 | 107 | 0 | 2 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,767 | 140 | 44 | 0 | 0 | 67 | 25 | 24 | 27 | 14 | 0 | 28 | 19 | 8 | 1 | 6 | 45 | 67 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 130 | 31 | 0 | 0 | 63 | 24 | 23 | 24 | 13 | 0 | 35 | 28 | 7 | 1 | 5 | 31 | 63 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 260,613,236 | 811 | 395 | 0 | 1 | 339 | 129 | 128 | 76 | 133 | 0 | 76 | 36 | 39 | 21 | 18 | 395 | 339 | 0 | 6 | 132 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 902,782,844 | 2,532 | 954 | 0 | 310 | 1,385 | 846 | 844 | 328 | 210 | 63 | 192 | 41 | 151 | 84 | 67 | 954 | 1,385 | 0 | 3 | 145 | 0 | 0 | 
| app_proof | prover | 1 | 279,963,980 | 739 | 222 | 0 | 1 | 441 | 251 | 250 | 104 | 86 | 0 | 74 | 29 | 45 | 24 | 20 | 222 | 441 | 0 | 3 | 85 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 94 | 2,831 | 94 | 136 | 0 | 4 | 68 | 1,445,000 | 31.25 | 
| app_proof | 1 | 34 | 899 | 34 | 41 | 0 | 2 | 84 | 534,971 | 32.03 | 

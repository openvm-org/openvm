...
|:---|---:|---:|
| Total |  106.22 |  90.93 |
| kitchen_sink |  20.15 |  13.21 |
| leaf |  37.50 |  29.13 |
| internal.0 |  9.77 |  9.77 |
| root |  38.81 |  38.81 |
...
| `total_proof_time_ms ` |  10,073.50 |  20,147 |  13,213 |  6,934 |
...
| `trace_gen_time_ms   ` |  366.50 |  733 |  468 |  265 |
| `stark_prove_excluding_trace_time_ms` |  9,687 |  19,374 |  12,714 |  6,660 |
| `main_trace_commit_time_ms` |  3,091 |  6,182 |  4,180 |  2,002 |
| `generate_perm_trace_time_ms` |  290.50 |  581 |  384 |  197 |
| `perm_trace_commit_time_ms` |  941 |  1,882 |  1,251 |  631 |
| `quotient_poly_compute_time_ms` |  4,235 |  8,470 |  5,624 |  2,846 |
| `quotient_poly_commit_time_ms` |  224.50 |  449 |  241 |  208 |
| `pcs_opening_time_ms ` |  875 |  1,750 |  988 |  762 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  18,750 |  37,500 |  29,128 |  8,372 |
| `main_cells_used     ` |  463,783,018 |  927,566,036 |  739,554,610 |  188,011,426 |
| `total_cycles        ` |  5,251,187 |  10,502,374 |  8,097,610 |  2,404,764 |
| `execute_time_ms     ` |  1,842 |  3,684 |  2,782 |  902 |
| `trace_gen_time_ms   ` |  4,201.50 |  8,403 |  6,536 |  1,867 |
| `stark_prove_excluding_trace_time_ms` |  12,706.50 |  25,413 |  19,810 |  5,603 |
| `main_trace_commit_time_ms` |  2,615.50 |  5,231 |  4,136 |  1,095 |
| `generate_perm_trace_time_ms` |  1,115.50 |  2,231 |  1,778 |  453 |
| `perm_trace_commit_time_ms` |  3,306 |  6,612 |  5,233 |  1,379 |
| `quotient_poly_compute_time_ms` |  2,021 |  4,042 |  3,156 |  886 |
| `quotient_poly_commit_time_ms` |  956.50 |  1,913 |  1,439 |  474 |
| `pcs_opening_time_ms ` |  2,686.50 |  5,373 |  4,062 |  1,311 |

| internal.0 |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  9,771 |  9,771 |  9,771 |  9,771 |
| `main_cells_used     ` |  143,862,290 |  143,862,290 |  143,862,290 |  143,862,290 |
| `total_cycles        ` |  2,397,858 |  2,397,858 |  2,397,858 |  2,397,858 |
| `execute_time_ms     ` |  1,055 |  1,055 |  1,055 |  1,055 |
| `trace_gen_time_ms   ` |  1,328 |  1,328 |  1,328 |  1,328 |
| `stark_prove_excluding_trace_time_ms` |  7,388 |  7,388 |  7,388 |  7,388 |
| `main_trace_commit_time_ms` |  1,718 |  1,718 |  1,718 |  1,718 |
| `generate_perm_trace_time_ms` |  344 |  344 |  344 |  344 |
| `perm_trace_commit_time_ms` |  1,276 |  1,276 |  1,276 |  1,276 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  38,806 |  38,806 |  38,806 |  38,806 |
| `main_cells_used     ` |  38,196,754 |  38,196,754 |  38,196,754 |  38,196,754 |
| `total_cycles        ` |  766,814 |  766,814 |  766,814 |  766,814 |
...
| `quotient_poly_commit_time_ms` |  13,670 |  13,670 |  13,670 |  13,670 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  43,984 |  43,984 |  43,984 |  43,984 |
...
| --- | --- | --- | --- |
| halo2_outer | 89,801 |  | 62,297,054 | 
| halo2_wrapper | 43,984 |  |  | 
| kitchen_sink |  | 2 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal.0 | 0 | 1,328 | 9,771 | 2,397,858 | 420,325,858 | 7,388 | 1,368 | 1,063 | 1,276 | 1,614 | 1,718 | 143,862,290 | 344 | 1,055 | 
| leaf | 0 | 6,536 | 29,128 | 8,097,610 | 2,772,897,258 | 19,810 | 3,156 | 1,439 | 5,233 | 4,062 | 4,136 | 739,554,610 | 1,778 | 2,782 | 
| leaf | 1 | 1,867 | 8,372 | 2,404,764 | 746,278,378 | 5,603 | 886 | 474 | 1,379 | 1,311 | 1,095 | 188,011,426 | 453 | 902 | 
| root | 0 | 411 | 38,806 | 766,814 | 80,435,354 | 38,147 | 825 | 13,670 | 7,586 | 3,665 | 12,314 | 38,196,754 | 77 | 248 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| kitchen_sink | 0 | 468 | 13,213 | 85,850 | 1,307,172,505 | 12,714 | 5,624 | 241 | 1,251 | 988 | 4,180 | 632,432,647 | 384 | 31 | 
| kitchen_sink | 1 | 265 | 6,934 | 13,666 | 661,752,828 | 6,660 | 2,846 | 208 | 631 | 762 | 2,002 | 264,431,162 | 197 | 9 | 

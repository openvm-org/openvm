...
|:---|---:|---:|
| Total |  242.25 |  227.01 |
| kitchen_sink |  20.08 |  13.18 |
| leaf |  37.80 |  29.46 |
| internal.0 |  9.80 |  9.80 |
| root |  38.73 |  38.73 |
...
| `total_proof_time_ms ` |  10,041 |  20,082 |  13,176 |  6,906 |
...
| `trace_gen_time_ms   ` |  360 |  720 |  457 |  263 |
| `stark_prove_excluding_trace_time_ms` |  9,661 |  19,322 |  12,688 |  6,634 |
| `main_trace_commit_time_ms` |  3,101 |  6,202 |  4,205 |  1,997 |
| `generate_perm_trace_time_ms` |  290.50 |  581 |  384 |  197 |
| `perm_trace_commit_time_ms` |  936 |  1,872 |  1,242 |  630 |
| `quotient_poly_compute_time_ms` |  4,212 |  8,424 |  5,596 |  2,828 |
| `quotient_poly_commit_time_ms` |  222.50 |  445 |  238 |  207 |
| `pcs_opening_time_ms ` |  871 |  1,742 |  979 |  763 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  18,899.50 |  37,799 |  29,460 |  8,339 |
| `main_cells_used     ` |  463,783,036 |  927,566,072 |  739,554,682 |  188,011,390 |
| `total_cycles        ` |  5,251,188.50 |  10,502,377 |  8,097,616 |  2,404,761 |
| `execute_time_ms     ` |  1,836 |  3,672 |  2,775 |  897 |
| `trace_gen_time_ms   ` |  4,361.50 |  8,723 |  6,870 |  1,853 |
| `stark_prove_excluding_trace_time_ms` |  12,702 |  25,404 |  19,815 |  5,589 |
| `main_trace_commit_time_ms` |  2,628.50 |  5,257 |  4,155 |  1,102 |
| `generate_perm_trace_time_ms` |  1,125 |  2,250 |  1,795 |  455 |
| `perm_trace_commit_time_ms` |  3,289.50 |  6,579 |  5,203 |  1,376 |
| `quotient_poly_compute_time_ms` |  2,026.50 |  4,053 |  3,170 |  883 |
| `quotient_poly_commit_time_ms` |  960.50 |  1,921 |  1,456 |  465 |
| `pcs_opening_time_ms ` |  2,667 |  5,334 |  4,031 |  1,303 |

| internal.0 |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  9,799 |  9,799 |  9,799 |  9,799 |
| `main_cells_used     ` |  143,862,578 |  143,862,578 |  143,862,578 |  143,862,578 |
| `total_cycles        ` |  2,397,882 |  2,397,882 |  2,397,882 |  2,397,882 |
| `execute_time_ms     ` |  1,027 |  1,027 |  1,027 |  1,027 |
| `trace_gen_time_ms   ` |  1,371 |  1,371 |  1,371 |  1,371 |
| `stark_prove_excluding_trace_time_ms` |  7,401 |  7,401 |  7,401 |  7,401 |
| `main_trace_commit_time_ms` |  1,714 |  1,714 |  1,714 |  1,714 |
| `generate_perm_trace_time_ms` |  344 |  344 |  344 |  344 |
| `perm_trace_commit_time_ms` |  1,244 |  1,244 |  1,244 |  1,244 |
| `quotient_poly_compute_time_ms` |  1,372 |  1,372 |  1,372 |  1,372 |
| `quotient_poly_commit_time_ms` |  1,052 |  1,052 |  1,052 |  1,052 |
| `pcs_opening_time_ms ` |  1,669 |  1,669 |  1,669 |  1,669 |

| root |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  38,732 |  38,732 |  38,732 |  38,732 |
| `main_cells_used     ` |  38,196,526 |  38,196,526 |  38,196,526 |  38,196,526 |
| `total_cycles        ` |  766,795 |  766,795 |  766,795 |  766,795 |
...
| `quotient_poly_commit_time_ms` |  13,599 |  13,599 |  13,599 |  13,599 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  44,165 |  44,165 |  44,165 |  44,165 |
...
| --- | --- | --- | --- |
| halo2_outer | 91,668 |  | 62,297,054 | 
| halo2_wrapper | 44,165 |  |  | 
| kitchen_sink |  | 2 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal.0 | 0 | 1,371 | 9,799 | 2,397,882 | 420,325,858 | 7,401 | 1,372 | 1,052 | 1,244 | 1,669 | 1,714 | 143,862,578 | 344 | 1,027 | 
| leaf | 0 | 6,870 | 29,460 | 8,097,616 | 2,772,897,258 | 19,815 | 3,170 | 1,456 | 5,203 | 4,031 | 4,155 | 739,554,682 | 1,795 | 2,775 | 
| leaf | 1 | 1,853 | 8,339 | 2,404,761 | 746,278,378 | 5,589 | 883 | 465 | 1,376 | 1,303 | 1,102 | 188,011,390 | 455 | 897 | 
| root | 0 | 403 | 38,732 | 766,795 | 80,435,354 | 38,086 | 827 | 13,599 | 7,582 | 3,669 | 12,310 | 38,196,526 | 78 | 243 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| kitchen_sink | 0 | 457 | 13,176 | 85,850 | 1,307,172,505 | 12,688 | 5,596 | 238 | 1,242 | 979 | 4,205 | 632,432,647 | 384 | 31 | 
| kitchen_sink | 1 | 263 | 6,906 | 13,666 | 661,752,828 | 6,634 | 2,828 | 207 | 630 | 763 | 1,997 | 264,431,162 | 197 | 9 | 

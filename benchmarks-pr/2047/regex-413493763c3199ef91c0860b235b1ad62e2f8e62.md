...
|:---|---:|---:|
| Total |  3.10 |  1.82 |
| regex_program |  3.06 |  1.77 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,529.50 |  3,059 |  1,774 |  1,285 |
| `main_cells_used     ` |  6,703,152 |  13,406,304 |  10,858,068 |  2,548,236 |
| `total_cells_used    ` |  17,692,274 |  35,384,548 |  23,389,822 |  11,994,726 |
| `execute_metered_time_ms` |  44 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  91.76 | -          |  91.76 |  91.76 |
| `execute_preflight_insns` |  2,054,293 |  4,108,586 |  2,211,000 |  1,897,586 |
| `execute_preflight_time_ms` |  98 |  196 |  111 |  85 |
| `execute_preflight_insn_mi/s` |  30.10 | -          |  31.96 |  28.24 |
| `trace_gen_time_ms   ` |  311 |  622 |  332 |  290 |
| `memory_finalize_time_ms` |  2 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  1,033.50 |  2,067 |  1,272 |  795 |
| `main_trace_commit_time_ms` |  142.50 |  285 |  185 |  100 |
| `generate_perm_trace_time_ms` |  102 |  204 |  132 |  72 |
| `perm_trace_commit_time_ms` |  172.26 |  344.51 |  223.47 |  121.04 |
| `quotient_poly_compute_time_ms` |  165.66 |  331.32 |  184.15 |  147.17 |
| `quotient_poly_commit_time_ms` |  37.20 |  74.39 |  48.47 |  25.92 |
| `pcs_opening_time_ms ` |  408 |  816 |  532 |  284 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 1,285 | 41 | 1 | 44 | 4,108,586 | 91.76 | 251 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 290 | 1,774 | 23,389,822 | 373,183,036 | 290 | 1,272 | 0 | 147.17 | 48.47 | 6 | 223.47 | 532 | 356 | 532 | 4 | 185 | 10,858,068 | 132 | 85 | 2,211,000 | 28.24 | 47 | 197 | 2 | 532 | 
| regex_program | 1 | 332 | 1,285 | 11,994,726 | 196,838,026 | 332 | 795 | 2 | 184.15 | 25.92 | 5 | 121.04 | 284 | 196 | 284 | 0 | 100 | 2,548,236 | 72 | 111 | 1,897,586 | 31.96 | 28 | 214 | 2 | 284 | 

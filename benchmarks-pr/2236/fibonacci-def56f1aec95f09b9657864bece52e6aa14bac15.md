...
| `total_proof_time_ms ` |  498 |  996 |  565 |  431 |
| `main_cells_used     ` |  1,050,201 |  2,100,402 |  1,064,416 |  1,035,986 |
| `total_cells_used    ` |  9,692,939 |  19,385,878 |  9,708,170 |  9,677,708 |
| `execute_metered_time_ms` |  17 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  84.48 | -          |  84.48 |  84.48 |
| `execute_preflight_insns` |  750,104.50 |  1,500,209 |  873,000 |  627,209 |
| `execute_preflight_time_ms` |  30.50 |  61 |  34 |  27 |
| `execute_preflight_insn_mi/s` |  34.43 | -          |  36.17 |  32.68 |
| `trace_gen_time_ms   ` |  194 |  388 |  199 |  189 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  179 |  358 |  193 |  165 |
| `main_trace_commit_time_ms` |  30.50 |  61 |  33 |  28 |
| `generate_perm_trace_time_ms` |  15.50 |  31 |  18 |  13 |
| `perm_trace_commit_time_ms` |  43.52 |  87.05 |  46.07 |  40.98 |
| `quotient_poly_compute_time_ms` |  32.15 |  64.30 |  34.79 |  29.51 |
| `quotient_poly_commit_time_ms` |  12.79 |  25.58 |  13.25 |  12.33 |
| `pcs_opening_time_ms ` |  42.50 |  85 |  46 |  39 |
...
| --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 431 | 1 | 17 | 1,500,209 | 84.48 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 199 | 565 | 9,677,708 | 84,395,212 | 199 | 193 | 0 | 34.79 | 13.25 | 4 | 46.07 | 46 | 65 | 46 | 0 | 33 | 1,035,986 | 18 | 27 | 873,000 | 32.68 | 14 | 48 | 0 | 46 | 
| fibonacci_program | 1 | 189 | 431 | 9,708,170 | 74,305,770 | 189 | 165 | 1 | 29.51 | 12.33 | 4 | 40.98 | 39 | 54 | 39 | 0 | 28 | 1,064,416 | 13 | 34 | 627,209 | 36.17 | 11 | 42 | 0 | 39 | 

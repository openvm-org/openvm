...
| `total_proof_time_ms ` |  593.50 |  2,374 |  748 |  532 |
...
| `execute_metered_insn_mi/s` |  108.91 | -          |  108.91 |  108.91 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  55 |  220 |  68 |  46 |
| `execute_preflight_insn_mi/s` |  30.12 | -          |  31.22 |  27.24 |
| `trace_gen_time_ms   ` |  178.25 |  713 |  210 |  156 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  292.50 |  1,170 |  346 |  269 |
| `main_trace_commit_time_ms` |  51.50 |  206 |  57 |  49 |
| `generate_perm_trace_time_ms` |  35.25 |  141 |  55 |  20 |
| `perm_trace_commit_time_ms` |  64.63 |  258.53 |  71.70 |  54.79 |
| `quotient_poly_compute_time_ms` |  58.09 |  232.38 |  71.100 |  48.87 |
| `quotient_poly_commit_time_ms` |  15.13 |  60.53 |  16.84 |  13 |
| `pcs_opening_time_ms ` |  64.50 |  258 |  83 |  55 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 544 | 1 | 37 | 4,137,502 | 108.91 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 210 | 748 | 23,446,148 | 150,778,428 | 210 | 346 | 0 | 58.53 | 16.84 | 5 | 71.70 | 83 | 128 | 83 | 4 | 57 | 10,899,170 | 55 | 47 | 1,103,000 | 27.24 | 21 | 76 | 1 | 83 | 
| regex_program | 1 | 156 | 550 | 11,598,276 | 128,513,066 | 156 | 284 | 1 | 48.87 | 15.48 | 4 | 65.52 | 63 | 105 | 63 | 0 | 50 | 2,196,106 | 39 | 68 | 1,104,000 | 31.03 | 16 | 64 | 0 | 63 | 
| regex_program | 2 | 162 | 532 | 11,579,064 | 128,513,066 | 162 | 269 | 1 | 52.98 | 15.21 | 4 | 66.52 | 55 | 94 | 54 | 0 | 50 | 2,177,334 | 27 | 59 | 1,104,000 | 31.22 | 16 | 68 | 0 | 54 | 
| regex_program | 3 | 185 | 544 | 11,853,872 | 103,456,394 | 185 | 271 | 0 | 71.100 | 13 | 5 | 54.79 | 57 | 78 | 56 | 0 | 49 | 2,422,606 | 20 | 46 | 826,502 | 31.01 | 18 | 86 | 1 | 56 | 
...
Commit: https://github.com/openvm-org/openvm/commit/def56f1aec95f09b9657864bece52e6aa14bac15
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19345999256)

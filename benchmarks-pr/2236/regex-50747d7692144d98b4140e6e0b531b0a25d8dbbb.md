...
| `total_proof_time_ms ` |  587 |  2,348 |  730 |  536 |
...
| `execute_preflight_insn_mi/s` |  30.53 | -          |  31.48 |  28.02 |
| `trace_gen_time_ms   ` |  176.25 |  705 |  209 |  154 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  288.75 |  1,155 |  329 |  267 |
| `main_trace_commit_time_ms` |  51.25 |  205 |  57 |  49 |
| `generate_perm_trace_time_ms` |  29.50 |  118 |  37 |  19 |
| `perm_trace_commit_time_ms` |  64.45 |  257.80 |  71.37 |  54.71 |
| `quotient_poly_compute_time_ms` |  58.12 |  232.47 |  71.07 |  51.91 |
| `quotient_poly_commit_time_ms` |  14.99 |  59.96 |  16.49 |  12.77 |
| `pcs_opening_time_ms ` |  67.50 |  270 |  90 |  56 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 536 | 1 | 39 | 4,137,502 | 104.54 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 209 | 730 | 23,446,148 | 150,778,428 | 209 | 329 | 0 | 57.46 | 16.49 | 5 | 71.37 | 90 | 106 | 90 | 4 | 57 | 10,899,170 | 34 | 46 | 1,103,000 | 28.02 | 21 | 74 | 1 | 90 | 
| regex_program | 1 | 154 | 545 | 11,598,276 | 128,513,066 | 154 | 284 | 1 | 51.91 | 15.06 | 4 | 65.48 | 62 | 103 | 62 | 0 | 50 | 2,196,106 | 37 | 66 | 1,104,000 | 31.36 | 16 | 67 | 0 | 62 | 
| regex_program | 2 | 161 | 537 | 11,579,064 | 128,513,066 | 161 | 275 | 1 | 52.02 | 15.64 | 4 | 66.24 | 62 | 95 | 62 | 0 | 49 | 2,177,334 | 28 | 59 | 1,104,000 | 31.48 | 17 | 68 | 0 | 62 | 
| regex_program | 3 | 181 | 536 | 11,853,872 | 103,456,394 | 181 | 267 | 0 | 71.07 | 12.77 | 5 | 54.71 | 56 | 77 | 56 | 0 | 49 | 2,422,606 | 19 | 45 | 826,502 | 31.27 | 18 | 84 | 1 | 56 | 
...
Commit: https://github.com/openvm-org/openvm/commit/50747d7692144d98b4140e6e0b531b0a25d8dbbb
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19346445669)

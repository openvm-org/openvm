...
| `execute_preflight_time_ms` |  96.50 |  193 |  129 |  64 |
| `execute_preflight_insn_mi/s` |  12.89 | -          |  16.60 |  9.19 |
| `trace_gen_time_ms   ` |  175.50 |  351 |  190 |  161 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  343.50 |  687 |  378 |  309 |
| `main_trace_commit_time_ms` |  65 |  130 |  75 |  55 |
| `generate_perm_trace_time_ms` |  41.50 |  83 |  48 |  35 |
| `perm_trace_commit_time_ms` |  77.74 |  155.48 |  90.17 |  65.31 |
| `quotient_poly_compute_time_ms` |  78.76 |  157.52 |  87.16 |  70.35 |
| `quotient_poly_commit_time_ms` |  16.71 |  33.43 |  19.20 |  14.23 |
| `pcs_opening_time_ms ` |  59 |  118 |  66 |  52 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 605 | 1 | 94 | 1,745,742 | 18.48 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 161 | 812 | 32,689,110 | 172,558,444 | 161 | 378 | 0 | 87.16 | 19.20 | 6 | 90.17 | 66 | 128 | 66 | 1 | 75 | 16,059,916 | 35 | 129 | 1,157,000 | 9.19 | 26 | 107 | 1 | 66 | 
| pairing | 1 | 190 | 605 | 22,314,288 | 119,958,502 | 190 | 309 | 1 | 70.35 | 14.23 | 6 | 65.31 | 52 | 116 | 52 | 0 | 55 | 9,408,294 | 48 | 64 | 588,742 | 16.60 | 20 | 85 | 1 | 52 | 

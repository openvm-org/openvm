...
|:---|---:|---:|
| Total |  2.42 |  0.79 |
| regex_program |  2.38 |  0.74 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  594.50 |  2,378 |  743 |  542 |
...
| `execute_preflight_insn_mi/s` |  30.44 | -          |  31.94 |  27.49 |
| `trace_gen_time_ms   ` |  180 |  720 |  213 |  157 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  293 |  1,172 |  339 |  270 |
| `main_trace_commit_time_ms` |  51.50 |  206 |  56 |  49 |
| `generate_perm_trace_time_ms` |  35 |  140 |  55 |  19 |
| `perm_trace_commit_time_ms` |  64.11 |  256.46 |  70.41 |  54.71 |
| `quotient_poly_compute_time_ms` |  59.02 |  236.06 |  71.61 |  52.32 |
| `quotient_poly_commit_time_ms` |  15.20 |  60.82 |  17.05 |  12.98 |
| `pcs_opening_time_ms ` |  65 |  260 |  77 |  57 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 542 | 1 | 45 | 4,137,502 | 90.53 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 213 | 743 | 23,446,148 | 150,778,428 | 213 | 339 | 0 | 59.81 | 17.05 | 5 | 70.41 | 77 | 126 | 77 | 4 | 56 | 10,899,170 | 55 | 47 | 1,103,000 | 27.49 | 21 | 77 | 1 | 77 | 
| regex_program | 1 | 157 | 551 | 11,598,276 | 128,513,066 | 157 | 286 | 1 | 52.33 | 15.09 | 4 | 65.07 | 63 | 104 | 63 | 0 | 50 | 2,196,106 | 38 | 66 | 1,104,000 | 30.73 | 17 | 67 | 0 | 63 | 
| regex_program | 2 | 165 | 542 | 11,579,064 | 128,513,066 | 165 | 277 | 1 | 52.32 | 15.69 | 4 | 66.26 | 63 | 94 | 62 | 0 | 51 | 2,177,334 | 28 | 58 | 1,104,000 | 31.60 | 17 | 68 | 0 | 62 | 
| regex_program | 3 | 185 | 542 | 11,853,872 | 103,456,394 | 185 | 270 | 0 | 71.61 | 12.98 | 5 | 54.71 | 57 | 77 | 57 | 0 | 49 | 2,422,606 | 19 | 46 | 826,502 | 31.94 | 18 | 85 | 1 | 57 | 

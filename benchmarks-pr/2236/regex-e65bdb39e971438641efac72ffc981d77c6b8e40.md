...
| `total_proof_time_ms ` |  589.25 |  2,357 |  741 |  536 |
...
| `execute_preflight_insn_mi/s` |  30.70 | -          |  31.75 |  27.85 |
| `trace_gen_time_ms   ` |  176.25 |  705 |  208 |  154 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  291.25 |  1,165 |  343 |  270 |
| `main_trace_commit_time_ms` |  52.25 |  209 |  57 |  50 |
| `generate_perm_trace_time_ms` |  34 |  136 |  55 |  19 |
| `perm_trace_commit_time_ms` |  64.10 |  256.42 |  71.04 |  55.81 |
| `quotient_poly_compute_time_ms` |  57.69 |  230.76 |  69.31 |  51.27 |
| `quotient_poly_commit_time_ms` |  14.83 |  59.31 |  16.60 |  12.81 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 539 | 1 | 38 | 4,137,502 | 108.62 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 208 | 741 | 23,446,148 | 150,778,428 | 208 | 343 | 0 | 58.10 | 16.60 | 5 | 71.04 | 83 | 127 | 82 | 4 | 57 | 10,899,170 | 55 | 46 | 1,103,000 | 27.85 | 21 | 75 | 1 | 82 | 
| regex_program | 1 | 154 | 541 | 11,598,276 | 128,513,066 | 154 | 279 | 1 | 51.27 | 15.36 | 4 | 65.40 | 59 | 101 | 59 | 0 | 51 | 2,196,106 | 35 | 67 | 1,104,000 | 31.68 | 17 | 67 | 0 | 59 | 
| regex_program | 2 | 161 | 536 | 11,579,064 | 128,513,066 | 161 | 273 | 1 | 52.08 | 14.54 | 5 | 64.16 | 62 | 92 | 62 | 0 | 51 | 2,177,334 | 27 | 59 | 1,104,000 | 31.52 | 16 | 67 | 0 | 62 | 
| regex_program | 3 | 182 | 539 | 11,853,872 | 103,456,394 | 182 | 270 | 0 | 69.31 | 12.81 | 5 | 55.81 | 57 | 78 | 56 | 0 | 50 | 2,422,606 | 19 | 46 | 826,502 | 31.75 | 18 | 83 | 1 | 56 | 

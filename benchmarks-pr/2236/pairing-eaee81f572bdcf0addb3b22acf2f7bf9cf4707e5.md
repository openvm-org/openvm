...
| `total_proof_time_ms ` |  737 |  1,474 |  845 |  629 |
...
| `execute_preflight_insn_mi/s` |  13.44 | -          |  17.74 |  9.14 |
| `trace_gen_time_ms   ` |  176 |  352 |  193 |  159 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  373.50 |  747 |  412 |  335 |
| `main_trace_commit_time_ms` |  64.50 |  129 |  74 |  55 |
| `generate_perm_trace_time_ms` |  55 |  110 |  71 |  39 |
| `perm_trace_commit_time_ms` |  76.44 |  152.88 |  88.69 |  64.19 |
| `quotient_poly_compute_time_ms` |  77.55 |  155.10 |  85.94 |  69.16 |
| `quotient_poly_commit_time_ms` |  15.44 |  30.88 |  17.11 |  13.77 |
| `pcs_opening_time_ms ` |  80.50 |  161 |  103 |  58 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 629 | 1 | 92 | 1,745,742 | 18.89 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 159 | 845 | 32,689,110 | 172,558,444 | 159 | 412 | 0 | 85.94 | 17.11 | 6 | 88.69 | 103 | 130 | 102 | 0 | 74 | 16,059,916 | 39 | 130 | 1,157,000 | 9.14 | 26 | 103 | 1 | 102 | 
| pairing | 1 | 193 | 629 | 22,314,288 | 119,958,502 | 193 | 335 | 1 | 69.16 | 13.77 | 6 | 64.19 | 58 | 138 | 57 | 0 | 55 | 9,408,294 | 71 | 59 | 588,742 | 17.74 | 20 | 83 | 1 | 57 | 

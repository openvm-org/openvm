...
| `total_proof_time_ms ` |  586.50 |  2,346 |  735 |  532 |
...
| `execute_preflight_insn_mi/s` |  30.90 | -          |  32.15 |  27.95 |
| `trace_gen_time_ms   ` |  176 |  704 |  208 |  153 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  289.50 |  1,158 |  336 |  264 |
| `main_trace_commit_time_ms` |  50.75 |  203 |  56 |  49 |
| `generate_perm_trace_time_ms` |  35 |  140 |  55 |  19 |
| `perm_trace_commit_time_ms` |  63.67 |  254.70 |  69.81 |  54.17 |
| `quotient_poly_compute_time_ms` |  58.23 |  232.92 |  69.44 |  51.76 |
| `quotient_poly_commit_time_ms` |  14.82 |  59.29 |  16.86 |  12.42 |
| `pcs_opening_time_ms ` |  64 |  256 |  77 |  55 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 532 | 1 | 38 | 4,137,502 | 107.18 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 208 | 735 | 23,446,148 | 150,778,428 | 208 | 336 | 0 | 58.80 | 16.86 | 5 | 69.81 | 77 | 126 | 76 | 4 | 56 | 10,899,170 | 55 | 46 | 1,103,000 | 27.95 | 21 | 76 | 1 | 76 | 
| regex_program | 1 | 153 | 544 | 11,598,276 | 128,513,066 | 153 | 284 | 1 | 52.92 | 14.49 | 5 | 64.85 | 62 | 103 | 62 | 0 | 49 | 2,196,106 | 38 | 65 | 1,104,000 | 31.68 | 16 | 67 | 0 | 62 | 
| regex_program | 2 | 161 | 535 | 11,579,064 | 128,513,066 | 161 | 274 | 1 | 51.76 | 15.52 | 4 | 65.86 | 62 | 94 | 62 | 0 | 49 | 2,177,334 | 28 | 58 | 1,104,000 | 32.15 | 16 | 67 | 0 | 62 | 
| regex_program | 3 | 182 | 532 | 11,853,872 | 103,456,394 | 182 | 264 | 0 | 69.44 | 12.42 | 5 | 54.17 | 55 | 76 | 55 | 0 | 49 | 2,422,606 | 19 | 45 | 826,502 | 31.81 | 18 | 82 | 1 | 55 | 
...
Commit: https://github.com/openvm-org/openvm/commit/eaee81f572bdcf0addb3b22acf2f7bf9cf4707e5
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19349087134)

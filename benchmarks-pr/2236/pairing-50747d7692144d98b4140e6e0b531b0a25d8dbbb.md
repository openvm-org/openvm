...
| `total_proof_time_ms ` |  741 |  1,482 |  811 |  671 |
...
| `execute_preflight_insn_mi/s` |  13.59 | -          |  18.03 |  9.16 |
| `trace_gen_time_ms   ` |  175 |  350 |  191 |  159 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  379.50 |  759 |  380 |  379 |
| `main_trace_commit_time_ms` |  64 |  128 |  74 |  54 |
| `generate_perm_trace_time_ms` |  55.50 |  111 |  71 |  40 |
| `perm_trace_commit_time_ms` |  76.34 |  152.69 |  89.08 |  63.61 |
| `quotient_poly_compute_time_ms` |  78.94 |  157.88 |  86.99 |  70.89 |
| `quotient_poly_commit_time_ms` |  16.08 |  32.15 |  17.61 |  14.55 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 671 | 1 | 91 | 1,745,742 | 19.09 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 159 | 811 | 32,689,110 | 172,558,444 | 159 | 380 | 0 | 86.99 | 17.61 | 6 | 89.08 | 68 | 131 | 68 | 1 | 74 | 16,059,916 | 40 | 130 | 1,157,000 | 9.16 | 26 | 105 | 1 | 68 | 
| pairing | 1 | 191 | 671 | 22,314,288 | 119,958,502 | 191 | 379 | 1 | 70.89 | 14.55 | 6 | 63.61 | 99 | 138 | 99 | 0 | 54 | 9,408,294 | 71 | 60 | 588,742 | 18.03 | 21 | 86 | 1 | 99 | 

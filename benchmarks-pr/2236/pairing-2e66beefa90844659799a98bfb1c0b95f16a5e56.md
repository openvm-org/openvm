...
| `total_proof_time_ms ` |  734.50 |  1,469 |  819 |  650 |
...
| `execute_preflight_insn_mi/s` |  13.60 | -          |  17.98 |  9.23 |
| `trace_gen_time_ms   ` |  177.50 |  355 |  194 |  161 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  369 |  738 |  384 |  354 |
| `main_trace_commit_time_ms` |  64.50 |  129 |  75 |  54 |
| `generate_perm_trace_time_ms` |  55.50 |  111 |  72 |  39 |
| `perm_trace_commit_time_ms` |  76.08 |  152.15 |  88.39 |  63.77 |
| `quotient_poly_compute_time_ms` |  79.82 |  159.63 |  87.36 |  72.27 |
| `quotient_poly_commit_time_ms` |  16.46 |  32.92 |  18.43 |  14.49 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 650 | 1 | 91 | 1,745,742 | 19.11 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 161 | 819 | 32,689,110 | 172,558,444 | 161 | 384 | 0 | 87.36 | 18.43 | 6 | 88.39 | 72 | 130 | 72 | 1 | 75 | 16,059,916 | 39 | 129 | 1,157,000 | 9.23 | 26 | 106 | 1 | 72 | 
| pairing | 1 | 194 | 650 | 22,314,288 | 119,958,502 | 194 | 354 | 1 | 72.27 | 14.49 | 6 | 63.77 | 72 | 138 | 72 | 0 | 54 | 9,408,294 | 72 | 61 | 588,742 | 17.98 | 21 | 87 | 1 | 72 | 

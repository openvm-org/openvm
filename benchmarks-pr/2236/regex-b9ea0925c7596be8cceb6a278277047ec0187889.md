...
| `total_proof_time_ms ` |  585.50 |  2,342 |  721 |  536 |
...
| `execute_preflight_time_ms` |  57.50 |  230 |  71 |  48 |
| `execute_preflight_insn_mi/s` |  30.18 | -          |  31.50 |  26.72 |
| `trace_gen_time_ms   ` |  174.25 |  697 |  210 |  150 |
| `memory_finalize_time_ms` |  0.75 |  3 |  3 |  0 |
| `stark_prove_excluding_trace_time_ms` |  286 |  1,144 |  318 |  267 |
| `main_trace_commit_time_ms` |  51.75 |  207 |  57 |  49 |
| `generate_perm_trace_time_ms` |  29 |  116 |  38 |  18 |
| `perm_trace_commit_time_ms` |  64.54 |  258.15 |  71.34 |  55.68 |
| `quotient_poly_compute_time_ms` |  57.42 |  229.68 |  69.27 |  51.35 |
| `quotient_poly_commit_time_ms` |  14.83 |  59.31 |  16.47 |  12.38 |
| `pcs_opening_time_ms ` |  65.50 |  262 |  80 |  57 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 536 | 1 | 40 | 4,137,502 | 102.46 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 210 | 721 | 23,446,148 | 150,778,428 | 210 | 318 | 0 | 57.58 | 16.47 | 5 | 71.34 | 80 | 105 | 79 | 3 | 57 | 10,899,170 | 33 | 48 | 1,103,000 | 26.72 | 21 | 74 | 1 | 79 | 
| regex_program | 1 | 150 | 549 | 11,598,276 | 128,513,066 | 150 | 286 | 1 | 51.35 | 15.38 | 4 | 65.65 | 63 | 104 | 63 | 0 | 51 | 2,196,106 | 38 | 71 | 1,104,000 | 31.50 | 17 | 67 | 0 | 63 | 
| regex_program | 2 | 158 | 536 | 11,579,064 | 128,513,066 | 158 | 273 | 1 | 51.47 | 15.09 | 4 | 65.48 | 62 | 93 | 62 | 0 | 50 | 2,177,334 | 27 | 63 | 1,104,000 | 31.14 | 16 | 67 | 0 | 62 | 
| regex_program | 3 | 179 | 536 | 11,853,872 | 103,456,394 | 179 | 267 | 0 | 69.27 | 12.38 | 5 | 55.68 | 57 | 77 | 57 | 0 | 49 | 2,422,606 | 18 | 48 | 826,502 | 31.36 | 18 | 82 | 1 | 57 | 
...
Commit: https://github.com/openvm-org/openvm/commit/b9ea0925c7596be8cceb6a278277047ec0187889
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19349543262)

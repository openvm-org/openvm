...
| `total_proof_time_ms ` |  731.50 |  1,463 |  813 |  650 |
...
| `execute_preflight_insn_mi/s` |  13.73 | -          |  18.32 |  9.14 |
| `trace_gen_time_ms   ` |  177.50 |  355 |  194 |  161 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  366 |  732 |  378 |  354 |
| `main_trace_commit_time_ms` |  62.50 |  125 |  71 |  54 |
| `generate_perm_trace_time_ms` |  55 |  110 |  72 |  38 |
| `perm_trace_commit_time_ms` |  77.35 |  154.70 |  89.57 |  65.13 |
| `quotient_poly_compute_time_ms` |  79.53 |  159.05 |  87.84 |  71.22 |
| `quotient_poly_commit_time_ms` |  16.93 |  33.86 |  19.08 |  14.78 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 650 | 1 | 91 | 1,745,742 | 19.03 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 161 | 813 | 32,689,110 | 172,558,444 | 161 | 378 | 0 | 87.84 | 19.08 | 6 | 89.57 | 68 | 130 | 68 | 1 | 71 | 16,059,916 | 38 | 130 | 1,157,000 | 9.14 | 26 | 107 | 1 | 68 | 
| pairing | 1 | 194 | 650 | 22,314,288 | 119,958,502 | 194 | 354 | 1 | 71.22 | 14.78 | 6 | 65.13 | 72 | 140 | 72 | 0 | 54 | 9,408,294 | 72 | 60 | 588,742 | 18.32 | 20 | 86 | 1 | 72 | 

...
| `total_proof_time_ms ` |  747 |  1,494 |  833 |  661 |
...
| `execute_preflight_insn_mi/s` |  13.55 | -          |  18.04 |  9.06 |
| `trace_gen_time_ms   ` |  179.50 |  359 |  194 |  165 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  372.50 |  745 |  384 |  361 |
| `main_trace_commit_time_ms` |  65 |  130 |  75 |  55 |
| `generate_perm_trace_time_ms` |  56 |  112 |  72 |  40 |
| `perm_trace_commit_time_ms` |  77.70 |  155.41 |  90.01 |  65.39 |
| `quotient_poly_compute_time_ms` |  78.99 |  157.98 |  86.71 |  71.27 |
| `quotient_poly_commit_time_ms` |  16.07 |  32.14 |  17.68 |  14.46 |
| `pcs_opening_time_ms ` |  73 |  146 |  77 |  69 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 661 | 1 | 91 | 1,745,742 | 19.13 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 165 | 833 | 32,689,110 | 172,558,444 | 165 | 384 | 0 | 86.71 | 17.68 | 7 | 90.01 | 69 | 134 | 69 | 1 | 75 | 16,059,916 | 40 | 132 | 1,157,000 | 9.06 | 26 | 105 | 1 | 69 | 
| pairing | 1 | 194 | 661 | 22,314,288 | 119,958,502 | 194 | 361 | 1 | 71.27 | 14.46 | 6 | 65.39 | 77 | 141 | 77 | 0 | 55 | 9,408,294 | 72 | 63 | 588,742 | 18.04 | 20 | 86 | 1 | 77 | 

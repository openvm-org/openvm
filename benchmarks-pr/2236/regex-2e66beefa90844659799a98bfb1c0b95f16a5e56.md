...
| `total_proof_time_ms ` |  588.75 |  2,355 |  735 |  536 |
...
| `execute_preflight_insn_mi/s` |  31.79 | -          |  33.21 |  28.96 |
| `trace_gen_time_ms   ` |  179 |  716 |  211 |  156 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  290 |  1,160 |  335 |  268 |
| `main_trace_commit_time_ms` |  51 |  204 |  56 |  49 |
| `generate_perm_trace_time_ms` |  34.50 |  138 |  54 |  19 |
| `perm_trace_commit_time_ms` |  63.41 |  253.64 |  67.62 |  55.48 |
| `quotient_poly_compute_time_ms` |  56.99 |  227.98 |  70.14 |  52.16 |
| `quotient_poly_commit_time_ms` |  14.98 |  59.93 |  17.60 |  12.67 |
| `pcs_opening_time_ms ` |  65.75 |  263 |  84 |  56 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 539 | 1 | 38 | 4,137,502 | 107.95 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 211 | 735 | 23,446,148 | 150,778,428 | 211 | 335 | 0 | 52.16 | 17.60 | 5 | 67.62 | 84 | 123 | 83 | 4 | 56 | 10,899,170 | 54 | 45 | 1,103,000 | 28.96 | 21 | 70 | 1 | 83 | 
| regex_program | 1 | 156 | 545 | 11,598,276 | 128,513,066 | 156 | 283 | 1 | 52.92 | 14.63 | 4 | 64.46 | 62 | 103 | 62 | 0 | 49 | 2,196,106 | 38 | 64 | 1,104,000 | 32.35 | 16 | 68 | 0 | 62 | 
| regex_program | 2 | 164 | 536 | 11,579,064 | 128,513,066 | 164 | 274 | 1 | 52.76 | 15.03 | 4 | 66.08 | 61 | 94 | 61 | 0 | 50 | 2,177,334 | 27 | 57 | 1,104,000 | 33.21 | 16 | 68 | 0 | 61 | 
| regex_program | 3 | 185 | 539 | 11,853,872 | 103,456,394 | 185 | 268 | 0 | 70.14 | 12.67 | 5 | 55.48 | 56 | 78 | 56 | 0 | 49 | 2,422,606 | 19 | 44 | 826,502 | 32.64 | 18 | 83 | 1 | 56 | 

...
| `total_proof_time_ms ` |  580.25 |  2,321 |  714 |  531 |
...
| `execute_preflight_time_ms` |  55.50 |  222 |  67 |  46 |
| `execute_preflight_insn_mi/s` |  29.95 | -          |  31.55 |  28.17 |
| `trace_gen_time_ms   ` |  174.50 |  698 |  209 |  153 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  283 |  1,132 |  314 |  268 |
| `main_trace_commit_time_ms` |  51.25 |  205 |  56 |  49 |
| `generate_perm_trace_time_ms` |  33.75 |  135 |  55 |  19 |
| `perm_trace_commit_time_ms` |  63.56 |  254.23 |  69.39 |  55.16 |
| `quotient_poly_compute_time_ms` |  58.10 |  232.38 |  70.32 |  51.33 |
| `quotient_poly_commit_time_ms` |  15.09 |  60.37 |  17.69 |  12.86 |
| `pcs_opening_time_ms ` |  57.75 |  231 |  61 |  55 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 536 | 1 | 37 | 4,137,502 | 109.80 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 209 | 714 | 23,446,148 | 150,778,428 | 209 | 314 | 0 | 59.03 | 17.69 | 5 | 69.39 | 55 | 125 | 55 | 4 | 56 | 10,899,170 | 55 | 46 | 1,103,000 | 28.17 | 21 | 77 | 1 | 55 | 
| regex_program | 1 | 153 | 540 | 11,598,276 | 128,513,066 | 153 | 279 | 1 | 51.33 | 15.44 | 4 | 65.32 | 59 | 101 | 59 | 0 | 50 | 2,196,106 | 35 | 67 | 1,104,000 | 31.55 | 17 | 67 | 0 | 59 | 
| regex_program | 2 | 156 | 531 | 11,579,064 | 128,513,066 | 156 | 271 | 1 | 51.70 | 14.37 | 4 | 64.36 | 61 | 91 | 61 | 0 | 50 | 2,177,334 | 26 | 63 | 1,104,000 | 28.64 | 16 | 66 | 0 | 61 | 
| regex_program | 3 | 180 | 536 | 11,853,872 | 103,456,394 | 180 | 268 | 0 | 70.32 | 12.86 | 5 | 55.16 | 56 | 77 | 56 | 0 | 49 | 2,422,606 | 19 | 46 | 826,502 | 31.44 | 18 | 84 | 1 | 56 | 

...
|:---|---:|---:|---:|
| Total |  10.03 |  6.98 |  6.98 |
| app_proof |  8.35 |  5.30 |  5.30 |
| leaf |  1 |  1 |  1 |
...
| `total_proof_time_ms ` |  4,125 |  8,250 |  5,200 |  3,050 |
| `compile_metered_time_ms` |  4 |  4 |  4 |  4 |
| `execute_metered_time_ms` |  99 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  111.93 | -          |  111.93 |  111.93 |
| `execute_preflight_insns` |  5,583,980.50 |  11,167,961 |  7,124,000 |  4,043,961 |
| `execute_preflight_time_ms` |  269 |  538 |  298 |  240 |
| `execute_preflight_insn_mi/s` |  34.44 | -          |  36.40 |  32.48 |
| `trace_gen_time_ms   ` |  125.50 |  251 |  176 |  75 |
| `set_initial_memory_time_ms` |  89.50 |  179 |  138 |  41 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  3,640 |  7,280 |  4,645 |  2,635 |
| `prover.main_trace_commit_time_ms` |  959.50 |  1,919 |  1,330 |  589 |
| `prover.rap_constraints_time_ms` |  1,975 |  3,950 |  2,431 |  1,519 |
| `prover.openings_time_ms` |  704 |  1,408 |  883 |  525 |
| `prover.rap_constraints.logup_gkr_time_ms` |  554.50 |  1,109 |  592 |  517 |
| `prover.rap_constraints.round0_time_ms` |  1,040 |  2,080 |  1,348 |  732 |
| `prover.rap_constraints.mle_rounds_time_ms` |  379.50 |  759 |  489 |  270 |
| `prover.openings.stacked_reduction_time_ms` |  164.50 |  329 |  211 |  118 |
...
| `prover.openings.whir_time_ms` |  539.50 |  1,079 |  672 |  407 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,001 |  1,001 |  1,001 |  1,001 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/f93ba4e24941e820448f8248f6d6da95ab2d8956/sha2_bench-f93ba4e24941e820448f8248f6d6da95ab2d8956.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 68 |  |  |  | 337 |  |  |  |  |  |  | 
| app_proof |  |  |  | 3,050 |  | 99 | 11,167,961 | 111.93 | 0 | 8,357 |  | 
...
| leaf | 0 | 110 | 1,001 | 110 | 34 | 17 | 2 | 7 | 7 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 325 | 116 | 0 | 0 | 108 | 34 | 34 | 51 | 21 | 0 | 99 | 86 | 13 | 3 | 9 | 117 | 116 | 108 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 169 | 46 | 0 | 0 | 66 | 24 | 23 | 28 | 14 | 0 | 55 | 47 | 8 | 1 | 6 | 47 | 46 | 66 | 0 | 3 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 142 | 32 | 0 | 0 | 61 | 22 | 22 | 24 | 14 | 0 | 47 | 40 | 7 | 1 | 5 | 32 | 32 | 61 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 237,896,248 | 890 | 372 | 0 | 0 | 225 | 107 | 106 | 67 | 50 | 0 | 292 | 255 | 37 | 19 | 17 | 372 | 372 | 225 | 0 | 11 | 49 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,288,077,561 | 4,645 | 1,330 | 0 | 0 | 2,431 | 1,348 | 1,348 | 489 | 592 | 0 | 883 | 672 | 211 | 132 | 78 | 1,330 | 1,330 | 2,431 | 0 | 5 | 591 | 0 | 0 | 
| app_proof | prover | 1 | 751,206,644 | 2,635 | 589 | 0 | 0 | 1,519 | 732 | 731 | 270 | 517 | 0 | 525 | 407 | 118 | 72 | 45 | 589 | 589 | 1,519 | 0 | 7 | 515 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 138 | 2 | 176 | 5,200 | 176 | 138 | 13,329,494,472 | 2,141,911,524 | 15,471,405,996 | 2,097,152 | 0 | 4 | 240 | 7,124,000 | 32.48 | 
| app_proof | 1 | 41 | 1 | 75 | 3,050 | 75 | 41 | 7,598,498,184 | 1,557,865,504 | 9,156,363,688 | 2,097,152 | 0 | 2 | 298 | 4,043,961 | 36.40 | 

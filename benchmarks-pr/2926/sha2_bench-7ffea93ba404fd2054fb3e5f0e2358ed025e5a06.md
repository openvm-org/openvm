...
|:---|---:|---:|---:|
| Total |  10.02 |  6.98 |  6.98 |
| app_proof |  8.33 |  5.29 |  5.29 |
| leaf |  1.01 |  1.01 |  1.01 |
...
| `total_proof_time_ms ` |  4,115 |  8,230 |  5,189 |  3,041 |
| `compile_metered_time_ms` |  4 |  4 |  4 |  4 |
| `execute_metered_time_ms` |  98 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  113.18 | -          |  113.18 |  113.18 |
| `execute_preflight_insns` |  5,583,980.50 |  11,167,961 |  7,124,000 |  4,043,961 |
| `execute_preflight_time_ms` |  247 |  494 |  283 |  211 |
| `execute_preflight_insn_mi/s` |  39.29 | -          |  41.42 |  37.15 |
| `trace_gen_time_ms   ` |  122 |  244 |  171 |  73 |
| `set_initial_memory_time_ms` |  88.50 |  177 |  136 |  41 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  3,656 |  7,312 |  4,669 |  2,643 |
| `prover.main_trace_commit_time_ms` |  966.50 |  1,933 |  1,339 |  594 |
| `prover.rap_constraints_time_ms` |  1,978.50 |  3,957 |  2,436 |  1,521 |
| `prover.openings_time_ms` |  710 |  1,420 |  892 |  528 |
| `prover.rap_constraints.logup_gkr_time_ms` |  556 |  1,112 |  596 |  516 |
| `prover.rap_constraints.round0_time_ms` |  1,038 |  2,076 |  1,345 |  731 |
| `prover.rap_constraints.mle_rounds_time_ms` |  383 |  766 |  494 |  272 |
| `prover.openings.stacked_reduction_time_ms` |  166 |  332 |  214 |  118 |
| `prover.openings.stacked_reduction.round0_time_ms` |  102.50 |  205 |  134 |  71 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  62.50 |  125 |  79 |  46 |
| `prover.openings.whir_time_ms` |  543.50 |  1,087 |  678 |  409 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,012 |  1,012 |  1,012 |  1,012 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/7ffea93ba404fd2054fb3e5f0e2358ed025e5a06/sha2_bench-7ffea93ba404fd2054fb3e5f0e2358ed025e5a06.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 70 |  |  |  | 345 |  |  |  |  |  |  | 
| app_proof |  |  |  | 3,041 |  | 98 | 11,167,961 | 113.18 | 0 | 8,335 |  | 
...
| leaf | 0 | 111 | 1,012 | 110 | 34 | 17 | 2 | 7 | 7 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 330 | 117 | 0 | 0 | 110 | 34 | 34 | 52 | 22 | 0 | 102 | 88 | 13 | 3 | 9 | 118 | 117 | 110 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 170 | 47 | 0 | 0 | 67 | 25 | 24 | 28 | 14 | 0 | 54 | 46 | 8 | 1 | 6 | 47 | 47 | 67 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 138 | 31 | 0 | 0 | 63 | 24 | 23 | 24 | 14 | 0 | 41 | 34 | 7 | 1 | 5 | 32 | 31 | 63 | 0 | 2 | 13 | 0 | 0 | 
| leaf | 0 | prover | 237,929,016 | 901 | 375 | 0 | 0 | 230 | 110 | 110 | 68 | 50 | 0 | 294 | 256 | 37 | 20 | 17 | 376 | 375 | 230 | 0 | 10 | 50 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,286,242,554 | 4,669 | 1,339 | 0 | 0 | 2,436 | 1,345 | 1,344 | 494 | 596 | 0 | 892 | 678 | 214 | 134 | 79 | 1,339 | 1,339 | 2,436 | 0 | 5 | 595 | 0 | 0 | 
| app_proof | prover | 1 | 750,289,144 | 2,643 | 593 | 0 | 0 | 1,521 | 731 | 731 | 272 | 516 | 0 | 528 | 409 | 118 | 71 | 46 | 594 | 593 | 1,521 | 0 | 6 | 515 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 136 | 1 | 171 | 5,189 | 171 | 136 | 13,311,936,132 | 2,137,449,780 | 15,449,385,912 | 2,097,152 | 0 | 4 | 211 | 7,124,000 | 37.15 | 
| app_proof | 1 | 41 | 1 | 73 | 3,041 | 73 | 41 | 7,588,526,580 | 1,502,398,413 | 9,090,924,993 | 2,097,152 | 0 | 2 | 283 | 4,043,961 | 41.42 | 

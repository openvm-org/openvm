...
| `total_proof_time_ms ` |  4,063.50 |  8,127 |  5,143 |  2,984 |
...
| `execute_preflight_time_ms` |  253.50 |  507 |  279 |  228 |
| `execute_preflight_insn_mi/s` |  35.70 | -          |  37.53 |  33.87 |
| `trace_gen_time_ms   ` |  126 |  252 |  177 |  75 |
| `set_initial_memory_time_ms` |  87.50 |  175 |  134 |  41 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  3,595 |  7,190 |  4,602 |  2,588 |
| `prover.main_trace_commit_time_ms` |  961.50 |  1,923 |  1,335 |  588 |
| `prover.rap_constraints_time_ms` |  1,934.50 |  3,869 |  2,383 |  1,486 |
| `prover.openings_time_ms` |  698 |  1,396 |  883 |  513 |
| `prover.rap_constraints.logup_gkr_time_ms` |  547.50 |  1,095 |  590 |  505 |
| `prover.rap_constraints.round0_time_ms` |  1,009 |  2,018 |  1,306 |  712 |
| `prover.rap_constraints.mle_rounds_time_ms` |  377 |  754 |  486 |  268 |
| `prover.openings.stacked_reduction_time_ms` |  159.50 |  319 |  208 |  111 |
| `prover.openings.stacked_reduction.round0_time_ms` |  98 |  196 |  131 |  65 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  61 |  122 |  77 |  45 |
| `prover.openings.whir_time_ms` |  538 |  1,076 |  674 |  402 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/99060bf0ecd740a70193f005a3567028675abd5e/sha2_bench-99060bf0ecd740a70193f005a3567028675abd5e.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 68 |  |  |  | 341 |  |  |  |  |  |  | 
| app_proof |  |  |  | 2,984 |  | 99 | 11,167,961 | 112.06 | 0 | 8,233 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 326 | 116 | 0 | 0 | 108 | 36 | 35 | 51 | 20 | 0 | 101 | 87 | 13 | 3 | 9 | 116 | 116 | 108 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 173 | 47 | 0 | 0 | 66 | 24 | 24 | 28 | 13 | 0 | 58 | 50 | 8 | 1 | 6 | 47 | 47 | 66 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 137 | 32 | 0 | 0 | 61 | 22 | 22 | 24 | 14 | 0 | 42 | 35 | 7 | 1 | 5 | 32 | 32 | 61 | 0 | 2 | 13 | 0 | 0 | 
| leaf | 0 | prover | 237,896,248 | 890 | 370 | 0 | 0 | 225 | 108 | 107 | 66 | 51 | 0 | 294 | 256 | 37 | 20 | 17 | 370 | 370 | 225 | 0 | 9 | 49 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,288,077,561 | 4,602 | 1,335 | 0 | 0 | 2,383 | 1,306 | 1,306 | 486 | 590 | 1 | 883 | 674 | 208 | 131 | 77 | 1,335 | 1,335 | 2,383 | 0 | 4 | 588 | 0 | 0 | 
| app_proof | prover | 1 | 751,206,644 | 2,588 | 587 | 0 | 0 | 1,486 | 712 | 712 | 268 | 505 | 0 | 513 | 402 | 111 | 65 | 45 | 588 | 587 | 1,486 | 0 | 5 | 503 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 134 | 1 | 177 | 5,143 | 177 | 134 | 13,329,494,472 | 2,141,911,524 | 15,471,405,996 | 2,097,152 | 0 | 3 | 228 | 7,124,000 | 33.87 | 
| app_proof | 1 | 41 | 1 | 75 | 2,984 | 75 | 41 | 7,598,498,184 | 1,557,865,504 | 9,156,363,688 | 2,097,152 | 0 | 2 | 279 | 4,043,961 | 37.53 | 

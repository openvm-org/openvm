...
| `total_proof_time_ms ` |  769.25 |  3,077 |  932 |  554 |
...
| `execute_preflight_time_ms` |  93.25 |  373 |  123 |  45 |
| `execute_preflight_insn_mi/s` |  48.81 | -          |  50.35 |  44.83 |
| `trace_gen_time_ms   ` |  130.50 |  522 |  171 |  102 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  472.50 |  1,890 |  542 |  295 |
| `prover.main_trace_commit_time_ms` |  98.25 |  393 |  113 |  59 |
| `prover.rap_constraints_time_ms` |  273.25 |  1,093 |  312 |  169 |
| `prover.openings_time_ms` |  100.25 |  401 |  116 |  66 |
| `prover.rap_constraints.logup_gkr_time_ms` |  195.25 |  781 |  221 |  118 |
| `prover.rap_constraints.round0_time_ms` |  51.50 |  206 |  61 |  32 |
| `prover.rap_constraints.mle_rounds_time_ms` |  24.75 |  99 |  28 |  17 |
| `prover.openings.stacked_reduction_time_ms` |  19 |  76 |  22 |  12 |
...
| `prover.openings.whir_time_ms` |  81 |  324 |  94 |  53 |
...
| `prover.rap_constraints.mle_rounds_time_ms` |  55 |  55 |  55 |  55 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/c55ccb3e4eecbd5dfbc84cf8cfa8e5414cddc140/fibonacci-c55ccb3e4eecbd5dfbc84cf8cfa8e5414cddc140.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 78 |  |  |  | 374 |  |  |  |  |  |  | 
| app_proof |  |  |  | 554 |  | 68 | 12,000,265 | 176.06 | 0 | 3,152 |  | 
...
| app_proof | VmAirWrapper<Rv32BaseAluAdapterAir, BaseAluCoreAir<4, 8> | 1 | 9 | 10 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 328 | 117 | 0 | 0 | 110 | 36 | 35 | 52 | 20 | 0 | 100 | 86 | 14 | 3 | 10 | 117 | 117 | 110 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 169 | 46 | 0 | 0 | 68 | 25 | 24 | 28 | 14 | 0 | 53 | 44 | 8 | 1 | 6 | 47 | 46 | 68 | 0 | 3 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 137 | 31 | 0 | 0 | 64 | 25 | 24 | 25 | 13 | 0 | 41 | 33 | 7 | 1 | 5 | 31 | 31 | 64 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 147,934,254 | 607 | 233 | 0 | 0 | 186 | 84 | 83 | 55 | 46 | 0 | 187 | 162 | 24 | 12 | 12 | 233 | 233 | 186 | 0 | 8 | 44 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 136,618,054 | 542 | 112 | 0 | 0 | 312 | 61 | 61 | 28 | 221 | 0 | 116 | 94 | 22 | 12 | 9 | 113 | 112 | 312 | 0 | 3 | 220 | 0 | 0 | 
| app_proof | prover | 1 | 136,570,716 | 526 | 109 | 0 | 0 | 305 | 56 | 56 | 27 | 221 | 0 | 111 | 90 | 21 | 12 | 9 | 109 | 109 | 305 | 0 | 3 | 220 | 0 | 0 | 
| app_proof | prover | 2 | 136,570,716 | 527 | 112 | 0 | 0 | 307 | 57 | 56 | 27 | 221 | 0 | 108 | 87 | 21 | 12 | 9 | 112 | 112 | 306 | 0 | 3 | 220 | 0 | 0 | 
| app_proof | prover | 3 | 70,295,004 | 295 | 59 | 0 | 0 | 169 | 32 | 32 | 17 | 118 | 0 | 66 | 53 | 12 | 6 | 6 | 59 | 59 | 169 | 0 | 3 | 117 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 161 | 125 | 932 | 125 | 161 | 2,770,197,065 | 323,292,691 | 3,093,489,756 | 2,097,152 | 0 | 3 | 102 | 3,495,000 | 44.83 | 
| app_proof | 1 | 41 | 102 | 794 | 102 | 41 | 2,768,862,357 | 322,353,414 | 3,091,215,771 | 2,097,152 | 0 | 2 | 123 | 3,495,000 | 50.09 | 
| app_proof | 2 | 41 | 124 | 797 | 124 | 41 | 2,768,862,357 | 322,353,414 | 3,091,215,771 | 2,097,152 | 0 | 2 | 103 | 3,495,000 | 50.35 | 
| app_proof | 3 | 41 | 171 | 554 | 171 | 41 | 1,230,956,171 | 342,871,578 | 1,573,827,749 | 2,097,152 | 0 | 2 | 45 | 1,515,265 | 49.96 | 

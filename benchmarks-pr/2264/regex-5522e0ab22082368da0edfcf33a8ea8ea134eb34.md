...
|:---|---:|---:|
| Total | <span style='color: red'>(+0 [+0.1%])</span> 2.37 | <span style='color: red'>(+0 [+2.8%])</span> 0.78 |
| regex_program |  2.33 | <span style='color: red'>(+0 [+2.6%])</span> 0.74 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  583 |  2,332 | <span style='color: red'>(+19 [+2.6%])</span> 743 | <span style='color: green'>(-14 [-2.6%])</span> 520 |
...
| `execute_metered_insn_mi/s` | <span style='color: green'>(-5 [-4.1%])</span> 110.46 | -          | <span style='color: green'>(-5 [-4.1%])</span> 110.46 | <span style='color: green'>(-5 [-4.1%])</span> 110.46 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` | <span style='color: red'>(+3 [+5.2%])</span> 56 | <span style='color: red'>(+11 [+5.2%])</span> 224 | <span style='color: red'>(+3 [+4.6%])</span> 68 | <span style='color: red'>(+3 [+6.8%])</span> 47 |
| `execute_preflight_insn_mi/s` | <span style='color: green'>(-1 [-3.2%])</span> 30.61 | -          | <span style='color: green'>(-1 [-3.6%])</span> 31.72 | <span style='color: green'>(-1 [-4.0%])</span> 27.49 |
| `trace_gen_time_ms   ` | <span style='color: green'>(-2 [-1.3%])</span> 175 | <span style='color: green'>(-9 [-1.3%])</span> 700 |  210 | <span style='color: green'>(-3 [-1.9%])</span> 151 |
| `memory_finalize_time_ms` |  1 |  4 |  4 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: green'>(-1 [-0.4%])</span> 283.25 | <span style='color: green'>(-4 [-0.4%])</span> 1,133 | <span style='color: red'>(+15 [+4.6%])</span> 338 | <span style='color: green'>(-6 [-2.3%])</span> 258 |
| `main_trace_commit_time_ms` | <span style='color: red'>(+1 [+2.0%])</span> 51.25 | <span style='color: red'>(+4 [+2.0%])</span> 205 | <span style='color: red'>(+2 [+3.6%])</span> 57 | <span style='color: red'>(+1 [+2.1%])</span> 49 |
| `generate_perm_trace_time_ms` | <span style='color: green'>(-0 [-0.7%])</span> 34.25 | <span style='color: green'>(-1 [-0.7%])</span> 137 |  55 | <span style='color: red'>(+1 [+5.6%])</span> 19 |
| `perm_trace_commit_time_ms` | <span style='color: red'>(+0 [+0.2%])</span> 63.80 | <span style='color: red'>(+0 [+0.2%])</span> 255.21 | <span style='color: red'>(+2 [+2.6%])</span> 70.96 | <span style='color: green'>(-0 [-0.5%])</span> 54.99 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+0 [+0.3%])</span> 58.17 | <span style='color: red'>(+1 [+0.3%])</span> 232.68 | <span style='color: red'>(+2 [+2.9%])</span> 70.32 | <span style='color: red'>(+0 [+0.6%])</span> 51.88 |
| `quotient_poly_commit_time_ms` | <span style='color: green'>(-0 [-2.9%])</span> 14.64 | <span style='color: green'>(-2 [-2.9%])</span> 58.58 | <span style='color: green'>(-1 [-7.5%])</span> 16.60 | <span style='color: red'>(+0 [+1.6%])</span> 12.58 |
| `pcs_opening_time_ms ` | <span style='color: green'>(-1 [-2.1%])</span> 57.75 | <span style='color: green'>(-5 [-2.1%])</span> 231 | <span style='color: red'>(+15 [+24.2%])</span> 77 | <span style='color: green'>(-8 [-14.5%])</span> 47 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 538 | 1 | 37 | 4,137,502 | 110.46 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 210 | 743 | 23,446,148 | 150,778,428 | 210 | 338 | 0 | 58.01 | 16.60 | 5 | 70.96 | 77 | 127 | 77 | 4 | 57 | 10,899,170 | 55 | 48 | 1,103,000 | 27.49 | 21 | 75 | 1 | 77 | 
| regex_program | 1 | 151 | 531 | 11,598,276 | 128,513,066 | 151 | 270 | 1 | 52.47 | 14.38 | 4 | 64.28 | 51 | 100 | 51 | 0 | 49 | 2,196,106 | 36 | 68 | 1,104,000 | 31.71 | 16 | 67 | 0 | 51 | 
| regex_program | 2 | 158 | 520 | 11,579,064 | 128,513,066 | 158 | 258 | 1 | 51.88 | 15.02 | 4 | 64.99 | 47 | 92 | 47 | 0 | 50 | 2,177,334 | 27 | 61 | 1,104,000 | 31.50 | 16 | 67 | 0 | 47 | 
| regex_program | 3 | 181 | 538 | 11,853,872 | 103,456,394 | 181 | 267 | 0 | 70.32 | 12.58 | 5 | 54.99 | 56 | 77 | 56 | 0 | 49 | 2,422,606 | 19 | 47 | 826,502 | 31.72 | 18 | 84 | 1 | 56 | 

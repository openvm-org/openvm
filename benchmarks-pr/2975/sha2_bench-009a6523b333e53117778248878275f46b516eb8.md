...
|:---|---:|---:|---:|
| Total |  9.74 |  6.76 |  6.76 |
| app_proof |  8.06 |  5.08 |  5.08 |
...
| `total_proof_time_ms ` |  3,985.50 |  7,971 |  4,999 |  2,972 |
...
| `execute_preflight_time_ms` |  242.50 |  485 |  279 |  206 |
| `execute_preflight_insn_mi/s` |  37.45 | -          |  39.77 |  35.14 |
| `trace_gen_time_ms   ` |  121 |  242 |  170 |  72 |
| `set_initial_memory_time_ms` |  0 |  0 |  0 |  0 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  3,620.50 |  7,241 |  4,621 |  2,620 |
| `prover.main_trace_commit_time_ms` |  955.50 |  1,911 |  1,321 |  590 |
| `prover.rap_constraints_time_ms` |  1,957 |  3,914 |  2,410 |  1,504 |
| `prover.openings_time_ms` |  706.50 |  1,413 |  888 |  525 |
| `prover.rap_constraints.logup_gkr_time_ms` |  552.50 |  1,105 |  591 |  514 |
| `prover.rap_constraints.round0_time_ms` |  1,026.50 |  2,053 |  1,333 |  720 |
| `prover.rap_constraints.mle_rounds_time_ms` |  377 |  754 |  485 |  269 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/009a6523b333e53117778248878275f46b516eb8/sha2_bench-009a6523b333e53117778248878275f46b516eb8.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 70 |  |  |  | 339 |  |  |  |  |  |  | 
| app_proof |  |  |  | 2,972 |  | 86 | 11,167,961 | 129.11 | 0 | 8,063 |  | 
...
| leaf | 0 | 109 | 999 | 109 | 35 | 17 | 2 | 7 | 7 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 332 | 117 | 0 | 0 | 108 | 35 | 35 | 51 | 20 | 0 | 106 | 92 | 13 | 3 | 9 | 117 | 117 | 108 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 169 | 46 | 0 | 0 | 67 | 25 | 24 | 27 | 13 | 0 | 55 | 47 | 8 | 1 | 6 | 46 | 46 | 67 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 136 | 32 | 0 | 0 | 61 | 23 | 22 | 24 | 13 | 0 | 41 | 34 | 7 | 1 | 5 | 33 | 32 | 61 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 237,929,016 | 890 | 372 | 0 | 0 | 228 | 109 | 108 | 67 | 50 | 0 | 289 | 251 | 37 | 20 | 17 | 372 | 372 | 228 | 0 | 10 | 50 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,286,242,554 | 4,621 | 1,321 | 0 | 0 | 2,410 | 1,333 | 1,333 | 485 | 591 | 0 | 888 | 675 | 213 | 133 | 80 | 1,321 | 1,321 | 2,410 | 0 | 5 | 590 | 0 | 0 | 
| app_proof | prover | 1 | 750,289,144 | 2,620 | 590 | 0 | 0 | 1,504 | 720 | 720 | 269 | 514 | 0 | 525 | 407 | 117 | 71 | 46 | 590 | 590 | 1,504 | 0 | 6 | 513 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 0 | 1 | 170 | 4,999 | 170 | 0 | 13,306,647,852 | 2,134,713,996 | 15,441,361,848 | 2,097,152 | 0 | 3 | 206 | 7,124,000 | 35.14 | 
| app_proof | 1 | 0 | 1 | 72 | 2,972 | 72 | 0 | 7,584,540,132 | 1,503,573,469 | 9,088,113,601 | 2,097,152 | 0 | 2 | 279 | 4,043,961 | 39.77 | 

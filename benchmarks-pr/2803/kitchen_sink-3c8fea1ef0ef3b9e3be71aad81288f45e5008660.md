...
| `total_proof_time_ms ` |  957.50 |  1,915 |  1,237 |  678 |
...
| `execute_preflight_insn_mi/s` |  34.37 | -          |  35.23 |  33.52 |
| `trace_gen_time_ms   ` |  25.50 |  51 |  35 |  16 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  722.50 |  1,445 |  959 |  486 |
| `prover.main_trace_commit_time_ms` |  218 |  436 |  298 |  138 |
| `prover.rap_constraints_time_ms` |  454.50 |  909 |  603 |  306 |
| `prover.openings_time_ms` |  48.50 |  97 |  56 |  41 |
| `prover.rap_constraints.logup_gkr_time_ms` |  85 |  170 |  116 |  54 |
| `prover.rap_constraints.round0_time_ms` |  265.50 |  531 |  354 |  177 |
| `prover.rap_constraints.mle_rounds_time_ms` |  103.50 |  207 |  132 |  75 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/3c8fea1ef0ef3b9e3be71aad81288f45e5008660/kitchen_sink-3c8fea1ef0ef3b9e3be71aad81288f45e5008660.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 68 | 3 |  |  | 0 |  | 348 | 3 |  |  |  |  |  |  | 
| app_proof |  |  |  |  |  | 678 |  |  | 34 | 2,579,903 | 74.18 | 0 | 1,954 |  | 
...
| leaf | 0 | 112 | 412 | 112 | 24 | 9 | 21 | 5 | 5 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 567,917,156 | 959 | 298 | 0 | 167 | 603 | 354 | 352 | 132 | 116 | 59 | 56 | 14 | 42 | 16 | 26 | 298 | 603 | 0 | 1 | 55 | 0 | 0 | 
| app_proof | prover | 1 | 537,266,124 | 486 | 138 | 0 | 1 | 306 | 177 | 176 | 75 | 54 | 0 | 41 | 12 | 28 | 14 | 13 | 138 | 306 | 0 | 1 | 53 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 35 | 1,237 | 35 | 178 | 0 | 3 | 64 | 1,540,000 | 33.52 | 
| app_proof | 1 | 16 | 678 | 16 | 40 | 0 | 1 | 134 | 1,039,903 | 35.23 | 

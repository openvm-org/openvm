...
|:---|---:|---:|---:|
| Total |  12.28 |  3.52 |  3.52 |
| app_proof |  10.10 |  1.83 |  1.83 |
| leaf |  1.43 |  0.95 |  0.95 |
| internal_for_leaf |  0.45 |  0.45 |  0.45 |
...
| `total_proof_time_ms ` |  1,660.83 |  9,965 |  1,689 |  1,615 |
| `execute_metered_time_ms` |  137 | -          | -          | -          |
| `execute_metered_insns` |  14,793,960 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  107.52 | -          |  107.52 |  107.52 |
| `execute_preflight_insns` |  2,465,660 |  14,793,960 |  2,625,000 |  1,670,960 |
| `execute_preflight_time_ms` |  121.83 |  731 |  153 |  86 |
| `execute_preflight_insn_mi/s` |  41.04 | -          |  41.85 |  37.65 |
| `trace_gen_time_ms   ` |  157.17 |  943 |  190 |  134 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,245.17 |  7,471 |  1,270 |  1,209 |
| `prover.main_trace_commit_time_ms` |  280.17 |  1,681 |  281 |  279 |
| `prover.rap_constraints_time_ms` |  881.67 |  5,290 |  906 |  844 |
| `prover.openings_time_ms` |  82.67 |  496 |  87 |  79 |
| `prover.rap_constraints.logup_gkr_time_ms` |  284.33 |  1,706 |  301 |  236 |
| `prover.rap_constraints.round0_time_ms` |  433.17 |  2,599 |  448 |  378 |
| `prover.rap_constraints.mle_rounds_time_ms` |  163 |  978 |  166 |  158 |
| `prover.openings.stacked_reduction_time_ms` |  52.83 |  317 |  53 |  52 |
| `prover.openings.stacked_reduction.round0_time_ms` |  30.83 |  185 |  31 |  30 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  21.17 |  127 |  22 |  21 |
| `prover.openings.whir_time_ms` |  29.33 |  176 |  34 |  26 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  716 |  1,432 |  951 |  481 |
| `execute_preflight_time_ms` |  2 |  4 |  2 |  2 |
| `trace_gen_time_ms   ` |  75.50 |  151 |  102 |  49 |
| `generate_blob_total_time_ms` |  9.50 |  19 |  13 |  6 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  640.50 |  1,281 |  849 |  432 |
| `prover.main_trace_commit_time_ms` |  355.50 |  711 |  495 |  216 |
| `prover.rap_constraints_time_ms` |  220.50 |  441 |  277 |  164 |
| `prover.openings_time_ms` |  62.50 |  125 |  75 |  50 |
| `prover.rap_constraints.logup_gkr_time_ms` |  58.50 |  117 |  72 |  45 |
| `prover.rap_constraints.round0_time_ms` |  99 |  198 |  126 |  72 |
...
| `prover.openings.whir_time_ms` |  31 |  62 |  35 |  27 |
...
| `prover.main_trace_commit_time_ms` |  221 |  221 |  221 |  221 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/bc449d4a08299e16d01fac1295cc822f5cf87cae/sha2_bench-bc449d4a08299e16d01fac1295cc822f5cf87cae.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 76 | 9 |  |  | 0 |  | 347 | 9 |  |  |  |  |  |  | 
| app_proof |  |  |  |  |  | 1,656 |  |  | 137 | 14,793,960 | 107.52 | 0 | 10,109 |  | 
| internal_for_leaf |  |  |  | 452 |  |  |  |  |  |  |  |  |  | 452 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 29 | 452 | 29 | 11 | 2 | 2 | 1 | 1 | 
| internal_recursive.0 | 1 | 12 | 165 | 12 | 2 | 1 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 9 | 131 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 102 | 951 | 101 | 37 | 13 | 2 | 3 | 3 | 
| leaf | 1 | 49 | 481 | 48 | 18 | 6 | 2 | 3 | 3 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 75,647,860 | 422 | 220 | 0 | 1 | 160 | 44 | 44 | 85 | 29 | 0 | 40 | 18 | 22 | 7 | 15 | 221 | 160 | 0 | 2 | 28 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,879 | 152 | 48 | 0 | 0 | 72 | 25 | 24 | 29 | 17 | 0 | 31 | 23 | 8 | 1 | 6 | 48 | 72 | 0 | 2 | 16 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 122 | 31 | 0 | 0 | 61 | 23 | 22 | 24 | 13 | 0 | 29 | 22 | 7 | 1 | 5 | 31 | 61 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 266,560,230 | 849 | 495 | 0 | 94 | 277 | 126 | 125 | 78 | 72 | 0 | 75 | 35 | 40 | 21 | 18 | 495 | 277 | 0 | 6 | 72 | 0 | 0 | 
| leaf | 1 | prover | 135,246,516 | 432 | 216 | 0 | 1 | 164 | 72 | 71 | 47 | 45 | 0 | 50 | 27 | 22 | 11 | 11 | 216 | 164 | 0 | 5 | 44 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 353,899,717 | 1,209 | 279 | 0 | 1 | 844 | 378 | 377 | 163 | 301 | 74 | 85 | 31 | 53 | 31 | 22 | 279 | 844 | 0 | 3 | 227 | 0 | 0 | 
| app_proof | prover | 1 | 353,899,532 | 1,265 | 280 | 0 | 1 | 902 | 445 | 445 | 163 | 293 | 73 | 81 | 28 | 53 | 31 | 21 | 281 | 902 | 0 | 3 | 218 | 0 | 0 | 
| app_proof | prover | 2 | 353,899,532 | 1,270 | 280 | 0 | 1 | 902 | 445 | 445 | 165 | 292 | 73 | 87 | 34 | 53 | 31 | 21 | 280 | 902 | 0 | 3 | 218 | 0 | 0 | 
| app_proof | prover | 3 | 353,899,532 | 1,210 | 281 | 0 | 1 | 848 | 448 | 447 | 163 | 236 | 0 | 81 | 28 | 53 | 31 | 21 | 281 | 848 | 0 | 3 | 235 | 0 | 0 | 
| app_proof | prover | 4 | 353,899,532 | 1,270 | 281 | 0 | 1 | 906 | 445 | 445 | 166 | 293 | 74 | 83 | 29 | 53 | 31 | 21 | 281 | 906 | 0 | 3 | 218 | 0 | 0 | 
| app_proof | prover | 5 | 353,980,012 | 1,247 | 279 | 0 | 1 | 888 | 438 | 437 | 158 | 291 | 73 | 79 | 26 | 52 | 30 | 21 | 279 | 888 | 0 | 3 | 216 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 157 | 1,615 | 157 | 161 | 0 | 3 | 86 | 2,623,000 | 37.65 | 
| app_proof | 1 | 134 | 1,688 | 134 | 135 | 0 | 2 | 153 | 2,625,000 | 41.85 | 
| app_proof | 2 | 154 | 1,688 | 154 | 129 | 0 | 2 | 134 | 2,625,000 | 41.80 | 
| app_proof | 3 | 154 | 1,629 | 154 | 129 | 0 | 2 | 134 | 2,625,000 | 41.52 | 
| app_proof | 4 | 154 | 1,689 | 154 | 129 | 0 | 2 | 134 | 2,625,000 | 41.70 | 
| app_proof | 5 | 190 | 1,656 | 190 | 128 | 0 | 2 | 90 | 1,670,960 | 41.71 | 

...
| `execute_metered_insn_mi/s` |  73.44 | -          |  73.44 |  73.44 |
| `execute_preflight_insns` |  1,289,951.50 |  2,579,903 |  1,540,000 |  1,039,903 |
| `execute_preflight_time_ms` |  98 |  196 |  133 |  63 |
| `execute_preflight_insn_mi/s` |  35.92 | -          |  37.03 |  34.80 |
| `trace_gen_time_ms   ` |  26 |  52 |  36 |  16 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  715 |  1,430 |  943 |  487 |
| `prover.main_trace_commit_time_ms` |  215 |  430 |  292 |  138 |
| `prover.rap_constraints_time_ms` |  451 |  902 |  595 |  307 |
| `prover.openings_time_ms` |  48.50 |  97 |  55 |  42 |
| `prover.rap_constraints.logup_gkr_time_ms` |  83.50 |  167 |  112 |  55 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/ccd2dfad935c08db92fc95aff95822fa93a0b0a3/kitchen_sink-ccd2dfad935c08db92fc95aff95822fa93a0b0a3.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 76 | 3 |  |  | 0 |  | 340 | 3 |  |  |  |  |  |  | 
| app_proof |  |  |  |  |  | 679 |  |  | 35 | 2,579,903 | 73.44 | 0 | 1,939 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 17 | 136 | 17 | 6 | 1 | 2 | 1 | 2 | 
| internal_recursive.0 | 1 | 10 | 89 | 9 | 1 | 0 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 8 | 85 | 8 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 111 | 409 | 111 | 23 | 9 | 21 | 4 | 4 | 
...
| leaf | 0 | prover | 265,006,708 | 297 | 128 | 0 | 1 | 140 | 48 | 47 | 37 | 54 | 0 | 27 | 11 | 15 | 7 | 8 | 129 | 140 | 0 | 2 | 53 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 567,917,156 | 943 | 291 | 0 | 160 | 595 | 353 | 352 | 129 | 112 | 55 | 55 | 13 | 41 | 16 | 25 | 292 | 595 | 0 | 1 | 56 | 0 | 0 | 
| app_proof | prover | 1 | 537,266,124 | 487 | 137 | 0 | 2 | 307 | 175 | 175 | 75 | 55 | 0 | 42 | 14 | 27 | 14 | 13 | 138 | 307 | 0 | 1 | 54 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 36 | 1,221 | 36 | 178 | 0 | 3 | 63 | 1,540,000 | 34.80 | 
| app_proof | 1 | 16 | 679 | 16 | 40 | 0 | 1 | 133 | 1,039,903 | 37.03 | 

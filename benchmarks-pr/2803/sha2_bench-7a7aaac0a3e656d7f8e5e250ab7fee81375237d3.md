...
|:---|---:|---:|---:|
| Total |  12.38 |  3.55 |  3.55 |
| app_proof |  10.19 |  1.84 |  1.84 |
| leaf |  1.44 |  0.96 |  0.96 |
...
| `total_proof_time_ms ` |  1,675.67 |  10,054 |  1,708 |  1,621 |
| `execute_metered_time_ms` |  136 | -          | -          | -          |
| `execute_metered_insns` |  14,793,960 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  108.24 | -          |  108.24 |  108.24 |
| `execute_preflight_insns` |  2,465,660 |  14,793,960 |  2,625,000 |  1,670,960 |
| `execute_preflight_time_ms` |  120.83 |  725 |  151 |  84 |
| `execute_preflight_insn_mi/s` |  40.96 | -          |  41.82 |  38.57 |
| `trace_gen_time_ms   ` |  158.83 |  953 |  190 |  137 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,256.83 |  7,541 |  1,286 |  1,212 |
| `prover.main_trace_commit_time_ms` |  281.67 |  1,690 |  282 |  281 |
| `prover.rap_constraints_time_ms` |  890.50 |  5,343 |  920 |  845 |
| `prover.openings_time_ms` |  83.50 |  501 |  90 |  79 |
| `prover.rap_constraints.logup_gkr_time_ms` |  288.17 |  1,729 |  305 |  238 |
| `prover.rap_constraints.round0_time_ms` |  437 |  2,622 |  453 |  379 |
| `prover.rap_constraints.mle_rounds_time_ms` |  164.17 |  985 |  167 |  160 |
| `prover.openings.stacked_reduction_time_ms` |  53.17 |  319 |  54 |  52 |
...
| `prover.openings.whir_time_ms` |  29.83 |  179 |  36 |  26 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  721.50 |  1,443 |  959 |  484 |
| `execute_preflight_time_ms` |  2 |  4 |  2 |  2 |
| `trace_gen_time_ms   ` |  75 |  150 |  101 |  49 |
| `generate_blob_total_time_ms` |  9.50 |  19 |  13 |  6 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  646.50 |  1,293 |  858 |  435 |
| `prover.main_trace_commit_time_ms` |  359.50 |  719 |  500 |  219 |
| `prover.rap_constraints_time_ms` |  220.50 |  441 |  278 |  163 |
| `prover.openings_time_ms` |  65.50 |  131 |  79 |  52 |
| `prover.rap_constraints.logup_gkr_time_ms` |  57.50 |  115 |  71 |  44 |
| `prover.rap_constraints.round0_time_ms` |  99 |  198 |  127 |  71 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/7a7aaac0a3e656d7f8e5e250ab7fee81375237d3/sha2_bench-7a7aaac0a3e656d7f8e5e250ab7fee81375237d3.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 75 | 9 |  |  | 0 |  | 363 | 9 |  |  |  |  |  |  | 
| app_proof |  |  |  |  |  | 1,676 |  |  | 136 | 14,793,960 | 108.24 | 0 | 10,198 |  | 
| internal_for_leaf |  |  |  | 456 |  |  |  |  |  |  |  |  |  | 456 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 29 | 456 | 29 | 10 | 2 | 2 | 1 | 1 | 
| internal_recursive.0 | 1 | 12 | 161 | 12 | 2 | 1 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 9 | 126 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 101 | 959 | 101 | 37 | 13 | 2 | 3 | 3 | 
| leaf | 1 | 49 | 484 | 49 | 18 | 6 | 2 | 3 | 3 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 75,647,860 | 426 | 221 | 0 | 1 | 161 | 46 | 45 | 85 | 30 | 0 | 42 | 20 | 21 | 6 | 15 | 221 | 161 | 0 | 3 | 28 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,879 | 149 | 48 | 0 | 0 | 72 | 25 | 25 | 29 | 17 | 0 | 27 | 18 | 8 | 1 | 6 | 48 | 72 | 0 | 2 | 16 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 117 | 31 | 0 | 0 | 60 | 22 | 22 | 24 | 13 | 0 | 25 | 18 | 7 | 1 | 5 | 31 | 60 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 266,560,230 | 858 | 500 | 0 | 96 | 278 | 127 | 126 | 78 | 71 | 0 | 79 | 38 | 40 | 22 | 18 | 500 | 278 | 0 | 6 | 71 | 0 | 0 | 
| leaf | 1 | prover | 135,246,516 | 435 | 218 | 0 | 1 | 163 | 71 | 70 | 47 | 44 | 0 | 52 | 30 | 22 | 11 | 11 | 219 | 163 | 0 | 6 | 43 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 353,899,717 | 1,212 | 282 | 0 | 1 | 845 | 379 | 378 | 160 | 305 | 76 | 84 | 30 | 54 | 32 | 22 | 282 | 845 | 0 | 3 | 228 | 0 | 0 | 
| app_proof | prover | 1 | 353,899,532 | 1,274 | 282 | 0 | 1 | 908 | 447 | 447 | 166 | 294 | 74 | 83 | 29 | 54 | 32 | 21 | 282 | 908 | 0 | 3 | 218 | 0 | 0 | 
| app_proof | prover | 2 | 353,899,532 | 1,286 | 282 | 0 | 1 | 913 | 449 | 449 | 167 | 295 | 75 | 90 | 36 | 53 | 31 | 21 | 282 | 913 | 0 | 3 | 219 | 0 | 0 | 
| app_proof | prover | 3 | 353,899,532 | 1,220 | 281 | 0 | 1 | 855 | 453 | 453 | 163 | 238 | 0 | 82 | 29 | 53 | 31 | 22 | 281 | 855 | 0 | 4 | 237 | 0 | 0 | 
| app_proof | prover | 4 | 353,899,532 | 1,285 | 281 | 0 | 1 | 920 | 452 | 452 | 167 | 300 | 76 | 83 | 29 | 53 | 31 | 21 | 281 | 920 | 0 | 3 | 223 | 0 | 0 | 
| app_proof | prover | 5 | 353,980,012 | 1,264 | 282 | 0 | 1 | 902 | 442 | 441 | 162 | 297 | 75 | 79 | 26 | 52 | 31 | 21 | 282 | 902 | 0 | 3 | 221 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 160 | 1,621 | 160 | 163 | 0 | 3 | 84 | 2,623,000 | 38.57 | 
| app_proof | 1 | 137 | 1,701 | 137 | 138 | 0 | 2 | 151 | 2,625,000 | 41.77 | 
| app_proof | 2 | 154 | 1,706 | 154 | 131 | 0 | 2 | 134 | 2,625,000 | 40.78 | 
| app_proof | 3 | 155 | 1,642 | 155 | 131 | 0 | 2 | 134 | 2,625,000 | 41.37 | 
| app_proof | 4 | 157 | 1,708 | 157 | 131 | 0 | 2 | 133 | 2,625,000 | 41.82 | 
| app_proof | 5 | 190 | 1,676 | 190 | 131 | 0 | 2 | 89 | 1,670,960 | 41.43 | 

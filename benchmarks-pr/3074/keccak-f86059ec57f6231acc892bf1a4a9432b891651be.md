...
|:---|---:|---:|---:|
| Total |  9.64 |  3.52 |  3.52 |
| app_proof |  7.54 |  1.93 |  1.93 |
| leaf |  1.53 |  1.02 |  1.02 |
...
| `total_proof_time_ms ` |  1,236.17 |  7,417 |  1,364 |  1,197 |
| `compile_metered_time_ms` |  3 |  3 |  3 |  3 |
| `prepare_preflight_time_ms` |  5 |  5 |  5 |  5 |
| `upload_preflight_program_time_ms` |  0 |  0 |  0 |  0 |
| `app_prove_time_ms   ` |  7,559 |  7,559 |  7,559 |  7,559 |
| `execute_metered_time_ms` |  127 | -          | -          | -          |
| `execute_metered_insns` |  14,365,133 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  112.97 | -          |  112.97 |  112.97 |
| `execute_preflight_insns` |  2,394,188.83 |  14,365,133 |  2,413,000 |  2,300,133 |
| `execute_preflight_time_ms` |  92.50 |  555 |  120 |  83 |
| `execute_preflight_insn_mi/s` |  26.02 | -          |  27.53 |  20.02 |
| `postflight_time_ms  ` |  24.50 |  147 |  28 |  23 |
| `trace_gen_time_ms   ` |  12.50 |  75 |  17 |  11 |
| `set_initial_memory_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,094.67 |  6,568 |  1,185 |  1,069 |
| `prover.main_trace_commit_time_ms` |  339.67 |  2,038 |  364 |  332 |
| `prover.rap_constraints_time_ms` |  513 |  3,078 |  515 |  509 |
| `prover.openings_time_ms` |  240.83 |  1,445 |  304 |  226 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/f86059ec57f6231acc892bf1a4a9432b891651be/keccak-f86059ec57f6231acc892bf1a4a9432b891651be.memory.svg)
...
| group | transport_pk_to_device_time_ms | single_leaf_agg_time_ms | single_internal_agg_time_ms | new_time_ms | agg_layer_time_ms |
| --- | --- | --- | --- | --- | --- |
| agg_keygen | 59 |  |  | 296 |  | 
...
| app_proof | Poseidon2PeripheryAir<BabyBearParameters>, 1> |  | 1 | 7 | 
...
| app_proof | Poseidon2PeripheryAir<BabyBearParameters>, 1> |  | 2 | 7 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 41 | 324 | 41 | 13 | 3 | 2 | 2 | 2 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 81,415,160 | 283 | 93 | 0 | 0 | 112 | 37 | 36 | 57 | 18 | 0 | 76 | 61 | 15 | 5 | 10 | 93 | 93 | 112 | 0 | 1 | 17 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,945 | 121 | 21 | 0 | 0 | 62 | 24 | 23 | 24 | 13 | 0 | 36 | 28 | 8 | 1 | 6 | 21 | 21 | 62 | 0 | 1 | 12 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 98 | 15 | 0 | 0 | 53 | 20 | 19 | 21 | 10 | 0 | 29 | 22 | 7 | 1 | 5 | 15 | 15 | 53 | 0 | 1 | 10 | 0 | 0 | 
| leaf | 0 | prover | 476,578,798 | 833 | 386 | 0 | 0 | 233 | 121 | 120 | 71 | 40 | 0 | 213 | 175 | 37 | 20 | 17 | 386 | 386 | 233 | 0 | 3 | 39 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover |  | 0 | 832,452,236 | 1,185 | 364 | 0 | 50 | 515 | 285 | 284 | 124 | 106 | 0 | 304 | 243 | 61 | 36 | 24 | 364 | 364 | 515 | 0 | 1 | 105 | 0 | 0 | 
| app_proof | prover |  | 1 | 832,452,236 | 1,078 | 335 | 0 | 0 | 511 | 282 | 282 | 124 | 104 | 0 | 231 | 168 | 62 | 37 | 24 | 335 | 335 | 511 | 0 | 1 | 103 | 0 | 0 | 
| app_proof | prover |  | 2 | 832,452,236 | 1,076 | 335 | 0 | 0 | 514 | 284 | 283 | 124 | 105 | 0 | 226 | 164 | 62 | 37 | 24 | 335 | 335 | 514 | 0 | 1 | 104 | 0 | 0 | 
| app_proof | prover |  | 3 | 832,452,236 | 1,080 | 335 | 0 | 0 | 515 | 285 | 284 | 124 | 105 | 0 | 229 | 167 | 61 | 36 | 24 | 336 | 335 | 515 | 0 | 1 | 104 | 0 | 0 | 
| app_proof | prover |  | 4 | 832,452,236 | 1,080 | 336 | 0 | 0 | 514 | 284 | 284 | 124 | 105 | 0 | 229 | 166 | 62 | 37 | 25 | 336 | 336 | 514 | 0 | 1 | 104 | 0 | 0 | 
| app_proof | prover |  | 5 | 822,228,620 | 1,069 | 332 | 0 | 0 | 509 | 283 | 282 | 123 | 102 | 0 | 226 | 164 | 62 | 37 | 25 | 332 | 332 | 509 | 0 | 1 | 101 | 0 | 0 | 
...
| group | program | upload_preflight_program_time_ms | prove_segment_time_ms | prepare_preflight_time_ms | execute_preflight_insn_mi/s | execute_metered_time_ms | execute_metered_insns | execute_metered_insn_mi/s | compute_user_public_values_proof_time_ms | app_prove_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof |  | 0 | 1,197 | 5 | 25.71 | 127 | 14,365,133 | 112.97 | 0 | 7,559 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof |  | 0 | 0 | 2 | 17 | 1,364 | 3 | 0 | 0 | 28 | 0 | 9,354,519,192 | 634,907,640 | 9,989,426,832 | 2,097,152 | 2 | 0 | 0 | 2 | 14 | 120 | 2,413,000 | 20.02 | 0 | 0 | 
| app_proof |  | 1 | 0 | 1 | 12 | 1,214 | 2 | 0 | 0 | 24 | 0 | 9,354,826,824 | 635,521,608 | 9,990,348,432 | 2,097,152 | 2 | 0 | 0 | 2 | 9 | 89 | 2,413,000 | 27.04 | 0 | 0 | 
| app_proof |  | 2 | 0 | 1 | 12 | 1,212 | 2 | 0 | 0 | 24 | 0 | 9,354,062,988 | 636,285,444 | 9,990,348,432 | 2,097,152 | 2 | 0 | 0 | 2 | 9 | 87 | 2,413,000 | 27.47 | 0 | 0 | 
| app_proof |  | 3 | 0 | 1 | 11 | 1,216 | 2 | 0 | 0 | 24 | 0 | 9,354,825,960 | 635,522,472 | 9,990,348,432 | 2,097,152 | 2 | 0 | 0 | 2 | 9 | 89 | 2,413,000 | 26.98 | 0 | 0 | 
| app_proof |  | 4 | 0 | 1 | 12 | 1,214 | 2 | 0 | 0 | 24 | 0 | 9,354,062,904 | 636,285,528 | 9,990,348,432 | 2,097,152 | 2 | 0 | 0 | 2 | 9 | 87 | 2,413,000 | 27.53 | 0 | 0 | 
| app_proof |  | 5 | 0 | 1 | 11 | 1,197 | 2 | 0 | 0 | 23 | 0 | 8,920,153,908 | 947,511,132 | 9,867,665,040 | 2,097,152 | 2 | 0 | 0 | 2 | 9 | 83 | 2,300,133 | 27.43 | 0 | 0 | 

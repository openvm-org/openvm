...
|:---|---:|---:|---:|
| Total |  9.46 |  3.46 |  3.46 |
| app_proof |  7.44 |  1.93 |  1.93 |
| leaf |  1.47 |  0.99 |  0.99 |
...
| `total_proof_time_ms ` |  1,218.17 |  7,309 |  1,344 |  1,182 |
| `compile_metered_time_ms` |  2 |  2 |  2 |  2 |
| `prepare_preflight_time_ms` |  2 |  2 |  2 |  2 |
| `upload_preflight_program_time_ms` |  0 |  0 |  0 |  0 |
| `app_prove_time_ms   ` |  7,444 |  7,444 |  7,444 |  7,444 |
| `execute_metered_time_ms` |  126 | -          | -          | -          |
| `execute_metered_insns` |  14,365,133 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  113.29 | -          |  113.29 |  113.29 |
| `execute_preflight_insns` |  2,394,188.83 |  14,365,133 |  2,413,000 |  2,300,133 |
| `execute_preflight_time_ms` |  96.67 |  580 |  125 |  88 |
| `execute_preflight_insn_mi/s` |  24.51 | -          |  26.53 |  19.25 |
| `postflight_time_ms  ` |  25.50 |  153 |  28 |  24 |
| `trace_gen_time_ms   ` |  12 |  72 |  17 |  11 |
| `set_initial_memory_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,070.33 |  6,422 |  1,158 |  1,046 |
| `prover.main_trace_commit_time_ms` |  330.17 |  1,981 |  354 |  324 |
| `prover.rap_constraints_time_ms` |  511.33 |  3,068 |  513 |  509 |
| `prover.openings_time_ms` |  227.50 |  1,365 |  292 |  212 |
| `prover.rap_constraints.logup_gkr_time_ms` |  101.83 |  611 |  103 |  100 |
| `prover.rap_constraints.round0_time_ms` |  278.50 |  1,671 |  280 |  278 |
| `prover.rap_constraints.mle_rounds_time_ms` |  130 |  780 |  130 |  130 |
| `prover.openings.stacked_reduction_time_ms` |  58.33 |  350 |  59 |  57 |
...
| `prover.openings.whir_time_ms` |  168.83 |  1,013 |  233 |  154 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  737 |  1,474 |  989 |  485 |
| `execute_preflight_time_ms` |  4.50 |  9 |  5 |  4 |
| `trace_gen_time_ms   ` |  139 |  278 |  185 |  93 |
| `generate_blob_total_time_ms` |  15.50 |  31 |  21 |  10 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  598 |  1,196 |  804 |  392 |
| `prover.main_trace_commit_time_ms` |  260.50 |  521 |  377 |  144 |
| `prover.rap_constraints_time_ms` |  180.50 |  361 |  225 |  136 |
| `prover.openings_time_ms` |  156 |  312 |  201 |  111 |
...
| `prover.openings.stacked_reduction_time_ms` |  25.50 |  51 |  33 |  18 |
| `prover.openings.stacked_reduction.round0_time_ms` |  15.50 |  31 |  20 |  11 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/d91c410525ef173d89c3bc79acf3822b4b18536f/keccak-d91c410525ef173d89c3bc79acf3822b4b18536f.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 41 | 321 | 41 | 14 | 3 | 2 | 2 | 2 | 
| internal_recursive.0 | 1 | 14 | 130 | 13 | 2 | 0 | 2 | 2 | 2 | 
| internal_recursive.1 | 1 | 10 | 97 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 185 | 989 | 184 | 59 | 21 | 4 | 11 | 11 | 
| leaf | 1 | 93 | 485 | 92 | 30 | 10 | 5 | 10 | 10 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 81,415,160 | 280 | 91 | 0 | 0 | 107 | 35 | 34 | 55 | 17 | 0 | 80 | 68 | 11 | 5 | 5 | 92 | 91 | 107 | 0 | 1 | 15 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,945 | 116 | 21 | 0 | 0 | 55 | 20 | 19 | 21 | 12 | 0 | 39 | 34 | 5 | 2 | 2 | 21 | 21 | 55 | 0 | 1 | 11 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 |
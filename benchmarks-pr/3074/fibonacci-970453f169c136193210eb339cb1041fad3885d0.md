...
|:---|---:|---:|---:|
| Total |  1.07 |  0.97 |  0.97 |
| app_proof |  0.50 |  0.39 |  0.39 |
| leaf |  0.22 |  0.22 |  0.22 |
...
| `total_proof_time_ms ` |  241 |  482 |  365 |  117 |
| `compile_metered_time_ms` |  2 |  2 |  2 |  2 |
| `prepare_preflight_time_ms` |  2 |  2 |  2 |  2 |
| `upload_preflight_program_time_ms` |  0 |  0 |  0 |  0 |
| `app_prove_time_ms   ` |  501 |  501 |  501 |  501 |
| `execute_metered_time_ms` |  13 | -          | -          | -          |
| `execute_metered_insns` |  4,000,051 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  288.49 | -          |  288.49 |  288.49 |
| `execute_preflight_insns` |  2,000,025.50 |  4,000,051 |  3,495,000 |  505,051 |
| `execute_preflight_time_ms` |  69 |  138 |  125 |  13 |
| `execute_preflight_insn_mi/s` |  29.93 | -          |  36.53 |  25.31 |
| `postflight_time_ms  ` |  30 |  60 |  38 |  22 |
| `trace_gen_time_ms   ` |  8 |  16 |  11 |  5 |
| `set_initial_memory_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  122.50 |  245 |  173 |  72 |
| `prover.main_trace_commit_time_ms` |  23 |  46 |  35 |  11 |
| `prover.rap_constraints_time_ms` |  63.50 |  127 |  92 |  35 |
| `prover.openings_time_ms` |  34.50 |  69 |  44 |  25 |
| `prover.rap_constraints.logup_gkr_time_ms` |  38.50 |  77 |  57 |  20 |
| `prover.rap_constraints.round0_time_ms` |  16 |  32 |  23 |  9 |
| `prover.rap_constraints.mle_rounds_time_ms` |  7.50 |  15 |  10 |  5 |
| `prover.openings.stacked_reduction_time_ms` |  7 |  14 |  10 |  4 |
| `prover.openings.stacked_reduction.round0_time_ms` |  3.50 |  7 |  5 |  2 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  2 |  4 |  3 |  1 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/970453f169c136193210eb339cb1041fad3885d0/fibonacci-970453f169c136193210eb339cb1041fad3885d0.memory.svg)
...
| prover.rap_constraints | 0.92 | app_proof.prover..0 |
| set initial memory | 0.86 | app_proof..1 |
| prover.batch_constraints.round0 | 0.69 | leaf.0.prover |
| prover.batch_constraints.fold_ple_evals | 0.69 | leaf.0.prover |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 16 | 153 | 16 | 5 | 0 | 2 | 1 | 1 | 
| internal_recursive.0 | 1 | 11 | 111 | 11 | 1 | 0 | 2 | 0 | 0 | 
| internal_recursive.1 | 1 | 10 | 99 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 36 | 216 | 36 | 13 | 1 | 1 | 0 | 1 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 27,277,885 | 136 | 33 | 0 | 0 | 66 | 23 | 22 | 31 | 12 | 0 | 36 | 29 | 6 | 3 | 2 | 33 | 33 | 66 | 0 | 1 | 11 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 99 | 20 | 0 | 0 | 50 | 19 | 18 | 20 | 10 | 0 | 28 | 23 | 4 | 2 | 2 | 20 | 20 | 50 | 0 | 1 | 9 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 89 | 14 | 0 | 0 | 46 | 17 | 16 | 18 | 9 | 0 | 28 | 24 | 4 | 1 | 1 | 15 | 14 | 46 | 0 | 1 | 9 | 0 | 0 | 
| leaf | 0 | prover | 76,005,176 | 179 | 49 | 0 | 0 | 80 | 38 | 36 | 25 | 16 | 0 | 49 | 41 | 8 | 4 | 3 | 50 | 49 | 80 | 0 | 3 | 15 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover |  | 0 | 109,310,570 | 173 | 35 | 0 | 0 | 92 | 23 | 23 | 10 | 57 | 0 | 44 | 34 | 10 | 5 | 3 | 35 | 35 | 92 | 0 | 1 | 56 | 0 | 0 | 
| app_proof | prover |  | 1 | 24,506,017 | 72 | 11 | 0 | 0 | 35 | 9 | 9 | 5 | 20 | 0 | 25 | 21 | 4 | 2 | 1 | 11 | 11 | 35 | 0 | 1 | 20 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof |  | 117 | 25.31 | 13 | 4,000,051 | 288.49 | 0 | 501 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof |  | 0 | 0 | 2 | 11 | 365 | 3 | 0 | 0 | 38 | 0 | 2,393,898,952 | 454,606,312 | 2,848,505,264 | 2,097,152 | 2 | 0 | 0 | 2 | 7 | 125 | 3,495,000 | 27.95 | 0 | 0 | 
| app_proof |  | 1 | 0 | 1 | 5 | 117 | 2 | 0 | 0 | 22 | 0 | 411,328,323 | 187,896,478 | 599,224,801 | 2,097,152 | 2 | 0 | 0 | 2 | 2 | 13 | 505,051 | 36.53 | 0 | 0 | 

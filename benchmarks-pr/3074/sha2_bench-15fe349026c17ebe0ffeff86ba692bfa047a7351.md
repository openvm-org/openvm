...
| `total_proof_time_ms ` |  2,083 |  4,166 |  2,830 |  1,336 |
| `compile_metered_time_ms` |  3 |  3 |  3 |  3 |
| `prepare_preflight_time_ms` |  3 |  3 |  3 |  3 |
| `upload_preflight_program_time_ms` |  0 |  0 |  0 |  0 |
| `app_prove_time_ms   ` |  4,230 |  4,230 |  4,230 |  4,230 |
| `execute_metered_time_ms` |  57 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  195.27 | -          |  195.27 |  195.27 |
| `execute_preflight_insns` |  5,583,980.50 |  11,167,961 |  7,136,000 |  4,031,961 |
| `execute_preflight_time_ms` |  278 |  556 |  399 |  157 |
| `execute_preflight_insn_mi/s` |  20.49 | -          |  25.61 |  17.86 |
| `postflight_time_ms  ` |  69 |  138 |  90 |  48 |
| `trace_gen_time_ms   ` |  57.50 |  115 |  91 |  24 |
| `set_initial_memory_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,645 |  3,290 |  2,207 |  1,083 |
| `prover.main_trace_commit_time_ms` |  394.50 |  789 |  570 |  219 |
| `prover.rap_constraints_time_ms` |  981.50 |  1,963 |  1,291 |  672 |
| `prover.openings_time_ms` |  267.50 |  535 |  345 |  190 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/15fe349026c17ebe0ffeff86ba692bfa047a7351/sha2_bench-15fe349026c17ebe0ffeff86ba692bfa047a7351.memory.svg)
...
| app_proof | Rv64HintStoreAir |  | 0 | 5 | 
| app_proof | Sha2BlockHasherVmAir<Sha256Config> |  | 0 | 53 | 
...
| app_proof | VmAirWrapper<Rv64StoreMultiByteAdapterAir, StoreCoreAir<8, 4> |  | 0 | 5 | 
...
| leaf | 0 | 118 | 530 | 117 | 36 | 13 | 2 | 10 | 10 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 179 | 46 | 0 | 0 | 79 | 28 | 27 | 36 | 13 | 0 | 53 | 42 | 10 | 2 | 7 | 47 | 46 | 79 | 0 | 1 | 12 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 107 | 20 | 0 | 0 | 55 | 20 | 20 | 23 | 10 | 0 | 30 | 23 | 7 | 1 | 6 | 20 | 20 | 55 | 0 | 1 | 10 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 100 | 15 | 0 | 0 | 55 | 20 | 19 | 21 | 12 | 0 | 30 | 23 | 7 | 1 | 6 | 15 | 15 | 55 | 0 | 1 | 10 | 0 | 0 | 
| leaf | 0 | prover | 237,929,272 | 411 | 146 | 0 | 0 | 141 | 71 | 70 | 44 | 26 | 0 | 122 | 100 | 22 | 10 | 11 | 146 | 146 | 141 | 0 | 3 | 25 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover |  | 0 | 1,285,848,458 | 2,207 | 570 | 0 | 0 | 1,291 | 701 | 700 | 234 | 355 | 0 | 345 | 251 | 94 | 58 | 36 | 570 | 570 | 1,291 | 0 | 1 | 353 | 0 | 0 | 
| app_proof | prover |  | 1 | 690,310,084 | 1,083 | 219 | 0 | 0 | 672 | 351 | 350 | 126 | 195 | 0 | 190 | 139 | 51 | 30 | 21 | 219 | 219 | 672 | 0 | 1 | 194 | 0 | 0 | 
...
| group | program | prove_segment_time_ms | execute_preflight_insn_mi/s | execute_metered_time_ms | execute_metered_insns | execute_metered_insn_mi/s | compute_user_public_values_proof_time_ms | app_prove_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof |  | 1,336 | 18.01 | 57 | 11,167,961 | 195.27 | 0 | 4,230 | 

| group | program | reason | segment | segmentation_trigger |
| --- | --- | --- | --- | --- |
| app_proof |  | memory | 0 | 1 | 

| group | program | segment | vm.transport_init_memory_time_ms | update_merkle_tree_time_ms | trace_gen_time_ms | total_proof_time_ms | system_trace_gen_time_ms | set_initial_memory_time_ms | program_trace_gen_time_ms | postflight_time_ms | poseidon2_prepare_time_ms | metered_memory_unpadded_bytes | metered_memory_padding_bytes | metered_memory_bytes | metered_interaction_memory_overhead_bytes | merkle_update_time_ms | merkle_drop_time_ms | mem_merge_records_time_ms | generate_proving_ctxs_from_device_time_ms | executor_trace_gen_time_ms | execute_preflight_time_ms | execute_preflight_insns | execute_preflight_insn_mi/s | connector_trace_gen_time_ms | boundary_trace_gen_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof |  | 0 | 0 | 2 | 91 | 2,830 | 3 | 0 | 0 | 90 | 0 | 12,567,738,156 | 2,865,208,140 | 15,432,946,296 | 2,097,152 | 2 | 0 | 0 | 2 | 88 | 399 | 7,136,000 | 17.86 | 0 | 0 | 
| app_proof |  | 1 | 0 | 1 | 24 | 1,336 | 2 | 0 | 0 | 48 | 0 | 7,133,254,296 | 1,693,718,849 | 8,826,973,145 | 2,097,152 | 2 | 0 | 0 | 2 | 21 | 157 | 4,031,961 | 25.61 | 0 | 0 | 

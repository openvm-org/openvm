...
| `total_proof_time_ms ` |  2,048.50 |  4,097 |  2,755 |  1,342 |
| `compile_metered_time_ms` |  2 |  2 |  2 |  2 |
| `execute_metered_time_ms` |  57 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  192.74 | -          |  192.74 |  192.74 |
| `set_initial_memory_time_ms` |  0 |  0 |  0 |  0 |
| `execute_preflight_insns` |  5,583,980.50 |  11,167,961 |  7,136,000 |  4,031,961 |
| `execute_preflight_time_ms` |  252 |  504 |  340 |  164 |
| `execute_preflight_insn_mi/s` |  22.16 | -          |  24.56 |  20.93 |
| `postflight_time_ms  ` |  67 |  134 |  86 |  48 |
| `postflight_memory_chronology_time_ms` |  7 |  14 |  10 |  4 |
| `postflight_program_index_time_ms` |  1 |  2 |  1 |  1 |
| `trace_gen_time_ms   ` |  58 |  116 |  92 |  24 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,635 |  3,270 |  2,191 |  1,079 |
| `prover.main_trace_commit_time_ms` |  392 |  784 |  568 |  216 |
| `prover.rap_constraints_time_ms` |  976 |  1,952 |  1,280 |  672 |
| `prover.openings_time_ms` |  266 |  532 |  342 |  190 |
| `prover.rap_constraints.logup_gkr_time_ms` |  274 |  548 |  352 |  196 |
| `prover.rap_constraints.round0_time_ms` |  523 |  1,046 |  697 |  349 |
| `prover.rap_constraints.mle_rounds_time_ms` |  178 |  356 |  230 |  126 |
| `prover.openings.stacked_reduction_time_ms` |  71.50 |  143 |  92 |  51 |
...
| `prover.openings.whir_time_ms` |  194.50 |  389 |  250 |  139 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/2799cd1fe6c12dd8e4a3fbae5ba03d2c9d5cea21/sha2_bench-2799cd1fe6c12dd8e4a3fbae5ba03d2c9d5cea21.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 176 | 46 | 0 | 0 | 78 | 27 | 27 | 37 | 13 | 0 | 50 | 40 | 10 | 2 | 7 | 46 | 46 | 78 | 0 | 1 | 12 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 108 | 20 | 0 | 0 | 56 | 20 | 20 | 23 | 11 | 0 | 31 | 23 | 7 | 1 | 6 | 20 | 20 | 56 | 0 | 1 | 10 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 102 | 15 | 0 | 0 | 55 | 22 | 21 | 21 | 11 | 0 | 31 | 24 | 7 | 1 | 5 | 15 | 15 | 55 | 0 | 1 | 10 | 0 | 0 | 
| leaf | 0 | prover | 237,929,272 | 403 | 144 | 0 | 0 | 141 | 71 | 69 | 44 | 25 | 0 | 116 | 94 | 21 | 10 | 11 | 145 | 144 | 141 | 0 | 3 | 25 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover |  | 0 | 1,285,848,458 | 2,191 | 567 | 0 | 0 | 1,280 | 697 | 696 | 230 | 352 | 0 | 342 | 250 | 92 | 56 | 35 | 568 | 567 | 1,280 | 0 | 1 | 350 | 0 | 0 | 
| app_proof | prover |  | 1 | 690,310,084 | 1,079 | 216 | 0 | 0 | 672 | 349 | 349 | 126 | 196 | 0 | 190 | 139 | 51 | 30 | 21 | 216 | 216 | 672 | 0 | 1 | 194 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof |  | 1,342 | 57 | 11,167,961 | 192.74 | 0 | 4,160 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof |  | 0 | 0 | 2 | 92 | 2,755 | 3 | 0 | 0 | 86 | 1 | 10 | 0 | 12,567,738,156 | 2,865,208,140 | 15,432,946,296 | 2,097,152 | 2 | 0 | 0 | 3 | 88 | 340 | 7,136,000 | 20.93 | 0 | 0 | 
| app_proof |  | 1 | 0 | 1 | 24 | 1,342 | 2 | 0 | 0 | 48 | 1 | 4 | 0 | 7,133,254,296 | 1,693,718,849 | 8,826,973,145 | 2,097,152 | 2 | 0 | 0 | 2 | 21 | 164 | 4,031,961 | 24.56 | 0 | 0 | 

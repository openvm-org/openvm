...
|:---|---:|---:|
| Total |  7.60 |  4.74 |
| regex_program |  7.57 |  4.70 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  3,783 |  7,566 |  4,703 |  2,863 |
...
| `execute_e3_time_ms  ` |  121 |  242 |  138 |  104 |
| `execute_e3_insn_mi/s` |  17.30 | -          |  18.37 |  16.24 |
| `trace_gen_time_ms   ` |  409 |  818 |  523 |  295 |
| `memory_finalize_time_ms` |  7 |  14 |  12 |  2 |
| `boundary_finalize_time_ms` |  2 |  4 |  4 |  0 |
| `merkle_finalize_time_ms` |  157.50 |  315 |  246 |  69 |
| `stark_prove_excluding_trace_time_ms` |  3,253 |  6,506 |  4,042 |  2,464 |
| `main_trace_commit_time_ms` |  650.50 |  1,301 |  849 |  452 |
| `generate_perm_trace_time_ms` |  254.50 |  509 |  299 |  210 |
| `perm_trace_commit_time_ms` |  692 |  1,384 |  859 |  525 |
| `quotient_poly_compute_time_ms` |  339.50 |  679 |  430 |  249 |
| `quotient_poly_commit_time_ms` |  303.50 |  607 |  395 |  212 |
| `pcs_opening_time_ms ` |  1,005.50 |  2,011 |  1,205 |  806 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 4,126 | 24 | 4,165,433 | 1 | 34 | 119.21 | 62 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 523 | 4,703 | 211,864,680 | 373,166,268 | 4,042 | 430 | 395 | 859 | 1,205 | 246 | 25 | 12 | 849 | 91,153,694 | 2,244,000 | 299 | 138 | 16.24 | 4 | 
| regex_program | 1 | 295 | 2,863 | 176,237,560 | 242,975,370 | 2,464 | 249 | 212 | 525 | 806 | 69 | 24 | 2 | 452 | 74,277,990 | 1,921,433 | 210 | 104 | 18.37 | 0 | 

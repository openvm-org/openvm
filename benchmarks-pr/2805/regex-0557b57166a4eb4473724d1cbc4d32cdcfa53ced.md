...
| `total_proof_time_ms ` |  786 |  1,572 |  904 |  668 |
| `execute_metered_time_ms` |  34 | -          | -          | -          |
| `execute_metered_insns` |  4,090,656 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  118.51 | -          |  118.51 |  118.51 |
| `execute_preflight_insns` |  2,045,328 |  4,090,656 |  2,327,000 |  1,763,656 |
| `execute_preflight_time_ms` |  92.50 |  185 |  102 |  83 |
| `execute_preflight_insn_mi/s` |  29.24 | -          |  29.99 |  28.49 |
| `trace_gen_time_ms   ` |  30.50 |  61 |  36 |  25 |
| `memory_finalize_time_ms` |  1 |  2 |  2 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  572.50 |  1,145 |  638 |  507 |
| `prover.main_trace_commit_time_ms` |  114 |  228 |  128 |  100 |
| `prover.rap_constraints_time_ms` |  412 |  824 |  458 |  366 |
| `prover.openings_time_ms` |  46 |  92 |  52 |  40 |
| `prover.rap_constraints.logup_gkr_time_ms` |  276 |  552 |  326 |  226 |
| `prover.rap_constraints.round0_time_ms` |  95.50 |  191 |  104 |  87 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/0557b57166a4eb4473724d1cbc4d32cdcfa53ced/regex-0557b57166a4eb4473724d1cbc4d32cdcfa53ced.memory.svg)
...
| app_proof |  |  |  |  |  | 668 |  |  | 34 | 4,090,656 | 118.51 | 0 | 1,620 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 27,289,339 | 210 | 81 | 0 | 0 | 98 | 32 | 32 | 46 | 19 | 0 | 29 | 18 | 11 | 2 | 8 | 81 | 98 | 0 | 2 | 19 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 161,843,666 | 638 | 128 | 0 | 0 | 458 | 87 | 86 | 44 | 326 | 85 | 52 | 27 | 24 | 13 | 11 | 128 | 458 | 0 | 3 | 240 | 0 | 0 | 
| app_proof | prover | 1 | 123,257,151 | 507 | 100 | 0 | 8 | 366 | 104 | 103 | 35 | 226 | 0 | 40 | 19 | 20 | 9 | 10 | 100 | 366 | 0 | 2 | 226 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 25 | 904 | 25 | 137 | 2 | 4 | 102 | 2,327,000 | 28.49 | 
| app_proof | 1 | 36 | 668 | 36 | 40 | 0 | 2 | 83 | 1,763,656 | 29.99 | 

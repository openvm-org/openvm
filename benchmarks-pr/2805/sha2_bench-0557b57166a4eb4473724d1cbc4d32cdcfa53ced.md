...
|:---|---:|---:|---:|
| Total |  11.20 |  4.60 |  4.60 |
| app_proof |  9.15 |  2.54 |  2.54 |
| leaf |  1.39 |  1.39 |  1.39 |
...
| `total_proof_time_ms ` |  2,262.75 |  9,051 |  2,444 |  2,181 |
| `execute_metered_time_ms` |  97 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  114.85 | -          |  114.85 |  114.85 |
| `execute_preflight_insns` |  2,791,990.25 |  11,167,961 |  2,851,000 |  2,614,961 |
| `execute_preflight_time_ms` |  172.25 |  689 |  221 |  106 |
| `execute_preflight_insn_mi/s` |  31.91 | -          |  32.71 |  29.88 |
| `trace_gen_time_ms   ` |  57.75 |  231 |  63 |  54 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,966.75 |  7,867 |  2,138 |  1,906 |
| `prover.main_trace_commit_time_ms` |  529.50 |  2,118 |  618 |  500 |
| `prover.rap_constraints_time_ms` |  1,302.75 |  5,211 |  1,391 |  1,272 |
| `prover.openings_time_ms` |  133.25 |  533 |  137 |  128 |
| `prover.rap_constraints.logup_gkr_time_ms` |  352.75 |  1,411 |  441 |  323 |
| `prover.rap_constraints.round0_time_ms` |  651.75 |  2,607 |  654 |  649 |
| `prover.rap_constraints.mle_rounds_time_ms` |  297.25 |  1,189 |  300 |  295 |
| `prover.openings.stacked_reduction_time_ms` |  97 |  388 |  98 |  94 |
| `prover.openings.stacked_reduction.round0_time_ms` |  58.75 |  235 |  60 |  56 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  37.75 |  151 |  38 |  37 |
| `prover.openings.whir_time_ms` |  36 |  144 |  38 |  34 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,392 |  1,392 |  1,392 |  1,392 |
| `execute_preflight_time_ms` |  2 |  2 |  2 |  2 |
| `trace_gen_time_ms   ` |  148 |  148 |  148 |  148 |
| `generate_blob_total_time_ms` |  25 |  25 |  25 |  25 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,243 |  1,243 |  1,243 |  1,243 |
...
| `prover.openings.stacked_reduction_time_ms` |  63 |  63 |  63 |  63 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/0557b57166a4eb4473724d1cbc4d32cdcfa53ced/sha2_bench-0557b57166a4eb4473724d1cbc4d32cdcfa53ced.memory.svg)
...
| prover.rap_constraints | 10.92 | app_proof.prover.0 |
...
| app_proof |  |  |  |  |  | 2,181 |  |  | 97 | 11,167,961 | 114.85 | 0 | 9,155 |  | 
| internal_for_leaf |  |  |  | 373 |  |  |  |  |  |  |  |  |  | 373 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 24 | 373 | 24 | 7 | 2 | 2 | 3 | 3 | 
| internal_recursive.0 | 1 | 12 | 162 | 12 | 2 | 0 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 9 | 129 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 148 | 1,392 | 148 | 53 | 25 | 2 | 6 | 6 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 61,220,603 | 349 | 181 | 0 | 0 | 127 | 36 | 36 | 63 | 26 | 0 | 40 | 21 | 18 | 5 | 12 | 181 | 127 | 0 | 2 | 26 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,879 | 150 | 48 | 0 | 0 | 71 | 24 | 24 | 29 | 17 | 0 | 29 | 20 | 8 | 1 | 6 | 48 | 71 | 0 | 2 | 16 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 120 | 31 | 0 | 0 | 60 | 23 | 22 | 24 | 13 | 0 | 27 | 20 | 7 | 1 | 5 | 31 | 60 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 425,198,438 | 1,243 | 794 | 0 | 158 | 345 | 165 | 164 | 104 | 74 | 0 | 103 | 40 | 63 | 35 | 27 | 794 | 345 | 0 | 6 | 73 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 640,057,593 | 2,138 | 618 | 0 | 118 | 1,391 | 649 | 648 | 300 | 441 | 133 | 128 | 34 | 94 | 56 | 37 | 618 | 1,391 | 0 | 3 | 307 | 0 | 0 | 
| app_proof | prover | 1 | 640,057,356 | 1,906 | 500 | 0 | 2 | 1,272 | 653 | 653 | 295 | 323 | 0 | 132 | 34 | 98 | 60 | 38 | 500 | 1,272 | 0 | 3 | 321 | 0 | 0 | 
| app_proof | prover | 2 | 640,057,356 | 1,914 | 500 | 0 | 2 | 1,276 | 654 | 654 | 298 | 323 | 0 | 137 | 38 | 98 | 60 | 38 | 500 | 1,276 | 0 | 3 | 321 | 0 | 0 | 
| app_proof | prover | 3 | 640,057,588 | 1,909 | 500 | 0 | 2 | 1,272 | 651 | 650 | 296 | 324 | 0 | 136 | 38 | 98 | 59 | 38 | 500 | 1,272 | 0 | 3 | 322 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 63 | 2,444 | 63 | 135 | 0 | 3 | 106 | 2,851,000 | 29.88 | 
| app_proof | 1 | 57 | 2,226 | 57 | 41 | 0 | 1 | 221 | 2,851,000 | 32.38 | 
| app_proof | 2 | 57 | 2,200 | 57 | 41 | 0 | 1 | 186 | 2,851,000 | 32.71 | 
| app_proof | 3 | 54 | 2,181 | 54 | 41 | 0 | 1 | 176 | 2,614,961 | 32.67 | 

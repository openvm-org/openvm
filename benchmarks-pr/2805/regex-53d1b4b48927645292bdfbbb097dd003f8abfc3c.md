...
| `total_proof_time_ms ` |  730 |  1,460 |  868 |  592 |
| `execute_metered_time_ms` |  34 | -          | -          | -          |
| `execute_metered_insns` |  4,090,656 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  119.69 | -          |  119.69 |  119.69 |
| `execute_preflight_insns` |  2,045,328 |  4,090,656 |  2,327,000 |  1,763,656 |
| `execute_preflight_time_ms` |  88.50 |  177 |  98 |  79 |
| `execute_preflight_insn_mi/s` |  31.13 | -          |  32.07 |  30.18 |
| `trace_gen_time_ms   ` |  36 |  72 |  42 |  30 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  516 |  1,032 |  603 |  429 |
| `prover.main_trace_commit_time_ms` |  116.50 |  233 |  130 |  103 |
| `prover.rap_constraints_time_ms` |  355.50 |  711 |  425 |  286 |
| `prover.openings_time_ms` |  43 |  86 |  47 |  39 |
| `prover.rap_constraints.logup_gkr_time_ms` |  219.50 |  439 |  292 |  147 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/53d1b4b48927645292bdfbbb097dd003f8abfc3c/regex-53d1b4b48927645292bdfbbb097dd003f8abfc3c.memory.svg)

| Module | Max (GB) | Max At |
| --- | ---: | --- |
| prover.batch_constraints.before_round0 | 4.63 | app_proof.prover.0 |
| frac_sumcheck.gkr_rounds | 4.63 | app_proof.prover.0 |
| prover.gkr_input_evals | 4.50 | app_proof.prover.0 |
| frac_sumcheck.segment_tree | 4.50 | app_proof.prover.0 |
...
| app_proof |  |  |  |  |  | 592 |  |  | 34 | 4,090,656 | 119.69 | 0 | 1,508 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 27,289,339 | 211 | 82 | 0 | 0 | 97 | 31 | 30 | 46 | 20 | 0 | 30 | 19 | 11 | 2 | 8 | 83 | 97 | 0 | 2 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,703 | 145 | 46 | 0 | 0 | 66 | 24 | 23 | 27 | 13 | 0 | 31 | 23 | 8 | 1 | 6 | 46 | 66 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 119 | 32 | 0 | 0 | 62 | 24 | 23 | 24 | 13 | 0 | 24 | 17 | 7 | 1 | 5 | 32 | 62 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 79,659,764 | 313 | 128 | 0 | 0 | 137 | 56 | 55 | 37 | 42 | 0 | 47 | 31 | 15 | 6 | 8 | 128 | 137 | 0 | 5 | 41 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 161,778,130 | 603 | 130 | 0 | 0 | 425 | 87 | 87 | 45 | 292 | 67 | 47 | 22 | 25 | 13 | 11 | 130 | 425 | 0 | 3 | 224 | 0 | 0 | 
| app_proof | prover | 1 | 123,191,821 | 429 | 103 | 0 | 8 | 286 | 103 | 102 | 35 | 147 | 0 | 39 | 18 | 20 | 10 | 10 | 103 | 286 | 0 | 3 | 146 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 30 | 868 | 30 | 135 | 1 | 4 | 98 | 2,327,000 | 30.18 | 
| app_proof | 1 | 42 | 592 | 42 | 41 | 0 | 2 | 79 | 1,763,656 | 32.07 | 

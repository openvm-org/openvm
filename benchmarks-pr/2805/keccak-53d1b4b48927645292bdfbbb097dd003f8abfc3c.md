...
|:---|---:|---:|---:|
| Total |  17.10 |  5.06 |  5.06 |
| app_proof |  13.94 |  2.66 |  2.66 |
| leaf |  2.37 |  1.60 |  1.60 |
...
| `total_proof_time_ms ` |  2,299.33 |  13,796 |  2,523 |  2,216 |
| `execute_metered_time_ms` |  141 | -          | -          | -          |
| `execute_metered_insns` |  14,365,133 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  101.78 | -          |  101.78 |  101.78 |
| `execute_preflight_insns` |  2,394,188.83 |  14,365,133 |  2,413,000 |  2,300,133 |
| `execute_preflight_time_ms` |  244.67 |  1,468 |  327 |  95 |
| `execute_preflight_insn_mi/s` |  30.60 | -          |  31.57 |  28.35 |
| `trace_gen_time_ms   ` |  35.67 |  214 |  45 |  33 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,961.17 |  11,767 |  2,246 |  1,897 |
| `prover.main_trace_commit_time_ms` |  693.67 |  4,162 |  851 |  661 |
| `prover.rap_constraints_time_ms` |  1,086 |  6,516 |  1,216 |  1,052 |
| `prover.openings_time_ms` |  180.50 |  1,083 |  186 |  176 |
| `prover.rap_constraints.logup_gkr_time_ms` |  250 |  1,500 |  309 |  236 |
| `prover.rap_constraints.round0_time_ms` |  527 |  3,162 |  598 |  510 |
| `prover.rap_constraints.mle_rounds_time_ms` |  308.17 |  1,849 |  329 |  303 |
| `prover.openings.stacked_reduction_time_ms` |  134.67 |  808 |  136 |  134 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/53d1b4b48927645292bdfbbb097dd003f8abfc3c/keccak-53d1b4b48927645292bdfbbb097dd003f8abfc3c.memory.svg)

| Module | Max (GB) | Max At |
| --- | ---: | --- |
| prover.rap_constraints | 14.27 | app_proof.prover.0 |
| prover.openings | 12.92 | app_proof.prover.0 |
| prover.merkle_tree | 12.92 | app_proof.prover.0 |
| prover.prove_whir_opening | 12.92 | app_proof.prover.0 |
| prover.batch_constraints.fold_ple_evals | 12.42 | app_proof.prover.0 |
| prover.batch_constraints.round0 | 12.42 | app_proof.prover.0 |
| frac_sumcheck.gkr_rounds | 12.23 | app_proof.prover.0 |
| prover.batch_constraints.before_round0 | 12.23 | app_proof.prover.0 |
| prover.gkr_input_evals | 12.10 | app_proof.prover.0 |
| frac_sumcheck.segment_tree | 12.10 | app_proof.prover.0 |
| prover.before_gkr_input_evals | 9.80 | app_proof.prover.0 |
| prover.stacked_commit | 9.80 | app_proof.prover.0 |
...
| app_proof |  |  |  |  |  | 2,216 |  |  | 141 | 14,365,133 | 101.78 | 0 | 13,943 |  | 
...
| internal_recursive.0 | 1 | 13 | 166 | 13 | 2 | 1 | 2 | 1 | 2 | 
| internal_recursive.1 | 1 | 9 | 129 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 182 | 1,602 | 182 | 64 | 32 | 6 | 7 | 7 | 
| leaf | 1 | 91 | 766 | 90 | 32 | 16 | 5 | 7 | 7 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 81,415,028 | 463 | 242 | 0 | 1 | 171 | 49 | 48 | 92 | 30 | 0 | 48 | 24 | 23 | 7 | 15 | 243 | 171 | 0 | 3 | 29 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,879 | 153 | 49 | 0 | 0 | 73 | 25 | 24 | 29 | 18 | 0 | 29 | 20 | 8 | 2 | 6 | 49 | 73 | 0 | 2 | 17 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 119 | 31 | 0 | 0 | 62 | 24 | 23 | 24 | 13 | 0 | 25 | 18 | 7 | 1 | 5 | 32 | 62 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 476,578,662 | 1,419 | 893 | 0 | 175 | 411 | 203 | 202 | 120 | 87 | 0 | 114 | 43 | 71 | 40 | 30 | 893 | 411 | 0 | 7 | 84 | 0 | 0 | 
| leaf | 1 | prover | 240,255,732 | 675 | 373 | 0 | 1 | 229 | 109 | 108 | 68 | 51 | 0 | 72 | 34 | 37 | 19 | 17 | 374 | 228 | 0 | 6 | 50 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 843,806,348 | 2,246 | 850 | 0 | 192 | 1,216 | 598 | 598 | 307 | 309 | 77 | 178 | 43 | 134 | 82 | 52 | 851 | 1,216 | 0 | 4 | 231 | 0 | 0 | 
| app_proof | prover | 1 | 843,806,348 | 1,917 | 661 | 0 | 3 | 1,079 | 513 | 513 | 329 | 236 | 0 | 176 | 42 | 134 | 82 | 52 | 661 | 1,079 | 0 | 4 | 235 | 0 | 0 | 
| app_proof | prover | 2 | 843,806,348 | 1,897 | 662 | 0 | 3 | 1,052 | 510 | 510 | 303 | 238 | 0 | 182 | 46 | 136 | 81 | 54 | 662 | 1,052 | 0 | 4 | 237 | 0 | 0 | 
| app_proof | prover | 3 | 843,806,348 | 1,901 | 662 | 0 | 2 | 1,052 | 510 | 509 | 303 | 239 | 0 | 186 | 50 | 135 | 83 | 52 | 662 | 1,052 | 0 | 3 | 238 | 0 | 0 | 
| app_proof | prover | 4 | 843,806,348 | 1,904 | 663 | 0 | 2 | 1,059 | 518 | 517 | 303 | 238 | 0 | 181 | 46 | 134 | 81 | 53 | 663 | 1,059 | 0 | 4 | 237 | 0 | 0 | 
| app_proof | prover | 5 | 843,806,348 | 1,902 | 662 | 0 | 2 | 1,058 | 513 | 512 | 304 | 240 | 0 | 180 | 44 | 135 | 82 | 53 | 663 | 1,058 | 0 | 4 | 239 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 45 | 2,523 | 45 | 135 | 0 | 3 | 95 | 2,413,000 | 28.35 | 
| app_proof | 1 | 34 | 2,320 | 34 | 41 | 0 | 1 | 327 | 2,413,000 | 30.89 | 
| app_proof | 2 | 34 | 2,243 | 34 | 41 | 0 | 1 | 270 | 2,413,000 | 31.54 | 
| app_proof | 3 | 34 | 2,245 | 34 | 41 | 0 | 1 | 268 | 2,413,000 | 31.57 | 
| app_proof | 4 | 34 | 2,249 | 34 | 41 | 0 | 1 | 269 | 2,413,000 | 31.34 | 
| app_proof | 5 | 33 | 2,216 | 33 | 41 | 0 | 1 | 239 | 2,300,133 | 29.94 | 

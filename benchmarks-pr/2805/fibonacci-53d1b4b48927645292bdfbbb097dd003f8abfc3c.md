...
| `total_proof_time_ms ` |  387.25 |  1,549 |  513 |  217 |
| `execute_metered_time_ms` |  19 | -          | -          | -          |
| `execute_metered_insns` |  4,000,051 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  200.80 | -          |  200.80 |  200.80 |
| `execute_preflight_insns` |  1,000,012.75 |  4,000,051 |  1,310,000 |  70,051 |
| `execute_preflight_time_ms` |  38 |  152 |  52 |  4 |
| `execute_preflight_insn_mi/s` |  37.28 | -          |  37.38 |  37.08 |
| `trace_gen_time_ms   ` |  73.25 |  293 |  102 |  63 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  210.25 |  841 |  261 |  69 |
| `prover.main_trace_commit_time_ms` |  41.25 |  165 |  51 |  15 |
| `prover.rap_constraints_time_ms` |  139.25 |  557 |  178 |  34 |
| `prover.openings_time_ms` |  28.50 |  114 |  33 |  19 |
| `prover.rap_constraints.logup_gkr_time_ms` |  95.25 |  381 |  123 |  17 |
| `prover.rap_constraints.round0_time_ms` |  28.25 |  113 |  37 |  9 |
...
| `prover.openings.whir_time_ms` |  19.50 |  78 |  22 |  16 |
...
| `prover.main_trace_commit_time_ms` |  168 |  168 |  168 |  168 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/53d1b4b48927645292bdfbbb097dd003f8abfc3c/fibonacci-53d1b4b48927645292bdfbbb097dd003f8abfc3c.memory.svg)
...
| frac_sumcheck.segment_tree | 2.65 | leaf.0.prover |
| prover.gkr_input_evals | 2.65 | leaf.0.prover |
...
| app_proof |  |  |  |  |  | 217 |  |  | 19 | 4,000,051 | 200.80 | 0 | 1,575 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 27,289,339 | 209 | 81 | 0 | 0 | 97 | 32 | 31 | 45 | 20 | 0 | 29 | 18 | 11 | 2 | 8 | 82 | 97 | 0 | 2 | 18 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,703 | 142 | 45 | 0 | 0 | 66 | 25 | 24 | 28 | 13 | 0 | 29 | 21 | 8 | 1 | 6 | 46 | 66 | 0 | 2 | 12 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 118 | 31 | 0 | 0 | 61 | 23 | 23 | 24 | 13 | 0 | 25 | 18 | 7 | 1 | 5 | 31 | 61 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 103,146,406 | 376 | 168 | 0 | 0 | 159 | 69 | 68 | 46 | 43 | 0 | 47 | 28 | 18 | 8 | 9 | 168 | 159 | 0 | 5 | 42 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 62,648,816 | 261 | 50 | 0 | 0 | 178 | 37 | 37 | 17 | 123 | 0 | 32 | 21 | 11 | 5 | 5 | 50 | 178 | 0 | 3 | 121 | 0 | 0 | 
| app_proof | prover | 1 | 62,602,932 | 254 | 49 | 0 | 0 | 173 | 34 | 34 | 17 | 121 | 0 | 30 | 19 | 10 | 5 | 5 | 49 | 173 | 0 | 3 | 120 | 0 | 0 | 
| app_proof | prover | 2 | 62,602,932 | 257 | 50 | 0 | 0 | 172 | 33 | 33 | 17 | 120 | 0 | 33 | 22 | 11 | 5 | 5 | 51 | 172 | 0 | 3 | 120 | 0 | 0 | 
| app_proof | prover | 3 | 9,072,096 | 69 | 15 | 0 | 0 | 34 | 9 | 8 | 7 | 17 | 0 | 19 | 16 | 3 | 0 | 2 | 15 | 34 | 0 | 2 | 16 | 0 | 0 | 

| group | phase | segment | trace_height_constraint | weighted_sum | threshold |
| --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 0 | 37,885,718 | 2,013,265,921 | 
| app_proof | prover | 1 | 0 | 37,884,330 | 2,013,265,921 | 
| app_proof | prover | 2 | 0 | 37,884,330 | 2,013,265,921 | 
| app_proof | prover | 3 | 0 | 3,724,669 | 2,013,265,921 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 63 | 513 | 63 | 135 | 0 | 3 | 52 | 1,310,000 | 37.38 | 
| app_proof | 1 | 64 | 408 | 64 | 40 | 0 | 1 | 48 | 1,310,000 | 37.35 | 
| app_proof | 2 | 64 | 411 | 64 | 40 | 0 | 1 | 48 | 1,310,000 | 37.30 | 
| app_proof | 3 | 102 | 217 | 102 | 40 | 0 | 1 | 4 | 70,051 | 37.08 | 

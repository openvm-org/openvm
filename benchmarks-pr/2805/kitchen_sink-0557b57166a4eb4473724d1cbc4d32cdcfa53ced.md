...
| `total_proof_time_ms ` |  1,001 |  2,002 |  1,566 |  436 |
| `execute_metered_time_ms` |  24 | -          | -          | -          |
| `execute_metered_insns` |  1,979,971 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  80.67 | -          |  80.67 |  80.67 |
| `execute_preflight_insns` |  989,985.50 |  1,979,971 |  1,445,000 |  534,971 |
| `execute_preflight_time_ms` |  77.50 |  155 |  83 |  72 |
| `execute_preflight_insn_mi/s` |  28.97 | -          |  29.42 |  28.52 |
| `trace_gen_time_ms   ` |  28 |  56 |  46 |  10 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  806 |  1,612 |  1,312 |  300 |
| `prover.main_trace_commit_time_ms` |  274 |  548 |  476 |  72 |
| `prover.rap_constraints_time_ms` |  484 |  968 |  767 |  201 |
| `prover.openings_time_ms` |  46.50 |  93 |  67 |  26 |
| `prover.rap_constraints.logup_gkr_time_ms` |  82 |  164 |  128 |  36 |
| `prover.rap_constraints.round0_time_ms` |  273 |  546 |  428 |  118 |
| `prover.rap_constraints.mle_rounds_time_ms` |  128 |  256 |  210 |  46 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/0557b57166a4eb4473724d1cbc4d32cdcfa53ced/kitchen_sink-0557b57166a4eb4473724d1cbc4d32cdcfa53ced.memory.svg)
...
| app_proof |  |  |  |  |  | 436 |  |  | 24 | 1,979,971 | 80.67 | 0 | 2,031 |  | 
...
| leaf | 0 | 107 | 404 | 107 | 25 | 11 | 17 | 2 | 2 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,577,915 | 118 | 38 | 0 | 0 | 61 | 20 | 19 | 29 | 12 | 0 | 17 | 10 | 7 | 1 | 6 | 38 | 61 | 0 | 1 | 11 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,703 | 80 | 16 | 0 | 0 | 49 | 18 | 17 | 20 | 10 | 0 | 14 | 8 | 5 | 1 | 4 | 16 | 49 | 0 | 1 | 9 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 75 | 11 | 0 | 0 | 47 | 19 | 18 | 18 | 10 | 0 | 16 | 10 | 5 | 0 | 4 | 11 | 47 | 0 | 1 | 9 | 0 | 0 | 
| leaf | 0 | prover | 260,616,052 | 296 | 128 | 0 | 1 | 139 | 48 | 47 | 36 | 54 | 0 | 28 | 12 | 15 | 7 | 8 | 128 | 139 | 0 | 2 | 53 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 902,782,844 | 1,312 | 476 | 0 | 266 | 767 | 428 | 427 | 210 | 128 | 67 | 67 | 15 | 52 | 24 | 27 | 476 | 767 | 0 | 1 | 60 | 0 | 0 | 
| app_proof | prover | 1 | 279,963,980 | 300 | 72 | 0 | 1 | 201 | 118 | 117 | 46 | 36 | 0 | 26 | 9 | 16 | 7 | 9 | 72 | 201 | 0 | 1 | 36 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 46 | 1,566 | 46 | 135 | 0 | 4 | 72 | 1,445,000 | 28.52 | 
| app_proof | 1 | 10 | 436 | 10 | 40 | 0 | 1 | 83 | 534,971 | 29.42 | 

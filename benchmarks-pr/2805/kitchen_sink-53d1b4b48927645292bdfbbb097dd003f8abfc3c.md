...
|:---|---:|---:|---:|
| Total |  2.88 |  2.27 |  2.27 |
| app_proof |  2.16 |  1.56 |  1.56 |
| leaf |  0.41 |  0.41 |  0.41 |
...
| `total_proof_time_ms ` |  1,070 |  2,140 |  1,532 |  608 |
| `execute_metered_time_ms` |  24 | -          | -          | -          |
| `execute_metered_insns` |  1,979,971 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  81.90 | -          |  81.90 |  81.90 |
| `execute_preflight_insns` |  989,985.50 |  1,979,971 |  1,278,000 |  701,971 |
| `execute_preflight_time_ms` |  88.50 |  177 |  117 |  60 |
| `execute_preflight_insn_mi/s` |  29.22 | -          |  30.01 |  28.43 |
| `trace_gen_time_ms   ` |  27.50 |  55 |  42 |  13 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  865 |  1,730 |  1,294 |  436 |
| `prover.main_trace_commit_time_ms` |  291.50 |  583 |  467 |  116 |
| `prover.rap_constraints_time_ms` |  520.50 |  1,041 |  758 |  283 |
| `prover.openings_time_ms` |  52 |  104 |  68 |  36 |
| `prover.rap_constraints.logup_gkr_time_ms` |  73.50 |  147 |  112 |  35 |
| `prover.rap_constraints.round0_time_ms` |  306 |  612 |  431 |  181 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/53d1b4b48927645292bdfbbb097dd003f8abfc3c/kitchen_sink-53d1b4b48927645292bdfbbb097dd003f8abfc3c.memory.svg)

| Module | Max (GB) | Max At |
| --- | ---: | --- |
| prover.rap_constraints | 15.90 | app_proof.prover.0 |
...
| prover.batch_constraints.round0 | 12.69 | app_proof.prover.0 |
| prover.batch_constraints.fold_ple_evals | 12.69 | app_proof.prover.0 |
| prover.gkr_input_evals | 12.60 | app_proof.prover.0 |
| prover.batch_constraints.before_round0 | 12.60 | app_proof.prover.0 |
| frac_sumcheck.gkr_rounds | 12.60 | app_proof.prover.0 |
| frac_sumcheck.segment_tree | 12.60 | app_proof.prover.0 |
...
| app_proof |  |  |  |  |  | 608 |  |  | 24 | 1,979,971 | 81.90 | 0 | 2,169 |  | 
...
| app_proof | 43 | VmAirWrapper<Rv64VecHeapAdapterAir<2, 4, 4>, 2, 4, 4, 8, 32, 32>, ShiftCoreAir<32, 8> | prover | 1 | 128 | 246 | 31,488 | 
| app_proof | 44 | VmAirWrapper<Rv64VecHeapAdapterAir<2, 4, 4>, 2, 4, 4, 8, 32, 32>, MultiplicationCoreAir<32, 8> | prover | 1 | 64 | 169 | 10,816 | 
...
| app_proof | 48 | VmAirWrapper<Rv64VecHeapAdapterAir<2, 4, 4>, 2, 4, 4, 8, 32, 32>, BaseAluCoreAir<32, 8> | prover | 1 | 256 | 173 | 44,288 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 17 | 135 | 17 | 6 | 1 | 2 | 2 | 2 | 
| internal_recursive.0 | 1 | 10 | 91 | 9 | 1 | 0 | 2 | 0 | 0 | 
| internal_recursive.1 | 1 | 8 | 82 | 8 | 1 | 0 | 1 | 0 | 0 | 
| leaf | 0 | 115 | 407 | 114 | 28 | 13 | 17 | 4 | 4 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,577,915 | 117 | 38 | 0 | 0 | 62 | 20 | 19 | 29 | 12 | 0 | 16 | 8 | 7 | 1 | 6 | 38 | 62 | 0 | 1 | 11 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,703 | 81 | 16 | 0 | 0 | 49 | 19 | 18 | 20 | 10 | 0 | 15 | 9 | 5 | 1 | 4 | 16 | 49 | 0 | 1 | 9 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 73 | 11 | 0 | 0 | 47 | 18 | 17 | 18 | 10 | 0 | 14 | 8 | 5 | 0 | 4 | 11 | 47 | 0 | 1 | 9 | 0 | 0 | 
| leaf | 0 | prover | 260,616,052 | 292 | 126 | 0 | 1 | 137 | 47 | 47 | 36 | 52 | 0 | 28 | 12 | 15 | 7 | 8 | 127 | 137 | 0 | 2 | 51 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 902,733,692 | 1,294 | 467 | 0 | 259 | 758 | 431 | 429 | 214 | 112 | 56 | 68 | 15 | 52 | 25 | 26 | 467 | 758 | 0 | 1 | 56 | 0 | 0 | 
| app_proof | prover | 1 | 457,259,660 | 436 | 116 | 0 | 1 | 283 | 181 | 180 | 65 | 35 | 0 | 36 | 11 | 24 | 12 | 11 | 116 | 283 | 0 | 1 | 35 | 0 | 0 | 

| group | phase | segment | trace_height_constraint | weighted_sum | threshold |
| --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 0 | 50,545,662 | 2,013,265,921 | 
| app_proof | prover | 1 | 0 | 27,034,122 | 2,013,265,921 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 42 | 1,532 | 42 | 134 | 0 | 3 | 60 | 1,278,000 | 28.43 | 
| app_proof | 1 | 13 | 608 | 13 | 40 | 0 | 1 | 117 | 701,971 | 30.01 | 

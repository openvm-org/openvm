...
|:---|---:|---:|---:|
| Total |  11.38 |  4.62 |  4.62 |
| app_proof |  9.31 |  2.55 |  2.55 |
| leaf |  1.40 |  1.40 |  1.40 |
...
| `total_proof_time_ms ` |  2,304.25 |  9,217 |  2,453 |  2,195 |
| `execute_metered_time_ms` |  96 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  115.92 | -          |  115.92 |  115.92 |
| `execute_preflight_insns` |  2,791,990.25 |  11,167,961 |  2,851,000 |  2,614,961 |
| `execute_preflight_time_ms` |  168.25 |  673 |  207 |  105 |
| `execute_preflight_insn_mi/s` |  32.11 | -          |  33.34 |  30.40 |
| `trace_gen_time_ms   ` |  57.75 |  231 |  63 |  54 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  2,012.25 |  8,049 |  2,147 |  1,926 |
| `prover.main_trace_commit_time_ms` |  537 |  2,148 |  623 |  508 |
| `prover.rap_constraints_time_ms` |  1,337 |  5,348 |  1,386 |  1,283 |
| `prover.openings_time_ms` |  136.75 |  547 |  141 |  134 |
| `prover.rap_constraints.logup_gkr_time_ms` |  361.50 |  1,446 |  413 |  311 |
| `prover.rap_constraints.round0_time_ms` |  659.25 |  2,637 |  667 |  654 |
| `prover.rap_constraints.mle_rounds_time_ms` |  315 |  1,260 |  317 |  311 |
| `prover.openings.stacked_reduction_time_ms` |  98.50 |  394 |  100 |  97 |
...
| `prover.openings.whir_time_ms` |  37.50 |  150 |  40 |  36 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,396 |  1,396 |  1,396 |  1,396 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/53d1b4b48927645292bdfbbb097dd003f8abfc3c/sha2_bench-53d1b4b48927645292bdfbbb097dd003f8abfc3c.memory.svg)

| Module | Max (GB) | Max At |
| --- | ---: | --- |
| prover.batch_constraints.before_round0 | 11.09 | app_proof.prover.3 |
| frac_sumcheck.gkr_rounds | 11.09 | app_proof.prover.3 |
| prover.rap_constraints | 11.02 | app_proof.prover.0 |
| frac_sumcheck.segment_tree | 10.99 | app_proof.prover.0 |
| prover.gkr_input_evals | 10.99 | app_proof.prover.0 |
...
| app_proof |  |  |  |  |  | 2,195 |  |  | 96 | 11,167,961 | 115.92 | 0 | 9,320 |  | 
...
| leaf | 0 | 144 | 1,396 | 143 | 53 | 25 | 2 | 6 | 6 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 61,220,603 | 354 | 183 | 0 | 0 | 130 | 37 | 37 | 65 | 27 | 0 | 40 | 21 | 18 | 5 | 12 | 183 | 130 | 0 | 3 | 26 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,879 | 148 | 47 | 0 | 0 | 72 | 24 | 24 | 29 | 18 | 0 | 27 | 19 | 8 | 1 | 6 | 47 | 72 | 0 | 2 | 17 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 122 | 31 | 0 | 0 | 61 | 23 | 22 | 24 | 14 | 0 | 28 | 21 | 7 | 1 | 5 | 32 | 61 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 425,198,438 | 1,252 | 800 | 0 | 154 | 344 | 168 | 167 | 102 | 74 | 0 | 106 | 42 | 64 | 36 | 27 | 800 | 344 | 0 | 7 | 73 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 644,579,577 | 2,147 | 623 | 0 | 116 | 1,385 | 658 | 658 | 317 | 410 | 113 | 137 | 36 | 100 | 60 | 39 | 623 | 1,385 | 0 | 4 | 295 | 0 | 0 | 
| app_proof | prover | 1 | 644,579,340 | 2,036 | 508 | 0 | 2 | 1,386 | 654 | 654 | 317 | 413 | 122 | 141 | 40 | 100 | 61 | 39 | 508 | 1,386 | 0 | 4 | 290 | 0 | 0 | 
| app_proof | prover | 2 | 644,579,340 | 1,940 | 509 | 0 | 2 | 1,294 | 667 | 667 | 315 | 311 | 0 | 135 | 38 | 97 | 59 | 38 | 509 | 1,294 | 0 | 3 | 310 | 0 | 0 | 
| app_proof | prover | 3 | 644,579,572 | 1,926 | 508 | 0 | 2 | 1,283 | 658 | 658 | 311 | 312 | 0 | 134 | 36 | 97 | 59 | 38 | 508 | 1,283 | 0 | 3 | 311 | 0 | 0 | 

| group | phase | segment | trace_height_constraint | weighted_sum | threshold |
| --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 0 | 109,273,489 | 2,013,265,921 | 
| app_proof | prover | 1 | 0 | 109,273,354 | 2,013,265,921 | 
| app_proof | prover | 2 | 0 | 109,273,354 | 2,013,265,921 | 
| app_proof | prover | 3 | 0 | 109,273,470 | 2,013,265,921 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 63 | 2,453 | 63 | 136 | 0 | 3 | 105 | 2,851,000 | 30.40 | 
| app_proof | 1 | 57 | 2,343 | 57 | 41 | 0 | 1 | 207 | 2,851,000 | 33.20 | 
| app_proof | 2 | 57 | 2,226 | 57 | 41 | 0 | 1 | 188 | 2,851,000 | 31.52 | 
| app_proof | 3 | 54 | 2,195 | 54 | 41 | 0 | 1 | 173 | 2,614,961 | 33.34 | 

...
| `total_proof_time_ms ` |  1,087 |  2,174 |  1,562 |  612 |
| `execute_metered_time_ms` |  24 | -          | -          | -          |
| `execute_metered_insns` |  1,979,971 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  80.60 | -          |  80.60 |  80.60 |
| `execute_preflight_insns` |  989,985.50 |  1,979,971 |  1,278,000 |  701,971 |
| `execute_preflight_time_ms` |  89.50 |  179 |  118 |  61 |
| `execute_preflight_insn_mi/s` |  29.34 | -          |  30.33 |  28.34 |
| `trace_gen_time_ms   ` |  28 |  56 |  43 |  13 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  879.50 |  1,759 |  1,320 |  439 |
| `prover.main_trace_commit_time_ms` |  298.50 |  597 |  480 |  117 |
| `prover.rap_constraints_time_ms` |  527.50 |  1,055 |  770 |  285 |
| `prover.openings_time_ms` |  52.50 |  105 |  69 |  36 |
| `prover.rap_constraints.logup_gkr_time_ms` |  76 |  152 |  115 |  37 |
| `prover.rap_constraints.round0_time_ms` |  307.50 |  615 |  434 |  181 |
| `prover.rap_constraints.mle_rounds_time_ms` |  142.50 |  285 |  220 |  65 |
...
| `prover.openings.whir_time_ms` |  14 |  28 |  16 |  12 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/513501d09176f2d9e107d153b062b232575fd262/kitchen_sink-513501d09176f2d9e107d153b062b232575fd262.memory.svg)
...
| app_proof |  |  |  |  |  | 612 |  |  | 24 | 1,979,971 | 80.60 | 0 | 2,203 |  | 
...
| leaf | 0 | 115 | 412 | 114 | 28 | 13 | 17 | 4 | 4 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,577,915 | 119 | 38 | 0 | 0 | 63 | 20 | 19 | 30 | 12 | 0 | 17 | 9 | 7 | 1 | 6 | 38 | 63 | 0 | 1 | 11 | 0 | 0 | 
...
| leaf | 0 | prover | 260,616,052 | 297 | 127 | 0 | 1 | 140 | 48 | 47 | 37 | 54 | 0 | 28 | 13 | 15 | 7 | 8 | 128 | 140 | 0 | 2 | 53 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 902,733,692 | 1,320 | 479 | 0 | 272 | 770 | 434 | 433 | 220 | 115 | 58 | 69 | 16 | 52 | 25 | 27 | 480 | 770 | 0 | 1 | 56 | 0 | 0 | 
| app_proof | prover | 1 | 457,259,660 | 439 | 117 | 0 | 1 | 285 | 181 | 181 | 65 | 37 | 0 | 36 | 12 | 24 | 12 | 12 | 117 | 285 | 0 | 1 | 36 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 43 | 1,562 | 43 | 136 | 0 | 3 | 61 | 1,278,000 | 28.34 | 
| app_proof | 1 | 13 | 612 | 13 | 40 | 0 | 1 | 118 | 701,971 | 30.33 | 

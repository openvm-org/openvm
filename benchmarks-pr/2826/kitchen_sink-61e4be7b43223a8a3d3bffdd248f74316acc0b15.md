...
| `total_proof_time_ms ` |  952 |  1,904 |  1,227 |  677 |
...
| `execute_preflight_time_ms` |  99 |  198 |  135 |  63 |
| `execute_preflight_insn_mi/s` |  35.13 | -          |  36.23 |  34.04 |
| `trace_gen_time_ms   ` |  25.50 |  51 |  35 |  16 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  717.50 |  1,435 |  951 |  484 |
| `prover.main_trace_commit_time_ms` |  216.50 |  433 |  295 |  138 |
| `prover.rap_constraints_time_ms` |  452 |  904 |  599 |  305 |
| `prover.openings_time_ms` |  48 |  96 |  56 |  40 |
| `prover.rap_constraints.logup_gkr_time_ms` |  85 |  170 |  115 |  55 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/61e4be7b43223a8a3d3bffdd248f74316acc0b15/kitchen_sink-61e4be7b43223a8a3d3bffdd248f74316acc0b15.memory.svg)
...
| app_proof |  |  |  |  |  | 677 |  |  | 34 | 2,579,903 | 73.98 | 0 | 1,944 |  | 
...
| leaf | 0 | 110 | 409 | 109 | 23 | 9 | 21 | 5 | 5 | 
...
| leaf | 0 | prover | 265,006,708 | 299 | 129 | 0 | 1 | 141 | 49 | 48 | 37 | 54 | 0 | 28 | 12 | 15 | 7 | 8 | 129 | 141 | 0 | 2 | 53 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 567,917,156 | 951 | 295 | 0 | 165 | 599 | 352 | 351 | 131 | 115 | 58 | 56 | 13 | 42 | 16 | 26 | 295 | 599 | 0 | 1 | 56 | 0 | 0 | 
| app_proof | prover | 1 | 537,266,124 | 484 | 137 | 0 | 2 | 305 | 174 | 174 | 75 | 55 | 0 | 40 | 12 | 27 | 14 | 13 | 138 | 305 | 0 | 1 | 54 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 35 | 1,227 | 35 | 177 | 0 | 3 | 63 | 1,540,000 | 34.04 | 
| app_proof | 1 | 16 | 677 | 16 | 40 | 0 | 1 | 135 | 1,039,903 | 36.23 | 

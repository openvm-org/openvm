...
| `total_proof_time_ms ` |  3,801 |  7,602 |  4,860 |  2,742 |
...
| `execute_preflight_insn_mi/s` |  28.55 | -          |  30.91 |  26.18 |
| `trace_gen_time_ms   ` |  400.50 |  801 |  509 |  292 |
| `memory_finalize_time_ms` |  8 |  16 |  14 |  2 |
| `stark_prove_excluding_trace_time_ms` |  3,077 |  6,154 |  4,007 |  2,147 |
| `main_trace_commit_time_ms` |  624.50 |  1,249 |  833 |  416 |
| `generate_perm_trace_time_ms` |  231 |  462 |  309 |  153 |
| `perm_trace_commit_time_ms` |  645.50 |  1,291 |  846 |  445 |
| `quotient_poly_compute_time_ms` |  320.50 |  641 |  427 |  214 |
| `quotient_poly_commit_time_ms` |  296.50 |  593 |  394 |  199 |
| `pcs_opening_time_ms ` |  950.50 |  1,901 |  1,191 |  710 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2,742 | 6 | 1 | 31 | 4,108,597 | 131.93 | 44 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 509 | 4,860 | 211,758,557 | 373,183,036 | 509 | 4,007 | 0 | 427 | 394 | 846 | 1,191 | 7 | 14 | 833 | 91,281,687 | 309 | 101 | 2,211,000 | 26.18 | 
| regex_program | 1 | 292 | 2,742 | 174,326,267 | 196,838,026 | 292 | 2,147 | 55 | 214 | 199 | 445 | 710 | 6 | 2 | 416 | 73,453,305 | 153 | 85 | 1,897,597 | 30.91 | 

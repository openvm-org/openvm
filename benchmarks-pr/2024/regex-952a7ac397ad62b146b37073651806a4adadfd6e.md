...
| `total_proof_time_ms ` |  3,804.50 |  7,609 |  4,877 |  2,732 |
...
| `execute_preflight_insn_mi/s` |  28.50 | -          |  30.88 |  26.11 |
| `trace_gen_time_ms   ` |  376 |  752 |  484 |  268 |
| `memory_finalize_time_ms` |  9.50 |  19 |  17 |  2 |
| `stark_prove_excluding_trace_time_ms` |  3,108 |  6,216 |  4,048 |  2,168 |
| `main_trace_commit_time_ms` |  628.50 |  1,257 |  843 |  414 |
| `generate_perm_trace_time_ms` |  231 |  462 |  302 |  160 |
| `perm_trace_commit_time_ms` |  673.50 |  1,347 |  889 |  458 |
| `quotient_poly_compute_time_ms` |  311 |  622 |  424 |  198 |
| `quotient_poly_commit_time_ms` |  304.50 |  609 |  396 |  213 |
| `pcs_opening_time_ms ` |  952 |  1,904 |  1,190 |  714 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2,732 | 6 | 1 | 31 | 4,108,597 | 130.10 | 44 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 484 | 4,877 | 211,758,557 | 373,183,036 | 484 | 4,048 | 0 | 424 | 396 | 889 | 1,190 | 7 | 17 | 843 | 91,281,687 | 302 | 104 | 2,211,000 | 26.11 | 
| regex_program | 1 | 268 | 2,732 | 174,326,267 | 196,838,026 | 268 | 2,168 | 49 | 198 | 213 | 458 | 714 | 6 | 2 | 414 | 73,453,305 | 160 | 86 | 1,897,597 | 30.88 | 

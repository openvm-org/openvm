...
| `total_proof_time_ms ` |  3,795 |  7,590 |  4,859 |  2,731 |
...
| `execute_metered_insn_mi/s` |  130.56 | -          |  130.56 |  130.56 |
| `execute_preflight_insns` |  2,054,298.50 |  4,108,597 |  2,211,000 |  1,897,597 |
| `execute_preflight_time_ms` |  93 |  186 |  102 |  84 |
| `execute_preflight_insn_mi/s` |  28.37 | -          |  30.76 |  25.98 |
| `trace_gen_time_ms   ` |  394 |  788 |  504 |  284 |
| `memory_finalize_time_ms` |  7.50 |  15 |  13 |  2 |
| `stark_prove_excluding_trace_time_ms` |  3,075.50 |  6,151 |  4,005 |  2,146 |
| `main_trace_commit_time_ms` |  629 |  1,258 |  842 |  416 |
| `generate_perm_trace_time_ms` |  225.50 |  451 |  299 |  152 |
| `perm_trace_commit_time_ms` |  649.50 |  1,299 |  849 |  450 |
| `quotient_poly_compute_time_ms` |  319.50 |  639 |  433 |  206 |
| `quotient_poly_commit_time_ms` |  295.50 |  591 |  393 |  198 |
| `pcs_opening_time_ms ` |  948.50 |  1,897 |  1,183 |  714 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2,731 | 6 | 1 | 31 | 4,108,597 | 130.56 | 44 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 504 | 4,859 | 211,758,557 | 373,183,036 | 504 | 4,005 | 0 | 433 | 393 | 849 | 1,183 | 7 | 13 | 842 | 91,281,687 | 299 | 102 | 2,211,000 | 25.98 | 
| regex_program | 1 | 284 | 2,731 | 174,326,267 | 196,838,026 | 284 | 2,146 | 53 | 206 | 198 | 450 | 714 | 6 | 2 | 416 | 73,453,305 | 152 | 84 | 1,897,597 | 30.76 | 

...
|:---|---:|---:|
| Total |  7.69 |  4.94 |
| regex_program |  7.66 |  4.91 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  3,831.50 |  7,663 |  4,911 |  2,752 |
...
| `execute_metered_insn_mi/s` |  131.17 | -          |  131.17 |  131.17 |
| `execute_preflight_insns` |  2,054,298.50 |  4,108,597 |  2,211,000 |  1,897,597 |
| `execute_preflight_time_ms` |  93 |  186 |  101 |  85 |
| `execute_preflight_insn_mi/s` |  28.40 | -          |  30.79 |  26.01 |
| `trace_gen_time_ms   ` |  395 |  790 |  503 |  287 |
| `memory_finalize_time_ms` |  7.50 |  15 |  13 |  2 |
| `stark_prove_excluding_trace_time_ms` |  3,113.50 |  6,227 |  4,064 |  2,163 |
| `main_trace_commit_time_ms` |  624.50 |  1,249 |  852 |  397 |
| `generate_perm_trace_time_ms` |  254 |  508 |  330 |  178 |
| `perm_trace_commit_time_ms` |  649.50 |  1,299 |  849 |  450 |
| `quotient_poly_compute_time_ms` |  317.50 |  635 |  430 |  205 |
| `quotient_poly_commit_time_ms` |  302.50 |  605 |  402 |  203 |
| `pcs_opening_time_ms ` |  958 |  1,916 |  1,196 |  720 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2,752 | 6 | 1 | 31 | 4,108,597 | 131.17 | 45 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 503 | 4,911 | 211,758,557 | 373,183,036 | 503 | 4,064 | 0 | 430 | 402 | 849 | 1,196 | 7 | 13 | 852 | 91,281,687 | 330 | 101 | 2,211,000 | 26.01 | 
| regex_program | 1 | 287 | 2,752 | 174,326,267 | 196,838,026 | 287 | 2,163 | 54 | 205 | 203 | 450 | 720 | 6 | 2 | 397 | 73,453,305 | 178 | 85 | 1,897,597 | 30.79 | 

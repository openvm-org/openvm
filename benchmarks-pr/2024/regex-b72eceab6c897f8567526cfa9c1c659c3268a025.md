...
| `total_proof_time_ms ` |  3,808.50 |  7,617 |  4,863 |  2,754 |
...
| `execute_preflight_insn_mi/s` |  28.54 | -          |  30.96 |  26.11 |
| `trace_gen_time_ms   ` |  397 |  794 |  506 |  288 |
| `memory_finalize_time_ms` |  8 |  16 |  14 |  2 |
| `stark_prove_excluding_trace_time_ms` |  3,087 |  6,174 |  4,016 |  2,158 |
| `main_trace_commit_time_ms` |  624 |  1,248 |  838 |  410 |
| `generate_perm_trace_time_ms` |  236.50 |  473 |  322 |  151 |
| `perm_trace_commit_time_ms` |  664 |  1,328 |  844 |  484 |
| `quotient_poly_compute_time_ms` |  313.50 |  627 |  425 |  202 |
| `quotient_poly_commit_time_ms` |  299.50 |  599 |  407 |  192 |
| `pcs_opening_time_ms ` |  941 |  1,882 |  1,173 |  709 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2,754 | 6 | 1 | 32 | 4,108,597 | 128.04 | 45 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 506 | 4,863 | 211,758,557 | 373,183,036 | 506 | 4,016 | 0 | 425 | 407 | 844 | 1,173 | 7 | 14 | 838 | 91,281,687 | 322 | 101 | 2,211,000 | 26.11 | 
| regex_program | 1 | 288 | 2,754 | 174,326,267 | 196,838,026 | 288 | 2,158 | 55 | 202 | 192 | 484 | 709 | 6 | 2 | 410 | 73,453,305 | 151 | 87 | 1,897,597 | 30.96 | 

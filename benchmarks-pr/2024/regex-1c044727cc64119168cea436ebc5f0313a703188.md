...
| `total_proof_time_ms ` |  3,818.50 |  7,637 |  4,869 |  2,768 |
...
| `execute_preflight_insn_mi/s` |  28.65 | -          |  31.11 |  26.18 |
| `trace_gen_time_ms   ` |  396.50 |  793 |  505 |  288 |
| `memory_finalize_time_ms` |  8 |  16 |  14 |  2 |
| `stark_prove_excluding_trace_time_ms` |  3,097 |  6,194 |  4,023 |  2,171 |
| `main_trace_commit_time_ms` |  625.50 |  1,251 |  841 |  410 |
| `generate_perm_trace_time_ms` |  229.50 |  459 |  305 |  154 |
| `perm_trace_commit_time_ms` |  648 |  1,296 |  848 |  448 |
| `quotient_poly_compute_time_ms` |  318 |  636 |  426 |  210 |
| `quotient_poly_commit_time_ms` |  308 |  616 |  404 |  212 |
| `pcs_opening_time_ms ` |  960 |  1,920 |  1,191 |  729 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2,768 | 6 | 1 | 31 | 4,108,597 | 130.11 | 45 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 505 | 4,869 | 211,758,557 | 373,183,036 | 505 | 4,023 | 0 | 426 | 404 | 848 | 1,191 | 8 | 14 | 841 | 91,281,687 | 305 | 101 | 2,211,000 | 26.18 | 
| regex_program | 1 | 288 | 2,768 | 174,326,267 | 196,838,026 | 288 | 2,171 | 53 | 210 | 212 | 448 | 729 | 8 | 2 | 410 | 73,453,305 | 154 | 84 | 1,897,597 | 31.11 | 

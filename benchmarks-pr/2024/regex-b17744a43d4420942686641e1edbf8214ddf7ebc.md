...
|:---|---:|---:|
| Total |  7.75 |  4.94 |
| regex_program |  7.72 |  4.91 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  3,861.50 |  7,723 |  4,905 |  2,818 |
...
| `execute_preflight_insn_mi/s` |  28.51 | -          |  31.03 |  25.99 |
| `trace_gen_time_ms   ` |  389.50 |  779 |  497 |  282 |
| `memory_finalize_time_ms` |  7.50 |  15 |  13 |  2 |
| `stark_prove_excluding_trace_time_ms` |  3,150.50 |  6,301 |  4,068 |  2,233 |
| `main_trace_commit_time_ms` |  627 |  1,254 |  839 |  415 |
| `generate_perm_trace_time_ms` |  248 |  496 |  321 |  175 |
| `perm_trace_commit_time_ms` |  670.50 |  1,341 |  862 |  479 |
| `quotient_poly_compute_time_ms` |  316 |  632 |  427 |  205 |
| `quotient_poly_commit_time_ms` |  306.50 |  613 |  401 |  212 |
| `pcs_opening_time_ms ` |  974 |  1,948 |  1,210 |  738 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2,818 | 6 | 1 | 31 | 4,108,597 | 129.39 | 44 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 497 | 4,905 | 211,758,557 | 373,183,036 | 497 | 4,068 | 0 | 427 | 401 | 862 | 1,210 | 7 | 13 | 839 | 91,281,687 | 321 | 102 | 2,211,000 | 25.99 | 
| regex_program | 1 | 282 | 2,818 | 174,326,267 | 196,838,026 | 282 | 2,233 | 53 | 205 | 212 | 479 | 738 | 6 | 2 | 415 | 73,453,305 | 175 | 85 | 1,897,597 | 31.03 | 

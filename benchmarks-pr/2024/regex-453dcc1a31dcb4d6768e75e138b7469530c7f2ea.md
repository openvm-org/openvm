...
|:---|---:|---:|
| Total |  7.77 |  4.97 |
| regex_program |  7.74 |  4.94 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  3,868 |  7,736 |  4,941 |  2,795 |
...
| `execute_preflight_insn_mi/s` |  28.65 | -          |  31.07 |  26.23 |
| `trace_gen_time_ms   ` |  403.50 |  807 |  514 |  293 |
| `memory_finalize_time_ms` |  8.50 |  17 |  15 |  2 |
| `stark_prove_excluding_trace_time_ms` |  3,145.50 |  6,291 |  4,086 |  2,205 |
| `main_trace_commit_time_ms` |  628.50 |  1,257 |  843 |  414 |
| `generate_perm_trace_time_ms` |  231.50 |  463 |  297 |  166 |
| `perm_trace_commit_time_ms` |  649 |  1,298 |  850 |  448 |
| `quotient_poly_compute_time_ms` |  317 |  634 |  427 |  207 |
| `quotient_poly_commit_time_ms` |  299.50 |  599 |  403 |  196 |
| `pcs_opening_time_ms ` |  1,011 |  2,022 |  1,263 |  759 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2,795 | 6 | 1 | 31 | 4,108,597 | 131.30 | 44 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 514 | 4,941 | 211,758,557 | 373,183,036 | 514 | 4,086 | 0 | 427 | 403 | 850 | 1,263 | 8 | 15 | 843 | 91,281,687 | 297 | 102 | 2,211,000 | 26.23 | 
| regex_program | 1 | 293 | 2,795 | 174,326,267 | 196,838,026 | 293 | 2,205 | 56 | 207 | 196 | 448 | 759 | 6 | 2 | 414 | 73,453,305 | 166 | 83 | 1,897,597 | 31.07 | 

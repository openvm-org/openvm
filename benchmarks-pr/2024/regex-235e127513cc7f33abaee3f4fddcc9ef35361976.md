...
| `total_proof_time_ms ` |  3,787.50 |  7,575 |  4,862 |  2,713 |
...
| `execute_metered_insn_mi/s` |  131.43 | -          |  131.43 |  131.43 |
| `execute_preflight_insns` |  2,054,298.50 |  4,108,597 |  2,211,000 |  1,897,597 |
| `execute_preflight_time_ms` |  93.50 |  187 |  102 |  85 |
| `execute_preflight_insn_mi/s` |  28.60 | -          |  31.11 |  26.10 |
| `trace_gen_time_ms   ` |  378 |  756 |  485 |  271 |
| `memory_finalize_time_ms` |  8.50 |  17 |  15 |  2 |
| `stark_prove_excluding_trace_time_ms` |  3,089 |  6,178 |  4,035 |  2,143 |
| `main_trace_commit_time_ms` |  627.50 |  1,255 |  843 |  412 |
| `generate_perm_trace_time_ms` |  234 |  468 |  317 |  151 |
| `perm_trace_commit_time_ms` |  647.50 |  1,295 |  846 |  449 |
| `quotient_poly_compute_time_ms` |  314 |  628 |  430 |  198 |
| `quotient_poly_commit_time_ms` |  304.50 |  609 |  398 |  211 |
| `pcs_opening_time_ms ` |  953.50 |  1,907 |  1,195 |  712 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2,713 | 6 | 1 | 31 | 4,108,597 | 131.43 | 44 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 485 | 4,862 | 211,758,557 | 373,183,036 | 485 | 4,035 | 0 | 430 | 398 | 846 | 1,195 | 7 | 15 | 843 | 91,281,687 | 317 | 102 | 2,211,000 | 26.10 | 
| regex_program | 1 | 271 | 2,713 | 174,326,267 | 196,838,026 | 271 | 2,143 | 50 | 198 | 211 | 449 | 712 | 6 | 2 | 412 | 73,453,305 | 151 | 85 | 1,897,597 | 31.11 | 

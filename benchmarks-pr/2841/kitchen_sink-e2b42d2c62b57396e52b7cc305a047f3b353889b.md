...
|:---|---:|---:|---:|
| Total |  5.26 |  4.36 |  4.36 |
| app_proof |  3.76 |  2.87 |  2.87 |
| leaf |  0.93 |  0.93 |  0.93 |
...
| `total_proof_time_ms ` |  1,869 |  3,738 |  2,842 |  896 |
| `execute_metered_time_ms` |  24 | -          | -          | -          |
| `execute_metered_insns` |  1,979,971 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  81.11 | -          |  81.11 |  81.11 |
| `execute_preflight_insns` |  989,985.50 |  1,979,971 |  1,445,000 |  534,971 |
| `execute_preflight_time_ms` |  78 |  156 |  90 |  66 |
| `execute_preflight_insn_mi/s` |  30.38 | -          |  31.40 |  29.35 |
| `trace_gen_time_ms   ` |  61 |  122 |  94 |  28 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,639.50 |  3,279 |  2,543 |  736 |
| `prover.main_trace_commit_time_ms` |  590.50 |  1,181 |  957 |  224 |
| `prover.rap_constraints_time_ms` |  912 |  1,824 |  1,385 |  439 |
| `prover.openings_time_ms` |  136 |  272 |  200 |  72 |
| `prover.rap_constraints.logup_gkr_time_ms` |  149 |  298 |  213 |  85 |
| `prover.rap_constraints.round0_time_ms` |  544 |  1,088 |  839 |  249 |
...
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  43 |  86 |  67 |  19 |
...
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  812 |  812 |  812 |  812 |
| `prover.main_trace_commit_time_ms` |  395 |  395 |  395 |  395 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/e2b42d2c62b57396e52b7cc305a047f3b353889b/kitchen_sink-e2b42d2c62b57396e52b7cc305a047f3b353889b.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 72 | 9 |  |  | 0 |  | 383 | 9 |  |  |  |  |  |  | 
| app_proof |  |  |  |  |  | 896 |  |  | 24 | 1,979,971 | 81.11 | 0 | 3,767 |  | 
...
| leaf | 0 | 118 | 930 | 118 | 24 | 10 | 18 | 3 | 3 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,577,979 | 261 | 115 | 0 | 0 | 108 | 35 | 35 | 52 | 20 | 0 | 37 | 23 | 13 | 3 | 9 | 115 | 108 | 0 | 2 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,767 | 141 | 46 | 0 | 0 | 68 | 26 | 25 | 28 | 14 | 0 | 26 | 18 | 8 | 1 | 6 | 46 | 68 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 120 | 31 | 0 | 0 | 62 | 24 | 23 | 24 | 13 | 0 | 25 | 18 | 7 | 1 | 5 | 31 | 62 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 260,613,236 | 812 | 395 | 0 | 1 | 340 | 132 | 131 | 74 | 134 | 0 | 75 | 36 | 39 | 21 | 18 | 395 | 340 | 0 | 6 | 132 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 902,782,844 | 2,543 | 957 | 0 | 313 | 1,385 | 839 | 838 | 331 | 213 | 66 | 200 | 45 | 154 | 87 | 67 | 957 | 1,385 | 0 | 3 | 145 | 0 | 0 | 
| app_proof | prover | 1 | 279,963,980 | 736 | 224 | 0 | 1 | 439 | 249 | 248 | 104 | 85 | 0 | 72 | 27 | 45 | 25 | 19 | 224 | 439 | 0 | 3 | 84 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 94 | 2,842 | 94 | 138 | 0 | 3 | 66 | 1,445,000 | 29.35 | 
| app_proof | 1 | 28 | 896 | 28 | 41 | 0 | 2 | 90 | 534,971 | 31.40 | 

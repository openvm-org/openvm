...
| `total_proof_time_ms ` |  711 |  1,422 |  812 |  610 |
...
| `execute_preflight_insn_mi/s` |  13.47 | -          |  18.15 |  8.79 |
| `trace_gen_time_ms   ` |  173.50 |  347 |  191 |  156 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  347 |  694 |  377 |  317 |
| `main_trace_commit_time_ms` |  63.50 |  127 |  74 |  53 |
| `generate_perm_trace_time_ms` |  36.50 |  73 |  40 |  33 |
| `perm_trace_commit_time_ms` |  75.77 |  151.54 |  88.26 |  63.28 |
| `quotient_poly_compute_time_ms` |  78.43 |  156.85 |  85.63 |  71.22 |
| `quotient_poly_commit_time_ms` |  15.88 |  31.77 |  17.15 |  14.62 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 610 | 1 | 98 | 1,745,742 | 17.76 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 156 | 812 | 32,689,110 | 172,558,444 | 156 | 377 | 0 | 85.63 | 17.15 | 6 | 88.26 | 67 | 131 | 67 | 1 | 74 | 16,059,916 | 40 | 135 | 1,157,000 | 8.79 | 26 | 103 | 1 | 67 | 
| pairing | 1 | 191 | 610 | 22,314,288 | 119,958,502 | 191 | 317 | 1 | 71.22 | 14.62 | 6 | 63.28 | 77 | 99 | 77 | 0 | 53 | 9,408,294 | 33 | 60 | 588,742 | 18.15 | 21 | 86 | 1 | 77 | 

...
| `execute_e3_insn_mi/s` |  17.03 | -          |  17.92 |  16.13 |
| `memory_finalize_time_ms` |  7 |  14 |  12 |  2 |
| `boundary_finalize_time_ms` |  2 |  4 |  4 |  0 |
| `merkle_finalize_time_ms` |  156 |  312 |  243 |  69 |
| `stark_prove_excluding_trace_time_ms` |  3,078.50 |  6,157 |  3,832 |  2,325 |
| `main_trace_commit_time_ms` |  592.50 |  1,185 |  764 |  421 |
| `generate_perm_trace_time_ms` |  262 |  524 |  313 |  211 |
| `perm_trace_commit_time_ms` |  610.50 |  1,221 |  759 |  462 |
| `quotient_poly_compute_time_ms` |  331.50 |  663 |  421 |  242 |
| `quotient_poly_commit_time_ms` |  276.50 |  553 |  363 |  190 |
| `pcs_opening_time_ms ` |  996.50 |  1,993 |  1,207 |  786 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 3,987 | 24 | 4,165,433 | 1 | 36 | 113.45 | 63 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 540 | 211,864,680 | 373,166,268 | 3,832 | 421 | 363 | 759 | 1,207 | 243 | 26 | 12 | 764 | 91,153,694 | 2,244,000 | 313 | 139 | 16.13 | 4 | 
| regex_program | 1 | 312 | 176,237,560 | 242,975,370 | 2,325 | 242 | 190 | 462 | 786 | 69 | 24 | 2 | 421 | 74,277,990 | 1,921,433 | 211 | 107 | 17.92 | 0 | 

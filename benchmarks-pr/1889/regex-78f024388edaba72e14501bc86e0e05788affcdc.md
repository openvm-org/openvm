...
| `execute_e3_insn_mi/s` |  17.06 | -          |  17.96 |  16.15 |
| `memory_finalize_time_ms` |  7 |  14 |  12 |  2 |
| `boundary_finalize_time_ms` |  2 |  4 |  4 |  0 |
| `merkle_finalize_time_ms` |  154.50 |  309 |  241 |  68 |
| `stark_prove_excluding_trace_time_ms` |  3,066.50 |  6,133 |  3,872 |  2,261 |
| `main_trace_commit_time_ms` |  577 |  1,154 |  754 |  400 |
| `generate_perm_trace_time_ms` |  264.50 |  529 |  329 |  200 |
| `perm_trace_commit_time_ms` |  612 |  1,224 |  764 |  460 |
| `quotient_poly_compute_time_ms` |  339.50 |  679 |  428 |  251 |
| `quotient_poly_commit_time_ms` |  276 |  552 |  362 |  190 |
| `pcs_opening_time_ms ` |  987 |  1,974 |  1,231 |  743 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 3,888 | 25 | 4,165,433 | 1 | 36 | 113.28 | 63 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 523 | 211,864,680 | 373,166,268 | 3,872 | 428 | 362 | 764 | 1,231 | 241 | 25 | 12 | 754 | 91,153,694 | 2,244,000 | 329 | 138 | 16.15 | 4 | 
| regex_program | 1 | 296 | 176,237,560 | 242,975,370 | 2,261 | 251 | 190 | 460 | 743 | 68 | 24 | 2 | 400 | 74,277,990 | 1,921,433 | 200 | 106 | 17.96 | 0 | 

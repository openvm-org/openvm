...
| `total_proof_time_ms ` |  585.75 |  2,343 |  727 |  535 |
...
| `execute_metered_insn_mi/s` |  102.30 | -          |  102.30 |  102.30 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  53.25 |  213 |  65 |  45 |
| `execute_preflight_insn_mi/s` |  30.88 | -          |  32.14 |  27.81 |
| `trace_gen_time_ms   ` |  178.75 |  715 |  213 |  156 |
| `memory_finalize_time_ms` |  0.75 |  3 |  3 |  0 |
| `stark_prove_excluding_trace_time_ms` |  286.25 |  1,145 |  324 |  266 |
| `main_trace_commit_time_ms` |  51.50 |  206 |  56 |  48 |
| `generate_perm_trace_time_ms` |  34.50 |  138 |  55 |  18 |
| `perm_trace_commit_time_ms` |  64.28 |  257.10 |  70.52 |  55.72 |
| `quotient_poly_compute_time_ms` |  58.48 |  233.93 |  69.23 |  52.49 |
| `quotient_poly_commit_time_ms` |  15.25 |  60.98 |  17.22 |  13.23 |
| `pcs_opening_time_ms ` |  59 |  236 |  62 |  56 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 535 | 65 | 1 | 40 | 4,137,502 | 102.30 | 193 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 213 | 727 | 23,446,148 | 150,778,428 | 213 | 324 | 0 | 59.70 | 17.22 | 5 | 70.52 | 62 | 127 | 61 | 3 | 56 | 10,899,170 | 55 | 45 | 1,103,000 | 27.81 | 21 | 77 | 1 | 61 | 
| regex_program | 1 | 156 | 545 | 11,598,276 | 128,513,066 | 156 | 282 | 1 | 52.51 | 15.80 | 4 | 66.05 | 57 | 104 | 57 | 0 | 51 | 2,196,106 | 38 | 65 | 1,104,000 | 31.73 | 17 | 68 | 0 | 57 | 
| regex_program | 2 | 163 | 536 | 11,579,064 | 128,513,066 | 163 | 273 | 1 | 52.49 | 14.73 | 4 | 64.81 | 61 | 92 | 61 | 0 | 51 | 2,177,334 | 27 | 58 | 1,104,000 | 32.14 | 16 | 67 | 0 | 61 | 
| regex_program | 3 | 183 | 535 | 11,853,872 | 103,456,394 | 183 | 266 | 0 | 69.23 | 13.23 | 5 | 55.72 | 56 | 76 | 56 | 0 | 48 | 2,422,606 | 18 | 45 | 826,502 | 31.84 | 18 | 83 | 1 | 56 | 
...
Commit: https://github.com/openvm-org/openvm/commit/867fd9923ef6ce3d8808ec1444d3885d59070ecf
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19285804285)

...
| `total_proof_time_ms ` |  589 |  2,356 |  747 |  531 |
...
| `execute_preflight_time_ms` |  54.75 |  219 |  72 |  44 |
| `execute_preflight_insn_mi/s` |  31.81 | -          |  32.89 |  28.82 |
| `trace_gen_time_ms   ` |  176.50 |  706 |  213 |  148 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  290 |  1,160 |  345 |  267 |
| `main_trace_commit_time_ms` |  51.50 |  206 |  57 |  49 |
| `generate_perm_trace_time_ms` |  33.75 |  135 |  55 |  18 |
| `perm_trace_commit_time_ms` |  64.09 |  256.35 |  70.54 |  55.52 |
| `quotient_poly_compute_time_ms` |  57.38 |  229.51 |  67.94 |  50.73 |
| `quotient_poly_commit_time_ms` |  14.93 |  59.73 |  16.86 |  13.02 |
| `pcs_opening_time_ms ` |  65.25 |  261 |  85 |  57 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 537 | 66 | 1 | 37 | 4,137,502 | 109.75 | 194 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 213 | 747 | 23,446,148 | 150,778,428 | 213 | 345 | 0 | 58.46 | 16.86 | 5 | 70.54 | 85 | 126 | 84 | 4 | 57 | 10,899,170 | 55 | 44 | 1,103,000 | 28.82 | 21 | 76 | 1 | 84 | 
| regex_program | 1 | 148 | 541 | 11,598,276 | 128,513,066 | 148 | 279 | 1 | 52.37 | 15.30 | 4 | 65.55 | 58 | 101 | 58 | 0 | 50 | 2,196,106 | 35 | 72 | 1,104,000 | 32.89 | 16 | 68 | 0 | 58 | 
| regex_program | 2 | 162 | 531 | 11,579,064 | 128,513,066 | 162 | 269 | 1 | 50.73 | 14.55 | 4 | 64.74 | 61 | 92 | 61 | 0 | 49 | 2,177,334 | 27 | 58 | 1,104,000 | 32.73 | 16 | 65 | 0 | 61 | 
| regex_program | 3 | 183 | 537 | 11,853,872 | 103,456,394 | 183 | 267 | 0 | 67.94 | 13.02 | 5 | 55.52 | 57 | 77 | 56 | 0 | 50 | 2,422,606 | 18 | 45 | 826,502 | 32.81 | 18 | 82 | 1 | 56 | 
...
Commit: https://github.com/openvm-org/openvm/commit/be5475691363e742c2af6c195728c317bb9dcad7
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19285144443)

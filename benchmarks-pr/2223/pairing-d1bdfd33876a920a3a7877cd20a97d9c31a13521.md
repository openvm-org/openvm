...
| `total_proof_time_ms ` |  736.50 |  1,473 |  859 |  614 |
...
| `execute_preflight_insn_mi/s` |  13.48 | -          |  17.87 |  9.09 |
| `trace_gen_time_ms   ` |  180 |  360 |  195 |  165 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  367 |  734 |  419 |  315 |
| `main_trace_commit_time_ms` |  64.50 |  129 |  75 |  54 |
| `generate_perm_trace_time_ms` |  36 |  72 |  39 |  33 |
| `perm_trace_commit_time_ms` |  77.06 |  154.13 |  89.31 |  64.82 |
| `quotient_poly_compute_time_ms` |  79.96 |  159.92 |  87.85 |  72.07 |
| `quotient_poly_commit_time_ms` |  16.53 |  33.05 |  18.13 |  14.92 |
| `pcs_opening_time_ms ` |  87 |  174 |  103 |  71 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 614 | 40 | 1 | 91 | 1,745,742 | 18.98 | 146 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 165 | 859 | 32,689,110 | 172,558,444 | 165 | 419 | 0 | 87.85 | 18.13 | 6 | 89.31 | 103 | 132 | 103 | 1 | 75 | 16,059,916 | 39 | 130 | 1,157,000 | 9.09 | 26 | 106 | 1 | 103 | 
| pairing | 1 | 195 | 614 | 22,314,288 | 119,958,502 | 195 | 315 | 1 | 72.07 | 14.92 | 6 | 64.82 | 71 | 102 | 70 | 0 | 54 | 9,408,294 | 33 | 62 | 588,742 | 17.87 | 21 | 87 | 1 | 70 | 

...
| `total_proof_time_ms ` |  728 |  1,456 |  837 |  619 |
...
| `execute_preflight_insn_mi/s` |  13.80 | -          |  18.33 |  9.26 |
| `trace_gen_time_ms   ` |  183 |  366 |  197 |  169 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  358 |  716 |  395 |  321 |
| `main_trace_commit_time_ms` |  63 |  126 |  71 |  55 |
| `generate_perm_trace_time_ms` |  38.50 |  77 |  43 |  34 |
| `perm_trace_commit_time_ms` |  78.05 |  156.11 |  90.72 |  65.39 |
| `quotient_poly_compute_time_ms` |  79.100 |  159.100 |  89.14 |  70.86 |
| `quotient_poly_commit_time_ms` |  16.22 |  32.43 |  18.37 |  14.06 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 619 | 40 | 1 | 90 | 1,745,742 | 19.24 | 144 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 169 | 837 | 32,689,110 | 172,558,444 | 169 | 395 | 0 | 89.14 | 18.37 | 6 | 90.72 | 78 | 136 | 78 | 1 | 71 | 16,059,916 | 43 | 128 | 1,157,000 | 9.26 | 27 | 108 | 1 | 78 | 
| pairing | 1 | 197 | 619 | 22,314,288 | 119,958,502 | 197 | 321 | 1 | 70.86 | 14.06 | 6 | 65.39 | 77 | 103 | 77 | 0 | 55 | 9,408,294 | 34 | 59 | 588,742 | 18.33 | 20 | 85 | 1 | 77 | 

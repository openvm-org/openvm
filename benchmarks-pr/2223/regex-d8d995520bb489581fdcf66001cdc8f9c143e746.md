...
| `total_proof_time_ms ` |  584.50 |  2,338 |  715 |  537 |
...
| `execute_preflight_insn_mi/s` |  30.89 | -          |  32.36 |  28.35 |
| `trace_gen_time_ms   ` |  178.75 |  715 |  213 |  155 |
| `memory_finalize_time_ms` |  0.75 |  3 |  3 |  0 |
| `stark_prove_excluding_trace_time_ms` |  284.50 |  1,138 |  313 |  267 |
| `main_trace_commit_time_ms` |  51.50 |  206 |  55 |  50 |
| `generate_perm_trace_time_ms` |  28.75 |  115 |  38 |  18 |
| `perm_trace_commit_time_ms` |  64.35 |  257.42 |  70.92 |  55.70 |
| `quotient_poly_compute_time_ms` |  57.44 |  229.77 |  68.60 |  51.29 |
| `quotient_poly_commit_time_ms` |  14.78 |  59.12 |  16.71 |  12.43 |
| `pcs_opening_time_ms ` |  64.50 |  258 |  76 |  57 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 538 | 66 | 1 | 38 | 4,137,502 | 106.28 | 192 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 213 | 715 | 23,446,148 | 150,778,428 | 213 | 313 | 0 | 58.29 | 16.71 | 5 | 70.92 | 76 | 104 | 76 | 3 | 55 | 10,899,170 | 32 | 45 | 1,103,000 | 28.35 | 21 | 75 | 1 | 76 | 
| regex_program | 1 | 155 | 548 | 11,598,276 | 128,513,066 | 155 | 285 | 1 | 51.29 | 15.12 | 4 | 65.48 | 63 | 104 | 62 | 0 | 50 | 2,196,106 | 38 | 66 | 1,104,000 | 32.15 | 17 | 66 | 0 | 62 | 
| regex_program | 2 | 164 | 537 | 11,579,064 | 128,513,066 | 164 | 273 | 1 | 51.58 | 14.86 | 4 | 65.33 | 62 | 93 | 61 | 0 | 51 | 2,177,334 | 27 | 58 | 1,104,000 | 32.36 | 16 | 67 | 0 | 61 | 
| regex_program | 3 | 183 | 538 | 11,853,872 | 103,456,394 | 182 | 267 | 0 | 68.60 | 12.43 | 5 | 55.70 | 57 | 77 | 57 | 0 | 50 | 2,422,606 | 18 | 47 | 826,502 | 30.69 | 18 | 82 | 1 | 57 | 
...
Commit: https://github.com/openvm-org/openvm/commit/d8d995520bb489581fdcf66001cdc8f9c143e746
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19284890498)

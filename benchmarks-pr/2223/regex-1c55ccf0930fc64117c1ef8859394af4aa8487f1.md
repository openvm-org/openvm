...
|:---|---:|---:|
| Total |  2.36 |  0.76 |
| regex_program |  2.32 |  0.73 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  581 |  2,324 |  727 |  529 |
...
| `execute_preflight_insn_mi/s` |  31.52 | -          |  32.80 |  28.16 |
| `trace_gen_time_ms   ` |  176.25 |  705 |  211 |  153 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  284.25 |  1,137 |  327 |  261 |
| `main_trace_commit_time_ms` |  50.50 |  202 |  55 |  48 |
| `generate_perm_trace_time_ms` |  34.25 |  137 |  55 |  18 |
| `perm_trace_commit_time_ms` |  63.02 |  252.07 |  67.07 |  54.96 |
| `quotient_poly_compute_time_ms` |  55.83 |  223.33 |  68.39 |  51.26 |
| `quotient_poly_commit_time_ms` |  14.69 |  58.77 |  16.62 |  12.28 |
| `pcs_opening_time_ms ` |  63 |  252 |  78 |  54 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 529 | 41 | 1 | 36 | 4,137,502 | 114.06 | 167 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 211 | 727 | 23,446,148 | 150,778,428 | 211 | 327 | 0 | 52.29 | 16.62 | 5 | 67.07 | 78 | 123 | 78 | 4 | 55 | 10,899,170 | 55 | 45 | 1,103,000 | 28.16 | 21 | 69 | 1 | 78 | 
| regex_program | 1 | 153 | 535 | 11,598,276 | 128,513,066 | 153 | 275 | 1 | 51.40 | 14.32 | 4 | 63.92 | 58 | 100 | 58 | 0 | 50 | 2,196,106 | 36 | 65 | 1,104,000 | 32.80 | 16 | 66 | 0 | 58 | 
| regex_program | 2 | 160 | 533 | 11,579,064 | 128,513,066 | 160 | 274 | 1 | 51.26 | 15.55 | 4 | 66.12 | 62 | 94 | 62 | 0 | 49 | 2,177,334 | 28 | 58 | 1,104,000 | 32.54 | 16 | 67 | 0 | 62 | 
| regex_program | 3 | 181 | 529 | 11,853,872 | 103,456,394 | 181 | 261 | 0 | 68.39 | 12.28 | 5 | 54.96 | 54 | 76 | 54 | 0 | 48 | 2,422,606 | 18 | 45 | 826,502 | 32.59 | 18 | 81 | 1 | 54 | 
...
Commit: https://github.com/openvm-org/openvm/commit/1c55ccf0930fc64117c1ef8859394af4aa8487f1
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19285586826)

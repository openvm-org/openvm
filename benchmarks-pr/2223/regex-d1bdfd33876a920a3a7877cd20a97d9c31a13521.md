...
| `total_proof_time_ms ` |  581.50 |  2,326 |  718 |  533 |
...
| `execute_preflight_insn_mi/s` |  31.31 | -          |  32.62 |  28.40 |
| `trace_gen_time_ms   ` |  176.50 |  706 |  212 |  152 |
| `memory_finalize_time_ms` |  0.75 |  3 |  3 |  0 |
| `stark_prove_excluding_trace_time_ms` |  283.25 |  1,133 |  317 |  264 |
| `main_trace_commit_time_ms` |  50.50 |  202 |  56 |  48 |
| `generate_perm_trace_time_ms` |  28.75 |  115 |  35 |  18 |
| `perm_trace_commit_time_ms` |  63.67 |  254.68 |  67.65 |  55.34 |
| `quotient_poly_compute_time_ms` |  55.74 |  222.97 |  68.17 |  50.65 |
| `quotient_poly_commit_time_ms` |  14.78 |  59.14 |  16.65 |  12.34 |
| `pcs_opening_time_ms ` |  66.50 |  266 |  89 |  57 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 533 | 66 | 1 | 37 | 4,137,502 | 110.95 | 194 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 212 | 718 | 23,446,148 | 150,778,428 | 212 | 317 | 0 | 50.65 | 16.65 | 5 | 67.65 | 89 | 102 | 89 | 3 | 56 | 10,899,170 | 34 | 45 | 1,103,000 | 28.40 | 21 | 68 | 1 | 89 | 
| regex_program | 1 | 152 | 539 | 11,598,276 | 128,513,066 | 152 | 278 | 1 | 52.98 | 14.53 | 4 | 65.77 | 58 | 101 | 58 | 0 | 49 | 2,196,106 | 35 | 67 | 1,104,000 | 32.62 | 16 | 68 | 0 | 58 | 
| regex_program | 2 | 161 | 536 | 11,579,064 | 128,513,066 | 161 | 274 | 1 | 51.16 | 15.62 | 4 | 65.93 | 62 | 94 | 62 | 0 | 49 | 2,177,334 | 28 | 58 | 1,104,000 | 31.99 | 17 | 67 | 0 | 62 | 
| regex_program | 3 | 181 | 533 | 11,853,872 | 103,456,394 | 181 | 264 | 0 | 68.17 | 12.34 | 5 | 55.34 | 57 | 76 | 57 | 0 | 48 | 2,422,606 | 18 | 45 | 826,502 | 32.24 | 18 | 81 | 1 | 56 | 
...
Commit: https://github.com/openvm-org/openvm/commit/d1bdfd33876a920a3a7877cd20a97d9c31a13521
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19284412935)

...
| `total_proof_time_ms ` |  1,921 |  3,842 |  2,237 |  1,605 |
...
| `execute_preflight_time_ms` |  101.50 |  203 |  139 |  64 |
| `execute_preflight_insn_mi/s` |  35.38 | -          |  36.32 |  34.43 |
| `trace_gen_time_ms   ` |  136 |  272 |  182 |  90 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,573.50 |  3,147 |  1,813 |  1,334 |
| `prover.main_trace_commit_time_ms` |  513 |  1,026 |  598 |  428 |
| `prover.rap_constraints_time_ms` |  931.50 |  1,863 |  1,081 |  782 |
| `prover.openings_time_ms` |  128 |  256 |  133 |  123 |
| `prover.rap_constraints.logup_gkr_time_ms` |  168 |  336 |  200 |  136 |
| `prover.rap_constraints.round0_time_ms` |  561.50 |  1,123 |  669 |  454 |
| `prover.rap_constraints.mle_rounds_time_ms` |  201.50 |  403 |  212 |  191 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  949 |  949 |  949 |  949 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/617dd8451b6585f9c44aa399e17ca7cc79ee035a/kitchen_sink-617dd8451b6585f9c44aa399e17ca7cc79ee035a.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 73 | 9 |  |  | 0 |  | 371 | 9 |  |  |  |  |  |  | 
| app_proof |  |  |  |  |  | 1,605 |  |  | 35 | 2,579,903 | 73.47 | 0 | 3,882 |  | 
...
| leaf | 0 | 122 | 949 | 122 | 23 | 9 | 21 | 5 | 5 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,577,979 | 256 | 116 | 0 | 0 | 107 | 35 | 34 | 51 | 20 | 0 | 32 | 18 | 13 | 3 | 9 | 116 | 107 | 0 | 2 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,767 | 145 | 46 | 0 | 0 | 66 | 24 | 23 | 28 | 13 | 0 | 32 | 24 | 8 | 1 | 6 | 46 | 66 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 119 | 31 | 0 | 0 | 62 | 24 | 23 | 24 | 13 | 0 | 24 | 17 | 7 | 1 | 5 | 32 | 62 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 265,003,892 | 826 | 399 | 0 | 1 | 347 | 133 | 133 | 76 | 136 | 0 | 78 | 38 | 40 | 21 | 18 | 400 | 347 | 0 | 6 | 135 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 567,917,156 | 1,813 | 597 | 0 | 189 | 1,081 | 669 | 667 | 212 | 200 | 58 | 133 | 30 | 103 | 50 | 52 | 598 | 1,081 | 0 | 3 | 140 | 0 | 0 | 
| app_proof | prover | 1 | 537,266,124 | 1,334 | 428 | 0 | 1 | 782 | 454 | 453 | 191 | 136 | 0 | 123 | 38 | 85 | 48 | 36 | 428 | 782 | 0 | 4 | 135 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 182 | 2,237 | 182 | 176 | 0 | 4 | 64 | 1,540,000 | 34.43 | 
| app_proof | 1 | 90 | 1,605 | 90 | 41 | 0 | 2 | 139 | 1,039,903 | 36.32 | 

...
|:---|---:|---:|---:|
| Total |  6.03 |  2.22 |  2.22 |
| app_proof |  4.08 |  0.75 |  0.75 |
| leaf |  1.15 |  0.67 |  0.67 |
...
| `total_proof_time_ms ` |  573.29 |  4,013 |  681 |  551 |
| `execute_metered_time_ms` |  67 | -          | -          | -          |
| `execute_metered_insns` |  12,000,265 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  177.02 | -          |  177.02 |  177.02 |
| `execute_preflight_insns` |  1,714,323.57 |  12,000,265 |  1,747,000 |  1,518,265 |
| `execute_preflight_time_ms` |  49.29 |  345 |  54 |  43 |
| `execute_preflight_insn_mi/s` |  50.34 | -          |  50.63 |  49.76 |
| `trace_gen_time_ms   ` |  169.29 |  1,185 |  175 |  166 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  295.71 |  2,070 |  299 |  291 |
| `prover.main_trace_commit_time_ms` |  59.43 |  416 |  60 |  59 |
| `prover.rap_constraints_time_ms` |  168.29 |  1,178 |  171 |  166 |
| `prover.openings_time_ms` |  67 |  469 |  69 |  65 |
| `prover.rap_constraints.logup_gkr_time_ms` |  117.57 |  823 |  119 |  116 |
| `prover.rap_constraints.round0_time_ms` |  32.57 |  228 |  35 |  31 |
| `prover.rap_constraints.mle_rounds_time_ms` |  17.29 |  121 |  18 |  17 |
...
| `prover.openings.whir_time_ms` |  54.57 |  382 |  57 |  52 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  575.50 |  1,151 |  668 |  483 |
| `execute_preflight_time_ms` |  1 |  2 |  1 |  1 |
| `trace_gen_time_ms   ` |  47.50 |  95 |  57 |  38 |
| `generate_blob_total_time_ms` |  2.50 |  5 |  3 |  2 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  527 |  1,054 |  610 |  444 |
| `prover.main_trace_commit_time_ms` |  196.50 |  393 |  235 |  158 |
| `prover.rap_constraints_time_ms` |  166.50 |  333 |  185 |  148 |
| `prover.openings_time_ms` |  163.50 |  327 |  190 |  137 |
| `prover.rap_constraints.logup_gkr_time_ms` |  39 |  78 |  46 |  32 |
...
| `prover.openings.whir_time_ms` |  142 |  284 |  165 |  119 |
...
| `prover.openings.whir_time_ms` |  112 |  112 |  112 |  112 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/d7b8b75608451b52ebcdedce16681dcbbe5ed5e8/fibonacci-d7b8b75608451b52ebcdedce16681dcbbe5ed5e8.memory.svg)
...
| app_proof |  |  |  |  |  | 555 |  |  | 67 | 12,000,265 | 177.02 | 0 | 4,090 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 29 | 466 | 29 | 9 | 1 | 2 | 1 | 1 | 
| internal_recursive.0 | 1 | 12 | 182 | 12 | 1 | 0 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 9 | 155 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 57 | 668 | 57 | 23 | 3 | 1 | 1 | 1 | 
| leaf | 1 | 38 | 483 | 38 | 17 | 2 | 1 | 1 | 1 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 53,005,300 | 436 | 160 | 0 | 0 | 145 | 42 | 41 | 73 | 30 | 0 | 129 | 112 | 17 | 5 | 12 | 160 | 145 | 0 | 4 | 28 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,767 | 169 | 48 | 0 | 0 | 67 | 25 | 24 | 28 | 13 | 0 | 53 | 45 | 8 | 1 | 6 | 48 | 67 | 0 | 3 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 145 | 31 | 0 | 0 | 62 | 24 | 24 | 24 | 13 | 0 | 50 | 43 | 7 | 1 | 5 | 32 | 62 | 0 | 3 | 12 | 0 | 0 | 
| leaf | 0 | prover | 147,934,246 | 610 | 234 | 0 | 0 | 185 | 85 | 84 | 54 | 46 | 0 | 190 | 165 | 24 | 12 | 12 | 235 | 185 | 0 | 8 | 44 | 0 | 0 | 
| leaf | 1 | prover | 98,728,630 | 444 | 158 | 0 | 0 | 148 | 70 | 69 | 45 | 32 | 0 | 137 | 119 | 18 | 8 | 9 | 158 | 148 | 0 | 7 | 32 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 70,295,622 | 299 | 59 | 0 | 0 | 171 | 35 | 34 | 18 | 118 | 0 | 67 | 54 | 13 | 6 | 6 | 60 | 171 | 0 | 3 | 117 | 0 | 0 | 
| app_proof | prover | 1 | 70,248,284 | 294 | 59 | 0 | 0 | 168 | 32 | 32 | 17 | 117 | 0 | 66 | 54 | 12 | 6 | 5 | 59 | 168 | 0 | 3 | 117 | 0 | 0 | 
| app_proof | prover | 2 | 70,248,284 | 296 | 59 | 0 | 0 | 167 | 33 | 33 | 17 | 116 | 0 | 69 | 57 | 12 | 6 | 5 | 59 | 167 | 0 | 3 | 116 | 0 | 0 | 
| app_proof | prover | 3 | 70,248,284 | 291 | 59 | 0 | 0 | 166 | 32 | 31 | 17 | 117 | 0 | 65 | 52 | 12 | 6 | 5 | 59 | 166 | 0 | 3 | 115 | 0 | 0 | 
| app_proof | prover | 4 | 70,248,284 | 297 | 59 | 0 | 0 | 168 | 31 | 31 | 17 | 119 | 0 | 68 | 56 | 12 | 6 | 5 | 60 | 168 | 0 | 3 | 118 | 0 | 0 | 
| app_proof | prover | 5 | 70,248,284 | 297 | 59 | 0 | 0 | 169 | 32 | 31 | 17 | 119 | 0 | 67 | 55 | 12 | 6 | 5 | 59 | 169 | 0 | 3 | 118 | 0 | 0 | 
| app_proof | prover | 6 | 70,295,004 | 296 | 59 | 0 | 0 | 169 | 33 | 32 | 18 | 117 | 0 | 67 | 54 | 12 | 6 | 6 | 60 | 169 | 0 | 3 | 116 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 166 | 681 | 166 | 160 | 1,411,127,546 | 162,713,442 | 1,573,840,988 | 2,097,152 | 0 | 3 | 54 | 1,747,000 | 49.76 | 
| app_proof | 1 | 168 | 555 | 168 | 41 | 1,409,791,968 | 161,775,035 | 1,571,567,003 | 2,097,152 | 0 | 1 | 50 | 1,747,000 | 50.51 | 
| app_proof | 2 | 169 | 557 | 169 | 41 | 1,409,792,265 | 161,774,738 | 1,571,567,003 | 2,097,152 | 0 | 1 | 49 | 1,747,000 | 50.63 | 
| app_proof | 3 | 169 | 551 | 169 | 41 | 1,409,792,837 | 161,774,166 | 1,571,567,003 | 2,097,152 | 0 | 1 | 49 | 1,747,000 | 50.58 | 
| app_proof | 4 | 169 | 557 | 169 | 41 | 1,409,791,968 | 161,775,035 | 1,571,567,003 | 2,097,152 | 0 | 1 | 50 | 1,747,000 | 50.38 | 
| app_proof | 5 | 169 | 557 | 169 | 41 | 1,409,792,265 | 161,774,738 | 1,571,567,003 | 2,097,152 | 0 | 1 | 50 | 1,747,000 | 49.98 | 
| app_proof | 6 | 175 | 555 | 175 | 40 | 1,233,288,671 | 340,539,078 | 1,573,827,749 | 2,097,152 | 0 | 2 | 43 | 1,518,265 | 50.56 | 

...
|:---|---:|---:|---:|
| Total |  17.32 |  5.04 |  5.04 |
| app_proof |  14.17 |  2.65 |  2.65 |
| leaf |  2.36 |  1.60 |  1.60 |
...
| `total_proof_time_ms ` |  2,337 |  14,022 |  2,506 |  2,245 |
| `execute_metered_time_ms` |  144 | -          | -          | -          |
| `execute_metered_insns` |  14,365,133 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  99.22 | -          |  99.22 |  99.22 |
| `execute_preflight_insns` |  2,394,188.83 |  14,365,133 |  2,413,000 |  2,300,133 |
| `execute_preflight_time_ms` |  255.17 |  1,531 |  346 |  95 |
| `execute_preflight_insn_mi/s` |  31.55 | -          |  32.28 |  28.73 |
| `trace_gen_time_ms   ` |  36.17 |  217 |  46 |  34 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,987.67 |  11,926 |  2,228 |  1,912 |
| `prover.main_trace_commit_time_ms` |  695.17 |  4,171 |  856 |  662 |
| `prover.rap_constraints_time_ms` |  1,113.17 |  6,679 |  1,189 |  1,074 |
| `prover.openings_time_ms` |  178.50 |  1,071 |  183 |  174 |
| `prover.rap_constraints.logup_gkr_time_ms` |  289 |  1,734 |  349 |  260 |
| `prover.rap_constraints.round0_time_ms` |  509.50 |  3,057 |  513 |  503 |
| `prover.rap_constraints.mle_rounds_time_ms` |  313.50 |  1,881 |  331 |  304 |
| `prover.openings.stacked_reduction_time_ms` |  134 |  804 |  135 |  131 |
| `prover.openings.stacked_reduction.round0_time_ms` |  80.83 |  485 |  82 |  78 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  52.50 |  315 |  53 |  52 |
| `prover.openings.whir_time_ms` |  44 |  264 |  48 |  42 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,178.50 |  2,357 |  1,597 |  760 |
| `execute_preflight_time_ms` |  5 |  10 |  5 |  5 |
| `trace_gen_time_ms   ` |  135 |  270 |  181 |  89 |
| `generate_blob_total_time_ms` |  24 |  48 |  32 |  16 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,043 |  2,086 |  1,416 |  670 |
| `prover.main_trace_commit_time_ms` |  632.50 |  1,265 |  892 |  373 |
...
| `prover.openings.whir_time_ms` |  38 |  76 |  42 |  34 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/4f3eaf870da012bcefb0be884967ee28ae365fdb/keccak-4f3eaf870da012bcefb0be884967ee28ae365fdb.memory.svg)
...
| app_proof |  |  |  |  |  | 2,245 |  |  | 144 | 14,365,133 | 99.22 | 0 | 14,175 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 39 | 501 | 39 | 14 | 4 | 2 | 2 | 2 | 
| internal_recursive.0 | 1 | 14 | 163 | 14 | 2 | 1 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 9 | 128 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 181 | 1,597 | 180 | 64 | 32 | 5 | 7 | 7 | 
| leaf | 1 | 89 | 760 | 89 | 32 | 16 | 5 | 8 | 8 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 81,415,028 | 461 | 244 | 0 | 1 | 173 | 50 | 49 | 92 | 30 | 0 | 44 | 20 | 23 | 7 | 15 | 244 | 173 | 0 | 3 | 29 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,879 | 149 | 48 | 0 | 0 | 72 | 25 | 24 | 29 | 17 | 0 | 28 | 19 | 8 | 1 | 6 | 49 | 72 | 0 | 2 | 16 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 119 | 31 | 0 | 0 | 61 | 24 | 23 | 24 | 13 | 0 | 25 | 18 | 7 | 1 | 5 | 31 | 61 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 476,578,662 | 1,416 | 892 | 0 | 175 | 409 | 203 | 202 | 120 | 86 | 0 | 113 | 42 | 71 | 40 | 30 | 892 | 409 | 0 | 7 | 85 | 0 | 0 | 
| leaf | 1 | prover | 240,255,732 | 670 | 373 | 0 | 1 | 225 | 108 | 107 | 66 | 51 | 0 | 71 | 34 | 37 | 19 | 17 | 373 | 225 | 0 | 6 | 50 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 847,541,900 | 2,228 | 855 | 0 | 195 | 1,189 | 507 | 507 | 331 | 349 | 96 | 183 | 48 | 134 | 81 | 53 | 856 | 1,189 | 0 | 3 | 252 | 0 | 0 | 
| app_proof | prover | 1 | 847,541,900 | 1,944 | 663 | 0 | 3 | 1,103 | 513 | 512 | 329 | 260 | 0 | 177 | 42 | 134 | 82 | 52 | 663 | 1,103 | 0 | 3 | 258 | 0 | 0 | 
| app_proof | prover | 2 | 847,541,900 | 1,998 | 662 | 0 | 3 | 1,156 | 503 | 502 | 308 | 344 | 102 | 179 | 43 | 135 | 82 | 52 | 662 | 1,156 | 0 | 4 | 241 | 0 | 0 | 
| app_proof | prover | 3 | 847,541,900 | 1,912 | 663 | 0 | 3 | 1,074 | 509 | 509 | 304 | 260 | 0 | 174 | 43 | 131 | 78 | 52 | 663 | 1,074 | 0 | 4 | 258 | 0 | 0 | 
| app_proof | prover | 4 | 847,541,900 | 1,922 | 664 | 0 | 3 | 1,078 | 513 | 513 | 304 | 260 | 0 | 179 | 44 | 135 | 81 | 53 | 664 | 1,078 | 0 | 3 | 258 | 0 | 0 | 
| app_proof | prover | 5 | 847,541,900 | 1,922 | 663 | 0 | 3 | 1,079 | 512 | 511 | 305 | 261 | 0 | 179 | 44 | 135 | 81 | 53 | 663 | 1,079 | 0 | 4 | 259 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 46 | 2,506 | 46 | 135 | 0 | 3 | 95 | 2,413,000 | 28.73 | 
| app_proof | 1 | 35 | 2,367 | 35 | 41 | 0 | 1 | 346 | 2,413,000 | 31.88 | 
| app_proof | 2 | 34 | 2,357 | 34 | 41 | 0 | 1 | 283 | 2,413,000 | 32.28 | 
| app_proof | 3 | 34 | 2,269 | 34 | 41 | 0 | 1 | 281 | 2,413,000 | 32.09 | 
| app_proof | 4 | 34 | 2,278 | 34 | 41 | 0 | 1 | 279 | 2,413,000 | 32.06 | 
| app_proof | 5 | 34 | 2,245 | 34 | 41 | 0 | 1 | 247 | 2,300,133 | 32.28 | 

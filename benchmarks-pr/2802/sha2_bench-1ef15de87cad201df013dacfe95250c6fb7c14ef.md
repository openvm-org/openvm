...
|:---|---:|---:|---:|
| Total |  11.32 |  4.64 |  4.64 |
| app_proof |  9.26 |  2.58 |  2.58 |
| leaf |  1.40 |  1.40 |  1.40 |
...
| `total_proof_time_ms ` |  2,290 |  9,160 |  2,481 |  2,201 |
...
| `execute_preflight_time_ms` |  169.25 |  677 |  216 |  102 |
| `execute_preflight_insn_mi/s` |  34.67 | -          |  35.60 |  32.20 |
| `trace_gen_time_ms   ` |  57.75 |  231 |  63 |  54 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,997.50 |  7,990 |  2,181 |  1,927 |
| `prover.main_trace_commit_time_ms` |  537.50 |  2,150 |  628 |  507 |
| `prover.rap_constraints_time_ms` |  1,321 |  5,284 |  1,416 |  1,279 |
| `prover.openings_time_ms` |  138.25 |  553 |  139 |  137 |
| `prover.rap_constraints.logup_gkr_time_ms` |  359.50 |  1,438 |  454 |  328 |
| `prover.rap_constraints.round0_time_ms` |  660.50 |  2,642 |  663 |  658 |
| `prover.rap_constraints.mle_rounds_time_ms` |  300 |  1,200 |  303 |  291 |
| `prover.openings.stacked_reduction_time_ms` |  100.25 |  401 |  101 |  100 |
| `prover.openings.stacked_reduction.round0_time_ms` |  61 |  244 |  61 |  61 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  39 |  156 |  39 |  39 |
| `prover.openings.whir_time_ms` |  37.75 |  151 |  39 |  36 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,403 |  1,403 |  1,403 |  1,403 |
| `execute_preflight_time_ms` |  2 |  2 |  2 |  2 |
| `trace_gen_time_ms   ` |  151 |  151 |  151 |  151 |
| `generate_blob_total_time_ms` |  26 |  26 |  26 |  26 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,251 |  1,251 |  1,251 |  1,251 |
| `prover.main_trace_commit_time_ms` |  798 |  798 |  798 |  798 |
...
| `prover.main_trace_commit_time_ms` |  182 |  182 |  182 |  182 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/1ef15de87cad201df013dacfe95250c6fb7c14ef/sha2_bench-1ef15de87cad201df013dacfe95250c6fb7c14ef.memory.svg)
...
| app_proof |  |  |  |  |  | 2,201 |  |  | 97 | 11,167,961 | 114.71 | 0 | 9,265 |  | 
| internal_for_leaf |  |  |  | 376 |  |  |  |  |  |  |  |  |  | 376 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 24 | 376 | 24 | 7 | 2 | 2 | 3 | 3 | 
| internal_recursive.0 | 1 | 12 | 158 | 12 | 2 | 0 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 9 | 127 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 151 | 1,403 | 151 | 54 | 26 | 2 | 6 | 6 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 61,220,603 | 351 | 181 | 0 | 0 | 129 | 37 | 36 | 64 | 27 | 0 | 39 | 21 | 18 | 5 | 12 | 182 | 129 | 0 | 2 | 26 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,879 | 146 | 48 | 0 | 0 | 71 | 24 | 24 | 29 | 17 | 0 | 26 | 17 | 8 | 1 | 6 | 48 | 71 | 0 | 2 | 16 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 117 | 31 | 0 | 0 | 60 | 23 | 22 | 24 | 13 | 0 | 25 | 18 | 7 | 1 | 5 | 31 | 60 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 425,198,438 | 1,251 | 798 | 0 | 158 | 345 | 166 | 165 | 103 | 75 | 0 | 107 | 43 | 63 | 36 | 27 | 798 | 345 | 0 | 7 | 74 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 649,888,033 | 2,181 | 628 | 0 | 123 | 1,416 | 658 | 658 | 303 | 454 | 139 | 137 | 36 | 100 | 61 | 39 | 628 | 1,416 | 0 | 3 | 313 | 0 | 0 | 
| app_proof | prover | 1 | 649,887,756 | 1,941 | 506 | 0 | 2 | 1,295 | 663 | 662 | 303 | 328 | 0 | 138 | 38 | 100 | 61 | 39 | 507 | 1,295 | 0 | 4 | 326 | 0 | 0 | 
| app_proof | prover | 2 | 649,887,756 | 1,941 | 507 | 0 | 2 | 1,294 | 662 | 662 | 303 | 328 | 0 | 139 | 39 | 100 | 61 | 39 | 507 | 1,294 | 0 | 3 | 327 | 0 | 0 | 
| app_proof | prover | 3 | 649,888,004 | 1,927 | 508 | 0 | 2 | 1,279 | 659 | 658 | 291 | 328 | 0 | 139 | 38 | 101 | 61 | 39 | 508 | 1,279 | 0 | 3 | 327 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 63 | 2,481 | 63 | 134 | 0 | 3 | 102 | 2,851,000 | 32.20 | 
| app_proof | 1 | 57 | 2,256 | 57 | 41 | 0 | 1 | 216 | 2,851,000 | 35.42 | 
| app_proof | 2 | 57 | 2,222 | 57 | 41 | 0 | 1 | 181 | 2,851,000 | 35.60 | 
| app_proof | 3 | 54 | 2,201 | 54 | 41 | 0 | 1 | 178 | 2,614,961 | 35.45 | 

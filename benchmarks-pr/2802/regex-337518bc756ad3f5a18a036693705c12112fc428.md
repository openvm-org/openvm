...
| `total_proof_time_ms ` |  736.50 |  1,473 |  880 |  593 |
| `execute_metered_time_ms` |  33 | -          | -          | -          |
| `execute_metered_insns` |  4,090,656 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  121.05 | -          |  121.05 |  121.05 |
| `execute_preflight_insns` |  2,045,328 |  4,090,656 |  2,327,000 |  1,763,656 |
| `execute_preflight_time_ms` |  86.50 |  173 |  96 |  77 |
| `execute_preflight_insn_mi/s` |  32.73 | -          |  34.21 |  31.25 |
| `trace_gen_time_ms   ` |  36 |  72 |  42 |  30 |
| `memory_finalize_time_ms` |  1 |  2 |  2 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  524.50 |  1,049 |  618 |  431 |
| `prover.main_trace_commit_time_ms` |  120.50 |  241 |  137 |  104 |
| `prover.rap_constraints_time_ms` |  355 |  710 |  427 |  283 |
| `prover.openings_time_ms` |  48 |  96 |  52 |  44 |
| `prover.rap_constraints.logup_gkr_time_ms` |  222 |  444 |  297 |  147 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/337518bc756ad3f5a18a036693705c12112fc428/regex-337518bc756ad3f5a18a036693705c12112fc428.memory.svg)
...
| app_proof |  |  |  |  |  | 593 |  |  | 33 | 4,090,656 | 121.05 | 0 | 1,519 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 27,289,339 | 208 | 80 | 0 | 0 | 98 | 31 | 30 | 45 | 21 | 0 | 28 | 17 | 11 | 2 | 8 | 80 | 98 | 0 | 2 | 19 | 0 | 0 | 
...
| leaf | 0 | prover | 79,659,764 | 305 | 126 | 0 | 0 | 134 | 54 | 53 | 37 | 42 | 0 | 43 | 28 | 15 | 6 | 8 | 127 | 134 | 0 | 5 | 41 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 169,896,914 | 618 | 137 | 0 | 0 | 427 | 85 | 85 | 44 | 297 | 72 | 52 | 26 | 26 | 14 | 11 | 137 | 427 | 0 | 3 | 224 | 0 | 0 | 
| app_proof | prover | 1 | 129,384,771 | 431 | 104 | 0 | 8 | 283 | 100 | 99 | 35 | 147 | 0 | 44 | 22 | 21 | 10 | 10 | 104 | 283 | 0 | 3 | 146 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 30 | 880 | 30 | 135 | 2 | 4 | 96 | 2,327,000 | 31.25 | 
| app_proof | 1 | 42 | 593 | 42 | 40 | 0 | 2 | 77 | 1,763,656 | 34.21 | 

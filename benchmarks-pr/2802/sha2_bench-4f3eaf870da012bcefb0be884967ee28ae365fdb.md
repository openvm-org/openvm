...
|:---|---:|---:|---:|
| Total |  11.40 |  4.69 |  4.69 |
| app_proof |  9.31 |  2.61 |  2.61 |
| leaf |  1.41 |  1.41 |  1.41 |
...
| `total_proof_time_ms ` |  2,303.25 |  9,213 |  2,506 |  2,214 |
| `execute_metered_time_ms` |  99 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  112.26 | -          |  112.26 |  112.26 |
| `execute_preflight_insns` |  2,791,990.25 |  11,167,961 |  2,851,000 |  2,614,961 |
| `execute_preflight_time_ms` |  167.50 |  670 |  209 |  105 |
| `execute_preflight_insn_mi/s` |  32.86 | -          |  33.73 |  30.80 |
| `trace_gen_time_ms   ` |  58 |  232 |  64 |  54 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  2,011.25 |  8,045 |  2,198 |  1,943 |
| `prover.main_trace_commit_time_ms` |  541 |  2,164 |  634 |  510 |
| `prover.rap_constraints_time_ms` |  1,331.75 |  5,327 |  1,426 |  1,297 |
| `prover.openings_time_ms` |  137.25 |  549 |  139 |  135 |
| `prover.rap_constraints.logup_gkr_time_ms` |  361 |  1,444 |  454 |  330 |
| `prover.rap_constraints.round0_time_ms` |  665 |  2,660 |  667 |  664 |
| `prover.rap_constraints.mle_rounds_time_ms` |  304.75 |  1,219 |  307 |  302 |
| `prover.openings.stacked_reduction_time_ms` |  98.75 |  395 |  101 |  96 |
| `prover.openings.stacked_reduction.round0_time_ms` |  59.50 |  238 |  61 |  57 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  38.50 |  154 |  39 |  38 |
| `prover.openings.whir_time_ms` |  38.25 |  153 |  39 |  37 |
...
| `trace_gen_time_ms   ` |  151 |  151 |  151 |  151 |
| `generate_blob_total_time_ms` |  25 |  25 |  25 |  25 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,255 |  1,255 |  1,255 |  1,255 |
| `prover.main_trace_commit_time_ms` |  800 |  800 |  800 |  800 |
...
| `prover.rap_constraints.round0_time_ms` |  171 |  171 |  171 |  171 |
| `prover.rap_constraints.mle_rounds_time_ms` |  104 |  104 |  104 |  104 |
| `prover.openings.stacked_reduction_time_ms` |  62 |  62 |  62 |  62 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/4f3eaf870da012bcefb0be884967ee28ae365fdb/sha2_bench-4f3eaf870da012bcefb0be884967ee28ae365fdb.memory.svg)
...
| app_proof |  |  |  |  |  | 2,214 |  |  | 99 | 11,167,961 | 112.26 | 0 | 9,320 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 25 | 382 | 25 | 7 | 2 | 2 | 3 | 3 | 
| internal_recursive.0 | 1 | 12 | 170 | 12 | 2 | 0 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 9 | 129 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 151 | 1,406 | 151 | 54 | 25 | 3 | 6 | 6 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 61,220,603 | 357 | 183 | 0 | 0 | 131 | 38 | 37 | 64 | 28 | 0 | 42 | 23 | 18 | 5 | 12 | 183 | 131 | 0 | 2 | 26 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,879 | 157 | 48 | 0 | 0 | 72 | 25 | 24 | 29 | 17 | 0 | 36 | 27 | 8 | 2 | 6 | 49 | 72 | 0 | 2 | 17 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 119 | 31 | 0 | 0 | 62 | 24 | 23 | 24 | 13 | 0 | 24 | 17 | 7 | 1 | 5 | 31 | 62 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 425,198,438 | 1,255 | 799 | 0 | 155 | 352 | 171 | 170 | 104 | 76 | 0 | 102 | 39 | 62 | 36 | 26 | 800 | 352 | 0 | 7 | 75 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 649,888,033 | 2,198 | 634 | 0 | 124 | 1,426 | 664 | 663 | 307 | 454 | 139 | 138 | 37 | 101 | 61 | 39 | 634 | 1,426 | 0 | 4 | 314 | 0 | 0 | 
| app_proof | prover | 1 | 649,887,756 | 1,953 | 510 | 0 | 2 | 1,302 | 667 | 667 | 304 | 330 | 0 | 139 | 39 | 100 | 61 | 39 | 510 | 1,302 | 0 | 4 | 329 | 0 | 0 | 
| app_proof | prover | 2 | 649,887,756 | 1,951 | 510 | 0 | 2 | 1,302 | 665 | 664 | 306 | 330 | 0 | 137 | 39 | 98 | 59 | 38 | 510 | 1,302 | 0 | 3 | 329 | 0 | 0 | 
| app_proof | prover | 3 | 649,888,004 | 1,943 | 510 | 0 | 2 | 1,297 | 664 | 663 | 302 | 330 | 0 | 135 | 38 | 96 | 57 | 38 | 510 | 1,297 | 0 | 3 | 329 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 64 | 2,506 | 64 | 137 | 0 | 3 | 105 | 2,851,000 | 30.80 | 
| app_proof | 1 | 57 | 2,261 | 57 | 41 | 0 | 1 | 209 | 2,851,000 | 33.64 | 
| app_proof | 2 | 57 | 2,232 | 57 | 41 | 0 | 1 | 181 | 2,851,000 | 33.73 | 
| app_proof | 3 | 54 | 2,214 | 54 | 41 | 0 | 1 | 175 | 2,614,961 | 33.28 | 

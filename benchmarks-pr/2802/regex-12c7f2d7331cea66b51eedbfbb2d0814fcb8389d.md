...
|:---|---:|---:|---:|
| Total |  2.50 |  1.81 |  1.81 |
| app_proof |  1.64 |  0.96 |  0.96 |
| leaf |  0.35 |  0.35 |  0.35 |
...
| `total_proof_time_ms ` |  803.50 |  1,607 |  926 |  681 |
| `execute_metered_time_ms` |  33 | -          | -          | -          |
| `execute_metered_insns` |  4,090,656 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  123.57 | -          |  123.57 |  123.57 |
| `execute_preflight_insns` |  2,045,328 |  4,090,656 |  2,327,000 |  1,763,656 |
| `execute_preflight_time_ms` |  86 |  172 |  95 |  77 |
| `execute_preflight_insn_mi/s` |  32.77 | -          |  33.94 |  31.59 |
| `trace_gen_time_ms   ` |  37.50 |  75 |  43 |  32 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  591 |  1,182 |  663 |  519 |
| `prover.main_trace_commit_time_ms` |  121 |  242 |  137 |  105 |
| `prover.rap_constraints_time_ms` |  420 |  840 |  470 |  370 |
| `prover.openings_time_ms` |  49 |  98 |  55 |  43 |
| `prover.rap_constraints.logup_gkr_time_ms` |  282.50 |  565 |  336 |  229 |
| `prover.rap_constraints.round0_time_ms` |  96 |  192 |  104 |  88 |
...
| `prover.openings.whir_time_ms` |  25.50 |  51 |  29 |  22 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/12c7f2d7331cea66b51eedbfbb2d0814fcb8389d/regex-12c7f2d7331cea66b51eedbfbb2d0814fcb8389d.memory.svg)

| Module | Max (GB) | Max At |
| --- | ---: | --- |
| prover.batch_constraints.before_round0 | 5.33 | app_proof.prover.0 |
| frac_sumcheck.gkr_rounds | 5.33 | app_proof.prover.0 |
| prover.gkr_input_evals | 5.20 | app_proof.prover.0 |
| frac_sumcheck.segment_tree | 5.20 | app_proof.prover.0 |
| prover.batch_constraints.round0 | 2.93 | app_proof.prover.0 |
| prover.batch_constraints.fold_ple_evals | 2.93 | app_proof.prover.0 |
...
| app_proof |  |  |  |  |  | 681 |  |  | 33 | 4,090,656 | 123.57 | 0 | 1,654 |  | 
...
| internal_recursive.0 | 1 | 9 | 152 | 9 | 1 | 0 | 2 | 0 | 0 | 
| internal_recursive.1 | 1 | 9 | 125 | 8 | 1 | 0 | 1 | 0 | 0 | 
| leaf | 0 | 50 | 354 | 50 | 14 | 3 | 4 | 1 | 1 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 27,289,339 | 209 | 81 | 0 | 0 | 97 | 32 | 31 | 45 | 19 | 0 | 29 | 18 | 11 | 2 | 8 | 81 | 97 | 0 | 2 | 18 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,703 | 142 | 46 | 0 | 0 | 67 | 25 | 25 | 27 | 13 | 0 | 28 | 20 | 8 | 1 | 6 | 46 | 67 | 0 | 2 | 12 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 116 | 31 | 0 | 0 | 60 | 23 | 22 | 24 | 12 | 0 | 24 | 16 | 7 | 1 | 5 | 31 | 60 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 79,659,764 | 304 | 127 | 0 | 0 | 133 | 54 | 53 | 37 | 41 | 0 | 43 | 28 | 15 | 6 | 8 | 127 | 133 | 0 | 5 | 40 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 169,896,914 | 663 | 137 | 0 | 0 | 470 | 88 | 88 | 45 | 336 | 91 | 55 | 29 | 26 | 14 | 11 | 137 | 470 | 0 | 3 | 244 | 0 | 0 | 
| app_proof | prover | 1 | 129,384,771 | 519 | 104 | 0 | 8 | 370 | 104 | 104 | 36 | 229 | 0 | 43 | 22 | 21 | 10 | 10 | 105 | 370 | 0 | 3 | 228 | 0 | 0 | 

| group | phase | segment | trace_height_constraint | weighted_sum | threshold |
| --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 0 | 94,331,085 | 2,013,265,921 | 
| app_proof | prover | 1 | 0 | 72,825,402 | 2,013,265,921 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 32 | 926 | 32 | 135 | 1 | 4 | 95 | 2,327,000 | 31.59 | 
| app_proof | 1 | 43 | 681 | 43 | 40 | 0 | 2 | 77 | 1,763,656 | 33.94 | 

...
|:---|---:|---:|---:|
| Total |  11.42 |  4.69 |  4.69 |
| app_proof |  9.34 |  2.61 |  2.61 |
| leaf |  1.41 |  1.41 |  1.41 |
...
| `total_proof_time_ms ` |  2,310.25 |  9,241 |  2,516 |  2,221 |
...
| `execute_preflight_time_ms` |  163.50 |  654 |  204 |  101 |
| `execute_preflight_insn_mi/s` |  34.62 | -          |  35.47 |  32.28 |
| `trace_gen_time_ms   ` |  58.25 |  233 |  65 |  54 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  2,022.25 |  8,089 |  2,212 |  1,954 |
| `prover.main_trace_commit_time_ms` |  542.75 |  2,171 |  637 |  510 |
| `prover.rap_constraints_time_ms` |  1,338.50 |  5,354 |  1,434 |  1,304 |
| `prover.openings_time_ms` |  139.75 |  559 |  141 |  138 |
| `prover.rap_constraints.logup_gkr_time_ms` |  363.25 |  1,453 |  459 |  331 |
| `prover.rap_constraints.round0_time_ms` |  667.75 |  2,671 |  670 |  666 |
| `prover.rap_constraints.mle_rounds_time_ms` |  306.50 |  1,226 |  308 |  306 |
| `prover.openings.stacked_reduction_time_ms` |  101 |  404 |  103 |  99 |
| `prover.openings.stacked_reduction.round0_time_ms` |  61 |  244 |  62 |  60 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  39.25 |  157 |  40 |  39 |
| `prover.openings.whir_time_ms` |  38.50 |  154 |  39 |  37 |
...
| `prover.rap_constraints_time_ms` |  353 |  353 |  353 |  353 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/12c7f2d7331cea66b51eedbfbb2d0814fcb8389d/sha2_bench-12c7f2d7331cea66b51eedbfbb2d0814fcb8389d.memory.svg)

| Module | Max (GB) | Max At |
| --- | ---: | --- |
| prover.batch_constraints.before_round0 | 11.76 | app_proof.prover.3 |
| frac_sumcheck.gkr_rounds | 11.76 | app_proof.prover.3 |
| prover.gkr_input_evals | 11.66 | app_proof.prover.0 |
| frac_sumcheck.segment_tree | 11.66 | app_proof.prover.0 |
| prover.rap_constraints | 11.04 | app_proof.prover.0 |
| prover.batch_constraints.fold_ple_evals | 10.49 | app_proof.prover.0 |
| prover.batch_constraints.round0 | 10.49 | app_proof.prover.0 |
| prover.openings | 9.87 | app_proof.prover.0 |
| prover.prove_whir_opening | 9.87 | app_proof.prover.0 |
| prover.merkle_tree | 9.87 | app_proof.prover.0 |
...
| 14 | Rv64HintStoreAir | 23 | 15 | 3 | 
| 15 | VmAirWrapper<Rv64RdWriteAdapterAir, Rv64AuipcCoreAir> | 12 | 6 | 3 | 
| 16 | VmAirWrapper<Rv64JalrAdapterAir, Rv64JalrCoreAir> | 18 | 9 | 3 | 
| 17 | VmAirWrapper<Rv64CondRdWriteAdapterAir, Rv64JalLuiCoreAir> | 10 | 10 | 2 | 
| 18 | VmAirWrapper<Rv64BranchAdapterAir, BranchLessThanCoreAir<8, 8> | 21 | 37 | 3 | 
| 19 | VmAirWrapper<Rv64BranchAdapterAir, BranchEqualCoreAir<8> | 19 | 15 | 3 | 
...
| 24 | VmAirWrapper<Rv64BaseAluAdapterAir, LessThanCoreAir<8, 8> | 26 | 44 | 3 | 
...
| app_proof |  |  |  |  |  | 2,221 |  |  | 96 | 11,167,961 | 115.69 | 0 | 9,344 |  | 
| internal_for_leaf |  |  |  | 379 |  |  |  |  |  |  |  |  |  | 379 | 
| internal_recursive.0 |  |  |  | 160 |  |  |  |  |  |  |  |  |  | 160 | 
| internal_recursive.1 |  |  |  | 128 |  |  |  |  |  |  |  |  |  | 129 | 
| leaf |  |  | 1,414 |  |  |  |  |  |  |  |  |  |  | 1,414 | 
...
| app_proof | 14 | Rv64HintStoreAir | prover | 0 | 2 | 34 | 68 | 
| app_proof | 15 | VmAirWrapper<Rv64RdWriteAdapterAir, Rv64AuipcCoreAir> | prover | 0 | 65,536 | 21 | 1,376,256 | 
| app_proof | 16 | VmAirWrapper<Rv64JalrAdapterAir, Rv64JalrCoreAir>
...
|:---|---:|---:|---:|
| Total |  11.34 |  4.66 |  4.66 |
| app_proof |  9.25 |  2.57 |  2.57 |
| leaf |  1.42 |  1.42 |  1.42 |
...
| `total_proof_time_ms ` |  2,287.75 |  9,151 |  2,468 |  2,204 |
...
| `execute_preflight_time_ms` |  171.25 |  685 |  217 |  106 |
| `execute_preflight_insn_mi/s` |  32.73 | -          |  33.61 |  30.43 |
| `trace_gen_time_ms   ` |  57.75 |  231 |  63 |  54 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,993 |  7,972 |  2,162 |  1,931 |
| `prover.main_trace_commit_time_ms` |  543 |  2,172 |  635 |  511 |
| `prover.rap_constraints_time_ms` |  1,312.25 |  5,249 |  1,391 |  1,278 |
| `prover.openings_time_ms` |  136.75 |  547 |  140 |  134 |
| `prover.rap_constraints.logup_gkr_time_ms` |  341.50 |  1,366 |  421 |  314 |
| `prover.rap_constraints.round0_time_ms` |  665.50 |  2,662 |  672 |  662 |
| `prover.rap_constraints.mle_rounds_time_ms` |  304 |  1,216 |  306 |  300 |
| `prover.openings.stacked_reduction_time_ms` |  99 |  396 |  100 |  98 |
...
| `prover.openings.whir_time_ms` |  37.25 |  149 |  42 |  34 |
...
| `prover.main_trace_commit_time_ms` |  808 |  808 |  808 |  808 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/8b0a2d8ac8d8b8f7be4bc65b494c773cdc9b5499/sha2_bench-8b0a2d8ac8d8b8f7be4bc65b494c773cdc9b5499.memory.svg)

| Module | Max (GB) | Max At |
| --- | ---: | --- |
| prover.batch_constraints.before_round0 | 11.24 | app_proof.prover.3 |
| frac_sumcheck.gkr_rounds | 11.24 | app_proof.prover.3 |
| frac_sumcheck.segment_tree | 11.14 | app_proof.prover.0 |
| prover.gkr_input_evals | 11.14 | app_proof.prover.0 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 78 | 9 |  |  | 0 |  | 353 | 9 |  |  |  |  |  |  | 
| app_proof |  |  |  |  |  | 2,204 |  |  | 98 | 11,167,961 | 113.74 | 0 | 9,256 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 25 | 383 | 24 | 7 | 2 | 2 | 3 | 3 | 
| internal_recursive.0 | 1 | 12 | 161 | 12 | 2 | 0 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 9 | 126 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 152 | 1,421 | 152 | 53 | 25 | 2 | 6 | 6 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 61,220,603 | 358 | 183 | 0 | 0 | 131 | 38 | 38 | 65 | 27 | 0 | 42 | 23 | 19 | 5 | 13 | 184 | 131 | 0 | 3 | 26 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,879 | 149 | 48 | 0 | 0 | 72 | 24 | 23 | 29 | 18 | 0 | 27 | 19 | 8 | 1 | 6 | 48 | 72 | 0 | 2 | 17 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 116 | 32 | 0 | 0 | 60 | 22 | 22 | 24 | 13 | 0 | 23 | 16 | 7 | 1 | 5 | 32 | 60 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 425,198,438 | 1,268 | 807 | 0 | 163 | 350 | 168 | 167 | 106 | 76 | 0 | 109 | 44 | 64 | 36 | 28 | 808 | 350 | 0 | 7 | 75 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 649,888,033 | 2,162 | 635 | 0 | 124 | 1,391 | 662 | 661 | 306 | 421 | 121 | 135 | 35 | 99 | 59 | 39 | 635 | 1,391 | 0 | 3 | 299 | 0 | 0 | 
| app_proof | prover | 1 | 649,887,756 | 1,941 | 513 | 0 | 2 | 1,288 | 665 | 664 | 306 | 316 | 0 | 138 | 38 | 100 | 61 | 39 | 514 | 1,288 | 0 | 3 | 314 | 0 | 0 | 
| app_proof | prover | 2 | 649,887,756 | 1,938 | 511 | 0 | 2 | 1,292 | 672 | 672 | 304 | 315 | 0 | 134 | 34 | 99 | 60 | 39 | 512 | 1,292 | 0 | 3 | 314 | 0 | 0 | 
| app_proof | prover | 3 | 649,888,004 | 1,931 | 511 | 0 | 2 | 1,278 | 663 | 663 | 300 | 314 | 0 | 140 | 42 | 98 | 59 | 38 | 511 | 1,278 | 0 | 3 | 312 | 0 | 0 | 

| group | phase | segment | trace_height_constraint | weighted_sum | threshold |
| --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 0 | 112,615,835 | 2,013,265,921 | 
| app_proof | prover | 1 | 0 | 112,615,690 | 2,013,265,921 | 
| app_proof | prover | 2 | 0 | 112,615,690 | 2,013,265,921 | 
| app_proof | prover | 3 | 0 | 112,615,806 | 2,013,265,921 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 63 | 2,468 | 63 | 135 | 0 | 3 | 106 | 2,851,000 | 30.43 | 
| app_proof | 1 | 57 | 2,257 | 57 | 41 | 0 | 1 | 217 | 2,851,000 | 33.61 | 
| app_proof | 2 | 57 | 2,222 | 57 | 41 | 0 | 1 | 185 | 2,851,000 | 33.54 | 
| app_proof | 3 | 54 | 2,204 | 54 | 41 | 0 | 1 | 177 | 2,614,961 | 33.36 | 

...
| `total_proof_time_ms ` |  732.50 |  1,465 |  874 |  591 |
| `execute_metered_time_ms` |  33 | -          | -          | -          |
| `execute_metered_insns` |  4,090,656 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  121.17 | -          |  121.17 |  121.17 |
| `execute_preflight_insns` |  2,045,328 |  4,090,656 |  2,327,000 |  1,763,656 |
| `execute_preflight_time_ms` |  88.50 |  177 |  98 |  79 |
| `execute_preflight_insn_mi/s` |  31.41 | -          |  32.57 |  30.25 |
| `trace_gen_time_ms   ` |  33.50 |  67 |  40 |  27 |
| `memory_finalize_time_ms` |  1 |  2 |  2 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  521 |  1,042 |  611 |  431 |
| `prover.main_trace_commit_time_ms` |  119.50 |  239 |  136 |  103 |
| `prover.rap_constraints_time_ms` |  353 |  706 |  423 |  283 |
| `prover.openings_time_ms` |  47 |  94 |  51 |  43 |
| `prover.rap_constraints.logup_gkr_time_ms` |  220 |  440 |  294 |  146 |
| `prover.rap_constraints.round0_time_ms` |  92.50 |  185 |  100 |  85 |
| `prover.rap_constraints.mle_rounds_time_ms` |  39.50 |  79 |  43 |  36 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/8b0a2d8ac8d8b8f7be4bc65b494c773cdc9b5499/regex-8b0a2d8ac8d8b8f7be4bc65b494c773cdc9b5499.memory.svg)

| Module | Max (GB) | Max At |
| --- | ---: | --- |
| prover.batch_constraints.before_round0 | 4.81 | app_proof.prover.0 |
| frac_sumcheck.gkr_rounds | 4.81 | app_proof.prover.0 |
| frac_sumcheck.segment_tree | 4.68 | app_proof.prover.0 |
| prover.gkr_input_evals | 4.68 | app_proof.prover.0 |
| prover.rap_constraints | 2.93 | app_proof.prover.0 |
| generate mem proving ctxs | 2.86 | app_proof.0 |
| set initial memory | 2.85 | app_proof.1 |
| prover.batch_constraints.round0 | 2.74 | app_proof.prover.0 |
| prover.batch_constraints.fold_ple_evals | 2.74 | app_proof.prover.0 |
| prover.prove_whir_opening | 2.67 | app_proof.prover.0 |
| prover.merkle_tree | 2.67 | app_proof.prover.0 |
| prover.openings | 2.67 | app_proof.prover.0 |
| prover.before_gkr_input_evals | 2.27 | app_proof.prover.0 |
| prover.stacked_commit | 2.27 | app_proof.prover.0 |
| prover.rs_code_matrix | 2.25 | app_proof.prover.0 |
...
| app_proof |  |  |  |  |  | 591 |  |  | 33 | 4,090,656 | 121.17 | 0 | 1,512 |  | 
...
| app_proof | 13 | Rv64HintStoreAir | prover | 0 | 8,192 | 34 | 278,528 | 
...
| app_proof | 23 | VmAirWrapper<Rv64BaseAluAdapterAir, LessThanCoreAir<8, 8> | prover | 0 | 16,384 | 49 | 802,816 | 
...
| app_proof | 15 | VmAirWrapper<Rv64JalrAdapterAir, Rv64JalrCoreAir> | prover | 1 | 65,536 | 28 | 1,835,008 | 
| app_proof | 16 | VmAirWrapper<Rv64CondRdWriteAdapterAir, Rv64JalLuiCoreAir> | prover | 1 | 32,768 | 19 | 622,592 | 
...
| app_proof | 23 | VmAirWrapper<Rv64BaseAluAdapterAir, LessThanCoreAir<8, 8> | prover | 1 | 16,384 | 49 | 802,816 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 27,289,339 | 207 | 80 | 0 | 0 | 96 | 31 | 30 | 45 | 20 | 0 | 29 | 18 | 11 | 2 | 8 | 81 | 96 | 0 | 2 | 18 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,703 | 139 | 45 | 0 | 0 | 68 | 26 | 25 | 27 | 14 | 0 | 24 | 16 | 8 | 1 | 6 | 46 | 68 | 0 | 2 | 12 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 121 | 31 | 0 | 0 | 61 | 23 | 23 | 24 | 13 | 0 | 28 | 21 | 7 | 1 | 5 | 31 | 61 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 79,659,764 | 301 | 126 | 0 | 1 | 132 | 53 | 52 | 37 | 42 | 0 | 41 | 26 | 15 | 6 | 8 | 126 | 132 | 0 | 5 | 41 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 169,896,914 | 611 | 136 | 0 | 0 | 423 | 85 | 84 | 43 | 294 | 70 | 51 | 26 | 25 | 13 | 11 | 136 | 423 | 0 | 3 | 223 | 0 | 0 | 
| app_proof | prover | 1 | 129,384,771 | 431 | 103 | 0 | 8 | 283 | 100 | 100 | 36 | 146 | 0 | 43 | 22 | 21 | 10 | 10 | 103 | 283 | 0 | 3 | 145 | 0 | 0 | 

| group | phase | segment | trace_height_constraint | weighted_sum | threshold |
| --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 0 | 76,824,781 | 2,013,265,921 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 27 | 874 | 27 | 135 | 2 | 4 | 98 | 2,327,000 | 30.25 | 
| app_proof | 1 | 40 | 591 | 40 | 41 | 0 | 2 | 79 | 1,763,656 | 32.57 | 

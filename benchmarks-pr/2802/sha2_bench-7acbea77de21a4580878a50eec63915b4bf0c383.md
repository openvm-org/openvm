...
| `total_proof_time_ms ` |  2,251.25 |  9,005 |  2,428 |  2,178 |
| `execute_metered_time_ms` |  97 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  114.28 | -          |  114.28 |  114.28 |
| `execute_preflight_insns` |  2,791,990.25 |  11,167,961 |  2,851,000 |  2,614,961 |
| `execute_preflight_time_ms` |  169.50 |  678 |  212 |  105 |
| `execute_preflight_insn_mi/s` |  32.64 | -          |  33.54 |  30.56 |
| `trace_gen_time_ms   ` |  58 |  232 |  64 |  54 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,957.50 |  7,830 |  2,121 |  1,898 |
| `prover.main_trace_commit_time_ms` |  533 |  2,132 |  622 |  503 |
| `prover.rap_constraints_time_ms` |  1,288 |  5,152 |  1,366 |  1,259 |
| `prover.openings_time_ms` |  135.75 |  543 |  141 |  132 |
| `prover.rap_constraints.logup_gkr_time_ms` |  337 |  1,348 |  417 |  310 |
| `prover.rap_constraints.round0_time_ms` |  653 |  2,612 |  656 |  651 |
| `prover.rap_constraints.mle_rounds_time_ms` |  297 |  1,188 |  299 |  295 |
...
| `prover.openings.whir_time_ms` |  37 |  148 |  42 |  34 |
...
| `prover.main_trace_commit_time_ms` |  180 |  180 |  180 |  180 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/7acbea77de21a4580878a50eec63915b4bf0c383/sha2_bench-7acbea77de21a4580878a50eec63915b4bf0c383.memory.svg)
...
| app_proof |  |  |  |  |  | 2,178 |  |  | 97 | 11,167,961 | 114.28 | 0 | 9,109 |  | 
...
| leaf | 0 | 148 | 1,387 | 148 | 53 | 25 | 3 | 6 | 6 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 61,220,603 | 348 | 179 | 0 | 0 | 129 | 37 | 37 | 64 | 27 | 0 | 39 | 20 | 18 | 5 | 12 | 180 | 129 | 0 | 3 | 26 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,879 | 148 | 48 | 0 | 0 | 72 | 25 | 25 | 29 | 17 | 0 | 26 | 18 | 8 | 1 | 6 | 48 | 72 | 0 | 2 | 16 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 117 | 31 | 0 | 0 | 59 | 22 | 21 | 24 | 13 | 0 | 26 | 19 | 7 | 1 | 5 | 31 | 59 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 425,198,438 | 1,238 | 793 | 0 | 158 | 344 | 166 | 165 | 103 | 74 | 0 | 100 | 38 | 61 | 35 | 26 | 794 | 344 | 0 | 7 | 73 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 649,888,033 | 2,121 | 621 | 0 | 122 | 1,366 | 651 | 651 | 297 | 417 | 121 | 132 | 34 | 97 | 58 | 38 | 622 | 1,366 | 0 | 3 | 295 | 0 | 0 | 
| app_proof | prover | 1 | 649,887,756 | 1,906 | 503 | 0 | 2 | 1,265 | 654 | 654 | 299 | 310 | 0 | 138 | 38 | 99 | 60 | 38 | 503 | 1,264 | 0 | 4 | 308 | 0 | 0 | 
| app_proof | prover | 2 | 649,887,756 | 1,898 | 503 | 0 | 2 | 1,262 | 656 | 655 | 295 | 310 | 0 | 132 | 34 | 97 | 59 | 38 | 503 | 1,262 | 0 | 3 | 309 | 0 | 0 | 
| app_proof | prover | 3 | 649,888,004 | 1,905 | 504 | 0 | 2 | 1,259 | 651 | 650 | 297 | 311 | 0 | 141 | 42 | 99 | 60 | 38 | 504 | 1,259 | 0 | 3 | 309 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 64 | 2,428 | 64 | 137 | 0 | 4 | 105 | 2,851,000 | 30.56 | 
| app_proof | 1 | 57 | 2,218 | 57 | 41 | 0 | 1 | 212 | 2,851,000 | 33.10 | 
| app_proof | 2 | 57 | 2,181 | 57 | 41 | 0 | 1 | 184 | 2,851,000 | 33.54 | 
| app_proof | 3 | 54 | 2,178 | 54 | 41 | 0 | 1 | 177 | 2,614,961 | 33.35 | 

...
|:---|---:|---:|---:|
| Total |  2.52 |  1.83 |  1.83 |
| app_proof |  1.65 |  0.96 |  0.96 |
| leaf |  0.36 |  0.36 |  0.36 |
...
| `total_proof_time_ms ` |  808 |  1,616 |  928 |  688 |
| `execute_metered_time_ms` |  34 | -          | -          | -          |
| `execute_metered_insns` |  4,090,656 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  119.60 | -          |  119.60 |  119.60 |
| `execute_preflight_insns` |  2,045,328 |  4,090,656 |  2,327,000 |  1,763,656 |
| `execute_preflight_time_ms` |  89 |  178 |  97 |  81 |
| `execute_preflight_insn_mi/s` |  31.32 | -          |  31.100 |  30.64 |
| `trace_gen_time_ms   ` |  34.50 |  69 |  39 |  30 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  594.50 |  1,189 |  663 |  526 |
| `prover.main_trace_commit_time_ms` |  121 |  242 |  137 |  105 |
| `prover.rap_constraints_time_ms` |  422.50 |  845 |  469 |  376 |
| `prover.openings_time_ms` |  49.50 |  99 |  55 |  44 |
| `prover.rap_constraints.logup_gkr_time_ms` |  283.50 |  567 |  335 |  232 |
| `prover.rap_constraints.round0_time_ms` |  97.50 |  195 |  107 |  88 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/4f3eaf870da012bcefb0be884967ee28ae365fdb/regex-4f3eaf870da012bcefb0be884967ee28ae365fdb.memory.svg)
...
| app_proof |  |  |  |  |  | 688 |  |  | 34 | 4,090,656 | 119.60 | 0 | 1,664 |  | 
...
| internal_recursive.0 | 1 | 10 | 160 | 9 | 1 | 0 | 2 | 0 | 0 | 
| internal_recursive.1 | 1 | 9 | 127 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 50 | 357 | 50 | 14 | 3 | 4 | 1 | 1 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 27,289,339 | 213 | 82 | 0 | 0 | 98 | 32 | 32 | 45 | 20 | 0 | 31 | 20 | 11 | 2 | 8 | 82 | 98 | 0 | 2 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,703 | 150 | 45 | 0 | 0 | 69 | 26 | 25 | 28 | 14 | 0 | 35 | 26 | 8 | 1 | 6 | 46 | 69 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 117 | 32 | 0 | 0 | 61 | 23 | 23 | 24 | 13 | 0 | 23 | 16 | 7 | 1 | 5 | 32 | 61 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 79,659,764 | 306 | 128 | 0 | 0 | 133 | 54 | 53 | 37 | 41 | 0 | 43 | 28 | 15 | 6 | 8 | 128 | 133 | 0 | 5 | 41 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 169,896,914 | 663 | 137 | 0 | 0 | 469 | 88 | 87 | 46 | 335 | 90 | 55 | 28 | 27 | 15 | 11 | 137 | 469 | 0 | 3 | 243 | 0 | 0 | 
| app_proof | prover | 1 | 129,384,771 | 526 | 105 | 0 | 8 | 376 | 107 | 106 | 36 | 232 | 0 | 44 | 22 | 21 | 10 | 11 | 105 | 376 | 0 | 3 | 231 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 30 | 928 | 30 | 137 | 1 | 5 | 97 | 2,327,000 | 30.64 | 
| app_proof | 1 | 39 | 688 | 39 | 40 | 0 | 2 | 81 | 1,763,656 | 31.100 | 

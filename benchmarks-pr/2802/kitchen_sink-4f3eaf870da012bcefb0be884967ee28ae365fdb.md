...
|:---|---:|---:|---:|
| Total |  2.92 |  2.31 |  2.31 |
| app_proof |  2.20 |  1.60 |  1.60 |
| leaf |  0.41 |  0.41 |  0.41 |
...
| `total_proof_time_ms ` |  1,088 |  2,176 |  1,571 |  605 |
| `execute_metered_time_ms` |  24 | -          | -          | -          |
| `execute_metered_insns` |  1,979,971 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  81.01 | -          |  81.01 |  81.01 |
| `execute_preflight_insns` |  989,985.50 |  1,979,971 |  1,278,000 |  701,971 |
| `execute_preflight_time_ms` |  85.50 |  171 |  111 |  60 |
| `execute_preflight_insn_mi/s` |  29.81 | -          |  30.94 |  28.67 |
| `trace_gen_time_ms   ` |  29 |  58 |  44 |  14 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  884.50 |  1,769 |  1,331 |  438 |
| `prover.main_trace_commit_time_ms` |  298.50 |  597 |  480 |  117 |
| `prover.rap_constraints_time_ms` |  533.50 |  1,067 |  782 |  285 |
| `prover.openings_time_ms` |  51 |  102 |  67 |  35 |
| `prover.rap_constraints.logup_gkr_time_ms` |  85.50 |  171 |  132 |  39 |
| `prover.rap_constraints.round0_time_ms` |  307.50 |  615 |  435 |  180 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  412 |  412 |  412 |  412 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/4f3eaf870da012bcefb0be884967ee28ae365fdb/kitchen_sink-4f3eaf870da012bcefb0be884967ee28ae365fdb.memory.svg)
...
| prover.gkr_input_evals | 12.92 | app_proof.prover.0 |
| prover.batch_constraints.before_round0 | 12.92 | app_proof.prover.0 |
| frac_sumcheck.gkr_rounds | 12.92 | app_proof.prover.0 |
| frac_sumcheck.segment_tree | 12.92 | app_proof.prover.0 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 84 | 3 |  |  | 0 |  | 366 | 3 |  |  |  |  |  |  | 
| app_proof |  |  |  |  |  | 605 |  |  | 24 | 1,979,971 | 81.01 | 0 | 2,205 |  | 
...
| internal_recursive.0 | 1 | 10 | 88 | 9 | 1 | 0 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 9 | 84 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 114 | 412 | 114 | 28 | 13 | 18 | 3 | 3 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,577,915 | 117 | 38 | 0 | 0 | 62 | 21 | 20 | 29 | 12 | 0 | 15 | 7 | 7 | 1 | 6 | 38 | 62 | 0 | 1 | 11 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,703 | 78 | 16 | 0 | 0 | 47 | 17 | 17 | 20 | 9 | 0 | 13 | 8 | 5 | 1 | 4 | 16 | 47 | 0 | 1 | 9 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 75 | 11 | 0 | 0 | 49 | 20 | 19 | 18 | 10 | 0 | 13 | 8 | 5 | 0 | 4 | 11 | 49 | 0 | 1 | 9 | 0 | 0 | 
| leaf | 0 | prover | 263,565,172 | 297 | 128 | 0 | 1 | 140 | 49 | 48 | 37 | 54 | 0 | 27 | 11 | 15 | 7 | 8 | 128 | 140 | 0 | 2 | 53 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 904,012,452 | 1,331 | 479 | 0 | 269 | 782 | 435 | 433 | 215 | 132 | 66 | 67 | 15 | 52 | 25 | 27 | 480 | 782 | 0 | 1 | 64 | 0 | 0 | 
| app_proof | prover | 1 | 458,298,508 | 438 | 116 | 0 | 1 | 285 | 180 | 179 | 65 | 39 | 0 | 35 | 11 | 24 | 12 | 11 | 117 | 285 | 0 | 1 | 38 | 0 | 0 | 

| group | phase | segment | trace_height_constraint | weighted_sum | threshold |
| --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 0 | 60,417,546 | 2,013,265,921 | 
| app_proof | prover | 1 | 0 | 32,258,314 | 2,013,265,921 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 44 | 1,571 | 44 | 135 | 0 | 3 | 60 | 1,278,000 | 28.67 | 
| app_proof | 1 | 14 | 605 | 14 | 40 | 0 | 1 | 111 | 701,971 | 30.94 | 

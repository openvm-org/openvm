...
|:---|---:|---:|---:|
| Total |  2.50 |  1.82 |  1.82 |
| app_proof |  1.63 |  0.95 |  0.95 |
| leaf |  0.35 |  0.35 |  0.35 |
...
| `total_proof_time_ms ` |  799 |  1,598 |  920 |  678 |
| `execute_metered_time_ms` |  33 | -          | -          | -          |
| `execute_metered_insns` |  4,090,656 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  121.45 | -          |  121.45 |  121.45 |
| `execute_preflight_insns` |  2,045,328 |  4,090,656 |  2,327,000 |  1,763,656 |
| `execute_preflight_time_ms` |  87 |  174 |  97 |  77 |
| `execute_preflight_insn_mi/s` |  32.45 | -          |  34.17 |  30.74 |
| `trace_gen_time_ms   ` |  35 |  70 |  42 |  28 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  587.50 |  1,175 |  658 |  517 |
| `prover.main_trace_commit_time_ms` |  119.50 |  239 |  136 |  103 |
| `prover.rap_constraints_time_ms` |  417.50 |  835 |  466 |  369 |
| `prover.openings_time_ms` |  49 |  98 |  55 |  43 |
| `prover.rap_constraints.logup_gkr_time_ms` |  281.50 |  563 |  335 |  228 |
| `prover.rap_constraints.round0_time_ms` |  95 |  190 |  104 |  86 |
...
| `prover.openings.whir_time_ms` |  25 |  50 |  28 |  22 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/1ef15de87cad201df013dacfe95250c6fb7c14ef/regex-1ef15de87cad201df013dacfe95250c6fb7c14ef.memory.svg)
...
| app_proof |  |  |  |  |  | 678 |  |  | 33 | 4,090,656 | 121.45 | 0 | 1,646 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 27,289,339 | 212 | 80 | 0 | 0 | 97 | 32 | 31 | 45 | 19 | 0 | 33 | 22 | 11 | 2 | 8 | 81 | 97 | 0 | 2 | 18 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,703 | 140 | 46 | 0 | 0 | 67 | 25 | 24 | 27 | 14 | 0 | 26 | 17 | 8 | 1 | 6 | 46 | 67 | 0 | 2 | 12 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 123 | 31 | 0 | 0 | 61 | 24 | 23 | 24 | 13 | 0 | 30 | 23 | 7 | 1 | 5 | 31 | 61 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 79,659,764 | 302 | 126 | 0 | 0 | 132 | 53 | 52 | 37 | 41 | 0 | 42 | 27 | 15 | 6 | 8 | 126 | 132 | 0 | 5 | 40 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 169,896,914 | 658 | 136 | 0 | 0 | 466 | 86 | 85 | 44 | 335 | 91 | 55 | 28 | 26 | 14 | 11 | 136 | 466 | 0 | 3 | 243 | 0 | 0 | 
| app_proof | prover | 1 | 129,384,771 | 517 | 103 | 0 | 8 | 369 | 104 | 103 | 36 | 228 | 0 | 43 | 22 | 21 | 10 | 10 | 103 | 369 | 0 | 2 | 227 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 28 | 920 | 28 | 136 | 1 | 4 | 97 | 2,327,000 | 30.74 | 
| app_proof | 1 | 42 | 678 | 42 | 41 | 0 | 2 | 77 | 1,763,656 | 34.17 | 

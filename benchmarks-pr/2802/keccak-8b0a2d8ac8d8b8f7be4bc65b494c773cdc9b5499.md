...
|:---|---:|---:|---:|
| Total |  17.01 |  4.92 |  4.92 |
| app_proof |  14.01 |  2.69 |  2.69 |
| leaf |  2.20 |  1.43 |  1.43 |
...
| `total_proof_time_ms ` |  2,310.83 |  13,865 |  2,547 |  2,221 |
| `execute_metered_time_ms` |  141 | -          | -          | -          |
| `execute_metered_insns` |  14,365,133 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  101.17 | -          |  101.17 |  101.17 |
| `execute_preflight_insns` |  2,394,188.83 |  14,365,133 |  2,413,000 |  2,300,133 |
| `execute_preflight_time_ms` |  242.17 |  1,453 |  320 |  93 |
| `execute_preflight_insn_mi/s` |  31.42 | -          |  32.02 |  29.01 |
| `trace_gen_time_ms   ` |  35.83 |  215 |  47 |  33 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,975 |  11,850 |  2,270 |  1,910 |
| `prover.main_trace_commit_time_ms` |  700.67 |  4,204 |  864 |  666 |
| `prover.rap_constraints_time_ms` |  1,092.17 |  6,553 |  1,230 |  1,058 |
| `prover.openings_time_ms` |  181.17 |  1,087 |  185 |  176 |
| `prover.rap_constraints.logup_gkr_time_ms` |  254 |  1,524 |  316 |  240 |
| `prover.rap_constraints.round0_time_ms` |  525.17 |  3,151 |  602 |  508 |
| `prover.rap_constraints.mle_rounds_time_ms` |  312 |  1,872 |  331 |  307 |
| `prover.openings.stacked_reduction_time_ms` |  137.50 |  825 |  139 |  134 |
...
| `prover.openings.whir_time_ms` |  43 |  258 |  46 |  41 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,101.50 |  2,203 |  1,431 |  772 |
| `execute_preflight_time_ms` |  5 |  10 |  5 |  5 |
| `trace_gen_time_ms   ` |  133 |  266 |  177 |  89 |
| `generate_blob_total_time_ms` |  24.50 |  49 |  33 |  16 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  968 |  1,936 |  1,253 |  683 |
| `prover.main_trace_commit_time_ms` |  550.50 |  1,101 |  725 |  376 |
| `prover.rap_constraints_time_ms` |  320.50 |  641 |  412 |  229 |
| `prover.openings_time_ms` |  96 |  192 |  115 |  77 |
| `prover.rap_constraints.logup_gkr_time_ms` |  68.50 |  137 |  86 |  51 |
| `prover.rap_constraints.round0_time_ms` |  158 |  316 |  206 |  110 |
...
| `prover.openings.whir_time_ms` |  42 |  84 |  44 |  40 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/8b0a2d8ac8d8b8f7be4bc65b494c773cdc9b5499/keccak-8b0a2d8ac8d8b8f7be4bc65b494c773cdc9b5499.memory.svg)
...
| app_proof |  |  |  |  |  | 2,221 |  |  | 141 | 14,365,133 | 101.17 | 0 | 14,015 |  | 
...
| internal_recursive.0 | 1 | 14 | 167 | 13 | 2 | 1 | 2 | 2 | 2 | 
| internal_recursive.1 | 1 | 9 | 129 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 177 | 1,431 | 177 | 64 | 33 | 5 | 7 | 7 | 
| leaf | 1 | 89 | 772 | 88 | 32 | 16 | 5 | 7 | 7 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 81,415,028 | 466 | 245 | 0 | 1 | 173 | 50 | 49 | 93 | 30 | 0 | 47 | 23 | 23 | 7 | 15 | 245 | 173 | 0 | 3 | 29 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,879 |
...
|:---|---:|---:|---:|
| Total |  2.52 |  1.47 |  1.47 |
| app_proof |  1.58 |  0.53 |  0.53 |
| leaf |  0.44 |  0.44 |  0.44 |
...
| `total_proof_time_ms ` |  390 |  1,560 |  512 |  218 |
| `execute_metered_time_ms` |  20 | -          | -          | -          |
| `execute_metered_insns` |  4,000,051 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  197.51 | -          |  197.51 |  197.51 |
| `execute_preflight_insns` |  1,000,012.75 |  4,000,051 |  1,310,000 |  70,051 |
| `execute_preflight_time_ms` |  36.50 |  146 |  50 |  4 |
| `execute_preflight_insn_mi/s` |  40.73 | -          |  41 |  40.54 |
| `trace_gen_time_ms   ` |  74.25 |  297 |  101 |  65 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  213.75 |  855 |  262 |  71 |
| `prover.main_trace_commit_time_ms` |  42.75 |  171 |  52 |  15 |
| `prover.rap_constraints_time_ms` |  139.75 |  559 |  178 |  34 |
| `prover.openings_time_ms` |  30.50 |  122 |  35 |  21 |
| `prover.rap_constraints.logup_gkr_time_ms` |  95.25 |  381 |  123 |  17 |
| `prover.rap_constraints.round0_time_ms` |  28.50 |  114 |  39 |  9 |
...
| `prover.openings.whir_time_ms` |  21 |  84 |  24 |  17 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/1ef15de87cad201df013dacfe95250c6fb7c14ef/fibonacci-1ef15de87cad201df013dacfe95250c6fb7c14ef.memory.svg)
...
| 14 | VmAirWrapper<Rv64BranchAdapterAir, BranchLessThanCoreAir<8, 8> | 21 | 37 | 3 | 
...
| 20 | VmAirWrapper<Rv64BaseAluAdapterAir, LessThanCoreAir<8, 8> | 26 | 44 | 3 | 
...
| app_proof |  |  |  |  |  | 218 |  |  | 20 | 4,000,051 | 197.51 | 0 | 1,587 |  | 
...
| app_proof | 10 | Rv64HintStoreAir | prover | 0 | 2 | 34 | 68 | 
| app_proof | 11 | VmAirWrapper<Rv64RdWriteAdapterAir, Rv64AuipcCoreAir> | prover | 0 | 8 | 21 | 168 | 
| app_proof | 12 | VmAirWrapper<Rv64JalrAdapterAir, Rv64JalrCoreAir> | prover | 0 | 4 | 28 | 112 | 
| app_proof | 13 | VmAirWrapper<Rv64CondRdWriteAdapterAir, Rv64JalLuiCoreAir> | prover | 0 | 1 | 19 | 19 | 
...
| app_proof | 20 | VmAirWrapper<Rv64BaseAluAdapterAir, LessThanCoreAir<8, 8> | prover | 0 | 1 | 49 | 49 | 
...
| app_proof | 12 | VmAirWrapper<Rv64JalrAdapterAir, Rv64JalrCoreAir> | prover | 3 | 1 | 28 | 28 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 27,289,339 | 209 | 81 | 0 | 0 | 95 | 31 | 31 | 45 | 19 | 0 | 32 | 20 | 11 | 2 | 8 | 81 | 95 | 0 | 2 | 18 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,703 | 140 | 45 | 0 | 0 | 67 | 24 | 24 | 27 | 14 | 0 | 27 | 19 | 8 | 1 | 6 | 45 | 67 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 117 | 31 | 0 | 0 | 61 | 23 | 23 | 24 | 12 | 0 | 25 | 18 | 7 | 1 | 5 | 31 | 61 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 103,146,406 | 374 | 169 | 0 | 0 | 158 | 69 | 68 | 46 | 42 | 0 | 46 | 28 | 18 | 8 | 9 | 169 | 158 | 0 | 5 | 41 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 65,794,666 | 261 | 51 | 0 | 0 | 178 | 39 | 38 | 17 | 120 | 0 | 31 | 19 | 11 | 5 | 5 | 52 | 178 | 0 | 3 | 120 | 0 | 0 | 
| app_proof | prover | 1 | 65,748,660 | 261 | 52 | 0 | 0 | 173 | 33 | 33 | 17 | 121 | 0 | 35 | 24 | 11 | 6 | 5 | 52 | 173 | 0 | 3 | 121 | 0 | 0 | 
| app_proof | prover | 2 | 65,748,660 | 262 | 52 | 0 | 0 | 174 | 33 | 33 | 17 | 123 | 0 | 35 | 24 | 11 | 6 | 5 | 52 | 174 | 0 | 3 | 122 | 0 | 0 | 
| app_proof | prover | 3 | 9,268,712 | 71 | 15 | 0 | 0 | 34 | 9 | 8 | 7 | 17 | 0 | 21 | 17 | 3 | 0 | 2 | 15 | 34 | 0 | 2 | 16 | 0 | 0 | 

| group | phase | segment | trace_height_constraint | weighted_sum | threshold |
| --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 0 | 39,983,033 | 2,013,265,921 | 
| app_proof | prover | 1 | 0 | 39,981,482 | 2,013,265,921 | 
| app_proof | prover | 2 | 0 | 39,981,482 | 2,013,265,921 | 
| app_proof | prover | 3 | 0 | 3,855,774 | 2,013,265,921 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 65 | 512 | 65 | 135 | 0 | 3 | 50 | 1,310,000 | 40.56 | 
| app_proof | 1 | 65 | 414 | 65 | 40 | 0 | 1 | 46 | 1,310,000 | 40.81 | 
| app_proof | 2 | 66 | 416 | 66 | 40 | 0 | 1 | 46 | 1,310,000 | 41 | 
| app_proof | 3 | 101 | 218 | 101 | 40 | 0 | 1 | 4 | 70,051 | 40.54 | 

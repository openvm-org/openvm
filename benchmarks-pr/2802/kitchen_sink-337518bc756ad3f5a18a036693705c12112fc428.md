...
| `total_proof_time_ms ` |  1,111.50 |  2,223 |  1,622 |  601 |
| `execute_metered_time_ms` |  24 | -          | -          | -          |
| `execute_metered_insns` |  1,979,971 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  81.17 | -          |  81.17 |  81.17 |
| `execute_preflight_insns` |  989,985.50 |  1,979,971 |  1,278,000 |  701,971 |
| `execute_preflight_time_ms` |  85 |  170 |  110 |  60 |
| `execute_preflight_insn_mi/s` |  29.57 | -          |  30.62 |  28.51 |
| `trace_gen_time_ms   ` |  28 |  56 |  43 |  13 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  909 |  1,818 |  1,383 |  435 |
| `prover.main_trace_commit_time_ms` |  300 |  600 |  483 |  117 |
| `prover.rap_constraints_time_ms` |  556 |  1,112 |  830 |  282 |
| `prover.openings_time_ms` |  52 |  104 |  69 |  35 |
| `prover.rap_constraints.logup_gkr_time_ms` |  79 |  158 |  121 |  37 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/337518bc756ad3f5a18a036693705c12112fc428/kitchen_sink-337518bc756ad3f5a18a036693705c12112fc428.memory.svg)
...
| app_proof |  |  |  |  |  | 601 |  |  | 24 | 1,979,971 | 81.17 | 0 | 2,252 |  | 
...
| leaf | 0 | 115 | 410 | 114 | 27 | 13 | 18 | 3 | 3 | 
...
| leaf | 0 | prover | 261,140,340 | 295 | 127 | 0 | 1 | 139 | 48 | 48 | 36 | 53 | 0 | 27 | 11 | 15 | 7 | 8 | 128 | 139 | 0 | 2 | 53 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 904,012,452 | 1,383 | 483 | 0 | 275 | 830 | 490 | 489 | 217 | 121 | 60 | 69 | 16 | 52 | 24 | 27 | 483 | 829 | 0 | 1 | 60 | 0 | 0 | 
| app_proof | prover | 1 | 458,298,508 | 435 | 117 | 0 | 1 | 282 | 180 | 179 | 65 | 37 | 0 | 35 | 11 | 24 | 12 | 11 | 117 | 282 | 0 | 1 | 36 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 43 | 1,622 | 43 | 135 | 0 | 3 | 60 | 1,278,000 | 28.51 | 
| app_proof | 1 | 13 | 601 | 13 | 40 | 0 | 1 | 110 | 701,971 | 30.62 | 

...
|:---|---:|---:|---:|
| Total |  2.60 |  1.53 |  1.53 |
| app_proof |  1.64 |  0.57 |  0.57 |
| leaf |  0.45 |  0.45 |  0.45 |
...
| `total_proof_time_ms ` |  396.25 |  1,585 |  519 |  218 |
| `execute_metered_time_ms` |  52 | -          | -          | -          |
| `execute_metered_insns` |  4,000,051 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  76.35 | -          |  76.35 |  76.35 |
| `execute_preflight_insns` |  1,000,012.75 |  4,000,051 |  1,310,000 |  70,051 |
| `execute_preflight_time_ms` |  36 |  144 |  49 |  4 |
| `execute_preflight_insn_mi/s` |  41.08 | -          |  41.27 |  40.92 |
| `trace_gen_time_ms   ` |  76.50 |  306 |  101 |  68 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  218.75 |  875 |  270 |  71 |
| `prover.main_trace_commit_time_ms` |  42.75 |  171 |  52 |  15 |
| `prover.rap_constraints_time_ms` |  143.25 |  573 |  181 |  34 |
| `prover.openings_time_ms` |  31.25 |  125 |  36 |  21 |
| `prover.rap_constraints.logup_gkr_time_ms` |  98.25 |  393 |  126 |  17 |
| `prover.rap_constraints.round0_time_ms` |  29 |  116 |  36 |  9 |
...
| `prover.openings.whir_time_ms` |  21.25 |  85 |  25 |  17 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/12c7f2d7331cea66b51eedbfbb2d0814fcb8389d/fibonacci-12c7f2d7331cea66b51eedbfbb2d0814fcb8389d.memory.svg)
...
| app_proof |  |  |  |  |  | 218 |  |  | 52 | 4,000,051 | 76.35 | 0 | 1,644 |  | 
...
| internal_recursive.0 | 1 | 11 | 152 | 10 | 1 | 0 | 2 | 0 | 0 | 
| internal_recursive.1 | 1 | 9 | 132 | 9 | 1 | 0 | 1 | 0 | 0 | 
| leaf | 0 | 60 | 446 | 60 | 22 | 3 | 1 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 27,289,339 | 211 | 82 | 0 | 0 | 98 | 32 | 32 | 45 | 20 | 0 | 30 | 19 | 11 | 2 | 8 | 82 | 98 | 0 | 2 | 18 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,703 | 141 | 46 | 0 | 0 | 67 | 25 | 24 | 28 | 13 | 0 | 27 | 19 | 8 | 1 | 6 | 46 | 66 | 0 | 2 | 12 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 122 | 31 | 0 | 0 | 63 | 24 | 23 | 24 | 14 | 0 | 27 | 20 | 7 | 1 | 5 | 31 | 63 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 103,146,406 | 385 | 172 | 0 | 0 | 162 | 72 | 71 | 46 | 43 | 0 | 50 | 31 | 18 | 8 | 9 | 172 | 162 | 0 | 5 | 42 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 65,794,666 | 267 | 52 | 0 | 0 | 181 | 36 | 36 | 18 | 126 | 0 | 32 | 19 | 12 | 6 | 6 | 52 | 181 | 0 | 3 | 125 | 0 | 0 | 
| app_proof | prover | 1 | 65,748,660 | 270 | 52 | 0 | 0 | 180 | 36 | 35 | 18 | 125 | 0 | 36 | 25 | 11 | 6 | 5 | 52 | 180 | 0 | 3 | 125 | 0 | 0 | 
| app_proof | prover | 2 | 65,748,660 | 267 | 52 | 0 | 0 | 178 | 35 | 35 | 18 | 125 | 0 | 36 | 24 | 11 | 6 | 5 | 52 | 178 | 0 | 3 | 124 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 68 | 519 | 68 | 135 | 0 | 3 | 49 | 1,310,000 | 41.20 | 
| app_proof | 1 | 68 | 425 | 68 | 40 | 0 | 1 | 46 | 1,310,000 | 40.96 | 
| app_proof | 2 | 69 | 423 | 69 | 40 | 0 | 1 | 45 | 1,310,000 | 41.27 | 
| app_proof | 3 | 101 | 218 | 101 | 41 | 0 | 1 | 4 | 70,051 | 40.92 | 

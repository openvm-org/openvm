...
|:---|---:|---:|---:|
| Total |  2.41 |  1.81 |  1.81 |
| app_proof |  1.54 |  0.93 |  0.93 |
| leaf |  0.36 |  0.36 |  0.36 |
...
| `total_proof_time_ms ` |  751.50 |  1,503 |  899 |  604 |
| `execute_metered_time_ms` |  33 | -          | -          | -          |
| `execute_metered_insns` |  4,090,656 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  121.83 | -          |  121.83 |  121.83 |
| `execute_preflight_insns` |  2,045,328 |  4,090,656 |  2,327,000 |  1,763,656 |
| `execute_preflight_time_ms` |  87.50 |  175 |  96 |  79 |
| `execute_preflight_insn_mi/s` |  31.80 | -          |  33.10 |  30.50 |
| `trace_gen_time_ms   ` |  37.50 |  75 |  43 |  32 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  536.50 |  1,073 |  632 |  441 |
| `prover.main_trace_commit_time_ms` |  122.50 |  245 |  139 |  106 |
| `prover.rap_constraints_time_ms` |  364 |  728 |  438 |  290 |
| `prover.openings_time_ms` |  49 |  98 |  54 |  44 |
| `prover.rap_constraints.logup_gkr_time_ms` |  224.50 |  449 |  300 |  149 |
| `prover.rap_constraints.round0_time_ms` |  97.50 |  195 |  104 |  91 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/db27775bcd5b02e59886b78fbceed2744654b62b/regex-db27775bcd5b02e59886b78fbceed2744654b62b.memory.svg)
...
| app_proof |  |  |  |  |  | 604 |  |  | 33 | 4,090,656 | 121.83 | 0 | 1,550 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 27,289,339 | 215 | 83 | 0 | 0 | 97 | 31 | 30 | 46 | 19 | 0 | 34 | 23 | 11 | 2 | 8 | 83 | 97 | 0 | 2 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,703 | 142 | 46 | 0 | 0 | 68 | 26 | 25 | 28 | 14 | 0 | 26 | 18 | 8 | 1 | 6 | 46 | 68 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 120 | 32 | 0 | 0 | 62 | 23 | 23 | 24 | 13 | 0 | 25 | 18 | 7 | 1 | 5 | 32 | 62 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 79,659,764 | 310 | 129 | 0 | 0 | 136 | 55 | 54 | 37 | 42 | 0 | 43 | 27 | 15 | 6 | 8 | 130 | 136 | 0 | 5 | 41 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 169,896,914 | 632 | 139 | 0 | 0 | 438 | 91 | 90 | 46 | 300 | 71 | 54 | 28 | 26 | 14 | 11 | 139 | 438 | 0 | 3 | 227 | 0 | 0 | 
| app_proof | prover | 1 | 129,384,771 | 441 | 106 | 0 | 8 | 290 | 104 | 103 | 36 | 149 | 0 | 44 | 22 | 21 | 10 | 11 | 106 | 290 | 0 | 3 | 148 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 32 | 899 | 32 | 137 | 1 | 4 | 96 | 2,327,000 | 30.50 | 
| app_proof | 1 | 43 | 604 | 43 | 41 | 0 | 2 | 79 | 1,763,656 | 33.10 | 

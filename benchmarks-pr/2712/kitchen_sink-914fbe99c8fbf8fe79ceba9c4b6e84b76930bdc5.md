...
|:---|---:|---:|---:|
| Total |  2.96 |  2.17 |  2.17 |
| app_proof |  2.14 |  1.35 |  1.35 |
| leaf |  0.44 |  0.44 |  0.44 |
...
| `total_proof_time_ms ` |  1,055 |  2,110 |  1,316 |  794 |
| `execute_metered_time_ms` |  34 | -          | -          | -          |
| `execute_metered_insns` |  2,579,903 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  74.44 | -          |  74.44 |  74.44 |
| `execute_preflight_insns` |  1,289,951.50 |  2,579,903 |  1,540,000 |  1,039,903 |
| `execute_preflight_time_ms` |  99.50 |  199 |  135 |  64 |
| `execute_preflight_insn_mi/s` |  34.49 | -          |  35.54 |  33.44 |
| `trace_gen_time_ms   ` |  26.50 |  53 |  36 |  17 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  815 |  1,630 |  1,030 |  600 |
| `prover.main_trace_commit_time_ms` |  230 |  460 |  306 |  154 |
| `prover.rap_constraints_time_ms` |  520 |  1,040 |  647 |  393 |
| `prover.openings_time_ms` |  64.50 |  129 |  77 |  52 |
| `prover.rap_constraints.logup_gkr_time_ms` |  149.50 |  299 |  164 |  135 |
| `prover.rap_constraints.round0_time_ms` |  263 |  526 |  349 |  177 |
| `prover.rap_constraints.mle_rounds_time_ms` |  106.50 |  213 |  133 |  80 |
| `prover.openings.stacked_reduction_time_ms` |  51.50 |  103 |  64 |  39 |
| `prover.openings.stacked_reduction.round0_time_ms` |  17 |  34 |  18 |  16 |
...
| `prover.main_trace_commit_time_ms` |  137 |  137 |  137 |  137 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/914fbe99c8fbf8fe79ceba9c4b6e84b76930bdc5/kitchen_sink-914fbe99c8fbf8fe79ceba9c4b6e84b76930bdc5.memory.svg)
...
| app_proof |  |  |  |  |  | 794 |  |  | 34 | 2,579,903 | 74.44 | 0 | 2,149 |  | 
...
| internal_recursive.1 | 1 | 8 | 104 | 8 | 1 | 0 | 1 | 0 | 0 | 
| leaf | 0 | 113 | 442 | 112 | 24 | 11 | 20 | 5 | 5 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 53,472,003 | 140 | 42 | 0 | 4 | 64 | 20 | 19 | 29 | 15 | 0 | 32 | 9 | 23 | 1 | 21 | 43 | 64 | 0 | 1 | 14 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 23,651,975 | 102 | 19 | 0 | 3 | 51 | 17 | 16 | 20 | 13 | 0 | 30 | 9 | 21 | 1 | 20 | 20 | 51 | 0 | 1 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 17,507,975 | 95 | 15 | 0 | 3 | 49 | 17 | 16 | 18 | 13 | 0 | 31 | 9 | 21 | 0 | 20 | 15 | 49 | 0 | 1 | 13 | 0 | 0 | 
| leaf | 0 | prover | 428,317,568 | 329 | 137 | 0 | 10 | 147 | 48 | 48 | 37 | 60 | 0 | 44 | 12 | 31 | 7 | 24 | 137 | 147 | 0 | 2 | 59 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 787,664,364 | 1,030 | 305 | 0 | 170 | 647 | 349 | 348 | 133 | 164 | 64 | 77 | 12 | 64 | 18 | 46 | 306 | 647 | 0 | 1 | 99 | 0 | 0 | 
| app_proof | prover | 1 | 700,866,292 | 600 | 154 | 0 | 23 | 393 | 177 | 176 | 80 | 135 | 73 | 52 | 12 | 39 | 16 | 22 | 154 | 393 | 0 | 1 | 61 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 36 | 1,316 | 36 | 185 | 0 | 4 | 64 | 1,540,000 | 33.44 | 
| app_proof | 1 | 17 | 794 | 16 | 40 | 0 | 1 | 135 | 1,039,903 | 35.54 | 

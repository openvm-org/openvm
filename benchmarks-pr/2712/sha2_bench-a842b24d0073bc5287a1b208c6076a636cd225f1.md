...
|:---|---:|---:|---:|
| Total |  11.50 |  3.60 |  3.60 |
| app_proof |  9.24 |  1.87 |  1.87 |
| leaf |  1.43 |  0.91 |  0.91 |
...
| `total_proof_time_ms ` |  1,517.33 |  9,104 |  1,728 |  1,447 |
...
| `execute_preflight_time_ms` |  125.50 |  753 |  157 |  87 |
| `execute_preflight_insn_mi/s` |  40.32 | -          |  41.02 |  38.04 |
| `trace_gen_time_ms   ` |  123.50 |  741 |  166 |  92 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,205.33 |  7,232 |  1,306 |  1,165 |
| `prover.main_trace_commit_time_ms` |  289.83 |  1,739 |  291 |  289 |
| `prover.rap_constraints_time_ms` |  822.33 |  4,934 |  921 |  784 |
| `prover.openings_time_ms` |  92.17 |  553 |  94 |  90 |
| `prover.rap_constraints.logup_gkr_time_ms` |  282.33 |  1,694 |  386 |  261 |
| `prover.rap_constraints.round0_time_ms` |  367.67 |  2,206 |  373 |  358 |
| `prover.rap_constraints.mle_rounds_time_ms` |  171.17 |  1,027 |  173 |  163 |
| `prover.openings.stacked_reduction_time_ms` |  62 |  372 |  63 |  61 |
| `prover.openings.stacked_reduction.round0_time_ms` |  32.17 |  193 |  33 |  32 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  29.17 |  175 |  30 |  29 |
| `prover.openings.whir_time_ms` |  29.83 |  179 |  31 |  28 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  713.50 |  1,427 |  907 |  520 |
| `execute_preflight_time_ms` |  2 |  4 |  2 |  2 |
| `trace_gen_time_ms   ` |  80 |  160 |  108 |  52 |
...
| `prover.rap_constraints_time_ms` |  231.50 |  463 |  292 |  171 |
| `prover.openings_time_ms` |  80.50 |  161 |  91 |  70 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/a842b24d0073bc5287a1b208c6076a636cd225f1/sha2_bench-a842b24d0073bc5287a1b208c6076a636cd225f1.memory.svg)
...
| app_proof |  |  |  |  |  | 1,447 |  |  | 138 | 14,793,960 | 106.83 | 0 | 9,252 |  | 
...
| leaf | 0 | 108 | 907 | 107 | 38 | 14 | 2 | 3 | 3 | 
| leaf | 1 | 52 | 520 | 51 | 19 | 7 | 2 | 3 | 3 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 100,404,864 | 457 | 228 | 0 | 13 | 168 | 46 | 45 | 88 | 33 | 0 | 59 | 21 | 38 | 7 | 30 | 229 | 168 | 0 | 2 | 32 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 25,962,119 | 174 | 51 | 0 | 4 | 76 | 24 | 24 | 29 | 23 | 0 | 45 | 21 | 24 | 2 | 21 | 51 | 76 | 0 | 2 | 22 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 17,507,975 | 143 | 34 | 0 | 4 | 65 | 22 | 22 | 24 | 17 | 0 | 42 | 19 | 22 | 1 | 21 | 35 | 65 | 0 | 2 | 16 | 0 | 0 | 
| leaf | 0 | prover | 341,718,010 | 799 | 415 | 0 | 26 | 292 | 132 | 131 | 80 | 79 | 0 | 91 | 35 | 56 | 22 | 33 | 415 | 292 | 0 | 6 | 78 | 0 | 0 | 
| leaf | 1 | prover | 179,641,792 | 467 | 225 | 0 | 13 | 171 | 73 | 72 | 48 | 49 | 0 | 70 | 32 | 38 | 11 | 26 | 225 | 171 | 0 | 5 | 48 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 630,037,121 | 1,306 | 290 | 0 | 21 | 921 | 361 | 361 | 172 | 386 | 137 | 94 | 30 | 63 | 33 | 30 | 290 | 920 | 0 | 3 | 248 | 0 | 0 | 
| app_proof | prover | 1 | 630,036,532 | 1,192 | 290 | 0 | 19 | 809 | 371 | 370 | 173 | 264 | 0 | 92 | 30 | 62 | 32 | 29 | 291 | 809 | 0 | 3 | 263 | 0 | 0 | 
| app_proof | prover | 2 | 630,036,532 | 1,190 | 289 | 0 | 19 | 807 | 373 | 372 | 173 | 261 | 0 | 92 | 30 | 62 | 32 | 29 | 289 | 807 | 0 | 3 | 259 | 0 | 0 | 
| app_proof | prover | 3 | 630,036,532 | 1,189 | 289 | 0 | 19 | 806 | 371 | 370 | 173 | 261 | 0 | 93 | 31 | 62 | 32 | 29 | 289 | 805 | 0 | 3 | 260 | 0 | 0 | 
| app_proof | prover | 4 | 630,036,532 | 1,190 | 289 | 0 | 19 | 807 | 372 | 372 | 173 | 261 | 0 | 92 | 30 | 61 | 32 | 29 | 290 | 807 | 0 | 3 | 260 | 0 | 0 | 
| app_proof | prover | 5 | 630,124,756 | 1,165 | 290 | 0 | 20 | 784 | 358 | 358 | 163 | 261 | 0 | 90 | 28 | 62 | 32 | 29 | 290 | 784 | 0 | 3 | 260 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 166 | 1,728 | 166 | 168 | 0 | 3 | 87 | 2,623,000 | 38.04 | 
| app_proof | 1 | 92 | 1,484 | 92 | 41 | 0 | 2 | 157 | 2,625,000 | 40.96 | 
| app_proof | 2 | 113 | 1,481 | 113 | 41 | 0 | 2 | 136 | 2,625,000 | 41.02 | 
| app_proof | 3 | 113 | 1,481 | 113 | 41 | 0 | 2 | 138 | 2,625,000 | 40.59 | 
| app_proof | 4 | 113 | 1,483 | 113 | 41 | 0 | 2 | 138 | 2,625,000 | 40.78 | 
| app_proof | 5 | 144 | 1,447 | 144 | 41 | 0 | 2 | 97 | 1,670,960 | 40.55 | 

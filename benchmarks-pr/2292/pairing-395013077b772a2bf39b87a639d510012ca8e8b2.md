...
|:---|---:|---:|
| Total | <span style='color: red'>(+0 [+0.5%])</span> 1.51 | <span style='color: red'>(+0 [+0.2%])</span> 0.89 |
| pairing | <span style='color: red'>(+0 [+0.8%])</span> 1.44 | <span style='color: red'>(+0 [+0.6%])</span> 0.82 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+6 [+0.8%])</span> 721 | <span style='color: red'>(+11 [+0.8%])</span> 1,442 | <span style='color: red'>(+5 [+0.6%])</span> 821 | <span style='color: red'>(+6 [+1.0%])</span> 621 |
| `main_cells_used     ` |  12,704,151 |  25,408,302 |  15,909,408 |  9,498,894 |
| `total_cells_used    ` |  27,472,173 |  54,944,346 |  32,480,114 |  22,464,232 |
| `execute_metered_time_ms` | <span style='color: green'>(-3 [-4.3%])</span> 67 | -          | -          | -          |
| `execute_metered_insn_mi/s` | <span style='color: red'>(+1 [+3.7%])</span> 25.84 | -          | <span style='color: red'>(+1 [+3.7%])</span> 25.84 | <span style='color: red'>(+1 [+3.7%])</span> 25.84 |
...
| `execute_preflight_insn_mi/s` | <span style='color: green'>(-0 [-1.0%])</span> 14.65 | -          | <span style='color: green'>(-0 [-1.0%])</span> 18.40 | <span style='color: green'>(-0 [-0.8%])</span> 10.90 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+0 [+0.3%])</span> 186 | <span style='color: red'>(+1 [+0.3%])</span> 372 | <span style='color: green'>(-1 [-0.5%])</span> 191 | <span style='color: red'>(+2 [+1.1%])</span> 181 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+2 [+0.6%])</span> 356.50 | <span style='color: red'>(+4 [+0.6%])</span> 713 | <span style='color: red'>(+1 [+0.3%])</span> 387 | <span style='color: red'>(+3 [+0.9%])</span> 326 |
| `main_trace_commit_time_ms` |  64 |  128 | <span style='color: red'>(+1 [+1.4%])</span> 75 | <span style='color: green'>(-1 [-1.9%])</span> 53 |
| `generate_perm_trace_time_ms` | <span style='color: green'>(-6 [-14.5%])</span> 32.50 | <span style='color: green'>(-11 [-14.5%])</span> 65 | <span style='color: green'>(-4 [-10.0%])</span> 36 | <span style='color: green'>(-7 [-19.4%])</span> 29 |
| `perm_trace_commit_time_ms` | <span style='color: red'>(+1 [+1.3%])</span> 76.90 | <span style='color: red'>(+2 [+1.3%])</span> 153.80 | <span style='color: red'>(+1 [+1.0%])</span> 88.83 | <span style='color: red'>(+1 [+1.7%])</span> 64.97 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+5 [+6.5%])</span> 82.91 | <span style='color: red'>(+10 [+6.5%])</span> 165.83 | <span style='color: red'>(+6 [+7.0%])</span> 92.15 | <span style='color: red'>(+4 [+6.0%])</span> 73.68 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+2 [+10.2%])</span> 17.41 | <span style='color: red'>(+3 [+10.2%])</span> 34.81 | <span style='color: red'>(+3 [+15.7%])</span> 19.92 | <span style='color: red'>(+1 [+3.7%])</span> 14.89 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+0 [+0.6%])</span> 77.50 | <span style='color: red'>(+1 [+0.6%])</span> 155 | <span style='color: red'>(+6 [+7.6%])</span> 85 | <span style='color: green'>(-5 [-6.7%])</span> 70 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 621 | 1 | 67 | 1,745,742 | 25.84 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 181 | 821 | 32,480,114 | 172,558,444 | 181 | 387 | 0 | 92.15 | 19.92 | 6 | 88.83 | 70 | 127 | 70 | 1 | 75 | 15,909,408 | 36 | 109 | 1,149,000 | 10.90 | 27 | 112 | 1 | 70 | 
| pairing | 1 | 191 | 621 | 22,464,232 | 119,958,502 | 191 | 326 | 1 | 73.68 | 14.89 | 5 | 64.97 | 85 | 97 | 85 | 0 | 53 | 9,498,894 | 29 | 62 | 596,742 | 18.40 | 20 | 89 | 1 | 85 | 

...
| `total_proof_time_ms ` |  2,632.50 |  15,795 |  2,998 |  2,540 |
| `execute_metered_time_ms` |  36 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  33.72 | -          |  33.72 |  33.72 |
| `execute_preflight_insns` |  205,869.67 |  1,235,218 |  207,000 |  200,218 |
| `execute_preflight_time_ms` |  177 |  1,062 |  262 |  15 |
| `execute_preflight_insn_mi/s` |  19.19 | -          |  19.31 |  18.90 |
| `trace_gen_time_ms   ` |  391.33 |  2,348 |  546 |  351 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  2,000.33 |  12,002 |  2,265 |  1,939 |
| `prover.main_trace_commit_time_ms` |  693.67 |  4,162 |  849 |  661 |
| `prover.rap_constraints_time_ms` |  1,120.33 |  6,722 |  1,230 |  1,093 |
| `prover.openings_time_ms` |  185.17 |  1,111 |  191 |  180 |
| `prover.rap_constraints.logup_gkr_time_ms` |  276 |  1,656 |  384 |  254 |
| `prover.rap_constraints.round0_time_ms` |  525.17 |  3,151 |  529 |  522 |
| `prover.rap_constraints.mle_rounds_time_ms` |  318 |  1,908 |  323 |  316 |
| `prover.openings.stacked_reduction_time_ms` |  142.17 |  853 |  145 |  140 |
| `prover.openings.stacked_reduction.round0_time_ms` |  86.67 |  520 |  88 |  85 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  55.17 |  331 |  56 |  54 |
| `prover.openings.whir_time_ms` |  42.50 |  255 |  48 |  39 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,110.50 |  2,221 |  1,442 |  779 |
| `execute_preflight_time_ms` |  4.50 |  9 |  5 |  4 |
| `trace_gen_time_ms   ` |  137.50 |  275 |  186 |  89 |
| `generate_blob_total_time_ms` |  25.50 |  51 |  34 |  17 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  972.50 |  1,945 |  1,256 |  689 |
| `prover.main_trace_commit_time_ms` |  550 |  1,100 |  721 |  379 |
| `prover.rap_constraints_time_ms` |  314 |  628 |  405 |  223 |
| `prover.openings_time_ms` |  107 |  214 |  128 |  86 |
| `prover.rap_constraints.logup_gkr_time_ms` |  66 |  132 |  82 |  50 |
| `prover.rap_constraints.round0_time_ms` |  151.50 |  303 |  199 |  104 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/be59cd83e60b4825a773e610435fff180fcc510b/keccak-be59cd83e60b4825a773e610435fff180fcc510b.memory.svg)
...
| app_proof |  |  |  |  |  | 2,558 |  |  | 36 | 1,235,218 | 33.72 | 0 | 15,838 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 38 | 521 | 38 | 13 | 4 | 2 | 2 | 2 | 
| internal_recursive.0 | 1 | 12 | 180 | 12 | 2 | 1 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 9 | 148 | 8 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 186 | 1,442 | 185 | 65 | 34 | 5 | 8 | 8 | 
| leaf | 1 | 89 | 779 | 89 | 32 | 17 | 4 | 7 | 7 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 109,497,984 | 483 | 249 | 0 | 14 | 173 | 46 | 45 | 94 | 33 | 0 | 58 | 20 | 38 | 7 | 30 | 250 | 173 | 0 | 3 | 32 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 25,962,119 | 168 | 51 | 0 | 3 | 75 | 23 | 23 | 29 | 22 | 0 | 41 | 17 | 24 | 2 | 21 | 51 | 75 | 0 | 2 | 21 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 17,507,975 | 139 | 34 | 0 | 4 | 63 | 21 | 21 | 24 | 17 | 0 | 41 | 18 | 22 | 1 | 21 | 34 | 63 | 0 | 2 | 17 | 0 | 0 | 
| leaf | 0 | prover | 583,523,386 | 1,256 | 721 | 0 | 47 | 405 | 199 | 198 | 123 | 82 | 0 | 128 | 42 | 85 | 40 | 45 | 721 | 405 | 0 | 6 | 81 | 0 | 0 | 
| leaf | 1 | prover | 300,618,208 | 689 | 378 | 0 | 24 | 223 | 104 | 103 | 67 | 50 | 0 | 86 | 33 | 52 | 20 | 32 | 379 | 223 | 0 | 6 | 50 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,205,061,845 | 2,265 | 849 | 0 | 240 | 1,230 | 522 | 522 | 323 | 384 | 128 | 185 | 41 | 143 | 87 | 56 | 849 | 1,230 | 0 | 3 | 255 | 0 | 0 | 
| app_proof | prover | 1 | 1,205,053,652 | 1,948 | 662 | 0 | 51 | 1,093 | 522 | 522 | 316 | 254 | 0 | 191 | 48 | 142 | 87 | 55 | 662 | 1,093 | 0 | 3 | 253 | 0 | 0 | 
| app_proof | prover | 2 | 1,205,053,652 | 1,939 | 661 | 0 | 51 | 1,096 | 524 | 524 | 316 | 254 | 0 | 181 | 40 | 141 | 86 | 55 | 661 | 1,096 | 0 | 4 | 253 | 0 | 0 | 
| app_proof | prover | 3 | 1,205,053,652 | 1,953 | 664 | 0 | 51 | 1,100 | 528 | 527 | 318 | 254 | 0 | 187 | 45 | 142 | 87 | 54 | 664 | 1,100 | 0 | 3 | 253 | 0 | 0 | 
| app_proof | prover | 4 | 1,205,053,652 | 1,941 | 661 | 0 | 51 | 1,100 | 526 | 526 | 317 | 255 | 0 | 180 | 39 | 140 | 85 | 55 | 661 | 1,100 | 0 | 3 | 254 | 0 | 0 | 
| app_proof | prover | 5 | 1,205,062,652 | 1,956 | 664 | 0 | 52 | 1,103 | 529 | 529 | 318 | 255 | 0 | 187 | 42 | 145 | 88 | 56 | 665 | 1,103 | 0 | 3 | 254 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 546 | 2,998 | 546 | 170 | 0 | 194 | 15 | 207,000 | 18.90 | 
| app_proof | 1 | 351 | 2,603 | 351 | 40 | 0 | 1 | 262 | 207,000 | 19.11 | 
| app_proof | 2 | 354 | 2,540 | 354 | 40 | 0 | 4 | 204 | 207,000 | 19.25 | 
| app_proof | 3 | 357 | 2,553 | 357 | 40 | 0 | 8 | 202 | 207,000 | 19.31 | 
| app_proof | 4 | 354 | 2,543 | 354 | 40 | 0 | 5 | 205 | 207,000 | 19.28 | 
| app_proof | 5 | 386 | 2,558 | 386 | 40 | 0 | 37 | 174 | 200,218 | 19.31 | 

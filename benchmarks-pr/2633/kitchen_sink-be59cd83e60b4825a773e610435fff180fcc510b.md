...
|:---|---:|---:|---:|
| Total |  3.21 |  2.24 |  2.24 |
| app_proof |  2.40 |  1.44 |  1.44 |
| leaf |  0.42 |  0.42 |  0.42 |
...
| `total_proof_time_ms ` |  1,198.50 |  2,397 |  1,429 |  968 |
| `execute_metered_time_ms` |  7 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  20.24 | -          |  20.24 |  20.24 |
| `execute_preflight_insns` |  77,381.50 |  154,763 |  121,000 |  33,763 |
| `execute_preflight_time_ms` |  75 |  150 |  129 |  21 |
| `execute_preflight_insn_mi/s` |  8.34 | -          |  10.93 |  5.75 |
| `trace_gen_time_ms   ` |  158.50 |  317 |  188 |  129 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  850 |  1,700 |  1,032 |  668 |
| `prover.main_trace_commit_time_ms` |  221 |  442 |  293 |  149 |
| `prover.rap_constraints_time_ms` |  565.50 |  1,131 |  664 |  467 |
| `prover.openings_time_ms` |  62 |  124 |  74 |  50 |
| `prover.rap_constraints.logup_gkr_time_ms` |  142.50 |  285 |  156 |  129 |
| `prover.rap_constraints.round0_time_ms` |  287.50 |  575 |  366 |  209 |
| `prover.rap_constraints.mle_rounds_time_ms` |  134.50 |  269 |  141 |  128 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  422 |  422 |  422 |  422 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/be59cd83e60b4825a773e610435fff180fcc510b/kitchen_sink-be59cd83e60b4825a773e610435fff180fcc510b.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 68 | 3 |  |  | 0 |  | 330 | 3 |  |  |  |  |  |  | 
| app_proof |  |  |  |  |  | 968 |  |  | 7 | 154,763 | 20.24 | 0 | 2,410 |  | 
...
| internal_recursive.0 | 1 | 11 | 114 | 10 | 1 | 0 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 10 | 104 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 112 | 422 | 112 | 27 | 11 | 18 | 5 | 5 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 53,472,003 | 142 | 40 | 0 | 4 | 66 | 20 | 19 | 30 | 15 | 0 | 34 | 10 | 23 | 1 | 21 | 41 | 66 | 0 | 1 | 15 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 23,651,975 | 103 | 19 | 0 | 4 | 51 | 17 | 16 | 20 | 13 | 0 | 32 | 10 | 21 | 1 | 20 | 19 | 51 | 0 | 1 | 12 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 17,507,975 | 94 | 14 | 0 | 4 | 49 | 17 | 16 | 18 | 13 | 0 | 29 | 8 | 21 | 0 | 20 | 15 | 49 | 0 | 1 | 12 | 0 | 0 | 
| leaf | 0 | prover | 407,935,872 | 309 | 123 | 0 | 9 | 141 | 45 | 44 | 36 | 59 | 0 | 43 | 12 | 31 | 7 | 24 | 124 | 141 | 0 | 2 | 58 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 816,542,084 | 1,032 | 293 | 1 | 164 | 664 | 366 | 364 | 141 | 156 | 63 | 74 | 13 | 60 | 16 | 44 | 293 | 664 | 0 | 1 | 91 | 0 | 0 | 
| app_proof | prover | 1 | 800,298,548 | 668 | 149 | 0 | 20 | 467 | 209 | 208 | 128 | 129 | 75 | 50 | 13 | 37 | 14 | 22 | 149 | 467 | 0 | 1 | 53 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 188 | 1,429 | 188 | 187 | 0 | 49 | 21 | 121,000 | 10.93 | 
| app_proof | 1 | 129 | 968 | 129 | 40 | 0 | 3 | 129 | 33,763 | 5.75 | 

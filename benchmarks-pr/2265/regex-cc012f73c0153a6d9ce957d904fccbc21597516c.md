...
|:---|---:|---:|
| Total | <span style='color: red'>(+0 [+0.7%])</span> 2.41 | <span style='color: red'>(+0 [+0.1%])</span> 0.78 |
| regex_program | <span style='color: red'>(+0 [+0.7%])</span> 2.38 | <span style='color: red'>(+0 [+0.1%])</span> 0.75 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+4 [+0.7%])</span> 593.75 | <span style='color: red'>(+16 [+0.7%])</span> 2,375 | <span style='color: red'>(+1 [+0.1%])</span> 746 | <span style='color: red'>(+1 [+0.2%])</span> 538 |
...
| `execute_metered_insn_mi/s` | <span style='color: green'>(-1 [-0.7%])</span> 113.26 | -          | <span style='color: green'>(-1 [-0.7%])</span> 113.26 | <span style='color: green'>(-1 [-0.7%])</span> 113.26 |
...
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+0 [+1.5%])</span> 31.14 | -          | <span style='color: red'>(+0 [+1.4%])</span> 32.35 | <span style='color: red'>(+1 [+2.0%])</span> 28.19 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+2 [+1.4%])</span> 180 | <span style='color: red'>(+10 [+1.4%])</span> 720 | <span style='color: red'>(+4 [+1.9%])</span> 215 | <span style='color: red'>(+3 [+2.0%])</span> 156 |
| `memory_finalize_time_ms` |  1 |  4 |  4 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+1 [+0.4%])</span> 292.25 | <span style='color: red'>(+5 [+0.4%])</span> 1,169 | <span style='color: green'>(-1 [-0.3%])</span> 341 | <span style='color: red'>(+1 [+0.4%])</span> 271 |
| `main_trace_commit_time_ms` | <span style='color: red'>(+0 [+0.5%])</span> 52 | <span style='color: red'>(+1 [+0.5%])</span> 208 | <span style='color: green'>(-1 [-1.8%])</span> 56 |  50 |
...
| `perm_trace_commit_time_ms` | <span style='color: green'>(-0 [-0.3%])</span> 64.27 | <span style='color: green'>(-1 [-0.3%])</span> 257.06 | <span style='color: green'>(-1 [-0.9%])</span> 70.25 | <span style='color: red'>(+1 [+1.1%])</span> 56.41 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+0 [+0.8%])</span> 58.89 | <span style='color: red'>(+2 [+0.8%])</span> 235.56 |  69.67 | <span style='color: green'>(-0 [-0.6%])</span> 52.62 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+0 [+1.8%])</span> 14.93 | <span style='color: red'>(+1 [+1.8%])</span> 59.71 | <span style='color: red'>(+1 [+7.9%])</span> 18.04 | <span style='color: red'>(+0 [+0.1%])</span> 12.87 |
| `pcs_opening_time_ms ` | <span style='color: green'>(-0 [-0.8%])</span> 64.50 | <span style='color: green'>(-2 [-0.8%])</span> 258 | <span style='color: green'>(-4 [-4.9%])</span> 78 | <span style='color: red'>(+1 [+1.8%])</span> 57 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 543 | 1 | 36 | 4,137,502 | 113.26 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 215 | 746 | 23,446,148 | 150,778,428 | 215 | 341 | 0 | 60.61 | 18.04 | 5 | 70.25 | 78 | 126 | 78 | 4 | 56 | 10,899,170 | 55 | 45 | 1,103,000 | 28.19 | 21 | 79 | 1 | 78 | 
| regex_program | 1 | 156 | 548 | 11,598,276 | 128,513,066 | 156 | 284 | 1 | 52.62 | 14.40 | 5 | 65.17 | 62 | 104 | 62 | 0 | 50 | 2,196,106 | 38 | 66 | 1,104,000 | 32.31 | 16 | 67 | 0 | 62 | 
| regex_program | 2 | 165 | 538 | 11,579,064 | 128,513,066 | 165 | 273 | 1 | 52.66 | 14.39 | 4 | 65.23 | 61 | 92 | 61 | 0 | 51 | 2,177,334 | 27 | 58 | 1,104,000 | 32.35 | 16 | 67 | 0 | 61 | 
| regex_program | 3 | 184 | 543 | 11,853,872 | 103,456,394 | 184 | 271 | 0 | 69.67 | 12.87 | 5 | 56.41 | 57 | 78 | 57 | 0 | 51 | 2,422,606 | 19 | 46 | 826,502 | 31.69 | 19 | 83 | 1 | 57 | 

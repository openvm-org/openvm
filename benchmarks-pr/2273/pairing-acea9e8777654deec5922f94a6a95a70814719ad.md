...
|:---|---:|---:|
| Total | <span style='color: green'>(-0 [-0.5%])</span> 1.48 | <span style='color: green'>(-0 [-0.2%])</span> 0.89 |
| pairing | <span style='color: green'>(-0 [-0.5%])</span> 1.42 | <span style='color: green'>(-0 [-0.1%])</span> 0.83 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: green'>(-4 [-0.5%])</span> 707.50 | <span style='color: green'>(-7 [-0.5%])</span> 1,415 | <span style='color: green'>(-1 [-0.1%])</span> 826 | <span style='color: green'>(-6 [-1.0%])</span> 589 |
...
| `execute_metered_insn_mi/s` | <span style='color: red'>(+0 [+0.8%])</span> 25.84 | -          | <span style='color: red'>(+0 [+0.8%])</span> 25.84 | <span style='color: red'>(+0 [+0.8%])</span> 25.84 |
| `execute_preflight_insns` |  872,871 |  1,745,742 |  1,157,000 |  588,742 |
| `execute_preflight_time_ms` | <span style='color: green'>(-1 [-1.2%])</span> 83.50 | <span style='color: green'>(-2 [-1.2%])</span> 167 | <span style='color: green'>(-2 [-1.8%])</span> 108 |  59 |
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+0 [+0.6%])</span> 14.81 | -          |  18.55 | <span style='color: red'>(+0 [+1.4%])</span> 11.07 |
| `trace_gen_time_ms   ` |  187.50 |  375 | <span style='color: red'>(+1 [+0.5%])</span> 194 | <span style='color: green'>(-1 [-0.5%])</span> 181 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  343.50 |  687 | <span style='color: red'>(+5 [+1.3%])</span> 393 | <span style='color: green'>(-5 [-1.7%])</span> 294 |
...
| `generate_perm_trace_time_ms` | <span style='color: green'>(-2 [-3.9%])</span> 36.50 | <span style='color: green'>(-3 [-3.9%])</span> 73 |  41 | <span style='color: green'>(-3 [-8.6%])</span> 32 |
| `perm_trace_commit_time_ms` | <span style='color: red'>(+3 [+3.4%])</span> 76.68 | <span style='color: red'>(+5 [+3.4%])</span> 153.35 | <span style='color: red'>(+5 [+5.8%])</span> 88.27 | <span style='color: red'>(+0 [+0.3%])</span> 65.08 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+0 [+0.6%])</span> 78.54 | <span style='color: red'>(+1 [+0.6%])</span> 157.09 | <span style='color: red'>(+2 [+2.0%])</span> 87.26 | <span style='color: green'>(-1 [-1.1%])</span> 69.83 |
| `quotient_poly_commit_time_ms` | <span style='color: green'>(-1 [-4.9%])</span> 16.08 | <span style='color: green'>(-2 [-4.9%])</span> 32.16 | <span style='color: green'>(-1 [-6.6%])</span> 17.82 | <span style='color: green'>(-0 [-2.6%])</span> 14.34 |
| `pcs_opening_time_ms ` | <span style='color: green'>(-0 [-0.8%])</span> 66 | <span style='color: green'>(-1 [-0.8%])</span> 132 | <span style='color: green'>(-1 [-1.2%])</span> 79 |  53 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 589 | 1 | 67 | 1,745,742 | 25.84 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 181 | 826 | 32,689,110 | 172,558,444 | 181 | 393 | 0 | 87.26 | 17.82 | 6 | 88.27 | 79 | 132 | 79 | 1 | 75 | 16,059,916 | 41 | 108 | 1,157,000 | 11.07 | 26 | 105 | 1 | 79 | 
| pairing | 1 | 194 | 589 | 22,314,288 | 119,958,502 | 194 | 294 | 1 | 69.83 | 14.34 | 6 | 65.08 | 53 | 100 | 53 | 0 | 55 | 9,408,294 | 32 | 59 | 588,742 | 18.55 | 20 | 84 | 1 | 53 | 

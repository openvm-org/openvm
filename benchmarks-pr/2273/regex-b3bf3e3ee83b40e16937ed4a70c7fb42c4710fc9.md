...
|:---|---:|---:|
| Total | <span style='color: green'>(-0 [-2.2%])</span> 2.34 | <span style='color: green'>(-0 [-6.0%])</span> 0.73 |
| regex_program | <span style='color: green'>(-0 [-2.2%])</span> 2.31 | <span style='color: green'>(-0 [-6.5%])</span> 0.70 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: green'>(-13 [-2.2%])</span> 576.50 | <span style='color: green'>(-53 [-2.2%])</span> 2,306 | <span style='color: green'>(-48 [-6.5%])</span> 695 | <span style='color: green'>(-3 [-0.6%])</span> 524 |
...
| `execute_metered_insn_mi/s` | <span style='color: green'>(-5 [-4.5%])</span> 106.55 | -          | <span style='color: green'>(-5 [-4.5%])</span> 106.55 | <span style='color: green'>(-5 [-4.5%])</span> 106.55 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` | <span style='color: green'>(-4 [-7.0%])</span> 53.25 | <span style='color: green'>(-16 [-7.0%])</span> 213 | <span style='color: green'>(-6 [-8.5%])</span> 65 | <span style='color: green'>(-3 [-6.4%])</span> 44 |
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+0 [+0.7%])</span> 31.37 | -          | <span style='color: green'>(-0 [-0.3%])</span> 32.43 | <span style='color: red'>(+1 [+3.1%])</span> 28.57 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+2 [+1.1%])</span> 178 | <span style='color: red'>(+8 [+1.1%])</span> 712 |  212 | <span style='color: red'>(+6 [+4.0%])</span> 156 |
...
| `stark_prove_excluding_trace_time_ms` | <span style='color: green'>(-11 [-3.9%])</span> 277.50 | <span style='color: green'>(-45 [-3.9%])</span> 1,110 | <span style='color: green'>(-45 [-13.3%])</span> 293 |  263 |
| `main_trace_commit_time_ms` | <span style='color: green'>(-1 [-1.4%])</span> 51.25 | <span style='color: green'>(-3 [-1.4%])</span> 205 | <span style='color: green'>(-1 [-1.8%])</span> 56 | <span style='color: green'>(-1 [-2.0%])</span> 49 |
| `generate_perm_trace_time_ms` | <span style='color: green'>(-6 [-17.6%])</span> 28 | <span style='color: green'>(-24 [-17.6%])</span> 112 | <span style='color: green'>(-16 [-29.6%])</span> 38 |  19 |
| `perm_trace_commit_time_ms` | <span style='color: red'>(+0 [+0.4%])</span> 64.54 | <span style='color: red'>(+1 [+0.4%])</span> 258.15 | <span style='color: green'>(-1 [-1.5%])</span> 70.31 | <span style='color: green'>(-0 [-0.2%])</span> 55.85 |
| `quotient_poly_compute_time_ms` | <span style='color: green'>(-0 [-0.8%])</span> 58.31 | <span style='color: green'>(-2 [-0.8%])</span> 233.23 | <span style='color: green'>(-2 [-2.2%])</span> 68.97 |  52.70 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+0 [+2.6%])</span> 15.19 | <span style='color: red'>(+2 [+2.6%])</span> 60.77 | <span style='color: red'>(+1 [+6.6%])</span> 17.68 | <span style='color: green'>(-0 [-0.5%])</span> 12.80 |
| `pcs_opening_time_ms ` | <span style='color: green'>(-4 [-6.5%])</span> 57.25 | <span style='color: green'>(-16 [-6.5%])</span> 229 | <span style='color: green'>(-15 [-19.5%])</span> 62 |  50 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 539 | 1 | 38 | 4,137,502 | 106.55 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 212 | 695 | 23,446,148 | 150,778,428 | 212 | 293 | 0 | 58.60 | 17.68 | 5 | 70.31 | 60 | 100 | 59 | 4 | 56 | 10,899,170 | 28 | 46 | 1,103,000 | 28.57 | 21 | 77 | 1 | 59 | 
| regex_program | 1 | 156 | 548 | 11,598,276 | 128,513,066 | 156 | 285 | 1 | 52.95 | 14.77 | 4 | 65.35 | 62 | 103 | 62 | 0 | 50 | 2,196,106 | 38 | 65 | 1,104,000 | 32.43 | 16 | 68 | 0 | 62 | 
| regex_program | 2 | 161 | 524 | 11,579,064 | 128,513,066 | 161 | 263 | 1 | 52.70 | 15.53 | 4 | 66.64 | 50 | 94 | 50 | 0 | 49 | 2,177,334 | 27 | 58 | 1,104,000 | 32.03 | 16 | 68 | 0 | 50 | 
| regex_program | 3 | 183 | 539 | 11,853,872 | 103,456,394 | 183 | 269 | 0 | 68.97 | 12.80 | 5 | 55.85 | 57 | 78 | 57 | 0 | 50 | 2,422,606 | 19 | 44 | 826,502 | 32.43 | 18 | 82 | 1 | 57 | 

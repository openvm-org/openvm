...
|:---|---:|---:|
| Total | <span style='color: red'>(+0 [+0.5%])</span> 0.98 | <span style='color: red'>(+0 [+0.4%])</span> 0.56 |
| fibonacci_program | <span style='color: red'>(+0 [+0.4%])</span> 0.97 | <span style='color: red'>(+0 [+0.2%])</span> 0.55 |


| fibonacci_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+2 [+0.4%])</span> 485 | <span style='color: red'>(+4 [+0.4%])</span> 970 | <span style='color: red'>(+1 [+0.2%])</span> 549 | <span style='color: red'>(+3 [+0.7%])</span> 421 |
...
| `execute_metered_insn_mi/s` | <span style='color: green'>(-12 [-10.5%])</span> 102.84 | -          | <span style='color: green'>(-12 [-10.5%])</span> 102.84 | <span style='color: green'>(-12 [-10.5%])</span> 102.84 |
...
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+0 [+0.8%])</span> 36.98 | -          | <span style='color: red'>(+0 [+0.8%])</span> 39.02 | <span style='color: red'>(+0 [+0.8%])</span> 34.94 |
...
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+1 [+0.6%])</span> 173 | <span style='color: red'>(+2 [+0.6%])</span> 346 |  184 | <span style='color: red'>(+2 [+1.2%])</span> 162 |
...
| `perm_trace_commit_time_ms` | <span style='color: green'>(-1 [-2.6%])</span> 41.03 | <span style='color: green'>(-2 [-2.6%])</span> 82.06 | <span style='color: green'>(-0 [-0.3%])</span> 44.27 | <span style='color: green'>(-2 [-5.2%])</span> 37.78 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+1 [+4.3%])</span> 31.13 | <span style='color: red'>(+3 [+4.3%])</span> 62.25 | <span style='color: red'>(+2 [+5.9%])</span> 32.10 | <span style='color: red'>(+1 [+2.6%])</span> 30.15 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+1 [+9.2%])</span> 12.38 | <span style='color: red'>(+2 [+9.2%])</span> 24.75 | <span style='color: red'>(+1 [+12.4%])</span> 12.77 | <span style='color: red'>(+1 [+6.0%])</span> 11.98 |
...
| --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 421 | 1 | 14 | 1,500,209 | 102.84 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 195 | 549 | 9,677,708 | 84,395,212 | 195 | 184 | 0 | 32.10 | 12.77 | 4 | 44.27 | 44 | 61 | 44 | 0 | 33 | 1,035,986 | 16 | 25 | 873,000 | 34.94 | 14 | 45 | 0 | 44 | 
| fibonacci_program | 1 | 185 | 421 | 9,708,170 | 74,305,770 | 185 | 162 | 1 | 30.15 | 11.98 | 4 | 37.78 | 41 | 50 | 41 | 0 | 28 | 1,064,416 | 11 | 33 | 627,209 | 39.02 | 11 | 42 | 0 | 41 | 

...
|:---|---:|---:|
| Total | <span style='color: red'>(+0 [+2.0%])</span> 1.50 | <span style='color: red'>(+0 [+2.0%])</span> 0.90 |
| pairing | <span style='color: red'>(+0 [+2.1%])</span> 1.43 | <span style='color: red'>(+0 [+2.2%])</span> 0.84 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+15 [+2.1%])</span> 716.50 | <span style='color: red'>(+30 [+2.1%])</span> 1,433 | <span style='color: red'>(+18 [+2.2%])</span> 835 | <span style='color: red'>(+12 [+2.0%])</span> 598 |
...
| `execute_metered_insn_mi/s` | <span style='color: red'>(+0 [+0.4%])</span> 27.42 | -          | <span style='color: red'>(+0 [+0.4%])</span> 27.42 | <span style='color: red'>(+0 [+0.4%])</span> 27.42 |
| `execute_preflight_insns` |  872,871 |  1,745,742 |  1,157,000 |  588,742 |
| `execute_preflight_time_ms` | <span style='color: green'>(-0 [-0.6%])</span> 83 | <span style='color: green'>(-1 [-0.6%])</span> 166 | <span style='color: red'>(+1 [+0.9%])</span> 107 | <span style='color: green'>(-2 [-3.3%])</span> 59 |
| `execute_preflight_insn_mi/s` | <span style='color: green'>(-0 [-1.4%])</span> 14.60 | -          | <span style='color: green'>(-0 [-1.6%])</span> 17.99 | <span style='color: green'>(-0 [-1.0%])</span> 11.20 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+3 [+1.6%])</span> 190 | <span style='color: red'>(+6 [+1.6%])</span> 380 | <span style='color: red'>(+5 [+2.6%])</span> 196 | <span style='color: red'>(+1 [+0.5%])</span> 184 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+13 [+3.9%])</span> 350.50 | <span style='color: red'>(+26 [+3.9%])</span> 701 | <span style='color: red'>(+16 [+4.2%])</span> 400 | <span style='color: red'>(+10 [+3.4%])</span> 301 |
| `main_trace_commit_time_ms` | <span style='color: red'>(+2 [+3.1%])</span> 66 | <span style='color: red'>(+4 [+3.1%])</span> 132 | <span style='color: red'>(+1 [+1.3%])</span> 76 | <span style='color: red'>(+3 [+5.7%])</span> 56 |
| `generate_perm_trace_time_ms` | <span style='color: red'>(+0 [+1.4%])</span> 37.50 | <span style='color: red'>(+1 [+1.4%])</span> 75 | <span style='color: red'>(+1 [+2.4%])</span> 42 |  33 |
| `perm_trace_commit_time_ms` | <span style='color: red'>(+4 [+4.8%])</span> 78.02 | <span style='color: red'>(+7 [+4.8%])</span> 156.04 | <span style='color: red'>(+6 [+6.7%])</span> 90.07 | <span style='color: red'>(+1 [+2.3%])</span> 65.98 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+4 [+5.2%])</span> 81.31 | <span style='color: red'>(+8 [+5.2%])</span> 162.61 | <span style='color: red'>(+4 [+4.4%])</span> 88 | <span style='color: red'>(+4 [+6.1%])</span> 74.61 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+1 [+4.4%])</span> 16.86 | <span style='color: red'>(+1 [+4.4%])</span> 33.72 | <span style='color: red'>(+1 [+4.4%])</span> 19.11 | <span style='color: red'>(+1 [+4.4%])</span> 14.62 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+2 [+3.9%])</span> 66.50 | <span style='color: red'>(+5 [+3.9%])</span> 133 | <span style='color: red'>(+4 [+5.3%])</span> 80 | <span style='color: red'>(+1 [+1.9%])</span> 53 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 598 | 1 | 63 | 1,745,742 | 27.42 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 184 | 835 | 32,689,110 | 172,558,444 | 184 | 400 | 0 | 88 | 19.11 | 6 | 90.07 | 80 | 135 | 80 | 1 | 76 | 16,059,916 | 42 | 107 | 1,157,000 | 11.20 | 26 | 107 | 1 | 80 | 
| pairing | 1 | 196 | 598 | 22,314,288 | 119,958,502 | 196 | 301 | 1 | 74.61 | 14.62 | 6 | 65.98 | 53 | 102 | 53 | 0 | 56 | 9,408,294 | 33 | 59 | 588,742 | 17.99 | 20 | 89 | 1 | 53 | 
...
Commit: https://github.com/openvm-org/openvm/commit/b3bf3e3ee83b40e16937ed4a70c7fb42c4710fc9
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19558130529)

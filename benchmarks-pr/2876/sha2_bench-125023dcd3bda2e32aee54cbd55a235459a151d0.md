...
|:---|---:|---:|---:|
| Total |  13.31 |  5.59 |  5.59 |
| app_proof |  10.53 |  2.81 |  2.81 |
| leaf |  1.95 |  1.95 |  1.95 |
...
| `total_proof_time_ms ` |  2,607 |  10,428 |  2,713 |  2,554 |
| `compile_metered_time_ms` |  3 |  3 |  3 |  3 |
| `execute_metered_time_ms` |  100 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  110.58 | -          |  110.58 |  110.58 |
| `execute_preflight_insns` |  2,791,990.25 |  11,167,961 |  2,851,000 |  2,614,961 |
| `execute_preflight_time_ms` |  161.50 |  646 |  203 |  98 |
| `execute_preflight_insn_mi/s` |  35.19 | -          |  36.08 |  32.72 |
| `trace_gen_time_ms   ` |  58.75 |  235 |  67 |  54 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  2,321 |  9,284 |  2,411 |  2,290 |
| `prover.main_trace_commit_time_ms` |  616.25 |  2,465 |  619 |  614 |
| `prover.rap_constraints_time_ms` |  1,230.25 |  4,921 |  1,236 |  1,226 |
| `prover.openings_time_ms` |  473.50 |  1,894 |  563 |  441 |
| `prover.rap_constraints.logup_gkr_time_ms` |  309.75 |  1,239 |  311 |  309 |
| `prover.rap_constraints.round0_time_ms` |  673.25 |  2,693 |  676 |  668 |
| `prover.rap_constraints.mle_rounds_time_ms` |  246.25 |  985 |  250 |  242 |
...
| `prover.openings.whir_time_ms` |  374.75 |  1,499 |  464 |  343 |
...
| `prover.openings.whir_time_ms` |  130 |  130 |  130 |  130 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/125023dcd3bda2e32aee54cbd55a235459a151d0/sha2_bench-125023dcd3bda2e32aee54cbd55a235459a151d0.memory.svg)
...
| app_proof |  |  |  |  |  | 2,554 |  |  | 100 | 11,167,961 | 110.58 | 0 | 10,536 |  | 
| internal_for_leaf |  |  |  | 493 |  |  |  |  |  |  |  |  |  | 493 | 
| internal_recursive.0 |  |  |  | 190 |  |  |  |  |  |  |  |  |  | 191 | 
...
| internal_recursive.0 | 1 | 13 | 190 | 12 | 1 | 0 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 9 | 146 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 143 | 1,948 | 143 | 50 | 22 | 2 | 6 | 6 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 61,220,667 | 466 | 185 | 0 | 0 | 130 | 37 | 37 | 64 | 28 | 0 | 149 | 130 | 18 | 5 | 12 | 185 | 130 | 0 | 4 | 26 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,943 | 177 | 49 | 0 | 0 | 72 | 25 | 24 | 29 | 17 | 0 | 55 | 46 | 8 | 2 | 6 | 49 | 72 | 0 | 2 | 17 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 136 | 31 | 0 | 0 | 62 | 23 | 23 | 24 | 14 | 0 | 42 | 35 | 7 | 1 | 5 | 31 | 62 | 0 | 2 | 13 | 0 | 0 | 
| leaf | 0 | prover | 425,192,422 | 1,804 | 811 | 0 | 89 | 354 | 170 | 169 | 107 | 76 | 0 | 638 | 573 | 64 | 36 | 28 | 812 | 354 | 0 | 9 | 75 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 640,057,593 | 2,411 | 619 | 0 | 71 | 1,227 | 673 | 673 | 242 | 311 | 0 | 563 | 464 | 99 | 60 | 39 | 619 | 1,227 | 0 | 4 | 309 | 0 | 0 | 
| app_proof | prover | 1 | 640,057,356 | 2,292 | 615 | 0 | 0 | 1,236 | 676 | 676 | 250 | 309 | 0 | 441 | 343 | 97 | 59 | 38 | 615 | 1,236 | 0 | 4 | 308 | 0 | 0 | 
| app_proof | prover | 2 | 640,057,356 | 2,291 | 614 | 0 | 0 | 1,232 | 676 | 676 | 245 | 310 | 0 | 444 | 343 | 100 | 61 | 39 | 614 | 1,232 | 0 | 5 | 309 | 0 | 0 | 
| app_proof | prover | 3 | 640,057,588 | 2,290 | 616 | 0 | 0 | 1,226 | 668 | 668 | 248 | 309 | 0 | 446 | 349 | 97 | 58 | 38 | 617 | 1,226 | 0 | 4 | 308 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 67 | 2,713 | 67 | 136 | 5,529,436,044 | 2,165,730,336 | 7,695,166,380 | 2,097,152 | 0 | 3 | 98 | 2,851,000 | 32.72 | 
| app_proof | 1 | 57 | 2,594 | 57 | 41 | 5,529,347,520 | 2,165,557,968 | 7,694,905,488 | 2,097,152 | 0 | 1 | 203 | 2,851,000 | 35.99 | 
| app_proof | 2 | 57 | 2,567 | 57 | 41 | 5,529,349,296 | 2,165,556,192 | 7,694,905,488 | 2,097,152 | 0 | 1 | 177 | 2,851,000 | 36.08 | 
| app_proof | 3 | 54 | 2,554 | 54 | 41 | 5,077,435,956 | 2,617,472,316 | 7,694,908,272 | 2,097,152 | 0 | 1 | 168 | 2,614,961 | 35.97 | 

...
| `total_proof_time_ms ` |  2,640.25 |  10,561 |  2,745 |  2,592 |
...
| `execute_preflight_time_ms` |  161.50 |  646 |  203 |  99 |
| `execute_preflight_insn_mi/s` |  35.03 | -          |  36.07 |  32.61 |
| `trace_gen_time_ms   ` |  59 |  236 |  68 |  54 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  2,354 |  9,416 |  2,441 |  2,322 |
| `prover.main_trace_commit_time_ms` |  623.50 |  2,494 |  626 |  621 |
| `prover.rap_constraints_time_ms` |  1,251.75 |  5,007 |  1,253 |  1,250 |
| `prover.openings_time_ms` |  477.75 |  1,911 |  562 |  448 |
| `prover.rap_constraints.logup_gkr_time_ms` |  314.25 |  1,257 |  315 |  314 |
| `prover.rap_constraints.round0_time_ms` |  684.50 |  2,738 |  686 |  683 |
| `prover.rap_constraints.mle_rounds_time_ms` |  252 |  1,008 |  254 |  251 |
| `prover.openings.stacked_reduction_time_ms` |  100 |  400 |  102 |  97 |
| `prover.openings.stacked_reduction.round0_time_ms` |  60.25 |  241 |  62 |  58 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  39 |  156 |  39 |  39 |
| `prover.openings.whir_time_ms` |  377.50 |  1,510 |  465 |  346 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,983 |  1,983 |  1,983 |  1,983 |
...
| `prover.main_trace_commit_time_ms` |  827 |  827 |  827 |  827 |
| `prover.rap_constraints_time_ms` |  360 |  360 |  360 |  360 |
| `prover.openings_time_ms` |  649 |  649 |  649 |  649 |
...
| `prover.openings.whir_time_ms` |  582 |  582 |  582 |  582 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/796458ee5da6795eb241854ca948f921d258eb45/sha2_bench-796458ee5da6795eb241854ca948f921d258eb45.memory.svg)
...
| app_proof |  |  |  |  |  | 2,592 |  |  | 100 | 11,167,961 | 110.66 | 0 | 10,669 |  | 
| internal_for_leaf |  |  |  | 492 |  |  |  |  |  |  |  |  |  | 492 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 61,220,667 | 465 | 188 | 0 | 0 | 131 | 38 | 38 | 65 | 27 | 0 | 145 | 126 | 19 | 6 | 13 | 188 | 131 | 0 | 4 | 26 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,943 | 181 | 50 | 0 | 0 | 73 | 25 | 24 | 29 | 18 | 0 | 58 | 49 | 8 | 2 | 6 | 50 | 73 | 0 | 3 | 17 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 138 | 32 | 0 | 0 | 63 | 24 | 23 | 25 | 13 | 0 | 43 | 35 | 7 | 1 | 5 | 32 | 63 | 0 | 3 | 13 | 0 | 0 | 
| leaf | 0 | prover | 425,192,422 | 1,837 | 826 | 0 | 91 | 360 | 175 | 174 | 106 | 78 | 0 | 649 | 582 | 66 | 37 | 29 | 827 | 360 | 0 | 10 | 76 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 640,057,593 | 2,441 | 625 | 0 | 72 | 1,252 | 685 | 685 | 252 | 314 | 0 | 562 | 465 | 97 | 58 | 39 | 626 | 1,252 | 0 | 5 | 312 | 0 | 0 | 
| app_proof | prover | 1 | 640,057,356 | 2,322 | 621 | 0 | 0 | 1,252 | 686 | 686 | 251 | 314 | 0 | 448 | 346 | 101 | 61 | 39 | 621 | 1,252 | 0 | 5 | 313 | 0 | 0 | 
| app_proof | prover | 2 | 640,057,356 | 2,325 | 622 | 0 | 0 | 1,253 | 684 | 684 | 254 | 314 | 0 | 449 | 347 | 102 | 62 | 39 | 622 | 1,253 | 0 | 5 | 313 | 0 | 0 | 
| app_proof | prover | 3 | 640,057,588 | 2,328 | 624 | 0 | 0 | 1,250 | 683 | 683 | 251 | 315 | 0 | 452 | 352 | 100 | 60 | 39 | 625 | 1,250 | 0 | 5 | 313 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 68 | 2,745 | 68 | 136 | 5,529,436,044 | 2,165,730,336 | 7,695,166,380 | 2,097,152 | 0 | 3 | 99 | 2,851,000 | 32.61 | 
| app_proof | 1 | 57 | 2,623 | 57 | 41 | 5,529,347,520 | 2,165,557,968 | 7,694,905,488 | 2,097,152 | 0 | 1 | 203 | 2,851,000 | 35.96 | 
| app_proof | 2 | 57 | 2,601 | 57 | 41 | 5,529,349,296 | 2,165,556,192 | 7,694,905,488 | 2,097,152 | 0 | 1 | 176 | 2,851,000 | 36.07 | 
| app_proof | 3 | 54 | 2,592 | 54 | 41 | 5,077,435,956 | 2,617,472,316 | 7,694,908,272 | 2,097,152 | 0 | 1 | 168 | 2,614,961 | 35.51 | 

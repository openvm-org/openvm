...
| `total_proof_time_ms ` |  764 |  1,528 |  883 |  645 |
| `compile_metered_time_ms` |  8 |  8 |  8 |  8 |
| `execute_metered_time_ms` |  35 | -          | -          | -          |
| `execute_metered_insns` |  4,090,656 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  116.15 | -          |  116.15 |  116.15 |
| `execute_preflight_insns` |  2,045,328 |  4,090,656 |  2,327,000 |  1,763,656 |
| `execute_preflight_time_ms` |  85.50 |  171 |  97 |  74 |
| `execute_preflight_insn_mi/s` |  33 | -          |  35.27 |  30.74 |
| `trace_gen_time_ms   ` |  37 |  74 |  45 |  29 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  552 |  1,104 |  620 |  484 |
| `prover.main_trace_commit_time_ms` |  113.50 |  227 |  128 |  99 |
| `prover.rap_constraints_time_ms` |  325 |  650 |  366 |  284 |
| `prover.openings_time_ms` |  113 |  226 |  126 |  100 |
| `prover.rap_constraints.logup_gkr_time_ms` |  197 |  394 |  240 |  154 |
| `prover.rap_constraints.round0_time_ms` |  92.50 |  185 |  98 |  87 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/125023dcd3bda2e32aee54cbd55a235459a151d0/regex-125023dcd3bda2e32aee54cbd55a235459a151d0.memory.svg)
...
| app_proof |  |  |  |  |  | 645 |  |  | 35 | 4,090,656 | 116.15 | 0 | 1,577 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 27,289,403 | 256 | 81 | 0 | 0 | 96 | 31 | 30 | 45 | 19 | 0 | 78 | 67 | 11 | 2 | 8 | 81 | 96 | 0 | 3 | 18 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,767 | 171 | 47 | 0 | 0 | 67 | 25 | 25 | 28 | 13 | 0 | 56 | 48 | 8 | 1 | 6 | 47 | 67 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 134 | 31 | 0 | 0 | 61 | 23 | 22 | 24 | 13 | 0 | 40 | 32 | 7 | 1 | 5 | 32 | 61 | 0 | 2 | 13 | 0 | 0 | 
| leaf | 0 | prover | 79,656,756 | 375 | 126 | 0 | 0 | 133 | 53 | 52 | 37 | 41 | 0 | 115 | 99 | 15 | 6 | 8 | 127 | 133 | 0 | 6 | 40 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 161,843,666 | 620 | 128 | 0 | 0 | 366 | 87 | 86 | 37 | 240 | 0 | 126 | 100 | 25 | 13 | 11 | 128 | 366 | 0 | 3 | 239 | 0 | 0 | 
| app_proof | prover | 1 | 123,257,151 | 484 | 99 | 0 | 0 | 284 | 98 | 98 | 30 | 154 | 0 | 100 | 80 | 20 | 9 | 10 | 99 | 284 | 0 | 3 | 153 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 29 | 883 | 29 | 136 | 2,906,597,493 | 888,488,923 | 3,795,086,416 | 2,097,152 | 1 | 4 | 97 | 2,327,000 | 30.74 | 
| app_proof | 1 | 45 | 645 | 45 | 41 | 2,092,069,523 | 674,063,136 | 2,766,132,659 | 2,097,152 | 0 | 2 | 74 | 1,763,656 | 35.27 | 

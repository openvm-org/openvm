...
|:---|---:|---:|---:|
| Total |  13.29 |  5.59 |  5.59 |
| app_proof |  10.53 |  2.82 |  2.82 |
| leaf |  1.94 |  1.94 |  1.94 |
...
| `total_proof_time_ms ` |  2,607 |  10,428 |  2,719 |  2,555 |
...
| `execute_preflight_time_ms` |  160.75 |  643 |  202 |  97 |
| `execute_preflight_insn_mi/s` |  35.32 | -          |  36.29 |  33.04 |
| `trace_gen_time_ms   ` |  59 |  236 |  68 |  54 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  2,321.25 |  9,285 |  2,416 |  2,288 |
| `prover.main_trace_commit_time_ms` |  615 |  2,460 |  619 |  611 |
| `prover.rap_constraints_time_ms` |  1,231 |  4,924 |  1,234 |  1,227 |
| `prover.openings_time_ms` |  474.25 |  1,897 |  563 |  442 |
| `prover.rap_constraints.logup_gkr_time_ms` |  310.50 |  1,242 |  312 |  309 |
| `prover.rap_constraints.round0_time_ms` |  676.50 |  2,706 |  681 |  673 |
| `prover.rap_constraints.mle_rounds_time_ms` |  243.25 |  973 |  246 |  240 |
| `prover.openings.stacked_reduction_time_ms` |  99.25 |  397 |  101 |  98 |
...
| `prover.openings.whir_time_ms` |  374.75 |  1,499 |  463 |  343 |
...
| `prover.openings_time_ms` |  638 |  638 |  638 |  638 |
...
| `prover.openings.whir_time_ms` |  573 |  573 |  573 |  573 |
...
| `prover.openings.whir_time_ms` |  126 |  126 |  126 |  126 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/e7c1354ae4ec90f3265b5d0e86d4871719649c37/sha2_bench-e7c1354ae4ec90f3265b5d0e86d4871719649c37.memory.svg)
...
| app_proof |  |  |  |  |  | 2,555 |  |  | 100 | 11,167,961 | 111.60 | 0 | 10,534 |  | 
| internal_for_leaf |  |  |  | 487 |  |  |  |  |  |  |  |  |  | 487 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 61,220,667 | 460 | 184 | 0 | 0 | 130 | 38 | 37 | 64 | 27 | 0 | 144 | 126 | 18 | 5 | 12 | 184 | 130 | 0 | 4 | 26 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,943 | 183 | 50 | 0 | 0 | 72 | 25 | 25 | 29 | 17 | 0 | 59 | 50 | 8 | 2 | 6 | 50 | 72 | 0 | 3 | 17 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 135 | 32 | 0 | 0 | 59 | 22 | 21 | 24 | 13 | 0 | 42 | 35 | 7 | 1 | 5 | 32 | 59 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 425,192,422 | 1,798 | 809 | 0 | 88 | 350 | 169 | 168 | 105 | 74 | 0 | 638 | 573 | 64 | 35 | 28 | 809 | 350 | 0 | 9 | 73 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 640,057,593 | 2,416 | 618 | 0 | 70 | 1,233 | 676 | 675 | 246 | 311 | 0 | 563 | 463 | 99 | 60 | 39 | 619 | 1,233 | 0 | 4 | 308 | 0 | 0 | 
| app_proof | prover | 1 | 640,057,356 | 2,289 | 611 | 0 | 0 | 1,234 | 681 | 680 | 244 | 309 | 0 | 442 | 343 | 99 | 60 | 38 | 611 | 1,234 | 0 | 5 | 308 | 0 | 0 | 
| app_proof | prover | 2 | 640,057,356 | 2,288 | 612 | 0 | 0 | 1,227 | 676 | 676 | 240 | 310 | 0 | 447 | 346 | 101 | 61 | 39 | 613 | 1,227 | 0 | 5 | 309 | 0 | 0 | 
| app_proof | prover | 3 | 640,057,588 | 2,292 | 616 | 0 | 0 | 1,230 | 673 | 673 | 243 | 312 | 0 | 445 | 347 | 98 | 59 | 38 | 617 | 1,230 | 0 | 5 | 310 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 68 | 2,719 | 68 | 137 | 5,529,436,044 | 2,165,730,336 | 7,695,166,380 | 2,097,152 | 0 | 3 | 97 | 2,851,000 | 33.04 | 
| app_proof | 1 | 57 | 2,590 | 57 | 41 | 5,529,347,520 | 2,165,557,968 | 7,694,905,488 | 2,097,152 | 0 | 1 | 202 | 2,851,000 | 36.29 | 
| app_proof | 2 | 57 | 2,564 | 57 | 41 | 5,529,349,296 | 2,165,556,192 | 7,694,905,488 | 2,097,152 | 0 | 1 | 177 | 2,851,000 | 35.71 | 
| app_proof | 3 | 54 | 2,555 | 54 | 41 | 5,077,435,956 | 2,617,472,316 | 7,694,908,272 | 2,097,152 | 0 | 1 | 167 | 2,614,961 | 36.22 | 

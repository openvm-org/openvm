...
| `total_proof_time_ms ` |  766.50 |  1,533 |  882 |  651 |
| `compile_metered_time_ms` |  8 |  8 |  8 |  8 |
| `execute_metered_time_ms` |  35 | -          | -          | -          |
| `execute_metered_insns` |  4,090,656 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  116.33 | -          |  116.33 |  116.33 |
| `execute_preflight_insns` |  2,045,328 |  4,090,656 |  2,327,000 |  1,763,656 |
| `execute_preflight_time_ms` |  85.50 |  171 |  95 |  76 |
| `execute_preflight_insn_mi/s` |  33.33 | -          |  34.54 |  32.12 |
| `trace_gen_time_ms   ` |  38 |  76 |  44 |  32 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  553 |  1,106 |  617 |  489 |
| `prover.main_trace_commit_time_ms` |  114 |  228 |  129 |  99 |
| `prover.rap_constraints_time_ms` |  324 |  648 |  361 |  287 |
| `prover.openings_time_ms` |  113.50 |  227 |  125 |  102 |
| `prover.rap_constraints.logup_gkr_time_ms` |  197 |  394 |  239 |  155 |
| `prover.rap_constraints.round0_time_ms` |  92 |  184 |  100 |  84 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/e7c1354ae4ec90f3265b5d0e86d4871719649c37/regex-e7c1354ae4ec90f3265b5d0e86d4871719649c37.memory.svg)
...
| app_proof |  |  |  |  |  | 651 |  |  | 35 | 4,090,656 | 116.33 | 0 | 1,583 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 27,289,403 | 257 | 82 | 0 | 0 | 97 | 32 | 31 | 45 | 19 | 0 | 77 | 66 | 11 | 2 | 8 | 82 | 97 | 0 | 3 | 18 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,767 | 166 | 47 | 0 | 0 | 67 | 25 | 25 | 28 | 13 | 0 | 51 | 42 | 8 | 1 | 6 | 47 | 67 | 0 | 2 | 12 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 136 | 31 | 0 | 0 | 62 | 23 | 23 | 24 | 13 | 0 | 41 | 34 | 7 | 1 | 5 | 32 | 62 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 79,656,756 | 381 | 127 | 0 | 0 | 135 | 54 | 53 | 37 | 42 | 0 | 118 | 103 | 15 | 6 | 8 | 127 | 135 | 0 | 6 | 41 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 161,843,666 | 617 | 129 | 0 | 0 | 361 | 84 | 83 | 37 | 239 | 0 | 125 | 100 | 24 | 13 | 11 | 129 | 361 | 0 | 3 | 238 | 0 | 0 | 
| app_proof | prover | 1 | 123,257,151 | 489 | 99 | 0 | 0 | 287 | 100 | 100 | 30 | 155 | 0 | 102 | 81 | 20 | 9 | 10 | 99 | 287 | 0 | 3 | 154 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 32 | 882 | 32 | 137 | 2,906,597,493 | 888,488,923 | 3,795,086,416 | 2,097,152 | 1 | 4 | 95 | 2,327,000 | 32.12 | 
| app_proof | 1 | 44 | 651 | 44 | 41 | 2,092,069,523 | 674,063,136 | 2,766,132,659 | 2,097,152 | 0 | 2 | 76 | 1,763,656 | 34.54 | 

...
| `total_proof_time_ms ` |  780.50 |  1,561 |  899 |  662 |
| `compile_metered_time_ms` |  8 |  8 |  8 |  8 |
| `execute_metered_time_ms` |  35 | -          | -          | -          |
| `execute_metered_insns` |  4,090,656 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  114.68 | -          |  114.68 |  114.68 |
| `execute_preflight_insns` |  2,045,328 |  4,090,656 |  2,327,000 |  1,763,656 |
| `execute_preflight_time_ms` |  85.50 |  171 |  96 |  75 |
| `execute_preflight_insn_mi/s` |  33.04 | -          |  35.12 |  30.95 |
| `trace_gen_time_ms   ` |  40 |  80 |  48 |  32 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  565 |  1,130 |  633 |  497 |
| `prover.main_trace_commit_time_ms` |  116 |  232 |  130 |  102 |
| `prover.rap_constraints_time_ms` |  332.50 |  665 |  373 |  292 |
| `prover.openings_time_ms` |  115 |  230 |  128 |  102 |
| `prover.rap_constraints.logup_gkr_time_ms` |  201 |  402 |  245 |  157 |
| `prover.rap_constraints.round0_time_ms` |  95.50 |  191 |  102 |  89 |
| `prover.rap_constraints.mle_rounds_time_ms` |  35.50 |  71 |  39 |  32 |
| `prover.openings.stacked_reduction_time_ms` |  23 |  46 |  26 |  20 |
...
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  388 |  388 |  388 |  388 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/796458ee5da6795eb241854ca948f921d258eb45/regex-796458ee5da6795eb241854ca948f921d258eb45.memory.svg)
...
| app_proof |  |  |  |  |  | 662 |  |  | 35 | 4,090,656 | 114.68 | 0 | 1,610 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 27,289,403 | 261 | 83 | 0 | 0 | 99 | 32 | 31 | 46 | 20 | 0 | 78 | 66 | 11 | 2 | 8 | 84 | 99 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,767 | 167 | 45 | 0 | 0 | 66 | 24 | 23 | 27 | 13 | 0 | 55 | 46 | 8 | 1 | 6 | 46 | 66 | 0 | 3 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 139 | 32 | 0 | 0 | 63 | 24 | 23 | 24 | 14 | 0 | 43 | 35 | 7 | 1 | 5 | 32 | 63 | 0 | 2 | 13 | 0 | 0 | 
| leaf | 0 | prover | 79,656,756 | 388 | 129 | 0 | 0 | 137 | 56 | 55 | 38 | 42 | 0 | 120 | 105 | 15 | 6 | 8 | 129 | 137 | 0 | 7 | 42 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 161,843,666 | 633 | 130 | 0 | 0 | 373 | 89 | 89 | 39 | 245 | 0 | 128 | 102 | 26 | 14 | 11 | 130 | 373 | 0 | 3 | 244 | 0 | 0 | 
| app_proof | prover | 1 | 123,257,151 | 497 | 102 | 0 | 0 | 292 | 102 | 102 | 32 | 157 | 0 | 102 | 81 | 20 | 10 | 10 | 102 | 292 | 0 | 3 | 156 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 32 | 899 | 32 | 136 | 2,906,597,493 | 888,488,923 | 3,795,086,416 | 2,097,152 | 1 | 4 | 96 | 2,327,000 | 30.95 | 
| app_proof | 1 | 48 | 662 | 48 | 41 | 2,092,069,523 | 674,063,136 | 2,766,132,659 | 2,097,152 | 0 | 2 | 75 | 1,763,656 | 35.12 | 

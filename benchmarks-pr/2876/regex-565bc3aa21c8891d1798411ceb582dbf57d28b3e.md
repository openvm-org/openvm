...
| `total_proof_time_ms ` |  769 |  1,538 |  885 |  653 |
| `compile_metered_time_ms` |  8 |  8 |  8 |  8 |
| `execute_metered_time_ms` |  34 | -          | -          | -          |
| `execute_metered_insns` |  4,090,656 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  117.28 | -          |  117.28 |  117.28 |
| `execute_preflight_insns` |  2,045,328 |  4,090,656 |  2,327,000 |  1,763,656 |
| `execute_preflight_time_ms` |  89 |  178 |  98 |  80 |
| `execute_preflight_insn_mi/s` |  31.07 | -          |  31.56 |  30.57 |
| `trace_gen_time_ms   ` |  34.50 |  69 |  40 |  29 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  556.50 |  1,113 |  622 |  491 |
| `prover.main_trace_commit_time_ms` |  115.50 |  231 |  129 |  102 |
| `prover.rap_constraints_time_ms` |  327 |  654 |  366 |  288 |
| `prover.openings_time_ms` |  113.50 |  227 |  126 |  101 |
| `prover.rap_constraints.logup_gkr_time_ms` |  199 |  398 |  243 |  155 |
| `prover.rap_constraints.round0_time_ms` |  93 |  186 |  101 |  85 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/565bc3aa21c8891d1798411ceb582dbf57d28b3e/regex-565bc3aa21c8891d1798411ceb582dbf57d28b3e.memory.svg)
...
| app_proof |  |  |  |  |  | 653 |  |  | 34 | 4,090,656 | 117.28 | 0 | 1,587 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 17 | 277 | 16 | 5 | 0 | 2 | 1 | 1 | 
| internal_recursive.0 | 1 | 11 | 186 | 10 | 1 | 0 | 2 | 0 | 0 | 
| internal_recursive.1 | 1 | 10 | 150 | 10 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 48 | 435 | 48 | 13 | 3 | 4 | 1 | 1 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 27,289,403 | 260 | 82 | 0 | 0 | 98 | 32 | 31 | 45 | 20 | 0 | 78 | 67 | 11 | 2 | 8 | 83 | 98 | 0 | 3 | 18 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,767 | 175 | 46 | 0 | 0 | 67 | 25 | 24 | 27 | 13 | 0 | 61 | 53 | 8 | 1 | 6 | 46 | 67 | 0 | 3 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 139 | 32 | 0 | 0 | 62 | 23 | 22 | 24 | 14 | 0 | 44 | 36 | 7 | 1 | 5 | 32 | 62 | 0 | 3 | 13 | 0 | 0 | 
| leaf | 0 | prover | 79,656,756 | 387 | 128 | 0 | 0 | 138 | 57 | 56 | 37 | 43 | 0 | 120 | 105 | 15 | 6 | 8 | 128 | 138 | 0 | 6 | 42 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 161,843,666 | 622 | 129 | 0 | 0 | 366 | 85 | 85 | 37 | 243 | 0 | 126 | 101 | 25 | 13 | 11 | 129 | 366 | 0 | 3 | 242 | 0 | 0 | 
| app_proof | prover | 1 | 123,257,151 | 491 | 101 | 0 | 0 | 288 | 101 | 100 | 31 | 155 | 0 | 101 | 80 | 20 | 9 | 10 | 102 | 287 | 0 | 3 | 155 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 29 | 885 | 29 | 135 | 2,906,597,493 | 888,488,923 | 3,795,086,416 | 2,097,152 | 1 | 4 | 98 | 2,327,000 | 30.57 | 
| app_proof | 1 | 40 | 653 | 40 | 41 | 2,092,069,523 | 674,063,136 | 2,766,132,659 | 2,097,152 | 0 | 2 | 80 | 1,763,656 | 31.56 | 

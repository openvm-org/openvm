...
|:---|---:|---:|---:|
| Total |  13.43 |  5.64 |  5.64 |
| app_proof |  10.64 |  2.85 |  2.85 |
| leaf |  1.96 |  1.96 |  1.96 |
...
| `total_proof_time_ms ` |  2,634.75 |  10,539 |  2,747 |  2,578 |
...
| `execute_preflight_insn_mi/s` |  35.16 | -          |  36.19 |  32.86 |
| `trace_gen_time_ms   ` |  59.25 |  237 |  69 |  54 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  2,349.50 |  9,398 |  2,444 |  2,316 |
| `prover.main_trace_commit_time_ms` |  624 |  2,496 |  628 |  621 |
| `prover.rap_constraints_time_ms` |  1,247.75 |  4,991 |  1,251 |  1,244 |
| `prover.openings_time_ms` |  476.75 |  1,907 |  567 |  446 |
| `prover.rap_constraints.logup_gkr_time_ms` |  313.75 |  1,255 |  315 |  313 |
| `prover.rap_constraints.round0_time_ms` |  679.75 |  2,719 |  683 |  675 |
| `prover.rap_constraints.mle_rounds_time_ms` |  253 |  1,012 |  254 |  251 |
| `prover.openings.stacked_reduction_time_ms` |  99.75 |  399 |  102 |  96 |
| `prover.openings.stacked_reduction.round0_time_ms` |  60.50 |  242 |  62 |  57 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  39.25 |  157 |  40 |  39 |
| `prover.openings.whir_time_ms` |  376.25 |  1,505 |  464 |  345 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,955 |  1,955 |  1,955 |  1,955 |
...
| `prover.main_trace_commit_time_ms` |  815 |  815 |  815 |  815 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/5026b7e11933f1328e66893a96bc547be64a2b30/sha2_bench-5026b7e11933f1328e66893a96bc547be64a2b30.memory.svg)
...
| app_proof |  |  |  |  |  | 2,578 |  |  | 99 | 11,167,961 | 111.73 | 0 | 10,645 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 61,220,667 | 463 | 187 | 0 | 0 | 131 | 38 | 37 | 65 | 27 | 0 | 144 | 125 | 18 | 5 | 13 | 187 | 131 | 0 | 4 | 26 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,943 | 182 | 51 | 0 | 0 | 74 | 26 | 25 | 29 | 18 | 0 | 56 | 47 | 8 | 2 | 6 | 51 | 74 | 0 | 3 | 17 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 140 | 32 | 0 | 0 | 62 | 23 | 22 | 24 | 13 | 0 | 45 | 37 | 7 | 1 | 5 | 32 | 62 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 425,192,422 | 1,810 | 815 | 0 | 89 | 359 | 176 | 175 | 106 | 76 | 0 | 635 | 569 | 65 | 37 | 28 | 815 | 359 | 0 | 10 | 75 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 640,057,593 | 2,444 | 628 | 0 | 71 | 1,248 | 681 | 680 | 251 | 315 | 0 | 567 | 464 | 102 | 62 | 40 | 628 | 1,248 | 0 | 5 | 313 | 0 | 0 | 
| app_proof | prover | 1 | 640,057,356 | 2,318 | 621 | 0 | 0 | 1,248 | 680 | 680 | 254 | 313 | 0 | 448 | 346 | 101 | 62 | 39 | 621 | 1,248 | 0 | 5 | 312 | 0 | 0 | 
| app_proof | prover | 2 | 640,057,356 | 2,320 | 622 | 0 | 0 | 1,251 | 683 | 683 | 253 | 313 | 0 | 446 | 345 | 100 | 61 | 39 | 622 | 1,251 | 0 | 6 | 312 | 0 | 0 | 
| app_proof | prover | 3 | 640,057,588 | 2,316 | 624 | 0 | 0 | 1,244 | 675 | 675 | 254 | 314 | 0 | 446 | 350 | 96 | 57 | 39 | 625 | 1,244 | 0 | 5 | 313 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 69 | 2,747 | 69 | 135 | 5,529,436,044 | 2,165,730,336 | 7,695,166,380 | 2,097,152 | 0 | 3 | 97 | 2,851,000 | 32.86 | 
| app_proof | 1 | 57 | 2,619 | 57 | 41 | 5,529,347,520 | 2,165,557,968 | 7,694,905,488 | 2,097,152 | 0 | 1 | 201 | 2,851,000 | 36.05 | 
| app_proof | 2 | 57 | 2,595 | 57 | 41 | 5,529,349,296 | 2,165,556,192 | 7,694,905,488 | 2,097,152 | 0 | 1 | 176 | 2,851,000 | 35.55 | 
| app_proof | 3 | 54 | 2,578 | 54 | 41 | 5,077,435,956 | 2,617,472,316 | 7,694,908,272 | 2,097,152 | 0 | 1 | 166 | 2,614,961 | 36.19 | 

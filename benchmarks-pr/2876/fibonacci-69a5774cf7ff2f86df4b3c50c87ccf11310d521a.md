...
|:---|---:|---:|---:|
| Total |  2.82 |  1.70 |  1.70 |
| app_proof |  1.69 |  0.57 |  0.57 |
| leaf |  0.53 |  0.53 |  0.53 |
...
| `total_proof_time_ms ` |  416.50 |  1,666 |  548 |  226 |
| `compile_metered_time_ms` |  4 |  4 |  4 |  4 |
| `execute_metered_time_ms` |  21 | -          | -          | -          |
| `execute_metered_insns` |  4,000,051 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  189.37 | -          |  189.37 |  189.37 |
| `execute_preflight_insns` |  1,000,012.75 |  4,000,051 |  1,310,000 |  70,051 |
| `execute_preflight_time_ms` |  36.25 |  145 |  50 |  4 |
| `execute_preflight_insn_mi/s` |  41.08 | -          |  41.23 |  40.78 |
| `trace_gen_time_ms   ` |  75.50 |  302 |  103 |  64 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  239 |  956 |  295 |  77 |
| `prover.main_trace_commit_time_ms` |  41.75 |  167 |  51 |  16 |
| `prover.rap_constraints_time_ms` |  140.75 |  563 |  178 |  34 |
| `prover.openings_time_ms` |  55.25 |  221 |  67 |  26 |
| `prover.rap_constraints.logup_gkr_time_ms` |  97.25 |  389 |  125 |  17 |
| `prover.rap_constraints.round0_time_ms` |  29 |  116 |  37 |  9 |
| `prover.rap_constraints.mle_rounds_time_ms` |  13.50 |  54 |  16 |  7 |
| `prover.openings.stacked_reduction_time_ms` |  9 |  36 |  11 |  3 |
...
| `prover.openings.whir_time_ms` |  45.75 |  183 |  56 |  22 |
...
| `prover.openings.whir_time_ms` |  123 |  123 |  123 |  123 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/69a5774cf7ff2f86df4b3c50c87ccf11310d521a/fibonacci-69a5774cf7ff2f86df4b3c50c87ccf11310d521a.memory.svg)
...
| app_proof |  |  |  |  |  | 226 |  |  | 21 | 4,000,051 | 189.37 | 0 | 1,694 |  | 
...
| app_proof | 25 | Poseidon2PeripheryAir<BabyBearParameters>, 1> | 1 | 298 | 214 | 223,500 | 160,500 | 357,600 | 256,800 | 89,400 | 64,200 | 10,803 | 7,757 | 298 | 214 | 
...
| app_proof | 25 | Poseidon2PeripheryAir<BabyBearParameters>, 1> | 2 | 298 | 214 | 223,500 | 160,500 | 357,600 | 256,800 | 89,400 | 64,200 | 10,803 | 7,757 | 298 | 214 | 
...
| app_proof | 25 | Poseidon2PeripheryAir<BabyBearParameters>, 1> | 3 | 894 | 130 | 670,500 | 97,500 | 1,072,800 | 156,000 | 268,200 | 39,000 | 32,408 | 4,712 | 894 | 130 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 18 | 279 | 17 | 5 | 0 | 2 | 1 | 1 | 
| internal_recursive.0 | 1 | 10 | 178 | 10 | 1 | 0 | 2 | 0 | 1 | 
| internal_recursive.1 | 1 | 10 | 144 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 57 | 530 | 57 | 22 | 3 | 1 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 27,289,403 | 260 | 83 | 0 | 0 | 98 | 33 | 32 | 45 | 20 | 0 | 78 | 67 | 11 | 2 | 8 | 83 | 98 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,767 | 167 | 46 | 0 | 0 | 67 | 25 | 24 | 28 | 14 | 0 | 53 | 44 | 8 | 1 | 6 | 46 | 67 | 0 | 3 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 134 | 31 | 0 | 0 | 60 | 23 | 22 | 24 | 13 | 0 | 40 | 33 | 7 | 1 | 5 | 32 | 60 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 102,779,942 | 473 | 169 | 0 | 0 | 161 | 70 | 69 | 46 | 43 | 0 | 141 | 123 | 18 | 8 | 9 | 169 | 161 | 0 | 7 | 42 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 62,648,824 | 295 | 51 | 0 | 0 | 178 | 37 | 36 | 15 | 125 | 0 | 64 | 52 | 11 | 5 | 5 | 51 | 178 | 0 | 3 | 124 | 0 | 0 | 
| app_proof | prover | 1 | 62,602,932 | 294 | 50 | 0 | 0 | 176 | 35 | 35 | 16 | 124 | 0 | 67 | 56 | 11 | 5 | 5 | 50 | 176 | 0 | 3 | 123 | 0 | 0 | 
| app_proof | prover | 2 | 62,602,932 | 290 | 50 | 0 | 0 | 175 | 35 | 35 | 16 | 123 | 0 | 64 | 53 | 11 | 5 | 5 | 50 | 175 | 0 | 3 | 122 | 0 | 0 | 
| app_proof | prover | 3 | 9,072,096 | 77 | 16 | 0 | 0 | 34 | 9 | 9 | 7 | 17 | 0 | 26 | 22 | 3 | 0 | 2 | 16 | 34 | 0 | 2 | 16 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 66 | 548 | 66 | 136 | 1,626,487,336 | 2,099,944 | 1,628,587,280 | 2,097,152 | 0 | 3 | 50 | 1,310,000 | 41.13 | 
| app_proof | 1 | 64 | 446 | 64 | 41 | 1,625,164,404 | 1,206,055 | 1,626,370,459 | 2,097,152 | 0 | 1 | 46 | 1,310,000 | 41.23 | 
| app_proof | 2 | 69 | 446 | 69 | 40 | 1,625,164,404 | 1,206,055 | 1,626,370,459 | 2,097,152 | 0 | 1 | 45 | 1,310,000 | 41.19 | 
| app_proof | 3 | 103 | 226 | 103 | 40 | 160,245,438 | 14,292,769 | 174,538,207 | 2,097,152 | 0 | 1 | 4 | 70,051 | 40.78 | 

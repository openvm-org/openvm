...
|:---|---:|---:|---:|
| Total |  13.29 |  5.58 |  5.58 |
| app_proof |  10.52 |  2.81 |  2.81 |
| leaf |  1.94 |  1.94 |  1.94 |
...
| `total_proof_time_ms ` |  2,605 |  10,420 |  2,714 |  2,554 |
...
| `execute_preflight_time_ms` |  162.50 |  650 |  202 |  98 |
| `execute_preflight_insn_mi/s` |  35.14 | -          |  35.98 |  32.78 |
| `trace_gen_time_ms   ` |  58.75 |  235 |  67 |  54 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  2,318.25 |  9,273 |  2,414 |  2,283 |
| `prover.main_trace_commit_time_ms` |  611.75 |  2,447 |  615 |  609 |
| `prover.rap_constraints_time_ms` |  1,232 |  4,928 |  1,234 |  1,229 |
| `prover.openings_time_ms` |  473.50 |  1,894 |  565 |  441 |
| `prover.rap_constraints.logup_gkr_time_ms` |  309.50 |  1,238 |  311 |  308 |
| `prover.rap_constraints.round0_time_ms` |  675.75 |  2,703 |  678 |  672 |
| `prover.rap_constraints.mle_rounds_time_ms` |  245.75 |  983 |  247 |  245 |
...
| `prover.openings.whir_time_ms` |  570 |  570 |  570 |  570 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/565bc3aa21c8891d1798411ceb582dbf57d28b3e/sha2_bench-565bc3aa21c8891d1798411ceb582dbf57d28b3e.memory.svg)
...
| app_proof |  |  |  |  |  | 2,554 |  |  | 99 | 11,167,961 | 112.19 | 0 | 10,526 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 61,220,667 | 468 | 183 | 0 | 0 | 132 | 38 | 38 | 65 | 27 | 0 | 151 | 132 | 18 | 5 | 13 | 184 | 132 | 0 | 4 | 26 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,943 | 182 | 50 | 0 | 0 | 72 | 25 | 24 | 29 | 18 | 0 | 59 | 50 | 8 | 2 | 6 | 50 | 72 | 0 | 3 | 17 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 133 | 31 | 0 | 0 | 58 | 22 | 21 | 23 | 12 | 0 | 42 | 35 | 7 | 1 | 5 | 32 | 58 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 425,192,422 | 1,792 | 805 | 0 | 91 | 349 | 170 | 169 | 104 | 74 | 0 | 636 | 570 | 65 | 36 | 28 | 806 | 349 | 0 | 10 | 73 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 640,057,593 | 2,414 | 614 | 0 | 71 | 1,234 | 676 | 676 | 246 | 311 | 0 | 565 | 465 | 99 | 60 | 39 | 614 | 1,234 | 0 | 4 | 309 | 0 | 0 | 
| app_proof | prover | 1 | 640,057,356 | 2,283 | 609 | 0 | 0 | 1,232 | 678 | 678 | 245 | 308 | 0 | 441 | 342 | 98 | 60 | 38 | 609 | 1,232 | 0 | 5 | 307 | 0 | 0 | 
| app_proof | prover | 2 | 640,057,356 | 2,286 | 608 | 0 | 0 | 1,233 | 677 | 677 | 245 | 310 | 0 | 443 | 343 | 100 | 61 | 39 | 609 | 1,233 | 0 | 5 | 309 | 0 | 0 | 
| app_proof | prover | 3 | 640,057,588 | 2,290 | 615 | 0 | 0 | 1,229 | 672 | 671 | 247 | 309 | 0 | 445 | 347 | 97 | 59 | 38 | 615 | 1,229 | 0 | 4 | 308 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 67 | 2,714 | 67 | 135 | 5,529,436,044 | 2,165,730,336 | 7,695,166,380 | 2,097,152 | 0 | 3 | 98 | 2,851,000 | 32.78 | 
| app_proof | 1 | 57 | 2,585 | 57 | 41 | 5,529,347,520 | 2,165,557,968 | 7,694,905,488 | 2,097,152 | 0 | 1 | 202 | 2,851,000 | 35.91 | 
| app_proof | 2 | 57 | 2,567 | 57 | 41 | 5,529,349,296 | 2,165,556,192 | 7,694,905,488 | 2,097,152 | 0 | 1 | 182 | 2,851,000 | 35.98 | 
| app_proof | 3 | 54 | 2,554 | 54 | 41 | 5,077,435,956 | 2,617,472,316 | 7,694,908,272 | 2,097,152 | 0 | 1 | 168 | 2,614,961 | 35.87 | 

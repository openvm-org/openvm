...
|:---|---:|---:|---:|
| Total |  13.24 |  5.57 |  5.57 |
| app_proof |  10.48 |  2.82 |  2.82 |
| leaf |  1.93 |  1.93 |  1.93 |
...
| `total_proof_time_ms ` |  2,596 |  10,384 |  2,716 |  2,539 |
...
| `execute_preflight_time_ms` |  165.25 |  661 |  205 |  112 |
| `execute_preflight_insn_mi/s` |  34.03 | -          |  36.01 |  28.25 |
| `trace_gen_time_ms   ` |  57.75 |  231 |  63 |  54 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  2,306.75 |  9,227 |  2,403 |  2,274 |
| `prover.main_trace_commit_time_ms` |  611.75 |  2,447 |  614 |  609 |
| `prover.rap_constraints_time_ms` |  1,223.50 |  4,894 |  1,228 |  1,217 |
| `prover.openings_time_ms` |  470.50 |  1,882 |  560 |  439 |
| `prover.rap_constraints.logup_gkr_time_ms` |  307.75 |  1,231 |  308 |  307 |
| `prover.rap_constraints.round0_time_ms` |  673 |  2,692 |  677 |  667 |
| `prover.rap_constraints.mle_rounds_time_ms` |  242 |  968 |  243 |  241 |
| `prover.openings.stacked_reduction_time_ms` |  97.25 |  389 |  99 |  96 |
| `prover.openings.stacked_reduction.round0_time_ms` |  58.25 |  233 |  59 |  57 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  38.25 |  153 |  39 |  38 |
| `prover.openings.whir_time_ms` |  372.50 |  1,490 |  461 |  342 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/583c1ab400fd0ab34b2f0b10ace19ab3343638a8/sha2_bench-583c1ab400fd0ab34b2f0b10ace19ab3343638a8.memory.svg)
...
| app_proof |  |  |  |  |  | 2,539 |  |  | 100 | 11,167,961 | 110.81 | 0 | 10,491 |  | 
...
| internal_recursive.0 | 1 | 13 | 191 | 12 | 1 | 0 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 9 | 147 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 145 | 1,929 | 144 | 50 | 22 | 3 | 6 | 6 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 61,220,667 | 458 | 183 | 0 | 0 | 129 | 37 | 37 | 64 | 27 | 0 | 143 | 125 | 18 | 5 | 12 | 184 | 129 | 0 | 4 | 26 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,943 | 178 | 50 | 0 | 0 | 72 | 25 | 24 | 29 | 17 | 0 | 55 | 46 | 8 | 1 | 6 | 50 | 72 | 0 | 2 | 16 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 138 | 32 | 0 | 0 | 60 | 22 | 21 | 24 | 13 | 0 | 44 | 37 | 7 | 1 | 5 | 32 | 60 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 425,192,422 | 1,784 | 805 | 0 | 88 | 348 | 170 | 169 | 102 | 75 | 0 | 630 | 566 | 64 | 36 | 27 | 805 | 348 | 0 | 9 | 73 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 640,057,593 | 2,403 | 614 | 0 | 70 | 1,228 | 677 | 676 | 242 | 308 | 0 | 560 | 461 | 99 | 59 | 39 | 614 | 1,228 | 0 | 4 | 306 | 0 | 0 | 
| app_proof | prover | 1 | 640,057,356 | 2,274 | 610 | 0 | 0 | 1,222 | 671 | 671 | 243 | 307 | 0 | 441 | 342 | 98 | 59 | 38 | 610 | 1,222 | 0 | 5 | 306 | 0 | 0 | 
| app_proof | prover | 2 | 640,057,356 | 2,275 | 608 | 0 | 0 | 1,227 | 677 | 677 | 241 | 308 | 0 | 439 | 342 | 96 | 57 | 38 | 609 | 1,227 | 0 | 4 | 307 | 0 | 0 | 
| app_proof | prover | 3 | 640,057,588 | 2,275 | 614 | 0 | 0 | 1,217 | 667 | 666 | 242 | 308 | 0 | 442 | 345 | 96 | 58 | 38 | 614 | 1,217 | 0 | 4 | 307 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 63 | 2,716 | 63 | 137 | 5,529,436,044 | 2,165,730,336 | 7,695,166,380 | 2,097,152 | 0 | 3 | 112 | 2,851,000 | 28.25 | 
| app_proof | 1 | 57 | 2,578 | 57 | 41 | 5,529,347,520 | 2,165,557,968 | 7,694,905,488 | 2,097,152 | 0 | 1 | 205 | 2,851,000 | 35.88 | 
| app_proof | 2 | 57 | 2,551 | 57 | 41 | 5,529,349,296 | 2,165,556,192 | 7,694,905,488 | 2,097,152 | 0 | 1 | 176 | 2,851,000 | 36.01 | 
| app_proof | 3 | 54 | 2,539 | 54 | 41 | 5,077,435,956 | 2,617,472,316 | 7,694,908,272 | 2,097,152 | 0 | 1 | 168 | 2,614,961 | 35.98 | 

...
| `execute_metered_insn_mi/s` |  77 | -          |  77 |  77 |
| `execute_preflight_insns` |  1,979,971 |  1,979,971 |  1,979,971 |  1,979,971 |
| `execute_preflight_time_ms` |  85 |  85 |  85 |  85 |
| `execute_preflight_insn_mi/s` |  30.25 | -          |  30.25 |  30.25 |
| `trace_gen_time_ms   ` |  108 |  108 |  108 |  108 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  3,681 |  3,681 |  3,681 |  3,681 |
| `prover.main_trace_commit_time_ms` |  1,173 |  1,173 |  1,173 |  1,173 |
| `prover.rap_constraints_time_ms` |  1,722 |  1,722 |  1,722 |  1,722 |
| `prover.openings_time_ms` |  785 |  785 |  785 |  785 |
| `prover.rap_constraints.logup_gkr_time_ms` |  296 |  296 |  296 |  296 |
| `prover.rap_constraints.round0_time_ms` |  1,037 |  1,037 |  1,037 |  1,037 |
| `prover.rap_constraints.mle_rounds_time_ms` |  389 |  389 |  389 |  389 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  881 |  881 |  881 |  881 |
...
| `prover.rap_constraints_time_ms` |  301 |  301 |  301 |  301 |
| `prover.openings_time_ms` |  216 |  216 |  216 |  216 |
| `prover.rap_constraints.logup_gkr_time_ms` |  132 |  132 |  132 |  132 |
| `prover.rap_constraints.round0_time_ms` |  108 |  108 |  108 |  108 |
| `prover.rap_constraints.mle_rounds_time_ms` |  60 |  60 |  60 |  60 |
...
| `prover.openings.whir_time_ms` |  188 |  188 |  188 |  188 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/69a5774cf7ff2f86df4b3c50c87ccf11310d521a/kitchen_sink-69a5774cf7ff2f86df4b3c50c87ccf11310d521a.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 71 | 9 |  |  | 0 |  | 371 | 9 |  |  |  |  |  |  | 
| app_proof |  |  |  |  |  | 4,010 |  |  | 25 | 1,979,971 | 77 | 0 | 4,040 |  | 
...
| leaf | 0 | 105 | 881 | 105 | 18 | 9 | 18 | 18 | 18 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,577,979 | 332 | 119 | 0 | 0 | 110 | 36 | 35 | 52 | 20 | 0 | 102 | 88 | 13 | 3 | 9 | 120 | 110 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,767 | 171 | 47 | 0 | 0 | 67 | 25 | 24 | 28 | 13 | 0 | 56 | 47 | 8 | 1 | 6 | 47 | 67 | 0 | 3 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 141 | 32 | 0 | 0 | 62 | 23 | 23 | 25 | 13 | 0 | 45 | 38 | 7 | 1 | 5 | 32 | 62 | 0 | 3 | 12 | 0 | 0 | 
| leaf | 0 | prover | 167,484,091 | 776 | 257 | 0 | 0 | 301 | 108 | 107 | 60 | 132 | 0 | 216 | 188 | 27 | 13 | 13 | 258 | 301 | 0 | 9 | 131 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,092,578,684 | 3,681 | 1,172 | 0 | 0 | 1,722 | 1,037 | 1,036 | 389 | 296 | 1 | 785 | 595 | 189 | 108 | 81 | 1,173 | 1,722 | 0 | 6 | 294 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 108 | 4,010 | 108 | 135 | 10,383,992,448 | 2,771,188,560 | 13,155,181,008 | 2,097,152 | 0 | 3 | 85 | 1,979,971 | 30.25 | 

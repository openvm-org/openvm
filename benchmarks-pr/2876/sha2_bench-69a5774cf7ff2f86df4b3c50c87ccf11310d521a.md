...
| `total_proof_time_ms ` |  2,607.75 |  10,431 |  2,704 |  2,553 |
...
| `execute_preflight_time_ms` |  168.25 |  673 |  217 |  99 |
| `execute_preflight_insn_mi/s` |  35.05 | -          |  35.99 |  32.58 |
| `trace_gen_time_ms   ` |  58.25 |  233 |  65 |  54 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  2,315.25 |  9,261 |  2,404 |  2,283 |
| `prover.main_trace_commit_time_ms` |  613 |  2,452 |  616 |  610 |
| `prover.rap_constraints_time_ms` |  1,229 |  4,916 |  1,235 |  1,222 |
| `prover.openings_time_ms` |  472.25 |  1,889 |  560 |  440 |
| `prover.rap_constraints.logup_gkr_time_ms` |  309 |  1,236 |  310 |  308 |
| `prover.rap_constraints.round0_time_ms` |  676.50 |  2,706 |  682 |  670 |
| `prover.rap_constraints.mle_rounds_time_ms` |  242.25 |  969 |  247 |  235 |
...
| `prover.openings.whir_time_ms` |  374 |  1,496 |  460 |  344 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,941 |  1,941 |  1,941 |  1,941 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/69a5774cf7ff2f86df4b3c50c87ccf11310d521a/sha2_bench-69a5774cf7ff2f86df4b3c50c87ccf11310d521a.memory.svg)
...
| app_proof |  |  |  |  |  | 2,553 |  |  | 101 | 11,167,961 | 110.04 | 0 | 10,539 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 61,220,667 | 461 | 184 | 0 | 0 | 130 | 38 | 37 | 64 | 27 | 0 | 146 | 127 | 18 | 5 | 12 | 184 | 130 | 0 | 4 | 26 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,943 | 182 | 50 | 0 | 0 | 73 | 25 | 24 | 29 | 18 | 0 | 57 | 48 | 8 | 2 | 6 | 50 | 73 | 0 | 3 | 17 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 138 | 31 | 0 | 0 | 62 | 23 | 23 | 24 | 14 | 0 | 43 | 36 | 7 | 1 | 5 | 31 | 62 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 425,192,422 | 1,794 | 805 | 0 | 88 | 350 | 169 | 168 | 106 | 75 | 0 | 638 | 573 | 64 | 35 | 28 | 805 | 350 | 0 | 10 | 74 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 640,057,593 | 2,404 | 615 | 0 | 71 | 1,228 | 682 | 681 | 235 | 310 | 0 | 560 | 460 | 99 | 59 | 39 | 616 | 1,228 | 0 | 4 | 308 | 0 | 0 | 
| app_proof | prover | 1 | 640,057,356 | 2,283 | 610 | 0 | 0 | 1,231 | 675 | 675 | 247 | 308 | 0 | 440 | 344 | 96 | 58 | 38 | 610 | 1,231 | 0 | 5 | 307 | 0 | 0 | 
| app_proof | prover | 2 | 640,057,356 | 2,291 | 611 | 0 | 0 | 1,235 | 679 | 679 | 245 | 309 | 0 | 444 | 345 | 99 | 60 | 39 | 611 | 1,235 | 0 | 5 | 308 | 0 | 0 | 
| app_proof | prover | 3 | 640,057,588 | 2,283 | 615 | 0 | 0 | 1,222 | 670 | 669 | 242 | 309 | 0 | 445 | 347 | 97 | 59 | 38 | 615 | 1,222 | 0 | 5 | 308 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 65 | 2,704 | 65 | 135 | 5,529,436,044 | 2,165,730,336 | 7,695,166,380 | 2,097,152 | 0 | 3 | 99 | 2,851,000 | 32.58 | 
| app_proof | 1 | 57 | 2,600 | 57 | 41 | 5,529,347,520 | 2,165,557,968 | 7,694,905,488 | 2,097,152 | 0 | 1 | 217 | 2,851,000 | 35.76 | 
| app_proof | 2 | 57 | 2,574 | 57 | 41 | 5,529,349,296 | 2,165,556,192 | 7,694,905,488 | 2,097,152 | 0 | 1 | 183 | 2,851,000 | 35.99 | 
| app_proof | 3 | 54 | 2,553 | 54 | 41 | 5,077,435,956 | 2,617,472,316 | 7,694,908,272 | 2,097,152 | 0 | 1 | 174 | 2,614,961 | 35.85 | 

...
|:---|---:|---:|
| Total | <span style='color: red'>(+0 [+1.6%])</span> 1.54 | <span style='color: green'>(-0 [-0.4%])</span> 0.91 |
| pairing | <span style='color: red'>(+0 [+2.1%])</span> 1.47 | <span style='color: red'>(+0 [+0.2%])</span> 0.85 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+15 [+2.1%])</span> 737 | <span style='color: red'>(+30 [+2.1%])</span> 1,474 | <span style='color: red'>(+2 [+0.2%])</span> 846 | <span style='color: red'>(+28 [+4.7%])</span> 628 |
...
| `execute_metered_insn_mi/s` | <span style='color: red'>(+2 [+8.6%])</span> 27.37 | -          | <span style='color: red'>(+2 [+8.6%])</span> 27.37 | <span style='color: red'>(+2 [+8.6%])</span> 27.37 |
| `execute_preflight_insns` |  872,871 |  1,745,742 |  1,149,000 |  596,742 |
| `execute_preflight_time_ms` | <span style='color: green'>(-2 [-1.8%])</span> 82 | <span style='color: green'>(-3 [-1.8%])</span> 164 | <span style='color: green'>(-4 [-3.7%])</span> 104 | <span style='color: red'>(+1 [+1.7%])</span> 60 |
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+0 [+0.7%])</span> 14.76 | -          | <span style='color: green'>(-0 [-1.3%])</span> 18.16 | <span style='color: red'>(+0 [+4.2%])</span> 11.35 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+5 [+2.7%])</span> 191 | <span style='color: red'>(+10 [+2.7%])</span> 382 | <span style='color: red'>(+3 [+1.6%])</span> 195 | <span style='color: red'>(+7 [+3.9%])</span> 187 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+12 [+3.3%])</span> 358 | <span style='color: red'>(+23 [+3.3%])</span> 716 | <span style='color: green'>(-1 [-0.3%])</span> 385 | <span style='color: red'>(+24 [+7.8%])</span> 331 |
...
| `generate_perm_trace_time_ms` | <span style='color: red'>(+1 [+3.1%])</span> 33.50 | <span style='color: red'>(+2 [+3.1%])</span> 67 |  36 | <span style='color: red'>(+2 [+6.9%])</span> 31 |
| `perm_trace_commit_time_ms` | <span style='color: green'>(-0 [-0.4%])</span> 76.69 | <span style='color: green'>(-1 [-0.4%])</span> 153.39 | <span style='color: green'>(-0 [-0.3%])</span> 89.02 | <span style='color: green'>(-0 [-0.6%])</span> 64.37 |
| `quotient_poly_compute_time_ms` |  82.84 |  165.68 | <span style='color: green'>(-2 [-1.8%])</span> 90.24 | <span style='color: red'>(+2 [+2.3%])</span> 75.44 |
| `quotient_poly_commit_time_ms` | <span style='color: green'>(-1 [-2.9%])</span> 17.13 | <span style='color: green'>(-1 [-2.9%])</span> 34.25 | <span style='color: green'>(-0 [-2.1%])</span> 19.40 | <span style='color: green'>(-1 [-4.0%])</span> 14.86 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+10 [+15.6%])</span> 78 | <span style='color: red'>(+21 [+15.6%])</span> 156 | <span style='color: red'>(+17 [+24.6%])</span> 86 | <span style='color: red'>(+4 [+6.1%])</span> 70 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 628 | 1 | 63 | 1,745,742 | 27.37 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 187 | 846 | 32,480,114 | 172,558,444 | 187 | 385 | 0 | 90.24 | 19.40 | 7 | 89.02 | 70 | 128 | 69 | 1 | 75 | 15,909,408 | 36 | 104 | 1,149,000 | 11.35 | 26 | 110 | 1 | 69 | 
| pairing | 1 | 195 | 628 | 22,464,232 | 119,958,502 | 195 | 331 | 1 | 75.44 | 14.86 | 6 | 64.37 | 86 | 98 | 86 | 0 | 55 | 9,498,894 | 31 | 60 | 596,742 | 18.16 | 21 | 90 | 1 | 86 | 

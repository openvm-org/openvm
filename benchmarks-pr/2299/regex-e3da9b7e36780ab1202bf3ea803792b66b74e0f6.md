...
|:---|---:|---:|
| Total | <span style='color: red'>(+0 [+2.5%])</span> 2.43 | <span style='color: red'>(+0 [+8.1%])</span> 0.81 |
| regex_program | <span style='color: red'>(+0 [+2.5%])</span> 2.40 | <span style='color: red'>(+0 [+8.4%])</span> 0.78 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+15 [+2.5%])</span> 599 | <span style='color: red'>(+59 [+2.5%])</span> 2,396 | <span style='color: red'>(+60 [+8.4%])</span> 775 | <span style='color: green'>(-2 [-0.4%])</span> 538 |
...
| `execute_metered_insn_mi/s` | <span style='color: green'>(-1 [-1.2%])</span> 111.73 | -          | <span style='color: green'>(-1 [-1.2%])</span> 111.73 | <span style='color: green'>(-1 [-1.2%])</span> 111.73 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` | <span style='color: red'>(+1 [+1.9%])</span> 53.25 | <span style='color: red'>(+4 [+1.9%])</span> 213 | <span style='color: red'>(+2 [+3.2%])</span> 65 |  44 |
| `execute_preflight_insn_mi/s` | <span style='color: green'>(-1 [-1.9%])</span> 31.57 | -          | <span style='color: green'>(-1 [-1.7%])</span> 32.73 | <span style='color: green'>(-0 [-0.9%])</span> 28.82 |
| `trace_gen_time_ms   ` | <span style='color: green'>(-2 [-1.3%])</span> 177 | <span style='color: green'>(-9 [-1.3%])</span> 708 | <span style='color: green'>(-2 [-1.0%])</span> 208 | <span style='color: green'>(-3 [-1.9%])</span> 155 |
| `memory_finalize_time_ms` |  1 |  4 |  4 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+15 [+5.5%])</span> 294.50 | <span style='color: red'>(+61 [+5.5%])</span> 1,178 | <span style='color: red'>(+59 [+20.3%])</span> 350 | <span style='color: red'>(+4 [+1.5%])</span> 273 |
| `main_trace_commit_time_ms` | <span style='color: green'>(-0 [-1.0%])</span> 51.25 | <span style='color: green'>(-2 [-1.0%])</span> 205 | <span style='color: red'>(+1 [+1.8%])</span> 57 |  49 |
| `generate_perm_trace_time_ms` | <span style='color: red'>(+9 [+35.2%])</span> 35.50 | <span style='color: red'>(+37 [+35.2%])</span> 142 | <span style='color: red'>(+20 [+55.6%])</span> 56 | <span style='color: red'>(+2 [+10.5%])</span> 21 |
| `perm_trace_commit_time_ms` | <span style='color: green'>(-1 [-1.1%])</span> 63.81 | <span style='color: green'>(-3 [-1.1%])</span> 255.25 | <span style='color: green'>(-1 [-2.0%])</span> 70.29 | <span style='color: green'>(-1 [-1.0%])</span> 54.58 |
| `quotient_poly_compute_time_ms` | <span style='color: green'>(-1 [-1.1%])</span> 58.65 | <span style='color: green'>(-3 [-1.1%])</span> 234.60 | <span style='color: red'>(+2 [+2.8%])</span> 72.03 | <span style='color: green'>(-5 [-9.9%])</span> 47.80 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+0 [+2.2%])</span> 16.08 | <span style='color: red'>(+1 [+2.2%])</span> 64.31 | <span style='color: red'>(+1 [+5.6%])</span> 18.51 | <span style='color: red'>(+0 [+3.4%])</span> 13.53 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+7 [+12.4%])</span> 65.75 | <span style='color: red'>(+29 [+12.4%])</span> 263 | <span style='color: red'>(+22 [+35.5%])</span> 84 | <span style='color: red'>(+3 [+5.6%])</span> 57 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 543 | 1 | 37 | 4,137,502 | 111.73 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 208 | 775 | 23,446,148 | 150,778,428 | 208 | 350 | 0 | 61.23 | 18.51 | 5 | 70.29 | 84 | 127 | 83 | 4 | 57 | 10,899,170 | 56 | 46 | 1,103,000 | 28.82 | 22 | 80 | 1 | 83 | 
| regex_program | 1 | 155 | 538 | 11,598,276 | 128,513,066 | 155 | 276 | 1 | 47.80 | 15.97 | 4 | 64.65 | 59 | 102 | 59 | 0 | 49 | 2,196,106 | 37 | 65 | 1,104,000 | 32.23 | 17 | 64 | 0 | 59 | 
| regex_program | 2 | 161 | 540 | 11,579,064 | 128,513,066 | 161 | 279 | 1 | 53.55 | 16.30 | 4 | 65.73 | 63 | 94 | 63 | 0 | 50 | 2,177,334 | 28 | 58 | 1,104,000 | 32.50 | 17 | 70 | 0 | 63 | 
| regex_program | 3 | 184 | 543 | 11,853,872 | 103,456,394 | 184 | 273 | 0 | 72.03 | 13.53 | 5 | 54.58 | 57 | 78 | 57 | 0 | 49 | 2,422,606 | 21 | 44 | 826,502 | 32.73 | 19 | 86 | 1 | 57 | 

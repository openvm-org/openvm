...
|:---|---:|---:|
| Total | <span style='color: red'>(+0 [+0.3%])</span> 1.52 | <span style='color: green'>(-0 [-0.3%])</span> 0.91 |
| pairing | <span style='color: red'>(+0 [+0.7%])</span> 1.45 | <span style='color: red'>(+0 [+0.4%])</span> 0.85 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+5 [+0.7%])</span> 727 | <span style='color: red'>(+10 [+0.7%])</span> 1,454 | <span style='color: red'>(+3 [+0.4%])</span> 847 | <span style='color: red'>(+7 [+1.2%])</span> 607 |
| `main_cells_used     ` |  12,704,151 |  25,408,302 |  15,909,408 |  9,498,894 |
| `total_cells_used    ` |  27,472,173 |  54,944,346 |  32,480,114 |  22,464,232 |
| `execute_metered_time_ms` | <span style='color: green'>(-6 [-8.7%])</span> 63 | -          | -          | -          |
| `execute_metered_insn_mi/s` | <span style='color: red'>(+2 [+9.6%])</span> 27.63 | -          | <span style='color: red'>(+2 [+9.6%])</span> 27.63 | <span style='color: red'>(+2 [+9.6%])</span> 27.63 |
| `execute_preflight_insns` |  872,871 |  1,745,742 |  1,149,000 |  596,742 |
| `execute_preflight_time_ms` | <span style='color: green'>(-1 [-1.2%])</span> 82.50 | <span style='color: green'>(-2 [-1.2%])</span> 165 | <span style='color: green'>(-3 [-2.8%])</span> 105 | <span style='color: red'>(+1 [+1.7%])</span> 60 |
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+0 [+0.2%])</span> 14.67 | -          | <span style='color: green'>(-0 [-1.9%])</span> 18.06 | <span style='color: red'>(+0 [+3.6%])</span> 11.29 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+5 [+2.7%])</span> 191 | <span style='color: red'>(+10 [+2.7%])</span> 382 | <span style='color: red'>(+2 [+1.0%])</span> 194 | <span style='color: red'>(+8 [+4.4%])</span> 188 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+0 [+0.1%])</span> 347 | <span style='color: red'>(+1 [+0.1%])</span> 694 | <span style='color: green'>(-3 [-0.8%])</span> 383 | <span style='color: red'>(+4 [+1.3%])</span> 311 |
| `main_trace_commit_time_ms` |  64 |  128 | <span style='color: green'>(-1 [-1.3%])</span> 74 | <span style='color: red'>(+1 [+1.9%])</span> 54 |
| `generate_perm_trace_time_ms` | <span style='color: red'>(+0 [+1.5%])</span> 33 | <span style='color: red'>(+1 [+1.5%])</span> 66 |  36 | <span style='color: red'>(+1 [+3.4%])</span> 30 |
| `perm_trace_commit_time_ms` | <span style='color: green'>(-1 [-1.0%])</span> 76.23 | <span style='color: green'>(-2 [-1.0%])</span> 152.46 | <span style='color: green'>(-1 [-1.1%])</span> 88.31 | <span style='color: green'>(-1 [-0.9%])</span> 64.15 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+1 [+0.9%])</span> 83.56 | <span style='color: red'>(+2 [+0.9%])</span> 167.13 | <span style='color: green'>(-0 [-0.5%])</span> 91.37 | <span style='color: red'>(+2 [+2.7%])</span> 75.75 |
| `quotient_poly_commit_time_ms` | <span style='color: green'>(-0 [-1.9%])</span> 17.30 | <span style='color: green'>(-1 [-1.9%])</span> 34.60 | <span style='color: green'>(-0 [-1.4%])</span> 19.54 | <span style='color: green'>(-0 [-2.7%])</span> 15.06 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+1 [+1.5%])</span> 68.50 | <span style='color: red'>(+2 [+1.5%])</span> 137 | <span style='color: red'>(+1 [+1.4%])</span> 70 | <span style='color: red'>(+1 [+1.5%])</span> 67 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 607 | 1 | 63 | 1,745,742 | 27.63 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 188 | 847 | 32,480,114 | 172,558,444 | 188 | 383 | 0 | 91.37 | 19.54 | 6 | 88.31 | 70 | 126 | 70 | 1 | 74 | 15,909,408 | 36 | 105 | 1,149,000 | 11.29 | 27 | 111 | 1 | 70 | 
| pairing | 1 | 194 | 607 | 22,464,232 | 119,958,502 | 194 | 311 | 1 | 75.75 | 15.06 | 6 | 64.15 | 67 | 98 | 66 | 0 | 54 | 9,498,894 | 30 | 60 | 596,742 | 18.06 | 21 | 91 | 1 | 66 | 

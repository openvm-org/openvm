...
|:---|---:|---:|
| Total | <span style='color: red'>(+0 [+1.1%])</span> 1.53 | <span style='color: red'>(+0 [+0.7%])</span> 0.92 |
| pairing | <span style='color: red'>(+0 [+1.6%])</span> 1.47 | <span style='color: red'>(+0 [+1.4%])</span> 0.86 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+12 [+1.6%])</span> 733.50 | <span style='color: red'>(+23 [+1.6%])</span> 1,467 | <span style='color: red'>(+12 [+1.4%])</span> 856 | <span style='color: red'>(+11 [+1.8%])</span> 611 |
...
| `execute_metered_insn_mi/s` | <span style='color: red'>(+2 [+8.2%])</span> 27.28 | -          | <span style='color: red'>(+2 [+8.2%])</span> 27.28 | <span style='color: red'>(+2 [+8.2%])</span> 27.28 |
| `execute_preflight_insns` |  872,871 |  1,745,742 |  1,149,000 |  596,742 |
| `execute_preflight_time_ms` | <span style='color: green'>(-1 [-1.2%])</span> 82.50 | <span style='color: green'>(-2 [-1.2%])</span> 165 | <span style='color: green'>(-4 [-3.7%])</span> 104 | <span style='color: red'>(+2 [+3.4%])</span> 61 |
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+0 [+1.5%])</span> 14.87 | -          | <span style='color: green'>(-0 [-0.2%])</span> 18.36 | <span style='color: red'>(+0 [+4.3%])</span> 11.37 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+6 [+3.0%])</span> 191.50 | <span style='color: red'>(+11 [+3.0%])</span> 383 | <span style='color: red'>(+2 [+1.0%])</span> 194 | <span style='color: red'>(+9 [+5.0%])</span> 189 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+6 [+1.7%])</span> 352.50 | <span style='color: red'>(+12 [+1.7%])</span> 705 | <span style='color: red'>(+5 [+1.3%])</span> 391 | <span style='color: red'>(+7 [+2.3%])</span> 314 |
| `main_trace_commit_time_ms` | <span style='color: red'>(+1 [+1.6%])</span> 65 | <span style='color: red'>(+2 [+1.6%])</span> 130 | <span style='color: red'>(+1 [+1.3%])</span> 76 | <span style='color: red'>(+1 [+1.9%])</span> 54 |
| `generate_perm_trace_time_ms` | <span style='color: red'>(+2 [+4.6%])</span> 34 | <span style='color: red'>(+3 [+4.6%])</span> 68 | <span style='color: red'>(+1 [+2.8%])</span> 37 | <span style='color: red'>(+2 [+6.9%])</span> 31 |
| `perm_trace_commit_time_ms` | <span style='color: red'>(+0 [+0.2%])</span> 77.18 | <span style='color: red'>(+0 [+0.2%])</span> 154.35 | <span style='color: red'>(+0 [+0.3%])</span> 89.57 |  64.78 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+2 [+2.4%])</span> 84.77 | <span style='color: red'>(+4 [+2.4%])</span> 169.54 | <span style='color: red'>(+2 [+1.8%])</span> 93.47 | <span style='color: red'>(+2 [+3.2%])</span> 76.07 |
| `quotient_poly_commit_time_ms` | <span style='color: green'>(-0 [-0.8%])</span> 17.51 | <span style='color: green'>(-0 [-0.8%])</span> 35.01 | <span style='color: red'>(+0 [+1.3%])</span> 20.07 | <span style='color: green'>(-1 [-3.4%])</span> 14.94 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+2 [+2.2%])</span> 69 | <span style='color: red'>(+3 [+2.2%])</span> 138 | <span style='color: red'>(+1 [+1.4%])</span> 70 | <span style='color: red'>(+2 [+3.0%])</span> 68 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 611 | 1 | 63 | 1,745,742 | 27.28 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 189 | 856 | 32,480,114 | 172,558,444 | 189 | 391 | 0 | 93.47 | 20.07 | 6 | 89.57 | 70 | 129 | 70 | 1 | 76 | 15,909,408 | 37 | 104 | 1,149,000 | 11.37 | 27 | 114 | 1 | 70 | 
| pairing | 1 | 194 | 611 | 22,464,232 | 119,958,502 | 194 | 314 | 1 | 76.07 | 14.94 | 6 | 64.78 | 68 | 99 | 67 | 0 | 54 | 9,498,894 | 31 | 61 | 596,742 | 18.36 | 21 | 91 | 1 | 67 | 

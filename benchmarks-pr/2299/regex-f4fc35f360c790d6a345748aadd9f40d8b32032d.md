...
|:---|---:|---:|
| Total | <span style='color: red'>(+0 [+2.2%])</span> 2.43 | <span style='color: red'>(+0 [+8.0%])</span> 0.81 |
| regex_program | <span style='color: red'>(+0 [+2.3%])</span> 2.39 | <span style='color: red'>(+0 [+8.4%])</span> 0.78 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+13 [+2.3%])</span> 597.50 | <span style='color: red'>(+53 [+2.3%])</span> 2,390 | <span style='color: red'>(+60 [+8.4%])</span> 775 | <span style='color: green'>(-3 [-0.6%])</span> 537 |
...
| `execute_metered_insn_mi/s` | <span style='color: red'>(+0 [+0.3%])</span> 113.47 | -          | <span style='color: red'>(+0 [+0.3%])</span> 113.47 | <span style='color: red'>(+0 [+0.3%])</span> 113.47 |
...
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+0 [+0.1%])</span> 32.21 | -          | <span style='color: red'>(+0 [+0.4%])</span> 33.42 | <span style='color: red'>(+0 [+0.8%])</span> 29.34 |
| `trace_gen_time_ms   ` | <span style='color: green'>(-1 [-0.7%])</span> 178 | <span style='color: green'>(-5 [-0.7%])</span> 712 | <span style='color: red'>(+1 [+0.5%])</span> 211 | <span style='color: green'>(-3 [-1.9%])</span> 155 |
| `memory_finalize_time_ms` |  1 |  4 |  4 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+13 [+4.7%])</span> 292.25 | <span style='color: red'>(+52 [+4.7%])</span> 1,169 | <span style='color: red'>(+57 [+19.6%])</span> 348 | <span style='color: green'>(-1 [-0.4%])</span> 268 |
| `main_trace_commit_time_ms` | <span style='color: green'>(-0 [-1.0%])</span> 51.25 | <span style='color: green'>(-2 [-1.0%])</span> 205 |  56 |  49 |
| `generate_perm_trace_time_ms` | <span style='color: red'>(+10 [+40.0%])</span> 36.75 | <span style='color: red'>(+42 [+40.0%])</span> 147 | <span style='color: red'>(+20 [+55.6%])</span> 56 | <span style='color: red'>(+3 [+15.8%])</span> 22 |
| `perm_trace_commit_time_ms` | <span style='color: green'>(-0 [-0.6%])</span> 64.12 | <span style='color: green'>(-1 [-0.6%])</span> 256.46 | <span style='color: green'>(-2 [-2.8%])</span> 69.71 | <span style='color: red'>(+0 [+0.9%])</span> 55.63 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+0 [+0.7%])</span> 59.69 | <span style='color: red'>(+2 [+0.7%])</span> 238.78 | <span style='color: green'>(-0 [-0.7%])</span> 69.60 | <span style='color: green'>(-0 [-0.6%])</span> 52.75 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+0 [+2.4%])</span> 16.10 | <span style='color: red'>(+1 [+2.4%])</span> 64.40 | <span style='color: red'>(+1 [+6.2%])</span> 18.62 | <span style='color: red'>(+1 [+7.1%])</span> 14.02 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+3 [+5.6%])</span> 61.75 | <span style='color: red'>(+13 [+5.6%])</span> 247 | <span style='color: red'>(+21 [+33.9%])</span> 83 | <span style='color: green'>(-4 [-7.4%])</span> 50 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 538 | 1 | 36 | 4,137,502 | 113.47 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 211 | 775 | 23,446,148 | 150,778,428 | 211 | 348 | 0 | 62.39 | 18.62 | 5 | 69.71 | 83 | 126 | 83 | 4 | 56 | 10,899,170 | 56 | 45 | 1,103,000 | 29.34 | 22 | 81 | 1 | 83 | 
| regex_program | 1 | 155 | 537 | 11,598,276 | 128,513,066 | 155 | 275 | 1 | 52.75 | 16.06 | 4 | 65.10 | 50 | 105 | 50 | 0 | 50 | 2,196,106 | 40 | 65 | 1,104,000 | 32.86 | 17 | 69 | 0 | 50 | 
| regex_program | 2 | 163 | 540 | 11,579,064 | 128,513,066 | 163 | 278 | 1 | 54.04 | 15.70 | 4 | 66.02 | 62 | 95 | 61 | 0 | 49 | 2,177,334 | 29 | 57 | 1,104,000 | 33.42 | 16 | 70 | 0 | 61 | 
| regex_program | 3 | 183 | 538 | 11,853,872 | 103,456,394 | 183 | 268 | 0 | 69.60 | 14.02 | 5 | 55.63 | 52 | 80 | 52 | 0 | 50 | 2,422,606 | 22 | 44 | 826,502 | 33.22 | 19 | 84 | 1 | 52 | 

...
|:---|---:|---:|
| Total | <span style='color: red'>(+0 [+0.5%])</span> 1.52 | <span style='color: red'>(+0 [+0.1%])</span> 0.91 |
| pairing | <span style='color: red'>(+0 [+0.8%])</span> 1.46 | <span style='color: red'>(+0 [+0.6%])</span> 0.85 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+6 [+0.8%])</span> 728 | <span style='color: red'>(+12 [+0.8%])</span> 1,456 | <span style='color: red'>(+5 [+0.6%])</span> 849 | <span style='color: red'>(+7 [+1.2%])</span> 607 |
| `main_cells_used     ` |  12,704,151 |  25,408,302 |  15,909,408 |  9,498,894 |
| `total_cells_used    ` |  27,472,173 |  54,944,346 |  32,480,114 |  22,464,232 |
| `execute_metered_time_ms` | <span style='color: green'>(-4 [-5.8%])</span> 65 | -          | -          | -          |
| `execute_metered_insn_mi/s` | <span style='color: red'>(+1 [+5.1%])</span> 26.50 | -          | <span style='color: red'>(+1 [+5.1%])</span> 26.50 | <span style='color: red'>(+1 [+5.1%])</span> 26.50 |
...
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+0 [+1.4%])</span> 14.86 | -          | <span style='color: green'>(-0 [-0.5%])</span> 18.32 | <span style='color: red'>(+1 [+4.6%])</span> 11.40 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+6 [+3.2%])</span> 192 | <span style='color: red'>(+12 [+3.2%])</span> 384 | <span style='color: red'>(+4 [+2.1%])</span> 196 | <span style='color: red'>(+8 [+4.4%])</span> 188 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+2 [+0.6%])</span> 348.50 | <span style='color: red'>(+4 [+0.6%])</span> 697 | <span style='color: red'>(+1 [+0.3%])</span> 387 | <span style='color: red'>(+3 [+1.0%])</span> 310 |
| `main_trace_commit_time_ms` | <span style='color: red'>(+0 [+0.8%])</span> 64.50 | <span style='color: red'>(+1 [+0.8%])</span> 129 |  75 | <span style='color: red'>(+1 [+1.9%])</span> 54 |
...
| `perm_trace_commit_time_ms` | <span style='color: green'>(-0 [-0.3%])</span> 76.77 | <span style='color: green'>(-1 [-0.3%])</span> 153.55 | <span style='color: red'>(+0 [+0.2%])</span> 89.49 | <span style='color: green'>(-1 [-1.1%])</span> 64.06 |
| `quotient_poly_compute_time_ms` | <span style='color: green'>(-0 [-0.3%])</span> 82.51 | <span style='color: green'>(-1 [-0.3%])</span> 165.03 | <span style='color: green'>(-1 [-0.7%])</span> 91.23 |  73.80 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+0 [+0.9%])</span> 17.79 | <span style='color: red'>(+0 [+0.9%])</span> 35.59 | <span style='color: green'>(-0 [-0.6%])</span> 19.70 | <span style='color: red'>(+0 [+2.7%])</span> 15.89 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+0 [+0.7%])</span> 68 | <span style='color: red'>(+1 [+0.7%])</span> 136 |  69 | <span style='color: red'>(+1 [+1.5%])</span> 67 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 607 | 1 | 65 | 1,745,742 | 26.50 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 188 | 849 | 32,480,114 | 172,558,444 | 188 | 387 | 0 | 91.23 | 19.70 | 6 | 89.49 | 69 | 130 | 69 | 1 | 75 | 15,909,408 | 37 | 104 | 1,149,000 | 11.40 | 27 | 111 | 1 | 69 | 
| pairing | 1 | 196 | 607 | 22,464,232 | 119,958,502 | 196 | 310 | 1 | 73.80 | 15.89 | 6 | 64.06 | 67 | 97 | 67 | 0 | 54 | 9,498,894 | 30 | 60 | 596,742 | 18.32 | 21 | 90 | 1 | 67 | 

...
|:---|---:|---:|
| Total | <span style='color: red'>(+0 [+0.7%])</span> 1.52 | <span style='color: green'>(-0 [-1.0%])</span> 0.90 |
| pairing | <span style='color: red'>(+0 [+1.1%])</span> 1.46 | <span style='color: green'>(-0 [-0.4%])</span> 0.84 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+8 [+1.1%])</span> 730 | <span style='color: red'>(+16 [+1.1%])</span> 1,460 | <span style='color: green'>(-3 [-0.4%])</span> 841 | <span style='color: red'>(+19 [+3.2%])</span> 619 |
...
| `execute_metered_insn_mi/s` | <span style='color: red'>(+2 [+8.9%])</span> 27.47 | -          | <span style='color: red'>(+2 [+8.9%])</span> 27.47 | <span style='color: red'>(+2 [+8.9%])</span> 27.47 |
...
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+0 [+1.3%])</span> 14.84 | -          | <span style='color: green'>(-0 [-0.4%])</span> 18.32 | <span style='color: red'>(+0 [+4.3%])</span> 11.36 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+2 [+0.8%])</span> 187.50 | <span style='color: red'>(+3 [+0.8%])</span> 375 | <span style='color: green'>(-1 [-0.5%])</span> 191 | <span style='color: red'>(+4 [+2.2%])</span> 184 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+8 [+2.5%])</span> 355 | <span style='color: red'>(+17 [+2.5%])</span> 710 | <span style='color: green'>(-3 [-0.8%])</span> 383 | <span style='color: red'>(+20 [+6.5%])</span> 327 |
...
| `perm_trace_commit_time_ms` | <span style='color: green'>(-0 [-0.4%])</span> 76.76 | <span style='color: green'>(-1 [-0.4%])</span> 153.51 | <span style='color: green'>(-1 [-0.8%])</span> 88.59 | <span style='color: red'>(+0 [+0.2%])</span> 64.92 |
| `quotient_poly_compute_time_ms` |  82.75 |  165.50 | <span style='color: green'>(-0 [-0.4%])</span> 91.52 | <span style='color: red'>(+0 [+0.3%])</span> 73.98 |
| `quotient_poly_commit_time_ms` | <span style='color: green'>(-1 [-3.4%])</span> 17.04 | <span style='color: green'>(-1 [-3.4%])</span> 34.09 | <span style='color: green'>(-1 [-5.4%])</span> 18.74 | <span style='color: green'>(-0 [-0.8%])</span> 15.35 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+10 [+14.1%])</span> 77 | <span style='color: red'>(+19 [+14.1%])</span> 154 | <span style='color: red'>(+16 [+23.2%])</span> 85 | <span style='color: red'>(+3 [+4.5%])</span> 69 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 619 | 1 | 63 | 1,745,742 | 27.47 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 184 | 841 | 32,480,114 | 172,558,444 | 184 | 383 | 0 | 91.52 | 18.74 | 6 | 88.59 | 69 | 127 | 69 | 1 | 74 | 15,909,408 | 36 | 104 | 1,149,000 | 11.36 | 27 | 111 | 1 | 69 | 
| pairing | 1 | 191 | 619 | 22,464,232 | 119,958,502 | 191 | 327 | 1 | 73.98 | 15.35 | 6 | 64.92 | 85 | 97 | 85 | 0 | 53 | 9,498,894 | 29 | 59 | 596,742 | 18.32 | 20 | 89 | 1 | 85 | 

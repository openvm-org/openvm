...
| `total_proof_time_ms ` |  4,106.50 |  8,213 |  5,144 |  3,069 |
...
| `execute_preflight_time_ms` |  246 |  492 |  285 |  207 |
| `execute_preflight_insn_mi/s` |  37.38 | -          |  39.80 |  34.97 |
| `trace_gen_time_ms   ` |  122 |  244 |  172 |  72 |
| `set_initial_memory_time_ms` |  0 |  0 |  0 |  0 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  3,736.50 |  7,473 |  4,763 |  2,710 |
| `prover.main_trace_commit_time_ms` |  971 |  1,942 |  1,342 |  600 |
| `prover.rap_constraints_time_ms` |  2,045 |  4,090 |  2,518 |  1,572 |
| `prover.openings_time_ms` |  720 |  1,440 |  902 |  538 |
| `prover.rap_constraints.logup_gkr_time_ms` |  568 |  1,136 |  607 |  529 |
| `prover.rap_constraints.round0_time_ms` |  1,086 |  2,172 |  1,406 |  766 |
| `prover.rap_constraints.mle_rounds_time_ms` |  389 |  778 |  503 |  275 |
...
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  64.50 |  129 |  81 |  48 |
| `prover.openings.whir_time_ms` |  550 |  1,100 |  684 |  416 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/80607f2ca987e48d3dd133347647475c8d14cd76/sha2_bench-80607f2ca987e48d3dd133347647475c8d14cd76.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 70 |  |  |  | 346 |  |  |  |  |  |  | 
| app_proof |  |  |  | 3,069 |  | 88 | 11,167,961 | 126.07 | 0 | 8,307 |  | 
...
| leaf | 0 | 110 | 1,027 | 110 | 34 | 17 | 2 | 7 | 7 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 327 | 119 | 0 | 0 | 108 | 35 | 34 | 52 | 21 | 0 | 98 | 84 | 13 | 3 | 9 | 119 | 119 | 108 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 169 | 48 | 0 | 0 | 68 | 25 | 24 | 28 | 14 | 0 | 52 | 43 | 8 | 1 | 6 | 48 | 48 | 68 | 0 | 3 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 148 | 32 | 0 | 0 | 63 | 24 | 23 | 24 | 14 | 0 | 52 | 44 | 7 | 1 | 5 | 33 | 32 | 63 | 0 | 3 | 13 | 0 | 0 | 
| leaf | 0 | prover | 237,929,016 | 916 | 382 | 0 | 0 | 233 | 113 | 112 | 69 | 50 | 0 | 300 | 262 | 38 | 20 | 17 | 382 | 382 | 233 | 0 | 13 | 50 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,286,242,554 | 4,763 | 1,342 | 0 | 0 | 2,518 | 1,406 | 1,406 | 503 | 607 | 0 | 902 | 684 | 217 | 136 | 81 | 1,342 | 1,342 | 2,518 | 0 | 8 | 606 | 0 | 0 | 
| app_proof | prover | 1 | 750,289,144 | 2,710 | 599 | 0 | 0 | 1,572 | 766 | 766 | 275 | 529 | 0 | 538 | 416 | 121 | 73 | 48 | 600 | 599 | 1,572 | 0 | 8 | 528 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 0 | 1 | 172 | 5,144 | 172 | 0 | 13,306,647,852 | 2,134,713,996 | 15,441,361,848 | 2,097,152 | 0 | 4 | 207 | 7,124,000 | 34.97 | 
| app_proof | 1 | 0 | 1 | 72 | 3,069 | 72 | 0 | 7,584,540,132 | 1,503,573,469 | 9,088,113,601 | 2,097,152 | 0 | 2 | 285 | 4,043,961 | 39.80 | 

...
|:---|---:|---:|
| Total | <span style='color: red'>(+0 [+3.1%])</span> 1.60 | <span style='color: red'>(+0 [+8.2%])</span> 1 |
| pairing | <span style='color: red'>(+0 [+3.3%])</span> 1.51 | <span style='color: red'>(+0 [+9.1%])</span> 0.91 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+24 [+3.3%])</span> 754.50 | <span style='color: red'>(+48 [+3.3%])</span> 1,509 | <span style='color: red'>(+76 [+9.1%])</span> 912 | <span style='color: green'>(-28 [-4.5%])</span> 597 |
...
| `execute_metered_insn_mi/s` | <span style='color: green'>(-0 [-0.4%])</span> 19.45 | -          | <span style='color: green'>(-0 [-0.4%])</span> 19.45 | <span style='color: green'>(-0 [-0.4%])</span> 19.45 |
| `execute_preflight_insns` |  872,871 |  1,745,742 |  1,157,000 |  588,742 |
| `execute_preflight_time_ms` | <span style='color: red'>(+1 [+1.1%])</span> 96 | <span style='color: red'>(+2 [+1.1%])</span> 192 | <span style='color: green'>(-1 [-0.8%])</span> 129 | <span style='color: red'>(+3 [+5.0%])</span> 63 |
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+0 [+1.0%])</span> 13.76 | -          | <span style='color: red'>(+0 [+0.9%])</span> 18.28 | <span style='color: red'>(+0 [+1.3%])</span> 9.24 |
| `trace_gen_time_ms   ` | <span style='color: green'>(-0 [-0.3%])</span> 177 | <span style='color: green'>(-1 [-0.3%])</span> 354 | <span style='color: green'>(-2 [-1.0%])</span> 192 | <span style='color: red'>(+1 [+0.6%])</span> 162 |
...
| `stark_prove_excluding_trace_time_ms` | <span style='color: green'>(-20 [-5.6%])</span> 342.50 | <span style='color: green'>(-41 [-5.6%])</span> 685 | <span style='color: green'>(-13 [-3.3%])</span> 384 | <span style='color: green'>(-28 [-8.5%])</span> 301 |
| `main_trace_commit_time_ms` | <span style='color: red'>(+1 [+1.6%])</span> 65 | <span style='color: red'>(+2 [+1.6%])</span> 130 | <span style='color: red'>(+2 [+2.7%])</span> 76 |  54 |
| `generate_perm_trace_time_ms` | <span style='color: green'>(-6 [-14.1%])</span> 39.50 | <span style='color: green'>(-13 [-14.1%])</span> 79 | <span style='color: green'>(-4 [-8.5%])</span> 43 | <span style='color: green'>(-9 [-20.0%])</span> 36 |
| `perm_trace_commit_time_ms` | <span style='color: green'>(-2 [-2.5%])</span> 74.52 | <span style='color: green'>(-4 [-2.5%])</span> 149.05 | <span style='color: green'>(-4 [-4.3%])</span> 84.89 |  64.16 |
| `quotient_poly_compute_time_ms` | <span style='color: green'>(-1 [-1.3%])</span> 77.97 | <span style='color: green'>(-2 [-1.3%])</span> 155.95 | <span style='color: green'>(-2 [-1.8%])</span> 85.72 | <span style='color: green'>(-1 [-0.8%])</span> 70.23 |
| `quotient_poly_commit_time_ms` | <span style='color: green'>(-0 [-2.0%])</span> 16.21 | <span style='color: green'>(-1 [-2.0%])</span> 32.43 | <span style='color: green'>(-1 [-3.6%])</span> 18.02 |  14.40 |
| `pcs_opening_time_ms ` | <span style='color: green'>(-12 [-15.8%])</span> 64 | <span style='color: green'>(-24 [-15.8%])</span> 128 | <span style='color: green'>(-5 [-6.6%])</span> 71 | <span style='color: green'>(-19 [-25.0%])</span> 57 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 597 | 41 | 1 | 89 | 1,745,742 | 19.45 | 146 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 162 | 912 | 32,689,110 | 172,558,444 | 162 | 384 | 0 | 85.72 | 18.02 | 7 | 84.89 | 71 | 131 | 71 | 0 | 76 | 16,059,916 | 43 | 129 | 1,157,000 | 9.24 | 27 | 104 | 1 | 71 | 
| pairing | 1 | 192 | 597 | 22,314,288 | 119,958,502 | 192 | 301 | 1 | 70.23 | 14.40 | 6 | 64.16 | 57 | 103 | 57 | 0 | 54 | 9,408,294 | 36 | 63 | 588,742 | 18.28 | 20 | 85 | 1 | 57 | 

...
|:---|---:|---:|---:|
| Total |  4.42 |  2.30 |  2.30 |
| app_proof |  3.09 |  0.97 |  0.97 |
| leaf |  0.67 |  0.67 |  0.67 |
...
| `total_proof_time_ms ` |  755 |  3,020 |  906 |  546 |
| `execute_metered_time_ms` |  67 | -          | -          | -          |
| `execute_metered_insns` |  12,000,265 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  178.89 | -          |  178.89 |  178.89 |
| `execute_preflight_insns` |  3,000,066.25 |  12,000,265 |  3,495,000 |  1,515,265 |
| `execute_preflight_time_ms` |  81.25 |  325 |  100 |  42 |
| `execute_preflight_insn_mi/s` |  50.43 | -          |  51.57 |  47.29 |
| `trace_gen_time_ms   ` |  138.25 |  553 |  171 |  121 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  465 |  1,860 |  527 |  291 |
| `prover.main_trace_commit_time_ms` |  97 |  388 |  110 |  58 |
| `prover.rap_constraints_time_ms` |  267.50 |  1,070 |  303 |  166 |
| `prover.openings_time_ms` |  99.25 |  397 |  113 |  66 |
| `prover.rap_constraints.logup_gkr_time_ms` |  192.75 |  771 |  220 |  115 |
| `prover.rap_constraints.round0_time_ms` |  49.50 |  198 |  57 |  33 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/e16b82f410363dfe7413aac93e3be2b853837d99/fibonacci-e16b82f410363dfe7413aac93e3be2b853837d99.memory.svg)
...
| app_proof |  |  |  |  |  | 546 |  |  | 67 | 12,000,265 | 178.89 | 0 | 3,094 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 320 | 115 | 0 | 0 | 106 | 35 | 35 | 50 | 20 | 0 | 98 | 84 | 13 | 3 | 9 | 115 | 106 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 168 | 47 | 0 | 0 | 67 | 25 | 24 | 28 | 14 | 0 | 53 | 45 | 8 | 1 | 6 | 47 | 67 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 137 | 31 | 0 | 0 | 62 | 24 | 23 | 24 | 13 | 0 | 43 | 35 | 7 | 1 | 5 | 31 | 62 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 147,934,254 | 601 | 229 | 0 | 0 | 179 | 82 | 81 | 52 | 44 | 0 | 192 | 167 | 24 | 12 | 12 | 229 | 179 | 0 | 8 | 43 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 136,618,054 | 527 | 110 | 0 | 0 | 302 | 57 | 57 | 26 | 218 | 0 | 113 | 92 | 20 | 11 | 9 | 110 | 302 | 0 | 3 | 217 | 0 | 0 | 
| app_proof | prover | 1 | 136,570,716 | 525 | 110 | 0 | 0 | 303 | 55 | 55 | 26 | 220 | 0 | 111 | 89 | 21 | 11 | 9 | 110 | 303 | 0 | 3 | 219 | 0 | 0 | 
| app_proof | prover | 2 | 136,570,716 | 517 | 110 | 0 | 0 | 299 | 53 | 53 | 26 | 218 | 0 | 107 | 86 | 20 | 11 | 8 | 110 | 299 | 0 | 3 | 218 | 0 | 0 | 
| app_proof | prover | 3 | 70,295,004 | 291 | 58 | 0 | 0 | 166 | 33 | 32 | 17 | 115 | 0 | 66 | 54 | 12 | 6 | 6 | 58 | 166 | 0 | 3 | 114 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 135 | 906 | 135 | 155 | 2,770,197,065 | 323,292,691 | 3,093,489,756 | 2,097,152 | 0 | 3 | 88 | 3,495,000 | 47.29 | 
| app_proof | 1 | 121 | 788 | 121 | 41 | 2,768,862,357 | 322,353,414 | 3,091,215,771 | 2,097,152 | 0 | 1 | 100 | 3,495,000 | 51.48 | 
| app_proof | 2 | 126 | 780 | 126 | 41 | 2,768,862,357 | 322,353,414 | 3,091,215,771 | 2,097,152 | 0 | 1 | 95 | 3,495,000 | 51.57 | 
| app_proof | 3 | 171 | 546 | 171 | 41 | 1,230,956,171 | 342,871,578 | 1,573,827,749 | 2,097,152 | 0 | 1 | 42 | 1,515,265 | 51.37 | 

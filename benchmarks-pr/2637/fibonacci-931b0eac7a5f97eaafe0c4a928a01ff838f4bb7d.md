...
|:---|---:|---:|---:|
| Total |  5.65 |  2.04 |  2.04 |
| app_proof |  3.97 |  0.76 |  0.76 |
| leaf |  0.97 |  0.56 |  0.56 |
...
| `total_proof_time_ms ` |  556.43 |  3,895 |  682 |  533 |
| `execute_metered_time_ms` |  73 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  163.02 | -          |  163.02 |  163.02 |
| `execute_preflight_insns` |  1,714,323.57 |  12,000,265 |  1,747,000 |  1,518,265 |
| `execute_preflight_time_ms` |  57.14 |  400 |  64 |  50 |
| `execute_preflight_insn_mi/s` |  41 | -          |  41.27 |  40.41 |
| `trace_gen_time_ms   ` |  162.29 |  1,136 |  169 |  159 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  276.14 |  1,933 |  285 |  272 |
| `prover.main_trace_commit_time_ms` |  60.14 |  421 |  61 |  60 |
| `prover.rap_constraints_time_ms` |  177.14 |  1,240 |  182 |  176 |
| `prover.openings_time_ms` |  38 |  266 |  42 |  34 |
| `prover.rap_constraints.logup_gkr_time_ms` |  127 |  889 |  128 |  126 |
| `prover.rap_constraints.round0_time_ms` |  29.57 |  207 |  33 |  28 |
| `prover.rap_constraints.mle_rounds_time_ms` |  19.29 |  135 |  20 |  19 |
| `prover.openings.stacked_reduction_time_ms` |  17.29 |  121 |  20 |  16 |
...
| `prover.openings.whir_time_ms` |  20 |  140 |  23 |  17 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  483 |  966 |  560 |  406 |
| `execute_preflight_time_ms` |  1 |  2 |  1 |  1 |
| `trace_gen_time_ms   ` |  47 |  94 |  60 |  34 |
| `generate_blob_total_time_ms` |  3.50 |  7 |  4 |  3 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  435 |  870 |  499 |  371 |
| `prover.main_trace_commit_time_ms` |  199.50 |  399 |  238 |  161 |
| `prover.rap_constraints_time_ms` |  167 |  334 |  187 |  147 |
| `prover.openings_time_ms` |  67 |  134 |  72 |  62 |
| `prover.rap_constraints.logup_gkr_time_ms` |  42.50 |  85 |  50 |  35 |
| `prover.rap_constraints.round0_time_ms` |  74 |  148 |  82 |  66 |
| `prover.rap_constraints.mle_rounds_time_ms` |  50 |  100 |  55 |  45 |
| `prover.openings.stacked_reduction_time_ms` |  36.50 |  73 |  40 |  33 |
...
| `prover.openings.whir_time_ms` |  30 |  60 |  32 |  28 |
...
| `prover.main_trace_commit_time_ms` |  163 |  163 |  163 |  163 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/931b0eac7a5f97eaafe0c4a928a01ff838f4bb7d/fibonacci-931b0eac7a5f97eaafe0c4a928a01ff838f4bb7d.memory.svg)
...
| app_proof |  |  |  |  |  | 537 |  |  | 73 | 12,000,265 | 163.02 | 0 | 3,978 |  | 
| internal_for_leaf |  |  |  | 392 |  |  |  |  |  |  |  |  |  | 392 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 26 | 392 | 26 | 10 | 2 | 2 | 0 | 0 | 
| internal_recursive.0 | 1 | 12 | 174 | 12 | 1 | 0 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 9 | 154 | 8 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 60 | 560 | 60 | 23 | 4 | 1 | 1 | 1 | 
| leaf | 1 | 34 | 406 | 34 | 17 | 3 | 1 | 1 | 1 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 75,533,952 | 365 | 163 | 0 | 9 | 148 | 39 | 39 | 75 | 33 | 0 | 53 | 20 | 32 | 5 | 27 | 163 | 148 | 0 | 2 | 32 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 23,651,975 | 162 | 49 | 0 | 4 | 71 | 23 | 23 | 28 | 18 | 0 | 41 | 17 | 24 | 1 | 22 | 49 | 71 | 0 | 2 | 17 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 17,507,975 | 144 | 34 | 0 | 4 | 66 | 22 | 21 | 24 | 19 | 0 | 42 | 19 | 22 | 1 | 21 | 35 | 66 | 0 | 2 | 17 | 0 | 0 | 
| leaf | 0 | prover | 187,180,090 | 499 | 238 | 0 | 15 | 187 | 82 | 81 | 55 | 50 | 0 | 72 | 32 | 40 | 12 | 27 | 238 | 187 | 0 | 5 | 49 | 0 | 0 | 
| leaf | 1 | prover | 130,615,306 | 371 | 161 | 0 | 10 | 147 | 66 | 65 | 45 | 35 | 0 | 62 | 28 | 33 | 8 | 25 | 161 | 147 | 0 | 5 | 34 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 212,425,530 | 285 | 60 | 0 | 2 | 182 | 33 | 33 | 20 | 128 | 0 | 42 | 21 | 20 | 6 | 13 | 61 | 182 | 0 | 3 | 127 | 0 | 0 | 
| app_proof | prover | 1 | 212,366,468 | 275 | 60 | 0 | 1 | 176 | 28 | 28 | 19 | 127 | 0 | 38 | 21 | 17 | 6 | 10 | 60 | 176 | 0 | 3 | 126 | 0 | 0 | 
| app_proof | prover | 2 | 212,366,468 | 277 | 59 | 0 | 1 | 176 | 29 | 29 | 19 | 126 | 0 | 40 | 23 | 17 | 6 | 10 | 60 | 176 | 0 | 3 | 126 | 0 | 0 | 
| app_proof | prover | 3 | 212,366,468 | 272 | 60 | 0 | 1 | 177 | 30 | 29 | 19 | 127 | 0 | 34 | 17 | 16 | 6 | 10 | 60 | 177 | 0 | 3 | 126 | 0 | 0 | 
| app_proof | prover | 4 | 212,366,468 | 272 | 60 | 0 | 1 | 176 | 29 | 29 | 19 | 127 | 0 | 35 | 18 | 16 | 6 | 10 | 60 | 176 | 0 | 3 | 126 | 0 | 0 | 
| app_proof | prover | 5 | 212,366,468 | 275 | 59 | 0 | 1 | 176 | 29 | 28 | 19 | 127 | 0 | 39 | 21 | 17 | 6 | 10 | 60 | 176 | 0 | 3 | 126 | 0 | 0 | 
| app_proof | prover | 6 | 212,423,724 | 277 | 60 | 0 | 1 | 177 | 29 | 29 | 20 | 127 | 0 | 38 | 19 | 18 | 6 | 12 | 60 | 177 | 0 | 3 | 126 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 159 | 682 | 159 | 173 | 0 | 147 | 64 | 1,747,000 | 40.41 | 
| app_proof | 1 | 160 | 535 | 160 | 41 | 0 | 150 | 58 | 1,747,000 | 41.27 | 
| app_proof | 2 | 161 | 538 | 161 | 41 | 0 | 152 | 57 | 1,747,000 | 41.19 | 
| app_proof | 3 | 162 | 533 | 162 | 41 | 0 | 153 | 57 | 1,747,000 | 41.08 | 
| app_proof | 4 | 162 | 533 | 162 | 41 | 0 | 152 | 57 | 1,747,000 | 41.14 | 
| app_proof | 5 | 163 | 537 | 163 | 41 | 0 | 154 | 57 | 1,747,000 | 41.27 | 
| app_proof | 6 | 169 | 537 | 169 | 41 | 0 | 160 | 50 | 1,518,265 | 40.64 | 

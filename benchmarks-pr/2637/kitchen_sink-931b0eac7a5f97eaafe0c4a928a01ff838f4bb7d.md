...
| `total_proof_time_ms ` |  1,184.50 |  2,369 |  1,415 |  954 |
...
| `execute_preflight_insn_mi/s` |  8.51 | -          |  11.21 |  5.82 |
| `trace_gen_time_ms   ` |  158.50 |  317 |  189 |  128 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  842.50 |  1,685 |  1,021 |  664 |
| `prover.main_trace_commit_time_ms` |  221.50 |  443 |  293 |  150 |
| `prover.rap_constraints_time_ms` |  558 |  1,116 |  653 |  463 |
| `prover.openings_time_ms` |  61.50 |  123 |  73 |  50 |
| `prover.rap_constraints.logup_gkr_time_ms` |  140.50 |  281 |  153 |  128 |
| `prover.rap_constraints.round0_time_ms` |  285 |  570 |  360 |  210 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/931b0eac7a5f97eaafe0c4a928a01ff838f4bb7d/kitchen_sink-931b0eac7a5f97eaafe0c4a928a01ff838f4bb7d.memory.svg)
...
| app_proof |  |  |  |  |  | 954 |  |  | 7 | 154,763 | 19.81 | 0 | 2,382 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 53,472,003 | 141 | 40 | 0 | 4 | 65 | 19 | 19 | 29 | 15 | 0 | 34 | 10 | 23 | 1 | 21 | 41 | 65 | 0 | 1 | 15 | 0 | 0 | 
...
| leaf | 0 | prover | 407,935,872 | 310 | 125 | 0 | 9 | 140 | 44 | 43 | 36 | 59 | 0 | 44 | 13 | 31 | 7 | 24 | 126 | 140 | 0 | 2 | 58 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 816,542,084 | 1,021 | 292 | 0 | 162 | 653 | 360 | 359 | 139 | 153 | 61 | 73 | 12 | 60 | 15 | 45 | 293 | 653 | 0 | 1 | 91 | 0 | 0 | 
| app_proof | prover | 1 | 800,298,548 | 664 | 150 | 0 | 20 | 463 | 210 | 209 | 125 | 128 | 74 | 50 | 13 | 37 | 14 | 22 | 150 | 463 | 0 | 1 | 53 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 189 | 1,415 | 189 | 184 | 0 | 50 | 19 | 121,000 | 11.21 | 
| app_proof | 1 | 128 | 954 | 128 | 40 | 0 | 3 | 120 | 33,763 | 5.82 | 

...
| `total_proof_time_ms ` |  1,183 |  2,366 |  1,408 |  958 |
| `execute_metered_time_ms` |  7 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  20.06 | -          |  20.06 |  20.06 |
| `execute_preflight_insns` |  77,381.50 |  154,763 |  121,000 |  33,763 |
| `execute_preflight_time_ms` |  71.50 |  143 |  123 |  20 |
| `execute_preflight_insn_mi/s` |  8.48 | -          |  11.15 |  5.82 |
| `trace_gen_time_ms   ` |  159 |  318 |  189 |  129 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  840 |  1,680 |  1,016 |  664 |
| `prover.main_trace_commit_time_ms` |  220.50 |  441 |  290 |  151 |
| `prover.rap_constraints_time_ms` |  557 |  1,114 |  652 |  462 |
| `prover.openings_time_ms` |  61.50 |  123 |  73 |  50 |
| `prover.rap_constraints.logup_gkr_time_ms` |  139.50 |  279 |  153 |  126 |
| `prover.rap_constraints.round0_time_ms` |  285.50 |  571 |  360 |  211 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/7fd4610fa7831c691de3403135fcf1ab95b80d0f/kitchen_sink-7fd4610fa7831c691de3403135fcf1ab95b80d0f.memory.svg)
...
| app_proof |  |  |  |  |  | 958 |  |  | 7 | 154,763 | 20.06 | 0 | 2,378 |  | 
...
| leaf | 0 | 105 | 414 | 105 | 25 | 11 | 18 | 5 | 5 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 53,472,003 | 139 | 40 | 0 | 4 | 64 | 19 | 18 | 29 | 15 | 0 | 33 | 10 | 23 | 1 | 21 | 41 | 64 | 0 | 1 | 14 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 23,651,975 | 101 | 19 | 0 | 3 | 50 | 16 | 16 | 20 | 13 | 0 | 31 | 9 | 21 | 1 | 20 | 19 | 50 | 0 | 1 | 12 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 17,507,975 | 93 | 14 | 0 | 4 | 48 | 16 | 16 | 18 | 13 | 0 | 29 | 8 | 21 | 0 | 20 | 14 | 48 | 0 | 1 | 12 | 0 | 0 | 
| leaf | 0 | prover | 407,935,872 | 309 | 124 | 0 | 9 | 140 | 44 | 43 | 36 | 59 | 0 | 43 | 12 | 31 | 7 | 23 | 124 | 140 | 0 | 2 | 59 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 816,542,084 | 1,016 | 289 | 0 | 160 | 652 | 360 | 358 | 138 | 153 | 60 | 73 | 13 | 60 | 15 | 44 | 290 | 652 | 0 | 1 | 92 | 0 | 0 | 
| app_proof | prover | 1 | 800,298,548 | 664 | 151 | 0 | 20 | 462 | 211 | 210 | 124 | 126 | 73 | 50 | 13 | 36 | 14 | 22 | 151 | 462 | 0 | 1 | 53 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 189 | 1,408 | 189 | 182 | 0 | 51 | 20 | 121,000 | 11.15 | 
| app_proof | 1 | 129 | 958 | 129 | 40 | 0 | 2 | 123 | 33,763 | 5.82 | 

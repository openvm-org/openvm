...
|:---|---:|---:|
| Total |  11.66 |  6.22 |
| regex_program |  11.39 |  5.96 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  5,696 |  11,392 |  5,955 |  5,437 |
...
| `execute_metered_insn_mi/s` |  15.49 | -          | -          | -          |
| `execute_e3_time_ms  ` |  190 |  380 |  207 |  173 |
| `execute_e3_insn_mi/s` |  10.92 | -          |  11.05 |  10.79 |
| `trace_gen_time_ms   ` |  2,911.50 |  5,823 |  2,931 |  2,892 |
| `memory_finalize_time_ms` |  2,361.50 |  4,723 |  2,450 |  2,273 |
| `boundary_finalize_time_ms` |  3 |  6 |  6 |  0 |
| `merkle_finalize_time_ms` |  2,111 |  4,222 |  2,190 |  2,032 |
| `stark_prove_excluding_trace_time_ms` |  2,594.50 |  5,189 |  2,817 |  2,372 |
| `main_trace_commit_time_ms` |  511.50 |  1,023 |  579 |  444 |
| `generate_perm_trace_time_ms` |  208.50 |  417 |  234 |  183 |
| `perm_trace_commit_time_ms` |  555.50 |  1,111 |  591 |  520 |
| `quotient_poly_compute_time_ms` |  261.50 |  523 |  287 |  236 |
| `quotient_poly_commit_time_ms` |  248 |  496 |  282 |  214 |
| `pcs_opening_time_ms ` |  801.50 |  1,603 |  839 |  764 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2 | 548 | 4,165,433 | 1 | 268 | 15.49 | 20 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 2,931 | 5,955 | 2,243,700 | 275,648,700 | 2,817 | 287 | 282 | 591 | 839 | 2,190 | 2,450 | 579 | 93,502,324 | 2,243,700 | 234 | 207 | 10.79 | 6 | 
| regex_program | 1 | 2,892 | 5,437 | 1,921,732 | 242,975,388 | 2,372 | 236 | 214 | 520 | 764 | 2,032 | 2,273 | 444 | 73,017,132 | 1,921,733 | 183 | 173 | 11.05 | 0 | 

...
|:---|---:|---:|---:|
| Total |  2.67 |  1.100 |  1.100 |
| app_proof |  1.94 |  1.27 |  1.27 |
| leaf |  0.42 |  0.42 |  0.42 |
...
| `total_proof_time_ms ` |  954 |  1,908 |  1,232 |  676 |
| `execute_metered_time_ms` |  35 | -          | -          | -          |
| `execute_metered_insns` |  2,579,903 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  72.84 | -          |  72.84 |  72.84 |
| `execute_preflight_insns` |  1,289,951.50 |  2,579,903 |  1,540,000 |  1,039,903 |
| `execute_preflight_time_ms` |  97 |  194 |  131 |  63 |
| `execute_preflight_insn_mi/s` |  35.10 | -          |  36.49 |  33.71 |
| `trace_gen_time_ms   ` |  26 |  52 |  36 |  16 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  720.50 |  1,441 |  954 |  487 |
| `prover.main_trace_commit_time_ms` |  218.50 |  437 |  298 |  139 |
| `prover.rap_constraints_time_ms` |  452.50 |  905 |  600 |  305 |
| `prover.openings_time_ms` |  48 |  96 |  55 |  41 |
| `prover.rap_constraints.logup_gkr_time_ms` |  84 |  168 |  113 |  55 |
| `prover.rap_constraints.round0_time_ms` |  264 |  528 |  355 |  173 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/c56a3a5ea3cbf3103f3941a8ae4035f581cccb9c/kitchen_sink-c56a3a5ea3cbf3103f3941a8ae4035f581cccb9c.memory.svg)
...
| app_proof |  |  |  |  |  | 676 |  |  | 35 | 2,579,903 | 72.84 | 0 | 1,948 |  | 
...
| leaf | 0 | 113 | 417 | 113 | 23 | 9 | 21 | 4 | 4 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,577,915 | 120 | 38 | 0 | 0 | 63 | 21 | 20 | 29 | 12 | 0 | 18 | 10 | 7 | 1 | 6 | 39 | 63 | 0 | 1 | 11 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,703 | 81 | 16 | 0 | 0 | 48 | 17 | 16 | 20 | 10 | 0 | 15 | 9 | 5 | 1 | 4 | 16 | 48 | 0 | 1 | 9 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 73 | 11 | 0 | 0 | 48 | 19 | 18 | 18 | 10 | 0 | 13 | 7 | 5 | 0 | 4 | 11 | 48 | 0 | 1 | 9 | 0 | 0 | 
| leaf | 0 | prover | 265,006,708 | 304 | 130 | 0 | 1 | 144 | 49 | 48 | 38 | 56 | 0 | 28 | 12 | 16 | 7 | 8 | 131 | 144 | 0 | 2 | 55 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 567,917,156 | 954 | 297 | 0 | 165 | 600 | 355 | 353 | 132 | 113 | 56 | 55 | 13 | 42 | 16 | 25 | 298 | 600 | 0 | 1 | 56 | 0 | 0 | 
| app_proof | prover | 1 | 537,266,124 | 487 | 139 | 0 | 2 | 305 | 173 | 173 | 76 | 55 | 0 | 41 | 13 | 28 | 14 | 13 | 139 | 305 | 0 | 1 | 54 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 36 | 1,232 | 36 | 177 | 0 | 3 | 63 | 1,540,000 | 33.71 | 
| app_proof | 1 | 16 | 676 | 16 | 40 | 0 | 1 | 131 | 1,039,903 | 36.49 | 

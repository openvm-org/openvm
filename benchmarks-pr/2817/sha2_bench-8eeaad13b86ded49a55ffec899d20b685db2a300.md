...
|:---|---:|---:|---:|
| Total |  12.44 |  3.58 |  3.58 |
| app_proof |  10.21 |  1.85 |  1.85 |
| leaf |  1.47 |  0.98 |  0.98 |
...
| `total_proof_time_ms ` |  1,679.17 |  10,075 |  1,710 |  1,625 |
...
| `execute_preflight_time_ms` |  124.33 |  746 |  159 |  89 |
| `execute_preflight_insn_mi/s` |  40.85 | -          |  41.85 |  36.67 |
| `trace_gen_time_ms   ` |  161.50 |  969 |  196 |  135 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,252.67 |  7,516 |  1,279 |  1,214 |
| `prover.main_trace_commit_time_ms` |  286.33 |  1,718 |  287 |  286 |
| `prover.rap_constraints_time_ms` |  878.83 |  5,273 |  902 |  840 |
| `prover.openings_time_ms` |  86.17 |  517 |  89 |  81 |
| `prover.rap_constraints.logup_gkr_time_ms` |  293.50 |  1,761 |  310 |  243 |
| `prover.rap_constraints.round0_time_ms` |  446.67 |  2,680 |  461 |  391 |
| `prover.rap_constraints.mle_rounds_time_ms` |  137.50 |  825 |  138 |  135 |
| `prover.openings.stacked_reduction_time_ms` |  54.17 |  325 |  55 |  53 |
...
| `prover.openings.whir_time_ms` |  31.50 |  189 |  34 |  28 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  735 |  1,470 |  976 |  494 |
| `execute_preflight_time_ms` |  2 |  4 |  2 |  2 |
| `trace_gen_time_ms   ` |  78 |  156 |  105 |  51 |
| `generate_blob_total_time_ms` |  9.50 |  19 |  13 |  6 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  656 |  1,312 |  870 |  442 |
| `prover.main_trace_commit_time_ms` |  365 |  730 |  508 |  222 |
| `prover.rap_constraints_time_ms` |  224 |  448 |  282 |  166 |
| `prover.openings_time_ms` |  65.50 |  131 |  78 |  53 |
| `prover.rap_constraints.logup_gkr_time_ms` |  59 |  118 |  73 |  45 |
| `prover.rap_constraints.round0_time_ms` |  101 |  202 |  130 |  72 |
...
| `prover.openings.whir_time_ms` |  33.50 |  67 |  37 |  30 |
...
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  435 |  435 |  435 |  435 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/8eeaad13b86ded49a55ffec899d20b685db2a300/sha2_bench-8eeaad13b86ded49a55ffec899d20b685db2a300.memory.svg)
...
| app_proof |  |  |  |  |  | 1,678 |  |  | 138 | 14,793,960 | 106.65 | 0 | 10,220 |  | 
| internal_for_leaf |  |  |  | 466 |  |  |  |  |  |  |  |  |  | 466 | 
| internal_recursive.0 |  |  |  | 160 |  |  |  |  |  |  |  |  |  | 160 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 31 | 466 | 31 | 11 | 2 | 2 | 1 | 1 | 
| internal_recursive.0 | 1 | 13 | 160 | 12 | 2 | 1 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 9 | 129 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 105 | 976 | 105 | 40 | 13 | 2 | 3 | 3 | 
| leaf | 1 | 51 | 494 | 51 | 20 | 6 | 2 | 3 | 3 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 75,647,988 | 435 | 224 | 0 | 1 | 165 | 46 | 46 | 87 | 30 | 0 | 44 | 21 | 22 | 7 | 15 | 225 | 165 | 0 | 2 | 29 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,943 | 147 | 48 | 0 | 0 | 71 | 24 | 23 | 29 | 17 | 0 | 26 | 18 | 8 | 2 | 6 | 49 | 71 | 0 | 2 | 16 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 119 | 31 | 0 | 0 | 60 | 21 | 21 | 24 | 13 | 0 | 26 | 19 | 7 | 1 | 5 | 31 | 60 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 266,554,214 | 870 | 508 | 0 | 98 | 282 | 130 | 129 | 79 | 73 | 0 | 78 | 37 | 40 | 22 | 18 | 508 | 282 | 0 | 6 | 72 | 0 | 0 | 
| leaf | 1 | prover | 135,243,508 | 442 | 221 | 0 | 1 | 166 | 72 | 71 | 48 | 45 | 0 | 53 | 30 | 22 | 11 | 11 | 222 | 166 | 0 | 6 | 44 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 353,899,717 | 1,214 | 286 | 0 | 1 | 840 | 391 | 390 | 138 | 310 | 76 | 87 | 32 | 55 | 32 | 22 | 286 | 840 | 0 | 4 | 231 | 0 | 0 | 
| app_proof | prover | 1 | 353,899,532 | 1,276 | 287 | 0 | 1 | 900 | 459 | 459 | 138 | 302 | 78 | 87 | 32 | 54 | 32 | 22 | 287 | 900 | 0 | 4 | 224 | 0 | 0 | 
| app_proof | prover | 2 | 353,899,532 | 1,276 | 287 | 0 | 1 | 900 | 459 | 459 | 138 | 302 | 76 | 88 | 33 | 54 | 31 | 22 | 287 | 900 | 0 | 4 | 224 | 0 | 0 | 
| app_proof | prover | 3 | 353,899,532 | 1,215 | 286 | 0 | 1 | 843 | 460 | 459 | 138 | 243 | 0 | 85 | 30 | 54 | 32 | 22 | 286 | 842 | 0 | 3 | 242 | 0 | 0 | 
| app_proof | prover | 4 | 353,899,532 | 1,279 | 286 | 0 | 1 | 902 | 461 | 460 | 138 | 303 | 78 | 89 | 34 | 55 | 32 | 22 | 286 | 902 | 0 | 4 | 224 | 0 | 0 | 
| app_proof | prover | 5 | 353,980,012 | 1,256 | 286 | 0 | 1 | 888 | 450 | 450 | 135 | 301 | 77 | 81 | 28 | 53 | 31 | 22 | 286 | 888 | 0 | 3 | 222 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 160 | 1,625 | 160 | 160 | 0 | 3 | 89 | 2,623,000 | 36.67 | 
| app_proof | 1 | 135 | 1,710 | 135 | 139 | 0 | 2 | 159 | 2,625,000 | 41.59 | 
| app_proof | 2 | 160 | 1,707 | 160 | 133 | 0 | 2 | 136 | 2,625,000 | 41.85 | 
| app_proof | 3 | 159 | 1,646 | 159 | 134 | 0 | 2 | 136 | 2,625,000 | 41.61 | 
| app_proof | 4 | 159 | 1,709 | 159 | 133 | 0 | 2 | 136 | 2,625,000 | 41.68 | 
| app_proof | 5 | 196 | 1,678 | 196 | 134 | 0 | 2 | 90 | 1,670,960 | 41.68 | 

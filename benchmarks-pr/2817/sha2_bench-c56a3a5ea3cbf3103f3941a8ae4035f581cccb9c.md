...
| `total_proof_time_ms ` |  1,696.50 |  10,179 |  1,727 |  1,644 |
...
| `execute_preflight_time_ms` |  120.17 |  721 |  151 |  82 |
| `execute_preflight_insn_mi/s` |  41.45 | -          |  42.03 |  39.66 |
| `trace_gen_time_ms   ` |  163.67 |  982 |  195 |  141 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,274.50 |  7,647 |  1,302 |  1,232 |
| `prover.main_trace_commit_time_ms` |  285.17 |  1,711 |  287 |  284 |
| `prover.rap_constraints_time_ms` |  901.33 |  5,408 |  927 |  860 |
| `prover.openings_time_ms` |  86.83 |  521 |  93 |  82 |
| `prover.rap_constraints.logup_gkr_time_ms` |  290 |  1,740 |  305 |  241 |
| `prover.rap_constraints.round0_time_ms` |  441.50 |  2,649 |  457 |  383 |
| `prover.rap_constraints.mle_rounds_time_ms` |  168.67 |  1,012 |  170 |  162 |
...
| `prover.openings.whir_time_ms` |  31.83 |  191 |  38 |  28 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  733 |  1,466 |  970 |  496 |
| `execute_preflight_time_ms` |  2 |  4 |  2 |  2 |
| `trace_gen_time_ms   ` |  75.50 |  151 |  102 |  49 |
| `generate_blob_total_time_ms` |  9.50 |  19 |  13 |  6 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  657 |  1,314 |  868 |  446 |
| `prover.main_trace_commit_time_ms` |  362.50 |  725 |  503 |  222 |
| `prover.rap_constraints_time_ms` |  226 |  452 |  284 |  168 |
| `prover.openings_time_ms` |  67.50 |  135 |  80 |  55 |
...
| `prover.openings.whir_time_ms` |  35.50 |  71 |  39 |  32 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/c56a3a5ea3cbf3103f3941a8ae4035f581cccb9c/sha2_bench-c56a3a5ea3cbf3103f3941a8ae4035f581cccb9c.memory.svg)
...
| app_proof |  |  |  |  |  | 1,696 |  |  | 138 | 14,793,960 | 106.62 | 0 | 10,325 |  | 
| internal_for_leaf |  |  |  | 465 |  |  |  |  |  |  |  |  |  | 465 | 
| internal_recursive.0 |  |  |  | 168 |  |  |  |  |  |  |  |  |  | 169 | 
| internal_recursive.1 |  |  |  | 126 |  |  |  |  |  |  |  |  |  | 126 | 
| leaf |  |  | 496 |  |  |  |  |  |  |  |  |  |  | 1,466 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 31 | 465 | 31 | 10 | 2 | 2 | 1 | 1 | 
| internal_recursive.0 | 1 | 13 | 168 | 12 | 2 | 1 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 9 | 126 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 102 | 970 | 101 | 37 | 13 | 2 | 3 | 3 | 
| leaf | 1 | 49 | 496 | 49 | 18 | 6 | 2 | 3 | 3 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 75,647,860 | 433 | 224 | 0 | 1 | 162 | 46 | 45 | 86 | 29 | 0 | 46 | 24 | 22 | 7 | 15 | 224 | 162 | 0 | 3 | 29 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,879 | 155 | 49 | 0 | 0 | 73 | 26 | 26 | 29 | 17 | 0 | 32 | 23 | 8 | 1 | 6 | 49 | 73 | 0 | 2 | 16 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 116 | 31 | 0 | 0 | 61 | 23 | 22 | 24 | 13 | 0 | 22 | 15 | 7 | 1 | 5 | 32 | 61 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 266,560,230 | 868 | 503 | 0 | 95 | 284 | 130 | 129 | 79 | 73 | 0 | 80 | 39 | 41 | 22 | 19 | 503 | 284 | 0 | 6 | 72 | 0 | 0 | 
| leaf | 1 | prover | 135,246,516 | 446 | 221 | 0 | 1 | 168 | 73 | 73 | 49 | 46 | 0 | 55 | 32 | 22 | 11 | 11 | 222 | 168 | 0 | 5 | 44 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 353,899,717 | 1,232 | 284 | 0 | 1 | 860 | 383 | 382 | 170 | 305 | 75 | 88 | 32 | 55 | 32 | 23 | 284 | 860 | 0 | 4 | 230 | 0 | 0 | 
| app_proof | prover | 1 | 353,899,532 | 1,292 | 284 | 0 | 1 | 921 | 455 | 455 | 170 | 294 | 75 | 86 | 31 | 55 | 32 | 22 | 284 | 921 | 0 | 4 | 217 | 0 | 0 | 
| app_proof | prover | 2 | 353,899,532 | 1,302 | 285 | 0 | 1 | 922 | 453 | 453 | 170 | 298 | 74 | 93 | 38 | 55 | 32 | 22 | 285 | 922 | 0 | 4 | 223 | 0 | 0 | 
| app_proof | prover | 3 | 353,899,532 | 1,241 | 286 | 0 | 1 | 868 | 457 | 456 | 170 | 241 | 0 | 85 | 30 | 54 | 32 | 22 | 287 | 868 | 0 | 4 | 240 | 0 | 0 | 
| app_proof | prover | 4 | 353,899,532 | 1,301 | 286 | 0 | 1 | 927 | 454 | 454 | 170 | 302 | 75 | 87 | 32 | 55 | 32 | 22 | 286 | 927 | 0 | 4 | 226 | 0 | 0 | 
| app_proof | prover | 5 | 353,980,012 | 1,279 | 285 | 0 | 1 | 910 | 447 | 447 | 162 | 300 | 75 | 82 | 28 | 53 | 31 | 22 | 285 | 910 | 0 | 4 | 224 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 166 | 1,644 | 166 | 161 | 0 | 3 | 82 | 2,623,000 | 39.66 | 
| app_proof | 1 | 141 | 1,720 | 141 | 135 | 0 | 2 | 151 | 2,625,000 | 41.100 | 
| app_proof | 2 | 160 | 1,727 | 160 | 131 | 0 | 2 | 133 | 2,625,000 | 41.87 | 
| app_proof | 3 | 160 | 1,666 | 160 | 130 | 0 | 2 | 133 | 2,625,000 | 41.84 | 
| app_proof | 4 | 160 | 1,726 | 160 | 130 | 0 | 2 | 133 | 2,625,000 | 42.03 | 
| app_proof | 5 | 195 | 1,696 | 195 | 132 | 0 | 2 | 89 | 1,670,960 | 41.34 | 

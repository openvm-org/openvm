...
| `total_proof_time_ms ` |  700 |  1,400 |  760 |  640 |
| `execute_metered_time_ms` |  31 | -          | -          | -          |
| `execute_metered_insns` |  4,137,067 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  129.53 | -          |  129.53 |  129.53 |
| `execute_preflight_insns` |  2,068,533.50 |  4,137,067 |  2,208,000 |  1,929,067 |
| `execute_preflight_time_ms` |  72 |  144 |  78 |  66 |
| `execute_preflight_insn_mi/s` |  40.02 | -          |  41.80 |  38.24 |
| `trace_gen_time_ms   ` |  150.50 |  301 |  154 |  147 |
| `memory_finalize_time_ms` |  1 |  2 |  2 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  375.50 |  751 |  379 |  372 |
| `prover.main_trace_commit_time_ms` |  93.50 |  187 |  99 |  88 |
| `prover.rap_constraints_time_ms` |  241 |  482 |  252 |  230 |
| `prover.openings_time_ms` |  39 |  78 |  41 |  37 |
| `prover.rap_constraints.logup_gkr_time_ms` |  138 |  276 |  139 |  137 |
...
| `prover.openings.whir_time_ms` |  20 |  40 |  22 |  18 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/c56a3a5ea3cbf3103f3941a8ae4035f581cccb9c/regex-c56a3a5ea3cbf3103f3941a8ae4035f581cccb9c.memory.svg)
...
| app_proof |  |  |  |  |  | 640 |  |  | 31 | 4,137,067 | 129.53 | 0 | 1,446 |  | 
...
| internal_recursive.0 | 1 | 9 | 151 | 9 | 1 | 0 | 2 | 0 | 0 | 
| internal_recursive.1 | 1 | 9 | 127 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 48 | 352 | 48 | 13 | 2 | 5 | 1 | 1 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 27,256,571 | 208 | 81 | 0 | 0 | 97 | 32 | 31 | 45 | 19 | 0 | 29 | 18 | 11 | 2 | 8 | 81 | 97 | 0 | 2 | 18 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,703 | 141 | 45 | 0 | 0 | 66 | 25 | 24 | 28 | 13 | 0 | 28 | 19 | 8 | 1 | 6 | 46 | 66 | 0 | 2 | 12 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 118 | 31 | 0 | 0 | 61 | 23 | 23 | 24 | 13 | 0 | 25 | 17 | 7 | 1 | 5 | 31 | 61 | 0 | 3 | 12 | 0 | 0 | 
| leaf | 0 | prover | 79,962,804 | 304 | 127 | 0 | 0 | 133 | 54 | 53 | 37 | 42 | 0 | 42 | 27 | 15 | 6 | 8 | 127 | 133 | 0 | 5 | 41 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 123,384,338 | 372 | 99 | 0 | 0 | 230 | 55 | 55 | 34 | 139 | 0 | 41 | 22 | 19 | 10 | 9 | 99 | 230 | 0 | 3 | 138 | 0 | 0 | 
| app_proof | prover | 1 | 106,568,591 | 379 | 88 | 0 | 8 | 252 | 86 | 85 | 29 | 137 | 0 | 37 | 18 | 19 | 8 | 10 | 88 | 252 | 0 | 3 | 136 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 147 | 760 | 147 | 161 | 2 | 7 | 78 | 2,208,000 | 38.24 | 
| app_proof | 1 | 154 | 640 | 154 | 41 | 0 | 2 | 66 | 1,929,067 | 41.80 | 

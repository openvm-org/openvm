...
| `total_proof_time_ms ` |  751.50 |  1,503 |  903 |  600 |
...
| `execute_preflight_insn_mi/s` |  14.66 | -          |  18.19 |  11.12 |
| `trace_gen_time_ms   ` |  180 |  360 |  201 |  159 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  380.50 |  761 |  452 |  309 |
| `main_trace_commit_time_ms` |  64 |  128 |  74 |  54 |
| `generate_perm_trace_time_ms` |  36 |  72 |  38 |  34 |
| `perm_trace_commit_time_ms` |  75.99 |  151.97 |  88.10 |  63.88 |
| `quotient_poly_compute_time_ms` |  82.11 |  164.23 |  91.28 |  72.95 |
| `quotient_poly_commit_time_ms` |  16.83 |  33.65 |  18.15 |  15.50 |
| `pcs_opening_time_ms ` |  100.50 |  201 |  141 |  60 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 600 | 1 | 67 | 1,745,757 | 25.90 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 159 | 903 | 172,558,444 | 159 | 452 | 0 | 91.28 | 18.15 | 6 | 88.10 | 141 | 125 | 141 | 1 | 74 | 34 | 123 | 1,151,000 | 11.12 | 26 | 110 | 1 | 141 | 
| pairing | 1 | 201 | 600 | 119,958,502 | 201 | 309 | 1 | 72.95 | 15.50 | 6 | 63.88 | 60 | 105 | 60 | 0 | 54 | 38 | 48 | 594,757 | 18.19 | 21 | 89 | 1 | 60 | 

...
|:---|---:|---:|---:|
| Total |  2.44 |  0.75 | 0.75 |
| regex_program |  2.44 |  0.75 |  0.75 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  599.50 |  2,398 |  712 |  538 |
...
| `execute_preflight_time_ms` |  46.25 |  185 |  58 |  35 |
| `execute_preflight_insn_mi/s` |  31.47 | -          |  31.87 |  30.62 |
| `trace_gen_time_ms   ` |  181.75 |  727 |  201 |  172 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  297.50 |  1,190 |  324 |  273 |
| `main_trace_commit_time_ms` |  52.25 |  209 |  57 |  50 |
| `generate_perm_trace_time_ms` |  43.50 |  174 |  87 |  22 |
| `perm_trace_commit_time_ms` |  65.11 |  260.45 |  72.35 |  55.26 |
| `quotient_poly_compute_time_ms` |  60.73 |  242.93 |  74.05 |  53.35 |
| `quotient_poly_commit_time_ms` |  16.03 |  64.12 |  18.23 |  13.72 |
| `pcs_opening_time_ms ` |  56.25 |  225 |  61 |  50 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 560 | 1 | 39 | 4,137,727 | 105.20 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 172 | 712 | 150,778,428 | 172 | 311 | 0 | 60.26 | 18.23 | 5 | 72.35 | 61 | 112 | 61 | 4 | 57 | 39 | 58 | 1,103,000 | 30.62 | 22 | 79 | 1 | 61 | 
| regex_program | 1 | 176 | 588 | 128,513,066 | 176 | 324 | 1 | 53.35 | 16.35 | 4 | 65.13 | 50 | 153 | 49 | 0 | 50 | 87 | 46 | 1,104,000 | 31.87 | 17 | 70 | 0 | 49 | 
| regex_program | 2 | 178 | 538 | 128,513,066 | 178 | 273 | 1 | 55.26 | 15.82 | 4 | 67.71 | 59 | 90 | 59 | 0 | 50 | 22 | 46 | 1,104,000 | 31.83 | 17 | 71 | 0 | 59 | 
| regex_program | 3 | 201 | 560 | 103,475,717 | 201 | 282 | 0 | 74.05 | 13.72 | 6 | 55.26 | 55 | 85 | 54 | 0 | 52 | 26 | 35 | 826,727 | 31.58 | 20 | 88 | 1 | 54 | 

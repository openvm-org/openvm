...
|:---|---:|---:|---:|
| Total |  2.44 |  0.76 | 0.76 |
| regex_program |  2.44 |  0.76 |  0.76 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  600.25 |  2,401 |  728 |  529 |
...
| `execute_preflight_time_ms` |  46.75 |  187 |  58 |  36 |
| `execute_preflight_insn_mi/s` |  30.35 | -          |  31.13 |  29.65 |
| `trace_gen_time_ms   ` |  182 |  728 |  201 |  173 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  297.75 |  1,191 |  328 |  264 |
| `main_trace_commit_time_ms` |  52.50 |  210 |  58 |  50 |
| `generate_perm_trace_time_ms` |  33 |  132 |  45 |  22 |
| `perm_trace_commit_time_ms` |  64.16 |  256.63 |  71.32 |  52.72 |
| `quotient_poly_compute_time_ms` |  60.33 |  241.31 |  68.100 |  53.75 |
| `quotient_poly_commit_time_ms` |  16.14 |  64.58 |  19.14 |  13.60 |
| `pcs_opening_time_ms ` |  68.50 |  274 |  89 |  52 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 604 | 1 | 36 | 4,137,600 | 113.83 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 173 | 728 | 150,778,428 | 173 | 328 | 0 | 63.27 | 19.14 | 6 | 71.32 | 72 | 113 | 72 | 4 | 58 | 41 | 58 | 1,103,000 | 30.13 | 22 | 83 | 1 | 72 | 
| regex_program | 1 | 176 | 529 | 128,513,066 | 176 | 264 | 1 | 53.75 | 15.96 | 4 | 65.40 | 52 | 90 | 52 | 0 | 51 | 24 | 47 | 1,104,000 | 30.47 | 17 | 70 | 0 | 52 | 
| regex_program | 2 | 178 | 540 | 128,513,066 | 178 | 274 | 1 | 55.29 | 15.87 | 4 | 67.18 | 61 | 89 | 61 | 0 | 51 | 22 | 46 | 1,104,000 | 31.13 | 17 | 71 | 0 | 60 | 
| regex_program | 3 | 201 | 604 | 103,473,675 | 201 | 325 | 0 | 68.100 | 13.60 | 5 | 52.72 | 89 | 101 | 89 | 0 | 50 | 45 | 36 | 826,600 | 29.65 | 18 | 83 | 1 | 89 | 

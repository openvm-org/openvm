...
| `total_proof_time_ms ` |  724 |  1,448 |  852 |  596 |
...
| `execute_preflight_time_ms` |  86 |  172 |  124 |  48 |
| `execute_preflight_insn_mi/s` |  14.32 | -          |  17.80 |  10.85 |
| `trace_gen_time_ms   ` |  183 |  366 |  205 |  161 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  349.50 |  699 |  397 |  302 |
| `main_trace_commit_time_ms` |  63.50 |  127 |  71 |  56 |
| `generate_perm_trace_time_ms` |  32.50 |  65 |  34 |  31 |
| `perm_trace_commit_time_ms` |  77.86 |  155.72 |  89.99 |  65.73 |
| `quotient_poly_compute_time_ms` |  84.21 |  168.42 |  93.95 |  74.47 |
| `quotient_poly_commit_time_ms` |  18 |  36.01 |  20.38 |  15.63 |
| `pcs_opening_time_ms ` |  69 |  138 |  83 |  55 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 596 | 1 | 68 | 1,745,757 | 25.54 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 161 | 852 | 172,558,444 | 161 | 397 | 0 | 93.95 | 20.38 | 6 | 89.99 | 83 | 126 | 82 | 1 | 71 | 34 | 124 | 1,151,000 | 10.85 | 27 | 115 | 1 | 82 | 
| pairing | 1 | 205 | 596 | 119,958,502 | 205 | 302 | 1 | 74.47 | 15.63 | 6 | 65.73 | 55 | 99 | 55 | 0 | 56 | 31 | 48 | 594,757 | 17.80 | 21 | 90 | 1 | 55 | 

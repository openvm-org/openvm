...
|:---|---:|---:|
| Total |  7.10 |  3.82 |
| regex_program |  7.04 |  3.76 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  3,520 |  7,040 |  3,759 |  3,281 |
...
| `execute_metered_insn_mi/s` |  68.39 | -          |  68.39 |  68.39 |
| `execute_e3_time_ms  ` |  166 |  332 |  180 |  152 |
| `execute_e3_insn_mi/s` |  12.50 | -          |  12.60 |  12.40 |
| `trace_gen_time_ms   ` |  732.50 |  1,465 |  754 |  711 |
| `memory_finalize_time_ms` |  169.50 |  339 |  265 |  74 |
| `boundary_finalize_time_ms` |  2.50 |  5 |  5 |  0 |
| `merkle_finalize_time_ms` |  155.50 |  311 |  242 |  69 |
| `stark_prove_excluding_trace_time_ms` |  2,621.50 |  5,243 |  2,825 |  2,418 |
| `main_trace_commit_time_ms` |  508.50 |  1,017 |  572 |  445 |
| `generate_perm_trace_time_ms` |  218.50 |  437 |  232 |  205 |
| `perm_trace_commit_time_ms` |  566 |  1,132 |  611 |  521 |
| `quotient_poly_compute_time_ms` |  266.50 |  533 |  289 |  244 |
| `quotient_poly_commit_time_ms` |  252 |  504 |  276 |  228 |
| `pcs_opening_time_ms ` |  802.50 |  1,605 |  840 |  765 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2 | 24 | 4,165,433 | 1 | 7,028 | 60 | 68.39 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 754 | 3,759 | 2,243,700 | 275,648,700 | 2,825 | 289 | 276 | 3,050 | 611 | 840 | 242 | 26 | 265 | 572 | 93,439,220 | 2,243,700 | 232 | 180 | 12.40 | 5 | 
| regex_program | 1 | 711 | 3,281 | 1,921,732 | 242,975,388 | 2,418 | 244 | 228 | 3,012 | 521 | 765 | 69 | 24 | 74 | 445 | 73,010,366 | 1,921,733 | 205 | 152 | 12.60 | 0 | 

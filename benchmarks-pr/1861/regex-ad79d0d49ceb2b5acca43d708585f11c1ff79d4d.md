...
|:---|---:|---:|
| Total |  7.10 |  3.82 |
| regex_program |  7.04 |  3.75 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  3,519 |  7,038 |  3,755 |  3,283 |
...
| `execute_metered_insn_mi/s` |  68.49 | -          |  68.49 |  68.49 |
| `execute_e3_time_ms  ` |  166 |  332 |  180 |  152 |
| `execute_e3_insn_mi/s` |  12.51 | -          |  12.59 |  12.42 |
| `trace_gen_time_ms   ` |  736.50 |  1,473 |  758 |  715 |
| `memory_finalize_time_ms` |  169.50 |  339 |  266 |  73 |
| `boundary_finalize_time_ms` |  2.50 |  5 |  5 |  0 |
| `merkle_finalize_time_ms` |  154.50 |  309 |  241 |  68 |
| `stark_prove_excluding_trace_time_ms` |  2,616.50 |  5,233 |  2,817 |  2,416 |
| `main_trace_commit_time_ms` |  516 |  1,032 |  583 |  449 |
| `generate_perm_trace_time_ms` |  212.50 |  425 |  231 |  194 |
| `perm_trace_commit_time_ms` |  556 |  1,112 |  589 |  523 |
| `quotient_poly_compute_time_ms` |  266.50 |  533 |  289 |  244 |
| `quotient_poly_commit_time_ms` |  243.50 |  487 |  281 |  206 |
| `pcs_opening_time_ms ` |  813 |  1,626 |  836 |  790 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2 | 25 | 4,165,433 | 1 | 7,111 | 60 | 68.49 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 758 | 3,755 | 2,243,700 | 275,648,700 | 2,817 | 289 | 281 | 3,042 | 589 | 836 | 241 | 24 | 266 | 583 | 93,439,220 | 2,243,700 | 231 | 180 | 12.42 | 5 | 
| regex_program | 1 | 715 | 3,283 | 1,921,732 | 242,975,388 | 2,416 | 244 | 206 | 3,010 | 523 | 790 | 68 | 24 | 73 | 449 | 73,010,366 | 1,921,733 | 194 | 152 | 12.59 | 0 | 

...
|:---|---:|---:|
| Total |  7.06 |  3.81 |
| regex_program |  6.100 |  3.75 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  3,498 |  6,996 |  3,746 |  3,250 |
...
| `execute_metered_insn_mi/s` |  68.56 | -          |  68.56 |  68.56 |
| `execute_e3_time_ms  ` |  166.50 |  333 |  181 |  152 |
| `execute_e3_insn_mi/s` |  12.46 | -          |  12.58 |  12.35 |
| `trace_gen_time_ms   ` |  730 |  1,460 |  757 |  703 |
| `memory_finalize_time_ms` |  170.50 |  341 |  266 |  75 |
| `boundary_finalize_time_ms` |  3 |  6 |  6 |  0 |
| `merkle_finalize_time_ms` |  156.50 |  313 |  243 |  70 |
| `stark_prove_excluding_trace_time_ms` |  2,601.50 |  5,203 |  2,808 |  2,395 |
| `main_trace_commit_time_ms` |  509.50 |  1,019 |  574 |  445 |
| `generate_perm_trace_time_ms` |  214 |  428 |  228 |  200 |
| `perm_trace_commit_time_ms` |  556 |  1,112 |  593 |  519 |
| `quotient_poly_compute_time_ms` |  264 |  528 |  285 |  243 |
| `quotient_poly_commit_time_ms` |  246 |  492 |  283 |  209 |
| `pcs_opening_time_ms ` |  802 |  1,604 |  836 |  768 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2 | 24 | 4,165,433 | 1 | 7,014 | 60 | 68.56 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 757 | 3,746 | 2,243,700 | 275,648,700 | 2,808 | 285 | 283 | 3,032 | 593 | 836 | 243 | 26 | 266 | 574 | 93,439,220 | 2,243,700 | 228 | 181 | 12.35 | 6 | 
| regex_program | 1 | 703 | 3,250 | 1,921,732 | 242,975,388 | 2,395 | 243 | 209 | 2,988 | 519 | 768 | 70 | 24 | 75 | 445 | 73,010,366 | 1,921,733 | 200 | 152 | 12.58 | 0 | 

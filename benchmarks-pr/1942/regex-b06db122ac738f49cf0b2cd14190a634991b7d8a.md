...
| `total_proof_time_ms ` |  3,448.50 |  6,897 |  4,460 |  2,437 |
...
| `execute_e3_time_ms  ` |  67 |  134 |  78 |  56 |
| `execute_e3_insn_mi/s` |  30.85 | -          |  33.54 |  28.16 |
| `trace_gen_time_ms   ` |  401.50 |  803 |  513 |  290 |
| `memory_finalize_time_ms` |  40.50 |  81 |  43 |  38 |
| `boundary_finalize_time_ms` |  2 |  4 |  4 |  0 |
| `merkle_finalize_time_ms` |  135 |  270 |  218 |  52 |
| `stark_prove_excluding_trace_time_ms` |  2,980 |  5,960 |  3,869 |  2,091 |
| `main_trace_commit_time_ms` |  570.50 |  1,141 |  766 |  375 |
| `generate_perm_trace_time_ms` |  238 |  476 |  314 |  162 |
| `perm_trace_commit_time_ms` |  597 |  1,194 |  771 |  423 |
| `quotient_poly_compute_time_ms` |  322.50 |  645 |  435 |  210 |
| `quotient_poly_commit_time_ms` |  283 |  566 |  375 |  191 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2,724 | 6 | 4,108,597 | 1 | 32 | 125.53 | 45 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 513 | 4,460 | 211,758,557 | 373,183,036 | 513 | 3,869 | 2 | 435 | 375 | 771 | 1,202 | 218 | 8 | 43 | 766 | 91,281,687 | 2,211,000 | 314 | 78 | 28.16 | 4 | 
| regex_program | 1 | 290 | 2,437 | 174,326,267 | 196,838,026 | 290 | 2,091 | 2 | 210 | 191 | 423 | 719 | 52 | 6 | 38 | 375 | 73,453,305 | 1,897,597 | 162 | 56 | 33.54 | 0 | 

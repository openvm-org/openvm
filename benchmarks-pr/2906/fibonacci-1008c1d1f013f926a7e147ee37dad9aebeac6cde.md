...
|:---|---:|---:|---:|
| Total |  4.45 |  2.33 |  2.33 |
| app_proof |  3.11 |  0.98 |  0.98 |
| leaf |  0.68 |  0.68 |  0.68 |
...
| `total_proof_time_ms ` |  760.75 |  3,043 |  916 |  547 |
...
| `execute_preflight_time_ms` |  82.75 |  331 |  102 |  43 |
| `execute_preflight_insn_mi/s` |  49.17 | -          |  50.19 |  46.39 |
| `trace_gen_time_ms   ` |  139 |  556 |  172 |  121 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  468.50 |  1,874 |  535 |  290 |
| `prover.main_trace_commit_time_ms` |  98.25 |  393 |  112 |  59 |
| `prover.rap_constraints_time_ms` |  269.50 |  1,078 |  308 |  165 |
| `prover.openings_time_ms` |  99.50 |  398 |  114 |  65 |
| `prover.rap_constraints.logup_gkr_time_ms` |  194 |  776 |  221 |  115 |
...
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  7.75 |  31 |  9 |  5 |
| `prover.openings.whir_time_ms` |  80.25 |  321 |  92 |  52 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/1008c1d1f013f926a7e147ee37dad9aebeac6cde/fibonacci-1008c1d1f013f926a7e147ee37dad9aebeac6cde.memory.svg)
...
| app_proof |  |  |  |  |  | 547 |  |  | 67 | 12,000,265 | 178.43 | 0 | 3,116 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 320 | 116 | 0 | 0 | 106 | 35 | 35 | 50 | 19 | 0 | 97 | 83 | 13 | 3 | 9 | 116 | 106 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 172 | 47 | 0 | 0 | 66 | 24 | 24 | 27 | 13 | 0 | 58 | 50 | 8 | 1 | 6 | 47 | 66 | 0 | 3 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 135 | 32 | 0 | 0 | 62 | 23 | 22 | 24 | 15 | 0 | 40 | 33 | 7 | 1 | 5 | 32 | 62 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 147,934,254 | 608 | 233 | 0 | 0 | 182 | 84 | 83 | 53 | 44 | 0 | 191 | 167 | 24 | 11 | 12 | 233 | 182 | 0 | 8 | 43 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 136,618,054 | 535 | 112 | 0 | 0 | 308 | 59 | 59 | 27 | 221 | 0 | 114 | 92 | 21 | 11 | 9 | 112 | 308 | 0 | 3 | 220 | 0 | 0 | 
| app_proof | prover | 1 | 136,570,716 | 526 | 111 | 0 | 0 | 303 | 56 | 55 | 26 | 220 | 0 | 110 | 89 | 21 | 12 | 9 | 111 | 303 | 0 | 3 | 220 | 0 | 0 | 
| app_proof | prover | 2 | 136,570,716 | 523 | 111 | 0 | 0 | 302 | 56 | 55 | 26 | 220 | 0 | 109 | 88 | 20 | 11 | 8 | 111 | 302 | 0 | 3 | 219 | 0 | 0 | 
| app_proof | prover | 3 | 70,295,004 | 290 | 59 | 0 | 0 | 165 | 32 | 32 | 17 | 115 | 0 | 65 | 52 | 12 | 6 | 5 | 59 | 165 | 0 | 3 | 114 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 136 | 916 | 136 | 154 | 2,770,197,065 | 323,292,691 | 3,093,489,756 | 2,097,152 | 0 | 3 | 89 | 3,495,000 | 46.39 | 
| app_proof | 1 | 121 | 791 | 121 | 41 | 2,768,862,357 | 322,353,414 | 3,091,215,771 | 2,097,152 | 0 | 1 | 102 | 3,495,000 | 50.03 | 
| app_proof | 2 | 127 | 789 | 127 | 41 | 2,768,862,357 | 322,353,414 | 3,091,215,771 | 2,097,152 | 0 | 1 | 97 | 3,495,000 | 50.19 | 
| app_proof | 3 | 172 | 547 | 172 | 41 | 1,230,956,171 | 342,871,578 | 1,573,827,749 | 2,097,152 | 0 | 2 | 43 | 1,515,265 | 50.05 | 

...
| `total_proof_time_ms ` |  714 |  1,428 |  770 |  658 |
| `execute_metered_time_ms` |  31 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  131.07 | -          |  131.07 |  131.07 |
| `execute_preflight_insns` |  2,068,533.50 |  4,137,067 |  2,208,000 |  1,929,067 |
| `execute_preflight_time_ms` |  73.50 |  147 |  79 |  68 |
| `execute_preflight_insn_mi/s` |  39.48 | -          |  40.65 |  38.30 |
| `trace_gen_time_ms   ` |  151.50 |  303 |  155 |  148 |
| `memory_finalize_time_ms` |  1 |  2 |  2 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  382.50 |  765 |  393 |  372 |
| `prover.main_trace_commit_time_ms` |  98 |  196 |  101 |  95 |
| `prover.rap_constraints_time_ms` |  234.50 |  469 |  248 |  221 |
| `prover.openings_time_ms` |  49 |  98 |  49 |  49 |
| `prover.rap_constraints.logup_gkr_time_ms` |  138.50 |  277 |  140 |  137 |
| `prover.rap_constraints.round0_time_ms` |  64 |  128 |  78 |  50 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/10a3bf33d2eec42d1b554dbfe35aa1ca55bb449c/regex-10a3bf33d2eec42d1b554dbfe35aa1ca55bb449c.memory.svg)
...
| app_proof |  |  |  |  |  | 658 |  |  | 31 | 4,137,067 | 131.07 | 0 | 1,473 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 41,036,547 | 227 | 83 | 0 | 5 | 99 | 29 | 29 | 45 | 23 | 0 | 44 | 18 | 26 | 2 | 23 | 84 | 99 | 0 | 2 | 22 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 23,651,975 | 160 | 48 | 0 | 3 | 69 | 23 | 22 | 27 | 18 | 0 | 41 | 18 | 23 | 1 | 21 | 49 | 69 | 0 | 2 | 17 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 17,507,975 | 139 | 34 | 0 | 3 | 64 | 21 | 21 | 24 | 18 | 0 | 40 | 18 | 22 | 1 | 20 | 34 | 64 | 0 | 2 | 16 | 0 | 0 | 
| leaf | 0 | prover | 115,080,128 | 325 | 129 | 0 | 8 | 136 | 51 | 50 | 37 | 47 | 0 | 58 | 28 | 30 | 6 | 23 | 130 | 136 | 0 | 5 | 46 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 335,517,254 | 372 | 101 | 0 | 2 | 221 | 50 | 49 | 34 | 137 | 0 | 49 | 21 | 27 | 10 | 17 | 101 | 221 | 0 | 3 | 136 | 0 | 0 | 
| app_proof | prover | 1 | 303,289,171 | 393 | 94 | 0 | 15 | 248 | 78 | 78 | 29 | 140 | 0 | 49 | 23 | 26 | 8 | 17 | 95 | 248 | 0 | 3 | 139 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 148 | 770 | 148 | 169 | 2 | 131 | 79 | 2,208,000 | 38.30 | 
| app_proof | 1 | 155 | 658 | 155 | 40 | 0 | 138 | 68 | 1,929,067 | 40.65 | 

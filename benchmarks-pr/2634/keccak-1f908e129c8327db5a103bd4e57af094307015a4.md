...
|:---|---:|---:|---:|
| Total |  19.05 |  5.38 |  5.38 |
| app_proof |  15.96 |  3.08 |  3.08 |
| leaf |  2.23 |  1.45 |  1.45 |
...
| `total_proof_time_ms ` |  2,654.33 |  15,926 |  3,042 |  2,555 |
| `execute_metered_time_ms` |  37 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  32.73 | -          |  32.73 |  32.73 |
| `execute_preflight_insns` |  205,869.67 |  1,235,218 |  207,000 |  200,218 |
| `execute_preflight_time_ms` |  181 |  1,086 |  278 |  15 |
| `execute_preflight_insn_mi/s` |  19.27 | -          |  19.35 |  19.06 |
| `trace_gen_time_ms   ` |  391.33 |  2,348 |  548 |  350 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  2,018.50 |  12,111 |  2,308 |  1,952 |
| `prover.main_trace_commit_time_ms` |  700.83 |  4,205 |  871 |  665 |
| `prover.rap_constraints_time_ms` |  1,128.50 |  6,771 |  1,247 |  1,101 |
| `prover.openings_time_ms` |  188 |  1,128 |  193 |  182 |
| `prover.rap_constraints.logup_gkr_time_ms` |  278.67 |  1,672 |  395 |  254 |
| `prover.rap_constraints.round0_time_ms` |  527.67 |  3,166 |  530 |  526 |
| `prover.rap_constraints.mle_rounds_time_ms` |  321.33 |  1,928 |  325 |  320 |
| `prover.openings.stacked_reduction_time_ms` |  143.33 |  860 |  145 |  141 |
| `prover.openings.stacked_reduction.round0_time_ms` |  86.67 |  520 |  88 |  86 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  56.17 |  337 |  58 |  55 |
| `prover.openings.whir_time_ms` |  44.17 |  265 |  51 |  40 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,115 |  2,230 |  1,445 |  785 |
...
| `prover.main_trace_commit_time_ms` |  553.50 |  1,107 |  727 |  380 |
| `prover.rap_constraints_time_ms` |  313 |  626 |  400 |  226 |
| `prover.openings_time_ms` |  109.50 |  219 |  132 |  87 |
| `prover.rap_constraints.logup_gkr_time_ms` |  66.50 |  133 |  81 |  52 |
| `prover.rap_constraints.round0_time_ms` |  151.50 |  303 |  198 |  105 |
...
| `prover.openings.whir_time_ms` |  39.50 |  79 |  45 |  34 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/1f908e129c8327db5a103bd4e57af094307015a4/keccak-1f908e129c8327db5a103bd4e57af094307015a4.memory.svg)
...
| app_proof |  |  |  |  |  | 2,569 |  |  | 37 | 1,235,218 | 32.73 | 0 | 15,971 |  | 
...
| leaf | 0 | 184 | 1,445 | 184 | 64 | 34 | 5 | 7 | 7 | 
| leaf | 1 | 91 | 785 | 90 | 32 | 17 | 4 | 7 | 7 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 109,497,984 | 486 | 249 | 0 | 14 | 177 | 46 | 46 | 96 | 34 | 0 | 59 | 20 | 39 | 8 | 31 | 249 | 177 | 0 | 3 | 33 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 25,962,119 | 169 | 51 | 0 | 4 | 77 | 24 | 23 | 29 | 23 | 0 | 40 | 16 | 24 | 2 | 22 | 51 | 77 | 0 | 2 | 22 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 17,507,975 | 141 | 34 | 0 | 4 | 65 | 22 | 21 | 24 | 18 | 0 | 40 | 17 | 22 | 1 | 21 | 35 | 65 | 0 | 2 | 17 | 0 | 0 | 
| leaf | 0 | prover | 583,523,386 | 1,260 | 727 | 0 | 47 | 400 | 198 | 197 | 119 | 81 | 0 | 132 | 45 | 86 | 41 | 45 | 727 | 400 | 0 | 6 | 81 | 0 | 0 | 
| leaf | 1 | prover | 300,618,208 | 694 | 379 | 0 | 24 | 226 | 105 | 104 | 68 | 52 | 0 | 87 | 34 | 52 | 20 | 32 | 380 | 226 | 0 | 6 | 50 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,205,061,845 | 2,308 | 871 | 0 | 257 | 1,247 | 527 | 526 | 325 | 395 | 138 | 188 | 42 | 145 | 87 | 58 | 871 | 1,247 | 0 | 3 | 255 | 0 | 0 | 
| app_proof | prover | 1 | 1,205,053,652 | 1,962 | 667 | 0 | 51 | 1,101 | 526 | 525 | 320 | 254 | 0 | 193 | 48 | 145 | 88 | 56 | 667 | 1,101 | 0 | 3 | 253 | 0 | 0 | 
| app_proof | prover | 2 | 1,205,053,652 | 1,952 | 665 | 0 | 51 | 1,104 | 527 | 527 | 320 | 256 | 0 | 182 | 40 | 142 | 86 | 55 | 665 | 1,104 | 0 | 4 | 255 | 0 | 0 | 
| app_proof | prover | 3 | 1,205,053,652 | 1,959 | 667 | 0 | 51 | 1,104 | 528 | 528 | 320 | 255 | 0 | 186 | 43 | 143 | 87 | 55 | 667 | 1,104 | 0 | 4 | 255 | 0 | 0 | 
| app_proof | prover | 4 | 1,205,053,652 | 1,965 | 667 | 0 | 51 | 1,105 | 528 | 527 | 320 | 256 | 0 | 193 | 51 | 141 | 86 | 55 | 667 | 1,105 | 0 | 3 | 254 | 0 | 0 | 
| app_proof | prover | 5 | 1,205,062,652 | 1,965 | 668 | 0 | 52 | 1,110 | 530 | 530 | 323 | 256 | 0 | 186 | 41 | 144 | 86 | 58 | 668 | 1,110 | 0 | 4 | 255 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 548 | 3,042 | 548 | 169 | 0 | 195 | 15 | 207,000 | 19.06 | 
| app_proof | 1 | 350 | 2,632 | 350 | 41 | 0 | 1 | 278 | 207,000 | 19.30 | 
| app_proof | 2 | 356 | 2,555 | 356 | 41 | 0 | 6 | 205 | 207,000 | 19.28 | 
| app_proof | 3 | 355 | 2,560 | 355 | 41 | 0 | 6 | 205 | 207,000 | 19.31 | 
| app_proof | 4 | 355 | 2,568 | 355 | 41 | 0 | 7 | 205 | 207,000 | 19.35 | 
| app_proof | 5 | 384 | 2,569 | 384 | 41 | 0 | 35 | 178 | 200,218 | 19.31 | 

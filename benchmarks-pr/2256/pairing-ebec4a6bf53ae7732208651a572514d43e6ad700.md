...
| `total_proof_time_ms ` |  743.50 |  1,487 |  831 |  656 |
...
| `execute_preflight_time_ms` |  91.50 |  183 |  125 |  58 |
| `execute_preflight_insn_mi/s` |  14.01 | -          |  18.54 |  9.48 |
| `trace_gen_time_ms   ` |  185.50 |  371 |  201 |  170 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  371.50 |  743 |  389 |  354 |
| `main_trace_commit_time_ms` |  65 |  130 |  76 |  54 |
| `generate_perm_trace_time_ms` |  56.50 |  113 |  72 |  41 |
| `perm_trace_commit_time_ms` |  78.06 |  156.12 |  91.38 |  64.74 |
| `quotient_poly_compute_time_ms` |  80.62 |  161.24 |  88.85 |  72.40 |
| `quotient_poly_commit_time_ms` |  17.01 |  34.03 |  18.89 |  15.14 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 656 | 1 | 87 | 1,745,742 | 20.05 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 170 | 831 | 32,689,110 | 172,558,444 | 170 | 389 | 0 | 88.85 | 18.89 | 6 | 91.38 | 68 | 135 | 68 | 1 | 76 | 16,059,916 | 41 | 125 | 1,157,000 | 9.48 | 27 | 108 | 1 | 68 | 
| pairing | 1 | 201 | 656 | 22,314,288 | 119,958,502 | 201 | 354 | 1 | 72.40 | 15.14 | 6 | 64.74 | 72 | 139 | 72 | 0 | 54 | 9,408,294 | 72 | 58 | 588,742 | 18.54 | 21 | 88 | 1 | 72 | 

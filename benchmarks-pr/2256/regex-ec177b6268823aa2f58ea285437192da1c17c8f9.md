...
| `total_proof_time_ms ` |  588.50 |  2,354 |  712 |  541 |
...
| `execute_preflight_insn_mi/s` |  31.57 | -          |  32.84 |  28.49 |
| `trace_gen_time_ms   ` |  180.50 |  722 |  214 |  156 |
| `memory_finalize_time_ms` |  0.75 |  3 |  3 |  0 |
| `stark_prove_excluding_trace_time_ms` |  286 |  1,144 |  308 |  268 |
| `main_trace_commit_time_ms` |  52.25 |  209 |  57 |  50 |
| `generate_perm_trace_time_ms` |  29 |  116 |  38 |  19 |
| `perm_trace_commit_time_ms` |  65.56 |  262.22 |  72.47 |  56.78 |
| `quotient_poly_compute_time_ms` |  58.81 |  235.25 |  70.02 |  52.94 |
| `quotient_poly_commit_time_ms` |  15.28 |  61.12 |  17.16 |  12.68 |
| `pcs_opening_time_ms ` |  61.75 |  247 |  69 |  52 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 541 | 1 | 38 | 4,137,502 | 108.37 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 214 | 712 | 23,446,148 | 150,778,428 | 214 | 308 | 0 | 58.54 | 17.16 | 5 | 72.47 | 69 | 104 | 69 | 3 | 57 | 10,899,170 | 31 | 44 | 1,103,000 | 28.49 | 22 | 76 | 1 | 69 | 
| regex_program | 1 | 156 | 556 | 11,598,276 | 128,513,066 | 156 | 290 | 1 | 52.94 | 15.81 | 4 | 66.01 | 64 | 105 | 64 | 0 | 51 | 2,196,106 | 38 | 68 | 1,104,000 | 32.23 | 17 | 69 | 0 | 64 | 
| regex_program | 2 | 166 | 545 | 11,579,064 | 128,513,066 | 166 | 278 | 1 | 53.74 | 15.47 | 4 | 66.97 | 62 | 95 | 62 | 0 | 50 | 2,177,334 | 28 | 59 | 1,104,000 | 32.72 | 16 | 69 | 0 | 62 | 
| regex_program | 3 | 186 | 541 | 11,853,872 | 103,456,394 | 186 | 268 | 0 | 70.02 | 12.68 | 5 | 56.78 | 52 | 79 | 52 | 0 | 51 | 2,422,606 | 19 | 46 | 826,502 | 32.84 | 19 | 83 | 1 | 52 | 
...
Commit: https://github.com/openvm-org/openvm/commit/ec177b6268823aa2f58ea285437192da1c17c8f9
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19415692629)

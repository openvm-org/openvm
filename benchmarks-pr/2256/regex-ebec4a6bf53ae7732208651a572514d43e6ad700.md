...
| `total_proof_time_ms ` |  587.50 |  2,350 |  739 |  524 |
...
| `execute_metered_insn_mi/s` |  109.84 | -          |  109.84 |  109.84 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  51.50 |  206 |  63 |  43 |
| `execute_preflight_insn_mi/s` |  32.75 | -          |  34.12 |  29.48 |
| `trace_gen_time_ms   ` |  179.75 |  719 |  212 |  158 |
| `memory_finalize_time_ms` |  0.75 |  3 |  3 |  0 |
| `stark_prove_excluding_trace_time_ms` |  289.25 |  1,157 |  339 |  263 |
| `main_trace_commit_time_ms` |  51.50 |  206 |  57 |  49 |
| `generate_perm_trace_time_ms` |  34.50 |  138 |  55 |  19 |
| `perm_trace_commit_time_ms` |  64.33 |  257.33 |  69.36 |  55.62 |
| `quotient_poly_compute_time_ms` |  58.22 |  232.89 |  68.58 |  52.18 |
| `quotient_poly_commit_time_ms` |  15.32 |  61.28 |  17.74 |  12.73 |
| `pcs_opening_time_ms ` |  62 |  248 |  78 |  51 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 538 | 1 | 37 | 4,137,502 | 109.84 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 212 | 739 | 23,446,148 | 150,778,428 | 212 | 339 | 0 | 59.20 | 17.74 | 5 | 69.36 | 78 | 125 | 78 | 3 | 57 | 10,899,170 | 55 | 43 | 1,103,000 | 29.48 | 22 | 77 | 1 | 78 | 
| regex_program | 1 | 158 | 549 | 11,598,276 | 128,513,066 | 158 | 287 | 1 | 52.93 | 15.13 | 4 | 65.83 | 62 | 104 | 62 | 0 | 50 | 2,196,106 | 38 | 63 | 1,104,000 | 33.91 | 16 | 68 | 0 | 62 | 
| regex_program | 2 | 164 | 524 | 11,579,064 | 128,513,066 | 164 | 263 | 1 | 52.18 | 15.68 | 4 | 66.51 | 51 | 93 | 51 | 0 | 49 | 2,177,334 | 26 | 56 | 1,104,000 | 33.51 | 17 | 68 | 0 | 50 | 
| regex_program | 3 | 185 | 538 | 11,853,872 | 103,456,394 | 185 | 268 | 0 | 68.58 | 12.73 | 5 | 55.62 | 57 | 77 | 57 | 0 | 50 | 2,422,606 | 19 | 44 | 826,502 | 34.12 | 18 | 82 | 1 | 57 | 
...
Commit: https://github.com/openvm-org/openvm/commit/ebec4a6bf53ae7732208651a572514d43e6ad700
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19415943130)

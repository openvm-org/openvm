...
|:---|---:|---:|---:|
| Total |  11.40 |  3.57 |  3.57 |
| app_proof |  9.17 |  1.85 |  1.85 |
| leaf |  1.41 |  0.89 |  0.89 |
...
| `total_proof_time_ms ` |  1,505 |  9,030 |  1,714 |  1,440 |
| `execute_metered_time_ms` |  138 | -          | -          | -          |
| `execute_metered_insns` |  14,793,960 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  106.44 | -          |  106.44 |  106.44 |
| `execute_preflight_insns` |  2,465,660 |  14,793,960 |  2,625,000 |  1,670,960 |
| `execute_preflight_time_ms` |  125.50 |  753 |  160 |  88 |
| `execute_preflight_insn_mi/s` |  40.36 | -          |  41.04 |  37.56 |
| `trace_gen_time_ms   ` |  120.50 |  723 |  162 |  87 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,196.83 |  7,181 |  1,300 |  1,162 |
| `prover.main_trace_commit_time_ms` |  287.33 |  1,724 |  289 |  286 |
| `prover.rap_constraints_time_ms` |  817.67 |  4,906 |  920 |  784 |
| `prover.openings_time_ms` |  90.83 |  545 |  93 |  88 |
| `prover.rap_constraints.logup_gkr_time_ms` |  283 |  1,698 |  392 |  260 |
| `prover.rap_constraints.round0_time_ms` |  363.50 |  2,181 |  368 |  356 |
| `prover.rap_constraints.mle_rounds_time_ms` |  170 |  1,020 |  172 |  165 |
| `prover.openings.stacked_reduction_time_ms` |  61.33 |  368 |  63 |  61 |
| `prover.openings.stacked_reduction.round0_time_ms` |  32.17 |  193 |  33 |  32 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  28.50 |  171 |  30 |  28 |
| `prover.openings.whir_time_ms` |  29.17 |  175 |  31 |  27 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  703 |  1,406 |  892 |  514 |
| `execute_preflight_time_ms` |  2 |  4 |  2 |  2 |
| `trace_gen_time_ms   ` |  77.50 |  155 |  105 |  50 |
| `generate_blob_total_time_ms` |  10.50 |  21 |  14 |  7 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  624.50 |  1,249 |  786 |  463 |
| `prover.main_trace_commit_time_ms` |  317.50 |  635 |  411 |  224 |
| `prover.rap_constraints_time_ms` |  229 |  458 |  286 |  172 |
| `prover.openings_time_ms` |  77.50 |  155 |  88 |  67 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/acf9d226bb796675be5efb82d5e7af99639033ca/sha2_bench-acf9d226bb796675be5efb82d5e7af99639033ca.memory.svg)
...
| app_proof |  |  |  |  |  | 1,440 |  |  | 138 | 14,793,960 | 106.44 | 0 | 9,178 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 31 | 484 | 31 | 11 | 2 | 2 | 1 | 1 | 
| internal_recursive.0 | 1 | 12 | 185 | 12 | 2 | 1 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 9 | 155 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 |
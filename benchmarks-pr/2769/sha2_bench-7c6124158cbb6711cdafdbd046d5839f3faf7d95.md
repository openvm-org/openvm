...
|:---|---:|---:|---:|
| Total |  11.26 |  3.54 |  3.54 |
| app_proof |  9.05 |  1.84 |  1.84 |
| leaf |  1.39 |  0.88 |  0.88 |
...
| `total_proof_time_ms ` |  1,485.50 |  8,913 |  1,700 |  1,419 |
...
| `execute_preflight_time_ms` |  128.67 |  772 |  182 |  85 |
| `execute_preflight_insn_mi/s` |  40.13 | -          |  40.66 |  38.47 |
| `trace_gen_time_ms   ` |  113 |  678 |  160 |  60 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,181.17 |  7,087 |  1,290 |  1,144 |
| `prover.main_trace_commit_time_ms` |  283.17 |  1,699 |  284 |  283 |
| `prover.rap_constraints_time_ms` |  808 |  4,848 |  912 |  773 |
| `prover.openings_time_ms` |  89 |  534 |  93 |  86 |
| `prover.rap_constraints.logup_gkr_time_ms` |  281.17 |  1,687 |  392 |  258 |
| `prover.rap_constraints.round0_time_ms` |  360.50 |  2,163 |  368 |  353 |
| `prover.rap_constraints.mle_rounds_time_ms` |  165 |  990 |  168 |  161 |
| `prover.openings.stacked_reduction_time_ms` |  60 |  360 |  62 |  59 |
| `prover.openings.stacked_reduction.round0_time_ms` |  31.17 |  187 |  32 |  30 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  28.17 |  169 |  29 |  27 |
| `prover.openings.whir_time_ms` |  28.50 |  171 |  31 |  26 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  693.50 |  1,387 |  884 |  503 |
| `execute_preflight_time_ms` |  2 |  4 |  2 |  2 |
| `trace_gen_time_ms   ` |  80 |  160 |  112 |  48 |
| `generate_blob_total_time_ms` |  10.50 |  21 |  14 |  7 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  612.50 |  1,225 |  771 |  454 |
| `prover.main_trace_commit_time_ms` |  312.50 |  625 |  405 |  220 |
| `prover.rap_constraints_time_ms` |  223 |  446 |  279 |  167 |
| `prover.openings_time_ms` |  76.50 |  153 |  86 |  67 |
| `prover.rap_constraints.logup_gkr_time_ms` |  62.50 |  125 |  77 |  48 |
| `prover.rap_constraints.round0_time_ms` |  96.50 |  193 |  123 |  70 |
| `prover.rap_constraints.mle_rounds_time_ms` |  63 |  126 |  78 |  48 |
| `prover.openings.stacked_reduction_time_ms` |  46 |  92 |  54 |  38 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/7c6124158cbb6711cdafdbd046d5839f3faf7d95/sha2_bench-7c6124158cbb6711cdafdbd046d5839f3faf7d95.memory.svg)
...
| app_proof |  |  |  |  |  | 1,419 |  |  | 139 | 14,793,960 | 105.96 | 0 | 9,060 |  | 
| internal_for_leaf |  |  |  | 477 |  |  |  |  |  |  |  |  |  | 477 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 32 | 477 | 31 | 11 | 2 | 2 | 1 | 1 | 
| internal_recursive.0 | 1 | 13 | 187 | 13 | 2 | 1 | 2 | 2 | 2 | 
| internal_recursive.1 | 1 | 9 | 154 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 112 | 884 | 111 | 40 | 14 | 2 | 5 | 5 | 
| leaf | 1 | 48 | 503 | 48 | 19 | 7 | 2 | 3 | 3 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 100,404,864 | 445 | 223 | 0 | 13 | 163 | 45 | 45 | 84 | 32 | 0 | 57 | 20 | 36 | 6 | 29 | 223 | 163 | 0 | 2 | 32 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 25,962,119 | 173 | 50 | 0 | 4 | 76 | 24 | 23 | 29 | 22 | 0 | 45 | 21 | 24 | 1 | 22 | 51 | 76 | 0 | 2 | 21 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 17,507,975 | 145 | 33 | 0 | 4 | 65 | 23 | 22 | 24 | 17 | 0 | 45 | 22 | 22 | 1 | 21 | 34 | 65 | 0 | 2 | 16 | 0 | 0 | 
| leaf | 0 | prover | 341,718,010 | 771 | 405 | 0 | 26 | 279 | 123 | 123 | 78 | 77 | 0 | 86 | 31 | 54 | 21 | 33 | 405 | 279 | 0 | 5 | 76 | 0 | 0 | 
| leaf | 1 | prover | 179,641,792 | 454 | 219 | 0 | 14 | 167 | 70 | 69 | 48 | 48 | 0 | 67 | 28 | 38 | 11 | 27 | 220 | 167 | 0 | 5 | 47 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 630,037,121 | 1,290 | 284 | 0 | 21 | 912 | 353 | 352 | 166 | 392 | 144 | 93 | 31 | 62 | 32 | 29 | 284 | 912 | 0 | 3 | 247 | 0 | 0 | 
| app_proof | prover | 1 | 630,036,532 | 1,160 | 283 | 0 | 19 | 790 | 362 | 361 | 165 | 262 | 0 | 86 | 27 | 59 | 31 | 28 | 283 | 790 | 0 | 3 | 262 | 0 | 0 | 
| app_proof | prover | 2 | 630,036,532 | 1,155 | 283 | 0 | 19 | 784 | 360 | 360 | 164 | 258 | 0 | 87 | 27 | 59 | 31 | 28 | 283 | 784 | 0 | 3 | 257 | 0 | 0 | 
| app_proof | prover | 3 | 630,036,532 | 1,169 | 282 | 0 | 19 | 794 | 367 | 367 | 168 | 258 | 0 | 91 | 30 | 60 | 31 | 28 | 283 | 794 | 0 | 3 | 257 | 0 | 0 | 
| app_proof | prover | 4 | 630,036,532 | 1,169 | 283 | 0 | 19 | 795 | 368 | 368 | 166 | 259 | 0 | 90 | 30 | 60 | 32 | 27 | 283 | 795 | 0 | 3 | 258 | 0 | 0 | 
| app_proof | prover | 5 | 630,124,756 | 1,144 | 283 | 0 | 20 | 773 | 353 | 353 | 161 | 258 | 0 | 87 | 26 | 60 | 30 | 29 | 283 | 773 | 0 | 3 | 257 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 160 | 1,700 | 160 | 164 | 0 | 3 | 85 | 2,623,000 | 38.47 | 
| app_proof | 1 | 60 | 1,444 | 60 | 41 | 0 | 2 | 182 | 2,625,000 | 40.40 | 
| app_proof | 2 | 107 | 1,441 | 107 | 41 | 0 | 2 | 136 | 2,625,000 | 40.43 | 
| app_proof | 3 | 108 | 1,454 | 108 | 41 | 0 | 2 | 136 | 2,625,000 | 40.65 | 
| app_proof | 4 | 101 | 1,455 | 101 | 41 | 0 | 2 | 142 | 2,625,000 | 40.16 | 
| app_proof | 5 | 142 | 1,419 | 142 | 41 | 0 | 2 | 91 | 1,670,960 | 40.66 | 

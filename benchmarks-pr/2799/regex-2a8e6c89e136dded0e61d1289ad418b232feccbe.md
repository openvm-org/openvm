...
| `total_proof_time_ms ` |  697 |  1,394 |  757 |  637 |
| `execute_metered_time_ms` |  31 | -          | -          | -          |
| `execute_metered_insns` |  4,137,067 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  129.55 | -          |  129.55 |  129.55 |
| `execute_preflight_insns` |  2,068,533.50 |  4,137,067 |  2,208,000 |  1,929,067 |
| `execute_preflight_time_ms` |  73 |  146 |  78 |  68 |
| `execute_preflight_insn_mi/s` |  39.86 | -          |  40.76 |  38.96 |
| `trace_gen_time_ms   ` |  149 |  298 |  151 |  147 |
| `memory_finalize_time_ms` |  1 |  2 |  2 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  372 |  744 |  376 |  368 |
| `prover.main_trace_commit_time_ms` |  93 |  186 |  99 |  87 |
| `prover.rap_constraints_time_ms` |  238.50 |  477 |  250 |  227 |
| `prover.openings_time_ms` |  39.50 |  79 |  42 |  37 |
| `prover.rap_constraints.logup_gkr_time_ms` |  137 |  274 |  139 |  135 |
| `prover.rap_constraints.round0_time_ms` |  69 |  138 |  85 |  53 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/2a8e6c89e136dded0e61d1289ad418b232feccbe/regex-2a8e6c89e136dded0e61d1289ad418b232feccbe.memory.svg)
...
| app_proof |  |  |  |  |  | 637 |  |  | 31 | 4,137,067 | 129.55 | 0 | 1,440 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 15 | 227 | 14 | 4 | 0 | 2 | 0 | 0 | 
| internal_recursive.0 | 1 | 10 | 155 | 10 | 1 | 0 | 2 | 0 | 0 | 
| internal_recursive.1 | 1 | 9 | 130 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 48 | 350 | 48 | 13 | 2 | 5 | 1 | 1 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 27,256,571 | 212 | 81 | 0 | 0 | 97 | 32 | 32 | 45 | 19 | 0 | 32 | 21 | 11 | 2 | 8 | 81 | 97 | 0 | 2 | 18 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,703 | 144 | 45 | 0 | 0 | 67 | 25 | 25 | 27 | 13 | 0 | 31 | 22 | 8 | 1 | 6 | 45 | 67 | 0 | 2 | 12 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 121 | 31 | 0 | 0 | 62 | 24 | 23 | 24 | 13 | 0 | 26 | 19 | 7 | 1 | 5 | 31 | 62 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 79,962,804 | 301 | 126 | 0 | 0 | 133 | 54 | 53 | 37 | 41 | 0 | 40 | 25 | 15 | 6 | 8 | 127 | 133 | 0 | 5 | 41 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 123,384,338 | 368 | 98 | 0 | 0 | 227 | 53 | 53 | 34 | 139 | 0 | 42 | 22 | 19 | 10 | 9 | 99 | 227 | 0 | 3 | 137 | 0 | 0 | 
| app_proof | prover | 1 | 106,568,591 | 376 | 87 | 0 | 8 | 250 | 85 | 85 | 29 | 135 | 0 | 37 | 18 | 19 | 8 | 10 | 87 | 250 | 0 | 3 | 134 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 147 | 757 | 146 | 163 | 2 | 6 | 78 | 2,208,000 | 38.96 | 
| app_proof | 1 | 151 | 637 | 151 | 41 | 0 | 2 | 68 | 1,929,067 | 40.76 | 

...
| `total_proof_time_ms ` |  690.50 |  1,381 |  751 |  630 |
| `execute_metered_time_ms` |  31 | -          | -          | -          |
| `execute_metered_insns` |  4,137,067 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  129.85 | -          |  129.85 |  129.85 |
| `execute_preflight_insns` |  2,068,533.50 |  4,137,067 |  2,208,000 |  1,929,067 |
| `execute_preflight_time_ms` |  75.50 |  151 |  80 |  71 |
| `execute_preflight_insn_mi/s` |  37.30 | -          |  37.69 |  36.90 |
| `trace_gen_time_ms   ` |  145 |  290 |  145 |  145 |
| `memory_finalize_time_ms` |  1 |  2 |  2 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  367 |  734 |  372 |  362 |
| `prover.main_trace_commit_time_ms` |  90.50 |  181 |  93 |  88 |
| `prover.rap_constraints_time_ms` |  238 |  476 |  247 |  229 |
| `prover.openings_time_ms` |  37.50 |  75 |  39 |  36 |
| `prover.rap_constraints.logup_gkr_time_ms` |  136 |  272 |  139 |  133 |
| `prover.rap_constraints.round0_time_ms` |  69.50 |  139 |  84 |  55 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/fd79a5eabda1de96df61b7f9b913f58ddbfc68c6/regex-fd79a5eabda1de96df61b7f9b913f58ddbfc68c6.memory.svg)
...
| app_proof |  |  |  |  |  | 630 |  |  | 31 | 4,137,067 | 129.85 | 0 | 1,427 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 27,256,571 | 210 | 80 | 0 | 0 | 96 | 31 | 30 | 45 | 19 | 0 | 33 | 22 | 11 | 2 | 8 | 80 | 96 | 0 | 2 | 18 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,703 | 138 | 45 | 0 | 0 | 65 | 24 | 24 | 27 | 13 | 0 | 25 | 17 | 8 | 1 | 6 | 46 | 65 | 0 | 2 | 12 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 121 | 31 | 0 | 0 | 61 | 23 | 23 | 24 | 13 | 0 | 28 | 21 | 7 | 1 | 5 | 31 | 61 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 79,962,804 | 304 | 126 | 0 | 0 | 134 | 54 | 53 | 37 | 41 | 0 | 42 | 27 | 15 | 6 | 8 | 126 | 134 | 0 | 5 | 41 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 123,384,338 | 362 | 93 | 0 | 0 | 229 | 55 | 55 | 34 | 139 | 0 | 39 | 20 | 19 | 10 | 9 | 93 | 229 | 0 | 3 | 137 | 0 | 0 | 
| app_proof | prover | 1 | 106,568,591 | 372 | 87 | 0 | 8 | 247 | 84 | 84 | 29 | 133 | 0 | 36 | 17 | 19 | 8 | 10 | 88 | 247 | 0 | 2 | 132 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 145 | 751 | 145 | 162 | 2 | 8 | 80 | 2,208,000 | 36.90 | 
| app_proof | 1 | 145 | 630 | 145 | 40 | 0 | 2 | 71 | 1,929,067 | 37.69 | 

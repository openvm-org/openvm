...
| `execute_e3_insn_mi/s` |  17.07 | -          |  17.98 |  16.17 |
| `memory_finalize_time_ms` |  6.50 |  13 |  10 |  3 |
| `boundary_finalize_time_ms` |  2 |  4 |  4 |  0 |
| `merkle_finalize_time_ms` |  153.50 |  307 |  239 |  68 |
| `stark_prove_excluding_trace_time_ms` |  2,592 |  5,184 |  2,817 |  2,367 |
| `main_trace_commit_time_ms` |  509.50 |  1,019 |  574 |  445 |
| `generate_perm_trace_time_ms` |  203 |  406 |  227 |  179 |
| `perm_trace_commit_time_ms` |  558.50 |  1,117 |  599 |  518 |
| `quotient_poly_compute_time_ms` |  265.50 |  531 |  286 |  245 |
| `quotient_poly_commit_time_ms` |  239.50 |  479 |  274 |  205 |
| `pcs_opening_time_ms ` |  807.50 |  1,615 |  851 |  764 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 3,972 | 24 | 4,165,433 | 1 | 61 | 67.42 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 529 | 275,648,700 | 2,817 | 286 | 274 | 599 | 851 | 239 | 25 | 10 | 574 | 2,243,700 | 227 | 138 | 16.17 | 4 | 
| regex_program | 1 | 305 | 242,975,370 | 2,367 | 245 | 205 | 518 | 764 | 68 | 24 | 3 | 445 | 1,921,733 | 179 | 106 | 17.98 | 0 | 

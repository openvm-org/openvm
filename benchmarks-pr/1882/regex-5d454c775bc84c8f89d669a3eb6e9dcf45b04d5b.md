...
| `execute_e3_insn_mi/s` |  17.09 | -          |  17.99 |  16.19 |
| `memory_finalize_time_ms` |  6.50 |  13 |  11 |  2 |
| `boundary_finalize_time_ms` |  2 |  4 |  4 |  0 |
| `merkle_finalize_time_ms` |  153 |  306 |  237 |  69 |
| `stark_prove_excluding_trace_time_ms` |  2,633.50 |  5,267 |  2,853 |  2,414 |
| `main_trace_commit_time_ms` |  515.50 |  1,031 |  582 |  449 |
| `generate_perm_trace_time_ms` |  224.50 |  449 |  246 |  203 |
| `perm_trace_commit_time_ms` |  572 |  1,144 |  599 |  545 |
| `quotient_poly_compute_time_ms` |  260 |  520 |  284 |  236 |
| `quotient_poly_commit_time_ms` |  252.50 |  505 |  295 |  210 |
| `pcs_opening_time_ms ` |  799 |  1,598 |  841 |  757 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 4,044 | 24 | 4,165,433 | 1 | 61 | 67.60 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 520 | 275,648,700 | 2,853 | 284 | 295 | 599 | 841 | 237 | 25 | 11 | 582 | 2,243,700 | 246 | 138 | 16.19 | 4 | 
| regex_program | 1 | 301 | 242,975,370 | 2,414 | 236 | 210 | 545 | 757 | 69 | 24 | 2 | 449 | 1,921,733 | 203 | 106 | 17.99 | 0 | 

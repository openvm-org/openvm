...
| `execute_metered_insn_mi/s` |  67.10 | -          |  67.10 |  67.10 |
| `execute_e3_time_ms  ` |  122 |  244 |  138 |  106 |
| `execute_e3_insn_mi/s` |  17.08 | -          |  18.02 |  16.15 |
| `memory_finalize_time_ms` |  6.50 |  13 |  12 |  1 |
| `boundary_finalize_time_ms` |  2 |  4 |  4 |  0 |
| `merkle_finalize_time_ms` |  156 |  312 |  244 |  68 |
| `stark_prove_excluding_trace_time_ms` |  2,608.50 |  5,217 |  2,835 |  2,382 |
| `main_trace_commit_time_ms` |  524 |  1,048 |  580 |  468 |
| `generate_perm_trace_time_ms` |  212 |  424 |  231 |  193 |
| `perm_trace_commit_time_ms` |  563.50 |  1,127 |  612 |  515 |
| `quotient_poly_compute_time_ms` |  264 |  528 |  285 |  243 |
| `quotient_poly_commit_time_ms` |  239 |  478 |  273 |  205 |
| `pcs_opening_time_ms ` |  799 |  1,598 |  849 |  749 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 3,996 | 25 | 4,165,433 | 1 | 62 | 67.10 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 537 | 275,648,700 | 2,835 | 285 | 273 | 612 | 849 | 244 | 25 | 12 | 580 | 2,243,700 | 231 | 138 | 16.15 | 4 | 
| regex_program | 1 | 310 | 242,975,370 | 2,382 | 243 | 205 | 515 | 749 | 68 | 24 | 1 | 468 | 1,921,733 | 193 | 106 | 18.02 | 0 | 

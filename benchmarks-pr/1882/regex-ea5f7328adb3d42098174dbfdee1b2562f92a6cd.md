...
| `execute_metered_insn_mi/s` |  112.78 | -          |  112.78 |  112.78 |
| `execute_e3_time_ms  ` |  122 |  244 |  138 |  106 |
| `execute_e3_insn_mi/s` |  17.06 | -          |  17.96 |  16.16 |
| `memory_finalize_time_ms` |  6 |  12 |  10 |  2 |
| `boundary_finalize_time_ms` |  2 |  4 |  4 |  0 |
| `merkle_finalize_time_ms` |  155 |  310 |  241 |  69 |
| `stark_prove_excluding_trace_time_ms` |  3,048 |  6,096 |  3,821 |  2,275 |
| `main_trace_commit_time_ms` |  593.50 |  1,187 |  762 |  425 |
| `generate_perm_trace_time_ms` |  258 |  516 |  312 |  204 |
| `perm_trace_commit_time_ms` |  620 |  1,240 |  777 |  463 |
| `quotient_poly_compute_time_ms` |  331 |  662 |  425 |  237 |
| `quotient_poly_commit_time_ms` |  277 |  554 |  365 |  189 |
| `pcs_opening_time_ms ` |  961 |  1,922 |  1,176 |  746 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 3,918 | 24 | 4,165,433 | 1 | 36 | 112.78 | 62 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 528 | 211,864,680 | 373,166,268 | 3,821 | 425 | 365 | 777 | 1,176 | 241 | 25 | 10 | 762 | 91,153,694 | 2,244,000 | 312 | 138 | 16.16 | 4 | 
| regex_program | 1 | 302 | 176,237,560 | 242,975,370 | 2,275 | 237 | 189 | 463 | 746 | 69 | 24 | 2 | 425 | 74,277,990 | 1,921,433 | 204 | 106 | 17.96 | 0 | 

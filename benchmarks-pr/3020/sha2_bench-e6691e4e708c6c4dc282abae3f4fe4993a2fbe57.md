...
|:---|---:|---:|---:|
| Total |  5.46 |  3.95 |  3.95 |
| app_proof |  4.50 |  2.100 |  2.100 |
| leaf |  0.53 |  0.53 |  0.53 |
...
| `total_proof_time_ms ` |  2,220 |  4,440 |  2,939 |  1,501 |
...
| `execute_preflight_time_ms` |  160 |  320 |  206 |  114 |
| `execute_preflight_insn_mi/s` |  35.75 | -          |  35.88 |  35.63 |
| `trace_gen_time_ms   ` |  64.50 |  129 |  98 |  31 |
| `set_initial_memory_time_ms` |  0 |  0 |  0 |  0 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,994 |  3,988 |  2,634 |  1,354 |
| `prover.main_trace_commit_time_ms` |  702.50 |  1,405 |  1,187 |  218 |
| `prover.rap_constraints_time_ms` |  1,027 |  2,054 |  1,115 |  939 |
| `prover.openings_time_ms` |  263.50 |  527 |  331 |  196 |
| `prover.rap_constraints.logup_gkr_time_ms` |  343.50 |  687 |  465 |  222 |
| `prover.rap_constraints.round0_time_ms` |  505 |  1,010 |  664 |  346 |
| `prover.rap_constraints.mle_rounds_time_ms` |  177 |  354 |  228 |  126 |
| `prover.openings.stacked_reduction_time_ms` |  70.50 |  141 |  90 |  51 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/e6691e4e708c6c4dc282abae3f4fe4993a2fbe57/sha2_bench-e6691e4e708c6c4dc282abae3f4fe4993a2fbe57.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 58 |  |  |  | 295 |  |  |  |  |  |  | 
| app_proof |  |  |  | 1,501 |  | 56 | 11,167,961 | 197.13 | 0 | 4,505 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 177 | 46 | 0 | 0 | 78 | 28 | 27 | 37 | 13 | 0 | 51 | 40 | 10 | 2 | 7 | 47 | 46 | 78 | 0 | 1 | 12 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 113 | 20 | 0 | 0 | 58 | 23 | 22 | 23 | 11 | 0 | 34 | 26 | 7 | 1 | 6 | 20 | 20 | 58 | 0 | 1 | 10 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 96 | 15 | 0 | 0 | 54 | 20 | 19 | 21 | 12 | 0 | 26 | 18 | 7 | 1 | 5 | 15 | 15 | 54 | 0 | 1 | 10 | 0 | 0 | 
| leaf | 0 | prover | 237,929,144 | 406 | 145 | 0 | 0 | 141 | 70 | 69 | 44 | 25 | 0 | 119 | 97 | 21 | 10 | 11 | 146 | 145 | 141 | 0 | 3 | 25 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,233,945,850 | 2,634 | 1,187 | 0 | 0 | 1,115 | 664 | 663 | 228 | 222 | 1 | 331 | 240 | 90 | 55 | 34 | 1,187 | 1,187 | 1,115 | 0 | 1 | 221 | 0 | 0 | 
| app_proof | prover | 1 | 698,978,064 | 1,354 | 218 | 0 | 0 | 939 | 346 | 346 | 126 | 465 | 260 | 196 | 144 | 51 | 30 | 21 | 218 | 218 | 939 | 0 | 1 | 203 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 0 | 2 | 98 | 2,939 | 98 | 0 | 12,684,755,076 | 2,129,046,324 | 14,813,801,400 | 2,097,152 | 0 | 4 | 206 | 7,124,000 | 35.63 | 
| app_proof | 1 | 0 | 1 | 31 | 1,501 | 31 | 0 | 7,231,569,048 | 1,162,618,920 | 8,394,187,968 | 2,097,152 | 0 | 2 | 114 | 4,043,961 | 35.88 | 

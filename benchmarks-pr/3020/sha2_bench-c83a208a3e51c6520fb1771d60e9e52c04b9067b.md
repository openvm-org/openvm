...
| `total_proof_time_ms ` |  2,369 |  4,738 |  3,244 |  1,494 |
...
| `execute_preflight_time_ms` |  155.50 |  311 |  210 |  101 |
| `execute_preflight_insn_mi/s` |  38.18 | -          |  40.40 |  35.97 |
| `trace_gen_time_ms   ` |  67.50 |  135 |  108 |  27 |
| `set_initial_memory_time_ms` |  0 |  0 |  0 |  0 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  2,145 |  4,290 |  2,925 |  1,365 |
| `prover.main_trace_commit_time_ms` |  749.50 |  1,499 |  1,275 |  224 |
| `prover.rap_constraints_time_ms` |  1,120.50 |  2,241 |  1,296 |  945 |
| `prover.openings_time_ms` |  273.50 |  547 |  352 |  195 |
| `prover.rap_constraints.logup_gkr_time_ms` |  408 |  816 |  460 |  356 |
| `prover.rap_constraints.round0_time_ms` |  528.50 |  1,057 |  703 |  354 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/c83a208a3e51c6520fb1771d60e9e52c04b9067b/sha2_bench-c83a208a3e51c6520fb1771d60e9e52c04b9067b.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 59 |  |  |  | 290 |  |  |  |  |  |  | 
| app_proof |  |  |  | 1,494 |  | 56 | 11,167,961 | 197.27 | 0 | 4,804 |  | 
...
| leaf | 0 | 123 | 528 | 122 | 33 | 12 | 2 | 9 | 9 | 
...
| leaf | 0 | prover | 237,929,272 | 404 | 145 | 0 | 0 | 142 | 70 | 69 | 44 | 26 | 0 | 117 | 95 | 21 | 10 | 11 | 145 | 145 | 142 | 0 | 3 | 25 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,315,603,879 | 2,925 | 1,275 | 0 | 0 | 1,296 | 703 | 702 | 237 | 356 | 1 | 352 | 256 | 95 | 58 | 37 | 1,275 | 1,275 | 1,296 | 0 | 1 | 354 | 0 | 0 | 
| app_proof | prover | 1 | 709,400,372 | 1,365 | 223 | 0 | 0 | 945 | 354 | 354 | 129 | 460 | 278 | 195 | 142 | 53 | 31 | 21 | 224 | 223 | 945 | 0 | 1 | 182 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 0 | 2 | 108 | 3,244 | 4 | 0 | 0 | 0 | 12,820,745,040 | 2,969,266,308 | 15,790,011,348 | 2,097,152 | 2 | 0 | 0 | 1 | 3 | 103 | 210 | 7,136,000 | 35.97 | 0 | 0 | 
| app_proof | 1 | 0 | 1 | 27 | 1,494 | 2 | 0 | 0 | 0 | 7,276,211,748 | 1,627,054,965 | 8,903,266,713 | 2,097,152 | 1 | 0 | 0 | 0 | 2 | 24 | 101 | 4,031,961 | 40.40 | 0 | 0 | 

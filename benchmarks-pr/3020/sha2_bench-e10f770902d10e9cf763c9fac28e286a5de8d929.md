...
| `total_proof_time_ms ` |  2,363.50 |  4,727 |  3,232 |  1,495 |
...
| `execute_preflight_time_ms` |  167.50 |  335 |  221 |  114 |
| `execute_preflight_insn_mi/s` |  35.02 | -          |  35.94 |  34.11 |
| `trace_gen_time_ms   ` |  67 |  134 |  107 |  27 |
| `set_initial_memory_time_ms` |  0 |  0 |  0 |  0 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  2,127.50 |  4,255 |  2,902 |  1,353 |
| `prover.main_trace_commit_time_ms` |  744.50 |  1,489 |  1,267 |  222 |
| `prover.rap_constraints_time_ms` |  1,109.50 |  2,219 |  1,284 |  935 |
| `prover.openings_time_ms` |  272.50 |  545 |  350 |  195 |
| `prover.rap_constraints.logup_gkr_time_ms` |  402.50 |  805 |  455 |  350 |
| `prover.rap_constraints.round0_time_ms` |  526 |  1,052 |  700 |  352 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/e10f770902d10e9cf763c9fac28e286a5de8d929/sha2_bench-e10f770902d10e9cf763c9fac28e286a5de8d929.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 57 |  |  |  | 292 |  |  |  |  |  |  | 
| app_proof |  |  |  | 1,495 |  | 56 | 11,167,961 | 196.38 | 0 | 4,793 |  | 
...
| leaf | 0 | 127 | 531 | 126 | 34 | 13 | 2 | 10 | 10 | 
...
| leaf | 0 | prover | 237,929,272 | 403 | 144 | 0 | 0 | 141 | 70 | 69 | 44 | 25 | 0 | 117 | 95 | 21 | 10 | 11 | 144 | 144 | 141 | 0 | 3 | 25 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,315,603,879 | 2,902 | 1,267 | 0 | 0 | 1,284 | 700 | 699 | 233 | 350 | 1 | 350 | 255 | 94 | 58 | 36 | 1,267 | 1,267 | 1,284 | 0 | 1 | 348 | 0 | 0 | 
| app_proof | prover | 1 | 709,400,372 | 1,353 | 222 | 0 | 0 | 935 | 352 | 351 | 127 | 455 | 275 | 195 | 142 | 52 | 31 | 21 | 222 | 222 | 935 | 0 | 1 | 180 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 0 | 2 | 107 | 3,232 | 4 | 0 | 0 | 0 | 12,820,745,040 | 2,969,266,308 | 15,790,011,348 | 2,097,152 | 2 | 0 | 0 | 1 | 3 | 103 | 221 | 7,136,000 | 34.11 | 0 | 0 | 
| app_proof | 1 | 0 | 1 | 27 | 1,495 | 2 | 0 | 0 | 0 | 7,276,211,748 | 1,627,054,965 | 8,903,266,713 | 2,097,152 | 1 | 0 | 0 | 0 | 2 | 24 | 114 | 4,031,961 | 35.94 | 0 | 0 | 

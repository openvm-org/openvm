...
|:---|---:|---:|---:|
| Total |  5.53 |  4.02 |  4.02 |
| app_proof |  4.58 |  3.06 |  3.06 |
| leaf |  0.53 |  0.53 |  0.53 |
...
| `total_proof_time_ms ` |  2,260.50 |  4,521 |  3,005 |  1,516 |
...
| `execute_preflight_time_ms` |  159.50 |  319 |  211 |  108 |
| `execute_preflight_insn_mi/s` |  36.47 | -          |  38.06 |  34.87 |
| `trace_gen_time_ms   ` |  67.50 |  135 |  103 |  32 |
| `set_initial_memory_time_ms` |  0 |  0 |  0 |  0 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  2,031 |  4,062 |  2,688 |  1,374 |
| `prover.main_trace_commit_time_ms` |  728 |  1,456 |  1,238 |  218 |
| `prover.rap_constraints_time_ms` |  1,038 |  2,076 |  1,118 |  958 |
| `prover.openings_time_ms` |  264.50 |  529 |  332 |  197 |
| `prover.rap_constraints.logup_gkr_time_ms` |  353.50 |  707 |  483 |  224 |
| `prover.rap_constraints.round0_time_ms` |  505 |  1,010 |  664 |  346 |
| `prover.rap_constraints.mle_rounds_time_ms` |  178.50 |  357 |  230 |  127 |
...
| `prover.openings.whir_time_ms` |  192.50 |  385 |  241 |  144 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/f21f22a23a9c079be3d014cbb9f48df4d96855a9/sha2_bench-f21f22a23a9c079be3d014cbb9f48df4d96855a9.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 60 |  |  |  | 297 |  |  |  |  |  |  | 
| app_proof |  |  |  | 1,516 |  | 56 | 11,167,961 | 196.53 | 0 | 4,587 |  | 
...
| app_proof | VmAirWrapper<Rv64BaseAluU16AdapterAir, ShiftLogicalCoreAir<4, 16> | 1 | 2 | 3 | 
...
| leaf | 0 | 126 | 530 | 126 | 39 | 13 | 2 | 9 | 9 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 177 | 46 | 0 | 0 | 78 | 28 | 27 | 37 | 13 | 0 | 51 | 40 | 10 | 2 | 7 | 46 | 46 | 78 | 0 | 1 | 12 | 0 | 0 | 
...
| leaf | 0 | prover | 237,929,144 | 403 | 145 | 0 | 0 | 141 | 70 | 69 | 44 | 26 | 0 | 116 | 94 | 21 | 10 | 11 | 145 | 145 | 141 | 0 | 3 | 25 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,233,945,850 | 2,688 | 1,237 | 0 | 0 | 1,118 | 664 | 663 | 230 | 224 | 1 | 332 | 241 | 90 | 55 | 34 | 1,238 | 1,237 | 1,118 | 0 | 1 | 222 | 0 | 0 | 
| app_proof | prover | 1 | 698,978,064 | 1,374 | 218 | 0 | 0 | 958 | 346 | 346 | 127 | 483 | 278 | 197 | 144 | 52 | 31 | 21 | 218 | 218 | 958 | 0 | 1 | 204 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 0 | 2 | 103 | 3,005 | 103 | 0 | 12,684,755,076 | 2,129,046,324 | 14,813,801,400 | 2,097,152 | 0 | 4 | 211 | 7,124,000 | 34.87 | 
| app_proof | 1 | 0 | 1 | 32 | 1,516 | 32 | 0 | 7,231,569,048 | 1,162,618,920 | 8,394,187,968 | 2,097,152 | 0 | 2 | 108 | 4,043,961 | 38.06 | 

...
|:---|---:|---:|---:|
| Total |  5.46 |  3.99 |  3.99 |
| app_proof |  4.51 |  3.03 |  3.03 |
| leaf |  0.53 |  0.53 |  0.53 |
...
| `total_proof_time_ms ` |  2,225 |  4,450 |  2,975 |  1,475 |
| `compile_metered_time_ms` |  5 |  5 |  5 |  5 |
| `execute_metered_time_ms` |  57 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  195.20 | -          |  195.20 |  195.20 |
| `execute_preflight_insns` |  5,583,980.50 |  11,167,961 |  7,136,000 |  4,031,961 |
| `execute_preflight_time_ms` |  157.50 |  315 |  200 |  115 |
| `execute_preflight_insn_mi/s` |  36.05 | -          |  36.73 |  35.37 |
| `trace_gen_time_ms   ` |  63.50 |  127 |  100 |  27 |
| `set_initial_memory_time_ms` |  0 |  0 |  0 |  0 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  2,002.50 |  4,005 |  2,673 |  1,332 |
| `prover.main_trace_commit_time_ms` |  702 |  1,404 |  1,190 |  214 |
| `prover.rap_constraints_time_ms` |  1,031.50 |  2,063 |  1,137 |  926 |
| `prover.openings_time_ms` |  268.50 |  537 |  346 |  191 |
| `prover.rap_constraints.logup_gkr_time_ms` |  344 |  688 |  456 |  232 |
| `prover.rap_constraints.round0_time_ms` |  508 |  1,016 |  672 |  344 |
| `prover.rap_constraints.mle_rounds_time_ms` |  178 |  356 |  231 |  125 |
| `prover.openings.stacked_reduction_time_ms` |  72.50 |  145 |  94 |  51 |
...
| `prover.openings.whir_time_ms` |  195 |  390 |  251 |  139 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/89750e0dbde71bba3bf107bb4b6adda13be44b2b/sha2_bench-89750e0dbde71bba3bf107bb4b6adda13be44b2b.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 58 |  |  |  | 293 |  |  |  |  |  |  | 
| app_proof |  |  |  | 1,475 |  | 57 | 11,167,961 | 195.20 | 0 | 4,516 |  | 
...
| leaf | 0 | 123 | 529 | 122 | 37 | 12 | 2 | 9 | 9 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 179 | 46 | 0 | 0 | 78 | 28 | 27 | 37 | 13 | 0 | 53 | 43 | 10 | 2 | 7 | 47 | 46 | 78 | 0 | 1 | 12 | 0 | 0 | 
...
| leaf | 0 | prover | 237,929,144 | 406 | 146 | 0 | 0 | 141 | 71 | 69 | 44 | 26 | 0 | 117 | 95 | 22 | 10 | 11 | 146 | 146 | 141 | 0 | 3 | 25 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,280,083,194 | 2,673 | 1,189 | 0 | 0 | 1,137 | 672 | 672 | 231 | 232 | 1 | 346 | 251 | 94 | 57 | 36 | 1,190 | 1,189 | 1,137 | 0 | 1 | 230 | 0 | 0 | 
| app_proof | prover | 1 | 687,443,728 | 1,332 | 214 | 0 | 0 | 926 | 344 | 344 | 125 | 456 | 0 | 191 | 139 | 51 | 30 | 20 | 214 | 214 | 926 | 0 | 1 | 455 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 0 | 2 | 100 | 2,975 | 100 | 0 | 12,567,225,180 | 2,800,224,348 | 15,367,449,528 | 2,097,152 | 0 | 3 | 200 | 7,136,000 | 36.73 | 
| app_proof | 1 | 0 | 1 | 27 | 1,475 | 27 | 0 | 7,131,913,452 | 1,123,862,484 | 8,255,775,936 | 2,097,152 | 0 | 2 | 115 | 4,031,961 | 35.37 | 

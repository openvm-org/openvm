...
|:---|---:|---:|---:|
| Total |  5.51 |  4.02 |  4.02 |
| app_proof |  4.55 |  3.06 |  3.06 |
| leaf |  0.53 |  0.53 |  0.53 |
...
| `total_proof_time_ms ` |  2,246 |  4,492 |  3,003 |  1,489 |
...
| `execute_preflight_time_ms` |  165 |  330 |  216 |  114 |
| `execute_preflight_insn_mi/s` |  34.90 | -          |  35.73 |  34.06 |
| `trace_gen_time_ms   ` |  67.50 |  135 |  102 |  33 |
| `set_initial_memory_time_ms` |  0 |  0 |  0 |  0 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  2,012 |  4,024 |  2,684 |  1,340 |
| `prover.main_trace_commit_time_ms` |  725.50 |  1,451 |  1,231 |  220 |
| `prover.rap_constraints_time_ms` |  1,021.50 |  2,043 |  1,120 |  923 |
| `prover.openings_time_ms` |  264.50 |  529 |  332 |  197 |
| `prover.rap_constraints.logup_gkr_time_ms` |  336 |  672 |  447 |  225 |
| `prover.rap_constraints.round0_time_ms` |  505.50 |  1,011 |  664 |  347 |
| `prover.rap_constraints.mle_rounds_time_ms` |  179 |  358 |  230 |  128 |
...
| `prover.openings.whir_time_ms` |  193 |  386 |  241 |  145 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/d0d1dafe5e42ac6cea002336f46915ed4006a34d/sha2_bench-d0d1dafe5e42ac6cea002336f46915ed4006a34d.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 60 |  |  |  | 301 |  |  |  |  |  |  | 
| app_proof |  |  |  | 1,489 |  | 56 | 11,167,961 | 197.48 | 0 | 4,557 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 173 | 46 | 0 | 0 | 79 | 28 | 27 | 37 | 13 | 0 | 46 | 36 | 10 | 2 | 7 | 47 | 46 | 79 | 0 | 1 | 13 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 116 | 20 | 0 | 0 | 59 | 23 | 22 | 23 | 12 | 0 | 36 | 28 | 7 | 1 | 6 | 20 | 20 | 59 | 0 | 1 | 10 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 97 | 15 | 0 | 0 | 54 | 20 | 19 | 22 | 11 | 0 | 27 | 20 | 7 | 1 | 5 | 15 | 15 | 54 | 0 | 1 | 10 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,233,945,850 | 2,684 | 1,231 | 0 | 0 | 1,120 | 664 | 663 | 230 | 225 | 1 | 332 | 241 | 90 | 55 | 34 | 1,231 | 1,231 | 1,120 | 0 | 1 | 223 | 0 | 0 | 
| app_proof | prover | 1 | 698,978,064 | 1,340 | 219 | 0 | 0 | 923 | 347 | 347 | 128 | 447 | 276 | 197 | 145 | 52 | 31 | 21 | 220 | 219 | 923 | 0 | 1 | 170 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 0 | 2 | 102 | 3,003 | 102 | 0 | 12,684,755,076 | 2,129,046,324 | 14,813,801,400 | 2,097,152 | 0 | 4 | 216 | 7,124,000 | 34.06 | 
| app_proof | 1 | 0 | 1 | 33 | 1,489 | 33 | 0 | 7,231,569,048 | 1,162,618,920 | 8,394,187,968 | 2,097,152 | 0 | 2 | 114 | 4,043,961 | 35.73 | 

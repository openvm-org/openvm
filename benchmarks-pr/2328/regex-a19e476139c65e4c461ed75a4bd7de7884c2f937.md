...
| `total_proof_time_ms ` |  594.75 |  2,379 |  735 |  544 |
...
| `execute_preflight_insn_mi/s` |  30.78 | -          |  32.25 |  27.55 |
| `trace_gen_time_ms   ` |  177 |  708 |  210 |  154 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  289.75 |  1,159 |  309 |  279 |
| `main_trace_commit_time_ms` |  51.75 |  207 |  56 |  50 |
| `generate_perm_trace_time_ms` |  27.25 |  109 |  40 |  20 |
| `perm_trace_commit_time_ms` |  65.06 |  260.22 |  72.29 |  55.93 |
| `quotient_poly_compute_time_ms` |  59.36 |  237.45 |  69.86 |  53.44 |
| `quotient_poly_commit_time_ms` |  15.71 |  62.85 |  17.63 |  13.48 |
| `pcs_opening_time_ms ` |  67.25 |  269 |  74 |  60 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 549 | 1 | 36 | 4,137,502 | 114.51 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 210 | 735 | 23,446,148 | 150,778,428 | 210 | 309 | 0 | 59.53 | 17.63 | 5 | 72.29 | 60 | 113 | 60 | 4 | 56 | 10,899,170 | 40 | 47 | 1,103,000 | 27.55 | 22 | 77 | 1 | 60 | 
| regex_program | 1 | 154 | 544 | 11,598,276 | 128,513,066 | 154 | 282 | 1 | 54.61 | 15.42 | 4 | 66.59 | 72 | 87 | 72 | 0 | 51 | 2,196,106 | 20 | 66 | 1,104,000 | 31.56 | 17 | 70 | 0 | 72 | 
| regex_program | 2 | 162 | 551 | 11,579,064 | 128,513,066 | 162 | 289 | 1 | 53.44 | 16.31 | 4 | 65.41 | 74 | 94 | 73 | 0 | 50 | 2,177,334 | 28 | 58 | 1,104,000 | 32.25 | 17 | 70 | 0 | 73 | 
| regex_program | 3 | 182 | 549 | 11,853,872 | 103,456,394 | 182 | 279 | 0 | 69.86 | 13.48 | 5 | 55.93 | 63 | 80 | 63 | 0 | 50 | 2,422,606 | 21 | 46 | 826,502 | 31.76 | 19 | 84 | 1 | 63 | 
...
Commit: https://github.com/openvm-org/openvm/commit/a19e476139c65e4c461ed75a4bd7de7884c2f937
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/20507157339)

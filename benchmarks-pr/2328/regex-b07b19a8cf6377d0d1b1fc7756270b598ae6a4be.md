...
| `total_proof_time_ms ` |  598 |  2,392 |  737 |  549 |
...
| `execute_metered_insn_mi/s` |  112.61 | -          |  112.61 |  112.61 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  53 |  212 |  64 |  44 |
| `execute_preflight_insn_mi/s` |  31.41 | -          |  32.37 |  28.70 |
| `trace_gen_time_ms   ` |  180.25 |  721 |  213 |  158 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  290.50 |  1,162 |  307 |  278 |
| `main_trace_commit_time_ms` |  51.50 |  206 |  56 |  49 |
| `generate_perm_trace_time_ms` |  26.75 |  107 |  37 |  20 |
| `perm_trace_commit_time_ms` |  64.97 |  259.87 |  70.90 |  54.97 |
| `quotient_poly_compute_time_ms` |  61.12 |  244.47 |  71.87 |  54.93 |
| `quotient_poly_commit_time_ms` |  15.99 |  63.97 |  18.25 |  13.81 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 549 | 1 | 36 | 4,137,502 | 112.61 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 213 | 737 | 23,446,148 | 150,778,428 | 213 | 307 | 0 | 61.96 | 18.25 | 5 | 70.90 | 59 | 109 | 59 | 4 | 56 | 10,899,170 | 37 | 46 | 1,103,000 | 28.70 | 22 | 80 | 1 | 59 | 
| regex_program | 1 | 158 | 549 | 11,598,276 | 128,513,066 | 158 | 285 | 1 | 55.71 | 15.69 | 4 | 66.98 | 72 | 89 | 72 | 0 | 51 | 2,196,106 | 21 | 64 | 1,104,000 | 32.24 | 17 | 71 | 0 | 72 | 
| regex_program | 2 | 165 | 557 | 11,579,064 | 128,513,066 | 165 | 292 | 1 | 54.93 | 16.21 | 4 | 67.02 | 73 | 96 | 73 | 0 | 50 | 2,177,334 | 29 | 58 | 1,104,000 | 32.37 | 17 | 71 | 0 | 73 | 
| regex_program | 3 | 185 | 549 | 11,853,872 | 103,456,394 | 185 | 278 | 0 | 71.87 | 13.81 | 5 | 54.97 | 63 | 78 | 62 | 0 | 49 | 2,422,606 | 20 | 44 | 826,502 | 32.33 | 19 | 86 | 1 | 62 | 

...
| `total_proof_time_ms ` |  727 |  1,454 |  847 |  607 |
...
| `execute_preflight_insn_mi/s` |  14.44 | -          |  17.86 |  11.01 |
| `trace_gen_time_ms   ` |  188.50 |  377 |  193 |  184 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  348.50 |  697 |  386 |  311 |
| `main_trace_commit_time_ms` |  64 |  128 |  74 |  54 |
| `generate_perm_trace_time_ms` |  34.50 |  69 |  39 |  30 |
| `perm_trace_commit_time_ms` |  76.02 |  152.03 |  87.79 |  64.24 |
| `quotient_poly_compute_time_ms` |  83.13 |  166.27 |  91.09 |  75.17 |
| `quotient_poly_commit_time_ms` |  17.09 |  34.19 |  19.09 |  15.10 |
| `pcs_opening_time_ms ` |  68.50 |  137 |  69 |  68 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 607 | 1 | 63 | 1,745,742 | 27.59 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 184 | 847 | 32,480,114 | 172,558,444 | 184 | 386 | 0 | 91.09 | 19.09 | 6 | 87.79 | 69 | 130 | 69 | 1 | 74 | 15,909,408 | 39 | 108 | 1,149,000 | 11.01 | 27 | 111 | 1 | 69 | 
| pairing | 1 | 193 | 607 | 22,464,232 | 119,958,502 | 193 | 311 | 1 | 75.17 | 15.10 | 5 | 64.24 | 68 | 97 | 68 | 0 | 54 | 9,498,894 | 30 | 60 | 596,742 | 17.86 | 21 | 90 | 1 | 68 | 

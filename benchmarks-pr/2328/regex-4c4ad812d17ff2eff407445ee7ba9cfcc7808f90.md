...
|:---|---:|---:|---:|
| Total |  2.39 |  0.76 | 0.76 |
| regex_program |  2.39 |  0.76 |  0.76 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  588.75 |  2,355 |  726 |  541 |
...
| `execute_preflight_insn_mi/s` |  31.61 | -          |  32.62 |  28.92 |
| `trace_gen_time_ms   ` |  176.75 |  707 |  210 |  154 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  284.50 |  1,138 |  300 |  272 |
| `main_trace_commit_time_ms` |  51.25 |  205 |  57 |  48 |
| `generate_perm_trace_time_ms` |  23.25 |  93 |  28 |  20 |
| `perm_trace_commit_time_ms` |  63.88 |  255.53 |  69.98 |  54.52 |
| `quotient_poly_compute_time_ms` |  59.03 |  236.12 |  68.99 |  52.69 |
| `quotient_poly_commit_time_ms` |  15.58 |  62.31 |  18.32 |  13.18 |
| `pcs_opening_time_ms ` |  68.25 |  273 |  72 |  62 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 541 | 1 | 36 | 4,137,502 | 112.53 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 210 | 726 | 23,446,148 | 150,778,428 | 210 | 300 | 0 | 60.98 | 18.32 | 5 | 69.98 | 67 | 94 | 67 | 4 | 57 | 10,899,170 | 24 | 45 | 1,103,000 | 28.92 | 22 | 80 | 1 | 67 | 
| regex_program | 1 | 154 | 542 | 11,598,276 | 128,513,066 | 154 | 281 | 1 | 53.46 | 15.100 | 5 | 66.66 | 72 | 88 | 72 | 0 | 50 | 2,196,106 | 21 | 65 | 1,104,000 | 32.28 | 17 | 70 | 0 | 72 | 
| regex_program | 2 | 161 | 546 | 11,579,064 | 128,513,066 | 161 | 285 | 1 | 52.69 | 14.81 | 4 | 64.36 | 72 | 93 | 72 | 0 | 50 | 2,177,334 | 28 | 58 | 1,104,000 | 32.60 | 16 | 68 | 0 | 72 | 
| regex_program | 3 | 182 | 541 | 11,853,872 | 103,456,394 | 182 | 272 | 0 | 68.99 | 13.18 | 5 | 54.52 | 62 | 77 | 62 | 0 | 48 | 2,422,606 | 20 | 45 | 826,502 | 32.62 | 19 | 83 | 1 | 62 | 
...
Commit: https://github.com/openvm-org/openvm/commit/4c4ad812d17ff2eff407445ee7ba9cfcc7808f90
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/20499041185)

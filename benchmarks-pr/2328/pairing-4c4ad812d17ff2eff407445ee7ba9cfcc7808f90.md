...
|:---|---:|---:|---:|
| Total |  1.52 |  0.92 | 0.92 |
| pairing |  1.52 |  0.92 |  0.92 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  728 |  1,456 |  857 |  599 |
...
| `execute_metered_insn_mi/s` |  27.51 | -          |  27.51 |  27.51 |
| `execute_preflight_insns` |  872,871 |  1,745,742 |  1,149,000 |  596,742 |
| `execute_preflight_time_ms` |  83 |  166 |  106 |  60 |
| `execute_preflight_insn_mi/s` |  14.67 | -          |  18.17 |  11.16 |
| `trace_gen_time_ms   ` |  187.50 |  375 |  192 |  183 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  351.50 |  703 |  398 |  305 |
| `main_trace_commit_time_ms` |  62.50 |  125 |  73 |  52 |
| `generate_perm_trace_time_ms` |  40.50 |  81 |  43 |  38 |
| `perm_trace_commit_time_ms` |  75.66 |  151.32 |  88.26 |  63.06 |
| `quotient_poly_compute_time_ms` |  83.24 |  166.48 |  92.40 |  74.08 |
| `quotient_poly_commit_time_ms` |  17.38 |  34.75 |  19.34 |  15.41 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 599 | 1 | 63 | 1,745,742 | 27.51 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 183 | 857 | 32,480,114 | 172,558,444 | 183 | 398 | 0 | 92.40 | 19.34 | 6 | 88.26 | 76 | 134 | 76 | 1 | 73 | 15,909,408 | 43 | 106 | 1,149,000 | 11.16 | 27 | 112 | 1 | 76 | 
| pairing | 1 | 192 | 599 | 22,464,232 | 119,958,502 | 192 | 305 | 1 | 74.08 | 15.41 | 6 | 63.06 | 57 | 104 | 57 | 0 | 52 | 9,498,894 | 38 | 60 | 596,742 | 18.17 | 21 | 90 | 1 | 57 | 

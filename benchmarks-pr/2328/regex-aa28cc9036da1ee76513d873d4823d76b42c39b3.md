...
| `total_proof_time_ms ` |  596.50 |  2,386 |  735 |  547 |
...
| `execute_preflight_insn_mi/s` |  31.66 | -          |  32.79 |  29.01 |
| `trace_gen_time_ms   ` |  177.75 |  711 |  210 |  156 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  290.50 |  1,162 |  309 |  280 |
| `main_trace_commit_time_ms` |  52.25 |  209 |  56 |  51 |
| `generate_perm_trace_time_ms` |  26.50 |  106 |  36 |  21 |
| `perm_trace_commit_time_ms` |  64.68 |  258.71 |  70.28 |  56.10 |
| `quotient_poly_compute_time_ms` |  60.29 |  241.15 |  70.61 |  53.22 |
| `quotient_poly_commit_time_ms` |  15.98 |  63.92 |  18.24 |  13.71 |
| `pcs_opening_time_ms ` |  67.50 |  270 |  74 |  62 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 551 | 1 | 37 | 4,137,502 | 110.96 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 210 | 735 | 23,446,148 | 150,778,428 | 210 | 309 | 0 | 62.83 | 18.24 | 5 | 70.28 | 62 | 108 | 62 | 4 | 56 | 10,899,170 | 36 | 46 | 1,103,000 | 29.01 | 21 | 81 | 1 | 62 | 
| regex_program | 1 | 156 | 547 | 11,598,276 | 128,513,066 | 156 | 283 | 1 | 54.49 | 15.73 | 4 | 66.68 | 72 | 88 | 72 | 0 | 51 | 2,196,106 | 21 | 65 | 1,104,000 | 32.79 | 17 | 70 | 0 | 72 | 
| regex_program | 2 | 161 | 553 | 11,579,064 | 128,513,066 | 161 | 290 | 1 | 53.22 | 16.24 | 4 | 65.66 | 74 | 94 | 73 | 0 | 51 | 2,177,334 | 28 | 60 | 1,104,000 | 32.07 | 17 | 70 | 0 | 73 | 
| regex_program | 3 | 184 | 551 | 11,853,872 | 103,456,394 | 184 | 280 | 0 | 70.61 | 13.71 | 5 | 56.10 | 62 | 80 | 62 | 0 | 51 | 2,422,606 | 21 | 45 | 826,502 | 32.77 | 19 | 85 | 1 | 62 | 
...
Commit: https://github.com/openvm-org/openvm/commit/aa28cc9036da1ee76513d873d4823d76b42c39b3
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/20385501079)

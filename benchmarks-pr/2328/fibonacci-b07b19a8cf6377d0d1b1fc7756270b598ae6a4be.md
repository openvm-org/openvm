...
| `total_proof_time_ms ` |  512 |  1,024 |  585 |  439 |
...
| `execute_metered_insn_mi/s` |  107.23 | -          |  107.23 |  107.23 |
| `execute_preflight_insns` |  750,104.50 |  1,500,209 |  873,000 |  627,209 |
| `execute_preflight_time_ms` |  28 |  56 |  32 |  24 |
| `execute_preflight_insn_mi/s` |  38.29 | -          |  40.45 |  36.13 |
| `trace_gen_time_ms   ` |  193.50 |  387 |  198 |  189 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  185.50 |  371 |  194 |  177 |
| `main_trace_commit_time_ms` |  30.50 |  61 |  33 |  28 |
| `generate_perm_trace_time_ms` |  22 |  44 |  23 |  21 |
| `perm_trace_commit_time_ms` |  41.89 |  83.78 |  45.23 |  38.55 |
| `quotient_poly_compute_time_ms` |  31.76 |  63.53 |  34.71 |  28.82 |
| `quotient_poly_commit_time_ms` |  13.28 |  26.56 |  13.89 |  12.67 |
| `pcs_opening_time_ms ` |  44 |  88 |  45 |  43 |
...
| --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 439 | 1 | 13 | 1,500,209 | 107.23 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 198 | 585 | 9,677,708 | 84,395,212 | 198 | 194 | 0 | 34.71 | 13.89 | 4 | 45.23 | 43 | 68 | 43 | 0 | 33 | 1,035,986 | 23 | 24 | 873,000 | 36.13 | 14 | 49 | 0 | 43 | 
| fibonacci_program | 1 | 189 | 439 | 9,708,170 | 74,305,770 | 189 | 177 | 1 | 28.82 | 12.67 | 4 | 38.55 | 45 | 60 | 45 | 0 | 28 | 1,064,416 | 21 | 32 | 627,209 | 40.45 | 11 | 41 | 0 | 45 | 
...
Commit: https://github.com/openvm-org/openvm/commit/b07b19a8cf6377d0d1b1fc7756270b598ae6a4be
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/20384684062)

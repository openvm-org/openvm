...
| `total_proof_time_ms ` |  589.75 |  2,359 |  731 |  535 |
...
| `execute_preflight_insn_mi/s` |  31.50 | -          |  32.81 |  28.33 |
| `trace_gen_time_ms   ` |  177.50 |  710 |  212 |  153 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  285.50 |  1,142 |  304 |  275 |
| `main_trace_commit_time_ms` |  51 |  204 |  56 |  49 |
| `generate_perm_trace_time_ms` |  26.75 |  107 |  37 |  20 |
| `perm_trace_commit_time_ms` |  63.34 |  253.35 |  69.36 |  55.11 |
| `quotient_poly_compute_time_ms` |  59.33 |  237.31 |  70.51 |  52.59 |
| `quotient_poly_commit_time_ms` |  15.51 |  62.02 |  18.53 |  13.48 |
| `pcs_opening_time_ms ` |  66.50 |  266 |  73 |  59 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 547 | 1 | 36 | 4,137,502 | 111.95 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 212 | 731 | 23,446,148 | 150,778,428 | 212 | 304 | 0 | 61.56 | 18.53 | 5 | 69.36 | 59 | 107 | 59 | 4 | 56 | 10,899,170 | 37 | 45 | 1,103,000 | 28.33 | 22 | 80 | 1 | 59 | 
| regex_program | 1 | 153 | 535 | 11,598,276 | 128,513,066 | 153 | 275 | 1 | 52.59 | 14.72 | 4 | 64.74 | 71 | 85 | 71 | 0 | 49 | 2,196,106 | 20 | 65 | 1,104,000 | 32.28 | 16 | 67 | 0 | 71 | 
| regex_program | 2 | 162 | 546 | 11,579,064 | 128,513,066 | 162 | 285 | 1 | 52.66 | 15.29 | 4 | 64.14 | 73 | 92 | 73 | 0 | 50 | 2,177,334 | 28 | 57 | 1,104,000 | 32.81 | 17 | 68 | 0 | 73 | 
| regex_program | 3 | 183 | 547 | 11,853,872 | 103,456,394 | 183 | 278 | 0 | 70.51 | 13.48 | 5 | 55.11 | 63 | 80 | 63 | 0 | 49 | 2,422,606 | 22 | 44 | 826,502 | 32.58 | 19 | 85 | 1 | 63 | 

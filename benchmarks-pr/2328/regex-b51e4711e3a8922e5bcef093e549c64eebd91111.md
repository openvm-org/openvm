...
|:---|---:|---:|---:|
| Total |  2.41 |  0.76 | 0.76 |
| regex_program |  2.41 |  0.76 |  0.76 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  594.25 |  2,377 |  723 |  550 |
...
| `execute_preflight_insn_mi/s` |  31.58 | -          |  32.75 |  28.52 |
| `trace_gen_time_ms   ` |  179 |  716 |  213 |  155 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  286.50 |  1,146 |  292 |  280 |
| `main_trace_commit_time_ms` |  52.50 |  210 |  58 |  50 |
| `generate_perm_trace_time_ms` |  24.50 |  98 |  28 |  21 |
| `perm_trace_commit_time_ms` |  65.31 |  261.25 |  71.83 |  56.05 |
| `quotient_poly_compute_time_ms` |  59.87 |  239.49 |  70.52 |  53.61 |
| `quotient_poly_commit_time_ms` |  15.76 |  63.02 |  17.64 |  13.42 |
| `pcs_opening_time_ms ` |  66 |  264 |  73 |  55 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 552 | 1 | 36 | 4,137,502 | 112.79 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 213 | 723 | 23,446,148 | 150,778,428 | 213 | 292 | 0 | 60.26 | 17.64 | 5 | 71.83 | 55 | 100 | 55 | 4 | 58 | 10,899,170 | 27 | 46 | 1,103,000 | 28.52 | 21 | 78 | 1 | 55 | 
| regex_program | 1 | 155 | 550 | 11,598,276 | 128,513,066 | 155 | 286 | 1 | 55.10 | 16.12 | 4 | 68.19 | 72 | 91 | 72 | 0 | 50 | 2,196,106 | 22 | 67 | 1,104,000 | 32.75 | 17 | 71 | 0 | 72 | 
| regex_program | 2 | 163 | 552 | 11,579,064 | 128,513,066 | 163 | 288 | 1 | 53.61 | 15.84 | 4 | 65.18 | 73 | 93 | 73 | 0 | 51 | 2,177,334 | 28 | 59 | 1,104,000 | 32.47 | 17 | 70 | 0 | 73 | 
| regex_program | 3 | 185 | 552 | 11,853,872 | 103,456,394 | 185 | 280 | 0 | 70.52 | 13.42 | 5 | 56.05 | 64 | 80 | 63 | 0 | 51 | 2,422,606 | 21 | 45 | 826,502 | 32.57 | 19 | 85 | 1 | 63 | 

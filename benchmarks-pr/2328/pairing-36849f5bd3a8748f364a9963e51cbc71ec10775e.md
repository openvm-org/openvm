...
| `total_proof_time_ms ` |  735 |  1,470 |  863 |  607 |
...
| `execute_metered_insn_mi/s` |  22.39 | -          |  22.39 |  22.39 |
| `execute_preflight_insns` |  872,871 |  1,745,742 |  1,149,000 |  596,742 |
| `execute_preflight_time_ms` |  83 |  166 |  106 |  60 |
| `execute_preflight_insn_mi/s` |  14.67 | -          |  18.12 |  11.23 |
| `trace_gen_time_ms   ` |  188.50 |  377 |  194 |  183 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  358 |  716 |  405 |  311 |
| `main_trace_commit_time_ms` |  64.50 |  129 |  74 |  55 |
| `generate_perm_trace_time_ms` |  45 |  90 |  53 |  37 |
| `perm_trace_commit_time_ms` |  76.68 |  153.36 |  88.10 |  65.26 |
| `quotient_poly_compute_time_ms` |  81.80 |  163.60 |  89.57 |  74.03 |
| `quotient_poly_commit_time_ms` |  15.73 |  31.47 |  16.59 |  14.88 |
| `pcs_opening_time_ms ` |  68.50 |  137 |  77 |  60 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 607 | 1 | 77 | 1,745,742 | 22.39 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 183 | 863 | 32,480,114 | 172,558,444 | 183 | 405 | 0 | 89.57 | 16.59 | 6 | 88.10 | 77 | 145 | 77 | 1 | 74 | 15,909,408 | 53 | 106 | 1,149,000 | 11.23 | 26 | 106 | 1 | 77 | 
| pairing | 1 | 194 | 607 | 22,464,232 | 119,958,502 | 194 | 311 | 1 | 74.03 | 14.88 | 6 | 65.26 | 60 | 105 | 60 | 0 | 55 | 9,498,894 | 37 | 60 | 596,742 | 18.12 | 21 | 89 | 1 | 60 | 

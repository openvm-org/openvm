...
| `total_proof_time_ms ` |  730 |  1,460 |  855 |  605 |
...
| `execute_preflight_insn_mi/s` |  14.82 | -          |  18.44 |  11.21 |
| `trace_gen_time_ms   ` |  186 |  372 |  192 |  180 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  355 |  710 |  398 |  312 |
| `main_trace_commit_time_ms` |  63.50 |  127 |  74 |  53 |
| `generate_perm_trace_time_ms` |  41 |  82 |  43 |  39 |
| `perm_trace_commit_time_ms` |  75.93 |  151.87 |  88.14 |  63.73 |
| `quotient_poly_compute_time_ms` |  82.80 |  165.61 |  92.50 |  73.11 |
| `quotient_poly_commit_time_ms` |  17.09 |  34.18 |  19.81 |  14.37 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 605 | 1 | 63 | 1,745,742 | 27.43 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 180 | 855 | 32,480,114 | 172,558,444 | 180 | 398 | 0 | 92.50 | 19.81 | 6 | 88.14 | 76 | 134 | 75 | 1 | 74 | 15,909,408 | 43 | 106 | 1,149,000 | 11.21 | 27 | 113 | 1 | 75 | 
| pairing | 1 | 192 | 605 | 22,464,232 | 119,958,502 | 192 | 312 | 1 | 73.11 | 14.37 | 6 | 63.73 | 65 | 105 | 64 | 0 | 53 | 9,498,894 | 39 | 59 | 596,742 | 18.44 | 21 | 88 | 1 | 64 | 

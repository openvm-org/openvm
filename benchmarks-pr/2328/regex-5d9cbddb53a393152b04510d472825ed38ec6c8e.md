...
| `total_proof_time_ms ` |  597 |  2,388 |  736 |  550 |
...
| `execute_metered_insn_mi/s` |  112.72 | -          |  112.72 |  112.72 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  55 |  220 |  67 |  46 |
| `execute_preflight_insn_mi/s` |  31.12 | -          |  32.21 |  28 |
| `trace_gen_time_ms   ` |  177 |  708 |  210 |  154 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  291 |  1,164 |  308 |  280 |
| `main_trace_commit_time_ms` |  51.75 |  207 |  57 |  49 |
| `generate_perm_trace_time_ms` |  27.50 |  110 |  38 |  22 |
| `perm_trace_commit_time_ms` |  63.86 |  255.43 |  69.51 |  55.74 |
| `quotient_poly_compute_time_ms` |  59.54 |  238.17 |  70.05 |  52.71 |
| `quotient_poly_commit_time_ms` |  15.98 |  63.93 |  18.67 |  14.20 |
| `pcs_opening_time_ms ` |  69.25 |  277 |  81 |  59 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 551 | 1 | 36 | 4,137,502 | 112.72 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 210 | 736 | 23,446,148 | 150,778,428 | 210 | 308 | 0 | 62.23 | 18.67 | 5 | 69.51 | 59 | 108 | 59 | 4 | 57 | 10,899,170 | 38 | 47 | 1,103,000 | 28 | 22 | 81 | 1 | 59 | 
| regex_program | 1 | 154 | 551 | 11,598,276 | 128,513,066 | 154 | 289 | 1 | 52.71 | 15.57 | 4 | 65.79 | 81 | 88 | 81 | 0 | 49 | 2,196,106 | 22 | 67 | 1,104,000 | 32.21 | 17 | 68 | 0 | 81 | 
| regex_program | 2 | 161 | 550 | 11,579,064 | 128,513,066 | 161 | 287 | 1 | 53.20 | 15.50 | 4 | 64.39 | 73 | 93 | 72 | 0 | 51 | 2,177,334 | 28 | 60 | 1,104,000 | 32.06 | 17 | 69 | 0 | 72 | 
| regex_program | 3 | 183 | 551 | 11,853,872 | 103,456,394 | 183 | 280 | 0 | 70.05 | 14.20 | 5 | 55.74 | 64 | 80 | 63 | 0 | 50 | 2,422,606 | 22 | 46 | 826,502 | 32.20 | 19 | 85 | 1 | 63 | 

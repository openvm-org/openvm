...
| `total_proof_time_ms ` |  740 |  1,480 |  873 |  607 |
...
| `execute_preflight_insn_mi/s` |  14.90 | -          |  18.53 |  11.27 |
| `trace_gen_time_ms   ` |  191 |  382 |  196 |  186 |
| `memory_finalize_time_ms` |  1 |  2 |  1 |  1 |
| `stark_prove_excluding_trace_time_ms` |  362.50 |  725 |  415 |  310 |
| `main_trace_commit_time_ms` |  65 |  130 |  75 |  55 |
| `generate_perm_trace_time_ms` |  45 |  90 |  53 |  37 |
| `perm_trace_commit_time_ms` |  77.43 |  154.87 |  89.84 |  65.03 |
| `quotient_poly_compute_time_ms` |  82.88 |  165.75 |  92.01 |  73.75 |
| `quotient_poly_commit_time_ms` |  17.55 |  35.11 |  19.98 |  15.12 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 607 | 1 | 63 | 1,745,742 | 27.54 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 186 | 873 | 32,480,114 | 172,558,444 | 186 | 415 | 0 | 92.01 | 19.98 | 6 | 89.84 | 79 | 147 | 78 | 1 | 75 | 15,909,408 | 53 | 105 | 1,149,000 | 11.27 | 27 | 112 | 1 | 78 | 
| pairing | 1 | 196 | 607 | 22,464,232 | 119,958,502 | 196 | 310 | 1 | 73.75 | 15.12 | 6 | 65.03 | 60 | 104 | 60 | 1 | 55 | 9,498,894 | 37 | 60 | 596,742 | 18.53 | 21 | 89 | 1 | 60 | 

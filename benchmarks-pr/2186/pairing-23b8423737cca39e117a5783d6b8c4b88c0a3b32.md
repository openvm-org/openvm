...
| `total_proof_time_ms ` |  727 |  1,454 |  825 |  629 |
...
| `execute_preflight_insn_mi/s` |  13.16 | -          |  17.34 |  8.98 |
| `trace_gen_time_ms   ` |  175 |  350 |  193 |  157 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  361 |  722 |  390 |  332 |
| `main_trace_commit_time_ms` |  65 |  130 |  75 |  55 |
| `generate_perm_trace_time_ms` |  55 |  110 |  68 |  42 |
| `perm_trace_commit_time_ms` |  77.78 |  155.55 |  89.85 |  65.70 |
| `quotient_poly_compute_time_ms` |  79.71 |  159.41 |  88.31 |  71.11 |
| `quotient_poly_commit_time_ms` |  16.13 |  32.26 |  17.66 |  14.61 |
| `pcs_opening_time_ms ` |  62.50 |  125 |  73 |  52 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 629 | 66 | 1 | 89 | 1,745,742 | 19.41 | 171 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 157 | 825 | 32,689,110 | 172,558,444 | 157 | 390 | 0 | 88.31 | 17.66 | 6 | 89.85 | 73 | 135 | 72 | 1 | 75 | 16,059,916 | 42 | 132 | 1,157,000 | 8.98 | 26 | 106 | 1 | 72 | 
| pairing | 1 | 193 | 629 | 22,314,288 | 119,958,502 | 193 | 332 | 1 | 71.11 | 14.61 | 6 | 65.70 | 52 | 137 | 52 | 0 | 55 | 9,408,294 | 68 | 63 | 588,742 | 17.34 | 20 | 86 | 1 | 52 | 

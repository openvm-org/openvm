...
| `total_proof_time_ms ` |  577.25 |  2,309 |  729 |  519 |
...
| `execute_metered_insn_mi/s` |  121.68 | -          |  121.68 |  121.68 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  54.50 |  218 |  66 |  46 |
| `execute_preflight_insn_mi/s` |  30.17 | -          |  31.33 |  27.50 |
| `trace_gen_time_ms   ` |  176.75 |  707 |  211 |  154 |
| `memory_finalize_time_ms` |  0.75 |  3 |  3 |  0 |
| `stark_prove_excluding_trace_time_ms` |  277.50 |  1,110 |  325 |  257 |
| `main_trace_commit_time_ms` |  51.50 |  206 |  56 |  50 |
| `generate_perm_trace_time_ms` |  24.25 |  97 |  29 |  20 |
| `perm_trace_commit_time_ms` |  65.49 |  261.97 |  72.33 |  55.76 |
| `quotient_poly_compute_time_ms` |  58.34 |  233.36 |  69.12 |  52.67 |
| `quotient_poly_commit_time_ms` |  15.22 |  60.89 |  17.61 |  12.47 |
| `pcs_opening_time_ms ` |  60 |  240 |  90 |  46 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 536 | 41 | 1 | 33 | 4,137,502 | 121.68 | 168 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 211 | 729 | 23,446,148 | 150,778,428 | 211 | 325 | 0 | 58.50 | 17.61 | 5 | 72.33 | 90 | 102 | 90 | 3 | 56 | 10,899,170 | 29 | 46 | 1,103,000 | 27.50 | 21 | 76 | 1 | 90 | 
| regex_program | 1 | 154 | 519 | 11,598,276 | 128,513,066 | 154 | 257 | 1 | 52.67 | 15.57 | 4 | 67.59 | 46 | 90 | 46 | 0 | 50 | 2,196,106 | 22 | 66 | 1,104,000 | 31.14 | 16 | 68 | 0 | 46 | 
| regex_program | 2 | 160 | 525 | 11,579,064 | 128,513,066 | 160 | 262 | 1 | 53.07 | 15.24 | 4 | 66.29 | 50 | 93 | 50 | 0 | 50 | 2,177,334 | 26 | 60 | 1,104,000 | 30.71 | 16 | 68 | 0 | 50 | 
| regex_program | 3 | 182 | 536 | 11,853,872 | 103,456,394 | 182 | 266 | 0 | 69.12 | 12.47 | 5 | 55.76 | 54 | 78 | 53 | 0 | 50 | 2,422,606 | 20 | 46 | 826,502 | 31.33 | 18 | 82 | 1 | 53 | 

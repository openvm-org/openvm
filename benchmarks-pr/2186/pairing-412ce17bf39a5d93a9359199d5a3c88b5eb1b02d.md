...
| `total_proof_time_ms ` |  709.50 |  1,419 |  816 |  603 |
...
| `execute_preflight_insn_mi/s` |  13.46 | -          |  17.85 |  9.07 |
| `trace_gen_time_ms   ` |  175 |  350 |  191 |  159 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  343 |  686 |  378 |  308 |
| `main_trace_commit_time_ms` |  65 |  130 |  75 |  55 |
| `generate_perm_trace_time_ms` |  38.50 |  77 |  41 |  36 |
| `perm_trace_commit_time_ms` |  76.61 |  153.23 |  89.07 |  64.15 |
| `quotient_poly_compute_time_ms` |  78.55 |  157.10 |  86.99 |  70.11 |
| `quotient_poly_commit_time_ms` |  16.01 |  32.01 |  17.93 |  14.08 |
| `pcs_opening_time_ms ` |  62.50 |  125 |  67 |  58 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 603 | 40 | 1 | 89 | 1,745,742 | 19.56 | 147 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 159 | 816 | 32,689,110 | 172,558,444 | 159 | 378 | 0 | 86.99 | 17.93 | 6 | 89.07 | 67 | 129 | 67 | 1 | 75 | 16,059,916 | 36 | 131 | 1,157,000 | 9.07 | 26 | 105 | 1 | 67 | 
| pairing | 1 | 191 | 603 | 22,314,288 | 119,958,502 | 191 | 308 | 1 | 70.11 | 14.08 | 6 | 64.15 | 58 | 108 | 58 | 0 | 55 | 9,408,294 | 41 | 63 | 588,742 | 17.85 | 20 | 84 | 1 | 58 | 

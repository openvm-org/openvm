...
|:---|---:|---:|
| Total |  2.32 |  0.73 |
| regex_program |  2.28 |  0.70 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  570.75 |  2,283 |  698 |  514 |
...
| `execute_metered_insn_mi/s` |  123.96 | -          |  123.96 |  123.96 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  55 |  220 |  67 |  46 |
| `execute_preflight_insn_mi/s` |  30.08 | -          |  30.92 |  27.67 |
| `trace_gen_time_ms   ` |  176 |  704 |  208 |  152 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  272 |  1,088 |  298 |  252 |
| `main_trace_commit_time_ms` |  51.75 |  207 |  56 |  50 |
| `generate_perm_trace_time_ms` |  26.25 |  105 |  33 |  21 |
| `perm_trace_commit_time_ms` |  63.90 |  255.59 |  70.76 |  54.10 |
| `quotient_poly_compute_time_ms` |  58.78 |  235.10 |  70.76 |  52.67 |
| `quotient_poly_commit_time_ms` |  14.90 |  59.59 |  17.62 |  12.64 |
| `pcs_opening_time_ms ` |  53.50 |  214 |  60 |  46 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 550 | 66 | 1 | 33 | 4,137,502 | 123.96 | 192 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 208 | 698 | 23,446,148 | 150,778,428 | 208 | 298 | 0 | 58.54 | 17.62 | 5 | 70.76 | 59 | 104 | 59 | 4 | 56 | 10,899,170 | 33 | 47 | 1,103,000 | 27.67 | 22 | 76 | 1 | 59 | 
| regex_program | 1 | 152 | 514 | 11,598,276 | 128,513,066 | 152 | 252 | 1 | 53.13 | 14.56 | 4 | 65.41 | 46 | 87 | 46 | 0 | 50 | 2,196,106 | 21 | 67 | 1,104,000 | 30.92 | 16 | 68 | 0 | 46 | 
| regex_program | 2 | 162 | 521 | 11,579,064 | 128,513,066 | 162 | 258 | 1 | 52.67 | 14.76 | 4 | 65.31 | 49 | 89 | 48 | 0 | 51 | 2,177,334 | 24 | 60 | 1,104,000 | 30.86 | 16 | 68 | 0 | 48 | 
| regex_program | 3 | 182 | 550 | 11,853,872 | 103,456,394 | 182 | 280 | 0 | 70.76 | 12.64 | 5 | 54.10 | 60 | 84 | 60 | 0 | 50 | 2,422,606 | 27 | 46 | 826,502 | 30.86 | 18 | 84 | 1 | 60 | 

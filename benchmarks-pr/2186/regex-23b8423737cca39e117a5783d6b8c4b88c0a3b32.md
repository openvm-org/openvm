...
| `total_proof_time_ms ` |  603.25 |  2,413 |  724 |  555 |
...
| `execute_metered_insn_mi/s` |  117.94 | -          |  117.94 |  117.94 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  55.25 |  221 |  68 |  46 |
| `execute_preflight_insn_mi/s` |  30.09 | -          |  31.17 |  27.07 |
| `trace_gen_time_ms   ` |  177.75 |  711 |  211 |  154 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  301.50 |  1,206 |  317 |  290 |
| `main_trace_commit_time_ms` |  52 |  208 |  57 |  50 |
| `generate_perm_trace_time_ms` |  44.50 |  178 |  65 |  22 |
| `perm_trace_commit_time_ms` |  64.27 |  257.09 |  71.29 |  55.80 |
| `quotient_poly_compute_time_ms` |  58.33 |  233.32 |  68.79 |  51.86 |
| `quotient_poly_commit_time_ms` |  14.97 |  59.86 |  18.02 |  12.45 |
| `pcs_opening_time_ms ` |  64.25 |  257 |  84 |  49 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 570 | 67 | 1 | 35 | 4,137,502 | 117.94 | 195 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 211 | 724 | 23,446,148 | 150,778,428 | 211 | 317 | 0 | 59.98 | 18.02 | 5 | 71.29 | 74 | 106 | 74 | 4 | 57 | 10,899,170 | 34 | 47 | 1,103,000 | 27.07 | 22 | 78 | 1 | 74 | 
| regex_program | 1 | 154 | 564 | 11,598,276 | 128,513,066 | 154 | 300 | 1 | 52.68 | 14.77 | 4 | 64.40 | 49 | 130 | 49 | 0 | 51 | 2,196,106 | 65 | 68 | 1,104,000 | 31.17 | 16 | 68 | 0 | 49 | 
| regex_program | 2 | 163 | 555 | 11,579,064 | 128,513,066 | 163 | 290 | 1 | 51.86 | 14.63 | 4 | 65.60 | 84 | 88 | 84 | 0 | 50 | 2,177,334 | 22 | 60 | 1,104,000 | 30.95 | 16 | 67 | 0 | 84 | 
| regex_program | 3 | 183 | 570 | 11,853,872 | 103,456,394 | 183 | 299 | 0 | 68.79 | 12.45 | 5 | 55.80 | 50 | 116 | 50 | 0 | 50 | 2,422,606 | 57 | 46 | 826,502 | 31.16 | 18 | 82 | 1 | 50 | 

...
| `total_proof_time_ms ` |  595.75 |  2,383 |  753 |  535 |
...
| `execute_metered_insn_mi/s` |  118.66 | -          |  118.66 |  118.66 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  55 |  220 |  68 |  46 |
| `execute_preflight_insn_mi/s` |  30.14 | -          |  31.22 |  27.50 |
| `trace_gen_time_ms   ` |  180.25 |  721 |  214 |  156 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  292.75 |  1,171 |  347 |  269 |
| `main_trace_commit_time_ms` |  51.50 |  206 |  56 |  49 |
| `generate_perm_trace_time_ms` |  33 |  132 |  55 |  19 |
| `perm_trace_commit_time_ms` |  64.88 |  259.54 |  70.35 |  55.37 |
| `quotient_poly_compute_time_ms` |  60.05 |  240.21 |  72.27 |  52.58 |
| `quotient_poly_commit_time_ms` |  15.65 |  62.60 |  17.75 |  13.08 |
| `pcs_opening_time_ms ` |  64 |  256 |  82 |  56 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 545 | 40 | 1 | 34 | 4,137,502 | 118.66 | 167 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 214 | 753 | 23,446,148 | 150,778,428 | 214 | 347 | 0 | 62.17 | 17.75 | 5 | 70.35 | 82 | 127 | 82 | 4 | 56 | 10,899,170 | 55 | 47 | 1,103,000 | 27.50 | 21 | 80 | 1 | 82 | 
| regex_program | 1 | 156 | 550 | 11,598,276 | 128,513,066 | 156 | 284 | 1 | 53.20 | 15.93 | 4 | 66.56 | 60 | 102 | 59 | 0 | 51 | 2,196,106 | 35 | 68 | 1,104,000 | 30.90 | 17 | 69 | 0 | 59 | 
| regex_program | 2 | 165 | 535 | 11,579,064 | 128,513,066 | 165 | 269 | 1 | 52.58 | 15.84 | 4 | 67.26 | 58 | 91 | 57 | 0 | 50 | 2,177,334 | 23 | 59 | 1,104,000 | 31.22 | 17 | 69 | 0 | 57 | 
| regex_program | 3 | 186 | 545 | 11,853,872 | 103,456,394 | 186 | 271 | 0 | 72.27 | 13.08 | 5 | 55.37 | 56 | 77 | 56 | 0 | 49 | 2,422,606 | 19 | 46 | 826,502 | 30.95 | 18 | 86 | 1 | 56 | 

...
| `total_proof_time_ms ` |  722 |  1,444 |  816 |  628 |
...
| `execute_preflight_insn_mi/s` |  13.47 | -          |  17.79 |  9.14 |
| `trace_gen_time_ms   ` |  178.50 |  357 |  195 |  162 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  355.50 |  711 |  380 |  331 |
| `main_trace_commit_time_ms` |  65 |  130 |  76 |  54 |
| `generate_perm_trace_time_ms` |  53 |  106 |  68 |  38 |
| `perm_trace_commit_time_ms` |  77.66 |  155.32 |  89.66 |  65.66 |
| `quotient_poly_compute_time_ms` |  79.42 |  158.84 |  87.37 |  71.47 |
| `quotient_poly_commit_time_ms` |  16.86 |  33.72 |  18.93 |  14.79 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 628 | 65 | 1 | 89 | 1,745,742 | 19.58 | 171 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 162 | 816 | 32,689,110 | 172,558,444 | 162 | 380 | 0 | 87.37 | 18.93 | 6 | 89.66 | 64 | 131 | 64 | 1 | 76 | 16,059,916 | 38 | 130 | 1,157,000 | 9.14 | 26 | 107 | 1 | 64 | 
| pairing | 1 | 195 | 628 | 22,314,288 | 119,958,502 | 195 | 331 | 1 | 71.47 | 14.79 | 6 | 65.66 | 52 | 137 | 52 | 0 | 54 | 9,408,294 | 68 | 60 | 588,742 | 17.79 | 20 | 86 | 1 | 52 | 

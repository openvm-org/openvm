...
| `total_proof_time_ms ` |  722 |  1,444 |  821 |  623 |
...
| `execute_preflight_insn_mi/s` |  13.46 | -          |  17.82 |  9.10 |
| `trace_gen_time_ms   ` |  175.50 |  351 |  193 |  158 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  358 |  716 |  388 |  328 |
| `main_trace_commit_time_ms` |  64 |  128 |  75 |  53 |
| `generate_perm_trace_time_ms` |  55.50 |  111 |  69 |  42 |
| `perm_trace_commit_time_ms` |  76.44 |  152.88 |  88.18 |  64.70 |
| `quotient_poly_compute_time_ms` |  78.80 |  157.60 |  87.01 |  70.59 |
| `quotient_poly_commit_time_ms` |  16.42 |  32.84 |  18.53 |  14.31 |
| `pcs_opening_time_ms ` |  62 |  124 |  72 |  52 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 623 | 66 | 1 | 89 | 1,745,742 | 19.52 | 174 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 158 | 821 | 32,689,110 | 172,558,444 | 158 | 388 | 0 | 87.01 | 18.53 | 6 | 88.18 | 72 | 133 | 72 | 1 | 75 | 16,059,916 | 42 | 130 | 1,157,000 | 9.10 | 26 | 106 | 1 | 72 | 
| pairing | 1 | 193 | 623 | 22,314,288 | 119,958,502 | 193 | 328 | 1 | 70.59 | 14.31 | 6 | 64.70 | 52 | 136 | 52 | 0 | 53 | 9,408,294 | 69 | 60 | 588,742 | 17.82 | 20 | 85 | 1 | 52 | 

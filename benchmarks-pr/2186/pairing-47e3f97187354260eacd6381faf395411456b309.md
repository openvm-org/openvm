...
| `total_proof_time_ms ` |  709 |  1,418 |  819 |  599 |
...
| `execute_preflight_insn_mi/s` |  13.46 | -          |  17.84 |  9.09 |
| `trace_gen_time_ms   ` |  177.50 |  355 |  195 |  160 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  341.50 |  683 |  382 |  301 |
| `main_trace_commit_time_ms` |  66 |  132 |  76 |  56 |
| `generate_perm_trace_time_ms` |  35.50 |  71 |  39 |  32 |
| `perm_trace_commit_time_ms` |  78.04 |  156.09 |  90.05 |  66.03 |
| `quotient_poly_compute_time_ms` |  79.97 |  159.94 |  88.76 |  71.18 |
| `quotient_poly_commit_time_ms` |  16.36 |  32.72 |  17.86 |  14.87 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 599 | 40 | 1 | 90 | 1,745,742 | 19.20 | 144 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 160 | 819 | 32,689,110 | 172,558,444 | 160 | 382 | 0 | 88.76 | 17.86 | 6 | 90.05 | 65 | 132 | 65 | 1 | 76 | 16,059,916 | 39 | 131 | 1,157,000 | 9.09 | 26 | 107 | 1 | 65 | 
| pairing | 1 | 195 | 599 | 22,314,288 | 119,958,502 | 195 | 301 | 1 | 71.18 | 14.87 | 6 | 66.03 | 56 | 101 | 56 | 0 | 56 | 9,408,294 | 32 | 60 | 588,742 | 17.84 | 21 | 86 | 1 | 56 | 

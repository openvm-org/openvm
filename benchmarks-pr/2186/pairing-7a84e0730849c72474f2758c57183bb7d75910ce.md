...
| `total_proof_time_ms ` |  722 |  1,444 |  849 |  595 |
...
| `execute_preflight_insn_mi/s` |  13.53 | -          |  18.02 |  9.04 |
| `trace_gen_time_ms   ` |  173 |  346 |  190 |  156 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  360 |  720 |  418 |  302 |
| `main_trace_commit_time_ms` |  64 |  128 |  74 |  54 |
| `generate_perm_trace_time_ms` |  37 |  74 |  40 |  34 |
| `perm_trace_commit_time_ms` |  75.04 |  150.07 |  87.02 |  63.05 |
| `quotient_poly_compute_time_ms` |  79.33 |  158.65 |  88.02 |  70.63 |
| `quotient_poly_commit_time_ms` |  16.61 |  33.22 |  18.75 |  14.47 |
| `pcs_opening_time_ms ` |  83 |  166 |  111 |  55 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 595 | 40 | 1 | 89 | 1,745,742 | 19.47 | 148 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 156 | 849 | 32,689,110 | 172,558,444 | 156 | 418 | 0 | 88.02 | 18.75 | 6 | 87.02 | 111 | 125 | 111 | 1 | 74 | 16,059,916 | 34 | 131 | 1,157,000 | 9.04 | 26 | 107 | 1 | 111 | 
| pairing | 1 | 190 | 595 | 22,314,288 | 119,958,502 | 190 | 302 | 1 | 70.63 | 14.47 | 6 | 63.05 | 55 | 106 | 55 | 0 | 54 | 9,408,294 | 40 | 61 | 588,742 | 18.02 | 20 | 85 | 1 | 55 | 

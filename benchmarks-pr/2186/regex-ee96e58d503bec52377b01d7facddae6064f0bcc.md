...
|:---|---:|---:|
| Total |  2.31 |  0.74 |
| regex_program |  2.28 |  0.71 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  569.75 |  2,279 |  707 |  515 |
...
| `execute_preflight_insn_mi/s` |  30.04 | -          |  30.93 |  27.63 |
| `trace_gen_time_ms   ` |  177.75 |  711 |  210 |  156 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  269.75 |  1,079 |  305 |  251 |
| `main_trace_commit_time_ms` |  51 |  204 |  56 |  49 |
| `generate_perm_trace_time_ms` |  22.75 |  91 |  33 |  18 |
| `perm_trace_commit_time_ms` |  64.24 |  256.97 |  69.59 |  54.62 |
| `quotient_poly_compute_time_ms` |  57.70 |  230.82 |  71.69 |  51.87 |
| `quotient_poly_commit_time_ms` |  14.89 |  59.58 |  16.90 |  12.83 |
| `pcs_opening_time_ms ` |  56 |  224 |  72 |  48 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 538 | 40 | 1 | 35 | 4,137,502 | 115.28 | 165 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 210 | 707 | 23,446,148 | 150,778,428 | 210 | 305 | 0 | 54.27 | 16.90 | 5 | 69.59 | 72 | 104 | 72 | 4 | 56 | 10,899,170 | 33 | 46 | 1,103,000 | 27.63 | 21 | 71 | 1 | 72 | 
| regex_program | 1 | 156 | 515 | 11,598,276 | 128,513,066 | 156 | 251 | 1 | 51.87 | 14.99 | 4 | 66.54 | 48 | 85 | 47 | 0 | 50 | 2,196,106 | 18 | 66 | 1,104,000 | 30.91 | 16 | 67 | 0 | 47 | 
| regex_program | 2 | 162 | 519 | 11,579,064 | 128,513,066 | 162 | 256 | 1 | 52.98 | 14.86 | 4 | 66.23 | 51 | 86 | 51 | 0 | 49 | 2,177,334 | 19 | 60 | 1,104,000 | 30.69 | 16 | 68 | 0 | 51 | 
| regex_program | 3 | 183 | 538 | 11,853,872 | 103,456,394 | 183 | 267 | 0 | 71.69 | 12.83 | 5 | 54.62 | 53 | 78 | 53 | 0 | 49 | 2,422,606 | 21 | 46 | 826,502 | 30.93 | 18 | 85 | 1 | 53 | 

...
| `total_proof_time_ms ` |  578 |  2,312 |  699 |  529 |
...
| `execute_preflight_insn_mi/s` |  30.26 | -          |  31.62 |  27.34 |
| `trace_gen_time_ms   ` |  178.75 |  715 |  212 |  157 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  277 |  1,108 |  296 |  264 |
| `main_trace_commit_time_ms` |  51.50 |  206 |  56 |  50 |
| `generate_perm_trace_time_ms` |  26.50 |  106 |  35 |  18 |
| `perm_trace_commit_time_ms` |  65.30 |  261.22 |  72.40 |  55.88 |
| `quotient_poly_compute_time_ms` |  58.71 |  234.83 |  69.12 |  53.17 |
| `quotient_poly_commit_time_ms` |  15.18 |  60.72 |  17.26 |  12.72 |
| `pcs_opening_time_ms ` |  56.50 |  226 |  62 |  50 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 538 | 40 | 1 | 34 | 4,137,502 | 120.51 | 168 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 212 | 699 | 23,446,148 | 150,778,428 | 212 | 296 | 0 | 59.01 | 17.26 | 5 | 72.40 | 62 | 100 | 62 | 4 | 56 | 10,899,170 | 26 | 47 | 1,103,000 | 27.34 | 22 | 77 | 1 | 62 | 
| regex_program | 1 | 157 | 546 | 11,598,276 | 128,513,066 | 157 | 281 | 1 | 53.52 | 15.26 | 4 | 66.29 | 59 | 101 | 58 | 0 | 50 | 2,196,106 | 35 | 66 | 1,104,000 | 31.36 | 16 | 69 | 0 | 58 | 
| regex_program | 2 | 163 | 529 | 11,579,064 | 128,513,066 | 163 | 264 | 1 | 53.17 | 15.49 | 4 | 66.64 | 50 | 95 | 49 | 0 | 50 | 2,177,334 | 27 | 61 | 1,104,000 | 30.72 | 16 | 69 | 0 | 49 | 
| regex_program | 3 | 183 | 538 | 11,853,872 | 103,456,394 | 183 | 267 | 0 | 69.12 | 12.72 | 5 | 55.88 | 55 | 77 | 55 | 0 | 50 | 2,422,606 | 18 | 46 | 826,502 | 31.62 | 18 | 82 | 1 | 55 | 

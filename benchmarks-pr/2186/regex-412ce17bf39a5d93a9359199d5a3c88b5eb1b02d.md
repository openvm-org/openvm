...
| `total_proof_time_ms ` |  581.50 |  2,326 |  704 |  537 |
...
| `execute_preflight_insn_mi/s` |  30.29 | -          |  31.40 |  27.48 |
| `trace_gen_time_ms   ` |  176 |  704 |  210 |  152 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  282.25 |  1,129 |  301 |  269 |
| `main_trace_commit_time_ms` |  51.25 |  205 |  56 |  49 |
| `generate_perm_trace_time_ms` |  31.50 |  126 |  40 |  20 |
| `perm_trace_commit_time_ms` |  64.17 |  256.66 |  70.49 |  55.67 |
| `quotient_poly_compute_time_ms` |  58.59 |  234.37 |  69.43 |  52.44 |
| `quotient_poly_commit_time_ms` |  14.81 |  59.24 |  17.08 |  12.76 |
| `pcs_opening_time_ms ` |  58.75 |  235 |  62 |  55 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 539 | 40 | 1 | 34 | 4,137,502 | 120.38 | 167 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 210 | 704 | 23,446,148 | 150,778,428 | 210 | 301 | 0 | 59.82 | 17.08 | 5 | 70.49 | 55 | 112 | 54 | 4 | 56 | 10,899,170 | 40 | 47 | 1,103,000 | 27.48 | 21 | 77 | 1 | 54 | 
| regex_program | 1 | 152 | 546 | 11,598,276 | 128,513,066 | 152 | 284 | 1 | 52.44 | 14.50 | 4 | 64.47 | 62 | 104 | 62 | 0 | 49 | 2,196,106 | 39 | 68 | 1,104,000 | 31.03 | 16 | 67 | 0 | 62 | 
| regex_program | 2 | 160 | 537 | 11,579,064 | 128,513,066 | 160 | 275 | 1 | 52.68 | 14.90 | 5 | 66.02 | 62 | 94 | 62 | 0 | 50 | 2,177,334 | 27 | 60 | 1,104,000 | 31.27 | 16 | 68 | 0 | 62 | 
| regex_program | 3 | 182 | 539 | 11,853,872 | 103,456,394 | 182 | 269 | 0 | 69.43 | 12.76 | 5 | 55.67 | 56 | 78 | 56 | 0 | 50 | 2,422,606 | 20 | 46 | 826,502 | 31.40 | 18 | 83 | 1 | 56 | 

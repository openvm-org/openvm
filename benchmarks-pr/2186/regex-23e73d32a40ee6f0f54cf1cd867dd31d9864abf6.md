...
| `total_proof_time_ms ` |  578 |  2,312 |  702 |  519 |
...
| `execute_preflight_time_ms` |  55.75 |  223 |  68 |  47 |
| `execute_preflight_insn_mi/s` |  30.71 | -          |  31.80 |  27.85 |
| `trace_gen_time_ms   ` |  175.50 |  702 |  207 |  153 |
| `memory_finalize_time_ms` |  1.25 |  5 |  5 |  0 |
| `stark_prove_excluding_trace_time_ms` |  279 |  1,116 |  302 |  256 |
| `main_trace_commit_time_ms` |  51.75 |  207 |  57 |  49 |
| `generate_perm_trace_time_ms` |  32.25 |  129 |  55 |  20 |
| `perm_trace_commit_time_ms` |  64.89 |  259.58 |  71.92 |  55.35 |
| `quotient_poly_compute_time_ms` |  57.92 |  231.68 |  68.68 |  52.38 |
| `quotient_poly_commit_time_ms` |  14.66 |  58.64 |  16.60 |  12.76 |
| `pcs_opening_time_ms ` |  54.25 |  217 |  62 |  50 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 566 | 67 | 1 | 32 | 4,137,502 | 125.49 | 194 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 207 | 702 | 23,446,148 | 150,778,428 | 207 | 302 | 0 | 58.11 | 16.60 | 5 | 71.92 | 62 | 106 | 62 | 5 | 57 | 10,899,170 | 33 | 47 | 1,103,000 | 27.85 | 21 | 75 | 1 | 62 | 
| regex_program | 1 | 153 | 525 | 11,598,276 | 128,513,066 | 153 | 262 | 1 | 52.51 | 14.96 | 4 | 66.35 | 54 | 88 | 54 | 0 | 51 | 2,196,106 | 21 | 68 | 1,104,000 | 31.80 | 16 | 68 | 0 | 54 | 
| regex_program | 2 | 161 | 519 | 11,579,064 | 128,513,066 | 160 | 256 | 1 | 52.38 | 14.31 | 4 | 65.95 | 51 | 86 | 51 | 0 | 50 | 2,177,334 | 20 | 61 | 1,104,000 | 31.50 | 16 | 67 | 0 | 51 | 
| regex_program | 3 | 181 | 566 | 11,853,872 | 103,456,394 | 181 | 296 | 0 | 68.68 | 12.76 | 5 | 55.35 | 50 | 114 | 49 | 0 | 49 | 2,422,606 | 55 | 47 | 826,502 | 31.69 | 18 | 82 | 1 | 49 | 

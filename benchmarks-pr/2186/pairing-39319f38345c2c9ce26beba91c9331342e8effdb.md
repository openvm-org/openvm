...
| `total_proof_time_ms ` |  719.50 |  1,439 |  841 |  598 |
...
| `execute_preflight_insn_mi/s` |  13.46 | -          |  17.86 |  9.06 |
| `trace_gen_time_ms   ` |  179.50 |  359 |  199 |  160 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  351 |  702 |  405 |  297 |
| `main_trace_commit_time_ms` |  65.50 |  131 |  77 |  54 |
| `generate_perm_trace_time_ms` |  33 |  66 |  37 |  29 |
| `perm_trace_commit_time_ms` |  78.46 |  156.92 |  90.71 |  66.20 |
| `quotient_poly_compute_time_ms` |  80.49 |  160.97 |  89.04 |  71.93 |
| `quotient_poly_commit_time_ms` |  17.08 |  34.15 |  19.46 |  14.69 |
| `pcs_opening_time_ms ` |  72 |  144 |  87 |  57 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 598 | 40 | 1 | 89 | 1,745,742 | 19.41 | 145 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 160 | 841 | 32,689,110 | 172,558,444 | 160 | 405 | 0 | 89.04 | 19.46 | 6 | 90.71 | 87 | 132 | 87 | 1 | 77 | 16,059,916 | 37 | 131 | 1,157,000 | 9.06 | 27 | 109 | 1 | 86 | 
| pairing | 1 | 199 | 598 | 22,314,288 | 119,958,502 | 199 | 297 | 1 | 71.93 | 14.69 | 6 | 66.20 | 57 | 98 | 56 | 0 | 54 | 9,408,294 | 29 | 59 | 588,742 | 17.86 | 21 | 87 | 1 | 56 | 

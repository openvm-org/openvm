...
| `total_proof_time_ms ` |  581.50 |  2,326 |  707 |  524 |
...
| `execute_preflight_time_ms` |  54.75 |  219 |  67 |  45 |
| `execute_preflight_insn_mi/s` |  29.85 | -          |  31.09 |  27.45 |
| `trace_gen_time_ms   ` |  178.50 |  714 |  212 |  155 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  280.50 |  1,122 |  304 |  259 |
| `main_trace_commit_time_ms` |  51.50 |  206 |  56 |  49 |
| `generate_perm_trace_time_ms` |  25.25 |  101 |  34 |  21 |
| `perm_trace_commit_time_ms` |  64.19 |  256.74 |  70.25 |  55.09 |
| `quotient_poly_compute_time_ms` |  59.01 |  236.04 |  70.61 |  52.09 |
| `quotient_poly_commit_time_ms` |  15.06 |  60.22 |  17.43 |  12.76 |
| `pcs_opening_time_ms ` |  62.75 |  251 |  83 |  50 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 568 | 41 | 1 | 35 | 4,137,502 | 116.70 | 171 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 212 | 707 | 23,446,148 | 150,778,428 | 212 | 304 | 0 | 60.40 | 17.43 | 5 | 70.25 | 63 | 105 | 63 | 4 | 56 | 10,899,170 | 34 | 47 | 1,103,000 | 27.45 | 21 | 78 | 1 | 63 | 
| regex_program | 1 | 155 | 527 | 11,598,276 | 128,513,066 | 155 | 263 | 1 | 52.09 | 15.24 | 4 | 66.77 | 55 | 89 | 54 | 0 | 51 | 2,196,106 | 22 | 67 | 1,104,000 | 30.21 | 16 | 67 | 0 | 54 | 
| regex_program | 2 | 163 | 524 | 11,579,064 | 128,513,066 | 163 | 259 | 1 | 52.94 | 14.79 | 4 | 64.63 | 50 | 89 | 50 | 0 | 50 | 2,177,334 | 24 | 60 | 1,104,000 | 30.66 | 16 | 68 | 0 | 50 | 
| regex_program | 3 | 184 | 568 | 11,853,872 | 103,456,394 | 184 | 296 | 0 | 70.61 | 12.76 | 5 | 55.09 | 83 | 79 | 82 | 0 | 49 | 2,422,606 | 21 | 45 | 826,502 | 31.09 | 18 | 84 | 1 | 82 | 

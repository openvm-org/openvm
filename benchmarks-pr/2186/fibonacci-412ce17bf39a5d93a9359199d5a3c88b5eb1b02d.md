...
| `total_proof_time_ms ` |  506.50 |  1,013 |  553 |  460 |
...
| `execute_metered_insn_mi/s` |  149.50 | -          |  149.50 |  149.50 |
| `execute_preflight_insns` |  750,104.50 |  1,500,209 |  873,000 |  627,209 |
| `execute_preflight_time_ms` |  29.50 |  59 |  33 |  26 |
| `execute_preflight_insn_mi/s` |  36.23 | -          |  38.03 |  34.43 |
| `trace_gen_time_ms   ` |  188.50 |  377 |  192 |  185 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  195 |  390 |  200 |  190 |
| `main_trace_commit_time_ms` |  30.50 |  61 |  33 |  28 |
| `generate_perm_trace_time_ms` |  18.50 |  37 |  25 |  12 |
| `perm_trace_commit_time_ms` |  41.20 |  82.41 |  43.58 |  38.82 |
| `quotient_poly_compute_time_ms` |  31.71 |  63.41 |  33 |  30.41 |
| `quotient_poly_commit_time_ms` |  12.01 |  24.03 |  12.49 |  11.54 |
| `pcs_opening_time_ms ` |  59.50 |  119 |  78 |  41 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 460 | 41 | 1 | 10 | 1,500,209 | 149.50 | 145 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 192 | 553 | 9,677,708 | 84,395,212 | 192 | 190 | 0 | 33 | 12.49 | 4 | 43.58 | 41 | 69 | 41 | 0 | 33 | 1,035,986 | 25 | 26 | 873,000 | 34.43 | 13 | 45 | 0 | 41 | 
| fibonacci_program | 1 | 185 | 460 | 9,708,170 | 74,305,770 | 185 | 200 | 1 | 30.41 | 11.54 | 4 | 38.82 | 78 | 51 | 77 | 0 | 28 | 1,064,416 | 12 | 33 | 627,209 | 38.03 | 11 | 42 | 0 | 77 | 

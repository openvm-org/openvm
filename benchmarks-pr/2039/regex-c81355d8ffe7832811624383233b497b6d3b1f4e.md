...
| `total_proof_time_ms ` |  3,811 |  7,622 |  4,896 |  2,726 |
...
| `execute_preflight_insn_mi/s` |  28.43 | -          |  30.85 |  26.01 |
| `trace_gen_time_ms   ` |  378 |  756 |  484 |  272 |
| `memory_finalize_time_ms` |  7.50 |  15 |  13 |  2 |
| `stark_prove_excluding_trace_time_ms` |  3,105 |  6,210 |  4,066 |  2,144 |
| `main_trace_commit_time_ms` |  629 |  1,258 |  844 |  414 |
| `generate_perm_trace_time_ms` |  220 |  440 |  295 |  145 |
| `perm_trace_commit_time_ms` |  649 |  1,298 |  849 |  449 |
| `quotient_poly_compute_time_ms` |  314.50 |  629 |  427 |  202 |
| `quotient_poly_commit_time_ms` |  298.50 |  597 |  394 |  203 |
| `pcs_opening_time_ms ` |  984.50 |  1,969 |  1,253 |  716 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2,726 | 6 | 1 | 31 | 4,108,597 | 129.03 | 45 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 484 | 4,896 | 211,758,557 | 373,183,036 | 484 | 4,066 | 0 | 427 | 394 | 849 | 1,253 | 7 | 13 | 844 | 91,281,687 | 295 | 101 | 2,211,000 | 26.01 | 
| regex_program | 1 | 272 | 2,726 | 174,326,267 | 196,838,026 | 272 | 2,144 | 50 | 202 | 203 | 449 | 716 | 6 | 2 | 414 | 73,453,305 | 145 | 85 | 1,897,597 | 30.85 | 

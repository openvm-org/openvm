...
|:---|---:|---:|
| Total |  7.65 |  4.90 |
| regex_program |  7.62 |  4.87 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  3,807.50 |  7,615 |  4,866 |  2,749 |
...
| `execute_preflight_insn_mi/s` |  28.36 | -          |  30.82 |  25.90 |
| `trace_gen_time_ms   ` |  384.50 |  769 |  492 |  277 |
| `memory_finalize_time_ms` |  9 |  18 |  14 |  4 |
| `stark_prove_excluding_trace_time_ms` |  3,093 |  6,186 |  4,020 |  2,166 |
| `main_trace_commit_time_ms` |  617 |  1,234 |  841 |  393 |
| `generate_perm_trace_time_ms` |  229.50 |  459 |  306 |  153 |
| `perm_trace_commit_time_ms` |  661 |  1,322 |  848 |  474 |
| `quotient_poly_compute_time_ms` |  318 |  636 |  429 |  207 |
| `quotient_poly_commit_time_ms` |  300 |  600 |  393 |  207 |
| `pcs_opening_time_ms ` |  956 |  1,912 |  1,197 |  715 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2,749 | 6 | 1 | 31 | 4,108,597 | 128.43 | 44 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 492 | 4,866 | 211,758,557 | 373,183,036 | 492 | 4,020 | 0 | 429 | 393 | 848 | 1,197 | 7 | 14 | 841 | 91,281,687 | 306 | 104 | 2,211,000 | 25.90 | 
| regex_program | 1 | 277 | 2,749 | 174,326,267 | 196,838,026 | 277 | 2,166 | 52 | 207 | 207 | 474 | 715 | 7 | 4 | 393 | 73,453,305 | 153 | 86 | 1,897,597 | 30.82 | 

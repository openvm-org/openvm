...
|:---|---:|---:|
| Total |  7.69 |  4.91 |
| regex_program |  7.66 |  4.88 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  3,829.50 |  7,659 |  4,881 |  2,778 |
...
| `execute_metered_insn_mi/s` |  129.31 | -          |  129.31 |  129.31 |
| `execute_preflight_insns` |  2,054,298.50 |  4,108,597 |  2,211,000 |  1,897,597 |
| `execute_preflight_time_ms` |  94.50 |  189 |  102 |  87 |
| `execute_preflight_insn_mi/s` |  28.45 | -          |  30.72 |  26.19 |
| `trace_gen_time_ms   ` |  390 |  780 |  498 |  282 |
| `memory_finalize_time_ms` |  7.50 |  15 |  13 |  2 |
| `stark_prove_excluding_trace_time_ms` |  3,118.50 |  6,237 |  4,039 |  2,198 |
| `main_trace_commit_time_ms` |  628 |  1,256 |  845 |  411 |
| `generate_perm_trace_time_ms` |  240 |  480 |  304 |  176 |
| `perm_trace_commit_time_ms` |  650 |  1,300 |  852 |  448 |
| `quotient_poly_compute_time_ms` |  319 |  638 |  430 |  208 |
| `quotient_poly_commit_time_ms` |  303.50 |  607 |  401 |  206 |
| `pcs_opening_time_ms ` |  969.50 |  1,939 |  1,201 |  738 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 2,778 | 6 | 1 | 31 | 4,108,597 | 129.31 | 44 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 498 | 4,881 | 211,758,557 | 373,183,036 | 498 | 4,039 | 0 | 430 | 401 | 852 | 1,201 | 7 | 13 | 845 | 91,281,687 | 304 | 102 | 2,211,000 | 26.19 | 
| regex_program | 1 | 282 | 2,778 | 174,326,267 | 196,838,026 | 282 | 2,198 | 53 | 208 | 206 | 448 | 738 | 7 | 2 | 411 | 73,453,305 | 176 | 87 | 1,897,597 | 30.72 | 

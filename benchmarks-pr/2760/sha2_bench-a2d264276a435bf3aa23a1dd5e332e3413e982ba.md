...
|:---|---:|---:|---:|
| Total |  11.46 |  4.73 |  4.73 |
| app_proof |  9.47 |  2.74 |  2.74 |
| leaf |  1.26 |  1.26 |  1.26 |
...
| `total_proof_time_ms ` |  2,343 |  9,372 |  2,645 |  2,235 |
| `execute_metered_time_ms` |  94 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  118.18 | -          |  118.18 |  118.18 |
| `execute_preflight_insns` |  2,791,990.25 |  11,167,961 |  2,851,000 |  2,614,961 |
| `execute_preflight_time_ms` |  164.25 |  657 |  209 |  99 |
| `execute_preflight_insn_mi/s` |  36.01 | -          |  37.09 |  33.50 |
| `trace_gen_time_ms   ` |  98 |  392 |  164 |  58 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  2,006 |  8,024 |  2,209 |  1,934 |
| `prover.main_trace_commit_time_ms` |  554 |  2,216 |  663 |  517 |
| `prover.rap_constraints_time_ms` |  1,305 |  5,220 |  1,396 |  1,270 |
| `prover.openings_time_ms` |  146 |  584 |  149 |  144 |
| `prover.rap_constraints.logup_gkr_time_ms` |  333.75 |  1,335 |  430 |  301 |
| `prover.rap_constraints.round0_time_ms` |  659.25 |  2,637 |  665 |  650 |
| `prover.rap_constraints.mle_rounds_time_ms` |  311.25 |  1,245 |  315 |  309 |
| `prover.openings.stacked_reduction_time_ms` |  108.50 |  434 |  110 |  107 |
| `prover.openings.stacked_reduction.round0_time_ms` |  61.50 |  246 |  62 |  61 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  46.75 |  187 |  48 |  46 |
| `prover.openings.whir_time_ms` |  36.50 |  146 |  38 |  35 |
...
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,110 |  1,110 |  1,110 |  1,110 |
| `prover.main_trace_commit_time_ms` |  641 |  641 |  641 |  641 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/a2d264276a435bf3aa23a1dd5e332e3413e982ba/sha2_bench-a2d264276a435bf3aa23a1dd5e332e3413e982ba.memory.svg)
...
| app_proof |  |  |  |  |  | 2,235 |  |  | 94 | 11,167,961 | 118.18 | 0 | 9,474 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 25 | 397 | 24 | 7 | 2 | 2 | 3 | 3 | 
| internal_recursive.0 | 1 | 12 | 185 | 12 | 2 | 0 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 9 | 149 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 151 | 1,262 | 151 | 54 | 26 | 3 | 6 | 6 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 78,342,915 | 372 | 185 | 0 | 11 | 132 | 36 | 36 | 63 | 32 | 0 | 54 | 19 | 34 | 5 | 28 | 185 | 132 | 0 | 2 | 31 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 25,962,119 | 173 | 51 | 0 | 4 | 76 | 24 | 24 | 29 | 22 | 0 | 44 | 20 | 24 | 2 | 22 | 51 | 76 | 0 | 2 | 21 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 17,507,975 | 139 | 33 | 0 | 4 | 65 | 22 | 22 | 24 | 17 | 0 | 40 | 17 | 22 | 1 | 21 | 33 | 65 | 0 | 2 | 17 | 0 | 0 | 
| leaf | 0 | prover | 503,738,490 | 1,110 | 640 | 0 | 42 | 351 | 166 | 165 | 106 | 79 | 0 | 117 | 39 | 78 | 35 | 42 | 641 | 351 | 0 | 6 | 78 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,057,043,293 | 2,209 | 663 | 0 | 190 | 1,396 | 650 | 649 | 315 | 430 | 132 | 149 | 38 | 110 | 61 | 48 | 663 | 1,396 | 0 | 3 | 296 | 0 | 0 | 
| app_proof | prover | 1 | 1,057,042,484 | 1,939 | 517 | 0 | 39 | 1,275 | 664 | 663 | 309 | 302 | 0 | 146 | 38 | 107 | 61 | 46 | 517 | 1,275 | 0 | 3 | 301 | 0 | 0 | 
| app_proof | prover | 2 | 1,057,042,484 | 1,942 | 518 | 0 | 39 | 1,279 | 665 | 665 | 311 | 302 | 0 | 144 | 35 | 108 | 62 | 46 | 518 | 1,279 | 0 | 3 | 301 | 0 | 0 | 
| app_proof | prover | 3 | 1,057,120,972 | 1,934 | 518 | 0 | 41 | 1,270 | 658 | 658 | 310 | 301 | 0 | 145 | 35 | 109 | 62 | 47 | 518 | 1,270 | 0 | 3 | 300 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 164 | 2,645 | 164 | 171 | 0 | 3 | 99 | 2,851,000 | 33.50 | 
| app_proof | 1 | 58 | 2,248 | 58 | 41 | 0 | 2 | 209 | 2,851,000 | 36.73 | 
| app_proof | 2 | 81 | 2,244 | 80 | 41 | 0 | 2 | 179 | 2,851,000 | 36.71 | 
| app_proof | 3 | 89 | 2,235 | 89 | 41 | 0 | 2 | 170 | 2,614,961 | 37.09 | 

...
|:---|---:|---:|---:|
| Total | <span style='color: green'>(-0 [-9.0%])</span> 4.70 | <span style='color: red'>(+0 [+1.8%])</span> 1.59 | 1.59 |
| regex_program | <span style='color: green'>(-0 [-9.0%])</span> 4.70 | <span style='color: red'>(+0 [+1.8%])</span> 1.59 |  1.59 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: green'>(-116 [-9.0%])</span> 1,166 | <span style='color: green'>(-464 [-9.0%])</span> 4,664 | <span style='color: red'>(+28 [+1.8%])</span> 1,557 | <span style='color: green'>(-288 [-24.7%])</span> 877 |
...
| `execute_metered_insn_mi/s` | <span style='color: red'>(+2 [+1.6%])</span> 114.06 | -          | <span style='color: red'>(+2 [+1.6%])</span> 114.06 | <span style='color: red'>(+2 [+1.6%])</span> 114.06 |
| `execute_preflight_insns` |  1,034,284.75 |  4,137,139 |  1,104,000 |  826,139 |
| `execute_preflight_time_ms` | <span style='color: green'>(-1 [-2.2%])</span> 45 | <span style='color: green'>(-4 [-2.2%])</span> 180 |  56 | <span style='color: green'>(-2 [-5.6%])</span> 34 |
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+1 [+4.4%])</span> 32.15 | -          | <span style='color: red'>(+1 [+2.1%])</span> 32.91 | <span style='color: red'>(+0 [+0.9%])</span> 30.42 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+8 [+4.3%])</span> 189.50 | <span style='color: red'>(+31 [+4.3%])</span> 758 | <span style='color: red'>(+9 [+4.6%])</span> 204 | <span style='color: red'>(+4 [+2.3%])</span> 180 |
...
| `stark_prove_excluding_trace_time_ms` | <span style='color: green'>(-122 [-12.4%])</span> 860.25 | <span style='color: green'>(-487 [-12.4%])</span> 3,441 | <span style='color: red'>(+26 [+2.3%])</span> 1,160 | <span style='color: green'>(-288 [-32.3%])</span> 604 |
| `main_trace_commit_time_ms` | <span style='color: red'>(+1 [+2.4%])</span> 54 | <span style='color: red'>(+5 [+2.4%])</span> 216 | <span style='color: red'>(+1 [+1.7%])</span> 59 | <span style='color: red'>(+1 [+2.0%])</span> 52 |
| `generate_perm_trace_time_ms` | <span style='color: green'>(-4 [-17.8%])</span> 20.75 | <span style='color: green'>(-18 [-17.8%])</span> 83 | <span style='color: green'>(-11 [-29.7%])</span> 26 | <span style='color: red'>(+1 [+5.9%])</span> 18 |
| `perm_trace_commit_time_ms` | <span style='color: red'>(+1 [+2.1%])</span> 67.35 | <span style='color: red'>(+6 [+2.1%])</span> 269.40 | <span style='color: red'>(+1 [+0.8%])</span> 73.78 | <span style='color: red'>(+1 [+1.5%])</span> 57.29 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+2 [+3.5%])</span> 61.93 | <span style='color: red'>(+8 [+3.5%])</span> 247.73 | <span style='color: red'>(+3 [+3.7%])</span> 72.09 | <span style='color: red'>(+1 [+1.7%])</span> 55.44 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+1 [+3.3%])</span> 16.41 | <span style='color: red'>(+2 [+3.3%])</span> 65.64 | <span style='color: red'>(+0 [+0.6%])</span> 18.87 | <span style='color: red'>(+0 [+2.4%])</span> 14.12 |
| `pcs_opening_time_ms ` | <span style='color: green'>(-122 [-16.1%])</span> 636.50 | <span style='color: green'>(-490 [-16.1%])</span> 2,546 | <span style='color: red'>(+20 [+2.2%])</span> 915 | <span style='color: green'>(-285 [-42.2%])</span> 390 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 1,195 | 1 | 36 | 4,137,139 | 114.06 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 180 | 1,557 | 23,441,564 | 150,778,428 | 180 | 1,160 | 0 | 64.22 | 18.87 | 7 | 73.78 | 915 | 101 | 914 | 3 | 59 | 10,895,130 | 26 | 56 | 1,103,000 | 30.42 | 22 | 83 | 0 | 914 | 
| regex_program | 1 | 187 | 1,035 | 11,592,182 | 128,513,066 | 187 | 762 | 1 | 55.44 | 16.61 | 6 | 68.91 | 548 | 88 | 548 | 0 | 52 | 2,190,100 | 18 | 45 | 1,104,000 | 32.86 | 17 | 72 | 0 | 548 | 
| regex_program | 2 | 187 | 877 | 11,583,038 | 128,513,066 | 187 | 604 | 1 | 55.99 | 16.04 | 6 | 69.43 | 390 | 88 | 389 | 0 | 53 | 2,181,164 | 18 | 45 | 1,104,000 | 32.91 | 17 | 72 | 0 | 389 | 
| regex_program | 3 | 204 | 1,195 | 11,854,458 | 103,456,394 | 204 | 915 | 0 | 72.09 | 14.12 | 7 | 57.29 | 693 | 81 | 693 | 0 | 52 | 2,423,136 | 21 | 34 | 826,139 | 32.41 | 19 | 87 | 0 | 692 | 

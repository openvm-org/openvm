...
|:---|---:|---:|---:|
| Total | <span style='color: red'>(+0 [+4.2%])</span> 2.50 | <span style='color: red'>(+0 [+12.1%])</span> 1.37 | 1.37 |
| fibonacci_program | <span style='color: red'>(+0 [+4.2%])</span> 2.50 | <span style='color: red'>(+0 [+12.1%])</span> 1.37 |  1.37 |


| fibonacci_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+50 [+4.2%])</span> 1,243 | <span style='color: red'>(+101 [+4.2%])</span> 2,486 | <span style='color: red'>(+148 [+12.2%])</span> 1,363 | <span style='color: green'>(-47 [-4.0%])</span> 1,123 |
...
| `execute_metered_insn_mi/s` | <span style='color: green'>(-2 [-1.4%])</span> 162.27 | -          | <span style='color: green'>(-2 [-1.4%])</span> 162.27 | <span style='color: green'>(-2 [-1.4%])</span> 162.27 |
| `execute_preflight_insns` |  750,104.50 |  1,500,209 |  873,000 |  627,209 |
| `execute_preflight_time_ms` | <span style='color: green'>(-0 [-1.9%])</span> 26.50 | <span style='color: green'>(-1 [-1.9%])</span> 53 | <span style='color: green'>(-1 [-3.0%])</span> 32 |  21 |
| `execute_preflight_insn_mi/s` | <span style='color: green'>(-0 [-0.6%])</span> 38.27 | -          | <span style='color: green'>(-1 [-1.4%])</span> 38.33 | <span style='color: red'>(+0 [+0.2%])</span> 38.21 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+7 [+3.7%])</span> 198 | <span style='color: red'>(+14 [+3.7%])</span> 396 | <span style='color: red'>(+7 [+3.6%])</span> 201 | <span style='color: red'>(+7 [+3.7%])</span> 195 |
| `memory_finalize_time_ms` | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+44 [+5.1%])</span> 916.50 | <span style='color: red'>(+89 [+5.1%])</span> 1,833 | <span style='color: red'>(+63 [+6.9%])</span> 975 | <span style='color: red'>(+26 [+3.1%])</span> 858 |
| `main_trace_commit_time_ms` | <span style='color: red'>(+1 [+3.3%])</span> 31 | <span style='color: red'>(+2 [+3.3%])</span> 62 | <span style='color: red'>(+1 [+3.1%])</span> 33 | <span style='color: red'>(+1 [+3.6%])</span> 29 |
| `generate_perm_trace_time_ms` |  22.50 |  45 |  25 |  20 |
| `perm_trace_commit_time_ms` | <span style='color: red'>(+1 [+1.9%])</span> 41.64 | <span style='color: red'>(+2 [+1.9%])</span> 83.28 | <span style='color: red'>(+1 [+1.8%])</span> 44.01 | <span style='color: red'>(+1 [+2.0%])</span> 39.27 |
| `quotient_poly_compute_time_ms` | <span style='color: green'>(-0 [-0.3%])</span> 31.10 | <span style='color: green'>(-0 [-0.3%])</span> 62.20 | <span style='color: green'>(-0 [-1.1%])</span> 33.63 | <span style='color: red'>(+0 [+0.7%])</span> 28.56 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+1 [+9.6%])</span> 12.98 | <span style='color: red'>(+2 [+9.6%])</span> 25.96 | <span style='color: red'>(+1 [+7.3%])</span> 13.28 | <span style='color: red'>(+1 [+12.1%])</span> 12.67 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+42 [+5.8%])</span> 775.50 | <span style='color: red'>(+85 [+5.8%])</span> 1,551 | <span style='color: red'>(+50 [+6.4%])</span> 829 | <span style='color: red'>(+35 [+5.1%])</span> 722 |
...
| --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 1,123 | 1 | 9 | 1,500,209 | 162.27 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 195 | 1,363 | 9,677,708 | 84,395,212 | 195 | 975 | 0 | 33.63 | 13.28 | 6 | 44.01 | 829 | 64 | 829 | 0 | 33 | 1,035,986 | 20 | 32 | 873,000 | 38.21 | 14 | 47 | 0 | 829 | 
| fibonacci_program | 1 | 201 | 1,123 | 9,708,170 | 74,305,770 | 201 | 858 | 1 | 28.56 | 12.67 | 5 | 39.27 | 722 | 64 | 722 | 0 | 29 | 1,064,416 | 25 | 21 | 627,209 | 38.33 | 11 | 41 | 0 | 722 | 

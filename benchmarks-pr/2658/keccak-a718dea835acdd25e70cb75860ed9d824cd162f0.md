...
|:---|---:|---:|---:|
| Total |  18.67 |  5.28 |  5.28 |
| app_proof |  15.64 |  3.02 |  3.02 |
| leaf |  2.18 |  1.41 |  1.41 |
...
| `total_proof_time_ms ` |  2,601.17 |  15,607 |  2,980 |  2,506 |
| `execute_metered_time_ms` |  36 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  33.55 | -          |  33.55 |  33.55 |
| `execute_preflight_insns` |  205,869.67 |  1,235,218 |  207,000 |  200,218 |
| `execute_preflight_time_ms` |  175.83 |  1,055 |  261 |  15 |
| `execute_preflight_insn_mi/s` |  19.63 | -          |  19.77 |  19.34 |
| `trace_gen_time_ms   ` |  388 |  2,328 |  541 |  351 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,974 |  11,844 |  2,252 |  1,911 |
| `prover.main_trace_commit_time_ms` |  689.33 |  4,136 |  851 |  656 |
| `prover.rap_constraints_time_ms` |  1,102.33 |  6,614 |  1,219 |  1,074 |
| `prover.openings_time_ms` |  181 |  1,086 |  183 |  178 |
| `prover.rap_constraints.logup_gkr_time_ms` |  275.50 |  1,653 |  387 |  253 |
| `prover.rap_constraints.round0_time_ms` |  516 |  3,096 |  518 |  514 |
| `prover.rap_constraints.mle_rounds_time_ms` |  309.83 |  1,859 |  315 |  304 |
| `prover.openings.stacked_reduction_time_ms` |  138.83 |  833 |  140 |  137 |
...
| `prover.openings.whir_time_ms` |  41.50 |  249 |  43 |  38 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,090.50 |  2,181 |  1,413 |  768 |
| `execute_preflight_time_ms` |  4.50 |  9 |  5 |  4 |
| `trace_gen_time_ms   ` |  135.50 |  271 |  182 |  89 |
| `generate_blob_total_time_ms` |  25.50 |  51 |  34 |  17 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  954 |  1,908 |  1,230 |  678 |
| `prover.main_trace_commit_time_ms` |  543 |  1,086 |  713 |  373 |
| `prover.rap_constraints_time_ms` |  304 |  608 |  390 |  218 |
...
| `prover.rap_constraints.mle_rounds_time_ms` |  92.50 |  185 |  120 |  65 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/a718dea835acdd25e70cb75860ed9d824cd162f0/keccak-a718dea835acdd25e70cb75860ed9d824cd162f0.memory.svg)
...
| app_proof |  |  |  |  |  | 2,522 |  |  | 36 | 1,235,218 | 33.55 | 0 | 15,652 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 38 | 513 | 38 | 14 | 4 | 2 | 2 | 2 | 
| internal_recursive.0 | 1 | 12 | 181 | 12 | 2 | 1 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 8 | 153 | 8 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 182 | 1,413 | 182 | 64 | 34 | 5 | 7 | 7 | 
| leaf | 1 | 89 | 768 | 88 | 32 | 17 | 4 | 7 | 7 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 109,497,984 | 474 | 245 | 0 | 14 | 172 | 45 | 45 | 93 | 33 | 0 | 56 | 18 | 38 | 7 | 30 | 245 | 172 | 0 | 2 | 32 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 25,962,119 | 168 | 51 | 0 | 3 | 74 | 23 | 23 | 28 | 21 | 0 | 41 | 18 | 23 | 1 | 21 | 51 | 74 | 0 | 2 | 21 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 17,507,975 | 144 | 33 | 0 | 3 | 64 | 22 | 22 | 24 | 17 | 0 | 45 | 22 | 22 | 1 | 20 | 34 | 64 | 0 | 2 | 16 | 0 | 0 | 
| leaf | 0 | prover | 583,523,386 | 1,230 | 713 | 0 | 47 | 390 | 189 | 188 | 120 | 81 | 0 | 126 | 40 | 85 | 40 | 45 | 713 | 390 | 0 | 6 | 79 | 0 | 0 | 
| leaf | 1 | prover | 300,618,208 | 678 | 372 | 0 | 24 | 218 | 101 | 100 | 65 | 50 | 0 | 87 | 36 | 51 | 19 | 31 | 373 | 218 | 0 | 6 | 49 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,205,061,845 | 2,252 | 851 | 0 | 249 | 1,219 | 516 | 515 | 315 | 387 | 132 | 180 | 40 | 140 | 84 | 55 | 851 | 1,219 | 0 | 4 | 253 | 0 | 0 | 
| app_proof | prover | 1 | 1,205,053,652 | 1,920 | 656 | 0 | 51 | 1,082 | 518 | 518 | 309 | 253 | 0 | 180 | 43 | 137 | 83 | 53 | 656 | 1,082 | 0 | 3 | 252 | 0 | 0 | 
| app_proof | prover | 2 | 1,205,053,652 | 1,915 | 656 | 0 | 51 | 1,075 | 518 | 517 | 304 | 253 | 0 | 183 | 42 | 140 | 86 | 54 | 657 | 1,075 | 0 | 4 | 252 | 0 | 0 | 
| app_proof | prover | 3 | 1,205,053,652 | 1,911 | 657 | 0 | 51 | 1,074 | 515 | 515 | 305 | 253 | 0 | 178 | 38 | 139 | 84 | 55 | 657 | 1,074 | 0 | 3 | 252 | 0 | 0 | 
| app_proof | prover | 4 | 1,205,053,652 | 1,921 | 657 | 0 | 51 | 1,081 | 514 | 514 | 313 | 253 | 0 | 182 | 43 | 138 | 85 | 52 | 657 | 1,081 | 0 | 3 | 252 | 0 | 0 | 
| app_proof | prover | 5 | 1,205,062,652 | 1,925 | 657 | 0 | 52 | 1,083 | 515 | 515 | 313 | 254 | 0 | 183 | 43 | 139 | 84 | 54 | 658 | 1,083 | 0 | 3 | 253 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 541 | 2,980 | 541 | 170 | 0 | 189 | 15 | 207,000 | 19.34 | 
| app_proof | 1 | 351 | 2,573 | 351 | 41 | 0 | 1 | 261 | 207,000 | 19.72 | 
| app_proof | 2 | 351 | 2,510 | 351 | 41 | 0 | 2 | 201 | 207,000 | 19.72 | 
| app_proof | 3 | 352 | 2,506 | 352 | 41 | 0 | 3 | 202 | 207,000 | 19.69 | 
| app_proof | 4 | 352 | 2,516 | 352 | 41 | 0 | 2 | 202 | 207,000 | 19.56 | 
| app_proof | 5 | 381 | 2,522 | 381 | 41 | 0 | 32 | 174 | 200,218 | 19.77 | 

...
| `total_proof_time_ms ` |  717.50 |  1,435 |  780 |  655 |
| `execute_metered_time_ms` |  38 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  108.75 | -          |  108.75 |  108.75 |
| `execute_preflight_insns` |  2,068,347 |  4,136,694 |  2,208,000 |  1,928,694 |
| `execute_preflight_time_ms` |  86.50 |  173 |  95 |  78 |
| `execute_preflight_insn_mi/s` |  32.22 | -          |  33.10 |  31.33 |
| `trace_gen_time_ms   ` |  140.50 |  281 |  146 |  135 |
| `memory_finalize_time_ms` |  2 |  4 |  4 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  382.50 |  765 |  389 |  376 |
| `prover.main_trace_commit_time_ms` |  97.50 |  195 |  102 |  93 |
| `prover.rap_constraints_time_ms` |  236 |  472 |  247 |  225 |
| `prover.openings_time_ms` |  48 |  96 |  48 |  48 |
...
| `prover.openings.whir_time_ms` |  21.50 |  43 |  23 |  20 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/a021cefc8efa3cf38edc2da679acfa09ac1ad1a6/regex-a021cefc8efa3cf38edc2da679acfa09ac1ad1a6.memory.svg)
...
| app_proof |  |  |  |  |  | 655 |  |  | 38 | 4,136,694 | 108.75 | 0 | 1,488 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 14 | 248 | 14 | 4 | 0 | 2 | 1 | 1 | 
| internal_recursive.0 | 1 | 9 | 171 | 9 | 1 | 0 | 2 | 0 | 0 | 
| internal_recursive.1 | 1 | 8 | 158 | 8 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 48 | 377 | 47 | 13 | 3 | 4 | 1 | 1 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 41,110,275 | 233 | 84 | 0 | 5 | 100 | 30 | 29 | 45 | 24 | 0 | 48 | 21 | 26 | 2 | 23 | 85 | 100 | 0 | 2 | 23 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 23,651,975 | 161 | 48 | 0 | 3 | 70 | 23 | 23 | 27 | 18 | 0 | 42 | 18 | 23 | 1 | 21 | 49 | 70 | 0 | 2 | 17 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 17,507,975 | 150 | 34 | 0 | 3 | 63 | 21 | 21 | 24 | 17 | 0 | 51 | 29 | 22 | 1 | 20 | 35 | 63 | 0 | 2 | 16 | 0 | 0 | 
| leaf | 0 | prover | 113,138,688 | 328 | 130 | 0 | 8 | 137 | 52 | 51 | 37 | 47 | 0 | 60 | 29 | 30 | 6 | 23 | 131 | 137 | 0 | 5 | 46 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 339,711,558 | 376 | 102 | 0 | 2 | 225 | 51 | 51 | 35 | 138 | 0 | 48 | 20 | 28 | 10 | 17 | 102 | 225 | 0 | 3 | 137 | 0 | 0 | 
| app_proof | prover | 1 | 303,309,204 | 389 | 93 | 0 | 13 | 247 | 80 | 80 | 28 | 137 | 0 | 48 | 23 | 25 | 8 | 16 | 93 | 247 | 0 | 2 | 137 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 135 | 780 | 135 | 171 | 4 | 117 | 95 | 2,208,000 | 31.33 | 
| app_proof | 1 | 146 | 655 | 146 | 40 | 0 | 131 | 78 | 1,928,694 | 33.10 | 

...
|:---|---:|---:|---:|
| Total |  18.99 |  5.36 |  5.36 |
| app_proof |  15.90 |  3.05 |  3.05 |
| leaf |  2.23 |  1.45 |  1.45 |
...
| `total_proof_time_ms ` |  2,644.17 |  15,865 |  3,014 |  2,553 |
...
| `execute_preflight_time_ms` |  176.83 |  1,061 |  263 |  15 |
| `execute_preflight_insn_mi/s` |  19.62 | -          |  19.87 |  19.04 |
| `trace_gen_time_ms   ` |  392.17 |  2,353 |  548 |  350 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  2,011.50 |  12,069 |  2,280 |  1,953 |
| `prover.main_trace_commit_time_ms` |  698.17 |  4,189 |  857 |  666 |
| `prover.rap_constraints_time_ms` |  1,124 |  6,744 |  1,234 |  1,097 |
| `prover.openings_time_ms` |  188.17 |  1,129 |  190 |  185 |
| `prover.rap_constraints.logup_gkr_time_ms` |  276.67 |  1,660 |  385 |  254 |
| `prover.rap_constraints.round0_time_ms` |  525.50 |  3,153 |  531 |  522 |
| `prover.rap_constraints.mle_rounds_time_ms` |  321 |  1,926 |  327 |  317 |
| `prover.openings.stacked_reduction_time_ms` |  144.17 |  865 |  145 |  143 |
| `prover.openings.stacked_reduction.round0_time_ms` |  87.83 |  527 |  89 |  86 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  55.83 |  335 |  58 |  55 |
| `prover.openings.whir_time_ms` |  43.33 |  260 |  45 |  41 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,114.50 |  2,229 |  1,446 |  783 |
| `execute_preflight_time_ms` |  4.50 |  9 |  5 |  4 |
| `trace_gen_time_ms   ` |  137.50 |  275 |  185 |  90 |
| `generate_blob_total_time_ms` |  25.50 |  51 |  34 |  17 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  976 |  1,952 |  1,260 |  692 |
| `prover.main_trace_commit_time_ms` |  552.50 |  1,105 |  726 |  379 |
| `prover.rap_constraints_time_ms` |  318 |  636 |  408 |  228 |
| `prover.openings_time_ms` |  105 |  210 |  125 |  85 |
| `prover.rap_constraints.logup_gkr_time_ms` |  68 |  136 |  82 |  54 |
| `prover.rap_constraints.round0_time_ms` |  152 |  304 |  200 |  104 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/a021cefc8efa3cf38edc2da679acfa09ac1ad1a6/keccak-a021cefc8efa3cf38edc2da679acfa09ac1ad1a6.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 74 | 9 |  |  | 0 |  | 342 | 9 |  |  |  |  |  |  | 
| app_proof |  |  |  |  |  | 2,570 |  |  | 37 | 1,235,218 | 33.28 | 0 | 15,910 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 37 | 524 | 37 | 13 | 4 | 2 | 2 | 2 | 
| internal_recursive.0 | 1 | 12 | 186 | 12 | 2 | 1 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 8 | 149 | 8 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 185 | 1,446 | 185 | 65 | 34 | 5 | 8 | 8 | 
| leaf | 1 | 90 | 783 | 90 | 32 | 17 | 4 | 7 | 7 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 109,497,984 | 486 | 249 | 0 | 14 | 176 | 46 | 45 | 95 | 34 | 0 | 59 | 21 | 38 | 7 | 30 | 249 | 176 | 0 | 3 | 32 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 25,962,119 | 174 | 51 | 0 | 3 | 76 | 23 | 23 | 29 | 23 | 0 | 46 | 21 | 24 | 1 | 21 | 51 | 76 | 0 | 2 | 22 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 17,507,975 | 140 | 34 | 0 | 3 | 63 | 21 | 21 | 24 | 17 | 0 | 41 | 18 | 22 | 1 | 20 | 35 | 63 | 0 | 2 | 16 | 0 | 0 | 
| leaf | 0 | prover | 583,523,386 | 1,260 | 725 | 0 | 47 | 408 | 200 | 199 | 125 | 82 | 0 | 125 | 37 | 87 | 41 | 46 | 726 | 408 | 0 | 6 | 81 | 0 | 0 | 
| leaf | 1 | prover | 300,618,208 | 692 | 378 | 0 | 24 | 228 | 104 | 103 | 68 | 54 | 0 | 85 | 32 | 52 | 20 | 32 | 379 | 228 | 0 | 6 | 50 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,205,061,845 | 2,280 | 857 | 0 | 244 | 1,234 | 522 | 521 | 327 | 385 | 129 | 187 | 43 | 144 | 86 | 57 | 857 | 1,234 | 0 | 4 | 255 | 0 | 0 | 
| app_proof | prover | 1 | 1,205,053,652 | 1,957 | 666 | 0 | 51 | 1,100 | 524 | 524 | 321 | 254 | 0 | 190 | 44 | 145 | 89 | 55 | 666 | 1,100 | 0 | 4 | 253 | 0 | 0 | 
| app_proof | prover | 2 | 1,205,053,652 | 1,953 | 667 | 0 | 51 | 1,097 | 524 | 524 | 317 | 255 | 0 | 188 | 43 | 145 | 89 | 55 | 667 | 1,097 | 0 | 4 | 254 | 0 | 0 | 
| app_proof | prover | 3 | 1,205,053,652 | 1,955 | 666 | 0 | 51 | 1,103 | 528 | 527 | 319 | 255 | 0 | 185 | 41 | 143 | 88 | 55 | 666 | 1,103 | 0 | 4 | 254 | 0 | 0 | 
| app_proof | prover | 4 | 1,205,053,652 | 1,956 | 666 | 0 | 51 | 1,100 | 524 | 524 | 320 | 255 | 0 | 189 | 45 | 143 | 88 | 55 | 666 | 1,100 | 0 | 4 | 253 | 0 | 0 | 
| app_proof | prover | 5 | 1,205,062,652 | 1,968 | 666 | 0 | 52 | 1,110 | 531 | 530 | 322 | 256 | 0 | 190 | 44 | 145 | 87 | 58 | 667 | 1,110 | 0 | 4 | 254 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 548 | 3,014 | 548 | 170 | 0 | 196 | 15 | 207,000 | 19.49 | 
| app_proof | 1 | 350 | 2,613 | 350 | 41 | 0 | 1 | 263 | 207,000 | 19.04 | 
| app_proof | 2 | 355 | 2,553 | 355 | 41 | 0 | 6 | 203 | 207,000 | 19.72 | 
| app_proof | 3 | 357 | 2,557 | 357 | 41 | 0 | 8 | 203 | 207,000 | 19.87 | 
| app_proof | 4 | 358 | 2,558 | 358 | 41 | 0 | 9 | 202 | 207,000 | 19.80 | 
| app_proof | 5 | 385 | 2,570 | 385 | 41 | 0 | 37 | 175 | 200,218 | 19.83 | 

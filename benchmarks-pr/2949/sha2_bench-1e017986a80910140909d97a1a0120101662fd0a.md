...
| `total_proof_time_ms ` |  4,048 |  8,096 |  5,104 |  2,992 |
...
| `execute_preflight_time_ms` |  239 |  478 |  273 |  205 |
| `execute_preflight_insn_mi/s` |  37.67 | -          |  40.06 |  35.27 |
| `trace_gen_time_ms   ` |  121 |  242 |  170 |  72 |
| `set_initial_memory_time_ms` |  88.50 |  177 |  136 |  41 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  3,598 |  7,196 |  4,592 |  2,604 |
| `prover.main_trace_commit_time_ms` |  949 |  1,898 |  1,312 |  586 |
| `prover.rap_constraints_time_ms` |  1,945.50 |  3,891 |  2,396 |  1,495 |
| `prover.openings_time_ms` |  702 |  1,404 |  882 |  522 |
| `prover.rap_constraints.logup_gkr_time_ms` |  549.50 |  1,099 |  588 |  511 |
| `prover.rap_constraints.round0_time_ms` |  1,022 |  2,044 |  1,327 |  717 |
| `prover.rap_constraints.mle_rounds_time_ms` |  372.50 |  745 |  480 |  265 |
...
| `prover.openings.whir_time_ms` |  540 |  1,080 |  674 |  406 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/1e017986a80910140909d97a1a0120101662fd0a/sha2_bench-1e017986a80910140909d97a1a0120101662fd0a.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 69 |  |  |  | 342 |  |  |  |  |  |  | 
| app_proof |  |  |  | 2,992 |  | 86 | 11,167,961 | 129.16 | 0 | 8,188 |  | 
...
| internal_recursive.0 | 1 | 13 | 184 | 10 | 1 | 0 | 2 | 1 | 1 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 325 | 116 | 0 | 0 | 107 | 35 | 34 | 51 | 20 | 0 | 101 | 87 | 13 | 3 | 9 | 116 | 116 | 107 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 171 | 47 | 0 | 0 | 67 | 25 | 24 | 28 | 13 | 0 | 56 | 48 | 8 | 1 | 6 | 47 | 47 | 67 | 0 | 2 | 12 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 137 | 32 | 0 | 0 | 61 | 22 | 22 | 24 | 13 | 0 | 43 | 36 | 7 | 1 | 5 | 32 | 32 | 61 | 0 | 2 | 13 | 0 | 0 | 
| leaf | 0 | prover | 237,929,016 | 883 | 370 | 0 | 0 | 225 | 108 | 107 | 66 | 50 | 0 | 286 | 250 | 36 | 19 | 16 | 370 | 370 | 225 | 0 | 9 | 49 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,286,242,554 | 4,592 | 1,312 | 0 | 0 | 2,396 | 1,327 | 1,326 | 480 | 588 | 0 | 882 | 674 | 208 | 130 | 77 | 1,312 | 1,312 | 2,396 | 0 | 5 | 586 | 0 | 0 | 
| app_proof | prover | 1 | 750,289,144 | 2,604 | 586 | 0 | 0 | 1,495 | 717 | 717 | 265 | 511 | 0 | 522 | 406 | 116 | 70 | 45 | 586 | 586 | 1,495 | 0 | 5 | 510 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 136 | 1 | 170 | 5,104 | 170 | 136 | 13,306,647,852 | 2,134,713,996 | 15,441,361,848 | 2,097,152 | 0 | 3 | 205 | 7,124,000 | 35.27 | 
| app_proof | 1 | 41 | 1 | 72 | 2,992 | 72 | 41 | 7,584,540,132 | 1,503,573,469 | 9,088,113,601 | 2,097,152 | 0 | 2 | 273 | 4,043,961 | 40.06 | 

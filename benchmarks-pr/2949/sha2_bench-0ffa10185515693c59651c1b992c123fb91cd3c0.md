...
| `total_proof_time_ms ` |  4,091.50 |  8,183 |  5,166 |  3,017 |
...
| `execute_preflight_time_ms` |  239 |  478 |  275 |  203 |
| `execute_preflight_insn_mi/s` |  37.82 | -          |  40.04 |  35.60 |
| `trace_gen_time_ms   ` |  121 |  242 |  170 |  72 |
| `set_initial_memory_time_ms` |  88.50 |  177 |  136 |  41 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  3,641.50 |  7,283 |  4,655 |  2,628 |
| `prover.main_trace_commit_time_ms` |  959 |  1,918 |  1,329 |  589 |
| `prover.rap_constraints_time_ms` |  1,973.50 |  3,947 |  2,435 |  1,512 |
| `prover.openings_time_ms` |  708.50 |  1,417 |  890 |  527 |
| `prover.rap_constraints.logup_gkr_time_ms` |  554 |  1,108 |  593 |  515 |
| `prover.rap_constraints.round0_time_ms` |  1,038.50 |  2,077 |  1,351 |  726 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/0ffa10185515693c59651c1b992c123fb91cd3c0/sha2_bench-0ffa10185515693c59651c1b992c123fb91cd3c0.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 69 |  |  |  | 341 |  |  |  |  |  |  | 
| app_proof |  |  |  | 3,017 |  | 86 | 11,167,961 | 129.35 | 0 | 8,275 |  | 
...
| leaf | 0 | 107 | 1,000 | 107 | 34 | 17 | 2 | 7 | 7 | 
...
| internal_recursive.0 | 1 | prover | 15,378,769 | 169 | 47 | 0 | 0 | 67 | 24 | 24 | 28 | 13 | 0 | 54 | 45 | 8 | 1 | 6 | 47 | 47 | 67 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 138 | 32 | 0 | 0 | 62 | 23 | 22 | 24 | 14 | 0 | 43 | 35 | 7 | 1 | 5 | 32 | 32 | 62 | 0 | 3 | 13 | 0 | 0 | 
| leaf | 0 | prover | 237,929,016 | 892 | 373 | 0 | 0 | 229 | 110 | 109 | 67 | 50 | 0 | 289 | 251 | 37 | 20 | 17 | 373 | 373 | 229 | 0 | 10 | 50 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,286,242,554 | 4,655 | 1,328 | 0 | 0 | 2,435 | 1,351 | 1,351 | 489 | 593 | 0 | 890 | 678 | 212 | 132 | 79 | 1,329 | 1,328 | 2,435 | 0 | 5 | 592 | 0 | 0 | 
| app_proof | prover | 1 | 750,289,144 | 2,628 | 588 | 0 | 0 | 1,512 | 726 | 726 | 270 | 515 | 0 | 527 | 409 | 117 | 70 | 46 | 589 | 588 | 1,512 | 0 | 6 | 514 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 136 | 1 | 170 | 5,166 | 170 | 136 | 13,306,647,852 | 2,134,713,996 | 15,441,361,848 | 2,097,152 | 0 | 3 | 203 | 7,124,000 | 35.60 | 
| app_proof | 1 | 41 | 1 | 72 | 3,017 | 72 | 41 | 7,584,540,132 | 1,503,573,469 | 9,088,113,601 | 2,097,152 | 0 | 2 | 275 | 4,043,961 | 40.04 | 

...
|:---|---:|---:|---:|
| Total |  5.45 |  3.85 |  3.85 |
| app_proof |  3.90 |  2.30 |  2.30 |
| leaf |  0.97 |  0.97 |  0.97 |
...
| `total_proof_time_ms ` |  1,934.50 |  3,869 |  2,269 |  1,600 |
| `execute_metered_time_ms` |  35 | -          | -          | -          |
| `execute_metered_insns` |  2,579,903 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  73.40 | -          |  73.40 |  73.40 |
| `execute_preflight_insns` |  1,289,951.50 |  2,579,903 |  1,540,000 |  1,039,903 |
| `execute_preflight_time_ms` |  116 |  232 |  162 |  70 |
| `execute_preflight_insn_mi/s` |  35.21 | -          |  36.67 |  33.76 |
| `trace_gen_time_ms   ` |  122.50 |  245 |  179 |  66 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,577 |  3,154 |  1,825 |  1,329 |
| `prover.main_trace_commit_time_ms` |  512.50 |  1,025 |  600 |  425 |
| `prover.rap_constraints_time_ms` |  936 |  1,872 |  1,087 |  785 |
| `prover.openings_time_ms` |  128 |  256 |  137 |  119 |
| `prover.rap_constraints.logup_gkr_time_ms` |  167.50 |  335 |  199 |  136 |
| `prover.rap_constraints.round0_time_ms` |  565 |  1,130 |  672 |  458 |
| `prover.rap_constraints.mle_rounds_time_ms` |  202 |  404 |  215 |  189 |
| `prover.openings.stacked_reduction_time_ms` |  93 |  186 |  102 |  84 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/4c33cf70b986023280907f6f57b1b6e4b67286ad/kitchen_sink-4c33cf70b986023280907f6f57b1b6e4b67286ad.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 80 | 9 |  |  | 0 |  | 417 | 9 |  |  |  |  |  |  | 
| app_proof |  |  |  |  |  | 1,600 |  |  | 35 | 2,579,903 | 73.40 | 0 | 3,910 |  | 
...
| leaf | 0 | 139 | 967 | 139 | 27 | 10 | 21 | 7 | 7 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,577,979 | 258 | 115 | 0 | 0 | 108 | 35 | 34 | 52 | 20 | 0 | 33 | 19 | 13 | 3 | 9 | 116 | 108 | 0 | 2 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,767 | 146 | 44 | 0 | 0 | 70 | 25 | 24 | 30 | 14 | 0 | 30 | 21 | 8 | 1 | 6 | 45 | 69 | 0 | 3 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 125 | 31 | 0 | 0 | 66 | 25 | 24 | 25 | 14 | 0 | 27 | 19 | 7 | 1 | 5 | 32 | 66 | 0 | 2 | 13 | 0 | 0 | 
| leaf | 0 | prover | 265,003,892 | 827 | 399 | 0 | 1 | 350 | 135 | 134 | 78 | 135 | 0 | 77 | 36 | 40 | 22 | 18 | 399 | 350 | 0 | 6 | 134 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 567,917,156 | 1,825 | 599 | 0 | 195 | 1,087 | 672 | 670 | 215 | 199 | 58 | 137 | 35 | 102 | 51 | 50 | 600 | 1,087 | 0 | 3 | 139 | 0 | 0 | 
| app_proof | prover | 1 | 537,266,124 | 1,329 | 425 | 0 | 2 | 785 | 458 | 458 | 189 | 136 | 0 | 119 | 34 | 84 | 48 | 36 | 425 | 784 | 0 | 3 | 135 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 179 | 2,269 | 179 | 194 | 0 | 4 | 70 | 1,540,000 | 33.76 | 
| app_proof | 1 | 66 | 1,600 | 66 | 41 | 0 | 2 | 162 | 1,039,903 | 36.67 | 

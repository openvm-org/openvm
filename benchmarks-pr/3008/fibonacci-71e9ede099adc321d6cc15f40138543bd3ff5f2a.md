...
|:---|---:|---:|---:|
| Total |  1.95 |  1.50 |  1.50 |
| app_proof |  0.95 |  0.50 |  0.50 |
| leaf |  0.40 |  0.40 |  0.40 |
...
| `total_proof_time_ms ` |  463 |  926 |  479 |  447 |
| `compile_metered_time_ms` |  4 |  4 |  4 |  4 |
| `execute_metered_time_ms` |  21 | -          | -          | -          |
| `execute_metered_insns` |  4,000,051 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  187.80 | -          |  187.80 |  187.80 |
| `execute_preflight_insns` |  2,000,025.50 |  4,000,051 |  2,621,000 |  1,379,051 |
| `execute_preflight_time_ms` |  47.50 |  95 |  63 |  32 |
| `execute_preflight_insn_mi/s` |  43.39 | -          |  43.40 |  43.37 |
| `trace_gen_time_ms   ` |  39 |  78 |  51 |  27 |
| `set_initial_memory_time_ms` |  0 |  0 |  0 |  0 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  374.50 |  749 |  387 |  362 |
| `prover.main_trace_commit_time_ms` |  74 |  148 |  74 |  74 |
| `prover.rap_constraints_time_ms` |  219 |  438 |  232 |  206 |
| `prover.openings_time_ms` |  81 |  162 |  82 |  80 |
| `prover.rap_constraints.logup_gkr_time_ms` |  160.50 |  321 |  171 |  150 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/71e9ede099adc321d6cc15f40138543bd3ff5f2a/fibonacci-71e9ede099adc321d6cc15f40138543bd3ff5f2a.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 66 |  |  |  | 340 |  |  |  |  |  |  | 
| app_proof |  |  |  | 447 |  | 21 | 4,000,051 | 187.80 | 0 | 953 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 27,277,885 | 258 | 82 | 0 | 0 | 99 | 32 | 31 | 45 | 21 | 0 | 77 | 65 | 11 | 2 | 8 | 82 | 82 | 99 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 169 | 46 | 0 | 0 | 67 | 25 | 24 | 28 | 13 | 0 | 55 | 46 | 8 | 1 | 6 | 46 | 46 | 67 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 138 | 31 | 0 | 0 | 63 | 23 | 23 | 24 | 14 | 0 | 43 | 35 | 7 | 1 | 5 | 31 | 31 | 63 | 0 | 3 | 13 | 0 | 0 | 
| leaf | 0 | prover | 74,737,560 | 356 | 123 | 0 | 0 | 118 | 53 | 52 | 35 | 29 | 0 | 114 | 99 | 14 | 6 | 8 | 123 | 123 | 118 | 0 | 6 | 28 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 90,436,180 | 387 | 74 | 0 | 0 | 232 | 39 | 39 | 20 | 171 | 0 | 80 | 65 | 15 | 8 | 7 | 74 | 74 | 232 | 0 | 3 | 170 | 0 | 0 | 
| app_proof | prover | 1 | 90,435,040 | 362 | 73 | 0 | 0 | 206 | 35 | 35 | 20 | 150 | 0 | 82 | 67 | 14 | 7 | 6 | 74 | 74 | 206 | 0 | 3 | 149 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 0 | 2 | 27 | 479 | 27 | 0 | 2,145,305,497 | 522,291 | 2,145,827,788 | 2,097,152 | 0 | 4 | 63 | 2,621,000 | 43.37 | 
| app_proof | 1 | 0 | 1 | 51 | 447 | 51 | 0 | 1,164,981,971 | 980,826,252 | 2,145,808,223 | 2,097,152 | 0 | 2 | 32 | 1,379,051 | 43.40 | 

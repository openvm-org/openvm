...
|:---|---:|---:|---:|
| Total |  10.09 |  7.16 |  7.16 |
| app_proof |  8.42 |  5.49 |  5.49 |
...
| `total_proof_time_ms ` |  4,168 |  8,336 |  5,406 |  2,930 |
...
| `execute_preflight_time_ms` |  159.50 |  319 |  208 |  111 |
| `execute_preflight_insn_mi/s` |  35.82 | -          |  36.74 |  34.89 |
| `trace_gen_time_ms   ` |  122.50 |  245 |  173 |  72 |
| `set_initial_memory_time_ms` |  0 |  0 |  0 |  0 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  3,884.50 |  7,769 |  5,024 |  2,745 |
| `prover.main_trace_commit_time_ms` |  1,164.50 |  2,329 |  1,746 |  583 |
| `prover.rap_constraints_time_ms` |  2,016.50 |  4,033 |  2,394 |  1,639 |
| `prover.openings_time_ms` |  701.50 |  1,403 |  882 |  521 |
| `prover.rap_constraints.logup_gkr_time_ms` |  627.50 |  1,255 |  670 |  585 |
| `prover.rap_constraints.round0_time_ms` |  1,015.50 |  2,031 |  1,327 |  704 |
| `prover.rap_constraints.mle_rounds_time_ms` |  373 |  746 |  481 |  265 |
| `prover.openings.stacked_reduction_time_ms` |  162 |  324 |  209 |  115 |
...
| `prover.openings.whir_time_ms` |  539.50 |  1,079 |  673 |  406 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/71e9ede099adc321d6cc15f40138543bd3ff5f2a/sha2_bench-71e9ede099adc321d6cc15f40138543bd3ff5f2a.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 71 |  |  |  | 347 |  |  |  |  |  |  | 
| app_proof |  |  |  | 2,930 |  | 88 | 11,167,961 | 126.04 | 0 | 8,431 |  | 
...
| app_proof | VmAirWrapper<Rv64BaseAluU16AdapterAir, AddSubCoreAir<4, 16> | 0 |  | 22 | 
...
| app_proof | VmAirWrapper<Rv64BaseAluU16AdapterAir, AddSubCoreAir<4, 16> | 1 |  | 8 | 
...
| app_proof | VmAirWrapper<Rv64LoadStoreAdapterAir, LoadStoreCoreAir<8> | 1 | 54 | 54 | 
| app_proof | VmAirWrapper<Rv64RdWriteAdapterAir, Rv64AuipcCoreAir> | 1 | 1 | 1 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 21 | 343 | 20 | 6 | 1 | 2 | 2 | 2 | 
| internal_recursive.0 | 1 | 12 | 182 | 11 | 1 | 0 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 10 | 146 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 110 | 995 | 109 | 34 | 17 | 2 | 7 | 7 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 322 | 115 | 0 | 0 | 105 | 33 | 33 | 51 | 19 | 0 | 101 | 87 | 13 | 3 | 9 | 115 | 115 | 105 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 170 | 45 | 0 | 0 | 67 | 24 | 23 | 27 | 15 | 0 | 56 | 48 | 8 | 1 | 6 | 46 | 45 | 67 | 0 | 3 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 136 | 31 | 0 | 0 | 61 | 23 | 22 | 24 | 13 | 0 | 42 | 35 | 7 | 1 | 5 | 32 | 31 | 61 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 237,929,016 | 885 | 368 | 0 | 0 | 223 | 106 | 105 | 64 | 52 | 0 | 292 | 256 | 36 | 19 | 16 | 369 | 368 | 223 | 0 | 10 | 49 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,286,242,554 | 5,024 | 1,746 | 0 | 0 | 2,394 | 1,327 | 1,327 | 481 | 585 | 1 | 882 | 673 | 209 | 130 | 78 | 1,746 | 1,746 | 2,394 | 0 | 4 | 583 | 0 | 0 | 
| app_proof | prover | 1 | 750,289,144 | 2,745 | 583 | 0 | 0 | 1,639 | 704 | 703 | 265 | 670 | 163 | 521 | 406 | 115 | 70 | 45 | 583 | 583 | 1,639 | 0 | 5 | 506 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 0 | 1 | 173 | 5,406 | 173 | 0 | 13,306,647,852 | 2,134,713,996 | 15,441,361,848 | 2,097,152 | 0 | 3 | 208 | 7,124,000 | 34.89 | 
| app_proof | 1 | 0 | 1 | 72 | 2,930 | 72 | 0 | 7,584,540,132 | 1,503,573,469 | 9,088,113,601 | 2,097,152 | 0 | 2 | 111 | 4,043,961 | 36.74 | 

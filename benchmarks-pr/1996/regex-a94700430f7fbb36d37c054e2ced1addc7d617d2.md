...
| `total_proof_time_ms ` |  3,803.50 |  7,607 |  4,888 |  2,719 |
...
| `execute_preflight_insn_mi/s` |  28.59 | -          |  30.99 |  26.19 |
| `trace_gen_time_ms   ` |  387.50 |  775 |  502 |  273 |
| `memory_finalize_time_ms` |  8.50 |  17 |  15 |  2 |
| `stark_prove_excluding_trace_time_ms` |  3,092 |  6,184 |  4,039 |  2,145 |
| `main_trace_commit_time_ms` |  626.50 |  1,253 |  843 |  410 |
| `generate_perm_trace_time_ms` |  239 |  478 |  313 |  165 |
| `perm_trace_commit_time_ms` |  647 |  1,294 |  848 |  446 |
| `quotient_poly_compute_time_ms` |  314 |  628 |  431 |  197 |
| `quotient_poly_commit_time_ms` |  304.50 |  609 |  398 |  211 |
| `pcs_opening_time_ms ` |  953.50 |  1,907 |  1,201 |  706 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 1 | 2,719 | 7 | 1 | 32 | 4,108,597 | 127.41 | 45 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 502 | 4,888 | 211,758,557 | 373,183,036 | 502 | 4,039 | 0 | 431 | 398 | 848 | 1,201 | 8 | 15 | 843 | 91,281,687 | 313 | 103 | 2,211,000 | 26.19 | 
| regex_program | 1 | 273 | 2,719 | 174,326,267 | 196,838,026 | 273 | 2,145 | 51 | 197 | 211 | 446 | 706 | 6 | 2 | 410 | 73,453,305 | 165 | 87 | 1,897,597 | 30.99 | 

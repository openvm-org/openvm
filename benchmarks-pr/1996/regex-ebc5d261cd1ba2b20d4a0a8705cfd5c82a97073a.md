...
|:---|---:|---:|
| Total |  7.71 |  4.99 |
| regex_program |  7.68 |  4.96 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  3,838.50 |  7,677 |  4,955 |  2,722 |
...
| `execute_metered_insn_mi/s` |  126.41 | -          |  126.41 |  126.41 |
| `execute_preflight_insns` |  2,054,298.50 |  4,108,597 |  2,211,000 |  1,897,597 |
| `execute_preflight_time_ms` |  94 |  188 |  101 |  87 |
| `execute_preflight_insn_mi/s` |  28.40 | -          |  30.93 |  25.87 |
| `trace_gen_time_ms   ` |  396.50 |  793 |  511 |  282 |
| `memory_finalize_time_ms` |  7.50 |  15 |  13 |  2 |
| `stark_prove_excluding_trace_time_ms` |  3,116.50 |  6,233 |  4,099 |  2,134 |
| `main_trace_commit_time_ms` |  625.50 |  1,251 |  842 |  409 |
| `generate_perm_trace_time_ms` |  238 |  476 |  330 |  146 |
| `perm_trace_commit_time_ms` |  671 |  1,342 |  895 |  447 |
| `quotient_poly_compute_time_ms` |  317.50 |  635 |  426 |  209 |
| `quotient_poly_commit_time_ms` |  301.50 |  603 |  402 |  201 |
| `pcs_opening_time_ms ` |  956 |  1,912 |  1,199 |  713 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 1 | 2,722 | 6 | 1 | 32 | 4,108,597 | 126.41 | 44 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 511 | 4,955 | 211,758,557 | 373,183,036 | 511 | 4,099 | 0 | 426 | 402 | 895 | 1,199 | 7 | 13 | 842 | 91,281,687 | 330 | 101 | 2,211,000 | 25.87 | 
| regex_program | 1 | 282 | 2,722 | 174,326,267 | 196,838,026 | 282 | 2,134 | 53 | 209 | 201 | 447 | 713 | 6 | 2 | 409 | 73,453,305 | 146 | 87 | 1,897,597 | 30.93 | 

...
|:---|---:|---:|---:|
| Total |  5.10 |  3.92 |  3.92 |
| app_proof |  4.15 |  2.97 |  2.97 |
| leaf |  0.52 |  0.52 |  0.52 |
...
| `total_proof_time_ms ` |  2,046 |  4,092 |  2,751 |  1,341 |
| `compile_metered_time_ms` |  2 |  2 |  2 |  2 |
| `execute_metered_time_ms` |  58 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  191.70 | -          |  191.70 |  191.70 |
| `set_initial_memory_time_ms` |  0 |  0 |  0 |  0 |
| `execute_preflight_insns` |  5,583,980.50 |  11,167,961 |  7,136,000 |  4,031,961 |
| `execute_preflight_time_ms` |  252 |  504 |  338 |  166 |
| `execute_preflight_insn_mi/s` |  22.16 | -          |  24.21 |  21.07 |
| `postflight_time_ms  ` |  66.50 |  133 |  85 |  48 |
| `postflight_memory_chronology_time_ms` |  7 |  14 |  10 |  4 |
| `postflight_program_index_time_ms` |  1 |  2 |  1 |  1 |
| `trace_gen_time_ms   ` |  57.50 |  115 |  91 |  24 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,636.50 |  3,273 |  2,195 |  1,078 |
| `prover.main_trace_commit_time_ms` |  392 |  784 |  567 |  217 |
| `prover.rap_constraints_time_ms` |  976.50 |  1,953 |  1,283 |  670 |
| `prover.openings_time_ms` |  267 |  534 |  344 |  190 |
| `prover.rap_constraints.logup_gkr_time_ms` |  273 |  546 |  352 |  194 |
| `prover.rap_constraints.round0_time_ms` |  523.50 |  1,047 |  697 |  350 |
| `prover.rap_constraints.mle_rounds_time_ms` |  179 |  358 |  232 |  126 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/e298ad0738a0cac5ac3286ef9c6d52f9d043f2e9/sha2_bench-e298ad0738a0cac5ac3286ef9c6d52f9d043f2e9.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 178 | 46 | 0 | 0 | 78 | 27 | 26 | 37 | 13 | 0 | 52 | 42 | 10 | 2 | 7 | 46 | 46 | 78 | 0 | 1 | 12 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 113 | 20 | 0 | 0 | 56 | 20 | 20 | 23 | 11 | 0 | 36 | 29 | 7 | 1 | 6 | 20 | 20 | 55 | 0 | 1 | 10 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 98 | 15 | 0 | 0 | 54 | 22 | 21 | 21 | 11 | 0 | 28 | 20 | 7 | 1 | 5 | 15 | 15 | 54 | 0 | 1 | 10 | 0 | 0 | 
| leaf | 0 | prover | 237,929,272 | 406 | 145 | 0 | 0 | 141 | 71 | 69 | 44 | 26 | 0 | 118 | 96 | 21 | 10 | 11 | 145 | 145 | 141 | 0 | 3 | 25 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover |  | 0 | 1,285,848,458 | 2,195 | 567 | 0 | 0 | 1,283 | 697 | 697 | 232 | 352 | 0 | 344 | 250 | 94 | 57 | 36 | 567 | 567 | 1,283 | 0 | 1 | 351 | 0 | 0 | 
| app_proof | prover |  | 1 | 690,310,084 | 1,078 | 217 | 0 | 0 | 670 | 350 | 350 | 126 | 194 | 0 | 190 | 138 | 51 | 30 | 21 | 217 | 217 | 670 | 0 | 1 | 193 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof |  | 1,341 | 58 | 11,167,961 | 191.70 | 0 | 4,156 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof |  | 0 | 0 | 2 | 91 | 2,751 | 3 | 0 | 0 | 85 | 1 | 10 | 0 | 12,567,738,156 | 2,865,208,140 | 15,432,946,296 | 2,097,152 | 2 | 0 | 0 | 3 | 87 | 338 | 7,136,000 | 21.07 | 0 | 0 | 
| app_proof |  | 1 | 0 | 1 | 24 | 1,341 | 2 | 0 | 0 | 48 | 1 | 4 | 0 | 7,133,254,296 | 1,693,718,849 | 8,826,973,145 | 2,097,152 | 2 | 0 | 0 | 2 | 21 | 166 | 4,031,961 | 24.21 | 0 | 0 | 

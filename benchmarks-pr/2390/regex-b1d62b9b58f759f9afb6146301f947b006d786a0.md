...
|:---|---:|---:|---:|
| Total | <span style='color: red'>(+4 [+21.5%])</span> 20.46 | <span style='color: red'>(+1 [+17.9%])</span> 7.24 | 7.24 |
| regex_program | <span style='color: red'>(+4 [+21.5%])</span> 20.46 | <span style='color: red'>(+1 [+18.0%])</span> 7.24 |  7.24 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+905 [+21.5%])</span> 5,107 | <span style='color: red'>(+3620 [+21.5%])</span> 20,428 | <span style='color: red'>(+1104 [+18.1%])</span> 7,207 | <span style='color: red'>(+778 [+24.1%])</span> 4,006 |
...
| `execute_metered_time_ms` | <span style='color: green'>(-4 [-10.0%])</span> 36 | -          | -          | -          |
| `execute_metered_insn_mi/s` | <span style='color: red'>(+9 [+8.4%])</span> 111.97 | -          | <span style='color: red'>(+9 [+8.4%])</span> 111.97 | <span style='color: red'>(+9 [+8.4%])</span> 111.97 |
| `execute_preflight_insns` |  1,034,306.25 |  4,137,225 |  1,104,000 |  826,225 |
| `execute_preflight_time_ms` | <span style='color: green'>(-1 [-1.6%])</span> 44.75 | <span style='color: green'>(-3 [-1.6%])</span> 179 | <span style='color: green'>(-1 [-1.8%])</span> 55 |  34 |
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+1 [+1.7%])</span> 31.95 | -          | <span style='color: red'>(+1 [+2.6%])</span> 32.82 | <span style='color: red'>(+0 [+1.0%])</span> 30.39 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+2 [+1.0%])</span> 181.25 | <span style='color: red'>(+7 [+1.0%])</span> 725 | <span style='color: red'>(+1 [+0.5%])</span> 196 |  173 |
| `memory_finalize_time_ms` |  1 |  4 |  4 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+903 [+23.1%])</span> 4,806.75 | <span style='color: red'>(+3613 [+23.1%])</span> 19,227 | <span style='color: red'>(+1109 [+19.0%])</span> 6,942 | <span style='color: red'>(+769 [+25.9%])</span> 3,734 |
| `main_trace_commit_time_ms` | <span style='color: red'>(+0 [+1.0%])</span> 52.25 | <span style='color: red'>(+2 [+1.0%])</span> 209 |  58 | <span style='color: red'>(+1 [+2.0%])</span> 50 |
| `generate_perm_trace_time_ms` | <span style='color: red'>(+10 [+19.3%])</span> 61.75 | <span style='color: red'>(+40 [+19.3%])</span> 247 | <span style='color: red'>(+49 [+62.0%])</span> 128 | <span style='color: green'>(-16 [-45.7%])</span> 19 |
| `perm_trace_commit_time_ms` | <span style='color: red'>(+1 [+1.6%])</span> 64.76 | <span style='color: red'>(+4 [+1.6%])</span> 259.05 | <span style='color: green'>(-0 [-0.4%])</span> 70.40 | <span style='color: red'>(+1 [+1.6%])</span> 54.93 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+2 [+2.6%])</span> 61.65 | <span style='color: red'>(+6 [+2.6%])</span> 246.62 |  72.93 | <span style='color: red'>(+2 [+3.9%])</span> 54.100 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+1 [+3.4%])</span> 16.36 | <span style='color: red'>(+2 [+3.4%])</span> 65.43 | <span style='color: red'>(+1 [+5.5%])</span> 18.92 | <span style='color: red'>(+1 [+4.2%])</span> 14.23 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+890 [+24.3%])</span> 4,546.50 | <span style='color: red'>(+3561 [+24.3%])</span> 18,186 | <span style='color: red'>(+1175 [+21.1%])</span> 6,731 | <span style='color: red'>(+755 [+27.7%])</span> 3,477 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 4,006 | 1 | 36 | 4,137,225 | 111.97 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 173 | 4,635 | 23,458,696 | 150,778,428 | 173 | 4,236 | 0 | 63.46 | 18.92 | 7 | 70.40 | 3,981 | 111 | 3,981 | 4 | 58 | 10,906,398 | 40 | 55 | 1,103,000 | 30.39 | 22 | 83 | 0 | 3,981 | 
| regex_program | 1 | 178 | 7,207 | 11,603,568 | 128,513,066 | 177 | 6,942 | 1 | 55.22 | 15.84 | 6 | 67.39 | 6,731 | 87 | 6,731 | 0 | 51 | 2,196,414 | 19 | 45 | 1,104,000 | 32.27 | 17 | 71 | 0 | 6,730 | 
| regex_program | 2 | 178 | 4,580 | 11,597,216 | 128,513,066 | 178 | 4,315 | 1 | 54.100 | 16.44 | 6 | 66.33 | 3,997 | 195 | 3,997 | 0 | 50 | 2,190,286 | 128 | 45 | 1,104,000 | 32.82 | 17 | 72 | 0 | 3,997 | 
| regex_program | 3 | 196 | 4,006 | 11,874,660 | 103,456,394 | 196 | 3,734 | 0 | 72.93 | 14.23 | 7 | 54.93 | 3,477 | 118 | 3,477 | 0 | 50 | 2,437,978 | 60 | 34 | 826,225 | 32.34 | 19 | 88 | 0 | 3,476 | 
...
Commit: https://github.com/openvm-org/openvm/commit/b1d62b9b58f759f9afb6146301f947b006d786a0
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/21652591794)

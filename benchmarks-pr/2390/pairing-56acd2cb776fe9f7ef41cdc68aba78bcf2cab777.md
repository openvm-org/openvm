...
|:---|---:|---:|---:|
| Total | <span style='color: red'>(+2 [+29.6%])</span> 10.35 | <span style='color: red'>(+1 [+23.0%])</span> 5.78 | 5.78 |
| pairing | <span style='color: red'>(+2 [+29.6%])</span> 10.35 | <span style='color: red'>(+1 [+23.0%])</span> 5.78 |  5.78 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+1182 [+29.9%])</span> 5,142 | <span style='color: red'>(+2365 [+29.9%])</span> 10,284 | <span style='color: red'>(+1080 [+23.3%])</span> 5,721 | <span style='color: red'>(+1285 [+39.2%])</span> 4,563 |
...
| `execute_metered_insn_mi/s` | <span style='color: red'>(+0 [+0.5%])</span> 27.54 | -          | <span style='color: red'>(+0 [+0.5%])</span> 27.54 | <span style='color: red'>(+0 [+0.5%])</span> 27.54 |
| `execute_preflight_insns` |  872,871 |  1,745,742 |  1,149,000 |  596,742 |
| `execute_preflight_time_ms` | <span style='color: red'>(+1 [+1.2%])</span> 84.50 | <span style='color: red'>(+2 [+1.2%])</span> 169 | <span style='color: red'>(+1 [+0.8%])</span> 120 | <span style='color: red'>(+1 [+2.1%])</span> 49 |
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+0 [+0.3%])</span> 14.77 | -          | <span style='color: red'>(+0 [+0.4%])</span> 18.12 | <span style='color: red'>(+0 [+0.2%])</span> 11.41 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+0 [+0.3%])</span> 185 | <span style='color: red'>(+1 [+0.3%])</span> 370 | <span style='color: red'>(+1 [+0.5%])</span> 204 |  166 |
...
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+1182 [+33.0%])</span> 4,767 | <span style='color: red'>(+2363 [+33.0%])</span> 9,534 | <span style='color: red'>(+1079 [+25.8%])</span> 5,265 | <span style='color: red'>(+1284 [+43.0%])</span> 4,269 |
| `main_trace_commit_time_ms` | <span style='color: red'>(+1 [+1.6%])</span> 65 | <span style='color: red'>(+2 [+1.6%])</span> 130 |  75 | <span style='color: red'>(+2 [+3.8%])</span> 55 |
| `generate_perm_trace_time_ms` | <span style='color: red'>(+16 [+42.1%])</span> 54 | <span style='color: red'>(+32 [+42.1%])</span> 108 | <span style='color: red'>(+30 [+69.8%])</span> 73 | <span style='color: red'>(+2 [+6.1%])</span> 35 |
| `perm_trace_commit_time_ms` | <span style='color: red'>(+1 [+0.8%])</span> 76.78 | <span style='color: red'>(+1 [+0.8%])</span> 153.56 | <span style='color: red'>(+1 [+1.3%])</span> 88.93 |  64.63 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+1 [+1.2%])</span> 82.15 | <span style='color: red'>(+2 [+1.2%])</span> 164.30 | <span style='color: red'>(+1 [+1.3%])</span> 90.43 | <span style='color: red'>(+1 [+0.9%])</span> 73.87 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+1 [+8.3%])</span> 17.22 | <span style='color: red'>(+3 [+8.3%])</span> 34.44 | <span style='color: red'>(+3 [+16.2%])</span> 19.34 | <span style='color: green'>(-0 [-0.3%])</span> 15.10 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+1160 [+35.1%])</span> 4,465.50 | <span style='color: red'>(+2319 [+35.1%])</span> 8,931 | <span style='color: red'>(+1080 [+27.9%])</span> 4,950 | <span style='color: red'>(+1239 [+45.2%])</span> 3,981 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 4,563 | 1 | 63 | 1,745,742 | 27.54 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 166 | 5,721 | 32,480,114 | 172,558,444 | 166 | 5,265 | 0 | 90.43 | 19.34 | 9 | 88.93 | 4,950 | 128 | 4,950 | 1 | 75 | 15,909,408 | 35 | 120 | 1,149,000 | 11.41 | 27 | 110 | 1 | 4,949 | 
| pairing | 1 | 204 | 4,563 | 22,464,232 | 119,958,502 | 204 | 4,269 | 1 | 73.87 | 15.10 | 8 | 64.63 | 3,981 | 142 | 3,981 | 1 | 55 | 9,498,894 | 73 | 49 | 596,742 | 18.12 | 21 | 89 | 1 | 3,981 | 

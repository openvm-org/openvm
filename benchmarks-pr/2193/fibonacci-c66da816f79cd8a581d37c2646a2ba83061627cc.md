...
| `total_proof_time_ms ` |  504.50 |  1,009 |  554 |  455 |
...
| `execute_metered_insn_mi/s` |  146.50 | -          |  146.50 |  146.50 |
| `execute_preflight_insns` |  750,104.50 |  1,500,209 |  873,000 |  627,209 |
| `execute_preflight_time_ms` |  29.50 |  59 |  33 |  26 |
| `execute_preflight_insn_mi/s` |  36.41 | -          |  38.34 |  34.49 |
| `trace_gen_time_ms   ` |  187 |  374 |  192 |  182 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  195 |  390 |  198 |  192 |
| `main_trace_commit_time_ms` |  30.50 |  61 |  33 |  28 |
| `generate_perm_trace_time_ms` |  18 |  36 |  24 |  12 |
| `perm_trace_commit_time_ms` |  40.62 |  81.24 |  43.05 |  38.19 |
| `quotient_poly_compute_time_ms` |  30.93 |  61.87 |  32.19 |  29.68 |
| `quotient_poly_commit_time_ms` |  11.92 |  23.85 |  12.35 |  11.49 |
| `pcs_opening_time_ms ` |  61 |  122 |  77 |  45 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 455 | 41 | 1 | 10 | 1,500,209 | 146.50 | 141 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 192 | 554 | 9,677,708 | 84,395,212 | 192 | 192 | 0 | 32.19 | 12.35 | 4 | 43.05 | 45 | 68 | 45 | 0 | 33 | 1,035,986 | 24 | 26 | 873,000 | 34.49 | 14 | 45 | 0 | 45 | 
| fibonacci_program | 1 | 182 | 455 | 9,708,170 | 74,305,770 | 182 | 198 | 1 | 29.68 | 11.49 | 4 | 38.19 | 77 | 50 | 77 | 0 | 28 | 1,064,416 | 12 | 33 | 627,209 | 38.34 | 11 | 41 | 0 | 77 | 

...
| `total_proof_time_ms ` |  713.50 |  1,427 |  830 |  597 |
...
| `execute_preflight_insn_mi/s` |  13.57 | -          |  18.09 |  9.06 |
| `trace_gen_time_ms   ` |  177 |  354 |  194 |  160 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  348.50 |  697 |  394 |  303 |
| `main_trace_commit_time_ms` |  64 |  128 |  75 |  53 |
| `generate_perm_trace_time_ms` |  38.50 |  77 |  41 |  36 |
| `perm_trace_commit_time_ms` |  76.57 |  153.14 |  88.80 |  64.34 |
| `quotient_poly_compute_time_ms` |  78.75 |  157.50 |  87.35 |  70.15 |
| `quotient_poly_commit_time_ms` |  15.62 |  31.25 |  17.16 |  14.09 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 597 | 44 | 1 | 90 | 1,745,742 | 19.29 | 147 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 160 | 830 | 32,689,110 | 172,558,444 | 160 | 394 | 0 | 87.35 | 17.16 | 6 | 88.80 | 85 | 128 | 85 | 1 | 75 | 16,059,916 | 36 | 131 | 1,157,000 | 9.06 | 26 | 105 | 1 | 85 | 
| pairing | 1 | 194 | 597 | 22,314,288 | 119,958,502 | 194 | 303 | 1 | 70.15 | 14.09 | 6 | 64.34 | 55 | 108 | 55 | 0 | 53 | 9,408,294 | 41 | 59 | 588,742 | 18.09 | 20 | 84 | 1 | 55 | 

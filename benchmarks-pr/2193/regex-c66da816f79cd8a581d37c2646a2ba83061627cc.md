...
| `total_proof_time_ms ` |  588.75 |  2,355 |  739 |  535 |
...
| `execute_metered_insn_mi/s` |  119.39 | -          |  119.39 |  119.39 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  56 |  224 |  68 |  47 |
| `execute_preflight_insn_mi/s` |  29.46 | -          |  30.71 |  26.89 |
| `trace_gen_time_ms   ` |  174.75 |  699 |  207 |  152 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  291 |  1,164 |  339 |  268 |
| `main_trace_commit_time_ms` |  51 |  204 |  56 |  49 |
| `generate_perm_trace_time_ms` |  34.75 |  139 |  55 |  19 |
| `perm_trace_commit_time_ms` |  63.51 |  254.06 |  69.33 |  54.58 |
| `quotient_poly_compute_time_ms` |  58.64 |  234.57 |  70.44 |  51.81 |
| `quotient_poly_commit_time_ms` |  14.97 |  59.89 |  17.48 |  12.74 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 537 | 41 | 1 | 34 | 4,137,502 | 119.39 | 168 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 207 | 739 | 23,446,148 | 150,778,428 | 207 | 339 | 0 | 60.08 | 17.48 | 5 | 69.33 | 78 | 125 | 78 | 4 | 56 | 10,899,170 | 55 | 48 | 1,103,000 | 26.89 | 21 | 78 | 1 | 78 | 
| regex_program | 1 | 152 | 544 | 11,598,276 | 128,513,066 | 152 | 283 | 1 | 51.81 | 14.62 | 4 | 64.33 | 62 | 103 | 62 | 0 | 49 | 2,196,106 | 38 | 68 | 1,104,000 | 30.71 | 16 | 67 | 0 | 62 | 
| regex_program | 2 | 159 | 535 | 11,579,064 | 128,513,066 | 159 | 274 | 1 | 52.24 | 15.04 | 4 | 65.81 | 61 | 94 | 61 | 0 | 50 | 2,177,334 | 27 | 61 | 1,104,000 | 30.25 | 16 | 67 | 0 | 61 | 
| regex_program | 3 | 181 | 537 | 11,853,872 | 103,456,394 | 181 | 268 | 0 | 70.44 | 12.74 | 5 | 54.58 | 56 | 77 | 56 | 0 | 49 | 2,422,606 | 19 | 47 | 826,502 | 29.98 | 18 | 84 | 1 | 56 | 

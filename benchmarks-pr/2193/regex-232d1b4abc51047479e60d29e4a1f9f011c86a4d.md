...
| `total_proof_time_ms ` |  573.50 |  2,294 |  718 |  515 |
...
| `execute_metered_insn_mi/s` |  119.68 | -          |  119.68 |  119.68 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  55 |  220 |  66 |  47 |
| `execute_preflight_insn_mi/s` |  29.45 | -          |  30.82 |  27.24 |
| `trace_gen_time_ms   ` |  173.75 |  695 |  206 |  152 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  277.25 |  1,109 |  320 |  254 |
| `main_trace_commit_time_ms` |  51.75 |  207 |  57 |  50 |
| `generate_perm_trace_time_ms` |  33.75 |  135 |  55 |  18 |
| `perm_trace_commit_time_ms` |  63.55 |  254.19 |  69.85 |  55.50 |
| `quotient_poly_compute_time_ms` |  56.79 |  227.15 |  68.37 |  50.34 |
| `quotient_poly_commit_time_ms` |  14.45 |  57.80 |  16.46 |  12.54 |
| `pcs_opening_time_ms ` |  53.75 |  215 |  61 |  46 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 533 | 40 | 1 | 34 | 4,137,502 | 119.68 | 167 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 206 | 718 | 23,446,148 | 150,778,428 | 206 | 320 | 0 | 57.33 | 16.46 | 5 | 69.85 | 61 | 125 | 61 | 4 | 57 | 10,899,170 | 55 | 47 | 1,103,000 | 27.24 | 21 | 74 | 1 | 61 | 
| regex_program | 1 | 152 | 528 | 11,598,276 | 128,513,066 | 152 | 268 | 1 | 51.10 | 14.44 | 4 | 64.26 | 51 | 100 | 51 | 0 | 50 | 2,196,106 | 35 | 66 | 1,104,000 | 30.82 | 16 | 66 | 0 | 51 | 
| regex_program | 2 | 159 | 515 | 11,579,064 | 128,513,066 | 159 | 254 | 1 | 50.34 | 14.36 | 4 | 64.58 | 46 | 92 | 46 | 0 | 50 | 2,177,334 | 27 | 60 | 1,104,000 | 30.39 | 16 | 65 | 0 | 46 | 
| regex_program | 3 | 178 | 533 | 11,853,872 | 103,456,394 | 178 | 267 | 0 | 68.37 | 12.54 | 5 | 55.50 | 57 | 77 | 57 | 0 | 50 | 2,422,606 | 18 | 47 | 826,502 | 29.35 | 18 | 81 | 1 | 57 | 

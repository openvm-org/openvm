...
|:---|---:|---:|---:|
| Total |  5.39 |  3.77 |  3.77 |
| app_proof |  3.88 |  2.26 |  2.26 |
| leaf |  0.95 |  0.95 |  0.95 |
...
| `total_proof_time_ms ` |  1,925 |  3,850 |  2,229 |  1,621 |
| `execute_metered_time_ms` |  34 | -          | -          | -          |
| `execute_metered_insns` |  2,579,903 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  73.92 | -          |  73.92 |  73.92 |
...
| `trace_gen_time_ms   ` |  145 |  290 |  188 |  102 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,575.50 |  3,151 |  1,803 |  1,348 |
| `prover.main_trace_commit_time_ms` |  509 |  1,018 |  590 |  428 |
| `prover.rap_constraints_time_ms` |  937 |  1,874 |  1,079 |  795 |
| `prover.openings_time_ms` |  128.50 |  257 |  133 |  124 |
| `prover.rap_constraints.logup_gkr_time_ms` |  166.50 |  333 |  196 |  137 |
| `prover.rap_constraints.round0_time_ms` |  569 |  1,138 |  671 |  467 |
| `prover.rap_constraints.mle_rounds_time_ms` |  201 |  402 |  212 |  190 |
| `prover.openings.stacked_reduction_time_ms` |  93.50 |  187 |  102 |  85 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/6be74102e7b9caab06777c321b7d9d9b0a8d9b78/kitchen_sink-6be74102e7b9caab06777c321b7d9d9b0a8d9b78.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 73 | 9 |  |  | 0 |  | 370 | 9 |  |  |  |  |  |  | 
| app_proof |  |  |  |  |  | 1,621 |  |  | 34 | 2,579,903 | 73.92 | 0 | 3,890 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,577,979 | 257 | 117 | 0 | 0 | 107 | 36 | 35 | 51 | 19 | 0 | 32 | 18 | 13 | 3 | 9 | 117 | 107 | 0 | 2 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,767 | 141 | 45 | 0 | 0 | 67 | 24 | 24 | 28 | 14 | 0 | 28 | 20 | 8 | 1 | 6 | 45 | 67 | 0 | 2 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,863 | 121 | 31 | 0 | 0 | 63 | 24 | 24 | 24 | 14 | 0 | 26 | 19 | 7 | 1 | 5 | 31 | 63 | 0 | 2 | 13 | 0 | 0 | 
| leaf | 0 | prover | 265,003,892 | 827 | 400 | 0 | 1 | 351 | 134 | 134 | 78 | 138 | 0 | 74 | 34 | 40 | 22 | 18 | 400 | 351 | 0 | 6 | 137 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 567,917,156 | 1,803 | 589 | 0 | 183 | 1,079 | 671 | 670 | 212 | 196 | 55 | 133 | 30 | 102 | 50 | 52 | 590 | 1,079 | 0 | 3 | 139 | 0 | 0 | 
| app_proof | prover | 1 | 537,266,124 | 1,348 | 428 | 0 | 1 | 795 | 467 | 467 | 190 | 137 | 0 | 124 | 38 | 85 | 48 | 37 | 428 | 795 | 0 | 4 | 136 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 188 | 2,229 | 188 | 175 | 0 | 3 | 61 | 1,540,000 | 34.99 | 
| app_proof | 1 | 102 | 1,621 | 102 | 41 | 0 | 2 | 130 | 1,039,903 | 36.81 | 

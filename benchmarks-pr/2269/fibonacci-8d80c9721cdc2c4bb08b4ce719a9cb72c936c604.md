...
|:---|---:|---:|
| Total | <span style='color: red'>(+0 [+0.4%])</span> 0.98 |  0.56 |
| fibonacci_program | <span style='color: red'>(+0 [+0.4%])</span> 0.97 |  0.55 |


| fibonacci_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+2 [+0.4%])</span> 485 | <span style='color: red'>(+4 [+0.4%])</span> 970 |  548 | <span style='color: red'>(+4 [+1.0%])</span> 422 |
...
| `execute_metered_insn_mi/s` | <span style='color: green'>(-1 [-1.1%])</span> 113.66 | -          | <span style='color: green'>(-1 [-1.1%])</span> 113.66 | <span style='color: green'>(-1 [-1.1%])</span> 113.66 |
| `execute_preflight_insns` |  750,104.50 |  1,500,209 |  873,000 |  627,209 |
| `execute_preflight_time_ms` | <span style='color: green'>(-0 [-1.7%])</span> 29 | <span style='color: green'>(-1 [-1.7%])</span> 58 | <span style='color: green'>(-2 [-5.9%])</span> 32 | <span style='color: red'>(+1 [+4.0%])</span> 26 |
| `execute_preflight_insn_mi/s` |  36.71 | -          | <span style='color: red'>(+0 [+0.4%])</span> 38.87 | <span style='color: green'>(-0 [-0.4%])</span> 34.55 |
| `trace_gen_time_ms   ` | <span style='color: green'>(-0 [-0.3%])</span> 188 | <span style='color: green'>(-1 [-0.3%])</span> 376 | <span style='color: green'>(-3 [-1.5%])</span> 192 | <span style='color: red'>(+2 [+1.1%])</span> 184 |
| `memory_finalize_time_ms` | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+3 [+1.7%])</span> 175 | <span style='color: red'>(+6 [+1.7%])</span> 350 | <span style='color: red'>(+2 [+1.1%])</span> 186 | <span style='color: red'>(+4 [+2.5%])</span> 164 |
| `main_trace_commit_time_ms` |  30.50 |  61 |  33 |  28 |
| `generate_perm_trace_time_ms` | <span style='color: green'>(-0 [-3.3%])</span> 14.50 | <span style='color: green'>(-1 [-3.3%])</span> 29 | <span style='color: green'>(-1 [-5.6%])</span> 17 |  12 |
| `perm_trace_commit_time_ms` | <span style='color: green'>(-1 [-1.5%])</span> 41.50 | <span style='color: green'>(-1 [-1.5%])</span> 83 | <span style='color: green'>(-0 [-0.1%])</span> 44.36 | <span style='color: green'>(-1 [-3.1%])</span> 38.64 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+2 [+5.3%])</span> 31.42 | <span style='color: red'>(+3 [+5.3%])</span> 62.84 | <span style='color: red'>(+3 [+8.6%])</span> 32.93 | <span style='color: red'>(+1 [+1.8%])</span> 29.91 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+1 [+8.2%])</span> 12.26 | <span style='color: red'>(+2 [+8.2%])</span> 24.52 | <span style='color: red'>(+1 [+9.5%])</span> 12.43 | <span style='color: red'>(+1 [+7.0%])</span> 12.09 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+2 [+3.7%])</span> 42.50 | <span style='color: red'>(+3 [+3.7%])</span> 85 | <span style='color: green'>(-1 [-2.2%])</span> 44 | <span style='color: red'>(+4 [+10.8%])</span> 41 |
...
| --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 422 | 1 | 13 | 1,500,209 | 113.66 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 192 | 548 | 9,677,708 | 84,395,212 | 192 | 186 | 0 | 32.93 | 12.43 | 4 | 44.36 | 44 | 62 | 44 | 0 | 33 | 1,035,986 | 17 | 26 | 873,000 | 34.55 | 13 | 45 | 0 | 44 | 
| fibonacci_program | 1 | 184 | 422 | 9,708,170 | 74,305,770 | 184 | 164 | 1 | 29.91 | 12.09 | 4 | 38.64 | 41 | 51 | 41 | 0 | 28 | 1,064,416 | 12 | 32 | 627,209 | 38.87 | 11 | 42 | 0 | 41 | 
...
Commit: https://github.com/openvm-org/openvm/commit/8d80c9721cdc2c4bb08b4ce719a9cb72c936c604
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19556242366)

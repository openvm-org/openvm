...
|:---|---:|---:|
| Total | <span style='color: red'>(+0 [+0.4%])</span> 2.41 | <span style='color: green'>(-0 [-0.9%])</span> 0.77 |
| regex_program | <span style='color: red'>(+0 [+0.5%])</span> 2.37 | <span style='color: green'>(-0 [-0.7%])</span> 0.74 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+3 [+0.5%])</span> 592.75 | <span style='color: red'>(+12 [+0.5%])</span> 2,371 | <span style='color: green'>(-5 [-0.7%])</span> 738 | <span style='color: red'>(+11 [+2.1%])</span> 538 |
...
| `execute_metered_insn_mi/s` | <span style='color: red'>(+5 [+4.3%])</span> 116.42 | -          | <span style='color: red'>(+5 [+4.3%])</span> 116.42 | <span style='color: red'>(+5 [+4.3%])</span> 116.42 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` | <span style='color: green'>(-3 [-5.7%])</span> 54 | <span style='color: green'>(-13 [-5.7%])</span> 216 | <span style='color: green'>(-6 [-8.5%])</span> 65 | <span style='color: green'>(-2 [-4.3%])</span> 45 |
| `execute_preflight_insn_mi/s` | <span style='color: green'>(-1 [-2.2%])</span> 30.47 | -          | <span style='color: green'>(-1 [-2.1%])</span> 31.84 | <span style='color: red'>(+0 [+0.8%])</span> 27.93 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+2 [+1.0%])</span> 177.75 | <span style='color: red'>(+7 [+1.0%])</span> 711 | <span style='color: green'>(-2 [-0.9%])</span> 210 | <span style='color: red'>(+5 [+3.3%])</span> 155 |
| `memory_finalize_time_ms` |  0.75 |  3 |  3 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+5 [+1.6%])</span> 293.50 | <span style='color: red'>(+19 [+1.6%])</span> 1,174 | <span style='color: green'>(-1 [-0.3%])</span> 337 | <span style='color: red'>(+11 [+4.2%])</span> 274 |
| `main_trace_commit_time_ms` | <span style='color: green'>(-0 [-1.0%])</span> 51.50 | <span style='color: green'>(-2 [-1.0%])</span> 206 | <span style='color: green'>(-1 [-1.8%])</span> 56 | <span style='color: green'>(-1 [-2.0%])</span> 49 |
| `generate_perm_trace_time_ms` | <span style='color: red'>(+0 [+1.5%])</span> 34.50 | <span style='color: red'>(+2 [+1.5%])</span> 138 |  54 | <span style='color: red'>(+1 [+5.3%])</span> 20 |
| `perm_trace_commit_time_ms` |  64.27 |  257.10 | <span style='color: green'>(-2 [-2.5%])</span> 69.56 | <span style='color: green'>(-1 [-1.0%])</span> 55.38 |
| `quotient_poly_compute_time_ms` | <span style='color: green'>(-0 [-0.3%])</span> 58.57 | <span style='color: green'>(-1 [-0.3%])</span> 234.27 | <span style='color: green'>(-1 [-1.1%])</span> 69.72 | <span style='color: green'>(-0 [-0.5%])</span> 52.48 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+0 [+2.4%])</span> 15.17 | <span style='color: red'>(+1 [+2.4%])</span> 60.70 | <span style='color: red'>(+1 [+6.6%])</span> 17.67 | <span style='color: green'>(-0 [-1.6%])</span> 12.65 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+4 [+7.3%])</span> 65.75 | <span style='color: red'>(+18 [+7.3%])</span> 263 |  77 | <span style='color: red'>(+11 [+22.0%])</span> 61 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 547 | 1 | 35 | 4,137,502 | 116.42 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 210 | 738 | 23,446,148 | 150,778,428 | 210 | 337 | 0 | 59.11 | 17.67 | 5 | 69.56 | 77 | 125 | 77 | 3 | 56 | 10,899,170 | 54 | 46 | 1,103,000 | 27.93 | 21 | 77 | 1 | 77 | 
| regex_program | 1 | 155 | 548 | 11,598,276 | 128,513,066 | 155 | 287 | 1 | 52.96 | 15.36 | 4 | 65.84 | 62 | 104 | 62 | 0 | 51 | 2,196,106 | 37 | 65 | 1,104,000 | 31.42 | 16 | 68 | 0 | 62 | 
| regex_program | 2 | 162 | 538 | 11,579,064 | 128,513,066 | 162 | 274 | 1 | 52.48 | 15.02 | 4 | 66.32 | 61 | 94 | 61 | 0 | 49 | 2,177,334 | 27 | 60 | 1,104,000 | 30.69 | 16 | 68 | 0 | 61 | 
| regex_program | 3 | 184 | 547 | 11,853,872 | 103,456,394 | 184 | 276 | 0 | 69.72 | 12.65 | 5 | 55.38 | 63 | 78 | 63 | 0 | 50 | 2,422,606 | 20 | 45 | 826,502 | 31.84 | 18 | 83 | 1 | 63 | 

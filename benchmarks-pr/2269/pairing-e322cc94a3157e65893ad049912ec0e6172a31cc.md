...
|:---|---:|---:|
| Total | <span style='color: red'>(+0 [+1.7%])</span> 1.49 | <span style='color: red'>(+0 [+3.1%])</span> 0.91 |
| pairing | <span style='color: green'>(-0 [-0.2%])</span> 1.40 | <span style='color: green'>(-0 [-0.1%])</span> 0.82 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: green'>(-2 [-0.2%])</span> 700 | <span style='color: green'>(-3 [-0.2%])</span> 1,400 | <span style='color: green'>(-1 [-0.1%])</span> 816 | <span style='color: green'>(-2 [-0.3%])</span> 584 |
| `main_cells_used     ` |  12,734,105 |  25,468,210 |  16,059,916 |  9,408,294 |
| `total_cells_used    ` |  27,501,699 |  55,003,398 |  32,689,110 |  22,314,288 |
| `execute_metered_time_ms` | <span style='color: red'>(+28 [+44.4%])</span> 91 | -          | -          | -          |
| `execute_metered_insn_mi/s` | <span style='color: green'>(-8 [-30.1%])</span> 19.09 | -          | <span style='color: green'>(-8 [-30.1%])</span> 19.09 | <span style='color: green'>(-8 [-30.1%])</span> 19.09 |
| `execute_preflight_insns` |  872,871 |  1,745,742 |  1,157,000 |  588,742 |
| `execute_preflight_time_ms` | <span style='color: red'>(+6 [+7.2%])</span> 89.50 | <span style='color: red'>(+12 [+7.2%])</span> 179 | <span style='color: red'>(+13 [+12.3%])</span> 119 | <span style='color: green'>(-1 [-1.6%])</span> 60 |
| `execute_preflight_insn_mi/s` | <span style='color: green'>(-1 [-4.9%])</span> 14.07 | -          | <span style='color: green'>(-0 [-0.7%])</span> 18.15 | <span style='color: green'>(-1 [-11.7%])</span> 9.99 |
| `trace_gen_time_ms   ` | <span style='color: green'>(-7 [-3.7%])</span> 180 | <span style='color: green'>(-14 [-3.7%])</span> 360 |  191 | <span style='color: green'>(-14 [-7.7%])</span> 169 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: green'>(-0 [-0.1%])</span> 337 | <span style='color: green'>(-1 [-0.1%])</span> 674 | <span style='color: green'>(-1 [-0.3%])</span> 383 |  291 |
| `main_trace_commit_time_ms` | <span style='color: green'>(-1 [-1.6%])</span> 63 | <span style='color: green'>(-2 [-1.6%])</span> 126 | <span style='color: green'>(-1 [-1.3%])</span> 74 | <span style='color: green'>(-1 [-1.9%])</span> 52 |
| `generate_perm_trace_time_ms` | <span style='color: red'>(+0 [+1.4%])</span> 37.50 | <span style='color: red'>(+1 [+1.4%])</span> 75 |  41 | <span style='color: red'>(+1 [+3.0%])</span> 34 |
| `perm_trace_commit_time_ms` | <span style='color: red'>(+1 [+1.5%])</span> 75.57 | <span style='color: red'>(+2 [+1.5%])</span> 151.13 | <span style='color: red'>(+3 [+3.4%])</span> 87.28 | <span style='color: green'>(-1 [-1.0%])</span> 63.86 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+0 [+0.4%])</span> 77.63 | <span style='color: red'>(+1 [+0.4%])</span> 155.26 | <span style='color: red'>(+1 [+1.1%])</span> 85.20 | <span style='color: green'>(-0 [-0.3%])</span> 70.06 |
| `quotient_poly_commit_time_ms` | <span style='color: green'>(-1 [-5.1%])</span> 15.32 | <span style='color: green'>(-2 [-5.1%])</span> 30.65 | <span style='color: green'>(-2 [-9.2%])</span> 16.62 | <span style='color: red'>(+0 [+0.2%])</span> 14.03 |
| `pcs_opening_time_ms ` | <span style='color: green'>(-0 [-0.8%])</span> 63.50 | <span style='color: green'>(-1 [-0.8%])</span> 127 | <span style='color: green'>(-1 [-1.3%])</span> 75 |  52 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 584 | 1 | 91 | 1,745,742 | 19.09 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 169 | 816 | 32,689,110 | 172,558,444 | 169 | 383 | 0 | 85.20 | 16.62 | 6 | 87.28 | 75 | 131 | 74 | 1 | 74 | 16,059,916 | 41 | 119 | 1,157,000 | 9.99 | 25 | 102 | 1 | 74 | 
| pairing | 1 | 191 | 584 | 22,314,288 | 119,958,502 | 191 | 291 | 1 | 70.06 | 14.03 | 6 | 63.86 | 52 | 101 | 52 | 0 | 52 | 9,408,294 | 34 | 60 | 588,742 | 18.15 | 20 | 84 | 1 | 52 | 

...
|:---|---:|---:|
| Total | <span style='color: green'>(-0 [-1.0%])</span> 1.52 | <span style='color: green'>(-0 [-0.9%])</span> 0.91 |
| pairing |  1.44 | <span style='color: red'>(+0 [+0.8%])</span> 0.83 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  721.50 |  1,443 | <span style='color: red'>(+7 [+0.8%])</span> 831 | <span style='color: green'>(-8 [-1.3%])</span> 612 |
...
| `execute_metered_insn_mi/s` | <span style='color: red'>(+4 [+21.0%])</span> 23.23 | -          | <span style='color: red'>(+4 [+21.0%])</span> 23.23 | <span style='color: red'>(+4 [+21.0%])</span> 23.23 |
...
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+1 [+5.6%])</span> 14.19 | -          | <span style='color: red'>(+1 [+3.3%])</span> 18.32 | <span style='color: red'>(+1 [+10.2%])</span> 10.06 |
| `trace_gen_time_ms   ` | <span style='color: green'>(-2 [-1.4%])</span> 179.50 | <span style='color: green'>(-5 [-1.4%])</span> 359 | <span style='color: green'>(-10 [-5.0%])</span> 189 | <span style='color: red'>(+5 [+3.0%])</span> 170 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+8 [+2.3%])</span> 360 | <span style='color: red'>(+16 [+2.3%])</span> 720 | <span style='color: red'>(+16 [+4.2%])</span> 400 |  320 |
...
| `generate_perm_trace_time_ms` | <span style='color: red'>(+10 [+23.9%])</span> 54.50 | <span style='color: red'>(+21 [+23.9%])</span> 109 | <span style='color: red'>(+13 [+27.1%])</span> 61 | <span style='color: red'>(+8 [+20.0%])</span> 48 |
| `perm_trace_commit_time_ms` | <span style='color: green'>(-1 [-1.4%])</span> 75.45 | <span style='color: green'>(-2 [-1.4%])</span> 150.91 | <span style='color: green'>(-2 [-1.7%])</span> 88.09 | <span style='color: green'>(-1 [-1.0%])</span> 62.82 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+1 [+0.7%])</span> 78.85 | <span style='color: red'>(+1 [+0.7%])</span> 157.70 | <span style='color: green'>(-2 [-1.7%])</span> 86.64 | <span style='color: red'>(+3 [+3.8%])</span> 71.07 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+0 [+2.6%])</span> 16.71 | <span style='color: red'>(+1 [+2.6%])</span> 33.42 | <span style='color: red'>(+0 [+2.4%])</span> 18.75 | <span style='color: red'>(+0 [+2.8%])</span> 14.68 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 612 | 1 | 75 | 1,745,742 | 23.23 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 170 | 831 | 32,689,110 | 172,558,444 | 170 | 400 | 0 | 86.64 | 18.75 | 6 | 88.09 | 67 | 152 | 66 | 1 | 74 | 16,059,916 | 61 | 118 | 1,157,000 | 10.06 | 26 | 106 | 1 | 66 | 
| pairing | 1 | 189 | 612 | 22,314,288 | 119,958,502 | 189 | 320 | 1 | 71.07 | 14.68 | 6 | 62.82 | 65 | 113 | 65 | 0 | 55 | 9,408,294 | 48 | 61 | 588,742 | 18.32 | 20 | 86 | 1 | 65 | 

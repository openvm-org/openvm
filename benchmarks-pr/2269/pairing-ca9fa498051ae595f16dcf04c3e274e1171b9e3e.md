...
|:---|---:|---:|
| Total | <span style='color: red'>(+0 [+3.5%])</span> 1.59 | <span style='color: red'>(+0 [+0.2%])</span> 0.92 |
| pairing | <span style='color: red'>(+0 [+4.7%])</span> 1.51 | <span style='color: red'>(+0 [+2.1%])</span> 0.84 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+34 [+4.7%])</span> 756 | <span style='color: red'>(+68 [+4.7%])</span> 1,512 | <span style='color: red'>(+17 [+2.1%])</span> 841 | <span style='color: red'>(+51 [+8.2%])</span> 671 |
| `main_cells_used     ` |  12,734,105 |  25,468,210 |  16,059,916 |  9,408,294 |
| `total_cells_used    ` |  27,501,699 |  55,003,398 |  32,689,110 |  22,314,288 |
| `execute_metered_time_ms` | <span style='color: green'>(-15 [-16.7%])</span> 75 | -          | -          | -          |
| `execute_metered_insn_mi/s` | <span style='color: red'>(+4 [+21.1%])</span> 23.25 | -          | <span style='color: red'>(+4 [+21.1%])</span> 23.25 | <span style='color: red'>(+4 [+21.1%])</span> 23.25 |
| `execute_preflight_insns` |  872,871 |  1,745,742 |  1,157,000 |  588,742 |
| `execute_preflight_time_ms` | <span style='color: green'>(-6 [-5.8%])</span> 89 | <span style='color: green'>(-11 [-5.8%])</span> 178 | <span style='color: green'>(-11 [-8.5%])</span> 119 |  59 |
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+1 [+5.0%])</span> 14.10 | -          | <span style='color: red'>(+0 [+2.5%])</span> 18.19 | <span style='color: red'>(+1 [+9.7%])</span> 10.01 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+8 [+4.1%])</span> 189.50 | <span style='color: red'>(+15 [+4.1%])</span> 379 |  199 | <span style='color: red'>(+15 [+9.1%])</span> 180 |
...
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+33 [+9.4%])</span> 385 | <span style='color: red'>(+66 [+9.4%])</span> 770 | <span style='color: red'>(+15 [+3.9%])</span> 399 | <span style='color: red'>(+51 [+15.9%])</span> 371 |
| `main_trace_commit_time_ms` | <span style='color: red'>(+0 [+0.8%])</span> 65.50 | <span style='color: red'>(+1 [+0.8%])</span> 131 | <span style='color: red'>(+2 [+2.7%])</span> 77 | <span style='color: green'>(-1 [-1.8%])</span> 54 |
...
| `perm_trace_commit_time_ms` |  76.48 |  152.96 | <span style='color: green'>(-2 [-2.6%])</span> 87.26 | <span style='color: red'>(+2 [+3.6%])</span> 65.70 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+2 [+2.1%])</span> 79.97 | <span style='color: red'>(+3 [+2.1%])</span> 159.94 |  88.24 | <span style='color: red'>(+3 [+4.7%])</span> 71.70 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+1 [+3.5%])</span> 16.87 | <span style='color: red'>(+1 [+3.5%])</span> 33.74 | <span style='color: red'>(+1 [+4.3%])</span> 19.08 | <span style='color: red'>(+0 [+2.6%])</span> 14.66 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+20 [+31.1%])</span> 86.50 | <span style='color: red'>(+41 [+31.1%])</span> 173 | <span style='color: red'>(+22 [+32.8%])</span> 89 | <span style='color: red'>(+19 [+29.2%])</span> 84 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 671 | 1 | 75 | 1,745,742 | 23.25 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 180 | 841 | 32,689,110 | 172,558,444 | 180 | 399 | 0 | 88.24 | 19.08 | 6 | 87.26 | 84 | 129 | 84 | 0 | 77 | 16,059,916 | 39 | 119 | 1,157,000 | 10.01 | 26 | 108 | 1 | 84 | 
| pairing | 1 | 199 | 671 | 22,314,288 | 119,958,502 | 199 | 371 | 1 | 71.70 | 14.66 | 6 | 65.70 | 89 | 139 | 89 | 0 | 54 | 9,408,294 | 71 | 59 | 588,742 | 18.19 | 20 | 86 | 1 | 89 | 

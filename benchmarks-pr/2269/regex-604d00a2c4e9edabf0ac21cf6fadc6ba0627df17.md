...
|:---|---:|---:|
| Total | <span style='color: red'>(+0 [+1.0%])</span> 2.42 | <span style='color: red'>(+0 [+0.8%])</span> 0.79 |
| regex_program | <span style='color: red'>(+0 [+1.0%])</span> 2.38 | <span style='color: red'>(+0 [+0.8%])</span> 0.75 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+6 [+1.0%])</span> 595.75 | <span style='color: red'>(+24 [+1.0%])</span> 2,383 | <span style='color: red'>(+6 [+0.8%])</span> 751 | <span style='color: red'>(+4 [+0.7%])</span> 541 |
...
| `execute_metered_insn_mi/s` | <span style='color: green'>(-2 [-1.6%])</span> 112.22 | -          | <span style='color: green'>(-2 [-1.6%])</span> 112.22 | <span style='color: green'>(-2 [-1.6%])</span> 112.22 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` | <span style='color: red'>(+2 [+4.2%])</span> 56 | <span style='color: red'>(+9 [+4.2%])</span> 224 | <span style='color: red'>(+4 [+6.2%])</span> 69 | <span style='color: red'>(+1 [+2.2%])</span> 46 |
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+0 [+1.2%])</span> 31.04 | -          | <span style='color: red'>(+0 [+0.7%])</span> 32.13 | <span style='color: red'>(+0 [+1.0%])</span> 27.92 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+0 [+0.3%])</span> 178 | <span style='color: red'>(+2 [+0.3%])</span> 712 | <span style='color: red'>(+2 [+0.9%])</span> 213 |  153 |
| `memory_finalize_time_ms` |  1 |  4 |  4 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+2 [+0.8%])</span> 293.25 | <span style='color: red'>(+9 [+0.8%])</span> 1,173 | <span style='color: red'>(+2 [+0.6%])</span> 344 | <span style='color: green'>(-2 [-0.7%])</span> 268 |
...
| `generate_perm_trace_time_ms` | <span style='color: red'>(+2 [+4.5%])</span> 34.75 | <span style='color: red'>(+6 [+4.5%])</span> 139 | <span style='color: red'>(+1 [+1.9%])</span> 55 | <span style='color: green'>(-2 [-10.0%])</span> 18 |
| `perm_trace_commit_time_ms` | <span style='color: green'>(-0 [-0.2%])</span> 64.32 | <span style='color: green'>(-0 [-0.2%])</span> 257.27 | <span style='color: red'>(+0 [+0.6%])</span> 71.32 | <span style='color: red'>(+0 [+0.3%])</span> 55.98 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+0 [+0.4%])</span> 58.64 | <span style='color: red'>(+1 [+0.4%])</span> 234.58 | <span style='color: green'>(-0 [-0.6%])</span> 69.32 | <span style='color: red'>(+0 [+0.2%])</span> 53.05 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+0 [+0.3%])</span> 14.71 | <span style='color: red'>(+0 [+0.3%])</span> 58.84 | <span style='color: red'>(+0 [+2.5%])</span> 17.14 | <span style='color: green'>(-0 [-2.9%])</span> 12.49 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+1 [+1.9%])</span> 66.25 | <span style='color: red'>(+5 [+1.9%])</span> 265 | <span style='color: red'>(+2 [+2.4%])</span> 84 |  56 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 541 | 1 | 36 | 4,137,502 | 112.22 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 213 | 751 | 23,446,148 | 150,778,428 | 213 | 344 | 0 | 59.06 | 17.14 | 5 | 71.32 | 84 | 127 | 84 | 4 | 55 | 10,899,170 | 55 | 46 | 1,103,000 | 27.92 | 22 | 76 | 1 | 84 | 
| regex_program | 1 | 153 | 550 | 11,598,276 | 128,513,066 | 153 | 286 | 1 | 53.15 | 14.54 | 5 | 65.13 | 63 | 103 | 63 | 0 | 50 | 2,196,106 | 38 | 69 | 1,104,000 | 31.99 | 16 | 68 | 0 | 63 | 
| regex_program | 2 | 163 | 541 | 11,579,064 | 128,513,066 | 163 | 275 | 1 | 53.05 | 14.67 | 4 | 64.84 | 62 | 93 | 61 | 0 | 51 | 2,177,334 | 28 | 61 | 1,104,000 | 32.11 | 16 | 68 | 0 | 61 | 
| regex_program | 3 | 183 | 541 | 11,853,872 | 103,456,394 | 183 | 268 | 0 | 69.32 | 12.49 | 5 | 55.98 | 56 | 77 | 56 | 0 | 50 | 2,422,606 | 18 | 48 | 826,502 | 32.13 | 18 | 82 | 1 | 56 | 

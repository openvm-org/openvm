...
|:---|---:|---:|
| Total | <span style='color: green'>(-0 [-2.1%])</span> 0.97 | <span style='color: green'>(-0 [-1.4%])</span> 0.56 |
| fibonacci_program | <span style='color: green'>(-0 [-2.0%])</span> 0.96 | <span style='color: green'>(-0 [-1.3%])</span> 0.55 |


| fibonacci_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: green'>(-10 [-2.0%])</span> 479.50 | <span style='color: green'>(-20 [-2.0%])</span> 959 | <span style='color: green'>(-7 [-1.3%])</span> 546 | <span style='color: green'>(-13 [-3.1%])</span> 413 |
| `main_cells_used     ` |  1,050,201 |  2,100,402 |  1,064,416 |  1,035,986 |
| `total_cells_used    ` |  9,692,939 |  19,385,878 |  9,708,170 |  9,677,708 |
| `execute_metered_time_ms` | <span style='color: green'>(-1 [-8.3%])</span> 11 | -          | -          | -          |
| `execute_metered_insn_mi/s` | <span style='color: red'>(+13 [+11.6%])</span> 128.67 | -          | <span style='color: red'>(+13 [+11.6%])</span> 128.67 | <span style='color: red'>(+13 [+11.6%])</span> 128.67 |
| `execute_preflight_insns` |  750,104.50 |  1,500,209 |  873,000 |  627,209 |
| `execute_preflight_time_ms` | <span style='color: red'>(+0 [+1.8%])</span> 29 | <span style='color: red'>(+1 [+1.8%])</span> 58 | <span style='color: red'>(+1 [+3.1%])</span> 33 |  25 |
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+0 [+0.2%])</span> 36.79 | -          | <span style='color: red'>(+0 [+0.7%])</span> 38.88 | <span style='color: green'>(-0 [-0.3%])</span> 34.69 |
| `trace_gen_time_ms   ` | <span style='color: green'>(-6 [-2.9%])</span> 185.50 | <span style='color: green'>(-11 [-2.9%])</span> 371 | <span style='color: green'>(-4 [-2.0%])</span> 192 | <span style='color: green'>(-7 [-3.8%])</span> 179 |
...
| `perm_trace_commit_time_ms` | <span style='color: green'>(-1 [-1.5%])</span> 41.66 | <span style='color: green'>(-1 [-1.5%])</span> 83.32 | <span style='color: green'>(-1 [-3.3%])</span> 44.05 | <span style='color: red'>(+0 [+0.6%])</span> 39.26 |
| `quotient_poly_compute_time_ms` | <span style='color: green'>(-2 [-5.2%])</span> 30.91 | <span style='color: green'>(-3 [-5.2%])</span> 61.81 | <span style='color: green'>(-1 [-2.8%])</span> 33.59 | <span style='color: green'>(-2 [-7.9%])</span> 28.22 |
| `quotient_poly_commit_time_ms` | <span style='color: green'>(-1 [-6.1%])</span> 11.45 | <span style='color: green'>(-1 [-6.1%])</span> 22.90 | <span style='color: green'>(-0 [-3.4%])</span> 11.89 | <span style='color: green'>(-1 [-8.9%])</span> 11.01 |
| `pcs_opening_time_ms ` | <span style='color: green'>(-2 [-3.5%])</span> 41 | <span style='color: green'>(-3 [-3.5%])</span> 82 | <span style='color: green'>(-1 [-2.3%])</span> 43 | <span style='color: green'>(-2 [-4.9%])</span> 39 |
...
| --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 413 | 1 | 11 | 1,500,209 | 128.67 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 192 | 546 | 9,677,708 | 84,395,212 | 191 | 185 | 0 | 33.59 | 11.89 | 4 | 44.05 | 43 | 62 | 43 | 0 | 33 | 1,035,986 | 17 | 25 | 873,000 | 34.69 | 13 | 45 | 0 | 43 | 
| fibonacci_program | 1 | 179 | 413 | 9,708,170 | 74,305,770 | 179 | 159 | 1 | 28.22 | 11.01 | 4 | 39.26 | 39 | 52 | 39 | 0 | 28 | 1,064,416 | 12 | 33 | 627,209 | 38.88 | 11 | 39 | 0 | 39 | 
...
Commit: https://github.com/openvm-org/openvm/commit/ca9fa498051ae595f16dcf04c3e274e1171b9e3e
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19520008449)

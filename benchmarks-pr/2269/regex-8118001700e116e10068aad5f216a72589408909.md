...
|:---|---:|---:|
| Total | <span style='color: red'>(+0 [+1.7%])</span> 2.44 | <span style='color: red'>(+0 [+1.5%])</span> 0.79 |
| regex_program | <span style='color: red'>(+0 [+1.7%])</span> 2.40 | <span style='color: red'>(+0 [+1.6%])</span> 0.76 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+10 [+1.7%])</span> 600 | <span style='color: red'>(+41 [+1.7%])</span> 2,400 | <span style='color: red'>(+12 [+1.6%])</span> 757 | <span style='color: red'>(+8 [+1.5%])</span> 545 |
...
| `execute_metered_insn_mi/s` | <span style='color: green'>(-1 [-0.6%])</span> 113.37 | -          | <span style='color: green'>(-1 [-0.6%])</span> 113.37 | <span style='color: green'>(-1 [-0.6%])</span> 113.37 |
...
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+0 [+1.0%])</span> 30.97 | -          | <span style='color: red'>(+0 [+0.2%])</span> 31.97 | <span style='color: red'>(+1 [+2.0%])</span> 28.19 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+4 [+2.1%])</span> 181.25 | <span style='color: red'>(+15 [+2.1%])</span> 725 | <span style='color: red'>(+5 [+2.4%])</span> 216 | <span style='color: red'>(+5 [+3.3%])</span> 158 |
| `memory_finalize_time_ms` |  1 |  4 |  4 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+6 [+2.0%])</span> 296.75 | <span style='color: red'>(+23 [+2.0%])</span> 1,187 | <span style='color: red'>(+8 [+2.3%])</span> 350 | <span style='color: red'>(+2 [+0.7%])</span> 272 |
...
| `perm_trace_commit_time_ms` | <span style='color: red'>(+1 [+1.5%])</span> 65.43 | <span style='color: red'>(+4 [+1.5%])</span> 261.72 | <span style='color: red'>(+1 [+0.9%])</span> 71.49 | <span style='color: red'>(+1 [+2.0%])</span> 56.87 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+1 [+1.8%])</span> 59.46 | <span style='color: red'>(+4 [+1.8%])</span> 237.83 | <span style='color: red'>(+1 [+0.8%])</span> 70.25 | <span style='color: green'>(-0 [-0.7%])</span> 52.55 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+1 [+6.8%])</span> 15.66 | <span style='color: red'>(+4 [+6.8%])</span> 62.65 | <span style='color: red'>(+1 [+8.8%])</span> 18.19 | <span style='color: red'>(+0 [+1.7%])</span> 13.08 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+2 [+2.3%])</span> 66.50 | <span style='color: red'>(+6 [+2.3%])</span> 266 | <span style='color: red'>(+2 [+2.4%])</span> 84 | <span style='color: red'>(+1 [+1.8%])</span> 57 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 545 | 1 | 36 | 4,137,502 | 113.37 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 216 | 757 | 23,446,148 | 150,778,428 | 216 | 350 | 0 | 61.22 | 18.19 | 5 | 71.49 | 84 | 127 | 83 | 4 | 58 | 10,899,170 | 55 | 46 | 1,103,000 | 28.19 | 22 | 80 | 1 | 83 | 
| regex_program | 1 | 158 | 553 | 11,598,276 | 128,513,066 | 158 | 287 | 1 | 52.55 | 15.73 | 4 | 65.86 | 63 | 104 | 63 | 0 | 51 | 2,196,106 | 37 | 66 | 1,104,000 | 31.97 | 17 | 68 | 0 | 63 | 
| regex_program | 2 | 166 | 545 | 11,579,064 | 128,513,066 | 166 | 278 | 1 | 53.81 | 15.64 | 4 | 67.49 | 62 | 96 | 61 | 0 | 50 | 2,177,334 | 28 | 59 | 1,104,000 | 31.86 | 16 | 70 | 0 | 61 | 
| regex_program | 3 | 185 | 545 | 11,853,872 | 103,456,394 | 185 | 272 | 0 | 70.25 | 13.08 | 5 | 56.87 | 57 | 79 | 56 | 0 | 51 | 2,422,606 | 19 | 45 | 826,502 | 31.87 | 18 | 84 | 1 | 56 | 
...
Commit: https://github.com/openvm-org/openvm/commit/8118001700e116e10068aad5f216a72589408909
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19520991158)

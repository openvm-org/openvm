...
|:---|---:|---:|
| Total | <span style='color: red'>(+0 [+1.0%])</span> 2.42 | <span style='color: red'>(+0 [+0.6%])</span> 0.79 |
| regex_program | <span style='color: red'>(+0 [+1.1%])</span> 2.38 | <span style='color: red'>(+0 [+0.9%])</span> 0.75 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+6 [+1.1%])</span> 596 | <span style='color: red'>(+25 [+1.1%])</span> 2,384 | <span style='color: red'>(+7 [+0.9%])</span> 750 | <span style='color: red'>(+15 [+2.8%])</span> 542 |
...
| `execute_metered_insn_mi/s` | <span style='color: red'>(+4 [+3.4%])</span> 115.33 | -          | <span style='color: red'>(+4 [+3.4%])</span> 115.33 | <span style='color: red'>(+4 [+3.4%])</span> 115.33 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` | <span style='color: green'>(-5 [-8.7%])</span> 52.25 | <span style='color: green'>(-20 [-8.7%])</span> 209 | <span style='color: green'>(-8 [-11.3%])</span> 63 | <span style='color: green'>(-3 [-6.4%])</span> 44 |
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+1 [+2.0%])</span> 31.80 | -          | <span style='color: red'>(+0 [+1.1%])</span> 32.89 | <span style='color: red'>(+1 [+4.0%])</span> 28.82 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+6 [+3.3%])</span> 181.75 | <span style='color: red'>(+23 [+3.3%])</span> 727 |  212 | <span style='color: red'>(+10 [+6.7%])</span> 160 |
...
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+6 [+1.9%])</span> 294.25 | <span style='color: red'>(+22 [+1.9%])</span> 1,177 | <span style='color: red'>(+10 [+3.0%])</span> 348 | <span style='color: red'>(+8 [+3.0%])</span> 271 |
...
| `perm_trace_commit_time_ms` | <span style='color: red'>(+0 [+0.8%])</span> 64.80 | <span style='color: red'>(+2 [+0.8%])</span> 259.19 | <span style='color: red'>(+0 [+0.6%])</span> 71.76 | <span style='color: red'>(+0 [+0.5%])</span> 56.25 |
| `quotient_poly_compute_time_ms` | <span style='color: green'>(-1 [-1.9%])</span> 57.62 | <span style='color: green'>(-5 [-1.9%])</span> 230.47 | <span style='color: green'>(-1 [-1.4%])</span> 69.54 | <span style='color: green'>(-4 [-8.3%])</span> 48.37 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+0 [+0.3%])</span> 14.85 | <span style='color: red'>(+0 [+0.3%])</span> 59.40 | <span style='color: red'>(+0 [+2.1%])</span> 16.93 | <span style='color: green'>(-0 [-2.4%])</span> 12.56 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+5 [+8.6%])</span> 66.50 | <span style='color: red'>(+21 [+8.6%])</span> 266 | <span style='color: red'>(+7 [+9.1%])</span> 84 | <span style='color: red'>(+8 [+16.0%])</span> 58 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 545 | 1 | 35 | 4,137,502 | 115.33 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 212 | 750 | 23,446,148 | 150,778,428 | 212 | 348 | 0 | 59.09 | 16.93 | 5 | 71.76 | 84 | 128 | 84 | 4 | 58 | 10,899,170 | 55 | 45 | 1,103,000 | 28.82 | 22 | 76 | 1 | 84 | 
| regex_program | 1 | 160 | 547 | 11,598,276 | 128,513,066 | 160 | 282 | 1 | 48.37 | 15.26 | 4 | 65.46 | 63 | 104 | 63 | 0 | 50 | 2,196,106 | 38 | 63 | 1,104,000 | 32.89 | 16 | 64 | 0 | 63 | 
| regex_program | 2 | 168 | 542 | 11,579,064 | 128,513,066 | 168 | 276 | 1 | 53.48 | 14.66 | 4 | 65.73 | 61 | 93 | 61 | 0 | 51 | 2,177,334 | 27 | 57 | 1,104,000 | 32.79 | 16 | 68 | 0 | 61 | 
| regex_program | 3 | 187 | 545 | 11,853,872 | 103,456,394 | 187 | 271 | 0 | 69.54 | 12.56 | 5 | 56.25 | 58 | 78 | 58 | 0 | 51 | 2,422,606 | 19 | 44 | 826,502 | 32.67 | 18 | 83 | 1 | 58 | 
...
Commit: https://github.com/openvm-org/openvm/commit/e322cc94a3157e65893ad049912ec0e6172a31cc
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19554694031)

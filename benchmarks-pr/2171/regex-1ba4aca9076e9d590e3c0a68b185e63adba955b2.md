...
|:---|---:|---:|
| Total | <span style='color: red'>(+0 [+0.3%])</span> 2.35 | <span style='color: red'>(+0 [+1.5%])</span> 0.75 |
| regex_program | <span style='color: red'>(+0 [+0.3%])</span> 2.32 | <span style='color: red'>(+0 [+1.7%])</span> 0.72 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+2 [+0.3%])</span> 579.75 | <span style='color: red'>(+7 [+0.3%])</span> 2,319 | <span style='color: red'>(+12 [+1.7%])</span> 721 | <span style='color: green'>(-1 [-0.2%])</span> 520 |
...
| `execute_metered_insn_mi/s` | <span style='color: red'>(+4 [+3.3%])</span> 125.05 | -          | <span style='color: red'>(+4 [+3.3%])</span> 125.05 | <span style='color: red'>(+4 [+3.3%])</span> 125.05 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` | <span style='color: green'>(-2 [-2.7%])</span> 54 | <span style='color: green'>(-6 [-2.7%])</span> 216 | <span style='color: green'>(-3 [-4.4%])</span> 65 | <span style='color: green'>(-1 [-2.2%])</span> 45 |
| `execute_preflight_insn_mi/s` | <span style='color: green'>(-0 [-0.2%])</span> 30.59 | -          | <span style='color: green'>(-0 [-0.3%])</span> 31.87 | <span style='color: green'>(-1 [-1.9%])</span> 27.19 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+1 [+0.4%])</span> 176.25 | <span style='color: red'>(+3 [+0.4%])</span> 705 | <span style='color: green'>(-1 [-0.5%])</span> 208 | <span style='color: red'>(+3 [+2.0%])</span> 155 |
| `memory_finalize_time_ms` |  1 |  4 |  4 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+3 [+1.2%])</span> 282.25 | <span style='color: red'>(+13 [+1.2%])</span> 1,129 | <span style='color: red'>(+14 [+4.6%])</span> 321 |  259 |
...
| `generate_perm_trace_time_ms` | <span style='color: red'>(+1 [+4.1%])</span> 25.50 | <span style='color: red'>(+4 [+4.1%])</span> 102 | <span style='color: green'>(-2 [-6.7%])</span> 28 |  20 |
| `perm_trace_commit_time_ms` |  64.28 |  257.10 | <span style='color: red'>(+1 [+1.6%])</span> 71.56 | <span style='color: red'>(+1 [+2.2%])</span> 55.56 |
| `quotient_poly_compute_time_ms` | <span style='color: green'>(-1 [-1.2%])</span> 57.68 | <span style='color: green'>(-3 [-1.2%])</span> 230.70 | <span style='color: green'>(-1 [-1.6%])</span> 68.76 | <span style='color: red'>(+0 [+0.9%])</span> 51.80 |
| `quotient_poly_commit_time_ms` | <span style='color: green'>(-0 [-1.7%])</span> 14.76 | <span style='color: green'>(-1 [-1.7%])</span> 59.04 | <span style='color: green'>(-1 [-7.5%])</span> 16.44 | <span style='color: red'>(+0 [+3.8%])</span> 13.02 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+3 [+5.3%])</span> 65 | <span style='color: red'>(+13 [+5.3%])</span> 260 | <span style='color: red'>(+15 [+20.5%])</span> 88 | <span style='color: green'>(-1 [-1.9%])</span> 52 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 553 | 43 | 1 | 33 | 4,137,502 | 125.05 | 170 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 208 | 721 | 23,446,148 | 150,778,428 | 208 | 321 | 0 | 57.56 | 16.44 | 5 | 71.56 | 88 | 100 | 88 | 4 | 57 | 10,899,170 | 28 | 47 | 1,103,000 | 27.19 | 21 | 74 | 1 | 88 | 
| regex_program | 1 | 155 | 520 | 11,598,276 | 128,513,066 | 155 | 259 | 1 | 52.59 | 14.61 | 4 | 64.90 | 54 | 86 | 53 | 0 | 50 | 2,196,106 | 20 | 65 | 1,104,000 | 31.76 | 16 | 67 | 0 | 53 | 
| regex_program | 2 | 161 | 525 | 11,579,064 | 128,513,066 | 161 | 264 | 1 | 51.80 | 14.97 | 4 | 65.08 | 52 | 93 | 52 | 0 | 50 | 2,177,334 | 27 | 59 | 1,104,000 | 31.55 | 16 | 67 | 0 | 52 | 
| regex_program | 3 | 181 | 553 | 11,853,872 | 103,456,394 | 181 | 285 | 0 | 68.76 | 13.02 | 5 | 55.56 | 66 | 86 | 65 | 0 | 49 | 2,422,606 | 27 | 45 | 826,502 | 31.87 | 18 | 82 | 1 | 65 | 

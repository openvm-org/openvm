...
|:---|---:|---:|
| Total | <span style='color: red'>(+0 [+5.0%])</span> 1.63 | <span style='color: red'>(+0 [+10.3%])</span> 1.02 |
| pairing | <span style='color: red'>(+0 [+5.1%])</span> 1.54 | <span style='color: red'>(+0 [+11.1%])</span> 0.93 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+38 [+5.1%])</span> 768 | <span style='color: red'>(+75 [+5.1%])</span> 1,536 | <span style='color: red'>(+93 [+11.1%])</span> 929 | <span style='color: green'>(-18 [-2.9%])</span> 607 |
| `main_cells_used     ` |  12,734,105 |  25,468,210 |  16,059,916 |  9,408,294 |
| `total_cells_used    ` |  27,501,699 |  55,003,398 |  32,689,110 |  22,314,288 |
| `execute_metered_time_ms` | <span style='color: red'>(+2 [+2.2%])</span> 91 | -          | -          | -          |
| `execute_metered_insn_mi/s` | <span style='color: green'>(-0 [-2.2%])</span> 19.10 | -          | <span style='color: green'>(-0 [-2.2%])</span> 19.10 | <span style='color: green'>(-0 [-2.2%])</span> 19.10 |
| `execute_preflight_insns` |  872,871 |  1,745,742 |  1,157,000 |  588,742 |
| `execute_preflight_time_ms` | <span style='color: green'>(-2 [-2.1%])</span> 93 | <span style='color: green'>(-4 [-2.1%])</span> 186 | <span style='color: green'>(-2 [-1.5%])</span> 128 | <span style='color: green'>(-2 [-3.3%])</span> 58 |
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+0 [+1.4%])</span> 13.81 | -          | <span style='color: red'>(+0 [+1.4%])</span> 18.38 | <span style='color: red'>(+0 [+1.4%])</span> 9.24 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+3 [+1.7%])</span> 180.50 | <span style='color: red'>(+6 [+1.7%])</span> 361 | <span style='color: red'>(+2 [+1.0%])</span> 196 | <span style='color: red'>(+4 [+2.5%])</span> 165 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: green'>(-6 [-1.8%])</span> 356.50 | <span style='color: green'>(-13 [-1.8%])</span> 713 | <span style='color: red'>(+5 [+1.3%])</span> 402 | <span style='color: green'>(-18 [-5.5%])</span> 311 |
| `main_trace_commit_time_ms` |  64 |  128 |  74 |  54 |
| `generate_perm_trace_time_ms` | <span style='color: green'>(-1 [-2.2%])</span> 45 | <span style='color: green'>(-2 [-2.2%])</span> 90 |  47 | <span style='color: green'>(-2 [-4.4%])</span> 43 |
| `perm_trace_commit_time_ms` | <span style='color: red'>(+1 [+1.7%])</span> 77.73 | <span style='color: red'>(+3 [+1.7%])</span> 155.46 | <span style='color: red'>(+1 [+1.6%])</span> 90.12 | <span style='color: red'>(+1 [+1.8%])</span> 65.34 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+1 [+0.6%])</span> 79.53 | <span style='color: red'>(+1 [+0.6%])</span> 159.06 | <span style='color: red'>(+1 [+0.7%])</span> 87.89 | <span style='color: red'>(+0 [+0.6%])</span> 71.17 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+0 [+1.5%])</span> 16.80 | <span style='color: red'>(+1 [+1.5%])</span> 33.60 | <span style='color: red'>(+0 [+0.6%])</span> 18.81 | <span style='color: red'>(+0 [+2.6%])</span> 14.79 |
| `pcs_opening_time_ms ` | <span style='color: green'>(-8 [-10.5%])</span> 68 | <span style='color: green'>(-16 [-10.5%])</span> 136 | <span style='color: red'>(+2 [+2.6%])</span> 78 | <span style='color: green'>(-18 [-23.7%])</span> 58 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 607 | 65 | 1 | 91 | 1,745,742 | 19.10 | 171 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 165 | 929 | 32,689,110 | 172,558,444 | 165 | 402 | 0 | 87.89 | 18.81 | 6 | 90.12 | 78 | 141 | 78 | 1 | 74 | 16,059,916 | 47 | 128 | 1,157,000 | 9.24 | 27 | 107 | 1 | 78 | 
| pairing | 1 | 196 | 607 | 22,314,288 | 119,958,502 | 196 | 311 | 1 | 71.17 | 14.79 | 6 | 65.34 | 58 | 111 | 57 | 0 | 54 | 9,408,294 | 43 | 58 | 588,742 | 18.38 | 20 | 86 | 1 | 57 | 

...
|:---|---:|---:|
| Total |  25.16 |  16.34 |
| regex_program |  25.12 |  16.30 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  12,560.50 |  25,121 |  16,302 |  8,819 |
...
| `execute_preflight_time_ms` |  107.50 |  215 |  119 |  96 |
| `execute_preflight_insn_mi/s` |  28.06 | -          |  31.21 |  24.90 |
| `trace_gen_time_ms   ` |  345 |  690 |  418 |  272 |
| `memory_finalize_time_ms` |  2 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  11,757.50 |  23,515 |  15,405 |  8,110 |
| `main_trace_commit_time_ms` |  1,892 |  3,784 |  2,540 |  1,244 |
| `generate_perm_trace_time_ms` |  2,427 |  4,854 |  3,191 |  1,663 |
| `perm_trace_commit_time_ms` |  2,140 |  4,280 |  2,802 |  1,478 |
| `quotient_poly_compute_time_ms` |  1,569 |  3,138 |  2,060 |  1,078 |
| `quotient_poly_commit_time_ms` |  993.50 |  1,987 |  1,305 |  682 |
| `pcs_opening_time_ms ` |  2,720.50 |  5,441 |  3,501 |  1,940 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 8,819 | 41 | 1 | 42 | 4,108,586 | 97.62 | 167 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 418 | 16,302 | 211,757,797 | 373,183,036 | 418 | 15,405 | 0 | 2,060 | 1,305 | 2,802 | 3,501 | 41 | 4 | 2,540 | 91,281,307 | 3,191 | 96 | 2,211,000 | 24.90 | 
| regex_program | 1 | 272 | 8,819 | 174,325,741 | 196,838,026 | 272 | 8,110 | 25 | 1,078 | 682 | 1,478 | 1,940 | 40 | 0 | 1,244 | 73,453,175 | 1,663 | 119 | 1,897,586 | 31.21 | 

...
| `total_proof_time_ms ` |  584 |  2,336 |  733 |  529 |
...
| `execute_metered_insn_mi/s` |  120.51 | -          |  120.51 |  120.51 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  55 |  220 |  68 |  46 |
| `execute_preflight_insn_mi/s` |  30.13 | -          |  31.28 |  27.57 |
| `trace_gen_time_ms   ` |  172 |  688 |  205 |  148 |
| `memory_finalize_time_ms` |  0.75 |  3 |  3 |  0 |
| `stark_prove_excluding_trace_time_ms` |  288.75 |  1,155 |  336 |  266 |
| `main_trace_commit_time_ms` |  51.25 |  205 |  56 |  49 |
| `generate_perm_trace_time_ms` |  34.50 |  138 |  55 |  19 |
| `perm_trace_commit_time_ms` |  63.13 |  252.53 |  68.94 |  54.14 |
| `quotient_poly_compute_time_ms` |  57.43 |  229.72 |  70.14 |  50.54 |
| `quotient_poly_commit_time_ms` |  14.75 |  58.99 |  17.17 |  12.60 |
| `pcs_opening_time_ms ` |  64.25 |  257 |  78 |  56 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 533 | 41 | 1 | 34 | 4,137,502 | 120.51 | 169 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 205 | 733 | 23,446,148 | 150,778,428 | 205 | 336 | 0 | 57.77 | 17.17 | 5 | 68.94 | 78 | 125 | 78 | 3 | 56 | 10,899,170 | 55 | 46 | 1,103,000 | 27.57 | 22 | 75 | 1 | 78 | 
| regex_program | 1 | 148 | 541 | 11,598,276 | 128,513,066 | 148 | 283 | 1 | 50.54 | 14.89 | 4 | 65.24 | 62 | 103 | 62 | 0 | 50 | 2,196,106 | 37 | 68 | 1,104,000 | 30.49 | 16 | 66 | 0 | 62 | 
| regex_program | 2 | 157 | 529 | 11,579,064 | 128,513,066 | 157 | 270 | 1 | 51.26 | 14.34 | 4 | 64.22 | 61 | 91 | 61 | 0 | 50 | 2,177,334 | 27 | 60 | 1,104,000 | 31.28 | 16 | 66 | 0 | 61 | 
| regex_program | 3 | 178 | 533 | 11,853,872 | 103,456,394 | 178 | 266 | 0 | 70.14 | 12.60 | 5 | 54.14 | 56 | 77 | 56 | 0 | 49 | 2,422,606 | 19 | 46 | 826,502 | 31.20 | 18 | 83 | 1 | 56 | 
...
Commit: https://github.com/openvm-org/openvm/commit/8bf5e7eb652a50e6e365e73d69cfe12dc2aaf607
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19077987210)

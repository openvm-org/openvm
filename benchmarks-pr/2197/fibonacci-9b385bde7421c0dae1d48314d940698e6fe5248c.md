...
|:---|---:|---:|
| Total |  1.04 |  0.59 |
| fibonacci_program |  1.03 |  0.57 |


| fibonacci_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  513 |  1,026 |  575 |  451 |
...
| `execute_preflight_insn_mi/s` |  36.51 | -          |  38.37 |  34.65 |
| `trace_gen_time_ms   ` |  189 |  378 |  192 |  186 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  202 |  404 |  214 |  190 |
| `main_trace_commit_time_ms` |  30.50 |  61 |  33 |  28 |
| `generate_perm_trace_time_ms` |  25 |  50 |  33 |  17 |
| `perm_trace_commit_time_ms` |  41.51 |  83.02 |  44.56 |  38.46 |
| `quotient_poly_compute_time_ms` |  30.21 |  60.42 |  32.80 |  27.62 |
| `quotient_poly_commit_time_ms` |  12.13 |  24.27 |  12.90 |  11.37 |
| `pcs_opening_time_ms ` |  61 |  122 |  72 |  50 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 451 | 41 | 1 | 10 | 1,500,209 | 145.50 | 140 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 192 | 575 | 9,677,708 | 84,395,212 | 192 | 214 | 0 | 32.80 | 12.90 | 4 | 44.56 | 72 | 62 | 72 | 0 | 33 | 1,035,986 | 17 | 26 | 873,000 | 34.65 | 14 | 46 | 0 | 72 | 
| fibonacci_program | 1 | 186 | 451 | 9,708,170 | 74,305,770 | 186 | 190 | 1 | 27.62 | 11.37 | 4 | 38.46 | 50 | 72 | 50 | 0 | 28 | 1,064,416 | 33 | 33 | 627,209 | 38.37 | 11 | 39 | 0 | 50 | 

...
| `total_proof_time_ms ` |  719 |  1,438 |  831 |  607 |
...
| `execute_preflight_insn_mi/s` |  13.32 | -          |  17.56 |  9.07 |
| `trace_gen_time_ms   ` |  178 |  356 |  194 |  162 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  352.50 |  705 |  395 |  310 |
| `main_trace_commit_time_ms` |  64 |  128 |  75 |  53 |
| `generate_perm_trace_time_ms` |  33 |  66 |  37 |  29 |
| `perm_trace_commit_time_ms` |  76.88 |  153.76 |  88.80 |  64.96 |
| `quotient_poly_compute_time_ms` |  78.94 |  157.88 |  87.11 |  70.77 |
| `quotient_poly_commit_time_ms` |  15.61 |  31.23 |  16.92 |  14.30 |
| `pcs_opening_time_ms ` |  79 |  158 |  85 |  73 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 607 | 41 | 1 | 90 | 1,745,742 | 19.30 | 146 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 162 | 831 | 32,689,110 | 172,558,444 | 162 | 395 | 0 | 87.11 | 16.92 | 6 | 88.80 | 85 | 129 | 85 | 1 | 75 | 16,059,916 | 37 | 131 | 1,157,000 | 9.07 | 26 | 104 | 1 | 85 | 
| pairing | 1 | 194 | 607 | 22,314,288 | 119,958,502 | 194 | 310 | 1 | 70.77 | 14.30 | 6 | 64.96 | 73 | 97 | 73 | 0 | 53 | 9,408,294 | 29 | 61 | 588,742 | 17.56 | 20 | 85 | 1 | 73 | 

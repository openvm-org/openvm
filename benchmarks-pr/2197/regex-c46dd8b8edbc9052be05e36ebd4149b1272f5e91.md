...
| `total_proof_time_ms ` |  592.25 |  2,369 |  744 |  540 |
...
| `execute_metered_insn_mi/s` |  118.10 | -          |  118.10 |  118.10 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  53.75 |  215 |  65 |  45 |
| `execute_preflight_insn_mi/s` |  30.87 | -          |  32.12 |  27.56 |
| `trace_gen_time_ms   ` |  177.50 |  710 |  211 |  154 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  292.75 |  1,171 |  341 |  270 |
| `main_trace_commit_time_ms` |  51.75 |  207 |  57 |  50 |
| `generate_perm_trace_time_ms` |  34.50 |  138 |  55 |  20 |
| `perm_trace_commit_time_ms` |  64.89 |  259.55 |  70.25 |  55.99 |
| `quotient_poly_compute_time_ms` |  59.52 |  238.06 |  69.34 |  53.53 |
| `quotient_poly_commit_time_ms` |  15.49 |  61.95 |  18.03 |  13.31 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 540 | 67 | 1 | 35 | 4,137,502 | 118.10 | 194 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 211 | 744 | 23,446,148 | 150,778,428 | 211 | 341 | 0 | 60.100 | 18.03 | 5 | 70.25 | 77 | 126 | 77 | 4 | 57 | 10,899,170 | 55 | 46 | 1,103,000 | 27.56 | 21 | 79 | 1 | 77 | 
| regex_program | 1 | 154 | 543 | 11,598,276 | 128,513,066 | 154 | 281 | 1 | 53.53 | 15.20 | 5 | 66.12 | 59 | 102 | 59 | 0 | 50 | 2,196,106 | 35 | 65 | 1,104,000 | 32.12 | 16 | 69 | 0 | 59 | 
| regex_program | 2 | 162 | 542 | 11,579,064 | 128,513,066 | 162 | 279 | 1 | 54.20 | 15.41 | 4 | 67.19 | 62 | 95 | 62 | 0 | 50 | 2,177,334 | 28 | 59 | 1,104,000 | 31.96 | 16 | 70 | 0 | 62 | 
| regex_program | 3 | 183 | 540 | 11,853,872 | 103,456,394 | 183 | 270 | 0 | 69.34 | 13.31 | 5 | 55.99 | 57 | 79 | 56 | 0 | 50 | 2,422,606 | 20 | 45 | 826,502 | 31.86 | 19 | 83 | 1 | 56 | 

...
| `total_proof_time_ms ` |  713 |  1,426 |  817 |  609 |
...
| `execute_preflight_insn_mi/s` |  13.73 | -          |  18.22 |  9.23 |
| `trace_gen_time_ms   ` |  182.50 |  365 |  199 |  166 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  342.50 |  685 |  377 |  308 |
| `main_trace_commit_time_ms` |  64.50 |  129 |  75 |  54 |
| `generate_perm_trace_time_ms` |  32 |  64 |  35 |  29 |
| `perm_trace_commit_time_ms` |  76.58 |  153.16 |  88.02 |  65.14 |
| `quotient_poly_compute_time_ms` |  79.63 |  159.26 |  88.49 |  70.77 |
| `quotient_poly_commit_time_ms` |  16.59 |  33.17 |  18.95 |  14.23 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 609 | 66 | 1 | 89 | 1,745,742 | 19.42 | 171 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 166 | 817 | 32,689,110 | 172,558,444 | 166 | 377 | 0 | 88.49 | 18.95 | 6 | 88.02 | 66 | 126 | 66 | 1 | 75 | 16,059,916 | 35 | 129 | 1,157,000 | 9.23 | 26 | 108 | 1 | 66 | 
| pairing | 1 | 199 | 609 | 22,314,288 | 119,958,502 | 199 | 308 | 1 | 70.77 | 14.23 | 5 | 65.14 | 69 | 97 | 69 | 0 | 54 | 9,408,294 | 29 | 59 | 588,742 | 18.22 | 20 | 85 | 1 | 69 | 

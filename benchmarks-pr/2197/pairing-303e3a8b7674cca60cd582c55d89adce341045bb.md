...
| `total_proof_time_ms ` |  714.50 |  1,429 |  820 |  609 |
...
| `execute_preflight_insn_mi/s` |  13.73 | -          |  18.33 |  9.14 |
| `trace_gen_time_ms   ` |  178 |  356 |  195 |  161 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  345.50 |  691 |  380 |  311 |
| `main_trace_commit_time_ms` |  64 |  128 |  76 |  52 |
| `generate_perm_trace_time_ms` |  36.50 |  73 |  37 |  36 |
| `perm_trace_commit_time_ms` |  78.05 |  156.10 |  90.13 |  65.97 |
| `quotient_poly_compute_time_ms` |  80.13 |  160.25 |  88.31 |  71.95 |
| `quotient_poly_commit_time_ms` |  16.30 |  32.60 |  17.98 |  14.62 |
| `pcs_opening_time_ms ` |  65.50 |  131 |  67 |  64 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 609 | 66 | 1 | 89 | 1,745,742 | 19.54 | 173 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 161 | 820 | 32,689,110 | 172,558,444 | 161 | 380 | 0 | 88.31 | 17.98 | 6 | 90.13 | 67 | 130 | 67 | 1 | 76 | 16,059,916 | 36 | 130 | 1,157,000 | 9.14 | 26 | 107 | 1 | 67 | 
| pairing | 1 | 195 | 609 | 22,314,288 | 119,958,502 | 195 | 311 | 1 | 71.95 | 14.62 | 6 | 65.97 | 64 | 106 | 64 | 0 | 52 | 9,408,294 | 37 | 61 | 588,742 | 18.33 | 20 | 87 | 1 | 64 | 

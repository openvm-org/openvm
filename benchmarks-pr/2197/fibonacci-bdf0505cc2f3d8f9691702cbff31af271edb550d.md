...
|:---|---:|---:|
| Total |  1.04 |  0.56 |
| fibonacci_program |  1.03 |  0.55 |


| fibonacci_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  513.50 |  1,027 |  554 |  473 |
...
| `execute_metered_insn_mi/s` |  150.64 | -          |  150.64 |  150.64 |
| `execute_preflight_insns` |  750,104.50 |  1,500,209 |  873,000 |  627,209 |
| `execute_preflight_time_ms` |  29.50 |  59 |  33 |  26 |
| `execute_preflight_insn_mi/s` |  36.30 | -          |  37.98 |  34.63 |
| `trace_gen_time_ms   ` |  192 |  384 |  196 |  188 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  198.50 |  397 |  210 |  187 |
| `main_trace_commit_time_ms` |  30.50 |  61 |  33 |  28 |
| `generate_perm_trace_time_ms` |  13 |  26 |  13 |  13 |
| `perm_trace_commit_time_ms` |  42.95 |  85.90 |  45.21 |  40.70 |
| `quotient_poly_compute_time_ms` |  31.41 |  62.82 |  33.64 |  29.18 |
| `quotient_poly_commit_time_ms` |  12.57 |  25.13 |  13.12 |  12.01 |
| `pcs_opening_time_ms ` |  66 |  132 |  85 |  47 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 473 | 41 | 1 | 9 | 1,500,209 | 150.64 | 140 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 196 | 554 | 9,677,708 | 84,395,212 | 196 | 187 | 0 | 33.64 | 13.12 | 4 | 45.21 | 47 | 59 | 47 | 0 | 33 | 1,035,986 | 13 | 26 | 873,000 | 34.63 | 14 | 47 | 0 | 47 | 
| fibonacci_program | 1 | 188 | 473 | 9,708,170 | 74,305,770 | 188 | 210 | 1 | 29.18 | 12.01 | 4 | 40.70 | 85 | 54 | 85 | 0 | 28 | 1,064,416 | 13 | 33 | 627,209 | 37.98 | 11 | 41 | 0 | 85 | 

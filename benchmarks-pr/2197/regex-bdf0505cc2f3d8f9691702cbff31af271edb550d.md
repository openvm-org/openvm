...
|:---|---:|---:|
| Total |  2.45 |  0.77 |
| regex_program |  2.42 |  0.74 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  604.75 |  2,419 |  736 |  542 |
...
| `execute_metered_insn_mi/s` |  122.64 | -          |  122.64 |  122.64 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  54.50 |  218 |  66 |  46 |
| `execute_preflight_insn_mi/s` |  29.63 | -          |  30.50 |  27.15 |
| `trace_gen_time_ms   ` |  181 |  724 |  214 |  158 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  301 |  1,204 |  329 |  271 |
| `main_trace_commit_time_ms` |  52 |  208 |  58 |  50 |
| `generate_perm_trace_time_ms` |  46.75 |  187 |  83 |  20 |
| `perm_trace_commit_time_ms` |  65.03 |  260.11 |  71.91 |  55.65 |
| `quotient_poly_compute_time_ms` |  59.45 |  237.80 |  71.27 |  52.97 |
| `quotient_poly_commit_time_ms` |  15.55 |  62.20 |  17.48 |  12.88 |
| `pcs_opening_time_ms ` |  59.75 |  239 |  64 |  57 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 545 | 40 | 1 | 33 | 4,137,502 | 122.64 | 167 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 214 | 736 | 23,446,148 | 150,778,428 | 214 | 329 | 0 | 59.76 | 17.48 | 5 | 71.91 | 64 | 129 | 63 | 4 | 58 | 10,899,170 | 56 | 47 | 1,103,000 | 27.15 | 22 | 77 | 1 | 63 | 
| regex_program | 1 | 158 | 596 | 11,598,276 | 128,513,066 | 158 | 329 | 1 | 52.97 | 15.78 | 4 | 65.36 | 60 | 149 | 60 | 0 | 50 | 2,196,106 | 83 | 66 | 1,104,000 | 30.38 | 17 | 69 | 0 | 60 | 
| regex_program | 2 | 165 | 542 | 11,579,064 | 128,513,066 | 165 | 275 | 1 | 53.81 | 16.06 | 4 | 67.18 | 58 | 96 | 58 | 0 | 50 | 2,177,334 | 28 | 59 | 1,104,000 | 30.50 | 17 | 70 | 0 | 58 | 
| regex_program | 3 | 187 | 545 | 11,853,872 | 103,456,394 | 186 | 271 | 0 | 71.27 | 12.88 | 5 | 55.65 | 57 | 78 | 56 | 0 | 50 | 2,422,606 | 20 | 46 | 826,502 | 30.47 | 18 | 85 | 1 | 56 | 
...
Commit: https://github.com/openvm-org/openvm/commit/bdf0505cc2f3d8f9691702cbff31af271edb550d
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19077610210)

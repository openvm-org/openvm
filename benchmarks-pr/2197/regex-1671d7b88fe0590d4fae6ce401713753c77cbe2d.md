...
|:---|---:|---:|
| Total |  2.44 |  0.79 |
| regex_program |  2.40 |  0.75 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  600.75 |  2,403 |  753 |  547 |
...
| `execute_metered_insn_mi/s` |  118.23 | -          |  118.23 |  118.23 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  55 |  220 |  67 |  46 |
| `execute_preflight_insn_mi/s` |  29.57 | -          |  30.49 |  26.88 |
| `trace_gen_time_ms   ` |  181.75 |  727 |  215 |  159 |
| `memory_finalize_time_ms` |  0.75 |  3 |  3 |  0 |
| `stark_prove_excluding_trace_time_ms` |  296.25 |  1,185 |  346 |  272 |
| `main_trace_commit_time_ms` |  52.25 |  209 |  58 |  50 |
| `generate_perm_trace_time_ms` |  35.50 |  142 |  56 |  19 |
| `perm_trace_commit_time_ms` |  65.19 |  260.75 |  71.14 |  56.67 |
| `quotient_poly_compute_time_ms` |  59.61 |  238.45 |  69.64 |  52.85 |
| `quotient_poly_commit_time_ms` |  15.65 |  62.60 |  18.40 |  13.01 |
| `pcs_opening_time_ms ` |  65 |  260 |  78 |  57 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 547 | 41 | 1 | 34 | 4,137,502 | 118.23 | 168 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 215 | 753 | 23,446,148 | 150,778,428 | 215 | 346 | 0 | 61.51 | 18.40 | 5 | 71.14 | 78 | 128 | 78 | 3 | 58 | 10,899,170 | 56 | 47 | 1,103,000 | 26.88 | 21 | 80 | 1 | 78 | 
| regex_program | 1 | 159 | 555 | 11,598,276 | 128,513,066 | 159 | 287 | 1 | 52.85 | 15.19 | 4 | 65.55 | 63 | 105 | 62 | 0 | 50 | 2,196,106 | 39 | 67 | 1,104,000 | 30.41 | 16 | 68 | 0 | 62 | 
| regex_program | 2 | 166 | 548 | 11,579,064 | 128,513,066 | 166 | 280 | 1 | 54.45 | 15.99 | 4 | 67.39 | 62 | 96 | 62 | 0 | 50 | 2,177,334 | 28 | 60 | 1,104,000 | 30.48 | 17 | 71 | 0 | 62 | 
| regex_program | 3 | 187 | 547 | 11,853,872 | 103,456,394 | 187 | 272 | 0 | 69.64 | 13.01 | 5 | 56.67 | 57 | 79 | 57 | 0 | 51 | 2,422,606 | 19 | 46 | 826,502 | 30.49 | 19 | 83 | 1 | 57 | 

...
| `total_proof_time_ms ` |  706 |  1,412 |  812 |  600 |
...
| `execute_preflight_insn_mi/s` |  13.14 | -          |  17.34 |  8.95 |
| `trace_gen_time_ms   ` |  174.50 |  349 |  193 |  156 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  340 |  680 |  376 |  304 |
| `main_trace_commit_time_ms` |  64 |  128 |  74 |  54 |
| `generate_perm_trace_time_ms` |  38.50 |  77 |  41 |  36 |
| `perm_trace_commit_time_ms` |  75.96 |  151.92 |  88.54 |  63.38 |
| `quotient_poly_compute_time_ms` |  79.06 |  158.13 |  86.57 |  71.56 |
| `quotient_poly_commit_time_ms` |  16.72 |  33.44 |  18.70 |  14.73 |
| `pcs_opening_time_ms ` |  61 |  122 |  67 |  55 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 600 | 40 | 1 | 91 | 1,745,742 | 19.01 | 146 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 156 | 812 | 32,689,110 | 172,558,444 | 156 | 376 | 0 | 86.57 | 18.70 | 6 | 88.54 | 67 | 127 | 67 | 1 | 74 | 16,059,916 | 36 | 132 | 1,157,000 | 8.95 | 26 | 106 | 1 | 67 | 
| pairing | 1 | 193 | 600 | 22,314,288 | 119,958,502 | 193 | 304 | 1 | 71.56 | 14.73 | 5 | 63.38 | 55 | 107 | 55 | 0 | 54 | 9,408,294 | 41 | 61 | 588,742 | 17.34 | 20 | 86 | 1 | 55 | 

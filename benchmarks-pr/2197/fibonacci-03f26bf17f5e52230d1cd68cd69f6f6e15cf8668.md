...
|:---|---:|---:|
| Total |  1.03 |  0.56 |
| fibonacci_program |  1.02 |  0.55 |


| fibonacci_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  508.50 |  1,017 |  554 |  463 |
...
| `execute_metered_insn_mi/s` |  147.44 | -          |  147.44 |  147.44 |
| `execute_preflight_insns` |  750,104.50 |  1,500,209 |  873,000 |  627,209 |
| `execute_preflight_time_ms` |  29.50 |  59 |  33 |  26 |
| `execute_preflight_insn_mi/s` |  36.49 | -          |  38.26 |  34.72 |
| `trace_gen_time_ms   ` |  189 |  378 |  194 |  184 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  196.50 |  393 |  204 |  189 |
| `main_trace_commit_time_ms` |  30.50 |  61 |  33 |  28 |
| `generate_perm_trace_time_ms` |  18.50 |  37 |  25 |  12 |
| `perm_trace_commit_time_ms` |  40.79 |  81.57 |  43.66 |  37.92 |
| `quotient_poly_compute_time_ms` |  30.44 |  60.88 |  31.51 |  29.37 |
| `quotient_poly_commit_time_ms` |  12.28 |  24.57 |  12.65 |  11.91 |
| `pcs_opening_time_ms ` |  62.50 |  125 |  83 |  42 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 463 | 41 | 1 | 10 | 1,500,209 | 147.44 | 142 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 194 | 554 | 9,677,708 | 84,395,212 | 194 | 189 | 0 | 31.51 | 12.65 | 4 | 43.66 | 42 | 69 | 42 | 0 | 33 | 1,035,986 | 25 | 26 | 873,000 | 34.72 | 14 | 44 | 0 | 42 | 
| fibonacci_program | 1 | 184 | 463 | 9,708,170 | 74,305,770 | 184 | 204 | 1 | 29.37 | 11.91 | 4 | 37.92 | 83 | 50 | 83 | 0 | 28 | 1,064,416 | 12 | 33 | 627,209 | 38.26 | 11 | 41 | 0 | 83 | 

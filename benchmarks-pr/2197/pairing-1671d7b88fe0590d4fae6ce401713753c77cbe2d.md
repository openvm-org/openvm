...
| `total_proof_time_ms ` |  718 |  1,436 |  832 |  604 |
...
| `execute_preflight_insn_mi/s` |  13.61 | -          |  18.10 |  9.11 |
| `trace_gen_time_ms   ` |  180 |  360 |  197 |  163 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  350.50 |  701 |  394 |  307 |
| `main_trace_commit_time_ms` |  63 |  126 |  72 |  54 |
| `generate_perm_trace_time_ms` |  38 |  76 |  41 |  35 |
| `perm_trace_commit_time_ms` |  78.03 |  156.06 |  89.95 |  66.11 |
| `quotient_poly_compute_time_ms` |  79.11 |  158.23 |  87.67 |  70.56 |
| `quotient_poly_commit_time_ms` |  16.37 |  32.75 |  18.45 |  14.29 |
| `pcs_opening_time_ms ` |  70 |  140 |  85 |  55 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 604 | 40 | 1 | 89 | 1,745,742 | 19.44 | 143 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 163 | 832 | 32,689,110 | 172,558,444 | 163 | 394 | 0 | 87.67 | 18.45 | 6 | 89.95 | 85 | 128 | 85 | 1 | 72 | 16,059,916 | 35 | 130 | 1,157,000 | 9.11 | 26 | 106 | 1 | 85 | 
| pairing | 1 | 197 | 604 | 22,314,288 | 119,958,502 | 197 | 307 | 1 | 70.56 | 14.29 | 5 | 66.11 | 55 | 111 | 55 | 0 | 54 | 9,408,294 | 41 | 59 | 588,742 | 18.10 | 20 | 85 | 1 | 55 | 

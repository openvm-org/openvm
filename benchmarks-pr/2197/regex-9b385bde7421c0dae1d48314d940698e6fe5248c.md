...
| `total_proof_time_ms ` |  596 |  2,384 |  746 |  541 |
...
| `execute_preflight_insn_mi/s` |  29.73 | -          |  31.12 |  26.63 |
| `trace_gen_time_ms   ` |  179.25 |  717 |  211 |  156 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  294 |  1,176 |  341 |  270 |
| `main_trace_commit_time_ms` |  52.75 |  211 |  58 |  51 |
| `generate_perm_trace_time_ms` |  34.75 |  139 |  55 |  19 |
| `perm_trace_commit_time_ms` |  64.82 |  259.28 |  71.27 |  56.43 |
| `quotient_poly_compute_time_ms` |  59.05 |  236.20 |  69.87 |  53.49 |
| `quotient_poly_commit_time_ms` |  14.91 |  59.62 |  16.91 |  12.64 |
| `pcs_opening_time_ms ` |  64.50 |  258 |  78 |  57 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 543 | 42 | 1 | 34 | 4,137,502 | 118.94 | 169 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 211 | 746 | 23,446,148 | 150,778,428 | 211 | 341 | 0 | 59.21 | 16.91 | 5 | 71.27 | 78 | 127 | 78 | 4 | 58 | 10,899,170 | 55 | 48 | 1,103,000 | 26.63 | 21 | 76 | 1 | 78 | 
| regex_program | 1 | 156 | 554 | 11,598,276 | 128,513,066 | 156 | 289 | 1 | 53.49 | 15.37 | 4 | 66.01 | 62 | 105 | 62 | 0 | 51 | 2,196,106 | 38 | 68 | 1,104,000 | 30.51 | 16 | 69 | 0 | 62 | 
| regex_program | 2 | 165 | 541 | 11,579,064 | 128,513,066 | 165 | 276 | 1 | 53.62 | 14.70 | 4 | 65.57 | 61 | 93 | 61 | 0 | 51 | 2,177,334 | 27 | 59 | 1,104,000 | 31.12 | 16 | 68 | 0 | 61 | 
| regex_program | 3 | 185 | 543 | 11,853,872 | 103,456,394 | 185 | 270 | 0 | 69.87 | 12.64 | 5 | 56.43 | 57 | 78 | 57 | 0 | 51 | 2,422,606 | 19 | 46 | 826,502 | 30.68 | 18 | 83 | 1 | 57 | 
...
Commit: https://github.com/openvm-org/openvm/commit/9b385bde7421c0dae1d48314d940698e6fe5248c
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19082663455)

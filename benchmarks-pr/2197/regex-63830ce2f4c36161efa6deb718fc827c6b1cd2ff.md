...
| `total_proof_time_ms ` |  583.75 |  2,335 |  727 |  526 |
...
| `execute_metered_insn_mi/s` |  120.81 | -          |  120.81 |  120.81 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  53.25 |  213 |  65 |  44 |
| `execute_preflight_insn_mi/s` |  31.27 | -          |  32.32 |  28.32 |
| `trace_gen_time_ms   ` |  179.75 |  719 |  212 |  157 |
...
| `perm_trace_commit_time_ms` |  64.29 |  257.15 |  70.37 |  55.49 |
| `quotient_poly_compute_time_ms` |  59.06 |  236.23 |  70.05 |  52.50 |
| `quotient_poly_commit_time_ms` |  14.90 |  59.60 |  18.12 |  12.60 |
| `pcs_opening_time_ms ` |  55.75 |  223 |  62 |  50 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 533 | 67 | 1 | 34 | 4,137,502 | 120.81 | 192 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 212 | 727 | 23,446,148 | 150,778,428 | 212 | 324 | 0 | 60.38 | 18.12 | 5 | 70.37 | 60 | 126 | 60 | 4 | 57 | 10,899,170 | 55 | 46 | 1,103,000 | 28.32 | 21 | 79 | 1 | 60 | 
| regex_program | 1 | 157 | 549 | 11,598,276 | 128,513,066 | 157 | 284 | 1 | 52.50 | 14.43 | 4 | 65.28 | 62 | 104 | 62 | 0 | 50 | 2,196,106 | 38 | 65 | 1,104,000 | 32.13 | 16 | 67 | 0 | 62 | 
| regex_program | 2 | 165 | 526 | 11,579,064 | 128,513,066 | 165 | 262 | 1 | 53.30 | 14.45 | 4 | 66.01 | 50 | 91 | 49 | 0 | 51 | 2,177,334 | 25 | 58 | 1,104,000 | 32.32 | 16 | 68 | 0 | 49 | 
| regex_program | 3 | 185 | 533 | 11,853,872 | 103,456,394 | 185 | 262 | 0 | 70.05 | 12.60 | 5 | 55.49 | 51 | 77 | 51 | 0 | 49 | 2,422,606 | 18 | 44 | 826,502 | 32.29 | 18 | 83 | 1 | 51 | 
...
Commit: https://github.com/openvm-org/openvm/commit/63830ce2f4c36161efa6deb718fc827c6b1cd2ff
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19089147013)

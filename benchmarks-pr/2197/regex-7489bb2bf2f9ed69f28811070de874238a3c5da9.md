...
| `total_proof_time_ms ` |  588.75 |  2,355 |  715 |  545 |
...
| `execute_preflight_time_ms` |  55.25 |  221 |  67 |  46 |
| `execute_preflight_insn_mi/s` |  29.88 | -          |  30.79 |  27.32 |
| `trace_gen_time_ms   ` |  181.50 |  726 |  215 |  159 |
| `memory_finalize_time_ms` |  1.25 |  5 |  5 |  0 |
| `stark_prove_excluding_trace_time_ms` |  284.50 |  1,138 |  307 |  272 |
| `main_trace_commit_time_ms` |  52.50 |  210 |  58 |  50 |
| `generate_perm_trace_time_ms` |  31.50 |  126 |  41 |  20 |
| `perm_trace_commit_time_ms` |  64.22 |  256.90 |  70.69 |  55.57 |
| `quotient_poly_compute_time_ms` |  58.54 |  234.17 |  71.66 |  47.08 |
| `quotient_poly_commit_time_ms` |  15.32 |  61.26 |  17.91 |  13.02 |
| `pcs_opening_time_ms ` |  59.50 |  238 |  63 |  55 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 547 | 40 | 1 | 34 | 4,137,502 | 119.26 | 170 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 215 | 715 | 23,446,148 | 150,778,428 | 215 | 307 | 0 | 62.20 | 17.91 | 5 | 70.69 | 55 | 112 | 55 | 5 | 58 | 10,899,170 | 41 | 48 | 1,103,000 | 27.32 | 21 | 80 | 1 | 55 | 
| regex_program | 1 | 159 | 548 | 11,598,276 | 128,513,066 | 159 | 281 | 1 | 47.08 | 14.95 | 4 | 64.61 | 63 | 103 | 62 | 0 | 51 | 2,196,106 | 38 | 67 | 1,104,000 | 30.79 | 16 | 62 | 0 | 62 | 
| regex_program | 2 | 165 | 545 | 11,579,064 | 128,513,066 | 165 | 278 | 1 | 53.22 | 15.38 | 4 | 66.02 | 63 | 94 | 63 | 0 | 51 | 2,177,334 | 27 | 60 | 1,104,000 | 30.67 | 17 | 69 | 0 | 63 | 
| regex_program | 3 | 187 | 547 | 11,853,872 | 103,456,394 | 187 | 272 | 0 | 71.66 | 13.02 | 5 | 55.57 | 57 | 78 | 57 | 0 | 50 | 2,422,606 | 20 | 46 | 826,502 | 30.75 | 18 | 85 | 1 | 57 | 
...
Commit: https://github.com/openvm-org/openvm/commit/7489bb2bf2f9ed69f28811070de874238a3c5da9
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19086284155)

...
|:---|---:|---:|
| Total |  2.38 |  0.75 |
| regex_program |  2.35 |  0.71 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  587 |  2,348 |  712 |  543 |
...
| `execute_metered_insn_mi/s` |  118.64 | -          |  118.64 |  118.64 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  54.25 |  217 |  67 |  45 |
| `execute_preflight_insn_mi/s` |  31.11 | -          |  32.14 |  28.38 |
| `trace_gen_time_ms   ` |  179.50 |  718 |  213 |  156 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  285.25 |  1,141 |  308 |  272 |
| `main_trace_commit_time_ms` |  52.25 |  209 |  57 |  50 |
| `generate_perm_trace_time_ms` |  29.25 |  117 |  35 |  20 |
| `perm_trace_commit_time_ms` |  65.36 |  261.46 |  71.13 |  56.46 |
| `quotient_poly_compute_time_ms` |  59.65 |  238.62 |  70.03 |  53.51 |
| `quotient_poly_commit_time_ms` |  15.51 |  62.03 |  17.43 |  13.27 |
| `pcs_opening_time_ms ` |  60.75 |  243 |  65 |  57 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 545 | 66 | 1 | 34 | 4,137,502 | 118.64 | 195 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 213 | 712 | 23,446,148 | 150,778,428 | 213 | 308 | 0 | 61.40 | 17.43 | 5 | 71.13 | 65 | 106 | 64 | 4 | 57 | 10,899,170 | 34 | 45 | 1,103,000 | 28.38 | 21 | 79 | 1 | 64 | 
| regex_program | 1 | 156 | 548 | 11,598,276 | 128,513,066 | 156 | 283 | 1 | 53.51 | 15.75 | 4 | 66.54 | 59 | 102 | 58 | 0 | 51 | 2,196,106 | 35 | 67 | 1,104,000 | 31.80 | 16 | 69 | 0 | 58 | 
| regex_program | 2 | 164 | 543 | 11,579,064 | 128,513,066 | 164 | 278 | 1 | 53.68 | 15.58 | 4 | 67.32 | 62 | 96 | 61 | 0 | 50 | 2,177,334 | 28 | 59 | 1,104,000 | 32.13 | 16 | 69 | 0 | 61 | 
| regex_program | 3 | 185 | 545 | 11,853,872 | 103,456,394 | 185 | 272 | 0 | 70.03 | 13.27 | 5 | 56.46 | 57 | 79 | 57 | 0 | 51 | 2,422,606 | 20 | 46 | 826,502 | 32.14 | 18 | 84 | 1 | 57 | 
...
Commit: https://github.com/openvm-org/openvm/commit/b8e5b98f9945652f5ce5d90a8afb0bd3daa3201d
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19088767372)

...
| `total_proof_time_ms ` |  586 |  2,344 |  730 |  534 |
...
| `execute_metered_insn_mi/s` |  119.93 | -          |  119.93 |  119.93 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  53.25 |  213 |  64 |  45 |
| `execute_preflight_insn_mi/s` |  30.98 | -          |  32.16 |  27.84 |
| `trace_gen_time_ms   ` |  177 |  708 |  209 |  154 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  288 |  1,152 |  329 |  269 |
| `main_trace_commit_time_ms` |  51.75 |  207 |  56 |  50 |
| `generate_perm_trace_time_ms` |  34 |  136 |  53 |  19 |
| `perm_trace_commit_time_ms` |  63.66 |  254.62 |  69.35 |  55.86 |
| `quotient_poly_compute_time_ms` |  57.97 |  231.86 |  69.22 |  51.48 |
| `quotient_poly_commit_time_ms` |  14.89 |  59.56 |  17.59 |  13.08 |
| `pcs_opening_time_ms ` |  63 |  252 |  72 |  57 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 538 | 40 | 1 | 34 | 4,137,502 | 119.93 | 167 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 209 | 730 | 23,446,148 | 150,778,428 | 209 | 329 | 0 | 58.78 | 17.59 | 5 | 69.35 | 72 | 123 | 72 | 4 | 56 | 10,899,170 | 53 | 46 | 1,103,000 | 27.84 | 22 | 77 | 1 | 72 | 
| regex_program | 1 | 154 | 542 | 11,598,276 | 128,513,066 | 154 | 282 | 1 | 51.48 | 14.57 | 4 | 64.65 | 62 | 103 | 62 | 0 | 50 | 2,196,106 | 37 | 64 | 1,104,000 | 32.16 | 16 | 66 | 0 | 62 | 
| regex_program | 2 | 162 | 534 | 11,579,064 | 128,513,066 | 162 | 272 | 1 | 52.38 | 14.31 | 4 | 64.77 | 61 | 92 | 61 | 0 | 51 | 2,177,334 | 27 | 58 | 1,104,000 | 32.09 | 16 | 67 | 0 | 61 | 
| regex_program | 3 | 183 | 538 | 11,853,872 | 103,456,394 | 183 | 269 | 0 | 69.22 | 13.08 | 5 | 55.86 | 57 | 78 | 56 | 0 | 50 | 2,422,606 | 19 | 45 | 826,502 | 31.84 | 18 | 83 | 1 | 56 | 

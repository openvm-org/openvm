...
| `total_proof_time_ms ` |  588 |  2,352 |  738 |  534 |
...
| `execute_preflight_insn_mi/s` |  29.82 | -          |  30.79 |  27.50 |
| `trace_gen_time_ms   ` |  175 |  700 |  209 |  150 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  290.75 |  1,163 |  337 |  270 |
| `main_trace_commit_time_ms` |  52.25 |  209 |  58 |  50 |
| `generate_perm_trace_time_ms` |  35.25 |  141 |  56 |  20 |
| `perm_trace_commit_time_ms` |  64.10 |  256.40 |  70.18 |  55.97 |
| `quotient_poly_compute_time_ms` |  58.16 |  232.65 |  69.24 |  51.26 |
| `quotient_poly_commit_time_ms` |  15.02 |  60.06 |  17.86 |  13.27 |
| `pcs_opening_time_ms ` |  63.25 |  253 |  73 |  57 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 539 | 41 | 1 | 35 | 4,137,502 | 117.33 | 168 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 209 | 738 | 23,446,148 | 150,778,428 | 209 | 337 | 0 | 59.73 | 17.86 | 5 | 70.18 | 73 | 127 | 73 | 4 | 58 | 10,899,170 | 56 | 47 | 1,103,000 | 27.50 | 21 | 78 | 1 | 73 | 
| regex_program | 1 | 150 | 541 | 11,598,276 | 128,513,066 | 150 | 283 | 1 | 51.26 | 14.64 | 4 | 65.40 | 62 | 104 | 62 | 0 | 50 | 2,196,106 | 38 | 66 | 1,104,000 | 30.23 | 16 | 66 | 0 | 62 | 
| regex_program | 2 | 160 | 534 | 11,579,064 | 128,513,066 | 160 | 273 | 1 | 52.42 | 14.30 | 4 | 64.85 | 61 | 92 | 61 | 0 | 51 | 2,177,334 | 27 | 59 | 1,104,000 | 30.79 | 16 | 67 | 0 | 61 | 
| regex_program | 3 | 181 | 539 | 11,853,872 | 103,456,394 | 181 | 270 | 0 | 69.24 | 13.27 | 5 | 55.97 | 57 | 78 | 57 | 0 | 50 | 2,422,606 | 20 | 46 | 826,502 | 30.76 | 18 | 83 | 1 | 57 | 
...
Commit: https://github.com/openvm-org/openvm/commit/827061070c389b915bbf1e70655acee85f6b826f
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19052346523)

...
| `total_proof_time_ms ` |  707.50 |  1,415 |  807 |  608 |
...
| `execute_preflight_time_ms` |  95 |  190 |  131 |  59 |
| `execute_preflight_insn_mi/s` |  13.54 | -          |  18.05 |  9.02 |
| `trace_gen_time_ms   ` |  178 |  356 |  195 |  161 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  342 |  684 |  372 |  312 |
| `main_trace_commit_time_ms` |  64.50 |  129 |  74 |  55 |
| `generate_perm_trace_time_ms` |  36.50 |  73 |  38 |  35 |
| `perm_trace_commit_time_ms` |  76.75 |  153.50 |  88.94 |  64.56 |
| `quotient_poly_compute_time_ms` |  78.51 |  157.02 |  86.46 |  70.57 |
| `quotient_poly_commit_time_ms` |  15.83 |  31.67 |  17.54 |  14.13 |
| `pcs_opening_time_ms ` |  65.50 |  131 |  66 |  65 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 608 | 66 | 1 | 88 | 1,745,742 | 19.62 | 170 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 161 | 807 | 32,689,110 | 172,558,444 | 161 | 372 | 0 | 86.46 | 17.54 | 6 | 88.94 | 65 | 127 | 65 | 1 | 74 | 16,059,916 | 35 | 131 | 1,157,000 | 9.02 | 26 | 104 | 1 | 65 | 
| pairing | 1 | 195 | 608 | 22,314,288 | 119,958,502 | 195 | 312 | 1 | 70.57 | 14.13 | 6 | 64.56 | 66 | 105 | 65 | 0 | 55 | 9,408,294 | 38 | 59 | 588,742 | 18.05 | 20 | 85 | 1 | 65 | 

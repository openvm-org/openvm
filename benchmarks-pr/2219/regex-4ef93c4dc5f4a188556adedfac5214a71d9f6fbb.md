...
|:---|---:|---:|
| Total |  2.38 |  0.78 |
| regex_program |  2.34 |  0.74 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  586 |  2,344 |  740 |  531 |
...
| `execute_preflight_insn_mi/s` |  31.46 | -          |  32.61 |  28.69 |
| `trace_gen_time_ms   ` |  176.25 |  705 |  210 |  153 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  289.50 |  1,158 |  341 |  263 |
| `main_trace_commit_time_ms` |  50.50 |  202 |  56 |  48 |
| `generate_perm_trace_time_ms` |  35 |  140 |  55 |  19 |
| `perm_trace_commit_time_ms` |  63.40 |  253.59 |  69.88 |  54.38 |
| `quotient_poly_compute_time_ms` |  57.60 |  230.42 |  68.92 |  51.73 |
| `quotient_poly_commit_time_ms` |  14.64 |  58.57 |  16.90 |  12.15 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 531 | 65 | 1 | 36 | 4,137,502 | 112.58 | 192 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 210 | 740 | 23,446,148 | 150,778,428 | 210 | 341 | 0 | 57.93 | 16.90 | 5 | 69.88 | 82 | 126 | 82 | 4 | 56 | 10,899,170 | 55 | 45 | 1,103,000 | 28.69 | 21 | 75 | 1 | 82 | 
| regex_program | 1 | 153 | 539 | 11,598,276 | 128,513,066 | 153 | 280 | 1 | 51.73 | 14.20 | 4 | 63.63 | 62 | 102 | 62 | 0 | 49 | 2,196,106 | 38 | 65 | 1,104,000 | 32.34 | 16 | 66 | 0 | 62 | 
| regex_program | 2 | 161 | 534 | 11,579,064 | 128,513,066 | 161 | 274 | 1 | 51.84 | 15.32 | 4 | 65.70 | 62 | 94 | 62 | 0 | 49 | 2,177,334 | 28 | 57 | 1,104,000 | 32.61 | 16 | 67 | 0 | 62 | 
| regex_program | 3 | 181 | 531 | 11,853,872 | 103,456,394 | 181 | 263 | 0 | 68.92 | 12.15 | 5 | 54.38 | 56 | 76 | 56 | 0 | 48 | 2,422,606 | 19 | 45 | 826,502 | 32.20 | 18 | 82 | 1 | 56 | 
...
Commit: https://github.com/openvm-org/openvm/commit/4ef93c4dc5f4a188556adedfac5214a71d9f6fbb
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19280293668)

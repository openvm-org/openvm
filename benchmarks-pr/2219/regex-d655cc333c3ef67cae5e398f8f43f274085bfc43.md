...
| `total_proof_time_ms ` |  575.75 |  2,303 |  697 |  535 |
...
| `execute_preflight_insn_mi/s` |  31.14 | -          |  32.14 |  28.67 |
| `trace_gen_time_ms   ` |  176.75 |  707 |  209 |  154 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  277.25 |  1,109 |  298 |  266 |
| `main_trace_commit_time_ms` |  51.25 |  205 |  56 |  49 |
| `generate_perm_trace_time_ms` |  30 |  120 |  40 |  18 |
| `perm_trace_commit_time_ms` |  63.100 |  255.99 |  70.92 |  55.56 |
| `quotient_poly_compute_time_ms` |  57.64 |  230.54 |  68.98 |  51.66 |
| `quotient_poly_commit_time_ms` |  14.65 |  58.60 |  16.51 |  12.31 |
| `pcs_opening_time_ms ` |  56.75 |  227 |  62 |  54 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 536 | 65 | 1 | 36 | 4,137,502 | 114.20 | 193 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 209 | 697 | 23,446,148 | 150,778,428 | 209 | 298 | 0 | 57.41 | 16.51 | 5 | 70.92 | 54 | 112 | 54 | 4 | 56 | 10,899,170 | 40 | 45 | 1,103,000 | 28.67 | 21 | 74 | 1 | 54 | 
| regex_program | 1 | 154 | 535 | 11,598,276 | 128,513,066 | 154 | 273 | 1 | 52.49 | 14.63 | 4 | 64.51 | 54 | 100 | 54 | 0 | 49 | 2,196,106 | 35 | 67 | 1,104,000 | 32.14 | 16 | 67 | 0 | 54 | 
| regex_program | 2 | 162 | 535 | 11,579,064 | 128,513,066 | 162 | 272 | 1 | 51.66 | 15.14 | 4 | 64.99 | 62 | 92 | 62 | 0 | 50 | 2,177,334 | 27 | 59 | 1,104,000 | 31.79 | 16 | 67 | 0 | 62 | 
| regex_program | 3 | 182 | 536 | 11,853,872 | 103,456,394 | 182 | 266 | 0 | 68.98 | 12.31 | 5 | 55.56 | 57 | 77 | 57 | 0 | 50 | 2,422,606 | 18 | 46 | 826,502 | 31.97 | 18 | 82 | 1 | 57 | 

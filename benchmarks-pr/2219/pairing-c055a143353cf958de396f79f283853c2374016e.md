...
| `total_proof_time_ms ` |  703 |  1,406 |  803 |  603 |
...
| `execute_preflight_insn_mi/s` |  13.79 | -          |  18.35 |  9.23 |
| `trace_gen_time_ms   ` |  174 |  348 |  190 |  158 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  341.50 |  683 |  372 |  311 |
| `main_trace_commit_time_ms` |  63.50 |  127 |  74 |  53 |
| `generate_perm_trace_time_ms` |  36.50 |  73 |  40 |  33 |
| `perm_trace_commit_time_ms` |  74.56 |  149.13 |  86.21 |  62.92 |
| `quotient_poly_compute_time_ms` |  76.49 |  152.98 |  83.79 |  69.18 |
| `quotient_poly_commit_time_ms` |  15.42 |  30.85 |  17.11 |  13.73 |
| `pcs_opening_time_ms ` |  71 |  142 |  75 |  67 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 603 | 40 | 1 | 90 | 1,745,742 | 19.28 | 144 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 158 | 803 | 32,689,110 | 172,558,444 | 158 | 372 | 0 | 83.79 | 17.11 | 6 | 86.21 | 67 | 128 | 67 | 1 | 74 | 16,059,916 | 40 | 128 | 1,157,000 | 9.23 | 26 | 101 | 1 | 67 | 
| pairing | 1 | 190 | 603 | 22,314,288 | 119,958,502 | 190 | 311 | 1 | 69.18 | 13.73 | 6 | 62.92 | 75 | 99 | 75 | 0 | 53 | 9,408,294 | 33 | 60 | 588,742 | 18.35 | 20 | 83 | 1 | 75 | 

...
| `total_proof_time_ms ` |  735 |  1,470 |  841 |  629 |
...
| `execute_preflight_insn_mi/s` |  13.69 | -          |  18.09 |  9.29 |
| `trace_gen_time_ms   ` |  175 |  350 |  192 |  158 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  372 |  744 |  409 |  335 |
| `main_trace_commit_time_ms` |  63.50 |  127 |  73 |  54 |
| `generate_perm_trace_time_ms` |  54.50 |  109 |  71 |  38 |
| `perm_trace_commit_time_ms` |  75.24 |  150.49 |  86.85 |  63.64 |
| `quotient_poly_compute_time_ms` |  77.48 |  154.96 |  85.94 |  69.02 |
| `quotient_poly_commit_time_ms` |  16.06 |  32.11 |  18.47 |  13.64 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 629 | 40 | 1 | 90 | 1,745,742 | 19.25 | 144 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 158 | 841 | 32,689,110 | 172,558,444 | 158 | 409 | 0 | 85.94 | 18.47 | 6 | 86.85 | 103 | 128 | 102 | 1 | 73 | 16,059,916 | 38 | 128 | 1,157,000 | 9.29 | 26 | 105 | 1 | 102 | 
| pairing | 1 | 192 | 629 | 22,314,288 | 119,958,502 | 192 | 335 | 1 | 69.02 | 13.64 | 6 | 63.64 | 58 | 138 | 58 | 0 | 54 | 9,408,294 | 71 | 59 | 588,742 | 18.09 | 20 | 83 | 1 | 58 | 

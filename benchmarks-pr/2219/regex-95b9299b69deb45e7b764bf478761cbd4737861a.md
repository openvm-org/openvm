...
|:---|---:|---:|
| Total |  2.47 |  0.80 |
| regex_program |  2.43 |  0.76 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  606.75 |  2,427 |  763 |  551 |
...
| `execute_metered_insn_mi/s` |  101.14 | -          |  101.14 |  101.14 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  53.25 |  213 |  65 |  44 |
| `execute_preflight_insn_mi/s` |  31.29 | -          |  32.62 |  28.88 |
| `trace_gen_time_ms   ` |  185.25 |  741 |  219 |  163 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  301 |  1,204 |  355 |  274 |
| `main_trace_commit_time_ms` |  53.25 |  213 |  58 |  51 |
| `generate_perm_trace_time_ms` |  35.75 |  143 |  57 |  19 |
| `perm_trace_commit_time_ms` |  65.40 |  261.62 |  71.33 |  56.90 |
| `quotient_poly_compute_time_ms` |  60.39 |  241.57 |  70.64 |  54.04 |
| `quotient_poly_commit_time_ms` |  15.55 |  62.19 |  18.25 |  12.88 |
| `pcs_opening_time_ms ` |  67.75 |  271 |  85 |  58 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 551 | 64 | 1 | 40 | 4,137,502 | 101.14 | 190 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 219 | 763 | 23,446,148 | 150,778,428 | 219 | 355 | 0 | 62.35 | 18.25 | 5 | 71.33 | 85 | 129 | 84 | 4 | 58 | 10,899,170 | 57 | 44 | 1,103,000 | 28.88 | 21 | 81 | 1 | 84 | 
| regex_program | 1 | 163 | 561 | 11,598,276 | 128,513,066 | 163 | 292 | 1 | 54.04 | 14.81 | 4 | 66.09 | 64 | 106 | 64 | 0 | 52 | 2,196,106 | 39 | 65 | 1,104,000 | 32.44 | 16 | 69 | 0 | 64 | 
| regex_program | 2 | 169 | 552 | 11,579,064 | 128,513,066 | 169 | 283 | 1 | 54.53 | 16.26 | 4 | 67.29 | 64 | 96 | 64 | 0 | 51 | 2,177,334 | 28 | 59 | 1,104,000 | 31.22 | 17 | 71 | 0 | 64 | 
| regex_program | 3 | 190 | 551 | 11,853,872 | 103,456,394 | 190 | 274 | 0 | 70.64 | 12.88 | 5 | 56.90 | 58 | 79 | 58 | 0 | 52 | 2,422,606 | 19 | 45 | 826,502 | 32.62 | 19 | 84 | 1 | 58 | 
...
Commit: https://github.com/openvm-org/openvm/commit/95b9299b69deb45e7b764bf478761cbd4737861a
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19282211540)

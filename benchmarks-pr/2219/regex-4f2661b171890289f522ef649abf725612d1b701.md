...
| `total_proof_time_ms ` |  593.75 |  2,375 |  746 |  537 |
...
| `execute_metered_insn_mi/s` |  112.49 | -          |  112.49 |  112.49 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  52.75 |  211 |  65 |  44 |
| `execute_preflight_insn_mi/s` |  31.58 | -          |  32.73 |  28.44 |
| `trace_gen_time_ms   ` |  180 |  720 |  214 |  156 |
| `memory_finalize_time_ms` |  0.75 |  3 |  3 |  0 |
| `stark_prove_excluding_trace_time_ms` |  293.50 |  1,174 |  343 |  270 |
| `main_trace_commit_time_ms` |  51.25 |  205 |  56 |  49 |
| `generate_perm_trace_time_ms` |  34.75 |  139 |  55 |  20 |
| `perm_trace_commit_time_ms` |  64.45 |  257.81 |  70.92 |  54.90 |
| `quotient_poly_compute_time_ms` |  58.54 |  234.16 |  71.64 |  51.80 |
| `quotient_poly_commit_time_ms` |  15.25 |  61.01 |  16.68 |  12.84 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 541 | 66 | 1 | 36 | 4,137,502 | 112.49 | 192 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 214 | 746 | 23,446,148 | 150,778,428 | 214 | 343 | 0 | 58.17 | 16.68 | 5 | 70.92 | 83 | 127 | 82 | 3 | 56 | 10,899,170 | 55 | 44 | 1,103,000 | 28.44 | 21 | 75 | 1 | 82 | 
| regex_program | 1 | 156 | 551 | 11,598,276 | 128,513,066 | 156 | 288 | 1 | 52.54 | 15.77 | 4 | 66.17 | 63 | 104 | 63 | 0 | 51 | 2,196,106 | 38 | 65 | 1,104,000 | 32.73 | 17 | 68 | 0 | 63 | 
| regex_program | 2 | 165 | 537 | 11,579,064 | 128,513,066 | 165 | 273 | 1 | 51.80 | 15.72 | 4 | 65.83 | 62 | 92 | 62 | 0 | 49 | 2,177,334 | 26 | 57 | 1,104,000 | 32.70 | 16 | 68 | 0 | 62 | 
| regex_program | 3 | 185 | 541 | 11,853,872 | 103,456,394 | 185 | 270 | 0 | 71.64 | 12.84 | 5 | 54.90 | 56 | 78 | 56 | 0 | 49 | 2,422,606 | 20 | 45 | 826,502 | 32.45 | 18 | 85 | 1 | 56 | 
...
Commit: https://github.com/openvm-org/openvm/commit/4f2661b171890289f522ef649abf725612d1b701
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19282402221)

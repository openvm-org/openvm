...
| `total_proof_time_ms ` |  747.50 |  1,495 |  818 |  677 |
...
| `execute_preflight_insn_mi/s` |  13.88 | -          |  18.56 |  9.20 |
| `trace_gen_time_ms   ` |  180.50 |  361 |  199 |  162 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  380.50 |  761 |  383 |  378 |
| `main_trace_commit_time_ms` |  65.50 |  131 |  76 |  55 |
| `generate_perm_trace_time_ms` |  51 |  102 |  62 |  40 |
| `perm_trace_commit_time_ms` |  77.64 |  155.27 |  89.59 |  65.69 |
| `quotient_poly_compute_time_ms` |  80.17 |  160.34 |  88.46 |  71.88 |
| `quotient_poly_commit_time_ms` |  16.28 |  32.56 |  17.73 |  14.83 |
| `pcs_opening_time_ms ` |  85.50 |  171 |  104 |  67 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 677 | 40 | 1 | 91 | 1,745,742 | 19.16 | 144 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 162 | 818 | 32,689,110 | 172,558,444 | 162 | 383 | 0 | 88.46 | 17.73 | 6 | 89.59 | 67 | 132 | 67 | 1 | 76 | 16,059,916 | 40 | 129 | 1,157,000 | 9.20 | 26 | 107 | 1 | 67 | 
| pairing | 1 | 199 | 677 | 22,314,288 | 119,958,502 | 199 | 378 | 1 | 71.88 | 14.83 | 6 | 65.69 | 104 | 131 | 103 | 0 | 55 | 9,408,294 | 62 | 58 | 588,742 | 18.56 | 20 | 87 | 1 | 103 | 

...
| `total_proof_time_ms ` |  732 |  1,464 |  817 |  647 |
...
| `execute_preflight_insn_mi/s` |  13.72 | -          |  18.22 |  9.21 |
| `trace_gen_time_ms   ` |  179 |  358 |  195 |  163 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  366.50 |  733 |  382 |  351 |
| `main_trace_commit_time_ms` |  64.50 |  129 |  74 |  55 |
| `generate_perm_trace_time_ms` |  55.50 |  111 |  71 |  40 |
| `perm_trace_commit_time_ms` |  77.08 |  154.17 |  89.52 |  64.65 |
| `quotient_poly_compute_time_ms` |  78.85 |  157.70 |  87.75 |  69.95 |
| `quotient_poly_commit_time_ms` |  15.83 |  31.67 |  17.66 |  14 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 647 | 40 | 1 | 90 | 1,745,742 | 19.21 | 148 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 163 | 817 | 32,689,110 | 172,558,444 | 163 | 382 | 0 | 87.75 | 17.66 | 6 | 89.52 | 69 | 132 | 68 | 1 | 74 | 16,059,916 | 40 | 129 | 1,157,000 | 9.21 | 26 | 106 | 1 | 68 | 
| pairing | 1 | 195 | 647 | 22,314,288 | 119,958,502 | 195 | 351 | 1 | 69.95 | 14 | 5 | 64.65 | 72 | 138 | 72 | 0 | 55 | 9,408,294 | 71 | 59 | 588,742 | 18.22 | 20 | 84 | 1 | 72 | 

...
|:---|---:|---:|
| Total | <span style='color: red'>(+0 [+7.2%])</span> 1.60 | <span style='color: red'>(+0 [+11.8%])</span> 0.99 |
| pairing | <span style='color: red'>(+0 [+7.6%])</span> 1.51 | <span style='color: red'>(+0 [+13.0%])</span> 0.90 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+53 [+7.6%])</span> 753 | <span style='color: red'>(+106 [+7.6%])</span> 1,506 | <span style='color: red'>(+103 [+13.0%])</span> 898 | <span style='color: red'>(+3 [+0.5%])</span> 608 |
| `main_cells_used     ` | <span style='color: green'>(-188244 [-1.5%])</span> 12,734,341 | <span style='color: green'>(-376488 [-1.5%])</span> 25,468,682 | <span style='color: red'>(+1047334 [+7.0%])</span> 16,060,152 | <span style='color: green'>(-1423822 [-13.1%])</span> 9,408,530 |
| `total_cells_used    ` | <span style='color: green'>(-260224 [-0.9%])</span> 27,501,911 | <span style='color: green'>(-520448 [-0.9%])</span> 55,003,822 | <span style='color: red'>(+1649110 [+5.3%])</span> 32,689,322 | <span style='color: green'>(-2169558 [-8.9%])</span> 22,314,500 |
| `execute_metered_time_ms` | <span style='color: red'>(+1 [+1.1%])</span> 91 | -          | -          | -          |
| `execute_metered_insn_mi/s` | <span style='color: green'>(-2 [-8.7%])</span> 19.01 | -          | <span style='color: green'>(-2 [-8.7%])</span> 19.01 | <span style='color: green'>(-2 [-8.7%])</span> 19.01 |
...
| `execute_preflight_time_ms` | <span style='color: green'>(-10 [-9.7%])</span> 93 | <span style='color: green'>(-20 [-9.7%])</span> 186 |  128 | <span style='color: green'>(-20 [-25.6%])</span> 58 |
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+0 [+0.1%])</span> 13.92 | -          | <span style='color: green'>(-0 [-0.3%])</span> 18.56 | <span style='color: red'>(+0 [+1.0%])</span> 9.28 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+14 [+7.9%])</span> 183.50 | <span style='color: red'>(+27 [+7.9%])</span> 367 | <span style='color: red'>(+16 [+8.7%])</span> 199 | <span style='color: red'>(+11 [+7.0%])</span> 168 |
...
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+52 [+15.9%])</span> 382.50 | <span style='color: red'>(+105 [+15.9%])</span> 765 | <span style='color: red'>(+97 [+27.1%])</span> 455 | <span style='color: red'>(+8 [+2.6%])</span> 310 |
...
| `generate_perm_trace_time_ms` | <span style='color: red'>(+39 [+123.8%])</span> 70.50 | <span style='color: red'>(+78 [+123.8%])</span> 141 | <span style='color: red'>(+61 [+184.8%])</span> 94 | <span style='color: red'>(+17 [+56.7%])</span> 47 |
| `perm_trace_commit_time_ms` | <span style='color: red'>(+2 [+2.1%])</span> 77.13 | <span style='color: red'>(+3 [+2.1%])</span> 154.26 | <span style='color: red'>(+4 [+5.2%])</span> 88.72 | <span style='color: green'>(-1 [-1.8%])</span> 65.54 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+3 [+3.4%])</span> 80.97 | <span style='color: red'>(+5 [+3.4%])</span> 161.94 | <span style='color: red'>(+6 [+6.9%])</span> 90.84 | <span style='color: green'>(-1 [-0.8%])</span> 71.09 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+1 [+6.7%])</span> 16.52 | <span style='color: red'>(+2 [+6.7%])</span> 33.04 | <span style='color: red'>(+2 [+10.8%])</span> 18.73 | <span style='color: red'>(+0 [+1.8%])</span> 14.32 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+6 [+8.9%])</span> 67 | <span style='color: red'>(+11 [+8.9%])</span> 134 | <span style='color: red'>(+17 [+26.2%])</span> 82 | <span style='color: green'>(-6 [-10.3%])</span> 52 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 608 | 65 | 1 | 91 | 1,745,742 | 19.01 | 170 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 168 | 898 | 32,689,322 | 172,558,444 | 168 | 455 | 0 | 90.84 | 18.73 | 6 | 88.72 | 82 | 186 | 82 | 0 | 76 | 16,060,152 | 94 | 128 | 1,157,000 | 9.28 | 27 | 110 | 1 | 82 | 
| pairing | 1 | 199 | 608 | 22,314,500 | 119,958,502 | 199 | 310 | 1 | 71.09 | 14.32 | 6 | 65.54 | 52 | 115 | 52 | 0 | 55 | 9,408,530 | 47 | 58 | 588,742 | 18.56 | 21 | 86 | 1 | 52 | 

...
|:---|---:|---:|
| Total | <span style='color: red'>(+0 [+2.5%])</span> 1.53 | <span style='color: red'>(+0 [+3.3%])</span> 0.91 |
| pairing | <span style='color: red'>(+0 [+2.7%])</span> 1.44 | <span style='color: red'>(+0 [+3.8%])</span> 0.83 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+19 [+2.7%])</span> 719 | <span style='color: red'>(+38 [+2.7%])</span> 1,438 | <span style='color: red'>(+30 [+3.8%])</span> 825 | <span style='color: red'>(+8 [+1.3%])</span> 613 |
| `main_cells_used     ` | <span style='color: green'>(-188480 [-1.5%])</span> 12,734,105 | <span style='color: green'>(-376960 [-1.5%])</span> 25,468,210 | <span style='color: red'>(+1047098 [+7.0%])</span> 16,059,916 | <span style='color: green'>(-1424058 [-13.1%])</span> 9,408,294 |
| `total_cells_used    ` | <span style='color: green'>(-260436 [-0.9%])</span> 27,501,699 | <span style='color: green'>(-520872 [-0.9%])</span> 55,003,398 | <span style='color: red'>(+1648898 [+5.3%])</span> 32,689,110 | <span style='color: green'>(-2169770 [-8.9%])</span> 22,314,288 |
| `execute_metered_time_ms` | <span style='color: green'>(-1 [-1.1%])</span> 89 | -          | -          | -          |
| `execute_metered_insn_mi/s` | <span style='color: green'>(-1 [-6.2%])</span> 19.52 | -          | <span style='color: green'>(-1 [-6.2%])</span> 19.52 | <span style='color: green'>(-1 [-6.2%])</span> 19.52 |
| `execute_preflight_insns` | <span style='color: green'>(-68598 [-7.3%])</span> 872,871 | <span style='color: green'>(-137197 [-7.3%])</span> 1,745,742 | <span style='color: red'>(+14000 [+1.2%])</span> 1,157,000 | <span style='color: green'>(-151197 [-20.4%])</span> 588,742 |
| `execute_preflight_time_ms` | <span style='color: green'>(-10 [-9.2%])</span> 93.50 | <span style='color: green'>(-19 [-9.2%])</span> 187 |  128 | <span style='color: green'>(-19 [-24.4%])</span> 59 |
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+0 [+0.2%])</span> 13.93 | -          | <span style='color: green'>(-0 [-0.4%])</span> 18.55 | <span style='color: red'>(+0 [+1.3%])</span> 9.30 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+14 [+8.5%])</span> 184.50 | <span style='color: red'>(+29 [+8.5%])</span> 369 | <span style='color: red'>(+17 [+9.3%])</span> 200 | <span style='color: red'>(+12 [+7.6%])</span> 169 |
...
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+18 [+5.3%])</span> 347.50 | <span style='color: red'>(+35 [+5.3%])</span> 695 | <span style='color: red'>(+24 [+6.7%])</span> 382 | <span style='color: red'>(+11 [+3.6%])</span> 313 |
| `main_trace_commit_time_ms` | <span style='color: red'>(+3 [+4.8%])</span> 65.50 | <span style='color: red'>(+6 [+4.8%])</span> 131 | <span style='color: red'>(+7 [+10.1%])</span> 76 | <span style='color: green'>(-1 [-1.8%])</span> 55 |
| `generate_perm_trace_time_ms` | <span style='color: red'>(+1 [+3.2%])</span> 32.50 | <span style='color: red'>(+2 [+3.2%])</span> 65 | <span style='color: red'>(+3 [+9.1%])</span> 36 | <span style='color: green'>(-1 [-3.3%])</span> 29 |
| `perm_trace_commit_time_ms` | <span style='color: red'>(+3 [+4.0%])</span> 78.57 | <span style='color: red'>(+6 [+4.0%])</span> 157.14 | <span style='color: red'>(+6 [+7.6%])</span> 90.74 | <span style='color: green'>(-0 [-0.5%])</span> 66.39 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+3 [+3.5%])</span> 81.09 | <span style='color: red'>(+6 [+3.5%])</span> 162.19 | <span style='color: red'>(+5 [+5.8%])</span> 89.90 | <span style='color: red'>(+1 [+0.9%])</span> 72.29 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+1 [+9.1%])</span> 16.90 | <span style='color: red'>(+3 [+9.1%])</span> 33.80 | <span style='color: red'>(+2 [+12.4%])</span> 18.100 | <span style='color: red'>(+1 [+5.2%])</span> 14.80 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+6 [+9.8%])</span> 67.50 | <span style='color: red'>(+12 [+9.8%])</span> 135 | <span style='color: red'>(+5 [+7.7%])</span> 70 | <span style='color: red'>(+7 [+12.1%])</span> 65 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 613 | 65 | 1 | 89 | 1,745,742 | 19.52 | 171 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 169 | 825 | 32,689,110 | 172,558,444 | 169 | 382 | 0 | 89.90 | 18.100 | 6 | 90.74 | 65 | 130 | 65 | 0 | 76 | 16,059,916 | 36 | 128 | 1,157,000 | 9.30 | 27 | 109 | 1 | 65 | 
| pairing | 1 | 200 | 613 | 22,314,288 | 119,958,502 | 200 | 313 | 1 | 72.29 | 14.80 | 6 | 66.39 | 70 | 99 | 70 | 0 | 55 | 9,408,294 | 29 | 59 | 588,742 | 18.55 | 20 | 87 | 1 | 70 | 

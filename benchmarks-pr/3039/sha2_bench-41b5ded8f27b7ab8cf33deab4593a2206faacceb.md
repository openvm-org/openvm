...
| `total_proof_time_ms ` |  2,108.50 |  4,217 |  2,576 |  1,641 |
| `compile_metered_time_ms` |  5 |  5 |  5 |  5 |
| `execute_metered_time_ms` |  56 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  197.13 | -          |  197.13 |  197.13 |
| `execute_preflight_insns` |  5,583,980.50 |  11,167,961 |  7,136,000 |  4,031,961 |
| `execute_preflight_time_ms` |  361.50 |  723 |  492 |  231 |
| `execute_preflight_insn_mi/s` |  34.42 | -          |  36.33 |  32.50 |
| `trace_gen_time_ms   ` |  76.50 |  153 |  108 |  45 |
| `set_initial_memory_time_ms` |  0 |  0 |  0 |  0 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,669.50 |  3,339 |  2,236 |  1,103 |
| `prover.main_trace_commit_time_ms` |  405 |  810 |  586 |  224 |
| `prover.rap_constraints_time_ms` |  987 |  1,974 |  1,295 |  679 |
| `prover.openings_time_ms` |  276.50 |  553 |  354 |  199 |
| `prover.rap_constraints.logup_gkr_time_ms` |  275 |  550 |  355 |  195 |
| `prover.rap_constraints.round0_time_ms` |  529.50 |  1,059 |  703 |  356 |
| `prover.rap_constraints.mle_rounds_time_ms` |  181.50 |  363 |  236 |  127 |
| `prover.openings.stacked_reduction_time_ms` |  75 |  150 |  97 |  53 |
| `prover.openings.stacked_reduction.round0_time_ms` |  45.50 |  91 |  60 |  31 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/41b5ded8f27b7ab8cf33deab4593a2206faacceb/sha2_bench-41b5ded8f27b7ab8cf33deab4593a2206faacceb.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 58 |  |  |  | 292 |  |  |  |  |  |  | 
| app_proof |  |  |  | 1,641 |  | 56 | 11,167,961 | 197.13 | 0 | 4,283 |  | 
...
| leaf | 0 | 114 | 521 | 113 | 34 | 13 | 2 | 9 | 9 | 
...
| leaf | 0 | prover | 237,929,144 | 407 | 145 | 0 | 0 | 141 | 70 | 69 | 44 | 26 | 0 | 120 | 98 | 21 | 10 | 11 | 145 | 145 | 141 | 0 | 3 | 25 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,324,516,602 | 2,236 | 585 | 0 | 0 | 1,295 | 703 | 702 | 236 | 355 | 1 | 354 | 256 | 97 | 60 | 37 | 586 | 585 | 1,295 | 0 | 1 | 353 | 0 | 0 | 
| app_proof | prover | 1 | 716,475,896 | 1,103 | 224 | 0 | 0 | 679 | 356 | 355 | 127 | 195 | 0 | 199 | 145 | 53 | 31 | 21 | 224 | 224 | 679 | 0 | 1 | 194 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 0 | 2 | 108 | 2,576 | 108 | 0 | 12,918,735,564 | 2,978,228,460 | 15,896,964,024 | 2,097,152 | 0 | 4 | 231 | 7,136,000 | 32.50 | 
| app_proof | 1 | 0 | 1 | 45 | 1,641 | 45 | 0 | 7,331,586,696 | 1,706,847,983 | 9,038,434,679 | 2,097,152 | 0 | 2 | 492 | 4,031,961 | 36.33 | 

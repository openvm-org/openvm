...
| `total_proof_time_ms ` |  2,100.50 |  4,201 |  2,564 |  1,637 |
| `compile_metered_time_ms` |  4 |  4 |  4 |  4 |
| `execute_metered_time_ms` |  56 | -          | -          | -          |
| `execute_metered_insns` |  11,167,961 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  197.75 | -          |  197.75 |  197.75 |
| `execute_preflight_insns` |  5,583,980.50 |  11,167,961 |  7,136,000 |  4,031,961 |
| `execute_preflight_time_ms` |  360.50 |  721 |  492 |  229 |
| `execute_preflight_insn_mi/s` |  35.02 | -          |  37.26 |  32.78 |
| `trace_gen_time_ms   ` |  75 |  150 |  106 |  44 |
| `set_initial_memory_time_ms` |  0 |  0 |  0 |  0 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,664 |  3,328 |  2,228 |  1,100 |
| `prover.main_trace_commit_time_ms` |  403.50 |  807 |  584 |  223 |
| `prover.rap_constraints_time_ms` |  984 |  1,968 |  1,290 |  678 |
| `prover.openings_time_ms` |  275.50 |  551 |  353 |  198 |
| `prover.rap_constraints.logup_gkr_time_ms` |  274.50 |  549 |  354 |  195 |
| `prover.rap_constraints.round0_time_ms` |  527.50 |  1,055 |  700 |  355 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/7f15e22bbcf442661096b974513481d56bca3ad7/sha2_bench-7f15e22bbcf442661096b974513481d56bca3ad7.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 58 |  |  |  | 288 |  |  |  |  |  |  | 
| app_proof |  |  |  | 1,638 |  | 56 | 11,167,961 | 197.75 | 0 | 4,265 |  | 
...
| leaf | 0 | 113 | 520 | 112 | 35 | 13 | 2 | 9 | 9 | 
...
| internal_recursive.0 | 1 | prover | 15,378,769 | 116 | 20 | 0 | 0 | 55 | 20 | 20 | 23 | 11 | 0 | 39 | 32 | 7 | 1 | 6 | 20 | 20 | 55 | 0 | 1 | 10 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 96 | 15 | 0 | 0 | 53 | 20 | 19 | 21 | 10 | 0 | 28 | 21 | 7 | 1 | 5 | 15 | 15 | 53 | 0 | 1 | 10 | 0 | 0 | 
| leaf | 0 | prover | 237,929,144 | 407 | 144 | 0 | 0 | 141 | 70 | 69 | 44 | 25 | 0 | 121 | 99 | 21 | 10 | 11 | 144 | 144 | 141 | 0 | 3 | 25 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 1,324,516,602 | 2,228 | 583 | 0 | 0 | 1,290 | 700 | 699 | 235 | 354 | 1 | 353 | 256 | 96 | 59 | 37 | 584 | 583 | 1,290 | 0 | 1 | 352 | 0 | 0 | 
| app_proof | prover | 1 | 716,475,896 | 1,100 | 223 | 0 | 0 | 678 | 355 | 354 | 127 | 195 | 0 | 198 | 145 | 52 | 31 | 21 | 223 | 223 | 678 | 0 | 1 | 193 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 0 | 2 | 106 | 2,564 | 106 | 0 | 12,918,735,564 | 2,978,228,460 | 15,896,964,024 | 2,097,152 | 0 | 4 | 229 | 7,136,000 | 32.78 | 
| app_proof | 1 | 0 | 1 | 44 | 1,637 | 44 | 0 | 7,331,586,696 | 1,706,847,983 | 9,038,434,679 | 2,097,152 | 0 | 2 | 492 | 4,031,961 | 37.26 | 

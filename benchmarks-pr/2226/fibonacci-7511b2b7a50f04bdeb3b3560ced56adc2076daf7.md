...
|:---|---:|---:|
| Total |  0.97 |  0.56 |
| fibonacci_program |  0.96 |  0.55 |


| fibonacci_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  482 |  964 |  546 |  418 |
...
| `execute_metered_insn_mi/s` |  152.82 | -          |  152.82 |  152.82 |
| `execute_preflight_insns` |  750,104.50 |  1,500,209 |  873,000 |  627,209 |
| `execute_preflight_time_ms` |  28.50 |  57 |  33 |  24 |
| `execute_preflight_insn_mi/s` |  38.27 | -          |  40.32 |  36.21 |
| `trace_gen_time_ms   ` |  188 |  376 |  193 |  183 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  172 |  344 |  184 |  160 |
| `main_trace_commit_time_ms` |  30 |  60 |  32 |  28 |
| `generate_perm_trace_time_ms` |  14 |  28 |  16 |  12 |
| `perm_trace_commit_time_ms` |  40.96 |  81.91 |  43.75 |  38.16 |
| `quotient_poly_compute_time_ms` |  30.76 |  61.52 |  31.79 |  29.73 |
| `quotient_poly_commit_time_ms` |  12.05 |  24.11 |  12.57 |  11.54 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 418 | 39 | 1 | 9 | 1,500,209 | 152.82 | 137 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 193 | 546 | 9,677,708 | 84,395,212 | 193 | 184 | 0 | 31.79 | 12.57 | 4 | 43.75 | 45 | 60 | 45 | 0 | 32 | 1,035,986 | 16 | 24 | 873,000 | 36.21 | 14 | 44 | 0 | 45 | 
| fibonacci_program | 1 | 183 | 418 | 9,708,170 | 74,305,770 | 183 | 160 | 1 | 29.73 | 11.54 | 4 | 38.16 | 39 | 50 | 39 | 0 | 28 | 1,064,416 | 12 | 33 | 627,209 | 40.32 | 11 | 41 | 0 | 39 | 

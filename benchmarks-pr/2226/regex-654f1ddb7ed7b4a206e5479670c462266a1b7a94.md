...
|:---|---:|---:|
| Total |  2.45 |  0.79 |
| regex_program |  2.41 |  0.75 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  601.75 |  2,407 |  745 |  545 |
...
| `execute_preflight_insn_mi/s` |  31 | -          |  32.54 |  28.62 |
| `trace_gen_time_ms   ` |  183.25 |  733 |  220 |  159 |
| `memory_finalize_time_ms` |  0.75 |  3 |  3 |  0 |
| `stark_prove_excluding_trace_time_ms` |  297.50 |  1,190 |  337 |  271 |
| `main_trace_commit_time_ms` |  53 |  212 |  58 |  51 |
| `generate_perm_trace_time_ms` |  29.75 |  119 |  38 |  19 |
| `perm_trace_commit_time_ms` |  65.27 |  261.07 |  72.08 |  56.61 |
| `quotient_poly_compute_time_ms` |  59.34 |  237.38 |  70.79 |  50.47 |
| `quotient_poly_commit_time_ms` |  15.37 |  61.48 |  18.18 |  12.64 |
| `pcs_opening_time_ms ` |  71.75 |  287 |  89 |  56 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 545 | 41 | 1 | 42 | 4,137,502 | 98.12 | 167 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 220 | 745 | 23,446,148 | 150,778,428 | 220 | 337 | 0 | 62.21 | 18.18 | 5 | 72.08 | 89 | 108 | 88 | 3 | 58 | 10,899,170 | 35 | 44 | 1,103,000 | 28.62 | 22 | 81 | 1 | 88 | 
| regex_program | 1 | 159 | 555 | 11,598,276 | 128,513,066 | 159 | 288 | 1 | 50.47 | 15.40 | 5 | 66.61 | 64 | 105 | 63 | 0 | 51 | 2,196,106 | 38 | 66 | 1,104,000 | 31.63 | 17 | 66 | 0 | 63 | 
| regex_program | 2 | 167 | 562 | 11,579,064 | 128,513,066 | 167 | 294 | 1 | 53.91 | 15.26 | 4 | 65.79 | 78 | 93 | 78 | 0 | 52 | 2,177,334 | 27 | 59 | 1,104,000 | 31.20 | 17 | 69 | 0 | 78 | 
| regex_program | 3 | 187 | 545 | 11,853,872 | 103,456,394 | 187 | 271 | 0 | 70.79 | 12.64 | 5 | 56.61 | 56 | 78 | 56 | 0 | 51 | 2,422,606 | 19 | 45 | 826,502 | 32.54 | 18 | 84 | 1 | 56 | 
...
Commit: https://github.com/openvm-org/openvm/commit/654f1ddb7ed7b4a206e5479670c462266a1b7a94
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19289805628)

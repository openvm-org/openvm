...
| `total_proof_time_ms ` |  728 |  1,456 |  812 |  644 |
...
| `execute_preflight_insn_mi/s` |  13.81 | -          |  18.36 |  9.25 |
| `trace_gen_time_ms   ` |  176.50 |  353 |  192 |  161 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  365.50 |  731 |  380 |  351 |
| `main_trace_commit_time_ms` |  63.50 |  127 |  74 |  53 |
| `generate_perm_trace_time_ms` |  55 |  110 |  71 |  39 |
| `perm_trace_commit_time_ms` |  76.46 |  152.92 |  88.16 |  64.76 |
| `quotient_poly_compute_time_ms` |  78.40 |  156.80 |  86.09 |  70.71 |
| `quotient_poly_commit_time_ms` |  16.40 |  32.80 |  18.35 |  14.45 |
| `pcs_opening_time_ms ` |  70 |  140 |  71 |  69 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 644 | 66 | 1 | 90 | 1,745,742 | 19.18 | 170 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 161 | 812 | 32,689,110 | 172,558,444 | 161 | 380 | 0 | 86.09 | 18.35 | 6 | 88.16 | 69 | 130 | 69 | 1 | 74 | 16,059,916 | 39 | 128 | 1,157,000 | 9.25 | 26 | 105 | 1 | 69 | 
| pairing | 1 | 192 | 644 | 22,314,288 | 119,958,502 | 192 | 351 | 1 | 70.71 | 14.45 | 5 | 64.76 | 71 | 139 | 71 | 0 | 53 | 9,408,294 | 71 | 60 | 588,742 | 18.36 | 20 | 85 | 1 | 71 | 

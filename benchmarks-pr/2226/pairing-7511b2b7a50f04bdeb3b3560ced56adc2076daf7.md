...
| `total_proof_time_ms ` |  734 |  1,468 |  821 |  647 |
...
| `execute_preflight_insn_mi/s` |  13.67 | -          |  18.10 |  9.24 |
| `trace_gen_time_ms   ` |  181 |  362 |  197 |  165 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  366.50 |  733 |  384 |  349 |
| `main_trace_commit_time_ms` |  64.50 |  129 |  76 |  53 |
| `generate_perm_trace_time_ms` |  56 |  112 |  70 |  42 |
| `perm_trace_commit_time_ms` |  77.20 |  154.39 |  89.39 |  64.100 |
| `quotient_poly_compute_time_ms` |  79.20 |  158.40 |  87.42 |  70.97 |
| `quotient_poly_commit_time_ms` |  16.55 |  33.10 |  18.55 |  14.55 |
| `pcs_opening_time_ms ` |  68.50 |  137 |  71 |  66 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 647 | 40 | 1 | 91 | 1,745,742 | 19.16 | 144 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 165 | 821 | 32,689,110 | 172,558,444 | 165 | 384 | 0 | 87.42 | 18.55 | 6 | 89.39 | 66 | 134 | 66 | 1 | 76 | 16,059,916 | 42 | 128 | 1,157,000 | 9.24 | 26 | 106 | 1 | 66 | 
| pairing | 1 | 197 | 647 | 22,314,288 | 119,958,502 | 197 | 349 | 1 | 70.97 | 14.55 | 5 | 64.100 | 71 | 138 | 71 | 0 | 53 | 9,408,294 | 70 | 59 | 588,742 | 18.10 | 20 | 86 | 1 | 71 | 

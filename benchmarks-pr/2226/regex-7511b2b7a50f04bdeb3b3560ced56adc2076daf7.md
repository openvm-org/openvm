...
| `total_proof_time_ms ` |  582 |  2,328 |  719 |  532 |
...
| `execute_metered_insn_mi/s` |  102.50 | -          |  102.50 |  102.50 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  53.25 |  213 |  65 |  45 |
| `execute_preflight_insn_mi/s` |  31.46 | -          |  32.87 |  28.26 |
| `trace_gen_time_ms   ` |  177 |  708 |  209 |  155 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  283.75 |  1,135 |  320 |  263 |
| `main_trace_commit_time_ms` |  52 |  208 |  57 |  50 |
| `generate_perm_trace_time_ms` |  34 |  136 |  55 |  19 |
| `perm_trace_commit_time_ms` |  64.11 |  256.45 |  70.14 |  55.70 |
| `quotient_poly_compute_time_ms` |  57.44 |  229.75 |  68.82 |  51.54 |
| `quotient_poly_commit_time_ms` |  15.03 |  60.13 |  17.08 |  12.81 |
| `pcs_opening_time_ms ` |  58 |  232 |  61 |  52 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 532 | 41 | 1 | 40 | 4,137,502 | 102.50 | 168 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 209 | 719 | 23,446,148 | 150,778,428 | 209 | 320 | 0 | 57.79 | 17.08 | 5 | 70.14 | 60 | 126 | 59 | 4 | 57 | 10,899,170 | 55 | 45 | 1,103,000 | 28.26 | 21 | 75 | 1 | 59 | 
| regex_program | 1 | 155 | 543 | 11,598,276 | 128,513,066 | 155 | 281 | 1 | 51.59 | 15.59 | 5 | 65.84 | 59 | 102 | 59 | 0 | 51 | 2,196,106 | 35 | 65 | 1,104,000 | 32.44 | 17 | 67 | 0 | 59 | 
| regex_program | 2 | 162 | 534 | 11,579,064 | 128,513,066 | 162 | 271 | 1 | 51.54 | 14.65 | 4 | 64.76 | 61 | 92 | 61 | 0 | 50 | 2,177,334 | 27 | 58 | 1,104,000 | 32.26 | 16 | 66 | 0 | 61 | 
| regex_program | 3 | 182 | 532 | 11,853,872 | 103,456,394 | 182 | 263 | 0 | 68.82 | 12.81 | 5 | 55.70 | 52 | 77 | 51 | 0 | 50 | 2,422,606 | 19 | 45 | 826,502 | 32.87 | 18 | 82 | 1 | 51 | 
...
Commit: https://github.com/openvm-org/openvm/commit/7511b2b7a50f04bdeb3b3560ced56adc2076daf7
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19289599058)

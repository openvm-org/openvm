...
|:---|---:|---:|---:|
| Total |  18.19 |  13.29 | 13.29 |
| kitchen_sink |  3.13 |  1.87 |  1.87 |
| leaf |  11.74 |  8.10 |  8.10 |
| internal.0 |  3.32 |  3.32 |  3.32 |


| kitchen_sink |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,561 |  3,122 |  1,866 |  1,256 |
...
| `execute_preflight_time_ms` |  114.50 |  229 |  133 |  96 |
| `execute_preflight_insn_mi/s` |  8.45 | -          |  11.19 |  5.71 |
| `trace_gen_time_ms   ` |  136 |  272 |  141 |  131 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  1,216.50 |  2,433 |  1,446 |  987 |
| `main_trace_commit_time_ms` |  192.50 |  385 |  209 |  176 |
| `generate_perm_trace_time_ms` |  98 |  196 |  147 |  49 |
| `perm_trace_commit_time_ms` |  79.84 |  159.69 |  94.79 |  64.90 |
| `quotient_poly_compute_time_ms` |  372.60 |  745.20 |  450.27 |  294.93 |
| `quotient_poly_commit_time_ms` |  9.39 |  18.78 |  10.27 |  8.51 |
| `pcs_opening_time_ms ` |  448 |  896 |  509 |  387 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  5,871 |  11,742 |  8,104 |  3,638 |
...
| `execute_preflight_insns` |  6,288,739 |  12,577,478 |  9,308,316 |  3,269,162 |
| `execute_preflight_time_ms` |  2,481 |  4,962 |  3,029 |  1,933 |
| `execute_preflight_insn_mi/s` |  5.76 | -          |  5.83 |  5.69 |
| `trace_gen_time_ms   ` |  414 |  828 |  609 |  219 |
| `memory_finalize_time_ms` |  31 |  62 |  38 |  24 |
| `stark_prove_excluding_trace_time_ms` |  2,974.50 |  5,949 |  4,465 |  1,484 |
| `main_trace_commit_time_ms` |  443 |  886 |  732 |  154 |
| `generate_perm_trace_time_ms` |  246 |  492 |  435 |  57 |
| `perm_trace_commit_time_ms` |  926.33 |  1,852.66 |  1,604.88 |  247.78 |
| `quotient_poly_compute_time_ms` |  346.94 |  693.89 |  522.19 |  171.70 |
| `quotient_poly_commit_time_ms` |  130.23 |  260.45 |  229.93 |  30.52 |
| `pcs_opening_time_ms ` |  867 |  1,734 |  914 |  820 |

| internal.0 |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  3,317 |  3,317 |  3,317 |  3,317 |
...
| `execute_preflight_time_ms` |  2,045 |  2,045 |  2,045 |  2,045 |
| `execute_preflight_insn_mi/s` |  5.97 | -          |  5.97 |  5.97 |
| `trace_gen_time_ms   ` |  159 |  159 |  159 |  159 |
| `memory_finalize_time_ms` |  17 |  17 |  17 |  17 |
| `stark_prove_excluding_trace_time_ms` |  1,112 |  1,112 |  1,112 |  1,112 |
| `main_trace_commit_time_ms` |  255 |  255 |  255 |  255 |
| `generate_perm_trace_time_ms` |  74 |  74 |  74 |  74 |
| `perm_trace_commit_time_ms` |  187.14 |  187.14 |  187.14 |  187.14 |
| `quotient_poly_compute_time_ms` |  279.32 |  279.32 |  279.32 |  279.32 |
| `quotient_poly_commit_time_ms` |  74.58 |  74.58 |  74.58 |  74.58 |
| `pcs_opening_time_ms ` |  237 |  237 |  237 |  237 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal.0 |  | 3,322 |  | 3 | 2 |  |  |  |  | 
| kitchen_sink |  |  | 1,256 |  | 1 | 7 | 154,763 | 21.15 | 0 | 
| leaf | 3,642 |  |  | 1 | 1 |  |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal.0 | 0 | 159 | 3,317 | 43,709,890 | 732,015,074 | 159 | 1,112 | 0 | 279.32 | 74.58 | 5 | 187.14 | 237 | 262 | 237 | 17 | 255 | 20,592,928 | 74 | 2,045 | 4,041,593 | 5.97 | 44 | 355 | 0 | 237 | 
| leaf | 0 | 609 | 8,104 | 193,614,318 | 3,758,099,946 | 609 | 4,465 | 0 | 522.19 | 229.93 | 6 | 1,604.88 | 914 | 2,041 | 914 | 38 | 732 | 83,649,940 | 435 | 3,029 | 9,308,316 | 5.69 | 204 | 776 | 36 | 914 | 
| leaf | 1 | 219 | 3,638 | 93,232,594 | 1,225,346,538 | 219 | 1,484 | 0 | 171.70 | 30.52 | 6 | 247.78 | 820 | 305 | 819 | 24 | 154 | 41,597,560 | 57 | 1,933 | 3,269,162 | 5.83 | 42 | 203 | 0 | 819 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| kitchen_sink | 0 | 141 | 1,866 | 39,702,956 | 760,599,754 | 141 | 1,446 | 0 | 450.27 | 10.27 | 17 | 94.79 | 509 | 265 | 508 | 0 | 209 | 10,085,858 | 147 | 133 | 121,000 | 11.19 | 61 | 461 | 3 | 508 | 
| kitchen_sink | 1 | 131 | 1,256 | 36,350,580 | 747,143,466 | 131 | 987 | 0 | 294.93 | 8.51 | 9 | 64.90 | 387 | 120 | 386 | 0 | 176 | 8,253,090 | 49 | 96 | 33,763 | 5.71 | 29 | 303 | 1 | 386 | 

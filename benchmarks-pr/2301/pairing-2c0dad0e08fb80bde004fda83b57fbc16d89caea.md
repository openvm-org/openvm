...
|:---|---:|---:|---:|
| Total |  9.39 |  5.26 | 5.26 |
| pairing |  2.36 |  1.25 |  1.25 |
| leaf |  7.03 |  4.01 |  4.01 |
...
| `total_proof_time_ms ` |  1,149.50 |  2,299 |  1,183 |  1,116 |
...
| `execute_metered_insn_mi/s` |  27.54 | -          |  27.54 |  27.54 |
| `execute_preflight_insns` |  872,871 |  1,745,742 |  1,149,000 |  596,742 |
| `execute_preflight_time_ms` |  88 |  176 |  112 |  64 |
| `execute_preflight_insn_mi/s` |  13.37 | -          |  16.21 |  10.54 |
| `trace_gen_time_ms   ` |  188 |  376 |  194 |  182 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  768.50 |  1,537 |  883 |  654 |
| `main_trace_commit_time_ms` |  66.50 |  133 |  77 |  56 |
| `generate_perm_trace_time_ms` |  42.50 |  85 |  44 |  41 |
| `perm_trace_commit_time_ms` |  78.18 |  156.36 |  90.65 |  65.72 |
| `quotient_poly_compute_time_ms` |  86.81 |  173.63 |  96.78 |  76.85 |
| `quotient_poly_commit_time_ms` |  17.91 |  35.82 |  20.62 |  15.20 |
| `pcs_opening_time_ms ` |  471 |  942 |  623 |  319 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  3,516 |  7,032 |  4,013 |  3,019 |
| `main_cells_used     ` |  20,416,836 |  40,833,672 |  20,627,230 |  20,206,442 |
| `total_cells_used    ` |  49,512,028 |  99,024,056 |  50,015,232 |  49,008,824 |
| `execute_preflight_insns` |  2,988,709.50 |  5,977,419 |  3,050,892 |  2,926,527 |
| `execute_preflight_time_ms` |  1,049.50 |  2,099 |  1,570 |  529 |
| `execute_preflight_insn_mi/s` |  6.31 | -          |  6.38 |  6.25 |
| `trace_gen_time_ms   ` |  162.50 |  325 |  169 |  156 |
| `memory_finalize_time_ms` |  15.50 |  31 |  16 |  15 |
| `stark_prove_excluding_trace_time_ms` |  2,302 |  4,604 |  2,320 |  2,284 |
| `main_trace_commit_time_ms` |  302.50 |  605 |  303 |  302 |
| `generate_perm_trace_time_ms` |  115 |  230 |  126 |  104 |
| `perm_trace_commit_time_ms` |  476.25 |  952.51 |  487.75 |  464.76 |
| `quotient_poly_compute_time_ms` |  353.66 |  707.31 |  355.69 |  351.62 |
| `quotient_poly_commit_time_ms` |  72.25 |  144.51 |  75.85 |  68.66 |
| `pcs_opening_time_ms ` |  976.50 |  1,953 |  988 |  965 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 4,016 |  | 1 | 1 |  |  |  |  | 
| pairing |  | 1,183 |  | 1 | 63 | 1,745,742 | 27.54 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 169 | 3,019 | 50,015,232 | 761,351,658 | 169 | 2,320 | 0 | 355.69 | 75.85 | 6 | 487.75 | 965 | 614 | 965 | 16 | 302 | 20,627,230 | 126 | 529 | 3,050,892 | 6.25 | 83 | 437 | 5 | 965 | 
| leaf | 1 | 156 | 4,013 | 49,008,824 | 761,351,658 | 156 | 2,284 | 0 | 351.62 | 68.66 | 6 | 464.76 | 988 | 570 | 988 | 15 | 303 | 20,206,442 | 104 | 1,570 | 2,926,527 | 6.38 | 80 | 422 | 0 | 988 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 182 | 1,116 | 32,480,114 | 172,558,444 | 182 | 654 | 0 | 96.78 | 20.62 | 8 | 90.65 | 319 | 138 | 319 | 1 | 77 | 15,909,408 | 44 | 112 | 1,149,000 | 10.54 | 27 | 118 | 1 | 319 | 
| pairing | 1 | 194 | 1,183 | 22,464,232 | 119,958,502 | 194 | 883 | 1 | 76.85 | 15.20 | 8 | 65.72 | 623 | 110 | 623 | 0 | 56 | 9,498,894 | 41 | 64 | 596,742 | 16.21 | 21 | 92 | 1 | 623 | 

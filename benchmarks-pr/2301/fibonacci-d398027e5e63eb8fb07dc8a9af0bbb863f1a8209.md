...
|:---|---:|---:|---:|
| Total |  6.23 |  3.61 | 3.61 |
| fibonacci_program |  2.23 |  1.12 |  1.12 |
| leaf |  4 |  2.49 |  2.49 |
...
| `total_proof_time_ms ` |  1,107 |  2,214 |  1,110 |  1,104 |
...
| `execute_preflight_insn_mi/s` |  36.70 | -          |  38.65 |  34.75 |
| `trace_gen_time_ms   ` |  191.50 |  383 |  198 |  185 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  779.50 |  1,559 |  849 |  710 |
| `main_trace_commit_time_ms` |  31 |  62 |  33 |  29 |
| `generate_perm_trace_time_ms` |  35.50 |  71 |  39 |  32 |
| `perm_trace_commit_time_ms` |  41.25 |  82.49 |  44.05 |  38.45 |
| `quotient_poly_compute_time_ms` |  31.21 |  62.41 |  31.75 |  30.67 |
| `quotient_poly_commit_time_ms` |  11.82 |  23.64 |  11.91 |  11.73 |
| `pcs_opening_time_ms ` |  627.50 |  1,255 |  699 |  556 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  2,001.50 |  4,003 |  2,491 |  1,512 |
| `main_cells_used     ` |  9,910,726 |  19,821,452 |  10,121,356 |  9,700,096 |
| `total_cells_used    ` |  25,895,192 |  51,790,384 |  26,398,858 |  25,391,526 |
| `execute_preflight_insns` |  1,999,754 |  3,999,508 |  2,061,640 |  1,937,868 |
| `execute_preflight_time_ms` |  952.50 |  1,905 |  1,531 |  374 |
| `execute_preflight_insn_mi/s` |  5.94 | -          |  5.95 |  5.93 |
| `trace_gen_time_ms   ` |  94.50 |  189 |  99 |  90 |
| `memory_finalize_time_ms` |  9 |  18 |  9 |  9 |
| `stark_prove_excluding_trace_time_ms` |  953 |  1,906 |  1,038 |  868 |
| `main_trace_commit_time_ms` |  133 |  266 |  133 |  133 |
| `generate_perm_trace_time_ms` |  55.50 |  111 |  59 |  52 |
| `perm_trace_commit_time_ms` |  184.39 |  368.78 |  184.77 |  184.01 |
| `quotient_poly_compute_time_ms` |  146.70 |  293.41 |  146.81 |  146.60 |
| `quotient_poly_commit_time_ms` |  28.83 |  57.65 |  28.95 |  28.70 |
| `pcs_opening_time_ms ` |  401 |  802 |  483 |  319 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program |  | 1,110 |  | 1 | 13 | 1,500,209 | 112.19 | 0 | 
| leaf | 2,494 |  | 1 | 1 |  |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 99 | 1,512 | 26,398,858 | 342,564,330 | 99 | 1,038 | 0 | 146.60 | 28.95 | 6 | 184.01 | 483 | 244 | 482 | 9 | 133 | 10,121,356 | 59 | 374 | 2,061,640 | 5.93 | 33 | 176 | 0 | 482 | 
| leaf | 1 | 90 | 2,491 | 25,391,526 | 342,564,330 | 90 | 868 | 0 | 146.81 | 28.70 | 6 | 184.77 | 319 | 238 | 319 | 9 | 133 | 9,700,096 | 52 | 1,531 | 1,937,868 | 5.95 | 32 | 176 | 0 | 319 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 198 | 1,104 | 9,677,708 | 84,395,212 | 198 | 710 | 0 | 31.75 | 11.91 | 6 | 44.05 | 556 | 77 | 555 | 0 | 33 | 1,035,986 | 32 | 26 | 873,000 | 34.75 | 14 | 44 | 0 | 555 | 
| fibonacci_program | 1 | 185 | 1,110 | 9,708,170 | 74,305,770 | 185 | 849 | 1 | 30.67 | 11.73 | 5 | 38.45 | 699 | 78 | 698 | 0 | 29 | 1,064,416 | 39 | 35 | 627,209 | 38.65 | 11 | 42 | 0 | 698 | 

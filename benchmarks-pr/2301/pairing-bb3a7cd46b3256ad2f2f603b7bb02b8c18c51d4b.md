...
|:---|---:|---:|---:|
| Total |  8.18 |  4.78 | 4.78 |
| pairing |  2.15 |  1.27 |  1.27 |
| leaf |  6.04 |  3.51 |  3.51 |
...
| `total_proof_time_ms ` |  1,041.50 |  2,083 |  1,206 |  877 |
...
| `execute_preflight_time_ms` |  83 |  166 |  106 |  60 |
| `execute_preflight_insn_mi/s` |  14.53 | -          |  17.90 |  11.16 |
| `trace_gen_time_ms   ` |  189 |  378 |  196 |  182 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  664 |  1,328 |  749 |  579 |
| `main_trace_commit_time_ms` |  64.50 |  129 |  74 |  55 |
| `generate_perm_trace_time_ms` |  42.50 |  85 |  56 |  29 |
| `perm_trace_commit_time_ms` |  77.23 |  154.45 |  88.82 |  65.63 |
| `quotient_poly_compute_time_ms` |  83.73 |  167.45 |  92.98 |  74.47 |
| `quotient_poly_commit_time_ms` |  16.81 |  33.62 |  18.54 |  15.08 |
| `pcs_opening_time_ms ` |  373.50 |  747 |  413 |  334 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  3,018.50 |  6,037 |  3,510 |  2,527 |
| `main_cells_used     ` |  20,416,836 |  40,833,672 |  20,627,230 |  20,206,442 |
| `total_cells_used    ` |  49,512,028 |  99,024,056 |  50,015,232 |  49,008,824 |
| `execute_preflight_insns` |  2,988,663.50 |  5,977,327 |  3,050,876 |  2,926,451 |
| `execute_preflight_time_ms` |  1,054.50 |  2,109 |  1,577 |  532 |
| `execute_preflight_insn_mi/s` |  6.42 | -          |  6.52 |  6.32 |
| `trace_gen_time_ms   ` |  167.50 |  335 |  176 |  159 |
| `memory_finalize_time_ms` |  16 |  32 |  17 |  15 |
| `stark_prove_excluding_trace_time_ms` |  1,795 |  3,590 |  1,817 |  1,773 |
| `main_trace_commit_time_ms` |  297 |  594 |  297 |  297 |
| `generate_perm_trace_time_ms` |  116 |  232 |  125 |  107 |
| `perm_trace_commit_time_ms` |  472.23 |  944.46 |  485.70 |  458.76 |
| `quotient_poly_compute_time_ms` |  346.09 |  692.18 |  348.39 |  343.79 |
| `quotient_poly_commit_time_ms` |  71.26 |  142.52 |  74.42 |  68.10 |
| `pcs_opening_time_ms ` |  486 |  972 |  494 |  478 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 3,513 |  | 1 | 1 |  |  |  |  | 
| pairing |  | 877 |  | 1 | 63 | 1,745,742 | 27.47 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 176 | 2,527 | 50,015,232 | 761,351,658 | 176 | 1,817 | 0 | 348.39 | 74.42 | 6 | 485.70 | 478 | 612 | 478 | 17 | 297 | 20,627,230 | 125 | 532 | 3,050,876 | 6.32 | 83 | 429 | 5 | 478 | 
| leaf | 1 | 159 | 3,510 | 49,008,824 | 761,351,658 | 159 | 1,773 | 0 | 343.79 | 68.10 | 6 | 458.76 | 494 | 566 | 493 | 15 | 297 | 20,206,442 | 107 | 1,577 | 2,926,451 | 6.52 | 79 | 414 | 0 | 493 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 182 | 1,206 | 32,480,114 | 172,558,444 | 182 | 749 | 0 | 92.98 | 18.54 | 9 | 88.82 | 413 | 148 | 412 | 1 | 74 | 15,909,408 | 56 | 106 | 1,149,000 | 11.16 | 27 | 112 | 1 | 412 | 
| pairing | 1 | 196 | 877 | 22,464,232 | 119,958,502 | 196 | 579 | 1 | 74.47 | 15.08 | 8 | 65.63 | 334 | 98 | 334 | 0 | 55 | 9,498,894 | 29 | 60 | 596,742 | 17.90 | 21 | 90 | 1 | 334 | 

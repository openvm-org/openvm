...
|:---|---:|---:|---:|
| Total |  16.67 |  12.67 | 12.67 |
| kitchen_sink |  3.63 |  2.37 |  2.37 |
| leaf |  10.34 |  7.60 |  7.60 |
| internal.0 |  2.70 |  2.70 |  2.70 |


| kitchen_sink |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,813 |  3,626 |  2,363 |  1,263 |
...
| `execute_metered_insn_mi/s` |  21.10 | -          |  21.10 |  21.10 |
| `execute_preflight_insns` |  77,381.50 |  154,763 |  121,000 |  33,763 |
| `execute_preflight_time_ms` |  114 |  228 |  134 |  94 |
| `execute_preflight_insn_mi/s` |  8.80 | -          |  11.62 |  5.98 |
| `trace_gen_time_ms   ` |  137 |  274 |  142 |  132 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  1,467.50 |  2,935 |  1,940 |  995 |
| `main_trace_commit_time_ms` |  193 |  386 |  209 |  177 |
| `generate_perm_trace_time_ms` |  101.50 |  203 |  158 |  45 |
| `perm_trace_commit_time_ms` |  80.44 |  160.87 |  96.26 |  64.61 |
| `quotient_poly_compute_time_ms` |  373.02 |  746.04 |  453.73 |  292.31 |
| `quotient_poly_commit_time_ms` |  9.36 |  18.73 |  10.22 |  8.50 |
| `pcs_opening_time_ms ` |  693 |  1,386 |  986 |  400 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  5,172 |  10,344 |  7,603 |  2,741 |
...
| `execute_preflight_insns` |  6,288,708 |  12,577,416 |  9,308,143 |  3,269,273 |
| `execute_preflight_time_ms` |  1,956 |  3,912 |  2,495 |  1,417 |
| `execute_preflight_insn_mi/s` |  5.71 | -          |  5.73 |  5.70 |
| `trace_gen_time_ms   ` |  411.50 |  823 |  608 |  215 |
| `memory_finalize_time_ms` |  31 |  62 |  39 |  23 |
| `stark_prove_excluding_trace_time_ms` |  2,803 |  5,606 |  4,499 |  1,107 |
| `main_trace_commit_time_ms` |  446.50 |  893 |  737 |  156 |
| `generate_perm_trace_time_ms` |  225.50 |  451 |  395 |  56 |
| `perm_trace_commit_time_ms` |  929.64 |  1,859.28 |  1,608.01 |  251.27 |
| `quotient_poly_compute_time_ms` |  348.01 |  696.02 |  524.43 |  171.58 |
| `quotient_poly_commit_time_ms` |  130.68 |  261.36 |  230.95 |  30.41 |
| `pcs_opening_time_ms ` |  707.50 |  1,415 |  976 |  439 |

| internal.0 |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  2,696 |  2,696 |  2,696 |  2,696 |
| `main_cells_used     ` |  20,592,928 |  20,592,928 |  20,592,928 |  20,592,928 |
| `total_cells_used    ` |  43,709,890 |  43,709,890 |  43,709,890 |  43,709,890 |
| `execute_preflight_insns` |  4,041,585 |  4,041,585 |  4,041,585 |  4,041,585 |
| `execute_preflight_time_ms` |  1,519 |  1,519 |  1,519 |  1,519 |
| `execute_preflight_insn_mi/s` |  5.88 | -          |  5.88 |  5.88 |
| `trace_gen_time_ms   ` |  168 |  168 |  168 |  168 |
...
| `perm_trace_commit_time_ms` |  189.43 |  189.43 |  189.43 |  189.43 |
| `quotient_poly_compute_time_ms` |  281.57 |  281.57 |  281.57 |  281.57 |
| `quotient_poly_commit_time_ms` |  74.57 |  74.57 |  74.57 |  74.57 |
| `pcs_opening_time_ms ` |  157 |  157 |  157 |  157 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal.0 |  | 2,700 |  | 3 | 2 |  |  |  |  | 
| kitchen_sink |  |  | 1,263 |  | 1 | 7 | 154,763 | 21.10 | 0 | 
| leaf | 2,746 |  |  | 1 | 1 |  |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal.0 | 0 | 168 | 2,696 | 43,709,890 | 732,015,074 | 168 | 1,007 | 0 | 281.57 | 74.57 | 5 | 189.43 | 157 | 233 | 157 | 17 | 258 | 20,592,928 | 43 | 1,519 | 4,041,585 | 5.88 | 44 | 358 | 0 | 157 | 
| leaf | 0 | 608 | 7,603 | 193,614,318 | 3,758,099,946 | 608 | 4,499 | 0 | 524.43 | 230.95 | 7 | 1,608.01 | 976 | 2,004 | 976 | 39 | 737 | 83,649,940 | 395 | 2,495 | 9,308,143 | 5.70 | 205 | 779 | 36 | 976 | 
| leaf | 1 | 215 | 2,741 | 93,232,594 | 1,225,346,538 | 215 | 1,107 | 0 | 171.58 | 30.41 | 7 | 251.27 | 439 | 308 | 438 | 23 | 156 | 41,597,560 | 56 | 1,417 | 3,269,273 | 5.73 | 43 | 203 | 0 | 438 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| kitchen_sink | 0 | 142 | 2,363 | 39,702,956 | 760,599,754 | 142 | 1,940 | 0 | 453.73 | 10.22 | 17 | 96.26 | 986 | 279 | 985 | 0 | 209 | 10,085,858 | 158 | 134 | 121,000 | 11.62 | 61 | 464 | 3 | 985 | 
| kitchen_sink | 1 | 132 | 1,263 | 36,350,580 | 747,143,466 | 132 | 995 | 0 | 292.31 | 8.50 | 9 | 64.61 | 400 | 116 | 400 | 0 | 177 | 8,253,090 | 45 | 94 | 33,763 | 5.98 | 29 | 301 | 1 | 400 | 

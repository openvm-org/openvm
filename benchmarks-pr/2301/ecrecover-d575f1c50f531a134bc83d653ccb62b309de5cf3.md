...
| `stark_prove_excluding_trace_time_ms` |  539 |  539 |  539 |  539 |
...
| `quotient_poly_compute_time_ms` |  104.95 |  104.95 |  104.95 |  104.95 |
| `quotient_poly_commit_time_ms` |  9.16 |  9.16 |  9.16 |  9.16 |
| `pcs_opening_time_ms ` |  300 |  300 |  300 |  300 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  6,039 |  6,039 |  6,039 |  6,039 |
| `main_cells_used     ` |  34,465,046 |  34,465,046 |  34,465,046 |  34,465,046 |
| `total_cells_used    ` |  83,385,200 |  83,385,200 |  83,385,200 |  83,385,200 |
| `execute_preflight_insns` |  4,109,245 |  4,109,245 |  4,109,245 |  4,109,245 |
| `execute_preflight_time_ms` |  736 |  736 |  736 |  736 |
| `execute_preflight_insn_mi/s` |  5.85 | -          |  5.85 |  5.85 |
| `trace_gen_time_ms   ` |  310 |  310 |  310 |  310 |
| `memory_finalize_time_ms` |  27 |  27 |  27 |  27 |
| `stark_prove_excluding_trace_time_ms` |  4,992 |  4,992 |  4,992 |  4,992 |
| `main_trace_commit_time_ms` |  720 |  720 |  720 |  720 |
| `generate_perm_trace_time_ms` |  340 |  340 |  340 |  340 |
| `perm_trace_commit_time_ms` |  1,492.25 |  1,492.25 |  1,492.25 |  1,492.25 |
| `quotient_poly_compute_time_ms` |  822.29 |  822.29 |  822.29 |  822.29 |
| `quotient_poly_commit_time_ms` |  199.21 |  199.21 |  199.21 |  199.21 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program |  | 976 |  | 1 | 6 | 122,859 | 19.65 | 0 | 
| leaf | 6,045 |  | 1 | 1 |  |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 310 | 6,039 | 83,385,200 | 1,726,057,962 | 310 | 4,992 | 0 | 822.29 | 199.21 | 6 | 1,492.25 | 1,410 | 1,834 | 1,410 | 27 | 720 | 34,465,046 | 340 | 736 | 4,109,245 | 5.85 | 268 | 1,026 | 13 | 1,410 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 211 | 976 | 11,345,240 | 31,789,298 | 211 | 539 | 0 | 104.95 | 9.16 | 10 | 34.16 | 300 | 86 | 300 | 0 | 37 | 2,263,998 | 45 | 59 | 122,859 | 2.24 | 21 | 114 | 1 | 300 | 

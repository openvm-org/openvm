...
|:---|---:|---:|---:|
| Total |  8.78 |  5.06 | 5.06 |
| pairing |  2.11 |  1.19 |  1.19 |
| leaf |  6.67 |  3.86 |  3.86 |
...
| `total_proof_time_ms ` |  1,024 |  2,048 |  1,132 |  916 |
...
| `execute_preflight_insn_mi/s` |  14.12 | -          |  17.39 |  10.84 |
| `trace_gen_time_ms   ` |  188 |  376 |  192 |  184 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  646 |  1,292 |  671 |  621 |
| `main_trace_commit_time_ms` |  64 |  128 |  73 |  55 |
| `generate_perm_trace_time_ms` |  76 |  152 |  97 |  55 |
| `perm_trace_commit_time_ms` |  75.83 |  151.65 |  87.72 |  63.94 |
| `quotient_poly_compute_time_ms` |  81.69 |  163.38 |  90.49 |  72.89 |
| `quotient_poly_commit_time_ms` |  17.06 |  34.13 |  19.17 |  14.96 |
| `pcs_opening_time_ms ` |  326.50 |  653 |  340 |  313 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  3,332.50 |  6,665 |  3,861 |  2,804 |
| `main_cells_used     ` |  20,416,836 |  40,833,672 |  20,627,230 |  20,206,442 |
| `total_cells_used    ` |  49,512,028 |  99,024,056 |  50,015,232 |  49,008,824 |
| `execute_preflight_insns` |  2,988,636.50 |  5,977,273 |  3,050,874 |  2,926,399 |
| `execute_preflight_time_ms` |  1,018 |  2,036 |  1,524 |  512 |
| `execute_preflight_insn_mi/s` |  6.46 | -          |  6.49 |  6.44 |
| `trace_gen_time_ms   ` |  165 |  330 |  169 |  161 |
| `memory_finalize_time_ms` |  15 |  30 |  15 |  15 |
| `stark_prove_excluding_trace_time_ms` |  2,148.50 |  4,297 |  2,175 |  2,122 |
| `main_trace_commit_time_ms` |  295 |  590 |  295 |  295 |
| `generate_perm_trace_time_ms` |  115 |  230 |  133 |  97 |
| `perm_trace_commit_time_ms` |  465.20 |  930.41 |  477.56 |  452.85 |
| `quotient_poly_compute_time_ms` |  338.15 |  676.29 |  340.24 |  336.05 |
| `quotient_poly_commit_time_ms` |  69.10 |  138.20 |  72.03 |  66.17 |
| `pcs_opening_time_ms ` |  859 |  1,718 |  918 |  800 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 3,864 |  | 1 | 1 |  |  |  |  | 
| pairing |  | 916 |  | 1 | 63 | 1,745,742 | 27.62 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 169 | 2,804 | 50,015,232 | 761,351,658 | 169 | 2,122 | 0 | 336.05 | 72.03 | 6 | 477.56 | 800 | 612 | 800 | 15 | 295 | 20,627,230 | 133 | 512 | 3,050,874 | 6.44 | 82 | 414 | 5 | 800 | 
| leaf | 1 | 161 | 3,861 | 49,008,824 | 761,351,658 | 161 | 2,175 | 0 | 340.24 | 66.17 | 6 | 452.85 | 918 | 551 | 918 | 15 | 295 | 20,206,442 | 97 | 1,524 | 2,926,399 | 6.49 | 79 | 409 | 0 | 918 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 184 | 1,132 | 32,480,114 | 172,558,444 | 184 | 671 | 0 | 90.49 | 19.17 | 8 | 87.72 | 340 | 146 | 340 | 1 | 73 | 15,909,408 | 55 | 109 | 1,149,000 | 10.84 | 26 | 110 | 1 | 339 | 
| pairing | 1 | 192 | 916 | 22,464,232 | 119,958,502 | 191 | 621 | 1 | 72.89 | 14.96 | 8 | 63.94 | 313 | 163 | 313 | 0 | 55 | 9,498,894 | 97 | 61 | 596,742 | 17.39 | 20 | 88 | 1 | 313 | 

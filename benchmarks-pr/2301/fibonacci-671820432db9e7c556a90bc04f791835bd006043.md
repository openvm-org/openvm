...
|:---|---:|---:|---:|
| Total |  1.63 |  0.95 | 0.95 |
| fibonacci_program |  1.63 |  0.95 |  0.95 |


| fibonacci_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  808 |  1,616 |  938 |  678 |
...
| `execute_preflight_insn_mi/s` |  37.87 | -          |  40.11 |  35.64 |
| `trace_gen_time_ms   ` |  190 |  380 |  196 |  184 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  483.50 |  967 |  548 |  419 |
| `main_trace_commit_time_ms` |  30.50 |  61 |  33 |  28 |
| `generate_perm_trace_time_ms` |  24.50 |  49 |  28 |  21 |
| `perm_trace_commit_time_ms` |  40.73 |  81.47 |  43.06 |  38.41 |
| `quotient_poly_compute_time_ms` |  30.92 |  61.83 |  34.75 |  27.08 |
| `quotient_poly_commit_time_ms` |  11.94 |  23.89 |  12.30 |  11.58 |
| `pcs_opening_time_ms ` |  342.50 |  685 |  394 |  291 |
...
| --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 678 | 1 | 13 | 1,500,209 | 110.07 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 196 | 938 | 9,677,708 | 84,395,212 | 196 | 548 | 0 | 34.75 | 12.30 | 5 | 43.06 | 394 | 72 | 394 | 0 | 33 | 1,035,986 | 28 | 25 | 873,000 | 35.64 | 13 | 47 | 0 | 394 | 
| fibonacci_program | 1 | 184 | 678 | 9,708,170 | 74,305,770 | 184 | 419 | 1 | 27.08 | 11.58 | 5 | 38.41 | 291 | 59 | 290 | 0 | 28 | 1,064,416 | 21 | 34 | 627,209 | 40.11 | 11 | 39 | 0 | 290 | 

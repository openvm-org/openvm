...
| ecrecover_program |  1.02 |  1.02 |  1.02 |
| leaf |  5.58 |  5.58 |  5.58 |
...
| `total_proof_time_ms ` |  1,010 |  1,010 |  1,010 |  1,010 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  5,577 |  5,577 |  5,577 |  5,577 |
| `main_cells_used     ` |  34,465,046 |  34,465,046 |  34,465,046 |  34,465,046 |
| `total_cells_used    ` |  83,385,200 |  83,385,200 |  83,385,200 |  83,385,200 |
| `execute_preflight_insns` |  4,109,187 |  4,109,187 |  4,109,187 |  4,109,187 |
| `execute_preflight_time_ms` |  735 |  735 |  735 |  735 |
| `execute_preflight_insn_mi/s` |  5.85 | -          |  5.85 |  5.85 |
| `trace_gen_time_ms   ` |  315 |  315 |  315 |  315 |
| `memory_finalize_time_ms` |  27 |  27 |  27 |  27 |
| `stark_prove_excluding_trace_time_ms` |  4,526 |  4,526 |  4,526 |  4,526 |
| `main_trace_commit_time_ms` |  722 |  722 |  722 |  722 |
| `generate_perm_trace_time_ms` |  347 |  347 |  347 |  347 |
| `perm_trace_commit_time_ms` |  1,490.88 |  1,490.88 |  1,490.88 |  1,490.88 |
| `quotient_poly_compute_time_ms` |  817.32 |  817.32 |  817.32 |  817.32 |
| `quotient_poly_commit_time_ms` |  198.62 |  198.62 |  198.62 |  198.62 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program |  | 1,010 |  | 1 | 6 | 122,859 | 19.67 | 0 | 
| leaf | 5,582 |  | 1 | 1 |  |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 315 | 5,577 | 83,385,200 | 1,726,057,962 | 315 | 4,526 | 0 | 817.32 | 198.62 | 6 | 1,490.88 | 943 | 1,838 | 943 | 27 | 722 | 34,465,046 | 347 | 735 | 4,109,187 | 5.85 | 268 | 1,021 | 13 | 943 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 210 | 1,010 | 11,344,654 | 31,789,298 | 210 | 571 | 0 | 104.81 | 9.12 | 10 | 34.06 | 343 | 76 | 342 | 0 | 37 | 2,262,772 | 34 | 61 | 122,859 | 2.15 | 21 | 114 | 1 | 342 | 

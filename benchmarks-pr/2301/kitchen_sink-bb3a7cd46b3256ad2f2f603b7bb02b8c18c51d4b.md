...
|:---|---:|---:|---:|
| Total |  16.04 |  12.02 | 12.02 |
| kitchen_sink |  2.90 |  1.69 |  1.69 |
| leaf |  10.28 |  7.46 |  7.46 |
...
| `total_proof_time_ms ` |  1,448 |  2,896 |  1,680 |  1,216 |
...
| `execute_metered_insn_mi/s` |  21.20 | -          |  21.20 |  21.20 |
| `execute_preflight_insns` |  77,381.50 |  154,763 |  121,000 |  33,763 |
| `execute_preflight_time_ms` |  116 |  232 |  136 |  96 |
| `execute_preflight_insn_mi/s` |  8.67 | -          |  11.38 |  5.95 |
| `trace_gen_time_ms   ` |  135 |  270 |  139 |  131 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  1,103.50 |  2,207 |  1,260 |  947 |
| `main_trace_commit_time_ms` |  193 |  386 |  208 |  178 |
| `generate_perm_trace_time_ms` |  88.50 |  177 |  132 |  45 |
| `perm_trace_commit_time_ms` |  80.51 |  161.02 |  96.42 |  64.60 |
| `quotient_poly_compute_time_ms` |  372.56 |  745.12 |  451.78 |  293.35 |
| `quotient_poly_commit_time_ms` |  9.36 |  18.71 |  10.21 |  8.50 |
| `pcs_opening_time_ms ` |  342.50 |  685 |  351 |  334 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  5,138 |  10,276 |  7,465 |  2,811 |
...
| `execute_preflight_insns` |  6,288,671 |  12,577,342 |  9,308,210 |  3,269,132 |
| `execute_preflight_time_ms` |  1,956 |  3,912 |  2,509 |  1,403 |
| `execute_preflight_insn_mi/s` |  5.74 | -          |  5.82 |  5.67 |
| `trace_gen_time_ms   ` |  415.50 |  831 |  611 |  220 |
| `memory_finalize_time_ms` |  29 |  58 |  37 |  21 |
| `stark_prove_excluding_trace_time_ms` |  2,765 |  5,530 |  4,344 |  1,186 |
| `main_trace_commit_time_ms` |  447 |  894 |  739 |  155 |
| `generate_perm_trace_time_ms` |  225 |  450 |  397 |  53 |
| `perm_trace_commit_time_ms` |  931.31 |  1,862.61 |  1,611.41 |  251.20 |
| `quotient_poly_compute_time_ms` |  347.97 |  695.94 |  523.74 |  172.20 |
| `quotient_poly_commit_time_ms` |  130.50 |  261 |  230.55 |  30.45 |
| `pcs_opening_time_ms ` |  668 |  1,336 |  816 |  520 |

| internal.0 |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  2,863 |  2,863 |  2,863 |  2,863 |
| `main_cells_used     ` |  20,592,928 |  20,592,928 |  20,592,928 |  20,592,928 |
| `total_cells_used    ` |  43,709,890 |  43,709,890 |  43,709,890 |  43,709,890 |
| `execute_preflight_insns` |  4,041,415 |  4,041,415 |  4,041,415 |  4,041,415 |
| `execute_preflight_time_ms` |  1,532 |  1,532 |  1,532 |  1,532 |
| `execute_preflight_insn_mi/s` |  5.95 | -          |  5.95 |  5.95 |
| `trace_gen_time_ms   ` |  162 |  162 |  162 |  162 |
| `memory_finalize_time_ms` |  16 |  16 |  16 |  16 |
| `stark_prove_excluding_trace_time_ms` |  1,168 |  1,168 |  1,168 |  1,168 |
| `main_trace_commit_time_ms` |  256 |  256 |  256 |  256 |
| `generate_perm_trace_time_ms` |  41 |  41 |  41 |  41 |
| `perm_trace_commit_time_ms` |  189.56 |  189.56 |  189.56 |  189.56 |
| `quotient_poly_compute_time_ms` |  282.07 |  282.07 |  282.07 |  282.07 |
| `quotient_poly_commit_time_ms` |  74.75 |  74.75 |  74.75 |  74.75 |
| `pcs_opening_time_ms ` |  320 |  320 |  320 |  320 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal.0 |  | 2,868 |  | 3 | 2 |  |  |  |  | 
| kitchen_sink |  |  | 1,216 |  | 1 | 7 | 154,763 | 21.20 | 0 | 
| leaf | 2,815 |  |  | 1 | 1 |  |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal.0 | 0 | 162 | 2,863 | 43,709,890 | 732,015,074 | 162 | 1,168 | 0 | 282.07 | 74.75 | 6 | 189.56 | 320 | 232 | 320 | 16 | 256 | 20,592,928 | 41 | 1,532 | 4,041,415 | 5.95 | 44 | 358 | 0 | 320 | 
| leaf | 0 | 611 | 7,465 | 193,614,318 | 3,758,099,946 | 611 | 4,344 | 0 | 523.74 | 230.55 | 6 | 1,611.41 | 816 | 2,009 | 816 | 37 | 739 | 83,649,940 | 397 | 2,509 | 9,308,210 | 5.67 | 205 | 778 | 36 | 816 | 
| leaf | 1 | 220 | 2,811 | 93,232,594 | 1,225,346,538 | 220 | 1,186 | 0 | 172.20 | 30.45 | 6 | 251.20 | 520 | 305 | 520 | 21 | 155 | 41,597,560 | 53 | 1,403 | 3,269,132 | 5.82 | 43 | 203 | 0 | 520 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| kitchen_sink | 0 | 139 | 1,680 | 39,702,956 | 760,599,754 | 139 | 1,260 | 0 | 451.78 | 10.21 | 17 | 96.42 | 334 | 254 | 334 | 0 | 208 | 10,085,858 | 132 | 136 | 121,000 | 11.38 | 61 | 462 | 3 | 334 | 
| kitchen_sink | 1 | 131 | 1,216 | 36,350,580 | 747,143,466 | 131 | 947 | 0 | 293.35 | 8.50 | 9 | 64.60 | 351 | 115 | 350 | 0 | 178 | 8,253,090 | 45 | 96 | 33,763 | 5.95 | 29 | 302 | 1 | 350 | 

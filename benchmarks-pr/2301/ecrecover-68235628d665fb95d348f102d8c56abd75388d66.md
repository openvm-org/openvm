...
|:---|---:|---:|---:|
| Total |  6.58 |  6.58 | 6.58 |
| ecrecover_program |  1.16 |  1.16 |  1.16 |
| leaf |  5.42 |  5.42 |  5.42 |
...
| `stark_prove_excluding_trace_time_ms` |  718 |  718 |  718 |  718 |
...
| `quotient_poly_compute_time_ms` |  105.02 |  105.02 |  105.02 |  105.02 |
| `quotient_poly_commit_time_ms` |  9.12 |  9.12 |  9.12 |  9.12 |
| `pcs_opening_time_ms ` |  489 |  489 |  489 |  489 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  5,420 |  5,420 |  5,420 |  5,420 |
| `main_cells_used     ` |  34,465,046 |  34,465,046 |  34,465,046 |  34,465,046 |
| `total_cells_used    ` |  83,385,200 |  83,385,200 |  83,385,200 |  83,385,200 |
| `execute_preflight_insns` |  4,109,089 |  4,109,089 |  4,109,089 |  4,109,089 |
| `execute_preflight_time_ms` |  744 |  744 |  744 |  744 |
| `execute_preflight_insn_mi/s` |  5.78 | -          |  5.78 |  5.78 |
| `trace_gen_time_ms   ` |  304 |  304 |  304 |  304 |
| `memory_finalize_time_ms` |  28 |  28 |  28 |  28 |
| `stark_prove_excluding_trace_time_ms` |  4,371 |  4,371 |  4,371 |  4,371 |
| `main_trace_commit_time_ms` |  717 |  717 |  717 |  717 |
| `generate_perm_trace_time_ms` |  369 |  369 |  369 |  369 |
| `perm_trace_commit_time_ms` |  1,488.67 |  1,488.67 |  1,488.67 |  1,488.67 |
| `quotient_poly_compute_time_ms` |  814.27 |  814.27 |  814.27 |  814.27 |
| `quotient_poly_commit_time_ms` |  200.68 |  200.68 |  200.68 |  200.68 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program |  | 1,157 |  | 1 | 6 | 122,859 | 19.71 | 0 | 
| leaf | 5,426 |  | 1 | 1 |  |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 304 | 5,420 | 83,385,200 | 1,726,057,962 | 304 | 4,371 | 0 | 814.27 | 200.68 | 6 | 1,488.67 | 773 | 1,859 | 773 | 28 | 717 | 34,465,046 | 369 | 744 | 4,109,089 | 5.78 | 268 | 1,020 | 13 | 773 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 209 | 1,157 | 11,344,654 | 31,789,298 | 209 | 718 | 0 | 105.02 | 9.12 | 10 | 34.12 | 489 | 76 | 489 | 0 | 37 | 2,262,772 | 34 | 61 | 122,859 | 2.16 | 21 | 114 | 1 | 489 | 

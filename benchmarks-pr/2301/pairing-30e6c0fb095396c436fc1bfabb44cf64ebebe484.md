...
|:---|---:|---:|---:|
| Total |  8.34 |  4.80 | 4.80 |
| pairing |  2.27 |  1.32 |  1.32 |
| leaf |  6.06 |  3.48 |  3.48 |
...
| `total_proof_time_ms ` |  1,104 |  2,208 |  1,259 |  949 |
...
| `execute_metered_insn_mi/s` |  27.57 | -          |  27.57 |  27.57 |
| `execute_preflight_insns` |  872,871 |  1,745,742 |  1,149,000 |  596,742 |
| `execute_preflight_time_ms` |  83.50 |  167 |  106 |  61 |
| `execute_preflight_insn_mi/s` |  14.55 | -          |  17.90 |  11.20 |
| `trace_gen_time_ms   ` |  187.50 |  375 |  192 |  183 |
| `memory_finalize_time_ms` |  1 |  2 |  1 |  1 |
| `stark_prove_excluding_trace_time_ms` |  727 |  1,454 |  801 |  653 |
| `main_trace_commit_time_ms` |  66 |  132 |  76 |  56 |
| `generate_perm_trace_time_ms` |  46 |  92 |  48 |  44 |
| `perm_trace_commit_time_ms` |  76.11 |  152.22 |  86.88 |  65.34 |
| `quotient_poly_compute_time_ms` |  83.46 |  166.93 |  91.94 |  74.99 |
| `quotient_poly_commit_time_ms` |  17.94 |  35.87 |  20.21 |  15.67 |
| `pcs_opening_time_ms ` |  433 |  866 |  477 |  389 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  3,032 |  6,064 |  3,480 |  2,584 |
| `main_cells_used     ` |  20,416,836 |  40,833,672 |  20,627,230 |  20,206,442 |
| `total_cells_used    ` |  49,512,028 |  99,024,056 |  50,015,232 |  49,008,824 |
| `execute_preflight_insns` |  2,988,729 |  5,977,458 |  3,050,968 |  2,926,490 |
| `execute_preflight_time_ms` |  1,021.50 |  2,043 |  1,533 |  510 |
| `execute_preflight_insn_mi/s` |  6.49 | -          |  6.50 |  6.48 |
| `trace_gen_time_ms   ` |  165.50 |  331 |  174 |  157 |
| `memory_finalize_time_ms` |  15.50 |  31 |  17 |  14 |
| `stark_prove_excluding_trace_time_ms` |  1,843.50 |  3,687 |  1,899 |  1,788 |
| `main_trace_commit_time_ms` |  299.50 |  599 |  300 |  299 |
| `generate_perm_trace_time_ms` |  113.50 |  227 |  128 |  99 |
| `perm_trace_commit_time_ms` |  471.39 |  942.78 |  483.01 |  459.77 |
| `quotient_poly_compute_time_ms` |  344.46 |  688.92 |  347.62 |  341.30 |
| `quotient_poly_commit_time_ms` |  70.87 |  141.74 |  74.25 |  67.49 |
| `pcs_opening_time_ms ` |  538 |  1,076 |  559 |  517 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 3,483 |  | 1 | 1 |  |  |  |  | 
| pairing |  | 949 |  | 1 | 63 | 1,745,742 | 27.57 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 174 | 2,584 | 50,015,232 | 761,351,658 | 174 | 1,899 | 0 | 347.62 | 74.25 | 6 | 483.01 | 559 | 612 | 559 | 17 | 299 | 20,627,230 | 128 | 510 | 3,050,968 | 6.48 | 82 | 427 | 5 | 559 | 
| leaf | 1 | 157 | 3,480 | 49,008,824 | 761,351,658 | 157 | 1,788 | 0 | 341.30 | 67.49 | 6 | 459.77 | 517 | 559 | 516 | 14 | 300 | 20,206,442 | 99 | 1,533 | 2,926,490 | 6.50 | 79 | 411 | 0 | 516 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 183 | 1,259 | 32,480,114 | 172,558,444 | 183 | 801 | 0 | 91.94 | 20.21 | 8 | 86.88 | 477 | 134 | 477 | 1 | 76 | 15,909,408 | 44 | 106 | 1,149,000 | 11.20 | 27 | 113 | 1 | 477 | 
| pairing | 1 | 192 | 949 | 22,464,232 | 119,958,502 | 192 | 653 | 1 | 74.99 | 15.67 | 8 | 65.34 | 389 | 116 | 389 | 1 | 56 | 9,498,894 | 48 | 61 | 596,742 | 17.90 | 21 | 91 | 1 | 389 | 

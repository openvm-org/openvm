...
|:---|---:|---:|---:|
| Total |  8.50 |  6.04 | 6.04 |
| fibonacci_program |  1.69 |  0.92 |  0.92 |
| leaf |  6.81 |  5.13 |  5.13 |
...
| `total_proof_time_ms ` |  840.50 |  1,681 |  904 |  777 |
...
| `execute_metered_insn_mi/s` |  134.86 | -          |  134.86 |  134.86 |
| `execute_preflight_insns` |  750,104.50 |  1,500,209 |  873,000 |  627,209 |
| `execute_preflight_time_ms` |  29 |  58 |  33 |  25 |
| `execute_preflight_insn_mi/s` |  36.100 | -          |  38.93 |  35.07 |
| `trace_gen_time_ms   ` |  187 |  374 |  192 |  182 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  520 |  1,040 |  648 |  392 |
| `main_trace_commit_time_ms` |  30 |  60 |  32 |  28 |
| `generate_perm_trace_time_ms` |  27.50 |  55 |  33 |  22 |
| `perm_trace_commit_time_ms` |  40.81 |  81.63 |  43.72 |  37.90 |
| `quotient_poly_compute_time_ms` |  30.75 |  61.49 |  31.78 |  29.72 |
| `quotient_poly_commit_time_ms` |  12.52 |  25.04 |  12.86 |  12.19 |
| `pcs_opening_time_ms ` |  376.50 |  753 |  517 |  236 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  3,406 |  6,812 |  5,129 |  1,683 |
| `main_cells_used     ` |  9,910,726 |  19,821,452 |  10,121,356 |  9,700,096 |
| `total_cells_used    ` |  25,895,192 |  51,790,384 |  26,398,858 |  25,391,526 |
| `execute_preflight_insns` |  1,999,718.50 |  3,999,437 |  2,061,609 |  1,937,828 |
| `execute_preflight_time_ms` |  2,250 |  4,500 |  4,138 |  362 |
| `execute_preflight_insn_mi/s` |  5.95 | -          |  5.99 |  5.92 |
| `trace_gen_time_ms   ` |  96 |  192 |  98 |  94 |
| `memory_finalize_time_ms` |  10 |  20 |  11 |  9 |
| `stark_prove_excluding_trace_time_ms` |  1,059 |  2,118 |  1,222 |  896 |
| `main_trace_commit_time_ms` |  130 |  260 |  130 |  130 |
| `generate_perm_trace_time_ms` |  48 |  96 |  49 |  47 |
| `perm_trace_commit_time_ms` |  181.65 |  363.30 |  181.93 |  181.36 |
| `quotient_poly_compute_time_ms` |  140.93 |  281.85 |  141.61 |  140.24 |
| `quotient_poly_commit_time_ms` |  27.69 |  55.38 |  27.70 |  27.69 |
| `pcs_opening_time_ms ` |  528.50 |  1,057 |  691 |  366 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program |  | 904 |  | 1 | 11 | 1,500,209 | 134.86 | 0 | 
| leaf | 5,132 |  | 1 | 1 |  |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 98 | 1,683 | 26,398,858 | 342,564,330 | 98 | 1,222 | 0 | 140.24 | 27.70 | 6 | 181.93 | 691 | 232 | 690 | 11 | 130 | 10,121,356 | 49 | 362 | 2,061,609 | 5.99 | 32 | 169 | 0 | 690 | 
| leaf | 1 | 94 | 5,129 | 25,391,526 | 342,564,330 | 94 | 896 | 0 | 141.61 | 27.69 | 6 | 181.36 | 366 | 229 | 366 | 9 | 130 | 9,700,096 | 47 | 4,138 | 1,937,828 | 5.92 | 32 | 170 | 0 | 366 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 192 | 777 | 9,677,708 | 84,395,212 | 192 | 392 | 0 | 31.78 | 12.86 | 5 | 43.72 | 236 | 77 | 236 | 0 | 32 | 1,035,986 | 33 | 25 | 873,000 | 35.07 | 14 | 45 | 0 | 236 | 
| fibonacci_program | 1 | 182 | 904 | 9,708,170 | 74,305,770 | 181 | 648 | 1 | 29.72 | 12.19 | 5 | 37.90 | 517 | 60 | 517 | 0 | 28 | 1,064,416 | 22 | 33 | 627,209 | 38.93 | 11 | 42 | 0 | 516 | 

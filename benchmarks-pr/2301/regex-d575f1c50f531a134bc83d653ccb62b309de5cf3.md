...
|:---|---:|---:|---:|
| Total |  18.55 |  6.29 | 6.29 |
| regex_program |  3.65 |  1.11 |  1.11 |
| leaf |  14.91 |  5.17 |  5.17 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  901.75 |  3,607 |  1,075 |  707 |
...
| `execute_metered_insn_mi/s` |  103.46 | -          |  103.46 |  103.46 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  53.50 |  214 |  65 |  45 |
| `execute_preflight_insn_mi/s` |  30.99 | -          |  32.13 |  28.07 |
| `trace_gen_time_ms   ` |  177.75 |  711 |  211 |  155 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  596.75 |  2,387 |  813 |  445 |
| `main_trace_commit_time_ms` |  52 |  208 |  57 |  50 |
| `generate_perm_trace_time_ms` |  30.50 |  122 |  47 |  21 |
| `perm_trace_commit_time_ms` |  64.16 |  256.66 |  71.31 |  55.33 |
| `quotient_poly_compute_time_ms` |  59.73 |  238.90 |  69.35 |  53.45 |
| `quotient_poly_commit_time_ms` |  15.50 |  62.01 |  17.94 |  13.44 |
| `pcs_opening_time_ms ` |  371 |  1,484 |  580 |  228 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  3,726.75 |  14,907 |  5,175 |  1,943 |
...
| `execute_preflight_insns` |  2,313,071.75 |  9,252,287 |  2,693,955 |  2,073,290 |
| `execute_preflight_time_ms` |  2,007.25 |  8,029 |  4,034 |  393 |
| `execute_preflight_insn_mi/s` |  6.05 | -          |  6.61 |  5.36 |
| `trace_gen_time_ms   ` |  131.75 |  527 |  232 |  92 |
| `memory_finalize_time_ms` |  13.25 |  53 |  23 |  9 |
| `stark_prove_excluding_trace_time_ms` |  1,586.75 |  6,347 |  2,915 |  943 |
| `main_trace_commit_time_ms` |  213 |  852 |  377 |  144 |
| `generate_perm_trace_time_ms` |  88.50 |  354 |  175 |  57 |
| `perm_trace_commit_time_ms` |  357.07 |  1,428.29 |  696.10 |  226.65 |
| `quotient_poly_compute_time_ms` |  250.31 |  1,001.23 |  459.42 |  172.36 |
| `quotient_poly_commit_time_ms` |  54.08 |  216.30 |  105.80 |  30.85 |
| `pcs_opening_time_ms ` |  618.50 |  2,474 |  1,092 |  303 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 5,043 |  | 1 | 1 |  |  |  |  | 
| regex_program |  | 764 |  | 1 | 39 | 4,137,502 | 103.46 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 108 | 1,943 | 32,454,646 | 471,277,034 | 108 | 1,441 | 0 | 195.67 | 48.68 | 6 | 277.10 | 669 | 338 | 669 | 10 | 186 | 13,045,812 | 61 | 393 | 2,411,590 | 6.61 | 51 | 246 | 4 | 669 | 
| leaf | 1 | 92 | 5,175 | 29,451,830 | 403,119,594 | 92 | 1,048 | 0 | 172.36 | 30.98 | 6 | 228.44 | 410 | 287 | 410 | 9 | 145 | 11,789,672 | 57 | 4,034 | 2,073,452 | 6.20 | 38 | 204 | 0 | 410 | 
| leaf | 2 | 95 | 2,755 | 29,451,830 | 403,119,594 | 95 | 943 | 0 | 173.78 | 30.85 | 6 | 226.65 | 303 | 288 | 303 | 11 | 144 | 11,789,672 | 61 | 1,716 | 2,073,290 | 6.02 | 38 | 206 | 0 | 303 | 
| leaf | 3 | 232 | 5,034 | 60,115,460 | 989,416,938 | 232 | 2,915 | 0 | 459.42 | 105.80 | 6 | 696.10 | 1,092 | 872 | 1,092 | 23 | 377 | 24,205,574 | 175 | 1,886 | 2,693,955 | 5.36 | 135 | 572 | 9 | 1,092 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 211 | 1,061 | 23,446,148 | 150,778,428 | 211 | 634 | 0 | 61.88 | 17.94 | 8 | 71.31 | 398 | 97 | 398 | 4 | 57 | 10,899,170 | 24 | 46 | 1,103,000 | 28.07 | 21 | 80 | 0 | 398 | 
| regex_program | 1 | 155 | 707 | 11,598,276 | 128,513,066 | 155 | 445 | 1 | 54.23 | 15.29 | 6 | 65.96 | 228 | 96 | 228 | 0 | 50 | 2,196,106 | 30 | 65 | 1,104,000 | 32.13 | 16 | 70 | 0 | 228 | 
| regex_program | 2 | 162 | 1,075 | 11,579,064 | 128,513,066 | 162 | 813 | 1 | 53.45 | 15.34 | 6 | 64.05 | 580 | 112 | 580 | 0 | 51 | 2,177,334 | 47 | 58 | 1,104,000 | 31.76 | 17 | 69 | 0 | 580 | 
| regex_program | 3 | 183 | 764 | 11,853,872 | 103,456,394 | 183 | 495 | 0 | 69.35 | 13.44 | 7 | 55.33 | 278 | 81 | 278 | 0 | 50 | 2,422,606 | 21 | 45 | 826,502 | 32.02 | 19 | 83 | 0 | 278 | 

...
| ecrecover_program |  0.91 |  0.91 |  0.91 |
| leaf |  5.81 |  5.81 |  5.81 |
...
| `pcs_opening_time_ms ` |  230 |  230 |  230 |  230 |
...
| `execute_preflight_insns` |  4,109,308 |  4,109,308 |  4,109,308 |  4,109,308 |
| `execute_preflight_time_ms` |  734 |  734 |  734 |  734 |
| `execute_preflight_insn_mi/s` |  5.87 | -          |  5.87 |  5.87 |
| `trace_gen_time_ms   ` |  301 |  301 |  301 |  301 |
| `memory_finalize_time_ms` |  28 |  28 |  28 |  28 |
| `stark_prove_excluding_trace_time_ms` |  4,771 |  4,771 |  4,771 |  4,771 |
| `main_trace_commit_time_ms` |  721 |  721 |  721 |  721 |
| `generate_perm_trace_time_ms` |  338 |  338 |  338 |  338 |
| `perm_trace_commit_time_ms` |  1,495.03 |  1,495.03 |  1,495.03 |  1,495.03 |
| `quotient_poly_compute_time_ms` |  820.71 |  820.71 |  820.71 |  820.71 |
| `quotient_poly_commit_time_ms` |  199.15 |  199.15 |  199.15 |  199.15 |
| `pcs_opening_time_ms ` |  1,189 |  1,189 |  1,189 |  1,189 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program |  | 901 |  | 1 | 6 | 122,859 | 19.33 | 0 | 
| leaf | 5,812 |  | 1 | 1 |  |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 301 | 5,807 | 83,385,200 | 1,726,057,962 | 301 | 4,771 | 0 | 820.71 | 199.15 | 6 | 1,495.03 | 1,189 | 1,834 | 1,189 | 28 | 721 | 34,465,046 | 338 | 734 | 4,109,308 | 5.87 | 268 | 1,024 | 14 | 1,189 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 215 | 901 | 11,345,240 | 31,789,298 | 215 | 457 | 0 | 104.90 | 9.13 | 10 | 34.10 | 230 | 74 | 230 | 0 | 37 | 2,263,998 | 32 | 59 | 122,859 | 2.26 | 21 | 114 | 1 | 230 | 

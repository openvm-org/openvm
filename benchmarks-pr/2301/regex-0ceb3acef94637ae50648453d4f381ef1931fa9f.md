...
|:---|---:|---:|---:|
| Total |  18.95 |  6.75 | 6.75 |
| regex_program |  4.20 |  1.23 |  1.23 |
| leaf |  14.75 |  5.51 |  5.51 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,040 |  4,160 |  1,194 |  858 |
...
| `execute_preflight_insn_mi/s` |  30.39 | -          |  31.53 |  27.67 |
| `trace_gen_time_ms   ` |  175.50 |  702 |  210 |  151 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  736 |  2,944 |  888 |  596 |
| `main_trace_commit_time_ms` |  50.75 |  203 |  55 |  49 |
| `generate_perm_trace_time_ms` |  26 |  104 |  32 |  21 |
| `perm_trace_commit_time_ms` |  64.12 |  256.49 |  71.47 |  54.26 |
| `quotient_poly_compute_time_ms` |  59.37 |  237.47 |  70.02 |  53.91 |
| `quotient_poly_commit_time_ms` |  15.47 |  61.87 |  17.50 |  13.04 |
| `pcs_opening_time_ms ` |  516 |  2,064 |  672 |  376 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  3,687 |  14,748 |  5,515 |  1,668 |
...
| `execute_preflight_insns` |  2,313,052 |  9,252,208 |  2,693,773 |  2,073,435 |
| `execute_preflight_time_ms` |  2,078.75 |  8,315 |  4,250 |  402 |
| `execute_preflight_insn_mi/s` |  5.90 | -          |  6.49 |  5.30 |
| `trace_gen_time_ms   ` |  132.75 |  531 |  233 |  94 |
| `memory_finalize_time_ms` |  14.50 |  58 |  26 |  10 |
| `stark_prove_excluding_trace_time_ms` |  1,473.75 |  5,895 |  2,547 |  1,022 |
| `main_trace_commit_time_ms` |  213.25 |  853 |  375 |  145 |
| `generate_perm_trace_time_ms` |  88.25 |  353 |  174 |  56 |
| `perm_trace_commit_time_ms` |  357.44 |  1,429.75 |  699.31 |  226.90 |
| `quotient_poly_compute_time_ms` |  250.64 |  1,002.56 |  458.56 |  173.82 |
| `quotient_poly_commit_time_ms` |  54.36 |  217.45 |  106.97 |  30.35 |
| `pcs_opening_time_ms ` |  504.75 |  2,019 |  724 |  377 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 4,712 |  | 1 | 1 |  |  |  |  | 
| regex_program |  | 959 |  | 1 | 37 | 4,137,502 | 111.53 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 108 | 1,668 | 32,454,646 | 471,277,034 | 108 | 1,157 | 0 | 196.21 | 49.16 | 6 | 276.24 | 377 | 344 | 377 | 12 | 188 | 13,045,812 | 67 | 402 | 2,411,514 | 6.49 | 52 | 247 | 4 | 377 | 
| leaf | 1 | 94 | 5,515 | 29,451,830 | 403,119,594 | 94 | 1,169 | 0 | 173.97 | 30.35 | 6 | 226.90 | 533 | 283 | 533 | 10 | 145 | 11,789,672 | 56 | 4,250 | 2,073,486 | 5.87 | 38 | 205 | 0 | 533 | 
| leaf | 2 | 96 | 2,858 | 29,451,830 | 403,119,594 | 96 | 1,022 | 0 | 173.82 | 30.97 | 6 | 227.30 | 385 | 284 | 385 | 10 | 145 | 11,789,672 | 56 | 1,738 | 2,073,435 | 5.93 | 38 | 206 | 0 | 385 | 
| leaf | 3 | 233 | 4,707 | 60,115,460 | 989,416,938 | 233 | 2,547 | 0 | 458.56 | 106.97 | 6 | 699.31 | 724 | 874 | 724 | 26 | 375 | 24,205,574 | 174 | 1,925 | 2,693,773 | 5.30 | 135 | 572 | 9 | 724 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 210 | 1,194 | 23,446,148 | 150,778,428 | 210 | 768 | 0 | 59.50 | 17.50 | 7 | 71.47 | 539 | 95 | 538 | 4 | 55 | 10,899,170 | 22 | 46 | 1,103,000 | 27.67 | 21 | 77 | 0 | 538 | 
| regex_program | 1 | 151 | 1,149 | 11,598,276 | 128,513,066 | 151 | 888 | 1 | 54.04 | 15.18 | 6 | 64.90 | 672 | 95 | 672 | 0 | 50 | 2,196,106 | 29 | 68 | 1,104,000 | 31.23 | 17 | 69 | 0 | 672 | 
| regex_program | 2 | 162 | 858 | 11,579,064 | 128,513,066 | 162 | 596 | 1 | 53.91 | 16.15 | 6 | 65.86 | 376 | 98 | 376 | 0 | 49 | 2,177,334 | 32 | 59 | 1,104,000 | 31.53 | 17 | 70 | 0 | 376 | 
| regex_program | 3 | 179 | 959 | 11,853,872 | 103,456,394 | 179 | 692 | 0 | 70.02 | 13.04 | 7 | 54.26 | 477 | 80 | 477 | 0 | 49 | 2,422,606 | 21 | 47 | 826,502 | 31.11 | 18 | 84 | 0 | 477 | 

...
|:---|---:|---:|---:|
| Total |  4.36 |  1.21 | 1.21 |
| regex_program |  4.36 |  1.21 |  1.21 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,080.75 |  4,323 |  1,171 |  975 |
...
| `execute_preflight_insn_mi/s` |  31.09 | -          |  32.63 |  27.39 |
| `trace_gen_time_ms   ` |  180.50 |  722 |  213 |  158 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  771.75 |  3,087 |  898 |  629 |
| `main_trace_commit_time_ms` |  52.25 |  209 |  56 |  51 |
| `generate_perm_trace_time_ms` |  28.50 |  114 |  34 |  22 |
| `perm_trace_commit_time_ms` |  65.59 |  262.36 |  73.38 |  56.43 |
| `quotient_poly_compute_time_ms` |  60.33 |  241.30 |  71.18 |  53.99 |
| `quotient_poly_commit_time_ms` |  16.27 |  65.07 |  18.85 |  13.86 |
| `pcs_opening_time_ms ` |  545.25 |  2,181 |  677 |  392 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 1,171 | 1 | 37 | 4,137,502 | 111.50 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 213 | 1,059 | 23,446,148 | 150,778,428 | 213 | 629 | 0 | 60.52 | 18.85 | 7 | 73.38 | 392 | 100 | 391 | 4 | 56 | 10,899,170 | 26 | 47 | 1,103,000 | 27.39 | 22 | 80 | 0 | 391 | 
| regex_program | 1 | 158 | 975 | 11,598,276 | 128,513,066 | 158 | 709 | 1 | 55.61 | 16.20 | 6 | 67.16 | 482 | 102 | 482 | 0 | 51 | 2,196,106 | 34 | 65 | 1,104,000 | 32.58 | 17 | 72 | 0 | 482 | 
| regex_program | 2 | 166 | 1,118 | 11,579,064 | 128,513,066 | 166 | 851 | 1 | 53.99 | 16.17 | 6 | 65.40 | 630 | 98 | 630 | 0 | 51 | 2,177,334 | 32 | 58 | 1,104,000 | 32.63 | 17 | 70 | 0 | 630 | 
| regex_program | 3 | 185 | 1,171 | 11,853,872 | 103,456,394 | 185 | 898 | 0 | 71.18 | 13.86 | 8 | 56.43 | 677 | 83 | 677 | 0 | 51 | 2,422,606 | 22 | 46 | 826,502 | 31.78 | 19 | 86 | 0 | 677 | 

...
|:---|---:|---:|---:|
| Total |  8.66 |  5.19 | 5.19 |
| pairing |  2.30 |  1.30 |  1.30 |
| leaf |  6.37 |  3.88 |  3.88 |
...
| `total_proof_time_ms ` |  1,116 |  2,232 |  1,241 |  991 |
...
| `execute_preflight_insn_mi/s` |  14.64 | -          |  18.17 |  11.10 |
| `trace_gen_time_ms   ` |  185.50 |  371 |  191 |  180 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  741.50 |  1,483 |  786 |  697 |
| `main_trace_commit_time_ms` |  64.50 |  129 |  74 |  55 |
| `generate_perm_trace_time_ms` |  77.50 |  155 |  97 |  58 |
| `perm_trace_commit_time_ms` |  77.12 |  154.25 |  88.92 |  65.32 |
| `quotient_poly_compute_time_ms` |  83.79 |  167.58 |  92.96 |  74.62 |
| `quotient_poly_commit_time_ms` |  16.100 |  33.100 |  18.67 |  15.33 |
| `pcs_opening_time_ms ` |  416.50 |  833 |  448 |  385 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  3,183.50 |  6,367 |  3,885 |  2,482 |
| `main_cells_used     ` |  20,416,836 |  40,833,672 |  20,627,230 |  20,206,442 |
| `total_cells_used    ` |  49,512,028 |  99,024,056 |  50,015,232 |  49,008,824 |
| `execute_preflight_insns` |  2,988,719 |  5,977,438 |  3,050,873 |  2,926,565 |
| `execute_preflight_time_ms` |  1,059.50 |  2,119 |  1,610 |  509 |
| `execute_preflight_insn_mi/s` |  6.50 | -          |  6.50 |  6.50 |
| `trace_gen_time_ms   ` |  168 |  336 |  175 |  161 |
| `memory_finalize_time_ms` |  16 |  32 |  17 |  15 |
| `stark_prove_excluding_trace_time_ms` |  1,954 |  3,908 |  2,112 |  1,796 |
| `main_trace_commit_time_ms` |  297.50 |  595 |  299 |  296 |
| `generate_perm_trace_time_ms` |  120 |  240 |  127 |  113 |
| `perm_trace_commit_time_ms` |  469.33 |  938.67 |  481.76 |  456.90 |
| `quotient_poly_compute_time_ms` |  344.05 |  688.10 |  348.43 |  339.67 |
| `quotient_poly_commit_time_ms` |  70.79 |  141.59 |  74.53 |  67.05 |
| `pcs_opening_time_ms ` |  645.50 |  1,291 |  831 |  460 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 3,888 |  | 1 | 1 |  |  |  |  | 
| pairing |  | 991 |  | 1 | 63 | 1,745,742 | 27.58 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 175 | 2,482 | 50,015,232 | 761,351,658 | 175 | 1,796 | 0 | 348.43 | 74.53 | 6 | 481.76 | 460 | 610 | 459 | 17 | 296 | 20,627,230 | 127 | 509 | 3,050,873 | 6.50 | 82 | 429 | 5 | 459 | 
| leaf | 1 | 161 | 3,885 | 49,008,824 | 761,351,658 | 161 | 2,112 | 0 | 339.67 | 67.05 | 6 | 456.90 | 831 | 571 | 831 | 15 | 299 | 20,206,442 | 113 | 1,610 | 2,926,565 | 6.50 | 80 | 409 | 0 | 831 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 180 | 1,241 | 32,480,114 | 172,558,444 | 180 | 786 | 0 | 92.96 | 18.67 | 8 | 88.92 | 448 | 149 | 448 | 1 | 74 | 15,909,408 | 58 | 107 | 1,149,000 | 11.10 | 27 | 112 | 1 | 448 | 
| pairing | 1 | 191 | 991 | 22,464,232 | 119,958,502 | 191 | 697 | 1 | 74.62 | 15.33 | 8 | 65.32 | 385 | 165 | 384 | 0 | 55 | 9,498,894 | 97 | 62 | 596,742 | 18.17 | 20 | 90 | 1 | 384 | 

...
|:---|---:|---:|---:|
| Total |  8.53 |  4.86 | 4.86 |
| pairing |  2.60 |  1.34 |  1.34 |
| leaf |  5.93 |  3.53 |  3.53 |
...
| `total_proof_time_ms ` |  1,266.50 |  2,533 |  1,272 |  1,261 |
...
| `execute_metered_insn_mi/s` |  27.04 | -          |  27.04 |  27.04 |
| `execute_preflight_insns` |  872,871 |  1,745,742 |  1,149,000 |  596,742 |
| `execute_preflight_time_ms` |  84.50 |  169 |  108 |  61 |
| `execute_preflight_insn_mi/s` |  14.37 | -          |  17.77 |  10.98 |
| `trace_gen_time_ms   ` |  192 |  384 |  197 |  187 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  884 |  1,768 |  972 |  796 |
| `main_trace_commit_time_ms` |  65.50 |  131 |  76 |  55 |
| `generate_perm_trace_time_ms` |  74 |  148 |  104 |  44 |
| `perm_trace_commit_time_ms` |  77.15 |  154.30 |  89.68 |  64.61 |
| `quotient_poly_compute_time_ms` |  84.56 |  169.13 |  92.88 |  76.25 |
| `quotient_poly_commit_time_ms` |  17.13 |  34.25 |  19.09 |  15.16 |
| `pcs_opening_time_ms ` |  560.50 |  1,121 |  652 |  469 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  2,965.50 |  5,931 |  3,527 |  2,404 |
| `main_cells_used     ` |  20,416,836 |  40,833,672 |  20,627,230 |  20,206,442 |
| `total_cells_used    ` |  49,512,028 |  99,024,056 |  50,015,232 |  49,008,824 |
| `execute_preflight_insns` |  2,988,603 |  5,977,206 |  3,050,839 |  2,926,367 |
| `execute_preflight_time_ms` |  1,043.50 |  2,087 |  1,569 |  518 |
| `execute_preflight_insn_mi/s` |  6.46 | -          |  6.52 |  6.40 |
| `trace_gen_time_ms   ` |  162 |  324 |  170 |  154 |
| `memory_finalize_time_ms` |  16 |  32 |  17 |  15 |
| `stark_prove_excluding_trace_time_ms` |  1,758 |  3,516 |  1,801 |  1,715 |
| `main_trace_commit_time_ms` |  299.50 |  599 |  300 |  299 |
| `generate_perm_trace_time_ms` |  111 |  222 |  123 |  99 |
| `perm_trace_commit_time_ms` |  470.96 |  941.93 |  481.46 |  460.47 |
| `quotient_poly_compute_time_ms` |  344.30 |  688.59 |  344.60 |  343.100 |
| `quotient_poly_commit_time_ms` |  70.74 |  141.47 |  73.74 |  67.73 |
| `pcs_opening_time_ms ` |  455.50 |  911 |  526 |  385 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 3,530 |  | 1 | 1 |  |  |  |  | 
| pairing |  | 1,272 |  | 1 | 64 | 1,745,742 | 27.04 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 170 | 2,404 | 50,015,232 | 761,351,658 | 170 | 1,715 | 0 | 343.100 | 73.74 | 6 | 481.46 | 385 | 605 | 384 | 17 | 300 | 20,627,230 | 123 | 518 | 3,050,839 | 6.40 | 83 | 423 | 5 | 384 | 
| leaf | 1 | 154 | 3,527 | 49,008,824 | 761,351,658 | 154 | 1,801 | 0 | 344.60 | 67.73 | 6 | 460.47 | 526 | 561 | 525 | 15 | 299 | 20,206,442 | 99 | 1,569 | 2,926,367 | 6.52 | 80 | 414 | 0 | 525 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 187 | 1,261 | 32,480,114 | 172,558,444 | 187 | 796 | 0 | 92.88 | 19.09 | 9 | 89.68 | 469 | 137 | 469 | 1 | 76 | 15,909,408 | 44 | 108 | 1,149,000 | 10.98 | 27 | 112 | 1 | 469 | 
| pairing | 1 | 197 | 1,272 | 22,464,232 | 119,958,502 | 197 | 972 | 1 | 76.25 | 15.16 | 8 | 64.61 | 652 | 171 | 652 | 0 | 55 | 9,498,894 | 104 | 61 | 596,742 | 17.77 | 21 | 92 | 1 | 652 | 

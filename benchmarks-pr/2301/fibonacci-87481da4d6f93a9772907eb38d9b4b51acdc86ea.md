...
|:---|---:|---:|---:|
| Total |  2.09 |  1.23 | 1.23 |
| fibonacci_program |  2.09 |  1.23 |  1.23 |


| fibonacci_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,041 |  2,082 |  1,219 |  863 |
...
| `execute_metered_insn_mi/s` |  110.83 | -          |  110.83 |  110.83 |
| `execute_preflight_insns` |  750,104.50 |  1,500,209 |  873,000 |  627,209 |
| `execute_preflight_time_ms` |  28.50 |  57 |  32 |  25 |
| `execute_preflight_insn_mi/s` |  38.43 | -          |  40.56 |  36.29 |
| `trace_gen_time_ms   ` |  191 |  382 |  195 |  187 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  716 |  1,432 |  959 |  473 |
| `main_trace_commit_time_ms` |  30.50 |  61 |  33 |  28 |
| `generate_perm_trace_time_ms` |  30 |  60 |  31 |  29 |
| `perm_trace_commit_time_ms` |  41.36 |  82.71 |  43.67 |  39.04 |
| `quotient_poly_compute_time_ms` |  32.45 |  64.90 |  35.14 |  29.76 |
| `quotient_poly_commit_time_ms` |  12.03 |  24.06 |  12.38 |  11.68 |
| `pcs_opening_time_ms ` |  567.50 |  1,135 |  817 |  318 |
...
| --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 1,219 | 1 | 13 | 1,500,209 | 110.83 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 195 | 863 | 9,677,708 | 84,395,212 | 195 | 473 | 0 | 35.14 | 12.38 | 6 | 43.67 | 318 | 73 | 317 | 0 | 33 | 1,035,986 | 29 | 25 | 873,000 | 36.29 | 14 | 48 | 0 | 317 | 
| fibonacci_program | 1 | 187 | 1,219 | 9,708,170 | 74,305,770 | 187 | 959 | 1 | 29.76 | 11.68 | 5 | 39.04 | 817 | 71 | 817 | 0 | 28 | 1,064,416 | 31 | 32 | 627,209 | 40.56 | 11 | 41 | 0 | 817 | 
...
Commit: https://github.com/openvm-org/openvm/commit/87481da4d6f93a9772907eb38d9b4b51acdc86ea
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/20308596458)

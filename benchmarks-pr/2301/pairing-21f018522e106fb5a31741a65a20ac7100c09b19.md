...
|:---|---:|---:|
| Total | <span style='color: red'>(+0 [+32.3%])</span> 2.02 | <span style='color: red'>(+0 [+28.7%])</span> 1.17 |
| pairing | <span style='color: red'>(+0 [+33.7%])</span> 1.96 | <span style='color: red'>(+0 [+30.9%])</span> 1.11 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+247 [+33.7%])</span> 981 | <span style='color: red'>(+494 [+33.7%])</span> 1,962 | <span style='color: red'>(+261 [+30.9%])</span> 1,106 | <span style='color: red'>(+233 [+37.4%])</span> 856 |
...
| `execute_metered_insn_mi/s` | <span style='color: red'>(+0 [+0.1%])</span> 27.53 | -          | <span style='color: red'>(+0 [+0.1%])</span> 27.53 | <span style='color: red'>(+0 [+0.1%])</span> 27.53 |
| `execute_preflight_insns` |  872,871 |  1,745,742 |  1,149,000 |  596,742 |
| `execute_preflight_time_ms` | <span style='color: green'>(-2 [-1.7%])</span> 85 | <span style='color: green'>(-3 [-1.7%])</span> 170 | <span style='color: green'>(-4 [-3.6%])</span> 106 | <span style='color: red'>(+1 [+1.6%])</span> 64 |
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+1 [+5.1%])</span> 14.56 | -          | <span style='color: red'>(+1 [+5.8%])</span> 17.93 | <span style='color: red'>(+0 [+3.9%])</span> 11.19 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+2 [+0.8%])</span> 185.50 | <span style='color: red'>(+3 [+0.8%])</span> 371 | <span style='color: green'>(-2 [-1.1%])</span> 188 | <span style='color: red'>(+5 [+2.8%])</span> 183 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+247 [+69.1%])</span> 604.50 | <span style='color: red'>(+494 [+69.1%])</span> 1,209 | <span style='color: red'>(+425 [+109.8%])</span> 812 | <span style='color: red'>(+69 [+21.0%])</span> 397 |
...
| `generate_perm_trace_time_ms` |  32.50 |  65 | <span style='color: green'>(-1 [-2.8%])</span> 35 | <span style='color: red'>(+1 [+3.4%])</span> 30 |
| `perm_trace_commit_time_ms` | <span style='color: green'>(-2 [-1.9%])</span> 75.74 | <span style='color: green'>(-3 [-1.9%])</span> 151.47 | <span style='color: green'>(-1 [-1.7%])</span> 88.24 | <span style='color: green'>(-2 [-2.4%])</span> 63.23 |
| `quotient_poly_compute_time_ms` | <span style='color: green'>(-1 [-1.6%])</span> 82.25 | <span style='color: green'>(-3 [-1.6%])</span> 164.50 | <span style='color: green'>(-1 [-1.3%])</span> 91.76 | <span style='color: green'>(-2 [-2.1%])</span> 72.73 |
| `quotient_poly_commit_time_ms` | <span style='color: green'>(-1 [-4.1%])</span> 16.81 | <span style='color: green'>(-1 [-4.1%])</span> 33.62 | <span style='color: green'>(-1 [-6.4%])</span> 18.46 | <span style='color: green'>(-0 [-1.1%])</span> 15.17 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+250 [+323.2%])</span> 328 | <span style='color: red'>(+501 [+323.2%])</span> 656 | <span style='color: red'>(+486 [+565.1%])</span> 572 | <span style='color: red'>(+15 [+21.7%])</span> 84 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 1,106 | 1 | 63 | 1,745,742 | 27.53 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 183 | 856 | 32,480,114 | 172,558,444 | 183 | 397 | 0 | 91.76 | 18.46 | 9 | 88.24 | 84 | 126 | 84 | 1 | 74 | 15,909,408 | 35 | 106 | 1,149,000 | 11.19 | 27 | 111 | 1 | 84 | 
| pairing | 1 | 188 | 1,106 | 22,464,232 | 119,958,502 | 188 | 812 | 1 | 72.73 | 15.17 | 9 | 63.23 | 572 | 97 | 572 | 0 | 53 | 9,498,894 | 30 | 64 | 596,742 | 17.93 | 21 | 88 | 1 | 572 | 

...
|:---|---:|---:|---:|
| Total |  5.51 |  3.48 | 3.48 |
| fibonacci_program |  1.63 |  1.02 |  1.02 |
| leaf |  3.88 |  2.46 |  2.46 |
...
| `total_proof_time_ms ` |  808 |  1,616 |  1,007 |  609 |
...
| `execute_metered_insn_mi/s` |  110.77 | -          |  110.77 |  110.77 |
| `execute_preflight_insns` |  750,104.50 |  1,500,209 |  873,000 |  627,209 |
| `execute_preflight_time_ms` |  29.50 |  59 |  33 |  26 |
| `execute_preflight_insn_mi/s` |  36.66 | -          |  38.71 |  34.61 |
| `trace_gen_time_ms   ` |  190.50 |  381 |  196 |  185 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  482.50 |  965 |  615 |  350 |
| `main_trace_commit_time_ms` |  30.50 |  61 |  33 |  28 |
| `generate_perm_trace_time_ms` |  21 |  42 |  29 |  13 |
| `perm_trace_commit_time_ms` |  41.43 |  82.86 |  43.54 |  39.33 |
| `quotient_poly_compute_time_ms` |  32.34 |  64.69 |  35.03 |  29.65 |
| `quotient_poly_commit_time_ms` |  12.09 |  24.18 |  12.56 |  11.62 |
| `pcs_opening_time_ms ` |  342.50 |  685 |  459 |  226 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,941.50 |  3,883 |  2,460 |  1,423 |
| `main_cells_used     ` |  9,910,726 |  19,821,452 |  10,121,356 |  9,700,096 |
| `total_cells_used    ` |  25,895,192 |  51,790,384 |  26,398,858 |  25,391,526 |
| `execute_preflight_insns` |  1,999,738.50 |  3,999,477 |  2,061,723 |  1,937,754 |
| `execute_preflight_time_ms` |  935 |  1,870 |  1,501 |  369 |
| `execute_preflight_insn_mi/s` |  6.01 | -          |  6.01 |  6.01 |
| `trace_gen_time_ms   ` |  94.50 |  189 |  98 |  91 |
| `memory_finalize_time_ms` |  9 |  18 |  9 |  9 |
| `stark_prove_excluding_trace_time_ms` |  910.50 |  1,821 |  954 |  867 |
| `main_trace_commit_time_ms` |  132.50 |  265 |  133 |  132 |
| `generate_perm_trace_time_ms` |  49.50 |  99 |  53 |  46 |
| `perm_trace_commit_time_ms` |  184.98 |  369.97 |  185.14 |  184.83 |
| `quotient_poly_compute_time_ms` |  146.07 |  292.13 |  146.42 |  145.71 |
| `quotient_poly_commit_time_ms` |  28.94 |  57.89 |  29.25 |  28.64 |
| `pcs_opening_time_ms ` |  364.50 |  729 |  405 |  324 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program |  | 609 |  | 1 | 13 | 1,500,209 | 110.77 | 0 | 
| leaf | 2,462 |  | 1 | 1 |  |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 98 | 1,423 | 26,398,858 | 342,564,330 | 98 | 954 | 0 | 145.71 | 29.25 | 6 | 185.14 | 405 | 239 | 405 | 9 | 133 | 10,121,356 | 53 | 369 | 2,061,723 | 6.01 | 32 | 176 | 0 | 405 | 
| leaf | 1 | 91 | 2,460 | 25,391,526 | 342,564,330 | 91 | 867 | 0 | 146.42 | 28.64 | 6 | 184.83 | 324 | 232 | 324 | 9 | 132 | 9,700,096 | 46 | 1,501 | 1,937,754 | 6.01 | 32 | 176 | 0 | 324 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 196 | 1,007 | 9,677,708 | 84,395,212 | 196 | 615 | 0 | 35.03 | 12.56 | 6 | 43.54 | 459 | 73 | 459 | 0 | 33 | 1,035,986 | 29 | 26 | 873,000 | 34.61 | 14 | 48 | 0 | 459 | 
| fibonacci_program | 1 | 185 | 609 | 9,708,170 | 74,305,770 | 185 | 350 | 1 | 29.65 | 11.62 | 5 | 39.33 | 226 | 53 | 226 | 0 | 28 | 1,064,416 | 13 | 33 | 627,209 | 38.71 | 11 | 41 | 0 | 226 | 

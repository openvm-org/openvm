...
|:---|---:|---:|
| Total | <span style='color: red'>(+1 [+33.8%])</span> 2.02 | <span style='color: red'>(+0 [+27.8%])</span> 1.17 |
| pairing | <span style='color: red'>(+1 [+35.5%])</span> 1.96 | <span style='color: red'>(+0 [+30.2%])</span> 1.10 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+256 [+35.5%])</span> 978.50 | <span style='color: red'>(+513 [+35.5%])</span> 1,957 | <span style='color: red'>(+255 [+30.2%])</span> 1,099 | <span style='color: red'>(+258 [+43.0%])</span> 858 |
...
| `execute_metered_insn_mi/s` | <span style='color: red'>(+0 [+1.6%])</span> 25.61 | -          | <span style='color: red'>(+0 [+1.6%])</span> 25.61 | <span style='color: red'>(+0 [+1.6%])</span> 25.61 |
...
| `execute_preflight_insn_mi/s` | <span style='color: green'>(-0 [-0.7%])</span> 14.54 | -          | <span style='color: green'>(-0 [-0.8%])</span> 18.25 | <span style='color: green'>(-0 [-0.6%])</span> 10.83 |
| `trace_gen_time_ms   ` | <span style='color: green'>(-1 [-0.5%])</span> 185 | <span style='color: green'>(-2 [-0.5%])</span> 370 |  192 | <span style='color: green'>(-2 [-1.1%])</span> 178 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+255 [+73.6%])</span> 601.50 | <span style='color: red'>(+510 [+73.6%])</span> 1,203 | <span style='color: red'>(+419 [+108.5%])</span> 805 | <span style='color: red'>(+91 [+29.6%])</span> 398 |
...
| `perm_trace_commit_time_ms` | <span style='color: green'>(-1 [-1.1%])</span> 76.16 | <span style='color: green'>(-2 [-1.1%])</span> 152.31 | <span style='color: green'>(-1 [-0.6%])</span> 88.75 | <span style='color: green'>(-1 [-1.9%])</span> 63.56 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+1 [+1.7%])</span> 84.21 | <span style='color: red'>(+3 [+1.7%])</span> 168.43 | <span style='color: red'>(+1 [+1.6%])</span> 93.36 | <span style='color: red'>(+1 [+1.8%])</span> 75.07 |
| `quotient_poly_commit_time_ms` | <span style='color: green'>(-1 [-3.8%])</span> 16.97 | <span style='color: green'>(-1 [-3.8%])</span> 33.94 | <span style='color: green'>(-1 [-3.2%])</span> 19.17 | <span style='color: green'>(-1 [-4.5%])</span> 14.78 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+256 [+378.5%])</span> 323 | <span style='color: red'>(+511 [+378.5%])</span> 646 | <span style='color: red'>(+494 [+715.9%])</span> 563 | <span style='color: red'>(+17 [+25.8%])</span> 83 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 1,099 | 1 | 68 | 1,745,742 | 25.61 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 178 | 858 | 32,480,114 | 172,558,444 | 178 | 398 | 0 | 93.36 | 19.17 | 8 | 88.75 | 83 | 127 | 82 | 1 | 75 | 15,909,408 | 35 | 109 | 1,149,000 | 10.83 | 27 | 113 | 1 | 82 | 
| pairing | 1 | 192 | 1,099 | 22,464,232 | 119,958,502 | 192 | 805 | 1 | 75.07 | 14.78 | 8 | 63.56 | 563 | 97 | 562 | 0 | 54 | 9,498,894 | 30 | 60 | 596,742 | 18.25 | 21 | 90 | 1 | 562 | 

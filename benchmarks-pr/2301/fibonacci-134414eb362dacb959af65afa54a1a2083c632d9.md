...
|:---|---:|---:|---:|
| Total |  2.39 |  1.52 | 1.52 |
| fibonacci_program |  2.39 |  1.52 |  1.52 |


| fibonacci_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,187 |  2,374 |  1,503 |  871 |
...
| `execute_preflight_insn_mi/s` |  38.24 | -          |  40.30 |  36.19 |
| `trace_gen_time_ms   ` |  188.50 |  377 |  194 |  183 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  864.50 |  1,729 |  1,115 |  614 |
| `main_trace_commit_time_ms` |  30 |  60 |  32 |  28 |
| `generate_perm_trace_time_ms` |  25 |  50 |  29 |  21 |
| `perm_trace_commit_time_ms` |  41.50 |  83 |  44.31 |  38.69 |
| `quotient_poly_compute_time_ms` |  30.66 |  61.31 |  31.87 |  29.44 |
| `quotient_poly_commit_time_ms` |  12.33 |  24.67 |  13.12 |  11.55 |
| `pcs_opening_time_ms ` |  723 |  1,446 |  963 |  483 |
...
| --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 871 | 1 | 13 | 1,500,209 | 112.11 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 194 | 1,503 | 9,677,708 | 84,395,212 | 194 | 1,115 | 0 | 31.87 | 13.12 | 6 | 44.31 | 963 | 73 | 963 | 0 | 32 | 1,035,986 | 29 | 25 | 873,000 | 36.19 | 14 | 45 | 0 | 963 | 
| fibonacci_program | 1 | 183 | 871 | 9,708,170 | 74,305,770 | 183 | 614 | 1 | 29.44 | 11.55 | 5 | 38.69 | 483 | 60 | 483 | 0 | 28 | 1,064,416 | 21 | 32 | 627,209 | 40.30 | 11 | 41 | 0 | 483 | 

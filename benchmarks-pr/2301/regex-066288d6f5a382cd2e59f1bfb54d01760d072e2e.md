...
|:---|---:|---:|---:|
| Total |  15.63 |  5.81 | 5.81 |
| regex_program |  4.53 |  1.55 |  1.55 |
| leaf |  11.10 |  4.26 |  4.26 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,124.75 |  4,499 |  1,515 |  854 |
...
| `execute_preflight_insn_mi/s` |  30.25 | -          |  31.27 |  27.59 |
| `trace_gen_time_ms   ` |  170 |  680 |  182 |  154 |
| `memory_finalize_time_ms` |  1.25 |  5 |  5 |  0 |
| `stark_prove_excluding_trace_time_ms` |  826.25 |  3,305 |  1,251 |  558 |
| `main_trace_commit_time_ms` |  51.50 |  206 |  58 |  49 |
| `generate_perm_trace_time_ms` |  28.50 |  114 |  35 |  21 |
| `perm_trace_commit_time_ms` |  63.63 |  254.51 |  69.86 |  54.33 |
| `quotient_poly_compute_time_ms` |  59.17 |  236.69 |  72.03 |  53.65 |
| `quotient_poly_commit_time_ms` |  15.80 |  63.21 |  18.98 |  13.66 |
| `pcs_opening_time_ms ` |  604 |  2,416 |  1,031 |  327 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  2,774.75 |  11,099 |  4,261 |  1,782 |
...
| `execute_preflight_insns` |  2,313,093 |  9,252,372 |  2,693,928 |  2,073,493 |
| `execute_preflight_time_ms` |  1,103.75 |  4,415 |  1,479 |  397 |
| `execute_preflight_insn_mi/s` |  6.09 | -          |  6.59 |  5.52 |
| `trace_gen_time_ms   ` |  125.75 |  503 |  208 |  93 |
| `memory_finalize_time_ms` |  12 |  48 |  22 |  8 |
| `stark_prove_excluding_trace_time_ms` |  1,543.25 |  6,173 |  2,701 |  1,094 |
| `main_trace_commit_time_ms` |  214 |  856 |  379 |  144 |
| `generate_perm_trace_time_ms` |  87.50 |  350 |  174 |  55 |
| `perm_trace_commit_time_ms` |  357.23 |  1,428.92 |  700.100 |  220.53 |
| `quotient_poly_compute_time_ms` |  254.06 |  1,016.24 |  464.64 |  175.42 |
| `quotient_poly_commit_time_ms` |  55.06 |  220.23 |  108.16 |  30.68 |
| `pcs_opening_time_ms ` |  570.50 |  2,282 |  864 |  457 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 4,264 |  | 1 | 1 |  |  |  |  | 
| regex_program |  | 1,174 |  | 1 | 35 | 4,137,502 | 115.15 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 107 | 1,782 | 32,454,646 | 471,277,034 | 107 | 1,276 | 0 | 200.54 | 50.71 | 6 | 278.95 | 490 | 344 | 490 | 9 | 188 | 13,045,812 | 65 | 397 | 2,411,415 | 6.59 | 52 | 252 | 5 | 490 | 
| leaf | 1 | 93 | 2,668 | 29,451,830 | 403,119,594 | 93 | 1,094 | 0 | 175.42 | 30.68 | 6 | 228.44 | 457 | 284 | 457 | 9 | 144 | 11,789,672 | 55 | 1,479 | 2,073,493 | 6.13 | 38 | 207 | 0 | 457 | 
| leaf | 2 | 95 | 2,388 | 29,451,830 | 403,119,594 | 95 | 1,102 | 0 | 175.63 | 30.68 | 6 | 220.53 | 471 | 278 | 470 | 8 | 145 | 11,789,672 | 56 | 1,189 | 2,073,536 | 6.12 | 38 | 207 | 0 | 470 | 
| leaf | 3 | 208 | 4,261 | 60,115,460 | 989,416,938 | 208 | 2,701 | 0 | 464.64 | 108.16 | 6 | 700.100 | 864 | 876 | 864 | 22 | 379 | 24,205,574 | 174 | 1,350 | 2,693,928 | 5.52 | 136 | 580 | 9 | 864 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 181 | 956 | 23,446,148 | 150,778,428 | 181 | 558 | 0 | 56.42 | 18.98 | 7 | 69.86 | 327 | 96 | 327 | 5 | 58 | 10,899,170 | 25 | 47 | 1,103,000 | 27.59 | 22 | 76 | 0 | 327 | 
| regex_program | 1 | 154 | 854 | 11,598,276 | 128,513,066 | 154 | 592 | 1 | 53.65 | 15.30 | 6 | 64.47 | 371 | 100 | 371 | 0 | 50 | 2,196,106 | 35 | 67 | 1,104,000 | 31.27 | 17 | 69 | 0 | 371 | 
| regex_program | 2 | 163 | 1,515 | 11,579,064 | 128,513,066 | 163 | 1,251 | 1 | 54.60 | 15.28 | 6 | 65.86 | 1,031 | 99 | 1,030 | 0 | 49 | 2,177,334 | 33 | 60 | 1,104,000 | 30.97 | 16 | 70 | 0 | 1,030 | 
| regex_program | 3 | 182 | 1,174 | 11,853,872 | 103,456,394 | 182 | 904 | 0 | 72.03 | 13.66 | 7 | 54.33 | 687 | 80 | 687 | 0 | 49 | 2,422,606 | 21 | 46 | 826,502 | 31.19 | 18 | 86 | 0 | 687 | 

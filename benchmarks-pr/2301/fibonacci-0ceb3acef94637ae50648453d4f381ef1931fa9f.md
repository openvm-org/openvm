...
|:---|---:|---:|---:|
| Total |  8.74 |  6.31 | 6.31 |
| fibonacci_program |  1.55 |  0.89 |  0.89 |
| leaf |  7.19 |  5.42 |  5.42 |
...
| `total_proof_time_ms ` |  767.50 |  1,535 |  877 |  658 |
...
| `execute_metered_insn_mi/s` |  112.32 | -          |  112.32 |  112.32 |
| `execute_preflight_insns` |  750,104.50 |  1,500,209 |  873,000 |  627,209 |
| `execute_preflight_time_ms` |  29.50 |  59 |  33 |  26 |
| `execute_preflight_insn_mi/s` |  36.50 | -          |  38.49 |  34.50 |
| `trace_gen_time_ms   ` |  188.50 |  377 |  193 |  184 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  445 |  890 |  490 |  400 |
| `main_trace_commit_time_ms` |  30.50 |  61 |  33 |  28 |
| `generate_perm_trace_time_ms` |  24.50 |  49 |  28 |  21 |
| `perm_trace_commit_time_ms` |  40.84 |  81.67 |  43.51 |  38.16 |
| `quotient_poly_compute_time_ms` |  31.20 |  62.40 |  34.67 |  27.73 |
| `quotient_poly_commit_time_ms` |  12.40 |  24.79 |  12.45 |  12.34 |
| `pcs_opening_time_ms ` |  303 |  606 |  336 |  270 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  3,594.50 |  7,189 |  5,423 |  1,766 |
| `main_cells_used     ` |  9,910,726 |  19,821,452 |  10,121,356 |  9,700,096 |
| `total_cells_used    ` |  25,895,192 |  51,790,384 |  26,398,858 |  25,391,526 |
| `execute_preflight_insns` |  1,999,705.50 |  3,999,411 |  2,061,587 |  1,937,824 |
| `execute_preflight_time_ms` |  2,171 |  4,342 |  3,993 |  349 |
| `execute_preflight_insn_mi/s` |  5.91 | -          |  6.18 |  5.64 |
| `trace_gen_time_ms   ` |  94.50 |  189 |  96 |  93 |
| `memory_finalize_time_ms` |  10 |  20 |  11 |  9 |
| `stark_prove_excluding_trace_time_ms` |  1,328 |  2,656 |  1,336 |  1,320 |
| `main_trace_commit_time_ms` |  132 |  264 |  132 |  132 |
| `generate_perm_trace_time_ms` |  57 |  114 |  58 |  56 |
| `perm_trace_commit_time_ms` |  183.34 |  366.69 |  183.71 |  182.98 |
| `quotient_poly_compute_time_ms` |  145.64 |  291.29 |  146.22 |  145.06 |
| `quotient_poly_commit_time_ms` |  28.64 |  57.29 |  29.22 |  28.07 |
| `pcs_opening_time_ms ` |  777.50 |  1,555 |  783 |  772 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program |  | 658 |  | 1 | 13 | 1,500,209 | 112.32 | 0 | 
| leaf | 5,426 |  | 1 | 1 |  |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 96 | 1,766 | 26,398,858 | 342,564,330 | 96 | 1,320 | 0 | 145.06 | 28.07 | 6 | 182.98 | 772 | 240 | 772 | 9 | 132 | 10,121,356 | 56 | 349 | 2,061,587 | 6.18 | 32 | 174 | 0 | 772 | 
| leaf | 1 | 93 | 5,423 | 25,391,526 | 342,564,330 | 93 | 1,336 | 0 | 146.22 | 29.22 | 6 | 183.71 | 783 | 243 | 783 | 11 | 132 | 9,700,096 | 58 | 3,993 | 1,937,824 | 5.64 | 32 | 176 | 0 | 783 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 193 | 877 | 9,677,708 | 84,395,212 | 193 | 490 | 0 | 34.67 | 12.45 | 6 | 43.51 | 336 | 72 | 335 | 0 | 33 | 1,035,986 | 28 | 26 | 873,000 | 34.50 | 14 | 47 | 0 | 335 | 
| fibonacci_program | 1 | 184 | 658 | 9,708,170 | 74,305,770 | 184 | 400 | 1 | 27.73 | 12.34 | 5 | 38.16 | 270 | 60 | 270 | 0 | 28 | 1,064,416 | 21 | 33 | 627,209 | 38.49 | 11 | 40 | 0 | 270 | 

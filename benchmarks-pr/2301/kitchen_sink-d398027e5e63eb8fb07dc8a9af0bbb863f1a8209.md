...
|:---|---:|---:|---:|
| Total |  16.18 |  12.21 | 12.21 |
| kitchen_sink |  3.09 |  1.90 |  1.90 |
| leaf |  10.23 |  7.45 |  7.45 |
| internal.0 |  2.86 |  2.86 |  2.86 |


| kitchen_sink |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,540.50 |  3,081 |  1,892 |  1,189 |
...
| `execute_metered_insn_mi/s` |  21.26 | -          |  21.26 |  21.26 |
| `execute_preflight_insns` |  77,381.50 |  154,763 |  121,000 |  33,763 |
| `execute_preflight_time_ms` |  115 |  230 |  135 |  95 |
| `execute_preflight_insn_mi/s` |  8.45 | -          |  11.29 |  5.61 |
| `trace_gen_time_ms   ` |  135 |  270 |  140 |  130 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  1,198 |  2,396 |  1,474 |  922 |
| `main_trace_commit_time_ms` |  191.50 |  383 |  203 |  180 |
| `generate_perm_trace_time_ms` |  99 |  198 |  150 |  48 |
| `perm_trace_commit_time_ms` |  80.06 |  160.13 |  95.15 |  64.98 |
| `quotient_poly_compute_time_ms` |  376.39 |  752.78 |  459.58 |  293.20 |
| `quotient_poly_commit_time_ms` |  9.39 |  18.78 |  10.27 |  8.52 |
| `pcs_opening_time_ms ` |  423 |  846 |  527 |  319 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  5,117 |  10,234 |  7,450 |  2,784 |
...
| `execute_preflight_insns` |  6,288,702 |  12,577,404 |  9,308,305 |  3,269,099 |
| `execute_preflight_time_ms` |  1,952 |  3,904 |  2,496 |  1,408 |
| `execute_preflight_insn_mi/s` |  5.79 | -          |  5.88 |  5.70 |
| `trace_gen_time_ms   ` |  408.50 |  817 |  597 |  220 |
| `memory_finalize_time_ms` |  30 |  60 |  38 |  22 |
| `stark_prove_excluding_trace_time_ms` |  2,754.50 |  5,509 |  4,355 |  1,154 |
| `main_trace_commit_time_ms` |  442.50 |  885 |  731 |  154 |
| `generate_perm_trace_time_ms` |  224 |  448 |  399 |  49 |
| `perm_trace_commit_time_ms` |  928.91 |  1,857.83 |  1,610.11 |  247.72 |
| `quotient_poly_compute_time_ms` |  346.91 |  693.82 |  522.100 |  170.83 |
| `quotient_poly_commit_time_ms` |  130.38 |  260.75 |  230.34 |  30.41 |
| `pcs_opening_time_ms ` |  666.50 |  1,333 |  835 |  498 |

| internal.0 |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  2,861 |  2,861 |  2,861 |  2,861 |
| `main_cells_used     ` |  20,592,928 |  20,592,928 |  20,592,928 |  20,592,928 |
| `total_cells_used    ` |  43,709,890 |  43,709,890 |  43,709,890 |  43,709,890 |
| `execute_preflight_insns` |  4,041,413 |  4,041,413 |  4,041,413 |  4,041,413 |
| `execute_preflight_time_ms` |  1,533 |  1,533 |  1,533 |  1,533 |
| `execute_preflight_insn_mi/s` |  5.94 | -          |  5.94 |  5.94 |
| `trace_gen_time_ms   ` |  159 |  159 |  159 |  159 |
| `memory_finalize_time_ms` |  15 |  15 |  15 |  15 |
| `stark_prove_excluding_trace_time_ms` |  1,167 |  1,167 |  1,167 |  1,167 |
| `main_trace_commit_time_ms` |  255 |  255 |  255 |  255 |
| `generate_perm_trace_time_ms` |  46 |  46 |  46 |  46 |
| `perm_trace_commit_time_ms` |  188.57 |  188.57 |  188.57 |  188.57 |
| `quotient_poly_compute_time_ms` |  284.03 |  284.03 |  284.03 |  284.03 |
| `quotient_poly_commit_time_ms` |  74.99 |  74.99 |  74.99 |  74.99 |
| `pcs_opening_time_ms ` |  314 |  314 |  314 |  314 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal.0 |  | 2,867 |  | 3 | 2 |  |  |  |  | 
| kitchen_sink |  |  | 1,189 |  | 1 | 7 | 154,763 | 21.26 | 0 | 
| leaf | 2,789 |  |  | 1 | 1 |  |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal.0 | 0 | 159 | 2,861 | 43,709,890 | 732,015,074 | 159 | 1,167 | 0 | 284.03 | 74.99 | 6 | 188.57 | 314 | 235 | 314 | 15 | 255 | 20,592,928 | 46 | 1,533 | 4,041,413 | 5.94 | 44 | 361 | 0 | 314 | 
| leaf | 0 | 597 | 7,450 | 193,614,318 | 3,758,099,946 | 597 | 4,355 | 0 | 522.100 | 230.34 | 7 | 1,610.11 | 835 | 2,010 | 834 | 38 | 731 | 83,649,940 | 399 | 2,496 | 9,308,305 | 5.70 | 205 | 777 | 35 | 834 | 
| leaf | 1 | 220 | 2,784 | 93,232,594 | 1,225,346,538 | 220 | 1,154 | 0 | 170.83 | 30.41 | 6 | 247.72 | 498 | 298 | 498 | 22 | 154 | 41,597,560 | 49 | 1,408 | 3,269,099 | 5.88 | 43 | 202 | 0 | 498 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| kitchen_sink | 0 | 140 | 1,892 | 39,702,956 | 760,599,754 | 140 | 1,474 | 0 | 459.58 | 10.27 | 17 | 95.15 | 527 | 271 | 527 | 0 | 203 | 10,085,858 | 150 | 135 | 121,000 | 11.29 | 61 | 470 | 3 | 527 | 
| kitchen_sink | 1 | 130 | 1,189 | 36,350,580 | 747,143,466 | 130 | 922 | 0 | 293.20 | 8.52 | 9 | 64.98 | 319 | 119 | 319 | 0 | 180 | 8,253,090 | 48 | 95 | 33,763 | 5.61 | 29 | 302 | 1 | 319 | 

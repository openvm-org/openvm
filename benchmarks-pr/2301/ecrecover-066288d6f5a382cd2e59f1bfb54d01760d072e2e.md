...
| ecrecover_program |  1.08 |  1.08 |  1.08 |
| leaf |  5.45 |  5.45 |  5.45 |
...
| `execute_preflight_insns` |  4,109,213 |  4,109,213 |  4,109,213 |  4,109,213 |
| `execute_preflight_time_ms` |  725 |  725 |  725 |  725 |
| `execute_preflight_insn_mi/s` |  5.91 | -          |  5.91 |  5.91 |
| `trace_gen_time_ms   ` |  304 |  304 |  304 |  304 |
| `memory_finalize_time_ms` |  25 |  25 |  25 |  25 |
| `stark_prove_excluding_trace_time_ms` |  4,423 |  4,423 |  4,423 |  4,423 |
| `main_trace_commit_time_ms` |  720 |  720 |  720 |  720 |
| `generate_perm_trace_time_ms` |  342 |  342 |  342 |  342 |
| `perm_trace_commit_time_ms` |  1,483.72 |  1,483.72 |  1,483.72 |  1,483.72 |
| `quotient_poly_compute_time_ms` |  817.34 |  817.34 |  817.34 |  817.34 |
| `quotient_poly_commit_time_ms` |  200.24 |  200.24 |  200.24 |  200.24 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program |  | 1,078 |  | 1 | 6 | 122,859 | 19.93 | 0 | 
| leaf | 5,460 |  | 1 | 1 |  |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 304 | 5,454 | 83,385,200 | 1,726,057,962 | 304 | 4,423 | 0 | 817.34 | 200.24 | 6 | 1,483.72 | 852 | 1,826 | 852 | 25 | 720 | 34,465,046 | 342 | 725 | 4,109,213 | 5.91 | 267 | 1,022 | 13 | 852 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 215 | 1,078 | 11,344,654 | 31,789,298 | 215 | 631 | 0 | 104.81 | 9.12 | 10 | 34.07 | 403 | 76 | 403 | 0 | 37 | 2,262,772 | 34 | 60 | 122,859 | 2.19 | 21 | 114 | 1 | 403 | 

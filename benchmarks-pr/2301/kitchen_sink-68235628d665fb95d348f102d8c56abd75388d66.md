...
|:---|---:|---:|---:|
| Total |  16.28 |  12.08 | 12.08 |
| kitchen_sink |  3.11 |  1.81 |  1.81 |
| leaf |  10.21 |  7.31 |  7.31 |
| internal.0 |  2.96 |  2.96 |  2.96 |


| kitchen_sink |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,551 |  3,102 |  1,804 |  1,298 |
...
| `execute_metered_insn_mi/s` |  21.19 | -          |  21.19 |  21.19 |
| `execute_preflight_insns` |  77,381.50 |  154,763 |  121,000 |  33,763 |
| `execute_preflight_time_ms` |  119.50 |  239 |  141 |  98 |
| `execute_preflight_insn_mi/s` |  8.04 | -          |  10.75 |  5.34 |
| `trace_gen_time_ms   ` |  134.50 |  269 |  139 |  130 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  1,204 |  2,408 |  1,379 |  1,029 |
| `main_trace_commit_time_ms` |  193 |  386 |  209 |  177 |
| `generate_perm_trace_time_ms` |  95.50 |  191 |  147 |  44 |
| `perm_trace_commit_time_ms` |  80.26 |  160.52 |  95.90 |  64.62 |
| `quotient_poly_compute_time_ms` |  372.74 |  745.47 |  453.29 |  292.18 |
| `quotient_poly_commit_time_ms` |  9.39 |  18.78 |  10.26 |  8.52 |
| `pcs_opening_time_ms ` |  436 |  872 |  437 |  435 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  5,107.50 |  10,215 |  7,310 |  2,905 |
...
| `execute_preflight_insns` |  6,288,703.50 |  12,577,407 |  9,308,284 |  3,269,123 |
| `execute_preflight_time_ms` |  1,983 |  3,966 |  2,531 |  1,435 |
| `execute_preflight_insn_mi/s` |  5.74 | -          |  5.78 |  5.69 |
| `trace_gen_time_ms   ` |  410.50 |  821 |  602 |  219 |
| `memory_finalize_time_ms` |  29 |  58 |  37 |  21 |
| `stark_prove_excluding_trace_time_ms` |  2,712 |  5,424 |  4,175 |  1,249 |
| `main_trace_commit_time_ms` |  445 |  890 |  734 |  156 |
| `generate_perm_trace_time_ms` |  225 |  450 |  392 |  58 |
| `perm_trace_commit_time_ms` |  921.26 |  1,842.52 |  1,591.55 |  250.97 |
| `quotient_poly_compute_time_ms` |  348.12 |  696.24 |  523.62 |  172.62 |
| `quotient_poly_commit_time_ms` |  128.86 |  257.73 |  227.24 |  30.49 |
| `pcs_opening_time_ms ` |  629.50 |  1,259 |  682 |  577 |

| internal.0 |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  2,956 |  2,956 |  2,956 |  2,956 |
| `main_cells_used     ` |  20,592,928 |  20,592,928 |  20,592,928 |  20,592,928 |
| `total_cells_used    ` |  43,709,890 |  43,709,890 |  43,709,890 |  43,709,890 |
| `execute_preflight_insns` |  4,041,492 |  4,041,492 |  4,041,492 |  4,041,492 |
| `execute_preflight_time_ms` |  1,550 |  1,550 |  1,550 |  1,550 |
| `execute_preflight_insn_mi/s` |  5.82 | -          |  5.82 |  5.82 |
...
| `quotient_poly_compute_time_ms` |  284.29 |  284.29 |  284.29 |  284.29 |
| `quotient_poly_commit_time_ms` |  74.75 |  74.75 |  74.75 |  74.75 |
| `pcs_opening_time_ms ` |  391 |  391 |  391 |  391 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal.0 |  | 2,961 |  | 3 | 2 |  |  |  |  | 
| kitchen_sink |  |  | 1,298 |  | 1 | 7 | 154,763 | 21.19 | 0 | 
| leaf | 2,909 |  |  | 1 | 1 |  |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal.0 | 0 | 157 | 2,956 | 43,709,890 | 732,015,074 | 157 | 1,247 | 0 | 284.29 | 74.75 | 5 | 189.67 | 391 | 234 | 391 | 15 | 259 | 20,592,928 | 44 | 1,550 | 4,041,492 | 5.82 | 44 | 361 | 0 | 391 | 
| leaf | 0 | 602 | 7,310 | 193,614,318 | 3,758,099,946 | 602 | 4,175 | 0 | 523.62 | 227.24 | 7 | 1,591.55 | 682 | 1,984 | 682 | 37 | 734 | 83,649,940 | 392 | 2,531 | 9,308,284 | 5.69 | 203 | 774 | 34 | 682 | 
| leaf | 1 | 219 | 2,905 | 93,232,594 | 1,225,346,538 | 219 | 1,249 | 0 | 172.62 | 30.49 | 6 | 250.97 | 577 | 310 | 577 | 21 | 156 | 41,597,560 | 58 | 1,435 | 3,269,123 | 5.78 | 42 | 204 | 0 | 577 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| kitchen_sink | 0 | 139 | 1,804 | 39,702,956 | 760,599,754 | 139 | 1,379 | 0 | 453.29 | 10.26 | 17 | 95.90 | 437 | 267 | 437 | 0 | 209 | 10,085,858 | 147 | 141 | 121,000 | 10.75 | 61 | 464 | 3 | 437 | 
| kitchen_sink | 1 | 130 | 1,298 | 36,350,580 | 747,143,466 | 130 | 1,029 | 0 | 292.18 | 8.52 | 9 | 64.62 | 435 | 114 | 435 | 0 | 177 | 8,253,090 | 44 | 98 | 33,763 | 5.34 | 29 | 301 | 1 | 435 | 

...
|:---|---:|---:|---:|
| Total |  18.52 |  13.40 | 13.40 |
| kitchen_sink |  3.02 |  1.71 |  1.71 |
| leaf |  11.84 |  8.03 |  8.03 |
| internal.0 |  3.66 |  3.66 |  3.66 |


| kitchen_sink |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,508.50 |  3,017 |  1,702 |  1,315 |
...
| `execute_preflight_time_ms` |  115 |  230 |  133 |  97 |
| `execute_preflight_insn_mi/s` |  8.71 | -          |  11.53 |  5.89 |
| `trace_gen_time_ms   ` |  137 |  274 |  142 |  132 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  1,164.50 |  2,329 |  1,284 |  1,045 |
| `main_trace_commit_time_ms` |  192 |  384 |  206 |  178 |
| `generate_perm_trace_time_ms` |  98 |  196 |  147 |  49 |
| `perm_trace_commit_time_ms` |  80.12 |  160.25 |  95.74 |  64.51 |
| `quotient_poly_compute_time_ms` |  372.06 |  744.12 |  451.55 |  292.57 |
| `quotient_poly_commit_time_ms` |  9.34 |  18.67 |  10.22 |  8.46 |
| `pcs_opening_time_ms ` |  394.50 |  789 |  445 |  344 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  5,919.50 |  11,839 |  8,032 |  3,807 |
...
| `execute_preflight_insns` |  6,288,783.50 |  12,577,567 |  9,308,336 |  3,269,231 |
| `execute_preflight_time_ms` |  2,472 |  4,944 |  3,017 |  1,927 |
| `execute_preflight_insn_mi/s` |  5.70 | -          |  5.74 |  5.66 |
| `trace_gen_time_ms   ` |  409.50 |  819 |  599 |  220 |
| `memory_finalize_time_ms` |  30.50 |  61 |  35 |  26 |
| `stark_prove_excluding_trace_time_ms` |  3,037 |  6,074 |  4,415 |  1,659 |
| `main_trace_commit_time_ms` |  447 |  894 |  741 |  153 |
| `generate_perm_trace_time_ms` |  229 |  458 |  409 |  49 |
| `perm_trace_commit_time_ms` |  927.64 |  1,855.29 |  1,606.23 |  249.06 |
| `quotient_poly_compute_time_ms` |  341.16 |  682.32 |  514.20 |  168.13 |
| `quotient_poly_commit_time_ms` |  130.48 |  260.97 |  230.73 |  30.24 |
| `pcs_opening_time_ms ` |  946.50 |  1,893 |  1,006 |  887 |

| internal.0 |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  3,658 |  3,658 |  3,658 |  3,658 |
| `main_cells_used     ` |  20,592,928 |  20,592,928 |  20,592,928 |  20,592,928 |
| `total_cells_used    ` |  43,709,890 |  43,709,890 |  43,709,890 |  43,709,890 |
| `execute_preflight_insns` |  4,041,575 |  4,041,575 |  4,041,575 |  4,041,575 |
| `execute_preflight_time_ms` |  2,043 |  2,043 |  2,043 |  2,043 |
| `execute_preflight_insn_mi/s` |  5.88 | -          |  5.88 |  5.88 |
| `trace_gen_time_ms   ` |  158 |  158 |  158 |  158 |
| `memory_finalize_time_ms` |  17 |  17 |  17 |  17 |
| `stark_prove_excluding_trace_time_ms` |  1,456 |  1,456 |  1,456 |  1,456 |
| `main_trace_commit_time_ms` |  257 |  257 |  257 |  257 |
| `generate_perm_trace_time_ms` |  60 |  60 |  60 |  60 |
| `perm_trace_commit_time_ms` |  188.29 |  188.29 |  188.29 |  188.29 |
| `quotient_poly_compute_time_ms` |  276.74 |  276.74 |  276.74 |  276.74 |
| `quotient_poly_commit_time_ms` |  73.95 |  73.95 |  73.95 |  73.95 |
| `pcs_opening_time_ms ` |  595 |  595 |  595 |  595 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal.0 |  | 3,663 |  | 3 | 2 |  |  |  |  | 
| kitchen_sink |  |  | 1,315 |  | 1 | 7 | 154,763 | 21.27 | 0 | 
| leaf | 3,812 |  |  | 1 | 1 |  |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal.0 | 0 | 158 | 3,658 | 43,709,890 | 732,015,074 | 158 | 1,456 | 0 | 276.74 | 73.95 | 5 | 188.29 | 595 | 249 | 595 | 17 | 257 | 20,592,928 | 60 | 2,043 | 4,041,575 | 5.88 | 44 | 352 | 0 | 595 | 
| leaf | 0 | 599 | 8,032 | 193,614,318 | 3,758,099,946 | 599 | 4,415 | 0 | 514.20 | 230.73 | 7 | 1,606.23 | 887 | 2,016 | 887 | 35 | 741 | 83,649,940 | 409 | 3,017 | 9,308,336 | 5.66 | 205 | 769 | 36 | 887 | 
| leaf | 1 | 220 | 3,807 | 93,232,594 | 1,225,346,538 | 220 | 1,659 | 0 | 168.13 | 30.24 | 6 | 249.06 | 1,006 | 299 | 1,006 | 26 | 153 | 41,597,560 | 49 | 1,927 | 3,269,231 | 5.74 | 43 | 199 | 0 | 1,006 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| kitchen_sink | 0 | 142 | 1,702 | 39,702,956 | 760,599,754 | 142 | 1,284 | 0 | 451.55 | 10.22 | 17 | 95.74 | 344 | 269 | 344 | 0 | 206 | 10,085,858 | 147 | 133 | 121,000 | 11.53 | 62 | 462 | 3 | 344 | 
| kitchen_sink | 1 | 132 | 1,315 | 36,350,580 | 747,143,466 | 132 | 1,045 | 0 | 292.57 | 8.46 | 9 | 64.51 | 445 | 119 | 444 | 0 | 178 | 8,253,090 | 49 | 97 | 33,763 | 5.89 | 29 | 301 | 1 | 444 | 

...
|:---|---:|---:|---:|
| Total |  4.14 |  1.31 | 1.31 |
| regex_program |  4.14 |  1.31 |  1.31 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,026.50 |  4,106 |  1,275 |  817 |
...
| `execute_preflight_insn_mi/s` |  31.57 | -          |  32.88 |  28.37 |
| `trace_gen_time_ms   ` |  180.75 |  723 |  216 |  157 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  717.75 |  2,871 |  1,009 |  552 |
| `main_trace_commit_time_ms` |  52.50 |  210 |  58 |  50 |
| `generate_perm_trace_time_ms` |  27 |  108 |  32 |  21 |
| `perm_trace_commit_time_ms` |  65.51 |  262.04 |  72.08 |  55.54 |
| `quotient_poly_compute_time_ms` |  61.95 |  247.82 |  71.89 |  55.64 |
| `quotient_poly_commit_time_ms` |  16.06 |  64.23 |  18.48 |  13.76 |
| `pcs_opening_time_ms ` |  491.50 |  1,966 |  788 |  327 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 832 | 1 | 36 | 4,137,502 | 113.75 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 216 | 1,182 | 23,446,148 | 150,778,428 | 216 | 750 | 0 | 64.17 | 18.48 | 7 | 72.08 | 510 | 98 | 509 | 4 | 58 | 10,899,170 | 25 | 46 | 1,103,000 | 28.37 | 22 | 83 | 0 | 509 | 
| regex_program | 1 | 157 | 1,275 | 11,598,276 | 128,513,066 | 157 | 1,009 | 1 | 55.64 | 15.88 | 6 | 67.03 | 788 | 97 | 788 | 0 | 50 | 2,196,106 | 30 | 67 | 1,104,000 | 32.75 | 17 | 72 | 0 | 788 | 
| regex_program | 2 | 164 | 817 | 11,579,064 | 128,513,066 | 164 | 552 | 1 | 56.12 | 16.11 | 6 | 67.39 | 327 | 100 | 327 | 0 | 51 | 2,177,334 | 32 | 59 | 1,104,000 | 32.29 | 17 | 72 | 0 | 327 | 
| regex_program | 3 | 186 | 832 | 11,853,872 | 103,456,394 | 186 | 560 | 0 | 71.89 | 13.76 | 7 | 55.54 | 341 | 80 | 341 | 0 | 51 | 2,422,606 | 21 | 45 | 826,502 | 32.88 | 19 | 86 | 0 | 341 | 
...
Commit: https://github.com/openvm-org/openvm/commit/671820432db9e7c556a90bc04f791835bd006043
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/20311255206)

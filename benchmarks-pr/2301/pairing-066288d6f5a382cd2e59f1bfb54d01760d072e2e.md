...
|:---|---:|---:|---:|
| Total |  9.22 |  5.73 | 5.73 |
| pairing |  2.41 |  1.40 |  1.40 |
| leaf |  6.81 |  4.32 |  4.32 |
...
| `total_proof_time_ms ` |  1,174 |  2,348 |  1,340 |  1,008 |
...
| `execute_metered_insn_mi/s` |  27.32 | -          |  27.32 |  27.32 |
| `execute_preflight_insns` |  872,871 |  1,745,742 |  1,149,000 |  596,742 |
| `execute_preflight_time_ms` |  84.50 |  169 |  107 |  62 |
| `execute_preflight_insn_mi/s` |  14.52 | -          |  17.97 |  11.07 |
| `trace_gen_time_ms   ` |  181.50 |  363 |  188 |  175 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  802.50 |  1,605 |  888 |  717 |
| `main_trace_commit_time_ms` |  64.50 |  129 |  74 |  55 |
| `generate_perm_trace_time_ms` |  68 |  136 |  92 |  44 |
| `perm_trace_commit_time_ms` |  76.100 |  153.100 |  89.36 |  64.64 |
| `quotient_poly_compute_time_ms` |  82.55 |  165.09 |  91.34 |  73.75 |
| `quotient_poly_commit_time_ms` |  17.73 |  35.46 |  19.90 |  15.57 |
| `pcs_opening_time_ms ` |  488 |  976 |  565 |  411 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  3,404 |  6,808 |  4,324 |  2,484 |
| `main_cells_used     ` |  20,416,836 |  40,833,672 |  20,627,230 |  20,206,442 |
| `total_cells_used    ` |  49,512,028 |  99,024,056 |  50,015,232 |  49,008,824 |
| `execute_preflight_insns` |  2,988,677.50 |  5,977,355 |  3,050,916 |  2,926,439 |
| `execute_preflight_time_ms` |  1,062 |  2,124 |  1,595 |  529 |
| `execute_preflight_insn_mi/s` |  6.33 | -          |  6.41 |  6.26 |
| `trace_gen_time_ms   ` |  165 |  330 |  172 |  158 |
| `memory_finalize_time_ms` |  15.50 |  31 |  16 |  15 |
| `stark_prove_excluding_trace_time_ms` |  2,175.50 |  4,351 |  2,569 |  1,782 |
| `main_trace_commit_time_ms` |  296 |  592 |  297 |  295 |
| `generate_perm_trace_time_ms` |  123.50 |  247 |  146 |  101 |
| `perm_trace_commit_time_ms` |  463.50 |  926.100 |  474.22 |  452.78 |
| `quotient_poly_compute_time_ms` |  337.12 |  674.25 |  338.72 |  335.53 |
| `quotient_poly_commit_time_ms` |  69 |  138 |  72.09 |  65.91 |
| `pcs_opening_time_ms ` |  880 |  1,760 |  1,309 |  451 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 4,327 |  | 1 | 1 |  |  |  |  | 
| pairing |  | 1,008 |  | 1 | 63 | 1,745,742 | 27.32 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 172 | 2,484 | 50,015,232 | 761,351,658 | 172 | 1,782 | 0 | 335.53 | 72.09 | 6 | 474.22 | 451 | 621 | 451 | 16 | 295 | 20,627,230 | 146 | 529 | 3,050,916 | 6.26 | 83 | 413 | 5 | 451 | 
| leaf | 1 | 158 | 4,324 | 49,008,824 | 761,351,658 | 158 | 2,569 | 0 | 338.72 | 65.91 | 6 | 452.78 | 1,309 | 554 | 1,309 | 15 | 297 | 20,206,442 | 101 | 1,595 | 2,926,439 | 6.41 | 79 | 407 | 0 | 1,309 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 175 | 1,340 | 32,480,114 | 172,558,444 | 175 | 888 | 0 | 91.34 | 19.90 | 9 | 89.36 | 565 | 136 | 564 | 1 | 74 | 15,909,408 | 44 | 107 | 1,149,000 | 11.07 | 27 | 112 | 1 | 564 | 
| pairing | 1 | 188 | 1,008 | 22,464,232 | 119,958,502 | 188 | 717 | 1 | 73.75 | 15.57 | 8 | 64.64 | 411 | 160 | 411 | 0 | 55 | 9,498,894 | 92 | 62 | 596,742 | 17.97 | 21 | 89 | 1 | 411 | 

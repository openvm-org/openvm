...
|:---|---:|---:|---:|
| Total |  6.69 |  3.82 | 3.82 |
| fibonacci_program |  1.86 |  0.94 |  0.94 |
| leaf |  4.84 |  2.88 |  2.88 |
...
| `total_proof_time_ms ` |  923 |  1,846 |  927 |  919 |
...
| `execute_preflight_insn_mi/s` |  36.60 | -          |  38.75 |  34.44 |
| `trace_gen_time_ms   ` |  194.50 |  389 |  200 |  189 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  592.50 |  1,185 |  655 |  530 |
| `main_trace_commit_time_ms` |  31 |  62 |  34 |  28 |
| `generate_perm_trace_time_ms` |  25.50 |  51 |  29 |  22 |
| `perm_trace_commit_time_ms` |  41.21 |  82.43 |  43.84 |  38.59 |
| `quotient_poly_compute_time_ms` |  33.47 |  66.93 |  36.17 |  30.76 |
| `quotient_poly_commit_time_ms` |  12.84 |  25.67 |  12.93 |  12.74 |
| `pcs_opening_time_ms ` |  447 |  894 |  521 |  373 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  2,417.50 |  4,835 |  2,877 |  1,958 |
| `main_cells_used     ` |  9,910,726 |  19,821,452 |  10,121,356 |  9,700,096 |
| `total_cells_used    ` |  25,895,192 |  51,790,384 |  26,398,858 |  25,391,526 |
| `execute_preflight_insns` |  1,999,824 |  3,999,648 |  2,061,772 |  1,937,876 |
| `execute_preflight_time_ms` |  925.50 |  1,851 |  1,482 |  369 |
| `execute_preflight_insn_mi/s` |  5.99 | -          |  6.02 |  5.96 |
| `trace_gen_time_ms   ` |  93.50 |  187 |  98 |  89 |
| `memory_finalize_time_ms` |  8.50 |  17 |  9 |  8 |
| `stark_prove_excluding_trace_time_ms` |  1,397.50 |  2,795 |  1,491 |  1,304 |
| `main_trace_commit_time_ms` |  134.50 |  269 |  135 |  134 |
| `generate_perm_trace_time_ms` |  52 |  104 |  52 |  52 |
| `perm_trace_commit_time_ms` |  186.78 |  373.55 |  186.90 |  186.65 |
| `quotient_poly_compute_time_ms` |  149.40 |  298.80 |  149.89 |  148.91 |
| `quotient_poly_commit_time_ms` |  29.55 |  59.10 |  29.84 |  29.26 |
| `pcs_opening_time_ms ` |  842 |  1,684 |  936 |  748 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program |  | 919 |  | 1 | 13 | 1,500,209 | 112.53 | 0 | 
| leaf | 2,879 |  | 1 | 1 |  |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 98 | 1,958 | 26,398,858 | 342,564,330 | 98 | 1,491 | 0 | 148.91 | 29.26 | 6 | 186.65 | 936 | 239 | 936 | 9 | 135 | 10,121,356 | 52 | 369 | 2,061,772 | 6.02 | 33 | 179 | 0 | 936 | 
| leaf | 1 | 89 | 2,877 | 25,391,526 | 342,564,330 | 89 | 1,304 | 0 | 149.89 | 29.84 | 6 | 186.90 | 748 | 240 | 748 | 8 | 134 | 9,700,096 | 52 | 1,482 | 1,937,876 | 5.96 | 33 | 181 | 0 | 748 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 200 | 927 | 9,677,708 | 84,395,212 | 200 | 530 | 0 | 36.17 | 12.74 | 6 | 43.84 | 373 | 73 | 372 | 0 | 34 | 1,035,986 | 29 | 26 | 873,000 | 34.44 | 14 | 49 | 0 | 372 | 
| fibonacci_program | 1 | 189 | 919 | 9,708,170 | 74,305,770 | 189 | 655 | 1 | 30.76 | 12.93 | 5 | 38.59 | 521 | 61 | 521 | 0 | 28 | 1,064,416 | 22 | 33 | 627,209 | 38.75 | 11 | 44 | 0 | 521 | 

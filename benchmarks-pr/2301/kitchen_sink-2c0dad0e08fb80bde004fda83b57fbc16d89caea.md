...
|:---|---:|---:|---:|
| Total |  16.35 |  12.15 | 12.15 |
| kitchen_sink |  3.34 |  1.85 |  1.85 |
| leaf |  10.26 |  7.55 |  7.55 |
| internal.0 |  2.75 |  2.75 |  2.75 |


| kitchen_sink |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,668 |  3,336 |  1,840 |  1,496 |
...
| `execute_metered_insn_mi/s` |  21.28 | -          |  21.28 |  21.28 |
| `execute_preflight_insns` |  77,381.50 |  154,763 |  121,000 |  33,763 |
| `execute_preflight_time_ms` |  114.50 |  229 |  134 |  95 |
| `execute_preflight_insn_mi/s` |  8.48 | -          |  11.17 |  5.79 |
| `trace_gen_time_ms   ` |  134.50 |  269 |  138 |  131 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  1,326 |  2,652 |  1,424 |  1,228 |
| `main_trace_commit_time_ms` |  189 |  378 |  203 |  175 |
| `generate_perm_trace_time_ms` |  105 |  210 |  166 |  44 |
| `perm_trace_commit_time_ms` |  79.55 |  159.10 |  94.67 |  64.43 |
| `quotient_poly_compute_time_ms` |  372.49 |  744.98 |  453.16 |  291.82 |
| `quotient_poly_commit_time_ms` |  9.38 |  18.75 |  10.24 |  8.51 |
| `pcs_opening_time_ms ` |  553 |  1,106 |  637 |  469 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  5,128.50 |  10,257 |  7,554 |  2,703 |
...
| `execute_preflight_insns` |  6,288,839 |  12,577,678 |  9,308,318 |  3,269,360 |
| `execute_preflight_time_ms` |  1,958.50 |  3,917 |  2,496 |  1,421 |
| `execute_preflight_insn_mi/s` |  5.72 | -          |  5.75 |  5.69 |
| `trace_gen_time_ms   ` |  412.50 |  825 |  609 |  216 |
| `memory_finalize_time_ms` |  30.50 |  61 |  38 |  23 |
| `stark_prove_excluding_trace_time_ms` |  2,755.50 |  5,511 |  4,447 |  1,064 |
| `main_trace_commit_time_ms` |  444.50 |  889 |  735 |  154 |
| `generate_perm_trace_time_ms` |  236 |  472 |  413 |  59 |
| `perm_trace_commit_time_ms` |  923.32 |  1,846.63 |  1,596.84 |  249.79 |
| `quotient_poly_compute_time_ms` |  339.98 |  679.95 |  511.83 |  168.12 |
| `quotient_poly_commit_time_ms` |  129.01 |  258.02 |  227.69 |  30.33 |
| `pcs_opening_time_ms ` |  668 |  1,336 |  937 |  399 |

| internal.0 |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  2,747 |  2,747 |  2,747 |  2,747 |
| `main_cells_used     ` |  20,592,928 |  20,592,928 |  20,592,928 |  20,592,928 |
| `total_cells_used    ` |  43,709,890 |  43,709,890 |  43,709,890 |  43,709,890 |
| `execute_preflight_insns` |  4,041,579 |  4,041,579 |  4,041,579 |  4,041,579 |
| `execute_preflight_time_ms` |  1,516 |  1,516 |  1,516 |  1,516 |
| `execute_preflight_insn_mi/s` |  5.95 | -          |  5.95 |  5.95 |
| `trace_gen_time_ms   ` |  164 |  164 |  164 |  164 |
| `memory_finalize_time_ms` |  16 |  16 |  16 |  16 |
| `stark_prove_excluding_trace_time_ms` |  1,065 |  1,065 |  1,065 |  1,065 |
| `main_trace_commit_time_ms` |  258 |  258 |  258 |  258 |
| `generate_perm_trace_time_ms` |  40 |  40 |  40 |  40 |
| `perm_trace_commit_time_ms` |  185.82 |  185.82 |  185.82 |  185.82 |
| `quotient_poly_compute_time_ms` |  275.42 |  275.42 |  275.42 |  275.42 |
| `quotient_poly_commit_time_ms` |  74.02 |  74.02 |  74.02 |  74.02 |
| `pcs_opening_time_ms ` |  228 |  228 |  228 |  228 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal.0 |  | 2,751 |  | 3 | 2 |  |  |  |  | 
| kitchen_sink |  |  | 1,496 |  | 1 | 7 | 154,763 | 21.28 | 0 | 
| leaf | 2,707 |  |  | 1 | 1 |  |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal.0 | 0 | 164 | 2,747 | 43,709,890 | 732,015,074 | 164 | 1,065 | 0 | 275.42 | 74.02 | 5 | 185.82 | 228 | 226 | 228 | 16 | 258 | 20,592,928 | 40 | 1,516 | 4,041,579 | 5.95 | 44 | 351 | 0 | 228 | 
| leaf | 0 | 609 | 7,554 | 193,614,318 | 3,758,099,946 | 609 | 4,447 | 0 | 511.83 | 227.69 | 6 | 1,596.84 | 937 | 2,011 | 937 | 38 | 735 | 83,649,940 | 413 | 2,496 | 9,308,318 | 5.69 | 205 | 763 | 36 | 937 | 
| leaf | 1 | 216 | 2,703 | 93,232,594 | 1,225,346,538 | 216 | 1,064 | 0 | 168.12 | 30.33 | 6 | 249.79 | 399 | 310 | 398 | 23 | 154 | 41,597,560 | 59 | 1,421 | 3,269,360 | 5.75 | 42 | 199 | 0 | 398 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| kitchen_sink | 0 | 138 | 1,840 | 39,702,956 | 760,599,754 | 138 | 1,424 | 0 | 453.16 | 10.24 | 17 | 94.67 | 469 | 285 | 469 | 0 | 203 | 10,085,858 | 166 | 134 | 121,000 | 11.17 | 61 | 464 | 3 | 469 | 
| kitchen_sink | 1 | 131 | 1,496 | 36,350,580 | 747,143,466 | 131 | 1,228 | 0 | 291.82 | 8.51 | 9 | 64.43 | 637 | 114 | 636 | 0 | 175 | 8,253,090 | 44 | 95 | 33,763 | 5.79 | 29 | 300 | 1 | 636 | 

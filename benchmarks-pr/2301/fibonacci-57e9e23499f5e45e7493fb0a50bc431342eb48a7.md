...
|:---|---:|---:|---:|
| Total |  5.62 |  3.49 | 3.49 |
| fibonacci_program |  1.59 |  0.82 |  0.82 |
| leaf |  4.03 |  2.68 |  2.68 |
...
| `total_proof_time_ms ` |  789.50 |  1,579 |  802 |  777 |
...
| `execute_preflight_insn_mi/s` |  36.95 | -          |  38.92 |  34.97 |
| `trace_gen_time_ms   ` |  192.50 |  385 |  198 |  187 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  461.50 |  923 |  514 |  409 |
| `main_trace_commit_time_ms` |  31 |  62 |  33 |  29 |
| `generate_perm_trace_time_ms` |  26.50 |  53 |  31 |  22 |
| `perm_trace_commit_time_ms` |  41.99 |  83.98 |  44.64 |  39.34 |
| `quotient_poly_compute_time_ms` |  31.34 |  62.69 |  32.19 |  30.49 |
| `quotient_poly_commit_time_ms` |  11.87 |  23.74 |  12 |  11.73 |
| `pcs_opening_time_ms ` |  316.50 |  633 |  380 |  253 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  2,013.50 |  4,027 |  2,678 |  1,349 |
| `main_cells_used     ` |  9,910,726 |  19,821,452 |  10,121,356 |  9,700,096 |
| `total_cells_used    ` |  25,895,192 |  51,790,384 |  26,398,858 |  25,391,526 |
| `execute_preflight_insns` |  1,999,720.50 |  3,999,441 |  2,061,652 |  1,937,789 |
| `execute_preflight_time_ms` |  906.50 |  1,813 |  1,449 |  364 |
| `execute_preflight_insn_mi/s` |  6.03 | -          |  6.11 |  5.95 |
| `trace_gen_time_ms   ` |  95 |  190 |  99 |  91 |
| `memory_finalize_time_ms` |  9.50 |  19 |  10 |  9 |
| `stark_prove_excluding_trace_time_ms` |  1,011 |  2,022 |  1,137 |  885 |
| `main_trace_commit_time_ms` |  133.50 |  267 |  135 |  132 |
| `generate_perm_trace_time_ms` |  46.50 |  93 |  48 |  45 |
| `perm_trace_commit_time_ms` |  186.31 |  372.61 |  186.65 |  185.96 |
| `quotient_poly_compute_time_ms` |  148.50 |  297 |  148.72 |  148.28 |
| `quotient_poly_commit_time_ms` |  29.31 |  58.61 |  29.56 |  29.05 |
| `pcs_opening_time_ms ` |  463 |  926 |  586 |  340 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program |  | 777 |  | 1 | 13 | 1,500,209 | 111.42 | 0 | 
| leaf | 2,681 |  | 1 | 1 |  |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 99 | 1,349 | 26,398,858 | 342,564,330 | 99 | 885 | 0 | 148.28 | 29.05 | 6 | 185.96 | 340 | 232 | 340 | 10 | 132 | 10,121,356 | 45 | 364 | 2,061,652 | 6.11 | 33 | 178 | 0 | 340 | 
| leaf | 1 | 91 | 2,678 | 25,391,526 | 342,564,330 | 91 | 1,137 | 0 | 148.72 | 29.56 | 6 | 186.65 | 586 | 236 | 585 | 9 | 135 | 9,700,096 | 48 | 1,449 | 1,937,789 | 5.95 | 33 | 179 | 0 | 585 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 198 | 802 | 9,677,708 | 84,395,212 | 198 | 409 | 0 | 32.19 | 12 | 6 | 44.64 | 253 | 77 | 253 | 0 | 33 | 1,035,986 | 31 | 25 | 873,000 | 34.97 | 14 | 44 | 0 | 253 | 
| fibonacci_program | 1 | 187 | 777 | 9,708,170 | 74,305,770 | 187 | 514 | 1 | 30.49 | 11.73 | 6 | 39.34 | 380 | 62 | 380 | 0 | 29 | 1,064,416 | 22 | 34 | 627,209 | 38.92 | 11 | 42 | 0 | 380 | 

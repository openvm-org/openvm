...
|:---|---:|---:|---:|
| Total |  5.50 |  3.43 | 3.43 |
| fibonacci_program |  1.75 |  1.01 |  1.01 |
| leaf |  3.75 |  2.42 |  2.42 |
...
| `total_proof_time_ms ` |  870.50 |  1,741 |  999 |  742 |
...
| `execute_metered_insn_mi/s` |  113.07 | -          |  113.07 |  113.07 |
| `execute_preflight_insns` |  750,104.50 |  1,500,209 |  873,000 |  627,209 |
| `execute_preflight_time_ms` |  28.50 |  57 |  32 |  25 |
| `execute_preflight_insn_mi/s` |  36.70 | -          |  38.63 |  34.76 |
| `trace_gen_time_ms   ` |  192 |  384 |  196 |  188 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  545 |  1,090 |  610 |  480 |
| `main_trace_commit_time_ms` |  30.50 |  61 |  33 |  28 |
| `generate_perm_trace_time_ms` |  25 |  50 |  28 |  22 |
| `perm_trace_commit_time_ms` |  41.70 |  83.40 |  44.46 |  38.94 |
| `quotient_poly_compute_time_ms` |  32.94 |  65.87 |  34.85 |  31.02 |
| `quotient_poly_commit_time_ms` |  12.68 |  25.37 |  13.50 |  11.87 |
| `pcs_opening_time_ms ` |  399.50 |  799 |  454 |  345 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,874.50 |  3,749 |  2,416 |  1,333 |
| `main_cells_used     ` |  9,910,726 |  19,821,452 |  10,121,356 |  9,700,096 |
| `total_cells_used    ` |  25,895,192 |  51,790,384 |  26,398,858 |  25,391,526 |
| `execute_preflight_insns` |  1,999,736 |  3,999,472 |  2,061,559 |  1,937,913 |
| `execute_preflight_time_ms` |  875 |  1,750 |  1,397 |  353 |
| `execute_preflight_insn_mi/s` |  6.11 | -          |  6.28 |  5.94 |
| `trace_gen_time_ms   ` |  95 |  190 |  101 |  89 |
| `memory_finalize_time_ms` |  8.50 |  17 |  9 |  8 |
| `stark_prove_excluding_trace_time_ms` |  903 |  1,806 |  929 |  877 |
| `main_trace_commit_time_ms` |  133.50 |  267 |  134 |  133 |
| `generate_perm_trace_time_ms` |  46 |  92 |  46 |  46 |
| `perm_trace_commit_time_ms` |  186.75 |  373.49 |  187.18 |  186.32 |
| `quotient_poly_compute_time_ms` |  147.87 |  295.74 |  148.40 |  147.34 |
| `quotient_poly_commit_time_ms` |  29.36 |  58.71 |  29.77 |  28.95 |
| `pcs_opening_time_ms ` |  356 |  712 |  383 |  329 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program |  | 742 |  | 1 | 13 | 1,500,209 | 113.07 | 0 | 
| leaf | 2,418 |  | 1 | 1 |  |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 101 | 1,333 | 26,398,858 | 342,564,330 | 101 | 877 | 0 | 148.40 | 29.77 | 6 | 187.18 | 329 | 234 | 329 | 9 | 134 | 10,121,356 | 46 | 353 | 2,061,559 | 6.28 | 32 | 179 | 0 | 329 | 
| leaf | 1 | 89 | 2,416 | 25,391,526 | 342,564,330 | 89 | 929 | 0 | 147.34 | 28.95 | 5 | 186.32 | 383 | 233 | 383 | 8 | 133 | 9,700,096 | 46 | 1,397 | 1,937,913 | 5.94 | 33 | 177 | 0 | 383 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 196 | 999 | 9,677,708 | 84,395,212 | 196 | 610 | 0 | 34.85 | 13.50 | 6 | 44.46 | 454 | 73 | 453 | 0 | 33 | 1,035,986 | 28 | 25 | 873,000 | 34.76 | 14 | 48 | 0 | 453 | 
| fibonacci_program | 1 | 188 | 742 | 9,708,170 | 74,305,770 | 188 | 480 | 1 | 31.02 | 11.87 | 5 | 38.94 | 345 | 61 | 345 | 0 | 28 | 1,064,416 | 22 | 32 | 627,209 | 38.63 | 11 | 43 | 0 | 345 | 

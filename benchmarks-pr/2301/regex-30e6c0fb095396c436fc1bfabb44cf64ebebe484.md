...
|:---|---:|---:|---:|
| Total |  15.20 |  5.38 | 5.38 |
| regex_program |  4.13 |  1.47 |  1.47 |
| leaf |  11.07 |  3.91 |  3.91 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,024.25 |  4,097 |  1,430 |  683 |
...
| `execute_preflight_time_ms` |  54.75 |  219 |  66 |  46 |
| `execute_preflight_insn_mi/s` |  30.12 | -          |  31.37 |  27.72 |
| `trace_gen_time_ms   ` |  169.75 |  679 |  181 |  156 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  726 |  2,904 |  1,166 |  413 |
| `main_trace_commit_time_ms` |  51.50 |  206 |  56 |  50 |
| `generate_perm_trace_time_ms` |  27.50 |  110 |  33 |  22 |
| `perm_trace_commit_time_ms` |  64.63 |  258.50 |  71.87 |  56.25 |
| `quotient_poly_compute_time_ms` |  59.69 |  238.75 |  69.90 |  53.72 |
| `quotient_poly_commit_time_ms` |  16.16 |  64.65 |  18.64 |  14.04 |
| `pcs_opening_time_ms ` |  503.25 |  2,013 |  949 |  195 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  2,767.50 |  11,070 |  3,914 |  1,811 |
...
| `execute_preflight_insns` |  2,313,083.75 |  9,252,335 |  2,693,955 |  2,073,398 |
| `execute_preflight_time_ms` |  1,070.50 |  4,282 |  1,400 |  397 |
| `execute_preflight_insn_mi/s` |  6.15 | -          |  6.59 |  5.58 |
| `trace_gen_time_ms   ` |  126 |  504 |  210 |  92 |
| `memory_finalize_time_ms` |  12.75 |  51 |  21 |  9 |
| `stark_prove_excluding_trace_time_ms` |  1,569.25 |  6,277 |  2,384 |  1,209 |
| `main_trace_commit_time_ms` |  213.25 |  853 |  376 |  144 |
| `generate_perm_trace_time_ms` |  84.50 |  338 |  169 |  54 |
| `perm_trace_commit_time_ms` |  357.79 |  1,431.16 |  696.14 |  227.97 |
| `quotient_poly_compute_time_ms` |  251.75 |  1,007 |  460.08 |  173.32 |
| `quotient_poly_commit_time_ms` |  54.66 |  218.62 |  106.82 |  30.14 |
| `pcs_opening_time_ms ` |  602.75 |  2,411 |  742 |  526 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 3,918 |  | 1 | 1 |  |  |  |  | 
| regex_program |  | 683 |  | 1 | 36 | 4,137,502 | 113.13 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 107 | 1,811 | 32,454,646 | 471,277,034 | 107 | 1,305 | 0 | 198.62 | 50.27 | 6 | 277.96 | 526 | 339 | 526 | 11 | 188 | 13,045,812 | 60 | 397 | 2,411,541 | 6.59 | 52 | 250 | 4 | 526 | 
| leaf | 1 | 92 | 2,873 | 29,451,830 | 403,119,594 | 92 | 1,379 | 0 | 174.99 | 31.39 | 6 | 227.97 | 742 | 284 | 741 | 9 | 145 | 11,789,672 | 55 | 1,400 | 2,073,441 | 6.18 | 38 | 207 | 0 | 741 | 
| leaf | 2 | 95 | 2,472 | 29,451,830 | 403,119,594 | 95 | 1,209 | 0 | 173.32 | 30.14 | 5 | 229.09 | 576 | 284 | 575 | 10 | 144 | 11,789,672 | 54 | 1,167 | 2,073,398 | 6.25 | 38 | 204 | 0 | 575 | 
| leaf | 3 | 210 | 3,914 | 60,115,460 | 989,416,938 | 210 | 2,384 | 0 | 460.08 | 106.82 | 6 | 696.14 | 567 | 867 | 567 | 21 | 376 | 24,205,574 | 169 | 1,318 | 2,693,955 | 5.58 | 135 | 573 | 8 | 566 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 180 | 1,049 | 23,446,148 | 150,778,428 | 180 | 654 | 0 | 61.41 | 18.64 | 7 | 71.87 | 418 | 98 | 418 | 4 | 56 | 10,899,170 | 26 | 46 | 1,103,000 | 27.72 | 22 | 80 | 0 | 418 | 
| regex_program | 1 | 156 | 1,430 | 11,598,276 | 128,513,066 | 156 | 1,166 | 1 | 53.72 | 16.29 | 6 | 65.92 | 949 | 95 | 949 | 0 | 50 | 2,196,106 | 29 | 66 | 1,104,000 | 31.37 | 17 | 70 | 0 | 949 | 
| regex_program | 2 | 162 | 935 | 11,579,064 | 128,513,066 | 162 | 671 | 1 | 53.73 | 15.68 | 6 | 64.45 | 451 | 98 | 451 | 0 | 50 | 2,177,334 | 33 | 60 | 1,104,000 | 30.72 | 17 | 69 | 0 | 451 | 
| regex_program | 3 | 181 | 683 | 11,853,872 | 103,456,394 | 181 | 413 | 0 | 69.90 | 14.04 | 7 | 56.25 | 195 | 82 | 195 | 0 | 50 | 2,422,606 | 22 | 47 | 826,502 | 30.66 | 19 | 85 | 0 | 195 | 

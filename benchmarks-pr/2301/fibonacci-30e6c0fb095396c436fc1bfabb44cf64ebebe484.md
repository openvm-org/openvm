...
|:---|---:|---:|---:|
| Total |  5.91 |  3.64 | 3.64 |
| fibonacci_program |  1.82 |  0.99 |  0.99 |
| leaf |  4.08 |  2.65 |  2.65 |
...
| `total_proof_time_ms ` |  905.50 |  1,811 |  981 |  830 |
...
| `execute_metered_insn_mi/s` |  120.80 | -          |  120.80 |  120.80 |
| `execute_preflight_insns` |  750,104.50 |  1,500,209 |  873,000 |  627,209 |
| `execute_preflight_time_ms` |  30 |  60 |  34 |  26 |
| `execute_preflight_insn_mi/s` |  36.47 | -          |  38.28 |  34.66 |
| `trace_gen_time_ms   ` |  191.50 |  383 |  198 |  185 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  578.50 |  1,157 |  588 |  569 |
| `main_trace_commit_time_ms` |  30.50 |  61 |  33 |  28 |
| `generate_perm_trace_time_ms` |  20.50 |  41 |  29 |  12 |
| `perm_trace_commit_time_ms` |  41.02 |  82.04 |  43.63 |  38.41 |
| `quotient_poly_compute_time_ms` |  33.05 |  66.10 |  35.18 |  30.92 |
| `quotient_poly_commit_time_ms` |  12.30 |  24.60 |  12.59 |  12.01 |
| `pcs_opening_time_ms ` |  438.50 |  877 |  445 |  432 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  2,042 |  4,084 |  2,645 |  1,439 |
| `main_cells_used     ` |  9,910,726 |  19,821,452 |  10,121,356 |  9,700,096 |
| `total_cells_used    ` |  25,895,192 |  51,790,384 |  26,398,858 |  25,391,526 |
| `execute_preflight_insns` |  1,999,720 |  3,999,440 |  2,061,553 |  1,937,887 |
| `execute_preflight_time_ms` |  927.50 |  1,855 |  1,493 |  362 |
| `execute_preflight_insn_mi/s` |  6.05 | -          |  6.12 |  5.97 |
| `trace_gen_time_ms   ` |  93.50 |  187 |  98 |  89 |
| `memory_finalize_time_ms` |  9.50 |  19 |  10 |  9 |
| `stark_prove_excluding_trace_time_ms` |  1,019 |  2,038 |  1,061 |  977 |
| `main_trace_commit_time_ms` |  133 |  266 |  134 |  132 |
| `generate_perm_trace_time_ms` |  48.50 |  97 |  52 |  45 |
| `perm_trace_commit_time_ms` |  186.29 |  372.58 |  186.96 |  185.62 |
| `quotient_poly_compute_time_ms` |  146.46 |  292.93 |  147.19 |  145.73 |
| `quotient_poly_commit_time_ms` |  29.02 |  58.04 |  29.29 |  28.76 |
| `pcs_opening_time_ms ` |  472.50 |  945 |  511 |  434 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program |  | 830 |  | 1 | 12 | 1,500,209 | 120.80 | 0 | 
| leaf | 2,647 |  | 1 | 1 |  |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 98 | 1,439 | 26,398,858 | 342,564,330 | 98 | 977 | 0 | 147.19 | 28.76 | 6 | 186.96 | 434 | 232 | 433 | 10 | 132 | 10,121,356 | 45 | 362 | 2,061,553 | 6.12 | 33 | 177 | 0 | 433 | 
| leaf | 1 | 89 | 2,645 | 25,391,526 | 342,564,330 | 89 | 1,061 | 0 | 145.73 | 29.29 | 6 | 185.62 | 511 | 239 | 511 | 9 | 134 | 9,700,096 | 52 | 1,493 | 1,937,887 | 5.97 | 32 | 176 | 0 | 511 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 198 | 981 | 9,677,708 | 84,395,212 | 198 | 588 | 0 | 35.18 | 12.59 | 6 | 43.63 | 432 | 73 | 432 | 0 | 33 | 1,035,986 | 29 | 26 | 873,000 | 34.66 | 14 | 48 | 0 | 432 | 
| fibonacci_program | 1 | 185 | 830 | 9,708,170 | 74,305,770 | 185 | 569 | 1 | 30.92 | 12.01 | 5 | 38.41 | 445 | 51 | 445 | 0 | 28 | 1,064,416 | 12 | 34 | 627,209 | 38.28 | 11 | 43 | 0 | 445 | 

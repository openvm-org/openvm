...
|:---|---:|---:|---:|
| Total |  6.09 |  3.69 | 3.69 |
| fibonacci_program |  2.38 |  1.28 |  1.28 |
| leaf |  3.71 |  2.41 |  2.41 |
...
| `total_proof_time_ms ` |  1,182 |  2,364 |  1,268 |  1,096 |
...
| `execute_preflight_insn_mi/s` |  36.67 | -          |  38.73 |  34.60 |
| `trace_gen_time_ms   ` |  190.50 |  381 |  196 |  185 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  857 |  1,714 |  877 |  837 |
| `main_trace_commit_time_ms` |  30 |  60 |  32 |  28 |
| `generate_perm_trace_time_ms` |  25 |  50 |  29 |  21 |
| `perm_trace_commit_time_ms` |  41.50 |  83 |  44.52 |  38.48 |
| `quotient_poly_compute_time_ms` |  30.48 |  60.95 |  32.73 |  28.22 |
| `quotient_poly_commit_time_ms` |  12.51 |  25.02 |  13.29 |  11.73 |
| `pcs_opening_time_ms ` |  715 |  1,430 |  723 |  707 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,857 |  3,714 |  2,406 |  1,308 |
| `main_cells_used     ` |  9,910,726 |  19,821,452 |  10,121,356 |  9,700,096 |
| `total_cells_used    ` |  25,895,192 |  51,790,384 |  26,398,858 |  25,391,526 |
| `execute_preflight_insns` |  1,999,804 |  3,999,608 |  2,061,716 |  1,937,892 |
| `execute_preflight_time_ms` |  902 |  1,804 |  1,435 |  369 |
| `execute_preflight_insn_mi/s` |  5.99 | -          |  6.01 |  5.97 |
| `trace_gen_time_ms   ` |  93.50 |  187 |  99 |  88 |
| `memory_finalize_time_ms` |  10 |  20 |  10 |  10 |
| `stark_prove_excluding_trace_time_ms` |  860 |  1,720 |  881 |  839 |
| `main_trace_commit_time_ms` |  132 |  264 |  132 |  132 |
| `generate_perm_trace_time_ms` |  45 |  90 |  47 |  43 |
| `perm_trace_commit_time_ms` |  184.66 |  369.33 |  184.75 |  184.57 |
| `quotient_poly_compute_time_ms` |  145.71 |  291.42 |  145.88 |  145.54 |
| `quotient_poly_commit_time_ms` |  29.10 |  58.20 |  29.27 |  28.93 |
| `pcs_opening_time_ms ` |  319 |  638 |  342 |  296 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program |  | 1,096 |  | 1 | 13 | 1,500,209 | 112.67 | 0 | 
| leaf | 2,408 |  | 1 | 1 |  |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 99 | 1,308 | 26,398,858 | 342,564,330 | 99 | 839 | 0 | 145.54 | 29.27 | 5 | 184.75 | 296 | 232 | 296 | 10 | 132 | 10,121,356 | 47 | 369 | 2,061,716 | 6.01 | 32 | 176 | 0 | 296 | 
| leaf | 1 | 88 | 2,406 | 25,391,526 | 342,564,330 | 88 | 881 | 0 | 145.88 | 28.93 | 6 | 184.57 | 342 | 229 | 342 | 10 | 132 | 9,700,096 | 43 | 1,435 | 1,937,892 | 5.97 | 32 | 176 | 0 | 342 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 196 | 1,268 | 9,677,708 | 84,395,212 | 196 | 877 | 0 | 32.73 | 13.29 | 6 | 44.52 | 723 | 74 | 723 | 0 | 32 | 1,035,986 | 29 | 25 | 873,000 | 34.60 | 14 | 46 | 0 | 723 | 
| fibonacci_program | 1 | 185 | 1,096 | 9,708,170 | 74,305,770 | 185 | 837 | 1 | 28.22 | 11.73 | 5 | 38.48 | 707 | 60 | 707 | 0 | 28 | 1,064,416 | 21 | 33 | 627,209 | 38.73 | 11 | 40 | 0 | 707 | 

...
|:---|---:|---:|---:|
| Total |  6.42 |  6.42 | 6.42 |
| ecrecover_program |  0.94 |  0.94 |  0.94 |
| leaf |  5.48 |  5.48 |  5.48 |
...
| `stark_prove_excluding_trace_time_ms` |  491 |  491 |  491 |  491 |
...
| `quotient_poly_compute_time_ms` |  104.87 |  104.87 |  104.87 |  104.87 |
| `quotient_poly_commit_time_ms` |  9.18 |  9.18 |  9.18 |  9.18 |
| `pcs_opening_time_ms ` |  264 |  264 |  264 |  264 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  5,480 |  5,480 |  5,480 |  5,480 |
| `main_cells_used     ` |  34,465,046 |  34,465,046 |  34,465,046 |  34,465,046 |
| `total_cells_used    ` |  83,385,200 |  83,385,200 |  83,385,200 |  83,385,200 |
| `execute_preflight_insns` |  4,109,152 |  4,109,152 |  4,109,152 |  4,109,152 |
| `execute_preflight_time_ms` |  730 |  730 |  730 |  730 |
| `execute_preflight_insn_mi/s` |  5.89 | -          |  5.89 |  5.89 |
| `trace_gen_time_ms   ` |  315 |  315 |  315 |  315 |
| `memory_finalize_time_ms` |  27 |  27 |  27 |  27 |
| `stark_prove_excluding_trace_time_ms` |  4,434 |  4,434 |  4,434 |  4,434 |
| `main_trace_commit_time_ms` |  722 |  722 |  722 |  722 |
| `generate_perm_trace_time_ms` |  336 |  336 |  336 |  336 |
| `perm_trace_commit_time_ms` |  1,492.76 |  1,492.76 |  1,492.76 |  1,492.76 |
| `quotient_poly_compute_time_ms` |  822.56 |  822.56 |  822.56 |  822.56 |
| `quotient_poly_commit_time_ms` |  199.76 |  199.76 |  199.76 |  199.76 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program |  | 935 |  | 1 | 6 | 122,859 | 19.59 | 0 | 
| leaf | 5,485 |  | 1 | 1 |  |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 315 | 5,480 | 83,385,200 | 1,726,057,962 | 315 | 4,434 | 0 | 822.56 | 199.76 | 6 | 1,492.76 | 853 | 1,830 | 852 | 27 | 722 | 34,465,046 | 336 | 730 | 4,109,152 | 5.89 | 269 | 1,027 | 14 | 852 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 213 | 935 | 11,344,654 | 31,789,298 | 213 | 491 | 0 | 104.87 | 9.18 | 10 | 34.13 | 264 | 75 | 264 | 1 | 37 | 2,262,772 | 33 | 61 | 122,859 | 2.16 | 21 | 114 | 1 | 264 | 

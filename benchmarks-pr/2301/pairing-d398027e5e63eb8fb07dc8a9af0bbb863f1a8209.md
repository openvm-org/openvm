...
|:---|---:|---:|---:|
| Total |  8.91 |  5.18 | 5.18 |
| pairing |  2.34 |  1.51 |  1.51 |
| leaf |  6.56 |  3.67 |  3.67 |
...
| `total_proof_time_ms ` |  1,140.50 |  2,281 |  1,450 |  831 |
...
| `execute_metered_insn_mi/s` |  27.29 | -          |  27.29 |  27.29 |
| `execute_preflight_insns` |  872,871 |  1,745,742 |  1,149,000 |  596,742 |
| `execute_preflight_time_ms` |  83.50 |  167 |  105 |  62 |
| `execute_preflight_insn_mi/s` |  14.59 | -          |  17.91 |  11.28 |
| `trace_gen_time_ms   ` |  185 |  370 |  190 |  180 |
| `memory_finalize_time_ms` |  1 |  2 |  1 |  1 |
| `stark_prove_excluding_trace_time_ms` |  765.50 |  1,531 |  994 |  537 |
| `main_trace_commit_time_ms` |  64.50 |  129 |  74 |  55 |
| `generate_perm_trace_time_ms` |  67 |  134 |  90 |  44 |
| `perm_trace_commit_time_ms` |  77.26 |  154.51 |  89.46 |  65.05 |
| `quotient_poly_compute_time_ms` |  84.05 |  168.11 |  93.83 |  74.28 |
| `quotient_poly_commit_time_ms` |  17.40 |  34.80 |  19.50 |  15.30 |
| `pcs_opening_time_ms ` |  450 |  900 |  668 |  232 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  3,282 |  6,564 |  3,667 |  2,897 |
| `main_cells_used     ` |  20,416,836 |  40,833,672 |  20,627,230 |  20,206,442 |
| `total_cells_used    ` |  49,512,028 |  99,024,056 |  50,015,232 |  49,008,824 |
| `execute_preflight_insns` |  2,988,564.50 |  5,977,129 |  3,050,824 |  2,926,305 |
| `execute_preflight_time_ms` |  1,078 |  2,156 |  1,639 |  517 |
| `execute_preflight_insn_mi/s` |  6.44 | -          |  6.47 |  6.41 |
| `trace_gen_time_ms   ` |  163 |  326 |  169 |  157 |
| `memory_finalize_time_ms` |  16.50 |  33 |  18 |  15 |
| `stark_prove_excluding_trace_time_ms` |  2,039 |  4,078 |  2,209 |  1,869 |
| `main_trace_commit_time_ms` |  295.50 |  591 |  296 |  295 |
| `generate_perm_trace_time_ms` |  110 |  220 |  123 |  97 |
| `perm_trace_commit_time_ms` |  466.63 |  933.26 |  478.54 |  454.72 |
| `quotient_poly_compute_time_ms` |  340.24 |  680.48 |  342.42 |  338.06 |
| `quotient_poly_commit_time_ms` |  70.81 |  141.63 |  74.89 |  66.74 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 3,670 |  | 1 | 1 |  |  |  |  | 
| pairing |  | 831 |  | 1 | 63 | 1,745,742 | 27.29 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 169 | 2,897 | 50,015,232 | 761,351,658 | 169 | 2,209 | 0 | 338.06 | 74.89 | 6 | 478.54 | 890 | 602 | 889 | 18 | 296 | 20,627,230 | 123 | 517 | 3,050,824 | 6.41 | 83 | 419 | 5 | 889 | 
| leaf | 1 | 157 | 3,667 | 49,008,824 | 761,351,658 | 157 | 1,869 | 0 | 342.42 | 66.74 | 6 | 454.72 | 608 | 552 | 608 | 15 | 295 | 20,206,442 | 97 | 1,639 | 2,926,305 | 6.47 | 80 | 411 | 0 | 608 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 180 | 1,450 | 32,480,114 | 172,558,444 | 180 | 994 | 0 | 93.83 | 19.50 | 8 | 89.46 | 668 | 136 | 667 | 1 | 74 | 15,909,408 | 44 | 105 | 1,149,000 | 11.28 | 27 | 114 | 1 | 667 | 
| pairing | 1 | 190 | 831 | 22,464,232 | 119,958,502 | 190 | 537 | 1 | 74.28 | 15.30 | 8 | 65.05 | 232 | 158 | 232 | 1 | 55 | 9,498,894 | 90 | 62 | 596,742 | 17.91 | 20 | 90 | 1 | 232 | 

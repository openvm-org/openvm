...
|:---|---:|---:|---:|
| Total |  16.15 |  11.98 | 11.98 |
| kitchen_sink |  2.93 |  1.72 |  1.72 |
| leaf |  10.42 |  7.46 |  7.46 |
| internal.0 |  2.80 |  2.80 |  2.80 |


| kitchen_sink |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,460.50 |  2,921 |  1,709 |  1,212 |
...
| `execute_preflight_insn_mi/s` |  8.55 | -          |  11.36 |  5.73 |
| `trace_gen_time_ms   ` |  136.50 |  273 |  141 |  132 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  1,117 |  2,234 |  1,290 |  944 |
| `main_trace_commit_time_ms` |  194.50 |  389 |  209 |  180 |
| `generate_perm_trace_time_ms` |  92 |  184 |  139 |  45 |
| `perm_trace_commit_time_ms` |  80.68 |  161.37 |  96.84 |  64.53 |
| `quotient_poly_compute_time_ms` |  374.56 |  749.12 |  454.89 |  294.22 |
| `quotient_poly_commit_time_ms` |  9.43 |  18.86 |  10.34 |  8.52 |
| `pcs_opening_time_ms ` |  348.50 |  697 |  353 |  344 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  5,210.50 |  10,421 |  7,465 |  2,956 |
...
| `execute_preflight_insns` |  6,288,749 |  12,577,498 |  9,308,259 |  3,269,239 |
| `execute_preflight_time_ms` |  1,949.50 |  3,899 |  2,481 |  1,418 |
| `execute_preflight_insn_mi/s` |  5.79 | -          |  5.86 |  5.72 |
| `trace_gen_time_ms   ` |  428 |  856 |  640 |  216 |
| `memory_finalize_time_ms` |  29.50 |  59 |  36 |  23 |
| `stark_prove_excluding_trace_time_ms` |  2,831.50 |  5,663 |  4,343 |  1,320 |
| `main_trace_commit_time_ms` |  445 |  890 |  734 |  156 |
| `generate_perm_trace_time_ms` |  227.50 |  455 |  398 |  57 |
| `perm_trace_commit_time_ms` |  926.34 |  1,852.69 |  1,600.22 |  252.46 |
| `quotient_poly_compute_time_ms` |  349.90 |  699.79 |  526.55 |  173.24 |
| `quotient_poly_commit_time_ms` |  130.22 |  260.43 |  229.93 |  30.50 |
| `pcs_opening_time_ms ` |  738 |  1,476 |  829 |  647 |

| internal.0 |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  2,804 |  2,804 |  2,804 |  2,804 |
| `main_cells_used     ` |  20,592,928 |  20,592,928 |  20,592,928 |  20,592,928 |
| `total_cells_used    ` |  43,709,890 |  43,709,890 |  43,709,890 |  43,709,890 |
| `execute_preflight_insns` |  4,041,674 |  4,041,674 |  4,041,674 |  4,041,674 |
| `execute_preflight_time_ms` |  1,522 |  1,522 |  1,522 |  1,522 |
| `execute_preflight_insn_mi/s` |  6 | -          |  6 |  6 |
| `trace_gen_time_ms   ` |  164 |  164 |  164 |  164 |
| `memory_finalize_time_ms` |  15 |  15 |  15 |  15 |
| `stark_prove_excluding_trace_time_ms` |  1,117 |  1,117 |  1,117 |  1,117 |
| `main_trace_commit_time_ms` |  259 |  259 |  259 |  259 |
| `generate_perm_trace_time_ms` |  41 |  41 |  41 |  41 |
| `perm_trace_commit_time_ms` |  187.92 |  187.92 |  187.92 |  187.92 |
| `quotient_poly_compute_time_ms` |  282.91 |  282.91 |  282.91 |  282.91 |
| `quotient_poly_commit_time_ms` |  75.21 |  75.21 |  75.21 |  75.21 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal.0 |  | 2,810 |  | 3 | 2 |  |  |  |  | 
| kitchen_sink |  |  | 1,212 |  | 1 | 7 | 154,763 | 20.08 | 0 | 
| leaf | 2,960 |  |  | 1 | 1 |  |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal.0 | 0 | 164 | 2,804 | 43,709,890 | 732,015,074 | 164 | 1,117 | 0 | 282.91 | 75.21 | 6 | 187.92 | 266 | 230 | 266 | 15 | 259 | 20,592,928 | 41 | 1,522 | 4,041,674 | 6 | 44 | 360 | 0 | 266 | 
| leaf | 0 | 640 | 7,465 | 193,614,318 | 3,758,099,946 | 640 | 4,343 | 0 | 526.55 | 229.93 | 6 | 1,600.22 | 829 | 1,999 | 828 | 36 | 734 | 83,649,940 | 398 | 2,481 | 9,308,259 | 5.72 | 204 | 780 | 35 | 828 | 
| leaf | 1 | 216 | 2,956 | 93,232,594 | 1,225,346,538 | 216 | 1,320 | 0 | 173.24 | 30.50 | 6 | 252.46 | 647 | 310 | 647 | 23 | 156 | 41,597,560 | 57 | 1,418 | 3,269,239 | 5.86 | 43 | 205 | 0 | 647 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| kitchen_sink | 0 | 141 | 1,709 | 39,702,956 | 760,599,754 | 141 | 1,290 | 0 | 454.89 | 10.34 | 17 | 96.84 | 353 | 261 | 352 | 0 | 209 | 10,085,858 | 139 | 132 | 121,000 | 11.36 | 61 | 465 | 3 | 352 | 
| kitchen_sink | 1 | 132 | 1,212 | 36,350,580 | 747,143,466 | 132 | 944 | 0 | 294.22 | 8.52 | 9 | 64.53 | 344 | 116 | 344 | 0 | 180 | 8,253,090 | 45 | 94 | 33,763 | 5.73 | 29 | 303 | 1 | 344 | 

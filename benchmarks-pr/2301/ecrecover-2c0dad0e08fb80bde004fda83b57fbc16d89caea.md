...
|:---|---:|---:|---:|
| Total |  6.76 |  6.76 | 6.76 |
| ecrecover_program |  1.23 |  1.23 |  1.23 |
| leaf |  5.53 |  5.53 |  5.53 |
...
| `total_proof_time_ms ` |  1,226 |  1,226 |  1,226 |  1,226 |
...
| `quotient_poly_compute_time_ms` |  104.82 |  104.82 |  104.82 |  104.82 |
| `quotient_poly_commit_time_ms` |  9.15 |  9.15 |  9.15 |  9.15 |
| `pcs_opening_time_ms ` |  550 |  550 |  550 |  550 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  5,532 |  5,532 |  5,532 |  5,532 |
| `main_cells_used     ` |  34,465,046 |  34,465,046 |  34,465,046 |  34,465,046 |
| `total_cells_used    ` |  83,385,200 |  83,385,200 |  83,385,200 |  83,385,200 |
| `execute_preflight_insns` |  4,109,157 |  4,109,157 |  4,109,157 |  4,109,157 |
| `execute_preflight_time_ms` |  731 |  731 |  731 |  731 |
| `execute_preflight_insn_mi/s` |  5.87 | -          |  5.87 |  5.87 |
| `trace_gen_time_ms   ` |  311 |  311 |  311 |  311 |
| `memory_finalize_time_ms` |  26 |  26 |  26 |  26 |
| `stark_prove_excluding_trace_time_ms` |  4,489 |  4,489 |  4,489 |  4,489 |
| `main_trace_commit_time_ms` |  725 |  725 |  725 |  725 |
| `generate_perm_trace_time_ms` |  350 |  350 |  350 |  350 |
| `perm_trace_commit_time_ms` |  1,499.60 |  1,499.60 |  1,499.60 |  1,499.60 |
| `quotient_poly_compute_time_ms` |  828.21 |  828.21 |  828.21 |  828.21 |
| `quotient_poly_commit_time_ms` |  200.48 |  200.48 |  200.48 |  200.48 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program |  | 1,226 |  | 1 | 6 | 122,859 | 19.70 | 0 | 
| leaf | 5,537 |  | 1 | 1 |  |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 311 | 5,532 | 83,385,200 | 1,726,057,962 | 311 | 4,489 | 0 | 828.21 | 200.48 | 6 | 1,499.60 | 878 | 1,851 | 878 | 26 | 725 | 34,465,046 | 350 | 731 | 4,109,157 | 5.87 | 268 | 1,033 | 13 | 878 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 216 | 1,226 | 11,344,654 | 31,789,298 | 216 | 778 | 0 | 104.82 | 9.15 | 10 | 34.12 | 550 | 75 | 550 | 0 | 37 | 2,262,772 | 34 | 61 | 122,859 | 2.17 | 21 | 114 | 1 | 550 | 

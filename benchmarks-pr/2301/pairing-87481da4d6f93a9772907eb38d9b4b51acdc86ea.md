...
|:---|---:|---:|---:|
| Total |  2.30 |  1.40 | 1.40 |
| pairing |  2.30 |  1.40 |  1.40 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,116 |  2,232 |  1,333 |  899 |
...
| `execute_preflight_insn_mi/s` |  14.60 | -          |  17.96 |  11.25 |
| `trace_gen_time_ms   ` |  189.50 |  379 |  194 |  185 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  738 |  1,476 |  874 |  602 |
| `main_trace_commit_time_ms` |  64.50 |  129 |  75 |  54 |
| `generate_perm_trace_time_ms` |  38 |  76 |  41 |  35 |
| `perm_trace_commit_time_ms` |  77.13 |  154.25 |  88.97 |  65.28 |
| `quotient_poly_compute_time_ms` |  84.34 |  168.67 |  94.07 |  74.61 |
| `quotient_poly_commit_time_ms` |  17.51 |  35.02 |  19.56 |  15.47 |
| `pcs_opening_time_ms ` |  452 |  904 |  557 |  347 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 899 | 1 | 63 | 1,745,742 | 27.50 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 185 | 1,333 | 32,480,114 | 172,558,444 | 185 | 874 | 0 | 94.07 | 19.56 | 9 | 88.97 | 557 | 126 | 557 | 1 | 75 | 15,909,408 | 35 | 105 | 1,149,000 | 11.25 | 27 | 114 | 1 | 557 | 
| pairing | 1 | 194 | 899 | 22,464,232 | 119,958,502 | 194 | 602 | 1 | 74.61 | 15.47 | 8 | 65.28 | 347 | 109 | 347 | 0 | 54 | 9,498,894 | 41 | 61 | 596,742 | 17.96 | 21 | 90 | 1 | 347 | 

...
|:---|---:|---:|
| Total | <span style='color: green'>(-0 [-0.7%])</span> 19.11 | <span style='color: green'>(-0 [-0.9%])</span> 11.80 |
| regex_program | <span style='color: green'>(-0 [-1.7%])</span> 7.62 | <span style='color: green'>(-0 [-2.1%])</span> 4.89 |
| leaf |  11.46 |  6.88 |
...
| `total_proof_time_ms ` | <span style='color: green'>(-64 [-1.7%])</span> 3,808.50 | <span style='color: green'>(-128 [-1.7%])</span> 7,617 | <span style='color: green'>(-105 [-2.1%])</span> 4,886 | <span style='color: green'>(-23 [-0.8%])</span> 2,731 |
...
| `execute_metered_insn_mi/s` | <span style='color: green'>(-1 [-0.8%])</span> 126.23 | -          | <span style='color: green'>(-1 [-0.8%])</span> 126.23 | <span style='color: green'>(-1 [-0.8%])</span> 126.23 |
| `execute_preflight_insns` |  2,054,298.50 |  4,108,597 |  2,211,000 |  1,897,597 |
| `execute_preflight_time_ms` | <span style='color: green'>(-2 [-2.6%])</span> 92.50 | <span style='color: green'>(-5 [-2.6%])</span> 185 | <span style='color: green'>(-2 [-2.0%])</span> 100 | <span style='color: green'>(-3 [-3.4%])</span> 85 |
| `execute_preflight_insn_mi/s` | <span style='color: green'>(-0 [-0.6%])</span> 28.46 | -          | <span style='color: green'>(-0 [-0.6%])</span> 30.82 | <span style='color: green'>(-0 [-0.5%])</span> 26.10 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+1 [+0.3%])</span> 383.50 | <span style='color: red'>(+2 [+0.3%])</span> 767 | <span style='color: green'>(-2 [-0.4%])</span> 493 | <span style='color: red'>(+4 [+1.5%])</span> 274 |
...
| `stark_prove_excluding_trace_time_ms` | <span style='color: green'>(-66 [-2.1%])</span> 3,101.50 | <span style='color: green'>(-133 [-2.1%])</span> 6,203 | <span style='color: green'>(-105 [-2.5%])</span> 4,047 | <span style='color: green'>(-28 [-1.3%])</span> 2,156 |
| `main_trace_commit_time_ms` | <span style='color: green'>(-18 [-2.8%])</span> 630 | <span style='color: green'>(-36 [-2.8%])</span> 1,260 | <span style='color: green'>(-35 [-4.0%])</span> 846 | <span style='color: green'>(-1 [-0.2%])</span> 414 |
| `generate_perm_trace_time_ms` | <span style='color: red'>(+6 [+2.7%])</span> 231 | <span style='color: red'>(+12 [+2.7%])</span> 462 | <span style='color: red'>(+6 [+2.0%])</span> 302 | <span style='color: red'>(+6 [+3.9%])</span> 160 |
| `perm_trace_commit_time_ms` | <span style='color: green'>(-24 [-3.5%])</span> 649.50 | <span style='color: green'>(-47 [-3.5%])</span> 1,299 | <span style='color: green'>(-44 [-4.9%])</span> 851 | <span style='color: green'>(-3 [-0.7%])</span> 448 |
| `quotient_poly_compute_time_ms` | <span style='color: green'>(-5 [-1.5%])</span> 322.50 | <span style='color: green'>(-10 [-1.5%])</span> 645 | <span style='color: red'>(+18 [+4.2%])</span> 447 | <span style='color: green'>(-28 [-12.4%])</span> 198 |
| `quotient_poly_commit_time_ms` | <span style='color: green'>(-2 [-0.5%])</span> 301.50 | <span style='color: green'>(-3 [-0.5%])</span> 603 |  396 | <span style='color: green'>(-3 [-1.4%])</span> 207 |
| `pcs_opening_time_ms ` | <span style='color: green'>(-24 [-2.4%])</span> 959.50 | <span style='color: green'>(-48 [-2.4%])</span> 1,919 | <span style='color: green'>(-50 [-4.0%])</span> 1,200 | <span style='color: red'>(+2 [+0.3%])</span> 719 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  5,729 |  11,458 |  6,877 |  4,581 |
| `main_cells_used     ` |  122,269,971 |  244,539,942 |  153,709,100 |  90,830,842 |
| `total_cells_used    ` |  304,358,821 |  608,717,642 |  391,462,082 |  217,255,560 |
| `execute_preflight_insns` |  1,663,339 |  3,326,678 |  1,830,045 |  1,496,633 |
| `execute_preflight_time_ms` |  585.50 |  1,171 |  738 |  433 |
| `execute_preflight_insn_mi/s` |  4.34 | -          |  4.50 |  4.18 |
| `trace_gen_time_ms   ` |  300 |  600 |  371 |  229 |
| `memory_finalize_time_ms` |  11.50 |  23 |  14 |  9 |
| `stark_prove_excluding_trace_time_ms` |  3,784.50 |  7,569 |  4,710 |  2,859 |
| `main_trace_commit_time_ms` |  710.50 |  1,421 |  842 |  579 |
| `generate_perm_trace_time_ms` |  315.50 |  631 |  404 |  227 |
| `perm_trace_commit_time_ms` |  959.50 |  1,919 |  1,245 |  674 |
| `quotient_poly_compute_time_ms` |  425.50 |  851 |  525 |  326 |
| `quotient_poly_commit_time_ms` |  318.50 |  637 |  378 |  259 |
| `pcs_opening_time_ms ` |  1,050.50 |  2,101 |  1,312 |  789 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf |  | 6,879 |  | 1 |  | 1 |  |  |  |  | 
| regex_program | 1 |  | 2,731 |  | 6 | 1 | 32 | 4,108,597 | 126.23 | 44 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 0 | 229 | 4,581 | 217,255,560 | 319,626,730 | 229 | 2,859 | 0 | 326 | 259 | 674 | 789 | 9 | 579 | 90,830,842 | 227 | 433 | 1,496,633 | 4.18 | 
| leaf | 1 | 4 | 371 | 6,877 | 391,462,082 | 538,660,330 | 371 | 4,710 | 0 | 525 | 378 | 1,245 | 1,312 | 14 | 842 | 153,709,100 | 404 | 738 | 1,830,045 | 4.50 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 493 | 4,886 | 211,758,557 | 373,183,036 | 493 | 4,047 | 0 | 447 | 396 | 851 | 1,200 | 7 | 13 | 846 | 91,281,687 | 302 | 100 | 2,211,000 | 26.10 | 
| regex_program | 1 | 274 | 2,731 | 174,326,267 | 196,838,026 | 274 | 2,156 | 50 | 198 | 207 | 448 | 719 | 6 | 2 | 414 | 73,453,305 | 160 | 85 | 1,897,597 | 30.82 | 

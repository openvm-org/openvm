...
|:---|---:|---:|
| Total | <span style='color: green'>(-0 [-0.3%])</span> 19.15 | <span style='color: green'>(-0 [-0.6%])</span> 11.84 |
| regex_program | <span style='color: green'>(-0 [-0.7%])</span> 7.69 | <span style='color: green'>(-0 [-1.5%])</span> 4.91 |
| leaf |  11.43 |  6.90 |
...
| `total_proof_time_ms ` | <span style='color: green'>(-29 [-0.7%])</span> 3,843.50 | <span style='color: green'>(-58 [-0.7%])</span> 7,687 | <span style='color: green'>(-77 [-1.5%])</span> 4,914 | <span style='color: red'>(+19 [+0.7%])</span> 2,773 |
...
| `execute_metered_insn_mi/s` | <span style='color: green'>(-0 [-0.3%])</span> 126.84 | -          | <span style='color: green'>(-0 [-0.3%])</span> 126.84 | <span style='color: green'>(-0 [-0.3%])</span> 126.84 |
| `execute_preflight_insns` |  2,054,298.50 |  4,108,597 |  2,211,000 |  1,897,597 |
| `execute_preflight_time_ms` | <span style='color: green'>(-1 [-1.1%])</span> 94 | <span style='color: green'>(-2 [-1.1%])</span> 188 | <span style='color: red'>(+2 [+2.0%])</span> 104 | <span style='color: green'>(-4 [-4.5%])</span> 84 |
| `execute_preflight_insn_mi/s` | <span style='color: green'>(-0 [-0.2%])</span> 28.58 | -          | <span style='color: green'>(-0 [-0.3%])</span> 30.93 |  26.22 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+6 [+1.4%])</span> 388 | <span style='color: red'>(+11 [+1.4%])</span> 776 | <span style='color: red'>(+1 [+0.2%])</span> 496 | <span style='color: red'>(+10 [+3.7%])</span> 280 |
...
| `stark_prove_excluding_trace_time_ms` | <span style='color: green'>(-34 [-1.1%])</span> 3,134 | <span style='color: green'>(-68 [-1.1%])</span> 6,268 | <span style='color: green'>(-77 [-1.9%])</span> 4,075 | <span style='color: red'>(+9 [+0.4%])</span> 2,193 |
| `main_trace_commit_time_ms` | <span style='color: green'>(-30 [-4.6%])</span> 618 | <span style='color: green'>(-60 [-4.6%])</span> 1,236 | <span style='color: green'>(-39 [-4.4%])</span> 842 | <span style='color: green'>(-21 [-5.1%])</span> 394 |
| `generate_perm_trace_time_ms` | <span style='color: red'>(+13 [+5.8%])</span> 238 | <span style='color: red'>(+26 [+5.8%])</span> 476 | <span style='color: red'>(+28 [+9.5%])</span> 324 | <span style='color: green'>(-2 [-1.3%])</span> 152 |
| `perm_trace_commit_time_ms` | <span style='color: red'>(+1 [+0.1%])</span> 674 | <span style='color: red'>(+2 [+0.1%])</span> 1,348 | <span style='color: green'>(-43 [-4.8%])</span> 852 | <span style='color: red'>(+45 [+10.0%])</span> 496 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+6 [+1.8%])</span> 333.50 | <span style='color: red'>(+12 [+1.8%])</span> 667 | <span style='color: red'>(+24 [+5.6%])</span> 453 | <span style='color: green'>(-12 [-5.3%])</span> 214 |
...
| `pcs_opening_time_ms ` | <span style='color: green'>(-22 [-2.2%])</span> 961.50 | <span style='color: green'>(-44 [-2.2%])</span> 1,923 | <span style='color: green'>(-46 [-3.7%])</span> 1,204 | <span style='color: red'>(+2 [+0.3%])</span> 719 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  5,715.50 |  11,431 |  6,896 |  4,535 |
| `main_cells_used     ` |  122,269,761 |  244,539,522 |  153,708,872 |  90,830,650 |
| `total_cells_used    ` |  304,358,121 |  608,716,242 |  391,461,322 |  217,254,920 |
| `execute_preflight_insns` |  1,663,321.50 |  3,326,643 |  1,830,026 |  1,496,617 |
| `execute_preflight_time_ms` |  586 |  1,172 |  745 |  427 |
| `execute_preflight_insn_mi/s` |  4.38 | -          |  4.52 |  4.23 |
| `trace_gen_time_ms   ` |  310 |  620 |  383 |  237 |
| `memory_finalize_time_ms` |  11.50 |  23 |  14 |  9 |
| `stark_prove_excluding_trace_time_ms` |  3,788 |  7,576 |  4,740 |  2,836 |
| `main_trace_commit_time_ms` |  720.50 |  1,441 |  869 |  572 |
| `generate_perm_trace_time_ms` |  322.50 |  645 |  429 |  216 |
| `perm_trace_commit_time_ms` |  957 |  1,914 |  1,244 |  670 |
| `quotient_poly_compute_time_ms` |  423 |  846 |  518 |  328 |
| `quotient_poly_commit_time_ms` |  316.50 |  633 |  377 |  256 |
| `pcs_opening_time_ms ` |  1,043 |  2,086 |  1,298 |  788 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf |  | 6,898 |  | 1 |  | 1 |  |  |  |  | 
| regex_program | 1 |  | 2,773 |  | 6 | 1 | 32 | 4,108,597 | 126.84 | 45 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 0 | 237 | 4,535 | 217,254,920 | 319,626,730 | 237 | 2,836 | 0 | 328 | 256 | 670 | 788 | 9 | 572 | 90,830,650 | 216 | 427 | 1,496,617 | 4.23 | 
| leaf | 1 | 4 | 383 | 6,896 | 391,461,322 | 538,660,330 | 383 | 4,740 | 0 | 518 | 377 | 1,244 | 1,298 | 14 | 869 | 153,708,872 | 429 | 745 | 1,830,026 | 4.52 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 496 | 4,914 | 211,758,557 | 373,183,036 | 496 | 4,075 | 0 | 453 | 396 | 852 | 1,204 | 7 | 13 | 842 | 91,281,687 | 324 | 104 | 2,211,000 | 26.22 | 
| regex_program | 1 | 280 | 2,773 | 174,326,267 | 196,838,026 | 280 | 2,193 | 52 | 214 | 207 | 496 | 719 | 6 | 2 | 394 | 73,453,305 | 152 | 84 | 1,897,597 | 30.93 | 

...
|:---|---:|---:|
| Total | <span style='color: green'>(-0 [-0.3%])</span> 19.14 | <span style='color: green'>(-0 [-0.3%])</span> 11.86 |
| regex_program | <span style='color: green'>(-0 [-0.7%])</span> 7.69 | <span style='color: green'>(-0 [-0.8%])</span> 4.95 |
| leaf |  11.42 |  6.88 |
...
| `total_proof_time_ms ` | <span style='color: green'>(-28 [-0.7%])</span> 3,844 | <span style='color: green'>(-57 [-0.7%])</span> 7,688 | <span style='color: green'>(-40 [-0.8%])</span> 4,951 | <span style='color: green'>(-17 [-0.6%])</span> 2,737 |
...
| `execute_metered_insn_mi/s` | <span style='color: green'>(-2 [-1.6%])</span> 125.23 | -          | <span style='color: green'>(-2 [-1.6%])</span> 125.23 | <span style='color: green'>(-2 [-1.6%])</span> 125.23 |
| `execute_preflight_insns` |  2,054,298.50 |  4,108,597 |  2,211,000 |  1,897,597 |
| `execute_preflight_time_ms` | <span style='color: green'>(-2 [-1.6%])</span> 93.50 | <span style='color: green'>(-3 [-1.6%])</span> 187 |  102 | <span style='color: green'>(-3 [-3.4%])</span> 85 |
| `execute_preflight_insn_mi/s` | <span style='color: green'>(-0 [-1.2%])</span> 28.28 | -          | <span style='color: green'>(-0 [-1.2%])</span> 30.64 | <span style='color: green'>(-0 [-1.2%])</span> 25.93 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+10 [+2.6%])</span> 392.50 | <span style='color: red'>(+20 [+2.6%])</span> 785 | <span style='color: red'>(+9 [+1.8%])</span> 504 | <span style='color: red'>(+11 [+4.1%])</span> 281 |
| `memory_finalize_time_ms` |  8 |  16 |  14 |  2 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: green'>(-42 [-1.3%])</span> 3,125.50 | <span style='color: green'>(-85 [-1.3%])</span> 6,251 | <span style='color: green'>(-48 [-1.2%])</span> 4,104 | <span style='color: green'>(-37 [-1.7%])</span> 2,147 |
| `main_trace_commit_time_ms` | <span style='color: green'>(-24 [-3.8%])</span> 623.50 | <span style='color: green'>(-49 [-3.8%])</span> 1,247 | <span style='color: green'>(-37 [-4.2%])</span> 844 | <span style='color: green'>(-12 [-2.9%])</span> 403 |
| `generate_perm_trace_time_ms` | <span style='color: red'>(+13 [+5.8%])</span> 238 | <span style='color: red'>(+26 [+5.8%])</span> 476 | <span style='color: red'>(+23 [+7.8%])</span> 319 | <span style='color: red'>(+3 [+1.9%])</span> 157 |
| `perm_trace_commit_time_ms` | <span style='color: green'>(-25 [-3.7%])</span> 648 | <span style='color: green'>(-50 [-3.7%])</span> 1,296 | <span style='color: green'>(-47 [-5.3%])</span> 848 | <span style='color: green'>(-3 [-0.7%])</span> 448 |
| `quotient_poly_compute_time_ms` | <span style='color: green'>(-10 [-3.2%])</span> 317 | <span style='color: green'>(-21 [-3.2%])</span> 634 | <span style='color: green'>(-4 [-0.9%])</span> 425 | <span style='color: green'>(-17 [-7.5%])</span> 209 |
| `quotient_poly_commit_time_ms` | <span style='color: green'>(-3 [-1.0%])</span> 300 | <span style='color: green'>(-6 [-1.0%])</span> 600 | <span style='color: red'>(+2 [+0.5%])</span> 398 | <span style='color: green'>(-8 [-3.8%])</span> 202 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+8 [+0.8%])</span> 991.50 | <span style='color: red'>(+16 [+0.8%])</span> 1,983 | <span style='color: red'>(+14 [+1.1%])</span> 1,264 | <span style='color: red'>(+2 [+0.3%])</span> 719 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  5,711.50 |  11,423 |  6,878 |  4,545 |
| `main_cells_used     ` |  122,270,247 |  244,540,494 |  153,709,784 |  90,830,710 |
| `total_cells_used    ` |  304,359,741 |  608,719,482 |  391,464,362 |  217,255,120 |
| `execute_preflight_insns` |  1,663,362 |  3,326,724 |  1,830,102 |  1,496,622 |
| `execute_preflight_time_ms` |  602.50 |  1,205 |  760 |  445 |
| `execute_preflight_insn_mi/s` |  4.23 | -          |  4.40 |  4.06 |
| `trace_gen_time_ms   ` |  302.50 |  605 |  375 |  230 |
| `memory_finalize_time_ms` |  11 |  22 |  13 |  9 |
| `stark_prove_excluding_trace_time_ms` |  3,763.50 |  7,527 |  4,713 |  2,814 |
| `main_trace_commit_time_ms` |  718 |  1,436 |  849 |  587 |
| `generate_perm_trace_time_ms` |  317.50 |  635 |  414 |  221 |
| `perm_trace_commit_time_ms` |  955 |  1,910 |  1,242 |  668 |
| `quotient_poly_compute_time_ms` |  421.50 |  843 |  538 |  305 |
| `quotient_poly_commit_time_ms` |  315.50 |  631 |  377 |  254 |
| `pcs_opening_time_ms ` |  1,031.50 |  2,063 |  1,289 |  774 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf |  | 6,880 |  | 1 |  | 1 |  |  |  |  | 
| regex_program | 1 |  | 2,737 |  | 6 | 1 | 32 | 4,108,597 | 125.23 | 44 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 0 | 230 | 4,545 | 217,255,120 | 319,626,730 | 230 | 2,814 | 0 | 305 | 254 | 668 | 774 | 9 | 587 | 90,830,710 | 221 | 445 | 1,496,622 | 4.06 | 
| leaf | 1 | 4 | 375 | 6,878 | 391,464,362 | 538,660,330 | 375 | 4,713 | 0 | 538 | 377 | 1,242 | 1,289 | 13 | 849 | 153,709,784 | 414 | 760 | 1,830,102 | 4.40 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 504 | 4,951 | 211,758,557 | 373,183,036 | 504 | 4,104 | 0 | 425 | 398 | 848 | 1,264 | 7 | 14 | 844 | 91,281,687 | 319 | 102 | 2,211,000 | 25.93 | 
| regex_program | 1 | 281 | 2,737 | 174,326,267 | 196,838,026 | 281 | 2,147 | 53 | 209 | 202 | 448 | 719 | 7 | 2 | 403 | 73,453,305 | 157 | 85 | 1,897,597 | 30.64 | 

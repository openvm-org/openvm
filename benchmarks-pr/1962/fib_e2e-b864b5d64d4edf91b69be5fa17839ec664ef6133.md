...
| fib_e2e |  20.88 |  3.24 |
| leaf |  24.32 |  4.12 |
| internal.0 |  28.58 |  11.44 |
| internal.1 |  8.03 |  8.03 |
| root |  38.55 |  38.55 |
| halo2_outer |  91.83 |  91.83 |
...
| `total_proof_time_ms ` |  2,982.29 |  20,876 |  3,243 |  2,273 |
...
| `execute_preflight_insn_mi/s` |  37 | -          |  37.11 |  36.82 |
| `trace_gen_time_ms   ` |  224.43 |  1,571 |  228 |  206 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| `stark_prove_excluding_trace_time_ms` |  2,473.86 |  17,317 |  2,699 |  1,801 |
| `main_trace_commit_time_ms` |  467.57 |  3,273 |  520 |  348 |
| `generate_perm_trace_time_ms` |  182.86 |  1,280 |  210 |  128 |
| `perm_trace_commit_time_ms` |  565 |  3,955 |  620 |  381 |
| `quotient_poly_compute_time_ms` |  239.57 |  1,677 |  255 |  162 |
| `quotient_poly_commit_time_ms` |  212.86 |  1,490 |  264 |  171 |
| `pcs_opening_time_ms ` |  800.71 |  5,605 |  845 |  603 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  3,474.43 |  24,321 |  4,123 |  3,263 |
| `main_cells_used     ` |  63,012,825.57 |  441,089,779 |  72,248,541 |  60,332,769 |
| `total_cells_used    ` |  147,166,902.43 |  1,030,168,317 |  170,627,491 |  140,164,343 |
| `execute_preflight_insns` |  1,066,092.57 |  7,462,648 |  1,260,060 |  1,007,127 |
| `execute_preflight_time_ms` |  466.29 |  3,264 |  483 |  462 |
| `execute_preflight_insn_mi/s` |  3.42 | -          |  3.87 |  3.23 |
| `trace_gen_time_ms   ` |  156.43 |  1,095 |  184 |  147 |
| `memory_finalize_time_ms` |  8.43 |  59 |  9 |  8 |
| `stark_prove_excluding_trace_time_ms` |  1,815.29 |  12,707 |  2,445 |  1,608 |
| `main_trace_commit_time_ms` |  346.86 |  2,428 |  469 |  299 |
| `generate_perm_trace_time_ms` |  127.57 |  893 |  174 |  115 |
| `perm_trace_commit_time_ms` |  427.43 |  2,992 |  574 |  368 |
| `quotient_poly_compute_time_ms` |  199.71 |  1,398 |  262 |  178 |
| `quotient_poly_commit_time_ms` |  164.57 |  1,152 |  239 |  146 |
| `pcs_opening_time_ms ` |  542 |  3,794 |  721 |  486 |

| internal.0 |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  9,525.33 |  28,576 |  11,438 |  5,847 |
| `main_cells_used     ` |  162,337,165.67 |  487,011,497 |  207,106,647 |  74,651,193 |
| `total_cells_used    ` |  292,155,910.33 |  876,467,731 |  371,616,513 |  136,141,323 |
| `execute_preflight_insns` |  2,660,564.67 |  7,981,694 |  3,422,821 |  1,151,454 |
| `execute_preflight_time_ms` |  813.33 |  2,440 |  1,004 |  447 |
| `execute_preflight_insn_mi/s` |  4.03 | -          |  4.11 |  3.94 |
| `trace_gen_time_ms   ` |  376.33 |  1,129 |  478 |  173 |
| `memory_finalize_time_ms` |  11 |  33 |  13 |  9 |
| `stark_prove_excluding_trace_time_ms` |  7,258.67 |  21,776 |  8,904 |  4,149 |
| `main_trace_commit_time_ms` |  1,648.67 |  4,946 |  2,108 |  824 |
| `generate_perm_trace_time_ms` |  325.67 |  977 |  404 |  174 |
| `perm_trace_commit_time_ms` |  1,278.33 |  3,835 |  1,556 |  747 |
| `quotient_poly_compute_time_ms` |  1,023.67 |  3,071 |  1,280 |  539 |
| `quotient_poly_commit_time_ms` |  1,054.33 |  3,163 |  1,326 |  659 |
| `pcs_opening_time_ms ` |  1,922 |  5,766 |  2,285 |  1,197 |

| internal.1 |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  8,026 |  8,026 |  8,026 |  8,026 |
| `main_cells_used     ` |  116,589,917 |  116,589,917 |  116,589,917 |  116,589,917 |
| `total_cells_used    ` |  207,813,275 |  207,813,275 |  207,813,275 |  207,813,275 |
| `execute_preflight_insns` |  2,330,605 |  2,330,605 |  2,330,605 |  2,330,605 |
...
| `stark_prove_excluding_trace_time_ms` |  6,034 |  6,034 |  6,034 |  6,034 |
...
| `main_cells_used     ` |  42,135,575 |  42,135,575 |  42,135,575 |  42,135,575 |
| `total_cells_used    ` |  65,006,165 |  65,006,165 |  65,006,165 |  65,006,165 |
| `execute_preflight_insns` |  779,766 |  779,766 |  779,766 |  779,766 |
| `execute_preflight_time_ms` |  165 |  165 |  165 |  165 |
| `execute_preflight_insn_mi/s` |  5.18 | -          |  5.18 |  5.18 |
| `trace_gen_time_ms   ` |  118 |  118 |  118 |  118 |
| `memory_finalize_time_ms` |  9 |  9 |  9 |  9 |
| `stark_prove_excluding_trace_time_ms` |  38,266 |  38,266 |  38,266 |  38,266 |
...
| `quotient_poly_commit_time_ms` |  13,613 |  13,613 |  13,613 |  13,613 |
| `pcs_opening_time_ms ` |  3,886 |  3,886 |  3,886 |  3,886 |

| halo2_outer |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  91,828 |  91,828 |  91,828 |  91,828 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  3,918.50 |  7,837 |  6,167 |  1,670 |
...
| `execute_preflight_time_ms` |  151 |  302 |  300 |  2 |
| `execute_preflight_insn_mi/s` |  9,223,372,036,854,775,807 | -          |  9,223,372,036,854,775,807 |  5.45 |
| `trace_gen_time_ms   ` |  73.50 |  147 |  113 |  34 |
| `memory_finalize_time_ms` |  5 |  10 |  8 |  2 |
| `stark_prove_excluding_trace_time_ms` |  2,333 |  4,666 |  4,176 |  490 |
| `main_trace_commit_time_ms` |  456.50 |  913 |  845 |  68 |
| `generate_perm_trace_time_ms` |  95.50 |  191 |  179 |  12 |
| `perm_trace_commit_time_ms` |  369 |  738 |  681 |  57 |
| `quotient_poly_compute_time_ms` |  284 |  568 |  543 |  25 |
| `quotient_poly_commit_time_ms` |  397.50 |  795 |  726 |  69 |
| `pcs_opening_time_ms ` |  724 |  1,448 |  1,195 |  253 |
...
| `execute_preflight_insn_mi/s` |  5.51 | -          |  5.51 |  5.51 |
| `trace_gen_time_ms   ` |  120 |  120 |  120 |  120 |
| `memory_finalize_time_ms` |  7 |  7 |  7 |  7 |
| `stark_prove_excluding_trace_time_ms` |  38,377 |  38,377 |  38,377 |  38,377 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
|  |
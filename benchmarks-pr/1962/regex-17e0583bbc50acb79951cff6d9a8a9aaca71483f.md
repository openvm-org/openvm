...
|:---|---:|---:|
| Total |  7.67 |  4.95 |
| regex_program |  7.64 |  4.92 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  3,820.50 |  7,641 |  4,917 |  2,724 |
...
| `execute_preflight_insn_mi/s` |  27.61 | -          |  29.75 |  25.47 |
| `trace_gen_time_ms   ` |  394 |  788 |  509 |  279 |
| `memory_finalize_time_ms` |  7.50 |  15 |  13 |  2 |
| `stark_prove_excluding_trace_time_ms` |  3,133.50 |  6,267 |  4,125 |  2,142 |
| `main_trace_commit_time_ms` |  624.50 |  1,249 |  838 |  411 |
| `generate_perm_trace_time_ms` |  234 |  468 |  322 |  146 |
| `perm_trace_commit_time_ms` |  653 |  1,306 |  851 |  455 |
| `quotient_poly_compute_time_ms` |  321.50 |  643 |  436 |  207 |
| `quotient_poly_commit_time_ms` |  297.50 |  595 |  399 |  196 |
| `pcs_opening_time_ms ` |  994 |  1,988 |  1,274 |  714 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 174 | 2,724 | 9 | 4,108,597 | 1 | 31 | 129.55 | 47 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 509 | 4,917 | 211,758,557 | 373,183,036 | 509 | 4,125 | 0 | 436 | 399 | 851 | 1,274 | 10 | 13 | 838 | 91,281,687 | 2,211,000 | 322 | 103 | 25.47 | 
| regex_program | 1 | 279 | 2,724 | 174,326,267 | 196,838,026 | 279 | 2,142 | 52 | 207 | 196 | 455 | 714 | 8 | 2 | 411 | 73,453,305 | 1,897,597 | 146 | 89 | 29.75 | 

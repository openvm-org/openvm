...
|:---|---:|---:|
| Total |  2.31 |  0.72 |
| regex_program |  2.27 |  0.69 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  568.25 |  2,273 |  685 |  518 |
...
| `execute_preflight_insn_mi/s` |  30.57 | -          |  31.62 |  27.60 |
| `trace_gen_time_ms   ` |  174.50 |  698 |  209 |  150 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  270.50 |  1,082 |  284 |  257 |
| `main_trace_commit_time_ms` |  50.50 |  202 |  55 |  49 |
| `generate_perm_trace_time_ms` |  25.25 |  101 |  28 |  22 |
| `perm_trace_commit_time_ms` |  64.17 |  256.69 |  70.89 |  55.24 |
| `quotient_poly_compute_time_ms` |  56.48 |  225.93 |  68.64 |  50.75 |
| `quotient_poly_commit_time_ms` |  14.62 |  58.48 |  16.23 |  13.12 |
| `pcs_opening_time_ms ` |  56.25 |  225 |  65 |  51 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 551 | 66 | 1 | 33 | 4,137,502 | 124.10 | 195 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 209 | 685 | 23,446,148 | 150,778,428 | 209 | 284 | 0 | 55.62 | 16.23 | 5 | 70.89 | 55 | 100 | 54 | 4 | 55 | 10,899,170 | 28 | 47 | 1,103,000 | 27.60 | 21 | 72 | 1 | 54 | 
| regex_program | 1 | 150 | 519 | 11,598,276 | 128,513,066 | 150 | 258 | 1 | 50.93 | 14.41 | 4 | 65.23 | 54 | 88 | 54 | 0 | 49 | 2,196,106 | 22 | 69 | 1,104,000 | 31.51 | 16 | 65 | 0 | 54 | 
| regex_program | 2 | 159 | 518 | 11,579,064 | 128,513,066 | 159 | 257 | 1 | 50.75 | 14.72 | 4 | 65.33 | 51 | 90 | 51 | 0 | 49 | 2,177,334 | 24 | 60 | 1,104,000 | 31.53 | 16 | 66 | 0 | 51 | 
| regex_program | 3 | 180 | 551 | 11,853,872 | 103,456,394 | 180 | 283 | 0 | 68.64 | 13.12 | 5 | 55.24 | 65 | 85 | 65 | 0 | 49 | 2,422,606 | 27 | 47 | 826,502 | 31.62 | 18 | 82 | 1 | 65 | 

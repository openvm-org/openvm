...
| `total_proof_time_ms ` |  722.50 |  1,445 |  834 |  611 |
...
| `execute_preflight_insn_mi/s` |  13.32 | -          |  17.62 |  9.02 |
| `trace_gen_time_ms   ` |  176.50 |  353 |  194 |  159 |
| `memory_finalize_time_ms` |  1 |  2 |  1 |  1 |
| `stark_prove_excluding_trace_time_ms` |  356 |  712 |  398 |  314 |
| `main_trace_commit_time_ms` |  64.50 |  129 |  75 |  54 |
| `generate_perm_trace_time_ms` |  43.50 |  87 |  48 |  39 |
| `perm_trace_commit_time_ms` |  77.41 |  154.82 |  89.29 |  65.52 |
| `quotient_poly_compute_time_ms` |  79.10 |  158.19 |  87.18 |  71.02 |
| `quotient_poly_commit_time_ms` |  16.68 |  33.37 |  18.66 |  14.71 |
| `pcs_opening_time_ms ` |  70 |  140 |  84 |  56 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 611 | 66 | 1 | 90 | 1,745,742 | 19.31 | 172 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 159 | 834 | 32,689,110 | 172,558,444 | 159 | 398 | 0 | 87.18 | 18.66 | 6 | 89.29 | 84 | 131 | 84 | 1 | 75 | 16,059,916 | 39 | 131 | 1,157,000 | 9.02 | 26 | 106 | 1 | 84 | 
| pairing | 1 | 194 | 611 | 22,314,288 | 119,958,502 | 194 | 314 | 1 | 71.02 | 14.71 | 6 | 65.52 | 56 | 117 | 56 | 1 | 54 | 9,408,294 | 48 | 61 | 588,742 | 17.62 | 20 | 86 | 1 | 56 | 

...
|:---|---:|---:|
| Total | <span style='color: green'>(-0 [-0.6%])</span> 2.38 | <span style='color: green'>(-0 [-0.5%])</span> 0.78 |
| regex_program | <span style='color: green'>(-0 [-0.6%])</span> 2.35 | <span style='color: green'>(-0 [-0.5%])</span> 0.74 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: green'>(-4 [-0.6%])</span> 586.25 | <span style='color: green'>(-14 [-0.6%])</span> 2,345 | <span style='color: green'>(-4 [-0.5%])</span> 741 | <span style='color: green'>(-8 [-1.5%])</span> 529 |
...
| `execute_metered_insn_mi/s` | <span style='color: green'>(-0 [-0.3%])</span> 113.72 | -          | <span style='color: green'>(-0 [-0.3%])</span> 113.72 | <span style='color: green'>(-0 [-0.3%])</span> 113.72 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` | <span style='color: red'>(+1 [+1.9%])</span> 54.75 | <span style='color: red'>(+4 [+1.9%])</span> 219 | <span style='color: red'>(+1 [+1.5%])</span> 66 | <span style='color: red'>(+1 [+2.2%])</span> 46 |
| `execute_preflight_insn_mi/s` | <span style='color: green'>(-0 [-1.2%])</span> 30.29 | -          | <span style='color: green'>(-1 [-1.9%])</span> 31.33 |  27.62 |
| `trace_gen_time_ms   ` | <span style='color: green'>(-3 [-1.8%])</span> 174.25 | <span style='color: green'>(-13 [-1.8%])</span> 697 | <span style='color: green'>(-4 [-1.9%])</span> 207 | <span style='color: green'>(-1 [-0.7%])</span> 152 |
| `memory_finalize_time_ms` |  1 |  4 |  4 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: green'>(-2 [-0.5%])</span> 289.50 | <span style='color: green'>(-6 [-0.5%])</span> 1,158 |  342 | <span style='color: green'>(-8 [-3.0%])</span> 262 |
...
| `perm_trace_commit_time_ms` | <span style='color: green'>(-1 [-1.7%])</span> 63.37 | <span style='color: green'>(-4 [-1.7%])</span> 253.46 | <span style='color: green'>(-1 [-1.9%])</span> 69.53 | <span style='color: green'>(-1 [-1.3%])</span> 55.06 |
| `quotient_poly_compute_time_ms` | <span style='color: green'>(-2 [-2.6%])</span> 56.89 | <span style='color: green'>(-6 [-2.6%])</span> 227.56 | <span style='color: green'>(-1 [-1.6%])</span> 68.60 | <span style='color: green'>(-2 [-4.2%])</span> 50.67 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+0 [+1.8%])</span> 14.92 | <span style='color: red'>(+1 [+1.8%])</span> 59.69 | <span style='color: green'>(-0 [-0.7%])</span> 16.61 | <span style='color: red'>(+0 [+1.2%])</span> 13.01 |
| `pcs_opening_time_ms ` |  65 |  260 | <span style='color: red'>(+2 [+2.4%])</span> 84 | <span style='color: green'>(-5 [-8.9%])</span> 51 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 531 | 1 | 36 | 4,137,502 | 113.72 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 207 | 741 | 23,446,148 | 150,778,428 | 207 | 342 | 0 | 57.41 | 16.61 | 5 | 69.53 | 84 | 126 | 83 | 4 | 57 | 10,899,170 | 55 | 47 | 1,103,000 | 27.62 | 22 | 74 | 1 | 83 | 
| regex_program | 1 | 152 | 544 | 11,598,276 | 128,513,066 | 152 | 284 | 1 | 50.67 | 15.70 | 4 | 64.75 | 63 | 103 | 63 | 0 | 50 | 2,196,106 | 37 | 66 | 1,104,000 | 31.33 | 17 | 67 | 0 | 63 | 
| regex_program | 2 | 158 | 529 | 11,579,064 | 128,513,066 | 158 | 270 | 1 | 50.88 | 14.37 | 4 | 64.11 | 62 | 91 | 61 | 0 | 49 | 2,177,334 | 27 | 60 | 1,104,000 | 31.17 | 16 | 65 | 0 | 61 | 
| regex_program | 3 | 180 | 531 | 11,853,872 | 103,456,394 | 180 | 262 | 1 | 68.60 | 13.01 | 5 | 55.06 | 51 | 77 | 51 | 0 | 50 | 2,422,606 | 19 | 46 | 826,502 | 31.05 | 18 | 82 | 1 | 51 | 
...
Commit: https://github.com/openvm-org/openvm/commit/7d8a8f758003d78aee714d41ad4ff8f91c867473
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19552489291)

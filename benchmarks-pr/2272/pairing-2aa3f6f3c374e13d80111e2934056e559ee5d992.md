...
|:---|---:|---:|
| Total | <span style='color: green'>(-0 [-4.4%])</span> 1.47 | <span style='color: green'>(-0 [-3.6%])</span> 0.88 |
| pairing | <span style='color: green'>(-0 [-2.8%])</span> 1.40 | <span style='color: green'>(-0 [-0.7%])</span> 0.82 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: green'>(-20 [-2.8%])</span> 702 | <span style='color: green'>(-40 [-2.8%])</span> 1,404 | <span style='color: green'>(-6 [-0.7%])</span> 818 | <span style='color: green'>(-34 [-5.5%])</span> 586 |
| `main_cells_used     ` |  12,734,105 |  25,468,210 |  16,059,916 |  9,408,294 |
| `total_cells_used    ` |  27,501,699 |  55,003,398 |  32,689,110 |  22,314,288 |
| `execute_metered_time_ms` | <span style='color: green'>(-27 [-30.0%])</span> 63 | -          | -          | -          |
| `execute_metered_insn_mi/s` | <span style='color: red'>(+8 [+43.8%])</span> 27.62 | -          | <span style='color: red'>(+8 [+43.8%])</span> 27.62 | <span style='color: red'>(+8 [+43.8%])</span> 27.62 |
| `execute_preflight_insns` |  872,871 |  1,745,742 |  1,157,000 |  588,742 |
| `execute_preflight_time_ms` | <span style='color: green'>(-12 [-12.7%])</span> 82.50 | <span style='color: green'>(-24 [-12.7%])</span> 165 | <span style='color: green'>(-24 [-18.5%])</span> 106 |  59 |
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+1 [+9.0%])</span> 14.64 | -          | <span style='color: red'>(+0 [+1.8%])</span> 18.06 | <span style='color: red'>(+2 [+22.9%])</span> 11.22 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+6 [+3.3%])</span> 188 | <span style='color: red'>(+12 [+3.3%])</span> 376 | <span style='color: green'>(-6 [-3.0%])</span> 193 | <span style='color: red'>(+18 [+10.9%])</span> 183 |
...
| `stark_prove_excluding_trace_time_ms` | <span style='color: green'>(-13 [-3.7%])</span> 339 | <span style='color: green'>(-26 [-3.7%])</span> 678 | <span style='color: red'>(+1 [+0.3%])</span> 385 | <span style='color: green'>(-27 [-8.4%])</span> 293 |
| `main_trace_commit_time_ms` | <span style='color: green'>(-0 [-0.8%])</span> 64.50 | <span style='color: green'>(-1 [-0.8%])</span> 129 |  75 | <span style='color: green'>(-1 [-1.8%])</span> 54 |
| `generate_perm_trace_time_ms` | <span style='color: green'>(-8 [-17.0%])</span> 36.50 | <span style='color: green'>(-15 [-17.0%])</span> 73 | <span style='color: green'>(-7 [-14.6%])</span> 41 | <span style='color: green'>(-8 [-20.0%])</span> 32 |
| `perm_trace_commit_time_ms` | <span style='color: red'>(+0 [+0.3%])</span> 76.74 | <span style='color: red'>(+0 [+0.3%])</span> 153.49 | <span style='color: green'>(-1 [-0.9%])</span> 88.82 | <span style='color: red'>(+1 [+1.9%])</span> 64.66 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+0 [+0.5%])</span> 78.69 | <span style='color: red'>(+1 [+0.5%])</span> 157.38 | <span style='color: green'>(-1 [-1.3%])</span> 86.98 | <span style='color: red'>(+2 [+2.8%])</span> 70.40 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+1 [+3.1%])</span> 16.80 | <span style='color: red'>(+1 [+3.1%])</span> 33.59 | <span style='color: red'>(+1 [+4.0%])</span> 19.04 | <span style='color: red'>(+0 [+1.9%])</span> 14.56 |
| `pcs_opening_time_ms ` | <span style='color: green'>(-6 [-8.3%])</span> 60.50 | <span style='color: green'>(-11 [-8.3%])</span> 121 | <span style='color: red'>(+2 [+3.0%])</span> 69 | <span style='color: green'>(-13 [-20.0%])</span> 52 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 586 | 1 | 63 | 1,745,742 | 27.62 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 183 | 818 | 32,689,110 | 172,558,444 | 183 | 385 | 0 | 86.98 | 19.04 | 6 | 88.82 | 69 | 133 | 69 | 0 | 75 | 16,059,916 | 41 | 106 | 1,157,000 | 11.22 | 26 | 106 | 1 | 69 | 
| pairing | 1 | 193 | 586 | 22,314,288 | 119,958,502 | 193 | 293 | 1 | 70.40 | 14.56 | 5 | 64.66 | 52 | 99 | 52 | 0 | 54 | 9,408,294 | 32 | 59 | 588,742 | 18.06 | 20 | 85 | 1 | 52 | 

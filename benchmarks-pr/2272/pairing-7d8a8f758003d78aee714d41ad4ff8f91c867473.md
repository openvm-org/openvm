...
|:---|---:|---:|
| Total | <span style='color: green'>(-0 [-1.2%])</span> 1.52 | <span style='color: green'>(-0 [-0.3%])</span> 0.91 |
| pairing | <span style='color: red'>(+0 [+0.6%])</span> 1.45 | <span style='color: red'>(+0 [+2.8%])</span> 0.85 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+4 [+0.6%])</span> 726 | <span style='color: red'>(+8 [+0.6%])</span> 1,452 | <span style='color: red'>(+23 [+2.8%])</span> 847 | <span style='color: green'>(-15 [-2.4%])</span> 605 |
| `main_cells_used     ` |  12,734,105 |  25,468,210 |  16,059,916 |  9,408,294 |
| `total_cells_used    ` |  27,501,699 |  55,003,398 |  32,689,110 |  22,314,288 |
| `execute_metered_time_ms` | <span style='color: green'>(-26 [-28.9%])</span> 64 | -          | -          | -          |
| `execute_metered_insn_mi/s` | <span style='color: red'>(+8 [+41.2%])</span> 27.12 | -          | <span style='color: red'>(+8 [+41.2%])</span> 27.12 | <span style='color: red'>(+8 [+41.2%])</span> 27.12 |
| `execute_preflight_insns` |  872,871 |  1,745,742 |  1,157,000 |  588,742 |
| `execute_preflight_time_ms` | <span style='color: green'>(-10 [-11.1%])</span> 84 | <span style='color: green'>(-21 [-11.1%])</span> 168 | <span style='color: green'>(-24 [-18.5%])</span> 106 | <span style='color: red'>(+3 [+5.1%])</span> 62 |
| `execute_preflight_insn_mi/s` | <span style='color: red'>(+1 [+9.8%])</span> 14.75 | -          | <span style='color: red'>(+0 [+2.7%])</span> 18.22 | <span style='color: red'>(+2 [+23.5%])</span> 11.28 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+8 [+4.1%])</span> 189.50 | <span style='color: red'>(+15 [+4.1%])</span> 379 | <span style='color: green'>(-6 [-3.0%])</span> 193 | <span style='color: red'>(+21 [+12.7%])</span> 186 |
...
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+6 [+1.7%])</span> 358 | <span style='color: red'>(+12 [+1.7%])</span> 716 | <span style='color: red'>(+24 [+6.2%])</span> 408 | <span style='color: green'>(-12 [-3.8%])</span> 308 |
...
| `generate_perm_trace_time_ms` | <span style='color: green'>(-4 [-8.0%])</span> 40.50 | <span style='color: green'>(-7 [-8.0%])</span> 81 | <span style='color: red'>(+2 [+4.2%])</span> 50 | <span style='color: green'>(-9 [-22.5%])</span> 31 |
| `perm_trace_commit_time_ms` | <span style='color: red'>(+1 [+1.7%])</span> 77.82 | <span style='color: red'>(+3 [+1.7%])</span> 155.65 | <span style='color: red'>(+0 [+0.3%])</span> 89.86 | <span style='color: red'>(+2 [+3.7%])</span> 65.79 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+1 [+1.4%])</span> 79.39 | <span style='color: red'>(+2 [+1.4%])</span> 158.78 | <span style='color: green'>(-0 [-0.5%])</span> 87.73 | <span style='color: red'>(+3 [+3.7%])</span> 71.05 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+1 [+4.6%])</span> 17.05 | <span style='color: red'>(+2 [+4.6%])</span> 34.10 | <span style='color: red'>(+1 [+5.7%])</span> 19.35 | <span style='color: red'>(+0 [+3.3%])</span> 14.75 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+8 [+11.4%])</span> 73.50 | <span style='color: red'>(+15 [+11.4%])</span> 147 | <span style='color: red'>(+15 [+22.4%])</span> 82 |  65 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 605 | 1 | 64 | 1,745,742 | 27.12 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 186 | 847 | 32,689,110 | 172,558,444 | 186 | 408 | 0 | 87.73 | 19.35 | 6 | 89.86 | 82 | 143 | 82 | 0 | 74 | 16,059,916 | 50 | 106 | 1,157,000 | 11.28 | 27 | 108 | 1 | 82 | 
| pairing | 1 | 193 | 605 | 22,314,288 | 119,958,502 | 193 | 308 | 1 | 71.05 | 14.75 | 6 | 65.79 | 65 | 100 | 65 | 0 | 55 | 9,408,294 | 31 | 62 | 588,742 | 18.22 | 21 | 86 | 1 | 65 | 

...
| `total_proof_time_ms ` |  578.50 |  2,314 |  716 |  524 |
...
| `execute_preflight_time_ms` |  46.25 |  185 |  58 |  34 |
| `execute_preflight_insn_mi/s` |  31.52 | -          |  32.18 |  30.37 |
| `trace_gen_time_ms   ` |  180.25 |  721 |  201 |  170 |
| `memory_finalize_time_ms` |  1 |  4 |  4 |  0 |
| `stark_prove_excluding_trace_time_ms` |  277.75 |  1,111 |  317 |  261 |
| `main_trace_commit_time_ms` |  52 |  208 |  58 |  50 |
| `generate_perm_trace_time_ms` |  28 |  112 |  46 |  20 |
| `perm_trace_commit_time_ms` |  64.26 |  257.05 |  69.84 |  54.23 |
| `quotient_poly_compute_time_ms` |  59.87 |  239.48 |  66.98 |  53.87 |
| `quotient_poly_commit_time_ms` |  16.07 |  64.27 |  18.36 |  14.17 |
...
| --- | --- | --- | --- | --- | --- | --- |
| regex_program | 545 | 1 | 36 | 4,137,600 | 112.34 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 170 | 716 | 150,778,428 | 170 | 317 | 0 | 63.31 | 18.36 | 5 | 69.84 | 59 | 117 | 59 | 4 | 58 | 46 | 58 | 1,103,000 | 30.37 | 22 | 82 | 1 | 59 | 
| regex_program | 1 | 175 | 529 | 128,513,066 | 175 | 265 | 1 | 55.32 | 15.83 | 4 | 68.08 | 53 | 89 | 53 | 0 | 50 | 21 | 47 | 1,104,000 | 31.87 | 17 | 71 | 0 | 52 | 
| regex_program | 2 | 175 | 524 | 128,513,066 | 175 | 261 | 1 | 53.87 | 15.91 | 4 | 64.89 | 49 | 90 | 49 | 0 | 50 | 25 | 46 | 1,104,000 | 32.18 | 17 | 70 | 0 | 49 | 
| regex_program | 3 | 201 | 545 | 103,473,675 | 201 | 268 | 0 | 66.98 | 14.17 | 5 | 54.23 | 56 | 77 | 56 | 0 | 50 | 20 | 34 | 826,600 | 31.65 | 19 | 82 | 1 | 56 | 

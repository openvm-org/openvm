...
| `total_proof_time_ms ` |  748 |  1,496 |  843 |  653 |
...
| `execute_preflight_insn_mi/s` |  14.65 | -          |  18.18 |  11.12 |
| `trace_gen_time_ms   ` |  180 |  360 |  201 |  159 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 |  0 |
| `stark_prove_excluding_trace_time_ms` |  378 |  756 |  393 |  363 |
| `main_trace_commit_time_ms` |  64 |  128 |  75 |  53 |
| `generate_perm_trace_time_ms` |  61 |  122 |  72 |  50 |
| `perm_trace_commit_time_ms` |  76.29 |  152.57 |  88.13 |  64.45 |
| `quotient_poly_compute_time_ms` |  82.56 |  165.13 |  91.70 |  73.43 |
| `quotient_poly_commit_time_ms` |  16.72 |  33.43 |  18.37 |  15.06 |
| `pcs_opening_time_ms ` |  73 |  146 |  81 |  65 |
...
| --- | --- | --- | --- | --- | --- | --- |
| pairing | 653 | 1 | 67 | 1,745,757 | 25.89 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 159 | 843 | 172,558,444 | 159 | 393 | 0 | 91.70 | 18.37 | 6 | 88.13 | 65 | 141 | 65 | 1 | 75 | 50 | 122 | 1,151,000 | 11.12 | 26 | 110 | 1 | 65 | 
| pairing | 1 | 201 | 653 | 119,958,502 | 201 | 363 | 1 | 73.43 | 15.06 | 5 | 64.45 | 81 | 139 | 81 | 0 | 53 | 72 | 47 | 594,757 | 18.18 | 20 | 89 | 1 | 81 | 

...
| `total_proof_time_ms ` |  1,194 |  2,388 |  1,423 |  965 |
...
| `execute_preflight_insn_mi/s` |  7.64 | -          |  10.31 |  4.97 |
| `trace_gen_time_ms   ` |  157.50 |  315 |  187 |  128 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  850.50 |  1,701 |  1,028 |  673 |
| `prover.main_trace_commit_time_ms` |  222.50 |  445 |  295 |  150 |
| `prover.rap_constraints_time_ms` |  565.50 |  1,131 |  659 |  472 |
| `prover.openings_time_ms` |  61.50 |  123 |  73 |  50 |
| `prover.rap_constraints.logup_gkr_time_ms` |  142 |  284 |  154 |  130 |
| `prover.rap_constraints.round0_time_ms` |  288.50 |  577 |  364 |  213 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/41ee564bf356d7fe7635f05e946b839d4422d2b2/kitchen_sink-41ee564bf356d7fe7635f05e946b839d4422d2b2.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 73 | 3 |  |  | 0 |  | 354 | 3 |  |  |  |  |  |  | 
| app_proof |  |  |  |  |  | 965 |  |  | 7 | 154,763 | 20.43 | 0 | 2,401 |  | 
...
| leaf | 0 | 108 | 421 | 108 | 26 | 11 | 17 | 5 | 5 | 
...
| leaf | 0 | prover | 407,935,872 | 312 | 124 | 0 | 9 | 142 | 46 | 45 | 36 | 59 | 0 | 44 | 13 | 31 | 6 | 24 | 125 | 142 | 0 | 2 | 59 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 816,542,084 | 1,028 | 295 | 0 | 166 | 659 | 364 | 363 | 140 | 154 | 62 | 73 | 12 | 60 | 15 | 44 | 295 | 659 | 0 | 1 | 91 | 0 | 0 | 
| app_proof | prover | 1 | 800,298,548 | 673 | 149 | 0 | 20 | 472 | 213 | 213 | 128 | 130 | 76 | 50 | 12 | 37 | 14 | 22 | 150 | 472 | 0 | 1 | 53 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 187 | 1,423 | 187 | 185 | 0 | 5 | 21 | 121,000 | 10.31 | 
| app_proof | 1 | 128 | 965 | 128 | 40 | 0 | 3 | 122 | 33,763 | 4.97 | 

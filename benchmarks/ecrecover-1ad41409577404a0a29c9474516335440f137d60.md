...
| `quotient_poly_compute_time_ms` |  305 |  305 |  305 |  305 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  41,932 |  41,932 |  41,932 |  41,932 |
| `main_cells_used     ` |  365,893,486 |  365,893,486 |  365,893,486 |  365,893,486 |
| `total_cycles        ` |  8,653,657 |  8,653,657 |  8,653,657 |  8,653,657 |
| `execute_time_ms     ` |  2,561 |  2,561 |  2,561 |  2,561 |
| `trace_gen_time_ms   ` |  6,481 |  6,481 |  6,481 |  6,481 |
| `stark_prove_excluding_trace_time_ms` |  32,890 |  32,890 |  32,890 |  32,890 |
| `main_trace_commit_time_ms` |  5,821 |  5,821 |  5,821 |  5,821 |
| `generate_perm_trace_time_ms` |  710 |  710 |  710 |  710 |
| `perm_trace_commit_time_ms` |  7,104 |  7,104 |  7,104 |  7,104 |
| `quotient_poly_compute_time_ms` |  7,786 |  7,786 |  7,786 |  7,786 |
| `quotient_poly_commit_time_ms` |  5,049 |  5,049 |  5,049 |  5,049 |
| `pcs_opening_time_ms ` |  6,417 |  6,417 |  6,417 |  6,417 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 6,481 | 41,932 | 8,653,657 | 1,052,183,000 | 32,890 | 7,786 | 5,049 | 7,104 | 6,417 | 5,821 | 365,893,486 | 710 | 2,561 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 260 | 2,616 | 285,401 | 56,172,159 | 2,210 | 305 | 306 | 533 | 620 | 402 | 15,092,297 | 40 | 146 | 

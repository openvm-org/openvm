...
|:---|---:|---:|---:|
| Total |  4.51 |  2.69 | 2.69 |
| pairing |  1.55 |  0.94 |  0.94 |
| leaf |  2.96 |  1.75 |  1.75 |
...
| `total_proof_time_ms ` |  745 |  1,490 |  880 |  610 |
...
| `execute_preflight_insn_mi/s` |  14.68 | -          |  18.05 |  11.32 |
| `trace_gen_time_ms   ` |  193 |  386 |  197 |  189 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  364.50 |  729 |  418 |  311 |
| `main_trace_commit_time_ms` |  66 |  132 |  77 |  55 |
| `generate_perm_trace_time_ms` |  46.50 |  93 |  54 |  39 |
| `perm_trace_commit_time_ms` |  77.38 |  154.76 |  90.24 |  64.52 |
| `quotient_poly_compute_time_ms` |  84.61 |  169.22 |  93.06 |  76.16 |
| `quotient_poly_commit_time_ms` |  17.60 |  35.19 |  20.15 |  15.05 |
| `pcs_opening_time_ms ` |  68 |  136 |  79 |  57 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,477.50 |  2,955 |  1,750 |  1,205 |
| `main_cells_used     ` |  16,200,472 |  32,400,944 |  16,332,746 |  16,068,198 |
| `total_cells_used    ` |  39,332,920 |  78,665,840 |  39,650,868 |  39,014,972 |
| `execute_preflight_insns` |  1,952,426 |  3,904,852 |  1,991,972 |  1,912,880 |
| `execute_preflight_time_ms` |  589.50 |  1,179 |  875 |  304 |
| `execute_preflight_insn_mi/s` |  7.50 | -          |  7.57 |  7.42 |
| `trace_gen_time_ms   ` |  119.50 |  239 |  129 |  110 |
| `memory_finalize_time_ms` |  12 |  24 |  13 |  11 |
| `stark_prove_excluding_trace_time_ms` |  767 |  1,534 |  771 |  763 |
| `main_trace_commit_time_ms` |  147 |  294 |  150 |  144 |
| `generate_perm_trace_time_ms` |  56 |  112 |  58 |  54 |
| `perm_trace_commit_time_ms` |  228.45 |  456.91 |  232.31 |  224.60 |
| `quotient_poly_compute_time_ms` |  176.02 |  352.05 |  178.68 |  173.37 |
| `quotient_poly_commit_time_ms` |  33.82 |  67.64 |  34.81 |  32.84 |
| `pcs_opening_time_ms ` |  122 |  244 |  131 |  113 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 1,752 |  | 1 | 1 |  |  |  |  | 
| pairing |  | 610 |  | 1 | 63 | 1,745,742 | 27.37 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 129 | 1,205 | 39,650,868 | 410,701,290 | 129 | 771 | 0 | 178.68 | 34.81 | 5 | 232.31 | 113 | 291 | 113 | 13 | 150 | 16,332,746 | 58 | 304 | 1,991,972 | 7.42 | 39 | 215 | 0 | 113 | 
| leaf | 1 | 110 | 1,750 | 39,014,972 | 396,840,426 | 110 | 763 | 0 | 173.37 | 32.84 | 4 | 224.60 | 131 | 279 | 131 | 11 | 144 | 16,068,198 | 54 | 875 | 1,912,880 | 7.57 | 38 | 207 | 0 | 131 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 189 | 880 | 32,480,114 | 172,558,444 | 189 | 418 | 0 | 93.06 | 20.15 | 7 | 90.24 | 79 | 147 | 79 | 1 | 77 | 15,909,408 | 54 | 105 | 1,149,000 | 11.32 | 27 | 114 | 1 | 79 | 
| pairing | 1 | 197 | 610 | 22,464,232 | 119,958,502 | 197 | 311 | 1 | 76.16 | 15.05 | 6 | 64.52 | 57 | 106 | 56 | 0 | 55 | 9,498,894 | 39 | 60 | 596,742 | 18.05 | 21 | 91 | 1 | 56 | 

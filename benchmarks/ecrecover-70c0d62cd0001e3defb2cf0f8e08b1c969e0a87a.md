...
| `stark_prove_excluding_trace_time_ms` |  1,135 |  1,135 |  1,135 |  1,135 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  13,129 |  13,129 |  13,129 |  13,129 |
| `main_cells_used     ` |  245,279,064 |  245,279,064 |  245,279,064 |  245,279,064 |
| `total_cycles        ` |  2,990,940 |  2,990,940 |  2,990,940 |  2,990,940 |
| `execute_time_ms     ` |  1,093 |  1,093 |  1,093 |  1,093 |
| `trace_gen_time_ms   ` |  2,351 |  2,351 |  2,351 |  2,351 |
| `stark_prove_excluding_trace_time_ms` |  9,685 |  9,685 |  9,685 |  9,685 |
| `main_trace_commit_time_ms` |  1,725 |  1,725 |  1,725 |  1,725 |
| `generate_perm_trace_time_ms` |  709 |  709 |  709 |  709 |
| `perm_trace_commit_time_ms` |  3,209 |  3,209 |  3,209 |  3,209 |
| `quotient_poly_compute_time_ms` |  1,351 |  1,351 |  1,351 |  1,351 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 2,351 | 13,129 | 2,990,940 | 1,008,831,978 | 9,685 | 1,351 | 878 | 3,209 | 1,806 | 1,725 | 245,279,064 | 709 | 1,093 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 185 | 1,471 | 295,490 | 48,240,457 | 1,135 | 126 | 162 | 201 | 414 | 183 | 15,627,255 | 33 | 151 | 

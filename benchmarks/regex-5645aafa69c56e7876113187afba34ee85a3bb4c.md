...
| `total_proof_time_ms ` |  6,874 |  13,748 |  7,745 |  6,003 |
| `main_cells_used     ` |  82,727,686.50 |  165,455,373 |  92,686,348 |  72,769,025 |
| `total_cycles        ` |  1,914,103 |  1,914,103 |  1,914,103 |  1,914,103 |
| `execute_time_ms     ` |  435.50 |  871 |  469 |  402 |
| `trace_gen_time_ms   ` |  1,083 |  2,166 |  1,245 |  921 |
| `stark_prove_excluding_trace_time_ms` |  5,355.50 |  10,711 |  6,031 |  4,680 |
| `main_trace_commit_time_ms` |  1,021 |  2,042 |  1,257 |  785 |
| `generate_perm_trace_time_ms` |  174.50 |  349 |  187 |  162 |
| `perm_trace_commit_time_ms` |  1,137.50 |  2,275 |  1,193 |  1,082 |
| `quotient_poly_compute_time_ms` |  750.50 |  1,501 |  867 |  634 |
| `quotient_poly_commit_time_ms` |  951.50 |  1,903 |  1,101 |  802 |
| `pcs_opening_time_ms ` |  1,307 |  2,614 |  1,417 |  1,197 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  8,002.50 |  16,005 |  8,217 |  7,788 |
| `main_cells_used     ` |  77,286,687.50 |  154,573,375 |  78,374,792 |  76,198,583 |
| `total_cycles        ` |  1,028,155.50 |  2,056,311 |  1,045,576 |  1,010,735 |
| `execute_time_ms     ` |  384.50 |  769 |  430 |  339 |
| `trace_gen_time_ms   ` |  1,151 |  2,302 |  1,239 |  1,063 |
| `stark_prove_excluding_trace_time_ms` |  6,467 |  12,934 |  6,724 |  6,210 |
| `main_trace_commit_time_ms` |  1,326.50 |  2,653 |  1,390 |  1,263 |
| `generate_perm_trace_time_ms` |  163.50 |  327 |  175 |  152 |
| `perm_trace_commit_time_ms` |  1,309.50 |  2,619 |  1,359 |  1,260 |
| `quotient_poly_compute_time_ms` |  961.50 |  1,923 |  1,031 |  892 |
| `quotient_poly_commit_time_ms` |  1,254 |  2,508 |  1,296 |  1,212 |
| `pcs_opening_time_ms ` |  1,448 |  2,896 |  1,469 |  1,427 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,063 | 8,217 | 1,045,576 | 220,669,656 | 6,724 | 1,031 | 1,296 | 1,359 | 1,469 | 1,390 | 78,374,792 | 175 | 430 | 
| leaf | 1 | 1,239 | 7,788 | 1,010,735 | 194,986,968 | 6,210 | 892 | 1,212 | 1,260 | 1,427 | 1,263 | 76,198,583 | 152 | 339 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,245 | 7,745 |  | 209,921,543 | 6,031 | 867 | 1,101 | 1,193 | 1,417 | 1,257 | 92,686,348 | 187 | 469 | 
| regex_program | 1 | 921 | 6,003 | 1,914,103 | 149,454,692 | 4,680 | 634 | 802 | 1,082 | 1,197 | 785 | 72,769,025 | 162 | 402 | 

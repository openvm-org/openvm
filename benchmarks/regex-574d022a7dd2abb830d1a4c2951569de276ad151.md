...
| `total_proof_time_ms ` |  1,459 |  2,918 |  1,688 |  1,230 |
...
| `execute_preflight_insn_mi/s` |  30.87 | -          |  32.46 |  29.28 |
| `trace_gen_time_ms   ` |  306 |  612 |  328 |  284 |
| `memory_finalize_time_ms` |  2 |  4 |  4 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  968 |  1,936 |  1,194 |  742 |
| `main_trace_commit_time_ms` |  140 |  280 |  181 |  99 |
| `generate_perm_trace_time_ms` |  59 |  118 |  72 |  46 |
| `perm_trace_commit_time_ms` |  170.48 |  340.97 |  221.53 |  119.44 |
| `quotient_poly_compute_time_ms` |  160.98 |  321.96 |  177.69 |  144.27 |
| `quotient_poly_commit_time_ms` |  35.12 |  70.24 |  46.90 |  23.34 |
| `pcs_opening_time_ms ` |  395 |  790 |  524 |  266 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  2,082.50 |  4,165 |  2,873 |  1,292 |
...
| `execute_preflight_time_ms` |  609 |  1,218 |  949 |  269 |
| `execute_preflight_insn_mi/s` |  6.98 | -          |  7.20 |  6.76 |
| `trace_gen_time_ms   ` |  123.50 |  247 |  169 |  78 |
| `memory_finalize_time_ms` |  12 |  24 |  16 |  8 |
| `stark_prove_excluding_trace_time_ms` |  1,349 |  2,698 |  1,754 |  944 |
| `main_trace_commit_time_ms` |  178 |  356 |  226 |  130 |
| `generate_perm_trace_time_ms` |  71.50 |  143 |  85 |  58 |
| `perm_trace_commit_time_ms` |  274.57 |  549.14 |  364.49 |  184.64 |
| `quotient_poly_compute_time_ms` |  173.36 |  346.71 |  224.48 |  122.24 |
| `quotient_poly_commit_time_ms` |  42.95 |  85.90 |  56.65 |  29.25 |
| `pcs_opening_time_ms ` |  604.50 |  1,209 |  793 |  416 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 2,875 |  | 1 |  | 1 |  |  |  |  | 
| regex_program |  | 1,230 |  | 42 | 1 | 43 | 4,108,483 | 95.06 | 168 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 78 | 1,292 | 23,479,090 | 319,626,730 | 78 | 944 | 0 | 122.24 | 29.25 | 5 | 184.64 | 416 | 244 | 416 | 8 | 130 | 9,325,224 | 58 | 269 | 1,496,599 | 7.20 | 29 | 152 | 1 | 416 | 
| leaf | 1 | 169 | 2,873 | 50,586,080 | 538,660,330 | 168 | 1,754 | 0 | 224.48 | 56.65 | 5 | 364.49 | 793 | 451 | 792 | 16 | 226 | 20,272,474 | 85 | 949 | 1,830,088 | 6.76 | 56 | 283 | 1 | 792 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 284 | 1,688 | 23,397,108 | 373,183,036 | 284 | 1,194 | 0 | 144.27 | 46.90 | 6 | 221.53 | 524 | 294 | 524 | 4 | 181 | 10,866,434 | 72 | 83 | 2,211,000 | 29.28 | 46 | 193 | 2 | 524 | 
| regex_program | 1 | 328 | 1,230 | 11,981,356 | 196,739,722 | 328 | 742 | 2 | 177.69 | 23.34 | 6 | 119.44 | 266 | 169 | 266 | 0 | 99 | 2,537,170 | 46 | 112 | 1,897,483 | 32.46 | 26 | 206 | 2 | 266 | 

...
| `total_proof_time_ms ` |  3,888.50 |  7,777 |  4,482 |  3,295 |
...
| `trace_gen_time_ms   ` |  975 |  1,950 |  1,160 |  790 |
| `stark_prove_excluding_trace_time_ms` |  2,578 |  5,156 |  2,949 |  2,207 |
| `main_trace_commit_time_ms` |  452 |  904 |  534 |  370 |
| `generate_perm_trace_time_ms` |  168.50 |  337 |  196 |  141 |
| `perm_trace_commit_time_ms` |  640.50 |  1,281 |  748 |  533 |
| `quotient_poly_compute_time_ms` |  365.50 |  731 |  423 |  308 |
| `quotient_poly_commit_time_ms` |  277.50 |  555 |  319 |  236 |
| `pcs_opening_time_ms ` |  665 |  1,330 |  721 |  609 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,531.50 |  15,063 |  7,615 |  7,448 |
| `main_cells_used     ` |  152,306,395 |  304,612,790 |  154,765,485 |  149,847,305 |
| `total_cycles        ` |  1,993,373 |  3,986,746 |  2,024,230 |  1,962,516 |
| `execute_time_ms     ` |  766.50 |  1,533 |  775 |  758 |
| `trace_gen_time_ms   ` |  1,480.50 |  2,961 |  1,514 |  1,447 |
| `stark_prove_excluding_trace_time_ms` |  5,284.50 |  10,569 |  5,326 |  5,243 |
| `main_trace_commit_time_ms` |  891 |  1,782 |  892 |  890 |
| `generate_perm_trace_time_ms` |  355 |  710 |  372 |  338 |
| `perm_trace_commit_time_ms` |  1,683.50 |  3,367 |  1,714 |  1,653 |
| `quotient_poly_compute_time_ms` |  761 |  1,522 |  765 |  757 |
| `quotient_poly_commit_time_ms` |  521 |  1,042 |  522 |  520 |
| `pcs_opening_time_ms ` |  1,068 |  2,136 |  1,068 |  1,068 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,514 | 7,615 | 2,024,230 | 533,941,738 | 5,326 | 757 | 520 | 1,714 | 1,068 | 890 | 154,765,485 | 372 | 775 | 
| leaf | 1 | 1,447 | 7,448 | 1,962,516 | 533,941,738 | 5,243 | 765 | 522 | 1,653 | 1,068 | 892 | 149,847,305 | 338 | 758 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,160 | 4,482 | 2,225,434 | 275,652,919 | 2,949 | 423 | 319 | 748 | 721 | 534 | 93,699,990 | 196 | 373 | 
| regex_program | 1 | 790 | 3,295 | 1,914,730 | 198,099,628 | 2,207 | 308 | 236 | 533 | 609 | 370 | 73,689,460 | 141 | 298 | 

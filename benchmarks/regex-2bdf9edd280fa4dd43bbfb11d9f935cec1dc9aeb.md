...
| `total_proof_time_ms ` |  3,886 |  7,772 |  4,474 |  3,298 |
| `main_cells_used     ` |  83,723,935.50 |  167,447,871 |  93,738,635 |  73,709,236 |
| `total_cycles        ` |  2,070,213.50 |  4,140,427 |  2,225,434 |  1,914,993 |
| `execute_time_ms     ` |  339.50 |  679 |  375 |  304 |
| `trace_gen_time_ms   ` |  976.50 |  1,953 |  1,162 |  791 |
| `stark_prove_excluding_trace_time_ms` |  2,570 |  5,140 |  2,937 |  2,203 |
| `main_trace_commit_time_ms` |  452.50 |  905 |  535 |  370 |
| `generate_perm_trace_time_ms` |  161 |  322 |  179 |  143 |
| `perm_trace_commit_time_ms` |  643.50 |  1,287 |  745 |  542 |
| `quotient_poly_compute_time_ms` |  359 |  718 |  414 |  304 |
| `quotient_poly_commit_time_ms` |  277 |  554 |  324 |  230 |
| `pcs_opening_time_ms ` |  665.50 |  1,331 |  729 |  602 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,517 |  15,034 |  7,573 |  7,461 |
| `main_cells_used     ` |  152,709,771.50 |  305,419,543 |  155,169,191 |  150,250,352 |
| `total_cycles        ` |  1,991,009 |  3,982,018 |  2,021,827 |  1,960,191 |
| `execute_time_ms     ` |  760.50 |  1,521 |  770 |  751 |
| `trace_gen_time_ms   ` |  1,488.50 |  2,977 |  1,507 |  1,470 |
| `stark_prove_excluding_trace_time_ms` |  5,268 |  10,536 |  5,296 |  5,240 |
| `main_trace_commit_time_ms` |  889.50 |  1,779 |  890 |  889 |
| `generate_perm_trace_time_ms` |  346 |  692 |  348 |  344 |
| `perm_trace_commit_time_ms` |  1,661 |  3,322 |  1,689 |  1,633 |
| `quotient_poly_compute_time_ms` |  767 |  1,534 |  767 |  767 |
| `quotient_poly_commit_time_ms` |  525.50 |  1,051 |  527 |  524 |
| `pcs_opening_time_ms ` |  1,074.50 |  2,149 |  1,079 |  1,070 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,507 | 7,573 | 2,021,827 | 538,660,330 | 5,296 | 767 | 527 | 1,689 | 1,070 | 890 | 155,169,191 | 348 | 770 | 
| leaf | 1 | 1,470 | 7,461 | 1,960,191 | 538,660,330 | 5,240 | 767 | 524 | 1,633 | 1,079 | 889 | 150,250,352 | 344 | 751 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,162 | 4,474 | 2,225,434 | 275,652,919 | 2,937 | 414 | 324 | 745 | 729 | 535 | 93,738,635 | 179 | 375 | 
| regex_program | 1 | 791 | 3,298 | 1,914,993 | 198,099,628 | 2,203 | 304 | 230 | 542 | 602 | 370 | 73,709,236 | 143 | 304 | 

...
| `total_proof_time_ms ` |  4,736 |  4,736 |  4,736 |  4,736 |
...
| `trace_gen_time_ms   ` |  935 |  935 |  935 |  935 |
...
| `pcs_opening_time_ms ` |  755 |  755 |  755 |  755 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  14,041 |  14,041 |  14,041 |  14,041 |
| `main_cells_used     ` |  275,728,972 |  275,728,972 |  275,728,972 |  275,728,972 |
| `total_cycles        ` |  3,305,839 |  3,305,839 |  3,305,839 |  3,305,839 |
| `execute_time_ms     ` |  1,205 |  1,205 |  1,205 |  1,205 |
| `trace_gen_time_ms   ` |  2,575 |  2,575 |  2,575 |  2,575 |
| `stark_prove_excluding_trace_time_ms` |  10,261 |  10,261 |  10,261 |  10,261 |
| `main_trace_commit_time_ms` |  1,771 |  1,771 |  1,771 |  1,771 |
| `generate_perm_trace_time_ms` |  723 |  723 |  723 |  723 |
| `perm_trace_commit_time_ms` |  3,359 |  3,359 |  3,359 |  3,359 |
| `quotient_poly_compute_time_ms` |  1,474 |  1,474 |  1,474 |  1,474 |
| `quotient_poly_commit_time_ms` |  966 |  966 |  966 |  966 |
| `pcs_opening_time_ms ` |  1,964 |  1,964 |  1,964 |  1,964 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 2,575 | 14,041 | 3,305,839 | 1,071,746,538 | 10,261 | 1,474 | 966 | 3,359 | 1,964 | 1,771 | 275,728,972 | 723 | 1,205 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 935 | 4,736 | 1,711,640 | 297,389,207 | 3,137 | 465 | 330 | 776 | 755 | 599 | 92,620,923 | 193 | 664 | 

...
|:---|---:|---:|---:|
| Total |  4.60 |  2.69 | 2.69 |
| pairing |  1.61 |  0.94 |  0.94 |
| leaf |  2.99 |  1.75 |  1.75 |
...
| `total_proof_time_ms ` |  772 |  1,544 |  876 |  668 |
...
| `execute_metered_insn_mi/s` |  27.40 | -          |  27.40 |  27.40 |
| `execute_preflight_insns` |  872,871 |  1,745,742 |  1,149,000 |  596,742 |
| `execute_preflight_time_ms` |  83 |  166 |  119 |  47 |
| `execute_preflight_insn_mi/s` |  14.78 | -          |  18.16 |  11.40 |
| `trace_gen_time_ms   ` |  184 |  368 |  204 |  164 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  398.50 |  797 |  422 |  375 |
| `main_trace_commit_time_ms` |  65 |  130 |  75 |  55 |
| `generate_perm_trace_time_ms` |  80.50 |  161 |  89 |  72 |
| `perm_trace_commit_time_ms` |  77.13 |  154.27 |  89.47 |  64.80 |
| `quotient_poly_compute_time_ms` |  83.29 |  166.58 |  92.54 |  74.03 |
| `quotient_poly_commit_time_ms` |  17.74 |  35.48 |  19.87 |  15.61 |
| `pcs_opening_time_ms ` |  70 |  140 |  72 |  68 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,496.50 |  2,993 |  1,752 |  1,241 |
| `main_cells_used     ` |  16,200,472 |  32,400,944 |  16,332,746 |  16,068,198 |
| `total_cells_used    ` |  39,332,920 |  78,665,840 |  39,650,868 |  39,014,972 |
| `execute_preflight_insns` |  1,952,408 |  3,904,816 |  1,991,911 |  1,912,905 |
| `execute_preflight_time_ms` |  590.50 |  1,181 |  869 |  312 |
| `execute_preflight_insn_mi/s` |  7.47 | -          |  7.48 |  7.46 |
| `trace_gen_time_ms   ` |  121 |  242 |  127 |  115 |
| `memory_finalize_time_ms` |  12.50 |  25 |  14 |  11 |
| `stark_prove_excluding_trace_time_ms` |  783.50 |  1,567 |  801 |  766 |
| `main_trace_commit_time_ms` |  146.50 |  293 |  150 |  143 |
| `generate_perm_trace_time_ms` |  81.50 |  163 |  99 |  64 |
| `perm_trace_commit_time_ms` |  227.35 |  454.70 |  231.73 |  222.97 |
| `quotient_poly_compute_time_ms` |  172.31 |  344.62 |  174.52 |  170.10 |
| `quotient_poly_commit_time_ms` |  32.78 |  65.57 |  33.66 |  31.91 |
| `pcs_opening_time_ms ` |  120 |  240 |  131 |  109 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 1,754 |  | 1 | 1 |  |  |  |  | 
| pairing |  | 668 |  | 1 | 63 | 1,745,742 | 27.40 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 127 | 1,241 | 39,650,868 | 410,701,290 | 127 | 801 | 0 | 174.52 | 33.66 | 4 | 231.73 | 109 | 331 | 109 | 14 | 150 | 16,332,746 | 99 | 312 | 1,991,911 | 7.48 | 39 | 209 | 0 | 109 | 
| leaf | 1 | 115 | 1,752 | 39,014,972 | 396,840,426 | 115 | 766 | 0 | 170.10 | 31.91 | 5 | 222.97 | 131 | 288 | 131 | 11 | 143 | 16,068,198 | 64 | 869 | 1,912,905 | 7.46 | 38 | 203 | 0 | 131 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 164 | 876 | 32,480,114 | 172,558,444 | 164 | 422 | 0 | 92.54 | 19.87 | 6 | 89.47 | 68 | 165 | 67 | 1 | 75 | 15,909,408 | 72 | 119 | 1,149,000 | 11.40 | 27 | 113 | 1 | 67 | 
| pairing | 1 | 204 | 668 | 22,464,232 | 119,958,502 | 204 | 375 | 1 | 74.03 | 15.61 | 6 | 64.80 | 72 | 157 | 72 | 0 | 55 | 9,498,894 | 89 | 47 | 596,742 | 18.16 | 21 | 90 | 1 | 72 | 

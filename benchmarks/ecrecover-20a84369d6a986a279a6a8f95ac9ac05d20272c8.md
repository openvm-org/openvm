...
| `stark_prove_excluding_trace_time_ms` |  1,129 |  1,129 |  1,129 |  1,129 |
| `main_trace_commit_time_ms` |  189 |  189 |  189 |  189 |
| `generate_perm_trace_time_ms` |  33 |  33 |  33 |  33 |
| `perm_trace_commit_time_ms` |  202 |  202 |  202 |  202 |
| `quotient_poly_compute_time_ms` |  118 |  118 |  118 |  118 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  13,115 |  13,115 |  13,115 |  13,115 |
| `main_cells_used     ` |  244,001,453 |  244,001,453 |  244,001,453 |  244,001,453 |
| `total_cycles        ` |  2,985,140 |  2,985,140 |  2,985,140 |  2,985,140 |
| `execute_time_ms     ` |  1,090 |  1,090 |  1,090 |  1,090 |
| `trace_gen_time_ms   ` |  2,406 |  2,406 |  2,406 |  2,406 |
| `stark_prove_excluding_trace_time_ms` |  9,619 |  9,619 |  9,619 |  9,619 |
...
| `pcs_opening_time_ms ` |  1,860 |  1,860 |  1,860 |  1,860 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 2,406 | 13,115 | 2,985,140 | 999,394,794 | 9,619 | 1,337 | 885 | 3,115 | 1,860 | 1,719 | 244,001,453 | 697 | 1,090 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 183 | 1,461 | 295,291 | 48,197,161 | 1,129 | 118 | 163 | 202 | 409 | 189 | 15,588,656 | 33 | 149 | 

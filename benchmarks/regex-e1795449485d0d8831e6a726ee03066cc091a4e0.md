...
| `total_proof_time_ms ` |  3,884.50 |  7,769 |  4,472 |  3,297 |
...
| `trace_gen_time_ms   ` |  966 |  1,932 |  1,145 |  787 |
| `stark_prove_excluding_trace_time_ms` |  2,579 |  5,158 |  2,951 |  2,207 |
| `main_trace_commit_time_ms` |  454 |  908 |  539 |  369 |
| `generate_perm_trace_time_ms` |  168 |  336 |  188 |  148 |
| `perm_trace_commit_time_ms` |  644.50 |  1,289 |  752 |  537 |
| `quotient_poly_compute_time_ms` |  366.50 |  733 |  425 |  308 |
| `quotient_poly_commit_time_ms` |  277 |  554 |  320 |  234 |
| `pcs_opening_time_ms ` |  659.50 |  1,319 |  717 |  602 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,555 |  15,110 |  7,615 |  7,495 |
| `main_cells_used     ` |  152,710,389.50 |  305,420,779 |  155,170,019 |  150,250,760 |
| `total_cycles        ` |  1,991,060.50 |  3,982,121 |  2,021,896 |  1,960,225 |
| `execute_time_ms     ` |  770 |  1,540 |  779 |  761 |
| `trace_gen_time_ms   ` |  1,462.50 |  2,925 |  1,472 |  1,453 |
| `stark_prove_excluding_trace_time_ms` |  5,322.50 |  10,645 |  5,364 |  5,281 |
| `main_trace_commit_time_ms` |  894 |  1,788 |  895 |  893 |
| `generate_perm_trace_time_ms` |  356 |  712 |  368 |  344 |
| `perm_trace_commit_time_ms` |  1,700.50 |  3,401 |  1,726 |  1,675 |
| `quotient_poly_compute_time_ms` |  765.50 |  1,531 |  767 |  764 |
| `quotient_poly_commit_time_ms` |  525.50 |  1,051 |  526 |  525 |
| `pcs_opening_time_ms ` |  1,074 |  2,148 |  1,077 |  1,071 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,472 | 7,615 | 2,021,896 | 538,660,330 | 5,364 | 767 | 526 | 1,726 | 1,077 | 895 | 155,170,019 | 368 | 779 | 
| leaf | 1 | 1,453 | 7,495 | 1,960,225 | 538,660,330 | 5,281 | 764 | 525 | 1,675 | 1,071 | 893 | 150,250,760 | 344 | 761 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,145 | 4,472 | 2,225,434 | 275,652,919 | 2,951 | 425 | 320 | 752 | 717 | 539 | 93,738,635 | 188 | 376 | 
| regex_program | 1 | 787 | 3,297 | 1,914,993 | 198,099,628 | 2,207 | 308 | 234 | 537 | 602 | 369 | 73,709,236 | 148 | 303 | 

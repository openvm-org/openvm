...
| `total_proof_time_ms ` |  1,493.50 |  2,987 |  1,734 |  1,253 |
...
| `execute_preflight_time_ms` |  97 |  194 |  111 |  83 |
| `execute_preflight_insn_mi/s` |  30.78 | -          |  32.20 |  29.36 |
| `trace_gen_time_ms   ` |  316 |  632 |  336 |  296 |
| `memory_finalize_time_ms` |  2 |  4 |  4 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  993 |  1,986 |  1,229 |  757 |
| `main_trace_commit_time_ms` |  143.50 |  287 |  187 |  100 |
| `generate_perm_trace_time_ms` |  62.50 |  125 |  78 |  47 |
| `perm_trace_commit_time_ms` |  174.54 |  349.08 |  227.46 |  121.62 |
| `quotient_poly_compute_time_ms` |  167.78 |  335.55 |  184.22 |  151.33 |
| `quotient_poly_commit_time_ms` |  36.81 |  73.61 |  49.30 |  24.31 |
| `pcs_opening_time_ms ` |  401 |  802 |  532 |  270 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  2,104.50 |  4,209 |  2,894 |  1,315 |
| `main_cells_used     ` |  14,798,849 |  29,597,698 |  20,272,474 |  9,325,224 |
| `total_cells_used    ` |  37,032,585 |  74,065,170 |  50,586,080 |  23,479,090 |
| `execute_preflight_insns` |  1,663,356 |  3,326,712 |  1,830,088 |  1,496,624 |
| `execute_preflight_time_ms` |  602.50 |  1,205 |  943 |  262 |
| `execute_preflight_insn_mi/s` |  6.97 | -          |  7.32 |  6.62 |
| `trace_gen_time_ms   ` |  121.50 |  243 |  168 |  75 |
| `memory_finalize_time_ms` |  12 |  24 |  18 |  6 |
| `stark_prove_excluding_trace_time_ms` |  1,379.50 |  2,759 |  1,782 |  977 |
| `main_trace_commit_time_ms` |  182.50 |  365 |  232 |  133 |
| `generate_perm_trace_time_ms` |  68 |  136 |  86 |  50 |
| `perm_trace_commit_time_ms` |  281.36 |  562.73 |  373.23 |  189.50 |
| `quotient_poly_compute_time_ms` |  180.76 |  361.52 |  233.96 |  127.56 |
| `quotient_poly_commit_time_ms` |  45.67 |  91.33 |  59.56 |  31.77 |
| `pcs_opening_time_ms ` |  617 |  1,234 |  792 |  442 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 2,896 |  | 1 |  | 1 |  |  |  |  | 
| regex_program |  | 1,253 |  | 40 | 1 | 44 | 4,108,483 | 93.32 | 248 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 75 | 1,315 | 23,479,090 | 319,626,730 | 75 | 977 | 0 | 127.56 | 31.77 | 5 | 189.50 | 442 | 240 | 442 | 6 | 133 | 9,325,224 | 50 | 262 | 1,496,624 | 7.32 | 30 | 160 | 1 | 442 | 
| leaf | 1 | 168 | 2,894 | 50,586,080 | 538,660,330 | 168 | 1,782 | 0 | 233.96 | 59.56 | 5 | 373.23 | 792 | 460 | 791 | 18 | 232 | 20,272,474 | 86 | 943 | 1,830,088 | 6.62 | 57 | 296 | 1 | 791 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 296 | 1,734 | 23,397,108 | 373,183,036 | 296 | 1,229 | 0 | 151.33 | 49.30 | 6 | 227.46 | 532 | 306 | 531 | 4 | 187 | 10,866,434 | 78 | 83 | 2,211,000 | 29.36 | 47 | 202 | 2 | 531 | 
| regex_program | 1 | 336 | 1,253 | 11,981,356 | 196,739,722 | 336 | 757 | 2 | 184.22 | 24.31 | 6 | 121.62 | 270 | 172 | 270 | 0 | 100 | 2,537,170 | 47 | 111 | 1,897,483 | 32.20 | 28 | 213 | 2 | 270 | 

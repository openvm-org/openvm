...
| `total_proof_time_ms ` |  4,018 |  8,036 |  4,463 |  3,573 |
...
| `trace_gen_time_ms   ` |  958.50 |  1,917 |  1,145 |  772 |
| `stark_prove_excluding_trace_time_ms` |  2,717 |  5,434 |  2,937 |  2,497 |
| `main_trace_commit_time_ms` |  471.50 |  943 |  531 |  412 |
| `generate_perm_trace_time_ms` |  188.50 |  377 |  191 |  186 |
| `perm_trace_commit_time_ms` |  689.50 |  1,379 |  741 |  638 |
| `quotient_poly_compute_time_ms` |  393.50 |  787 |  423 |  364 |
| `quotient_poly_commit_time_ms` |  278 |  556 |  314 |  242 |
| `pcs_opening_time_ms ` |  687 |  1,374 |  733 |  641 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,288.50 |  14,577 |  7,391 |  7,186 |
| `main_cells_used     ` |  152,278,393 |  304,556,786 |  154,677,718 |  149,879,068 |
| `total_cycles        ` |  1,991,044 |  3,982,088 |  2,021,827 |  1,960,261 |
| `execute_time_ms     ` |  779 |  1,558 |  789 |  769 |
| `trace_gen_time_ms   ` |  1,480 |  2,960 |  1,513 |  1,447 |
| `stark_prove_excluding_trace_time_ms` |  5,029.50 |  10,059 |  5,089 |  4,970 |
| `main_trace_commit_time_ms` |  811.50 |  1,623 |  815 |  808 |
| `generate_perm_trace_time_ms` |  375 |  750 |  390 |  360 |
| `perm_trace_commit_time_ms` |  1,535 |  3,070 |  1,572 |  1,498 |
| `quotient_poly_compute_time_ms` |  766.50 |  1,533 |  768 |  765 |
| `quotient_poly_commit_time_ms` |  492 |  984 |  494 |  490 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,513 | 7,391 | 2,021,827 | 538,660,330 | 5,089 | 768 | 494 | 1,572 | 1,046 | 815 | 154,677,718 | 390 | 789 | 
| leaf | 1 | 1,447 | 7,186 | 1,960,261 | 538,660,330 | 4,970 | 765 | 490 | 1,498 | 1,044 | 808 | 149,879,068 | 360 | 769 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,145 | 4,463 | 2,243,715 | 275,652,919 | 2,937 | 423 | 314 | 741 | 733 | 531 | 93,500,799 | 186 | 381 | 
| regex_program | 1 | 772 | 3,573 | 1,921,511 | 242,975,404 | 2,497 | 364 | 242 | 638 | 641 | 412 | 73,010,353 | 191 | 304 | 
...
Commit: https://github.com/openvm-org/openvm/commit/609c7c1f3b5e23f059d481ba90cca0f15e978432
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/14720669230)

...
| `perm_trace_commit_time_ms` |  207 |  207 |  207 |  207 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  13,032 |  13,032 |  13,032 |  13,032 |
| `main_cells_used     ` |  244,104,048 |  244,104,048 |  244,104,048 |  244,104,048 |
| `total_cycles        ` |  2,988,857 |  2,988,857 |  2,988,857 |  2,988,857 |
| `execute_time_ms     ` |  1,093 |  1,093 |  1,093 |  1,093 |
| `trace_gen_time_ms   ` |  2,313 |  2,313 |  2,313 |  2,313 |
| `stark_prove_excluding_trace_time_ms` |  9,626 |  9,626 |  9,626 |  9,626 |
| `main_trace_commit_time_ms` |  1,723 |  1,723 |  1,723 |  1,723 |
| `generate_perm_trace_time_ms` |  703 |  703 |  703 |  703 |
| `perm_trace_commit_time_ms` |  3,147 |  3,147 |  3,147 |  3,147 |
| `quotient_poly_compute_time_ms` |  1,345 |  1,345 |  1,345 |  1,345 |
| `quotient_poly_commit_time_ms` |  885 |  885 |  885 |  885 |
| `pcs_opening_time_ms ` |  1,818 |  1,818 |  1,818 |  1,818 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 2,313 | 13,032 | 2,988,857 | 999,394,794 | 9,626 | 1,345 | 885 | 3,147 | 1,818 | 1,723 | 244,104,048 | 703 | 1,093 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 182 | 1,470 | 295,181 | 48,197,161 | 1,140 | 124 | 165 | 207 | 414 | 184 | 15,586,346 | 31 | 148 | 

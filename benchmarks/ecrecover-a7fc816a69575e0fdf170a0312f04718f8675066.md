...
| `stark_prove_excluding_trace_time_ms` |  2,136 |  2,136 |  2,136 |  2,136 |
...
| `pcs_opening_time_ms ` |  660 |  660 |  660 |  660 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  18,258 |  18,258 |  18,258 |  18,258 |
| `main_cells_used     ` |  186,732,850 |  186,732,850 |  186,732,850 |  186,732,850 |
| `total_cycles        ` |  4,157,919 |  4,157,919 |  4,157,919 |  4,157,919 |
| `execute_time_ms     ` |  936 |  936 |  936 |  936 |
| `trace_gen_time_ms   ` |  3,515 |  3,515 |  3,515 |  3,515 |
| `stark_prove_excluding_trace_time_ms` |  13,807 |  13,807 |  13,807 |  13,807 |
| `main_trace_commit_time_ms` |  2,781 |  2,781 |  2,781 |  2,781 |
| `generate_perm_trace_time_ms` |  351 |  351 |  351 |  351 |
| `perm_trace_commit_time_ms` |  2,878 |  2,878 |  2,878 |  2,878 |
| `quotient_poly_compute_time_ms` |  2,076 |  2,076 |  2,076 |  2,076 |
| `quotient_poly_commit_time_ms` |  2,633 |  2,633 |  2,633 |  2,633 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 3,515 | 18,258 | 4,157,919 | 459,031,512 | 13,807 | 2,076 | 2,633 | 2,878 | 3,084 | 2,781 | 186,732,850 | 351 | 936 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 255 | 2,539 | 284,567 | 38,417,467 | 2,136 | 230 | 461 | 350 | 660 | 386 | 15,055,723 | 36 | 148 | 

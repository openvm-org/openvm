...
| `total_proof_time_ms ` |  3,922.50 |  7,845 |  4,374 |  3,471 |
| `main_cells_used     ` |  83,255,576 |  166,511,152 |  93,500,799 |  73,010,353 |
| `total_cycles        ` |  2,082,613 |  4,165,226 |  2,243,715 |  1,921,511 |
| `execute_time_ms     ` |  352.50 |  705 |  391 |  314 |
| `trace_gen_time_ms   ` |  974 |  1,948 |  1,188 |  760 |
| `stark_prove_excluding_trace_time_ms` |  2,596 |  5,192 |  2,795 |  2,397 |
| `main_trace_commit_time_ms` |  502.50 |  1,005 |  563 |  442 |
| `generate_perm_trace_time_ms` |  212 |  424 |  230 |  194 |
| `perm_trace_commit_time_ms` |  546.50 |  1,093 |  573 |  520 |
| `quotient_poly_compute_time_ms` |  262.50 |  525 |  291 |  234 |
| `quotient_poly_commit_time_ms` |  244.50 |  489 |  280 |  209 |
| `pcs_opening_time_ms ` |  818 |  1,636 |  848 |  788 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  6,969 |  13,938 |  7,039 |  6,899 |
...
| `trace_gen_time_ms   ` |  1,455.50 |  2,911 |  1,495 |  1,416 |
| `stark_prove_excluding_trace_time_ms` |  4,736 |  9,472 |  4,760 |  4,712 |
| `main_trace_commit_time_ms` |  866 |  1,732 |  868 |  864 |
| `generate_perm_trace_time_ms` |  397 |  794 |  419 |  375 |
| `perm_trace_commit_time_ms` |  1,241 |  2,482 |  1,246 |  1,236 |
| `quotient_poly_compute_time_ms` |  522.50 |  1,045 |  523 |  522 |
| `quotient_poly_commit_time_ms` |  412.50 |  825 |  413 |  412 |
| `pcs_opening_time_ms ` |  1,292.50 |  2,585 |  1,298 |  1,287 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,495 | 7,039 | 2,006,569 | 538,660,330 | 4,760 | 523 | 412 | 1,246 | 1,287 | 868 | 154,227,878 | 419 | 784 | 
| leaf | 1 | 1,416 | 6,899 | 1,944,913 | 538,660,330 | 4,712 | 522 | 413 | 1,236 | 1,298 | 864 | 149,428,148 | 375 | 771 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,188 | 4,374 | 2,243,715 | 275,652,919 | 2,795 | 291 | 280 | 573 | 848 | 563 | 93,500,799 | 230 | 391 | 
| regex_program | 1 | 760 | 3,471 | 1,921,511 | 242,975,404 | 2,397 | 234 | 209 | 520 | 788 | 442 | 73,010,353 | 194 | 314 | 

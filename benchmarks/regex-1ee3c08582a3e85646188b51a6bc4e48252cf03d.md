...
| `total_proof_time_ms ` |  4,065 |  8,130 |  4,528 |  3,602 |
...
| `trace_gen_time_ms   ` |  975 |  1,950 |  1,146 |  804 |
| `stark_prove_excluding_trace_time_ms` |  2,751.50 |  5,503 |  3,006 |  2,497 |
| `main_trace_commit_time_ms` |  471.50 |  943 |  532 |  411 |
| `generate_perm_trace_time_ms` |  186 |  372 |  198 |  174 |
| `perm_trace_commit_time_ms` |  692 |  1,384 |  739 |  645 |
| `quotient_poly_compute_time_ms` |  394 |  788 |  423 |  365 |
| `quotient_poly_commit_time_ms` |  280 |  560 |  316 |  244 |
| `pcs_opening_time_ms ` |  719 |  1,438 |  789 |  649 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,309.50 |  14,619 |  7,364 |  7,255 |
| `main_cells_used     ` |  152,278,345 |  304,556,690 |  154,678,462 |  149,878,228 |
| `total_cycles        ` |  1,991,040 |  3,982,080 |  2,021,889 |  1,960,191 |
| `execute_time_ms     ` |  785.50 |  1,571 |  794 |  777 |
| `trace_gen_time_ms   ` |  1,490 |  2,980 |  1,498 |  1,482 |
| `stark_prove_excluding_trace_time_ms` |  5,034 |  10,068 |  5,072 |  4,996 |
| `main_trace_commit_time_ms` |  810.50 |  1,621 |  812 |  809 |
| `generate_perm_trace_time_ms` |  367.50 |  735 |  371 |  364 |
| `perm_trace_commit_time_ms` |  1,538.50 |  3,077 |  1,571 |  1,506 |
| `quotient_poly_compute_time_ms` |  769 |  1,538 |  772 |  766 |
| `quotient_poly_commit_time_ms` |  494 |  988 |  494 |  494 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,498 | 7,364 | 2,021,889 | 538,660,330 | 5,072 | 772 | 494 | 1,571 | 1,048 | 812 | 154,678,462 | 371 | 794 | 
| leaf | 1 | 1,482 | 7,255 | 1,960,191 | 538,660,330 | 4,996 | 766 | 494 | 1,506 | 1,052 | 809 | 149,878,228 | 364 | 777 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,146 | 4,528 | 2,243,715 | 275,652,919 | 3,006 | 423 | 316 | 739 | 789 | 532 | 93,500,799 | 198 | 376 | 
| regex_program | 1 | 804 | 3,602 | 1,921,511 | 242,975,404 | 2,497 | 365 | 244 | 645 | 649 | 411 | 73,010,353 | 174 | 301 | 

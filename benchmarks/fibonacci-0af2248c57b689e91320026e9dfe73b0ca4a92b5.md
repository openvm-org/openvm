...
| `total_proof_time_ms ` |  496.50 |  993 |  559 |  434 |
...
| `perm_trace_commit_time_ms` |  41.47 |  82.93 |  44.52 |  38.41 |
| `quotient_poly_compute_time_ms` |  29.88 |  59.76 |  32.33 |  27.43 |
| `quotient_poly_commit_time_ms` |  12.44 |  24.88 |  12.93 |  11.95 |
| `pcs_opening_time_ms ` |  43.50 |  87 |  44 |  43 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,027.50 |  2,055 |  1,320 |  735 |
| `main_cells_used     ` |  6,475,562 |  12,951,124 |  6,608,072 |  6,343,052 |
| `total_cells_used    ` |  17,568,644 |  35,137,288 |  17,887,054 |  17,250,234 |
| `execute_preflight_insns` |  1,190,422 |  2,380,844 |  1,229,665 |  1,151,179 |
| `execute_preflight_time_ms` |  519 |  1,038 |  839 |  199 |
| `execute_preflight_insn_mi/s` |  6.82 | -          |  6.96 |  6.68 |
| `trace_gen_time_ms   ` |  57.50 |  115 |  60 |  55 |
| `memory_finalize_time_ms` |  5.50 |  11 |  6 |  5 |
| `stark_prove_excluding_trace_time_ms` |  450.50 |  901 |  476 |  425 |
| `main_trace_commit_time_ms` |  84.50 |  169 |  92 |  77 |
| `generate_perm_trace_time_ms` |  44.50 |  89 |  53 |  36 |
| `perm_trace_commit_time_ms` |  126.17 |  252.33 |  144.55 |  107.79 |
| `quotient_poly_compute_time_ms` |  91.96 |  183.93 |  102.69 |  81.24 |
| `quotient_poly_commit_time_ms` |  21.58 |  43.15 |  23.16 |  19.100 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program |  | 434 |  | 41 | 1 | 9 | 1,500,209 | 160.48 | 142 | 
| leaf | 1,321 |  | 1 |  | 1 |  |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 60 | 735 | 17,887,054 | 252,878,314 | 60 | 476 | 0 | 102.69 | 23.16 | 4 | 144.55 | 75 | 181 | 75 | 6 | 92 | 6,608,072 | 36 | 199 | 1,229,665 | 6.96 | 26 | 126 | 0 | 75 | 
| leaf | 1 | 55 | 1,320 | 17,250,234 | 207,789,546 | 55 | 425 | 0 | 81.24 | 19.100 | 4 | 107.79 | 84 | 161 | 83 | 5 | 77 | 6,343,052 | 53 | 839 | 1,151,179 | 6.68 | 22 | 102 | 0 | 83 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 197 | 559 | 9,677,708 | 84,395,212 | 197 | 193 | 0 | 32.33 | 12.93 | 4 | 44.52 | 43 | 70 | 43 | 0 | 33 | 1,035,986 | 25 | 25 | 873,000 | 35.74 | 14 | 45 | 0 | 43 | 
| fibonacci_program | 1 | 187 | 434 | 9,708,170 | 74,305,770 | 187 | 173 | 1 | 27.43 | 11.95 | 4 | 38.41 | 44 | 59 | 44 | 0 | 28 | 1,064,416 | 21 | 33 | 627,209 | 39.49 | 11 | 39 | 0 | 44 | 

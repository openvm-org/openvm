...
| `execute_time_ms     ` |  340.50 |  681 |  376 |  305 |
| `trace_gen_time_ms   ` |  963 |  1,926 |  1,148 |  778 |
| `stark_prove_excluding_trace_time_ms` |  2,603 |  5,206 |  2,976 |  2,230 |
| `main_trace_commit_time_ms` |  453.50 |  907 |  539 |  368 |
| `generate_perm_trace_time_ms` |  168 |  336 |  194 |  142 |
| `perm_trace_commit_time_ms` |  646.50 |  1,293 |  755 |  538 |
| `quotient_poly_compute_time_ms` |  364 |  728 |  422 |  306 |
| `quotient_poly_commit_time_ms` |  276.50 |  553 |  320 |  233 |
| `pcs_opening_time_ms ` |  685 |  1,370 |  736 |  634 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,517.50 |  15,035 |  7,593 |  7,442 |
| `main_cells_used     ` |  152,709,417.50 |  305,418,835 |  155,168,687 |  150,250,148 |
| `total_cycles        ` |  1,990,980.50 |  3,981,961 |  2,021,786 |  1,960,175 |
| `execute_time_ms     ` |  765.50 |  1,531 |  773 |  758 |
| `trace_gen_time_ms   ` |  1,478.50 |  2,957 |  1,526 |  1,431 |
| `stark_prove_excluding_trace_time_ms` |  5,273.50 |  10,547 |  5,294 |  5,253 |
| `main_trace_commit_time_ms` |  896 |  1,792 |  900 |  892 |
| `generate_perm_trace_time_ms` |  346 |  692 |  349 |  343 |
| `perm_trace_commit_time_ms` |  1,664.50 |  3,329 |  1,685 |  1,644 |
| `quotient_poly_compute_time_ms` |  769.50 |  1,539 |  770 |  769 |
| `quotient_poly_commit_time_ms` |  526 |  1,052 |  527 |  525 |
| `pcs_opening_time_ms ` |  1,066 |  2,132 |  1,072 |  1,060 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,526 | 7,593 | 2,021,786 | 538,660,330 | 5,294 | 770 | 525 | 1,685 | 1,060 | 900 | 155,168,687 | 349 | 773 | 
| leaf | 1 | 1,431 | 7,442 | 1,960,175 | 538,660,330 | 5,253 | 769 | 527 | 1,644 | 1,072 | 892 | 150,250,148 | 343 | 758 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,148 | 4,500 | 2,225,434 | 275,652,919 | 2,976 | 422 | 320 | 755 | 736 | 539 | 93,738,635 | 194 | 376 | 
| regex_program | 1 | 778 | 3,313 | 1,914,993 | 198,099,628 | 2,230 | 306 | 233 | 538 | 634 | 368 | 73,709,236 | 142 | 305 | 

...
| `total_proof_time_ms ` |  3,848.50 |  7,697 |  4,426 |  3,271 |
| `main_cells_used     ` |  83,694,725 |  167,389,450 |  93,699,990 |  73,689,460 |
| `total_cycles        ` |  2,070,082 |  4,140,164 |  2,225,434 |  1,914,730 |
| `execute_time_ms     ` |  335 |  670 |  370 |  300 |
| `trace_gen_time_ms   ` |  946 |  1,892 |  1,117 |  775 |
| `stark_prove_excluding_trace_time_ms` |  2,567.50 |  5,135 |  2,939 |  2,196 |
| `main_trace_commit_time_ms` |  447.50 |  895 |  523 |  372 |
| `generate_perm_trace_time_ms` |  165 |  330 |  186 |  144 |
| `perm_trace_commit_time_ms` |  641.50 |  1,283 |  751 |  532 |
| `quotient_poly_compute_time_ms` |  365.50 |  731 |  423 |  308 |
| `quotient_poly_commit_time_ms` |  277.50 |  555 |  325 |  230 |
| `pcs_opening_time_ms ` |  662.50 |  1,325 |  724 |  601 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,501.50 |  15,003 |  7,523 |  7,480 |
| `main_cells_used     ` |  152,306,323.50 |  304,612,647 |  154,765,267 |  149,847,380 |
| `total_cycles        ` |  1,993,354.50 |  3,986,709 |  2,024,200 |  1,962,509 |
| `execute_time_ms     ` |  760 |  1,520 |  769 |  751 |
| `trace_gen_time_ms   ` |  1,480.50 |  2,961 |  1,483 |  1,478 |
| `stark_prove_excluding_trace_time_ms` |  5,261 |  10,522 |  5,271 |  5,251 |
| `main_trace_commit_time_ms` |  892 |  1,784 |  893 |  891 |
| `generate_perm_trace_time_ms` |  349 |  698 |  359 |  339 |
| `perm_trace_commit_time_ms` |  1,660 |  3,320 |  1,672 |  1,648 |
| `quotient_poly_compute_time_ms` |  763 |  1,526 |  767 |  759 |
| `quotient_poly_commit_time_ms` |  520.50 |  1,041 |  522 |  519 |
| `pcs_opening_time_ms ` |  1,071.50 |  2,143 |  1,075 |  1,068 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,483 | 7,523 | 2,024,200 | 533,941,738 | 5,271 | 767 | 519 | 1,672 | 1,075 | 893 | 154,765,267 | 339 | 769 | 
| leaf | 1 | 1,478 | 7,480 | 1,962,509 | 533,941,738 | 5,251 | 759 | 522 | 1,648 | 1,068 | 891 | 149,847,380 | 359 | 751 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,117 | 4,426 | 2,225,434 | 275,652,919 | 2,939 | 423 | 325 | 751 | 724 | 523 | 93,699,990 | 186 | 370 | 
| regex_program | 1 | 775 | 3,271 | 1,914,730 | 198,099,628 | 2,196 | 308 | 230 | 532 | 601 | 372 | 73,689,460 | 144 | 300 | 

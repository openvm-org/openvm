...
| `total_proof_time_ms ` |  3,874 |  7,748 |  4,489 |  3,259 |
...
| `trace_gen_time_ms   ` |  961 |  1,922 |  1,163 |  759 |
| `stark_prove_excluding_trace_time_ms` |  2,573.50 |  5,147 |  2,949 |  2,198 |
| `main_trace_commit_time_ms` |  453 |  906 |  538 |  368 |
| `generate_perm_trace_time_ms` |  166.50 |  333 |  193 |  140 |
| `perm_trace_commit_time_ms` |  645 |  1,290 |  746 |  544 |
| `quotient_poly_compute_time_ms` |  362 |  724 |  421 |  303 |
| `quotient_poly_commit_time_ms` |  276 |  552 |  320 |  232 |
| `pcs_opening_time_ms ` |  662 |  1,324 |  722 |  602 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,480 |  14,960 |  7,570 |  7,390 |
| `main_cells_used     ` |  152,709,495.50 |  305,418,991 |  155,168,519 |  150,250,472 |
| `total_cycles        ` |  1,990,986 |  3,981,972 |  2,021,771 |  1,960,201 |
| `execute_time_ms     ` |  751 |  1,502 |  759 |  743 |
| `trace_gen_time_ms   ` |  1,442.50 |  2,885 |  1,487 |  1,398 |
| `stark_prove_excluding_trace_time_ms` |  5,286.50 |  10,573 |  5,324 |  5,249 |
| `main_trace_commit_time_ms` |  893.50 |  1,787 |  894 |  893 |
| `generate_perm_trace_time_ms` |  345 |  690 |  347 |  343 |
| `perm_trace_commit_time_ms` |  1,687 |  3,374 |  1,728 |  1,646 |
| `quotient_poly_compute_time_ms` |  762.50 |  1,525 |  764 |  761 |
| `quotient_poly_commit_time_ms` |  524 |  1,048 |  526 |  522 |
| `pcs_opening_time_ms ` |  1,067 |  2,134 |  1,068 |  1,066 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,487 | 7,570 | 2,021,771 | 538,660,330 | 5,324 | 761 | 522 | 1,728 | 1,066 | 893 | 155,168,519 | 347 | 759 | 
| leaf | 1 | 1,398 | 7,390 | 1,960,201 | 538,660,330 | 5,249 | 764 | 526 | 1,646 | 1,068 | 894 | 150,250,472 | 343 | 743 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,163 | 4,489 | 2,225,434 | 275,652,919 | 2,949 | 421 | 320 | 746 | 722 | 538 | 93,738,635 | 193 | 377 | 
| regex_program | 1 | 759 | 3,259 | 1,914,993 | 198,099,628 | 2,198 | 303 | 232 | 544 | 602 | 368 | 73,709,236 | 140 | 302 | 

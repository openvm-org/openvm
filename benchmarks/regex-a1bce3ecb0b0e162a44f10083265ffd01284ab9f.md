...
| `total_proof_time_ms ` |  583 |  2,332 |  689 |  543 |
...
| `execute_metered_insn_mi/s` |  107.06 | -          |  107.06 |  107.06 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  54 |  216 |  67 |  45 |
| `execute_preflight_insn_mi/s` |  30.99 | -          |  32.30 |  28.18 |
| `trace_gen_time_ms   ` |  169.75 |  679 |  183 |  153 |
| `memory_finalize_time_ms` |  1 |  4 |  4 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  285.50 |  1,142 |  293 |  278 |
| `main_trace_commit_time_ms` |  52 |  208 |  56 |  50 |
| `generate_perm_trace_time_ms` |  24 |  96 |  28 |  20 |
| `perm_trace_commit_time_ms` |  64.71 |  258.86 |  71.36 |  55.66 |
| `quotient_poly_compute_time_ms` |  59.67 |  238.68 |  69.56 |  53.63 |
| `quotient_poly_commit_time_ms` |  15.98 |  63.94 |  18.67 |  13.54 |
| `pcs_opening_time_ms ` |  66 |  264 |  73 |  56 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,391.50 |  5,566 |  2,052 |  897 |
...
| `execute_preflight_insns` |  1,440,841.25 |  5,763,365 |  1,814,584 |  1,241,376 |
| `execute_preflight_time_ms` |  628.25 |  2,513 |  839 |  225 |
| `execute_preflight_insn_mi/s` |  7.07 | -          |  7.46 |  6.76 |
| `trace_gen_time_ms   ` |  87 |  348 |  160 |  58 |
| `memory_finalize_time_ms` |  8.75 |  35 |  17 |  5 |
| `stark_prove_excluding_trace_time_ms` |  674.75 |  2,699 |  1,112 |  488 |
| `main_trace_commit_time_ms` |  125 |  500 |  195 |  91 |
| `generate_perm_trace_time_ms` |  51.50 |  206 |  73 |  38 |
| `perm_trace_commit_time_ms` |  209.35 |  837.38 |  382.61 |  142.41 |
| `quotient_poly_compute_time_ms` |  146.06 |  584.24 |  241.12 |  103.03 |
| `quotient_poly_commit_time_ms` |  33.11 |  132.46 |  56.96 |  24.26 |
| `pcs_opening_time_ms ` |  105.25 |  421 |  156 |  77 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 2,053 |  | 1 | 1 |  |  |  |  | 
| regex_program |  | 548 |  | 1 | 38 | 4,137,502 | 107.06 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 71 | 897 | 22,981,570 | 319,331,818 | 71 | 599 | 0 | 136.88 | 26.82 | 4 | 169.67 | 92 | 219 | 92 | 7 | 122 | 9,122,488 | 48 | 225 | 1,466,017 | 7.46 | 31 | 164 | 0 | 92 | 
| leaf | 1 | 58 | 1,398 | 20,905,034 | 255,237,610 | 58 | 500 | 0 | 103.21 | 24.26 | 4 | 142.70 | 96 | 182 | 96 | 5 | 92 | 8,256,948 | 38 | 839 | 1,241,376 | 6.96 | 26 | 128 | 0 | 96 | 
| leaf | 2 | 59 | 1,219 | 20,905,034 | 255,237,610 | 59 | 488 | 0 | 103.03 | 24.42 | 4 | 142.41 | 77 | 190 | 77 | 6 | 91 | 8,256,948 | 47 | 671 | 1,241,388 | 7.11 | 26 | 128 | 0 | 77 | 
| leaf | 3 | 160 | 2,052 | 50,337,320 | 538,365,418 | 160 | 1,112 | 0 | 241.12 | 56.96 | 4 | 382.61 | 156 | 457 | 156 | 17 | 195 | 20,171,106 | 73 | 778 | 1,814,584 | 6.76 | 61 | 302 | 5 | 156 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 181 | 689 | 23,446,148 | 150,778,428 | 181 | 293 | 0 | 60.81 | 18.67 | 5 | 71.36 | 56 | 100 | 55 | 4 | 56 | 10,899,170 | 28 | 46 | 1,103,000 | 28.18 | 22 | 80 | 1 | 55 | 
| regex_program | 1 | 153 | 543 | 11,598,276 | 128,513,066 | 153 | 281 | 1 | 54.67 | 15.37 | 4 | 66.05 | 72 | 87 | 72 | 0 | 51 | 2,196,106 | 20 | 67 | 1,104,000 | 31.56 | 17 | 70 | 0 | 72 | 
| regex_program | 2 | 162 | 552 | 11,579,064 | 128,513,066 | 162 | 290 | 1 | 53.63 | 16.37 | 4 | 65.79 | 73 | 94 | 73 | 0 | 50 | 2,177,334 | 28 | 58 | 1,104,000 | 32.30 | 17 | 70 | 0 | 73 | 
| regex_program | 3 | 183 | 548 | 11,853,872 | 103,456,394 | 183 | 278 | 0 | 69.56 | 13.54 | 5 | 55.66 | 63 | 79 | 63 | 0 | 51 | 2,422,606 | 20 | 45 | 826,502 | 31.91 | 19 | 84 | 1 | 63 | 

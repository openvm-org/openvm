...
| `total_proof_time_ms ` |  715.50 |  1,431 |  816 |  615 |
...
| `execute_preflight_insn_mi/s` |  14.79 | -          |  18.60 |  10.99 |
| `trace_gen_time_ms   ` |  185.50 |  371 |  192 |  179 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  354.50 |  709 |  386 |  323 |
| `main_trace_commit_time_ms` |  64 |  128 |  74 |  54 |
| `generate_perm_trace_time_ms` |  38 |  76 |  40 |  36 |
| `perm_trace_commit_time_ms` |  75.92 |  151.85 |  87.99 |  63.86 |
| `quotient_poly_compute_time_ms` |  77.84 |  155.67 |  86.13 |  69.54 |
| `quotient_poly_commit_time_ms` |  15.79 |  31.58 |  17.22 |  14.36 |
| `pcs_opening_time_ms ` |  77 |  154 |  79 |  75 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,432 |  2,864 |  1,693 |  1,171 |
| `main_cells_used     ` |  16,200,472 |  32,400,944 |  16,332,746 |  16,068,198 |
| `total_cells_used    ` |  39,332,920 |  78,665,840 |  39,650,868 |  39,014,972 |
| `execute_preflight_insns` |  1,952,392 |  3,904,784 |  1,991,936 |  1,912,848 |
| `execute_preflight_time_ms` |  583.50 |  1,167 |  870 |  297 |
| `execute_preflight_insn_mi/s` |  7.62 | -          |  7.63 |  7.61 |
| `trace_gen_time_ms   ` |  119.50 |  239 |  128 |  111 |
| `memory_finalize_time_ms` |  12 |  24 |  13 |  11 |
| `stark_prove_excluding_trace_time_ms` |  727 |  1,454 |  744 |  710 |
| `main_trace_commit_time_ms` |  145.50 |  291 |  149 |  142 |
| `generate_perm_trace_time_ms` |  54 |  108 |  54 |  54 |
| `perm_trace_commit_time_ms` |  224.43 |  448.86 |  229.76 |  219.11 |
| `quotient_poly_compute_time_ms` |  164.96 |  329.92 |  167.06 |  162.87 |
| `quotient_poly_commit_time_ms` |  31.02 |  62.03 |  31.86 |  30.18 |
| `pcs_opening_time_ms ` |  104.50 |  209 |  110 |  99 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 1,695 |  | 1 | 1 |  |  |  |  | 
| pairing |  | 615 |  | 1 | 70 | 1,745,742 | 24.91 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 128 | 1,171 | 39,650,868 | 410,701,290 | 128 | 744 | 0 | 167.06 | 31.86 | 4 | 229.76 | 110 | 284 | 110 | 13 | 149 | 16,332,746 | 54 | 297 | 1,991,936 | 7.61 | 39 | 200 | 0 | 110 | 
| leaf | 1 | 111 | 1,693 | 39,014,972 | 396,840,426 | 111 | 710 | 0 | 162.87 | 30.18 | 4 | 219.11 | 99 | 273 | 99 | 11 | 142 | 16,068,198 | 54 | 870 | 1,912,848 | 7.63 | 37 | 194 | 0 | 99 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 179 | 816 | 32,480,114 | 172,558,444 | 179 | 386 | 0 | 86.13 | 17.22 | 6 | 87.99 | 75 | 131 | 75 | 1 | 74 | 15,909,408 | 40 | 108 | 1,149,000 | 10.99 | 26 | 104 | 1 | 75 | 
| pairing | 1 | 192 | 615 | 22,464,232 | 119,958,502 | 192 | 323 | 1 | 69.54 | 14.36 | 6 | 63.86 | 79 | 103 | 79 | 0 | 54 | 9,498,894 | 36 | 59 | 596,742 | 18.60 | 20 | 84 | 1 | 79 | 

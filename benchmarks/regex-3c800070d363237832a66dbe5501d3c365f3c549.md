...
| `total_proof_time_ms ` |  3,941 |  7,882 |  4,364 |  3,518 |
...
| `trace_gen_time_ms   ` |  982.50 |  1,965 |  1,172 |  793 |
| `stark_prove_excluding_trace_time_ms` |  2,600.50 |  5,201 |  2,794 |  2,407 |
| `main_trace_commit_time_ms` |  498.50 |  997 |  554 |  443 |
| `generate_perm_trace_time_ms` |  222 |  444 |  232 |  212 |
| `perm_trace_commit_time_ms` |  547.50 |  1,095 |  575 |  520 |
| `quotient_poly_compute_time_ms` |  261.50 |  523 |  284 |  239 |
| `quotient_poly_commit_time_ms` |  251 |  502 |  290 |  212 |
| `pcs_opening_time_ms ` |  810 |  1,620 |  849 |  771 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  6,989.50 |  13,979 |  7,063 |  6,916 |
| `main_cells_used     ` |  151,828,013 |  303,656,026 |  154,227,878 |  149,428,148 |
| `total_cycles        ` |  1,975,741 |  3,951,482 |  2,006,569 |  1,944,913 |
| `execute_time_ms     ` |  775.50 |  1,551 |  785 |  766 |
| `trace_gen_time_ms   ` |  1,445 |  2,890 |  1,478 |  1,412 |
| `stark_prove_excluding_trace_time_ms` |  4,769 |  9,538 |  4,800 |  4,738 |
| `main_trace_commit_time_ms` |  866 |  1,732 |  867 |  865 |
| `generate_perm_trace_time_ms` |  405.50 |  811 |  425 |  386 |
| `perm_trace_commit_time_ms` |  1,261.50 |  2,523 |  1,265 |  1,258 |
| `quotient_poly_compute_time_ms` |  519.50 |  1,039 |  529 |  510 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,478 | 7,063 | 2,006,569 | 538,660,330 | 4,800 | 529 | 413 | 1,258 | 1,304 | 865 | 154,227,878 | 425 | 785 | 
| leaf | 1 | 1,412 | 6,916 | 1,944,913 | 538,660,330 | 4,738 | 510 | 415 | 1,265 | 1,290 | 867 | 149,428,148 | 386 | 766 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,172 | 4,364 | 2,243,715 | 275,652,919 | 2,794 | 284 | 290 | 575 | 849 | 554 | 93,500,799 | 232 | 398 | 
| regex_program | 1 | 793 | 3,518 | 1,921,511 | 242,975,404 | 2,407 | 239 | 212 | 520 | 771 | 443 | 73,010,353 | 212 | 318 | 

...
| `total_proof_time_ms ` |  3,794.50 |  7,589 |  4,862 |  2,727 |
...
| `execute_metered_insn_mi/s` |  131.12 | -          |  131.12 |  131.12 |
| `execute_preflight_insns` |  2,054,298.50 |  4,108,597 |  2,211,000 |  1,897,597 |
| `execute_preflight_time_ms` |  96 |  192 |  104 |  88 |
| `execute_preflight_insn_mi/s` |  28.18 | -          |  30.96 |  25.41 |
| `trace_gen_time_ms   ` |  392.50 |  785 |  501 |  284 |
| `memory_finalize_time_ms` |  8 |  16 |  14 |  2 |
| `stark_prove_excluding_trace_time_ms` |  3,078 |  6,156 |  4,014 |  2,142 |
| `main_trace_commit_time_ms` |  629.50 |  1,259 |  846 |  413 |
| `generate_perm_trace_time_ms` |  225.50 |  451 |  300 |  151 |
| `perm_trace_commit_time_ms` |  647.50 |  1,295 |  847 |  448 |
| `quotient_poly_compute_time_ms` |  314 |  628 |  427 |  201 |
| `quotient_poly_commit_time_ms` |  299 |  598 |  394 |  204 |
| `pcs_opening_time_ms ` |  954.50 |  1,909 |  1,194 |  715 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  5,703 |  11,406 |  6,884 |  4,522 |
| `main_cells_used     ` |  122,269,851 |  244,539,702 |  153,709,940 |  90,829,762 |
| `total_cells_used    ` |  304,358,421 |  608,716,842 |  391,464,882 |  217,251,960 |
| `execute_preflight_insns` |  1,663,329 |  3,326,658 |  1,830,115 |  1,496,543 |
| `execute_preflight_time_ms` |  623 |  1,246 |  803 |  443 |
| `execute_preflight_insn_mi/s` |  4.22 | -          |  4.39 |  4.04 |
| `trace_gen_time_ms   ` |  286 |  572 |  353 |  219 |
| `memory_finalize_time_ms` |  12.50 |  25 |  16 |  9 |
| `stark_prove_excluding_trace_time_ms` |  3,749.50 |  7,499 |  4,670 |  2,829 |
| `main_trace_commit_time_ms` |  707 |  1,414 |  837 |  577 |
| `generate_perm_trace_time_ms` |  310.50 |  621 |  392 |  229 |
| `perm_trace_commit_time_ms` |  959.50 |  1,919 |  1,245 |  674 |
| `quotient_poly_compute_time_ms` |  415.50 |  831 |  521 |  310 |
| `quotient_poly_commit_time_ms` |  316 |  632 |  376 |  256 |
| `pcs_opening_time_ms ` |  1,035.50 |  2,071 |  1,294 |  777 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 6,886 |  | 1 |  | 1 |  |  |  |  | 
| regex_program |  | 2,727 |  | 6 | 1 | 31 | 4,108,597 | 131.12 | 44 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 219 | 4,522 | 217,251,960 | 319,626,730 | 219 | 2,829 | 0 | 310 | 256 | 674 | 777 | 9 | 577 | 90,829,762 | 229 | 443 | 1,496,543 | 4.04 | 
| leaf | 1 | 353 | 6,884 | 391,464,882 | 538,660,330 | 353 | 4,670 | 0 | 521 | 376 | 1,245 | 1,294 | 16 | 837 | 153,709,940 | 392 | 803 | 1,830,115 | 4.39 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 501 | 4,862 | 211,758,557 | 373,183,036 | 501 | 4,014 | 0 | 427 | 394 | 847 | 1,194 | 7 | 14 | 846 | 91,281,687 | 300 | 104 | 2,211,000 | 25.41 | 
| regex_program | 1 | 284 | 2,727 | 174,326,267 | 196,838,026 | 284 | 2,142 | 54 | 201 | 204 | 448 | 715 | 8 | 2 | 413 | 73,453,305 | 151 | 88 | 1,897,597 | 30.96 | 

...
| `total_proof_time_ms ` |  3,856.50 |  7,713 |  4,429 |  3,284 |
| `main_cells_used     ` |  83,723,935.50 |  167,447,871 |  93,738,635 |  73,709,236 |
| `total_cycles        ` |  2,070,213.50 |  4,140,427 |  2,225,434 |  1,914,993 |
| `execute_time_ms     ` |  340 |  680 |  375 |  305 |
| `trace_gen_time_ms   ` |  973 |  1,946 |  1,151 |  795 |
| `stark_prove_excluding_trace_time_ms` |  2,543.50 |  5,087 |  2,903 |  2,184 |
| `main_trace_commit_time_ms` |  452 |  904 |  534 |  370 |
| `generate_perm_trace_time_ms` |  159 |  318 |  178 |  140 |
| `perm_trace_commit_time_ms` |  643.50 |  1,287 |  742 |  545 |
| `quotient_poly_compute_time_ms` |  358.50 |  717 |  417 |  300 |
| `quotient_poly_commit_time_ms` |  270.50 |  541 |  315 |  226 |
| `pcs_opening_time_ms ` |  650 |  1,300 |  707 |  593 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,477.50 |  14,955 |  7,577 |  7,378 |
| `main_cells_used     ` |  152,710,377.50 |  305,420,755 |  155,170,079 |  150,250,676 |
| `total_cycles        ` |  1,991,059.50 |  3,982,119 |  2,021,901 |  1,960,218 |
| `execute_time_ms     ` |  753.50 |  1,507 |  760 |  747 |
| `trace_gen_time_ms   ` |  1,473 |  2,946 |  1,521 |  1,425 |
| `stark_prove_excluding_trace_time_ms` |  5,251 |  10,502 |  5,296 |  5,206 |
| `main_trace_commit_time_ms` |  890.50 |  1,781 |  892 |  889 |
| `generate_perm_trace_time_ms` |  342.50 |  685 |  344 |  341 |
| `perm_trace_commit_time_ms` |  1,664 |  3,328 |  1,698 |  1,630 |
| `quotient_poly_compute_time_ms` |  762.50 |  1,525 |  768 |  757 |
| `quotient_poly_commit_time_ms` |  523.50 |  1,047 |  526 |  521 |
| `pcs_opening_time_ms ` |  1,063 |  2,126 |  1,063 |  1,063 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,521 | 7,577 | 2,021,901 | 538,660,330 | 5,296 | 768 | 526 | 1,698 | 1,063 | 892 | 155,170,079 | 344 | 760 | 
| leaf | 1 | 1,425 | 7,378 | 1,960,218 | 538,660,330 | 5,206 | 757 | 521 | 1,630 | 1,063 | 889 | 150,250,676 | 341 | 747 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,151 | 4,429 | 2,225,434 | 275,652,919 | 2,903 | 417 | 315 | 742 | 707 | 534 | 93,738,635 | 178 | 375 | 
| regex_program | 1 | 795 | 3,284 | 1,914,993 | 198,099,628 | 2,184 | 300 | 226 | 545 | 593 | 370 | 73,709,236 | 140 | 305 | 

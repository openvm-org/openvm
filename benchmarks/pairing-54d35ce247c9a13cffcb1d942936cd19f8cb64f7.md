...
| `total_proof_time_ms ` |  717.50 |  1,435 |  836 |  599 |
...
| `execute_metered_insn_mi/s` |  27.49 | -          |  27.49 |  27.49 |
| `execute_preflight_insns` |  872,871 |  1,745,742 |  1,149,000 |  596,742 |
| `execute_preflight_time_ms` |  84 |  168 |  106 |  62 |
| `execute_preflight_insn_mi/s` |  14.73 | -          |  18.30 |  11.16 |
| `trace_gen_time_ms   ` |  181 |  362 |  187 |  175 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  346.50 |  693 |  384 |  309 |
| `main_trace_commit_time_ms` |  63.50 |  127 |  74 |  53 |
| `generate_perm_trace_time_ms` |  34 |  68 |  39 |  29 |
| `perm_trace_commit_time_ms` |  76.49 |  152.97 |  87.85 |  65.13 |
| `quotient_poly_compute_time_ms` |  82.12 |  164.23 |  90.01 |  74.22 |
| `quotient_poly_commit_time_ms` |  17.04 |  34.08 |  18.87 |  15.21 |
| `pcs_opening_time_ms ` |  68 |  136 |  69 |  67 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,461 |  2,922 |  1,733 |  1,189 |
| `main_cells_used     ` |  16,200,472 |  32,400,944 |  16,332,746 |  16,068,198 |
| `total_cells_used    ` |  39,332,920 |  78,665,840 |  39,650,868 |  39,014,972 |
| `execute_preflight_insns` |  1,952,463.50 |  3,904,927 |  1,991,979 |  1,912,948 |
| `execute_preflight_time_ms` |  595.50 |  1,191 |  888 |  303 |
| `execute_preflight_insn_mi/s` |  7.50 | -          |  7.50 |  7.49 |
| `trace_gen_time_ms   ` |  121.50 |  243 |  131 |  112 |
| `memory_finalize_time_ms` |  12.50 |  25 |  14 |  11 |
| `stark_prove_excluding_trace_time_ms` |  742 |  1,484 |  753 |  731 |
| `main_trace_commit_time_ms` |  144.50 |  289 |  148 |  141 |
| `generate_perm_trace_time_ms` |  56.50 |  113 |  58 |  55 |
| `perm_trace_commit_time_ms` |  225.65 |  451.29 |  229.29 |  222 |
| `quotient_poly_compute_time_ms` |  172.95 |  345.90 |  174.83 |  171.08 |
| `quotient_poly_commit_time_ms` |  33.22 |  66.43 |  34.06 |  32.37 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 1,735 |  | 1 | 1 |  |  |  |  | 
| pairing |  | 599 |  | 1 | 63 | 1,745,742 | 27.49 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 131 | 1,189 | 39,650,868 | 410,701,290 | 131 | 753 | 0 | 174.83 | 34.06 | 4 | 229.29 | 109 | 285 | 109 | 14 | 148 | 16,332,746 | 55 | 303 | 1,991,979 | 7.49 | 39 | 210 | 0 | 109 | 
| leaf | 1 | 112 | 1,733 | 39,014,972 | 396,840,426 | 112 | 731 | 0 | 171.08 | 32.37 | 4 | 222 | 103 | 280 | 103 | 11 | 141 | 16,068,198 | 58 | 888 | 1,912,948 | 7.50 | 38 | 204 | 0 | 103 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 175 | 836 | 32,480,114 | 172,558,444 | 175 | 384 | 0 | 90.01 | 18.87 | 6 | 87.85 | 69 | 130 | 69 | 1 | 74 | 15,909,408 | 39 | 106 | 1,149,000 | 11.16 | 26 | 109 | 1 | 69 | 
| pairing | 1 | 187 | 599 | 22,464,232 | 119,958,502 | 187 | 309 | 1 | 74.22 | 15.21 | 6 | 65.13 | 67 | 97 | 67 | 0 | 53 | 9,498,894 | 29 | 62 | 596,742 | 18.30 | 20 | 90 | 1 | 67 | 

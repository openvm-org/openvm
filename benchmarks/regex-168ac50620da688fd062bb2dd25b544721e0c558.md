...
| `total_proof_time_ms ` |  4,164 |  8,328 |  4,624 |  3,704 |
| `main_cells_used     ` |  83,910,936 |  167,821,872 |  94,156,159 |  73,665,713 |
| `total_cycles        ` |  2,082,613 |  4,165,226 |  2,243,715 |  1,921,511 |
| `execute_time_ms     ` |  338 |  676 |  376 |  300 |
| `trace_gen_time_ms   ` |  965.50 |  1,931 |  1,169 |  762 |
| `stark_prove_excluding_trace_time_ms` |  2,860.50 |  5,721 |  3,079 |  2,642 |
| `main_trace_commit_time_ms` |  520.50 |  1,041 |  584 |  457 |
| `generate_perm_trace_time_ms` |  195 |  390 |  196 |  194 |
| `perm_trace_commit_time_ms` |  750.50 |  1,501 |  804 |  697 |
| `quotient_poly_compute_time_ms` |  394 |  788 |  419 |  369 |
| `quotient_poly_commit_time_ms` |  300 |  600 |  337 |  263 |
| `pcs_opening_time_ms ` |  691.50 |  1,383 |  732 |  651 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,522 |  15,044 |  7,604 |  7,440 |
| `main_cells_used     ` |  152,278,339 |  304,556,678 |  154,678,006 |  149,878,672 |
| `total_cycles        ` |  1,991,039.50 |  3,982,079 |  2,021,851 |  1,960,228 |
| `execute_time_ms     ` |  751.50 |  1,503 |  759 |  744 |
| `trace_gen_time_ms   ` |  1,487 |  2,974 |  1,530 |  1,444 |
| `stark_prove_excluding_trace_time_ms` |  5,283.50 |  10,567 |  5,315 |  5,252 |
| `main_trace_commit_time_ms` |  892.50 |  1,785 |  894 |  891 |
| `generate_perm_trace_time_ms` |  361.50 |  723 |  362 |  361 |
| `perm_trace_commit_time_ms` |  1,662 |  3,324 |  1,691 |  1,633 |
| `quotient_poly_compute_time_ms` |  770.50 |  1,541 |  776 |  765 |
| `quotient_poly_commit_time_ms` |  522 |  1,044 |  524 |  520 |
| `pcs_opening_time_ms ` |  1,070.50 |  2,141 |  1,075 |  1,066 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,530 | 7,604 | 2,021,851 | 538,660,330 | 5,315 | 765 | 524 | 1,691 | 1,075 | 894 | 154,678,006 | 361 | 759 | 
| leaf | 1 | 1,444 | 7,440 | 1,960,228 | 538,660,330 | 5,252 | 776 | 520 | 1,633 | 1,066 | 891 | 149,878,672 | 362 | 744 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,169 | 4,624 | 2,243,715 | 275,652,919 | 3,079 | 419 | 337 | 804 | 732 | 584 | 94,156,159 | 194 | 376 | 
| regex_program | 1 | 762 | 3,704 | 1,921,511 | 242,975,404 | 2,642 | 369 | 263 | 697 | 651 | 457 | 73,665,713 | 196 | 300 | 

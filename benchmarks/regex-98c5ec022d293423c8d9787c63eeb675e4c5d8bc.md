...
| `total_proof_time_ms ` |  4,160.50 |  8,321 |  4,606 |  3,715 |
...
| `trace_gen_time_ms   ` |  969 |  1,938 |  1,156 |  782 |
| `stark_prove_excluding_trace_time_ms` |  2,851.50 |  5,703 |  3,073 |  2,630 |
| `main_trace_commit_time_ms` |  520.50 |  1,041 |  584 |  457 |
| `generate_perm_trace_time_ms` |  191 |  382 |  193 |  189 |
| `perm_trace_commit_time_ms` |  746.50 |  1,493 |  799 |  694 |
| `quotient_poly_compute_time_ms` |  394 |  788 |  424 |  364 |
| `quotient_poly_commit_time_ms` |  296 |  592 |  334 |  258 |
| `pcs_opening_time_ms ` |  694 |  1,388 |  733 |  655 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,548 |  15,096 |  7,611 |  7,485 |
| `main_cells_used     ` |  152,278,273 |  304,556,546 |  154,678,318 |  149,878,228 |
| `total_cycles        ` |  1,991,034 |  3,982,068 |  2,021,877 |  1,960,191 |
| `execute_time_ms     ` |  760 |  1,520 |  769 |  751 |
| `trace_gen_time_ms   ` |  1,479 |  2,958 |  1,499 |  1,459 |
| `stark_prove_excluding_trace_time_ms` |  5,309 |  10,618 |  5,343 |  5,275 |
| `main_trace_commit_time_ms` |  893.50 |  1,787 |  894 |  893 |
| `generate_perm_trace_time_ms` |  374.50 |  749 |  388 |  361 |
| `perm_trace_commit_time_ms` |  1,672 |  3,344 |  1,709 |  1,635 |
| `quotient_poly_compute_time_ms` |  769.50 |  1,539 |  772 |  767 |
| `quotient_poly_commit_time_ms` |  520 |  1,040 |  522 |  518 |
| `pcs_opening_time_ms ` |  1,074.50 |  2,149 |  1,096 |  1,053 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,499 | 7,611 | 2,021,877 | 538,660,330 | 5,343 | 772 | 522 | 1,709 | 1,053 | 894 | 154,678,318 | 388 | 769 | 
| leaf | 1 | 1,459 | 7,485 | 1,960,191 | 538,660,330 | 5,275 | 767 | 518 | 1,635 | 1,096 | 893 | 149,878,228 | 361 | 751 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,156 | 4,606 | 2,243,715 | 275,652,919 | 3,073 | 424 | 334 | 799 | 733 | 584 | 94,156,159 | 189 | 377 | 
| regex_program | 1 | 782 | 3,715 | 1,921,511 | 242,975,404 | 2,630 | 364 | 258 | 694 | 655 | 457 | 73,665,713 | 193 | 303 | 

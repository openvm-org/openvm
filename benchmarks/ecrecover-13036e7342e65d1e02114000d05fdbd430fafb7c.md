...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  18,247 |  18,247 |  18,247 |  18,247 |
| `main_cells_used     ` |  186,734,533 |  186,734,533 |  186,734,533 |  186,734,533 |
| `total_cycles        ` |  4,158,106 |  4,158,106 |  4,158,106 |  4,158,106 |
| `execute_time_ms     ` |  940 |  940 |  940 |  940 |
| `trace_gen_time_ms   ` |  3,403 |  3,403 |  3,403 |  3,403 |
| `stark_prove_excluding_trace_time_ms` |  13,904 |  13,904 |  13,904 |  13,904 |
| `main_trace_commit_time_ms` |  2,787 |  2,787 |  2,787 |  2,787 |
| `generate_perm_trace_time_ms` |  358 |  358 |  358 |  358 |
| `perm_trace_commit_time_ms` |  2,896 |  2,896 |  2,896 |  2,896 |
| `quotient_poly_compute_time_ms` |  2,081 |  2,081 |  2,081 |  2,081 |
| `quotient_poly_commit_time_ms` |  2,656 |  2,656 |  2,656 |  2,656 |
| `pcs_opening_time_ms ` |  3,123 |  3,123 |  3,123 |  3,123 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 3,403 | 18,247 | 4,158,106 | 459,031,512 | 13,904 | 2,081 | 2,656 | 2,896 | 3,123 | 2,787 | 186,734,533 | 358 | 940 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 262 | 2,586 | 284,567 | 38,417,467 | 2,176 | 227 | 485 | 352 | 669 | 398 | 15,055,723 | 33 | 148 | 

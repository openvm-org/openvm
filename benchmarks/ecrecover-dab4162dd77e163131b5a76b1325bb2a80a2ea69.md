...
| `total_proof_time_ms ` |  1,482 |  1,482 |  1,482 |  1,482 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  12,720 |  12,720 |  12,720 |  12,720 |
...
| `stark_prove_excluding_trace_time_ms` |  9,311 |  9,311 |  9,311 |  9,311 |
| `main_trace_commit_time_ms` |  1,626 |  1,626 |  1,626 |  1,626 |
| `generate_perm_trace_time_ms` |  709 |  709 |  709 |  709 |
| `perm_trace_commit_time_ms` |  2,986 |  2,986 |  2,986 |  2,986 |
| `quotient_poly_compute_time_ms` |  1,340 |  1,340 |  1,340 |  1,340 |
| `quotient_poly_commit_time_ms` |  838 |  838 |  838 |  838 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 2,302 | 12,720 | 2,989,593 | 999,656,938 | 9,311 | 1,340 | 838 | 2,986 | 1,802 | 1,626 | 244,319,094 | 709 | 1,107 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 180 | 1,482 | 295,181 | 48,197,161 | 1,153 | 126 | 160 | 197 | 439 | 181 | 15,586,346 | 32 | 149 | 

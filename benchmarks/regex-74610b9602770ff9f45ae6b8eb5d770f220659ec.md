...
| `total_proof_time_ms ` |  7,447.50 |  14,895 |  8,334 |  6,561 |
| `main_cells_used     ` |  82,727,686.50 |  165,455,373 |  92,686,348 |  72,769,025 |
| `total_cycles        ` |  1,914,103 |  1,914,103 |  1,914,103 |  1,914,103 |
| `execute_time_ms     ` |  449.50 |  899 |  483 |  416 |
| `trace_gen_time_ms   ` |  1,450 |  2,900 |  1,611 |  1,289 |
| `stark_prove_excluding_trace_time_ms` |  5,548 |  11,096 |  6,240 |  4,856 |
| `main_trace_commit_time_ms` |  1,116.50 |  2,233 |  1,341 |  892 |
| `generate_perm_trace_time_ms` |  179.50 |  359 |  194 |  165 |
| `perm_trace_commit_time_ms` |  1,191 |  2,382 |  1,252 |  1,130 |
| `quotient_poly_compute_time_ms` |  739.50 |  1,479 |  859 |  620 |
| `quotient_poly_commit_time_ms` |  978.50 |  1,957 |  1,144 |  813 |
| `pcs_opening_time_ms ` |  1,329 |  2,658 |  1,440 |  1,218 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  14,425 |  28,850 |  14,596 |  14,254 |
| `main_cells_used     ` |  129,447,973.50 |  258,895,947 |  131,049,344 |  127,846,603 |
| `total_cycles        ` |  2,941,713.50 |  5,883,427 |  2,978,223 |  2,905,204 |
| `execute_time_ms     ` |  640.50 |  1,281 |  676 |  605 |
| `trace_gen_time_ms   ` |  2,380.50 |  4,761 |  2,555 |  2,206 |
| `stark_prove_excluding_trace_time_ms` |  11,404 |  22,808 |  11,436 |  11,372 |
| `main_trace_commit_time_ms` |  2,346 |  4,692 |  2,366 |  2,326 |
| `generate_perm_trace_time_ms` |  288 |  576 |  292 |  284 |
| `perm_trace_commit_time_ms` |  2,306 |  4,612 |  2,309 |  2,303 |
| `quotient_poly_compute_time_ms` |  1,640 |  3,280 |  1,644 |  1,636 |
| `quotient_poly_commit_time_ms` |  2,221.50 |  4,443 |  2,254 |  2,189 |
| `pcs_opening_time_ms ` |  2,599 |  5,198 |  2,615 |  2,583 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 2,206 | 14,254 | 2,978,223 | 353,773,272 | 11,372 | 1,644 | 2,189 | 2,303 | 2,615 | 2,326 | 131,049,344 | 292 | 676 | 
| leaf | 1 | 2,555 | 14,596 | 2,905,204 | 353,780,696 | 11,436 | 1,636 | 2,254 | 2,309 | 2,583 | 2,366 | 127,846,603 | 284 | 605 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,611 | 8,334 |  | 209,921,543 | 6,240 | 859 | 1,144 | 1,252 | 1,440 | 1,341 | 92,686,348 | 194 | 483 | 
| regex_program | 1 | 1,289 | 6,561 | 1,914,103 | 149,454,692 | 4,856 | 620 | 813 | 1,130 | 1,218 | 892 | 72,769,025 | 165 | 416 | 

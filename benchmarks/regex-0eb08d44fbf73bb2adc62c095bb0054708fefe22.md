...
| `total_proof_time_ms ` |  3,872.50 |  7,745 |  4,480 |  3,265 |
...
| `trace_gen_time_ms   ` |  968 |  1,936 |  1,155 |  781 |
| `stark_prove_excluding_trace_time_ms` |  2,568.50 |  5,137 |  2,952 |  2,185 |
| `main_trace_commit_time_ms` |  449 |  898 |  529 |  369 |
| `generate_perm_trace_time_ms` |  164 |  328 |  191 |  137 |
| `perm_trace_commit_time_ms` |  639.50 |  1,279 |  747 |  532 |
| `quotient_poly_compute_time_ms` |  361.50 |  723 |  416 |  307 |
| `quotient_poly_commit_time_ms` |  272.50 |  545 |  319 |  226 |
| `pcs_opening_time_ms ` |  671 |  1,342 |  739 |  603 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,498.50 |  14,997 |  7,558 |  7,439 |
| `main_cells_used     ` |  152,323,227.50 |  304,646,455 |  154,782,208 |  149,864,247 |
| `total_cycles        ` |  1,993,991 |  3,987,982 |  2,024,839 |  1,963,143 |
| `execute_time_ms     ` |  775.50 |  1,551 |  784 |  767 |
| `trace_gen_time_ms   ` |  1,490 |  2,980 |  1,521 |  1,459 |
| `stark_prove_excluding_trace_time_ms` |  5,233 |  10,466 |  5,253 |  5,213 |
| `main_trace_commit_time_ms` |  898.50 |  1,797 |  900 |  897 |
| `generate_perm_trace_time_ms` |  340 |  680 |  342 |  338 |
| `perm_trace_commit_time_ms` |  1,645.50 |  3,291 |  1,674 |  1,617 |
| `quotient_poly_compute_time_ms` |  757.50 |  1,515 |  759 |  756 |
| `quotient_poly_commit_time_ms` |  523 |  1,046 |  525 |  521 |
| `pcs_opening_time_ms ` |  1,062.50 |  2,125 |  1,070 |  1,055 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,521 | 7,558 | 2,024,839 | 533,941,738 | 5,253 | 759 | 521 | 1,674 | 1,055 | 897 | 154,782,208 | 342 | 784 | 
| leaf | 1 | 1,459 | 7,439 | 1,963,143 | 533,941,738 | 5,213 | 756 | 525 | 1,617 | 1,070 | 900 | 149,864,247 | 338 | 767 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,155 | 4,480 | 2,225,434 | 275,652,919 | 2,952 | 416 | 319 | 747 | 739 | 529 | 93,699,990 | 191 | 373 | 
| regex_program | 1 | 781 | 3,265 | 1,914,730 | 198,099,628 | 2,185 | 307 | 226 | 532 | 603 | 369 | 73,689,460 | 137 | 299 | 

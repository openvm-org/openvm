...
| `total_proof_time_ms ` |  3,939 |  7,878 |  4,391 |  3,487 |
...
| `trace_gen_time_ms   ` |  964 |  1,928 |  1,161 |  767 |
| `stark_prove_excluding_trace_time_ms` |  2,620 |  5,240 |  2,835 |  2,405 |
| `main_trace_commit_time_ms` |  502.50 |  1,005 |  557 |  448 |
| `generate_perm_trace_time_ms` |  223.50 |  447 |  232 |  215 |
| `perm_trace_commit_time_ms` |  570.50 |  1,141 |  621 |  520 |
| `quotient_poly_compute_time_ms` |  260.50 |  521 |  284 |  237 |
| `quotient_poly_commit_time_ms` |  245 |  490 |  282 |  208 |
| `pcs_opening_time_ms ` |  809.50 |  1,619 |  850 |  769 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  6,999 |  13,998 |  7,064 |  6,934 |
| `main_cells_used     ` |  151,827,689 |  303,655,378 |  154,227,374 |  149,428,004 |
| `total_cycles        ` |  1,975,714 |  3,951,428 |  2,006,527 |  1,944,901 |
| `execute_time_ms     ` |  774 |  1,548 |  780 |  768 |
| `trace_gen_time_ms   ` |  1,469 |  2,938 |  1,490 |  1,448 |
| `stark_prove_excluding_trace_time_ms` |  4,756 |  9,512 |  4,794 |  4,718 |
| `main_trace_commit_time_ms` |  867.50 |  1,735 |  868 |  867 |
| `generate_perm_trace_time_ms` |  408 |  816 |  441 |  375 |
| `perm_trace_commit_time_ms` |  1,249.50 |  2,499 |  1,261 |  1,238 |
| `quotient_poly_compute_time_ms` |  515.50 |  1,031 |  518 |  513 |
| `quotient_poly_commit_time_ms` |  412 |  824 |  413 |  411 |
| `pcs_opening_time_ms ` |  1,297 |  2,594 |  1,304 |  1,290 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,490 | 7,064 | 2,006,527 | 538,660,330 | 4,794 | 518 | 413 | 1,261 | 1,290 | 867 | 154,227,374 | 441 | 780 | 
| leaf | 1 | 1,448 | 6,934 | 1,944,901 | 538,660,330 | 4,718 | 513 | 411 | 1,238 | 1,304 | 868 | 149,428,004 | 375 | 768 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,161 | 4,391 | 2,243,715 | 275,652,919 | 2,835 | 284 | 282 | 621 | 850 | 557 | 93,500,799 | 232 | 395 | 
| regex_program | 1 | 767 | 3,487 | 1,921,511 | 242,975,404 | 2,405 | 237 | 208 | 520 | 769 | 448 | 73,010,353 | 215 | 315 | 

...
| `total_proof_time_ms ` |  4,086.50 |  8,173 |  4,536 |  3,637 |
...
| `trace_gen_time_ms   ` |  1,041 |  2,082 |  1,230 |  852 |
| `stark_prove_excluding_trace_time_ms` |  2,707.50 |  5,415 |  2,931 |  2,484 |
| `main_trace_commit_time_ms` |  469.50 |  939 |  528 |  411 |
| `generate_perm_trace_time_ms` |  185 |  370 |  193 |  177 |
...
| `pcs_opening_time_ms ` |  682.50 |  1,365 |  722 |  643 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,270.50 |  14,541 |  7,335 |  7,206 |
| `main_cells_used     ` |  152,277,871 |  304,555,742 |  154,677,418 |  149,878,324 |
| `total_cycles        ` |  1,991,000.50 |  3,982,001 |  2,021,802 |  1,960,199 |
| `execute_time_ms     ` |  771 |  1,542 |  780 |  762 |
| `trace_gen_time_ms   ` |  1,483 |  2,966 |  1,487 |  1,479 |
| `stark_prove_excluding_trace_time_ms` |  5,016.50 |  10,033 |  5,068 |  4,965 |
| `main_trace_commit_time_ms` |  806 |  1,612 |  808 |  804 |
| `generate_perm_trace_time_ms` |  374 |  748 |  389 |  359 |
| `perm_trace_commit_time_ms` |  1,534 |  3,068 |  1,567 |  1,501 |
| `quotient_poly_compute_time_ms` |  767 |  1,534 |  769 |  765 |
| `quotient_poly_commit_time_ms` |  489 |  978 |  489 |  489 |
| `pcs_opening_time_ms ` |  1,041 |  2,082 |  1,042 |  1,040 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,487 | 7,335 | 2,021,802 | 538,660,330 | 5,068 | 769 | 489 | 1,567 | 1,040 | 808 | 154,677,418 | 389 | 780 | 
| leaf | 1 | 1,479 | 7,206 | 1,960,199 | 538,660,330 | 4,965 | 765 | 489 | 1,501 | 1,042 | 804 | 149,878,324 | 359 | 762 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,230 | 4,536 | 2,243,715 | 275,652,919 | 2,931 | 423 | 317 | 739 | 722 | 528 | 93,500,799 | 193 | 375 | 
| regex_program | 1 | 852 | 3,637 | 1,921,511 | 242,975,404 | 2,484 | 364 | 242 | 637 | 643 | 411 | 73,010,353 | 177 | 301 | 

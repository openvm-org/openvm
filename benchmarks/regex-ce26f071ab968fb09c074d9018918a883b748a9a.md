...
| `total_proof_time_ms ` |  1,483.50 |  2,967 |  1,718 |  1,249 |
...
| `execute_metered_insn_mi/s` |  103 | -          |  103 |  103 |
| `execute_preflight_insns` |  2,054,241.50 |  4,108,483 |  2,211,000 |  1,897,483 |
| `execute_preflight_time_ms` |  98 |  196 |  110 |  86 |
| `execute_preflight_insn_mi/s` |  29.78 | -          |  31.74 |  27.83 |
| `trace_gen_time_ms   ` |  312.50 |  625 |  335 |  290 |
| `memory_finalize_time_ms` |  1.50 |  3 |  3 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  986 |  1,972 |  1,215 |  757 |
| `main_trace_commit_time_ms` |  141 |  282 |  183 |  99 |
| `generate_perm_trace_time_ms` |  60.50 |  121 |  65 |  56 |
| `perm_trace_commit_time_ms` |  172.49 |  344.97 |  225.76 |  119.21 |
| `quotient_poly_compute_time_ms` |  164.05 |  328.10 |  179.57 |  148.53 |
| `quotient_poly_commit_time_ms` |  36.28 |  72.56 |  48.54 |  24.02 |
| `pcs_opening_time_ms ` |  404.50 |  809 |  540 |  269 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  2,062 |  4,124 |  2,828 |  1,296 |
| `main_cells_used     ` |  14,798,849 |  29,597,698 |  20,272,474 |  9,325,224 |
| `total_cells_used    ` |  37,032,585 |  74,065,170 |  50,586,080 |  23,479,090 |
| `execute_preflight_insns` |  1,663,268 |  3,326,536 |  1,829,910 |  1,496,626 |
| `execute_preflight_time_ms` |  581.50 |  1,163 |  899 |  264 |
| `execute_preflight_insn_mi/s` |  6.98 | -          |  7.23 |  6.73 |
| `trace_gen_time_ms   ` |  123.50 |  247 |  169 |  78 |
| `memory_finalize_time_ms` |  12.50 |  25 |  18 |  7 |
| `stark_prove_excluding_trace_time_ms` |  1,355.50 |  2,711 |  1,758 |  953 |
| `main_trace_commit_time_ms` |  181 |  362 |  230 |  132 |
| `generate_perm_trace_time_ms` |  73 |  146 |  85 |  61 |
| `perm_trace_commit_time_ms` |  276.95 |  553.90 |  368.14 |  185.77 |
| `quotient_poly_compute_time_ms` |  178.02 |  356.05 |  229.76 |  126.29 |
| `quotient_poly_commit_time_ms` |  43.99 |  87.99 |  58.72 |  29.27 |
| `pcs_opening_time_ms ` |  598.50 |  1,197 |  782 |  415 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 2,830 |  | 1 |  | 1 |  |  |  |  | 
| regex_program |  | 1,249 |  | 65 | 1 | 39 | 4,108,483 | 103 | 192 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 78 | 1,296 | 23,479,090 | 319,626,730 | 78 | 953 | 0 | 126.29 | 29.27 | 4 | 185.77 | 415 | 248 | 415 | 7 | 132 | 9,325,224 | 61 | 264 | 1,496,626 | 7.23 | 29 | 156 | 1 | 415 | 
| leaf | 1 | 169 | 2,828 | 50,586,080 | 538,660,330 | 169 | 1,758 | 0 | 229.76 | 58.72 | 5 | 368.14 | 782 | 454 | 782 | 18 | 230 | 20,272,474 | 85 | 899 | 1,829,910 | 6.73 | 56 | 291 | 1 | 782 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 290 | 1,718 | 23,397,108 | 373,183,036 | 290 | 1,215 | 0 | 148.53 | 48.54 | 6 | 225.76 | 540 | 292 | 540 | 3 | 183 | 10,866,434 | 65 | 86 | 2,211,000 | 27.83 | 46 | 199 | 2 | 540 | 
| regex_program | 1 | 335 | 1,249 | 11,981,356 | 196,739,722 | 335 | 757 | 2 | 179.57 | 24.02 | 6 | 119.21 | 269 | 179 | 269 | 0 | 99 | 2,537,170 | 56 | 110 | 1,897,483 | 31.74 | 26 | 208 | 2 | 269 | 

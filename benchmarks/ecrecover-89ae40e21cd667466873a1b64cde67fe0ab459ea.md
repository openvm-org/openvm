...
| `main_trace_commit_time_ms` |  175 |  175 |  175 |  175 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  12,808 |  12,808 |  12,808 |  12,808 |
| `main_cells_used     ` |  244,253,470 |  244,253,470 |  244,253,470 |  244,253,470 |
| `total_cycles        ` |  2,988,622 |  2,988,622 |  2,988,622 |  2,988,622 |
| `execute_time_ms     ` |  1,119 |  1,119 |  1,119 |  1,119 |
| `trace_gen_time_ms   ` |  2,372 |  2,372 |  2,372 |  2,372 |
| `stark_prove_excluding_trace_time_ms` |  9,317 |  9,317 |  9,317 |  9,317 |
| `main_trace_commit_time_ms` |  1,588 |  1,588 |  1,588 |  1,588 |
| `generate_perm_trace_time_ms` |  757 |  757 |  757 |  757 |
| `perm_trace_commit_time_ms` |  2,961 |  2,961 |  2,961 |  2,961 |
| `quotient_poly_compute_time_ms` |  1,350 |  1,350 |  1,350 |  1,350 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 2,372 | 12,808 | 2,988,622 | 1,008,831,978 | 9,317 | 1,350 | 834 | 2,961 | 1,821 | 1,588 | 244,253,470 | 757 | 1,119 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 187 | 1,446 | 289,447 | 48,240,297 | 1,112 | 127 | 155 | 188 | 418 | 175 | 14,470,186 | 34 | 147 | 

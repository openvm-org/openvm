...
| `pcs_opening_time_ms ` |  431 |  431 |  431 |  431 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  12,813 |  12,813 |  12,813 |  12,813 |
| `main_cells_used     ` |  244,252,846 |  244,252,846 |  244,252,846 |  244,252,846 |
| `total_cycles        ` |  2,988,570 |  2,988,570 |  2,988,570 |  2,988,570 |
| `execute_time_ms     ` |  1,110 |  1,110 |  1,110 |  1,110 |
| `trace_gen_time_ms   ` |  2,398 |  2,398 |  2,398 |  2,398 |
| `stark_prove_excluding_trace_time_ms` |  9,305 |  9,305 |  9,305 |  9,305 |
| `main_trace_commit_time_ms` |  1,578 |  1,578 |  1,578 |  1,578 |
| `generate_perm_trace_time_ms` |  749 |  749 |  749 |  749 |
| `perm_trace_commit_time_ms` |  2,975 |  2,975 |  2,975 |  2,975 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 2,398 | 12,813 | 2,988,570 | 1,008,831,978 | 9,305 | 1,345 | 836 | 2,975 | 1,816 | 1,578 | 244,252,846 | 749 | 1,110 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 176 | 1,451 | 289,447 | 48,240,297 | 1,128 | 126 | 154 | 193 | 431 | 174 | 14,470,186 | 34 | 147 | 

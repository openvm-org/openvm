...
| `total_proof_time_ms ` |  3,946 |  7,892 |  4,388 |  3,504 |
...
| `trace_gen_time_ms   ` |  976.50 |  1,953 |  1,151 |  802 |
| `stark_prove_excluding_trace_time_ms` |  2,615 |  5,230 |  2,843 |  2,387 |
| `main_trace_commit_time_ms` |  499 |  998 |  556 |  442 |
| `generate_perm_trace_time_ms` |  221 |  442 |  230 |  212 |
| `perm_trace_commit_time_ms` |  567.50 |  1,135 |  618 |  517 |
| `quotient_poly_compute_time_ms` |  264 |  528 |  286 |  242 |
| `quotient_poly_commit_time_ms` |  245.50 |  491 |  286 |  205 |
| `pcs_opening_time_ms ` |  808 |  1,616 |  857 |  759 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  6,976 |  13,952 |  7,033 |  6,919 |
| `main_cells_used     ` |  151,827,533 |  303,655,066 |  154,227,494 |  149,427,572 |
| `total_cycles        ` |  1,975,701 |  3,951,402 |  2,006,537 |  1,944,865 |
| `execute_time_ms     ` |  785.50 |  1,571 |  791 |  780 |
| `trace_gen_time_ms   ` |  1,455 |  2,910 |  1,471 |  1,439 |
| `stark_prove_excluding_trace_time_ms` |  4,735.50 |  9,471 |  4,771 |  4,700 |
| `main_trace_commit_time_ms` |  864.50 |  1,729 |  866 |  863 |
| `generate_perm_trace_time_ms` |  390.50 |  781 |  407 |  374 |
| `perm_trace_commit_time_ms` |  1,243.50 |  2,487 |  1,248 |  1,239 |
| `quotient_poly_compute_time_ms` |  538 |  1,076 |  544 |  532 |
| `quotient_poly_commit_time_ms` |  409.50 |  819 |  410 |  409 |
| `pcs_opening_time_ms ` |  1,284 |  2,568 |  1,291 |  1,277 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,471 | 7,033 | 2,006,537 | 538,660,330 | 4,771 | 544 | 409 | 1,248 | 1,291 | 866 | 154,227,494 | 407 | 791 | 
| leaf | 1 | 1,439 | 6,919 | 1,944,865 | 538,660,330 | 4,700 | 532 | 410 | 1,239 | 1,277 | 863 | 149,427,572 | 374 | 780 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,151 | 4,388 | 2,243,715 | 275,652,919 | 2,843 | 286 | 286 | 618 | 857 | 556 | 93,500,799 | 230 | 394 | 
| regex_program | 1 | 802 | 3,504 | 1,921,511 | 242,975,404 | 2,387 | 242 | 205 | 517 | 759 | 442 | 73,010,353 | 212 | 315 | 

...
| `total_proof_time_ms ` |  500 |  1,000 |  558 |  442 |
...
| `execute_metered_insn_mi/s` |  150.28 | -          |  150.28 |  150.28 |
| `execute_preflight_insns` |  750,104.50 |  1,500,209 |  873,000 |  627,209 |
| `execute_preflight_time_ms` |  29 |  58 |  33 |  25 |
| `execute_preflight_insn_mi/s` |  36.72 | -          |  38.72 |  34.71 |
| `trace_gen_time_ms   ` |  190 |  380 |  196 |  184 |
| `memory_finalize_time_ms` | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  188.50 |  377 |  193 |  184 |
| `main_trace_commit_time_ms` |  30 |  60 |  32 |  28 |
| `generate_perm_trace_time_ms` |  33 |  66 |  38 |  28 |
| `perm_trace_commit_time_ms` |  41.08 |  82.16 |  44.39 |  37.76 |
| `quotient_poly_compute_time_ms` |  30.99 |  61.99 |  32.23 |  29.75 |
| `quotient_poly_commit_time_ms` |  12.24 |  24.47 |  12.75 |  11.72 |
| `pcs_opening_time_ms ` |  39 |  78 |  41 |  37 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  979.50 |  1,959 |  1,223 |  736 |
...
| `execute_preflight_time_ms` |  490.50 |  981 |  786 |  195 |
| `execute_preflight_insn_mi/s` |  6.95 | -          |  7.04 |  6.86 |
| `trace_gen_time_ms   ` |  57.50 |  115 |  59 |  56 |
| `memory_finalize_time_ms` |  5 |  10 |  5 |  5 |
| `stark_prove_excluding_trace_time_ms` |  430 |  860 |  481 |  379 |
| `main_trace_commit_time_ms` |  83 |  166 |  91 |  75 |
| `generate_perm_trace_time_ms` |  36 |  72 |  46 |  26 |
| `perm_trace_commit_time_ms` |  124.65 |  249.29 |  141.02 |  108.28 |
| `quotient_poly_compute_time_ms` |  90.77 |  181.54 |  99.77 |  81.77 |
| `quotient_poly_commit_time_ms` |  21.23 |  42.46 |  22.59 |  19.88 |
| `pcs_opening_time_ms ` |  71 |  142 |  77 |  65 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program |  | 442 |  | 41 | 1 | 9 | 1,500,209 | 150.28 | 141 | 
| leaf | 1,224 |  | 1 |  | 1 |  |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 59 | 736 | 17,887,054 | 252,878,314 | 59 | 481 | 0 | 99.77 | 22.59 | 5 | 141.02 | 77 | 188 | 77 | 5 | 91 | 6,608,072 | 46 | 195 | 1,229,581 | 7.04 | 25 | 123 | 0 | 77 | 
| leaf | 1 | 56 | 1,223 | 17,250,234 | 207,789,546 | 56 | 379 | 0 | 81.77 | 19.88 | 4 | 108.28 | 65 | 135 | 65 | 5 | 75 | 6,343,052 | 26 | 786 | 1,151,214 | 6.86 | 22 | 102 | 0 | 65 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 196 | 558 | 9,677,708 | 84,395,212 | 196 | 193 | 0 | 32.23 | 12.75 | 4 | 44.39 | 41 | 73 | 41 | 0 | 32 | 1,035,986 | 28 | 25 | 873,000 | 34.71 | 14 | 45 | 0 | 41 | 
| fibonacci_program | 1 | 184 | 442 | 9,708,170 | 74,305,770 | 184 | 184 | 1 | 29.75 | 11.72 | 4 | 37.76 | 37 | 76 | 36 | 0 | 28 | 1,064,416 | 38 | 33 | 627,209 | 38.72 | 11 | 41 | 0 | 36 | 

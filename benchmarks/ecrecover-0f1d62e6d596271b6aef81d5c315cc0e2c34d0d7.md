...
| `perm_trace_commit_time_ms` |  34.26 |  34.26 |  34.26 |  34.26 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  2,816 |  2,816 |  2,816 |  2,816 |
| `main_cells_used     ` |  29,404,728 |  29,404,728 |  29,404,728 |  29,404,728 |
| `total_cells_used    ` |  71,174,330 |  71,174,330 |  71,174,330 |  71,174,330 |
| `execute_preflight_insns` |  2,934,907 |  2,934,907 |  2,934,907 |  2,934,907 |
| `execute_preflight_time_ms` |  437 |  437 |  437 |  437 |
| `execute_preflight_insn_mi/s` |  7.13 | -          |  7.13 |  7.13 |
| `trace_gen_time_ms   ` |  235 |  235 |  235 |  235 |
| `memory_finalize_time_ms` |  21 |  21 |  21 |  21 |
| `stark_prove_excluding_trace_time_ms` |  2,143 |  2,143 |  2,143 |  2,143 |
| `main_trace_commit_time_ms` |  375 |  375 |  375 |  375 |
| `generate_perm_trace_time_ms` |  184 |  184 |  184 |  184 |
| `perm_trace_commit_time_ms` |  699.26 |  699.26 |  699.26 |  699.26 |
| `quotient_poly_compute_time_ms` |  459.84 |  459.84 |  459.84 |  459.84 |
| `quotient_poly_commit_time_ms` |  105.07 |  105.07 |  105.07 |  105.07 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program |  | 763 |  | 1 | 6 | 122,859 | 19.79 | 0 | 
| leaf | 2,819 |  | 1 | 1 |  |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 235 | 2,816 | 71,174,330 | 992,054,762 | 235 | 2,143 | 0 | 459.84 | 105.07 | 4 | 699.26 | 311 | 884 | 311 | 21 | 375 | 29,404,728 | 184 | 437 | 2,934,907 | 7.13 | 135 | 571 | 9 | 311 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 212 | 763 | 11,345,240 | 31,789,298 | 212 | 321 | 0 | 105.18 | 9.17 | 8 | 34.26 | 78 | 90 | 78 | 0 | 37 | 2,263,998 | 49 | 61 | 122,859 | 2.17 | 21 | 114 | 2 | 78 | 

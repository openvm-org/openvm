...
| `total_proof_time_ms ` |  4,727 |  4,727 |  4,727 |  4,727 |
...
| `trace_gen_time_ms   ` |  870 |  870 |  870 |  870 |
...
| `quotient_poly_commit_time_ms` |  340 |  340 |  340 |  340 |
| `pcs_opening_time_ms ` |  763 |  763 |  763 |  763 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  14,063 |  14,063 |  14,063 |  14,063 |
| `main_cells_used     ` |  274,764,180 |  274,764,180 |  274,764,180 |  274,764,180 |
| `total_cycles        ` |  3,297,916 |  3,297,916 |  3,297,916 |  3,297,916 |
| `execute_time_ms     ` |  1,211 |  1,211 |  1,211 |  1,211 |
| `trace_gen_time_ms   ` |  2,538 |  2,538 |  2,538 |  2,538 |
| `stark_prove_excluding_trace_time_ms` |  10,314 |  10,314 |  10,314 |  10,314 |
| `main_trace_commit_time_ms` |  1,771 |  1,771 |  1,771 |  1,771 |
| `generate_perm_trace_time_ms` |  727 |  727 |  727 |  727 |
| `perm_trace_commit_time_ms` |  3,377 |  3,377 |  3,377 |  3,377 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 2,538 | 14,063 | 3,297,916 | 1,071,746,538 | 10,314 | 1,475 | 979 | 3,377 | 1,980 | 1,771 | 274,764,180 | 727 | 1,211 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 870 | 4,727 | 1,711,640 | 297,186,413 | 3,184 | 495 | 340 | 779 | 763 | 603 | 92,585,975 | 187 | 673 | 

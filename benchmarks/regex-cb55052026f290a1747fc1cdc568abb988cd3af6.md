...
| `total_proof_time_ms ` |  3,862 |  7,724 |  4,454 |  3,270 |
...
| `trace_gen_time_ms   ` |  979.50 |  1,959 |  1,153 |  806 |
| `stark_prove_excluding_trace_time_ms` |  2,547 |  5,094 |  2,928 |  2,166 |
| `main_trace_commit_time_ms` |  444 |  888 |  521 |  367 |
| `generate_perm_trace_time_ms` |  163 |  326 |  191 |  135 |
| `perm_trace_commit_time_ms` |  639 |  1,278 |  748 |  530 |
| `quotient_poly_compute_time_ms` |  365.50 |  731 |  421 |  310 |
| `quotient_poly_commit_time_ms` |  272 |  544 |  320 |  224 |
| `pcs_opening_time_ms ` |  654.50 |  1,309 |  718 |  591 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,458 |  14,916 |  7,524 |  7,392 |
| `main_cells_used     ` |  152,233,532 |  304,467,064 |  154,691,276 |  149,775,788 |
| `total_cycles        ` |  1,990,776.50 |  3,981,553 |  2,021,588 |  1,959,965 |
| `execute_time_ms     ` |  756 |  1,512 |  764 |  748 |
| `trace_gen_time_ms   ` |  1,497.50 |  2,995 |  1,523 |  1,472 |
| `stark_prove_excluding_trace_time_ms` |  5,204.50 |  10,409 |  5,237 |  5,172 |
| `main_trace_commit_time_ms` |  893.50 |  1,787 |  895 |  892 |
| `generate_perm_trace_time_ms` |  341 |  682 |  342 |  340 |
| `perm_trace_commit_time_ms` |  1,638 |  3,276 |  1,669 |  1,607 |
| `quotient_poly_compute_time_ms` |  759.50 |  1,519 |  762 |  757 |
| `quotient_poly_commit_time_ms` |  517.50 |  1,035 |  518 |  517 |
| `pcs_opening_time_ms ` |  1,050 |  2,100 |  1,052 |  1,048 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,523 | 7,524 | 2,021,588 | 533,941,738 | 5,237 | 757 | 517 | 1,669 | 1,052 | 895 | 154,691,276 | 342 | 764 | 
| leaf | 1 | 1,472 | 7,392 | 1,959,965 | 533,941,738 | 5,172 | 762 | 518 | 1,607 | 1,048 | 892 | 149,775,788 | 340 | 748 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,153 | 4,454 | 2,225,434 | 275,652,919 | 2,928 | 421 | 320 | 748 | 718 | 521 | 93,699,990 | 191 | 373 | 
| regex_program | 1 | 806 | 3,270 | 1,914,730 | 198,099,628 | 2,166 | 310 | 224 | 530 | 591 | 367 | 73,689,460 | 135 | 298 | 

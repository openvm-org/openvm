...
| `total_proof_time_ms ` |  595.50 |  2,382 |  715 |  524 |
...
| `execute_preflight_time_ms` |  56.25 |  225 |  67 |  46 |
| `execute_preflight_insn_mi/s` |  30.48 | -          |  33.05 |  27.14 |
| `trace_gen_time_ms   ` |  175.25 |  701 |  210 |  154 |
| `memory_finalize_time_ms` |  1 |  4 |  4 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  296 |  1,184 |  326 |  262 |
| `main_trace_commit_time_ms` |  51.75 |  207 |  57 |  49 |
| `generate_perm_trace_time_ms` |  36 |  144 |  48 |  19 |
| `perm_trace_commit_time_ms` |  64.79 |  259.15 |  70.65 |  54.60 |
| `quotient_poly_compute_time_ms` |  58.58 |  234.33 |  71.22 |  52.52 |
| `quotient_poly_commit_time_ms` |  15.13 |  60.53 |  16.66 |  12.71 |
| `pcs_opening_time_ms ` |  66.50 |  266 |  92 |  54 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,412 |  5,648 |  2,056 |  893 |
...
| `execute_preflight_insns` |  1,440,887.75 |  5,763,551 |  1,814,634 |  1,241,413 |
| `execute_preflight_time_ms` |  650.50 |  2,602 |  839 |  225 |
| `execute_preflight_insn_mi/s` |  7.12 | -          |  7.52 |  6.75 |
| `trace_gen_time_ms   ` |  86.50 |  346 |  162 |  58 |
| `memory_finalize_time_ms` |  8.50 |  34 |  16 |  5 |
| `stark_prove_excluding_trace_time_ms` |  673.75 |  2,695 |  1,070 |  482 |
| `main_trace_commit_time_ms` |  124.50 |  498 |  194 |  91 |
| `generate_perm_trace_time_ms` |  50 |  200 |  84 |  38 |
| `perm_trace_commit_time_ms` |  199.37 |  797.49 |  341.85 |  142.43 |
| `quotient_poly_compute_time_ms` |  140.59 |  562.36 |  230.80 |  99.53 |
| `quotient_poly_commit_time_ms` |  30.70 |  122.81 |  51.86 |  22.02 |
| `pcs_opening_time_ms ` |  125 |  500 |  162 |  85 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 2,058 |  | 1 | 1 |  |  |  |  | 
| regex_program |  | 597 |  | 1 | 37 | 4,137,502 | 111.27 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 68 | 893 | 22,981,570 | 319,331,818 | 68 | 599 | 0 | 132.19 | 26.26 | 4 | 170.58 | 107 | 209 | 107 | 6 | 122 | 9,122,488 | 38 | 225 | 1,466,074 | 7.52 | 30 | 159 | 0 | 107 | 
| leaf | 1 | 58 | 1,442 | 20,905,034 | 255,237,610 | 58 | 544 | 0 | 99.53 | 22.68 | 4 | 142.43 | 146 | 183 | 146 | 5 | 91 | 8,256,948 | 39 | 839 | 1,241,430 | 7.06 | 25 | 123 | 0 | 146 | 
| leaf | 2 | 58 | 1,257 | 20,905,034 | 255,237,610 | 58 | 482 | 0 | 99.84 | 22.02 | 4 | 142.63 | 85 | 182 | 84 | 7 | 91 | 8,256,948 | 39 | 715 | 1,241,413 | 7.14 | 25 | 122 | 0 | 84 | 
| leaf | 3 | 162 | 2,056 | 50,337,320 | 538,365,418 | 162 | 1,070 | 0 | 230.80 | 51.86 | 4 | 341.85 | 162 | 427 | 162 | 16 | 194 | 20,171,106 | 84 | 823 | 1,814,634 | 6.75 | 61 | 286 | 5 | 162 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 210 | 715 | 23,446,148 | 150,778,428 | 210 | 313 | 0 | 57.90 | 16.66 | 5 | 70.65 | 60 | 120 | 60 | 4 | 57 | 10,899,170 | 48 | 46 | 1,103,000 | 28.81 | 21 | 75 | 1 | 60 | 
| regex_program | 1 | 154 | 524 | 11,598,276 | 128,513,066 | 154 | 262 | 1 | 52.68 | 15.60 | 4 | 68.17 | 54 | 88 | 54 | 0 | 50 | 2,196,106 | 19 | 66 | 1,104,000 | 33.05 | 16 | 68 | 0 | 54 | 
| regex_program | 2 | 154 | 546 | 11,579,064 | 128,513,066 | 154 | 283 | 1 | 52.52 | 15.55 | 4 | 65.73 | 60 | 103 | 60 | 0 | 51 | 2,177,334 | 36 | 67 | 1,104,000 | 27.14 | 16 | 68 | 0 | 60 | 
| regex_program | 3 | 183 | 597 | 11,853,872 | 103,456,394 | 183 | 326 | 0 | 71.22 | 12.71 | 5 | 54.60 | 92 | 98 | 92 | 0 | 49 | 2,422,606 | 41 | 46 | 826,502 | 32.91 | 18 | 84 | 1 | 92 | 

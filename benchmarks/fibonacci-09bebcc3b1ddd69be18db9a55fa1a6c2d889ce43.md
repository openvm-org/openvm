...
| `stark_prove_excluding_trace_time_ms` |  4,940 |  4,940 |  4,940 |  4,940 |
| `main_trace_commit_time_ms` |  812 |  812 |  812 |  812 |
| `generate_perm_trace_time_ms` |  177 |  177 |  177 |  177 |
| `perm_trace_commit_time_ms` |  1,620 |  1,620 |  1,620 |  1,620 |
| `quotient_poly_compute_time_ms` |  775 |  775 |  775 |  775 |
| `quotient_poly_commit_time_ms` |  527 |  527 |  527 |  527 |
| `pcs_opening_time_ms ` |  1,025 |  1,025 |  1,025 |  1,025 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,790 |  7,790 |  7,790 |  7,790 |
| `main_cells_used     ` |  68,756,739 |  68,756,739 |  68,756,739 |  68,756,739 |
| `total_cycles        ` |  1,781,396 |  1,781,396 |  1,781,396 |  1,781,396 |
| `execute_time_ms     ` |  334 |  334 |  334 |  334 |
| `trace_gen_time_ms   ` |  1,222 |  1,222 |  1,222 |  1,222 |
| `stark_prove_excluding_trace_time_ms` |  6,234 |  6,234 |  6,234 |  6,234 |
| `main_trace_commit_time_ms` |  1,101 |  1,101 |  1,101 |  1,101 |
| `generate_perm_trace_time_ms` |  132 |  132 |  132 |  132 |
| `perm_trace_commit_time_ms` |  1,209 |  1,209 |  1,209 |  1,209 |
| `quotient_poly_compute_time_ms` |  1,465 |  1,465 |  1,465 |  1,465 |
| `quotient_poly_commit_time_ms` |  1,037 |  1,037 |  1,037 |  1,037 |
| `pcs_opening_time_ms ` |  1,288 |  1,288 |  1,288 |  1,288 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,222 | 7,790 | 1,781,396 | 180,014,040 | 6,234 | 1,465 | 1,037 | 1,209 | 1,288 | 1,101 | 68,756,739 | 132 | 334 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 814 | 6,066 | 1,500,092 | 197,435,660 | 4,940 | 775 | 527 | 1,620 | 1,025 | 812 | 51,484,605 | 177 | 312 | 

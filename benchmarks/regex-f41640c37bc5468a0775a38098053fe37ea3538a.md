...
| `total_proof_time_ms ` |  4,161 |  8,322 |  4,646 |  3,676 |
...
| `trace_gen_time_ms   ` |  941 |  1,882 |  1,128 |  754 |
| `stark_prove_excluding_trace_time_ms` |  2,882 |  5,764 |  3,143 |  2,621 |
| `main_trace_commit_time_ms` |  520 |  1,040 |  586 |  454 |
| `generate_perm_trace_time_ms` |  198.50 |  397 |  207 |  190 |
| `perm_trace_commit_time_ms` |  750 |  1,500 |  803 |  697 |
| `quotient_poly_compute_time_ms` |  400 |  800 |  429 |  371 |
| `quotient_poly_commit_time_ms` |  296.50 |  593 |  338 |  255 |
| `pcs_opening_time_ms ` |  708.50 |  1,417 |  771 |  646 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,536 |  15,072 |  7,576 |  7,496 |
| `main_cells_used     ` |  152,278,015 |  304,556,030 |  154,677,574 |  149,878,456 |
| `total_cycles        ` |  1,991,012.50 |  3,982,025 |  2,021,815 |  1,960,210 |
| `execute_time_ms     ` |  761 |  1,522 |  770 |  752 |
| `trace_gen_time_ms   ` |  1,454 |  2,908 |  1,466 |  1,442 |
| `stark_prove_excluding_trace_time_ms` |  5,321 |  10,642 |  5,364 |  5,278 |
| `main_trace_commit_time_ms` |  892 |  1,784 |  893 |  891 |
| `generate_perm_trace_time_ms` |  375.50 |  751 |  385 |  366 |
| `perm_trace_commit_time_ms` |  1,675.50 |  3,351 |  1,705 |  1,646 |
| `quotient_poly_compute_time_ms` |  766.50 |  1,533 |  769 |  764 |
| `quotient_poly_commit_time_ms` |  522.50 |  1,045 |  524 |  521 |
| `pcs_opening_time_ms ` |  1,083 |  2,166 |  1,086 |  1,080 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,442 | 7,576 | 2,021,815 | 538,660,330 | 5,364 | 769 | 521 | 1,705 | 1,086 | 891 | 154,677,574 | 385 | 770 | 
| leaf | 1 | 1,466 | 7,496 | 1,960,210 | 538,660,330 | 5,278 | 764 | 524 | 1,646 | 1,080 | 893 | 149,878,456 | 366 | 752 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,128 | 4,646 | 2,243,715 | 275,652,919 | 3,143 | 429 | 338 | 803 | 771 | 586 | 94,156,159 | 207 | 375 | 
| regex_program | 1 | 754 | 3,676 | 1,921,511 | 242,975,404 | 2,621 | 371 | 255 | 697 | 646 | 454 | 73,665,713 | 190 | 301 | 

...
| `total_proof_time_ms ` |  492.50 |  985 |  559 |  426 |
...
| `perm_trace_commit_time_ms` |  42.04 |  84.09 |  45.72 |  38.36 |
| `quotient_poly_compute_time_ms` |  32.95 |  65.91 |  35.07 |  30.83 |
| `quotient_poly_commit_time_ms` |  12.31 |  24.62 |  12.64 |  11.98 |
| `pcs_opening_time_ms ` |  43 |  86 |  45 |  41 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,033 |  2,066 |  1,313 |  753 |
...
| `execute_preflight_time_ms` |  519.50 |  1,039 |  835 |  204 |
| `execute_preflight_insn_mi/s` |  6.62 | -          |  6.74 |  6.50 |
| `trace_gen_time_ms   ` |  58 |  116 |  61 |  55 |
| `memory_finalize_time_ms` |  5.50 |  11 |  6 |  5 |
| `stark_prove_excluding_trace_time_ms` |  454 |  908 |  487 |  421 |
| `main_trace_commit_time_ms` |  84.50 |  169 |  92 |  77 |
| `generate_perm_trace_time_ms` |  39 |  78 |  39 |  39 |
| `perm_trace_commit_time_ms` |  125.31 |  250.62 |  143.04 |  107.57 |
| `quotient_poly_compute_time_ms` |  93.47 |  186.94 |  101.60 |  85.34 |
| `quotient_poly_commit_time_ms` |  22.14 |  44.28 |  23.63 |  20.65 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program |  | 426 |  | 1 | 10 | 1,500,209 | 142.67 | 0 | 
| leaf | 1,314 |  | 1 | 1 |  |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 61 | 753 | 17,887,054 | 252,878,314 | 61 | 487 | 0 | 101.60 | 23.63 | 4 | 143.04 | 84 | 183 | 84 | 6 | 92 | 6,608,072 | 39 | 204 | 1,229,730 | 6.74 | 26 | 126 | 0 | 84 | 
| leaf | 1 | 55 | 1,313 | 17,250,234 | 207,789,546 | 55 | 421 | 0 | 85.34 | 20.65 | 4 | 107.57 | 89 | 147 | 89 | 5 | 77 | 6,343,052 | 39 | 835 | 1,151,166 | 6.50 | 22 | 106 | 0 | 89 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 197 | 559 | 9,677,708 | 84,395,212 | 197 | 191 | 0 | 35.07 | 12.64 | 4 | 45.72 | 45 | 64 | 45 | 0 | 33 | 1,035,986 | 18 | 26 | 873,000 | 34.74 | 14 | 48 | 0 | 45 | 
| fibonacci_program | 1 | 187 | 426 | 9,708,170 | 74,305,770 | 187 | 164 | 1 | 30.83 | 11.98 | 4 | 38.36 | 41 | 50 | 41 | 0 | 28 | 1,064,416 | 12 | 33 | 627,209 | 38.01 | 11 | 43 | 0 | 41 | 

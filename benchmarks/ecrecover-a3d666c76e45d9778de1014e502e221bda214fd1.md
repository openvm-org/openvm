...
| `total_proof_time_ms ` |  2,558 |  2,558 |  2,558 |  2,558 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  18,501 |  18,501 |  18,501 |  18,501 |
...
| `trace_gen_time_ms   ` |  3,554 |  3,554 |  3,554 |  3,554 |
| `stark_prove_excluding_trace_time_ms` |  13,970 |  13,970 |  13,970 |  13,970 |
| `main_trace_commit_time_ms` |  2,941 |  2,941 |  2,941 |  2,941 |
| `generate_perm_trace_time_ms` |  358 |  358 |  358 |  358 |
| `perm_trace_commit_time_ms` |  2,964 |  2,964 |  2,964 |  2,964 |
| `quotient_poly_compute_time_ms` |  2,092 |  2,092 |  2,092 |  2,092 |
| `quotient_poly_commit_time_ms` |  2,669 |  2,669 |  2,669 |  2,669 |
| `pcs_opening_time_ms ` |  2,941 |  2,941 |  2,941 |  2,941 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 3,554 | 18,501 | 4,155,768 | 466,306,008 | 13,970 | 2,092 | 2,669 | 2,964 | 2,941 | 2,941 | 193,204,866 | 358 | 977 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 258 | 2,558 | 285,401 | 38,415,035 | 2,151 | 226 | 474 | 357 | 657 | 391 | 15,075,033 | 33 | 149 | 

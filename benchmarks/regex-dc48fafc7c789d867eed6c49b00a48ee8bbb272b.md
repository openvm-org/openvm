...
| `total_proof_time_ms ` |  4,076 |  8,152 |  4,539 |  3,613 |
...
| `trace_gen_time_ms   ` |  998 |  1,996 |  1,192 |  804 |
| `stark_prove_excluding_trace_time_ms` |  2,739.50 |  5,479 |  2,971 |  2,508 |
| `main_trace_commit_time_ms` |  468.50 |  937 |  528 |  409 |
| `generate_perm_trace_time_ms` |  192.50 |  385 |  201 |  184 |
| `perm_trace_commit_time_ms` |  689.50 |  1,379 |  739 |  640 |
| `quotient_poly_compute_time_ms` |  393.50 |  787 |  424 |  363 |
| `quotient_poly_commit_time_ms` |  274 |  548 |  309 |  239 |
| `pcs_opening_time_ms ` |  712 |  1,424 |  761 |  663 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,315.50 |  14,631 |  7,427 |  7,204 |
| `main_cells_used     ` |  152,278,033 |  304,556,066 |  154,677,634 |  149,878,432 |
| `total_cycles        ` |  1,991,014 |  3,982,028 |  2,021,820 |  1,960,208 |
| `execute_time_ms     ` |  784 |  1,568 |  791 |  777 |
| `trace_gen_time_ms   ` |  1,490 |  2,980 |  1,526 |  1,454 |
| `stark_prove_excluding_trace_time_ms` |  5,041.50 |  10,083 |  5,110 |  4,973 |
| `main_trace_commit_time_ms` |  808 |  1,616 |  809 |  807 |
| `generate_perm_trace_time_ms` |  376.50 |  753 |  393 |  360 |
| `perm_trace_commit_time_ms` |  1,538.50 |  3,077 |  1,586 |  1,491 |
| `quotient_poly_compute_time_ms` |  771.50 |  1,543 |  772 |  771 |
| `quotient_poly_commit_time_ms` |  488.50 |  977 |  490 |  487 |
| `pcs_opening_time_ms ` |  1,052.50 |  2,105 |  1,059 |  1,046 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,526 | 7,427 | 2,021,820 | 538,660,330 | 5,110 | 771 | 487 | 1,586 | 1,059 | 809 | 154,677,634 | 393 | 791 | 
| leaf | 1 | 1,454 | 7,204 | 1,960,208 | 538,660,330 | 4,973 | 772 | 490 | 1,491 | 1,046 | 807 | 149,878,432 | 360 | 777 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,192 | 4,539 | 2,243,715 | 275,652,919 | 2,971 | 424 | 309 | 739 | 761 | 528 | 93,500,799 | 201 | 376 | 
| regex_program | 1 | 804 | 3,613 | 1,921,511 | 242,975,404 | 2,508 | 363 | 239 | 640 | 663 | 409 | 73,010,353 | 184 | 301 | 

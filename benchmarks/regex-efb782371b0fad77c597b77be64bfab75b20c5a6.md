...
| `total_proof_time_ms ` |  3,932 |  7,864 |  4,512 |  3,352 |
| `main_cells_used     ` |  83,723,935.50 |  167,447,871 |  93,738,635 |  73,709,236 |
| `total_cycles        ` |  2,070,213.50 |  4,140,427 |  2,225,434 |  1,914,993 |
| `execute_time_ms     ` |  338.50 |  677 |  375 |  302 |
| `trace_gen_time_ms   ` |  987 |  1,974 |  1,154 |  820 |
| `stark_prove_excluding_trace_time_ms` |  2,606.50 |  5,213 |  2,983 |  2,230 |
| `main_trace_commit_time_ms` |  455 |  910 |  538 |  372 |
| `generate_perm_trace_time_ms` |  165 |  330 |  187 |  143 |
| `perm_trace_commit_time_ms` |  652 |  1,304 |  754 |  550 |
| `quotient_poly_compute_time_ms` |  363 |  726 |  426 |  300 |
| `quotient_poly_commit_time_ms` |  281 |  562 |  325 |  237 |
| `pcs_opening_time_ms ` |  680 |  1,360 |  744 |  616 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,542 |  15,084 |  7,632 |  7,452 |
| `main_cells_used     ` |  152,703,187.50 |  305,406,375 |  155,162,354 |  150,244,021 |
| `total_cycles        ` |  1,990,883.50 |  3,981,767 |  2,021,687 |  1,960,080 |
| `execute_time_ms     ` |  797.50 |  1,595 |  807 |  788 |
| `trace_gen_time_ms   ` |  1,451.50 |  2,903 |  1,489 |  1,414 |
| `stark_prove_excluding_trace_time_ms` |  5,293 |  10,586 |  5,336 |  5,250 |
| `main_trace_commit_time_ms` |  895 |  1,790 |  897 |  893 |
| `generate_perm_trace_time_ms` |  352.50 |  705 |  353 |  352 |
| `perm_trace_commit_time_ms` |  1,679.50 |  3,359 |  1,720 |  1,639 |
| `quotient_poly_compute_time_ms` |  760 |  1,520 |  761 |  759 |
| `quotient_poly_commit_time_ms` |  527.50 |  1,055 |  529 |  526 |
| `pcs_opening_time_ms ` |  1,073.50 |  2,147 |  1,075 |  1,072 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,489 | 7,632 | 2,021,687 | 538,660,330 | 5,336 | 759 | 529 | 1,720 | 1,075 | 897 | 155,162,354 | 352 | 807 | 
| leaf | 1 | 1,414 | 7,452 | 1,960,080 | 538,660,330 | 5,250 | 761 | 526 | 1,639 | 1,072 | 893 | 150,244,021 | 353 | 788 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,154 | 4,512 | 2,225,434 | 275,652,919 | 2,983 | 426 | 325 | 754 | 744 | 538 | 93,738,635 | 187 | 375 | 
| regex_program | 1 | 820 | 3,352 | 1,914,993 | 198,099,628 | 2,230 | 300 | 237 | 550 | 616 | 372 | 73,709,236 | 143 | 302 | 

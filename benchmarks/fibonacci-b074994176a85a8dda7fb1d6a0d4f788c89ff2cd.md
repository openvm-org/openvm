...
| `total_proof_time_ms ` |  5,161 |  5,161 |  5,161 |  5,161 |
...
| `stark_prove_excluding_trace_time_ms` |  4,030 |  4,030 |  4,030 |  4,030 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,212 |  7,212 |  7,212 |  7,212 |
| `main_cells_used     ` |  74,253,044 |  74,253,044 |  74,253,044 |  74,253,044 |
| `total_cycles        ` |  1,976,132 |  1,976,132 |  1,976,132 |  1,976,132 |
| `execute_time_ms     ` |  423 |  423 |  423 |  423 |
| `trace_gen_time_ms   ` |  1,307 |  1,307 |  1,307 |  1,307 |
| `stark_prove_excluding_trace_time_ms` |  5,482 |  5,482 |  5,482 |  5,482 |
| `main_trace_commit_time_ms` |  1,125 |  1,125 |  1,125 |  1,125 |
| `generate_perm_trace_time_ms` |  134 |  134 |  134 |  134 |
| `perm_trace_commit_time_ms` |  1,015 |  1,015 |  1,015 |  1,015 |
| `quotient_poly_compute_time_ms` |  771 |  771 |  771 |  771 |
| `quotient_poly_commit_time_ms` |  1,111 |  1,111 |  1,111 |  1,111 |
| `pcs_opening_time_ms ` |  1,322 |  1,322 |  1,322 |  1,322 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,307 | 7,212 | 1,976,132 | 160,482,264 | 5,482 | 771 | 1,111 | 1,015 | 1,322 | 1,125 | 74,253,044 | 134 | 423 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 820 | 5,161 | 1,500,137 | 122,462,014 | 4,030 | 509 | 729 | 784 | 1,072 | 799 | 51,487,838 | 133 | 311 | 

...
| `total_proof_time_ms ` |  3,894.50 |  7,789 |  4,499 |  3,290 |
...
| `trace_gen_time_ms   ` |  964.50 |  1,929 |  1,138 |  791 |
| `stark_prove_excluding_trace_time_ms` |  2,593 |  5,186 |  2,987 |  2,199 |
| `main_trace_commit_time_ms` |  455.50 |  911 |  540 |  371 |
| `generate_perm_trace_time_ms` |  160 |  320 |  182 |  138 |
| `perm_trace_commit_time_ms` |  643.50 |  1,287 |  746 |  541 |
| `quotient_poly_compute_time_ms` |  362.50 |  725 |  420 |  305 |
| `quotient_poly_commit_time_ms` |  275 |  550 |  325 |  225 |
| `pcs_opening_time_ms ` |  687 |  1,374 |  765 |  609 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,561 |  15,122 |  7,651 |  7,471 |
| `main_cells_used     ` |  152,701,837.50 |  305,403,675 |  155,161,310 |  150,242,365 |
| `total_cycles        ` |  1,990,771 |  3,981,542 |  2,021,600 |  1,959,942 |
| `execute_time_ms     ` |  769 |  1,538 |  776 |  762 |
| `trace_gen_time_ms   ` |  1,499.50 |  2,999 |  1,541 |  1,458 |
| `stark_prove_excluding_trace_time_ms` |  5,292.50 |  10,585 |  5,334 |  5,251 |
| `main_trace_commit_time_ms` |  893.50 |  1,787 |  895 |  892 |
| `generate_perm_trace_time_ms` |  358.50 |  717 |  373 |  344 |
| `perm_trace_commit_time_ms` |  1,672.50 |  3,345 |  1,702 |  1,643 |
| `quotient_poly_compute_time_ms` |  762 |  1,524 |  764 |  760 |
| `quotient_poly_commit_time_ms` |  522.50 |  1,045 |  523 |  522 |
| `pcs_opening_time_ms ` |  1,079 |  2,158 |  1,086 |  1,072 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,541 | 7,651 | 2,021,600 | 538,660,330 | 5,334 | 764 | 523 | 1,702 | 1,072 | 895 | 155,161,310 | 373 | 776 | 
| leaf | 1 | 1,458 | 7,471 | 1,959,942 | 538,660,330 | 5,251 | 760 | 522 | 1,643 | 1,086 | 892 | 150,242,365 | 344 | 762 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,138 | 4,499 | 2,225,434 | 275,652,919 | 2,987 | 420 | 325 | 746 | 765 | 540 | 93,727,369 | 182 | 374 | 
| regex_program | 1 | 791 | 3,290 | 1,914,797 | 198,099,628 | 2,199 | 305 | 225 | 541 | 609 | 371 | 73,687,582 | 138 | 300 | 

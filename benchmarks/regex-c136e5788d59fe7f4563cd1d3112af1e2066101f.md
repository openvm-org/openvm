...
| `total_proof_time_ms ` |  3,901 |  7,802 |  4,466 |  3,336 |
...
| `trace_gen_time_ms   ` |  966.50 |  1,933 |  1,135 |  798 |
| `stark_prove_excluding_trace_time_ms` |  2,597.50 |  5,195 |  2,956 |  2,239 |
| `main_trace_commit_time_ms` |  446 |  892 |  524 |  368 |
| `generate_perm_trace_time_ms` |  168.50 |  337 |  201 |  136 |
| `perm_trace_commit_time_ms` |  648 |  1,296 |  753 |  543 |
| `quotient_poly_compute_time_ms` |  363 |  726 |  421 |  305 |
| `quotient_poly_commit_time_ms` |  273.50 |  547 |  321 |  226 |
| `pcs_opening_time_ms ` |  688 |  1,376 |  726 |  650 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,497.50 |  14,995 |  7,517 |  7,478 |
| `main_cells_used     ` |  152,233,595 |  304,467,190 |  154,691,027 |  149,776,163 |
| `total_cycles        ` |  1,990,751.50 |  3,981,503 |  2,021,537 |  1,959,966 |
| `execute_time_ms     ` |  762 |  1,524 |  770 |  754 |
| `trace_gen_time_ms   ` |  1,460.50 |  2,921 |  1,475 |  1,446 |
| `stark_prove_excluding_trace_time_ms` |  5,275 |  10,550 |  5,278 |  5,272 |
| `main_trace_commit_time_ms` |  892 |  1,784 |  893 |  891 |
| `generate_perm_trace_time_ms` |  341.50 |  683 |  345 |  338 |
| `perm_trace_commit_time_ms` |  1,671.50 |  3,343 |  1,685 |  1,658 |
| `quotient_poly_compute_time_ms` |  758.50 |  1,517 |  761 |  756 |
| `quotient_poly_commit_time_ms` |  523 |  1,046 |  524 |  522 |
| `pcs_opening_time_ms ` |  1,083.50 |  2,167 |  1,101 |  1,066 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,475 | 7,517 | 2,021,537 | 533,941,738 | 5,272 | 756 | 522 | 1,685 | 1,066 | 893 | 154,691,027 | 345 | 770 | 
| leaf | 1 | 1,446 | 7,478 | 1,959,966 | 533,941,738 | 5,278 | 761 | 524 | 1,658 | 1,101 | 891 | 149,776,163 | 338 | 754 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,135 | 4,466 | 2,225,434 | 275,652,919 | 2,956 | 421 | 321 | 753 | 726 | 524 | 93,727,369 | 201 | 375 | 
| regex_program | 1 | 798 | 3,336 | 1,914,797 | 198,099,628 | 2,239 | 305 | 226 | 543 | 650 | 368 | 73,687,582 | 136 | 299 | 

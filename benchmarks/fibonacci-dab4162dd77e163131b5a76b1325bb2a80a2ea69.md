...
| `main_cells_used     ` |  70,354,211 |  70,354,211 |  70,354,211 |  70,354,211 |
| `total_cycles        ` |  1,265,692 |  1,265,692 |  1,265,692 |  1,265,692 |
| `execute_time_ms     ` |  523 |  523 |  523 |  523 |
| `trace_gen_time_ms   ` |  674 |  674 |  674 |  674 |
| `stark_prove_excluding_trace_time_ms` |  2,590 |  2,590 |  2,590 |  2,590 |
| `main_trace_commit_time_ms` |  437 |  437 |  437 |  437 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 674 | 3,787 | 1,265,692 | 252,059,114 | 2,590 | 374 | 282 | 735 | 602 | 437 | 70,354,211 | 156 | 523 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 554 | 2,752 | 1,500,096 | 160,733,916 | 1,964 | 250 | 232 | 507 | 506 | 357 | 51,485,167 | 110 | 234 | 

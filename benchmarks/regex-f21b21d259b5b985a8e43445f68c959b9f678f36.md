...
| `total_proof_time_ms ` |  737 |  2,948 |  877 |  677 |
...
| `execute_preflight_insn_mi/s` |  30.51 | -          |  32.02 |  28.28 |
| `trace_gen_time_ms   ` |  202.25 |  809 |  238 |  179 |
| `memory_finalize_time_ms` |  1 |  4 |  4 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  412 |  1,648 |  443 |  384 |
| `main_trace_commit_time_ms` |  56.75 |  227 |  62 |  54 |
| `generate_perm_trace_time_ms` |  29.25 |  117 |  36 |  21 |
| `perm_trace_commit_time_ms` |  71.06 |  284.24 |  77.62 |  59.20 |
| `quotient_poly_compute_time_ms` |  56.93 |  227.70 |  67.81 |  50.27 |
| `quotient_poly_commit_time_ms` |  18.08 |  72.32 |  21.07 |  15.25 |
| `pcs_opening_time_ms ` |  176 |  704 |  187 |  157 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,750.75 |  7,003 |  2,670 |  1,232 |
...
| `execute_preflight_insns` |  1,440,903.25 |  5,763,613 |  1,814,601 |  1,241,436 |
| `execute_preflight_time_ms` |  609.25 |  2,437 |  800 |  227 |
| `execute_preflight_insn_mi/s` |  7.05 | -          |  7.33 |  6.80 |
| `trace_gen_time_ms   ` |  88 |  352 |  164 |  57 |
| `memory_finalize_time_ms` |  8.50 |  34 |  16 |  6 |
| `stark_prove_excluding_trace_time_ms` |  1,052 |  4,208 |  1,747 |  746 |
| `main_trace_commit_time_ms` |  136.25 |  545 |  210 |  101 |
| `generate_perm_trace_time_ms` |  52.75 |  211 |  74 |  41 |
| `perm_trace_commit_time_ms` |  214.21 |  856.86 |  363.20 |  153.87 |
| `quotient_poly_compute_time_ms` |  137.76 |  551.04 |  228.82 |  96.21 |
| `quotient_poly_commit_time_ms` |  36.58 |  146.30 |  59.82 |  27.78 |
| `pcs_opening_time_ms ` |  470.50 |  1,882 |  805 |  322 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 2,672 |  | 1 |  | 1 |  |  |  |  | 
| regex_program |  | 677 |  | 41 | 1 | 33 | 4,108,483 | 124.16 | 168 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 70 | 1,232 | 22,981,570 | 319,331,818 | 70 | 933 | 0 | 129.69 | 30.24 | 4 | 184.93 | 411 | 227 | 411 | 6 | 133 | 9,122,488 | 41 | 227 | 1,466,110 | 7.33 | 29 | 161 | 1 | 411 | 
| leaf | 1 | 57 | 1,641 | 20,905,034 | 255,237,610 | 57 | 782 | 0 | 96.32 | 28.45 | 4 | 154.86 | 344 | 210 | 344 | 6 | 101 | 8,256,948 | 54 | 800 | 1,241,466 | 6.97 | 25 | 125 | 1 | 344 | 
| leaf | 2 | 61 | 1,460 | 20,905,034 | 255,237,610 | 61 | 746 | 0 | 96.21 | 27.78 | 4 | 153.87 | 322 | 197 | 322 | 6 | 101 | 8,256,948 | 42 | 652 | 1,241,436 | 7.11 | 25 | 124 | 1 | 322 | 
| leaf | 3 | 164 | 2,670 | 50,337,320 | 538,365,418 | 164 | 1,747 | 0 | 228.82 | 59.82 | 4 | 363.20 | 805 | 438 | 805 | 16 | 210 | 20,171,106 | 74 | 758 | 1,814,601 | 6.80 | 59 | 292 | 6 | 805 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 238 | 877 | 23,395,260 | 150,778,428 | 238 | 443 | 0 | 57.28 | 21.07 | 5 | 77.62 | 187 | 114 | 187 | 4 | 62 | 10,864,634 | 35 | 46 | 1,102,000 | 28.28 | 20 | 79 | 2 | 187 | 
| regex_program | 1 | 179 | 705 | 11,589,074 | 132,682,794 | 179 | 418 | 1 | 50.27 | 17.81 | 4 | 72.95 | 181 | 110 | 181 | 0 | 56 | 2,191,608 | 36 | 66 | 1,108,000 | 31.05 | 16 | 68 | 1 | 181 | 
| regex_program | 2 | 186 | 689 | 11,583,256 | 132,682,794 | 186 | 403 | 1 | 52.34 | 18.19 | 4 | 74.47 | 179 | 95 | 179 | 0 | 55 | 2,185,918 | 21 | 58 | 1,108,000 | 32.02 | 15 | 71 | 1 | 179 | 
| regex_program | 3 | 206 | 677 | 11,847,840 | 103,522,954 | 206 | 384 | 0 | 67.81 | 15.25 | 5 | 59.20 | 157 | 87 | 157 | 0 | 54 | 2,420,726 | 25 | 45 | 790,483 | 30.68 | 17 | 84 | 2 | 157 | 

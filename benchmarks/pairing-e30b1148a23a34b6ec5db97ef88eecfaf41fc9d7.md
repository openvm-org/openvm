...
| `total_proof_time_ms ` |  727.50 |  1,455 |  852 |  603 |
...
| `execute_metered_insn_mi/s` |  27.34 | -          |  27.34 |  27.34 |
| `execute_preflight_insns` |  872,871 |  1,745,742 |  1,149,000 |  596,742 |
| `execute_preflight_time_ms` |  82.50 |  165 |  104 |  61 |
| `execute_preflight_insn_mi/s` |  14.88 | -          |  18.37 |  11.38 |
| `trace_gen_time_ms   ` |  191 |  382 |  195 |  187 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  348.50 |  697 |  392 |  305 |
| `main_trace_commit_time_ms` |  63.50 |  127 |  75 |  52 |
| `generate_perm_trace_time_ms` |  39.50 |  79 |  41 |  38 |
| `perm_trace_commit_time_ms` |  77.71 |  155.41 |  90.49 |  64.92 |
| `quotient_poly_compute_time_ms` |  83.97 |  167.94 |  93.09 |  74.85 |
| `quotient_poly_commit_time_ms` |  17.73 |  35.46 |  19.100 |  15.46 |
| `pcs_opening_time_ms ` |  60.50 |  121 |  67 |  54 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,496 |  2,992 |  1,778 |  1,214 |
| `main_cells_used     ` |  16,200,472 |  32,400,944 |  16,332,746 |  16,068,198 |
| `total_cells_used    ` |  39,332,920 |  78,665,840 |  39,650,868 |  39,014,972 |
| `execute_preflight_insns` |  1,952,457.50 |  3,904,915 |  1,991,915 |  1,913,000 |
| `execute_preflight_time_ms` |  605.50 |  1,211 |  907 |  304 |
| `execute_preflight_insn_mi/s` |  7.49 | -          |  7.53 |  7.46 |
| `trace_gen_time_ms   ` |  120 |  240 |  127 |  113 |
| `memory_finalize_time_ms` |  13 |  26 |  14 |  12 |
| `stark_prove_excluding_trace_time_ms` |  769.50 |  1,539 |  782 |  757 |
| `main_trace_commit_time_ms` |  146.50 |  293 |  150 |  143 |
| `generate_perm_trace_time_ms` |  71 |  142 |  73 |  69 |
| `perm_trace_commit_time_ms` |  229.63 |  459.25 |  234.09 |  225.17 |
| `quotient_poly_compute_time_ms` |  175.74 |  351.48 |  178.47 |  173.01 |
| `quotient_poly_commit_time_ms` |  33.42 |  66.84 |  34.84 |  31.100 |
| `pcs_opening_time_ms ` |  110 |  220 |  112 |  108 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 1,780 |  | 1 | 1 |  |  |  |  | 
| pairing |  | 603 |  | 1 | 63 | 1,745,742 | 27.34 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 127 | 1,214 | 39,650,868 | 410,701,290 | 127 | 782 | 0 | 178.47 | 34.84 | 4 | 234.09 | 112 | 304 | 112 | 14 | 150 | 16,332,746 | 69 | 304 | 1,991,915 | 7.46 | 39 | 214 | 0 | 112 | 
| leaf | 1 | 113 | 1,778 | 39,014,972 | 396,840,426 | 113 | 757 | 0 | 173.01 | 31.100 | 4 | 225.17 | 108 | 299 | 108 | 12 | 143 | 16,068,198 | 73 | 907 | 1,913,000 | 7.53 | 38 | 206 | 0 | 108 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 187 | 852 | 32,480,114 | 172,558,444 | 187 | 392 | 0 | 93.09 | 19.100 | 6 | 90.49 | 67 | 134 | 67 | 1 | 75 | 15,909,408 | 41 | 104 | 1,149,000 | 11.38 | 27 | 113 | 1 | 67 | 
| pairing | 1 | 195 | 603 | 22,464,232 | 119,958,502 | 195 | 305 | 1 | 74.85 | 15.46 | 6 | 64.92 | 54 | 106 | 54 | 0 | 52 | 9,498,894 | 38 | 61 | 596,742 | 18.37 | 21 | 90 | 1 | 54 | 

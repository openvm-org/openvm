...
| `stark_prove_excluding_trace_time_ms` |  1,104 |  1,104 |  1,104 |  1,104 |
| `main_trace_commit_time_ms` |  173 |  173 |  173 |  173 |
| `generate_perm_trace_time_ms` |  33 |  33 |  33 |  33 |
| `perm_trace_commit_time_ms` |  190 |  190 |  190 |  190 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  13,056 |  13,056 |  13,056 |  13,056 |
| `main_cells_used     ` |  244,742,244 |  244,742,244 |  244,742,244 |  244,742,244 |
| `total_cycles        ` |  2,990,589 |  2,990,589 |  2,990,589 |  2,990,589 |
| `execute_time_ms     ` |  1,078 |  1,078 |  1,078 |  1,078 |
| `trace_gen_time_ms   ` |  2,310 |  2,310 |  2,310 |  2,310 |
| `stark_prove_excluding_trace_time_ms` |  9,668 |  9,668 |  9,668 |  9,668 |
| `main_trace_commit_time_ms` |  1,725 |  1,725 |  1,725 |  1,725 |
| `generate_perm_trace_time_ms` |  708 |  708 |  708 |  708 |
| `perm_trace_commit_time_ms` |  3,175 |  3,175 |  3,175 |  3,175 |
| `quotient_poly_compute_time_ms` |  1,344 |  1,344 |  1,344 |  1,344 |
| `quotient_poly_commit_time_ms` |  891 |  891 |  891 |  891 |
| `pcs_opening_time_ms ` |  1,822 |  1,822 |  1,822 |  1,822 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 2,310 | 13,056 | 2,990,589 | 999,394,794 | 9,668 | 1,344 | 891 | 3,175 | 1,822 | 1,725 | 244,742,244 | 708 | 1,078 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 182 | 1,434 | 295,285 | 48,240,457 | 1,104 | 126 | 154 | 190 | 412 | 173 | 15,597,969 | 33 | 148 | 

...
| `quotient_poly_compute_time_ms` |  308 |  308 |  308 |  308 |
...
| `main_cells_used     ` |  203,255,719 |  203,255,719 |  203,255,719 |  203,255,719 |
| `total_cycles        ` |  4,146,521 |  4,146,521 |  4,146,521 |  4,146,521 |
| `execute_time_ms     ` |  972 |  972 |  972 |  972 |
| `trace_gen_time_ms   ` |  3,689 |  3,689 |  3,689 |  3,689 |
| `stark_prove_excluding_trace_time_ms` |  18,129 |  18,129 |  18,129 |  18,129 |
| `main_trace_commit_time_ms` |  3,128 |  3,128 |  3,128 |  3,128 |
| `generate_perm_trace_time_ms` |  412 |  412 |  412 |  412 |
| `perm_trace_commit_time_ms` |  3,749 |  3,749 |  3,749 |  3,749 |
| `quotient_poly_compute_time_ms` |  4,827 |  4,827 |  4,827 |  4,827 |
| `quotient_poly_commit_time_ms` |  2,856 |  2,856 |  2,856 |  2,856 |
| `pcs_opening_time_ms ` |  3,154 |  3,154 |  3,154 |  3,154 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 3,689 | 22,790 | 4,146,521 | 572,214,232 | 18,129 | 4,827 | 2,856 | 3,749 | 3,154 | 3,128 | 203,255,719 | 412 | 972 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 257 | 2,617 | 284,561 | 56,184,959 | 2,215 | 308 | 305 | 538 | 621 | 399 | 15,054,935 | 40 | 145 | 

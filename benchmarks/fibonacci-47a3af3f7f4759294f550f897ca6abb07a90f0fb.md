...
| `total_proof_time_ms ` |  511.50 |  1,023 |  575 |  448 |
...
| `execute_metered_insn_mi/s` |  114.87 | -          |  114.87 |  114.87 |
| `execute_preflight_insns` |  750,104.50 |  1,500,209 |  873,000 |  627,209 |
| `execute_preflight_time_ms` |  29 |  58 |  33 |  25 |
| `execute_preflight_insn_mi/s` |  36.61 | -          |  38.31 |  34.92 |
| `trace_gen_time_ms   ` |  190 |  380 |  194 |  186 |
| `memory_finalize_time_ms` | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  198.50 |  397 |  211 |  186 |
| `main_trace_commit_time_ms` |  30.50 |  61 |  33 |  28 |
| `generate_perm_trace_time_ms` |  35.50 |  71 |  38 |  33 |
| `perm_trace_commit_time_ms` |  41.19 |  82.39 |  44.44 |  37.95 |
| `quotient_poly_compute_time_ms` |  31.52 |  63.03 |  32.40 |  30.63 |
| `quotient_poly_commit_time_ms` |  12.53 |  25.07 |  13.02 |  12.05 |
| `pcs_opening_time_ms ` |  45 |  90 |  53 |  37 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,024.50 |  2,049 |  1,290 |  759 |
| `main_cells_used     ` |  6,475,562 |  12,951,124 |  6,608,072 |  6,343,052 |
| `total_cells_used    ` |  17,568,644 |  35,137,288 |  17,887,054 |  17,250,234 |
| `execute_preflight_insns` |  1,190,433.50 |  2,380,867 |  1,229,653 |  1,151,214 |
| `execute_preflight_time_ms` |  528.50 |  1,057 |  850 |  207 |
| `execute_preflight_insn_mi/s` |  6.67 | -          |  6.67 |  6.67 |
| `trace_gen_time_ms   ` |  59 |  118 |  64 |  54 |
| `memory_finalize_time_ms` |  6 |  12 |  6 |  6 |
| `stark_prove_excluding_trace_time_ms` |  436.50 |  873 |  488 |  385 |
| `main_trace_commit_time_ms` |  84 |  168 |  92 |  76 |
| `generate_perm_trace_time_ms` |  37.50 |  75 |  47 |  28 |
| `perm_trace_commit_time_ms` |  125.25 |  250.50 |  142.39 |  108.11 |
| `quotient_poly_compute_time_ms` |  92.64 |  185.28 |  101.39 |  83.90 |
| `quotient_poly_commit_time_ms` |  21.44 |  42.87 |  23.02 |  19.85 |
| `pcs_opening_time_ms ` |  73 |  146 |  80 |  66 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program |  | 448 |  | 1 | 13 | 1,500,209 | 114.87 | 0 | 
| leaf | 1,291 |  | 1 | 1 |  |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 64 | 759 | 17,887,054 | 252,878,314 | 64 | 488 | 0 | 101.39 | 23.02 | 4 | 142.39 | 80 | 190 | 79 | 6 | 92 | 6,608,072 | 47 | 207 | 1,229,653 | 6.67 | 26 | 125 | 0 | 79 | 
| leaf | 1 | 54 | 1,290 | 17,250,234 | 207,789,546 | 54 | 385 | 0 | 83.90 | 19.85 | 4 | 108.11 | 66 | 137 | 66 | 6 | 76 | 6,343,052 | 28 | 850 | 1,151,214 | 6.67 | 22 | 104 | 0 | 66 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 194 | 575 | 9,677,708 | 84,395,212 | 194 | 211 | 0 | 32.40 | 13.02 | 4 | 44.44 | 53 | 78 | 53 | 0 | 33 | 1,035,986 | 33 | 25 | 873,000 | 34.92 | 14 | 45 | 0 | 53 | 
| fibonacci_program | 1 | 186 | 448 | 9,708,170 | 74,305,770 | 186 | 186 | 1 | 30.63 | 12.05 | 4 | 37.95 | 37 | 76 | 37 | 0 | 28 | 1,064,416 | 38 | 33 | 627,209 | 38.31 | 11 | 43 | 0 | 37 | 
...
Commit: https://github.com/openvm-org/openvm/commit/47a3af3f7f4759294f550f897ca6abb07a90f0fb
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19806626148)

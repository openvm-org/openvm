...
| `total_proof_time_ms ` |  3,842.50 |  7,685 |  4,947 |  2,738 |
...
| `execute_preflight_time_ms` |  94 |  188 |  104 |  84 |
| `execute_preflight_insn_mi/s` |  28.57 | -          |  31.01 |  26.12 |
| `trace_gen_time_ms   ` |  379.50 |  759 |  487 |  272 |
| `memory_finalize_time_ms` |  7.50 |  15 |  13 |  2 |
| `stark_prove_excluding_trace_time_ms` |  3,140 |  6,280 |  4,118 |  2,162 |
| `main_trace_commit_time_ms` |  626 |  1,252 |  841 |  411 |
| `generate_perm_trace_time_ms` |  232.50 |  465 |  306 |  159 |
| `perm_trace_commit_time_ms` |  672 |  1,344 |  893 |  451 |
| `quotient_poly_compute_time_ms` |  331 |  662 |  461 |  201 |
| `quotient_poly_commit_time_ms` |  309 |  618 |  411 |  207 |
| `pcs_opening_time_ms ` |  959.50 |  1,919 |  1,200 |  719 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  5,669 |  11,338 |  6,830 |  4,508 |
| `main_cells_used     ` |  122,270,013 |  244,540,026 |  153,709,316 |  90,830,710 |
| `total_cells_used    ` |  304,358,961 |  608,717,922 |  391,462,802 |  217,255,120 |
| `execute_preflight_insns` |  1,663,342.50 |  3,326,685 |  1,830,063 |  1,496,622 |
| `execute_preflight_time_ms` |  582.50 |  1,165 |  742 |  423 |
| `execute_preflight_insn_mi/s` |  4.39 | -          |  4.53 |  4.25 |
| `trace_gen_time_ms   ` |  288 |  576 |  356 |  220 |
| `memory_finalize_time_ms` |  12 |  24 |  14 |  10 |
| `stark_prove_excluding_trace_time_ms` |  3,770 |  7,540 |  4,709 |  2,831 |
| `main_trace_commit_time_ms` |  707.50 |  1,415 |  841 |  574 |
...
| `quotient_poly_commit_time_ms` |  318 |  636 |  378 |  258 |
| `pcs_opening_time_ms ` |  1,045 |  2,090 |  1,309 |  781 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 6,832 |  | 1 |  | 1 |  |  |  |  | 
| regex_program |  | 2,738 |  | 6 | 1 | 32 | 4,108,597 | 126.78 | 45 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 220 | 4,508 | 217,255,120 | 319,626,730 | 220 | 2,831 | 0 | 312 | 258 | 672 | 781 | 10 | 574 | 90,830,710 | 226 | 423 | 1,496,622 | 4.25 | 
| leaf | 1 | 356 | 6,830 | 391,462,802 | 538,660,330 | 356 | 4,709 | 0 | 521 | 378 | 1,246 | 1,309 | 14 | 841 | 153,709,316 | 410 | 742 | 1,830,063 | 4.53 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 487 | 4,947 | 211,758,557 | 373,183,036 | 487 | 4,118 | 0 | 461 | 411 | 893 | 1,200 | 8 | 13 | 841 | 91,281,687 | 306 | 104 | 2,211,000 | 26.12 | 
| regex_program | 1 | 272 | 2,738 | 174,326,267 | 196,838,026 | 271 | 2,162 | 50 | 201 | 207 | 451 | 719 | 6 | 2 | 411 | 73,453,305 | 159 | 84 | 1,897,597 | 31.01 | 

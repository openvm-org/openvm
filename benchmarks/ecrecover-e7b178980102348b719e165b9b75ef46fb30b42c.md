...
| `total_proof_time_ms ` |  2,534 |  2,534 |  2,534 |  2,534 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  17,818 |  17,818 |  17,818 |  17,818 |
| `main_cells_used     ` |  186,732,337 |  186,732,337 |  186,732,337 |  186,732,337 |
| `total_cycles        ` |  4,157,862 |  4,157,862 |  4,157,862 |  4,157,862 |
| `execute_time_ms     ` |  958 |  958 |  958 |  958 |
| `trace_gen_time_ms   ` |  3,118 |  3,118 |  3,118 |  3,118 |
| `stark_prove_excluding_trace_time_ms` |  13,742 |  13,742 |  13,742 |  13,742 |
| `main_trace_commit_time_ms` |  2,772 |  2,772 |  2,772 |  2,772 |
| `generate_perm_trace_time_ms` |  361 |  361 |  361 |  361 |
| `perm_trace_commit_time_ms` |  2,859 |  2,859 |  2,859 |  2,859 |
| `quotient_poly_compute_time_ms` |  2,083 |  2,083 |  2,083 |  2,083 |
| `quotient_poly_commit_time_ms` |  2,631 |  2,631 |  2,631 |  2,631 |
| `pcs_opening_time_ms ` |  3,031 |  3,031 |  3,031 |  3,031 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 3,118 | 17,818 | 4,157,862 | 459,031,512 | 13,742 | 2,083 | 2,631 | 2,859 | 3,031 | 2,772 | 186,732,337 | 361 | 958 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 224 | 2,534 | 284,567 | 38,417,467 | 2,163 | 229 | 479 | 353 | 665 | 391 | 15,055,723 | 34 | 147 | 

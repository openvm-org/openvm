...
| `stark_prove_excluding_trace_time_ms` |  2,199 |  2,199 |  2,199 |  2,199 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  41,711 |  41,711 |  41,711 |  41,711 |
| `main_cells_used     ` |  365,932,096 |  365,932,096 |  365,932,096 |  365,932,096 |
| `total_cycles        ` |  8,657,518 |  8,657,518 |  8,657,518 |  8,657,518 |
| `execute_time_ms     ` |  2,456 |  2,456 |  2,456 |  2,456 |
| `trace_gen_time_ms   ` |  6,602 |  6,602 |  6,602 |  6,602 |
| `stark_prove_excluding_trace_time_ms` |  32,653 |  32,653 |  32,653 |  32,653 |
| `main_trace_commit_time_ms` |  5,801 |  5,801 |  5,801 |  5,801 |
| `generate_perm_trace_time_ms` |  733 |  733 |  733 |  733 |
| `perm_trace_commit_time_ms` |  7,240 |  7,240 |  7,240 |  7,240 |
| `quotient_poly_compute_time_ms` |  7,410 |  7,410 |  7,410 |  7,410 |
| `quotient_poly_commit_time_ms` |  5,173 |  5,173 |  5,173 |  5,173 |
| `pcs_opening_time_ms ` |  6,293 |  6,293 |  6,293 |  6,293 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 6,602 | 41,711 | 8,657,518 | 1,052,183,000 | 32,653 | 7,410 | 5,173 | 7,240 | 6,293 | 5,801 | 365,932,096 | 733 | 2,456 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 269 | 2,620 | 285,401 | 56,172,159 | 2,199 | 291 | 312 | 528 | 634 | 394 | 15,092,297 | 37 | 152 | 

...
| `total_proof_time_ms ` |  15,165 |  15,165 |  15,165 |  15,165 |
...
| `stark_prove_excluding_trace_time_ms` |  11,110 |  11,110 |  11,110 |  11,110 |
| `main_trace_commit_time_ms` |  2,570 |  2,570 |  2,570 |  2,570 |
| `generate_perm_trace_time_ms` |  391 |  391 |  391 |  391 |
| `perm_trace_commit_time_ms` |  2,187 |  2,187 |  2,187 |  2,187 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  15,050 |  15,050 |  15,050 |  15,050 |
| `main_cells_used     ` |  140,982,474 |  140,982,474 |  140,982,474 |  140,982,474 |
| `total_cycles        ` |  3,130,227 |  3,130,227 |  3,130,227 |  3,130,227 |
| `execute_time_ms     ` |  721 |  721 |  721 |  721 |
| `trace_gen_time_ms   ` |  2,862 |  2,862 |  2,862 |  2,862 |
| `stark_prove_excluding_trace_time_ms` |  11,467 |  11,467 |  11,467 |  11,467 |
| `main_trace_commit_time_ms` |  2,369 |  2,369 |  2,369 |  2,369 |
| `generate_perm_trace_time_ms` |  293 |  293 |  293 |  293 |
| `perm_trace_commit_time_ms` |  2,246 |  2,246 |  2,246 |  2,246 |
| `quotient_poly_compute_time_ms` |  1,672 |  1,672 |  1,672 |  1,672 |
| `quotient_poly_commit_time_ms` |  2,280 |  2,280 |  2,280 |  2,280 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 2,862 | 15,050 | 3,130,227 | 360,334,296 | 11,467 | 1,672 | 2,280 | 2,246 | 2,603 | 2,369 | 140,982,474 | 293 | 721 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 3,059 | 15,165 | 4,139,840 | 384,265,816 | 11,110 | 1,544 | 1,996 | 2,187 | 2,415 | 2,570 | 163,831,435 | 391 | 996 | 

...
| `total_proof_time_ms ` |  3,970 |  7,940 |  4,588 |  3,352 |
...
| `trace_gen_time_ms   ` |  934 |  1,868 |  1,107 |  761 |
| `stark_prove_excluding_trace_time_ms` |  2,698.50 |  5,397 |  3,106 |  2,291 |
| `main_trace_commit_time_ms` |  491 |  982 |  576 |  406 |
| `generate_perm_trace_time_ms` |  172 |  344 |  199 |  145 |
| `perm_trace_commit_time_ms` |  697.50 |  1,395 |  813 |  582 |
| `quotient_poly_compute_time_ms` |  364 |  728 |  417 |  311 |
| `quotient_poly_commit_time_ms` |  287.50 |  575 |  332 |  243 |
| `pcs_opening_time_ms ` |  676.50 |  1,353 |  759 |  594 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,478.50 |  14,957 |  7,546 |  7,411 |
| `main_cells_used     ` |  152,233,652 |  304,467,304 |  154,691,132 |  149,776,172 |
| `total_cycles        ` |  1,990,786.50 |  3,981,573 |  2,021,576 |  1,959,997 |
| `execute_time_ms     ` |  756 |  1,512 |  763 |  749 |
| `trace_gen_time_ms   ` |  1,490.50 |  2,981 |  1,501 |  1,480 |
| `stark_prove_excluding_trace_time_ms` |  5,232 |  10,464 |  5,282 |  5,182 |
| `main_trace_commit_time_ms` |  889 |  1,778 |  891 |  887 |
| `generate_perm_trace_time_ms` |  351.50 |  703 |  366 |  337 |
| `perm_trace_commit_time_ms` |  1,653 |  3,306 |  1,690 |  1,616 |
| `quotient_poly_compute_time_ms` |  765 |  1,530 |  766 |  764 |
| `quotient_poly_commit_time_ms` |  518.50 |  1,037 |  519 |  518 |
| `pcs_opening_time_ms ` |  1,050 |  2,100 |  1,051 |  1,049 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,501 | 7,546 | 2,021,576 | 533,941,738 | 5,282 | 766 | 519 | 1,690 | 1,049 | 887 | 154,691,132 | 366 | 763 | 
| leaf | 1 | 1,480 | 7,411 | 1,959,997 | 533,941,738 | 5,182 | 764 | 518 | 1,616 | 1,051 | 891 | 149,776,172 | 337 | 749 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,107 | 4,588 | 2,225,434 | 275,652,919 | 3,106 | 417 | 332 | 813 | 759 | 576 | 93,699,990 | 199 | 375 | 
| regex_program | 1 | 761 | 3,352 | 1,914,730 | 198,099,628 | 2,291 | 311 | 243 | 582 | 594 | 406 | 73,689,460 | 145 | 300 | 

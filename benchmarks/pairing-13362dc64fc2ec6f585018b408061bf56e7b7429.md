...
| `total_proof_time_ms ` |  721 |  1,442 |  829 |  613 |
...
| `execute_preflight_insn_mi/s` |  13.52 | -          |  17.88 |  9.16 |
| `trace_gen_time_ms   ` |  182 |  364 |  198 |  166 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  348 |  696 |  384 |  312 |
| `main_trace_commit_time_ms` |  66 |  132 |  76 |  56 |
| `generate_perm_trace_time_ms` |  31.50 |  63 |  34 |  29 |
| `perm_trace_commit_time_ms` |  78.14 |  156.29 |  89.95 |  66.34 |
| `quotient_poly_compute_time_ms` |  79.69 |  159.38 |  87.83 |  71.55 |
| `quotient_poly_commit_time_ms` |  16.71 |  33.42 |  18.77 |  14.65 |
| `pcs_opening_time_ms ` |  70.50 |  141 |  72 |  69 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,481.50 |  2,963 |  1,768 |  1,195 |
| `main_cells_used     ` |  16,200,472 |  32,400,944 |  16,332,746 |  16,068,198 |
| `total_cells_used    ` |  39,332,920 |  78,665,840 |  39,650,868 |  39,014,972 |
| `execute_preflight_insns` |  1,952,365 |  3,904,730 |  1,991,856 |  1,912,874 |
| `execute_preflight_time_ms` |  608.50 |  1,217 |  914 |  303 |
| `execute_preflight_insn_mi/s` |  7.49 | -          |  7.53 |  7.45 |
| `trace_gen_time_ms   ` |  119.50 |  239 |  128 |  111 |
| `memory_finalize_time_ms` |  10.50 |  21 |  11 |  10 |
| `stark_prove_excluding_trace_time_ms` |  752 |  1,504 |  762 |  742 |
| `main_trace_commit_time_ms` |  148 |  296 |  152 |  144 |
| `generate_perm_trace_time_ms` |  58 |  116 |  60 |  56 |
| `perm_trace_commit_time_ms` |  230.32 |  460.64 |  234.66 |  225.99 |
| `quotient_poly_compute_time_ms` |  172.16 |  344.33 |  173.59 |  170.74 |
| `quotient_poly_commit_time_ms` |  31.29 |  62.58 |  32.01 |  30.57 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 1,770 |  | 1 |  | 1 |  |  |  |  | 
| pairing |  | 613 |  | 42 | 1 | 89 | 1,745,742 | 19.44 | 146 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 128 | 1,195 | 39,650,868 | 410,701,290 | 128 | 762 | 0 | 173.59 | 32.01 | 4 | 234.66 | 110 | 291 | 110 | 11 | 152 | 16,332,746 | 56 | 303 | 1,991,856 | 7.45 | 40 | 207 | 0 | 110 | 
| leaf | 1 | 111 | 1,768 | 39,014,972 | 396,840,426 | 111 | 742 | 0 | 170.74 | 30.57 | 4 | 225.99 | 107 | 286 | 107 | 10 | 144 | 16,068,198 | 60 | 914 | 1,912,874 | 7.53 | 38 | 202 | 0 | 107 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 166 | 829 | 32,689,110 | 172,558,444 | 166 | 384 | 0 | 87.83 | 18.77 | 7 | 89.95 | 72 | 128 | 71 | 1 | 76 | 16,059,916 | 34 | 130 | 1,157,000 | 9.16 | 27 | 107 | 1 | 71 | 
| pairing | 1 | 198 | 613 | 22,314,288 | 119,958,502 | 198 | 312 | 1 | 71.55 | 14.65 | 6 | 66.34 | 69 | 98 | 69 | 0 | 56 | 9,408,294 | 29 | 62 | 588,742 | 17.88 | 21 | 86 | 1 | 69 | 

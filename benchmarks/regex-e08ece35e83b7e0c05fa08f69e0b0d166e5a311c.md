...
| `total_proof_time_ms ` |  3,856.50 |  7,713 |  4,446 |  3,267 |
...
| `trace_gen_time_ms   ` |  954 |  1,908 |  1,149 |  759 |
| `stark_prove_excluding_trace_time_ms` |  2,564 |  5,128 |  2,921 |  2,207 |
| `main_trace_commit_time_ms` |  446.50 |  893 |  522 |  371 |
| `generate_perm_trace_time_ms` |  177 |  354 |  189 |  165 |
| `perm_trace_commit_time_ms` |  637.50 |  1,275 |  744 |  531 |
| `quotient_poly_compute_time_ms` |  365 |  730 |  424 |  306 |
| `quotient_poly_commit_time_ms` |  269 |  538 |  315 |  223 |
| `pcs_opening_time_ms ` |  659 |  1,318 |  717 |  601 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,510.50 |  15,021 |  7,538 |  7,483 |
| `main_cells_used     ` |  152,234,294 |  304,468,588 |  154,692,212 |  149,776,376 |
| `total_cycles        ` |  1,990,840 |  3,981,680 |  2,021,666 |  1,960,014 |
| `execute_time_ms     ` |  760.50 |  1,521 |  767 |  754 |
| `trace_gen_time_ms   ` |  1,469.50 |  2,939 |  1,482 |  1,457 |
| `stark_prove_excluding_trace_time_ms` |  5,280.50 |  10,561 |  5,314 |  5,247 |
| `main_trace_commit_time_ms` |  893.50 |  1,787 |  895 |  892 |
| `generate_perm_trace_time_ms` |  352 |  704 |  365 |  339 |
| `perm_trace_commit_time_ms` |  1,676.50 |  3,353 |  1,702 |  1,651 |
| `quotient_poly_compute_time_ms` |  764 |  1,528 |  765 |  763 |
| `quotient_poly_commit_time_ms` |  520 |  1,040 |  520 |  520 |
| `pcs_opening_time_ms ` |  1,069.50 |  2,139 |  1,077 |  1,062 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,457 | 7,538 | 2,021,666 | 533,941,738 | 5,314 | 765 | 520 | 1,702 | 1,062 | 895 | 154,692,212 | 365 | 767 | 
| leaf | 1 | 1,482 | 7,483 | 1,960,014 | 533,941,738 | 5,247 | 763 | 520 | 1,651 | 1,077 | 892 | 149,776,376 | 339 | 754 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,149 | 4,446 | 2,225,434 | 275,652,919 | 2,921 | 424 | 315 | 744 | 717 | 522 | 93,701,806 | 189 | 376 | 
| regex_program | 1 | 759 | 3,267 | 1,914,806 | 198,099,628 | 2,207 | 306 | 223 | 531 | 601 | 371 | 73,698,552 | 165 | 301 | 

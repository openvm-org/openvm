...
| `total_proof_time_ms ` |  4,049.50 |  8,099 |  4,486 |  3,613 |
| `main_cells_used     ` |  83,255,576 |  166,511,152 |  93,500,799 |  73,010,353 |
| `total_cycles        ` |  2,082,613 |  4,165,226 |  2,243,715 |  1,921,511 |
| `execute_time_ms     ` |  343 |  686 |  381 |  305 |
| `trace_gen_time_ms   ` |  971.50 |  1,943 |  1,147 |  796 |
| `stark_prove_excluding_trace_time_ms` |  2,735 |  5,470 |  2,958 |  2,512 |
| `main_trace_commit_time_ms` |  473 |  946 |  533 |  413 |
| `generate_perm_trace_time_ms` |  192 |  384 |  192 |  192 |
| `perm_trace_commit_time_ms` |  694 |  1,388 |  747 |  641 |
| `quotient_poly_compute_time_ms` |  397.50 |  795 |  428 |  367 |
| `quotient_poly_commit_time_ms` |  281 |  562 |  317 |  245 |
| `pcs_opening_time_ms ` |  688.50 |  1,377 |  733 |  644 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,279 |  14,558 |  7,341 |  7,217 |
| `main_cells_used     ` |  152,278,603 |  304,557,206 |  154,678,042 |  149,879,164 |
| `total_cycles        ` |  1,991,061.50 |  3,982,123 |  2,021,854 |  1,960,269 |
| `execute_time_ms     ` |  774 |  1,548 |  782 |  766 |
| `trace_gen_time_ms   ` |  1,451.50 |  2,903 |  1,461 |  1,442 |
| `stark_prove_excluding_trace_time_ms` |  5,053.50 |  10,107 |  5,098 |  5,009 |
| `main_trace_commit_time_ms` |  810.50 |  1,621 |  812 |  809 |
| `generate_perm_trace_time_ms` |  361 |  722 |  363 |  359 |
| `perm_trace_commit_time_ms` |  1,552 |  3,104 |  1,587 |  1,517 |
| `quotient_poly_compute_time_ms` |  767 |  1,534 |  768 |  766 |
| `quotient_poly_commit_time_ms` |  498 |  996 |  498 |  498 |
| `pcs_opening_time_ms ` |  1,060.50 |  2,121 |  1,066 |  1,055 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,461 | 7,341 | 2,021,854 | 538,660,330 | 5,098 | 768 | 498 | 1,587 | 1,066 | 812 | 154,678,042 | 363 | 782 | 
| leaf | 1 | 1,442 | 7,217 | 1,960,269 | 538,660,330 | 5,009 | 766 | 498 | 1,517 | 1,055 | 809 | 149,879,164 | 359 | 766 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,147 | 4,486 | 2,243,715 | 275,652,919 | 2,958 | 428 | 317 | 747 | 733 | 533 | 93,500,799 | 192 | 381 | 
| regex_program | 1 | 796 | 3,613 | 1,921,511 | 242,975,404 | 2,512 | 367 | 245 | 641 | 644 | 413 | 73,010,353 | 192 | 305 | 

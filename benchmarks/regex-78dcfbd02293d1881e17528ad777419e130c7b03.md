...
| `total_proof_time_ms ` |  4,190.50 |  8,381 |  4,652 |  3,729 |
| `main_cells_used     ` |  83,255,576 |  166,511,152 |  93,500,799 |  73,010,353 |
| `total_cycles        ` |  2,082,613 |  4,165,226 |  2,243,715 |  1,921,511 |
| `execute_time_ms     ` |  340.50 |  681 |  379 |  302 |
| `trace_gen_time_ms   ` |  990 |  1,980 |  1,182 |  798 |
| `stark_prove_excluding_trace_time_ms` |  2,860 |  5,720 |  3,091 |  2,629 |
| `main_trace_commit_time_ms` |  520.50 |  1,041 |  582 |  459 |
| `generate_perm_trace_time_ms` |  196.50 |  393 |  197 |  196 |
| `perm_trace_commit_time_ms` |  748 |  1,496 |  806 |  690 |
| `quotient_poly_compute_time_ms` |  392.50 |  785 |  427 |  358 |
| `quotient_poly_commit_time_ms` |  301.50 |  603 |  340 |  263 |
| `pcs_opening_time_ms ` |  690.50 |  1,381 |  729 |  652 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,266.50 |  14,533 |  7,342 |  7,191 |
| `main_cells_used     ` |  152,278,267 |  304,556,534 |  154,677,898 |  149,878,636 |
| `total_cycles        ` |  1,991,033.50 |  3,982,067 |  2,021,842 |  1,960,225 |
| `execute_time_ms     ` |  757.50 |  1,515 |  766 |  749 |
| `trace_gen_time_ms   ` |  1,453 |  2,906 |  1,468 |  1,438 |
| `stark_prove_excluding_trace_time_ms` |  5,056 |  10,112 |  5,108 |  5,004 |
| `main_trace_commit_time_ms` |  809.50 |  1,619 |  813 |  806 |
| `generate_perm_trace_time_ms` |  378.50 |  757 |  396 |  361 |
| `perm_trace_commit_time_ms` |  1,534 |  3,068 |  1,568 |  1,500 |
| `quotient_poly_compute_time_ms` |  768 |  1,536 |  771 |  765 |
| `quotient_poly_commit_time_ms` |  493.50 |  987 |  495 |  492 |
| `pcs_opening_time_ms ` |  1,065.50 |  2,131 |  1,066 |  1,065 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,468 | 7,342 | 2,021,842 | 538,660,330 | 5,108 | 765 | 492 | 1,568 | 1,066 | 813 | 154,677,898 | 396 | 766 | 
| leaf | 1 | 1,438 | 7,191 | 1,960,225 | 538,660,330 | 5,004 | 771 | 495 | 1,500 | 1,065 | 806 | 149,878,636 | 361 | 749 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,182 | 4,652 | 2,243,715 | 275,652,919 | 3,091 | 427 | 340 | 806 | 729 | 582 | 93,500,799 | 197 | 379 | 
| regex_program | 1 | 798 | 3,729 | 1,921,511 | 242,975,404 | 2,629 | 358 | 263 | 690 | 652 | 459 | 73,010,353 | 196 | 302 | 

...
| `total_proof_time_ms ` |  3,879 |  7,758 |  4,476 |  3,282 |
...
| `trace_gen_time_ms   ` |  971.50 |  1,943 |  1,155 |  788 |
| `stark_prove_excluding_trace_time_ms` |  2,568 |  5,136 |  2,944 |  2,192 |
| `main_trace_commit_time_ms` |  447.50 |  895 |  528 |  367 |
| `generate_perm_trace_time_ms` |  159.50 |  319 |  180 |  139 |
| `perm_trace_commit_time_ms` |  645 |  1,290 |  750 |  540 |
| `quotient_poly_compute_time_ms` |  362.50 |  725 |  419 |  306 |
| `quotient_poly_commit_time_ms` |  275 |  550 |  322 |  228 |
| `pcs_opening_time_ms ` |  669 |  1,338 |  734 |  604 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,502.50 |  15,005 |  7,574 |  7,431 |
| `main_cells_used     ` |  152,233,742 |  304,467,484 |  154,691,288 |  149,776,196 |
| `total_cycles        ` |  1,990,794 |  3,981,588 |  2,021,589 |  1,959,999 |
| `execute_time_ms     ` |  772 |  1,544 |  780 |  764 |
| `trace_gen_time_ms   ` |  1,484.50 |  2,969 |  1,491 |  1,478 |
| `stark_prove_excluding_trace_time_ms` |  5,246 |  10,492 |  5,303 |  5,189 |
| `main_trace_commit_time_ms` |  891 |  1,782 |  892 |  890 |
| `generate_perm_trace_time_ms` |  352.50 |  705 |  366 |  339 |
| `perm_trace_commit_time_ms` |  1,658.50 |  3,317 |  1,690 |  1,627 |
| `quotient_poly_compute_time_ms` |  760 |  1,520 |  761 |  759 |
| `quotient_poly_commit_time_ms` |  523.50 |  1,047 |  524 |  523 |
| `pcs_opening_time_ms ` |  1,054 |  2,108 |  1,064 |  1,044 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,491 | 7,574 | 2,021,589 | 533,941,738 | 5,303 | 761 | 523 | 1,690 | 1,064 | 890 | 154,691,288 | 366 | 780 | 
| leaf | 1 | 1,478 | 7,431 | 1,959,999 | 533,941,738 | 5,189 | 759 | 524 | 1,627 | 1,044 | 892 | 149,776,196 | 339 | 764 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,155 | 4,476 | 2,225,434 | 275,652,919 | 2,944 | 419 | 322 | 750 | 734 | 528 | 93,701,806 | 180 | 377 | 
| regex_program | 1 | 788 | 3,282 | 1,914,806 | 198,099,628 | 2,192 | 306 | 228 | 540 | 604 | 367 | 73,698,552 | 139 | 302 | 

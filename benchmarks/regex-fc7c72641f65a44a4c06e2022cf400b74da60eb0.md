...
| `total_proof_time_ms ` |  584.25 |  2,337 |  715 |  540 |
...
| `execute_preflight_time_ms` |  52.25 |  209 |  63 |  44 |
| `execute_preflight_insn_mi/s` |  32.17 | -          |  33.29 |  29.10 |
| `trace_gen_time_ms   ` |  179.25 |  717 |  210 |  158 |
| `memory_finalize_time_ms` |  1 |  4 |  4 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  279.25 |  1,117 |  291 |  269 |
| `main_trace_commit_time_ms` |  51.75 |  207 |  56 |  49 |
| `generate_perm_trace_time_ms` |  26.25 |  105 |  36 |  19 |
| `perm_trace_commit_time_ms` |  64.49 |  257.96 |  71.75 |  55.13 |
| `quotient_poly_compute_time_ms` |  59.30 |  237.20 |  70.10 |  53.08 |
| `quotient_poly_commit_time_ms` |  15.73 |  62.91 |  17.53 |  13.09 |
| `pcs_opening_time_ms ` |  58.50 |  234 |  62 |  54 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,393.50 |  5,574 |  2,050 |  909 |
...
| `execute_preflight_insns` |  1,440,868 |  5,763,472 |  1,814,630 |  1,241,327 |
| `execute_preflight_time_ms` |  610.25 |  2,441 |  795 |  223 |
| `execute_preflight_insn_mi/s` |  7.08 | -          |  7.53 |  6.79 |
| `trace_gen_time_ms   ` |  87.25 |  349 |  165 |  57 |
| `memory_finalize_time_ms` |  9 |  36 |  17 |  6 |
| `stark_prove_excluding_trace_time_ms` |  694.75 |  2,779 |  1,124 |  506 |
| `main_trace_commit_time_ms` |  124.50 |  498 |  193 |  91 |
| `generate_perm_trace_time_ms` |  62.50 |  250 |  74 |  50 |
| `perm_trace_commit_time_ms` |  208.88 |  835.51 |  382.71 |  140.28 |
| `quotient_poly_compute_time_ms` |  146.95 |  587.81 |  241.87 |  103.93 |
| `quotient_poly_commit_time_ms` |  33.31 |  133.24 |  56.84 |  24.29 |
| `pcs_opening_time_ms ` |  114.50 |  458 |  169 |  74 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 2,052 |  | 1 | 1 |  |  |  |  | 
| regex_program |  | 540 |  | 1 | 36 | 4,137,502 | 113.09 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 69 | 909 | 22,981,570 | 319,331,818 | 69 | 616 | 0 | 137.23 | 27.24 | 4 | 169.82 | 106 | 221 | 106 | 7 | 122 | 9,122,488 | 50 | 223 | 1,466,016 | 7.53 | 31 | 165 | 0 | 106 | 
| leaf | 1 | 58 | 1,388 | 20,905,034 | 255,237,610 | 58 | 533 | 0 | 103.93 | 24.29 | 4 | 142.69 | 109 | 202 | 109 | 6 | 91 | 8,256,948 | 59 | 795 | 1,241,499 | 7.06 | 26 | 129 | 0 | 109 | 
| leaf | 2 | 57 | 1,227 | 20,905,034 | 255,237,610 | 57 | 506 | 0 | 104.78 | 24.87 | 4 | 140.28 | 74 | 208 | 74 | 6 | 92 | 8,256,948 | 67 | 663 | 1,241,327 | 6.94 | 26 | 130 | 0 | 74 | 
| leaf | 3 | 165 | 2,050 | 50,337,320 | 538,365,418 | 165 | 1,124 | 0 | 241.87 | 56.84 | 4 | 382.71 | 169 | 458 | 169 | 17 | 193 | 20,171,106 | 74 | 760 | 1,814,630 | 6.79 | 61 | 303 | 5 | 169 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 210 | 715 | 23,446,148 | 150,778,428 | 210 | 291 | 0 | 59.74 | 17.53 | 5 | 71.75 | 61 | 94 | 61 | 4 | 56 | 10,899,170 | 22 | 45 | 1,103,000 | 29.10 | 21 | 77 | 1 | 61 | 
| regex_program | 1 | 158 | 542 | 11,598,276 | 128,513,066 | 158 | 280 | 1 | 54.29 | 16.45 | 4 | 65.98 | 54 | 102 | 54 | 0 | 51 | 2,196,106 | 36 | 63 | 1,104,000 | 33.22 | 17 | 71 | 0 | 54 | 
| regex_program | 2 | 164 | 540 | 11,579,064 | 128,513,066 | 164 | 277 | 1 | 53.08 | 15.84 | 4 | 65.10 | 62 | 93 | 62 | 0 | 51 | 2,177,334 | 28 | 57 | 1,104,000 | 33.29 | 17 | 69 | 0 | 62 | 
| regex_program | 3 | 185 | 540 | 11,853,872 | 103,456,394 | 185 | 269 | 0 | 70.10 | 13.09 | 5 | 55.13 | 57 | 78 | 56 | 0 | 49 | 2,422,606 | 19 | 44 | 826,502 | 33.07 | 18 | 84 | 1 | 56 | 

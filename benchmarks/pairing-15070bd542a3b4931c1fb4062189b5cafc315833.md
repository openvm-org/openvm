...
| `execute_preflight_insn_mi/s` |  11.63 | -          |  11.63 |  11.63 |
| `trace_gen_time_ms   ` |  278 |  278 |  278 |  278 |
| `memory_finalize_time_ms` |  1 |  1 |  1 |  1 |
| `stark_prove_excluding_trace_time_ms` |  941 |  941 |  941 |  941 |
| `main_trace_commit_time_ms` |  140 |  140 |  140 |  140 |
| `generate_perm_trace_time_ms` |  64 |  64 |  64 |  64 |
| `perm_trace_commit_time_ms` |  177.80 |  177.80 |  177.80 |  177.80 |
| `quotient_poly_compute_time_ms` |  144.01 |  144.01 |  144.01 |  144.01 |
| `quotient_poly_commit_time_ms` |  33.53 |  33.53 |  33.53 |  33.53 |
| `pcs_opening_time_ms ` |  377 |  377 |  377 |  377 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,738 |  1,738 |  1,738 |  1,738 |
...
| `execute_preflight_time_ms` |  332 |  332 |  332 |  332 |
| `execute_preflight_insn_mi/s` |  7.67 | -          |  7.67 |  7.67 |
...
| `perm_trace_commit_time_ms` |  250.56 |  250.56 |  250.56 |  250.56 |
| `quotient_poly_compute_time_ms` |  164.68 |  164.68 |  164.68 |  164.68 |
| `quotient_poly_commit_time_ms` |  40.46 |  40.46 |  40.46 |  40.46 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 1,740 |  | 1 |  | 1 |  |  |  |  | 
| pairing |  | 1,514 |  | 40 | 1 | 93 | 1,882,939 | 20.15 | 151 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 123 | 1,738 | 39,940,154 | 418,598,378 | 123 | 1,282 | 0 | 164.68 | 40.46 | 4 | 250.56 | 587 | 322 | 587 | 12 | 165 | 16,451,316 | 71 | 332 | 2,010,437 | 7.67 | 39 | 206 | 1 | 587 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 278 | 1,514 | 44,491,360 | 304,931,516 | 278 | 941 | 0 | 144.01 | 33.53 | 7 | 177.80 | 377 | 244 | 376 | 1 | 140 | 23,722,622 | 64 | 166 | 1,882,939 | 11.63 | 37 | 179 | 3 | 376 | 

...
| `total_proof_time_ms ` |  3,747 |  7,494 |  4,794 |  2,700 |
...
| `execute_metered_insn_mi/s` |  122.15 | -          |  122.15 |  122.15 |
| `execute_preflight_insns` |  2,054,298.50 |  4,108,597 |  2,211,000 |  1,897,597 |
| `execute_preflight_time_ms` |  98.50 |  197 |  106 |  91 |
| `execute_preflight_insn_mi/s` |  26.34 | -          |  28.18 |  24.51 |
| `trace_gen_time_ms   ` |  385 |  770 |  497 |  273 |
| `memory_finalize_time_ms` |  7.50 |  15 |  13 |  2 |
| `stark_prove_excluding_trace_time_ms` |  3,034.50 |  6,069 |  3,952 |  2,117 |
| `main_trace_commit_time_ms` |  580.50 |  1,161 |  790 |  371 |
| `generate_perm_trace_time_ms` |  245.50 |  491 |  329 |  162 |
| `perm_trace_commit_time_ms` |  604.50 |  1,209 |  790 |  419 |
| `quotient_poly_compute_time_ms` |  325.50 |  651 |  439 |  212 |
| `quotient_poly_commit_time_ms` |  290.50 |  581 |  375 |  206 |
| `pcs_opening_time_ms ` |  975.50 |  1,951 |  1,224 |  727 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  5,628 |  11,256 |  6,797 |  4,459 |
| `main_cells_used     ` |  122,270,427 |  244,540,854 |  153,709,496 |  90,831,358 |
| `total_cells_used    ` |  304,360,341 |  608,720,682 |  391,463,402 |  217,257,280 |
| `execute_preflight_insns` |  1,663,377 |  3,326,754 |  1,830,078 |  1,496,676 |
| `execute_preflight_time_ms` |  607 |  1,214 |  779 |  435 |
| `execute_preflight_insn_mi/s` |  4.30 | -          |  4.45 |  4.14 |
| `trace_gen_time_ms   ` |  294.50 |  589 |  363 |  226 |
| `memory_finalize_time_ms` |  29.50 |  59 |  50 |  9 |
| `stark_prove_excluding_trace_time_ms` |  3,709.50 |  7,419 |  4,635 |  2,784 |
| `main_trace_commit_time_ms` |  673.50 |  1,347 |  794 |  553 |
| `generate_perm_trace_time_ms` |  336 |  672 |  435 |  237 |
| `perm_trace_commit_time_ms` |  901 |  1,802 |  1,178 |  624 |
| `quotient_poly_compute_time_ms` |  435.50 |  871 |  542 |  329 |
| `quotient_poly_commit_time_ms` |  301.50 |  603 |  358 |  245 |
| `pcs_opening_time_ms ` |  1,055.50 |  2,111 |  1,320 |  791 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 6,799 |  | 1 |  | 1 |  |  |  |  | 
| regex_program |  | 2,700 |  | 6 | 1 | 33 | 4,108,597 | 122.15 | 43 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 226 | 4,459 | 217,257,280 | 319,626,730 | 226 | 2,784 | 0 | 329 | 245 | 624 | 791 | 9 | 553 | 90,831,358 | 237 | 435 | 1,496,676 | 4.14 | 
| leaf | 1 | 363 | 6,797 | 391,463,402 | 538,660,330 | 363 | 4,635 | 0 | 542 | 358 | 1,178 | 1,320 | 50 | 794 | 153,709,496 | 435 | 779 | 1,830,078 | 4.45 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 497 | 4,794 | 211,758,557 | 373,183,036 | 497 | 3,952 | 0 | 439 | 375 | 790 | 1,224 | 7 | 13 | 790 | 91,281,687 | 329 | 106 | 2,211,000 | 24.51 | 
| regex_program | 1 | 273 | 2,700 | 174,326,267 | 196,838,026 | 273 | 2,117 | 51 | 212 | 206 | 419 | 727 | 6 | 2 | 371 | 73,453,305 | 162 | 91 | 1,897,597 | 28.18 | 

...
| `total_proof_time_ms ` |  3,838 |  7,676 |  4,442 |  3,234 |
...
| `trace_gen_time_ms   ` |  938 |  1,876 |  1,125 |  751 |
| `stark_prove_excluding_trace_time_ms` |  2,564.50 |  5,129 |  2,944 |  2,185 |
| `main_trace_commit_time_ms` |  448 |  896 |  526 |  370 |
| `generate_perm_trace_time_ms` |  164.50 |  329 |  185 |  144 |
| `perm_trace_commit_time_ms` |  644 |  1,288 |  754 |  534 |
| `quotient_poly_compute_time_ms` |  367.50 |  735 |  430 |  305 |
| `quotient_poly_commit_time_ms` |  271 |  542 |  315 |  227 |
| `pcs_opening_time_ms ` |  661.50 |  1,323 |  726 |  597 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,525 |  15,050 |  7,569 |  7,481 |
| `main_cells_used     ` |  152,233,658 |  304,467,316 |  154,691,132 |  149,776,184 |
| `total_cycles        ` |  1,990,787 |  3,981,574 |  2,021,576 |  1,959,998 |
| `execute_time_ms     ` |  754 |  1,508 |  762 |  746 |
| `trace_gen_time_ms   ` |  1,506 |  3,012 |  1,531 |  1,481 |
| `stark_prove_excluding_trace_time_ms` |  5,265 |  10,530 |  5,276 |  5,254 |
| `main_trace_commit_time_ms` |  894.50 |  1,789 |  895 |  894 |
| `generate_perm_trace_time_ms` |  346.50 |  693 |  350 |  343 |
| `perm_trace_commit_time_ms` |  1,673 |  3,346 |  1,690 |  1,656 |
| `quotient_poly_compute_time_ms` |  767 |  1,534 |  770 |  764 |
| `quotient_poly_commit_time_ms` |  522 |  1,044 |  523 |  521 |
| `pcs_opening_time_ms ` |  1,056 |  2,112 |  1,063 |  1,049 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,531 | 7,569 | 2,021,576 | 533,941,738 | 5,276 | 764 | 523 | 1,690 | 1,049 | 895 | 154,691,132 | 350 | 762 | 
| leaf | 1 | 1,481 | 7,481 | 1,959,998 | 533,941,738 | 5,254 | 770 | 521 | 1,656 | 1,063 | 894 | 149,776,184 | 343 | 746 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,125 | 4,442 | 2,225,434 | 275,652,919 | 2,944 | 430 | 315 | 754 | 726 | 526 | 93,699,990 | 185 | 373 | 
| regex_program | 1 | 751 | 3,234 | 1,914,730 | 198,099,628 | 2,185 | 305 | 227 | 534 | 597 | 370 | 73,689,460 | 144 | 298 | 

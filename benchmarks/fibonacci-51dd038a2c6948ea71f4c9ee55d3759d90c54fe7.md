...
| `total_proof_time_ms ` |  523.50 |  1,047 |  614 |  433 |
...
| `execute_metered_insn_mi/s` |  160.54 | -          |  160.54 |  160.54 |
| `execute_preflight_insns` |  750,104.50 |  1,500,209 |  873,000 |  627,209 |
| `execute_preflight_time_ms` |  26 |  52 |  31 |  21 |
| `execute_preflight_insn_mi/s` |  40.12 | -          |  40.18 |  40.05 |
| `trace_gen_time_ms   ` |  192 |  384 |  196 |  188 |
| `memory_finalize_time_ms` | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  199.50 |  399 |  225 |  174 |
| `main_trace_commit_time_ms` |  30.50 |  61 |  33 |  28 |
| `generate_perm_trace_time_ms` |  26 |  52 |  31 |  21 |
| `perm_trace_commit_time_ms` |  40.64 |  81.29 |  42.85 |  38.44 |
| `quotient_poly_compute_time_ms` |  32.04 |  64.08 |  34.56 |  29.52 |
| `quotient_poly_commit_time_ms` |  11.81 |  23.62 |  12.19 |  11.43 |
...
| `execute_preflight_time_ms` |  511 |  1,022 |  823 |  199 |
| `execute_preflight_insn_mi/s` |  6.88 | -          |  6.96 |  6.81 |
| `trace_gen_time_ms   ` |  59 |  118 |  61 |  57 |
| `memory_finalize_time_ms` |  5.50 |  11 |  6 |  5 |
| `stark_prove_excluding_trace_time_ms` |  448.50 |  897 |  484 |  413 |
| `main_trace_commit_time_ms` |  83 |  166 |  91 |  75 |
| `generate_perm_trace_time_ms` |  32.50 |  65 |  37 |  28 |
| `perm_trace_commit_time_ms` |  122.61 |  245.22 |  138.48 |  106.74 |
| `quotient_poly_compute_time_ms` |  92.19 |  184.39 |  104.50 |  79.89 |
| `quotient_poly_commit_time_ms` |  22.58 |  45.15 |  25.38 |  19.78 |
| `pcs_opening_time_ms ` |  92.50 |  185 |  100 |  85 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program |  | 433 |  | 1 | 9 | 1,500,209 | 160.54 | 0 | 
| leaf | 1,295 |  | 1 | 1 |  |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 61 | 745 | 17,887,054 | 252,878,314 | 61 | 484 | 0 | 104.50 | 25.38 | 4 | 138.48 | 85 | 176 | 84 | 5 | 91 | 6,608,072 | 37 | 199 | 1,229,687 | 6.96 | 26 | 130 | 0 | 84 | 
| leaf | 1 | 57 | 1,294 | 17,250,234 | 207,789,546 | 57 | 413 | 0 | 79.89 | 19.78 | 4 | 106.74 | 100 | 136 | 100 | 6 | 75 | 6,343,052 | 28 | 823 | 1,151,179 | 6.81 | 22 | 100 | 0 | 100 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 188 | 614 | 9,677,708 | 84,395,212 | 188 | 225 | 0 | 34.56 | 12.19 | 4 | 42.85 | 70 | 74 | 70 | 0 | 33 | 1,035,986 | 31 | 31 | 873,000 | 40.05 | 14 | 47 | 0 | 70 | 
| fibonacci_program | 1 | 196 | 433 | 9,708,170 | 74,305,770 | 196 | 174 | 1 | 29.52 | 11.43 | 4 | 38.44 | 43 | 60 | 43 | 0 | 28 | 1,064,416 | 21 | 21 | 627,209 | 40.18 | 11 | 41 | 0 | 43 | 

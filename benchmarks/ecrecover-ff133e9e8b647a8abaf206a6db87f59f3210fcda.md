...
| `pcs_opening_time_ms ` |  677 |  677 |  677 |  677 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  13,266 |  13,266 |  13,266 |  13,266 |
| `main_cells_used     ` |  133,785,545 |  133,785,545 |  133,785,545 |  133,785,545 |
| `total_cycles        ` |  2,253,289 |  2,253,289 |  2,253,289 |  2,253,289 |
| `execute_time_ms     ` |  717 |  717 |  717 |  717 |
| `trace_gen_time_ms   ` |  1,725 |  1,725 |  1,725 |  1,725 |
| `stark_prove_excluding_trace_time_ms` |  10,824 |  10,824 |  10,824 |  10,824 |
| `main_trace_commit_time_ms` |  2,317 |  2,317 |  2,317 |  2,317 |
| `generate_perm_trace_time_ms` |  316 |  316 |  316 |  316 |
| `perm_trace_commit_time_ms` |  2,319 |  2,319 |  2,319 |  2,319 |
| `quotient_poly_compute_time_ms` |  1,653 |  1,653 |  1,653 |  1,653 |
| `quotient_poly_commit_time_ms` |  1,977 |  1,977 |  1,977 |  1,977 |
| `pcs_opening_time_ms ` |  2,237 |  2,237 |  2,237 |  2,237 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,725 | 13,266 | 2,253,289 | 377,489,890 | 10,824 | 1,653 | 1,977 | 2,319 | 2,237 | 2,317 | 133,785,545 | 316 | 717 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 184 | 2,496 | 295,181 | 38,665,477 | 2,163 | 230 | 477 | 350 | 677 | 379 | 15,586,346 | 37 | 149 | 

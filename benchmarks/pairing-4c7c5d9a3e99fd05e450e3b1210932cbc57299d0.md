...
|:---|---:|---:|---:|
| Total |  4.64 |  2.78 | 2.78 |
| pairing |  1.61 |  0.97 |  0.97 |
| leaf |  3.04 |  1.81 |  1.81 |
...
| `total_proof_time_ms ` |  772 |  1,544 |  902 |  642 |
...
| `execute_metered_insn_mi/s` |  27.50 | -          |  27.50 |  27.50 |
| `execute_preflight_insns` |  872,871 |  1,745,742 |  1,149,000 |  596,742 |
| `execute_preflight_time_ms` |  83.50 |  167 |  106 |  61 |
| `execute_preflight_insn_mi/s` |  14.60 | -          |  17.99 |  11.21 |
| `trace_gen_time_ms   ` |  187.50 |  375 |  193 |  182 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  394.50 |  789 |  444 |  345 |
| `main_trace_commit_time_ms` |  65 |  130 |  76 |  54 |
| `generate_perm_trace_time_ms` |  39 |  78 |  40 |  38 |
| `perm_trace_commit_time_ms` |  78.61 |  157.22 |  90.100 |  66.22 |
| `quotient_poly_compute_time_ms` |  84.01 |  168.02 |  92.37 |  75.65 |
| `quotient_poly_commit_time_ms` |  17.56 |  35.12 |  19.20 |  15.92 |
| `pcs_opening_time_ms ` |  104.50 |  209 |  122 |  87 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,517.50 |  3,035 |  1,811 |  1,224 |
| `main_cells_used     ` |  16,200,472 |  32,400,944 |  16,332,746 |  16,068,198 |
| `total_cells_used    ` |  39,332,920 |  78,665,840 |  39,650,868 |  39,014,972 |
| `execute_preflight_insns` |  1,952,436.50 |  3,904,873 |  1,991,952 |  1,912,921 |
| `execute_preflight_time_ms` |  603 |  1,206 |  908 |  298 |
| `execute_preflight_insn_mi/s` |  7.57 | -          |  7.59 |  7.56 |
| `trace_gen_time_ms   ` |  125 |  250 |  128 |  122 |
| `memory_finalize_time_ms` |  12 |  24 |  12 |  12 |
| `stark_prove_excluding_trace_time_ms` |  788.50 |  1,577 |  797 |  780 |
| `main_trace_commit_time_ms` |  148 |  296 |  152 |  144 |
| `generate_perm_trace_time_ms` |  65.50 |  131 |  74 |  57 |
| `perm_trace_commit_time_ms` |  230.17 |  460.35 |  234.16 |  226.19 |
| `quotient_poly_compute_time_ms` |  178.17 |  356.33 |  180.81 |  175.52 |
| `quotient_poly_commit_time_ms` |  33.95 |  67.90 |  35.71 |  32.19 |
| `pcs_opening_time_ms ` |  129.50 |  259 |  142 |  117 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 1,813 |  | 1 | 1 |  |  |  |  | 
| pairing |  | 642 |  | 1 | 63 | 1,745,742 | 27.50 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 128 | 1,224 | 39,650,868 | 410,701,290 | 128 | 797 | 0 | 180.81 | 35.71 | 4 | 234.16 | 117 | 309 | 116 | 12 | 152 | 16,332,746 | 74 | 298 | 1,991,952 | 7.59 | 39 | 218 | 0 | 116 | 
| leaf | 1 | 122 | 1,811 | 39,014,972 | 396,840,426 | 122 | 780 | 0 | 175.52 | 32.19 | 4 | 226.19 | 142 | 284 | 142 | 12 | 144 | 16,068,198 | 57 | 908 | 1,912,921 | 7.56 | 38 | 209 | 0 | 142 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 182 | 902 | 32,480,114 | 172,558,444 | 182 | 444 | 0 | 92.37 | 19.20 | 6 | 90.100 | 122 | 132 | 122 | 1 | 76 | 15,909,408 | 38 | 106 | 1,149,000 | 11.21 | 27 | 112 | 1 | 122 | 
| pairing | 1 | 193 | 642 | 22,464,232 | 119,958,502 | 193 | 345 | 1 | 75.65 | 15.92 | 6 | 66.22 | 87 | 110 | 87 | 0 | 54 | 9,498,894 | 40 | 61 | 596,742 | 17.99 | 21 | 92 | 1 | 87 | 

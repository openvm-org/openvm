...
| `total_proof_time_ms ` |  889.50 |  1,779 |  1,018 |  761 |
...
| `execute_metered_insn_mi/s` |  20.66 | -          |  20.66 |  20.66 |
| `execute_preflight_insns` |  941,469.50 |  1,882,939 |  1,143,000 |  739,939 |
| `execute_preflight_time_ms` |  101.50 |  203 |  127 |  76 |
| `execute_preflight_insn_mi/s` |  13.90 | -          |  18.58 |  9.22 |
| `trace_gen_time_ms   ` |  188.50 |  377 |  204 |  173 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  504.50 |  1,009 |  570 |  439 |
| `main_trace_commit_time_ms` |  69 |  138 |  77 |  61 |
| `generate_perm_trace_time_ms` |  63.50 |  127 |  84 |  43 |
| `perm_trace_commit_time_ms` |  82.73 |  165.46 |  91.84 |  73.62 |
| `quotient_poly_compute_time_ms` |  97.89 |  195.78 |  103.99 |  91.79 |
| `quotient_poly_commit_time_ms` |  18.50 |  37 |  19.99 |  17.01 |
| `pcs_opening_time_ms ` |  168.50 |  337 |  189 |  148 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,961 |  3,922 |  2,264 |  1,658 |
| `main_cells_used     ` |  16,200,472 |  32,400,944 |  16,332,746 |  16,068,198 |
| `total_cells_used    ` |  39,332,920 |  78,665,840 |  39,650,868 |  39,014,972 |
| `execute_preflight_insns` |  1,952,436 |  3,904,872 |  1,991,861 |  1,913,011 |
| `execute_preflight_time_ms` |  594.50 |  1,189 |  898 |  291 |
| `execute_preflight_insn_mi/s` |  7.73 | -          |  7.75 |  7.71 |
| `trace_gen_time_ms   ` |  121 |  242 |  126 |  116 |
| `memory_finalize_time_ms` |  11.50 |  23 |  12 |  11 |
| `stark_prove_excluding_trace_time_ms` |  1,244.50 |  2,489 |  1,249 |  1,240 |
| `main_trace_commit_time_ms` |  156.50 |  313 |  160 |  153 |
| `generate_perm_trace_time_ms` |  66 |  132 |  71 |  61 |
| `perm_trace_commit_time_ms` |  241.58 |  483.16 |  246.37 |  236.79 |
| `quotient_poly_compute_time_ms` |  164.35 |  328.70 |  166.87 |  161.83 |
| `quotient_poly_commit_time_ms` |  37.21 |  74.43 |  37.87 |  36.55 |
| `pcs_opening_time_ms ` |  575 |  1,150 |  596 |  554 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 2,266 |  | 1 |  | 1 |  |  |  |  | 
| pairing |  | 761 |  | 65 | 1 | 91 | 1,882,939 | 20.66 | 172 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 126 | 1,658 | 39,650,868 | 410,701,290 | 126 | 1,240 | 0 | 166.87 | 37.87 | 4 | 246.37 | 554 | 318 | 554 | 12 | 160 | 16,332,746 | 71 | 291 | 1,991,861 | 7.75 | 38 | 206 | 1 | 554 | 
| leaf | 1 | 116 | 2,264 | 39,014,972 | 396,840,426 | 116 | 1,249 | 0 | 161.83 | 36.55 | 4 | 236.79 | 596 | 298 | 596 | 11 | 153 | 16,068,198 | 61 | 898 | 1,913,011 | 7.71 | 36 | 199 | 1 | 596 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 173 | 1,018 | 31,041,944 | 160,949,612 | 173 | 570 | 0 | 103.99 | 19.99 | 6 | 91.84 | 189 | 178 | 189 | 1 | 77 | 15,014,446 | 84 | 127 | 1,143,000 | 9.22 | 24 | 124 | 3 | 189 | 
| pairing | 1 | 204 | 761 | 24,485,078 | 124,079,782 | 204 | 439 | 1 | 91.79 | 17.01 | 6 | 73.62 | 148 | 120 | 148 | 0 | 61 | 10,833,316 | 43 | 76 | 739,939 | 18.58 | 19 | 109 | 2 | 148 | 

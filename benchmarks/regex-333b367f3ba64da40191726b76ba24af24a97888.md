...
| `total_proof_time_ms ` |  6,989 |  13,978 |  7,867 |  6,111 |
...
| `trace_gen_time_ms   ` |  1,267 |  2,534 |  1,306 |  1,228 |
| `stark_prove_excluding_trace_time_ms` |  5,331.50 |  10,663 |  6,086 |  4,577 |
| `main_trace_commit_time_ms` |  1,156 |  2,312 |  1,324 |  988 |
| `generate_perm_trace_time_ms` |  175.50 |  351 |  194 |  157 |
| `perm_trace_commit_time_ms` |  1,040 |  2,080 |  1,189 |  891 |
| `quotient_poly_compute_time_ms` |  750.50 |  1,501 |  882 |  619 |
| `quotient_poly_commit_time_ms` |  926 |  1,852 |  1,068 |  784 |
| `pcs_opening_time_ms ` |  1,272.50 |  2,545 |  1,419 |  1,126 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  8,415 |  16,830 |  8,418 |  8,412 |
| `main_cells_used     ` |  86,869,572.50 |  173,739,145 |  88,129,714 |  85,609,431 |
| `total_cycles        ` |  1,451,198 |  2,902,396 |  1,475,911 |  1,426,485 |
| `execute_time_ms     ` |  445 |  890 |  497 |  393 |
| `trace_gen_time_ms   ` |  1,272.50 |  2,545 |  1,347 |  1,198 |
| `stark_prove_excluding_trace_time_ms` |  6,697.50 |  13,395 |  6,723 |  6,672 |
| `main_trace_commit_time_ms` |  1,338 |  2,676 |  1,338 |  1,338 |
| `generate_perm_trace_time_ms` |  186.50 |  373 |  189 |  184 |
| `perm_trace_commit_time_ms` |  1,338 |  2,676 |  1,343 |  1,333 |
| `quotient_poly_compute_time_ms` |  1,083 |  2,166 |  1,094 |  1,072 |
| `quotient_poly_commit_time_ms` |  1,342.50 |  2,685 |  1,346 |  1,339 |
| `pcs_opening_time_ms ` |  1,405 |  2,810 |  1,431 |  1,379 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,198 | 8,418 | 1,475,911 | 225,774,050 | 6,723 | 1,094 | 1,339 | 1,333 | 1,431 | 1,338 | 88,129,714 | 184 | 497 | 
| leaf | 1 | 1,347 | 8,412 | 1,426,485 | 225,774,050 | 6,672 | 1,072 | 1,346 | 1,343 | 1,379 | 1,338 | 85,609,431 | 189 | 393 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,306 | 7,867 | 2,225,434 | 210,931,487 | 6,086 | 882 | 1,068 | 1,189 | 1,419 | 1,324 | 93,699,990 | 194 | 475 | 
| regex_program | 1 | 1,228 | 6,111 | 1,914,730 | 150,470,512 | 4,577 | 619 | 784 | 891 | 1,126 | 988 | 73,689,460 | 157 | 306 | 

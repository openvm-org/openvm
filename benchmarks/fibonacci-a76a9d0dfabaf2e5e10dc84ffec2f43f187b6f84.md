...
| `total_proof_time_ms ` |  498.50 |  997 |  556 |  441 |
...
| `execute_metered_insn_mi/s` |  146.46 | -          |  146.46 |  146.46 |
| `execute_preflight_insns` |  750,104.50 |  1,500,209 |  873,000 |  627,209 |
| `execute_preflight_time_ms` |  31 |  62 |  35 |  27 |
| `execute_preflight_insn_mi/s` |  34.99 | -          |  36.83 |  33.14 |
| `trace_gen_time_ms   ` |  187.50 |  375 |  192 |  183 |
| `memory_finalize_time_ms` | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  187 |  374 |  192 |  182 |
| `main_trace_commit_time_ms` |  30.50 |  61 |  33 |  28 |
| `generate_perm_trace_time_ms` |  32.50 |  65 |  38 |  27 |
| `perm_trace_commit_time_ms` |  40.59 |  81.17 |  43.08 |  38.09 |
| `quotient_poly_compute_time_ms` |  30.74 |  61.47 |  34.14 |  27.34 |
| `quotient_poly_commit_time_ms` |  11.64 |  23.28 |  12.10 |  11.18 |
| `pcs_opening_time_ms ` |  38.50 |  77 |  40 |  37 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,001.50 |  2,003 |  1,264 |  739 |
| `main_cells_used     ` |  6,475,562 |  12,951,124 |  6,608,072 |  6,343,052 |
| `total_cells_used    ` |  17,568,644 |  35,137,288 |  17,887,054 |  17,250,234 |
| `execute_preflight_insns` |  1,190,397.50 |  2,380,795 |  1,229,581 |  1,151,214 |
| `execute_preflight_time_ms` |  520 |  1,040 |  831 |  209 |
| `execute_preflight_insn_mi/s` |  6.46 | -          |  6.57 |  6.34 |
| `trace_gen_time_ms   ` |  59.50 |  119 |  65 |  54 |
| `memory_finalize_time_ms` |  5 |  10 |  5 |  5 |
| `stark_prove_excluding_trace_time_ms` |  420.50 |  841 |  464 |  377 |
| `main_trace_commit_time_ms` |  82.50 |  165 |  90 |  75 |
| `generate_perm_trace_time_ms` |  30 |  60 |  33 |  27 |
| `perm_trace_commit_time_ms` |  124.26 |  248.52 |  141.79 |  106.74 |
| `quotient_poly_compute_time_ms` |  89.97 |  179.94 |  99.84 |  80.10 |
| `quotient_poly_commit_time_ms` |  21.28 |  42.55 |  23.35 |  19.20 |
| `pcs_opening_time_ms ` |  69.50 |  139 |  73 |  66 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program |  | 441 |  | 41 | 1 | 10 | 1,500,209 | 146.46 | 141 | 
| leaf | 1,265 |  | 1 |  | 1 |  |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 65 | 739 | 17,887,054 | 252,878,314 | 65 | 464 | 0 | 99.84 | 23.35 | 4 | 141.79 | 73 | 175 | 73 | 5 | 90 | 6,608,072 | 33 | 209 | 1,229,581 | 6.57 | 25 | 124 | 0 | 73 | 
| leaf | 1 | 54 | 1,264 | 17,250,234 | 207,789,546 | 54 | 377 | 0 | 80.10 | 19.20 | 5 | 106.74 | 66 | 134 | 65 | 5 | 75 | 6,343,052 | 27 | 831 | 1,151,214 | 6.34 | 22 | 100 | 0 | 65 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 192 | 556 | 9,677,708 | 84,395,212 | 192 | 192 | 0 | 34.14 | 12.10 | 4 | 43.08 | 40 | 71 | 40 | 0 | 33 | 1,035,986 | 27 | 27 | 873,000 | 33.14 | 13 | 46 | 0 | 40 | 
| fibonacci_program | 1 | 183 | 441 | 9,708,170 | 74,305,770 | 183 | 182 | 1 | 27.34 | 11.18 | 4 | 38.09 | 37 | 76 | 37 | 0 | 28 | 1,064,416 | 38 | 35 | 627,209 | 36.83 | 11 | 38 | 0 | 37 | 

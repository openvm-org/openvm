...
|:---|---:|---:|---:|
| Total |  4.52 |  2.70 | 2.70 |
| pairing |  1.54 |  0.91 |  0.91 |
| leaf |  2.98 |  1.79 |  1.79 |
...
| `total_proof_time_ms ` |  741 |  1,482 |  851 |  631 |
...
| `execute_preflight_time_ms` |  85 |  170 |  106 |  64 |
| `execute_preflight_insn_mi/s` |  14.62 | -          |  18.03 |  11.21 |
| `trace_gen_time_ms   ` |  182.50 |  365 |  186 |  179 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  368 |  736 |  397 |  339 |
| `main_trace_commit_time_ms` |  64.50 |  129 |  74 |  55 |
| `generate_perm_trace_time_ms` |  38.50 |  77 |  39 |  38 |
| `perm_trace_commit_time_ms` |  76 |  152 |  88.26 |  63.74 |
| `quotient_poly_compute_time_ms` |  81.52 |  163.04 |  89.80 |  73.24 |
| `quotient_poly_commit_time_ms` |  17.38 |  34.76 |  19.12 |  15.64 |
| `pcs_opening_time_ms ` |  85.50 |  171 |  88 |  83 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,489.50 |  2,979 |  1,789 |  1,190 |
| `main_cells_used     ` |  16,200,472 |  32,400,944 |  16,332,746 |  16,068,198 |
| `total_cells_used    ` |  39,332,920 |  78,665,840 |  39,650,868 |  39,014,972 |
| `execute_preflight_insns` |  1,952,424 |  3,904,848 |  1,991,927 |  1,912,921 |
| `execute_preflight_time_ms` |  623 |  1,246 |  943 |  303 |
| `execute_preflight_insn_mi/s` |  7.54 | -          |  7.54 |  7.53 |
| `trace_gen_time_ms   ` |  120 |  240 |  128 |  112 |
| `memory_finalize_time_ms` |  12.50 |  25 |  13 |  12 |
| `stark_prove_excluding_trace_time_ms` |  745 |  1,490 |  758 |  732 |
| `main_trace_commit_time_ms` |  145.50 |  291 |  150 |  141 |
| `generate_perm_trace_time_ms` |  56 |  112 |  57 |  55 |
| `perm_trace_commit_time_ms` |  227.35 |  454.70 |  231.64 |  223.06 |
| `quotient_poly_compute_time_ms` |  173.20 |  346.41 |  175.13 |  171.28 |
| `quotient_poly_commit_time_ms` |  33.08 |  66.15 |  33.68 |  32.47 |
| `pcs_opening_time_ms ` |  106 |  212 |  106 |  106 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 1,791 |  | 1 | 1 |  |  |  |  | 
| pairing |  | 631 |  | 1 | 63 | 1,745,742 | 27.37 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 128 | 1,190 | 39,650,868 | 410,701,290 | 128 | 758 | 0 | 175.13 | 33.68 | 4 | 231.64 | 106 | 290 | 106 | 13 | 150 | 16,332,746 | 57 | 303 | 1,991,927 | 7.54 | 39 | 210 | 0 | 106 | 
| leaf | 1 | 112 | 1,789 | 39,014,972 | 396,840,426 | 112 | 732 | 0 | 171.28 | 32.47 | 4 | 223.06 | 106 | 279 | 105 | 12 | 141 | 16,068,198 | 55 | 943 | 1,912,921 | 7.53 | 38 | 205 | 0 | 105 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 179 | 851 | 32,480,114 | 172,558,444 | 179 | 397 | 0 | 89.80 | 19.12 | 6 | 88.26 | 83 | 129 | 83 | 1 | 74 | 15,909,408 | 38 | 106 | 1,149,000 | 11.21 | 27 | 109 | 1 | 83 | 
| pairing | 1 | 186 | 631 | 22,464,232 | 119,958,502 | 186 | 339 | 1 | 73.24 | 15.64 | 6 | 63.74 | 88 | 106 | 87 | 0 | 55 | 9,498,894 | 39 | 64 | 596,742 | 18.03 | 21 | 89 | 1 | 87 | 

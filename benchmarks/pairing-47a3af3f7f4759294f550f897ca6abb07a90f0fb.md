...
| `total_proof_time_ms ` |  705.50 |  1,411 |  820 |  591 |
...
| `execute_preflight_insn_mi/s` |  14.46 | -          |  18.14 |  10.77 |
| `trace_gen_time_ms   ` |  184.50 |  369 |  191 |  178 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  342 |  684 |  387 |  297 |
| `main_trace_commit_time_ms` |  64 |  128 |  74 |  54 |
| `generate_perm_trace_time_ms` |  35 |  70 |  40 |  30 |
| `perm_trace_commit_time_ms` |  75.49 |  150.99 |  87.75 |  63.23 |
| `quotient_poly_compute_time_ms` |  78.76 |  157.51 |  87.05 |  70.47 |
| `quotient_poly_commit_time_ms` |  16.28 |  32.57 |  17.92 |  14.65 |
| `pcs_opening_time_ms ` |  67.50 |  135 |  76 |  59 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,461.50 |  2,923 |  1,729 |  1,194 |
| `main_cells_used     ` |  16,200,472 |  32,400,944 |  16,332,746 |  16,068,198 |
| `total_cells_used    ` |  39,332,920 |  78,665,840 |  39,650,868 |  39,014,972 |
| `execute_preflight_insns` |  1,952,394.50 |  3,904,789 |  1,991,936 |  1,912,853 |
| `execute_preflight_time_ms` |  591 |  1,182 |  886 |  296 |
| `execute_preflight_insn_mi/s` |  7.59 | -          |  7.63 |  7.56 |
| `trace_gen_time_ms   ` |  117 |  234 |  125 |  109 |
| `memory_finalize_time_ms` |  10.50 |  21 |  11 |  10 |
| `stark_prove_excluding_trace_time_ms` |  751.50 |  1,503 |  772 |  731 |
| `main_trace_commit_time_ms` |  146 |  292 |  150 |  142 |
| `generate_perm_trace_time_ms` |  54 |  108 |  54 |  54 |
| `perm_trace_commit_time_ms` |  226.69 |  453.37 |  231.49 |  221.89 |
| `quotient_poly_compute_time_ms` |  165.73 |  331.46 |  167.47 |  163.99 |
| `quotient_poly_commit_time_ms` |  31.21 |  62.42 |  33.23 |  29.19 |
| `pcs_opening_time_ms ` |  125.50 |  251 |  133 |  118 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 1,731 |  | 1 | 1 |  |  |  |  | 
| pairing |  | 591 |  | 1 | 70 | 1,745,742 | 24.86 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 125 | 1,194 | 39,650,868 | 410,701,290 | 125 | 772 | 0 | 167.47 | 33.23 | 4 | 231.49 | 133 | 286 | 132 | 11 | 150 | 16,332,746 | 54 | 296 | 1,991,936 | 7.63 | 39 | 202 | 0 | 132 | 
| leaf | 1 | 109 | 1,729 | 39,014,972 | 396,840,426 | 109 | 731 | 0 | 163.99 | 29.19 | 5 | 221.89 | 118 | 276 | 118 | 10 | 142 | 16,068,198 | 54 | 886 | 1,912,853 | 7.56 | 37 | 194 | 0 | 118 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 178 | 820 | 32,480,114 | 172,558,444 | 178 | 387 | 0 | 87.05 | 17.92 | 6 | 87.75 | 76 | 130 | 76 | 1 | 74 | 15,909,408 | 40 | 110 | 1,149,000 | 10.77 | 26 | 105 | 1 | 76 | 
| pairing | 1 | 191 | 591 | 22,464,232 | 119,958,502 | 191 | 297 | 1 | 70.47 | 14.65 | 6 | 63.23 | 59 | 96 | 59 | 0 | 54 | 9,498,894 | 30 | 61 | 596,742 | 18.14 | 21 | 85 | 1 | 59 | 

...
| `stark_prove_excluding_trace_time_ms` |  1,106 |  1,106 |  1,106 |  1,106 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  12,809 |  12,809 |  12,809 |  12,809 |
| `main_cells_used     ` |  244,252,966 |  244,252,966 |  244,252,966 |  244,252,966 |
| `total_cycles        ` |  2,988,580 |  2,988,580 |  2,988,580 |  2,988,580 |
| `execute_time_ms     ` |  1,107 |  1,107 |  1,107 |  1,107 |
| `trace_gen_time_ms   ` |  2,411 |  2,411 |  2,411 |  2,411 |
| `stark_prove_excluding_trace_time_ms` |  9,291 |  9,291 |  9,291 |  9,291 |
| `main_trace_commit_time_ms` |  1,580 |  1,580 |  1,580 |  1,580 |
| `generate_perm_trace_time_ms` |  763 |  763 |  763 |  763 |
| `perm_trace_commit_time_ms` |  2,972 |  2,972 |  2,972 |  2,972 |
| `quotient_poly_compute_time_ms` |  1,349 |  1,349 |  1,349 |  1,349 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 2,411 | 12,809 | 2,988,580 | 1,008,831,978 | 9,291 | 1,349 | 829 | 2,972 | 1,794 | 1,580 | 244,252,966 | 763 | 1,107 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 178 | 1,432 | 289,447 | 48,240,297 | 1,106 | 125 | 154 | 193 | 412 | 172 | 14,470,186 | 33 | 148 | 

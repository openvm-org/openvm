...
| `total_proof_time_ms ` |  1,486.50 |  2,973 |  1,724 |  1,249 |
...
| `execute_preflight_time_ms` |  99.50 |  199 |  114 |  85 |
| `execute_preflight_insn_mi/s` |  29.76 | -          |  31.22 |  28.29 |
| `trace_gen_time_ms   ` |  314.50 |  629 |  334 |  295 |
| `memory_finalize_time_ms` |  2 |  4 |  4 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  985 |  1,970 |  1,217 |  753 |
| `main_trace_commit_time_ms` |  138.50 |  277 |  180 |  97 |
| `generate_perm_trace_time_ms` |  56.50 |  113 |  65 |  48 |
| `perm_trace_commit_time_ms` |  175.57 |  351.15 |  227.92 |  123.23 |
| `quotient_poly_compute_time_ms` |  167.11 |  334.21 |  181.48 |  152.73 |
| `quotient_poly_commit_time_ms` |  36.98 |  73.95 |  48.02 |  25.94 |
| `pcs_opening_time_ms ` |  402.50 |  805 |  538 |  267 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  2,101 |  4,202 |  2,901 |  1,301 |
| `main_cells_used     ` |  14,798,849 |  29,597,698 |  20,272,474 |  9,325,224 |
| `total_cells_used    ` |  37,032,585 |  74,065,170 |  50,586,080 |  23,479,090 |
| `execute_preflight_insns` |  1,663,344 |  3,326,688 |  1,830,065 |  1,496,623 |
| `execute_preflight_time_ms` |  595 |  1,190 |  923 |  267 |
| `execute_preflight_insn_mi/s` |  6.99 | -          |  7.23 |  6.75 |
| `trace_gen_time_ms   ` |  123 |  246 |  170 |  76 |
| `memory_finalize_time_ms` |  12 |  24 |  18 |  6 |
| `stark_prove_excluding_trace_time_ms` |  1,382 |  2,764 |  1,807 |  957 |
| `main_trace_commit_time_ms` |  183 |  366 |  232 |  134 |
| `generate_perm_trace_time_ms` |  79 |  158 |  106 |  52 |
| `perm_trace_commit_time_ms` |  280.83 |  561.66 |  372.52 |  189.14 |
| `quotient_poly_compute_time_ms` |  181.40 |  362.80 |  235.76 |  127.04 |
| `quotient_poly_commit_time_ms` |  45.45 |  90.91 |  59.07 |  31.84 |
| `pcs_opening_time_ms ` |  607.50 |  1,215 |  796 |  419 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 2,903 |  | 1 |  | 1 |  |  |  |  | 
| regex_program |  | 1,249 |  | 41 | 1 | 45 | 4,108,483 | 90.37 | 168 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 76 | 1,301 | 23,479,090 | 319,626,730 | 76 | 957 | 0 | 127.04 | 31.84 | 4 | 189.14 | 419 | 242 | 419 | 6 | 134 | 9,325,224 | 52 | 267 | 1,496,623 | 7.23 | 29 | 160 | 1 | 419 | 
| leaf | 1 | 170 | 2,901 | 50,586,080 | 538,660,330 | 170 | 1,807 | 0 | 235.76 | 59.07 | 4 | 372.52 | 796 | 480 | 796 | 18 | 232 | 20,272,474 | 106 | 923 | 1,830,065 | 6.75 | 56 | 297 | 1 | 796 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 295 | 1,724 | 23,397,108 | 373,183,036 | 295 | 1,217 | 0 | 152.73 | 48.02 | 6 | 227.92 | 538 | 294 | 538 | 4 | 180 | 10,866,434 | 65 | 85 | 2,211,000 | 28.29 | 47 | 202 | 2 | 538 | 
| regex_program | 1 | 334 | 1,249 | 11,981,356 | 196,739,722 | 334 | 753 | 2 | 181.48 | 25.94 | 5 | 123.23 | 267 | 175 | 267 | 0 | 97 | 2,537,170 | 48 | 114 | 1,897,483 | 31.22 | 26 | 212 | 2 | 267 | 

...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  18,343 |  18,343 |  18,343 |  18,343 |
| `main_cells_used     ` |  193,313,067 |  193,313,067 |  193,313,067 |  193,313,067 |
...
| `stark_prove_excluding_trace_time_ms` |  13,921 |  13,921 |  13,921 |  13,921 |
| `main_trace_commit_time_ms` |  2,918 |  2,918 |  2,918 |  2,918 |
| `generate_perm_trace_time_ms` |  351 |  351 |  351 |  351 |
| `perm_trace_commit_time_ms` |  2,921 |  2,921 |  2,921 |  2,921 |
| `quotient_poly_compute_time_ms` |  2,088 |  2,088 |  2,088 |  2,088 |
| `quotient_poly_commit_time_ms` |  2,649 |  2,649 |  2,649 |  2,649 |
| `pcs_opening_time_ms ` |  2,991 |  2,991 |  2,991 |  2,991 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 3,490 | 18,343 | 4,157,698 | 466,306,008 | 13,921 | 2,088 | 2,649 | 2,921 | 2,991 | 2,918 | 193,313,067 | 351 | 932 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 257 | 2,558 | 284,567 | 38,417,467 | 2,152 | 233 | 468 | 350 | 659 | 396 | 15,055,723 | 32 | 149 | 

...
| `main_trace_commit_time_ms` |  604 |  604 |  604 |  604 |
...
| `pcs_opening_time_ms ` |  820 |  820 |  820 |  820 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  14,066 |  14,066 |  14,066 |  14,066 |
| `main_cells_used     ` |  275,729,704 |  275,729,704 |  275,729,704 |  275,729,704 |
| `total_cycles        ` |  3,305,900 |  3,305,900 |  3,305,900 |  3,305,900 |
| `execute_time_ms     ` |  1,208 |  1,208 |  1,208 |  1,208 |
| `trace_gen_time_ms   ` |  2,574 |  2,574 |  2,574 |  2,574 |
| `stark_prove_excluding_trace_time_ms` |  10,284 |  10,284 |  10,284 |  10,284 |
| `main_trace_commit_time_ms` |  1,777 |  1,777 |  1,777 |  1,777 |
| `generate_perm_trace_time_ms` |  725 |  725 |  725 |  725 |
| `perm_trace_commit_time_ms` |  3,364 |  3,364 |  3,364 |  3,364 |
| `quotient_poly_compute_time_ms` |  1,472 |  1,472 |  1,472 |  1,472 |
| `quotient_poly_commit_time_ms` |  970 |  970 |  970 |  970 |
| `pcs_opening_time_ms ` |  1,970 |  1,970 |  1,970 |  1,970 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 2,574 | 14,066 | 3,305,900 | 1,071,746,538 | 10,284 | 1,472 | 970 | 3,364 | 1,970 | 1,777 | 275,729,704 | 725 | 1,208 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 897 | 4,785 | 1,711,640 | 297,389,207 | 3,220 | 467 | 332 | 778 | 820 | 604 | 92,620,923 | 198 | 668 | 

...
| `total_proof_time_ms ` |  4,136 |  8,272 |  4,601 |  3,671 |
| `main_cells_used     ` |  84,263,708 |  168,527,416 |  94,508,931 |  74,018,485 |
| `total_cycles        ` |  2,082,613 |  4,165,226 |  2,243,715 |  1,921,511 |
| `execute_time_ms     ` |  339 |  678 |  376 |  302 |
| `trace_gen_time_ms   ` |  955 |  1,910 |  1,160 |  750 |
| `stark_prove_excluding_trace_time_ms` |  2,842 |  5,684 |  3,065 |  2,619 |
| `main_trace_commit_time_ms` |  519.50 |  1,039 |  581 |  458 |
| `generate_perm_trace_time_ms` |  195 |  390 |  195 |  195 |
| `perm_trace_commit_time_ms` |  748.50 |  1,497 |  805 |  692 |
| `quotient_poly_compute_time_ms` |  396 |  792 |  425 |  367 |
| `quotient_poly_commit_time_ms` |  295.50 |  591 |  333 |  258 |
| `pcs_opening_time_ms ` |  678.50 |  1,357 |  716 |  641 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,547.50 |  15,095 |  7,643 |  7,452 |
| `main_cells_used     ` |  152,769,632 |  305,539,264 |  155,169,131 |  150,370,133 |
| `total_cycles        ` |  1,991,024.50 |  3,982,049 |  2,021,822 |  1,960,227 |
| `execute_time_ms     ` |  767.50 |  1,535 |  774 |  761 |
| `trace_gen_time_ms   ` |  1,481.50 |  2,963 |  1,501 |  1,462 |
| `stark_prove_excluding_trace_time_ms` |  5,298.50 |  10,597 |  5,368 |  5,229 |
| `main_trace_commit_time_ms` |  895.50 |  1,791 |  897 |  894 |
| `generate_perm_trace_time_ms` |  379.50 |  759 |  400 |  359 |
| `perm_trace_commit_time_ms` |  1,669 |  3,338 |  1,710 |  1,628 |
| `quotient_poly_compute_time_ms` |  772 |  1,544 |  776 |  768 |
| `quotient_poly_commit_time_ms` |  522 |  1,044 |  525 |  519 |
| `pcs_opening_time_ms ` |  1,054.50 |  2,109 |  1,056 |  1,053 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,501 | 7,643 | 2,021,822 | 538,660,330 | 5,368 | 776 | 525 | 1,710 | 1,056 | 897 | 155,169,131 | 400 | 774 | 
| leaf | 1 | 1,462 | 7,452 | 1,960,227 | 538,660,330 | 5,229 | 768 | 519 | 1,628 | 1,053 | 894 | 150,370,133 | 359 | 761 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,160 | 4,601 | 2,243,715 | 275,652,919 | 3,065 | 425 | 333 | 805 | 716 | 581 | 94,508,931 | 195 | 376 | 
| regex_program | 1 | 750 | 3,671 | 1,921,511 | 242,975,404 | 2,619 | 367 | 258 | 692 | 641 | 458 | 74,018,485 | 195 | 302 | 

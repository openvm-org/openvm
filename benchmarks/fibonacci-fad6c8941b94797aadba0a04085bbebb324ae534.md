...
| `total_proof_time_ms ` |  4,966 |  4,966 |  4,966 |  4,966 |
| `main_cells_used     ` |  51,485,167 |  51,485,167 |  51,485,167 |  51,485,167 |
| `total_cycles        ` |  1,500,096 |  1,500,096 |  1,500,096 |  1,500,096 |
| `execute_time_ms     ` |  289 |  289 |  289 |  289 |
| `trace_gen_time_ms   ` |  619 |  619 |  619 |  619 |
| `stark_prove_excluding_trace_time_ms` |  4,058 |  4,058 |  4,058 |  4,058 |
...
| `main_cells_used     ` |  38,847,448 |  38,847,448 |  38,847,448 |  38,847,448 |
| `total_cycles        ` |  815,574 |  815,574 |  815,574 |  815,574 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 636 | 4,162 | 815,574 | 95,033,826 | 3,257 | 475 | 674 | 630 | 736 | 647 | 38,847,448 | 84 | 269 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 619 | 4,966 | 1,500,096 | 122,458,688 | 4,058 | 515 | 763 | 794 | 989 | 858 | 51,485,167 | 136 | 289 | 

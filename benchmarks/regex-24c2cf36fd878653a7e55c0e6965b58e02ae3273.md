...
| `total_proof_time_ms ` |  4,046 |  8,092 |  4,485 |  3,607 |
...
| `trace_gen_time_ms   ` |  973 |  1,946 |  1,160 |  786 |
| `stark_prove_excluding_trace_time_ms` |  2,737 |  5,474 |  2,952 |  2,522 |
| `main_trace_commit_time_ms` |  475.50 |  951 |  530 |  421 |
| `generate_perm_trace_time_ms` |  203.50 |  407 |  204 |  203 |
| `perm_trace_commit_time_ms` |  687.50 |  1,375 |  743 |  632 |
| `quotient_poly_compute_time_ms` |  393.50 |  787 |  426 |  361 |
| `quotient_poly_commit_time_ms` |  280.50 |  561 |  315 |  246 |
| `pcs_opening_time_ms ` |  686 |  1,372 |  727 |  645 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,265 |  14,530 |  7,375 |  7,155 |
| `main_cells_used     ` |  152,278,303 |  304,556,606 |  154,678,318 |  149,878,288 |
| `total_cycles        ` |  1,991,036.50 |  3,982,073 |  2,021,877 |  1,960,196 |
| `execute_time_ms     ` |  769.50 |  1,539 |  779 |  760 |
| `trace_gen_time_ms   ` |  1,450 |  2,900 |  1,479 |  1,421 |
| `stark_prove_excluding_trace_time_ms` |  5,045.50 |  10,091 |  5,117 |  4,974 |
| `main_trace_commit_time_ms` |  812 |  1,624 |  819 |  805 |
| `generate_perm_trace_time_ms` |  375 |  750 |  390 |  360 |
| `perm_trace_commit_time_ms` |  1,542.50 |  3,085 |  1,587 |  1,498 |
| `quotient_poly_compute_time_ms` |  765.50 |  1,531 |  772 |  759 |
| `quotient_poly_commit_time_ms` |  493 |  986 |  495 |  491 |
| `pcs_opening_time_ms ` |  1,053 |  2,106 |  1,054 |  1,052 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,479 | 7,375 | 2,021,877 | 538,660,330 | 5,117 | 772 | 491 | 1,587 | 1,054 | 819 | 154,678,318 | 390 | 779 | 
| leaf | 1 | 1,421 | 7,155 | 1,960,196 | 538,660,330 | 4,974 | 759 | 495 | 1,498 | 1,052 | 805 | 149,878,288 | 360 | 760 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,160 | 4,485 | 2,243,715 | 275,652,919 | 2,952 | 426 | 315 | 743 | 727 | 530 | 93,500,799 | 203 | 373 | 
| regex_program | 1 | 786 | 3,607 | 1,921,511 | 242,975,404 | 2,522 | 361 | 246 | 632 | 645 | 421 | 73,010,353 | 204 | 299 | 

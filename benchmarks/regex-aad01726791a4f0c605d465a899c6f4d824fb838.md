...
| `total_proof_time_ms ` |  3,764.50 |  7,529 |  4,817 |  2,712 |
...
| `execute_preflight_time_ms` |  100.50 |  201 |  108 |  93 |
| `execute_preflight_insn_mi/s` |  26.17 | -          |  28.15 |  24.19 |
| `trace_gen_time_ms   ` |  381.50 |  763 |  495 |  268 |
| `memory_finalize_time_ms` |  7.50 |  15 |  13 |  2 |
| `stark_prove_excluding_trace_time_ms` |  3,042.50 |  6,085 |  3,961 |  2,124 |
| `main_trace_commit_time_ms` |  592 |  1,184 |  797 |  387 |
| `generate_perm_trace_time_ms` |  243 |  486 |  319 |  167 |
| `perm_trace_commit_time_ms` |  608.50 |  1,217 |  797 |  420 |
| `quotient_poly_compute_time_ms` |  322.50 |  645 |  438 |  207 |
| `quotient_poly_commit_time_ms` |  286 |  572 |  377 |  195 |
| `pcs_opening_time_ms ` |  982 |  1,964 |  1,227 |  737 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  5,627 |  11,254 |  6,747 |  4,507 |
| `main_cells_used     ` |  122,270,511 |  244,541,022 |  153,709,016 |  90,832,006 |
| `total_cells_used    ` |  304,360,621 |  608,721,242 |  391,461,802 |  217,259,440 |
| `execute_preflight_insns` |  1,663,384 |  3,326,768 |  1,830,038 |  1,496,730 |
| `execute_preflight_time_ms` |  578.50 |  1,157 |  728 |  429 |
| `execute_preflight_insn_mi/s` |  4.35 | -          |  4.49 |  4.20 |
| `trace_gen_time_ms   ` |  278.50 |  557 |  344 |  213 |
| `memory_finalize_time_ms` |  12.50 |  25 |  15 |  10 |
| `stark_prove_excluding_trace_time_ms` |  3,724 |  7,448 |  4,621 |  2,827 |
| `main_trace_commit_time_ms` |  667.50 |  1,335 |  783 |  552 |
| `generate_perm_trace_time_ms` |  342 |  684 |  434 |  250 |
| `perm_trace_commit_time_ms` |  895 |  1,790 |  1,163 |  627 |
| `quotient_poly_compute_time_ms` |  445.50 |  891 |  542 |  349 |
| `quotient_poly_commit_time_ms` |  303 |  606 |  359 |  247 |
| `pcs_opening_time_ms ` |  1,065 |  2,130 |  1,334 |  796 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 6,748 |  | 1 |  | 1 |  |  |  |  | 
| regex_program |  | 2,712 |  | 6 | 1 | 33 | 4,108,597 | 121.04 | 44 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 213 | 4,507 | 217,259,440 | 319,626,730 | 213 | 2,827 | 0 | 349 | 247 | 627 | 796 | 10 | 552 | 90,832,006 | 250 | 429 | 1,496,730 | 4.20 | 
| leaf | 1 | 344 | 6,747 | 391,461,802 | 538,660,330 | 344 | 4,621 | 0 | 542 | 359 | 1,163 | 1,334 | 15 | 783 | 153,709,016 | 434 | 728 | 1,830,038 | 4.49 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 495 | 4,817 | 211,758,557 | 373,183,036 | 495 | 3,961 | 0 | 438 | 377 | 797 | 1,227 | 8 | 13 | 797 | 91,281,687 | 319 | 108 | 2,211,000 | 24.19 | 
| regex_program | 1 | 268 | 2,712 | 174,326,267 | 196,838,026 | 268 | 2,124 | 49 | 207 | 195 | 420 | 737 | 6 | 2 | 387 | 73,453,305 | 167 | 93 | 1,897,597 | 28.15 | 

...
| `total_proof_time_ms ` |  2,546 |  2,546 |  2,546 |  2,546 |
...
| `stark_prove_excluding_trace_time_ms` |  2,139 |  2,139 |  2,139 |  2,139 |
...
| `pcs_opening_time_ms ` |  650 |  650 |  650 |  650 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  18,319 |  18,319 |  18,319 |  18,319 |
| `main_cells_used     ` |  193,315,277 |  193,315,277 |  193,315,277 |  193,315,277 |
| `total_cycles        ` |  4,157,919 |  4,157,919 |  4,157,919 |  4,157,919 |
| `execute_time_ms     ` |  911 |  911 |  911 |  911 |
| `trace_gen_time_ms   ` |  3,501 |  3,501 |  3,501 |  3,501 |
| `stark_prove_excluding_trace_time_ms` |  13,907 |  13,907 |  13,907 |  13,907 |
| `main_trace_commit_time_ms` |  2,911 |  2,911 |  2,911 |  2,911 |
| `generate_perm_trace_time_ms` |  361 |  361 |  361 |  361 |
| `perm_trace_commit_time_ms` |  2,936 |  2,936 |  2,936 |  2,936 |
| `quotient_poly_compute_time_ms` |  2,072 |  2,072 |  2,072 |  2,072 |
| `quotient_poly_commit_time_ms` |  2,673 |  2,673 |  2,673 |  2,673 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 3,501 | 18,319 | 4,157,919 | 466,306,008 | 13,907 | 2,072 | 2,673 | 2,936 | 2,950 | 2,911 | 193,315,277 | 361 | 911 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 257 | 2,546 | 284,567 | 38,417,467 | 2,139 | 225 | 465 | 351 | 650 | 402 | 15,055,723 | 33 | 150 | 

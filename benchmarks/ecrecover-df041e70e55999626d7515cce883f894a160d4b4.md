...
| `total_proof_time_ms ` |  2,490 |  2,490 |  2,490 |  2,490 |
...
| `main_cells_used     ` |  133,785,028 |  133,785,028 |  133,785,028 |  133,785,028 |
| `total_cycles        ` |  2,253,251 |  2,253,251 |  2,253,251 |  2,253,251 |
| `execute_time_ms     ` |  719 |  719 |  719 |  719 |
| `trace_gen_time_ms   ` |  1,698 |  1,698 |  1,698 |  1,698 |
| `stark_prove_excluding_trace_time_ms` |  10,795 |  10,795 |  10,795 |  10,795 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,698 | 13,212 | 2,253,251 | 377,489,890 | 10,795 | 1,656 | 1,997 | 2,292 | 2,239 | 2,289 | 133,785,028 | 316 | 719 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 185 | 2,490 | 295,181 | 38,665,477 | 2,156 | 231 | 460 | 361 | 667 | 388 | 15,586,346 | 33 | 149 | 

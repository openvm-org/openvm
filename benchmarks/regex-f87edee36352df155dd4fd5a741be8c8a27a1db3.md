...
| `total_proof_time_ms ` |  6,990.50 |  13,981 |  7,878 |  6,103 |
| `main_cells_used     ` |  83,694,725 |  167,389,450 |  93,699,990 |  73,689,460 |
| `total_cycles        ` |  2,070,082 |  4,140,164 |  2,225,434 |  1,914,730 |
| `execute_time_ms     ` |  390 |  780 |  472 |  308 |
| `trace_gen_time_ms   ` |  1,267 |  2,534 |  1,305 |  1,229 |
| `stark_prove_excluding_trace_time_ms` |  5,333.50 |  10,667 |  6,101 |  4,566 |
| `main_trace_commit_time_ms` |  1,146 |  2,292 |  1,327 |  965 |
| `generate_perm_trace_time_ms` |  176 |  352 |  193 |  159 |
| `perm_trace_commit_time_ms` |  1,037.50 |  2,075 |  1,184 |  891 |
| `quotient_poly_compute_time_ms` |  748.50 |  1,497 |  876 |  621 |
| `quotient_poly_commit_time_ms` |  915.50 |  1,831 |  1,072 |  759 |
| `pcs_opening_time_ms ` |  1,301.50 |  2,603 |  1,440 |  1,163 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  8,416 |  16,832 |  8,420 |  8,412 |
| `main_cells_used     ` |  86,869,926.50 |  173,739,853 |  88,130,530 |  85,609,323 |
| `total_cycles        ` |  1,451,227.50 |  2,902,455 |  1,475,979 |  1,426,476 |
| `execute_time_ms     ` |  451 |  902 |  497 |  405 |
| `trace_gen_time_ms   ` |  1,265.50 |  2,531 |  1,342 |  1,189 |
| `stark_prove_excluding_trace_time_ms` |  6,699.50 |  13,399 |  6,734 |  6,665 |
| `main_trace_commit_time_ms` |  1,329.50 |  2,659 |  1,334 |  1,325 |
| `generate_perm_trace_time_ms` |  188 |  376 |  189 |  187 |
| `perm_trace_commit_time_ms` |  1,344.50 |  2,689 |  1,346 |  1,343 |
| `quotient_poly_compute_time_ms` |  1,090.50 |  2,181 |  1,104 |  1,077 |
| `quotient_poly_commit_time_ms` |  1,341 |  2,682 |  1,342 |  1,340 |
| `pcs_opening_time_ms ` |  1,400.50 |  2,801 |  1,425 |  1,376 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,189 | 8,420 | 1,475,979 | 225,774,050 | 6,734 | 1,104 | 1,340 | 1,346 | 1,425 | 1,325 | 88,130,530 | 187 | 497 | 
| leaf | 1 | 1,342 | 8,412 | 1,426,476 | 225,774,050 | 6,665 | 1,077 | 1,342 | 1,343 | 1,376 | 1,334 | 85,609,323 | 189 | 405 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,305 | 7,878 | 2,225,434 | 210,931,487 | 6,101 | 876 | 1,072 | 1,184 | 1,440 | 1,327 | 93,699,990 | 193 | 472 | 
| regex_program | 1 | 1,229 | 6,103 | 1,914,730 | 150,470,512 | 4,566 | 621 | 759 | 891 | 1,163 | 965 | 73,689,460 | 159 | 308 | 

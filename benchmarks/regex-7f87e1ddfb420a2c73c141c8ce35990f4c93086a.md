...
| `total_proof_time_ms ` |  3,884.50 |  7,769 |  4,480 |  3,289 |
...
| `trace_gen_time_ms   ` |  993 |  1,986 |  1,173 |  813 |
| `stark_prove_excluding_trace_time_ms` |  2,555.50 |  5,111 |  2,933 |  2,178 |
| `main_trace_commit_time_ms` |  443.50 |  887 |  521 |  366 |
| `generate_perm_trace_time_ms` |  169 |  338 |  191 |  147 |
| `perm_trace_commit_time_ms` |  647 |  1,294 |  755 |  539 |
| `quotient_poly_compute_time_ms` |  360.50 |  721 |  420 |  301 |
| `quotient_poly_commit_time_ms` |  273.50 |  547 |  321 |  226 |
| `pcs_opening_time_ms ` |  652.50 |  1,305 |  716 |  589 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,510 |  15,020 |  7,573 |  7,447 |
| `main_cells_used     ` |  152,307,145.50 |  304,614,291 |  154,765,927 |  149,848,364 |
| `total_cycles        ` |  1,993,423 |  3,986,846 |  2,024,255 |  1,962,591 |
| `execute_time_ms     ` |  762 |  1,524 |  770 |  754 |
| `trace_gen_time_ms   ` |  1,495 |  2,990 |  1,526 |  1,464 |
| `stark_prove_excluding_trace_time_ms` |  5,253 |  10,506 |  5,277 |  5,229 |
| `main_trace_commit_time_ms` |  889.50 |  1,779 |  892 |  887 |
| `generate_perm_trace_time_ms` |  353 |  706 |  366 |  340 |
| `perm_trace_commit_time_ms` |  1,661 |  3,322 |  1,685 |  1,637 |
| `quotient_poly_compute_time_ms` |  765 |  1,530 |  767 |  763 |
| `quotient_poly_commit_time_ms` |  521.50 |  1,043 |  522 |  521 |
| `pcs_opening_time_ms ` |  1,057.50 |  2,115 |  1,066 |  1,049 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,526 | 7,573 | 2,024,255 | 533,941,738 | 5,277 | 763 | 521 | 1,685 | 1,049 | 887 | 154,765,927 | 366 | 770 | 
| leaf | 1 | 1,464 | 7,447 | 1,962,591 | 533,941,738 | 5,229 | 767 | 522 | 1,637 | 1,066 | 892 | 149,848,364 | 340 | 754 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,173 | 4,480 | 2,225,434 | 275,652,919 | 2,933 | 420 | 321 | 755 | 716 | 521 | 93,699,990 | 191 | 374 | 
| regex_program | 1 | 813 | 3,289 | 1,914,730 | 198,099,628 | 2,178 | 301 | 226 | 539 | 589 | 366 | 73,689,460 | 147 | 298 | 

...
| `quotient_poly_commit_time_ms` |  321 |  321 |  321 |  321 |
| `pcs_opening_time_ms ` |  630 |  630 |  630 |  630 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  40,897 |  40,897 |  40,897 |  40,897 |
| `main_cells_used     ` |  365,931,856 |  365,931,856 |  365,931,856 |  365,931,856 |
| `total_cycles        ` |  8,657,494 |  8,657,494 |  8,657,494 |  8,657,494 |
| `execute_time_ms     ` |  2,424 |  2,424 |  2,424 |  2,424 |
| `trace_gen_time_ms   ` |  6,376 |  6,376 |  6,376 |  6,376 |
| `stark_prove_excluding_trace_time_ms` |  32,097 |  32,097 |  32,097 |  32,097 |
| `main_trace_commit_time_ms` |  5,829 |  5,829 |  5,829 |  5,829 |
| `generate_perm_trace_time_ms` |  707 |  707 |  707 |  707 |
| `perm_trace_commit_time_ms` |  7,177 |  7,177 |  7,177 |  7,177 |
| `quotient_poly_compute_time_ms` |  6,989 |  6,989 |  6,989 |  6,989 |
| `quotient_poly_commit_time_ms` |  5,110 |  5,110 |  5,110 |  5,110 |
| `pcs_opening_time_ms ` |  6,282 |  6,282 |  6,282 |  6,282 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 6,376 | 40,897 | 8,657,494 | 1,052,183,000 | 32,097 | 6,989 | 5,110 | 7,177 | 6,282 | 5,829 | 365,931,856 | 707 | 2,424 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 264 | 2,635 | 285,401 | 56,172,159 | 2,221 | 290 | 321 | 532 | 630 | 402 | 15,092,297 | 43 | 150 | 

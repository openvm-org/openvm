...
| `total_proof_time_ms ` |  486.50 |  973 |  548 |  425 |
...
| `execute_metered_insn_mi/s` |  150.55 | -          |  150.55 |  150.55 |
| `execute_preflight_insns` |  750,104.50 |  1,500,209 |  873,000 |  627,209 |
| `execute_preflight_time_ms` |  29.50 |  59 |  34 |  25 |
| `execute_preflight_insn_mi/s` |  36.73 | -          |  38.70 |  34.75 |
| `trace_gen_time_ms   ` |  188.50 |  377 |  194 |  183 |
| `memory_finalize_time_ms` | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  175 |  350 |  184 |  166 |
| `main_trace_commit_time_ms` |  30.50 |  61 |  33 |  28 |
| `generate_perm_trace_time_ms` |  12.50 |  25 |  13 |  12 |
| `perm_trace_commit_time_ms` |  42.32 |  84.64 |  45.32 |  39.32 |
| `quotient_poly_compute_time_ms` |  32.50 |  65 |  34.66 |  30.34 |
| `quotient_poly_commit_time_ms` |  12.26 |  24.51 |  12.32 |  12.19 |
| `pcs_opening_time_ms ` |  42 |  84 |  43 |  41 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,018.50 |  2,037 |  1,304 |  733 |
| `main_cells_used     ` |  6,475,562 |  12,951,124 |  6,608,072 |  6,343,052 |
| `total_cells_used    ` |  17,568,644 |  35,137,288 |  17,887,054 |  17,250,234 |
| `execute_preflight_insns` |  1,190,434 |  2,380,868 |  1,229,702 |  1,151,166 |
| `execute_preflight_time_ms` |  516.50 |  1,033 |  837 |  196 |
| `execute_preflight_insn_mi/s` |  6.96 | -          |  7.04 |  6.89 |
| `trace_gen_time_ms   ` |  58 |  116 |  59 |  57 |
| `memory_finalize_time_ms` |  5.50 |  11 |  6 |  5 |
| `stark_prove_excluding_trace_time_ms` |  442.50 |  885 |  477 |  408 |
| `main_trace_commit_time_ms` |  83 |  166 |  90 |  76 |
| `generate_perm_trace_time_ms` |  36 |  72 |  39 |  33 |
| `perm_trace_commit_time_ms` |  123.87 |  247.74 |  141.55 |  106.18 |
| `quotient_poly_compute_time_ms` |  91.46 |  182.92 |  99.38 |  83.54 |
| `quotient_poly_commit_time_ms` |  21.91 |  43.82 |  23.53 |  20.29 |
| `pcs_opening_time_ms ` |  83 |  166 |  86 |  80 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program |  | 425 |  | 1 | 9 | 1,500,209 | 150.55 | 0 | 
| leaf | 1,305 |  | 1 | 1 |  |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 59 | 733 | 17,887,054 | 252,878,314 | 59 | 477 | 0 | 99.38 | 23.53 | 4 | 141.55 | 86 | 176 | 85 | 5 | 90 | 6,608,072 | 33 | 196 | 1,229,702 | 7.04 | 26 | 123 | 0 | 85 | 
| leaf | 1 | 57 | 1,304 | 17,250,234 | 207,789,546 | 57 | 408 | 0 | 83.54 | 20.29 | 4 | 106.18 | 80 | 146 | 80 | 6 | 76 | 6,343,052 | 39 | 837 | 1,151,166 | 6.89 | 22 | 104 | 0 | 80 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 194 | 548 | 9,677,708 | 84,395,212 | 194 | 184 | 0 | 34.66 | 12.32 | 4 | 45.32 | 43 | 59 | 43 | 0 | 33 | 1,035,986 | 13 | 25 | 873,000 | 34.75 | 14 | 47 | 0 | 43 | 
| fibonacci_program | 1 | 183 | 425 | 9,708,170 | 74,305,770 | 183 | 166 | 1 | 30.34 | 12.19 | 4 | 39.32 | 41 | 52 | 41 | 0 | 28 | 1,064,416 | 12 | 34 | 627,209 | 38.70 | 11 | 42 | 0 | 41 | 

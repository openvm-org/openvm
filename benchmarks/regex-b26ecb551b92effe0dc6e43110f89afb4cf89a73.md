...
| `total_proof_time_ms ` |  592.75 |  2,371 |  716 |  534 |
...
| `execute_metered_insn_mi/s` |  122.97 | -          |  122.97 |  122.97 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  55.50 |  222 |  68 |  46 |
| `execute_preflight_insn_mi/s` |  30.19 | -          |  31.55 |  27.04 |
| `trace_gen_time_ms   ` |  177.25 |  709 |  210 |  154 |
| `memory_finalize_time_ms` |  1 |  4 |  4 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  292.25 |  1,169 |  311 |  271 |
| `main_trace_commit_time_ms` |  51.75 |  207 |  57 |  49 |
| `generate_perm_trace_time_ms` |  32 |  128 |  49 |  23 |
| `perm_trace_commit_time_ms` |  64.73 |  258.91 |  72.43 |  54.14 |
| `quotient_poly_compute_time_ms` |  59.45 |  237.81 |  71.45 |  52.91 |
| `quotient_poly_commit_time_ms` |  15.27 |  61.07 |  17.26 |  12.82 |
| `pcs_opening_time_ms ` |  65.25 |  261 |  74 |  60 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,397 |  5,588 |  2,005 |  898 |
...
| `execute_preflight_insns` |  1,440,884.50 |  5,763,538 |  1,814,591 |  1,241,405 |
| `execute_preflight_time_ms` |  635.50 |  2,542 |  858 |  234 |
| `execute_preflight_insn_mi/s` |  6.77 | -          |  7.14 |  6.60 |
| `trace_gen_time_ms   ` |  87.25 |  349 |  161 |  58 |
| `memory_finalize_time_ms` |  8.75 |  35 |  17 |  5 |
| `stark_prove_excluding_trace_time_ms` |  673.25 |  2,693 |  1,069 |  492 |
| `main_trace_commit_time_ms` |  124.50 |  498 |  192 |  92 |
| `generate_perm_trace_time_ms` |  69.25 |  277 |  90 |  42 |
| `perm_trace_commit_time_ms` |  198.56 |  794.25 |  342.23 |  140.54 |
| `quotient_poly_compute_time_ms` |  142.29 |  569.16 |  231.94 |  102.22 |
| `quotient_poly_commit_time_ms` |  31.07 |  124.29 |  51 |  23.99 |
| `pcs_opening_time_ms ` |  104 |  416 |  155 |  75 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 2,008 |  | 1 |  | 1 |  |  |  |  | 
| regex_program |  | 556 |  | 40 | 1 | 33 | 4,137,502 | 122.97 | 167 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 72 | 898 | 22,981,570 | 319,331,818 | 72 | 591 | 0 | 132.64 | 25.26 | 4 | 170.88 | 96 | 213 | 96 | 7 | 122 | 9,122,488 | 42 | 234 | 1,466,043 | 7.14 | 30 | 159 | 0 | 96 | 
| leaf | 1 | 58 | 1,459 | 20,905,034 | 255,237,610 | 58 | 541 | 0 | 102.22 | 23.99 | 4 | 140.54 | 90 | 231 | 90 | 5 | 92 | 8,256,948 | 90 | 858 | 1,241,499 | 6.71 | 26 | 127 | 0 | 90 | 
| leaf | 2 | 58 | 1,226 | 20,905,034 | 255,237,610 | 58 | 492 | 0 | 102.36 | 24.04 | 4 | 140.59 | 75 | 196 | 74 | 6 | 92 | 8,256,948 | 55 | 676 | 1,241,405 | 6.60 | 26 | 127 | 0 | 74 | 
| leaf | 3 | 161 | 2,005 | 50,337,320 | 538,365,418 | 161 | 1,069 | 0 | 231.94 | 51 | 4 | 342.23 | 155 | 434 | 155 | 17 | 192 | 20,171,106 | 90 | 774 | 1,814,591 | 6.62 | 61 | 286 | 5 | 155 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 210 | 716 | 23,446,148 | 150,778,428 | 210 | 311 | 0 | 60.46 | 17.26 | 5 | 72.43 | 74 | 100 | 74 | 4 | 57 | 10,899,170 | 26 | 48 | 1,103,000 | 27.04 | 22 | 78 | 1 | 74 | 
| regex_program | 1 | 154 | 534 | 11,598,276 | 128,513,066 | 154 | 271 | 1 | 52.91 | 15.43 | 4 | 66.46 | 60 | 90 | 60 | 0 | 50 | 2,196,106 | 23 | 68 | 1,104,000 | 31.13 | 16 | 68 | 0 | 60 | 
| regex_program | 2 | 162 | 565 | 11,579,064 | 128,513,066 | 162 | 302 | 1 | 52.99 | 15.56 | 4 | 65.88 | 66 | 116 | 66 | 0 | 49 | 2,177,334 | 49 | 60 | 1,104,000 | 31.05 | 16 | 69 | 0 | 66 | 
| regex_program | 3 | 183 | 556 | 11,853,872 | 103,456,394 | 183 | 285 | 0 | 71.45 | 12.82 | 5 | 54.14 | 61 | 87 | 61 | 0 | 51 | 2,422,606 | 30 | 46 | 826,502 | 31.55 | 18 | 85 | 1 | 61 | 

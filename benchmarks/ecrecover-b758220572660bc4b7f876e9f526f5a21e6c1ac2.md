...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  18,244 |  18,244 |  18,244 |  18,244 |
| `main_cells_used     ` |  193,314,407 |  193,314,407 |  193,314,407 |  193,314,407 |
| `total_cycles        ` |  4,157,832 |  4,157,832 |  4,157,832 |  4,157,832 |
| `execute_time_ms     ` |  904 |  904 |  904 |  904 |
| `trace_gen_time_ms   ` |  3,495 |  3,495 |  3,495 |  3,495 |
| `stark_prove_excluding_trace_time_ms` |  13,845 |  13,845 |  13,845 |  13,845 |
| `main_trace_commit_time_ms` |  2,904 |  2,904 |  2,904 |  2,904 |
| `generate_perm_trace_time_ms` |  349 |  349 |  349 |  349 |
| `perm_trace_commit_time_ms` |  2,922 |  2,922 |  2,922 |  2,922 |
| `quotient_poly_compute_time_ms` |  2,065 |  2,065 |  2,065 |  2,065 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 3,495 | 18,244 | 4,157,832 | 466,306,008 | 13,845 | 2,065 | 2,643 | 2,922 | 2,957 | 2,904 | 193,314,407 | 349 | 904 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 259 | 2,568 | 284,567 | 38,417,467 | 2,160 | 230 | 479 | 354 | 654 | 397 | 15,055,723 | 34 | 149 | 

...
| `stark_prove_excluding_trace_time_ms` |  1,192 |  1,192 |  1,192 |  1,192 |
...
| `pcs_opening_time_ms ` |  471 |  471 |  471 |  471 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  13,053 |  13,053 |  13,053 |  13,053 |
| `main_cells_used     ` |  244,104,713 |  244,104,713 |  244,104,713 |  244,104,713 |
| `total_cycles        ` |  2,988,885 |  2,988,885 |  2,988,885 |  2,988,885 |
| `execute_time_ms     ` |  1,082 |  1,082 |  1,082 |  1,082 |
| `trace_gen_time_ms   ` |  2,343 |  2,343 |  2,343 |  2,343 |
| `stark_prove_excluding_trace_time_ms` |  9,628 |  9,628 |  9,628 |  9,628 |
| `main_trace_commit_time_ms` |  1,748 |  1,748 |  1,748 |  1,748 |
| `generate_perm_trace_time_ms` |  698 |  698 |  698 |  698 |
| `perm_trace_commit_time_ms` |  3,161 |  3,161 |  3,161 |  3,161 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 2,343 | 13,053 | 2,988,885 | 999,394,794 | 9,628 | 1,339 | 878 | 3,161 | 1,799 | 1,748 | 244,104,713 | 698 | 1,082 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 181 | 1,522 | 295,291 | 48,197,161 | 1,192 | 125 | 162 | 204 | 471 | 181 | 15,588,656 | 33 | 149 | 

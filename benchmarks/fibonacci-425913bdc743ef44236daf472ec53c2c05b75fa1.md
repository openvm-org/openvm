...
|:---|---:|---:|---:|
| Total |  6.97 |  4.21 | 4.21 |
| fibonacci_program |  2.77 |  1.48 |  1.48 |
| leaf |  4.20 |  2.73 |  2.73 |
...
| `total_proof_time_ms ` |  1,381 |  2,762 |  1,469 |  1,293 |
...
| `execute_metered_insn_mi/s` |  164.39 | -          |  164.39 |  164.39 |
| `execute_preflight_insns` |  750,104.50 |  1,500,209 |  873,000 |  627,209 |
| `execute_preflight_time_ms` |  27 |  54 |  32 |  22 |
| `execute_preflight_insn_mi/s` |  38.45 | -          |  38.66 |  38.23 |
| `trace_gen_time_ms   ` |  196.50 |  393 |  199 |  194 |
| `memory_finalize_time_ms` | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  1,056 |  2,112 |  1,082 |  1,030 |
| `main_trace_commit_time_ms` |  30.50 |  61 |  33 |  28 |
| `generate_perm_trace_time_ms` |  30.50 |  61 |  31 |  30 |
| `perm_trace_commit_time_ms` |  40.60 |  81.20 |  43.28 |  37.92 |
| `quotient_poly_compute_time_ms` |  30.76 |  61.51 |  33.94 |  27.58 |
| `quotient_poly_commit_time_ms` |  12.80 |  25.60 |  12.97 |  12.63 |
| `pcs_opening_time_ms ` |  908.50 |  1,817 |  927 |  890 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  2,099.50 |  4,199 |  2,727 |  1,472 |
| `main_cells_used     ` |  9,918,323 |  19,836,646 |  10,128,708 |  9,707,938 |
| `total_cells_used    ` |  25,910,701 |  51,821,402 |  26,413,786 |  25,407,616 |
| `execute_preflight_insns` |  2,001,582 |  4,003,164 |  2,063,578 |  1,939,586 |
| `execute_preflight_time_ms` |  891.50 |  1,783 |  1,461 |  322 |
| `execute_preflight_insn_mi/s` |  6.100 | -          |  7 |  6.100 |
| `trace_gen_time_ms   ` |  95.50 |  191 |  98 |  93 |
| `memory_finalize_time_ms` |  10 |  20 |  10 |  10 |
| `stark_prove_excluding_trace_time_ms` |  1,111.50 |  2,223 |  1,172 |  1,051 |
| `main_trace_commit_time_ms` |  132.50 |  265 |  133 |  132 |
| `generate_perm_trace_time_ms` |  40 |  80 |  41 |  39 |
| `perm_trace_commit_time_ms` |  185.48 |  370.97 |  186.20 |  184.77 |
| `quotient_poly_compute_time_ms` |  144.21 |  288.42 |  144.36 |  144.06 |
| `quotient_poly_commit_time_ms` |  28.95 |  57.91 |  29.24 |  28.66 |
| `pcs_opening_time_ms ` |  576.50 |  1,153 |  636 |  517 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program |  | 1,293 |  | 1 | 9 | 1,500,209 | 164.39 | 0 | 
| leaf | 2,730 |  | 1 | 1 |  |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 98 | 1,472 | 26,413,786 | 342,564,330 | 98 | 1,051 | 0 | 144.36 | 28.66 | 6 | 184.77 | 517 | 224 | 517 | 10 | 133 | 10,128,708 | 39 | 322 | 2,063,578 | 6.100 | 32 | 174 | 0 | 517 | 
| leaf | 1 | 93 | 2,727 | 25,407,616 | 342,564,330 | 93 | 1,172 | 0 | 144.06 | 29.24 | 7 | 186.20 | 636 | 228 | 636 | 10 | 132 | 9,707,938 | 41 | 1,461 | 1,939,586 | 7 | 32 | 174 | 0 | 636 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 194 | 1,469 | 9,677,898 | 84,395,468 | 193 | 1,082 | 0 | 33.94 | 12.97 | 6 | 43.28 | 927 | 73 | 927 | 0 | 33 | 1,036,176 | 30 | 32 | 873,000 | 38.66 | 14 | 47 | 0 | 927 | 
| fibonacci_program | 1 | 199 | 1,293 | 9,708,412 | 74,306,026 | 199 | 1,030 | 1 | 27.58 | 12.63 | 5 | 37.92 | 890 | 70 | 890 | 0 | 28 | 1,064,658 | 31 | 22 | 627,209 | 38.23 | 11 | 40 | 0 | 890 | 

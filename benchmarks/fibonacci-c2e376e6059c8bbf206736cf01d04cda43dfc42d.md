...
| `total_proof_time_ms ` |  503 |  1,006 |  577 |  429 |
...
| `execute_metered_insn_mi/s` |  146.71 | -          |  146.71 |  146.71 |
| `execute_preflight_insns` |  750,104.50 |  1,500,209 |  873,000 |  627,209 |
| `execute_preflight_time_ms` |  29 |  58 |  33 |  25 |
| `execute_preflight_insn_mi/s` |  37.55 | -          |  39.52 |  35.58 |
| `trace_gen_time_ms   ` |  188.50 |  377 |  195 |  182 |
| `memory_finalize_time_ms` | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  193.50 |  387 |  214 |  173 |
| `main_trace_commit_time_ms` |  30 |  60 |  32 |  28 |
| `generate_perm_trace_time_ms` |  19.50 |  39 |  21 |  18 |
| `perm_trace_commit_time_ms` |  41.11 |  82.21 |  43.75 |  38.46 |
| `quotient_poly_compute_time_ms` |  31.89 |  63.78 |  34.30 |  29.48 |
| `quotient_poly_commit_time_ms` |  11.62 |  23.25 |  11.98 |  11.27 |
| `pcs_opening_time_ms ` |  57 |  114 |  71 |  43 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  996 |  1,992 |  1,237 |  755 |
| `main_cells_used     ` |  6,475,562 |  12,951,124 |  6,608,072 |  6,343,052 |
| `total_cells_used    ` |  17,568,644 |  35,137,288 |  17,887,054 |  17,250,234 |
| `execute_preflight_insns` |  1,190,373.50 |  2,380,747 |  1,229,568 |  1,151,179 |
| `execute_preflight_time_ms` |  493.50 |  987 |  792 |  195 |
| `execute_preflight_insn_mi/s` |  6.93 | -          |  7.04 |  6.82 |
| `trace_gen_time_ms   ` |  56.50 |  113 |  59 |  54 |
| `memory_finalize_time_ms` |  5 |  10 |  5 |  5 |
| `stark_prove_excluding_trace_time_ms` |  445 |  890 |  500 |  390 |
| `main_trace_commit_time_ms` |  83 |  166 |  90 |  76 |
| `generate_perm_trace_time_ms` |  41.50 |  83 |  56 |  27 |
| `perm_trace_commit_time_ms` |  123.03 |  246.07 |  140.52 |  105.55 |
| `quotient_poly_compute_time_ms` |  89.84 |  179.67 |  98.74 |  80.94 |
| `quotient_poly_commit_time_ms` |  20.81 |  41.63 |  22.49 |  19.14 |
| `pcs_opening_time_ms ` |  84.50 |  169 |  90 |  79 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program |  | 429 |  | 41 | 1 | 10 | 1,500,209 | 146.71 | 140 | 
| leaf | 1,239 |  | 1 |  | 1 |  |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 59 | 755 | 17,887,054 | 252,878,314 | 59 | 500 | 0 | 98.74 | 22.49 | 4 | 140.52 | 90 | 197 | 89 | 5 | 90 | 6,608,072 | 56 | 195 | 1,229,568 | 7.04 | 25 | 122 | 0 | 89 | 
| leaf | 1 | 54 | 1,237 | 17,250,234 | 207,789,546 | 54 | 390 | 0 | 80.94 | 19.14 | 4 | 105.55 | 79 | 134 | 78 | 5 | 76 | 6,343,052 | 27 | 792 | 1,151,179 | 6.82 | 22 | 100 | 0 | 78 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 195 | 577 | 9,677,708 | 84,395,212 | 195 | 214 | 0 | 34.30 | 11.98 | 4 | 43.75 | 71 | 62 | 71 | 0 | 32 | 1,035,986 | 18 | 25 | 873,000 | 35.58 | 13 | 46 | 0 | 71 | 
| fibonacci_program | 1 | 182 | 429 | 9,708,170 | 74,305,770 | 182 | 173 | 1 | 29.48 | 11.27 | 4 | 38.46 | 43 | 60 | 42 | 0 | 28 | 1,064,416 | 21 | 33 | 627,209 | 39.52 | 11 | 41 | 0 | 42 | 

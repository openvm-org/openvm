...
| `total_proof_time_ms ` |  2,575 |  2,575 |  2,575 |  2,575 |
...
| `pcs_opening_time_ms ` |  609 |  609 |  609 |  609 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  20,996 |  20,996 |  20,996 |  20,996 |
...
| `trace_gen_time_ms   ` |  3,676 |  3,676 |  3,676 |  3,676 |
| `stark_prove_excluding_trace_time_ms` |  16,372 |  16,372 |  16,372 |  16,372 |
| `main_trace_commit_time_ms` |  2,924 |  2,924 |  2,924 |  2,924 |
| `generate_perm_trace_time_ms` |  379 |  379 |  379 |  379 |
| `perm_trace_commit_time_ms` |  3,258 |  3,258 |  3,258 |  3,258 |
| `quotient_poly_compute_time_ms` |  4,399 |  4,399 |  4,399 |  4,399 |
| `quotient_poly_commit_time_ms` |  2,531 |  2,531 |  2,531 |  2,531 |
| `pcs_opening_time_ms ` |  2,878 |  2,878 |  2,878 |  2,878 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 3,676 | 20,996 | 4,138,523 | 508,251,096 | 16,372 | 4,399 | 2,531 | 3,258 | 2,878 | 2,924 | 202,802,486 | 379 | 948 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 250 | 2,575 | 285,401 | 56,172,159 | 2,177 | 289 | 303 | 534 | 609 | 399 | 15,075,033 | 39 | 148 | 

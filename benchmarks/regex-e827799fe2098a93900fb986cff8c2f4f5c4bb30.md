...
| `total_proof_time_ms ` |  4,061 |  8,122 |  4,508 |  3,614 |
| `main_cells_used     ` |  83,255,576 |  166,511,152 |  93,500,799 |  73,010,353 |
| `total_cycles        ` |  2,082,613 |  4,165,226 |  2,243,715 |  1,921,511 |
| `execute_time_ms     ` |  341.50 |  683 |  378 |  305 |
| `trace_gen_time_ms   ` |  989 |  1,978 |  1,171 |  807 |
| `stark_prove_excluding_trace_time_ms` |  2,730.50 |  5,461 |  2,959 |  2,502 |
| `main_trace_commit_time_ms` |  470.50 |  941 |  533 |  408 |
| `generate_perm_trace_time_ms` |  189 |  378 |  196 |  182 |
| `perm_trace_commit_time_ms` |  692.50 |  1,385 |  744 |  641 |
| `quotient_poly_compute_time_ms` |  397 |  794 |  427 |  367 |
| `quotient_poly_commit_time_ms` |  277 |  554 |  314 |  240 |
| `pcs_opening_time_ms ` |  693.50 |  1,387 |  734 |  653 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,324 |  14,648 |  7,385 |  7,263 |
| `main_cells_used     ` |  152,278,399 |  304,556,798 |  154,678,342 |  149,878,456 |
| `total_cycles        ` |  1,991,044.50 |  3,982,089 |  2,021,879 |  1,960,210 |
| `execute_time_ms     ` |  778 |  1,556 |  787 |  769 |
| `trace_gen_time_ms   ` |  1,506.50 |  3,013 |  1,516 |  1,497 |
| `stark_prove_excluding_trace_time_ms` |  5,039.50 |  10,079 |  5,082 |  4,997 |
| `main_trace_commit_time_ms` |  812.50 |  1,625 |  818 |  807 |
| `generate_perm_trace_time_ms` |  374.50 |  749 |  387 |  362 |
| `perm_trace_commit_time_ms` |  1,537.50 |  3,075 |  1,574 |  1,501 |
| `quotient_poly_compute_time_ms` |  765 |  1,530 |  771 |  759 |
| `quotient_poly_commit_time_ms` |  495 |  990 |  495 |  495 |
| `pcs_opening_time_ms ` |  1,049.50 |  2,099 |  1,056 |  1,043 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,516 | 7,385 | 2,021,879 | 538,660,330 | 5,082 | 759 | 495 | 1,574 | 1,043 | 818 | 154,678,342 | 387 | 787 | 
| leaf | 1 | 1,497 | 7,263 | 1,960,210 | 538,660,330 | 4,997 | 771 | 495 | 1,501 | 1,056 | 807 | 149,878,456 | 362 | 769 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,171 | 4,508 | 2,243,715 | 275,652,919 | 2,959 | 427 | 314 | 744 | 734 | 533 | 93,500,799 | 196 | 378 | 
| regex_program | 1 | 807 | 3,614 | 1,921,511 | 242,975,404 | 2,502 | 367 | 240 | 641 | 653 | 408 | 73,010,353 | 182 | 305 | 

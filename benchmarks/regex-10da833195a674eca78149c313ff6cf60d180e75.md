...
| `total_proof_time_ms ` |  3,990 |  7,980 |  4,585 |  3,395 |
| `main_cells_used     ` |  83,694,725 |  167,389,450 |  93,699,990 |  73,689,460 |
| `total_cycles        ` |  2,070,082 |  4,140,164 |  2,225,434 |  1,914,730 |
| `execute_time_ms     ` |  341 |  682 |  378 |  304 |
| `trace_gen_time_ms   ` |  958.50 |  1,917 |  1,124 |  793 |
| `stark_prove_excluding_trace_time_ms` |  2,690.50 |  5,381 |  3,083 |  2,298 |
| `main_trace_commit_time_ms` |  492 |  984 |  576 |  408 |
| `generate_perm_trace_time_ms` |  167.50 |  335 |  188 |  147 |
| `perm_trace_commit_time_ms` |  696.50 |  1,393 |  809 |  584 |
| `quotient_poly_compute_time_ms` |  361.50 |  723 |  427 |  296 |
| `quotient_poly_commit_time_ms` |  293.50 |  587 |  338 |  249 |
| `pcs_opening_time_ms ` |  670.50 |  1,341 |  735 |  606 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,527 |  15,054 |  7,615 |  7,439 |
| `main_cells_used     ` |  152,233,892 |  304,467,784 |  154,691,444 |  149,776,340 |
| `total_cycles        ` |  1,990,806.50 |  3,981,613 |  2,021,602 |  1,960,011 |
| `execute_time_ms     ` |  760 |  1,520 |  768 |  752 |
| `trace_gen_time_ms   ` |  1,478 |  2,956 |  1,530 |  1,426 |
| `stark_prove_excluding_trace_time_ms` |  5,289 |  10,578 |  5,317 |  5,261 |
| `main_trace_commit_time_ms` |  891.50 |  1,783 |  892 |  891 |
| `generate_perm_trace_time_ms` |  358 |  716 |  377 |  339 |
| `perm_trace_commit_time_ms` |  1,686.50 |  3,373 |  1,712 |  1,661 |
| `quotient_poly_compute_time_ms` |  764.50 |  1,529 |  772 |  757 |
| `quotient_poly_commit_time_ms` |  521.50 |  1,043 |  522 |  521 |
| `pcs_opening_time_ms ` |  1,061 |  2,122 |  1,071 |  1,051 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,530 | 7,615 | 2,021,602 | 533,941,738 | 5,317 | 757 | 522 | 1,712 | 1,051 | 891 | 154,691,444 | 377 | 768 | 
| leaf | 1 | 1,426 | 7,439 | 1,960,011 | 533,941,738 | 5,261 | 772 | 521 | 1,661 | 1,071 | 892 | 149,776,340 | 339 | 752 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,124 | 4,585 | 2,225,434 | 275,652,919 | 3,083 | 427 | 338 | 809 | 735 | 576 | 93,699,990 | 188 | 378 | 
| regex_program | 1 | 793 | 3,395 | 1,914,730 | 198,099,628 | 2,298 | 296 | 249 | 584 | 606 | 408 | 73,689,460 | 147 | 304 | 

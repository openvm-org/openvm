...
| `stark_prove_excluding_trace_time_ms` |  1,086 |  1,086 |  1,086 |  1,086 |
...
| `pcs_opening_time_ms ` |  398 |  398 |  398 |  398 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  13,094 |  13,094 |  13,094 |  13,094 |
| `main_cells_used     ` |  244,742,856 |  244,742,856 |  244,742,856 |  244,742,856 |
| `total_cycles        ` |  2,990,640 |  2,990,640 |  2,990,640 |  2,990,640 |
| `execute_time_ms     ` |  1,083 |  1,083 |  1,083 |  1,083 |
| `trace_gen_time_ms   ` |  2,366 |  2,366 |  2,366 |  2,366 |
| `stark_prove_excluding_trace_time_ms` |  9,645 |  9,645 |  9,645 |  9,645 |
| `main_trace_commit_time_ms` |  1,743 |  1,743 |  1,743 |  1,743 |
| `generate_perm_trace_time_ms` |  691 |  691 |  691 |  691 |
| `perm_trace_commit_time_ms` |  3,138 |  3,138 |  3,138 |  3,138 |
| `quotient_poly_compute_time_ms` |  1,341 |  1,341 |  1,341 |  1,341 |
| `quotient_poly_commit_time_ms` |  877 |  877 |  877 |  877 |
| `pcs_opening_time_ms ` |  1,850 |  1,850 |  1,850 |  1,850 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 2,366 | 13,094 | 2,990,640 | 999,394,794 | 9,645 | 1,341 | 877 | 3,138 | 1,850 | 1,743 | 244,742,856 | 691 | 1,083 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 177 | 1,411 | 295,291 | 48,240,457 | 1,086 | 125 | 154 | 189 | 398 | 170 | 15,598,160 | 33 | 148 | 

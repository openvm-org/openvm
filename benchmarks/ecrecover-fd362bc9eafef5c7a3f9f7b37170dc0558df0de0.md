...
| `total_proof_time_ms ` |  1,393 |  1,393 |  1,393 |  1,393 |
...
| `execute_metered_insn_mi/s` |  20.13 | -          |  20.13 |  20.13 |
...
| `stark_prove_excluding_trace_time_ms` |  973 |  973 |  973 |  973 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  10,660 |  10,660 |  10,660 |  10,660 |
| `main_cells_used     ` |  247,226,538 |  247,226,538 |  247,226,538 |  247,226,538 |
| `total_cells_used    ` |  646,606,452 |  646,606,452 |  646,606,452 |  646,606,452 |
| `execute_preflight_insns` |  2,934,900 |  2,934,900 |  2,934,900 |  2,934,900 |
| `execute_preflight_time_ms` |  571 |  571 |  571 |  571 |
| `execute_preflight_insn_mi/s` |  5.36 | -          |  5.36 |  5.36 |
| `trace_gen_time_ms   ` |  583 |  583 |  583 |  583 |
| `memory_finalize_time_ms` |  16 |  16 |  16 |  16 |
| `stark_prove_excluding_trace_time_ms` |  8,449 |  8,449 |  8,449 |  8,449 |
| `main_trace_commit_time_ms` |  1,550 |  1,550 |  1,550 |  1,550 |
| `generate_perm_trace_time_ms` |  847 |  847 |  847 |  847 |
| `perm_trace_commit_time_ms` |  2,170 |  2,170 |  2,170 |  2,170 |
| `quotient_poly_compute_time_ms` |  930 |  930 |  930 |  930 |
| `quotient_poly_commit_time_ms` |  667 |  667 |  667 |  667 |
| `pcs_opening_time_ms ` |  2,280 |  2,280 |  2,280 |  2,280 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program |  | 1,393 |  | 6 | 1 | 6 | 140,487 | 20.13 | 38 | 
| leaf | 10,663 |  | 1 |  | 1 |  |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 583 | 10,660 | 646,606,452 | 992,054,762 | 583 | 8,449 | 0 | 930 | 667 | 2,170 | 2,280 | 16 | 1,550 | 247,226,538 | 847 | 571 | 2,934,900 | 5.36 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 92 | 1,393 | 26,518,220 | 32,927,986 | 92 | 973 | 0 | 80 | 127 | 129 | 452 | 6 | 2 | 137 | 8,866,654 | 30 | 81 | 140,487 | 1.83 | 

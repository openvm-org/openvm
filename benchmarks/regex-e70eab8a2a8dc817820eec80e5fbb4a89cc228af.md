...
| `total_proof_time_ms ` |  1,480 |  2,960 |  1,714 |  1,246 |
...
| `execute_metered_insn_mi/s` |  95.17 | -          |  95.17 |  95.17 |
| `execute_preflight_insns` |  2,054,241.50 |  4,108,483 |  2,211,000 |  1,897,483 |
| `execute_preflight_time_ms` |  101 |  202 |  115 |  87 |
| `execute_preflight_insn_mi/s` |  29.64 | -          |  31.13 |  28.16 |
| `trace_gen_time_ms   ` |  308.50 |  617 |  329 |  288 |
| `memory_finalize_time_ms` |  2 |  4 |  4 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  983 |  1,966 |  1,212 |  754 |
| `main_trace_commit_time_ms` |  142 |  284 |  185 |  99 |
| `generate_perm_trace_time_ms` |  59.50 |  119 |  65 |  54 |
| `perm_trace_commit_time_ms` |  172.66 |  345.32 |  224.60 |  120.72 |
| `quotient_poly_compute_time_ms` |  158.18 |  316.37 |  169.06 |  147.31 |
| `quotient_poly_commit_time_ms` |  36.42 |  72.84 |  47.39 |  25.46 |
| `pcs_opening_time_ms ` |  407 |  814 |  538 |  276 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  2,099 |  4,198 |  2,894 |  1,304 |
| `main_cells_used     ` |  14,798,849 |  29,597,698 |  20,272,474 |  9,325,224 |
| `total_cells_used    ` |  37,032,585 |  74,065,170 |  50,586,080 |  23,479,090 |
| `execute_preflight_insns` |  1,663,312.50 |  3,326,625 |  1,829,999 |  1,496,626 |
| `execute_preflight_time_ms` |  616 |  1,232 |  964 |  268 |
| `execute_preflight_insn_mi/s` |  6.92 | -          |  7.20 |  6.64 |
| `trace_gen_time_ms   ` |  123.50 |  247 |  168 |  79 |
| `memory_finalize_time_ms` |  12.50 |  25 |  18 |  7 |
| `stark_prove_excluding_trace_time_ms` |  1,358.50 |  2,717 |  1,761 |  956 |
| `main_trace_commit_time_ms` |  180 |  360 |  228 |  132 |
| `generate_perm_trace_time_ms` |  78.50 |  157 |  96 |  61 |
| `perm_trace_commit_time_ms` |  276.36 |  552.72 |  366.84 |  185.88 |
| `quotient_poly_compute_time_ms` |  174.75 |  349.50 |  226.24 |  123.26 |
| `quotient_poly_commit_time_ms` |  43.21 |  86.42 |  57.18 |  29.24 |
| `pcs_opening_time_ms ` |  602 |  1,204 |  782 |  422 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 2,896 |  | 1 |  | 1 |  |  |  |  | 
| regex_program |  | 1,246 |  | 40 | 1 | 43 | 4,108,483 | 95.17 | 170 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 79 | 1,304 | 23,479,090 | 319,626,730 | 79 | 956 | 0 | 123.26 | 29.24 | 5 | 185.88 | 422 | 247 | 422 | 7 | 132 | 9,325,224 | 61 | 268 | 1,496,626 | 7.20 | 29 | 153 | 1 | 422 | 
| leaf | 1 | 168 | 2,894 | 50,586,080 | 538,660,330 | 168 | 1,761 | 0 | 226.24 | 57.18 | 5 | 366.84 | 782 | 464 | 782 | 18 | 228 | 20,272,474 | 96 | 964 | 1,829,999 | 6.64 | 56 | 286 | 1 | 782 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 288 | 1,714 | 23,397,108 | 373,183,036 | 288 | 1,212 | 0 | 147.31 | 47.39 | 6 | 224.60 | 538 | 290 | 538 | 4 | 185 | 10,866,434 | 65 | 87 | 2,211,000 | 28.16 | 46 | 196 | 2 | 538 | 
| regex_program | 1 | 329 | 1,246 | 11,981,356 | 196,739,722 | 329 | 754 | 2 | 169.06 | 25.46 | 6 | 120.72 | 276 | 178 | 276 | 0 | 99 | 2,537,170 | 54 | 115 | 1,897,483 | 31.13 | 26 | 199 | 2 | 276 | 

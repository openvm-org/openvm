...
| `total_proof_time_ms ` |  714 |  1,428 |  825 |  603 |
...
| `execute_preflight_insn_mi/s` |  13.55 | -          |  17.99 |  9.10 |
| `trace_gen_time_ms   ` |  180.50 |  361 |  197 |  164 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  345 |  690 |  386 |  304 |
| `main_trace_commit_time_ms` |  66.50 |  133 |  77 |  56 |
| `generate_perm_trace_time_ms` |  35.50 |  71 |  36 |  35 |
| `perm_trace_commit_time_ms` |  78.18 |  156.36 |  89.80 |  66.55 |
| `quotient_poly_compute_time_ms` |  79.79 |  159.58 |  87.66 |  71.92 |
| `quotient_poly_commit_time_ms` |  17.04 |  34.08 |  18.97 |  15.11 |
| `pcs_opening_time_ms ` |  63 |  126 |  72 |  54 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,499 |  2,998 |  1,781 |  1,217 |
| `main_cells_used     ` |  16,200,472 |  32,400,944 |  16,332,746 |  16,068,198 |
| `total_cells_used    ` |  39,332,920 |  78,665,840 |  39,650,868 |  39,014,972 |
| `execute_preflight_insns` |  1,952,403.50 |  3,904,807 |  1,991,911 |  1,912,896 |
| `execute_preflight_time_ms` |  611.50 |  1,223 |  917 |  306 |
| `execute_preflight_insn_mi/s` |  7.39 | -          |  7.41 |  7.37 |
| `trace_gen_time_ms   ` |  120 |  240 |  129 |  111 |
| `memory_finalize_time_ms` |  11.50 |  23 |  12 |  11 |
| `stark_prove_excluding_trace_time_ms` |  766 |  1,532 |  781 |  751 |
| `main_trace_commit_time_ms` |  148 |  296 |  152 |  144 |
| `generate_perm_trace_time_ms` |  58.50 |  117 |  63 |  54 |
| `perm_trace_commit_time_ms` |  229.40 |  458.81 |  234.64 |  224.17 |
| `quotient_poly_compute_time_ms` |  170.30 |  340.60 |  171.85 |  168.75 |
| `quotient_poly_commit_time_ms` |  32.01 |  64.01 |  33.45 |  30.57 |
| `pcs_opening_time_ms ` |  124.50 |  249 |  132 |  117 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 1,783 |  | 1 |  | 1 |  |  |  |  | 
| pairing |  | 603 |  | 40 | 1 | 89 | 1,745,742 | 19.47 | 144 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 129 | 1,217 | 39,650,868 | 410,701,290 | 129 | 781 | 0 | 171.85 | 33.45 | 4 | 234.64 | 132 | 289 | 131 | 12 | 152 | 16,332,746 | 54 | 306 | 1,991,911 | 7.37 | 40 | 206 | 0 | 131 | 
| leaf | 1 | 111 | 1,781 | 39,014,972 | 396,840,426 | 111 | 751 | 0 | 168.75 | 30.57 | 4 | 224.17 | 117 | 288 | 116 | 11 | 144 | 16,068,198 | 63 | 917 | 1,912,896 | 7.41 | 38 | 200 | 0 | 116 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 164 | 825 | 32,689,110 | 172,558,444 | 164 | 386 | 0 | 87.66 | 18.97 | 6 | 89.80 | 72 | 129 | 71 | 1 | 77 | 16,059,916 | 36 | 130 | 1,157,000 | 9.10 | 26 | 107 | 1 | 71 | 
| pairing | 1 | 197 | 603 | 22,314,288 | 119,958,502 | 197 | 304 | 1 | 71.92 | 15.11 | 6 | 66.55 | 54 | 104 | 54 | 0 | 56 | 9,408,294 | 35 | 60 | 588,742 | 17.99 | 21 | 87 | 1 | 54 | 

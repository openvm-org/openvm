...
| `total_proof_time_ms ` |  2,547 |  2,547 |  2,547 |  2,547 |
...
| `stark_prove_excluding_trace_time_ms` |  2,214 |  2,214 |  2,214 |  2,214 |
| `main_trace_commit_time_ms` |  378 |  378 |  378 |  378 |
| `generate_perm_trace_time_ms` |  35 |  35 |  35 |  35 |
| `perm_trace_commit_time_ms` |  360 |  360 |  360 |  360 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  13,600 |  13,600 |  13,600 |  13,600 |
| `main_cells_used     ` |  133,786,073 |  133,786,073 |  133,786,073 |  133,786,073 |
| `total_cycles        ` |  2,253,333 |  2,253,333 |  2,253,333 |  2,253,333 |
| `execute_time_ms     ` |  719 |  719 |  719 |  719 |
| `trace_gen_time_ms   ` |  1,751 |  1,751 |  1,751 |  1,751 |
| `stark_prove_excluding_trace_time_ms` |  11,130 |  11,130 |  11,130 |  11,130 |
| `main_trace_commit_time_ms` |  2,432 |  2,432 |  2,432 |  2,432 |
| `generate_perm_trace_time_ms` |  314 |  314 |  314 |  314 |
| `perm_trace_commit_time_ms` |  2,388 |  2,388 |  2,388 |  2,388 |
| `quotient_poly_compute_time_ms` |  1,654 |  1,654 |  1,654 |  1,654 |
| `quotient_poly_commit_time_ms` |  2,045 |  2,045 |  2,045 |  2,045 |
| `pcs_opening_time_ms ` |  2,292 |  2,292 |  2,292 |  2,292 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,751 | 13,600 | 2,253,333 | 377,489,890 | 11,130 | 1,654 | 2,045 | 2,388 | 2,292 | 2,432 | 133,786,073 | 314 | 719 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 185 | 2,547 | 295,181 | 38,665,477 | 2,214 | 235 | 496 | 360 | 694 | 378 | 15,586,346 | 35 | 148 | 

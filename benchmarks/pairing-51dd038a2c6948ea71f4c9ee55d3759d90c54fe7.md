...
| `total_proof_time_ms ` |  712.50 |  1,425 |  835 |  590 |
...
| `execute_metered_insn_mi/s` |  27.77 | -          |  27.77 |  27.77 |
| `execute_preflight_insns` |  872,871 |  1,745,742 |  1,149,000 |  596,742 |
| `execute_preflight_time_ms` |  83 |  166 |  119 |  47 |
| `execute_preflight_insn_mi/s` |  14.82 | -          |  18.26 |  11.38 |
| `trace_gen_time_ms   ` |  179.50 |  359 |  199 |  160 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  345 |  690 |  388 |  302 |
| `main_trace_commit_time_ms` |  64.50 |  129 |  75 |  54 |
| `generate_perm_trace_time_ms` |  36 |  72 |  36 |  36 |
| `perm_trace_commit_time_ms` |  75.85 |  151.71 |  87.57 |  64.13 |
| `quotient_poly_compute_time_ms` |  82.37 |  164.75 |  91.81 |  72.94 |
| `quotient_poly_commit_time_ms` |  17.02 |  34.03 |  19.16 |  14.87 |
| `pcs_opening_time_ms ` |  64.50 |  129 |  73 |  56 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,440.50 |  2,881 |  1,682 |  1,199 |
| `main_cells_used     ` |  16,200,472 |  32,400,944 |  16,332,746 |  16,068,198 |
| `total_cells_used    ` |  39,332,920 |  78,665,840 |  39,650,868 |  39,014,972 |
| `execute_preflight_insns` |  1,952,437.50 |  3,904,875 |  1,991,944 |  1,912,931 |
| `execute_preflight_time_ms` |  561.50 |  1,123 |  825 |  298 |
| `execute_preflight_insn_mi/s` |  7.81 | -          |  7.84 |  7.77 |
| `trace_gen_time_ms   ` |  125 |  250 |  130 |  120 |
| `memory_finalize_time_ms` |  13 |  26 |  14 |  12 |
| `stark_prove_excluding_trace_time_ms` |  753 |  1,506 |  770 |  736 |
| `main_trace_commit_time_ms` |  143.50 |  287 |  146 |  141 |
| `generate_perm_trace_time_ms` |  68.50 |  137 |  69 |  68 |
| `perm_trace_commit_time_ms` |  223.06 |  446.12 |  227.46 |  218.66 |
| `quotient_poly_compute_time_ms` |  169.56 |  339.11 |  172.69 |  166.42 |
| `quotient_poly_commit_time_ms` |  32.86 |  65.73 |  34.07 |  31.66 |
| `pcs_opening_time_ms ` |  111.50 |  223 |  118 |  105 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 1,684 |  | 1 | 1 |  |  |  |  | 
| pairing |  | 590 |  | 1 | 62 | 1,745,742 | 27.77 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 130 | 1,199 | 39,650,868 | 410,701,290 | 130 | 770 | 0 | 172.69 | 34.07 | 4 | 227.46 | 118 | 296 | 118 | 14 | 146 | 16,332,746 | 68 | 298 | 1,991,944 | 7.84 | 39 | 208 | 0 | 118 | 
| leaf | 1 | 120 | 1,682 | 39,014,972 | 396,840,426 | 120 | 736 | 0 | 166.42 | 31.66 | 4 | 218.66 | 105 | 289 | 105 | 12 | 141 | 16,068,198 | 69 | 825 | 1,912,931 | 7.77 | 37 | 199 | 0 | 105 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 160 | 835 | 32,480,114 | 172,558,444 | 160 | 388 | 0 | 91.81 | 19.16 | 6 | 87.57 | 73 | 127 | 73 | 1 | 75 | 15,909,408 | 36 | 119 | 1,149,000 | 11.38 | 26 | 111 | 1 | 73 | 
| pairing | 1 | 199 | 590 | 22,464,232 | 119,958,502 | 199 | 302 | 1 | 72.94 | 14.87 | 6 | 64.13 | 56 | 103 | 55 | 0 | 54 | 9,498,894 | 36 | 47 | 596,742 | 18.26 | 20 | 88 | 1 | 55 | 

...
| `total_proof_time_ms ` |  587.25 |  2,349 |  738 |  536 |
...
| `execute_metered_insn_mi/s` |  118.70 | -          |  118.70 |  118.70 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  53.50 |  214 |  65 |  45 |
| `execute_preflight_insn_mi/s` |  30.98 | -          |  32.12 |  28.08 |
| `trace_gen_time_ms   ` |  177.25 |  709 |  210 |  154 |
| `memory_finalize_time_ms` |  1 |  4 |  4 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  288.75 |  1,155 |  337 |  266 |
| `main_trace_commit_time_ms` |  51 |  204 |  57 |  49 |
| `generate_perm_trace_time_ms` |  33.75 |  135 |  54 |  19 |
| `perm_trace_commit_time_ms` |  63.55 |  254.20 |  68.16 |  54.68 |
| `quotient_poly_compute_time_ms` |  57.21 |  228.86 |  70.11 |  51.52 |
| `quotient_poly_commit_time_ms` |  15.11 |  60.45 |  17.71 |  12.56 |
| `pcs_opening_time_ms ` |  65 |  260 |  83 |  56 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,355.25 |  5,421 |  1,982 |  877 |
...
| `execute_preflight_insns` |  1,440,833.75 |  5,763,335 |  1,814,630 |  1,241,327 |
| `execute_preflight_time_ms` |  612.25 |  2,449 |  801 |  226 |
| `execute_preflight_insn_mi/s` |  6.98 | -          |  7.40 |  6.80 |
| `trace_gen_time_ms   ` |  87 |  348 |  161 |  58 |
| `memory_finalize_time_ms` |  8.75 |  35 |  17 |  5 |
| `stark_prove_excluding_trace_time_ms` |  654.50 |  2,618 |  1,057 |  489 |
| `main_trace_commit_time_ms` |  124.50 |  498 |  193 |  91 |
| `generate_perm_trace_time_ms` |  46.50 |  186 |  71 |  33 |
| `perm_trace_commit_time_ms` |  198.97 |  795.89 |  341.50 |  142.15 |
| `quotient_poly_compute_time_ms` |  139.58 |  558.32 |  228.71 |  99.45 |
| `quotient_poly_commit_time_ms` |  30.13 |  120.53 |  49.86 |  22.82 |
| `pcs_opening_time_ms ` |  111.75 |  447 |  167 |  89 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 1,984 |  | 1 | 1 |  |  |  |  | 
| regex_program |  | 536 |  | 1 | 34 | 4,137,502 | 118.70 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 70 | 877 | 22,981,570 | 319,331,818 | 70 | 580 | 0 | 130.66 | 24.66 | 4 | 169.29 | 91 | 210 | 91 | 7 | 122 | 9,122,488 | 40 | 226 | 1,466,015 | 7.40 | 30 | 156 | 0 | 91 | 
| leaf | 1 | 59 | 1,354 | 20,905,034 | 255,237,610 | 59 | 492 | 0 | 99.45 | 23.19 | 4 | 142.96 | 100 | 176 | 99 | 5 | 91 | 8,256,948 | 33 | 801 | 1,241,363 | 6.87 | 25 | 123 | 0 | 99 | 
| leaf | 2 | 58 | 1,208 | 20,905,034 | 255,237,610 | 58 | 489 | 0 | 99.50 | 22.82 | 4 | 142.15 | 89 | 185 | 88 | 6 | 92 | 8,256,948 | 42 | 659 | 1,241,327 | 6.80 | 25 | 123 | 0 | 88 | 
| leaf | 3 | 161 | 1,982 | 50,337,320 | 538,365,418 | 161 | 1,057 | 0 | 228.71 | 49.86 | 4 | 341.50 | 167 | 414 | 166 | 17 | 193 | 20,171,106 | 71 | 763 | 1,814,630 | 6.84 | 61 | 282 | 5 | 166 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 210 | 738 | 23,446,148 | 150,778,428 | 210 | 337 | 0 | 54.02 | 17.71 | 5 | 68.16 | 83 | 123 | 83 | 4 | 57 | 10,899,170 | 54 | 46 | 1,103,000 | 28.08 | 21 | 72 | 1 | 83 | 
| regex_program | 1 | 154 | 538 | 11,598,276 | 128,513,066 | 154 | 277 | 1 | 53.22 | 14.53 | 4 | 64.93 | 58 | 101 | 58 | 0 | 49 | 2,196,106 | 35 | 65 | 1,104,000 | 31.82 | 16 | 68 | 0 | 58 | 
| regex_program | 2 | 162 | 537 | 11,579,064 | 128,513,066 | 162 | 275 | 1 | 51.52 | 15.66 | 4 | 66.42 | 63 | 94 | 62 | 0 | 49 | 2,177,334 | 27 | 58 | 1,104,000 | 31.91 | 17 | 67 | 0 | 62 | 
| regex_program | 3 | 183 | 536 | 11,853,872 | 103,456,394 | 183 | 266 | 0 | 70.11 | 12.56 | 5 | 54.68 | 56 | 77 | 55 | 0 | 49 | 2,422,606 | 19 | 45 | 826,502 | 32.12 | 18 | 83 | 1 | 55 | 
...
Commit: https://github.com/openvm-org/openvm/commit/11bad01a7f5ae70ac8e993d9cfbd4952acf01f72
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19292116783)

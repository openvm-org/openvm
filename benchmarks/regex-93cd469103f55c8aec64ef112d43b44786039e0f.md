...
| `total_proof_time_ms ` |  3,940.50 |  7,881 |  4,331 |  3,550 |
...
| `stark_prove_excluding_trace_time_ms` |  2,623.50 |  5,247 |  2,777 |  2,470 |
| `main_trace_commit_time_ms` |  499.50 |  999 |  555 |  444 |
| `generate_perm_trace_time_ms` |  218 |  436 |  224 |  212 |
| `perm_trace_commit_time_ms` |  547.50 |  1,095 |  576 |  519 |
| `quotient_poly_compute_time_ms` |  267.50 |  535 |  284 |  251 |
| `quotient_poly_commit_time_ms` |  257 |  514 |  278 |  236 |
| `pcs_opening_time_ms ` |  825 |  1,650 |  850 |  800 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  6,994.50 |  13,989 |  7,045 |  6,944 |
| `main_cells_used     ` |  151,827,653 |  303,655,306 |  154,226,882 |  149,428,424 |
| `total_cycles        ` |  1,975,711 |  3,951,422 |  2,006,486 |  1,944,936 |
| `execute_time_ms     ` |  776 |  1,552 |  784 |  768 |
| `trace_gen_time_ms   ` |  1,465.50 |  2,931 |  1,476 |  1,455 |
| `stark_prove_excluding_trace_time_ms` |  4,753 |  9,506 |  4,785 |  4,721 |
| `main_trace_commit_time_ms` |  866 |  1,732 |  867 |  865 |
| `generate_perm_trace_time_ms` |  399 |  798 |  417 |  381 |
| `perm_trace_commit_time_ms` |  1,242.50 |  2,485 |  1,245 |  1,240 |
| `quotient_poly_compute_time_ms` |  531 |  1,062 |  533 |  529 |
| `quotient_poly_commit_time_ms` |  417 |  834 |  424 |  410 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,476 | 7,045 | 2,006,486 | 538,660,330 | 4,785 | 533 | 424 | 1,245 | 1,292 | 865 | 154,226,882 | 417 | 784 | 
| leaf | 1 | 1,455 | 6,944 | 1,944,936 | 538,660,330 | 4,721 | 529 | 410 | 1,240 | 1,288 | 867 | 149,428,424 | 381 | 768 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,161 | 4,331 | 2,243,715 | 275,652,919 | 2,777 | 284 | 278 | 576 | 850 | 555 | 93,500,799 | 224 | 393 | 
| regex_program | 1 | 767 | 3,550 | 1,921,511 | 242,975,404 | 2,470 | 251 | 236 | 519 | 800 | 444 | 73,010,353 | 212 | 313 | 

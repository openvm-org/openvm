...
| `total_proof_time_ms ` |  4,896 |  4,896 |  4,896 |  4,896 |
| `main_cells_used     ` |  51,485,080 |  51,485,080 |  51,485,080 |  51,485,080 |
| `total_cycles        ` |  1,500,095 |  1,500,095 |  1,500,095 |  1,500,095 |
| `execute_time_ms     ` |  292 |  292 |  292 |  292 |
| `trace_gen_time_ms   ` |  617 |  617 |  617 |  617 |
| `stark_prove_excluding_trace_time_ms` |  3,987 |  3,987 |  3,987 |  3,987 |
...
| `main_cells_used     ` |  33,540,484 |  33,540,484 |  33,540,484 |  33,540,484 |
| `total_cycles        ` |  615,292 |  615,292 |  615,292 |  615,292 |
...
| `pcs_opening_time_ms ` |  728 |  728 |  728 |  728 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 576 | 3,822 | 615,292 | 86,295,512 | 3,009 | 418 | 611 | 560 | 728 | 618 | 33,540,484 | 71 | 237 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 617 | 4,896 | 1,500,095 | 122,458,476 | 3,987 | 513 | 716 | 745 | 1,072 | 797 | 51,485,080 | 140 | 292 | 

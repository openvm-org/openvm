...
| `total_proof_time_ms ` |  2,531 |  2,531 |  2,531 |  2,531 |
...
| `pcs_opening_time_ms ` |  696 |  696 |  696 |  696 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  13,318 |  13,318 |  13,318 |  13,318 |
| `main_cells_used     ` |  133,786,229 |  133,786,229 |  133,786,229 |  133,786,229 |
| `total_cycles        ` |  2,253,346 |  2,253,346 |  2,253,346 |  2,253,346 |
| `execute_time_ms     ` |  729 |  729 |  729 |  729 |
| `trace_gen_time_ms   ` |  1,762 |  1,762 |  1,762 |  1,762 |
| `stark_prove_excluding_trace_time_ms` |  10,827 |  10,827 |  10,827 |  10,827 |
| `main_trace_commit_time_ms` |  2,323 |  2,323 |  2,323 |  2,323 |
| `generate_perm_trace_time_ms` |  317 |  317 |  317 |  317 |
| `perm_trace_commit_time_ms` |  2,299 |  2,299 |  2,299 |  2,299 |
| `quotient_poly_compute_time_ms` |  1,651 |  1,651 |  1,651 |  1,651 |
| `quotient_poly_commit_time_ms` |  1,957 |  1,957 |  1,957 |  1,957 |
| `pcs_opening_time_ms ` |  2,275 |  2,275 |  2,275 |  2,275 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,762 | 13,318 | 2,253,346 | 377,489,890 | 10,827 | 1,651 | 1,957 | 2,299 | 2,275 | 2,323 | 133,786,229 | 317 | 729 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 188 | 2,531 | 295,181 | 38,665,477 | 2,192 | 233 | 482 | 358 | 696 | 376 | 15,586,346 | 32 | 151 | 

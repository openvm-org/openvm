...
| `total_proof_time_ms ` |  3,909.50 |  7,819 |  4,362 |  3,457 |
| `main_cells_used     ` |  83,255,576 |  166,511,152 |  93,500,799 |  73,010,353 |
| `total_cycles        ` |  2,082,613 |  4,165,226 |  2,243,715 |  1,921,511 |
| `execute_time_ms     ` |  352.50 |  705 |  392 |  313 |
| `trace_gen_time_ms   ` |  972.50 |  1,945 |  1,174 |  771 |
| `stark_prove_excluding_trace_time_ms` |  2,584.50 |  5,169 |  2,796 |  2,373 |
| `main_trace_commit_time_ms` |  503 |  1,006 |  560 |  446 |
| `generate_perm_trace_time_ms` |  210 |  420 |  241 |  179 |
| `perm_trace_commit_time_ms` |  546.50 |  1,093 |  575 |  518 |
| `quotient_poly_compute_time_ms` |  264.50 |  529 |  284 |  245 |
| `quotient_poly_commit_time_ms` |  246.50 |  493 |  282 |  211 |
| `pcs_opening_time_ms ` |  805 |  1,610 |  845 |  765 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  6,973.50 |  13,947 |  7,024 |  6,923 |
| `main_cells_used     ` |  151,827,257 |  303,654,514 |  154,227,110 |  149,427,404 |
| `total_cycles        ` |  1,975,678 |  3,951,356 |  2,006,505 |  1,944,851 |
| `execute_time_ms     ` |  782 |  1,564 |  790 |  774 |
| `trace_gen_time_ms   ` |  1,452 |  2,904 |  1,461 |  1,443 |
| `stark_prove_excluding_trace_time_ms` |  4,739.50 |  9,479 |  4,773 |  4,706 |
| `main_trace_commit_time_ms` |  865 |  1,730 |  865 |  865 |
| `generate_perm_trace_time_ms` |  397 |  794 |  419 |  375 |
| `perm_trace_commit_time_ms` |  1,243 |  2,486 |  1,249 |  1,237 |
| `quotient_poly_compute_time_ms` |  522.50 |  1,045 |  532 |  513 |
| `quotient_poly_commit_time_ms` |  416 |  832 |  418 |  414 |
| `pcs_opening_time_ms ` |  1,288.50 |  2,577 |  1,290 |  1,287 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,461 | 7,024 | 2,006,505 | 538,660,330 | 4,773 | 532 | 414 | 1,249 | 1,290 | 865 | 154,227,110 | 419 | 790 | 
| leaf | 1 | 1,443 | 6,923 | 1,944,851 | 538,660,330 | 4,706 | 513 | 418 | 1,237 | 1,287 | 865 | 149,427,404 | 375 | 774 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,174 | 4,362 | 2,243,715 | 275,652,919 | 2,796 | 284 | 282 | 575 | 845 | 560 | 93,500,799 | 241 | 392 | 
| regex_program | 1 | 771 | 3,457 | 1,921,511 | 242,975,404 | 2,373 | 245 | 211 | 518 | 765 | 446 | 73,010,353 | 179 | 313 | 

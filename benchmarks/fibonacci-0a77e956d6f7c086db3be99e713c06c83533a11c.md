...
| `total_proof_time_ms ` |  5,280 |  5,280 |  5,280 |  5,280 |
| `main_cells_used     ` |  51,485,080 |  51,485,080 |  51,485,080 |  51,485,080 |
| `total_cycles        ` |  1,500,095 |  1,500,095 |  1,500,095 |  1,500,095 |
| `execute_time_ms     ` |  310 |  310 |  310 |  310 |
| `trace_gen_time_ms   ` |  814 |  814 |  814 |  814 |
| `stark_prove_excluding_trace_time_ms` |  4,156 |  4,156 |  4,156 |  4,156 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,078 |  7,078 |  7,078 |  7,078 |
| `main_cells_used     ` |  72,164,943 |  72,164,943 |  72,164,943 |  72,164,943 |
| `total_cycles        ` |  1,924,868 |  1,924,868 |  1,924,868 |  1,924,868 |
| `execute_time_ms     ` |  296 |  296 |  296 |  296 |
| `trace_gen_time_ms   ` |  1,375 |  1,375 |  1,375 |  1,375 |
| `stark_prove_excluding_trace_time_ms` |  5,407 |  5,407 |  5,407 |  5,407 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,375 | 7,078 | 1,924,868 | 160,482,264 | 5,407 | 774 | 1,082 | 1,012 | 1,298 | 1,106 | 72,164,943 | 131 | 296 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 814 | 5,280 | 1,500,095 | 122,458,476 | 4,156 | 509 | 764 | 804 | 1,072 | 864 | 51,485,080 | 140 | 310 | 

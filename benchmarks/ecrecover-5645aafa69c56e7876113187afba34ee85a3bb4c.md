...
| `pcs_opening_time_ms ` |  670 |  670 |  670 |  670 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  11,322 |  11,322 |  11,322 |  11,322 |
| `main_cells_used     ` |  117,320,802 |  117,320,802 |  117,320,802 |  117,320,802 |
| `total_cycles        ` |  1,603,998 |  1,603,998 |  1,603,998 |  1,603,998 |
| `execute_time_ms     ` |  570 |  570 |  570 |  570 |
| `trace_gen_time_ms   ` |  1,499 |  1,499 |  1,499 |  1,499 |
| `stark_prove_excluding_trace_time_ms` |  9,253 |  9,253 |  9,253 |  9,253 |
...
| `quotient_poly_commit_time_ms` |  1,672 |  1,672 |  1,672 |  1,672 |
| `pcs_opening_time_ms ` |  1,932 |  1,932 |  1,932 |  1,932 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,499 | 11,322 | 1,603,998 | 334,709,720 | 9,253 | 1,462 | 1,672 | 2,005 | 1,932 | 1,919 | 117,320,802 | 260 | 570 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 182 | 2,505 | 284,567 | 38,417,467 | 2,176 | 229 | 489 | 357 | 670 | 386 | 15,055,723 | 33 | 147 | 

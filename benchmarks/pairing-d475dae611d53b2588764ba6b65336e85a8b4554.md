...
| `total_proof_time_ms ` |  699 |  1,398 |  814 |  584 |
...
| `execute_preflight_time_ms` |  84 |  168 |  109 |  59 |
| `execute_preflight_insn_mi/s` |  14.78 | -          |  18.61 |  10.94 |
| `trace_gen_time_ms   ` |  185 |  370 |  191 |  179 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  337 |  674 |  382 |  292 |
| `main_trace_commit_time_ms` |  64 |  128 |  74 |  54 |
| `generate_perm_trace_time_ms` |  37 |  74 |  42 |  32 |
| `perm_trace_commit_time_ms` |  75.91 |  151.81 |  87.69 |  64.13 |
| `quotient_poly_compute_time_ms` |  77.53 |  155.05 |  86.16 |  68.90 |
| `quotient_poly_commit_time_ms` |  15.69 |  31.38 |  17.74 |  13.65 |
| `pcs_opening_time_ms ` |  61.50 |  123 |  70 |  53 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,476 |  2,952 |  1,743 |  1,209 |
| `main_cells_used     ` |  16,200,472 |  32,400,944 |  16,332,746 |  16,068,198 |
| `total_cells_used    ` |  39,332,920 |  78,665,840 |  39,650,868 |  39,014,972 |
| `execute_preflight_insns` |  1,952,391.50 |  3,904,783 |  1,991,883 |  1,912,900 |
| `execute_preflight_time_ms` |  605.50 |  1,211 |  911 |  300 |
| `execute_preflight_insn_mi/s` |  7.55 | -          |  7.56 |  7.54 |
| `trace_gen_time_ms   ` |  117.50 |  235 |  124 |  111 |
| `memory_finalize_time_ms` |  11.50 |  23 |  13 |  10 |
| `stark_prove_excluding_trace_time_ms` |  751.50 |  1,503 |  784 |  719 |
| `main_trace_commit_time_ms` |  145.50 |  291 |  149 |  142 |
| `generate_perm_trace_time_ms` |  68.50 |  137 |  76 |  61 |
| `perm_trace_commit_time_ms` |  220.61 |  441.22 |  228.32 |  212.90 |
| `quotient_poly_compute_time_ms` |  164.93 |  329.86 |  166.91 |  162.95 |
| `quotient_poly_commit_time_ms` |  30.63 |  61.26 |  30.75 |  30.51 |
| `pcs_opening_time_ms ` |  118.50 |  237 |  130 |  107 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 1,745 |  | 1 | 1 |  |  |  |  | 
| pairing |  | 584 |  | 1 | 68 | 1,745,742 | 25.67 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 124 | 1,209 | 39,650,868 | 410,701,290 | 124 | 784 | 0 | 166.91 | 30.75 | 4 | 228.32 | 130 | 305 | 130 | 13 | 149 | 16,332,746 | 76 | 300 | 1,991,883 | 7.56 | 39 | 199 | 0 | 130 | 
| leaf | 1 | 111 | 1,743 | 39,014,972 | 396,840,426 | 111 | 719 | 0 | 162.95 | 30.51 | 4 | 212.90 | 107 | 275 | 106 | 10 | 142 | 16,068,198 | 61 | 911 | 1,912,900 | 7.54 | 37 | 194 | 0 | 106 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 179 | 814 | 32,689,110 | 172,558,444 | 179 | 382 | 0 | 86.16 | 17.74 | 6 | 87.69 | 70 | 132 | 70 | 1 | 74 | 16,059,916 | 42 | 109 | 1,157,000 | 10.94 | 26 | 104 | 1 | 70 | 
| pairing | 1 | 191 | 584 | 22,314,288 | 119,958,502 | 191 | 292 | 1 | 68.90 | 13.65 | 6 | 64.13 | 53 | 100 | 53 | 0 | 54 | 9,408,294 | 32 | 59 | 588,742 | 18.61 | 20 | 83 | 1 | 53 | 

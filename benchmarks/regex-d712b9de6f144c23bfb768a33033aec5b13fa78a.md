...
| `total_proof_time_ms ` |  4,055 |  8,110 |  4,502 |  3,608 |
| `main_cells_used     ` |  83,255,576 |  166,511,152 |  93,500,799 |  73,010,353 |
| `total_cycles        ` |  2,082,613 |  4,165,226 |  2,243,715 |  1,921,511 |
| `execute_time_ms     ` |  344 |  688 |  383 |  305 |
| `trace_gen_time_ms   ` |  980 |  1,960 |  1,164 |  796 |
| `stark_prove_excluding_trace_time_ms` |  2,731 |  5,462 |  2,955 |  2,507 |
| `main_trace_commit_time_ms` |  472 |  944 |  533 |  411 |
| `generate_perm_trace_time_ms` |  196 |  392 |  197 |  195 |
| `perm_trace_commit_time_ms` |  688.50 |  1,377 |  743 |  634 |
| `quotient_poly_compute_time_ms` |  395 |  790 |  427 |  363 |
| `quotient_poly_commit_time_ms` |  286 |  572 |  331 |  241 |
| `pcs_opening_time_ms ` |  686 |  1,372 |  717 |  655 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,304.50 |  14,609 |  7,362 |  7,247 |
| `main_cells_used     ` |  152,277,391 |  304,554,782 |  154,677,358 |  149,877,424 |
| `total_cycles        ` |  1,990,960.50 |  3,981,921 |  2,021,797 |  1,960,124 |
| `execute_time_ms     ` |  771.50 |  1,543 |  781 |  762 |
| `trace_gen_time_ms   ` |  1,462.50 |  2,925 |  1,490 |  1,435 |
| `stark_prove_excluding_trace_time_ms` |  5,070.50 |  10,141 |  5,091 |  5,050 |
| `main_trace_commit_time_ms` |  807 |  1,614 |  810 |  804 |
| `generate_perm_trace_time_ms` |  374 |  748 |  386 |  362 |
| `perm_trace_commit_time_ms` |  1,549.50 |  3,099 |  1,577 |  1,522 |
| `quotient_poly_compute_time_ms` |  765 |  1,530 |  767 |  763 |
| `quotient_poly_commit_time_ms` |  495 |  990 |  497 |  493 |
| `pcs_opening_time_ms ` |  1,075 |  2,150 |  1,097 |  1,053 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,490 | 7,362 | 2,021,797 | 538,660,330 | 5,091 | 767 | 493 | 1,577 | 1,053 | 810 | 154,677,358 | 386 | 781 | 
| leaf | 1 | 1,435 | 7,247 | 1,960,124 | 538,660,330 | 5,050 | 763 | 497 | 1,522 | 1,097 | 804 | 149,877,424 | 362 | 762 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,164 | 4,502 | 2,243,715 | 275,652,919 | 2,955 | 427 | 331 | 743 | 717 | 533 | 93,500,799 | 195 | 383 | 
| regex_program | 1 | 796 | 3,608 | 1,921,511 | 242,975,404 | 2,507 | 363 | 241 | 634 | 655 | 411 | 73,010,353 | 197 | 305 | 

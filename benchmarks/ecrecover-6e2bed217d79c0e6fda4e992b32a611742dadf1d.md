...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  13,134 |  13,134 |  13,134 |  13,134 |
| `main_cells_used     ` |  245,278,572 |  245,278,572 |  245,278,572 |  245,278,572 |
| `total_cycles        ` |  2,990,898 |  2,990,898 |  2,990,898 |  2,990,898 |
| `execute_time_ms     ` |  1,068 |  1,068 |  1,068 |  1,068 |
| `trace_gen_time_ms   ` |  2,394 |  2,394 |  2,394 |  2,394 |
| `stark_prove_excluding_trace_time_ms` |  9,672 |  9,672 |  9,672 |  9,672 |
| `main_trace_commit_time_ms` |  1,737 |  1,737 |  1,737 |  1,737 |
| `generate_perm_trace_time_ms` |  702 |  702 |  702 |  702 |
| `perm_trace_commit_time_ms` |  3,207 |  3,207 |  3,207 |  3,207 |
| `quotient_poly_compute_time_ms` |  1,342 |  1,342 |  1,342 |  1,342 |
| `quotient_poly_commit_time_ms` |  882 |  882 |  882 |  882 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 2,394 | 13,134 | 2,990,898 | 1,008,831,978 | 9,672 | 1,342 | 882 | 3,207 | 1,798 | 1,737 | 245,278,572 | 702 | 1,068 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 183 | 1,455 | 295,490 | 48,240,457 | 1,123 | 127 | 161 | 198 | 404 | 182 | 15,627,255 | 33 | 149 | 

...
| `total_proof_time_ms ` |  6,960.50 |  13,921 |  7,832 |  6,089 |
| `main_cells_used     ` |  82,727,686.50 |  165,455,373 |  92,686,348 |  72,769,025 |
| `total_cycles        ` |  1,914,103 |  1,914,103 |  1,914,103 |  1,914,103 |
| `execute_time_ms     ` |  441.50 |  883 |  476 |  407 |
| `trace_gen_time_ms   ` |  1,096.50 |  2,193 |  1,262 |  931 |
| `stark_prove_excluding_trace_time_ms` |  5,422.50 |  10,845 |  6,094 |  4,751 |
| `main_trace_commit_time_ms` |  1,042.50 |  2,085 |  1,281 |  804 |
| `generate_perm_trace_time_ms` |  182.50 |  365 |  191 |  174 |
| `perm_trace_commit_time_ms` |  1,157 |  2,314 |  1,193 |  1,121 |
| `quotient_poly_compute_time_ms` |  761 |  1,522 |  889 |  633 |
| `quotient_poly_commit_time_ms` |  949.50 |  1,899 |  1,103 |  796 |
| `pcs_opening_time_ms ` |  1,317.50 |  2,635 |  1,429 |  1,206 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  8,120.50 |  16,241 |  8,391 |  7,850 |
| `main_cells_used     ` |  77,287,088 |  154,574,176 |  78,375,899 |  76,198,277 |
| `total_cycles        ` |  1,028,200 |  2,056,400 |  1,045,699 |  1,010,701 |
| `execute_time_ms     ` |  379 |  758 |  412 |  346 |
| `trace_gen_time_ms   ` |  1,177 |  2,354 |  1,234 |  1,120 |
| `stark_prove_excluding_trace_time_ms` |  6,564.50 |  13,129 |  6,859 |  6,270 |
| `main_trace_commit_time_ms` |  1,344 |  2,688 |  1,396 |  1,292 |
| `generate_perm_trace_time_ms` |  161.50 |  323 |  171 |  152 |
| `perm_trace_commit_time_ms` |  1,325 |  2,650 |  1,376 |  1,274 |
| `quotient_poly_compute_time_ms` |  983.50 |  1,967 |  1,034 |  933 |
| `quotient_poly_commit_time_ms` |  1,297.50 |  2,595 |  1,359 |  1,236 |
| `pcs_opening_time_ms ` |  1,449 |  2,898 |  1,519 |  1,379 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,120 | 8,391 | 1,045,699 | 220,669,656 | 6,859 | 1,034 | 1,359 | 1,376 | 1,519 | 1,396 | 78,375,899 | 171 | 412 | 
| leaf | 1 | 1,234 | 7,850 | 1,010,701 | 194,986,968 | 6,270 | 933 | 1,236 | 1,274 | 1,379 | 1,292 | 76,198,277 | 152 | 346 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,262 | 7,832 |  | 209,921,543 | 6,094 | 889 | 1,103 | 1,193 | 1,429 | 1,281 | 92,686,348 | 191 | 476 | 
| regex_program | 1 | 931 | 6,089 | 1,914,103 | 149,454,692 | 4,751 | 633 | 796 | 1,121 | 1,206 | 804 | 72,769,025 | 174 | 407 | 

...
| `total_proof_time_ms ` |  2,553 |  2,553 |  2,553 |  2,553 |
...
| `stark_prove_excluding_trace_time_ms` |  2,150 |  2,150 |  2,150 |  2,150 |
...
| `pcs_opening_time_ms ` |  652 |  652 |  652 |  652 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  18,287 |  18,287 |  18,287 |  18,287 |
| `main_cells_used     ` |  193,327,577 |  193,327,577 |  193,327,577 |  193,327,577 |
| `total_cycles        ` |  4,157,674 |  4,157,674 |  4,157,674 |  4,157,674 |
| `execute_time_ms     ` |  920 |  920 |  920 |  920 |
| `trace_gen_time_ms   ` |  3,572 |  3,572 |  3,572 |  3,572 |
| `stark_prove_excluding_trace_time_ms` |  13,795 |  13,795 |  13,795 |  13,795 |
| `main_trace_commit_time_ms` |  2,892 |  2,892 |  2,892 |  2,892 |
| `generate_perm_trace_time_ms` |  355 |  355 |  355 |  355 |
| `perm_trace_commit_time_ms` |  2,850 |  2,850 |  2,850 |  2,850 |
| `quotient_poly_compute_time_ms` |  2,087 |  2,087 |  2,087 |  2,087 |
| `quotient_poly_commit_time_ms` |  2,653 |  2,653 |  2,653 |  2,653 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 3,572 | 18,287 | 4,157,674 | 466,306,008 | 13,795 | 2,087 | 2,653 | 2,850 | 2,954 | 2,892 | 193,327,577 | 355 | 920 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 255 | 2,553 | 284,567 | 38,417,595 | 2,150 | 227 | 476 | 351 | 652 | 397 | 15,055,843 | 34 | 148 | 

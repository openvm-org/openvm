...
|:---|---:|---:|---:|
| Total |  20.37 |  11.56 | 11.56 |
| pairing |  8.52 |  5.06 |  5.06 |
| leaf |  11.85 |  6.49 |  6.49 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  4,228 |  8,456 |  5,002 |  3,454 |
...
| `execute_preflight_time_ms` |  85.50 |  171 |  122 |  49 |
| `execute_preflight_insn_mi/s` |  14.75 | -          |  18.06 |  11.45 |
| `trace_gen_time_ms   ` |  184.50 |  369 |  206 |  163 |
| `memory_finalize_time_ms` |  1 |  2 |  1 |  1 |
| `stark_prove_excluding_trace_time_ms` |  3,852.50 |  7,705 |  4,705 |  3,000 |
| `main_trace_commit_time_ms` |  65.50 |  131 |  76 |  55 |
| `generate_perm_trace_time_ms` |  85 |  170 |  99 |  71 |
| `perm_trace_commit_time_ms` |  77.29 |  154.58 |  90.05 |  64.53 |
| `quotient_poly_compute_time_ms` |  83.45 |  166.89 |  90.98 |  75.91 |
| `quotient_poly_commit_time_ms` |  15.99 |  31.97 |  16.78 |  15.19 |
| `pcs_opening_time_ms ` |  3,520.50 |  7,041 |  4,391 |  2,650 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  5,924.50 |  11,849 |  6,494 |  5,355 |
| `main_cells_used     ` |  20,420,666 |  40,841,332 |  20,631,060 |  20,210,272 |
| `total_cells_used    ` |  49,519,454 |  99,038,908 |  50,022,658 |  49,016,250 |
| `execute_preflight_insns` |  2,989,104 |  5,978,208 |  3,051,337 |  2,926,871 |
| `execute_preflight_time_ms` |  1,115 |  2,230 |  1,696 |  534 |
| `execute_preflight_insn_mi/s` |  6.34 | -          |  6.34 |  6.33 |
| `trace_gen_time_ms   ` |  165 |  330 |  171 |  159 |
| `memory_finalize_time_ms` |  14 |  28 |  15 |  13 |
| `stark_prove_excluding_trace_time_ms` |  4,643 |  9,286 |  4,649 |  4,637 |
| `main_trace_commit_time_ms` |  299.50 |  599 |  300 |  299 |
| `generate_perm_trace_time_ms` |  243 |  486 |  244 |  242 |
| `perm_trace_commit_time_ms` |  459.06 |  918.13 |  460.84 |  457.28 |
| `quotient_poly_compute_time_ms` |  341.26 |  682.52 |  342.92 |  339.60 |
| `quotient_poly_commit_time_ms` |  69.44 |  138.87 |  69.51 |  69.36 |
| `pcs_opening_time_ms ` |  3,223.50 |  6,447 |  3,225 |  3,222 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 6,498 |  | 1 | 1 |  |  |  |  | 
| pairing |  | 5,002 |  | 1 | 63 | 1,745,742 | 27.51 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 171 | 5,355 | 50,022,658 | 761,351,658 | 171 | 4,649 | 0 | 342.92 | 69.36 | 7 | 460.84 | 3,225 | 704 | 3,225 | 15 | 300 | 20,631,060 | 242 | 534 | 3,051,337 | 6.34 | 84 | 419 | 5 | 3,225 | 
| leaf | 1 | 159 | 6,494 | 49,016,250 | 761,351,658 | 159 | 4,637 | 0 | 339.60 | 69.51 | 6 | 457.28 | 3,222 | 702 | 3,222 | 13 | 299 | 20,210,272 | 244 | 1,696 | 2,926,871 | 6.33 | 80 | 411 | 0 | 3,222 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 163 | 3,454 | 32,480,114 | 172,558,444 | 163 | 3,000 | 0 | 90.98 | 16.78 | 9 | 90.05 | 2,650 | 164 | 2,650 | 1 | 76 | 15,909,408 | 71 | 122 | 1,149,000 | 11.45 | 26 | 108 | 1 | 2,649 | 
| pairing | 1 | 206 | 5,002 | 22,464,232 | 119,958,502 | 206 | 4,705 | 1 | 75.91 | 15.19 | 8 | 64.53 | 4,391 | 167 | 4,390 | 1 | 55 | 9,498,894 | 99 | 49 | 596,742 | 18.06 | 21 | 91 | 1 | 4,390 | 

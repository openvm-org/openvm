...
| `total_proof_time_ms ` |  506.50 |  1,013 |  574 |  439 |
...
| `execute_metered_insn_mi/s` |  143.96 | -          |  143.96 |  143.96 |
| `execute_preflight_insns` |  750,104.50 |  1,500,209 |  873,000 |  627,209 |
| `execute_preflight_time_ms` |  28.50 |  57 |  32 |  25 |
| `execute_preflight_insn_mi/s` |  37.55 | -          |  39.53 |  35.58 |
| `trace_gen_time_ms   ` |  194 |  388 |  200 |  188 |
...
| `generate_perm_trace_time_ms` |  23.50 |  47 |  31 |  16 |
| `perm_trace_commit_time_ms` |  42.11 |  84.21 |  44.48 |  39.73 |
| `quotient_poly_compute_time_ms` |  30.98 |  61.96 |  32.99 |  28.97 |
| `quotient_poly_commit_time_ms` |  12.47 |  24.94 |  12.72 |  12.21 |
| `pcs_opening_time_ms ` |  48 |  96 |  50 |  46 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,012 |  2,024 |  1,257 |  767 |
| `main_cells_used     ` |  6,475,562 |  12,951,124 |  6,608,072 |  6,343,052 |
| `total_cells_used    ` |  17,568,644 |  35,137,288 |  17,887,054 |  17,250,234 |
| `execute_preflight_insns` |  1,190,383.50 |  2,380,767 |  1,229,635 |  1,151,132 |
| `execute_preflight_time_ms` |  497.50 |  995 |  794 |  201 |
| `execute_preflight_insn_mi/s` |  6.74 | -          |  6.83 |  6.64 |
| `trace_gen_time_ms   ` |  57.50 |  115 |  61 |  54 |
| `memory_finalize_time_ms` |  5.50 |  11 |  6 |  5 |
| `stark_prove_excluding_trace_time_ms` |  456 |  912 |  504 |  408 |
| `main_trace_commit_time_ms` |  83.50 |  167 |  91 |  76 |
| `generate_perm_trace_time_ms` |  55 |  110 |  55 |  55 |
| `perm_trace_commit_time_ms` |  123.78 |  247.56 |  141.43 |  106.14 |
| `quotient_poly_compute_time_ms` |  93.29 |  186.58 |  102.82 |  83.76 |
| `quotient_poly_commit_time_ms` |  21.89 |  43.78 |  24.27 |  19.52 |
| `pcs_opening_time_ms ` |  75 |  150 |  86 |  64 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program |  | 439 |  | 41 | 1 | 10 | 1,500,209 | 143.96 | 140 | 
| leaf | 1,259 |  | 1 |  | 1 |  |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 61 | 767 | 17,887,054 | 252,878,314 | 61 | 504 | 0 | 102.82 | 24.27 | 4 | 141.43 | 86 | 197 | 86 | 6 | 91 | 6,608,072 | 55 | 201 | 1,229,635 | 6.83 | 26 | 128 | 0 | 86 | 
| leaf | 1 | 54 | 1,257 | 17,250,234 | 207,789,546 | 54 | 408 | 0 | 83.76 | 19.52 | 4 | 106.14 | 64 | 162 | 64 | 5 | 76 | 6,343,052 | 55 | 794 | 1,151,132 | 6.64 | 22 | 104 | 0 | 64 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 200 | 574 | 9,677,708 | 84,395,212 | 200 | 202 | 0 | 32.99 | 12.72 | 4 | 44.48 | 46 | 76 | 46 | 0 | 32 | 1,035,986 | 31 | 25 | 873,000 | 35.58 | 14 | 46 | 0 | 46 | 
| fibonacci_program | 1 | 188 | 439 | 9,708,170 | 74,305,770 | 187 | 177 | 1 | 28.97 | 12.21 | 4 | 39.73 | 50 | 57 | 50 | 0 | 28 | 1,064,416 | 16 | 32 | 627,209 | 39.53 | 11 | 41 | 0 | 50 | 

...
| `total_proof_time_ms ` |  4,061 |  8,122 |  4,533 |  3,589 |
...
| `trace_gen_time_ms   ` |  961 |  1,922 |  1,156 |  766 |
| `stark_prove_excluding_trace_time_ms` |  2,760 |  5,520 |  2,999 |  2,521 |
| `main_trace_commit_time_ms` |  472.50 |  945 |  534 |  411 |
| `generate_perm_trace_time_ms` |  199 |  398 |  215 |  183 |
| `perm_trace_commit_time_ms` |  694.50 |  1,389 |  747 |  642 |
| `quotient_poly_compute_time_ms` |  392 |  784 |  425 |  359 |
| `quotient_poly_commit_time_ms` |  282 |  564 |  319 |  245 |
| `pcs_opening_time_ms ` |  708.50 |  1,417 |  749 |  668 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,327 |  14,654 |  7,367 |  7,287 |
...
| `trace_gen_time_ms   ` |  1,481 |  2,962 |  1,485 |  1,477 |
| `stark_prove_excluding_trace_time_ms` |  5,067.50 |  10,135 |  5,095 |  5,040 |
| `main_trace_commit_time_ms` |  815 |  1,630 |  824 |  806 |
| `generate_perm_trace_time_ms` |  376 |  752 |  390 |  362 |
| `perm_trace_commit_time_ms` |  1,557 |  3,114 |  1,565 |  1,549 |
| `quotient_poly_compute_time_ms` |  766.50 |  1,533 |  769 |  764 |
| `quotient_poly_commit_time_ms` |  496 |  992 |  498 |  494 |
| `pcs_opening_time_ms ` |  1,052 |  2,104 |  1,053 |  1,051 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,485 | 7,367 | 2,021,840 | 538,660,330 | 5,095 | 764 | 494 | 1,565 | 1,053 | 824 | 154,677,874 | 390 | 787 | 
| leaf | 1 | 1,477 | 7,287 | 1,960,220 | 538,660,330 | 5,040 | 769 | 498 | 1,549 | 1,051 | 806 | 149,878,576 | 362 | 770 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,156 | 4,533 | 2,243,715 | 275,652,919 | 2,999 | 425 | 319 | 747 | 749 | 534 | 93,500,799 | 215 | 378 | 
| regex_program | 1 | 766 | 3,589 | 1,921,511 | 242,975,404 | 2,521 | 359 | 245 | 642 | 668 | 411 | 73,010,353 | 183 | 302 | 

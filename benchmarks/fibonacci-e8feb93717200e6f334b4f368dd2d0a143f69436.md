...
|:---|---:|---:|---:|
| Total |  3.12 |  1.92 | 1.92 |
| fibonacci_program |  1.07 |  0.64 |  0.64 |
| leaf |  2.04 |  1.29 |  1.29 |
...
| `total_proof_time_ms ` |  532.50 |  1,065 |  629 |  436 |
...
| `execute_metered_insn_mi/s` |  163.76 | -          |  163.76 |  163.76 |
| `execute_preflight_insns` |  750,104.50 |  1,500,209 |  873,000 |  627,209 |
| `execute_preflight_time_ms` |  27 |  54 |  32 |  22 |
| `execute_preflight_insn_mi/s` |  37.98 | -          |  38.11 |  37.85 |
| `trace_gen_time_ms   ` |  194 |  388 |  198 |  190 |
| `memory_finalize_time_ms` | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  205.50 |  411 |  237 |  174 |
| `main_trace_commit_time_ms` |  31 |  62 |  33 |  29 |
| `generate_perm_trace_time_ms` |  18.50 |  37 |  21 |  16 |
| `perm_trace_commit_time_ms` |  41.93 |  83.86 |  44.73 |  39.13 |
| `quotient_poly_compute_time_ms` |  31.60 |  63.20 |  33.17 |  30.03 |
| `quotient_poly_commit_time_ms` |  12.70 |  25.40 |  13.58 |  11.81 |
| `pcs_opening_time_ms ` |  67.50 |  135 |  94 |  41 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,021 |  2,042 |  1,286 |  756 |
| `main_cells_used     ` |  6,475,562 |  12,951,124 |  6,608,072 |  6,343,052 |
| `total_cells_used    ` |  17,568,644 |  35,137,288 |  17,887,054 |  17,250,234 |
| `execute_preflight_insns` |  1,190,365.50 |  2,380,731 |  1,229,552 |  1,151,179 |
| `execute_preflight_time_ms` |  515.50 |  1,031 |  825 |  206 |
| `execute_preflight_insn_mi/s` |  6.67 | -          |  6.70 |  6.65 |
...
| `perm_trace_commit_time_ms` |  126.37 |  252.74 |  143.36 |  109.38 |
| `quotient_poly_compute_time_ms` |  94.91 |  189.83 |  104.61 |  85.22 |
| `quotient_poly_commit_time_ms` |  22.42 |  44.83 |  24.31 |  20.52 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program |  | 436 |  | 1 | 9 | 1,500,209 | 163.76 | 0 | 
| leaf | 1,288 |  | 1 | 1 |  |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 62 | 756 | 17,887,054 | 252,878,314 | 62 | 486 | 0 | 104.61 | 24.31 | 5 | 143.36 | 85 | 178 | 85 | 6 | 92 | 6,608,072 | 33 | 206 | 1,229,552 | 6.70 | 26 | 129 | 0 | 85 | 
| leaf | 1 | 54 | 1,286 | 17,250,234 | 207,789,546 | 54 | 406 | 0 | 85.22 | 20.52 | 4 | 109.38 | 84 | 138 | 84 | 5 | 76 | 6,343,052 | 28 | 825 | 1,151,179 | 6.65 | 22 | 106 | 0 | 84 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 190 | 629 | 9,677,708 | 84,395,212 | 190 | 237 | 0 | 33.17 | 13.58 | 4 | 44.73 | 94 | 62 | 94 | 0 | 33 | 1,035,986 | 16 | 32 | 873,000 | 38.11 | 14 | 47 | 0 | 94 | 
| fibonacci_program | 1 | 198 | 436 | 9,708,170 | 74,305,770 | 198 | 174 | 1 | 30.03 | 11.81 | 4 | 39.13 | 41 | 61 | 41 | 0 | 29 | 1,064,416 | 21 | 22 | 627,209 | 37.85 | 11 | 42 | 0 | 41 | 

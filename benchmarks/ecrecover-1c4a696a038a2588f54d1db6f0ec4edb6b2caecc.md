...
| `stark_prove_excluding_trace_time_ms` |  911 |  911 |  911 |  911 |
...
| `pcs_opening_time_ms ` |  408 |  408 |  408 |  408 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  11,749 |  11,749 |  11,749 |  11,749 |
| `main_cells_used     ` |  245,012,763 |  245,012,763 |  245,012,763 |  245,012,763 |
| `total_cycles        ` |  3,012,535 |  3,012,535 |  3,012,535 |  3,012,535 |
| `execute_time_ms     ` |  1,105 |  1,105 |  1,105 |  1,105 |
| `trace_gen_time_ms   ` |  2,438 |  2,438 |  2,438 |  2,438 |
| `stark_prove_excluding_trace_time_ms` |  8,206 |  8,206 |  8,206 |  8,206 |
| `main_trace_commit_time_ms` |  1,514 |  1,514 |  1,514 |  1,514 |
| `generate_perm_trace_time_ms` |  793 |  793 |  793 |  793 |
| `perm_trace_commit_time_ms` |  2,119 |  2,119 |  2,119 |  2,119 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 2,438 | 11,749 | 3,012,535 | 1,008,831,978 | 8,206 | 922 | 641 | 2,119 | 2,211 | 1,514 | 245,012,763 | 793 | 1,105 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 108 | 1,138 | 120,958 | 32,514,138 | 911 | 80 | 124 | 120 | 408 | 135 | 7,478,092 | 28 | 119 | 

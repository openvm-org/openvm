...
| `stark_prove_excluding_trace_time_ms` |  2,119 |  2,119 |  2,119 |  2,119 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  11,207 |  11,207 |  11,207 |  11,207 |
| `main_cells_used     ` |  117,320,757 |  117,320,757 |  117,320,757 |  117,320,757 |
| `total_cycles        ` |  1,603,993 |  1,603,993 |  1,603,993 |  1,603,993 |
| `execute_time_ms     ` |  561 |  561 |  561 |  561 |
| `trace_gen_time_ms   ` |  1,545 |  1,545 |  1,545 |  1,545 |
| `stark_prove_excluding_trace_time_ms` |  9,101 |  9,101 |  9,101 |  9,101 |
| `main_trace_commit_time_ms` |  1,904 |  1,904 |  1,904 |  1,904 |
| `generate_perm_trace_time_ms` |  262 |  262 |  262 |  262 |
| `perm_trace_commit_time_ms` |  1,983 |  1,983 |  1,983 |  1,983 |
| `quotient_poly_compute_time_ms` |  1,463 |  1,463 |  1,463 |  1,463 |
| `quotient_poly_commit_time_ms` |  1,694 |  1,694 |  1,694 |  1,694 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,545 | 11,207 | 1,603,993 | 334,709,720 | 9,101 | 1,463 | 1,694 | 1,983 | 1,791 | 1,904 | 117,320,757 | 262 | 561 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 172 | 2,440 | 284,567 | 38,417,467 | 2,119 | 226 | 460 | 352 | 655 | 382 | 15,055,723 | 31 | 149 | 

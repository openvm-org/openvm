...
| `total_proof_time_ms ` |  4,014.50 |  8,029 |  4,444 |  3,585 |
| `main_cells_used     ` |  83,255,576 |  166,511,152 |  93,500,799 |  73,010,353 |
| `total_cycles        ` |  2,082,613 |  4,165,226 |  2,243,715 |  1,921,511 |
| `execute_time_ms     ` |  342 |  684 |  380 |  304 |
| `trace_gen_time_ms   ` |  969 |  1,938 |  1,130 |  808 |
| `stark_prove_excluding_trace_time_ms` |  2,703.50 |  5,407 |  2,934 |  2,473 |
| `main_trace_commit_time_ms` |  472 |  944 |  535 |  409 |
| `generate_perm_trace_time_ms` |  187.50 |  375 |  201 |  174 |
| `perm_trace_commit_time_ms` |  689.50 |  1,379 |  741 |  638 |
| `quotient_poly_compute_time_ms` |  389 |  778 |  419 |  359 |
| `quotient_poly_commit_time_ms` |  278.50 |  557 |  316 |  241 |
| `pcs_opening_time_ms ` |  676.50 |  1,353 |  712 |  641 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,280.50 |  14,561 |  7,348 |  7,213 |
| `main_cells_used     ` |  152,277,721 |  304,555,442 |  154,678,006 |  149,877,436 |
| `total_cycles        ` |  1,990,988 |  3,981,976 |  2,021,851 |  1,960,125 |
| `execute_time_ms     ` |  766.50 |  1,533 |  776 |  757 |
| `trace_gen_time_ms   ` |  1,485 |  2,970 |  1,514 |  1,456 |
| `stark_prove_excluding_trace_time_ms` |  5,029 |  10,058 |  5,058 |  5,000 |
| `main_trace_commit_time_ms` |  808 |  1,616 |  809 |  807 |
| `generate_perm_trace_time_ms` |  362.50 |  725 |  364 |  361 |
| `perm_trace_commit_time_ms` |  1,550.50 |  3,101 |  1,577 |  1,524 |
| `quotient_poly_compute_time_ms` |  767 |  1,534 |  769 |  765 |
| `quotient_poly_commit_time_ms` |  492 |  984 |  492 |  492 |
| `pcs_opening_time_ms ` |  1,044 |  2,088 |  1,048 |  1,040 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,514 | 7,348 | 2,021,851 | 538,660,330 | 5,058 | 765 | 492 | 1,577 | 1,048 | 809 | 154,678,006 | 361 | 776 | 
| leaf | 1 | 1,456 | 7,213 | 1,960,125 | 538,660,330 | 5,000 | 769 | 492 | 1,524 | 1,040 | 807 | 149,877,436 | 364 | 757 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,130 | 4,444 | 2,243,715 | 275,652,919 | 2,934 | 419 | 316 | 741 | 712 | 535 | 93,500,799 | 201 | 380 | 
| regex_program | 1 | 808 | 3,585 | 1,921,511 | 242,975,404 | 2,473 | 359 | 241 | 638 | 641 | 409 | 73,010,353 | 174 | 304 | 

...
| `main_cells_used     ` |  245,013,123 |  245,013,123 |  245,013,123 |  245,013,123 |
| `total_cycles        ` |  3,012,565 |  3,012,565 |  3,012,565 |  3,012,565 |
| `execute_time_ms     ` |  1,103 |  1,103 |  1,103 |  1,103 |
| `trace_gen_time_ms   ` |  2,398 |  2,398 |  2,398 |  2,398 |
| `stark_prove_excluding_trace_time_ms` |  8,192 |  8,192 |  8,192 |  8,192 |
| `main_trace_commit_time_ms` |  1,519 |  1,519 |  1,519 |  1,519 |
| `generate_perm_trace_time_ms` |  797 |  797 |  797 |  797 |
| `perm_trace_commit_time_ms` |  2,110 |  2,110 |  2,110 |  2,110 |
| `quotient_poly_compute_time_ms` |  906 |  906 |  906 |  906 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 2,398 | 11,693 | 3,012,565 | 1,008,831,978 | 8,192 | 906 | 643 | 2,110 | 2,210 | 1,519 | 245,013,123 | 797 | 1,103 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 108 | 1,143 | 121,143 | 32,514,138 | 916 | 80 | 126 | 121 | 412 | 134 | 7,489,352 | 29 | 119 | 

...
| `total_proof_time_ms ` |  2,619 |  2,619 |  2,619 |  2,619 |
...
| `stark_prove_excluding_trace_time_ms` |  2,216 |  2,216 |  2,216 |  2,216 |
...
| `quotient_poly_compute_time_ms` |  288 |  288 |  288 |  288 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  22,715 |  22,715 |  22,715 |  22,715 |
| `main_cells_used     ` |  203,549,977 |  203,549,977 |  203,549,977 |  203,549,977 |
| `total_cycles        ` |  4,164,778 |  4,164,778 |  4,164,778 |  4,164,778 |
| `execute_time_ms     ` |  1,050 |  1,050 |  1,050 |  1,050 |
| `trace_gen_time_ms   ` |  3,777 |  3,777 |  3,777 |  3,777 |
| `stark_prove_excluding_trace_time_ms` |  17,888 |  17,888 |  17,888 |  17,888 |
| `main_trace_commit_time_ms` |  3,161 |  3,161 |  3,161 |  3,161 |
| `generate_perm_trace_time_ms` |  419 |  419 |  419 |  419 |
| `perm_trace_commit_time_ms` |  3,734 |  3,734 |  3,734 |  3,734 |
| `quotient_poly_compute_time_ms` |  4,523 |  4,523 |  4,523 |  4,523 |
| `quotient_poly_commit_time_ms` |  2,855 |  2,855 |  2,855 |  2,855 |
| `pcs_opening_time_ms ` |  3,193 |  3,193 |  3,193 |  3,193 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 3,777 | 22,715 | 4,164,778 | 572,214,232 | 17,888 | 4,523 | 2,855 | 3,734 | 3,193 | 3,161 | 203,549,977 | 419 | 1,050 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 256 | 2,619 | 285,401 | 56,172,159 | 2,216 | 288 | 312 | 536 | 640 | 396 | 15,075,033 | 41 | 147 | 

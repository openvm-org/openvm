...
| `total_proof_time_ms ` |  4,208 |  8,416 |  4,658 |  3,758 |
| `main_cells_used     ` |  83,910,936 |  167,821,872 |  94,156,159 |  73,665,713 |
| `total_cycles        ` |  2,082,613 |  4,165,226 |  2,243,715 |  1,921,511 |
| `execute_time_ms     ` |  338.50 |  677 |  377 |  300 |
| `trace_gen_time_ms   ` |  988 |  1,976 |  1,185 |  791 |
| `stark_prove_excluding_trace_time_ms` |  2,881.50 |  5,763 |  3,096 |  2,667 |
| `main_trace_commit_time_ms` |  521 |  1,042 |  580 |  462 |
| `generate_perm_trace_time_ms` |  196 |  392 |  206 |  186 |
| `perm_trace_commit_time_ms` |  751 |  1,502 |  805 |  697 |
| `quotient_poly_compute_time_ms` |  394 |  788 |  425 |  363 |
| `quotient_poly_commit_time_ms` |  303.50 |  607 |  347 |  260 |
| `pcs_opening_time_ms ` |  706 |  1,412 |  724 |  688 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,499 |  14,998 |  7,572 |  7,426 |
| `main_cells_used     ` |  152,277,151 |  304,554,302 |  154,676,458 |  149,877,844 |
| `total_cycles        ` |  1,990,940.50 |  3,981,881 |  2,021,722 |  1,960,159 |
| `execute_time_ms     ` |  752 |  1,504 |  758 |  746 |
| `trace_gen_time_ms   ` |  1,449.50 |  2,899 |  1,471 |  1,428 |
| `stark_prove_excluding_trace_time_ms` |  5,297.50 |  10,595 |  5,343 |  5,252 |
| `main_trace_commit_time_ms` |  893.50 |  1,787 |  895 |  892 |
| `generate_perm_trace_time_ms` |  381.50 |  763 |  400 |  363 |
| `perm_trace_commit_time_ms` |  1,671.50 |  3,343 |  1,708 |  1,635 |
| `quotient_poly_compute_time_ms` |  765 |  1,530 |  768 |  762 |
| `quotient_poly_commit_time_ms` |  523.50 |  1,047 |  524 |  523 |
| `pcs_opening_time_ms ` |  1,057.50 |  2,115 |  1,065 |  1,050 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,471 | 7,572 | 2,021,722 | 538,660,330 | 5,343 | 762 | 524 | 1,708 | 1,050 | 895 | 154,676,458 | 400 | 758 | 
| leaf | 1 | 1,428 | 7,426 | 1,960,159 | 538,660,330 | 5,252 | 768 | 523 | 1,635 | 1,065 | 892 | 149,877,844 | 363 | 746 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,185 | 4,658 | 2,243,715 | 275,652,919 | 3,096 | 425 | 347 | 805 | 724 | 580 | 94,156,159 | 206 | 377 | 
| regex_program | 1 | 791 | 3,758 | 1,921,511 | 242,975,404 | 2,667 | 363 | 260 | 697 | 688 | 462 | 73,665,713 | 186 | 300 | 

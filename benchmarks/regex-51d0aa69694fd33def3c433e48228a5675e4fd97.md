...
| `total_proof_time_ms ` |  3,786 |  7,572 |  4,850 |  2,722 |
...
| `execute_preflight_insn_mi/s` |  28.56 | -          |  31.06 |  26.06 |
| `trace_gen_time_ms   ` |  395 |  790 |  503 |  287 |
| `memory_finalize_time_ms` |  8 |  16 |  14 |  2 |
| `stark_prove_excluding_trace_time_ms` |  3,069 |  6,138 |  4,003 |  2,135 |
| `main_trace_commit_time_ms` |  627 |  1,254 |  833 |  421 |
| `generate_perm_trace_time_ms` |  223.50 |  447 |  302 |  145 |
| `perm_trace_commit_time_ms` |  646.50 |  1,293 |  846 |  447 |
| `quotient_poly_compute_time_ms` |  316.50 |  633 |  431 |  202 |
| `quotient_poly_commit_time_ms` |  298.50 |  597 |  395 |  202 |
| `pcs_opening_time_ms ` |  947.50 |  1,895 |  1,190 |  705 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  5,689.50 |  11,379 |  6,805 |  4,574 |
| `main_cells_used     ` |  122,270,223 |  244,540,446 |  153,709,928 |  90,830,518 |
| `total_cells_used    ` |  304,359,661 |  608,719,322 |  391,464,842 |  217,254,480 |
| `execute_preflight_insns` |  1,663,360 |  3,326,720 |  1,830,114 |  1,496,606 |
| `execute_preflight_time_ms` |  597.50 |  1,195 |  752 |  443 |
| `execute_preflight_insn_mi/s` |  4.20 | -          |  4.35 |  4.05 |
| `trace_gen_time_ms   ` |  298 |  596 |  369 |  227 |
| `memory_finalize_time_ms` |  11 |  22 |  13 |  9 |
| `stark_prove_excluding_trace_time_ms` |  3,781 |  7,562 |  4,682 |  2,880 |
| `main_trace_commit_time_ms` |  709 |  1,418 |  839 |  579 |
| `generate_perm_trace_time_ms` |  325.50 |  651 |  412 |  239 |
| `perm_trace_commit_time_ms` |  976.50 |  1,953 |  1,244 |  709 |
| `quotient_poly_compute_time_ms` |  418 |  836 |  525 |  311 |
| `quotient_poly_commit_time_ms` |  315.50 |  631 |  374 |  257 |
| `pcs_opening_time_ms ` |  1,032 |  2,064 |  1,284 |  780 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 6,807 |  | 1 |  | 1 |  |  |  |  | 
| regex_program |  | 2,722 |  | 7 | 1 | 31 | 4,108,597 | 131.06 | 45 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 227 | 4,574 | 217,254,480 | 319,626,730 | 227 | 2,880 | 0 | 311 | 257 | 709 | 780 | 9 | 579 | 90,830,518 | 239 | 443 | 1,496,606 | 4.05 | 
| leaf | 1 | 369 | 6,805 | 391,464,842 | 538,660,330 | 369 | 4,682 | 0 | 525 | 374 | 1,244 | 1,284 | 13 | 839 | 153,709,928 | 412 | 752 | 1,830,114 | 4.35 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 503 | 4,850 | 211,758,557 | 373,183,036 | 503 | 4,003 | 0 | 431 | 395 | 846 | 1,190 | 7 | 14 | 833 | 91,281,687 | 302 | 101 | 2,211,000 | 26.06 | 
| regex_program | 1 | 287 | 2,722 | 174,326,267 | 196,838,026 | 287 | 2,135 | 54 | 202 | 202 | 447 | 705 | 6 | 2 | 421 | 73,453,305 | 145 | 84 | 1,897,597 | 31.06 | 

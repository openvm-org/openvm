...
| `total_proof_time_ms ` |  595.25 |  2,381 |  711 |  538 |
...
| `execute_metered_insn_mi/s` |  115.34 | -          |  115.34 |  115.34 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  45.25 |  181 |  56 |  34 |
| `execute_preflight_insn_mi/s` |  31.70 | -          |  32.07 |  30.67 |
| `trace_gen_time_ms   ` |  179 |  716 |  194 |  170 |
| `memory_finalize_time_ms` |  1 |  4 |  4 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  297 |  1,188 |  314 |  275 |
| `main_trace_commit_time_ms` |  52.25 |  209 |  57 |  50 |
| `generate_perm_trace_time_ms` |  33.50 |  134 |  51 |  24 |
| `perm_trace_commit_time_ms` |  64.49 |  257.96 |  71.74 |  54.95 |
| `quotient_poly_compute_time_ms` |  60.83 |  243.34 |  72.93 |  53.95 |
| `quotient_poly_commit_time_ms` |  16.09 |  64.35 |  18.75 |  13.58 |
| `pcs_opening_time_ms ` |  66.50 |  266 |  74 |  62 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,396.75 |  5,587 |  2,024 |  892 |
...
| `execute_preflight_time_ms` |  624.25 |  2,497 |  830 |  226 |
| `execute_preflight_insn_mi/s` |  7.10 | -          |  7.50 |  6.83 |
| `trace_gen_time_ms   ` |  86.25 |  345 |  159 |  57 |
| `memory_finalize_time_ms` |  9 |  36 |  16 |  6 |
| `stark_prove_excluding_trace_time_ms` |  684.75 |  2,739 |  1,092 |  508 |
| `main_trace_commit_time_ms` |  124 |  496 |  193 |  91 |
| `generate_perm_trace_time_ms` |  61.25 |  245 |  85 |  36 |
| `perm_trace_commit_time_ms` |  200.19 |  800.75 |  342.32 |  142.47 |
| `quotient_poly_compute_time_ms` |  146.95 |  587.80 |  241.46 |  103.93 |
| `quotient_poly_commit_time_ms` |  31.67 |  126.67 |  51.18 |  23.89 |
| `pcs_opening_time_ms ` |  116.25 |  465 |  172 |  94 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 2,026 |  | 1 | 1 |  |  |  |  | 
| regex_program |  | 560 |  | 1 | 35 | 4,137,502 | 115.34 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 70 | 892 | 22,981,570 | 319,331,818 | 70 | 594 | 0 | 136.45 | 26.69 | 4 | 172.70 | 94 | 214 | 94 | 7 | 121 | 9,122,488 | 40 | 226 | 1,466,043 | 7.50 | 31 | 164 | 0 | 94 | 
| leaf | 1 | 59 | 1,398 | 20,905,034 | 255,237,610 | 59 | 508 | 0 | 105.97 | 24.91 | 4 | 142.47 | 105 | 179 | 105 | 7 | 91 | 8,256,948 | 36 | 830 | 1,241,439 | 7.08 | 26 | 131 | 0 | 105 | 
| leaf | 2 | 57 | 1,273 | 20,905,034 | 255,237,610 | 57 | 545 | 0 | 103.93 | 23.89 | 4 | 143.26 | 94 | 229 | 94 | 6 | 91 | 8,256,948 | 85 | 669 | 1,241,405 | 7.01 | 26 | 128 | 0 | 94 | 
| leaf | 3 | 159 | 2,024 | 50,337,320 | 538,365,418 | 159 | 1,092 | 0 | 241.46 | 51.18 | 4 | 342.32 | 172 | 428 | 172 | 16 | 193 | 20,171,106 | 84 | 772 | 1,814,591 | 6.83 | 61 | 297 | 4 | 172 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 170 | 711 | 23,446,148 | 150,778,428 | 170 | 314 | 0 | 61.95 | 18.75 | 5 | 71.74 | 74 | 101 | 74 | 4 | 57 | 10,899,170 | 28 | 56 | 1,103,000 | 30.67 | 22 | 81 | 1 | 74 | 
| regex_program | 1 | 176 | 538 | 11,598,276 | 128,513,066 | 176 | 275 | 1 | 53.95 | 15.52 | 4 | 65.24 | 63 | 90 | 63 | 0 | 51 | 2,196,106 | 24 | 45 | 1,104,000 | 32.05 | 17 | 70 | 0 | 63 | 
| regex_program | 2 | 176 | 572 | 11,579,064 | 128,513,066 | 176 | 309 | 1 | 54.51 | 16.50 | 4 | 66.02 | 67 | 118 | 67 | 0 | 51 | 2,177,334 | 51 | 46 | 1,104,000 | 32.07 | 17 | 71 | 0 | 67 | 
| regex_program | 3 | 194 | 560 | 11,853,872 | 103,456,394 | 194 | 290 | 0 | 72.93 | 13.58 | 5 | 54.95 | 62 | 89 | 61 | 0 | 50 | 2,422,606 | 31 | 34 | 826,502 | 32.01 | 19 | 87 | 1 | 61 | 

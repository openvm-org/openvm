...
| `quotient_poly_commit_time_ms` |  149 |  149 |  149 |  149 |
| `pcs_opening_time_ms ` |  449 |  449 |  449 |  449 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  12,033 |  12,033 |  12,033 |  12,033 |
| `main_cells_used     ` |  244,253,654 |  244,253,654 |  244,253,654 |  244,253,654 |
| `total_cycles        ` |  2,988,612 |  2,988,612 |  2,988,612 |  2,988,612 |
| `execute_time_ms     ` |  1,100 |  1,100 |  1,100 |  1,100 |
| `trace_gen_time_ms   ` |  2,349 |  2,349 |  2,349 |  2,349 |
| `stark_prove_excluding_trace_time_ms` |  8,584 |  8,584 |  8,584 |  8,584 |
| `main_trace_commit_time_ms` |  1,684 |  1,684 |  1,684 |  1,684 |
| `generate_perm_trace_time_ms` |  769 |  769 |  769 |  769 |
| `perm_trace_commit_time_ms` |  2,415 |  2,415 |  2,415 |  2,415 |
| `quotient_poly_compute_time_ms` |  1,213 |  1,213 |  1,213 |  1,213 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 2,349 | 12,033 | 2,988,612 | 1,008,831,978 | 8,584 | 1,213 | 704 | 2,415 | 1,795 | 1,684 | 244,253,654 | 769 | 1,100 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 180 | 1,421 | 289,447 | 48,240,297 | 1,095 | 108 | 149 | 163 | 449 | 178 | 14,470,186 | 34 | 146 | 

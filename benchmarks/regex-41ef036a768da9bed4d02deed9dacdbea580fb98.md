...
| `total_proof_time_ms ` |  1,480.50 |  2,961 |  1,715 |  1,246 |
...
| `execute_preflight_time_ms` |  97.50 |  195 |  111 |  84 |
| `execute_preflight_insn_mi/s` |  30.87 | -          |  32.77 |  28.97 |
| `trace_gen_time_ms   ` |  313.50 |  627 |  335 |  292 |
| `memory_finalize_time_ms` |  2 |  4 |  4 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  983 |  1,966 |  1,213 |  753 |
| `main_trace_commit_time_ms` |  141 |  282 |  184 |  98 |
| `generate_perm_trace_time_ms` |  58.50 |  117 |  63 |  54 |
| `perm_trace_commit_time_ms` |  172.65 |  345.29 |  223.62 |  121.67 |
| `quotient_poly_compute_time_ms` |  157.95 |  315.89 |  168.07 |  147.82 |
| `quotient_poly_commit_time_ms` |  36.89 |  73.79 |  48.35 |  25.44 |
| `pcs_opening_time_ms ` |  409.50 |  819 |  542 |  277 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  2,092 |  4,184 |  2,881 |  1,303 |
...
| `execute_preflight_time_ms` |  597 |  1,194 |  937 |  257 |
| `execute_preflight_insn_mi/s` |  7.17 | -          |  7.51 |  6.83 |
| `trace_gen_time_ms   ` |  126 |  252 |  175 |  77 |
| `memory_finalize_time_ms` |  11.50 |  23 |  17 |  6 |
| `stark_prove_excluding_trace_time_ms` |  1,367.50 |  2,735 |  1,768 |  967 |
| `main_trace_commit_time_ms` |  180.50 |  361 |  229 |  132 |
| `generate_perm_trace_time_ms` |  75.50 |  151 |  97 |  54 |
| `perm_trace_commit_time_ms` |  277.63 |  555.25 |  368.49 |  186.76 |
| `quotient_poly_compute_time_ms` |  177.55 |  355.09 |  228.46 |  126.64 |
| `quotient_poly_commit_time_ms` |  43.55 |  87.10 |  57.53 |  29.57 |
| `pcs_opening_time_ms ` |  609 |  1,218 |  783 |  435 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 2,883 |  | 1 |  | 1 |  |  |  |  | 
| regex_program |  | 1,246 |  | 40 | 1 | 42 | 4,108,483 | 95.57 | 166 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 77 | 1,303 | 23,479,090 | 319,626,730 | 77 | 967 | 0 | 126.64 | 29.57 | 4 | 186.76 | 435 | 242 | 434 | 6 | 132 | 9,325,224 | 54 | 257 | 1,496,665 | 7.51 | 29 | 157 | 1 | 434 | 
| leaf | 1 | 175 | 2,881 | 50,586,080 | 538,660,330 | 175 | 1,768 | 0 | 228.46 | 57.53 | 5 | 368.49 | 783 | 466 | 783 | 17 | 229 | 20,272,474 | 97 | 937 | 1,829,999 | 6.83 | 56 | 288 | 1 | 783 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 292 | 1,715 | 23,397,108 | 373,183,036 | 292 | 1,213 | 0 | 147.82 | 48.35 | 6 | 223.62 | 542 | 287 | 542 | 4 | 184 | 10,866,434 | 63 | 84 | 2,211,000 | 28.97 | 46 | 198 | 2 | 542 | 
| regex_program | 1 | 335 | 1,246 | 11,981,356 | 196,739,722 | 335 | 753 | 2 | 168.07 | 25.44 | 5 | 121.67 | 277 | 179 | 276 | 0 | 98 | 2,537,170 | 54 | 111 | 1,897,483 | 32.77 | 27 | 198 | 3 | 276 | 

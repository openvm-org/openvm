...
| `total_proof_time_ms ` |  2,173 |  2,173 |  2,173 |  2,173 |
...
| `stark_prove_excluding_trace_time_ms` |  1,728 |  1,728 |  1,728 |  1,728 |
| `main_trace_commit_time_ms` |  320 |  320 |  320 |  320 |
| `generate_perm_trace_time_ms` |  39 |  39 |  39 |  39 |
| `perm_trace_commit_time_ms` |  295 |  295 |  295 |  295 |
| `quotient_poly_compute_time_ms` |  234 |  234 |  234 |  234 |
| `quotient_poly_commit_time_ms` |  389 |  389 |  389 |  389 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| verify_fibair | 335 | 2,173 | 513,915 | 44,140,184 | 1,728 | 234 | 389 | 295 | 448 | 320 | 19,377,671 | 39 | 110 | 

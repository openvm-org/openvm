...
| `total_proof_time_ms ` |  591 |  2,364 |  713 |  524 |
...
| `execute_preflight_insn_mi/s` |  30.56 | -          |  31.97 |  27.51 |
| `trace_gen_time_ms   ` |  178.50 |  714 |  212 |  156 |
| `memory_finalize_time_ms` |  1 |  4 |  4 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  290.75 |  1,163 |  308 |  261 |
| `main_trace_commit_time_ms` |  51.50 |  206 |  57 |  49 |
| `generate_perm_trace_time_ms` |  32.25 |  129 |  50 |  23 |
| `perm_trace_commit_time_ms` |  64.07 |  256.29 |  70.70 |  54.66 |
| `quotient_poly_compute_time_ms` |  59.76 |  239.02 |  71.67 |  52.87 |
| `quotient_poly_commit_time_ms` |  15.24 |  60.97 |  17.65 |  12.97 |
| `pcs_opening_time_ms ` |  64.75 |  259 |  73 |  53 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,375.50 |  5,502 |  2,073 |  883 |
...
| `execute_preflight_insns` |  1,440,862 |  5,763,448 |  1,814,613 |  1,241,387 |
| `execute_preflight_time_ms` |  612.25 |  2,449 |  806 |  223 |
| `execute_preflight_insn_mi/s` |  7.18 | -          |  7.54 |  6.89 |
| `trace_gen_time_ms   ` |  85.50 |  342 |  159 |  57 |
| `memory_finalize_time_ms` |  8 |  32 |  15 |  5 |
| `stark_prove_excluding_trace_time_ms` |  676.50 |  2,706 |  1,153 |  471 |
| `main_trace_commit_time_ms` |  125 |  500 |  195 |  91 |
| `generate_perm_trace_time_ms` |  53.50 |  214 |  103 |  34 |
| `perm_trace_commit_time_ms` |  210.99 |  843.98 |  384.96 |  143.44 |
| `quotient_poly_compute_time_ms` |  141.31 |  565.25 |  232.40 |  100.73 |
| `quotient_poly_commit_time_ms` |  31.41 |  125.63 |  55.26 |  22.90 |
| `pcs_opening_time_ms ` |  109.75 |  439 |  175 |  75 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 2,075 |  | 1 | 1 |  |  |  |  | 
| regex_program |  | 562 |  | 1 | 36 | 4,137,502 | 112.59 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 68 | 883 | 22,981,570 | 319,331,818 | 68 | 590 | 0 | 130.80 | 24.52 | 4 | 172.06 | 96 | 214 | 96 | 7 | 122 | 9,122,488 | 41 | 223 | 1,466,043 | 7.54 | 31 | 156 | 0 | 96 | 
| leaf | 1 | 58 | 1,336 | 20,905,034 | 255,237,610 | 58 | 471 | 0 | 101.32 | 22.90 | 4 | 143.53 | 75 | 178 | 75 | 5 | 91 | 8,256,948 | 34 | 806 | 1,241,387 | 7.16 | 26 | 125 | 0 | 75 | 
| leaf | 2 | 57 | 1,210 | 20,905,034 | 255,237,610 | 57 | 492 | 0 | 100.73 | 22.95 | 4 | 143.44 | 93 | 181 | 93 | 5 | 92 | 8,256,948 | 36 | 660 | 1,241,405 | 7.12 | 26 | 124 | 0 | 93 | 
| leaf | 3 | 159 | 2,073 | 50,337,320 | 538,365,418 | 159 | 1,153 | 0 | 232.40 | 55.26 | 4 | 384.96 | 175 | 489 | 175 | 15 | 195 | 20,171,106 | 103 | 760 | 1,814,613 | 6.89 | 61 | 292 | 5 | 175 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 212 | 713 | 23,446,148 | 150,778,428 | 212 | 308 | 0 | 61.25 | 17.65 | 5 | 70.70 | 73 | 97 | 73 | 4 | 57 | 10,899,170 | 26 | 47 | 1,103,000 | 27.51 | 21 | 79 | 1 | 73 | 
| regex_program | 1 | 156 | 524 | 11,598,276 | 128,513,066 | 156 | 261 | 1 | 52.87 | 14.85 | 4 | 65.05 | 53 | 89 | 53 | 0 | 50 | 2,196,106 | 23 | 66 | 1,104,000 | 31.35 | 16 | 68 | 0 | 53 | 
| regex_program | 2 | 162 | 565 | 11,579,064 | 128,513,066 | 162 | 302 | 1 | 53.24 | 15.50 | 4 | 65.87 | 66 | 116 | 66 | 0 | 49 | 2,177,334 | 50 | 59 | 1,104,000 | 31.42 | 16 | 69 | 0 | 66 | 
| regex_program | 3 | 184 | 562 | 11,853,872 | 103,456,394 | 184 | 292 | 0 | 71.67 | 12.97 | 5 | 54.66 | 67 | 87 | 67 | 0 | 50 | 2,422,606 | 30 | 45 | 826,502 | 31.97 | 18 | 85 | 1 | 67 | 

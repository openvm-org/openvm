...
| `total_proof_time_ms ` |  585 |  2,340 |  730 |  524 |
...
| `execute_preflight_insn_mi/s` |  30.45 | -          |  31.77 |  27.85 |
| `trace_gen_time_ms   ` |  179 |  716 |  211 |  155 |
| `memory_finalize_time_ms` |  1 |  4 |  4 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  283.25 |  1,133 |  327 |  259 |
| `main_trace_commit_time_ms` |  52 |  208 |  57 |  50 |
| `generate_perm_trace_time_ms` |  33.50 |  134 |  54 |  18 |
| `perm_trace_commit_time_ms` |  64.29 |  257.16 |  70.61 |  55.94 |
| `quotient_poly_compute_time_ms` |  59.07 |  236.27 |  69.51 |  52.76 |
| `quotient_poly_commit_time_ms` |  14.97 |  59.86 |  18.25 |  12.32 |
| `pcs_opening_time_ms ` |  56 |  224 |  63 |  46 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,373.50 |  5,494 |  2,001 |  885 |
...
| `execute_preflight_insns` |  1,440,841.25 |  5,763,365 |  1,814,630 |  1,241,330 |
| `execute_preflight_time_ms` |  613.25 |  2,453 |  804 |  221 |
| `execute_preflight_insn_mi/s` |  7.21 | -          |  7.60 |  6.97 |
| `trace_gen_time_ms   ` |  87.50 |  350 |  166 |  57 |
| `memory_finalize_time_ms` |  8.25 |  33 |  16 |  5 |
| `stark_prove_excluding_trace_time_ms` |  672 |  2,688 |  1,070 |  483 |
| `main_trace_commit_time_ms` |  126 |  504 |  196 |  92 |
| `generate_perm_trace_time_ms` |  46.50 |  186 |  73 |  36 |
| `perm_trace_commit_time_ms` |  200.98 |  803.94 |  344.18 |  142.36 |
| `quotient_poly_compute_time_ms` |  143 |  572.01 |  235.08 |  101.26 |
| `quotient_poly_commit_time_ms` |  31.45 |  125.79 |  52.35 |  23 |
| `pcs_opening_time_ms ` |  120.50 |  482 |  164 |  81 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 2,003 |  | 1 | 1 |  |  |  |  | 
| regex_program |  | 541 |  | 1 | 37 | 4,137,502 | 111.68 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 69 | 885 | 22,981,570 | 319,331,818 | 69 | 594 | 0 | 132.79 | 26.14 | 4 | 172.98 | 96 | 214 | 96 | 6 | 123 | 9,122,488 | 40 | 221 | 1,466,042 | 7.60 | 31 | 160 | 0 | 96 | 
| leaf | 1 | 58 | 1,404 | 20,905,034 | 255,237,610 | 58 | 541 | 0 | 102.89 | 24.30 | 4 | 142.36 | 141 | 179 | 140 | 6 | 92 | 8,256,948 | 36 | 804 | 1,241,363 | 7.16 | 26 | 128 | 0 | 140 | 
| leaf | 2 | 57 | 1,204 | 20,905,034 | 255,237,610 | 57 | 483 | 0 | 101.26 | 23 | 4 | 144.42 | 81 | 182 | 80 | 5 | 93 | 8,256,948 | 37 | 663 | 1,241,330 | 7.14 | 25 | 125 | 0 | 80 | 
| leaf | 3 | 166 | 2,001 | 50,337,320 | 538,365,418 | 166 | 1,070 | 0 | 235.08 | 52.35 | 4 | 344.18 | 164 | 418 | 164 | 16 | 196 | 20,171,106 | 73 | 765 | 1,814,630 | 6.97 | 61 | 291 | 4 | 164 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 211 | 730 | 23,446,148 | 150,778,428 | 211 | 327 | 0 | 60.57 | 18.25 | 5 | 70.61 | 63 | 126 | 63 | 4 | 57 | 10,899,170 | 54 | 47 | 1,103,000 | 27.85 | 22 | 79 | 1 | 63 | 
| regex_program | 1 | 155 | 545 | 11,598,276 | 128,513,066 | 155 | 279 | 1 | 53.43 | 14.85 | 4 | 64.93 | 58 | 101 | 58 | 0 | 50 | 2,196,106 | 35 | 68 | 1,104,000 | 30.45 | 16 | 68 | 0 | 58 | 
| regex_program | 2 | 164 | 524 | 11,579,064 | 128,513,066 | 164 | 259 | 1 | 52.76 | 14.44 | 4 | 65.68 | 46 | 93 | 46 | 0 | 51 | 2,177,334 | 27 | 59 | 1,104,000 | 31.77 | 16 | 67 | 0 | 46 | 
| regex_program | 3 | 186 | 541 | 11,853,872 | 103,456,394 | 186 | 268 | 0 | 69.51 | 12.32 | 5 | 55.94 | 57 | 77 | 56 | 0 | 50 | 2,422,606 | 18 | 45 | 826,502 | 31.74 | 18 | 82 | 1 | 56 | 

...
| `total_proof_time_ms ` |  710 |  1,420 |  830 |  590 |
...
| `execute_preflight_time_ms` |  83 |  166 |  108 |  58 |
| `execute_preflight_insn_mi/s` |  14.77 | -          |  18.55 |  10.99 |
| `trace_gen_time_ms   ` |  190 |  380 |  196 |  184 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  343 |  686 |  393 |  293 |
| `main_trace_commit_time_ms` |  63.50 |  127 |  74 |  53 |
| `generate_perm_trace_time_ms` |  36.50 |  73 |  41 |  32 |
| `perm_trace_commit_time_ms` |  77.11 |  154.22 |  89.15 |  65.07 |
| `quotient_poly_compute_time_ms` |  78.93 |  157.85 |  87.16 |  70.69 |
| `quotient_poly_commit_time_ms` |  15.82 |  31.63 |  17.17 |  14.46 |
| `pcs_opening_time_ms ` |  65.50 |  131 |  79 |  52 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,482 |  2,964 |  1,737 |  1,227 |
...
| `execute_preflight_time_ms` |  581.50 |  1,163 |  869 |  294 |
| `execute_preflight_insn_mi/s` |  7.61 | -          |  7.63 |  7.60 |
| `trace_gen_time_ms   ` |  116.50 |  233 |  124 |  109 |
| `memory_finalize_time_ms` |  10.50 |  21 |  11 |  10 |
| `stark_prove_excluding_trace_time_ms` |  783 |  1,566 |  808 |  758 |
| `main_trace_commit_time_ms` |  145.50 |  291 |  148 |  143 |
| `generate_perm_trace_time_ms` |  57.50 |  115 |  62 |  53 |
| `perm_trace_commit_time_ms` |  226.03 |  452.05 |  231.01 |  221.04 |
| `quotient_poly_compute_time_ms` |  168.49 |  336.97 |  169.49 |  167.48 |
| `quotient_poly_commit_time_ms` |  30.43 |  60.87 |  31.88 |  28.98 |
| `pcs_opening_time_ms ` |  151.50 |  303 |  171 |  132 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 1,739 |  | 1 | 1 |  |  |  |  | 
| pairing |  | 590 |  | 1 | 67 | 1,745,742 | 25.78 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 124 | 1,227 | 39,650,868 | 410,701,290 | 124 | 808 | 0 | 169.49 | 31.88 | 4 | 231.01 | 171 | 285 | 171 | 11 | 148 | 16,332,746 | 53 | 294 | 1,991,982 | 7.63 | 39 | 202 | 0 | 171 | 
| leaf | 1 | 109 | 1,737 | 39,014,972 | 396,840,426 | 109 | 758 | 0 | 167.48 | 28.98 | 4 | 221.04 | 132 | 284 | 132 | 10 | 143 | 16,068,198 | 62 | 869 | 1,912,900 | 7.60 | 38 | 197 | 0 | 132 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 184 | 830 | 32,689,110 | 172,558,444 | 184 | 393 | 0 | 87.16 | 17.17 | 6 | 89.15 | 79 | 133 | 79 | 1 | 74 | 16,059,916 | 41 | 108 | 1,157,000 | 10.99 | 26 | 105 | 1 | 79 | 
| pairing | 1 | 196 | 590 | 22,314,288 | 119,958,502 | 196 | 293 | 1 | 70.69 | 14.46 | 5 | 65.07 | 52 | 101 | 52 | 0 | 53 | 9,408,294 | 32 | 58 | 588,742 | 18.55 | 20 | 85 | 1 | 52 | 

...
| `total_proof_time_ms ` |  2,613 |  2,613 |  2,613 |  2,613 |
...
| `main_trace_commit_time_ms` |  385 |  385 |  385 |  385 |
| `generate_perm_trace_time_ms` |  40 |  40 |  40 |  40 |
| `perm_trace_commit_time_ms` |  549 |  549 |  549 |  549 |
| `quotient_poly_compute_time_ms` |  296 |  296 |  296 |  296 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  21,387 |  21,387 |  21,387 |  21,387 |
| `main_cells_used     ` |  202,801,986 |  202,801,986 |  202,801,986 |  202,801,986 |
| `total_cycles        ` |  4,138,473 |  4,138,473 |  4,138,473 |  4,138,473 |
| `execute_time_ms     ` |  969 |  969 |  969 |  969 |
| `trace_gen_time_ms   ` |  3,769 |  3,769 |  3,769 |  3,769 |
| `stark_prove_excluding_trace_time_ms` |  16,649 |  16,649 |  16,649 |  16,649 |
| `main_trace_commit_time_ms` |  2,981 |  2,981 |  2,981 |  2,981 |
| `generate_perm_trace_time_ms` |  371 |  371 |  371 |  371 |
| `perm_trace_commit_time_ms` |  3,345 |  3,345 |  3,345 |  3,345 |
| `quotient_poly_compute_time_ms` |  4,482 |  4,482 |  4,482 |  4,482 |
| `quotient_poly_commit_time_ms` |  2,567 |  2,567 |  2,567 |  2,567 |
| `pcs_opening_time_ms ` |  2,901 |  2,901 |  2,901 |  2,901 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 3,769 | 21,387 | 4,138,473 | 508,251,096 | 16,649 | 4,482 | 2,567 | 3,345 | 2,901 | 2,981 | 202,801,986 | 371 | 969 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 263 | 2,613 | 285,401 | 56,172,159 | 2,206 | 296 | 310 | 549 | 622 | 385 | 15,075,033 | 40 | 144 | 

...
| `total_proof_time_ms ` |  6,987 |  13,974 |  7,850 |  6,124 |
| `main_cells_used     ` |  82,727,686.50 |  165,455,373 |  92,686,348 |  72,769,025 |
| `total_cycles        ` |  1,914,103 |  1,914,103 |  1,914,103 |  1,914,103 |
| `execute_time_ms     ` |  442.50 |  885 |  475 |  410 |
| `trace_gen_time_ms   ` |  1,104 |  2,208 |  1,271 |  937 |
| `stark_prove_excluding_trace_time_ms` |  5,440.50 |  10,881 |  6,104 |  4,777 |
| `main_trace_commit_time_ms` |  1,037 |  2,074 |  1,277 |  797 |
| `generate_perm_trace_time_ms` |  181 |  362 |  197 |  165 |
| `perm_trace_commit_time_ms` |  1,166 |  2,332 |  1,206 |  1,126 |
| `quotient_poly_compute_time_ms` |  751 |  1,502 |  867 |  635 |
| `quotient_poly_commit_time_ms` |  966.50 |  1,933 |  1,114 |  819 |
| `pcs_opening_time_ms ` |  1,327.50 |  2,655 |  1,434 |  1,221 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  8,051.50 |  16,103 |  8,305 |  7,798 |
| `main_cells_used     ` |  77,286,795.50 |  154,573,591 |  78,374,882 |  76,198,709 |
| `total_cycles        ` |  1,028,167.50 |  2,056,335 |  1,045,586 |  1,010,749 |
| `execute_time_ms     ` |  373.50 |  747 |  410 |  337 |
| `trace_gen_time_ms   ` |  1,151 |  2,302 |  1,241 |  1,061 |
| `stark_prove_excluding_trace_time_ms` |  6,527 |  13,054 |  6,834 |  6,220 |
| `main_trace_commit_time_ms` |  1,320.50 |  2,641 |  1,369 |  1,272 |
| `generate_perm_trace_time_ms` |  162 |  324 |  175 |  149 |
| `perm_trace_commit_time_ms` |  1,312 |  2,624 |  1,367 |  1,257 |
| `quotient_poly_compute_time_ms` |  972.50 |  1,945 |  1,045 |  900 |
| `quotient_poly_commit_time_ms` |  1,298.50 |  2,597 |  1,351 |  1,246 |
| `pcs_opening_time_ms ` |  1,456.50 |  2,913 |  1,522 |  1,391 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,061 | 8,305 | 1,045,586 | 220,669,656 | 6,834 | 1,045 | 1,351 | 1,367 | 1,522 | 1,369 | 78,374,882 | 175 | 410 | 
| leaf | 1 | 1,241 | 7,798 | 1,010,749 | 194,986,968 | 6,220 | 900 | 1,246 | 1,257 | 1,391 | 1,272 | 76,198,709 | 149 | 337 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,271 | 7,850 |  | 209,921,543 | 6,104 | 867 | 1,114 | 1,206 | 1,434 | 1,277 | 92,686,348 | 197 | 475 | 
| regex_program | 1 | 937 | 6,124 | 1,914,103 | 149,454,692 | 4,777 | 635 | 819 | 1,126 | 1,221 | 797 | 72,769,025 | 165 | 410 | 

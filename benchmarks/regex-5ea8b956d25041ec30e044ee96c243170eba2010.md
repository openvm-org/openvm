...
| `total_proof_time_ms ` |  588.25 |  2,353 |  741 |  534 |
...
| `execute_metered_insn_mi/s` |  114.11 | -          |  114.11 |  114.11 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  57.25 |  229 |  71 |  47 |
| `execute_preflight_insn_mi/s` |  30.22 | -          |  31.18 |  27.84 |
| `trace_gen_time_ms   ` |  174 |  696 |  208 |  150 |
| `memory_finalize_time_ms` |  1 |  4 |  4 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  288.25 |  1,153 |  338 |  268 |
| `main_trace_commit_time_ms` |  51.50 |  206 |  56 |  50 |
| `generate_perm_trace_time_ms` |  34 |  136 |  54 |  18 |
| `perm_trace_commit_time_ms` |  63.85 |  255.39 |  69.50 |  55.79 |
| `quotient_poly_compute_time_ms` |  58.49 |  233.97 |  69.29 |  52.23 |
| `quotient_poly_commit_time_ms` |  15.03 |  60.11 |  17.96 |  12.67 |
| `pcs_opening_time_ms ` |  62.25 |  249 |  78 |  53 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,405 |  5,620 |  2,056 |  895 |
...
| `execute_preflight_insns` |  1,440,856.25 |  5,763,425 |  1,814,630 |  1,241,327 |
| `execute_preflight_time_ms` |  657.25 |  2,629 |  872 |  223 |
| `execute_preflight_insn_mi/s` |  7.29 | -          |  7.64 |  6.94 |
| `trace_gen_time_ms   ` |  87 |  348 |  163 |  57 |
| `memory_finalize_time_ms` |  7.75 |  31 |  15 |  5 |
| `stark_prove_excluding_trace_time_ms` |  659.25 |  2,637 |  1,070 |  471 |
| `main_trace_commit_time_ms` |  124 |  496 |  193 |  91 |
| `generate_perm_trace_time_ms` |  48.25 |  193 |  72 |  36 |
| `perm_trace_commit_time_ms` |  199.28 |  797.12 |  341.90 |  141.75 |
| `quotient_poly_compute_time_ms` |  140.89 |  563.56 |  230.20 |  100.26 |
| `quotient_poly_commit_time_ms` |  30.32 |  121.28 |  50.63 |  22.61 |
| `pcs_opening_time_ms ` |  112.25 |  449 |  176 |  73 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 2,058 |  | 1 | 1 |  |  |  |  | 
| regex_program |  | 539 |  | 1 | 36 | 4,137,502 | 114.11 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 70 | 895 | 22,981,570 | 319,331,818 | 70 | 602 | 0 | 131.65 | 24.81 | 4 | 171.26 | 103 | 219 | 102 | 6 | 121 | 9,122,488 | 47 | 223 | 1,465,998 | 7.64 | 30 | 157 | 0 | 102 | 
| leaf | 1 | 57 | 1,402 | 20,905,034 | 255,237,610 | 57 | 471 | 0 | 100.26 | 23.23 | 4 | 142.21 | 73 | 181 | 73 | 5 | 91 | 8,256,948 | 38 | 872 | 1,241,470 | 7.23 | 25 | 124 | 0 | 73 | 
| leaf | 2 | 58 | 1,267 | 20,905,034 | 255,237,610 | 58 | 494 | 0 | 101.45 | 22.61 | 4 | 141.75 | 97 | 179 | 97 | 5 | 91 | 8,256,948 | 36 | 713 | 1,241,327 | 7.34 | 26 | 125 | 0 | 97 | 
| leaf | 3 | 163 | 2,056 | 50,337,320 | 538,365,418 | 163 | 1,070 | 0 | 230.20 | 50.63 | 4 | 341.90 | 176 | 415 | 176 | 15 | 193 | 20,171,106 | 72 | 821 | 1,814,630 | 6.94 | 61 | 284 | 5 | 176 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 208 | 741 | 23,446,148 | 150,778,428 | 208 | 338 | 0 | 59.76 | 17.96 | 5 | 69.50 | 78 | 125 | 78 | 4 | 56 | 10,899,170 | 54 | 47 | 1,103,000 | 27.84 | 22 | 78 | 1 | 78 | 
| regex_program | 1 | 150 | 539 | 11,598,276 | 128,513,066 | 150 | 276 | 1 | 52.69 | 14.89 | 5 | 65.72 | 53 | 103 | 53 | 0 | 50 | 2,196,106 | 37 | 71 | 1,104,000 | 30.94 | 16 | 68 | 0 | 53 | 
| regex_program | 2 | 158 | 534 | 11,579,064 | 128,513,066 | 158 | 271 | 1 | 52.23 | 14.59 | 4 | 64.38 | 61 | 91 | 61 | 0 | 50 | 2,177,334 | 27 | 63 | 1,104,000 | 31.18 | 16 | 67 | 0 | 61 | 
| regex_program | 3 | 180 | 539 | 11,853,872 | 103,456,394 | 180 | 268 | 0 | 69.29 | 12.67 | 5 | 55.79 | 57 | 77 | 57 | 0 | 50 | 2,422,606 | 18 | 48 | 826,502 | 30.92 | 18 | 83 | 1 | 57 | 

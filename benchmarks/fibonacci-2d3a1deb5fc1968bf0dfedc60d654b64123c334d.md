...
| `stark_prove_excluding_trace_time_ms` |  4,068 |  4,068 |  4,068 |  4,068 |
...
| `quotient_poly_compute_time_ms` |  525 |  525 |  525 |  525 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  4,113 |  4,113 |  4,113 |  4,113 |
| `main_cells_used     ` |  38,847,280 |  38,847,280 |  38,847,280 |  38,847,280 |
| `total_cycles        ` |  815,560 |  815,560 |  815,560 |  815,560 |
| `execute_time_ms     ` |  274 |  274 |  274 |  274 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 651 | 4,113 | 815,560 | 95,033,826 | 3,188 | 470 | 649 | 608 | 724 | 644 | 38,847,280 | 85 | 274 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 614 | 4,976 | 1,500,096 | 122,458,688 | 4,068 | 525 | 767 | 793 | 968 | 852 | 51,485,167 | 159 | 294 | 

...
| `total_proof_time_ms ` |  2,528 |  2,528 |  2,528 |  2,528 |
...
| `pcs_opening_time_ms ` |  698 |  698 |  698 |  698 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  13,396 |  13,396 |  13,396 |  13,396 |
| `main_cells_used     ` |  133,786,481 |  133,786,481 |  133,786,481 |  133,786,481 |
| `total_cycles        ` |  2,253,367 |  2,253,367 |  2,253,367 |  2,253,367 |
| `execute_time_ms     ` |  753 |  753 |  753 |  753 |
| `trace_gen_time_ms   ` |  1,746 |  1,746 |  1,746 |  1,746 |
| `stark_prove_excluding_trace_time_ms` |  10,897 |  10,897 |  10,897 |  10,897 |
| `main_trace_commit_time_ms` |  2,295 |  2,295 |  2,295 |  2,295 |
| `generate_perm_trace_time_ms` |  314 |  314 |  314 |  314 |
| `perm_trace_commit_time_ms` |  2,315 |  2,315 |  2,315 |  2,315 |
| `quotient_poly_compute_time_ms` |  1,631 |  1,631 |  1,631 |  1,631 |
| `quotient_poly_commit_time_ms` |  2,005 |  2,005 |  2,005 |  2,005 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,746 | 13,396 | 2,253,367 | 377,489,890 | 10,897 | 1,631 | 2,005 | 2,315 | 2,331 | 2,295 | 133,786,481 | 314 | 753 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 182 | 2,528 | 295,181 | 38,665,477 | 2,197 | 224 | 488 | 356 | 698 | 383 | 15,586,346 | 34 | 149 | 

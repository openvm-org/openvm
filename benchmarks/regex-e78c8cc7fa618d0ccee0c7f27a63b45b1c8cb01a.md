...
| `total_proof_time_ms ` |  3,819.50 |  7,639 |  4,904 |  2,735 |
...
| `execute_preflight_time_ms` |  93 |  186 |  101 |  85 |
| `execute_preflight_insn_mi/s` |  28.54 | -          |  30.74 |  26.33 |
| `trace_gen_time_ms   ` |  378 |  756 |  485 |  271 |
| `memory_finalize_time_ms` |  7.50 |  15 |  13 |  2 |
| `stark_prove_excluding_trace_time_ms` |  3,116.50 |  6,233 |  4,075 |  2,158 |
| `main_trace_commit_time_ms` |  628 |  1,256 |  844 |  412 |
| `generate_perm_trace_time_ms` |  245.50 |  491 |  333 |  158 |
| `perm_trace_commit_time_ms` |  664.50 |  1,329 |  877 |  452 |
| `quotient_poly_compute_time_ms` |  312.50 |  625 |  425 |  200 |
| `quotient_poly_commit_time_ms` |  303 |  606 |  399 |  207 |
| `pcs_opening_time_ms ` |  953 |  1,906 |  1,191 |  715 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  5,688.50 |  11,377 |  6,844 |  4,533 |
| `main_cells_used     ` |  122,270,199 |  244,540,398 |  153,709,772 |  90,830,626 |
| `total_cells_used    ` |  304,359,581 |  608,719,162 |  391,464,322 |  217,254,840 |
| `execute_preflight_insns` |  1,663,358 |  3,326,716 |  1,830,101 |  1,496,615 |
| `execute_preflight_time_ms` |  575 |  1,150 |  720 |  430 |
| `execute_preflight_insn_mi/s` |  4.40 | -          |  4.57 |  4.24 |
| `trace_gen_time_ms   ` |  285.50 |  571 |  352 |  219 |
| `memory_finalize_time_ms` |  11.50 |  23 |  14 |  9 |
| `stark_prove_excluding_trace_time_ms` |  3,779 |  7,558 |  4,725 |  2,833 |
| `main_trace_commit_time_ms` |  715 |  1,430 |  839 |  591 |
| `generate_perm_trace_time_ms` |  313 |  626 |  400 |  226 |
| `perm_trace_commit_time_ms` |  956.50 |  1,913 |  1,242 |  671 |
| `quotient_poly_compute_time_ms` |  430 |  860 |  552 |  308 |
| `quotient_poly_commit_time_ms` |  317.50 |  635 |  378 |  257 |
| `pcs_opening_time_ms ` |  1,042.50 |  2,085 |  1,308 |  777 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 6,846 |  | 1 |  | 1 |  |  |  |  | 
| regex_program |  | 2,735 |  | 7 | 1 | 32 | 4,108,597 | 127.33 | 46 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 219 | 4,533 | 217,254,840 | 319,626,730 | 219 | 2,833 | 0 | 308 | 257 | 671 | 777 | 9 | 591 | 90,830,626 | 226 | 430 | 1,496,615 | 4.24 | 
| leaf | 1 | 352 | 6,844 | 391,464,322 | 538,660,330 | 352 | 4,725 | 0 | 552 | 378 | 1,242 | 1,308 | 14 | 839 | 153,709,772 | 400 | 720 | 1,830,101 | 4.57 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 485 | 4,904 | 211,758,557 | 373,183,036 | 485 | 4,075 | 0 | 425 | 399 | 877 | 1,191 | 7 | 13 | 844 | 91,281,687 | 333 | 101 | 2,211,000 | 26.33 | 
| regex_program | 1 | 271 | 2,735 | 174,326,267 | 196,838,026 | 271 | 2,158 | 50 | 200 | 207 | 452 | 715 | 6 | 2 | 412 | 73,453,305 | 158 | 85 | 1,897,597 | 30.74 | 

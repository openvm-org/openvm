...
| `stark_prove_excluding_trace_time_ms` |  1,147 |  1,147 |  1,147 |  1,147 |
| `main_trace_commit_time_ms` |  186 |  186 |  186 |  186 |
| `generate_perm_trace_time_ms` |  32 |  32 |  32 |  32 |
| `perm_trace_commit_time_ms` |  203 |  203 |  203 |  203 |
| `quotient_poly_compute_time_ms` |  125 |  125 |  125 |  125 |
| `quotient_poly_commit_time_ms` |  166 |  166 |  166 |  166 |
| `pcs_opening_time_ms ` |  421 |  421 |  421 |  421 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  13,086 |  13,086 |  13,086 |  13,086 |
| `main_cells_used     ` |  244,122,111 |  244,122,111 |  244,122,111 |  244,122,111 |
| `total_cycles        ` |  2,989,588 |  2,989,588 |  2,989,588 |  2,989,588 |
| `execute_time_ms     ` |  1,107 |  1,107 |  1,107 |  1,107 |
| `trace_gen_time_ms   ` |  2,326 |  2,326 |  2,326 |  2,326 |
| `stark_prove_excluding_trace_time_ms` |  9,653 |  9,653 |  9,653 |  9,653 |
| `main_trace_commit_time_ms` |  1,750 |  1,750 |  1,750 |  1,750 |
| `generate_perm_trace_time_ms` |  705 |  705 |  705 |  705 |
| `perm_trace_commit_time_ms` |  3,174 |  3,174 |  3,174 |  3,174 |
| `quotient_poly_compute_time_ms` |  1,331 |  1,331 |  1,331 |  1,331 |
| `quotient_poly_commit_time_ms` |  884 |  884 |  884 |  884 |
| `pcs_opening_time_ms ` |  1,806 |  1,806 |  1,806 |  1,806 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 2,326 | 13,086 | 2,989,588 | 999,394,794 | 9,653 | 1,331 | 884 | 3,174 | 1,806 | 1,750 | 244,122,111 | 705 | 1,107 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 181 | 1,479 | 295,181 | 48,197,161 | 1,147 | 125 | 166 | 203 | 421 | 186 | 15,586,346 | 32 | 151 | 

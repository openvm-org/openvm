...
| `main_cells_used     ` |  8,227,838 |  8,227,838 |  8,227,838 |  8,227,838 |
| `total_cycles        ` |  140,486 |  140,486 |  140,486 |  140,486 |
| `execute_time_ms     ` |  123 |  123 |  123 |  123 |
| `trace_gen_time_ms   ` |  106 |  106 |  106 |  106 |
| `stark_prove_excluding_trace_time_ms` |  910 |  910 |  910 |  910 |
| `main_trace_commit_time_ms` |  132 |  132 |  132 |  132 |
| `generate_perm_trace_time_ms` |  37 |  37 |  37 |  37 |
| `perm_trace_commit_time_ms` |  119 |  119 |  119 |  119 |
| `quotient_poly_compute_time_ms` |  81 |  81 |  81 |  81 |
| `quotient_poly_commit_time_ms` |  121 |  121 |  121 |  121 |
| `pcs_opening_time_ms ` |  405 |  405 |  405 |  405 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  11,648 |  11,648 |  11,648 |  11,648 |
| `main_cells_used     ` |  243,578,802 |  243,578,802 |  243,578,802 |  243,578,802 |
| `total_cycles        ` |  2,973,846 |  2,973,846 |  2,973,846 |  2,973,846 |
| `execute_time_ms     ` |  1,117 |  1,117 |  1,117 |  1,117 |
| `trace_gen_time_ms   ` |  2,360 |  2,360 |  2,360 |  2,360 |
| `stark_prove_excluding_trace_time_ms` |  8,171 |  8,171 |  8,171 |  8,171 |
| `main_trace_commit_time_ms` |  1,511 |  1,511 |  1,511 |  1,511 |
| `generate_perm_trace_time_ms` |  789 |  789 |  789 |  789 |
| `perm_trace_commit_time_ms` |  2,113 |  2,113 |  2,113 |  2,113 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 2,360 | 11,648 | 2,973,846 | 1,008,831,978 | 8,171 | 909 | 639 | 2,113 | 2,206 | 1,511 | 243,578,802 | 789 | 1,117 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 106 | 1,139 | 140,486 | 32,659,506 | 910 | 81 | 121 | 119 | 405 | 132 | 8,227,838 | 37 | 123 | 

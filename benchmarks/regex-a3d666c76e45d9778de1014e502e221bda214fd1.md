...
| `total_proof_time_ms ` |  14,628 |  14,628 |  14,628 |  14,628 |
| `main_cells_used     ` |  165,010,909 |  165,010,909 |  165,010,909 |  165,010,909 |
| `total_cycles        ` |  4,190,904 |  4,190,904 |  4,190,904 |  4,190,904 |
| `execute_time_ms     ` |  1,002 |  1,002 |  1,002 |  1,002 |
| `trace_gen_time_ms   ` |  2,874 |  2,874 |  2,874 |  2,874 |
| `stark_prove_excluding_trace_time_ms` |  10,752 |  10,752 |  10,752 |  10,752 |
| `main_trace_commit_time_ms` |  2,410 |  2,410 |  2,410 |  2,410 |
| `generate_perm_trace_time_ms` |  388 |  388 |  388 |  388 |
| `perm_trace_commit_time_ms` |  2,161 |  2,161 |  2,161 |  2,161 |
| `quotient_poly_compute_time_ms` |  1,530 |  1,530 |  1,530 |  1,530 |
| `quotient_poly_commit_time_ms` |  1,867 |  1,867 |  1,867 |  1,867 |
| `pcs_opening_time_ms ` |  2,387 |  2,387 |  2,387 |  2,387 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  15,117 |  15,117 |  15,117 |  15,117 |
| `main_cells_used     ` |  140,888,821 |  140,888,821 |  140,888,821 |  140,888,821 |
| `total_cycles        ` |  3,128,272 |  3,128,272 |  3,128,272 |  3,128,272 |
| `execute_time_ms     ` |  753 |  753 |  753 |  753 |
| `trace_gen_time_ms   ` |  2,841 |  2,841 |  2,841 |  2,841 |
| `stark_prove_excluding_trace_time_ms` |  11,523 |  11,523 |  11,523 |  11,523 |
| `main_trace_commit_time_ms` |  2,412 |  2,412 |  2,412 |  2,412 |
| `generate_perm_trace_time_ms` |  291 |  291 |  291 |  291 |
| `perm_trace_commit_time_ms` |  2,349 |  2,349 |  2,349 |  2,349 |
| `quotient_poly_compute_time_ms` |  1,671 |  1,671 |  1,671 |  1,671 |
| `quotient_poly_commit_time_ms` |  2,239 |  2,239 |  2,239 |  2,239 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 2,841 | 15,117 | 3,128,272 | 360,334,296 | 11,523 | 1,671 | 2,239 | 2,349 | 2,557 | 2,412 | 140,888,821 | 291 | 753 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 2,874 | 14,628 | 4,190,904 | 384,102,008 | 10,752 | 1,530 | 1,867 | 2,161 | 2,387 | 2,410 | 165,010,909 | 388 | 1,002 | 

...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  13,089 |  13,089 |  13,089 |  13,089 |
| `main_cells_used     ` |  244,104,881 |  244,104,881 |  244,104,881 |  244,104,881 |
| `total_cycles        ` |  2,988,899 |  2,988,899 |  2,988,899 |  2,988,899 |
| `execute_time_ms     ` |  1,094 |  1,094 |  1,094 |  1,094 |
| `trace_gen_time_ms   ` |  2,316 |  2,316 |  2,316 |  2,316 |
| `stark_prove_excluding_trace_time_ms` |  9,679 |  9,679 |  9,679 |  9,679 |
| `main_trace_commit_time_ms` |  1,751 |  1,751 |  1,751 |  1,751 |
| `generate_perm_trace_time_ms` |  682 |  682 |  682 |  682 |
| `perm_trace_commit_time_ms` |  3,208 |  3,208 |  3,208 |  3,208 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 2,316 | 13,089 | 2,988,899 | 999,394,794 | 9,679 | 1,338 | 885 | 3,208 | 1,810 | 1,751 | 244,104,881 | 682 | 1,094 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 181 | 1,470 | 295,291 | 48,197,161 | 1,140 | 126 | 164 | 203 | 417 | 182 | 15,588,656 | 32 | 149 | 

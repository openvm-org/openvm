...
| `total_proof_time_ms ` |  711.50 |  1,423 |  828 |  595 |
...
| `execute_preflight_insn_mi/s` |  13.26 | -          |  17.50 |  9.02 |
| `trace_gen_time_ms   ` |  180 |  360 |  197 |  163 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  343 |  686 |  390 |  296 |
| `main_trace_commit_time_ms` |  64.50 |  129 |  75 |  54 |
| `generate_perm_trace_time_ms` |  32.50 |  65 |  36 |  29 |
| `perm_trace_commit_time_ms` |  78.10 |  156.19 |  90.87 |  65.33 |
| `quotient_poly_compute_time_ms` |  80.47 |  160.93 |  89.53 |  71.40 |
| `quotient_poly_commit_time_ms` |  16.56 |  33.13 |  18.75 |  14.38 |
| `pcs_opening_time_ms ` |  66 |  132 |  74 |  58 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,472 |  2,944 |  1,729 |  1,215 |
| `main_cells_used     ` |  16,200,472 |  32,400,944 |  16,332,746 |  16,068,198 |
| `total_cells_used    ` |  39,332,920 |  78,665,840 |  39,650,868 |  39,014,972 |
| `execute_preflight_insns` |  1,952,320 |  3,904,640 |  1,991,842 |  1,912,798 |
| `execute_preflight_time_ms` |  591 |  1,182 |  876 |  306 |
| `execute_preflight_insn_mi/s` |  7.41 | -          |  7.48 |  7.35 |
| `trace_gen_time_ms   ` |  121 |  242 |  130 |  112 |
| `memory_finalize_time_ms` |  11.50 |  23 |  12 |  11 |
| `stark_prove_excluding_trace_time_ms` |  759 |  1,518 |  778 |  740 |
| `main_trace_commit_time_ms` |  148 |  296 |  152 |  144 |
| `generate_perm_trace_time_ms` |  55.50 |  111 |  57 |  54 |
| `perm_trace_commit_time_ms` |  229.12 |  458.24 |  233.35 |  224.88 |
| `quotient_poly_compute_time_ms` |  170.78 |  341.57 |  172.21 |  169.36 |
| `quotient_poly_commit_time_ms` |  32.17 |  64.35 |  32.99 |  31.36 |
| `pcs_opening_time_ms ` |  119.50 |  239 |  127 |  112 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 1,731 |  | 1 |  | 1 |  |  |  |  | 
| pairing |  | 595 |  | 66 | 1 | 89 | 1,745,742 | 19.42 | 171 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 130 | 1,215 | 39,650,868 | 410,701,290 | 130 | 778 | 0 | 172.21 | 32.99 | 4 | 233.35 | 127 | 292 | 127 | 12 | 152 | 16,332,746 | 57 | 306 | 1,991,842 | 7.35 | 39 | 206 | 0 | 127 | 
| leaf | 1 | 112 | 1,729 | 39,014,972 | 396,840,426 | 112 | 740 | 0 | 169.36 | 31.36 | 4 | 224.88 | 112 | 280 | 112 | 11 | 144 | 16,068,198 | 54 | 876 | 1,912,798 | 7.48 | 38 | 202 | 0 | 112 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 163 | 828 | 32,689,110 | 172,558,444 | 163 | 390 | 0 | 89.53 | 18.75 | 6 | 90.87 | 74 | 130 | 73 | 1 | 75 | 16,059,916 | 36 | 132 | 1,157,000 | 9.02 | 27 | 109 | 1 | 73 | 
| pairing | 1 | 197 | 595 | 22,314,288 | 119,958,502 | 197 | 296 | 1 | 71.40 | 14.38 | 6 | 65.33 | 58 | 97 | 58 | 0 | 54 | 9,408,294 | 29 | 60 | 588,742 | 17.50 | 20 | 86 | 1 | 58 | 

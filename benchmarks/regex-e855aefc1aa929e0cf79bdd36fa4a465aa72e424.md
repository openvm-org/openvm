...
| `total_proof_time_ms ` |  14,632 |  14,632 |  14,632 |  14,632 |
| `main_cells_used     ` |  165,010,909 |  165,010,909 |  165,010,909 |  165,010,909 |
| `total_cycles        ` |  4,190,904 |  4,190,904 |  4,190,904 |  4,190,904 |
| `execute_time_ms     ` |  1,001 |  1,001 |  1,001 |  1,001 |
| `trace_gen_time_ms   ` |  2,958 |  2,958 |  2,958 |  2,958 |
| `stark_prove_excluding_trace_time_ms` |  10,673 |  10,673 |  10,673 |  10,673 |
| `main_trace_commit_time_ms` |  2,411 |  2,411 |  2,411 |  2,411 |
| `generate_perm_trace_time_ms` |  369 |  369 |  369 |  369 |
| `perm_trace_commit_time_ms` |  2,120 |  2,120 |  2,120 |  2,120 |
| `quotient_poly_compute_time_ms` |  1,527 |  1,527 |  1,527 |  1,527 |
| `quotient_poly_commit_time_ms` |  1,862 |  1,862 |  1,862 |  1,862 |
| `pcs_opening_time_ms ` |  2,376 |  2,376 |  2,376 |  2,376 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  15,109 |  15,109 |  15,109 |  15,109 |
| `main_cells_used     ` |  140,890,111 |  140,890,111 |  140,890,111 |  140,890,111 |
| `total_cycles        ` |  3,128,401 |  3,128,401 |  3,128,401 |  3,128,401 |
| `execute_time_ms     ` |  742 |  742 |  742 |  742 |
| `trace_gen_time_ms   ` |  2,806 |  2,806 |  2,806 |  2,806 |
| `stark_prove_excluding_trace_time_ms` |  11,561 |  11,561 |  11,561 |  11,561 |
| `main_trace_commit_time_ms` |  2,407 |  2,407 |  2,407 |  2,407 |
| `generate_perm_trace_time_ms` |  290 |  290 |  290 |  290 |
| `perm_trace_commit_time_ms` |  2,350 |  2,350 |  2,350 |  2,350 |
| `quotient_poly_compute_time_ms` |  1,633 |  1,633 |  1,633 |  1,633 |
| `quotient_poly_commit_time_ms` |  2,234 |  2,234 |  2,234 |  2,234 |
| `pcs_opening_time_ms ` |  2,643 |  2,643 |  2,643 |  2,643 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 2,806 | 15,109 | 3,128,401 | 360,334,296 | 11,561 | 1,633 | 2,234 | 2,350 | 2,643 | 2,407 | 140,890,111 | 290 | 742 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 2,958 | 14,632 | 4,190,904 | 384,102,008 | 10,673 | 1,527 | 1,862 | 2,120 | 2,376 | 2,411 | 165,010,909 | 369 | 1,001 | 

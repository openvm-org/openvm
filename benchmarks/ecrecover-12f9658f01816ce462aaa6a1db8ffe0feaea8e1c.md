...
| `total_proof_time_ms ` |  2,598 |  2,598 |  2,598 |  2,598 |
...
| `main_cells_used     ` |  203,551,527 |  203,551,527 |  203,551,527 |  203,551,527 |
| `total_cycles        ` |  4,164,933 |  4,164,933 |  4,164,933 |  4,164,933 |
| `execute_time_ms     ` |  1,067 |  1,067 |  1,067 |  1,067 |
| `trace_gen_time_ms   ` |  3,725 |  3,725 |  3,725 |  3,725 |
| `stark_prove_excluding_trace_time_ms` |  18,079 |  18,079 |  18,079 |  18,079 |
| `main_trace_commit_time_ms` |  3,154 |  3,154 |  3,154 |  3,154 |
| `generate_perm_trace_time_ms` |  415 |  415 |  415 |  415 |
| `perm_trace_commit_time_ms` |  3,721 |  3,721 |  3,721 |  3,721 |
| `quotient_poly_compute_time_ms` |  4,830 |  4,830 |  4,830 |  4,830 |
| `quotient_poly_commit_time_ms` |  2,784 |  2,784 |  2,784 |  2,784 |
| `pcs_opening_time_ms ` |  3,173 |  3,173 |  3,173 |  3,173 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 3,725 | 22,871 | 4,164,933 | 572,214,232 | 18,079 | 4,830 | 2,784 | 3,721 | 3,173 | 3,154 | 203,551,527 | 415 | 1,067 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 253 | 2,598 | 285,401 | 56,172,159 | 2,197 | 301 | 302 | 532 | 618 | 400 | 15,075,033 | 41 | 148 | 

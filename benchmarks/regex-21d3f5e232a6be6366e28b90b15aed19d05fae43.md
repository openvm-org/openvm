...
| `total_proof_time_ms ` |  1,491.50 |  2,983 |  1,723 |  1,260 |
...
| `execute_preflight_time_ms` |  98 |  196 |  111 |  85 |
| `execute_preflight_insn_mi/s` |  29.62 | -          |  31.10 |  28.14 |
| `trace_gen_time_ms   ` |  312.50 |  625 |  333 |  292 |
| `memory_finalize_time_ms` |  2 |  4 |  4 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  992.50 |  1,985 |  1,218 |  767 |
| `main_trace_commit_time_ms` |  141.50 |  283 |  184 |  99 |
| `generate_perm_trace_time_ms` |  60.50 |  121 |  66 |  55 |
| `perm_trace_commit_time_ms` |  173.33 |  346.65 |  225.56 |  121.09 |
| `quotient_poly_compute_time_ms` |  168.18 |  336.37 |  187.66 |  148.71 |
| `quotient_poly_commit_time_ms` |  37.17 |  74.33 |  48.84 |  25.49 |
| `pcs_opening_time_ms ` |  405.50 |  811 |  541 |  270 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  2,069.50 |  4,139 |  2,829 |  1,310 |
| `main_cells_used     ` |  14,798,849 |  29,597,698 |  20,272,474 |  9,325,224 |
| `total_cells_used    ` |  37,032,585 |  74,065,170 |  50,586,080 |  23,479,090 |
| `execute_preflight_insns` |  1,663,362.50 |  3,326,725 |  1,830,060 |  1,496,665 |
| `execute_preflight_time_ms` |  576.50 |  1,153 |  889 |  264 |
| `execute_preflight_insn_mi/s` |  6.97 | -          |  7.24 |  6.71 |
| `trace_gen_time_ms   ` |  121 |  242 |  166 |  76 |
| `memory_finalize_time_ms` |  11.50 |  23 |  16 |  7 |
| `stark_prove_excluding_trace_time_ms` |  1,370.50 |  2,741 |  1,772 |  969 |
| `main_trace_commit_time_ms` |  181.50 |  363 |  230 |  133 |
| `generate_perm_trace_time_ms` |  76.50 |  153 |  98 |  55 |
| `perm_trace_commit_time_ms` |  277.82 |  555.64 |  368.32 |  187.32 |
| `quotient_poly_compute_time_ms` |  177.98 |  355.96 |  228.04 |  127.92 |
| `quotient_poly_commit_time_ms` |  43.16 |  86.32 |  56.76 |  29.56 |
| `pcs_opening_time_ms ` |  610 |  1,220 |  786 |  434 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 2,831 |  | 1 |  | 1 |  |  |  |  | 
| regex_program |  | 1,260 |  | 40 | 1 | 42 | 4,108,483 | 96.51 | 166 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 76 | 1,310 | 23,479,090 | 319,626,730 | 76 | 969 | 0 | 127.92 | 29.56 | 4 | 187.32 | 434 | 243 | 434 | 7 | 133 | 9,325,224 | 55 | 264 | 1,496,665 | 7.24 | 29 | 158 | 1 | 434 | 
| leaf | 1 | 166 | 2,829 | 50,586,080 | 538,660,330 | 166 | 1,772 | 0 | 228.04 | 56.76 | 4 | 368.32 | 786 | 467 | 785 | 16 | 230 | 20,272,474 | 98 | 889 | 1,830,060 | 6.71 | 56 | 287 | 1 | 785 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 292 | 1,723 | 23,397,108 | 373,183,036 | 292 | 1,218 | 0 | 148.71 | 48.84 | 6 | 225.56 | 541 | 292 | 541 | 4 | 184 | 10,866,434 | 66 | 85 | 2,211,000 | 28.14 | 46 | 199 | 2 | 541 | 
| regex_program | 1 | 333 | 1,260 | 11,981,356 | 196,739,722 | 333 | 767 | 2 | 187.66 | 25.49 | 6 | 121.09 | 270 | 179 | 270 | 0 | 99 | 2,537,170 | 55 | 111 | 1,897,483 | 31.10 | 26 | 218 | 2 | 270 | 

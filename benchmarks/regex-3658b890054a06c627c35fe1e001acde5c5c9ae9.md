...
| `total_proof_time_ms ` |  4,188 |  8,376 |  4,638 |  3,738 |
...
| `trace_gen_time_ms   ` |  990.50 |  1,981 |  1,175 |  806 |
| `stark_prove_excluding_trace_time_ms` |  2,863 |  5,726 |  3,092 |  2,634 |
...
| `quotient_poly_compute_time_ms` |  397.50 |  795 |  426 |  369 |
| `quotient_poly_commit_time_ms` |  298 |  596 |  338 |  258 |
| `pcs_opening_time_ms ` |  691.50 |  1,383 |  727 |  656 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,534 |  15,068 |  7,635 |  7,433 |
| `main_cells_used     ` |  152,278,225 |  304,556,450 |  154,677,874 |  149,878,576 |
| `total_cycles        ` |  1,991,030 |  3,982,060 |  2,021,840 |  1,960,220 |
| `execute_time_ms     ` |  757.50 |  1,515 |  767 |  748 |
| `trace_gen_time_ms   ` |  1,482 |  2,964 |  1,523 |  1,441 |
| `stark_prove_excluding_trace_time_ms` |  5,294.50 |  10,589 |  5,345 |  5,244 |
| `main_trace_commit_time_ms` |  891.50 |  1,783 |  894 |  889 |
| `generate_perm_trace_time_ms` |  375.50 |  751 |  390 |  361 |
| `perm_trace_commit_time_ms` |  1,669 |  3,338 |  1,702 |  1,636 |
| `quotient_poly_compute_time_ms` |  772.50 |  1,545 |  775 |  770 |
| `quotient_poly_commit_time_ms` |  525 |  1,050 |  527 |  523 |
| `pcs_opening_time_ms ` |  1,056.50 |  2,113 |  1,057 |  1,056 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,523 | 7,635 | 2,021,840 | 538,660,330 | 5,345 | 775 | 523 | 1,702 | 1,057 | 894 | 154,677,874 | 390 | 767 | 
| leaf | 1 | 1,441 | 7,433 | 1,960,220 | 538,660,330 | 5,244 | 770 | 527 | 1,636 | 1,056 | 889 | 149,878,576 | 361 | 748 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,175 | 4,638 | 2,243,715 | 275,652,919 | 3,092 | 426 | 338 | 804 | 727 | 582 | 94,156,159 | 205 | 371 | 
| regex_program | 1 | 806 | 3,738 | 1,921,511 | 242,975,404 | 2,634 | 369 | 258 | 696 | 656 | 455 | 73,665,713 | 192 | 298 | 

...
| `total_proof_time_ms ` |  585 |  2,340 |  704 |  542 |
...
| `execute_metered_insn_mi/s` |  118.82 | -          |  118.82 |  118.82 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  54.50 |  218 |  67 |  45 |
| `execute_preflight_insn_mi/s` |  30.12 | -          |  31.31 |  27.07 |
| `trace_gen_time_ms   ` |  178.75 |  715 |  211 |  156 |
| `memory_finalize_time_ms` |  1 |  4 |  4 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  284 |  1,136 |  301 |  270 |
| `main_trace_commit_time_ms` |  52.25 |  209 |  57 |  50 |
| `generate_perm_trace_time_ms` |  22.50 |  90 |  27 |  20 |
| `perm_trace_commit_time_ms` |  65.77 |  263.09 |  73.60 |  56.32 |
| `quotient_poly_compute_time_ms` |  59.27 |  237.07 |  70.34 |  52.83 |
| `quotient_poly_commit_time_ms` |  15.40 |  61.60 |  18.15 |  13.12 |
| `pcs_opening_time_ms ` |  66.25 |  265 |  71 |  56 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,382.75 |  5,531 |  2,046 |  884 |
...
| `execute_preflight_time_ms` |  619.75 |  2,479 |  840 |  224 |
| `execute_preflight_insn_mi/s` |  7.08 | -          |  7.51 |  6.88 |
| `trace_gen_time_ms   ` |  87 |  348 |  162 |  57 |
| `memory_finalize_time_ms` |  8.50 |  34 |  17 |  5 |
| `stark_prove_excluding_trace_time_ms` |  675 |  2,700 |  1,126 |  491 |
| `main_trace_commit_time_ms` |  125.25 |  501 |  195 |  91 |
| `generate_perm_trace_time_ms` |  49.50 |  198 |  81 |  34 |
| `perm_trace_commit_time_ms` |  201 |  804.01 |  342.86 |  143.50 |
| `quotient_poly_compute_time_ms` |  141.57 |  566.30 |  232.37 |  100.23 |
| `quotient_poly_commit_time_ms` |  30.24 |  120.96 |  50.86 |  22.58 |
| `pcs_opening_time_ms ` |  123.25 |  493 |  218 |  84 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 2,048 |  | 1 |  | 1 |  |  |  |  | 
| regex_program |  | 542 |  | 65 | 1 | 34 | 4,137,502 | 118.82 | 193 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 69 | 884 | 22,981,570 | 319,331,818 | 69 | 591 | 0 | 132.32 | 24.73 | 4 | 173.38 | 95 | 214 | 95 | 6 | 122 | 9,122,488 | 40 | 224 | 1,466,048 | 7.51 | 30 | 158 | 0 | 95 | 
| leaf | 1 | 60 | 1,393 | 20,905,034 | 255,237,610 | 60 | 492 | 0 | 100.23 | 22.58 | 4 | 144.27 | 96 | 179 | 96 | 6 | 91 | 8,256,948 | 34 | 840 | 1,241,376 | 6.96 | 25 | 123 | 0 | 96 | 
| leaf | 2 | 57 | 1,208 | 20,905,034 | 255,237,610 | 57 | 491 | 0 | 101.38 | 22.80 | 4 | 143.50 | 84 | 187 | 84 | 5 | 93 | 8,256,948 | 43 | 659 | 1,241,388 | 6.97 | 26 | 125 | 0 | 84 | 
| leaf | 3 | 162 | 2,046 | 50,337,320 | 538,365,418 | 162 | 1,126 | 0 | 232.37 | 50.86 | 4 | 342.86 | 218 | 425 | 218 | 17 | 195 | 20,171,106 | 81 | 756 | 1,814,622 | 6.88 | 61 | 286 | 5 | 218 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 211 | 704 | 23,446,148 | 150,778,428 | 211 | 301 | 0 | 60.42 | 18.15 | 5 | 73.60 | 67 | 97 | 66 | 4 | 57 | 10,899,170 | 23 | 47 | 1,103,000 | 27.07 | 22 | 79 | 1 | 66 | 
| regex_program | 1 | 156 | 546 | 11,598,276 | 128,513,066 | 156 | 281 | 1 | 53.48 | 15.51 | 4 | 68.01 | 71 | 89 | 71 | 0 | 51 | 2,196,106 | 20 | 67 | 1,104,000 | 30.100 | 16 | 69 | 0 | 71 | 
| regex_program | 2 | 163 | 548 | 11,579,064 | 128,513,066 | 163 | 284 | 1 | 52.83 | 14.82 | 4 | 65.17 | 71 | 92 | 71 | 0 | 51 | 2,177,334 | 27 | 59 | 1,104,000 | 31.10 | 16 | 68 | 0 | 71 | 
| regex_program | 3 | 185 | 542 | 11,853,872 | 103,456,394 | 185 | 270 | 0 | 70.34 | 13.12 | 5 | 56.32 | 56 | 79 | 55 | 0 | 50 | 2,422,606 | 20 | 45 | 826,502 | 31.31 | 18 | 84 | 1 | 55 | 

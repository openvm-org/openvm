...
| `total_proof_time_ms ` |  1,147 |  1,147 |  1,147 |  1,147 |
| `main_cells_used     ` |  7,621,824 |  7,621,824 |  7,621,824 |  7,621,824 |
| `total_cycles        ` |  124,323 |  124,323 |  124,323 |  124,323 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  11,634 |  11,634 |  11,634 |  11,634 |
| `main_cells_used     ` |  245,011,971 |  245,011,971 |  245,011,971 |  245,011,971 |
| `total_cycles        ` |  3,012,469 |  3,012,469 |  3,012,469 |  3,012,469 |
| `execute_time_ms     ` |  1,118 |  1,118 |  1,118 |  1,118 |
| `trace_gen_time_ms   ` |  2,342 |  2,342 |  2,342 |  2,342 |
| `stark_prove_excluding_trace_time_ms` |  8,174 |  8,174 |  8,174 |  8,174 |
...
| `quotient_poly_compute_time_ms` |  900 |  900 |  900 |  900 |
| `quotient_poly_commit_time_ms` |  641 |  641 |  641 |  641 |
| `pcs_opening_time_ms ` |  2,207 |  2,207 |  2,207 |  2,207 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 2,342 | 11,634 | 3,012,469 | 1,008,831,978 | 8,174 | 900 | 641 | 2,115 | 2,207 | 1,515 | 245,011,971 | 791 | 1,118 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 109 | 1,147 | 124,323 | 32,514,138 | 919 | 77 | 132 | 125 | 410 | 134 | 7,621,824 | 27 | 119 | 

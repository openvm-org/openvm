...
| `total_proof_time_ms ` |  3,860 |  7,720 |  4,446 |  3,274 |
...
| `trace_gen_time_ms   ` |  965 |  1,930 |  1,153 |  777 |
| `stark_prove_excluding_trace_time_ms` |  2,558 |  5,116 |  2,919 |  2,197 |
| `main_trace_commit_time_ms` |  445.50 |  891 |  525 |  366 |
| `generate_perm_trace_time_ms` |  165.50 |  331 |  184 |  147 |
| `perm_trace_commit_time_ms` |  640 |  1,280 |  742 |  538 |
| `quotient_poly_compute_time_ms` |  365 |  730 |  423 |  307 |
| `quotient_poly_commit_time_ms` |  271.50 |  543 |  317 |  226 |
| `pcs_opening_time_ms ` |  659 |  1,318 |  717 |  601 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,475 |  14,950 |  7,560 |  7,390 |
| `main_cells_used     ` |  152,233,496 |  304,466,992 |  154,691,060 |  149,775,932 |
| `total_cycles        ` |  1,990,773.50 |  3,981,547 |  2,021,570 |  1,959,977 |
| `execute_time_ms     ` |  757 |  1,514 |  764 |  750 |
| `trace_gen_time_ms   ` |  1,449 |  2,898 |  1,481 |  1,417 |
| `stark_prove_excluding_trace_time_ms` |  5,269 |  10,538 |  5,315 |  5,223 |
| `main_trace_commit_time_ms` |  894 |  1,788 |  899 |  889 |
| `generate_perm_trace_time_ms` |  339.50 |  679 |  342 |  337 |
| `perm_trace_commit_time_ms` |  1,673 |  3,346 |  1,694 |  1,652 |
| `quotient_poly_compute_time_ms` |  763 |  1,526 |  764 |  762 |
| `quotient_poly_commit_time_ms` |  522.50 |  1,045 |  524 |  521 |
| `pcs_opening_time_ms ` |  1,072 |  2,144 |  1,090 |  1,054 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,481 | 7,560 | 2,021,570 | 533,941,738 | 5,315 | 762 | 524 | 1,694 | 1,090 | 899 | 154,691,060 | 342 | 764 | 
| leaf | 1 | 1,417 | 7,390 | 1,959,977 | 533,941,738 | 5,223 | 764 | 521 | 1,652 | 1,054 | 889 | 149,775,932 | 337 | 750 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,153 | 4,446 | 2,225,434 | 275,652,919 | 2,919 | 423 | 317 | 742 | 717 | 525 | 93,699,990 | 184 | 374 | 
| regex_program | 1 | 777 | 3,274 | 1,914,730 | 198,099,628 | 2,197 | 307 | 226 | 538 | 601 | 366 | 73,689,460 | 147 | 300 | 

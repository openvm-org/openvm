...
| `trace_gen_time_ms   ` |  981 |  981 |  981 |  981 |
| `stark_prove_excluding_trace_time_ms` |  3,203 |  3,203 |  3,203 |  3,203 |
| `main_trace_commit_time_ms` |  592 |  592 |  592 |  592 |
...
| `pcs_opening_time_ms ` |  817 |  817 |  817 |  817 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  14,137 |  14,137 |  14,137 |  14,137 |
| `main_cells_used     ` |  273,857,052 |  273,857,052 |  273,857,052 |  273,857,052 |
| `total_cycles        ` |  3,267,434 |  3,267,434 |  3,267,434 |  3,267,434 |
| `execute_time_ms     ` |  1,182 |  1,182 |  1,182 |  1,182 |
| `trace_gen_time_ms   ` |  2,604 |  2,604 |  2,604 |  2,604 |
| `stark_prove_excluding_trace_time_ms` |  10,351 |  10,351 |  10,351 |  10,351 |
| `main_trace_commit_time_ms` |  1,774 |  1,774 |  1,774 |  1,774 |
| `generate_perm_trace_time_ms` |  766 |  766 |  766 |  766 |
| `perm_trace_commit_time_ms` |  3,393 |  3,393 |  3,393 |  3,393 |
| `quotient_poly_compute_time_ms` |  1,483 |  1,483 |  1,483 |  1,483 |
| `quotient_poly_commit_time_ms` |  963 |  963 |  963 |  963 |
| `pcs_opening_time_ms ` |  1,967 |  1,967 |  1,967 |  1,967 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 2,604 | 14,137 | 3,267,434 | 1,081,183,722 | 10,351 | 1,483 | 963 | 3,393 | 1,967 | 1,774 | 273,857,052 | 766 | 1,182 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 981 | 4,842 | 1,820,436 | 297,675,351 | 3,203 | 472 | 333 | 770 | 817 | 592 | 96,487,767 | 201 | 658 | 

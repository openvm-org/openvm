...
| `total_proof_time_ms ` |  589 |  2,356 |  705 |  545 |
...
| `execute_preflight_insn_mi/s` |  31.96 | -          |  32.50 |  30.62 |
| `trace_gen_time_ms   ` |  182.25 |  729 |  197 |  174 |
| `memory_finalize_time_ms` |  1 |  4 |  4 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  287.50 |  1,150 |  304 |  272 |
| `main_trace_commit_time_ms` |  52 |  208 |  57 |  50 |
| `generate_perm_trace_time_ms` |  34.50 |  138 |  48 |  23 |
| `perm_trace_commit_time_ms` |  64.72 |  258.89 |  71.25 |  54.88 |
| `quotient_poly_compute_time_ms` |  61.81 |  247.23 |  73.79 |  55.01 |
| `quotient_poly_commit_time_ms` |  16.40 |  65.59 |  18.63 |  14.02 |
| `pcs_opening_time_ms ` |  54.75 |  219 |  60 |  50 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,385.75 |  5,543 |  2,015 |  920 |
...
| `execute_preflight_insns` |  1,440,854.25 |  5,763,417 |  1,814,676 |  1,241,353 |
| `execute_preflight_time_ms` |  627.25 |  2,509 |  837 |  228 |
| `execute_preflight_insn_mi/s` |  6.100 | -          |  7.41 |  6.75 |
| `trace_gen_time_ms   ` |  87.50 |  350 |  161 |  60 |
| `memory_finalize_time_ms` |  9.50 |  38 |  19 |  6 |
| `stark_prove_excluding_trace_time_ms` |  669.50 |  2,678 |  1,078 |  487 |
| `main_trace_commit_time_ms` |  126 |  504 |  196 |  92 |
| `generate_perm_trace_time_ms` |  54 |  216 |  75 |  39 |
| `perm_trace_commit_time_ms` |  201.55 |  806.19 |  345.97 |  143.69 |
| `quotient_poly_compute_time_ms` |  149.11 |  596.44 |  243.47 |  106.55 |
| `quotient_poly_commit_time_ms` |  32.38 |  129.52 |  52.14 |  24.82 |
| `pcs_opening_time_ms ` |  101.75 |  407 |  158 |  75 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 2,017 |  | 1 | 1 |  |  |  |  | 
| regex_program |  | 545 |  | 1 | 36 | 4,137,502 | 112.78 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 69 | 920 | 22,981,570 | 319,331,818 | 69 | 622 | 0 | 139.59 | 26.88 | 4 | 172.32 | 94 | 235 | 94 | 7 | 124 | 9,122,488 | 61 | 228 | 1,465,975 | 7.41 | 31 | 167 | 0 | 94 | 
| leaf | 1 | 60 | 1,390 | 20,905,034 | 255,237,610 | 60 | 491 | 0 | 106.55 | 25.67 | 4 | 144.21 | 80 | 184 | 80 | 6 | 92 | 8,256,948 | 39 | 837 | 1,241,413 | 6.94 | 26 | 133 | 0 | 80 | 
| leaf | 2 | 60 | 1,218 | 20,905,034 | 255,237,610 | 60 | 487 | 0 | 106.83 | 24.82 | 4 | 143.69 | 75 | 186 | 75 | 6 | 92 | 8,256,948 | 41 | 670 | 1,241,353 | 6.88 | 26 | 132 | 0 | 75 | 
| leaf | 3 | 161 | 2,015 | 50,337,320 | 538,365,418 | 161 | 1,078 | 0 | 243.47 | 52.14 | 4 | 345.97 | 158 | 422 | 158 | 19 | 196 | 20,171,106 | 75 | 774 | 1,814,676 | 6.75 | 62 | 300 | 5 | 158 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 174 | 705 | 23,446,148 | 150,778,428 | 174 | 304 | 0 | 63.05 | 18.63 | 5 | 71.25 | 60 | 103 | 59 | 4 | 57 | 10,899,170 | 31 | 56 | 1,103,000 | 30.62 | 22 | 82 | 1 | 59 | 
| regex_program | 1 | 179 | 551 | 11,598,276 | 128,513,066 | 179 | 285 | 1 | 55.01 | 16.65 | 4 | 66.24 | 58 | 102 | 58 | 0 | 51 | 2,196,106 | 36 | 45 | 1,104,000 | 32.50 | 17 | 72 | 0 | 58 | 
| regex_program | 2 | 179 | 555 | 11,579,064 | 128,513,066 | 178 | 289 | 1 | 55.38 | 16.28 | 4 | 66.53 | 50 | 115 | 50 | 0 | 50 | 2,177,334 | 48 | 45 | 1,104,000 | 32.42 | 17 | 72 | 0 | 50 | 
| regex_program | 3 | 197 | 545 | 11,853,872 | 103,456,394 | 197 | 272 | 0 | 73.79 | 14.02 | 5 | 54.88 | 51 | 81 | 50 | 0 | 50 | 2,422,606 | 23 | 34 | 826,502 | 32.30 | 19 | 88 | 1 | 50 | 
...
Commit: https://github.com/openvm-org/openvm/commit/69d89ba5335026b36e88cba62ff3706b37eea795
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/20890418093)

...
| `total_proof_time_ms ` |  3,921.50 |  7,843 |  4,342 |  3,501 |
| `main_cells_used     ` |  83,255,576 |  166,511,152 |  93,500,799 |  73,010,353 |
| `total_cycles        ` |  2,082,613 |  4,165,226 |  2,243,715 |  1,921,511 |
| `execute_time_ms     ` |  357 |  714 |  397 |  317 |
| `trace_gen_time_ms   ` |  990.50 |  1,981 |  1,176 |  805 |
| `stark_prove_excluding_trace_time_ms` |  2,574 |  5,148 |  2,769 |  2,379 |
| `main_trace_commit_time_ms` |  497.50 |  995 |  553 |  442 |
| `generate_perm_trace_time_ms` |  216.50 |  433 |  226 |  207 |
| `perm_trace_commit_time_ms` |  546 |  1,092 |  571 |  521 |
| `quotient_poly_compute_time_ms` |  257 |  514 |  279 |  235 |
| `quotient_poly_commit_time_ms` |  248 |  496 |  291 |  205 |
| `pcs_opening_time_ms ` |  799.50 |  1,599 |  838 |  761 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  6,938.50 |  13,877 |  7,021 |  6,856 |
| `main_cells_used     ` |  151,828,109 |  303,656,218 |  154,228,070 |  149,428,148 |
| `total_cycles        ` |  1,975,749 |  3,951,498 |  2,006,585 |  1,944,913 |
| `execute_time_ms     ` |  771.50 |  1,543 |  779 |  764 |
| `trace_gen_time_ms   ` |  1,447 |  2,894 |  1,490 |  1,404 |
| `stark_prove_excluding_trace_time_ms` |  4,720 |  9,440 |  4,752 |  4,688 |
| `main_trace_commit_time_ms` |  866.50 |  1,733 |  867 |  866 |
| `generate_perm_trace_time_ms` |  392 |  784 |  416 |  368 |
| `perm_trace_commit_time_ms` |  1,241.50 |  2,483 |  1,246 |  1,237 |
| `quotient_poly_compute_time_ms` |  517 |  1,034 |  524 |  510 |
| `quotient_poly_commit_time_ms` |  412.50 |  825 |  414 |  411 |
| `pcs_opening_time_ms ` |  1,283.50 |  2,567 |  1,287 |  1,280 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,490 | 7,021 | 2,006,585 | 538,660,330 | 4,752 | 524 | 411 | 1,246 | 1,280 | 867 | 154,228,070 | 416 | 779 | 
| leaf | 1 | 1,404 | 6,856 | 1,944,913 | 538,660,330 | 4,688 | 510 | 414 | 1,237 | 1,287 | 866 | 149,428,148 | 368 | 764 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,176 | 4,342 | 2,243,715 | 275,652,919 | 2,769 | 279 | 291 | 571 | 838 | 553 | 93,500,799 | 226 | 397 | 
| regex_program | 1 | 805 | 3,501 | 1,921,511 | 242,975,404 | 2,379 | 235 | 205 | 521 | 761 | 442 | 73,010,353 | 207 | 317 | 

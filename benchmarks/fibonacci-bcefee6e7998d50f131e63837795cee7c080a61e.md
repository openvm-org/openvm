...
| `total_proof_time_ms ` |  4,943 |  4,943 |  4,943 |  4,943 |
| `main_cells_used     ` |  51,485,080 |  51,485,080 |  51,485,080 |  51,485,080 |
| `total_cycles        ` |  1,500,095 |  1,500,095 |  1,500,095 |  1,500,095 |
| `execute_time_ms     ` |  299 |  299 |  299 |  299 |
| `trace_gen_time_ms   ` |  634 |  634 |  634 |  634 |
| `stark_prove_excluding_trace_time_ms` |  4,010 |  4,010 |  4,010 |  4,010 |
...
| `pcs_opening_time_ms ` |  735 |  735 |  735 |  735 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 564 | 3,835 | 615,348 | 86,295,512 | 3,034 | 413 | 616 | 560 | 735 | 629 | 33,540,988 | 77 | 237 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 634 | 4,943 | 1,500,095 | 122,458,476 | 4,010 | 511 | 733 | 753 | 1,071 | 802 | 51,485,080 | 136 | 299 | 

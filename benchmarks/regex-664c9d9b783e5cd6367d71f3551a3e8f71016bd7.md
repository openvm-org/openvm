...
| `total_proof_time_ms ` |  3,878.50 |  7,757 |  4,294 |  3,463 |
| `main_cells_used     ` |  83,255,576 |  166,511,152 |  93,500,799 |  73,010,353 |
| `total_cycles        ` |  2,082,613 |  4,165,226 |  2,243,715 |  1,921,511 |
| `execute_time_ms     ` |  350.50 |  701 |  390 |  311 |
| `trace_gen_time_ms   ` |  948 |  1,896 |  1,118 |  778 |
| `stark_prove_excluding_trace_time_ms` |  2,580 |  5,160 |  2,786 |  2,374 |
| `main_trace_commit_time_ms` |  498 |  996 |  554 |  442 |
| `generate_perm_trace_time_ms` |  215 |  430 |  231 |  199 |
| `perm_trace_commit_time_ms` |  548 |  1,096 |  578 |  518 |
| `quotient_poly_compute_time_ms` |  259 |  518 |  281 |  237 |
| `quotient_poly_commit_time_ms` |  242 |  484 |  277 |  207 |
| `pcs_opening_time_ms ` |  807 |  1,614 |  852 |  762 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  6,993 |  13,986 |  7,057 |  6,929 |
| `main_cells_used     ` |  151,828,373 |  303,656,746 |  154,227,998 |  149,428,748 |
| `total_cycles        ` |  1,975,771 |  3,951,542 |  2,006,579 |  1,944,963 |
| `execute_time_ms     ` |  781.50 |  1,563 |  790 |  773 |
| `trace_gen_time_ms   ` |  1,464.50 |  2,929 |  1,497 |  1,432 |
| `stark_prove_excluding_trace_time_ms` |  4,747 |  9,494 |  4,770 |  4,724 |
| `main_trace_commit_time_ms` |  868.50 |  1,737 |  872 |  865 |
| `generate_perm_trace_time_ms` |  397 |  794 |  421 |  373 |
| `perm_trace_commit_time_ms` |  1,243 |  2,486 |  1,245 |  1,241 |
| `quotient_poly_compute_time_ms` |  528.50 |  1,057 |  533 |  524 |
| `quotient_poly_commit_time_ms` |  411.50 |  823 |  413 |  410 |
| `pcs_opening_time_ms ` |  1,294 |  2,588 |  1,298 |  1,290 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,497 | 7,057 | 2,006,579 | 538,660,330 | 4,770 | 524 | 413 | 1,245 | 1,290 | 872 | 154,227,998 | 421 | 790 | 
| leaf | 1 | 1,432 | 6,929 | 1,944,963 | 538,660,330 | 4,724 | 533 | 410 | 1,241 | 1,298 | 865 | 149,428,748 | 373 | 773 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,118 | 4,294 | 2,243,715 | 275,652,919 | 2,786 | 281 | 277 | 578 | 852 | 554 | 93,500,799 | 231 | 390 | 
| regex_program | 1 | 778 | 3,463 | 1,921,511 | 242,975,404 | 2,374 | 237 | 207 | 518 | 762 | 442 | 73,010,353 | 199 | 311 | 

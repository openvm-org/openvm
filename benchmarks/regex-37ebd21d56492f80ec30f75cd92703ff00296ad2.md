...
| `total_proof_time_ms ` |  3,893 |  7,786 |  4,481 |  3,305 |
...
| `trace_gen_time_ms   ` |  991 |  1,982 |  1,179 |  803 |
| `stark_prove_excluding_trace_time_ms` |  2,565.50 |  5,131 |  2,929 |  2,202 |
| `main_trace_commit_time_ms` |  445.50 |  891 |  522 |  369 |
| `generate_perm_trace_time_ms` |  162.50 |  325 |  182 |  143 |
| `perm_trace_commit_time_ms` |  646 |  1,292 |  751 |  541 |
| `quotient_poly_compute_time_ms` |  361.50 |  723 |  419 |  304 |
| `quotient_poly_commit_time_ms` |  276.50 |  553 |  322 |  231 |
| `pcs_opening_time_ms ` |  664 |  1,328 |  724 |  604 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,521.50 |  15,043 |  7,575 |  7,468 |
| `main_cells_used     ` |  152,306,947.50 |  304,613,895 |  154,766,623 |  149,847,272 |
| `total_cycles        ` |  1,993,406.50 |  3,986,813 |  2,024,313 |  1,962,500 |
| `execute_time_ms     ` |  765.50 |  1,531 |  774 |  757 |
| `trace_gen_time_ms   ` |  1,468.50 |  2,937 |  1,478 |  1,459 |
| `stark_prove_excluding_trace_time_ms` |  5,287.50 |  10,575 |  5,323 |  5,252 |
| `main_trace_commit_time_ms` |  889 |  1,778 |  889 |  889 |
| `generate_perm_trace_time_ms` |  351 |  702 |  363 |  339 |
| `perm_trace_commit_time_ms` |  1,686 |  3,372 |  1,711 |  1,661 |
| `quotient_poly_compute_time_ms` |  763.50 |  1,527 |  765 |  762 |
| `quotient_poly_commit_time_ms` |  522 |  1,044 |  525 |  519 |
| `pcs_opening_time_ms ` |  1,070 |  2,140 |  1,073 |  1,067 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,478 | 7,575 | 2,024,313 | 533,941,738 | 5,323 | 762 | 519 | 1,711 | 1,073 | 889 | 154,766,623 | 363 | 774 | 
| leaf | 1 | 1,459 | 7,468 | 1,962,500 | 533,941,738 | 5,252 | 765 | 525 | 1,661 | 1,067 | 889 | 149,847,272 | 339 | 757 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,179 | 4,481 | 2,225,434 | 275,652,919 | 2,929 | 419 | 322 | 751 | 724 | 522 | 93,699,990 | 182 | 373 | 
| regex_program | 1 | 803 | 3,305 | 1,914,730 | 198,099,628 | 2,202 | 304 | 231 | 541 | 604 | 369 | 73,689,460 | 143 | 300 | 

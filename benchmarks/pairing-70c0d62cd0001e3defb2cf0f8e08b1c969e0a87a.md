...
| `total_proof_time_ms ` |  4,698 |  4,698 |  4,698 |  4,698 |
...
| `trace_gen_time_ms   ` |  894 |  894 |  894 |  894 |
...
| `quotient_poly_commit_time_ms` |  339 |  339 |  339 |  339 |
| `pcs_opening_time_ms ` |  749 |  749 |  749 |  749 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  14,090 |  14,090 |  14,090 |  14,090 |
| `main_cells_used     ` |  274,611,932 |  274,611,932 |  274,611,932 |  274,611,932 |
| `total_cycles        ` |  3,267,460 |  3,267,460 |  3,267,460 |  3,267,460 |
| `execute_time_ms     ` |  1,209 |  1,209 |  1,209 |  1,209 |
| `trace_gen_time_ms   ` |  2,579 |  2,579 |  2,579 |  2,579 |
| `stark_prove_excluding_trace_time_ms` |  10,302 |  10,302 |  10,302 |  10,302 |
| `main_trace_commit_time_ms` |  1,775 |  1,775 |  1,775 |  1,775 |
| `generate_perm_trace_time_ms` |  725 |  725 |  725 |  725 |
| `perm_trace_commit_time_ms` |  3,387 |  3,387 |  3,387 |  3,387 |
| `quotient_poly_compute_time_ms` |  1,488 |  1,488 |  1,488 |  1,488 |
| `quotient_poly_commit_time_ms` |  969 |  969 |  969 |  969 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 2,579 | 14,090 | 3,267,460 | 1,081,183,722 | 10,302 | 1,488 | 969 | 3,387 | 1,952 | 1,775 | 274,611,932 | 725 | 1,209 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 894 | 4,698 | 1,711,829 | 297,380,439 | 3,132 | 468 | 339 | 776 | 749 | 597 | 92,771,449 | 186 | 672 | 

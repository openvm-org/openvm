...
| `total_proof_time_ms ` |  483 |  966 |  548 |  418 |
...
| `perm_trace_commit_time_ms` |  42.13 |  84.27 |  44.41 |  39.86 |
| `quotient_poly_compute_time_ms` |  29.85 |  59.70 |  30.31 |  29.39 |
| `quotient_poly_commit_time_ms` |  11.33 |  22.66 |  11.36 |  11.30 |
| `pcs_opening_time_ms ` |  41 |  82 |  45 |  37 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,001 |  2,002 |  1,259 |  743 |
| `main_cells_used     ` |  6,475,562 |  12,951,124 |  6,608,072 |  6,343,052 |
| `total_cells_used    ` |  17,568,644 |  35,137,288 |  17,887,054 |  17,250,234 |
| `execute_preflight_insns` |  1,190,452.50 |  2,380,905 |  1,229,730 |  1,151,175 |
| `execute_preflight_time_ms` |  507 |  1,014 |  814 |  200 |
| `execute_preflight_insn_mi/s` |  6.92 | -          |  6.95 |  6.89 |
| `trace_gen_time_ms   ` |  58 |  116 |  61 |  55 |
| `memory_finalize_time_ms` |  5.50 |  11 |  6 |  5 |
| `stark_prove_excluding_trace_time_ms` |  434.50 |  869 |  480 |  389 |
| `main_trace_commit_time_ms` |  83 |  166 |  91 |  75 |
| `generate_perm_trace_time_ms` |  34 |  68 |  38 |  30 |
| `perm_trace_commit_time_ms` |  123.58 |  247.15 |  140.13 |  107.02 |
| `quotient_poly_compute_time_ms` |  91.74 |  183.48 |  100.27 |  83.21 |
| `quotient_poly_commit_time_ms` |  22.01 |  44.02 |  24.06 |  19.96 |
| `pcs_opening_time_ms ` |  76.50 |  153 |  83 |  70 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program |  | 418 |  | 1 | 13 | 1,500,209 | 114.96 | 0 | 
| leaf | 1,260 |  | 1 | 1 |  |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 61 | 743 | 17,887,054 | 252,878,314 | 61 | 480 | 0 | 100.27 | 24.06 | 4 | 140.13 | 83 | 179 | 83 | 6 | 91 | 6,608,072 | 38 | 200 | 1,229,730 | 6.89 | 26 | 125 | 0 | 83 | 
| leaf | 1 | 55 | 1,259 | 17,250,234 | 207,789,546 | 55 | 389 | 0 | 83.21 | 19.96 | 4 | 107.02 | 70 | 138 | 70 | 5 | 75 | 6,343,052 | 30 | 814 | 1,151,175 | 6.95 | 22 | 103 | 0 | 70 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 195 | 548 | 9,677,708 | 84,395,212 | 195 | 184 | 0 | 30.31 | 11.30 | 4 | 44.41 | 45 | 62 | 45 | 0 | 33 | 1,035,986 | 18 | 25 | 873,000 | 34.68 | 14 | 42 | 0 | 45 | 
| fibonacci_program | 1 | 182 | 418 | 9,708,170 | 74,305,770 | 182 | 160 | 1 | 29.39 | 11.36 | 4 | 39.86 | 37 | 52 | 37 | 0 | 28 | 1,064,416 | 12 | 34 | 627,209 | 38.73 | 11 | 41 | 0 | 37 | 

...
| `total_proof_time_ms ` |  3,852.50 |  7,705 |  4,453 |  3,252 |
| `main_cells_used     ` |  83,694,725 |  167,389,450 |  93,699,990 |  73,689,460 |
| `total_cycles        ` |  2,070,082 |  4,140,164 |  2,225,434 |  1,914,730 |
| `execute_time_ms     ` |  333.50 |  667 |  371 |  296 |
| `trace_gen_time_ms   ` |  961 |  1,922 |  1,160 |  762 |
| `stark_prove_excluding_trace_time_ms` |  2,558 |  5,116 |  2,922 |  2,194 |
| `main_trace_commit_time_ms` |  446 |  892 |  524 |  368 |
| `generate_perm_trace_time_ms` |  168.50 |  337 |  187 |  150 |
| `perm_trace_commit_time_ms` |  648 |  1,296 |  750 |  546 |
| `quotient_poly_compute_time_ms` |  356.50 |  713 |  416 |  297 |
| `quotient_poly_commit_time_ms` |  273.50 |  547 |  318 |  229 |
| `pcs_opening_time_ms ` |  657 |  1,314 |  718 |  596 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,365 |  14,730 |  7,443 |  7,287 |
| `main_cells_used     ` |  152,447,764.50 |  304,895,529 |  154,909,245 |  149,986,284 |
| `total_cycles        ` |  1,994,023.50 |  3,988,047 |  2,024,924 |  1,963,123 |
| `execute_time_ms     ` |  792.50 |  1,585 |  802 |  783 |
| `trace_gen_time_ms   ` |  1,474 |  2,948 |  1,505 |  1,443 |
| `stark_prove_excluding_trace_time_ms` |  5,098.50 |  10,197 |  5,136 |  5,061 |
| `main_trace_commit_time_ms` |  836.50 |  1,673 |  838 |  835 |
| `generate_perm_trace_time_ms` |  341 |  682 |  352 |  330 |
| `perm_trace_commit_time_ms` |  1,598.50 |  3,197 |  1,629 |  1,568 |
| `quotient_poly_compute_time_ms` |  764.50 |  1,529 |  766 |  763 |
| `quotient_poly_commit_time_ms` |  506 |  1,012 |  506 |  506 |
| `pcs_opening_time_ms ` |  1,046.50 |  2,093 |  1,054 |  1,039 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,505 | 7,443 | 2,024,924 | 534,072,810 | 5,136 | 766 | 506 | 1,629 | 1,039 | 838 | 154,909,245 | 352 | 802 | 
| leaf | 1 | 1,443 | 7,287 | 1,963,123 | 534,072,810 | 5,061 | 763 | 506 | 1,568 | 1,054 | 835 | 149,986,284 | 330 | 783 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,160 | 4,453 | 2,225,434 | 275,652,919 | 2,922 | 416 | 318 | 750 | 718 | 524 | 93,699,990 | 187 | 371 | 
| regex_program | 1 | 762 | 3,252 | 1,914,730 | 198,099,628 | 2,194 | 297 | 229 | 546 | 596 | 368 | 73,689,460 | 150 | 296 | 

...
| `total_proof_time_ms ` |  1,423 |  1,423 |  1,423 |  1,423 |
...
| `stark_prove_excluding_trace_time_ms` |  1,088 |  1,088 |  1,088 |  1,088 |
...
| `pcs_opening_time_ms ` |  403 |  403 |  403 |  403 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  13,026 |  13,026 |  13,026 |  13,026 |
| `main_cells_used     ` |  244,000,370 |  244,000,370 |  244,000,370 |  244,000,370 |
| `total_cycles        ` |  2,985,177 |  2,985,177 |  2,985,177 |  2,985,177 |
| `execute_time_ms     ` |  1,083 |  1,083 |  1,083 |  1,083 |
| `trace_gen_time_ms   ` |  2,312 |  2,312 |  2,312 |  2,312 |
| `stark_prove_excluding_trace_time_ms` |  9,631 |  9,631 |  9,631 |  9,631 |
| `main_trace_commit_time_ms` |  1,728 |  1,728 |  1,728 |  1,728 |
| `generate_perm_trace_time_ms` |  712 |  712 |  712 |  712 |
| `perm_trace_commit_time_ms` |  3,099 |  3,099 |  3,099 |  3,099 |
| `quotient_poly_compute_time_ms` |  1,346 |  1,346 |  1,346 |  1,346 |
| `quotient_poly_commit_time_ms` |  881 |  881 |  881 |  881 |
| `pcs_opening_time_ms ` |  1,859 |  1,859 |  1,859 |  1,859 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 2,312 | 13,026 | 2,985,177 | 999,394,794 | 9,631 | 1,346 | 881 | 3,099 | 1,859 | 1,728 | 244,000,370 | 712 | 1,083 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 186 | 1,423 | 295,291 | 48,197,161 | 1,088 | 124 | 154 | 187 | 403 | 172 | 15,588,656 | 32 | 149 | 

...
| `total_proof_time_ms ` |  716.50 |  1,433 |  831 |  602 |
...
| `execute_preflight_time_ms` |  98.50 |  197 |  126 |  71 |
| `execute_preflight_insn_mi/s` |  13.91 | -          |  18.53 |  9.30 |
| `trace_gen_time_ms   ` |  175 |  350 |  190 |  160 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  349 |  698 |  399 |  299 |
| `main_trace_commit_time_ms` |  61.50 |  123 |  66 |  57 |
| `generate_perm_trace_time_ms` |  44 |  88 |  59 |  29 |
| `perm_trace_commit_time_ms` |  75.07 |  150.13 |  83.28 |  66.86 |
| `quotient_poly_compute_time_ms` |  78.78 |  157.55 |  84.86 |  72.70 |
| `quotient_poly_commit_time_ms` |  15.98 |  31.95 |  17.43 |  14.52 |
| `pcs_opening_time_ms ` |  68.50 |  137 |  83 |  54 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,445.50 |  2,891 |  1,704 |  1,187 |
| `main_cells_used     ` |  16,200,472 |  32,400,944 |  16,332,746 |  16,068,198 |
| `total_cells_used    ` |  39,332,920 |  78,665,840 |  39,650,868 |  39,014,972 |
| `execute_preflight_insns` |  1,952,447.50 |  3,904,895 |  1,991,838 |  1,913,057 |
| `execute_preflight_time_ms` |  584 |  1,168 |  871 |  297 |
| `execute_preflight_insn_mi/s` |  7.55 | -          |  7.57 |  7.53 |
| `trace_gen_time_ms   ` |  117 |  234 |  122 |  112 |
| `memory_finalize_time_ms` |  10.50 |  21 |  11 |  10 |
| `stark_prove_excluding_trace_time_ms` |  743 |  1,486 |  766 |  720 |
| `main_trace_commit_time_ms` |  146 |  292 |  150 |  142 |
| `generate_perm_trace_time_ms` |  53 |  106 |  56 |  50 |
| `perm_trace_commit_time_ms` |  225.96 |  451.92 |  230.55 |  221.37 |
| `quotient_poly_compute_time_ms` |  167.72 |  335.44 |  169.64 |  165.80 |
| `quotient_poly_commit_time_ms` |  30.98 |  61.97 |  32.98 |  28.99 |
| `pcs_opening_time_ms ` |  116 |  232 |  124 |  108 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 1,706 |  | 1 |  | 1 |  |  |  |  | 
| pairing |  | 602 |  | 41 | 1 | 91 | 1,882,939 | 20.54 | 146 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 122 | 1,187 | 39,650,868 | 410,701,290 | 122 | 766 | 0 | 169.64 | 32.98 | 4 | 230.55 | 124 | 287 | 124 | 11 | 150 | 16,332,746 | 56 | 297 | 1,991,838 | 7.53 | 39 | 204 | 0 | 124 | 
| leaf | 1 | 112 | 1,704 | 39,014,972 | 396,840,426 | 112 | 720 | 0 | 165.80 | 28.99 | 5 | 221.37 | 108 | 272 | 108 | 10 | 142 | 16,068,198 | 50 | 871 | 1,913,057 | 7.57 | 38 | 196 | 0 | 108 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 160 | 831 | 31,041,944 | 160,949,612 | 160 | 399 | 0 | 84.86 | 17.43 | 6 | 83.28 | 83 | 145 | 83 | 1 | 66 | 15,014,446 | 59 | 126 | 1,143,000 | 9.30 | 25 | 103 | 1 | 83 | 
| pairing | 1 | 190 | 602 | 24,485,078 | 124,079,782 | 190 | 299 | 1 | 72.70 | 14.52 | 5 | 66.86 | 54 | 99 | 54 | 0 | 57 | 10,833,316 | 29 | 71 | 739,939 | 18.53 | 21 | 87 | 1 | 54 | 

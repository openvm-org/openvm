...
| `total_proof_time_ms ` |  4,195.50 |  8,391 |  4,613 |  3,778 |
| `main_cells_used     ` |  83,910,936 |  167,821,872 |  94,156,159 |  73,665,713 |
| `total_cycles        ` |  2,082,613 |  4,165,226 |  2,243,715 |  1,921,511 |
| `execute_time_ms     ` |  342 |  684 |  381 |  303 |
| `trace_gen_time_ms   ` |  968 |  1,936 |  1,140 |  796 |
| `stark_prove_excluding_trace_time_ms` |  2,885.50 |  5,771 |  3,092 |  2,679 |
| `main_trace_commit_time_ms` |  521.50 |  1,043 |  586 |  457 |
| `generate_perm_trace_time_ms` |  197 |  394 |  201 |  193 |
| `perm_trace_commit_time_ms` |  748 |  1,496 |  800 |  696 |
| `quotient_poly_compute_time_ms` |  396 |  792 |  426 |  366 |
| `quotient_poly_commit_time_ms` |  294.50 |  589 |  329 |  260 |
| `pcs_opening_time_ms ` |  719.50 |  1,439 |  748 |  691 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,505.50 |  15,011 |  7,557 |  7,454 |
| `main_cells_used     ` |  152,279,161 |  304,558,322 |  154,679,302 |  149,879,020 |
| `total_cycles        ` |  1,991,108 |  3,982,216 |  2,021,959 |  1,960,257 |
| `execute_time_ms     ` |  750 |  1,500 |  759 |  741 |
| `trace_gen_time_ms   ` |  1,471 |  2,942 |  1,504 |  1,438 |
| `stark_prove_excluding_trace_time_ms` |  5,284.50 |  10,569 |  5,294 |  5,275 |
| `main_trace_commit_time_ms` |  890.50 |  1,781 |  891 |  890 |
| `generate_perm_trace_time_ms` |  360.50 |  721 |  363 |  358 |
| `perm_trace_commit_time_ms` |  1,691 |  3,382 |  1,711 |  1,671 |
| `quotient_poly_compute_time_ms` |  762.50 |  1,525 |  767 |  758 |
| `quotient_poly_commit_time_ms` |  519.50 |  1,039 |  520 |  519 |
| `pcs_opening_time_ms ` |  1,056.50 |  2,113 |  1,066 |  1,047 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,504 | 7,557 | 2,021,959 | 538,660,330 | 5,294 | 758 | 520 | 1,711 | 1,047 | 891 | 154,679,302 | 363 | 759 | 
| leaf | 1 | 1,438 | 7,454 | 1,960,257 | 538,660,330 | 5,275 | 767 | 519 | 1,671 | 1,066 | 890 | 149,879,020 | 358 | 741 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,140 | 4,613 | 2,243,715 | 275,652,919 | 3,092 | 426 | 329 | 800 | 748 | 586 | 94,156,159 | 193 | 381 | 
| regex_program | 1 | 796 | 3,778 | 1,921,511 | 242,975,404 | 2,679 | 366 | 260 | 696 | 691 | 457 | 73,665,713 | 201 | 303 | 

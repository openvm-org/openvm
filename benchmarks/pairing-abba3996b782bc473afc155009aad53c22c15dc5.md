...
| `stark_prove_excluding_trace_time_ms` |  958 |  958 |  958 |  958 |
| `main_trace_commit_time_ms` |  150 |  150 |  150 |  150 |
| `generate_perm_trace_time_ms` |  71 |  71 |  71 |  71 |
| `perm_trace_commit_time_ms` |  180.57 |  180.57 |  180.57 |  180.57 |
| `quotient_poly_compute_time_ms` |  136.80 |  136.80 |  136.80 |  136.80 |
| `quotient_poly_commit_time_ms` |  34.51 |  34.51 |  34.51 |  34.51 |
| `pcs_opening_time_ms ` |  379 |  379 |  379 |  379 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,732 |  1,732 |  1,732 |  1,732 |
| `main_cells_used     ` |  16,451,316 |  16,451,316 |  16,451,316 |  16,451,316 |
| `total_cells_used    ` |  39,940,154 |  39,940,154 |  39,940,154 |  39,940,154 |
| `execute_preflight_insns` |  2,010,439 |  2,010,439 |  2,010,439 |  2,010,439 |
| `execute_preflight_time_ms` |  331 |  331 |  331 |  331 |
| `execute_preflight_insn_mi/s` |  7.59 | -          |  7.59 |  7.59 |
| `trace_gen_time_ms   ` |  122 |  122 |  122 |  122 |
| `memory_finalize_time_ms` |  12 |  12 |  12 |  12 |
| `stark_prove_excluding_trace_time_ms` |  1,278 |  1,278 |  1,278 |  1,278 |
| `main_trace_commit_time_ms` |  166 |  166 |  166 |  166 |
| `generate_perm_trace_time_ms` |  76 |  76 |  76 |  76 |
| `perm_trace_commit_time_ms` |  249.55 |  249.55 |  249.55 |  249.55 |
| `quotient_poly_compute_time_ms` |  168.64 |  168.64 |  168.64 |  168.64 |
| `quotient_poly_commit_time_ms` |  39.75 |  39.75 |  39.75 |  39.75 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 1,734 |  | 1 |  | 1 |  |  |  |  | 
| pairing |  | 1,528 |  | 40 | 1 | 91 | 1,882,939 | 20.54 | 148 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 122 | 1,732 | 39,940,154 | 418,598,378 | 122 | 1,278 | 0 | 168.64 | 39.75 | 4 | 249.55 | 574 | 327 | 574 | 12 | 166 | 16,451,316 | 76 | 331 | 2,010,439 | 7.59 | 39 | 209 | 1 | 574 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 274 | 1,528 | 44,491,360 | 304,931,516 | 274 | 958 | 0 | 136.80 | 34.51 | 7 | 180.57 | 379 | 254 | 379 | 1 | 150 | 23,722,622 | 71 | 170 | 1,882,939 | 11.33 | 38 | 173 | 3 | 379 | 

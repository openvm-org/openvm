...
| ecrecover_program |  4.12 |  4.12 |  4.12 |
| leaf |  10.86 |  10.86 |  10.86 |


| ecrecover_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  4,110 |  4,110 |  4,110 |  4,110 |
...
| `stark_prove_excluding_trace_time_ms` |  3,672 |  3,672 |  3,672 |  3,672 |
...
| `quotient_poly_compute_time_ms` |  104.21 |  104.21 |  104.21 |  104.21 |
| `quotient_poly_commit_time_ms` |  9.11 |  9.11 |  9.11 |  9.11 |
| `pcs_opening_time_ms ` |  3,353 |  3,353 |  3,353 |  3,353 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  10,857 |  10,857 |  10,857 |  10,857 |
| `main_cells_used     ` |  34,469,436 |  34,469,436 |  34,469,436 |  34,469,436 |
| `total_cells_used    ` |  83,393,874 |  83,393,874 |  83,393,874 |  83,393,874 |
| `execute_preflight_insns` |  4,109,657 |  4,109,657 |  4,109,657 |  4,109,657 |
| `execute_preflight_time_ms` |  763 |  763 |  763 |  763 |
| `execute_preflight_insn_mi/s` |  5.72 | -          |  5.72 |  5.72 |
| `trace_gen_time_ms   ` |  305 |  305 |  305 |  305 |
| `memory_finalize_time_ms` |  26 |  26 |  26 |  26 |
| `stark_prove_excluding_trace_time_ms` |  9,788 |  9,788 |  9,788 |  9,788 |
| `main_trace_commit_time_ms` |  722 |  722 |  722 |  722 |
| `generate_perm_trace_time_ms` |  349 |  349 |  349 |  349 |
| `perm_trace_commit_time_ms` |  1,465.53 |  1,465.53 |  1,465.53 |  1,465.53 |
| `quotient_poly_compute_time_ms` |  815.02 |  815.02 |  815.02 |  815.02 |
| `quotient_poly_commit_time_ms` |  184.02 |  184.02 |  184.02 |  184.02 |
| `pcs_opening_time_ms ` |  6,245 |  6,245 |  6,245 |  6,245 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program |  | 4,110 |  | 1 | 6 | 122,859 | 19.61 | 0 | 
| leaf | 10,863 |  | 1 | 1 |  |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 305 | 10,857 | 83,393,874 | 1,726,057,962 | 305 | 9,788 | 0 | 815.02 | 184.02 | 6 | 1,465.53 | 6,245 | 1,815 | 6,245 | 26 | 722 | 34,469,436 | 349 | 763 | 4,109,657 | 5.72 | 270 | 1,004 | 13 | 6,245 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 207 | 4,110 | 11,345,240 | 31,789,298 | 207 | 3,672 | 0 | 104.21 | 9.11 | 12 | 34.18 | 3,353 | 167 | 3,353 | 0 | 37 | 2,263,998 | 126 | 63 | 122,859 | 2.21 | 21 | 113 | 1 | 3,353 | 

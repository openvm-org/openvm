...
| `total_proof_time_ms ` |  6,933.50 |  13,867 |  7,801 |  6,066 |
| `main_cells_used     ` |  82,727,686.50 |  165,455,373 |  92,686,348 |  72,769,025 |
| `total_cycles        ` |  2,069,920 |  4,139,840 |  2,225,737 |  1,914,103 |
| `execute_time_ms     ` |  397.50 |  795 |  474 |  321 |
| `trace_gen_time_ms   ` |  1,209 |  2,418 |  1,279 |  1,139 |
| `stark_prove_excluding_trace_time_ms` |  5,327 |  10,654 |  6,048 |  4,606 |
| `main_trace_commit_time_ms` |  1,121 |  2,242 |  1,318 |  924 |
| `generate_perm_trace_time_ms` |  183.50 |  367 |  204 |  163 |
| `perm_trace_commit_time_ms` |  1,030 |  2,060 |  1,161 |  899 |
| `quotient_poly_compute_time_ms` |  741 |  1,482 |  865 |  617 |
| `quotient_poly_commit_time_ms` |  944.50 |  1,889 |  1,091 |  798 |
| `pcs_opening_time_ms ` |  1,298 |  2,596 |  1,400 |  1,196 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  8,020 |  16,040 |  8,273 |  7,767 |
| `main_cells_used     ` |  77,287,079 |  154,574,158 |  78,375,179 |  76,198,979 |
| `total_cycles        ` |  1,028,199 |  2,056,398 |  1,045,619 |  1,010,779 |
| `execute_time_ms     ` |  378.50 |  757 |  413 |  344 |
| `trace_gen_time_ms   ` |  1,145 |  2,290 |  1,222 |  1,068 |
| `stark_prove_excluding_trace_time_ms` |  6,496.50 |  12,993 |  6,792 |  6,201 |
| `main_trace_commit_time_ms` |  1,310 |  2,620 |  1,366 |  1,254 |
| `generate_perm_trace_time_ms` |  163.50 |  327 |  175 |  152 |
| `perm_trace_commit_time_ms` |  1,302 |  2,604 |  1,350 |  1,254 |
| `quotient_poly_compute_time_ms` |  974 |  1,948 |  1,026 |  922 |
| `quotient_poly_commit_time_ms` |  1,280 |  2,560 |  1,356 |  1,204 |
| `pcs_opening_time_ms ` |  1,463 |  2,926 |  1,515 |  1,411 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,068 | 8,273 | 1,045,619 | 220,669,656 | 6,792 | 1,026 | 1,356 | 1,350 | 1,515 | 1,366 | 78,375,179 | 175 | 413 | 
| leaf | 1 | 1,222 | 7,767 | 1,010,779 | 194,986,968 | 6,201 | 922 | 1,204 | 1,254 | 1,411 | 1,254 | 76,198,979 | 152 | 344 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,279 | 7,801 | 2,225,737 | 209,921,543 | 6,048 | 865 | 1,091 | 1,161 | 1,400 | 1,318 | 92,686,348 | 204 | 474 | 
| regex_program | 1 | 1,139 | 6,066 | 1,914,103 | 149,454,692 | 4,606 | 617 | 798 | 899 | 1,196 | 924 | 72,769,025 | 163 | 321 | 

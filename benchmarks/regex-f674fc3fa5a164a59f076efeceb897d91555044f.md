...
| `total_proof_time_ms ` |  3,838 |  7,676 |  4,398 |  3,278 |
| `main_cells_used     ` |  83,694,725 |  167,389,450 |  93,699,990 |  73,689,460 |
| `total_cycles        ` |  2,070,082 |  4,140,164 |  2,225,434 |  1,914,730 |
| `execute_time_ms     ` |  332 |  664 |  368 |  296 |
| `trace_gen_time_ms   ` |  957.50 |  1,915 |  1,117 |  798 |
| `stark_prove_excluding_trace_time_ms` |  2,548.50 |  5,097 |  2,913 |  2,184 |
| `main_trace_commit_time_ms` |  444.50 |  889 |  523 |  366 |
| `generate_perm_trace_time_ms` |  159 |  318 |  181 |  137 |
| `perm_trace_commit_time_ms` |  644 |  1,288 |  745 |  543 |
| `quotient_poly_compute_time_ms` |  361.50 |  723 |  421 |  302 |
| `quotient_poly_commit_time_ms` |  269.50 |  539 |  313 |  226 |
| `pcs_opening_time_ms ` |  661 |  1,322 |  721 |  601 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,503.50 |  15,007 |  7,592 |  7,415 |
| `main_cells_used     ` |  152,448,142.50 |  304,896,285 |  154,909,233 |  149,987,052 |
| `total_cycles        ` |  1,994,055 |  3,988,110 |  2,024,923 |  1,963,187 |
| `execute_time_ms     ` |  783 |  1,566 |  792 |  774 |
| `trace_gen_time_ms   ` |  1,471 |  2,942 |  1,513 |  1,429 |
| `stark_prove_excluding_trace_time_ms` |  5,249.50 |  10,499 |  5,287 |  5,212 |
| `main_trace_commit_time_ms` |  896 |  1,792 |  896 |  896 |
| `generate_perm_trace_time_ms` |  343.50 |  687 |  346 |  341 |
| `perm_trace_commit_time_ms` |  1,657.50 |  3,315 |  1,689 |  1,626 |
| `quotient_poly_compute_time_ms` |  768 |  1,536 |  768 |  768 |
| `quotient_poly_commit_time_ms` |  521.50 |  1,043 |  522 |  521 |
| `pcs_opening_time_ms ` |  1,057.50 |  2,115 |  1,062 |  1,053 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,513 | 7,592 | 2,024,923 | 534,072,810 | 5,287 | 768 | 521 | 1,689 | 1,062 | 896 | 154,909,233 | 346 | 792 | 
| leaf | 1 | 1,429 | 7,415 | 1,963,187 | 534,072,810 | 5,212 | 768 | 522 | 1,626 | 1,053 | 896 | 149,987,052 | 341 | 774 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,117 | 4,398 | 2,225,434 | 275,652,919 | 2,913 | 421 | 313 | 745 | 721 | 523 | 93,699,990 | 181 | 368 | 
| regex_program | 1 | 798 | 3,278 | 1,914,730 | 198,099,628 | 2,184 | 302 | 226 | 543 | 601 | 366 | 73,689,460 | 137 | 296 | 

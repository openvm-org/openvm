...
| `total_proof_time_ms ` |  3,925 |  7,850 |  4,530 |  3,320 |
...
| `trace_gen_time_ms   ` |  987 |  1,974 |  1,179 |  795 |
| `stark_prove_excluding_trace_time_ms` |  2,594.50 |  5,189 |  2,972 |  2,217 |
| `main_trace_commit_time_ms` |  454 |  908 |  540 |  368 |
| `generate_perm_trace_time_ms` |  164 |  328 |  190 |  138 |
| `perm_trace_commit_time_ms` |  645.50 |  1,291 |  747 |  544 |
| `quotient_poly_compute_time_ms` |  363 |  726 |  416 |  310 |
| `quotient_poly_commit_time_ms` |  274 |  548 |  318 |  230 |
| `pcs_opening_time_ms ` |  685 |  1,370 |  753 |  617 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,477.50 |  14,955 |  7,545 |  7,410 |
| `main_cells_used     ` |  152,305,915 |  304,611,830 |  154,765,761 |  149,846,069 |
| `total_cycles        ` |  1,993,333 |  3,986,666 |  2,024,253 |  1,962,413 |
| `execute_time_ms     ` |  765.50 |  1,531 |  776 |  755 |
| `trace_gen_time_ms   ` |  1,450.50 |  2,901 |  1,466 |  1,435 |
| `stark_prove_excluding_trace_time_ms` |  5,261.50 |  10,523 |  5,303 |  5,220 |
| `main_trace_commit_time_ms` |  896 |  1,792 |  900 |  892 |
| `generate_perm_trace_time_ms` |  339 |  678 |  339 |  339 |
| `perm_trace_commit_time_ms` |  1,656 |  3,312 |  1,689 |  1,623 |
| `quotient_poly_compute_time_ms` |  766 |  1,532 |  768 |  764 |
| `quotient_poly_commit_time_ms` |  524 |  1,048 |  527 |  521 |
| `pcs_opening_time_ms ` |  1,076 |  2,152 |  1,080 |  1,072 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,466 | 7,545 | 2,024,253 | 533,941,738 | 5,303 | 764 | 527 | 1,689 | 1,080 | 900 | 154,765,761 | 339 | 776 | 
| leaf | 1 | 1,435 | 7,410 | 1,962,413 | 533,941,738 | 5,220 | 768 | 521 | 1,623 | 1,072 | 892 | 149,846,069 | 339 | 755 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,179 | 4,530 | 2,225,434 | 275,652,919 | 2,972 | 416 | 318 | 747 | 753 | 540 | 93,699,990 | 190 | 379 | 
| regex_program | 1 | 795 | 3,320 | 1,914,730 | 198,099,628 | 2,217 | 310 | 230 | 544 | 617 | 368 | 73,689,460 | 138 | 308 | 

...
| `total_proof_time_ms ` |  3,855.50 |  7,711 |  4,450 |  3,261 |
| `main_cells_used     ` |  83,707,475.50 |  167,414,951 |  93,727,369 |  73,687,582 |
| `total_cycles        ` |  2,070,115.50 |  4,140,231 |  2,225,434 |  1,914,797 |
| `execute_time_ms     ` |  341 |  682 |  379 |  303 |
| `trace_gen_time_ms   ` |  941 |  1,882 |  1,100 |  782 |
| `stark_prove_excluding_trace_time_ms` |  2,573.50 |  5,147 |  2,971 |  2,176 |
| `main_trace_commit_time_ms` |  449.50 |  899 |  523 |  376 |
| `generate_perm_trace_time_ms` |  162.50 |  325 |  187 |  138 |
| `perm_trace_commit_time_ms` |  641.50 |  1,283 |  742 |  541 |
| `quotient_poly_compute_time_ms` |  359 |  718 |  422 |  296 |
| `quotient_poly_commit_time_ms` |  269 |  538 |  312 |  226 |
| `pcs_opening_time_ms ` |  683.50 |  1,367 |  777 |  590 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,558.50 |  15,117 |  7,665 |  7,452 |
| `main_cells_used     ` |  152,701,669.50 |  305,403,339 |  155,161,310 |  150,242,029 |
| `total_cycles        ` |  1,990,757 |  3,981,514 |  2,021,600 |  1,959,914 |
| `execute_time_ms     ` |  771 |  1,542 |  780 |  762 |
| `trace_gen_time_ms   ` |  1,522.50 |  3,045 |  1,564 |  1,481 |
| `stark_prove_excluding_trace_time_ms` |  5,265 |  10,530 |  5,321 |  5,209 |
| `main_trace_commit_time_ms` |  889.50 |  1,779 |  890 |  889 |
| `generate_perm_trace_time_ms` |  345.50 |  691 |  348 |  343 |
| `perm_trace_commit_time_ms` |  1,681 |  3,362 |  1,731 |  1,631 |
| `quotient_poly_compute_time_ms` |  764.50 |  1,529 |  771 |  758 |
| `quotient_poly_commit_time_ms` |  520 |  1,040 |  521 |  519 |
| `pcs_opening_time_ms ` |  1,059.50 |  2,119 |  1,064 |  1,055 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,564 | 7,665 | 2,021,600 | 538,660,330 | 5,321 | 771 | 521 | 1,731 | 1,055 | 889 | 155,161,310 | 348 | 780 | 
| leaf | 1 | 1,481 | 7,452 | 1,959,914 | 538,660,330 | 5,209 | 758 | 519 | 1,631 | 1,064 | 890 | 150,242,029 | 343 | 762 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,100 | 4,450 | 2,225,434 | 275,652,919 | 2,971 | 422 | 312 | 742 | 777 | 523 | 93,727,369 | 187 | 379 | 
| regex_program | 1 | 782 | 3,261 | 1,914,797 | 198,099,628 | 2,176 | 296 | 226 | 541 | 590 | 376 | 73,687,582 | 138 | 303 | 

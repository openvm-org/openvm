...
| `total_proof_time_ms ` |  714 |  1,428 |  813 |  615 |
...
| `execute_preflight_time_ms` |  96 |  192 |  132 |  60 |
| `execute_preflight_insn_mi/s` |  13.66 | -          |  18.35 |  8.98 |
| `trace_gen_time_ms   ` |  171 |  342 |  188 |  154 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  354 |  708 |  383 |  325 |
| `main_trace_commit_time_ms` |  62 |  124 |  72 |  52 |
| `generate_perm_trace_time_ms` |  53.50 |  107 |  62 |  45 |
| `perm_trace_commit_time_ms` |  74.97 |  149.94 |  87.30 |  62.64 |
| `quotient_poly_compute_time_ms` |  77.94 |  155.87 |  85.74 |  70.14 |
| `quotient_poly_commit_time_ms` |  15.56 |  31.13 |  16.80 |  14.33 |
| `pcs_opening_time_ms ` |  64 |  128 |  70 |  58 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,464.50 |  2,929 |  1,735 |  1,194 |
| `main_cells_used     ` |  16,200,472 |  32,400,944 |  16,332,746 |  16,068,198 |
| `total_cells_used    ` |  39,332,920 |  78,665,840 |  39,650,868 |  39,014,972 |
| `execute_preflight_insns` |  1,952,427 |  3,904,854 |  1,991,872 |  1,912,982 |
| `execute_preflight_time_ms` |  606 |  1,212 |  909 |  303 |
| `execute_preflight_insn_mi/s` |  7.50 | -          |  7.58 |  7.43 |
| `trace_gen_time_ms   ` |  123.50 |  247 |  132 |  115 |
| `memory_finalize_time_ms` |  11.50 |  23 |  12 |  11 |
| `stark_prove_excluding_trace_time_ms` |  733.50 |  1,467 |  758 |  709 |
| `main_trace_commit_time_ms` |  144 |  288 |  148 |  140 |
| `generate_perm_trace_time_ms` |  53.50 |  107 |  56 |  51 |
| `perm_trace_commit_time_ms` |  221.96 |  443.92 |  226.94 |  216.98 |
| `quotient_poly_compute_time_ms` |  162.92 |  325.84 |  165.46 |  160.38 |
| `quotient_poly_commit_time_ms` |  30.81 |  61.62 |  31.02 |  30.59 |
| `pcs_opening_time_ms ` |  116.50 |  233 |  132 |  101 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 1,737 |  | 1 |  | 1 |  |  |  |  | 
| pairing |  | 615 |  | 67 | 1 | 89 | 1,745,742 | 19.51 | 172 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 132 | 1,194 | 39,650,868 | 410,701,290 | 132 | 758 | 0 | 165.46 | 31.02 | 4 | 226.94 | 132 | 279 | 132 | 11 | 148 | 16,332,746 | 51 | 303 | 1,991,872 | 7.43 | 39 | 198 | 0 | 132 | 
| leaf | 1 | 115 | 1,735 | 39,014,972 | 396,840,426 | 115 | 709 | 0 | 160.38 | 30.59 | 5 | 216.98 | 101 | 274 | 100 | 12 | 140 | 16,068,198 | 56 | 909 | 1,912,982 | 7.58 | 37 | 192 | 0 | 100 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 154 | 813 | 32,689,110 | 172,558,444 | 154 | 383 | 0 | 85.74 | 16.80 | 6 | 87.30 | 70 | 136 | 69 | 1 | 72 | 16,059,916 | 45 | 132 | 1,157,000 | 8.98 | 26 | 103 | 1 | 69 | 
| pairing | 1 | 188 | 615 | 22,314,288 | 119,958,502 | 188 | 325 | 1 | 70.14 | 14.33 | 6 | 62.64 | 58 | 128 | 58 | 0 | 52 | 9,408,294 | 62 | 60 | 588,742 | 18.35 | 20 | 85 | 1 | 58 | 

...
| `total_proof_time_ms ` |  3,682.50 |  7,365 |  4,080 |  3,285 |
...
| `trace_gen_time_ms   ` |  957 |  1,914 |  1,119 |  795 |
| `stark_prove_excluding_trace_time_ms` |  2,389 |  4,778 |  2,586 |  2,192 |
| `main_trace_commit_time_ms` |  450 |  900 |  503 |  397 |
| `generate_perm_trace_time_ms` |  195.50 |  391 |  207 |  184 |
| `perm_trace_commit_time_ms` |  487.50 |  975 |  513 |  462 |
| `quotient_poly_compute_time_ms` |  332 |  664 |  359 |  305 |
| `quotient_poly_commit_time_ms` |  226.50 |  453 |  263 |  190 |
| `pcs_opening_time_ms ` |  688 |  1,376 |  732 |  644 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  6,627.50 |  13,255 |  6,674 |  6,581 |
| `main_cells_used     ` |  152,278,613 |  304,557,226 |  154,678,274 |  149,878,952 |
| `total_cycles        ` |  1,991,037 |  3,982,074 |  2,021,848 |  1,960,226 |
| `execute_time_ms     ` |  779 |  1,558 |  788 |  770 |
| `trace_gen_time_ms   ` |  1,475.50 |  2,951 |  1,506 |  1,445 |
| `stark_prove_excluding_trace_time_ms` |  4,373 |  8,746 |  4,380 |  4,366 |
| `main_trace_commit_time_ms` |  780 |  1,560 |  782 |  778 |
| `generate_perm_trace_time_ms` |  384.50 |  769 |  402 |  367 |
| `perm_trace_commit_time_ms` |  1,114 |  2,228 |  1,116 |  1,112 |
| `quotient_poly_compute_time_ms` |  657 |  1,314 |  658 |  656 |
| `quotient_poly_commit_time_ms` |  383.50 |  767 |  385 |  382 |
| `pcs_opening_time_ms ` |  1,048 |  2,096 |  1,052 |  1,044 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,506 | 6,674 | 2,021,848 | 538,660,330 | 4,380 | 656 | 382 | 1,112 | 1,044 | 778 | 154,678,274 | 402 | 788 | 
| leaf | 1 | 1,445 | 6,581 | 1,960,226 | 538,660,330 | 4,366 | 658 | 385 | 1,116 | 1,052 | 782 | 149,878,952 | 367 | 770 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,119 | 4,080 | 2,243,715 | 275,652,919 | 2,586 | 359 | 263 | 513 | 732 | 503 | 93,500,799 | 207 | 375 | 
| regex_program | 1 | 795 | 3,285 | 1,921,511 | 242,975,404 | 2,192 | 305 | 190 | 462 | 644 | 397 | 73,010,353 | 184 | 298 | 

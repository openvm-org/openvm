...
| `total_proof_time_ms ` |  3,904.50 |  7,809 |  4,310 |  3,499 |
...
| `trace_gen_time_ms   ` |  973.50 |  1,947 |  1,139 |  808 |
| `stark_prove_excluding_trace_time_ms` |  2,574 |  5,148 |  2,774 |  2,374 |
| `main_trace_commit_time_ms` |  498.50 |  997 |  555 |  442 |
| `generate_perm_trace_time_ms` |  215.50 |  431 |  229 |  202 |
| `perm_trace_commit_time_ms` |  543 |  1,086 |  572 |  514 |
| `quotient_poly_compute_time_ms` |  271.50 |  543 |  298 |  245 |
| `quotient_poly_commit_time_ms` |  239.50 |  479 |  273 |  206 |
| `pcs_opening_time_ms ` |  796 |  1,592 |  838 |  754 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  6,983 |  13,966 |  7,039 |  6,927 |
| `main_cells_used     ` |  151,827,911 |  303,655,822 |  154,227,674 |  149,428,148 |
| `total_cycles        ` |  1,975,732.50 |  3,951,465 |  2,006,552 |  1,944,913 |
| `execute_time_ms     ` |  772 |  1,544 |  780 |  764 |
| `trace_gen_time_ms   ` |  1,471 |  2,942 |  1,477 |  1,465 |
| `stark_prove_excluding_trace_time_ms` |  4,740 |  9,480 |  4,782 |  4,698 |
| `main_trace_commit_time_ms` |  865 |  1,730 |  865 |  865 |
| `generate_perm_trace_time_ms` |  390.50 |  781 |  411 |  370 |
| `perm_trace_commit_time_ms` |  1,253.50 |  2,507 |  1,268 |  1,239 |
| `quotient_poly_compute_time_ms` |  535 |  1,070 |  543 |  527 |
| `quotient_poly_commit_time_ms` |  413 |  826 |  416 |  410 |
| `pcs_opening_time_ms ` |  1,277.50 |  2,555 |  1,279 |  1,276 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,477 | 7,039 | 2,006,552 | 538,660,330 | 4,782 | 543 | 410 | 1,268 | 1,279 | 865 | 154,227,674 | 411 | 780 | 
| leaf | 1 | 1,465 | 6,927 | 1,944,913 | 538,660,330 | 4,698 | 527 | 416 | 1,239 | 1,276 | 865 | 149,428,148 | 370 | 764 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,139 | 4,310 | 2,243,715 | 275,652,919 | 2,774 | 298 | 273 | 572 | 838 | 555 | 93,500,799 | 229 | 397 | 
| regex_program | 1 | 808 | 3,499 | 1,921,511 | 242,975,404 | 2,374 | 245 | 206 | 514 | 754 | 442 | 73,010,353 | 202 | 317 | 

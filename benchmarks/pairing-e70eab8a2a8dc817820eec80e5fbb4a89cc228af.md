...
| `total_proof_time_ms ` |  1,535 |  1,535 |  1,535 |  1,535 |
...
| `execute_preflight_insn_mi/s` |  11.57 | -          |  11.57 |  11.57 |
| `trace_gen_time_ms   ` |  274 |  274 |  274 |  274 |
| `memory_finalize_time_ms` |  1 |  1 |  1 |  1 |
| `stark_prove_excluding_trace_time_ms` |  966 |  966 |  966 |  966 |
| `main_trace_commit_time_ms` |  149 |  149 |  149 |  149 |
| `generate_perm_trace_time_ms` |  78 |  78 |  78 |  78 |
| `perm_trace_commit_time_ms` |  176.70 |  176.70 |  176.70 |  176.70 |
| `quotient_poly_compute_time_ms` |  141.55 |  141.55 |  141.55 |  141.55 |
| `quotient_poly_commit_time_ms` |  33.81 |  33.81 |  33.81 |  33.81 |
| `pcs_opening_time_ms ` |  380 |  380 |  380 |  380 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,740 |  1,740 |  1,740 |  1,740 |
| `main_cells_used     ` |  16,451,316 |  16,451,316 |  16,451,316 |  16,451,316 |
| `total_cells_used    ` |  39,940,154 |  39,940,154 |  39,940,154 |  39,940,154 |
| `execute_preflight_insns` |  2,010,455 |  2,010,455 |  2,010,455 |  2,010,455 |
| `execute_preflight_time_ms` |  336 |  336 |  336 |  336 |
...
| `perm_trace_commit_time_ms` |  250.36 |  250.36 |  250.36 |  250.36 |
| `quotient_poly_compute_time_ms` |  160.26 |  160.26 |  160.26 |  160.26 |
| `quotient_poly_commit_time_ms` |  39.03 |  39.03 |  39.03 |  39.03 |
| `pcs_opening_time_ms ` |  587 |  587 |  587 |  587 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 1,742 |  | 1 |  | 1 |  |  |  |  | 
| pairing |  | 1,535 |  | 40 | 1 | 93 | 1,882,939 | 20.15 | 149 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 123 | 1,740 | 39,940,154 | 418,598,378 | 122 | 1,280 | 0 | 160.26 | 39.03 | 4 | 250.36 | 587 | 327 | 586 | 13 | 165 | 16,451,316 | 76 | 336 | 2,010,455 | 7.49 | 39 | 200 | 1 | 586 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 274 | 1,535 | 44,491,360 | 304,931,516 | 274 | 966 | 0 | 141.55 | 33.81 | 6 | 176.70 | 380 | 258 | 380 | 1 | 149 | 23,722,622 | 78 | 167 | 1,882,939 | 11.57 | 37 | 177 | 3 | 380 | 

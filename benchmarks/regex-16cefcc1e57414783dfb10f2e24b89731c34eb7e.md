...
| `total_proof_time_ms ` |  4,188.50 |  8,377 |  4,624 |  3,753 |
...
| `trace_gen_time_ms   ` |  986.50 |  1,973 |  1,161 |  812 |
| `stark_prove_excluding_trace_time_ms` |  2,859.50 |  5,719 |  3,082 |  2,637 |
| `main_trace_commit_time_ms` |  520.50 |  1,041 |  583 |  458 |
| `generate_perm_trace_time_ms` |  200 |  400 |  207 |  193 |
| `perm_trace_commit_time_ms` |  749.50 |  1,499 |  802 |  697 |
| `quotient_poly_compute_time_ms` |  396 |  792 |  423 |  369 |
| `quotient_poly_commit_time_ms` |  297.50 |  595 |  336 |  259 |
| `pcs_opening_time_ms ` |  686.50 |  1,373 |  722 |  651 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,573 |  15,146 |  7,660 |  7,486 |
| `main_cells_used     ` |  152,770,112 |  305,540,224 |  155,170,139 |  150,370,085 |
| `total_cycles        ` |  1,991,064.50 |  3,982,129 |  2,021,906 |  1,960,223 |
| `execute_time_ms     ` |  775 |  1,550 |  781 |  769 |
| `trace_gen_time_ms   ` |  1,483.50 |  2,967 |  1,520 |  1,447 |
| `stark_prove_excluding_trace_time_ms` |  5,314.50 |  10,629 |  5,359 |  5,270 |
| `main_trace_commit_time_ms` |  895 |  1,790 |  896 |  894 |
| `generate_perm_trace_time_ms` |  366.50 |  733 |  373 |  360 |
| `perm_trace_commit_time_ms` |  1,684 |  3,368 |  1,721 |  1,647 |
| `quotient_poly_compute_time_ms` |  767.50 |  1,535 |  768 |  767 |
| `quotient_poly_commit_time_ms` |  525 |  1,050 |  525 |  525 |
| `pcs_opening_time_ms ` |  1,069.50 |  2,139 |  1,083 |  1,056 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,520 | 7,660 | 2,021,906 | 538,660,330 | 5,359 | 768 | 525 | 1,721 | 1,083 | 896 | 155,170,139 | 360 | 781 | 
| leaf | 1 | 1,447 | 7,486 | 1,960,223 | 538,660,330 | 5,270 | 767 | 525 | 1,647 | 1,056 | 894 | 150,370,085 | 373 | 769 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,161 | 4,624 | 2,243,715 | 275,652,919 | 3,082 | 423 | 336 | 802 | 722 | 583 | 94,508,931 | 207 | 381 | 
| regex_program | 1 | 812 | 3,753 | 1,921,511 | 242,975,404 | 2,637 | 369 | 259 | 697 | 651 | 458 | 74,018,485 | 193 | 304 | 

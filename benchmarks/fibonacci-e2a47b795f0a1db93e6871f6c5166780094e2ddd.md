...
| `total_proof_time_ms ` |  514.50 |  1,029 |  586 |  443 |
...
| `execute_preflight_insn_mi/s` |  36.72 | -          |  38.79 |  34.64 |
| `trace_gen_time_ms   ` |  188.50 |  377 |  195 |  182 |
| `memory_finalize_time_ms` | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  190.50 |  381 |  195 |  186 |
| `main_trace_commit_time_ms` |  30 |  60 |  32 |  28 |
| `generate_perm_trace_time_ms` |  33.50 |  67 |  39 |  28 |
| `perm_trace_commit_time_ms` |  41.38 |  82.76 |  44.36 |  38.40 |
| `quotient_poly_compute_time_ms` |  31.08 |  62.17 |  32.38 |  29.79 |
| `quotient_poly_commit_time_ms` |  12.43 |  24.86 |  13.35 |  11.51 |
| `pcs_opening_time_ms ` |  39.50 |  79 |  42 |  37 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  986 |  1,972 |  1,240 |  732 |
...
| `execute_preflight_time_ms` |  502 |  1,004 |  804 |  200 |
| `execute_preflight_insn_mi/s` |  6.87 | -          |  6.91 |  6.82 |
| `trace_gen_time_ms   ` |  56.50 |  113 |  59 |  54 |
| `memory_finalize_time_ms` |  6 |  12 |  6 |  6 |
| `stark_prove_excluding_trace_time_ms` |  425.50 |  851 |  471 |  380 |
| `main_trace_commit_time_ms` |  83.50 |  167 |  91 |  76 |
| `generate_perm_trace_time_ms` |  31 |  62 |  34 |  28 |
| `perm_trace_commit_time_ms` |  124.87 |  249.74 |  142.04 |  107.70 |
| `quotient_poly_compute_time_ms` |  91.81 |  183.63 |  102.99 |  80.64 |
| `quotient_poly_commit_time_ms` |  22.31 |  44.62 |  24.12 |  20.50 |
| `pcs_opening_time_ms ` |  69.50 |  139 |  74 |  65 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program |  | 443 |  | 1 | 13 | 1,500,209 | 111.72 | 0 | 
| leaf | 1,242 |  | 1 | 1 |  |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 59 | 732 | 17,887,054 | 252,878,314 | 59 | 471 | 0 | 102.99 | 24.12 | 4 | 142.04 | 74 | 177 | 74 | 6 | 91 | 6,608,072 | 34 | 200 | 1,229,581 | 6.91 | 26 | 128 | 0 | 74 | 
| leaf | 1 | 54 | 1,240 | 17,250,234 | 207,789,546 | 54 | 380 | 0 | 80.64 | 20.50 | 4 | 107.70 | 65 | 136 | 65 | 6 | 76 | 6,343,052 | 28 | 804 | 1,151,214 | 6.82 | 22 | 101 | 0 | 65 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 195 | 586 | 9,677,708 | 84,395,212 | 195 | 195 | 0 | 32.38 | 13.35 | 4 | 44.36 | 42 | 73 | 42 | 0 | 32 | 1,035,986 | 28 | 26 | 873,000 | 34.64 | 14 | 46 | 0 | 42 | 
| fibonacci_program | 1 | 182 | 443 | 9,708,170 | 74,305,770 | 182 | 186 | 1 | 29.79 | 11.51 | 4 | 38.40 | 37 | 78 | 37 | 0 | 28 | 1,064,416 | 39 | 33 | 627,209 | 38.79 | 11 | 41 | 0 | 37 | 

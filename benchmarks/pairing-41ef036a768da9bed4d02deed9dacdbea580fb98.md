...
| `total_proof_time_ms ` |  1,596 |  1,596 |  1,596 |  1,596 |
...
| `stark_prove_excluding_trace_time_ms` |  950 |  950 |  950 |  950 |
| `main_trace_commit_time_ms` |  147 |  147 |  147 |  147 |
| `generate_perm_trace_time_ms` |  72 |  72 |  72 |  72 |
| `perm_trace_commit_time_ms` |  175.39 |  175.39 |  175.39 |  175.39 |
| `quotient_poly_compute_time_ms` |  140.68 |  140.68 |  140.68 |  140.68 |
| `quotient_poly_commit_time_ms` |  33.98 |  33.98 |  33.98 |  33.98 |
| `pcs_opening_time_ms ` |  375 |  375 |  375 |  375 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,708 |  1,708 |  1,708 |  1,708 |
| `main_cells_used     ` |  16,451,316 |  16,451,316 |  16,451,316 |  16,451,316 |
| `total_cells_used    ` |  39,940,154 |  39,940,154 |  39,940,154 |  39,940,154 |
| `execute_preflight_insns` |  2,010,388 |  2,010,388 |  2,010,388 |  2,010,388 |
| `execute_preflight_time_ms` |  324 |  324 |  324 |  324 |
| `execute_preflight_insn_mi/s` |  7.76 | -          |  7.76 |  7.76 |
...
| `generate_perm_trace_time_ms` |  72 |  72 |  72 |  72 |
| `perm_trace_commit_time_ms` |  249.03 |  249.03 |  249.03 |  249.03 |
| `quotient_poly_compute_time_ms` |  166 |  166 |  166 |  166 |
| `quotient_poly_commit_time_ms` |  40.05 |  40.05 |  40.05 |  40.05 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 1,711 |  | 1 |  | 1 |  |  |  |  | 
| pairing |  | 1,596 |  | 41 | 1 | 94 | 1,882,939 | 19.98 | 151 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 123 | 1,708 | 39,940,154 | 418,598,378 | 123 | 1,259 | 0 | 166 | 40.05 | 4 | 249.03 | 564 | 322 | 564 | 11 | 165 | 16,451,316 | 72 | 324 | 2,010,388 | 7.76 | 39 | 207 | 1 | 564 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 351 | 1,596 | 44,491,360 | 304,931,516 | 351 | 950 | 0 | 140.68 | 33.98 | 7 | 175.39 | 375 | 250 | 375 | 1 | 147 | 23,722,622 | 72 | 167 | 1,882,939 | 11.61 | 37 | 176 | 3 | 375 | 

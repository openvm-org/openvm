...
| `total_proof_time_ms ` |  508.50 |  1,017 |  591 |  426 |
...
| `execute_metered_insn_mi/s` |  146.98 | -          |  146.98 |  146.98 |
| `execute_preflight_insns` |  750,104.50 |  1,500,209 |  873,000 |  627,209 |
| `execute_preflight_time_ms` |  29 |  58 |  32 |  26 |
| `execute_preflight_insn_mi/s` |  36.47 | -          |  38.33 |  34.61 |
| `trace_gen_time_ms   ` |  192 |  384 |  197 |  187 |
| `memory_finalize_time_ms` | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  194.50 |  389 |  225 |  164 |
| `main_trace_commit_time_ms` |  30.50 |  61 |  33 |  28 |
| `generate_perm_trace_time_ms` |  21.50 |  43 |  29 |  14 |
| `perm_trace_commit_time_ms` |  40.74 |  81.49 |  43.37 |  38.12 |
| `quotient_poly_compute_time_ms` |  32.73 |  65.47 |  34.66 |  30.80 |
| `quotient_poly_commit_time_ms` |  12.16 |  24.32 |  12.37 |  11.94 |
| `pcs_opening_time_ms ` |  54.50 |  109 |  70 |  39 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  985 |  1,970 |  1,239 |  731 |
| `main_cells_used     ` |  6,475,562 |  12,951,124 |  6,608,072 |  6,343,052 |
| `total_cells_used    ` |  17,568,644 |  35,137,288 |  17,887,054 |  17,250,234 |
| `execute_preflight_insns` |  1,190,389.50 |  2,380,779 |  1,229,642 |  1,151,137 |
| `execute_preflight_time_ms` |  496 |  992 |  792 |  200 |
| `execute_preflight_insn_mi/s` |  6.71 | -          |  6.87 |  6.56 |
| `trace_gen_time_ms   ` |  58.50 |  117 |  60 |  57 |
| `memory_finalize_time_ms` |  5 |  10 |  5 |  5 |
| `stark_prove_excluding_trace_time_ms` |  429 |  858 |  470 |  388 |
| `main_trace_commit_time_ms` |  83.50 |  167 |  91 |  76 |
| `generate_perm_trace_time_ms` |  33.50 |  67 |  35 |  32 |
| `perm_trace_commit_time_ms` |  125.27 |  250.55 |  143.72 |  106.82 |
| `quotient_poly_compute_time_ms` |  90.66 |  181.31 |  100.13 |  81.18 |
| `quotient_poly_commit_time_ms` |  21.23 |  42.47 |  23.06 |  19.41 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program |  | 426 |  | 41 | 1 | 10 | 1,500,209 | 146.98 | 141 | 
| leaf | 1,240 |  | 1 |  | 1 |  |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 60 | 731 | 17,887,054 | 252,878,314 | 60 | 470 | 0 | 100.13 | 23.06 | 4 | 143.72 | 77 | 177 | 77 | 5 | 91 | 6,608,072 | 32 | 200 | 1,229,642 | 6.87 | 25 | 124 | 0 | 77 | 
| leaf | 1 | 57 | 1,239 | 17,250,234 | 207,789,546 | 57 | 388 | 0 | 81.18 | 19.41 | 4 | 106.82 | 67 | 143 | 67 | 5 | 76 | 6,343,052 | 35 | 792 | 1,151,137 | 6.56 | 22 | 101 | 0 | 67 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 197 | 591 | 9,677,708 | 84,395,212 | 197 | 225 | 0 | 34.66 | 12.37 | 4 | 43.37 | 70 | 73 | 70 | 0 | 33 | 1,035,986 | 29 | 26 | 873,000 | 34.61 | 13 | 47 | 0 | 70 | 
| fibonacci_program | 1 | 187 | 426 | 9,708,170 | 74,305,770 | 187 | 164 | 1 | 30.80 | 11.94 | 4 | 38.12 | 39 | 53 | 39 | 0 | 28 | 1,064,416 | 14 | 32 | 627,209 | 38.33 | 11 | 43 | 0 | 39 | 

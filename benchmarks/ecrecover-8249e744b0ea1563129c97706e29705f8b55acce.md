...
| `stark_prove_excluding_trace_time_ms` |  1,048 |  1,048 |  1,048 |  1,048 |
...
| `quotient_poly_commit_time_ms` |  151 |  151 |  151 |  151 |
| `pcs_opening_time_ms ` |  404 |  404 |  404 |  404 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  11,950 |  11,950 |  11,950 |  11,950 |
| `main_cells_used     ` |  244,253,162 |  244,253,162 |  244,253,162 |  244,253,162 |
| `total_cycles        ` |  2,988,571 |  2,988,571 |  2,988,571 |  2,988,571 |
| `execute_time_ms     ` |  1,102 |  1,102 |  1,102 |  1,102 |
| `trace_gen_time_ms   ` |  2,318 |  2,318 |  2,318 |  2,318 |
| `stark_prove_excluding_trace_time_ms` |  8,530 |  8,530 |  8,530 |  8,530 |
| `main_trace_commit_time_ms` |  1,683 |  1,683 |  1,683 |  1,683 |
| `generate_perm_trace_time_ms` |  771 |  771 |  771 |  771 |
| `perm_trace_commit_time_ms` |  2,384 |  2,384 |  2,384 |  2,384 |
| `quotient_poly_compute_time_ms` |  1,212 |  1,212 |  1,212 |  1,212 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 2,318 | 11,950 | 2,988,571 | 1,008,831,978 | 8,530 | 1,212 | 698 | 2,384 | 1,778 | 1,683 | 244,253,162 | 771 | 1,102 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 173 | 1,367 | 289,447 | 48,240,297 | 1,048 | 109 | 151 | 160 | 404 | 175 | 14,470,186 | 34 | 146 | 

...
| `total_proof_time_ms ` |  4,162 |  8,324 |  4,654 |  3,670 |
...
| `trace_gen_time_ms   ` |  968.50 |  1,937 |  1,173 |  764 |
| `stark_prove_excluding_trace_time_ms` |  2,859 |  5,718 |  3,109 |  2,609 |
| `main_trace_commit_time_ms` |  518.50 |  1,037 |  581 |  456 |
| `generate_perm_trace_time_ms` |  186 |  372 |  187 |  185 |
| `perm_trace_commit_time_ms` |  750.50 |  1,501 |  806 |  695 |
| `quotient_poly_compute_time_ms` |  391 |  782 |  425 |  357 |
| `quotient_poly_commit_time_ms` |  296.50 |  593 |  336 |  257 |
| `pcs_opening_time_ms ` |  707.50 |  1,415 |  765 |  650 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,254.50 |  14,509 |  7,296 |  7,213 |
| `main_cells_used     ` |  152,278,507 |  304,557,014 |  154,678,558 |  149,878,456 |
| `total_cycles        ` |  1,991,053.50 |  3,982,107 |  2,021,897 |  1,960,210 |
| `execute_time_ms     ` |  756.50 |  1,513 |  765 |  748 |
| `trace_gen_time_ms   ` |  1,458 |  2,916 |  1,469 |  1,447 |
| `stark_prove_excluding_trace_time_ms` |  5,040 |  10,080 |  5,062 |  5,018 |
| `main_trace_commit_time_ms` |  808 |  1,616 |  809 |  807 |
| `generate_perm_trace_time_ms` |  369.50 |  739 |  375 |  364 |
| `perm_trace_commit_time_ms` |  1,543.50 |  3,087 |  1,565 |  1,522 |
| `quotient_poly_compute_time_ms` |  766 |  1,532 |  769 |  763 |
| `quotient_poly_commit_time_ms` |  496.50 |  993 |  497 |  496 |
| `pcs_opening_time_ms ` |  1,050.50 |  2,101 |  1,054 |  1,047 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,469 | 7,296 | 2,021,897 | 538,660,330 | 5,062 | 769 | 497 | 1,565 | 1,054 | 807 | 154,678,558 | 364 | 765 | 
| leaf | 1 | 1,447 | 7,213 | 1,960,210 | 538,660,330 | 5,018 | 763 | 496 | 1,522 | 1,047 | 809 | 149,878,456 | 375 | 748 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,173 | 4,654 | 2,243,715 | 275,652,919 | 3,109 | 425 | 336 | 806 | 765 | 581 | 93,500,799 | 187 | 372 | 
| regex_program | 1 | 764 | 3,670 | 1,921,511 | 242,975,404 | 2,609 | 357 | 257 | 695 | 650 | 456 | 73,010,353 | 185 | 297 | 

...
|:---|---:|---:|---:|
| Total |  23.94 |  12.34 | 12.34 |
| pairing |  9.79 |  5.24 |  5.24 |
| leaf |  14.15 |  7.09 |  7.09 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  4,863.50 |  9,727 |  5,180 |  4,547 |
...
| `execute_preflight_insn_mi/s` |  14.45 | -          |  17.65 |  11.25 |
| `trace_gen_time_ms   ` |  183 |  366 |  202 |  164 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  4,490.50 |  8,981 |  4,888 |  4,093 |
| `main_trace_commit_time_ms` |  65 |  130 |  75 |  55 |
| `generate_perm_trace_time_ms` |  46.50 |  93 |  47 |  46 |
| `perm_trace_commit_time_ms` |  76.74 |  153.48 |  89.64 |  63.84 |
| `quotient_poly_compute_time_ms` |  83.18 |  166.36 |  92.37 |  73.100 |
| `quotient_poly_commit_time_ms` |  17.25 |  34.50 |  19.58 |  14.92 |
| `pcs_opening_time_ms ` |  4,196.50 |  8,393 |  4,628 |  3,765 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,074.50 |  14,149 |  7,095 |  7,054 |
| `main_cells_used     ` |  20,421,191 |  40,842,382 |  20,631,620 |  20,210,762 |
| `total_cells_used    ` |  49,520,619 |  99,041,238 |  50,023,906 |  49,017,332 |
| `execute_preflight_insns` |  2,989,054.50 |  5,978,109 |  3,051,218 |  2,926,891 |
| `execute_preflight_time_ms` |  1,027.50 |  2,055 |  1,533 |  522 |
| `execute_preflight_insn_mi/s` |  6.38 | -          |  6.40 |  6.36 |
| `trace_gen_time_ms   ` |  164 |  328 |  171 |  157 |
| `memory_finalize_time_ms` |  14.50 |  29 |  15 |  14 |
| `stark_prove_excluding_trace_time_ms` |  5,881.50 |  11,763 |  6,360 |  5,403 |
| `main_trace_commit_time_ms` |  297.50 |  595 |  298 |  297 |
| `generate_perm_trace_time_ms` |  190 |  380 |  262 |  118 |
| `perm_trace_commit_time_ms` |  454.74 |  909.48 |  456.40 |  453.07 |
| `quotient_poly_compute_time_ms` |  332.33 |  664.66 |  333.19 |  331.48 |
| `quotient_poly_commit_time_ms` |  69 |  138.01 |  69.77 |  68.24 |
| `pcs_opening_time_ms ` |  4,531.50 |  9,063 |  4,936 |  4,127 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 7,099 |  | 1 | 1 |  |  |  |  | 
| pairing |  | 5,180 |  | 1 | 63 | 1,745,742 | 27.69 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 171 | 7,054 | 50,023,906 | 761,351,658 | 171 | 6,360 | 0 | 331.48 | 68.24 | 6 | 456.40 | 4,936 | 719 | 4,936 | 15 | 298 | 20,631,620 | 262 | 522 | 3,051,218 | 6.40 | 83 | 405 | 4 | 4,936 | 
| leaf | 1 | 157 | 7,095 | 49,017,332 | 761,351,658 | 157 | 5,403 | 0 | 333.19 | 69.77 | 6 | 453.07 | 4,127 | 572 | 4,127 | 14 | 297 | 20,210,762 | 118 | 1,533 | 2,926,891 | 6.36 | 79 | 405 | 0 | 4,127 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 164 | 4,547 | 32,480,114 | 172,558,444 | 164 | 4,093 | 0 | 92.37 | 19.58 | 8 | 89.64 | 3,765 | 139 | 3,765 | 1 | 75 | 15,909,408 | 46 | 120 | 1,149,000 | 11.25 | 27 | 112 | 1 | 3,765 | 
| pairing | 1 | 202 | 5,180 | 22,464,232 | 119,958,502 | 202 | 4,888 | 1 | 73.100 | 14.92 | 8 | 63.84 | 4,628 | 114 | 4,628 | 0 | 55 | 9,498,894 | 47 | 48 | 596,742 | 17.65 | 21 | 89 | 1 | 4,628 | 

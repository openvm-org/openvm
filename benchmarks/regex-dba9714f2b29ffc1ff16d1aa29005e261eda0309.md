...
| `total_proof_time_ms ` |  3,928 |  7,856 |  4,344 |  3,512 |
| `main_cells_used     ` |  83,255,576 |  166,511,152 |  93,500,799 |  73,010,353 |
| `total_cycles        ` |  2,082,613 |  4,165,226 |  2,243,715 |  1,921,511 |
| `execute_time_ms     ` |  350 |  700 |  389 |  311 |
| `trace_gen_time_ms   ` |  979 |  1,958 |  1,177 |  781 |
| `stark_prove_excluding_trace_time_ms` |  2,599 |  5,198 |  2,778 |  2,420 |
| `main_trace_commit_time_ms` |  498.50 |  997 |  554 |  443 |
| `generate_perm_trace_time_ms` |  215.50 |  431 |  221 |  210 |
| `perm_trace_commit_time_ms` |  557.50 |  1,115 |  572 |  543 |
| `quotient_poly_compute_time_ms` |  260 |  520 |  285 |  235 |
| `quotient_poly_commit_time_ms` |  243.50 |  487 |  275 |  212 |
| `pcs_opening_time_ms ` |  813 |  1,626 |  859 |  767 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,022 |  14,044 |  7,081 |  6,963 |
| `main_cells_used     ` |  151,828,199 |  303,656,398 |  154,227,758 |  149,428,640 |
| `total_cycles        ` |  1,975,756.50 |  3,951,513 |  2,006,559 |  1,944,954 |
| `execute_time_ms     ` |  771.50 |  1,543 |  779 |  764 |
| `trace_gen_time_ms   ` |  1,506.50 |  3,013 |  1,533 |  1,480 |
| `stark_prove_excluding_trace_time_ms` |  4,744 |  9,488 |  4,769 |  4,719 |
| `main_trace_commit_time_ms` |  867 |  1,734 |  868 |  866 |
| `generate_perm_trace_time_ms` |  395.50 |  791 |  418 |  373 |
| `perm_trace_commit_time_ms` |  1,243 |  2,486 |  1,247 |  1,239 |
| `quotient_poly_compute_time_ms` |  529 |  1,058 |  531 |  527 |
| `quotient_poly_commit_time_ms` |  410.50 |  821 |  411 |  410 |
| `pcs_opening_time_ms ` |  1,292.50 |  2,585 |  1,293 |  1,292 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,533 | 7,081 | 2,006,559 | 538,660,330 | 4,769 | 527 | 410 | 1,247 | 1,292 | 868 | 154,227,758 | 418 | 779 | 
| leaf | 1 | 1,480 | 6,963 | 1,944,954 | 538,660,330 | 4,719 | 531 | 411 | 1,239 | 1,293 | 866 | 149,428,640 | 373 | 764 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,177 | 4,344 | 2,243,715 | 275,652,919 | 2,778 | 285 | 275 | 572 | 859 | 554 | 93,500,799 | 221 | 389 | 
| regex_program | 1 | 781 | 3,512 | 1,921,511 | 242,975,404 | 2,420 | 235 | 212 | 543 | 767 | 443 | 73,010,353 | 210 | 311 | 

...
| `total_proof_time_ms ` |  7,687.50 |  15,375 |  8,638 |  6,737 |
| `main_cells_used     ` |  82,727,686.50 |  165,455,373 |  92,686,348 |  72,769,025 |
| `total_cycles        ` |  1,914,103 |  1,914,103 |  1,914,103 |  1,914,103 |
| `execute_time_ms     ` |  451 |  902 |  485 |  417 |
| `trace_gen_time_ms   ` |  1,687 |  3,374 |  1,877 |  1,497 |
| `stark_prove_excluding_trace_time_ms` |  5,549.50 |  11,099 |  6,276 |  4,823 |
| `main_trace_commit_time_ms` |  1,092 |  2,184 |  1,336 |  848 |
| `generate_perm_trace_time_ms` |  170 |  340 |  191 |  149 |
| `perm_trace_commit_time_ms` |  1,184 |  2,368 |  1,247 |  1,121 |
| `quotient_poly_compute_time_ms` |  746 |  1,492 |  871 |  621 |
| `quotient_poly_commit_time_ms` |  1,000 |  2,000 |  1,162 |  838 |
| `pcs_opening_time_ms ` |  1,344 |  2,688 |  1,460 |  1,228 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  14,800.50 |  29,601 |  14,962 |  14,639 |
| `main_cells_used     ` |  129,448,828.50 |  258,897,657 |  131,047,301 |  127,850,356 |
| `total_cycles        ` |  2,941,808.50 |  5,883,617 |  2,977,996 |  2,905,621 |
| `execute_time_ms     ` |  638.50 |  1,277 |  682 |  595 |
| `trace_gen_time_ms   ` |  2,681.50 |  5,363 |  2,837 |  2,526 |
| `stark_prove_excluding_trace_time_ms` |  11,480.50 |  22,961 |  11,530 |  11,431 |
| `main_trace_commit_time_ms` |  2,353.50 |  4,707 |  2,371 |  2,336 |
| `generate_perm_trace_time_ms` |  282.50 |  565 |  283 |  282 |
| `perm_trace_commit_time_ms` |  2,312.50 |  4,625 |  2,329 |  2,296 |
| `quotient_poly_compute_time_ms` |  1,658 |  3,316 |  1,660 |  1,656 |
| `quotient_poly_commit_time_ms` |  2,234 |  4,468 |  2,245 |  2,223 |
| `pcs_opening_time_ms ` |  2,635.50 |  5,271 |  2,643 |  2,628 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 2,526 | 14,639 | 2,977,996 | 353,773,272 | 11,431 | 1,660 | 2,223 | 2,296 | 2,628 | 2,336 | 131,047,301 | 282 | 682 | 
| leaf | 1 | 2,837 | 14,962 | 2,905,621 | 353,780,696 | 11,530 | 1,656 | 2,245 | 2,329 | 2,643 | 2,371 | 127,850,356 | 283 | 595 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,877 | 8,638 |  | 209,921,543 | 6,276 | 871 | 1,162 | 1,247 | 1,460 | 1,336 | 92,686,348 | 191 | 485 | 
| regex_program | 1 | 1,497 | 6,737 | 1,914,103 | 149,454,692 | 4,823 | 621 | 838 | 1,121 | 1,228 | 848 | 72,769,025 | 149 | 417 | 

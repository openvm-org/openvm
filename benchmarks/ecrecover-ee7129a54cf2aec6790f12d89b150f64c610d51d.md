...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  41,953 |  41,953 |  41,953 |  41,953 |
| `main_cells_used     ` |  365,929,499 |  365,929,499 |  365,929,499 |  365,929,499 |
| `total_cycles        ` |  8,656,424 |  8,656,424 |  8,656,424 |  8,656,424 |
| `execute_time_ms     ` |  2,458 |  2,458 |  2,458 |  2,458 |
| `trace_gen_time_ms   ` |  6,605 |  6,605 |  6,605 |  6,605 |
| `stark_prove_excluding_trace_time_ms` |  32,890 |  32,890 |  32,890 |  32,890 |
| `main_trace_commit_time_ms` |  5,835 |  5,835 |  5,835 |  5,835 |
| `generate_perm_trace_time_ms` |  707 |  707 |  707 |  707 |
| `perm_trace_commit_time_ms` |  7,317 |  7,317 |  7,317 |  7,317 |
| `quotient_poly_compute_time_ms` |  7,483 |  7,483 |  7,483 |  7,483 |
| `quotient_poly_commit_time_ms` |  5,134 |  5,134 |  5,134 |  5,134 |
| `pcs_opening_time_ms ` |  6,411 |  6,411 |  6,411 |  6,411 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 6,605 | 41,953 | 8,656,424 | 1,052,183,000 | 32,890 | 7,483 | 5,134 | 7,317 | 6,411 | 5,835 | 365,929,499 | 707 | 2,458 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 264 | 2,599 | 285,401 | 56,172,159 | 2,183 | 293 | 298 | 524 | 624 | 398 | 15,092,297 | 41 | 152 | 

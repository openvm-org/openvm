...
| `total_proof_time_ms ` |  758.50 |  1,517 |  847 |  670 |
...
| `execute_preflight_insn_mi/s` |  13.47 | -          |  17.76 |  9.18 |
| `trace_gen_time_ms   ` |  176.50 |  353 |  192 |  161 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  394.50 |  789 |  413 |  376 |
| `main_trace_commit_time_ms` |  63.50 |  127 |  75 |  52 |
| `generate_perm_trace_time_ms` |  55 |  110 |  71 |  39 |
| `perm_trace_commit_time_ms` |  76.75 |  153.50 |  88.89 |  64.61 |
| `quotient_poly_compute_time_ms` |  78.66 |  157.32 |  86.80 |  70.52 |
| `quotient_poly_commit_time_ms` |  15.86 |  31.72 |  17.16 |  14.56 |
| `pcs_opening_time_ms ` |  100 |  200 |  102 |  98 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,453 |  2,906 |  1,724 |  1,182 |
| `main_cells_used     ` |  16,200,472 |  32,400,944 |  16,332,746 |  16,068,198 |
| `total_cells_used    ` |  39,332,920 |  78,665,840 |  39,650,868 |  39,014,972 |
| `execute_preflight_insns` |  1,952,506 |  3,905,012 |  1,992,064 |  1,912,948 |
| `execute_preflight_time_ms` |  584.50 |  1,169 |  881 |  288 |
| `execute_preflight_insn_mi/s` |  7.80 | -          |  7.84 |  7.75 |
| `trace_gen_time_ms   ` |  116.50 |  233 |  125 |  108 |
| `memory_finalize_time_ms` |  10.50 |  21 |  11 |  10 |
| `stark_prove_excluding_trace_time_ms` |  750 |  1,500 |  767 |  733 |
| `main_trace_commit_time_ms` |  146.50 |  293 |  150 |  143 |
| `generate_perm_trace_time_ms` |  62.50 |  125 |  73 |  52 |
| `perm_trace_commit_time_ms` |  226.49 |  452.97 |  230.74 |  222.23 |
| `quotient_poly_compute_time_ms` |  166.15 |  332.30 |  168.56 |  163.73 |
| `quotient_poly_commit_time_ms` |  32.31 |  64.62 |  33.20 |  31.42 |
| `pcs_opening_time_ms ` |  112.50 |  225 |  117 |  108 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 1,725 |  | 1 | 1 |  |  |  |  | 
| pairing |  | 670 |  | 1 | 90 | 1,745,742 | 19.37 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 125 | 1,182 | 39,650,868 | 410,701,290 | 125 | 767 | 0 | 168.56 | 33.20 | 4 | 230.74 | 108 | 305 | 108 | 11 | 150 | 16,332,746 | 73 | 288 | 1,992,064 | 7.84 | 39 | 203 | 0 | 108 | 
| leaf | 1 | 108 | 1,724 | 39,014,972 | 396,840,426 | 108 | 733 | 0 | 163.73 | 31.42 | 4 | 222.23 | 117 | 274 | 117 | 10 | 143 | 16,068,198 | 52 | 881 | 1,912,948 | 7.75 | 37 | 196 | 0 | 117 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 161 | 847 | 32,689,110 | 172,558,444 | 161 | 413 | 0 | 86.80 | 17.16 | 6 | 88.89 | 102 | 130 | 102 | 1 | 75 | 16,059,916 | 39 | 129 | 1,157,000 | 9.18 | 26 | 104 | 1 | 102 | 
| pairing | 1 | 192 | 670 | 22,314,288 | 119,958,502 | 192 | 376 | 1 | 70.52 | 14.56 | 6 | 64.61 | 98 | 138 | 98 | 0 | 52 | 9,408,294 | 71 | 60 | 588,742 | 17.76 | 20 | 85 | 1 | 98 | 

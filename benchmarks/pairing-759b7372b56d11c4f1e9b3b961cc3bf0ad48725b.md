...
| `quotient_poly_commit_time_ms` |  345 |  345 |  345 |  345 |
| `pcs_opening_time_ms ` |  767 |  767 |  767 |  767 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  13,747 |  13,747 |  13,747 |  13,747 |
| `main_cells_used     ` |  275,118,292 |  275,118,292 |  275,118,292 |  275,118,292 |
| `total_cycles        ` |  3,302,666 |  3,302,666 |  3,302,666 |  3,302,666 |
| `execute_time_ms     ` |  1,245 |  1,245 |  1,245 |  1,245 |
| `trace_gen_time_ms   ` |  2,555 |  2,555 |  2,555 |  2,555 |
| `stark_prove_excluding_trace_time_ms` |  9,947 |  9,947 |  9,947 |  9,947 |
| `main_trace_commit_time_ms` |  1,671 |  1,671 |  1,671 |  1,671 |
...
| `quotient_poly_commit_time_ms` |  941 |  941 |  941 |  941 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 2,555 | 13,747 | 3,302,666 | 1,072,008,682 | 9,947 | 1,479 | 941 | 3,174 | 1,966 | 1,671 | 275,118,292 | 712 | 1,245 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 895 | 4,733 | 1,711,640 | 297,186,413 | 3,183 | 470 | 345 | 786 | 767 | 602 | 92,585,975 | 195 | 655 | 

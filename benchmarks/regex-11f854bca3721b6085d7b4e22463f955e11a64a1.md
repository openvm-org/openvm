...
| `total_proof_time_ms ` |  3,786.50 |  7,573 |  4,863 |  2,710 |
...
| `execute_preflight_insn_mi/s` |  28.45 | -          |  30.90 |  26 |
| `trace_gen_time_ms   ` |  391 |  782 |  499 |  283 |
| `memory_finalize_time_ms` |  7.50 |  15 |  13 |  2 |
| `stark_prove_excluding_trace_time_ms` |  3,076.50 |  6,153 |  4,023 |  2,130 |
| `main_trace_commit_time_ms` |  615 |  1,230 |  837 |  393 |
| `generate_perm_trace_time_ms` |  232 |  464 |  301 |  163 |
| `perm_trace_commit_time_ms` |  648 |  1,296 |  849 |  447 |
| `quotient_poly_compute_time_ms` |  319.50 |  639 |  440 |  199 |
| `quotient_poly_commit_time_ms` |  300 |  600 |  396 |  204 |
| `pcs_opening_time_ms ` |  953.50 |  1,907 |  1,194 |  713 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  5,685.50 |  11,371 |  6,828 |  4,543 |
| `main_cells_used     ` |  122,270,397 |  244,540,794 |  153,710,648 |  90,830,146 |
| `total_cells_used    ` |  304,360,241 |  608,720,482 |  391,467,242 |  217,253,240 |
| `execute_preflight_insns` |  1,663,374.50 |  3,326,749 |  1,830,174 |  1,496,575 |
| `execute_preflight_time_ms` |  576 |  1,152 |  733 |  419 |
| `execute_preflight_insn_mi/s` |  4.42 | -          |  4.55 |  4.29 |
| `trace_gen_time_ms   ` |  300 |  600 |  371 |  229 |
| `memory_finalize_time_ms` |  11.50 |  23 |  14 |  9 |
| `stark_prove_excluding_trace_time_ms` |  3,796 |  7,592 |  4,712 |  2,880 |
| `main_trace_commit_time_ms` |  713 |  1,426 |  842 |  584 |
| `generate_perm_trace_time_ms` |  321 |  642 |  403 |  239 |
| `perm_trace_commit_time_ms` |  956.50 |  1,913 |  1,241 |  672 |
| `quotient_poly_compute_time_ms` |  435 |  870 |  533 |  337 |
| `quotient_poly_commit_time_ms` |  317.50 |  635 |  379 |  256 |
| `pcs_opening_time_ms ` |  1,047.50 |  2,095 |  1,309 |  786 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 6,830 |  | 1 |  | 1 |  |  |  |  | 
| regex_program |  | 2,710 |  | 6 | 1 | 31 | 4,108,597 | 130.01 | 44 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 229 | 4,543 | 217,253,240 | 319,626,730 | 229 | 2,880 | 0 | 337 | 256 | 672 | 786 | 9 | 584 | 90,830,146 | 239 | 419 | 1,496,575 | 4.29 | 
| leaf | 1 | 371 | 6,828 | 391,467,242 | 538,660,330 | 371 | 4,712 | 0 | 533 | 379 | 1,241 | 1,309 | 14 | 842 | 153,710,648 | 403 | 733 | 1,830,174 | 4.55 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 499 | 4,863 | 211,758,557 | 373,183,036 | 499 | 4,023 | 0 | 440 | 396 | 849 | 1,194 | 8 | 13 | 837 | 91,281,687 | 301 | 101 | 2,211,000 | 26 | 
| regex_program | 1 | 283 | 2,710 | 174,326,267 | 196,838,026 | 283 | 2,130 | 53 | 199 | 204 | 447 | 713 | 7 | 2 | 393 | 73,453,305 | 163 | 84 | 1,897,597 | 30.90 | 

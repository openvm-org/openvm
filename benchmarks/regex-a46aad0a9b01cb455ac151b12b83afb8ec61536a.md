...
| `total_proof_time_ms ` |  4,015.50 |  8,031 |  4,628 |  3,403 |
| `main_cells_used     ` |  83,694,725 |  167,389,450 |  93,699,990 |  73,689,460 |
| `total_cycles        ` |  2,070,082 |  4,140,164 |  2,225,434 |  1,914,730 |
| `execute_time_ms     ` |  341.50 |  683 |  379 |  304 |
| `trace_gen_time_ms   ` |  954.50 |  1,909 |  1,136 |  773 |
| `stark_prove_excluding_trace_time_ms` |  2,719.50 |  5,439 |  3,113 |  2,326 |
| `main_trace_commit_time_ms` |  499.50 |  999 |  588 |  411 |
| `generate_perm_trace_time_ms` |  175 |  350 |  199 |  151 |
| `perm_trace_commit_time_ms` |  702 |  1,404 |  810 |  594 |
| `quotient_poly_compute_time_ms` |  362.50 |  725 |  419 |  306 |
| `quotient_poly_commit_time_ms` |  294 |  588 |  340 |  248 |
| `pcs_opening_time_ms ` |  676.50 |  1,353 |  747 |  606 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,507.50 |  15,015 |  7,564 |  7,451 |
| `main_cells_used     ` |  152,233,004 |  304,466,008 |  154,690,532 |  149,775,476 |
| `total_cycles        ` |  1,990,732.50 |  3,981,465 |  2,021,526 |  1,959,939 |
| `execute_time_ms     ` |  767.50 |  1,535 |  774 |  761 |
| `trace_gen_time_ms   ` |  1,466.50 |  2,933 |  1,487 |  1,446 |
| `stark_prove_excluding_trace_time_ms` |  5,273.50 |  10,547 |  5,303 |  5,244 |
| `main_trace_commit_time_ms` |  893 |  1,786 |  893 |  893 |
| `generate_perm_trace_time_ms` |  344 |  688 |  349 |  339 |
| `perm_trace_commit_time_ms` |  1,670.50 |  3,341 |  1,703 |  1,638 |
| `quotient_poly_compute_time_ms` |  763.50 |  1,527 |  764 |  763 |
| `quotient_poly_commit_time_ms` |  524.50 |  1,049 |  527 |  522 |
| `pcs_opening_time_ms ` |  1,074 |  2,148 |  1,080 |  1,068 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,487 | 7,564 | 2,021,526 | 533,941,738 | 5,303 | 763 | 522 | 1,703 | 1,068 | 893 | 154,690,532 | 349 | 774 | 
| leaf | 1 | 1,446 | 7,451 | 1,959,939 | 533,941,738 | 5,244 | 764 | 527 | 1,638 | 1,080 | 893 | 149,775,476 | 339 | 761 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,136 | 4,628 | 2,225,434 | 275,652,919 | 3,113 | 419 | 340 | 810 | 747 | 588 | 93,699,990 | 199 | 379 | 
| regex_program | 1 | 773 | 3,403 | 1,914,730 | 198,099,628 | 2,326 | 306 | 248 | 594 | 606 | 411 | 73,689,460 | 151 | 304 | 

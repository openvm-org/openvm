...
| `total_proof_time_ms ` |  1,465 |  2,930 |  1,704 |  1,226 |
...
| `execute_preflight_time_ms` |  102 |  204 |  119 |  85 |
| `execute_preflight_insn_mi/s` |  27.69 | -          |  28.21 |  27.16 |
| `trace_gen_time_ms   ` |  303.50 |  607 |  320 |  287 |
| `memory_finalize_time_ms` |  2 |  4 |  4 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  972 |  1,944 |  1,205 |  739 |
| `main_trace_commit_time_ms` |  140.50 |  281 |  182 |  99 |
| `generate_perm_trace_time_ms` |  58.50 |  117 |  63 |  54 |
| `perm_trace_commit_time_ms` |  167.63 |  335.27 |  223.10 |  112.17 |
| `quotient_poly_compute_time_ms` |  162.43 |  324.86 |  178.41 |  146.45 |
| `quotient_poly_commit_time_ms` |  35.90 |  71.80 |  47.47 |  24.33 |
| `pcs_opening_time_ms ` |  400.50 |  801 |  539 |  262 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  2,068.50 |  4,137 |  2,839 |  1,298 |
| `main_cells_used     ` |  14,798,849 |  29,597,698 |  20,272,474 |  9,325,224 |
| `total_cells_used    ` |  37,032,585 |  74,065,170 |  50,586,080 |  23,479,090 |
| `execute_preflight_insns` |  1,663,374 |  3,326,748 |  1,830,083 |  1,496,665 |
| `execute_preflight_time_ms` |  584.50 |  1,169 |  904 |  265 |
| `execute_preflight_insn_mi/s` |  6.95 | -          |  7.18 |  6.73 |
| `trace_gen_time_ms   ` |  122 |  244 |  169 |  75 |
| `memory_finalize_time_ms` |  11.50 |  23 |  17 |  6 |
| `stark_prove_excluding_trace_time_ms` |  1,360 |  2,720 |  1,764 |  956 |
| `main_trace_commit_time_ms` |  178.50 |  357 |  227 |  130 |
| `generate_perm_trace_time_ms` |  69 |  138 |  86 |  52 |
| `perm_trace_commit_time_ms` |  274.36 |  548.72 |  364.75 |  183.97 |
| `quotient_poly_compute_time_ms` |  175.55 |  351.09 |  226.26 |  124.84 |
| `quotient_poly_commit_time_ms` |  43.58 |  87.16 |  57.86 |  29.30 |
| `pcs_opening_time_ms ` |  615 |  1,230 |  797 |  433 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 2,841 |  | 1 |  | 1 |  |  |  |  | 
| regex_program |  | 1,226 |  | 40 | 1 | 39 | 4,108,483 | 103.51 | 167 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 75 | 1,298 | 23,479,090 | 319,626,730 | 75 | 956 | 0 | 124.84 | 29.30 | 4 | 183.97 | 433 | 237 | 433 | 6 | 130 | 9,325,224 | 52 | 265 | 1,496,665 | 7.18 | 29 | 155 | 1 | 433 | 
| leaf | 1 | 169 | 2,839 | 50,586,080 | 538,660,330 | 169 | 1,764 | 0 | 226.26 | 57.86 | 4 | 364.75 | 797 | 451 | 797 | 17 | 227 | 20,272,474 | 86 | 904 | 1,830,083 | 6.73 | 56 | 286 | 1 | 797 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 287 | 1,704 | 23,397,108 | 373,183,036 | 287 | 1,205 | 0 | 146.45 | 47.47 | 6 | 223.10 | 539 | 287 | 539 | 4 | 182 | 10,866,434 | 63 | 85 | 2,211,000 | 28.21 | 46 | 195 | 2 | 539 | 
| regex_program | 1 | 320 | 1,226 | 11,981,356 | 196,739,722 | 320 | 739 | 2 | 178.41 | 24.33 | 6 | 112.17 | 262 | 170 | 262 | 0 | 99 | 2,537,170 | 54 | 119 | 1,897,483 | 27.16 | 26 | 207 | 2 | 262 | 

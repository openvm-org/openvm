...
| `execute_time_ms     ` |  337 |  674 |  376 |  298 |
| `trace_gen_time_ms   ` |  975.50 |  1,951 |  1,146 |  805 |
| `stark_prove_excluding_trace_time_ms` |  2,427.50 |  4,855 |  2,604 |  2,251 |
| `main_trace_commit_time_ms` |  455.50 |  911 |  513 |  398 |
| `generate_perm_trace_time_ms` |  198.50 |  397 |  204 |  193 |
| `perm_trace_commit_time_ms` |  489.50 |  979 |  514 |  465 |
| `quotient_poly_compute_time_ms` |  335 |  670 |  357 |  313 |
| `quotient_poly_commit_time_ms` |  236.50 |  473 |  266 |  207 |
| `pcs_opening_time_ms ` |  702 |  1,404 |  740 |  664 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  6,665 |  13,330 |  6,720 |  6,610 |
| `main_cells_used     ` |  152,278,823 |  304,557,646 |  154,678,682 |  149,878,964 |
| `total_cycles        ` |  1,991,054.50 |  3,982,109 |  2,021,882 |  1,960,227 |
| `execute_time_ms     ` |  791.50 |  1,583 |  800 |  783 |
| `trace_gen_time_ms   ` |  1,497 |  2,994 |  1,530 |  1,464 |
| `stark_prove_excluding_trace_time_ms` |  4,376.50 |  8,753 |  4,390 |  4,363 |
| `main_trace_commit_time_ms` |  782 |  1,564 |  782 |  782 |
| `generate_perm_trace_time_ms` |  379.50 |  759 |  397 |  362 |
| `perm_trace_commit_time_ms` |  1,106.50 |  2,213 |  1,109 |  1,104 |
| `quotient_poly_compute_time_ms` |  660 |  1,320 |  661 |  659 |
| `quotient_poly_commit_time_ms` |  382.50 |  765 |  383 |  382 |
| `pcs_opening_time_ms ` |  1,061 |  2,122 |  1,068 |  1,054 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,530 | 6,720 | 2,021,882 | 538,660,330 | 4,390 | 661 | 382 | 1,109 | 1,054 | 782 | 154,678,682 | 397 | 800 | 
| leaf | 1 | 1,464 | 6,610 | 1,960,227 | 538,660,330 | 4,363 | 659 | 383 | 1,104 | 1,068 | 782 | 149,878,964 | 362 | 783 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,146 | 4,126 | 2,243,715 | 275,652,919 | 2,604 | 357 | 266 | 514 | 740 | 513 | 93,500,799 | 204 | 376 | 
| regex_program | 1 | 805 | 3,354 | 1,921,511 | 242,975,404 | 2,251 | 313 | 207 | 465 | 664 | 398 | 73,010,353 | 193 | 298 | 

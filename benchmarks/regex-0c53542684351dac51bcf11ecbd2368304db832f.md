...
| `total_proof_time_ms ` |  7,663 |  15,326 |  8,557 |  6,769 |
...
| `trace_gen_time_ms   ` |  1,699.50 |  3,399 |  1,878 |  1,521 |
| `stark_prove_excluding_trace_time_ms` |  5,510.50 |  11,021 |  6,192 |  4,829 |
| `main_trace_commit_time_ms` |  1,100 |  2,200 |  1,340 |  860 |
| `generate_perm_trace_time_ms` |  178 |  356 |  185 |  171 |
| `perm_trace_commit_time_ms` |  1,185.50 |  2,371 |  1,241 |  1,130 |
| `quotient_poly_compute_time_ms` |  735.50 |  1,471 |  861 |  610 |
| `quotient_poly_commit_time_ms` |  975 |  1,950 |  1,113 |  837 |
| `pcs_opening_time_ms ` |  1,326.50 |  2,653 |  1,445 |  1,208 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  14,606.50 |  29,213 |  14,747 |  14,466 |
| `main_cells_used     ` |  133,955,051 |  267,910,102 |  135,611,839 |  132,298,263 |
| `total_cycles        ` |  2,941,531 |  5,883,062 |  2,977,593 |  2,905,469 |
| `execute_time_ms     ` |  612.50 |  1,225 |  657 |  568 |
| `trace_gen_time_ms   ` |  2,641.50 |  5,283 |  2,790 |  2,493 |
| `stark_prove_excluding_trace_time_ms` |  11,352.50 |  22,705 |  11,389 |  11,316 |
| `main_trace_commit_time_ms` |  2,368 |  4,736 |  2,384 |  2,352 |
| `generate_perm_trace_time_ms` |  280 |  560 |  281 |  279 |
| `perm_trace_commit_time_ms` |  2,268.50 |  4,537 |  2,279 |  2,258 |
| `quotient_poly_compute_time_ms` |  1,657.50 |  3,315 |  1,670 |  1,645 |
| `quotient_poly_commit_time_ms` |  2,213 |  4,426 |  2,216 |  2,210 |
| `pcs_opening_time_ms ` |  2,561.50 |  5,123 |  2,566 |  2,557 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 2,493 | 14,466 | 2,977,593 | 360,326,872 | 11,316 | 1,645 | 2,210 | 2,258 | 2,566 | 2,352 | 135,611,839 | 281 | 657 | 
| leaf | 1 | 2,790 | 14,747 | 2,905,469 | 360,334,296 | 11,389 | 1,670 | 2,216 | 2,279 | 2,557 | 2,384 | 132,298,263 | 279 | 568 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,878 | 8,557 |  | 209,921,543 | 6,192 | 861 | 1,113 | 1,241 | 1,445 | 1,340 | 92,686,348 | 185 | 487 | 
| regex_program | 1 | 1,521 | 6,769 | 1,914,103 | 149,454,692 | 4,829 | 610 | 837 | 1,130 | 1,208 | 860 | 72,769,025 | 171 | 419 | 

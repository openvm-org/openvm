...
| `total_proof_time_ms ` |  3,712 |  7,424 |  4,112 |  3,312 |
...
| `trace_gen_time_ms   ` |  967.50 |  1,935 |  1,132 |  803 |
| `stark_prove_excluding_trace_time_ms` |  2,408 |  4,816 |  2,605 |  2,211 |
| `main_trace_commit_time_ms` |  450 |  900 |  503 |  397 |
| `generate_perm_trace_time_ms` |  201.50 |  403 |  210 |  193 |
| `perm_trace_commit_time_ms` |  486 |  972 |  511 |  461 |
| `quotient_poly_compute_time_ms` |  334.50 |  669 |  358 |  311 |
| `quotient_poly_commit_time_ms` |  232.50 |  465 |  274 |  191 |
| `pcs_opening_time_ms ` |  695 |  1,390 |  741 |  649 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  6,622.50 |  13,245 |  6,647 |  6,598 |
| `main_cells_used     ` |  152,278,325 |  304,556,650 |  154,677,602 |  149,879,048 |
| `total_cycles        ` |  1,991,013 |  3,982,026 |  2,021,792 |  1,960,234 |
| `execute_time_ms     ` |  787 |  1,574 |  792 |  782 |
| `trace_gen_time_ms   ` |  1,479 |  2,958 |  1,485 |  1,473 |
| `stark_prove_excluding_trace_time_ms` |  4,356.50 |  8,713 |  4,370 |  4,343 |
| `main_trace_commit_time_ms` |  779 |  1,558 |  782 |  776 |
| `generate_perm_trace_time_ms` |  379.50 |  759 |  395 |  364 |
| `perm_trace_commit_time_ms` |  1,104.50 |  2,209 |  1,107 |  1,102 |
| `quotient_poly_compute_time_ms` |  659 |  1,318 |  662 |  656 |
| `quotient_poly_commit_time_ms` |  379.50 |  759 |  381 |  378 |
| `pcs_opening_time_ms ` |  1,049 |  2,098 |  1,052 |  1,046 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,485 | 6,647 | 2,021,792 | 538,660,330 | 4,370 | 656 | 378 | 1,107 | 1,052 | 776 | 154,677,602 | 395 | 792 | 
| leaf | 1 | 1,473 | 6,598 | 1,960,234 | 538,660,330 | 4,343 | 662 | 381 | 1,102 | 1,046 | 782 | 149,879,048 | 364 | 782 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,132 | 4,112 | 2,243,715 | 275,652,919 | 2,605 | 358 | 274 | 511 | 741 | 503 | 93,500,799 | 210 | 375 | 
| regex_program | 1 | 803 | 3,312 | 1,921,511 | 242,975,404 | 2,211 | 311 | 191 | 461 | 649 | 397 | 73,010,353 | 193 | 298 | 

...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  22,407 |  22,407 |  22,407 |  22,407 |
| `main_cells_used     ` |  203,267,521 |  203,267,521 |  203,267,521 |  203,267,521 |
| `total_cycles        ` |  4,146,826 |  4,146,826 |  4,146,826 |  4,146,826 |
| `execute_time_ms     ` |  966 |  966 |  966 |  966 |
| `trace_gen_time_ms   ` |  3,643 |  3,643 |  3,643 |  3,643 |
| `stark_prove_excluding_trace_time_ms` |  17,798 |  17,798 |  17,798 |  17,798 |
| `main_trace_commit_time_ms` |  3,143 |  3,143 |  3,143 |  3,143 |
| `generate_perm_trace_time_ms` |  422 |  422 |  422 |  422 |
| `perm_trace_commit_time_ms` |  3,709 |  3,709 |  3,709 |  3,709 |
| `quotient_poly_compute_time_ms` |  4,530 |  4,530 |  4,530 |  4,530 |
| `quotient_poly_commit_time_ms` |  2,866 |  2,866 |  2,866 |  2,866 |
| `pcs_opening_time_ms ` |  3,126 |  3,126 |  3,126 |  3,126 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 3,643 | 22,407 | 4,146,826 | 572,214,232 | 17,798 | 4,530 | 2,866 | 3,709 | 3,126 | 3,143 | 203,267,521 | 422 | 966 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 253 | 2,595 | 284,561 | 56,184,959 | 2,194 | 299 | 307 | 528 | 627 | 393 | 15,054,935 | 38 | 148 | 

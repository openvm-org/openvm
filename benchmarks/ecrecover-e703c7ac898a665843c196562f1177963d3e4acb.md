...
| `total_proof_time_ms ` |  2,579 |  2,579 |  2,579 |  2,579 |
...
| `stark_prove_excluding_trace_time_ms` |  2,179 |  2,179 |  2,179 |  2,179 |
| `main_trace_commit_time_ms` |  398 |  398 |  398 |  398 |
| `generate_perm_trace_time_ms` |  33 |  33 |  33 |  33 |
| `perm_trace_commit_time_ms` |  369 |  369 |  369 |  369 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  18,444 |  18,444 |  18,444 |  18,444 |
| `main_cells_used     ` |  193,343,219 |  193,343,219 |  193,343,219 |  193,343,219 |
| `total_cycles        ` |  4,158,115 |  4,158,115 |  4,158,115 |  4,158,115 |
| `execute_time_ms     ` |  937 |  937 |  937 |  937 |
| `trace_gen_time_ms   ` |  3,567 |  3,567 |  3,567 |  3,567 |
| `stark_prove_excluding_trace_time_ms` |  13,940 |  13,940 |  13,940 |  13,940 |
| `main_trace_commit_time_ms` |  2,923 |  2,923 |  2,923 |  2,923 |
...
| `pcs_opening_time_ms ` |  2,990 |  2,990 |  2,990 |  2,990 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 3,567 | 18,444 | 4,158,115 | 466,306,008 | 13,940 | 2,094 | 2,665 | 2,905 | 2,990 | 2,923 | 193,343,219 | 361 | 937 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 252 | 2,579 | 284,567 | 38,417,595 | 2,179 | 229 | 474 | 369 | 662 | 398 | 15,055,843 | 33 | 148 | 

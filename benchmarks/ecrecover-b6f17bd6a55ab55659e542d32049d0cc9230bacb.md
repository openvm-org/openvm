...
| `execute_preflight_insn_mi/s` |  1.80 | -          |  1.80 |  1.80 |
| `trace_gen_time_ms   ` |  95 |  95 |  95 |  95 |
| `memory_finalize_time_ms` |  5 |  5 |  5 |  5 |
| `stark_prove_excluding_trace_time_ms` |  978 |  978 |  978 |  978 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  10,835 |  10,835 |  10,835 |  10,835 |
| `main_cells_used     ` |  247,226,478 |  247,226,478 |  247,226,478 |  247,226,478 |
| `total_cells_used    ` |  646,606,252 |  646,606,252 |  646,606,252 |  646,606,252 |
| `execute_preflight_insns` |  2,934,895 |  2,934,895 |  2,934,895 |  2,934,895 |
| `execute_preflight_time_ms` |  567 |  567 |  567 |  567 |
| `execute_preflight_insn_mi/s` |  5.42 | -          |  5.42 |  5.42 |
| `trace_gen_time_ms   ` |  574 |  574 |  574 |  574 |
| `memory_finalize_time_ms` |  15 |  15 |  15 |  15 |
| `stark_prove_excluding_trace_time_ms` |  8,626 |  8,626 |  8,626 |  8,626 |
| `main_trace_commit_time_ms` |  1,652 |  1,652 |  1,652 |  1,652 |
| `generate_perm_trace_time_ms` |  817 |  817 |  817 |  817 |
| `perm_trace_commit_time_ms` |  2,312 |  2,312 |  2,312 |  2,312 |
| `quotient_poly_compute_time_ms` |  914 |  914 |  914 |  914 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program |  | 1,409 |  | 6 | 1 | 6 | 140,487 | 20.51 | 38 | 
| leaf | 10,838 |  | 1 |  | 1 |  |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 574 | 10,835 | 646,606,252 | 992,054,762 | 574 | 8,626 | 0 | 914 | 694 | 2,312 | 2,231 | 15 | 1,652 | 247,226,478 | 817 | 567 | 2,934,895 | 5.42 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 95 | 1,409 | 26,518,220 | 32,927,986 | 95 | 978 | 0 | 83 | 127 | 166 | 416 | 7 | 5 | 139 | 8,866,654 | 29 | 85 | 140,487 | 1.80 | 

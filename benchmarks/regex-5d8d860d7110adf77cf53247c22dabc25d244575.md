...
| `total_proof_time_ms ` |  3,883.50 |  7,767 |  4,465 |  3,302 |
...
| `trace_gen_time_ms   ` |  956.50 |  1,913 |  1,152 |  761 |
| `stark_prove_excluding_trace_time_ms` |  2,591 |  5,182 |  2,940 |  2,242 |
| `main_trace_commit_time_ms` |  452.50 |  905 |  536 |  369 |
| `generate_perm_trace_time_ms` |  168.50 |  337 |  189 |  148 |
| `perm_trace_commit_time_ms` |  643.50 |  1,287 |  747 |  540 |
| `quotient_poly_compute_time_ms` |  359 |  718 |  415 |  303 |
| `quotient_poly_commit_time_ms` |  276 |  552 |  318 |  234 |
| `pcs_opening_time_ms ` |  682 |  1,364 |  724 |  640 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,456 |  14,912 |  7,526 |  7,386 |
| `main_cells_used     ` |  152,233,700 |  304,467,400 |  154,691,300 |  149,776,100 |
| `total_cycles        ` |  1,990,790.50 |  3,981,581 |  2,021,590 |  1,959,991 |
| `execute_time_ms     ` |  760 |  1,520 |  768 |  752 |
| `trace_gen_time_ms   ` |  1,445 |  2,890 |  1,462 |  1,428 |
| `stark_prove_excluding_trace_time_ms` |  5,251 |  10,502 |  5,296 |  5,206 |
| `main_trace_commit_time_ms` |  894.50 |  1,789 |  898 |  891 |
| `generate_perm_trace_time_ms` |  340.50 |  681 |  343 |  338 |
| `perm_trace_commit_time_ms` |  1,660 |  3,320 |  1,708 |  1,612 |
| `quotient_poly_compute_time_ms` |  767.50 |  1,535 |  768 |  767 |
| `quotient_poly_commit_time_ms` |  523 |  1,046 |  523 |  523 |
| `pcs_opening_time_ms ` |  1,060 |  2,120 |  1,068 |  1,052 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,462 | 7,526 | 2,021,590 | 533,941,738 | 5,296 | 767 | 523 | 1,708 | 1,052 | 898 | 154,691,300 | 343 | 768 | 
| leaf | 1 | 1,428 | 7,386 | 1,959,991 | 533,941,738 | 5,206 | 768 | 523 | 1,612 | 1,068 | 891 | 149,776,100 | 338 | 752 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,152 | 4,465 | 2,225,434 | 275,652,919 | 2,940 | 415 | 318 | 747 | 724 | 536 | 93,701,806 | 189 | 373 | 
| regex_program | 1 | 761 | 3,302 | 1,914,806 | 198,099,628 | 2,242 | 303 | 234 | 540 | 640 | 369 | 73,698,552 | 148 | 299 | 

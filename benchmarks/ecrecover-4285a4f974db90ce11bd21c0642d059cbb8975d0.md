...
| `total_proof_time_ms ` |  2,498 |  2,498 |  2,498 |  2,498 |
...
| `stark_prove_excluding_trace_time_ms` |  2,170 |  2,170 |  2,170 |  2,170 |
| `main_trace_commit_time_ms` |  388 |  388 |  388 |  388 |
...
| `pcs_opening_time_ms ` |  673 |  673 |  673 |  673 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  11,214 |  11,214 |  11,214 |  11,214 |
| `main_cells_used     ` |  117,321,099 |  117,321,099 |  117,321,099 |  117,321,099 |
| `total_cycles        ` |  1,604,031 |  1,604,031 |  1,604,031 |  1,604,031 |
| `execute_time_ms     ` |  569 |  569 |  569 |  569 |
| `trace_gen_time_ms   ` |  1,464 |  1,464 |  1,464 |  1,464 |
| `stark_prove_excluding_trace_time_ms` |  9,181 |  9,181 |  9,181 |  9,181 |
...
| `quotient_poly_compute_time_ms` |  1,451 |  1,451 |  1,451 |  1,451 |
| `quotient_poly_commit_time_ms` |  1,648 |  1,648 |  1,648 |  1,648 |
| `pcs_opening_time_ms ` |  1,883 |  1,883 |  1,883 |  1,883 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,464 | 11,214 | 1,604,031 | 334,709,720 | 9,181 | 1,451 | 1,648 | 2,035 | 1,883 | 1,900 | 117,321,099 | 261 | 569 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 179 | 2,498 | 284,567 | 38,417,467 | 2,170 | 231 | 470 | 358 | 673 | 388 | 15,055,723 | 37 | 149 | 

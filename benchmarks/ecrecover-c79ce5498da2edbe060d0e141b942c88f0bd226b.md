...
| `total_proof_time_ms ` |  2,524 |  2,524 |  2,524 |  2,524 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  13,330 |  13,330 |  13,330 |  13,330 |
| `main_cells_used     ` |  133,786,373 |  133,786,373 |  133,786,373 |  133,786,373 |
| `total_cycles        ` |  2,253,358 |  2,253,358 |  2,253,358 |  2,253,358 |
| `execute_time_ms     ` |  731 |  731 |  731 |  731 |
| `trace_gen_time_ms   ` |  1,742 |  1,742 |  1,742 |  1,742 |
| `stark_prove_excluding_trace_time_ms` |  10,857 |  10,857 |  10,857 |  10,857 |
| `main_trace_commit_time_ms` |  2,279 |  2,279 |  2,279 |  2,279 |
| `generate_perm_trace_time_ms` |  319 |  319 |  319 |  319 |
| `perm_trace_commit_time_ms` |  2,305 |  2,305 |  2,305 |  2,305 |
| `quotient_poly_compute_time_ms` |  1,665 |  1,665 |  1,665 |  1,665 |
| `quotient_poly_commit_time_ms` |  1,957 |  1,957 |  1,957 |  1,957 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,742 | 13,330 | 2,253,358 | 377,489,890 | 10,857 | 1,665 | 1,957 | 2,305 | 2,325 | 2,279 | 133,786,373 | 319 | 731 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 185 | 2,524 | 295,181 | 38,665,477 | 2,189 | 228 | 482 | 358 | 692 | 379 | 15,586,346 | 35 | 150 | 

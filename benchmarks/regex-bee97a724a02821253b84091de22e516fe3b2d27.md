...
| `total_proof_time_ms ` |  3,931.50 |  7,863 |  4,346 |  3,517 |
| `main_cells_used     ` |  83,255,576 |  166,511,152 |  93,500,799 |  73,010,353 |
| `total_cycles        ` |  2,082,613 |  4,165,226 |  2,243,715 |  1,921,511 |
| `execute_time_ms     ` |  359 |  718 |  400 |  318 |
| `trace_gen_time_ms   ` |  999.50 |  1,999 |  1,184 |  815 |
| `stark_prove_excluding_trace_time_ms` |  2,573 |  5,146 |  2,762 |  2,384 |
| `main_trace_commit_time_ms` |  498.50 |  997 |  551 |  446 |
| `generate_perm_trace_time_ms` |  211.50 |  423 |  221 |  202 |
| `perm_trace_commit_time_ms` |  547.50 |  1,095 |  579 |  516 |
| `quotient_poly_compute_time_ms` |  264 |  528 |  282 |  246 |
| `quotient_poly_commit_time_ms` |  242 |  484 |  280 |  204 |
| `pcs_opening_time_ms ` |  800 |  1,600 |  840 |  760 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  6,985 |  13,970 |  7,022 |  6,948 |
| `main_cells_used     ` |  151,826,861 |  303,653,722 |  154,226,318 |  149,427,404 |
| `total_cycles        ` |  1,975,645 |  3,951,290 |  2,006,439 |  1,944,851 |
| `execute_time_ms     ` |  780 |  1,560 |  788 |  772 |
| `trace_gen_time_ms   ` |  1,453 |  2,906 |  1,474 |  1,432 |
| `stark_prove_excluding_trace_time_ms` |  4,752 |  9,504 |  4,760 |  4,744 |
| `main_trace_commit_time_ms` |  864.50 |  1,729 |  866 |  863 |
| `generate_perm_trace_time_ms` |  402.50 |  805 |  427 |  378 |
| `perm_trace_commit_time_ms` |  1,252 |  2,504 |  1,260 |  1,244 |
| `quotient_poly_compute_time_ms` |  523 |  1,046 |  534 |  512 |
| `quotient_poly_commit_time_ms` |  411.50 |  823 |  412 |  411 |
| `pcs_opening_time_ms ` |  1,292.50 |  2,585 |  1,296 |  1,289 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,474 | 7,022 | 2,006,439 | 538,660,330 | 4,760 | 512 | 411 | 1,244 | 1,296 | 863 | 154,226,318 | 427 | 788 | 
| leaf | 1 | 1,432 | 6,948 | 1,944,851 | 538,660,330 | 4,744 | 534 | 412 | 1,260 | 1,289 | 866 | 149,427,404 | 378 | 772 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,184 | 4,346 | 2,243,715 | 275,652,919 | 2,762 | 282 | 280 | 579 | 840 | 551 | 93,500,799 | 221 | 400 | 
| regex_program | 1 | 815 | 3,517 | 1,921,511 | 242,975,404 | 2,384 | 246 | 204 | 516 | 760 | 446 | 73,010,353 | 202 | 318 | 

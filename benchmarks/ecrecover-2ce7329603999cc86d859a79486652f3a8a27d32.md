...
|:---|---:|---:|---:|
| Total |  13.16 |  13.16 | 13.16 |
| ecrecover_program |  3.74 |  3.74 |  3.74 |
| leaf |  9.42 |  9.42 |  9.42 |
...
| `total_proof_time_ms ` |  3,735 |  3,735 |  3,735 |  3,735 |
...
| `quotient_poly_compute_time_ms` |  104.25 |  104.25 |  104.25 |  104.25 |
| `quotient_poly_commit_time_ms` |  9.12 |  9.12 |  9.12 |  9.12 |
| `pcs_opening_time_ms ` |  2,957 |  2,957 |  2,957 |  2,957 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  9,424 |  9,424 |  9,424 |  9,424 |
| `main_cells_used     ` |  34,468,876 |  34,468,876 |  34,468,876 |  34,468,876 |
| `total_cells_used    ` |  83,392,626 |  83,392,626 |  83,392,626 |  83,392,626 |
| `execute_preflight_insns` |  4,109,600 |  4,109,600 |  4,109,600 |  4,109,600 |
| `execute_preflight_time_ms` |  757 |  757 |  757 |  757 |
| `execute_preflight_insn_mi/s` |  5.78 | -          |  5.78 |  5.78 |
| `trace_gen_time_ms   ` |  302 |  302 |  302 |  302 |
| `memory_finalize_time_ms` |  27 |  27 |  27 |  27 |
| `stark_prove_excluding_trace_time_ms` |  8,364 |  8,364 |  8,364 |  8,364 |
| `main_trace_commit_time_ms` |  724 |  724 |  724 |  724 |
| `generate_perm_trace_time_ms` |  316 |  316 |  316 |  316 |
| `perm_trace_commit_time_ms` |  1,469.49 |  1,469.49 |  1,469.49 |  1,469.49 |
| `quotient_poly_compute_time_ms` |  818.17 |  818.17 |  818.17 |  818.17 |
| `quotient_poly_commit_time_ms` |  185.04 |  185.04 |  185.04 |  185.04 |
| `pcs_opening_time_ms ` |  4,844 |  4,844 |  4,844 |  4,844 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program |  | 3,735 |  | 1 | 6 | 122,859 | 19.100 | 0 | 
| leaf | 9,430 |  | 1 | 1 |  |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 302 | 9,424 | 83,392,626 | 1,726,057,962 | 302 | 8,364 | 0 | 818.17 | 185.04 | 6 | 1,469.49 | 4,844 | 1,786 | 4,844 | 27 | 724 | 34,468,876 | 316 | 757 | 4,109,600 | 5.78 | 271 | 1,008 | 13 | 4,844 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 212 | 3,735 | 11,346,486 | 31,789,298 | 212 | 3,292 | 0 | 104.25 | 9.12 | 10 | 34.12 | 2,957 | 184 | 2,956 | 0 | 37 | 2,265,100 | 143 | 62 | 122,859 | 2.26 | 21 | 113 | 1 | 2,956 | 

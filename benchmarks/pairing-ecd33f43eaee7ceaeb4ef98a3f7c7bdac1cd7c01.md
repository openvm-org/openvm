...
| `total_proof_time_ms ` |  4,714 |  4,714 |  4,714 |  4,714 |
...
| `pcs_opening_time_ms ` |  767 |  767 |  767 |  767 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  14,061 |  14,061 |  14,061 |  14,061 |
| `main_cells_used     ` |  274,877,448 |  274,877,448 |  274,877,448 |  274,877,448 |
| `total_cycles        ` |  3,301,973 |  3,301,973 |  3,301,973 |  3,301,973 |
| `execute_time_ms     ` |  1,212 |  1,212 |  1,212 |  1,212 |
| `trace_gen_time_ms   ` |  2,576 |  2,576 |  2,576 |  2,576 |
| `stark_prove_excluding_trace_time_ms` |  10,273 |  10,273 |  10,273 |  10,273 |
| `main_trace_commit_time_ms` |  1,765 |  1,765 |  1,765 |  1,765 |
| `generate_perm_trace_time_ms` |  725 |  725 |  725 |  725 |
| `perm_trace_commit_time_ms` |  3,361 |  3,361 |  3,361 |  3,361 |
| `quotient_poly_compute_time_ms` |  1,470 |  1,470 |  1,470 |  1,470 |
| `quotient_poly_commit_time_ms` |  972 |  972 |  972 |  972 |
| `pcs_opening_time_ms ` |  1,976 |  1,976 |  1,976 |  1,976 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 2,576 | 14,061 | 3,301,973 | 1,071,746,538 | 10,273 | 1,470 | 972 | 3,361 | 1,976 | 1,765 | 274,877,448 | 725 | 1,212 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 902 | 4,714 | 1,711,640 | 297,186,413 | 3,139 | 460 | 335 | 772 | 767 | 596 | 92,585,975 | 191 | 673 | 

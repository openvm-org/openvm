...
| `stark_prove_excluding_trace_time_ms` |  4,360 |  4,360 |  4,360 |  4,360 |
| `main_trace_commit_time_ms` |  794 |  794 |  794 |  794 |
| `generate_perm_trace_time_ms` |  178 |  178 |  178 |  178 |
| `perm_trace_commit_time_ms` |  1,571 |  1,571 |  1,571 |  1,571 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  6,969 |  6,969 |  6,969 |  6,969 |
| `main_cells_used     ` |  70,691,881 |  70,691,881 |  70,691,881 |  70,691,881 |
| `total_cycles        ` |  1,832,651 |  1,832,651 |  1,832,651 |  1,832,651 |
| `execute_time_ms     ` |  350 |  350 |  350 |  350 |
| `trace_gen_time_ms   ` |  1,280 |  1,280 |  1,280 |  1,280 |
| `stark_prove_excluding_trace_time_ms` |  5,339 |  5,339 |  5,339 |  5,339 |
| `main_trace_commit_time_ms` |  1,023 |  1,023 |  1,023 |  1,023 |
| `generate_perm_trace_time_ms` |  132 |  132 |  132 |  132 |
| `perm_trace_commit_time_ms` |  1,157 |  1,157 |  1,157 |  1,157 |
| `quotient_poly_compute_time_ms` |  736 |  736 |  736 |  736 |
| `quotient_poly_commit_time_ms` |  998 |  998 |  998 |  998 |
| `pcs_opening_time_ms ` |  1,289 |  1,289 |  1,289 |  1,289 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,280 | 6,969 | 1,832,651 | 180,014,040 | 5,339 | 736 | 998 | 1,157 | 1,289 | 1,023 | 70,691,881 | 132 | 350 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 825 | 5,498 | 1,500,137 | 197,440,542 | 4,360 | 316 | 497 | 1,571 | 999 | 794 | 51,487,838 | 178 | 313 | 

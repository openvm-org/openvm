...
| `total_proof_time_ms ` |  6,952 |  13,904 |  7,815 |  6,089 |
| `main_cells_used     ` |  83,694,725 |  167,389,450 |  93,699,990 |  73,689,460 |
| `total_cycles        ` |  2,070,082 |  4,140,164 |  2,225,434 |  1,914,730 |
| `execute_time_ms     ` |  385.50 |  771 |  467 |  304 |
| `trace_gen_time_ms   ` |  1,267.50 |  2,535 |  1,300 |  1,235 |
| `stark_prove_excluding_trace_time_ms` |  5,299 |  10,598 |  6,048 |  4,550 |
| `main_trace_commit_time_ms` |  1,143 |  2,286 |  1,325 |  961 |
| `generate_perm_trace_time_ms` |  181 |  362 |  200 |  162 |
| `perm_trace_commit_time_ms` |  1,030 |  2,060 |  1,176 |  884 |
| `quotient_poly_compute_time_ms` |  752.50 |  1,505 |  884 |  621 |
| `quotient_poly_commit_time_ms` |  914.50 |  1,829 |  1,056 |  773 |
| `pcs_opening_time_ms ` |  1,267 |  2,534 |  1,395 |  1,139 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  8,294 |  16,588 |  8,331 |  8,257 |
| `main_cells_used     ` |  86,869,494.50 |  173,738,989 |  88,129,870 |  85,609,119 |
| `total_cycles        ` |  1,451,191.50 |  2,902,383 |  1,475,924 |  1,426,459 |
| `execute_time_ms     ` |  445 |  890 |  492 |  398 |
| `trace_gen_time_ms   ` |  1,272 |  2,544 |  1,352 |  1,192 |
| `stark_prove_excluding_trace_time_ms` |  6,577 |  13,154 |  6,581 |  6,573 |
| `main_trace_commit_time_ms` |  1,315.50 |  2,631 |  1,319 |  1,312 |
| `generate_perm_trace_time_ms` |  188.50 |  377 |  191 |  186 |
| `perm_trace_commit_time_ms` |  1,325 |  2,650 |  1,329 |  1,321 |
| `quotient_poly_compute_time_ms` |  1,082 |  2,164 |  1,082 |  1,082 |
| `quotient_poly_commit_time_ms` |  1,315.50 |  2,631 |  1,320 |  1,311 |
| `pcs_opening_time_ms ` |  1,343.50 |  2,687 |  1,349 |  1,338 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,192 | 8,257 | 1,475,924 | 225,774,050 | 6,573 | 1,082 | 1,320 | 1,321 | 1,338 | 1,319 | 88,129,870 | 186 | 492 | 
| leaf | 1 | 1,352 | 8,331 | 1,426,459 | 225,774,050 | 6,581 | 1,082 | 1,311 | 1,329 | 1,349 | 1,312 | 85,609,119 | 191 | 398 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,300 | 7,815 | 2,225,434 | 210,931,487 | 6,048 | 884 | 1,056 | 1,176 | 1,395 | 1,325 | 93,699,990 | 200 | 467 | 
| regex_program | 1 | 1,235 | 6,089 | 1,914,730 | 150,470,512 | 4,550 | 621 | 773 | 884 | 1,139 | 961 | 73,689,460 | 162 | 304 | 

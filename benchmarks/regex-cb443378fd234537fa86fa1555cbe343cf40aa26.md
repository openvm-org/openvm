...
| `total_proof_time_ms ` |  7,633 |  15,266 |  8,582 |  6,684 |
...
| `trace_gen_time_ms   ` |  1,699 |  3,398 |  1,880 |  1,518 |
| `stark_prove_excluding_trace_time_ms` |  5,482.50 |  10,965 |  6,216 |  4,749 |
| `main_trace_commit_time_ms` |  1,086.50 |  2,173 |  1,335 |  838 |
| `generate_perm_trace_time_ms` |  174 |  348 |  191 |  157 |
| `perm_trace_commit_time_ms` |  1,191.50 |  2,383 |  1,245 |  1,138 |
| `quotient_poly_compute_time_ms` |  740 |  1,480 |  875 |  605 |
| `quotient_poly_commit_time_ms` |  976 |  1,952 |  1,125 |  827 |
| `pcs_opening_time_ms ` |  1,302.50 |  2,605 |  1,437 |  1,168 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  14,712.50 |  29,425 |  14,815 |  14,610 |
| `main_cells_used     ` |  133,954,086 |  267,908,172 |  135,611,299 |  132,296,873 |
| `total_cycles        ` |  2,941,434.50 |  5,882,869 |  2,977,539 |  2,905,330 |
| `execute_time_ms     ` |  626 |  1,252 |  682 |  570 |
| `trace_gen_time_ms   ` |  2,694 |  5,388 |  2,841 |  2,547 |
| `stark_prove_excluding_trace_time_ms` |  11,392.50 |  22,785 |  11,404 |  11,381 |
| `main_trace_commit_time_ms` |  2,383 |  4,766 |  2,396 |  2,370 |
| `generate_perm_trace_time_ms` |  280.50 |  561 |  281 |  280 |
| `perm_trace_commit_time_ms` |  2,277 |  4,554 |  2,300 |  2,254 |
| `quotient_poly_compute_time_ms` |  1,654.50 |  3,309 |  1,666 |  1,643 |
| `quotient_poly_commit_time_ms` |  2,224 |  4,448 |  2,235 |  2,213 |
| `pcs_opening_time_ms ` |  2,569 |  5,138 |  2,569 |  2,569 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 2,547 | 14,610 | 2,977,539 | 360,326,872 | 11,381 | 1,643 | 2,213 | 2,300 | 2,569 | 2,370 | 135,611,299 | 281 | 682 | 
| leaf | 1 | 2,841 | 14,815 | 2,905,330 | 360,334,296 | 11,404 | 1,666 | 2,235 | 2,254 | 2,569 | 2,396 | 132,296,873 | 280 | 570 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,880 | 8,582 |  | 209,921,543 | 6,216 | 875 | 1,125 | 1,245 | 1,437 | 1,335 | 92,686,348 | 191 | 486 | 
| regex_program | 1 | 1,518 | 6,684 | 1,914,103 | 149,454,692 | 4,749 | 605 | 827 | 1,138 | 1,168 | 838 | 72,769,025 | 157 | 417 | 

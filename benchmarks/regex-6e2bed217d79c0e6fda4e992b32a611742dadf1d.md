...
| `total_proof_time_ms ` |  3,876 |  7,752 |  4,472 |  3,280 |
| `main_cells_used     ` |  83,723,935.50 |  167,447,871 |  93,738,635 |  73,709,236 |
| `total_cycles        ` |  2,070,213.50 |  4,140,427 |  2,225,434 |  1,914,993 |
| `execute_time_ms     ` |  343.50 |  687 |  379 |  308 |
| `trace_gen_time_ms   ` |  965.50 |  1,931 |  1,161 |  770 |
| `stark_prove_excluding_trace_time_ms` |  2,567 |  5,134 |  2,932 |  2,202 |
| `main_trace_commit_time_ms` |  450.50 |  901 |  534 |  367 |
| `generate_perm_trace_time_ms` |  163.50 |  327 |  185 |  142 |
| `perm_trace_commit_time_ms` |  638 |  1,276 |  744 |  532 |
| `quotient_poly_compute_time_ms` |  360.50 |  721 |  421 |  300 |
| `quotient_poly_commit_time_ms` |  272.50 |  545 |  320 |  225 |
| `pcs_opening_time_ms ` |  673 |  1,346 |  718 |  628 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,504 |  15,008 |  7,578 |  7,430 |
| `main_cells_used     ` |  152,709,957.50 |  305,419,915 |  155,169,239 |  150,250,676 |
| `total_cycles        ` |  1,991,024.50 |  3,982,049 |  2,021,831 |  1,960,218 |
| `execute_time_ms     ` |  742.50 |  1,485 |  749 |  736 |
| `trace_gen_time_ms   ` |  1,470 |  2,940 |  1,500 |  1,440 |
| `stark_prove_excluding_trace_time_ms` |  5,291.50 |  10,583 |  5,329 |  5,254 |
| `main_trace_commit_time_ms` |  891 |  1,782 |  892 |  890 |
| `generate_perm_trace_time_ms` |  352.50 |  705 |  362 |  343 |
| `perm_trace_commit_time_ms` |  1,702 |  3,404 |  1,735 |  1,669 |
| `quotient_poly_compute_time_ms` |  765.50 |  1,531 |  766 |  765 |
| `quotient_poly_commit_time_ms` |  519.50 |  1,039 |  520 |  519 |
| `pcs_opening_time_ms ` |  1,055 |  2,110 |  1,059 |  1,051 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,500 | 7,578 | 2,021,831 | 538,660,330 | 5,329 | 765 | 519 | 1,735 | 1,051 | 890 | 155,169,239 | 362 | 749 | 
| leaf | 1 | 1,440 | 7,430 | 1,960,218 | 538,660,330 | 5,254 | 766 | 520 | 1,669 | 1,059 | 892 | 150,250,676 | 343 | 736 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,161 | 4,472 | 2,225,434 | 275,652,919 | 2,932 | 421 | 320 | 744 | 718 | 534 | 93,738,635 | 185 | 379 | 
| regex_program | 1 | 770 | 3,280 | 1,914,993 | 198,099,628 | 2,202 | 300 | 225 | 532 | 628 | 367 | 73,709,236 | 142 | 308 | 

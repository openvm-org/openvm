...
| `stark_prove_excluding_trace_time_ms` |  2,190 |  2,190 |  2,190 |  2,190 |
...
| `pcs_opening_time_ms ` |  625 |  625 |  625 |  625 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  21,182 |  21,182 |  21,182 |  21,182 |
| `main_cells_used     ` |  202,804,476 |  202,804,476 |  202,804,476 |  202,804,476 |
| `total_cycles        ` |  4,138,722 |  4,138,722 |  4,138,722 |  4,138,722 |
| `execute_time_ms     ` |  963 |  963 |  963 |  963 |
| `trace_gen_time_ms   ` |  3,654 |  3,654 |  3,654 |  3,654 |
| `stark_prove_excluding_trace_time_ms` |  16,565 |  16,565 |  16,565 |  16,565 |
| `main_trace_commit_time_ms` |  2,961 |  2,961 |  2,961 |  2,961 |
| `generate_perm_trace_time_ms` |  378 |  378 |  378 |  378 |
| `perm_trace_commit_time_ms` |  3,273 |  3,273 |  3,273 |  3,273 |
| `quotient_poly_compute_time_ms` |  4,453 |  4,453 |  4,453 |  4,453 |
| `quotient_poly_commit_time_ms` |  2,522 |  2,522 |  2,522 |  2,522 |
| `pcs_opening_time_ms ` |  2,975 |  2,975 |  2,975 |  2,975 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 3,654 | 21,182 | 4,138,722 | 508,251,096 | 16,565 | 4,453 | 2,522 | 3,273 | 2,975 | 2,961 | 202,804,476 | 378 | 963 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 256 | 2,591 | 285,401 | 56,172,159 | 2,190 | 289 | 308 | 533 | 625 | 391 | 15,075,033 | 41 | 145 | 

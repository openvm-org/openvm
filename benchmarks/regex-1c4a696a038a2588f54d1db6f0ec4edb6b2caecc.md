...
| `total_proof_time_ms ` |  3,941 |  7,882 |  4,367 |  3,515 |
| `main_cells_used     ` |  83,255,576 |  166,511,152 |  93,500,799 |  73,010,353 |
| `total_cycles        ` |  2,082,613 |  4,165,226 |  2,243,715 |  1,921,511 |
| `execute_time_ms     ` |  353.50 |  707 |  392 |  315 |
| `trace_gen_time_ms   ` |  997.50 |  1,995 |  1,190 |  805 |
| `stark_prove_excluding_trace_time_ms` |  2,590 |  5,180 |  2,785 |  2,395 |
| `main_trace_commit_time_ms` |  499.50 |  999 |  557 |  442 |
| `generate_perm_trace_time_ms` |  219 |  438 |  229 |  209 |
| `perm_trace_commit_time_ms` |  546 |  1,092 |  574 |  518 |
| `quotient_poly_compute_time_ms` |  258.50 |  517 |  282 |  235 |
| `quotient_poly_commit_time_ms` |  243 |  486 |  277 |  209 |
| `pcs_opening_time_ms ` |  813.50 |  1,627 |  855 |  772 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  6,994 |  13,988 |  7,041 |  6,947 |
| `main_cells_used     ` |  151,828,163 |  303,656,326 |  154,228,466 |  149,427,860 |
| `total_cycles        ` |  1,975,753.50 |  3,951,507 |  2,006,618 |  1,944,889 |
| `execute_time_ms     ` |  773 |  1,546 |  782 |  764 |
| `trace_gen_time_ms   ` |  1,465 |  2,930 |  1,470 |  1,460 |
| `stark_prove_excluding_trace_time_ms` |  4,756 |  9,512 |  4,789 |  4,723 |
| `main_trace_commit_time_ms` |  872 |  1,744 |  878 |  866 |
| `generate_perm_trace_time_ms` |  399 |  798 |  412 |  386 |
| `perm_trace_commit_time_ms` |  1,255 |  2,510 |  1,268 |  1,242 |
| `quotient_poly_compute_time_ms` |  523.50 |  1,047 |  524 |  523 |
| `quotient_poly_commit_time_ms` |  412 |  824 |  413 |  411 |
| `pcs_opening_time_ms ` |  1,288 |  2,576 |  1,290 |  1,286 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,470 | 7,041 | 2,006,618 | 538,660,330 | 4,789 | 523 | 411 | 1,268 | 1,290 | 878 | 154,228,466 | 412 | 782 | 
| leaf | 1 | 1,460 | 6,947 | 1,944,889 | 538,660,330 | 4,723 | 524 | 413 | 1,242 | 1,286 | 866 | 149,427,860 | 386 | 764 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,190 | 4,367 | 2,243,715 | 275,652,919 | 2,785 | 282 | 277 | 574 | 855 | 557 | 93,500,799 | 229 | 392 | 
| regex_program | 1 | 805 | 3,515 | 1,921,511 | 242,975,404 | 2,395 | 235 | 209 | 518 | 772 | 442 | 73,010,353 | 209 | 315 | 

...
| `total_proof_time_ms ` |  3,949.50 |  7,899 |  4,397 |  3,502 |
...
| `trace_gen_time_ms   ` |  985 |  1,970 |  1,172 |  798 |
| `stark_prove_excluding_trace_time_ms` |  2,609.50 |  5,219 |  2,830 |  2,389 |
| `main_trace_commit_time_ms` |  503 |  1,006 |  558 |  448 |
| `generate_perm_trace_time_ms` |  210 |  420 |  215 |  205 |
| `perm_trace_commit_time_ms` |  551.50 |  1,103 |  587 |  516 |
| `quotient_poly_compute_time_ms` |  264.50 |  529 |  285 |  244 |
| `quotient_poly_commit_time_ms` |  240.50 |  481 |  276 |  205 |
| `pcs_opening_time_ms ` |  829 |  1,658 |  899 |  759 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,009.50 |  14,019 |  7,081 |  6,938 |
| `main_cells_used     ` |  151,828,391 |  303,656,782 |  154,228,178 |  149,428,604 |
| `total_cycles        ` |  1,975,772.50 |  3,951,545 |  2,006,594 |  1,944,951 |
| `execute_time_ms     ` |  786 |  1,572 |  792 |  780 |
| `trace_gen_time_ms   ` |  1,488.50 |  2,977 |  1,528 |  1,449 |
| `stark_prove_excluding_trace_time_ms` |  4,735 |  9,470 |  4,761 |  4,709 |
| `main_trace_commit_time_ms` |  866 |  1,732 |  866 |  866 |
| `generate_perm_trace_time_ms` |  396 |  792 |  422 |  370 |
| `perm_trace_commit_time_ms` |  1,243.50 |  2,487 |  1,244 |  1,243 |
| `quotient_poly_compute_time_ms` |  524.50 |  1,049 |  525 |  524 |
| `quotient_poly_commit_time_ms` |  411 |  822 |  417 |  405 |
| `pcs_opening_time_ms ` |  1,289 |  2,578 |  1,294 |  1,284 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,528 | 7,081 | 2,006,594 | 538,660,330 | 4,761 | 524 | 417 | 1,244 | 1,284 | 866 | 154,228,178 | 422 | 792 | 
| leaf | 1 | 1,449 | 6,938 | 1,944,951 | 538,660,330 | 4,709 | 525 | 405 | 1,243 | 1,294 | 866 | 149,428,604 | 370 | 780 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,172 | 4,397 | 2,243,715 | 275,652,919 | 2,830 | 285 | 276 | 587 | 899 | 558 | 93,500,799 | 215 | 395 | 
| regex_program | 1 | 798 | 3,502 | 1,921,511 | 242,975,404 | 2,389 | 244 | 205 | 516 | 759 | 448 | 73,010,353 | 205 | 315 | 

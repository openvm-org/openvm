...
| `total_proof_time_ms ` |  2,616 |  2,616 |  2,616 |  2,616 |
...
| `stark_prove_excluding_trace_time_ms` |  2,209 |  2,209 |  2,209 |  2,209 |
...
| `quotient_poly_compute_time_ms` |  298 |  298 |  298 |  298 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  42,218 |  42,218 |  42,218 |  42,218 |
| `main_cells_used     ` |  365,919,656 |  365,919,656 |  365,919,656 |  365,919,656 |
| `total_cycles        ` |  8,656,274 |  8,656,274 |  8,656,274 |  8,656,274 |
| `execute_time_ms     ` |  2,587 |  2,587 |  2,587 |  2,587 |
| `trace_gen_time_ms   ` |  6,422 |  6,422 |  6,422 |  6,422 |
| `stark_prove_excluding_trace_time_ms` |  33,209 |  33,209 |  33,209 |  33,209 |
| `main_trace_commit_time_ms` |  5,798 |  5,798 |  5,798 |  5,798 |
| `generate_perm_trace_time_ms` |  708 |  708 |  708 |  708 |
| `perm_trace_commit_time_ms` |  7,209 |  7,209 |  7,209 |  7,209 |
| `quotient_poly_compute_time_ms` |  7,866 |  7,866 |  7,866 |  7,866 |
| `quotient_poly_commit_time_ms` |  5,150 |  5,150 |  5,150 |  5,150 |
| `pcs_opening_time_ms ` |  6,474 |  6,474 |  6,474 |  6,474 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 6,422 | 42,218 | 8,656,274 | 1,052,183,000 | 33,209 | 7,866 | 5,150 | 7,209 | 6,474 | 5,798 | 365,919,656 | 708 | 2,587 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 262 | 2,616 | 285,401 | 56,172,159 | 2,209 | 298 | 310 | 534 | 626 | 399 | 15,092,297 | 39 | 145 | 

...
| `stark_prove_excluding_trace_time_ms` |  1,111 |  1,111 |  1,111 |  1,111 |
...
| `quotient_poly_commit_time_ms` |  159 |  159 |  159 |  159 |
| `pcs_opening_time_ms ` |  415 |  415 |  415 |  415 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  13,050 |  13,050 |  13,050 |  13,050 |
| `main_cells_used     ` |  244,742,172 |  244,742,172 |  244,742,172 |  244,742,172 |
| `total_cycles        ` |  2,990,583 |  2,990,583 |  2,990,583 |  2,990,583 |
| `execute_time_ms     ` |  1,087 |  1,087 |  1,087 |  1,087 |
| `trace_gen_time_ms   ` |  2,335 |  2,335 |  2,335 |  2,335 |
| `stark_prove_excluding_trace_time_ms` |  9,628 |  9,628 |  9,628 |  9,628 |
| `main_trace_commit_time_ms` |  1,728 |  1,728 |  1,728 |  1,728 |
| `generate_perm_trace_time_ms` |  702 |  702 |  702 |  702 |
| `perm_trace_commit_time_ms` |  3,170 |  3,170 |  3,170 |  3,170 |
| `quotient_poly_compute_time_ms` |  1,337 |  1,337 |  1,337 |  1,337 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 2,335 | 13,050 | 2,990,583 | 999,394,794 | 9,628 | 1,337 | 884 | 3,170 | 1,803 | 1,728 | 244,742,172 | 702 | 1,087 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 182 | 1,441 | 295,303 | 48,240,457 | 1,111 | 123 | 159 | 190 | 415 | 173 | 15,598,665 | 32 | 148 | 

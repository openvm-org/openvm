...
| `total_proof_time_ms ` |  4,224 |  8,448 |  4,661 |  3,787 |
| `main_cells_used     ` |  83,255,576 |  166,511,152 |  93,500,799 |  73,010,353 |
| `total_cycles        ` |  2,082,613 |  4,165,226 |  2,243,715 |  1,921,511 |
| `execute_time_ms     ` |  340.50 |  681 |  378 |  303 |
| `trace_gen_time_ms   ` |  987.50 |  1,975 |  1,174 |  801 |
| `stark_prove_excluding_trace_time_ms` |  2,896 |  5,792 |  3,109 |  2,683 |
| `main_trace_commit_time_ms` |  518 |  1,036 |  580 |  456 |
| `generate_perm_trace_time_ms` |  202.50 |  405 |  211 |  194 |
| `perm_trace_commit_time_ms` |  749.50 |  1,499 |  805 |  694 |
| `quotient_poly_compute_time_ms` |  397 |  794 |  429 |  365 |
| `quotient_poly_commit_time_ms` |  304 |  608 |  338 |  270 |
| `pcs_opening_time_ms ` |  714.50 |  1,429 |  735 |  694 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,247.50 |  14,495 |  7,345 |  7,150 |
| `main_cells_used     ` |  152,278,105 |  304,556,210 |  154,678,318 |  149,877,892 |
| `total_cycles        ` |  1,991,020 |  3,982,040 |  2,021,877 |  1,960,163 |
| `execute_time_ms     ` |  755 |  1,510 |  765 |  745 |
| `trace_gen_time_ms   ` |  1,457 |  2,914 |  1,490 |  1,424 |
| `stark_prove_excluding_trace_time_ms` |  5,035.50 |  10,071 |  5,090 |  4,981 |
| `main_trace_commit_time_ms` |  809 |  1,618 |  813 |  805 |
| `generate_perm_trace_time_ms` |  375 |  750 |  389 |  361 |
| `perm_trace_commit_time_ms` |  1,532 |  3,064 |  1,569 |  1,495 |
| `quotient_poly_compute_time_ms` |  766.50 |  1,533 |  769 |  764 |
| `quotient_poly_commit_time_ms` |  494.50 |  989 |  495 |  494 |
| `pcs_opening_time_ms ` |  1,053.50 |  2,107 |  1,056 |  1,051 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,490 | 7,345 | 2,021,877 | 538,660,330 | 5,090 | 764 | 494 | 1,569 | 1,056 | 813 | 154,678,318 | 389 | 765 | 
| leaf | 1 | 1,424 | 7,150 | 1,960,163 | 538,660,330 | 4,981 | 769 | 495 | 1,495 | 1,051 | 805 | 149,877,892 | 361 | 745 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,174 | 4,661 | 2,243,715 | 275,652,919 | 3,109 | 429 | 338 | 805 | 735 | 580 | 93,500,799 | 211 | 378 | 
| regex_program | 1 | 801 | 3,787 | 1,921,511 | 242,975,404 | 2,683 | 365 | 270 | 694 | 694 | 456 | 73,010,353 | 194 | 303 | 

...
| `total_proof_time_ms ` |  3,957.50 |  7,915 |  4,557 |  3,358 |
...
| `trace_gen_time_ms   ` |  941.50 |  1,883 |  1,109 |  774 |
| `stark_prove_excluding_trace_time_ms` |  2,676.50 |  5,353 |  3,072 |  2,281 |
| `main_trace_commit_time_ms` |  494 |  988 |  577 |  411 |
| `generate_perm_trace_time_ms` |  164.50 |  329 |  195 |  134 |
| `perm_trace_commit_time_ms` |  698 |  1,396 |  807 |  589 |
| `quotient_poly_compute_time_ms` |  356.50 |  713 |  419 |  294 |
| `quotient_poly_commit_time_ms` |  292.50 |  585 |  342 |  243 |
| `pcs_opening_time_ms ` |  660 |  1,320 |  722 |  598 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,495.50 |  14,991 |  7,564 |  7,427 |
| `main_cells_used     ` |  152,232,812 |  304,465,624 |  154,690,520 |  149,775,104 |
| `total_cycles        ` |  1,990,716.50 |  3,981,433 |  2,021,525 |  1,959,908 |
| `execute_time_ms     ` |  769.50 |  1,539 |  778 |  761 |
| `trace_gen_time_ms   ` |  1,475 |  2,950 |  1,481 |  1,469 |
| `stark_prove_excluding_trace_time_ms` |  5,251 |  10,502 |  5,305 |  5,197 |
| `main_trace_commit_time_ms` |  893 |  1,786 |  894 |  892 |
| `generate_perm_trace_time_ms` |  342.50 |  685 |  347 |  338 |
| `perm_trace_commit_time_ms` |  1,647 |  3,294 |  1,680 |  1,614 |
| `quotient_poly_compute_time_ms` |  770 |  1,540 |  771 |  769 |
| `quotient_poly_commit_time_ms` |  518 |  1,036 |  519 |  517 |
| `pcs_opening_time_ms ` |  1,075.50 |  2,151 |  1,093 |  1,058 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,481 | 7,564 | 2,021,525 | 533,941,738 | 5,305 | 769 | 517 | 1,680 | 1,093 | 894 | 154,690,520 | 347 | 778 | 
| leaf | 1 | 1,469 | 7,427 | 1,959,908 | 533,941,738 | 5,197 | 771 | 519 | 1,614 | 1,058 | 892 | 149,775,104 | 338 | 761 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,109 | 4,557 | 2,225,434 | 275,652,919 | 3,072 | 419 | 342 | 807 | 722 | 577 | 93,699,990 | 195 | 376 | 
| regex_program | 1 | 774 | 3,358 | 1,914,730 | 198,099,628 | 2,281 | 294 | 243 | 589 | 598 | 411 | 73,689,460 | 134 | 303 | 

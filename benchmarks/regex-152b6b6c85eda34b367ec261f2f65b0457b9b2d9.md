...
| `total_proof_time_ms ` |  3,919.50 |  7,839 |  4,324 |  3,515 |
| `main_cells_used     ` |  83,255,576 |  166,511,152 |  93,500,799 |  73,010,353 |
| `total_cycles        ` |  2,082,613 |  4,165,226 |  2,243,715 |  1,921,511 |
| `execute_time_ms     ` |  358.50 |  717 |  399 |  318 |
| `trace_gen_time_ms   ` |  967.50 |  1,935 |  1,152 |  783 |
| `stark_prove_excluding_trace_time_ms` |  2,593.50 |  5,187 |  2,773 |  2,414 |
| `main_trace_commit_time_ms` |  501 |  1,002 |  559 |  443 |
| `generate_perm_trace_time_ms` |  219.50 |  439 |  230 |  209 |
| `perm_trace_commit_time_ms` |  545.50 |  1,091 |  573 |  518 |
| `quotient_poly_compute_time_ms` |  274 |  548 |  283 |  265 |
| `quotient_poly_commit_time_ms` |  243.50 |  487 |  279 |  208 |
| `pcs_opening_time_ms ` |  799.50 |  1,599 |  838 |  761 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,007.50 |  14,015 |  7,067 |  6,948 |
| `main_cells_used     ` |  151,827,935 |  303,655,870 |  154,227,722 |  149,428,148 |
| `total_cycles        ` |  1,975,734.50 |  3,951,469 |  2,006,556 |  1,944,913 |
| `execute_time_ms     ` |  784 |  1,568 |  790 |  778 |
| `trace_gen_time_ms   ` |  1,488 |  2,976 |  1,514 |  1,462 |
| `stark_prove_excluding_trace_time_ms` |  4,735.50 |  9,471 |  4,763 |  4,708 |
| `main_trace_commit_time_ms` |  869 |  1,738 |  872 |  866 |
| `generate_perm_trace_time_ms` |  401 |  802 |  421 |  381 |
| `perm_trace_commit_time_ms` |  1,245 |  2,490 |  1,252 |  1,238 |
| `quotient_poly_compute_time_ms` |  523.50 |  1,047 |  524 |  523 |
| `quotient_poly_commit_time_ms` |  415.50 |  831 |  417 |  414 |
| `pcs_opening_time_ms ` |  1,278 |  2,556 |  1,278 |  1,278 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,514 | 7,067 | 2,006,556 | 538,660,330 | 4,763 | 523 | 414 | 1,252 | 1,278 | 872 | 154,227,722 | 421 | 790 | 
| leaf | 1 | 1,462 | 6,948 | 1,944,913 | 538,660,330 | 4,708 | 524 | 417 | 1,238 | 1,278 | 866 | 149,428,148 | 381 | 778 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,152 | 4,324 | 2,243,715 | 275,652,919 | 2,773 | 283 | 279 | 573 | 838 | 559 | 93,500,799 | 230 | 399 | 
| regex_program | 1 | 783 | 3,515 | 1,921,511 | 242,975,404 | 2,414 | 265 | 208 | 518 | 761 | 443 | 73,010,353 | 209 | 318 | 

...
| `total_proof_time_ms ` |  3,913 |  7,826 |  4,331 |  3,495 |
...
| `trace_gen_time_ms   ` |  952.50 |  1,905 |  1,128 |  777 |
| `stark_prove_excluding_trace_time_ms` |  2,602.50 |  5,205 |  2,805 |  2,400 |
| `main_trace_commit_time_ms` |  499.50 |  999 |  556 |  443 |
| `generate_perm_trace_time_ms` |  216.50 |  433 |  232 |  201 |
| `perm_trace_commit_time_ms` |  545.50 |  1,091 |  574 |  517 |
| `quotient_poly_compute_time_ms` |  266.50 |  533 |  288 |  245 |
| `quotient_poly_commit_time_ms` |  244.50 |  489 |  277 |  212 |
| `pcs_opening_time_ms ` |  820.50 |  1,641 |  869 |  772 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  6,986.50 |  13,973 |  7,057 |  6,916 |
| `main_cells_used     ` |  151,828,625 |  303,657,250 |  154,228,274 |  149,428,976 |
| `total_cycles        ` |  1,975,792 |  3,951,584 |  2,006,602 |  1,944,982 |
| `execute_time_ms     ` |  771.50 |  1,543 |  780 |  763 |
| `trace_gen_time_ms   ` |  1,473.50 |  2,947 |  1,498 |  1,449 |
| `stark_prove_excluding_trace_time_ms` |  4,741.50 |  9,483 |  4,779 |  4,704 |
| `main_trace_commit_time_ms` |  867.50 |  1,735 |  868 |  867 |
| `generate_perm_trace_time_ms` |  392.50 |  785 |  413 |  372 |
| `perm_trace_commit_time_ms` |  1,242 |  2,484 |  1,245 |  1,239 |
| `quotient_poly_compute_time_ms` |  537.50 |  1,075 |  547 |  528 |
| `quotient_poly_commit_time_ms` |  411.50 |  823 |  413 |  410 |
| `pcs_opening_time_ms ` |  1,285 |  2,570 |  1,291 |  1,279 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,498 | 7,057 | 2,006,602 | 538,660,330 | 4,779 | 547 | 410 | 1,245 | 1,291 | 867 | 154,228,274 | 413 | 780 | 
| leaf | 1 | 1,449 | 6,916 | 1,944,982 | 538,660,330 | 4,704 | 528 | 413 | 1,239 | 1,279 | 868 | 149,428,976 | 372 | 763 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,128 | 4,331 | 2,243,715 | 275,652,919 | 2,805 | 288 | 277 | 574 | 869 | 556 | 93,500,799 | 232 | 398 | 
| regex_program | 1 | 777 | 3,495 | 1,921,511 | 242,975,404 | 2,400 | 245 | 212 | 517 | 772 | 443 | 73,010,353 | 201 | 318 | 

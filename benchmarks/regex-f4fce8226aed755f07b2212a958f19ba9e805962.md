...
| `total_proof_time_ms ` |  3,941 |  7,882 |  4,391 |  3,491 |
...
| `trace_gen_time_ms   ` |  985.50 |  1,971 |  1,183 |  788 |
| `stark_prove_excluding_trace_time_ms` |  2,603 |  5,206 |  2,816 |  2,390 |
| `main_trace_commit_time_ms` |  502.50 |  1,005 |  560 |  445 |
| `generate_perm_trace_time_ms` |  219.50 |  439 |  230 |  209 |
| `perm_trace_commit_time_ms` |  560.50 |  1,121 |  603 |  518 |
| `quotient_poly_compute_time_ms` |  264.50 |  529 |  291 |  238 |
| `quotient_poly_commit_time_ms` |  242.50 |  485 |  278 |  207 |
| `pcs_opening_time_ms ` |  804 |  1,608 |  844 |  764 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  6,966.50 |  13,933 |  7,056 |  6,877 |
| `main_cells_used     ` |  151,827,431 |  303,654,862 |  154,227,146 |  149,427,716 |
| `total_cycles        ` |  1,975,692.50 |  3,951,385 |  2,006,508 |  1,944,877 |
| `execute_time_ms     ` |  771 |  1,542 |  778 |  764 |
| `trace_gen_time_ms   ` |  1,465 |  2,930 |  1,525 |  1,405 |
| `stark_prove_excluding_trace_time_ms` |  4,730.50 |  9,461 |  4,753 |  4,708 |
| `main_trace_commit_time_ms` |  867 |  1,734 |  869 |  865 |
| `generate_perm_trace_time_ms` |  404 |  808 |  429 |  379 |
| `perm_trace_commit_time_ms` |  1,242.50 |  2,485 |  1,246 |  1,239 |
| `quotient_poly_compute_time_ms` |  513 |  1,026 |  515 |  511 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,525 | 7,056 | 2,006,508 | 538,660,330 | 4,753 | 511 | 414 | 1,246 | 1,280 | 869 | 154,227,146 | 429 | 778 | 
| leaf | 1 | 1,405 | 6,877 | 1,944,877 | 538,660,330 | 4,708 | 515 | 417 | 1,239 | 1,287 | 865 | 149,427,716 | 379 | 764 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,183 | 4,391 | 2,243,715 | 275,652,919 | 2,816 | 291 | 278 | 603 | 844 | 560 | 93,500,799 | 230 | 392 | 
| regex_program | 1 | 788 | 3,491 | 1,921,511 | 242,975,404 | 2,390 | 238 | 207 | 518 | 764 | 445 | 73,010,353 | 209 | 313 | 

...
| `total_proof_time_ms ` |  1,498 |  2,996 |  1,711 |  1,285 |
...
| `execute_preflight_insn_mi/s` |  31.76 | -          |  33.66 |  29.87 |
| `trace_gen_time_ms   ` |  317 |  634 |  340 |  294 |
| `memory_finalize_time_ms` |  2 |  4 |  4 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  999.50 |  1,999 |  1,209 |  790 |
| `main_trace_commit_time_ms` |  141 |  282 |  184 |  98 |
| `generate_perm_trace_time_ms` |  61.50 |  123 |  66 |  57 |
| `perm_trace_commit_time_ms` |  172.63 |  345.26 |  225.69 |  119.56 |
| `quotient_poly_compute_time_ms` |  159.93 |  319.87 |  170.50 |  149.36 |
| `quotient_poly_commit_time_ms` |  36.73 |  73.45 |  48.01 |  25.44 |
| `pcs_opening_time_ms ` |  420 |  840 |  531 |  309 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  2,068.50 |  4,137 |  2,847 |  1,290 |
| `main_cells_used     ` |  14,798,849 |  29,597,698 |  20,272,474 |  9,325,224 |
| `total_cells_used    ` |  37,032,585 |  74,065,170 |  50,586,080 |  23,479,090 |
| `execute_preflight_insns` |  1,663,280.50 |  3,326,561 |  1,830,016 |  1,496,545 |
| `execute_preflight_time_ms` |  576 |  1,152 |  892 |  260 |
| `execute_preflight_insn_mi/s` |  7.09 | -          |  7.36 |  6.82 |
| `trace_gen_time_ms   ` |  127.50 |  255 |  179 |  76 |
| `memory_finalize_time_ms` |  12.50 |  25 |  18 |  7 |
| `stark_prove_excluding_trace_time_ms` |  1,364 |  2,728 |  1,775 |  953 |
| `main_trace_commit_time_ms` |  181 |  362 |  230 |  132 |
| `generate_perm_trace_time_ms` |  73.50 |  147 |  95 |  52 |
| `perm_trace_commit_time_ms` |  278.88 |  557.76 |  370.36 |  187.41 |
| `quotient_poly_compute_time_ms` |  177.71 |  355.42 |  230.16 |  125.26 |
| `quotient_poly_commit_time_ms` |  44.02 |  88.04 |  57.09 |  30.95 |
| `pcs_opening_time_ms ` |  604.50 |  1,209 |  787 |  422 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 2,849 |  | 1 |  | 1 |  |  |  |  | 
| regex_program |  | 1,285 |  | 41 | 1 | 43 | 4,108,483 | 95.11 | 168 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 76 | 1,290 | 23,479,090 | 319,626,730 | 76 | 953 | 0 | 125.26 | 30.95 | 5 | 187.41 | 422 | 240 | 422 | 7 | 132 | 9,325,224 | 52 | 260 | 1,496,545 | 7.36 | 29 | 157 | 1 | 422 | 
| leaf | 1 | 179 | 2,847 | 50,586,080 | 538,660,330 | 179 | 1,775 | 0 | 230.16 | 57.09 | 5 | 370.36 | 787 | 466 | 787 | 18 | 230 | 20,272,474 | 95 | 892 | 1,830,016 | 6.82 | 56 | 289 | 1 | 787 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 294 | 1,711 | 23,397,108 | 373,183,036 | 294 | 1,209 | 0 | 149.36 | 48.01 | 6 | 225.69 | 531 | 293 | 531 | 4 | 184 | 10,866,434 | 66 | 82 | 2,211,000 | 29.87 | 46 | 199 | 2 | 531 | 
| regex_program | 1 | 340 | 1,285 | 11,981,356 | 196,739,722 | 340 | 790 | 2 | 170.50 | 25.44 | 6 | 119.56 | 309 | 180 | 309 | 0 | 98 | 2,537,170 | 57 | 107 | 1,897,483 | 33.66 | 26 | 201 | 2 | 309 | 

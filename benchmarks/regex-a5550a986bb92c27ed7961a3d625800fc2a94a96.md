...
| `total_proof_time_ms ` |  4,007 |  8,014 |  4,425 |  3,589 |
...
| `trace_gen_time_ms   ` |  945.50 |  1,891 |  1,101 |  790 |
| `stark_prove_excluding_trace_time_ms` |  2,724 |  5,448 |  2,949 |  2,499 |
| `main_trace_commit_time_ms` |  473 |  946 |  534 |  412 |
| `generate_perm_trace_time_ms` |  197 |  394 |  205 |  189 |
| `perm_trace_commit_time_ms` |  690 |  1,380 |  737 |  643 |
| `quotient_poly_compute_time_ms` |  395 |  790 |  428 |  362 |
| `quotient_poly_commit_time_ms` |  279 |  558 |  314 |  244 |
| `pcs_opening_time_ms ` |  682.50 |  1,365 |  723 |  642 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,300.50 |  14,601 |  7,365 |  7,236 |
| `main_cells_used     ` |  152,278,087 |  304,556,174 |  154,677,418 |  149,878,756 |
| `total_cycles        ` |  1,991,018.50 |  3,982,037 |  2,021,802 |  1,960,235 |
| `execute_time_ms     ` |  775 |  1,550 |  783 |  767 |
| `trace_gen_time_ms   ` |  1,474 |  2,948 |  1,488 |  1,460 |
| `stark_prove_excluding_trace_time_ms` |  5,051.50 |  10,103 |  5,094 |  5,009 |
| `main_trace_commit_time_ms` |  811 |  1,622 |  815 |  807 |
| `generate_perm_trace_time_ms` |  379 |  758 |  388 |  370 |
| `perm_trace_commit_time_ms` |  1,547 |  3,094 |  1,583 |  1,511 |
| `quotient_poly_compute_time_ms` |  764.50 |  1,529 |  767 |  762 |
| `quotient_poly_commit_time_ms` |  494 |  988 |  494 |  494 |
| `pcs_opening_time_ms ` |  1,050.50 |  2,101 |  1,055 |  1,046 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,488 | 7,365 | 2,021,802 | 538,660,330 | 5,094 | 762 | 494 | 1,583 | 1,046 | 815 | 154,677,418 | 388 | 783 | 
| leaf | 1 | 1,460 | 7,236 | 1,960,235 | 538,660,330 | 5,009 | 767 | 494 | 1,511 | 1,055 | 807 | 149,878,756 | 370 | 767 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,101 | 4,425 | 2,243,715 | 275,652,919 | 2,949 | 428 | 314 | 737 | 723 | 534 | 93,500,799 | 205 | 375 | 
| regex_program | 1 | 790 | 3,589 | 1,921,511 | 242,975,404 | 2,499 | 362 | 244 | 643 | 642 | 412 | 73,010,353 | 189 | 300 | 

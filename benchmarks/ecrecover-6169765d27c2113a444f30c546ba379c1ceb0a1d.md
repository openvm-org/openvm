...
| `total_proof_time_ms ` |  1,503 |  1,503 |  1,503 |  1,503 |
...
| `main_cells_used     ` |  244,318,770 |  244,318,770 |  244,318,770 |  244,318,770 |
| `total_cycles        ` |  2,989,566 |  2,989,566 |  2,989,566 |  2,989,566 |
| `execute_time_ms     ` |  1,106 |  1,106 |  1,106 |  1,106 |
| `trace_gen_time_ms   ` |  2,370 |  2,370 |  2,370 |  2,370 |
| `stark_prove_excluding_trace_time_ms` |  9,621 |  9,621 |  9,621 |  9,621 |
| `main_trace_commit_time_ms` |  1,736 |  1,736 |  1,736 |  1,736 |
| `generate_perm_trace_time_ms` |  696 |  696 |  696 |  696 |
| `perm_trace_commit_time_ms` |  3,133 |  3,133 |  3,133 |  3,133 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 2,370 | 13,097 | 2,989,566 | 999,656,938 | 9,621 | 1,343 | 885 | 3,133 | 1,824 | 1,736 | 244,318,770 | 696 | 1,106 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 183 | 1,503 | 295,181 | 48,197,161 | 1,172 | 125 | 163 | 199 | 452 | 183 | 15,586,346 | 31 | 148 | 

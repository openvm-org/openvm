...
| `total_proof_time_ms ` |  6,889 |  13,778 |  7,753 |  6,025 |
| `main_cells_used     ` |  82,727,686.50 |  165,455,373 |  92,686,348 |  72,769,025 |
| `total_cycles        ` |  1,914,103 |  1,914,103 |  1,914,103 |  1,914,103 |
| `execute_time_ms     ` |  447.50 |  895 |  482 |  413 |
| `trace_gen_time_ms   ` |  1,074.50 |  2,149 |  1,230 |  919 |
| `stark_prove_excluding_trace_time_ms` |  5,367 |  10,734 |  6,041 |  4,693 |
| `main_trace_commit_time_ms` |  1,019.50 |  2,039 |  1,261 |  778 |
| `generate_perm_trace_time_ms` |  166 |  332 |  187 |  145 |
| `perm_trace_commit_time_ms` |  1,138 |  2,276 |  1,202 |  1,074 |
| `quotient_poly_compute_time_ms` |  749 |  1,498 |  867 |  631 |
| `quotient_poly_commit_time_ms` |  948 |  1,896 |  1,095 |  801 |
| `pcs_opening_time_ms ` |  1,318.50 |  2,637 |  1,420 |  1,217 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  8,002 |  16,004 |  8,233 |  7,771 |
| `main_cells_used     ` |  77,286,777.50 |  154,573,555 |  78,375,071 |  76,198,484 |
| `total_cycles        ` |  1,028,165.50 |  2,056,331 |  1,045,607 |  1,010,724 |
| `execute_time_ms     ` |  378 |  756 |  421 |  335 |
| `trace_gen_time_ms   ` |  1,132.50 |  2,265 |  1,216 |  1,049 |
| `stark_prove_excluding_trace_time_ms` |  6,491.50 |  12,983 |  6,763 |  6,220 |
| `main_trace_commit_time_ms` |  1,313.50 |  2,627 |  1,369 |  1,258 |
| `generate_perm_trace_time_ms` |  162 |  324 |  174 |  150 |
| `perm_trace_commit_time_ms` |  1,302.50 |  2,605 |  1,357 |  1,248 |
| `quotient_poly_compute_time_ms` |  975 |  1,950 |  1,036 |  914 |
| `quotient_poly_commit_time_ms` |  1,267 |  2,534 |  1,323 |  1,211 |
| `pcs_opening_time_ms ` |  1,468 |  2,936 |  1,500 |  1,436 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,049 | 8,233 | 1,045,607 | 220,669,656 | 6,763 | 1,036 | 1,323 | 1,357 | 1,500 | 1,369 | 78,375,071 | 174 | 421 | 
| leaf | 1 | 1,216 | 7,771 | 1,010,724 | 194,986,968 | 6,220 | 914 | 1,211 | 1,248 | 1,436 | 1,258 | 76,198,484 | 150 | 335 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,230 | 7,753 |  | 209,921,543 | 6,041 | 867 | 1,095 | 1,202 | 1,420 | 1,261 | 92,686,348 | 187 | 482 | 
| regex_program | 1 | 919 | 6,025 | 1,914,103 | 149,454,692 | 4,693 | 631 | 801 | 1,074 | 1,217 | 778 | 72,769,025 | 145 | 413 | 

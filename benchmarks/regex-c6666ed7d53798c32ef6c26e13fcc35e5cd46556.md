...
| `total_proof_time_ms ` |  14,598 |  14,598 |  14,598 |  14,598 |
| `main_cells_used     ` |  165,010,909 |  165,010,909 |  165,010,909 |  165,010,909 |
| `total_cycles        ` |  4,190,904 |  4,190,904 |  4,190,904 |  4,190,904 |
| `execute_time_ms     ` |  1,008 |  1,008 |  1,008 |  1,008 |
| `trace_gen_time_ms   ` |  2,918 |  2,918 |  2,918 |  2,918 |
| `stark_prove_excluding_trace_time_ms` |  10,672 |  10,672 |  10,672 |  10,672 |
| `main_trace_commit_time_ms` |  2,369 |  2,369 |  2,369 |  2,369 |
| `generate_perm_trace_time_ms` |  395 |  395 |  395 |  395 |
| `perm_trace_commit_time_ms` |  2,114 |  2,114 |  2,114 |  2,114 |
| `quotient_poly_compute_time_ms` |  1,514 |  1,514 |  1,514 |  1,514 |
| `quotient_poly_commit_time_ms` |  1,881 |  1,881 |  1,881 |  1,881 |
| `pcs_opening_time_ms ` |  2,390 |  2,390 |  2,390 |  2,390 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  15,056 |  15,056 |  15,056 |  15,056 |
| `main_cells_used     ` |  140,890,111 |  140,890,111 |  140,890,111 |  140,890,111 |
| `total_cycles        ` |  3,128,401 |  3,128,401 |  3,128,401 |  3,128,401 |
| `execute_time_ms     ` |  754 |  754 |  754 |  754 |
| `trace_gen_time_ms   ` |  2,810 |  2,810 |  2,810 |  2,810 |
| `stark_prove_excluding_trace_time_ms` |  11,492 |  11,492 |  11,492 |  11,492 |
| `main_trace_commit_time_ms` |  2,381 |  2,381 |  2,381 |  2,381 |
| `generate_perm_trace_time_ms` |  290 |  290 |  290 |  290 |
| `perm_trace_commit_time_ms` |  2,295 |  2,295 |  2,295 |  2,295 |
| `quotient_poly_compute_time_ms` |  1,670 |  1,670 |  1,670 |  1,670 |
| `quotient_poly_commit_time_ms` |  2,207 |  2,207 |  2,207 |  2,207 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 2,810 | 15,056 | 3,128,401 | 360,334,296 | 11,492 | 1,670 | 2,207 | 2,295 | 2,645 | 2,381 | 140,890,111 | 290 | 754 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 2,918 | 14,598 | 4,190,904 | 384,102,008 | 10,672 | 1,514 | 1,881 | 2,114 | 2,390 | 2,369 | 165,010,909 | 395 | 1,008 | 

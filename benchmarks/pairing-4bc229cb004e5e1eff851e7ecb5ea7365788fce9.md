...
| `quotient_poly_commit_time_ms` |  357 |  357 |  357 |  357 |
| `pcs_opening_time_ms ` |  775 |  775 |  775 |  775 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  14,283 |  14,283 |  14,283 |  14,283 |
| `main_cells_used     ` |  273,857,244 |  273,857,244 |  273,857,244 |  273,857,244 |
| `total_cycles        ` |  3,267,450 |  3,267,450 |  3,267,450 |  3,267,450 |
| `execute_time_ms     ` |  1,280 |  1,280 |  1,280 |  1,280 |
| `trace_gen_time_ms   ` |  2,623 |  2,623 |  2,623 |  2,623 |
| `stark_prove_excluding_trace_time_ms` |  10,380 |  10,380 |  10,380 |  10,380 |
| `main_trace_commit_time_ms` |  1,776 |  1,776 |  1,776 |  1,776 |
| `generate_perm_trace_time_ms` |  766 |  766 |  766 |  766 |
| `perm_trace_commit_time_ms` |  3,392 |  3,392 |  3,392 |  3,392 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 2,623 | 14,283 | 3,267,450 | 1,081,183,722 | 10,380 | 1,488 | 974 | 3,392 | 1,978 | 1,776 | 273,857,244 | 766 | 1,280 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 977 | 4,926 | 1,820,436 | 297,675,351 | 3,297 | 472 | 357 | 832 | 775 | 651 | 95,832,407 | 193 | 652 | 

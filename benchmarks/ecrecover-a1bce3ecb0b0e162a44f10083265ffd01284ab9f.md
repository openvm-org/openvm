...
| `quotient_poly_compute_time_ms` |  104.86 |  104.86 |  104.86 |  104.86 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  2,823 |  2,823 |  2,823 |  2,823 |
| `main_cells_used     ` |  29,404,728 |  29,404,728 |  29,404,728 |  29,404,728 |
| `total_cells_used    ` |  71,174,330 |  71,174,330 |  71,174,330 |  71,174,330 |
| `execute_preflight_insns` |  2,934,812 |  2,934,812 |  2,934,812 |  2,934,812 |
| `execute_preflight_time_ms` |  422 |  422 |  422 |  422 |
| `execute_preflight_insn_mi/s` |  7.43 | -          |  7.43 |  7.43 |
| `trace_gen_time_ms   ` |  242 |  242 |  242 |  242 |
| `memory_finalize_time_ms` |  22 |  22 |  22 |  22 |
| `stark_prove_excluding_trace_time_ms` |  2,158 |  2,158 |  2,158 |  2,158 |
| `main_trace_commit_time_ms` |  377 |  377 |  377 |  377 |
| `generate_perm_trace_time_ms` |  183 |  183 |  183 |  183 |
| `perm_trace_commit_time_ms` |  699.56 |  699.56 |  699.56 |  699.56 |
| `quotient_poly_compute_time_ms` |  465.44 |  465.44 |  465.44 |  465.44 |
| `quotient_poly_commit_time_ms` |  106.75 |  106.75 |  106.75 |  106.75 |
| `pcs_opening_time_ms ` |  318 |  318 |  318 |  318 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program |  | 748 |  | 1 | 6 | 122,859 | 19.79 | 0 | 
| leaf | 2,826 |  | 1 | 1 |  |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 242 | 2,823 | 71,174,330 | 992,054,762 | 242 | 2,158 | 0 | 465.44 | 106.75 | 4 | 699.56 | 318 | 883 | 318 | 22 | 377 | 29,404,728 | 183 | 422 | 2,934,812 | 7.43 | 135 | 579 | 9 | 318 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 215 | 748 | 11,345,240 | 31,789,298 | 215 | 305 | 0 | 104.86 | 9.20 | 7 | 34.20 | 53 | 99 | 53 | 0 | 37 | 2,263,998 | 58 | 58 | 122,859 | 2.26 | 21 | 114 | 2 | 53 | 

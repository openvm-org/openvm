...
| `total_proof_time_ms ` |  4,192.50 |  8,385 |  4,666 |  3,719 |
...
| `trace_gen_time_ms   ` |  984 |  1,968 |  1,185 |  783 |
| `stark_prove_excluding_trace_time_ms` |  2,867.50 |  5,735 |  3,103 |  2,632 |
| `main_trace_commit_time_ms` |  520 |  1,040 |  582 |  458 |
| `generate_perm_trace_time_ms` |  193 |  386 |  205 |  181 |
| `perm_trace_commit_time_ms` |  748.50 |  1,497 |  800 |  697 |
| `quotient_poly_compute_time_ms` |  395 |  790 |  420 |  370 |
| `quotient_poly_commit_time_ms` |  298 |  596 |  333 |  263 |
| `pcs_opening_time_ms ` |  704.50 |  1,409 |  755 |  654 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,259.50 |  14,519 |  7,307 |  7,212 |
| `main_cells_used     ` |  152,277,757 |  304,555,514 |  154,677,634 |  149,877,880 |
| `total_cycles        ` |  1,990,991 |  3,981,982 |  2,021,820 |  1,960,162 |
| `execute_time_ms     ` |  753.50 |  1,507 |  762 |  745 |
| `trace_gen_time_ms   ` |  1,479 |  2,958 |  1,502 |  1,456 |
| `stark_prove_excluding_trace_time_ms` |  5,027 |  10,054 |  5,043 |  5,011 |
| `main_trace_commit_time_ms` |  806.50 |  1,613 |  809 |  804 |
| `generate_perm_trace_time_ms` |  364.50 |  729 |  366 |  363 |
| `perm_trace_commit_time_ms` |  1,531.50 |  3,063 |  1,565 |  1,498 |
| `quotient_poly_compute_time_ms` |  766 |  1,532 |  771 |  761 |
| `quotient_poly_commit_time_ms` |  492 |  984 |  493 |  491 |
| `pcs_opening_time_ms ` |  1,062.50 |  2,125 |  1,076 |  1,049 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,502 | 7,307 | 2,021,820 | 538,660,330 | 5,043 | 761 | 491 | 1,565 | 1,049 | 809 | 154,677,634 | 363 | 762 | 
| leaf | 1 | 1,456 | 7,212 | 1,960,162 | 538,660,330 | 5,011 | 771 | 493 | 1,498 | 1,076 | 804 | 149,877,880 | 366 | 745 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,185 | 4,666 | 2,243,715 | 275,652,919 | 3,103 | 420 | 333 | 800 | 755 | 582 | 93,500,799 | 205 | 378 | 
| regex_program | 1 | 783 | 3,719 | 1,921,511 | 242,975,404 | 2,632 | 370 | 263 | 697 | 654 | 458 | 73,010,353 | 181 | 304 | 

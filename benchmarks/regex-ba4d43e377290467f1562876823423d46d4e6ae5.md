...
| `total_proof_time_ms ` |  4,142.50 |  8,285 |  4,630 |  3,655 |
...
| `trace_gen_time_ms   ` |  962 |  1,924 |  1,184 |  740 |
| `stark_prove_excluding_trace_time_ms` |  2,841.50 |  5,683 |  3,069 |  2,614 |
| `main_trace_commit_time_ms` |  522.50 |  1,045 |  584 |  461 |
| `generate_perm_trace_time_ms` |  182.50 |  365 |  186 |  179 |
| `perm_trace_commit_time_ms` |  747.50 |  1,495 |  800 |  695 |
| `quotient_poly_compute_time_ms` |  394 |  788 |  423 |  365 |
| `quotient_poly_commit_time_ms` |  298.50 |  597 |  337 |  260 |
| `pcs_opening_time_ms ` |  686 |  1,372 |  729 |  643 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,542.50 |  15,085 |  7,577 |  7,508 |
| `main_cells_used     ` |  152,277,985 |  304,555,970 |  154,677,694 |  149,878,276 |
| `total_cycles        ` |  1,991,010 |  3,982,020 |  2,021,825 |  1,960,195 |
| `execute_time_ms     ` |  748.50 |  1,497 |  755 |  742 |
| `trace_gen_time_ms   ` |  1,486 |  2,972 |  1,491 |  1,481 |
| `stark_prove_excluding_trace_time_ms` |  5,308 |  10,616 |  5,331 |  5,285 |
| `main_trace_commit_time_ms` |  891 |  1,782 |  891 |  891 |
| `generate_perm_trace_time_ms` |  359 |  718 |  359 |  359 |
| `perm_trace_commit_time_ms` |  1,699.50 |  3,399 |  1,730 |  1,669 |
| `quotient_poly_compute_time_ms` |  769.50 |  1,539 |  773 |  766 |
| `quotient_poly_commit_time_ms` |  522 |  1,044 |  523 |  521 |
| `pcs_opening_time_ms ` |  1,063.50 |  2,127 |  1,067 |  1,060 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,491 | 7,577 | 2,021,825 | 538,660,330 | 5,331 | 766 | 521 | 1,730 | 1,060 | 891 | 154,677,694 | 359 | 755 | 
| leaf | 1 | 1,481 | 7,508 | 1,960,195 | 538,660,330 | 5,285 | 773 | 523 | 1,669 | 1,067 | 891 | 149,878,276 | 359 | 742 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,184 | 4,630 | 2,243,715 | 275,652,919 | 3,069 | 423 | 337 | 800 | 729 | 584 | 94,156,159 | 186 | 377 | 
| regex_program | 1 | 740 | 3,655 | 1,921,511 | 242,975,404 | 2,614 | 365 | 260 | 695 | 643 | 461 | 73,665,713 | 179 | 301 | 

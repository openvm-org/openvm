...
| `total_proof_time_ms ` |  1,495.50 |  2,991 |  1,715 |  1,276 |
...
| `execute_metered_insn_mi/s` |  90.67 | -          |  90.67 |  90.67 |
| `execute_preflight_insns` |  2,054,241.50 |  4,108,483 |  2,211,000 |  1,897,483 |
| `execute_preflight_time_ms` |  98 |  196 |  110 |  86 |
| `execute_preflight_insn_mi/s` |  29.89 | -          |  31.64 |  28.13 |
| `trace_gen_time_ms   ` |  310.50 |  621 |  333 |  288 |
| `memory_finalize_time_ms` |  2 |  4 |  4 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  999 |  1,998 |  1,213 |  785 |
| `main_trace_commit_time_ms` |  141.50 |  283 |  185 |  98 |
| `generate_perm_trace_time_ms` |  59 |  118 |  63 |  55 |
| `perm_trace_commit_time_ms` |  172.63 |  345.26 |  224.37 |  120.88 |
| `quotient_poly_compute_time_ms` |  161.49 |  322.97 |  175.95 |  147.02 |
| `quotient_poly_commit_time_ms` |  36.89 |  73.78 |  48.57 |  25.21 |
| `pcs_opening_time_ms ` |  420.50 |  841 |  541 |  300 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  2,075.50 |  4,151 |  2,858 |  1,293 |
| `main_cells_used     ` |  14,798,849 |  29,597,698 |  20,272,474 |  9,325,224 |
| `total_cells_used    ` |  37,032,585 |  74,065,170 |  50,586,080 |  23,479,090 |
| `execute_preflight_insns` |  1,663,334 |  3,326,668 |  1,830,003 |  1,496,665 |
| `execute_preflight_time_ms` |  580.50 |  1,161 |  899 |  262 |
| `execute_preflight_insn_mi/s` |  7.05 | -          |  7.36 |  6.75 |
| `trace_gen_time_ms   ` |  124.50 |  249 |  174 |  75 |
| `memory_finalize_time_ms` |  12.50 |  25 |  18 |  7 |
| `stark_prove_excluding_trace_time_ms` |  1,369.50 |  2,739 |  1,784 |  955 |
| `main_trace_commit_time_ms` |  180 |  360 |  228 |  132 |
| `generate_perm_trace_time_ms` |  86.50 |  173 |  117 |  56 |
| `perm_trace_commit_time_ms` |  277.37 |  554.74 |  367.62 |  187.12 |
| `quotient_poly_compute_time_ms` |  176.41 |  352.82 |  225.98 |  126.84 |
| `quotient_poly_commit_time_ms` |  43.50 |  87 |  57.10 |  29.90 |
| `pcs_opening_time_ms ` |  601.50 |  1,203 |  783 |  420 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 2,860 |  | 1 |  | 1 |  |  |  |  | 
| regex_program |  | 1,276 |  | 41 | 1 | 45 | 4,108,483 | 90.67 | 167 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 75 | 1,293 | 23,479,090 | 319,626,730 | 75 | 955 | 0 | 126.84 | 29.90 | 4 | 187.12 | 420 | 244 | 420 | 7 | 132 | 9,325,224 | 56 | 262 | 1,496,665 | 7.36 | 29 | 157 | 1 | 420 | 
| leaf | 1 | 174 | 2,858 | 50,586,080 | 538,660,330 | 174 | 1,784 | 0 | 225.98 | 57.10 | 5 | 367.62 | 783 | 486 | 783 | 18 | 228 | 20,272,474 | 117 | 899 | 1,830,003 | 6.75 | 56 | 285 | 1 | 783 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 288 | 1,715 | 23,397,108 | 373,183,036 | 288 | 1,213 | 0 | 147.02 | 48.57 | 6 | 224.37 | 541 | 289 | 541 | 4 | 185 | 10,866,434 | 63 | 86 | 2,211,000 | 28.13 | 46 | 197 | 2 | 541 | 
| regex_program | 1 | 333 | 1,276 | 11,981,356 | 196,739,722 | 333 | 785 | 2 | 175.95 | 25.21 | 6 | 120.88 | 300 | 179 | 300 | 0 | 98 | 2,537,170 | 55 | 110 | 1,897,483 | 31.64 | 26 | 206 | 2 | 300 | 

...
| `execute_preflight_insn_mi/s` |  2.16 | -          |  2.16 |  2.16 |
...
| `quotient_poly_compute_time_ms` |  102.33 |  102.33 |  102.33 |  102.33 |
| `quotient_poly_commit_time_ms` |  9.13 |  9.13 |  9.13 |  9.13 |
| `pcs_opening_time_ms ` |  77 |  77 |  77 |  77 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  2,762 |  2,762 |  2,762 |  2,762 |
| `main_cells_used     ` |  29,404,728 |  29,404,728 |  29,404,728 |  29,404,728 |
| `total_cells_used    ` |  71,174,330 |  71,174,330 |  71,174,330 |  71,174,330 |
| `execute_preflight_insns` |  2,934,817 |  2,934,817 |  2,934,817 |  2,934,817 |
| `execute_preflight_time_ms` |  431 |  431 |  431 |  431 |
| `execute_preflight_insn_mi/s` |  7.25 | -          |  7.25 |  7.25 |
| `trace_gen_time_ms   ` |  236 |  236 |  236 |  236 |
| `memory_finalize_time_ms` |  22 |  22 |  22 |  22 |
| `stark_prove_excluding_trace_time_ms` |  2,094 |  2,094 |  2,094 |  2,094 |
| `main_trace_commit_time_ms` |  375 |  375 |  375 |  375 |
| `generate_perm_trace_time_ms` |  181 |  181 |  181 |  181 |
| `perm_trace_commit_time_ms` |  695.28 |  695.28 |  695.28 |  695.28 |
| `quotient_poly_compute_time_ms` |  437.59 |  437.59 |  437.59 |  437.59 |
| `quotient_poly_commit_time_ms` |  103.79 |  103.79 |  103.79 |  103.79 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program |  | 721 |  | 1 | 6 | 122,859 | 19.71 | 0 | 
| leaf | 2,765 |  | 1 | 1 |  |  |  |  | 
...
| leaf | 8 | FriReducedOpeningAir | 0 | 4,194,304 |  | 84 | 27 | 465,567,744 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 236 | 2,762 | 71,174,330 | 992,054,762 | 236 | 2,094 | 0 | 437.59 | 103.79 | 4 | 695.28 | 293 | 877 | 293 | 22 | 375 | 29,404,728 | 181 | 431 | 2,934,817 | 7.25 | 135 | 548 | 9 | 293 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 211 | 721 | 11,344,654 | 31,789,298 | 211 | 305 | 0 | 102.33 | 9.13 | 7 | 34.17 | 77 | 79 | 76 | 0 | 37 | 2,262,772 | 37 | 61 | 122,859 | 2.16 | 21 | 111 | 2 | 76 | 

...
|:---|---:|---:|---:|
| Total |  19.10 |  10.58 | 10.58 |
| fibonacci_program |  7.68 |  4.33 |  4.33 |
| leaf |  11.43 |  6.24 |  6.24 |


| fibonacci_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  3,834 |  7,668 |  4,325 |  3,343 |
...
| `execute_preflight_insn_mi/s` |  37.99 | -          |  38.14 |  37.84 |
| `trace_gen_time_ms   ` |  194.50 |  389 |  197 |  192 |
| `memory_finalize_time_ms` | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  3,507.50 |  7,015 |  3,933 |  3,082 |
| `main_trace_commit_time_ms` |  31 |  62 |  33 |  29 |
| `generate_perm_trace_time_ms` |  41.50 |  83 |  48 |  35 |
| `perm_trace_commit_time_ms` |  41.06 |  82.11 |  44.12 |  37.99 |
| `quotient_poly_compute_time_ms` |  32.41 |  64.81 |  34.34 |  30.47 |
| `quotient_poly_commit_time_ms` |  12.84 |  25.68 |  13.10 |  12.58 |
| `pcs_opening_time_ms ` |  3,346.50 |  6,693 |  3,758 |  2,935 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  5,713 |  11,426 |  6,244 |  5,182 |
| `main_cells_used     ` |  9,914,556 |  19,829,112 |  10,125,186 |  9,703,926 |
| `total_cells_used    ` |  25,902,618 |  51,805,236 |  26,406,284 |  25,398,952 |
| `execute_preflight_insns` |  2,000,077.50 |  4,000,155 |  2,061,897 |  1,938,258 |
| `execute_preflight_time_ms` |  893.50 |  1,787 |  1,418 |  369 |
| `execute_preflight_insn_mi/s` |  5.92 | -          |  6.01 |  5.83 |
| `trace_gen_time_ms   ` |  93.50 |  187 |  98 |  89 |
| `memory_finalize_time_ms` |  9 |  18 |  10 |  8 |
| `stark_prove_excluding_trace_time_ms` |  4,724.50 |  9,449 |  4,735 |  4,714 |
| `main_trace_commit_time_ms` |  132.50 |  265 |  133 |  132 |
| `generate_perm_trace_time_ms` |  74 |  148 |  98 |  50 |
| `perm_trace_commit_time_ms` |  184.51 |  369.02 |  184.55 |  184.48 |
| `quotient_poly_compute_time_ms` |  146.59 |  293.17 |  146.99 |  146.19 |
| `quotient_poly_commit_time_ms` |  28.89 |  57.78 |  28.91 |  28.87 |
| `pcs_opening_time_ms ` |  4,154.50 |  8,309 |  4,189 |  4,120 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program |  | 3,343 |  | 1 | 9 | 1,500,209 | 160.76 | 0 | 
| leaf | 6,246 |  | 1 | 1 |  |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 98 | 5,182 | 26,406,284 | 342,564,330 | 98 | 4,714 | 0 | 146.19 | 28.87 | 6 | 184.48 | 4,120 | 283 | 4,120 | 10 | 133 | 10,125,186 | 98 | 369 | 2,061,897 | 6.01 | 33 | 176 | 0 | 4,120 | 
| leaf | 1 | 89 | 6,244 | 25,398,952 | 342,564,330 | 89 | 4,735 | 0 | 146.99 | 28.91 | 6 | 184.55 | 4,189 | 236 | 4,189 | 8 | 132 | 9,703,926 | 50 | 1,418 | 1,938,258 | 5.83 | 32 | 177 | 0 | 4,189 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 192 | 4,325 | 9,677,708 | 84,395,212 | 192 | 3,933 | 0 | 34.34 | 13.10 | 6 | 44.12 | 3,758 | 93 | 3,758 | 0 | 33 | 1,035,986 | 48 | 32 | 873,000 | 38.14 | 14 | 47 | 0 | 3,758 | 
| fibonacci_program | 1 | 197 | 3,343 | 9,708,170 | 74,305,770 | 197 | 3,082 | 1 | 30.47 | 12.58 | 6 | 37.99 | 2,935 | 73 | 2,935 | 0 | 29 | 1,064,416 | 35 | 22 | 627,209 | 37.84 | 12 | 43 | 0 | 2,935 | 

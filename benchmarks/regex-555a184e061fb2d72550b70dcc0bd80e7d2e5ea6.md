...
| `total_proof_time_ms ` |  3,864 |  7,728 |  4,444 |  3,284 |
| `main_cells_used     ` |  83,723,935.50 |  167,447,871 |  93,738,635 |  73,709,236 |
| `total_cycles        ` |  2,070,213.50 |  4,140,427 |  2,225,434 |  1,914,993 |
| `execute_time_ms     ` |  337 |  674 |  373 |  301 |
| `trace_gen_time_ms   ` |  958 |  1,916 |  1,129 |  787 |
| `stark_prove_excluding_trace_time_ms` |  2,569 |  5,138 |  2,942 |  2,196 |
| `main_trace_commit_time_ms` |  451 |  902 |  535 |  367 |
| `generate_perm_trace_time_ms` |  172 |  344 |  197 |  147 |
| `perm_trace_commit_time_ms` |  646.50 |  1,293 |  749 |  544 |
| `quotient_poly_compute_time_ms` |  360 |  720 |  416 |  304 |
| `quotient_poly_commit_time_ms` |  272 |  544 |  317 |  227 |
| `pcs_opening_time_ms ` |  657.50 |  1,315 |  718 |  597 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,537 |  15,074 |  7,613 |  7,461 |
| `main_cells_used     ` |  152,702,515.50 |  305,405,031 |  155,161,394 |  150,243,637 |
| `total_cycles        ` |  1,990,827.50 |  3,981,655 |  2,021,607 |  1,960,048 |
| `execute_time_ms     ` |  761 |  1,522 |  769 |  753 |
| `trace_gen_time_ms   ` |  1,475 |  2,950 |  1,529 |  1,421 |
| `stark_prove_excluding_trace_time_ms` |  5,301 |  10,602 |  5,315 |  5,287 |
| `main_trace_commit_time_ms` |  893.50 |  1,787 |  894 |  893 |
| `generate_perm_trace_time_ms` |  344 |  688 |  347 |  341 |
| `perm_trace_commit_time_ms` |  1,678.50 |  3,357 |  1,716 |  1,641 |
| `quotient_poly_compute_time_ms` |  757.50 |  1,515 |  758 |  757 |
| `quotient_poly_commit_time_ms` |  522 |  1,044 |  522 |  522 |
| `pcs_opening_time_ms ` |  1,100.50 |  2,201 |  1,128 |  1,073 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,529 | 7,613 | 2,021,607 | 538,660,330 | 5,315 | 757 | 522 | 1,716 | 1,073 | 894 | 155,161,394 | 347 | 769 | 
| leaf | 1 | 1,421 | 7,461 | 1,960,048 | 538,660,330 | 5,287 | 758 | 522 | 1,641 | 1,128 | 893 | 150,243,637 | 341 | 753 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,129 | 4,444 | 2,225,434 | 275,652,919 | 2,942 | 416 | 317 | 749 | 718 | 535 | 93,738,635 | 197 | 373 | 
| regex_program | 1 | 787 | 3,284 | 1,914,993 | 198,099,628 | 2,196 | 304 | 227 | 544 | 597 | 367 | 73,709,236 | 147 | 301 | 

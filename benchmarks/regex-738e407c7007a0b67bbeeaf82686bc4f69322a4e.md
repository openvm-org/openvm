...
| `total_proof_time_ms ` |  4,039 |  8,078 |  4,518 |  3,560 |
| `main_cells_used     ` |  83,255,576 |  166,511,152 |  93,500,799 |  73,010,353 |
| `total_cycles        ` |  2,082,613 |  4,165,226 |  2,243,715 |  1,921,511 |
| `execute_time_ms     ` |  339.50 |  679 |  379 |  300 |
| `trace_gen_time_ms   ` |  966 |  1,932 |  1,172 |  760 |
| `stark_prove_excluding_trace_time_ms` |  2,733.50 |  5,467 |  2,967 |  2,500 |
| `main_trace_commit_time_ms` |  469 |  938 |  527 |  411 |
| `generate_perm_trace_time_ms` |  196 |  392 |  204 |  188 |
| `perm_trace_commit_time_ms` |  691.50 |  1,383 |  745 |  638 |
| `quotient_poly_compute_time_ms` |  392.50 |  785 |  421 |  364 |
| `quotient_poly_commit_time_ms` |  280.50 |  561 |  317 |  244 |
| `pcs_opening_time_ms ` |  695 |  1,390 |  745 |  645 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,291 |  14,582 |  7,393 |  7,189 |
| `main_cells_used     ` |  152,278,393 |  304,556,786 |  154,677,718 |  149,879,068 |
| `total_cycles        ` |  1,991,044 |  3,982,088 |  2,021,827 |  1,960,261 |
| `execute_time_ms     ` |  771 |  1,542 |  781 |  761 |
| `trace_gen_time_ms   ` |  1,482.50 |  2,965 |  1,516 |  1,449 |
| `stark_prove_excluding_trace_time_ms` |  5,037.50 |  10,075 |  5,096 |  4,979 |
| `main_trace_commit_time_ms` |  808.50 |  1,617 |  810 |  807 |
| `generate_perm_trace_time_ms` |  377 |  754 |  384 |  370 |
| `perm_trace_commit_time_ms` |  1,537.50 |  3,075 |  1,580 |  1,495 |
| `quotient_poly_compute_time_ms` |  768 |  1,536 |  769 |  767 |
| `quotient_poly_commit_time_ms` |  492.50 |  985 |  493 |  492 |
| `pcs_opening_time_ms ` |  1,050 |  2,100 |  1,058 |  1,042 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,516 | 7,393 | 2,021,827 | 538,660,330 | 5,096 | 767 | 493 | 1,580 | 1,058 | 810 | 154,677,718 | 384 | 781 | 
| leaf | 1 | 1,449 | 7,189 | 1,960,261 | 538,660,330 | 4,979 | 769 | 492 | 1,495 | 1,042 | 807 | 149,879,068 | 370 | 761 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,172 | 4,518 | 2,243,715 | 275,652,919 | 2,967 | 421 | 317 | 745 | 745 | 527 | 93,500,799 | 204 | 379 | 
| regex_program | 1 | 760 | 3,560 | 1,921,511 | 242,975,404 | 2,500 | 364 | 244 | 638 | 645 | 411 | 73,010,353 | 188 | 300 | 

...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  18,532 |  18,532 |  18,532 |  18,532 |
| `main_cells_used     ` |  193,208,066 |  193,208,066 |  193,208,066 |  193,208,066 |
| `total_cycles        ` |  4,156,088 |  4,156,088 |  4,156,088 |  4,156,088 |
| `execute_time_ms     ` |  964 |  964 |  964 |  964 |
| `trace_gen_time_ms   ` |  3,504 |  3,504 |  3,504 |  3,504 |
| `stark_prove_excluding_trace_time_ms` |  14,064 |  14,064 |  14,064 |  14,064 |
| `main_trace_commit_time_ms` |  2,939 |  2,939 |  2,939 |  2,939 |
| `generate_perm_trace_time_ms` |  362 |  362 |  362 |  362 |
| `perm_trace_commit_time_ms` |  2,907 |  2,907 |  2,907 |  2,907 |
| `quotient_poly_compute_time_ms` |  2,103 |  2,103 |  2,103 |  2,103 |
| `quotient_poly_commit_time_ms` |  2,662 |  2,662 |  2,662 |  2,662 |
| `pcs_opening_time_ms ` |  3,087 |  3,087 |  3,087 |  3,087 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 3,504 | 18,532 | 4,156,088 | 466,306,008 | 14,064 | 2,103 | 2,662 | 2,907 | 3,087 | 2,939 | 193,208,066 | 362 | 964 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 261 | 2,584 | 285,401 | 38,415,035 | 2,174 | 229 | 483 | 357 | 665 | 395 | 15,075,033 | 32 | 149 | 

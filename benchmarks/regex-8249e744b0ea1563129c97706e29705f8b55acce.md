...
| `total_proof_time_ms ` |  3,764.50 |  7,529 |  4,149 |  3,380 |
| `main_cells_used     ` |  83,255,576 |  166,511,152 |  93,500,799 |  73,010,353 |
| `total_cycles        ` |  2,082,613 |  4,165,226 |  2,243,715 |  1,921,511 |
| `execute_time_ms     ` |  344 |  688 |  382 |  306 |
| `trace_gen_time_ms   ` |  996.50 |  1,993 |  1,163 |  830 |
| `stark_prove_excluding_trace_time_ms` |  2,424 |  4,848 |  2,604 |  2,244 |
| `main_trace_commit_time_ms` |  448 |  896 |  502 |  394 |
| `generate_perm_trace_time_ms` |  193 |  386 |  213 |  173 |
| `perm_trace_commit_time_ms` |  487.50 |  975 |  513 |  462 |
| `quotient_poly_compute_time_ms` |  334 |  668 |  359 |  309 |
| `quotient_poly_commit_time_ms` |  232.50 |  465 |  273 |  192 |
| `pcs_opening_time_ms ` |  720 |  1,440 |  735 |  705 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  6,632 |  13,264 |  6,670 |  6,594 |
| `main_cells_used     ` |  152,278,043 |  304,556,086 |  154,677,614 |  149,878,472 |
| `total_cycles        ` |  1,990,989.50 |  3,981,979 |  2,021,793 |  1,960,186 |
| `execute_time_ms     ` |  768.50 |  1,537 |  780 |  757 |
| `trace_gen_time_ms   ` |  1,487.50 |  2,975 |  1,495 |  1,480 |
| `stark_prove_excluding_trace_time_ms` |  4,376 |  8,752 |  4,395 |  4,357 |
| `main_trace_commit_time_ms` |  776.50 |  1,553 |  777 |  776 |
| `generate_perm_trace_time_ms` |  390 |  780 |  400 |  380 |
| `perm_trace_commit_time_ms` |  1,110 |  2,220 |  1,111 |  1,109 |
| `quotient_poly_compute_time_ms` |  659 |  1,318 |  660 |  658 |
| `quotient_poly_commit_time_ms` |  385 |  770 |  385 |  385 |
| `pcs_opening_time_ms ` |  1,051 |  2,102 |  1,060 |  1,042 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,495 | 6,670 | 2,021,793 | 538,660,330 | 4,395 | 660 | 385 | 1,109 | 1,060 | 777 | 154,677,614 | 400 | 780 | 
| leaf | 1 | 1,480 | 6,594 | 1,960,186 | 538,660,330 | 4,357 | 658 | 385 | 1,111 | 1,042 | 776 | 149,878,472 | 380 | 757 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,163 | 4,149 | 2,243,715 | 275,652,919 | 2,604 | 359 | 273 | 513 | 735 | 502 | 93,500,799 | 213 | 382 | 
| regex_program | 1 | 830 | 3,380 | 1,921,511 | 242,975,404 | 2,244 | 309 | 192 | 462 | 705 | 394 | 73,010,353 | 173 | 306 | 

...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  11,344 |  11,344 |  11,344 |  11,344 |
| `main_cells_used     ` |  117,321,216 |  117,321,216 |  117,321,216 |  117,321,216 |
| `total_cycles        ` |  1,604,044 |  1,604,044 |  1,604,044 |  1,604,044 |
| `execute_time_ms     ` |  592 |  592 |  592 |  592 |
| `trace_gen_time_ms   ` |  1,542 |  1,542 |  1,542 |  1,542 |
| `stark_prove_excluding_trace_time_ms` |  9,210 |  9,210 |  9,210 |  9,210 |
| `main_trace_commit_time_ms` |  1,885 |  1,885 |  1,885 |  1,885 |
| `generate_perm_trace_time_ms` |  260 |  260 |  260 |  260 |
| `perm_trace_commit_time_ms` |  2,020 |  2,020 |  2,020 |  2,020 |
| `quotient_poly_compute_time_ms` |  1,460 |  1,460 |  1,460 |  1,460 |
| `quotient_poly_commit_time_ms` |  1,695 |  1,695 |  1,695 |  1,695 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,542 | 11,344 | 1,604,044 | 334,709,720 | 9,210 | 1,460 | 1,695 | 2,020 | 1,885 | 1,885 | 117,321,216 | 260 | 592 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 187 | 2,496 | 284,567 | 38,417,467 | 2,163 | 228 | 476 | 359 | 662 | 392 | 15,055,723 | 34 | 146 | 

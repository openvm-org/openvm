...
| `total_proof_time_ms ` |  3,695.50 |  7,391 |  4,082 |  3,309 |
...
| `trace_gen_time_ms   ` |  967 |  1,934 |  1,127 |  807 |
| `stark_prove_excluding_trace_time_ms` |  2,390.50 |  4,781 |  2,579 |  2,202 |
| `main_trace_commit_time_ms` |  451.50 |  903 |  501 |  402 |
| `generate_perm_trace_time_ms` |  190.50 |  381 |  209 |  172 |
| `perm_trace_commit_time_ms` |  486.50 |  973 |  514 |  459 |
| `quotient_poly_compute_time_ms` |  334 |  668 |  357 |  311 |
| `quotient_poly_commit_time_ms` |  228.50 |  457 |  264 |  193 |
| `pcs_opening_time_ms ` |  690 |  1,380 |  724 |  656 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  6,641 |  13,282 |  6,690 |  6,592 |
| `main_cells_used     ` |  152,278,757 |  304,557,514 |  154,678,502 |  149,879,012 |
| `total_cycles        ` |  1,991,049 |  3,982,098 |  2,021,867 |  1,960,231 |
| `execute_time_ms     ` |  772 |  1,544 |  780 |  764 |
| `trace_gen_time_ms   ` |  1,514.50 |  3,029 |  1,530 |  1,499 |
| `stark_prove_excluding_trace_time_ms` |  4,354.50 |  8,709 |  4,380 |  4,329 |
| `main_trace_commit_time_ms` |  778 |  1,556 |  779 |  777 |
| `generate_perm_trace_time_ms` |  379.50 |  759 |  395 |  364 |
| `perm_trace_commit_time_ms` |  1,110.50 |  2,221 |  1,124 |  1,097 |
| `quotient_poly_compute_time_ms` |  660 |  1,320 |  661 |  659 |
| `quotient_poly_commit_time_ms` |  378.50 |  757 |  381 |  376 |
| `pcs_opening_time_ms ` |  1,043.50 |  2,087 |  1,051 |  1,036 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,530 | 6,690 | 2,021,867 | 538,660,330 | 4,380 | 661 | 381 | 1,124 | 1,036 | 779 | 154,678,502 | 395 | 780 | 
| leaf | 1 | 1,499 | 6,592 | 1,960,231 | 538,660,330 | 4,329 | 659 | 376 | 1,097 | 1,051 | 777 | 149,879,012 | 364 | 764 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,127 | 4,082 | 2,243,715 | 275,652,919 | 2,579 | 357 | 264 | 514 | 724 | 501 | 93,500,799 | 209 | 376 | 
| regex_program | 1 | 807 | 3,309 | 1,921,511 | 242,975,404 | 2,202 | 311 | 193 | 459 | 656 | 402 | 73,010,353 | 172 | 300 | 

...
| `execute_metered_insn_mi/s` |  20.60 | -          |  20.60 |  20.60 |
...
| `stark_prove_excluding_trace_time_ms` |  992 |  992 |  992 |  992 |
| `main_trace_commit_time_ms` |  150 |  150 |  150 |  150 |
| `generate_perm_trace_time_ms` |  29 |  29 |  29 |  29 |
| `perm_trace_commit_time_ms` |  139 |  139 |  139 |  139 |
| `quotient_poly_compute_time_ms` |  79 |  79 |  79 |  79 |
| `quotient_poly_commit_time_ms` |  135 |  135 |  135 |  135 |
| `pcs_opening_time_ms ` |  444 |  444 |  444 |  444 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  10,831 |  10,831 |  10,831 |  10,831 |
| `main_cells_used     ` |  247,226,226 |  247,226,226 |  247,226,226 |  247,226,226 |
| `total_cells_used    ` |  646,605,412 |  646,605,412 |  646,605,412 |  646,605,412 |
| `execute_preflight_insns` |  2,934,874 |  2,934,874 |  2,934,874 |  2,934,874 |
| `execute_preflight_time_ms` |  573 |  573 |  573 |  573 |
| `execute_preflight_insn_mi/s` |  5.35 | -          |  5.35 |  5.35 |
| `trace_gen_time_ms   ` |  600 |  600 |  600 |  600 |
| `memory_finalize_time_ms` |  15 |  15 |  15 |  15 |
| `stark_prove_excluding_trace_time_ms` |  8,595 |  8,595 |  8,595 |  8,595 |
| `main_trace_commit_time_ms` |  1,662 |  1,662 |  1,662 |  1,662 |
| `generate_perm_trace_time_ms` |  783 |  783 |  783 |  783 |
| `perm_trace_commit_time_ms` |  2,311 |  2,311 |  2,311 |  2,311 |
| `quotient_poly_compute_time_ms` |  903 |  903 |  903 |  903 |
| `quotient_poly_commit_time_ms` |  704 |  704 |  704 |  704 |
| `pcs_opening_time_ms ` |  2,227 |  2,227 |  2,227 |  2,227 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program |  | 1,418 |  | 6 | 1 | 6 | 140,487 | 20.60 | 38 | 
| leaf | 10,833 |  | 1 |  | 1 |  |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 600 | 10,831 | 646,605,412 | 992,054,762 | 600 | 8,595 | 1 | 903 | 704 | 2,311 | 2,227 | 15 | 1,662 | 247,226,226 | 783 | 573 | 2,934,874 | 5.35 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 95 | 1,418 | 26,518,220 | 32,927,986 | 94 | 992 | 0 | 79 | 135 | 139 | 444 | 7 | 2 | 150 | 8,866,654 | 29 | 83 | 140,487 | 1.82 | 

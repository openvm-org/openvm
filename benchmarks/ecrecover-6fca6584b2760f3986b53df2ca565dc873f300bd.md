...
| `stark_prove_excluding_trace_time_ms` |  2,141 |  2,141 |  2,141 |  2,141 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  11,158 |  11,158 |  11,158 |  11,158 |
...
| `trace_gen_time_ms   ` |  1,520 |  1,520 |  1,520 |  1,520 |
| `stark_prove_excluding_trace_time_ms` |  9,073 |  9,073 |  9,073 |  9,073 |
| `main_trace_commit_time_ms` |  1,888 |  1,888 |  1,888 |  1,888 |
| `generate_perm_trace_time_ms` |  265 |  265 |  265 |  265 |
| `perm_trace_commit_time_ms` |  2,027 |  2,027 |  2,027 |  2,027 |
| `quotient_poly_compute_time_ms` |  1,436 |  1,436 |  1,436 |  1,436 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,520 | 11,158 | 1,603,998 | 334,709,720 | 9,073 | 1,436 | 1,655 | 2,027 | 1,798 | 1,888 | 117,320,802 | 265 | 565 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 173 | 2,461 | 284,567 | 38,417,467 | 2,141 | 228 | 472 | 350 | 664 | 381 | 15,055,723 | 34 | 147 | 

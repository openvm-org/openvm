...
| `total_proof_time_ms ` |  6,862.50 |  13,725 |  7,741 |  5,984 |
| `main_cells_used     ` |  82,727,686.50 |  165,455,373 |  92,686,348 |  72,769,025 |
| `total_cycles        ` |  1,914,103 |  1,914,103 |  1,914,103 |  1,914,103 |
| `execute_time_ms     ` |  440.50 |  881 |  474 |  407 |
| `trace_gen_time_ms   ` |  1,084.50 |  2,169 |  1,234 |  935 |
| `stark_prove_excluding_trace_time_ms` |  5,337.50 |  10,675 |  6,033 |  4,642 |
| `main_trace_commit_time_ms` |  1,022.50 |  2,045 |  1,262 |  783 |
| `generate_perm_trace_time_ms` |  184 |  368 |  214 |  154 |
| `perm_trace_commit_time_ms` |  1,119.50 |  2,239 |  1,190 |  1,049 |
| `quotient_poly_compute_time_ms` |  740 |  1,480 |  850 |  630 |
| `quotient_poly_commit_time_ms` |  948 |  1,896 |  1,095 |  801 |
| `pcs_opening_time_ms ` |  1,313 |  2,626 |  1,414 |  1,212 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  8,037.50 |  16,075 |  8,228 |  7,847 |
| `main_cells_used     ` |  77,286,998 |  154,573,996 |  78,374,999 |  76,198,997 |
| `total_cycles        ` |  1,028,190 |  2,056,380 |  1,045,599 |  1,010,781 |
| `execute_time_ms     ` |  379.50 |  759 |  424 |  335 |
| `trace_gen_time_ms   ` |  1,138.50 |  2,277 |  1,248 |  1,029 |
| `stark_prove_excluding_trace_time_ms` |  6,519.50 |  13,039 |  6,775 |  6,264 |
| `main_trace_commit_time_ms` |  1,339 |  2,678 |  1,389 |  1,289 |
| `generate_perm_trace_time_ms` |  166 |  332 |  176 |  156 |
| `perm_trace_commit_time_ms` |  1,318.50 |  2,637 |  1,373 |  1,264 |
| `quotient_poly_compute_time_ms` |  981.50 |  1,963 |  1,033 |  930 |
| `quotient_poly_commit_time_ms` |  1,284 |  2,568 |  1,336 |  1,232 |
| `pcs_opening_time_ms ` |  1,426 |  2,852 |  1,463 |  1,389 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,029 | 8,228 | 1,045,599 | 220,669,656 | 6,775 | 1,033 | 1,336 | 1,373 | 1,463 | 1,389 | 78,374,999 | 176 | 424 | 
| leaf | 1 | 1,248 | 7,847 | 1,010,781 | 194,986,968 | 6,264 | 930 | 1,232 | 1,264 | 1,389 | 1,289 | 76,198,997 | 156 | 335 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,234 | 7,741 |  | 209,921,543 | 6,033 | 850 | 1,095 | 1,190 | 1,414 | 1,262 | 92,686,348 | 214 | 474 | 
| regex_program | 1 | 935 | 5,984 | 1,914,103 | 149,454,692 | 4,642 | 630 | 801 | 1,049 | 1,212 | 783 | 72,769,025 | 154 | 407 | 

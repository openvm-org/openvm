...
| `trace_gen_time_ms   ` |  992 |  992 |  992 |  992 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  9,099 |  9,099 |  9,099 |  9,099 |
| `main_cells_used     ` |  205,525,550 |  205,525,550 |  205,525,550 |  205,525,550 |
| `total_cycles        ` |  2,574,547 |  2,574,547 |  2,574,547 |  2,574,547 |
| `execute_time_ms     ` |  985 |  985 |  985 |  985 |
| `trace_gen_time_ms   ` |  1,945 |  1,945 |  1,945 |  1,945 |
| `stark_prove_excluding_trace_time_ms` |  6,169 |  6,169 |  6,169 |  6,169 |
| `main_trace_commit_time_ms` |  1,242 |  1,242 |  1,242 |  1,242 |
| `generate_perm_trace_time_ms` |  565 |  565 |  565 |  565 |
| `perm_trace_commit_time_ms` |  1,604 |  1,604 |  1,604 |  1,604 |
| `quotient_poly_compute_time_ms` |  749 |  749 |  749 |  749 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,945 | 9,099 | 2,574,547 | 759,926,250 | 6,169 | 749 | 496 | 1,604 | 1,509 | 1,242 | 205,525,550 | 565 | 985 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 992 | 4,670 | 1,857,264 | 304,937,591 | 3,025 | 347 | 289 | 615 | 894 | 639 | 97,048,631 | 229 | 653 | 

...
| `total_proof_time_ms ` |  3,864 |  7,728 |  4,469 |  3,259 |
...
| `trace_gen_time_ms   ` |  955.50 |  1,911 |  1,162 |  749 |
| `stark_prove_excluding_trace_time_ms` |  2,575.50 |  5,151 |  2,938 |  2,213 |
| `main_trace_commit_time_ms` |  449 |  898 |  527 |  371 |
...
| `quotient_poly_commit_time_ms` |  275.50 |  551 |  319 |  232 |
| `pcs_opening_time_ms ` |  664 |  1,328 |  727 |  601 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,270.50 |  14,541 |  7,323 |  7,218 |
| `main_cells_used     ` |  152,447,632.50 |  304,895,265 |  154,908,261 |  149,987,004 |
| `total_cycles        ` |  1,994,012.50 |  3,988,025 |  2,024,842 |  1,963,183 |
| `execute_time_ms     ` |  784 |  1,568 |  790 |  778 |
| `trace_gen_time_ms   ` |  1,424.50 |  2,849 |  1,441 |  1,408 |
| `stark_prove_excluding_trace_time_ms` |  5,062 |  10,124 |  5,092 |  5,032 |
| `main_trace_commit_time_ms` |  840.50 |  1,681 |  845 |  836 |
| `generate_perm_trace_time_ms` |  340 |  680 |  343 |  337 |
| `perm_trace_commit_time_ms` |  1,553 |  3,106 |  1,571 |  1,535 |
| `quotient_poly_compute_time_ms` |  767.50 |  1,535 |  770 |  765 |
| `quotient_poly_commit_time_ms` |  504.50 |  1,009 |  507 |  502 |
| `pcs_opening_time_ms ` |  1,050 |  2,100 |  1,054 |  1,046 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,441 | 7,323 | 2,024,842 | 534,072,810 | 5,092 | 770 | 502 | 1,571 | 1,054 | 845 | 154,908,261 | 343 | 790 | 
| leaf | 1 | 1,408 | 7,218 | 1,963,183 | 534,072,810 | 5,032 | 765 | 507 | 1,535 | 1,046 | 836 | 149,987,004 | 337 | 778 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,162 | 4,469 | 2,225,434 | 275,652,919 | 2,938 | 425 | 319 | 748 | 727 | 527 | 93,699,990 | 183 | 369 | 
| regex_program | 1 | 749 | 3,259 | 1,914,730 | 198,099,628 | 2,213 | 308 | 232 | 543 | 601 | 371 | 73,689,460 | 144 | 297 | 

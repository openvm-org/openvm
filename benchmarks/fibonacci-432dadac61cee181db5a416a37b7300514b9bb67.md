...
| `total_proof_time_ms ` |  491 |  982 |  555 |  427 |
...
| `execute_preflight_insn_mi/s` |  35.89 | -          |  37.27 |  34.52 |
| `trace_gen_time_ms   ` |  191 |  382 |  195 |  187 |
| `memory_finalize_time_ms` | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  178 |  356 |  191 |  165 |
| `main_trace_commit_time_ms` |  30.50 |  61 |  33 |  28 |
| `generate_perm_trace_time_ms` |  12.50 |  25 |  13 |  12 |
| `perm_trace_commit_time_ms` |  42.71 |  85.42 |  44.82 |  40.60 |
| `quotient_poly_compute_time_ms` |  30.37 |  60.73 |  31.13 |  29.61 |
| `quotient_poly_commit_time_ms` |  11.74 |  23.47 |  11.81 |  11.66 |
| `pcs_opening_time_ms ` |  48 |  96 |  55 |  41 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  982 |  1,964 |  1,232 |  732 |
| `main_cells_used     ` |  6,475,562 |  12,951,124 |  6,608,072 |  6,343,052 |
| `total_cells_used    ` |  17,568,644 |  35,137,288 |  17,887,054 |  17,250,234 |
| `execute_preflight_insns` |  1,190,367 |  2,380,734 |  1,229,568 |  1,151,166 |
| `execute_preflight_time_ms` |  492.50 |  985 |  790 |  195 |
| `execute_preflight_insn_mi/s` |  6.90 | -          |  7.06 |  6.73 |
| `trace_gen_time_ms   ` |  58 |  116 |  61 |  55 |
| `memory_finalize_time_ms` |  5.50 |  11 |  6 |  5 |
| `stark_prove_excluding_trace_time_ms` |  430 |  860 |  475 |  385 |
| `main_trace_commit_time_ms` |  84 |  168 |  91 |  77 |
| `generate_perm_trace_time_ms` |  30 |  60 |  33 |  27 |
| `perm_trace_commit_time_ms` |  125.39 |  250.78 |  142.63 |  108.15 |
| `quotient_poly_compute_time_ms` |  90.88 |  181.77 |  101.91 |  79.86 |
| `quotient_poly_commit_time_ms` |  21.93 |  43.87 |  24.50 |  19.37 |
| `pcs_opening_time_ms ` |  74.50 |  149 |  78 |  71 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program |  | 427 |  | 1 | 13 | 1,500,209 | 112.51 | 0 | 
| leaf | 1,233 |  | 1 | 1 |  |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 61 | 732 | 17,887,054 | 252,878,314 | 61 | 475 | 0 | 101.91 | 24.50 | 4 | 142.63 | 78 | 177 | 78 | 6 | 91 | 6,608,072 | 33 | 195 | 1,229,568 | 7.06 | 26 | 127 | 0 | 78 | 
| leaf | 1 | 55 | 1,232 | 17,250,234 | 207,789,546 | 55 | 385 | 0 | 79.86 | 19.37 | 4 | 108.15 | 71 | 136 | 71 | 5 | 77 | 6,343,052 | 27 | 790 | 1,151,166 | 6.73 | 22 | 100 | 0 | 71 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 195 | 555 | 9,677,708 | 84,395,212 | 195 | 191 | 0 | 31.13 | 11.81 | 4 | 44.82 | 55 | 58 | 55 | 0 | 33 | 1,035,986 | 13 | 26 | 873,000 | 34.52 | 13 | 43 | 0 | 55 | 
| fibonacci_program | 1 | 187 | 427 | 9,708,170 | 74,305,770 | 187 | 165 | 1 | 29.61 | 11.66 | 4 | 40.60 | 41 | 53 | 41 | 0 | 28 | 1,064,416 | 12 | 33 | 627,209 | 37.27 | 11 | 41 | 0 | 41 | 
...
Commit: https://github.com/openvm-org/openvm/commit/432dadac61cee181db5a416a37b7300514b9bb67
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19440284065)

...
| `perm_trace_commit_time_ms` |  527 |  527 |  527 |  527 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  21,564 |  21,564 |  21,564 |  21,564 |
| `main_cells_used     ` |  241,413,599 |  241,413,599 |  241,413,599 |  241,413,599 |
| `total_cycles        ` |  4,167,050 |  4,167,050 |  4,167,050 |  4,167,050 |
| `execute_time_ms     ` |  918 |  918 |  918 |  918 |
| `trace_gen_time_ms   ` |  3,855 |  3,855 |  3,855 |  3,855 |
| `stark_prove_excluding_trace_time_ms` |  16,791 |  16,791 |  16,791 |  16,791 |
| `main_trace_commit_time_ms` |  3,025 |  3,025 |  3,025 |  3,025 |
| `generate_perm_trace_time_ms` |  386 |  386 |  386 |  386 |
| `perm_trace_commit_time_ms` |  3,654 |  3,654 |  3,654 |  3,654 |
| `quotient_poly_compute_time_ms` |  4,461 |  4,461 |  4,461 |  4,461 |
| `quotient_poly_commit_time_ms` |  2,418 |  2,418 |  2,418 |  2,418 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 3,855 | 21,564 | 4,167,050 | 590,040,024 | 16,791 | 4,461 | 2,418 | 3,654 | 2,845 | 3,025 | 241,413,599 | 386 | 918 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 259 | 2,571 | 285,401 | 56,172,159 | 2,168 | 296 | 302 | 527 | 615 | 386 | 15,075,033 | 38 | 144 | 

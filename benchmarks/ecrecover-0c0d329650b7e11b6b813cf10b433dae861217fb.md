...
| `stark_prove_excluding_trace_time_ms` |  2,102 |  2,102 |  2,102 |  2,102 |
| `main_trace_commit_time_ms` |  392 |  392 |  392 |  392 |
| `generate_perm_trace_time_ms` |  41 |  41 |  41 |  41 |
| `perm_trace_commit_time_ms` |  544 |  544 |  544 |  544 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  19,459 |  19,459 |  19,459 |  19,459 |
| `main_cells_used     ` |  203,553,067 |  203,553,067 |  203,553,067 |  203,553,067 |
| `total_cycles        ` |  4,165,087 |  4,165,087 |  4,165,087 |  4,165,087 |
| `execute_time_ms     ` |  1,030 |  1,030 |  1,030 |  1,030 |
| `trace_gen_time_ms   ` |  3,615 |  3,615 |  3,615 |  3,615 |
| `stark_prove_excluding_trace_time_ms` |  14,814 |  14,814 |  14,814 |  14,814 |
| `main_trace_commit_time_ms` |  2,932 |  2,932 |  2,932 |  2,932 |
...
| `quotient_poly_commit_time_ms` |  2,572 |  2,572 |  2,572 |  2,572 |
| `pcs_opening_time_ms ` |  3,133 |  3,133 |  3,133 |  3,133 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 3,615 | 19,459 | 4,165,087 | 572,214,232 | 14,814 | 2,112 | 2,572 | 3,648 | 3,133 | 2,932 | 203,553,067 | 413 | 1,030 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 262 | 2,519 | 285,401 | 56,172,159 | 2,102 | 163 | 332 | 544 | 618 | 392 | 15,075,033 | 41 | 155 | 

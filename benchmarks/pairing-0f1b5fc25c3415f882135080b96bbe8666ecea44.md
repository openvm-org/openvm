...
| `total_proof_time_ms ` |  717 |  1,434 |  836 |  598 |
...
| `execute_preflight_insn_mi/s` |  15.06 | -          |  18.52 |  11.59 |
| `trace_gen_time_ms   ` |  186 |  372 |  204 |  168 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  344 |  688 |  382 |  306 |
| `main_trace_commit_time_ms` |  65 |  130 |  75 |  55 |
| `generate_perm_trace_time_ms` |  37 |  74 |  37 |  37 |
| `perm_trace_commit_time_ms` |  77.22 |  154.43 |  89.59 |  64.84 |
| `quotient_poly_compute_time_ms` |  82.30 |  164.59 |  91.25 |  73.34 |
| `quotient_poly_commit_time_ms` |  16.79 |  33.58 |  18.51 |  15.07 |
| `pcs_opening_time_ms ` |  60.50 |  121 |  65 |  56 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,488.50 |  2,977 |  1,768 |  1,209 |
| `main_cells_used     ` |  16,200,472 |  32,400,944 |  16,332,746 |  16,068,198 |
| `total_cells_used    ` |  39,332,920 |  78,665,840 |  39,650,868 |  39,014,972 |
| `execute_preflight_insns` |  1,952,430.50 |  3,904,861 |  1,991,930 |  1,912,931 |
| `execute_preflight_time_ms` |  596.50 |  1,193 |  885 |  308 |
| `execute_preflight_insn_mi/s` |  7.52 | -          |  7.52 |  7.52 |
| `trace_gen_time_ms   ` |  120 |  240 |  128 |  112 |
| `memory_finalize_time_ms` |  11 |  22 |  12 |  10 |
| `stark_prove_excluding_trace_time_ms` |  769.50 |  1,539 |  771 |  768 |
| `main_trace_commit_time_ms` |  146.50 |  293 |  151 |  142 |
| `generate_perm_trace_time_ms` |  70 |  140 |  84 |  56 |
| `perm_trace_commit_time_ms` |  226.65 |  453.31 |  231.40 |  221.90 |
| `quotient_poly_compute_time_ms` |  173.23 |  346.47 |  174.52 |  171.95 |
| `quotient_poly_commit_time_ms` |  32.78 |  65.56 |  34.07 |  31.48 |
| `pcs_opening_time_ms ` |  117 |  234 |  121 |  113 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 1,770 |  | 1 | 1 |  |  |  |  | 
| pairing |  | 598 |  | 1 | 63 | 1,745,742 | 27.62 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 128 | 1,209 | 39,650,868 | 410,701,290 | 128 | 771 | 0 | 174.52 | 34.07 | 4 | 231.40 | 121 | 288 | 121 | 12 | 151 | 16,332,746 | 56 | 308 | 1,991,930 | 7.52 | 39 | 210 | 0 | 121 | 
| leaf | 1 | 112 | 1,768 | 39,014,972 | 396,840,426 | 112 | 768 | 0 | 171.95 | 31.48 | 4 | 221.90 | 113 | 307 | 113 | 10 | 142 | 16,068,198 | 84 | 885 | 1,912,931 | 7.52 | 38 | 204 | 0 | 113 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 168 | 836 | 32,480,114 | 172,558,444 | 168 | 382 | 0 | 91.25 | 18.51 | 6 | 89.59 | 65 | 130 | 65 | 1 | 75 | 15,909,408 | 37 | 118 | 1,149,000 | 11.59 | 27 | 110 | 1 | 65 | 
| pairing | 1 | 204 | 598 | 22,464,232 | 119,958,502 | 204 | 306 | 1 | 73.34 | 15.07 | 6 | 64.84 | 56 | 104 | 56 | 0 | 55 | 9,498,894 | 37 | 47 | 596,742 | 18.52 | 21 | 89 | 1 | 56 | 

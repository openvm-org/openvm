...
| `total_proof_time_ms ` |  581.75 |  2,327 |  718 |  522 |
...
| `execute_metered_insn_mi/s` |  122.07 | -          |  122.07 |  122.07 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  54.25 |  217 |  69 |  44 |
| `execute_preflight_insn_mi/s` |  31.97 | -          |  33.33 |  28.44 |
| `trace_gen_time_ms   ` |  180 |  720 |  215 |  154 |
| `memory_finalize_time_ms` |  1 |  4 |  4 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  278.50 |  1,114 |  307 |  257 |
| `main_trace_commit_time_ms` |  51.50 |  206 |  57 |  49 |
| `generate_perm_trace_time_ms` |  24.50 |  98 |  29 |  18 |
| `perm_trace_commit_time_ms` |  64.100 |  259.100 |  71.46 |  55.43 |
| `quotient_poly_compute_time_ms` |  59.32 |  237.28 |  70.15 |  53.42 |
| `quotient_poly_commit_time_ms` |  15.01 |  60.04 |  16.65 |  13.16 |
| `pcs_opening_time_ms ` |  60 |  240 |  73 |  52 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,377.50 |  5,510 |  2,030 |  898 |
...
| `execute_preflight_insns` |  1,440,887.25 |  5,763,549 |  1,814,591 |  1,241,387 |
| `execute_preflight_time_ms` |  634.25 |  2,537 |  833 |  229 |
| `execute_preflight_insn_mi/s` |  6.90 | -          |  7.28 |  6.69 |
| `trace_gen_time_ms   ` |  89.50 |  358 |  174 |  57 |
| `memory_finalize_time_ms` |  8.25 |  33 |  16 |  5 |
| `stark_prove_excluding_trace_time_ms` |  652.50 |  2,610 |  1,065 |  471 |
| `main_trace_commit_time_ms` |  124.75 |  499 |  194 |  91 |
| `generate_perm_trace_time_ms` |  46.25 |  185 |  79 |  33 |
| `perm_trace_commit_time_ms` |  199.98 |  799.92 |  342.20 |  141.55 |
| `quotient_poly_compute_time_ms` |  141.85 |  567.41 |  231.36 |  101.56 |
| `quotient_poly_commit_time_ms` |  30.10 |  120.40 |  49.39 |  23.13 |
| `pcs_opening_time_ms ` |  105.75 |  423 |  163 |  75 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 2,032 |  | 1 |  | 1 |  |  |  |  | 
| regex_program |  | 555 |  | 66 | 1 | 33 | 4,137,502 | 122.07 | 194 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 70 | 898 | 22,981,570 | 319,331,818 | 70 | 598 | 0 | 132.18 | 24.53 | 4 | 172.91 | 104 | 213 | 104 | 6 | 122 | 9,122,488 | 39 | 229 | 1,466,043 | 7.28 | 30 | 157 | 0 | 104 | 
| leaf | 1 | 57 | 1,362 | 20,905,034 | 255,237,610 | 57 | 471 | 0 | 101.56 | 23.13 | 4 | 143.25 | 75 | 178 | 75 | 6 | 91 | 8,256,948 | 34 | 833 | 1,241,387 | 6.83 | 25 | 125 | 0 | 75 | 
| leaf | 2 | 57 | 1,220 | 20,905,034 | 255,237,610 | 57 | 476 | 0 | 102.31 | 23.34 | 4 | 141.55 | 81 | 175 | 81 | 5 | 92 | 8,256,948 | 33 | 685 | 1,241,528 | 6.82 | 26 | 126 | 0 | 81 | 
| leaf | 3 | 174 | 2,030 | 50,337,320 | 538,365,418 | 174 | 1,065 | 0 | 231.36 | 49.39 | 4 | 342.20 | 163 | 422 | 163 | 16 | 194 | 20,171,106 | 79 | 790 | 1,814,591 | 6.69 | 62 | 284 | 5 | 163 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 215 | 718 | 23,446,148 | 150,778,428 | 215 | 307 | 0 | 60.28 | 16.65 | 5 | 71.46 | 73 | 99 | 72 | 4 | 57 | 10,899,170 | 26 | 46 | 1,103,000 | 28.44 | 21 | 77 | 1 | 72 | 
| regex_program | 1 | 154 | 532 | 11,598,276 | 128,513,066 | 154 | 267 | 1 | 53.42 | 15.70 | 4 | 67.16 | 54 | 93 | 54 | 0 | 49 | 2,196,106 | 25 | 69 | 1,104,000 | 32.92 | 17 | 69 | 0 | 54 | 
| regex_program | 2 | 165 | 522 | 11,579,064 | 128,513,066 | 165 | 257 | 1 | 53.43 | 14.52 | 4 | 65.95 | 52 | 85 | 52 | 0 | 51 | 2,177,334 | 18 | 58 | 1,104,000 | 33.19 | 16 | 68 | 0 | 52 | 
| regex_program | 3 | 186 | 555 | 11,853,872 | 103,456,394 | 186 | 283 | 0 | 70.15 | 13.16 | 5 | 55.43 | 61 | 88 | 61 | 0 | 49 | 2,422,606 | 29 | 44 | 826,502 | 33.33 | 18 | 84 | 1 | 61 | 

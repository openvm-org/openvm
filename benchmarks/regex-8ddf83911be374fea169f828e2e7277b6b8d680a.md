...
| `total_proof_time_ms ` |  7,674.50 |  15,349 |  8,581 |  6,768 |
...
| `trace_gen_time_ms   ` |  1,689.50 |  3,379 |  1,877 |  1,502 |
| `stark_prove_excluding_trace_time_ms` |  5,531 |  11,062 |  6,215 |  4,847 |
| `main_trace_commit_time_ms` |  1,093.50 |  2,187 |  1,342 |  845 |
| `generate_perm_trace_time_ms` |  176.50 |  353 |  193 |  160 |
| `perm_trace_commit_time_ms` |  1,191.50 |  2,383 |  1,241 |  1,142 |
| `quotient_poly_compute_time_ms` |  739.50 |  1,479 |  862 |  617 |
| `quotient_poly_commit_time_ms` |  991.50 |  1,983 |  1,130 |  853 |
| `pcs_opening_time_ms ` |  1,326.50 |  2,653 |  1,439 |  1,214 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  14,703.50 |  29,407 |  14,857 |  14,550 |
| `main_cells_used     ` |  133,954,666 |  267,909,332 |  135,615,819 |  132,293,513 |
| `total_cycles        ` |  2,941,492.50 |  5,882,985 |  2,977,991 |  2,904,994 |
| `execute_time_ms     ` |  612 |  1,224 |  655 |  569 |
| `trace_gen_time_ms   ` |  2,672 |  5,344 |  2,838 |  2,506 |
| `stark_prove_excluding_trace_time_ms` |  11,419.50 |  22,839 |  11,450 |  11,389 |
| `main_trace_commit_time_ms` |  2,378.50 |  4,757 |  2,393 |  2,364 |
| `generate_perm_trace_time_ms` |  285.50 |  571 |  291 |  280 |
| `perm_trace_commit_time_ms` |  2,289.50 |  4,579 |  2,296 |  2,283 |
| `quotient_poly_compute_time_ms` |  1,668 |  3,336 |  1,689 |  1,647 |
| `quotient_poly_commit_time_ms` |  2,225 |  4,450 |  2,239 |  2,211 |
| `pcs_opening_time_ms ` |  2,568 |  5,136 |  2,576 |  2,560 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 2,506 | 14,550 | 2,977,991 | 360,326,872 | 11,389 | 1,647 | 2,211 | 2,296 | 2,576 | 2,364 | 135,615,819 | 291 | 655 | 
| leaf | 1 | 2,838 | 14,857 | 2,904,994 | 360,334,296 | 11,450 | 1,689 | 2,239 | 2,283 | 2,560 | 2,393 | 132,293,513 | 280 | 569 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,877 | 8,581 |  | 209,921,543 | 6,215 | 862 | 1,130 | 1,241 | 1,439 | 1,342 | 92,686,348 | 193 | 489 | 
| regex_program | 1 | 1,502 | 6,768 | 1,914,103 | 149,454,692 | 4,847 | 617 | 853 | 1,142 | 1,214 | 845 | 72,769,025 | 160 | 419 | 

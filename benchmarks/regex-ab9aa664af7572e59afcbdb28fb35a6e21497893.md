...
| `total_proof_time_ms ` |  4,129 |  8,258 |  4,578 |  3,680 |
| `main_cells_used     ` |  83,910,936 |  167,821,872 |  94,156,159 |  73,665,713 |
| `total_cycles        ` |  2,082,613 |  4,165,226 |  2,243,715 |  1,921,511 |
| `execute_time_ms     ` |  344.50 |  689 |  383 |  306 |
| `trace_gen_time_ms   ` |  937.50 |  1,875 |  1,122 |  753 |
| `stark_prove_excluding_trace_time_ms` |  2,847 |  5,694 |  3,073 |  2,621 |
| `main_trace_commit_time_ms` |  519 |  1,038 |  583 |  455 |
| `generate_perm_trace_time_ms` |  191 |  382 |  192 |  190 |
| `perm_trace_commit_time_ms` |  749.50 |  1,499 |  800 |  699 |
| `quotient_poly_compute_time_ms` |  397.50 |  795 |  427 |  368 |
| `quotient_poly_commit_time_ms` |  300.50 |  601 |  342 |  259 |
| `pcs_opening_time_ms ` |  679.50 |  1,359 |  719 |  640 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,526 |  15,052 |  7,578 |  7,474 |
| `main_cells_used     ` |  152,277,829 |  304,555,658 |  154,677,274 |  149,878,384 |
| `total_cycles        ` |  1,990,997 |  3,981,994 |  2,021,790 |  1,960,204 |
| `execute_time_ms     ` |  752.50 |  1,505 |  761 |  744 |
| `trace_gen_time_ms   ` |  1,509.50 |  3,019 |  1,529 |  1,490 |
| `stark_prove_excluding_trace_time_ms` |  5,264 |  10,528 |  5,288 |  5,240 |
| `main_trace_commit_time_ms` |  891.50 |  1,783 |  892 |  891 |
| `generate_perm_trace_time_ms` |  358.50 |  717 |  360 |  357 |
| `perm_trace_commit_time_ms` |  1,673 |  3,346 |  1,687 |  1,659 |
| `quotient_poly_compute_time_ms` |  767 |  1,534 |  769 |  765 |
| `quotient_poly_commit_time_ms` |  520.50 |  1,041 |  521 |  520 |
| `pcs_opening_time_ms ` |  1,049 |  2,098 |  1,055 |  1,043 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,529 | 7,578 | 2,021,790 | 538,660,330 | 5,288 | 769 | 520 | 1,687 | 1,055 | 892 | 154,677,274 | 360 | 761 | 
| leaf | 1 | 1,490 | 7,474 | 1,960,204 | 538,660,330 | 5,240 | 765 | 521 | 1,659 | 1,043 | 891 | 149,878,384 | 357 | 744 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,122 | 4,578 | 2,243,715 | 275,652,919 | 3,073 | 427 | 342 | 800 | 719 | 583 | 94,156,159 | 192 | 383 | 
| regex_program | 1 | 753 | 3,680 | 1,921,511 | 242,975,404 | 2,621 | 368 | 259 | 699 | 640 | 455 | 73,665,713 | 190 | 306 | 

...
| `total_proof_time_ms ` |  3,831.50 |  7,663 |  4,438 |  3,225 |
...
| `trace_gen_time_ms   ` |  945.50 |  1,891 |  1,142 |  749 |
| `stark_prove_excluding_trace_time_ms` |  2,548.50 |  5,097 |  2,921 |  2,176 |
| `main_trace_commit_time_ms` |  452.50 |  905 |  537 |  368 |
| `generate_perm_trace_time_ms` |  163 |  326 |  185 |  141 |
| `perm_trace_commit_time_ms` |  644.50 |  1,289 |  753 |  536 |
| `quotient_poly_compute_time_ms` |  358 |  716 |  415 |  301 |
| `quotient_poly_commit_time_ms` |  272 |  544 |  317 |  227 |
| `pcs_opening_time_ms ` |  649 |  1,298 |  706 |  592 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,518.50 |  15,037 |  7,578 |  7,459 |
| `main_cells_used     ` |  152,702,167.50 |  305,404,335 |  155,161,634 |  150,242,701 |
| `total_cycles        ` |  1,990,798.50 |  3,981,597 |  2,021,627 |  1,959,970 |
| `execute_time_ms     ` |  760 |  1,520 |  770 |  750 |
| `trace_gen_time_ms   ` |  1,515.50 |  3,031 |  1,533 |  1,498 |
| `stark_prove_excluding_trace_time_ms` |  5,243 |  10,486 |  5,275 |  5,211 |
| `main_trace_commit_time_ms` |  892 |  1,784 |  893 |  891 |
| `generate_perm_trace_time_ms` |  343.50 |  687 |  345 |  342 |
| `perm_trace_commit_time_ms` |  1,662.50 |  3,325 |  1,688 |  1,637 |
| `quotient_poly_compute_time_ms` |  760.50 |  1,521 |  764 |  757 |
| `quotient_poly_commit_time_ms` |  519 |  1,038 |  521 |  517 |
| `pcs_opening_time_ms ` |  1,060.50 |  2,121 |  1,062 |  1,059 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,533 | 7,578 | 2,021,627 | 538,660,330 | 5,275 | 764 | 517 | 1,688 | 1,062 | 893 | 155,161,634 | 345 | 770 | 
| leaf | 1 | 1,498 | 7,459 | 1,959,970 | 538,660,330 | 5,211 | 757 | 521 | 1,637 | 1,059 | 891 | 150,242,701 | 342 | 750 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,142 | 4,438 | 2,225,434 | 275,652,919 | 2,921 | 415 | 317 | 753 | 706 | 537 | 93,738,635 | 185 | 375 | 
| regex_program | 1 | 749 | 3,225 | 1,914,993 | 198,099,628 | 2,176 | 301 | 227 | 536 | 592 | 368 | 73,709,236 | 141 | 300 | 

...
| `total_proof_time_ms ` |  3,951.50 |  7,903 |  4,370 |  3,533 |
...
| `trace_gen_time_ms   ` |  998.50 |  1,997 |  1,182 |  815 |
| `stark_prove_excluding_trace_time_ms` |  2,600.50 |  5,201 |  2,796 |  2,405 |
| `main_trace_commit_time_ms` |  500 |  1,000 |  558 |  442 |
| `generate_perm_trace_time_ms` |  212.50 |  425 |  230 |  195 |
| `perm_trace_commit_time_ms` |  548 |  1,096 |  575 |  521 |
| `quotient_poly_compute_time_ms` |  265 |  530 |  278 |  252 |
| `quotient_poly_commit_time_ms` |  250 |  500 |  279 |  221 |
| `pcs_opening_time_ms ` |  815.50 |  1,631 |  867 |  764 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,062 |  14,124 |  7,102 |  7,022 |
| `main_cells_used     ` |  151,828,247 |  303,656,494 |  154,227,878 |  149,428,616 |
| `total_cycles        ` |  1,975,760.50 |  3,951,521 |  2,006,569 |  1,944,952 |
| `execute_time_ms     ` |  783.50 |  1,567 |  787 |  780 |
| `trace_gen_time_ms   ` |  1,494 |  2,988 |  1,509 |  1,479 |
| `stark_prove_excluding_trace_time_ms` |  4,784.50 |  9,569 |  4,806 |  4,763 |
| `main_trace_commit_time_ms` |  870 |  1,740 |  873 |  867 |
| `generate_perm_trace_time_ms` |  412 |  824 |  439 |  385 |
| `perm_trace_commit_time_ms` |  1,255 |  2,510 |  1,256 |  1,254 |
| `quotient_poly_compute_time_ms` |  537.50 |  1,075 |  540 |  535 |
| `quotient_poly_commit_time_ms` |  414.50 |  829 |  417 |  412 |
| `pcs_opening_time_ms ` |  1,290 |  2,580 |  1,298 |  1,282 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,509 | 7,102 | 2,006,569 | 538,660,330 | 4,806 | 535 | 417 | 1,254 | 1,282 | 873 | 154,227,878 | 439 | 787 | 
| leaf | 1 | 1,479 | 7,022 | 1,944,952 | 538,660,330 | 4,763 | 540 | 412 | 1,256 | 1,298 | 867 | 149,428,616 | 385 | 780 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,182 | 4,370 | 2,243,715 | 275,652,919 | 2,796 | 278 | 279 | 575 | 867 | 558 | 93,500,799 | 230 | 392 | 
| regex_program | 1 | 815 | 3,533 | 1,921,511 | 242,975,404 | 2,405 | 252 | 221 | 521 | 764 | 442 | 73,010,353 | 195 | 313 | 

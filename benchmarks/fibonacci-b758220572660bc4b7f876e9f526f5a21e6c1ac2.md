...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,063 |  7,063 |  7,063 |  7,063 |
| `main_cells_used     ` |  72,168,873 |  72,168,873 |  72,168,873 |  72,168,873 |
| `total_cycles        ` |  1,925,261 |  1,925,261 |  1,925,261 |  1,925,261 |
| `execute_time_ms     ` |  295 |  295 |  295 |  295 |
| `trace_gen_time_ms   ` |  1,359 |  1,359 |  1,359 |  1,359 |
...
| `perm_trace_commit_time_ms` |  981 |  981 |  981 |  981 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,359 | 7,063 | 1,925,261 | 160,482,264 | 5,409 | 768 | 1,089 | 981 | 1,321 | 1,108 | 72,168,873 | 139 | 295 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 817 | 5,339 | 1,500,095 | 122,458,476 | 4,211 | 527 | 789 | 809 | 1,064 | 868 | 51,485,080 | 151 | 311 | 

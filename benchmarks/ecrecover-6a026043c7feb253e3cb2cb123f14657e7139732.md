...
| `total_proof_time_ms ` |  1,447 |  1,447 |  1,447 |  1,447 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  12,631 |  12,631 |  12,631 |  12,631 |
| `main_cells_used     ` |  244,252,594 |  244,252,594 |  244,252,594 |  244,252,594 |
| `total_cycles        ` |  2,988,549 |  2,988,549 |  2,988,549 |  2,988,549 |
| `execute_time_ms     ` |  1,100 |  1,100 |  1,100 |  1,100 |
| `trace_gen_time_ms   ` |  2,309 |  2,309 |  2,309 |  2,309 |
| `stark_prove_excluding_trace_time_ms` |  9,222 |  9,222 |  9,222 |  9,222 |
| `main_trace_commit_time_ms` |  1,571 |  1,571 |  1,571 |  1,571 |
| `generate_perm_trace_time_ms` |  741 |  741 |  741 |  741 |
| `perm_trace_commit_time_ms` |  2,923 |  2,923 |  2,923 |  2,923 |
| `quotient_poly_compute_time_ms` |  1,361 |  1,361 |  1,361 |  1,361 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 2,309 | 12,631 | 2,988,549 | 1,008,831,978 | 9,222 | 1,361 | 830 | 2,923 | 1,792 | 1,571 | 244,252,594 | 741 | 1,100 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 181 | 1,447 | 289,447 | 48,240,297 | 1,121 | 125 | 162 | 193 | 417 | 174 | 14,470,186 | 34 | 145 | 

...
| `total_proof_time_ms ` |  3,888.50 |  7,777 |  4,472 |  3,305 |
| `main_cells_used     ` |  83,694,725 |  167,389,450 |  93,699,990 |  73,689,460 |
| `total_cycles        ` |  2,070,082 |  4,140,164 |  2,225,434 |  1,914,730 |
| `execute_time_ms     ` |  334 |  668 |  371 |  297 |
| `trace_gen_time_ms   ` |  981.50 |  1,963 |  1,166 |  797 |
| `stark_prove_excluding_trace_time_ms` |  2,573 |  5,146 |  2,935 |  2,211 |
| `main_trace_commit_time_ms` |  445 |  890 |  523 |  367 |
| `generate_perm_trace_time_ms` |  176.50 |  353 |  194 |  159 |
| `perm_trace_commit_time_ms` |  643.50 |  1,287 |  746 |  541 |
| `quotient_poly_compute_time_ms` |  358 |  716 |  417 |  299 |
| `quotient_poly_commit_time_ms` |  274.50 |  549 |  320 |  229 |
| `pcs_opening_time_ms ` |  663 |  1,326 |  723 |  603 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,351.50 |  14,703 |  7,431 |  7,272 |
| `main_cells_used     ` |  152,447,728.50 |  304,895,457 |  154,908,477 |  149,986,980 |
| `total_cycles        ` |  1,994,020.50 |  3,988,041 |  2,024,860 |  1,963,181 |
| `execute_time_ms     ` |  794.50 |  1,589 |  803 |  786 |
| `trace_gen_time_ms   ` |  1,458.50 |  2,917 |  1,476 |  1,441 |
| `stark_prove_excluding_trace_time_ms` |  5,098.50 |  10,197 |  5,152 |  5,045 |
| `main_trace_commit_time_ms` |  837 |  1,674 |  837 |  837 |
| `generate_perm_trace_time_ms` |  366.50 |  733 |  373 |  360 |
| `perm_trace_commit_time_ms` |  1,565.50 |  3,131 |  1,597 |  1,534 |
| `quotient_poly_compute_time_ms` |  763 |  1,526 |  767 |  759 |
| `quotient_poly_commit_time_ms` |  505.50 |  1,011 |  509 |  502 |
| `pcs_opening_time_ms ` |  1,054 |  2,108 |  1,061 |  1,047 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,476 | 7,431 | 2,024,860 | 534,072,810 | 5,152 | 767 | 509 | 1,597 | 1,061 | 837 | 154,908,477 | 373 | 803 | 
| leaf | 1 | 1,441 | 7,272 | 1,963,181 | 534,072,810 | 5,045 | 759 | 502 | 1,534 | 1,047 | 837 | 149,986,980 | 360 | 786 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,166 | 4,472 | 2,225,434 | 275,652,919 | 2,935 | 417 | 320 | 746 | 723 | 523 | 93,699,990 | 194 | 371 | 
| regex_program | 1 | 797 | 3,305 | 1,914,730 | 198,099,628 | 2,211 | 299 | 229 | 541 | 603 | 367 | 73,689,460 | 159 | 297 | 

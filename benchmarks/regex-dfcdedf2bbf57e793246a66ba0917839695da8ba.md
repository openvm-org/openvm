...
| `total_proof_time_ms ` |  3,891.50 |  7,783 |  4,492 |  3,291 |
| `main_cells_used     ` |  83,707,475.50 |  167,414,951 |  93,727,369 |  73,687,582 |
| `total_cycles        ` |  2,070,115.50 |  4,140,231 |  2,225,434 |  1,914,797 |
| `execute_time_ms     ` |  337 |  674 |  374 |  300 |
| `trace_gen_time_ms   ` |  975 |  1,950 |  1,155 |  795 |
| `stark_prove_excluding_trace_time_ms` |  2,579.50 |  5,159 |  2,963 |  2,196 |
| `main_trace_commit_time_ms` |  460.50 |  921 |  551 |  370 |
| `generate_perm_trace_time_ms` |  161 |  322 |  182 |  140 |
| `perm_trace_commit_time_ms` |  643.50 |  1,287 |  748 |  539 |
| `quotient_poly_compute_time_ms` |  364.50 |  729 |  420 |  309 |
| `quotient_poly_commit_time_ms` |  275.50 |  551 |  324 |  227 |
| `pcs_opening_time_ms ` |  663.50 |  1,327 |  726 |  601 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,487.50 |  14,975 |  7,604 |  7,371 |
| `main_cells_used     ` |  152,233,190 |  304,466,380 |  154,691,204 |  149,775,176 |
| `total_cycles        ` |  1,990,748 |  3,981,496 |  2,021,582 |  1,959,914 |
| `execute_time_ms     ` |  767.50 |  1,535 |  775 |  760 |
| `trace_gen_time_ms   ` |  1,463 |  2,926 |  1,512 |  1,414 |
| `stark_prove_excluding_trace_time_ms` |  5,257 |  10,514 |  5,317 |  5,197 |
| `main_trace_commit_time_ms` |  892.50 |  1,785 |  893 |  892 |
| `generate_perm_trace_time_ms` |  352 |  704 |  363 |  341 |
| `perm_trace_commit_time_ms` |  1,654 |  3,308 |  1,692 |  1,616 |
| `quotient_poly_compute_time_ms` |  766.50 |  1,533 |  768 |  765 |
| `quotient_poly_commit_time_ms` |  524.50 |  1,049 |  525 |  524 |
| `pcs_opening_time_ms ` |  1,063.50 |  2,127 |  1,072 |  1,055 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,512 | 7,604 | 2,021,582 | 533,941,738 | 5,317 | 768 | 525 | 1,692 | 1,072 | 893 | 154,691,204 | 363 | 775 | 
| leaf | 1 | 1,414 | 7,371 | 1,959,914 | 533,941,738 | 5,197 | 765 | 524 | 1,616 | 1,055 | 892 | 149,775,176 | 341 | 760 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,155 | 4,492 | 2,225,434 | 275,652,919 | 2,963 | 420 | 324 | 748 | 726 | 551 | 93,727,369 | 182 | 374 | 
| regex_program | 1 | 795 | 3,291 | 1,914,797 | 198,099,628 | 2,196 | 309 | 227 | 539 | 601 | 370 | 73,687,582 | 140 | 300 | 

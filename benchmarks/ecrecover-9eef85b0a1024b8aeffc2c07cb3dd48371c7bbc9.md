...
|:---|---:|---:|---:|
| Total |  13.91 |  13.91 | 13.91 |
| ecrecover_program |  4.92 |  4.92 |  4.92 |
| leaf |  8.99 |  8.99 |  8.99 |
...
| `total_proof_time_ms ` |  4,912 |  4,912 |  4,912 |  4,912 |
...
| `stark_prove_excluding_trace_time_ms` |  4,474 |  4,474 |  4,474 |  4,474 |
| `main_trace_commit_time_ms` |  37 |  37 |  37 |  37 |
| `generate_perm_trace_time_ms` |  67 |  67 |  67 |  67 |
| `perm_trace_commit_time_ms` |  34.06 |  34.06 |  34.06 |  34.06 |
| `quotient_poly_compute_time_ms` |  104.70 |  104.70 |  104.70 |  104.70 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  8,988 |  8,988 |  8,988 |  8,988 |
| `main_cells_used     ` |  34,468,876 |  34,468,876 |  34,468,876 |  34,468,876 |
| `total_cells_used    ` |  83,392,626 |  83,392,626 |  83,392,626 |  83,392,626 |
| `execute_preflight_insns` |  4,109,551 |  4,109,551 |  4,109,551 |  4,109,551 |
| `execute_preflight_time_ms` |  780 |  780 |  780 |  780 |
| `execute_preflight_insn_mi/s` |  5.61 | -          |  5.61 |  5.61 |
| `trace_gen_time_ms   ` |  316 |  316 |  316 |  316 |
| `memory_finalize_time_ms` |  29 |  29 |  29 |  29 |
| `stark_prove_excluding_trace_time_ms` |  7,890 |  7,890 |  7,890 |  7,890 |
| `main_trace_commit_time_ms` |  712 |  712 |  712 |  712 |
| `generate_perm_trace_time_ms` |  477 |  477 |  477 |  477 |
| `perm_trace_commit_time_ms` |  1,448.47 |  1,448.47 |  1,448.47 |  1,448.47 |
| `quotient_poly_compute_time_ms` |  802.54 |  802.54 |  802.54 |  802.54 |
| `quotient_poly_commit_time_ms` |  178.53 |  178.53 |  178.53 |  178.53 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program |  | 4,912 |  | 1 | 6 | 122,859 | 19.80 | 0 | 
| leaf | 8,994 |  | 1 | 1 |  |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 316 | 8,988 | 83,392,626 | 1,726,057,962 | 316 | 7,890 | 0 | 802.54 | 178.53 | 7 | 1,448.47 | 4,264 | 1,927 | 4,264 | 29 | 712 | 34,468,876 | 477 | 780 | 4,109,551 | 5.61 | 271 | 986 | 13 | 4,264 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 206 | 4,912 | 11,345,240 | 31,789,298 | 206 | 4,474 | 0 | 104.70 | 9.13 | 11 | 34.06 | 4,213 | 109 | 4,213 | 0 | 37 | 2,263,998 | 67 | 62 | 122,859 | 2.24 | 21 | 114 | 1 | 4,213 | 

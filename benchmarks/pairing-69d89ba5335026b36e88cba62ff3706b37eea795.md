...
| `total_proof_time_ms ` |  732.50 |  1,465 |  860 |  605 |
...
| `execute_preflight_insn_mi/s` |  14.64 | -          |  17.82 |  11.45 |
| `trace_gen_time_ms   ` |  184 |  368 |  203 |  165 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  359.50 |  719 |  407 |  312 |
| `main_trace_commit_time_ms` |  65 |  130 |  75 |  55 |
| `generate_perm_trace_time_ms` |  46 |  92 |  56 |  36 |
| `perm_trace_commit_time_ms` |  77.38 |  154.76 |  90.04 |  64.72 |
| `quotient_poly_compute_time_ms` |  83.91 |  167.81 |  94.45 |  73.36 |
| `quotient_poly_commit_time_ms` |  17.73 |  35.46 |  20.10 |  15.36 |
| `pcs_opening_time_ms ` |  64 |  128 |  66 |  62 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,448 |  2,896 |  1,687 |  1,209 |
| `main_cells_used     ` |  16,200,472 |  32,400,944 |  16,332,746 |  16,068,198 |
| `total_cells_used    ` |  39,332,920 |  78,665,840 |  39,650,868 |  39,014,972 |
| `execute_preflight_insns` |  1,952,330 |  3,904,660 |  1,991,817 |  1,912,843 |
| `execute_preflight_time_ms` |  570 |  1,140 |  835 |  305 |
| `execute_preflight_insn_mi/s` |  7.63 | -          |  7.64 |  7.62 |
| `trace_gen_time_ms   ` |  120 |  240 |  126 |  114 |
| `memory_finalize_time_ms` |  12 |  24 |  12 |  12 |
| `stark_prove_excluding_trace_time_ms` |  756 |  1,512 |  776 |  736 |
| `main_trace_commit_time_ms` |  146.50 |  293 |  151 |  142 |
| `generate_perm_trace_time_ms` |  55.50 |  111 |  59 |  52 |
| `perm_trace_commit_time_ms` |  227.84 |  455.68 |  231.69 |  223.99 |
| `quotient_poly_compute_time_ms` |  175.48 |  350.95 |  178.75 |  172.20 |
| `quotient_poly_commit_time_ms` |  33.58 |  67.17 |  34.62 |  32.55 |
| `pcs_opening_time_ms ` |  114 |  228 |  118 |  110 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 1,689 |  | 1 | 1 |  |  |  |  | 
| pairing |  | 605 |  | 1 | 63 | 1,745,742 | 27.64 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 126 | 1,209 | 39,650,868 | 410,701,290 | 126 | 776 | 0 | 178.75 | 34.62 | 4 | 231.69 | 118 | 292 | 118 | 12 | 151 | 16,332,746 | 59 | 305 | 1,991,817 | 7.62 | 39 | 214 | 0 | 118 | 
| leaf | 1 | 114 | 1,687 | 39,014,972 | 396,840,426 | 114 | 736 | 0 | 172.20 | 32.55 | 5 | 223.99 | 110 | 277 | 110 | 12 | 142 | 16,068,198 | 52 | 835 | 1,912,843 | 7.64 | 38 | 206 | 0 | 110 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 165 | 860 | 32,480,114 | 172,558,444 | 165 | 407 | 0 | 94.45 | 20.10 | 7 | 90.04 | 66 | 150 | 66 | 1 | 75 | 15,909,408 | 56 | 118 | 1,149,000 | 11.45 | 27 | 115 | 1 | 66 | 
| pairing | 1 | 203 | 605 | 22,464,232 | 119,958,502 | 203 | 312 | 1 | 73.36 | 15.36 | 6 | 64.72 | 62 | 104 | 62 | 0 | 55 | 9,498,894 | 36 | 48 | 596,742 | 17.82 | 21 | 89 | 1 | 62 | 

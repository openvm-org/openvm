...
| `total_proof_time_ms ` |  3,683.50 |  7,367 |  4,063 |  3,304 |
...
| `trace_gen_time_ms   ` |  952.50 |  1,905 |  1,102 |  803 |
| `stark_prove_excluding_trace_time_ms` |  2,390.50 |  4,781 |  2,582 |  2,199 |
| `main_trace_commit_time_ms` |  447.50 |  895 |  500 |  395 |
| `generate_perm_trace_time_ms` |  203.50 |  407 |  216 |  191 |
| `perm_trace_commit_time_ms` |  484.50 |  969 |  511 |  458 |
| `quotient_poly_compute_time_ms` |  333 |  666 |  356 |  310 |
| `quotient_poly_commit_time_ms` |  229 |  458 |  270 |  188 |
| `pcs_opening_time_ms ` |  684 |  1,368 |  720 |  648 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  6,624.50 |  13,249 |  6,681 |  6,568 |
| `main_cells_used     ` |  152,278,235 |  304,556,470 |  154,677,782 |  149,878,688 |
| `total_cycles        ` |  1,991,005.50 |  3,982,011 |  2,021,807 |  1,960,204 |
| `execute_time_ms     ` |  775.50 |  1,551 |  783 |  768 |
| `trace_gen_time_ms   ` |  1,498.50 |  2,997 |  1,538 |  1,459 |
| `stark_prove_excluding_trace_time_ms` |  4,350.50 |  8,701 |  4,360 |  4,341 |
| `main_trace_commit_time_ms` |  782.50 |  1,565 |  787 |  778 |
| `generate_perm_trace_time_ms` |  378.50 |  757 |  394 |  363 |
| `perm_trace_commit_time_ms` |  1,106.50 |  2,213 |  1,108 |  1,105 |
| `quotient_poly_compute_time_ms` |  661 |  1,322 |  662 |  660 |
| `quotient_poly_commit_time_ms` |  377.50 |  755 |  379 |  376 |
| `pcs_opening_time_ms ` |  1,040.50 |  2,081 |  1,041 |  1,040 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,538 | 6,681 | 2,021,807 | 538,660,330 | 4,360 | 660 | 376 | 1,108 | 1,040 | 778 | 154,677,782 | 394 | 783 | 
| leaf | 1 | 1,459 | 6,568 | 1,960,204 | 538,660,330 | 4,341 | 662 | 379 | 1,105 | 1,041 | 787 | 149,878,688 | 363 | 768 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,102 | 4,063 | 2,243,715 | 275,652,919 | 2,582 | 356 | 270 | 511 | 720 | 500 | 93,500,799 | 216 | 379 | 
| regex_program | 1 | 803 | 3,304 | 1,921,511 | 242,975,404 | 2,199 | 310 | 188 | 458 | 648 | 395 | 73,010,353 | 191 | 302 | 

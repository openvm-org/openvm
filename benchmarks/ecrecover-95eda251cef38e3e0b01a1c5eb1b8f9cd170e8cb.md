...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  12,711 |  12,711 |  12,711 |  12,711 |
| `main_cells_used     ` |  244,252,702 |  244,252,702 |  244,252,702 |  244,252,702 |
| `total_cycles        ` |  2,988,558 |  2,988,558 |  2,988,558 |  2,988,558 |
| `execute_time_ms     ` |  1,106 |  1,106 |  1,106 |  1,106 |
| `trace_gen_time_ms   ` |  2,353 |  2,353 |  2,353 |  2,353 |
| `stark_prove_excluding_trace_time_ms` |  9,252 |  9,252 |  9,252 |  9,252 |
| `main_trace_commit_time_ms` |  1,579 |  1,579 |  1,579 |  1,579 |
| `generate_perm_trace_time_ms` |  746 |  746 |  746 |  746 |
| `perm_trace_commit_time_ms` |  2,956 |  2,956 |  2,956 |  2,956 |
| `quotient_poly_compute_time_ms` |  1,362 |  1,362 |  1,362 |  1,362 |
| `quotient_poly_commit_time_ms` |  822 |  822 |  822 |  822 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 2,353 | 12,711 | 2,988,558 | 1,008,831,978 | 9,252 | 1,362 | 822 | 2,956 | 1,780 | 1,579 | 244,252,702 | 746 | 1,106 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 175 | 1,441 | 289,447 | 48,240,297 | 1,120 | 128 | 155 | 187 | 431 | 169 | 14,470,186 | 33 | 146 | 

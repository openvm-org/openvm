...
| `total_proof_time_ms ` |  3,894 |  7,788 |  4,289 |  3,499 |
| `main_cells_used     ` |  83,255,576 |  166,511,152 |  93,500,799 |  73,010,353 |
| `total_cycles        ` |  2,082,613 |  4,165,226 |  2,243,715 |  1,921,511 |
| `execute_time_ms     ` |  364.50 |  729 |  405 |  324 |
| `trace_gen_time_ms   ` |  957.50 |  1,915 |  1,121 |  794 |
| `stark_prove_excluding_trace_time_ms` |  2,572 |  5,144 |  2,763 |  2,381 |
| `main_trace_commit_time_ms` |  499 |  998 |  556 |  442 |
| `generate_perm_trace_time_ms` |  213.50 |  427 |  228 |  199 |
| `perm_trace_commit_time_ms` |  546.50 |  1,093 |  573 |  520 |
| `quotient_poly_compute_time_ms` |  261 |  522 |  279 |  243 |
| `quotient_poly_commit_time_ms` |  243 |  486 |  280 |  206 |
| `pcs_opening_time_ms ` |  799.50 |  1,599 |  838 |  761 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,017 |  14,034 |  7,098 |  6,936 |
| `main_cells_used     ` |  151,828,625 |  303,657,250 |  154,228,274 |  149,428,976 |
| `total_cycles        ` |  1,975,792 |  3,951,584 |  2,006,602 |  1,944,982 |
| `execute_time_ms     ` |  788 |  1,576 |  796 |  780 |
| `trace_gen_time_ms   ` |  1,486.50 |  2,973 |  1,518 |  1,455 |
| `stark_prove_excluding_trace_time_ms` |  4,742.50 |  9,485 |  4,784 |  4,701 |
| `main_trace_commit_time_ms` |  866.50 |  1,733 |  867 |  866 |
| `generate_perm_trace_time_ms` |  393 |  786 |  418 |  368 |
| `perm_trace_commit_time_ms` |  1,252 |  2,504 |  1,252 |  1,252 |
| `quotient_poly_compute_time_ms` |  534 |  1,068 |  550 |  518 |
| `quotient_poly_commit_time_ms` |  410.50 |  821 |  412 |  409 |
| `pcs_opening_time_ms ` |  1,281.50 |  2,563 |  1,283 |  1,280 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,518 | 7,098 | 2,006,602 | 538,660,330 | 4,784 | 550 | 412 | 1,252 | 1,280 | 867 | 154,228,274 | 418 | 796 | 
| leaf | 1 | 1,455 | 6,936 | 1,944,982 | 538,660,330 | 4,701 | 518 | 409 | 1,252 | 1,283 | 866 | 149,428,976 | 368 | 780 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,121 | 4,289 | 2,243,715 | 275,652,919 | 2,763 | 279 | 280 | 573 | 838 | 556 | 93,500,799 | 228 | 405 | 
| regex_program | 1 | 794 | 3,499 | 1,921,511 | 242,975,404 | 2,381 | 243 | 206 | 520 | 761 | 442 | 73,010,353 | 199 | 324 | 

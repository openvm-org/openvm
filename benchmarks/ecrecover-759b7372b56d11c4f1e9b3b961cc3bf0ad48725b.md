...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  12,828 |  12,828 |  12,828 |  12,828 |
| `main_cells_used     ` |  244,318,278 |  244,318,278 |  244,318,278 |  244,318,278 |
| `total_cycles        ` |  2,989,525 |  2,989,525 |  2,989,525 |  2,989,525 |
| `execute_time_ms     ` |  1,111 |  1,111 |  1,111 |  1,111 |
| `trace_gen_time_ms   ` |  2,365 |  2,365 |  2,365 |  2,365 |
| `stark_prove_excluding_trace_time_ms` |  9,352 |  9,352 |  9,352 |  9,352 |
| `main_trace_commit_time_ms` |  1,642 |  1,642 |  1,642 |  1,642 |
| `generate_perm_trace_time_ms` |  694 |  694 |  694 |  694 |
| `perm_trace_commit_time_ms` |  3,041 |  3,041 |  3,041 |  3,041 |
| `quotient_poly_compute_time_ms` |  1,338 |  1,338 |  1,338 |  1,338 |
| `quotient_poly_commit_time_ms` |  855 |  855 |  855 |  855 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 2,365 | 12,828 | 2,989,525 | 999,656,938 | 9,352 | 1,338 | 855 | 3,041 | 1,779 | 1,642 | 244,318,278 | 694 | 1,111 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 183 | 1,475 | 295,181 | 48,197,161 | 1,143 | 127 | 166 | 205 | 414 | 184 | 15,586,346 | 33 | 149 | 

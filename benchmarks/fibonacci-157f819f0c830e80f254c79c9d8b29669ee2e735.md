...
| `total_proof_time_ms ` |  6,085 |  6,085 |  6,085 |  6,085 |
...
| `perm_trace_commit_time_ms` |  1,636 |  1,636 |  1,636 |  1,636 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,784 |  7,784 |  7,784 |  7,784 |
| `main_cells_used     ` |  69,166,376 |  69,166,376 |  69,166,376 |  69,166,376 |
| `total_cycles        ` |  1,795,648 |  1,795,648 |  1,795,648 |  1,795,648 |
| `execute_time_ms     ` |  329 |  329 |  329 |  329 |
| `trace_gen_time_ms   ` |  1,198 |  1,198 |  1,198 |  1,198 |
| `stark_prove_excluding_trace_time_ms` |  6,257 |  6,257 |  6,257 |  6,257 |
| `main_trace_commit_time_ms` |  1,100 |  1,100 |  1,100 |  1,100 |
| `generate_perm_trace_time_ms` |  136 |  136 |  136 |  136 |
| `perm_trace_commit_time_ms` |  1,201 |  1,201 |  1,201 |  1,201 |
| `quotient_poly_compute_time_ms` |  1,496 |  1,496 |  1,496 |  1,496 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,198 | 7,784 | 1,795,648 | 180,014,040 | 6,257 | 1,496 | 1,030 | 1,201 | 1,289 | 1,100 | 69,166,376 | 136 | 329 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 826 | 6,085 | 1,500,092 | 197,435,660 | 4,944 | 772 | 527 | 1,636 | 1,021 | 808 | 51,484,605 | 179 | 315 | 

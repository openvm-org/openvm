...
| `total_proof_time_ms ` |  582.25 |  2,329 |  703 |  528 |
...
| `execute_preflight_insn_mi/s` |  30.80 | -          |  31.42 |  29.91 |
| `trace_gen_time_ms   ` |  179.75 |  719 |  196 |  171 |
| `memory_finalize_time_ms` |  0.75 |  3 |  3 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  282.25 |  1,129 |  304 |  264 |
| `main_trace_commit_time_ms` |  51.75 |  207 |  58 |  49 |
| `generate_perm_trace_time_ms` |  29 |  116 |  35 |  22 |
| `perm_trace_commit_time_ms` |  64.35 |  257.42 |  69.33 |  55.79 |
| `quotient_poly_compute_time_ms` |  59.04 |  236.15 |  70.24 |  54.10 |
| `quotient_poly_commit_time_ms` |  15.64 |  62.58 |  18.10 |  13.88 |
| `pcs_opening_time_ms ` |  59.50 |  238 |  67 |  53 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,408.50 |  5,634 |  2,070 |  895 |
...
| `execute_preflight_insns` |  1,440,866.50 |  5,763,466 |  1,814,710 |  1,241,403 |
| `execute_preflight_time_ms` |  617.75 |  2,471 |  815 |  225 |
| `execute_preflight_insn_mi/s` |  7.15 | -          |  7.53 |  6.86 |
| `trace_gen_time_ms   ` |  88.25 |  353 |  163 |  59 |
| `memory_finalize_time_ms` |  9 |  36 |  18 |  5 |
| `stark_prove_excluding_trace_time_ms` |  701 |  2,804 |  1,139 |  500 |
| `main_trace_commit_time_ms` |  125.25 |  501 |  194 |  92 |
| `generate_perm_trace_time_ms` |  60.75 |  243 |  95 |  42 |
| `perm_trace_commit_time_ms` |  211.65 |  846.59 |  385.66 |  143.68 |
| `quotient_poly_compute_time_ms` |  147.53 |  590.12 |  245.04 |  103.57 |
| `quotient_poly_commit_time_ms` |  33.38 |  133.53 |  58 |  23.85 |
| `pcs_opening_time_ms ` |  119 |  476 |  156 |  88 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 2,072 |  | 1 | 1 |  |  |  |  | 
| regex_program |  | 562 |  | 1 | 36 | 4,137,502 | 112.78 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 70 | 895 | 22,981,570 | 319,331,818 | 70 | 599 | 0 | 136.91 | 27.57 | 4 | 173.42 | 88 | 222 | 88 | 7 | 123 | 9,122,488 | 48 | 225 | 1,465,948 | 7.53 | 31 | 165 | 0 | 88 | 
| leaf | 1 | 61 | 1,444 | 20,905,034 | 255,237,610 | 61 | 566 | 0 | 104.60 | 24.10 | 5 | 143.68 | 141 | 202 | 141 | 6 | 92 | 8,256,948 | 58 | 815 | 1,241,403 | 7.10 | 26 | 129 | 0 | 141 | 
| leaf | 2 | 59 | 1,225 | 20,905,034 | 255,237,610 | 59 | 500 | 0 | 103.57 | 23.85 | 4 | 143.82 | 91 | 187 | 91 | 5 | 92 | 8,256,948 | 42 | 665 | 1,241,405 | 7.11 | 26 | 128 | 0 | 91 | 
| leaf | 3 | 163 | 2,070 | 50,337,320 | 538,365,418 | 163 | 1,139 | 0 | 245.04 | 58 | 5 | 385.66 | 156 | 481 | 156 | 18 | 194 | 20,171,106 | 95 | 766 | 1,814,710 | 6.86 | 61 | 307 | 5 | 156 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 171 | 703 | 23,446,148 | 150,778,428 | 171 | 304 | 0 | 56.98 | 18.10 | 5 | 69.33 | 64 | 105 | 63 | 3 | 58 | 10,899,170 | 35 | 57 | 1,103,000 | 29.91 | 22 | 75 | 1 | 63 | 
| regex_program | 1 | 176 | 528 | 11,598,276 | 128,513,066 | 176 | 264 | 1 | 54.10 | 15.11 | 4 | 65.50 | 54 | 88 | 54 | 0 | 51 | 2,196,106 | 22 | 47 | 1,104,000 | 30.100 | 16 | 69 | 0 | 54 | 
| regex_program | 2 | 176 | 536 | 11,579,064 | 128,513,066 | 176 | 271 | 1 | 54.83 | 15.49 | 4 | 66.80 | 53 | 97 | 53 | 0 | 49 | 2,177,334 | 30 | 46 | 1,104,000 | 31.42 | 17 | 70 | 0 | 53 | 
| regex_program | 3 | 196 | 562 | 11,853,872 | 103,456,394 | 196 | 290 | 0 | 70.24 | 13.88 | 5 | 55.79 | 67 | 87 | 66 | 0 | 49 | 2,422,606 | 29 | 35 | 826,502 | 30.88 | 19 | 85 | 1 | 66 | 

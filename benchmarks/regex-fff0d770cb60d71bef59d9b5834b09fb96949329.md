...
| `total_proof_time_ms ` |  3,971.50 |  7,943 |  4,370 |  3,573 |
| `main_cells_used     ` |  83,255,576 |  166,511,152 |  93,500,799 |  73,010,353 |
| `total_cycles        ` |  2,082,613 |  4,165,226 |  2,243,715 |  1,921,511 |
| `execute_time_ms     ` |  352 |  704 |  392 |  312 |
| `trace_gen_time_ms   ` |  974 |  1,948 |  1,141 |  807 |
| `stark_prove_excluding_trace_time_ms` |  2,645.50 |  5,291 |  2,837 |  2,454 |
| `main_trace_commit_time_ms` |  502 |  1,004 |  561 |  443 |
| `generate_perm_trace_time_ms` |  222 |  444 |  236 |  208 |
| `perm_trace_commit_time_ms` |  548 |  1,096 |  577 |  519 |
| `quotient_poly_compute_time_ms` |  263.50 |  527 |  290 |  237 |
| `quotient_poly_commit_time_ms` |  249 |  498 |  287 |  211 |
| `pcs_opening_time_ms ` |  851.50 |  1,703 |  877 |  826 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,047.50 |  14,095 |  7,117 |  6,978 |
| `main_cells_used     ` |  151,828,013 |  303,656,026 |  154,227,878 |  149,428,148 |
| `total_cycles        ` |  1,975,741 |  3,951,482 |  2,006,569 |  1,944,913 |
| `execute_time_ms     ` |  779 |  1,558 |  787 |  771 |
| `trace_gen_time_ms   ` |  1,475.50 |  2,951 |  1,534 |  1,417 |
| `stark_prove_excluding_trace_time_ms` |  4,793 |  9,586 |  4,796 |  4,790 |
| `main_trace_commit_time_ms` |  871 |  1,742 |  873 |  869 |
| `generate_perm_trace_time_ms` |  399.50 |  799 |  411 |  388 |
| `perm_trace_commit_time_ms` |  1,262.50 |  2,525 |  1,274 |  1,251 |
| `quotient_poly_compute_time_ms` |  544.50 |  1,089 |  555 |  534 |
| `quotient_poly_commit_time_ms` |  414.50 |  829 |  415 |  414 |
| `pcs_opening_time_ms ` |  1,296.50 |  2,593 |  1,302 |  1,291 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,534 | 7,117 | 2,006,569 | 538,660,330 | 4,796 | 555 | 415 | 1,251 | 1,291 | 869 | 154,227,878 | 411 | 787 | 
| leaf | 1 | 1,417 | 6,978 | 1,944,913 | 538,660,330 | 4,790 | 534 | 414 | 1,274 | 1,302 | 873 | 149,428,148 | 388 | 771 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,141 | 4,370 | 2,243,715 | 275,652,919 | 2,837 | 290 | 287 | 577 | 877 | 561 | 93,500,799 | 236 | 392 | 
| regex_program | 1 | 807 | 3,573 | 1,921,511 | 242,975,404 | 2,454 | 237 | 211 | 519 | 826 | 443 | 73,010,353 | 208 | 312 | 

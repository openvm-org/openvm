...
| `total_proof_time_ms ` |  721.50 |  1,443 |  834 |  609 |
...
| `execute_metered_insn_mi/s` |  19.38 | -          |  19.38 |  19.38 |
| `execute_preflight_insns` |  872,871 |  1,745,742 |  1,157,000 |  588,742 |
| `execute_preflight_time_ms` |  95.50 |  191 |  131 |  60 |
| `execute_preflight_insn_mi/s` |  13.48 | -          |  17.90 |  9.07 |
| `trace_gen_time_ms   ` |  177 |  354 |  195 |  159 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  356.50 |  713 |  401 |  312 |
| `main_trace_commit_time_ms` |  65.50 |  131 |  76 |  55 |
| `generate_perm_trace_time_ms` |  35.50 |  71 |  36 |  35 |
| `perm_trace_commit_time_ms` |  77.87 |  155.75 |  90.86 |  64.89 |
| `quotient_poly_compute_time_ms` |  79.89 |  159.79 |  88.43 |  71.36 |
| `quotient_poly_commit_time_ms` |  16.98 |  33.95 |  19.44 |  14.52 |
| `pcs_opening_time_ms ` |  76 |  152 |  86 |  66 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,451.50 |  2,903 |  1,715 |  1,188 |
| `main_cells_used     ` |  16,200,472 |  32,400,944 |  16,332,746 |  16,068,198 |
| `total_cells_used    ` |  39,332,920 |  78,665,840 |  39,650,868 |  39,014,972 |
| `execute_preflight_insns` |  1,952,416 |  3,904,832 |  1,991,954 |  1,912,878 |
| `execute_preflight_time_ms` |  583.50 |  1,167 |  870 |  297 |
| `execute_preflight_insn_mi/s` |  7.56 | -          |  7.58 |  7.55 |
| `trace_gen_time_ms   ` |  122 |  244 |  131 |  113 |
| `memory_finalize_time_ms` |  11 |  22 |  11 |  11 |
| `stark_prove_excluding_trace_time_ms` |  745 |  1,490 |  759 |  731 |
| `main_trace_commit_time_ms` |  148.50 |  297 |  152 |  145 |
| `generate_perm_trace_time_ms` |  57.50 |  115 |  59 |  56 |
| `perm_trace_commit_time_ms` |  229.12 |  458.24 |  233.81 |  224.43 |
| `quotient_poly_compute_time_ms` |  170.48 |  340.96 |  172.77 |  168.19 |
| `quotient_poly_commit_time_ms` |  31.94 |  63.87 |  32.79 |  31.08 |
| `pcs_opening_time_ms ` |  104 |  208 |  105 |  103 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 1,717 |  | 1 |  | 1 |  |  |  |  | 
| pairing |  | 609 |  | 40 | 1 | 90 | 1,745,742 | 19.38 | 144 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 131 | 1,188 | 39,650,868 | 410,701,290 | 131 | 759 | 0 | 172.77 | 32.79 | 4 | 233.81 | 105 | 294 | 105 | 11 | 152 | 16,332,746 | 59 | 297 | 1,991,954 | 7.58 | 39 | 207 | 0 | 105 | 
| leaf | 1 | 113 | 1,715 | 39,014,972 | 396,840,426 | 113 | 731 | 0 | 168.19 | 31.08 | 4 | 224.43 | 103 | 281 | 103 | 11 | 145 | 16,068,198 | 56 | 870 | 1,912,878 | 7.55 | 38 | 200 | 0 | 103 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 159 | 834 | 32,689,110 | 172,558,444 | 159 | 401 | 0 | 88.43 | 19.44 | 6 | 90.86 | 86 | 129 | 86 | 1 | 76 | 16,059,916 | 35 | 131 | 1,157,000 | 9.07 | 27 | 108 | 1 | 86 | 
| pairing | 1 | 195 | 609 | 22,314,288 | 119,958,502 | 195 | 312 | 1 | 71.36 | 14.52 | 5 | 64.89 | 66 | 104 | 66 | 0 | 55 | 9,408,294 | 36 | 60 | 588,742 | 17.90 | 20 | 86 | 1 | 66 | 

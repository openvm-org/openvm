...
| `total_proof_time_ms ` |  4,022.50 |  8,045 |  4,463 |  3,582 |
...
| `trace_gen_time_ms   ` |  948.50 |  1,897 |  1,130 |  767 |
| `stark_prove_excluding_trace_time_ms` |  2,733 |  5,466 |  2,955 |  2,511 |
| `main_trace_commit_time_ms` |  472.50 |  945 |  532 |  413 |
| `generate_perm_trace_time_ms` |  190 |  380 |  192 |  188 |
| `perm_trace_commit_time_ms` |  693.50 |  1,387 |  745 |  642 |
| `quotient_poly_compute_time_ms` |  396.50 |  793 |  428 |  365 |
| `quotient_poly_commit_time_ms` |  283.50 |  567 |  322 |  245 |
| `pcs_opening_time_ms ` |  687 |  1,374 |  726 |  648 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,276.50 |  14,553 |  7,403 |  7,150 |
| `main_cells_used     ` |  152,277,589 |  304,555,178 |  154,676,722 |  149,878,456 |
| `total_cycles        ` |  1,990,977 |  3,981,954 |  2,021,744 |  1,960,210 |
| `execute_time_ms     ` |  770 |  1,540 |  779 |  761 |
| `trace_gen_time_ms   ` |  1,478 |  2,956 |  1,533 |  1,423 |
| `stark_prove_excluding_trace_time_ms` |  5,028.50 |  10,057 |  5,091 |  4,966 |
| `main_trace_commit_time_ms` |  811.50 |  1,623 |  816 |  807 |
| `generate_perm_trace_time_ms` |  375.50 |  751 |  391 |  360 |
| `perm_trace_commit_time_ms` |  1,531.50 |  3,063 |  1,570 |  1,493 |
| `quotient_poly_compute_time_ms` |  766 |  1,532 |  768 |  764 |
| `quotient_poly_commit_time_ms` |  493 |  986 |  497 |  489 |
| `pcs_opening_time_ms ` |  1,045.50 |  2,091 |  1,051 |  1,040 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,533 | 7,403 | 2,021,744 | 538,660,330 | 5,091 | 768 | 489 | 1,570 | 1,051 | 816 | 154,676,722 | 391 | 779 | 
| leaf | 1 | 1,423 | 7,150 | 1,960,210 | 538,660,330 | 4,966 | 764 | 497 | 1,493 | 1,040 | 807 | 149,878,456 | 360 | 761 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,130 | 4,463 | 2,243,715 | 275,652,919 | 2,955 | 428 | 322 | 745 | 726 | 532 | 93,500,799 | 192 | 378 | 
| regex_program | 1 | 767 | 3,582 | 1,921,511 | 242,975,404 | 2,511 | 365 | 245 | 642 | 648 | 413 | 73,010,353 | 188 | 304 | 

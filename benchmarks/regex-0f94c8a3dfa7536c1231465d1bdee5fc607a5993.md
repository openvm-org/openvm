...
| `total_proof_time_ms ` |  4,081.50 |  8,163 |  4,543 |  3,620 |
| `main_cells_used     ` |  83,255,576 |  166,511,152 |  93,500,799 |  73,010,353 |
| `total_cycles        ` |  2,082,613 |  4,165,226 |  2,243,715 |  1,921,511 |
| `execute_time_ms     ` |  341.50 |  683 |  381 |  302 |
| `trace_gen_time_ms   ` |  991 |  1,982 |  1,171 |  811 |
| `stark_prove_excluding_trace_time_ms` |  2,749 |  5,498 |  2,991 |  2,507 |
| `main_trace_commit_time_ms` |  470 |  940 |  529 |  411 |
| `generate_perm_trace_time_ms` |  190 |  380 |  192 |  188 |
| `perm_trace_commit_time_ms` |  691 |  1,382 |  743 |  639 |
| `quotient_poly_compute_time_ms` |  394.50 |  789 |  424 |  365 |
| `quotient_poly_commit_time_ms` |  282.50 |  565 |  317 |  248 |
| `pcs_opening_time_ms ` |  712 |  1,424 |  776 |  648 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,276 |  14,552 |  7,328 |  7,224 |
| `main_cells_used     ` |  152,277,859 |  304,555,718 |  154,677,214 |  149,878,504 |
| `total_cycles        ` |  1,990,999.50 |  3,981,999 |  2,021,785 |  1,960,214 |
| `execute_time_ms     ` |  768.50 |  1,537 |  773 |  764 |
| `trace_gen_time_ms   ` |  1,474 |  2,948 |  1,480 |  1,468 |
| `stark_prove_excluding_trace_time_ms` |  5,033.50 |  10,067 |  5,075 |  4,992 |
| `main_trace_commit_time_ms` |  810.50 |  1,621 |  813 |  808 |
| `generate_perm_trace_time_ms` |  372 |  744 |  385 |  359 |
| `perm_trace_commit_time_ms` |  1,537.50 |  3,075 |  1,568 |  1,507 |
| `quotient_poly_compute_time_ms` |  770.50 |  1,541 |  773 |  768 |
| `quotient_poly_commit_time_ms` |  492 |  984 |  493 |  491 |
| `pcs_opening_time_ms ` |  1,046.50 |  2,093 |  1,048 |  1,045 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,480 | 7,328 | 2,021,785 | 538,660,330 | 5,075 | 768 | 491 | 1,568 | 1,045 | 813 | 154,677,214 | 385 | 773 | 
| leaf | 1 | 1,468 | 7,224 | 1,960,214 | 538,660,330 | 4,992 | 773 | 493 | 1,507 | 1,048 | 808 | 149,878,504 | 359 | 764 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,171 | 4,543 | 2,243,715 | 275,652,919 | 2,991 | 424 | 317 | 743 | 776 | 529 | 93,500,799 | 192 | 381 | 
| regex_program | 1 | 811 | 3,620 | 1,921,511 | 242,975,404 | 2,507 | 365 | 248 | 639 | 648 | 411 | 73,010,353 | 188 | 302 | 

...
| `total_proof_time_ms ` |  3,901.50 |  7,803 |  4,489 |  3,314 |
...
| `trace_gen_time_ms   ` |  986.50 |  1,973 |  1,165 |  808 |
| `stark_prove_excluding_trace_time_ms` |  2,575.50 |  5,151 |  2,946 |  2,205 |
| `main_trace_commit_time_ms` |  455 |  910 |  538 |  372 |
| `generate_perm_trace_time_ms` |  161 |  322 |  186 |  136 |
| `perm_trace_commit_time_ms` |  640.50 |  1,281 |  744 |  537 |
| `quotient_poly_compute_time_ms` |  361 |  722 |  414 |  308 |
| `quotient_poly_commit_time_ms` |  274.50 |  549 |  319 |  230 |
| `pcs_opening_time_ms ` |  673.50 |  1,347 |  734 |  613 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,335 |  14,670 |  7,403 |  7,267 |
| `main_cells_used     ` |  152,709,627.50 |  305,419,255 |  155,169,287 |  150,249,968 |
| `total_cycles        ` |  1,990,997 |  3,981,994 |  2,021,835 |  1,960,159 |
| `execute_time_ms     ` |  770 |  1,540 |  779 |  761 |
| `trace_gen_time_ms   ` |  1,492 |  2,984 |  1,507 |  1,477 |
| `stark_prove_excluding_trace_time_ms` |  5,073 |  10,146 |  5,117 |  5,029 |
| `main_trace_commit_time_ms` |  816 |  1,632 |  822 |  810 |
| `generate_perm_trace_time_ms` |  359 |  718 |  374 |  344 |
| `perm_trace_commit_time_ms` |  1,571 |  3,142 |  1,600 |  1,542 |
| `quotient_poly_compute_time_ms` |  766.50 |  1,533 |  768 |  765 |
| `quotient_poly_commit_time_ms` |  495 |  990 |  496 |  494 |
| `pcs_opening_time_ms ` |  1,061 |  2,122 |  1,070 |  1,052 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,507 | 7,403 | 2,021,835 | 538,660,330 | 5,117 | 768 | 496 | 1,600 | 1,052 | 822 | 155,169,287 | 374 | 779 | 
| leaf | 1 | 1,477 | 7,267 | 1,960,159 | 538,660,330 | 5,029 | 765 | 494 | 1,542 | 1,070 | 810 | 150,249,968 | 344 | 761 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,165 | 4,489 | 2,225,434 | 275,652,919 | 2,946 | 414 | 319 | 744 | 734 | 538 | 93,738,635 | 186 | 378 | 
| regex_program | 1 | 808 | 3,314 | 1,914,993 | 198,099,628 | 2,205 | 308 | 230 | 537 | 613 | 372 | 73,709,236 | 136 | 301 | 

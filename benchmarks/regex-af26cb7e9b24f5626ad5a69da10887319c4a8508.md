...
| `total_proof_time_ms ` |  6,903.50 |  13,807 |  7,793 |  6,014 |
| `main_cells_used     ` |  82,727,686.50 |  165,455,373 |  92,686,348 |  72,769,025 |
| `total_cycles        ` |  1,914,103 |  1,914,103 |  1,914,103 |  1,914,103 |
| `execute_time_ms     ` |  438 |  876 |  471 |  405 |
| `trace_gen_time_ms   ` |  1,084 |  2,168 |  1,243 |  925 |
| `stark_prove_excluding_trace_time_ms` |  5,381.50 |  10,763 |  6,079 |  4,684 |
| `main_trace_commit_time_ms` |  1,058.50 |  2,117 |  1,282 |  835 |
| `generate_perm_trace_time_ms` |  173.50 |  347 |  191 |  156 |
| `perm_trace_commit_time_ms` |  1,130.50 |  2,261 |  1,193 |  1,068 |
| `quotient_poly_compute_time_ms` |  737.50 |  1,475 |  861 |  614 |
| `quotient_poly_commit_time_ms` |  965 |  1,930 |  1,111 |  819 |
| `pcs_opening_time_ms ` |  1,307 |  2,614 |  1,434 |  1,180 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,995.50 |  15,991 |  8,224 |  7,767 |
| `main_cells_used     ` |  77,287,259 |  154,574,518 |  78,375,899 |  76,198,619 |
| `total_cycles        ` |  1,028,219 |  2,056,438 |  1,045,699 |  1,010,739 |
| `execute_time_ms     ` |  370.50 |  741 |  399 |  342 |
| `trace_gen_time_ms   ` |  1,150 |  2,300 |  1,228 |  1,072 |
| `stark_prove_excluding_trace_time_ms` |  6,475 |  12,950 |  6,753 |  6,197 |
| `main_trace_commit_time_ms` |  1,329 |  2,658 |  1,393 |  1,265 |
| `generate_perm_trace_time_ms` |  164.50 |  329 |  176 |  153 |
| `perm_trace_commit_time_ms` |  1,311.50 |  2,623 |  1,375 |  1,248 |
| `quotient_poly_compute_time_ms` |  966.50 |  1,933 |  1,033 |  900 |
| `quotient_poly_commit_time_ms` |  1,273.50 |  2,547 |  1,294 |  1,253 |
| `pcs_opening_time_ms ` |  1,426 |  2,852 |  1,479 |  1,373 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,072 | 8,224 | 1,045,699 | 220,669,656 | 6,753 | 1,033 | 1,294 | 1,375 | 1,479 | 1,393 | 78,375,899 | 176 | 399 | 
| leaf | 1 | 1,228 | 7,767 | 1,010,739 | 194,986,968 | 6,197 | 900 | 1,253 | 1,248 | 1,373 | 1,265 | 76,198,619 | 153 | 342 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,243 | 7,793 |  | 209,921,543 | 6,079 | 861 | 1,111 | 1,193 | 1,434 | 1,282 | 92,686,348 | 191 | 471 | 
| regex_program | 1 | 925 | 6,014 | 1,914,103 | 149,454,692 | 4,684 | 614 | 819 | 1,068 | 1,180 | 835 | 72,769,025 | 156 | 405 | 

...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  18,125 |  18,125 |  18,125 |  18,125 |
...
| `trace_gen_time_ms   ` |  3,431 |  3,431 |  3,431 |  3,431 |
| `stark_prove_excluding_trace_time_ms` |  13,741 |  13,741 |  13,741 |  13,741 |
| `main_trace_commit_time_ms` |  2,779 |  2,779 |  2,779 |  2,779 |
| `generate_perm_trace_time_ms` |  357 |  357 |  357 |  357 |
| `perm_trace_commit_time_ms` |  2,884 |  2,884 |  2,884 |  2,884 |
| `quotient_poly_compute_time_ms` |  2,091 |  2,091 |  2,091 |  2,091 |
| `quotient_poly_commit_time_ms` |  2,649 |  2,649 |  2,649 |  2,649 |
| `pcs_opening_time_ms ` |  2,978 |  2,978 |  2,978 |  2,978 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 3,431 | 18,125 | 4,157,698 | 459,031,512 | 13,741 | 2,091 | 2,649 | 2,884 | 2,978 | 2,779 | 186,730,861 | 357 | 953 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 255 | 2,573 | 284,567 | 38,417,467 | 2,169 | 227 | 480 | 359 | 663 | 392 | 15,055,723 | 34 | 149 | 

...
| `total_proof_time_ms ` |  3,688.50 |  7,377 |  4,120 |  3,257 |
...
| `trace_gen_time_ms   ` |  939.50 |  1,879 |  1,111 |  768 |
| `stark_prove_excluding_trace_time_ms` |  2,408.50 |  4,817 |  2,630 |  2,187 |
| `main_trace_commit_time_ms` |  451.50 |  903 |  506 |  397 |
| `generate_perm_trace_time_ms` |  189.50 |  379 |  207 |  172 |
| `perm_trace_commit_time_ms` |  498 |  996 |  533 |  463 |
| `quotient_poly_compute_time_ms` |  333 |  666 |  357 |  309 |
| `quotient_poly_commit_time_ms` |  233.50 |  467 |  277 |  190 |
| `pcs_opening_time_ms ` |  693.50 |  1,387 |  740 |  647 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  6,655.50 |  13,311 |  6,707 |  6,604 |
| `main_cells_used     ` |  152,278,409 |  304,556,818 |  154,678,118 |  149,878,700 |
| `total_cycles        ` |  1,991,020 |  3,982,040 |  2,021,835 |  1,960,205 |
| `execute_time_ms     ` |  770.50 |  1,541 |  778 |  763 |
| `trace_gen_time_ms   ` |  1,487 |  2,974 |  1,533 |  1,441 |
| `stark_prove_excluding_trace_time_ms` |  4,398 |  8,796 |  4,400 |  4,396 |
| `main_trace_commit_time_ms` |  781 |  1,562 |  785 |  777 |
| `generate_perm_trace_time_ms` |  379.50 |  759 |  396 |  363 |
| `perm_trace_commit_time_ms` |  1,103 |  2,206 |  1,105 |  1,101 |
| `quotient_poly_compute_time_ms` |  660 |  1,320 |  661 |  659 |
| `quotient_poly_commit_time_ms` |  380.50 |  761 |  383 |  378 |
| `pcs_opening_time_ms ` |  1,087.50 |  2,175 |  1,108 |  1,067 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,533 | 6,707 | 2,021,835 | 538,660,330 | 4,396 | 661 | 383 | 1,105 | 1,067 | 777 | 154,678,118 | 396 | 778 | 
| leaf | 1 | 1,441 | 6,604 | 1,960,205 | 538,660,330 | 4,400 | 659 | 378 | 1,101 | 1,108 | 785 | 149,878,700 | 363 | 763 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,111 | 4,120 | 2,243,715 | 275,652,919 | 2,630 | 357 | 277 | 533 | 740 | 506 | 93,500,799 | 207 | 379 | 
| regex_program | 1 | 768 | 3,257 | 1,921,511 | 242,975,404 | 2,187 | 309 | 190 | 463 | 647 | 397 | 73,010,353 | 172 | 302 | 

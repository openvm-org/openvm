...
| `total_proof_time_ms ` |  580.75 |  2,323 |  703 |  521 |
...
| `execute_metered_insn_mi/s` |  120.34 | -          |  120.34 |  120.34 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  52.25 |  209 |  63 |  44 |
| `execute_preflight_insn_mi/s` |  32.30 | -          |  33.54 |  29.07 |
| `trace_gen_time_ms   ` |  179 |  716 |  213 |  157 |
| `memory_finalize_time_ms` |  1 |  4 |  4 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  281.25 |  1,125 |  300 |  259 |
| `main_trace_commit_time_ms` |  51 |  204 |  55 |  49 |
| `generate_perm_trace_time_ms` |  28.25 |  113 |  48 |  19 |
| `perm_trace_commit_time_ms` |  64.10 |  256.42 |  71.04 |  54.03 |
| `quotient_poly_compute_time_ms` |  58.28 |  233.14 |  70.94 |  51.89 |
| `quotient_poly_commit_time_ms` |  14.73 |  58.91 |  16.36 |  12.71 |
| `pcs_opening_time_ms ` |  61 |  244 |  71 |  52 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,364.50 |  5,458 |  1,978 |  916 |
...
| `execute_preflight_insns` |  1,440,908.50 |  5,763,634 |  1,814,610 |  1,241,439 |
| `execute_preflight_time_ms` |  609.75 |  2,439 |  794 |  224 |
| `execute_preflight_insn_mi/s` |  7.05 | -          |  7.47 |  6.76 |
| `trace_gen_time_ms   ` |  87.50 |  350 |  161 |  59 |
| `memory_finalize_time_ms` |  9 |  36 |  18 |  5 |
| `stark_prove_excluding_trace_time_ms` |  666.50 |  2,666 |  1,054 |  491 |
| `main_trace_commit_time_ms` |  123.25 |  493 |  191 |  90 |
| `generate_perm_trace_time_ms` |  54.25 |  217 |  88 |  32 |
| `perm_trace_commit_time_ms` |  197.62 |  790.48 |  337.79 |  141.41 |
| `quotient_poly_compute_time_ms` |  139.50 |  558 |  228.05 |  99.48 |
| `quotient_poly_commit_time_ms` |  29.76 |  119.03 |  48.74 |  22.65 |
| `pcs_opening_time_ms ` |  118 |  472 |  154 |  100 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 1,980 |  | 1 |  | 1 |  |  |  |  | 
| regex_program |  | 569 |  | 66 | 1 | 34 | 4,137,502 | 120.34 | 192 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 70 | 916 | 22,981,570 | 319,331,818 | 70 | 621 | 0 | 130.65 | 24.79 | 4 | 169.01 | 109 | 233 | 109 | 7 | 122 | 9,122,488 | 63 | 224 | 1,466,057 | 7.47 | 30 | 156 | 0 | 109 | 
| leaf | 1 | 60 | 1,345 | 20,905,034 | 255,237,610 | 60 | 491 | 0 | 99.48 | 22.65 | 4 | 141.41 | 100 | 176 | 100 | 5 | 90 | 8,256,948 | 34 | 794 | 1,241,439 | 6.95 | 26 | 123 | 0 | 100 | 
| leaf | 2 | 59 | 1,219 | 20,905,034 | 255,237,610 | 59 | 500 | 0 | 99.82 | 22.85 | 4 | 142.27 | 109 | 175 | 109 | 6 | 90 | 8,256,948 | 32 | 659 | 1,241,528 | 7.03 | 25 | 123 | 0 | 109 | 
| leaf | 3 | 161 | 1,978 | 50,337,320 | 538,365,418 | 161 | 1,054 | 0 | 228.05 | 48.74 | 4 | 337.79 | 154 | 427 | 154 | 18 | 191 | 20,171,106 | 88 | 762 | 1,814,610 | 6.76 | 61 | 280 | 5 | 154 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 213 | 703 | 23,446,148 | 150,778,428 | 213 | 298 | 0 | 57.78 | 16.36 | 5 | 71.04 | 71 | 95 | 71 | 4 | 55 | 10,899,170 | 23 | 45 | 1,103,000 | 29.07 | 21 | 74 | 1 | 71 | 
| regex_program | 1 | 157 | 530 | 11,598,276 | 128,513,066 | 157 | 268 | 1 | 51.89 | 14.42 | 4 | 64.76 | 62 | 88 | 62 | 0 | 49 | 2,196,106 | 23 | 63 | 1,104,000 | 33.54 | 16 | 66 | 0 | 62 | 
| regex_program | 2 | 163 | 521 | 11,579,064 | 128,513,066 | 163 | 259 | 1 | 52.53 | 15.43 | 4 | 66.59 | 52 | 86 | 52 | 0 | 50 | 2,177,334 | 19 | 57 | 1,104,000 | 33.35 | 16 | 68 | 0 | 52 | 
| regex_program | 3 | 183 | 569 | 11,853,872 | 103,456,394 | 183 | 300 | 0 | 70.94 | 12.71 | 5 | 54.03 | 59 | 105 | 59 | 0 | 50 | 2,422,606 | 48 | 44 | 826,502 | 33.25 | 18 | 84 | 1 | 59 | 

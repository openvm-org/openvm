...
| `trace_gen_time_ms   ` |  1,291 |  2,582 |  1,319 |  1,263 |
| `stark_prove_excluding_trace_time_ms` |  5,305.50 |  10,611 |  6,056 |  4,555 |
| `main_trace_commit_time_ms` |  1,149 |  2,298 |  1,327 |  971 |
| `generate_perm_trace_time_ms` |  183.50 |  367 |  208 |  159 |
| `perm_trace_commit_time_ms` |  1,030.50 |  2,061 |  1,181 |  880 |
| `quotient_poly_compute_time_ms` |  744.50 |  1,489 |  874 |  615 |
| `quotient_poly_commit_time_ms` |  920.50 |  1,841 |  1,069 |  772 |
| `pcs_opening_time_ms ` |  1,267 |  2,534 |  1,386 |  1,148 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  8,591.50 |  17,183 |  8,593 |  8,590 |
| `main_cells_used     ` |  86,869,698.50 |  173,739,397 |  88,130,050 |  85,609,347 |
| `total_cycles        ` |  1,451,208.50 |  2,902,417 |  1,475,939 |  1,426,478 |
| `execute_time_ms     ` |  453 |  906 |  491 |  415 |
| `trace_gen_time_ms   ` |  1,273 |  2,546 |  1,340 |  1,206 |
| `stark_prove_excluding_trace_time_ms` |  6,865.50 |  13,731 |  6,896 |  6,835 |
| `main_trace_commit_time_ms` |  1,398 |  2,796 |  1,400 |  1,396 |
| `generate_perm_trace_time_ms` |  189.50 |  379 |  190 |  189 |
| `perm_trace_commit_time_ms` |  1,400 |  2,800 |  1,406 |  1,394 |
| `quotient_poly_compute_time_ms` |  1,083.50 |  2,167 |  1,103 |  1,064 |
| `quotient_poly_commit_time_ms` |  1,368 |  2,736 |  1,370 |  1,366 |
| `pcs_opening_time_ms ` |  1,421.50 |  2,843 |  1,430 |  1,413 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,206 | 8,593 | 1,475,939 | 225,774,050 | 6,896 | 1,103 | 1,366 | 1,406 | 1,430 | 1,396 | 88,130,050 | 190 | 491 | 
| leaf | 1 | 1,340 | 8,590 | 1,426,478 | 225,774,050 | 6,835 | 1,064 | 1,370 | 1,394 | 1,413 | 1,400 | 85,609,347 | 189 | 415 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,319 | 7,850 | 2,225,434 | 210,931,487 | 6,056 | 874 | 1,069 | 1,181 | 1,386 | 1,327 | 93,699,990 | 208 | 475 | 
| regex_program | 1 | 1,263 | 6,124 | 1,914,730 | 150,470,512 | 4,555 | 615 | 772 | 880 | 1,148 | 971 | 73,689,460 | 159 | 306 | 

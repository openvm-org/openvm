...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  18,019 |  18,019 |  18,019 |  18,019 |
| `main_cells_used     ` |  186,733,246 |  186,733,246 |  186,733,246 |  186,733,246 |
| `total_cycles        ` |  4,157,963 |  4,157,963 |  4,157,963 |  4,157,963 |
| `execute_time_ms     ` |  947 |  947 |  947 |  947 |
| `trace_gen_time_ms   ` |  3,385 |  3,385 |  3,385 |  3,385 |
| `stark_prove_excluding_trace_time_ms` |  13,687 |  13,687 |  13,687 |  13,687 |
...
| `quotient_poly_compute_time_ms` |  2,080 |  2,080 |  2,080 |  2,080 |
| `quotient_poly_commit_time_ms` |  2,634 |  2,634 |  2,634 |  2,634 |
| `pcs_opening_time_ms ` |  2,961 |  2,961 |  2,961 |  2,961 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 3,385 | 18,019 | 4,157,963 | 459,031,512 | 13,687 | 2,080 | 2,634 | 2,878 | 2,961 | 2,766 | 186,733,246 | 362 | 947 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 251 | 2,559 | 284,567 | 38,417,467 | 2,156 | 224 | 479 | 360 | 654 | 395 | 15,055,723 | 32 | 152 | 

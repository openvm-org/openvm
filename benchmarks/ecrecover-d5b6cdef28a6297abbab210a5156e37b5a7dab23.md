...
| `stark_prove_excluding_trace_time_ms` |  2,183 |  2,183 |  2,183 |  2,183 |
...
| `pcs_opening_time_ms ` |  681 |  681 |  681 |  681 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  18,140 |  18,140 |  18,140 |  18,140 |
| `main_cells_used     ` |  186,732,049 |  186,732,049 |  186,732,049 |  186,732,049 |
| `total_cycles        ` |  4,157,830 |  4,157,830 |  4,157,830 |  4,157,830 |
| `execute_time_ms     ` |  952 |  952 |  952 |  952 |
| `trace_gen_time_ms   ` |  3,470 |  3,470 |  3,470 |  3,470 |
| `stark_prove_excluding_trace_time_ms` |  13,718 |  13,718 |  13,718 |  13,718 |
| `main_trace_commit_time_ms` |  2,786 |  2,786 |  2,786 |  2,786 |
| `generate_perm_trace_time_ms` |  354 |  354 |  354 |  354 |
| `perm_trace_commit_time_ms` |  2,868 |  2,868 |  2,868 |  2,868 |
| `quotient_poly_compute_time_ms` |  2,082 |  2,082 |  2,082 |  2,082 |
| `quotient_poly_commit_time_ms` |  2,643 |  2,643 |  2,643 |  2,643 |
| `pcs_opening_time_ms ` |  2,980 |  2,980 |  2,980 |  2,980 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 3,470 | 18,140 | 4,157,830 | 459,031,512 | 13,718 | 2,082 | 2,643 | 2,868 | 2,980 | 2,786 | 186,732,049 | 354 | 952 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 254 | 2,586 | 284,567 | 38,417,467 | 2,183 | 231 | 468 | 356 | 681 | 397 | 15,055,723 | 35 | 149 | 

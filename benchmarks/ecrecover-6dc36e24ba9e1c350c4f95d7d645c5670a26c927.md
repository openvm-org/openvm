...
| `total_proof_time_ms ` |  2,502 |  2,502 |  2,502 |  2,502 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  10,873 |  10,873 |  10,873 |  10,873 |
| `main_cells_used     ` |  116,986,378 |  116,986,378 |  116,986,378 |  116,986,378 |
| `total_cycles        ` |  1,591,587 |  1,591,587 |  1,591,587 |  1,591,587 |
| `execute_time_ms     ` |  571 |  571 |  571 |  571 |
| `trace_gen_time_ms   ` |  1,507 |  1,507 |  1,507 |  1,507 |
| `stark_prove_excluding_trace_time_ms` |  8,795 |  8,795 |  8,795 |  8,795 |
| `main_trace_commit_time_ms` |  1,781 |  1,781 |  1,781 |  1,781 |
| `generate_perm_trace_time_ms` |  263 |  263 |  263 |  263 |
| `perm_trace_commit_time_ms` |  1,878 |  1,878 |  1,878 |  1,878 |
| `quotient_poly_compute_time_ms` |  1,456 |  1,456 |  1,456 |  1,456 |
| `quotient_poly_commit_time_ms` |  1,613 |  1,613 |  1,613 |  1,613 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,507 | 10,873 | 1,591,587 | 334,709,720 | 8,795 | 1,456 | 1,613 | 1,878 | 1,801 | 1,781 | 116,986,378 | 263 | 571 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 181 | 2,502 | 284,567 | 38,417,467 | 2,172 | 225 | 483 | 359 | 671 | 388 | 15,055,723 | 33 | 149 | 

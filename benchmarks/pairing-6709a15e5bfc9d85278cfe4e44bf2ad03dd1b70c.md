...
| `total_proof_time_ms ` |  4,672 |  4,672 |  4,672 |  4,672 |
...
| `main_trace_commit_time_ms` |  597 |  597 |  597 |  597 |
...
| `quotient_poly_commit_time_ms` |  333 |  333 |  333 |  333 |
| `pcs_opening_time_ms ` |  754 |  754 |  754 |  754 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  14,142 |  14,142 |  14,142 |  14,142 |
| `main_cells_used     ` |  275,729,620 |  275,729,620 |  275,729,620 |  275,729,620 |
| `total_cycles        ` |  3,305,893 |  3,305,893 |  3,305,893 |  3,305,893 |
| `execute_time_ms     ` |  1,231 |  1,231 |  1,231 |  1,231 |
| `trace_gen_time_ms   ` |  2,642 |  2,642 |  2,642 |  2,642 |
| `stark_prove_excluding_trace_time_ms` |  10,269 |  10,269 |  10,269 |  10,269 |
| `main_trace_commit_time_ms` |  1,754 |  1,754 |  1,754 |  1,754 |
| `generate_perm_trace_time_ms` |  723 |  723 |  723 |  723 |
| `perm_trace_commit_time_ms` |  3,368 |  3,368 |  3,368 |  3,368 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 2,642 | 14,142 | 3,305,893 | 1,071,746,538 | 10,269 | 1,478 | 976 | 3,368 | 1,963 | 1,754 | 275,729,620 | 723 | 1,231 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 886 | 4,672 | 1,711,640 | 297,389,207 | 3,117 | 465 | 333 | 766 | 754 | 597 | 92,620,923 | 186 | 669 | 

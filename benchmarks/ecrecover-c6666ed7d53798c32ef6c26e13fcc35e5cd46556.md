...
| `total_proof_time_ms ` |  2,588 |  2,588 |  2,588 |  2,588 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  18,526 |  18,526 |  18,526 |  18,526 |
| `main_cells_used     ` |  193,204,266 |  193,204,266 |  193,204,266 |  193,204,266 |
| `total_cycles        ` |  4,155,708 |  4,155,708 |  4,155,708 |  4,155,708 |
| `execute_time_ms     ` |  986 |  986 |  986 |  986 |
| `trace_gen_time_ms   ` |  3,524 |  3,524 |  3,524 |  3,524 |
| `stark_prove_excluding_trace_time_ms` |  14,016 |  14,016 |  14,016 |  14,016 |
| `main_trace_commit_time_ms` |  2,946 |  2,946 |  2,946 |  2,946 |
...
| `quotient_poly_commit_time_ms` |  2,698 |  2,698 |  2,698 |  2,698 |
| `pcs_opening_time_ms ` |  2,972 |  2,972 |  2,972 |  2,972 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 3,524 | 18,526 | 4,155,708 | 466,306,008 | 14,016 | 2,103 | 2,698 | 2,933 | 2,972 | 2,946 | 193,204,266 | 360 | 986 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 262 | 2,588 | 285,401 | 38,415,035 | 2,172 | 232 | 473 | 356 | 667 | 397 | 15,075,033 | 33 | 154 | 

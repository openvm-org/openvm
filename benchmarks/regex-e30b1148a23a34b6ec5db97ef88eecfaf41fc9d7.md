...
| `total_proof_time_ms ` |  587.25 |  2,349 |  717 |  542 |
...
| `execute_preflight_insn_mi/s` |  32.31 | -          |  33.74 |  29.16 |
| `trace_gen_time_ms   ` |  177.25 |  709 |  212 |  154 |
| `memory_finalize_time_ms` |  1 |  4 |  4 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  283.50 |  1,134 |  291 |  274 |
| `main_trace_commit_time_ms` |  50.75 |  203 |  56 |  49 |
| `generate_perm_trace_time_ms` |  23.50 |  94 |  29 |  20 |
| `perm_trace_commit_time_ms` |  63.57 |  254.29 |  68.57 |  54.88 |
| `quotient_poly_compute_time_ms` |  57.18 |  228.71 |  68.44 |  52.28 |
| `quotient_poly_commit_time_ms` |  15.62 |  62.48 |  18.55 |  12.98 |
| `pcs_opening_time_ms ` |  69.50 |  278 |  76 |  63 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,387.50 |  5,550 |  2,042 |  908 |
...
| `execute_preflight_insns` |  1,440,854.75 |  5,763,419 |  1,814,584 |  1,241,388 |
| `execute_preflight_time_ms` |  629.50 |  2,518 |  843 |  228 |
| `execute_preflight_insn_mi/s` |  6.99 | -          |  7.41 |  6.75 |
| `trace_gen_time_ms   ` |  86.75 |  347 |  159 |  59 |
| `memory_finalize_time_ms` |  9 |  36 |  18 |  5 |
| `stark_prove_excluding_trace_time_ms` |  669.75 |  2,679 |  1,107 |  473 |
| `main_trace_commit_time_ms` |  123.75 |  495 |  193 |  90 |
| `generate_perm_trace_time_ms` |  51.50 |  206 |  74 |  37 |
| `perm_trace_commit_time_ms` |  207.83 |  831.31 |  381.06 |  138.46 |
| `quotient_poly_compute_time_ms` |  144.71 |  578.84 |  238.82 |  102.30 |
| `quotient_poly_commit_time_ms` |  32.98 |  131.93 |  57.29 |  23.95 |
| `pcs_opening_time_ms ` |  105 |  420 |  156 |  74 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 2,044 |  | 1 | 1 |  |  |  |  | 
| regex_program |  | 542 |  | 1 | 38 | 4,137,502 | 107.62 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 69 | 908 | 22,981,570 | 319,331,818 | 69 | 610 | 0 | 133.19 | 25.78 | 4 | 169.82 | 106 | 222 | 106 | 7 | 121 | 9,122,488 | 51 | 228 | 1,466,017 | 7.41 | 31 | 160 | 0 | 106 | 
| leaf | 1 | 59 | 1,376 | 20,905,034 | 255,237,610 | 59 | 473 | 0 | 102.30 | 23.95 | 4 | 141.97 | 74 | 179 | 74 | 5 | 91 | 8,256,948 | 37 | 843 | 1,241,430 | 7.03 | 26 | 127 | 0 | 74 | 
| leaf | 2 | 60 | 1,224 | 20,905,034 | 255,237,610 | 60 | 489 | 0 | 104.52 | 24.90 | 4 | 138.46 | 84 | 183 | 84 | 6 | 90 | 8,256,948 | 44 | 673 | 1,241,388 | 6.79 | 26 | 130 | 0 | 84 | 
| leaf | 3 | 159 | 2,042 | 50,337,320 | 538,365,418 | 159 | 1,107 | 0 | 238.82 | 57.29 | 5 | 381.06 | 156 | 456 | 156 | 18 | 193 | 20,171,106 | 74 | 774 | 1,814,584 | 6.75 | 61 | 300 | 5 | 156 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 212 | 717 | 23,446,148 | 150,778,428 | 212 | 291 | 0 | 54.26 | 18.55 | 5 | 68.57 | 67 | 93 | 66 | 4 | 56 | 10,899,170 | 24 | 45 | 1,103,000 | 29.16 | 22 | 73 | 1 | 66 | 
| regex_program | 1 | 154 | 542 | 11,598,276 | 128,513,066 | 154 | 281 | 1 | 52.28 | 15.29 | 4 | 65.13 | 76 | 87 | 76 | 0 | 49 | 2,196,106 | 21 | 65 | 1,104,000 | 33.74 | 17 | 68 | 0 | 76 | 
| regex_program | 2 | 161 | 548 | 11,579,064 | 128,513,066 | 161 | 288 | 1 | 53.74 | 15.66 | 4 | 65.71 | 72 | 95 | 72 | 0 | 49 | 2,177,334 | 29 | 57 | 1,104,000 | 33.65 | 16 | 69 | 0 | 72 | 
| regex_program | 3 | 182 | 542 | 11,853,872 | 103,456,394 | 182 | 274 | 0 | 68.44 | 12.98 | 5 | 54.88 | 63 | 78 | 63 | 0 | 49 | 2,422,606 | 20 | 44 | 826,502 | 32.67 | 19 | 82 | 1 | 63 | 

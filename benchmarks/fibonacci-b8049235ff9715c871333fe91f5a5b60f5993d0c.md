...
| `total_proof_time_ms ` |  517 |  1,034 |  563 |  471 |
...
| `execute_metered_insn_mi/s` |  145.75 | -          |  145.75 |  145.75 |
| `execute_preflight_insns` |  750,104.50 |  1,500,209 |  873,000 |  627,209 |
| `execute_preflight_time_ms` |  29 |  58 |  33 |  25 |
| `execute_preflight_insn_mi/s` |  37.49 | -          |  39.22 |  35.76 |
| `trace_gen_time_ms   ` |  192 |  384 |  196 |  188 |
| `memory_finalize_time_ms` | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  201 |  402 |  208 |  194 |
| `main_trace_commit_time_ms` |  31 |  62 |  33 |  29 |
| `generate_perm_trace_time_ms` |  20 |  40 |  27 |  13 |
| `perm_trace_commit_time_ms` |  41.46 |  82.91 |  43.83 |  39.08 |
| `quotient_poly_compute_time_ms` |  32.94 |  65.87 |  35.38 |  30.50 |
| `quotient_poly_commit_time_ms` |  12.29 |  24.59 |  12.39 |  12.19 |
| `pcs_opening_time_ms ` |  62 |  124 |  83 |  41 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,014 |  2,028 |  1,269 |  759 |
| `main_cells_used     ` |  6,475,562 |  12,951,124 |  6,608,072 |  6,343,052 |
| `total_cells_used    ` |  17,568,644 |  35,137,288 |  17,887,054 |  17,250,234 |
| `execute_preflight_insns` |  1,190,385.50 |  2,380,771 |  1,229,581 |  1,151,190 |
| `execute_preflight_time_ms` |  500 |  1,000 |  801 |  199 |
| `execute_preflight_insn_mi/s` |  6.85 | -          |  6.91 |  6.79 |
| `trace_gen_time_ms   ` |  57 |  114 |  59 |  55 |
| `memory_finalize_time_ms` |  5.50 |  11 |  6 |  5 |
| `stark_prove_excluding_trace_time_ms` |  456 |  912 |  499 |  413 |
| `main_trace_commit_time_ms` |  84 |  168 |  92 |  76 |
| `generate_perm_trace_time_ms` |  47.50 |  95 |  50 |  45 |
| `perm_trace_commit_time_ms` |  124.71 |  249.42 |  142.16 |  107.26 |
| `quotient_poly_compute_time_ms` |  91.08 |  182.16 |  101.14 |  81.02 |
| `quotient_poly_commit_time_ms` |  21.55 |  43.11 |  23.59 |  19.52 |
| `pcs_opening_time_ms ` |  84.50 |  169 |  88 |  81 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program |  | 471 |  | 42 | 1 | 10 | 1,500,209 | 145.75 | 141 | 
| leaf | 1,271 |  | 1 |  | 1 |  |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 59 | 759 | 17,887,054 | 252,878,314 | 59 | 499 | 0 | 101.14 | 23.59 | 4 | 142.16 | 88 | 193 | 88 | 6 | 92 | 6,608,072 | 50 | 199 | 1,229,581 | 6.91 | 26 | 125 | 0 | 88 | 
| leaf | 1 | 55 | 1,269 | 17,250,234 | 207,789,546 | 55 | 413 | 0 | 81.02 | 19.52 | 4 | 107.26 | 81 | 153 | 81 | 5 | 76 | 6,343,052 | 45 | 801 | 1,151,190 | 6.79 | 22 | 101 | 0 | 81 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 196 | 563 | 9,677,708 | 84,395,212 | 196 | 194 | 0 | 35.38 | 12.39 | 4 | 43.83 | 41 | 71 | 41 | 0 | 33 | 1,035,986 | 27 | 25 | 873,000 | 35.76 | 14 | 48 | 0 | 41 | 
| fibonacci_program | 1 | 188 | 471 | 9,708,170 | 74,305,770 | 188 | 208 | 1 | 30.50 | 12.19 | 4 | 39.08 | 83 | 53 | 82 | 0 | 29 | 1,064,416 | 13 | 33 | 627,209 | 39.22 | 11 | 43 | 0 | 82 | 

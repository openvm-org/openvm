...
| `total_proof_time_ms ` |  3,854.50 |  7,709 |  4,404 |  3,305 |
...
| `trace_gen_time_ms   ` |  955.50 |  1,911 |  1,104 |  807 |
| `stark_prove_excluding_trace_time_ms` |  2,565 |  5,130 |  2,929 |  2,201 |
| `main_trace_commit_time_ms` |  446 |  892 |  524 |  368 |
| `generate_perm_trace_time_ms` |  167 |  334 |  188 |  146 |
| `perm_trace_commit_time_ms` |  648.50 |  1,297 |  753 |  544 |
| `quotient_poly_compute_time_ms` |  366 |  732 |  419 |  313 |
| `quotient_poly_commit_time_ms` |  271.50 |  543 |  315 |  228 |
| `pcs_opening_time_ms ` |  657 |  1,314 |  720 |  594 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,331 |  14,662 |  7,398 |  7,264 |
| `main_cells_used     ` |  152,447,866.50 |  304,895,733 |  154,909,173 |  149,986,560 |
| `total_cycles        ` |  1,994,032 |  3,988,064 |  2,024,918 |  1,963,146 |
| `execute_time_ms     ` |  791.50 |  1,583 |  798 |  785 |
| `trace_gen_time_ms   ` |  1,437 |  2,874 |  1,456 |  1,418 |
| `stark_prove_excluding_trace_time_ms` |  5,102.50 |  10,205 |  5,144 |  5,061 |
| `main_trace_commit_time_ms` |  837 |  1,674 |  839 |  835 |
| `generate_perm_trace_time_ms` |  347 |  694 |  362 |  332 |
| `perm_trace_commit_time_ms` |  1,596 |  3,192 |  1,619 |  1,573 |
| `quotient_poly_compute_time_ms` |  765 |  1,530 |  767 |  763 |
| `quotient_poly_commit_time_ms` |  501.50 |  1,003 |  503 |  500 |
| `pcs_opening_time_ms ` |  1,050.50 |  2,101 |  1,056 |  1,045 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,456 | 7,398 | 2,024,918 | 534,072,810 | 5,144 | 767 | 500 | 1,619 | 1,056 | 835 | 154,909,173 | 362 | 798 | 
| leaf | 1 | 1,418 | 7,264 | 1,963,146 | 534,072,810 | 5,061 | 763 | 503 | 1,573 | 1,045 | 839 | 149,986,560 | 332 | 785 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,104 | 4,404 | 2,225,434 | 275,652,919 | 2,929 | 419 | 315 | 753 | 720 | 524 | 93,699,990 | 188 | 371 | 
| regex_program | 1 | 807 | 3,305 | 1,914,730 | 198,099,628 | 2,201 | 313 | 228 | 544 | 594 | 368 | 73,689,460 | 146 | 297 | 

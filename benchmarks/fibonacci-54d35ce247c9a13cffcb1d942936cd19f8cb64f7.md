...
|:---|---:|---:|---:|
| Total |  3.10 |  1.88 | 1.88 |
| fibonacci_program |  1.05 |  0.60 |  0.60 |
| leaf |  2.05 |  1.27 |  1.27 |
...
| `total_proof_time_ms ` |  520.50 |  1,041 |  589 |  452 |
...
| `generate_perm_trace_time_ms` |  26.50 |  53 |  28 |  25 |
| `perm_trace_commit_time_ms` |  41.43 |  82.86 |  44.19 |  38.67 |
| `quotient_poly_compute_time_ms` |  31.51 |  63.01 |  34.84 |  28.17 |
| `quotient_poly_commit_time_ms` |  12.90 |  25.79 |  13.25 |  12.55 |
| `pcs_opening_time_ms ` |  48.50 |  97 |  55 |  42 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,024 |  2,048 |  1,275 |  773 |
| `main_cells_used     ` |  6,475,562 |  12,951,124 |  6,608,072 |  6,343,052 |
| `total_cells_used    ` |  17,568,644 |  35,137,288 |  17,887,054 |  17,250,234 |
| `execute_preflight_insns` |  1,190,364 |  2,380,728 |  1,229,581 |  1,151,147 |
| `execute_preflight_time_ms` |  509 |  1,018 |  816 |  202 |
| `execute_preflight_insn_mi/s` |  6.75 | -          |  6.84 |  6.67 |
| `trace_gen_time_ms   ` |  57 |  114 |  59 |  55 |
| `memory_finalize_time_ms` |  6 |  12 |  6 |  6 |
| `stark_prove_excluding_trace_time_ms` |  456.50 |  913 |  510 |  403 |
| `main_trace_commit_time_ms` |  84.50 |  169 |  92 |  77 |
| `generate_perm_trace_time_ms` |  45 |  90 |  58 |  32 |
| `perm_trace_commit_time_ms` |  124.100 |  249.100 |  141.12 |  108.88 |
| `quotient_poly_compute_time_ms` |  95.62 |  191.24 |  105.03 |  86.22 |
| `quotient_poly_commit_time_ms` |  23.33 |  46.67 |  24.86 |  21.80 |
| `pcs_opening_time_ms ` |  80 |  160 |  85 |  75 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program |  | 452 |  | 1 | 13 | 1,500,209 | 112.85 | 0 | 
| leaf | 1,277 |  | 1 | 1 |  |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 59 | 773 | 17,887,054 | 252,878,314 | 59 | 510 | 0 | 105.03 | 24.86 | 4 | 141.12 | 85 | 200 | 85 | 6 | 92 | 6,608,072 | 58 | 202 | 1,229,581 | 6.84 | 26 | 130 | 0 | 85 | 
| leaf | 1 | 55 | 1,275 | 17,250,234 | 207,789,546 | 55 | 403 | 0 | 86.22 | 21.80 | 4 | 108.88 | 75 | 142 | 74 | 6 | 77 | 6,343,052 | 32 | 816 | 1,151,147 | 6.67 | 23 | 108 | 0 | 74 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 195 | 589 | 9,677,708 | 84,395,212 | 195 | 197 | 0 | 34.84 | 13.25 | 4 | 44.19 | 42 | 73 | 42 | 0 | 33 | 1,035,986 | 28 | 26 | 873,000 | 34.09 | 14 | 48 | 0 | 42 | 
| fibonacci_program | 1 | 187 | 452 | 9,708,170 | 74,305,770 | 187 | 190 | 1 | 28.17 | 12.55 | 4 | 38.67 | 55 | 64 | 55 | 0 | 28 | 1,064,416 | 25 | 33 | 627,209 | 37.46 | 11 | 41 | 0 | 55 | 

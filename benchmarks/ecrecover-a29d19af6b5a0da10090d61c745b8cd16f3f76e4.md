...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  12,755 |  12,755 |  12,755 |  12,755 |
| `main_cells_used     ` |  244,253,254 |  244,253,254 |  244,253,254 |  244,253,254 |
| `total_cycles        ` |  2,988,604 |  2,988,604 |  2,988,604 |  2,988,604 |
| `execute_time_ms     ` |  1,110 |  1,110 |  1,110 |  1,110 |
| `trace_gen_time_ms   ` |  2,349 |  2,349 |  2,349 |  2,349 |
| `stark_prove_excluding_trace_time_ms` |  9,296 |  9,296 |  9,296 |  9,296 |
| `main_trace_commit_time_ms` |  1,602 |  1,602 |  1,602 |  1,602 |
| `generate_perm_trace_time_ms` |  768 |  768 |  768 |  768 |
| `perm_trace_commit_time_ms` |  2,957 |  2,957 |  2,957 |  2,957 |
| `quotient_poly_compute_time_ms` |  1,360 |  1,360 |  1,360 |  1,360 |
| `quotient_poly_commit_time_ms` |  827 |  827 |  827 |  827 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 2,349 | 12,755 | 2,988,604 | 1,008,831,978 | 9,296 | 1,360 | 827 | 2,957 | 1,777 | 1,602 | 244,253,254 | 768 | 1,110 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 182 | 1,425 | 289,447 | 48,240,297 | 1,096 | 126 | 157 | 188 | 402 | 172 | 14,470,186 | 34 | 147 | 

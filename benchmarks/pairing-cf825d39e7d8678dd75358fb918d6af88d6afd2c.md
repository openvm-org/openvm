...
| `quotient_poly_commit_time_ms` |  335 |  335 |  335 |  335 |
| `pcs_opening_time_ms ` |  769 |  769 |  769 |  769 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  14,103 |  14,103 |  14,103 |  14,103 |
| `main_cells_used     ` |  275,729,680 |  275,729,680 |  275,729,680 |  275,729,680 |
| `total_cycles        ` |  3,305,898 |  3,305,898 |  3,305,898 |  3,305,898 |
| `execute_time_ms     ` |  1,231 |  1,231 |  1,231 |  1,231 |
| `trace_gen_time_ms   ` |  2,588 |  2,588 |  2,588 |  2,588 |
| `stark_prove_excluding_trace_time_ms` |  10,284 |  10,284 |  10,284 |  10,284 |
| `main_trace_commit_time_ms` |  1,759 |  1,759 |  1,759 |  1,759 |
| `generate_perm_trace_time_ms` |  716 |  716 |  716 |  716 |
| `perm_trace_commit_time_ms` |  3,324 |  3,324 |  3,324 |  3,324 |
| `quotient_poly_compute_time_ms` |  1,469 |  1,469 |  1,469 |  1,469 |
| `quotient_poly_commit_time_ms` |  975 |  975 |  975 |  975 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 2,588 | 14,103 | 3,305,898 | 1,071,746,538 | 10,284 | 1,469 | 975 | 3,324 | 2,036 | 1,759 | 275,729,680 | 716 | 1,231 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 898 | 4,702 | 1,711,640 | 297,389,207 | 3,132 | 460 | 335 | 762 | 769 | 605 | 92,620,923 | 184 | 672 | 

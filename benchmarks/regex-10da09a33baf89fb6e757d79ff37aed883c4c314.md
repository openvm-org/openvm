...
| `total_proof_time_ms ` |  3,861 |  7,722 |  4,468 |  3,254 |
...
| `trace_gen_time_ms   ` |  953 |  1,906 |  1,148 |  758 |
| `stark_prove_excluding_trace_time_ms` |  2,571 |  5,142 |  2,946 |  2,196 |
| `main_trace_commit_time_ms` |  454 |  908 |  539 |  369 |
| `generate_perm_trace_time_ms` |  158.50 |  317 |  180 |  137 |
| `perm_trace_commit_time_ms` |  646.50 |  1,293 |  752 |  541 |
| `quotient_poly_compute_time_ms` |  364.50 |  729 |  424 |  305 |
| `quotient_poly_commit_time_ms` |  275.50 |  551 |  321 |  230 |
| `pcs_opening_time_ms ` |  663 |  1,326 |  720 |  606 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,491.50 |  14,983 |  7,522 |  7,461 |
| `main_cells_used     ` |  152,709,939.50 |  305,419,879 |  155,169,719 |  150,250,160 |
| `total_cycles        ` |  1,991,023 |  3,982,046 |  2,021,871 |  1,960,175 |
| `execute_time_ms     ` |  764 |  1,528 |  773 |  755 |
| `trace_gen_time_ms   ` |  1,448.50 |  2,897 |  1,466 |  1,431 |
| `stark_prove_excluding_trace_time_ms` |  5,279 |  10,558 |  5,318 |  5,240 |
| `main_trace_commit_time_ms` |  894 |  1,788 |  895 |  893 |
| `generate_perm_trace_time_ms` |  346 |  692 |  349 |  343 |
| `perm_trace_commit_time_ms` |  1,676 |  3,352 |  1,710 |  1,642 |
| `quotient_poly_compute_time_ms` |  766.50 |  1,533 |  770 |  763 |
| `quotient_poly_commit_time_ms` |  528.50 |  1,057 |  530 |  527 |
| `pcs_opening_time_ms ` |  1,063.50 |  2,127 |  1,064 |  1,063 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,431 | 7,522 | 2,021,871 | 538,660,330 | 5,318 | 770 | 527 | 1,710 | 1,063 | 895 | 155,169,719 | 349 | 773 | 
| leaf | 1 | 1,466 | 7,461 | 1,960,175 | 538,660,330 | 5,240 | 763 | 530 | 1,642 | 1,064 | 893 | 150,250,160 | 343 | 755 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,148 | 4,468 | 2,225,434 | 275,652,919 | 2,946 | 424 | 321 | 752 | 720 | 539 | 93,738,635 | 180 | 374 | 
| regex_program | 1 | 758 | 3,254 | 1,914,993 | 198,099,628 | 2,196 | 305 | 230 | 541 | 606 | 369 | 73,709,236 | 137 | 300 | 

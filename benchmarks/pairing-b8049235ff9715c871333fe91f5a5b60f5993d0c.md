...
| `total_proof_time_ms ` |  730.50 |  1,461 |  836 |  625 |
...
| `execute_preflight_insn_mi/s` |  13.62 | -          |  18.13 |  9.11 |
| `trace_gen_time_ms   ` |  177.50 |  355 |  194 |  161 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  363 |  726 |  397 |  329 |
| `main_trace_commit_time_ms` |  64 |  128 |  74 |  54 |
| `generate_perm_trace_time_ms` |  46 |  92 |  47 |  45 |
| `perm_trace_commit_time_ms` |  76.45 |  152.90 |  88.73 |  64.18 |
| `quotient_poly_compute_time_ms` |  79.02 |  158.05 |  87.28 |  70.77 |
| `quotient_poly_commit_time_ms` |  16.55 |  33.10 |  18.69 |  14.41 |
| `pcs_opening_time_ms ` |  76 |  152 |  76 |  76 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,444 |  2,888 |  1,722 |  1,166 |
| `main_cells_used     ` |  16,200,472 |  32,400,944 |  16,332,746 |  16,068,198 |
| `total_cells_used    ` |  39,332,920 |  78,665,840 |  39,650,868 |  39,014,972 |
| `execute_preflight_insns` |  1,952,428 |  3,904,856 |  1,991,958 |  1,912,898 |
| `execute_preflight_time_ms` |  589.50 |  1,179 |  884 |  295 |
| `execute_preflight_insn_mi/s` |  7.73 | -          |  7.80 |  7.67 |
| `trace_gen_time_ms   ` |  119 |  238 |  127 |  111 |
| `memory_finalize_time_ms` |  12 |  24 |  12 |  12 |
| `stark_prove_excluding_trace_time_ms` |  734 |  1,468 |  743 |  725 |
| `main_trace_commit_time_ms` |  145 |  290 |  148 |  142 |
| `generate_perm_trace_time_ms` |  54.50 |  109 |  57 |  52 |
| `perm_trace_commit_time_ms` |  226.52 |  453.04 |  230.78 |  222.26 |
| `quotient_poly_compute_time_ms` |  168.23 |  336.46 |  170.08 |  166.38 |
| `quotient_poly_commit_time_ms` |  30.98 |  61.97 |  32.61 |  29.36 |
| `pcs_opening_time_ms ` |  104.50 |  209 |  105 |  104 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 1,724 |  | 1 |  | 1 |  |  |  |  | 
| pairing |  | 625 |  | 53 | 1 | 89 | 1,745,742 | 19.53 | 157 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 127 | 1,166 | 39,650,868 | 410,701,290 | 127 | 743 | 0 | 170.08 | 32.61 | 4 | 230.78 | 105 | 284 | 105 | 12 | 148 | 16,332,746 | 52 | 295 | 1,991,958 | 7.67 | 39 | 204 | 0 | 105 | 
| leaf | 1 | 111 | 1,722 | 39,014,972 | 396,840,426 | 111 | 725 | 0 | 166.38 | 29.36 | 4 | 222.26 | 104 | 280 | 104 | 12 | 142 | 16,068,198 | 57 | 884 | 1,912,898 | 7.80 | 38 | 197 | 0 | 104 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 161 | 836 | 32,689,110 | 172,558,444 | 161 | 397 | 0 | 87.28 | 18.69 | 6 | 88.73 | 76 | 139 | 75 | 1 | 74 | 16,059,916 | 47 | 130 | 1,157,000 | 9.11 | 27 | 106 | 1 | 75 | 
| pairing | 1 | 194 | 625 | 22,314,288 | 119,958,502 | 194 | 329 | 1 | 70.77 | 14.41 | 6 | 64.18 | 76 | 112 | 76 | 0 | 54 | 9,408,294 | 45 | 60 | 588,742 | 18.13 | 20 | 85 | 1 | 76 | 

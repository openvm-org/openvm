...
| `total_proof_time_ms ` |  3,813 |  7,626 |  4,882 |  2,744 |
...
| `execute_metered_insn_mi/s` |  130.66 | -          |  130.66 |  130.66 |
| `execute_preflight_insns` |  2,054,298.50 |  4,108,597 |  2,211,000 |  1,897,597 |
| `execute_preflight_time_ms` |  92.50 |  185 |  101 |  84 |
| `execute_preflight_insn_mi/s` |  28.68 | -          |  31.27 |  26.10 |
| `trace_gen_time_ms   ` |  379.50 |  759 |  489 |  270 |
| `memory_finalize_time_ms` |  7.50 |  15 |  13 |  2 |
| `stark_prove_excluding_trace_time_ms` |  3,109.50 |  6,219 |  4,046 |  2,173 |
| `main_trace_commit_time_ms` |  629.50 |  1,259 |  844 |  415 |
| `generate_perm_trace_time_ms` |  234 |  468 |  313 |  155 |
| `perm_trace_commit_time_ms` |  649.50 |  1,299 |  850 |  449 |
| `quotient_poly_compute_time_ms` |  326 |  652 |  438 |  214 |
| `quotient_poly_commit_time_ms` |  299 |  598 |  394 |  204 |
| `pcs_opening_time_ms ` |  961 |  1,922 |  1,203 |  719 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  5,652.50 |  11,305 |  6,807 |  4,498 |
| `main_cells_used     ` |  122,268,903 |  244,537,806 |  153,709,136 |  90,828,670 |
| `total_cells_used    ` |  304,355,261 |  608,710,522 |  391,462,202 |  217,248,320 |
| `execute_preflight_insns` |  1,663,250 |  3,326,500 |  1,830,048 |  1,496,452 |
| `execute_preflight_time_ms` |  585.50 |  1,171 |  733 |  438 |
| `execute_preflight_insn_mi/s` |  4.34 | -          |  4.48 |  4.19 |
| `trace_gen_time_ms   ` |  294 |  588 |  363 |  225 |
| `memory_finalize_time_ms` |  12 |  24 |  16 |  8 |
| `stark_prove_excluding_trace_time_ms` |  3,757.50 |  7,515 |  4,692 |  2,823 |
| `main_trace_commit_time_ms` |  703 |  1,406 |  836 |  570 |
| `generate_perm_trace_time_ms` |  324.50 |  649 |  418 |  231 |
| `perm_trace_commit_time_ms` |  957.50 |  1,915 |  1,246 |  669 |
| `quotient_poly_compute_time_ms` |  410 |  820 |  517 |  303 |
| `quotient_poly_commit_time_ms` |  321 |  642 |  379 |  263 |
| `pcs_opening_time_ms ` |  1,037 |  2,074 |  1,292 |  782 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 6,809 |  | 1 |  | 1 |  |  |  |  | 
| regex_program |  | 2,744 |  | 6 | 1 | 31 | 4,108,597 | 130.66 | 44 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 225 | 4,498 | 217,248,320 | 319,626,730 | 225 | 2,823 | 0 | 303 | 263 | 669 | 782 | 8 | 570 | 90,828,670 | 231 | 438 | 1,496,452 | 4.19 | 
| leaf | 1 | 363 | 6,807 | 391,462,202 | 538,660,330 | 363 | 4,692 | 0 | 517 | 379 | 1,246 | 1,292 | 16 | 836 | 153,709,136 | 418 | 733 | 1,830,048 | 4.48 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 489 | 4,882 | 211,758,557 | 373,183,036 | 489 | 4,046 | 0 | 438 | 394 | 850 | 1,203 | 7 | 13 | 844 | 91,281,687 | 313 | 101 | 2,211,000 | 26.10 | 
| regex_program | 1 | 270 | 2,744 | 174,326,267 | 196,838,026 | 270 | 2,173 | 50 | 214 | 204 | 449 | 719 | 8 | 2 | 415 | 73,453,305 | 155 | 84 | 1,897,597 | 31.27 | 

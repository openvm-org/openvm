...
| `total_proof_time_ms ` |  3,886.50 |  7,773 |  4,279 |  3,494 |
| `main_cells_used     ` |  83,255,576 |  166,511,152 |  93,500,799 |  73,010,353 |
| `total_cycles        ` |  2,082,613 |  4,165,226 |  2,243,715 |  1,921,511 |
| `execute_time_ms     ` |  349.50 |  699 |  388 |  311 |
| `trace_gen_time_ms   ` |  955.50 |  1,911 |  1,109 |  802 |
| `stark_prove_excluding_trace_time_ms` |  2,581.50 |  5,163 |  2,782 |  2,381 |
| `main_trace_commit_time_ms` |  500 |  1,000 |  556 |  444 |
| `generate_perm_trace_time_ms` |  202 |  404 |  218 |  186 |
| `perm_trace_commit_time_ms` |  550 |  1,100 |  573 |  527 |
| `quotient_poly_compute_time_ms` |  265.50 |  531 |  292 |  239 |
| `quotient_poly_commit_time_ms` |  244 |  488 |  279 |  209 |
| `pcs_opening_time_ms ` |  809 |  1,618 |  853 |  765 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,001 |  14,002 |  7,070 |  6,932 |
| `main_cells_used     ` |  151,827,929 |  303,655,858 |  154,227,998 |  149,427,860 |
| `total_cycles        ` |  1,975,734 |  3,951,468 |  2,006,579 |  1,944,889 |
| `execute_time_ms     ` |  777 |  1,554 |  784 |  770 |
| `trace_gen_time_ms   ` |  1,487.50 |  2,975 |  1,513 |  1,462 |
| `stark_prove_excluding_trace_time_ms` |  4,736.50 |  9,473 |  4,773 |  4,700 |
| `main_trace_commit_time_ms` |  869.50 |  1,739 |  872 |  867 |
| `generate_perm_trace_time_ms` |  397 |  794 |  424 |  370 |
| `perm_trace_commit_time_ms` |  1,241.50 |  2,483 |  1,247 |  1,236 |
| `quotient_poly_compute_time_ms` |  520.50 |  1,041 |  523 |  518 |
| `quotient_poly_commit_time_ms` |  415 |  830 |  417 |  413 |
| `pcs_opening_time_ms ` |  1,286.50 |  2,573 |  1,290 |  1,283 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,513 | 7,070 | 2,006,579 | 538,660,330 | 4,773 | 523 | 413 | 1,247 | 1,290 | 867 | 154,227,998 | 424 | 784 | 
| leaf | 1 | 1,462 | 6,932 | 1,944,889 | 538,660,330 | 4,700 | 518 | 417 | 1,236 | 1,283 | 872 | 149,427,860 | 370 | 770 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,109 | 4,279 | 2,243,715 | 275,652,919 | 2,782 | 292 | 279 | 573 | 853 | 556 | 93,500,799 | 218 | 388 | 
| regex_program | 1 | 802 | 3,494 | 1,921,511 | 242,975,404 | 2,381 | 239 | 209 | 527 | 765 | 444 | 73,010,353 | 186 | 311 | 

...
| `total_proof_time_ms ` |  499.50 |  999 |  569 |  430 |
...
| `execute_preflight_insn_mi/s` |  34.73 | -          |  35.05 |  34.41 |
| `trace_gen_time_ms   ` |  188.50 |  377 |  194 |  183 |
| `memory_finalize_time_ms` | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  187.50 |  375 |  205 |  170 |
| `main_trace_commit_time_ms` |  30.50 |  61 |  33 |  28 |
| `generate_perm_trace_time_ms` |  18 |  36 |  20 |  16 |
| `perm_trace_commit_time_ms` |  41.42 |  82.83 |  44.27 |  38.57 |
| `quotient_poly_compute_time_ms` |  30.22 |  60.44 |  32.77 |  27.67 |
| `quotient_poly_commit_time_ms` |  11.91 |  23.82 |  12.76 |  11.06 |
| `pcs_opening_time_ms ` |  53.50 |  107 |  64 |  43 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,027.50 |  2,055 |  1,316 |  739 |
| `main_cells_used     ` |  6,475,562 |  12,951,124 |  6,608,072 |  6,343,052 |
| `total_cells_used    ` |  17,568,644 |  35,137,288 |  17,887,054 |  17,250,234 |
| `execute_preflight_insns` |  1,190,378.50 |  2,380,757 |  1,229,578 |  1,151,179 |
| `execute_preflight_time_ms` |  521.50 |  1,043 |  838 |  205 |
| `execute_preflight_insn_mi/s` |  6.62 | -          |  6.69 |  6.55 |
| `trace_gen_time_ms   ` |  57 |  114 |  60 |  54 |
| `memory_finalize_time_ms` |  5.50 |  11 |  6 |  5 |
| `stark_prove_excluding_trace_time_ms` |  447.50 |  895 |  473 |  422 |
| `main_trace_commit_time_ms` |  83 |  166 |  91 |  75 |
| `generate_perm_trace_time_ms` |  46 |  92 |  53 |  39 |
| `perm_trace_commit_time_ms` |  123.97 |  247.93 |  142.68 |  105.25 |
| `quotient_poly_compute_time_ms` |  91.18 |  182.36 |  99.30 |  83.06 |
| `quotient_poly_commit_time_ms` |  21.26 |  42.53 |  22.74 |  19.79 |
| `pcs_opening_time_ms ` |  79 |  158 |  83 |  75 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program |  | 430 |  | 41 | 1 | 10 | 1,500,209 | 145.59 | 141 | 
| leaf | 1,317 |  | 1 |  | 1 |  |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 60 | 739 | 17,887,054 | 252,878,314 | 60 | 473 | 0 | 99.30 | 22.74 | 4 | 142.68 | 75 | 183 | 75 | 6 | 91 | 6,608,072 | 39 | 205 | 1,229,578 | 6.69 | 25 | 123 | 0 | 75 | 
| leaf | 1 | 54 | 1,316 | 17,250,234 | 207,789,546 | 54 | 422 | 0 | 83.06 | 19.79 | 4 | 105.25 | 83 | 159 | 83 | 5 | 75 | 6,343,052 | 53 | 838 | 1,151,179 | 6.55 | 22 | 103 | 0 | 83 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 194 | 569 | 9,677,708 | 84,395,212 | 194 | 205 | 0 | 32.77 | 12.76 | 4 | 44.27 | 64 | 61 | 64 | 0 | 33 | 1,035,986 | 16 | 26 | 873,000 | 34.41 | 14 | 46 | 0 | 64 | 
| fibonacci_program | 1 | 183 | 430 | 9,708,170 | 74,305,770 | 183 | 170 | 1 | 27.67 | 11.06 | 4 | 38.57 | 43 | 59 | 43 | 0 | 28 | 1,064,416 | 20 | 35 | 627,209 | 35.05 | 11 | 39 | 0 | 43 | 

...
| `total_proof_time_ms ` |  4,146 |  8,292 |  4,573 |  3,719 |
| `main_cells_used     ` |  83,910,936 |  167,821,872 |  94,156,159 |  73,665,713 |
| `total_cycles        ` |  2,082,613 |  4,165,226 |  2,243,715 |  1,921,511 |
| `execute_time_ms     ` |  336.50 |  673 |  373 |  300 |
| `trace_gen_time_ms   ` |  964.50 |  1,929 |  1,128 |  801 |
| `stark_prove_excluding_trace_time_ms` |  2,845 |  5,690 |  3,072 |  2,618 |
| `main_trace_commit_time_ms` |  524.50 |  1,049 |  587 |  462 |
| `generate_perm_trace_time_ms` |  190 |  380 |  193 |  187 |
| `perm_trace_commit_time_ms` |  748.50 |  1,497 |  804 |  693 |
| `quotient_poly_compute_time_ms` |  384.50 |  769 |  411 |  358 |
| `quotient_poly_commit_time_ms` |  296.50 |  593 |  333 |  260 |
| `pcs_opening_time_ms ` |  691 |  1,382 |  734 |  648 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,506 |  15,012 |  7,592 |  7,420 |
| `main_cells_used     ` |  152,277,925 |  304,555,850 |  154,677,790 |  149,878,060 |
| `total_cycles        ` |  1,991,005 |  3,982,010 |  2,021,833 |  1,960,177 |
| `execute_time_ms     ` |  758 |  1,516 |  767 |  749 |
| `trace_gen_time_ms   ` |  1,482 |  2,964 |  1,526 |  1,438 |
| `stark_prove_excluding_trace_time_ms` |  5,266 |  10,532 |  5,299 |  5,233 |
| `main_trace_commit_time_ms` |  893 |  1,786 |  895 |  891 |
| `generate_perm_trace_time_ms` |  360 |  720 |  362 |  358 |
| `perm_trace_commit_time_ms` |  1,671.50 |  3,343 |  1,707 |  1,636 |
| `quotient_poly_compute_time_ms` |  761.50 |  1,523 |  764 |  759 |
| `quotient_poly_commit_time_ms` |  525 |  1,050 |  525 |  525 |
| `pcs_opening_time_ms ` |  1,050.50 |  2,101 |  1,051 |  1,050 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,526 | 7,592 | 2,021,833 | 538,660,330 | 5,299 | 759 | 525 | 1,707 | 1,051 | 891 | 154,677,790 | 362 | 767 | 
| leaf | 1 | 1,438 | 7,420 | 1,960,177 | 538,660,330 | 5,233 | 764 | 525 | 1,636 | 1,050 | 895 | 149,878,060 | 358 | 749 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,128 | 4,573 | 2,243,715 | 275,652,919 | 3,072 | 411 | 333 | 804 | 734 | 587 | 94,156,159 | 193 | 373 | 
| regex_program | 1 | 801 | 3,719 | 1,921,511 | 242,975,404 | 2,618 | 358 | 260 | 693 | 648 | 462 | 73,665,713 | 187 | 300 | 

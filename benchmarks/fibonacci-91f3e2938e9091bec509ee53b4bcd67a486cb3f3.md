...
| `perm_trace_commit_time_ms` |  42.28 |  84.55 |  45.54 |  39.01 |
| `quotient_poly_compute_time_ms` |  32.60 |  65.19 |  34.55 |  30.65 |
| `quotient_poly_commit_time_ms` |  12.20 |  24.39 |  12.31 |  12.08 |
| `pcs_opening_time_ms ` |  42.50 |  85 |  44 |  41 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  984.50 |  1,969 |  1,235 |  734 |
...
| `execute_preflight_time_ms` |  488 |  976 |  782 |  194 |
| `execute_preflight_insn_mi/s` |  6.100 | -          |  7.13 |  6.87 |
| `trace_gen_time_ms   ` |  56 |  112 |  58 |  54 |
| `memory_finalize_time_ms` |  5.50 |  11 |  6 |  5 |
| `stark_prove_excluding_trace_time_ms` |  439.50 |  879 |  480 |  399 |
| `main_trace_commit_time_ms` |  83.50 |  167 |  92 |  75 |
| `generate_perm_trace_time_ms` |  32 |  64 |  36 |  28 |
| `perm_trace_commit_time_ms` |  124.58 |  249.16 |  142.21 |  106.95 |
| `quotient_poly_compute_time_ms` |  89.77 |  179.53 |  99.71 |  79.82 |
| `quotient_poly_commit_time_ms` |  21.32 |  42.64 |  23.37 |  19.27 |
| `pcs_opening_time_ms ` |  85.50 |  171 |  87 |  84 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program |  | 426 |  | 1 | 12 | 1,500,209 | 115.35 | 0 | 
| leaf | 1,237 |  | 1 | 1 |  |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 58 | 734 | 17,887,054 | 252,878,314 | 58 | 480 | 0 | 99.71 | 23.37 | 4 | 142.21 | 84 | 179 | 84 | 6 | 92 | 6,608,072 | 36 | 194 | 1,229,730 | 7.13 | 25 | 124 | 0 | 84 | 
| leaf | 1 | 54 | 1,235 | 17,250,234 | 207,789,546 | 54 | 399 | 0 | 79.82 | 19.27 | 4 | 106.95 | 87 | 135 | 86 | 5 | 75 | 6,343,052 | 28 | 782 | 1,151,166 | 6.87 | 22 | 99 | 0 | 86 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 196 | 553 | 9,677,708 | 84,395,212 | 196 | 188 | 0 | 34.55 | 12.31 | 4 | 45.54 | 44 | 62 | 44 | 0 | 33 | 1,035,986 | 16 | 25 | 873,000 | 34.78 | 14 | 47 | 0 | 44 | 
| fibonacci_program | 1 | 186 | 426 | 9,708,170 | 74,305,770 | 186 | 166 | 1 | 30.65 | 12.08 | 4 | 39.01 | 41 | 52 | 41 | 0 | 28 | 1,064,416 | 12 | 32 | 627,209 | 38.62 | 11 | 43 | 0 | 41 | 
...
Commit: https://github.com/openvm-org/openvm/commit/91f3e2938e9091bec509ee53b4bcd67a486cb3f3
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19476706755)

...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  2,791 |  2,791 |  2,791 |  2,791 |
| `main_cells_used     ` |  29,404,728 |  29,404,728 |  29,404,728 |  29,404,728 |
| `total_cells_used    ` |  71,174,330 |  71,174,330 |  71,174,330 |  71,174,330 |
| `execute_preflight_insns` |  2,934,825 |  2,934,825 |  2,934,825 |  2,934,825 |
| `execute_preflight_time_ms` |  433 |  433 |  433 |  433 |
| `execute_preflight_insn_mi/s` |  7.47 | -          |  7.47 |  7.47 |
| `trace_gen_time_ms   ` |  245 |  245 |  245 |  245 |
| `memory_finalize_time_ms` |  22 |  22 |  22 |  22 |
| `stark_prove_excluding_trace_time_ms` |  2,112 |  2,112 |  2,112 |  2,112 |
| `main_trace_commit_time_ms` |  374 |  374 |  374 |  374 |
| `generate_perm_trace_time_ms` |  192 |  192 |  192 |  192 |
| `perm_trace_commit_time_ms` |  686.83 |  686.83 |  686.83 |  686.83 |
| `quotient_poly_compute_time_ms` |  456.84 |  456.84 |  456.84 |  456.84 |
| `quotient_poly_commit_time_ms` |  97.17 |  97.17 |  97.17 |  97.17 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program |  | 741 |  | 1 | 6 | 122,859 | 19.83 | 0 | 
| leaf | 2,794 |  | 1 | 1 |  |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 245 | 2,791 | 71,174,330 | 992,054,762 | 245 | 2,112 | 0 | 456.84 | 97.17 | 4 | 686.83 | 296 | 879 | 296 | 22 | 374 | 29,404,728 | 192 | 433 | 2,934,825 | 7.47 | 136 | 561 | 9 | 296 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 209 | 741 | 11,346,486 | 31,789,298 | 209 | 300 | 0 | 104.66 | 9.10 | 8 | 34.05 | 58 | 89 | 58 | 0 | 37 | 2,265,100 | 48 | 63 | 122,859 | 2.20 | 21 | 114 | 2 | 58 | 

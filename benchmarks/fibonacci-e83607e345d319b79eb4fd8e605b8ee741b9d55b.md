...
| `total_proof_time_ms ` |  505.50 |  1,011 |  562 |  449 |
...
| `execute_metered_insn_mi/s` |  145.41 | -          |  145.41 |  145.41 |
| `execute_preflight_insns` |  750,105 |  1,500,210 |  873,000 |  627,210 |
| `execute_preflight_time_ms` |  28.50 |  57 |  32 |  25 |
| `execute_preflight_insn_mi/s` |  38.22 | -          |  40.17 |  36.28 |
| `trace_gen_time_ms   ` |  192 |  384 |  198 |  186 |
| `memory_finalize_time_ms` | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  191 |  382 |  193 |  189 |
| `main_trace_commit_time_ms` |  30 |  60 |  32 |  28 |
| `generate_perm_trace_time_ms` |  29 |  58 |  38 |  20 |
| `perm_trace_commit_time_ms` |  40.66 |  81.32 |  43.44 |  37.88 |
| `quotient_poly_compute_time_ms` |  32.14 |  64.28 |  34.56 |  29.72 |
| `quotient_poly_commit_time_ms` |  11.73 |  23.45 |  11.96 |  11.50 |
| `pcs_opening_time_ms ` |  44.50 |  89 |  48 |  41 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  993 |  1,986 |  1,260 |  726 |
| `main_cells_used     ` |  6,475,562 |  12,951,124 |  6,608,072 |  6,343,052 |
| `total_cells_used    ` |  17,568,644 |  35,137,288 |  17,887,054 |  17,250,234 |
| `execute_preflight_insns` |  1,190,467.50 |  2,380,935 |  1,229,650 |  1,151,285 |
| `execute_preflight_time_ms` |  493.50 |  987 |  790 |  197 |
| `execute_preflight_insn_mi/s` |  6.85 | -          |  6.98 |  6.72 |
| `trace_gen_time_ms   ` |  56.50 |  113 |  58 |  55 |
| `memory_finalize_time_ms` |  5.50 |  11 |  6 |  5 |
| `stark_prove_excluding_trace_time_ms` |  442 |  884 |  470 |  414 |
| `main_trace_commit_time_ms` |  83 |  166 |  91 |  75 |
| `generate_perm_trace_time_ms` |  42.50 |  85 |  48 |  37 |
| `perm_trace_commit_time_ms` |  123.68 |  247.36 |  141.65 |  105.71 |
| `quotient_poly_compute_time_ms` |  90.13 |  180.25 |  99.86 |  80.40 |
| `quotient_poly_commit_time_ms` |  21 |  42.01 |  22.54 |  19.47 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program |  | 449 |  | 41 | 1 | 10 | 1,500,210 | 145.41 | 141 | 
| leaf | 1,261 |  | 1 |  | 1 |  |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 58 | 726 | 17,887,054 | 252,878,314 | 58 | 470 | 0 | 99.86 | 22.54 | 4 | 141.65 | 75 | 179 | 75 | 6 | 91 | 6,608,072 | 37 | 197 | 1,229,650 | 6.98 | 25 | 123 | 0 | 75 | 
| leaf | 1 | 55 | 1,260 | 17,250,234 | 207,789,546 | 55 | 414 | 0 | 80.40 | 19.47 | 4 | 105.71 | 83 | 154 | 83 | 5 | 75 | 6,343,052 | 48 | 790 | 1,151,285 | 6.72 | 22 | 100 | 0 | 83 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 198 | 562 | 9,684,992 | 84,395,212 | 198 | 193 | 0 | 34.56 | 11.96 | 4 | 43.44 | 48 | 64 | 48 | 0 | 32 | 1,040,430 | 20 | 25 | 873,000 | 36.28 | 13 | 47 | 0 | 48 | 
| fibonacci_program | 1 | 186 | 449 | 9,714,030 | 74,305,770 | 186 | 189 | 1 | 29.72 | 11.50 | 4 | 37.88 | 41 | 76 | 41 | 0 | 28 | 1,067,532 | 38 | 32 | 627,210 | 40.17 | 11 | 41 | 0 | 41 | 

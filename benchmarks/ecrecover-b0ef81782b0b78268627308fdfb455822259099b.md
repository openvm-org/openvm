...
| `total_proof_time_ms ` |  2,541 |  2,541 |  2,541 |  2,541 |
...
| `stark_prove_excluding_trace_time_ms` |  2,203 |  2,203 |  2,203 |  2,203 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  13,392 |  13,392 |  13,392 |  13,392 |
| `main_cells_used     ` |  133,785,665 |  133,785,665 |  133,785,665 |  133,785,665 |
| `total_cycles        ` |  2,253,299 |  2,253,299 |  2,253,299 |  2,253,299 |
| `execute_time_ms     ` |  730 |  730 |  730 |  730 |
| `trace_gen_time_ms   ` |  1,725 |  1,725 |  1,725 |  1,725 |
| `stark_prove_excluding_trace_time_ms` |  10,937 |  10,937 |  10,937 |  10,937 |
| `main_trace_commit_time_ms` |  2,312 |  2,312 |  2,312 |  2,312 |
...
| `quotient_poly_commit_time_ms` |  1,984 |  1,984 |  1,984 |  1,984 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,725 | 13,392 | 2,253,299 | 377,489,890 | 10,937 | 1,658 | 1,984 | 2,299 | 2,358 | 2,312 | 133,785,665 | 319 | 730 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 189 | 2,541 | 295,181 | 38,665,477 | 2,203 | 232 | 465 | 364 | 702 | 391 | 15,586,346 | 34 | 149 | 

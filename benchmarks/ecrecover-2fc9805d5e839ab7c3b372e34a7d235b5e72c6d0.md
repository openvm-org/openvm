...
|:---|---:|---:|---:|
| Total |  11.78 |  11.78 | 11.78 |
| ecrecover_program |  3.33 |  3.33 |  3.33 |
| leaf |  8.45 |  8.45 |  8.45 |
...
| `total_proof_time_ms ` |  3,323 |  3,323 |  3,323 |  3,323 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  8,450 |  8,450 |  8,450 |  8,450 |
| `main_cells_used     ` |  34,468,876 |  34,468,876 |  34,468,876 |  34,468,876 |
| `total_cells_used    ` |  83,392,626 |  83,392,626 |  83,392,626 |  83,392,626 |
| `execute_preflight_insns` |  4,109,513 |  4,109,513 |  4,109,513 |  4,109,513 |
| `execute_preflight_time_ms` |  842 |  842 |  842 |  842 |
| `execute_preflight_insn_mi/s` |  5.20 | -          |  5.20 |  5.20 |
| `trace_gen_time_ms   ` |  322 |  322 |  322 |  322 |
| `memory_finalize_time_ms` |  32 |  32 |  32 |  32 |
| `stark_prove_excluding_trace_time_ms` |  7,284 |  7,284 |  7,284 |  7,284 |
| `main_trace_commit_time_ms` |  718 |  718 |  718 |  718 |
| `generate_perm_trace_time_ms` |  356 |  356 |  356 |  356 |
| `perm_trace_commit_time_ms` |  1,479.88 |  1,479.88 |  1,479.88 |  1,479.88 |
| `quotient_poly_compute_time_ms` |  816.31 |  816.31 |  816.31 |  816.31 |
| `quotient_poly_commit_time_ms` |  181.79 |  181.79 |  181.79 |  181.79 |
| `pcs_opening_time_ms ` |  3,724 |  3,724 |  3,724 |  3,724 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program |  | 3,323 |  | 1 | 6 | 122,859 | 19.74 | 0 | 
| leaf | 8,458 |  | 1 | 1 |  |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 322 | 8,450 | 83,392,626 | 1,726,057,962 | 322 | 7,284 | 0 | 816.31 | 181.79 | 7 | 1,479.88 | 3,724 | 1,837 | 3,724 | 32 | 718 | 34,468,876 | 356 | 842 | 4,109,513 | 5.20 | 274 | 1,003 | 16 | 3,724 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 206 | 3,323 | 11,345,240 | 31,789,298 | 206 | 2,876 | 0 | 105.07 | 9.16 | 11 | 34.15 | 2,629 | 95 | 2,628 | 0 | 37 | 2,263,998 | 52 | 65 | 122,859 | 2.27 | 22 | 114 | 1 | 2,628 | 

...
| `total_proof_time_ms ` |  4,040 |  8,080 |  4,659 |  3,421 |
...
| `trace_gen_time_ms   ` |  972 |  1,944 |  1,165 |  779 |
| `stark_prove_excluding_trace_time_ms` |  2,726 |  5,452 |  3,114 |  2,338 |
| `main_trace_commit_time_ms` |  496 |  992 |  581 |  411 |
| `generate_perm_trace_time_ms` |  170 |  340 |  186 |  154 |
| `perm_trace_commit_time_ms` |  700 |  1,400 |  806 |  594 |
| `quotient_poly_compute_time_ms` |  363 |  726 |  421 |  305 |
| `quotient_poly_commit_time_ms` |  291.50 |  583 |  340 |  243 |
| `pcs_opening_time_ms ` |  696 |  1,392 |  769 |  623 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,537.50 |  15,075 |  7,597 |  7,478 |
| `main_cells_used     ` |  152,233,934 |  304,467,868 |  154,691,384 |  149,776,484 |
| `total_cycles        ` |  1,990,810 |  3,981,620 |  2,021,597 |  1,960,023 |
| `execute_time_ms     ` |  763.50 |  1,527 |  774 |  753 |
| `trace_gen_time_ms   ` |  1,498 |  2,996 |  1,524 |  1,472 |
| `stark_prove_excluding_trace_time_ms` |  5,276 |  10,552 |  5,299 |  5,253 |
| `main_trace_commit_time_ms` |  890.50 |  1,781 |  891 |  890 |
| `generate_perm_trace_time_ms` |  352.50 |  705 |  366 |  339 |
| `perm_trace_commit_time_ms` |  1,684 |  3,368 |  1,704 |  1,664 |
| `quotient_poly_compute_time_ms` |  767.50 |  1,535 |  768 |  767 |
| `quotient_poly_commit_time_ms` |  517 |  1,034 |  518 |  516 |
| `pcs_opening_time_ms ` |  1,058.50 |  2,117 |  1,068 |  1,049 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,524 | 7,597 | 2,021,597 | 533,941,738 | 5,299 | 768 | 516 | 1,704 | 1,049 | 890 | 154,691,384 | 366 | 774 | 
| leaf | 1 | 1,472 | 7,478 | 1,960,023 | 533,941,738 | 5,253 | 767 | 518 | 1,664 | 1,068 | 891 | 149,776,484 | 339 | 753 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,165 | 4,659 | 2,225,434 | 275,652,919 | 3,114 | 421 | 340 | 806 | 769 | 581 | 93,699,990 | 186 | 380 | 
| regex_program | 1 | 779 | 3,421 | 1,914,730 | 198,099,628 | 2,338 | 305 | 243 | 594 | 623 | 411 | 73,689,460 | 154 | 304 | 

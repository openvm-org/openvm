...
| `stark_prove_excluding_trace_time_ms` |  2,172 |  2,172 |  2,172 |  2,172 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  11,254 |  11,254 |  11,254 |  11,254 |
| `main_cells_used     ` |  117,320,955 |  117,320,955 |  117,320,955 |  117,320,955 |
| `total_cycles        ` |  1,604,015 |  1,604,015 |  1,604,015 |  1,604,015 |
| `execute_time_ms     ` |  571 |  571 |  571 |  571 |
| `trace_gen_time_ms   ` |  1,565 |  1,565 |  1,565 |  1,565 |
| `stark_prove_excluding_trace_time_ms` |  9,118 |  9,118 |  9,118 |  9,118 |
| `main_trace_commit_time_ms` |  1,919 |  1,919 |  1,919 |  1,919 |
| `generate_perm_trace_time_ms` |  261 |  261 |  261 |  261 |
| `perm_trace_commit_time_ms` |  2,005 |  2,005 |  2,005 |  2,005 |
| `quotient_poly_compute_time_ms` |  1,449 |  1,449 |  1,449 |  1,449 |
| `quotient_poly_commit_time_ms` |  1,666 |  1,666 |  1,666 |  1,666 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,565 | 11,254 | 1,604,015 | 334,709,720 | 9,118 | 1,449 | 1,666 | 2,005 | 1,815 | 1,919 | 117,320,955 | 261 | 571 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 178 | 2,496 | 284,567 | 38,417,467 | 2,172 | 228 | 494 | 356 | 662 | 386 | 15,055,723 | 33 | 146 | 

...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  11,604 |  11,604 |  11,604 |  11,604 |
| `main_cells_used     ` |  245,012,343 |  245,012,343 |  245,012,343 |  245,012,343 |
| `total_cycles        ` |  3,012,500 |  3,012,500 |  3,012,500 |  3,012,500 |
| `execute_time_ms     ` |  1,104 |  1,104 |  1,104 |  1,104 |
| `trace_gen_time_ms   ` |  2,343 |  2,343 |  2,343 |  2,343 |
| `stark_prove_excluding_trace_time_ms` |  8,157 |  8,157 |  8,157 |  8,157 |
| `main_trace_commit_time_ms` |  1,511 |  1,511 |  1,511 |  1,511 |
| `generate_perm_trace_time_ms` |  790 |  790 |  790 |  790 |
| `perm_trace_commit_time_ms` |  2,111 |  2,111 |  2,111 |  2,111 |
| `quotient_poly_compute_time_ms` |  908 |  908 |  908 |  908 |
| `quotient_poly_commit_time_ms` |  638 |  638 |  638 |  638 |
| `pcs_opening_time_ms ` |  2,194 |  2,194 |  2,194 |  2,194 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 2,343 | 11,604 | 3,012,500 | 1,008,831,978 | 8,157 | 908 | 638 | 2,111 | 2,194 | 1,511 | 245,012,343 | 790 | 1,104 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 110 | 1,136 | 121,143 | 32,514,138 | 907 | 80 | 124 | 120 | 407 | 133 | 7,489,352 | 28 | 119 | 

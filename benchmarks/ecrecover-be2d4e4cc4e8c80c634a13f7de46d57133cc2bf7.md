...
| `total_proof_time_ms ` |  2,634 |  2,634 |  2,634 |  2,634 |
...
| `stark_prove_excluding_trace_time_ms` |  2,225 |  2,225 |  2,225 |  2,225 |
...
| `quotient_poly_compute_time_ms` |  301 |  301 |  301 |  301 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  41,755 |  41,755 |  41,755 |  41,755 |
| `main_cells_used     ` |  365,911,097 |  365,911,097 |  365,911,097 |  365,911,097 |
| `total_cycles        ` |  8,655,005 |  8,655,005 |  8,655,005 |  8,655,005 |
| `execute_time_ms     ` |  2,440 |  2,440 |  2,440 |  2,440 |
| `trace_gen_time_ms   ` |  6,617 |  6,617 |  6,617 |  6,617 |
| `stark_prove_excluding_trace_time_ms` |  32,698 |  32,698 |  32,698 |  32,698 |
| `main_trace_commit_time_ms` |  5,798 |  5,798 |  5,798 |  5,798 |
| `generate_perm_trace_time_ms` |  712 |  712 |  712 |  712 |
| `perm_trace_commit_time_ms` |  7,241 |  7,241 |  7,241 |  7,241 |
| `quotient_poly_compute_time_ms` |  7,435 |  7,435 |  7,435 |  7,435 |
| `quotient_poly_commit_time_ms` |  5,142 |  5,142 |  5,142 |  5,142 |
| `pcs_opening_time_ms ` |  6,366 |  6,366 |  6,366 |  6,366 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 6,617 | 41,755 | 8,655,005 | 1,052,183,000 | 32,698 | 7,435 | 5,142 | 7,241 | 6,366 | 5,798 | 365,911,097 | 712 | 2,440 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 257 | 2,634 | 285,401 | 56,172,159 | 2,225 | 301 | 332 | 530 | 622 | 396 | 15,092,297 | 41 | 152 | 

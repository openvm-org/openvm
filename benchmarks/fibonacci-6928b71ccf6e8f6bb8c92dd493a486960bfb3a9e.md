...
| `total_proof_time_ms ` |  4,924 |  4,924 |  4,924 |  4,924 |
| `main_cells_used     ` |  51,485,080 |  51,485,080 |  51,485,080 |  51,485,080 |
| `total_cycles        ` |  1,500,095 |  1,500,095 |  1,500,095 |  1,500,095 |
| `execute_time_ms     ` |  298 |  298 |  298 |  298 |
| `trace_gen_time_ms   ` |  624 |  624 |  624 |  624 |
| `stark_prove_excluding_trace_time_ms` |  4,002 |  4,002 |  4,002 |  4,002 |
...
| `main_cells_used     ` |  33,540,736 |  33,540,736 |  33,540,736 |  33,540,736 |
| `total_cycles        ` |  615,320 |  615,320 |  615,320 |  615,320 |
...
| `perm_trace_commit_time_ms` |  567 |  567 |  567 |  567 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 579 | 3,865 | 615,320 | 86,295,512 | 3,047 | 412 | 626 | 567 | 743 | 627 | 33,540,736 | 69 | 239 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 624 | 4,924 | 1,500,095 | 122,458,476 | 4,002 | 508 | 722 | 747 | 1,080 | 800 | 51,485,080 | 143 | 298 | 

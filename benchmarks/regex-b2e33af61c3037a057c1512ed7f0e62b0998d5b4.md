...
| `total_proof_time_ms ` |  579 |  2,316 |  692 |  536 |
...
| `execute_metered_insn_mi/s` |  87.11 | -          |  87.11 |  87.11 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  52.75 |  211 |  64 |  44 |
| `execute_preflight_insn_mi/s` |  31.58 | -          |  33.35 |  29.03 |
| `trace_gen_time_ms   ` |  179 |  716 |  212 |  157 |
| `memory_finalize_time_ms` |  1 |  4 |  4 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  279.50 |  1,118 |  291 |  268 |
| `main_trace_commit_time_ms` |  51.75 |  207 |  56 |  50 |
| `generate_perm_trace_time_ms` |  28.25 |  113 |  38 |  19 |
| `perm_trace_commit_time_ms` |  64.54 |  258.18 |  71.73 |  55.47 |
| `quotient_poly_compute_time_ms` |  57.44 |  229.76 |  69.38 |  51.23 |
| `quotient_poly_commit_time_ms` |  14.73 |  58.92 |  16.41 |  12.46 |
| `pcs_opening_time_ms ` |  60 |  240 |  63 |  57 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,344 |  5,376 |  1,964 |  874 |
...
| `execute_preflight_insns` |  1,440,804.50 |  5,763,218 |  1,814,630 |  1,241,324 |
| `execute_preflight_time_ms` |  605.50 |  2,422 |  793 |  220 |
| `execute_preflight_insn_mi/s` |  7.23 | -          |  7.63 |  6.95 |
| `trace_gen_time_ms   ` |  85 |  340 |  158 |  57 |
| `memory_finalize_time_ms` |  8.50 |  34 |  17 |  5 |
| `stark_prove_excluding_trace_time_ms` |  652 |  2,608 |  1,053 |  465 |
| `main_trace_commit_time_ms` |  124 |  496 |  193 |  91 |
| `generate_perm_trace_time_ms` |  55.25 |  221 |  75 |  33 |
| `perm_trace_commit_time_ms` |  198.76 |  795.04 |  339.91 |  141.88 |
| `quotient_poly_compute_time_ms` |  139.30 |  557.21 |  227.78 |  98.88 |
| `quotient_poly_commit_time_ms` |  29.70 |  118.79 |  48.33 |  22.25 |
| `pcs_opening_time_ms ` |  101.50 |  406 |  168 |  74 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 1,966 |  | 1 | 1 |  |  |  |  | 
| regex_program |  | 539 |  | 1 | 47 | 4,137,502 | 87.11 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 68 | 874 | 22,981,570 | 319,331,818 | 68 | 584 | 0 | 131.13 | 25.18 | 4 | 171.05 | 90 | 215 | 89 | 7 | 121 | 9,122,488 | 43 | 220 | 1,465,937 | 7.63 | 30 | 157 | 0 | 89 | 
| leaf | 1 | 57 | 1,317 | 20,905,034 | 255,237,610 | 57 | 465 | 0 | 99.42 | 23.02 | 4 | 142.21 | 74 | 176 | 74 | 5 | 91 | 8,256,948 | 33 | 793 | 1,241,324 | 7.16 | 25 | 123 | 0 | 74 | 
| leaf | 2 | 57 | 1,221 | 20,905,034 | 255,237,610 | 57 | 506 | 0 | 98.88 | 22.25 | 4 | 141.88 | 74 | 218 | 74 | 5 | 91 | 8,256,948 | 75 | 657 | 1,241,327 | 7.17 | 25 | 122 | 0 | 74 | 
| leaf | 3 | 158 | 1,964 | 50,337,320 | 538,365,418 | 158 | 1,053 | 0 | 227.78 | 48.33 | 4 | 339.91 | 168 | 411 | 168 | 17 | 193 | 20,171,106 | 70 | 752 | 1,814,630 | 6.95 | 61 | 279 | 5 | 168 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 212 | 692 | 23,446,148 | 150,778,428 | 212 | 291 | 0 | 57.75 | 16.41 | 5 | 71.73 | 57 | 101 | 57 | 4 | 56 | 10,899,170 | 29 | 44 | 1,103,000 | 29.03 | 21 | 74 | 1 | 57 | 
| regex_program | 1 | 157 | 549 | 11,598,276 | 128,513,066 | 157 | 286 | 1 | 51.40 | 15.33 | 4 | 65.74 | 63 | 104 | 62 | 0 | 51 | 2,196,106 | 38 | 64 | 1,104,000 | 33.13 | 16 | 67 | 0 | 62 | 
| regex_program | 2 | 164 | 536 | 11,579,064 | 128,513,066 | 164 | 273 | 1 | 51.23 | 14.72 | 4 | 65.25 | 63 | 93 | 63 | 0 | 50 | 2,177,334 | 27 | 57 | 1,104,000 | 33.35 | 16 | 66 | 0 | 63 | 
| regex_program | 3 | 183 | 539 | 11,853,872 | 103,456,394 | 183 | 268 | 0 | 69.38 | 12.46 | 5 | 55.47 | 57 | 77 | 57 | 0 | 50 | 2,422,606 | 19 | 46 | 826,502 | 30.82 | 18 | 82 | 1 | 57 | 

...
| ecrecover_program |  1.20 |  1.20 |  1.20 |
| leaf |  6.01 |  6.01 |  6.01 |
...
| `total_proof_time_ms ` |  1,196 |  1,196 |  1,196 |  1,196 |
...
| `pcs_opening_time_ms ` |  538 |  538 |  538 |  538 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  6,011 |  6,011 |  6,011 |  6,011 |
| `main_cells_used     ` |  34,465,416 |  34,465,416 |  34,465,416 |  34,465,416 |
| `total_cells_used    ` |  83,383,566 |  83,383,566 |  83,383,566 |  83,383,566 |
| `execute_preflight_insns` |  4,112,213 |  4,112,213 |  4,112,213 |  4,112,213 |
| `execute_preflight_time_ms` |  723 |  723 |  723 |  723 |
| `execute_preflight_insn_mi/s` |  6.05 | -          |  6.05 |  6.05 |
| `trace_gen_time_ms   ` |  302 |  302 |  302 |  302 |
| `memory_finalize_time_ms` |  25 |  25 |  25 |  25 |
| `stark_prove_excluding_trace_time_ms` |  4,984 |  4,984 |  4,984 |  4,984 |
| `main_trace_commit_time_ms` |  717 |  717 |  717 |  717 |
| `generate_perm_trace_time_ms` |  312 |  312 |  312 |  312 |
| `perm_trace_commit_time_ms` |  1,470.20 |  1,470.20 |  1,470.20 |  1,470.20 |
| `quotient_poly_compute_time_ms` |  803.89 |  803.89 |  803.89 |  803.89 |
| `quotient_poly_commit_time_ms` |  181.44 |  181.44 |  181.44 |  181.44 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program |  | 1,196 |  | 1 | 6 | 126,680 | 20.62 | 0 | 
| leaf | 6,016 |  | 1 | 1 |  |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 302 | 6,011 | 83,383,566 | 1,726,057,962 | 302 | 4,984 | 0 | 803.89 | 181.44 | 6 | 1,470.20 | 1,493 | 1,783 | 1,492 | 25 | 717 | 34,465,416 | 312 | 723 | 4,112,213 | 6.05 | 271 | 990 | 14 | 1,492 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 207 | 1,196 | 11,352,776 | 31,789,298 | 207 | 764 | 0 | 102.29 | 9.17 | 10 | 34.16 | 538 | 77 | 537 | 0 | 37 | 2,270,038 | 35 | 62 | 126,680 | 2.30 | 21 | 111 | 1 | 537 | 

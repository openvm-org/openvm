...
| `total_proof_time_ms ` |  3,850 |  7,700 |  4,435 |  3,265 |
...
| `trace_gen_time_ms   ` |  951 |  1,902 |  1,121 |  781 |
| `stark_prove_excluding_trace_time_ms` |  2,559.50 |  5,119 |  2,937 |  2,182 |
| `main_trace_commit_time_ms` |  453.50 |  907 |  537 |  370 |
| `generate_perm_trace_time_ms` |  159.50 |  319 |  178 |  141 |
| `perm_trace_commit_time_ms` |  638 |  1,276 |  748 |  528 |
| `quotient_poly_compute_time_ms` |  361 |  722 |  415 |  307 |
| `quotient_poly_commit_time_ms` |  271.50 |  543 |  316 |  227 |
| `pcs_opening_time_ms ` |  667.50 |  1,335 |  734 |  601 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,457.50 |  14,915 |  7,530 |  7,385 |
| `main_cells_used     ` |  152,710,317.50 |  305,420,635 |  155,169,815 |  150,250,820 |
| `total_cycles        ` |  1,991,054.50 |  3,982,109 |  2,021,879 |  1,960,230 |
| `execute_time_ms     ` |  744.50 |  1,489 |  755 |  734 |
| `trace_gen_time_ms   ` |  1,438.50 |  2,877 |  1,463 |  1,414 |
| `stark_prove_excluding_trace_time_ms` |  5,274.50 |  10,549 |  5,312 |  5,237 |
| `main_trace_commit_time_ms` |  893.50 |  1,787 |  895 |  892 |
| `generate_perm_trace_time_ms` |  346 |  692 |  349 |  343 |
| `perm_trace_commit_time_ms` |  1,674 |  3,348 |  1,712 |  1,636 |
| `quotient_poly_compute_time_ms` |  765.50 |  1,531 |  769 |  762 |
| `quotient_poly_commit_time_ms` |  521.50 |  1,043 |  522 |  521 |
| `pcs_opening_time_ms ` |  1,067.50 |  2,135 |  1,076 |  1,059 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,463 | 7,530 | 2,021,879 | 538,660,330 | 5,312 | 769 | 521 | 1,712 | 1,059 | 895 | 155,169,815 | 349 | 755 | 
| leaf | 1 | 1,414 | 7,385 | 1,960,230 | 538,660,330 | 5,237 | 762 | 522 | 1,636 | 1,076 | 892 | 150,250,820 | 343 | 734 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,121 | 4,435 | 2,225,434 | 275,652,919 | 2,937 | 415 | 316 | 748 | 734 | 537 | 93,738,635 | 178 | 377 | 
| regex_program | 1 | 781 | 3,265 | 1,914,993 | 198,099,628 | 2,182 | 307 | 227 | 528 | 601 | 370 | 73,709,236 | 141 | 302 | 

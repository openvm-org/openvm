...
| `total_proof_time_ms ` |  4,131 |  8,262 |  4,571 |  3,691 |
...
| `trace_gen_time_ms   ` |  960.50 |  1,921 |  1,137 |  784 |
| `stark_prove_excluding_trace_time_ms` |  2,833.50 |  5,667 |  3,060 |  2,607 |
| `main_trace_commit_time_ms` |  519.50 |  1,039 |  581 |  458 |
| `generate_perm_trace_time_ms` |  192 |  384 |  200 |  184 |
| `perm_trace_commit_time_ms` |  748.50 |  1,497 |  799 |  698 |
| `quotient_poly_compute_time_ms` |  392 |  784 |  424 |  360 |
| `quotient_poly_commit_time_ms` |  295 |  590 |  332 |  258 |
| `pcs_opening_time_ms ` |  677 |  1,354 |  714 |  640 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,504 |  15,008 |  7,560 |  7,448 |
| `main_cells_used     ` |  152,278,183 |  304,556,366 |  154,678,006 |  149,878,360 |
| `total_cycles        ` |  1,991,026.50 |  3,982,053 |  2,021,851 |  1,960,202 |
| `execute_time_ms     ` |  748 |  1,496 |  756 |  740 |
| `trace_gen_time_ms   ` |  1,481.50 |  2,963 |  1,482 |  1,481 |
| `stark_prove_excluding_trace_time_ms` |  5,274.50 |  10,549 |  5,323 |  5,226 |
| `main_trace_commit_time_ms` |  892 |  1,784 |  893 |  891 |
| `generate_perm_trace_time_ms` |  374 |  748 |  387 |  361 |
| `perm_trace_commit_time_ms` |  1,662 |  3,324 |  1,694 |  1,630 |
| `quotient_poly_compute_time_ms` |  765.50 |  1,531 |  767 |  764 |
| `quotient_poly_commit_time_ms` |  520.50 |  1,041 |  521 |  520 |
| `pcs_opening_time_ms ` |  1,056 |  2,112 |  1,058 |  1,054 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,481 | 7,560 | 2,021,851 | 538,660,330 | 5,323 | 767 | 520 | 1,694 | 1,058 | 893 | 154,678,006 | 387 | 756 | 
| leaf | 1 | 1,482 | 7,448 | 1,960,202 | 538,660,330 | 5,226 | 764 | 521 | 1,630 | 1,054 | 891 | 149,878,360 | 361 | 740 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,137 | 4,571 | 2,243,715 | 275,652,919 | 3,060 | 424 | 332 | 799 | 714 | 581 | 94,156,159 | 200 | 374 | 
| regex_program | 1 | 784 | 3,691 | 1,921,511 | 242,975,404 | 2,607 | 360 | 258 | 698 | 640 | 458 | 73,665,713 | 184 | 300 | 

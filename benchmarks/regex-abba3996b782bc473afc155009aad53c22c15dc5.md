...
| `total_proof_time_ms ` |  1,473 |  2,946 |  1,711 |  1,235 |
...
| `execute_preflight_insn_mi/s` |  29.44 | -          |  30.81 |  28.08 |
| `trace_gen_time_ms   ` |  310.50 |  621 |  332 |  289 |
| `memory_finalize_time_ms` |  2 |  4 |  4 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  976 |  1,952 |  1,209 |  743 |
| `main_trace_commit_time_ms` |  141.50 |  283 |  184 |  99 |
| `generate_perm_trace_time_ms` |  60 |  120 |  75 |  45 |
| `perm_trace_commit_time_ms` |  171.82 |  343.64 |  223.96 |  119.68 |
| `quotient_poly_compute_time_ms` |  162.75 |  325.49 |  178.55 |  146.94 |
| `quotient_poly_commit_time_ms` |  36.64 |  73.27 |  48.13 |  25.14 |
| `pcs_opening_time_ms ` |  397 |  794 |  528 |  266 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  2,072 |  4,144 |  2,840 |  1,304 |
...
| `execute_preflight_time_ms` |  586.50 |  1,173 |  899 |  274 |
| `execute_preflight_insn_mi/s` |  6.88 | -          |  7.09 |  6.67 |
| `trace_gen_time_ms   ` |  124.50 |  249 |  172 |  77 |
| `memory_finalize_time_ms` |  13 |  26 |  18 |  8 |
| `stark_prove_excluding_trace_time_ms` |  1,359.50 |  2,719 |  1,767 |  952 |
| `main_trace_commit_time_ms` |  180.50 |  361 |  229 |  132 |
| `generate_perm_trace_time_ms` |  73.50 |  147 |  88 |  59 |
| `perm_trace_commit_time_ms` |  276.40 |  552.80 |  366.86 |  185.94 |
| `quotient_poly_compute_time_ms` |  176.60 |  353.20 |  227.43 |  125.77 |
| `quotient_poly_commit_time_ms` |  44.05 |  88.11 |  58.13 |  29.98 |
| `pcs_opening_time_ms ` |  604 |  1,208 |  792 |  416 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 2,842 |  | 1 |  | 1 |  |  |  |  | 
| regex_program |  | 1,235 |  | 65 | 1 | 33 | 4,108,483 | 123.78 | 191 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 77 | 1,304 | 23,479,090 | 319,626,730 | 77 | 952 | 0 | 125.77 | 29.98 | 4 | 185.94 | 416 | 246 | 416 | 8 | 132 | 9,325,224 | 59 | 274 | 1,496,599 | 7.09 | 29 | 156 | 1 | 416 | 
| leaf | 1 | 172 | 2,840 | 50,586,080 | 538,660,330 | 172 | 1,767 | 0 | 227.43 | 58.13 | 5 | 366.86 | 792 | 456 | 792 | 18 | 229 | 20,272,474 | 88 | 899 | 1,830,088 | 6.67 | 56 | 288 | 1 | 792 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 289 | 1,711 | 23,397,108 | 373,183,036 | 289 | 1,209 | 0 | 146.94 | 48.13 | 6 | 223.96 | 528 | 299 | 527 | 4 | 184 | 10,866,434 | 75 | 85 | 2,211,000 | 28.08 | 46 | 197 | 2 | 527 | 
| regex_program | 1 | 332 | 1,235 | 11,981,356 | 196,739,722 | 332 | 743 | 2 | 178.55 | 25.14 | 5 | 119.68 | 266 | 168 | 266 | 0 | 99 | 2,537,170 | 45 | 113 | 1,897,483 | 30.81 | 26 | 208 | 2 | 266 | 

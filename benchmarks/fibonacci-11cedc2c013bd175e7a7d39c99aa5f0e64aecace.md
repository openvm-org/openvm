...
| `perm_trace_commit_time_ms` |  41.98 |  83.96 |  42.99 |  40.97 |
| `quotient_poly_compute_time_ms` |  32.02 |  64.04 |  34.72 |  29.32 |
| `quotient_poly_commit_time_ms` |  11.92 |  23.85 |  12.14 |  11.71 |
| `pcs_opening_time_ms ` |  42 |  84 |  43 |  41 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,026 |  2,052 |  1,301 |  751 |
...
| `execute_preflight_time_ms` |  525 |  1,050 |  850 |  200 |
| `execute_preflight_insn_mi/s` |  6.85 | -          |  6.89 |  6.81 |
| `trace_gen_time_ms   ` |  59 |  118 |  62 |  56 |
| `memory_finalize_time_ms` |  5 |  10 |  5 |  5 |
| `stark_prove_excluding_trace_time_ms` |  441.50 |  883 |  489 |  394 |
| `main_trace_commit_time_ms` |  83.50 |  167 |  91 |  76 |
| `generate_perm_trace_time_ms` |  40.50 |  81 |  48 |  33 |
| `perm_trace_commit_time_ms` |  123.13 |  246.26 |  138.68 |  107.58 |
| `quotient_poly_compute_time_ms` |  93.55 |  187.10 |  102.76 |  84.34 |
| `quotient_poly_commit_time_ms` |  22.44 |  44.88 |  24.41 |  20.46 |
| `pcs_opening_time_ms ` |  75.50 |  151 |  81 |  70 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program |  | 429 |  | 41 | 1 | 10 | 1,500,210 | 145.24 | 142 | 
| leaf | 1,302 |  | 1 |  | 1 |  |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 62 | 751 | 17,887,054 | 252,878,314 | 62 | 489 | 0 | 102.76 | 24.41 | 4 | 138.68 | 81 | 187 | 81 | 5 | 91 | 6,608,072 | 48 | 200 | 1,229,594 | 6.89 | 26 | 128 | 0 | 81 | 
| leaf | 1 | 56 | 1,301 | 17,250,234 | 207,789,546 | 56 | 394 | 0 | 84.34 | 20.46 | 4 | 107.58 | 70 | 142 | 70 | 5 | 76 | 6,343,052 | 33 | 850 | 1,151,182 | 6.81 | 22 | 105 | 0 | 70 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 195 | 557 | 9,684,992 | 84,395,212 | 195 | 190 | 0 | 34.72 | 12.14 | 4 | 42.99 | 41 | 68 | 40 | 0 | 33 | 1,040,430 | 25 | 25 | 873,000 | 36.29 | 14 | 47 | 0 | 40 | 
| fibonacci_program | 1 | 186 | 429 | 9,714,030 | 74,305,770 | 186 | 167 | 1 | 29.32 | 11.71 | 4 | 40.97 | 43 | 53 | 43 | 0 | 28 | 1,067,532 | 12 | 34 | 627,210 | 40.64 | 11 | 41 | 0 | 43 | 

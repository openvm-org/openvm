...
| `trace_gen_time_ms   ` |  918 |  918 |  918 |  918 |
...
| `pcs_opening_time_ms ` |  776 |  776 |  776 |  776 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  13,991 |  13,991 |  13,991 |  13,991 |
| `main_cells_used     ` |  274,767,050 |  274,767,050 |  274,767,050 |  274,767,050 |
| `total_cycles        ` |  3,297,897 |  3,297,897 |  3,297,897 |  3,297,897 |
| `execute_time_ms     ` |  1,213 |  1,213 |  1,213 |  1,213 |
| `trace_gen_time_ms   ` |  2,523 |  2,523 |  2,523 |  2,523 |
| `stark_prove_excluding_trace_time_ms` |  10,255 |  10,255 |  10,255 |  10,255 |
| `main_trace_commit_time_ms` |  1,766 |  1,766 |  1,766 |  1,766 |
| `generate_perm_trace_time_ms` |  721 |  721 |  721 |  721 |
| `perm_trace_commit_time_ms` |  3,366 |  3,366 |  3,366 |  3,366 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 2,523 | 13,991 | 3,297,897 | 1,071,746,538 | 10,255 | 1,473 | 969 | 3,366 | 1,956 | 1,766 | 274,767,050 | 721 | 1,213 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 918 | 4,758 | 1,711,640 | 297,186,413 | 3,164 | 462 | 334 | 783 | 776 | 600 | 92,585,975 | 192 | 676 | 

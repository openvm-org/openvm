...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  22,166 |  22,166 |  22,166 |  22,166 |
| `main_cells_used     ` |  241,413,029 |  241,413,029 |  241,413,029 |  241,413,029 |
| `total_cycles        ` |  4,166,993 |  4,166,993 |  4,166,993 |  4,166,993 |
| `execute_time_ms     ` |  939 |  939 |  939 |  939 |
| `trace_gen_time_ms   ` |  4,004 |  4,004 |  4,004 |  4,004 |
| `stark_prove_excluding_trace_time_ms` |  17,223 |  17,223 |  17,223 |  17,223 |
| `main_trace_commit_time_ms` |  3,286 |  3,286 |  3,286 |  3,286 |
| `generate_perm_trace_time_ms` |  386 |  386 |  386 |  386 |
| `perm_trace_commit_time_ms` |  3,974 |  3,974 |  3,974 |  3,974 |
| `quotient_poly_compute_time_ms` |  4,080 |  4,080 |  4,080 |  4,080 |
| `quotient_poly_commit_time_ms` |  2,590 |  2,590 |  2,590 |  2,590 |
| `pcs_opening_time_ms ` |  2,904 |  2,904 |  2,904 |  2,904 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 4,004 | 22,166 | 4,166,993 | 590,040,024 | 17,223 | 4,080 | 2,590 | 3,974 | 2,904 | 3,286 | 241,413,029 | 386 | 939 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 255 | 2,568 | 285,401 | 56,172,159 | 2,167 | 292 | 299 | 525 | 618 | 388 | 15,075,033 | 41 | 146 | 

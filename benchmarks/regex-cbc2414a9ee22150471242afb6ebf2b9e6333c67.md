...
| `total_proof_time_ms ` |  6,920.50 |  13,841 |  7,803 |  6,038 |
...
| `trace_gen_time_ms   ` |  1,084 |  2,168 |  1,252 |  916 |
| `stark_prove_excluding_trace_time_ms` |  5,401.50 |  10,803 |  6,083 |  4,720 |
| `main_trace_commit_time_ms` |  1,034.50 |  2,069 |  1,273 |  796 |
| `generate_perm_trace_time_ms` |  174 |  348 |  193 |  155 |
| `perm_trace_commit_time_ms` |  1,142 |  2,284 |  1,206 |  1,078 |
| `quotient_poly_compute_time_ms` |  741.50 |  1,483 |  868 |  615 |
| `quotient_poly_commit_time_ms` |  967.50 |  1,935 |  1,106 |  829 |
| `pcs_opening_time_ms ` |  1,329.50 |  2,659 |  1,429 |  1,230 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  8,014.50 |  16,029 |  8,222 |  7,807 |
| `main_cells_used     ` |  77,287,101.50 |  154,574,203 |  78,374,999 |  76,199,204 |
| `total_cycles        ` |  1,028,201.50 |  2,056,403 |  1,045,599 |  1,010,804 |
| `execute_time_ms     ` |  376.50 |  753 |  405 |  348 |
| `trace_gen_time_ms   ` |  1,162 |  2,324 |  1,233 |  1,091 |
| `stark_prove_excluding_trace_time_ms` |  6,476 |  12,952 |  6,726 |  6,226 |
| `main_trace_commit_time_ms` |  1,333.50 |  2,667 |  1,397 |  1,270 |
| `generate_perm_trace_time_ms` |  166 |  332 |  173 |  159 |
| `perm_trace_commit_time_ms` |  1,311.50 |  2,623 |  1,361 |  1,262 |
| `quotient_poly_compute_time_ms` |  958 |  1,916 |  1,023 |  893 |
| `quotient_poly_commit_time_ms` |  1,259 |  2,518 |  1,285 |  1,233 |
| `pcs_opening_time_ms ` |  1,445 |  2,890 |  1,484 |  1,406 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,091 | 8,222 | 1,045,599 | 220,669,656 | 6,726 | 1,023 | 1,285 | 1,361 | 1,484 | 1,397 | 78,374,999 | 173 | 405 | 
| leaf | 1 | 1,233 | 7,807 | 1,010,804 | 194,986,968 | 6,226 | 893 | 1,233 | 1,262 | 1,406 | 1,270 | 76,199,204 | 159 | 348 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,252 | 7,803 |  | 209,921,543 | 6,083 | 868 | 1,106 | 1,206 | 1,429 | 1,273 | 92,686,348 | 193 | 468 | 
| regex_program | 1 | 916 | 6,038 | 1,914,103 | 149,454,692 | 4,720 | 615 | 829 | 1,078 | 1,230 | 796 | 72,769,025 | 155 | 402 | 

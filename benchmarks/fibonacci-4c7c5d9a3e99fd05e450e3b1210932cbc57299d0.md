...
|:---|---:|---:|---:|
| Total |  3.14 |  1.91 | 1.91 |
| fibonacci_program |  1.05 |  0.61 |  0.61 |
| leaf |  2.09 |  1.31 |  1.31 |
...
| `total_proof_time_ms ` |  519 |  1,038 |  596 |  442 |
...
| `execute_metered_insn_mi/s` |  150.53 | -          |  150.53 |  150.53 |
| `execute_preflight_insns` |  750,104.50 |  1,500,209 |  873,000 |  627,209 |
| `execute_preflight_time_ms` |  31 |  62 |  34 |  28 |
| `execute_preflight_insn_mi/s` |  34.96 | -          |  38.20 |  31.73 |
| `trace_gen_time_ms   ` |  193 |  386 |  199 |  187 |
| `memory_finalize_time_ms` | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  187.50 |  375 |  196 |  179 |
| `main_trace_commit_time_ms` |  31 |  62 |  33 |  29 |
| `generate_perm_trace_time_ms` |  24 |  48 |  26 |  22 |
| `perm_trace_commit_time_ms` |  41.73 |  83.46 |  44.88 |  38.58 |
| `quotient_poly_compute_time_ms` |  31.97 |  63.93 |  32.82 |  31.12 |
| `quotient_poly_commit_time_ms` |  13.01 |  26.01 |  13.41 |  12.60 |
| `pcs_opening_time_ms ` |  43.50 |  87 |  44 |  43 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,045.50 |  2,091 |  1,307 |  784 |
| `main_cells_used     ` |  6,475,562 |  12,951,124 |  6,608,072 |  6,343,052 |
| `total_cells_used    ` |  17,568,644 |  35,137,288 |  17,887,054 |  17,250,234 |
| `execute_preflight_insns` |  1,190,400 |  2,380,800 |  1,229,569 |  1,151,231 |
| `execute_preflight_time_ms` |  526.50 |  1,053 |  847 |  206 |
| `execute_preflight_insn_mi/s` |  6.67 | -          |  6.68 |  6.66 |
| `trace_gen_time_ms   ` |  58.50 |  117 |  61 |  56 |
| `memory_finalize_time_ms` |  5.50 |  11 |  6 |  5 |
| `stark_prove_excluding_trace_time_ms` |  459.50 |  919 |  516 |  403 |
| `main_trace_commit_time_ms` |  85.50 |  171 |  94 |  77 |
| `generate_perm_trace_time_ms` |  35 |  70 |  36 |  34 |
| `perm_trace_commit_time_ms` |  126.37 |  252.74 |  144.55 |  108.19 |
| `quotient_poly_compute_time_ms` |  96.58 |  193.15 |  105.37 |  87.78 |
| `quotient_poly_commit_time_ms` |  23.03 |  46.06 |  24.88 |  21.17 |
| `pcs_opening_time_ms ` |  89.50 |  179 |  108 |  71 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program |  | 442 |  | 1 | 9 | 1,500,209 | 150.53 | 0 | 
| leaf | 1,308 |  | 1 | 1 |  |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 61 | 784 | 17,887,054 | 252,878,314 | 61 | 516 | 0 | 105.37 | 24.88 | 4 | 144.55 | 108 | 181 | 108 | 5 | 94 | 6,608,072 | 36 | 206 | 1,229,569 | 6.68 | 26 | 131 | 0 | 108 | 
| leaf | 1 | 56 | 1,307 | 17,250,234 | 207,789,546 | 56 | 403 | 0 | 87.78 | 21.17 | 4 | 108.19 | 71 | 143 | 71 | 6 | 77 | 6,343,052 | 34 | 847 | 1,151,231 | 6.66 | 22 | 109 | 0 | 71 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 199 | 596 | 9,677,708 | 84,395,212 | 199 | 196 | 0 | 32.82 | 13.41 | 4 | 44.88 | 43 | 71 | 43 | 0 | 33 | 1,035,986 | 26 | 28 | 873,000 | 31.73 | 14 | 46 | 0 | 43 | 
| fibonacci_program | 1 | 187 | 442 | 9,708,170 | 74,305,770 | 187 | 179 | 1 | 31.12 | 12.60 | 4 | 38.58 | 44 | 61 | 43 | 0 | 29 | 1,064,416 | 22 | 34 | 627,209 | 38.20 | 11 | 44 | 0 | 43 | 

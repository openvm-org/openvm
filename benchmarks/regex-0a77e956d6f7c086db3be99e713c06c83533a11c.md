...
| `total_proof_time_ms ` |  14,989 |  14,989 |  14,989 |  14,989 |
...
| `trace_gen_time_ms   ` |  2,932 |  2,932 |  2,932 |  2,932 |
| `stark_prove_excluding_trace_time_ms` |  11,059 |  11,059 |  11,059 |  11,059 |
| `main_trace_commit_time_ms` |  2,564 |  2,564 |  2,564 |  2,564 |
| `generate_perm_trace_time_ms` |  393 |  393 |  393 |  393 |
| `perm_trace_commit_time_ms` |  2,200 |  2,200 |  2,200 |  2,200 |
| `quotient_poly_compute_time_ms` |  1,529 |  1,529 |  1,529 |  1,529 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  15,073 |  15,073 |  15,073 |  15,073 |
...
| `trace_gen_time_ms   ` |  2,857 |  2,857 |  2,857 |  2,857 |
...
| `perm_trace_commit_time_ms` |  2,205 |  2,205 |  2,205 |  2,205 |
| `quotient_poly_compute_time_ms` |  1,685 |  1,685 |  1,685 |  1,685 |
| `quotient_poly_commit_time_ms` |  2,293 |  2,293 |  2,293 |  2,293 |
| `pcs_opening_time_ms ` |  2,660 |  2,660 |  2,660 |  2,660 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 2,857 | 15,073 | 3,130,227 | 360,334,296 | 11,510 | 1,685 | 2,293 | 2,205 | 2,660 | 2,376 | 140,982,474 | 289 | 706 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 2,932 | 14,989 | 4,139,840 | 384,265,816 | 11,059 | 1,529 | 1,979 | 2,200 | 2,385 | 2,564 | 163,831,435 | 393 | 998 | 

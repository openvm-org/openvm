...
| `execute_metered_insn_mi/s` |  136.36 | -          |  136.36 |  136.36 |
| `execute_preflight_insns` |  1,500,210 |  1,500,210 |  1,500,210 |  1,500,210 |
| `execute_preflight_time_ms` |  44 |  44 |  44 |  44 |
| `execute_preflight_insn_mi/s` |  35.57 | -          |  35.57 |  35.57 |
| `trace_gen_time_ms   ` |  298 |  298 |  298 |  298 |
| `memory_finalize_time_ms` | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  552 |  552 |  552 |  552 |
| `main_trace_commit_time_ms` |  73 |  73 |  73 |  73 |
| `generate_perm_trace_time_ms` |  44 |  44 |  44 |  44 |
| `perm_trace_commit_time_ms` |  102.27 |  102.27 |  102.27 |  102.27 |
| `quotient_poly_compute_time_ms` |  63.12 |  63.12 |  63.12 |  63.12 |
| `quotient_poly_commit_time_ms` |  23.42 |  23.42 |  23.42 |  23.42 |
| `pcs_opening_time_ms ` |  243 |  243 |  243 |  243 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,084 |  1,084 |  1,084 |  1,084 |
...
| `execute_preflight_time_ms` |  226 |  226 |  226 |  226 |
| `execute_preflight_insn_mi/s` |  6.62 | -          |  6.62 |  6.62 |
| `trace_gen_time_ms   ` |  65 |  65 |  65 |  65 |
| `memory_finalize_time_ms` |  5 |  5 |  5 |  5 |
| `stark_prove_excluding_trace_time_ms` |  792 |  792 |  792 |  792 |
| `main_trace_commit_time_ms` |  99 |  99 |  99 |  99 |
| `generate_perm_trace_time_ms` |  83 |  83 |  83 |  83 |
| `perm_trace_commit_time_ms` |  154.98 |  154.98 |  154.98 |  154.98 |
| `quotient_poly_compute_time_ms` |  98.38 |  98.38 |  98.38 |  98.38 |
| `quotient_poly_commit_time_ms` |  28.57 |  28.57 |  28.57 |  28.57 |
| `pcs_opening_time_ms ` |  325 |  325 |  325 |  325 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program |  | 1,022 |  | 53 | 1 | 10 | 1,500,210 | 136.36 | 154 | 
| leaf | 1,085 |  | 1 |  | 1 |  |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 65 | 1,084 | 18,178,004 | 253,173,226 | 65 | 792 | 0 | 98.38 | 28.57 | 4 | 154.98 | 325 | 239 | 325 | 5 | 99 | 6,727,266 | 83 | 226 | 1,248,050 | 6.62 | 25 | 127 | 1 | 325 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 298 | 1,022 | 9,707,634 | 160,836,972 | 298 | 552 | 0 | 63.12 | 23.42 | 4 | 102.27 | 243 | 147 | 243 | 0 | 73 | 1,060,232 | 44 | 44 | 1,500,210 | 35.57 | 20 | 87 | 1 | 243 | 

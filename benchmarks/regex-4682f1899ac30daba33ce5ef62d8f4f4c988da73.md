...
| `total_proof_time_ms ` |  3,909.50 |  7,819 |  4,323 |  3,496 |
...
| `trace_gen_time_ms   ` |  987 |  1,974 |  1,167 |  807 |
| `stark_prove_excluding_trace_time_ms` |  2,567.50 |  5,135 |  2,761 |  2,374 |
| `main_trace_commit_time_ms` |  497 |  994 |  554 |  440 |
| `generate_perm_trace_time_ms` |  215 |  430 |  233 |  197 |
| `perm_trace_commit_time_ms` |  543.50 |  1,087 |  571 |  516 |
| `quotient_poly_compute_time_ms` |  268 |  536 |  280 |  256 |
| `quotient_poly_commit_time_ms` |  242 |  484 |  280 |  204 |
| `pcs_opening_time_ms ` |  793 |  1,586 |  834 |  752 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  6,964.50 |  13,929 |  7,039 |  6,890 |
| `main_cells_used     ` |  151,827,839 |  303,655,678 |  154,226,318 |  149,429,360 |
| `total_cycles        ` |  1,975,726.50 |  3,951,453 |  2,006,439 |  1,945,014 |
| `execute_time_ms     ` |  782 |  1,564 |  790 |  774 |
| `trace_gen_time_ms   ` |  1,464 |  2,928 |  1,494 |  1,434 |
| `stark_prove_excluding_trace_time_ms` |  4,718.50 |  9,437 |  4,755 |  4,682 |
| `main_trace_commit_time_ms` |  867 |  1,734 |  870 |  864 |
| `generate_perm_trace_time_ms` |  400 |  800 |  429 |  371 |
| `perm_trace_commit_time_ms` |  1,242 |  2,484 |  1,246 |  1,238 |
| `quotient_poly_compute_time_ms` |  513 |  1,026 |  514 |  512 |
| `quotient_poly_commit_time_ms` |  408 |  816 |  411 |  405 |
| `pcs_opening_time_ms ` |  1,282 |  2,564 |  1,287 |  1,277 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,494 | 7,039 | 2,006,439 | 538,660,330 | 4,755 | 512 | 405 | 1,246 | 1,287 | 870 | 154,226,318 | 429 | 790 | 
| leaf | 1 | 1,434 | 6,890 | 1,945,014 | 538,660,330 | 4,682 | 514 | 411 | 1,238 | 1,277 | 864 | 149,429,360 | 371 | 774 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,167 | 4,323 | 2,243,715 | 275,652,919 | 2,761 | 280 | 280 | 571 | 834 | 554 | 93,500,799 | 233 | 395 | 
| regex_program | 1 | 807 | 3,496 | 1,921,511 | 242,975,404 | 2,374 | 256 | 204 | 516 | 752 | 440 | 73,010,353 | 197 | 315 | 

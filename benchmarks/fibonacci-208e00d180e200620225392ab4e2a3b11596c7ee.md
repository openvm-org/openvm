...
| `total_proof_time_ms ` |  6,091 |  6,091 |  6,091 |  6,091 |
...
| `perm_trace_commit_time_ms` |  1,633 |  1,633 |  1,633 |  1,633 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,722 |  7,722 |  7,722 |  7,722 |
| `main_cells_used     ` |  68,757,119 |  68,757,119 |  68,757,119 |  68,757,119 |
| `total_cycles        ` |  1,781,434 |  1,781,434 |  1,781,434 |  1,781,434 |
| `execute_time_ms     ` |  337 |  337 |  337 |  337 |
| `trace_gen_time_ms   ` |  1,212 |  1,212 |  1,212 |  1,212 |
| `stark_prove_excluding_trace_time_ms` |  6,173 |  6,173 |  6,173 |  6,173 |
| `main_trace_commit_time_ms` |  1,094 |  1,094 |  1,094 |  1,094 |
...
| `pcs_opening_time_ms ` |  1,268 |  1,268 |  1,268 |  1,268 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,212 | 7,722 | 1,781,434 | 180,014,040 | 6,173 | 1,471 | 1,016 | 1,189 | 1,268 | 1,094 | 68,757,119 | 131 | 337 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 823 | 6,091 | 1,500,092 | 197,435,660 | 4,953 | 785 | 526 | 1,633 | 1,027 | 799 | 51,484,605 | 179 | 315 | 

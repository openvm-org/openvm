...
| `total_proof_time_ms ` |  589.75 |  2,359 |  743 |  527 |
...
| `execute_preflight_time_ms` |  57.25 |  229 |  71 |  47 |
| `execute_preflight_insn_mi/s` |  31.17 | -          |  32.54 |  27.72 |
| `trace_gen_time_ms   ` |  176 |  704 |  212 |  150 |
| `memory_finalize_time_ms` |  0.75 |  3 |  3 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  288.75 |  1,155 |  338 |  263 |
| `main_trace_commit_time_ms` |  52 |  208 |  57 |  50 |
| `generate_perm_trace_time_ms` |  34 |  136 |  54 |  19 |
| `perm_trace_commit_time_ms` |  64.31 |  257.23 |  71.36 |  55.94 |
| `quotient_poly_compute_time_ms` |  58.75 |  234.99 |  70.52 |  52.73 |
| `quotient_poly_commit_time_ms` |  14.81 |  59.25 |  16.58 |  12.86 |
| `pcs_opening_time_ms ` |  61.25 |  245 |  77 |  50 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,445.50 |  5,782 |  2,097 |  916 |
...
| `execute_preflight_insns` |  1,440,834 |  5,763,336 |  1,814,599 |  1,241,324 |
| `execute_preflight_time_ms` |  694.50 |  2,778 |  933 |  230 |
| `execute_preflight_insn_mi/s` |  7.07 | -          |  7.39 |  6.79 |
| `trace_gen_time_ms   ` |  89 |  356 |  167 |  58 |
| `memory_finalize_time_ms` |  8.50 |  34 |  17 |  5 |
| `stark_prove_excluding_trace_time_ms` |  660.75 |  2,643 |  1,064 |  473 |
| `main_trace_commit_time_ms` |  125.50 |  502 |  196 |  91 |
| `generate_perm_trace_time_ms` |  50.25 |  201 |  74 |  35 |
| `perm_trace_commit_time_ms` |  200.28 |  801.12 |  345.03 |  140.97 |
| `quotient_poly_compute_time_ms` |  142.26 |  569.05 |  232.73 |  101.24 |
| `quotient_poly_commit_time_ms` |  31.11 |  124.46 |  51.68 |  23.24 |
| `pcs_opening_time_ms ` |  107.75 |  431 |  160 |  74 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 2,100 |  | 1 | 1 |  |  |  |  | 
| regex_program |  | 542 |  | 1 | 37 | 4,137,502 | 111.59 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 69 | 916 | 22,981,570 | 319,331,818 | 69 | 615 | 0 | 132.39 | 25.40 | 4 | 171.28 | 113 | 219 | 113 | 6 | 122 | 9,122,488 | 47 | 230 | 1,465,998 | 7.39 | 30 | 158 | 0 | 113 | 
| leaf | 1 | 58 | 1,465 | 20,905,034 | 255,237,610 | 58 | 473 | 0 | 101.24 | 23.24 | 4 | 143.84 | 74 | 179 | 74 | 6 | 93 | 8,256,948 | 35 | 933 | 1,241,324 | 7.03 | 25 | 125 | 0 | 74 | 
| leaf | 2 | 62 | 1,304 | 20,905,034 | 255,237,610 | 62 | 491 | 0 | 102.69 | 24.13 | 4 | 140.97 | 84 | 187 | 84 | 5 | 91 | 8,256,948 | 45 | 750 | 1,241,415 | 7.07 | 26 | 127 | 0 | 84 | 
| leaf | 3 | 167 | 2,097 | 50,337,320 | 538,365,418 | 167 | 1,064 | 0 | 232.73 | 51.68 | 4 | 345.03 | 160 | 419 | 160 | 17 | 196 | 20,171,106 | 74 | 865 | 1,814,599 | 6.79 | 61 | 288 | 5 | 160 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 212 | 743 | 23,446,148 | 150,778,428 | 212 | 338 | 0 | 58.85 | 16.58 | 5 | 71.36 | 77 | 126 | 77 | 3 | 57 | 10,899,170 | 54 | 47 | 1,103,000 | 27.72 | 21 | 76 | 1 | 76 | 
| regex_program | 1 | 150 | 547 | 11,598,276 | 128,513,066 | 150 | 284 | 1 | 52.90 | 14.90 | 4 | 64.87 | 62 | 102 | 62 | 0 | 50 | 2,196,106 | 37 | 71 | 1,104,000 | 32.31 | 16 | 68 | 0 | 62 | 
| regex_program | 2 | 160 | 527 | 11,579,064 | 128,513,066 | 160 | 263 | 1 | 52.73 | 14.90 | 4 | 65.06 | 50 | 92 | 50 | 0 | 51 | 2,177,334 | 26 | 63 | 1,104,000 | 32.54 | 16 | 68 | 0 | 50 | 
| regex_program | 3 | 182 | 542 | 11,853,872 | 103,456,394 | 182 | 270 | 0 | 70.52 | 12.86 | 5 | 55.94 | 56 | 79 | 55 | 0 | 50 | 2,422,606 | 19 | 48 | 826,502 | 32.10 | 18 | 84 | 1 | 55 | 
...
Commit: https://github.com/openvm-org/openvm/commit/280515e78aad7e75349c085e2075f7a8df2eb2c5
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19554195995)

...
| `total_proof_time_ms ` |  4,939 |  4,939 |  4,939 |  4,939 |
...
| `trace_gen_time_ms   ` |  974 |  974 |  974 |  974 |
| `stark_prove_excluding_trace_time_ms` |  3,301 |  3,301 |  3,301 |  3,301 |
| `main_trace_commit_time_ms` |  657 |  657 |  657 |  657 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  14,335 |  14,335 |  14,335 |  14,335 |
| `main_cells_used     ` |  273,858,874 |  273,858,874 |  273,858,874 |  273,858,874 |
| `total_cycles        ` |  3,267,543 |  3,267,543 |  3,267,543 |  3,267,543 |
| `execute_time_ms     ` |  1,273 |  1,273 |  1,273 |  1,273 |
| `trace_gen_time_ms   ` |  2,620 |  2,620 |  2,620 |  2,620 |
| `stark_prove_excluding_trace_time_ms` |  10,442 |  10,442 |  10,442 |  10,442 |
| `main_trace_commit_time_ms` |  1,796 |  1,796 |  1,796 |  1,796 |
| `generate_perm_trace_time_ms` |  765 |  765 |  765 |  765 |
| `perm_trace_commit_time_ms` |  3,450 |  3,450 |  3,450 |  3,450 |
| `quotient_poly_compute_time_ms` |  1,487 |  1,487 |  1,487 |  1,487 |
| `quotient_poly_commit_time_ms` |  986 |  986 |  986 |  986 |
| `pcs_opening_time_ms ` |  1,951 |  1,951 |  1,951 |  1,951 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 2,620 | 14,335 | 3,267,543 | 1,081,183,722 | 10,442 | 1,487 | 986 | 3,450 | 1,951 | 1,796 | 273,858,874 | 765 | 1,273 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 974 | 4,939 | 1,820,436 | 297,675,351 | 3,301 | 463 | 354 | 843 | 760 | 657 | 95,832,407 | 208 | 664 | 

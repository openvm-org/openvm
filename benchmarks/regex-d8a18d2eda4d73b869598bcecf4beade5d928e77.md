...
| `total_proof_time_ms ` |  4,152.50 |  8,305 |  4,571 |  3,734 |
...
| `trace_gen_time_ms   ` |  944 |  1,888 |  1,116 |  772 |
| `stark_prove_excluding_trace_time_ms` |  2,871.50 |  5,743 |  3,081 |  2,662 |
| `main_trace_commit_time_ms` |  519.50 |  1,039 |  581 |  458 |
| `generate_perm_trace_time_ms` |  194 |  388 |  204 |  184 |
| `perm_trace_commit_time_ms` |  745.50 |  1,491 |  799 |  692 |
| `quotient_poly_compute_time_ms` |  394 |  788 |  425 |  363 |
| `quotient_poly_commit_time_ms` |  299.50 |  599 |  335 |  264 |
| `pcs_opening_time_ms ` |  710 |  1,420 |  728 |  692 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,529.50 |  15,059 |  7,643 |  7,416 |
| `main_cells_used     ` |  152,278,213 |  304,556,426 |  154,677,790 |  149,878,636 |
| `total_cycles        ` |  1,991,029 |  3,982,058 |  2,021,833 |  1,960,225 |
| `execute_time_ms     ` |  756.50 |  1,513 |  762 |  751 |
| `trace_gen_time_ms   ` |  1,481.50 |  2,963 |  1,537 |  1,426 |
| `stark_prove_excluding_trace_time_ms` |  5,291.50 |  10,583 |  5,344 |  5,239 |
| `main_trace_commit_time_ms` |  891.50 |  1,783 |  893 |  890 |
| `generate_perm_trace_time_ms` |  364.50 |  729 |  367 |  362 |
| `perm_trace_commit_time_ms` |  1,683.50 |  3,367 |  1,732 |  1,635 |
| `quotient_poly_compute_time_ms` |  770 |  1,540 |  771 |  769 |
| `quotient_poly_commit_time_ms` |  523.50 |  1,047 |  524 |  523 |
| `pcs_opening_time_ms ` |  1,054 |  2,108 |  1,055 |  1,053 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,537 | 7,643 | 2,021,833 | 538,660,330 | 5,344 | 771 | 524 | 1,732 | 1,053 | 893 | 154,677,790 | 367 | 762 | 
| leaf | 1 | 1,426 | 7,416 | 1,960,225 | 538,660,330 | 5,239 | 769 | 523 | 1,635 | 1,055 | 890 | 149,878,636 | 362 | 751 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,116 | 4,571 | 2,243,715 | 275,652,919 | 3,081 | 425 | 335 | 799 | 728 | 581 | 94,156,159 | 204 | 374 | 
| regex_program | 1 | 772 | 3,734 | 1,921,511 | 242,975,404 | 2,662 | 363 | 264 | 692 | 692 | 458 | 73,665,713 | 184 | 300 | 

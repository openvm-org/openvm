...
| `execute_metered_insn_mi/s` |  148.85 | -          |  148.85 |  148.85 |
| `execute_preflight_insns` |  750,105 |  1,500,210 |  873,000 |  627,210 |
| `execute_preflight_time_ms` |  28.50 |  57 |  32 |  25 |
| `execute_preflight_insn_mi/s` |  38.17 | -          |  40.18 |  36.15 |
| `trace_gen_time_ms   ` |  205.50 |  411 |  211 |  200 |
| `memory_finalize_time_ms` | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  269 |  538 |  280 |  258 |
| `main_trace_commit_time_ms` |  32.50 |  65 |  35 |  30 |
| `generate_perm_trace_time_ms` |  31.50 |  63 |  36 |  27 |
| `perm_trace_commit_time_ms` |  42.77 |  85.54 |  45.62 |  39.92 |
| `quotient_poly_compute_time_ms` |  30.25 |  60.50 |  32.80 |  27.70 |
| `quotient_poly_commit_time_ms` |  13.60 |  27.20 |  13.66 |  13.54 |
| `pcs_opening_time_ms ` |  116.50 |  233 |  124 |  109 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,239.50 |  2,479 |  1,473 |  1,006 |
...
| `execute_preflight_time_ms` |  497 |  994 |  794 |  200 |
| `execute_preflight_insn_mi/s` |  6.79 | -          |  6.87 |  6.71 |
| `trace_gen_time_ms   ` |  58 |  116 |  60 |  56 |
| `memory_finalize_time_ms` |  5.50 |  11 |  6 |  5 |
| `stark_prove_excluding_trace_time_ms` |  683 |  1,366 |  745 |  621 |
| `main_trace_commit_time_ms` |  89 |  178 |  97 |  81 |
| `generate_perm_trace_time_ms` |  41 |  82 |  52 |  30 |
| `perm_trace_commit_time_ms` |  130.14 |  260.29 |  147.39 |  112.90 |
| `quotient_poly_compute_time_ms` |  86.19 |  172.38 |  94.66 |  77.72 |
| `quotient_poly_commit_time_ms` |  25.08 |  50.16 |  27.87 |  22.29 |
| `pcs_opening_time_ms ` |  308 |  616 |  322 |  294 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program |  | 532 |  | 41 | 1 | 10 | 1,500,210 | 148.85 | 143 | 
| leaf | 1,474 |  | 1 |  | 1 |  |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 60 | 1,006 | 17,887,054 | 252,878,314 | 60 | 745 | 0 | 94.66 | 27.87 | 4 | 147.39 | 322 | 200 | 322 | 6 | 97 | 6,608,072 | 52 | 200 | 1,229,594 | 6.87 | 24 | 123 | 1 | 322 | 
| leaf | 1 | 56 | 1,473 | 17,250,234 | 207,789,546 | 56 | 621 | 0 | 77.72 | 22.29 | 4 | 112.90 | 294 | 143 | 294 | 5 | 81 | 6,343,052 | 30 | 794 | 1,151,214 | 6.71 | 21 | 100 | 1 | 294 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 211 | 664 | 9,684,992 | 84,395,212 | 211 | 280 | 0 | 32.80 | 13.66 | 4 | 45.62 | 124 | 73 | 124 | 0 | 35 | 1,040,430 | 27 | 25 | 873,000 | 36.15 | 13 | 46 | 1 | 124 | 
| fibonacci_program | 1 | 200 | 532 | 9,714,030 | 74,305,770 | 200 | 258 | 1 | 27.70 | 13.54 | 4 | 39.92 | 109 | 76 | 109 | 0 | 30 | 1,067,532 | 36 | 32 | 627,210 | 40.18 | 10 | 41 | 1 | 109 | 

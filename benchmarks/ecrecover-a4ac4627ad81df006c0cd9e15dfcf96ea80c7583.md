...
| `total_proof_time_ms ` |  2,501 |  2,501 |  2,501 |  2,501 |
...
| `quotient_poly_commit_time_ms` |  487 |  487 |  487 |  487 |
| `pcs_opening_time_ms ` |  663 |  663 |  663 |  663 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  11,318 |  11,318 |  11,318 |  11,318 |
| `main_cells_used     ` |  117,320,775 |  117,320,775 |  117,320,775 |  117,320,775 |
| `total_cycles        ` |  1,603,995 |  1,603,995 |  1,603,995 |  1,603,995 |
| `execute_time_ms     ` |  560 |  560 |  560 |  560 |
| `trace_gen_time_ms   ` |  1,549 |  1,549 |  1,549 |  1,549 |
| `stark_prove_excluding_trace_time_ms` |  9,209 |  9,209 |  9,209 |  9,209 |
| `main_trace_commit_time_ms` |  1,904 |  1,904 |  1,904 |  1,904 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,549 | 11,318 | 1,603,995 | 334,709,720 | 9,209 | 1,476 | 1,679 | 2,019 | 1,865 | 1,904 | 117,320,775 | 262 | 560 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 181 | 2,501 | 284,567 | 38,417,467 | 2,174 | 225 | 487 | 363 | 663 | 391 | 15,055,723 | 32 | 146 | 

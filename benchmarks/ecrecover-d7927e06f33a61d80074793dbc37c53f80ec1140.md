...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  16,225 |  16,225 |  16,225 |  16,225 |
| `main_cells_used     ` |  168,281,801 |  168,281,801 |  168,281,801 |  168,281,801 |
| `total_cycles        ` |  3,484,336 |  3,484,336 |  3,484,336 |  3,484,336 |
| `execute_time_ms     ` |  931 |  931 |  931 |  931 |
| `trace_gen_time_ms   ` |  2,405 |  2,405 |  2,405 |  2,405 |
| `stark_prove_excluding_trace_time_ms` |  12,889 |  12,889 |  12,889 |  12,889 |
| `main_trace_commit_time_ms` |  2,703 |  2,703 |  2,703 |  2,703 |
| `generate_perm_trace_time_ms` |  336 |  336 |  336 |  336 |
| `perm_trace_commit_time_ms` |  2,719 |  2,719 |  2,719 |  2,719 |
| `quotient_poly_compute_time_ms` |  1,900 |  1,900 |  1,900 |  1,900 |
| `quotient_poly_commit_time_ms` |  2,387 |  2,387 |  2,387 |  2,387 |
| `pcs_opening_time_ms ` |  2,840 |  2,840 |  2,840 |  2,840 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 2,405 | 16,225 | 3,484,336 | 430,851,032 | 12,889 | 1,900 | 2,387 | 2,719 | 2,840 | 2,703 | 168,281,801 | 336 | 931 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 181 | 2,476 | 284,567 | 38,417,467 | 2,150 | 220 | 473 | 352 | 667 | 389 | 15,055,723 | 36 | 145 | 

...
| `total_proof_time_ms ` |  2,763 |  2,763 |  2,763 |  2,763 |
| `main_cells_used     ` |  51,485,167 |  51,485,167 |  51,485,167 |  51,485,167 |
| `total_cycles        ` |  1,500,096 |  1,500,096 |  1,500,096 |  1,500,096 |
| `execute_time_ms     ` |  236 |  236 |  236 |  236 |
| `trace_gen_time_ms   ` |  550 |  550 |  550 |  550 |
| `stark_prove_excluding_trace_time_ms` |  1,977 |  1,977 |  1,977 |  1,977 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  3,804 |  3,804 |  3,804 |  3,804 |
| `main_cells_used     ` |  70,352,015 |  70,352,015 |  70,352,015 |  70,352,015 |
| `total_cycles        ` |  1,265,509 |  1,265,509 |  1,265,509 |  1,265,509 |
| `execute_time_ms     ` |  529 |  529 |  529 |  529 |
| `trace_gen_time_ms   ` |  669 |  669 |  669 |  669 |
| `stark_prove_excluding_trace_time_ms` |  2,606 |  2,606 |  2,606 |  2,606 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 669 | 3,804 | 1,265,509 | 252,059,114 | 2,606 | 377 | 284 | 731 | 610 | 439 | 70,352,015 | 159 | 529 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 550 | 2,763 | 1,500,096 | 160,733,916 | 1,977 | 249 | 235 | 506 | 509 | 360 | 51,485,167 | 111 | 236 | 

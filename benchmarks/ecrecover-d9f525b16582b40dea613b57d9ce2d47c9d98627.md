...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  13,607 |  13,607 |  13,607 |  13,607 |
| `main_cells_used     ` |  133,785,989 |  133,785,989 |  133,785,989 |  133,785,989 |
| `total_cycles        ` |  2,253,326 |  2,253,326 |  2,253,326 |  2,253,326 |
| `execute_time_ms     ` |  712 |  712 |  712 |  712 |
| `trace_gen_time_ms   ` |  1,743 |  1,743 |  1,743 |  1,743 |
| `stark_prove_excluding_trace_time_ms` |  11,152 |  11,152 |  11,152 |  11,152 |
| `main_trace_commit_time_ms` |  2,433 |  2,433 |  2,433 |  2,433 |
| `generate_perm_trace_time_ms` |  317 |  317 |  317 |  317 |
| `perm_trace_commit_time_ms` |  2,369 |  2,369 |  2,369 |  2,369 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,743 | 13,607 | 2,253,326 | 377,489,890 | 11,152 | 1,665 | 2,075 | 2,369 | 2,285 | 2,433 | 133,785,989 | 317 | 712 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 193 | 2,509 | 295,181 | 38,665,477 | 2,162 | 226 | 457 | 356 | 692 | 382 | 15,586,346 | 35 | 154 | 

...
| `total_proof_time_ms ` |  2,640 |  2,640 |  2,640 |  2,640 |
...
| `stark_prove_excluding_trace_time_ms` |  2,224 |  2,224 |  2,224 |  2,224 |
...
| `quotient_poly_compute_time_ms` |  306 |  306 |  306 |  306 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  42,212 |  42,212 |  42,212 |  42,212 |
| `main_cells_used     ` |  365,932,096 |  365,932,096 |  365,932,096 |  365,932,096 |
| `total_cycles        ` |  8,657,518 |  8,657,518 |  8,657,518 |  8,657,518 |
| `execute_time_ms     ` |  2,476 |  2,476 |  2,476 |  2,476 |
| `trace_gen_time_ms   ` |  6,532 |  6,532 |  6,532 |  6,532 |
| `stark_prove_excluding_trace_time_ms` |  33,204 |  33,204 |  33,204 |  33,204 |
| `main_trace_commit_time_ms` |  5,829 |  5,829 |  5,829 |  5,829 |
| `generate_perm_trace_time_ms` |  714 |  714 |  714 |  714 |
| `perm_trace_commit_time_ms` |  7,231 |  7,231 |  7,231 |  7,231 |
| `quotient_poly_compute_time_ms` |  8,055 |  8,055 |  8,055 |  8,055 |
| `quotient_poly_commit_time_ms` |  5,094 |  5,094 |  5,094 |  5,094 |
| `pcs_opening_time_ms ` |  6,280 |  6,280 |  6,280 |  6,280 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 6,532 | 42,212 | 8,657,518 | 1,052,183,000 | 33,204 | 8,055 | 5,094 | 7,231 | 6,280 | 5,829 | 365,932,096 | 714 | 2,476 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 265 | 2,640 | 285,401 | 56,172,159 | 2,224 | 306 | 327 | 532 | 624 | 390 | 15,092,297 | 42 | 151 | 

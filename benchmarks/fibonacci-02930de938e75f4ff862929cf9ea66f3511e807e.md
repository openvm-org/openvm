...
| `total_proof_time_ms ` |  5,010 |  5,010 |  5,010 |  5,010 |
...
| `main_cells_used     ` |  38,846,692 |  38,846,692 |  38,846,692 |  38,846,692 |
| `total_cycles        ` |  815,511 |  815,511 |  815,511 |  815,511 |
| `execute_time_ms     ` |  275 |  275 |  275 |  275 |
| `trace_gen_time_ms   ` |  657 |  657 |  657 |  657 |
| `stark_prove_excluding_trace_time_ms` |  3,149 |  3,149 |  3,149 |  3,149 |
| `main_trace_commit_time_ms` |  614 |  614 |  614 |  614 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 657 | 4,081 | 815,511 | 95,033,826 | 3,149 | 466 | 657 | 597 | 725 | 614 | 38,846,692 | 82 | 275 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 618 | 5,010 | 1,500,096 | 122,458,688 | 4,096 | 520 | 767 | 805 | 986 | 862 | 51,485,167 | 147 | 296 | 

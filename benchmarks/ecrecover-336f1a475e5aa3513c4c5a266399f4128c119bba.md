...
| `stark_prove_excluding_trace_time_ms` |  2,147 |  2,147 |  2,147 |  2,147 |
| `main_trace_commit_time_ms` |  395 |  395 |  395 |  395 |
| `generate_perm_trace_time_ms` |  34 |  34 |  34 |  34 |
| `perm_trace_commit_time_ms` |  347 |  347 |  347 |  347 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  18,219 |  18,219 |  18,219 |  18,219 |
| `main_cells_used     ` |  186,731,626 |  186,731,626 |  186,731,626 |  186,731,626 |
| `total_cycles        ` |  4,157,783 |  4,157,783 |  4,157,783 |  4,157,783 |
| `execute_time_ms     ` |  930 |  930 |  930 |  930 |
| `trace_gen_time_ms   ` |  3,442 |  3,442 |  3,442 |  3,442 |
| `stark_prove_excluding_trace_time_ms` |  13,847 |  13,847 |  13,847 |  13,847 |
| `main_trace_commit_time_ms` |  2,749 |  2,749 |  2,749 |  2,749 |
| `generate_perm_trace_time_ms` |  353 |  353 |  353 |  353 |
| `perm_trace_commit_time_ms` |  2,870 |  2,870 |  2,870 |  2,870 |
| `quotient_poly_compute_time_ms` |  2,094 |  2,094 |  2,094 |  2,094 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 3,442 | 18,219 | 4,157,783 | 459,031,512 | 13,847 | 2,094 | 2,668 | 2,870 | 3,108 | 2,749 | 186,731,626 | 353 | 930 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 251 | 2,546 | 284,567 | 38,417,467 | 2,147 | 224 | 473 | 347 | 661 | 395 | 15,055,723 | 34 | 148 | 

...
| `stark_prove_excluding_trace_time_ms` |  1,127 |  1,127 |  1,127 |  1,127 |
...
| `main_cells_used     ` |  244,317,642 |  244,317,642 |  244,317,642 |  244,317,642 |
| `total_cycles        ` |  2,989,472 |  2,989,472 |  2,989,472 |  2,989,472 |
| `execute_time_ms     ` |  1,141 |  1,141 |  1,141 |  1,141 |
| `trace_gen_time_ms   ` |  2,352 |  2,352 |  2,352 |  2,352 |
| `stark_prove_excluding_trace_time_ms` |  9,327 |  9,327 |  9,327 |  9,327 |
| `main_trace_commit_time_ms` |  1,632 |  1,632 |  1,632 |  1,632 |
| `generate_perm_trace_time_ms` |  674 |  674 |  674 |  674 |
| `perm_trace_commit_time_ms` |  3,041 |  3,041 |  3,041 |  3,041 |
| `quotient_poly_compute_time_ms` |  1,346 |  1,346 |  1,346 |  1,346 |
| `quotient_poly_commit_time_ms` |  839 |  839 |  839 |  839 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 2,352 | 12,820 | 2,989,472 | 999,656,938 | 9,327 | 1,346 | 839 | 3,041 | 1,790 | 1,632 | 244,317,642 | 674 | 1,141 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 175 | 1,452 | 295,181 | 48,197,161 | 1,127 | 124 | 161 | 204 | 411 | 180 | 15,586,346 | 32 | 150 | 

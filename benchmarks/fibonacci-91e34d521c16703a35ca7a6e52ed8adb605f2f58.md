...
| `total_proof_time_ms ` |  483.50 |  967 |  547 |  420 |
...
| `execute_preflight_insn_mi/s` |  36.62 | -          |  38.41 |  34.82 |
...
| `perm_trace_commit_time_ms` |  41.12 |  82.24 |  44.23 |  38.01 |
| `quotient_poly_compute_time_ms` |  31.16 |  62.32 |  32.17 |  30.15 |
| `quotient_poly_commit_time_ms` |  12.33 |  24.65 |  12.79 |  11.86 |
| `pcs_opening_time_ms ` |  42.50 |  85 |  44 |  41 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,007.50 |  2,015 |  1,275 |  740 |
...
| `execute_preflight_time_ms` |  509.50 |  1,019 |  819 |  200 |
| `execute_preflight_insn_mi/s` |  6.82 | -          |  6.89 |  6.75 |
| `trace_gen_time_ms   ` |  59 |  118 |  65 |  53 |
| `memory_finalize_time_ms` |  5 |  10 |  5 |  5 |
| `stark_prove_excluding_trace_time_ms` |  438 |  876 |  474 |  402 |
| `main_trace_commit_time_ms` |  83 |  166 |  90 |  76 |
| `generate_perm_trace_time_ms` |  35.50 |  71 |  39 |  32 |
| `perm_trace_commit_time_ms` |  123.34 |  246.69 |  141.35 |  105.34 |
| `quotient_poly_compute_time_ms` |  90.79 |  181.58 |  98.69 |  82.89 |
| `quotient_poly_commit_time_ms` |  21.13 |  42.27 |  22.72 |  19.55 |
| `pcs_opening_time_ms ` |  81 |  162 |  86 |  76 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program |  | 420 |  | 1 | 13 | 1,500,209 | 111.85 | 0 | 
| leaf | 1,277 |  | 1 | 1 |  |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 65 | 740 | 17,887,054 | 252,878,314 | 65 | 474 | 0 | 98.69 | 22.72 | 4 | 141.35 | 86 | 174 | 86 | 5 | 90 | 6,608,072 | 32 | 200 | 1,229,669 | 6.89 | 25 | 122 | 0 | 86 | 
| leaf | 1 | 53 | 1,275 | 17,250,234 | 207,789,546 | 53 | 402 | 0 | 82.89 | 19.55 | 4 | 105.34 | 76 | 145 | 76 | 5 | 76 | 6,343,052 | 39 | 819 | 1,151,166 | 6.75 | 22 | 103 | 0 | 76 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 192 | 547 | 9,677,708 | 84,395,212 | 192 | 184 | 0 | 32.17 | 12.79 | 4 | 44.23 | 44 | 61 | 44 | 0 | 33 | 1,035,986 | 16 | 25 | 873,000 | 34.82 | 14 | 45 | 0 | 44 | 
| fibonacci_program | 1 | 182 | 420 | 9,708,170 | 74,305,770 | 182 | 162 | 1 | 30.15 | 11.86 | 4 | 38.01 | 41 | 50 | 41 | 0 | 28 | 1,064,416 | 11 | 34 | 627,209 | 38.41 | 11 | 42 | 0 | 41 | 

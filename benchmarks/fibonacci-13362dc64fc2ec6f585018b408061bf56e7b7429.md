...
| `total_proof_time_ms ` |  512 |  1,024 |  593 |  431 |
...
| `execute_preflight_insn_mi/s` |  38.16 | -          |  40.09 |  36.22 |
| `trace_gen_time_ms   ` |  191.50 |  383 |  197 |  186 |
| `memory_finalize_time_ms` | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  196.50 |  393 |  223 |  170 |
| `main_trace_commit_time_ms` |  30 |  60 |  32 |  28 |
| `generate_perm_trace_time_ms` |  25 |  50 |  30 |  20 |
| `perm_trace_commit_time_ms` |  40.94 |  81.87 |  43.89 |  37.98 |
| `quotient_poly_compute_time_ms` |  30.22 |  60.45 |  33.12 |  27.33 |
| `quotient_poly_commit_time_ms` |  11.75 |  23.50 |  12.24 |  11.27 |
| `pcs_opening_time_ms ` |  56.50 |  113 |  69 |  44 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,018 |  2,036 |  1,291 |  745 |
...
| `execute_preflight_time_ms` |  525 |  1,050 |  846 |  204 |
| `execute_preflight_insn_mi/s` |  6.60 | -          |  6.72 |  6.48 |
| `trace_gen_time_ms   ` |  57 |  114 |  60 |  54 |
| `memory_finalize_time_ms` |  5 |  10 |  5 |  5 |
| `stark_prove_excluding_trace_time_ms` |  435 |  870 |  480 |  390 |
| `main_trace_commit_time_ms` |  83 |  166 |  90 |  76 |
| `generate_perm_trace_time_ms` |  32 |  64 |  35 |  29 |
| `perm_trace_commit_time_ms` |  124.15 |  248.29 |  141.24 |  107.05 |
| `quotient_poly_compute_time_ms` |  90.52 |  181.04 |  99 |  82.04 |
| `quotient_poly_commit_time_ms` |  20.82 |  41.64 |  22.27 |  19.37 |
| `pcs_opening_time_ms ` |  81.50 |  163 |  89 |  74 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program |  | 431 |  | 42 | 1 | 10 | 1,500,209 | 145.59 | 142 | 
| leaf | 1,292 |  | 1 |  | 1 |  |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 60 | 745 | 17,887,054 | 252,878,314 | 60 | 480 | 0 | 99 | 22.27 | 5 | 141.24 | 89 | 177 | 89 | 5 | 90 | 6,608,072 | 35 | 204 | 1,229,687 | 6.72 | 25 | 122 | 0 | 89 | 
| leaf | 1 | 54 | 1,291 | 17,250,234 | 207,789,546 | 54 | 390 | 0 | 82.04 | 19.37 | 4 | 107.05 | 74 | 137 | 74 | 5 | 76 | 6,343,052 | 29 | 846 | 1,151,179 | 6.48 | 22 | 102 | 0 | 74 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 197 | 593 | 9,677,708 | 84,395,212 | 197 | 223 | 0 | 33.12 | 12.24 | 4 | 43.89 | 69 | 74 | 69 | 0 | 32 | 1,035,986 | 30 | 25 | 873,000 | 36.22 | 14 | 45 | 0 | 69 | 
| fibonacci_program | 1 | 186 | 431 | 9,708,170 | 74,305,770 | 186 | 170 | 1 | 27.33 | 11.27 | 4 | 37.98 | 44 | 59 | 43 | 0 | 28 | 1,064,416 | 20 | 32 | 627,209 | 40.09 | 11 | 39 | 0 | 43 | 

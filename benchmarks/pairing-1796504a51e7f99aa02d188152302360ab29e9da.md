...
|:---|---:|---:|---:|
| Total |  4.43 |  2.58 | 2.58 |
| pairing |  1.57 |  0.91 |  0.91 |
| leaf |  2.86 |  1.67 |  1.67 |
...
| `total_proof_time_ms ` |  751.50 |  1,503 |  849 |  654 |
...
| `execute_preflight_insn_mi/s` |  14.92 | -          |  18.26 |  11.58 |
| `trace_gen_time_ms   ` |  186 |  372 |  204 |  168 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  377.50 |  755 |  394 |  361 |
| `main_trace_commit_time_ms` |  63.50 |  127 |  74 |  53 |
| `generate_perm_trace_time_ms` |  61.50 |  123 |  85 |  38 |
| `perm_trace_commit_time_ms` |  77.38 |  154.75 |  89.29 |  65.46 |
| `quotient_poly_compute_time_ms` |  84.67 |  169.34 |  94.32 |  75.02 |
| `quotient_poly_commit_time_ms` |  17.73 |  35.47 |  19.84 |  15.63 |
| `pcs_opening_time_ms ` |  67.50 |  135 |  73 |  62 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,430 |  2,860 |  1,667 |  1,193 |
| `main_cells_used     ` |  16,200,472 |  32,400,944 |  16,332,746 |  16,068,198 |
| `total_cells_used    ` |  39,332,920 |  78,665,840 |  39,650,868 |  39,014,972 |
| `execute_preflight_insns` |  1,952,398.50 |  3,904,797 |  1,991,875 |  1,912,922 |
| `execute_preflight_time_ms` |  562.50 |  1,125 |  824 |  301 |
| `execute_preflight_insn_mi/s` |  7.70 | -          |  7.71 |  7.70 |
| `trace_gen_time_ms   ` |  119 |  238 |  127 |  111 |
| `memory_finalize_time_ms` |  12 |  24 |  12 |  12 |
| `stark_prove_excluding_trace_time_ms` |  747 |  1,494 |  763 |  731 |
| `main_trace_commit_time_ms` |  146 |  292 |  150 |  142 |
| `generate_perm_trace_time_ms` |  57.50 |  115 |  62 |  53 |
| `perm_trace_commit_time_ms` |  228.15 |  456.30 |  232.19 |  224.11 |
| `quotient_poly_compute_time_ms` |  173.04 |  346.07 |  173.77 |  172.31 |
| `quotient_poly_commit_time_ms` |  32.100 |  65.100 |  33.50 |  32.50 |
| `pcs_opening_time_ms ` |  106 |  212 |  108 |  104 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 1,669 |  | 1 | 1 |  |  |  |  | 
| pairing |  | 654 |  | 1 | 63 | 1,745,742 | 27.55 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 127 | 1,193 | 39,650,868 | 410,701,290 | 127 | 763 | 0 | 173.77 | 33.50 | 4 | 232.19 | 108 | 295 | 108 | 12 | 150 | 16,332,746 | 62 | 301 | 1,991,875 | 7.70 | 39 | 208 | 0 | 108 | 
| leaf | 1 | 111 | 1,667 | 39,014,972 | 396,840,426 | 111 | 731 | 0 | 172.31 | 32.50 | 4 | 224.11 | 104 | 278 | 104 | 12 | 142 | 16,068,198 | 53 | 824 | 1,912,922 | 7.71 | 38 | 206 | 0 | 104 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 168 | 849 | 32,480,114 | 172,558,444 | 168 | 394 | 0 | 94.32 | 19.84 | 6 | 89.29 | 73 | 130 | 73 | 1 | 74 | 15,909,408 | 38 | 117 | 1,149,000 | 11.58 | 27 | 115 | 1 | 73 | 
| pairing | 1 | 204 | 654 | 22,464,232 | 119,958,502 | 204 | 361 | 1 | 75.02 | 15.63 | 6 | 65.46 | 62 | 153 | 61 | 0 | 53 | 9,498,894 | 85 | 47 | 596,742 | 18.26 | 21 | 91 | 1 | 61 | 

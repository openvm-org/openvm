...
| `stark_prove_excluding_trace_time_ms` |  2,200 |  2,200 |  2,200 |  2,200 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  42,321 |  42,321 |  42,321 |  42,321 |
| `main_cells_used     ` |  365,910,116 |  365,910,116 |  365,910,116 |  365,910,116 |
| `total_cycles        ` |  8,655,320 |  8,655,320 |  8,655,320 |  8,655,320 |
| `execute_time_ms     ` |  2,576 |  2,576 |  2,576 |  2,576 |
| `trace_gen_time_ms   ` |  6,460 |  6,460 |  6,460 |  6,460 |
| `stark_prove_excluding_trace_time_ms` |  33,285 |  33,285 |  33,285 |  33,285 |
| `main_trace_commit_time_ms` |  5,870 |  5,870 |  5,870 |  5,870 |
| `generate_perm_trace_time_ms` |  709 |  709 |  709 |  709 |
| `perm_trace_commit_time_ms` |  7,280 |  7,280 |  7,280 |  7,280 |
| `quotient_poly_compute_time_ms` |  7,865 |  7,865 |  7,865 |  7,865 |
| `quotient_poly_commit_time_ms` |  5,254 |  5,254 |  5,254 |  5,254 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 6,460 | 42,321 | 8,655,320 | 1,052,183,000 | 33,285 | 7,865 | 5,254 | 7,280 | 6,305 | 5,870 | 365,910,116 | 709 | 2,576 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 258 | 2,602 | 285,401 | 56,172,159 | 2,200 | 296 | 311 | 526 | 633 | 394 | 15,092,297 | 39 | 144 | 

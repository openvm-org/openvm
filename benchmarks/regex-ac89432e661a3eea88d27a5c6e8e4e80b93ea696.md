...
| `total_proof_time_ms ` |  4,178 |  8,356 |  4,654 |  3,702 |
| `main_cells_used     ` |  83,910,936 |  167,821,872 |  94,156,159 |  73,665,713 |
| `total_cycles        ` |  2,082,613 |  4,165,226 |  2,243,715 |  1,921,511 |
| `execute_time_ms     ` |  340 |  680 |  378 |  302 |
| `trace_gen_time_ms   ` |  974.50 |  1,949 |  1,171 |  778 |
| `stark_prove_excluding_trace_time_ms` |  2,863.50 |  5,727 |  3,105 |  2,622 |
| `main_trace_commit_time_ms` |  520 |  1,040 |  583 |  457 |
| `generate_perm_trace_time_ms` |  187.50 |  375 |  196 |  179 |
| `perm_trace_commit_time_ms` |  749.50 |  1,499 |  803 |  696 |
| `quotient_poly_compute_time_ms` |  399 |  798 |  430 |  368 |
| `quotient_poly_commit_time_ms` |  300 |  600 |  336 |  264 |
| `pcs_opening_time_ms ` |  697.50 |  1,395 |  747 |  648 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,513 |  15,026 |  7,570 |  7,456 |
| `main_cells_used     ` |  152,278,111 |  304,556,222 |  154,677,934 |  149,878,288 |
| `total_cycles        ` |  1,991,020.50 |  3,982,041 |  2,021,845 |  1,960,196 |
| `execute_time_ms     ` |  772 |  1,544 |  779 |  765 |
| `trace_gen_time_ms   ` |  1,444.50 |  2,889 |  1,472 |  1,417 |
| `stark_prove_excluding_trace_time_ms` |  5,296.50 |  10,593 |  5,319 |  5,274 |
| `main_trace_commit_time_ms` |  894 |  1,788 |  898 |  890 |
| `generate_perm_trace_time_ms` |  361.50 |  723 |  362 |  361 |
| `perm_trace_commit_time_ms` |  1,683 |  3,366 |  1,701 |  1,665 |
| `quotient_poly_compute_time_ms` |  761.50 |  1,523 |  763 |  760 |
| `quotient_poly_commit_time_ms` |  527 |  1,054 |  528 |  526 |
| `pcs_opening_time_ms ` |  1,065 |  2,130 |  1,067 |  1,063 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,472 | 7,570 | 2,021,845 | 538,660,330 | 5,319 | 760 | 528 | 1,701 | 1,067 | 898 | 154,677,934 | 361 | 779 | 
| leaf | 1 | 1,417 | 7,456 | 1,960,196 | 538,660,330 | 5,274 | 763 | 526 | 1,665 | 1,063 | 890 | 149,878,288 | 362 | 765 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,171 | 4,654 | 2,243,715 | 275,652,919 | 3,105 | 430 | 336 | 803 | 747 | 583 | 94,156,159 | 196 | 378 | 
| regex_program | 1 | 778 | 3,702 | 1,921,511 | 242,975,404 | 2,622 | 368 | 264 | 696 | 648 | 457 | 73,665,713 | 179 | 302 | 

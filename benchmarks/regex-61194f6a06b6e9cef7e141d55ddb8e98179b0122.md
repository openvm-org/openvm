...
| `total_proof_time_ms ` |  4,013.50 |  8,027 |  4,463 |  3,564 |
...
| `trace_gen_time_ms   ` |  957.50 |  1,915 |  1,145 |  770 |
| `stark_prove_excluding_trace_time_ms` |  2,717.50 |  5,435 |  2,942 |  2,493 |
| `main_trace_commit_time_ms` |  469.50 |  939 |  530 |  409 |
| `generate_perm_trace_time_ms` |  196 |  392 |  201 |  191 |
| `perm_trace_commit_time_ms` |  688 |  1,376 |  739 |  637 |
| `quotient_poly_compute_time_ms` |  399.50 |  799 |  428 |  371 |
| `quotient_poly_commit_time_ms` |  280 |  560 |  319 |  241 |
| `pcs_opening_time_ms ` |  675 |  1,350 |  716 |  634 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,295 |  14,590 |  7,366 |  7,224 |
| `main_cells_used     ` |  152,278,091 |  304,556,182 |  154,677,302 |  149,878,880 |
| `total_cycles        ` |  1,990,993.50 |  3,981,987 |  2,021,767 |  1,960,220 |
| `execute_time_ms     ` |  767 |  1,534 |  776 |  758 |
| `trace_gen_time_ms   ` |  1,464 |  2,928 |  1,486 |  1,442 |
| `stark_prove_excluding_trace_time_ms` |  5,064 |  10,128 |  5,104 |  5,024 |
| `main_trace_commit_time_ms` |  808 |  1,616 |  809 |  807 |
| `generate_perm_trace_time_ms` |  372.50 |  745 |  385 |  360 |
| `perm_trace_commit_time_ms` |  1,561 |  3,122 |  1,590 |  1,532 |
| `quotient_poly_compute_time_ms` |  763.50 |  1,527 |  766 |  761 |
| `quotient_poly_commit_time_ms` |  492.50 |  985 |  494 |  491 |
| `pcs_opening_time_ms ` |  1,062 |  2,124 |  1,069 |  1,055 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,486 | 7,366 | 2,021,767 | 538,660,330 | 5,104 | 766 | 494 | 1,590 | 1,055 | 809 | 154,677,302 | 385 | 776 | 
| leaf | 1 | 1,442 | 7,224 | 1,960,220 | 538,660,330 | 5,024 | 761 | 491 | 1,532 | 1,069 | 807 | 149,878,880 | 360 | 758 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,145 | 4,463 | 2,243,715 | 275,652,919 | 2,942 | 428 | 319 | 739 | 716 | 530 | 93,500,799 | 201 | 376 | 
| regex_program | 1 | 770 | 3,564 | 1,921,511 | 242,975,404 | 2,493 | 371 | 241 | 637 | 634 | 409 | 73,010,353 | 191 | 301 | 

...
| `stark_prove_excluding_trace_time_ms` |  2,196 |  2,196 |  2,196 |  2,196 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  13,593 |  13,593 |  13,593 |  13,593 |
| `main_cells_used     ` |  133,785,797 |  133,785,797 |  133,785,797 |  133,785,797 |
| `total_cycles        ` |  2,253,310 |  2,253,310 |  2,253,310 |  2,253,310 |
| `execute_time_ms     ` |  706 |  706 |  706 |  706 |
| `trace_gen_time_ms   ` |  1,719 |  1,719 |  1,719 |  1,719 |
| `stark_prove_excluding_trace_time_ms` |  11,168 |  11,168 |  11,168 |  11,168 |
| `main_trace_commit_time_ms` |  2,429 |  2,429 |  2,429 |  2,429 |
| `generate_perm_trace_time_ms` |  314 |  314 |  314 |  314 |
| `perm_trace_commit_time_ms` |  2,403 |  2,403 |  2,403 |  2,403 |
| `quotient_poly_compute_time_ms` |  1,651 |  1,651 |  1,651 |  1,651 |
| `quotient_poly_commit_time_ms` |  2,063 |  2,063 |  2,063 |  2,063 |
| `pcs_opening_time_ms ` |  2,303 |  2,303 |  2,303 |  2,303 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,719 | 13,593 | 2,253,310 | 377,489,890 | 11,168 | 1,651 | 2,063 | 2,403 | 2,303 | 2,429 | 133,785,797 | 314 | 706 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 186 | 2,530 | 295,181 | 38,665,477 | 2,196 | 227 | 499 | 352 | 688 | 381 | 15,586,346 | 34 | 148 | 

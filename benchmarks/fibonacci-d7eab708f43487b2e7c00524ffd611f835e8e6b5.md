...
| `total_proof_time_ms ` |  514 |  1,028 |  595 |  433 |
...
| `execute_preflight_insn_mi/s` |  36.55 | -          |  38.53 |  34.57 |
| `trace_gen_time_ms   ` |  191.50 |  383 |  200 |  183 |
| `memory_finalize_time_ms` | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  187 |  374 |  199 |  175 |
| `main_trace_commit_time_ms` |  30.50 |  61 |  33 |  28 |
| `generate_perm_trace_time_ms` |  23.50 |  47 |  26 |  21 |
| `perm_trace_commit_time_ms` |  41.58 |  83.16 |  44.29 |  38.88 |
| `quotient_poly_compute_time_ms` |  32.22 |  64.45 |  35.56 |  28.89 |
| `quotient_poly_commit_time_ms` |  12.48 |  24.97 |  13.24 |  11.73 |
| `pcs_opening_time_ms ` |  45 |  90 |  46 |  44 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,015.50 |  2,031 |  1,295 |  736 |
| `main_cells_used     ` |  6,475,562 |  12,951,124 |  6,608,072 |  6,343,052 |
| `total_cells_used    ` |  17,568,644 |  35,137,288 |  17,887,054 |  17,250,234 |
| `execute_preflight_insns` |  1,190,397.50 |  2,380,795 |  1,229,616 |  1,151,179 |
| `execute_preflight_time_ms` |  514 |  1,028 |  831 |  197 |
| `execute_preflight_insn_mi/s` |  6.88 | -          |  7.01 |  6.75 |
| `trace_gen_time_ms   ` |  57.50 |  115 |  61 |  54 |
| `memory_finalize_time_ms` |  6 |  12 |  6 |  6 |
| `stark_prove_excluding_trace_time_ms` |  443.50 |  887 |  477 |  410 |
| `main_trace_commit_time_ms` |  84.50 |  169 |  92 |  77 |
| `generate_perm_trace_time_ms` |  32.50 |  65 |  36 |  29 |
| `perm_trace_commit_time_ms` |  125.06 |  250.11 |  141.16 |  108.95 |
| `quotient_poly_compute_time_ms` |  96.35 |  192.70 |  105.95 |  86.75 |
| `quotient_poly_commit_time_ms` |  23.40 |  46.79 |  25.03 |  21.76 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program |  | 433 |  | 1 | 13 | 1,500,209 | 112.50 | 0 | 
| leaf | 1,297 |  | 1 | 1 |  |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 61 | 736 | 17,887,054 | 252,878,314 | 61 | 477 | 0 | 105.95 | 25.03 | 4 | 141.16 | 75 | 178 | 75 | 6 | 92 | 6,608,072 | 36 | 197 | 1,229,616 | 7.01 | 26 | 131 | 0 | 75 | 
| leaf | 1 | 54 | 1,295 | 17,250,234 | 207,789,546 | 54 | 410 | 0 | 86.75 | 21.76 | 4 | 108.95 | 83 | 139 | 83 | 6 | 77 | 6,343,052 | 29 | 831 | 1,151,179 | 6.75 | 23 | 109 | 0 | 83 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 200 | 595 | 9,677,708 | 84,395,212 | 200 | 199 | 0 | 35.56 | 13.24 | 4 | 44.29 | 46 | 70 | 46 | 0 | 33 | 1,035,986 | 26 | 26 | 873,000 | 34.57 | 14 | 49 | 0 | 46 | 
| fibonacci_program | 1 | 183 | 433 | 9,708,170 | 74,305,770 | 183 | 175 | 1 | 28.89 | 11.73 | 4 | 38.88 | 44 | 60 | 44 | 0 | 28 | 1,064,416 | 21 | 34 | 627,209 | 38.53 | 11 | 41 | 0 | 44 | 

...
|:---|---:|---:|---:|
| Total |  20.69 |  11.23 | 11.23 |
| fibonacci_program |  9.91 |  5.60 |  5.60 |
| leaf |  10.78 |  5.63 |  5.63 |


| fibonacci_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  4,949 |  9,898 |  5,592 |  4,306 |
...
| `execute_metered_insn_mi/s` |  159.70 | -          |  159.70 |  159.70 |
| `execute_preflight_insns` |  750,104.50 |  1,500,209 |  873,000 |  627,209 |
| `execute_preflight_time_ms` |  27.50 |  55 |  33 |  22 |
| `execute_preflight_insn_mi/s` |  38.18 | -          |  38.33 |  38.03 |
| `trace_gen_time_ms   ` |  191.50 |  383 |  196 |  187 |
| `memory_finalize_time_ms` | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  4,623.50 |  9,247 |  5,332 |  3,915 |
| `main_trace_commit_time_ms` |  30.50 |  61 |  33 |  28 |
| `generate_perm_trace_time_ms` |  87.50 |  175 |  140 |  35 |
| `perm_trace_commit_time_ms` |  41.18 |  82.35 |  43.80 |  38.55 |
| `quotient_poly_compute_time_ms` |  28.97 |  57.94 |  30.88 |  27.06 |
| `quotient_poly_commit_time_ms` |  12.66 |  25.32 |  13.21 |  12.11 |
| `pcs_opening_time_ms ` |  4,420 |  8,840 |  5,189 |  3,651 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  5,390 |  10,780 |  5,632 |  5,148 |
| `main_cells_used     ` |  9,914,556 |  19,829,112 |  10,125,186 |  9,703,926 |
| `total_cells_used    ` |  25,902,618 |  51,805,236 |  26,406,284 |  25,398,952 |
| `execute_preflight_insns` |  2,000,116 |  4,000,232 |  2,061,940 |  1,938,292 |
| `execute_preflight_time_ms` |  939.50 |  1,879 |  1,512 |  367 |
| `execute_preflight_insn_mi/s` |  5.100 | -          |  6.07 |  5.92 |
| `trace_gen_time_ms   ` |  96 |  192 |  100 |  92 |
| `memory_finalize_time_ms` |  10 |  20 |  10 |  10 |
| `stark_prove_excluding_trace_time_ms` |  4,353.50 |  8,707 |  5,164 |  3,543 |
| `main_trace_commit_time_ms` |  131.50 |  263 |  132 |  131 |
| `generate_perm_trace_time_ms` |  70 |  140 |  77 |  63 |
| `perm_trace_commit_time_ms` |  184.68 |  369.37 |  185.21 |  184.15 |
| `quotient_poly_compute_time_ms` |  142.25 |  284.49 |  142.26 |  142.24 |
| `quotient_poly_commit_time_ms` |  28.99 |  57.98 |  29.41 |  28.57 |
| `pcs_opening_time_ms ` |  3,792.50 |  7,585 |  4,609 |  2,976 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program |  | 5,592 |  | 1 | 9 | 1,500,209 | 159.70 | 0 | 
| leaf | 5,151 |  | 1 | 1 |  |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 100 | 5,632 | 26,406,284 | 342,564,330 | 100 | 5,164 | 0 | 142.26 | 29.41 | 6 | 185.21 | 4,609 | 250 | 4,609 | 10 | 131 | 10,125,186 | 63 | 367 | 2,061,940 | 6.07 | 32 | 172 | 0 | 4,609 | 
| leaf | 1 | 92 | 5,148 | 25,398,952 | 342,564,330 | 92 | 3,543 | 0 | 142.24 | 28.57 | 6 | 184.15 | 2,976 | 262 | 2,976 | 10 | 132 | 9,703,926 | 77 | 1,512 | 1,938,292 | 5.92 | 32 | 172 | 0 | 2,975 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 187 | 4,306 | 9,677,708 | 84,395,212 | 187 | 3,915 | 0 | 30.88 | 13.21 | 6 | 43.80 | 3,651 | 184 | 3,651 | 0 | 33 | 1,035,986 | 140 | 33 | 873,000 | 38.03 | 14 | 44 | 0 | 3,651 | 
| fibonacci_program | 1 | 196 | 5,592 | 9,708,170 | 74,305,770 | 196 | 5,332 | 1 | 27.06 | 12.11 | 7 | 38.55 | 5,189 | 74 | 5,189 | 0 | 28 | 1,064,416 | 35 | 22 | 627,209 | 38.33 | 11 | 39 | 0 | 5,189 | 

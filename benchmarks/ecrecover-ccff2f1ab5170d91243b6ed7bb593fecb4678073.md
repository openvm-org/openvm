...
| `stark_prove_excluding_trace_time_ms` |  2,187 |  2,187 |  2,187 |  2,187 |
| `main_trace_commit_time_ms` |  394 |  394 |  394 |  394 |
| `generate_perm_trace_time_ms` |  34 |  34 |  34 |  34 |
| `perm_trace_commit_time_ms` |  363 |  363 |  363 |  363 |
| `quotient_poly_compute_time_ms` |  231 |  231 |  231 |  231 |
| `quotient_poly_commit_time_ms` |  490 |  490 |  490 |  490 |
| `pcs_opening_time_ms ` |  662 |  662 |  662 |  662 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  11,266 |  11,266 |  11,266 |  11,266 |
| `main_cells_used     ` |  117,320,775 |  117,320,775 |  117,320,775 |  117,320,775 |
| `total_cycles        ` |  1,603,995 |  1,603,995 |  1,603,995 |  1,603,995 |
| `execute_time_ms     ` |  568 |  568 |  568 |  568 |
| `trace_gen_time_ms   ` |  1,534 |  1,534 |  1,534 |  1,534 |
| `stark_prove_excluding_trace_time_ms` |  9,164 |  9,164 |  9,164 |  9,164 |
| `main_trace_commit_time_ms` |  1,900 |  1,900 |  1,900 |  1,900 |
| `generate_perm_trace_time_ms` |  269 |  269 |  269 |  269 |
| `perm_trace_commit_time_ms` |  2,025 |  2,025 |  2,025 |  2,025 |
| `quotient_poly_compute_time_ms` |  1,475 |  1,475 |  1,475 |  1,475 |
| `quotient_poly_commit_time_ms` |  1,680 |  1,680 |  1,680 |  1,680 |
| `pcs_opening_time_ms ` |  1,811 |  1,811 |  1,811 |  1,811 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,534 | 11,266 | 1,603,995 | 334,709,720 | 9,164 | 1,475 | 1,680 | 2,025 | 1,811 | 1,900 | 117,320,775 | 269 | 568 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 177 | 2,510 | 284,567 | 38,417,467 | 2,187 | 231 | 490 | 363 | 662 | 394 | 15,055,723 | 34 | 146 | 

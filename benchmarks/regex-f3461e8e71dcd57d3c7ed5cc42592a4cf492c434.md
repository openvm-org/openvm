...
| `total_proof_time_ms ` |  3,946 |  7,892 |  4,580 |  3,312 |
| `main_cells_used     ` |  83,710,464.50 |  167,420,929 |  93,732,017 |  73,688,912 |
| `total_cycles        ` |  2,070,114.50 |  4,140,229 |  2,225,434 |  1,914,795 |
| `execute_time_ms     ` |  348 |  696 |  385 |  311 |
| `trace_gen_time_ms   ` |  969 |  1,938 |  1,145 |  793 |
| `stark_prove_excluding_trace_time_ms` |  2,629 |  5,258 |  3,050 |  2,208 |
| `main_trace_commit_time_ms` |  456.50 |  913 |  538 |  375 |
| `generate_perm_trace_time_ms` |  169 |  338 |  201 |  137 |
| `perm_trace_commit_time_ms` |  647 |  1,294 |  752 |  542 |
| `quotient_poly_compute_time_ms` |  368 |  736 |  423 |  313 |
| `quotient_poly_commit_time_ms` |  274.50 |  549 |  318 |  231 |
| `pcs_opening_time_ms ` |  705 |  1,410 |  809 |  601 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,484 |  14,968 |  7,563 |  7,405 |
| `main_cells_used     ` |  152,233,748 |  304,467,496 |  154,692,644 |  149,774,852 |
| `total_cycles        ` |  1,990,794.50 |  3,981,589 |  2,021,702 |  1,959,887 |
| `execute_time_ms     ` |  768.50 |  1,537 |  778 |  759 |
| `trace_gen_time_ms   ` |  1,459.50 |  2,919 |  1,495 |  1,424 |
| `stark_prove_excluding_trace_time_ms` |  5,256 |  10,512 |  5,290 |  5,222 |
| `main_trace_commit_time_ms` |  893.50 |  1,787 |  894 |  893 |
| `generate_perm_trace_time_ms` |  343.50 |  687 |  348 |  339 |
| `perm_trace_commit_time_ms` |  1,658 |  3,316 |  1,694 |  1,622 |
| `quotient_poly_compute_time_ms` |  766.50 |  1,533 |  768 |  765 |
| `quotient_poly_commit_time_ms` |  522 |  1,044 |  522 |  522 |
| `pcs_opening_time_ms ` |  1,068 |  2,136 |  1,072 |  1,064 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,495 | 7,563 | 2,021,702 | 533,941,738 | 5,290 | 765 | 522 | 1,694 | 1,064 | 893 | 154,692,644 | 348 | 778 | 
| leaf | 1 | 1,424 | 7,405 | 1,959,887 | 533,941,738 | 5,222 | 768 | 522 | 1,622 | 1,072 | 894 | 149,774,852 | 339 | 759 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,145 | 4,580 | 2,225,434 | 275,652,919 | 3,050 | 423 | 318 | 752 | 809 | 538 | 93,732,017 | 201 | 385 | 
| regex_program | 1 | 793 | 3,312 | 1,914,795 | 198,099,628 | 2,208 | 313 | 231 | 542 | 601 | 375 | 73,688,912 | 137 | 311 | 

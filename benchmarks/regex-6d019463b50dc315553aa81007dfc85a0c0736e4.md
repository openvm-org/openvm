...
| `total_proof_time_ms ` |  3,881 |  7,762 |  4,511 |  3,251 |
...
| `trace_gen_time_ms   ` |  963 |  1,926 |  1,179 |  747 |
| `stark_prove_excluding_trace_time_ms` |  2,579 |  5,158 |  2,955 |  2,203 |
| `main_trace_commit_time_ms` |  448 |  896 |  525 |  371 |
| `generate_perm_trace_time_ms` |  167 |  334 |  196 |  138 |
| `perm_trace_commit_time_ms` |  646.50 |  1,293 |  749 |  544 |
| `quotient_poly_compute_time_ms` |  363.50 |  727 |  421 |  306 |
| `quotient_poly_commit_time_ms` |  279 |  558 |  329 |  229 |
| `pcs_opening_time_ms ` |  665 |  1,330 |  726 |  604 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,508 |  15,016 |  7,582 |  7,434 |
| `main_cells_used     ` |  152,303,821 |  304,607,642 |  154,763,227 |  149,844,415 |
| `total_cycles        ` |  1,993,339 |  3,986,678 |  2,024,226 |  1,962,452 |
| `execute_time_ms     ` |  792.50 |  1,585 |  800 |  785 |
| `trace_gen_time_ms   ` |  1,454.50 |  2,909 |  1,464 |  1,445 |
| `stark_prove_excluding_trace_time_ms` |  5,261 |  10,522 |  5,318 |  5,204 |
| `main_trace_commit_time_ms` |  892.50 |  1,785 |  894 |  891 |
| `generate_perm_trace_time_ms` |  351 |  702 |  360 |  342 |
| `perm_trace_commit_time_ms` |  1,656.50 |  3,313 |  1,693 |  1,620 |
| `quotient_poly_compute_time_ms` |  770 |  1,540 |  771 |  769 |
| `quotient_poly_commit_time_ms` |  523.50 |  1,047 |  525 |  522 |
| `pcs_opening_time_ms ` |  1,061.50 |  2,123 |  1,069 |  1,054 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,464 | 7,582 | 2,024,226 | 533,941,738 | 5,318 | 771 | 525 | 1,693 | 1,069 | 894 | 154,763,227 | 360 | 800 | 
| leaf | 1 | 1,445 | 7,434 | 1,962,452 | 533,941,738 | 5,204 | 769 | 522 | 1,620 | 1,054 | 891 | 149,844,415 | 342 | 785 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,179 | 4,511 | 2,225,434 | 275,652,919 | 2,955 | 421 | 329 | 749 | 726 | 525 | 93,699,990 | 196 | 377 | 
| regex_program | 1 | 747 | 3,251 | 1,914,730 | 198,099,628 | 2,203 | 306 | 229 | 544 | 604 | 371 | 73,689,460 | 138 | 301 | 

...
| `total_proof_time_ms ` |  590 |  2,360 |  716 |  542 |
...
| `execute_metered_insn_mi/s` |  121.93 | -          |  121.93 |  121.93 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  55.50 |  222 |  68 |  46 |
| `execute_preflight_insn_mi/s` |  30.01 | -          |  31.27 |  27.43 |
| `trace_gen_time_ms   ` |  180.50 |  722 |  213 |  157 |
| `memory_finalize_time_ms` |  1 |  4 |  4 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  287 |  1,148 |  313 |  267 |
| `main_trace_commit_time_ms` |  52.25 |  209 |  58 |  50 |
| `generate_perm_trace_time_ms` |  28.75 |  115 |  38 |  19 |
| `perm_trace_commit_time_ms` |  65.50 |  261.99 |  72.21 |  56.62 |
| `quotient_poly_compute_time_ms` |  59.46 |  237.82 |  70.10 |  53.14 |
| `quotient_poly_commit_time_ms` |  15.24 |  60.95 |  17.10 |  12.72 |
| `pcs_opening_time_ms ` |  62.25 |  249 |  72 |  52 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,385.50 |  5,542 |  2,035 |  897 |
...
| `execute_preflight_insns` |  1,440,814 |  5,763,256 |  1,814,573 |  1,241,324 |
| `execute_preflight_time_ms` |  623 |  2,492 |  810 |  228 |
| `execute_preflight_insn_mi/s` |  7.07 | -          |  7.40 |  6.82 |
| `trace_gen_time_ms   ` |  86 |  344 |  160 |  57 |
| `memory_finalize_time_ms` |  8.75 |  35 |  17 |  5 |
| `stark_prove_excluding_trace_time_ms` |  675 |  2,700 |  1,098 |  500 |
| `main_trace_commit_time_ms` |  126.75 |  507 |  197 |  93 |
| `generate_perm_trace_time_ms` |  52.75 |  211 |  89 |  36 |
| `perm_trace_commit_time_ms` |  202.40 |  809.62 |  347.07 |  143.08 |
| `quotient_poly_compute_time_ms` |  144.70 |  578.79 |  236.63 |  103.06 |
| `quotient_poly_commit_time_ms` |  31.59 |  126.35 |  51.26 |  23.70 |
| `pcs_opening_time_ms ` |  113 |  452 |  171 |  90 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 2,037 |  | 1 |  | 1 |  |  |  |  | 
| regex_program |  | 542 |  | 66 | 1 | 33 | 4,137,502 | 121.93 | 194 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 69 | 897 | 22,981,570 | 319,331,818 | 69 | 599 | 0 | 135.36 | 27.06 | 4 | 174.27 | 90 | 220 | 90 | 7 | 123 | 9,122,488 | 45 | 228 | 1,466,032 | 7.40 | 30 | 163 | 0 | 90 | 
| leaf | 1 | 57 | 1,371 | 20,905,034 | 255,237,610 | 57 | 503 | 0 | 103.06 | 23.70 | 4 | 143.08 | 101 | 180 | 101 | 6 | 93 | 8,256,948 | 36 | 810 | 1,241,324 | 7.07 | 25 | 127 | 0 | 101 | 
| leaf | 2 | 58 | 1,239 | 20,905,034 | 255,237,610 | 58 | 500 | 0 | 103.74 | 24.34 | 4 | 145.20 | 90 | 187 | 90 | 5 | 94 | 8,256,948 | 41 | 679 | 1,241,327 | 6.99 | 26 | 129 | 0 | 89 | 
| leaf | 3 | 160 | 2,035 | 50,337,320 | 538,365,418 | 160 | 1,098 | 0 | 236.63 | 51.26 | 4 | 347.07 | 171 | 437 | 171 | 17 | 197 | 20,171,106 | 89 | 775 | 1,814,573 | 6.82 | 61 | 291 | 5 | 171 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 213 | 716 | 23,446,148 | 150,778,428 | 213 | 313 | 0 | 59.98 | 17.10 | 5 | 72.21 | 72 | 103 | 72 | 4 | 58 | 10,899,170 | 30 | 47 | 1,103,000 | 27.43 | 21 | 77 | 1 | 72 | 
| regex_program | 1 | 157 | 555 | 11,598,276 | 128,513,066 | 157 | 288 | 1 | 53.14 | 15.52 | 4 | 65.67 | 63 | 104 | 63 | 0 | 50 | 2,196,106 | 38 | 68 | 1,104,000 | 30.48 | 17 | 69 | 0 | 63 | 
| regex_program | 2 | 165 | 547 | 11,579,064 | 128,513,066 | 165 | 280 | 1 | 54.60 | 15.62 | 4 | 67.50 | 62 | 96 | 61 | 0 | 50 | 2,177,334 | 28 | 61 | 1,104,000 | 30.86 | 16 | 70 | 0 | 61 | 
| regex_program | 3 | 187 | 542 | 11,853,872 | 103,456,394 | 187 | 267 | 0 | 70.10 | 12.72 | 5 | 56.62 | 52 | 78 | 52 | 0 | 51 | 2,422,606 | 19 | 46 | 826,502 | 31.27 | 19 | 83 | 1 | 52 | 

...
| `total_proof_time_ms ` |  497 |  994 |  571 |  423 |
...
| `execute_metered_insn_mi/s` |  113.100 | -          |  113.100 |  113.100 |
| `execute_preflight_insns` |  750,104.50 |  1,500,209 |  873,000 |  627,209 |
| `execute_preflight_time_ms` |  28.50 |  57 |  32 |  25 |
| `execute_preflight_insn_mi/s` |  36.58 | -          |  38.53 |  34.63 |
| `trace_gen_time_ms   ` |  189 |  378 |  193 |  185 |
| `memory_finalize_time_ms` | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  186 |  372 |  208 |  164 |
| `main_trace_commit_time_ms` |  30.50 |  61 |  33 |  28 |
| `generate_perm_trace_time_ms` |  25.50 |  51 |  36 |  15 |
| `perm_trace_commit_time_ms` |  41.36 |  82.72 |  43.31 |  39.41 |
| `quotient_poly_compute_time_ms` |  30.66 |  61.32 |  33.14 |  28.18 |
| `quotient_poly_commit_time_ms` |  12.26 |  24.53 |  12.46 |  12.07 |
| `pcs_opening_time_ms ` |  43.50 |  87 |  48 |  39 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,012 |  2,024 |  1,224 |  800 |
| `main_cells_used     ` |  6,475,562 |  12,951,124 |  6,608,072 |  6,343,052 |
| `total_cells_used    ` |  17,568,644 |  35,137,288 |  17,887,054 |  17,250,234 |
| `execute_preflight_insns` |  1,190,401 |  2,380,802 |  1,229,665 |  1,151,137 |
| `execute_preflight_time_ms` |  489.50 |  979 |  782 |  197 |
| `execute_preflight_insn_mi/s` |  6.87 | -          |  6.96 |  6.78 |
| `trace_gen_time_ms   ` |  57.50 |  115 |  62 |  53 |
| `memory_finalize_time_ms` |  5 |  10 |  5 |  5 |
| `stark_prove_excluding_trace_time_ms` |  463 |  926 |  539 |  387 |
| `main_trace_commit_time_ms` |  83 |  166 |  91 |  75 |
| `generate_perm_trace_time_ms` |  43.50 |  87 |  58 |  29 |
| `perm_trace_commit_time_ms` |  125.21 |  250.43 |  142.24 |  108.19 |
| `quotient_poly_compute_time_ms` |  89.41 |  178.81 |  99.71 |  79.11 |
| `quotient_poly_commit_time_ms` |  21.15 |  42.30 |  23.10 |  19.20 |
| `pcs_opening_time_ms ` |  97.50 |  195 |  122 |  73 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program |  | 423 |  | 1 | 13 | 1,500,209 | 113.100 | 0 | 
| leaf | 1,225 |  | 1 | 1 |  |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 62 | 800 | 17,887,054 | 252,878,314 | 62 | 539 | 0 | 99.71 | 23.10 | 4 | 142.24 | 122 | 201 | 121 | 5 | 91 | 6,608,072 | 58 | 197 | 1,229,665 | 6.96 | 25 | 123 | 0 | 121 | 
| leaf | 1 | 53 | 1,224 | 17,250,234 | 207,789,546 | 53 | 387 | 0 | 79.11 | 19.20 | 4 | 108.19 | 73 | 138 | 72 | 5 | 75 | 6,343,052 | 29 | 782 | 1,151,137 | 6.78 | 22 | 99 | 0 | 72 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 193 | 571 | 9,677,708 | 84,395,212 | 193 | 208 | 0 | 33.14 | 12.46 | 4 | 43.31 | 48 | 80 | 48 | 0 | 33 | 1,035,986 | 36 | 25 | 873,000 | 34.63 | 13 | 46 | 0 | 48 | 
| fibonacci_program | 1 | 185 | 423 | 9,708,170 | 74,305,770 | 185 | 164 | 1 | 28.18 | 12.07 | 4 | 39.41 | 39 | 54 | 39 | 0 | 28 | 1,064,416 | 15 | 32 | 627,209 | 38.53 | 11 | 40 | 0 | 39 | 

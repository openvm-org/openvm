...
| `total_proof_time_ms ` |  7,131 |  14,262 |  8,082 |  6,180 |
| `main_cells_used     ` |  82,727,686.50 |  165,455,373 |  92,686,348 |  72,769,025 |
| `total_cycles        ` |  1,914,103 |  1,914,103 |  1,914,103 |  1,914,103 |
| `execute_time_ms     ` |  435.50 |  871 |  468 |  403 |
| `trace_gen_time_ms   ` |  1,151 |  2,302 |  1,365 |  937 |
| `stark_prove_excluding_trace_time_ms` |  5,544.50 |  11,089 |  6,249 |  4,840 |
| `main_trace_commit_time_ms` |  1,088 |  2,176 |  1,333 |  843 |
| `generate_perm_trace_time_ms` |  176 |  352 |  186 |  166 |
| `perm_trace_commit_time_ms` |  1,177.50 |  2,355 |  1,238 |  1,117 |
| `quotient_poly_compute_time_ms` |  747 |  1,494 |  869 |  625 |
| `quotient_poly_commit_time_ms` |  1,003.50 |  2,007 |  1,160 |  847 |
| `pcs_opening_time_ms ` |  1,342.50 |  2,685 |  1,455 |  1,230 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  12,976 |  25,952 |  13,100 |  12,852 |
| `main_cells_used     ` |  109,710,080 |  219,420,160 |  111,342,259 |  108,077,901 |
| `total_cycles        ` |  2,221,562 |  4,443,124 |  2,259,145 |  2,183,979 |
| `execute_time_ms     ` |  615.50 |  1,231 |  654 |  577 |
| `trace_gen_time_ms   ` |  1,810 |  3,620 |  1,980 |  1,640 |
| `stark_prove_excluding_trace_time_ms` |  10,550.50 |  21,101 |  10,806 |  10,295 |
| `main_trace_commit_time_ms` |  2,184 |  4,368 |  2,230 |  2,138 |
| `generate_perm_trace_time_ms` |  253 |  506 |  266 |  240 |
| `perm_trace_commit_time_ms` |  2,073.50 |  4,147 |  2,107 |  2,040 |
| `quotient_poly_compute_time_ms` |  1,487.50 |  2,975 |  1,540 |  1,435 |
| `quotient_poly_commit_time_ms` |  2,085 |  4,170 |  2,124 |  2,046 |
| `pcs_opening_time_ms ` |  2,463 |  4,926 |  2,534 |  2,392 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,640 | 13,100 | 2,259,145 | 328,738,520 | 10,806 | 1,540 | 2,124 | 2,107 | 2,534 | 2,230 | 111,342,259 | 266 | 654 | 
| leaf | 1 | 1,980 | 12,852 | 2,183,979 | 304,628,696 | 10,295 | 1,435 | 2,046 | 2,040 | 2,392 | 2,138 | 108,077,901 | 240 | 577 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,365 | 8,082 |  | 209,921,543 | 6,249 | 869 | 1,160 | 1,238 | 1,455 | 1,333 | 92,686,348 | 186 | 468 | 
| regex_program | 1 | 937 | 6,180 | 1,914,103 | 149,454,692 | 4,840 | 625 | 847 | 1,117 | 1,230 | 843 | 72,769,025 | 166 | 403 | 

...
| `total_proof_time_ms ` |  4,968 |  4,968 |  4,968 |  4,968 |
| `main_cells_used     ` |  51,485,080 |  51,485,080 |  51,485,080 |  51,485,080 |
| `total_cycles        ` |  1,500,095 |  1,500,095 |  1,500,095 |  1,500,095 |
| `execute_time_ms     ` |  310 |  310 |  310 |  310 |
| `trace_gen_time_ms   ` |  645 |  645 |  645 |  645 |
| `stark_prove_excluding_trace_time_ms` |  4,013 |  4,013 |  4,013 |  4,013 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  5,971 |  5,971 |  5,971 |  5,971 |
| `main_cells_used     ` |  50,831,128 |  50,831,128 |  50,831,128 |  50,831,128 |
| `total_cycles        ` |  1,248,469 |  1,248,469 |  1,248,469 |  1,248,469 |
| `execute_time_ms     ` |  321 |  321 |  321 |  321 |
| `trace_gen_time_ms   ` |  786 |  786 |  786 |  786 |
| `stark_prove_excluding_trace_time_ms` |  4,864 |  4,864 |  4,864 |  4,864 |
| `main_trace_commit_time_ms` |  958 |  958 |  958 |  958 |
| `generate_perm_trace_time_ms` |  116 |  116 |  116 |  116 |
| `perm_trace_commit_time_ms` |  909 |  909 |  909 |  909 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 786 | 5,971 | 1,248,469 | 139,379,672 | 4,864 | 675 | 984 | 909 | 1,218 | 958 | 50,831,128 | 116 | 321 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 645 | 4,968 | 1,500,095 | 122,458,476 | 4,013 | 518 | 727 | 751 | 1,081 | 794 | 51,485,080 | 138 | 310 | 

...
| `total_proof_time_ms ` |  3,839.50 |  7,679 |  4,257 |  3,422 |
...
| `trace_gen_time_ms   ` |  996 |  1,992 |  1,177 |  815 |
| `stark_prove_excluding_trace_time_ms` |  2,507.50 |  5,015 |  2,706 |  2,309 |
| `main_trace_commit_time_ms` |  453.50 |  907 |  506 |  401 |
| `generate_perm_trace_time_ms` |  193.50 |  387 |  215 |  172 |
| `perm_trace_commit_time_ms` |  491.50 |  983 |  517 |  466 |
| `quotient_poly_compute_time_ms` |  335 |  670 |  358 |  312 |
| `quotient_poly_commit_time_ms` |  222.50 |  445 |  255 |  190 |
| `pcs_opening_time_ms ` |  801.50 |  1,603 |  844 |  759 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  6,841.50 |  13,683 |  6,896 |  6,787 |
| `main_cells_used     ` |  151,827,671 |  303,655,342 |  154,227,614 |  149,427,728 |
| `total_cycles        ` |  1,975,712.50 |  3,951,425 |  2,006,547 |  1,944,878 |
| `execute_time_ms     ` |  790.50 |  1,581 |  799 |  782 |
| `trace_gen_time_ms   ` |  1,444 |  2,888 |  1,477 |  1,411 |
| `stark_prove_excluding_trace_time_ms` |  4,607 |  9,214 |  4,620 |  4,594 |
| `main_trace_commit_time_ms` |  787 |  1,574 |  789 |  785 |
| `generate_perm_trace_time_ms` |  378 |  756 |  393 |  363 |
| `perm_trace_commit_time_ms` |  1,117 |  2,234 |  1,121 |  1,113 |
| `quotient_poly_compute_time_ms` |  659 |  1,318 |  660 |  658 |
| `quotient_poly_commit_time_ms` |  378.50 |  757 |  382 |  375 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,477 | 6,896 | 2,006,547 | 538,660,330 | 4,620 | 658 | 375 | 1,121 | 1,283 | 785 | 154,227,614 | 393 | 799 | 
| leaf | 1 | 1,411 | 6,787 | 1,944,878 | 538,660,330 | 4,594 | 660 | 382 | 1,113 | 1,280 | 789 | 149,427,728 | 363 | 782 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,177 | 4,257 | 2,243,715 | 275,652,919 | 2,706 | 358 | 255 | 517 | 844 | 506 | 93,500,799 | 215 | 374 | 
| regex_program | 1 | 815 | 3,422 | 1,921,511 | 242,975,404 | 2,309 | 312 | 190 | 466 | 759 | 401 | 73,010,353 | 172 | 298 | 

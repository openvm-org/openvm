...
| `total_proof_time_ms ` |  486 |  972 |  552 |  420 |
...
| `execute_metered_insn_mi/s` |  147.91 | -          |  147.91 |  147.91 |
| `execute_preflight_insns` |  750,104.50 |  1,500,209 |  873,000 |  627,209 |
| `execute_preflight_time_ms` |  29.50 |  59 |  33 |  26 |
| `execute_preflight_insn_mi/s` |  36.17 | -          |  37.56 |  34.77 |
| `trace_gen_time_ms   ` |  187.50 |  375 |  195 |  180 |
| `memory_finalize_time_ms` | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  175 |  350 |  186 |  164 |
| `main_trace_commit_time_ms` |  30.50 |  61 |  33 |  28 |
| `generate_perm_trace_time_ms` |  15 |  30 |  17 |  13 |
| `perm_trace_commit_time_ms` |  42.13 |  84.27 |  44.82 |  39.45 |
| `quotient_poly_compute_time_ms` |  30.91 |  61.82 |  33.13 |  28.68 |
| `quotient_poly_commit_time_ms` |  11.93 |  23.86 |  12.26 |  11.60 |
| `pcs_opening_time_ms ` |  43 |  86 |  44 |  42 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,019.50 |  2,039 |  1,295 |  744 |
...
| `execute_preflight_time_ms` |  520 |  1,040 |  841 |  199 |
| `execute_preflight_insn_mi/s` |  6.77 | -          |  6.93 |  6.61 |
| `trace_gen_time_ms   ` |  57.50 |  115 |  60 |  55 |
| `memory_finalize_time_ms` |  5.50 |  11 |  6 |  5 |
| `stark_prove_excluding_trace_time_ms` |  440.50 |  881 |  484 |  397 |
| `main_trace_commit_time_ms` |  83 |  166 |  91 |  75 |
| `generate_perm_trace_time_ms` |  30.50 |  61 |  32 |  29 |
| `perm_trace_commit_time_ms` |  123.76 |  247.51 |  139.55 |  107.97 |
| `quotient_poly_compute_time_ms` |  91.53 |  183.07 |  100.75 |  82.32 |
| `quotient_poly_commit_time_ms` |  22.02 |  44.04 |  24.02 |  20.02 |
| `pcs_opening_time_ms ` |  87 |  174 |  94 |  80 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program |  | 420 |  | 1 | 10 | 1,500,209 | 147.91 | 0 | 
| leaf | 1,296 |  | 1 | 1 |  |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 60 | 744 | 17,887,054 | 252,878,314 | 60 | 484 | 0 | 100.75 | 24.02 | 4 | 139.55 | 94 | 172 | 94 | 5 | 91 | 6,608,072 | 32 | 199 | 1,229,669 | 6.93 | 26 | 125 | 0 | 94 | 
| leaf | 1 | 55 | 1,295 | 17,250,234 | 207,789,546 | 55 | 397 | 0 | 82.32 | 20.02 | 4 | 107.97 | 80 | 138 | 80 | 6 | 75 | 6,343,052 | 29 | 841 | 1,151,166 | 6.61 | 22 | 103 | 0 | 80 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 195 | 552 | 9,677,708 | 84,395,212 | 195 | 186 | 0 | 33.13 | 12.26 | 4 | 44.82 | 44 | 63 | 43 | 0 | 33 | 1,035,986 | 17 | 26 | 873,000 | 34.77 | 14 | 45 | 0 | 43 | 
| fibonacci_program | 1 | 180 | 420 | 9,708,170 | 74,305,770 | 180 | 164 | 1 | 28.68 | 11.60 | 4 | 39.45 | 42 | 53 | 42 | 0 | 28 | 1,064,416 | 13 | 33 | 627,209 | 37.56 | 11 | 40 | 0 | 42 | 

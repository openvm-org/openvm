...
| `total_proof_time_ms ` |  6,937.50 |  13,875 |  7,862 |  6,013 |
...
| `trace_gen_time_ms   ` |  1,086.50 |  2,173 |  1,255 |  918 |
| `stark_prove_excluding_trace_time_ms` |  5,400 |  10,800 |  6,122 |  4,678 |
| `main_trace_commit_time_ms` |  1,030.50 |  2,061 |  1,268 |  793 |
| `generate_perm_trace_time_ms` |  184 |  368 |  192 |  176 |
| `perm_trace_commit_time_ms` |  1,138 |  2,276 |  1,214 |  1,062 |
| `quotient_poly_compute_time_ms` |  741 |  1,482 |  868 |  614 |
| `quotient_poly_commit_time_ms` |  958 |  1,916 |  1,126 |  790 |
| `pcs_opening_time_ms ` |  1,323.50 |  2,647 |  1,446 |  1,201 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  8,031 |  16,062 |  8,275 |  7,787 |
| `main_cells_used     ` |  77,287,056.50 |  154,574,113 |  78,375,269 |  76,198,844 |
| `total_cycles        ` |  1,028,196.50 |  2,056,393 |  1,045,629 |  1,010,764 |
| `execute_time_ms     ` |  383 |  766 |  424 |  342 |
| `trace_gen_time_ms   ` |  1,155.50 |  2,311 |  1,241 |  1,070 |
| `stark_prove_excluding_trace_time_ms` |  6,492.50 |  12,985 |  6,781 |  6,204 |
| `main_trace_commit_time_ms` |  1,321.50 |  2,643 |  1,388 |  1,255 |
| `generate_perm_trace_time_ms` |  166 |  332 |  181 |  151 |
| `perm_trace_commit_time_ms` |  1,309 |  2,618 |  1,368 |  1,250 |
| `quotient_poly_compute_time_ms` |  965.50 |  1,931 |  1,013 |  918 |
| `quotient_poly_commit_time_ms` |  1,267.50 |  2,535 |  1,317 |  1,218 |
| `pcs_opening_time_ms ` |  1,459.50 |  2,919 |  1,511 |  1,408 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,070 | 8,275 | 1,045,629 | 220,669,656 | 6,781 | 1,013 | 1,317 | 1,368 | 1,511 | 1,388 | 78,375,269 | 181 | 424 | 
| leaf | 1 | 1,241 | 7,787 | 1,010,764 | 194,986,968 | 6,204 | 918 | 1,218 | 1,250 | 1,408 | 1,255 | 76,198,844 | 151 | 342 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,255 | 7,862 |  | 209,921,543 | 6,122 | 868 | 1,126 | 1,214 | 1,446 | 1,268 | 92,686,348 | 192 | 485 | 
| regex_program | 1 | 918 | 6,013 | 1,914,103 | 149,454,692 | 4,678 | 614 | 790 | 1,062 | 1,201 | 793 | 72,769,025 | 176 | 417 | 

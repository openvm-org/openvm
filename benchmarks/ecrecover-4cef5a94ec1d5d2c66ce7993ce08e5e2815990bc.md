...
| `stark_prove_excluding_trace_time_ms` |  2,182 |  2,182 |  2,182 |  2,182 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  21,238 |  21,238 |  21,238 |  21,238 |
| `main_cells_used     ` |  202,805,876 |  202,805,876 |  202,805,876 |  202,805,876 |
| `total_cycles        ` |  4,138,862 |  4,138,862 |  4,138,862 |  4,138,862 |
| `execute_time_ms     ` |  967 |  967 |  967 |  967 |
| `trace_gen_time_ms   ` |  3,658 |  3,658 |  3,658 |  3,658 |
| `stark_prove_excluding_trace_time_ms` |  16,613 |  16,613 |  16,613 |  16,613 |
| `main_trace_commit_time_ms` |  2,954 |  2,954 |  2,954 |  2,954 |
| `generate_perm_trace_time_ms` |  377 |  377 |  377 |  377 |
| `perm_trace_commit_time_ms` |  3,322 |  3,322 |  3,322 |  3,322 |
| `quotient_poly_compute_time_ms` |  4,485 |  4,485 |  4,485 |  4,485 |
| `quotient_poly_commit_time_ms` |  2,522 |  2,522 |  2,522 |  2,522 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 3,658 | 21,238 | 4,138,862 | 508,251,096 | 16,613 | 4,485 | 2,522 | 3,322 | 2,950 | 2,954 | 202,805,876 | 377 | 967 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 266 | 2,594 | 285,401 | 56,172,159 | 2,182 | 279 | 313 | 536 | 628 | 385 | 15,075,033 | 39 | 146 | 

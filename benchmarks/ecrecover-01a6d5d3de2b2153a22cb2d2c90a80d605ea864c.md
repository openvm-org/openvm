...
| `total_proof_time_ms ` |  1,476 |  1,476 |  1,476 |  1,476 |
...
| `main_trace_commit_time_ms` |  184 |  184 |  184 |  184 |
| `generate_perm_trace_time_ms` |  32 |  32 |  32 |  32 |
| `perm_trace_commit_time_ms` |  202 |  202 |  202 |  202 |
| `quotient_poly_compute_time_ms` |  136 |  136 |  136 |  136 |
| `quotient_poly_commit_time_ms` |  162 |  162 |  162 |  162 |
| `pcs_opening_time_ms ` |  412 |  412 |  412 |  412 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  12,772 |  12,772 |  12,772 |  12,772 |
| `main_cells_used     ` |  244,318,494 |  244,318,494 |  244,318,494 |  244,318,494 |
| `total_cycles        ` |  2,989,543 |  2,989,543 |  2,989,543 |  2,989,543 |
| `execute_time_ms     ` |  1,114 |  1,114 |  1,114 |  1,114 |
| `trace_gen_time_ms   ` |  2,337 |  2,337 |  2,337 |  2,337 |
| `stark_prove_excluding_trace_time_ms` |  9,321 |  9,321 |  9,321 |  9,321 |
| `main_trace_commit_time_ms` |  1,623 |  1,623 |  1,623 |  1,623 |
| `generate_perm_trace_time_ms` |  698 |  698 |  698 |  698 |
| `perm_trace_commit_time_ms` |  2,991 |  2,991 |  2,991 |  2,991 |
| `quotient_poly_compute_time_ms` |  1,356 |  1,356 |  1,356 |  1,356 |
| `quotient_poly_commit_time_ms` |  845 |  845 |  845 |  845 |
| `pcs_opening_time_ms ` |  1,803 |  1,803 |  1,803 |  1,803 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 2,337 | 12,772 | 2,989,543 | 999,656,938 | 9,321 | 1,356 | 845 | 2,991 | 1,803 | 1,623 | 244,318,494 | 698 | 1,114 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 183 | 1,476 | 295,181 | 48,197,161 | 1,143 | 136 | 162 | 202 | 412 | 184 | 15,586,346 | 32 | 150 | 

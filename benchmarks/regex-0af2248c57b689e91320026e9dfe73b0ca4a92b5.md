...
| `total_proof_time_ms ` |  578 |  2,312 |  709 |  521 |
...
| `execute_metered_insn_mi/s` |  121 | -          |  121 |  121 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  55.50 |  222 |  68 |  46 |
| `execute_preflight_insn_mi/s` |  30.64 | -          |  31.95 |  27.72 |
| `trace_gen_time_ms   ` |  175.50 |  702 |  209 |  152 |
| `memory_finalize_time_ms` |  1 |  4 |  4 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  279 |  1,116 |  307 |  259 |
| `main_trace_commit_time_ms` |  52 |  208 |  57 |  50 |
| `generate_perm_trace_time_ms` |  24.50 |  98 |  30 |  20 |
| `perm_trace_commit_time_ms` |  64.27 |  257.08 |  70.44 |  54.38 |
| `quotient_poly_compute_time_ms` |  58.38 |  233.53 |  69.89 |  51.33 |
| `quotient_poly_commit_time_ms` |  15.01 |  60.04 |  17.77 |  12.54 |
| `pcs_opening_time_ms ` |  61.75 |  247 |  73 |  53 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,381.25 |  5,525 |  2,033 |  891 |
...
| `execute_preflight_insns` |  1,440,900.25 |  5,763,601 |  1,814,591 |  1,241,439 |
| `execute_preflight_time_ms` |  643.75 |  2,575 |  844 |  232 |
| `execute_preflight_insn_mi/s` |  6.97 | -          |  7.27 |  6.78 |
| `trace_gen_time_ms   ` |  88.50 |  354 |  169 |  57 |
| `memory_finalize_time_ms` |  9 |  36 |  18 |  5 |
| `stark_prove_excluding_trace_time_ms` |  648 |  2,592 |  1,061 |  471 |
| `main_trace_commit_time_ms` |  124.25 |  497 |  194 |  91 |
| `generate_perm_trace_time_ms` |  49 |  196 |  89 |  32 |
| `perm_trace_commit_time_ms` |  199.57 |  798.27 |  341.57 |  142.64 |
| `quotient_poly_compute_time_ms` |  139.63 |  558.51 |  228.97 |  99.41 |
| `quotient_poly_commit_time_ms` |  29.73 |  118.93 |  48.16 |  22.22 |
| `pcs_opening_time_ms ` |  101.75 |  407 |  153 |  77 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 2,035 |  | 1 |  | 1 |  |  |  |  | 
| regex_program |  | 552 |  | 66 | 1 | 34 | 4,137,502 | 121 | 195 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 70 | 891 | 22,981,570 | 319,331,818 | 70 | 588 | 0 | 130.53 | 25.30 | 4 | 171.07 | 96 | 213 | 95 | 7 | 121 | 9,122,488 | 41 | 232 | 1,466,043 | 7.27 | 30 | 156 | 0 | 95 | 
| leaf | 1 | 58 | 1,374 | 20,905,034 | 255,237,610 | 58 | 471 | 0 | 99.60 | 23.25 | 4 | 142.98 | 77 | 178 | 77 | 6 | 91 | 8,256,948 | 34 | 844 | 1,241,439 | 6.78 | 25 | 123 | 0 | 77 | 
| leaf | 2 | 57 | 1,227 | 20,905,034 | 255,237,610 | 57 | 472 | 0 | 99.41 | 22.22 | 4 | 142.64 | 81 | 176 | 81 | 5 | 91 | 8,256,948 | 32 | 697 | 1,241,528 | 7.03 | 25 | 122 | 0 | 81 | 
| leaf | 3 | 169 | 2,033 | 50,337,320 | 538,365,418 | 169 | 1,061 | 0 | 228.97 | 48.16 | 4 | 341.57 | 153 | 431 | 153 | 18 | 194 | 20,171,106 | 89 | 802 | 1,814,591 | 6.80 | 61 | 280 | 5 | 153 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 209 | 709 | 23,446,148 | 150,778,428 | 209 | 307 | 0 | 60.22 | 17.77 | 5 | 70.44 | 73 | 97 | 73 | 4 | 57 | 10,899,170 | 26 | 46 | 1,103,000 | 27.72 | 21 | 78 | 1 | 73 | 
| regex_program | 1 | 152 | 530 | 11,598,276 | 128,513,066 | 152 | 268 | 1 | 52.09 | 14.36 | 4 | 65.10 | 61 | 88 | 61 | 0 | 51 | 2,196,106 | 22 | 68 | 1,104,000 | 31.95 | 16 | 67 | 0 | 61 | 
| regex_program | 2 | 160 | 521 | 11,579,064 | 128,513,066 | 159 | 259 | 1 | 51.33 | 15.36 | 4 | 67.16 | 53 | 88 | 53 | 0 | 50 | 2,177,334 | 20 | 61 | 1,104,000 | 31.26 | 17 | 67 | 0 | 53 | 
| regex_program | 3 | 181 | 552 | 11,853,872 | 103,456,394 | 181 | 282 | 0 | 69.89 | 12.54 | 5 | 54.38 | 60 | 87 | 60 | 0 | 50 | 2,422,606 | 30 | 47 | 826,502 | 31.63 | 18 | 83 | 1 | 60 | 

...
| `total_proof_time_ms ` |  6,945.50 |  13,891 |  7,798 |  6,093 |
...
| `trace_gen_time_ms   ` |  1,264 |  2,528 |  1,296 |  1,232 |
| `stark_prove_excluding_trace_time_ms` |  5,292.50 |  10,585 |  6,030 |  4,555 |
| `main_trace_commit_time_ms` |  1,130.50 |  2,261 |  1,307 |  954 |
| `generate_perm_trace_time_ms` |  180 |  360 |  192 |  168 |
| `perm_trace_commit_time_ms` |  1,031 |  2,062 |  1,183 |  879 |
| `quotient_poly_compute_time_ms` |  754.50 |  1,509 |  883 |  626 |
| `quotient_poly_commit_time_ms` |  928.50 |  1,857 |  1,082 |  775 |
| `pcs_opening_time_ms ` |  1,258 |  2,516 |  1,374 |  1,142 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  8,352.50 |  16,705 |  8,409 |  8,296 |
| `main_cells_used     ` |  86,869,506.50 |  173,739,013 |  88,130,098 |  85,608,915 |
| `total_cycles        ` |  1,451,192.50 |  2,902,385 |  1,475,943 |  1,426,442 |
| `execute_time_ms     ` |  454 |  908 |  497 |  411 |
| `trace_gen_time_ms   ` |  1,264.50 |  2,529 |  1,348 |  1,181 |
| `stark_prove_excluding_trace_time_ms` |  6,634 |  13,268 |  6,650 |  6,618 |
| `main_trace_commit_time_ms` |  1,321.50 |  2,643 |  1,322 |  1,321 |
| `generate_perm_trace_time_ms` |  189 |  378 |  190 |  188 |
| `perm_trace_commit_time_ms` |  1,333.50 |  2,667 |  1,337 |  1,330 |
| `quotient_poly_compute_time_ms` |  1,069 |  2,138 |  1,076 |  1,062 |
| `quotient_poly_commit_time_ms` |  1,319 |  2,638 |  1,324 |  1,314 |
| `pcs_opening_time_ms ` |  1,394.50 |  2,789 |  1,402 |  1,387 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,181 | 8,296 | 1,475,943 | 225,774,050 | 6,618 | 1,062 | 1,324 | 1,330 | 1,387 | 1,321 | 88,130,098 | 190 | 497 | 
| leaf | 1 | 1,348 | 8,409 | 1,426,442 | 225,774,050 | 6,650 | 1,076 | 1,314 | 1,337 | 1,402 | 1,322 | 85,608,915 | 188 | 411 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,296 | 7,798 | 2,225,434 | 210,931,487 | 6,030 | 883 | 1,082 | 1,183 | 1,374 | 1,307 | 93,699,990 | 192 | 472 | 
| regex_program | 1 | 1,232 | 6,093 | 1,914,730 | 150,470,512 | 4,555 | 626 | 775 | 879 | 1,142 | 954 | 73,689,460 | 168 | 306 | 

...
| `total_proof_time_ms ` |  3,774 |  7,548 |  4,849 |  2,699 |
...
| `execute_preflight_insn_mi/s` |  28.38 | -          |  30.92 |  25.85 |
| `trace_gen_time_ms   ` |  384 |  768 |  493 |  275 |
| `memory_finalize_time_ms` |  7.50 |  15 |  13 |  2 |
| `stark_prove_excluding_trace_time_ms` |  3,065.50 |  6,131 |  4,010 |  2,121 |
| `main_trace_commit_time_ms` |  613.50 |  1,227 |  841 |  386 |
| `generate_perm_trace_time_ms` |  225 |  450 |  303 |  147 |
| `perm_trace_commit_time_ms` |  648.50 |  1,297 |  849 |  448 |
| `quotient_poly_compute_time_ms` |  325 |  650 |  438 |  212 |
| `quotient_poly_commit_time_ms` |  294.50 |  589 |  391 |  198 |
| `pcs_opening_time_ms ` |  951.50 |  1,903 |  1,183 |  720 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  5,682.50 |  11,365 |  6,814 |  4,551 |
| `main_cells_used     ` |  122,270,007 |  244,540,014 |  153,708,824 |  90,831,190 |
| `total_cells_used    ` |  304,358,941 |  608,717,882 |  391,461,162 |  217,256,720 |
| `execute_preflight_insns` |  1,663,342 |  3,326,684 |  1,830,022 |  1,496,662 |
| `execute_preflight_time_ms` |  566 |  1,132 |  717 |  415 |
| `execute_preflight_insn_mi/s` |  4.52 | -          |  4.65 |  4.39 |
| `trace_gen_time_ms   ` |  291 |  582 |  360 |  222 |
| `memory_finalize_time_ms` |  12.50 |  25 |  15 |  10 |
| `stark_prove_excluding_trace_time_ms` |  3,781.50 |  7,563 |  4,709 |  2,854 |
| `main_trace_commit_time_ms` |  708 |  1,416 |  839 |  577 |
| `generate_perm_trace_time_ms` |  315.50 |  631 |  403 |  228 |
| `perm_trace_commit_time_ms` |  955.50 |  1,911 |  1,241 |  670 |
| `quotient_poly_compute_time_ms` |  415 |  830 |  526 |  304 |
| `quotient_poly_commit_time_ms` |  313.50 |  627 |  373 |  254 |
| `pcs_opening_time_ms ` |  1,068.50 |  2,137 |  1,322 |  815 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 6,816 |  | 1 |  | 1 |  |  |  |  | 
| regex_program |  | 2,699 |  | 6 | 1 | 31 | 4,108,597 | 128.97 | 44 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 222 | 4,551 | 217,256,720 | 319,626,730 | 222 | 2,854 | 0 | 304 | 254 | 670 | 815 | 10 | 577 | 90,831,190 | 228 | 415 | 1,496,662 | 4.39 | 
| leaf | 1 | 360 | 6,814 | 391,461,162 | 538,660,330 | 360 | 4,709 | 0 | 526 | 373 | 1,241 | 1,322 | 15 | 839 | 153,708,824 | 403 | 717 | 1,830,022 | 4.65 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 493 | 4,849 | 211,758,557 | 373,183,036 | 493 | 4,010 | 0 | 438 | 391 | 849 | 1,183 | 7 | 13 | 841 | 91,281,687 | 303 | 103 | 2,211,000 | 25.85 | 
| regex_program | 1 | 275 | 2,699 | 174,326,267 | 196,838,026 | 275 | 2,121 | 51 | 212 | 198 | 448 | 720 | 6 | 2 | 386 | 73,453,305 | 147 | 85 | 1,897,597 | 30.92 | 

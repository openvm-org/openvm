...
|:---|---:|---:|---:|
| Total |  1.35 |  1.35 | 1.34 |
| verify_fibair |  1.35 |  1.35 |  1.35 |


| verify_fibair |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,345 |  1,345 |  1,345 |  1,345 |
| `main_cells_used     ` |  3,615,122 |  3,615,122 |  3,615,122 |  3,615,122 |
| `total_cells_used    ` |  11,078,572 |  11,078,572 |  11,078,572 |  11,078,572 |
| `execute_preflight_insns` |  622,128 |  622,128 |  622,128 |  622,128 |
...
| `stark_prove_excluding_trace_time_ms` |  1,174 |  1,174 |  1,174 |  1,174 |
| `main_trace_commit_time_ms` |  46 |  46 |  46 |  46 |
| `generate_perm_trace_time_ms` |  42 |  42 |  42 |  42 |
| `perm_trace_commit_time_ms` |  53.13 |  53.13 |  53.13 |  53.13 |
| `quotient_poly_compute_time_ms` |  46.98 |  46.98 |  46.98 |  46.98 |
| `quotient_poly_commit_time_ms` |  14.24 |  14.24 |  14.24 |  14.24 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
|  | 9 | 1,345 | 65,536 | 504 | 0.14 | 0.73 | 2 | 0 | 499 | 0 | 499 | 3 | 0 | 1 | 0 | 0 | 499 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| verify_fibair | 39 | 1,345 | 11,078,572 | 120,541,482 | 39 | 1,174 | 0 | 46.98 | 14.24 | 6 | 53.13 | 969 | 96 | 969 | 4 | 46 | 3,615,122 | 42 | 1 | 131 | 622,128 | 4.95 | 15 | 61 | 0 | 969 | 

...
| `total_proof_time_ms ` |  489 |  978 |  546 |  432 |
...
| `execute_metered_insn_mi/s` |  146.01 | -          |  146.01 |  146.01 |
| `execute_preflight_insns` |  750,104.50 |  1,500,209 |  873,000 |  627,209 |
| `execute_preflight_time_ms` |  29.50 |  59 |  33 |  26 |
| `execute_preflight_insn_mi/s` |  36.07 | -          |  37.96 |  34.17 |
| `trace_gen_time_ms   ` |  188.50 |  377 |  194 |  183 |
| `memory_finalize_time_ms` | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  178 |  356 |  182 |  174 |
| `main_trace_commit_time_ms` |  30.50 |  61 |  33 |  28 |
| `generate_perm_trace_time_ms` |  19 |  38 |  21 |  17 |
| `perm_trace_commit_time_ms` |  41.35 |  82.70 |  44.15 |  38.55 |
| `quotient_poly_compute_time_ms` |  30.99 |  61.98 |  32.02 |  29.95 |
| `quotient_poly_commit_time_ms` |  11.93 |  23.86 |  12.53 |  11.33 |
| `pcs_opening_time_ms ` |  42 |  84 |  43 |  41 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,015 |  2,030 |  1,287 |  743 |
| `main_cells_used     ` |  6,475,562 |  12,951,124 |  6,608,072 |  6,343,052 |
| `total_cells_used    ` |  17,568,644 |  35,137,288 |  17,887,054 |  17,250,234 |
| `execute_preflight_insns` |  1,190,409 |  2,380,818 |  1,229,639 |  1,151,179 |
| `execute_preflight_time_ms` |  506.50 |  1,013 |  809 |  204 |
| `execute_preflight_insn_mi/s` |  6.78 | -          |  6.80 |  6.75 |
| `trace_gen_time_ms   ` |  58.50 |  117 |  61 |  56 |
| `memory_finalize_time_ms` |  5.50 |  11 |  6 |  5 |
| `stark_prove_excluding_trace_time_ms` |  449 |  898 |  477 |  421 |
| `main_trace_commit_time_ms` |  83 |  166 |  91 |  75 |
| `generate_perm_trace_time_ms` |  44 |  88 |  52 |  36 |
| `perm_trace_commit_time_ms` |  123.44 |  246.87 |  140.95 |  105.92 |
| `quotient_poly_compute_time_ms` |  90.65 |  181.29 |  99.31 |  81.99 |
| `quotient_poly_commit_time_ms` |  21.84 |  43.68 |  23.72 |  19.96 |
| `pcs_opening_time_ms ` |  83 |  166 |  83 |  83 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program |  | 432 |  | 41 | 1 | 10 | 1,500,209 | 146.01 | 141 | 
| leaf | 1,288 |  | 1 |  | 1 |  |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 61 | 743 | 17,887,054 | 252,878,314 | 61 | 477 | 0 | 99.31 | 23.72 | 4 | 140.95 | 83 | 178 | 83 | 6 | 91 | 6,608,072 | 36 | 204 | 1,229,639 | 6.75 | 25 | 123 | 0 | 83 | 
| leaf | 1 | 56 | 1,287 | 17,250,234 | 207,789,546 | 56 | 421 | 0 | 81.99 | 19.96 | 4 | 105.92 | 83 | 159 | 83 | 5 | 75 | 6,343,052 | 52 | 809 | 1,151,179 | 6.80 | 22 | 102 | 0 | 83 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 194 | 546 | 9,677,708 | 84,395,212 | 194 | 182 | 0 | 32.02 | 12.53 | 4 | 44.15 | 41 | 61 | 41 | 0 | 33 | 1,035,986 | 17 | 26 | 873,000 | 34.17 | 14 | 45 | 0 | 41 | 
| fibonacci_program | 1 | 183 | 432 | 9,708,170 | 74,305,770 | 183 | 174 | 1 | 29.95 | 11.33 | 4 | 38.55 | 43 | 60 | 43 | 0 | 28 | 1,064,416 | 21 | 33 | 627,209 | 37.96 | 11 | 41 | 0 | 43 | 

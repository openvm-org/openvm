...
| `stark_prove_excluding_trace_time_ms` |  2,162 |  2,162 |  2,162 |  2,162 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  11,263 |  11,263 |  11,263 |  11,263 |
| `main_cells_used     ` |  117,321,108 |  117,321,108 |  117,321,108 |  117,321,108 |
| `total_cycles        ` |  1,604,032 |  1,604,032 |  1,604,032 |  1,604,032 |
| `execute_time_ms     ` |  557 |  557 |  557 |  557 |
| `trace_gen_time_ms   ` |  1,566 |  1,566 |  1,566 |  1,566 |
| `stark_prove_excluding_trace_time_ms` |  9,140 |  9,140 |  9,140 |  9,140 |
| `main_trace_commit_time_ms` |  1,889 |  1,889 |  1,889 |  1,889 |
| `generate_perm_trace_time_ms` |  257 |  257 |  257 |  257 |
| `perm_trace_commit_time_ms` |  2,009 |  2,009 |  2,009 |  2,009 |
| `quotient_poly_compute_time_ms` |  1,460 |  1,460 |  1,460 |  1,460 |
| `quotient_poly_commit_time_ms` |  1,686 |  1,686 |  1,686 |  1,686 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,566 | 11,263 | 1,604,032 | 334,709,720 | 9,140 | 1,460 | 1,686 | 2,009 | 1,835 | 1,889 | 117,321,108 | 257 | 557 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 174 | 2,481 | 284,567 | 38,417,467 | 2,162 | 227 | 477 | 356 | 668 | 387 | 15,055,723 | 33 | 145 | 

...
| `total_proof_time_ms ` |  4,044 |  8,088 |  4,497 |  3,591 |
...
| `trace_gen_time_ms   ` |  986 |  1,972 |  1,172 |  800 |
| `stark_prove_excluding_trace_time_ms` |  2,720.50 |  5,441 |  2,949 |  2,492 |
| `main_trace_commit_time_ms` |  473.50 |  947 |  534 |  413 |
| `generate_perm_trace_time_ms` |  188.50 |  377 |  190 |  187 |
| `perm_trace_commit_time_ms` |  691.50 |  1,383 |  746 |  637 |
| `quotient_poly_compute_time_ms` |  393.50 |  787 |  429 |  358 |
| `quotient_poly_commit_time_ms` |  279 |  558 |  315 |  243 |
| `pcs_opening_time_ms ` |  686 |  1,372 |  729 |  643 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,307.50 |  14,615 |  7,394 |  7,221 |
| `main_cells_used     ` |  152,278,735 |  304,557,470 |  154,678,162 |  149,879,308 |
| `total_cycles        ` |  1,991,072.50 |  3,982,145 |  2,021,864 |  1,960,281 |
| `execute_time_ms     ` |  784 |  1,568 |  795 |  773 |
| `trace_gen_time_ms   ` |  1,469 |  2,938 |  1,487 |  1,451 |
| `stark_prove_excluding_trace_time_ms` |  5,054.50 |  10,109 |  5,112 |  4,997 |
| `main_trace_commit_time_ms` |  810 |  1,620 |  811 |  809 |
| `generate_perm_trace_time_ms` |  380 |  760 |  401 |  359 |
| `perm_trace_commit_time_ms` |  1,537 |  3,074 |  1,579 |  1,495 |
| `quotient_poly_compute_time_ms` |  770 |  1,540 |  771 |  769 |
| `quotient_poly_commit_time_ms` |  494.50 |  989 |  496 |  493 |
| `pcs_opening_time_ms ` |  1,058.50 |  2,117 |  1,062 |  1,055 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,487 | 7,394 | 2,021,864 | 538,660,330 | 5,112 | 771 | 493 | 1,579 | 1,055 | 809 | 154,678,162 | 401 | 795 | 
| leaf | 1 | 1,451 | 7,221 | 1,960,281 | 538,660,330 | 4,997 | 769 | 496 | 1,495 | 1,062 | 811 | 149,879,308 | 359 | 773 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,172 | 4,497 | 2,243,715 | 275,652,919 | 2,949 | 429 | 315 | 746 | 729 | 534 | 93,500,799 | 187 | 376 | 
| regex_program | 1 | 800 | 3,591 | 1,921,511 | 242,975,404 | 2,492 | 358 | 243 | 637 | 643 | 413 | 73,010,353 | 190 | 299 | 

...
| `total_proof_time_ms ` |  6,897.50 |  13,795 |  7,812 |  5,983 |
...
| `trace_gen_time_ms   ` |  1,092.50 |  2,185 |  1,263 |  922 |
| `stark_prove_excluding_trace_time_ms` |  5,370 |  10,740 |  6,081 |  4,659 |
| `main_trace_commit_time_ms` |  1,024 |  2,048 |  1,260 |  788 |
| `generate_perm_trace_time_ms` |  174.50 |  349 |  190 |  159 |
| `perm_trace_commit_time_ms` |  1,132.50 |  2,265 |  1,200 |  1,065 |
| `quotient_poly_compute_time_ms` |  755 |  1,510 |  883 |  627 |
| `quotient_poly_commit_time_ms` |  959 |  1,918 |  1,102 |  816 |
| `pcs_opening_time_ms ` |  1,314.50 |  2,629 |  1,437 |  1,192 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  8,009 |  16,018 |  8,254 |  7,764 |
| `main_cells_used     ` |  77,287,061 |  154,574,122 |  78,375,233 |  76,198,889 |
| `total_cycles        ` |  1,028,197 |  2,056,394 |  1,045,625 |  1,010,769 |
| `execute_time_ms     ` |  386 |  772 |  426 |  346 |
| `trace_gen_time_ms   ` |  1,132.50 |  2,265 |  1,218 |  1,047 |
| `stark_prove_excluding_trace_time_ms` |  6,490.50 |  12,981 |  6,781 |  6,200 |
| `main_trace_commit_time_ms` |  1,322.50 |  2,645 |  1,382 |  1,263 |
| `generate_perm_trace_time_ms` |  163.50 |  327 |  178 |  149 |
| `perm_trace_commit_time_ms` |  1,305 |  2,610 |  1,353 |  1,257 |
| `quotient_poly_compute_time_ms` |  977.50 |  1,955 |  1,027 |  928 |
| `quotient_poly_commit_time_ms` |  1,289 |  2,578 |  1,372 |  1,206 |
| `pcs_opening_time_ms ` |  1,429.50 |  2,859 |  1,466 |  1,393 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,047 | 8,254 | 1,045,625 | 220,669,656 | 6,781 | 1,027 | 1,372 | 1,353 | 1,466 | 1,382 | 78,375,233 | 178 | 426 | 
| leaf | 1 | 1,218 | 7,764 | 1,010,769 | 194,986,968 | 6,200 | 928 | 1,206 | 1,257 | 1,393 | 1,263 | 76,198,889 | 149 | 346 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,263 | 7,812 |  | 209,921,543 | 6,081 | 883 | 1,102 | 1,200 | 1,437 | 1,260 | 92,686,348 | 190 | 468 | 
| regex_program | 1 | 922 | 5,983 | 1,914,103 | 149,454,692 | 4,659 | 627 | 816 | 1,065 | 1,192 | 788 | 72,769,025 | 159 | 402 | 

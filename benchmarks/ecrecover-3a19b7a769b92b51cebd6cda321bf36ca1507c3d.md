...
| `quotient_poly_compute_time_ms` |  307 |  307 |  307 |  307 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  22,336 |  22,336 |  22,336 |  22,336 |
| `main_cells_used     ` |  237,694,655 |  237,694,655 |  237,694,655 |  237,694,655 |
| `total_cycles        ` |  4,081,135 |  4,081,135 |  4,081,135 |  4,081,135 |
| `execute_time_ms     ` |  1,190 |  1,190 |  1,190 |  1,190 |
| `trace_gen_time_ms   ` |  4,076 |  4,076 |  4,076 |  4,076 |
| `stark_prove_excluding_trace_time_ms` |  17,070 |  17,070 |  17,070 |  17,070 |
| `main_trace_commit_time_ms` |  3,178 |  3,178 |  3,178 |  3,178 |
| `generate_perm_trace_time_ms` |  380 |  380 |  380 |  380 |
| `perm_trace_commit_time_ms` |  3,826 |  3,826 |  3,826 |  3,826 |
| `quotient_poly_compute_time_ms` |  4,208 |  4,208 |  4,208 |  4,208 |
| `quotient_poly_commit_time_ms` |  2,516 |  2,516 |  2,516 |  2,516 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 4,076 | 22,336 | 4,081,135 | 590,040,024 | 17,070 | 4,208 | 2,516 | 3,826 | 2,959 | 3,178 | 237,694,655 | 380 | 1,190 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 261 | 2,612 | 285,401 | 56,172,159 | 2,197 | 307 | 308 | 521 | 621 | 394 | 15,092,297 | 43 | 154 | 

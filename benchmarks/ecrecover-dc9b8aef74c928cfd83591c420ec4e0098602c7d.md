...
| `stark_prove_excluding_trace_time_ms` |  2,161 |  2,161 |  2,161 |  2,161 |
...
| `quotient_poly_commit_time_ms` |  474 |  474 |  474 |  474 |
| `pcs_opening_time_ms ` |  669 |  669 |  669 |  669 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  18,239 |  18,239 |  18,239 |  18,239 |
| `main_cells_used     ` |  186,730,861 |  186,730,861 |  186,730,861 |  186,730,861 |
| `total_cycles        ` |  4,157,698 |  4,157,698 |  4,157,698 |  4,157,698 |
| `execute_time_ms     ` |  951 |  951 |  951 |  951 |
| `trace_gen_time_ms   ` |  3,455 |  3,455 |  3,455 |  3,455 |
| `stark_prove_excluding_trace_time_ms` |  13,833 |  13,833 |  13,833 |  13,833 |
| `main_trace_commit_time_ms` |  2,787 |  2,787 |  2,787 |  2,787 |
| `generate_perm_trace_time_ms` |  350 |  350 |  350 |  350 |
| `perm_trace_commit_time_ms` |  2,870 |  2,870 |  2,870 |  2,870 |
| `quotient_poly_compute_time_ms` |  2,070 |  2,070 |  2,070 |  2,070 |
| `quotient_poly_commit_time_ms` |  2,644 |  2,644 |  2,644 |  2,644 |
| `pcs_opening_time_ms ` |  3,108 |  3,108 |  3,108 |  3,108 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 3,455 | 18,239 | 4,157,698 | 459,031,512 | 13,833 | 2,070 | 2,644 | 2,870 | 3,108 | 2,787 | 186,730,861 | 350 | 951 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 259 | 2,568 | 284,567 | 38,417,467 | 2,161 | 224 | 474 | 355 | 669 | 393 | 15,055,723 | 32 | 148 | 

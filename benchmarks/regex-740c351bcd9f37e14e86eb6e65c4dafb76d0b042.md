...
|:---|---:|---:|---:|
| Total |  46.30 |  14.38 | 14.38 |
| regex_program |  19.53 |  6.39 |  6.39 |
| leaf |  26.78 |  7.99 |  7.99 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  4,872.25 |  19,489 |  6,353 |  4,125 |
...
| `execute_preflight_insn_mi/s` |  31.55 | -          |  32.07 |  30.54 |
| `trace_gen_time_ms   ` |  176.75 |  707 |  191 |  170 |
| `memory_finalize_time_ms` |  1 |  4 |  4 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  4,576.75 |  18,307 |  5,960 |  3,857 |
| `main_trace_commit_time_ms` |  51.75 |  207 |  57 |  50 |
| `generate_perm_trace_time_ms` |  86 |  344 |  111 |  56 |
| `perm_trace_commit_time_ms` |  62.34 |  249.35 |  69.29 |  53.97 |
| `quotient_poly_compute_time_ms` |  57.47 |  229.89 |  70.85 |  45.46 |
| `quotient_poly_commit_time_ms` |  15.34 |  61.37 |  18.44 |  13.20 |
| `pcs_opening_time_ms ` |  4,299.75 |  17,199 |  5,695 |  3,570 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  6,694.50 |  26,778 |  7,993 |  5,984 |
...
| `execute_preflight_insns` |  2,313,441.25 |  9,253,765 |  2,694,304 |  2,073,735 |
| `execute_preflight_time_ms` |  1,054 |  4,216 |  1,388 |  382 |
| `execute_preflight_insn_mi/s` |  6.35 | -          |  6.90 |  5.73 |
| `trace_gen_time_ms   ` |  125.75 |  503 |  206 |  94 |
| `memory_finalize_time_ms` |  11.75 |  47 |  20 |  8 |
| `stark_prove_excluding_trace_time_ms` |  5,513.25 |  22,053 |  6,485 |  4,784 |
| `main_trace_commit_time_ms` |  211.75 |  847 |  374 |  143 |
| `generate_perm_trace_time_ms` |  116.75 |  467 |  206 |  53 |
| `perm_trace_commit_time_ms` |  352.31 |  1,409.22 |  683.75 |  225.30 |
| `quotient_poly_compute_time_ms` |  247.22 |  988.90 |  449.59 |  171.07 |
| `quotient_poly_commit_time_ms` |  50.78 |  203.11 |  95.67 |  29.98 |
| `pcs_opening_time_ms ` |  4,529.75 |  18,119 |  4,685 |  4,104 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 7,997 |  | 1 | 1 |  |  |  |  | 
| regex_program |  | 4,125 |  | 1 | 37 | 4,137,502 | 109.78 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 107 | 5,984 | 32,462,072 | 471,277,034 | 107 | 5,493 | 0 | 195.75 | 46.41 | 6 | 274.80 | 4,685 | 377 | 4,685 | 10 | 186 | 13,049,642 | 101 | 382 | 2,411,869 | 6.90 | 52 | 243 | 4 | 4,684 | 
| leaf | 1 | 96 | 6,776 | 29,459,256 | 403,119,594 | 96 | 5,291 | 0 | 172.48 | 31.06 | 6 | 225.38 | 4,663 | 279 | 4,662 | 9 | 143 | 11,793,502 | 53 | 1,388 | 2,073,735 | 6.45 | 38 | 204 | 0 | 4,662 | 
| leaf | 2 | 94 | 6,025 | 29,459,256 | 403,119,594 | 94 | 4,784 | 0 | 171.07 | 29.98 | 6 | 225.30 | 4,104 | 333 | 4,103 | 8 | 144 | 11,793,502 | 107 | 1,145 | 2,073,857 | 6.34 | 38 | 202 | 0 | 4,103 | 
| leaf | 3 | 206 | 7,993 | 60,122,886 | 989,416,938 | 206 | 6,485 | 0 | 449.59 | 95.67 | 6 | 683.75 | 4,667 | 891 | 4,667 | 20 | 374 | 24,209,404 | 206 | 1,301 | 2,694,304 | 5.73 | 136 | 552 | 9 | 4,666 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 170 | 6,353 | 23,446,148 | 150,778,428 | 170 | 5,960 | 0 | 60.51 | 18.44 | 9 | 69.29 | 5,695 | 126 | 5,695 | 4 | 57 | 10,899,170 | 56 | 55 | 1,103,000 | 30.54 | 21 | 79 | 0 | 5,695 | 
| regex_program | 1 | 174 | 4,678 | 11,598,276 | 128,513,066 | 174 | 4,417 | 1 | 45.46 | 14.86 | 6 | 62.76 | 4,130 | 175 | 4,130 | 0 | 50 | 2,196,106 | 111 | 45 | 1,104,000 | 32.07 | 16 | 60 | 0 | 4,129 | 
| regex_program | 2 | 172 | 4,333 | 11,579,064 | 128,513,066 | 172 | 4,073 | 1 | 53.08 | 14.87 | 6 | 63.33 | 3,804 | 149 | 3,804 | 0 | 50 | 2,177,334 | 85 | 46 | 1,104,000 | 31.83 | 16 | 68 | 0 | 3,804 | 
| regex_program | 3 | 191 | 4,125 | 11,853,872 | 103,456,394 | 191 | 3,857 | 0 | 70.85 | 13.20 | 7 | 53.97 | 3,570 | 151 | 3,570 | 0 | 50 | 2,422,606 | 92 | 34 | 826,502 | 31.76 | 18 | 85 | 0 | 3,569 | 

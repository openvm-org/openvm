...
| `stark_prove_excluding_trace_time_ms` |  962 |  962 |  962 |  962 |
| `main_trace_commit_time_ms` |  143 |  143 |  143 |  143 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  10,786 |  10,786 |  10,786 |  10,786 |
| `main_cells_used     ` |  247,226,250 |  247,226,250 |  247,226,250 |  247,226,250 |
| `total_cells_used    ` |  646,605,492 |  646,605,492 |  646,605,492 |  646,605,492 |
| `execute_preflight_insns` |  2,934,876 |  2,934,876 |  2,934,876 |  2,934,876 |
...
| `stark_prove_excluding_trace_time_ms` |  8,587 |  8,587 |  8,587 |  8,587 |
| `main_trace_commit_time_ms` |  1,651 |  1,651 |  1,651 |  1,651 |
| `generate_perm_trace_time_ms` |  792 |  792 |  792 |  792 |
| `perm_trace_commit_time_ms` |  2,316 |  2,316 |  2,316 |  2,316 |
| `quotient_poly_compute_time_ms` |  919 |  919 |  919 |  919 |
| `quotient_poly_commit_time_ms` |  693 |  693 |  693 |  693 |
| `pcs_opening_time_ms ` |  2,212 |  2,212 |  2,212 |  2,212 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program |  | 1,386 |  | 7 | 1 | 6 | 140,487 | 20.47 | 39 | 
| leaf | 10,789 |  | 1 |  | 1 |  |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 567 | 10,786 | 646,605,492 | 992,054,762 | 567 | 8,587 | 0 | 919 | 693 | 2,316 | 2,212 | 15 | 1,651 | 247,226,250 | 792 | 566 | 2,934,876 | 5.42 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 94 | 1,386 | 26,518,220 | 32,927,986 | 94 | 962 | 0 | 82 | 131 | 135 | 428 | 7 | 1 | 143 | 8,866,654 | 27 | 84 | 140,487 | 1.82 | 

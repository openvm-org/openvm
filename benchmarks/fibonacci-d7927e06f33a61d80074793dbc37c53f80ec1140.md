...
| `stark_prove_excluding_trace_time_ms` |  3,995 |  3,995 |  3,995 |  3,995 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  5,967 |  5,967 |  5,967 |  5,967 |
| `main_cells_used     ` |  49,915,247 |  49,915,247 |  49,915,247 |  49,915,247 |
| `total_cycles        ` |  1,213,163 |  1,213,163 |  1,213,163 |  1,213,163 |
| `execute_time_ms     ` |  319 |  319 |  319 |  319 |
| `trace_gen_time_ms   ` |  755 |  755 |  755 |  755 |
| `stark_prove_excluding_trace_time_ms` |  4,893 |  4,893 |  4,893 |  4,893 |
| `main_trace_commit_time_ms` |  962 |  962 |  962 |  962 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 755 | 5,967 | 1,213,163 | 139,379,672 | 4,893 | 679 | 984 | 914 | 1,232 | 962 | 49,915,247 | 119 | 319 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 621 | 4,914 | 1,500,095 | 122,458,476 | 3,995 | 522 | 724 | 748 | 1,069 | 790 | 51,485,080 | 138 | 298 | 

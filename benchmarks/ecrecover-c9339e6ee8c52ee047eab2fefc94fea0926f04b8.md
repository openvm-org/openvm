...
| `total_proof_time_ms ` |  1,466 |  1,466 |  1,466 |  1,466 |
...
| `quotient_poly_commit_time_ms` |  158 |  158 |  158 |  158 |
| `pcs_opening_time_ms ` |  419 |  419 |  419 |  419 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  13,184 |  13,184 |  13,184 |  13,184 |
| `main_cells_used     ` |  245,268,211 |  245,268,211 |  245,268,211 |  245,268,211 |
| `total_cycles        ` |  2,990,658 |  2,990,658 |  2,990,658 |  2,990,658 |
| `execute_time_ms     ` |  1,099 |  1,099 |  1,099 |  1,099 |
| `trace_gen_time_ms   ` |  2,368 |  2,368 |  2,368 |  2,368 |
| `stark_prove_excluding_trace_time_ms` |  9,717 |  9,717 |  9,717 |  9,717 |
| `main_trace_commit_time_ms` |  1,725 |  1,725 |  1,725 |  1,725 |
| `generate_perm_trace_time_ms` |  689 |  689 |  689 |  689 |
| `perm_trace_commit_time_ms` |  3,246 |  3,246 |  3,246 |  3,246 |
| `quotient_poly_compute_time_ms` |  1,357 |  1,357 |  1,357 |  1,357 |
| `quotient_poly_commit_time_ms` |  885 |  885 |  885 |  885 |
| `pcs_opening_time_ms ` |  1,810 |  1,810 |  1,810 |  1,810 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 2,368 | 13,184 | 2,990,658 | 1,008,831,978 | 9,717 | 1,357 | 885 | 3,246 | 1,810 | 1,725 | 245,268,211 | 689 | 1,099 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 181 | 1,466 | 295,303 | 48,240,457 | 1,139 | 128 | 158 | 202 | 419 | 184 | 15,598,665 | 32 | 146 | 

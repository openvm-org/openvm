...
| `perm_trace_commit_time_ms` |  34.04 |  34.04 |  34.04 |  34.04 |
| `quotient_poly_compute_time_ms` |  100.82 |  100.82 |  100.82 |  100.82 |
| `quotient_poly_commit_time_ms` |  9.09 |  9.09 |  9.09 |  9.09 |
| `pcs_opening_time_ms ` |  60 |  60 |  60 |  60 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  2,698 |  2,698 |  2,698 |  2,698 |
| `main_cells_used     ` |  29,404,728 |  29,404,728 |  29,404,728 |  29,404,728 |
| `total_cells_used    ` |  71,174,330 |  71,174,330 |  71,174,330 |  71,174,330 |
| `execute_preflight_insns` |  2,934,900 |  2,934,900 |  2,934,900 |  2,934,900 |
| `execute_preflight_time_ms` |  426 |  426 |  426 |  426 |
| `execute_preflight_insn_mi/s` |  7.31 | -          |  7.31 |  7.31 |
| `trace_gen_time_ms   ` |  235 |  235 |  235 |  235 |
| `memory_finalize_time_ms` |  20 |  20 |  20 |  20 |
| `stark_prove_excluding_trace_time_ms` |  2,035 |  2,035 |  2,035 |  2,035 |
| `main_trace_commit_time_ms` |  368 |  368 |  368 |  368 |
| `generate_perm_trace_time_ms` |  174 |  174 |  174 |  174 |
| `perm_trace_commit_time_ms` |  677.01 |  677.01 |  677.01 |  677.01 |
| `quotient_poly_compute_time_ms` |  419.24 |  419.24 |  419.24 |  419.24 |
| `quotient_poly_commit_time_ms` |  93.23 |  93.23 |  93.23 |  93.23 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program |  | 695 |  | 42 | 1 | 6 | 122,859 | 19.88 | 144 | 
| leaf | 2,701 |  | 1 |  | 1 |  |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 235 | 2,698 | 71,174,330 | 992,054,762 | 235 | 2,035 | 0 | 419.24 | 93.23 | 4 | 677.01 | 295 | 852 | 295 | 20 | 368 | 29,404,728 | 174 | 426 | 2,934,900 | 7.31 | 135 | 519 | 9 | 295 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 207 | 695 | 11,345,110 | 31,789,298 | 207 | 282 | 0 | 100.82 | 9.09 | 7 | 34.04 | 60 | 74 | 60 | 0 | 37 | 2,263,820 | 32 | 61 | 122,859 | 2.16 | 21 | 110 | 2 | 60 | 

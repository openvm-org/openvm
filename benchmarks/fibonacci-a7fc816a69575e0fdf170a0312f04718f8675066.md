...
| `total_proof_time_ms ` |  5,346 |  5,346 |  5,346 |  5,346 |
| `main_cells_used     ` |  51,485,080 |  51,485,080 |  51,485,080 |  51,485,080 |
| `total_cycles        ` |  1,500,095 |  1,500,095 |  1,500,095 |  1,500,095 |
| `execute_time_ms     ` |  312 |  312 |  312 |  312 |
| `trace_gen_time_ms   ` |  818 |  818 |  818 |  818 |
| `stark_prove_excluding_trace_time_ms` |  4,216 |  4,216 |  4,216 |  4,216 |
...
| `stark_prove_excluding_trace_time_ms` |  5,438 |  5,438 |  5,438 |  5,438 |
| `main_trace_commit_time_ms` |  1,067 |  1,067 |  1,067 |  1,067 |
| `generate_perm_trace_time_ms` |  130 |  130 |  130 |  130 |
| `perm_trace_commit_time_ms` |  1,046 |  1,046 |  1,046 |  1,046 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,343 | 7,082 | 1,925,105 | 157,336,536 | 5,438 | 791 | 1,096 | 1,046 | 1,303 | 1,067 | 69,420,436 | 130 | 301 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 818 | 5,346 | 1,500,095 | 122,458,476 | 4,216 | 521 | 771 | 808 | 1,105 | 868 | 51,485,080 | 139 | 312 | 

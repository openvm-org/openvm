...
| `total_proof_time_ms ` |  3,878.50 |  7,757 |  4,499 |  3,258 |
...
| `trace_gen_time_ms   ` |  954 |  1,908 |  1,144 |  764 |
| `stark_prove_excluding_trace_time_ms` |  2,585 |  5,170 |  2,979 |  2,191 |
| `main_trace_commit_time_ms` |  454 |  908 |  541 |  367 |
| `generate_perm_trace_time_ms` |  166 |  332 |  194 |  138 |
| `perm_trace_commit_time_ms` |  642 |  1,284 |  749 |  535 |
| `quotient_poly_compute_time_ms` |  368.50 |  737 |  433 |  304 |
| `quotient_poly_commit_time_ms` |  278.50 |  557 |  330 |  227 |
| `pcs_opening_time_ms ` |  666.50 |  1,333 |  723 |  610 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,507.50 |  15,015 |  7,583 |  7,432 |
| `main_cells_used     ` |  152,234,126 |  304,468,252 |  154,691,708 |  149,776,544 |
| `total_cycles        ` |  1,990,826 |  3,981,652 |  2,021,624 |  1,960,028 |
| `execute_time_ms     ` |  781 |  1,562 |  791 |  771 |
| `trace_gen_time_ms   ` |  1,472 |  2,944 |  1,494 |  1,450 |
| `stark_prove_excluding_trace_time_ms` |  5,254.50 |  10,509 |  5,298 |  5,211 |
| `main_trace_commit_time_ms` |  892 |  1,784 |  893 |  891 |
| `generate_perm_trace_time_ms` |  353 |  706 |  368 |  338 |
| `perm_trace_commit_time_ms` |  1,652 |  3,304 |  1,682 |  1,622 |
| `quotient_poly_compute_time_ms` |  762.50 |  1,525 |  766 |  759 |
| `quotient_poly_commit_time_ms` |  525 |  1,050 |  527 |  523 |
| `pcs_opening_time_ms ` |  1,066 |  2,132 |  1,069 |  1,063 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,494 | 7,583 | 2,021,624 | 533,941,738 | 5,298 | 766 | 523 | 1,682 | 1,063 | 893 | 154,691,708 | 368 | 791 | 
| leaf | 1 | 1,450 | 7,432 | 1,960,028 | 533,941,738 | 5,211 | 759 | 527 | 1,622 | 1,069 | 891 | 149,776,544 | 338 | 771 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,144 | 4,499 | 2,225,434 | 275,652,919 | 2,979 | 433 | 330 | 749 | 723 | 541 | 93,701,806 | 194 | 376 | 
| regex_program | 1 | 764 | 3,258 | 1,914,806 | 198,099,628 | 2,191 | 304 | 227 | 535 | 610 | 367 | 73,698,552 | 138 | 303 | 

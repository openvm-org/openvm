...
| `stark_prove_excluding_trace_time_ms` |  2,211 |  2,211 |  2,211 |  2,211 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  13,606 |  13,606 |  13,606 |  13,606 |
| `main_cells_used     ` |  133,785,677 |  133,785,677 |  133,785,677 |  133,785,677 |
| `total_cycles        ` |  2,253,300 |  2,253,300 |  2,253,300 |  2,253,300 |
| `execute_time_ms     ` |  728 |  728 |  728 |  728 |
| `trace_gen_time_ms   ` |  1,727 |  1,727 |  1,727 |  1,727 |
| `stark_prove_excluding_trace_time_ms` |  11,151 |  11,151 |  11,151 |  11,151 |
| `main_trace_commit_time_ms` |  2,422 |  2,422 |  2,422 |  2,422 |
| `generate_perm_trace_time_ms` |  313 |  313 |  313 |  313 |
| `perm_trace_commit_time_ms` |  2,407 |  2,407 |  2,407 |  2,407 |
| `quotient_poly_compute_time_ms` |  1,643 |  1,643 |  1,643 |  1,643 |
| `quotient_poly_commit_time_ms` |  2,077 |  2,077 |  2,077 |  2,077 |
| `pcs_opening_time_ms ` |  2,282 |  2,282 |  2,282 |  2,282 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,727 | 13,606 | 2,253,300 | 377,489,890 | 11,151 | 1,643 | 2,077 | 2,407 | 2,282 | 2,422 | 133,785,677 | 313 | 728 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 179 | 2,539 | 295,181 | 38,665,477 | 2,211 | 232 | 453 | 364 | 737 | 378 | 15,586,346 | 34 | 149 | 

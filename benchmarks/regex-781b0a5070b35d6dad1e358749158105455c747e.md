...
| `total_proof_time_ms ` |  3,888 |  7,776 |  4,468 |  3,308 |
| `main_cells_used     ` |  83,694,725 |  167,389,450 |  93,699,990 |  73,689,460 |
| `total_cycles        ` |  2,070,082 |  4,140,164 |  2,225,434 |  1,914,730 |
| `execute_time_ms     ` |  333 |  666 |  370 |  296 |
| `trace_gen_time_ms   ` |  990.50 |  1,981 |  1,178 |  803 |
| `stark_prove_excluding_trace_time_ms` |  2,564.50 |  5,129 |  2,920 |  2,209 |
| `main_trace_commit_time_ms` |  445.50 |  891 |  524 |  367 |
| `generate_perm_trace_time_ms` |  164.50 |  329 |  179 |  150 |
| `perm_trace_commit_time_ms` |  642.50 |  1,285 |  744 |  541 |
| `quotient_poly_compute_time_ms` |  363.50 |  727 |  417 |  310 |
| `quotient_poly_commit_time_ms` |  273.50 |  547 |  321 |  226 |
| `pcs_opening_time_ms ` |  663 |  1,326 |  724 |  602 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,537.50 |  15,075 |  7,632 |  7,443 |
| `main_cells_used     ` |  152,448,004.50 |  304,896,009 |  154,909,353 |  149,986,656 |
| `total_cycles        ` |  1,994,043.50 |  3,988,087 |  2,024,933 |  1,963,154 |
| `execute_time_ms     ` |  795 |  1,590 |  805 |  785 |
| `trace_gen_time_ms   ` |  1,454.50 |  2,909 |  1,493 |  1,416 |
| `stark_prove_excluding_trace_time_ms` |  5,288 |  10,576 |  5,334 |  5,242 |
| `main_trace_commit_time_ms` |  894.50 |  1,789 |  897 |  892 |
| `generate_perm_trace_time_ms` |  350 |  700 |  357 |  343 |
| `perm_trace_commit_time_ms` |  1,692.50 |  3,385 |  1,733 |  1,652 |
| `quotient_poly_compute_time_ms` |  762.50 |  1,525 |  765 |  760 |
| `quotient_poly_commit_time_ms` |  525.50 |  1,051 |  526 |  525 |
| `pcs_opening_time_ms ` |  1,058.50 |  2,117 |  1,060 |  1,057 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,493 | 7,632 | 2,024,933 | 534,072,810 | 5,334 | 765 | 525 | 1,733 | 1,057 | 892 | 154,909,353 | 357 | 805 | 
| leaf | 1 | 1,416 | 7,443 | 1,963,154 | 534,072,810 | 5,242 | 760 | 526 | 1,652 | 1,060 | 897 | 149,986,656 | 343 | 785 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,178 | 4,468 | 2,225,434 | 275,652,919 | 2,920 | 417 | 321 | 744 | 724 | 524 | 93,699,990 | 179 | 370 | 
| regex_program | 1 | 803 | 3,308 | 1,914,730 | 198,099,628 | 2,209 | 310 | 226 | 541 | 602 | 367 | 73,689,460 | 150 | 296 | 

...
| `total_proof_time_ms ` |  486.50 |  973 |  552 |  421 |
...
| `execute_preflight_insn_mi/s` |  36.56 | -          |  38.65 |  34.47 |
| `trace_gen_time_ms   ` |  189 |  378 |  195 |  183 |
| `memory_finalize_time_ms` | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  174 |  348 |  185 |  163 |
| `main_trace_commit_time_ms` |  30 |  60 |  32 |  28 |
| `generate_perm_trace_time_ms` |  14.50 |  29 |  17 |  12 |
| `perm_trace_commit_time_ms` |  41.64 |  83.29 |  43.66 |  39.62 |
| `quotient_poly_compute_time_ms` |  31.58 |  63.15 |  34.38 |  28.77 |
| `quotient_poly_commit_time_ms` |  11.70 |  23.40 |  12.24 |  11.16 |
| `pcs_opening_time_ms ` |  42.50 |  85 |  44 |  41 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,009.50 |  2,019 |  1,278 |  741 |
...
| `execute_preflight_time_ms` |  512 |  1,024 |  819 |  205 |
| `execute_preflight_insn_mi/s` |  6.71 | -          |  6.73 |  6.68 |
| `trace_gen_time_ms   ` |  58.50 |  117 |  62 |  55 |
| `memory_finalize_time_ms` |  5.50 |  11 |  6 |  5 |
| `stark_prove_excluding_trace_time_ms` |  438 |  876 |  473 |  403 |
| `main_trace_commit_time_ms` |  83.50 |  167 |  91 |  76 |
| `generate_perm_trace_time_ms` |  37 |  74 |  40 |  34 |
| `perm_trace_commit_time_ms` |  124.28 |  248.57 |  140.48 |  108.09 |
| `quotient_poly_compute_time_ms` |  89.91 |  179.83 |  99.31 |  80.52 |
| `quotient_poly_commit_time_ms` |  22.01 |  44.01 |  24.02 |  19.100 |
| `pcs_opening_time_ms ` |  78.50 |  157 |  81 |  76 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program |  | 421 |  | 1 | 13 | 1,500,209 | 112.87 | 0 | 
| leaf | 1,280 |  | 1 | 1 |  |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 62 | 741 | 17,887,054 | 252,878,314 | 62 | 473 | 0 | 99.31 | 24.02 | 4 | 140.48 | 81 | 176 | 80 | 6 | 91 | 6,608,072 | 34 | 205 | 1,229,669 | 6.73 | 26 | 124 | 0 | 80 | 
| leaf | 1 | 55 | 1,278 | 17,250,234 | 207,789,546 | 55 | 403 | 0 | 80.52 | 19.100 | 4 | 108.09 | 76 | 148 | 76 | 5 | 76 | 6,343,052 | 40 | 819 | 1,151,166 | 6.68 | 22 | 101 | 0 | 76 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 195 | 552 | 9,677,708 | 84,395,212 | 195 | 185 | 0 | 34.38 | 12.24 | 4 | 43.66 | 44 | 61 | 43 | 0 | 32 | 1,035,986 | 17 | 26 | 873,000 | 34.47 | 14 | 47 | 0 | 43 | 
| fibonacci_program | 1 | 183 | 421 | 9,708,170 | 74,305,770 | 183 | 163 | 1 | 28.77 | 11.16 | 4 | 39.62 | 41 | 52 | 41 | 0 | 28 | 1,064,416 | 12 | 34 | 627,209 | 38.65 | 11 | 40 | 0 | 41 | 

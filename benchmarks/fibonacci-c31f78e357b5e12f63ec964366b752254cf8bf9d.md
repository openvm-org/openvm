...
| `total_proof_time_ms ` |  607.50 |  1,215 |  674 |  541 |
...
| `execute_metered_insn_mi/s` |  141.78 | -          |  141.78 |  141.78 |
| `execute_preflight_insns` |  750,105 |  1,500,210 |  873,000 |  627,210 |
| `execute_preflight_time_ms` |  29.50 |  59 |  35 |  24 |
| `execute_preflight_insn_mi/s` |  38.72 | -          |  40.66 |  36.78 |
| `trace_gen_time_ms   ` |  208.50 |  417 |  215 |  202 |
| `memory_finalize_time_ms` | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  273.50 |  547 |  285 |  262 |
| `main_trace_commit_time_ms` |  32.50 |  65 |  35 |  30 |
| `generate_perm_trace_time_ms` |  32 |  64 |  36 |  28 |
| `perm_trace_commit_time_ms` |  43.68 |  87.35 |  46.83 |  40.52 |
| `quotient_poly_compute_time_ms` |  30.67 |  61.35 |  32.61 |  28.74 |
| `quotient_poly_commit_time_ms` |  14.13 |  28.27 |  14.15 |  14.12 |
| `pcs_opening_time_ms ` |  118 |  236 |  126 |  110 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,240 |  2,480 |  1,459 |  1,021 |
| `main_cells_used     ` |  6,475,562 |  12,951,124 |  6,608,072 |  6,343,052 |
| `total_cells_used    ` |  17,568,644 |  35,137,288 |  17,887,054 |  17,250,234 |
| `execute_preflight_insns` |  1,190,404 |  2,380,808 |  1,229,594 |  1,151,214 |
| `execute_preflight_time_ms` |  502 |  1,004 |  802 |  202 |
| `execute_preflight_insn_mi/s` |  6.68 | -          |  6.79 |  6.57 |
| `trace_gen_time_ms   ` |  58 |  116 |  63 |  53 |
| `memory_finalize_time_ms` |  5.50 |  11 |  6 |  5 |
| `stark_prove_excluding_trace_time_ms` |  679 |  1,358 |  755 |  603 |
| `main_trace_commit_time_ms` |  90 |  180 |  98 |  82 |
| `generate_perm_trace_time_ms` |  41.50 |  83 |  52 |  31 |
| `perm_trace_commit_time_ms` |  132.82 |  265.65 |  150.21 |  115.44 |
| `quotient_poly_compute_time_ms` |  90.28 |  180.56 |  99.46 |  81.10 |
| `quotient_poly_commit_time_ms` |  25.23 |  50.46 |  26.92 |  23.54 |
| `pcs_opening_time_ms ` |  295.50 |  591 |  324 |  267 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program |  | 541 |  | 67 | 1 | 10 | 1,500,210 | 141.78 | 166 | 
| leaf | 1,461 |  | 1 |  | 1 |  |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 63 | 1,021 | 17,887,054 | 252,878,314 | 63 | 755 | 0 | 99.46 | 26.92 | 5 | 150.21 | 324 | 203 | 324 | 6 | 98 | 6,608,072 | 52 | 202 | 1,229,594 | 6.79 | 24 | 127 | 1 | 324 | 
| leaf | 1 | 53 | 1,459 | 17,250,234 | 207,789,546 | 53 | 603 | 0 | 81.10 | 23.54 | 4 | 115.44 | 267 | 147 | 267 | 5 | 82 | 6,343,052 | 31 | 802 | 1,151,214 | 6.57 | 21 | 105 | 1 | 267 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 215 | 674 | 9,684,992 | 84,395,212 | 215 | 285 | 0 | 32.61 | 14.15 | 5 | 46.83 | 126 | 75 | 126 | 0 | 35 | 1,040,430 | 28 | 24 | 873,000 | 36.78 | 13 | 47 | 1 | 126 | 
| fibonacci_program | 1 | 202 | 541 | 9,714,030 | 74,305,770 | 202 | 262 | 1 | 28.74 | 14.12 | 4 | 40.52 | 110 | 77 | 110 | 0 | 30 | 1,067,532 | 36 | 35 | 627,210 | 40.66 | 11 | 43 | 1 | 110 | 

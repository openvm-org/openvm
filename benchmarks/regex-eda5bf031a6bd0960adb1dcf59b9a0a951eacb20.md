...
|:---|---:|---:|---:|
| Total |  17.05 |  5.73 | 5.73 |
| regex_program |  5.16 |  1.56 |  1.56 |
| leaf |  11.89 |  4.17 |  4.17 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,282 |  5,128 |  1,529 |  1,165 |
...
| `execute_metered_insn_mi/s` |  112.27 | -          |  112.27 |  112.27 |
| `execute_preflight_insns` |  1,034,284.75 |  4,137,139 |  1,104,000 |  826,139 |
| `execute_preflight_time_ms` |  46 |  184 |  56 |  36 |
| `execute_preflight_insn_mi/s` |  30.80 | -          |  32.22 |  30.15 |
| `trace_gen_time_ms   ` |  181.75 |  727 |  195 |  176 |
| `memory_finalize_time_ms` |  1 |  4 |  4 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  982 |  3,928 |  1,134 |  892 |
| `main_trace_commit_time_ms` |  52.75 |  211 |  58 |  51 |
| `generate_perm_trace_time_ms` |  25.25 |  101 |  37 |  17 |
| `perm_trace_commit_time_ms` |  65.97 |  263.89 |  73.18 |  56.46 |
| `quotient_poly_compute_time_ms` |  59.82 |  239.29 |  69.48 |  54.53 |
| `quotient_poly_commit_time_ms` |  15.88 |  63.52 |  18.76 |  13.79 |
| `pcs_opening_time_ms ` |  759 |  3,036 |  895 |  675 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  2,972.25 |  11,889 |  4,169 |  2,155 |
| `main_cells_used     ` |  15,214,160 |  60,856,640 |  24,212,776 |  11,795,978 |
| `total_cells_used    ` |  37,881,319 |  151,525,276 |  60,130,130 |  29,464,276 |
| `execute_preflight_insns` |  2,315,021 |  9,260,084 |  2,695,881 |  2,075,256 |
| `execute_preflight_time_ms` |  1,055 |  4,220 |  1,384 |  385 |
| `execute_preflight_insn_mi/s` |  6.53 | -          |  6.88 |  5.85 |
| `trace_gen_time_ms   ` |  124.75 |  499 |  211 |  91 |
| `memory_finalize_time_ms` |  12 |  48 |  20 |  8 |
| `stark_prove_excluding_trace_time_ms` |  1,791 |  7,164 |  2,645 |  1,230 |
| `main_trace_commit_time_ms` |  217.50 |  870 |  383 |  148 |
| `generate_perm_trace_time_ms` |  77.50 |  310 |  156 |  47 |
| `perm_trace_commit_time_ms` |  361.32 |  1,445.29 |  702.10 |  230.11 |
| `quotient_poly_compute_time_ms` |  252.62 |  1,010.48 |  455.30 |  177 |
| `quotient_poly_commit_time_ms` |  53.23 |  212.92 |  100.89 |  31.90 |
| `pcs_opening_time_ms ` |  823.50 |  3,294 |  986 |  589 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 4,173 |  | 1 | 1 |  |  |  |  | 
| regex_program |  | 1,165 |  | 1 | 36 | 4,137,139 | 112.27 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 106 | 2,155 | 32,466,594 | 471,277,034 | 106 | 1,663 | 0 | 200.57 | 48.05 | 6 | 281.30 | 881 | 339 | 880 | 11 | 191 | 13,051,908 | 57 | 385 | 2,413,664 | 6.88 | 53 | 250 | 5 | 880 | 
| leaf | 1 | 91 | 3,103 | 29,464,276 | 403,119,594 | 91 | 1,626 | 0 | 177.61 | 31.90 | 6 | 231.78 | 986 | 280 | 986 | 8 | 148 | 11,795,978 | 47 | 1,384 | 2,075,283 | 6.71 | 38 | 210 | 0 | 986 | 
| leaf | 2 | 91 | 2,462 | 29,464,276 | 403,119,594 | 91 | 1,230 | 0 | 177 | 32.09 | 6 | 230.11 | 589 | 281 | 589 | 9 | 148 | 11,795,978 | 50 | 1,139 | 2,075,256 | 6.70 | 38 | 210 | 0 | 589 | 
| leaf | 3 | 211 | 4,169 | 60,130,130 | 989,416,938 | 211 | 2,645 | 0 | 455.30 | 100.89 | 6 | 702.10 | 838 | 859 | 838 | 20 | 383 | 24,212,776 | 156 | 1,312 | 2,695,881 | 5.85 | 137 | 563 | 9 | 837 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 177 | 1,529 | 23,441,564 | 150,778,428 | 177 | 1,134 | 0 | 60.63 | 18.76 | 7 | 73.18 | 895 | 100 | 895 | 4 | 58 | 10,895,130 | 26 | 56 | 1,103,000 | 30.45 | 22 | 80 | 0 | 895 | 
| regex_program | 1 | 179 | 1,221 | 11,592,182 | 128,513,066 | 179 | 954 | 1 | 54.64 | 15.45 | 6 | 67.72 | 746 | 85 | 746 | 0 | 51 | 2,190,100 | 17 | 45 | 1,104,000 | 32.22 | 17 | 70 | 0 | 746 | 
| regex_program | 2 | 176 | 1,213 | 11,583,038 | 128,513,066 | 176 | 948 | 1 | 54.53 | 15.51 | 6 | 66.54 | 720 | 104 | 720 | 0 | 51 | 2,181,164 | 37 | 47 | 1,104,000 | 30.37 | 17 | 70 | 0 | 720 | 
| regex_program | 3 | 195 | 1,165 | 11,854,458 | 103,456,394 | 195 | 892 | 0 | 69.48 | 13.79 | 7 | 56.46 | 675 | 80 | 675 | 0 | 51 | 2,423,136 | 21 | 36 | 826,139 | 30.15 | 19 | 84 | 0 | 674 | 

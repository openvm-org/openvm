...
| `total_proof_time_ms ` |  4,956 |  4,956 |  4,956 |  4,956 |
| `main_cells_used     ` |  51,485,080 |  51,485,080 |  51,485,080 |  51,485,080 |
| `total_cycles        ` |  1,500,095 |  1,500,095 |  1,500,095 |  1,500,095 |
| `execute_time_ms     ` |  310 |  310 |  310 |  310 |
| `trace_gen_time_ms   ` |  644 |  644 |  644 |  644 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  6,010 |  6,010 |  6,010 |  6,010 |
| `main_cells_used     ` |  49,918,559 |  49,918,559 |  49,918,559 |  49,918,559 |
| `total_cycles        ` |  1,213,531 |  1,213,531 |  1,213,531 |  1,213,531 |
...
| `main_trace_commit_time_ms` |  1,002 |  1,002 |  1,002 |  1,002 |
| `generate_perm_trace_time_ms` |  113 |  113 |  113 |  113 |
| `perm_trace_commit_time_ms` |  908 |  908 |  908 |  908 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 766 | 6,010 | 1,213,531 | 139,379,672 | 4,919 | 680 | 991 | 908 | 1,223 | 1,002 | 49,918,559 | 113 | 325 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 644 | 4,956 | 1,500,095 | 122,458,476 | 4,002 | 515 | 731 | 753 | 1,050 | 797 | 51,485,080 | 152 | 310 | 

...
| `total_proof_time_ms ` |  3,874.50 |  7,749 |  4,463 |  3,286 |
...
| `trace_gen_time_ms   ` |  980 |  1,960 |  1,158 |  802 |
| `stark_prove_excluding_trace_time_ms` |  2,555 |  5,110 |  2,929 |  2,181 |
| `main_trace_commit_time_ms` |  445.50 |  891 |  524 |  367 |
| `generate_perm_trace_time_ms` |  165 |  330 |  188 |  142 |
| `perm_trace_commit_time_ms` |  647.50 |  1,295 |  753 |  542 |
| `quotient_poly_compute_time_ms` |  358 |  716 |  414 |  302 |
| `quotient_poly_commit_time_ms` |  272 |  544 |  320 |  224 |
| `pcs_opening_time_ms ` |  656.50 |  1,313 |  720 |  593 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,446 |  14,892 |  7,508 |  7,384 |
| `main_cells_used     ` |  152,307,247.50 |  304,614,495 |  154,765,951 |  149,848,544 |
| `total_cycles        ` |  1,993,431.50 |  3,986,863 |  2,024,257 |  1,962,606 |
| `execute_time_ms     ` |  768 |  1,536 |  777 |  759 |
| `trace_gen_time_ms   ` |  1,461.50 |  2,923 |  1,484 |  1,439 |
| `stark_prove_excluding_trace_time_ms` |  5,216.50 |  10,433 |  5,247 |  5,186 |
| `main_trace_commit_time_ms` |  887.50 |  1,775 |  889 |  886 |
| `generate_perm_trace_time_ms` |  343 |  686 |  350 |  336 |
| `perm_trace_commit_time_ms` |  1,642.50 |  3,285 |  1,668 |  1,617 |
| `quotient_poly_compute_time_ms` |  759 |  1,518 |  761 |  757 |
| `quotient_poly_commit_time_ms` |  521 |  1,042 |  521 |  521 |
| `pcs_opening_time_ms ` |  1,057.50 |  2,115 |  1,059 |  1,056 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,484 | 7,508 | 2,024,257 | 533,941,738 | 5,247 | 757 | 521 | 1,668 | 1,059 | 886 | 154,765,951 | 350 | 777 | 
| leaf | 1 | 1,439 | 7,384 | 1,962,606 | 533,941,738 | 5,186 | 761 | 521 | 1,617 | 1,056 | 889 | 149,848,544 | 336 | 759 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,158 | 4,463 | 2,225,434 | 275,652,919 | 2,929 | 414 | 320 | 753 | 720 | 524 | 93,699,990 | 188 | 376 | 
| regex_program | 1 | 802 | 3,286 | 1,914,730 | 198,099,628 | 2,181 | 302 | 224 | 542 | 593 | 367 | 73,689,460 | 142 | 303 | 

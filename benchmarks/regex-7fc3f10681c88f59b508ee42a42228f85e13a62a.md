...
| `total_proof_time_ms ` |  4,027.50 |  8,055 |  4,451 |  3,604 |
...
| `trace_gen_time_ms   ` |  972 |  1,944 |  1,143 |  801 |
| `stark_prove_excluding_trace_time_ms` |  2,718 |  5,436 |  2,934 |  2,502 |
| `main_trace_commit_time_ms` |  470 |  940 |  528 |  412 |
| `generate_perm_trace_time_ms` |  197.50 |  395 |  201 |  194 |
| `perm_trace_commit_time_ms` |  691 |  1,382 |  743 |  639 |
| `quotient_poly_compute_time_ms` |  395 |  790 |  422 |  368 |
| `quotient_poly_commit_time_ms` |  276 |  552 |  312 |  240 |
| `pcs_opening_time_ms ` |  680 |  1,360 |  719 |  641 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,305.50 |  14,611 |  7,372 |  7,239 |
| `main_cells_used     ` |  152,278,057 |  304,556,114 |  154,677,970 |  149,878,144 |
| `total_cycles        ` |  1,991,016 |  3,982,032 |  2,021,848 |  1,960,184 |
| `execute_time_ms     ` |  769 |  1,538 |  776 |  762 |
| `trace_gen_time_ms   ` |  1,490 |  2,980 |  1,499 |  1,481 |
| `stark_prove_excluding_trace_time_ms` |  5,046.50 |  10,093 |  5,097 |  4,996 |
| `main_trace_commit_time_ms` |  811 |  1,622 |  815 |  807 |
| `generate_perm_trace_time_ms` |  376.50 |  753 |  390 |  363 |
| `perm_trace_commit_time_ms` |  1,542 |  3,084 |  1,574 |  1,510 |
| `quotient_poly_compute_time_ms` |  767 |  1,534 |  770 |  764 |
| `quotient_poly_commit_time_ms` |  492.50 |  985 |  493 |  492 |
| `pcs_opening_time_ms ` |  1,053 |  2,106 |  1,056 |  1,050 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,499 | 7,372 | 2,021,848 | 538,660,330 | 5,097 | 764 | 492 | 1,574 | 1,056 | 815 | 154,677,970 | 390 | 776 | 
| leaf | 1 | 1,481 | 7,239 | 1,960,184 | 538,660,330 | 4,996 | 770 | 493 | 1,510 | 1,050 | 807 | 149,878,144 | 363 | 762 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,143 | 4,451 | 2,243,715 | 275,652,919 | 2,934 | 422 | 312 | 743 | 719 | 528 | 93,500,799 | 201 | 374 | 
| regex_program | 1 | 801 | 3,604 | 1,921,511 | 242,975,404 | 2,502 | 368 | 240 | 639 | 641 | 412 | 73,010,353 | 194 | 301 | 

...
| `total_proof_time_ms ` |  734 |  1,468 |  845 |  623 |
...
| `execute_preflight_time_ms` |  86.50 |  173 |  110 |  63 |
| `execute_preflight_insn_mi/s` |  13.86 | -          |  16.94 |  10.77 |
| `trace_gen_time_ms   ` |  184 |  368 |  190 |  178 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  357.50 |  715 |  387 |  328 |
| `main_trace_commit_time_ms` |  64.50 |  129 |  75 |  54 |
| `generate_perm_trace_time_ms` |  32.50 |  65 |  36 |  29 |
| `perm_trace_commit_time_ms` |  77.24 |  154.49 |  89.73 |  64.76 |
| `quotient_poly_compute_time_ms` |  83.61 |  167.22 |  92.95 |  74.27 |
| `quotient_poly_commit_time_ms` |  17.53 |  35.06 |  19.73 |  15.33 |
| `pcs_opening_time_ms ` |  77.50 |  155 |  86 |  69 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,494.50 |  2,989 |  1,766 |  1,223 |
...
| `execute_preflight_time_ms` |  590 |  1,180 |  886 |  294 |
| `execute_preflight_insn_mi/s` |  7.69 | -          |  7.70 |  7.68 |
| `trace_gen_time_ms   ` |  117.50 |  235 |  125 |  110 |
| `memory_finalize_time_ms` |  12 |  24 |  13 |  11 |
| `stark_prove_excluding_trace_time_ms` |  785.50 |  1,571 |  802 |  769 |
| `main_trace_commit_time_ms` |  145 |  290 |  149 |  141 |
| `generate_perm_trace_time_ms` |  58 |  116 |  61 |  55 |
| `perm_trace_commit_time_ms` |  225.15 |  450.29 |  231.50 |  218.79 |
| `quotient_poly_compute_time_ms` |  173.02 |  346.05 |  174.05 |  172 |
| `quotient_poly_commit_time_ms` |  32.100 |  65.99 |  33.76 |  32.24 |
| `pcs_opening_time_ms ` |  147.50 |  295 |  149 |  146 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 1,768 |  | 1 | 1 |  |  |  |  | 
| pairing |  | 623 |  | 1 | 63 | 1,745,742 | 27.49 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 125 | 1,223 | 39,650,868 | 410,701,290 | 125 | 802 | 0 | 174.05 | 33.76 | 4 | 231.50 | 149 | 294 | 149 | 13 | 149 | 16,332,746 | 61 | 294 | 1,991,942 | 7.70 | 39 | 209 | 0 | 149 | 
| leaf | 1 | 110 | 1,766 | 39,014,972 | 396,840,426 | 110 | 769 | 0 | 172 | 32.24 | 4 | 218.79 | 146 | 275 | 146 | 11 | 141 | 16,068,198 | 55 | 886 | 1,912,947 | 7.68 | 37 | 205 | 0 | 146 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 178 | 845 | 32,480,114 | 172,558,444 | 178 | 387 | 0 | 92.95 | 19.73 | 6 | 89.73 | 69 | 128 | 69 | 1 | 75 | 15,909,408 | 36 | 110 | 1,149,000 | 10.77 | 27 | 113 | 1 | 69 | 
| pairing | 1 | 190 | 623 | 22,464,232 | 119,958,502 | 190 | 328 | 1 | 74.27 | 15.33 | 6 | 64.76 | 86 | 97 | 86 | 0 | 54 | 9,498,894 | 29 | 63 | 596,742 | 16.94 | 21 | 90 | 1 | 86 | 

...
| `total_proof_time_ms ` |  3,882.50 |  7,765 |  4,487 |  3,278 |
...
| `trace_gen_time_ms   ` |  964.50 |  1,929 |  1,151 |  778 |
| `stark_prove_excluding_trace_time_ms` |  2,577.50 |  5,155 |  2,957 |  2,198 |
| `main_trace_commit_time_ms` |  452.50 |  905 |  536 |  369 |
| `generate_perm_trace_time_ms` |  171.50 |  343 |  204 |  139 |
| `perm_trace_commit_time_ms` |  644.50 |  1,289 |  744 |  545 |
| `quotient_poly_compute_time_ms` |  367 |  734 |  425 |  309 |
| `quotient_poly_commit_time_ms` |  271.50 |  543 |  316 |  227 |
| `pcs_opening_time_ms ` |  660.50 |  1,321 |  721 |  600 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,489 |  14,978 |  7,603 |  7,375 |
| `main_cells_used     ` |  152,233,466 |  304,466,932 |  154,691,048 |  149,775,884 |
| `total_cycles        ` |  1,990,771 |  3,981,542 |  2,021,569 |  1,959,973 |
| `execute_time_ms     ` |  758 |  1,516 |  769 |  747 |
| `trace_gen_time_ms   ` |  1,463 |  2,926 |  1,485 |  1,441 |
| `stark_prove_excluding_trace_time_ms` |  5,268 |  10,536 |  5,349 |  5,187 |
| `main_trace_commit_time_ms` |  890.50 |  1,781 |  891 |  890 |
| `generate_perm_trace_time_ms` |  355 |  710 |  371 |  339 |
| `perm_trace_commit_time_ms` |  1,673.50 |  3,347 |  1,720 |  1,627 |
| `quotient_poly_compute_time_ms` |  768 |  1,536 |  771 |  765 |
| `quotient_poly_commit_time_ms` |  522 |  1,044 |  525 |  519 |
| `pcs_opening_time_ms ` |  1,054.50 |  2,109 |  1,066 |  1,043 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,485 | 7,603 | 2,021,569 | 533,941,738 | 5,349 | 771 | 525 | 1,720 | 1,066 | 891 | 154,691,048 | 371 | 769 | 
| leaf | 1 | 1,441 | 7,375 | 1,959,973 | 533,941,738 | 5,187 | 765 | 519 | 1,627 | 1,043 | 890 | 149,775,884 | 339 | 747 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,151 | 4,487 | 2,225,434 | 275,652,919 | 2,957 | 425 | 316 | 744 | 721 | 536 | 93,699,990 | 204 | 379 | 
| regex_program | 1 | 778 | 3,278 | 1,914,730 | 198,099,628 | 2,198 | 309 | 227 | 545 | 600 | 369 | 73,689,460 | 139 | 302 | 

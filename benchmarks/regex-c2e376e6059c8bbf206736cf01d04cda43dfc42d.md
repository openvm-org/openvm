...
| `total_proof_time_ms ` |  567.75 |  2,271 |  697 |  512 |
...
| `execute_metered_insn_mi/s` |  123.47 | -          |  123.47 |  123.47 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  54 |  216 |  65 |  45 |
| `execute_preflight_insn_mi/s` |  30.63 | -          |  31.95 |  27.21 |
| `trace_gen_time_ms   ` |  174 |  696 |  206 |  150 |
| `memory_finalize_time_ms` |  0.75 |  3 |  3 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  272.50 |  1,090 |  299 |  253 |
| `main_trace_commit_time_ms` |  51.25 |  205 |  56 |  49 |
| `generate_perm_trace_time_ms` |  22.75 |  91 |  32 |  18 |
| `perm_trace_commit_time_ms` |  63.48 |  253.90 |  69.05 |  55.07 |
| `quotient_poly_compute_time_ms` |  57.61 |  230.45 |  68.11 |  50.86 |
| `quotient_poly_commit_time_ms` |  14.96 |  59.86 |  17.35 |  13.03 |
| `pcs_opening_time_ms ` |  59 |  236 |  71 |  50 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,366 |  5,464 |  1,972 |  874 |
...
| `execute_preflight_insns` |  1,440,855.75 |  5,763,423 |  1,814,628 |  1,241,403 |
| `execute_preflight_time_ms` |  610.75 |  2,443 |  794 |  221 |
| `execute_preflight_insn_mi/s` |  7.19 | -          |  7.62 |  6.85 |
| `trace_gen_time_ms   ` |  86.50 |  346 |  160 |  58 |
| `memory_finalize_time_ms` |  8.50 |  34 |  16 |  5 |
| `stark_prove_excluding_trace_time_ms` |  667.25 |  2,669 |  1,047 |  495 |
| `main_trace_commit_time_ms` |  123 |  492 |  192 |  90 |
| `generate_perm_trace_time_ms` |  51.50 |  206 |  69 |  33 |
| `perm_trace_commit_time_ms` |  196.11 |  784.45 |  337.87 |  139.20 |
| `quotient_poly_compute_time_ms` |  138.35 |  553.41 |  227.01 |  97.95 |
| `quotient_poly_commit_time_ms` |  29.54 |  118.17 |  47.95 |  22.28 |
| `pcs_opening_time_ms ` |  125.25 |  501 |  168 |  91 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 1,974 |  | 1 |  | 1 |  |  |  |  | 
| regex_program |  | 550 |  | 66 | 1 | 33 | 4,137,502 | 123.47 | 197 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 69 | 874 | 22,981,570 | 319,331,818 | 69 | 583 | 0 | 129.31 | 24.66 | 4 | 168.14 | 91 | 216 | 91 | 7 | 120 | 9,122,488 | 47 | 221 | 1,465,948 | 7.62 | 30 | 155 | 0 | 91 | 
| leaf | 1 | 58 | 1,398 | 20,905,034 | 255,237,610 | 58 | 544 | 0 | 97.95 | 22.28 | 4 | 139.24 | 135 | 197 | 135 | 5 | 90 | 8,256,948 | 57 | 794 | 1,241,403 | 7.14 | 25 | 121 | 0 | 135 | 
| leaf | 2 | 59 | 1,220 | 20,905,034 | 255,237,610 | 59 | 495 | 0 | 99.13 | 23.28 | 4 | 139.20 | 107 | 173 | 107 | 6 | 90 | 8,256,948 | 33 | 665 | 1,241,444 | 7.13 | 26 | 123 | 0 | 107 | 
| leaf | 3 | 160 | 1,972 | 50,337,320 | 538,365,418 | 160 | 1,047 | 0 | 227.01 | 47.95 | 4 | 337.87 | 168 | 408 | 168 | 16 | 192 | 20,171,106 | 69 | 763 | 1,814,628 | 6.85 | 61 | 278 | 5 | 168 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 206 | 697 | 23,446,148 | 150,778,428 | 206 | 299 | 0 | 59.54 | 17.35 | 5 | 69.05 | 62 | 102 | 62 | 3 | 56 | 10,899,170 | 32 | 47 | 1,103,000 | 27.21 | 21 | 77 | 1 | 62 | 
| regex_program | 1 | 150 | 512 | 11,598,276 | 128,513,066 | 150 | 255 | 1 | 50.86 | 14.22 | 4 | 64.15 | 53 | 86 | 53 | 0 | 49 | 2,196,106 | 21 | 65 | 1,104,000 | 31.95 | 16 | 65 | 0 | 53 | 
| regex_program | 2 | 159 | 512 | 11,579,064 | 128,513,066 | 159 | 253 | 1 | 51.95 | 15.27 | 4 | 65.63 | 50 | 84 | 50 | 0 | 50 | 2,177,334 | 18 | 59 | 1,104,000 | 31.54 | 16 | 67 | 0 | 50 | 
| regex_program | 3 | 181 | 550 | 11,853,872 | 103,456,394 | 181 | 283 | 0 | 68.11 | 13.03 | 5 | 55.07 | 71 | 78 | 71 | 0 | 50 | 2,422,606 | 20 | 45 | 826,502 | 31.81 | 18 | 82 | 1 | 71 | 

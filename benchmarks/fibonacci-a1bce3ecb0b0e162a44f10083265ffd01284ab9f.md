...
|:---|---:|---:|---:|
| Total |  3.19 |  1.95 | 1.95 |
| fibonacci_program |  1.07 |  0.63 |  0.63 |
| leaf |  2.12 |  1.32 |  1.32 |
...
| `total_proof_time_ms ` |  529.50 |  1,059 |  615 |  444 |
...
| `execute_preflight_time_ms` |  30.50 |  61 |  34 |  27 |
| `execute_preflight_insn_mi/s` |  36.59 | -          |  38.77 |  34.41 |
| `trace_gen_time_ms   ` |  189 |  378 |  195 |  183 |
| `memory_finalize_time_ms` | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  201.50 |  403 |  219 |  184 |
| `main_trace_commit_time_ms` |  30.50 |  61 |  33 |  28 |
| `generate_perm_trace_time_ms` |  29 |  58 |  39 |  19 |
| `perm_trace_commit_time_ms` |  41.56 |  83.13 |  45.06 |  38.07 |
| `quotient_poly_compute_time_ms` |  31.18 |  62.35 |  35.09 |  27.27 |
| `quotient_poly_commit_time_ms` |  12.25 |  24.51 |  12.70 |  11.81 |
| `pcs_opening_time_ms ` |  55 |  110 |  72 |  38 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,062 |  2,124 |  1,320 |  804 |
| `main_cells_used     ` |  6,475,562 |  12,951,124 |  6,608,072 |  6,343,052 |
| `total_cells_used    ` |  17,568,644 |  35,137,288 |  17,887,054 |  17,250,234 |
| `execute_preflight_insns` |  1,190,391 |  2,380,782 |  1,229,568 |  1,151,214 |
| `execute_preflight_time_ms` |  547 |  1,094 |  877 |  217 |
| `execute_preflight_insn_mi/s` |  6.38 | -          |  6.42 |  6.34 |
| `trace_gen_time_ms   ` |  61.50 |  123 |  64 |  59 |
| `memory_finalize_time_ms` |  6 |  12 |  6 |  6 |
| `stark_prove_excluding_trace_time_ms` |  452 |  904 |  521 |  383 |
| `main_trace_commit_time_ms` |  82.50 |  165 |  90 |  75 |
| `generate_perm_trace_time_ms` |  43 |  86 |  58 |  28 |
| `perm_trace_commit_time_ms` |  124.53 |  249.06 |  141.47 |  107.58 |
| `quotient_poly_compute_time_ms` |  91.27 |  182.54 |  101.57 |  80.97 |
| `quotient_poly_commit_time_ms` |  22.37 |  44.74 |  24.13 |  20.60 |
| `pcs_opening_time_ms ` |  84.50 |  169 |  102 |  67 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program |  | 444 |  | 1 | 11 | 1,500,209 | 129.04 | 0 | 
| leaf | 1,321 |  | 1 | 1 |  |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 64 | 804 | 17,887,054 | 252,878,314 | 64 | 521 | 0 | 101.57 | 24.13 | 4 | 141.47 | 102 | 200 | 102 | 6 | 90 | 6,608,072 | 58 | 217 | 1,229,568 | 6.34 | 26 | 126 | 0 | 102 | 
| leaf | 1 | 59 | 1,320 | 17,250,234 | 207,789,546 | 59 | 383 | 0 | 80.97 | 20.60 | 5 | 107.58 | 67 | 137 | 66 | 6 | 75 | 6,343,052 | 28 | 877 | 1,151,214 | 6.42 | 22 | 102 | 0 | 66 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 195 | 615 | 9,677,708 | 84,395,212 | 195 | 219 | 0 | 35.09 | 12.70 | 5 | 45.06 | 72 | 65 | 72 | 0 | 33 | 1,035,986 | 19 | 27 | 873,000 | 34.41 | 14 | 48 | 0 | 72 | 
| fibonacci_program | 1 | 183 | 444 | 9,708,170 | 74,305,770 | 183 | 184 | 1 | 27.27 | 11.81 | 4 | 38.07 | 38 | 78 | 38 | 0 | 28 | 1,064,416 | 39 | 34 | 627,209 | 38.77 | 11 | 39 | 0 | 38 | 

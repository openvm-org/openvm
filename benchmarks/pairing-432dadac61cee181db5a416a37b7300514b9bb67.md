...
| `execute_preflight_insn_mi/s` |  13.67 | -          |  18.21 |  9.14 |
| `trace_gen_time_ms   ` |  178 |  356 |  194 |  162 |
| `memory_finalize_time_ms` | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  347.50 |  695 |  375 |  320 |
| `main_trace_commit_time_ms` |  62 |  124 |  71 |  53 |
| `generate_perm_trace_time_ms` |  43 |  86 |  47 |  39 |
| `perm_trace_commit_time_ms` |  76.80 |  153.60 |  88.35 |  65.25 |
| `quotient_poly_compute_time_ms` |  78.98 |  157.96 |  87.09 |  70.87 |
| `quotient_poly_commit_time_ms` |  16.44 |  32.89 |  18.34 |  14.55 |
| `pcs_opening_time_ms ` |  66 |  132 |  67 |  65 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,476 |  2,952 |  1,752 |  1,200 |
...
| `execute_preflight_time_ms` |  609 |  1,218 |  914 |  304 |
| `execute_preflight_insn_mi/s` |  7.53 | -          |  7.59 |  7.46 |
| `trace_gen_time_ms   ` |  115.50 |  231 |  123 |  108 |
| `memory_finalize_time_ms` |  11.50 |  23 |  12 |  11 |
| `stark_prove_excluding_trace_time_ms` |  750.50 |  1,501 |  772 |  729 |
| `main_trace_commit_time_ms` |  146 |  292 |  150 |  142 |
| `generate_perm_trace_time_ms` |  59.50 |  119 |  61 |  58 |
| `perm_trace_commit_time_ms` |  227.53 |  455.07 |  231.52 |  223.54 |
| `quotient_poly_compute_time_ms` |  167.02 |  334.04 |  168.84 |  165.20 |
| `quotient_poly_commit_time_ms` |  32.60 |  65.20 |  33.67 |  31.53 |
| `pcs_opening_time_ms ` |  115 |  230 |  127 |  103 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 1,754 |  | 1 | 1 |  |  |  |  | 
| pairing |  | 615 |  | 1 | 92 | 1,745,742 | 18.96 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 123 | 1,200 | 39,650,868 | 410,701,290 | 123 | 772 | 0 | 168.84 | 33.67 | 5 | 231.52 | 127 | 290 | 127 | 12 | 150 | 16,332,746 | 58 | 304 | 1,991,961 | 7.59 | 39 | 204 | 0 | 127 | 
| leaf | 1 | 108 | 1,752 | 39,014,972 | 396,840,426 | 108 | 729 | 0 | 165.20 | 31.53 | 4 | 223.54 | 103 | 285 | 103 | 11 | 142 | 16,068,198 | 61 | 914 | 1,912,891 | 7.46 | 38 | 198 | 0 | 103 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 162 | 811 | 32,689,110 | 172,558,444 | 162 | 375 | 0 | 87.09 | 18.34 | 6 | 88.35 | 67 | 129 | 67 | 0 | 71 | 16,059,916 | 39 | 130 | 1,157,000 | 9.14 | 26 | 106 | 1 | 67 | 
| pairing | 1 | 194 | 615 | 22,314,288 | 119,958,502 | 194 | 320 | 1 | 70.87 | 14.55 | 6 | 65.25 | 65 | 115 | 64 | 0 | 53 | 9,408,294 | 47 | 60 | 588,742 | 18.21 | 20 | 86 | 1 | 64 | 

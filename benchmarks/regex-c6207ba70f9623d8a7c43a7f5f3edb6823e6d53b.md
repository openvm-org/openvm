...
| `total_proof_time_ms ` |  4,039 |  8,078 |  4,492 |  3,586 |
...
| `trace_gen_time_ms   ` |  978.50 |  1,957 |  1,162 |  795 |
| `stark_prove_excluding_trace_time_ms` |  2,723.50 |  5,447 |  2,955 |  2,492 |
| `main_trace_commit_time_ms` |  470 |  940 |  531 |  409 |
| `generate_perm_trace_time_ms` |  200.50 |  401 |  207 |  194 |
| `perm_trace_commit_time_ms` |  687.50 |  1,375 |  745 |  630 |
| `quotient_poly_compute_time_ms` |  394 |  788 |  425 |  363 |
| `quotient_poly_commit_time_ms` |  278.50 |  557 |  315 |  242 |
| `pcs_opening_time_ms ` |  683.50 |  1,367 |  722 |  645 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,327.50 |  14,655 |  7,393 |  7,262 |
| `main_cells_used     ` |  152,277,553 |  304,555,106 |  154,677,214 |  149,877,892 |
| `total_cycles        ` |  1,990,974 |  3,981,948 |  2,021,785 |  1,960,163 |
| `execute_time_ms     ` |  766.50 |  1,533 |  775 |  758 |
| `trace_gen_time_ms   ` |  1,487 |  2,974 |  1,512 |  1,462 |
| `stark_prove_excluding_trace_time_ms` |  5,074 |  10,148 |  5,106 |  5,042 |
| `main_trace_commit_time_ms` |  807.50 |  1,615 |  809 |  806 |
| `generate_perm_trace_time_ms` |  374 |  748 |  382 |  366 |
| `perm_trace_commit_time_ms` |  1,566 |  3,132 |  1,593 |  1,539 |
| `quotient_poly_compute_time_ms` |  768.50 |  1,537 |  773 |  764 |
| `quotient_poly_commit_time_ms` |  493 |  986 |  493 |  493 |
| `pcs_opening_time_ms ` |  1,059 |  2,118 |  1,059 |  1,059 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,512 | 7,393 | 2,021,785 | 538,660,330 | 5,106 | 764 | 493 | 1,593 | 1,059 | 809 | 154,677,214 | 382 | 775 | 
| leaf | 1 | 1,462 | 7,262 | 1,960,163 | 538,660,330 | 5,042 | 773 | 493 | 1,539 | 1,059 | 806 | 149,877,892 | 366 | 758 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,162 | 4,492 | 2,243,715 | 275,652,919 | 2,955 | 425 | 315 | 745 | 722 | 531 | 93,500,799 | 207 | 375 | 
| regex_program | 1 | 795 | 3,586 | 1,921,511 | 242,975,404 | 2,492 | 363 | 242 | 630 | 645 | 409 | 73,010,353 | 194 | 299 | 

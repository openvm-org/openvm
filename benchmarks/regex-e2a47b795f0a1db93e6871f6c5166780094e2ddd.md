...
| `total_proof_time_ms ` |  584.50 |  2,338 |  717 |  537 |
...
| `execute_preflight_insn_mi/s` |  31.83 | -          |  32.95 |  28.72 |
| `trace_gen_time_ms   ` |  178 |  712 |  211 |  155 |
| `memory_finalize_time_ms` |  1 |  4 |  4 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  279.25 |  1,117 |  290 |  271 |
| `main_trace_commit_time_ms` |  51.75 |  207 |  57 |  50 |
| `generate_perm_trace_time_ms` |  27.75 |  111 |  39 |  20 |
| `perm_trace_commit_time_ms` |  63.98 |  255.93 |  70.11 |  55.96 |
| `quotient_poly_compute_time_ms` |  58.21 |  232.86 |  69.70 |  52.92 |
| `quotient_poly_commit_time_ms` |  15.69 |  62.75 |  18.31 |  13.81 |
| `pcs_opening_time_ms ` |  58.50 |  234 |  61 |  55 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,388.25 |  5,553 |  2,046 |  899 |
...
| `execute_preflight_insns` |  1,440,840 |  5,763,360 |  1,814,630 |  1,241,327 |
| `execute_preflight_time_ms` |  622.25 |  2,489 |  827 |  220 |
| `execute_preflight_insn_mi/s` |  7.12 | -          |  7.67 |  6.86 |
| `trace_gen_time_ms   ` |  88.25 |  353 |  165 |  58 |
| `memory_finalize_time_ms` |  8.75 |  35 |  17 |  5 |
| `stark_prove_excluding_trace_time_ms` |  676.25 |  2,705 |  1,108 |  494 |
| `main_trace_commit_time_ms` |  124 |  496 |  193 |  90 |
| `generate_perm_trace_time_ms` |  52.25 |  209 |  74 |  41 |
| `perm_trace_commit_time_ms` |  208.100 |  835.99 |  382.35 |  140.60 |
| `quotient_poly_compute_time_ms` |  147.07 |  588.26 |  241.20 |  104.52 |
| `quotient_poly_commit_time_ms` |  33.76 |  135.03 |  57.77 |  24.89 |
| `pcs_opening_time_ms ` |  106.25 |  425 |  153 |  86 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 2,048 |  | 1 | 1 |  |  |  |  | 
| regex_program |  | 541 |  | 1 | 38 | 4,137,502 | 107.91 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 71 | 899 | 22,981,570 | 319,331,818 | 71 | 607 | 0 | 137.45 | 27.34 | 4 | 170.89 | 96 | 222 | 96 | 7 | 122 | 9,122,488 | 51 | 220 | 1,466,016 | 7.67 | 31 | 165 | 0 | 96 | 
| leaf | 1 | 58 | 1,380 | 20,905,034 | 255,237,610 | 58 | 494 | 0 | 105.09 | 25.03 | 4 | 142.15 | 86 | 184 | 86 | 6 | 91 | 8,256,948 | 41 | 827 | 1,241,387 | 6.89 | 26 | 131 | 0 | 86 | 
| leaf | 2 | 59 | 1,228 | 20,905,034 | 255,237,610 | 59 | 496 | 0 | 104.52 | 24.89 | 4 | 140.60 | 90 | 184 | 90 | 5 | 90 | 8,256,948 | 43 | 671 | 1,241,327 | 7.04 | 26 | 130 | 0 | 90 | 
| leaf | 3 | 165 | 2,046 | 50,337,320 | 538,365,418 | 165 | 1,108 | 0 | 241.20 | 57.77 | 4 | 382.35 | 153 | 457 | 153 | 17 | 193 | 20,171,106 | 74 | 771 | 1,814,630 | 6.86 | 61 | 303 | 5 | 153 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 211 | 717 | 23,446,148 | 150,778,428 | 211 | 290 | 0 | 57.02 | 18.31 | 5 | 70.11 | 61 | 95 | 61 | 4 | 57 | 10,899,170 | 24 | 45 | 1,103,000 | 28.72 | 22 | 76 | 1 | 61 | 
| regex_program | 1 | 155 | 543 | 11,598,276 | 128,513,066 | 155 | 281 | 1 | 52.92 | 15.68 | 4 | 64.68 | 57 | 104 | 57 | 0 | 50 | 2,196,106 | 39 | 65 | 1,104,000 | 32.92 | 17 | 69 | 0 | 57 | 
| regex_program | 2 | 163 | 537 | 11,579,064 | 128,513,066 | 163 | 275 | 1 | 53.22 | 14.95 | 4 | 65.19 | 61 | 94 | 61 | 0 | 50 | 2,177,334 | 28 | 58 | 1,104,000 | 32.95 | 16 | 68 | 0 | 61 | 
| regex_program | 3 | 183 | 541 | 11,853,872 | 103,456,394 | 183 | 271 | 0 | 69.70 | 13.81 | 5 | 55.96 | 55 | 79 | 55 | 0 | 50 | 2,422,606 | 20 | 45 | 826,502 | 32.71 | 19 | 84 | 1 | 55 | 
...
Commit: https://github.com/openvm-org/openvm/commit/e2a47b795f0a1db93e6871f6c5166780094e2ddd
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19969483661)

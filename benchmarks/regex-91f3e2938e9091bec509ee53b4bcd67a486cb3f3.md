...
| `total_proof_time_ms ` |  589.75 |  2,359 |  745 |  537 |
...
| `execute_preflight_insn_mi/s` |  30.67 | -          |  31.92 |  27.63 |
| `trace_gen_time_ms   ` |  177.50 |  710 |  211 |  153 |
| `memory_finalize_time_ms` |  1 |  4 |  4 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  291 |  1,164 |  342 |  270 |
| `main_trace_commit_time_ms` |  51.75 |  207 |  57 |  50 |
| `generate_perm_trace_time_ms` |  33.25 |  133 |  54 |  20 |
| `perm_trace_commit_time_ms` |  64.44 |  257.77 |  70.87 |  55.78 |
| `quotient_poly_compute_time_ms` |  58.43 |  233.73 |  69.72 |  52.92 |
| `quotient_poly_commit_time_ms` |  14.66 |  58.65 |  16.72 |  12.86 |
| `pcs_opening_time_ms ` |  65 |  260 |  82 |  56 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,342.25 |  5,369 |  1,973 |  881 |
...
| `execute_preflight_insns` |  1,440,824 |  5,763,296 |  1,814,630 |  1,241,324 |
| `execute_preflight_time_ms` |  600.75 |  2,403 |  788 |  221 |
| `execute_preflight_insn_mi/s` |  7.22 | -          |  7.58 |  6.97 |
| `trace_gen_time_ms   ` |  88.75 |  355 |  168 |  59 |
| `memory_finalize_time_ms` |  8 |  32 |  15 |  5 |
| `stark_prove_excluding_trace_time_ms` |  651.75 |  2,607 |  1,059 |  474 |
| `main_trace_commit_time_ms` |  124.50 |  498 |  193 |  91 |
| `generate_perm_trace_time_ms` |  46 |  184 |  71 |  34 |
| `perm_trace_commit_time_ms` |  198.53 |  794.12 |  341.92 |  140.56 |
| `quotient_poly_compute_time_ms` |  141.60 |  566.41 |  230.66 |  101.25 |
| `quotient_poly_commit_time_ms` |  30.82 |  123.27 |  49.99 |  23.80 |
| `pcs_opening_time_ms ` |  107 |  428 |  167 |  75 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 1,975 |  | 1 | 1 |  |  |  |  | 
| regex_program |  | 539 |  | 1 | 36 | 4,137,502 | 114.03 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 69 | 881 | 22,981,570 | 319,331,818 | 69 | 591 | 0 | 132.35 | 25.38 | 4 | 170.64 | 98 | 211 | 98 | 6 | 122 | 9,122,488 | 40 | 221 | 1,466,015 | 7.58 | 30 | 158 | 0 | 98 | 
| leaf | 1 | 59 | 1,331 | 20,905,034 | 255,237,610 | 59 | 483 | 0 | 101.25 | 23.80 | 4 | 140.100 | 88 | 176 | 88 | 6 | 92 | 8,256,948 | 34 | 788 | 1,241,324 | 7.16 | 25 | 126 | 0 | 88 | 
| leaf | 2 | 59 | 1,184 | 20,905,034 | 255,237,610 | 59 | 474 | 0 | 102.15 | 24.10 | 4 | 140.56 | 75 | 180 | 75 | 5 | 91 | 8,256,948 | 39 | 649 | 1,241,327 | 7.18 | 26 | 127 | 0 | 75 | 
| leaf | 3 | 168 | 1,973 | 50,337,320 | 538,365,418 | 168 | 1,059 | 0 | 230.66 | 49.99 | 4 | 341.92 | 167 | 414 | 166 | 15 | 193 | 20,171,106 | 71 | 745 | 1,814,630 | 6.97 | 61 | 284 | 5 | 166 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 211 | 745 | 23,446,148 | 150,778,428 | 211 | 342 | 0 | 58.09 | 16.72 | 5 | 70.87 | 82 | 126 | 82 | 4 | 57 | 10,899,170 | 54 | 47 | 1,103,000 | 27.63 | 21 | 75 | 1 | 82 | 
| regex_program | 1 | 153 | 538 | 11,598,276 | 128,513,066 | 153 | 278 | 1 | 53.01 | 14.39 | 4 | 65.10 | 61 | 97 | 61 | 0 | 50 | 2,196,106 | 32 | 65 | 1,104,000 | 31.57 | 16 | 67 | 0 | 61 | 
| regex_program | 2 | 163 | 537 | 11,579,064 | 128,513,066 | 163 | 274 | 1 | 52.92 | 14.69 | 4 | 66.02 | 61 | 93 | 61 | 0 | 50 | 2,177,334 | 27 | 58 | 1,104,000 | 31.57 | 16 | 68 | 0 | 61 | 
| regex_program | 3 | 183 | 539 | 11,853,872 | 103,456,394 | 183 | 270 | 0 | 69.72 | 12.86 | 5 | 55.78 | 56 | 79 | 56 | 0 | 50 | 2,422,606 | 20 | 45 | 826,502 | 31.92 | 18 | 83 | 1 | 56 | 

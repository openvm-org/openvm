...
| `stark_prove_excluding_trace_time_ms` |  1,094 |  1,094 |  1,094 |  1,094 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  13,148 |  13,148 |  13,148 |  13,148 |
| `main_cells_used     ` |  244,742,856 |  244,742,856 |  244,742,856 |  244,742,856 |
| `total_cycles        ` |  2,990,640 |  2,990,640 |  2,990,640 |  2,990,640 |
| `execute_time_ms     ` |  1,086 |  1,086 |  1,086 |  1,086 |
| `trace_gen_time_ms   ` |  2,415 |  2,415 |  2,415 |  2,415 |
| `stark_prove_excluding_trace_time_ms` |  9,647 |  9,647 |  9,647 |  9,647 |
| `main_trace_commit_time_ms` |  1,727 |  1,727 |  1,727 |  1,727 |
| `generate_perm_trace_time_ms` |  689 |  689 |  689 |  689 |
| `perm_trace_commit_time_ms` |  3,199 |  3,199 |  3,199 |  3,199 |
| `quotient_poly_compute_time_ms` |  1,323 |  1,323 |  1,323 |  1,323 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 2,415 | 13,148 | 2,990,640 | 999,394,794 | 9,647 | 1,323 | 896 | 3,199 | 1,807 | 1,727 | 244,742,856 | 689 | 1,086 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 181 | 1,425 | 295,291 | 48,240,457 | 1,094 | 124 | 154 | 190 | 406 | 173 | 15,598,160 | 32 | 150 | 

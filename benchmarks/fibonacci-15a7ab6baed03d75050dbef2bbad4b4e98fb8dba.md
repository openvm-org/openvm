...
| `total_proof_time_ms ` |  758.50 |  3,034 |  907 |  549 |
| `execute_metered_time_ms` |  67 | -          | -          | -          |
| `execute_metered_insns` |  12,000,265 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  177.49 | -          |  177.49 |  177.49 |
| `execute_preflight_insns` |  3,000,066.25 |  12,000,265 |  3,495,000 |  1,515,265 |
| `execute_preflight_time_ms` |  83 |  332 |  103 |  43 |
| `execute_preflight_insn_mi/s` |  49.01 | -          |  50.23 |  46.12 |
| `trace_gen_time_ms   ` |  138 |  552 |  171 |  120 |
| `memory_finalize_time_ms` | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  467.25 |  1,869 |  528 |  293 |
| `prover.main_trace_commit_time_ms` |  98 |  392 |  112 |  59 |
| `prover.rap_constraints_time_ms` |  269.50 |  1,078 |  307 |  166 |
| `prover.openings_time_ms` |  98.75 |  395 |  110 |  67 |
| `prover.rap_constraints.logup_gkr_time_ms` |  194.25 |  777 |  220 |  117 |
| `prover.rap_constraints.round0_time_ms` |  50.25 |  201 |  59 |  31 |
...
| `prover.openings.whir_time_ms` |  79.75 |  319 |  88 |  55 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/15a7ab6baed03d75050dbef2bbad4b4e98fb8dba/fibonacci-15a7ab6baed03d75050dbef2bbad4b4e98fb8dba.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 70 |  |  |  | 346 |  |  |  |  |  |  | 
| app_proof |  |  |  | 549 |  | 67 | 12,000,265 | 177.49 | 0 | 3,109 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 328 | 116 | 0 | 0 | 106 | 35 | 34 | 50 | 20 | 0 | 104 | 91 | 13 | 3 | 9 | 116 | 116 | 106 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 168 | 47 | 0 | 0 | 68 | 26 | 25 | 28 | 13 | 0 | 52 | 43 | 8 | 1 | 6 | 47 | 47 | 68 | 0 | 3 | 13 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 136 | 31 | 0 | 0 | 62 | 24 | 23 | 24 | 13 | 0 | 41 | 34 | 7 | 1 | 5 | 31 | 31 | 62 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 147,934,254 | 606 | 229 | 0 | 0 | 182 | 83 | 82 | 53 | 45 | 0 | 193 | 169 | 24 | 12 | 11 | 230 | 229 | 182 | 0 | 8 | 43 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 136,618,310 | 528 | 110 | 0 | 0 | 307 | 59 | 59 | 27 | 220 | 0 | 110 | 88 | 21 | 12 | 9 | 110 | 110 | 307 | 0 | 3 | 219 | 0 | 0 | 
| app_proof | prover | 1 | 136,570,844 | 525 | 111 | 0 | 0 | 303 | 56 | 56 | 26 | 220 | 0 | 109 | 88 | 21 | 12 | 9 | 112 | 111 | 303 | 0 | 3 | 219 | 0 | 0 | 
| app_proof | prover | 2 | 136,570,844 | 523 | 110 | 0 | 0 | 302 | 55 | 55 | 27 | 220 | 0 | 109 | 88 | 21 | 12 | 8 | 111 | 111 | 302 | 0 | 3 | 218 | 0 | 0 | 
| app_proof | prover | 3 | 70,295,260 | 293 | 59 | 0 | 0 | 166 | 31 | 30 | 17 | 117 | 0 | 67 | 55 | 12 | 6 | 6 | 59 | 59 | 166 | 0 | 3 | 116 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 154 | 135 | 907 | 135 | 154 | 2,770,199,817 | 323,294,035 | 3,093,493,852 | 2,097,152 | 0 | 3 | 89 | 3,495,000 | 46.12 | 
| app_proof | 1 | 41 | 120 | 790 | 120 | 41 | 2,768,863,045 | 322,353,750 | 3,091,216,795 | 2,097,152 | 0 | 1 | 103 | 3,495,000 | 50.22 | 
| app_proof | 2 | 41 | 126 | 788 | 126 | 41 | 2,768,863,045 | 322,353,750 | 3,091,216,795 | 2,097,152 | 0 | 2 | 97 | 3,495,000 | 50.23 | 
| app_proof | 3 | 41 | 171 | 549 | 171 | 41 | 1,230,958,923 | 342,872,922 | 1,573,831,845 | 2,097,152 | 0 | 2 | 43 | 1,515,265 | 49.47 | 

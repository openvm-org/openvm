...
| `total_proof_time_ms ` |  736.50 |  2,946 |  859 |  666 |
...
| `execute_metered_insn_mi/s` |  118.84 | -          |  118.84 |  118.84 |
| `execute_preflight_insns` |  1,027,120.75 |  4,108,483 |  1,108,000 |  790,483 |
| `execute_preflight_time_ms` |  54.25 |  217 |  66 |  44 |
| `execute_preflight_insn_mi/s` |  30.25 | -          |  31.34 |  27.14 |
| `trace_gen_time_ms   ` |  192.25 |  769 |  223 |  171 |
| `memory_finalize_time_ms` |  1 |  4 |  4 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  421.50 |  1,686 |  463 |  388 |
| `main_trace_commit_time_ms` |  56.50 |  226 |  62 |  53 |
| `generate_perm_trace_time_ms` |  30.50 |  122 |  37 |  22 |
| `perm_trace_commit_time_ms` |  69.40 |  277.62 |  75.29 |  59.09 |
| `quotient_poly_compute_time_ms` |  74.64 |  298.56 |  139.22 |  50.45 |
| `quotient_poly_commit_time_ms` |  17.17 |  68.68 |  19.39 |  14.49 |
| `pcs_opening_time_ms ` |  170 |  680 |  186 |  157 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,745.50 |  6,982 |  2,669 |  1,243 |
...
| `execute_preflight_insns` |  1,440,895.75 |  5,763,583 |  1,814,601 |  1,241,431 |
| `execute_preflight_time_ms` |  611 |  2,444 |  800 |  227 |
| `execute_preflight_insn_mi/s` |  7.11 | -          |  7.34 |  6.90 |
| `trace_gen_time_ms   ` |  88.50 |  354 |  166 |  58 |
| `memory_finalize_time_ms` |  8.75 |  35 |  16 |  6 |
| `stark_prove_excluding_trace_time_ms` |  1,044.50 |  4,178 |  1,742 |  739 |
| `main_trace_commit_time_ms` |  133 |  532 |  205 |  98 |
| `generate_perm_trace_time_ms` |  51.75 |  207 |  77 |  37 |
| `perm_trace_commit_time_ms` |  210.24 |  840.95 |  358.51 |  149.68 |
| `quotient_poly_compute_time_ms` |  137.02 |  548.08 |  226.17 |  97.21 |
| `quotient_poly_commit_time_ms` |  34.87 |  139.48 |  55.87 |  26.82 |
| `pcs_opening_time_ms ` |  474 |  1,896 |  814 |  323 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 2,671 |  | 1 |  | 1 |  |  |  |  | 
| regex_program |  | 747 |  | 41 | 1 | 34 | 4,108,483 | 118.84 | 167 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 71 | 1,243 | 22,981,570 | 319,331,818 | 71 | 944 | 0 | 126.21 | 29.50 | 4 | 181.49 | 420 | 235 | 420 | 7 | 131 | 9,122,488 | 52 | 227 | 1,466,110 | 7.34 | 29 | 156 | 1 | 420 | 
| leaf | 1 | 58 | 1,599 | 20,905,034 | 255,237,610 | 58 | 739 | 0 | 98.49 | 26.82 | 4 | 149.68 | 323 | 191 | 322 | 6 | 98 | 8,256,948 | 41 | 800 | 1,241,431 | 7.03 | 25 | 126 | 1 | 322 | 
| leaf | 2 | 59 | 1,471 | 20,905,034 | 255,237,610 | 59 | 753 | 0 | 97.21 | 27.29 | 5 | 151.27 | 339 | 189 | 339 | 6 | 98 | 8,256,948 | 37 | 657 | 1,241,441 | 7.15 | 24 | 125 | 1 | 339 | 
| leaf | 3 | 166 | 2,669 | 50,337,320 | 538,365,418 | 166 | 1,742 | 0 | 226.17 | 55.87 | 5 | 358.51 | 814 | 436 | 813 | 16 | 205 | 20,171,106 | 77 | 760 | 1,814,601 | 6.90 | 59 | 285 | 6 | 813 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 223 | 859 | 23,395,260 | 150,778,428 | 223 | 439 | 0 | 56.49 | 19.39 | 5 | 75.29 | 186 | 114 | 186 | 4 | 62 | 10,864,634 | 37 | 48 | 1,102,000 | 27.14 | 19 | 76 | 2 | 186 | 
| regex_program | 1 | 171 | 674 | 11,589,074 | 132,682,794 | 171 | 396 | 1 | 52.40 | 18.21 | 4 | 71.13 | 167 | 100 | 167 | 0 | 56 | 2,191,608 | 29 | 66 | 1,108,000 | 31.23 | 15 | 71 | 1 | 167 | 
| regex_program | 2 | 177 | 666 | 11,583,256 | 132,682,794 | 177 | 388 | 1 | 50.45 | 16.59 | 5 | 72.10 | 170 | 95 | 170 | 0 | 55 | 2,185,918 | 22 | 59 | 1,108,000 | 31.34 | 15 | 67 | 1 | 170 | 
| regex_program | 3 | 198 | 747 | 11,847,840 | 103,522,954 | 198 | 463 | 0 | 139.22 | 14.49 | 5 | 59.09 | 157 | 96 | 157 | 0 | 53 | 2,420,726 | 34 | 44 | 790,483 | 31.30 | 17 | 154 | 2 | 157 | 

...
| `total_proof_time_ms ` |  3,737.50 |  7,475 |  4,133 |  3,342 |
| `main_cells_used     ` |  83,255,576 |  166,511,152 |  93,500,799 |  73,010,353 |
| `total_cycles        ` |  2,082,613 |  4,165,226 |  2,243,715 |  1,921,511 |
| `execute_time_ms     ` |  336 |  672 |  375 |  297 |
| `trace_gen_time_ms   ` |  997.50 |  1,995 |  1,191 |  804 |
| `stark_prove_excluding_trace_time_ms` |  2,404 |  4,808 |  2,567 |  2,241 |
| `main_trace_commit_time_ms` |  446 |  892 |  498 |  394 |
| `generate_perm_trace_time_ms` |  195.50 |  391 |  210 |  181 |
| `perm_trace_commit_time_ms` |  489 |  978 |  515 |  463 |
| `quotient_poly_compute_time_ms` |  332 |  664 |  355 |  309 |
| `quotient_poly_commit_time_ms` |  235.50 |  471 |  267 |  204 |
| `pcs_opening_time_ms ` |  697.50 |  1,395 |  714 |  681 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  6,561 |  13,122 |  6,613 |  6,509 |
| `main_cells_used     ` |  152,278,445 |  304,556,890 |  154,677,422 |  149,879,468 |
| `total_cycles        ` |  1,991,023 |  3,982,046 |  2,021,777 |  1,960,269 |
| `execute_time_ms     ` |  774.50 |  1,549 |  783 |  766 |
| `trace_gen_time_ms   ` |  1,457 |  2,914 |  1,484 |  1,430 |
| `stark_prove_excluding_trace_time_ms` |  4,329.50 |  8,659 |  4,346 |  4,313 |
| `main_trace_commit_time_ms` |  775.50 |  1,551 |  776 |  775 |
| `generate_perm_trace_time_ms` |  378 |  756 |  397 |  359 |
| `perm_trace_commit_time_ms` |  1,102 |  2,204 |  1,108 |  1,096 |
| `quotient_poly_compute_time_ms` |  658 |  1,316 |  661 |  655 |
| `quotient_poly_commit_time_ms` |  376 |  752 |  376 |  376 |
| `pcs_opening_time_ms ` |  1,033.50 |  2,067 |  1,038 |  1,029 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,484 | 6,613 | 2,021,777 | 538,660,330 | 4,346 | 655 | 376 | 1,108 | 1,029 | 776 | 154,677,422 | 397 | 783 | 
| leaf | 1 | 1,430 | 6,509 | 1,960,269 | 538,660,330 | 4,313 | 661 | 376 | 1,096 | 1,038 | 775 | 149,879,468 | 359 | 766 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,191 | 4,133 | 2,243,715 | 275,652,919 | 2,567 | 355 | 267 | 515 | 714 | 498 | 93,500,799 | 210 | 375 | 
| regex_program | 1 | 804 | 3,342 | 1,921,511 | 242,975,404 | 2,241 | 309 | 204 | 463 | 681 | 394 | 73,010,353 | 181 | 297 | 

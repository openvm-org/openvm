...
| `total_proof_time_ms ` |  4,176.50 |  8,353 |  4,602 |  3,751 |
...
| `trace_gen_time_ms   ` |  970.50 |  1,941 |  1,136 |  805 |
| `stark_prove_excluding_trace_time_ms` |  2,865 |  5,730 |  3,087 |  2,643 |
| `main_trace_commit_time_ms` |  519.50 |  1,039 |  580 |  459 |
| `generate_perm_trace_time_ms` |  192.50 |  385 |  201 |  184 |
| `perm_trace_commit_time_ms` |  750 |  1,500 |  804 |  696 |
| `quotient_poly_compute_time_ms` |  401 |  802 |  434 |  368 |
| `quotient_poly_commit_time_ms` |  302.50 |  605 |  331 |  274 |
| `pcs_opening_time_ms ` |  690.50 |  1,381 |  728 |  653 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,517.50 |  15,035 |  7,598 |  7,437 |
| `main_cells_used     ` |  152,278,183 |  304,556,366 |  154,678,090 |  149,878,276 |
| `total_cycles        ` |  1,991,026.50 |  3,982,053 |  2,021,858 |  1,960,195 |
| `execute_time_ms     ` |  748.50 |  1,497 |  756 |  741 |
| `trace_gen_time_ms   ` |  1,468 |  2,936 |  1,485 |  1,451 |
| `stark_prove_excluding_trace_time_ms` |  5,301 |  10,602 |  5,357 |  5,245 |
| `main_trace_commit_time_ms` |  895 |  1,790 |  896 |  894 |
| `generate_perm_trace_time_ms` |  378.50 |  757 |  395 |  362 |
| `perm_trace_commit_time_ms` |  1,672 |  3,344 |  1,714 |  1,630 |
| `quotient_poly_compute_time_ms` |  770 |  1,540 |  774 |  766 |
| `quotient_poly_commit_time_ms` |  519.50 |  1,039 |  520 |  519 |
| `pcs_opening_time_ms ` |  1,060.50 |  2,121 |  1,065 |  1,056 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,485 | 7,598 | 2,021,858 | 538,660,330 | 5,357 | 774 | 519 | 1,714 | 1,056 | 894 | 154,678,090 | 395 | 756 | 
| leaf | 1 | 1,451 | 7,437 | 1,960,195 | 538,660,330 | 5,245 | 766 | 520 | 1,630 | 1,065 | 896 | 149,878,276 | 362 | 741 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,136 | 4,602 | 2,243,715 | 275,652,919 | 3,087 | 434 | 331 | 804 | 728 | 580 | 94,156,159 | 201 | 379 | 
| regex_program | 1 | 805 | 3,751 | 1,921,511 | 242,975,404 | 2,643 | 368 | 274 | 696 | 653 | 459 | 73,665,713 | 184 | 303 | 

...
| `total_proof_time_ms ` |  1,462 |  2,924 |  1,697 |  1,227 |
...
| `execute_preflight_time_ms` |  96 |  192 |  112 |  80 |
| `execute_preflight_insn_mi/s` |  31.36 | -          |  32.31 |  30.41 |
| `trace_gen_time_ms   ` |  309 |  618 |  328 |  290 |
| `memory_finalize_time_ms` |  2 |  4 |  4 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  969 |  1,938 |  1,199 |  739 |
| `main_trace_commit_time_ms` |  140 |  280 |  182 |  98 |
| `generate_perm_trace_time_ms` |  59 |  118 |  72 |  46 |
| `perm_trace_commit_time_ms` |  170.48 |  340.96 |  221.95 |  119.01 |
| `quotient_poly_compute_time_ms` |  160.68 |  321.35 |  175.36 |  145.99 |
| `quotient_poly_commit_time_ms` |  36.15 |  72.30 |  47.74 |  24.56 |
| `pcs_opening_time_ms ` |  394.50 |  789 |  524 |  265 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  2,067 |  4,134 |  2,855 |  1,279 |
| `main_cells_used     ` |  14,798,849 |  29,597,698 |  20,272,474 |  9,325,224 |
| `total_cells_used    ` |  37,032,585 |  74,065,170 |  50,586,080 |  23,479,090 |
| `execute_preflight_insns` |  1,663,343.50 |  3,326,687 |  1,830,088 |  1,496,599 |
| `execute_preflight_time_ms` |  594 |  1,188 |  929 |  259 |
| `execute_preflight_insn_mi/s` |  7.17 | -          |  7.49 |  6.86 |
| `trace_gen_time_ms   ` |  125.50 |  251 |  175 |  76 |
| `memory_finalize_time_ms` |  11.50 |  23 |  16 |  7 |
| `stark_prove_excluding_trace_time_ms` |  1,347 |  2,694 |  1,750 |  944 |
| `main_trace_commit_time_ms` |  178.50 |  357 |  226 |  131 |
| `generate_perm_trace_time_ms` |  73.50 |  147 |  87 |  60 |
| `perm_trace_commit_time_ms` |  275.51 |  551.02 |  365.32 |  185.70 |
| `quotient_poly_compute_time_ms` |  173.63 |  347.26 |  224.90 |  122.36 |
| `quotient_poly_commit_time_ms` |  42.61 |  85.22 |  55.21 |  30.02 |
| `pcs_opening_time_ms ` |  599 |  1,198 |  787 |  411 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 2,857 |  | 1 |  | 1 |  |  |  |  | 
| regex_program |  | 1,227 |  | 41 | 1 | 42 | 4,108,483 | 97.26 | 168 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 76 | 1,279 | 23,479,090 | 319,626,730 | 75 | 944 | 0 | 122.36 | 30.02 | 5 | 185.70 | 411 | 247 | 411 | 7 | 131 | 9,325,224 | 60 | 259 | 1,496,599 | 7.49 | 29 | 153 | 1 | 411 | 
| leaf | 1 | 175 | 2,855 | 50,586,080 | 538,660,330 | 175 | 1,750 | 0 | 224.90 | 55.21 | 5 | 365.32 | 787 | 453 | 787 | 16 | 226 | 20,272,474 | 87 | 929 | 1,830,088 | 6.86 | 56 | 282 | 1 | 787 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 290 | 1,697 | 23,397,108 | 373,183,036 | 290 | 1,199 | 0 | 145.99 | 47.74 | 6 | 221.95 | 524 | 295 | 524 | 4 | 182 | 10,866,434 | 72 | 80 | 2,211,000 | 30.41 | 46 | 195 | 2 | 524 | 
| regex_program | 1 | 328 | 1,227 | 11,981,356 | 196,739,722 | 328 | 739 | 2 | 175.36 | 24.56 | 6 | 119.01 | 265 | 169 | 265 | 0 | 98 | 2,537,170 | 46 | 112 | 1,897,483 | 32.31 | 25 | 204 | 2 | 265 | 

...
| `total_proof_time_ms ` |  4,084 |  8,168 |  4,537 |  3,631 |
| `main_cells_used     ` |  83,255,576 |  166,511,152 |  93,500,799 |  73,010,353 |
| `total_cycles        ` |  2,082,613 |  4,165,226 |  2,243,715 |  1,921,511 |
| `execute_time_ms     ` |  346 |  692 |  385 |  307 |
| `trace_gen_time_ms   ` |  989.50 |  1,979 |  1,166 |  813 |
| `stark_prove_excluding_trace_time_ms` |  2,748.50 |  5,497 |  2,986 |  2,511 |
| `main_trace_commit_time_ms` |  469 |  938 |  528 |  410 |
| `generate_perm_trace_time_ms` |  200.50 |  401 |  203 |  198 |
| `perm_trace_commit_time_ms` |  693 |  1,386 |  742 |  644 |
| `quotient_poly_compute_time_ms` |  397.50 |  795 |  429 |  366 |
| `quotient_poly_commit_time_ms` |  276 |  552 |  309 |  243 |
| `pcs_opening_time_ms ` |  703.50 |  1,407 |  766 |  641 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,269.50 |  14,539 |  7,333 |  7,206 |
| `main_cells_used     ` |  152,278,159 |  304,556,318 |  154,677,658 |  149,878,660 |
| `total_cycles        ` |  1,991,024.50 |  3,982,049 |  2,021,822 |  1,960,227 |
| `execute_time_ms     ` |  775 |  1,550 |  782 |  768 |
| `trace_gen_time_ms   ` |  1,475.50 |  2,951 |  1,499 |  1,452 |
| `stark_prove_excluding_trace_time_ms` |  5,019 |  10,038 |  5,052 |  4,986 |
| `main_trace_commit_time_ms` |  807 |  1,614 |  808 |  806 |
| `generate_perm_trace_time_ms` |  363.50 |  727 |  366 |  361 |
| `perm_trace_commit_time_ms` |  1,540.50 |  3,081 |  1,574 |  1,507 |
| `quotient_poly_compute_time_ms` |  769.50 |  1,539 |  776 |  763 |
| `quotient_poly_commit_time_ms` |  488.50 |  977 |  490 |  487 |
| `pcs_opening_time_ms ` |  1,046 |  2,092 |  1,053 |  1,039 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,499 | 7,333 | 2,021,822 | 538,660,330 | 5,052 | 776 | 490 | 1,574 | 1,039 | 808 | 154,677,658 | 361 | 782 | 
| leaf | 1 | 1,452 | 7,206 | 1,960,227 | 538,660,330 | 4,986 | 763 | 487 | 1,507 | 1,053 | 806 | 149,878,660 | 366 | 768 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,166 | 4,537 | 2,243,715 | 275,652,919 | 2,986 | 429 | 309 | 742 | 766 | 528 | 93,500,799 | 203 | 385 | 
| regex_program | 1 | 813 | 3,631 | 1,921,511 | 242,975,404 | 2,511 | 366 | 243 | 644 | 641 | 410 | 73,010,353 | 198 | 307 | 

...
| `total_proof_time_ms ` |  3,925 |  7,850 |  4,342 |  3,508 |
...
| `trace_gen_time_ms   ` |  983.50 |  1,967 |  1,174 |  793 |
| `stark_prove_excluding_trace_time_ms` |  2,588 |  5,176 |  2,776 |  2,400 |
| `main_trace_commit_time_ms` |  503.50 |  1,007 |  555 |  452 |
| `generate_perm_trace_time_ms` |  222.50 |  445 |  236 |  209 |
| `perm_trace_commit_time_ms` |  545.50 |  1,091 |  573 |  518 |
| `quotient_poly_compute_time_ms` |  261.50 |  523 |  280 |  243 |
| `quotient_poly_commit_time_ms` |  242.50 |  485 |  278 |  207 |
| `pcs_opening_time_ms ` |  803.50 |  1,607 |  846 |  761 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  6,978 |  13,956 |  7,018 |  6,938 |
| `main_cells_used     ` |  151,828,247 |  303,656,494 |  154,227,878 |  149,428,616 |
| `total_cycles        ` |  1,975,760.50 |  3,951,521 |  2,006,569 |  1,944,952 |
| `execute_time_ms     ` |  787 |  1,574 |  793 |  781 |
| `trace_gen_time_ms   ` |  1,469.50 |  2,939 |  1,471 |  1,468 |
| `stark_prove_excluding_trace_time_ms` |  4,721.50 |  9,443 |  4,754 |  4,689 |
| `main_trace_commit_time_ms` |  865 |  1,730 |  865 |  865 |
| `generate_perm_trace_time_ms` |  397.50 |  795 |  418 |  377 |
| `perm_trace_commit_time_ms` |  1,241.50 |  2,483 |  1,245 |  1,238 |
| `quotient_poly_compute_time_ms` |  524.50 |  1,049 |  528 |  521 |
| `quotient_poly_commit_time_ms` |  409 |  818 |  411 |  407 |
| `pcs_opening_time_ms ` |  1,278.50 |  2,557 |  1,282 |  1,275 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,471 | 7,018 | 2,006,569 | 538,660,330 | 4,754 | 528 | 411 | 1,245 | 1,282 | 865 | 154,227,878 | 418 | 793 | 
| leaf | 1 | 1,468 | 6,938 | 1,944,952 | 538,660,330 | 4,689 | 521 | 407 | 1,238 | 1,275 | 865 | 149,428,616 | 377 | 781 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,174 | 4,342 | 2,243,715 | 275,652,919 | 2,776 | 280 | 278 | 573 | 846 | 555 | 93,500,799 | 236 | 392 | 
| regex_program | 1 | 793 | 3,508 | 1,921,511 | 242,975,404 | 2,400 | 243 | 207 | 518 | 761 | 452 | 73,010,353 | 209 | 315 | 

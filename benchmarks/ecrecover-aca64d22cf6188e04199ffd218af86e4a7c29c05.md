...
| `stark_prove_excluding_trace_time_ms` |  1,150 |  1,150 |  1,150 |  1,150 |
| `main_trace_commit_time_ms` |  184 |  184 |  184 |  184 |
| `generate_perm_trace_time_ms` |  32 |  32 |  32 |  32 |
| `perm_trace_commit_time_ms` |  210 |  210 |  210 |  210 |
| `quotient_poly_compute_time_ms` |  125 |  125 |  125 |  125 |
| `quotient_poly_commit_time_ms` |  168 |  168 |  168 |  168 |
| `pcs_opening_time_ms ` |  415 |  415 |  415 |  415 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  13,113 |  13,113 |  13,113 |  13,113 |
| `main_cells_used     ` |  244,104,965 |  244,104,965 |  244,104,965 |  244,104,965 |
| `total_cycles        ` |  2,988,906 |  2,988,906 |  2,988,906 |  2,988,906 |
| `execute_time_ms     ` |  1,088 |  1,088 |  1,088 |  1,088 |
| `trace_gen_time_ms   ` |  2,398 |  2,398 |  2,398 |  2,398 |
| `stark_prove_excluding_trace_time_ms` |  9,627 |  9,627 |  9,627 |  9,627 |
| `main_trace_commit_time_ms` |  1,726 |  1,726 |  1,726 |  1,726 |
| `generate_perm_trace_time_ms` |  702 |  702 |  702 |  702 |
| `perm_trace_commit_time_ms` |  3,142 |  3,142 |  3,142 |  3,142 |
| `quotient_poly_compute_time_ms` |  1,352 |  1,352 |  1,352 |  1,352 |
| `quotient_poly_commit_time_ms` |  884 |  884 |  884 |  884 |
| `pcs_opening_time_ms ` |  1,816 |  1,816 |  1,816 |  1,816 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 2,398 | 13,113 | 2,988,906 | 999,394,794 | 9,627 | 1,352 | 884 | 3,142 | 1,816 | 1,726 | 244,104,965 | 702 | 1,088 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 183 | 1,483 | 295,291 | 48,197,161 | 1,150 | 125 | 168 | 210 | 415 | 184 | 15,588,656 | 32 | 150 | 

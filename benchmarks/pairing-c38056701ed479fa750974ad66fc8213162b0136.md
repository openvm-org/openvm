...
| `total_proof_time_ms ` |  706.50 |  1,413 |  811 |  602 |
...
| `execute_preflight_time_ms` |  82.50 |  165 |  107 |  58 |
| `execute_preflight_insn_mi/s` |  14.90 | -          |  18.69 |  11.11 |
| `trace_gen_time_ms   ` |  187 |  374 |  194 |  180 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  344.50 |  689 |  381 |  308 |
| `main_trace_commit_time_ms` |  64.50 |  129 |  75 |  54 |
| `generate_perm_trace_time_ms` |  43.50 |  87 |  47 |  40 |
| `perm_trace_commit_time_ms` |  76.60 |  153.19 |  88.22 |  64.97 |
| `quotient_poly_compute_time_ms` |  77.93 |  155.87 |  86.17 |  69.70 |
| `quotient_poly_commit_time_ms` |  16.52 |  33.04 |  18.81 |  14.23 |
| `pcs_opening_time_ms ` |  60.50 |  121 |  68 |  53 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,462.50 |  2,925 |  1,749 |  1,176 |
| `main_cells_used     ` |  16,200,472 |  32,400,944 |  16,332,746 |  16,068,198 |
| `total_cells_used    ` |  39,332,920 |  78,665,840 |  39,650,868 |  39,014,972 |
| `execute_preflight_insns` |  1,952,380.50 |  3,904,761 |  1,991,880 |  1,912,881 |
| `execute_preflight_time_ms` |  592.50 |  1,185 |  888 |  297 |
| `execute_preflight_insn_mi/s` |  7.61 | -          |  7.62 |  7.59 |
| `trace_gen_time_ms   ` |  119.50 |  239 |  127 |  112 |
| `memory_finalize_time_ms` |  11 |  22 |  11 |  11 |
| `stark_prove_excluding_trace_time_ms` |  748.50 |  1,497 |  751 |  746 |
| `main_trace_commit_time_ms` |  145 |  290 |  148 |  142 |
| `generate_perm_trace_time_ms` |  55 |  110 |  55 |  55 |
| `perm_trace_commit_time_ms` |  225.87 |  451.74 |  230.25 |  221.49 |
| `quotient_poly_compute_time_ms` |  166.40 |  332.80 |  168.63 |  164.17 |
| `quotient_poly_commit_time_ms` |  30.61 |  61.22 |  31.65 |  29.58 |
| `pcs_opening_time_ms ` |  122.50 |  245 |  131 |  114 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 1,750 |  | 1 | 1 |  |  |  |  | 
| pairing |  | 602 |  | 1 | 67 | 1,745,742 | 25.71 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 127 | 1,176 | 39,650,868 | 410,701,290 | 127 | 751 | 0 | 168.63 | 31.65 | 4 | 230.25 | 114 | 286 | 114 | 11 | 148 | 16,332,746 | 55 | 297 | 1,991,880 | 7.59 | 39 | 201 | 0 | 114 | 
| leaf | 1 | 112 | 1,749 | 39,014,972 | 396,840,426 | 112 | 746 | 0 | 164.17 | 29.58 | 4 | 221.49 | 131 | 277 | 131 | 11 | 142 | 16,068,198 | 55 | 888 | 1,912,881 | 7.62 | 37 | 195 | 0 | 131 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 180 | 811 | 32,689,110 | 172,558,444 | 180 | 381 | 0 | 86.17 | 18.81 | 6 | 88.22 | 68 | 131 | 68 | 1 | 75 | 16,059,916 | 40 | 107 | 1,157,000 | 11.11 | 26 | 105 | 1 | 68 | 
| pairing | 1 | 194 | 602 | 22,314,288 | 119,958,502 | 194 | 308 | 1 | 69.70 | 14.23 | 6 | 64.97 | 53 | 116 | 53 | 0 | 54 | 9,408,294 | 47 | 58 | 588,742 | 18.69 | 20 | 84 | 1 | 53 | 

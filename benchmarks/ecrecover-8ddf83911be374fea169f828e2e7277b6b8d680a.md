...
| `stark_prove_excluding_trace_time_ms` |  2,155 |  2,155 |  2,155 |  2,155 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  18,471 |  18,471 |  18,471 |  18,471 |
...
| `trace_gen_time_ms   ` |  3,596 |  3,596 |  3,596 |  3,596 |
| `stark_prove_excluding_trace_time_ms` |  13,944 |  13,944 |  13,944 |  13,944 |
| `main_trace_commit_time_ms` |  2,913 |  2,913 |  2,913 |  2,913 |
| `generate_perm_trace_time_ms` |  352 |  352 |  352 |  352 |
| `perm_trace_commit_time_ms` |  2,893 |  2,893 |  2,893 |  2,893 |
| `quotient_poly_compute_time_ms` |  2,075 |  2,075 |  2,075 |  2,075 |
| `quotient_poly_commit_time_ms` |  2,634 |  2,634 |  2,634 |  2,634 |
| `pcs_opening_time_ms ` |  3,073 |  3,073 |  3,073 |  3,073 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 3,596 | 18,471 | 4,157,985 | 466,306,008 | 13,944 | 2,075 | 2,634 | 2,893 | 3,073 | 2,913 | 193,315,937 | 352 | 931 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 256 | 2,561 | 284,567 | 38,417,467 | 2,155 | 229 | 473 | 353 | 663 | 391 | 15,055,723 | 33 | 150 | 

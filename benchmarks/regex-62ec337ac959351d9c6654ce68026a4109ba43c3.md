...
| `total_proof_time_ms ` |  3,849.50 |  7,699 |  4,430 |  3,269 |
...
| `trace_gen_time_ms   ` |  955.50 |  1,911 |  1,116 |  795 |
| `stark_prove_excluding_trace_time_ms` |  2,559.50 |  5,119 |  2,943 |  2,176 |
| `main_trace_commit_time_ms` |  448 |  896 |  526 |  370 |
| `generate_perm_trace_time_ms` |  165.50 |  331 |  196 |  135 |
| `perm_trace_commit_time_ms` |  642.50 |  1,285 |  750 |  535 |
| `quotient_poly_compute_time_ms` |  361 |  722 |  422 |  300 |
| `quotient_poly_commit_time_ms` |  272.50 |  545 |  319 |  226 |
| `pcs_opening_time_ms ` |  660.50 |  1,321 |  720 |  601 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,459.50 |  14,919 |  7,480 |  7,439 |
| `main_cells_used     ` |  152,306,437.50 |  304,612,875 |  154,765,939 |  149,846,936 |
| `total_cycles        ` |  1,993,364 |  3,986,728 |  2,024,256 |  1,962,472 |
| `execute_time_ms     ` |  763.50 |  1,527 |  772 |  755 |
| `trace_gen_time_ms   ` |  1,470.50 |  2,941 |  1,476 |  1,465 |
| `stark_prove_excluding_trace_time_ms` |  5,225.50 |  10,451 |  5,243 |  5,208 |
| `main_trace_commit_time_ms` |  892 |  1,784 |  894 |  890 |
| `generate_perm_trace_time_ms` |  343.50 |  687 |  344 |  343 |
| `perm_trace_commit_time_ms` |  1,646.50 |  3,293 |  1,665 |  1,628 |
| `quotient_poly_compute_time_ms` |  758 |  1,516 |  762 |  754 |
| `quotient_poly_commit_time_ms` |  521 |  1,042 |  521 |  521 |
| `pcs_opening_time_ms ` |  1,058.50 |  2,117 |  1,063 |  1,054 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,465 | 7,480 | 2,024,256 | 533,941,738 | 5,243 | 754 | 521 | 1,665 | 1,063 | 890 | 154,765,939 | 343 | 772 | 
| leaf | 1 | 1,476 | 7,439 | 1,962,472 | 533,941,738 | 5,208 | 762 | 521 | 1,628 | 1,054 | 894 | 149,846,936 | 344 | 755 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,116 | 4,430 | 2,225,434 | 275,652,919 | 2,943 | 422 | 319 | 750 | 720 | 526 | 93,699,990 | 196 | 371 | 
| regex_program | 1 | 795 | 3,269 | 1,914,730 | 198,099,628 | 2,176 | 300 | 226 | 535 | 601 | 370 | 73,689,460 | 135 | 298 | 

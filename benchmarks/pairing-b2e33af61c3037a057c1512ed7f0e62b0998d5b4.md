...
| `total_proof_time_ms ` |  711 |  1,422 |  827 |  595 |
...
| `execute_preflight_time_ms` |  84.50 |  169 |  110 |  59 |
| `execute_preflight_insn_mi/s` |  14.72 | -          |  18.53 |  10.92 |
| `trace_gen_time_ms   ` |  187.50 |  375 |  193 |  182 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  343.50 |  687 |  388 |  299 |
| `main_trace_commit_time_ms` |  64.50 |  129 |  74 |  55 |
| `generate_perm_trace_time_ms` |  38 |  76 |  41 |  35 |
| `perm_trace_commit_time_ms` |  74.17 |  148.35 |  83.45 |  64.90 |
| `quotient_poly_compute_time_ms` |  78.09 |  156.18 |  85.55 |  70.62 |
| `quotient_poly_commit_time_ms` |  16.90 |  33.80 |  19.07 |  14.73 |
| `pcs_opening_time_ms ` |  66.50 |  133 |  80 |  53 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,488 |  2,976 |  1,775 |  1,201 |
...
| `execute_preflight_time_ms` |  620.50 |  1,241 |  931 |  310 |
| `execute_preflight_insn_mi/s` |  7.38 | -          |  7.46 |  7.30 |
| `trace_gen_time_ms   ` |  119 |  238 |  128 |  110 |
| `memory_finalize_time_ms` |  12 |  24 |  13 |  11 |
| `stark_prove_excluding_trace_time_ms` |  747 |  1,494 |  761 |  733 |
| `main_trace_commit_time_ms` |  146 |  292 |  149 |  143 |
| `generate_perm_trace_time_ms` |  60.50 |  121 |  62 |  59 |
| `perm_trace_commit_time_ms` |  226.43 |  452.87 |  230.44 |  222.43 |
| `quotient_poly_compute_time_ms` |  166.15 |  332.30 |  167.66 |  164.64 |
| `quotient_poly_commit_time_ms` |  31.04 |  62.07 |  33.21 |  28.87 |
| `pcs_opening_time_ms ` |  113.50 |  227 |  118 |  109 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 1,777 |  | 1 | 1 |  |  |  |  | 
| pairing |  | 595 |  | 1 | 68 | 1,745,742 | 25.64 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 128 | 1,201 | 39,650,868 | 410,701,290 | 128 | 761 | 0 | 167.66 | 33.21 | 4 | 230.44 | 118 | 290 | 117 | 13 | 149 | 16,332,746 | 59 | 310 | 1,991,982 | 7.30 | 39 | 202 | 0 | 117 | 
| leaf | 1 | 110 | 1,775 | 39,014,972 | 396,840,426 | 110 | 733 | 0 | 164.64 | 28.87 | 4 | 222.43 | 109 | 285 | 109 | 11 | 143 | 16,068,198 | 62 | 931 | 1,912,900 | 7.46 | 38 | 194 | 0 | 109 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 182 | 827 | 32,689,110 | 172,558,444 | 182 | 388 | 0 | 85.55 | 19.07 | 6 | 83.45 | 80 | 127 | 80 | 1 | 74 | 16,059,916 | 41 | 110 | 1,157,000 | 10.92 | 26 | 105 | 1 | 80 | 
| pairing | 1 | 193 | 595 | 22,314,288 | 119,958,502 | 193 | 299 | 1 | 70.62 | 14.73 | 6 | 64.90 | 53 | 103 | 53 | 0 | 55 | 9,408,294 | 35 | 59 | 588,742 | 18.53 | 21 | 85 | 1 | 53 | 

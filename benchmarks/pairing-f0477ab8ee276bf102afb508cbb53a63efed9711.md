...
| `total_proof_time_ms ` |  4,581 |  4,581 |  4,581 |  4,581 |
...
| `trace_gen_time_ms   ` |  979 |  979 |  979 |  979 |
| `stark_prove_excluding_trace_time_ms` |  2,951 |  2,951 |  2,951 |  2,951 |
...
| `pcs_opening_time_ms ` |  773 |  773 |  773 |  773 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  12,820 |  12,820 |  12,820 |  12,820 |
| `main_cells_used     ` |  273,857,986 |  273,857,986 |  273,857,986 |  273,857,986 |
| `total_cycles        ` |  3,267,469 |  3,267,469 |  3,267,469 |  3,267,469 |
| `execute_time_ms     ` |  1,224 |  1,224 |  1,224 |  1,224 |
| `trace_gen_time_ms   ` |  2,555 |  2,555 |  2,555 |  2,555 |
| `stark_prove_excluding_trace_time_ms` |  9,041 |  9,041 |  9,041 |  9,041 |
| `main_trace_commit_time_ms` |  1,707 |  1,707 |  1,707 |  1,707 |
| `generate_perm_trace_time_ms` |  794 |  794 |  794 |  794 |
| `perm_trace_commit_time_ms` |  2,476 |  2,476 |  2,476 |  2,476 |
| `quotient_poly_compute_time_ms` |  1,326 |  1,326 |  1,326 |  1,326 |
| `quotient_poly_commit_time_ms` |  754 |  754 |  754 |  754 |
| `pcs_opening_time_ms ` |  1,979 |  1,979 |  1,979 |  1,979 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 2,555 | 12,820 | 3,267,469 | 1,081,183,722 | 9,041 | 1,326 | 754 | 2,476 | 1,979 | 1,707 | 273,857,986 | 794 | 1,224 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 979 | 4,581 | 1,820,436 | 297,675,351 | 2,951 | 409 | 302 | 633 | 773 | 624 | 95,832,407 | 195 | 651 | 

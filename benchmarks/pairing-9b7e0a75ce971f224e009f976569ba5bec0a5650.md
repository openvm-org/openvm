...
| `total_proof_time_ms ` |  884.50 |  1,769 |  1,011 |  758 |
...
| `execute_preflight_time_ms` |  99 |  198 |  126 |  72 |
| `execute_preflight_insn_mi/s` |  14.01 | -          |  18.70 |  9.33 |
| `trace_gen_time_ms   ` |  193.50 |  387 |  207 |  180 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  497.50 |  995 |  558 |  437 |
| `main_trace_commit_time_ms` |  69 |  138 |  75 |  63 |
| `generate_perm_trace_time_ms` |  50 |  100 |  59 |  41 |
| `perm_trace_commit_time_ms` |  82.52 |  165.04 |  91.86 |  73.19 |
| `quotient_poly_compute_time_ms` |  94.40 |  188.79 |  99.71 |  89.08 |
| `quotient_poly_commit_time_ms` |  18.17 |  36.34 |  19.35 |  16.99 |
| `pcs_opening_time_ms ` |  178 |  356 |  208 |  148 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,913 |  3,826 |  2,170 |  1,656 |
| `main_cells_used     ` |  16,200,472 |  32,400,944 |  16,332,746 |  16,068,198 |
| `total_cells_used    ` |  39,332,920 |  78,665,840 |  39,650,868 |  39,014,972 |
| `execute_preflight_insns` |  1,952,447.50 |  3,904,895 |  1,991,905 |  1,912,990 |
| `execute_preflight_time_ms` |  589 |  1,178 |  879 |  299 |
| `execute_preflight_insn_mi/s` |  7.50 | -          |  7.53 |  7.47 |
| `trace_gen_time_ms   ` |  117.50 |  235 |  124 |  111 |
| `memory_finalize_time_ms` |  12 |  24 |  13 |  11 |
| `stark_prove_excluding_trace_time_ms` |  1,205 |  2,410 |  1,231 |  1,179 |
| `main_trace_commit_time_ms` |  157.50 |  315 |  161 |  154 |
| `generate_perm_trace_time_ms` |  62.50 |  125 |  70 |  55 |
| `perm_trace_commit_time_ms` |  241.64 |  483.28 |  245.73 |  237.56 |
| `quotient_poly_compute_time_ms` |  164.46 |  328.92 |  165.20 |  163.72 |
| `quotient_poly_commit_time_ms` |  37.67 |  75.34 |  39.09 |  36.25 |
| `pcs_opening_time_ms ` |  538.50 |  1,077 |  547 |  530 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 2,172 |  | 1 |  | 1 |  |  |  |  | 
| pairing |  | 758 |  | 40 | 1 | 91 | 1,882,939 | 20.48 | 147 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 124 | 1,656 | 39,650,868 | 410,701,290 | 124 | 1,231 | 0 | 165.20 | 39.09 | 4 | 245.73 | 547 | 317 | 547 | 13 | 161 | 16,332,746 | 70 | 299 | 1,991,905 | 7.53 | 38 | 205 | 1 | 547 | 
| leaf | 1 | 111 | 2,170 | 39,014,972 | 396,840,426 | 111 | 1,179 | 0 | 163.72 | 36.25 | 4 | 237.56 | 530 | 293 | 530 | 11 | 154 | 16,068,198 | 55 | 879 | 1,912,990 | 7.47 | 36 | 201 | 1 | 530 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 180 | 1,011 | 31,041,944 | 160,949,612 | 180 | 558 | 0 | 99.71 | 19.35 | 6 | 91.86 | 208 | 154 | 208 | 1 | 75 | 15,014,446 | 59 | 126 | 1,143,000 | 9.33 | 23 | 119 | 3 | 208 | 
| pairing | 1 | 207 | 758 | 24,485,078 | 124,079,782 | 207 | 437 | 1 | 89.08 | 16.99 | 6 | 73.19 | 148 | 118 | 148 | 0 | 63 | 10,833,316 | 41 | 72 | 739,939 | 18.70 | 19 | 106 | 2 | 148 | 

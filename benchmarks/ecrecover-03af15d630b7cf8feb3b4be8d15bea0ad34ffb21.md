...
| `total_proof_time_ms ` |  2,635 |  2,635 |  2,635 |  2,635 |
...
| `stark_prove_excluding_trace_time_ms` |  2,217 |  2,217 |  2,217 |  2,217 |
...
| `quotient_poly_compute_time_ms` |  299 |  299 |  299 |  299 |
| `quotient_poly_commit_time_ms` |  312 |  312 |  312 |  312 |
| `pcs_opening_time_ms ` |  641 |  641 |  641 |  641 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  42,039 |  42,039 |  42,039 |  42,039 |
| `main_cells_used     ` |  365,889,016 |  365,889,016 |  365,889,016 |  365,889,016 |
| `total_cycles        ` |  8,653,210 |  8,653,210 |  8,653,210 |  8,653,210 |
| `execute_time_ms     ` |  2,478 |  2,478 |  2,478 |  2,478 |
| `trace_gen_time_ms   ` |  6,559 |  6,559 |  6,559 |  6,559 |
| `stark_prove_excluding_trace_time_ms` |  33,002 |  33,002 |  33,002 |  33,002 |
| `main_trace_commit_time_ms` |  5,758 |  5,758 |  5,758 |  5,758 |
| `generate_perm_trace_time_ms` |  719 |  719 |  719 |  719 |
| `perm_trace_commit_time_ms` |  7,173 |  7,173 |  7,173 |  7,173 |
| `quotient_poly_compute_time_ms` |  7,908 |  7,908 |  7,908 |  7,908 |
| `quotient_poly_commit_time_ms` |  5,102 |  5,102 |  5,102 |  5,102 |
| `pcs_opening_time_ms ` |  6,340 |  6,340 |  6,340 |  6,340 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 6,559 | 42,039 | 8,653,210 | 1,052,183,000 | 33,002 | 7,908 | 5,102 | 7,173 | 6,340 | 5,758 | 365,889,016 | 719 | 2,478 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 266 | 2,635 | 285,401 | 56,172,159 | 2,217 | 299 | 312 | 526 | 641 | 395 | 15,092,297 | 39 | 152 | 

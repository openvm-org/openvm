...
| `total_proof_time_ms ` |  4,035.50 |  8,071 |  4,474 |  3,597 |
| `main_cells_used     ` |  83,255,576 |  166,511,152 |  93,500,799 |  73,010,353 |
| `total_cycles        ` |  2,082,613 |  4,165,226 |  2,243,715 |  1,921,511 |
| `execute_time_ms     ` |  341.50 |  683 |  380 |  303 |
| `trace_gen_time_ms   ` |  973.50 |  1,947 |  1,139 |  808 |
| `stark_prove_excluding_trace_time_ms` |  2,720.50 |  5,441 |  2,955 |  2,486 |
| `main_trace_commit_time_ms` |  470.50 |  941 |  529 |  412 |
| `generate_perm_trace_time_ms` |  192.50 |  385 |  206 |  179 |
| `perm_trace_commit_time_ms` |  689 |  1,378 |  749 |  629 |
| `quotient_poly_compute_time_ms` |  394 |  788 |  424 |  364 |
| `quotient_poly_commit_time_ms` |  277 |  554 |  314 |  240 |
| `pcs_opening_time_ms ` |  688 |  1,376 |  723 |  653 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,300 |  14,600 |  7,326 |  7,274 |
| `main_cells_used     ` |  152,277,625 |  304,555,250 |  154,676,902 |  149,878,348 |
| `total_cycles        ` |  1,990,980 |  3,981,960 |  2,021,759 |  1,960,201 |
| `execute_time_ms     ` |  772 |  1,544 |  778 |  766 |
| `trace_gen_time_ms   ` |  1,476 |  2,952 |  1,486 |  1,466 |
| `stark_prove_excluding_trace_time_ms` |  5,052 |  10,104 |  5,082 |  5,022 |
| `main_trace_commit_time_ms` |  810.50 |  1,621 |  815 |  806 |
| `generate_perm_trace_time_ms` |  371 |  742 |  382 |  360 |
...
| `pcs_opening_time_ms ` |  1,047.50 |  2,095 |  1,050 |  1,045 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,466 | 7,326 | 2,021,759 | 538,660,330 | 5,082 | 770 | 492 | 1,573 | 1,045 | 815 | 154,676,902 | 382 | 778 | 
| leaf | 1 | 1,486 | 7,274 | 1,960,201 | 538,660,330 | 5,022 | 766 | 492 | 1,541 | 1,050 | 806 | 149,878,348 | 360 | 766 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,139 | 4,474 | 2,243,715 | 275,652,919 | 2,955 | 424 | 314 | 749 | 723 | 529 | 93,500,799 | 206 | 380 | 
| regex_program | 1 | 808 | 3,597 | 1,921,511 | 242,975,404 | 2,486 | 364 | 240 | 629 | 653 | 412 | 73,010,353 | 179 | 303 | 

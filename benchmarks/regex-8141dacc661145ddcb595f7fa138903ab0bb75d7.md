...
| `total_proof_time_ms ` |  572 |  2,288 |  693 |  516 |
...
| `execute_metered_insn_mi/s` |  112.46 | -          |  112.46 |  112.46 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  54.25 |  217 |  65 |  45 |
| `execute_preflight_insn_mi/s` |  30.09 | -          |  31.37 |  26.65 |
| `trace_gen_time_ms   ` |  175.50 |  702 |  207 |  154 |
| `memory_finalize_time_ms` |  1 |  4 |  4 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  274 |  1,096 |  292 |  254 |
| `main_trace_commit_time_ms` |  51 |  204 |  55 |  49 |
| `generate_perm_trace_time_ms` |  23.50 |  94 |  26 |  20 |
| `perm_trace_commit_time_ms` |  64.05 |  256.19 |  71.82 |  53.95 |
| `quotient_poly_compute_time_ms` |  57.48 |  229.92 |  68.01 |  51.91 |
| `quotient_poly_commit_time_ms` |  14.66 |  58.63 |  16.58 |  12.61 |
| `pcs_opening_time_ms ` |  60.25 |  241 |  80 |  49 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,354.75 |  5,419 |  1,984 |  909 |
...
| `execute_preflight_insns` |  1,440,815.50 |  5,763,262 |  1,814,589 |  1,241,332 |
| `execute_preflight_time_ms` |  612.25 |  2,449 |  795 |  226 |
| `execute_preflight_insn_mi/s` |  7.01 | -          |  7.37 |  6.77 |
| `trace_gen_time_ms   ` |  88.50 |  354 |  171 |  57 |
| `memory_finalize_time_ms` |  8.25 |  33 |  16 |  5 |
| `stark_prove_excluding_trace_time_ms` |  652.50 |  2,610 |  1,045 |  476 |
| `main_trace_commit_time_ms` |  124.25 |  497 |  194 |  91 |
| `generate_perm_trace_time_ms` |  47.50 |  190 |  72 |  36 |
| `perm_trace_commit_time_ms` |  199.24 |  796.94 |  341.94 |  141.16 |
| `quotient_poly_compute_time_ms` |  140.14 |  560.58 |  228.91 |  100.16 |
| `quotient_poly_commit_time_ms` |  30.05 |  120.19 |  48.80 |  22.78 |
| `pcs_opening_time_ms ` |  107.25 |  429 |  154 |  76 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 1,986 |  | 1 |  | 1 |  |  |  |  | 
| regex_program |  | 529 |  | 41 | 1 | 36 | 4,137,502 | 112.46 | 167 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 69 | 909 | 22,981,570 | 319,331,818 | 69 | 613 | 0 | 131.04 | 24.97 | 4 | 171.17 | 120 | 214 | 119 | 6 | 120 | 9,122,488 | 42 | 226 | 1,465,976 | 7.37 | 30 | 157 | 0 | 119 | 
| leaf | 1 | 57 | 1,330 | 20,905,034 | 255,237,610 | 57 | 476 | 0 | 100.16 | 22.78 | 4 | 142.68 | 76 | 184 | 76 | 5 | 91 | 8,256,948 | 40 | 795 | 1,241,332 | 6.87 | 25 | 123 | 0 | 76 | 
| leaf | 2 | 57 | 1,196 | 20,905,034 | 255,237,610 | 57 | 476 | 0 | 100.46 | 23.64 | 4 | 141.16 | 79 | 178 | 79 | 6 | 92 | 8,256,948 | 36 | 662 | 1,241,365 | 7.04 | 25 | 125 | 0 | 79 | 
| leaf | 3 | 171 | 1,984 | 50,337,320 | 538,365,418 | 171 | 1,045 | 0 | 228.91 | 48.80 | 4 | 341.94 | 154 | 414 | 154 | 16 | 194 | 20,171,106 | 72 | 766 | 1,814,589 | 6.77 | 61 | 281 | 5 | 154 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 207 | 693 | 23,446,148 | 150,778,428 | 207 | 292 | 0 | 57.90 | 16.58 | 5 | 71.82 | 63 | 97 | 63 | 4 | 55 | 10,899,170 | 24 | 48 | 1,103,000 | 26.65 | 21 | 75 | 1 | 63 | 
| regex_program | 1 | 154 | 550 | 11,598,276 | 128,513,066 | 154 | 289 | 1 | 52.10 | 14.20 | 4 | 63.84 | 80 | 90 | 80 | 0 | 51 | 2,196,106 | 26 | 65 | 1,104,000 | 31.28 | 16 | 66 | 0 | 80 | 
| regex_program | 2 | 160 | 516 | 11,579,064 | 128,513,066 | 160 | 254 | 1 | 51.91 | 15.24 | 4 | 66.59 | 49 | 87 | 49 | 0 | 49 | 2,177,334 | 20 | 59 | 1,104,000 | 31.07 | 16 | 67 | 0 | 49 | 
| regex_program | 3 | 181 | 529 | 11,853,872 | 103,456,394 | 181 | 261 | 0 | 68.01 | 12.61 | 5 | 53.95 | 49 | 80 | 49 | 0 | 49 | 2,422,606 | 24 | 45 | 826,502 | 31.37 | 18 | 81 | 1 | 49 | 

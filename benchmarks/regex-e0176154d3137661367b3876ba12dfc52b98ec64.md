...
| `total_proof_time_ms ` |  587.75 |  2,351 |  709 |  525 |
...
| `execute_preflight_time_ms` |  52 |  208 |  63 |  43 |
| `execute_preflight_insn_mi/s` |  32.34 | -          |  33.79 |  29.17 |
| `trace_gen_time_ms   ` |  180.50 |  722 |  213 |  158 |
| `memory_finalize_time_ms` |  0.75 |  3 |  3 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  287.75 |  1,151 |  306 |  263 |
| `main_trace_commit_time_ms` |  51.50 |  206 |  56 |  49 |
| `generate_perm_trace_time_ms` |  32 |  128 |  49 |  23 |
| `perm_trace_commit_time_ms` |  64.65 |  258.59 |  71.57 |  55.60 |
| `quotient_poly_compute_time_ms` |  58.16 |  232.66 |  69.57 |  51.45 |
| `quotient_poly_commit_time_ms` |  15.20 |  60.78 |  17.44 |  13.09 |
| `pcs_opening_time_ms ` |  63.25 |  253 |  73 |  53 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,376.75 |  5,507 |  2,042 |  883 |
...
| `execute_preflight_insns` |  1,440,856.50 |  5,763,426 |  1,814,591 |  1,241,387 |
| `execute_preflight_time_ms` |  607.75 |  2,431 |  794 |  221 |
| `execute_preflight_insn_mi/s` |  7.31 | -          |  7.64 |  6.99 |
| `trace_gen_time_ms   ` |  85.50 |  342 |  159 |  57 |
| `memory_finalize_time_ms` |  8 |  32 |  15 |  5 |
| `stark_prove_excluding_trace_time_ms` |  682.25 |  2,729 |  1,121 |  471 |
| `main_trace_commit_time_ms` |  124.75 |  499 |  194 |  91 |
| `generate_perm_trace_time_ms` |  61.75 |  247 |  89 |  34 |
| `perm_trace_commit_time_ms` |  210.38 |  841.54 |  384.51 |  142.58 |
| `quotient_poly_compute_time_ms` |  142.06 |  568.25 |  234.69 |  100.70 |
| `quotient_poly_commit_time_ms` |  31.81 |  127.23 |  55.38 |  22.70 |
| `pcs_opening_time_ms ` |  107.50 |  430 |  156 |  76 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 2,043 |  | 1 | 1 |  |  |  |  | 
| regex_program |  | 554 |  | 1 | 36 | 4,137,502 | 113.63 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 68 | 883 | 22,981,570 | 319,331,818 | 68 | 593 | 0 | 131.97 | 26.15 | 4 | 171.39 | 97 | 213 | 96 | 7 | 123 | 9,122,488 | 41 | 221 | 1,466,043 | 7.64 | 30 | 159 | 0 | 96 | 
| leaf | 1 | 58 | 1,324 | 20,905,034 | 255,237,610 | 58 | 471 | 0 | 100.89 | 22.70 | 4 | 143.05 | 76 | 178 | 76 | 5 | 91 | 8,256,948 | 34 | 794 | 1,241,387 | 7.34 | 25 | 124 | 0 | 76 | 
| leaf | 2 | 57 | 1,258 | 20,905,034 | 255,237,610 | 57 | 544 | 0 | 100.70 | 22.99 | 4 | 142.58 | 101 | 227 | 100 | 5 | 91 | 8,256,948 | 83 | 655 | 1,241,405 | 7.28 | 25 | 124 | 0 | 100 | 
| leaf | 3 | 159 | 2,042 | 50,337,320 | 538,365,418 | 159 | 1,121 | 0 | 234.69 | 55.38 | 4 | 384.51 | 156 | 475 | 156 | 15 | 194 | 20,171,106 | 89 | 761 | 1,814,591 | 6.99 | 61 | 294 | 5 | 156 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 213 | 709 | 23,446,148 | 150,778,428 | 213 | 306 | 0 | 59.24 | 17.44 | 5 | 71.57 | 73 | 99 | 73 | 3 | 56 | 10,899,170 | 26 | 45 | 1,103,000 | 29.17 | 21 | 77 | 1 | 73 | 
| regex_program | 1 | 158 | 525 | 11,598,276 | 128,513,066 | 158 | 263 | 1 | 52.39 | 15.12 | 4 | 66.49 | 53 | 90 | 53 | 0 | 51 | 2,196,106 | 23 | 63 | 1,104,000 | 33.79 | 16 | 68 | 0 | 53 | 
| regex_program | 2 | 165 | 563 | 11,579,064 | 128,513,066 | 165 | 299 | 1 | 51.45 | 15.13 | 4 | 64.92 | 66 | 115 | 66 | 0 | 50 | 2,177,334 | 49 | 57 | 1,104,000 | 33.28 | 16 | 67 | 0 | 66 | 
| regex_program | 3 | 186 | 554 | 11,853,872 | 103,456,394 | 186 | 283 | 0 | 69.57 | 13.09 | 5 | 55.60 | 61 | 88 | 61 | 0 | 49 | 2,422,606 | 30 | 43 | 826,502 | 33.12 | 18 | 83 | 1 | 61 | 
...
Commit: https://github.com/openvm-org/openvm/commit/e0176154d3137661367b3876ba12dfc52b98ec64
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19806794789)

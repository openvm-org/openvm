...
| `total_proof_time_ms ` |  713 |  1,426 |  811 |  615 |
...
| `execute_metered_insn_mi/s` |  19.41 | -          |  19.41 |  19.41 |
| `execute_preflight_insns` |  872,871 |  1,745,742 |  1,157,000 |  588,742 |
| `execute_preflight_time_ms` |  94 |  188 |  129 |  59 |
| `execute_preflight_insn_mi/s` |  13.65 | -          |  18.13 |  9.16 |
| `trace_gen_time_ms   ` |  180 |  360 |  197 |  163 |
| `memory_finalize_time_ms` | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  345.50 |  691 |  374 |  317 |
| `main_trace_commit_time_ms` |  62.50 |  125 |  72 |  53 |
| `generate_perm_trace_time_ms` |  35 |  70 |  38 |  32 |
| `perm_trace_commit_time_ms` |  77.29 |  154.57 |  90.14 |  64.43 |
| `quotient_poly_compute_time_ms` |  79.72 |  159.43 |  87.31 |  72.13 |
| `quotient_poly_commit_time_ms` |  16.76 |  33.51 |  18.89 |  14.62 |
| `pcs_opening_time_ms ` |  68.50 |  137 |  70 |  67 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,442.50 |  2,885 |  1,709 |  1,176 |
| `main_cells_used     ` |  16,200,472 |  32,400,944 |  16,332,746 |  16,068,198 |
| `total_cells_used    ` |  39,332,920 |  78,665,840 |  39,650,868 |  39,014,972 |
| `execute_preflight_insns` |  1,952,429.50 |  3,904,859 |  1,991,926 |  1,912,933 |
| `execute_preflight_time_ms` |  583.50 |  1,167 |  871 |  296 |
| `execute_preflight_insn_mi/s` |  7.61 | -          |  7.61 |  7.61 |
| `trace_gen_time_ms   ` |  118.50 |  237 |  127 |  110 |
| `memory_finalize_time_ms` |  10.50 |  21 |  11 |  10 |
| `stark_prove_excluding_trace_time_ms` |  739 |  1,478 |  752 |  726 |
| `main_trace_commit_time_ms` |  147 |  294 |  151 |  143 |
| `generate_perm_trace_time_ms` |  54 |  108 |  54 |  54 |
| `perm_trace_commit_time_ms` |  227.74 |  455.47 |  231.42 |  224.05 |
| `quotient_poly_compute_time_ms` |  170.38 |  340.77 |  172.92 |  167.85 |
| `quotient_poly_commit_time_ms` |  31.55 |  63.11 |  33.05 |  30.06 |
| `pcs_opening_time_ms ` |  105 |  210 |  107 |  103 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 1,711 |  | 1 | 1 |  |  |  |  | 
| pairing |  | 615 |  | 1 | 89 | 1,745,742 | 19.41 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 127 | 1,176 | 39,650,868 | 410,701,290 | 127 | 752 | 0 | 172.92 | 33.05 | 4 | 231.42 | 107 | 286 | 107 | 11 | 151 | 16,332,746 | 54 | 296 | 1,991,926 | 7.61 | 39 | 207 | 0 | 107 | 
| leaf | 1 | 110 | 1,709 | 39,014,972 | 396,840,426 | 110 | 726 | 0 | 167.85 | 30.06 | 4 | 224.05 | 103 | 279 | 103 | 10 | 143 | 16,068,198 | 54 | 871 | 1,912,933 | 7.61 | 38 | 199 | 0 | 103 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 163 | 811 | 32,689,110 | 172,558,444 | 163 | 374 | 0 | 87.31 | 18.89 | 6 | 90.14 | 67 | 126 | 67 | 0 | 72 | 16,059,916 | 32 | 129 | 1,157,000 | 9.16 | 26 | 107 | 1 | 67 | 
| pairing | 1 | 197 | 615 | 22,314,288 | 119,958,502 | 197 | 317 | 1 | 72.13 | 14.62 | 6 | 64.43 | 70 | 105 | 70 | 0 | 53 | 9,408,294 | 38 | 59 | 588,742 | 18.13 | 21 | 87 | 1 | 70 | 

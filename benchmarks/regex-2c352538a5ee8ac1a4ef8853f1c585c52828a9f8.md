...
| `total_proof_time_ms ` |  3,934 |  7,868 |  4,344 |  3,524 |
| `main_cells_used     ` |  83,255,576 |  166,511,152 |  93,500,799 |  73,010,353 |
| `total_cycles        ` |  2,082,613 |  4,165,226 |  2,243,715 |  1,921,511 |
| `execute_time_ms     ` |  362.50 |  725 |  404 |  321 |
| `trace_gen_time_ms   ` |  961.50 |  1,923 |  1,146 |  777 |
| `stark_prove_excluding_trace_time_ms` |  2,610 |  5,220 |  2,794 |  2,426 |
| `main_trace_commit_time_ms` |  499.50 |  999 |  557 |  442 |
| `generate_perm_trace_time_ms` |  223 |  446 |  235 |  211 |
| `perm_trace_commit_time_ms` |  544.50 |  1,089 |  573 |  516 |
| `quotient_poly_compute_time_ms` |  259.50 |  519 |  282 |  237 |
| `quotient_poly_commit_time_ms` |  248.50 |  497 |  283 |  214 |
| `pcs_opening_time_ms ` |  825.50 |  1,651 |  854 |  797 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,002.50 |  14,005 |  7,070 |  6,935 |
| `main_cells_used     ` |  151,827,941 |  303,655,882 |  154,227,926 |  149,427,956 |
| `total_cycles        ` |  1,975,735 |  3,951,470 |  2,006,573 |  1,944,897 |
| `execute_time_ms     ` |  782 |  1,564 |  789 |  775 |
| `trace_gen_time_ms   ` |  1,471 |  2,942 |  1,473 |  1,469 |
| `stark_prove_excluding_trace_time_ms` |  4,749.50 |  9,499 |  4,812 |  4,687 |
| `main_trace_commit_time_ms` |  868 |  1,736 |  869 |  867 |
| `generate_perm_trace_time_ms` |  400.50 |  801 |  429 |  372 |
| `perm_trace_commit_time_ms` |  1,243.50 |  2,487 |  1,246 |  1,241 |
| `quotient_poly_compute_time_ms` |  536.50 |  1,073 |  557 |  516 |
| `quotient_poly_commit_time_ms` |  411 |  822 |  412 |  410 |
| `pcs_opening_time_ms ` |  1,284.50 |  2,569 |  1,294 |  1,275 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,469 | 7,070 | 2,006,573 | 538,660,330 | 4,812 | 557 | 412 | 1,246 | 1,294 | 869 | 154,227,926 | 429 | 789 | 
| leaf | 1 | 1,473 | 6,935 | 1,944,897 | 538,660,330 | 4,687 | 516 | 410 | 1,241 | 1,275 | 867 | 149,427,956 | 372 | 775 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,146 | 4,344 | 2,243,715 | 275,652,919 | 2,794 | 282 | 283 | 573 | 854 | 557 | 93,500,799 | 235 | 404 | 
| regex_program | 1 | 777 | 3,524 | 1,921,511 | 242,975,404 | 2,426 | 237 | 214 | 516 | 797 | 442 | 73,010,353 | 211 | 321 | 

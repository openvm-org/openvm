...
| fibonacci_program |  1.01 |  0.58 |  0.58 |
| leaf |  2.03 |  1.26 |  1.26 |
...
| `total_proof_time_ms ` |  499.50 |  999 |  575 |  424 |
...
| `execute_preflight_insn_mi/s` |  37.63 | -          |  38.04 |  37.21 |
| `trace_gen_time_ms   ` |  191 |  382 |  195 |  187 |
| `memory_finalize_time_ms` | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  176 |  352 |  187 |  165 |
| `main_trace_commit_time_ms` |  30 |  60 |  32 |  28 |
| `generate_perm_trace_time_ms` |  15.50 |  31 |  18 |  13 |
| `perm_trace_commit_time_ms` |  41.89 |  83.79 |  43.82 |  39.97 |
| `quotient_poly_compute_time_ms` |  31.19 |  62.38 |  33.83 |  28.56 |
| `quotient_poly_commit_time_ms` |  12.32 |  24.64 |  12.44 |  12.20 |
| `pcs_opening_time_ms ` |  43 |  86 |  45 |  41 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,013.50 |  2,027 |  1,264 |  763 |
| `main_cells_used     ` |  6,475,562 |  12,951,124 |  6,608,072 |  6,343,052 |
| `total_cells_used    ` |  17,568,644 |  35,137,288 |  17,887,054 |  17,250,234 |
| `execute_preflight_insns` |  1,190,480.50 |  2,380,961 |  1,229,730 |  1,151,231 |
| `execute_preflight_time_ms` |  503.50 |  1,007 |  804 |  203 |
| `execute_preflight_insn_mi/s` |  6.74 | -          |  6.83 |  6.65 |
| `trace_gen_time_ms   ` |  57.50 |  115 |  61 |  54 |
| `memory_finalize_time_ms` |  5.50 |  11 |  6 |  5 |
| `stark_prove_excluding_trace_time_ms` |  451 |  902 |  497 |  405 |
| `main_trace_commit_time_ms` |  82.50 |  165 |  90 |  75 |
| `generate_perm_trace_time_ms` |  36.50 |  73 |  39 |  34 |
| `perm_trace_commit_time_ms` |  123.42 |  246.84 |  141.58 |  105.26 |
| `quotient_poly_compute_time_ms` |  92.91 |  185.82 |  101.19 |  84.64 |
| `quotient_poly_commit_time_ms` |  22.50 |  44.100 |  24.27 |  20.73 |
| `pcs_opening_time_ms ` |  90 |  180 |  103 |  77 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program |  | 424 |  | 1 | 9 | 1,500,209 | 164.05 | 0 | 
| leaf | 1,265 |  | 1 | 1 |  |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 61 | 763 | 17,887,054 | 252,878,314 | 61 | 497 | 0 | 101.19 | 24.27 | 4 | 141.58 | 103 | 176 | 103 | 6 | 90 | 6,608,072 | 34 | 203 | 1,229,730 | 6.83 | 26 | 126 | 0 | 103 | 
| leaf | 1 | 54 | 1,264 | 17,250,234 | 207,789,546 | 54 | 405 | 0 | 84.64 | 20.73 | 4 | 105.26 | 77 | 145 | 77 | 5 | 75 | 6,343,052 | 39 | 804 | 1,151,231 | 6.65 | 22 | 106 | 0 | 77 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 187 | 575 | 9,677,708 | 84,395,212 | 187 | 187 | 0 | 33.83 | 12.44 | 4 | 43.82 | 45 | 62 | 45 | 0 | 32 | 1,035,986 | 18 | 33 | 873,000 | 37.21 | 14 | 46 | 0 | 45 | 
| fibonacci_program | 1 | 195 | 424 | 9,708,170 | 74,305,770 | 195 | 165 | 1 | 28.56 | 12.20 | 4 | 39.97 | 41 | 54 | 41 | 0 | 28 | 1,064,416 | 13 | 22 | 627,209 | 38.04 | 11 | 41 | 0 | 41 | 

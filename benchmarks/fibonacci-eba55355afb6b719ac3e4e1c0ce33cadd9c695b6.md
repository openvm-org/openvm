...
|:---|---:|---:|---:|
| Total |  3.07 |  1.88 | 1.88 |
| fibonacci_program |  1.04 |  0.61 |  0.61 |
| leaf |  2.02 |  1.27 |  1.27 |
...
| `total_proof_time_ms ` |  516 |  1,032 |  594 |  438 |
...
| `execute_metered_insn_mi/s` |  114.10 | -          |  114.10 |  114.10 |
| `execute_preflight_insns` |  750,104.50 |  1,500,209 |  873,000 |  627,209 |
| `execute_preflight_time_ms` |  29.50 |  59 |  33 |  26 |
| `execute_preflight_insn_mi/s` |  36.02 | -          |  38.45 |  33.59 |
| `trace_gen_time_ms   ` |  190 |  380 |  194 |  186 |
| `memory_finalize_time_ms` | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  189.50 |  379 |  202 |  177 |
| `main_trace_commit_time_ms` |  31 |  62 |  33 |  29 |
| `generate_perm_trace_time_ms` |  20 |  40 |  21 |  19 |
| `perm_trace_commit_time_ms` |  41.93 |  83.86 |  44.95 |  38.91 |
| `quotient_poly_compute_time_ms` |  31.94 |  63.87 |  33.67 |  30.20 |
| `quotient_poly_commit_time_ms` |  12.80 |  25.61 |  13.71 |  11.89 |
| `pcs_opening_time_ms ` |  50 |  100 |  56 |  44 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,010.50 |  2,021 |  1,270 |  751 |
| `main_cells_used     ` |  6,475,562 |  12,951,124 |  6,608,072 |  6,343,052 |
| `total_cells_used    ` |  17,568,644 |  35,137,288 |  17,887,054 |  17,250,234 |
| `execute_preflight_insns` |  1,190,437 |  2,380,874 |  1,229,695 |  1,151,179 |
| `execute_preflight_time_ms` |  512.50 |  1,025 |  819 |  206 |
| `execute_preflight_insn_mi/s` |  6.70 | -          |  6.72 |  6.68 |
| `trace_gen_time_ms   ` |  58 |  116 |  60 |  56 |
| `memory_finalize_time_ms` |  6.50 |  13 |  7 |  6 |
| `stark_prove_excluding_trace_time_ms` |  439 |  878 |  484 |  394 |
| `main_trace_commit_time_ms` |  84 |  168 |  92 |  76 |
| `generate_perm_trace_time_ms` |  35.50 |  71 |  37 |  34 |
| `perm_trace_commit_time_ms` |  125 |  250.01 |  143.48 |  106.53 |
| `quotient_poly_compute_time_ms` |  93.87 |  187.74 |  103.43 |  84.31 |
| `quotient_poly_commit_time_ms` |  22.50 |  44.100 |  24.51 |  20.49 |
| `pcs_opening_time_ms ` |  75.50 |  151 |  84 |  67 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program |  | 438 |  | 1 | 13 | 1,500,209 | 114.10 | 0 | 
| leaf | 1,272 |  | 1 | 1 |  |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 60 | 751 | 17,887,054 | 252,878,314 | 60 | 484 | 0 | 103.43 | 24.51 | 4 | 143.48 | 84 | 178 | 84 | 7 | 92 | 6,608,072 | 34 | 206 | 1,229,695 | 6.72 | 26 | 128 | 0 | 84 | 
| leaf | 1 | 56 | 1,270 | 17,250,234 | 207,789,546 | 56 | 394 | 0 | 84.31 | 20.49 | 4 | 106.53 | 67 | 145 | 67 | 6 | 76 | 6,343,052 | 37 | 819 | 1,151,179 | 6.68 | 22 | 105 | 0 | 67 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 194 | 594 | 9,677,708 | 84,395,212 | 194 | 202 | 0 | 33.67 | 13.71 | 4 | 44.95 | 56 | 64 | 55 | 0 | 33 | 1,035,986 | 19 | 26 | 873,000 | 33.59 | 14 | 47 | 0 | 55 | 
| fibonacci_program | 1 | 186 | 438 | 9,708,170 | 74,305,770 | 186 | 177 | 1 | 30.20 | 11.89 | 4 | 38.91 | 44 | 61 | 44 | 0 | 29 | 1,064,416 | 21 | 33 | 627,209 | 38.45 | 11 | 42 | 0 | 44 | 

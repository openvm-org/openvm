...
| `total_proof_time_ms ` |  1,367 |  1,367 |  1,367 |  1,367 |
| `main_cells_used     ` |  8,194,460 |  8,194,460 |  8,194,460 |  8,194,460 |
| `total_cycles        ` |  147,003 |  147,003 |  147,003 |  147,003 |
| `execute_time_ms     ` |  95 |  95 |  95 |  95 |
| `trace_gen_time_ms   ` |  106 |  106 |  106 |  106 |
| `stark_prove_excluding_trace_time_ms` |  1,166 |  1,166 |  1,166 |  1,166 |
...
| `quotient_poly_commit_time_ms` |  259 |  259 |  259 |  259 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| verify_fibair | 106 | 1,367 | 147,003 | 23,947,938 | 1,166 | 133 | 259 | 184 | 350 | 215 | 8,194,460 | 21 | 95 | 

...
| `main_cells_used     ` |  70,354,271 |  70,354,271 |  70,354,271 |  70,354,271 |
| `total_cycles        ` |  1,265,697 |  1,265,697 |  1,265,697 |  1,265,697 |
| `execute_time_ms     ` |  530 |  530 |  530 |  530 |
| `trace_gen_time_ms   ` |  679 |  679 |  679 |  679 |
| `stark_prove_excluding_trace_time_ms` |  2,612 |  2,612 |  2,612 |  2,612 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 679 | 3,821 | 1,265,697 | 252,059,114 | 2,612 | 373 | 286 | 737 | 618 | 439 | 70,354,271 | 154 | 530 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 553 | 2,780 | 1,500,096 | 160,733,916 | 1,992 | 250 | 237 | 514 | 511 | 361 | 51,485,167 | 112 | 235 | 

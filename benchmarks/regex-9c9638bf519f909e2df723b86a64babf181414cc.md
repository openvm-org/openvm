...
| `total_proof_time_ms ` |  4,029.50 |  8,059 |  4,662 |  3,397 |
| `main_cells_used     ` |  83,694,725 |  167,389,450 |  93,699,990 |  73,689,460 |
| `total_cycles        ` |  2,070,082 |  4,140,164 |  2,225,434 |  1,914,730 |
| `execute_time_ms     ` |  340.50 |  681 |  377 |  304 |
| `trace_gen_time_ms   ` |  971.50 |  1,943 |  1,159 |  784 |
| `stark_prove_excluding_trace_time_ms` |  2,717.50 |  5,435 |  3,126 |  2,309 |
| `main_trace_commit_time_ms` |  494 |  988 |  577 |  411 |
| `generate_perm_trace_time_ms` |  165 |  330 |  184 |  146 |
| `perm_trace_commit_time_ms` |  705 |  1,410 |  820 |  590 |
| `quotient_poly_compute_time_ms` |  369 |  738 |  425 |  313 |
| `quotient_poly_commit_time_ms` |  289 |  578 |  338 |  240 |
| `pcs_opening_time_ms ` |  685.50 |  1,371 |  772 |  599 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,530.50 |  15,061 |  7,629 |  7,432 |
| `main_cells_used     ` |  152,232,344 |  304,464,688 |  154,690,118 |  149,774,570 |
| `total_cycles        ` |  1,990,818 |  3,981,636 |  2,021,632 |  1,960,004 |
| `execute_time_ms     ` |  765 |  1,530 |  773 |  757 |
| `trace_gen_time_ms   ` |  1,484 |  2,968 |  1,495 |  1,473 |
| `stark_prove_excluding_trace_time_ms` |  5,281.50 |  10,563 |  5,361 |  5,202 |
| `main_trace_commit_time_ms` |  892 |  1,784 |  893 |  891 |
| `generate_perm_trace_time_ms` |  353.50 |  707 |  369 |  338 |
| `perm_trace_commit_time_ms` |  1,653.50 |  3,307 |  1,690 |  1,617 |
| `quotient_poly_compute_time_ms` |  764 |  1,528 |  768 |  760 |
| `quotient_poly_commit_time_ms` |  520 |  1,040 |  520 |  520 |
| `pcs_opening_time_ms ` |  1,094 |  2,188 |  1,118 |  1,070 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,495 | 7,629 | 2,021,632 | 533,941,738 | 5,361 | 768 | 520 | 1,690 | 1,118 | 891 | 154,690,118 | 369 | 773 | 
| leaf | 1 | 1,473 | 7,432 | 1,960,004 | 533,941,738 | 5,202 | 760 | 520 | 1,617 | 1,070 | 893 | 149,774,570 | 338 | 757 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,159 | 4,662 | 2,225,434 | 275,652,919 | 3,126 | 425 | 338 | 820 | 772 | 577 | 93,699,990 | 184 | 377 | 
| regex_program | 1 | 784 | 3,397 | 1,914,730 | 198,099,628 | 2,309 | 313 | 240 | 590 | 599 | 411 | 73,689,460 | 146 | 304 | 

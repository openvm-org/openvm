...
| `total_proof_time_ms ` |  6,962 |  13,924 |  7,794 |  6,130 |
| `main_cells_used     ` |  83,694,725 |  167,389,450 |  93,699,990 |  73,689,460 |
| `total_cycles        ` |  2,070,082 |  4,140,164 |  2,225,434 |  1,914,730 |
| `execute_time_ms     ` |  387 |  774 |  471 |  303 |
| `trace_gen_time_ms   ` |  1,246 |  2,492 |  1,281 |  1,211 |
| `stark_prove_excluding_trace_time_ms` |  5,329 |  10,658 |  6,042 |  4,616 |
| `main_trace_commit_time_ms` |  1,145.50 |  2,291 |  1,319 |  972 |
| `generate_perm_trace_time_ms` |  184.50 |  369 |  186 |  183 |
| `perm_trace_commit_time_ms` |  1,045 |  2,090 |  1,186 |  904 |
| `quotient_poly_compute_time_ms` |  752 |  1,504 |  883 |  621 |
| `quotient_poly_commit_time_ms` |  921.50 |  1,843 |  1,069 |  774 |
| `pcs_opening_time_ms ` |  1,270 |  2,540 |  1,389 |  1,151 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  8,535.50 |  17,071 |  8,604 |  8,467 |
| `main_cells_used     ` |  86,869,698.50 |  173,739,397 |  88,129,942 |  85,609,455 |
| `total_cycles        ` |  1,451,208.50 |  2,902,417 |  1,475,930 |  1,426,487 |
| `execute_time_ms     ` |  446 |  892 |  490 |  402 |
| `trace_gen_time_ms   ` |  1,255 |  2,510 |  1,322 |  1,188 |
| `stark_prove_excluding_trace_time_ms` |  6,834.50 |  13,669 |  6,880 |  6,789 |
| `main_trace_commit_time_ms` |  1,385 |  2,770 |  1,390 |  1,380 |
| `generate_perm_trace_time_ms` |  188.50 |  377 |  191 |  186 |
| `perm_trace_commit_time_ms` |  1,405 |  2,810 |  1,415 |  1,395 |
| `quotient_poly_compute_time_ms` |  1,074.50 |  2,149 |  1,078 |  1,071 |
| `quotient_poly_commit_time_ms` |  1,371 |  2,742 |  1,378 |  1,364 |
| `pcs_opening_time_ms ` |  1,405 |  2,810 |  1,449 |  1,361 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,188 | 8,467 | 1,475,930 | 225,774,050 | 6,789 | 1,078 | 1,364 | 1,415 | 1,361 | 1,380 | 88,129,942 | 186 | 490 | 
| leaf | 1 | 1,322 | 8,604 | 1,426,487 | 225,774,050 | 6,880 | 1,071 | 1,378 | 1,395 | 1,449 | 1,390 | 85,609,455 | 191 | 402 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,281 | 7,794 | 2,225,434 | 210,931,487 | 6,042 | 883 | 1,069 | 1,186 | 1,389 | 1,319 | 93,699,990 | 186 | 471 | 
| regex_program | 1 | 1,211 | 6,130 | 1,914,730 | 150,470,512 | 4,616 | 621 | 774 | 904 | 1,151 | 972 | 73,689,460 | 183 | 303 | 

...
| `total_proof_time_ms ` |  5,517 |  5,517 |  5,517 |  5,517 |
...
| `stark_prove_excluding_trace_time_ms` |  4,377 |  4,377 |  4,377 |  4,377 |
| `main_trace_commit_time_ms` |  797 |  797 |  797 |  797 |
| `generate_perm_trace_time_ms` |  178 |  178 |  178 |  178 |
| `perm_trace_commit_time_ms` |  1,574 |  1,574 |  1,574 |  1,574 |
...
| `trace_gen_time_ms   ` |  1,264 |  1,264 |  1,264 |  1,264 |
| `stark_prove_excluding_trace_time_ms` |  5,322 |  5,322 |  5,322 |  5,322 |
| `main_trace_commit_time_ms` |  1,042 |  1,042 |  1,042 |  1,042 |
| `generate_perm_trace_time_ms` |  134 |  134 |  134 |  134 |
| `perm_trace_commit_time_ms` |  1,125 |  1,125 |  1,125 |  1,125 |
| `quotient_poly_compute_time_ms` |  739 |  739 |  739 |  739 |
| `quotient_poly_commit_time_ms` |  990 |  990 |  990 |  990 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,264 | 6,957 | 1,832,637 | 180,014,040 | 5,322 | 739 | 990 | 1,125 | 1,288 | 1,042 | 70,691,741 | 134 | 371 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 829 | 5,517 | 1,500,137 | 197,440,542 | 4,377 | 316 | 506 | 1,574 | 1,002 | 797 | 51,487,838 | 178 | 311 | 

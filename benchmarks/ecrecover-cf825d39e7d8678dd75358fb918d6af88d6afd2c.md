...
| `main_cells_used     ` |  244,742,604 |  244,742,604 |  244,742,604 |  244,742,604 |
| `total_cycles        ` |  2,990,619 |  2,990,619 |  2,990,619 |  2,990,619 |
| `execute_time_ms     ` |  1,081 |  1,081 |  1,081 |  1,081 |
| `trace_gen_time_ms   ` |  2,404 |  2,404 |  2,404 |  2,404 |
| `stark_prove_excluding_trace_time_ms` |  9,589 |  9,589 |  9,589 |  9,589 |
| `main_trace_commit_time_ms` |  1,725 |  1,725 |  1,725 |  1,725 |
| `generate_perm_trace_time_ms` |  694 |  694 |  694 |  694 |
| `perm_trace_commit_time_ms` |  3,150 |  3,150 |  3,150 |  3,150 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 2,404 | 13,074 | 2,990,619 | 999,394,794 | 9,589 | 1,343 | 876 | 3,150 | 1,796 | 1,725 | 244,742,604 | 694 | 1,081 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 183 | 1,436 | 295,291 | 48,240,457 | 1,103 | 125 | 154 | 183 | 422 | 169 | 15,598,160 | 33 | 150 | 

...
| `total_proof_time_ms ` |  3,976.50 |  7,953 |  4,610 |  3,343 |
...
| `trace_gen_time_ms   ` |  936 |  1,872 |  1,127 |  745 |
| `stark_prove_excluding_trace_time_ms` |  2,704 |  5,408 |  3,109 |  2,299 |
| `main_trace_commit_time_ms` |  496 |  992 |  579 |  413 |
| `generate_perm_trace_time_ms` |  175 |  350 |  207 |  143 |
| `perm_trace_commit_time_ms` |  700 |  1,400 |  814 |  586 |
| `quotient_poly_compute_time_ms` |  361 |  722 |  422 |  300 |
| `quotient_poly_commit_time_ms` |  293 |  586 |  339 |  247 |
| `pcs_opening_time_ms ` |  671 |  1,342 |  740 |  602 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,521 |  15,042 |  7,541 |  7,501 |
| `main_cells_used     ` |  152,233,142 |  304,466,284 |  154,690,544 |  149,775,740 |
| `total_cycles        ` |  1,990,744 |  3,981,488 |  2,021,527 |  1,959,961 |
| `execute_time_ms     ` |  757 |  1,514 |  764 |  750 |
| `trace_gen_time_ms   ` |  1,491 |  2,982 |  1,500 |  1,482 |
| `stark_prove_excluding_trace_time_ms` |  5,273 |  10,546 |  5,295 |  5,251 |
| `main_trace_commit_time_ms` |  895 |  1,790 |  895 |  895 |
| `generate_perm_trace_time_ms` |  352 |  704 |  362 |  342 |
| `perm_trace_commit_time_ms` |  1,674 |  3,348 |  1,684 |  1,664 |
| `quotient_poly_compute_time_ms` |  764 |  1,528 |  765 |  763 |
| `quotient_poly_commit_time_ms` |  521.50 |  1,043 |  523 |  520 |
| `pcs_opening_time_ms ` |  1,061.50 |  2,123 |  1,062 |  1,061 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,482 | 7,541 | 2,021,527 | 533,941,738 | 5,295 | 765 | 523 | 1,684 | 1,061 | 895 | 154,690,544 | 362 | 764 | 
| leaf | 1 | 1,500 | 7,501 | 1,959,961 | 533,941,738 | 5,251 | 763 | 520 | 1,664 | 1,062 | 895 | 149,775,740 | 342 | 750 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,127 | 4,610 | 2,225,434 | 275,652,919 | 3,109 | 422 | 339 | 814 | 740 | 579 | 93,699,990 | 207 | 374 | 
| regex_program | 1 | 745 | 3,343 | 1,914,730 | 198,099,628 | 2,299 | 300 | 247 | 586 | 602 | 413 | 73,689,460 | 143 | 299 | 

...
| `total_proof_time_ms ` |  701.50 |  1,403 |  817 |  586 |
...
| `execute_metered_insn_mi/s` |  27.30 | -          |  27.30 |  27.30 |
| `execute_preflight_insns` |  872,871 |  1,745,742 |  1,157,000 |  588,742 |
| `execute_preflight_time_ms` |  83.50 |  167 |  106 |  61 |
| `execute_preflight_insn_mi/s` |  14.80 | -          |  18.29 |  11.31 |
| `trace_gen_time_ms   ` |  187 |  374 |  191 |  183 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  337.50 |  675 |  384 |  291 |
| `main_trace_commit_time_ms` |  64 |  128 |  75 |  53 |
| `generate_perm_trace_time_ms` |  37 |  74 |  41 |  33 |
| `perm_trace_commit_time_ms` |  74.43 |  148.86 |  84.38 |  64.49 |
| `quotient_poly_compute_time_ms` |  77.29 |  154.58 |  84.28 |  70.30 |
| `quotient_poly_commit_time_ms` |  16.15 |  32.30 |  18.30 |  14.01 |
| `pcs_opening_time_ms ` |  64 |  128 |  76 |  52 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,471 |  2,942 |  1,760 |  1,182 |
...
| `execute_preflight_time_ms` |  613 |  1,226 |  924 |  302 |
| `execute_preflight_insn_mi/s` |  7.54 | -          |  7.57 |  7.52 |
| `trace_gen_time_ms   ` |  121 |  242 |  132 |  110 |
| `memory_finalize_time_ms` |  11.50 |  23 |  12 |  11 |
| `stark_prove_excluding_trace_time_ms` |  735 |  1,470 |  746 |  724 |
| `main_trace_commit_time_ms` |  145.50 |  291 |  149 |  142 |
| `generate_perm_trace_time_ms` |  56 |  112 |  58 |  54 |
| `perm_trace_commit_time_ms` |  226.04 |  452.09 |  230.40 |  221.69 |
| `quotient_poly_compute_time_ms` |  166.69 |  333.37 |  168.91 |  164.46 |
| `quotient_poly_commit_time_ms` |  31.25 |  62.50 |  31.27 |  31.23 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 1,762 |  | 1 | 1 |  |  |  |  | 
| pairing |  | 586 |  | 1 | 63 | 1,745,742 | 27.30 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 132 | 1,182 | 39,650,868 | 410,701,290 | 132 | 746 | 0 | 168.91 | 31.23 | 4 | 230.40 | 109 | 286 | 109 | 12 | 149 | 16,332,746 | 54 | 302 | 1,991,850 | 7.52 | 39 | 201 | 0 | 109 | 
| leaf | 1 | 110 | 1,760 | 39,014,972 | 396,840,426 | 110 | 724 | 0 | 164.46 | 31.27 | 4 | 221.69 | 103 | 280 | 103 | 11 | 142 | 16,068,198 | 58 | 924 | 1,912,900 | 7.57 | 37 | 197 | 0 | 103 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 183 | 817 | 32,689,110 | 172,558,444 | 183 | 384 | 0 | 84.28 | 18.30 | 6 | 84.38 | 76 | 129 | 75 | 1 | 75 | 16,059,916 | 41 | 106 | 1,157,000 | 11.31 | 26 | 103 | 1 | 75 | 
| pairing | 1 | 191 | 586 | 22,314,288 | 119,958,502 | 191 | 291 | 1 | 70.30 | 14.01 | 5 | 64.49 | 52 | 100 | 52 | 0 | 53 | 9,408,294 | 33 | 61 | 588,742 | 18.29 | 20 | 84 | 1 | 52 | 

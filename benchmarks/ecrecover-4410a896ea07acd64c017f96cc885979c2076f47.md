...
| `quotient_poly_commit_time_ms` |  322 |  322 |  322 |  322 |
| `pcs_opening_time_ms ` |  619 |  619 |  619 |  619 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  21,235 |  21,235 |  21,235 |  21,235 |
| `main_cells_used     ` |  202,806,776 |  202,806,776 |  202,806,776 |  202,806,776 |
| `total_cycles        ` |  4,138,952 |  4,138,952 |  4,138,952 |  4,138,952 |
| `execute_time_ms     ` |  964 |  964 |  964 |  964 |
| `trace_gen_time_ms   ` |  3,740 |  3,740 |  3,740 |  3,740 |
| `stark_prove_excluding_trace_time_ms` |  16,531 |  16,531 |  16,531 |  16,531 |
| `main_trace_commit_time_ms` |  2,963 |  2,963 |  2,963 |  2,963 |
| `generate_perm_trace_time_ms` |  374 |  374 |  374 |  374 |
| `perm_trace_commit_time_ms` |  3,316 |  3,316 |  3,316 |  3,316 |
| `quotient_poly_compute_time_ms` |  4,521 |  4,521 |  4,521 |  4,521 |
| `quotient_poly_commit_time_ms` |  2,521 |  2,521 |  2,521 |  2,521 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 3,740 | 21,235 | 4,138,952 | 508,251,096 | 16,531 | 4,521 | 2,521 | 3,316 | 2,832 | 2,963 | 202,806,776 | 374 | 964 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 257 | 2,588 | 285,401 | 56,172,159 | 2,189 | 294 | 322 | 529 | 619 | 382 | 15,075,033 | 40 | 142 | 

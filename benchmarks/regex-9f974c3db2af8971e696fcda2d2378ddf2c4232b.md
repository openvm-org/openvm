...
| `total_proof_time_ms ` |  1,493.50 |  2,987 |  1,755 |  1,232 |
...
| `execute_preflight_time_ms` |  94 |  188 |  107 |  81 |
| `execute_preflight_insn_mi/s` |  31.57 | -          |  33.24 |  29.90 |
| `trace_gen_time_ms   ` |  319 |  638 |  340 |  298 |
| `memory_finalize_time_ms` |  2 |  4 |  4 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  993 |  1,986 |  1,249 |  737 |
| `main_trace_commit_time_ms` |  142 |  284 |  185 |  99 |
| `generate_perm_trace_time_ms` |  58 |  116 |  70 |  46 |
| `perm_trace_commit_time_ms` |  175.10 |  350.19 |  227.07 |  123.12 |
| `quotient_poly_compute_time_ms` |  159.25 |  318.50 |  167.46 |  151.04 |
| `quotient_poly_commit_time_ms` |  36.34 |  72.68 |  48.05 |  24.63 |
| `pcs_opening_time_ms ` |  415 |  830 |  563 |  267 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  2,080.50 |  4,161 |  2,853 |  1,308 |
| `main_cells_used     ` |  14,798,849 |  29,597,698 |  20,272,474 |  9,325,224 |
| `total_cells_used    ` |  37,032,585 |  74,065,170 |  50,586,080 |  23,479,090 |
| `execute_preflight_insns` |  1,663,347.50 |  3,326,695 |  1,830,088 |  1,496,607 |
| `execute_preflight_time_ms` |  579.50 |  1,159 |  902 |  257 |
| `execute_preflight_insn_mi/s` |  7.01 | -          |  7.47 |  6.55 |
| `trace_gen_time_ms   ` |  124.50 |  249 |  175 |  74 |
| `memory_finalize_time_ms` |  11.50 |  23 |  17 |  6 |
| `stark_prove_excluding_trace_time_ms` |  1,375.50 |  2,751 |  1,775 |  976 |
| `main_trace_commit_time_ms` |  182.50 |  365 |  231 |  134 |
| `generate_perm_trace_time_ms` |  81 |  162 |  86 |  76 |
| `perm_trace_commit_time_ms` |  281.53 |  563.05 |  373.63 |  189.42 |
| `quotient_poly_compute_time_ms` |  180.86 |  361.72 |  232.79 |  128.94 |
| `quotient_poly_commit_time_ms` |  43.100 |  87.100 |  57.54 |  30.46 |
| `pcs_opening_time_ms ` |  601 |  1,202 |  788 |  414 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 2,855 |  | 1 |  | 1 |  |  |  |  | 
| regex_program |  | 1,232 |  | 41 | 1 | 46 | 4,108,483 | 88.82 | 167 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 74 | 1,308 | 23,479,090 | 319,626,730 | 74 | 976 | 0 | 128.94 | 30.46 | 4 | 189.42 | 414 | 266 | 414 | 6 | 134 | 9,325,224 | 76 | 257 | 1,496,607 | 7.47 | 29 | 160 | 1 | 414 | 
| leaf | 1 | 175 | 2,853 | 50,586,080 | 538,660,330 | 175 | 1,775 | 0 | 232.79 | 57.54 | 5 | 373.63 | 788 | 461 | 788 | 17 | 231 | 20,272,474 | 86 | 902 | 1,830,088 | 6.55 | 56 | 293 | 1 | 788 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 298 | 1,755 | 23,397,108 | 373,183,036 | 298 | 1,249 | 0 | 151.04 | 48.05 | 6 | 227.07 | 563 | 298 | 563 | 4 | 185 | 10,866,434 | 70 | 81 | 2,211,000 | 29.90 | 46 | 201 | 2 | 563 | 
| regex_program | 1 | 340 | 1,232 | 11,981,356 | 196,739,722 | 340 | 737 | 2 | 167.46 | 24.63 | 5 | 123.12 | 267 | 172 | 267 | 0 | 99 | 2,537,170 | 46 | 107 | 1,897,483 | 33.24 | 26 | 197 | 2 | 267 | 

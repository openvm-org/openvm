...
| `perm_trace_commit_time_ms` |  142 |  142 |  142 |  142 |
| `quotient_poly_compute_time_ms` |  87 |  87 |  87 |  87 |
| `quotient_poly_commit_time_ms` |  133 |  133 |  133 |  133 |
| `pcs_opening_time_ms ` |  432 |  432 |  432 |  432 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  11,706 |  11,706 |  11,706 |  11,706 |
| `main_cells_used     ` |  243,695,025 |  243,695,025 |  243,695,025 |  243,695,025 |
| `total_cycles        ` |  2,973,670 |  2,973,670 |  2,973,670 |  2,973,670 |
| `execute_time_ms     ` |  1,085 |  1,085 |  1,085 |  1,085 |
| `trace_gen_time_ms   ` |  2,359 |  2,359 |  2,359 |  2,359 |
| `stark_prove_excluding_trace_time_ms` |  8,262 |  8,262 |  8,262 |  8,262 |
| `main_trace_commit_time_ms` |  1,516 |  1,516 |  1,516 |  1,516 |
| `generate_perm_trace_time_ms` |  792 |  792 |  792 |  792 |
| `perm_trace_commit_time_ms` |  2,112 |  2,112 |  2,112 |  2,112 |
| `quotient_poly_compute_time_ms` |  987 |  987 |  987 |  987 |
| `quotient_poly_commit_time_ms` |  639 |  639 |  639 |  639 |
| `pcs_opening_time_ms ` |  2,208 |  2,208 |  2,208 |  2,208 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 2,359 | 11,706 | 2,973,670 | 1,008,831,978 | 8,262 | 987 | 639 | 2,112 | 2,208 | 1,516 | 243,695,025 | 792 | 1,085 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 143 | 1,288 | 206,558 | 45,522,677 | 1,011 | 87 | 133 | 142 | 432 | 157 | 10,577,526 | 41 | 134 | 

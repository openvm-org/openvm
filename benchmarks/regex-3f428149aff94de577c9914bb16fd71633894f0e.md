...
| `total_proof_time_ms ` |  4,057 |  8,114 |  4,512 |  3,602 |
| `main_cells_used     ` |  83,255,576 |  166,511,152 |  93,500,799 |  73,010,353 |
| `total_cycles        ` |  2,082,613 |  4,165,226 |  2,243,715 |  1,921,511 |
| `execute_time_ms     ` |  345.50 |  691 |  384 |  307 |
| `trace_gen_time_ms   ` |  988 |  1,976 |  1,175 |  801 |
| `stark_prove_excluding_trace_time_ms` |  2,723.50 |  5,447 |  2,953 |  2,494 |
| `main_trace_commit_time_ms` |  470.50 |  941 |  530 |  411 |
| `generate_perm_trace_time_ms` |  197.50 |  395 |  203 |  192 |
| `perm_trace_commit_time_ms` |  693 |  1,386 |  747 |  639 |
| `quotient_poly_compute_time_ms` |  396.50 |  793 |  428 |  365 |
| `quotient_poly_commit_time_ms` |  277.50 |  555 |  314 |  241 |
| `pcs_opening_time_ms ` |  680.50 |  1,361 |  722 |  639 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,289 |  14,578 |  7,339 |  7,239 |
| `main_cells_used     ` |  152,278,099 |  304,556,198 |  154,677,214 |  149,878,984 |
| `total_cycles        ` |  1,991,019.50 |  3,982,039 |  2,021,785 |  1,960,254 |
| `execute_time_ms     ` |  764 |  1,528 |  774 |  754 |
| `trace_gen_time_ms   ` |  1,468 |  2,936 |  1,494 |  1,442 |
| `stark_prove_excluding_trace_time_ms` |  5,057 |  10,114 |  5,071 |  5,043 |
| `main_trace_commit_time_ms` |  806.50 |  1,613 |  808 |  805 |
| `generate_perm_trace_time_ms` |  383.50 |  767 |  389 |  378 |
| `perm_trace_commit_time_ms` |  1,557 |  3,114 |  1,573 |  1,541 |
| `quotient_poly_compute_time_ms` |  772.50 |  1,545 |  773 |  772 |
| `quotient_poly_commit_time_ms` |  489 |  978 |  490 |  488 |
| `pcs_opening_time_ms ` |  1,043.50 |  2,087 |  1,049 |  1,038 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,494 | 7,339 | 2,021,785 | 538,660,330 | 5,071 | 772 | 488 | 1,573 | 1,038 | 808 | 154,677,214 | 389 | 774 | 
| leaf | 1 | 1,442 | 7,239 | 1,960,254 | 538,660,330 | 5,043 | 773 | 490 | 1,541 | 1,049 | 805 | 149,878,984 | 378 | 754 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,175 | 4,512 | 2,243,715 | 275,652,919 | 2,953 | 428 | 314 | 747 | 722 | 530 | 93,500,799 | 203 | 384 | 
| regex_program | 1 | 801 | 3,602 | 1,921,511 | 242,975,404 | 2,494 | 365 | 241 | 639 | 639 | 411 | 73,010,353 | 192 | 307 | 

...
| `total_proof_time_ms ` |  4,063.50 |  8,127 |  4,519 |  3,608 |
...
| `trace_gen_time_ms   ` |  1,005 |  2,010 |  1,193 |  817 |
| `stark_prove_excluding_trace_time_ms` |  2,717 |  5,434 |  2,947 |  2,487 |
| `main_trace_commit_time_ms` |  468.50 |  937 |  527 |  410 |
| `generate_perm_trace_time_ms` |  192 |  384 |  201 |  183 |
| `perm_trace_commit_time_ms` |  689.50 |  1,379 |  738 |  641 |
| `quotient_poly_compute_time_ms` |  394 |  788 |  429 |  359 |
| `quotient_poly_commit_time_ms` |  280 |  560 |  318 |  242 |
| `pcs_opening_time_ms ` |  684 |  1,368 |  724 |  644 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,309 |  14,618 |  7,370 |  7,248 |
| `main_cells_used     ` |  152,278,087 |  304,556,174 |  154,677,658 |  149,878,516 |
| `total_cycles        ` |  1,991,018.50 |  3,982,037 |  2,021,822 |  1,960,215 |
| `execute_time_ms     ` |  773.50 |  1,547 |  783 |  764 |
| `trace_gen_time_ms   ` |  1,507.50 |  3,015 |  1,522 |  1,493 |
| `stark_prove_excluding_trace_time_ms` |  5,028 |  10,056 |  5,065 |  4,991 |
| `main_trace_commit_time_ms` |  809.50 |  1,619 |  811 |  808 |
| `generate_perm_trace_time_ms` |  360 |  720 |  360 |  360 |
| `perm_trace_commit_time_ms` |  1,544.50 |  3,089 |  1,579 |  1,510 |
| `quotient_poly_compute_time_ms` |  767.50 |  1,535 |  770 |  765 |
| `quotient_poly_commit_time_ms` |  493 |  986 |  497 |  489 |
| `pcs_opening_time_ms ` |  1,048 |  2,096 |  1,051 |  1,045 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,522 | 7,370 | 2,021,822 | 538,660,330 | 5,065 | 770 | 497 | 1,579 | 1,045 | 808 | 154,677,658 | 360 | 783 | 
| leaf | 1 | 1,493 | 7,248 | 1,960,215 | 538,660,330 | 4,991 | 765 | 489 | 1,510 | 1,051 | 811 | 149,878,516 | 360 | 764 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,193 | 4,519 | 2,243,715 | 275,652,919 | 2,947 | 429 | 318 | 738 | 724 | 527 | 93,500,799 | 201 | 379 | 
| regex_program | 1 | 817 | 3,608 | 1,921,511 | 242,975,404 | 2,487 | 359 | 242 | 641 | 644 | 410 | 73,010,353 | 183 | 304 | 

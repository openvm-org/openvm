...
| `total_proof_time_ms ` |  595.75 |  2,383 |  733 |  533 |
...
| `execute_metered_insn_mi/s` |  120.01 | -          |  120.01 |  120.01 |
| `execute_preflight_insns` |  1,034,343 |  4,137,372 |  1,104,000 |  826,372 |
| `execute_preflight_time_ms` |  54 |  216 |  66 |  45 |
| `execute_preflight_insn_mi/s` |  31.01 | -          |  32.03 |  28.19 |
| `trace_gen_time_ms   ` |  179.25 |  717 |  213 |  155 |
| `memory_finalize_time_ms` |  1 |  4 |  4 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  294.75 |  1,179 |  327 |  269 |
| `main_trace_commit_time_ms` |  51.75 |  207 |  56 |  50 |
| `generate_perm_trace_time_ms` |  41 |  164 |  64 |  26 |
| `perm_trace_commit_time_ms` |  64.44 |  257.76 |  71.100 |  55.14 |
| `quotient_poly_compute_time_ms` |  58.44 |  233.76 |  69.60 |  52.09 |
| `quotient_poly_commit_time_ms` |  15.11 |  60.45 |  17.32 |  12.68 |
| `pcs_opening_time_ms ` |  60.75 |  243 |  94 |  48 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,369.50 |  5,478 |  2,006 |  900 |
...
| `execute_preflight_insns` |  1,440,844.75 |  5,763,379 |  1,814,499 |  1,241,304 |
| `execute_preflight_time_ms` |  622 |  2,488 |  833 |  228 |
| `execute_preflight_insn_mi/s` |  7 | -          |  7.28 |  6.82 |
| `trace_gen_time_ms   ` |  88.75 |  355 |  171 |  57 |
| `memory_finalize_time_ms` |  8.50 |  34 |  17 |  5 |
| `stark_prove_excluding_trace_time_ms` |  657.25 |  2,629 |  1,067 |  467 |
| `main_trace_commit_time_ms` |  123.75 |  495 |  193 |  90 |
| `generate_perm_trace_time_ms` |  55.50 |  222 |  77 |  34 |
| `perm_trace_commit_time_ms` |  198.86 |  795.45 |  339.26 |  142.17 |
| `quotient_poly_compute_time_ms` |  140.22 |  560.88 |  229.94 |  99.59 |
| `quotient_poly_commit_time_ms` |  29.93 |  119.72 |  49.41 |  22.53 |
| `pcs_opening_time_ms ` |  105.50 |  422 |  173 |  74 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 2,008 |  | 1 |  | 1 |  |  |  |  | 
| regex_program |  | 557 |  | 40 | 1 | 34 | 4,137,372 | 120.01 | 167 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 69 | 900 | 22,981,570 | 319,331,818 | 69 | 602 | 0 | 131.32 | 24.81 | 4 | 171.06 | 91 | 231 | 91 | 6 | 121 | 9,122,488 | 59 | 228 | 1,466,036 | 7.28 | 30 | 157 | 0 | 91 | 
| leaf | 1 | 57 | 1,385 | 20,905,034 | 255,237,610 | 57 | 493 | 0 | 99.59 | 22.53 | 4 | 142.17 | 84 | 195 | 84 | 6 | 90 | 8,256,948 | 52 | 833 | 1,241,304 | 6.99 | 25 | 123 | 0 | 84 | 
| leaf | 2 | 58 | 1,187 | 20,905,034 | 255,237,610 | 58 | 467 | 0 | 100.02 | 22.98 | 4 | 142.96 | 74 | 177 | 74 | 5 | 91 | 8,256,948 | 34 | 660 | 1,241,540 | 6.93 | 25 | 123 | 0 | 74 | 
| leaf | 3 | 171 | 2,006 | 50,337,320 | 538,365,418 | 171 | 1,067 | 0 | 229.94 | 49.41 | 4 | 339.26 | 173 | 417 | 173 | 17 | 193 | 20,171,106 | 77 | 767 | 1,814,499 | 6.82 | 62 | 283 | 5 | 173 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 213 | 733 | 23,468,048 | 150,778,428 | 213 | 327 | 0 | 59.26 | 17.32 | 5 | 71.100 | 94 | 99 | 94 | 4 | 56 | 10,916,118 | 26 | 46 | 1,103,000 | 28.19 | 22 | 77 | 1 | 94 | 
| regex_program | 1 | 155 | 560 | 11,615,600 | 128,513,066 | 155 | 298 | 1 | 52.82 | 14.75 | 4 | 64.96 | 49 | 129 | 49 | 0 | 50 | 2,207,750 | 64 | 66 | 1,104,000 | 31.82 | 16 | 68 | 0 | 49 | 
| regex_program | 2 | 164 | 533 | 11,604,416 | 128,513,066 | 164 | 269 | 1 | 52.09 | 15.70 | 5 | 65.66 | 48 | 101 | 48 | 0 | 51 | 2,196,886 | 34 | 59 | 1,104,000 | 31.100 | 17 | 68 | 0 | 48 | 
| regex_program | 3 | 185 | 557 | 11,876,674 | 103,522,954 | 185 | 285 | 0 | 69.60 | 12.68 | 5 | 55.14 | 52 | 98 | 52 | 0 | 50 | 2,438,640 | 40 | 45 | 826,372 | 32.03 | 18 | 83 | 1 | 52 | 

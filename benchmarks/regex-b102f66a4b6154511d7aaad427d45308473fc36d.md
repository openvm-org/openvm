...
| `total_proof_time_ms ` |  3,893.50 |  7,787 |  4,491 |  3,296 |
| `main_cells_used     ` |  83,723,935.50 |  167,447,871 |  93,738,635 |  73,709,236 |
| `total_cycles        ` |  2,070,213.50 |  4,140,427 |  2,225,434 |  1,914,993 |
| `execute_time_ms     ` |  342.50 |  685 |  378 |  307 |
| `trace_gen_time_ms   ` |  975.50 |  1,951 |  1,163 |  788 |
| `stark_prove_excluding_trace_time_ms` |  2,575.50 |  5,151 |  2,950 |  2,201 |
| `main_trace_commit_time_ms` |  453 |  906 |  537 |  369 |
| `generate_perm_trace_time_ms` |  163 |  326 |  179 |  147 |
| `perm_trace_commit_time_ms` |  647 |  1,294 |  754 |  540 |
| `quotient_poly_compute_time_ms` |  363.50 |  727 |  423 |  304 |
| `quotient_poly_commit_time_ms` |  278 |  556 |  324 |  232 |
| `pcs_opening_time_ms ` |  659 |  1,318 |  722 |  596 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,529 |  15,058 |  7,566 |  7,492 |
| `main_cells_used     ` |  152,702,287.50 |  305,404,575 |  155,161,418 |  150,243,157 |
| `total_cycles        ` |  1,990,808.50 |  3,981,617 |  2,021,609 |  1,960,008 |
| `execute_time_ms     ` |  761 |  1,522 |  768 |  754 |
| `trace_gen_time_ms   ` |  1,488.50 |  2,977 |  1,494 |  1,483 |
| `stark_prove_excluding_trace_time_ms` |  5,279.50 |  10,559 |  5,304 |  5,255 |
| `main_trace_commit_time_ms` |  890 |  1,780 |  891 |  889 |
| `generate_perm_trace_time_ms` |  345.50 |  691 |  346 |  345 |
| `perm_trace_commit_time_ms` |  1,690.50 |  3,381 |  1,714 |  1,667 |
| `quotient_poly_compute_time_ms` |  756.50 |  1,513 |  761 |  752 |
| `quotient_poly_commit_time_ms` |  524 |  1,048 |  526 |  522 |
| `pcs_opening_time_ms ` |  1,067 |  2,134 |  1,072 |  1,062 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,494 | 7,566 | 2,021,609 | 538,660,330 | 5,304 | 752 | 526 | 1,714 | 1,072 | 889 | 155,161,418 | 346 | 768 | 
| leaf | 1 | 1,483 | 7,492 | 1,960,008 | 538,660,330 | 5,255 | 761 | 522 | 1,667 | 1,062 | 891 | 150,243,157 | 345 | 754 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,163 | 4,491 | 2,225,434 | 275,652,919 | 2,950 | 423 | 324 | 754 | 722 | 537 | 93,738,635 | 179 | 378 | 
| regex_program | 1 | 788 | 3,296 | 1,914,993 | 198,099,628 | 2,201 | 304 | 232 | 540 | 596 | 369 | 73,709,236 | 147 | 307 | 

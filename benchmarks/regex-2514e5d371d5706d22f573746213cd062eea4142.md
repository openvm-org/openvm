...
| `total_proof_time_ms ` |  3,898.50 |  7,797 |  4,496 |  3,301 |
| `main_cells_used     ` |  83,694,725 |  167,389,450 |  93,699,990 |  73,689,460 |
| `total_cycles        ` |  2,070,082 |  4,140,164 |  2,225,434 |  1,914,730 |
| `execute_time_ms     ` |  331.50 |  663 |  370 |  293 |
| `trace_gen_time_ms   ` |  980.50 |  1,961 |  1,160 |  801 |
| `stark_prove_excluding_trace_time_ms` |  2,586.50 |  5,173 |  2,966 |  2,207 |
| `main_trace_commit_time_ms` |  448.50 |  897 |  525 |  372 |
| `generate_perm_trace_time_ms` |  165 |  330 |  184 |  146 |
| `perm_trace_commit_time_ms` |  642 |  1,284 |  756 |  528 |
| `quotient_poly_compute_time_ms` |  363 |  726 |  423 |  303 |
| `quotient_poly_commit_time_ms` |  282 |  564 |  333 |  231 |
| `pcs_opening_time_ms ` |  676.50 |  1,353 |  736 |  617 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,618 |  15,236 |  7,693 |  7,543 |
| `main_cells_used     ` |  152,324,151.50 |  304,648,303 |  154,783,528 |  149,864,775 |
| `total_cycles        ` |  1,994,068 |  3,988,136 |  2,024,949 |  1,963,187 |
| `execute_time_ms     ` |  823 |  1,646 |  832 |  814 |
| `trace_gen_time_ms   ` |  1,477.50 |  2,955 |  1,499 |  1,456 |
| `stark_prove_excluding_trace_time_ms` |  5,317.50 |  10,635 |  5,362 |  5,273 |
| `main_trace_commit_time_ms` |  899 |  1,798 |  900 |  898 |
| `generate_perm_trace_time_ms` |  344 |  688 |  358 |  330 |
| `perm_trace_commit_time_ms` |  1,686.50 |  3,373 |  1,716 |  1,657 |
| `quotient_poly_compute_time_ms` |  768 |  1,536 |  770 |  766 |
| `quotient_poly_commit_time_ms` |  534 |  1,068 |  534 |  534 |
| `pcs_opening_time_ms ` |  1,079 |  2,158 |  1,080 |  1,078 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,499 | 7,693 | 2,024,949 | 533,941,738 | 5,362 | 770 | 534 | 1,716 | 1,080 | 898 | 154,783,528 | 358 | 832 | 
| leaf | 1 | 1,456 | 7,543 | 1,963,187 | 533,941,738 | 5,273 | 766 | 534 | 1,657 | 1,078 | 900 | 149,864,775 | 330 | 814 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,160 | 4,496 | 2,225,434 | 275,652,919 | 2,966 | 423 | 333 | 756 | 736 | 525 | 93,699,990 | 184 | 370 | 
| regex_program | 1 | 801 | 3,301 | 1,914,730 | 198,099,628 | 2,207 | 303 | 231 | 528 | 617 | 372 | 73,689,460 | 146 | 293 | 

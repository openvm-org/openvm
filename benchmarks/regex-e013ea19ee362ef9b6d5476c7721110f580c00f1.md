...
| `total_proof_time_ms ` |  1,473 |  2,946 |  1,715 |  1,231 |
...
| `execute_metered_insn_mi/s` |  93.24 | -          |  93.24 |  93.24 |
| `execute_preflight_insns` |  2,054,241.50 |  4,108,483 |  2,211,000 |  1,897,483 |
| `execute_preflight_time_ms` |  94.50 |  189 |  109 |  80 |
| `execute_preflight_insn_mi/s` |  31.95 | -          |  33.66 |  30.23 |
| `trace_gen_time_ms   ` |  314.50 |  629 |  335 |  294 |
| `memory_finalize_time_ms` |  1.50 |  3 |  3 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  975.50 |  1,951 |  1,212 |  739 |
| `main_trace_commit_time_ms` |  142 |  284 |  185 |  99 |
| `generate_perm_trace_time_ms` |  57 |  114 |  69 |  45 |
| `perm_trace_commit_time_ms` |  172.74 |  345.48 |  224.53 |  120.96 |
| `quotient_poly_compute_time_ms` |  157.45 |  314.89 |  167.53 |  147.36 |
| `quotient_poly_commit_time_ms` |  36.31 |  72.62 |  47.79 |  24.83 |
| `pcs_opening_time_ms ` |  403 |  806 |  534 |  272 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  2,057 |  4,114 |  2,824 |  1,290 |
| `main_cells_used     ` |  14,798,849 |  29,597,698 |  20,272,474 |  9,325,224 |
| `total_cells_used    ` |  37,032,585 |  74,065,170 |  50,586,080 |  23,479,090 |
| `execute_preflight_insns` |  1,663,263.50 |  3,326,527 |  1,829,982 |  1,496,545 |
| `execute_preflight_time_ms` |  577.50 |  1,155 |  893 |  262 |
| `execute_preflight_insn_mi/s` |  7.10 | -          |  7.35 |  6.85 |
| `trace_gen_time_ms   ` |  122.50 |  245 |  169 |  76 |
| `memory_finalize_time_ms` |  12.50 |  25 |  18 |  7 |
| `stark_prove_excluding_trace_time_ms` |  1,356 |  2,712 |  1,761 |  951 |
| `main_trace_commit_time_ms` |  180.50 |  361 |  229 |  132 |
| `generate_perm_trace_time_ms` |  69.50 |  139 |  86 |  53 |
| `perm_trace_commit_time_ms` |  278.39 |  556.78 |  369.20 |  187.58 |
| `quotient_poly_compute_time_ms` |  178.07 |  356.14 |  230.22 |  125.92 |
| `quotient_poly_commit_time_ms` |  44.39 |  88.78 |  58.54 |  30.23 |
| `pcs_opening_time_ms ` |  601 |  1,202 |  783 |  419 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 2,826 |  | 1 |  | 1 |  |  |  |  | 
| regex_program |  | 1,231 |  | 40 | 1 | 44 | 4,108,483 | 93.24 | 166 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 76 | 1,290 | 23,479,090 | 319,626,730 | 76 | 951 | 0 | 125.92 | 30.23 | 4 | 187.58 | 419 | 242 | 419 | 7 | 132 | 9,325,224 | 53 | 262 | 1,496,545 | 7.35 | 29 | 157 | 1 | 419 | 
| leaf | 1 | 169 | 2,824 | 50,586,080 | 538,660,330 | 169 | 1,761 | 0 | 230.22 | 58.54 | 5 | 369.20 | 783 | 456 | 783 | 18 | 229 | 20,272,474 | 86 | 893 | 1,829,982 | 6.85 | 56 | 291 | 1 | 783 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 294 | 1,715 | 23,397,108 | 373,183,036 | 294 | 1,212 | 0 | 147.36 | 47.79 | 6 | 224.53 | 534 | 295 | 534 | 3 | 185 | 10,866,434 | 69 | 80 | 2,211,000 | 30.23 | 46 | 197 | 2 | 534 | 
| regex_program | 1 | 335 | 1,231 | 11,981,356 | 196,739,722 | 334 | 739 | 2 | 167.53 | 24.83 | 6 | 120.96 | 272 | 169 | 272 | 0 | 99 | 2,537,170 | 45 | 109 | 1,897,483 | 33.66 | 26 | 197 | 2 | 272 | 

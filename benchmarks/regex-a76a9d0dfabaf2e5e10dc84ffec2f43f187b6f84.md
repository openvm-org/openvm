...
| `total_proof_time_ms ` |  573.50 |  2,294 |  690 |  524 |
...
| `execute_metered_insn_mi/s` |  121.96 | -          |  121.96 |  121.96 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  54.50 |  218 |  66 |  46 |
| `execute_preflight_insn_mi/s` |  30.27 | -          |  31.52 |  27.44 |
| `trace_gen_time_ms   ` |  177.75 |  711 |  211 |  153 |
| `memory_finalize_time_ms` |  1 |  4 |  4 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  273.50 |  1,094 |  287 |  262 |
| `main_trace_commit_time_ms` |  52 |  208 |  57 |  50 |
| `generate_perm_trace_time_ms` |  25.50 |  102 |  33 |  22 |
| `perm_trace_commit_time_ms` |  65.16 |  260.66 |  71.94 |  55.76 |
| `quotient_poly_compute_time_ms` |  58.54 |  234.15 |  70.27 |  51.98 |
| `quotient_poly_commit_time_ms` |  15.07 |  60.27 |  17.07 |  13.24 |
| `pcs_opening_time_ms ` |  54 |  216 |  55 |  51 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,379.75 |  5,519 |  1,990 |  918 |
...
| `execute_preflight_insns` |  1,440,876.50 |  5,763,506 |  1,814,597 |  1,241,403 |
| `execute_preflight_time_ms` |  615.50 |  2,462 |  798 |  230 |
| `execute_preflight_insn_mi/s` |  6.92 | -          |  7.23 |  6.72 |
| `trace_gen_time_ms   ` |  86.50 |  346 |  162 |  57 |
| `memory_finalize_time_ms` |  8 |  32 |  15 |  5 |
| `stark_prove_excluding_trace_time_ms` |  676.75 |  2,707 |  1,060 |  502 |
| `main_trace_commit_time_ms` |  124.75 |  499 |  193 |  91 |
| `generate_perm_trace_time_ms` |  62 |  248 |  72 |  55 |
| `perm_trace_commit_time_ms` |  199.42 |  797.67 |  343.44 |  140.78 |
| `quotient_poly_compute_time_ms` |  141.72 |  566.90 |  231.100 |  101.08 |
| `quotient_poly_commit_time_ms` |  30.80 |  123.22 |  50.65 |  23.14 |
| `pcs_opening_time_ms ` |  114.25 |  457 |  164 |  81 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 1,992 |  | 1 |  | 1 |  |  |  |  | 
| regex_program |  | 554 |  | 41 | 1 | 33 | 4,137,502 | 121.96 | 166 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 69 | 918 | 22,981,570 | 319,331,818 | 69 | 618 | 0 | 132.05 | 25.22 | 4 | 170.50 | 109 | 226 | 109 | 7 | 123 | 9,122,488 | 55 | 230 | 1,466,031 | 7.23 | 30 | 158 | 0 | 109 | 
| leaf | 1 | 58 | 1,359 | 20,905,034 | 255,237,610 | 58 | 502 | 0 | 101.08 | 23.14 | 4 | 142.94 | 81 | 202 | 81 | 5 | 92 | 8,256,948 | 58 | 798 | 1,241,403 | 6.79 | 25 | 125 | 0 | 81 | 
| leaf | 2 | 57 | 1,252 | 20,905,034 | 255,237,610 | 57 | 527 | 0 | 101.77 | 24.20 | 4 | 140.78 | 103 | 205 | 102 | 5 | 91 | 8,256,948 | 63 | 667 | 1,241,475 | 6.92 | 26 | 126 | 0 | 102 | 
| leaf | 3 | 162 | 1,990 | 50,337,320 | 538,365,418 | 162 | 1,060 | 0 | 231.100 | 50.65 | 4 | 343.44 | 164 | 416 | 163 | 15 | 193 | 20,171,106 | 72 | 767 | 1,814,597 | 6.72 | 61 | 286 | 5 | 163 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 211 | 690 | 23,446,148 | 150,778,428 | 211 | 287 | 0 | 59.06 | 17.07 | 5 | 71.94 | 55 | 96 | 55 | 4 | 57 | 10,899,170 | 23 | 47 | 1,103,000 | 27.44 | 21 | 76 | 1 | 55 | 
| regex_program | 1 | 153 | 524 | 11,598,276 | 128,513,066 | 153 | 262 | 1 | 51.98 | 14.94 | 4 | 66.11 | 55 | 89 | 55 | 0 | 50 | 2,196,106 | 22 | 66 | 1,104,000 | 31.52 | 17 | 67 | 0 | 55 | 
| regex_program | 2 | 163 | 526 | 11,579,064 | 128,513,066 | 163 | 262 | 1 | 52.84 | 15.01 | 4 | 66.85 | 51 | 91 | 50 | 0 | 51 | 2,177,334 | 24 | 59 | 1,104,000 | 30.85 | 16 | 68 | 0 | 50 | 
| regex_program | 3 | 184 | 554 | 11,853,872 | 103,456,394 | 183 | 283 | 0 | 70.27 | 13.24 | 5 | 55.76 | 55 | 92 | 55 | 0 | 50 | 2,422,606 | 33 | 46 | 826,502 | 31.26 | 18 | 84 | 1 | 55 | 

...
| `quotient_poly_compute_time_ms` |  291 |  291 |  291 |  291 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  42,435 |  42,435 |  42,435 |  42,435 |
| `main_cells_used     ` |  365,885,227 |  365,885,227 |  365,885,227 |  365,885,227 |
| `total_cycles        ` |  8,652,418 |  8,652,418 |  8,652,418 |  8,652,418 |
| `execute_time_ms     ` |  2,496 |  2,496 |  2,496 |  2,496 |
| `trace_gen_time_ms   ` |  6,388 |  6,388 |  6,388 |  6,388 |
| `stark_prove_excluding_trace_time_ms` |  33,551 |  33,551 |  33,551 |  33,551 |
| `main_trace_commit_time_ms` |  5,791 |  5,791 |  5,791 |  5,791 |
| `generate_perm_trace_time_ms` |  708 |  708 |  708 |  708 |
| `perm_trace_commit_time_ms` |  7,307 |  7,307 |  7,307 |  7,307 |
| `quotient_poly_compute_time_ms` |  8,010 |  8,010 |  8,010 |  8,010 |
| `quotient_poly_commit_time_ms` |  5,299 |  5,299 |  5,299 |  5,299 |
| `pcs_opening_time_ms ` |  6,433 |  6,433 |  6,433 |  6,433 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 6,388 | 42,435 | 8,652,418 | 1,052,183,000 | 33,551 | 8,010 | 5,299 | 7,307 | 6,433 | 5,791 | 365,885,227 | 708 | 2,496 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 261 | 2,602 | 285,401 | 56,172,159 | 2,188 | 291 | 302 | 531 | 626 | 395 | 15,092,297 | 40 | 153 | 

...
| `total_proof_time_ms ` |  3,985 |  7,970 |  4,588 |  3,382 |
| `main_cells_used     ` |  83,694,725 |  167,389,450 |  93,699,990 |  73,689,460 |
| `total_cycles        ` |  2,070,082 |  4,140,164 |  2,225,434 |  1,914,730 |
| `execute_time_ms     ` |  337.50 |  675 |  374 |  301 |
| `trace_gen_time_ms   ` |  960 |  1,920 |  1,136 |  784 |
| `stark_prove_excluding_trace_time_ms` |  2,687.50 |  5,375 |  3,078 |  2,297 |
| `main_trace_commit_time_ms` |  500 |  1,000 |  589 |  411 |
| `generate_perm_trace_time_ms` |  166.50 |  333 |  192 |  141 |
| `perm_trace_commit_time_ms` |  696.50 |  1,393 |  808 |  585 |
| `quotient_poly_compute_time_ms` |  364 |  728 |  425 |  303 |
| `quotient_poly_commit_time_ms` |  288.50 |  577 |  337 |  240 |
| `pcs_opening_time_ms ` |  663 |  1,326 |  718 |  608 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,482.50 |  14,965 |  7,549 |  7,416 |
| `main_cells_used     ` |  152,233,322 |  304,466,644 |  154,691,624 |  149,775,020 |
| `total_cycles        ` |  1,990,759 |  3,981,518 |  2,021,617 |  1,959,901 |
| `execute_time_ms     ` |  761.50 |  1,523 |  767 |  756 |
| `trace_gen_time_ms   ` |  1,479 |  2,958 |  1,519 |  1,439 |
| `stark_prove_excluding_trace_time_ms` |  5,242 |  10,484 |  5,263 |  5,221 |
| `main_trace_commit_time_ms` |  892.50 |  1,785 |  893 |  892 |
| `generate_perm_trace_time_ms` |  340.50 |  681 |  343 |  338 |
| `perm_trace_commit_time_ms` |  1,645.50 |  3,291 |  1,670 |  1,621 |
| `quotient_poly_compute_time_ms` |  764.50 |  1,529 |  766 |  763 |
| `quotient_poly_commit_time_ms` |  527.50 |  1,055 |  532 |  523 |
| `pcs_opening_time_ms ` |  1,064.50 |  2,129 |  1,066 |  1,063 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,519 | 7,549 | 2,021,617 | 533,941,738 | 5,263 | 763 | 523 | 1,670 | 1,063 | 892 | 154,691,624 | 343 | 767 | 
| leaf | 1 | 1,439 | 7,416 | 1,959,901 | 533,941,738 | 5,221 | 766 | 532 | 1,621 | 1,066 | 893 | 149,775,020 | 338 | 756 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,136 | 4,588 | 2,225,434 | 275,652,919 | 3,078 | 425 | 337 | 808 | 718 | 589 | 93,699,990 | 192 | 374 | 
| regex_program | 1 | 784 | 3,382 | 1,914,730 | 198,099,628 | 2,297 | 303 | 240 | 585 | 608 | 411 | 73,689,460 | 141 | 301 | 

...
| `total_proof_time_ms ` |  2,761 |  2,761 |  2,761 |  2,761 |
| `main_cells_used     ` |  51,485,167 |  51,485,167 |  51,485,167 |  51,485,167 |
| `total_cycles        ` |  1,500,096 |  1,500,096 |  1,500,096 |  1,500,096 |
| `execute_time_ms     ` |  237 |  237 |  237 |  237 |
| `trace_gen_time_ms   ` |  543 |  543 |  543 |  543 |
| `stark_prove_excluding_trace_time_ms` |  1,981 |  1,981 |  1,981 |  1,981 |
| `main_trace_commit_time_ms` |  356 |  356 |  356 |  356 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  3,840 |  3,840 |  3,840 |  3,840 |
| `main_cells_used     ` |  70,291,128 |  70,291,128 |  70,291,128 |  70,291,128 |
| `total_cycles        ` |  1,265,550 |  1,265,550 |  1,265,550 |  1,265,550 |
| `execute_time_ms     ` |  522 |  522 |  522 |  522 |
| `trace_gen_time_ms   ` |  646 |  646 |  646 |  646 |
| `stark_prove_excluding_trace_time_ms` |  2,672 |  2,672 |  2,672 |  2,672 |
| `main_trace_commit_time_ms` |  466 |  466 |  466 |  466 |
| `generate_perm_trace_time_ms` |  155 |  155 |  155 |  155 |
| `perm_trace_commit_time_ms` |  764 |  764 |  764 |  764 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 646 | 3,840 | 1,265,550 | 251,993,578 | 2,672 | 374 | 291 | 764 | 618 | 466 | 70,291,128 | 155 | 522 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 543 | 2,761 | 1,500,096 | 160,733,916 | 1,981 | 251 | 232 | 505 | 503 | 356 | 51,485,167 | 130 | 237 | 

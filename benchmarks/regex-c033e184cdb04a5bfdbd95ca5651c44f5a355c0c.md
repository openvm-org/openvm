...
| `total_proof_time_ms ` |  3,930.50 |  7,861 |  4,359 |  3,502 |
| `main_cells_used     ` |  83,259,728 |  166,519,456 |  93,502,875 |  73,016,581 |
| `total_cycles        ` |  2,082,716 |  4,165,432 |  2,243,715 |  1,921,717 |
| `execute_time_ms     ` |  353 |  706 |  393 |  313 |
| `trace_gen_time_ms   ` |  991 |  1,982 |  1,182 |  800 |
| `stark_prove_excluding_trace_time_ms` |  2,586.50 |  5,173 |  2,784 |  2,389 |
| `main_trace_commit_time_ms` |  499 |  998 |  556 |  442 |
| `generate_perm_trace_time_ms` |  223 |  446 |  237 |  209 |
| `perm_trace_commit_time_ms` |  544.50 |  1,089 |  571 |  518 |
| `quotient_poly_compute_time_ms` |  273.50 |  547 |  302 |  245 |
| `quotient_poly_commit_time_ms` |  239 |  478 |  274 |  204 |
| `pcs_opening_time_ms ` |  798 |  1,596 |  834 |  762 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  6,979.50 |  13,959 |  7,103 |  6,856 |
| `main_cells_used     ` |  150,211,301.50 |  300,422,603 |  154,228,118 |  146,194,485 |
| `total_cycles        ` |  1,937,108.50 |  3,874,217 |  2,006,589 |  1,867,628 |
| `execute_time_ms     ` |  773 |  1,546 |  787 |  759 |
| `trace_gen_time_ms   ` |  1,460.50 |  2,921 |  1,531 |  1,390 |
| `stark_prove_excluding_trace_time_ms` |  4,746 |  9,492 |  4,785 |  4,707 |
| `main_trace_commit_time_ms` |  863 |  1,726 |  864 |  862 |
| `generate_perm_trace_time_ms` |  410 |  820 |  427 |  393 |
| `perm_trace_commit_time_ms` |  1,244 |  2,488 |  1,254 |  1,234 |
| `quotient_poly_compute_time_ms` |  523 |  1,046 |  530 |  516 |
| `quotient_poly_commit_time_ms` |  409.50 |  819 |  410 |  409 |
| `pcs_opening_time_ms ` |  1,292 |  2,584 |  1,309 |  1,275 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,531 | 7,103 | 2,006,589 | 538,660,330 | 4,785 | 516 | 410 | 1,254 | 1,309 | 864 | 154,228,118 | 427 | 787 | 
| leaf | 1 | 1,390 | 6,856 | 1,867,628 | 538,660,330 | 4,707 | 530 | 409 | 1,234 | 1,275 | 862 | 146,194,485 | 393 | 759 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,182 | 4,359 | 2,243,715 | 275,652,919 | 2,784 | 302 | 274 | 571 | 834 | 556 | 93,502,875 | 237 | 393 | 
| regex_program | 1 | 800 | 3,502 | 1,921,717 | 242,975,388 | 2,389 | 245 | 204 | 518 | 762 | 442 | 73,016,581 | 209 | 313 | 

...
| `total_proof_time_ms ` |  3,949.50 |  7,899 |  4,368 |  3,531 |
| `main_cells_used     ` |  83,255,576 |  166,511,152 |  93,500,799 |  73,010,353 |
| `total_cycles        ` |  2,082,613 |  4,165,226 |  2,243,715 |  1,921,511 |
| `execute_time_ms     ` |  358 |  716 |  399 |  317 |
| `trace_gen_time_ms   ` |  977.50 |  1,955 |  1,141 |  814 |
| `stark_prove_excluding_trace_time_ms` |  2,614 |  5,228 |  2,828 |  2,400 |
| `main_trace_commit_time_ms` |  499.50 |  999 |  557 |  442 |
| `generate_perm_trace_time_ms` |  214.50 |  429 |  221 |  208 |
| `perm_trace_commit_time_ms` |  544 |  1,088 |  571 |  517 |
| `quotient_poly_compute_time_ms` |  267 |  534 |  286 |  248 |
| `quotient_poly_commit_time_ms` |  242 |  484 |  275 |  209 |
| `pcs_opening_time_ms ` |  837 |  1,674 |  907 |  767 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  6,985 |  13,970 |  7,041 |  6,929 |
| `main_cells_used     ` |  151,827,809 |  303,655,618 |  154,227,878 |  149,427,740 |
| `total_cycles        ` |  1,975,724 |  3,951,448 |  2,006,569 |  1,944,879 |
| `execute_time_ms     ` |  782 |  1,564 |  791 |  773 |
| `trace_gen_time_ms   ` |  1,473 |  2,946 |  1,489 |  1,457 |
| `stark_prove_excluding_trace_time_ms` |  4,730 |  9,460 |  4,761 |  4,699 |
| `main_trace_commit_time_ms` |  865 |  1,730 |  865 |  865 |
| `generate_perm_trace_time_ms` |  394 |  788 |  417 |  371 |
| `perm_trace_commit_time_ms` |  1,241.50 |  2,483 |  1,246 |  1,237 |
| `quotient_poly_compute_time_ms` |  529.50 |  1,059 |  532 |  527 |
| `quotient_poly_commit_time_ms` |  412 |  824 |  414 |  410 |
| `pcs_opening_time_ms ` |  1,282 |  2,564 |  1,284 |  1,280 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,489 | 7,041 | 2,006,569 | 538,660,330 | 4,761 | 532 | 410 | 1,246 | 1,284 | 865 | 154,227,878 | 417 | 791 | 
| leaf | 1 | 1,457 | 6,929 | 1,944,879 | 538,660,330 | 4,699 | 527 | 414 | 1,237 | 1,280 | 865 | 149,427,740 | 371 | 773 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,141 | 4,368 | 2,243,715 | 275,652,919 | 2,828 | 286 | 275 | 571 | 907 | 557 | 93,500,799 | 221 | 399 | 
| regex_program | 1 | 814 | 3,531 | 1,921,511 | 242,975,404 | 2,400 | 248 | 209 | 517 | 767 | 442 | 73,010,353 | 208 | 317 | 

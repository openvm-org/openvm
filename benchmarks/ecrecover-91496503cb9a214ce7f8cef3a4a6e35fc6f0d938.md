...
| `stark_prove_excluding_trace_time_ms` |  2,137 |  2,137 |  2,137 |  2,137 |
...
| `pcs_opening_time_ms ` |  654 |  654 |  654 |  654 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  11,239 |  11,239 |  11,239 |  11,239 |
...
| `trace_gen_time_ms   ` |  1,537 |  1,537 |  1,537 |  1,537 |
| `stark_prove_excluding_trace_time_ms` |  9,137 |  9,137 |  9,137 |  9,137 |
| `main_trace_commit_time_ms` |  1,886 |  1,886 |  1,886 |  1,886 |
| `generate_perm_trace_time_ms` |  264 |  264 |  264 |  264 |
| `perm_trace_commit_time_ms` |  2,017 |  2,017 |  2,017 |  2,017 |
| `quotient_poly_compute_time_ms` |  1,459 |  1,459 |  1,459 |  1,459 |
| `quotient_poly_commit_time_ms` |  1,679 |  1,679 |  1,679 |  1,679 |
| `pcs_opening_time_ms ` |  1,828 |  1,828 |  1,828 |  1,828 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,537 | 11,239 | 1,604,010 | 334,709,720 | 9,137 | 1,459 | 1,679 | 2,017 | 1,828 | 1,886 | 117,320,910 | 264 | 565 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 182 | 2,467 | 284,567 | 38,417,467 | 2,137 | 228 | 468 | 354 | 654 | 386 | 15,055,723 | 34 | 148 | 

...
| `total_proof_time_ms ` |  3,941.50 |  7,883 |  4,327 |  3,556 |
| `main_cells_used     ` |  83,255,576 |  166,511,152 |  93,500,799 |  73,010,353 |
| `total_cycles        ` |  2,082,613 |  4,165,226 |  2,243,715 |  1,921,511 |
| `execute_time_ms     ` |  354 |  708 |  393 |  315 |
| `trace_gen_time_ms   ` |  967.50 |  1,935 |  1,128 |  807 |
| `stark_prove_excluding_trace_time_ms` |  2,620 |  5,240 |  2,806 |  2,434 |
| `main_trace_commit_time_ms` |  499.50 |  999 |  557 |  442 |
| `generate_perm_trace_time_ms` |  221 |  442 |  235 |  207 |
| `perm_trace_commit_time_ms` |  545 |  1,090 |  574 |  516 |
| `quotient_poly_compute_time_ms` |  275 |  550 |  293 |  257 |
| `quotient_poly_commit_time_ms` |  258.50 |  517 |  279 |  238 |
| `pcs_opening_time_ms ` |  811.50 |  1,623 |  859 |  764 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  6,981 |  13,962 |  7,039 |  6,923 |
| `main_cells_used     ` |  151,828,199 |  303,656,398 |  154,228,202 |  149,428,196 |
| `total_cycles        ` |  1,975,756.50 |  3,951,513 |  2,006,596 |  1,944,917 |
| `execute_time_ms     ` |  772 |  1,544 |  778 |  766 |
| `trace_gen_time_ms   ` |  1,464.50 |  2,929 |  1,473 |  1,456 |
| `stark_prove_excluding_trace_time_ms` |  4,744.50 |  9,489 |  4,788 |  4,701 |
| `main_trace_commit_time_ms` |  866.50 |  1,733 |  867 |  866 |
| `generate_perm_trace_time_ms` |  391.50 |  783 |  413 |  370 |
| `perm_trace_commit_time_ms` |  1,239.50 |  2,479 |  1,242 |  1,237 |
| `quotient_poly_compute_time_ms` |  541 |  1,082 |  564 |  518 |
| `quotient_poly_commit_time_ms` |  414 |  828 |  416 |  412 |
| `pcs_opening_time_ms ` |  1,286 |  2,572 |  1,287 |  1,285 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,473 | 7,039 | 2,006,596 | 538,660,330 | 4,788 | 564 | 412 | 1,242 | 1,285 | 867 | 154,228,202 | 413 | 778 | 
| leaf | 1 | 1,456 | 6,923 | 1,944,917 | 538,660,330 | 4,701 | 518 | 416 | 1,237 | 1,287 | 866 | 149,428,196 | 370 | 766 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,128 | 4,327 | 2,243,715 | 275,652,919 | 2,806 | 293 | 279 | 574 | 859 | 557 | 93,500,799 | 235 | 393 | 
| regex_program | 1 | 807 | 3,556 | 1,921,511 | 242,975,404 | 2,434 | 257 | 238 | 516 | 764 | 442 | 73,010,353 | 207 | 315 | 

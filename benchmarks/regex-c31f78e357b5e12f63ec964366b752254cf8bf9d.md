...
| `total_proof_time_ms ` |  740.25 |  2,961 |  864 |  673 |
...
| `execute_metered_insn_mi/s` |  120.98 | -          |  120.98 |  120.98 |
| `execute_preflight_insns` |  1,027,120.75 |  4,108,483 |  1,108,000 |  790,483 |
| `execute_preflight_time_ms` |  52.50 |  210 |  63 |  44 |
| `execute_preflight_insn_mi/s` |  32.12 | -          |  33.15 |  29.21 |
| `trace_gen_time_ms   ` |  195.25 |  781 |  229 |  173 |
| `memory_finalize_time_ms` |  1 |  4 |  4 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  423.75 |  1,695 |  458 |  395 |
| `main_trace_commit_time_ms` |  56.50 |  226 |  62 |  53 |
| `generate_perm_trace_time_ms` |  34 |  136 |  38 |  29 |
| `perm_trace_commit_time_ms` |  68.68 |  274.70 |  74.53 |  58.84 |
| `quotient_poly_compute_time_ms` |  73.26 |  293.04 |  132.74 |  51.34 |
| `quotient_poly_commit_time_ms` |  17.89 |  71.57 |  19.69 |  15.22 |
| `pcs_opening_time_ms ` |  170.50 |  682 |  186 |  158 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,749 |  6,996 |  2,676 |  1,226 |
...
| `execute_preflight_insns` |  1,440,904 |  5,763,616 |  1,814,601 |  1,241,431 |
| `execute_preflight_time_ms` |  617.50 |  2,470 |  797 |  227 |
| `execute_preflight_insn_mi/s` |  6.98 | -          |  7.35 |  6.75 |
| `trace_gen_time_ms   ` |  94.25 |  377 |  181 |  60 |
| `memory_finalize_time_ms` |  8.25 |  33 |  16 |  5 |
| `stark_prove_excluding_trace_time_ms` |  1,036.50 |  4,146 |  1,724 |  746 |
| `main_trace_commit_time_ms` |  133.25 |  533 |  206 |  98 |
| `generate_perm_trace_time_ms` |  50 |  200 |  77 |  37 |
| `perm_trace_commit_time_ms` |  210.07 |  840.27 |  358.08 |  149.22 |
| `quotient_poly_compute_time_ms` |  136.10 |  544.39 |  224.76 |  96.56 |
| `quotient_poly_commit_time_ms` |  35.11 |  140.44 |  58.14 |  26.20 |
| `pcs_opening_time_ms ` |  468 |  1,872 |  794 |  331 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 2,678 |  | 1 |  | 1 |  |  |  |  | 
| regex_program |  | 742 |  | 66 | 1 | 33 | 4,108,483 | 120.98 | 193 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 75 | 1,226 | 22,981,570 | 319,331,818 | 75 | 924 | 0 | 124.52 | 28.80 | 4 | 181.44 | 410 | 227 | 410 | 6 | 131 | 9,122,488 | 45 | 227 | 1,466,110 | 7.35 | 29 | 154 | 1 | 410 | 
| leaf | 1 | 60 | 1,604 | 20,905,034 | 255,237,610 | 60 | 746 | 0 | 96.56 | 27.31 | 4 | 149.22 | 331 | 191 | 331 | 6 | 98 | 8,256,948 | 41 | 797 | 1,241,431 | 6.95 | 25 | 124 | 1 | 331 | 
| leaf | 2 | 61 | 1,490 | 20,905,034 | 255,237,610 | 61 | 752 | 0 | 98.54 | 26.20 | 4 | 151.53 | 337 | 190 | 337 | 5 | 98 | 8,256,948 | 37 | 676 | 1,241,474 | 6.88 | 24 | 125 | 1 | 337 | 
| leaf | 3 | 181 | 2,676 | 50,337,320 | 538,365,418 | 181 | 1,724 | 0 | 224.76 | 58.14 | 4 | 358.08 | 794 | 436 | 794 | 16 | 206 | 20,171,106 | 77 | 770 | 1,814,601 | 6.75 | 59 | 286 | 6 | 794 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 229 | 864 | 23,395,260 | 150,778,428 | 229 | 440 | 0 | 57 | 19.69 | 5 | 74.53 | 186 | 114 | 186 | 4 | 62 | 10,864,634 | 38 | 45 | 1,102,000 | 29.21 | 19 | 77 | 2 | 186 | 
| regex_program | 1 | 173 | 673 | 11,589,074 | 132,682,794 | 173 | 395 | 1 | 51.34 | 18.40 | 5 | 70.53 | 168 | 99 | 168 | 0 | 56 | 2,191,608 | 29 | 63 | 1,108,000 | 33.12 | 16 | 70 | 1 | 168 | 
| regex_program | 2 | 181 | 682 | 11,583,256 | 132,682,794 | 181 | 402 | 1 | 51.96 | 18.27 | 5 | 70.80 | 170 | 105 | 170 | 0 | 55 | 2,185,918 | 34 | 58 | 1,108,000 | 33.15 | 16 | 70 | 1 | 170 | 
| regex_program | 3 | 198 | 742 | 11,847,840 | 103,522,954 | 198 | 458 | 0 | 132.74 | 15.22 | 6 | 58.84 | 158 | 97 | 158 | 0 | 53 | 2,420,726 | 35 | 44 | 790,483 | 33.01 | 17 | 149 | 2 | 158 | 

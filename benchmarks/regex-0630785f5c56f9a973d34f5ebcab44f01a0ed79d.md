...
| `total_proof_time_ms ` |  3,891.50 |  7,783 |  4,475 |  3,308 |
| `main_cells_used     ` |  83,700,179 |  167,400,358 |  93,701,806 |  73,698,552 |
| `total_cycles        ` |  2,070,120 |  4,140,240 |  2,225,434 |  1,914,806 |
| `execute_time_ms     ` |  335.50 |  671 |  372 |  299 |
| `trace_gen_time_ms   ` |  989 |  1,978 |  1,174 |  804 |
| `stark_prove_excluding_trace_time_ms` |  2,567 |  5,134 |  2,929 |  2,205 |
| `main_trace_commit_time_ms` |  447.50 |  895 |  524 |  371 |
| `generate_perm_trace_time_ms` |  160.50 |  321 |  180 |  141 |
| `perm_trace_commit_time_ms` |  646.50 |  1,293 |  748 |  545 |
| `quotient_poly_compute_time_ms` |  359.50 |  719 |  416 |  303 |
| `quotient_poly_commit_time_ms` |  278 |  556 |  323 |  233 |
| `pcs_opening_time_ms ` |  665.50 |  1,331 |  729 |  602 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,498 |  14,996 |  7,598 |  7,398 |
| `main_cells_used     ` |  152,233,322 |  304,466,644 |  154,691,084 |  149,775,560 |
| `total_cycles        ` |  1,990,759 |  3,981,518 |  2,021,572 |  1,959,946 |
| `execute_time_ms     ` |  759 |  1,518 |  765 |  753 |
| `trace_gen_time_ms   ` |  1,456 |  2,912 |  1,515 |  1,397 |
| `stark_prove_excluding_trace_time_ms` |  5,283 |  10,566 |  5,318 |  5,248 |
| `main_trace_commit_time_ms` |  895 |  1,790 |  896 |  894 |
| `generate_perm_trace_time_ms` |  348.50 |  697 |  359 |  338 |
| `perm_trace_commit_time_ms` |  1,679 |  3,358 |  1,707 |  1,651 |
| `quotient_poly_compute_time_ms` |  766.50 |  1,533 |  767 |  766 |
| `quotient_poly_commit_time_ms` |  527.50 |  1,055 |  528 |  527 |
| `pcs_opening_time_ms ` |  1,061 |  2,122 |  1,065 |  1,057 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,515 | 7,598 | 2,021,572 | 533,941,738 | 5,318 | 766 | 527 | 1,707 | 1,057 | 896 | 154,691,084 | 359 | 765 | 
| leaf | 1 | 1,397 | 7,398 | 1,959,946 | 533,941,738 | 5,248 | 767 | 528 | 1,651 | 1,065 | 894 | 149,775,560 | 338 | 753 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,174 | 4,475 | 2,225,434 | 275,652,919 | 2,929 | 416 | 323 | 748 | 729 | 524 | 93,701,806 | 180 | 372 | 
| regex_program | 1 | 804 | 3,308 | 1,914,806 | 198,099,628 | 2,205 | 303 | 233 | 545 | 602 | 371 | 73,698,552 | 141 | 299 | 

...
| `total_proof_time_ms ` |  7,617 |  15,234 |  8,541 |  6,693 |
| `main_cells_used     ` |  82,727,686.50 |  165,455,373 |  92,686,348 |  72,769,025 |
| `total_cycles        ` |  1,914,103 |  1,914,103 |  1,914,103 |  1,914,103 |
| `execute_time_ms     ` |  449 |  898 |  483 |  415 |
| `trace_gen_time_ms   ` |  1,687.50 |  3,375 |  1,889 |  1,486 |
| `stark_prove_excluding_trace_time_ms` |  5,480.50 |  10,961 |  6,169 |  4,792 |
| `main_trace_commit_time_ms` |  1,103 |  2,206 |  1,329 |  877 |
| `generate_perm_trace_time_ms` |  177 |  354 |  189 |  165 |
| `perm_trace_commit_time_ms` |  1,166 |  2,332 |  1,240 |  1,092 |
| `quotient_poly_compute_time_ms` |  735.50 |  1,471 |  854 |  617 |
| `quotient_poly_commit_time_ms` |  963 |  1,926 |  1,117 |  809 |
| `pcs_opening_time_ms ` |  1,326.50 |  2,653 |  1,432 |  1,221 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  14,604.50 |  29,209 |  14,667 |  14,542 |
| `main_cells_used     ` |  129,446,772 |  258,893,544 |  131,045,807 |  127,847,737 |
| `total_cycles        ` |  2,941,580 |  5,883,160 |  2,977,830 |  2,905,330 |
| `execute_time_ms     ` |  634 |  1,268 |  672 |  596 |
| `trace_gen_time_ms   ` |  2,591 |  5,182 |  2,697 |  2,485 |
| `stark_prove_excluding_trace_time_ms` |  11,379.50 |  22,759 |  11,385 |  11,374 |
| `main_trace_commit_time_ms` |  2,353 |  4,706 |  2,370 |  2,336 |
| `generate_perm_trace_time_ms` |  278.50 |  557 |  281 |  276 |
| `perm_trace_commit_time_ms` |  2,288 |  4,576 |  2,305 |  2,271 |
| `quotient_poly_compute_time_ms` |  1,641.50 |  3,283 |  1,648 |  1,635 |
| `quotient_poly_commit_time_ms` |  2,214 |  4,428 |  2,215 |  2,213 |
| `pcs_opening_time_ms ` |  2,599 |  5,198 |  2,601 |  2,597 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 2,485 | 14,542 | 2,977,830 | 353,773,272 | 11,385 | 1,648 | 2,213 | 2,305 | 2,597 | 2,336 | 131,045,807 | 281 | 672 | 
| leaf | 1 | 2,697 | 14,667 | 2,905,330 | 353,780,696 | 11,374 | 1,635 | 2,215 | 2,271 | 2,601 | 2,370 | 127,847,737 | 276 | 596 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,889 | 8,541 |  | 209,921,543 | 6,169 | 854 | 1,117 | 1,240 | 1,432 | 1,329 | 92,686,348 | 189 | 483 | 
| regex_program | 1 | 1,486 | 6,693 | 1,914,103 | 149,454,692 | 4,792 | 617 | 809 | 1,092 | 1,221 | 877 | 72,769,025 | 165 | 415 | 

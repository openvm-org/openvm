...
| `total_proof_time_ms ` |  3,917.50 |  7,835 |  4,351 |  3,484 |
| `main_cells_used     ` |  83,255,576 |  166,511,152 |  93,500,799 |  73,010,353 |
| `total_cycles        ` |  2,082,613 |  4,165,226 |  2,243,715 |  1,921,511 |
| `execute_time_ms     ` |  354.50 |  709 |  394 |  315 |
| `trace_gen_time_ms   ` |  966 |  1,932 |  1,177 |  755 |
| `stark_prove_excluding_trace_time_ms` |  2,597 |  5,194 |  2,780 |  2,414 |
| `main_trace_commit_time_ms` |  501.50 |  1,003 |  559 |  444 |
| `generate_perm_trace_time_ms` |  214 |  428 |  220 |  208 |
| `perm_trace_commit_time_ms` |  547.50 |  1,095 |  576 |  519 |
| `quotient_poly_compute_time_ms` |  259 |  518 |  279 |  239 |
| `quotient_poly_commit_time_ms` |  247.50 |  495 |  281 |  214 |
| `pcs_opening_time_ms ` |  818.50 |  1,637 |  855 |  782 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  6,992.50 |  13,985 |  7,066 |  6,919 |
| `main_cells_used     ` |  151,827,941 |  303,655,882 |  154,227,494 |  149,428,388 |
| `total_cycles        ` |  1,975,735 |  3,951,470 |  2,006,537 |  1,944,933 |
| `execute_time_ms     ` |  776 |  1,552 |  787 |  765 |
| `trace_gen_time_ms   ` |  1,466.50 |  2,933 |  1,515 |  1,418 |
| `stark_prove_excluding_trace_time_ms` |  4,750 |  9,500 |  4,764 |  4,736 |
| `main_trace_commit_time_ms` |  868 |  1,736 |  869 |  867 |
| `generate_perm_trace_time_ms` |  396 |  792 |  417 |  375 |
| `perm_trace_commit_time_ms` |  1,242 |  2,484 |  1,246 |  1,238 |
| `quotient_poly_compute_time_ms` |  530 |  1,060 |  538 |  522 |
| `quotient_poly_commit_time_ms` |  417.50 |  835 |  422 |  413 |
| `pcs_opening_time_ms ` |  1,291.50 |  2,583 |  1,292 |  1,291 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,515 | 7,066 | 2,006,537 | 538,660,330 | 4,764 | 522 | 413 | 1,246 | 1,292 | 869 | 154,227,494 | 417 | 787 | 
| leaf | 1 | 1,418 | 6,919 | 1,944,933 | 538,660,330 | 4,736 | 538 | 422 | 1,238 | 1,291 | 867 | 149,428,388 | 375 | 765 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,177 | 4,351 | 2,243,715 | 275,652,919 | 2,780 | 279 | 281 | 576 | 855 | 559 | 93,500,799 | 220 | 394 | 
| regex_program | 1 | 755 | 3,484 | 1,921,511 | 242,975,404 | 2,414 | 239 | 214 | 519 | 782 | 444 | 73,010,353 | 208 | 315 | 

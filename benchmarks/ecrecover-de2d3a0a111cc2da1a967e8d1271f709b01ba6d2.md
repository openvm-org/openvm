...
| `stark_prove_excluding_trace_time_ms` |  1,151 |  1,151 |  1,151 |  1,151 |
...
| `pcs_opening_time_ms ` |  422 |  422 |  422 |  422 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  13,117 |  13,117 |  13,117 |  13,117 |
| `main_cells_used     ` |  245,280,108 |  245,280,108 |  245,280,108 |  245,280,108 |
| `total_cycles        ` |  2,991,026 |  2,991,026 |  2,991,026 |  2,991,026 |
| `execute_time_ms     ` |  1,067 |  1,067 |  1,067 |  1,067 |
| `trace_gen_time_ms   ` |  2,349 |  2,349 |  2,349 |  2,349 |
| `stark_prove_excluding_trace_time_ms` |  9,701 |  9,701 |  9,701 |  9,701 |
| `main_trace_commit_time_ms` |  1,730 |  1,730 |  1,730 |  1,730 |
| `generate_perm_trace_time_ms` |  705 |  705 |  705 |  705 |
| `perm_trace_commit_time_ms` |  3,206 |  3,206 |  3,206 |  3,206 |
| `quotient_poly_compute_time_ms` |  1,352 |  1,352 |  1,352 |  1,352 |
| `quotient_poly_commit_time_ms` |  882 |  882 |  882 |  882 |
| `pcs_opening_time_ms ` |  1,821 |  1,821 |  1,821 |  1,821 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 2,349 | 13,117 | 2,991,026 | 1,008,831,978 | 9,701 | 1,352 | 882 | 3,206 | 1,821 | 1,730 | 245,280,108 | 705 | 1,067 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 184 | 1,485 | 295,490 | 48,240,457 | 1,151 | 126 | 165 | 203 | 422 | 185 | 15,627,255 | 32 | 150 | 

...
| `total_proof_time_ms ` |  3,871.50 |  7,743 |  4,458 |  3,285 |
...
| `trace_gen_time_ms   ` |  954 |  1,908 |  1,141 |  767 |
| `stark_prove_excluding_trace_time_ms` |  2,581 |  5,162 |  2,944 |  2,218 |
| `main_trace_commit_time_ms` |  446.50 |  893 |  525 |  368 |
| `generate_perm_trace_time_ms` |  164.50 |  329 |  194 |  135 |
| `perm_trace_commit_time_ms` |  641 |  1,282 |  747 |  535 |
| `quotient_poly_compute_time_ms` |  363 |  726 |  426 |  300 |
| `quotient_poly_commit_time_ms` |  276 |  552 |  324 |  228 |
| `pcs_opening_time_ms ` |  680.50 |  1,361 |  719 |  642 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,530.50 |  15,061 |  7,590 |  7,471 |
| `main_cells_used     ` |  152,306,695.50 |  304,613,391 |  154,765,963 |  149,847,428 |
| `total_cycles        ` |  1,993,385.50 |  3,986,771 |  2,024,258 |  1,962,513 |
| `execute_time_ms     ` |  775 |  1,550 |  785 |  765 |
| `trace_gen_time_ms   ` |  1,475 |  2,950 |  1,479 |  1,471 |
| `stark_prove_excluding_trace_time_ms` |  5,280.50 |  10,561 |  5,326 |  5,235 |
| `main_trace_commit_time_ms` |  893 |  1,786 |  894 |  892 |
| `generate_perm_trace_time_ms` |  350.50 |  701 |  362 |  339 |
| `perm_trace_commit_time_ms` |  1,683 |  3,366 |  1,725 |  1,641 |
| `quotient_poly_compute_time_ms` |  760.50 |  1,521 |  761 |  760 |
| `quotient_poly_commit_time_ms` |  524 |  1,048 |  527 |  521 |
| `pcs_opening_time_ms ` |  1,064 |  2,128 |  1,070 |  1,058 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,479 | 7,590 | 2,024,258 | 533,941,738 | 5,326 | 761 | 521 | 1,725 | 1,058 | 894 | 154,765,963 | 362 | 785 | 
| leaf | 1 | 1,471 | 7,471 | 1,962,513 | 533,941,738 | 5,235 | 760 | 527 | 1,641 | 1,070 | 892 | 149,847,428 | 339 | 765 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,141 | 4,458 | 2,225,434 | 275,652,919 | 2,944 | 426 | 324 | 747 | 719 | 525 | 93,699,990 | 194 | 373 | 
| regex_program | 1 | 767 | 3,285 | 1,914,730 | 198,099,628 | 2,218 | 300 | 228 | 535 | 642 | 368 | 73,689,460 | 135 | 300 | 

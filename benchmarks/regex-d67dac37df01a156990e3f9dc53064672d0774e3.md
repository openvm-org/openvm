...
| `total_proof_time_ms ` |  4,149.50 |  8,299 |  4,546 |  3,753 |
...
| `trace_gen_time_ms   ` |  952 |  1,904 |  1,107 |  797 |
| `stark_prove_excluding_trace_time_ms` |  2,858.50 |  5,717 |  3,062 |  2,655 |
| `main_trace_commit_time_ms` |  517 |  1,034 |  578 |  456 |
| `generate_perm_trace_time_ms` |  192.50 |  385 |  203 |  182 |
| `perm_trace_commit_time_ms` |  748 |  1,496 |  801 |  695 |
| `quotient_poly_compute_time_ms` |  397 |  794 |  430 |  364 |
| `quotient_poly_commit_time_ms` |  292.50 |  585 |  330 |  255 |
| `pcs_opening_time_ms ` |  701 |  1,402 |  710 |  692 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,557.50 |  15,115 |  7,659 |  7,456 |
| `main_cells_used     ` |  152,769,224 |  305,538,448 |  155,168,435 |  150,370,013 |
| `total_cycles        ` |  1,990,990.50 |  3,981,981 |  2,021,764 |  1,960,217 |
| `execute_time_ms     ` |  766.50 |  1,533 |  775 |  758 |
| `trace_gen_time_ms   ` |  1,494.50 |  2,989 |  1,535 |  1,454 |
| `stark_prove_excluding_trace_time_ms` |  5,296.50 |  10,593 |  5,349 |  5,244 |
| `main_trace_commit_time_ms` |  893 |  1,786 |  893 |  893 |
| `generate_perm_trace_time_ms` |  374.50 |  749 |  389 |  360 |
| `perm_trace_commit_time_ms` |  1,677 |  3,354 |  1,711 |  1,643 |
| `quotient_poly_compute_time_ms` |  770 |  1,540 |  773 |  767 |
| `quotient_poly_commit_time_ms` |  520.50 |  1,041 |  523 |  518 |
| `pcs_opening_time_ms ` |  1,056.50 |  2,113 |  1,058 |  1,055 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,535 | 7,659 | 2,021,764 | 538,660,330 | 5,349 | 773 | 523 | 1,711 | 1,055 | 893 | 155,168,435 | 389 | 775 | 
| leaf | 1 | 1,454 | 7,456 | 1,960,217 | 538,660,330 | 5,244 | 767 | 518 | 1,643 | 1,058 | 893 | 150,370,013 | 360 | 758 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,107 | 4,546 | 2,243,715 | 275,652,919 | 3,062 | 430 | 330 | 801 | 710 | 578 | 94,508,931 | 203 | 377 | 
| regex_program | 1 | 797 | 3,753 | 1,921,511 | 242,975,404 | 2,655 | 364 | 255 | 695 | 692 | 456 | 74,018,485 | 182 | 301 | 

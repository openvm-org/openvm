...
| `total_proof_time_ms ` |  750 |  750 |  750 |  750 |
...
| `quotient_poly_compute_time_ms` |  104.65 |  104.65 |  104.65 |  104.65 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  2,852 |  2,852 |  2,852 |  2,852 |
| `main_cells_used     ` |  29,404,728 |  29,404,728 |  29,404,728 |  29,404,728 |
| `total_cells_used    ` |  71,174,330 |  71,174,330 |  71,174,330 |  71,174,330 |
| `execute_preflight_insns` |  2,934,860 |  2,934,860 |  2,934,860 |  2,934,860 |
| `execute_preflight_time_ms` |  429 |  429 |  429 |  429 |
| `execute_preflight_insn_mi/s` |  7.30 | -          |  7.30 |  7.30 |
| `trace_gen_time_ms   ` |  244 |  244 |  244 |  244 |
| `memory_finalize_time_ms` |  22 |  22 |  22 |  22 |
| `stark_prove_excluding_trace_time_ms` |  2,178 |  2,178 |  2,178 |  2,178 |
| `main_trace_commit_time_ms` |  378 |  378 |  378 |  378 |
| `generate_perm_trace_time_ms` |  201 |  201 |  201 |  201 |
| `perm_trace_commit_time_ms` |  706.77 |  706.77 |  706.77 |  706.77 |
| `quotient_poly_compute_time_ms` |  469.72 |  469.72 |  469.72 |  469.72 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program |  | 750 |  | 1 | 6 | 122,859 | 19.70 | 0 | 
| leaf | 2,855 |  | 1 | 1 |  |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 244 | 2,852 | 71,174,330 | 992,054,762 | 244 | 2,178 | 0 | 469.72 | 107.19 | 4 | 706.77 | 307 | 908 | 307 | 22 | 378 | 29,404,728 | 201 | 429 | 2,934,860 | 7.30 | 135 | 584 | 9 | 307 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 218 | 750 | 11,345,240 | 31,789,298 | 218 | 302 | 0 | 104.65 | 9.17 | 8 | 34.17 | 62 | 88 | 61 | 0 | 37 | 2,263,998 | 48 | 60 | 122,859 | 2.18 | 21 | 114 | 2 | 61 | 

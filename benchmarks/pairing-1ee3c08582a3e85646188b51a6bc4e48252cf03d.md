...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  14,240 |  14,240 |  14,240 |  14,240 |
| `main_cells_used     ` |  273,857,292 |  273,857,292 |  273,857,292 |  273,857,292 |
| `total_cycles        ` |  3,267,454 |  3,267,454 |  3,267,454 |  3,267,454 |
| `execute_time_ms     ` |  1,283 |  1,283 |  1,283 |  1,283 |
| `trace_gen_time_ms   ` |  2,616 |  2,616 |  2,616 |  2,616 |
| `stark_prove_excluding_trace_time_ms` |  10,341 |  10,341 |  10,341 |  10,341 |
| `main_trace_commit_time_ms` |  1,775 |  1,775 |  1,775 |  1,775 |
| `generate_perm_trace_time_ms` |  755 |  755 |  755 |  755 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 2,616 | 14,240 | 3,267,454 | 1,081,183,722 | 10,341 | 1,486 | 966 | 3,394 | 1,961 | 1,775 | 273,857,292 | 755 | 1,283 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 942 | 4,858 | 1,820,436 | 297,675,351 | 3,265 | 462 | 347 | 834 | 756 | 650 | 95,832,407 | 199 | 651 | 

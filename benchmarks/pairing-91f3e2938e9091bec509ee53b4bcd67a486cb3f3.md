...
| `total_proof_time_ms ` |  722 |  1,444 |  824 |  620 |
...
| `execute_preflight_insn_mi/s` |  13.43 | -          |  17.74 |  9.13 |
| `trace_gen_time_ms   ` |  182 |  364 |  199 |  165 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  352 |  704 |  384 |  320 |
| `main_trace_commit_time_ms` |  65 |  130 |  75 |  55 |
| `generate_perm_trace_time_ms` |  44 |  88 |  48 |  40 |
| `perm_trace_commit_time_ms` |  76.53 |  153.06 |  89.63 |  63.44 |
| `quotient_poly_compute_time_ms` |  78.33 |  156.66 |  88.16 |  68.50 |
| `quotient_poly_commit_time_ms` |  16.29 |  32.59 |  18.31 |  14.28 |
| `pcs_opening_time_ms ` |  66 |  132 |  67 |  65 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,456.50 |  2,913 |  1,719 |  1,194 |
| `main_cells_used     ` |  16,200,472 |  32,400,944 |  16,332,746 |  16,068,198 |
| `total_cells_used    ` |  39,332,920 |  78,665,840 |  39,650,868 |  39,014,972 |
| `execute_preflight_insns` |  1,952,426 |  3,904,852 |  1,991,961 |  1,912,891 |
| `execute_preflight_time_ms` |  584.50 |  1,169 |  869 |  300 |
| `execute_preflight_insn_mi/s` |  7.54 | -          |  7.56 |  7.52 |
| `trace_gen_time_ms   ` |  119.50 |  239 |  127 |  112 |
| `memory_finalize_time_ms` |  11.50 |  23 |  12 |  11 |
| `stark_prove_excluding_trace_time_ms` |  751 |  1,502 |  765 |  737 |
| `main_trace_commit_time_ms` |  147.50 |  295 |  152 |  143 |
| `generate_perm_trace_time_ms` |  59.50 |  119 |  62 |  57 |
| `perm_trace_commit_time_ms` |  229.84 |  459.67 |  235.13 |  224.54 |
| `quotient_poly_compute_time_ms` |  169.16 |  338.32 |  171.77 |  166.56 |
| `quotient_poly_commit_time_ms` |  31.33 |  62.66 |  31.89 |  30.77 |
| `pcs_opening_time_ms ` |  110 |  220 |  114 |  106 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 1,721 |  | 1 | 1 |  |  |  |  | 
| pairing |  | 620 |  | 1 | 90 | 1,745,742 | 19.20 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 127 | 1,194 | 39,650,868 | 410,701,290 | 127 | 765 | 0 | 171.77 | 31.89 | 4 | 235.13 | 114 | 293 | 114 | 12 | 152 | 16,332,746 | 57 | 300 | 1,991,961 | 7.52 | 39 | 205 | 0 | 114 | 
| leaf | 1 | 112 | 1,719 | 39,014,972 | 396,840,426 | 112 | 737 | 0 | 166.56 | 30.77 | 4 | 224.54 | 106 | 287 | 106 | 11 | 143 | 16,068,198 | 62 | 869 | 1,912,891 | 7.56 | 37 | 198 | 0 | 106 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 165 | 824 | 32,689,110 | 172,558,444 | 165 | 384 | 0 | 88.16 | 18.31 | 6 | 89.63 | 67 | 132 | 67 | 1 | 75 | 16,059,916 | 40 | 130 | 1,157,000 | 9.13 | 26 | 107 | 1 | 67 | 
| pairing | 1 | 199 | 620 | 22,314,288 | 119,958,502 | 199 | 320 | 1 | 68.50 | 14.28 | 6 | 63.44 | 65 | 115 | 65 | 0 | 55 | 9,408,294 | 48 | 59 | 588,742 | 17.74 | 20 | 83 | 1 | 65 | 

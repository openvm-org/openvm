...
| `quotient_poly_compute_time_ms` |  287 |  287 |  287 |  287 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  22,247 |  22,247 |  22,247 |  22,247 |
| `main_cells_used     ` |  241,412,199 |  241,412,199 |  241,412,199 |  241,412,199 |
| `total_cycles        ` |  4,166,910 |  4,166,910 |  4,166,910 |  4,166,910 |
| `execute_time_ms     ` |  937 |  937 |  937 |  937 |
| `trace_gen_time_ms   ` |  3,896 |  3,896 |  3,896 |  3,896 |
| `stark_prove_excluding_trace_time_ms` |  17,414 |  17,414 |  17,414 |  17,414 |
| `main_trace_commit_time_ms` |  3,258 |  3,258 |  3,258 |  3,258 |
| `generate_perm_trace_time_ms` |  384 |  384 |  384 |  384 |
| `perm_trace_commit_time_ms` |  3,927 |  3,927 |  3,927 |  3,927 |
| `quotient_poly_compute_time_ms` |  4,383 |  4,383 |  4,383 |  4,383 |
| `quotient_poly_commit_time_ms` |  2,552 |  2,552 |  2,552 |  2,552 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 3,896 | 22,247 | 4,166,910 | 590,040,024 | 17,414 | 4,383 | 2,552 | 3,927 | 2,909 | 3,258 | 241,412,199 | 384 | 937 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 258 | 2,588 | 285,401 | 56,172,159 | 2,183 | 287 | 307 | 533 | 620 | 393 | 15,075,033 | 38 | 147 | 

...
| `total_proof_time_ms ` |  763.25 |  3,053 |  865 |  684 |
...
| `execute_metered_insn_mi/s` |  119.52 | -          |  119.52 |  119.52 |
| `execute_preflight_insns` |  1,027,120.75 |  4,108,483 |  1,108,000 |  790,483 |
| `execute_preflight_time_ms` |  53.75 |  215 |  66 |  44 |
| `execute_preflight_insn_mi/s` |  30.93 | -          |  31.100 |  27.96 |
| `trace_gen_time_ms   ` |  194.75 |  779 |  229 |  172 |
| `memory_finalize_time_ms` |  1 |  4 |  4 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  446 |  1,784 |  476 |  405 |
| `main_trace_commit_time_ms` |  56.75 |  227 |  62 |  53 |
| `generate_perm_trace_time_ms` |  43.50 |  174 |  72 |  31 |
| `perm_trace_commit_time_ms` |  69.09 |  276.35 |  74.87 |  59.10 |
| `quotient_poly_compute_time_ms` |  75.16 |  300.64 |  140.04 |  51.67 |
| `quotient_poly_commit_time_ms` |  17.35 |  69.39 |  19.54 |  14.52 |
| `pcs_opening_time_ms ` |  181 |  724 |  206 |  157 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,734.75 |  6,939 |  2,654 |  1,225 |
...
| `execute_preflight_insns` |  1,440,903.75 |  5,763,615 |  1,814,601 |  1,241,447 |
| `execute_preflight_time_ms` |  611.50 |  2,446 |  801 |  228 |
| `execute_preflight_insn_mi/s` |  6.100 | -          |  7.33 |  6.80 |
| `trace_gen_time_ms   ` |  87.25 |  349 |  164 |  56 |
| `memory_finalize_time_ms` |  8.25 |  33 |  15 |  5 |
| `stark_prove_excluding_trace_time_ms` |  1,034.25 |  4,137 |  1,729 |  732 |
| `main_trace_commit_time_ms` |  133.50 |  534 |  207 |  98 |
| `generate_perm_trace_time_ms` |  49 |  196 |  78 |  36 |
| `perm_trace_commit_time_ms` |  211.36 |  845.43 |  358.76 |  151.75 |
| `quotient_poly_compute_time_ms` |  136.66 |  546.62 |  226.65 |  96.85 |
| `quotient_poly_commit_time_ms` |  35.34 |  141.34 |  56.60 |  27.08 |
| `pcs_opening_time_ms ` |  465.25 |  1,861 |  797 |  319 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 2,656 |  | 1 |  | 1 |  |  |  |  | 
| regex_program |  | 748 |  | 40 | 1 | 34 | 4,108,483 | 119.52 | 167 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 70 | 1,225 | 22,981,570 | 319,331,818 | 70 | 926 | 0 | 126.16 | 29.99 | 4 | 182.64 | 410 | 227 | 410 | 7 | 130 | 9,122,488 | 44 | 228 | 1,466,110 | 7.33 | 29 | 157 | 1 | 410 | 
| leaf | 1 | 59 | 1,612 | 20,905,034 | 255,237,610 | 59 | 750 | 0 | 96.96 | 27.08 | 4 | 152.27 | 335 | 191 | 335 | 5 | 98 | 8,256,948 | 38 | 801 | 1,241,457 | 6.92 | 25 | 125 | 1 | 335 | 
| leaf | 2 | 56 | 1,448 | 20,905,034 | 255,237,610 | 56 | 732 | 0 | 96.85 | 27.68 | 4 | 151.75 | 319 | 189 | 318 | 6 | 99 | 8,256,948 | 36 | 658 | 1,241,447 | 6.94 | 25 | 125 | 1 | 318 | 
| leaf | 3 | 164 | 2,654 | 50,337,320 | 538,365,418 | 164 | 1,729 | 0 | 226.65 | 56.60 | 4 | 358.76 | 797 | 437 | 797 | 15 | 207 | 20,171,106 | 78 | 759 | 1,814,601 | 6.80 | 59 | 286 | 6 | 797 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 229 | 865 | 23,395,260 | 150,778,428 | 229 | 440 | 0 | 57.16 | 19.54 | 5 | 74.87 | 186 | 113 | 186 | 4 | 62 | 10,864,634 | 37 | 47 | 1,102,000 | 27.96 | 19 | 77 | 2 | 186 | 
| regex_program | 1 | 172 | 756 | 11,589,074 | 132,682,794 | 172 | 476 | 1 | 51.77 | 16.93 | 4 | 71.68 | 206 | 144 | 205 | 0 | 56 | 2,191,608 | 72 | 66 | 1,108,000 | 31.100 | 15 | 69 | 1 | 205 | 
| regex_program | 2 | 179 | 684 | 11,583,256 | 132,682,794 | 179 | 405 | 1 | 51.67 | 18.40 | 5 | 70.69 | 175 | 102 | 175 | 0 | 56 | 2,185,918 | 31 | 58 | 1,108,000 | 31.95 | 16 | 70 | 1 | 175 | 
| regex_program | 3 | 199 | 748 | 11,847,840 | 103,522,954 | 199 | 463 | 0 | 140.04 | 14.52 | 5 | 59.10 | 157 | 96 | 156 | 0 | 53 | 2,420,726 | 34 | 44 | 790,483 | 31.79 | 17 | 155 | 2 | 156 | 

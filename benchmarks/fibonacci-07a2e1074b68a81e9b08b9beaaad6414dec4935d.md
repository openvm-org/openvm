...
| `total_proof_time_ms ` |  613 |  1,226 |  689 |  537 |
...
| `execute_metered_insn_mi/s` |  147.54 | -          |  147.54 |  147.54 |
| `execute_preflight_insns` |  750,105 |  1,500,210 |  873,000 |  627,210 |
| `execute_preflight_time_ms` |  29 |  58 |  33 |  25 |
| `execute_preflight_insn_mi/s` |  37.73 | -          |  39.11 |  36.35 |
| `trace_gen_time_ms   ` |  209 |  418 |  215 |  203 |
| `memory_finalize_time_ms` | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  279.50 |  559 |  300 |  259 |
| `main_trace_commit_time_ms` |  33 |  66 |  35 |  31 |
| `generate_perm_trace_time_ms` |  31 |  62 |  36 |  26 |
| `perm_trace_commit_time_ms` |  44.31 |  88.62 |  47.55 |  41.06 |
| `quotient_poly_compute_time_ms` |  30.19 |  60.39 |  32.49 |  27.89 |
| `quotient_poly_commit_time_ms` |  13.66 |  27.32 |  14.78 |  12.54 |
| `pcs_opening_time_ms ` |  126 |  252 |  143 |  109 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,244 |  2,488 |  1,480 |  1,008 |
| `main_cells_used     ` |  6,475,562 |  12,951,124 |  6,608,072 |  6,343,052 |
| `total_cells_used    ` |  17,568,644 |  35,137,288 |  17,887,054 |  17,250,234 |
| `execute_preflight_insns` |  1,190,458 |  2,380,916 |  1,229,702 |  1,151,214 |
| `execute_preflight_time_ms` |  510 |  1,020 |  814 |  206 |
| `execute_preflight_insn_mi/s` |  6.63 | -          |  6.65 |  6.60 |
| `trace_gen_time_ms   ` |  58 |  116 |  61 |  55 |
| `memory_finalize_time_ms` |  5.50 |  11 |  6 |  5 |
| `stark_prove_excluding_trace_time_ms` |  675 |  1,350 |  740 |  610 |
| `main_trace_commit_time_ms` |  90 |  180 |  98 |  82 |
| `generate_perm_trace_time_ms` |  33 |  66 |  35 |  31 |
| `perm_trace_commit_time_ms` |  133.49 |  266.98 |  152.63 |  114.36 |
| `quotient_poly_compute_time_ms` |  89.83 |  179.65 |  99.86 |  79.79 |
| `quotient_poly_commit_time_ms` |  25.43 |  50.86 |  27.82 |  23.04 |
| `pcs_opening_time_ms ` |  299.50 |  599 |  323 |  276 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program |  | 537 |  | 41 | 1 | 10 | 1,500,210 | 147.54 | 141 | 
| leaf | 1,481 |  | 1 |  | 1 |  |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 61 | 1,008 | 17,887,054 | 252,878,314 | 61 | 740 | 0 | 99.86 | 27.82 | 4 | 152.63 | 323 | 189 | 323 | 6 | 98 | 6,608,072 | 35 | 206 | 1,229,702 | 6.65 | 24 | 128 | 1 | 323 | 
| leaf | 1 | 55 | 1,480 | 17,250,234 | 207,789,546 | 55 | 610 | 0 | 79.79 | 23.04 | 4 | 114.36 | 276 | 146 | 276 | 5 | 82 | 6,343,052 | 31 | 814 | 1,151,214 | 6.60 | 21 | 103 | 1 | 276 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 215 | 689 | 9,684,992 | 84,395,212 | 215 | 300 | 0 | 32.49 | 14.78 | 4 | 47.55 | 143 | 74 | 143 | 0 | 35 | 1,040,430 | 26 | 25 | 873,000 | 36.35 | 13 | 47 | 1 | 143 | 
| fibonacci_program | 1 | 203 | 537 | 9,714,030 | 74,305,770 | 203 | 259 | 1 | 27.89 | 12.54 | 4 | 41.06 | 109 | 77 | 109 | 0 | 31 | 1,067,532 | 36 | 33 | 627,210 | 39.11 | 10 | 40 | 1 | 109 | 

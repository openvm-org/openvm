...
| `total_proof_time_ms ` |  3,915 |  7,830 |  4,506 |  3,324 |
| `main_cells_used     ` |  83,694,725 |  167,389,450 |  93,699,990 |  73,689,460 |
| `total_cycles        ` |  2,070,082 |  4,140,164 |  2,225,434 |  1,914,730 |
| `execute_time_ms     ` |  339 |  678 |  374 |  304 |
| `trace_gen_time_ms   ` |  974 |  1,948 |  1,172 |  776 |
| `stark_prove_excluding_trace_time_ms` |  2,602 |  5,204 |  2,960 |  2,244 |
| `main_trace_commit_time_ms` |  451 |  902 |  525 |  377 |
| `generate_perm_trace_time_ms` |  174.50 |  349 |  196 |  153 |
| `perm_trace_commit_time_ms` |  649.50 |  1,299 |  753 |  546 |
| `quotient_poly_compute_time_ms` |  365.50 |  731 |  428 |  303 |
| `quotient_poly_commit_time_ms` |  278 |  556 |  319 |  237 |
| `pcs_opening_time_ms ` |  674.50 |  1,349 |  731 |  618 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,518.50 |  15,037 |  7,576 |  7,461 |
| `main_cells_used     ` |  152,233,568 |  304,467,136 |  154,690,652 |  149,776,484 |
| `total_cycles        ` |  1,990,779.50 |  3,981,559 |  2,021,536 |  1,960,023 |
| `execute_time_ms     ` |  758.50 |  1,517 |  767 |  750 |
| `trace_gen_time_ms   ` |  1,500 |  3,000 |  1,532 |  1,468 |
| `stark_prove_excluding_trace_time_ms` |  5,260 |  10,520 |  5,277 |  5,243 |
| `main_trace_commit_time_ms` |  895.50 |  1,791 |  896 |  895 |
| `generate_perm_trace_time_ms` |  345 |  690 |  352 |  338 |
| `perm_trace_commit_time_ms` |  1,658.50 |  3,317 |  1,674 |  1,643 |
| `quotient_poly_compute_time_ms` |  758 |  1,516 |  760 |  756 |
| `quotient_poly_commit_time_ms` |  527 |  1,054 |  529 |  525 |
| `pcs_opening_time_ms ` |  1,071 |  2,142 |  1,076 |  1,066 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,532 | 7,576 | 2,021,536 | 533,941,738 | 5,277 | 756 | 529 | 1,674 | 1,066 | 895 | 154,690,652 | 352 | 767 | 
| leaf | 1 | 1,468 | 7,461 | 1,960,023 | 533,941,738 | 5,243 | 760 | 525 | 1,643 | 1,076 | 896 | 149,776,484 | 338 | 750 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,172 | 4,506 | 2,225,434 | 275,652,919 | 2,960 | 428 | 319 | 753 | 731 | 525 | 93,699,990 | 196 | 374 | 
| regex_program | 1 | 776 | 3,324 | 1,914,730 | 198,099,628 | 2,244 | 303 | 237 | 546 | 618 | 377 | 73,689,460 | 153 | 304 | 

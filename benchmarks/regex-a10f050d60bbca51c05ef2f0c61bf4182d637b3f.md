...
| `total_proof_time_ms ` |  4,072 |  8,144 |  4,518 |  3,626 |
...
| `trace_gen_time_ms   ` |  990.50 |  1,981 |  1,165 |  816 |
| `stark_prove_excluding_trace_time_ms` |  2,742 |  5,484 |  2,974 |  2,510 |
| `main_trace_commit_time_ms` |  472 |  944 |  530 |  414 |
| `generate_perm_trace_time_ms` |  189.50 |  379 |  191 |  188 |
| `perm_trace_commit_time_ms` |  688.50 |  1,377 |  740 |  637 |
| `quotient_poly_compute_time_ms` |  397 |  794 |  435 |  359 |
| `quotient_poly_commit_time_ms` |  278 |  556 |  312 |  244 |
| `pcs_opening_time_ms ` |  708 |  1,416 |  756 |  660 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,262 |  14,524 |  7,286 |  7,238 |
| `main_cells_used     ` |  152,278,279 |  304,556,558 |  154,678,042 |  149,878,516 |
| `total_cycles        ` |  1,991,034.50 |  3,982,069 |  2,021,854 |  1,960,215 |
| `execute_time_ms     ` |  777.50 |  1,555 |  785 |  770 |
| `trace_gen_time_ms   ` |  1,485.50 |  2,971 |  1,495 |  1,476 |
| `stark_prove_excluding_trace_time_ms` |  4,999 |  9,998 |  5,025 |  4,973 |
| `main_trace_commit_time_ms` |  808.50 |  1,617 |  812 |  805 |
| `generate_perm_trace_time_ms` |  363.50 |  727 |  367 |  360 |
| `perm_trace_commit_time_ms` |  1,527 |  3,054 |  1,555 |  1,499 |
| `quotient_poly_compute_time_ms` |  765 |  1,530 |  766 |  764 |
| `quotient_poly_commit_time_ms` |  490.50 |  981 |  491 |  490 |
| `pcs_opening_time_ms ` |  1,040 |  2,080 |  1,042 |  1,038 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,476 | 7,286 | 2,021,854 | 538,660,330 | 5,025 | 764 | 491 | 1,555 | 1,038 | 812 | 154,678,042 | 360 | 785 | 
| leaf | 1 | 1,495 | 7,238 | 1,960,215 | 538,660,330 | 4,973 | 766 | 490 | 1,499 | 1,042 | 805 | 149,878,516 | 367 | 770 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,165 | 4,518 | 2,243,715 | 275,652,919 | 2,974 | 435 | 312 | 740 | 756 | 530 | 93,500,799 | 191 | 379 | 
| regex_program | 1 | 816 | 3,626 | 1,921,511 | 242,975,404 | 2,510 | 359 | 244 | 637 | 660 | 414 | 73,010,353 | 188 | 300 | 

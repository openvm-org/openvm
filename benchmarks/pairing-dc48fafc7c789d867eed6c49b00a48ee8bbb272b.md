...
| `total_proof_time_ms ` |  4,935 |  4,935 |  4,935 |  4,935 |
...
| `trace_gen_time_ms   ` |  964 |  964 |  964 |  964 |
...
| `pcs_opening_time_ms ` |  801 |  801 |  801 |  801 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  14,248 |  14,248 |  14,248 |  14,248 |
| `main_cells_used     ` |  273,856,716 |  273,856,716 |  273,856,716 |  273,856,716 |
| `total_cycles        ` |  3,267,406 |  3,267,406 |  3,267,406 |  3,267,406 |
| `execute_time_ms     ` |  1,260 |  1,260 |  1,260 |  1,260 |
| `trace_gen_time_ms   ` |  2,613 |  2,613 |  2,613 |  2,613 |
| `stark_prove_excluding_trace_time_ms` |  10,375 |  10,375 |  10,375 |  10,375 |
| `main_trace_commit_time_ms` |  1,781 |  1,781 |  1,781 |  1,781 |
| `generate_perm_trace_time_ms` |  760 |  760 |  760 |  760 |
| `perm_trace_commit_time_ms` |  3,384 |  3,384 |  3,384 |  3,384 |
| `quotient_poly_compute_time_ms` |  1,472 |  1,472 |  1,472 |  1,472 |
| `quotient_poly_commit_time_ms` |  979 |  979 |  979 |  979 |
| `pcs_opening_time_ms ` |  1,993 |  1,993 |  1,993 |  1,993 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 2,613 | 14,248 | 3,267,406 | 1,081,183,722 | 10,375 | 1,472 | 979 | 3,384 | 1,993 | 1,781 | 273,856,716 | 760 | 1,260 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 964 | 4,935 | 1,820,436 | 297,675,351 | 3,318 | 471 | 344 | 838 | 801 | 653 | 95,832,407 | 194 | 653 | 

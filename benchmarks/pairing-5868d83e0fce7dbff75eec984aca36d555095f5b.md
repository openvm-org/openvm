...
| `total_proof_time_ms ` |  4,941 |  4,941 |  4,941 |  4,941 |
...
| `trace_gen_time_ms   ` |  936 |  936 |  936 |  936 |
...
| `perm_trace_commit_time_ms` |  832 |  832 |  832 |  832 |
| `quotient_poly_compute_time_ms` |  460 |  460 |  460 |  460 |
| `quotient_poly_commit_time_ms` |  359 |  359 |  359 |  359 |
| `pcs_opening_time_ms ` |  816 |  816 |  816 |  816 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  13,642 |  13,642 |  13,642 |  13,642 |
| `main_cells_used     ` |  273,857,640 |  273,857,640 |  273,857,640 |  273,857,640 |
| `total_cycles        ` |  3,267,483 |  3,267,483 |  3,267,483 |  3,267,483 |
| `execute_time_ms     ` |  1,196 |  1,196 |  1,196 |  1,196 |
| `trace_gen_time_ms   ` |  2,611 |  2,611 |  2,611 |  2,611 |
| `stark_prove_excluding_trace_time_ms` |  9,835 |  9,835 |  9,835 |  9,835 |
| `main_trace_commit_time_ms` |  1,601 |  1,601 |  1,601 |  1,601 |
| `generate_perm_trace_time_ms` |  765 |  765 |  765 |  765 |
| `perm_trace_commit_time_ms` |  3,117 |  3,117 |  3,117 |  3,117 |
| `quotient_poly_compute_time_ms` |  1,490 |  1,490 |  1,490 |  1,490 |
| `quotient_poly_commit_time_ms` |  910 |  910 |  910 |  910 |
| `pcs_opening_time_ms ` |  1,947 |  1,947 |  1,947 |  1,947 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 2,611 | 13,642 | 3,267,483 | 1,081,183,722 | 9,835 | 1,490 | 910 | 3,117 | 1,947 | 1,601 | 273,857,640 | 765 | 1,196 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 936 | 4,941 | 1,820,436 | 297,675,351 | 3,328 | 460 | 359 | 832 | 816 | 646 | 95,832,407 | 198 | 677 | 

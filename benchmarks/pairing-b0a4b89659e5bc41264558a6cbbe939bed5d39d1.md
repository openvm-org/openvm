...
| `total_proof_time_ms ` |  720.50 |  1,441 |  817 |  624 |
...
| `execute_preflight_time_ms` |  84 |  168 |  108 |  60 |
| `execute_preflight_insn_mi/s` |  14.63 | -          |  18.27 |  10.100 |
| `trace_gen_time_ms   ` |  187 |  374 |  193 |  181 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  356 |  712 |  383 |  329 |
| `main_trace_commit_time_ms` |  64 |  128 |  74 |  54 |
| `generate_perm_trace_time_ms` |  37 |  74 |  38 |  36 |
| `perm_trace_commit_time_ms` |  76.51 |  153.03 |  88.21 |  64.82 |
| `quotient_poly_compute_time_ms` |  78.08 |  156.16 |  86.41 |  69.75 |
| `quotient_poly_commit_time_ms` |  16.28 |  32.55 |  18.81 |  13.74 |
| `pcs_opening_time_ms ` |  79.50 |  159 |  84 |  75 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,480 |  2,960 |  1,758 |  1,202 |
| `main_cells_used     ` |  16,200,472 |  32,400,944 |  16,332,746 |  16,068,198 |
| `total_cells_used    ` |  39,332,920 |  78,665,840 |  39,650,868 |  39,014,972 |
| `execute_preflight_insns` |  1,952,411 |  3,904,822 |  1,991,933 |  1,912,889 |
| `execute_preflight_time_ms` |  588.50 |  1,177 |  883 |  294 |
| `execute_preflight_insn_mi/s` |  7.71 | -          |  7.73 |  7.70 |
| `trace_gen_time_ms   ` |  117 |  234 |  124 |  110 |
| `memory_finalize_time_ms` |  11 |  22 |  12 |  10 |
| `stark_prove_excluding_trace_time_ms` |  773 |  1,546 |  783 |  763 |
| `main_trace_commit_time_ms` |  145 |  290 |  149 |  141 |
| `generate_perm_trace_time_ms` |  53 |  106 |  56 |  50 |
| `perm_trace_commit_time_ms` |  225.78 |  451.57 |  230.03 |  221.53 |
| `quotient_poly_compute_time_ms` |  168.15 |  336.31 |  170.72 |  165.59 |
| `quotient_poly_commit_time_ms` |  31.02 |  62.03 |  33.27 |  28.76 |
| `pcs_opening_time_ms ` |  147 |  294 |  153 |  141 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 1,760 |  | 1 | 1 |  |  |  |  | 
| pairing |  | 624 |  | 1 | 68 | 1,745,742 | 25.64 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 124 | 1,202 | 39,650,868 | 410,701,290 | 123 | 783 | 0 | 170.72 | 33.27 | 4 | 230.03 | 141 | 286 | 140 | 12 | 149 | 16,332,746 | 56 | 294 | 1,991,933 | 7.70 | 39 | 205 | 0 | 140 | 
| leaf | 1 | 110 | 1,758 | 39,014,972 | 396,840,426 | 110 | 763 | 0 | 165.59 | 28.76 | 4 | 221.53 | 153 | 272 | 153 | 10 | 141 | 16,068,198 | 50 | 883 | 1,912,889 | 7.73 | 38 | 195 | 0 | 153 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 181 | 817 | 32,480,114 | 172,558,444 | 181 | 383 | 0 | 86.41 | 18.81 | 6 | 88.21 | 75 | 127 | 75 | 1 | 74 | 15,909,408 | 36 | 108 | 1,149,000 | 10.100 | 26 | 106 | 1 | 75 | 
| pairing | 1 | 193 | 624 | 22,464,232 | 119,958,502 | 193 | 329 | 1 | 69.75 | 13.74 | 6 | 64.82 | 84 | 106 | 84 | 0 | 54 | 9,498,894 | 38 | 60 | 596,742 | 18.27 | 20 | 84 | 1 | 84 | 

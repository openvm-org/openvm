...
| `total_proof_time_ms ` |  6,976 |  13,952 |  7,872 |  6,080 |
| `main_cells_used     ` |  83,694,725 |  167,389,450 |  93,699,990 |  73,689,460 |
| `total_cycles        ` |  2,070,082 |  4,140,164 |  2,225,434 |  1,914,730 |
| `execute_time_ms     ` |  388.50 |  777 |  472 |  305 |
| `trace_gen_time_ms   ` |  1,264.50 |  2,529 |  1,289 |  1,240 |
| `stark_prove_excluding_trace_time_ms` |  5,323 |  10,646 |  6,111 |  4,535 |
| `main_trace_commit_time_ms` |  1,150 |  2,300 |  1,331 |  969 |
| `generate_perm_trace_time_ms` |  171.50 |  343 |  191 |  152 |
| `perm_trace_commit_time_ms` |  1,036 |  2,072 |  1,170 |  902 |
| `quotient_poly_compute_time_ms` |  753 |  1,506 |  885 |  621 |
| `quotient_poly_commit_time_ms` |  929.50 |  1,859 |  1,094 |  765 |
| `pcs_opening_time_ms ` |  1,273 |  2,546 |  1,429 |  1,117 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  8,550.50 |  17,101 |  8,597 |  8,504 |
| `main_cells_used     ` |  86,869,500.50 |  173,739,001 |  88,129,654 |  85,609,347 |
| `total_cycles        ` |  1,451,192 |  2,902,384 |  1,475,906 |  1,426,478 |
| `execute_time_ms     ` |  439.50 |  879 |  483 |  396 |
| `trace_gen_time_ms   ` |  1,276 |  2,552 |  1,345 |  1,207 |
| `stark_prove_excluding_trace_time_ms` |  6,835 |  13,670 |  6,856 |  6,814 |
| `main_trace_commit_time_ms` |  1,389 |  2,778 |  1,392 |  1,386 |
| `generate_perm_trace_time_ms` |  188.50 |  377 |  191 |  186 |
| `perm_trace_commit_time_ms` |  1,391 |  2,782 |  1,397 |  1,385 |
| `quotient_poly_compute_time_ms` |  1,087 |  2,174 |  1,091 |  1,083 |
| `quotient_poly_commit_time_ms` |  1,376 |  2,752 |  1,376 |  1,376 |
| `pcs_opening_time_ms ` |  1,398.50 |  2,797 |  1,412 |  1,385 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,207 | 8,504 | 1,475,906 | 225,774,050 | 6,814 | 1,091 | 1,376 | 1,385 | 1,385 | 1,386 | 88,129,654 | 186 | 483 | 
| leaf | 1 | 1,345 | 8,597 | 1,426,478 | 225,774,050 | 6,856 | 1,083 | 1,376 | 1,397 | 1,412 | 1,392 | 85,609,347 | 191 | 396 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,289 | 7,872 | 2,225,434 | 210,931,487 | 6,111 | 885 | 1,094 | 1,170 | 1,429 | 1,331 | 93,699,990 | 191 | 472 | 
| regex_program | 1 | 1,240 | 6,080 | 1,914,730 | 150,470,512 | 4,535 | 621 | 765 | 902 | 1,117 | 969 | 73,689,460 | 152 | 305 | 

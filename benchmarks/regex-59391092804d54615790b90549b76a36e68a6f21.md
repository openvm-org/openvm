...
| `total_proof_time_ms ` |  4,053.50 |  8,107 |  4,507 |  3,600 |
...
| `trace_gen_time_ms   ` |  958.50 |  1,917 |  1,131 |  786 |
| `stark_prove_excluding_trace_time_ms` |  2,755 |  5,510 |  2,999 |  2,511 |
| `main_trace_commit_time_ms` |  473.50 |  947 |  533 |  414 |
| `generate_perm_trace_time_ms` |  198 |  396 |  214 |  182 |
| `perm_trace_commit_time_ms` |  693.50 |  1,387 |  744 |  643 |
| `quotient_poly_compute_time_ms` |  396.50 |  793 |  424 |  369 |
| `quotient_poly_commit_time_ms` |  281.50 |  563 |  320 |  243 |
| `pcs_opening_time_ms ` |  702.50 |  1,405 |  754 |  651 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,306.50 |  14,613 |  7,385 |  7,228 |
| `main_cells_used     ` |  152,277,961 |  304,555,922 |  154,677,694 |  149,878,228 |
| `total_cycles        ` |  1,991,008 |  3,982,016 |  2,021,825 |  1,960,191 |
| `execute_time_ms     ` |  780.50 |  1,561 |  786 |  775 |
| `trace_gen_time_ms   ` |  1,463.50 |  2,927 |  1,518 |  1,409 |
| `stark_prove_excluding_trace_time_ms` |  5,062.50 |  10,125 |  5,081 |  5,044 |
| `main_trace_commit_time_ms` |  810 |  1,620 |  812 |  808 |
| `generate_perm_trace_time_ms` |  361.50 |  723 |  362 |  361 |
| `perm_trace_commit_time_ms` |  1,552.50 |  3,105 |  1,574 |  1,531 |
| `quotient_poly_compute_time_ms` |  767.50 |  1,535 |  769 |  766 |
| `quotient_poly_commit_time_ms` |  497 |  994 |  499 |  495 |
| `pcs_opening_time_ms ` |  1,067.50 |  2,135 |  1,069 |  1,066 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,518 | 7,385 | 2,021,825 | 538,660,330 | 5,081 | 766 | 495 | 1,574 | 1,066 | 812 | 154,677,694 | 361 | 786 | 
| leaf | 1 | 1,409 | 7,228 | 1,960,191 | 538,660,330 | 5,044 | 769 | 499 | 1,531 | 1,069 | 808 | 149,878,228 | 362 | 775 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,131 | 4,507 | 2,243,715 | 275,652,919 | 2,999 | 424 | 320 | 744 | 754 | 533 | 93,500,799 | 214 | 377 | 
| regex_program | 1 | 786 | 3,600 | 1,921,511 | 242,975,404 | 2,511 | 369 | 243 | 643 | 651 | 414 | 73,010,353 | 182 | 303 | 

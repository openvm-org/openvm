...
|:---|---:|---:|---:|
| Total |  19.54 |  9.98 | 9.98 |
| pairing |  7.01 |  3.56 |  3.56 |
| leaf |  12.53 |  6.42 |  6.42 |


| pairing |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  3,473.50 |  6,947 |  3,497 |  3,450 |
...
| `execute_metered_insn_mi/s` |  27.59 | -          |  27.59 |  27.59 |
| `execute_preflight_insns` |  872,871 |  1,745,742 |  1,149,000 |  596,742 |
| `execute_preflight_time_ms` |  84 |  168 |  120 |  48 |
| `execute_preflight_insn_mi/s` |  14.67 | -          |  18.06 |  11.28 |
| `trace_gen_time_ms   ` |  178.50 |  357 |  198 |  159 |
| `memory_finalize_time_ms` |  1 |  2 |  1 |  1 |
| `stark_prove_excluding_trace_time_ms` |  3,105 |  6,210 |  3,209 |  3,001 |
| `main_trace_commit_time_ms` |  64 |  128 |  74 |  54 |
| `generate_perm_trace_time_ms` |  131.50 |  263 |  190 |  73 |
| `perm_trace_commit_time_ms` |  76.04 |  152.08 |  87.82 |  64.25 |
| `quotient_poly_compute_time_ms` |  82.69 |  165.38 |  92.04 |  73.34 |
| `quotient_poly_commit_time_ms` |  17.39 |  34.79 |  19.69 |  15.10 |
| `pcs_opening_time_ms ` |  2,729 |  5,458 |  2,925 |  2,533 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  6,265 |  12,530 |  6,419 |  6,111 |
| `main_cells_used     ` |  20,420,666 |  40,841,332 |  20,631,060 |  20,210,272 |
| `total_cells_used    ` |  49,519,454 |  99,038,908 |  50,022,658 |  49,016,250 |
| `execute_preflight_insns` |  2,989,030 |  5,978,060 |  3,051,213 |  2,926,847 |
| `execute_preflight_time_ms` |  1,028 |  2,056 |  1,540 |  516 |
| `execute_preflight_insn_mi/s` |  6.45 | -          |  6.51 |  6.40 |
| `trace_gen_time_ms   ` |  164 |  328 |  172 |  156 |
| `memory_finalize_time_ms` |  14.50 |  29 |  16 |  13 |
| `stark_prove_excluding_trace_time_ms` |  5,071 |  10,142 |  5,421 |  4,721 |
| `main_trace_commit_time_ms` |  293.50 |  587 |  294 |  293 |
| `generate_perm_trace_time_ms` |  120.50 |  241 |  137 |  104 |
| `perm_trace_commit_time_ms` |  450.35 |  900.70 |  451.55 |  449.15 |
| `quotient_poly_compute_time_ms` |  332.67 |  665.34 |  333.48 |  331.85 |
| `quotient_poly_commit_time_ms` |  65.84 |  131.69 |  66.44 |  65.25 |
| `pcs_opening_time_ms ` |  3,802 |  7,604 |  4,133 |  3,471 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 6,422 |  | 1 | 1 |  |  |  |  | 
| pairing |  | 3,497 |  | 1 | 63 | 1,745,742 | 27.59 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 172 | 6,111 | 50,022,658 | 761,351,658 | 172 | 5,421 | 0 | 333.48 | 65.25 | 6 | 451.55 | 4,133 | 590 | 4,132 | 16 | 293 | 20,631,060 | 137 | 516 | 3,051,213 | 6.51 | 83 | 404 | 5 | 4,132 | 
| leaf | 1 | 156 | 6,419 | 49,016,250 | 761,351,658 | 156 | 4,721 | 0 | 331.85 | 66.44 | 6 | 449.15 | 3,471 | 554 | 3,470 | 13 | 294 | 20,210,272 | 104 | 1,540 | 2,926,847 | 6.40 | 79 | 400 | 0 | 3,470 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 159 | 3,450 | 32,480,114 | 172,558,444 | 159 | 3,001 | 0 | 92.04 | 19.69 | 8 | 87.82 | 2,533 | 281 | 2,533 | 1 | 74 | 15,909,408 | 190 | 120 | 1,149,000 | 11.28 | 27 | 112 | 1 | 2,533 | 
| pairing | 1 | 198 | 3,497 | 22,464,232 | 119,958,502 | 198 | 3,209 | 1 | 73.34 | 15.10 | 8 | 64.25 | 2,925 | 140 | 2,925 | 1 | 54 | 9,498,894 | 73 | 48 | 596,742 | 18.06 | 20 | 89 | 1 | 2,925 | 

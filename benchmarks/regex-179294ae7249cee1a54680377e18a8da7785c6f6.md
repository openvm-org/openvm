...
| `total_proof_time_ms ` |  3,992 |  7,984 |  4,614 |  3,370 |
...
| `trace_gen_time_ms   ` |  956.50 |  1,913 |  1,159 |  754 |
| `stark_prove_excluding_trace_time_ms` |  2,695.50 |  5,391 |  3,078 |  2,313 |
| `main_trace_commit_time_ms` |  498.50 |  997 |  589 |  408 |
| `generate_perm_trace_time_ms` |  165.50 |  331 |  179 |  152 |
| `perm_trace_commit_time_ms` |  697 |  1,394 |  809 |  585 |
| `quotient_poly_compute_time_ms` |  362.50 |  725 |  419 |  306 |
| `quotient_poly_commit_time_ms` |  292.50 |  585 |  342 |  243 |
| `pcs_opening_time_ms ` |  670.50 |  1,341 |  730 |  611 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,542 |  15,084 |  7,614 |  7,470 |
| `main_cells_used     ` |  152,231,666 |  304,463,332 |  154,689,422 |  149,773,910 |
| `total_cycles        ` |  1,990,761.50 |  3,981,523 |  2,021,574 |  1,959,949 |
| `execute_time_ms     ` |  758.50 |  1,517 |  767 |  750 |
| `trace_gen_time_ms   ` |  1,495.50 |  2,991 |  1,515 |  1,476 |
| `stark_prove_excluding_trace_time_ms` |  5,288 |  10,576 |  5,332 |  5,244 |
| `main_trace_commit_time_ms` |  890.50 |  1,781 |  891 |  890 |
| `generate_perm_trace_time_ms` |  353 |  706 |  368 |  338 |
| `perm_trace_commit_time_ms` |  1,680.50 |  3,361 |  1,708 |  1,653 |
| `quotient_poly_compute_time_ms` |  768 |  1,536 |  770 |  766 |
| `quotient_poly_commit_time_ms` |  525.50 |  1,051 |  528 |  523 |
| `pcs_opening_time_ms ` |  1,065 |  2,130 |  1,065 |  1,065 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,515 | 7,614 | 2,021,574 | 533,941,738 | 5,332 | 766 | 528 | 1,708 | 1,065 | 891 | 154,689,422 | 368 | 767 | 
| leaf | 1 | 1,476 | 7,470 | 1,959,949 | 533,941,738 | 5,244 | 770 | 523 | 1,653 | 1,065 | 890 | 149,773,910 | 338 | 750 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,159 | 4,614 | 2,225,434 | 275,652,919 | 3,078 | 419 | 342 | 809 | 730 | 589 | 93,699,990 | 179 | 377 | 
| regex_program | 1 | 754 | 3,370 | 1,914,730 | 198,099,628 | 2,313 | 306 | 243 | 585 | 611 | 408 | 73,689,460 | 152 | 303 | 

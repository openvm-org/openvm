...
| `total_proof_time_ms ` |  571 |  2,284 |  688 |  516 |
...
| `execute_metered_insn_mi/s` |  122.11 | -          |  122.11 |  122.11 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  53 |  212 |  64 |  45 |
| `execute_preflight_insn_mi/s` |  31.22 | -          |  32.18 |  28.52 |
| `trace_gen_time_ms   ` |  177 |  708 |  211 |  155 |
| `memory_finalize_time_ms` |  1 |  4 |  4 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  272.75 |  1,091 |  293 |  255 |
| `main_trace_commit_time_ms` |  51.50 |  206 |  57 |  49 |
| `generate_perm_trace_time_ms` |  24.75 |  99 |  38 |  18 |
| `perm_trace_commit_time_ms` |  64.54 |  258.18 |  70.75 |  55.40 |
| `quotient_poly_compute_time_ms` |  57.69 |  230.75 |  69.05 |  51.53 |
| `quotient_poly_commit_time_ms` |  15.22 |  60.88 |  17.56 |  12.95 |
| `pcs_opening_time_ms ` |  56 |  224 |  62 |  51 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,382.50 |  5,530 |  1,994 |  899 |
...
| `execute_preflight_insns` |  1,440,856 |  5,763,424 |  1,814,546 |  1,241,403 |
| `execute_preflight_time_ms` |  617.50 |  2,470 |  802 |  230 |
| `execute_preflight_insn_mi/s` |  6.94 | -          |  7.25 |  6.76 |
| `trace_gen_time_ms   ` |  87.50 |  350 |  161 |  59 |
| `memory_finalize_time_ms` |  8.50 |  34 |  16 |  6 |
| `stark_prove_excluding_trace_time_ms` |  676.25 |  2,705 |  1,062 |  495 |
| `main_trace_commit_time_ms` |  123.25 |  493 |  192 |  90 |
| `generate_perm_trace_time_ms` |  50.25 |  201 |  69 |  33 |
| `perm_trace_commit_time_ms` |  197.20 |  788.81 |  338.70 |  140.19 |
| `quotient_poly_compute_time_ms` |  138.37 |  553.47 |  226.44 |  99.03 |
| `quotient_poly_commit_time_ms` |  29.59 |  118.35 |  48.42 |  22.12 |
| `pcs_opening_time_ms ` |  134 |  536 |  182 |  107 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 1,996 |  | 1 |  | 1 |  |  |  |  | 
| regex_program |  | 561 |  | 66 | 1 | 33 | 4,137,502 | 122.11 | 191 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 70 | 899 | 22,981,570 | 319,331,818 | 70 | 597 | 0 | 128.64 | 25.30 | 4 | 169.36 | 109 | 211 | 109 | 6 | 121 | 9,122,488 | 41 | 230 | 1,466,031 | 7.25 | 30 | 155 | 0 | 109 | 
| leaf | 1 | 60 | 1,414 | 20,905,034 | 255,237,610 | 60 | 551 | 0 | 99.03 | 22.50 | 4 | 140.19 | 138 | 199 | 138 | 6 | 90 | 8,256,948 | 58 | 802 | 1,241,403 | 6.88 | 25 | 122 | 0 | 138 | 
| leaf | 2 | 59 | 1,223 | 20,905,034 | 255,237,610 | 59 | 495 | 0 | 99.36 | 22.12 | 4 | 140.56 | 107 | 174 | 107 | 6 | 90 | 8,256,948 | 33 | 668 | 1,241,444 | 6.87 | 25 | 122 | 0 | 107 | 
| leaf | 3 | 161 | 1,994 | 50,337,320 | 538,365,418 | 161 | 1,062 | 0 | 226.44 | 48.42 | 4 | 338.70 | 182 | 408 | 182 | 16 | 192 | 20,171,106 | 69 | 770 | 1,814,546 | 6.76 | 61 | 278 | 5 | 182 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 211 | 688 | 23,446,148 | 150,778,428 | 211 | 286 | 0 | 58.58 | 17.56 | 5 | 70.75 | 57 | 94 | 56 | 4 | 57 | 10,899,170 | 23 | 45 | 1,103,000 | 28.52 | 21 | 76 | 1 | 56 | 
| regex_program | 1 | 155 | 519 | 11,598,276 | 128,513,066 | 155 | 257 | 1 | 51.58 | 15.13 | 4 | 65.64 | 54 | 86 | 53 | 0 | 49 | 2,196,106 | 20 | 64 | 1,104,000 | 32.15 | 16 | 67 | 0 | 53 | 
| regex_program | 2 | 161 | 516 | 11,579,064 | 128,513,066 | 161 | 255 | 1 | 51.53 | 15.23 | 4 | 66.38 | 51 | 85 | 51 | 0 | 50 | 2,177,334 | 18 | 58 | 1,104,000 | 32.18 | 16 | 67 | 0 | 51 | 
| regex_program | 3 | 181 | 561 | 11,853,872 | 103,456,394 | 181 | 293 | 0 | 69.05 | 12.95 | 5 | 55.40 | 62 | 96 | 62 | 0 | 50 | 2,422,606 | 38 | 45 | 826,502 | 32.02 | 18 | 83 | 1 | 61 | 

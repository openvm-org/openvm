...
| `total_proof_time_ms ` |  598 |  2,392 |  756 |  543 |
...
| `execute_metered_insn_mi/s` |  108.56 | -          |  108.56 |  108.56 |
| `execute_preflight_insns` |  1,034,375.50 |  4,137,502 |  1,104,000 |  826,502 |
| `execute_preflight_time_ms` |  53 |  212 |  66 |  44 |
| `execute_preflight_insn_mi/s` |  32 | -          |  33.17 |  28.78 |
| `trace_gen_time_ms   ` |  182.25 |  729 |  217 |  157 |
| `memory_finalize_time_ms` |  1 |  4 |  4 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  294.50 |  1,178 |  348 |  273 |
| `main_trace_commit_time_ms` |  52.25 |  209 |  58 |  50 |
| `generate_perm_trace_time_ms` |  34.25 |  137 |  55 |  19 |
| `perm_trace_commit_time_ms` |  65.58 |  262.32 |  72.21 |  56.80 |
| `quotient_poly_compute_time_ms` |  59.21 |  236.83 |  70.21 |  53.41 |
| `quotient_poly_commit_time_ms` |  15.09 |  60.36 |  16.75 |  12.80 |
| `pcs_opening_time_ms ` |  65.50 |  262 |  85 |  56 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,371.75 |  5,487 |  1,990 |  891 |
...
| `execute_preflight_insns` |  1,440,855 |  5,763,420 |  1,814,630 |  1,241,327 |
| `execute_preflight_time_ms` |  619.25 |  2,477 |  836 |  226 |
| `execute_preflight_insn_mi/s` |  7.11 | -          |  7.41 |  6.88 |
| `trace_gen_time_ms   ` |  86.50 |  346 |  162 |  57 |
| `memory_finalize_time_ms` |  8.50 |  34 |  16 |  5 |
| `stark_prove_excluding_trace_time_ms` |  664.75 |  2,659 |  1,074 |  492 |
| `main_trace_commit_time_ms` |  126 |  504 |  196 |  92 |
| `generate_perm_trace_time_ms` |  50 |  200 |  72 |  40 |
| `perm_trace_commit_time_ms` |  200.59 |  802.36 |  344.88 |  141.53 |
| `quotient_poly_compute_time_ms` |  143.36 |  573.45 |  233.89 |  103.18 |
| `quotient_poly_commit_time_ms` |  31.46 |  125.83 |  50.95 |  24.25 |
| `pcs_opening_time_ms ` |  109.50 |  438 |  170 |  87 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 1,992 |  | 1 | 1 |  |  |  |  | 
| regex_program |  | 547 |  | 1 | 38 | 4,137,502 | 108.56 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 70 | 891 | 22,981,570 | 319,331,818 | 70 | 593 | 0 | 133.08 | 26.20 | 4 | 173.02 | 92 | 216 | 92 | 7 | 124 | 9,122,488 | 42 | 226 | 1,466,015 | 7.41 | 30 | 160 | 0 | 92 | 
| leaf | 1 | 57 | 1,386 | 20,905,034 | 255,237,610 | 57 | 492 | 0 | 103.30 | 24.25 | 4 | 142.93 | 87 | 183 | 87 | 5 | 92 | 8,256,948 | 40 | 836 | 1,241,448 | 7.12 | 26 | 128 | 0 | 87 | 
| leaf | 2 | 57 | 1,220 | 20,905,034 | 255,237,610 | 57 | 500 | 0 | 103.18 | 24.43 | 4 | 141.53 | 89 | 188 | 89 | 6 | 92 | 8,256,948 | 46 | 662 | 1,241,327 | 7.02 | 26 | 128 | 0 | 89 | 
| leaf | 3 | 162 | 1,990 | 50,337,320 | 538,365,418 | 162 | 1,074 | 0 | 233.89 | 50.95 | 4 | 344.88 | 170 | 418 | 170 | 16 | 196 | 20,171,106 | 72 | 753 | 1,814,630 | 6.88 | 62 | 288 | 5 | 170 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 217 | 756 | 23,446,148 | 150,778,428 | 217 | 348 | 0 | 59.66 | 16.75 | 5 | 72.21 | 85 | 128 | 84 | 4 | 58 | 10,899,170 | 55 | 45 | 1,103,000 | 28.78 | 21 | 77 | 1 | 84 | 
| regex_program | 1 | 157 | 543 | 11,598,276 | 128,513,066 | 157 | 278 | 1 | 53.41 | 15.30 | 5 | 66.20 | 56 | 102 | 55 | 0 | 50 | 2,196,106 | 35 | 66 | 1,104,000 | 32.94 | 16 | 69 | 0 | 55 | 
| regex_program | 2 | 167 | 546 | 11,579,064 | 128,513,066 | 167 | 279 | 1 | 53.55 | 15.52 | 5 | 67.11 | 63 | 95 | 63 | 0 | 50 | 2,177,334 | 28 | 57 | 1,104,000 | 33.17 | 16 | 69 | 0 | 63 | 
| regex_program | 3 | 188 | 547 | 11,853,872 | 103,456,394 | 188 | 273 | 0 | 70.21 | 12.80 | 5 | 56.80 | 58 | 79 | 57 | 0 | 51 | 2,422,606 | 19 | 44 | 826,502 | 33.11 | 18 | 84 | 1 | 57 | 
...
Commit: https://github.com/openvm-org/openvm/commit/6ff454e651ebbdb4d97296daa5a3f12b10ae55f5
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/19583888585)

...
| `total_proof_time_ms ` |  6,183 |  6,183 |  6,183 |  6,183 |
...
| `stark_prove_excluding_trace_time_ms` |  5,036 |  5,036 |  5,036 |  5,036 |
| `main_trace_commit_time_ms` |  812 |  812 |  812 |  812 |
| `generate_perm_trace_time_ms` |  177 |  177 |  177 |  177 |
| `perm_trace_commit_time_ms` |  1,664 |  1,664 |  1,664 |  1,664 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,985 |  7,985 |  7,985 |  7,985 |
| `main_cells_used     ` |  70,261,826 |  70,261,826 |  70,261,826 |  70,261,826 |
| `total_cycles        ` |  1,817,697 |  1,817,697 |  1,817,697 |  1,817,697 |
| `execute_time_ms     ` |  351 |  351 |  351 |  351 |
| `trace_gen_time_ms   ` |  1,297 |  1,297 |  1,297 |  1,297 |
| `stark_prove_excluding_trace_time_ms` |  6,337 |  6,337 |  6,337 |  6,337 |
| `main_trace_commit_time_ms` |  1,102 |  1,102 |  1,102 |  1,102 |
| `generate_perm_trace_time_ms` |  133 |  133 |  133 |  133 |
| `perm_trace_commit_time_ms` |  1,180 |  1,180 |  1,180 |  1,180 |
| `quotient_poly_compute_time_ms` |  1,572 |  1,572 |  1,572 |  1,572 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,297 | 7,985 | 1,817,697 | 180,014,040 | 6,337 | 1,572 | 1,034 | 1,180 | 1,312 | 1,102 | 70,261,826 | 133 | 351 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 835 | 6,183 | 1,500,137 | 197,440,542 | 5,036 | 801 | 505 | 1,664 | 1,076 | 812 | 51,487,838 | 177 | 312 | 

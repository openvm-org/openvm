...
| `total_proof_time_ms ` |  3,912 |  7,824 |  4,503 |  3,321 |
| `main_cells_used     ` |  83,723,935.50 |  167,447,871 |  93,738,635 |  73,709,236 |
| `total_cycles        ` |  2,070,213.50 |  4,140,427 |  2,225,434 |  1,914,993 |
| `execute_time_ms     ` |  340 |  680 |  377 |  303 |
| `trace_gen_time_ms   ` |  989.50 |  1,979 |  1,164 |  815 |
| `stark_prove_excluding_trace_time_ms` |  2,582.50 |  5,165 |  2,962 |  2,203 |
| `main_trace_commit_time_ms` |  454 |  908 |  538 |  370 |
| `generate_perm_trace_time_ms` |  166.50 |  333 |  195 |  138 |
| `perm_trace_commit_time_ms` |  645 |  1,290 |  747 |  543 |
| `quotient_poly_compute_time_ms` |  363 |  726 |  421 |  305 |
| `quotient_poly_commit_time_ms` |  276.50 |  553 |  322 |  231 |
| `pcs_opening_time_ms ` |  668.50 |  1,337 |  731 |  606 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,262 |  14,524 |  7,339 |  7,185 |
| `main_cells_used     ` |  152,710,635.50 |  305,421,271 |  155,169,887 |  150,251,384 |
| `total_cycles        ` |  1,991,081 |  3,982,162 |  2,021,885 |  1,960,277 |
| `execute_time_ms     ` |  757.50 |  1,515 |  767 |  748 |
| `trace_gen_time_ms   ` |  1,477.50 |  2,955 |  1,515 |  1,440 |
| `stark_prove_excluding_trace_time_ms` |  5,027 |  10,054 |  5,057 |  4,997 |
| `main_trace_commit_time_ms` |  806.50 |  1,613 |  807 |  806 |
| `generate_perm_trace_time_ms` |  346 |  692 |  352 |  340 |
| `perm_trace_commit_time_ms` |  1,546.50 |  3,093 |  1,582 |  1,511 |
| `quotient_poly_compute_time_ms` |  773 |  1,546 |  773 |  773 |
| `quotient_poly_commit_time_ms` |  494.50 |  989 |  497 |  492 |
| `pcs_opening_time_ms ` |  1,056 |  2,112 |  1,064 |  1,048 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,515 | 7,339 | 2,021,885 | 538,660,330 | 5,057 | 773 | 492 | 1,582 | 1,048 | 806 | 155,169,887 | 352 | 767 | 
| leaf | 1 | 1,440 | 7,185 | 1,960,277 | 538,660,330 | 4,997 | 773 | 497 | 1,511 | 1,064 | 807 | 150,251,384 | 340 | 748 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,164 | 4,503 | 2,225,434 | 275,652,919 | 2,962 | 421 | 322 | 747 | 731 | 538 | 93,738,635 | 195 | 377 | 
| regex_program | 1 | 815 | 3,321 | 1,914,993 | 198,099,628 | 2,203 | 305 | 231 | 543 | 606 | 370 | 73,709,236 | 138 | 303 | 

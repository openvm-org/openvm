...
|:---|---:|---:|---:|
| Total |  42.03 |  13.96 | 13.96 |
| regex_program |  17.82 |  5.36 |  5.36 |
| leaf |  24.22 |  8.61 |  8.61 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  4,444.75 |  17,779 |  5,320 |  3,703 |
...
| `execute_preflight_insn_mi/s` |  31.45 | -          |  31.97 |  30.47 |
| `trace_gen_time_ms   ` |  178.25 |  713 |  194 |  171 |
| `memory_finalize_time_ms` |  1 |  4 |  4 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  4,146.25 |  16,585 |  4,920 |  3,441 |
| `main_trace_commit_time_ms` |  51 |  204 |  57 |  48 |
| `generate_perm_trace_time_ms` |  46.25 |  185 |  101 |  26 |
| `perm_trace_commit_time_ms` |  64.37 |  257.47 |  70.78 |  55.19 |
| `quotient_poly_compute_time_ms` |  57.43 |  229.71 |  68.82 |  51.57 |
| `quotient_poly_commit_time_ms` |  15.98 |  63.91 |  17.98 |  14.06 |
| `pcs_opening_time_ms ` |  3,908 |  15,632 |  4,685 |  3,231 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  6,054.25 |  24,217 |  8,606 |  4,924 |
...
| `execute_preflight_insns` |  2,313,391.75 |  9,253,567 |  2,694,218 |  2,073,727 |
| `execute_preflight_time_ms` |  1,085.75 |  4,343 |  1,441 |  393 |
| `execute_preflight_insn_mi/s` |  6.31 | -          |  6.73 |  5.70 |
| `trace_gen_time_ms   ` |  126.75 |  507 |  216 |  92 |
| `memory_finalize_time_ms` |  12.25 |  49 |  22 |  8 |
| `stark_prove_excluding_trace_time_ms` |  4,840 |  19,360 |  7,049 |  3,858 |
| `main_trace_commit_time_ms` |  214 |  856 |  377 |  146 |
| `generate_perm_trace_time_ms` |  147.25 |  589 |  215 |  62 |
| `perm_trace_commit_time_ms` |  354.30 |  1,417.19 |  688.09 |  226.60 |
| `quotient_poly_compute_time_ms` |  246.03 |  984.12 |  449.49 |  170.54 |
| `quotient_poly_commit_time_ms` |  51.41 |  205.66 |  97.36 |  30.53 |
| `pcs_opening_time_ms ` |  3,822.50 |  15,290 |  5,266 |  3,130 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 8,609 |  | 1 | 1 |  |  |  |  | 
| regex_program |  | 4,236 |  | 1 | 36 | 4,137,225 | 112.96 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 106 | 4,924 | 32,462,072 | 471,277,034 | 106 | 4,424 | 0 | 192.23 | 46.64 | 6 | 275 | 3,505 | 491 | 3,504 | 11 | 187 | 13,049,642 | 215 | 393 | 2,411,819 | 6.73 | 53 | 240 | 4 | 3,504 | 
| leaf | 1 | 93 | 5,564 | 29,459,256 | 403,119,594 | 93 | 4,029 | 0 | 170.54 | 31.12 | 6 | 227.50 | 3,389 | 290 | 3,389 | 8 | 146 | 11,793,502 | 62 | 1,441 | 2,073,727 | 6.37 | 38 | 203 | 0 | 3,388 | 
| leaf | 2 | 92 | 5,123 | 29,459,256 | 403,119,594 | 92 | 3,858 | 0 | 171.86 | 30.53 | 6 | 226.60 | 3,130 | 377 | 3,130 | 8 | 146 | 11,793,502 | 150 | 1,170 | 2,073,803 | 6.44 | 38 | 203 | 0 | 3,130 | 
| leaf | 3 | 216 | 8,606 | 60,122,886 | 989,416,938 | 216 | 7,049 | 0 | 449.49 | 97.36 | 7 | 688.09 | 5,266 | 851 | 5,266 | 22 | 377 | 24,209,404 | 162 | 1,339 | 2,694,218 | 5.70 | 136 | 554 | 9 | 5,266 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 171 | 5,320 | 23,458,696 | 150,778,428 | 171 | 4,920 | 0 | 56.13 | 17.98 | 7 | 70.78 | 4,685 | 103 | 4,685 | 4 | 57 | 10,906,398 | 31 | 57 | 1,103,000 | 30.47 | 22 | 74 | 0 | 4,684 | 
| regex_program | 1 | 174 | 3,703 | 11,603,568 | 128,513,066 | 174 | 3,441 | 1 | 51.57 | 15.72 | 6 | 65.17 | 3,231 | 91 | 3,231 | 0 | 50 | 2,196,414 | 26 | 46 | 1,104,000 | 31.64 | 17 | 67 | 0 | 3,231 | 
| regex_program | 2 | 174 | 4,520 | 11,597,216 | 128,513,066 | 174 | 4,258 | 1 | 53.19 | 16.16 | 6 | 66.32 | 4,043 | 94 | 4,043 | 0 | 49 | 2,190,286 | 27 | 46 | 1,104,000 | 31.73 | 16 | 69 | 0 | 4,043 | 
| regex_program | 3 | 194 | 4,236 | 11,874,660 | 103,456,394 | 194 | 3,966 | 0 | 68.82 | 14.06 | 7 | 55.19 | 3,673 | 159 | 3,673 | 0 | 48 | 2,437,978 | 101 | 34 | 826,225 | 31.97 | 19 | 83 | 0 | 3,673 | 

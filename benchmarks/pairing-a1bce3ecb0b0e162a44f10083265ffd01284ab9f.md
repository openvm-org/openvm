...
|:---|---:|---:|---:|
| Total |  4.50 |  2.70 | 2.70 |
| pairing |  1.54 |  0.93 |  0.93 |
| leaf |  2.97 |  1.77 |  1.77 |
...
| `total_proof_time_ms ` |  737 |  1,474 |  871 |  603 |
...
| `execute_metered_insn_mi/s` |  27.42 | -          |  27.42 |  27.42 |
| `execute_preflight_insns` |  872,871 |  1,745,742 |  1,149,000 |  596,742 |
| `execute_preflight_time_ms` |  83.50 |  167 |  106 |  61 |
| `execute_preflight_insn_mi/s` |  14.74 | -          |  18.22 |  11.25 |
| `trace_gen_time_ms   ` |  186 |  372 |  192 |  180 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  360.50 |  721 |  413 |  308 |
| `main_trace_commit_time_ms` |  64.50 |  129 |  75 |  54 |
| `generate_perm_trace_time_ms` |  45 |  90 |  53 |  37 |
| `perm_trace_commit_time_ms` |  76.98 |  153.97 |  89.53 |  64.43 |
| `quotient_poly_compute_time_ms` |  84.16 |  168.32 |  92.40 |  75.92 |
| `quotient_poly_commit_time_ms` |  16.90 |  33.80 |  18.60 |  15.20 |
| `pcs_opening_time_ms ` |  67.50 |  135 |  79 |  56 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,483.50 |  2,967 |  1,767 |  1,200 |
| `main_cells_used     ` |  16,200,472 |  32,400,944 |  16,332,746 |  16,068,198 |
| `total_cells_used    ` |  39,332,920 |  78,665,840 |  39,650,868 |  39,014,972 |
| `execute_preflight_insns` |  1,952,459.50 |  3,904,919 |  1,991,972 |  1,912,947 |
| `execute_preflight_time_ms` |  594 |  1,188 |  889 |  299 |
| `execute_preflight_insn_mi/s` |  7.61 | -          |  7.62 |  7.60 |
| `trace_gen_time_ms   ` |  121 |  242 |  126 |  116 |
| `memory_finalize_time_ms` |  13 |  26 |  14 |  12 |
| `stark_prove_excluding_trace_time_ms` |  767 |  1,534 |  773 |  761 |
| `main_trace_commit_time_ms` |  148.50 |  297 |  152 |  145 |
| `generate_perm_trace_time_ms` |  64 |  128 |  70 |  58 |
| `perm_trace_commit_time_ms` |  229.52 |  459.05 |  233.93 |  225.12 |
| `quotient_poly_compute_time_ms` |  176.77 |  353.54 |  178.54 |  174.100 |
| `quotient_poly_commit_time_ms` |  33.54 |  67.08 |  35.41 |  31.67 |
| `pcs_opening_time_ms ` |  111 |  222 |  111 |  111 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 126 | 1,200 | 39,650,868 | 410,701,290 | 126 | 773 | 0 | 178.54 | 35.41 | 4 | 233.93 | 111 | 293 | 111 | 14 | 152 | 16,332,746 | 58 | 299 | 1,991,972 | 7.60 | 39 | 215 | 0 | 111 | 
| leaf | 1 | 116 | 1,767 | 39,014,972 | 396,840,426 | 116 | 761 | 0 | 174.100 | 31.67 | 4 | 225.12 | 111 | 296 | 111 | 12 | 145 | 16,068,198 | 70 | 889 | 1,912,947 | 7.62 | 38 | 208 | 0 | 111 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 180 | 871 | 32,480,114 | 172,558,444 | 180 | 413 | 0 | 92.40 | 18.60 | 6 | 89.53 | 79 | 146 | 79 | 1 | 75 | 15,909,408 | 53 | 106 | 1,149,000 | 11.25 | 27 | 111 | 1 | 79 | 
| pairing | 1 | 192 | 603 | 22,464,232 | 119,958,502 | 192 | 308 | 1 | 75.92 | 15.20 | 6 | 64.43 | 56 | 105 | 56 | 0 | 54 | 9,498,894 | 37 | 61 | 596,742 | 18.22 | 21 | 91 | 1 | 56 | 
...
Commit: https://github.com/openvm-org/openvm/commit/a1bce3ecb0b0e162a44f10083265ffd01284ab9f
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/20383486026)

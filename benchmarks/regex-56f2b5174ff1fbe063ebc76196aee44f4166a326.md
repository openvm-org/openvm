...
| `total_proof_time_ms ` |  3,758.50 |  7,517 |  4,173 |  3,344 |
| `main_cells_used     ` |  83,255,576 |  166,511,152 |  93,500,799 |  73,010,353 |
| `total_cycles        ` |  2,082,613 |  4,165,226 |  2,243,715 |  1,921,511 |
| `execute_time_ms     ` |  337.50 |  675 |  376 |  299 |
| `trace_gen_time_ms   ` |  967.50 |  1,935 |  1,147 |  788 |
| `stark_prove_excluding_trace_time_ms` |  2,453.50 |  4,907 |  2,650 |  2,257 |
| `main_trace_commit_time_ms` |  448 |  896 |  501 |  395 |
| `generate_perm_trace_time_ms` |  207.50 |  415 |  222 |  193 |
| `perm_trace_commit_time_ms` |  487.50 |  975 |  515 |  460 |
| `quotient_poly_compute_time_ms` |  338 |  676 |  363 |  313 |
| `quotient_poly_commit_time_ms` |  253.50 |  507 |  273 |  234 |
| `pcs_opening_time_ms ` |  710.50 |  1,421 |  767 |  654 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  6,595.50 |  13,191 |  6,668 |  6,523 |
| `main_cells_used     ` |  152,278,067 |  304,556,134 |  154,677,806 |  149,878,328 |
| `total_cycles        ` |  1,990,991.50 |  3,981,983 |  2,021,809 |  1,960,174 |
| `execute_time_ms     ` |  777.50 |  1,555 |  784 |  771 |
| `trace_gen_time_ms   ` |  1,462.50 |  2,925 |  1,492 |  1,433 |
| `stark_prove_excluding_trace_time_ms` |  4,355.50 |  8,711 |  4,392 |  4,319 |
| `main_trace_commit_time_ms` |  776 |  1,552 |  776 |  776 |
| `generate_perm_trace_time_ms` |  379.50 |  759 |  397 |  362 |
| `perm_trace_commit_time_ms` |  1,100.50 |  2,201 |  1,102 |  1,099 |
| `quotient_poly_compute_time_ms` |  658 |  1,316 |  661 |  655 |
| `quotient_poly_commit_time_ms` |  379.50 |  759 |  380 |  379 |
| `pcs_opening_time_ms ` |  1,057 |  2,114 |  1,071 |  1,043 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,492 | 6,668 | 2,021,809 | 538,660,330 | 4,392 | 661 | 379 | 1,102 | 1,071 | 776 | 154,677,806 | 397 | 784 | 
| leaf | 1 | 1,433 | 6,523 | 1,960,174 | 538,660,330 | 4,319 | 655 | 380 | 1,099 | 1,043 | 776 | 149,878,328 | 362 | 771 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,147 | 4,173 | 2,243,715 | 275,652,919 | 2,650 | 363 | 273 | 515 | 767 | 501 | 93,500,799 | 222 | 376 | 
| regex_program | 1 | 788 | 3,344 | 1,921,511 | 242,975,404 | 2,257 | 313 | 234 | 460 | 654 | 395 | 73,010,353 | 193 | 299 | 

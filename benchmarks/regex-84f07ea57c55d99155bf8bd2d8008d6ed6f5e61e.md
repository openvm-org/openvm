...
| `total_proof_time_ms ` |  3,879.50 |  7,759 |  4,471 |  3,288 |
...
| `trace_gen_time_ms   ` |  959 |  1,918 |  1,145 |  773 |
| `stark_prove_excluding_trace_time_ms` |  2,584 |  5,168 |  2,953 |  2,215 |
| `main_trace_commit_time_ms` |  450.50 |  901 |  531 |  370 |
| `generate_perm_trace_time_ms` |  170.50 |  341 |  203 |  138 |
| `perm_trace_commit_time_ms` |  645 |  1,290 |  748 |  542 |
| `quotient_poly_compute_time_ms` |  363.50 |  727 |  421 |  306 |
| `quotient_poly_commit_time_ms` |  274.50 |  549 |  320 |  229 |
| `pcs_opening_time_ms ` |  671 |  1,342 |  721 |  621 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,469 |  14,938 |  7,538 |  7,400 |
| `main_cells_used     ` |  152,307,013.50 |  304,614,027 |  154,766,263 |  149,847,764 |
| `total_cycles        ` |  1,993,412 |  3,986,824 |  2,024,283 |  1,962,541 |
| `execute_time_ms     ` |  764.50 |  1,529 |  771 |  758 |
| `trace_gen_time_ms   ` |  1,432.50 |  2,865 |  1,459 |  1,406 |
| `stark_prove_excluding_trace_time_ms` |  5,272 |  10,544 |  5,308 |  5,236 |
| `main_trace_commit_time_ms` |  891 |  1,782 |  892 |  890 |
| `generate_perm_trace_time_ms` |  355.50 |  711 |  365 |  346 |
| `perm_trace_commit_time_ms` |  1,673.50 |  3,347 |  1,693 |  1,654 |
| `quotient_poly_compute_time_ms` |  763.50 |  1,527 |  766 |  761 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,459 | 7,538 | 2,024,283 | 533,941,738 | 5,308 | 766 | 522 | 1,693 | 1,067 | 890 | 154,766,263 | 365 | 771 | 
| leaf | 1 | 1,406 | 7,400 | 1,962,541 | 533,941,738 | 5,236 | 761 | 520 | 1,654 | 1,059 | 892 | 149,847,764 | 346 | 758 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,145 | 4,471 | 2,225,434 | 275,652,919 | 2,953 | 421 | 320 | 748 | 721 | 531 | 93,699,990 | 203 | 373 | 
| regex_program | 1 | 773 | 3,288 | 1,914,730 | 198,099,628 | 2,215 | 306 | 229 | 542 | 621 | 370 | 73,689,460 | 138 | 300 | 

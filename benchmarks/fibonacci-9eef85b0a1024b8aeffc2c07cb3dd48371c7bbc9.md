...
|:---|---:|---:|---:|
| Total |  16.89 |  9.45 | 9.45 |
| fibonacci_program |  6.69 |  3.51 |  3.51 |
| leaf |  10.20 |  5.94 |  5.94 |


| fibonacci_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  3,342 |  6,684 |  3,502 |  3,182 |
...
| `execute_metered_insn_mi/s` |  163.19 | -          |  163.19 |  163.19 |
| `execute_preflight_insns` |  750,104.50 |  1,500,209 |  873,000 |  627,209 |
| `execute_preflight_time_ms` |  26.50 |  53 |  32 |  21 |
| `execute_preflight_insn_mi/s` |  38.44 | -          |  38.58 |  38.29 |
| `trace_gen_time_ms   ` |  194 |  388 |  198 |  190 |
| `memory_finalize_time_ms` | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  3,015 |  6,030 |  3,110 |  2,920 |
| `main_trace_commit_time_ms` |  30.50 |  61 |  33 |  28 |
| `generate_perm_trace_time_ms` |  42 |  84 |  48 |  36 |
| `perm_trace_commit_time_ms` |  40.97 |  81.94 |  43.73 |  38.21 |
| `quotient_poly_compute_time_ms` |  31.43 |  62.86 |  34.98 |  27.88 |
| `quotient_poly_commit_time_ms` |  12.65 |  25.29 |  12.74 |  12.55 |
| `pcs_opening_time_ms ` |  2,855.50 |  5,711 |  2,936 |  2,775 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  5,101 |  10,202 |  5,940 |  4,262 |
| `main_cells_used     ` |  9,914,556 |  19,829,112 |  10,125,186 |  9,703,926 |
| `total_cells_used    ` |  25,902,618 |  51,805,236 |  26,406,284 |  25,398,952 |
| `execute_preflight_insns` |  2,000,128 |  4,000,256 |  2,062,060 |  1,938,196 |
| `execute_preflight_time_ms` |  917.50 |  1,835 |  1,462 |  373 |
| `execute_preflight_insn_mi/s` |  5.95 | -          |  5.95 |  5.95 |
| `trace_gen_time_ms   ` |  94.50 |  189 |  99 |  90 |
| `memory_finalize_time_ms` |  8.50 |  17 |  9 |  8 |
| `stark_prove_excluding_trace_time_ms` |  4,087.50 |  8,175 |  4,385 |  3,790 |
| `main_trace_commit_time_ms` |  132.50 |  265 |  133 |  132 |
| `generate_perm_trace_time_ms` |  73 |  146 |  101 |  45 |
| `perm_trace_commit_time_ms` |  184.69 |  369.38 |  185.58 |  183.80 |
| `quotient_poly_compute_time_ms` |  145.89 |  291.77 |  146.16 |  145.61 |
| `quotient_poly_commit_time_ms` |  29.74 |  59.48 |  29.96 |  29.52 |
| `pcs_opening_time_ms ` |  3,518.50 |  7,037 |  3,790 |  3,247 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program |  | 3,182 |  | 1 | 9 | 1,500,209 | 163.19 | 0 | 
| leaf | 5,942 |  | 1 | 1 |  |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 99 | 4,262 | 26,406,284 | 342,564,330 | 99 | 3,790 | 0 | 145.61 | 29.52 | 6 | 185.58 | 3,247 | 232 | 3,246 | 9 | 133 | 10,125,186 | 45 | 373 | 2,062,060 | 5.95 | 32 | 176 | 0 | 3,246 | 
| leaf | 1 | 90 | 5,940 | 25,398,952 | 342,564,330 | 90 | 4,385 | 0 | 146.16 | 29.96 | 6 | 183.80 | 3,790 | 285 | 3,789 | 8 | 132 | 9,703,926 | 101 | 1,462 | 1,938,196 | 5.95 | 33 | 177 | 0 | 3,789 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 190 | 3,502 | 9,677,708 | 84,395,212 | 190 | 3,110 | 0 | 34.98 | 12.74 | 6 | 43.73 | 2,936 | 92 | 2,936 | 0 | 33 | 1,035,986 | 48 | 32 | 873,000 | 38.29 | 14 | 48 | 0 | 2,935 | 
| fibonacci_program | 1 | 198 | 3,182 | 9,708,170 | 74,305,770 | 198 | 2,920 | 1 | 27.88 | 12.55 | 5 | 38.21 | 2,775 | 74 | 2,775 | 0 | 28 | 1,064,416 | 36 | 21 | 627,209 | 38.58 | 11 | 40 | 0 | 2,775 | 

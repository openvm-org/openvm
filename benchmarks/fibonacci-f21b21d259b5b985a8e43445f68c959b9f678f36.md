...
| `total_proof_time_ms ` |  582 |  1,164 |  659 |  505 |
...
| `execute_metered_insn_mi/s` |  146.89 | -          |  146.89 |  146.89 |
| `execute_preflight_insns` |  750,105 |  1,500,210 |  873,000 |  627,210 |
| `execute_preflight_time_ms` |  28.50 |  57 |  32 |  25 |
| `execute_preflight_insn_mi/s` |  38.02 | -          |  39.98 |  36.07 |
| `trace_gen_time_ms   ` |  207 |  414 |  211 |  203 |
| `memory_finalize_time_ms` | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  253 |  506 |  278 |  228 |
| `main_trace_commit_time_ms` |  33 |  66 |  35 |  31 |
| `generate_perm_trace_time_ms` |  18 |  36 |  25 |  11 |
| `perm_trace_commit_time_ms` |  44.27 |  88.55 |  46.66 |  41.89 |
| `quotient_poly_compute_time_ms` |  28.87 |  57.74 |  30.67 |  27.07 |
| `quotient_poly_commit_time_ms` |  13.30 |  26.60 |  14.06 |  12.54 |
| `pcs_opening_time_ms ` |  113.50 |  227 |  124 |  103 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,221 |  2,442 |  1,439 |  1,003 |
...
| `execute_preflight_time_ms` |  493.50 |  987 |  788 |  199 |
| `execute_preflight_insn_mi/s` |  6.83 | -          |  6.92 |  6.74 |
| `trace_gen_time_ms   ` |  58 |  116 |  62 |  54 |
| `memory_finalize_time_ms` |  5.50 |  11 |  6 |  5 |
| `stark_prove_excluding_trace_time_ms` |  668.50 |  1,337 |  742 |  595 |
| `main_trace_commit_time_ms` |  90 |  180 |  98 |  82 |
| `generate_perm_trace_time_ms` |  50.50 |  101 |  52 |  49 |
| `perm_trace_commit_time_ms` |  130.84 |  261.67 |  148.87 |  112.81 |
| `quotient_poly_compute_time_ms` |  83.61 |  167.23 |  92.32 |  74.90 |
| `quotient_poly_commit_time_ms` |  25.19 |  50.37 |  27.82 |  22.55 |
| `pcs_opening_time_ms ` |  285.50 |  571 |  323 |  248 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program |  | 505 |  | 41 | 1 | 10 | 1,500,210 | 146.89 | 141 | 
| leaf | 1,440 |  | 1 |  | 1 |  |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 62 | 1,003 | 17,887,054 | 252,878,314 | 62 | 742 | 0 | 92.32 | 27.82 | 4 | 148.87 | 323 | 198 | 323 | 6 | 98 | 6,608,072 | 49 | 199 | 1,229,594 | 6.92 | 24 | 121 | 1 | 322 | 
| leaf | 1 | 54 | 1,439 | 17,250,234 | 207,789,546 | 54 | 595 | 0 | 74.90 | 22.55 | 4 | 112.81 | 248 | 166 | 248 | 5 | 82 | 6,343,052 | 52 | 788 | 1,151,182 | 6.74 | 21 | 98 | 1 | 248 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 211 | 659 | 9,684,992 | 84,395,212 | 211 | 278 | 0 | 30.67 | 14.06 | 4 | 46.66 | 124 | 72 | 124 | 0 | 35 | 1,040,430 | 25 | 25 | 873,000 | 36.07 | 13 | 45 | 1 | 124 | 
| fibonacci_program | 1 | 203 | 505 | 9,714,030 | 74,305,770 | 203 | 228 | 1 | 27.07 | 12.54 | 5 | 41.89 | 103 | 53 | 103 | 0 | 31 | 1,067,532 | 11 | 32 | 627,210 | 39.98 | 10 | 40 | 1 | 103 | 

...
| `execute_preflight_insn_mi/s` |  11.44 | -          |  11.44 |  11.44 |
| `trace_gen_time_ms   ` |  279 |  279 |  279 |  279 |
| `memory_finalize_time_ms` |  1 |  1 |  1 |  1 |
| `stark_prove_excluding_trace_time_ms` |  979 |  979 |  979 |  979 |
| `main_trace_commit_time_ms` |  153 |  153 |  153 |  153 |
| `generate_perm_trace_time_ms` |  77 |  77 |  77 |  77 |
| `perm_trace_commit_time_ms` |  181.85 |  181.85 |  181.85 |  181.85 |
| `quotient_poly_compute_time_ms` |  147.76 |  147.76 |  147.76 |  147.76 |
| `quotient_poly_commit_time_ms` |  35.11 |  35.11 |  35.11 |  35.11 |
| `pcs_opening_time_ms ` |  378 |  378 |  378 |  378 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,799 |  1,799 |  1,799 |  1,799 |
| `main_cells_used     ` |  16,451,316 |  16,451,316 |  16,451,316 |  16,451,316 |
| `total_cells_used    ` |  39,940,154 |  39,940,154 |  39,940,154 |  39,940,154 |
| `execute_preflight_insns` |  2,010,453 |  2,010,453 |  2,010,453 |  2,010,453 |
| `execute_preflight_time_ms` |  354 |  354 |  354 |  354 |
| `execute_preflight_insn_mi/s` |  7.22 | -          |  7.22 |  7.22 |
| `trace_gen_time_ms   ` |  160 |  160 |  160 |  160 |
| `memory_finalize_time_ms` |  14 |  14 |  14 |  14 |
| `stark_prove_excluding_trace_time_ms` |  1,284 |  1,284 |  1,284 |  1,284 |
| `main_trace_commit_time_ms` |  163 |  163 |  163 |  163 |
| `generate_perm_trace_time_ms` |  70 |  70 |  70 |  70 |
| `perm_trace_commit_time_ms` |  253.76 |  253.76 |  253.76 |  253.76 |
| `quotient_poly_compute_time_ms` |  172.74 |  172.74 |  172.74 |  172.74 |
| `quotient_poly_commit_time_ms` |  42.56 |  42.56 |  42.56 |  42.56 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 1,801 |  | 1 |  | 1 |  |  |  |  | 
| pairing |  | 1,556 |  | 40 | 1 | 92 | 1,882,939 | 20.25 | 157 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 160 | 1,799 | 39,940,154 | 418,598,378 | 160 | 1,284 | 0 | 172.74 | 42.56 | 5 | 253.76 | 578 | 324 | 578 | 14 | 163 | 16,451,316 | 70 | 354 | 2,010,453 | 7.22 | 39 | 217 | 1 | 578 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 279 | 1,556 | 44,491,360 | 304,931,516 | 279 | 979 | 0 | 147.76 | 35.11 | 7 | 181.85 | 378 | 262 | 378 | 1 | 153 | 23,722,622 | 77 | 170 | 1,882,939 | 11.44 | 37 | 184 | 3 | 378 | 

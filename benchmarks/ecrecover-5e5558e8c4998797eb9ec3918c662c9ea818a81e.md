...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  11,229 |  11,229 |  11,229 |  11,229 |
...
| `trace_gen_time_ms   ` |  1,528 |  1,528 |  1,528 |  1,528 |
| `stark_prove_excluding_trace_time_ms` |  9,135 |  9,135 |  9,135 |  9,135 |
| `main_trace_commit_time_ms` |  1,872 |  1,872 |  1,872 |  1,872 |
| `generate_perm_trace_time_ms` |  264 |  264 |  264 |  264 |
| `perm_trace_commit_time_ms` |  1,991 |  1,991 |  1,991 |  1,991 |
| `quotient_poly_compute_time_ms` |  1,455 |  1,455 |  1,455 |  1,455 |
| `quotient_poly_commit_time_ms` |  1,665 |  1,665 |  1,665 |  1,665 |
| `pcs_opening_time_ms ` |  1,884 |  1,884 |  1,884 |  1,884 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,528 | 11,229 | 1,603,995 | 334,709,720 | 9,135 | 1,455 | 1,665 | 1,991 | 1,884 | 1,872 | 117,320,775 | 264 | 566 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 169 | 2,479 | 284,567 | 38,417,467 | 2,162 | 233 | 484 | 357 | 662 | 381 | 15,055,723 | 32 | 148 | 

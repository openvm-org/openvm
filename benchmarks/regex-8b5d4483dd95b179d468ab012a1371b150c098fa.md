...
| `total_proof_time_ms ` |  7,652 |  15,304 |  8,571 |  6,733 |
| `main_cells_used     ` |  82,727,686.50 |  165,455,373 |  92,686,348 |  72,769,025 |
| `total_cycles        ` |  1,914,103 |  1,914,103 |  1,914,103 |  1,914,103 |
| `execute_time_ms     ` |  456 |  912 |  491 |  421 |
| `trace_gen_time_ms   ` |  1,693 |  3,386 |  1,877 |  1,509 |
| `stark_prove_excluding_trace_time_ms` |  5,503 |  11,006 |  6,203 |  4,803 |
| `main_trace_commit_time_ms` |  1,085.50 |  2,171 |  1,332 |  839 |
| `generate_perm_trace_time_ms` |  179.50 |  359 |  192 |  167 |
| `perm_trace_commit_time_ms` |  1,178 |  2,356 |  1,243 |  1,113 |
| `quotient_poly_compute_time_ms` |  737.50 |  1,475 |  865 |  610 |
| `quotient_poly_commit_time_ms` |  983.50 |  1,967 |  1,128 |  839 |
| `pcs_opening_time_ms ` |  1,328.50 |  2,657 |  1,435 |  1,222 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  14,719 |  29,438 |  14,864 |  14,574 |
| `main_cells_used     ` |  129,447,789 |  258,895,578 |  131,047,571 |  127,848,007 |
| `total_cycles        ` |  2,941,693 |  5,883,386 |  2,978,026 |  2,905,360 |
| `execute_time_ms     ` |  646.50 |  1,293 |  689 |  604 |
| `trace_gen_time_ms   ` |  2,644 |  5,288 |  2,811 |  2,477 |
| `stark_prove_excluding_trace_time_ms` |  11,428.50 |  22,857 |  11,449 |  11,408 |
| `main_trace_commit_time_ms` |  2,367.50 |  4,735 |  2,374 |  2,361 |
| `generate_perm_trace_time_ms` |  281 |  562 |  282 |  280 |
| `perm_trace_commit_time_ms` |  2,307 |  4,614 |  2,308 |  2,306 |
| `quotient_poly_compute_time_ms` |  1,640.50 |  3,281 |  1,645 |  1,636 |
| `quotient_poly_commit_time_ms` |  2,216 |  4,432 |  2,228 |  2,204 |
| `pcs_opening_time_ms ` |  2,612 |  5,224 |  2,621 |  2,603 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 2,477 | 14,574 | 2,978,026 | 353,773,272 | 11,408 | 1,645 | 2,204 | 2,308 | 2,603 | 2,361 | 131,047,571 | 282 | 689 | 
| leaf | 1 | 2,811 | 14,864 | 2,905,360 | 353,780,696 | 11,449 | 1,636 | 2,228 | 2,306 | 2,621 | 2,374 | 127,848,007 | 280 | 604 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,877 | 8,571 |  | 209,921,543 | 6,203 | 865 | 1,128 | 1,243 | 1,435 | 1,332 | 92,686,348 | 192 | 491 | 
| regex_program | 1 | 1,509 | 6,733 | 1,914,103 | 149,454,692 | 4,803 | 610 | 839 | 1,113 | 1,222 | 839 | 72,769,025 | 167 | 421 | 

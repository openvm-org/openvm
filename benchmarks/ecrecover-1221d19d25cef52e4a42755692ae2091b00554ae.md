...
| `total_proof_time_ms ` |  2,478 |  2,478 |  2,478 |  2,478 |
...
| `stark_prove_excluding_trace_time_ms` |  2,149 |  2,149 |  2,149 |  2,149 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  11,387 |  11,387 |  11,387 |  11,387 |
| `main_cells_used     ` |  117,321,036 |  117,321,036 |  117,321,036 |  117,321,036 |
| `total_cycles        ` |  1,604,024 |  1,604,024 |  1,604,024 |  1,604,024 |
| `execute_time_ms     ` |  557 |  557 |  557 |  557 |
| `trace_gen_time_ms   ` |  1,522 |  1,522 |  1,522 |  1,522 |
| `stark_prove_excluding_trace_time_ms` |  9,308 |  9,308 |  9,308 |  9,308 |
...
| `quotient_poly_compute_time_ms` |  1,446 |  1,446 |  1,446 |  1,446 |
| `quotient_poly_commit_time_ms` |  1,723 |  1,723 |  1,723 |  1,723 |
| `pcs_opening_time_ms ` |  1,915 |  1,915 |  1,915 |  1,915 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,522 | 11,387 | 1,604,024 | 334,709,720 | 9,308 | 1,446 | 1,723 | 2,040 | 1,915 | 1,923 | 117,321,036 | 257 | 557 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 178 | 2,478 | 284,567 | 38,417,467 | 2,149 | 230 | 482 | 354 | 657 | 382 | 15,055,723 | 32 | 151 | 

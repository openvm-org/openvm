...
| `total_proof_time_ms ` |  5,000 |  5,000 |  5,000 |  5,000 |
| `main_cells_used     ` |  51,485,167 |  51,485,167 |  51,485,167 |  51,485,167 |
| `total_cycles        ` |  1,500,096 |  1,500,096 |  1,500,096 |  1,500,096 |
| `execute_time_ms     ` |  290 |  290 |  290 |  290 |
| `trace_gen_time_ms   ` |  620 |  620 |  620 |  620 |
| `stark_prove_excluding_trace_time_ms` |  4,090 |  4,090 |  4,090 |  4,090 |
...
| `main_cells_used     ` |  38,846,920 |  38,846,920 |  38,846,920 |  38,846,920 |
| `total_cycles        ` |  815,530 |  815,530 |  815,530 |  815,530 |
...
| `perm_trace_commit_time_ms` |  584 |  584 |  584 |  584 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 656 | 4,066 | 815,530 | 95,033,826 | 3,137 | 461 | 650 | 584 | 737 | 620 | 38,846,920 | 82 | 273 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 620 | 5,000 | 1,500,096 | 122,458,688 | 4,090 | 522 | 753 | 801 | 994 | 863 | 51,485,167 | 147 | 290 | 

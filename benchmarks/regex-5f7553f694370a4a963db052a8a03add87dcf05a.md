...
| `total_proof_time_ms ` |  3,978.50 |  7,957 |  4,435 |  3,522 |
| `main_cells_used     ` |  83,255,576 |  166,511,152 |  93,500,799 |  73,010,353 |
| `total_cycles        ` |  2,082,613 |  4,165,226 |  2,243,715 |  1,921,511 |
| `execute_time_ms     ` |  355 |  710 |  395 |  315 |
| `trace_gen_time_ms   ` |  1,007 |  2,014 |  1,191 |  823 |
| `stark_prove_excluding_trace_time_ms` |  2,616.50 |  5,233 |  2,849 |  2,384 |
| `main_trace_commit_time_ms` |  501.50 |  1,003 |  560 |  443 |
| `generate_perm_trace_time_ms` |  229 |  458 |  257 |  201 |
| `perm_trace_commit_time_ms` |  565 |  1,130 |  615 |  515 |
| `quotient_poly_compute_time_ms` |  260.50 |  521 |  280 |  241 |
| `quotient_poly_commit_time_ms` |  241 |  482 |  276 |  206 |
| `pcs_opening_time_ms ` |  811.50 |  1,623 |  853 |  770 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,037.50 |  14,075 |  7,089 |  6,986 |
| `main_cells_used     ` |  151,827,773 |  303,655,546 |  154,227,686 |  149,427,860 |
| `total_cycles        ` |  1,975,721 |  3,951,442 |  2,006,553 |  1,944,889 |
| `execute_time_ms     ` |  786 |  1,572 |  794 |  778 |
| `trace_gen_time_ms   ` |  1,483.50 |  2,967 |  1,485 |  1,482 |
| `stark_prove_excluding_trace_time_ms` |  4,768 |  9,536 |  4,810 |  4,726 |
| `main_trace_commit_time_ms` |  868 |  1,736 |  869 |  867 |
| `generate_perm_trace_time_ms` |  400.50 |  801 |  424 |  377 |
| `perm_trace_commit_time_ms` |  1,246.50 |  2,493 |  1,250 |  1,243 |
| `quotient_poly_compute_time_ms` |  539.50 |  1,079 |  551 |  528 |
| `quotient_poly_commit_time_ms` |  414 |  828 |  415 |  413 |
| `pcs_opening_time_ms ` |  1,291 |  2,582 |  1,295 |  1,287 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,485 | 7,089 | 2,006,553 | 538,660,330 | 4,810 | 551 | 413 | 1,250 | 1,295 | 869 | 154,227,686 | 424 | 794 | 
| leaf | 1 | 1,482 | 6,986 | 1,944,889 | 538,660,330 | 4,726 | 528 | 415 | 1,243 | 1,287 | 867 | 149,427,860 | 377 | 778 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,191 | 4,435 | 2,243,715 | 275,652,919 | 2,849 | 280 | 276 | 615 | 853 | 560 | 93,500,799 | 257 | 395 | 
| regex_program | 1 | 823 | 3,522 | 1,921,511 | 242,975,404 | 2,384 | 241 | 206 | 515 | 770 | 443 | 73,010,353 | 201 | 315 | 

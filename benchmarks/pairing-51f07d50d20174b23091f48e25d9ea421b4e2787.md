...
| `total_proof_time_ms ` |  4,906 |  4,906 |  4,906 |  4,906 |
...
| `quotient_poly_commit_time_ms` |  366 |  366 |  366 |  366 |
| `pcs_opening_time_ms ` |  769 |  769 |  769 |  769 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  14,245 |  14,245 |  14,245 |  14,245 |
| `main_cells_used     ` |  273,857,940 |  273,857,940 |  273,857,940 |  273,857,940 |
| `total_cycles        ` |  3,267,508 |  3,267,508 |  3,267,508 |  3,267,508 |
| `execute_time_ms     ` |  1,283 |  1,283 |  1,283 |  1,283 |
| `trace_gen_time_ms   ` |  2,580 |  2,580 |  2,580 |  2,580 |
| `stark_prove_excluding_trace_time_ms` |  10,382 |  10,382 |  10,382 |  10,382 |
| `main_trace_commit_time_ms` |  1,777 |  1,777 |  1,777 |  1,777 |
| `generate_perm_trace_time_ms` |  762 |  762 |  762 |  762 |
| `perm_trace_commit_time_ms` |  3,410 |  3,410 |  3,410 |  3,410 |
| `quotient_poly_compute_time_ms` |  1,470 |  1,470 |  1,470 |  1,470 |
| `quotient_poly_commit_time_ms` |  989 |  989 |  989 |  989 |
| `pcs_opening_time_ms ` |  1,969 |  1,969 |  1,969 |  1,969 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 2,580 | 14,245 | 3,267,508 | 1,081,183,722 | 10,382 | 1,470 | 989 | 3,410 | 1,969 | 1,777 | 273,857,940 | 762 | 1,283 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 938 | 4,906 | 1,820,436 | 297,675,351 | 3,320 | 467 | 366 | 840 | 769 | 648 | 95,832,407 | 213 | 648 | 

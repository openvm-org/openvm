...
| `total_proof_time_ms ` |  1,480.50 |  2,961 |  1,718 |  1,243 |
...
| `execute_preflight_time_ms` |  98.50 |  197 |  112 |  85 |
| `execute_preflight_insn_mi/s` |  29.80 | -          |  31.36 |  28.24 |
| `trace_gen_time_ms   ` |  311.50 |  623 |  332 |  291 |
| `memory_finalize_time_ms` |  2 |  4 |  4 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  983 |  1,966 |  1,215 |  751 |
| `main_trace_commit_time_ms` |  142.50 |  285 |  185 |  100 |
| `generate_perm_trace_time_ms` |  60 |  120 |  66 |  54 |
| `perm_trace_commit_time_ms` |  172.39 |  344.77 |  224.74 |  120.03 |
| `quotient_poly_compute_time_ms` |  158.48 |  316.95 |  168.31 |  148.64 |
| `quotient_poly_commit_time_ms` |  35.94 |  71.89 |  47.96 |  23.93 |
| `pcs_opening_time_ms ` |  407 |  814 |  539 |  275 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  2,069 |  4,138 |  2,829 |  1,309 |
...
| `execute_preflight_time_ms` |  579.50 |  1,159 |  895 |  264 |
| `execute_preflight_insn_mi/s` |  7.05 | -          |  7.29 |  6.82 |
| `trace_gen_time_ms   ` |  121.50 |  243 |  168 |  75 |
| `memory_finalize_time_ms` |  12 |  24 |  18 |  6 |
| `stark_prove_excluding_trace_time_ms` |  1,367.50 |  2,735 |  1,766 |  969 |
| `main_trace_commit_time_ms` |  180.50 |  361 |  229 |  132 |
| `generate_perm_trace_time_ms` |  76.50 |  153 |  97 |  56 |
| `perm_trace_commit_time_ms` |  278.73 |  557.46 |  369.66 |  187.80 |
| `quotient_poly_compute_time_ms` |  177.15 |  354.29 |  227.67 |  126.63 |
| `quotient_poly_commit_time_ms` |  43.47 |  86.93 |  56.75 |  30.18 |
| `pcs_opening_time_ms ` |  607 |  1,214 |  781 |  433 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 2,831 |  | 1 |  | 1 |  |  |  |  | 
| regex_program |  | 1,243 |  | 40 | 1 | 41 | 4,108,483 | 98.45 | 168 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 75 | 1,309 | 23,479,090 | 319,626,730 | 75 | 969 | 0 | 126.63 | 30.18 | 4 | 187.80 | 433 | 244 | 433 | 6 | 132 | 9,325,224 | 56 | 264 | 1,496,665 | 7.29 | 29 | 157 | 1 | 433 | 
| leaf | 1 | 168 | 2,829 | 50,586,080 | 538,660,330 | 168 | 1,766 | 0 | 227.67 | 56.75 | 4 | 369.66 | 781 | 468 | 781 | 18 | 229 | 20,272,474 | 97 | 895 | 1,829,999 | 6.82 | 56 | 287 | 1 | 781 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 291 | 1,718 | 23,397,108 | 373,183,036 | 290 | 1,215 | 0 | 148.64 | 47.96 | 6 | 224.74 | 539 | 292 | 539 | 4 | 185 | 10,866,434 | 66 | 85 | 2,211,000 | 28.24 | 46 | 198 | 2 | 539 | 
| regex_program | 1 | 332 | 1,243 | 11,981,356 | 196,739,722 | 332 | 751 | 2 | 168.31 | 23.93 | 6 | 120.03 | 275 | 178 | 275 | 0 | 100 | 2,537,170 | 54 | 112 | 1,897,483 | 31.36 | 25 | 197 | 2 | 275 | 

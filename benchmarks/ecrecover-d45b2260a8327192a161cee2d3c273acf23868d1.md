...
| `stark_prove_excluding_trace_time_ms` |  2,201 |  2,201 |  2,201 |  2,201 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  22,427 |  22,427 |  22,427 |  22,427 |
| `main_cells_used     ` |  203,253,529 |  203,253,529 |  203,253,529 |  203,253,529 |
| `total_cycles        ` |  4,146,302 |  4,146,302 |  4,146,302 |  4,146,302 |
| `execute_time_ms     ` |  938 |  938 |  938 |  938 |
| `trace_gen_time_ms   ` |  3,738 |  3,738 |  3,738 |  3,738 |
| `stark_prove_excluding_trace_time_ms` |  17,751 |  17,751 |  17,751 |  17,751 |
| `main_trace_commit_time_ms` |  3,127 |  3,127 |  3,127 |  3,127 |
| `generate_perm_trace_time_ms` |  410 |  410 |  410 |  410 |
| `perm_trace_commit_time_ms` |  3,670 |  3,670 |  3,670 |  3,670 |
| `quotient_poly_compute_time_ms` |  4,515 |  4,515 |  4,515 |  4,515 |
| `quotient_poly_commit_time_ms` |  2,832 |  2,832 |  2,832 |  2,832 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 3,738 | 22,427 | 4,146,302 | 572,214,232 | 17,751 | 4,515 | 2,832 | 3,670 | 3,195 | 3,127 | 203,253,529 | 410 | 938 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 262 | 2,609 | 284,561 | 56,184,959 | 2,201 | 295 | 300 | 546 | 622 | 396 | 15,054,935 | 40 | 146 | 

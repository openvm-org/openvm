...
| `total_proof_time_ms ` |  2,506 |  2,506 |  2,506 |  2,506 |
...
| `stark_prove_excluding_trace_time_ms` |  2,180 |  2,180 |  2,180 |  2,180 |
| `main_trace_commit_time_ms` |  387 |  387 |  387 |  387 |
| `generate_perm_trace_time_ms` |  35 |  35 |  35 |  35 |
| `perm_trace_commit_time_ms` |  362 |  362 |  362 |  362 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  11,400 |  11,400 |  11,400 |  11,400 |
| `main_cells_used     ` |  117,321,288 |  117,321,288 |  117,321,288 |  117,321,288 |
| `total_cycles        ` |  1,604,052 |  1,604,052 |  1,604,052 |  1,604,052 |
| `execute_time_ms     ` |  579 |  579 |  579 |  579 |
| `trace_gen_time_ms   ` |  1,547 |  1,547 |  1,547 |  1,547 |
| `stark_prove_excluding_trace_time_ms` |  9,274 |  9,274 |  9,274 |  9,274 |
| `main_trace_commit_time_ms` |  1,910 |  1,910 |  1,910 |  1,910 |
| `generate_perm_trace_time_ms` |  262 |  262 |  262 |  262 |
| `perm_trace_commit_time_ms` |  2,046 |  2,046 |  2,046 |  2,046 |
| `quotient_poly_compute_time_ms` |  1,463 |  1,463 |  1,463 |  1,463 |
| `quotient_poly_commit_time_ms` |  1,733 |  1,733 |  1,733 |  1,733 |
| `pcs_opening_time_ms ` |  1,856 |  1,856 |  1,856 |  1,856 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,547 | 11,400 | 1,604,052 | 334,709,720 | 9,274 | 1,463 | 1,733 | 2,046 | 1,856 | 1,910 | 117,321,288 | 262 | 579 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 179 | 2,506 | 284,567 | 38,417,467 | 2,180 | 229 | 488 | 362 | 667 | 387 | 15,055,723 | 35 | 147 | 

...
| `quotient_poly_commit_time_ms` |  171 |  171 |  171 |  171 |
| `pcs_opening_time_ms ` |  418 |  418 |  418 |  418 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  13,131 |  13,131 |  13,131 |  13,131 |
| `main_cells_used     ` |  245,280,636 |  245,280,636 |  245,280,636 |  245,280,636 |
| `total_cycles        ` |  2,991,070 |  2,991,070 |  2,991,070 |  2,991,070 |
| `execute_time_ms     ` |  1,069 |  1,069 |  1,069 |  1,069 |
| `trace_gen_time_ms   ` |  2,348 |  2,348 |  2,348 |  2,348 |
| `stark_prove_excluding_trace_time_ms` |  9,714 |  9,714 |  9,714 |  9,714 |
| `main_trace_commit_time_ms` |  1,754 |  1,754 |  1,754 |  1,754 |
| `generate_perm_trace_time_ms` |  722 |  722 |  722 |  722 |
| `perm_trace_commit_time_ms` |  3,193 |  3,193 |  3,193 |  3,193 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 2,348 | 13,131 | 2,991,070 | 1,008,831,978 | 9,714 | 1,347 | 881 | 3,193 | 1,812 | 1,754 | 245,280,636 | 722 | 1,069 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 185 | 1,485 | 295,490 | 48,240,457 | 1,150 | 125 | 171 | 202 | 418 | 185 | 15,627,255 | 34 | 150 | 

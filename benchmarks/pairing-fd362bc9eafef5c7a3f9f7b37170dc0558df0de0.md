...
| `total_proof_time_ms ` |  3,860 |  3,860 |  3,860 |  3,860 |
...
| `main_trace_commit_time_ms` |  606 |  606 |  606 |  606 |
| `generate_perm_trace_time_ms` |  257 |  257 |  257 |  257 |
| `perm_trace_commit_time_ms` |  585 |  585 |  585 |  585 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  5,385 |  5,385 |  5,385 |  5,385 |
| `main_cells_used     ` |  148,011,279 |  148,011,279 |  148,011,279 |  148,011,279 |
| `total_cells_used    ` |  370,452,245 |  370,452,245 |  370,452,245 |  370,452,245 |
| `execute_preflight_insns` |  2,010,411 |  2,010,411 |  2,010,411 |  2,010,411 |
| `execute_preflight_time_ms` |  476 |  476 |  476 |  476 |
| `execute_preflight_insn_mi/s` |  4.85 | -          |  4.85 |  4.85 |
| `trace_gen_time_ms   ` |  345 |  345 |  345 |  345 |
| `memory_finalize_time_ms` |  11 |  11 |  11 |  11 |
| `stark_prove_excluding_trace_time_ms` |  3,531 |  3,531 |  3,531 |  3,531 |
| `main_trace_commit_time_ms` |  668 |  668 |  668 |  668 |
| `generate_perm_trace_time_ms` |  341 |  341 |  341 |  341 |
| `perm_trace_commit_time_ms` |  824 |  824 |  824 |  824 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 5,387 |  | 1 |  | 1 |  |  |  |  | 
| pairing |  | 3,860 |  | 5 | 1 | 115 | 1,882,939 | 16.27 | 39 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 345 | 5,385 | 370,452,245 | 418,598,378 | 345 | 3,531 | 0 | 427 | 295 | 824 | 970 | 11 | 668 | 148,011,279 | 341 | 476 | 2,010,411 | 4.85 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 388 | 3,860 | 219,937,463 | 304,931,516 | 388 | 3,013 | 0 | 363 | 293 | 585 | 900 | 7 | 6 | 606 | 98,834,293 | 257 | 217 | 1,882,939 | 9.05 | 

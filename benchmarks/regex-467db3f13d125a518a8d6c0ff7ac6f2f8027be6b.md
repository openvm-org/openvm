...
| `total_proof_time_ms ` |  4,029.50 |  8,059 |  4,464 |  3,595 |
...
| `trace_gen_time_ms   ` |  978.50 |  1,957 |  1,149 |  808 |
| `stark_prove_excluding_trace_time_ms` |  2,715 |  5,430 |  2,941 |  2,489 |
| `main_trace_commit_time_ms` |  469 |  938 |  528 |  410 |
| `generate_perm_trace_time_ms` |  192 |  384 |  193 |  191 |
| `perm_trace_commit_time_ms` |  688.50 |  1,377 |  742 |  635 |
| `quotient_poly_compute_time_ms` |  394 |  788 |  425 |  363 |
| `quotient_poly_commit_time_ms` |  278.50 |  557 |  316 |  241 |
| `pcs_opening_time_ms ` |  684.50 |  1,369 |  728 |  641 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,282 |  14,564 |  7,379 |  7,185 |
| `main_cells_used     ` |  152,278,357 |  304,556,714 |  154,678,246 |  149,878,468 |
| `total_cycles        ` |  1,991,041 |  3,982,082 |  2,021,871 |  1,960,211 |
| `execute_time_ms     ` |  774 |  1,548 |  782 |  766 |
| `trace_gen_time_ms   ` |  1,481 |  2,962 |  1,521 |  1,441 |
| `stark_prove_excluding_trace_time_ms` |  5,027 |  10,054 |  5,076 |  4,978 |
| `main_trace_commit_time_ms` |  809 |  1,618 |  810 |  808 |
| `generate_perm_trace_time_ms` |  374 |  748 |  386 |  362 |
| `perm_trace_commit_time_ms` |  1,531.50 |  3,063 |  1,568 |  1,495 |
| `quotient_poly_compute_time_ms` |  769 |  1,538 |  772 |  766 |
| `quotient_poly_commit_time_ms` |  489.50 |  979 |  490 |  489 |
| `pcs_opening_time_ms ` |  1,048.50 |  2,097 |  1,051 |  1,046 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,521 | 7,379 | 2,021,871 | 538,660,330 | 5,076 | 766 | 490 | 1,568 | 1,051 | 810 | 154,678,246 | 386 | 782 | 
| leaf | 1 | 1,441 | 7,185 | 1,960,211 | 538,660,330 | 4,978 | 772 | 489 | 1,495 | 1,046 | 808 | 149,878,468 | 362 | 766 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,149 | 4,464 | 2,243,715 | 275,652,919 | 2,941 | 425 | 316 | 742 | 728 | 528 | 93,500,799 | 193 | 374 | 
| regex_program | 1 | 808 | 3,595 | 1,921,511 | 242,975,404 | 2,489 | 363 | 241 | 635 | 641 | 410 | 73,010,353 | 191 | 298 | 

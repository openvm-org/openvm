...
| `perm_trace_commit_time_ms` |  34.25 |  34.25 |  34.25 |  34.25 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  2,831 |  2,831 |  2,831 |  2,831 |
| `main_cells_used     ` |  29,404,728 |  29,404,728 |  29,404,728 |  29,404,728 |
| `total_cells_used    ` |  71,174,330 |  71,174,330 |  71,174,330 |  71,174,330 |
| `execute_preflight_insns` |  2,934,937 |  2,934,937 |  2,934,937 |  2,934,937 |
| `execute_preflight_time_ms` |  421 |  421 |  421 |  421 |
| `execute_preflight_insn_mi/s` |  7.46 | -          |  7.46 |  7.46 |
| `trace_gen_time_ms   ` |  241 |  241 |  241 |  241 |
| `memory_finalize_time_ms` |  23 |  23 |  23 |  23 |
| `stark_prove_excluding_trace_time_ms` |  2,168 |  2,168 |  2,168 |  2,168 |
| `main_trace_commit_time_ms` |  378 |  378 |  378 |  378 |
| `generate_perm_trace_time_ms` |  205 |  205 |  205 |  205 |
| `perm_trace_commit_time_ms` |  703.48 |  703.48 |  703.48 |  703.48 |
| `quotient_poly_compute_time_ms` |  463.87 |  463.87 |  463.87 |  463.87 |
| `quotient_poly_commit_time_ms` |  106.81 |  106.81 |  106.81 |  106.81 |
| `pcs_opening_time_ms ` |  301 |  301 |  301 |  301 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program |  | 749 |  | 1 | 6 | 122,859 | 19.50 | 0 | 
| leaf | 2,834 |  | 1 | 1 |  |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 241 | 2,831 | 71,174,330 | 992,054,762 | 241 | 2,168 | 0 | 463.87 | 106.81 | 4 | 703.48 | 301 | 910 | 301 | 23 | 378 | 29,404,728 | 205 | 421 | 2,934,937 | 7.46 | 135 | 577 | 9 | 301 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 220 | 749 | 11,345,240 | 31,789,298 | 220 | 302 | 0 | 105.09 | 9.16 | 8 | 34.25 | 61 | 87 | 61 | 0 | 37 | 2,263,998 | 47 | 58 | 122,859 | 2.26 | 22 | 114 | 2 | 61 | 

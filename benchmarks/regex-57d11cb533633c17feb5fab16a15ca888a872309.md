...
| `total_proof_time_ms ` |  7,413.50 |  14,827 |  8,289 |  6,538 |
| `main_cells_used     ` |  82,727,686.50 |  165,455,373 |  92,686,348 |  72,769,025 |
| `total_cycles        ` |  1,914,103 |  1,914,103 |  1,914,103 |  1,914,103 |
| `execute_time_ms     ` |  462.50 |  925 |  496 |  429 |
| `trace_gen_time_ms   ` |  1,422 |  2,844 |  1,581 |  1,263 |
| `stark_prove_excluding_trace_time_ms` |  5,529 |  11,058 |  6,212 |  4,846 |
| `main_trace_commit_time_ms` |  1,102 |  2,204 |  1,321 |  883 |
| `generate_perm_trace_time_ms` |  192.50 |  385 |  221 |  164 |
| `perm_trace_commit_time_ms` |  1,194 |  2,388 |  1,239 |  1,149 |
| `quotient_poly_compute_time_ms` |  744.50 |  1,489 |  866 |  623 |
| `quotient_poly_commit_time_ms` |  985 |  1,970 |  1,135 |  835 |
| `pcs_opening_time_ms ` |  1,298.50 |  2,597 |  1,422 |  1,175 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  13,264 |  26,528 |  13,409 |  13,119 |
| `main_cells_used     ` |  110,612,815.50 |  221,225,631 |  112,211,495 |  109,014,136 |
| `total_cycles        ` |  2,256,287.50 |  4,512,575 |  2,292,498 |  2,220,077 |
| `execute_time_ms     ` |  629.50 |  1,259 |  677 |  582 |
| `trace_gen_time_ms   ` |  1,895.50 |  3,791 |  2,082 |  1,709 |
| `stark_prove_excluding_trace_time_ms` |  10,739 |  21,478 |  10,745 |  10,733 |
| `main_trace_commit_time_ms` |  2,221.50 |  4,443 |  2,235 |  2,208 |
| `generate_perm_trace_time_ms` |  261.50 |  523 |  265 |  258 |
| `perm_trace_commit_time_ms` |  2,117.50 |  4,235 |  2,134 |  2,101 |
| `quotient_poly_compute_time_ms` |  1,535.50 |  3,071 |  1,554 |  1,517 |
| `quotient_poly_commit_time_ms` |  2,118 |  4,236 |  2,133 |  2,103 |
| `pcs_opening_time_ms ` |  2,480.50 |  4,961 |  2,493 |  2,468 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,709 | 13,119 | 2,292,498 | 328,738,520 | 10,733 | 1,554 | 2,133 | 2,101 | 2,468 | 2,208 | 112,211,495 | 265 | 677 | 
| leaf | 1 | 2,082 | 13,409 | 2,220,077 | 328,745,944 | 10,745 | 1,517 | 2,103 | 2,134 | 2,493 | 2,235 | 109,014,136 | 258 | 582 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,581 | 8,289 |  | 209,921,543 | 6,212 | 866 | 1,135 | 1,239 | 1,422 | 1,321 | 92,686,348 | 221 | 496 | 
| regex_program | 1 | 1,263 | 6,538 | 1,914,103 | 149,454,692 | 4,846 | 623 | 835 | 1,149 | 1,175 | 883 | 72,769,025 | 164 | 429 | 

...
| `stark_prove_excluding_trace_time_ms` |  2,193 |  2,193 |  2,193 |  2,193 |
...
| `quotient_poly_compute_time_ms` |  289 |  289 |  289 |  289 |
| `quotient_poly_commit_time_ms` |  306 |  306 |  306 |  306 |
| `pcs_opening_time_ms ` |  628 |  628 |  628 |  628 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  41,412 |  41,412 |  41,412 |  41,412 |
| `main_cells_used     ` |  365,885,227 |  365,885,227 |  365,885,227 |  365,885,227 |
| `total_cycles        ` |  8,652,418 |  8,652,418 |  8,652,418 |  8,652,418 |
| `execute_time_ms     ` |  2,400 |  2,400 |  2,400 |  2,400 |
| `trace_gen_time_ms   ` |  6,550 |  6,550 |  6,550 |  6,550 |
| `stark_prove_excluding_trace_time_ms` |  32,462 |  32,462 |  32,462 |  32,462 |
| `main_trace_commit_time_ms` |  5,829 |  5,829 |  5,829 |  5,829 |
| `generate_perm_trace_time_ms` |  717 |  717 |  717 |  717 |
| `perm_trace_commit_time_ms` |  7,176 |  7,176 |  7,176 |  7,176 |
| `quotient_poly_compute_time_ms` |  7,490 |  7,490 |  7,490 |  7,490 |
| `quotient_poly_commit_time_ms` |  5,094 |  5,094 |  5,094 |  5,094 |
| `pcs_opening_time_ms ` |  6,153 |  6,153 |  6,153 |  6,153 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 6,550 | 41,412 | 8,652,418 | 1,052,183,000 | 32,462 | 7,490 | 5,094 | 7,176 | 6,153 | 5,829 | 365,885,227 | 717 | 2,400 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 263 | 2,609 | 285,401 | 56,172,159 | 2,193 | 289 | 306 | 533 | 628 | 398 | 15,092,297 | 36 | 153 | 

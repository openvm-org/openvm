...
| `main_cells_used     ` |  244,743,075 |  244,743,075 |  244,743,075 |  244,743,075 |
| `total_cycles        ` |  2,990,628 |  2,990,628 |  2,990,628 |  2,990,628 |
| `execute_time_ms     ` |  1,078 |  1,078 |  1,078 |  1,078 |
| `trace_gen_time_ms   ` |  2,354 |  2,354 |  2,354 |  2,354 |
| `stark_prove_excluding_trace_time_ms` |  9,648 |  9,648 |  9,648 |  9,648 |
| `main_trace_commit_time_ms` |  1,724 |  1,724 |  1,724 |  1,724 |
| `generate_perm_trace_time_ms` |  693 |  693 |  693 |  693 |
| `perm_trace_commit_time_ms` |  3,221 |  3,221 |  3,221 |  3,221 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 2,354 | 13,080 | 2,990,628 | 999,394,794 | 9,648 | 1,336 | 878 | 3,221 | 1,791 | 1,724 | 244,743,075 | 693 | 1,078 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 183 | 1,423 | 295,303 | 48,240,457 | 1,091 | 124 | 155 | 188 | 401 | 173 | 15,598,665 | 33 | 149 | 

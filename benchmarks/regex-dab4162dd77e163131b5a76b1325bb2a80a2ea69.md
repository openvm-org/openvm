...
| `total_proof_time_ms ` |  3,847.50 |  7,695 |  4,422 |  3,273 |
| `main_cells_used     ` |  83,694,725 |  167,389,450 |  93,699,990 |  73,689,460 |
| `total_cycles        ` |  2,070,082 |  4,140,164 |  2,225,434 |  1,914,730 |
| `execute_time_ms     ` |  335 |  670 |  371 |  299 |
| `trace_gen_time_ms   ` |  949 |  1,898 |  1,121 |  777 |
| `stark_prove_excluding_trace_time_ms` |  2,563.50 |  5,127 |  2,930 |  2,197 |
| `main_trace_commit_time_ms` |  446 |  892 |  524 |  368 |
| `generate_perm_trace_time_ms` |  160.50 |  321 |  180 |  141 |
| `perm_trace_commit_time_ms` |  641 |  1,282 |  750 |  532 |
| `quotient_poly_compute_time_ms` |  362.50 |  725 |  422 |  303 |
| `quotient_poly_commit_time_ms` |  278.50 |  557 |  328 |  229 |
| `pcs_opening_time_ms ` |  663 |  1,326 |  716 |  610 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,338.50 |  14,677 |  7,455 |  7,222 |
| `main_cells_used     ` |  152,448,436.50 |  304,896,873 |  154,909,485 |  149,987,388 |
| `total_cycles        ` |  1,994,079.50 |  3,988,159 |  2,024,944 |  1,963,215 |
| `execute_time_ms     ` |  783.50 |  1,567 |  792 |  775 |
| `trace_gen_time_ms   ` |  1,463.50 |  2,927 |  1,504 |  1,423 |
| `stark_prove_excluding_trace_time_ms` |  5,091.50 |  10,183 |  5,159 |  5,024 |
| `main_trace_commit_time_ms` |  835.50 |  1,671 |  837 |  834 |
| `generate_perm_trace_time_ms` |  350.50 |  701 |  364 |  337 |
| `perm_trace_commit_time_ms` |  1,572 |  3,144 |  1,609 |  1,535 |
| `quotient_poly_compute_time_ms` |  765 |  1,530 |  766 |  764 |
| `quotient_poly_commit_time_ms` |  501 |  1,002 |  501 |  501 |
| `pcs_opening_time_ms ` |  1,061.50 |  2,123 |  1,078 |  1,045 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,504 | 7,455 | 2,024,944 | 534,072,810 | 5,159 | 764 | 501 | 1,609 | 1,078 | 837 | 154,909,485 | 364 | 792 | 
| leaf | 1 | 1,423 | 7,222 | 1,963,215 | 534,072,810 | 5,024 | 766 | 501 | 1,535 | 1,045 | 834 | 149,987,388 | 337 | 775 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,121 | 4,422 | 2,225,434 | 275,652,919 | 2,930 | 422 | 328 | 750 | 716 | 524 | 93,699,990 | 180 | 371 | 
| regex_program | 1 | 777 | 3,273 | 1,914,730 | 198,099,628 | 2,197 | 303 | 229 | 532 | 610 | 368 | 73,689,460 | 141 | 299 | 

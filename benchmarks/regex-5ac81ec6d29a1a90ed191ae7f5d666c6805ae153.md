...
| `total_proof_time_ms ` |  4,006.50 |  8,013 |  4,618 |  3,395 |
| `main_cells_used     ` |  83,694,725 |  167,389,450 |  93,699,990 |  73,689,460 |
| `total_cycles        ` |  2,070,082 |  4,140,164 |  2,225,434 |  1,914,730 |
| `execute_time_ms     ` |  339 |  678 |  375 |  303 |
| `trace_gen_time_ms   ` |  984 |  1,968 |  1,179 |  789 |
| `stark_prove_excluding_trace_time_ms` |  2,683.50 |  5,367 |  3,064 |  2,303 |
| `main_trace_commit_time_ms` |  491 |  982 |  574 |  408 |
| `generate_perm_trace_time_ms` |  171 |  342 |  203 |  139 |
| `perm_trace_commit_time_ms` |  700 |  1,400 |  804 |  596 |
| `quotient_poly_compute_time_ms` |  361.50 |  723 |  417 |  306 |
| `quotient_poly_commit_time_ms` |  288 |  576 |  333 |  243 |
| `pcs_opening_time_ms ` |  661 |  1,322 |  724 |  598 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,458.50 |  14,917 |  7,490 |  7,427 |
| `main_cells_used     ` |  152,230,945 |  304,461,890 |  154,688,899 |  149,772,991 |
| `total_cycles        ` |  1,990,701 |  3,981,402 |  2,021,530 |  1,959,872 |
| `execute_time_ms     ` |  763.50 |  1,527 |  771 |  756 |
| `trace_gen_time_ms   ` |  1,471.50 |  2,943 |  1,476 |  1,467 |
| `stark_prove_excluding_trace_time_ms` |  5,223.50 |  10,447 |  5,243 |  5,204 |
| `main_trace_commit_time_ms` |  893 |  1,786 |  894 |  892 |
| `generate_perm_trace_time_ms` |  342 |  684 |  344 |  340 |
| `perm_trace_commit_time_ms` |  1,644.50 |  3,289 |  1,667 |  1,622 |
| `quotient_poly_compute_time_ms` |  764.50 |  1,529 |  767 |  762 |
| `quotient_poly_commit_time_ms` |  519.50 |  1,039 |  520 |  519 |
| `pcs_opening_time_ms ` |  1,054.50 |  2,109 |  1,057 |  1,052 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,476 | 7,490 | 2,021,530 | 533,941,738 | 5,243 | 762 | 520 | 1,667 | 1,052 | 892 | 154,688,899 | 344 | 771 | 
| leaf | 1 | 1,467 | 7,427 | 1,959,872 | 533,941,738 | 5,204 | 767 | 519 | 1,622 | 1,057 | 894 | 149,772,991 | 340 | 756 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,179 | 4,618 | 2,225,434 | 275,652,919 | 3,064 | 417 | 333 | 804 | 724 | 574 | 93,699,990 | 203 | 375 | 
| regex_program | 1 | 789 | 3,395 | 1,914,730 | 198,099,628 | 2,303 | 306 | 243 | 596 | 598 | 408 | 73,689,460 | 139 | 303 | 

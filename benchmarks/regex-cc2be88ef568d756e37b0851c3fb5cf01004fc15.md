...
| `total_proof_time_ms ` |  4,161.50 |  8,323 |  4,579 |  3,744 |
...
| `trace_gen_time_ms   ` |  956 |  1,912 |  1,110 |  802 |
| `stark_prove_excluding_trace_time_ms` |  2,866 |  5,732 |  3,091 |  2,641 |
| `main_trace_commit_time_ms` |  518 |  1,036 |  580 |  456 |
| `generate_perm_trace_time_ms` |  191.50 |  383 |  203 |  180 |
| `perm_trace_commit_time_ms` |  751 |  1,502 |  808 |  694 |
| `quotient_poly_compute_time_ms` |  396.50 |  793 |  428 |  365 |
| `quotient_poly_commit_time_ms` |  295.50 |  591 |  333 |  258 |
| `pcs_opening_time_ms ` |  705 |  1,410 |  731 |  679 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,554 |  15,108 |  7,625 |  7,483 |
| `main_cells_used     ` |  152,278,447 |  304,556,894 |  154,677,574 |  149,879,320 |
| `total_cycles        ` |  1,991,048.50 |  3,982,097 |  2,021,815 |  1,960,282 |
| `execute_time_ms     ` |  761 |  1,522 |  770 |  752 |
| `trace_gen_time_ms   ` |  1,464 |  2,928 |  1,494 |  1,434 |
| `stark_prove_excluding_trace_time_ms` |  5,329 |  10,658 |  5,361 |  5,297 |
| `main_trace_commit_time_ms` |  895.50 |  1,791 |  900 |  891 |
| `generate_perm_trace_time_ms` |  360 |  720 |  361 |  359 |
| `perm_trace_commit_time_ms` |  1,699 |  3,398 |  1,717 |  1,681 |
| `quotient_poly_compute_time_ms` |  772.50 |  1,545 |  774 |  771 |
| `quotient_poly_commit_time_ms` |  524.50 |  1,049 |  526 |  523 |
| `pcs_opening_time_ms ` |  1,072.50 |  2,145 |  1,083 |  1,062 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,494 | 7,625 | 2,021,815 | 538,660,330 | 5,361 | 771 | 523 | 1,717 | 1,083 | 900 | 154,677,574 | 361 | 770 | 
| leaf | 1 | 1,434 | 7,483 | 1,960,282 | 538,660,330 | 5,297 | 774 | 526 | 1,681 | 1,062 | 891 | 149,879,320 | 359 | 752 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,110 | 4,579 | 2,243,715 | 275,652,919 | 3,091 | 428 | 333 | 808 | 731 | 580 | 94,156,159 | 203 | 378 | 
| regex_program | 1 | 802 | 3,744 | 1,921,511 | 242,975,404 | 2,641 | 365 | 258 | 694 | 679 | 456 | 73,665,713 | 180 | 301 | 

...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  18,300 |  18,300 |  18,300 |  18,300 |
| `main_cells_used     ` |  193,317,157 |  193,317,157 |  193,317,157 |  193,317,157 |
| `total_cycles        ` |  4,158,107 |  4,158,107 |  4,158,107 |  4,158,107 |
| `execute_time_ms     ` |  917 |  917 |  917 |  917 |
| `trace_gen_time_ms   ` |  3,493 |  3,493 |  3,493 |  3,493 |
| `stark_prove_excluding_trace_time_ms` |  13,890 |  13,890 |  13,890 |  13,890 |
| `main_trace_commit_time_ms` |  2,919 |  2,919 |  2,919 |  2,919 |
| `generate_perm_trace_time_ms` |  360 |  360 |  360 |  360 |
| `perm_trace_commit_time_ms` |  2,948 |  2,948 |  2,948 |  2,948 |
| `quotient_poly_compute_time_ms` |  2,077 |  2,077 |  2,077 |  2,077 |
| `quotient_poly_commit_time_ms` |  2,598 |  2,598 |  2,598 |  2,598 |
| `pcs_opening_time_ms ` |  2,984 |  2,984 |  2,984 |  2,984 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 3,493 | 18,300 | 4,158,107 | 466,306,008 | 13,890 | 2,077 | 2,598 | 2,948 | 2,984 | 2,919 | 193,317,157 | 360 | 917 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 246 | 2,536 | 284,567 | 38,417,467 | 2,140 | 225 | 471 | 359 | 655 | 385 | 15,055,723 | 32 | 150 | 

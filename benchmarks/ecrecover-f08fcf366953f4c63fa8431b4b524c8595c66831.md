...
| `stark_prove_excluding_trace_time_ms` |  2,120 |  2,120 |  2,120 |  2,120 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  19,494 |  19,494 |  19,494 |  19,494 |
| `main_cells_used     ` |  203,551,317 |  203,551,317 |  203,551,317 |  203,551,317 |
| `total_cycles        ` |  4,164,912 |  4,164,912 |  4,164,912 |  4,164,912 |
| `execute_time_ms     ` |  1,029 |  1,029 |  1,029 |  1,029 |
| `trace_gen_time_ms   ` |  3,692 |  3,692 |  3,692 |  3,692 |
| `stark_prove_excluding_trace_time_ms` |  14,773 |  14,773 |  14,773 |  14,773 |
| `main_trace_commit_time_ms` |  2,948 |  2,948 |  2,948 |  2,948 |
| `generate_perm_trace_time_ms` |  419 |  419 |  419 |  419 |
| `perm_trace_commit_time_ms` |  3,587 |  3,587 |  3,587 |  3,587 |
| `quotient_poly_compute_time_ms` |  2,110 |  2,110 |  2,110 |  2,110 |
| `quotient_poly_commit_time_ms` |  2,588 |  2,588 |  2,588 |  2,588 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 3,692 | 19,494 | 4,164,912 | 572,214,232 | 14,773 | 2,110 | 2,588 | 3,587 | 3,116 | 2,948 | 203,551,317 | 419 | 1,029 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 269 | 2,539 | 285,401 | 56,172,159 | 2,120 | 165 | 321 | 551 | 627 | 400 | 15,075,033 | 44 | 150 | 

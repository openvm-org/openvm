...
| `total_proof_time_ms ` |  4,210.50 |  8,421 |  4,679 |  3,742 |
...
| `trace_gen_time_ms   ` |  971.50 |  1,943 |  1,131 |  812 |
| `stark_prove_excluding_trace_time_ms` |  2,902 |  5,804 |  3,174 |  2,630 |
| `main_trace_commit_time_ms` |  521.50 |  1,043 |  586 |  457 |
| `generate_perm_trace_time_ms` |  183 |  366 |  194 |  172 |
| `perm_trace_commit_time_ms` |  757 |  1,514 |  813 |  701 |
| `quotient_poly_compute_time_ms` |  395.50 |  791 |  427 |  364 |
| `quotient_poly_commit_time_ms` |  302 |  604 |  341 |  263 |
| `pcs_opening_time_ms ` |  733 |  1,466 |  803 |  663 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,538.50 |  15,077 |  7,614 |  7,463 |
| `main_cells_used     ` |  152,277,829 |  304,555,658 |  154,677,502 |  149,878,156 |
| `total_cycles        ` |  1,990,997 |  3,981,994 |  2,021,809 |  1,960,185 |
| `execute_time_ms     ` |  752 |  1,504 |  763 |  741 |
| `trace_gen_time_ms   ` |  1,466 |  2,932 |  1,514 |  1,418 |
| `stark_prove_excluding_trace_time_ms` |  5,320.50 |  10,641 |  5,337 |  5,304 |
| `main_trace_commit_time_ms` |  894 |  1,788 |  896 |  892 |
| `generate_perm_trace_time_ms` |  367.50 |  735 |  373 |  362 |
| `perm_trace_commit_time_ms` |  1,678 |  3,356 |  1,695 |  1,661 |
| `quotient_poly_compute_time_ms` |  767.50 |  1,535 |  771 |  764 |
| `quotient_poly_commit_time_ms` |  528 |  1,056 |  530 |  526 |
| `pcs_opening_time_ms ` |  1,080 |  2,160 |  1,081 |  1,079 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,514 | 7,614 | 2,021,809 | 538,660,330 | 5,337 | 764 | 526 | 1,695 | 1,079 | 896 | 154,677,502 | 373 | 763 | 
| leaf | 1 | 1,418 | 7,463 | 1,960,185 | 538,660,330 | 5,304 | 771 | 530 | 1,661 | 1,081 | 892 | 149,878,156 | 362 | 741 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,131 | 4,679 | 2,243,715 | 275,652,919 | 3,174 | 427 | 341 | 813 | 803 | 586 | 94,156,159 | 194 | 374 | 
| regex_program | 1 | 812 | 3,742 | 1,921,511 | 242,975,404 | 2,630 | 364 | 263 | 701 | 663 | 457 | 73,665,713 | 172 | 300 | 

...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  22,764 |  22,764 |  22,764 |  22,764 |
| `main_cells_used     ` |  203,264,121 |  203,264,121 |  203,264,121 |  203,264,121 |
| `total_cycles        ` |  4,146,486 |  4,146,486 |  4,146,486 |  4,146,486 |
| `execute_time_ms     ` |  969 |  969 |  969 |  969 |
| `trace_gen_time_ms   ` |  3,711 |  3,711 |  3,711 |  3,711 |
| `stark_prove_excluding_trace_time_ms` |  18,084 |  18,084 |  18,084 |  18,084 |
| `main_trace_commit_time_ms` |  3,123 |  3,123 |  3,123 |  3,123 |
| `generate_perm_trace_time_ms` |  409 |  409 |  409 |  409 |
| `perm_trace_commit_time_ms` |  3,712 |  3,712 |  3,712 |  3,712 |
| `quotient_poly_compute_time_ms` |  4,753 |  4,753 |  4,753 |  4,753 |
| `quotient_poly_commit_time_ms` |  2,896 |  2,896 |  2,896 |  2,896 |
| `pcs_opening_time_ms ` |  3,188 |  3,188 |  3,188 |  3,188 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 3,711 | 22,764 | 4,146,486 | 572,214,232 | 18,084 | 4,753 | 2,896 | 3,712 | 3,188 | 3,123 | 203,264,121 | 409 | 969 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 262 | 2,608 | 284,561 | 56,184,959 | 2,194 | 299 | 308 | 530 | 622 | 394 | 15,054,935 | 37 | 152 | 

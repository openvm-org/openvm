...
| `total_proof_time_ms ` |  4,147.50 |  8,295 |  4,579 |  3,716 |
...
| `trace_gen_time_ms   ` |  954.50 |  1,909 |  1,152 |  757 |
| `stark_prove_excluding_trace_time_ms` |  2,855.50 |  5,711 |  3,052 |  2,659 |
| `main_trace_commit_time_ms` |  517.50 |  1,035 |  580 |  455 |
| `generate_perm_trace_time_ms` |  187 |  374 |  188 |  186 |
| `perm_trace_commit_time_ms` |  745.50 |  1,491 |  799 |  692 |
| `quotient_poly_compute_time_ms` |  396.50 |  793 |  427 |  366 |
| `quotient_poly_commit_time_ms` |  293 |  586 |  330 |  256 |
| `pcs_opening_time_ms ` |  707 |  1,414 |  719 |  695 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,506.50 |  15,013 |  7,576 |  7,437 |
| `main_cells_used     ` |  152,278,249 |  304,556,498 |  154,677,730 |  149,878,768 |
| `total_cycles        ` |  1,991,032 |  3,982,064 |  2,021,828 |  1,960,236 |
| `execute_time_ms     ` |  751 |  1,502 |  759 |  743 |
| `trace_gen_time_ms   ` |  1,464.50 |  2,929 |  1,467 |  1,462 |
| `stark_prove_excluding_trace_time_ms` |  5,291 |  10,582 |  5,355 |  5,227 |
| `main_trace_commit_time_ms` |  895 |  1,790 |  899 |  891 |
| `generate_perm_trace_time_ms` |  374 |  748 |  389 |  359 |
| `perm_trace_commit_time_ms` |  1,670.50 |  3,341 |  1,706 |  1,635 |
| `quotient_poly_compute_time_ms` |  767 |  1,534 |  770 |  764 |
| `quotient_poly_commit_time_ms` |  520 |  1,040 |  521 |  519 |
| `pcs_opening_time_ms ` |  1,058 |  2,116 |  1,063 |  1,053 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,462 | 7,576 | 2,021,828 | 538,660,330 | 5,355 | 770 | 521 | 1,706 | 1,063 | 899 | 154,677,730 | 389 | 759 | 
| leaf | 1 | 1,467 | 7,437 | 1,960,236 | 538,660,330 | 5,227 | 764 | 519 | 1,635 | 1,053 | 891 | 149,878,768 | 359 | 743 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,152 | 4,579 | 2,243,715 | 275,652,919 | 3,052 | 427 | 330 | 799 | 719 | 580 | 94,156,159 | 188 | 375 | 
| regex_program | 1 | 757 | 3,716 | 1,921,511 | 242,975,404 | 2,659 | 366 | 256 | 692 | 695 | 455 | 73,665,713 | 186 | 300 | 
...
Commit: https://github.com/openvm-org/openvm/commit/9201a2970337fb6036905d3ef1d450eb283b7604
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/14115451863)

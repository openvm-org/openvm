...
| `total_proof_time_ms ` |  5,272 |  5,272 |  5,272 |  5,272 |
...
| `main_cells_used     ` |  72,167,263 |  72,167,263 |  72,167,263 |  72,167,263 |
| `total_cycles        ` |  1,925,100 |  1,925,100 |  1,925,100 |  1,925,100 |
| `execute_time_ms     ` |  293 |  293 |  293 |  293 |
| `trace_gen_time_ms   ` |  1,387 |  1,387 |  1,387 |  1,387 |
| `stark_prove_excluding_trace_time_ms` |  5,402 |  5,402 |  5,402 |  5,402 |
| `main_trace_commit_time_ms` |  1,097 |  1,097 |  1,097 |  1,097 |
| `generate_perm_trace_time_ms` |  127 |  127 |  127 |  127 |
| `perm_trace_commit_time_ms` |  1,001 |  1,001 |  1,001 |  1,001 |
| `quotient_poly_compute_time_ms` |  766 |  766 |  766 |  766 |
| `quotient_poly_commit_time_ms` |  1,092 |  1,092 |  1,092 |  1,092 |
| `pcs_opening_time_ms ` |  1,315 |  1,315 |  1,315 |  1,315 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,387 | 7,082 | 1,925,100 | 160,482,264 | 5,402 | 766 | 1,092 | 1,001 | 1,315 | 1,097 | 72,167,263 | 127 | 293 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 809 | 5,272 | 1,500,095 | 122,458,476 | 4,153 | 511 | 765 | 795 | 1,085 | 863 | 51,485,080 | 131 | 310 | 

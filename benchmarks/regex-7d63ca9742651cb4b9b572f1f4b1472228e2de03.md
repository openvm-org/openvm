...
| `total_proof_time_ms ` |  3,943.50 |  7,887 |  4,377 |  3,510 |
...
| `trace_gen_time_ms   ` |  980 |  1,960 |  1,169 |  791 |
| `stark_prove_excluding_trace_time_ms` |  2,608.50 |  5,217 |  2,813 |  2,404 |
| `main_trace_commit_time_ms` |  498.50 |  997 |  555 |  442 |
| `generate_perm_trace_time_ms` |  211 |  422 |  221 |  201 |
| `perm_trace_commit_time_ms` |  560.50 |  1,121 |  604 |  517 |
| `quotient_poly_compute_time_ms` |  263.50 |  527 |  286 |  241 |
| `quotient_poly_commit_time_ms` |  247.50 |  495 |  281 |  214 |
| `pcs_opening_time_ms ` |  817.50 |  1,635 |  855 |  780 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,019.50 |  14,039 |  7,108 |  6,931 |
| `main_cells_used     ` |  151,828,049 |  303,656,098 |  154,227,746 |  149,428,352 |
| `total_cycles        ` |  1,975,744 |  3,951,488 |  2,006,558 |  1,944,930 |
| `execute_time_ms     ` |  793.50 |  1,587 |  801 |  786 |
| `trace_gen_time_ms   ` |  1,485 |  2,970 |  1,535 |  1,435 |
| `stark_prove_excluding_trace_time_ms` |  4,741 |  9,482 |  4,772 |  4,710 |
| `main_trace_commit_time_ms` |  866.50 |  1,733 |  867 |  866 |
| `generate_perm_trace_time_ms` |  404 |  808 |  425 |  383 |
| `perm_trace_commit_time_ms` |  1,243.50 |  2,487 |  1,246 |  1,241 |
| `quotient_poly_compute_time_ms` |  520.50 |  1,041 |  528 |  513 |
| `quotient_poly_commit_time_ms` |  410 |  820 |  411 |  409 |
| `pcs_opening_time_ms ` |  1,291 |  2,582 |  1,292 |  1,290 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,535 | 7,108 | 2,006,558 | 538,660,330 | 4,772 | 528 | 409 | 1,246 | 1,290 | 867 | 154,227,746 | 425 | 801 | 
| leaf | 1 | 1,435 | 6,931 | 1,944,930 | 538,660,330 | 4,710 | 513 | 411 | 1,241 | 1,292 | 866 | 149,428,352 | 383 | 786 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,169 | 4,377 | 2,243,715 | 275,652,919 | 2,813 | 286 | 281 | 604 | 855 | 555 | 93,500,799 | 221 | 395 | 
| regex_program | 1 | 791 | 3,510 | 1,921,511 | 242,975,404 | 2,404 | 241 | 214 | 517 | 780 | 442 | 73,010,353 | 201 | 315 | 

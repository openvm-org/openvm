...
|:---|---:|---:|---:|
| Total |  4.40 |  2.29 |  2.29 |
| app_proof |  3.07 |  0.97 |  0.97 |
| leaf |  0.66 |  0.66 |  0.66 |
...
| `total_proof_time_ms ` |  750.50 |  3,002 |  898 |  545 |
| `execute_metered_time_ms` |  67 | -          | -          | -          |
| `execute_metered_insns` |  12,000,265 | -          | -          | -          |
| `execute_metered_insn_mi/s` |  177.54 | -          |  177.54 |  177.54 |
| `execute_preflight_insns` |  3,000,066.25 |  12,000,265 |  3,495,000 |  1,515,265 |
| `execute_preflight_time_ms` |  83 |  332 |  102 |  43 |
| `execute_preflight_insn_mi/s` |  48.92 | -          |  49.95 |  46.05 |
| `trace_gen_time_ms   ` |  135.75 |  543 |  169 |  118 |
| `memory_finalize_time_ms` | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  461.75 |  1,847 |  521 |  291 |
| `prover.main_trace_commit_time_ms` |  97 |  388 |  110 |  58 |
| `prover.rap_constraints_time_ms` |  265.25 |  1,061 |  300 |  165 |
| `prover.openings_time_ms` |  98.25 |  393 |  110 |  67 |
| `prover.rap_constraints.logup_gkr_time_ms` |  191.25 |  765 |  217 |  115 |
| `prover.rap_constraints.round0_time_ms` |  48.75 |  195 |  56 |  31 |
| `prover.rap_constraints.mle_rounds_time_ms` |  23.75 |  95 |  26 |  17 |
| `prover.openings.stacked_reduction_time_ms` |  18 |  72 |  20 |  12 |
...
| `prover.openings.whir_time_ms` |  80 |  320 |  90 |  55 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/eb7c65e0f427926bde524c65435f9395156de676/fibonacci-eb7c65e0f427926bde524c65435f9395156de676.memory.svg)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 71 |  |  |  | 342 |  |  |  |  |  |  | 
| app_proof |  |  |  | 545 |  | 67 | 12,000,265 | 177.54 | 0 | 3,077 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 38,610,749 | 323 | 115 | 0 | 0 | 106 | 35 | 34 | 50 | 19 | 0 | 101 | 87 | 13 | 3 | 9 | 116 | 115 | 106 | 0 | 3 | 19 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 15,378,769 | 166 | 47 | 0 | 0 | 67 | 25 | 24 | 27 | 14 | 0 | 51 | 42 | 8 | 1 | 6 | 47 | 47 | 67 | 0 | 2 | 12 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,865 | 141 | 31 | 0 | 0 | 61 | 23 | 22 | 24 | 13 | 0 | 48 | 40 | 7 | 1 | 5 | 31 | 31 | 61 | 0 | 2 | 12 | 0 | 0 | 
| leaf | 0 | prover | 147,934,254 | 594 | 227 | 0 | 0 | 179 | 82 | 81 | 52 | 45 | 0 | 187 | 163 | 23 | 11 | 11 | 227 | 227 | 179 | 0 | 8 | 43 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 136,618,310 | 521 | 110 | 0 | 0 | 300 | 56 | 56 | 26 | 216 | 0 | 110 | 90 | 20 | 11 | 9 | 110 | 110 | 300 | 0 | 3 | 215 | 0 | 0 | 
| app_proof | prover | 1 | 136,570,844 | 516 | 110 | 0 | 0 | 297 | 54 | 53 | 26 | 217 | 0 | 107 | 87 | 20 | 11 | 8 | 110 | 110 | 297 | 0 | 3 | 216 | 0 | 0 | 
| app_proof | prover | 2 | 136,570,844 | 519 | 110 | 0 | 0 | 299 | 54 | 54 | 26 | 217 | 0 | 109 | 88 | 20 | 11 | 8 | 110 | 110 | 299 | 0 | 3 | 216 | 0 | 0 | 
| app_proof | prover | 3 | 70,295,260 | 291 | 58 | 0 | 0 | 165 | 31 | 31 | 17 | 115 | 0 | 67 | 55 | 12 | 6 | 6 | 58 | 58 | 165 | 0 | 3 | 115 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 154 | 132 | 898 | 132 | 154 | 2,770,199,817 | 323,294,035 | 3,093,493,852 | 2,097,152 | 0 | 3 | 89 | 3,495,000 | 46.05 | 
| app_proof | 1 | 41 | 118 | 777 | 118 | 41 | 2,768,863,045 | 322,353,750 | 3,091,216,795 | 2,097,152 | 0 | 1 | 102 | 3,495,000 | 49.92 | 
| app_proof | 2 | 41 | 124 | 782 | 124 | 41 | 2,768,863,045 | 322,353,750 | 3,091,216,795 | 2,097,152 | 0 | 1 | 98 | 3,495,000 | 49.95 | 
| app_proof | 3 | 41 | 169 | 545 | 169 | 41 | 1,230,958,923 | 342,872,922 | 1,573,831,845 | 2,097,152 | 0 | 2 | 43 | 1,515,265 | 49.76 | 

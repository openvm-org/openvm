...
| `total_proof_time_ms ` |  5,303 |  5,303 |  5,303 |  5,303 |
| `main_cells_used     ` |  51,485,080 |  51,485,080 |  51,485,080 |  51,485,080 |
| `total_cycles        ` |  1,500,095 |  1,500,095 |  1,500,095 |  1,500,095 |
| `execute_time_ms     ` |  311 |  311 |  311 |  311 |
| `trace_gen_time_ms   ` |  827 |  827 |  827 |  827 |
| `stark_prove_excluding_trace_time_ms` |  4,165 |  4,165 |  4,165 |  4,165 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,043 |  7,043 |  7,043 |  7,043 |
| `main_cells_used     ` |  69,420,391 |  69,420,391 |  69,420,391 |  69,420,391 |
| `total_cycles        ` |  1,925,100 |  1,925,100 |  1,925,100 |  1,925,100 |
| `execute_time_ms     ` |  304 |  304 |  304 |  304 |
| `trace_gen_time_ms   ` |  1,317 |  1,317 |  1,317 |  1,317 |
| `stark_prove_excluding_trace_time_ms` |  5,422 |  5,422 |  5,422 |  5,422 |
...
| `pcs_opening_time_ms ` |  1,308 |  1,308 |  1,308 |  1,308 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,317 | 7,043 | 1,925,100 | 157,336,536 | 5,422 | 784 | 1,094 | 1,021 | 1,308 | 1,073 | 69,420,391 | 139 | 304 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 827 | 5,303 | 1,500,095 | 122,458,476 | 4,165 | 520 | 782 | 797 | 1,064 | 867 | 51,485,080 | 131 | 311 | 

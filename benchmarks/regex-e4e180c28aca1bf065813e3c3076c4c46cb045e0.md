...
| `total_proof_time_ms ` |  4,048.50 |  8,097 |  4,496 |  3,601 |
...
| `trace_gen_time_ms   ` |  969.50 |  1,939 |  1,152 |  787 |
| `stark_prove_excluding_trace_time_ms` |  2,739 |  5,478 |  2,966 |  2,512 |
| `main_trace_commit_time_ms` |  473.50 |  947 |  535 |  412 |
| `generate_perm_trace_time_ms` |  189 |  378 |  190 |  188 |
| `perm_trace_commit_time_ms` |  692 |  1,384 |  741 |  643 |
| `quotient_poly_compute_time_ms` |  397 |  794 |  429 |  365 |
| `quotient_poly_commit_time_ms` |  286 |  572 |  328 |  244 |
| `pcs_opening_time_ms ` |  691.50 |  1,383 |  732 |  651 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,309.50 |  14,619 |  7,344 |  7,275 |
| `main_cells_used     ` |  152,278,093 |  304,556,186 |  154,677,694 |  149,878,492 |
| `total_cycles        ` |  1,991,019 |  3,982,038 |  2,021,825 |  1,960,213 |
| `execute_time_ms     ` |  776 |  1,552 |  784 |  768 |
| `trace_gen_time_ms   ` |  1,486.50 |  2,973 |  1,495 |  1,478 |
| `stark_prove_excluding_trace_time_ms` |  5,047 |  10,094 |  5,082 |  5,012 |
| `main_trace_commit_time_ms` |  812 |  1,624 |  815 |  809 |
| `generate_perm_trace_time_ms` |  361.50 |  723 |  362 |  361 |
| `perm_trace_commit_time_ms` |  1,530 |  3,060 |  1,561 |  1,499 |
| `quotient_poly_compute_time_ms` |  770 |  1,540 |  771 |  769 |
| `quotient_poly_commit_time_ms` |  496.50 |  993 |  499 |  494 |
| `pcs_opening_time_ms ` |  1,072.50 |  2,145 |  1,073 |  1,072 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,478 | 7,344 | 2,021,825 | 538,660,330 | 5,082 | 769 | 499 | 1,561 | 1,072 | 815 | 154,677,694 | 362 | 784 | 
| leaf | 1 | 1,495 | 7,275 | 1,960,213 | 538,660,330 | 5,012 | 771 | 494 | 1,499 | 1,073 | 809 | 149,878,492 | 361 | 768 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,152 | 4,496 | 2,243,715 | 275,652,919 | 2,966 | 429 | 328 | 741 | 732 | 535 | 93,500,799 | 190 | 378 | 
| regex_program | 1 | 787 | 3,601 | 1,921,511 | 242,975,404 | 2,512 | 365 | 244 | 643 | 651 | 412 | 73,010,353 | 188 | 302 | 

...
| `total_proof_time_ms ` |  3,748.50 |  7,497 |  4,172 |  3,325 |
...
| `trace_gen_time_ms   ` |  1,000.50 |  2,001 |  1,176 |  825 |
| `stark_prove_excluding_trace_time_ms` |  2,408.50 |  4,817 |  2,618 |  2,199 |
| `main_trace_commit_time_ms` |  451.50 |  903 |  503 |  400 |
| `generate_perm_trace_time_ms` |  191.50 |  383 |  211 |  172 |
| `perm_trace_commit_time_ms` |  488.50 |  977 |  515 |  462 |
| `quotient_poly_compute_time_ms` |  334 |  668 |  357 |  311 |
| `quotient_poly_commit_time_ms` |  231 |  462 |  269 |  193 |
| `pcs_opening_time_ms ` |  700.50 |  1,401 |  750 |  651 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  6,633.50 |  13,267 |  6,670 |  6,597 |
| `main_cells_used     ` |  152,278,445 |  304,556,890 |  154,678,262 |  149,878,628 |
| `total_cycles        ` |  1,991,023 |  3,982,046 |  2,021,847 |  1,960,199 |
| `execute_time_ms     ` |  784.50 |  1,569 |  791 |  778 |
| `trace_gen_time_ms   ` |  1,494.50 |  2,989 |  1,510 |  1,479 |
| `stark_prove_excluding_trace_time_ms` |  4,354.50 |  8,709 |  4,369 |  4,340 |
| `main_trace_commit_time_ms` |  780 |  1,560 |  780 |  780 |
| `generate_perm_trace_time_ms` |  377.50 |  755 |  390 |  365 |
| `perm_trace_commit_time_ms` |  1,103 |  2,206 |  1,106 |  1,100 |
| `quotient_poly_compute_time_ms` |  659.50 |  1,319 |  660 |  659 |
| `quotient_poly_commit_time_ms` |  381.50 |  763 |  382 |  381 |
| `pcs_opening_time_ms ` |  1,048.50 |  2,097 |  1,050 |  1,047 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,510 | 6,670 | 2,021,847 | 538,660,330 | 4,369 | 660 | 382 | 1,106 | 1,047 | 780 | 154,678,262 | 390 | 791 | 
| leaf | 1 | 1,479 | 6,597 | 1,960,199 | 538,660,330 | 4,340 | 659 | 381 | 1,100 | 1,050 | 780 | 149,878,628 | 365 | 778 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,176 | 4,172 | 2,243,715 | 275,652,919 | 2,618 | 357 | 269 | 515 | 750 | 503 | 93,500,799 | 211 | 378 | 
| regex_program | 1 | 825 | 3,325 | 1,921,511 | 242,975,404 | 2,199 | 311 | 193 | 462 | 651 | 400 | 73,010,353 | 172 | 301 | 

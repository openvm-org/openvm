...
| `total_proof_time_ms ` |  710 |  1,420 |  826 |  594 |
...
| `execute_preflight_time_ms` |  84.50 |  169 |  106 |  63 |
| `execute_preflight_insn_mi/s` |  14.72 | -          |  18.16 |  11.28 |
| `trace_gen_time_ms   ` |  186.50 |  373 |  190 |  183 |
| `memory_finalize_time_ms` |  0.50 |  1 |  1 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  345 |  690 |  391 |  299 |
| `main_trace_commit_time_ms` |  64.50 |  129 |  74 |  55 |
| `generate_perm_trace_time_ms` |  36 |  72 |  41 |  31 |
| `perm_trace_commit_time_ms` |  76.73 |  153.46 |  88.15 |  65.31 |
| `quotient_poly_compute_time_ms` |  78.65 |  157.30 |  86.88 |  70.42 |
| `quotient_poly_commit_time_ms` |  15.77 |  31.54 |  17.06 |  14.49 |
| `pcs_opening_time_ms ` |  68 |  136 |  78 |  58 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,483 |  2,966 |  1,787 |  1,179 |
| `main_cells_used     ` |  16,200,472 |  32,400,944 |  16,332,746 |  16,068,198 |
| `total_cells_used    ` |  39,332,920 |  78,665,840 |  39,650,868 |  39,014,972 |
| `execute_preflight_insns` |  1,952,444.50 |  3,904,889 |  1,991,982 |  1,912,907 |
| `execute_preflight_time_ms` |  630 |  1,260 |  956 |  304 |
| `execute_preflight_insn_mi/s` |  7.52 | -          |  7.53 |  7.51 |
| `trace_gen_time_ms   ` |  116 |  232 |  123 |  109 |
| `memory_finalize_time_ms` |  11.50 |  23 |  12 |  11 |
| `stark_prove_excluding_trace_time_ms` |  736 |  1,472 |  751 |  721 |
| `main_trace_commit_time_ms` |  145.50 |  291 |  149 |  142 |
| `generate_perm_trace_time_ms` |  57.50 |  115 |  58 |  57 |
| `perm_trace_commit_time_ms` |  225.39 |  450.78 |  228.99 |  221.79 |
| `quotient_poly_compute_time_ms` |  166.31 |  332.61 |  167.74 |  164.87 |
| `quotient_poly_commit_time_ms` |  30.39 |  60.78 |  31.89 |  28.89 |
| `pcs_opening_time_ms ` |  107.50 |  215 |  112 |  103 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 1,789 |  | 1 | 1 |  |  |  |  | 
| pairing |  | 594 |  | 1 | 63 | 1,745,742 | 27.66 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 123 | 1,179 | 39,650,868 | 410,701,290 | 123 | 751 | 0 | 167.74 | 31.89 | 4 | 228.99 | 112 | 288 | 111 | 12 | 149 | 16,332,746 | 58 | 304 | 1,991,982 | 7.51 | 39 | 201 | 0 | 111 | 
| leaf | 1 | 109 | 1,787 | 39,014,972 | 396,840,426 | 109 | 721 | 0 | 164.87 | 28.89 | 4 | 221.79 | 103 | 280 | 103 | 11 | 142 | 16,068,198 | 57 | 956 | 1,912,907 | 7.53 | 37 | 195 | 0 | 103 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 183 | 826 | 32,689,110 | 172,558,444 | 183 | 391 | 0 | 86.88 | 17.06 | 6 | 88.15 | 78 | 132 | 78 | 1 | 74 | 16,059,916 | 41 | 106 | 1,157,000 | 11.28 | 26 | 104 | 1 | 78 | 
| pairing | 1 | 190 | 594 | 22,314,288 | 119,958,502 | 190 | 299 | 1 | 70.42 | 14.49 | 5 | 65.31 | 58 | 99 | 58 | 0 | 55 | 9,408,294 | 31 | 63 | 588,742 | 18.16 | 20 | 85 | 1 | 58 | 

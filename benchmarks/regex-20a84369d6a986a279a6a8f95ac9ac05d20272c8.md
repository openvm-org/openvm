...
| `total_proof_time_ms ` |  3,856.50 |  7,713 |  4,468 |  3,245 |
| `main_cells_used     ` |  83,694,725 |  167,389,450 |  93,699,990 |  73,689,460 |
| `total_cycles        ` |  2,070,082 |  4,140,164 |  2,225,434 |  1,914,730 |
| `execute_time_ms     ` |  338 |  676 |  374 |  302 |
| `trace_gen_time_ms   ` |  976 |  1,952 |  1,181 |  771 |
| `stark_prove_excluding_trace_time_ms` |  2,542.50 |  5,085 |  2,913 |  2,172 |
| `main_trace_commit_time_ms` |  444.50 |  889 |  522 |  367 |
| `generate_perm_trace_time_ms` |  157.50 |  315 |  180 |  135 |
| `perm_trace_commit_time_ms` |  639.50 |  1,279 |  743 |  536 |
| `quotient_poly_compute_time_ms` |  357.50 |  715 |  411 |  304 |
| `quotient_poly_commit_time_ms` |  274.50 |  549 |  324 |  225 |
| `pcs_opening_time_ms ` |  658.50 |  1,317 |  723 |  594 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,451 |  14,902 |  7,479 |  7,423 |
| `main_cells_used     ` |  152,235,225 |  304,470,450 |  154,692,889 |  149,777,561 |
| `total_cycles        ` |  1,990,827.50 |  3,981,655 |  2,021,636 |  1,960,019 |
| `execute_time_ms     ` |  763.50 |  1,527 |  772 |  755 |
| `trace_gen_time_ms   ` |  1,459.50 |  2,919 |  1,460 |  1,459 |
| `stark_prove_excluding_trace_time_ms` |  5,228 |  10,456 |  5,248 |  5,208 |
| `main_trace_commit_time_ms` |  889.50 |  1,779 |  890 |  889 |
| `generate_perm_trace_time_ms` |  346.50 |  693 |  349 |  344 |
| `perm_trace_commit_time_ms` |  1,645.50 |  3,291 |  1,664 |  1,627 |
| `quotient_poly_compute_time_ms` |  762 |  1,524 |  763 |  761 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,459 | 7,479 | 2,021,636 | 533,941,738 | 5,248 | 761 | 521 | 1,664 | 1,057 | 889 | 154,692,889 | 349 | 772 | 
| leaf | 1 | 1,460 | 7,423 | 1,960,019 | 533,941,738 | 5,208 | 763 | 517 | 1,627 | 1,060 | 890 | 149,777,561 | 344 | 755 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,181 | 4,468 | 2,225,434 | 275,652,919 | 2,913 | 411 | 324 | 743 | 723 | 522 | 93,699,990 | 180 | 374 | 
| regex_program | 1 | 771 | 3,245 | 1,914,730 | 198,099,628 | 2,172 | 304 | 225 | 536 | 594 | 367 | 73,689,460 | 135 | 302 | 

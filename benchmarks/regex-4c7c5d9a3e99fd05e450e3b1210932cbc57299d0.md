...
|:---|---:|---:|---:|
| Total |  7.99 |  2.81 | 2.81 |
| regex_program |  2.39 |  0.74 |  0.74 |
| leaf |  5.60 |  2.07 |  2.07 |
...
| `total_proof_time_ms ` |  589 |  2,356 |  700 |  535 |
...
| `execute_preflight_insn_mi/s` |  32.16 | -          |  33.78 |  29.09 |
| `trace_gen_time_ms   ` |  173.25 |  693 |  184 |  159 |
| `memory_finalize_time_ms` |  1 |  4 |  4 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  288.25 |  1,153 |  299 |  270 |
| `main_trace_commit_time_ms` |  52.25 |  209 |  57 |  50 |
| `generate_perm_trace_time_ms` |  36 |  144 |  49 |  29 |
| `perm_trace_commit_time_ms` |  63.77 |  255.09 |  70.90 |  54.18 |
| `quotient_poly_compute_time_ms` |  60.98 |  243.92 |  73.33 |  53.73 |
| `quotient_poly_commit_time_ms` |  15.55 |  62.22 |  17.97 |  13.93 |
| `pcs_opening_time_ms ` |  56 |  224 |  58 |  53 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,399.25 |  5,597 |  2,069 |  914 |
...
| `execute_preflight_insns` |  1,440,864.75 |  5,763,459 |  1,814,597 |  1,241,405 |
| `execute_preflight_time_ms` |  629 |  2,516 |  836 |  232 |
| `execute_preflight_insn_mi/s` |  7.07 | -          |  7.26 |  6.95 |
| `trace_gen_time_ms   ` |  87.75 |  351 |  163 |  58 |
| `memory_finalize_time_ms` |  9 |  36 |  17 |  6 |
| `stark_prove_excluding_trace_time_ms` |  681 |  2,724 |  1,137 |  483 |
| `main_trace_commit_time_ms` |  125.25 |  501 |  195 |  91 |
| `generate_perm_trace_time_ms` |  51.25 |  205 |  75 |  36 |
| `perm_trace_commit_time_ms` |  210.53 |  842.13 |  384.61 |  141.79 |
| `quotient_poly_compute_time_ms` |  148.20 |  592.80 |  244.58 |  105.42 |
| `quotient_poly_commit_time_ms` |  33.97 |  135.89 |  58.31 |  24.61 |
| `pcs_opening_time_ms ` |  107.50 |  430 |  173 |  78 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 2,071 |  | 1 | 1 |  |  |  |  | 
| regex_program |  | 561 |  | 1 | 38 | 4,137,502 | 108.42 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 70 | 914 | 22,981,570 | 319,331,818 | 70 | 610 | 0 | 137.13 | 27.74 | 4 | 172.56 | 92 | 227 | 92 | 7 | 123 | 9,122,488 | 54 | 232 | 1,466,009 | 7.26 | 31 | 166 | 0 | 92 | 
| leaf | 1 | 60 | 1,381 | 20,905,034 | 255,237,610 | 60 | 483 | 0 | 105.42 | 25.24 | 4 | 143.17 | 78 | 180 | 77 | 6 | 92 | 8,256,948 | 36 | 836 | 1,241,448 | 6.97 | 26 | 131 | 0 | 77 | 
| leaf | 2 | 58 | 1,233 | 20,905,034 | 255,237,610 | 58 | 494 | 0 | 105.67 | 24.61 | 4 | 141.79 | 87 | 182 | 87 | 6 | 91 | 8,256,948 | 40 | 681 | 1,241,405 | 7.11 | 26 | 131 | 0 | 87 | 
| leaf | 3 | 163 | 2,069 | 50,337,320 | 538,365,418 | 163 | 1,137 | 0 | 244.58 | 58.31 | 5 | 384.61 | 173 | 460 | 173 | 17 | 195 | 20,171,106 | 75 | 767 | 1,814,597 | 6.95 | 61 | 307 | 5 | 173 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 184 | 700 | 23,446,148 | 150,778,428 | 184 | 299 | 0 | 62.94 | 17.97 | 5 | 70.90 | 57 | 102 | 57 | 4 | 57 | 10,899,170 | 30 | 44 | 1,103,000 | 29.09 | 22 | 81 | 1 | 57 | 
| regex_program | 1 | 159 | 560 | 11,598,276 | 128,513,066 | 159 | 295 | 1 | 53.92 | 15.18 | 4 | 64.50 | 58 | 114 | 58 | 0 | 51 | 2,196,106 | 49 | 64 | 1,104,000 | 33.78 | 17 | 69 | 0 | 58 | 
| regex_program | 2 | 166 | 535 | 11,579,064 | 128,513,066 | 166 | 270 | 1 | 53.73 | 15.14 | 4 | 65.52 | 53 | 95 | 53 | 0 | 51 | 2,177,334 | 29 | 57 | 1,104,000 | 33.61 | 17 | 69 | 0 | 53 | 
| regex_program | 3 | 184 | 561 | 11,853,872 | 103,456,394 | 184 | 289 | 0 | 73.33 | 13.93 | 5 | 54.18 | 56 | 94 | 56 | 0 | 50 | 2,422,606 | 36 | 46 | 826,502 | 32.15 | 19 | 88 | 1 | 56 | 
...
Commit: https://github.com/openvm-org/openvm/commit/4c7c5d9a3e99fd05e450e3b1210932cbc57299d0
...
[Benchmark Workflow](https://github.com/openvm-org/openvm/actions/runs/20601669160)

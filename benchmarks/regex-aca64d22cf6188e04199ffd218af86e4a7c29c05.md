...
| `total_proof_time_ms ` |  3,878 |  7,756 |  4,450 |  3,306 |
...
| `trace_gen_time_ms   ` |  966.50 |  1,933 |  1,130 |  803 |
| `stark_prove_excluding_trace_time_ms` |  2,575 |  5,150 |  2,947 |  2,203 |
| `main_trace_commit_time_ms` |  454 |  908 |  537 |  371 |
| `generate_perm_trace_time_ms` |  165.50 |  331 |  186 |  145 |
| `perm_trace_commit_time_ms` |  647 |  1,294 |  754 |  540 |
| `quotient_poly_compute_time_ms` |  358.50 |  717 |  422 |  295 |
| `quotient_poly_commit_time_ms` |  272.50 |  545 |  318 |  227 |
| `pcs_opening_time_ms ` |  668 |  1,336 |  721 |  615 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,503.50 |  15,007 |  7,586 |  7,421 |
| `main_cells_used     ` |  152,306,773.50 |  304,613,547 |  154,766,359 |  149,847,188 |
| `total_cycles        ` |  1,993,392 |  3,986,784 |  2,024,291 |  1,962,493 |
| `execute_time_ms     ` |  775 |  1,550 |  783 |  767 |
| `trace_gen_time_ms   ` |  1,458 |  2,916 |  1,487 |  1,429 |
| `stark_prove_excluding_trace_time_ms` |  5,270.50 |  10,541 |  5,316 |  5,225 |
| `main_trace_commit_time_ms` |  890.50 |  1,781 |  891 |  890 |
| `generate_perm_trace_time_ms` |  341.50 |  683 |  344 |  339 |
| `perm_trace_commit_time_ms` |  1,660 |  3,320 |  1,701 |  1,619 |
| `quotient_poly_compute_time_ms` |  767 |  1,534 |  769 |  765 |
| `quotient_poly_commit_time_ms` |  530 |  1,060 |  533 |  527 |
| `pcs_opening_time_ms ` |  1,075.50 |  2,151 |  1,079 |  1,072 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,487 | 7,586 | 2,024,291 | 533,941,738 | 5,316 | 769 | 527 | 1,701 | 1,079 | 890 | 154,766,359 | 344 | 783 | 
| leaf | 1 | 1,429 | 7,421 | 1,962,493 | 533,941,738 | 5,225 | 765 | 533 | 1,619 | 1,072 | 891 | 149,847,188 | 339 | 767 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,130 | 4,450 | 2,225,434 | 275,652,919 | 2,947 | 422 | 318 | 754 | 721 | 537 | 93,699,990 | 186 | 373 | 
| regex_program | 1 | 803 | 3,306 | 1,914,730 | 198,099,628 | 2,203 | 295 | 227 | 540 | 615 | 371 | 73,689,460 | 145 | 300 | 

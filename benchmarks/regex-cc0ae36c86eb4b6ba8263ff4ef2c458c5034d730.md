...
| `total_proof_time_ms ` |  3,981.50 |  7,963 |  4,412 |  3,551 |
| `main_cells_used     ` |  83,255,576 |  166,511,152 |  93,500,799 |  73,010,353 |
| `total_cycles        ` |  2,082,613 |  4,165,226 |  2,243,715 |  1,921,511 |
| `execute_time_ms     ` |  355 |  710 |  396 |  314 |
| `trace_gen_time_ms   ` |  995 |  1,990 |  1,180 |  810 |
| `stark_prove_excluding_trace_time_ms` |  2,631.50 |  5,263 |  2,836 |  2,427 |
| `main_trace_commit_time_ms` |  500.50 |  1,001 |  559 |  442 |
| `generate_perm_trace_time_ms` |  222 |  444 |  233 |  211 |
| `perm_trace_commit_time_ms` |  543.50 |  1,087 |  571 |  516 |
| `quotient_poly_compute_time_ms` |  268.50 |  537 |  294 |  243 |
| `quotient_poly_commit_time_ms` |  242.50 |  485 |  273 |  212 |
| `pcs_opening_time_ms ` |  842.50 |  1,685 |  893 |  792 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,017.50 |  14,035 |  7,069 |  6,966 |
| `main_cells_used     ` |  151,827,653 |  303,655,306 |  154,227,518 |  149,427,788 |
| `total_cycles        ` |  1,975,711 |  3,951,422 |  2,006,539 |  1,944,883 |
| `execute_time_ms     ` |  784.50 |  1,569 |  793 |  776 |
| `trace_gen_time_ms   ` |  1,488 |  2,976 |  1,510 |  1,466 |
| `stark_prove_excluding_trace_time_ms` |  4,745 |  9,490 |  4,766 |  4,724 |
| `main_trace_commit_time_ms` |  864 |  1,728 |  865 |  863 |
| `generate_perm_trace_time_ms` |  399.50 |  799 |  422 |  377 |
| `perm_trace_commit_time_ms` |  1,255 |  2,510 |  1,265 |  1,245 |
| `quotient_poly_compute_time_ms` |  530 |  1,060 |  537 |  523 |
| `quotient_poly_commit_time_ms` |  411 |  822 |  412 |  410 |
| `pcs_opening_time_ms ` |  1,278.50 |  2,557 |  1,280 |  1,277 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,510 | 7,069 | 2,006,539 | 538,660,330 | 4,766 | 537 | 410 | 1,245 | 1,280 | 865 | 154,227,518 | 422 | 793 | 
| leaf | 1 | 1,466 | 6,966 | 1,944,883 | 538,660,330 | 4,724 | 523 | 412 | 1,265 | 1,277 | 863 | 149,427,788 | 377 | 776 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,180 | 4,412 | 2,243,715 | 275,652,919 | 2,836 | 294 | 273 | 571 | 893 | 559 | 93,500,799 | 233 | 396 | 
| regex_program | 1 | 810 | 3,551 | 1,921,511 | 242,975,404 | 2,427 | 243 | 212 | 516 | 792 | 442 | 73,010,353 | 211 | 314 | 

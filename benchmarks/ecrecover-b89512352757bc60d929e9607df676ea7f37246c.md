...
| `total_proof_time_ms ` |  2,539 |  2,539 |  2,539 |  2,539 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  13,479 |  13,479 |  13,479 |  13,479 |
| `main_cells_used     ` |  133,785,785 |  133,785,785 |  133,785,785 |  133,785,785 |
| `total_cycles        ` |  2,253,309 |  2,253,309 |  2,253,309 |  2,253,309 |
| `execute_time_ms     ` |  717 |  717 |  717 |  717 |
| `trace_gen_time_ms   ` |  1,740 |  1,740 |  1,740 |  1,740 |
| `stark_prove_excluding_trace_time_ms` |  11,022 |  11,022 |  11,022 |  11,022 |
| `main_trace_commit_time_ms` |  2,388 |  2,388 |  2,388 |  2,388 |
| `generate_perm_trace_time_ms` |  317 |  317 |  317 |  317 |
| `perm_trace_commit_time_ms` |  2,385 |  2,385 |  2,385 |  2,385 |
| `quotient_poly_compute_time_ms` |  1,633 |  1,633 |  1,633 |  1,633 |
| `quotient_poly_commit_time_ms` |  2,008 |  2,008 |  2,008 |  2,008 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,740 | 13,479 | 2,253,309 | 377,489,890 | 11,022 | 1,633 | 2,008 | 2,385 | 2,285 | 2,388 | 133,785,785 | 317 | 717 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 184 | 2,539 | 295,181 | 38,665,477 | 2,207 | 235 | 487 | 360 | 692 | 380 | 15,586,346 | 37 | 148 | 

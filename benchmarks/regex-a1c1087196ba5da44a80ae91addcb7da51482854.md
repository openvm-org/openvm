...
| `total_proof_time_ms ` |  4,003 |  8,006 |  4,641 |  3,365 |
...
| `trace_gen_time_ms   ` |  958 |  1,916 |  1,167 |  749 |
| `stark_prove_excluding_trace_time_ms` |  2,704 |  5,408 |  3,095 |  2,313 |
| `main_trace_commit_time_ms` |  501 |  1,002 |  591 |  411 |
| `generate_perm_trace_time_ms` |  168.50 |  337 |  192 |  145 |
| `perm_trace_commit_time_ms` |  700.50 |  1,401 |  809 |  592 |
| `quotient_poly_compute_time_ms` |  365.50 |  731 |  426 |  305 |
| `quotient_poly_commit_time_ms` |  289 |  578 |  333 |  245 |
| `pcs_opening_time_ms ` |  669.50 |  1,339 |  733 |  606 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,570.50 |  15,141 |  7,668 |  7,473 |
| `main_cells_used     ` |  152,231,075 |  304,462,150 |  154,688,987 |  149,773,163 |
| `total_cycles        ` |  1,990,743.50 |  3,981,487 |  2,021,569 |  1,959,918 |
| `execute_time_ms     ` |  769 |  1,538 |  778 |  760 |
| `trace_gen_time_ms   ` |  1,501.50 |  3,003 |  1,527 |  1,476 |
| `stark_prove_excluding_trace_time_ms` |  5,300 |  10,600 |  5,363 |  5,237 |
| `main_trace_commit_time_ms` |  894 |  1,788 |  897 |  891 |
| `generate_perm_trace_time_ms` |  352.50 |  705 |  366 |  339 |
| `perm_trace_commit_time_ms` |  1,681 |  3,362 |  1,699 |  1,663 |
| `quotient_poly_compute_time_ms` |  761.50 |  1,523 |  762 |  761 |
| `quotient_poly_commit_time_ms` |  521.50 |  1,043 |  523 |  520 |
| `pcs_opening_time_ms ` |  1,086 |  2,172 |  1,112 |  1,060 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,527 | 7,668 | 2,021,569 | 533,941,738 | 5,363 | 762 | 523 | 1,699 | 1,112 | 897 | 154,688,987 | 366 | 778 | 
| leaf | 1 | 1,476 | 7,473 | 1,959,918 | 533,941,738 | 5,237 | 761 | 520 | 1,663 | 1,060 | 891 | 149,773,163 | 339 | 760 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,167 | 4,641 | 2,225,434 | 275,652,919 | 3,095 | 426 | 333 | 809 | 733 | 591 | 93,699,990 | 192 | 379 | 
| regex_program | 1 | 749 | 3,365 | 1,914,730 | 198,099,628 | 2,313 | 305 | 245 | 592 | 606 | 411 | 73,689,460 | 145 | 303 | 

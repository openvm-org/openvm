...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  22,405 |  22,405 |  22,405 |  22,405 |
| `main_cells_used     ` |  241,409,829 |  241,409,829 |  241,409,829 |  241,409,829 |
| `total_cycles        ` |  4,166,673 |  4,166,673 |  4,166,673 |  4,166,673 |
| `execute_time_ms     ` |  920 |  920 |  920 |  920 |
| `trace_gen_time_ms   ` |  3,912 |  3,912 |  3,912 |  3,912 |
| `stark_prove_excluding_trace_time_ms` |  17,573 |  17,573 |  17,573 |  17,573 |
| `main_trace_commit_time_ms` |  3,280 |  3,280 |  3,280 |  3,280 |
| `generate_perm_trace_time_ms` |  393 |  393 |  393 |  393 |
| `perm_trace_commit_time_ms` |  3,905 |  3,905 |  3,905 |  3,905 |
| `quotient_poly_compute_time_ms` |  4,519 |  4,519 |  4,519 |  4,519 |
| `quotient_poly_commit_time_ms` |  2,583 |  2,583 |  2,583 |  2,583 |
| `pcs_opening_time_ms ` |  2,891 |  2,891 |  2,891 |  2,891 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 3,912 | 22,405 | 4,166,673 | 590,040,024 | 17,573 | 4,519 | 2,583 | 3,905 | 2,891 | 3,280 | 241,409,829 | 393 | 920 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 259 | 2,611 | 285,401 | 56,172,159 | 2,206 | 314 | 295 | 535 | 626 | 390 | 15,075,033 | 43 | 146 | 

...
| `total_proof_time_ms ` |  7,682 |  15,364 |  8,571 |  6,793 |
| `main_cells_used     ` |  82,727,686.50 |  165,455,373 |  92,686,348 |  72,769,025 |
| `total_cycles        ` |  1,914,103 |  1,914,103 |  1,914,103 |  1,914,103 |
| `execute_time_ms     ` |  453.50 |  907 |  488 |  419 |
| `trace_gen_time_ms   ` |  1,701 |  3,402 |  1,887 |  1,515 |
| `stark_prove_excluding_trace_time_ms` |  5,527.50 |  11,055 |  6,196 |  4,859 |
| `main_trace_commit_time_ms` |  1,112 |  2,224 |  1,333 |  891 |
| `generate_perm_trace_time_ms` |  176 |  352 |  189 |  163 |
| `perm_trace_commit_time_ms` |  1,173.50 |  2,347 |  1,238 |  1,109 |
| `quotient_poly_compute_time_ms` |  738.50 |  1,477 |  860 |  617 |
| `quotient_poly_commit_time_ms` |  990.50 |  1,981 |  1,135 |  846 |
| `pcs_opening_time_ms ` |  1,325.50 |  2,651 |  1,433 |  1,218 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  14,679.50 |  29,359 |  14,778 |  14,581 |
| `main_cells_used     ` |  129,448,891.50 |  258,897,783 |  131,050,046 |  127,847,737 |
| `total_cycles        ` |  2,941,815.50 |  5,883,631 |  2,978,301 |  2,905,330 |
| `execute_time_ms     ` |  632 |  1,264 |  663 |  601 |
| `trace_gen_time_ms   ` |  2,648.50 |  5,297 |  2,782 |  2,515 |
| `stark_prove_excluding_trace_time_ms` |  11,399 |  22,798 |  11,403 |  11,395 |
| `main_trace_commit_time_ms` |  2,346.50 |  4,693 |  2,359 |  2,334 |
| `generate_perm_trace_time_ms` |  284.50 |  569 |  289 |  280 |
| `perm_trace_commit_time_ms` |  2,297.50 |  4,595 |  2,306 |  2,289 |
| `quotient_poly_compute_time_ms` |  1,647.50 |  3,295 |  1,659 |  1,636 |
| `quotient_poly_commit_time_ms` |  2,231 |  4,462 |  2,232 |  2,230 |
| `pcs_opening_time_ms ` |  2,588 |  5,176 |  2,597 |  2,579 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 2,515 | 14,581 | 2,978,301 | 353,773,272 | 11,403 | 1,659 | 2,230 | 2,289 | 2,597 | 2,334 | 131,050,046 | 289 | 663 | 
| leaf | 1 | 2,782 | 14,778 | 2,905,330 | 353,780,696 | 11,395 | 1,636 | 2,232 | 2,306 | 2,579 | 2,359 | 127,847,737 | 280 | 601 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,887 | 8,571 |  | 209,921,543 | 6,196 | 860 | 1,135 | 1,238 | 1,433 | 1,333 | 92,686,348 | 189 | 488 | 
| regex_program | 1 | 1,515 | 6,793 | 1,914,103 | 149,454,692 | 4,859 | 617 | 846 | 1,109 | 1,218 | 891 | 72,769,025 | 163 | 419 | 

...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  13,215 |  13,215 |  13,215 |  13,215 |
| `main_cells_used     ` |  247,319,559 |  247,319,559 |  247,319,559 |  247,319,559 |
| `total_cycles        ` |  3,038,529 |  3,038,529 |  3,038,529 |  3,038,529 |
| `execute_time_ms     ` |  1,077 |  1,077 |  1,077 |  1,077 |
| `trace_gen_time_ms   ` |  2,438 |  2,438 |  2,438 |  2,438 |
| `stark_prove_excluding_trace_time_ms` |  9,700 |  9,700 |  9,700 |  9,700 |
| `main_trace_commit_time_ms` |  1,732 |  1,732 |  1,732 |  1,732 |
| `generate_perm_trace_time_ms` |  735 |  735 |  735 |  735 |
| `perm_trace_commit_time_ms` |  3,194 |  3,194 |  3,194 |  3,194 |
| `quotient_poly_compute_time_ms` |  1,349 |  1,349 |  1,349 |  1,349 |
| `quotient_poly_commit_time_ms` |  874 |  874 |  874 |  874 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 2,438 | 13,215 | 3,038,529 | 1,008,831,978 | 9,700 | 1,349 | 874 | 3,194 | 1,810 | 1,732 | 247,319,559 | 735 | 1,077 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 183 | 1,422 | 294,389 | 48,241,345 | 1,091 | 123 | 157 | 189 | 405 | 168 | 15,287,786 | 34 | 148 | 

...
| `total_proof_time_ms ` |  6,867.50 |  13,735 |  7,752 |  5,983 |
...
| `trace_gen_time_ms   ` |  1,095.50 |  2,191 |  1,258 |  933 |
| `stark_prove_excluding_trace_time_ms` |  5,334.50 |  10,669 |  6,023 |  4,646 |
| `main_trace_commit_time_ms` |  1,027.50 |  2,055 |  1,272 |  783 |
| `generate_perm_trace_time_ms` |  177 |  354 |  193 |  161 |
| `perm_trace_commit_time_ms` |  1,136 |  2,272 |  1,191 |  1,081 |
| `quotient_poly_compute_time_ms` |  735 |  1,470 |  858 |  612 |
| `quotient_poly_commit_time_ms` |  944 |  1,888 |  1,085 |  803 |
| `pcs_opening_time_ms ` |  1,304 |  2,608 |  1,416 |  1,192 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  8,027.50 |  16,055 |  8,260 |  7,795 |
| `main_cells_used     ` |  77,286,912.50 |  154,573,825 |  78,375,071 |  76,198,754 |
| `total_cycles        ` |  1,028,180.50 |  2,056,361 |  1,045,607 |  1,010,754 |
| `execute_time_ms     ` |  374.50 |  749 |  410 |  339 |
| `trace_gen_time_ms   ` |  1,143.50 |  2,287 |  1,231 |  1,056 |
| `stark_prove_excluding_trace_time_ms` |  6,509.50 |  13,019 |  6,794 |  6,225 |
| `main_trace_commit_time_ms` |  1,335.50 |  2,671 |  1,380 |  1,291 |
| `generate_perm_trace_time_ms` |  164.50 |  329 |  173 |  156 |
| `perm_trace_commit_time_ms` |  1,311.50 |  2,623 |  1,368 |  1,255 |
| `quotient_poly_compute_time_ms` |  980 |  1,960 |  1,044 |  916 |
| `quotient_poly_commit_time_ms` |  1,273 |  2,546 |  1,359 |  1,187 |
| `pcs_opening_time_ms ` |  1,441.50 |  2,883 |  1,466 |  1,417 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,056 | 8,260 | 1,045,607 | 220,669,656 | 6,794 | 1,044 | 1,359 | 1,368 | 1,466 | 1,380 | 78,375,071 | 173 | 410 | 
| leaf | 1 | 1,231 | 7,795 | 1,010,754 | 194,986,968 | 6,225 | 916 | 1,187 | 1,255 | 1,417 | 1,291 | 76,198,754 | 156 | 339 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,258 | 7,752 |  | 209,921,543 | 6,023 | 858 | 1,085 | 1,191 | 1,416 | 1,272 | 92,686,348 | 193 | 471 | 
| regex_program | 1 | 933 | 5,983 | 1,914,103 | 149,454,692 | 4,646 | 612 | 803 | 1,081 | 1,192 | 783 | 72,769,025 | 161 | 404 | 

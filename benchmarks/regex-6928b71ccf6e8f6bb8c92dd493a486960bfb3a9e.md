...
| `total_proof_time_ms ` |  6,929.50 |  13,859 |  7,779 |  6,080 |
| `main_cells_used     ` |  82,727,686.50 |  165,455,373 |  92,686,348 |  72,769,025 |
| `total_cycles        ` |  2,069,920 |  4,139,840 |  2,225,737 |  1,914,103 |
| `execute_time_ms     ` |  438.50 |  877 |  472 |  405 |
| `trace_gen_time_ms   ` |  1,094 |  2,188 |  1,251 |  937 |
| `stark_prove_excluding_trace_time_ms` |  5,397 |  10,794 |  6,056 |  4,738 |
| `main_trace_commit_time_ms` |  1,031 |  2,062 |  1,259 |  803 |
| `generate_perm_trace_time_ms` |  175 |  350 |  193 |  157 |
| `perm_trace_commit_time_ms` |  1,150.50 |  2,301 |  1,196 |  1,105 |
| `quotient_poly_compute_time_ms` |  748.50 |  1,497 |  872 |  625 |
| `quotient_poly_commit_time_ms` |  972.50 |  1,945 |  1,108 |  837 |
| `pcs_opening_time_ms ` |  1,310.50 |  2,621 |  1,420 |  1,201 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  8,014 |  16,028 |  8,212 |  7,816 |
| `main_cells_used     ` |  77,287,088 |  154,574,176 |  78,375,899 |  76,198,277 |
| `total_cycles        ` |  1,028,200 |  2,056,400 |  1,045,699 |  1,010,701 |
| `execute_time_ms     ` |  385.50 |  771 |  430 |  341 |
| `trace_gen_time_ms   ` |  1,160.50 |  2,321 |  1,260 |  1,061 |
| `stark_prove_excluding_trace_time_ms` |  6,468 |  12,936 |  6,721 |  6,215 |
| `main_trace_commit_time_ms` |  1,326.50 |  2,653 |  1,381 |  1,272 |
| `generate_perm_trace_time_ms` |  161 |  322 |  174 |  148 |
| `perm_trace_commit_time_ms` |  1,309.50 |  2,619 |  1,352 |  1,267 |
| `quotient_poly_compute_time_ms` |  970 |  1,940 |  1,018 |  922 |
| `quotient_poly_commit_time_ms` |  1,262 |  2,524 |  1,324 |  1,200 |
| `pcs_opening_time_ms ` |  1,434.50 |  2,869 |  1,467 |  1,402 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,061 | 8,212 | 1,045,699 | 220,669,656 | 6,721 | 1,018 | 1,324 | 1,352 | 1,467 | 1,381 | 78,375,899 | 174 | 430 | 
| leaf | 1 | 1,260 | 7,816 | 1,010,701 | 194,986,968 | 6,215 | 922 | 1,200 | 1,267 | 1,402 | 1,272 | 76,198,277 | 148 | 341 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,251 | 7,779 | 2,225,737 | 209,921,543 | 6,056 | 872 | 1,108 | 1,196 | 1,420 | 1,259 | 92,686,348 | 193 | 472 | 
| regex_program | 1 | 937 | 6,080 | 1,914,103 | 149,454,692 | 4,738 | 625 | 837 | 1,105 | 1,201 | 803 | 72,769,025 | 157 | 405 | 

...
| `total_proof_time_ms ` |  1,602 |  1,602 |  1,602 |  1,602 |
...
| `stark_prove_excluding_trace_time_ms` |  952 |  952 |  952 |  952 |
| `main_trace_commit_time_ms` |  145 |  145 |  145 |  145 |
| `generate_perm_trace_time_ms` |  66 |  66 |  66 |  66 |
| `perm_trace_commit_time_ms` |  177.76 |  177.76 |  177.76 |  177.76 |
| `quotient_poly_compute_time_ms` |  144.54 |  144.54 |  144.54 |  144.54 |
| `quotient_poly_commit_time_ms` |  33.34 |  33.34 |  33.34 |  33.34 |
...
| `execute_preflight_insns` |  2,010,424 |  2,010,424 |  2,010,424 |  2,010,424 |
| `execute_preflight_time_ms` |  331 |  331 |  331 |  331 |
| `execute_preflight_insn_mi/s` |  7.72 | -          |  7.72 |  7.72 |
| `trace_gen_time_ms   ` |  122 |  122 |  122 |  122 |
| `memory_finalize_time_ms` |  13 |  13 |  13 |  13 |
| `stark_prove_excluding_trace_time_ms` |  1,267 |  1,267 |  1,267 |  1,267 |
| `main_trace_commit_time_ms` |  165 |  165 |  165 |  165 |
| `generate_perm_trace_time_ms` |  68 |  68 |  68 |  68 |
| `perm_trace_commit_time_ms` |  251.04 |  251.04 |  251.04 |  251.04 |
| `quotient_poly_compute_time_ms` |  169.48 |  169.48 |  169.48 |  169.48 |
| `quotient_poly_commit_time_ms` |  40.87 |  40.87 |  40.87 |  40.87 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 1,722 |  | 1 |  | 1 |  |  |  |  | 
| pairing |  | 1,602 |  | 41 | 1 | 92 | 1,882,939 | 20.34 | 150 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 122 | 1,720 | 39,940,154 | 418,598,378 | 122 | 1,267 | 0 | 169.48 | 40.87 | 4 | 251.04 | 569 | 320 | 569 | 13 | 165 | 16,451,316 | 68 | 331 | 2,010,424 | 7.72 | 39 | 211 | 1 | 569 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 357 | 1,602 | 44,491,360 | 304,931,516 | 357 | 952 | 0 | 144.54 | 33.34 | 7 | 177.76 | 379 | 247 | 379 | 1 | 145 | 23,722,622 | 66 | 165 | 1,882,939 | 11.73 | 37 | 179 | 3 | 379 | 

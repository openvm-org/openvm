...
| `pcs_opening_time_ms ` |  404 |  404 |  404 |  404 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  13,177 |  13,177 |  13,177 |  13,177 |
| `main_cells_used     ` |  247,318,935 |  247,318,935 |  247,318,935 |  247,318,935 |
| `total_cycles        ` |  3,038,477 |  3,038,477 |  3,038,477 |  3,038,477 |
| `execute_time_ms     ` |  1,081 |  1,081 |  1,081 |  1,081 |
| `trace_gen_time_ms   ` |  2,403 |  2,403 |  2,403 |  2,403 |
| `stark_prove_excluding_trace_time_ms` |  9,693 |  9,693 |  9,693 |  9,693 |
| `main_trace_commit_time_ms` |  1,724 |  1,724 |  1,724 |  1,724 |
| `generate_perm_trace_time_ms` |  738 |  738 |  738 |  738 |
| `perm_trace_commit_time_ms` |  3,197 |  3,197 |  3,197 |  3,197 |
| `quotient_poly_compute_time_ms` |  1,352 |  1,352 |  1,352 |  1,352 |
| `quotient_poly_commit_time_ms` |  879 |  879 |  879 |  879 |
| `pcs_opening_time_ms ` |  1,798 |  1,798 |  1,798 |  1,798 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 2,403 | 13,177 | 3,038,477 | 1,008,831,978 | 9,693 | 1,352 | 879 | 3,197 | 1,798 | 1,724 | 247,318,935 | 738 | 1,081 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 181 | 1,418 | 294,389 | 48,241,345 | 1,089 | 125 | 154 | 185 | 404 | 172 | 15,287,786 | 33 | 148 | 

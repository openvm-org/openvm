...
| `total_proof_time_ms ` |  1,468.50 |  2,937 |  1,717 |  1,220 |
...
| `execute_preflight_insn_mi/s` |  32.26 | -          |  34.01 |  30.51 |
| `trace_gen_time_ms   ` |  314.50 |  629 |  336 |  293 |
| `memory_finalize_time_ms` |  2 |  4 |  4 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  974 |  1,948 |  1,217 |  731 |
| `main_trace_commit_time_ms` |  140 |  280 |  183 |  97 |
| `generate_perm_trace_time_ms` |  58.50 |  117 |  71 |  46 |
| `perm_trace_commit_time_ms` |  171.69 |  343.38 |  223.14 |  120.25 |
| `quotient_poly_compute_time_ms` |  156.21 |  312.42 |  166.57 |  145.85 |
| `quotient_poly_commit_time_ms` |  36.70 |  73.39 |  48.24 |  25.16 |
| `pcs_opening_time_ms ` |  404 |  808 |  542 |  266 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  2,070.50 |  4,141 |  2,826 |  1,315 |
| `main_cells_used     ` |  14,798,849 |  29,597,698 |  20,272,474 |  9,325,224 |
| `total_cells_used    ` |  37,032,585 |  74,065,170 |  50,586,080 |  23,479,090 |
| `execute_preflight_insns` |  1,663,327 |  3,326,654 |  1,830,088 |  1,496,566 |
| `execute_preflight_time_ms` |  576.50 |  1,153 |  894 |  259 |
| `execute_preflight_insn_mi/s` |  7.11 | -          |  7.42 |  6.79 |
| `trace_gen_time_ms   ` |  122 |  244 |  168 |  76 |
| `memory_finalize_time_ms` |  11 |  22 |  15 |  7 |
| `stark_prove_excluding_trace_time_ms` |  1,370.50 |  2,741 |  1,763 |  978 |
| `main_trace_commit_time_ms` |  179 |  358 |  227 |  131 |
| `generate_perm_trace_time_ms` |  83 |  166 |  87 |  79 |
| `perm_trace_commit_time_ms` |  276.99 |  553.98 |  367.23 |  186.75 |
| `quotient_poly_compute_time_ms` |  176.49 |  352.98 |  228.31 |  124.67 |
| `quotient_poly_commit_time_ms` |  43.53 |  87.06 |  56.20 |  30.86 |
| `pcs_opening_time_ms ` |  607.50 |  1,215 |  792 |  423 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 2,828 |  | 1 |  | 1 |  |  |  |  | 
| regex_program |  | 1,220 |  | 40 | 1 | 43 | 4,108,483 | 94.45 | 166 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 76 | 1,315 | 23,479,090 | 319,626,730 | 76 | 978 | 0 | 124.67 | 30.86 | 4 | 186.75 | 423 | 267 | 423 | 7 | 131 | 9,325,224 | 79 | 259 | 1,496,566 | 7.42 | 29 | 156 | 1 | 423 | 
| leaf | 1 | 168 | 2,826 | 50,586,080 | 538,660,330 | 168 | 1,763 | 0 | 228.31 | 56.20 | 5 | 367.23 | 792 | 456 | 792 | 15 | 227 | 20,272,474 | 87 | 894 | 1,830,088 | 6.79 | 56 | 287 | 1 | 792 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 293 | 1,717 | 23,397,108 | 373,183,036 | 293 | 1,217 | 0 | 145.85 | 48.24 | 6 | 223.14 | 542 | 294 | 542 | 4 | 183 | 10,866,434 | 71 | 80 | 2,211,000 | 30.51 | 46 | 196 | 2 | 542 | 
| regex_program | 1 | 336 | 1,220 | 11,981,356 | 196,739,722 | 336 | 731 | 2 | 166.57 | 25.16 | 5 | 120.25 | 266 | 169 | 266 | 0 | 97 | 2,537,170 | 46 | 106 | 1,897,483 | 34.01 | 26 | 196 | 2 | 266 | 

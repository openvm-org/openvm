...
| `stark_prove_excluding_trace_time_ms` |  3,372 |  3,372 |  3,372 |  3,372 |
| `main_trace_commit_time_ms` |  653 |  653 |  653 |  653 |
| `generate_perm_trace_time_ms` |  206 |  206 |  206 |  206 |
| `perm_trace_commit_time_ms` |  844 |  844 |  844 |  844 |
| `quotient_poly_compute_time_ms` |  468 |  468 |  468 |  468 |
| `quotient_poly_commit_time_ms` |  358 |  358 |  358 |  358 |
| `pcs_opening_time_ms ` |  826 |  826 |  826 |  826 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  14,273 |  14,273 |  14,273 |  14,273 |
...
| `stark_prove_excluding_trace_time_ms` |  10,388 |  10,388 |  10,388 |  10,388 |
| `main_trace_commit_time_ms` |  1,779 |  1,779 |  1,779 |  1,779 |
| `generate_perm_trace_time_ms` |  758 |  758 |  758 |  758 |
| `perm_trace_commit_time_ms` |  3,414 |  3,414 |  3,414 |  3,414 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 2,601 | 14,273 | 3,267,508 | 1,081,183,722 | 10,388 | 1,477 | 980 | 3,414 | 1,975 | 1,779 | 273,857,940 | 758 | 1,284 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 938 | 4,962 | 1,820,436 | 297,675,351 | 3,372 | 468 | 358 | 844 | 826 | 653 | 95,832,407 | 206 | 652 | 

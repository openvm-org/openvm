...
| `total_proof_time_ms ` |  4,060 |  8,120 |  4,508 |  3,612 |
...
| `trace_gen_time_ms   ` |  996 |  1,992 |  1,182 |  810 |
| `stark_prove_excluding_trace_time_ms` |  2,724 |  5,448 |  2,947 |  2,501 |
| `main_trace_commit_time_ms` |  470.50 |  941 |  528 |  413 |
| `generate_perm_trace_time_ms` |  188.50 |  377 |  196 |  181 |
| `perm_trace_commit_time_ms` |  689 |  1,378 |  743 |  635 |
| `quotient_poly_compute_time_ms` |  396 |  792 |  429 |  363 |
| `quotient_poly_commit_time_ms` |  284.50 |  569 |  316 |  253 |
| `pcs_opening_time_ms ` |  686.50 |  1,373 |  725 |  648 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,295.50 |  14,591 |  7,374 |  7,217 |
| `main_cells_used     ` |  152,278,651 |  304,557,302 |  154,678,042 |  149,879,260 |
| `total_cycles        ` |  1,991,065.50 |  3,982,131 |  2,021,854 |  1,960,277 |
| `execute_time_ms     ` |  771.50 |  1,543 |  779 |  764 |
| `trace_gen_time_ms   ` |  1,493 |  2,986 |  1,514 |  1,472 |
| `stark_prove_excluding_trace_time_ms` |  5,031 |  10,062 |  5,081 |  4,981 |
| `main_trace_commit_time_ms` |  805 |  1,610 |  806 |  804 |
| `generate_perm_trace_time_ms` |  375 |  750 |  389 |  361 |
| `perm_trace_commit_time_ms` |  1,541.50 |  3,083 |  1,576 |  1,507 |
| `quotient_poly_compute_time_ms` |  763 |  1,526 |  765 |  761 |
| `quotient_poly_commit_time_ms` |  491 |  982 |  492 |  490 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,514 | 7,374 | 2,021,854 | 538,660,330 | 5,081 | 765 | 490 | 1,576 | 1,049 | 806 | 154,678,042 | 389 | 779 | 
| leaf | 1 | 1,472 | 7,217 | 1,960,277 | 538,660,330 | 4,981 | 761 | 492 | 1,507 | 1,051 | 804 | 149,879,260 | 361 | 764 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,182 | 4,508 | 2,243,715 | 275,652,919 | 2,947 | 429 | 316 | 743 | 725 | 528 | 93,500,799 | 196 | 379 | 
| regex_program | 1 | 810 | 3,612 | 1,921,511 | 242,975,404 | 2,501 | 363 | 253 | 635 | 648 | 413 | 73,010,353 | 181 | 301 | 

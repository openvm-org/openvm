...
| `total_proof_time_ms ` |  5,009 |  5,009 |  5,009 |  5,009 |
| `main_cells_used     ` |  51,485,167 |  51,485,167 |  51,485,167 |  51,485,167 |
| `total_cycles        ` |  1,500,096 |  1,500,096 |  1,500,096 |  1,500,096 |
| `execute_time_ms     ` |  292 |  292 |  292 |  292 |
| `trace_gen_time_ms   ` |  637 |  637 |  637 |  637 |
| `stark_prove_excluding_trace_time_ms` |  4,080 |  4,080 |  4,080 |  4,080 |
...
| `main_cells_used     ` |  38,847,184 |  38,847,184 |  38,847,184 |  38,847,184 |
| `total_cycles        ` |  815,552 |  815,552 |  815,552 |  815,552 |
| `execute_time_ms     ` |  272 |  272 |  272 |  272 |
| `trace_gen_time_ms   ` |  643 |  643 |  643 |  643 |
| `stark_prove_excluding_trace_time_ms` |  3,109 |  3,109 |  3,109 |  3,109 |
| `main_trace_commit_time_ms` |  609 |  609 |  609 |  609 |
| `generate_perm_trace_time_ms` |  81 |  81 |  81 |  81 |
| `perm_trace_commit_time_ms` |  589 |  589 |  589 |  589 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 643 | 4,024 | 815,552 | 95,033,826 | 3,109 | 458 | 649 | 589 | 717 | 609 | 38,847,184 | 81 | 272 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 637 | 5,009 | 1,500,096 | 122,458,688 | 4,080 | 526 | 768 | 798 | 973 | 852 | 51,485,167 | 159 | 292 | 

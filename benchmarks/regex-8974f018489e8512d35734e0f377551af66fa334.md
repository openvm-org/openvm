...
| `total_proof_time_ms ` |  3,845.50 |  7,691 |  4,453 |  3,238 |
...
| `trace_gen_time_ms   ` |  960 |  1,920 |  1,169 |  751 |
| `stark_prove_excluding_trace_time_ms` |  2,547 |  5,094 |  2,908 |  2,186 |
| `main_trace_commit_time_ms` |  445 |  890 |  523 |  367 |
| `generate_perm_trace_time_ms` |  155 |  310 |  177 |  133 |
| `perm_trace_commit_time_ms` |  639.50 |  1,279 |  747 |  532 |
| `quotient_poly_compute_time_ms` |  362.50 |  725 |  425 |  300 |
| `quotient_poly_commit_time_ms` |  269.50 |  539 |  315 |  224 |
| `pcs_opening_time_ms ` |  666 |  1,332 |  711 |  621 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,507 |  15,014 |  7,602 |  7,412 |
| `main_cells_used     ` |  152,306,777 |  304,613,554 |  154,766,443 |  149,847,111 |
| `total_cycles        ` |  1,993,410 |  3,986,820 |  2,024,315 |  1,962,505 |
| `execute_time_ms     ` |  763 |  1,526 |  770 |  756 |
| `trace_gen_time_ms   ` |  1,500 |  3,000 |  1,524 |  1,476 |
| `stark_prove_excluding_trace_time_ms` |  5,244 |  10,488 |  5,308 |  5,180 |
| `main_trace_commit_time_ms` |  891 |  1,782 |  893 |  889 |
| `generate_perm_trace_time_ms` |  345.50 |  691 |  349 |  342 |
| `perm_trace_commit_time_ms` |  1,648 |  3,296 |  1,679 |  1,617 |
| `quotient_poly_compute_time_ms` |  762 |  1,524 |  766 |  758 |
| `quotient_poly_commit_time_ms` |  518.50 |  1,037 |  520 |  517 |
| `pcs_opening_time_ms ` |  1,075 |  2,150 |  1,100 |  1,050 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,524 | 7,602 | 2,024,315 | 533,941,738 | 5,308 | 766 | 517 | 1,679 | 1,100 | 893 | 154,766,443 | 349 | 770 | 
| leaf | 1 | 1,476 | 7,412 | 1,962,505 | 533,941,738 | 5,180 | 758 | 520 | 1,617 | 1,050 | 889 | 149,847,111 | 342 | 756 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,169 | 4,453 | 2,225,434 | 275,652,919 | 2,908 | 425 | 315 | 747 | 711 | 523 | 93,699,990 | 177 | 376 | 
| regex_program | 1 | 751 | 3,238 | 1,914,730 | 198,099,628 | 2,186 | 300 | 224 | 532 | 621 | 367 | 73,689,460 | 133 | 301 | 

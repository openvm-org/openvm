...
| `total_proof_time_ms ` |  3,966.50 |  7,933 |  4,437 |  3,496 |
...
| `trace_gen_time_ms   ` |  970 |  1,940 |  1,166 |  774 |
| `stark_prove_excluding_trace_time_ms` |  2,639 |  5,278 |  2,874 |  2,404 |
| `main_trace_commit_time_ms` |  500 |  1,000 |  556 |  444 |
| `generate_perm_trace_time_ms` |  229 |  458 |  248 |  210 |
| `perm_trace_commit_time_ms` |  577.50 |  1,155 |  635 |  520 |
| `quotient_poly_compute_time_ms` |  266.50 |  533 |  289 |  244 |
| `quotient_poly_commit_time_ms` |  245 |  490 |  283 |  207 |
| `pcs_opening_time_ms ` |  813 |  1,626 |  856 |  770 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,002.50 |  14,005 |  7,074 |  6,931 |
| `main_cells_used     ` |  151,828,061 |  303,656,122 |  154,227,974 |  149,428,148 |
| `total_cycles        ` |  1,975,745 |  3,951,490 |  2,006,577 |  1,944,913 |
| `execute_time_ms     ` |  774 |  1,548 |  783 |  765 |
| `trace_gen_time_ms   ` |  1,486.50 |  2,973 |  1,514 |  1,459 |
| `stark_prove_excluding_trace_time_ms` |  4,742 |  9,484 |  4,777 |  4,707 |
| `main_trace_commit_time_ms` |  866 |  1,732 |  868 |  864 |
| `generate_perm_trace_time_ms` |  391 |  782 |  415 |  367 |
| `perm_trace_commit_time_ms` |  1,255.50 |  2,511 |  1,270 |  1,241 |
| `quotient_poly_compute_time_ms` |  523 |  1,046 |  525 |  521 |
| `quotient_poly_commit_time_ms` |  414 |  828 |  416 |  412 |
| `pcs_opening_time_ms ` |  1,287.50 |  2,575 |  1,290 |  1,285 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,514 | 7,074 | 2,006,577 | 538,660,330 | 4,777 | 521 | 416 | 1,270 | 1,285 | 864 | 154,227,974 | 415 | 783 | 
| leaf | 1 | 1,459 | 6,931 | 1,944,913 | 538,660,330 | 4,707 | 525 | 412 | 1,241 | 1,290 | 868 | 149,428,148 | 367 | 765 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,166 | 4,437 | 2,243,715 | 275,652,919 | 2,874 | 289 | 283 | 635 | 856 | 556 | 93,500,799 | 248 | 397 | 
| regex_program | 1 | 774 | 3,496 | 1,921,511 | 242,975,404 | 2,404 | 244 | 207 | 520 | 770 | 444 | 73,010,353 | 210 | 318 | 

...
| `total_proof_time_ms ` |  3,879 |  7,758 |  4,486 |  3,272 |
...
| `trace_gen_time_ms   ` |  960 |  1,920 |  1,153 |  767 |
| `stark_prove_excluding_trace_time_ms` |  2,580.50 |  5,161 |  2,957 |  2,204 |
| `main_trace_commit_time_ms` |  451 |  902 |  534 |  368 |
| `generate_perm_trace_time_ms` |  163.50 |  327 |  183 |  144 |
| `perm_trace_commit_time_ms` |  646.50 |  1,293 |  747 |  546 |
| `quotient_poly_compute_time_ms` |  363 |  726 |  420 |  306 |
| `quotient_poly_commit_time_ms` |  275 |  550 |  323 |  227 |
| `pcs_opening_time_ms ` |  673 |  1,346 |  741 |  605 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,311.50 |  14,623 |  7,372 |  7,251 |
| `main_cells_used     ` |  152,709,387.50 |  305,418,775 |  155,168,519 |  150,250,256 |
| `total_cycles        ` |  1,990,977 |  3,981,954 |  2,021,771 |  1,960,183 |
| `execute_time_ms     ` |  755.50 |  1,511 |  764 |  747 |
| `trace_gen_time_ms   ` |  1,503.50 |  3,007 |  1,520 |  1,487 |
| `stark_prove_excluding_trace_time_ms` |  5,052.50 |  10,105 |  5,088 |  5,017 |
| `main_trace_commit_time_ms` |  806 |  1,612 |  809 |  803 |
| `generate_perm_trace_time_ms` |  366.50 |  733 |  374 |  359 |
| `perm_trace_commit_time_ms` |  1,565 |  3,130 |  1,586 |  1,544 |
| `quotient_poly_compute_time_ms` |  767.50 |  1,535 |  771 |  764 |
| `quotient_poly_commit_time_ms` |  493 |  986 |  493 |  493 |
| `pcs_opening_time_ms ` |  1,049.50 |  2,099 |  1,050 |  1,049 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,520 | 7,372 | 2,021,771 | 538,660,330 | 5,088 | 771 | 493 | 1,586 | 1,050 | 809 | 155,168,519 | 374 | 764 | 
| leaf | 1 | 1,487 | 7,251 | 1,960,183 | 538,660,330 | 5,017 | 764 | 493 | 1,544 | 1,049 | 803 | 150,250,256 | 359 | 747 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,153 | 4,486 | 2,225,434 | 275,652,919 | 2,957 | 420 | 323 | 747 | 741 | 534 | 93,738,635 | 183 | 376 | 
| regex_program | 1 | 767 | 3,272 | 1,914,993 | 198,099,628 | 2,204 | 306 | 227 | 546 | 605 | 368 | 73,709,236 | 144 | 301 | 

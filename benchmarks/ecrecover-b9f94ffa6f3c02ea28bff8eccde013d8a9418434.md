...
| `execute_metered_insn_mi/s` |  21.72 | -          |  21.72 |  21.72 |
...
| `perm_trace_commit_time_ms` |  38.69 |  38.69 |  38.69 |  38.69 |
| `quotient_poly_compute_time_ms` |  199.82 |  199.82 |  199.82 |  199.82 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  4,029 |  4,029 |  4,029 |  4,029 |
| `main_cells_used     ` |  29,404,728 |  29,404,728 |  29,404,728 |  29,404,728 |
| `total_cells_used    ` |  71,174,330 |  71,174,330 |  71,174,330 |  71,174,330 |
| `execute_preflight_insns` |  2,934,884 |  2,934,884 |  2,934,884 |  2,934,884 |
| `execute_preflight_time_ms` |  425 |  425 |  425 |  425 |
| `execute_preflight_insn_mi/s` |  7.37 | -          |  7.37 |  7.37 |
| `trace_gen_time_ms   ` |  234 |  234 |  234 |  234 |
| `memory_finalize_time_ms` |  22 |  22 |  22 |  22 |
| `stark_prove_excluding_trace_time_ms` |  3,368 |  3,368 |  3,368 |  3,368 |
| `main_trace_commit_time_ms` |  403 |  403 |  403 |  403 |
| `generate_perm_trace_time_ms` |  177 |  177 |  177 |  177 |
| `perm_trace_commit_time_ms` |  712.38 |  712.38 |  712.38 |  712.38 |
| `quotient_poly_compute_time_ms` |  440.48 |  440.48 |  440.48 |  440.48 |
| `quotient_poly_commit_time_ms` |  109.43 |  109.43 |  109.43 |  109.43 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program |  | 962 |  | 40 | 1 | 6 | 140,497 | 21.72 | 141 | 
| leaf | 4,032 |  | 1 |  | 1 |  |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 234 | 4,029 | 71,174,330 | 992,054,762 | 234 | 3,368 | 0 | 440.48 | 109.43 | 5 | 712.38 | 1,520 | 890 | 1,520 | 22 | 403 | 29,404,728 | 177 | 425 | 2,934,884 | 7.37 | 131 | 553 | 2 | 1,520 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 336 | 962 | 11,359,780 | 32,927,986 | 336 | 440 | 0 | 199.82 | 10.11 | 8 | 38.69 | 68 | 115 | 67 | 0 | 41 | 2,275,066 | 70 | 60 | 140,497 | 2.51 | 21 | 215 | 4 | 67 | 

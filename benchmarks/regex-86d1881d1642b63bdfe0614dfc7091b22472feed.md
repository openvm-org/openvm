...
| `total_proof_time_ms ` |  6,866 |  13,732 |  7,722 |  6,010 |
| `main_cells_used     ` |  82,727,686.50 |  165,455,373 |  92,686,348 |  72,769,025 |
| `total_cycles        ` |  1,914,103 |  1,914,103 |  1,914,103 |  1,914,103 |
| `execute_time_ms     ` |  440 |  880 |  471 |  409 |
| `trace_gen_time_ms   ` |  1,086.50 |  2,173 |  1,238 |  935 |
| `stark_prove_excluding_trace_time_ms` |  5,339.50 |  10,679 |  6,013 |  4,666 |
| `main_trace_commit_time_ms` |  1,028.50 |  2,057 |  1,251 |  806 |
| `generate_perm_trace_time_ms` |  173 |  346 |  192 |  154 |
| `perm_trace_commit_time_ms` |  1,123.50 |  2,247 |  1,196 |  1,051 |
| `quotient_poly_compute_time_ms` |  740 |  1,480 |  854 |  626 |
| `quotient_poly_commit_time_ms` |  947.50 |  1,895 |  1,091 |  804 |
| `pcs_opening_time_ms ` |  1,316 |  2,632 |  1,419 |  1,213 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  8,052.50 |  16,105 |  8,292 |  7,813 |
| `main_cells_used     ` |  77,286,962 |  154,573,924 |  78,374,999 |  76,198,925 |
| `total_cycles        ` |  1,028,186 |  2,056,372 |  1,045,599 |  1,010,773 |
| `execute_time_ms     ` |  379 |  758 |  408 |  350 |
| `trace_gen_time_ms   ` |  1,163 |  2,326 |  1,231 |  1,095 |
| `stark_prove_excluding_trace_time_ms` |  6,510.50 |  13,021 |  6,789 |  6,232 |
| `main_trace_commit_time_ms` |  1,332 |  2,664 |  1,386 |  1,278 |
| `generate_perm_trace_time_ms` |  161 |  322 |  173 |  149 |
| `perm_trace_commit_time_ms` |  1,310 |  2,620 |  1,354 |  1,266 |
| `quotient_poly_compute_time_ms` |  987.50 |  1,975 |  1,044 |  931 |
| `quotient_poly_commit_time_ms` |  1,252.50 |  2,505 |  1,306 |  1,199 |
| `pcs_opening_time_ms ` |  1,463.50 |  2,927 |  1,522 |  1,405 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,095 | 8,292 | 1,045,599 | 220,669,656 | 6,789 | 1,044 | 1,306 | 1,354 | 1,522 | 1,386 | 78,374,999 | 173 | 408 | 
| leaf | 1 | 1,231 | 7,813 | 1,010,773 | 194,986,968 | 6,232 | 931 | 1,199 | 1,266 | 1,405 | 1,278 | 76,198,925 | 149 | 350 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,238 | 7,722 |  | 209,921,543 | 6,013 | 854 | 1,091 | 1,196 | 1,419 | 1,251 | 92,686,348 | 192 | 471 | 
| regex_program | 1 | 935 | 6,010 | 1,914,103 | 149,454,692 | 4,666 | 626 | 804 | 1,051 | 1,213 | 806 | 72,769,025 | 154 | 409 | 

...
| `stark_prove_excluding_trace_time_ms` |  2,145 |  2,145 |  2,145 |  2,145 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  16,280 |  16,280 |  16,280 |  16,280 |
| `main_cells_used     ` |  169,241,827 |  169,241,827 |  169,241,827 |  169,241,827 |
| `total_cycles        ` |  3,521,424 |  3,521,424 |  3,521,424 |  3,521,424 |
| `execute_time_ms     ` |  941 |  941 |  941 |  941 |
| `trace_gen_time_ms   ` |  2,524 |  2,524 |  2,524 |  2,524 |
| `stark_prove_excluding_trace_time_ms` |  12,815 |  12,815 |  12,815 |  12,815 |
| `main_trace_commit_time_ms` |  2,709 |  2,709 |  2,709 |  2,709 |
| `generate_perm_trace_time_ms` |  340 |  340 |  340 |  340 |
| `perm_trace_commit_time_ms` |  2,721 |  2,721 |  2,721 |  2,721 |
| `quotient_poly_compute_time_ms` |  1,910 |  1,910 |  1,910 |  1,910 |
| `quotient_poly_commit_time_ms` |  2,385 |  2,385 |  2,385 |  2,385 |
| `pcs_opening_time_ms ` |  2,745 |  2,745 |  2,745 |  2,745 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 2,524 | 16,280 | 3,521,424 | 431,539,160 | 12,815 | 1,910 | 2,385 | 2,721 | 2,745 | 2,709 | 169,241,827 | 340 | 941 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 215 | 2,509 | 284,567 | 38,417,467 | 2,145 | 224 | 475 | 350 | 654 | 394 | 15,055,723 | 35 | 149 | 

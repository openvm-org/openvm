...
| `total_proof_time_ms ` |  504 |  1,008 |  580 |  428 |
...
| `execute_preflight_insn_mi/s` |  36.52 | -          |  38.27 |  34.78 |
| `trace_gen_time_ms   ` |  187 |  374 |  191 |  183 |
| `memory_finalize_time_ms` | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  194.50 |  389 |  219 |  170 |
| `main_trace_commit_time_ms` |  30 |  60 |  32 |  28 |
| `generate_perm_trace_time_ms` |  18.50 |  37 |  20 |  17 |
| `perm_trace_commit_time_ms` |  40.93 |  81.87 |  43.71 |  38.16 |
| `quotient_poly_compute_time_ms` |  30.75 |  61.50 |  34.15 |  27.35 |
| `quotient_poly_commit_time_ms` |  11.53 |  23.06 |  11.98 |  11.08 |
| `pcs_opening_time_ms ` |  60.50 |  121 |  78 |  43 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  978.50 |  1,957 |  1,226 |  731 |
| `main_cells_used     ` |  6,475,562 |  12,951,124 |  6,608,072 |  6,343,052 |
| `total_cells_used    ` |  17,568,644 |  35,137,288 |  17,887,054 |  17,250,234 |
| `execute_preflight_insns` |  1,190,370.50 |  2,380,741 |  1,229,562 |  1,151,179 |
| `execute_preflight_time_ms` |  494 |  988 |  786 |  202 |
| `execute_preflight_insn_mi/s` |  6.78 | -          |  6.79 |  6.76 |
| `trace_gen_time_ms   ` |  57.50 |  115 |  62 |  53 |
| `memory_finalize_time_ms` |  5.50 |  11 |  6 |  5 |
| `stark_prove_excluding_trace_time_ms` |  426.50 |  853 |  466 |  387 |
| `main_trace_commit_time_ms` |  82.50 |  165 |  90 |  75 |
| `generate_perm_trace_time_ms` |  31 |  62 |  34 |  28 |
| `perm_trace_commit_time_ms` |  122.100 |  245.100 |  139.79 |  106.21 |
| `quotient_poly_compute_time_ms` |  89.35 |  178.71 |  96.90 |  81.80 |
| `quotient_poly_commit_time_ms` |  21.32 |  42.64 |  23.26 |  19.39 |
| `pcs_opening_time_ms ` |  76 |  152 |  79 |  73 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program |  | 428 |  | 1 | 13 | 1,500,209 | 113.40 | 0 | 
| leaf | 1,228 |  | 1 | 1 |  |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 62 | 731 | 17,887,054 | 252,878,314 | 61 | 466 | 0 | 96.90 | 23.26 | 4 | 139.79 | 79 | 175 | 79 | 6 | 90 | 6,608,072 | 34 | 202 | 1,229,562 | 6.79 | 25 | 121 | 0 | 79 | 
| leaf | 1 | 53 | 1,226 | 17,250,234 | 207,789,546 | 53 | 387 | 0 | 81.80 | 19.39 | 4 | 106.21 | 73 | 135 | 73 | 5 | 75 | 6,343,052 | 28 | 786 | 1,151,179 | 6.76 | 22 | 102 | 0 | 73 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 191 | 580 | 9,677,708 | 84,395,212 | 191 | 219 | 0 | 34.15 | 11.98 | 4 | 43.71 | 78 | 61 | 77 | 0 | 32 | 1,035,986 | 17 | 25 | 873,000 | 34.78 | 13 | 46 | 0 | 77 | 
| fibonacci_program | 1 | 183 | 428 | 9,708,170 | 74,305,770 | 183 | 170 | 1 | 27.35 | 11.08 | 4 | 38.16 | 43 | 59 | 43 | 0 | 28 | 1,064,416 | 20 | 33 | 627,209 | 38.27 | 11 | 38 | 0 | 43 | 

...
| `total_proof_time_ms ` |  491.50 |  983 |  554 |  429 |
...
| `execute_metered_insn_mi/s` |  147.82 | -          |  147.82 |  147.82 |
| `execute_preflight_insns` |  750,104.50 |  1,500,209 |  873,000 |  627,209 |
| `execute_preflight_time_ms` |  29.50 |  59 |  33 |  26 |
| `execute_preflight_insn_mi/s` |  35.32 | -          |  36.69 |  33.95 |
| `trace_gen_time_ms   ` |  188 |  376 |  193 |  183 |
| `memory_finalize_time_ms` | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  181 |  362 |  191 |  171 |
| `main_trace_commit_time_ms` |  30.50 |  61 |  33 |  28 |
| `generate_perm_trace_time_ms` |  24 |  48 |  28 |  20 |
| `perm_trace_commit_time_ms` |  40.98 |  81.97 |  43.64 |  38.33 |
| `quotient_poly_compute_time_ms` |  30.04 |  60.08 |  31.37 |  28.70 |
| `quotient_poly_commit_time_ms` |  11.81 |  23.63 |  12.64 |  10.98 |
| `pcs_opening_time_ms ` |  42 |  84 |  43 |  41 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,011.50 |  2,023 |  1,264 |  759 |
...
| `execute_preflight_time_ms` |  501.50 |  1,003 |  800 |  203 |
| `execute_preflight_insn_mi/s` |  6.72 | -          |  6.73 |  6.71 |
| `trace_gen_time_ms   ` |  57 |  114 |  61 |  53 |
| `memory_finalize_time_ms` |  5 |  10 |  5 |  5 |
| `stark_prove_excluding_trace_time_ms` |  452 |  904 |  494 |  410 |
| `main_trace_commit_time_ms` |  82.50 |  165 |  90 |  75 |
| `generate_perm_trace_time_ms` |  38.50 |  77 |  50 |  27 |
| `perm_trace_commit_time_ms` |  123.81 |  247.61 |  141.27 |  106.35 |
| `quotient_poly_compute_time_ms` |  89.27 |  178.54 |  98.71 |  79.83 |
| `quotient_poly_commit_time_ms` |  21.18 |  42.36 |  23.12 |  19.24 |
| `pcs_opening_time_ms ` |  93.50 |  187 |  99 |  88 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program |  | 429 |  | 66 | 1 | 10 | 1,500,209 | 147.82 | 169 | 
| leaf | 1,265 |  | 1 |  | 1 |  |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 61 | 759 | 17,887,054 | 252,878,314 | 61 | 494 | 0 | 98.71 | 23.12 | 4 | 141.27 | 88 | 192 | 87 | 5 | 90 | 6,608,072 | 50 | 203 | 1,229,581 | 6.73 | 25 | 122 | 0 | 87 | 
| leaf | 1 | 53 | 1,264 | 17,250,234 | 207,789,546 | 53 | 410 | 0 | 79.83 | 19.24 | 4 | 106.35 | 99 | 134 | 99 | 5 | 75 | 6,343,052 | 27 | 800 | 1,151,179 | 6.71 | 22 | 99 | 0 | 99 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 193 | 554 | 9,677,708 | 84,395,212 | 193 | 191 | 0 | 31.37 | 12.64 | 4 | 43.64 | 41 | 72 | 41 | 0 | 33 | 1,035,986 | 28 | 26 | 873,000 | 33.95 | 14 | 44 | 0 | 41 | 
| fibonacci_program | 1 | 183 | 429 | 9,708,170 | 74,305,770 | 183 | 171 | 1 | 28.70 | 10.98 | 4 | 38.33 | 43 | 59 | 43 | 0 | 28 | 1,064,416 | 20 | 33 | 627,209 | 36.69 | 11 | 40 | 0 | 42 | 

...
| `total_proof_time_ms ` |  729.50 |  1,459 |  825 |  634 |
...
| `execute_preflight_insn_mi/s` |  13.45 | -          |  17.86 |  9.03 |
| `trace_gen_time_ms   ` |  182 |  364 |  199 |  165 |
| `memory_finalize_time_ms` | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  358 |  716 |  383 |  333 |
| `main_trace_commit_time_ms` |  66 |  132 |  76 |  56 |
| `generate_perm_trace_time_ms` |  52 |  104 |  65 |  39 |
| `perm_trace_commit_time_ms` |  77.43 |  154.86 |  89.99 |  64.87 |
| `quotient_poly_compute_time_ms` |  81.57 |  163.15 |  89.75 |  73.40 |
| `quotient_poly_commit_time_ms` |  16.41 |  32.83 |  17.88 |  14.94 |
| `pcs_opening_time_ms ` |  59 |  118 |  64 |  54 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,465.50 |  2,931 |  1,717 |  1,214 |
| `main_cells_used     ` |  16,200,472 |  32,400,944 |  16,332,746 |  16,068,198 |
| `total_cells_used    ` |  39,332,920 |  78,665,840 |  39,650,868 |  39,014,972 |
| `execute_preflight_insns` |  1,952,365.50 |  3,904,731 |  1,991,895 |  1,912,836 |
| `execute_preflight_time_ms` |  583 |  1,166 |  869 |  297 |
| `execute_preflight_insn_mi/s` |  7.56 | -          |  7.57 |  7.54 |
| `trace_gen_time_ms   ` |  121.50 |  243 |  130 |  113 |
| `memory_finalize_time_ms` |  10.50 |  21 |  11 |  10 |
| `stark_prove_excluding_trace_time_ms` |  759 |  1,518 |  785 |  733 |
| `main_trace_commit_time_ms` |  149 |  298 |  153 |  145 |
| `generate_perm_trace_time_ms` |  56.50 |  113 |  61 |  52 |
| `perm_trace_commit_time_ms` |  230.92 |  461.84 |  235.71 |  226.13 |
| `quotient_poly_compute_time_ms` |  173 |  346.01 |  175.47 |  170.54 |
| `quotient_poly_commit_time_ms` |  33.40 |  66.81 |  34.59 |  32.22 |
| `pcs_opening_time_ms ` |  112 |  224 |  121 |  103 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 1,719 |  | 1 |  | 1 |  |  |  |  | 
| pairing |  | 634 |  | 40 | 1 | 90 | 1,745,742 | 19.32 | 145 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 130 | 1,214 | 39,650,868 | 410,701,290 | 130 | 785 | 0 | 175.47 | 34.59 | 4 | 235.71 | 121 | 298 | 121 | 11 | 153 | 16,332,746 | 61 | 297 | 1,991,895 | 7.54 | 39 | 211 | 0 | 121 | 
| leaf | 1 | 113 | 1,717 | 39,014,972 | 396,840,426 | 113 | 733 | 0 | 170.54 | 32.22 | 4 | 226.13 | 103 | 279 | 103 | 10 | 145 | 16,068,198 | 52 | 869 | 1,912,836 | 7.57 | 38 | 204 | 0 | 103 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 165 | 825 | 32,689,110 | 172,558,444 | 165 | 383 | 0 | 89.75 | 17.88 | 6 | 89.99 | 64 | 133 | 64 | 0 | 76 | 16,059,916 | 39 | 131 | 1,157,000 | 9.03 | 26 | 108 | 1 | 64 | 
| pairing | 1 | 199 | 634 | 22,314,288 | 119,958,502 | 199 | 333 | 1 | 73.40 | 14.94 | 5 | 64.87 | 54 | 133 | 54 | 0 | 56 | 9,408,294 | 65 | 60 | 588,742 | 17.86 | 21 | 88 | 1 | 54 | 

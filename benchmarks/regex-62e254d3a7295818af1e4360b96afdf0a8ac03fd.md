...
| `total_proof_time_ms ` |  3,835 |  7,670 |  4,878 |  2,792 |
...
| `execute_preflight_insn_mi/s` |  28.32 | -          |  30.66 |  25.99 |
| `trace_gen_time_ms   ` |  388.50 |  777 |  497 |  280 |
| `memory_finalize_time_ms` |  7.50 |  15 |  13 |  2 |
| `stark_prove_excluding_trace_time_ms` |  3,126.50 |  6,253 |  4,040 |  2,213 |
| `main_trace_commit_time_ms` |  627.50 |  1,255 |  840 |  415 |
| `generate_perm_trace_time_ms` |  232 |  464 |  305 |  159 |
| `perm_trace_commit_time_ms` |  668.50 |  1,337 |  851 |  486 |
| `quotient_poly_compute_time_ms` |  322.50 |  645 |  430 |  215 |
| `quotient_poly_commit_time_ms` |  306 |  612 |  403 |  209 |
| `pcs_opening_time_ms ` |  960.50 |  1,921 |  1,204 |  717 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  5,724 |  11,448 |  6,866 |  4,582 |
| `main_cells_used     ` |  122,269,959 |  244,539,918 |  153,709,436 |  90,830,482 |
| `total_cells_used    ` |  304,358,781 |  608,717,562 |  391,463,202 |  217,254,360 |
| `execute_preflight_insns` |  1,663,338 |  3,326,676 |  1,830,073 |  1,496,603 |
| `execute_preflight_time_ms` |  597 |  1,194 |  756 |  438 |
| `execute_preflight_insn_mi/s` |  4.27 | -          |  4.43 |  4.10 |
| `trace_gen_time_ms   ` |  299 |  598 |  370 |  228 |
| `memory_finalize_time_ms` |  11.50 |  23 |  14 |  9 |
| `stark_prove_excluding_trace_time_ms` |  3,804 |  7,608 |  4,722 |  2,886 |
| `main_trace_commit_time_ms` |  706 |  1,412 |  839 |  573 |
| `generate_perm_trace_time_ms` |  327 |  654 |  423 |  231 |
| `perm_trace_commit_time_ms` |  979 |  1,958 |  1,248 |  710 |
| `quotient_poly_compute_time_ms` |  414.50 |  829 |  525 |  304 |
| `quotient_poly_commit_time_ms` |  322 |  644 |  379 |  265 |
| `pcs_opening_time_ms ` |  1,050 |  2,100 |  1,305 |  795 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 6,868 |  | 1 |  | 1 |  |  |  |  | 
| regex_program |  | 2,792 |  | 6 | 1 | 31 | 4,108,597 | 128.93 | 44 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 228 | 4,582 | 217,254,360 | 319,626,730 | 228 | 2,886 | 0 | 304 | 265 | 710 | 795 | 9 | 573 | 90,830,482 | 231 | 438 | 1,496,603 | 4.10 | 
| leaf | 1 | 370 | 6,866 | 391,463,202 | 538,660,330 | 370 | 4,722 | 0 | 525 | 379 | 1,248 | 1,305 | 14 | 839 | 153,709,436 | 423 | 756 | 1,830,073 | 4.43 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 497 | 4,878 | 211,758,557 | 373,183,036 | 497 | 4,040 | 0 | 430 | 403 | 851 | 1,204 | 7 | 13 | 840 | 91,281,687 | 305 | 103 | 2,211,000 | 25.99 | 
| regex_program | 1 | 280 | 2,792 | 174,326,267 | 196,838,026 | 280 | 2,213 | 52 | 215 | 209 | 486 | 717 | 8 | 2 | 415 | 73,453,305 | 159 | 88 | 1,897,597 | 30.66 | 

...
| `total_proof_time_ms ` |  6,970 |  13,940 |  7,870 |  6,070 |
...
| `trace_gen_time_ms   ` |  1,270.50 |  2,541 |  1,318 |  1,223 |
| `stark_prove_excluding_trace_time_ms` |  5,310.50 |  10,621 |  6,079 |  4,542 |
| `main_trace_commit_time_ms` |  1,144 |  2,288 |  1,321 |  967 |
| `generate_perm_trace_time_ms` |  179.50 |  359 |  189 |  170 |
| `perm_trace_commit_time_ms` |  1,027 |  2,054 |  1,171 |  883 |
| `quotient_poly_compute_time_ms` |  753 |  1,506 |  886 |  620 |
| `quotient_poly_commit_time_ms` |  920.50 |  1,841 |  1,072 |  769 |
| `pcs_opening_time_ms ` |  1,275.50 |  2,551 |  1,429 |  1,122 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  8,327.50 |  16,655 |  8,360 |  8,295 |
| `main_cells_used     ` |  86,869,716.50 |  173,739,433 |  88,129,654 |  85,609,779 |
| `total_cycles        ` |  1,451,210 |  2,902,420 |  1,475,906 |  1,426,514 |
| `execute_time_ms     ` |  453.50 |  907 |  498 |  409 |
| `trace_gen_time_ms   ` |  1,263 |  2,526 |  1,313 |  1,213 |
| `stark_prove_excluding_trace_time_ms` |  6,611 |  13,222 |  6,638 |  6,584 |
| `main_trace_commit_time_ms` |  1,321 |  2,642 |  1,322 |  1,320 |
| `generate_perm_trace_time_ms` |  186 |  372 |  187 |  185 |
| `perm_trace_commit_time_ms` |  1,346 |  2,692 |  1,346 |  1,346 |
| `quotient_poly_compute_time_ms` |  1,079 |  2,158 |  1,080 |  1,078 |
| `quotient_poly_commit_time_ms` |  1,336.50 |  2,673 |  1,352 |  1,321 |
| `pcs_opening_time_ms ` |  1,336 |  2,672 |  1,348 |  1,324 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,213 | 8,295 | 1,475,906 | 225,774,050 | 6,584 | 1,080 | 1,321 | 1,346 | 1,324 | 1,320 | 88,129,654 | 185 | 498 | 
| leaf | 1 | 1,313 | 8,360 | 1,426,514 | 225,774,050 | 6,638 | 1,078 | 1,352 | 1,346 | 1,348 | 1,322 | 85,609,779 | 187 | 409 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,318 | 7,870 | 2,225,434 | 210,931,487 | 6,079 | 886 | 1,072 | 1,171 | 1,429 | 1,321 | 93,699,990 | 189 | 473 | 
| regex_program | 1 | 1,223 | 6,070 | 1,914,730 | 150,470,512 | 4,542 | 620 | 769 | 883 | 1,122 | 967 | 73,689,460 | 170 | 305 | 

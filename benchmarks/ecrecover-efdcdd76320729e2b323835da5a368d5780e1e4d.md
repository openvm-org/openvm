...
| `execute_time_ms     ` |  1,127 |  1,127 |  1,127 |  1,127 |
| `trace_gen_time_ms   ` |  2,314 |  2,314 |  2,314 |  2,314 |
| `stark_prove_excluding_trace_time_ms` |  9,368 |  9,368 |  9,368 |  9,368 |
| `main_trace_commit_time_ms` |  1,628 |  1,628 |  1,628 |  1,628 |
| `generate_perm_trace_time_ms` |  678 |  678 |  678 |  678 |
| `perm_trace_commit_time_ms` |  3,021 |  3,021 |  3,021 |  3,021 |
| `quotient_poly_compute_time_ms` |  1,334 |  1,334 |  1,334 |  1,334 |
| `quotient_poly_commit_time_ms` |  843 |  843 |  843 |  843 |
| `pcs_opening_time_ms ` |  1,858 |  1,858 |  1,858 |  1,858 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 2,314 | 12,809 | 2,989,561 | 999,656,938 | 9,368 | 1,334 | 843 | 3,021 | 1,858 | 1,628 | 244,318,710 | 678 | 1,127 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 180 | 1,457 | 295,181 | 48,197,161 | 1,127 | 126 | 164 | 201 | 405 | 183 | 15,586,346 | 31 | 150 | 

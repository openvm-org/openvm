...
| `total_proof_time_ms ` |  2,603 |  2,603 |  2,603 |  2,603 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  21,609 |  21,609 |  21,609 |  21,609 |
| `main_cells_used     ` |  241,408,809 |  241,408,809 |  241,408,809 |  241,408,809 |
| `total_cycles        ` |  4,166,571 |  4,166,571 |  4,166,571 |  4,166,571 |
| `execute_time_ms     ` |  927 |  927 |  927 |  927 |
| `trace_gen_time_ms   ` |  3,872 |  3,872 |  3,872 |  3,872 |
| `stark_prove_excluding_trace_time_ms` |  16,810 |  16,810 |  16,810 |  16,810 |
| `main_trace_commit_time_ms` |  2,991 |  2,991 |  2,991 |  2,991 |
| `generate_perm_trace_time_ms` |  413 |  413 |  413 |  413 |
| `perm_trace_commit_time_ms` |  3,603 |  3,603 |  3,603 |  3,603 |
| `quotient_poly_compute_time_ms` |  4,430 |  4,430 |  4,430 |  4,430 |
| `quotient_poly_commit_time_ms` |  2,401 |  2,401 |  2,401 |  2,401 |
| `pcs_opening_time_ms ` |  2,969 |  2,969 |  2,969 |  2,969 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 3,872 | 21,609 | 4,166,571 | 590,040,024 | 16,810 | 4,430 | 2,401 | 3,603 | 2,969 | 2,991 | 241,408,809 | 413 | 927 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 261 | 2,603 | 285,401 | 56,172,159 | 2,197 | 296 | 318 | 528 | 623 | 390 | 15,075,033 | 39 | 145 | 

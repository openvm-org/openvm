...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  14,011 |  14,011 |  14,011 |  14,011 |
| `main_cells_used     ` |  274,877,120 |  274,877,120 |  274,877,120 |  274,877,120 |
| `total_cycles        ` |  3,301,931 |  3,301,931 |  3,301,931 |  3,301,931 |
| `execute_time_ms     ` |  1,200 |  1,200 |  1,200 |  1,200 |
| `trace_gen_time_ms   ` |  2,570 |  2,570 |  2,570 |  2,570 |
| `stark_prove_excluding_trace_time_ms` |  10,241 |  10,241 |  10,241 |  10,241 |
| `main_trace_commit_time_ms` |  1,774 |  1,774 |  1,774 |  1,774 |
| `generate_perm_trace_time_ms` |  719 |  719 |  719 |  719 |
| `perm_trace_commit_time_ms` |  3,344 |  3,344 |  3,344 |  3,344 |
| `quotient_poly_compute_time_ms` |  1,464 |  1,464 |  1,464 |  1,464 |
| `quotient_poly_commit_time_ms` |  972 |  972 |  972 |  972 |
| `pcs_opening_time_ms ` |  1,962 |  1,962 |  1,962 |  1,962 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 2,570 | 14,011 | 3,301,931 | 1,071,746,538 | 10,241 | 1,464 | 972 | 3,344 | 1,962 | 1,774 | 274,877,120 | 719 | 1,200 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 884 | 4,704 | 1,711,640 | 297,186,413 | 3,147 | 468 | 338 | 774 | 757 | 597 | 92,585,975 | 196 | 673 | 

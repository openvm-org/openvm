...
| `total_proof_time_ms ` |  4,109.50 |  8,219 |  4,584 |  3,635 |
| `main_cells_used     ` |  83,255,576 |  166,511,152 |  93,500,799 |  73,010,353 |
| `total_cycles        ` |  2,082,613 |  4,165,226 |  2,243,715 |  1,921,511 |
| `execute_time_ms     ` |  335 |  670 |  373 |  297 |
| `trace_gen_time_ms   ` |  1,033.50 |  2,067 |  1,221 |  846 |
| `stark_prove_excluding_trace_time_ms` |  2,741 |  5,482 |  2,990 |  2,492 |
| `main_trace_commit_time_ms` |  468 |  936 |  526 |  410 |
| `generate_perm_trace_time_ms` |  189.50 |  379 |  206 |  173 |
| `perm_trace_commit_time_ms` |  694.50 |  1,389 |  749 |  640 |
| `quotient_poly_compute_time_ms` |  393 |  786 |  422 |  364 |
| `quotient_poly_commit_time_ms` |  281 |  562 |  317 |  245 |
| `pcs_opening_time_ms ` |  705.50 |  1,411 |  760 |  651 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,363 |  14,726 |  7,414 |  7,312 |
| `main_cells_used     ` |  152,277,847 |  304,555,694 |  154,677,190 |  149,878,504 |
| `total_cycles        ` |  1,990,998.50 |  3,981,997 |  2,021,783 |  1,960,214 |
| `execute_time_ms     ` |  780 |  1,560 |  787 |  773 |
| `trace_gen_time_ms   ` |  1,519 |  3,038 |  1,533 |  1,505 |
| `stark_prove_excluding_trace_time_ms` |  5,064 |  10,128 |  5,094 |  5,034 |
| `main_trace_commit_time_ms` |  807 |  1,614 |  810 |  804 |
| `generate_perm_trace_time_ms` |  371 |  742 |  381 |  361 |
| `perm_trace_commit_time_ms` |  1,538.50 |  3,077 |  1,573 |  1,504 |
| `quotient_poly_compute_time_ms` |  774 |  1,548 |  780 |  768 |
| `quotient_poly_commit_time_ms` |  493 |  986 |  494 |  492 |
| `pcs_opening_time_ms ` |  1,076.50 |  2,153 |  1,090 |  1,063 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,533 | 7,414 | 2,021,783 | 538,660,330 | 5,094 | 768 | 494 | 1,573 | 1,063 | 810 | 154,677,190 | 381 | 787 | 
| leaf | 1 | 1,505 | 7,312 | 1,960,214 | 538,660,330 | 5,034 | 780 | 492 | 1,504 | 1,090 | 804 | 149,878,504 | 361 | 773 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,221 | 4,584 | 2,243,715 | 275,652,919 | 2,990 | 422 | 317 | 749 | 760 | 526 | 93,500,799 | 206 | 373 | 
| regex_program | 1 | 846 | 3,635 | 1,921,511 | 242,975,404 | 2,492 | 364 | 245 | 640 | 651 | 410 | 73,010,353 | 173 | 297 | 

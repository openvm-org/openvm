...
| `total_proof_time_ms ` |  2,582 |  2,582 |  2,582 |  2,582 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  22,370 |  22,370 |  22,370 |  22,370 |
| `main_cells_used     ` |  204,012,852 |  204,012,852 |  204,012,852 |  204,012,852 |
| `total_cycles        ` |  4,172,865 |  4,172,865 |  4,172,865 |  4,172,865 |
| `execute_time_ms     ` |  956 |  956 |  956 |  956 |
| `trace_gen_time_ms   ` |  3,759 |  3,759 |  3,759 |  3,759 |
| `stark_prove_excluding_trace_time_ms` |  17,655 |  17,655 |  17,655 |  17,655 |
| `main_trace_commit_time_ms` |  3,144 |  3,144 |  3,144 |  3,144 |
| `generate_perm_trace_time_ms` |  413 |  413 |  413 |  413 |
| `perm_trace_commit_time_ms` |  3,682 |  3,682 |  3,682 |  3,682 |
| `quotient_poly_compute_time_ms` |  4,498 |  4,498 |  4,498 |  4,498 |
| `quotient_poly_commit_time_ms` |  2,819 |  2,819 |  2,819 |  2,819 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 3,759 | 22,370 | 4,172,865 | 572,214,232 | 17,655 | 4,498 | 2,819 | 3,682 | 3,096 | 3,144 | 204,012,852 | 413 | 956 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 264 | 2,582 | 284,561 | 56,184,959 | 2,174 | 289 | 309 | 528 | 620 | 382 | 15,054,935 | 41 | 144 | 

...
| `total_proof_time_ms ` |  3,895.50 |  7,791 |  4,537 |  3,254 |
...
| `trace_gen_time_ms   ` |  973.50 |  1,947 |  1,177 |  770 |
| `stark_prove_excluding_trace_time_ms` |  2,584 |  5,168 |  2,985 |  2,183 |
| `main_trace_commit_time_ms` |  450 |  900 |  533 |  367 |
| `generate_perm_trace_time_ms` |  162 |  324 |  184 |  140 |
| `perm_trace_commit_time_ms` |  645.50 |  1,291 |  748 |  543 |
| `quotient_poly_compute_time_ms` |  361 |  722 |  422 |  300 |
| `quotient_poly_commit_time_ms` |  272 |  544 |  317 |  227 |
| `pcs_opening_time_ms ` |  684 |  1,368 |  771 |  597 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,531.50 |  15,063 |  7,619 |  7,444 |
| `main_cells_used     ` |  152,709,999.50 |  305,419,999 |  155,169,131 |  150,250,868 |
| `total_cycles        ` |  1,991,028 |  3,982,056 |  2,021,822 |  1,960,234 |
| `execute_time_ms     ` |  761.50 |  1,523 |  768 |  755 |
| `trace_gen_time_ms   ` |  1,486.50 |  2,973 |  1,531 |  1,442 |
| `stark_prove_excluding_trace_time_ms` |  5,283.50 |  10,567 |  5,320 |  5,247 |
| `main_trace_commit_time_ms` |  891.50 |  1,783 |  893 |  890 |
| `generate_perm_trace_time_ms` |  359.50 |  719 |  375 |  344 |
| `perm_trace_commit_time_ms` |  1,692.50 |  3,385 |  1,723 |  1,662 |
| `quotient_poly_compute_time_ms` |  762 |  1,524 |  765 |  759 |
| `quotient_poly_commit_time_ms` |  517.50 |  1,035 |  518 |  517 |
| `pcs_opening_time_ms ` |  1,055.50 |  2,111 |  1,060 |  1,051 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,531 | 7,619 | 2,021,822 | 538,660,330 | 5,320 | 759 | 517 | 1,723 | 1,051 | 890 | 155,169,131 | 375 | 768 | 
| leaf | 1 | 1,442 | 7,444 | 1,960,234 | 538,660,330 | 5,247 | 765 | 518 | 1,662 | 1,060 | 893 | 150,250,868 | 344 | 755 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,177 | 4,537 | 2,225,434 | 275,652,919 | 2,985 | 422 | 317 | 748 | 771 | 533 | 93,738,635 | 184 | 375 | 
| regex_program | 1 | 770 | 3,254 | 1,914,993 | 198,099,628 | 2,183 | 300 | 227 | 543 | 597 | 367 | 73,709,236 | 140 | 301 | 

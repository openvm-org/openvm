...
| `total_proof_time_ms ` |  1,475 |  2,950 |  1,705 |  1,245 |
...
| `execute_preflight_time_ms` |  100 |  200 |  114 |  86 |
| `execute_preflight_insn_mi/s` |  29.62 | -          |  31.13 |  28.10 |
| `trace_gen_time_ms   ` |  308 |  616 |  328 |  288 |
| `memory_finalize_time_ms` |  2 |  4 |  4 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  980 |  1,960 |  1,205 |  755 |
| `main_trace_commit_time_ms` |  141 |  282 |  183 |  99 |
| `generate_perm_trace_time_ms` |  58.50 |  117 |  63 |  54 |
| `perm_trace_commit_time_ms` |  172.59 |  345.19 |  223.85 |  121.34 |
| `quotient_poly_compute_time_ms` |  158.56 |  317.13 |  170.28 |  146.85 |
| `quotient_poly_commit_time_ms` |  36.22 |  72.45 |  47.36 |  25.09 |
| `pcs_opening_time_ms ` |  405.50 |  811 |  536 |  275 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  2,074.50 |  4,149 |  2,860 |  1,289 |
...
| `execute_preflight_time_ms` |  596 |  1,192 |  928 |  264 |
| `execute_preflight_insn_mi/s` |  7.02 | -          |  7.27 |  6.76 |
| `trace_gen_time_ms   ` |  121.50 |  243 |  169 |  74 |
| `memory_finalize_time_ms` |  11 |  22 |  16 |  6 |
| `stark_prove_excluding_trace_time_ms` |  1,355.50 |  2,711 |  1,762 |  949 |
| `main_trace_commit_time_ms` |  180 |  360 |  229 |  131 |
| `generate_perm_trace_time_ms` |  78.50 |  157 |  97 |  60 |
| `perm_trace_commit_time_ms` |  277.16 |  554.31 |  367.42 |  186.90 |
| `quotient_poly_compute_time_ms` |  176.25 |  352.49 |  227.03 |  125.47 |
| `quotient_poly_commit_time_ms` |  42.69 |  85.38 |  55.18 |  30.20 |
| `pcs_opening_time_ms ` |  597 |  1,194 |  782 |  412 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 2,862 |  | 1 |  | 1 |  |  |  |  | 
| regex_program |  | 1,245 |  | 41 | 1 | 41 | 4,108,483 | 98.64 | 166 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 74 | 1,289 | 23,479,090 | 319,626,730 | 74 | 949 | 0 | 125.47 | 30.20 | 4 | 186.90 | 412 | 248 | 412 | 6 | 131 | 9,325,224 | 60 | 264 | 1,496,580 | 7.27 | 29 | 156 | 1 | 412 | 
| leaf | 1 | 169 | 2,860 | 50,586,080 | 538,660,330 | 169 | 1,762 | 0 | 227.03 | 55.18 | 5 | 367.42 | 782 | 465 | 782 | 16 | 229 | 20,272,474 | 97 | 928 | 1,829,999 | 6.76 | 56 | 284 | 1 | 782 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 288 | 1,705 | 23,397,108 | 373,183,036 | 288 | 1,205 | 0 | 146.85 | 47.36 | 6 | 223.85 | 536 | 288 | 536 | 4 | 183 | 10,866,434 | 63 | 86 | 2,211,000 | 28.10 | 46 | 196 | 2 | 536 | 
| regex_program | 1 | 328 | 1,245 | 11,981,356 | 196,739,722 | 328 | 755 | 2 | 170.28 | 25.09 | 6 | 121.34 | 275 | 178 | 275 | 0 | 99 | 2,537,170 | 54 | 114 | 1,897,483 | 31.13 | 26 | 200 | 2 | 275 | 

...
| `total_proof_time_ms ` |  6,920.50 |  13,841 |  7,780 |  6,061 |
| `main_cells_used     ` |  82,727,686.50 |  165,455,373 |  92,686,348 |  72,769,025 |
| `total_cycles        ` |  2,069,920 |  4,139,840 |  2,225,737 |  1,914,103 |
| `execute_time_ms     ` |  433.50 |  867 |  466 |  401 |
| `trace_gen_time_ms   ` |  1,086.50 |  2,173 |  1,249 |  924 |
| `stark_prove_excluding_trace_time_ms` |  5,400.50 |  10,801 |  6,065 |  4,736 |
| `main_trace_commit_time_ms` |  1,059.50 |  2,119 |  1,274 |  845 |
| `generate_perm_trace_time_ms` |  168 |  336 |  189 |  147 |
| `perm_trace_commit_time_ms` |  1,149.50 |  2,299 |  1,207 |  1,092 |
| `quotient_poly_compute_time_ms` |  742.50 |  1,485 |  858 |  627 |
| `quotient_poly_commit_time_ms` |  953.50 |  1,907 |  1,100 |  807 |
| `pcs_opening_time_ms ` |  1,317.50 |  2,635 |  1,429 |  1,206 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  8,019 |  16,038 |  8,230 |  7,808 |
| `main_cells_used     ` |  77,286,863 |  154,573,726 |  78,374,882 |  76,198,844 |
| `total_cycles        ` |  1,028,175 |  2,056,350 |  1,045,586 |  1,010,764 |
| `execute_time_ms     ` |  370.50 |  741 |  402 |  339 |
| `trace_gen_time_ms   ` |  1,149.50 |  2,299 |  1,233 |  1,066 |
| `stark_prove_excluding_trace_time_ms` |  6,499 |  12,998 |  6,762 |  6,236 |
| `main_trace_commit_time_ms` |  1,324 |  2,648 |  1,383 |  1,265 |
| `generate_perm_trace_time_ms` |  161 |  322 |  172 |  150 |
| `perm_trace_commit_time_ms` |  1,310.50 |  2,621 |  1,346 |  1,275 |
| `quotient_poly_compute_time_ms` |  968.50 |  1,937 |  1,029 |  908 |
| `quotient_poly_commit_time_ms` |  1,297 |  2,594 |  1,351 |  1,243 |
| `pcs_opening_time_ms ` |  1,434.50 |  2,869 |  1,478 |  1,391 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,066 | 8,230 | 1,045,586 | 220,669,656 | 6,762 | 1,029 | 1,351 | 1,346 | 1,478 | 1,383 | 78,374,882 | 172 | 402 | 
| leaf | 1 | 1,233 | 7,808 | 1,010,764 | 194,986,968 | 6,236 | 908 | 1,243 | 1,275 | 1,391 | 1,265 | 76,198,844 | 150 | 339 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,249 | 7,780 | 2,225,737 | 209,921,543 | 6,065 | 858 | 1,100 | 1,207 | 1,429 | 1,274 | 92,686,348 | 189 | 466 | 
| regex_program | 1 | 924 | 6,061 | 1,914,103 | 149,454,692 | 4,736 | 627 | 807 | 1,092 | 1,206 | 845 | 72,769,025 | 147 | 401 | 

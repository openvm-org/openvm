...
| `total_proof_time_ms ` |  6,924 |  13,848 |  7,770 |  6,078 |
| `main_cells_used     ` |  82,727,686.50 |  165,455,373 |  92,686,348 |  72,769,025 |
| `total_cycles        ` |  1,914,103 |  1,914,103 |  1,914,103 |  1,914,103 |
| `execute_time_ms     ` |  440 |  880 |  474 |  406 |
| `trace_gen_time_ms   ` |  1,092 |  2,184 |  1,249 |  935 |
| `stark_prove_excluding_trace_time_ms` |  5,392 |  10,784 |  6,047 |  4,737 |
| `main_trace_commit_time_ms` |  1,025 |  2,050 |  1,263 |  787 |
| `generate_perm_trace_time_ms` |  187 |  374 |  187 |  187 |
| `perm_trace_commit_time_ms` |  1,144 |  2,288 |  1,198 |  1,090 |
| `quotient_poly_compute_time_ms` |  744.50 |  1,489 |  862 |  627 |
| `quotient_poly_commit_time_ms` |  965.50 |  1,931 |  1,101 |  830 |
| `pcs_opening_time_ms ` |  1,315 |  2,630 |  1,428 |  1,202 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  8,110.50 |  16,221 |  8,361 |  7,860 |
| `main_cells_used     ` |  77,286,939.50 |  154,573,879 |  78,374,999 |  76,198,880 |
| `total_cycles        ` |  1,028,183.50 |  2,056,367 |  1,045,599 |  1,010,768 |
| `execute_time_ms     ` |  382.50 |  765 |  421 |  344 |
| `trace_gen_time_ms   ` |  1,153.50 |  2,307 |  1,251 |  1,056 |
| `stark_prove_excluding_trace_time_ms` |  6,574.50 |  13,149 |  6,884 |  6,265 |
| `main_trace_commit_time_ms` |  1,337 |  2,674 |  1,405 |  1,269 |
| `generate_perm_trace_time_ms` |  170.50 |  341 |  185 |  156 |
| `perm_trace_commit_time_ms` |  1,310 |  2,620 |  1,366 |  1,254 |
| `quotient_poly_compute_time_ms` |  987 |  1,974 |  1,034 |  940 |
| `quotient_poly_commit_time_ms` |  1,288.50 |  2,577 |  1,366 |  1,211 |
| `pcs_opening_time_ms ` |  1,477 |  2,954 |  1,524 |  1,430 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,056 | 8,361 | 1,045,599 | 220,669,656 | 6,884 | 1,034 | 1,366 | 1,366 | 1,524 | 1,405 | 78,374,999 | 185 | 421 | 
| leaf | 1 | 1,251 | 7,860 | 1,010,768 | 194,986,968 | 6,265 | 940 | 1,211 | 1,254 | 1,430 | 1,269 | 76,198,880 | 156 | 344 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,249 | 7,770 |  | 209,921,543 | 6,047 | 862 | 1,101 | 1,198 | 1,428 | 1,263 | 92,686,348 | 187 | 474 | 
| regex_program | 1 | 935 | 6,078 | 1,914,103 | 149,454,692 | 4,737 | 627 | 830 | 1,090 | 1,202 | 787 | 72,769,025 | 187 | 406 | 

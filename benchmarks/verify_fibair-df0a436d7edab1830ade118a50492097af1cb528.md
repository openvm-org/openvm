...
|:---|---:|---:|---:|
| Total |  3.73 |  3.73 | 3.73 |
| verify_fibair |  3.73 |  3.73 |  3.73 |


| verify_fibair |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  3,730 |  3,730 |  3,730 |  3,730 |
| `main_cells_used     ` |  3,614,212 |  3,614,212 |  3,614,212 |  3,614,212 |
| `total_cells_used    ` |  11,076,882 |  11,076,882 |  11,076,882 |  11,076,882 |
| `execute_preflight_insns` |  621,871 |  621,871 |  621,871 |  621,871 |
...
| `stark_prove_excluding_trace_time_ms` |  3,528 |  3,528 |  3,528 |  3,528 |
| `main_trace_commit_time_ms` |  48 |  48 |  48 |  48 |
| `generate_perm_trace_time_ms` |  85 |  85 |  85 |  85 |
| `perm_trace_commit_time_ms` |  52.83 |  52.83 |  52.83 |  52.83 |
| `quotient_poly_compute_time_ms` |  46.92 |  46.92 |  46.92 |  46.92 |
| `quotient_poly_commit_time_ms` |  14.03 |  14.03 |  14.03 |  14.03 |
| `pcs_opening_time_ms ` |  3,279 |  3,279 |  3,279 |  3,279 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
|  | 11 | 3,730 | 65,536 | 2,760 | 0.17 | 0.73 | 3 | 0 | 2,756 | 0 | 2,755 | 3 | 0 | 1 | 0 | 0 | 2,755 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| verify_fibair | 44 | 3,730 | 11,076,882 | 120,541,482 | 44 | 3,528 | 0 | 46.92 | 14.03 | 6 | 52.83 | 3,279 | 138 | 3,279 | 5 | 48 | 3,614,212 | 85 | 1 | 157 | 621,871 | 4.14 | 15 | 61 | 0 | 3,279 | 

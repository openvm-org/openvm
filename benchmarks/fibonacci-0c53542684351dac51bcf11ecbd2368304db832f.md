...
| `main_cells_used     ` |  72,162,553 |  72,162,553 |  72,162,553 |  72,162,553 |
| `total_cycles        ` |  1,924,629 |  1,924,629 |  1,924,629 |  1,924,629 |
| `execute_time_ms     ` |  298 |  298 |  298 |  298 |
| `trace_gen_time_ms   ` |  1,309 |  1,309 |  1,309 |  1,309 |
| `stark_prove_excluding_trace_time_ms` |  5,397 |  5,397 |  5,397 |  5,397 |
| `main_trace_commit_time_ms` |  1,130 |  1,130 |  1,130 |  1,130 |
| `generate_perm_trace_time_ms` |  128 |  128 |  128 |  128 |
| `perm_trace_commit_time_ms` |  989 |  989 |  989 |  989 |
| `quotient_poly_compute_time_ms` |  778 |  778 |  778 |  778 |
| `quotient_poly_commit_time_ms` |  1,075 |  1,075 |  1,075 |  1,075 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,309 | 7,004 | 1,924,629 | 160,482,264 | 5,397 | 778 | 1,075 | 989 | 1,291 | 1,130 | 72,162,553 | 128 | 298 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 813 | 5,308 | 1,500,095 | 122,458,476 | 4,187 | 521 | 785 | 798 | 1,059 | 864 | 51,485,080 | 157 | 308 | 

...
| `total_proof_time_ms ` |  519.50 |  1,039 |  608 |  431 |
...
| `execute_preflight_insn_mi/s` |  36.47 | -          |  38.08 |  34.87 |
| `trace_gen_time_ms   ` |  189 |  378 |  196 |  182 |
| `memory_finalize_time_ms` | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  195 |  390 |  217 |  173 |
| `main_trace_commit_time_ms` |  30.50 |  61 |  33 |  28 |
| `generate_perm_trace_time_ms` |  26 |  52 |  31 |  21 |
| `perm_trace_commit_time_ms` |  40.81 |  81.61 |  43.41 |  38.20 |
| `quotient_poly_compute_time_ms` |  30.92 |  61.83 |  34.16 |  27.67 |
| `quotient_poly_commit_time_ms` |  12.47 |  24.95 |  12.72 |  12.23 |
| `pcs_opening_time_ms ` |  52.50 |  105 |  61 |  44 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,012 |  2,024 |  1,287 |  737 |
| `main_cells_used     ` |  6,475,562 |  12,951,124 |  6,608,072 |  6,343,052 |
| `total_cells_used    ` |  17,568,644 |  35,137,288 |  17,887,054 |  17,250,234 |
| `execute_preflight_insns` |  1,190,426.50 |  2,380,853 |  1,229,674 |  1,151,179 |
| `execute_preflight_time_ms` |  506.50 |  1,013 |  811 |  202 |
| `execute_preflight_insn_mi/s` |  6.79 | -          |  6.83 |  6.75 |
| `trace_gen_time_ms   ` |  58.50 |  117 |  60 |  57 |
| `memory_finalize_time_ms` |  6 |  12 |  6 |  6 |
| `stark_prove_excluding_trace_time_ms` |  446 |  892 |  474 |  418 |
| `main_trace_commit_time_ms` |  83 |  166 |  91 |  75 |
| `generate_perm_trace_time_ms` |  35 |  70 |  37 |  33 |
| `perm_trace_commit_time_ms` |  123.89 |  247.78 |  141.87 |  105.91 |
| `quotient_poly_compute_time_ms` |  92.72 |  185.43 |  102.55 |  82.89 |
| `quotient_poly_commit_time_ms` |  22.36 |  44.72 |  24.33 |  20.39 |
| `pcs_opening_time_ms ` |  86 |  172 |  94 |  78 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program |  | 431 |  | 1 | 13 | 1,500,209 | 114.32 | 0 | 
| leaf | 1,288 |  | 1 | 1 |  |  |  |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 60 | 737 | 17,887,054 | 252,878,314 | 60 | 474 | 0 | 102.55 | 24.33 | 4 | 141.87 | 78 | 176 | 78 | 6 | 91 | 6,608,072 | 33 | 202 | 1,229,674 | 6.83 | 26 | 127 | 0 | 78 | 
| leaf | 1 | 57 | 1,287 | 17,250,234 | 207,789,546 | 57 | 418 | 0 | 82.89 | 20.39 | 4 | 105.91 | 94 | 144 | 93 | 6 | 75 | 6,343,052 | 37 | 811 | 1,151,179 | 6.75 | 22 | 104 | 0 | 93 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 196 | 608 | 9,677,708 | 84,395,212 | 196 | 217 | 0 | 34.16 | 12.72 | 4 | 43.41 | 61 | 75 | 61 | 0 | 33 | 1,035,986 | 31 | 25 | 873,000 | 34.87 | 14 | 47 | 0 | 61 | 
| fibonacci_program | 1 | 182 | 431 | 9,708,170 | 74,305,770 | 182 | 173 | 1 | 27.67 | 12.23 | 4 | 38.20 | 44 | 60 | 44 | 0 | 28 | 1,064,416 | 21 | 34 | 627,209 | 38.08 | 11 | 40 | 0 | 44 | 

...
| `total_proof_time_ms ` |  1,480 |  2,960 |  1,719 |  1,241 |
...
| `execute_preflight_time_ms` |  99 |  198 |  111 |  87 |
| `execute_preflight_insn_mi/s` |  29.38 | -          |  31.16 |  27.60 |
| `trace_gen_time_ms   ` |  311 |  622 |  334 |  288 |
| `memory_finalize_time_ms` |  2 |  4 |  4 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  983.50 |  1,967 |  1,218 |  749 |
| `main_trace_commit_time_ms` |  142 |  284 |  184 |  100 |
| `generate_perm_trace_time_ms` |  59.50 |  119 |  65 |  54 |
| `perm_trace_commit_time_ms` |  174.36 |  348.72 |  226.89 |  121.82 |
| `quotient_poly_compute_time_ms` |  163.50 |  327 |  177.45 |  149.55 |
| `quotient_poly_commit_time_ms` |  36.54 |  73.09 |  49.04 |  24.05 |
| `pcs_opening_time_ms ` |  400.50 |  801 |  539 |  262 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  2,068 |  4,136 |  2,845 |  1,291 |
...
| `execute_preflight_time_ms` |  577.50 |  1,155 |  891 |  264 |
| `execute_preflight_insn_mi/s` |  6.98 | -          |  7.22 |  6.75 |
| `trace_gen_time_ms   ` |  126.50 |  253 |  175 |  78 |
| `memory_finalize_time_ms` |  11 |  22 |  16 |  6 |
| `stark_prove_excluding_trace_time_ms` |  1,362.50 |  2,725 |  1,777 |  948 |
| `main_trace_commit_time_ms` |  182 |  364 |  231 |  133 |
| `generate_perm_trace_time_ms` |  70.50 |  141 |  87 |  54 |
| `perm_trace_commit_time_ms` |  278.34 |  556.69 |  369.38 |  187.31 |
| `quotient_poly_compute_time_ms` |  178.49 |  356.97 |  229.70 |  127.28 |
| `quotient_poly_commit_time_ms` |  43.88 |  87.75 |  57.81 |  29.94 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 2,847 |  | 1 |  | 1 |  |  |  |  | 
| regex_program |  | 1,241 |  | 40 | 1 | 35 | 4,108,483 | 115.09 | 167 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 78 | 1,291 | 23,479,090 | 319,626,730 | 78 | 948 | 0 | 127.28 | 29.94 | 4 | 187.31 | 413 | 243 | 413 | 6 | 133 | 9,325,224 | 54 | 264 | 1,496,665 | 7.22 | 29 | 158 | 1 | 413 | 
| leaf | 1 | 175 | 2,845 | 50,586,080 | 538,660,330 | 175 | 1,777 | 0 | 229.70 | 57.81 | 4 | 369.38 | 797 | 458 | 797 | 16 | 231 | 20,272,474 | 87 | 891 | 1,830,083 | 6.75 | 56 | 290 | 1 | 797 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 288 | 1,719 | 23,397,108 | 373,183,036 | 288 | 1,218 | 0 | 149.55 | 49.04 | 6 | 226.89 | 539 | 293 | 539 | 4 | 184 | 10,866,434 | 65 | 87 | 2,211,000 | 27.60 | 46 | 200 | 2 | 539 | 
| regex_program | 1 | 334 | 1,241 | 11,981,356 | 196,739,722 | 334 | 749 | 2 | 177.45 | 24.05 | 5 | 121.82 | 262 | 179 | 262 | 0 | 100 | 2,537,170 | 54 | 111 | 1,897,483 | 31.16 | 26 | 206 | 2 | 262 | 

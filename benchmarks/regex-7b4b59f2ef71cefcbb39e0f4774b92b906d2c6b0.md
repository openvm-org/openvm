...
| `total_proof_time_ms ` |  3,904 |  7,808 |  4,352 |  3,456 |
| `main_cells_used     ` |  83,255,576 |  166,511,152 |  93,500,799 |  73,010,353 |
| `total_cycles        ` |  2,082,613 |  4,165,226 |  2,243,715 |  1,921,511 |
| `execute_time_ms     ` |  351.50 |  703 |  391 |  312 |
| `trace_gen_time_ms   ` |  955 |  1,910 |  1,139 |  771 |
| `stark_prove_excluding_trace_time_ms` |  2,597.50 |  5,195 |  2,822 |  2,373 |
| `main_trace_commit_time_ms` |  499 |  998 |  555 |  443 |
| `generate_perm_trace_time_ms` |  215 |  430 |  230 |  200 |
| `perm_trace_commit_time_ms` |  544.50 |  1,089 |  573 |  516 |
| `quotient_poly_compute_time_ms` |  255.50 |  511 |  280 |  231 |
| `quotient_poly_commit_time_ms` |  246 |  492 |  284 |  208 |
| `pcs_opening_time_ms ` |  829 |  1,658 |  891 |  767 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,003.50 |  14,007 |  7,058 |  6,949 |
| `main_cells_used     ` |  151,827,653 |  303,655,306 |  154,227,350 |  149,427,956 |
| `total_cycles        ` |  1,975,711 |  3,951,422 |  2,006,525 |  1,944,897 |
| `execute_time_ms     ` |  778.50 |  1,557 |  786 |  771 |
| `trace_gen_time_ms   ` |  1,467.50 |  2,935 |  1,469 |  1,466 |
| `stark_prove_excluding_trace_time_ms` |  4,757.50 |  9,515 |  4,803 |  4,712 |
| `main_trace_commit_time_ms` |  870.50 |  1,741 |  872 |  869 |
| `generate_perm_trace_time_ms` |  397.50 |  795 |  424 |  371 |
| `perm_trace_commit_time_ms` |  1,245.50 |  2,491 |  1,252 |  1,239 |
| `quotient_poly_compute_time_ms` |  523 |  1,046 |  525 |  521 |
| `quotient_poly_commit_time_ms` |  414.50 |  829 |  416 |  413 |
| `pcs_opening_time_ms ` |  1,302 |  2,604 |  1,317 |  1,287 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,469 | 7,058 | 2,006,525 | 538,660,330 | 4,803 | 521 | 413 | 1,252 | 1,317 | 872 | 154,227,350 | 424 | 786 | 
| leaf | 1 | 1,466 | 6,949 | 1,944,897 | 538,660,330 | 4,712 | 525 | 416 | 1,239 | 1,287 | 869 | 149,427,956 | 371 | 771 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,139 | 4,352 | 2,243,715 | 275,652,919 | 2,822 | 280 | 284 | 573 | 891 | 555 | 93,500,799 | 230 | 391 | 
| regex_program | 1 | 771 | 3,456 | 1,921,511 | 242,975,404 | 2,373 | 231 | 208 | 516 | 767 | 443 | 73,010,353 | 200 | 312 | 

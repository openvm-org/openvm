...
| `total_proof_time_ms ` |  4,959 |  4,959 |  4,959 |  4,959 |
| `main_cells_used     ` |  51,485,080 |  51,485,080 |  51,485,080 |  51,485,080 |
| `total_cycles        ` |  1,500,095 |  1,500,095 |  1,500,095 |  1,500,095 |
| `execute_time_ms     ` |  297 |  297 |  297 |  297 |
| `trace_gen_time_ms   ` |  616 |  616 |  616 |  616 |
| `stark_prove_excluding_trace_time_ms` |  4,046 |  4,046 |  4,046 |  4,046 |
...
| `main_cells_used     ` |  33,541,402 |  33,541,402 |  33,541,402 |  33,541,402 |
| `total_cycles        ` |  615,394 |  615,394 |  615,394 |  615,394 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 568 | 3,859 | 615,394 | 86,295,512 | 3,052 | 420 | 631 | 558 | 747 | 621 | 33,541,402 | 71 | 239 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 616 | 4,959 | 1,500,095 | 122,458,476 | 4,046 | 511 | 733 | 766 | 1,085 | 803 | 51,485,080 | 144 | 297 | 

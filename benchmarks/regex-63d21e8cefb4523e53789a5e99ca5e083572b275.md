...
| `total_proof_time_ms ` |  3,939 |  7,878 |  4,360 |  3,518 |
...
| `trace_gen_time_ms   ` |  975 |  1,950 |  1,165 |  785 |
| `stark_prove_excluding_trace_time_ms` |  2,609.50 |  5,219 |  2,801 |  2,418 |
| `main_trace_commit_time_ms` |  502.50 |  1,005 |  560 |  445 |
| `generate_perm_trace_time_ms` |  217.50 |  435 |  227 |  208 |
| `perm_trace_commit_time_ms` |  545.50 |  1,091 |  576 |  515 |
| `quotient_poly_compute_time_ms` |  257 |  514 |  281 |  233 |
| `quotient_poly_commit_time_ms` |  264.50 |  529 |  290 |  239 |
| `pcs_opening_time_ms ` |  814 |  1,628 |  859 |  769 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,025.50 |  14,051 |  7,064 |  6,987 |
| `main_cells_used     ` |  151,827,869 |  303,655,738 |  154,227,734 |  149,428,004 |
| `total_cycles        ` |  1,975,729 |  3,951,458 |  2,006,557 |  1,944,901 |
| `execute_time_ms     ` |  772.50 |  1,545 |  779 |  766 |
| `trace_gen_time_ms   ` |  1,485 |  2,970 |  1,504 |  1,466 |
| `stark_prove_excluding_trace_time_ms` |  4,768 |  9,536 |  4,781 |  4,755 |
| `main_trace_commit_time_ms` |  868 |  1,736 |  870 |  866 |
| `generate_perm_trace_time_ms` |  398.50 |  797 |  423 |  374 |
| `perm_trace_commit_time_ms` |  1,243 |  2,486 |  1,248 |  1,238 |
| `quotient_poly_compute_time_ms` |  550 |  1,100 |  566 |  534 |
| `quotient_poly_commit_time_ms` |  412.50 |  825 |  413 |  412 |
| `pcs_opening_time_ms ` |  1,290 |  2,580 |  1,292 |  1,288 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,504 | 7,064 | 2,006,557 | 538,660,330 | 4,781 | 534 | 412 | 1,248 | 1,292 | 866 | 154,227,734 | 423 | 779 | 
| leaf | 1 | 1,466 | 6,987 | 1,944,901 | 538,660,330 | 4,755 | 566 | 413 | 1,238 | 1,288 | 870 | 149,428,004 | 374 | 766 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,165 | 4,360 | 2,243,715 | 275,652,919 | 2,801 | 281 | 290 | 576 | 859 | 560 | 93,500,799 | 227 | 394 | 
| regex_program | 1 | 785 | 3,518 | 1,921,511 | 242,975,404 | 2,418 | 233 | 239 | 515 | 769 | 445 | 73,010,353 | 208 | 315 | 

...
| `execute_preflight_insn_mi/s` |  11.51 | -          |  11.51 |  11.51 |
| `trace_gen_time_ms   ` |  280 |  280 |  280 |  280 |
| `memory_finalize_time_ms` |  1 |  1 |  1 |  1 |
| `stark_prove_excluding_trace_time_ms` |  976 |  976 |  976 |  976 |
| `main_trace_commit_time_ms` |  154 |  154 |  154 |  154 |
| `generate_perm_trace_time_ms` |  75 |  75 |  75 |  75 |
| `perm_trace_commit_time_ms` |  181.74 |  181.74 |  181.74 |  181.74 |
| `quotient_poly_compute_time_ms` |  146.45 |  146.45 |  146.45 |  146.45 |
| `quotient_poly_commit_time_ms` |  34.75 |  34.75 |  34.75 |  34.75 |
| `pcs_opening_time_ms ` |  378 |  378 |  378 |  378 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,750 |  1,750 |  1,750 |  1,750 |
...
| `execute_preflight_time_ms` |  328 |  328 |  328 |  328 |
| `execute_preflight_insn_mi/s` |  7.64 | -          |  7.64 |  7.64 |
| `trace_gen_time_ms   ` |  122 |  122 |  122 |  122 |
| `memory_finalize_time_ms` |  11 |  11 |  11 |  11 |
| `stark_prove_excluding_trace_time_ms` |  1,298 |  1,298 |  1,298 |  1,298 |
| `main_trace_commit_time_ms` |  169 |  169 |  169 |  169 |
| `generate_perm_trace_time_ms` |  81 |  81 |  81 |  81 |
| `perm_trace_commit_time_ms` |  256.67 |  256.67 |  256.67 |  256.67 |
| `quotient_poly_compute_time_ms` |  173.59 |  173.59 |  173.59 |  173.59 |
| `quotient_poly_commit_time_ms` |  40.65 |  40.65 |  40.65 |  40.65 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 1,752 |  | 1 |  | 1 |  |  |  |  | 
| pairing |  | 1,551 |  | 40 | 1 | 93 | 1,882,939 | 20.23 | 148 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 122 | 1,750 | 39,940,154 | 418,598,378 | 122 | 1,298 | 0 | 173.59 | 40.65 | 4 | 256.67 | 573 | 338 | 573 | 11 | 169 | 16,451,316 | 81 | 328 | 2,010,453 | 7.64 | 39 | 215 | 1 | 573 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 280 | 1,551 | 44,491,360 | 304,931,516 | 280 | 976 | 0 | 146.45 | 34.75 | 6 | 181.74 | 378 | 260 | 378 | 1 | 154 | 23,722,622 | 75 | 168 | 1,882,939 | 11.51 | 37 | 182 | 3 | 378 | 

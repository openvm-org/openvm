...
| `total_proof_time_ms ` |  3,855 |  7,710 |  4,486 |  3,224 |
...
| `trace_gen_time_ms   ` |  961.50 |  1,923 |  1,178 |  745 |
| `stark_prove_excluding_trace_time_ms` |  2,552.50 |  5,105 |  2,929 |  2,176 |
| `main_trace_commit_time_ms` |  450 |  900 |  534 |  366 |
| `generate_perm_trace_time_ms` |  163 |  326 |  189 |  137 |
| `perm_trace_commit_time_ms` |  643 |  1,286 |  747 |  539 |
| `quotient_poly_compute_time_ms` |  361.50 |  723 |  418 |  305 |
| `quotient_poly_commit_time_ms` |  270 |  540 |  317 |  223 |
| `pcs_opening_time_ms ` |  655.50 |  1,311 |  715 |  596 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,484.50 |  14,969 |  7,561 |  7,408 |
| `main_cells_used     ` |  152,710,605.50 |  305,421,211 |  155,170,331 |  150,250,880 |
| `total_cycles        ` |  1,991,078.50 |  3,982,157 |  2,021,922 |  1,960,235 |
| `execute_time_ms     ` |  761.50 |  1,523 |  773 |  750 |
| `trace_gen_time_ms   ` |  1,456.50 |  2,913 |  1,485 |  1,428 |
| `stark_prove_excluding_trace_time_ms` |  5,266.50 |  10,533 |  5,303 |  5,230 |
| `main_trace_commit_time_ms` |  893 |  1,786 |  896 |  890 |
| `generate_perm_trace_time_ms` |  350 |  700 |  351 |  349 |
| `perm_trace_commit_time_ms` |  1,670.50 |  3,341 |  1,703 |  1,638 |
| `quotient_poly_compute_time_ms` |  765 |  1,530 |  766 |  764 |
| `quotient_poly_commit_time_ms` |  523 |  1,046 |  526 |  520 |
| `pcs_opening_time_ms ` |  1,060 |  2,120 |  1,064 |  1,056 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,485 | 7,561 | 2,021,922 | 538,660,330 | 5,303 | 766 | 520 | 1,703 | 1,064 | 896 | 155,170,331 | 349 | 773 | 
| leaf | 1 | 1,428 | 7,408 | 1,960,235 | 538,660,330 | 5,230 | 764 | 526 | 1,638 | 1,056 | 890 | 150,250,880 | 351 | 750 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,178 | 4,486 | 2,225,434 | 275,652,919 | 2,929 | 418 | 317 | 747 | 715 | 534 | 93,738,635 | 189 | 379 | 
| regex_program | 1 | 745 | 3,224 | 1,914,993 | 198,099,628 | 2,176 | 305 | 223 | 539 | 596 | 366 | 73,709,236 | 137 | 303 | 

...
| `total_proof_time_ms ` |  3,891.50 |  7,783 |  4,481 |  3,302 |
...
| `trace_gen_time_ms   ` |  989.50 |  1,979 |  1,170 |  809 |
| `stark_prove_excluding_trace_time_ms` |  2,562.50 |  5,125 |  2,935 |  2,190 |
| `main_trace_commit_time_ms` |  444.50 |  889 |  522 |  367 |
| `generate_perm_trace_time_ms` |  165.50 |  331 |  192 |  139 |
| `perm_trace_commit_time_ms` |  639 |  1,278 |  742 |  536 |
| `quotient_poly_compute_time_ms` |  367 |  734 |  425 |  309 |
| `quotient_poly_commit_time_ms` |  273 |  546 |  317 |  229 |
| `pcs_opening_time_ms ` |  663.50 |  1,327 |  727 |  600 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,504.50 |  15,009 |  7,580 |  7,429 |
| `main_cells_used     ` |  152,709,957.50 |  305,419,915 |  155,170,163 |  150,249,752 |
| `total_cycles        ` |  1,991,024.50 |  3,982,049 |  2,021,908 |  1,960,141 |
| `execute_time_ms     ` |  753.50 |  1,507 |  762 |  745 |
| `trace_gen_time_ms   ` |  1,463.50 |  2,927 |  1,501 |  1,426 |
| `stark_prove_excluding_trace_time_ms` |  5,287.50 |  10,575 |  5,317 |  5,258 |
| `main_trace_commit_time_ms` |  891 |  1,782 |  892 |  890 |
| `generate_perm_trace_time_ms` |  348.50 |  697 |  354 |  343 |
| `perm_trace_commit_time_ms` |  1,669 |  3,338 |  1,695 |  1,643 |
| `quotient_poly_compute_time_ms` |  771.50 |  1,543 |  775 |  768 |
| `quotient_poly_commit_time_ms` |  526 |  1,052 |  528 |  524 |
| `pcs_opening_time_ms ` |  1,075.50 |  2,151 |  1,080 |  1,071 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,501 | 7,580 | 2,021,908 | 538,660,330 | 5,317 | 775 | 524 | 1,695 | 1,071 | 892 | 155,170,163 | 354 | 762 | 
| leaf | 1 | 1,426 | 7,429 | 1,960,141 | 538,660,330 | 5,258 | 768 | 528 | 1,643 | 1,080 | 890 | 150,249,752 | 343 | 745 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,170 | 4,481 | 2,225,434 | 275,652,919 | 2,935 | 425 | 317 | 742 | 727 | 522 | 93,738,635 | 192 | 376 | 
| regex_program | 1 | 809 | 3,302 | 1,914,993 | 198,099,628 | 2,190 | 309 | 229 | 536 | 600 | 367 | 73,709,236 | 139 | 303 | 

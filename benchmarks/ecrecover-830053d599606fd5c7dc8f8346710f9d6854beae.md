...
| `total_proof_time_ms ` |  2,540 |  2,540 |  2,540 |  2,540 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  13,532 |  13,532 |  13,532 |  13,532 |
| `main_cells_used     ` |  133,786,037 |  133,786,037 |  133,786,037 |  133,786,037 |
| `total_cycles        ` |  2,253,330 |  2,253,330 |  2,253,330 |  2,253,330 |
| `execute_time_ms     ` |  708 |  708 |  708 |  708 |
| `trace_gen_time_ms   ` |  1,752 |  1,752 |  1,752 |  1,752 |
| `stark_prove_excluding_trace_time_ms` |  11,072 |  11,072 |  11,072 |  11,072 |
| `main_trace_commit_time_ms` |  2,403 |  2,403 |  2,403 |  2,403 |
| `generate_perm_trace_time_ms` |  322 |  322 |  322 |  322 |
| `perm_trace_commit_time_ms` |  2,402 |  2,402 |  2,402 |  2,402 |
| `quotient_poly_compute_time_ms` |  1,645 |  1,645 |  1,645 |  1,645 |
| `quotient_poly_commit_time_ms` |  2,008 |  2,008 |  2,008 |  2,008 |
| `pcs_opening_time_ms ` |  2,284 |  2,284 |  2,284 |  2,284 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,752 | 13,532 | 2,253,330 | 377,489,890 | 11,072 | 1,645 | 2,008 | 2,402 | 2,284 | 2,403 | 133,786,037 | 322 | 708 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 179 | 2,540 | 295,181 | 38,665,477 | 2,209 | 233 | 469 | 366 | 702 | 384 | 15,586,346 | 34 | 152 | 

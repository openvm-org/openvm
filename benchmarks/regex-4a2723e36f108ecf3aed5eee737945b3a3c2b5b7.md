...
| `total_proof_time_ms ` |  3,875.50 |  7,751 |  4,477 |  3,274 |
...
| `trace_gen_time_ms   ` |  968 |  1,936 |  1,157 |  779 |
| `stark_prove_excluding_trace_time_ms` |  2,568.50 |  5,137 |  2,943 |  2,194 |
| `main_trace_commit_time_ms` |  446 |  892 |  524 |  368 |
| `generate_perm_trace_time_ms` |  163 |  326 |  190 |  136 |
| `perm_trace_commit_time_ms` |  645 |  1,290 |  747 |  543 |
| `quotient_poly_compute_time_ms` |  363 |  726 |  422 |  304 |
| `quotient_poly_commit_time_ms` |  275.50 |  551 |  321 |  230 |
| `pcs_opening_time_ms ` |  666.50 |  1,333 |  729 |  604 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,495.50 |  14,991 |  7,554 |  7,437 |
| `main_cells_used     ` |  152,323,473.50 |  304,646,947 |  154,782,172 |  149,864,775 |
| `total_cycles        ` |  1,994,011.50 |  3,988,023 |  2,024,836 |  1,963,187 |
| `execute_time_ms     ` |  763.50 |  1,527 |  771 |  756 |
| `trace_gen_time_ms   ` |  1,470 |  2,940 |  1,500 |  1,440 |
| `stark_prove_excluding_trace_time_ms` |  5,262 |  10,524 |  5,283 |  5,241 |
| `main_trace_commit_time_ms` |  891.50 |  1,783 |  893 |  890 |
| `generate_perm_trace_time_ms` |  344 |  688 |  346 |  342 |
| `perm_trace_commit_time_ms` |  1,647.50 |  3,295 |  1,677 |  1,618 |
| `quotient_poly_compute_time_ms` |  759 |  1,518 |  761 |  757 |
| `quotient_poly_commit_time_ms` |  527 |  1,054 |  528 |  526 |
| `pcs_opening_time_ms ` |  1,086.50 |  2,173 |  1,103 |  1,070 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,500 | 7,554 | 2,024,836 | 533,941,738 | 5,283 | 761 | 528 | 1,677 | 1,070 | 893 | 154,782,172 | 346 | 771 | 
| leaf | 1 | 1,440 | 7,437 | 1,963,187 | 533,941,738 | 5,241 | 757 | 526 | 1,618 | 1,103 | 890 | 149,864,775 | 342 | 756 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,157 | 4,477 | 2,225,434 | 275,652,919 | 2,943 | 422 | 321 | 747 | 729 | 524 | 93,699,990 | 190 | 377 | 
| regex_program | 1 | 779 | 3,274 | 1,914,730 | 198,099,628 | 2,194 | 304 | 230 | 543 | 604 | 368 | 73,689,460 | 136 | 301 | 

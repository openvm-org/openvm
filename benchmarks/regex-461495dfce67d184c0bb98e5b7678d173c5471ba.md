...
| `total_proof_time_ms ` |  1,475.50 |  2,951 |  1,705 |  1,246 |
...
| `execute_preflight_insn_mi/s` |  29.99 | -          |  31.53 |  28.44 |
| `trace_gen_time_ms   ` |  312 |  624 |  333 |  291 |
| `memory_finalize_time_ms` |  2 |  4 |  4 | <span style='color: green'>(+0 [NaN%])</span> 0 |
| `stark_prove_excluding_trace_time_ms` |  977.50 |  1,955 |  1,201 |  754 |
| `main_trace_commit_time_ms` |  141.50 |  283 |  184 |  99 |
| `generate_perm_trace_time_ms` |  57 |  114 |  67 |  47 |
| `perm_trace_commit_time_ms` |  172.81 |  345.61 |  225.50 |  120.11 |
| `quotient_poly_compute_time_ms` |  166.56 |  333.13 |  186.59 |  146.54 |
| `quotient_poly_commit_time_ms` |  36.27 |  72.53 |  48.44 |  24.09 |
| `pcs_opening_time_ms ` |  396.50 |  793 |  526 |  267 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  2,096 |  4,192 |  2,871 |  1,321 |
| `main_cells_used     ` |  14,798,849 |  29,597,698 |  20,272,474 |  9,325,224 |
| `total_cells_used    ` |  37,032,585 |  74,065,170 |  50,586,080 |  23,479,090 |
| `execute_preflight_insns` |  1,663,372.50 |  3,326,745 |  1,830,065 |  1,496,680 |
| `execute_preflight_time_ms` |  580.50 |  1,161 |  895 |  266 |
| `execute_preflight_insn_mi/s` |  6.93 | -          |  7.15 |  6.72 |
| `trace_gen_time_ms   ` |  124.50 |  249 |  173 |  76 |
| `memory_finalize_time_ms` |  11 |  22 |  16 |  6 |
| `stark_prove_excluding_trace_time_ms` |  1,390 |  2,780 |  1,802 |  978 |
| `main_trace_commit_time_ms` |  181 |  362 |  230 |  132 |
| `generate_perm_trace_time_ms` |  97 |  194 |  106 |  88 |
| `perm_trace_commit_time_ms` |  278.06 |  556.11 |  369.04 |  187.07 |
| `quotient_poly_compute_time_ms` |  176.60 |  353.19 |  227.76 |  125.44 |
| `quotient_poly_commit_time_ms` |  43.38 |  86.77 |  56.41 |  30.36 |
| `pcs_opening_time_ms ` |  610.50 |  1,221 |  809 |  412 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 2,873 |  | 1 |  | 1 |  |  |  |  | 
| regex_program |  | 1,246 |  | 41 | 1 | 43 | 4,108,483 | 94.03 | 169 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 76 | 1,321 | 23,479,090 | 319,626,730 | 76 | 978 | 0 | 125.44 | 30.36 | 4 | 187.07 | 412 | 276 | 412 | 6 | 132 | 9,325,224 | 88 | 266 | 1,496,680 | 7.15 | 29 | 156 | 1 | 412 | 
| leaf | 1 | 173 | 2,871 | 50,586,080 | 538,660,330 | 172 | 1,802 | 0 | 227.76 | 56.41 | 4 | 369.04 | 809 | 476 | 808 | 16 | 230 | 20,272,474 | 106 | 895 | 1,830,065 | 6.72 | 56 | 286 | 1 | 808 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 291 | 1,705 | 23,397,108 | 373,183,036 | 291 | 1,201 | 0 | 146.54 | 48.44 | 6 | 225.50 | 526 | 293 | 525 | 4 | 184 | 10,866,434 | 67 | 85 | 2,211,000 | 28.44 | 46 | 197 | 2 | 525 | 
| regex_program | 1 | 333 | 1,246 | 11,981,356 | 196,739,722 | 333 | 754 | 2 | 186.59 | 24.09 | 5 | 120.11 | 267 | 171 | 267 | 0 | 99 | 2,537,170 | 47 | 112 | 1,897,483 | 31.53 | 26 | 215 | 2 | 267 | 

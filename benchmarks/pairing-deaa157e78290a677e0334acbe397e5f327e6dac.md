...
| `trace_gen_time_ms   ` |  880 |  880 |  880 |  880 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  14,115 |  14,115 |  14,115 |  14,115 |
| `main_cells_used     ` |  274,767,387 |  274,767,387 |  274,767,387 |  274,767,387 |
| `total_cycles        ` |  3,298,029 |  3,298,029 |  3,298,029 |  3,298,029 |
| `execute_time_ms     ` |  1,208 |  1,208 |  1,208 |  1,208 |
| `trace_gen_time_ms   ` |  2,630 |  2,630 |  2,630 |  2,630 |
| `stark_prove_excluding_trace_time_ms` |  10,277 |  10,277 |  10,277 |  10,277 |
| `main_trace_commit_time_ms` |  1,768 |  1,768 |  1,768 |  1,768 |
| `generate_perm_trace_time_ms` |  715 |  715 |  715 |  715 |
| `perm_trace_commit_time_ms` |  3,372 |  3,372 |  3,372 |  3,372 |
| `quotient_poly_compute_time_ms` |  1,484 |  1,484 |  1,484 |  1,484 |
| `quotient_poly_commit_time_ms` |  967 |  967 |  967 |  967 |
| `pcs_opening_time_ms ` |  1,966 |  1,966 |  1,966 |  1,966 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 2,630 | 14,115 | 3,298,029 | 1,071,746,538 | 10,277 | 1,484 | 967 | 3,372 | 1,966 | 1,768 | 274,767,387 | 715 | 1,208 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pairing | 0 | 880 | 4,686 | 1,711,640 | 297,186,413 | 3,135 | 462 | 331 | 778 | 758 | 603 | 92,585,975 | 186 | 671 | 

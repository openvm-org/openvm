...
| `total_proof_time_ms ` |  1,457 |  1,457 |  1,457 |  1,457 |
...
| `stark_prove_excluding_trace_time_ms` |  1,128 |  1,128 |  1,128 |  1,128 |
| `main_trace_commit_time_ms` |  182 |  182 |  182 |  182 |
...
| `quotient_poly_commit_time_ms` |  164 |  164 |  164 |  164 |
| `pcs_opening_time_ms ` |  406 |  406 |  406 |  406 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  13,154 |  13,154 |  13,154 |  13,154 |
| `main_cells_used     ` |  245,267,923 |  245,267,923 |  245,267,923 |  245,267,923 |
| `total_cycles        ` |  2,990,634 |  2,990,634 |  2,990,634 |  2,990,634 |
| `execute_time_ms     ` |  1,085 |  1,085 |  1,085 |  1,085 |
| `trace_gen_time_ms   ` |  2,404 |  2,404 |  2,404 |  2,404 |
| `stark_prove_excluding_trace_time_ms` |  9,665 |  9,665 |  9,665 |  9,665 |
| `main_trace_commit_time_ms` |  1,737 |  1,737 |  1,737 |  1,737 |
| `generate_perm_trace_time_ms` |  711 |  711 |  711 |  711 |
| `perm_trace_commit_time_ms` |  3,188 |  3,188 |  3,188 |  3,188 |
| `quotient_poly_compute_time_ms` |  1,342 |  1,342 |  1,342 |  1,342 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 2,404 | 13,154 | 2,990,634 | 1,008,831,978 | 9,665 | 1,342 | 879 | 3,188 | 1,803 | 1,737 | 245,267,923 | 711 | 1,085 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 178 | 1,457 | 295,303 | 48,240,457 | 1,128 | 125 | 164 | 201 | 406 | 182 | 15,598,665 | 34 | 151 | 

...
| `pcs_opening_time_ms ` |  661 |  661 |  661 |  661 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  18,455 |  18,455 |  18,455 |  18,455 |
| `main_cells_used     ` |  193,204,866 |  193,204,866 |  193,204,866 |  193,204,866 |
| `total_cycles        ` |  4,155,768 |  4,155,768 |  4,155,768 |  4,155,768 |
| `execute_time_ms     ` |  974 |  974 |  974 |  974 |
| `trace_gen_time_ms   ` |  3,535 |  3,535 |  3,535 |  3,535 |
| `stark_prove_excluding_trace_time_ms` |  13,946 |  13,946 |  13,946 |  13,946 |
| `main_trace_commit_time_ms` |  2,939 |  2,939 |  2,939 |  2,939 |
| `generate_perm_trace_time_ms` |  360 |  360 |  360 |  360 |
| `perm_trace_commit_time_ms` |  2,942 |  2,942 |  2,942 |  2,942 |
| `quotient_poly_compute_time_ms` |  2,084 |  2,084 |  2,084 |  2,084 |
| `quotient_poly_commit_time_ms` |  2,646 |  2,646 |  2,646 |  2,646 |
| `pcs_opening_time_ms ` |  2,971 |  2,971 |  2,971 |  2,971 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 3,535 | 18,455 | 4,155,768 | 466,306,008 | 13,946 | 2,084 | 2,646 | 2,942 | 2,971 | 2,939 | 193,204,866 | 360 | 974 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 252 | 2,586 | 285,401 | 38,415,035 | 2,180 | 231 | 480 | 371 | 661 | 392 | 15,075,033 | 32 | 154 | 

...
| `total_proof_time_ms ` |  2,522 |  2,522 |  2,522 |  2,522 |
...
| `main_trace_commit_time_ms` |  371 |  371 |  371 |  371 |
| `generate_perm_trace_time_ms` |  33 |  33 |  33 |  33 |
| `perm_trace_commit_time_ms` |  351 |  351 |  351 |  351 |
| `quotient_poly_compute_time_ms` |  231 |  231 |  231 |  231 |
| `quotient_poly_commit_time_ms` |  481 |  481 |  481 |  481 |
| `pcs_opening_time_ms ` |  703 |  703 |  703 |  703 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  13,246 |  13,246 |  13,246 |  13,246 |
...
| `trace_gen_time_ms   ` |  1,748 |  1,748 |  1,748 |  1,748 |
| `stark_prove_excluding_trace_time_ms` |  10,773 |  10,773 |  10,773 |  10,773 |
| `main_trace_commit_time_ms` |  2,289 |  2,289 |  2,289 |  2,289 |
| `generate_perm_trace_time_ms` |  314 |  314 |  314 |  314 |
| `perm_trace_commit_time_ms` |  2,291 |  2,291 |  2,291 |  2,291 |
| `quotient_poly_compute_time_ms` |  1,664 |  1,664 |  1,664 |  1,664 |
| `quotient_poly_commit_time_ms` |  1,929 |  1,929 |  1,929 |  1,929 |
| `pcs_opening_time_ms ` |  2,279 |  2,279 |  2,279 |  2,279 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,748 | 13,246 | 2,253,324 | 377,489,890 | 10,773 | 1,664 | 1,929 | 2,291 | 2,279 | 2,289 | 133,785,965 | 314 | 725 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 186 | 2,522 | 295,181 | 38,665,477 | 2,185 | 231 | 481 | 351 | 703 | 371 | 15,586,346 | 33 | 151 | 

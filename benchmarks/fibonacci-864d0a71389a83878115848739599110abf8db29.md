...
| `stark_prove_excluding_trace_time_ms` |  4,961 |  4,961 |  4,961 |  4,961 |
| `main_trace_commit_time_ms` |  804 |  804 |  804 |  804 |
| `generate_perm_trace_time_ms` |  178 |  178 |  178 |  178 |
| `perm_trace_commit_time_ms` |  1,619 |  1,619 |  1,619 |  1,619 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  8,031 |  8,031 |  8,031 |  8,031 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,255 | 8,031 | 1,817,697 | 180,014,040 | 6,421 | 1,593 | 1,054 | 1,188 | 1,340 | 1,112 | 70,261,826 | 131 | 355 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 826 | 6,100 | 1,500,137 | 197,440,542 | 4,961 | 796 | 526 | 1,619 | 1,035 | 804 | 51,487,838 | 178 | 313 | 

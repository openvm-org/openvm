...
| `total_proof_time_ms ` |  2,544 |  2,544 |  2,544 |  2,544 |
...
| `pcs_opening_time_ms ` |  664 |  664 |  664 |  664 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  18,535 |  18,535 |  18,535 |  18,535 |
| `main_cells_used     ` |  193,315,937 |  193,315,937 |  193,315,937 |  193,315,937 |
| `total_cycles        ` |  4,157,985 |  4,157,985 |  4,157,985 |  4,157,985 |
| `execute_time_ms     ` |  929 |  929 |  929 |  929 |
| `trace_gen_time_ms   ` |  3,540 |  3,540 |  3,540 |  3,540 |
| `stark_prove_excluding_trace_time_ms` |  14,066 |  14,066 |  14,066 |  14,066 |
| `main_trace_commit_time_ms` |  2,919 |  2,919 |  2,919 |  2,919 |
| `generate_perm_trace_time_ms` |  355 |  355 |  355 |  355 |
| `perm_trace_commit_time_ms` |  2,915 |  2,915 |  2,915 |  2,915 |
| `quotient_poly_compute_time_ms` |  2,089 |  2,089 |  2,089 |  2,089 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 3,540 | 18,535 | 4,157,985 | 466,306,008 | 14,066 | 2,089 | 2,643 | 2,915 | 3,141 | 2,919 | 193,315,937 | 355 | 929 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 258 | 2,544 | 284,567 | 38,417,467 | 2,139 | 226 | 469 | 348 | 664 | 385 | 15,055,723 | 34 | 147 | 

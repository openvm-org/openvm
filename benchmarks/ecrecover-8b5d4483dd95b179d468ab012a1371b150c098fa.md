...
| `total_proof_time_ms ` |  2,566 |  2,566 |  2,566 |  2,566 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  18,110 |  18,110 |  18,110 |  18,110 |
| `main_cells_used     ` |  186,734,344 |  186,734,344 |  186,734,344 |  186,734,344 |
| `total_cycles        ` |  4,158,085 |  4,158,085 |  4,158,085 |  4,158,085 |
| `execute_time_ms     ` |  938 |  938 |  938 |  938 |
| `trace_gen_time_ms   ` |  3,457 |  3,457 |  3,457 |  3,457 |
| `stark_prove_excluding_trace_time_ms` |  13,715 |  13,715 |  13,715 |  13,715 |
| `main_trace_commit_time_ms` |  2,776 |  2,776 |  2,776 |  2,776 |
| `generate_perm_trace_time_ms` |  357 |  357 |  357 |  357 |
| `perm_trace_commit_time_ms` |  2,886 |  2,886 |  2,886 |  2,886 |
| `quotient_poly_compute_time_ms` |  2,085 |  2,085 |  2,085 |  2,085 |
| `quotient_poly_commit_time_ms` |  2,654 |  2,654 |  2,654 |  2,654 |
| `pcs_opening_time_ms ` |  2,953 |  2,953 |  2,953 |  2,953 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 3,457 | 18,110 | 4,158,085 | 459,031,512 | 13,715 | 2,085 | 2,654 | 2,886 | 2,953 | 2,776 | 186,734,344 | 357 | 938 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 255 | 2,566 | 284,567 | 38,417,467 | 2,158 | 224 | 489 | 354 | 650 | 393 | 15,055,723 | 34 | 153 | 

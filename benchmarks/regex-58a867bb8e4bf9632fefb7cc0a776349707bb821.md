...
| `total_proof_time_ms ` |  3,917.50 |  7,835 |  4,361 |  3,474 |
...
| `trace_gen_time_ms   ` |  980 |  1,960 |  1,177 |  783 |
| `stark_prove_excluding_trace_time_ms` |  2,581 |  5,162 |  2,788 |  2,374 |
| `main_trace_commit_time_ms` |  500 |  1,000 |  556 |  444 |
| `generate_perm_trace_time_ms` |  220.50 |  441 |  240 |  201 |
| `perm_trace_commit_time_ms` |  545.50 |  1,091 |  574 |  517 |
| `quotient_poly_compute_time_ms` |  256.50 |  513 |  280 |  233 |
| `quotient_poly_commit_time_ms` |  244.50 |  489 |  283 |  206 |
| `pcs_opening_time_ms ` |  805.50 |  1,611 |  847 |  764 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,013 |  14,026 |  7,075 |  6,951 |
| `main_cells_used     ` |  151,827,635 |  303,655,270 |  154,227,122 |  149,428,148 |
| `total_cycles        ` |  1,975,709.50 |  3,951,419 |  2,006,506 |  1,944,913 |
| `execute_time_ms     ` |  777.50 |  1,555 |  784 |  771 |
| `trace_gen_time_ms   ` |  1,478 |  2,956 |  1,507 |  1,449 |
| `stark_prove_excluding_trace_time_ms` |  4,757.50 |  9,515 |  4,784 |  4,731 |
| `main_trace_commit_time_ms` |  872.50 |  1,745 |  880 |  865 |
| `generate_perm_trace_time_ms` |  400 |  800 |  414 |  386 |
| `perm_trace_commit_time_ms` |  1,244 |  2,488 |  1,247 |  1,241 |
| `quotient_poly_compute_time_ms` |  539.50 |  1,079 |  543 |  536 |
| `quotient_poly_commit_time_ms` |  411.50 |  823 |  412 |  411 |
| `pcs_opening_time_ms ` |  1,285.50 |  2,571 |  1,286 |  1,285 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,507 | 7,075 | 2,006,506 | 538,660,330 | 4,784 | 543 | 411 | 1,247 | 1,285 | 880 | 154,227,122 | 414 | 784 | 
| leaf | 1 | 1,449 | 6,951 | 1,944,913 | 538,660,330 | 4,731 | 536 | 412 | 1,241 | 1,286 | 865 | 149,428,148 | 386 | 771 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,177 | 4,361 | 2,243,715 | 275,652,919 | 2,788 | 280 | 283 | 574 | 847 | 556 | 93,500,799 | 240 | 396 | 
| regex_program | 1 | 783 | 3,474 | 1,921,511 | 242,975,404 | 2,374 | 233 | 206 | 517 | 764 | 444 | 73,010,353 | 201 | 317 | 

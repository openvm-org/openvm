...
| `total_proof_time_ms ` |  3,976.50 |  7,953 |  4,362 |  3,591 |
...
| `trace_gen_time_ms   ` |  972 |  1,944 |  1,147 |  797 |
| `stark_prove_excluding_trace_time_ms` |  2,651.50 |  5,303 |  2,822 |  2,481 |
| `main_trace_commit_time_ms` |  500.50 |  1,001 |  557 |  444 |
| `generate_perm_trace_time_ms` |  219.50 |  439 |  232 |  207 |
| `perm_trace_commit_time_ms` |  556.50 |  1,113 |  576 |  537 |
| `quotient_poly_compute_time_ms` |  281 |  562 |  303 |  259 |
| `quotient_poly_commit_time_ms` |  245.50 |  491 |  281 |  210 |
| `pcs_opening_time_ms ` |  838 |  1,676 |  863 |  813 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,061 |  14,122 |  7,105 |  7,017 |
| `main_cells_used     ` |  151,828,013 |  303,656,026 |  154,227,878 |  149,428,148 |
| `total_cycles        ` |  1,975,741 |  3,951,482 |  2,006,569 |  1,944,913 |
| `execute_time_ms     ` |  778.50 |  1,557 |  787 |  770 |
| `trace_gen_time_ms   ` |  1,500.50 |  3,001 |  1,526 |  1,475 |
| `stark_prove_excluding_trace_time_ms` |  4,782 |  9,564 |  4,792 |  4,772 |
| `main_trace_commit_time_ms` |  867 |  1,734 |  867 |  867 |
| `generate_perm_trace_time_ms` |  394.50 |  789 |  417 |  372 |
| `perm_trace_commit_time_ms` |  1,256.50 |  2,513 |  1,259 |  1,254 |
| `quotient_poly_compute_time_ms` |  539 |  1,078 |  541 |  537 |
| `quotient_poly_commit_time_ms` |  417 |  834 |  420 |  414 |
| `pcs_opening_time_ms ` |  1,304 |  2,608 |  1,313 |  1,295 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,526 | 7,105 | 2,006,569 | 538,660,330 | 4,792 | 541 | 414 | 1,254 | 1,295 | 867 | 154,227,878 | 417 | 787 | 
| leaf | 1 | 1,475 | 7,017 | 1,944,913 | 538,660,330 | 4,772 | 537 | 420 | 1,259 | 1,313 | 867 | 149,428,148 | 372 | 770 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,147 | 4,362 | 2,243,715 | 275,652,919 | 2,822 | 303 | 281 | 576 | 863 | 557 | 93,500,799 | 232 | 393 | 
| regex_program | 1 | 797 | 3,591 | 1,921,511 | 242,975,404 | 2,481 | 259 | 210 | 537 | 813 | 444 | 73,010,353 | 207 | 313 | 

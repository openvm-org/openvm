...
| `pcs_opening_time_ms ` |  671 |  671 |  671 |  671 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  11,353 |  11,353 |  11,353 |  11,353 |
| `main_cells_used     ` |  117,321,027 |  117,321,027 |  117,321,027 |  117,321,027 |
| `total_cycles        ` |  1,604,023 |  1,604,023 |  1,604,023 |  1,604,023 |
| `execute_time_ms     ` |  566 |  566 |  566 |  566 |
| `trace_gen_time_ms   ` |  1,552 |  1,552 |  1,552 |  1,552 |
| `stark_prove_excluding_trace_time_ms` |  9,235 |  9,235 |  9,235 |  9,235 |
| `main_trace_commit_time_ms` |  1,913 |  1,913 |  1,913 |  1,913 |
| `generate_perm_trace_time_ms` |  267 |  267 |  267 |  267 |
| `perm_trace_commit_time_ms` |  2,015 |  2,015 |  2,015 |  2,015 |
| `quotient_poly_compute_time_ms` |  1,457 |  1,457 |  1,457 |  1,457 |
| `quotient_poly_commit_time_ms` |  1,693 |  1,693 |  1,693 |  1,693 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,552 | 11,353 | 1,604,023 | 334,709,720 | 9,235 | 1,457 | 1,693 | 2,015 | 1,885 | 1,913 | 117,321,027 | 267 | 566 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 174 | 2,486 | 284,567 | 38,417,467 | 2,164 | 230 | 477 | 362 | 671 | 380 | 15,055,723 | 32 | 148 | 

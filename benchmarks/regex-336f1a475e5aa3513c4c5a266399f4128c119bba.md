...
| `total_proof_time_ms ` |  7,633 |  15,266 |  8,539 |  6,727 |
...
| `trace_gen_time_ms   ` |  1,681.50 |  3,363 |  1,870 |  1,493 |
| `stark_prove_excluding_trace_time_ms` |  5,500.50 |  11,001 |  6,184 |  4,817 |
| `main_trace_commit_time_ms` |  1,081.50 |  2,163 |  1,320 |  843 |
| `generate_perm_trace_time_ms` |  170 |  340 |  189 |  151 |
| `perm_trace_commit_time_ms` |  1,183.50 |  2,367 |  1,236 |  1,131 |
| `quotient_poly_compute_time_ms` |  746.50 |  1,493 |  867 |  626 |
| `quotient_poly_commit_time_ms` |  980 |  1,960 |  1,126 |  834 |
| `pcs_opening_time_ms ` |  1,329 |  2,658 |  1,438 |  1,220 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  14,625.50 |  29,251 |  14,698 |  14,553 |
| `main_cells_used     ` |  129,448,509 |  258,897,018 |  131,049,470 |  127,847,548 |
| `total_cycles        ` |  2,941,773 |  5,883,546 |  2,978,237 |  2,905,309 |
| `execute_time_ms     ` |  646.50 |  1,293 |  698 |  595 |
| `trace_gen_time_ms   ` |  2,636.50 |  5,273 |  2,741 |  2,532 |
| `stark_prove_excluding_trace_time_ms` |  11,342.50 |  22,685 |  11,362 |  11,323 |
| `main_trace_commit_time_ms` |  2,326 |  4,652 |  2,339 |  2,313 |
| `generate_perm_trace_time_ms` |  283 |  566 |  283 |  283 |
| `perm_trace_commit_time_ms` |  2,286.50 |  4,573 |  2,288 |  2,285 |
| `quotient_poly_compute_time_ms` |  1,648.50 |  3,297 |  1,664 |  1,633 |
| `quotient_poly_commit_time_ms` |  2,194 |  4,388 |  2,204 |  2,184 |
| `pcs_opening_time_ms ` |  2,600 |  5,200 |  2,601 |  2,599 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 2,532 | 14,553 | 2,978,237 | 353,773,272 | 11,323 | 1,633 | 2,204 | 2,288 | 2,599 | 2,313 | 131,049,470 | 283 | 698 | 
| leaf | 1 | 2,741 | 14,698 | 2,905,309 | 353,780,696 | 11,362 | 1,664 | 2,184 | 2,285 | 2,601 | 2,339 | 127,847,548 | 283 | 595 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,870 | 8,539 |  | 209,921,543 | 6,184 | 867 | 1,126 | 1,236 | 1,438 | 1,320 | 92,686,348 | 189 | 485 | 
| regex_program | 1 | 1,493 | 6,727 | 1,914,103 | 149,454,692 | 4,817 | 626 | 834 | 1,131 | 1,220 | 843 | 72,769,025 | 151 | 417 | 

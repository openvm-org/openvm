...
| `total_proof_time_ms ` |  4,021.50 |  8,043 |  4,475 |  3,568 |
...
| `trace_gen_time_ms   ` |  979 |  1,958 |  1,163 |  795 |
| `stark_prove_excluding_trace_time_ms` |  2,706 |  5,412 |  2,938 |  2,474 |
| `main_trace_commit_time_ms` |  472.50 |  945 |  533 |  412 |
| `generate_perm_trace_time_ms` |  185 |  370 |  198 |  172 |
| `perm_trace_commit_time_ms` |  686.50 |  1,373 |  741 |  632 |
| `quotient_poly_compute_time_ms` |  390 |  780 |  416 |  364 |
| `quotient_poly_commit_time_ms` |  278.50 |  557 |  315 |  242 |
| `pcs_opening_time_ms ` |  684.50 |  1,369 |  726 |  643 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,260 |  14,520 |  7,355 |  7,165 |
| `main_cells_used     ` |  152,278,597 |  304,557,194 |  154,678,054 |  149,879,140 |
| `total_cycles        ` |  1,991,061 |  3,982,122 |  2,021,855 |  1,960,267 |
| `execute_time_ms     ` |  767 |  1,534 |  775 |  759 |
| `trace_gen_time_ms   ` |  1,456 |  2,912 |  1,472 |  1,440 |
| `stark_prove_excluding_trace_time_ms` |  5,037 |  10,074 |  5,108 |  4,966 |
| `main_trace_commit_time_ms` |  808.50 |  1,617 |  816 |  801 |
| `generate_perm_trace_time_ms` |  373.50 |  747 |  387 |  360 |
| `perm_trace_commit_time_ms` |  1,538 |  3,076 |  1,566 |  1,510 |
| `quotient_poly_compute_time_ms` |  766.50 |  1,533 |  769 |  764 |
| `quotient_poly_commit_time_ms` |  489.50 |  979 |  490 |  489 |
| `pcs_opening_time_ms ` |  1,056.50 |  2,113 |  1,075 |  1,038 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,472 | 7,355 | 2,021,855 | 538,660,330 | 5,108 | 769 | 490 | 1,566 | 1,075 | 816 | 154,678,054 | 387 | 775 | 
| leaf | 1 | 1,440 | 7,165 | 1,960,267 | 538,660,330 | 4,966 | 764 | 489 | 1,510 | 1,038 | 801 | 149,879,140 | 360 | 759 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,163 | 4,475 | 2,243,715 | 275,652,919 | 2,938 | 416 | 315 | 741 | 726 | 533 | 93,500,799 | 198 | 374 | 
| regex_program | 1 | 795 | 3,568 | 1,921,511 | 242,975,404 | 2,474 | 364 | 242 | 632 | 643 | 412 | 73,010,353 | 172 | 299 | 

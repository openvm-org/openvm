...
| `total_proof_time_ms ` |  5,337 |  5,337 |  5,337 |  5,337 |
| `main_cells_used     ` |  51,485,080 |  51,485,080 |  51,485,080 |  51,485,080 |
| `total_cycles        ` |  1,500,095 |  1,500,095 |  1,500,095 |  1,500,095 |
| `execute_time_ms     ` |  312 |  312 |  312 |  312 |
| `trace_gen_time_ms   ` |  824 |  824 |  824 |  824 |
| `stark_prove_excluding_trace_time_ms` |  4,201 |  4,201 |  4,201 |  4,201 |
| `main_trace_commit_time_ms` |  870 |  870 |  870 |  870 |
| `generate_perm_trace_time_ms` |  136 |  136 |  136 |  136 |
| `perm_trace_commit_time_ms` |  816 |  816 |  816 |  816 |
| `quotient_poly_compute_time_ms` |  524 |  524 |  524 |  524 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,054 |  7,054 |  7,054 |  7,054 |
| `main_cells_used     ` |  69,417,340 |  69,417,340 |  69,417,340 |  69,417,340 |
| `total_cycles        ` |  1,924,761 |  1,924,761 |  1,924,761 |  1,924,761 |
| `execute_time_ms     ` |  304 |  304 |  304 |  304 |
| `trace_gen_time_ms   ` |  1,305 |  1,305 |  1,305 |  1,305 |
| `stark_prove_excluding_trace_time_ms` |  5,445 |  5,445 |  5,445 |  5,445 |
...
| `quotient_poly_commit_time_ms` |  1,108 |  1,108 |  1,108 |  1,108 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 1,305 | 7,054 | 1,924,761 | 157,336,536 | 5,445 | 779 | 1,108 | 1,025 | 1,303 | 1,096 | 69,417,340 | 130 | 304 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fibonacci_program | 0 | 824 | 5,337 | 1,500,095 | 122,458,476 | 4,201 | 524 | 791 | 816 | 1,060 | 870 | 51,485,080 | 136 | 312 | 

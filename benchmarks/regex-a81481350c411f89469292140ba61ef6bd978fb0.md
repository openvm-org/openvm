...
| `total_proof_time_ms ` |  3,824.50 |  7,649 |  4,938 |  2,711 |
...
| `execute_preflight_insn_mi/s` |  28.57 | -          |  31.01 |  26.14 |
| `trace_gen_time_ms   ` |  383 |  766 |  488 |  278 |
| `memory_finalize_time_ms` |  8 |  16 |  13 |  3 |
| `stark_prove_excluding_trace_time_ms` |  3,120 |  6,240 |  4,105 |  2,135 |
| `main_trace_commit_time_ms` |  611.50 |  1,223 |  836 |  387 |
| `generate_perm_trace_time_ms` |  236 |  472 |  317 |  155 |
| `perm_trace_commit_time_ms` |  649.50 |  1,299 |  851 |  448 |
| `quotient_poly_compute_time_ms` |  331.50 |  663 |  452 |  211 |
| `quotient_poly_commit_time_ms` |  301.50 |  603 |  396 |  207 |
| `pcs_opening_time_ms ` |  982.50 |  1,965 |  1,247 |  718 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  5,763.50 |  11,527 |  6,958 |  4,569 |
| `main_cells_used     ` |  122,269,797 |  244,539,594 |  153,708,980 |  90,830,614 |
| `total_cells_used    ` |  304,358,241 |  608,716,482 |  391,461,682 |  217,254,800 |
| `execute_preflight_insns` |  1,663,324.50 |  3,326,649 |  1,830,035 |  1,496,614 |
| `execute_preflight_time_ms` |  578.50 |  1,157 |  735 |  422 |
| `execute_preflight_insn_mi/s` |  4.40 | -          |  4.55 |  4.25 |
| `trace_gen_time_ms   ` |  305 |  610 |  377 |  233 |
| `memory_finalize_time_ms` |  11.50 |  23 |  14 |  9 |
| `stark_prove_excluding_trace_time_ms` |  3,863.50 |  7,727 |  4,829 |  2,898 |
| `main_trace_commit_time_ms` |  709 |  1,418 |  841 |  577 |
| `generate_perm_trace_time_ms` |  319 |  638 |  419 |  219 |
| `perm_trace_commit_time_ms` |  961.50 |  1,923 |  1,246 |  677 |
| `quotient_poly_compute_time_ms` |  479.50 |  959 |  601 |  358 |
| `quotient_poly_commit_time_ms` |  316.50 |  633 |  374 |  259 |
| `pcs_opening_time_ms ` |  1,073 |  2,146 |  1,343 |  803 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 6,960 |  | 1 |  | 1 |  |  |  |  | 
| regex_program |  | 2,711 |  | 6 | 1 | 31 | 4,108,597 | 130.89 | 44 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 233 | 4,569 | 217,254,800 | 319,626,730 | 233 | 2,898 | 0 | 358 | 259 | 677 | 803 | 9 | 577 | 90,830,614 | 219 | 422 | 1,496,614 | 4.25 | 
| leaf | 1 | 377 | 6,958 | 391,461,682 | 538,660,330 | 377 | 4,829 | 0 | 601 | 374 | 1,246 | 1,343 | 14 | 841 | 153,708,980 | 419 | 735 | 1,830,035 | 4.55 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 488 | 4,938 | 211,758,557 | 373,183,036 | 488 | 4,105 | 0 | 452 | 396 | 851 | 1,247 | 7 | 13 | 836 | 91,281,687 | 317 | 103 | 2,211,000 | 26.14 | 
| regex_program | 1 | 278 | 2,711 | 174,326,267 | 196,838,026 | 278 | 2,135 | 51 | 211 | 207 | 448 | 718 | 7 | 3 | 387 | 73,453,305 | 155 | 85 | 1,897,597 | 31.01 | 

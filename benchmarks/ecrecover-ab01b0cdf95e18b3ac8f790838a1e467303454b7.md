...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  41,169 |  41,169 |  41,169 |  41,169 |
| `main_cells_used     ` |  365,885,227 |  365,885,227 |  365,885,227 |  365,885,227 |
| `total_cycles        ` |  8,652,418 |  8,652,418 |  8,652,418 |  8,652,418 |
| `execute_time_ms     ` |  2,529 |  2,529 |  2,529 |  2,529 |
| `trace_gen_time_ms   ` |  6,485 |  6,485 |  6,485 |  6,485 |
| `stark_prove_excluding_trace_time_ms` |  32,155 |  32,155 |  32,155 |  32,155 |
| `main_trace_commit_time_ms` |  5,823 |  5,823 |  5,823 |  5,823 |
| `generate_perm_trace_time_ms` |  710 |  710 |  710 |  710 |
| `perm_trace_commit_time_ms` |  7,171 |  7,171 |  7,171 |  7,171 |
| `quotient_poly_compute_time_ms` |  6,681 |  6,681 |  6,681 |  6,681 |
| `quotient_poly_commit_time_ms` |  5,259 |  5,259 |  5,259 |  5,259 |
| `pcs_opening_time_ms ` |  6,509 |  6,509 |  6,509 |  6,509 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| leaf | 0 | 6,485 | 41,169 | 8,652,418 | 1,052,183,000 | 32,155 | 6,681 | 5,259 | 7,171 | 6,509 | 5,823 | 365,885,227 | 710 | 2,529 | 

| group | segment | trace_gen_time_ms | total_proof_time_ms | total_cycles | total_cells | stark_prove_excluding_trace_time_ms | quotient_poly_compute_time_ms | quotient_poly_commit_time_ms | perm_trace_commit_time_ms | pcs_opening_time_ms | main_trace_commit_time_ms | main_cells_used | generate_perm_trace_time_ms | execute_time_ms |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ecrecover_program | 0 | 269 | 2,609 | 285,401 | 56,172,159 | 2,183 | 294 | 305 | 529 | 625 | 387 | 15,092,297 | 40 | 157 | 

...
As of July 2026, OpenVM v2.0.0 and later are recommended for production use. OpenVM v2.0.0 completed an external [audit](https://github.com/openvm-org/openvm/blob/main/audits/v2/) by [zkSecurity](https://zksecurity.xyz/).

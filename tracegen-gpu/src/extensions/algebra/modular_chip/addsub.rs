...
use derive_new::new;
use openvm_algebra_circuit::modular_chip::addsub_expr;
...
mod tests {
    ...
    use openvm_algebra_circuit::modular_chip::{
        get_modular_addsub_air, get_modular_addsub_chip, get_modular_addsub_step, ModularAir,
        ModularChip, ModularExecutor,
    };
    ...
    >(
        ...
        let (a, b, op) = if is_setup {
            ...
            let op = match op {
                0 => Rv32ModularArithmeticOpcode::ADD as usize,
                1 => Rv32ModularArithmeticOpcode::SUB as usize,
                _ => panic!(),
            };
            a %= modulus;
            b %= modulus;
    ...
    >(
        ...
        for i in 0..num_ops {
            set_and_execute_addsub::<BLOCKS, BLOCK_SIZE, NUM_LIMBS>(
                &mut tester,
                &mut harness,
                &mut rng,
                &modulus,
    ...
    #[test]
    fn test_modular_addsub_gpu_1x32_small() {
    ...
    #[test]
    fn test_modular_addsub_gpu_1x32() {
        run_test_with_config::<1, 32, 32>(secp256k1_coord_prime(), 50);
    }

    #[test]
    fn test_modular_addsub_gpu_3x16() {

...
__device__ void limb_mul_mixed(
    uint32_t *result,
    const uint32_t *a,
    const uint32_t *b2,
    uint32_t num_limbs,
    ...
    for (int i = 0; i < 3 * (int)num_limbs; i++)
        result[i] = 0;
...
__device__ inline void limb_mod_reduce(
    uint32_t *result,
...
__device__ inline void limb_mod_sub(
    uint32_t *result,
    const uint32_t *a,
    const uint32_t *b,
    const uint32_t *prime,
...
__device__ inline void limb_mod_inverse(
    uint32_t *result,
    const uint32_t *a,
    const uint32_t *prime,
    uint32_t num_limbs,
...
__device__ inline void limb_mod_div(
    uint32_t *result,
    const uint32_t *a,
    const uint32_t *b,
    const uint32_t *prime,
...
__device__ inline void limb_int_add(
    uint32_t *result,
    const uint32_t *a,
    int32_t scalar,
    uint32_t num_limbs,
...
__device__ inline void limb_int_mul(
    uint32_t *result,
    const uint32_t *a,
    int32_t scalar,
    uint32_t num_limbs,

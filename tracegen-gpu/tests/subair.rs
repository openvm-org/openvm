...
use tracegen_gpu::{
    ...
    testing::assert_eq_cpu_and_gpu_matrix,
};
...
fn test_fibair_tracegen() {
    ...
    for log_height in 1..=2 {
        ...
        let proving_ctx: AirProvingContext<CpuBackend<SC>> = chip.generate_proving_ctx(());
        assert_eq_cpu_and_gpu_matrix(proving_ctx.common_main.unwrap(), &output);
    }
}

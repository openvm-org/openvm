...
| **LUI**   | `a, b, _`                                     | Set `[a]_1 <- [b]_0 << 12`. The immediate `[b]_0` is constrained to be at most 20 bits.                                                                                |
| **AUIPC** | `a, b, _`                                     | Set `[a]_1 <- pc + ([b]_0 << 12)`. The immediate `[b]_0` is constrained to be at most 20 bits, where addition is mod `2^32`.                                                                                |

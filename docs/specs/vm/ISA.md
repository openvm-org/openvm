...
| ----------- | ------------ | ------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| HintSqrtMod | 10           | `a,_,c_upper` | Uses `c_upper = N::IDX` to determine the index of the modulus `N`, from the list of enabled moduli for modular arithmetic instructions. Let `x = [r32{0}(a): N::NUM_LIMBS]_2` be an integer modulo `N`. Let `y = sqrt(x)` be the square root of `x` modulo `N` if it exists, or `[0; N::NUM_LIMBS]` otherwise. The sub-instruction resets the hint stream to equal `y` as `N::NUM_LIMBS` bytes. |

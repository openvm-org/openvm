...
[stark-backend](https://github.com/openvm-org/stark-backend/blob/v2.0.0/crates/stark-sdk/src/config/mod.rs#L121),
which also includes a
[soundness calculator](https://github.com/openvm-org/stark-backend/blob/v2.0.0/crates/stark-backend/src/soundness/calculator.rs#L25)

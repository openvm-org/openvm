...
involved in the [Continuations Design](/specs/architecture/continuations).

| Proof | Type | Security Bits | `log_blowup` | `num_queries` | `proof_of_work_bits` |
| --- | --- | --- | --- | --- | --- |
| `app` | STARK | 100 | 1 | 1 | 1 |
| `leaf` | STARK | 100 | 1 | 1 | 1 |
| `internal` | STARK | 100 | 1 | 1 | 1 |
| `root` | STARK | 100 | 1 | 1 | 1 |

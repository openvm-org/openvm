...
| Name              | Discriminant | Operands | Description                                                                                                                                                                                                                                                    |
|-------------------| ------------ | -------- |----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Rv64HintInput     | 0x20         | `_`      | Pops a vector `hint` of field elements from the input stream and resets the hint stream to equal `[(hint.len() as u32).to_le_bytes(), hint, zero padding to 8-byte alignment].concat()`.                                                                       |

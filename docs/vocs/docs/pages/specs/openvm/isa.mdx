...
- [RV32IM/RV64IM](#rv32imrv64im-extension): An extension supporting the 32-bit and 64-bit RISC-V ISA with multiplication.
...
### RV32IM/RV64IM Extensions {#rv32imrv64im-extension}

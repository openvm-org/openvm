...
spaces `1`, `2`, `3`, and `4`, the minimum block size is 4, meaning all accesses must be at pointer addresses that are
...
| `3`           | User IO     |                                                                                   |
| `4`           | Deferral    | Elements are typically full field elements.                                       |

...
- **Guest**: `riscv64im-unknown-openvm-elf` with the prebuilt `openvm-nightly-2026-01-18` toolchain from the [openvm-org/rust](https://github.com/openvm-org/rust) fork (based on `rustc 1.94.0-nightly (fe98ddcfc 2026-01-17)`).

...
- **Host**: We support `aarch64-apple-darwin` and `x86_64-unknown-linux-gnu` with Rust 1.93.0.
For reproducible builds, we recommend using the `x86_64-unknown-linux-gnu` platform.
- **Guest**: `riscv32im-risc0-zkvm-elf` with Rust `nightly-2025-12-05`: `rustc 1.93.0-nightly (b33119ffd 2025-12-04)`.

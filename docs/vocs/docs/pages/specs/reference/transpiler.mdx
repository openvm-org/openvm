...
| RISC-V Inst     | OpenVM Instruction                                                                                                                                                |
| --------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| sw_add_proj\<C\>  | SW_EC_ADD_PROJ\<C\> `ind(rd), ind(rs1), ind(rs2), 1, 2`                                                                                                           |
| sw_double_proj\<C\>  | SW_EC_DOUBLE_PROJ\<C\> `ind(rd), ind(rs1), 0, 1, 2`                                                                                                                  |
| sw_setup\<C\>      | SETUP_SW_EC_ADD_PROJ\<C\> `ind(rd), ind(rs1), ind(rs2), 1, 2` if `ind(rs2) != 0`, SETUP_SW_EC_DOUBLE_PROJ\<C\> `ind(rd), ind(rs1), ind(rs2), 1, 2` if `ind(rs2) = 0` |

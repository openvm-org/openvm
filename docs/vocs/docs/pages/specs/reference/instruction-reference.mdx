...
| VM Extension | `LocalOpcode` | ISA Instruction |
| ------------- | ---------- | ------------- |
| Short Weierstrass Elliptic Curve | `Rv32WeierstrassOpcode::SW_EC_ADD_NE` | SW_EC_ADD_NE\<C\> |
| Short Weierstrass Elliptic Curve | `Rv32WeierstrassOpcode::SETUP_SW_EC_ADD_NE` | SETUP_SW_EC_ADD_NE\<C\> |
| Short Weierstrass Elliptic Curve | `Rv32WeierstrassOpcode::SW_EC_DOUBLE` | SW_EC_DOUBLE\<C\> |
| Short Weierstrass Elliptic Curve | `Rv32WeierstrassOpcode::SETUP_SW_EC_DOUBLE` | SETUP_SW_EC_DOUBLE\<C\> |
...
| VM Extension | `LocalOpcode` | ISA Instruction |
| ------------- | ---------- | ------------- |
| Twisted Edwards Elliptic Curve | `Rv32TeOpcode::TE_EC_ADD` | TE_EC_ADD\<C\> |
| Twisted Edwards Elliptic Curve | `Rv32TeOpcode::SETUP_TE_EC_ADD` | SETUP_TE_EC_ADD\<C\> |

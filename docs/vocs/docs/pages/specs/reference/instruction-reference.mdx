...
| VM Extension | `LocalOpcode` | ISA Instruction |
| ------------- | ---------- | ------------- |
| Short Weierstrass Elliptic Curve | `Rv32WeierstrassOpcode::EC_ADD_NE` | EC_ADD_NE\<C\> |
| Short Weierstrass Elliptic Curve | `Rv32WeierstrassOpcode::SETUP_EC_ADD_NE` | SETUP_EC_ADD_NE\<C\> |
| Short Weierstrass Elliptic Curve | `Rv32WeierstrassOpcode::EC_DOUBLE` | EC_DOUBLE\<C\> |
| Short Weierstrass Elliptic Curve | `Rv32WeierstrassOpcode::SETUP_EC_DOUBLE` | SETUP_EC_DOUBLE\<C\> |
...
| VM Extension | `LocalOpcode` | ISA Instruction |
| ------------- | ---------- | ------------- |
| Twisted Edwards Elliptic Curve | `Rv32TeOpcode::TE_ADD` | TE_ADD\<C\> |
| Twisted Edwards Elliptic Curve | `Rv32TeOpcode::SETUP_TE_ADD` | SETUP_TE_ADD\<C\> |

...
| VM Extension | `LocalOpcode` | ISA Instruction |
| ------------- | ---------- | ------------- |
| Short Weierstrass Elliptic Curve | `Rv32WeierstrassOpcode::EC_ADD_NE` | SW_EC_ADD_PROJ\<C\> |
| Short Weierstrass Elliptic Curve | `Rv32WeierstrassOpcode::SETUP_EC_ADD_NE` | SETUP_SW_EC_ADD_PROJ\<C\> |
| Short Weierstrass Elliptic Curve | `Rv32WeierstrassOpcode::EC_DOUBLE` | SW_EC_DOUBLE_PROJ\<C\> |
| Short Weierstrass Elliptic Curve | `Rv32WeierstrassOpcode::SETUP_EC_DOUBLE` | SETUP_SW_EC_DOUBLE_PROJ\<C\> |

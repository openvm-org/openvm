...
| VM Extension | `LocalOpcode` | ISA Instruction |
| ------------- | ---------- | ------------- |
| Deferral | `DeferralOpcode::CALL` | CALL |
| Deferral | `DeferralOpcode::OUTPUT` | OUTPUT |
...
| VM Extension | `LocalOpcode` | ISA Instruction |
| ------------- | ---------- | ------------- |
| Short Weierstrass Elliptic Curve | `Rv32WeierstrassOpcode::SW_EC_ADD_PROJ` | SW_EC_ADD_PROJ\<C\> |
| Short Weierstrass Elliptic Curve | `Rv32WeierstrassOpcode::SETUP_SW_EC_ADD_PROJ` | SETUP_SW_EC_ADD_PROJ\<C\> |
| Short Weierstrass Elliptic Curve | `Rv32WeierstrassOpcode::SW_EC_DOUBLE_PROJ` | SW_EC_DOUBLE_PROJ\<C\> |
| Short Weierstrass Elliptic Curve | `Rv32WeierstrassOpcode::SETUP_SW_EC_DOUBLE_PROJ` | SETUP_SW_EC_DOUBLE_PROJ\<C\> |

...
| ----------- | --- | ----------- | ------ | -------- | ---------------------------------------------------------------- |
| def_call    | I   | 0101011     | 111    | 0x0      | Deferred call: reads 32-byte input commitment from `[rs1]`, writes 40-byte `OutputKey` to `[rd]`. `imm[11:2]` = deferral index. |
| def_output  | I   | 0101011     | 111    | 0x1      | Retrieve deferred output: reads 40-byte `OutputKey` from `[rs1]`, writes output bytes to `[rd]`. `imm[11:2]` = deferral index. |

...
- [Short Weierstrass Elliptic curve](#short-weierstrass-elliptic-curve-extension): An extension for elliptic curve operations over short Weierstrass curves, including addition and doubling. This can be used to implement multi-scalar multiplication and ECDSA scalar multiplication. This extension respects the RISC-V memory format.
- [Twisted Edwards Elliptic curve](#twisted-edwards-elliptic-curve-extension): An extension for elliptic curve operations over twisted Edwards curves, including addition. This can be used to implement multi-scalar multiplication. This extension respects the RISC-V memory format.
...
The elliptic curve extension supports arithmetic over twisted Edwards curves, which requires specification of the elliptic curve `C`. The extension must be configured to support a fixed ordered list of supported curves. We use `config.curve_idx(C)` to denote the index of `C` in this list. In the list below, `idx` denotes `config.curve_idx(C)`.

| RISC-V Inst     | FMT | opcode[6:0] | funct3 | funct7    | RISC-V description and notes                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| --------------- | --- | ----------- | ------ | --------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| te_add\<C\>     | R   | 0101011     | 100    | `idx*8`   | `TePoint([rd:2*C::COORD_SIZE]_2) = TePoint([rs1:2*C::COORD_SIZE]_2) + TePoint([rs2:2*C::COORD_SIZE]_2)`.                                                                                                                                                                                                                                                                                                                                                   |
| te_setup\<C\>   | R   | 0101011     | 100    | `idx*8+1` | `assert([rs1: 2 * C::COORD_SIZE]_2 == [C::MODULUS, C::A] && [rs2: C::COORD_SIZE]_2 == C::D)`. For the sake of implementation convenience it also writes an unconstrained value into `[rd: C::COORD_SIZE]_2`.                                                                                                                                                                                                                                                                                                                                                                  |

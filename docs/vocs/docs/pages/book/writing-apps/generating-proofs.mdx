...
2. **`*.baseline.json`** — contains the full verification baseline used by `cargo openvm verify stark`, including the exe commit, memory dimensions, and all aggregation VK commits.

...
The OpenVM Short Weierstrass Elliptic Curve Cryptography Extension provides support for short Weierstrass elliptic curve operations through the `openvm-ecc-guest` crate.

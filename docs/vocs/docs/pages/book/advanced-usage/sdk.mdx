...
`Sdk::standard()` supports a wider variety of VM extensions, increasing the performance of many cryptographic operations. For more inforamtion, see [Another Example: Using the Standard SDK](/book/advanced-usage/sdk#another-example-using-the-standard-sdk) below.

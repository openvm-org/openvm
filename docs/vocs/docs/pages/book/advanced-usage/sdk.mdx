...
<details>
<summary>To to customize your `Sdk`, you may need additional dependencies. Click here to view.</summary>
...
:::warning
The halo2 aggregation proving key generated in the above example is very large.
:::

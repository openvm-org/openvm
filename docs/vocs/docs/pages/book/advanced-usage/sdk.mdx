...
// [!include ~/docs/snippets/examples/sdk_app.rs:dependencies]
```
...
```rust,no_run,noplayground
// [!include ~/docs/snippets/examples/sdk_app.rs:build]
// [!include ~/docs/snippets/examples/sdk_app.rs:read_elf]

// [!include ~/docs/snippets/examples/sdk_app.rs:transpilation]
```
...
```rust,no_run,noplayground
// [!include ~/docs/snippets/examples/sdk_app.rs:vm_config]
```
...
```rust,no_run,noplayground
// [!include ~/docs/snippets/examples/sdk_app.rs:execution]
```
...
```rust,no_run,noplayground
// [!include ~/docs/snippets/examples/sdk_app.rs:proof_generation]
```
...
```rust,no_run,noplayground
// [!include ~/docs/snippets/examples/sdk_app.rs:verification]
```
...
```rust,no_run,noplayground
// [!include ~/docs/snippets/examples/sdk_evm.rs:keygen]
```
...
```rust,no_run,noplayground
// [!include ~/docs/snippets/examples/sdk_evm.rs:evm_verification]
```

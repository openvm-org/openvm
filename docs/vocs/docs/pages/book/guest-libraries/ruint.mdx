...
openvm-ruint = { git = "https://github.com/openvm-org/openvm.git", tag = "v2.0.0-beta.2", package = "ruint" }
```
...
[patch.crates-io]
ruint = { git = "https://github.com/openvm-org/openvm.git", tag = "v2.0.0-beta.2" }
```

...
The Ruint guest library is [a fork of ruint](https://github.com/axiom-crypto/uint) that allows for patching of U256 operations with logic from [openvm-bigint-guest](/book/acceleration-using-extensions/big-integer).
...
openvm-ruint = { git = "https://github.com/axiom-crypto/uint.git", branch = "v1.14.0-openvm", package = "ruint" }
```
...
[patch.crates-io]
ruint = { git = "https://github.com/axiom-crypto/uint.git", branch = "v1.14.0-openvm" }
```

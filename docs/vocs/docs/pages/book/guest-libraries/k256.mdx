...
// [!include docs/snippets/examples/ecc/src/main.rs:imports]
// [!include docs/snippets/examples/ecc/src/main.rs:init]
```
...
```rust,no_run,noplayground
// [!include docs/snippets/examples/ecc/src/main.rs:main]
```

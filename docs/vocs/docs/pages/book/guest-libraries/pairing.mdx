...
// [!include ~/docs/docs/snippets/examples/pairing/src/main.rs:imports]
```
...
// [!include ~/docs/docs/snippets/examples/pairing/src/main.rs:init]
```
...
```rust,no_run,noplayground
// [!include ~/docs/docs/snippets/examples/pairing/src/main.rs:pairing_check]
```
...
```rust,no_run,noplayground
// [!include ~/docs/docs/snippets/examples/pairing/src/main.rs:pre]
// [!include ~/docs/docs/snippets/examples/pairing/src/main.rs:imports]

// [!include ~/docs/docs/snippets/examples/pairing/src/main.rs:init]

// [!include ~/docs/docs/snippets/examples/pairing/src/main.rs:main]
```

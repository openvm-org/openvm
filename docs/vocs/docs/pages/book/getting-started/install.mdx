...
```bash
cargo +1.90 install --locked --git https://github.com/openvm-org/openvm.git --tag v1.4.1 cargo-openvm
```
...
```bash
cargo +1.90 install --locked --git https://github.com/openvm-org/openvm.git --tag v1.4.1 --features cuda cargo-openvm
```

...
```bash
cargo +1.90 install --locked --git https://github.com/openvm-org/openvm.git --tag v1.7.0 cargo-openvm
```
...
```bash
cargo +1.90 install --locked --git https://github.com/openvm-org/openvm.git --tag v1.7.0 --features cuda cargo-openvm
```
...
:::code-group
```bash [Without GPU]
cargo +1.90 install --locked --git https://github.com/openvm-org/openvm.git --tag v1.7.0 --features aot cargo-openvm
```
```bash [Nvidia GPU]
cargo +1.90 install --locked --git https://github.com/openvm-org/openvm.git --tag v1.7.0 --features aot,cuda cargo-openvm
```
:::

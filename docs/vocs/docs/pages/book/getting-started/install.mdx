...
This downloads the prebuilt tarball for your host triple from the fork's [Releases](https://github.com/openvm-org/rust/releases) page, extracts it under `~/.openvm/toolchains/`, and links it into rustup. To install a specific release, pass `--version <tag>` (e.g. `--version openvm-nightly-2026-01-18`).

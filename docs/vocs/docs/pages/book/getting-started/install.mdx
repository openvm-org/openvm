...
```bash
cargo +1.93 install --locked --git https://github.com/openvm-org/openvm.git --tag v1.5.0 cargo-openvm
```
...
```bash
cargo +1.93 install --locked --git https://github.com/openvm-org/openvm.git --tag v1.5.0 --features cuda cargo-openvm
```
...
:::code-group
```bash [Without GPU]
cargo +nightly-2025-12-05 install --locked --git https://github.com/openvm-org/openvm.git --tag v1.5.0 --features tco cargo-openvm
```
```bash [Nvidia GPU]
cargo +nightly-2025-12-05 install --locked --git https://github.com/openvm-org/openvm.git --tag v1.5.0 --features tco,cuda cargo-openvm
```
:::
...
:::code-group
```bash [Without GPU]
cargo +nightly-2025-12-05 install --locked --force --path crates/cli --features tco
```
```bash [Nvidia GPU]
cargo +nightly-2025-12-05 install --locked --force --path crates/cli --features tco,cuda
```
:::
...
:::code-group
```bash [Without GPU]
cargo +1.93 install --locked --git https://github.com/openvm-org/openvm.git --tag v1.5.0 --features aot cargo-openvm
```
```bash [Nvidia GPU]
cargo +1.93 install --locked --git https://github.com/openvm-org/openvm.git --tag v1.5.0 --features aot,cuda cargo-openvm
```
:::
...
:::code-group
```bash [Without GPU]
cargo +1.93 install --locked --force --path crates/cli --features aot
```
```bash [Nvidia GPU]
cargo +1.93 install --locked --force --path crates/cli --features aot,cuda
```
:::

...
:::code-group
```bash [Without GPU]
cargo +nightly-2026-09-10 install --locked --git https://github.com/openvm-org/openvm.git --tag v2.0.0 --features tco cargo-openvm
```
```bash [Nvidia GPU]
cargo +nightly-2026-09-10 install --locked --git https://github.com/openvm-org/openvm.git --tag v2.0.0 --features tco,cuda cargo-openvm
```
:::

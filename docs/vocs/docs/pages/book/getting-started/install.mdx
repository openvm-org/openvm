...
rustup install nightly-2026-09-10
...
:::code-group
```bash [Without GPU]
cargo +nightly-2026-09-10 install --locked --git https://github.com/openvm-org/openvm.git --tag v2.1.0 --features tco cargo-openvm
```
```bash [Nvidia GPU]
cargo +nightly-2026-09-10 install --locked --git https://github.com/openvm-org/openvm.git --tag v2.1.0 --features tco,cuda cargo-openvm
```
:::
...
:::code-group
```bash [Without GPU]
cargo +nightly-2026-09-10 install --locked --force --path crates/cli --features tco
```
```bash [Nvidia GPU]
cargo +nightly-2026-09-10 install --locked --force --path crates/cli --features tco,cuda
```
:::

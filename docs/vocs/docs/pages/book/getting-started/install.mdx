...
:::code-group
```bash [Without GPU]
cargo +nightly-2025-08-19 install --locked --git https://github.com/openvm-org/openvm.git --tag v1.4.0-rc.8 --features tco cargo-openvm
```
```bash [Nvidia GPU]
cargo +nightly-2025-08-19 install --locked --git https://github.com/openvm-org/openvm.git --tag v1.4.0-rc.8 --features tco,cuda cargo-openvm
```
:::

...
- [Writing applications](../writing-apps/overview) in Rust targeting OpenVM and generating proofs.
- [Acceleration using extensions](../acceleration-using-extensions/overview) to optimize your Rust programs.
- An assortment of helpful [guest libraries](../guest-libraries/keccak256) designed for direct use within your guest programs.
- [How to add custom VM extensions](../advanced-usage/creating-a-new-extension).

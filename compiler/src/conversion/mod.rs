...
fn convert_instruction<F: PrimeField32, EF: ExtensionField<F>>(
    ...
    let instructions = match instruction {
        ...
        AsmInstruction::SubU256(dst, src1, src2) => vec![inst_med(
            SUB256,
            i32_f(dst),
            i32_f(src1),
            i32_f(src2),
        ...
        AsmInstruction::LessThanU256(dst, src1, src2) => vec![inst_med(
            LT256,
            i32_f(dst),
            i32_f(src1),
            i32_f(src2),
        ...
        AsmInstruction::EqualToU256(dst, src1, src2) => vec![inst_med(
            EQ256,
            i32_f(dst),
            i32_f(src1),
            i32_f(src2),

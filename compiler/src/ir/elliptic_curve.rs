    ...
    C::N: PrimeField64,
{
    pub fn ec_add(
        ...
        let x1_zero = self.bigint_is_zero(x1);
        let y1_zero = self.bigint_is_zero(y1);
        let x2_zero = self.bigint_is_zero(x2);
        let y2_zero = self.bigint_is_zero(y2);
                                    ...
                                    builder
                                        ...
                                        .then_or_else(
                                            |builder| {
                                                ...
                                                let three_x_squared =
                                                    builder.mod_mul(&three, &x_squared);
                                                let lambda_value =
                                                    builder.mod_div(&three_x_squared, &two_y);

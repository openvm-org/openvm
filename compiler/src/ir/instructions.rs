...
impl<C: Config> DslIr<C> {
    pub fn to_string(&self) -> String {
        match self {
            ...
            DslIr::ImmE(..) => "ImmE".to_string(),
            DslIr::AddV(..) => "AddV".to_string(),
            DslIr::AddVI(..) => "AddVI".to_string(),
            DslIr::AddF(..) => "AddF".to_string(),
            DslIr::AddFI(..) => "AddFI".to_string(),
            DslIr::AddE(..) => "AddE".to_string(),
            DslIr::AddEI(..) => "AddEI".to_string(),
            DslIr::AddEF(..) => "AddEF".to_string(),
            DslIr::AddEFI(..) => "AddEFI".to_string(),
            DslIr::AddEFFI(..) => "AddEFFI".to_string(),
            DslIr::SubV(..) => "SubV".to_string(),
            DslIr::SubVI(..) => "SubVI".to_string(),
            DslIr::SubVIN(..) => "SubVIN".to_string(),
            DslIr::SubF(..) => "SubF".to_string(),
            DslIr::SubFI(..) => "SubFI".to_string(),
            DslIr::SubFIN(..) => "SubFIN".to_string(),
            DslIr::SubE(..) => "SubE".to_string(),
            DslIr::SubEI(..) => "SubEI".to_string(),
            DslIr::SubEIN(..) => "SubEIN".to_string(),
            DslIr::SubEFI(..) => "SubEFI".to_string(),
            DslIr::SubEF(..) => "SubEF".to_string(),
            DslIr::MulV(..) => "MulV".to_string(),
            DslIr::MulVI(..) => "MulVI".to_string(),
            DslIr::MulF(..) => "MulF".to_string(),
            DslIr::MulFI(..) => "MulFI".to_string(),
            DslIr::MulE(..) => "MulE".to_string(),
            DslIr::MulEI(..) => "MulEI".to_string(),
            DslIr::MulEFI(..) => "MulEFI".to_string(),
            DslIr::MulEF(..) => "MulEF".to_string(),
            DslIr::DivF(..) => "DivF".to_string(),
            DslIr::DivFI(..) => "DivFI".to_string(),
            DslIr::DivFIN(..) => "DivFIN".to_string(),
            DslIr::DivE(..) => "DivE".to_string(),
            DslIr::DivEI(..) => "DivEI".to_string(),
            DslIr::DivEIN(..) => "DivEIN".to_string(),
            DslIr::NegV(..) => "NegV".to_string(),
            DslIr::NegF(..) => "NegF".to_string(),
            DslIr::NegE(..) => "NegE".to_string(),
            DslIr::InvE(..) => "InvE".to_string(),
            DslIr::For(..) => "For".to_string(),
            DslIr::IfEq(..) => "IfEq".to_string(),
            DslIr::IfNe(..) => "IfNe".to_string(),
            DslIr::IfEqI(..) => "IfEqI".to_string(),
            DslIr::IfNeI(..) => "IfNeI".to_string(),
            DslIr::Break => "Break".to_string(),
            DslIr::AssertEqV(..) => "AssertEqV".to_string(),
            DslIr::AssertNeV(..) => "AssertNeV".to_string(),
            DslIr::AssertEqF(..) => "AssertEqF".to_string(),
            DslIr::AssertNeF(..) => "AssertNeF".to_string(),
            DslIr::AssertEqE(..) => "AssertEqE".to_string(),
            DslIr::AssertNeE(..) => "AssertNeE".to_string(),
            DslIr::AssertEqVI(..) => "AssertEqVI".to_string(),
            DslIr::AssertNeVI(..) => "AssertNeVI".to_string(),
            DslIr::AssertEqFI(..) => "AssertEqFI".to_string(),
            DslIr::AssertNeFI(..) => "AssertNeFI".to_string(),
            DslIr::AssertEqEI(..) => "AssertEqEI".to_string(),
            DslIr::AssertNeEI(..) => "AssertNeEI".to_string(),
            DslIr::Alloc(..) => "Alloc".to_string(),
            DslIr::LoadV(..) => "LoadV".to_string(),
            DslIr::LoadF(..) => "LoadF".to_string(),
            DslIr::LoadE(..) => "LoadE".to_string(),
            DslIr::StoreV(..) => "StoreV".to_string(),
            DslIr::StoreF(..) => "StoreF".to_string(),
            DslIr::StoreE(..) => "StoreE".to_string(),
            DslIr::CircuitNum2BitsV(..) => "CircuitNum2BitsV".to_string(),
            DslIr::CircuitNum2BitsF(..) => "CircuitNum2BitsF".to_string(),
            DslIr::Poseidon2PermuteBabyBear(..) => "Poseidon2PermuteBabyBear".to_string(),
            DslIr::Poseidon2CompressBabyBear(..) => "Poseidon2CompressBabyBear".to_string(),
            DslIr::CircuitPoseidon2Permute(..) => "CircuitPoseidon2Permute".to_string(),
            DslIr::PrintV(..) => "PrintV".to_string(),
            DslIr::PrintF(..) => "PrintF".to_string(),
            DslIr::PrintE(..) => "PrintE".to_string(),
            DslIr::Error() => "Error".to_string(),
            DslIr::HintInputVec() => "HintInputVec".to_string(),
            DslIr::HintBitsU(..) => "HintBitsU".to_string(),
            DslIr::HintBitsV(..) => "HintBitsV".to_string(),
            DslIr::HintBitsF(..) => "HintBitsF".to_string(),
            DslIr::StoreHintWord(..) => "StoreHintWord".to_string(),
            DslIr::WitnessVar(..) => "WitnessVar".to_string(),
            DslIr::WitnessFelt(..) => "WitnessFelt".to_string(),
            DslIr::WitnessExt(..) => "WitnessExt".to_string(),
            DslIr::Publish(..) => "Publish".to_string(),
            DslIr::RegisterPublicValue(..) => "RegisterPublicValue".to_string(),
            DslIr::Halt => "Halt".to_string(),
            DslIr::CircuitCommitVkeyHash(..) => "CircuitCommitVkeyHash".to_string(),
            DslIr::CircuitCommitCommitedValuesDigest(..) => {
                "CircuitCommitCommitedValuesDigest".to_string()
            }
            DslIr::FriFold(..) => "FriFold".to_string(),
            DslIr::CircuitSelectV(..) => "CircuitSelectV".to_string(),
            DslIr::CircuitSelectF(..) => "CircuitSelectF".to_string(),
            DslIr::CircuitSelectE(..) => "CircuitSelectE".to_string(),
            DslIr::CircuitExt2Felt(..) => "CircuitExt2Felt".to_string(),
            DslIr::CircuitFelts2Ext(..) => "CircuitFelts2Ext".to_string(),
            DslIr::LessThan(..) => "LessThan".to_string(),
            DslIr::CycleTrackerStart(..) => "CycleTrackerStart".to_string(),
            DslIr::CycleTrackerEnd(..) => "CycleTrackerEnd".to_string(),
        }
    }
}

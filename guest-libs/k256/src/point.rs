...
impl VerifyPrimitive<Secp256k1> for Secp256k1Point {
    fn verify_prehashed(&self, z: &FieldBytes, sig: &Signature) -> Result<(), ecdsa::Error> {
        type PublicKey = openvm_ecc_guest::ecdsa::OpenVMPublicKey<Secp256k1>;
        type VerifyingKey = openvm_ecc_guest::ecdsa::OpenVMVerifyingKey<Secp256k1>;
...
impl FromEncodedPoint<Secp256k1> for Secp256k1Point {
    ...
    fn from_encoded_point(encoded_point: &EncodedPoint) -> CtOption<Self> {
        match openvm_ecc_guest::ecdsa::OpenVMVerifyingKey::<Secp256k1>::from_sec1_bytes(

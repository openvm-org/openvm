...
#[cfg(feature = "ecdsa")]
use openvm_weierstrass_guest::ecdsa::VerifyCustomHook;
#[cfg(feature = "ecdsa")]
use {
...
#[cfg(feature = "ecdsa")]
pub type SigningKey = openvm_weierstrass_guest::ecdsa::SigningKey<Secp256k1>;

/// ECDSA/secp256k1 verification key (i.e. public key)
#[cfg(feature = "ecdsa")]
pub type VerifyingKey = openvm_weierstrass_guest::ecdsa::VerifyingKey<Secp256k1>;
...
impl VerifyPrimitive<Secp256k1> for Secp256k1Point {
    fn verify_prehashed(
        ...
        openvm_weierstrass_guest::ecdsa::verify_prehashed::<Secp256k1>(
            *self,
            z.as_slice(),

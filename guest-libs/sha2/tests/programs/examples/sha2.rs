...
// This is a workaround to allow us to use the sha2 functions which
// expect the address of the input to be 4-byte aligned.
struct AlignedBytes {
    data: Vec<u8>,
    offset: usize,
}
...
impl AlignedBytes {
    fn new(data: &str, alignment: usize) -> Self {
        let mut data = Vec::from_hex(data).unwrap();
        data.reserve(alignment);
        let offset = (alignment - (data.as_ptr() as usize % alignment)) % alignment;
        for _ in 0..offset {
            data.insert(0, 0u8);
        }
        assert_eq!((data.as_ptr() as usize + offset) % alignment, 0);
        Self { data, offset }
    }
...
pub fn main() {
    let test_vectors = [
        ...
        ShaTestVector {
            input: AlignedBytes::new("98c1c0bdb7d5fea9a88859f06c6c439f", 4),
        ...
        ShaTestVector {
            input: AlignedBytes::new("5b58f4163e248467cc1cd3eecafe749e8e2baaf82c0f63af06df0526347d7a11327463c115210a46b6740244eddf370be89c", 4),
        ...
        ShaTestVector {
            input: AlignedBytes::new("", 4),

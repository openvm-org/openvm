...
//     let time_per =
//         Poseidon2Chip::<16, WORD_SIZE, BabyBear>::max_accesses_per_instruction(COMP_POS2);

//     let start_timestamp = timestamp;
//     (0..num_ops).for_each(|i| {
//         Poseidon2Chip::<16, WORD_SIZE, BabyBear>::calculate(
//             segment,
//             timestamp,
...
//         )
//     });
//     let mut chip = Poseidon2Chip::<16, WORD_SIZE, BabyBear>::from_poseidon2_config(

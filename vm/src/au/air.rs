...
impl<AB: AirBuilder> Air<AB> for FieldArithmeticAir {
    fn eval(&self, builder: &mut AB) {
        ...
        builder.assert_eq(
            aux.is_mul,
            aux.opcode_1bit - aux.opcode_1bit * aux.opcode_0bit,
        );
        ...
        builder.assert_eq(
            ...
            io.x + io.y - aux.opcode_0bit * io.y - aux.opcode_0bit * io.y,
        );

        builder.assert_eq(
            io.z,
            aux.is_mul * aux.mul_result + aux.is_div * aux.div_result + aux.lin_term
                - aux.opcode_1bit * aux.lin_term,
        );
    }
}

...
pub enum AxVmInstructionExecutor<F: PrimeField32> {
    ...
    Fp2ModularAddSubRv32_32(Rc<RefCell<Fp2AddSubChip<F, 1, 32>>>),
    Fp2ModularAddSubRv32_48(Rc<RefCell<Fp2AddSubChip<F, 3, 16>>>),
    Fp2ModularMulDivRv32_32(Rc<RefCell<Fp2MulDivChip<F, 1, 32>>>),
    Fp2ModularMulDivRv32_48(Rc<RefCell<Fp2MulDivChip<F, 3, 16>>>),

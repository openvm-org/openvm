...
//         interface::{
//             columns::MemoryInterfaceCols, AccessCell, MemoryInterfaceChip, EXPAND_BUS,
...
// const DEFAULT_NUM_WORDS: usize = DEFAULT_CHUNK / WORD_SIZE;

// #[test]
// fn test_flatten_fromslice_roundtrip() {
//     let num_cols = MemoryInterfaceCols::<DEFAULT_NUM_WORDS, WORD_SIZE, usize>::get_width();
//     let all_cols = (0..num_cols).collect::<Vec<usize>>();

//     let cols_numbered =
//         MemoryInterfaceCols::<DEFAULT_NUM_WORDS, WORD_SIZE, _>::from_slice(&all_cols);
...
//         as_offset: 1,
//     };
//     let mut chip = MemoryInterfaceChip::<NUM_WORDS, WORD_SIZE, _>::new(memory_dimensions);
...
//     random_test::<DEFAULT_CHUNK, DEFAULT_NUM_WORDS>(10, 3000, 400, 30);
// }

// #[test]
// fn memory_interface_test_2() {
//     random_test::<DEFAULT_CHUNK, DEFAULT_NUM_WORDS>(3, 3000, 3, 2);
// }
...
//     let mut chip =
//         MemoryInterfaceChip::<DEFAULT_CHUNK, DEFAULT_NUM_WORDS, _>::new(MemoryDimensions {
//             as_height: 1,
//             address_height: 3,
//             as_offset: 1,
//         });

...
|:---|---:|---:|---:|
| Total |  24.87 |  8.14 |  8.14 |
| app_proof |  22.72 |  5.99 |  5.99 |
| leaf |  1.41 |  1.41 |  1.41 |
...
| `total_proof_time_ms ` |  5,657.50 |  22,630 |  5,900 |  5,366 |
...
| `execute_preflight_time_ms` |  3,510 |  14,040 |  3,622 |  3,333 |
| `execute_preflight_insn_mi/s` |  0.82 | -          |  0.82 |  0.81 |
| `trace_gen_time_ms   ` |  58 |  232 |  63 |  54 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  2,017 |  8,068 |  2,177 |  1,934 |
| `prover.main_trace_commit_time_ms` |  553.50 |  2,214 |  663 |  516 |
| `prover.rap_constraints_time_ms` |  1,317.50 |  5,270 |  1,367 |  1,271 |
| `prover.openings_time_ms` |  145.25 |  581 |  147 |  142 |
| `prover.rap_constraints.logup_gkr_time_ms` |  351 |  1,404 |  400 |  301 |
| `prover.rap_constraints.round0_time_ms` |  653 |  2,612 |  663 |  648 |
| `prover.rap_constraints.mle_rounds_time_ms` |  312.50 |  1,250 |  314 |  311 |
| `prover.openings.stacked_reduction_time_ms` |  107.25 |  429 |  108 |  107 |
...
| `prover.openings.whir_time_ms` |  37.25 |  149 |  39 |  34 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/9a37c324d636150b631dab01cedfe4f413b93f41/sha2_bench-9a37c324d636150b631dab01cedfe4f413b93f41.memory.svg)
...
| --- | --- | --- |
| app_proof | ADD | 2,795,771 |
| app_proof | STORED | 1,641,543 |
| app_proof | LOADD | 1,641,024 |
| app_proof | AND | 819,225 |
| app_proof | BEQ | 657,933 |
| app_proof | SUB | 655,372 |
| app_proof | BLTU | 494,091 |
| app_proof | JAL | 494,087 |
| app_proof | JALR | 491,536 |
| app_proof | BNE | 327,765 |
| app_proof | LUI | 166,409 |
| app_proof | SRL | 163,885 |
| app_proof | AUIPC | 163,858 |
| app_proof | SLL | 163,857 |
| app_proof | LOADW | 163,849 |
| app_proof | BGEU | 163,844 |
| app_proof | SHA256 | 163,841 |
| app_proof | STOREB | 40 |
| app_proof | OR | 15 |
| app_proof | LOADB | 8 |
| app_proof | SLTU | 2 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| agg_keygen | 82 | 9 |  |  | 0 |  | 379 | 9 |  |  |  |  |  |  | 
| app_proof |  |  |  |  |  | 5,366 |  |  | 92 | 11,167,961 | 120.16 | 0 | 22,731 |  | 
...
| internal_recursive.0 | 1 | 12 | 186 | 12 | 2 | 0 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 9 | 151 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 146 | 1,410 | 146 | 54 | 26 | 3 | 6 | 6 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 61,220,603 | 374 | 184 | 0 | 10 | 133 | 36 | 36 | 63 | 33 | 0 | 56 | 22 | 33 | 5 | 28 | 184 | 133 | 0 | 2 | 31 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,879 | 173 | 51 | 0 | 4 | 76 | 24 | 23 | 29 | 22 | 0 | 45 | 21 | 24 | 1 | 22 | 51 | 76 | 0 | 2 | 22 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 141 | 33 | 0 | 4 | 66 | 22 | 21 | 24 | 18 | 0 | 41 | 19 | 22 | 1 | 21 | 34 | 66 | 0 | 2 | 18 | 0 | 0 | 
| leaf | 0 | prover | 424,379,238 | 1,264 | 797 | 0 | 199 | 350 | 166 | 165 | 104 | 79 | 0 | 116 | 38 | 77 | 35 | 41 | 797 | 350 | 0 | 6 | 78 | 0 | 0 | 
...
| --- | --- | --- | --- |
| app_proof | ADD | 0 | 713,679 | 
| app_proof | STORED | 0 | 419,377 | 
| app_proof | LOADD | 0 | 418,844 | 
| app_proof | AND | 0 | 209,098 | 
| app_proof | BEQ | 0 | 167,929 | 
| app_proof | SUB | 0 | 167,275 | 
| app_proof | BLTU | 0 | 126,112 | 
| app_proof | JAL | 0 | 126,109 | 
| app_proof | JALR | 0 | 125,460 | 
| app_proof | BNE | 0 | 83,704 | 
| app_proof | LUI | 0 | 42,478 | 
| app_proof | AUIPC | 0 | 41,831 | 
| app_proof | SRL | 0 | 41,822 | 
| app_proof | BGEU | 0 | 41,820 | 
| app_proof | SLL | 0 | 41,819 | 
| app_proof | LOADW | 0 | 41,818 | 
| app_proof | SHA256 | 0 | 41,818 | 
| app_proof | SLTU | 0 | 2 | 
...
| app_proof | ADD | 1 | 713,732 | 
| app_proof | LOADD | 1 | 418,954 | 
| app_proof | STORED | 1 | 418,954 | 
| app_proof | AND | 1 | 209,153 | 
| app_proof | BEQ | 1 | 167,976 | 
| app_proof | SUB | 1 | 167,322 | 
| app_proof | BLTU | 1 | 126,146 | 
| app_proof | JAL | 1 | 126,144 | 
| app_proof | JALR | 1 | 125,491 | 
| app_proof | BNE | 1 | 83,660 | 
| app_proof | LUI | 1 | 42,484 | 
| app_proof | AUIPC | 1 | 41,831 | 
| app_proof | BGEU | 1 | 41,831 | 
| app_proof | SLL | 1 | 41,831 | 
| app_proof | SRL | 1 | 41,831 | 
| app_proof | LOADW | 1 | 41,830 | 
| app_proof | SHA256 | 1 | 41,830 | 
| app_proof | ADD | 2 | 713,729 | 
| app_proof | LOADD | 2 | 418,961 | 
| app_proof | STORED | 2 | 418,961 | 
| app_proof | AND | 2 | 209,151 | 
| app_proof | BEQ | 2 | 167,973 | 
| app_proof | SUB | 2 | 167,320 | 
| app_proof | JAL | 2 | 126,145 | 
| app_proof | BLTU | 2 | 126,143 | 
| app_proof | JALR | 2 | 125,491 | 
| app_proof | BNE | 2 | 83,661 | 
| app_proof | LUI | 2 | 42,484 | 
| app_proof | LOADW | 2 | 41,831 | 
| app_proof | AUIPC | 2 | 41,830 | 
| app_proof | BGEU | 2 | 41,830 | 
| app_proof | SHA256 | 2 | 41,830 | 
| app_proof | SLL | 2 | 41,830 | 
| app_proof | SRL | 2 | 41,830 | 
| app_proof | ADD | 3 | 654,631 | 
| app_proof | LOADD | 3 | 384,265 | 
| app_proof | STORED | 3 | 384,251 | 
| app_proof | AND | 3 | 191,823 | 
| app_proof | BEQ | 3 | 154,055 | 
| app_proof | SUB | 3 | 153,455 | 
| app_proof | BLTU | 3 | 115,690 | 
| app_proof | JAL | 3 | 115,689 | 
| app_proof | JALR | 3 | 115,094 | 
| app_proof | BNE | 3 | 76,740 | 
| app_proof | LUI | 3 | 38,963 | 
| app_proof | SRL | 3 | 38,402 | 
| app_proof | SLL | 3 | 38,377 | 
| app_proof | LOADW | 3 | 38,370 | 
| app_proof | AUIPC | 3 | 38,366 | 
| app_proof | BGEU | 3 | 38,363 | 
| app_proof | SHA256 | 3 | 38,363 | 
| app_proof | STOREB | 3 | 40 | 
| app_proof | OR | 3 | 14 | 
| app_proof | LOADB | 3 | 8 | 
| app_proof | BLT | 3 | 1 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 662,392,121 | 2,177 | 663 | 0 | 187 | 1,367 | 652 | 651 | 314 | 400 | 96 | 147 | 38 | 108 | 60 | 48 | 663 | 1,367 | 0 | 3 | 303 | 0 | 0 | 
| app_proof | prover | 1 | 662,391,820 | 2,020 | 517 | 0 | 39 | 1,356 | 648 | 647 | 314 | 393 | 110 | 145 | 38 | 107 | 61 | 45 | 517 | 1,356 | 0 | 3 | 282 | 0 | 0 | 
| app_proof | prover | 2 | 662,391,820 | 1,934 | 516 | 0 | 39 | 1,276 | 663 | 663 | 311 | 301 | 0 | 142 | 34 | 107 | 61 | 45 | 516 | 1,276 | 0 | 3 | 300 | 0 | 0 | 
| app_proof | prover | 3 | 662,468,884 | 1,937 | 518 | 0 | 41 | 1,271 | 649 | 648 | 311 | 310 | 0 | 147 | 39 | 107 | 61 | 46 | 518 | 1,270 | 0 | 3 | 309 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 63 | 5,900 | 63 | 162 | 0 | 3 | 3,496 | 2,851,000 | 0.82 | 
| app_proof | 1 | 57 | 5,742 | 57 | 41 | 0 | 1 | 3,622 | 2,851,000 | 0.82 | 
| app_proof | 2 | 58 | 5,622 | 58 | 41 | 0 | 1 | 3,589 | 2,851,000 | 0.82 | 
| app_proof | 3 | 54 | 5,366 | 54 | 41 | 0 | 1 | 3,333 | 2,614,961 | 0.81 | 

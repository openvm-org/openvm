...
|:---|---:|---:|---:|
| Total |  33.52 |  7.67 |  7.67 |
| app_proof |  30.46 |  5.38 |  5.38 |
| leaf |  2.21 |  1.44 |  1.44 |
...
| `total_proof_time_ms ` |  5,053.17 |  30,319 |  5,239 |  4,865 |
...
| `execute_preflight_time_ms` |  3,061.67 |  18,370 |  3,167 |  2,918 |
| `execute_preflight_insn_mi/s` |  0.83 | -          |  0.83 |  0.82 |
| `trace_gen_time_ms   ` |  34.67 |  208 |  39 |  33 |
| `memory_finalize_time_ms` |  0 |  0 |  0 |  0 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  1,895.33 |  11,372 |  2,120 |  1,847 |
| `prover.main_trace_commit_time_ms` |  707.17 |  4,243 |  866 |  675 |
| `prover.rap_constraints_time_ms` |  1,003.33 |  6,020 |  1,069 |  984 |
| `prover.openings_time_ms` |  183.83 |  1,103 |  186 |  183 |
| `prover.rap_constraints.logup_gkr_time_ms` |  179.33 |  1,076 |  230 |  168 |
| `prover.rap_constraints.round0_time_ms` |  517.17 |  3,103 |  521 |  512 |
| `prover.rap_constraints.mle_rounds_time_ms` |  305.50 |  1,833 |  326 |  295 |
| `prover.openings.stacked_reduction_time_ms` |  142.83 |  857 |  146 |  141 |
| `prover.openings.stacked_reduction.round0_time_ms` |  83 |  498 |  85 |  82 |
| `prover.openings.stacked_reduction.mle_rounds_time_ms` |  59.33 |  356 |  60 |  59 |
| `prover.openings.whir_time_ms` |  40.50 |  243 |  42 |  40 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  1,107 |  2,214 |  1,436 |  778 |
| `execute_preflight_time_ms` |  5.50 |  11 |  6 |  5 |
| `trace_gen_time_ms   ` |  135 |  270 |  180 |  90 |
| `generate_blob_total_time_ms` |  24.50 |  49 |  33 |  16 |
| __Prover__ |||||
| `stark_prove_excluding_trace_time_ms` |  971.50 |  1,943 |  1,255 |  688 |
| `prover.main_trace_commit_time_ms` |  547 |  1,094 |  720 |  374 |
| `prover.rap_constraints_time_ms` |  320 |  640 |  411 |  229 |
| `prover.openings_time_ms` |  103.50 |  207 |  123 |  84 |
| `prover.rap_constraints.logup_gkr_time_ms` |  71.50 |  143 |  88 |  55 |
| `prover.rap_constraints.round0_time_ms` |  153.50 |  307 |  202 |  105 |
...
![GPU Memory Usage](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/charts/9a37c324d636150b631dab01cedfe4f413b93f41/keccak-9a37c324d636150b631dab01cedfe4f413b93f41.memory.svg)
...
| --- | --- | --- |
| app_proof | ADD | 3,900,030 |
| app_proof | STORED | 3,510,041 |
| app_proof | LOADD | 1,625,016 |
| app_proof | BEQ | 780,004 |
| app_proof | AND | 715,004 |
| app_proof | JALR | 585,005 |
| app_proof | BNE | 520,005 |
| app_proof | AUIPC | 325,006 |
| app_proof | STOREB | 260,004 |
| app_proof | BLTU | 260,002 |
| app_proof | JAL | 260,000 |
| app_proof | SUB | 260,000 |
| app_proof | LOADBU | 195,003 |
| app_proof | SRL | 195,002 |
| app_proof | OR | 195,002 |
| app_proof | LUI | 130,002 |
| app_proof | XOR | 130,002 |
| app_proof | BGEU | 130,001 |
| app_proof | SLL | 130,001 |
| app_proof | MUL | 65,001 |
| app_proof | KECCAKF | 65,001 |
| app_proof | XORIN | 65,000 |
| app_proof | LOADW | 65,000 |
...
| app_proof |  |  |  |  |  | 4,865 |  |  | 139 | 14,365,133 | 102.62 | 0 | 30,467 |  | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | 39 | 519 | 38 | 13 | 4 | 2 | 2 | 2 | 
| internal_recursive.0 | 1 | 13 | 183 | 13 | 2 | 1 | 2 | 1 | 1 | 
| internal_recursive.1 | 1 | 9 | 151 | 9 | 1 | 0 | 2 | 0 | 0 | 
| leaf | 0 | 180 | 1,436 | 180 | 64 | 33 | 6 | 7 | 7 | 
| leaf | 1 | 90 | 778 | 90 | 32 | 16 | 5 | 7 | 7 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal_for_leaf | 0 | prover | 81,415,028 | 480 | 245 | 0 | 14 | 175 | 48 | 47 | 92 | 35 | 0 | 58 | 20 | 38 | 7 | 30 | 245 | 175 | 0 | 2 | 34 | 0 | 0 | 
| internal_recursive.0 | 1 | prover | 16,836,879 | 169 | 51 | 0 | 3 | 76 | 24 | 23 | 29 | 23 | 0 | 41 | 17 | 24 | 1 | 22 | 51 | 76 | 0 | 2 | 22 | 0 | 0 | 
| internal_recursive.1 | 1 | prover | 9,750,799 | 141 | 33 | 0 | 4 | 66 | 23 | 22 | 24 | 18 | 0 | 40 | 18 | 22 | 1 | 20 | 34 | 66 | 0 | 2 | 18 | 0 | 0 | 
| leaf | 0 | prover | 476,578,662 | 1,255 | 719 | 0 | 47 | 411 | 202 | 201 | 120 | 88 | 0 | 123 | 37 | 85 | 40 | 44 | 720 | 411 | 0 | 6 | 88 | 0 | 0 | 
| leaf | 1 | prover | 240,255,732 | 688 | 374 | 0 | 24 | 229 | 105 | 105 | 68 | 55 | 0 | 84 | 32 | 52 | 19 | 32 | 374 | 229 | 0 | 6 | 54 | 0 | 0 | 
...
| --- | --- | --- | --- |
| app_proof | ADD | 0 | 655,108 | 
| app_proof | STORED | 0 | 589,612 | 
| app_proof | LOADD | 0 | 272,960 | 
| app_proof | BEQ | 0 | 131,020 | 
| app_proof | AND | 0 | 120,102 | 
| app_proof | JALR | 0 | 98,266 | 
| app_proof | BNE | 0 | 87,349 | 
| app_proof | AUIPC | 0 | 54,596 | 
| app_proof | STOREB | 0 | 43,676 | 
| app_proof | BLTU | 0 | 43,674 | 
| app_proof | JAL | 0 | 43,672 | 
| app_proof | SUB | 0 | 43,672 | 
| app_proof | LOADBU | 0 | 32,757 | 
| app_proof | OR | 0 | 32,756 | 
| app_proof | SRL | 0 | 32,756 | 
| app_proof | LUI | 0 | 21,838 | 
| app_proof | XOR | 0 | 21,838 | 
| app_proof | BGEU | 0 | 21,837 | 
| app_proof | SLL | 0 | 21,837 | 
| app_proof | KECCAKF | 0 | 10,919 | 
| app_proof | MUL | 0 | 10,919 | 
| app_proof | LOADW | 0 | 10,918 | 
| app_proof | XORIN | 0 | 10,918 | 
| app_proof | ADD | 1 | 655,119 | 
| app_proof | STORED | 1 | 589,592 | 
| app_proof | LOADD | 1 | 272,962 | 
| app_proof | BEQ | 1 | 131,024 | 
| app_proof | AND | 1 | 120,103 | 
| app_proof | JALR | 1 | 98,267 | 
| app_proof | BNE | 1 | 87,346 | 
| app_proof | AUIPC | 1 | 54,594 | 
| app_proof | SUB | 1 | 43,676 | 
| app_proof | JAL | 1 | 43,675 | 
| app_proof | STOREB | 1 | 43,675 | 
| app_proof | BLTU | 1 | 43,674 | 
| app_proof | LOADBU | 1 | 32,757 | 
| app_proof | OR | 1 | 32,756 | 
| app_proof | SRL | 1 | 32,755 | 
| app_proof | BGEU | 1 | 21,838 | 
| app_proof | XOR | 1 | 21,838 | 
| app_proof | LUI | 1 | 21,837 | 
| app_proof | SLL | 1 | 21,837 | 
| app_proof | KECCAKF | 1 | 10,919 | 
| app_proof | LOADW | 1 | 10,919 | 
| app_proof | XORIN | 1 | 10,919 | 
| app_proof | MUL | 1 | 10,918 | 
| app_proof | ADD | 2 | 655,108 | 
| app_proof | STORED | 2 | 589,616 | 
| app_proof | LOADD | 2 | 272,963 | 
| app_proof | BEQ | 2 | 131,020 | 
| app_proof | AND | 2 | 120,104 | 
| app_proof | JALR | 2 | 98,267 | 
| app_proof | BNE | 2 | 87,350 | 
| app_proof | AUIPC | 2 | 54,593 | 
| app_proof | BLTU | 2 | 43,674 | 
| app_proof | STOREB | 2 | 43,674 | 
| app_proof | JAL | 2 | 43,673 | 
| app_proof | SUB | 2 | 43,672 | 
| app_proof | OR | 2 | 32,756 | 
| app_proof | SRL | 2 | 32,756 | 
| app_proof | LOADBU | 2 | 32,755 | 
| app_proof | LUI | 2 | 21,837 | 
| app_proof | SLL | 2 | 21,837 | 
| app_proof | BGEU | 2 | 21,836 | 
| app_proof | XOR | 2 | 21,836 | 
| app_proof | MUL | 2 | 10,919 | 
| app_proof | KECCAKF | 2 | 10,918 | 
| app_proof | LOADW | 2 | 10,918 | 
| app_proof | XORIN | 2 | 10,918 | 
| app_proof | ADD | 3 | 655,120 | 
| app_proof | STORED | 3 | 589,583 | 
| app_proof | LOADD | 3 | 272,962 | 
| app_proof | BEQ | 3 | 131,026 | 
| app_proof | AND | 3 | 120,107 | 
| app_proof | JALR | 3 | 98,268 | 
| app_proof | BNE | 3 | 87,346 | 
| app_proof | AUIPC | 3 | 54,593 | 
| app_proof | JAL | 3 | 43,676 | 
| app_proof | SUB | 3 | 43,676 | 
| app_proof | BLTU | 3 | 43,675 | 
| app_proof | STOREB | 3 | 43,674 | 
| app_proof | LOADBU | 3 | 32,756 | 
| app_proof | OR | 3 | 32,755 | 
| app_proof | SRL | 3 | 32,755 | 
| app_proof | BGEU | 3 | 21,838 | 
| app_proof | LUI | 3 | 21,838 | 
| app_proof | SLL | 3 | 21,838 | 
| app_proof | XOR | 3 | 21,838 | 
| app_proof | KECCAKF | 3 | 10,919 | 
| app_proof | LOADW | 3 | 10,919 | 
| app_proof | MUL | 3 | 10,919 | 
| app_proof | XORIN | 3 | 10,919 | 
| app_proof | ADD | 4 | 655,110 | 
| app_proof | STORED | 4 | 589,619 | 
| app_proof | LOADD | 4 | 272,964 | 
| app_proof | BEQ | 4 | 131,020 | 
| app_proof | AND | 4 | 120,100 | 
| app_proof | JALR | 4 | 98,266 | 
| app_proof | BNE | 4 | 87,350 | 
| app_proof | AUIPC | 4 | 54,593 | 
| app_proof | BLTU | 4 | 43,674 | 
| app_proof | STOREB | 4 | 43,674 | 
| app_proof | JAL | 4 | 43,673 | 
| app_proof | SUB | 4 | 43,673 | 
| app_proof | OR | 4 | 32,756 | 
| app_proof | SRL | 4 | 32,756 | 
| app_proof | LOADBU | 4 | 32,755 | 
| app_proof | BGEU | 4 | 21,837 | 
| app_proof | LUI | 4 | 21,836 | 
| app_proof | SLL | 4 | 21,836 | 
| app_proof | XOR | 4 | 21,836 | 
| app_proof | KECCAKF | 4 | 10,918 | 
| app_proof | LOADW | 4 | 10,918 | 
| app_proof | MUL | 4 | 10,918 | 
| app_proof | XORIN | 4 | 10,918 | 
| app_proof | ADD | 5 | 624,465 | 
| app_proof | STORED | 5 | 562,019 | 
| app_proof | LOADD | 5 | 260,205 | 
| app_proof | BEQ | 5 | 124,894 | 
| app_proof | AND | 5 | 114,488 | 
| app_proof | JALR | 5 | 93,671 | 
| app_proof | BNE | 5 | 83,264 | 
| app_proof | AUIPC | 5 | 52,037 | 
| app_proof | BLTU | 5 | 41,631 | 
| app_proof | JAL | 5 | 41,631 | 
| app_proof | STOREB | 5 | 41,631 | 
| app_proof | SUB | 5 | 41,631 | 
| app_proof | SRL | 5 | 31,224 | 
| app_proof | LOADBU | 5 | 31,223 | 
| app_proof | OR | 5 | 31,223 | 
| app_proof | LUI | 5 | 20,816 | 
| app_proof | SLL | 5 | 20,816 | 
| app_proof | XOR | 5 | 20,816 | 
| app_proof | BGEU | 5 | 20,815 | 
| app_proof | KECCAKF | 5 | 10,408 | 
| app_proof | LOADW | 5 | 10,408 | 
| app_proof | MUL | 5 | 10,408 | 
| app_proof | XORIN | 5 | 10,408 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | prover | 0 | 857,743,372 | 2,120 | 866 | 0 | 251 | 1,069 | 512 | 511 | 326 | 230 | 63 | 184 | 41 | 143 | 82 | 60 | 866 | 1,069 | 0 | 3 | 166 | 0 | 0 | 
| app_proof | prover | 1 | 857,820,172 | 1,852 | 676 | 0 | 59 | 991 | 518 | 518 | 302 | 169 | 0 | 184 | 42 | 141 | 82 | 59 | 676 | 991 | 0 | 3 | 169 | 0 | 0 | 
| app_proof | prover | 2 | 857,820,172 | 1,849 | 675 | 0 | 59 | 990 | 517 | 516 | 302 | 170 | 0 | 183 | 40 | 143 | 83 | 59 | 675 | 990 | 0 | 3 | 169 | 0 | 0 | 
| app_proof | prover | 3 | 857,820,172 | 1,849 | 674 | 0 | 59 | 991 | 516 | 515 | 304 | 170 | 0 | 183 | 40 | 142 | 83 | 59 | 675 | 991 | 0 | 3 | 169 | 0 | 0 | 
| app_proof | prover | 4 | 857,820,172 | 1,855 | 676 | 0 | 59 | 995 | 521 | 521 | 304 | 168 | 0 | 183 | 40 | 142 | 83 | 59 | 676 | 995 | 0 | 3 | 167 | 0 | 0 | 
| app_proof | prover | 5 | 857,743,372 | 1,847 | 675 | 0 | 58 | 984 | 519 | 519 | 295 | 169 | 0 | 186 | 40 | 146 | 85 | 60 | 675 | 984 | 0 | 3 | 168 | 0 | 0 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| app_proof | 0 | 39 | 5,239 | 39 | 161 | 0 | 3 | 2,918 | 2,413,000 | 0.83 | 
| app_proof | 1 | 34 | 5,094 | 34 | 41 | 0 | 1 | 3,167 | 2,413,000 | 0.83 | 
| app_proof | 2 | 34 | 5,033 | 34 | 41 | 0 | 1 | 3,108 | 2,413,000 | 0.83 | 
| app_proof | 3 | 34 | 5,035 | 34 | 41 | 0 | 1 | 3,110 | 2,413,000 | 0.83 | 
| app_proof | 4 | 34 | 5,053 | 34 | 41 | 0 | 1 | 3,123 | 2,413,000 | 0.82 | 
| app_proof | 5 | 33 | 4,865 | 33 | 41 | 0 | 1 | 2,944 | 2,300,133 | 0.83 | 

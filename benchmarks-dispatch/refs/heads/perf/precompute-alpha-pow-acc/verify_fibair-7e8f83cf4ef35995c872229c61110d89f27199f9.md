...
|:---|---:|---:|
| Total | <span style='color: red'>(+0 [+29.3%])</span> 1.75 | <span style='color: red'>(+0 [+29.3%])</span> 1.75 |
| verify_fibair | <span style='color: red'>(+0 [+29.3%])</span> 1.75 | <span style='color: red'>(+0 [+29.3%])</span> 1.75 |


| verify_fibair |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+396 [+29.3%])</span> 1,746 | <span style='color: red'>(+396 [+29.3%])</span> 1,746 | <span style='color: red'>(+396 [+29.3%])</span> 1,746 | <span style='color: red'>(+396 [+29.3%])</span> 1,746 |
...
| `execute_time_ms     ` | <span style='color: red'>(+407 [+391.3%])</span> 511 | <span style='color: red'>(+407 [+391.3%])</span> 511 | <span style='color: red'>(+407 [+391.3%])</span> 511 | <span style='color: red'>(+407 [+391.3%])</span> 511 |
...
| `stark_prove_excluding_trace_time_ms` | <span style='color: green'>(-10 [-0.9%])</span> 1,131 | <span style='color: green'>(-10 [-0.9%])</span> 1,131 | <span style='color: green'>(-10 [-0.9%])</span> 1,131 | <span style='color: green'>(-10 [-0.9%])</span> 1,131 |
| `main_trace_commit_time_ms` | <span style='color: red'>(+4 [+2.0%])</span> 208 | <span style='color: red'>(+4 [+2.0%])</span> 208 | <span style='color: red'>(+4 [+2.0%])</span> 208 | <span style='color: red'>(+4 [+2.0%])</span> 208 |
...
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+5 [+2.0%])</span> 256 | <span style='color: red'>(+5 [+2.0%])</span> 256 | <span style='color: red'>(+5 [+2.0%])</span> 256 | <span style='color: red'>(+5 [+2.0%])</span> 256 |
| `pcs_opening_time_ms ` | <span style='color: green'>(-17 [-4.7%])</span> 341 | <span style='color: green'>(-17 [-4.7%])</span> 341 | <span style='color: green'>(-17 [-4.7%])</span> 341 | <span style='color: green'>(-17 [-4.7%])</span> 341 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| verify_fibair | 104 | 1,746 | 141,798 | 23,165,592 | 1,131 | 123 | 256 | 180 | 341 | 208 | 8,234,669 | 21 | 511 | 
...
| verify_fibair | <AluNativeAdapterAir,FieldArithmeticCoreAir> | AddEI | ADD | 242,208 | 
...
| verify_fibair | <AluNativeAdapterAir,FieldArithmeticCoreAir> | AddVI | ADD | 235,248 | 
| verify_fibair | <AluNativeAdapterAir,FieldArithmeticCoreAir> | Alloc | ADD | 331,528 | 
| verify_fibair | <AluNativeAdapterAir,FieldArithmeticCoreAir> | Alloc | MUL | 79,286 | 
...
| verify_fibair | <AluNativeAdapterAir,FieldArithmeticCoreAir> | ImmE | ADD | 20,068 | 
...
| verify_fibair | <AluNativeAdapterAir,FieldArithmeticCoreAir> | LoadE | ADD | 57,304 | 
| verify_fibair | <AluNativeAdapterAir,FieldArithmeticCoreAir> | LoadE | MUL | 57,304 | 
...
| verify_fibair | <AluNativeAdapterAir,FieldArithmeticCoreAir> | StoreE | ADD | 20,764 | 
| verify_fibair | <AluNativeAdapterAir,FieldArithmeticCoreAir> | StoreE | MUL | 20,764 | 
...
| verify_fibair | <AluNativeAdapterAir,FieldArithmeticCoreAir> | ZipFor | ADD | 298,642 | 
...
| verify_fibair | <BranchNativeAdapterAir,BranchEqualCoreAir<1>> | ZipFor | BNE | 195,661 | 
...
| verify_fibair | <JalNativeAdapterAir,JalCoreAir> | ZipFor | JAL | 10,845 | 
| verify_fibair | <NativeLoadStoreAdapterAir<1>,NativeLoadStoreCoreAir<1>> | LoadF | LOADW | 57,618 | 
| verify_fibair | <NativeLoadStoreAdapterAir<1>,NativeLoadStoreCoreAir<1>> | LoadV | LOADW | 249,744 | 
...
| verify_fibair | <NativeLoadStoreAdapterAir<1>,NativeLoadStoreCoreAir<1>> | StoreV | STOREW | 97,196 | 
| verify_fibair | <NativeLoadStoreAdapterAir<4>,NativeLoadStoreCoreAir<4>> | LoadE | LOADW | 129,394 | 
| verify_fibair | <NativeLoadStoreAdapterAir<4>,NativeLoadStoreCoreAir<4>> | StoreE | STOREW | 119,846 | 
...
| verify_fibair | <NativeVectorizedAdapterAir<4>,FieldExtensionCoreAir> | MulE | BBE4MUL | 109,402 | 
...
| --- | --- | --- |
| verify_fibair | <AluNativeAdapterAir,FieldArithmeticCoreAir> | 79,557 | 
| verify_fibair | <BranchNativeAdapterAir,BranchEqualCoreAir<1>> | 14,185 | 
| verify_fibair | <JalNativeAdapterAir,JalCoreAir> | 2,612 | 
| verify_fibair | <NativeLoadStoreAdapterAir<1>,NativeLoadStoreCoreAir<1>> | 26,455 | 
| verify_fibair | <NativeLoadStoreAdapterAir<4>,NativeLoadStoreCoreAir<4>> | 8,040 | 
| verify_fibair | <NativeVectorizedAdapterAir<4>,FieldExtensionCoreAir> | 7,056 | 
| verify_fibair | AccessAdapter<2> | 31,274 | 
| verify_fibair | AccessAdapter<4> | 15,006 | 
| verify_fibair | AccessAdapter<8> | 88 | 
| verify_fibair | Boundary | 20,376 | 
| verify_fibair | FriReducedOpeningAir | 588 | 
| verify_fibair | PhantomAir | 3,027 | 
| verify_fibair | ProgramChip | 5,213 | 
...
| verify_fibair | AddEI | ADD | 8,352 | 
| verify_fibair | AddF | ADD | 1,575 | 
| verify_fibair | AddFI | ADD | 1,675 | 
| verify_fibair | AddV | ADD | 1,825 | 
| verify_fibair | AddVI | ADD | 8,112 | 
| verify_fibair | Alloc | ADD | 11,432 | 
| verify_fibair | Alloc | MUL | 2,734 | 
...
| verify_fibair | StoreE | ADD | 716 | 
| verify_fibair | StoreE | MUL | 716 | 
| verify_fibair | StoreE | STOREW | 3,866 | 
...
| verify_fibair | StoreV | STOREW | 4,418 | 
...
| verify_fibair | ZipFor | ADD | 10,298 | 
| verify_fibair | ZipFor | BNE | 8,507 | 
| verify_fibair | ZipFor | JAL | 1,205 | 
...
[![](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/7e8f83cf4ef35995c872229c61110d89f27199f9/verify_fibair-7e8f83cf4ef35995c872229c61110d89f27199f9-verify_fibair.dsl_ir.opcode.air_name.cells_used.reverse.svg)](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/7e8f83cf4ef35995c872229c61110d89f27199f9/verify_fibair-7e8f83cf4ef35995c872229c61110d89f27199f9-verify_fibair.dsl_ir.opcode.air_name.cells_used.reverse.svg)
[![](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/7e8f83cf4ef35995c872229c61110d89f27199f9/verify_fibair-7e8f83cf4ef35995c872229c61110d89f27199f9-verify_fibair.dsl_ir.opcode.air_name.cells_used.svg)](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/7e8f83cf4ef35995c872229c61110d89f27199f9/verify_fibair-7e8f83cf4ef35995c872229c61110d89f27199f9-verify_fibair.dsl_ir.opcode.air_name.cells_used.svg)
[![](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/7e8f83cf4ef35995c872229c61110d89f27199f9/verify_fibair-7e8f83cf4ef35995c872229c61110d89f27199f9-verify_fibair.dsl_ir.opcode.frequency.reverse.svg)](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/7e8f83cf4ef35995c872229c61110d89f27199f9/verify_fibair-7e8f83cf4ef35995c872229c61110d89f27199f9-verify_fibair.dsl_ir.opcode.frequency.reverse.svg)
[![](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/7e8f83cf4ef35995c872229c61110d89f27199f9/verify_fibair-7e8f83cf4ef35995c872229c61110d89f27199f9-verify_fibair.dsl_ir.opcode.frequency.svg)](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/7e8f83cf4ef35995c872229c61110d89f27199f9/verify_fibair-7e8f83cf4ef35995c872229c61110d89f27199f9-verify_fibair.dsl_ir.opcode.frequency.svg)

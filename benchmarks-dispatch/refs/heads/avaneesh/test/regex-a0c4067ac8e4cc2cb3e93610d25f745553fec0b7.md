...
|:---|---:|---:|
| Total | <span style='color: red'>(+14 [+193.8%])</span> 21.64 | <span style='color: red'>(+8 [+186.5%])</span> 11.69 |
| regex_program | <span style='color: red'>(+14 [+193.8%])</span> 21.64 | <span style='color: red'>(+8 [+186.5%])</span> 11.69 |


| regex_program |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` | <span style='color: red'>(+7136 [+193.8%])</span> 10,818.50 | <span style='color: red'>(+14272 [+193.8%])</span> 21,637 | <span style='color: red'>(+7609 [+186.5%])</span> 11,689 | <span style='color: red'>(+6663 [+202.8%])</span> 9,948 |
...
| `execute_time_ms     ` | <span style='color: red'>(+6896 [+2049.3%])</span> 7,232.50 | <span style='color: red'>(+13792 [+2049.3%])</span> 14,465 | <span style='color: red'>(+7344 [+1958.4%])</span> 7,719 | <span style='color: red'>(+6448 [+2163.8%])</span> 6,746 |
| `trace_gen_time_ms   ` | <span style='color: red'>(+48 [+5.0%])</span> 1,004.50 | <span style='color: red'>(+95 [+5.0%])</span> 2,009 | <span style='color: red'>(+65 [+5.8%])</span> 1,184 | <span style='color: red'>(+30 [+3.8%])</span> 825 |
| `stark_prove_excluding_trace_time_ms` | <span style='color: red'>(+192 [+8.1%])</span> 2,581.50 | <span style='color: red'>(+385 [+8.1%])</span> 5,163 | <span style='color: red'>(+200 [+7.7%])</span> 2,786 | <span style='color: red'>(+185 [+8.4%])</span> 2,377 |
| `main_trace_commit_time_ms` | <span style='color: red'>(+51 [+11.3%])</span> 501 | <span style='color: red'>(+102 [+11.3%])</span> 1,002 | <span style='color: red'>(+52 [+10.3%])</span> 555 | <span style='color: red'>(+50 [+12.6%])</span> 447 |
| `generate_perm_trace_time_ms` | <span style='color: green'>(-3 [-1.5%])</span> 192.50 | <span style='color: green'>(-6 [-1.5%])</span> 385 | <span style='color: green'>(-4 [-1.9%])</span> 203 | <span style='color: green'>(-2 [-1.1%])</span> 182 |
| `perm_trace_commit_time_ms` | <span style='color: red'>(+86 [+17.6%])</span> 573.50 | <span style='color: red'>(+172 [+17.6%])</span> 1,147 | <span style='color: red'>(+85 [+16.6%])</span> 598 | <span style='color: red'>(+87 [+18.8%])</span> 549 |
| `quotient_poly_compute_time_ms` | <span style='color: red'>(+5 [+1.5%])</span> 337 | <span style='color: red'>(+10 [+1.5%])</span> 674 |  359 | <span style='color: red'>(+10 [+3.3%])</span> 315 |
| `quotient_poly_commit_time_ms` | <span style='color: red'>(+35 [+15.5%])</span> 261.50 | <span style='color: red'>(+70 [+15.5%])</span> 523 | <span style='color: red'>(+44 [+16.7%])</span> 307 | <span style='color: red'>(+26 [+13.7%])</span> 216 |
| `pcs_opening_time_ms ` | <span style='color: red'>(+18 [+2.7%])</span> 706.50 | <span style='color: red'>(+37 [+2.7%])</span> 1,413 | <span style='color: red'>(+22 [+3.0%])</span> 754 | <span style='color: red'>(+15 [+2.3%])</span> 659 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| regex_program | 0 | 1,184 | 11,689 | 2,240,483 | 275,652,919 | 2,786 | 359 | 307 | 598 | 754 | 555 | 93,294,534 | 203 | 7,719 | 
| regex_program | 1 | 825 | 9,948 | 1,965,864 | 244,236,972 | 2,377 | 315 | 216 | 549 | 659 | 447 | 74,618,236 | 182 | 6,746 | 
...
[![](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/regex-a0c4067ac8e4cc2cb3e93610d25f745553fec0b7/regex-regex_program.dsl_ir.opcode.air_name.cells_used.reverse.svg)](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/regex-a0c4067ac8e4cc2cb3e93610d25f745553fec0b7/regex-regex_program.dsl_ir.opcode.air_name.cells_used.reverse.svg)
[![](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/regex-a0c4067ac8e4cc2cb3e93610d25f745553fec0b7/regex-regex_program.dsl_ir.opcode.air_name.cells_used.svg)](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/regex-a0c4067ac8e4cc2cb3e93610d25f745553fec0b7/regex-regex_program.dsl_ir.opcode.air_name.cells_used.svg)
[![](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/regex-a0c4067ac8e4cc2cb3e93610d25f745553fec0b7/regex-regex_program.dsl_ir.opcode.frequency.reverse.svg)](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/regex-a0c4067ac8e4cc2cb3e93610d25f745553fec0b7/regex-regex_program.dsl_ir.opcode.frequency.reverse.svg)
[![](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/regex-a0c4067ac8e4cc2cb3e93610d25f745553fec0b7/regex-regex_program.dsl_ir.opcode.frequency.svg)](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/regex-a0c4067ac8e4cc2cb3e93610d25f745553fec0b7/regex-regex_program.dsl_ir.opcode.frequency.svg)

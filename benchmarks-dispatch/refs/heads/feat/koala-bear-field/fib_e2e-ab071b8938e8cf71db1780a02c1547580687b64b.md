...
| fib_e2e |  55.98 |  8.18 |
| leaf |  49.60 |  8.11 |
| internal.0 |  62.61 |  17.77 |
| internal.1 |  21.40 |  10.74 |
| internal.2 |  10.61 |  10.61 |
| root |  41.59 |  41.59 |
| halo2_outer |  93.65 |  93.65 |
...
| `total_proof_time_ms ` |  7,996.43 |  55,975 |  8,177 |  7,271 |
| `main_cells_used     ` |  57,756,362.14 |  404,294,535 |  58,898,534 |  51,097,540 |
| `total_cycles        ` |  1,714,325.29 |  12,000,277 |  1,747,603 |  1,515,164 |
| `execute_time_ms     ` |  5,507.43 |  38,552 |  5,674 |  4,850 |
| `trace_gen_time_ms   ` |  590.43 |  4,133 |  626 |  535 |
| `stark_prove_excluding_trace_time_ms` |  1,898.57 |  13,290 |  1,970 |  1,878 |
| `main_trace_commit_time_ms` |  323.86 |  2,267 |  350 |  318 |
| `generate_perm_trace_time_ms` |  119 |  833 |  125 |  114 |
| `perm_trace_commit_time_ms` |  485.43 |  3,398 |  490 |  484 |
| `quotient_poly_compute_time_ms` |  252.29 |  1,766 |  255 |  250 |
| `quotient_poly_commit_time_ms` |  202.86 |  1,420 |  236 |  194 |
| `pcs_opening_time_ms ` |  510.29 |  3,572 |  519 |  504 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  7,086.43 |  49,605 |  8,109 |  6,762 |
| `main_cells_used     ` |  61,974,435 |  433,821,045 |  70,451,898 |  59,081,809 |
| `total_cycles        ` |  1,143,715.57 |  8,006,009 |  1,310,886 |  1,085,344 |
| `execute_time_ms     ` |  4,175.29 |  29,227 |  4,721 |  3,970 |
| `trace_gen_time_ms   ` |  588.86 |  4,122 |  676 |  544 |
| `stark_prove_excluding_trace_time_ms` |  2,322.29 |  16,256 |  2,712 |  2,241 |
| `main_trace_commit_time_ms` |  407.71 |  2,854 |  471 |  393 |
| `generate_perm_trace_time_ms` |  133.14 |  932 |  165 |  126 |
| `perm_trace_commit_time_ms` |  613 |  4,291 |  761 |  585 |
| `quotient_poly_compute_time_ms` |  317.29 |  2,221 |  374 |  305 |
| `quotient_poly_commit_time_ms` |  259.29 |  1,815 |  299 |  250 |
| `pcs_opening_time_ms ` |  586.71 |  4,107 |  638 |  569 |

| internal.0 |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  15,653 |  62,612 |  17,765 |  9,434 |
| `main_cells_used     ` |  119,823,262 |  479,293,048 |  136,809,031 |  69,108,539 |
| `total_cycles        ` |  2,118,739.75 |  8,474,959 |  2,421,315 |  1,211,082 |
| `execute_time_ms     ` |  7,672.75 |  30,691 |  8,779 |  4,408 |
| `trace_gen_time_ms   ` |  1,115.25 |  4,461 |  1,288 |  649 |
| `stark_prove_excluding_trace_time_ms` |  6,865 |  27,460 |  7,708 |  4,377 |
| `main_trace_commit_time_ms` |  1,416.75 |  5,667 |  1,607 |  852 |
| `generate_perm_trace_time_ms` |  266.50 |  1,066 |  305 |  160 |
| `perm_trace_commit_time_ms` |  1,285.50 |  5,142 |  1,474 |  779 |
| `quotient_poly_compute_time_ms` |  1,166.25 |  4,665 |  1,319 |  733 |
| `quotient_poly_commit_time_ms` |  1,226.75 |  4,907 |  1,369 |  835 |
| `pcs_opening_time_ms ` |  1,498 |  5,992 |  1,663 |  1,012 |

| internal.1 |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  10,700.50 |  21,401 |  10,740 |  10,661 |
| `main_cells_used     ` |  74,977,871 |  149,955,742 |  75,274,067 |  74,681,675 |
| `total_cycles        ` |  1,575,590 |  3,151,180 |  1,579,484 |  1,571,696 |
| `execute_time_ms     ` |  5,534.50 |  11,069 |  5,555 |  5,514 |
| `trace_gen_time_ms   ` |  731.50 |  1,463 |  734 |  729 |
| `stark_prove_excluding_trace_time_ms` |  4,434.50 |  8,869 |  4,492 |  4,377 |
| `main_trace_commit_time_ms` |  862.50 |  1,725 |  869 |  856 |
| `generate_perm_trace_time_ms` |  159 |  318 |  165 |  153 |
| `perm_trace_commit_time_ms` |  774 |  1,548 |  781 |  767 |
| `quotient_poly_compute_time_ms` |  721 |  1,442 |  731 |  711 |
| `quotient_poly_commit_time_ms` |  872 |  1,744 |  882 |  862 |
| `pcs_opening_time_ms ` |  1,039.50 |  2,079 |  1,056 |  1,023 |

| internal.2 |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  10,611 |  10,611 |  10,611 |  10,611 |
| `main_cells_used     ` |  73,835,624 |  73,835,624 |  73,835,624 |  73,835,624 |
| `total_cycles        ` |  1,564,318 |  1,564,318 |  1,564,318 |  1,564,318 |
| `execute_time_ms     ` |  5,474 |  5,474 |  5,474 |  5,474 |
| `trace_gen_time_ms   ` |  722 |  722 |  722 |  722 |
| `stark_prove_excluding_trace_time_ms` |  4,415 |  4,415 |  4,415 |  4,415 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  41,591 |  41,591 |  41,591 |  41,591 |
| `main_cells_used     ` |  37,565,545 |  37,565,545 |  37,565,545 |  37,565,545 |
| `total_cycles        ` |  782,868 |  782,868 |  782,868 |  782,868 |
| `execute_time_ms     ` |  2,747 |  2,747 |  2,747 |  2,747 |
| `trace_gen_time_ms   ` |  390 |  390 |  390 |  390 |
| `stark_prove_excluding_trace_time_ms` |  38,454 |  38,454 |  38,454 |  38,454 |
| `main_trace_commit_time_ms` |  12,294 |  12,294 |  12,294 |  12,294 |
| `generate_perm_trace_time_ms` |  77 |  77 |  77 |  77 |
| `perm_trace_commit_time_ms` |  7,661 |  7,661 |  7,661 |  7,661 |
| `quotient_poly_compute_time_ms` |  867 |  867 |  867 |  867 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  93,653 |  93,653 |  93,653 |  93,653 |
| `main_cells_used     ` |  62,046,937 |  62,046,937 |  62,046,937 |  62,046,937 |

| halo2_wrapper |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  44,387 |  44,387 |  44,387 |  44,387 |
...
| --- | --- | --- | --- |
| fib_e2e |  | 7 |  | 
| halo2_outer | 93,653 |  | 62,046,937 | 
| halo2_wrapper | 44,387 |  |  | 
...
| internal.0 | JalRangeCheck | IfEqI | 0 | JAL | 98,736 | 
| internal.0 | JalRangeCheck | IfEqI | 1 | JAL | 99,900 | 
| internal.0 | JalRangeCheck | IfEqI | 2 | JAL | 99,156 | 
| internal.0 | JalRangeCheck | IfEqI | 3 | JAL | 50,736 | 
...
| internal.1 | JalRangeCheck | IfEqI | 4 | JAL | 46,032 | 
| internal.1 | JalRangeCheck | IfEqI | 5 | JAL | 44,688 | 
...
| internal.2 | JalRangeCheck | IfEqI | 6 | JAL | 43,488 | 
...
| leaf | JalRangeCheck | IfEqI | 0 | JAL | 50,460 | 
| leaf | JalRangeCheck | IfEqI | 1 | JAL | 50,604 | 
| leaf | JalRangeCheck | IfEqI | 2 | JAL | 50,676 | 
| leaf | JalRangeCheck | IfEqI | 3 | JAL | 50,256 | 
| leaf | JalRangeCheck | IfEqI | 4 | JAL | 50,640 | 
| leaf | JalRangeCheck | IfEqI | 5 | JAL | 49,008 | 
| leaf | JalRangeCheck | IfEqI | 6 | JAL | 49,152 | 
...
| root | JalRangeCheck | IfEqI | 0 | JAL | 21,072 | 
...
| internal.0 | JalRangeCheck | 0 | 81,044 | 
| internal.0 | JalRangeCheck | 1 | 81,141 | 
| internal.0 | JalRangeCheck | 2 | 81,079 | 
| internal.0 | JalRangeCheck | 3 | 40,647 | 
...
| internal.1 | JalRangeCheck | 4 | 42,634 | 
| internal.1 | JalRangeCheck | 5 | 42,057 | 
...
| internal.2 | JalRangeCheck | 6 | 41,492 | 
...
| leaf | JalRangeCheck | 0 | 43,146 | 
| leaf | JalRangeCheck | 1 | 40,327 | 
| leaf | JalRangeCheck | 2 | 40,333 | 
| leaf | JalRangeCheck | 3 | 40,298 | 
| leaf | JalRangeCheck | 4 | 40,330 | 
| leaf | JalRangeCheck | 5 | 40,194 | 
| leaf | JalRangeCheck | 6 | 42,704 | 
...
| internal.0 | IfEqI | 0 | JAL | 8,228 | 
| internal.0 | IfEqI | 1 | BNE | 22,062 | 
| internal.0 | IfEqI | 1 | JAL | 8,325 | 
| internal.0 | IfEqI | 2 | BNE | 22,062 | 
| internal.0 | IfEqI | 2 | JAL | 8,263 | 
| internal.0 | IfEqI | 3 | BNE | 11,031 | 
| internal.0 | IfEqI | 3 | JAL | 4,228 | 
...
| internal.1 | IfEqI | 4 | JAL | 3,836 | 
| internal.1 | IfEqI | 5 | BNE | 14,718 | 
| internal.1 | IfEqI | 5 | JAL | 3,724 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal.0 | 0 | 1,276 | 17,687 | 2,421,309 | 348,105,186 | 7,677 | 1,302 | 1,359 | 1,444 | 1,663 | 1,604 | 136,809,031 | 301 | 8,734 | 
| internal.0 | 1 | 1,248 | 17,726 | 2,421,315 | 348,105,186 | 7,708 | 1,319 | 1,369 | 1,445 | 1,661 | 1,604 | 136,688,111 | 305 | 8,770 | 
| internal.0 | 2 | 1,288 | 17,765 | 2,421,253 | 348,105,186 | 7,698 | 1,311 | 1,344 | 1,474 | 1,656 | 1,607 | 136,687,367 | 300 | 8,779 | 
| internal.0 | 3 | 649 | 9,434 | 1,211,082 | 185,719,266 | 4,377 | 733 | 835 | 779 | 1,012 | 852 | 69,108,539 | 160 | 4,408 | 
| internal.1 | 4 | 729 | 10,661 | 1,579,484 | 184,134,114 | 4,377 | 711 | 862 | 767 | 1,023 | 856 | 75,274,067 | 153 | 5,555 | 
| internal.1 | 5 | 734 | 10,740 | 1,571,696 | 187,279,842 | 4,492 | 731 | 882 | 781 | 1,056 | 869 | 74,681,675 | 165 | 5,514 | 
| internal.2 | 6 | 722 | 10,611 | 1,564,318 | 184,134,114 | 4,415 | 718 | 892 | 774 | 1,021 | 856 | 73,835,624 | 149 | 5,474 | 
| leaf | 0 | 676 | 8,109 | 1,310,886 | 254,942,698 | 2,712 | 374 | 299 | 761 | 638 | 471 | 70,451,898 | 165 | 4,721 | 
| leaf | 1 | 561 | 6,819 | 1,085,477 | 203,757,034 | 2,272 | 307 | 250 | 585 | 602 | 395 | 59,083,405 | 127 | 3,986 | 
| leaf | 2 | 544 | 6,762 | 1,085,483 | 203,757,034 | 2,245 | 308 | 253 | 587 | 571 | 394 | 59,083,477 | 128 | 3,973 | 
| leaf | 3 | 567 | 6,794 | 1,085,448 | 203,757,034 | 2,248 | 306 | 252 | 586 | 576 | 396 | 59,083,057 | 126 | 3,979 | 
| leaf | 4 | 559 | 6,799 | 1,085,480 | 203,757,034 | 2,241 | 305 | 251 | 587 | 569 | 393 | 59,083,441 | 129 | 3,999 | 
| leaf | 5 | 561 | 6,779 | 1,085,344 | 203,757,034 | 2,248 | 306 | 253 | 585 | 576 | 395 | 59,081,809 | 128 | 3,970 | 
| leaf | 6 | 654 | 7,543 | 1,267,891 | 208,674,282 | 2,290 | 315 | 257 | 600 | 575 | 410 | 67,953,958 | 129 | 4,599 | 
| root | 0 | 390 | 41,591 | 782,868 | 80,779,418 | 38,454 | 867 | 13,809 | 7,661 | 3,731 | 12,294 | 37,565,545 | 77 | 2,747 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fib_e2e | 0 |
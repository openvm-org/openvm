...
| fib_e2e |  54.50 |  7.96 |
| leaf |  48.59 |  7.94 |
| internal.0 |  57.07 |  23.99 |
| internal.1 |  15.68 |  15.68 |
| root |  41.74 |  41.74 |
...
| `total_proof_time_ms ` |  7,785.14 |  54,496 |  7,960 |  7,094 |
| `main_cells_used     ` |  57,756,362.14 |  404,294,535 |  58,898,534 |  51,097,540 |
| `total_cycles        ` |  1,714,325.29 |  12,000,277 |  1,747,603 |  1,515,164 |
| `execute_time_ms     ` |  5,389.14 |  37,724 |  5,529 |  4,763 |
| `trace_gen_time_ms   ` |  600.29 |  4,202 |  624 |  542 |
| `stark_prove_excluding_trace_time_ms` |  1,795.71 |  12,570 |  1,866 |  1,772 |
| `main_trace_commit_time_ms` |  291.43 |  2,040 |  322 |  283 |
| `generate_perm_trace_time_ms` |  121.14 |  848 |  127 |  115 |
| `perm_trace_commit_time_ms` |  444.71 |  3,113 |  451 |  442 |
| `quotient_poly_compute_time_ms` |  250.57 |  1,754 |  253 |  247 |
| `quotient_poly_commit_time_ms` |  188.71 |  1,321 |  221 |  180 |
| `pcs_opening_time_ms ` |  495 |  3,465 |  501 |  492 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  6,941.57 |  48,591 |  7,936 |  6,630 |
| `main_cells_used     ` |  61,974,207 |  433,819,449 |  70,451,442 |  59,082,085 |
| `total_cycles        ` |  1,143,696.57 |  8,005,876 |  1,310,848 |  1,085,367 |
| `execute_time_ms     ` |  4,143.57 |  29,005 |  4,701 |  3,933 |
| `trace_gen_time_ms   ` |  591 |  4,137 |  665 |  560 |
| `stark_prove_excluding_trace_time_ms` |  2,207 |  15,449 |  2,570 |  2,126 |
| `main_trace_commit_time_ms` |  367 |  2,569 |  426 |  353 |
| `generate_perm_trace_time_ms` |  133.86 |  937 |  165 |  125 |
| `perm_trace_commit_time_ms` |  566.29 |  3,964 |  696 |  540 |
| `quotient_poly_compute_time_ms` |  318.14 |  2,227 |  380 |  304 |
| `quotient_poly_commit_time_ms` |  245.57 |  1,719 |  286 |  235 |
| `pcs_opening_time_ms ` |  571.14 |  3,998 |  612 |  557 |

| internal.0 |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  19,023.33 |  57,070 |  23,986 |  9,214 |
| `main_cells_used     ` |  159,256,412.33 |  477,769,237 |  204,391,025 |  69,107,999 |
| `total_cycles        ` |  2,824,815.33 |  8,474,446 |  3,631,712 |  1,211,037 |
| `execute_time_ms     ` |  10,171 |  30,513 |  13,079 |  4,385 |
| `trace_gen_time_ms   ` |  1,473.33 |  4,420 |  1,891 |  672 |
| `stark_prove_excluding_trace_time_ms` |  7,379 |  22,137 |  9,016 |  4,157 |
| `main_trace_commit_time_ms` |  1,525 |  4,575 |  1,907 |  768 |
| `generate_perm_trace_time_ms` |  309.33 |  928 |  385 |  158 |
| `perm_trace_commit_time_ms` |  1,316 |  3,948 |  1,631 |  702 |
| `quotient_poly_compute_time_ms` |  1,375.67 |  4,127 |  1,701 |  728 |
| `quotient_poly_commit_time_ms` |  1,282 |  3,846 |  1,522 |  808 |
| `pcs_opening_time_ms ` |  1,566.33 |  4,699 |  1,864 |  990 |

| internal.1 |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  15,675 |  15,675 |  15,675 |  15,675 |
| `main_cells_used     ` |  111,670,999 |  111,670,999 |  111,670,999 |  111,670,999 |
| `total_cycles        ` |  2,362,255 |  2,362,255 |  2,362,255 |  2,362,255 |
| `execute_time_ms     ` |  8,274 |  8,274 |  8,274 |  8,274 |
| `trace_gen_time_ms   ` |  1,094 |  1,094 |  1,094 |  1,094 |
| `stark_prove_excluding_trace_time_ms` |  6,307 |  6,307 |  6,307 |  6,307 |
| `main_trace_commit_time_ms` |  1,260 |  1,260 |  1,260 |  1,260 |
| `generate_perm_trace_time_ms` |  251 |  251 |  251 |  251 |
| `perm_trace_commit_time_ms` |  1,053 |  1,053 |  1,053 |  1,053 |
| `quotient_poly_compute_time_ms` |  1,107 |  1,107 |  1,107 |  1,107 |
| `quotient_poly_commit_time_ms` |  1,097 |  1,097 |  1,097 |  1,097 |
| `pcs_opening_time_ms ` |  1,533 |  1,533 |  1,533 |  1,533 |

| root |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  41,737 |  41,737 |  41,737 |  41,737 |
| `main_cells_used     ` |  38,265,056 |  38,265,056 |  38,265,056 |  38,265,056 |
| `total_cycles        ` |  790,267 |  790,267 |  790,267 |  790,267 |
| `execute_time_ms     ` |  2,737 |  2,737 |  2,737 |  2,737 |
| `trace_gen_time_ms   ` |  391 |  391 |  391 |  391 |
| `stark_prove_excluding_trace_time_ms` |  38,609 |  38,609 |  38,609 |  38,609 |
...
| `quotient_poly_commit_time_ms` |  13,986 |  13,986 |  13,986 |  13,986 |
| `pcs_opening_time_ms ` |  3,722 |  3,722 |  3,722 |  3,722 |

| halo2_outer |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  92,315 |  92,315 |  92,315 |  92,315 |
| `main_cells_used     ` |  62,046,937 |  62,046,937 |  62,046,937 |  62,046,937 |

| halo2_wrapper |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  44,250 |  44,250 |  44,250 |  44,250 |
...
| --- | --- | --- | --- |
| fib_e2e |  | 7 |  | 
| halo2_outer | 92,315 |  | 62,046,937 | 
| halo2_wrapper | 44,250 |  |  | 
...
| internal.0 | JalRangeCheck | IfEqI | 0 | JAL | 149,376 | 
| internal.0 | JalRangeCheck | IfEqI | 1 | JAL | 150,648 | 
| internal.0 | JalRangeCheck | IfEqI | 2 | JAL | 50,196 | 
...
| internal.1 | JalRangeCheck | IfEqI | 3 | JAL | 68,400 | 
...
| leaf | JalRangeCheck | IfEqI | 0 | JAL | 50,004 | 
| leaf | JalRangeCheck | IfEqI | 1 | JAL | 49,464 | 
| leaf | JalRangeCheck | IfEqI | 2 | JAL | 49,284 | 
| leaf | JalRangeCheck | IfEqI | 3 | JAL | 49,980 | 
| leaf | JalRangeCheck | IfEqI | 4 | JAL | 50,316 | 
| leaf | JalRangeCheck | IfEqI | 5 | JAL | 50,112 | 
| leaf | JalRangeCheck | IfEqI | 6 | JAL | 50,040 | 
...
| root | JalRangeCheck | IfEqI | 0 | JAL | 22,572 | 
...
| internal.0 | JalRangeCheck | 0 | 121,661 | 
| internal.0 | JalRangeCheck | 1 | 121,767 | 
| internal.0 | JalRangeCheck | 2 | 40,602 | 
...
| internal.1 | JalRangeCheck | 3 | 63,421 | 
...
| leaf | JalRangeCheck | 0 | 43,108 | 
| leaf | JalRangeCheck | 1 | 40,232 | 
| leaf | JalRangeCheck | 2 | 40,217 | 
| leaf | JalRangeCheck | 3 | 40,275 | 
| leaf | JalRangeCheck | 4 | 40,303 | 
| leaf | JalRangeCheck | 5 | 40,286 | 
| leaf | JalRangeCheck | 6 | 42,778 | 
...
| internal.0 | IfEqI | 0 | JAL | 12,448 | 
| internal.0 | IfEqI | 1 | BNE | 33,093 | 
| internal.0 | IfEqI | 1 | JAL | 12,554 | 
| internal.0 | IfEqI | 2 | BNE | 11,031 | 
| internal.0 | IfEqI | 2 | JAL | 4,183 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal.0 | 0 |
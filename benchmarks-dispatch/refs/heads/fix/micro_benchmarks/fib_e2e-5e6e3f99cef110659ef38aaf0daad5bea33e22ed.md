...
| fib_e2e |  54.41 |  7.94 |
| leaf |  48.61 |  7.95 |
| internal.0 |  56.90 |  23.87 |
| internal.1 |  15.64 |  15.64 |
| root |  41.62 |  41.62 |
| halo2_outer |  91.17 |  91.17 |
...
| `total_proof_time_ms ` |  7,772.43 |  54,407 |  7,937 |  7,098 |
| `main_cells_used     ` |  57,756,362.14 |  404,294,535 |  58,898,534 |  51,097,540 |
| `total_cycles        ` |  1,714,325.29 |  12,000,277 |  1,747,603 |  1,515,164 |
| `execute_time_ms     ` |  5,386.86 |  37,708 |  5,538 |  4,774 |
| `trace_gen_time_ms   ` |  600.29 |  4,202 |  623 |  539 |
| `stark_prove_excluding_trace_time_ms` |  1,785.29 |  12,497 |  1,852 |  1,755 |
| `main_trace_commit_time_ms` |  289.57 |  2,027 |  314 |  284 |
| `generate_perm_trace_time_ms` |  114.29 |  800 |  116 |  111 |
| `perm_trace_commit_time_ms` |  443.14 |  3,102 |  449 |  438 |
| `quotient_poly_compute_time_ms` |  250.86 |  1,756 |  255 |  247 |
| `quotient_poly_commit_time_ms` |  187.86 |  1,315 |  221 |  180 |
| `pcs_opening_time_ms ` |  495.29 |  3,467 |  508 |  482 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  6,943.86 |  48,607 |  7,952 |  6,624 |
| `main_cells_used     ` |  61,974,352.71 |  433,820,469 |  70,452,390 |  59,082,181 |
| `total_cycles        ` |  1,143,708.71 |  8,005,961 |  1,310,927 |  1,085,375 |
| `execute_time_ms     ` |  4,156.71 |  29,097 |  4,715 |  3,952 |
| `trace_gen_time_ms   ` |  586.71 |  4,107 |  679 |  543 |
| `stark_prove_excluding_trace_time_ms` |  2,200.43 |  15,403 |  2,558 |  2,117 |
| `main_trace_commit_time_ms` |  368.29 |  2,578 |  421 |  353 |
| `generate_perm_trace_time_ms` |  132.57 |  928 |  164 |  125 |
| `perm_trace_commit_time_ms` |  561.71 |  3,932 |  693 |  536 |
| `quotient_poly_compute_time_ms` |  317.43 |  2,222 |  381 |  305 |
| `quotient_poly_commit_time_ms` |  244.71 |  1,713 |  280 |  237 |
| `pcs_opening_time_ms ` |  570.71 |  3,995 |  614 |  548 |

| internal.0 |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  18,967 |  56,901 |  23,869 |  9,184 |
| `main_cells_used     ` |  159,257,216.33 |  477,771,649 |  204,392,909 |  69,107,975 |
| `total_cycles        ` |  2,824,882.33 |  8,474,647 |  3,631,854 |  1,211,035 |
| `execute_time_ms     ` |  10,186 |  30,558 |  13,087 |  4,405 |
| `trace_gen_time_ms   ` |  1,455.67 |  4,367 |  1,857 |  675 |
| `stark_prove_excluding_trace_time_ms` |  7,325.33 |  21,976 |  8,947 |  4,104 |
| `main_trace_commit_time_ms` |  1,522 |  4,566 |  1,909 |  761 |
| `generate_perm_trace_time_ms` |  307.33 |  922 |  382 |  158 |
| `perm_trace_commit_time_ms` |  1,302.33 |  3,907 |  1,613 |  702 |
| `quotient_poly_compute_time_ms` |  1,379.33 |  4,138 |  1,709 |  727 |
| `quotient_poly_commit_time_ms` |  1,254.33 |  3,763 |  1,512 |  773 |
| `pcs_opening_time_ms ` |  1,555 |  4,665 |  1,850 |  977 |

| internal.1 |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  15,645 |  15,645 |  15,645 |  15,645 |
| `main_cells_used     ` |  111,669,019 |  111,669,019 |  111,669,019 |  111,669,019 |
| `total_cycles        ` |  2,362,090 |  2,362,090 |  2,362,090 |  2,362,090 |
| `execute_time_ms     ` |  8,304 |  8,304 |  8,304 |  8,304 |
| `trace_gen_time_ms   ` |  1,075 |  1,075 |  1,075 |  1,075 |
| `stark_prove_excluding_trace_time_ms` |  6,266 |  6,266 |  6,266 |  6,266 |
| `main_trace_commit_time_ms` |  1,251 |  1,251 |  1,251 |  1,251 |
| `generate_perm_trace_time_ms` |  247 |  247 |  247 |  247 |
| `perm_trace_commit_time_ms` |  1,048 |  1,048 |  1,048 |  1,048 |
| `quotient_poly_compute_time_ms` |  1,113 |  1,113 |  1,113 |  1,113 |
| `quotient_poly_commit_time_ms` |  1,081 |  1,081 |  1,081 |  1,081 |
| `pcs_opening_time_ms ` |  1,521 |  1,521 |  1,521 |  1,521 |

| root |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  41,616 |  41,616 |  41,616 |  41,616 |
| `main_cells_used     ` |  38,265,236 |  38,265,236 |  38,265,236 |  38,265,236 |
| `total_cycles        ` |  790,282 |  790,282 |  790,282 |  790,282 |
| `execute_time_ms     ` |  2,749 |  2,749 |  2,749 |  2,749 |
| `trace_gen_time_ms   ` |  397 |  397 |  397 |  397 |
| `stark_prove_excluding_trace_time_ms` |  38,470 |  38,470 |  38,470 |  38,470 |
| `main_trace_commit_time_ms` |  12,276 |  12,276 |  12,276 |  12,276 |
| `generate_perm_trace_time_ms` |  75 |  75 |  75 |  75 |
| `perm_trace_commit_time_ms` |  7,655 |  7,655 |  7,655 |  7,655 |
| `quotient_poly_compute_time_ms` |  866 |  866 |  866 |  866 |
| `quotient_poly_commit_time_ms` |  13,887 |  13,887 |  13,887 |  13,887 |
| `pcs_opening_time_ms ` |  3,662 |  3,662 |  3,662 |  3,662 |

| halo2_outer |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  91,166 |  91,166 |  91,166 |  91,166 |
...
| internal.0 | JalRangeCheck | IfEqI | 0 | JAL | 151,260 | 
| internal.0 | JalRangeCheck | IfEqI | 1 | JAL | 151,200 | 
| internal.0 | JalRangeCheck | IfEqI | 2 | JAL | 50,172 | 
...
| internal.1 | JalRangeCheck | IfEqI | 3 | JAL | 66,420 | 
...
| leaf | JalRangeCheck | IfEqI | 0 | JAL | 50,952 | 
| leaf | JalRangeCheck | IfEqI | 1 | JAL | 49,656 | 
| leaf | JalRangeCheck | IfEqI | 2 | JAL | 50,484 | 
| leaf | JalRangeCheck | IfEqI | 3 | JAL | 49,980 | 
| leaf | JalRangeCheck | IfEqI | 4 | JAL | 49,380 | 
| leaf | JalRangeCheck | IfEqI | 5 | JAL | 50,112 | 
| leaf | JalRangeCheck | IfEqI | 6 | JAL | 49,656 | 
...
| root | JalRangeCheck | IfEqI | 0 | JAL | 22,752 | 
...
| internal.0 | JalRangeCheck | 0 | 121,818 | 
| internal.0 | JalRangeCheck | 1 | 121,813 | 
| internal.0 | JalRangeCheck | 2 | 40,600 | 
...
| internal.1 | JalRangeCheck | 3 | 63,256 | 
...
| leaf | JalRangeCheck | 0 | 43,187 | 
| leaf | JalRangeCheck | 1 | 40,248 | 
| leaf | JalRangeCheck | 2 | 40,317 | 
| leaf | JalRangeCheck | 3 | 40,275 | 
| leaf | JalRangeCheck | 4 | 40,225 | 
| leaf | JalRangeCheck | 5 | 40,286 | 
| leaf | JalRangeCheck | 6 | 42,746 | 
...
| internal.0 | IfEqI | 0 | JAL | 12,605 | 
| internal.0 | IfEqI | 1 | BNE | 33,093 | 
| internal.0 | IfEqI | 1 | JAL | 12,600 | 
| internal.0 | IfEqI | 2 | BNE | 11,031 | 
| internal.0 | IfEqI | 2 | JAL | 4,181 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal.0 | 0 |
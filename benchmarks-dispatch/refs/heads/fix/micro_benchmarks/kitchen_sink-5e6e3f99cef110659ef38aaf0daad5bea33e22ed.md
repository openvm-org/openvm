...
|:---|---:|---:|
| Total |  298.50 |  274.04 |
| kitchen_sink |  21.46 |  14.24 |
| leaf |  76.09 |  58.85 |
| internal.0 |  18.31 |  18.31 |
| root |  41.61 |  41.61 |
| halo2_outer |  96.63 |  96.63 |
...
| `total_proof_time_ms ` |  10,728.50 |  21,457 |  14,236 |  7,221 |
| `main_cells_used     ` |  448,443,364.50 |  896,886,729 |  633,876,935 |  263,009,794 |
| `total_cycles        ` |  50,021.50 |  100,043 |  86,355 |  13,688 |
| `execute_time_ms     ` |  230 |  460 |  394 |  66 |
| `trace_gen_time_ms   ` |  362 |  724 |  457 |  267 |
| `stark_prove_excluding_trace_time_ms` |  10,136.50 |  20,273 |  13,385 |  6,888 |
| `main_trace_commit_time_ms` |  3,193 |  6,386 |  4,379 |  2,007 |
| `generate_perm_trace_time_ms` |  288.50 |  577 |  382 |  195 |
| `perm_trace_commit_time_ms` |  1,254 |  2,508 |  1,671 |  837 |
| `quotient_poly_compute_time_ms` |  4,261 |  8,522 |  5,651 |  2,871 |
| `quotient_poly_commit_time_ms` |  233.50 |  467 |  272 |  195 |
| `pcs_opening_time_ms ` |  876 |  1,752 |  984 |  768 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  38,046 |  76,092 |  58,853 |  17,239 |
| `main_cells_used     ` |  464,477,606 |  928,955,212 |  740,531,384 |  188,423,828 |
| `total_cycles        ` |  5,367,012.50 |  10,734,025 |  8,260,451 |  2,473,574 |
| `execute_time_ms     ` |  19,005.50 |  38,011 |  29,128 |  8,883 |
| `trace_gen_time_ms   ` |  4,222.50 |  8,445 |  6,590 |  1,855 |
| `stark_prove_excluding_trace_time_ms` |  14,818 |  29,636 |  23,135 |  6,501 |
| `main_trace_commit_time_ms` |  2,731 |  5,462 |  4,313 |  1,149 |
| `generate_perm_trace_time_ms` |  1,093.50 |  2,187 |  1,731 |  456 |
| `perm_trace_commit_time_ms` |  4,763.50 |  9,527 |  7,607 |  1,920 |
| `quotient_poly_compute_time_ms` |  2,228 |  4,456 |  3,441 |  1,015 |
| `quotient_poly_commit_time_ms` |  1,279.50 |  2,559 |  1,940 |  619 |
| `pcs_opening_time_ms ` |  2,717.50 |  5,435 |  4,098 |  1,337 |

| internal.0 |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  18,306 |  18,306 |  18,306 |  18,306 |
| `main_cells_used     ` |  144,122,133 |  144,122,133 |  144,122,133 |  144,122,133 |
| `total_cycles        ` |  2,487,199 |  2,487,199 |  2,487,199 |  2,487,199 |
| `execute_time_ms     ` |  9,036 |  9,036 |  9,036 |  9,036 |
| `trace_gen_time_ms   ` |  1,330 |  1,330 |  1,330 |  1,330 |
| `stark_prove_excluding_trace_time_ms` |  7,940 |  7,940 |  7,940 |  7,940 |
| `main_trace_commit_time_ms` |  1,754 |  1,754 |  1,754 |  1,754 |
| `generate_perm_trace_time_ms` |  342 |  342 |  342 |  342 |
| `perm_trace_commit_time_ms` |  1,470 |  1,470 |  1,470 |  1,470 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  41,612 |  41,612 |  41,612 |  41,612 |
| `main_cells_used     ` |  38,291,901 |  38,291,901 |  38,291,901 |  38,291,901 |
| `total_cycles        ` |  790,639 |  790,639 |  790,639 |  790,639 |
| `execute_time_ms     ` |  2,797 |  2,797 |  2,797 |  2,797 |
| `trace_gen_time_ms   ` |  393 |  393 |  393 |  393 |
| `stark_prove_excluding_trace_time_ms` |  38,422 |  38,422 |  38,422 |  38,422 |
| `main_trace_commit_time_ms` |  12,277 |  12,277 |  12,277 |  12,277 |
...
| `quotient_poly_commit_time_ms` |  13,852 |  13,852 |  13,852 |  13,852 |
| `pcs_opening_time_ms ` |  3,678 |  3,678 |  3,678 |  3,678 |

| halo2_outer |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  96,634 |  96,634 |  96,634 |  96,634 |
| `main_cells_used     ` |  62,046,937 |  62,046,937 |  62,046,937 |  62,046,937 |

| halo2_wrapper |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  44,399 |  44,399 |  44,399 |  44,399 |
...
| --- | --- | --- | --- |
| halo2_outer | 96,634 |  | 62,046,937 | 
| halo2_wrapper | 44,399 |  |  | 
| kitchen_sink |  | 2 |  | 
...
| internal.0 | JalRangeCheck | IfEqI | 0 | JAL | 108,504 | 
...
| leaf | JalRangeCheck | IfEqI | 0 | JAL | 52,788 | 
| leaf | JalRangeCheck | IfEqI | 1 | JAL | 52,956 | 
...
| root | JalRangeCheck | IfEqI | 0 | JAL | 23,232 | 
...
| internal.0 | JalRangeCheck | 0 | 86,270 | 
...
| leaf | JalRangeCheck | 0 | 76,516 | 
| leaf | JalRangeCheck | 1 | 49,926 | 
...
| leaf | IfEqI | 0 | JAL | 4,399 | 
| leaf | IfEqI | 1 | BNE | 13,464 | 
| leaf | IfEqI | 1 | JAL | 4,413 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal.0 | 0 | 1,330 | 18,306 | 2,487,199 | 421,243,362 | 7,940 | 1,471 | 1,273 | 1,470 | 1,624 | 1,754 | 144,122,133 | 342 | 9,036 | 
| leaf | 0 | 6,590 | 58,853 | 8,260,451 | 2,777,026,026 | 23,135 | 3,441 | 1,940 | 7,607 | 4,098 | 4,313 | 740,531,384 | 1,731 | 29,128 | 
| leaf | 1 | 1,855 | 17,239 | 2,473,574 | 748,047,850 | 6,501 | 1,015 | 619 | 1,920 | 1,337 | 1,149 | 188,423,828 | 456 | 8,883 | 
| root | 0 | 393 | 41,612 | 790,639 | 80,779,418 | 38,422 | 858 | 13,852 | 7,663 | 3,678 | 12,277 | 38,291,901 | 77 | 2,797 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| kitchen_sink | 0 | 457 | 14,236 | 86,355 | 1,307,172,505 | 13,385 | 5,651 | 272 | 1,671 | 984 | 4,379 | 633,876,935 | 382 | 394 | 
| kitchen_sink | 1 | 267 | 7,221 | 13,688 | 661,752,828 | 6,888 | 2,871 | 195 | 837 | 768 | 2,007 | 263,009,794 | 195 | 66 | 

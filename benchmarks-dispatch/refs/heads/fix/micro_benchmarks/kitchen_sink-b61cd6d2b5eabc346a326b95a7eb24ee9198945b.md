...
|:---|---:|---:|
| Total |  296.22 |  271.84 |
| kitchen_sink |  21.51 |  14.28 |
| leaf |  75.65 |  58.50 |
| internal.0 |  18.36 |  18.36 |
| root |  41.71 |  41.71 |
| halo2_outer |  94.68 |  94.68 |
...
| `total_proof_time_ms ` |  10,755 |  21,510 |  14,275 |  7,235 |
| `main_cells_used     ` |  448,443,364.50 |  896,886,729 |  633,876,935 |  263,009,794 |
| `total_cycles        ` |  50,021.50 |  100,043 |  86,355 |  13,688 |
| `execute_time_ms     ` |  229 |  458 |  392 |  66 |
| `trace_gen_time_ms   ` |  365.50 |  731 |  466 |  265 |
| `stark_prove_excluding_trace_time_ms` |  10,160.50 |  20,321 |  13,417 |  6,904 |
| `main_trace_commit_time_ms` |  3,186.50 |  6,373 |  4,366 |  2,007 |
| `generate_perm_trace_time_ms` |  289 |  578 |  382 |  196 |
| `perm_trace_commit_time_ms` |  1,253 |  2,506 |  1,667 |  839 |
| `quotient_poly_compute_time_ms` |  4,260.50 |  8,521 |  5,651 |  2,870 |
| `quotient_poly_commit_time_ms` |  234 |  468 |  272 |  196 |
| `pcs_opening_time_ms ` |  907.50 |  1,815 |  1,035 |  780 |

| leaf |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  37,826.50 |  75,653 |  58,504 |  17,149 |
| `main_cells_used     ` |  464,476,898 |  928,953,796 |  740,530,352 |  188,423,444 |
| `total_cycles        ` |  5,366,953.50 |  10,733,907 |  8,260,365 |  2,473,542 |
| `execute_time_ms     ` |  18,869 |  37,738 |  28,907 |  8,831 |
| `trace_gen_time_ms   ` |  4,173 |  8,346 |  6,529 |  1,817 |
| `stark_prove_excluding_trace_time_ms` |  14,784.50 |  29,569 |  23,068 |  6,501 |
| `main_trace_commit_time_ms` |  2,725 |  5,450 |  4,309 |  1,141 |
| `generate_perm_trace_time_ms` |  1,102.50 |  2,205 |  1,737 |  468 |
| `perm_trace_commit_time_ms` |  4,720 |  9,440 |  7,521 |  1,919 |
| `quotient_poly_compute_time_ms` |  2,230 |  4,460 |  3,451 |  1,009 |
| `quotient_poly_commit_time_ms` |  1,287.50 |  2,575 |  1,948 |  627 |
| `pcs_opening_time_ms ` |  2,713.50 |  5,427 |  4,096 |  1,331 |

| internal.0 |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  18,355 |  18,355 |  18,355 |  18,355 |
| `main_cells_used     ` |  144,123,525 |  144,123,525 |  144,123,525 |  144,123,525 |
| `total_cycles        ` |  2,487,315 |  2,487,315 |  2,487,315 |  2,487,315 |
| `execute_time_ms     ` |  9,010 |  9,010 |  9,010 |  9,010 |
| `trace_gen_time_ms   ` |  1,360 |  1,360 |  1,360 |  1,360 |
| `stark_prove_excluding_trace_time_ms` |  7,985 |  7,985 |  7,985 |  7,985 |
| `main_trace_commit_time_ms` |  1,756 |  1,756 |  1,756 |  1,756 |
| `generate_perm_trace_time_ms` |  345 |  345 |  345 |  345 |
...
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  41,706 |  41,706 |  41,706 |  41,706 |
| `main_cells_used     ` |  38,291,841 |  38,291,841 |  38,291,841 |  38,291,841 |
| `total_cycles        ` |  790,634 |  790,634 |  790,634 |  790,634 |
| `execute_time_ms     ` |  2,780 |  2,780 |  2,780 |  2,780 |
| `trace_gen_time_ms   ` |  382 |  382 |  382 |  382 |
| `stark_prove_excluding_trace_time_ms` |  38,544 |  38,544 |  38,544 |  38,544 |
| `main_trace_commit_time_ms` |  12,293 |  12,293 |  12,293 |  12,293 |
| `generate_perm_trace_time_ms` |  76 |  76 |  76 |  76 |
| `perm_trace_commit_time_ms` |  7,662 |  7,662 |  7,662 |  7,662 |
| `quotient_poly_compute_time_ms` |  863 |  863 |  863 |  863 |
| `quotient_poly_commit_time_ms` |  13,805 |  13,805 |  13,805 |  13,805 |
| `pcs_opening_time_ms ` |  3,840 |  3,840 |  3,840 |  3,840 |

| halo2_outer |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  94,679 |  94,679 |  94,679 |  94,679 |
| `main_cells_used     ` |  62,046,937 |  62,046,937 |  62,046,937 |  62,046,937 |

| halo2_wrapper |||||
|:---|---:|---:|---:|---:|
|metric|avg|sum|max|min|
| `total_proof_time_ms ` |  44,318 |  44,318 |  44,318 |  44,318 |
...
| --- | --- | --- | --- |
| halo2_outer | 94,679 |  | 62,046,937 | 
| halo2_wrapper | 44,318 |  |  | 
| kitchen_sink |  | 2 |  | 
...
| internal.0 | JalRangeCheck | IfEqI | 0 | JAL | 109,896 | 
...
| leaf | JalRangeCheck | IfEqI | 0 | JAL | 51,756 | 
| leaf | JalRangeCheck | IfEqI | 1 | JAL | 52,572 | 
...
| internal.0 | JalRangeCheck | 0 | 86,386 | 
...
| leaf | JalRangeCheck | 0 | 76,430 | 
| leaf | JalRangeCheck | 1 | 49,894 | 
...
| leaf | IfEqI | 0 | JAL | 4,313 | 
| leaf | IfEqI | 1 | BNE | 13,464 | 
| leaf | IfEqI | 1 | JAL | 4,381 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| internal.0 | 0 | 1,360 | 18,355 | 2,487,315 | 421,243,362 | 7,985 | 1,482 | 1,290 | 1,453 | 1,654 | 1,756 | 144,123,525 | 345 | 9,010 | 
| leaf | 0 | 6,529 | 58,504 | 8,260,365 | 2,777,026,026 | 23,068 | 3,451 | 1,948 | 7,521 | 4,096 | 4,309 | 740,530,352 | 1,737 | 28,907 | 
| leaf | 1 | 1,817 | 17,149 | 2,473,542 | 748,047,850 | 6,501 | 1,009 | 627 | 1,919 | 1,331 | 1,141 | 188,423,444 | 468 | 8,831 | 
| root | 0 | 382 | 41,706 | 790,634 | 80,779,418 | 38,544 | 863 | 13,805 | 7,662 | 3,840 | 12,293 | 38,291,841 | 76 | 2,780 | 
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| kitchen_sink | 0 | 466 | 14,275 | 86,355 | 1,307,172,505 | 13,417 | 5,651 | 272 | 1,667 | 1,035 | 4,366 | 633,876,935 | 382 | 392 | 
| kitchen_sink | 1 | 265 | 7,235 | 13,688 | 661,752,828 | 6,904 | 2,870 | 196 | 839 | 780 | 2,007 | 263,009,794 | 196 | 66 | 
...
[![](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/kitchen_sink-b61cd6d2b5eabc346a326b95a7eb24ee9198945b/kitchen_sink-halo2_outer.cell_tracker_span.cells_used.reverse.svg)](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/kitchen_sink-b61cd6d2b5eabc346a326b95a7eb24ee9198945b/kitchen_sink-halo2_outer.cell_tracker_span.cells_used.reverse.svg)
[![](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/kitchen_sink-b61cd6d2b5eabc346a326b95a7eb24ee9198945b/kitchen_sink-halo2_outer.cell_tracker_span.cells_used.svg)](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/kitchen_sink-b61cd6d2b5eabc346a326b95a7eb24ee9198945b/kitchen_sink-halo2_outer.cell_tracker_span.cells_used.svg)
[![](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/kitchen_sink-b61cd6d2b5eabc346a326b95a7eb24ee9198945b/kitchen_sink-internal.0.dsl_ir.opcode.air_name.cells_used.reverse.svg)](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/kitchen_sink-b61cd6d2b5eabc346a326b95a7eb24ee9198945b/kitchen_sink-internal.0.dsl_ir.opcode.air_name.cells_used.reverse.svg)
[![](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/kitchen_sink-b61cd6d2b5eabc346a326b95a7eb24ee9198945b/kitchen_sink-internal.0.dsl_ir.opcode.air_name.cells_used.svg)](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/kitchen_sink-b61cd6d2b5eabc346a326b95a7eb24ee9198945b/kitchen_sink-internal.0.dsl_ir.opcode.air_name.cells_used.svg)
[![](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/kitchen_sink-b61cd6d2b5eabc346a326b95a7eb24ee9198945b/kitchen_sink-internal.0.dsl_ir.opcode.frequency.reverse.svg)](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/kitchen_sink-b61cd6d2b5eabc346a326b95a7eb24ee9198945b/kitchen_sink-internal.0.dsl_ir.opcode.frequency.reverse.svg)
[![](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/kitchen_sink-b61cd6d2b5eabc346a326b95a7eb24ee9198945b/kitchen_sink-internal.0.dsl_ir.opcode.frequency.svg)](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/kitchen_sink-b61cd6d2b5eabc346a326b95a7eb24ee9198945b/kitchen_sink-internal.0.dsl_ir.opcode.frequency.svg)
[![](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/kitchen_sink-b61cd6d2b5eabc346a326b95a7eb24ee9198945b/kitchen_sink-kitchen_sink.dsl_ir.opcode.air_name.cells_used.reverse.svg)](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/kitchen_sink-b61cd6d2b5eabc346a326b95a7eb24ee9198945b/kitchen_sink-kitchen_sink.dsl_ir.opcode.air_name.cells_used.reverse.svg)
[![](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/kitchen_sink-b61cd6d2b5eabc346a326b95a7eb24ee9198945b/kitchen_sink-kitchen_sink.dsl_ir.opcode.air_name.cells_used.svg)](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/kitchen_sink-b61cd6d2b5eabc346a326b95a7eb24ee9198945b/kitchen_sink-kitchen_sink.dsl_ir.opcode.air_name.cells_used.svg)
[![](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/kitchen_sink-b61cd6d2b5eabc346a326b95a7eb24ee9198945b/kitchen_sink-kitchen_sink.dsl_ir.opcode.frequency.reverse.svg)](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/kitchen_sink-b61cd6d2b5eabc346a326b95a7eb24ee9198945b/kitchen_sink-kitchen_sink.dsl_ir.opcode.frequency.reverse.svg)
[![](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/kitchen_sink-b61cd6d2b5eabc346a326b95a7eb24ee9198945b/kitchen_sink-kitchen_sink.dsl_ir.opcode.frequency.svg)](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/kitchen_sink-b61cd6d2b5eabc346a326b95a7eb24ee9198945b/kitchen_sink-kitchen_sink.dsl_ir.opcode.frequency.svg)
[![](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/kitchen_sink-b61cd6d2b5eabc346a326b95a7eb24ee9198945b/kitchen_sink-leaf.dsl_ir.opcode.air_name.cells_used.reverse.svg)](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/kitchen_sink-b61cd6d2b5eabc346a326b95a7eb24ee9198945b/kitchen_sink-leaf.dsl_ir.opcode.air_name.cells_used.reverse.svg)
[![](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/kitchen_sink-b61cd6d2b5eabc346a326b95a7eb24ee9198945b/kitchen_sink-leaf.dsl_ir.opcode.air_name.cells_used.svg)](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/kitchen_sink-b61cd6d2b5eabc346a326b95a7eb24ee9198945b/kitchen_sink-leaf.dsl_ir.opcode.air_name.cells_used.svg)
[![](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/kitchen_sink-b61cd6d2b5eabc346a326b95a7eb24ee9198945b/kitchen_sink-leaf.dsl_ir.opcode.frequency.reverse.svg)](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/kitchen_sink-b61cd6d2b5eabc346a326b95a7eb24ee9198945b/kitchen_sink-leaf.dsl_ir.opcode.frequency.reverse.svg)
[![](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/kitchen_sink-b61cd6d2b5eabc346a326b95a7eb24ee9198945b/kitchen_sink-leaf.dsl_ir.opcode.frequency.svg)](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/kitchen_sink-b61cd6d2b5eabc346a326b95a7eb24ee9198945b/kitchen_sink-leaf.dsl_ir.opcode.frequency.svg)
[![](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/kitchen_sink-b61cd6d2b5eabc346a326b95a7eb24ee9198945b/kitchen_sink-root.dsl_ir.opcode.air_name.cells_used.reverse.svg)](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/kitchen_sink-b61cd6d2b5eabc346a326b95a7eb24ee9198945b/kitchen_sink-root.dsl_ir.opcode.air_name.cells_used.reverse.svg)
[![](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/kitchen_sink-b61cd6d2b5eabc346a326b95a7eb24ee9198945b/kitchen_sink-root.dsl_ir.opcode.air_name.cells_used.svg)](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/kitchen_sink-b61cd6d2b5eabc346a326b95a7eb24ee9198945b/kitchen_sink-root.dsl_ir.opcode.air_name.cells_used.svg)
[![](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/kitchen_sink-b61cd6d2b5eabc346a326b95a7eb24ee9198945b/kitchen_sink-root.dsl_ir.opcode.frequency.reverse.svg)](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/kitchen_sink-b61cd6d2b5eabc346a326b95a7eb24ee9198945b/kitchen_sink-root.dsl_ir.opcode.frequency.reverse.svg)
[![](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/kitchen_sink-b61cd6d2b5eabc346a326b95a7eb24ee9198945b/kitchen_sink-root.dsl_ir.opcode.frequency.svg)](https://openvm-public-data-sandbox-us-east-1.s3.us-east-1.amazonaws.com/benchmark/github/flamegraphs/kitchen_sink-b61cd6d2b5eabc346a326b95a7eb24ee9198945b/kitchen_sink-root.dsl_ir.opcode.frequency.svg)

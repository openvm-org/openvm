...
- (ISA) Memory accesses in non-native address spaces (address spaces other than `4`) now require 4-byte alignment, meaning the starting pointer address must be divisible by 4.

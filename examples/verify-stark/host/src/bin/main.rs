...
struct KeygenCmd {
    ...
    /// [input] number of verify-stark deferral circuits to use.
    #[arg(long, required = true)]
...
struct ProveCmd {
    ...
    /// [input] number of verify-stark calls to make for each deferral circuit.
...
fn main() -> Result<()> {
    match Cli::parse().command {
        Command::Keygen(cmd) => {
            ...
            let (cached_pk, vm_config, agg_vk) = keygen(child_agg_vk, cmd.num_def_circuits)?;
